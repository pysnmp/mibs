...
mibBuilder.exportSymbols("NEXANS-BM-MIB", portDefaultPrioQueue=portDefaultPrioQueue, infoLastTftpMessage=infoLastTftpMessage, bmTraps=bmTraps, adminLedGlobalMode=adminLedGlobalMode, adminUnsecureVlanId=adminUnsecureVlanId, infoFunctionInputStateF1=infoFunctionInputStateF1, portSpeedDuplexSetup=portSpeedDuplexSetup, portLEDYellow=portLEDYellow, portPoeAdminState=portPoeAdminState, infoNoOfPorts=infoNoOfPorts, bmSwitchSfpTable=bmSwitchSfpTable, adminReset=adminReset, radiusMgmtAuthReject=radiusMgmtAuthReject, clientRemoved=clientRemoved, portDefaultVlanId=portDefaultVlanId, portPoeOverloadFailure=portPoeOverloadFailure, switchIndustrialAlarmM2=switchIndustrialAlarmM2, sfpEvent=sfpEvent, portErrorDisabled=portErrorDisabled, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, sfpInfoLength9um=sfpInfoLength9um, switchTemperatureFailure=switchTemperatureFailure, bmSwitchSfpEntry=bmSwitchSfpEntry, adminAgentIpAddress=adminAgentIpAddress, infoSerie=infoSerie, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, portBandwidthLimitRxd=portBandwidthLimitRxd, infoSwitchHardwareVersion=infoSwitchHardwareVersion, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, portSecurityMacAddr2=portSecurityMacAddr2, sfpInfoRevisionNumber=sfpInfoRevisionNumber, bmSwitchVlan=bmSwitchVlan, adminAgentDhcp=adminAgentDhcp, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, portLinkType=portLinkType, infoProductNo=infoProductNo, adminAlarmM1=adminAlarmM1, sfpInfoSerialNumber=sfpInfoSerialNumber, sfpInfoVendorName=sfpInfoVendorName, portSecurityAdminState=portSecurityAdminState, infoSecurityFailMacAddr=infoSecurityFailMacAddr, bmSwitchPortEntry=bmSwitchPortEntry, switchConfigurationChanged=switchConfigurationChanged, portPrioDot1p=portPrioDot1p, bmSwitchAdmin=bmSwitchAdmin, adminAgentPhysAddress=adminAgentPhysAddress, infoNewMacAddr=infoNewMacAddr, bmSwitchPort=bmSwitchPort, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, sfpPortIndex=sfpPortIndex, vlanDescr=vlanDescr, sfpInfoWavelength=sfpInfoWavelength, bmSwitchSfp=bmSwitchSfp, portLinkChange=portLinkChange, portDescr=portDescr, infoSeriesNo=infoSeriesNo, sfpDiagTxOutputPower=sfpDiagTxOutputPower, sfpDiagTemperature=sfpDiagTemperature, bmSwitchPortTable=bmSwitchPortTable, infoPowerVoltage2500=infoPowerVoltage2500, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, adminAlarmNameM2=adminAlarmNameM2, internalMgmtWarning=internalMgmtWarning, adminSnmpMacTableMode=adminSnmpMacTableMode, adminMemoryCardMode=adminMemoryCardMode, portPoeCurrent=portPoeCurrent, portAcApSetup=portAcApSetup, portErrorCounter=portErrorCounter, infoTotalConfigChanges=infoTotalConfigChanges, adminFunctionInputNameF1=adminFunctionInputNameF1, infoNoOfReboots=infoNoOfReboots, infoPoeInputPower=infoPoeInputPower, portSecurityForwardingState=portSecurityForwardingState, sfpInfoBitRate=sfpInfoBitRate, portLEDGreen=portLEDGreen, radiusPortSecurityReject=radiusPortSecurityReject, sfpInfoLength62um=sfpInfoLength62um, infoAlarmStateM2=infoAlarmStateM2, infoTemperature=infoTemperature, adminSwitchPortMirror=adminSwitchPortMirror, sfpInfoPartNumber=sfpInfoPartNumber, infoPowerVoltage3300=infoPowerVoltage3300, vlanId=vlanId, infoAlarmStateM1=infoAlarmStateM1, infoUnauthIpAddr=infoUnauthIpAddr, tftpMessage=tftpMessage, sfpInfoConnectorDescr=sfpInfoConnectorDescr, portNewMacAddress=portNewMacAddress, portSecurityMacAddr1=portSecurityMacAddr1, infoDescr=infoDescr, portAdminState=portAdminState, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, portLinkState=portLinkState, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, portPoePower=portPoePower, sfpInfoDateCode=sfpInfoDateCode, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, switchPoeOverloadFailure=switchPoeOverloadFailure, adminAgentVlanId=adminAgentVlanId, adminAgentNetmask=adminAgentNetmask, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, portPoeVoltage=portPoeVoltage, bmSwitchInfo=bmSwitchInfo, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, portPrioIp=portPrioIp, portBandwidthLimitTxd=portBandwidthLimitTxd, switchIndustrialAlarmM1=switchIndustrialAlarmM1, portSecurityFailure=portSecurityFailure, sfpDiagRxIntputPower=sfpDiagRxIntputPower, portErrorCountFailure=portErrorCountFailure, portVoiceVlanId=portVoiceVlanId, portSecurityMacAddr3=portSecurityMacAddr3, portLoopBcastFailure=portLoopBcastFailure, adminAlarmNameM1=adminAlarmNameM1, portPoePowerLimit=portPoePowerLimit, portRemoteFault=portRemoteFault, sfpState=sfpState, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, infoMgmtHardwareVersion=infoMgmtHardwareVersion, PYSNMP_MODULE_ID=bmSwitchMIB, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, adminSwitchVlanTableMode=adminSwitchVlanTableMode, portTrunkingMode=portTrunkingMode, sfpInfoLength50um=sfpInfoLength50um, adminTftpAccess=adminTftpAccess, infoLastSfpEventMessage=infoLastSfpEventMessage, infoType=infoType, bmSwitchVlanEntry=bmSwitchVlanEntry, bmSwitchVlanTable=bmSwitchVlanTable, adminMgmtAccessList=adminMgmtAccessList, bmSwitchMIB=bmSwitchMIB, adminAlarmM2=adminAlarmM2, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, portIndex=portIndex, adminAgentPrioValue=adminAgentPrioValue, switchMgmtAuthFailure=switchMgmtAuthFailure, infoPoeInputVoltage=infoPoeInputVoltage, switchInternalVoltageFailure=switchInternalVoltageFailure, portLimiterPacketType=portLimiterPacketType, switchFunctionInputAlarm=switchFunctionInputAlarm, portName=portName, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, infoManufactureDate=infoManufactureDate, vlanIndex=vlanIndex, switchPoeVoltageFailure=switchPoeVoltageFailure)
