...
mibBuilder.exportSymbols("NEXANS-BM-MIB", portName=portName, bmSwitchInfo=bmSwitchInfo, portBandwidthLimitTxd=portBandwidthLimitTxd, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, portSecurityMacAddr2=portSecurityMacAddr2, portLinkChange=portLinkChange, adminSnmpMacTableMode=adminSnmpMacTableMode, portSecurityAdminState=portSecurityAdminState, portLinkType=portLinkType, infoPoeInputVoltage=infoPoeInputVoltage, portVoiceVlanId=portVoiceVlanId, adminAlarmNameM1=adminAlarmNameM1, sfpPortIndex=sfpPortIndex, switchPoeVoltageFailure=switchPoeVoltageFailure, sfpInfoVendorName=sfpInfoVendorName, sfpInfoPartNumber=sfpInfoPartNumber, portNewMacAddress=portNewMacAddress, sfpEvent=sfpEvent, adminAgentPrioValue=adminAgentPrioValue, adminSwitchVlanTableMode=adminSwitchVlanTableMode, portErrorDisabled=portErrorDisabled, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, adminAgentVlanId=adminAgentVlanId, adminReset=adminReset, switchPoeOverloadFailure=switchPoeOverloadFailure, sfpInfoLength50um=sfpInfoLength50um, switchIndustrialAlarmM1=switchIndustrialAlarmM1, bmSwitchVlanTable=bmSwitchVlanTable, bmSwitchVlan=bmSwitchVlan, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, infoSwitchHardwareVersion=infoSwitchHardwareVersion, adminAgentPhysAddress=adminAgentPhysAddress, sfpInfoLength62um=sfpInfoLength62um, sfpInfoSerialNumber=sfpInfoSerialNumber, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, portSecurityFailure=portSecurityFailure, infoNoOfPorts=infoNoOfPorts, infoType=infoType, infoFunctionInputStateF1=infoFunctionInputStateF1, sfpDiagTxOutputPower=sfpDiagTxOutputPower, portErrorCounter=portErrorCounter, sfpInfoRevisionNumber=sfpInfoRevisionNumber, sfpState=sfpState, portLimiterPacketType=portLimiterPacketType, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, switchConfigurationChanged=switchConfigurationChanged, portTrunkingMode=portTrunkingMode, vlanDescr=vlanDescr, portPoeVoltage=portPoeVoltage, portIndex=portIndex, sfpInfoLength9um=sfpInfoLength9um, infoPoeInputPower=infoPoeInputPower, radiusMgmtAuthReject=radiusMgmtAuthReject, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, infoSerie=infoSerie, portSecurityMacAddr3=portSecurityMacAddr3, infoAlarmStateM1=infoAlarmStateM1, infoProductNo=infoProductNo, sfpInfoWavelength=sfpInfoWavelength, infoNewMacAddr=infoNewMacAddr, portDefaultPrioQueue=portDefaultPrioQueue, switchFunctionInputAlarm=switchFunctionInputAlarm, sfpInfoDateCode=sfpInfoDateCode, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, switchTemperatureFailure=switchTemperatureFailure, infoLastSfpEventMessage=infoLastSfpEventMessage, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, infoTemperature=infoTemperature, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, portPrioDot1p=portPrioDot1p, infoPowerVoltage2500=infoPowerVoltage2500, portPoePower=portPoePower, bmTraps=bmTraps, infoPowerVoltage3300=infoPowerVoltage3300, infoLastTftpMessage=infoLastTftpMessage, infoSeriesNo=infoSeriesNo, vlanId=vlanId, radiusPortSecurityReject=radiusPortSecurityReject, portErrorCountFailure=portErrorCountFailure, portAcApSetup=portAcApSetup, adminTftpAccess=adminTftpAccess, vlanIndex=vlanIndex, portLoopBcastFailure=portLoopBcastFailure, switchInternalVoltageFailure=switchInternalVoltageFailure, portPoeAdminState=portPoeAdminState, switchMgmtAuthFailure=switchMgmtAuthFailure, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, portAdminState=portAdminState, infoSecurityFailMacAddr=infoSecurityFailMacAddr, tftpMessage=tftpMessage, sfpInfoBitRate=sfpInfoBitRate, portSecurityMacAddr1=portSecurityMacAddr1, PYSNMP_MODULE_ID=bmSwitchMIB, bmSwitchPortEntry=bmSwitchPortEntry, portDefaultVlanId=portDefaultVlanId, portPrioIp=portPrioIp, sfpDiagTemperature=sfpDiagTemperature, adminAgentIpAddress=adminAgentIpAddress, sfpDiagRxIntputPower=sfpDiagRxIntputPower, infoAlarmStateM2=infoAlarmStateM2, portSpeedDuplexSetup=portSpeedDuplexSetup, adminMgmtAccessList=adminMgmtAccessList, bmSwitchSfpEntry=bmSwitchSfpEntry, portBandwidthLimitRxd=portBandwidthLimitRxd, portLEDYellow=portLEDYellow, infoTotalConfigChanges=infoTotalConfigChanges, adminSwitchPortMirror=adminSwitchPortMirror, infoMgmtHardwareVersion=infoMgmtHardwareVersion, infoDescr=infoDescr, bmSwitchSfpTable=bmSwitchSfpTable, sfpInfoConnectorDescr=sfpInfoConnectorDescr, portPoeOverloadFailure=portPoeOverloadFailure, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, portRemoteFault=portRemoteFault, adminAlarmM2=adminAlarmM2, portPoeCurrent=portPoeCurrent, adminAgentNetmask=adminAgentNetmask, internalMgmtWarning=internalMgmtWarning, adminAlarmM1=adminAlarmM1, portPoePowerLimit=portPoePowerLimit, bmSwitchPortTable=bmSwitchPortTable, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, clientRemoved=clientRemoved, infoNoOfReboots=infoNoOfReboots, bmSwitchPort=bmSwitchPort, adminLedGlobalMode=adminLedGlobalMode, bmSwitchMIB=bmSwitchMIB, bmSwitchVlanEntry=bmSwitchVlanEntry, infoUnauthIpAddr=infoUnauthIpAddr, adminFunctionInputNameF1=adminFunctionInputNameF1, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, portSecurityForwardingState=portSecurityForwardingState, adminAgentDhcp=adminAgentDhcp, portDescr=portDescr, portLinkState=portLinkState, portLEDGreen=portLEDGreen, infoManufactureDate=infoManufactureDate, adminMemoryCardMode=adminMemoryCardMode, bmSwitchAdmin=bmSwitchAdmin, adminUnsecureVlanId=adminUnsecureVlanId, adminAlarmNameM2=adminAlarmNameM2, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, bmSwitchSfp=bmSwitchSfp, switchIndustrialAlarmM2=switchIndustrialAlarmM2)
