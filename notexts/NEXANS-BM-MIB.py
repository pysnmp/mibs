...
mibBuilder.exportSymbols("NEXANS-BM-MIB", switchIndustrialAlarmM1=switchIndustrialAlarmM1, portSpeedDuplexSetup=portSpeedDuplexSetup, infoDescr=infoDescr, portSecurityMacAddr3=portSecurityMacAddr3, portDefaultPrioQueue=portDefaultPrioQueue, bmSwitchInfo=bmSwitchInfo, sfpPortIndex=sfpPortIndex, sfpDiagTemperature=sfpDiagTemperature, portErrorCountFailure=portErrorCountFailure, infoNoOfPorts=infoNoOfPorts, portIndex=portIndex, sfpInfoWavelength=sfpInfoWavelength, sfpState=sfpState, clientRemoved=clientRemoved, infoPoeInputVoltage=infoPoeInputVoltage, adminAlarmNameM2=adminAlarmNameM2, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, portSecurityMacAddr2=portSecurityMacAddr2, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, portLinkState=portLinkState, switchConfigurationChanged=switchConfigurationChanged, infoSeriesNo=infoSeriesNo, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, tftpMessage=tftpMessage, sfpInfoPartNumber=sfpInfoPartNumber, portAdminState=portAdminState, vlanId=vlanId, portVoiceVlanId=portVoiceVlanId, portPrioDot1p=portPrioDot1p, sfpInfoLength62um=sfpInfoLength62um, infoNewMacAddr=infoNewMacAddr, adminAgentPrioValue=adminAgentPrioValue, infoAlarmStateM2=infoAlarmStateM2, adminLedGlobalMode=adminLedGlobalMode, portNewMacAddress=portNewMacAddress, portBandwidthLimitRxd=portBandwidthLimitRxd, portSecurityAdminState=portSecurityAdminState, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, adminAgentIpAddress=adminAgentIpAddress, adminReset=adminReset, adminAlarmNameM1=adminAlarmNameM1, adminAgentPhysAddress=adminAgentPhysAddress, portPoeVoltage=portPoeVoltage, adminAlarmM1=adminAlarmM1, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, adminAlarmM2=adminAlarmM2, portErrorCounter=portErrorCounter, portName=portName, portSecurityForwardingState=portSecurityForwardingState, portErrorDisabled=portErrorDisabled, portPoeAdminState=portPoeAdminState, PYSNMP_MODULE_ID=bmSwitchMIB, switchIndustrialAlarmM2=switchIndustrialAlarmM2, switchFunctionInputAlarm=switchFunctionInputAlarm, infoLastSfpEventMessage=infoLastSfpEventMessage, portBandwidthLimitTxd=portBandwidthLimitTxd, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, sfpInfoRevisionNumber=sfpInfoRevisionNumber, infoSerie=infoSerie, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, adminTftpAccess=adminTftpAccess, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, infoNoOfReboots=infoNoOfReboots, adminAgentNetmask=adminAgentNetmask, radiusPortSecurityReject=radiusPortSecurityReject, bmTraps=bmTraps, bmSwitchVlanTable=bmSwitchVlanTable, adminMgmtAccessList=adminMgmtAccessList, infoProductNo=infoProductNo, switchPoeVoltageFailure=switchPoeVoltageFailure, portLEDGreen=portLEDGreen, portPoeCurrent=portPoeCurrent, infoTotalConfigChanges=infoTotalConfigChanges, infoLastTftpMessage=infoLastTftpMessage, portTrunkingMode=portTrunkingMode, portPrioIp=portPrioIp, bmSwitchSfp=bmSwitchSfp, adminAgentDhcp=adminAgentDhcp, infoManufactureDate=infoManufactureDate, bmSwitchSfpTable=bmSwitchSfpTable, infoPoeInputPower=infoPoeInputPower, infoTemperature=infoTemperature, internalMgmtWarning=internalMgmtWarning, radiusMgmtAuthReject=radiusMgmtAuthReject, switchInternalVoltageFailure=switchInternalVoltageFailure, switchTemperatureFailure=switchTemperatureFailure, infoSecurityFailMacAddr=infoSecurityFailMacAddr, sfpDiagRxIntputPower=sfpDiagRxIntputPower, sfpInfoDateCode=sfpInfoDateCode, infoPowerVoltage2500=infoPowerVoltage2500, infoAlarmStateM1=infoAlarmStateM1, bmSwitchPortTable=bmSwitchPortTable, sfpInfoConnectorDescr=sfpInfoConnectorDescr, switchMgmtAuthFailure=switchMgmtAuthFailure, infoFunctionInputStateF1=infoFunctionInputStateF1, portLEDYellow=portLEDYellow, portPoePowerLimit=portPoePowerLimit, sfpInfoLength50um=sfpInfoLength50um, portPoePower=portPoePower, bmSwitchPortEntry=bmSwitchPortEntry, portRemoteFault=portRemoteFault, portSecurityMacAddr1=portSecurityMacAddr1, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, infoMgmtHardwareVersion=infoMgmtHardwareVersion, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, adminUnsecureVlanId=adminUnsecureVlanId, portLimiterPacketType=portLimiterPacketType, infoType=infoType, bmSwitchAdmin=bmSwitchAdmin, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, portDescr=portDescr, adminSwitchVlanTableMode=adminSwitchVlanTableMode, adminFunctionInputNameF1=adminFunctionInputNameF1, bmSwitchMIB=bmSwitchMIB, bmSwitchVlanEntry=bmSwitchVlanEntry, sfpInfoVendorName=sfpInfoVendorName, bmSwitchVlan=bmSwitchVlan, sfpInfoBitRate=sfpInfoBitRate, adminSnmpMacTableMode=adminSnmpMacTableMode, vlanIndex=vlanIndex, infoPowerVoltage3300=infoPowerVoltage3300, portSecurityFailure=portSecurityFailure, bmSwitchSfpEntry=bmSwitchSfpEntry, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, portLinkChange=portLinkChange, bmSwitchPort=bmSwitchPort, adminAgentVlanId=adminAgentVlanId, infoSwitchHardwareVersion=infoSwitchHardwareVersion, infoUnauthIpAddr=infoUnauthIpAddr, portPoeOverloadFailure=portPoeOverloadFailure, portAcApSetup=portAcApSetup, sfpDiagTxOutputPower=sfpDiagTxOutputPower, sfpInfoLength9um=sfpInfoLength9um, adminMemoryCardMode=adminMemoryCardMode, switchPoeOverloadFailure=switchPoeOverloadFailure, portLoopBcastFailure=portLoopBcastFailure, portLinkType=portLinkType, adminSwitchPortMirror=adminSwitchPortMirror, sfpInfoSerialNumber=sfpInfoSerialNumber, sfpEvent=sfpEvent, portDefaultVlanId=portDefaultVlanId, vlanDescr=vlanDescr)
