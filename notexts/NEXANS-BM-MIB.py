...
mibBuilder.exportSymbols("NEXANS-BM-MIB", portLoopBcastFailure=portLoopBcastFailure, switchIndustrialAlarmM2=switchIndustrialAlarmM2, portAdminState=portAdminState, bmSwitchSfpEntry=bmSwitchSfpEntry, portSpeedDuplexSetup=portSpeedDuplexSetup, infoPowerVoltage3300=infoPowerVoltage3300, sfpDiagTxOutputPower=sfpDiagTxOutputPower, switchPoeVoltageFailure=switchPoeVoltageFailure, bmSwitchSfp=bmSwitchSfp, sfpEvent=sfpEvent, internalMgmtWarning=internalMgmtWarning, adminReset=adminReset, sfpInfoRevisionNumber=sfpInfoRevisionNumber, portErrorCountFailure=portErrorCountFailure, portPrioDot1p=portPrioDot1p, sfpInfoLength50um=sfpInfoLength50um, infoAlarmStateM1=infoAlarmStateM1, radiusMgmtAuthReject=radiusMgmtAuthReject, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, infoType=infoType, bmSwitchVlan=bmSwitchVlan, sfpDiagTemperature=sfpDiagTemperature, adminUnsecureVlanId=adminUnsecureVlanId, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, adminAgentVlanId=adminAgentVlanId, infoTemperature=infoTemperature, adminAgentPrioValue=adminAgentPrioValue, bmSwitchInfo=bmSwitchInfo, adminMgmtAccessList=adminMgmtAccessList, adminFunctionInputNameF1=adminFunctionInputNameF1, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, infoTotalConfigChanges=infoTotalConfigChanges, sfpInfoDateCode=sfpInfoDateCode, bmSwitchMIB=bmSwitchMIB, portTrunkingMode=portTrunkingMode, adminLedGlobalMode=adminLedGlobalMode, portLinkState=portLinkState, portDefaultVlanId=portDefaultVlanId, portAcApSetup=portAcApSetup, sfpInfoVendorName=sfpInfoVendorName, portBandwidthLimitTxd=portBandwidthLimitTxd, portSecurityMacAddr3=portSecurityMacAddr3, clientRemoved=clientRemoved, sfpInfoLength9um=sfpInfoLength9um, portPoeOverloadFailure=portPoeOverloadFailure, sfpPortIndex=sfpPortIndex, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, bmSwitchAdmin=bmSwitchAdmin, portLinkType=portLinkType, infoUnauthIpAddr=infoUnauthIpAddr, infoNoOfPorts=infoNoOfPorts, adminAlarmNameM1=adminAlarmNameM1, vlanId=vlanId, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, sfpState=sfpState, portDefaultPrioQueue=portDefaultPrioQueue, adminAgentPhysAddress=adminAgentPhysAddress, adminMemoryCardMode=adminMemoryCardMode, switchPoeOverloadFailure=switchPoeOverloadFailure, portBandwidthLimitRxd=portBandwidthLimitRxd, portLEDGreen=portLEDGreen, portPoePowerLimit=portPoePowerLimit, infoLastTftpMessage=infoLastTftpMessage, portPoeAdminState=portPoeAdminState, portLEDYellow=portLEDYellow, sfpInfoPartNumber=sfpInfoPartNumber, infoManufactureDate=infoManufactureDate, switchMgmtAuthFailure=switchMgmtAuthFailure, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, infoNoOfReboots=infoNoOfReboots, switchTemperatureFailure=switchTemperatureFailure, adminAgentDhcp=adminAgentDhcp, vlanDescr=vlanDescr, infoAlarmStateM2=infoAlarmStateM2, portNewMacAddress=portNewMacAddress, adminAlarmNameM2=adminAlarmNameM2, bmSwitchPortTable=bmSwitchPortTable, switchIndustrialAlarmM1=switchIndustrialAlarmM1, portDescr=portDescr, portSecurityAdminState=portSecurityAdminState, portSecurityFailure=portSecurityFailure, sfpInfoBitRate=sfpInfoBitRate, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, infoFunctionInputStateF1=infoFunctionInputStateF1, portName=portName, portErrorDisabled=portErrorDisabled, adminTftpAccess=adminTftpAccess, infoPoeInputPower=infoPoeInputPower, portSecurityMacAddr1=portSecurityMacAddr1, portPoePower=portPoePower, sfpInfoConnectorDescr=sfpInfoConnectorDescr, tftpMessage=tftpMessage, bmSwitchVlanEntry=bmSwitchVlanEntry, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, portLinkChange=portLinkChange, sfpInfoSerialNumber=sfpInfoSerialNumber, portLimiterPacketType=portLimiterPacketType, infoSecurityFailMacAddr=infoSecurityFailMacAddr, adminSwitchVlanTableMode=adminSwitchVlanTableMode, vlanIndex=vlanIndex, portSecurityForwardingState=portSecurityForwardingState, infoSerie=infoSerie, adminSnmpMacTableMode=adminSnmpMacTableMode, portVoiceVlanId=portVoiceVlanId, adminSwitchPortMirror=adminSwitchPortMirror, portErrorCounter=portErrorCounter, sfpInfoWavelength=sfpInfoWavelength, adminAlarmM1=adminAlarmM1, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, portPoeCurrent=portPoeCurrent, switchConfigurationChanged=switchConfigurationChanged, infoSwitchHardwareVersion=infoSwitchHardwareVersion, bmSwitchPort=bmSwitchPort, bmSwitchPortEntry=bmSwitchPortEntry, switchFunctionInputAlarm=switchFunctionInputAlarm, infoPowerVoltage2500=infoPowerVoltage2500, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, bmSwitchVlanTable=bmSwitchVlanTable, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, infoSeriesNo=infoSeriesNo, infoProductNo=infoProductNo, portPrioIp=portPrioIp, adminAlarmM2=adminAlarmM2, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, adminAgentNetmask=adminAgentNetmask, infoDescr=infoDescr, infoPoeInputVoltage=infoPoeInputVoltage, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, radiusPortSecurityReject=radiusPortSecurityReject, adminAgentIpAddress=adminAgentIpAddress, bmTraps=bmTraps, infoLastSfpEventMessage=infoLastSfpEventMessage, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, portIndex=portIndex, portSecurityMacAddr2=portSecurityMacAddr2, infoNewMacAddr=infoNewMacAddr, bmSwitchSfpTable=bmSwitchSfpTable, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, infoMgmtHardwareVersion=infoMgmtHardwareVersion, PYSNMP_MODULE_ID=bmSwitchMIB, switchInternalVoltageFailure=switchInternalVoltageFailure, portPoeVoltage=portPoeVoltage, portRemoteFault=portRemoteFault, sfpDiagRxIntputPower=sfpDiagRxIntputPower, sfpInfoLength62um=sfpInfoLength62um)
