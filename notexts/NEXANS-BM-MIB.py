...
mibBuilder.exportSymbols("NEXANS-BM-MIB", infoNoOfPorts=infoNoOfPorts, portLoopBcastFailure=portLoopBcastFailure, portLEDGreen=portLEDGreen, sfpInfoRevisionNumber=sfpInfoRevisionNumber, sfpInfoSerialNumber=sfpInfoSerialNumber, infoTotalConfigChanges=infoTotalConfigChanges, adminAgentVlanId=adminAgentVlanId, infoDescr=infoDescr, portPoePowerLimit=portPoePowerLimit, adminAgentPrioValue=adminAgentPrioValue, sfpDiagTemperature=sfpDiagTemperature, infoAlarmStateM2=infoAlarmStateM2, portVoiceVlanId=portVoiceVlanId, radiusPortSecurityReject=radiusPortSecurityReject, infoManufactureDate=infoManufactureDate, bmSwitchInfo=bmSwitchInfo, portPrioIp=portPrioIp, adminAgentIpAddress=adminAgentIpAddress, portSpeedDuplexSetup=portSpeedDuplexSetup, portSecurityForwardingState=portSecurityForwardingState, sfpInfoBitRate=sfpInfoBitRate, portLEDYellow=portLEDYellow, internalMgmtWarning=internalMgmtWarning, bmSwitchPortTable=bmSwitchPortTable, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, adminAgentPhysAddress=adminAgentPhysAddress, adminAlarmM2=adminAlarmM2, sfpInfoPartNumber=sfpInfoPartNumber, sfpEvent=sfpEvent, switchPoeVoltageFailure=switchPoeVoltageFailure, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, portAdminState=portAdminState, infoNoOfReboots=infoNoOfReboots, infoSecurityFailMacAddr=infoSecurityFailMacAddr, sfpDiagRxIntputPower=sfpDiagRxIntputPower, clientRemoved=clientRemoved, portLimiterPacketType=portLimiterPacketType, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, portDefaultVlanId=portDefaultVlanId, PYSNMP_MODULE_ID=bmSwitchMIB, infoLastTftpMessage=infoLastTftpMessage, portNewMacAddress=portNewMacAddress, sfpDiagTxOutputPower=sfpDiagTxOutputPower, portPoeAdminState=portPoeAdminState, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, switchMgmtAuthFailure=switchMgmtAuthFailure, switchConfigurationChanged=switchConfigurationChanged, portRemoteFault=portRemoteFault, portPrioDot1p=portPrioDot1p, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, portSecurityAdminState=portSecurityAdminState, infoPoeInputVoltage=infoPoeInputVoltage, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, bmTraps=bmTraps, sfpInfoLength62um=sfpInfoLength62um, infoSerie=infoSerie, sfpInfoLength50um=sfpInfoLength50um, portPoeVoltage=portPoeVoltage, adminReset=adminReset, adminAlarmM1=adminAlarmM1, infoFunctionInputStateF1=infoFunctionInputStateF1, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, portLinkType=portLinkType, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, portAcApSetup=portAcApSetup, bmSwitchMIB=bmSwitchMIB, vlanDescr=vlanDescr, bmSwitchPortEntry=bmSwitchPortEntry, portPoePower=portPoePower, portLinkChange=portLinkChange, adminSwitchPortMirror=adminSwitchPortMirror, portSecurityMacAddr1=portSecurityMacAddr1, infoType=infoType, sfpInfoVendorName=sfpInfoVendorName, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, bmSwitchAdmin=bmSwitchAdmin, portSecurityFailure=portSecurityFailure, vlanId=vlanId, infoSwitchHardwareVersion=infoSwitchHardwareVersion, portDescr=portDescr, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, switchTemperatureFailure=switchTemperatureFailure, sfpInfoConnectorDescr=sfpInfoConnectorDescr, bmSwitchVlan=bmSwitchVlan, adminUnsecureVlanId=adminUnsecureVlanId, adminAlarmNameM2=adminAlarmNameM2, portSecurityMacAddr2=portSecurityMacAddr2, sfpInfoLength9um=sfpInfoLength9um, sfpInfoWavelength=sfpInfoWavelength, portTrunkingMode=portTrunkingMode, adminMemoryCardMode=adminMemoryCardMode, portErrorCounter=portErrorCounter, portSecurityMacAddr3=portSecurityMacAddr3, bmSwitchVlanEntry=bmSwitchVlanEntry, adminAlarmNameM1=adminAlarmNameM1, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, infoProductNo=infoProductNo, adminAgentDhcp=adminAgentDhcp, radiusMgmtAuthReject=radiusMgmtAuthReject, bmSwitchSfpEntry=bmSwitchSfpEntry, adminAgentNetmask=adminAgentNetmask, switchIndustrialAlarmM2=switchIndustrialAlarmM2, adminSwitchVlanTableMode=adminSwitchVlanTableMode, tftpMessage=tftpMessage, adminMgmtAccessList=adminMgmtAccessList, sfpInfoDateCode=sfpInfoDateCode, infoPowerVoltage3300=infoPowerVoltage3300, infoPoeInputPower=infoPoeInputPower, sfpPortIndex=sfpPortIndex, bmSwitchSfp=bmSwitchSfp, switchIndustrialAlarmM1=switchIndustrialAlarmM1, adminLedGlobalMode=adminLedGlobalMode, portName=portName, infoMgmtHardwareVersion=infoMgmtHardwareVersion, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, infoLastSfpEventMessage=infoLastSfpEventMessage, portErrorDisabled=portErrorDisabled, vlanIndex=vlanIndex, infoUnauthIpAddr=infoUnauthIpAddr, portDefaultPrioQueue=portDefaultPrioQueue, sfpState=sfpState, bmSwitchPort=bmSwitchPort, portPoeCurrent=portPoeCurrent, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, switchPoeOverloadFailure=switchPoeOverloadFailure, infoPowerVoltage2500=infoPowerVoltage2500, infoAlarmStateM1=infoAlarmStateM1, bmSwitchVlanTable=bmSwitchVlanTable, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, infoNewMacAddr=infoNewMacAddr, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, adminSnmpMacTableMode=adminSnmpMacTableMode, bmSwitchSfpTable=bmSwitchSfpTable, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, infoSeriesNo=infoSeriesNo, portBandwidthLimitRxd=portBandwidthLimitRxd, adminTftpAccess=adminTftpAccess, portLinkState=portLinkState, switchFunctionInputAlarm=switchFunctionInputAlarm, adminFunctionInputNameF1=adminFunctionInputNameF1, infoTemperature=infoTemperature, portBandwidthLimitTxd=portBandwidthLimitTxd, portPoeOverloadFailure=portPoeOverloadFailure, portIndex=portIndex, switchInternalVoltageFailure=switchInternalVoltageFailure, portErrorCountFailure=portErrorCountFailure)
