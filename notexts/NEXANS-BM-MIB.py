...
mibBuilder.exportSymbols("NEXANS-BM-MIB", sfpInfoConnectorDescr=sfpInfoConnectorDescr, bmSwitchVlan=bmSwitchVlan, bmSwitchVlanTable=bmSwitchVlanTable, portDefaultPrioQueue=portDefaultPrioQueue, switchIndustrialAlarmM1=switchIndustrialAlarmM1, switchMgmtAuthFailure=switchMgmtAuthFailure, portRemoteFault=portRemoteFault, adminAlarmNameM2=adminAlarmNameM2, infoTemperature=infoTemperature, bmSwitchSfpEntry=bmSwitchSfpEntry, adminAlarmM2=adminAlarmM2, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, switchPoeOverloadFailure=switchPoeOverloadFailure, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, portAdminState=portAdminState, sfpInfoVendorName=sfpInfoVendorName, bmSwitchAdmin=bmSwitchAdmin, adminTftpAccess=adminTftpAccess, sfpInfoRevisionNumber=sfpInfoRevisionNumber, adminLedGlobalMode=adminLedGlobalMode, clientRemoved=clientRemoved, switchFunctionInputAlarm=switchFunctionInputAlarm, adminMemoryCardMode=adminMemoryCardMode, PYSNMP_MODULE_ID=bmSwitchMIB, adminMgmtAccessList=adminMgmtAccessList, adminAlarmM1=adminAlarmM1, switchConfigurationChanged=switchConfigurationChanged, portName=portName, portPoePowerLimit=portPoePowerLimit, adminUnsecureVlanId=adminUnsecureVlanId, adminAgentPhysAddress=adminAgentPhysAddress, vlanId=vlanId, portSecurityForwardingState=portSecurityForwardingState, infoAlarmStateM1=infoAlarmStateM1, portPrioIp=portPrioIp, sfpEvent=sfpEvent, sfpDiagTemperature=sfpDiagTemperature, adminAlarmNameM1=adminAlarmNameM1, infoNoOfPorts=infoNoOfPorts, infoPoeInputVoltage=infoPoeInputVoltage, portSecurityMacAddr1=portSecurityMacAddr1, sfpPortIndex=sfpPortIndex, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, adminSwitchVlanTableMode=adminSwitchVlanTableMode, adminFunctionInputNameF1=adminFunctionInputNameF1, portDescr=portDescr, portSecurityFailure=portSecurityFailure, portIndex=portIndex, bmSwitchInfo=bmSwitchInfo, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, adminReset=adminReset, portLEDGreen=portLEDGreen, adminAgentDhcp=adminAgentDhcp, infoSeriesNo=infoSeriesNo, adminAgentPrioValue=adminAgentPrioValue, portSecurityAdminState=portSecurityAdminState, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, tftpMessage=tftpMessage, bmTraps=bmTraps, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, infoMgmtHardwareVersion=infoMgmtHardwareVersion, sfpInfoDateCode=sfpInfoDateCode, bmSwitchVlanEntry=bmSwitchVlanEntry, infoTotalConfigChanges=infoTotalConfigChanges, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, sfpInfoSerialNumber=sfpInfoSerialNumber, bmSwitchSfp=bmSwitchSfp, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, bmSwitchPortTable=bmSwitchPortTable, bmSwitchPortEntry=bmSwitchPortEntry, infoSwitchHardwareVersion=infoSwitchHardwareVersion, sfpInfoBitRate=sfpInfoBitRate, sfpInfoLength9um=sfpInfoLength9um, portPoeVoltage=portPoeVoltage, switchTemperatureFailure=switchTemperatureFailure, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, infoSerie=infoSerie, sfpState=sfpState, sfpDiagRxIntputPower=sfpDiagRxIntputPower, adminAgentNetmask=adminAgentNetmask, infoPowerVoltage3300=infoPowerVoltage3300, portLEDYellow=portLEDYellow, sfpInfoWavelength=sfpInfoWavelength, sfpInfoLength50um=sfpInfoLength50um, infoProductNo=infoProductNo, infoNewMacAddr=infoNewMacAddr, sfpInfoPartNumber=sfpInfoPartNumber, infoType=infoType, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, infoAlarmStateM2=infoAlarmStateM2, portLimiterPacketType=portLimiterPacketType, portBandwidthLimitRxd=portBandwidthLimitRxd, portLinkChange=portLinkChange, portLinkState=portLinkState, portErrorCounter=portErrorCounter, internalMgmtWarning=internalMgmtWarning, portAcApSetup=portAcApSetup, portPoeOverloadFailure=portPoeOverloadFailure, portSecurityMacAddr2=portSecurityMacAddr2, sfpInfoLength62um=sfpInfoLength62um, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, adminSnmpMacTableMode=adminSnmpMacTableMode, switchPoeVoltageFailure=switchPoeVoltageFailure, portSpeedDuplexSetup=portSpeedDuplexSetup, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, portNewMacAddress=portNewMacAddress, sfpDiagTxOutputPower=sfpDiagTxOutputPower, infoManufactureDate=infoManufactureDate, portTrunkingMode=portTrunkingMode, infoNoOfReboots=infoNoOfReboots, portVoiceVlanId=portVoiceVlanId, infoSecurityFailMacAddr=infoSecurityFailMacAddr, portSecurityMacAddr3=portSecurityMacAddr3, portLinkType=portLinkType, infoFunctionInputStateF1=infoFunctionInputStateF1, infoUnauthIpAddr=infoUnauthIpAddr, portLoopBcastFailure=portLoopBcastFailure, portErrorCountFailure=portErrorCountFailure, infoLastSfpEventMessage=infoLastSfpEventMessage, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, portDefaultVlanId=portDefaultVlanId, vlanIndex=vlanIndex, radiusMgmtAuthReject=radiusMgmtAuthReject, infoPowerVoltage2500=infoPowerVoltage2500, portPrioDot1p=portPrioDot1p, adminAgentIpAddress=adminAgentIpAddress, vlanDescr=vlanDescr, infoDescr=infoDescr, portPoeAdminState=portPoeAdminState, infoLastTftpMessage=infoLastTftpMessage, infoPoeInputPower=infoPoeInputPower, adminSwitchPortMirror=adminSwitchPortMirror, portBandwidthLimitTxd=portBandwidthLimitTxd, portPoeCurrent=portPoeCurrent, portErrorDisabled=portErrorDisabled, adminAgentVlanId=adminAgentVlanId, radiusPortSecurityReject=radiusPortSecurityReject, bmSwitchPort=bmSwitchPort, bmSwitchSfpTable=bmSwitchSfpTable, switchInternalVoltageFailure=switchInternalVoltageFailure, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, portPoePower=portPoePower, switchIndustrialAlarmM2=switchIndustrialAlarmM2, bmSwitchMIB=bmSwitchMIB)
