...
mibBuilder.exportSymbols("NEXANS-BM-MIB", portSpeedDuplexSetup=portSpeedDuplexSetup, bmSwitchAdmin=bmSwitchAdmin, portRemoteFault=portRemoteFault, infoSecurityFailMacAddr=infoSecurityFailMacAddr, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, portLinkType=portLinkType, portSecurityFailure=portSecurityFailure, adminSwitchPortMirror=adminSwitchPortMirror, portErrorCountFailure=portErrorCountFailure, sfpInfoPartNumber=sfpInfoPartNumber, infoLastSfpEventMessage=infoLastSfpEventMessage, sfpDiagRxIntputPower=sfpDiagRxIntputPower, adminLedGlobalMode=adminLedGlobalMode, bmTraps=bmTraps, portSecurityAdminState=portSecurityAdminState, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, portSecurityMacAddr3=portSecurityMacAddr3, bmSwitchPortEntry=bmSwitchPortEntry, sfpInfoDateCode=sfpInfoDateCode, PYSNMP_MODULE_ID=bmSwitchMIB, portIndex=portIndex, adminAlarmM1=adminAlarmM1, portSecurityForwardingState=portSecurityForwardingState, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, infoPoeInputVoltage=infoPoeInputVoltage, bmSwitchVlanTable=bmSwitchVlanTable, sfpEvent=sfpEvent, adminAgentNetmask=adminAgentNetmask, adminAgentVlanId=adminAgentVlanId, portTrunkingMode=portTrunkingMode, sfpInfoConnectorDescr=sfpInfoConnectorDescr, adminAlarmM2=adminAlarmM2, infoProductNo=infoProductNo, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, infoPoeInputPower=infoPoeInputPower, adminAgentPhysAddress=adminAgentPhysAddress, infoUnauthIpAddr=infoUnauthIpAddr, adminMgmtAccessList=adminMgmtAccessList, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, sfpDiagTemperature=sfpDiagTemperature, portPoePower=portPoePower, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, infoFunctionInputStateF1=infoFunctionInputStateF1, sfpPortIndex=sfpPortIndex, portPoeCurrent=portPoeCurrent, infoMgmtHardwareVersion=infoMgmtHardwareVersion, infoNoOfPorts=infoNoOfPorts, portSecurityMacAddr2=portSecurityMacAddr2, internalMgmtWarning=internalMgmtWarning, sfpInfoBitRate=sfpInfoBitRate, portErrorDisabled=portErrorDisabled, infoPowerVoltage3300=infoPowerVoltage3300, infoPowerVoltage2500=infoPowerVoltage2500, sfpInfoVendorName=sfpInfoVendorName, switchTemperatureFailure=switchTemperatureFailure, portPoeOverloadFailure=portPoeOverloadFailure, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, portPoeVoltage=portPoeVoltage, radiusMgmtAuthReject=radiusMgmtAuthReject, portDescr=portDescr, vlanId=vlanId, infoAlarmStateM2=infoAlarmStateM2, sfpInfoLength9um=sfpInfoLength9um, sfpInfoLength50um=sfpInfoLength50um, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, clientRemoved=clientRemoved, portLEDGreen=portLEDGreen, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, sfpInfoSerialNumber=sfpInfoSerialNumber, bmSwitchInfo=bmSwitchInfo, bmSwitchVlan=bmSwitchVlan, adminAgentPrioValue=adminAgentPrioValue, portErrorCounter=portErrorCounter, portLEDYellow=portLEDYellow, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, infoSeriesNo=infoSeriesNo, adminReset=adminReset, bmSwitchSfpEntry=bmSwitchSfpEntry, infoSerie=infoSerie, infoType=infoType, portDefaultVlanId=portDefaultVlanId, portSecurityMacAddr1=portSecurityMacAddr1, portBandwidthLimitRxd=portBandwidthLimitRxd, bmSwitchSfpTable=bmSwitchSfpTable, sfpInfoWavelength=sfpInfoWavelength, portVoiceVlanId=portVoiceVlanId, adminAgentIpAddress=adminAgentIpAddress, switchIndustrialAlarmM2=switchIndustrialAlarmM2, bmSwitchPort=bmSwitchPort, portLinkState=portLinkState, vlanIndex=vlanIndex, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, switchFunctionInputAlarm=switchFunctionInputAlarm, portPoePowerLimit=portPoePowerLimit, infoTemperature=infoTemperature, infoAlarmStateM1=infoAlarmStateM1, infoManufactureDate=infoManufactureDate, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, sfpDiagTxOutputPower=sfpDiagTxOutputPower, adminAlarmNameM2=adminAlarmNameM2, switchInternalVoltageFailure=switchInternalVoltageFailure, bmSwitchSfp=bmSwitchSfp, portAdminState=portAdminState, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, switchPoeVoltageFailure=switchPoeVoltageFailure, adminAgentDhcp=adminAgentDhcp, infoTotalConfigChanges=infoTotalConfigChanges, switchIndustrialAlarmM1=switchIndustrialAlarmM1, adminSwitchVlanTableMode=adminSwitchVlanTableMode, portName=portName, infoNewMacAddr=infoNewMacAddr, infoNoOfReboots=infoNoOfReboots, infoSwitchHardwareVersion=infoSwitchHardwareVersion, adminTftpAccess=adminTftpAccess, portPrioIp=portPrioIp, portBandwidthLimitTxd=portBandwidthLimitTxd, switchConfigurationChanged=switchConfigurationChanged, sfpState=sfpState, adminAlarmNameM1=adminAlarmNameM1, switchMgmtAuthFailure=switchMgmtAuthFailure, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, portPoeAdminState=portPoeAdminState, bmSwitchMIB=bmSwitchMIB, infoDescr=infoDescr, switchPoeOverloadFailure=switchPoeOverloadFailure, portLimiterPacketType=portLimiterPacketType, sfpInfoLength62um=sfpInfoLength62um, adminSnmpMacTableMode=adminSnmpMacTableMode, portLoopBcastFailure=portLoopBcastFailure, portAcApSetup=portAcApSetup, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, tftpMessage=tftpMessage, adminMemoryCardMode=adminMemoryCardMode, portDefaultPrioQueue=portDefaultPrioQueue, vlanDescr=vlanDescr, infoLastTftpMessage=infoLastTftpMessage, bmSwitchPortTable=bmSwitchPortTable, sfpInfoRevisionNumber=sfpInfoRevisionNumber, portNewMacAddress=portNewMacAddress, bmSwitchVlanEntry=bmSwitchVlanEntry, portPrioDot1p=portPrioDot1p, portLinkChange=portLinkChange, adminFunctionInputNameF1=adminFunctionInputNameF1, radiusPortSecurityReject=radiusPortSecurityReject, adminUnsecureVlanId=adminUnsecureVlanId)
