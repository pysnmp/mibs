...
mibBuilder.exportSymbols("NEXANS-BM-MIB", adminAgentVlanId=adminAgentVlanId, sfpInfoVendorName=sfpInfoVendorName, sfpInfoLength62um=sfpInfoLength62um, portDescr=portDescr, infoType=infoType, portSecurityForwardingState=portSecurityForwardingState, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, portLEDGreen=portLEDGreen, portSecurityMacAddr3=portSecurityMacAddr3, adminSwitchVlanTableMode=adminSwitchVlanTableMode, portIndex=portIndex, vlanIndex=vlanIndex, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, sfpInfoSerialNumber=sfpInfoSerialNumber, infoMgmtHardwareVersion=infoMgmtHardwareVersion, infoPowerVoltage3300=infoPowerVoltage3300, infoAlarmStateM2=infoAlarmStateM2, bmSwitchPortTable=bmSwitchPortTable, radiusMgmtAuthReject=radiusMgmtAuthReject, adminUnsecureVlanId=adminUnsecureVlanId, portRemoteFault=portRemoteFault, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, portDefaultVlanId=portDefaultVlanId, infoManufactureDate=infoManufactureDate, infoNewMacAddr=infoNewMacAddr, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, sfpInfoBitRate=sfpInfoBitRate, vlanDescr=vlanDescr, portPoeVoltage=portPoeVoltage, vlanId=vlanId, portNewMacAddress=portNewMacAddress, switchPoeOverloadFailure=switchPoeOverloadFailure, portName=portName, portPrioDot1p=portPrioDot1p, bmSwitchSfpEntry=bmSwitchSfpEntry, switchTemperatureFailure=switchTemperatureFailure, bmSwitchVlan=bmSwitchVlan, switchMgmtAuthFailure=switchMgmtAuthFailure, bmTraps=bmTraps, bmSwitchSfp=bmSwitchSfp, portLinkState=portLinkState, portPrioIp=portPrioIp, bmSwitchInfo=bmSwitchInfo, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, portBandwidthLimitRxd=portBandwidthLimitRxd, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, portLimiterPacketType=portLimiterPacketType, bmSwitchVlanTable=bmSwitchVlanTable, infoDescr=infoDescr, switchInternalVoltageFailure=switchInternalVoltageFailure, switchFunctionInputAlarm=switchFunctionInputAlarm, adminSnmpMacTableMode=adminSnmpMacTableMode, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, switchPoeVoltageFailure=switchPoeVoltageFailure, adminAlarmNameM2=adminAlarmNameM2, bmSwitchAdmin=bmSwitchAdmin, adminAlarmM1=adminAlarmM1, portPoeOverloadFailure=portPoeOverloadFailure, infoPoeInputVoltage=infoPoeInputVoltage, portBandwidthLimitTxd=portBandwidthLimitTxd, infoSwitchHardwareVersion=infoSwitchHardwareVersion, bmSwitchSfpTable=bmSwitchSfpTable, adminAgentNetmask=adminAgentNetmask, portSpeedDuplexSetup=portSpeedDuplexSetup, infoAlarmStateM1=infoAlarmStateM1, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, switchConfigurationChanged=switchConfigurationChanged, adminReset=adminReset, portErrorCounter=portErrorCounter, infoSecurityFailMacAddr=infoSecurityFailMacAddr, portErrorCountFailure=portErrorCountFailure, infoNoOfReboots=infoNoOfReboots, portAdminState=portAdminState, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, portDefaultPrioQueue=portDefaultPrioQueue, portVoiceVlanId=portVoiceVlanId, adminTftpAccess=adminTftpAccess, adminAgentPrioValue=adminAgentPrioValue, infoFunctionInputStateF1=infoFunctionInputStateF1, sfpDiagRxIntputPower=sfpDiagRxIntputPower, infoLastSfpEventMessage=infoLastSfpEventMessage, portPoeAdminState=portPoeAdminState, adminSwitchPortMirror=adminSwitchPortMirror, portSecurityMacAddr1=portSecurityMacAddr1, clientRemoved=clientRemoved, portTrunkingMode=portTrunkingMode, adminAgentDhcp=adminAgentDhcp, adminAlarmNameM1=adminAlarmNameM1, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, adminFunctionInputNameF1=adminFunctionInputNameF1, adminLedGlobalMode=adminLedGlobalMode, bmSwitchVlanEntry=bmSwitchVlanEntry, portLEDYellow=portLEDYellow, infoLastTftpMessage=infoLastTftpMessage, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, infoUnauthIpAddr=infoUnauthIpAddr, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, infoTemperature=infoTemperature, sfpPortIndex=sfpPortIndex, portPoePower=portPoePower, sfpInfoPartNumber=sfpInfoPartNumber, internalMgmtWarning=internalMgmtWarning, sfpInfoDateCode=sfpInfoDateCode, infoPowerVoltage2500=infoPowerVoltage2500, infoPoeInputPower=infoPoeInputPower, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, sfpDiagTemperature=sfpDiagTemperature, portPoeCurrent=portPoeCurrent, switchIndustrialAlarmM2=switchIndustrialAlarmM2, sfpInfoWavelength=sfpInfoWavelength, bmSwitchPort=bmSwitchPort, sfpState=sfpState, portLoopBcastFailure=portLoopBcastFailure, bmSwitchMIB=bmSwitchMIB, portLinkType=portLinkType, portSecurityFailure=portSecurityFailure, radiusPortSecurityReject=radiusPortSecurityReject, portLinkChange=portLinkChange, adminAgentIpAddress=adminAgentIpAddress, portErrorDisabled=portErrorDisabled, switchIndustrialAlarmM1=switchIndustrialAlarmM1, sfpEvent=sfpEvent, adminMemoryCardMode=adminMemoryCardMode, infoProductNo=infoProductNo, adminAgentPhysAddress=adminAgentPhysAddress, portSecurityAdminState=portSecurityAdminState, infoSeriesNo=infoSeriesNo, portPoePowerLimit=portPoePowerLimit, bmSwitchPortEntry=bmSwitchPortEntry, sfpInfoRevisionNumber=sfpInfoRevisionNumber, tftpMessage=tftpMessage, infoTotalConfigChanges=infoTotalConfigChanges, infoNoOfPorts=infoNoOfPorts, sfpInfoLength50um=sfpInfoLength50um, adminAlarmM2=adminAlarmM2, portSecurityMacAddr2=portSecurityMacAddr2, portAcApSetup=portAcApSetup, PYSNMP_MODULE_ID=bmSwitchMIB, sfpInfoLength9um=sfpInfoLength9um, infoSerie=infoSerie, adminMgmtAccessList=adminMgmtAccessList, sfpDiagTxOutputPower=sfpDiagTxOutputPower, sfpInfoConnectorDescr=sfpInfoConnectorDescr, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed)
