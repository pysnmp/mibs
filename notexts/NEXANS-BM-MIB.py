...
mibBuilder.exportSymbols("NEXANS-BM-MIB", bmSwitchVlan=bmSwitchVlan, portPoeCurrent=portPoeCurrent, portSecurityMacAddr1=portSecurityMacAddr1, portErrorCountFailure=portErrorCountFailure, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, portSecurityForwardingState=portSecurityForwardingState, sfpInfoConnectorDescr=sfpInfoConnectorDescr, portAdminState=portAdminState, portErrorDisabled=portErrorDisabled, radiusPortSecurityReject=radiusPortSecurityReject, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, bmSwitchAdmin=bmSwitchAdmin, bmSwitchInfo=bmSwitchInfo, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, infoDescr=infoDescr, portSecurityFailure=portSecurityFailure, adminAgentIpAddress=adminAgentIpAddress, infoProductNo=infoProductNo, clientRemoved=clientRemoved, adminSwitchPortMirror=adminSwitchPortMirror, adminSnmpMacTableMode=adminSnmpMacTableMode, bmSwitchSfpEntry=bmSwitchSfpEntry, infoSwitchHardwareVersion=infoSwitchHardwareVersion, portNewMacAddress=portNewMacAddress, adminUnsecureVlanId=adminUnsecureVlanId, switchTemperatureFailure=switchTemperatureFailure, infoUnauthIpAddr=infoUnauthIpAddr, adminAgentPrioValue=adminAgentPrioValue, bmSwitchPortEntry=bmSwitchPortEntry, infoSecurityFailMacAddr=infoSecurityFailMacAddr, sfpInfoWavelength=sfpInfoWavelength, portLinkState=portLinkState, infoFunctionInputStateF1=infoFunctionInputStateF1, switchIndustrialAlarmM2=switchIndustrialAlarmM2, infoMgmtHardwareVersion=infoMgmtHardwareVersion, portLinkType=portLinkType, portSecurityMacAddr2=portSecurityMacAddr2, adminMemoryCardMode=adminMemoryCardMode, portPoeAdminState=portPoeAdminState, sfpInfoVendorName=sfpInfoVendorName, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, infoPoeInputPower=infoPoeInputPower, sfpEvent=sfpEvent, infoTemperature=infoTemperature, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, infoPowerVoltage2500=infoPowerVoltage2500, adminSwitchVlanTableMode=adminSwitchVlanTableMode, PYSNMP_MODULE_ID=bmSwitchMIB, adminReset=adminReset, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, sfpInfoLength62um=sfpInfoLength62um, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, switchInternalVoltageFailure=switchInternalVoltageFailure, adminLedGlobalMode=adminLedGlobalMode, sfpState=sfpState, portIndex=portIndex, sfpDiagTxOutputPower=sfpDiagTxOutputPower, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, tftpMessage=tftpMessage, adminAlarmM2=adminAlarmM2, sfpInfoDateCode=sfpInfoDateCode, adminAgentPhysAddress=adminAgentPhysAddress, portRemoteFault=portRemoteFault, portPoeVoltage=portPoeVoltage, portPoePower=portPoePower, portPrioDot1p=portPrioDot1p, sfpDiagTemperature=sfpDiagTemperature, portErrorCounter=portErrorCounter, bmSwitchPort=bmSwitchPort, portVoiceVlanId=portVoiceVlanId, sfpInfoSerialNumber=sfpInfoSerialNumber, infoPoeInputVoltage=infoPoeInputVoltage, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, vlanDescr=vlanDescr, portBandwidthLimitTxd=portBandwidthLimitTxd, switchConfigurationChanged=switchConfigurationChanged, infoAlarmStateM2=infoAlarmStateM2, adminAlarmNameM2=adminAlarmNameM2, adminAlarmNameM1=adminAlarmNameM1, portPoePowerLimit=portPoePowerLimit, bmSwitchVlanTable=bmSwitchVlanTable, infoNoOfPorts=infoNoOfPorts, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, bmTraps=bmTraps, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, portSecurityAdminState=portSecurityAdminState, portDefaultPrioQueue=portDefaultPrioQueue, sfpInfoBitRate=sfpInfoBitRate, switchPoeOverloadFailure=switchPoeOverloadFailure, portPrioIp=portPrioIp, portTrunkingMode=portTrunkingMode, infoPowerVoltage3300=infoPowerVoltage3300, infoLastTftpMessage=infoLastTftpMessage, sfpInfoLength9um=sfpInfoLength9um, infoAlarmStateM1=infoAlarmStateM1, switchMgmtAuthFailure=switchMgmtAuthFailure, sfpPortIndex=sfpPortIndex, portLinkChange=portLinkChange, infoLastSfpEventMessage=infoLastSfpEventMessage, infoNoOfReboots=infoNoOfReboots, switchPoeVoltageFailure=switchPoeVoltageFailure, adminTftpAccess=adminTftpAccess, switchIndustrialAlarmM1=switchIndustrialAlarmM1, radiusMgmtAuthReject=radiusMgmtAuthReject, portPoeOverloadFailure=portPoeOverloadFailure, infoType=infoType, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, portDescr=portDescr, portDefaultVlanId=portDefaultVlanId, sfpInfoLength50um=sfpInfoLength50um, portLimiterPacketType=portLimiterPacketType, adminAgentNetmask=adminAgentNetmask, internalMgmtWarning=internalMgmtWarning, portSecurityMacAddr3=portSecurityMacAddr3, sfpInfoPartNumber=sfpInfoPartNumber, bmSwitchSfp=bmSwitchSfp, bmSwitchSfpTable=bmSwitchSfpTable, portSpeedDuplexSetup=portSpeedDuplexSetup, infoNewMacAddr=infoNewMacAddr, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, adminMgmtAccessList=adminMgmtAccessList, adminAgentVlanId=adminAgentVlanId, portLoopBcastFailure=portLoopBcastFailure, portLEDGreen=portLEDGreen, infoTotalConfigChanges=infoTotalConfigChanges, portName=portName, bmSwitchVlanEntry=bmSwitchVlanEntry, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, sfpDiagRxIntputPower=sfpDiagRxIntputPower, bmSwitchMIB=bmSwitchMIB, portLEDYellow=portLEDYellow, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, adminAlarmM1=adminAlarmM1, adminFunctionInputNameF1=adminFunctionInputNameF1, adminAgentDhcp=adminAgentDhcp, infoSeriesNo=infoSeriesNo, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, portAcApSetup=portAcApSetup, vlanIndex=vlanIndex, vlanId=vlanId, infoSerie=infoSerie, sfpInfoRevisionNumber=sfpInfoRevisionNumber, infoManufactureDate=infoManufactureDate, bmSwitchPortTable=bmSwitchPortTable, portBandwidthLimitRxd=portBandwidthLimitRxd, switchFunctionInputAlarm=switchFunctionInputAlarm)
