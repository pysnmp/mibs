...
mibBuilder.exportSymbols("NEXANS-BM-MIB", infoType=infoType, sfpInfoLength50um=sfpInfoLength50um, adminTftpAccess=adminTftpAccess, infoSecurityFailMacAddr=infoSecurityFailMacAddr, sfpDiagRxIntputPower=sfpDiagRxIntputPower, switchMgmtAuthFailure=switchMgmtAuthFailure, portPoePowerLimit=portPoePowerLimit, infoProductNo=infoProductNo, portLinkChange=portLinkChange, infoLastTftpMessage=infoLastTftpMessage, switchIndustrialAlarmM1=switchIndustrialAlarmM1, bmTraps=bmTraps, infoPoeInputVoltage=infoPoeInputVoltage, radiusMgmtAuthReject=radiusMgmtAuthReject, infoLastSfpEventMessage=infoLastSfpEventMessage, switchFunctionInputAlarm=switchFunctionInputAlarm, portSecurityFailure=portSecurityFailure, internalMgmtWarning=internalMgmtWarning, adminFunctionInputNameF1=adminFunctionInputNameF1, portLimiterPacketType=portLimiterPacketType, portSecurityMacAddr2=portSecurityMacAddr2, sfpDiagTxOutputPower=sfpDiagTxOutputPower, adminAgentDhcp=adminAgentDhcp, adminAlarmNameM1=adminAlarmNameM1, adminMemoryCardMode=adminMemoryCardMode, bmSwitchVlanTable=bmSwitchVlanTable, infoFunctionInputStateF1=infoFunctionInputStateF1, bmSwitchMIB=bmSwitchMIB, adminReset=adminReset, bmSwitchVlan=bmSwitchVlan, portSecurityMacAddr1=portSecurityMacAddr1, portNewMacAddress=portNewMacAddress, portLinkState=portLinkState, bmSwitchSfpTable=bmSwitchSfpTable, portDescr=portDescr, bmSwitchInfo=bmSwitchInfo, bmSwitchPortTable=bmSwitchPortTable, switchConfigurationChanged=switchConfigurationChanged, portAdminState=portAdminState, infoTemperature=infoTemperature, adminSwitchVlanTableMode=adminSwitchVlanTableMode, portLEDGreen=portLEDGreen, infoPoeInputPower=infoPoeInputPower, infoNewMacAddr=infoNewMacAddr, portPoeOverloadFailure=portPoeOverloadFailure, bmSwitchPortEntry=bmSwitchPortEntry, infoTotalConfigChanges=infoTotalConfigChanges, sfpInfoRevisionNumber=sfpInfoRevisionNumber, portName=portName, adminLedGlobalMode=adminLedGlobalMode, portSecurityMacAddr3=portSecurityMacAddr3, vlanIndex=vlanIndex, tftpMessage=tftpMessage, portAcApSetup=portAcApSetup, portErrorDisabled=portErrorDisabled, adminAlarmNameM2=adminAlarmNameM2, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, bmSwitchAdmin=bmSwitchAdmin, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, infoNoOfReboots=infoNoOfReboots, portBandwidthLimitTxd=portBandwidthLimitTxd, bmSwitchPort=bmSwitchPort, portSecurityAdminState=portSecurityAdminState, sfpInfoSerialNumber=sfpInfoSerialNumber, infoDescr=infoDescr, portPrioDot1p=portPrioDot1p, adminAgentPhysAddress=adminAgentPhysAddress, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, portVoiceVlanId=portVoiceVlanId, switchTemperatureFailure=switchTemperatureFailure, sfpInfoLength9um=sfpInfoLength9um, switchIndustrialAlarmM2=switchIndustrialAlarmM2, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, sfpInfoVendorName=sfpInfoVendorName, adminSnmpMacTableMode=adminSnmpMacTableMode, switchInternalVoltageFailure=switchInternalVoltageFailure, sfpEvent=sfpEvent, infoMgmtHardwareVersion=infoMgmtHardwareVersion, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, sfpDiagTemperature=sfpDiagTemperature, portPoeCurrent=portPoeCurrent, portDefaultVlanId=portDefaultVlanId, sfpInfoPartNumber=sfpInfoPartNumber, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, portLEDYellow=portLEDYellow, clientRemoved=clientRemoved, infoPowerVoltage3300=infoPowerVoltage3300, adminMgmtAccessList=adminMgmtAccessList, portPrioIp=portPrioIp, sfpPortIndex=sfpPortIndex, portPoeAdminState=portPoeAdminState, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, portLoopBcastFailure=portLoopBcastFailure, portErrorCounter=portErrorCounter, portDefaultPrioQueue=portDefaultPrioQueue, sfpInfoConnectorDescr=sfpInfoConnectorDescr, portTrunkingMode=portTrunkingMode, radiusPortSecurityReject=radiusPortSecurityReject, bmSwitchSfpEntry=bmSwitchSfpEntry, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, portBandwidthLimitRxd=portBandwidthLimitRxd, infoAlarmStateM1=infoAlarmStateM1, infoManufactureDate=infoManufactureDate, adminSwitchPortMirror=adminSwitchPortMirror, portPoePower=portPoePower, portRemoteFault=portRemoteFault, infoSerie=infoSerie, sfpInfoLength62um=sfpInfoLength62um, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, adminAgentNetmask=adminAgentNetmask, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, adminAgentIpAddress=adminAgentIpAddress, portPoeVoltage=portPoeVoltage, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, sfpInfoDateCode=sfpInfoDateCode, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, bmSwitchSfp=bmSwitchSfp, sfpInfoBitRate=sfpInfoBitRate, infoSeriesNo=infoSeriesNo, infoNoOfPorts=infoNoOfPorts, infoSwitchHardwareVersion=infoSwitchHardwareVersion, infoAlarmStateM2=infoAlarmStateM2, adminUnsecureVlanId=adminUnsecureVlanId, adminAgentVlanId=adminAgentVlanId, portSpeedDuplexSetup=portSpeedDuplexSetup, portSecurityForwardingState=portSecurityForwardingState, vlanDescr=vlanDescr, PYSNMP_MODULE_ID=bmSwitchMIB, portIndex=portIndex, vlanId=vlanId, switchPoeVoltageFailure=switchPoeVoltageFailure, portLinkType=portLinkType, adminAlarmM2=adminAlarmM2, switchPoeOverloadFailure=switchPoeOverloadFailure, adminAgentPrioValue=adminAgentPrioValue, adminAlarmM1=adminAlarmM1, bmSwitchVlanEntry=bmSwitchVlanEntry, infoPowerVoltage2500=infoPowerVoltage2500, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, sfpInfoWavelength=sfpInfoWavelength, infoUnauthIpAddr=infoUnauthIpAddr, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, portErrorCountFailure=portErrorCountFailure, sfpState=sfpState)
