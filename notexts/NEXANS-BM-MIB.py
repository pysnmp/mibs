...
mibBuilder.exportSymbols("NEXANS-BM-MIB", infoLastTftpMessage=infoLastTftpMessage, portDescr=portDescr, internalMgmtWarning=internalMgmtWarning, adminAlarmM1=adminAlarmM1, portDefaultPrioQueue=portDefaultPrioQueue, portLinkState=portLinkState, portDefaultVlanId=portDefaultVlanId, infoSecurityFailMacAddr=infoSecurityFailMacAddr, switchIndustrialAlarmM1=switchIndustrialAlarmM1, adminAgentDhcp=adminAgentDhcp, portSecurityMacAddr1=portSecurityMacAddr1, portVoiceVlanId=portVoiceVlanId, portBandwidthLimitRxd=portBandwidthLimitRxd, portIndex=portIndex, adminSnmpMacTableMode=adminSnmpMacTableMode, radiusPortSecurityReject=radiusPortSecurityReject, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, sfpInfoLength9um=sfpInfoLength9um, portLoopBcastFailure=portLoopBcastFailure, bmSwitchInfo=bmSwitchInfo, portSecurityFailure=portSecurityFailure, infoPoeInputPower=infoPoeInputPower, adminAlarmNameM1=adminAlarmNameM1, sfpInfoConnectorDescr=sfpInfoConnectorDescr, bmSwitchSfpEntry=bmSwitchSfpEntry, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, portLEDYellow=portLEDYellow, bmSwitchVlanEntry=bmSwitchVlanEntry, portName=portName, switchIndustrialAlarmM2=switchIndustrialAlarmM2, portPoeCurrent=portPoeCurrent, sfpPortIndex=sfpPortIndex, sfpEvent=sfpEvent, bmSwitchVlan=bmSwitchVlan, adminMgmtAccessList=adminMgmtAccessList, portPrioDot1p=portPrioDot1p, infoMgmtHardwareVersion=infoMgmtHardwareVersion, adminSwitchPortMirror=adminSwitchPortMirror, portErrorDisabled=portErrorDisabled, portSecurityMacAddr2=portSecurityMacAddr2, vlanIndex=vlanIndex, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, portPoeVoltage=portPoeVoltage, adminAlarmNameM2=adminAlarmNameM2, bmSwitchVlanTable=bmSwitchVlanTable, portAcApSetup=portAcApSetup, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, portNewMacAddress=portNewMacAddress, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, switchInternalVoltageFailure=switchInternalVoltageFailure, portLinkChange=portLinkChange, infoNoOfReboots=infoNoOfReboots, portRemoteFault=portRemoteFault, portTrunkingMode=portTrunkingMode, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, portSpeedDuplexSetup=portSpeedDuplexSetup, infoLastSfpEventMessage=infoLastSfpEventMessage, infoSeriesNo=infoSeriesNo, portAdminState=portAdminState, infoAlarmStateM1=infoAlarmStateM1, sfpInfoVendorName=sfpInfoVendorName, infoNoOfPorts=infoNoOfPorts, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, switchFunctionInputAlarm=switchFunctionInputAlarm, portLEDGreen=portLEDGreen, vlanDescr=vlanDescr, adminFunctionInputNameF1=adminFunctionInputNameF1, adminAgentIpAddress=adminAgentIpAddress, portBandwidthLimitTxd=portBandwidthLimitTxd, bmSwitchSfp=bmSwitchSfp, infoDescr=infoDescr, portSecurityForwardingState=portSecurityForwardingState, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, tftpMessage=tftpMessage, portErrorCounter=portErrorCounter, infoManufactureDate=infoManufactureDate, adminLedGlobalMode=adminLedGlobalMode, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, adminReset=adminReset, sfpInfoBitRate=sfpInfoBitRate, sfpDiagTxOutputPower=sfpDiagTxOutputPower, portErrorCountFailure=portErrorCountFailure, infoSwitchHardwareVersion=infoSwitchHardwareVersion, sfpInfoWavelength=sfpInfoWavelength, clientRemoved=clientRemoved, PYSNMP_MODULE_ID=bmSwitchMIB, bmSwitchMIB=bmSwitchMIB, infoTotalConfigChanges=infoTotalConfigChanges, portPrioIp=portPrioIp, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, portSecurityAdminState=portSecurityAdminState, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, sfpInfoRevisionNumber=sfpInfoRevisionNumber, switchPoeVoltageFailure=switchPoeVoltageFailure, infoAlarmStateM2=infoAlarmStateM2, infoPowerVoltage3300=infoPowerVoltage3300, infoType=infoType, bmSwitchPort=bmSwitchPort, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, portLinkType=portLinkType, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, bmTraps=bmTraps, sfpInfoLength50um=sfpInfoLength50um, adminAgentPhysAddress=adminAgentPhysAddress, adminTftpAccess=adminTftpAccess, portSecurityMacAddr3=portSecurityMacAddr3, sfpState=sfpState, switchPoeOverloadFailure=switchPoeOverloadFailure, switchConfigurationChanged=switchConfigurationChanged, portLimiterPacketType=portLimiterPacketType, adminAgentPrioValue=adminAgentPrioValue, infoPoeInputVoltage=infoPoeInputVoltage, infoTemperature=infoTemperature, portPoePower=portPoePower, switchTemperatureFailure=switchTemperatureFailure, infoSerie=infoSerie, adminUnsecureVlanId=adminUnsecureVlanId, adminMemoryCardMode=adminMemoryCardMode, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, adminAgentVlanId=adminAgentVlanId, bmSwitchAdmin=bmSwitchAdmin, sfpInfoPartNumber=sfpInfoPartNumber, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, portPoePowerLimit=portPoePowerLimit, sfpInfoDateCode=sfpInfoDateCode, sfpInfoLength62um=sfpInfoLength62um, infoPowerVoltage2500=infoPowerVoltage2500, switchMgmtAuthFailure=switchMgmtAuthFailure, infoUnauthIpAddr=infoUnauthIpAddr, infoFunctionInputStateF1=infoFunctionInputStateF1, adminAgentNetmask=adminAgentNetmask, bmSwitchPortTable=bmSwitchPortTable, infoNewMacAddr=infoNewMacAddr, sfpDiagTemperature=sfpDiagTemperature, infoProductNo=infoProductNo, bmSwitchPortEntry=bmSwitchPortEntry, sfpInfoSerialNumber=sfpInfoSerialNumber, vlanId=vlanId, adminSwitchVlanTableMode=adminSwitchVlanTableMode, adminAlarmM2=adminAlarmM2, portPoeAdminState=portPoeAdminState, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, radiusMgmtAuthReject=radiusMgmtAuthReject, portPoeOverloadFailure=portPoeOverloadFailure, bmSwitchSfpTable=bmSwitchSfpTable, sfpDiagRxIntputPower=sfpDiagRxIntputPower)
