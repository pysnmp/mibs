...
mibBuilder.exportSymbols("NEXANS-BM-MIB", portBandwidthLimitRxd=portBandwidthLimitRxd, infoUnauthIpAddr=infoUnauthIpAddr, switchInternalVoltageFailure=switchInternalVoltageFailure, sfpPortIndex=sfpPortIndex, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, portPoeAdminState=portPoeAdminState, clientRemoved=clientRemoved, vlanId=vlanId, portPoePower=portPoePower, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, portVoiceVlanId=portVoiceVlanId, infoAlarmStateM2=infoAlarmStateM2, portSecurityAdminState=portSecurityAdminState, sfpInfoLength50um=sfpInfoLength50um, portDescr=portDescr, infoSerie=infoSerie, infoFunctionInputStateF1=infoFunctionInputStateF1, infoLastTftpMessage=infoLastTftpMessage, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, portAdminState=portAdminState, adminFunctionInputNameF1=adminFunctionInputNameF1, adminAlarmNameM2=adminAlarmNameM2, portName=portName, adminTftpAccess=adminTftpAccess, sfpInfoDateCode=sfpInfoDateCode, infoPowerVoltage2500=infoPowerVoltage2500, infoSeriesNo=infoSeriesNo, portDefaultVlanId=portDefaultVlanId, portLinkState=portLinkState, adminSwitchPortMirror=adminSwitchPortMirror, portSecurityMacAddr1=portSecurityMacAddr1, portPoePowerLimit=portPoePowerLimit, portLinkType=portLinkType, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, adminReset=adminReset, portBandwidthLimitTxd=portBandwidthLimitTxd, sfpInfoBitRate=sfpInfoBitRate, portRemoteFault=portRemoteFault, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, switchIndustrialAlarmM2=switchIndustrialAlarmM2, infoPowerVoltage3300=infoPowerVoltage3300, bmSwitchVlanTable=bmSwitchVlanTable, portNewMacAddress=portNewMacAddress, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, portPoeOverloadFailure=portPoeOverloadFailure, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, adminAgentDhcp=adminAgentDhcp, infoMgmtHardwareVersion=infoMgmtHardwareVersion, bmSwitchSfpTable=bmSwitchSfpTable, bmSwitchAdmin=bmSwitchAdmin, infoProductNo=infoProductNo, adminAlarmNameM1=adminAlarmNameM1, switchConfigurationChanged=switchConfigurationChanged, portIndex=portIndex, adminAlarmM1=adminAlarmM1, sfpInfoVendorName=sfpInfoVendorName, infoNoOfReboots=infoNoOfReboots, switchPoeOverloadFailure=switchPoeOverloadFailure, adminAlarmM2=adminAlarmM2, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, switchPoeVoltageFailure=switchPoeVoltageFailure, bmSwitchSfp=bmSwitchSfp, vlanDescr=vlanDescr, portErrorCountFailure=portErrorCountFailure, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, infoNoOfPorts=infoNoOfPorts, bmSwitchMIB=bmSwitchMIB, bmSwitchVlan=bmSwitchVlan, vlanIndex=vlanIndex, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, adminAgentPrioValue=adminAgentPrioValue, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, portPoeVoltage=portPoeVoltage, sfpInfoSerialNumber=sfpInfoSerialNumber, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, bmSwitchInfo=bmSwitchInfo, internalMgmtWarning=internalMgmtWarning, portLinkChange=portLinkChange, portLoopBcastFailure=portLoopBcastFailure, adminAgentNetmask=adminAgentNetmask, adminLedGlobalMode=adminLedGlobalMode, infoSecurityFailMacAddr=infoSecurityFailMacAddr, portTrunkingMode=portTrunkingMode, sfpInfoPartNumber=sfpInfoPartNumber, infoTotalConfigChanges=infoTotalConfigChanges, infoManufactureDate=infoManufactureDate, infoTemperature=infoTemperature, sfpEvent=sfpEvent, bmSwitchPort=bmSwitchPort, radiusPortSecurityReject=radiusPortSecurityReject, sfpDiagTemperature=sfpDiagTemperature, adminMemoryCardMode=adminMemoryCardMode, infoDescr=infoDescr, infoNewMacAddr=infoNewMacAddr, portSpeedDuplexSetup=portSpeedDuplexSetup, portSecurityMacAddr3=portSecurityMacAddr3, adminMgmtAccessList=adminMgmtAccessList, bmTraps=bmTraps, switchMgmtAuthFailure=switchMgmtAuthFailure, infoType=infoType, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, sfpInfoConnectorDescr=sfpInfoConnectorDescr, infoSwitchHardwareVersion=infoSwitchHardwareVersion, PYSNMP_MODULE_ID=bmSwitchMIB, bmSwitchVlanEntry=bmSwitchVlanEntry, adminSwitchVlanTableMode=adminSwitchVlanTableMode, adminAgentPhysAddress=adminAgentPhysAddress, infoPoeInputPower=infoPoeInputPower, portSecurityMacAddr2=portSecurityMacAddr2, sfpDiagTxOutputPower=sfpDiagTxOutputPower, portAcApSetup=portAcApSetup, infoPoeInputVoltage=infoPoeInputVoltage, adminAgentIpAddress=adminAgentIpAddress, bmSwitchPortEntry=bmSwitchPortEntry, sfpInfoLength9um=sfpInfoLength9um, tftpMessage=tftpMessage, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, portErrorCounter=portErrorCounter, portPoeCurrent=portPoeCurrent, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, portSecurityFailure=portSecurityFailure, portErrorDisabled=portErrorDisabled, infoLastSfpEventMessage=infoLastSfpEventMessage, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, bmSwitchPortTable=bmSwitchPortTable, portPrioDot1p=portPrioDot1p, sfpInfoWavelength=sfpInfoWavelength, sfpDiagRxIntputPower=sfpDiagRxIntputPower, switchFunctionInputAlarm=switchFunctionInputAlarm, portDefaultPrioQueue=portDefaultPrioQueue, adminAgentVlanId=adminAgentVlanId, sfpState=sfpState, switchTemperatureFailure=switchTemperatureFailure, switchIndustrialAlarmM1=switchIndustrialAlarmM1, sfpInfoRevisionNumber=sfpInfoRevisionNumber, portPrioIp=portPrioIp, adminUnsecureVlanId=adminUnsecureVlanId, sfpInfoLength62um=sfpInfoLength62um, adminSnmpMacTableMode=adminSnmpMacTableMode, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, portSecurityForwardingState=portSecurityForwardingState, portLEDGreen=portLEDGreen, infoAlarmStateM1=infoAlarmStateM1, portLimiterPacketType=portLimiterPacketType, portLEDYellow=portLEDYellow, radiusMgmtAuthReject=radiusMgmtAuthReject, bmSwitchSfpEntry=bmSwitchSfpEntry)
