...
mibBuilder.exportSymbols("NEXANS-BM-MIB", portPoeOverloadFailure=portPoeOverloadFailure, switchConfigurationChanged=switchConfigurationChanged, adminUnsecureVlanId=adminUnsecureVlanId, infoMgmtHardwareVersion=infoMgmtHardwareVersion, adminFunctionInputNameF1=adminFunctionInputNameF1, portLinkState=portLinkState, bmSwitchSfpTable=bmSwitchSfpTable, radiusMgmtAuthReject=radiusMgmtAuthReject, portAdminState=portAdminState, adminAgentIpAddress=adminAgentIpAddress, infoPoeInputPower=infoPoeInputPower, portName=portName, switchIndustrialAlarmM2=switchIndustrialAlarmM2, bmSwitchPort=bmSwitchPort, portSecurityFailure=portSecurityFailure, infoLastTftpMessage=infoLastTftpMessage, sfpInfoLength50um=sfpInfoLength50um, sfpState=sfpState, tftpMessage=tftpMessage, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, vlanDescr=vlanDescr, switchPoeVoltageFailure=switchPoeVoltageFailure, infoUnauthIpAddr=infoUnauthIpAddr, bmTraps=bmTraps, adminAgentVlanId=adminAgentVlanId, sfpEvent=sfpEvent, PYSNMP_MODULE_ID=bmSwitchMIB, infoNewMacAddr=infoNewMacAddr, infoPowerVoltage3300=infoPowerVoltage3300, portDefaultPrioQueue=portDefaultPrioQueue, portLEDGreen=portLEDGreen, sfpInfoDateCode=sfpInfoDateCode, portBandwidthLimitTxd=portBandwidthLimitTxd, switchFunctionInputAlarm=switchFunctionInputAlarm, infoAlarmStateM2=infoAlarmStateM2, portPrioIp=portPrioIp, switchInternalVoltageFailure=switchInternalVoltageFailure, sfpInfoLength9um=sfpInfoLength9um, portErrorCounter=portErrorCounter, portLEDYellow=portLEDYellow, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, infoSwitchHardwareVersion=infoSwitchHardwareVersion, sfpPortIndex=sfpPortIndex, sfpInfoVendorName=sfpInfoVendorName, infoManufactureDate=infoManufactureDate, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, bmSwitchVlan=bmSwitchVlan, bmSwitchMIB=bmSwitchMIB, adminReset=adminReset, adminAgentPhysAddress=adminAgentPhysAddress, portSecurityAdminState=portSecurityAdminState, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, switchMgmtAuthFailure=switchMgmtAuthFailure, bmSwitchVlanEntry=bmSwitchVlanEntry, portLinkChange=portLinkChange, sfpInfoConnectorDescr=sfpInfoConnectorDescr, adminSwitchVlanTableMode=adminSwitchVlanTableMode, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, clientRemoved=clientRemoved, sfpInfoRevisionNumber=sfpInfoRevisionNumber, infoTemperature=infoTemperature, portPoePower=portPoePower, infoSeriesNo=infoSeriesNo, portSecurityMacAddr1=portSecurityMacAddr1, sfpInfoPartNumber=sfpInfoPartNumber, bmSwitchInfo=bmSwitchInfo, bmSwitchSfp=bmSwitchSfp, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, internalMgmtWarning=internalMgmtWarning, sfpDiagRxIntputPower=sfpDiagRxIntputPower, adminAlarmNameM1=adminAlarmNameM1, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, sfpInfoSerialNumber=sfpInfoSerialNumber, switchPoeOverloadFailure=switchPoeOverloadFailure, portTrunkingMode=portTrunkingMode, infoProductNo=infoProductNo, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, adminLedGlobalMode=adminLedGlobalMode, radiusPortSecurityReject=radiusPortSecurityReject, vlanIndex=vlanIndex, sfpDiagTxOutputPower=sfpDiagTxOutputPower, portDefaultVlanId=portDefaultVlanId, infoFunctionInputStateF1=infoFunctionInputStateF1, infoAlarmStateM1=infoAlarmStateM1, bmSwitchPortEntry=bmSwitchPortEntry, portNewMacAddress=portNewMacAddress, portErrorDisabled=portErrorDisabled, adminTftpAccess=adminTftpAccess, portPoeVoltage=portPoeVoltage, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, bmSwitchVlanTable=bmSwitchVlanTable, portSpeedDuplexSetup=portSpeedDuplexSetup, portPoeAdminState=portPoeAdminState, infoPowerVoltage2500=infoPowerVoltage2500, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, adminSnmpMacTableMode=adminSnmpMacTableMode, infoNoOfPorts=infoNoOfPorts, adminAgentNetmask=adminAgentNetmask, portBandwidthLimitRxd=portBandwidthLimitRxd, infoDescr=infoDescr, sfpInfoWavelength=sfpInfoWavelength, adminAlarmM2=adminAlarmM2, adminAlarmNameM2=adminAlarmNameM2, infoLastSfpEventMessage=infoLastSfpEventMessage, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, adminAlarmM1=adminAlarmM1, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, portLinkType=portLinkType, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, infoNoOfReboots=infoNoOfReboots, adminSwitchPortMirror=adminSwitchPortMirror, portPrioDot1p=portPrioDot1p, sfpInfoBitRate=sfpInfoBitRate, switchIndustrialAlarmM1=switchIndustrialAlarmM1, switchTemperatureFailure=switchTemperatureFailure, infoType=infoType, portVoiceVlanId=portVoiceVlanId, portLoopBcastFailure=portLoopBcastFailure, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, portRemoteFault=portRemoteFault, portPoeCurrent=portPoeCurrent, portDescr=portDescr, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, portSecurityMacAddr2=portSecurityMacAddr2, portSecurityForwardingState=portSecurityForwardingState, adminMgmtAccessList=adminMgmtAccessList, sfpDiagTemperature=sfpDiagTemperature, portIndex=portIndex, infoPoeInputVoltage=infoPoeInputVoltage, portErrorCountFailure=portErrorCountFailure, infoSecurityFailMacAddr=infoSecurityFailMacAddr, adminAgentPrioValue=adminAgentPrioValue, bmSwitchAdmin=bmSwitchAdmin, portPoePowerLimit=portPoePowerLimit, adminAgentDhcp=adminAgentDhcp, infoSerie=infoSerie, infoTotalConfigChanges=infoTotalConfigChanges, adminMemoryCardMode=adminMemoryCardMode, portLimiterPacketType=portLimiterPacketType, bmSwitchSfpEntry=bmSwitchSfpEntry, portSecurityMacAddr3=portSecurityMacAddr3, portAcApSetup=portAcApSetup, vlanId=vlanId, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, sfpInfoLength62um=sfpInfoLength62um, bmSwitchPortTable=bmSwitchPortTable)
