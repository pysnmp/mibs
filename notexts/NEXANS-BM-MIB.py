...
mibBuilder.exportSymbols("NEXANS-BM-MIB", infoSeriesNo=infoSeriesNo, sfpInfoLength50um=sfpInfoLength50um, infoNoOfPorts=infoNoOfPorts, portPrioIp=portPrioIp, switchPoeVoltageFailure=switchPoeVoltageFailure, portSecurityAdminState=portSecurityAdminState, adminUnsecureVlanId=adminUnsecureVlanId, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, portRemoteFault=portRemoteFault, bmSwitchAdmin=bmSwitchAdmin, infoSerie=infoSerie, infoMgmtHardwareVersion=infoMgmtHardwareVersion, switchInternalVoltageFailure=switchInternalVoltageFailure, adminMgmtAccessList=adminMgmtAccessList, infoAlarmStateM1=infoAlarmStateM1, infoNoOfReboots=infoNoOfReboots, adminMemoryCardMode=adminMemoryCardMode, portBandwidthLimitTxd=portBandwidthLimitTxd, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, clientRemoved=clientRemoved, bmTraps=bmTraps, infoLastSfpEventMessage=infoLastSfpEventMessage, adminSwitchPortMirror=adminSwitchPortMirror, adminAlarmM1=adminAlarmM1, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, infoSwitchHardwareVersion=infoSwitchHardwareVersion, radiusMgmtAuthReject=radiusMgmtAuthReject, portSecurityMacAddr2=portSecurityMacAddr2, portDefaultVlanId=portDefaultVlanId, vlanDescr=vlanDescr, adminAlarmNameM1=adminAlarmNameM1, infoTotalConfigChanges=infoTotalConfigChanges, portPoeAdminState=portPoeAdminState, sfpInfoVendorName=sfpInfoVendorName, portLEDGreen=portLEDGreen, portSecurityMacAddr1=portSecurityMacAddr1, adminSwitchVlanTableMode=adminSwitchVlanTableMode, portVoiceVlanId=portVoiceVlanId, bmSwitchMIB=bmSwitchMIB, switchIndustrialAlarmM1=switchIndustrialAlarmM1, infoDescr=infoDescr, portErrorDisabled=portErrorDisabled, infoType=infoType, portPoeVoltage=portPoeVoltage, portNewMacAddress=portNewMacAddress, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, sfpInfoDateCode=sfpInfoDateCode, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, adminAgentVlanId=adminAgentVlanId, sfpInfoLength62um=sfpInfoLength62um, bmSwitchVlanEntry=bmSwitchVlanEntry, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, portLinkChange=portLinkChange, vlanId=vlanId, portIndex=portIndex, portErrorCounter=portErrorCounter, portSecurityFailure=portSecurityFailure, portPoeCurrent=portPoeCurrent, portLimiterPacketType=portLimiterPacketType, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, PYSNMP_MODULE_ID=bmSwitchMIB, infoManufactureDate=infoManufactureDate, adminAgentDhcp=adminAgentDhcp, tftpMessage=tftpMessage, portPoeOverloadFailure=portPoeOverloadFailure, portDescr=portDescr, switchTemperatureFailure=switchTemperatureFailure, adminAlarmNameM2=adminAlarmNameM2, adminFunctionInputNameF1=adminFunctionInputNameF1, bmSwitchVlan=bmSwitchVlan, sfpInfoPartNumber=sfpInfoPartNumber, switchFunctionInputAlarm=switchFunctionInputAlarm, bmSwitchSfp=bmSwitchSfp, adminTftpAccess=adminTftpAccess, portSecurityForwardingState=portSecurityForwardingState, adminLedGlobalMode=adminLedGlobalMode, infoTemperature=infoTemperature, adminAgentPrioValue=adminAgentPrioValue, bmSwitchPortTable=bmSwitchPortTable, sfpInfoRevisionNumber=sfpInfoRevisionNumber, switchIndustrialAlarmM2=switchIndustrialAlarmM2, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, bmSwitchSfpEntry=bmSwitchSfpEntry, adminAgentIpAddress=adminAgentIpAddress, sfpEvent=sfpEvent, internalMgmtWarning=internalMgmtWarning, portLinkState=portLinkState, infoPoeInputVoltage=infoPoeInputVoltage, sfpInfoBitRate=sfpInfoBitRate, portTrunkingMode=portTrunkingMode, vlanIndex=vlanIndex, sfpDiagTemperature=sfpDiagTemperature, sfpInfoSerialNumber=sfpInfoSerialNumber, portLoopBcastFailure=portLoopBcastFailure, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, sfpDiagRxIntputPower=sfpDiagRxIntputPower, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, adminReset=adminReset, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, infoNewMacAddr=infoNewMacAddr, adminAgentNetmask=adminAgentNetmask, switchConfigurationChanged=switchConfigurationChanged, portAcApSetup=portAcApSetup, infoProductNo=infoProductNo, infoPowerVoltage3300=infoPowerVoltage3300, portPoePowerLimit=portPoePowerLimit, adminAlarmM2=adminAlarmM2, bmSwitchInfo=bmSwitchInfo, sfpInfoWavelength=sfpInfoWavelength, portSpeedDuplexSetup=portSpeedDuplexSetup, portAdminState=portAdminState, portSecurityMacAddr3=portSecurityMacAddr3, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, infoPoeInputPower=infoPoeInputPower, portErrorCountFailure=portErrorCountFailure, sfpDiagTxOutputPower=sfpDiagTxOutputPower, bmSwitchSfpTable=bmSwitchSfpTable, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, switchMgmtAuthFailure=switchMgmtAuthFailure, infoUnauthIpAddr=infoUnauthIpAddr, bmSwitchVlanTable=bmSwitchVlanTable, infoPowerVoltage2500=infoPowerVoltage2500, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, bmSwitchPort=bmSwitchPort, portLinkType=portLinkType, portName=portName, portPrioDot1p=portPrioDot1p, portPoePower=portPoePower, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, infoLastTftpMessage=infoLastTftpMessage, infoSecurityFailMacAddr=infoSecurityFailMacAddr, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, sfpInfoConnectorDescr=sfpInfoConnectorDescr, infoFunctionInputStateF1=infoFunctionInputStateF1, sfpInfoLength9um=sfpInfoLength9um, switchPoeOverloadFailure=switchPoeOverloadFailure, bmSwitchPortEntry=bmSwitchPortEntry, sfpState=sfpState, sfpPortIndex=sfpPortIndex, radiusPortSecurityReject=radiusPortSecurityReject, infoAlarmStateM2=infoAlarmStateM2, portLEDYellow=portLEDYellow, adminAgentPhysAddress=adminAgentPhysAddress, portDefaultPrioQueue=portDefaultPrioQueue, adminSnmpMacTableMode=adminSnmpMacTableMode, portBandwidthLimitRxd=portBandwidthLimitRxd, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress)
