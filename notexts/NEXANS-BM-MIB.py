...
mibBuilder.exportSymbols("NEXANS-BM-MIB", portLinkType=portLinkType, adminAgentPhysAddress=adminAgentPhysAddress, switchTemperatureFailure=switchTemperatureFailure, adminMgmtAccessList=adminMgmtAccessList, infoSeriesNo=infoSeriesNo, vlanDescr=vlanDescr, sfpInfoSerialNumber=sfpInfoSerialNumber, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, bmSwitchPortTable=bmSwitchPortTable, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, sfpDiagRxIntputPower=sfpDiagRxIntputPower, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, switchConfigurationChanged=switchConfigurationChanged, portErrorCountFailure=portErrorCountFailure, portLinkChange=portLinkChange, bmSwitchVlanTable=bmSwitchVlanTable, infoNoOfReboots=infoNoOfReboots, portVoiceVlanId=portVoiceVlanId, radiusPortSecurityReject=radiusPortSecurityReject, adminAgentNetmask=adminAgentNetmask, sfpDiagTxOutputPower=sfpDiagTxOutputPower, portRemoteFault=portRemoteFault, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, portPoeOverloadFailure=portPoeOverloadFailure, vlanIndex=vlanIndex, PYSNMP_MODULE_ID=bmSwitchMIB, infoType=infoType, adminAlarmM1=adminAlarmM1, bmTraps=bmTraps, infoDescr=infoDescr, portSecurityAdminState=portSecurityAdminState, switchPoeVoltageFailure=switchPoeVoltageFailure, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, bmSwitchVlan=bmSwitchVlan, infoSecurityFailMacAddr=infoSecurityFailMacAddr, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, sfpInfoVendorName=sfpInfoVendorName, portLEDYellow=portLEDYellow, portTrunkingMode=portTrunkingMode, switchIndustrialAlarmM1=switchIndustrialAlarmM1, infoPowerVoltage2500=infoPowerVoltage2500, portPoeAdminState=portPoeAdminState, adminAlarmM2=adminAlarmM2, portDefaultPrioQueue=portDefaultPrioQueue, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, bmSwitchSfpTable=bmSwitchSfpTable, bmSwitchSfp=bmSwitchSfp, portSecurityForwardingState=portSecurityForwardingState, infoPoeInputPower=infoPoeInputPower, adminAgentIpAddress=adminAgentIpAddress, adminUnsecureVlanId=adminUnsecureVlanId, portSpeedDuplexSetup=portSpeedDuplexSetup, bmSwitchPortEntry=bmSwitchPortEntry, switchIndustrialAlarmM2=switchIndustrialAlarmM2, adminLedGlobalMode=adminLedGlobalMode, portName=portName, switchMgmtAuthFailure=switchMgmtAuthFailure, bmSwitchInfo=bmSwitchInfo, portAdminState=portAdminState, sfpState=sfpState, infoAlarmStateM1=infoAlarmStateM1, infoProductNo=infoProductNo, sfpEvent=sfpEvent, adminAgentDhcp=adminAgentDhcp, portErrorCounter=portErrorCounter, portAcApSetup=portAcApSetup, portPoeCurrent=portPoeCurrent, portDefaultVlanId=portDefaultVlanId, adminAgentPrioValue=adminAgentPrioValue, adminAlarmNameM2=adminAlarmNameM2, sfpPortIndex=sfpPortIndex, portBandwidthLimitRxd=portBandwidthLimitRxd, bmSwitchMIB=bmSwitchMIB, sfpInfoLength50um=sfpInfoLength50um, radiusMgmtAuthReject=radiusMgmtAuthReject, clientRemoved=clientRemoved, vlanId=vlanId, sfpInfoLength9um=sfpInfoLength9um, adminFunctionInputNameF1=adminFunctionInputNameF1, portSecurityMacAddr3=portSecurityMacAddr3, infoPowerVoltage3300=infoPowerVoltage3300, infoAlarmStateM2=infoAlarmStateM2, adminTftpAccess=adminTftpAccess, switchInternalVoltageFailure=switchInternalVoltageFailure, sfpInfoLength62um=sfpInfoLength62um, adminAgentVlanId=adminAgentVlanId, sfpInfoRevisionNumber=sfpInfoRevisionNumber, adminMemoryCardMode=adminMemoryCardMode, sfpInfoDateCode=sfpInfoDateCode, infoSwitchHardwareVersion=infoSwitchHardwareVersion, infoTotalConfigChanges=infoTotalConfigChanges, portSecurityMacAddr2=portSecurityMacAddr2, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, infoSerie=infoSerie, adminReset=adminReset, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, sfpInfoBitRate=sfpInfoBitRate, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, switchPoeOverloadFailure=switchPoeOverloadFailure, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, bmSwitchSfpEntry=bmSwitchSfpEntry, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, infoPoeInputVoltage=infoPoeInputVoltage, adminSwitchVlanTableMode=adminSwitchVlanTableMode, portDescr=portDescr, bmSwitchAdmin=bmSwitchAdmin, portPrioIp=portPrioIp, internalMgmtWarning=internalMgmtWarning, infoMgmtHardwareVersion=infoMgmtHardwareVersion, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, portSecurityFailure=portSecurityFailure, infoTemperature=infoTemperature, portPoeVoltage=portPoeVoltage, infoManufactureDate=infoManufactureDate, infoUnauthIpAddr=infoUnauthIpAddr, adminSnmpMacTableMode=adminSnmpMacTableMode, infoLastTftpMessage=infoLastTftpMessage, portPoePowerLimit=portPoePowerLimit, tftpMessage=tftpMessage, portPoePower=portPoePower, portLimiterPacketType=portLimiterPacketType, portNewMacAddress=portNewMacAddress, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, sfpInfoConnectorDescr=sfpInfoConnectorDescr, portLoopBcastFailure=portLoopBcastFailure, portSecurityMacAddr1=portSecurityMacAddr1, sfpInfoPartNumber=sfpInfoPartNumber, sfpDiagTemperature=sfpDiagTemperature, portLinkState=portLinkState, portLEDGreen=portLEDGreen, infoNoOfPorts=infoNoOfPorts, adminAlarmNameM1=adminAlarmNameM1, portIndex=portIndex, switchFunctionInputAlarm=switchFunctionInputAlarm, infoNewMacAddr=infoNewMacAddr, portPrioDot1p=portPrioDot1p, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, bmSwitchPort=bmSwitchPort, infoLastSfpEventMessage=infoLastSfpEventMessage, portBandwidthLimitTxd=portBandwidthLimitTxd, adminSwitchPortMirror=adminSwitchPortMirror, sfpInfoWavelength=sfpInfoWavelength, portErrorDisabled=portErrorDisabled, infoFunctionInputStateF1=infoFunctionInputStateF1, bmSwitchVlanEntry=bmSwitchVlanEntry)
