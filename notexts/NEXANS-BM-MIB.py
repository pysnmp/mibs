...
mibBuilder.exportSymbols("NEXANS-BM-MIB", switchMgmtAuthFailure=switchMgmtAuthFailure, infoManufactureDate=infoManufactureDate, portName=portName, infoPoeInputPower=infoPoeInputPower, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, vlanDescr=vlanDescr, portLEDYellow=portLEDYellow, portErrorDisabled=portErrorDisabled, adminTftpAccess=adminTftpAccess, sfpInfoDateCode=sfpInfoDateCode, bmSwitchPortTable=bmSwitchPortTable, sfpInfoBitRate=sfpInfoBitRate, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, adminAlarmNameM1=adminAlarmNameM1, bmSwitchVlanTable=bmSwitchVlanTable, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, infoNoOfPorts=infoNoOfPorts, adminAlarmM1=adminAlarmM1, portPoePowerLimit=portPoePowerLimit, sfpDiagTxOutputPower=sfpDiagTxOutputPower, portPoeOverloadFailure=portPoeOverloadFailure, portSecurityAdminState=portSecurityAdminState, portRemoteFault=portRemoteFault, tftpMessage=tftpMessage, portBandwidthLimitRxd=portBandwidthLimitRxd, infoUnauthIpAddr=infoUnauthIpAddr, portLEDGreen=portLEDGreen, adminFunctionInputNameF1=adminFunctionInputNameF1, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, sfpPortIndex=sfpPortIndex, switchInternalVoltageFailure=switchInternalVoltageFailure, switchConfigurationChanged=switchConfigurationChanged, portLinkType=portLinkType, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, infoSeriesNo=infoSeriesNo, infoNoOfReboots=infoNoOfReboots, infoMgmtHardwareVersion=infoMgmtHardwareVersion, radiusPortSecurityReject=radiusPortSecurityReject, switchPoeVoltageFailure=switchPoeVoltageFailure, clientRemoved=clientRemoved, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, sfpInfoWavelength=sfpInfoWavelength, portAdminState=portAdminState, sfpDiagRxIntputPower=sfpDiagRxIntputPower, switchIndustrialAlarmM2=switchIndustrialAlarmM2, adminMgmtAccessList=adminMgmtAccessList, bmTraps=bmTraps, adminReset=adminReset, portBandwidthLimitTxd=portBandwidthLimitTxd, sfpState=sfpState, bmSwitchVlan=bmSwitchVlan, adminAgentDhcp=adminAgentDhcp, portNewMacAddress=portNewMacAddress, portErrorCountFailure=portErrorCountFailure, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, portDefaultVlanId=portDefaultVlanId, sfpInfoSerialNumber=sfpInfoSerialNumber, switchIndustrialAlarmM1=switchIndustrialAlarmM1, adminUnsecureVlanId=adminUnsecureVlanId, internalMgmtWarning=internalMgmtWarning, adminSwitchVlanTableMode=adminSwitchVlanTableMode, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, portDescr=portDescr, sfpInfoLength9um=sfpInfoLength9um, adminAgentPhysAddress=adminAgentPhysAddress, infoSwitchHardwareVersion=infoSwitchHardwareVersion, portLinkState=portLinkState, infoNewMacAddr=infoNewMacAddr, sfpInfoLength50um=sfpInfoLength50um, infoTemperature=infoTemperature, portPoeAdminState=portPoeAdminState, sfpInfoLength62um=sfpInfoLength62um, portIndex=portIndex, portPoePower=portPoePower, sfpInfoConnectorDescr=sfpInfoConnectorDescr, infoDescr=infoDescr, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, adminSnmpMacTableMode=adminSnmpMacTableMode, vlanId=vlanId, bmSwitchSfpEntry=bmSwitchSfpEntry, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, adminAlarmM2=adminAlarmM2, portSecurityMacAddr1=portSecurityMacAddr1, infoProductNo=infoProductNo, PYSNMP_MODULE_ID=bmSwitchMIB, bmSwitchPortEntry=bmSwitchPortEntry, adminAgentIpAddress=adminAgentIpAddress, portPoeVoltage=portPoeVoltage, adminMemoryCardMode=adminMemoryCardMode, infoPowerVoltage2500=infoPowerVoltage2500, portPoeCurrent=portPoeCurrent, vlanIndex=vlanIndex, infoAlarmStateM2=infoAlarmStateM2, infoPoeInputVoltage=infoPoeInputVoltage, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, adminAgentNetmask=adminAgentNetmask, infoSecurityFailMacAddr=infoSecurityFailMacAddr, portAcApSetup=portAcApSetup, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, switchPoeOverloadFailure=switchPoeOverloadFailure, bmSwitchMIB=bmSwitchMIB, portSecurityFailure=portSecurityFailure, infoLastTftpMessage=infoLastTftpMessage, bmSwitchSfpTable=bmSwitchSfpTable, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, bmSwitchPort=bmSwitchPort, bmSwitchVlanEntry=bmSwitchVlanEntry, adminSwitchPortMirror=adminSwitchPortMirror, portSecurityMacAddr3=portSecurityMacAddr3, portTrunkingMode=portTrunkingMode, sfpInfoPartNumber=sfpInfoPartNumber, portLimiterPacketType=portLimiterPacketType, infoSerie=infoSerie, portDefaultPrioQueue=portDefaultPrioQueue, portPrioDot1p=portPrioDot1p, infoPowerVoltage3300=infoPowerVoltage3300, portVoiceVlanId=portVoiceVlanId, radiusMgmtAuthReject=radiusMgmtAuthReject, bmSwitchInfo=bmSwitchInfo, sfpInfoRevisionNumber=sfpInfoRevisionNumber, switchFunctionInputAlarm=switchFunctionInputAlarm, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, portErrorCounter=portErrorCounter, switchTemperatureFailure=switchTemperatureFailure, adminLedGlobalMode=adminLedGlobalMode, infoAlarmStateM1=infoAlarmStateM1, adminAlarmNameM2=adminAlarmNameM2, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, sfpEvent=sfpEvent, sfpDiagTemperature=sfpDiagTemperature, portPrioIp=portPrioIp, infoType=infoType, adminAgentPrioValue=adminAgentPrioValue, portSpeedDuplexSetup=portSpeedDuplexSetup, infoTotalConfigChanges=infoTotalConfigChanges, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, portLoopBcastFailure=portLoopBcastFailure, bmSwitchSfp=bmSwitchSfp, sfpInfoVendorName=sfpInfoVendorName, infoFunctionInputStateF1=infoFunctionInputStateF1, adminAgentVlanId=adminAgentVlanId, portLinkChange=portLinkChange, portSecurityForwardingState=portSecurityForwardingState, infoLastSfpEventMessage=infoLastSfpEventMessage, portSecurityMacAddr2=portSecurityMacAddr2, bmSwitchAdmin=bmSwitchAdmin)
