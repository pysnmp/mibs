...
ModuleIdentity, Unsigned32, Gauge32, Counter64, enterprises, NotificationType, TimeTicks, IpAddress, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, Bits, ObjectIdentity, Opaque = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "Gauge32", "Counter64", "enterprises", "NotificationType", "TimeTicks", "IpAddress", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "Bits", "ObjectIdentity", "Opaque")
...
mibBuilder.exportSymbols("PDU-MIB", VoltAmps=VoltAmps, userPasswordChanged=userPasswordChanged, MilliAmps=MilliAmps, RelativeHumidity=RelativeHumidity, unitActivePower=unitActivePower, humidityUpperWarning=humidityUpperWarning, unitCurrentUpperWarning=unitCurrentUpperWarning, passwordSettingsChanged=passwordSettingsChanged, PowerFactorPercentage=PowerFactorPercentage, product=product, humidityUpperWarningReset=humidityUpperWarningReset, groups=groups, SensorStateEnumeration=SensorStateEnumeration, outletVoltage=outletVoltage, firmwareFileDiscarded=firmwareFileDiscarded, tempUpperWarning=tempUpperWarning, userLogout=userLogout, PYSNMP_MODULE_ID=eaton, DegreesCelsius=DegreesCelsius, objectName=objectName, thresholdSeverity=thresholdSeverity, pduagent=pduagent, unitCircuitBreak0Current=unitCircuitBreak0Current, userModified=userModified, outletGroupingConnectivityLost=outletGroupingConnectivityLost, tempUpperCriticalReset=tempUpperCriticalReset, hardwareRev=hardwareRev, tempSensorTable=tempSensorTable, tempLowerWarning=tempLowerWarning, humidityUpperCriticalReset=humidityUpperCriticalReset, unitVoltage=unitVoltage, serialNumber=serialNumber, targetUser=targetUser, Watts=Watts, tempLowerCritical=tempLowerCritical, outletCurrentUpperCritical=outletCurrentUpperCritical, tempSensorLabel=tempSensorLabel, userLogin=userLogin, info=info, humiditySensorIndex=humiditySensorIndex, compliance=compliance, externalTemperatureGroup=externalTemperatureGroup, compliances=compliances, unitApparentPower=unitApparentPower, unitCircuitBreak1State=unitCircuitBreak1State, humiditySensorLabel=humiditySensorLabel, imageVersion=imageVersion, userAdded=userAdded, outletActivePower=outletActivePower, outletsGroup=outletsGroup, thresholdDescr=thresholdDescr, outletEntry=outletEntry, Hertz=Hertz, unitVoltageLowerCritical=unitVoltageLowerCritical, tempSensorIndex=tempSensorIndex, thresholdAlarm=thresholdAlarm, humidity=humidity, tempSensorCount=tempSensorCount, unitTempUpperCritical=unitTempUpperCritical, unitTempLowerWarning=unitTempLowerWarning, userName=userName, humiditySensorEntry=humiditySensorEntry, firmwareValidationFailed=firmwareValidationFailed, outletCurrent=outletCurrent, outletMaxCurrent=outletMaxCurrent, pdu=pdu, humidityLowerCritical=humidityLowerCritical, outletTable=outletTable, logFileCleared=logFileCleared, rebootCompleted=rebootCompleted, unitReadings=unitReadings, conformance=conformance, traps=traps, outletCurrentUpperWarning=outletCurrentUpperWarning, sensorDescr=sensorDescr, groupModified=groupModified, unitCircuitBreak0State=unitCircuitBreak0State, tempUpperCritical=tempUpperCritical, deviceUpdateStarted=deviceUpdateStarted, eaton=eaton, environmental=environmental, unitCircuitBreak1Current=unitCircuitBreak1Current, externalHumidityGroup=externalHumidityGroup, MilliVolts=MilliVolts, tempLowerWarningReset=tempLowerWarningReset, unitCurrentUpperCritical=unitCurrentUpperCritical, slaveIpAddress=slaveIpAddress, humiditySensorCount=humiditySensorCount, netmask=netmask, mac=mac, temperature=temperature, unitCpuTemp=unitCpuTemp, trapsGroup=trapsGroup, userBlocked=userBlocked, board=board, unitCurrent=unitCurrent, gateway=gateway, outletPowerFactor=outletPowerFactor, objectInstance=objectInstance, tempLowerCriticalReset=tempLowerCriticalReset, firmwareVersion=firmwareVersion, humidityUpperCritical=humidityUpperCritical, humidityLowerWarning=humidityLowerWarning, unitVoltageLowerWarning=unitVoltageLowerWarning, userAuthenticationFailure=userAuthenticationFailure, SensorTypeEnumeration=SensorTypeEnumeration, unitCircuitBreak2Current=unitCircuitBreak2Current, outletOperationalState=outletOperationalState, humidityLowerCriticalReset=humidityLowerCriticalReset, outletCount=outletCount, securityViolation=securityViolation, status=status, infoGroup=infoGroup, outlets=outlets, powerControl=powerControl, tempUpperWarningReset=tempUpperWarningReset, rebootStarted=rebootStarted, unitCircuitBreak2State=unitCircuitBreak2State, userDeleted=userDeleted, unitTempUpperWarning=unitTempUpperWarning, humidityLowerWarningReset=humidityLowerWarningReset, outletIndex=outletIndex, tempSensorEntry=tempSensorEntry, groupAdded=groupAdded, humiditySensorTable=humiditySensorTable, unitTempLowerCritical=unitTempLowerCritical, thresholdEventType=thresholdEventType, outletLabel=outletLabel, outletApparentPower=outletApparentPower, ipAddress=ipAddress, groupName=groupName, unitVoltageUpperCritical=unitVoltageUpperCritical, unit=unit, groupDeleted=groupDeleted, unitVoltageUpperWarning=unitVoltageUpperWarning, userSessionTimeout=userSessionTimeout, unitSensorsGroup=unitSensorsGroup)
