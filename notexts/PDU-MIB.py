...
ObjectIdentity, Counter64, Unsigned32, IpAddress, Integer32, iso, Counter32, Gauge32, enterprises, NotificationType, ModuleIdentity, Opaque, Bits, TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter64", "Unsigned32", "IpAddress", "Integer32", "iso", "Counter32", "Gauge32", "enterprises", "NotificationType", "ModuleIdentity", "Opaque", "Bits", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("PDU-MIB", userModified=userModified, unitVoltage=unitVoltage, humidity=humidity, unitCpuTemp=unitCpuTemp, unitTempUpperCritical=unitTempUpperCritical, tempLowerWarningReset=tempLowerWarningReset, groups=groups, sensorDescr=sensorDescr, thresholdAlarm=thresholdAlarm, unitTempLowerCritical=unitTempLowerCritical, RelativeHumidity=RelativeHumidity, unitTempLowerWarning=unitTempLowerWarning, unitVoltageUpperWarning=unitVoltageUpperWarning, userDeleted=userDeleted, outletsGroup=outletsGroup, targetUser=targetUser, eaton=eaton, unitVoltageLowerCritical=unitVoltageLowerCritical, objectInstance=objectInstance, unitActivePower=unitActivePower, firmwareVersion=firmwareVersion, userName=userName, outletPowerFactor=outletPowerFactor, passwordSettingsChanged=passwordSettingsChanged, thresholdSeverity=thresholdSeverity, netmask=netmask, infoGroup=infoGroup, unitReadings=unitReadings, serialNumber=serialNumber, unitApparentPower=unitApparentPower, thresholdEventType=thresholdEventType, outletOperationalState=outletOperationalState, board=board, compliances=compliances, mac=mac, humiditySensorIndex=humiditySensorIndex, unitSensorsGroup=unitSensorsGroup, humidityLowerCritical=humidityLowerCritical, securityViolation=securityViolation, hardwareRev=hardwareRev, outletTable=outletTable, humidityUpperWarningReset=humidityUpperWarningReset, logFileCleared=logFileCleared, outletCurrent=outletCurrent, groupModified=groupModified, userPasswordChanged=userPasswordChanged, humiditySensorTable=humiditySensorTable, userAuthenticationFailure=userAuthenticationFailure, tempUpperWarningReset=tempUpperWarningReset, tempLowerCritical=tempLowerCritical, Hertz=Hertz, humidityLowerWarning=humidityLowerWarning, unitCircuitBreak1State=unitCircuitBreak1State, gateway=gateway, Watts=Watts, userAdded=userAdded, tempUpperCriticalReset=tempUpperCriticalReset, PYSNMP_MODULE_ID=eaton, tempLowerWarning=tempLowerWarning, slaveIpAddress=slaveIpAddress, outletMaxCurrent=outletMaxCurrent, deviceUpdateStarted=deviceUpdateStarted, trapsGroup=trapsGroup, compliance=compliance, unitCurrentUpperWarning=unitCurrentUpperWarning, outletApparentPower=outletApparentPower, thresholdDescr=thresholdDescr, unitVoltageUpperCritical=unitVoltageUpperCritical, environmental=environmental, unitCurrentUpperCritical=unitCurrentUpperCritical, unitCurrent=unitCurrent, externalTemperatureGroup=externalTemperatureGroup, outletCurrentUpperCritical=outletCurrentUpperCritical, tempSensorLabel=tempSensorLabel, info=info, rebootStarted=rebootStarted, rebootCompleted=rebootCompleted, SensorTypeEnumeration=SensorTypeEnumeration, outletActivePower=outletActivePower, unit=unit, MilliVolts=MilliVolts, groupName=groupName, userBlocked=userBlocked, humidityLowerCriticalReset=humidityLowerCriticalReset, firmwareFileDiscarded=firmwareFileDiscarded, userSessionTimeout=userSessionTimeout, unitCircuitBreak2State=unitCircuitBreak2State, temperature=temperature, humidityLowerWarningReset=humidityLowerWarningReset, unitCircuitBreak1Current=unitCircuitBreak1Current, userLogout=userLogout, externalHumidityGroup=externalHumidityGroup, userLogin=userLogin, tempUpperWarning=tempUpperWarning, pduagent=pduagent, groupAdded=groupAdded, outletIndex=outletIndex, SensorStateEnumeration=SensorStateEnumeration, tempSensorTable=tempSensorTable, objectName=objectName, firmwareValidationFailed=firmwareValidationFailed, product=product, tempUpperCritical=tempUpperCritical, humiditySensorLabel=humiditySensorLabel, tempSensorIndex=tempSensorIndex, groupDeleted=groupDeleted, tempSensorEntry=tempSensorEntry, powerControl=powerControl, humiditySensorEntry=humiditySensorEntry, unitTempUpperWarning=unitTempUpperWarning, DegreesCelsius=DegreesCelsius, ipAddress=ipAddress, unitCircuitBreak0Current=unitCircuitBreak0Current, humidityUpperCritical=humidityUpperCritical, outletCount=outletCount, conformance=conformance, tempSensorCount=tempSensorCount, unitCircuitBreak0State=unitCircuitBreak0State, outlets=outlets, humidityUpperCriticalReset=humidityUpperCriticalReset, outletVoltage=outletVoltage, MilliAmps=MilliAmps, unitVoltageLowerWarning=unitVoltageLowerWarning, PowerFactorPercentage=PowerFactorPercentage, pdu=pdu, humiditySensorCount=humiditySensorCount, imageVersion=imageVersion, outletCurrentUpperWarning=outletCurrentUpperWarning, humidityUpperWarning=humidityUpperWarning, traps=traps, unitCircuitBreak2Current=unitCircuitBreak2Current, outletEntry=outletEntry, outletLabel=outletLabel, VoltAmps=VoltAmps, tempLowerCriticalReset=tempLowerCriticalReset, status=status, outletGroupingConnectivityLost=outletGroupingConnectivityLost)
