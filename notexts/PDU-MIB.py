...
ModuleIdentity, Counter64, Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, enterprises, Bits, iso, IpAddress, TimeTicks, MibIdentifier, Unsigned32, Counter32, ObjectIdentity, Integer32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "enterprises", "Bits", "iso", "IpAddress", "TimeTicks", "MibIdentifier", "Unsigned32", "Counter32", "ObjectIdentity", "Integer32", "Gauge32")
...
mibBuilder.exportSymbols("PDU-MIB", gateway=gateway, tempSensorLabel=tempSensorLabel, outletMaxCurrent=outletMaxCurrent, humidityUpperCriticalReset=humidityUpperCriticalReset, unitVoltage=unitVoltage, MilliAmps=MilliAmps, rebootStarted=rebootStarted, unitTempLowerCritical=unitTempLowerCritical, deviceUpdateStarted=deviceUpdateStarted, tempUpperCritical=tempUpperCritical, humidityUpperWarning=humidityUpperWarning, product=product, tempLowerWarning=tempLowerWarning, outletTable=outletTable, humiditySensorEntry=humiditySensorEntry, eaton=eaton, Hertz=Hertz, hardwareRev=hardwareRev, targetUser=targetUser, humidityLowerCriticalReset=humidityLowerCriticalReset, unitApparentPower=unitApparentPower, VoltAmps=VoltAmps, unitCircuitBreak2State=unitCircuitBreak2State, ipAddress=ipAddress, tempSensorCount=tempSensorCount, mac=mac, outletCurrent=outletCurrent, temperature=temperature, unitCpuTemp=unitCpuTemp, unitVoltageUpperWarning=unitVoltageUpperWarning, unitCircuitBreak1State=unitCircuitBreak1State, userName=userName, compliance=compliance, userAuthenticationFailure=userAuthenticationFailure, thresholdEventType=thresholdEventType, unitCircuitBreak0Current=unitCircuitBreak0Current, unitTempUpperCritical=unitTempUpperCritical, userLogout=userLogout, tempSensorTable=tempSensorTable, humidityLowerWarning=humidityLowerWarning, outletIndex=outletIndex, humidityLowerCritical=humidityLowerCritical, userSessionTimeout=userSessionTimeout, unitCurrentUpperCritical=unitCurrentUpperCritical, outlets=outlets, outletApparentPower=outletApparentPower, PowerFactorPercentage=PowerFactorPercentage, outletPowerFactor=outletPowerFactor, unitCircuitBreak2Current=unitCircuitBreak2Current, externalTemperatureGroup=externalTemperatureGroup, unitVoltageUpperCritical=unitVoltageUpperCritical, firmwareVersion=firmwareVersion, tempSensorEntry=tempSensorEntry, unitTempUpperWarning=unitTempUpperWarning, environmental=environmental, compliances=compliances, SensorTypeEnumeration=SensorTypeEnumeration, humidityUpperWarningReset=humidityUpperWarningReset, outletCount=outletCount, tempUpperCriticalReset=tempUpperCriticalReset, RelativeHumidity=RelativeHumidity, outletEntry=outletEntry, conformance=conformance, thresholdDescr=thresholdDescr, outletVoltage=outletVoltage, tempLowerCriticalReset=tempLowerCriticalReset, outletGroupingConnectivityLost=outletGroupingConnectivityLost, MilliVolts=MilliVolts, Watts=Watts, securityViolation=securityViolation, firmwareFileDiscarded=firmwareFileDiscarded, tempUpperWarning=tempUpperWarning, netmask=netmask, traps=traps, outletActivePower=outletActivePower, outletCurrentUpperCritical=outletCurrentUpperCritical, unitCircuitBreak0State=unitCircuitBreak0State, infoGroup=infoGroup, humiditySensorTable=humiditySensorTable, objectInstance=objectInstance, passwordSettingsChanged=passwordSettingsChanged, userModified=userModified, unitTempLowerWarning=unitTempLowerWarning, tempLowerCritical=tempLowerCritical, groupAdded=groupAdded, userLogin=userLogin, imageVersion=imageVersion, outletCurrentUpperWarning=outletCurrentUpperWarning, groupDeleted=groupDeleted, groups=groups, unitActivePower=unitActivePower, unitCurrentUpperWarning=unitCurrentUpperWarning, slaveIpAddress=slaveIpAddress, humidityLowerWarningReset=humidityLowerWarningReset, externalHumidityGroup=externalHumidityGroup, objectName=objectName, status=status, outletLabel=outletLabel, humidity=humidity, rebootCompleted=rebootCompleted, outletOperationalState=outletOperationalState, unitVoltageLowerCritical=unitVoltageLowerCritical, pduagent=pduagent, unit=unit, unitReadings=unitReadings, powerControl=powerControl, PYSNMP_MODULE_ID=eaton, userPasswordChanged=userPasswordChanged, groupModified=groupModified, groupName=groupName, userBlocked=userBlocked, humiditySensorCount=humiditySensorCount, DegreesCelsius=DegreesCelsius, serialNumber=serialNumber, trapsGroup=trapsGroup, userAdded=userAdded, userDeleted=userDeleted, tempLowerWarningReset=tempLowerWarningReset, board=board, unitSensorsGroup=unitSensorsGroup, unitCurrent=unitCurrent, thresholdSeverity=thresholdSeverity, thresholdAlarm=thresholdAlarm, tempSensorIndex=tempSensorIndex, firmwareValidationFailed=firmwareValidationFailed, sensorDescr=sensorDescr, humiditySensorIndex=humiditySensorIndex, tempUpperWarningReset=tempUpperWarningReset, SensorStateEnumeration=SensorStateEnumeration, pdu=pdu, humidityUpperCritical=humidityUpperCritical, humiditySensorLabel=humiditySensorLabel, outletsGroup=outletsGroup, logFileCleared=logFileCleared, unitVoltageLowerWarning=unitVoltageLowerWarning, unitCircuitBreak1Current=unitCircuitBreak1Current, info=info)
