...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", trapLoggerAgent=trapLoggerAgent, filterSlotInChassis=filterSlotInChassis, slotInChassis=slotInChassis, filterTable=filterTable, wrap=wrap, totalNumberOfEntries=totalNumberOfEntries, trapOID=trapOID, filterTrapOID=filterTrapOID, nvmpId=nvmpId, slotChassis=slotChassis, trapLogDescription=trapLogDescription, trapLogTable=trapLogTable, configTableEntry=configTableEntry, filterLogId=filterLogId, filterNvmpId=filterNvmpId, trapLogVarBind=trapLogVarBind, z80Time=z80Time, filterTrapLogVarBind=filterTrapLogVarBind, filterFilterId=filterFilterId, lastLoggedEntryLogId=lastLoggedEntryLogId, filterTrapLogAcknowledged=filterTrapLogAcknowledged, trapLogEntry=trapLogEntry, trapLogAcknowledged=trapLogAcknowledged, logId=logId, filterId=filterId, filterTimeLogged=filterTimeLogged, configTable=configTable, numEntriesRequested=numEntriesRequested, numEntriesAllocated=numEntriesAllocated, timeLogged=timeLogged, filterEntry=filterEntry, filterZ80Time=filterZ80Time, logCommand=logCommand, filterTrapLogDescription=filterTrapLogDescription, numEntriesLoggeds=numEntriesLoggeds)
