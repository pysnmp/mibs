...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", lastLoggedEntryLogId=lastLoggedEntryLogId, wrap=wrap, filterNvmpId=filterNvmpId, filterTable=filterTable, z80Time=z80Time, numEntriesLoggeds=numEntriesLoggeds, logId=logId, configTable=configTable, slotInChassis=slotInChassis, configTableEntry=configTableEntry, filterLogId=filterLogId, filterZ80Time=filterZ80Time, filterTrapLogVarBind=filterTrapLogVarBind, slotChassis=slotChassis, filterTrapLogAcknowledged=filterTrapLogAcknowledged, trapLogTable=trapLogTable, logCommand=logCommand, filterEntry=filterEntry, timeLogged=timeLogged, filterTrapLogDescription=filterTrapLogDescription, trapLogVarBind=trapLogVarBind, filterTrapOID=filterTrapOID, filterId=filterId, filterSlotInChassis=filterSlotInChassis, trapLogDescription=trapLogDescription, trapLogAcknowledged=trapLogAcknowledged, nvmpId=nvmpId, trapLoggerAgent=trapLoggerAgent, trapOID=trapOID, numEntriesRequested=numEntriesRequested, numEntriesAllocated=numEntriesAllocated, totalNumberOfEntries=totalNumberOfEntries, filterFilterId=filterFilterId, trapLogEntry=trapLogEntry, filterTimeLogged=filterTimeLogged)
