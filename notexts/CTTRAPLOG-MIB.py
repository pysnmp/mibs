...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", trapLogTable=trapLogTable, slotChassis=slotChassis, logCommand=logCommand, filterId=filterId, trapOID=trapOID, trapLogAcknowledged=trapLogAcknowledged, filterTrapLogAcknowledged=filterTrapLogAcknowledged, trapLogEntry=trapLogEntry, filterTimeLogged=filterTimeLogged, trapLoggerAgent=trapLoggerAgent, timeLogged=timeLogged, filterZ80Time=filterZ80Time, lastLoggedEntryLogId=lastLoggedEntryLogId, filterSlotInChassis=filterSlotInChassis, filterLogId=filterLogId, trapLogDescription=trapLogDescription, numEntriesRequested=numEntriesRequested, filterTrapOID=filterTrapOID, filterTable=filterTable, slotInChassis=slotInChassis, configTableEntry=configTableEntry, numEntriesLoggeds=numEntriesLoggeds, trapLogVarBind=trapLogVarBind, filterNvmpId=filterNvmpId, totalNumberOfEntries=totalNumberOfEntries, wrap=wrap, filterFilterId=filterFilterId, logId=logId, filterTrapLogVarBind=filterTrapLogVarBind, numEntriesAllocated=numEntriesAllocated, z80Time=z80Time, filterEntry=filterEntry, filterTrapLogDescription=filterTrapLogDescription, configTable=configTable, nvmpId=nvmpId)
