...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", filterSlotInChassis=filterSlotInChassis, numEntriesAllocated=numEntriesAllocated, filterTrapLogDescription=filterTrapLogDescription, filterTable=filterTable, totalNumberOfEntries=totalNumberOfEntries, filterLogId=filterLogId, trapLogTable=trapLogTable, filterNvmpId=filterNvmpId, filterTimeLogged=filterTimeLogged, trapLogAcknowledged=trapLogAcknowledged, trapLoggerAgent=trapLoggerAgent, trapLogEntry=trapLogEntry, filterTrapLogVarBind=filterTrapLogVarBind, numEntriesRequested=numEntriesRequested, logId=logId, filterEntry=filterEntry, numEntriesLoggeds=numEntriesLoggeds, nvmpId=nvmpId, z80Time=z80Time, configTable=configTable, filterFilterId=filterFilterId, filterId=filterId, trapLogDescription=trapLogDescription, filterTrapOID=filterTrapOID, filterZ80Time=filterZ80Time, trapLogVarBind=trapLogVarBind, configTableEntry=configTableEntry, wrap=wrap, filterTrapLogAcknowledged=filterTrapLogAcknowledged, slotInChassis=slotInChassis, slotChassis=slotChassis, trapOID=trapOID, timeLogged=timeLogged, logCommand=logCommand, lastLoggedEntryLogId=lastLoggedEntryLogId)
