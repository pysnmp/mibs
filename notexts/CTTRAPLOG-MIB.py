...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", logId=logId, filterZ80Time=filterZ80Time, filterTimeLogged=filterTimeLogged, logCommand=logCommand, nvmpId=nvmpId, numEntriesRequested=numEntriesRequested, filterLogId=filterLogId, numEntriesAllocated=numEntriesAllocated, filterTrapLogVarBind=filterTrapLogVarBind, slotInChassis=slotInChassis, numEntriesLoggeds=numEntriesLoggeds, filterTrapLogDescription=filterTrapLogDescription, trapLogVarBind=trapLogVarBind, filterNvmpId=filterNvmpId, configTableEntry=configTableEntry, z80Time=z80Time, trapLogAcknowledged=trapLogAcknowledged, lastLoggedEntryLogId=lastLoggedEntryLogId, configTable=configTable, slotChassis=slotChassis, filterTrapOID=filterTrapOID, trapOID=trapOID, filterTrapLogAcknowledged=filterTrapLogAcknowledged, filterEntry=filterEntry, trapLoggerAgent=trapLoggerAgent, trapLogDescription=trapLogDescription, wrap=wrap, totalNumberOfEntries=totalNumberOfEntries, trapLogEntry=trapLogEntry, timeLogged=timeLogged, filterSlotInChassis=filterSlotInChassis, filterId=filterId, filterTable=filterTable, filterFilterId=filterFilterId, trapLogTable=trapLogTable)
