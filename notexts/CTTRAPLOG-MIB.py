...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", filterId=filterId, trapOID=trapOID, trapLogVarBind=trapLogVarBind, filterNvmpId=filterNvmpId, filterTrapLogAcknowledged=filterTrapLogAcknowledged, filterLogId=filterLogId, filterTrapLogDescription=filterTrapLogDescription, timeLogged=timeLogged, filterEntry=filterEntry, nvmpId=nvmpId, trapLogEntry=trapLogEntry, numEntriesLoggeds=numEntriesLoggeds, wrap=wrap, configTable=configTable, configTableEntry=configTableEntry, trapLoggerAgent=trapLoggerAgent, filterTimeLogged=filterTimeLogged, logId=logId, filterTrapLogVarBind=filterTrapLogVarBind, lastLoggedEntryLogId=lastLoggedEntryLogId, filterSlotInChassis=filterSlotInChassis, trapLogDescription=trapLogDescription, numEntriesRequested=numEntriesRequested, slotChassis=slotChassis, numEntriesAllocated=numEntriesAllocated, trapLogTable=trapLogTable, slotInChassis=slotInChassis, filterFilterId=filterFilterId, logCommand=logCommand, totalNumberOfEntries=totalNumberOfEntries, filterTable=filterTable, trapLogAcknowledged=trapLogAcknowledged, filterZ80Time=filterZ80Time, z80Time=z80Time, filterTrapOID=filterTrapOID)
