...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", filterTable=filterTable, numEntriesLoggeds=numEntriesLoggeds, numEntriesAllocated=numEntriesAllocated, trapLogDescription=trapLogDescription, filterTrapLogDescription=filterTrapLogDescription, configTable=configTable, filterTimeLogged=filterTimeLogged, wrap=wrap, configTableEntry=configTableEntry, slotInChassis=slotInChassis, trapLogEntry=trapLogEntry, filterEntry=filterEntry, filterTrapLogAcknowledged=filterTrapLogAcknowledged, trapOID=trapOID, filterFilterId=filterFilterId, trapLogTable=trapLogTable, filterLogId=filterLogId, filterNvmpId=filterNvmpId, totalNumberOfEntries=totalNumberOfEntries, filterTrapLogVarBind=filterTrapLogVarBind, filterZ80Time=filterZ80Time, trapLogVarBind=trapLogVarBind, filterSlotInChassis=filterSlotInChassis, filterId=filterId, z80Time=z80Time, numEntriesRequested=numEntriesRequested, logCommand=logCommand, trapLoggerAgent=trapLoggerAgent, timeLogged=timeLogged, trapLogAcknowledged=trapLogAcknowledged, lastLoggedEntryLogId=lastLoggedEntryLogId, nvmpId=nvmpId, filterTrapOID=filterTrapOID, slotChassis=slotChassis, logId=logId)
