...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", logCommand=logCommand, z80Time=z80Time, filterFilterId=filterFilterId, trapLogAcknowledged=trapLogAcknowledged, totalNumberOfEntries=totalNumberOfEntries, trapLogTable=trapLogTable, configTableEntry=configTableEntry, filterLogId=filterLogId, numEntriesAllocated=numEntriesAllocated, trapOID=trapOID, filterTrapOID=filterTrapOID, filterNvmpId=filterNvmpId, wrap=wrap, filterTrapLogVarBind=filterTrapLogVarBind, trapLoggerAgent=trapLoggerAgent, filterZ80Time=filterZ80Time, filterTrapLogDescription=filterTrapLogDescription, timeLogged=timeLogged, trapLogEntry=trapLogEntry, filterTimeLogged=filterTimeLogged, slotChassis=slotChassis, numEntriesLoggeds=numEntriesLoggeds, filterSlotInChassis=filterSlotInChassis, filterId=filterId, numEntriesRequested=numEntriesRequested, trapLogDescription=trapLogDescription, nvmpId=nvmpId, filterTable=filterTable, logId=logId, filterEntry=filterEntry, filterTrapLogAcknowledged=filterTrapLogAcknowledged, configTable=configTable, trapLogVarBind=trapLogVarBind, lastLoggedEntryLogId=lastLoggedEntryLogId, slotInChassis=slotInChassis)
