...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", totalNumberOfEntries=totalNumberOfEntries, trapLogEntry=trapLogEntry, logCommand=logCommand, trapOID=trapOID, filterTrapLogAcknowledged=filterTrapLogAcknowledged, wrap=wrap, configTable=configTable, numEntriesRequested=numEntriesRequested, logId=logId, filterZ80Time=filterZ80Time, trapLoggerAgent=trapLoggerAgent, filterLogId=filterLogId, trapLogDescription=trapLogDescription, trapLogAcknowledged=trapLogAcknowledged, slotInChassis=slotInChassis, filterTable=filterTable, filterTrapOID=filterTrapOID, filterNvmpId=filterNvmpId, slotChassis=slotChassis, filterEntry=filterEntry, filterTrapLogDescription=filterTrapLogDescription, filterSlotInChassis=filterSlotInChassis, trapLogVarBind=trapLogVarBind, filterTrapLogVarBind=filterTrapLogVarBind, numEntriesAllocated=numEntriesAllocated, filterTimeLogged=filterTimeLogged, trapLogTable=trapLogTable, z80Time=z80Time, timeLogged=timeLogged, lastLoggedEntryLogId=lastLoggedEntryLogId, nvmpId=nvmpId, configTableEntry=configTableEntry, filterId=filterId, filterFilterId=filterFilterId, numEntriesLoggeds=numEntriesLoggeds)
