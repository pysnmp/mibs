...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", numEntriesRequested=numEntriesRequested, nvmpId=nvmpId, filterEntry=filterEntry, filterTimeLogged=filterTimeLogged, numEntriesAllocated=numEntriesAllocated, trapLogVarBind=trapLogVarBind, slotInChassis=slotInChassis, configTable=configTable, lastLoggedEntryLogId=lastLoggedEntryLogId, trapLogTable=trapLogTable, numEntriesLoggeds=numEntriesLoggeds, filterTrapLogAcknowledged=filterTrapLogAcknowledged, configTableEntry=configTableEntry, trapLogEntry=trapLogEntry, slotChassis=slotChassis, filterFilterId=filterFilterId, logId=logId, filterTrapLogVarBind=filterTrapLogVarBind, filterTrapOID=filterTrapOID, logCommand=logCommand, trapLogAcknowledged=trapLogAcknowledged, trapLoggerAgent=trapLoggerAgent, filterId=filterId, filterZ80Time=filterZ80Time, z80Time=z80Time, timeLogged=timeLogged, filterLogId=filterLogId, wrap=wrap, filterTrapLogDescription=filterTrapLogDescription, filterTable=filterTable, filterNvmpId=filterNvmpId, filterSlotInChassis=filterSlotInChassis, trapLogDescription=trapLogDescription, trapOID=trapOID, totalNumberOfEntries=totalNumberOfEntries)
