...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", z80Time=z80Time, filterTrapLogDescription=filterTrapLogDescription, filterTrapLogVarBind=filterTrapLogVarBind, trapLogTable=trapLogTable, trapOID=trapOID, lastLoggedEntryLogId=lastLoggedEntryLogId, trapLogDescription=trapLogDescription, logId=logId, filterTrapLogAcknowledged=filterTrapLogAcknowledged, trapLogAcknowledged=trapLogAcknowledged, numEntriesLoggeds=numEntriesLoggeds, trapLoggerAgent=trapLoggerAgent, filterSlotInChassis=filterSlotInChassis, filterTimeLogged=filterTimeLogged, filterNvmpId=filterNvmpId, numEntriesRequested=numEntriesRequested, filterLogId=filterLogId, numEntriesAllocated=numEntriesAllocated, configTable=configTable, timeLogged=timeLogged, slotInChassis=slotInChassis, filterTrapOID=filterTrapOID, filterId=filterId, filterZ80Time=filterZ80Time, configTableEntry=configTableEntry, nvmpId=nvmpId, filterEntry=filterEntry, wrap=wrap, trapLogEntry=trapLogEntry, logCommand=logCommand, slotChassis=slotChassis, filterFilterId=filterFilterId, totalNumberOfEntries=totalNumberOfEntries, trapLogVarBind=trapLogVarBind, filterTable=filterTable)
