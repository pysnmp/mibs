...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", filterId=filterId, slotInChassis=slotInChassis, logId=logId, filterSlotInChassis=filterSlotInChassis, numEntriesRequested=numEntriesRequested, lastLoggedEntryLogId=lastLoggedEntryLogId, wrap=wrap, filterTrapLogVarBind=filterTrapLogVarBind, filterTrapOID=filterTrapOID, trapLogAcknowledged=trapLogAcknowledged, filterLogId=filterLogId, filterTrapLogAcknowledged=filterTrapLogAcknowledged, filterFilterId=filterFilterId, trapLogEntry=trapLogEntry, slotChassis=slotChassis, configTableEntry=configTableEntry, filterNvmpId=filterNvmpId, filterTimeLogged=filterTimeLogged, configTable=configTable, trapOID=trapOID, numEntriesAllocated=numEntriesAllocated, timeLogged=timeLogged, filterZ80Time=filterZ80Time, filterTrapLogDescription=filterTrapLogDescription, z80Time=z80Time, filterEntry=filterEntry, logCommand=logCommand, totalNumberOfEntries=totalNumberOfEntries, nvmpId=nvmpId, numEntriesLoggeds=numEntriesLoggeds, trapLogVarBind=trapLogVarBind, trapLoggerAgent=trapLoggerAgent, trapLogTable=trapLogTable, filterTable=filterTable, trapLogDescription=trapLogDescription)
