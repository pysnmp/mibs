...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", logCommand=logCommand, numEntriesRequested=numEntriesRequested, slotChassis=slotChassis, numEntriesAllocated=numEntriesAllocated, trapLoggerAgent=trapLoggerAgent, slotInChassis=slotInChassis, configTable=configTable, totalNumberOfEntries=totalNumberOfEntries, filterNvmpId=filterNvmpId, trapLogTable=trapLogTable, filterTimeLogged=filterTimeLogged, wrap=wrap, configTableEntry=configTableEntry, filterTrapLogDescription=filterTrapLogDescription, z80Time=z80Time, filterSlotInChassis=filterSlotInChassis, trapLogEntry=trapLogEntry, nvmpId=nvmpId, filterId=filterId, filterTrapOID=filterTrapOID, timeLogged=timeLogged, lastLoggedEntryLogId=lastLoggedEntryLogId, trapLogVarBind=trapLogVarBind, filterTrapLogVarBind=filterTrapLogVarBind, trapOID=trapOID, logId=logId, trapLogAcknowledged=trapLogAcknowledged, filterZ80Time=filterZ80Time, filterEntry=filterEntry, filterTable=filterTable, filterTrapLogAcknowledged=filterTrapLogAcknowledged, filterLogId=filterLogId, trapLogDescription=trapLogDescription, filterFilterId=filterFilterId, numEntriesLoggeds=numEntriesLoggeds)
