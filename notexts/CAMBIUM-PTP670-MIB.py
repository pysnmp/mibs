...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", dataBridgingStatus=dataBridgingStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, licenseInstancedTableIndex=licenseInstancedTableIndex, antennaSelection=antennaSelection, sNTPLastSync=sNTPLastSync, unitIdentificationGroup=unitIdentificationGroup, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, l2CPPriorityTableEntry=l2CPPriorityTableEntry, txMABFrames=txMABFrames, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, receiveChannel=receiveChannel, mainPSUPortQLRx=mainPSUPortQLRx, authorizationControl=authorizationControl, tDMGroup=tDMGroup, licenseTrialPeriod=licenseTrialPeriod, mainPSUPortAutoMdix=mainPSUPortAutoMdix, syslogClient=syslogClient, dfs=dfs, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, supplementaryGroup=supplementaryGroup, dNSGroup=dNSGroup, auxPortSSMTx=auxPortSSMTx, linkSymmetry=linkSymmetry, dNSServerTableIndex=dNSServerTableIndex, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, cableDiagnosticsGroup=cableDiagnosticsGroup, licenseInstancedTableEntry=licenseInstancedTableEntry, iPv6GatewayAddress=iPv6GatewayAddress, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, productName=productName, encryptionAlgorithm=encryptionAlgorithm, phyControlInstancedTable=phyControlInstancedTable, maximumTransmitPower=maximumTransmitPower, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, supplementary=supplementary, auxPortConfigurationMismatch=auxPortConfigurationMismatch, dataBridgingStatusAlarm=dataBridgingStatusAlarm, iPv4Address=iPv4Address, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, cableLoss=cableLoss, byteErrorRatioLinked=byteErrorRatioLinked, ethernetStatisticsTable=ethernetStatisticsTable, versions=versions, mainPSUPortAllocation=mainPSUPortAllocation, latitude=latitude, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, softwareVersion=softwareVersion, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, gatewayIPAddress=gatewayIPAddress, licenseVersion=licenseVersion, auxPortStatusTrap=auxPortStatusTrap, capacityVariantMismatch=capacityVariantMismatch, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, tdmTable=tdmTable, tDMConfigurationMismatch=tDMConfigurationMismatch, tFTPClient=tFTPClient, mainPSUPortSSMTx=mainPSUPortSSMTx, tempPcb=tempPcb, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, sMTPEnabledMessages=sMTPEnabledMessages, configurationInstancedTableNumber=configurationInstancedTableNumber, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, portAllocationMismatchLinked=portAllocationMismatchLinked, remoteInternetAddress=remoteInternetAddress, managementNetworkAccessEnabled=managementNetworkAccessEnabled, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, transmitPower=transmitPower, aAAControl=aAAControl, auxPortQLTx=auxPortQLTx, whitelistRMMacAddress=whitelistRMMacAddress, ethernetGroup=ethernetGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, sNTPServerInternetAddressType=sNTPServerInternetAddressType, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, dfsPeaks=dfsPeaks, packetsFromInternalStack=packetsFromInternalStack, installationMode=installationMode, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, hCMPLinkSymmetry=hCMPLinkSymmetry, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, licenseGroup=licenseGroup, hTTPPortNumber=hTTPPortNumber, dfsTable=dfsTable, aggregateDataRateLinked=aggregateDataRateLinked, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, sFPPortAutoMdix=sFPPortAutoMdix, licenseGroupAccess=licenseGroupAccess, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPServerPortNumber=tFTPServerPortNumber, phyControlInstancedTableEntry=phyControlInstancedTableEntry, transparentClock=transparentClock, sNMPTrapTable=sNMPTrapTable, auxPortAcceptedQLRx=auxPortAcceptedQLRx, mABProtocolVLANPriority=mABProtocolVLANPriority, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, lowestTDMModulationMode=lowestTDMModulationMode, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, tDMChannelStatusTrap=tDMChannelStatusTrap, transmitModulationModeLinked=transmitModulationModeLinked, dfsTableNumber=dfsTableNumber, txColorCode=txColorCode, cableDiagPair3Results=cableDiagPair3Results, alarmInstancedTableNumber=alarmInstancedTableNumber, l2CPPriorityTableIndex=l2CPPriorityTableIndex, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, sNMPv3Enable=sNMPv3Enable, nIDULanPortStatus=nIDULanPortStatus, mABProtocolVID=mABProtocolVID, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, cableDiagnosticsControl=cableDiagnosticsControl, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, transparentClockVLAN=transparentClockVLAN, sNMPTrapTableIndex=sNMPTrapTableIndex, erroredSeconds=erroredSeconds, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, receivePower=receivePower, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, rangingMode=rangingMode, lowestDataModulationMode=lowestDataModulationMode, aAAControlGroup=aAAControlGroup, transmitFreqKHz=transmitFreqKHz, unitIdentification=unitIdentification, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, severelyErroredSeconds=severelyErroredSeconds, userTableNumber=userTableNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, targetMACAddress=targetMACAddress, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, tdmTableEntry=tdmTableEntry, sNTPPollInterval=sNTPPollInterval, userName=userName, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, lbtDetectedTrap=lbtDetectedTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, unavailableSeconds=unavailableSeconds, unitOutOfCalibration=unitOutOfCalibration, mainPSUPortStatus=mainPSUPortStatus, dataBridgingAvailability=dataBridgingAvailability, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogControlGroup=syslogControlGroup, cableDiagPair3Distance=cableDiagPair3Distance, remoteUnitNameLinked=remoteUnitNameLinked, licenseSecurityLevel=licenseSecurityLevel, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, routerProtocols=routerProtocols, licenseIssueNumber=licenseIssueNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, linkLoss=linkLoss, hCMPMaximumLinkRange=hCMPMaximumLinkRange, hardwareVersion=hardwareVersion, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, transmitFreqMHz=transmitFreqMHz, apc=apc, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, l2CPPriorityTable=l2CPPriorityTable, installStatusLinked=installStatusLinked, alarmInstancedTableIndex=alarmInstancedTableIndex, localPacketFiltering=localPacketFiltering, mgmtInstancedTable=mgmtInstancedTable, licenseUnitSerialNumber=licenseUnitSerialNumber, cableDiagPair4Distance=cableDiagPair4Distance, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, cableDiagPair2Distance=cableDiagPair2Distance, wirelessOutEthernetOctets=wirelessOutEthernetOctets, deviceMACAddress=deviceMACAddress, licenseHCMPSupport=licenseHCMPSupport, installArmStateTrap=installArmStateTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, linkName=linkName, sFPPortAutoNegotiation=sFPPortAutoNegotiation, licenseIEEE1588Support=licenseIEEE1588Support, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, licenseTLSRekey=licenseTLSRekey, wirelessLinkStatus=wirelessLinkStatus, licenseRegulatoryBandsList=licenseRegulatoryBandsList, auxPortQLRx=auxPortQLRx, tDMChannelLineCode=tDMChannelLineCode, syncEEquipmentClock=syncEEquipmentClock, mABMaintenanceLevel=mABMaintenanceLevel, auxPortAllocation=auxPortAllocation, licenseMaxLinkRange=licenseMaxLinkRange, remoteMACAddressLinked=remoteMACAddressLinked, systemReset=systemReset, tDDSynchronizationStatus=tDDSynchronizationStatus, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, licenseCapacity=licenseCapacity, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, productVariant=productVariant, dSCPManagementPriority=dSCPManagementPriority, dfsTableIndex=dfsTableIndex, snmpControlGroup=snmpControlGroup, sFPPortStatus=sFPPortStatus, syslogState=syslogState, authorizationControlTableIndex=authorizationControlTableIndex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, unitName=unitName, signalStrengthRatio=signalStrengthRatio, authorizationControlTable=authorizationControlTable, deviceESN=deviceESN, blacklistRMEnabled=blacklistRMEnabled, extendedSpectrumScanning=extendedSpectrumScanning, userTable=userTable, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, mainPSUPortQLTx=mainPSUPortQLTx, authorizationControlTableEntry=authorizationControlTableEntry, packetsToInternalStack=packetsToInternalStack, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tDMChannelLoopback=tDMChannelLoopback, timeZone=timeZone, sNTPServerTableNumber=sNTPServerTableNumber, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, remoteInternetAddressType=remoteInternetAddressType, licenseInstancedTableNumber=licenseInstancedTableNumber, tDDControl=tDDControl, pubStats=pubStats, versionsGroup=versionsGroup, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, enableTransmission=enableTransmission, ptpTrapPrefix=ptpTrapPrefix, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sFPErrorTrap=sFPErrorTrap, aggregateDataRate=aggregateDataRate, dNSResolver=dNSResolver, qOSPriorityScheme=qOSPriorityScheme, cableDiagnosticsWarning=cableDiagnosticsWarning, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, userTableIndex=userTableIndex, dNSServerPortNumber=dNSServerPortNumber, portAllocationMismatchTrap=portAllocationMismatchTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, eIRP=eIRP, linkLossLinked=linkLossLinked, sNTPServerPortNumber=sNTPServerPortNumber, sntpGroup=sntpGroup, licenseRARSupport=licenseRARSupport, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, daylightSaving=daylightSaving, rawReceivePower=rawReceivePower)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", auxPortSyncERxStatus=auxPortSyncERxStatus, alarmInstancedTableEntry=alarmInstancedTableEntry, sntp=sntp, linkModeOptimization=linkModeOptimization, byteErrorRatio=byteErrorRatio, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ethernetPriorityTableNumber=ethernetPriorityTableNumber, installArmState=installArmState, phyInstancedStatusTable=phyInstancedStatusTable, channelBandwidth=channelBandwidth, dataPortPauseFrames=dataPortPauseFrames, ethernetInstancedTableIndex=ethernetInstancedTableIndex, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, siteName=siteName, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, blacklistRMMacAddress=blacklistRMMacAddress, mgmtInstancedTableEntry=mgmtInstancedTableEntry, cableDiagPair1Distance=cableDiagPair1Distance, mABNominalTransmitCapacity=mABNominalTransmitCapacity, dNS=dNS, searchState=searchState, incompatibleRegulatoryBands=incompatibleRegulatoryBands, regulatoryBandTrap=regulatoryBandTrap, mgmtInstancedTableNumber=mgmtInstancedTableNumber, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, alarmInstancedTable=alarmInstancedTable, linkModeOptimizationMismatch=linkModeOptimizationMismatch, maximumNumberOfSlaves=maximumNumberOfSlaves, mABHoldoffPeriod=mABHoldoffPeriod, phyControlGroup=phyControlGroup, useVLANForMABProtocol=useVLANForMABProtocol, transmitDataRateLinked=transmitDataRateLinked, sNMPTrapPortNumber=sNMPTrapPortNumber, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, cableDiagPair4Results=cableDiagPair4Results, sFPError=sFPError, sNMPTrapInternetAddress=sNMPTrapInternetAddress, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, phyControlInstancedTableNumber=phyControlInstancedTableNumber, capacityVariantMismatchLinked=capacityVariantMismatchLinked, subbandHighestFrequency=subbandHighestFrequency, sMTPEmailAlert=sMTPEmailAlert, sNTPSync=sNTPSync, dfsTableEntry=dfsTableEntry, pubInstancedStatsTable=pubInstancedStatsTable, transparentClockVID=transparentClockVID, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, resetGroup=resetGroup, alarms=alarms, remoteInternetAddressLinked=remoteInternetAddressLinked, ptpCompliance=ptpCompliance, ethernetInstancedTableEntry=ethernetInstancedTableEntry, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, cableDiagPair1Results=cableDiagPair1Results, ptpTraps=ptpTraps, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, frequencyVariant=frequencyVariant, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, tDMEnabledChannels=tDMEnabledChannels, hTTPSAccessEnabled=hTTPSAccessEnabled, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, sFPPortAllocation=sFPPortAllocation, iPv6PrefixLength=iPv6PrefixLength, range=range, receiveDataRate=receiveDataRate, vectorErrorLinked=vectorErrorLinked, dNSServerTableNumber=dNSServerTableNumber, ethernetPriorityTableIndex=ethernetPriorityTableIndex, accessMethod=accessMethod, vLANManagementPriority=vLANManagementPriority, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, licenseGasGroup=licenseGasGroup, configurationInstancedTableEntry=configurationInstancedTableEntry, signalStrengthRatioLinked=signalStrengthRatioLinked, longitude=longitude, transparentClockPort=transparentClockPort, oOBPriorityQueueMapping=oOBPriorityQueueMapping, tDMChannelStatus=tDMChannelStatus, antennaGain=antennaGain, phyStatusGroup=phyStatusGroup, cambium=cambium, targetRange=targetRange, sNTPServerStatus=sNTPServerStatus, tDMInterfaceStatus=tDMInterfaceStatus, licenseTDDSyncSupport=licenseTDDSyncSupport, sNTPServerTimeout=sNTPServerTimeout, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, dataBridgingStatusLinked=dataBridgingStatusLinked, hTTPAccessEnabled=hTTPAccessEnabled, sFPPortQLTx=sFPPortQLTx, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, sFPPortStatusTrap=sFPPortStatusTrap, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, licenseIPv6Support=licenseIPv6Support, phyStatus=phyStatus, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNTPPrimaryServer=sNTPPrimaryServer, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ptp670=ptp670, authorizationControlTableNumber=authorizationControlTableNumber, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, managementGroup=managementGroup, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, userRole=userRole, ethernetInstancedTableNumber=ethernetInstancedTableNumber, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, telnetAccessEnabled=telnetAccessEnabled, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, sNTPState=sNTPState, tdmTableIndex=tdmTableIndex, licenseOOBManagementSupport=licenseOOBManagementSupport, ethernetStatisticsDataSource=ethernetStatisticsDataSource, groupID=groupID, licenseBandwidthCap=licenseBandwidthCap, vLANManagementVID=vLANManagementVID, receiveFreqKHz=receiveFreqKHz, subnetMask=subnetMask, configurationGroup=configurationGroup, bridge=bridge, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, iPVersion=iPVersion, rangeLinked=rangeLinked, license=license, wirelessTopology=wirelessTopology, tDM=tDM, transmitPowerLinked=transmitPowerLinked, regulatoryBand=regulatoryBand, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, transmitterChannels=transmitterChannels, mainPSUPortStatusTrap=mainPSUPortStatusTrap, wirelessLinkStatusLinked=wirelessLinkStatusLinked, portAllocationMismatch=portAllocationMismatch, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, wirelessOutAllOctets=wirelessOutAllOctets, mABTransmissionInterval=mABTransmissionInterval, secureModeAlarm=secureModeAlarm, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, receiveFreqMHz=receiveFreqMHz, sFPPortQLRx=sFPPortQLRx, tDDControlGroup=tDDControlGroup, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, dfsGroup=dfsGroup, alarmsGroup=alarmsGroup, auxPortStatus=auxPortStatus, dNSServerTableEntry=dNSServerTableEntry, syslogClientTrap=syslogClientTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, mgmtInstancedTableIndex=mgmtInstancedTableIndex, sNMPCommunityString=sNMPCommunityString, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, sFPPortSSMTx=sFPPortSSMTx, syslogStateTrap=syslogStateTrap, smtp=smtp, licenseSFPPortSupport=licenseSFPPortSupport, vectorError=vectorError, installStatusTrap=installStatusTrap, sNTPSyncTrap=sNTPSyncTrap, iPv6Address=iPv6Address, dNSServerTable=dNSServerTable, maxLinkRangeExceeded=maxLinkRangeExceeded, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, notificationsGroup=notificationsGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, receiveModulationModeLinked=receiveModulationModeLinked, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, phyControl=phyControl, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, management=management, receivePowerLinked=receivePowerLinked, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, dNSPrimaryServer=dNSPrimaryServer, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, rawReceivePowerLinked=rawReceivePowerLinked, userPassword=userPassword, nIDULanPortAutoMdix=nIDULanPortAutoMdix, userEnabled=userEnabled, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, auxPortDisabledWarning=auxPortDisabledWarning, sMTPServerPortNumber=sMTPServerPortNumber, sFPPortDisabledWarning=sFPPortDisabledWarning, sNTPServerTable=sNTPServerTable, sNTPServerRetries=sNTPServerRetries, licenseEncryption=licenseEncryption, cableDiagnostics=cableDiagnostics, channelChangeTrap=channelChangeTrap, tDDSynchronizationMode=tDDSynchronizationMode, tDMInterfaceControl=tDMInterfaceControl, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, nIDULanPortStatusTrap=nIDULanPortStatusTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, authorizationMethod=authorizationMethod, mPLSTCPriorityTable=mPLSTCPriorityTable, sNMPTrapVersion=sNMPTrapVersion, configuration=configuration, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, whitelistRMEnabled=whitelistRMEnabled, syncESlavePort=syncESlavePort, bridgeGroup=bridgeGroup, transmitModulationMode=transmitModulationMode, configurationInstancedTable=configurationInstancedTable, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, receiveModulationMode=receiveModulationMode, tFTPServerInternetAddress=tFTPServerInternetAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, secondarySoftwareVersion=secondarySoftwareVersion, altitude=altitude, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, ptpGroups=ptpGroups, cableDiagnosticsResultTable=cableDiagnosticsResultTable, sNTPServerTableIndex=sNTPServerTableIndex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ethernet=ethernet, secureModeAlarmTrap=secureModeAlarmTrap, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, routerProtocolsGroup=routerProtocolsGroup, sMTPServerInternetAddressType=sMTPServerInternetAddressType, tDMChannelCableLength=tDMChannelCableLength, licenseSyncESupport=licenseSyncESupport, hTTPSPortNumber=hTTPSPortNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, syncETracking=syncETracking, bootVersion=bootVersion, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, cableDiagnosticsPorts=cableDiagnosticsPorts, deviceMSN=deviceMSN, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, dNSServerInternetAddressType=dNSServerInternetAddressType, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPServerTableEntry=sNTPServerTableEntry, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, tdmTableNumber=tdmTableNumber, licenseCountry=licenseCountry, ethernetInstancedTable=ethernetInstancedTable, rxColorCode=rxColorCode)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", receiveModulationModeDetail=receiveModulationModeDetail, dfsMeans=dfsMeans, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, masterSlaveMode=masterSlaveMode, userTableEntry=userTableEntry, smtpGroup=smtpGroup, mABNominalModulationMode=mABNominalModulationMode, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, syncETrackingState=syncETrackingState, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, configurationInstancedTableIndex=configurationInstancedTableIndex, sFPPortSyncERxStatus=sFPPortSyncERxStatus, systemClock=systemClock, installStatus=installStatus, pubStatsGroup=pubStatsGroup, PYSNMP_MODULE_ID=cambium, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, syslogControl=syslogControl, sNMPPortNumber=sNMPPortNumber, licenseInstancedTable=licenseInstancedTable, ptmp=ptmp, sNMPEnabledTraps=sNMPEnabledTraps, snmpControl=snmpControl, capacityVariantMismatchTrap=capacityVariantMismatchTrap, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitDataRate=transmitDataRate, encryptionGroup=encryptionGroup, telnetPortNumber=telnetPortNumber, remoteUnitName=remoteUnitName, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, reset=reset, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, sNTPServerInternetAddress=sNTPServerInternetAddress, wirelessLinkAvailability=wirelessLinkAvailability, authorizationControlGroup=authorizationControlGroup, iPDSCPPriorityTable=iPDSCPPriorityTable, transmitChannel=transmitChannel, wirelessOutOctets=wirelessOutOctets, encryption=encryption, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ptp=ptp, mABState=mABState, ethernetPriorityTable=ethernetPriorityTable, remoteMACAddress=remoteMACAddress, phyControlInstancedTableIndex=phyControlInstancedTableIndex, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, apcGroup=apcGroup, receiveDataRateLinked=receiveDataRateLinked, dNSServerInternetAddress=dNSServerInternetAddress, searchStateLinked=searchStateLinked, subbandLowestFrequency=subbandLowestFrequency, l2CPPriorityTableNumber=l2CPPriorityTableNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, cableDiagPair2Results=cableDiagPair2Results, enabledDiagnosticAlarms=enabledDiagnosticAlarms, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping)
