...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, userTableIndex=userTableIndex, tDMConfigurationMismatch=tDMConfigurationMismatch, phyControlInstancedTableIndex=phyControlInstancedTableIndex, unitIdentificationGroup=unitIdentificationGroup, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, sFPPortDisabledWarning=sFPPortDisabledWarning, configurationInstancedTableEntry=configurationInstancedTableEntry, sNMPCommunityString=sNMPCommunityString, groupID=groupID, versions=versions, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, mABProtocolVLANPriority=mABProtocolVLANPriority, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, whitelistRMEnabled=whitelistRMEnabled, licenseRegulatoryBandsList=licenseRegulatoryBandsList, alarmInstancedTableIndex=alarmInstancedTableIndex, phyControl=phyControl, lowestDataModulationMode=lowestDataModulationMode, wirelessTopology=wirelessTopology, auxPortQLRx=auxPortQLRx, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, ptpTraps=ptpTraps, dNSResolver=dNSResolver, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, userName=userName, ptpCompliance=ptpCompliance, hTTPSPortNumber=hTTPSPortNumber, tDDControl=tDDControl, tDMChannelStatus=tDMChannelStatus, mainPSUPortAutoMdix=mainPSUPortAutoMdix, incompatibleRegulatoryBands=incompatibleRegulatoryBands, channelChangeTrap=channelChangeTrap, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, tdmTableIndex=tdmTableIndex, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, auxPortDisabledWarning=auxPortDisabledWarning, dataBridgingStatus=dataBridgingStatus, vectorErrorLinked=vectorErrorLinked, managementNetworkAccessEnabled=managementNetworkAccessEnabled, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, unitOutOfCalibration=unitOutOfCalibration, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, telnetAccessEnabled=telnetAccessEnabled, cableDiagPair3Results=cableDiagPair3Results, sNTPServerTimeout=sNTPServerTimeout, licenseSyncESupport=licenseSyncESupport, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, licenseRARSupport=licenseRARSupport, subnetMask=subnetMask, sNMPEnabledTraps=sNMPEnabledTraps, tDM=tDM, remoteInternetAddress=remoteInternetAddress, secureModeAlarm=secureModeAlarm, sNMPTrapVersion=sNMPTrapVersion, cableDiagnosticsControl=cableDiagnosticsControl, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, licenseBandwidthCap=licenseBandwidthCap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, range=range, vLANManagementVID=vLANManagementVID, dSCPManagementPriority=dSCPManagementPriority, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, useVLANForMABProtocol=useVLANForMABProtocol, installStatusLinked=installStatusLinked, telnetPortNumber=telnetPortNumber, latitude=latitude, productVariant=productVariant, cableDiagnostics=cableDiagnostics, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, transmitModulationMode=transmitModulationMode, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, licenseVersion=licenseVersion, licenseTrialPeriod=licenseTrialPeriod, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, installationMode=installationMode, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, deviceESN=deviceESN, l2CPPriorityTableIndex=l2CPPriorityTableIndex, rxColorCode=rxColorCode, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, transmitModulationModeLinked=transmitModulationModeLinked, userRole=userRole, tDDSynchronizationMode=tDDSynchronizationMode, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tFTPClient=tFTPClient, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, lowestTDMModulationMode=lowestTDMModulationMode, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, tFTPServerInternetAddressType=tFTPServerInternetAddressType, syslogClient=syslogClient, receiveFreqMHz=receiveFreqMHz, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, mainPSUPortStatus=mainPSUPortStatus, siteName=siteName, cableDiagnosticsPorts=cableDiagnosticsPorts, sNTPServerTable=sNTPServerTable, licenseUnitSerialNumber=licenseUnitSerialNumber, configurationInstancedTableNumber=configurationInstancedTableNumber, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, managementPortWirelessDownAlert=managementPortWirelessDownAlert, ptp670=ptp670, iPv6PrefixLength=iPv6PrefixLength, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, auxPortStatusTrap=auxPortStatusTrap, bridgeGroup=bridgeGroup, accessMethod=accessMethod, userEnabled=userEnabled, dataBridgingAvailability=dataBridgingAvailability, timeZone=timeZone, managementGroup=managementGroup, cableDiagPair1Results=cableDiagPair1Results, smtpGroup=smtpGroup, syslogState=syslogState, alarms=alarms, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, remoteUnitName=remoteUnitName, alarmInstancedTable=alarmInstancedTable, sMTPServerInternetAddressType=sMTPServerInternetAddressType, dfsTableEntry=dfsTableEntry, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, unavailableSeconds=unavailableSeconds, receiveModulationModeLinked=receiveModulationModeLinked, hCMPLinkSymmetry=hCMPLinkSymmetry, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, l2CPPriorityTableEntry=l2CPPriorityTableEntry, smtp=smtp, hTTPSAccessEnabled=hTTPSAccessEnabled, dataPortPauseFrames=dataPortPauseFrames, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, tDDControlGroup=tDDControlGroup, licenseInstancedTableNumber=licenseInstancedTableNumber, sFPPortStatusTrap=sFPPortStatusTrap, dfsGroup=dfsGroup, dfsTable=dfsTable, signalStrengthRatioLinked=signalStrengthRatioLinked, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, iPv4Address=iPv4Address, noWirelessChannelAvailable=noWirelessChannelAvailable, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, targetMACAddress=targetMACAddress, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, iPv6GatewayAddress=iPv6GatewayAddress, ethernetInstancedTableNumber=ethernetInstancedTableNumber, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, sNTPServerTableNumber=sNTPServerTableNumber, altitude=altitude, remoteUnitNameLinked=remoteUnitNameLinked, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, dfsTableIndex=dfsTableIndex, syncETracking=syncETracking, licenseIssueNumber=licenseIssueNumber, auxPortSSMTx=auxPortSSMTx, transmitFreqKHz=transmitFreqKHz, portAllocationMismatchLinked=portAllocationMismatchLinked, portAllocationMismatch=portAllocationMismatch, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, softwareVersion=softwareVersion, mABHoldoffPeriod=mABHoldoffPeriod, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, mgmtInstancedTableIndex=mgmtInstancedTableIndex, dNSServerPortNumber=dNSServerPortNumber, licenseOOBManagementSupport=licenseOOBManagementSupport, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, configuration=configuration, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, authorizationControl=authorizationControl, dataBridgingStatusLinked=dataBridgingStatusLinked, mABNominalModulationMode=mABNominalModulationMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, encryptionAlgorithm=encryptionAlgorithm, transparentClock=transparentClock, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, licenseIPv6Support=licenseIPv6Support, txColorCode=txColorCode, dNSPrimaryServer=dNSPrimaryServer, cableDiagPair1Distance=cableDiagPair1Distance, cableDiagPair2Distance=cableDiagPair2Distance, phyInstancedStatusTable=phyInstancedStatusTable, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, cableLoss=cableLoss, dNSGroup=dNSGroup, secondarySoftwareVersion=secondarySoftwareVersion, eIRP=eIRP, auxPortAcceptedQLRx=auxPortAcceptedQLRx, syslogClientTrap=syslogClientTrap, ethernetGroup=ethernetGroup, licenseCountry=licenseCountry, mABNominalTransmitCapacity=mABNominalTransmitCapacity, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, linkLossLinked=linkLossLinked, blacklistRMEnabled=blacklistRMEnabled, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, wirelessLinkStatusLinked=wirelessLinkStatusLinked, nIDULanPortStatusTrap=nIDULanPortStatusTrap, licenseIEEE1588Support=licenseIEEE1588Support, licenseHCMPSupport=licenseHCMPSupport, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, linkModeOptimizationMismatch=linkModeOptimizationMismatch, installArmStateTrap=installArmStateTrap, license=license, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, tdmTableNumber=tdmTableNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, mgmtInstancedTableEntry=mgmtInstancedTableEntry, tDMChannelCableLength=tDMChannelCableLength, encryption=encryption, bridge=bridge, daylightSaving=daylightSaving, licenseTLSRekey=licenseTLSRekey, syslogLocalWrappedTrap=syslogLocalWrappedTrap, remoteInternetAddressLinked=remoteInternetAddressLinked, unitName=unitName, licenseSFPPortSupport=licenseSFPPortSupport, receivePowerLinked=receivePowerLinked, hTTPAccessEnabled=hTTPAccessEnabled, cableDiagPair4Results=cableDiagPair4Results, auxPortQLTx=auxPortQLTx, supplementaryGroup=supplementaryGroup, mainPSUPortSSMTx=mainPSUPortSSMTx, tDMEnabledChannels=tDMEnabledChannels, rangingMode=rangingMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPServerPortNumber=sMTPServerPortNumber, ptp=ptp, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, linkName=linkName, aggregateDataRate=aggregateDataRate, sNTPSyncTrap=sNTPSyncTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, versionsGroup=versionsGroup, maxLinkRangeExceeded=maxLinkRangeExceeded)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", searchStateLinked=searchStateLinked, sMTPEnabledMessages=sMTPEnabledMessages, tDMChannelLoopback=tDMChannelLoopback, sNTPSync=sNTPSync, receiveDataRate=receiveDataRate, secureModeAlarmTrap=secureModeAlarmTrap, deviceMSN=deviceMSN, systemReset=systemReset, ethernetPriorityTableEntry=ethernetPriorityTableEntry, linkSymmetry=linkSymmetry, sntp=sntp, longitude=longitude, sNMPTrapTable=sNMPTrapTable, licenseEncryption=licenseEncryption, mABState=mABState, licenseInstancedTableIndex=licenseInstancedTableIndex, transmitDataRate=transmitDataRate, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, apc=apc, enableTransmission=enableTransmission, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, dfsMeans=dfsMeans, severelyErroredSeconds=severelyErroredSeconds, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, licenseGroupAccess=licenseGroupAccess, tDMChannelLineCode=tDMChannelLineCode, userPassword=userPassword, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, rangeLinked=rangeLinked, configurationGroup=configurationGroup, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, tFTPServerPortNumber=tFTPServerPortNumber, erroredSeconds=erroredSeconds, remoteMACAddress=remoteMACAddress, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, management=management, authorizationControlGroup=authorizationControlGroup, iPVersion=iPVersion, capacityVariantMismatchLinked=capacityVariantMismatchLinked, PYSNMP_MODULE_ID=cambium, transmitChannel=transmitChannel, aAAControlGroup=aAAControlGroup, tFTPServerInternetAddress=tFTPServerInternetAddress, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, localPacketFiltering=localPacketFiltering, configurationInstancedTableIndex=configurationInstancedTableIndex, licenseSecurityLevel=licenseSecurityLevel, transmitPowerLinked=transmitPowerLinked, tDDSynchronizationStatus=tDDSynchronizationStatus, dNSServerTableIndex=dNSServerTableIndex, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, gatewayIPAddress=gatewayIPAddress, dfsPeaks=dfsPeaks, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, frequencyVariant=frequencyVariant, authorizationControlTableIndex=authorizationControlTableIndex, l2CPPriorityTable=l2CPPriorityTable, wirelessOutEthernetOctets=wirelessOutEthernetOctets, nIDULanPortAutoMdix=nIDULanPortAutoMdix, unitIdentification=unitIdentification, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, aAAControl=aAAControl, sNMPPortNumber=sNMPPortNumber, mABMaintenanceLevel=mABMaintenanceLevel, dNS=dNS, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ethernetStatisticsDataSource=ethernetStatisticsDataSource, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, cambium=cambium, userTable=userTable, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, cableDiagPair4Distance=cableDiagPair4Distance, alarmsGroup=alarmsGroup, vLANManagementPriority=vLANManagementPriority, packetsFromInternalStack=packetsFromInternalStack, transmitDataRateLinked=transmitDataRateLinked, blacklistRMMacAddress=blacklistRMMacAddress, remoteMACAddressLinked=remoteMACAddressLinked, sNTPServerRetries=sNTPServerRetries, dNSServerTableNumber=dNSServerTableNumber, notificationsGroup=notificationsGroup, authorizationControlTableNumber=authorizationControlTableNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, pubStats=pubStats, regulatoryBandTrap=regulatoryBandTrap, dNSServerTable=dNSServerTable, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, mABProtocolVID=mABProtocolVID, encryptionGroup=encryptionGroup, licenseGasGroup=licenseGasGroup, nIDULanPortStatus=nIDULanPortStatus, dNSServerInternetAddress=dNSServerInternetAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfs=dfs, cableDiagnosticsGroup=cableDiagnosticsGroup, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, sMTPEmailAlert=sMTPEmailAlert, licenseCapacity=licenseCapacity, alarmInstancedTableEntry=alarmInstancedTableEntry, transmitFreqMHz=transmitFreqMHz, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, receiveChannel=receiveChannel, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, licenseTDDSyncSupport=licenseTDDSyncSupport, packetsToInternalStack=packetsToInternalStack, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, subbandHighestFrequency=subbandHighestFrequency, sFPError=sFPError, sFPErrorTrap=sFPErrorTrap, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, linkModeOptimization=linkModeOptimization, dNSServerInternetAddressType=dNSServerInternetAddressType, extendedSpectrumScanning=extendedSpectrumScanning, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, dNSServerTableEntry=dNSServerTableEntry, cableDiagPair3Distance=cableDiagPair3Distance, tdmTableEntry=tdmTableEntry, sNTPServerStatus=sNTPServerStatus, receiveDataRateLinked=receiveDataRateLinked, routerProtocols=routerProtocols, ethernetPriorityTableIndex=ethernetPriorityTableIndex, hardwareVersion=hardwareVersion, mainPSUPortQLRx=mainPSUPortQLRx, receiveModulationModeDetail=receiveModulationModeDetail, phyControlInstancedTableNumber=phyControlInstancedTableNumber, sFPPortSSMTx=sFPPortSSMTx, ethernetPriorityTable=ethernetPriorityTable, channelBandwidth=channelBandwidth, incompatibleMasterAndSlave=incompatibleMasterAndSlave, hCMPMaximumLinkRange=hCMPMaximumLinkRange, tDMInterfaceStatus=tDMInterfaceStatus, ethernetStatisticsTable=ethernetStatisticsTable, masterSlaveMode=masterSlaveMode, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, auxPortAllocation=auxPortAllocation, sFPPortAutoMdix=sFPPortAutoMdix, sNTPLastSync=sNTPLastSync, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, userTableNumber=userTableNumber, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, syslogStateTrap=syslogStateTrap, tDMGroup=tDMGroup, whitelistRMMacAddress=whitelistRMMacAddress, ethernetPriorityTableNumber=ethernetPriorityTableNumber, syncETrackingState=syncETrackingState, sFPPortSyncERxStatus=sFPPortSyncERxStatus, mgmtInstancedTableNumber=mgmtInstancedTableNumber, pubInstancedStatsTable=pubInstancedStatsTable, portAllocationMismatchTrap=portAllocationMismatchTrap, tdmTable=tdmTable, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, authorizationControlTableEntry=authorizationControlTableEntry, syncESlavePort=syncESlavePort, wirelessOutAllOctets=wirelessOutAllOctets, licenseInstancedTableEntry=licenseInstancedTableEntry, aggregateDataRateLinked=aggregateDataRateLinked, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, maximumNumberOfSlaves=maximumNumberOfSlaves, dataBridgingStatusAlarm=dataBridgingStatusAlarm, iPDSCPPriorityTable=iPDSCPPriorityTable, qOSPriorityScheme=qOSPriorityScheme, linkLoss=linkLoss, sNMPTrapTableIndex=sNMPTrapTableIndex, phyControlInstancedTable=phyControlInstancedTable, mABTransmissionInterval=mABTransmissionInterval, tempPcb=tempPcb, sNTPServerInternetAddress=sNTPServerInternetAddress, alarmInstancedTableNumber=alarmInstancedTableNumber, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, ethernetInstancedTableIndex=ethernetInstancedTableIndex, pubStatsGroup=pubStatsGroup, ptpGroups=ptpGroups, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, signalStrengthRatio=signalStrengthRatio, licenseInstancedTable=licenseInstancedTable, antennaGain=antennaGain, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, phyStatus=phyStatus, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, authorizationMethod=authorizationMethod, searchState=searchState, apcGroup=apcGroup, ptmp=ptmp, sNTPServerPortNumber=sNTPServerPortNumber, transparentClockVLAN=transparentClockVLAN, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, mainPSUPortQLTx=mainPSUPortQLTx, installArmState=installArmState, sFPPortQLTx=sFPPortQLTx, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, regulatoryBand=regulatoryBand, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, cableDiagPair2Results=cableDiagPair2Results, sFPPortStatus=sFPPortStatus, ptpTrapPrefix=ptpTrapPrefix, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, byteErrorRatio=byteErrorRatio, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, sNMPTrapTableEntry=sNMPTrapTableEntry, receiveModulationMode=receiveModulationMode, ethernet=ethernet, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, antennaSelection=antennaSelection, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, l2CPPriorityTableNumber=l2CPPriorityTableNumber, maximumTransmitPower=maximumTransmitPower, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, licenseGroup=licenseGroup, sNTPServerTableIndex=sNTPServerTableIndex, sMTPSourceEmailAddress=sMTPSourceEmailAddress, phyStatusGroup=phyStatusGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, vectorError=vectorError, supplementary=supplementary, wirelessLinkStatus=wirelessLinkStatus, hTTPPortNumber=hTTPPortNumber, sntpGroup=sntpGroup, sNTPPollInterval=sNTPPollInterval, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, installStatusTrap=installStatusTrap, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, syslogControlGroup=syslogControlGroup, subbandLowestFrequency=subbandLowestFrequency, tDMChannelStatusTrap=tDMChannelStatusTrap, receiveFreqKHz=receiveFreqKHz, phyControlGroup=phyControlGroup, phyControlInstancedTableEntry=phyControlInstancedTableEntry, wirelessOutOctets=wirelessOutOctets, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, wirelessLinkAvailability=wirelessLinkAvailability, userTableEntry=userTableEntry, mPLSTCPriorityTable=mPLSTCPriorityTable, dfsTableNumber=dfsTableNumber, transmitterChannels=transmitterChannels, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, receivePower=receivePower, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, targetRange=targetRange, deviceMACAddress=deviceMACAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, transmitPower=transmitPower, authorizationControlTable=authorizationControlTable, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", productName=productName, reset=reset, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, ethernetInstancedTableEntry=ethernetInstancedTableEntry, sNMPTrapPortNumber=sNMPTrapPortNumber, resetGroup=resetGroup, ethernetInstancedTable=ethernetInstancedTable, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, mgmtInstancedTable=mgmtInstancedTable, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, routerProtocolsGroup=routerProtocolsGroup, auxPortConfigurationMismatch=auxPortConfigurationMismatch, snmpControl=snmpControl, enabledDiagnosticAlarms=enabledDiagnosticAlarms, systemClock=systemClock, sFPPortQLRx=sFPPortQLRx, sMTPServerInternetAddress=sMTPServerInternetAddress, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, sFPPortAllocation=sFPPortAllocation, iPv6Address=iPv6Address, auxPortStatus=auxPortStatus, syslogControl=syslogControl, sNMPTrapInternetAddress=sNMPTrapInternetAddress, transparentClockPort=transparentClockPort, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, dataPortWirelessDownAlert=dataPortWirelessDownAlert, capacityVariantMismatchTrap=capacityVariantMismatchTrap, cableDiagnosticsWarning=cableDiagnosticsWarning, bootVersion=bootVersion, rawReceivePowerLinked=rawReceivePowerLinked, licenseMaxLinkRange=licenseMaxLinkRange, sNTPServerTableEntry=sNTPServerTableEntry, tDMInterfaceControl=tDMInterfaceControl, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, rawReceivePower=rawReceivePower, auxPortSyncERxStatus=auxPortSyncERxStatus, mainPSUPortAllocation=mainPSUPortAllocation, syncEEquipmentClock=syncEEquipmentClock, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPState=sNTPState, cableDiagnosticsResultTable=cableDiagnosticsResultTable, snmpControlGroup=snmpControlGroup, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, lbtDetectedTrap=lbtDetectedTrap, sNMPv3Enable=sNMPv3Enable, oOBPriorityQueueMapping=oOBPriorityQueueMapping, txMABFrames=txMABFrames, installStatus=installStatus, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNTPPrimaryServer=sNTPPrimaryServer, transparentClockVID=transparentClockVID, byteErrorRatioLinked=byteErrorRatioLinked, configurationInstancedTable=configurationInstancedTable, remoteInternetAddressType=remoteInternetAddressType, capacityVariantMismatch=capacityVariantMismatch, sFPPortAutoNegotiation=sFPPortAutoNegotiation, mainPSUPortStatusTrap=mainPSUPortStatusTrap)
