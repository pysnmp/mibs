...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", subbandHighestFrequency=subbandHighestFrequency, sFPErrorTrap=sFPErrorTrap, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, reset=reset, regulatoryBand=regulatoryBand, portAllocationMismatch=portAllocationMismatch, mainPSUPortQLRx=mainPSUPortQLRx, tDMChannelLineCode=tDMChannelLineCode, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, mgmtInstancedTable=mgmtInstancedTable, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, ptpCompliance=ptpCompliance, tdmTableIndex=tdmTableIndex, sNMPv3Enable=sNMPv3Enable, searchState=searchState, transparentClockVLAN=transparentClockVLAN, transmitDataRateLinked=transmitDataRateLinked, mgmtInstancedTableNumber=mgmtInstancedTableNumber, tDDControl=tDDControl, mABNominalTransmitCapacity=mABNominalTransmitCapacity, sNMPTrapTableEntry=sNMPTrapTableEntry, ethernetGroup=ethernetGroup, accessMethod=accessMethod, cableLoss=cableLoss, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, alarmInstancedTableIndex=alarmInstancedTableIndex, cableDiagPair2Distance=cableDiagPair2Distance, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, authorizationControlTableNumber=authorizationControlTableNumber, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, vectorError=vectorError, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, rxColorCode=rxColorCode, sNMPCommunityString=sNMPCommunityString, erroredSeconds=erroredSeconds, remoteUnitName=remoteUnitName, syncESlavePort=syncESlavePort, dNSPrimaryServer=dNSPrimaryServer, ptpGroups=ptpGroups, nIDULanPortStatus=nIDULanPortStatus, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, syncETrackingState=syncETrackingState, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, routerProtocols=routerProtocols, byteErrorRatioLinked=byteErrorRatioLinked, syslogControl=syslogControl, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, userEnabled=userEnabled, licenseMaxLinkRange=licenseMaxLinkRange, daylightSaving=daylightSaving, auxPortQLRx=auxPortQLRx, snmpControlGroup=snmpControlGroup, linkSymmetry=linkSymmetry, remoteInternetAddressType=remoteInternetAddressType, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, authorizationControlTableEntry=authorizationControlTableEntry, managementNetworkAccessEnabled=managementNetworkAccessEnabled, byteErrorRatio=byteErrorRatio, sNMPTrapInternetAddress=sNMPTrapInternetAddress, receivePower=receivePower, mainPSUPortAutoMdix=mainPSUPortAutoMdix, useVLANForManagementInterfaces=useVLANForManagementInterfaces, wirelessTopology=wirelessTopology, incompatibleMasterAndSlave=incompatibleMasterAndSlave, capacityVariantMismatchLinked=capacityVariantMismatchLinked, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, sMTPEmailAlert=sMTPEmailAlert, phyInstancedStatusTable=phyInstancedStatusTable, sNMPTrapVersion=sNMPTrapVersion, enabledDiagnosticAlarms=enabledDiagnosticAlarms, mABTransmissionInterval=mABTransmissionInterval, dNSServerPortNumber=dNSServerPortNumber, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, tDMGroup=tDMGroup, longitude=longitude, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, phyControlInstancedTable=phyControlInstancedTable, hTTPSAccessEnabled=hTTPSAccessEnabled, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, licenseInstancedTableNumber=licenseInstancedTableNumber, ethernetStatisticsDataSource=ethernetStatisticsDataSource, deviceESN=deviceESN, licenseUnitSerialNumber=licenseUnitSerialNumber, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, cableDiagnostics=cableDiagnostics, useVLANForMABProtocol=useVLANForMABProtocol, ethernetPriorityTableEntry=ethernetPriorityTableEntry, managementPortWirelessDownAlert=managementPortWirelessDownAlert, licenseIPv6Support=licenseIPv6Support, targetRange=targetRange, auxPortSSMTx=auxPortSSMTx, licenseGroup=licenseGroup, tDMChannelStatusTrap=tDMChannelStatusTrap, configurationInstancedTableIndex=configurationInstancedTableIndex, remoteUnitNameLinked=remoteUnitNameLinked, antennaSelection=antennaSelection, rawReceivePowerLinked=rawReceivePowerLinked, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, lowestTDMModulationMode=lowestTDMModulationMode, receivePowerLinked=receivePowerLinked, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, mainPSUPortQLTx=mainPSUPortQLTx, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, sNTPServerTableEntry=sNTPServerTableEntry, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, licenseGroupAccess=licenseGroupAccess, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, dNSResolver=dNSResolver, phyControlInstancedTableEntry=phyControlInstancedTableEntry, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, tdmTableEntry=tdmTableEntry, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, tDDSynchronizationMode=tDDSynchronizationMode, hTTPAccessEnabled=hTTPAccessEnabled, antennaGain=antennaGain, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, userTableEntry=userTableEntry, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, authorizationControlGroup=authorizationControlGroup, ethernetInstancedTable=ethernetInstancedTable, range=range, transmitPowerLinked=transmitPowerLinked, tFTPServerInternetAddress=tFTPServerInternetAddress, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, transparentClockPort=transparentClockPort, cableDiagPair2Results=cableDiagPair2Results, transmitChannel=transmitChannel, extendedSpectrumScanning=extendedSpectrumScanning, sFPError=sFPError, lbtDetectedTrap=lbtDetectedTrap, transmitModulationMode=transmitModulationMode, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, sMTPServerPortNumber=sMTPServerPortNumber, licenseInstancedTable=licenseInstancedTable, auxPortStatus=auxPortStatus, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, receiveChannel=receiveChannel, supplementary=supplementary, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, configurationInstancedTableEntry=configurationInstancedTableEntry, cableDiagPair1Results=cableDiagPair1Results, productName=productName, transmitFreqMHz=transmitFreqMHz, packetsToInternalStack=packetsToInternalStack, searchStateLinked=searchStateLinked, portAllocationMismatchLinked=portAllocationMismatchLinked, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNMPTrapPortNumber=sNMPTrapPortNumber, regulatoryBandTrap=regulatoryBandTrap, sFPPortQLTx=sFPPortQLTx, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, dfsTableNumber=dfsTableNumber, mainPSUPortSSMTx=mainPSUPortSSMTx, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, sNTPServerTimeout=sNTPServerTimeout, dNSServerTable=dNSServerTable, licenseInstancedTableIndex=licenseInstancedTableIndex, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, rangeLinked=rangeLinked, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ethernetPriorityTableNumber=ethernetPriorityTableNumber, mABNominalModulationMode=mABNominalModulationMode, lowestDataModulationMode=lowestDataModulationMode, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, unitIdentification=unitIdentification, sntp=sntp, linkLoss=linkLoss, tDMInterfaceControl=tDMInterfaceControl, alarmInstancedTable=alarmInstancedTable, telnetAccessEnabled=telnetAccessEnabled, transmitModulationModeLinked=transmitModulationModeLinked, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, iPv6PrefixLength=iPv6PrefixLength, sFPPortSyncERxStatus=sFPPortSyncERxStatus, linkName=linkName, sNTPServerInternetAddress=sNTPServerInternetAddress, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, cableDiagPair4Results=cableDiagPair4Results, transmitFreqKHz=transmitFreqKHz, installationMode=installationMode, authorizationMethod=authorizationMethod, phyControl=phyControl, hardwareVersion=hardwareVersion, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, tDMConfigurationMismatch=tDMConfigurationMismatch, licenseIssueNumber=licenseIssueNumber, licenseIEEE1588Support=licenseIEEE1588Support, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, licenseGasGroup=licenseGasGroup, frequencyVariant=frequencyVariant, receiveModulationMode=receiveModulationMode, ethernetPriorityTableIndex=ethernetPriorityTableIndex, apcGroup=apcGroup, sFPPortSSMTx=sFPPortSSMTx, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, ethernet=ethernet, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, cableDiagPair4Distance=cableDiagPair4Distance, auxPortStatusTrap=auxPortStatusTrap, userTable=userTable, remoteMACAddressLinked=remoteMACAddressLinked, hCMPLinkSymmetry=hCMPLinkSymmetry, dataBridgingStatusLinked=dataBridgingStatusLinked, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, phyControlInstancedTableNumber=phyControlInstancedTableNumber, managementGroup=managementGroup, groupID=groupID, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, smtp=smtp, iPv6GatewayAddress=iPv6GatewayAddress, licenseVersion=licenseVersion, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, cableDiagnosticsResultTable=cableDiagnosticsResultTable, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, mainPSUPortStatus=mainPSUPortStatus, sMTPServerInternetAddress=sMTPServerInternetAddress, channelBandwidth=channelBandwidth, linkModeOptimization=linkModeOptimization, auxPortConfigurationMismatch=auxPortConfigurationMismatch, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, l2CPPriorityTableNumber=l2CPPriorityTableNumber, alarms=alarms, licenseHCMPSupport=licenseHCMPSupport, wirelessLinkStatusLinked=wirelessLinkStatusLinked, authorizationControlTableIndex=authorizationControlTableIndex, sFPPortDisabledWarning=sFPPortDisabledWarning, localPacketFiltering=localPacketFiltering, sNTPServerStatus=sNTPServerStatus, softwareVersion=softwareVersion, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, hTTPPortNumber=hTTPPortNumber, packetsFromInternalStack=packetsFromInternalStack, installStatusLinked=installStatusLinked, encryptionAlgorithm=encryptionAlgorithm, systemReset=systemReset, aAAControl=aAAControl, receiveDataRateLinked=receiveDataRateLinked, PYSNMP_MODULE_ID=cambium, vLANManagementVID=vLANManagementVID, ethernetPriorityTable=ethernetPriorityTable, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", mABHoldoffPeriod=mABHoldoffPeriod, licenseCountry=licenseCountry, encryption=encryption, sNTPServerRetries=sNTPServerRetries, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, auxPortDisabledWarning=auxPortDisabledWarning, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, mABProtocolVID=mABProtocolVID, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, mABState=mABState, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, transmitterChannels=transmitterChannels, cableDiagnosticsControl=cableDiagnosticsControl, sMTPEnabledMessages=sMTPEnabledMessages, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, dNSServerTableIndex=dNSServerTableIndex, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, tDDControlGroup=tDDControlGroup, syslogClientTrap=syslogClientTrap, dfsGroup=dfsGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, oOBPriorityQueueMapping=oOBPriorityQueueMapping, qOSPriorityScheme=qOSPriorityScheme, remoteInternetAddressLinked=remoteInternetAddressLinked, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, license=license, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, unitOutOfCalibration=unitOutOfCalibration, dNSServerInternetAddressType=dNSServerInternetAddressType, sFPPortStatus=sFPPortStatus, installArmState=installArmState, altitude=altitude, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, userName=userName, dNSServerTableEntry=dNSServerTableEntry, iPv4Address=iPv4Address, syslogControlGroup=syslogControlGroup, transmitDataRate=transmitDataRate, wirelessOutEthernetOctets=wirelessOutEthernetOctets, pubStatsGroup=pubStatsGroup, sNTPPrimaryServer=sNTPPrimaryServer, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, incompatibleRegulatoryBands=incompatibleRegulatoryBands, remoteMaximumTransmitPower=remoteMaximumTransmitPower, wirelessLinkAvailability=wirelessLinkAvailability, configuration=configuration, wirelessOutAllOctets=wirelessOutAllOctets, targetMACAddress=targetMACAddress, configurationInstancedTableNumber=configurationInstancedTableNumber, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, cableDiagnosticsWarning=cableDiagnosticsWarning, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, receiveModulationModeDetail=receiveModulationModeDetail, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, tDM=tDM, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, auxPortAllocation=auxPortAllocation, timeZone=timeZone, signalStrengthRatio=signalStrengthRatio, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, licenseTLSRekey=licenseTLSRekey, tDMEnabledChannels=tDMEnabledChannels, enableTransmission=enableTransmission, dNS=dNS, tDMChannelCableLength=tDMChannelCableLength, latitude=latitude, licenseEncryption=licenseEncryption, blacklistRMMacAddress=blacklistRMMacAddress, tDMChannelStatus=tDMChannelStatus, mainPSUPortStatusTrap=mainPSUPortStatusTrap, txColorCode=txColorCode, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, alarmInstancedTableEntry=alarmInstancedTableEntry, licenseInstancedTableEntry=licenseInstancedTableEntry, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, receiveModulationModeLinked=receiveModulationModeLinked, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, l2CPPriorityTable=l2CPPriorityTable, syslogClient=syslogClient, dataBridgingAvailability=dataBridgingAvailability, hCMPMaximumLinkRange=hCMPMaximumLinkRange, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, transparentClock=transparentClock, tDMChannelLoopback=tDMChannelLoopback, vectorErrorLinked=vectorErrorLinked, hTTPSPortNumber=hTTPSPortNumber, phyControlInstancedTableIndex=phyControlInstancedTableIndex, tFTPServerPortNumber=tFTPServerPortNumber, syslogStateTrap=syslogStateTrap, pubInstancedStatsTable=pubInstancedStatsTable, dataBridgingStatusAlarm=dataBridgingStatusAlarm, dfsMeans=dfsMeans, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sFPPortAllocation=sFPPortAllocation, cableDiagPair3Results=cableDiagPair3Results, ethernetInstancedTableIndex=ethernetInstancedTableIndex, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, mPLSTCPriorityTable=mPLSTCPriorityTable, severelyErroredSeconds=severelyErroredSeconds, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, phyStatus=phyStatus, ptp670=ptp670, receiveDataRate=receiveDataRate, maximumTransmitPower=maximumTransmitPower, deviceMACAddress=deviceMACAddress, cableDiagPair3Distance=cableDiagPair3Distance, sFPPortAutoMdix=sFPPortAutoMdix, sNTPServerTable=sNTPServerTable, sFPPortAutoNegotiation=sFPPortAutoNegotiation, alarmInstancedTableNumber=alarmInstancedTableNumber, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, bootVersion=bootVersion, secureModeAlarm=secureModeAlarm, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, sNTPSyncTrap=sNTPSyncTrap, whitelistRMEnabled=whitelistRMEnabled, licenseRegulatoryBandsList=licenseRegulatoryBandsList, dfsPeaks=dfsPeaks, phyStatusGroup=phyStatusGroup, nIDULanPortAutoMdix=nIDULanPortAutoMdix, rangingMode=rangingMode, aggregateDataRateLinked=aggregateDataRateLinked, iPv6Address=iPv6Address, encryptionGroup=encryptionGroup, cableDiagnosticsGroup=cableDiagnosticsGroup, mainPSUPortAllocation=mainPSUPortAllocation, licenseBandwidthCap=licenseBandwidthCap, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, siteName=siteName, sNMPPortNumber=sNMPPortNumber, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, ptpTrapPrefix=ptpTrapPrefix, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, userRole=userRole, capacityVariantMismatchTrap=capacityVariantMismatchTrap, dNSGroup=dNSGroup, ethernetInstancedTableNumber=ethernetInstancedTableNumber, phyControlGroup=phyControlGroup, licenseTrialPeriod=licenseTrialPeriod, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, wirelessOutOctets=wirelessOutOctets, mgmtInstancedTableEntry=mgmtInstancedTableEntry, dSCPManagementPriority=dSCPManagementPriority, notificationsGroup=notificationsGroup, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, unitName=unitName, unavailableSeconds=unavailableSeconds, maximumNumberOfSlaves=maximumNumberOfSlaves, tDDSynchronizationAlarm=tDDSynchronizationAlarm, installArmStateTrap=installArmStateTrap, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, ptp=ptp, linkModeOptimizationMismatch=linkModeOptimizationMismatch, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, deviceMSN=deviceMSN, noWirelessChannelAvailable=noWirelessChannelAvailable, ptmp=ptmp, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, transparentClockVID=transparentClockVID, ethernetInstancedTableEntry=ethernetInstancedTableEntry, linkLossLinked=linkLossLinked, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, dfs=dfs, supplementaryGroup=supplementaryGroup, mABMaintenanceLevel=mABMaintenanceLevel, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sFPPortQLRx=sFPPortQLRx, portAllocationMismatchTrap=portAllocationMismatchTrap, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, tFTPClient=tFTPClient, licenseOOBManagementSupport=licenseOOBManagementSupport, auxPortSyncERxStatus=auxPortSyncERxStatus, capacityVariantMismatch=capacityVariantMismatch, mABProtocolVLANPriority=mABProtocolVLANPriority, licenseSecurityLevel=licenseSecurityLevel, sNTPSync=sNTPSync, secureModeAlarmTrap=secureModeAlarmTrap, cableDiagnosticsPorts=cableDiagnosticsPorts, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, configurationInstancedTable=configurationInstancedTable, tDDSynchronizationStatus=tDDSynchronizationStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, sNTPServerTableNumber=sNTPServerTableNumber, mgmtInstancedTableIndex=mgmtInstancedTableIndex, authorizationControlTable=authorizationControlTable, userTableIndex=userTableIndex, subnetMask=subnetMask, tFTPServerInternetAddressType=tFTPServerInternetAddressType, auxPortQLTx=auxPortQLTx, auxPortAcceptedQLRx=auxPortAcceptedQLRx, dataPortWirelessDownAlert=dataPortWirelessDownAlert, productVariant=productVariant, receiveFreqKHz=receiveFreqKHz, dataPortPauseFrames=dataPortPauseFrames, blacklistRMEnabled=blacklistRMEnabled, tempPcb=tempPcb, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, channelChangeTrap=channelChangeTrap, bridge=bridge, dfsTable=dfsTable, pubStats=pubStats, licenseCapacity=licenseCapacity, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, licenseRARSupport=licenseRARSupport, licenseTDDSyncSupport=licenseTDDSyncSupport, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, rawReceivePower=rawReceivePower, syslogState=syslogState, authorizationControl=authorizationControl, l2CPPriorityTableIndex=l2CPPriorityTableIndex, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, eIRP=eIRP, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, transmitPower=transmitPower, masterSlaveMode=masterSlaveMode, txMABFrames=txMABFrames, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, sNTPServerPortNumber=sNTPServerPortNumber, sFPPortStatusTrap=sFPPortStatusTrap, sntpGroup=sntpGroup, dfsTableEntry=dfsTableEntry, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, installStatusTrap=installStatusTrap, versionsGroup=versionsGroup, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, signalStrengthRatioLinked=signalStrengthRatioLinked, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNTPPollInterval=sNTPPollInterval, cambium=cambium, sNMPTrapTable=sNMPTrapTable, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", snmpControl=snmpControl, versions=versions, subbandLowestFrequency=subbandLowestFrequency, sNMPEnabledTraps=sNMPEnabledTraps, smtpGroup=smtpGroup, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, remoteMACAddress=remoteMACAddress, wirelessLinkStatus=wirelessLinkStatus, aggregateDataRate=aggregateDataRate, unitIdentificationGroup=unitIdentificationGroup, alarmsGroup=alarmsGroup, systemClock=systemClock, iPVersion=iPVersion, vLANManagementPriority=vLANManagementPriority, tdmTable=tdmTable, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, sNMPTrapTableIndex=sNMPTrapTableIndex, secondarySoftwareVersion=secondarySoftwareVersion, ptpTraps=ptpTraps, tdmTableNumber=tdmTableNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, apc=apc, routerProtocolsGroup=routerProtocolsGroup, remoteInternetAddress=remoteInternetAddress, dNSServerInternetAddress=dNSServerInternetAddress, syncETracking=syncETracking, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, configurationGroup=configurationGroup, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, licenseSyncESupport=licenseSyncESupport, licenseSFPPortSupport=licenseSFPPortSupport, nIDULanPortStatusTrap=nIDULanPortStatusTrap, userPassword=userPassword, resetGroup=resetGroup, gatewayIPAddress=gatewayIPAddress, sNTPState=sNTPState, dfsTableIndex=dfsTableIndex, whitelistRMMacAddress=whitelistRMMacAddress, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNTPLastSync=sNTPLastSync, tDMInterfaceStatus=tDMInterfaceStatus, userTableNumber=userTableNumber, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, bridgeGroup=bridgeGroup, iPDSCPPriorityTable=iPDSCPPriorityTable, aAAControlGroup=aAAControlGroup, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, receiveFreqMHz=receiveFreqMHz, sNTPServerTableIndex=sNTPServerTableIndex, dNSServerTableNumber=dNSServerTableNumber, dataBridgingStatus=dataBridgingStatus, telnetPortNumber=telnetPortNumber, installStatus=installStatus, syncEEquipmentClock=syncEEquipmentClock, sNMPTrapTableNumber=sNMPTrapTableNumber, maxLinkRangeExceeded=maxLinkRangeExceeded, ethernetStatisticsTable=ethernetStatisticsTable, management=management, cableDiagPair1Distance=cableDiagPair1Distance)
