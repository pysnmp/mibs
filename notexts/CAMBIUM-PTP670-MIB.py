...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", mainPSUPortAutoMdix=mainPSUPortAutoMdix, wirelessOutOctets=wirelessOutOctets, ethernetStatisticsDataSource=ethernetStatisticsDataSource, sNMPEnabledTraps=sNMPEnabledTraps, useVLANForMABProtocol=useVLANForMABProtocol, ethernet=ethernet, licenseGasGroup=licenseGasGroup, whitelistRMEnabled=whitelistRMEnabled, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, lbtDetectedTrap=lbtDetectedTrap, alarmInstancedTableEntry=alarmInstancedTableEntry, antennaGain=antennaGain, dfsTableEntry=dfsTableEntry, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, softwareVersion=softwareVersion, licenseUnitSerialNumber=licenseUnitSerialNumber, hTTPSPortNumber=hTTPSPortNumber, daylightSaving=daylightSaving, mABNominalTransmitCapacity=mABNominalTransmitCapacity, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, signalStrengthRatioLinked=signalStrengthRatioLinked, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, subnetMask=subnetMask, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dSCPManagementPriority=dSCPManagementPriority, tFTPServerInternetAddress=tFTPServerInternetAddress, cableDiagPair4Distance=cableDiagPair4Distance, cambium=cambium, tFTPClient=tFTPClient, systemReset=systemReset, transmitFreqMHz=transmitFreqMHz, auxPortSyncERxStatus=auxPortSyncERxStatus, lowestTDMModulationMode=lowestTDMModulationMode, l2CPPriorityTableIndex=l2CPPriorityTableIndex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, receiveDataRate=receiveDataRate, iPv6Address=iPv6Address, lowestDataModulationMode=lowestDataModulationMode, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, ptpGroups=ptpGroups, noWirelessChannelAvailable=noWirelessChannelAvailable, versionsGroup=versionsGroup, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, remoteUnitName=remoteUnitName, apcGroup=apcGroup, bridge=bridge, tDMChannelStatus=tDMChannelStatus, cableDiagnosticsControl=cableDiagnosticsControl, vectorErrorLinked=vectorErrorLinked, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, receiveChannel=receiveChannel, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tDDSynchronizationStatus=tDDSynchronizationStatus, userTableEntry=userTableEntry, signalStrengthRatio=signalStrengthRatio, unavailableSeconds=unavailableSeconds, dNSServerTable=dNSServerTable, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, gatewayIPAddress=gatewayIPAddress, receiveModulationModeLinked=receiveModulationModeLinked, configurationInstancedTable=configurationInstancedTable, longitude=longitude, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, licenseRegulatoryBandsList=licenseRegulatoryBandsList, supplementaryGroup=supplementaryGroup, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, aAAControl=aAAControl, authorizationControl=authorizationControl, capacityVariantMismatch=capacityVariantMismatch, transmitModulationMode=transmitModulationMode, range=range, ethernetInstancedTableNumber=ethernetInstancedTableNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, licenseCapacity=licenseCapacity, transmitChannel=transmitChannel, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, tDMChannelStatusTrap=tDMChannelStatusTrap, installArmState=installArmState, blacklistRMEnabled=blacklistRMEnabled, transparentClock=transparentClock, configurationInstancedTableIndex=configurationInstancedTableIndex, authorizationControlTableNumber=authorizationControlTableNumber, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, auxPortStatus=auxPortStatus, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, ptpTrapPrefix=ptpTrapPrefix, userPassword=userPassword, regulatoryBandTrap=regulatoryBandTrap, dNSPrimaryServer=dNSPrimaryServer, wirelessLinkStatus=wirelessLinkStatus, licenseHCMPSupport=licenseHCMPSupport, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPPollInterval=sNTPPollInterval, configuration=configuration, routerProtocolsGroup=routerProtocolsGroup, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, licenseCountry=licenseCountry, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tempPcb=tempPcb, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, dataBridgingStatusAlarm=dataBridgingStatusAlarm, remoteMACAddress=remoteMACAddress, ethernetInstancedTableEntry=ethernetInstancedTableEntry, tDM=tDM, sNMPv3Enable=sNMPv3Enable, sNTPServerPortNumber=sNTPServerPortNumber, snmpControlGroup=snmpControlGroup, remoteInternetAddressType=remoteInternetAddressType, groupID=groupID, telnetAccessEnabled=telnetAccessEnabled, mainPSUPortQLTx=mainPSUPortQLTx, ptpCompliance=ptpCompliance, sFPPortSSMTx=sFPPortSSMTx, nIDULanPortStatus=nIDULanPortStatus, receiveFreqKHz=receiveFreqKHz, sNTPPrimaryServer=sNTPPrimaryServer, linkModeOptimizationMismatch=linkModeOptimizationMismatch, authorizationControlTableIndex=authorizationControlTableIndex, wirelessOutAllOctets=wirelessOutAllOctets, licenseGroupAccess=licenseGroupAccess, dNSServerPortNumber=dNSServerPortNumber, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNMPTrapTableIndex=sNMPTrapTableIndex, userName=userName, ethernetGroup=ethernetGroup, rawReceivePowerLinked=rawReceivePowerLinked, sNTPServerTimeout=sNTPServerTimeout, tDMChannelLoopback=tDMChannelLoopback, transmitFreqKHz=transmitFreqKHz, syslogStateTrap=syslogStateTrap, linkLossLinked=linkLossLinked, secureModeAlarm=secureModeAlarm, syslogClient=syslogClient, sMTPServerInternetAddress=sMTPServerInternetAddress, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dfsMeans=dfsMeans, sNTPServerTable=sNTPServerTable, auxPortStatusTrap=auxPortStatusTrap, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, linkSymmetry=linkSymmetry, l2CPPriorityTableEntry=l2CPPriorityTableEntry, license=license, licenseOOBManagementSupport=licenseOOBManagementSupport, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, masterSlaveMode=masterSlaveMode, mainPSUPortAllocation=mainPSUPortAllocation, sntp=sntp, licenseRARSupport=licenseRARSupport, licenseBandwidthCap=licenseBandwidthCap, licenseInstancedTableEntry=licenseInstancedTableEntry, encryption=encryption, regulatoryBand=regulatoryBand, receiveFreqMHz=receiveFreqMHz, siteName=siteName, mgmtInstancedTableIndex=mgmtInstancedTableIndex, receivePower=receivePower, mABTransmissionInterval=mABTransmissionInterval, userTableIndex=userTableIndex, latitude=latitude, auxPortQLRx=auxPortQLRx, remoteMACAddressLinked=remoteMACAddressLinked, ethernetInstancedTable=ethernetInstancedTable, accessMethod=accessMethod, tdmTableEntry=tdmTableEntry, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, tdmTableIndex=tdmTableIndex, licenseTDDSyncSupport=licenseTDDSyncSupport, enableTransmission=enableTransmission, byteErrorRatioLinked=byteErrorRatioLinked, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, alarms=alarms, subbandLowestFrequency=subbandLowestFrequency, transparentClockPort=transparentClockPort, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, auxPortDisabledWarning=auxPortDisabledWarning, versions=versions, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, iPVersion=iPVersion, unitName=unitName, dfsTable=dfsTable, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, nIDULanPortStatusTrap=nIDULanPortStatusTrap, cableDiagnosticsGroup=cableDiagnosticsGroup, tDMChannelCableLength=tDMChannelCableLength, tDMInterfaceStatus=tDMInterfaceStatus, hTTPAccessEnabled=hTTPAccessEnabled, smtpGroup=smtpGroup, sFPPortQLRx=sFPPortQLRx, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, mainPSUPortSSMTx=mainPSUPortSSMTx, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, portAllocationMismatch=portAllocationMismatch, sFPError=sFPError, txColorCode=txColorCode, PYSNMP_MODULE_ID=cambium, iPDSCPPriorityTable=iPDSCPPriorityTable, tDMConfigurationMismatch=tDMConfigurationMismatch, hardwareVersion=hardwareVersion, transmitPowerLinked=transmitPowerLinked, sNMPTrapTable=sNMPTrapTable, subbandHighestFrequency=subbandHighestFrequency, alarmInstancedTableNumber=alarmInstancedTableNumber, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, phyStatusGroup=phyStatusGroup, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, auxPortSSMTx=auxPortSSMTx, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, licenseInstancedTable=licenseInstancedTable, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sFPPortAutoNegotiation=sFPPortAutoNegotiation, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, rangingMode=rangingMode, supplementary=supplementary, phyControlInstancedTable=phyControlInstancedTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, targetMACAddress=targetMACAddress, incompatibleMasterAndSlave=incompatibleMasterAndSlave, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, wirelessTopology=wirelessTopology, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, tDMInterfaceControl=tDMInterfaceControl, rangeLinked=rangeLinked, cableDiagPair3Results=cableDiagPair3Results, sNTPSyncTrap=sNTPSyncTrap, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, installationMode=installationMode, licenseGroup=licenseGroup, phyControlInstancedTableNumber=phyControlInstancedTableNumber, secondarySoftwareVersion=secondarySoftwareVersion, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, erroredSeconds=erroredSeconds)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", telnetPortNumber=telnetPortNumber, mainPSUPortStatusTrap=mainPSUPortStatusTrap, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, managementGroup=managementGroup, ptp670=ptp670, ptmp=ptmp, syslogControl=syslogControl, mABProtocolVLANPriority=mABProtocolVLANPriority, phyControl=phyControl, tdmTableNumber=tdmTableNumber, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, userRole=userRole, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, cableDiagPair1Distance=cableDiagPair1Distance, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, syslogClientTrap=syslogClientTrap, qOSPriorityScheme=qOSPriorityScheme, tDDControlGroup=tDDControlGroup, mABHoldoffPeriod=mABHoldoffPeriod, sNTPServerRetries=sNTPServerRetries, bridgeGroup=bridgeGroup, transparentClockVID=transparentClockVID, cableDiagPair2Distance=cableDiagPair2Distance, mgmtInstancedTableEntry=mgmtInstancedTableEntry, extendedSpectrumScanning=extendedSpectrumScanning, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, sNMPTrapInternetAddress=sNMPTrapInternetAddress, pubInstancedStatsTable=pubInstancedStatsTable, mainPSUPortStatus=mainPSUPortStatus, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, ethernetPriorityTableNumber=ethernetPriorityTableNumber, licenseIPv6Support=licenseIPv6Support, sNMPPortNumber=sNMPPortNumber, cableLoss=cableLoss, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, ethernetInstancedTableIndex=ethernetInstancedTableIndex, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNMPTrapVersion=sNMPTrapVersion, linkLoss=linkLoss, tDDSynchronizationMode=tDDSynchronizationMode, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, management=management, sFPPortQLTx=sFPPortQLTx, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, sNMPCommunityString=sNMPCommunityString, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, licenseSyncESupport=licenseSyncESupport, tDMChannelLineCode=tDMChannelLineCode, auxPortAcceptedQLRx=auxPortAcceptedQLRx, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sFPPortSyncERxStatus=sFPPortSyncERxStatus, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, productName=productName, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, remoteUnitNameLinked=remoteUnitNameLinked, maximumTransmitPower=maximumTransmitPower, notificationsGroup=notificationsGroup, cableDiagnosticsPorts=cableDiagnosticsPorts, iPv6PrefixLength=iPv6PrefixLength, remoteInternetAddress=remoteInternetAddress, dNSServerTableIndex=dNSServerTableIndex, dNSGroup=dNSGroup, tFTPServerPortNumber=tFTPServerPortNumber, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, packetsFromInternalStack=packetsFromInternalStack, userTable=userTable, transmitModulationModeLinked=transmitModulationModeLinked, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, aggregateDataRateLinked=aggregateDataRateLinked, transmitDataRateLinked=transmitDataRateLinked, l2CPPriorityTableNumber=l2CPPriorityTableNumber, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, phyControlInstancedTableIndex=phyControlInstancedTableIndex, ptpTraps=ptpTraps, sMTPServerPortNumber=sMTPServerPortNumber, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, mgmtInstancedTable=mgmtInstancedTable, dNSServerInternetAddressType=dNSServerInternetAddressType, pubStats=pubStats, channelChangeTrap=channelChangeTrap, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, wirelessLinkAvailability=wirelessLinkAvailability, sFPPortStatusTrap=sFPPortStatusTrap, cableDiagPair2Results=cableDiagPair2Results, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, altitude=altitude, hTTPSAccessEnabled=hTTPSAccessEnabled, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, sNTPServerInternetAddressType=sNTPServerInternetAddressType, iPv6GatewayAddress=iPv6GatewayAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, sntpGroup=sntpGroup, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, sFPPortStatus=sFPPortStatus, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, authorizationControlTable=authorizationControlTable, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, linkModeOptimization=linkModeOptimization, receivePowerLinked=receivePowerLinked, installArmStateTrap=installArmStateTrap, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, sNTPServerTableNumber=sNTPServerTableNumber, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, sNTPLastSync=sNTPLastSync, secureModeAlarmTrap=secureModeAlarmTrap, transparentClockVLAN=transparentClockVLAN, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, maximumNumberOfSlaves=maximumNumberOfSlaves, mgmtInstancedTableNumber=mgmtInstancedTableNumber, phyInstancedStatusTable=phyInstancedStatusTable, pubStatsGroup=pubStatsGroup, licenseIssueNumber=licenseIssueNumber, sNTPServerInternetAddress=sNTPServerInternetAddress, ptp=ptp, authorizationControlGroup=authorizationControlGroup, authorizationMethod=authorizationMethod, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, installStatus=installStatus, phyStatus=phyStatus, mPLSTCPriorityTable=mPLSTCPriorityTable, searchStateLinked=searchStateLinked, txMABFrames=txMABFrames, installStatusTrap=installStatusTrap, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, dNSResolver=dNSResolver, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, wirelessOutEthernetOctets=wirelessOutEthernetOctets, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, unitOutOfCalibration=unitOutOfCalibration, portAllocationMismatchLinked=portAllocationMismatchLinked, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, configurationGroup=configurationGroup, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, localPacketFiltering=localPacketFiltering, receiveModulationModeDetail=receiveModulationModeDetail, mABProtocolVID=mABProtocolVID, sMTPServerInternetAddressType=sMTPServerInternetAddressType, dfsGroup=dfsGroup, auxPortConfigurationMismatch=auxPortConfigurationMismatch, maxLinkRangeExceeded=maxLinkRangeExceeded, userTableNumber=userTableNumber, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, auxPortQLTx=auxPortQLTx, timeZone=timeZone, sNMPTrapTableEntry=sNMPTrapTableEntry, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, portAllocationMismatchTrap=portAllocationMismatchTrap, deviceMACAddress=deviceMACAddress, dataBridgingStatus=dataBridgingStatus, hTTPPortNumber=hTTPPortNumber, capacityVariantMismatchTrap=capacityVariantMismatchTrap, frequencyVariant=frequencyVariant, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, authorizationControlTableEntry=authorizationControlTableEntry, cableDiagPair3Distance=cableDiagPair3Distance, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, cableDiagPair4Results=cableDiagPair4Results, whitelistRMMacAddress=whitelistRMMacAddress, incompatibleRegulatoryBands=incompatibleRegulatoryBands, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, licenseSFPPortSupport=licenseSFPPortSupport, alarmInstancedTable=alarmInstancedTable, apc=apc, rawReceivePower=rawReceivePower, dfsTableNumber=dfsTableNumber, productVariant=productVariant, remoteMaximumTransmitPower=remoteMaximumTransmitPower, oOBPriorityQueueMapping=oOBPriorityQueueMapping, sNTPState=sNTPState, syslogState=syslogState, cableDiagnosticsWarning=cableDiagnosticsWarning, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, receiveDataRateLinked=receiveDataRateLinked, blacklistRMMacAddress=blacklistRMMacAddress, receiveModulationMode=receiveModulationMode, sFPPortAllocation=sFPPortAllocation, syncESlavePort=syncESlavePort, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, deviceMSN=deviceMSN, mABState=mABState, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, unitIdentificationGroup=unitIdentificationGroup, mainPSUPortQLRx=mainPSUPortQLRx, sFPErrorTrap=sFPErrorTrap, dfs=dfs, syslogControlGroup=syslogControlGroup, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, transmitDataRate=transmitDataRate, tdmTable=tdmTable, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, l2CPPriorityTable=l2CPPriorityTable, snmpControl=snmpControl, iPv4Address=iPv4Address, vLANManagementPriority=vLANManagementPriority, nIDULanPortAutoMdix=nIDULanPortAutoMdix, dataPortPauseFrames=dataPortPauseFrames, searchState=searchState, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, configurationInstancedTableNumber=configurationInstancedTableNumber, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, encryptionGroup=encryptionGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, cableDiagnostics=cableDiagnostics, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, licenseMaxLinkRange=licenseMaxLinkRange, tDMGroup=tDMGroup, licenseIEEE1588Support=licenseIEEE1588Support, dNSServerTableNumber=dNSServerTableNumber, dNSServerTableEntry=dNSServerTableEntry, dataBridgingStatusLinked=dataBridgingStatusLinked, tDDControl=tDDControl, mABMaintenanceLevel=mABMaintenanceLevel, channelBandwidth=channelBandwidth, dataBridgingAvailability=dataBridgingAvailability, wirelessLinkStatusLinked=wirelessLinkStatusLinked, syncETrackingState=syncETrackingState, transmitPower=transmitPower, dfsPeaks=dfsPeaks, sNTPSync=sNTPSync, sMTPEnabledMessages=sMTPEnabledMessages, severelyErroredSeconds=severelyErroredSeconds, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, sFPPortAutoMdix=sFPPortAutoMdix, licenseTrialPeriod=licenseTrialPeriod, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, eIRP=eIRP, linkName=linkName, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, cableDiagPair1Results=cableDiagPair1Results, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsTableIndex=dfsTableIndex, transmitterChannels=transmitterChannels, tFTPServerInternetAddressType=tFTPServerInternetAddressType, phyControlInstancedTableEntry=phyControlInstancedTableEntry, vectorError=vectorError)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", bootVersion=bootVersion, dataPortWirelessDownAlert=dataPortWirelessDownAlert, rxColorCode=rxColorCode, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, vLANManagementVID=vLANManagementVID, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, resetGroup=resetGroup, hCMPMaximumLinkRange=hCMPMaximumLinkRange, aAAControlGroup=aAAControlGroup, dNS=dNS, licenseTLSRekey=licenseTLSRekey, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, hCMPLinkSymmetry=hCMPLinkSymmetry, tDMEnabledChannels=tDMEnabledChannels, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, sNTPServerTableEntry=sNTPServerTableEntry, auxPortAllocation=auxPortAllocation, deviceESN=deviceESN, targetRange=targetRange, sNMPTrapTableNumber=sNMPTrapTableNumber, phyControlGroup=phyControlGroup, sFPPortDisabledWarning=sFPPortDisabledWarning, encryptionAlgorithm=encryptionAlgorithm, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, mABNominalModulationMode=mABNominalModulationMode, licenseVersion=licenseVersion, sMTPEmailAlert=sMTPEmailAlert, ethernetStatisticsTable=ethernetStatisticsTable, useVLANForManagementInterfaces=useVLANForManagementInterfaces, licenseInstancedTableIndex=licenseInstancedTableIndex, systemClock=systemClock, capacityVariantMismatchLinked=capacityVariantMismatchLinked, antennaSelection=antennaSelection, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, smtp=smtp, licenseSecurityLevel=licenseSecurityLevel, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, sNTPServerTableIndex=sNTPServerTableIndex, remoteInternetAddressLinked=remoteInternetAddressLinked, byteErrorRatio=byteErrorRatio, installStatusLinked=installStatusLinked, userEnabled=userEnabled, licenseInstancedTableNumber=licenseInstancedTableNumber, ethernetPriorityTable=ethernetPriorityTable, cableDiagnosticsResultTable=cableDiagnosticsResultTable, syncETracking=syncETracking, reset=reset, syncEEquipmentClock=syncEEquipmentClock, routerProtocols=routerProtocols, managementNetworkAccessEnabled=managementNetworkAccessEnabled, aggregateDataRate=aggregateDataRate, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, unitIdentification=unitIdentification, dNSServerInternetAddress=dNSServerInternetAddress, sNTPServerStatus=sNTPServerStatus, licenseEncryption=licenseEncryption, alarmInstancedTableIndex=alarmInstancedTableIndex, configurationInstancedTableEntry=configurationInstancedTableEntry, packetsToInternalStack=packetsToInternalStack, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, alarmsGroup=alarmsGroup)
