...
iso, ModuleIdentity, Unsigned32, Integer32, Counter64, enterprises, Bits, TimeTicks, Counter32, ObjectIdentity, IpAddress, MibIdentifier, Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ModuleIdentity", "Unsigned32", "Integer32", "Counter64", "enterprises", "Bits", "TimeTicks", "Counter32", "ObjectIdentity", "IpAddress", "MibIdentifier", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", mainPSUPortSSMTx=mainPSUPortSSMTx, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, antennaSelection=antennaSelection, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, vectorErrorLinked=vectorErrorLinked, cableDiagPair4Distance=cableDiagPair4Distance, installStatus=installStatus, systemClock=systemClock, l2CPPriorityTableIndex=l2CPPriorityTableIndex, mgmtInstancedTableNumber=mgmtInstancedTableNumber, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, encryptionGroup=encryptionGroup, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, sNTPServerPortNumber=sNTPServerPortNumber, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, tDMChannelLineCode=tDMChannelLineCode, whitelistRMEnabled=whitelistRMEnabled, transparentClockVID=transparentClockVID, lowestTDMModulationMode=lowestTDMModulationMode, portAllocationMismatchTrap=portAllocationMismatchTrap, licenseSFPPortSupport=licenseSFPPortSupport, subnetMask=subnetMask, licenseGasGroup=licenseGasGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, groupID=groupID, tDM=tDM, txMABFrames=txMABFrames, mABTransmissionInterval=mABTransmissionInterval, regulatoryBandTrap=regulatoryBandTrap, sMTPEmailAlert=sMTPEmailAlert, capacityVariantMismatchTrap=capacityVariantMismatchTrap, licenseInstancedTableIndex=licenseInstancedTableIndex, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, dfsTableNumber=dfsTableNumber, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, sMTPServerInternetAddress=sMTPServerInternetAddress, ethernetPriorityTable=ethernetPriorityTable, cableDiagPair2Distance=cableDiagPair2Distance, sNTPServerStatus=sNTPServerStatus, mABMaintenanceLevel=mABMaintenanceLevel, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, sNMPTrapVersion=sNMPTrapVersion, unitName=unitName, range=range, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, apcGroup=apcGroup, configurationInstancedTableNumber=configurationInstancedTableNumber, transmitFreqMHz=transmitFreqMHz, blacklistRMMacAddress=blacklistRMMacAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, remoteMACAddress=remoteMACAddress, tDMInterfaceStatus=tDMInterfaceStatus, mainPSUPortAutoMdix=mainPSUPortAutoMdix, timeZone=timeZone, remoteInternetAddressType=remoteInternetAddressType, tDMChannelStatusTrap=tDMChannelStatusTrap, secureModeAlarmTrap=secureModeAlarmTrap, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tDMChannelLoopback=tDMChannelLoopback, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, managementNetworkAccessEnabled=managementNetworkAccessEnabled, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, auxPortDisabledWarning=auxPortDisabledWarning, subbandLowestFrequency=subbandLowestFrequency, transparentClockVLAN=transparentClockVLAN, bootVersion=bootVersion, sNTPServerTable=sNTPServerTable, daylightSaving=daylightSaving, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, vectorError=vectorError, blacklistRMEnabled=blacklistRMEnabled, transmitPower=transmitPower, tDDSynchronizationMode=tDDSynchronizationMode, dfsTableEntry=dfsTableEntry, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, useVLANForManagementInterfaces=useVLANForManagementInterfaces, pubStats=pubStats, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, dfs=dfs, syslogControl=syslogControl, tdmTable=tdmTable, sFPPortAutoMdix=sFPPortAutoMdix, sNTPSync=sNTPSync, antennaGain=antennaGain, ethernetInstancedTableNumber=ethernetInstancedTableNumber, lbtDetectedTrap=lbtDetectedTrap, tdmTableIndex=tdmTableIndex, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, licenseGroup=licenseGroup, tFTPServerInternetAddress=tFTPServerInternetAddress, licenseRARSupport=licenseRARSupport, phyControlGroup=phyControlGroup, dataPortPauseFrames=dataPortPauseFrames, syslogState=syslogState, phyControl=phyControl, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, channelChangeTrap=channelChangeTrap, transmitChannel=transmitChannel, cableDiagnosticsPorts=cableDiagnosticsPorts, dNSServerTable=dNSServerTable, supplementary=supplementary, licenseBandwidthCap=licenseBandwidthCap, syncETracking=syncETracking, licenseGroupAccess=licenseGroupAccess, severelyErroredSeconds=severelyErroredSeconds, txColorCode=txColorCode, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, ptmp=ptmp, dNSPrimaryServer=dNSPrimaryServer, receiveFreqMHz=receiveFreqMHz, cableDiagnostics=cableDiagnostics, dfsTable=dfsTable, iPv6GatewayAddress=iPv6GatewayAddress, syncEEquipmentClock=syncEEquipmentClock, sntp=sntp, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, iPv6Address=iPv6Address, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, l2CPPriorityTable=l2CPPriorityTable, sNMPTrapTableEntry=sNMPTrapTableEntry, managementGroup=managementGroup, dataBridgingAvailability=dataBridgingAvailability, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, licenseCountry=licenseCountry, noWirelessChannelAvailable=noWirelessChannelAvailable, ethernetPriorityTableEntry=ethernetPriorityTableEntry, pubInstancedStatsTable=pubInstancedStatsTable, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, userRole=userRole, tDDSynchronizationStatus=tDDSynchronizationStatus, remoteInternetAddress=remoteInternetAddress, dNSServerTableEntry=dNSServerTableEntry, syncESlavePort=syncESlavePort, licenseTDDSyncSupport=licenseTDDSyncSupport, mABNominalTransmitCapacity=mABNominalTransmitCapacity, dNSServerTableNumber=dNSServerTableNumber, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, incompatibleRegulatoryBands=incompatibleRegulatoryBands, licenseHCMPSupport=licenseHCMPSupport, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, licenseEncryption=licenseEncryption, mPLSTCPriorityTable=mPLSTCPriorityTable, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, licenseRegulatoryBandsList=licenseRegulatoryBandsList, management=management, syncETrackingState=syncETrackingState, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitterChannels=transmitterChannels, receivePowerLinked=receivePowerLinked, receiveModulationModeLinked=receiveModulationModeLinked, ptp670=ptp670, sNTPServerTimeout=sNTPServerTimeout, userTableNumber=userTableNumber, dNSServerTableIndex=dNSServerTableIndex, snmpControl=snmpControl, dfsPeaks=dfsPeaks, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, rangingMode=rangingMode, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, cambium=cambium, auxPortStatusTrap=auxPortStatusTrap, channelBandwidth=channelBandwidth, siteName=siteName, cableDiagPair1Distance=cableDiagPair1Distance, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, sNTPState=sNTPState, auxPortSSMTx=auxPortSSMTx, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, ptpTrapPrefix=ptpTrapPrefix, userTableIndex=userTableIndex, syslogStateTrap=syslogStateTrap, mgmtInstancedTableIndex=mgmtInstancedTableIndex, maxLinkRangeExceeded=maxLinkRangeExceeded, sMTPEnabledMessages=sMTPEnabledMessages, encryptionAlgorithm=encryptionAlgorithm, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, unitOutOfCalibration=unitOutOfCalibration, userName=userName, sNTPLastSync=sNTPLastSync, mainPSUPortStatus=mainPSUPortStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ptp=ptp, secureModeAlarm=secureModeAlarm, dNSGroup=dNSGroup, pubStatsGroup=pubStatsGroup, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, dfsGroup=dfsGroup, encryption=encryption, sNTPServerRetries=sNTPServerRetries, authorizationMethod=authorizationMethod, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, searchStateLinked=searchStateLinked, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, tDMConfigurationMismatch=tDMConfigurationMismatch, tDMInterfaceControl=tDMInterfaceControl, authorizationControl=authorizationControl, linkLoss=linkLoss, transparentClockPort=transparentClockPort, iPv4Address=iPv4Address, hTTPPortNumber=hTTPPortNumber, cableDiagPair3Distance=cableDiagPair3Distance, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, remoteUnitName=remoteUnitName, configurationInstancedTableEntry=configurationInstancedTableEntry, deviceMACAddress=deviceMACAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, configurationInstancedTableIndex=configurationInstancedTableIndex, ethernetPriorityTableIndex=ethernetPriorityTableIndex, licenseMaxLinkRange=licenseMaxLinkRange, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, sFPPortQLRx=sFPPortQLRx, sMTPServerPortNumber=sMTPServerPortNumber, dNSServerPortNumber=dNSServerPortNumber, subbandHighestFrequency=subbandHighestFrequency, hTTPSAccessEnabled=hTTPSAccessEnabled, oOBPriorityQueueMapping=oOBPriorityQueueMapping, alarmInstancedTable=alarmInstancedTable, licenseTrialPeriod=licenseTrialPeriod, l2CPPriorityTableNumber=l2CPPriorityTableNumber, deviceMSN=deviceMSN, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, snmpControlGroup=snmpControlGroup, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, auxPortQLRx=auxPortQLRx, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dfsMeans=dfsMeans, sNTPServerInternetAddress=sNTPServerInternetAddress, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, alarmsGroup=alarmsGroup, ethernetGroup=ethernetGroup, supplementaryGroup=supplementaryGroup, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, auxPortQLTx=auxPortQLTx, licenseSyncESupport=licenseSyncESupport, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, ethernet=ethernet, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, extendedSpectrumScanning=extendedSpectrumScanning)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sNTPServerInternetAddressType=sNTPServerInternetAddressType, transmitFreqKHz=transmitFreqKHz, masterSlaveMode=masterSlaveMode, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, notificationsGroup=notificationsGroup, tFTPClient=tFTPClient, dfsTableIndex=dfsTableIndex, licenseIPv6Support=licenseIPv6Support, latitude=latitude, cableDiagnosticsWarning=cableDiagnosticsWarning, ethernetStatisticsTable=ethernetStatisticsTable, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sMTPServerInternetAddressType=sMTPServerInternetAddressType, userTable=userTable, gatewayIPAddress=gatewayIPAddress, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, sFPPortSyncERxStatus=sFPPortSyncERxStatus, wirelessLinkAvailability=wirelessLinkAvailability, tempPcb=tempPcb, resetGroup=resetGroup, sNMPv3Enable=sNMPv3Enable, wirelessOutAllOctets=wirelessOutAllOctets, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, hTTPAccessEnabled=hTTPAccessEnabled, tdmTableNumber=tdmTableNumber, unavailableSeconds=unavailableSeconds, softwareVersion=softwareVersion, license=license, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, aggregateDataRate=aggregateDataRate, ptpTraps=ptpTraps, reset=reset, tDMChannelCableLength=tDMChannelCableLength, linkModeOptimization=linkModeOptimization, nIDULanPortStatus=nIDULanPortStatus, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, ethernetStatisticsDataSource=ethernetStatisticsDataSource, portAllocationMismatchLinked=portAllocationMismatchLinked, licenseVersion=licenseVersion, iPDSCPPriorityTable=iPDSCPPriorityTable, configuration=configuration, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, authorizationControlGroup=authorizationControlGroup, cableDiagnosticsResultTable=cableDiagnosticsResultTable, transparentClock=transparentClock, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, enabledDiagnosticAlarms=enabledDiagnosticAlarms, linkName=linkName, productName=productName, dataBridgingStatusAlarm=dataBridgingStatusAlarm, dNS=dNS, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, mgmtInstancedTable=mgmtInstancedTable, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, maximumNumberOfSlaves=maximumNumberOfSlaves, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, hTTPSPortNumber=hTTPSPortNumber, sFPErrorTrap=sFPErrorTrap, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, sFPPortAllocation=sFPPortAllocation, rawReceivePowerLinked=rawReceivePowerLinked, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, sFPPortAutoNegotiation=sFPPortAutoNegotiation, sMTPSourceEmailAddress=sMTPSourceEmailAddress, mABHoldoffPeriod=mABHoldoffPeriod, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, cableLoss=cableLoss, bridge=bridge, ethernetPriorityTableNumber=ethernetPriorityTableNumber, nIDULanPortAutoMdix=nIDULanPortAutoMdix, unitIdentification=unitIdentification, installationMode=installationMode, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, cableDiagPair1Results=cableDiagPair1Results, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, aggregateDataRateLinked=aggregateDataRateLinked, apc=apc, portAllocationMismatch=portAllocationMismatch, linkSymmetry=linkSymmetry, sntpGroup=sntpGroup, iPVersion=iPVersion, targetMACAddress=targetMACAddress, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, authorizationControlTable=authorizationControlTable, licenseInstancedTableNumber=licenseInstancedTableNumber, installStatusLinked=installStatusLinked, receiveModulationModeDetail=receiveModulationModeDetail, unitIdentificationGroup=unitIdentificationGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNTPPollInterval=sNTPPollInterval, telnetAccessEnabled=telnetAccessEnabled, hardwareVersion=hardwareVersion, aAAControl=aAAControl, l2CPPriorityTableEntry=l2CPPriorityTableEntry, mainPSUPortAllocation=mainPSUPortAllocation, cableDiagPair3Results=cableDiagPair3Results, configurationGroup=configurationGroup, ethernetInstancedTable=ethernetInstancedTable, userTableEntry=userTableEntry, regulatoryBand=regulatoryBand, licenseInstancedTable=licenseInstancedTable, mainPSUPortStatusTrap=mainPSUPortStatusTrap, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, transmitModulationModeLinked=transmitModulationModeLinked, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, alarmInstancedTableNumber=alarmInstancedTableNumber, transmitDataRateLinked=transmitDataRateLinked, phyStatus=phyStatus, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, maximumTransmitPower=maximumTransmitPower, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, localPacketFiltering=localPacketFiltering, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, installStatusTrap=installStatusTrap, nIDULanPortStatusTrap=nIDULanPortStatusTrap, sNTPServerTableEntry=sNTPServerTableEntry, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, alarmInstancedTableIndex=alarmInstancedTableIndex, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, phyControlInstancedTable=phyControlInstancedTable, licenseSecurityLevel=licenseSecurityLevel, byteErrorRatioLinked=byteErrorRatioLinked, telnetPortNumber=telnetPortNumber, mgmtInstancedTableEntry=mgmtInstancedTableEntry, sFPPortStatus=sFPPortStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, userPassword=userPassword, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, phyStatusGroup=phyStatusGroup, sFPPortQLTx=sFPPortQLTx, userEnabled=userEnabled, tDDControlGroup=tDDControlGroup, routerProtocols=routerProtocols, alarmInstancedTableEntry=alarmInstancedTableEntry, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, deviceESN=deviceESN, auxPortStatus=auxPortStatus, signalStrengthRatio=signalStrengthRatio, sFPError=sFPError, remoteMACAddressLinked=remoteMACAddressLinked, receiveFreqKHz=receiveFreqKHz, dNSServerInternetAddress=dNSServerInternetAddress, remoteInternetAddressLinked=remoteInternetAddressLinked, sNTPPrimaryServer=sNTPPrimaryServer, cableDiagnosticsControl=cableDiagnosticsControl, syslogClientTrap=syslogClientTrap, auxPortSyncERxStatus=auxPortSyncERxStatus, smtp=smtp, phyControlInstancedTableNumber=phyControlInstancedTableNumber, cableDiagnosticsGroup=cableDiagnosticsGroup, erroredSeconds=erroredSeconds, authorizationControlTableNumber=authorizationControlTableNumber, transmitModulationMode=transmitModulationMode, sNTPSyncTrap=sNTPSyncTrap, routerProtocolsGroup=routerProtocolsGroup, ptpCompliance=ptpCompliance, rangeLinked=rangeLinked, rawReceivePower=rawReceivePower, mABState=mABState, whitelistRMMacAddress=whitelistRMMacAddress, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, targetRange=targetRange, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, hCMPLinkSymmetry=hCMPLinkSymmetry, vLANManagementVID=vLANManagementVID, ptpGroups=ptpGroups, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, wirelessLinkStatusLinked=wirelessLinkStatusLinked, packetsToInternalStack=packetsToInternalStack, sFPPortSSMTx=sFPPortSSMTx, transmitDataRate=transmitDataRate, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, eIRP=eIRP, licenseIEEE1588Support=licenseIEEE1588Support, enableTransmission=enableTransmission, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, dataPortWirelessDownAlert=dataPortWirelessDownAlert, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, remoteMaximumTransmitPower=remoteMaximumTransmitPower, searchState=searchState, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, secondarySoftwareVersion=secondarySoftwareVersion, longitude=longitude, sFPPortStatusTrap=sFPPortStatusTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, frequencyVariant=frequencyVariant, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tdmTableEntry=tdmTableEntry, sNMPTrapTable=sNMPTrapTable, qOSPriorityScheme=qOSPriorityScheme, transmitPowerLinked=transmitPowerLinked, cableDiagPair4Results=cableDiagPair4Results, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, tDMEnabledChannels=tDMEnabledChannels, dNSServerInternetAddressType=dNSServerInternetAddressType, mABProtocolVLANPriority=mABProtocolVLANPriority, signalStrengthRatioLinked=signalStrengthRatioLinked, dataBridgingStatusLinked=dataBridgingStatusLinked, sNTPServerTableIndex=sNTPServerTableIndex, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, hCMPMaximumLinkRange=hCMPMaximumLinkRange, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, mainPSUPortQLRx=mainPSUPortQLRx, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, linkModeOptimizationMismatch=linkModeOptimizationMismatch, licenseTLSRekey=licenseTLSRekey, auxPortAcceptedQLRx=auxPortAcceptedQLRx, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, packetsFromInternalStack=packetsFromInternalStack, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, authorizationControlTableIndex=authorizationControlTableIndex, accessMethod=accessMethod, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, PYSNMP_MODULE_ID=cambium, smtpGroup=smtpGroup, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, licenseOOBManagementSupport=licenseOOBManagementSupport, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, sNMPTrapInternetAddress=sNMPTrapInternetAddress, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, wirelessOutEthernetOctets=wirelessOutEthernetOctets, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, versions=versions, phyControlInstancedTableIndex=phyControlInstancedTableIndex, sFPPortDisabledWarning=sFPPortDisabledWarning, tFTPServerInternetAddressType=tFTPServerInternetAddressType, byteErrorRatio=byteErrorRatio, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, configurationInstancedTable=configurationInstancedTable, wirelessTopology=wirelessTopology, ethernetInstancedTableIndex=ethernetInstancedTableIndex, useVLANForMABProtocol=useVLANForMABProtocol, bridgeGroup=bridgeGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, phyInstancedStatusTable=phyInstancedStatusTable, iPv6PrefixLength=iPv6PrefixLength, sNMPEnabledTraps=sNMPEnabledTraps, receivePower=receivePower, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, dataBridgingStatus=dataBridgingStatus)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, receiveModulationMode=receiveModulationMode, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, licenseCapacity=licenseCapacity, capacityVariantMismatch=capacityVariantMismatch, rxColorCode=rxColorCode, tDMGroup=tDMGroup, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, productVariant=productVariant, mABNominalModulationMode=mABNominalModulationMode, tDDSynchronizationAlarm=tDDSynchronizationAlarm, syslogControlGroup=syslogControlGroup, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, versionsGroup=versionsGroup, auxPortAllocation=auxPortAllocation, wirelessOutOctets=wirelessOutOctets, lowestDataModulationMode=lowestDataModulationMode, tDMChannelStatus=tDMChannelStatus, receiveDataRateLinked=receiveDataRateLinked, installArmState=installArmState, sNTPServerTableNumber=sNTPServerTableNumber, cableDiagPair2Results=cableDiagPair2Results, dSCPManagementPriority=dSCPManagementPriority, installArmStateTrap=installArmStateTrap, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, authorizationControlTableEntry=authorizationControlTableEntry, systemReset=systemReset, sNMPCommunityString=sNMPCommunityString, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, wirelessLinkStatus=wirelessLinkStatus, dNSResolver=dNSResolver, phyControlInstancedTableEntry=phyControlInstancedTableEntry, vLANManagementPriority=vLANManagementPriority, capacityVariantMismatchLinked=capacityVariantMismatchLinked, ethernetInstancedTableEntry=ethernetInstancedTableEntry, mainPSUPortQLTx=mainPSUPortQLTx, sNMPTrapTableIndex=sNMPTrapTableIndex, licenseInstancedTableEntry=licenseInstancedTableEntry, alarms=alarms, auxPortConfigurationMismatch=auxPortConfigurationMismatch, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, licenseUnitSerialNumber=licenseUnitSerialNumber, receiveChannel=receiveChannel, receiveDataRate=receiveDataRate, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, tFTPServerPortNumber=tFTPServerPortNumber, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, sNMPPortNumber=sNMPPortNumber, mABProtocolVID=mABProtocolVID, tDDControl=tDDControl, syslogClient=syslogClient, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, linkLossLinked=linkLossLinked, remoteUnitNameLinked=remoteUnitNameLinked, aAAControlGroup=aAAControlGroup, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, licenseIssueNumber=licenseIssueNumber, altitude=altitude)
