...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", ptpTraps=ptpTraps, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, cableLoss=cableLoss, wirelessLinkAvailability=wirelessLinkAvailability, iPv6Address=iPv6Address, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, ethernetStatisticsTable=ethernetStatisticsTable, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, dataBridgingStatus=dataBridgingStatus, cableDiagnosticsControl=cableDiagnosticsControl, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, cableDiagnostics=cableDiagnostics, phyInstancedStatusTable=phyInstancedStatusTable, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, configurationGroup=configurationGroup, dfsGroup=dfsGroup, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, eIRP=eIRP, searchState=searchState, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, authorizationControl=authorizationControl, byteErrorRatio=byteErrorRatio, sNMPCommunityString=sNMPCommunityString, tDM=tDM, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, sNMPTrapInternetAddress=sNMPTrapInternetAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, supplementaryGroup=supplementaryGroup, deviceMSN=deviceMSN, dNSPrimaryServer=dNSPrimaryServer, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, wirelessOutOctets=wirelessOutOctets, altitude=altitude, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, transparentClock=transparentClock, ethernetInstancedTableNumber=ethernetInstancedTableNumber, dataBridgingAvailability=dataBridgingAvailability, mainPSUPortAllocation=mainPSUPortAllocation, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, auxPortQLRx=auxPortQLRx, dNSServerTableIndex=dNSServerTableIndex, licenseTDDSyncSupport=licenseTDDSyncSupport, nIDULanPortAutoMdix=nIDULanPortAutoMdix, userTable=userTable, sFPPortAllocation=sFPPortAllocation, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, cableDiagPair4Results=cableDiagPair4Results, licenseSFPPortSupport=licenseSFPPortSupport, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, phyControlInstancedTable=phyControlInstancedTable, mABTransmissionInterval=mABTransmissionInterval, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, bridgeGroup=bridgeGroup, ethernetPriorityTableIndex=ethernetPriorityTableIndex, remoteInternetAddressLinked=remoteInternetAddressLinked, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, auxPortSSMTx=auxPortSSMTx, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, syncESlavePort=syncESlavePort, pubStats=pubStats, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, configuration=configuration, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitFreqKHz=transmitFreqKHz, dfsTableEntry=dfsTableEntry, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, ptmp=ptmp, oOBPriorityQueueMapping=oOBPriorityQueueMapping, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, tDDControl=tDDControl, configurationInstancedTableNumber=configurationInstancedTableNumber, tDMInterfaceControl=tDMInterfaceControl, license=license, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, sFPPortQLRx=sFPPortQLRx, regulatoryBand=regulatoryBand, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, wirelessOutEthernetOctets=wirelessOutEthernetOctets, alarmInstancedTableNumber=alarmInstancedTableNumber, receiveDataRateLinked=receiveDataRateLinked, productName=productName, auxPortAllocation=auxPortAllocation, dNSGroup=dNSGroup, alarmInstancedTable=alarmInstancedTable, licenseCountry=licenseCountry, transmitModulationMode=transmitModulationMode, secureModeAlarmTrap=secureModeAlarmTrap, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPServerStatus=sNTPServerStatus, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, rangeLinked=rangeLinked, receiveModulationModeDetail=receiveModulationModeDetail, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, phyControlInstancedTableEntry=phyControlInstancedTableEntry, wirelessTopology=wirelessTopology, linkSymmetry=linkSymmetry, sNMPTrapVersion=sNMPTrapVersion, ptp=ptp, tDMChannelLoopback=tDMChannelLoopback, mABHoldoffPeriod=mABHoldoffPeriod, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, transmitFreqMHz=transmitFreqMHz, wirelessOutAllOctets=wirelessOutAllOctets, installStatusTrap=installStatusTrap, syncETracking=syncETracking, accessMethod=accessMethod, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, authorizationControlGroup=authorizationControlGroup, cableDiagnosticsResultTable=cableDiagnosticsResultTable, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, bootVersion=bootVersion, lowestTDMModulationMode=lowestTDMModulationMode, deviceESN=deviceESN, lbtDetectedTrap=lbtDetectedTrap, receivePowerLinked=receivePowerLinked, licenseIPv6Support=licenseIPv6Support, transmitPowerLinked=transmitPowerLinked, useVLANForMABProtocol=useVLANForMABProtocol, pubStatsGroup=pubStatsGroup, capacityVariantMismatch=capacityVariantMismatch, sNTPServerTableEntry=sNTPServerTableEntry, gatewayIPAddress=gatewayIPAddress, licenseCapacity=licenseCapacity, transparentClockPort=transparentClockPort, dfsMeans=dfsMeans, userEnabled=userEnabled, userTableNumber=userTableNumber, mABNominalTransmitCapacity=mABNominalTransmitCapacity, licenseTrialPeriod=licenseTrialPeriod, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, mABProtocolVID=mABProtocolVID, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, mPLSTCPriorityTable=mPLSTCPriorityTable, tDDSynchronizationAlarm=tDDSynchronizationAlarm, licenseInstancedTable=licenseInstancedTable, smtpGroup=smtpGroup, licenseSyncESupport=licenseSyncESupport, sNMPv3Enable=sNMPv3Enable, maximumTransmitPower=maximumTransmitPower, telnetAccessEnabled=telnetAccessEnabled, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, vectorErrorLinked=vectorErrorLinked, authorizationControlTableEntry=authorizationControlTableEntry, latitude=latitude, regulatoryBandTrap=regulatoryBandTrap, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, ethernetPriorityTableEntry=ethernetPriorityTableEntry, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, sFPPortStatus=sFPPortStatus, txColorCode=txColorCode, noWirelessChannelAvailable=noWirelessChannelAvailable, sNTPServerTimeout=sNTPServerTimeout, whitelistRMMacAddress=whitelistRMMacAddress, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, receiveModulationModeLinked=receiveModulationModeLinked, sFPError=sFPError, sMTPSourceEmailAddress=sMTPSourceEmailAddress, unavailableSeconds=unavailableSeconds, dataPortPauseFrames=dataPortPauseFrames, managementNetworkAccessEnabled=managementNetworkAccessEnabled, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, mainPSUPortQLTx=mainPSUPortQLTx, remoteMACAddressLinked=remoteMACAddressLinked, cableDiagPair4Distance=cableDiagPair4Distance, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, localPacketFiltering=localPacketFiltering, mABNominalModulationMode=mABNominalModulationMode, sFPErrorTrap=sFPErrorTrap, portAllocationMismatchTrap=portAllocationMismatchTrap, syslogControl=syslogControl, hTTPPortNumber=hTTPPortNumber, syslogState=syslogState, sFPPortAutoNegotiation=sFPPortAutoNegotiation, sFPPortAutoMdix=sFPPortAutoMdix, userPassword=userPassword, dSCPManagementPriority=dSCPManagementPriority, rawReceivePower=rawReceivePower, authorizationControlTable=authorizationControlTable, mainPSUPortQLRx=mainPSUPortQLRx, enableTransmission=enableTransmission, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, iPDSCPPriorityTable=iPDSCPPriorityTable, transmitDataRate=transmitDataRate, transmitModulationModeLinked=transmitModulationModeLinked, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, transmitterChannels=transmitterChannels, routerProtocolsGroup=routerProtocolsGroup, systemClock=systemClock, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, tDDControlGroup=tDDControlGroup, antennaSelection=antennaSelection, tDMChannelLineCode=tDMChannelLineCode, iPv6PrefixLength=iPv6PrefixLength, tFTPClient=tFTPClient, licenseMaxLinkRange=licenseMaxLinkRange, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, portAllocationMismatchLinked=portAllocationMismatchLinked, l2CPPriorityTableEntry=l2CPPriorityTableEntry, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, userRole=userRole, encryptionGroup=encryptionGroup, whitelistRMEnabled=whitelistRMEnabled, ptp670=ptp670, auxPortConfigurationMismatch=auxPortConfigurationMismatch, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, linkModeOptimization=linkModeOptimization, byteErrorRatioLinked=byteErrorRatioLinked, mABProtocolVLANPriority=mABProtocolVLANPriority, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, receiveFreqMHz=receiveFreqMHz, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, authorizationControlTableNumber=authorizationControlTableNumber, nIDULanPortStatusTrap=nIDULanPortStatusTrap, alarmsGroup=alarmsGroup, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, syslogStateTrap=syslogStateTrap, tDMGroup=tDMGroup, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, secureModeAlarm=secureModeAlarm, hCMPMaximumLinkRange=hCMPMaximumLinkRange, iPv4Address=iPv4Address, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, installStatusLinked=installStatusLinked, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, dataPortWirelessDownAlert=dataPortWirelessDownAlert, licenseVersion=licenseVersion, subnetMask=subnetMask, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dfsPeaks=dfsPeaks, licenseTLSRekey=licenseTLSRekey, userName=userName, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, licenseHCMPSupport=licenseHCMPSupport, apcGroup=apcGroup, licenseInstancedTableEntry=licenseInstancedTableEntry, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, snmpControlGroup=snmpControlGroup, sNTPServerTableIndex=sNTPServerTableIndex, timeZone=timeZone, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", receiveDataRate=receiveDataRate, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, l2CPPriorityTable=l2CPPriorityTable, dfsTableIndex=dfsTableIndex, dNSServerInternetAddressType=dNSServerInternetAddressType, maximumNumberOfSlaves=maximumNumberOfSlaves, auxPortDisabledWarning=auxPortDisabledWarning, deviceMACAddress=deviceMACAddress, sNTPPrimaryServer=sNTPPrimaryServer, sMTPEnabledMessages=sMTPEnabledMessages, hardwareVersion=hardwareVersion, ethernet=ethernet, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, sFPPortSSMTx=sFPPortSSMTx, cambium=cambium, sNTPServerPortNumber=sNTPServerPortNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, mainPSUPortSSMTx=mainPSUPortSSMTx, resetGroup=resetGroup, managementPortWirelessDownAlert=managementPortWirelessDownAlert, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, mainPSUPortStatus=mainPSUPortStatus, tdmTableNumber=tdmTableNumber, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, masterSlaveMode=masterSlaveMode, versionsGroup=versionsGroup, tempPcb=tempPcb, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, cableDiagPair1Results=cableDiagPair1Results, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, sntp=sntp, blacklistRMEnabled=blacklistRMEnabled, lowestDataModulationMode=lowestDataModulationMode, licenseInstancedTableIndex=licenseInstancedTableIndex, routerProtocols=routerProtocols, subbandHighestFrequency=subbandHighestFrequency, sNTPServerTable=sNTPServerTable, auxPortQLTx=auxPortQLTx, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, systemReset=systemReset, extendedSpectrumScanning=extendedSpectrumScanning, iPv6GatewayAddress=iPv6GatewayAddress, phyStatus=phyStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, hTTPAccessEnabled=hTTPAccessEnabled, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, packetsToInternalStack=packetsToInternalStack, supplementary=supplementary, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, channelBandwidth=channelBandwidth, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, sMTPServerInternetAddress=sMTPServerInternetAddress, phyControlInstancedTableIndex=phyControlInstancedTableIndex, sNMPTrapTable=sNMPTrapTable, configurationInstancedTableIndex=configurationInstancedTableIndex, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, authorizationMethod=authorizationMethod, mgmtInstancedTableIndex=mgmtInstancedTableIndex, ethernetPriorityTableNumber=ethernetPriorityTableNumber, softwareVersion=softwareVersion, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, sNMPEnabledTraps=sNMPEnabledTraps, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNTPServerInternetAddressType=sNTPServerInternetAddressType, tdmTableIndex=tdmTableIndex, range=range, ethernetInstancedTable=ethernetInstancedTable, searchStateLinked=searchStateLinked, tDDSynchronizationStatus=tDDSynchronizationStatus, remoteUnitName=remoteUnitName, sNMPTrapTableEntry=sNMPTrapTableEntry, unitIdentification=unitIdentification, bridge=bridge, auxPortAcceptedQLRx=auxPortAcceptedQLRx, targetRange=targetRange, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, rxColorCode=rxColorCode, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, installationMode=installationMode, dfsTable=dfsTable, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, snmpControl=snmpControl, licenseBandwidthCap=licenseBandwidthCap, dataBridgingStatusAlarm=dataBridgingStatusAlarm, sNMPPortNumber=sNMPPortNumber, configurationInstancedTable=configurationInstancedTable, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, longitude=longitude, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, licenseRegulatoryBandsList=licenseRegulatoryBandsList, licenseGasGroup=licenseGasGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dNSResolver=dNSResolver, installArmState=installArmState, transmitChannel=transmitChannel, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, maxLinkRangeExceeded=maxLinkRangeExceeded, userTableIndex=userTableIndex, cableDiagPair3Distance=cableDiagPair3Distance, aggregateDataRateLinked=aggregateDataRateLinked, auxPortSyncERxStatus=auxPortSyncERxStatus, ethernetStatisticsDataSource=ethernetStatisticsDataSource, sMTPServerPortNumber=sMTPServerPortNumber, rawReceivePowerLinked=rawReceivePowerLinked, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, licenseRARSupport=licenseRARSupport, channelChangeTrap=channelChangeTrap, ptpTrapPrefix=ptpTrapPrefix, ethernetInstancedTableEntry=ethernetInstancedTableEntry, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, subbandLowestFrequency=subbandLowestFrequency, remoteUnitNameLinked=remoteUnitNameLinked, licenseOOBManagementSupport=licenseOOBManagementSupport, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, mainPSUPortAutoMdix=mainPSUPortAutoMdix, blacklistRMMacAddress=blacklistRMMacAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tDMChannelStatusTrap=tDMChannelStatusTrap, cableDiagPair2Results=cableDiagPair2Results, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, syslogClientTrap=syslogClientTrap, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, tFTPServerPortNumber=tFTPServerPortNumber, licenseGroup=licenseGroup, frequencyVariant=frequencyVariant, mgmtInstancedTableNumber=mgmtInstancedTableNumber, dNSServerPortNumber=dNSServerPortNumber, dfs=dfs, licenseIEEE1588Support=licenseIEEE1588Support, alarmInstancedTableIndex=alarmInstancedTableIndex, notificationsGroup=notificationsGroup, cableDiagnosticsGroup=cableDiagnosticsGroup, receiveChannel=receiveChannel, dfsTableNumber=dfsTableNumber, sNTPState=sNTPState, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, sNTPPollInterval=sNTPPollInterval, sNTPServerInternetAddress=sNTPServerInternetAddress, phyControlInstancedTableNumber=phyControlInstancedTableNumber, tDMEnabledChannels=tDMEnabledChannels, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, syslogClient=syslogClient, sNTPSync=sNTPSync, aAAControl=aAAControl, licenseInstancedTableNumber=licenseInstancedTableNumber, remoteInternetAddress=remoteInternetAddress, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, receivePower=receivePower, mABState=mABState, reset=reset, sNTPSyncTrap=sNTPSyncTrap, rangingMode=rangingMode, portAllocationMismatch=portAllocationMismatch, incompatibleMasterAndSlave=incompatibleMasterAndSlave, antennaGain=antennaGain, tDMInterfaceStatus=tDMInterfaceStatus, sFPPortDisabledWarning=sFPPortDisabledWarning, sMTPEmailAlert=sMTPEmailAlert, dNSServerTableNumber=dNSServerTableNumber, encryptionAlgorithm=encryptionAlgorithm, sNTPServerTableNumber=sNTPServerTableNumber, alarmInstancedTableEntry=alarmInstancedTableEntry, sNTPLastSync=sNTPLastSync, signalStrengthRatio=signalStrengthRatio, sFPPortStatusTrap=sFPPortStatusTrap, severelyErroredSeconds=severelyErroredSeconds, alarms=alarms, encryption=encryption, installStatus=installStatus, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, mABMaintenanceLevel=mABMaintenanceLevel, qOSPriorityScheme=qOSPriorityScheme, sFPPortQLTx=sFPPortQLTx, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, tDMChannelStatus=tDMChannelStatus, capacityVariantMismatchTrap=capacityVariantMismatchTrap, ptpGroups=ptpGroups, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, licenseSecurityLevel=licenseSecurityLevel, authorizationControlTableIndex=authorizationControlTableIndex, installArmStateTrap=installArmStateTrap, auxPortStatusTrap=auxPortStatusTrap, sntpGroup=sntpGroup, mainPSUPortStatusTrap=mainPSUPortStatusTrap, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, receiveFreqKHz=receiveFreqKHz, configurationInstancedTableEntry=configurationInstancedTableEntry, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, phyControl=phyControl, groupID=groupID, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, licenseEncryption=licenseEncryption, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, mgmtInstancedTableEntry=mgmtInstancedTableEntry, ethernetInstancedTableIndex=ethernetInstancedTableIndex, phyControlGroup=phyControlGroup, ethernetGroup=ethernetGroup, tdmTable=tdmTable, vectorError=vectorError, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, userTableEntry=userTableEntry, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, dNSServerInternetAddress=dNSServerInternetAddress, PYSNMP_MODULE_ID=cambium, syslogControlGroup=syslogControlGroup, unitIdentificationGroup=unitIdentificationGroup, tFTPServerInternetAddress=tFTPServerInternetAddress, cableDiagPair3Results=cableDiagPair3Results, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, wirelessLinkStatusLinked=wirelessLinkStatusLinked, remoteMACAddress=remoteMACAddress, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, productVariant=productVariant, linkLoss=linkLoss, aAAControlGroup=aAAControlGroup, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, phyStatusGroup=phyStatusGroup, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, sFPPortSyncERxStatus=sFPPortSyncERxStatus, tDMChannelCableLength=tDMChannelCableLength, sNTPServerRetries=sNTPServerRetries, telnetPortNumber=telnetPortNumber, versions=versions, tdmTableEntry=tdmTableEntry, transmitDataRateLinked=transmitDataRateLinked, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, management=management, targetMACAddress=targetMACAddress, mgmtInstancedTable=mgmtInstancedTable, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, hTTPSPortNumber=hTTPSPortNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, signalStrengthRatioLinked=signalStrengthRatioLinked, syncETrackingState=syncETrackingState, licenseGroupAccess=licenseGroupAccess, cableDiagPair1Distance=cableDiagPair1Distance, iPVersion=iPVersion, dNSServerTable=dNSServerTable, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", l2CPPriorityTableNumber=l2CPPriorityTableNumber, siteName=siteName, unitOutOfCalibration=unitOutOfCalibration, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, syncEEquipmentClock=syncEEquipmentClock, daylightSaving=daylightSaving, ethernetPriorityTable=ethernetPriorityTable, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, transmitPower=transmitPower, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, cableDiagnosticsPorts=cableDiagnosticsPorts, linkLossLinked=linkLossLinked, managementGroup=managementGroup, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, incompatibleRegulatoryBands=incompatibleRegulatoryBands, auxPortStatus=auxPortStatus, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, wirelessLinkStatus=wirelessLinkStatus, ptpCompliance=ptpCompliance, nIDULanPortStatus=nIDULanPortStatus, hCMPLinkSymmetry=hCMPLinkSymmetry, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, dataBridgingStatusLinked=dataBridgingStatusLinked, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, capacityVariantMismatchLinked=capacityVariantMismatchLinked, tDDSynchronizationMode=tDDSynchronizationMode, cableDiagPair2Distance=cableDiagPair2Distance, sNMPTrapPortNumber=sNMPTrapPortNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, txMABFrames=txMABFrames, packetsFromInternalStack=packetsFromInternalStack, secondarySoftwareVersion=secondarySoftwareVersion, licenseIssueNumber=licenseIssueNumber, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, receiveModulationMode=receiveModulationMode, transparentClockVID=transparentClockVID, sMTPServerInternetAddressType=sMTPServerInternetAddressType, cableDiagnosticsWarning=cableDiagnosticsWarning, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, transparentClockVLAN=transparentClockVLAN, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, erroredSeconds=erroredSeconds, dNS=dNS, licenseUnitSerialNumber=licenseUnitSerialNumber, linkName=linkName, aggregateDataRate=aggregateDataRate, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, remoteInternetAddressType=remoteInternetAddressType, pubInstancedStatsTable=pubInstancedStatsTable, vLANManagementPriority=vLANManagementPriority, apc=apc, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, smtp=smtp, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, tDMConfigurationMismatch=tDMConfigurationMismatch, dNSServerTableEntry=dNSServerTableEntry, vLANManagementVID=vLANManagementVID, unitName=unitName)
