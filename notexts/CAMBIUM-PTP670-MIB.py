...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", licenseInstancedTableIndex=licenseInstancedTableIndex, licenseTLSRekey=licenseTLSRekey, tDMGroup=tDMGroup, apcGroup=apcGroup, remoteInternetAddress=remoteInternetAddress, PYSNMP_MODULE_ID=cambium, iPDSCPPriorityTable=iPDSCPPriorityTable, mABTransmissionInterval=mABTransmissionInterval, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, unitIdentification=unitIdentification, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, transmitterChannels=transmitterChannels, tDMConfigurationMismatch=tDMConfigurationMismatch, dNSGroup=dNSGroup, phyInstancedStatusTable=phyInstancedStatusTable, receiveFreqKHz=receiveFreqKHz, ethernet=ethernet, dfsTable=dfsTable, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, regulatoryBand=regulatoryBand, userTableNumber=userTableNumber, ethernetStatisticsTable=ethernetStatisticsTable, txColorCode=txColorCode, cableDiagPair3Distance=cableDiagPair3Distance, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, userPassword=userPassword, tDDSynchronizationStatus=tDDSynchronizationStatus, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, alarms=alarms, remoteInternetAddressType=remoteInternetAddressType, sNTPServerTableIndex=sNTPServerTableIndex, timeZone=timeZone, syncETrackingState=syncETrackingState, phyControl=phyControl, licenseVersion=licenseVersion, alarmInstancedTableNumber=alarmInstancedTableNumber, signalStrengthRatio=signalStrengthRatio, gatewayIPAddress=gatewayIPAddress, subbandHighestFrequency=subbandHighestFrequency, bridge=bridge, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, l2CPPriorityTableEntry=l2CPPriorityTableEntry, licenseSecurityLevel=licenseSecurityLevel, range=range, dNSResolver=dNSResolver, tDDControl=tDDControl, unitIdentificationGroup=unitIdentificationGroup, hardwareVersion=hardwareVersion, wirelessOutOctets=wirelessOutOctets, sMTPServerInternetAddress=sMTPServerInternetAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, licenseHCMPSupport=licenseHCMPSupport, hCMPMaximumLinkRange=hCMPMaximumLinkRange, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, lbtDetectedTrap=lbtDetectedTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, management=management, targetMACAddress=targetMACAddress, installArmState=installArmState, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, sFPPortQLTx=sFPPortQLTx, maxLinkRangeExceeded=maxLinkRangeExceeded, configurationInstancedTableIndex=configurationInstancedTableIndex, ethernetInstancedTableEntry=ethernetInstancedTableEntry, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, transmitModulationMode=transmitModulationMode, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, sNTPServerInternetAddressType=sNTPServerInternetAddressType, licenseGroup=licenseGroup, capacityVariantMismatchTrap=capacityVariantMismatchTrap, phyControlInstancedTable=phyControlInstancedTable, dataBridgingStatus=dataBridgingStatus, sntp=sntp, dataBridgingStatusLinked=dataBridgingStatusLinked, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, vLANManagementPriority=vLANManagementPriority, mgmtInstancedTable=mgmtInstancedTable, aAAControl=aAAControl, mPLSTCPriorityTable=mPLSTCPriorityTable, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPPortNumber=sNMPPortNumber, encryptionAlgorithm=encryptionAlgorithm, tFTPServerInternetAddressType=tFTPServerInternetAddressType, linkModeOptimization=linkModeOptimization, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, sMTPServerPortNumber=sMTPServerPortNumber, systemReset=systemReset, alarmInstancedTableEntry=alarmInstancedTableEntry, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, packetsFromInternalStack=packetsFromInternalStack, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, receiveModulationModeLinked=receiveModulationModeLinked, tdmTableNumber=tdmTableNumber, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, receivePower=receivePower, userRole=userRole, qOSPriorityScheme=qOSPriorityScheme, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, syslogClientTrap=syslogClientTrap, receiveFreqMHz=receiveFreqMHz, dfsMeans=dfsMeans, auxPortStatusTrap=auxPortStatusTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, syslogState=syslogState, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, iPv6PrefixLength=iPv6PrefixLength, searchStateLinked=searchStateLinked, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, licenseCapacity=licenseCapacity, cableDiagPair4Results=cableDiagPair4Results, sFPPortSSMTx=sFPPortSSMTx, severelyErroredSeconds=severelyErroredSeconds, remoteInternetAddressLinked=remoteInternetAddressLinked, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, byteErrorRatioLinked=byteErrorRatioLinked, sFPPortAllocation=sFPPortAllocation, mABNominalTransmitCapacity=mABNominalTransmitCapacity, vectorErrorLinked=vectorErrorLinked, cableDiagnosticsControl=cableDiagnosticsControl, syncEEquipmentClock=syncEEquipmentClock, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, cableDiagnosticsPorts=cableDiagnosticsPorts, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, wirelessTopology=wirelessTopology, cableDiagPair4Distance=cableDiagPair4Distance, sFPPortStatusTrap=sFPPortStatusTrap, cableDiagPair2Distance=cableDiagPair2Distance, licenseBandwidthCap=licenseBandwidthCap, rangingMode=rangingMode, localPacketFiltering=localPacketFiltering, linkSymmetry=linkSymmetry, blacklistRMMacAddress=blacklistRMMacAddress, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, packetsToInternalStack=packetsToInternalStack, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, linkLossLinked=linkLossLinked, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dNSServerPortNumber=dNSServerPortNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, sNMPTrapVersion=sNMPTrapVersion, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, targetRange=targetRange, hTTPAccessEnabled=hTTPAccessEnabled, licenseIssueNumber=licenseIssueNumber, oOBPriorityQueueMapping=oOBPriorityQueueMapping, sNMPCommunityString=sNMPCommunityString, snmpControlGroup=snmpControlGroup, productName=productName, capacityVariantMismatch=capacityVariantMismatch, daylightSaving=daylightSaving, rawReceivePower=rawReceivePower, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, userTableIndex=userTableIndex, dNSPrimaryServer=dNSPrimaryServer, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, pubStatsGroup=pubStatsGroup, sFPError=sFPError, hTTPSPortNumber=hTTPSPortNumber, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, installArmStateTrap=installArmStateTrap, sNTPServerTableEntry=sNTPServerTableEntry, sNTPSync=sNTPSync, receivePowerLinked=receivePowerLinked, systemClock=systemClock, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, ethernetInstancedTableIndex=ethernetInstancedTableIndex, phyControlGroup=phyControlGroup, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, rangeLinked=rangeLinked, dfsPeaks=dfsPeaks, managementNetworkAccessEnabled=managementNetworkAccessEnabled, tdmTableIndex=tdmTableIndex, dfsTableIndex=dfsTableIndex, sMTPEnabledMessages=sMTPEnabledMessages, frequencyVariant=frequencyVariant, receiveModulationMode=receiveModulationMode, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, licenseInstancedTable=licenseInstancedTable, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, erroredSeconds=erroredSeconds, sNTPState=sNTPState, transmitPowerLinked=transmitPowerLinked, dNSServerInternetAddress=dNSServerInternetAddress, searchState=searchState, ethernetStatisticsDataSource=ethernetStatisticsDataSource, dfsGroup=dfsGroup, tFTPServerInternetAddress=tFTPServerInternetAddress, whitelistRMMacAddress=whitelistRMMacAddress, tdmTable=tdmTable, transparentClockVLAN=transparentClockVLAN, transparentClockVID=transparentClockVID, auxPortQLTx=auxPortQLTx, licenseEncryption=licenseEncryption, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dNSServerTable=dNSServerTable, licenseTDDSyncSupport=licenseTDDSyncSupport, blacklistRMEnabled=blacklistRMEnabled, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, wirelessOutAllOctets=wirelessOutAllOctets, phyStatus=phyStatus, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, authorizationMethod=authorizationMethod, licenseUnitSerialNumber=licenseUnitSerialNumber, ptpTrapPrefix=ptpTrapPrefix, sNMPv3Enable=sNMPv3Enable, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, productVariant=productVariant, wirelessLinkStatusLinked=wirelessLinkStatusLinked, deviceMACAddress=deviceMACAddress, tDMInterfaceControl=tDMInterfaceControl, iPVersion=iPVersion, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, iPv6Address=iPv6Address, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, installationMode=installationMode, unitName=unitName, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, transmitModulationModeLinked=transmitModulationModeLinked, transparentClock=transparentClock, authorizationControlTableNumber=authorizationControlTableNumber, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, ethernetInstancedTableNumber=ethernetInstancedTableNumber, phyControlInstancedTableNumber=phyControlInstancedTableNumber, ethernetPriorityTableIndex=ethernetPriorityTableIndex, ptpGroups=ptpGroups, cableDiagnosticsWarning=cableDiagnosticsWarning, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, portAllocationMismatch=portAllocationMismatch, tDM=tDM)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", mainPSUPortAllocation=mainPSUPortAllocation, tDMChannelLineCode=tDMChannelLineCode, subnetMask=subnetMask, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, dNSServerTableEntry=dNSServerTableEntry, snmpControl=snmpControl, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, smtp=smtp, configuration=configuration, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, licenseMaxLinkRange=licenseMaxLinkRange, whitelistRMEnabled=whitelistRMEnabled, authorizationControlTableEntry=authorizationControlTableEntry, mainPSUPortQLRx=mainPSUPortQLRx, txMABFrames=txMABFrames, mgmtInstancedTableNumber=mgmtInstancedTableNumber, lowestTDMModulationMode=lowestTDMModulationMode, softwareVersion=softwareVersion, encryptionGroup=encryptionGroup, authorizationControlTable=authorizationControlTable, deviceESN=deviceESN, syncESlavePort=syncESlavePort, managementGroup=managementGroup, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, cableDiagnostics=cableDiagnostics, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, channelChangeTrap=channelChangeTrap, groupID=groupID, capacityVariantMismatchLinked=capacityVariantMismatchLinked, licenseTrialPeriod=licenseTrialPeriod, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sFPPortQLRx=sFPPortQLRx, mgmtInstancedTableEntry=mgmtInstancedTableEntry, incompatibleMasterAndSlave=incompatibleMasterAndSlave, versions=versions, cableDiagnosticsGroup=cableDiagnosticsGroup, mainPSUPortStatus=mainPSUPortStatus, aAAControlGroup=aAAControlGroup, auxPortDisabledWarning=auxPortDisabledWarning, tDMChannelStatusTrap=tDMChannelStatusTrap, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, sNTPServerPortNumber=sNTPServerPortNumber, mainPSUPortAutoMdix=mainPSUPortAutoMdix, licenseOOBManagementSupport=licenseOOBManagementSupport, dNSServerTableIndex=dNSServerTableIndex, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, configurationInstancedTableNumber=configurationInstancedTableNumber, auxPortConfigurationMismatch=auxPortConfigurationMismatch, tdmTableEntry=tdmTableEntry, userEnabled=userEnabled, dNSServerTableNumber=dNSServerTableNumber, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, licenseRegulatoryBandsList=licenseRegulatoryBandsList, ethernetPriorityTableEntry=ethernetPriorityTableEntry, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, transmitChannel=transmitChannel, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dNS=dNS, routerProtocols=routerProtocols, receiveModulationModeDetail=receiveModulationModeDetail, mABMaintenanceLevel=mABMaintenanceLevel, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, remoteMACAddress=remoteMACAddress, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, remoteUnitNameLinked=remoteUnitNameLinked, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, siteName=siteName, rxColorCode=rxColorCode, authorizationControlGroup=authorizationControlGroup, licenseGasGroup=licenseGasGroup, notificationsGroup=notificationsGroup, tDMChannelCableLength=tDMChannelCableLength, ptp=ptp, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, phyControlInstancedTableIndex=phyControlInstancedTableIndex, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, auxPortStatus=auxPortStatus, pubInstancedStatsTable=pubInstancedStatsTable, maximumTransmitPower=maximumTransmitPower, dfsTableEntry=dfsTableEntry, unitOutOfCalibration=unitOutOfCalibration, alarmsGroup=alarmsGroup, encryption=encryption, alarmInstancedTableIndex=alarmInstancedTableIndex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, syslogControl=syslogControl, licenseRARSupport=licenseRARSupport, ethernetGroup=ethernetGroup, ethernetPriorityTable=ethernetPriorityTable, dataPortPauseFrames=dataPortPauseFrames, configurationGroup=configurationGroup, installStatusTrap=installStatusTrap, licenseIPv6Support=licenseIPv6Support, sNTPPollInterval=sNTPPollInterval, syslogStateTrap=syslogStateTrap, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, auxPortSyncERxStatus=auxPortSyncERxStatus, apc=apc, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, sNTPServerRetries=sNTPServerRetries, sFPPortAutoMdix=sFPPortAutoMdix, remoteMACAddressLinked=remoteMACAddressLinked, cableDiagPair1Distance=cableDiagPair1Distance, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, tDMEnabledChannels=tDMEnabledChannels, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, licenseGroupAccess=licenseGroupAccess, noWirelessChannelAvailable=noWirelessChannelAvailable, sntpGroup=sntpGroup, auxPortAllocation=auxPortAllocation, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, transmitFreqMHz=transmitFreqMHz, byteErrorRatio=byteErrorRatio, licenseCountry=licenseCountry, lowestDataModulationMode=lowestDataModulationMode, sMTPServerInternetAddressType=sMTPServerInternetAddressType, licenseSyncESupport=licenseSyncESupport, transparentClockPort=transparentClockPort, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, sNTPServerTimeout=sNTPServerTimeout, tDMChannelLoopback=tDMChannelLoopback, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, licenseInstancedTableNumber=licenseInstancedTableNumber, sMTPEmailAlert=sMTPEmailAlert, tDDControlGroup=tDDControlGroup, antennaGain=antennaGain, ptmp=ptmp, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, cableDiagPair2Results=cableDiagPair2Results, tFTPServerPortNumber=tFTPServerPortNumber, cableDiagnosticsResultTable=cableDiagnosticsResultTable, antennaSelection=antennaSelection, phyControlInstancedTableEntry=phyControlInstancedTableEntry, ethernetInstancedTable=ethernetInstancedTable, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dataBridgingAvailability=dataBridgingAvailability, nIDULanPortAutoMdix=nIDULanPortAutoMdix, deviceMSN=deviceMSN, mainPSUPortQLTx=mainPSUPortQLTx, telnetPortNumber=telnetPortNumber, ptpCompliance=ptpCompliance, supplementary=supplementary, unavailableSeconds=unavailableSeconds, hTTPPortNumber=hTTPPortNumber, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, wirelessLinkStatus=wirelessLinkStatus, sFPPortAutoNegotiation=sFPPortAutoNegotiation, sNTPServerTable=sNTPServerTable, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, remoteUnitName=remoteUnitName, cableLoss=cableLoss, userTable=userTable, syslogControlGroup=syslogControlGroup, sFPPortSyncERxStatus=sFPPortSyncERxStatus, sNMPEnabledTraps=sNMPEnabledTraps, sNTPSyncTrap=sNTPSyncTrap, wirelessLinkAvailability=wirelessLinkAvailability, mABHoldoffPeriod=mABHoldoffPeriod, useVLANForManagementInterfaces=useVLANForManagementInterfaces, nIDULanPortStatus=nIDULanPortStatus, secureModeAlarmTrap=secureModeAlarmTrap, telnetAccessEnabled=telnetAccessEnabled, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, licenseInstancedTableEntry=licenseInstancedTableEntry, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, syncETracking=syncETracking, tempPcb=tempPcb, secondarySoftwareVersion=secondarySoftwareVersion, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, tFTPClient=tFTPClient, pubStats=pubStats, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, incompatibleRegulatoryBands=incompatibleRegulatoryBands, managementPortWirelessDownAlert=managementPortWirelessDownAlert, transmitDataRate=transmitDataRate, cableDiagPair1Results=cableDiagPair1Results, receiveDataRate=receiveDataRate, configurationInstancedTableEntry=configurationInstancedTableEntry, signalStrengthRatioLinked=signalStrengthRatioLinked, mainPSUPortSSMTx=mainPSUPortSSMTx, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, transmitDataRateLinked=transmitDataRateLinked, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, installStatusLinked=installStatusLinked, sNTPServerTableNumber=sNTPServerTableNumber, subbandLowestFrequency=subbandLowestFrequency, alarmInstancedTable=alarmInstancedTable, phyStatusGroup=phyStatusGroup, aggregateDataRateLinked=aggregateDataRateLinked, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, vLANManagementVID=vLANManagementVID, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, userTableEntry=userTableEntry, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, ptpTraps=ptpTraps, mABState=mABState, mainPSUPortStatusTrap=mainPSUPortStatusTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, smtpGroup=smtpGroup, longitude=longitude, mABProtocolVLANPriority=mABProtocolVLANPriority, iPv6GatewayAddress=iPv6GatewayAddress, linkName=linkName, dSCPManagementPriority=dSCPManagementPriority, tDDSynchronizationMode=tDDSynchronizationMode, sNMPTrapTableEntry=sNMPTrapTableEntry, iPv4Address=iPv4Address, linkLoss=linkLoss, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, transmitFreqKHz=transmitFreqKHz, rawReceivePowerLinked=rawReceivePowerLinked, routerProtocolsGroup=routerProtocolsGroup, altitude=altitude, resetGroup=resetGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, l2CPPriorityTableNumber=l2CPPriorityTableNumber, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, secureModeAlarm=secureModeAlarm, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, sFPPortStatus=sFPPortStatus, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, reset=reset, portAllocationMismatchLinked=portAllocationMismatchLinked, dNSServerInternetAddressType=dNSServerInternetAddressType, auxPortAcceptedQLRx=auxPortAcceptedQLRx, dataBridgingStatusAlarm=dataBridgingStatusAlarm, masterSlaveMode=masterSlaveMode, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, ptp670=ptp670, l2CPPriorityTableIndex=l2CPPriorityTableIndex, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, hTTPSAccessEnabled=hTTPSAccessEnabled, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, supplementaryGroup=supplementaryGroup, aggregateDataRate=aggregateDataRate, enableTransmission=enableTransmission, bridgeGroup=bridgeGroup, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, license=license)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", tDMChannelStatus=tDMChannelStatus, auxPortQLRx=auxPortQLRx, versionsGroup=versionsGroup, configurationInstancedTable=configurationInstancedTable, receiveDataRateLinked=receiveDataRateLinked, regulatoryBandTrap=regulatoryBandTrap, receiveChannel=receiveChannel, enabledDiagnosticAlarms=enabledDiagnosticAlarms, cambium=cambium, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, portAllocationMismatchTrap=portAllocationMismatchTrap, sFPPortDisabledWarning=sFPPortDisabledWarning, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNTPServerInternetAddress=sNTPServerInternetAddress, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, nIDULanPortStatusTrap=nIDULanPortStatusTrap, auxPortSSMTx=auxPortSSMTx, sNTPPrimaryServer=sNTPPrimaryServer, tDMInterfaceStatus=tDMInterfaceStatus, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, accessMethod=accessMethod, userName=userName, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, bootVersion=bootVersion, useVLANForMABProtocol=useVLANForMABProtocol, licenseIEEE1588Support=licenseIEEE1588Support, maximumNumberOfSlaves=maximumNumberOfSlaves, sFPErrorTrap=sFPErrorTrap, extendedSpectrumScanning=extendedSpectrumScanning, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, hCMPLinkSymmetry=hCMPLinkSymmetry, installStatus=installStatus, l2CPPriorityTable=l2CPPriorityTable, channelBandwidth=channelBandwidth, wirelessOutEthernetOctets=wirelessOutEthernetOctets, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, vectorError=vectorError, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, authorizationControl=authorizationControl, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, mgmtInstancedTableIndex=mgmtInstancedTableIndex, syslogLocalWrappedTrap=syslogLocalWrappedTrap, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, sNTPServerStatus=sNTPServerStatus, transmitPower=transmitPower, eIRP=eIRP, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, syslogClient=syslogClient, latitude=latitude, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, sNTPLastSync=sNTPLastSync, mABNominalModulationMode=mABNominalModulationMode, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfsTableNumber=dfsTableNumber, sNMPTrapTable=sNMPTrapTable, authorizationControlTableIndex=authorizationControlTableIndex, licenseSFPPortSupport=licenseSFPPortSupport, mABProtocolVID=mABProtocolVID, dfs=dfs, cableDiagPair3Results=cableDiagPair3Results)
