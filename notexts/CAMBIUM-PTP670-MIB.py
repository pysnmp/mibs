...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", encryptionGroup=encryptionGroup, aggregateDataRateLinked=aggregateDataRateLinked, tempPcb=tempPcb, remoteInternetAddress=remoteInternetAddress, dNSResolver=dNSResolver, syslogControl=syslogControl, dSCPManagementPriority=dSCPManagementPriority, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, routerProtocolsGroup=routerProtocolsGroup, phyControlInstancedTableNumber=phyControlInstancedTableNumber, receiveFreqMHz=receiveFreqMHz, unitIdentificationGroup=unitIdentificationGroup, dfsTableIndex=dfsTableIndex, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, mABProtocolVLANPriority=mABProtocolVLANPriority, remoteMACAddress=remoteMACAddress, tDMChannelStatus=tDMChannelStatus, l2CPPriorityTableNumber=l2CPPriorityTableNumber, auxPortQLTx=auxPortQLTx, auxPortSyncERxStatus=auxPortSyncERxStatus, vLANManagementPriority=vLANManagementPriority, licenseIEEE1588Support=licenseIEEE1588Support, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptpGroups=ptpGroups, sFPPortStatus=sFPPortStatus, nIDULanPortStatusTrap=nIDULanPortStatusTrap, packetsFromInternalStack=packetsFromInternalStack, vLANManagementVID=vLANManagementVID, licenseSecurityLevel=licenseSecurityLevel, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, wirelessLinkStatusLinked=wirelessLinkStatusLinked, transmitFreqKHz=transmitFreqKHz, sNMPTrapTableNumber=sNMPTrapTableNumber, licenseEncryption=licenseEncryption, transmitModulationModeLinked=transmitModulationModeLinked, ptpTrapPrefix=ptpTrapPrefix, userTableIndex=userTableIndex, hTTPSAccessEnabled=hTTPSAccessEnabled, capacityVariantMismatchTrap=capacityVariantMismatchTrap, dNS=dNS, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, dNSServerTableEntry=dNSServerTableEntry, licenseSFPPortSupport=licenseSFPPortSupport, transmitterChannels=transmitterChannels, tDMInterfaceStatus=tDMInterfaceStatus, licenseInstancedTableNumber=licenseInstancedTableNumber, sNMPPortNumber=sNMPPortNumber, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, licenseTrialPeriod=licenseTrialPeriod, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, sNTPServerTableNumber=sNTPServerTableNumber, authorizationControlTableEntry=authorizationControlTableEntry, apc=apc, softwareVersion=softwareVersion, syncETracking=syncETracking, longitude=longitude, maxLinkRangeExceeded=maxLinkRangeExceeded, tdmTableIndex=tdmTableIndex, ethernetStatisticsTable=ethernetStatisticsTable, hTTPPortNumber=hTTPPortNumber, useVLANForMABProtocol=useVLANForMABProtocol, supplementaryGroup=supplementaryGroup, sFPPortAutoMdix=sFPPortAutoMdix, rawReceivePowerLinked=rawReceivePowerLinked, nIDULanPortAutoMdix=nIDULanPortAutoMdix, sNTPServerPortNumber=sNTPServerPortNumber, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, dfs=dfs, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, syslogClient=syslogClient, pubStatsGroup=pubStatsGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telnetPortNumber=telnetPortNumber, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, unavailableSeconds=unavailableSeconds, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tDMGroup=tDMGroup, encryption=encryption, receivePower=receivePower, mPLSTCPriorityTable=mPLSTCPriorityTable, ethernetStatisticsDataSource=ethernetStatisticsDataSource, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, tDMEnabledChannels=tDMEnabledChannels, mABNominalModulationMode=mABNominalModulationMode, dNSServerTable=dNSServerTable, noWirelessChannelAvailable=noWirelessChannelAvailable, licenseIPv6Support=licenseIPv6Support, channelChangeTrap=channelChangeTrap, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, sFPPortStatusTrap=sFPPortStatusTrap, managementNetworkAccessEnabled=managementNetworkAccessEnabled, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, sNTPServerInternetAddress=sNTPServerInternetAddress, txMABFrames=txMABFrames, regulatoryBand=regulatoryBand, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPState=sNTPState, blacklistRMEnabled=blacklistRMEnabled, sNTPSync=sNTPSync, syncESlavePort=syncESlavePort, authorizationControlTable=authorizationControlTable, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, auxPortQLRx=auxPortQLRx, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, alarmInstancedTableIndex=alarmInstancedTableIndex, regulatoryBandTrap=regulatoryBandTrap, versions=versions, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, userName=userName, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, latitude=latitude, managementPortWirelessDownAlert=managementPortWirelessDownAlert, altitude=altitude, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, capacityVariantMismatch=capacityVariantMismatch, receiveDataRate=receiveDataRate, aggregateDataRate=aggregateDataRate, sNTPServerTableIndex=sNTPServerTableIndex, remoteUnitNameLinked=remoteUnitNameLinked, tFTPClient=tFTPClient, transmitPowerLinked=transmitPowerLinked, ethernetPriorityTableIndex=ethernetPriorityTableIndex, l2CPPriorityTableIndex=l2CPPriorityTableIndex, secondarySoftwareVersion=secondarySoftwareVersion, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, licenseInstancedTable=licenseInstancedTable, managementGroup=managementGroup, hCMPMaximumLinkRange=hCMPMaximumLinkRange, receiveDataRateLinked=receiveDataRateLinked, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, licenseUnitSerialNumber=licenseUnitSerialNumber, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, daylightSaving=daylightSaving, routerProtocols=routerProtocols, dataBridgingStatusAlarm=dataBridgingStatusAlarm, sFPErrorTrap=sFPErrorTrap, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, receivePowerLinked=receivePowerLinked, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, severelyErroredSeconds=severelyErroredSeconds, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, dfsTableNumber=dfsTableNumber, transmitModulationMode=transmitModulationMode, licenseSyncESupport=licenseSyncESupport, configurationInstancedTable=configurationInstancedTable, cableDiagnosticsGroup=cableDiagnosticsGroup, sMTPServerInternetAddressType=sMTPServerInternetAddressType, telnetAccessEnabled=telnetAccessEnabled, licenseInstancedTableIndex=licenseInstancedTableIndex, sNTPServerStatus=sNTPServerStatus, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, mgmtInstancedTableEntry=mgmtInstancedTableEntry, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, transparentClockVID=transparentClockVID, oOBPriorityQueueMapping=oOBPriorityQueueMapping, supplementary=supplementary, sNTPServerTableEntry=sNTPServerTableEntry, PYSNMP_MODULE_ID=cambium, aAAControl=aAAControl, dfsPeaks=dfsPeaks, configurationInstancedTableNumber=configurationInstancedTableNumber, txColorCode=txColorCode, apcGroup=apcGroup, channelBandwidth=channelBandwidth, transparentClockVLAN=transparentClockVLAN, linkLossLinked=linkLossLinked, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, mainPSUPortQLRx=mainPSUPortQLRx, erroredSeconds=erroredSeconds, localPacketFiltering=localPacketFiltering, ethernetInstancedTableIndex=ethernetInstancedTableIndex, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, maximumNumberOfSlaves=maximumNumberOfSlaves, tDMChannelStatusTrap=tDMChannelStatusTrap, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, installStatus=installStatus, encryptionAlgorithm=encryptionAlgorithm, lowestDataModulationMode=lowestDataModulationMode, sNMPTrapVersion=sNMPTrapVersion, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, iPVersion=iPVersion, lowestTDMModulationMode=lowestTDMModulationMode, cableDiagnostics=cableDiagnostics, authorizationControl=authorizationControl, capacityVariantMismatchLinked=capacityVariantMismatchLinked, licenseGasGroup=licenseGasGroup, packetsToInternalStack=packetsToInternalStack, remoteMACAddressLinked=remoteMACAddressLinked, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, frequencyVariant=frequencyVariant, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, signalStrengthRatioLinked=signalStrengthRatioLinked, lbtDetectedTrap=lbtDetectedTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, phyInstancedStatusTable=phyInstancedStatusTable, sMTPEnabledMessages=sMTPEnabledMessages, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, tDMInterfaceControl=tDMInterfaceControl, dNSServerPortNumber=dNSServerPortNumber, mABProtocolVID=mABProtocolVID, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, eIRP=eIRP, dfsGroup=dfsGroup, userTable=userTable, tDM=tDM, transmitDataRateLinked=transmitDataRateLinked, reset=reset, tFTPServerInternetAddressType=tFTPServerInternetAddressType, mainPSUPortStatus=mainPSUPortStatus, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, ethernetInstancedTable=ethernetInstancedTable, wirelessOutAllOctets=wirelessOutAllOctets, wirelessLinkAvailability=wirelessLinkAvailability, siteName=siteName, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, alarmInstancedTable=alarmInstancedTable, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, transmitFreqMHz=transmitFreqMHz, licenseMaxLinkRange=licenseMaxLinkRange, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, license=license, hTTPAccessEnabled=hTTPAccessEnabled, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, tDDControlGroup=tDDControlGroup, transparentClock=transparentClock, sNTPPollInterval=sNTPPollInterval, licenseRegulatoryBandsList=licenseRegulatoryBandsList, auxPortStatus=auxPortStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, range=range, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, transmitDataRate=transmitDataRate, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, ptpTraps=ptpTraps, mgmtInstancedTableNumber=mgmtInstancedTableNumber, licenseGroupAccess=licenseGroupAccess, mainPSUPortSSMTx=mainPSUPortSSMTx, dfsTable=dfsTable, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", bootVersion=bootVersion, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, phyStatusGroup=phyStatusGroup, configurationInstancedTableEntry=configurationInstancedTableEntry, userRole=userRole, cableDiagPair4Distance=cableDiagPair4Distance, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, cableDiagnosticsControl=cableDiagnosticsControl, syncETrackingState=syncETrackingState, hardwareVersion=hardwareVersion, licenseTDDSyncSupport=licenseTDDSyncSupport, targetMACAddress=targetMACAddress, ptp670=ptp670, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sMTPServerInternetAddress=sMTPServerInternetAddress, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, resetGroup=resetGroup, installationMode=installationMode, unitIdentification=unitIdentification, subbandHighestFrequency=subbandHighestFrequency, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, cableDiagnosticsWarning=cableDiagnosticsWarning, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, linkLoss=linkLoss, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, receiveModulationMode=receiveModulationMode, phyControlInstancedTableIndex=phyControlInstancedTableIndex, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataBridgingAvailability=dataBridgingAvailability, unitOutOfCalibration=unitOutOfCalibration, sMTPSourceEmailAddress=sMTPSourceEmailAddress, auxPortStatusTrap=auxPortStatusTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, cableDiagPair3Results=cableDiagPair3Results, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, wirelessOutEthernetOctets=wirelessOutEthernetOctets, configuration=configuration, transparentClockPort=transparentClockPort, licenseInstancedTableEntry=licenseInstancedTableEntry, sNTPServerTable=sNTPServerTable, dataBridgingStatus=dataBridgingStatus, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, versionsGroup=versionsGroup, licenseBandwidthCap=licenseBandwidthCap, mABState=mABState, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, qOSPriorityScheme=qOSPriorityScheme, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, wirelessTopology=wirelessTopology, searchState=searchState, deviceESN=deviceESN, incompatibleMasterAndSlave=incompatibleMasterAndSlave, unitName=unitName, tDMConfigurationMismatch=tDMConfigurationMismatch, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, hCMPLinkSymmetry=hCMPLinkSymmetry, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, rangeLinked=rangeLinked, remoteInternetAddressLinked=remoteInternetAddressLinked, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, phyControlInstancedTable=phyControlInstancedTable, pubStats=pubStats, cableLoss=cableLoss, licenseHCMPSupport=licenseHCMPSupport, licenseOOBManagementSupport=licenseOOBManagementSupport, licenseVersion=licenseVersion, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, enableTransmission=enableTransmission, sFPPortQLRx=sFPPortQLRx, ethernetInstancedTableEntry=ethernetInstancedTableEntry, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, targetRange=targetRange, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, sNMPTrapTable=sNMPTrapTable, rxColorCode=rxColorCode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, tDMChannelLoopback=tDMChannelLoopback, receiveModulationModeDetail=receiveModulationModeDetail, iPv6Address=iPv6Address, licenseRARSupport=licenseRARSupport, incompatibleRegulatoryBands=incompatibleRegulatoryBands, iPv4Address=iPv4Address, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, syslogState=syslogState, dNSPrimaryServer=dNSPrimaryServer, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sFPPortQLTx=sFPPortQLTx, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, sMTPEmailAlert=sMTPEmailAlert, phyControl=phyControl, iPv6GatewayAddress=iPv6GatewayAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tdmTable=tdmTable, ethernet=ethernet, userTableEntry=userTableEntry, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, subbandLowestFrequency=subbandLowestFrequency, portAllocationMismatchTrap=portAllocationMismatchTrap, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, transmitChannel=transmitChannel, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, sFPError=sFPError, cableDiagPair4Results=cableDiagPair4Results, cableDiagnosticsResultTable=cableDiagnosticsResultTable, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, dNSServerTableNumber=dNSServerTableNumber, linkName=linkName, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, tFTPServerInternetAddress=tFTPServerInternetAddress, receiveFreqKHz=receiveFreqKHz, dNSServerTableIndex=dNSServerTableIndex, sNTPPrimaryServer=sNTPPrimaryServer, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, bridge=bridge, alarmsGroup=alarmsGroup, linkModeOptimization=linkModeOptimization, sFPPortSyncERxStatus=sFPPortSyncERxStatus, sFPPortSSMTx=sFPPortSSMTx, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, secureModeAlarm=secureModeAlarm, aAAControlGroup=aAAControlGroup, mABMaintenanceLevel=mABMaintenanceLevel, alarms=alarms, auxPortAcceptedQLRx=auxPortAcceptedQLRx, sNMPCommunityString=sNMPCommunityString, installStatusTrap=installStatusTrap, sNMPv3Enable=sNMPv3Enable, auxPortDisabledWarning=auxPortDisabledWarning, portAllocationMismatch=portAllocationMismatch, secureModeAlarmTrap=secureModeAlarmTrap, dataBridgingStatusLinked=dataBridgingStatusLinked, alarmInstancedTableEntry=alarmInstancedTableEntry, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dNSServerInternetAddressType=dNSServerInternetAddressType, sNTPServerRetries=sNTPServerRetries, antennaSelection=antennaSelection, pubInstancedStatsTable=pubInstancedStatsTable, sMTPServerPortNumber=sMTPServerPortNumber, snmpControlGroup=snmpControlGroup, cableDiagPair1Results=cableDiagPair1Results, ptmp=ptmp, tFTPServerPortNumber=tFTPServerPortNumber, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, tdmTableEntry=tdmTableEntry, mgmtInstancedTableIndex=mgmtInstancedTableIndex, whitelistRMMacAddress=whitelistRMMacAddress, signalStrengthRatio=signalStrengthRatio, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, tdmTableNumber=tdmTableNumber, management=management, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, auxPortAllocation=auxPortAllocation, licenseCapacity=licenseCapacity, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, byteErrorRatio=byteErrorRatio, rangingMode=rangingMode, tDDSynchronizationMode=tDDSynchronizationMode, syslogStateTrap=syslogStateTrap, licenseIssueNumber=licenseIssueNumber, gatewayIPAddress=gatewayIPAddress, configurationInstancedTableIndex=configurationInstancedTableIndex, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, ethernetInstancedTableNumber=ethernetInstancedTableNumber, mainPSUPortAllocation=mainPSUPortAllocation, byteErrorRatioLinked=byteErrorRatioLinked, authorizationControlTableIndex=authorizationControlTableIndex, systemReset=systemReset, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, wirelessOutOctets=wirelessOutOctets, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, userEnabled=userEnabled, iPv6PrefixLength=iPv6PrefixLength, sFPPortAllocation=sFPPortAllocation, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sFPPortDisabledWarning=sFPPortDisabledWarning, iPDSCPPriorityTable=iPDSCPPriorityTable, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, licenseGroup=licenseGroup, mainPSUPortStatusTrap=mainPSUPortStatusTrap, dNSServerInternetAddress=dNSServerInternetAddress, remoteUnitName=remoteUnitName, sNTPLastSync=sNTPLastSync, mABHoldoffPeriod=mABHoldoffPeriod, installArmState=installArmState, licenseTLSRekey=licenseTLSRekey, dataPortPauseFrames=dataPortPauseFrames, l2CPPriorityTable=l2CPPriorityTable, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, receiveChannel=receiveChannel, dNSGroup=dNSGroup, remoteInternetAddressType=remoteInternetAddressType, cableDiagPair2Distance=cableDiagPair2Distance, installStatusLinked=installStatusLinked, cableDiagPair3Distance=cableDiagPair3Distance, maximumTransmitPower=maximumTransmitPower, sNTPServerTimeout=sNTPServerTimeout, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, notificationsGroup=notificationsGroup, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, ptpCompliance=ptpCompliance, auxPortSSMTx=auxPortSSMTx, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, configurationGroup=configurationGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, groupID=groupID, tDDControl=tDDControl, snmpControl=snmpControl, dfsTableEntry=dfsTableEntry, dfsMeans=dfsMeans, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, userPassword=userPassword, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, vectorError=vectorError, installArmStateTrap=installArmStateTrap, cableDiagPair1Distance=cableDiagPair1Distance, rawReceivePower=rawReceivePower, sFPPortAutoNegotiation=sFPPortAutoNegotiation, wirelessLinkStatus=wirelessLinkStatus, mABTransmissionInterval=mABTransmissionInterval, systemClock=systemClock, sNMPEnabledTraps=sNMPEnabledTraps, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNTPSyncTrap=sNTPSyncTrap, authorizationControlTableNumber=authorizationControlTableNumber, mgmtInstancedTable=mgmtInstancedTable, authorizationMethod=authorizationMethod, phyControlGroup=phyControlGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, extendedSpectrumScanning=extendedSpectrumScanning, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", cambium=cambium, receiveModulationModeLinked=receiveModulationModeLinked, searchStateLinked=searchStateLinked, alarmInstancedTableNumber=alarmInstancedTableNumber, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, mainPSUPortQLTx=mainPSUPortQLTx, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, nIDULanPortStatus=nIDULanPortStatus, phyControlInstancedTableEntry=phyControlInstancedTableEntry, auxPortConfigurationMismatch=auxPortConfigurationMismatch, licenseCountry=licenseCountry, cableDiagPair2Results=cableDiagPair2Results, phyStatus=phyStatus, vectorErrorLinked=vectorErrorLinked, syslogClientTrap=syslogClientTrap, portAllocationMismatchLinked=portAllocationMismatchLinked, productName=productName, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, userTableNumber=userTableNumber, bridgeGroup=bridgeGroup, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sntpGroup=sntpGroup, timeZone=timeZone, ethernetGroup=ethernetGroup, cableDiagnosticsPorts=cableDiagnosticsPorts, smtpGroup=smtpGroup, tDMChannelCableLength=tDMChannelCableLength, mainPSUPortAutoMdix=mainPSUPortAutoMdix, ethernetPriorityTableEntry=ethernetPriorityTableEntry, blacklistRMMacAddress=blacklistRMMacAddress, ptp=ptp, linkSymmetry=linkSymmetry, deviceMSN=deviceMSN, accessMethod=accessMethod, productVariant=productVariant, hTTPSPortNumber=hTTPSPortNumber, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, sntp=sntp, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, tDMChannelLineCode=tDMChannelLineCode, ethernetPriorityTable=ethernetPriorityTable, syslogControlGroup=syslogControlGroup, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, authorizationControlGroup=authorizationControlGroup, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, sNTPServerInternetAddressType=sNTPServerInternetAddressType, mABNominalTransmitCapacity=mABNominalTransmitCapacity, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, whitelistRMEnabled=whitelistRMEnabled, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, smtp=smtp, subnetMask=subnetMask, deviceMACAddress=deviceMACAddress, syncEEquipmentClock=syncEEquipmentClock, transmitPower=transmitPower, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, antennaGain=antennaGain, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, masterSlaveMode=masterSlaveMode)
