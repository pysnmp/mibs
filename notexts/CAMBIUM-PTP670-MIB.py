...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", linkModeOptimization=linkModeOptimization, licenseSFPPortSupport=licenseSFPPortSupport, smtp=smtp, dataBridgingStatusLinked=dataBridgingStatusLinked, phyControlInstancedTableEntry=phyControlInstancedTableEntry, cableDiagnosticsWarning=cableDiagnosticsWarning, dataBridgingStatus=dataBridgingStatus, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dataBridgingStatusAlarm=dataBridgingStatusAlarm, aggregateDataRateLinked=aggregateDataRateLinked, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, remoteMACAddress=remoteMACAddress, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, auxPortStatusTrap=auxPortStatusTrap, cableDiagnosticsResultTable=cableDiagnosticsResultTable, userTableIndex=userTableIndex, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, remoteMACAddressLinked=remoteMACAddressLinked, supplementary=supplementary, searchStateLinked=searchStateLinked, pubStatsGroup=pubStatsGroup, sMTPEnabledMessages=sMTPEnabledMessages, dNSServerTable=dNSServerTable, sFPPortSSMTx=sFPPortSSMTx, versionsGroup=versionsGroup, ethernet=ethernet, sFPErrorTrap=sFPErrorTrap, mgmtInstancedTable=mgmtInstancedTable, syslogState=syslogState, auxPortQLTx=auxPortQLTx, sMTPServerInternetAddressType=sMTPServerInternetAddressType, licenseIPv6Support=licenseIPv6Support, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, syslogControlGroup=syslogControlGroup, targetMACAddress=targetMACAddress, installStatus=installStatus, range=range, subbandLowestFrequency=subbandLowestFrequency, licenseRARSupport=licenseRARSupport, dfsTableNumber=dfsTableNumber, phyControlInstancedTable=phyControlInstancedTable, bridge=bridge, receiveFreqMHz=receiveFreqMHz, hTTPAccessEnabled=hTTPAccessEnabled, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, sMTPEmailAlert=sMTPEmailAlert, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sMTPServerPortNumber=sMTPServerPortNumber, authorizationMethod=authorizationMethod, cableDiagPair3Results=cableDiagPair3Results, snmpControl=snmpControl, apc=apc, syslogClientTrap=syslogClientTrap, routerProtocolsGroup=routerProtocolsGroup, deviceESN=deviceESN, authorizationControl=authorizationControl, userName=userName, ethernetInstancedTableEntry=ethernetInstancedTableEntry, wirelessOutAllOctets=wirelessOutAllOctets, tDMInterfaceStatus=tDMInterfaceStatus, ptpCompliance=ptpCompliance, antennaSelection=antennaSelection, transmitDataRate=transmitDataRate, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, remoteMaximumTransmitPower=remoteMaximumTransmitPower, lowestTDMModulationMode=lowestTDMModulationMode, cableDiagPair4Distance=cableDiagPair4Distance, licenseEncryption=licenseEncryption, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, aAAControlGroup=aAAControlGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, licenseInstancedTableIndex=licenseInstancedTableIndex, receiveDataRate=receiveDataRate, configurationInstancedTable=configurationInstancedTable, nIDULanPortStatusTrap=nIDULanPortStatusTrap, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, secureModeAlarmTrap=secureModeAlarmTrap, cableDiagnosticsControl=cableDiagnosticsControl, packetsToInternalStack=packetsToInternalStack, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, auxPortAllocation=auxPortAllocation, hardwareVersion=hardwareVersion, transparentClockVLAN=transparentClockVLAN, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, sNTPServerRetries=sNTPServerRetries, mABHoldoffPeriod=mABHoldoffPeriod, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, licenseMaxLinkRange=licenseMaxLinkRange, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, cableDiagPair2Distance=cableDiagPair2Distance, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, sNTPServerInternetAddress=sNTPServerInternetAddress, secondarySoftwareVersion=secondarySoftwareVersion, sNTPServerTable=sNTPServerTable, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, receiveDataRateLinked=receiveDataRateLinked, receiveFreqKHz=receiveFreqKHz, smtpGroup=smtpGroup, localPacketFiltering=localPacketFiltering, hCMPLinkSymmetry=hCMPLinkSymmetry, systemClock=systemClock, reset=reset, frequencyVariant=frequencyVariant, maximumNumberOfSlaves=maximumNumberOfSlaves, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, mgmtInstancedTableIndex=mgmtInstancedTableIndex, lbtDetectedTrap=lbtDetectedTrap, whitelistRMEnabled=whitelistRMEnabled, mainPSUPortQLRx=mainPSUPortQLRx, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, sNTPLastSync=sNTPLastSync, aggregateDataRate=aggregateDataRate, licenseInstancedTable=licenseInstancedTable, mainPSUPortStatus=mainPSUPortStatus, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, byteErrorRatioLinked=byteErrorRatioLinked, cableDiagPair1Distance=cableDiagPair1Distance, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, unitName=unitName, sNTPServerTableIndex=sNTPServerTableIndex, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, alarmInstancedTableNumber=alarmInstancedTableNumber, subbandHighestFrequency=subbandHighestFrequency, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, installStatusLinked=installStatusLinked, authorizationControlTableNumber=authorizationControlTableNumber, tDMChannelStatus=tDMChannelStatus, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, managementGroup=managementGroup, phyControlGroup=phyControlGroup, dataBridgingAvailability=dataBridgingAvailability, l2CPPriorityTable=l2CPPriorityTable, packetsFromInternalStack=packetsFromInternalStack, licenseBandwidthCap=licenseBandwidthCap, alarmInstancedTable=alarmInstancedTable, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, encryptionGroup=encryptionGroup, mainPSUPortAllocation=mainPSUPortAllocation, tDMInterfaceControl=tDMInterfaceControl, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, ptp670=ptp670, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, linkLoss=linkLoss, hTTPSAccessEnabled=hTTPSAccessEnabled, masterSlaveMode=masterSlaveMode, whitelistRMMacAddress=whitelistRMMacAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sFPPortStatus=sFPPortStatus, receiveChannel=receiveChannel, syslogControl=syslogControl, licenseSyncESupport=licenseSyncESupport, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, syncESlavePort=syncESlavePort, useVLANForManagementInterfaces=useVLANForManagementInterfaces, configurationInstancedTableEntry=configurationInstancedTableEntry, authorizationControlGroup=authorizationControlGroup, sNTPSyncTrap=sNTPSyncTrap, sFPPortQLTx=sFPPortQLTx, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, ptmp=ptmp, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, licenseInstancedTableEntry=licenseInstancedTableEntry, sNMPv3Enable=sNMPv3Enable, tDMGroup=tDMGroup, receivePower=receivePower, blacklistRMEnabled=blacklistRMEnabled, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, sFPPortAllocation=sFPPortAllocation, phyStatusGroup=phyStatusGroup, cableDiagPair4Results=cableDiagPair4Results, capacityVariantMismatchTrap=capacityVariantMismatchTrap, syslogClient=syslogClient, vectorErrorLinked=vectorErrorLinked, tDMChannelLoopback=tDMChannelLoopback, licenseCountry=licenseCountry, cableDiagnosticsGroup=cableDiagnosticsGroup, tDMChannelCableLength=tDMChannelCableLength, nIDULanPortStatus=nIDULanPortStatus, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, tDMChannelLineCode=tDMChannelLineCode, tFTPServerPortNumber=tFTPServerPortNumber, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, dfsTable=dfsTable, dNSServerTableEntry=dNSServerTableEntry, sFPPortStatusTrap=sFPPortStatusTrap, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, licenseTrialPeriod=licenseTrialPeriod, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, configuration=configuration, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, userTableEntry=userTableEntry, transmitPower=transmitPower, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dNSServerTableNumber=dNSServerTableNumber, mABNominalTransmitCapacity=mABNominalTransmitCapacity, management=management, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, licenseGroup=licenseGroup, ethernetStatisticsTable=ethernetStatisticsTable, dfsGroup=dfsGroup, receiveModulationModeLinked=receiveModulationModeLinked, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, sFPPortDisabledWarning=sFPPortDisabledWarning, remoteInternetAddress=remoteInternetAddress, mABNominalModulationMode=mABNominalModulationMode, ptpTraps=ptpTraps, tempPcb=tempPcb, sNTPState=sNTPState, l2CPPriorityTableNumber=l2CPPriorityTableNumber, alarmInstancedTableIndex=alarmInstancedTableIndex, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, groupID=groupID, dNSServerInternetAddressType=dNSServerInternetAddressType, receiveModulationMode=receiveModulationMode, phyControlInstancedTableIndex=phyControlInstancedTableIndex, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, rangeLinked=rangeLinked, wirelessOutOctets=wirelessOutOctets, tDMChannelStatusTrap=tDMChannelStatusTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, remoteUnitName=remoteUnitName, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, ethernetStatisticsDataSource=ethernetStatisticsDataSource, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, authorizationControlTableEntry=authorizationControlTableEntry, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, iPv6Address=iPv6Address, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, licenseSecurityLevel=licenseSecurityLevel, sFPError=sFPError, phyStatus=phyStatus, configurationInstancedTableNumber=configurationInstancedTableNumber, dfsTableEntry=dfsTableEntry, tDM=tDM, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", wirelessTopology=wirelessTopology, receivePowerLinked=receivePowerLinked, vLANManagementVID=vLANManagementVID, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, cableLoss=cableLoss, ethernetPriorityTable=ethernetPriorityTable, dNS=dNS, lowestDataModulationMode=lowestDataModulationMode, subnetMask=subnetMask, dNSPrimaryServer=dNSPrimaryServer, dfsMeans=dfsMeans, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, wirelessLinkStatus=wirelessLinkStatus, licenseGroupAccess=licenseGroupAccess, auxPortConfigurationMismatch=auxPortConfigurationMismatch, installStatusTrap=installStatusTrap, ptpTrapPrefix=ptpTrapPrefix, antennaGain=antennaGain, managementPortWirelessDownAlert=managementPortWirelessDownAlert, iPv4Address=iPv4Address, channelBandwidth=channelBandwidth, deviceMSN=deviceMSN, sntp=sntp, mPLSTCPriorityTable=mPLSTCPriorityTable, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, dNSGroup=dNSGroup, linkSymmetry=linkSymmetry, cableDiagnostics=cableDiagnostics, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, wirelessLinkStatusLinked=wirelessLinkStatusLinked, auxPortQLRx=auxPortQLRx, tdmTableEntry=tdmTableEntry, sNMPTrapTable=sNMPTrapTable, mainPSUPortQLTx=mainPSUPortQLTx, alarms=alarms, longitude=longitude, aAAControl=aAAControl, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, cableDiagnosticsPorts=cableDiagnosticsPorts, deviceMACAddress=deviceMACAddress, cableDiagPair1Results=cableDiagPair1Results, ethernetInstancedTableIndex=ethernetInstancedTableIndex, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, mainPSUPortStatusTrap=mainPSUPortStatusTrap, mainPSUPortSSMTx=mainPSUPortSSMTx, installationMode=installationMode, configurationGroup=configurationGroup, ethernetInstancedTable=ethernetInstancedTable, linkName=linkName, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, transparentClockPort=transparentClockPort, iPv6GatewayAddress=iPv6GatewayAddress, pubInstancedStatsTable=pubInstancedStatsTable, unitOutOfCalibration=unitOutOfCalibration, tdmTableNumber=tdmTableNumber, licenseTDDSyncSupport=licenseTDDSyncSupport, hCMPMaximumLinkRange=hCMPMaximumLinkRange, wirelessOutEthernetOctets=wirelessOutEthernetOctets, sNTPServerStatus=sNTPServerStatus, syncETrackingState=syncETrackingState, ethernetPriorityTableIndex=ethernetPriorityTableIndex, secureModeAlarm=secureModeAlarm, mainPSUPortAutoMdix=mainPSUPortAutoMdix, dNSResolver=dNSResolver, authorizationControlTable=authorizationControlTable, capacityVariantMismatch=capacityVariantMismatch, sNMPEnabledTraps=sNMPEnabledTraps, remoteUnitNameLinked=remoteUnitNameLinked, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, dfsTableIndex=dfsTableIndex, bridgeGroup=bridgeGroup, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, l2CPPriorityTableEntry=l2CPPriorityTableEntry, productName=productName, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, eIRP=eIRP, sNTPServerTableNumber=sNTPServerTableNumber, qOSPriorityScheme=qOSPriorityScheme, txColorCode=txColorCode, transmitPowerLinked=transmitPowerLinked, daylightSaving=daylightSaving, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, vLANManagementPriority=vLANManagementPriority, remoteInternetAddressType=remoteInternetAddressType, mABMaintenanceLevel=mABMaintenanceLevel, sntpGroup=sntpGroup, sNMPTrapVersion=sNMPTrapVersion, auxPortDisabledWarning=auxPortDisabledWarning, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, snmpControlGroup=snmpControlGroup, transmitterChannels=transmitterChannels, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, userTable=userTable, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, versions=versions, tdmTable=tdmTable, siteName=siteName, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, txMABFrames=txMABFrames, oOBPriorityQueueMapping=oOBPriorityQueueMapping, tDDControl=tDDControl, useVLANForMABProtocol=useVLANForMABProtocol, licenseTLSRekey=licenseTLSRekey, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, license=license, receiveModulationModeDetail=receiveModulationModeDetail, syslogLocalWrappedTrap=syslogLocalWrappedTrap, latitude=latitude, telnetAccessEnabled=telnetAccessEnabled, transmitChannel=transmitChannel, channelChangeTrap=channelChangeTrap, byteErrorRatio=byteErrorRatio, phyInstancedStatusTable=phyInstancedStatusTable, dataPortPauseFrames=dataPortPauseFrames, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, capacityVariantMismatchLinked=capacityVariantMismatchLinked, incompatibleRegulatoryBands=incompatibleRegulatoryBands, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, transmitFreqMHz=transmitFreqMHz, linkModeOptimizationMismatch=linkModeOptimizationMismatch, enableTransmission=enableTransmission, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, hTTPSPortNumber=hTTPSPortNumber, userTableNumber=userTableNumber, encryption=encryption, tDDControlGroup=tDDControlGroup, signalStrengthRatioLinked=signalStrengthRatioLinked, licenseGasGroup=licenseGasGroup, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, licenseOOBManagementSupport=licenseOOBManagementSupport, targetRange=targetRange, tFTPClient=tFTPClient, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, searchState=searchState, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, gatewayIPAddress=gatewayIPAddress, mgmtInstancedTableEntry=mgmtInstancedTableEntry, tdmTableIndex=tdmTableIndex, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, portAllocationMismatch=portAllocationMismatch, dataPortWirelessDownAlert=dataPortWirelessDownAlert, vectorError=vectorError, ethernetGroup=ethernetGroup, rxColorCode=rxColorCode, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, routerProtocols=routerProtocols, resetGroup=resetGroup, licenseUnitSerialNumber=licenseUnitSerialNumber, sFPPortAutoMdix=sFPPortAutoMdix, managementNetworkAccessEnabled=managementNetworkAccessEnabled, bootVersion=bootVersion, linkLossLinked=linkLossLinked, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsPeaks=dfsPeaks, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, sFPPortSyncERxStatus=sFPPortSyncERxStatus, nIDULanPortAutoMdix=nIDULanPortAutoMdix, extendedSpectrumScanning=extendedSpectrumScanning, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, mgmtInstancedTableNumber=mgmtInstancedTableNumber, rawReceivePowerLinked=rawReceivePowerLinked, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, licenseIEEE1588Support=licenseIEEE1588Support, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, sNMPCommunityString=sNMPCommunityString, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, pubStats=pubStats, phyControlInstancedTableNumber=phyControlInstancedTableNumber, mABState=mABState, syslogStateTrap=syslogStateTrap, dSCPManagementPriority=dSCPManagementPriority, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, rawReceivePower=rawReceivePower, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, cableDiagPair2Results=cableDiagPair2Results, supplementaryGroup=supplementaryGroup, sNTPPollInterval=sNTPPollInterval, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, cableDiagPair3Distance=cableDiagPair3Distance, remoteInternetAddressLinked=remoteInternetAddressLinked, licenseIssueNumber=licenseIssueNumber, unavailableSeconds=unavailableSeconds, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, auxPortStatus=auxPortStatus, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, unitIdentificationGroup=unitIdentificationGroup, userRole=userRole, accessMethod=accessMethod, transmitModulationMode=transmitModulationMode, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, iPv6PrefixLength=iPv6PrefixLength, sNTPSync=sNTPSync, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, sMTPServerInternetAddress=sMTPServerInternetAddress, licenseInstancedTableNumber=licenseInstancedTableNumber, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, dNSServerPortNumber=dNSServerPortNumber, auxPortAcceptedQLRx=auxPortAcceptedQLRx, signalStrengthRatio=signalStrengthRatio, timeZone=timeZone, severelyErroredSeconds=severelyErroredSeconds, syncEEquipmentClock=syncEEquipmentClock, sNMPPortNumber=sNMPPortNumber, portAllocationMismatchTrap=portAllocationMismatchTrap, userEnabled=userEnabled, PYSNMP_MODULE_ID=cambium, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, sNTPServerTimeout=sNTPServerTimeout, sNTPPrimaryServer=sNTPPrimaryServer, transmitDataRateLinked=transmitDataRateLinked, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, phyControl=phyControl, auxPortSyncERxStatus=auxPortSyncERxStatus, softwareVersion=softwareVersion, auxPortSSMTx=auxPortSSMTx, iPVersion=iPVersion, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, ptp=ptp, productVariant=productVariant, maxLinkRangeExceeded=maxLinkRangeExceeded, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, dNSServerTableIndex=dNSServerTableIndex, ptpGroups=ptpGroups, mABProtocolVLANPriority=mABProtocolVLANPriority, alarmInstancedTableEntry=alarmInstancedTableEntry, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, sFPPortQLRx=sFPPortQLRx, regulatoryBand=regulatoryBand, tDDSynchronizationMode=tDDSynchronizationMode)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, installArmState=installArmState, erroredSeconds=erroredSeconds, dfs=dfs, dNSServerInternetAddress=dNSServerInternetAddress, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, tDMEnabledChannels=tDMEnabledChannels, cambium=cambium, userPassword=userPassword, transmitModulationModeLinked=transmitModulationModeLinked, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, blacklistRMMacAddress=blacklistRMMacAddress, apcGroup=apcGroup, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, tDMConfigurationMismatch=tDMConfigurationMismatch, mABProtocolVID=mABProtocolVID, altitude=altitude, transmitFreqKHz=transmitFreqKHz, unitIdentification=unitIdentification, alarmsGroup=alarmsGroup, sNTPServerInternetAddressType=sNTPServerInternetAddressType, transparentClockVID=transparentClockVID, configurationInstancedTableIndex=configurationInstancedTableIndex, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, syncETracking=syncETracking, maximumTransmitPower=maximumTransmitPower, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, hTTPPortNumber=hTTPPortNumber, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, licenseVersion=licenseVersion, ethernetInstancedTableNumber=ethernetInstancedTableNumber, tFTPServerInternetAddress=tFTPServerInternetAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, wirelessLinkAvailability=wirelessLinkAvailability, authorizationControlTableIndex=authorizationControlTableIndex, systemReset=systemReset, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, licenseHCMPSupport=licenseHCMPSupport, sNTPServerPortNumber=sNTPServerPortNumber, mABTransmissionInterval=mABTransmissionInterval, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, transparentClock=transparentClock, licenseCapacity=licenseCapacity, licenseRegulatoryBandsList=licenseRegulatoryBandsList, rangingMode=rangingMode, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, encryptionAlgorithm=encryptionAlgorithm, sFPPortAutoNegotiation=sFPPortAutoNegotiation, telnetPortNumber=telnetPortNumber, installArmStateTrap=installArmStateTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, regulatoryBandTrap=regulatoryBandTrap, portAllocationMismatchLinked=portAllocationMismatchLinked, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPServerTableEntry=sNTPServerTableEntry, notificationsGroup=notificationsGroup)
