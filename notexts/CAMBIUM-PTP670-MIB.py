...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", capacityVariantMismatchLinked=capacityVariantMismatchLinked, dNSServerTableIndex=dNSServerTableIndex, phyControlInstancedTable=phyControlInstancedTable, dNSResolver=dNSResolver, ethernetGroup=ethernetGroup, dfsTable=dfsTable, auxPortQLTx=auxPortQLTx, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sFPPortAutoMdix=sFPPortAutoMdix, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, dNSGroup=dNSGroup, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, bridgeGroup=bridgeGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, phyStatusGroup=phyStatusGroup, installStatusLinked=installStatusLinked, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, receiveChannel=receiveChannel, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, cableDiagPair3Results=cableDiagPair3Results, portAllocationMismatch=portAllocationMismatch, remoteUnitName=remoteUnitName, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, tFTPServerInternetAddress=tFTPServerInternetAddress, qOSPriorityScheme=qOSPriorityScheme, subbandHighestFrequency=subbandHighestFrequency, daylightSaving=daylightSaving, rawReceivePower=rawReceivePower, nIDULanPortAutoMdix=nIDULanPortAutoMdix, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, rxColorCode=rxColorCode, routerProtocols=routerProtocols, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, tdmTable=tdmTable, configurationInstancedTableIndex=configurationInstancedTableIndex, unitIdentification=unitIdentification, tDMChannelLineCode=tDMChannelLineCode, cableLoss=cableLoss, sNTPServerTable=sNTPServerTable, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, eIRP=eIRP, ethernetStatisticsTable=ethernetStatisticsTable, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, receiveDataRate=receiveDataRate, licenseRARSupport=licenseRARSupport, hTTPPortNumber=hTTPPortNumber, licenseTrialPeriod=licenseTrialPeriod, bootVersion=bootVersion, transmitDataRateLinked=transmitDataRateLinked, licenseSFPPortSupport=licenseSFPPortSupport, ethernetPriorityTableNumber=ethernetPriorityTableNumber, tDMChannelCableLength=tDMChannelCableLength, mainPSUPortAllocation=mainPSUPortAllocation, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, mgmtInstancedTableIndex=mgmtInstancedTableIndex, secureModeAlarmTrap=secureModeAlarmTrap, auxPortStatus=auxPortStatus, ethernetInstancedTable=ethernetInstancedTable, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, userTableEntry=userTableEntry, remoteMACAddress=remoteMACAddress, erroredSeconds=erroredSeconds, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, syslogState=syslogState, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, reset=reset, wirelessLinkAvailability=wirelessLinkAvailability, syslogClient=syslogClient, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, syslogControl=syslogControl, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, syncETrackingState=syncETrackingState, dataBridgingStatusLinked=dataBridgingStatusLinked, sNTPServerTableNumber=sNTPServerTableNumber, management=management, tDM=tDM, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, cableDiagPair1Distance=cableDiagPair1Distance, latitude=latitude, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, timeZone=timeZone, mABProtocolVLANPriority=mABProtocolVLANPriority, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, licenseSecurityLevel=licenseSecurityLevel, sFPPortAllocation=sFPPortAllocation, licenseInstancedTableNumber=licenseInstancedTableNumber, linkLossLinked=linkLossLinked, hCMPLinkSymmetry=hCMPLinkSymmetry, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, iPv4Address=iPv4Address, ethernetInstancedTableNumber=ethernetInstancedTableNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, hCMPMaximumLinkRange=hCMPMaximumLinkRange, userName=userName, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, iPv6PrefixLength=iPv6PrefixLength, notificationsGroup=notificationsGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPServerPortNumber=sNTPServerPortNumber, channelBandwidth=channelBandwidth, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, authorizationControl=authorizationControl, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dataBridgingStatus=dataBridgingStatus, remoteInternetAddress=remoteInternetAddress, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, regulatoryBandTrap=regulatoryBandTrap, ptpTraps=ptpTraps, tDMConfigurationMismatch=tDMConfigurationMismatch, receiveDataRateLinked=receiveDataRateLinked, transparentClockVLAN=transparentClockVLAN, licenseGroup=licenseGroup, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, wirelessOutEthernetOctets=wirelessOutEthernetOctets, licenseInstancedTable=licenseInstancedTable, mABProtocolVID=mABProtocolVID, signalStrengthRatioLinked=signalStrengthRatioLinked, transmitFreqKHz=transmitFreqKHz, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPSync=sNTPSync, siteName=siteName, dNSServerTableEntry=dNSServerTableEntry, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, linkModeOptimization=linkModeOptimization, transparentClockVID=transparentClockVID, licenseGroupAccess=licenseGroupAccess, hTTPSAccessEnabled=hTTPSAccessEnabled, wirelessOutOctets=wirelessOutOctets, dfsMeans=dfsMeans, transmitChannel=transmitChannel, receiveModulationModeDetail=receiveModulationModeDetail, subbandLowestFrequency=subbandLowestFrequency, tDDSynchronizationAlarm=tDDSynchronizationAlarm, cableDiagPair2Distance=cableDiagPair2Distance, cableDiagnosticsWarning=cableDiagnosticsWarning, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, sFPError=sFPError, unitName=unitName, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, targetRange=targetRange, incompatibleRegulatoryBands=incompatibleRegulatoryBands, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, cableDiagPair3Distance=cableDiagPair3Distance, ptpCompliance=ptpCompliance, licenseCapacity=licenseCapacity, userTable=userTable, sNMPTrapTableEntry=sNMPTrapTableEntry, portAllocationMismatchTrap=portAllocationMismatchTrap, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, userEnabled=userEnabled, cableDiagPair2Results=cableDiagPair2Results, tdmTableEntry=tdmTableEntry, l2CPPriorityTableIndex=l2CPPriorityTableIndex, auxPortConfigurationMismatch=auxPortConfigurationMismatch, ethernetInstancedTableEntry=ethernetInstancedTableEntry, auxPortDisabledWarning=auxPortDisabledWarning, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, sMTPEnabledMessages=sMTPEnabledMessages, txMABFrames=txMABFrames, iPv6Address=iPv6Address, authorizationControlTable=authorizationControlTable, licenseRegulatoryBandsList=licenseRegulatoryBandsList, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, wirelessLinkStatus=wirelessLinkStatus, mainPSUPortSSMTx=mainPSUPortSSMTx, licenseTDDSyncSupport=licenseTDDSyncSupport, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, range=range, sNMPTrapInternetAddress=sNMPTrapInternetAddress, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, dNS=dNS, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, alarms=alarms, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, tDMInterfaceControl=tDMInterfaceControl, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, licenseIEEE1588Support=licenseIEEE1588Support, sMTPServerInternetAddressType=sMTPServerInternetAddressType, cableDiagnosticsPorts=cableDiagnosticsPorts, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, productVariant=productVariant, receivePower=receivePower, linkName=linkName, mainPSUPortStatusTrap=mainPSUPortStatusTrap, dNSPrimaryServer=dNSPrimaryServer, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfsTableEntry=dfsTableEntry, phyControlInstancedTableEntry=phyControlInstancedTableEntry, sFPPortQLRx=sFPPortQLRx, installStatusTrap=installStatusTrap, secondarySoftwareVersion=secondarySoftwareVersion, tDMChannelLoopback=tDMChannelLoopback, aggregateDataRateLinked=aggregateDataRateLinked, licenseIssueNumber=licenseIssueNumber, dSCPManagementPriority=dSCPManagementPriority, alarmInstancedTableIndex=alarmInstancedTableIndex, dNSServerTableNumber=dNSServerTableNumber, sNMPEnabledTraps=sNMPEnabledTraps, phyControlInstancedTableIndex=phyControlInstancedTableIndex, telnetPortNumber=telnetPortNumber, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, phyInstancedStatusTable=phyInstancedStatusTable, l2CPPriorityTableNumber=l2CPPriorityTableNumber, unitIdentificationGroup=unitIdentificationGroup, installArmStateTrap=installArmStateTrap, mgmtInstancedTable=mgmtInstancedTable, authorizationControlTableNumber=authorizationControlTableNumber, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, licenseSyncESupport=licenseSyncESupport, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNTPLastSync=sNTPLastSync, configuration=configuration, aggregateDataRate=aggregateDataRate, tDMEnabledChannels=tDMEnabledChannels, lowestDataModulationMode=lowestDataModulationMode, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, sFPPortSSMTx=sFPPortSSMTx, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, versions=versions, bridge=bridge, ptp=ptp, useVLANForMABProtocol=useVLANForMABProtocol, signalStrengthRatio=signalStrengthRatio, dfsGroup=dfsGroup, ethernetStatisticsDataSource=ethernetStatisticsDataSource, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, sNTPPrimaryServer=sNTPPrimaryServer, transparentClock=transparentClock, pubStatsGroup=pubStatsGroup, phyStatus=phyStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, smtp=smtp, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, tFTPClient=tFTPClient, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, localPacketFiltering=localPacketFiltering)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", blacklistRMEnabled=blacklistRMEnabled, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, maxLinkRangeExceeded=maxLinkRangeExceeded, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, syncESlavePort=syncESlavePort, sNMPTrapVersion=sNMPTrapVersion, packetsToInternalStack=packetsToInternalStack, maximumTransmitPower=maximumTransmitPower, sNTPServerInternetAddress=sNTPServerInternetAddress, wirelessLinkStatusLinked=wirelessLinkStatusLinked, cableDiagPair4Distance=cableDiagPair4Distance, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, severelyErroredSeconds=severelyErroredSeconds, managementGroup=managementGroup, licenseOOBManagementSupport=licenseOOBManagementSupport, tdmTableIndex=tdmTableIndex, tdmTableNumber=tdmTableNumber, cableDiagPair4Results=cableDiagPair4Results, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, mABHoldoffPeriod=mABHoldoffPeriod, mABTransmissionInterval=mABTransmissionInterval, syslogClientTrap=syslogClientTrap, sFPPortDisabledWarning=sFPPortDisabledWarning, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, remoteInternetAddressType=remoteInternetAddressType, telnetAccessEnabled=telnetAccessEnabled, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, rangeLinked=rangeLinked, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, sNTPServerRetries=sNTPServerRetries, iPDSCPPriorityTable=iPDSCPPriorityTable, dNSServerInternetAddressType=dNSServerInternetAddressType, mainPSUPortQLRx=mainPSUPortQLRx, mainPSUPortAutoMdix=mainPSUPortAutoMdix, ethernetPriorityTable=ethernetPriorityTable, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, auxPortSyncERxStatus=auxPortSyncERxStatus, targetMACAddress=targetMACAddress, apcGroup=apcGroup, receiveModulationMode=receiveModulationMode, ethernet=ethernet, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, receivePowerLinked=receivePowerLinked, whitelistRMMacAddress=whitelistRMMacAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, capacityVariantMismatchTrap=capacityVariantMismatchTrap, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, antennaGain=antennaGain, wirelessTopology=wirelessTopology, sFPPortSyncERxStatus=sFPPortSyncERxStatus, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, lbtDetectedTrap=lbtDetectedTrap, hTTPAccessEnabled=hTTPAccessEnabled, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, deviceESN=deviceESN, sMTPEmailAlert=sMTPEmailAlert, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, mPLSTCPriorityTable=mPLSTCPriorityTable, receiveFreqMHz=receiveFreqMHz, userTableNumber=userTableNumber, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, syncEEquipmentClock=syncEEquipmentClock, oOBPriorityQueueMapping=oOBPriorityQueueMapping, transmitPower=transmitPower, dfsTableIndex=dfsTableIndex, mainPSUPortStatus=mainPSUPortStatus, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, sFPPortAutoNegotiation=sFPPortAutoNegotiation, installStatus=installStatus, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, configurationInstancedTable=configurationInstancedTable, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, channelChangeTrap=channelChangeTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, cambium=cambium, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, aAAControl=aAAControl, cableDiagnosticsResultTable=cableDiagnosticsResultTable, ptpTrapPrefix=ptpTrapPrefix, tDMChannelStatusTrap=tDMChannelStatusTrap, cableDiagPair1Results=cableDiagPair1Results, blacklistRMMacAddress=blacklistRMMacAddress, vectorError=vectorError, iPv6GatewayAddress=iPv6GatewayAddress, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, cableDiagnostics=cableDiagnostics, receiveFreqKHz=receiveFreqKHz, auxPortAllocation=auxPortAllocation, mABMaintenanceLevel=mABMaintenanceLevel, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, managementPortWirelessDownAlert=managementPortWirelessDownAlert, productName=productName, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, enableTransmission=enableTransmission, receiveModulationModeLinked=receiveModulationModeLinked, transmitModulationMode=transmitModulationMode, sNMPTrapTable=sNMPTrapTable, transmitPowerLinked=transmitPowerLinked, ethernetInstancedTableIndex=ethernetInstancedTableIndex, tDDControlGroup=tDDControlGroup, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, licenseGasGroup=licenseGasGroup, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, transmitFreqMHz=transmitFreqMHz, tDMInterfaceStatus=tDMInterfaceStatus, vLANManagementVID=vLANManagementVID, unavailableSeconds=unavailableSeconds, dataPortPauseFrames=dataPortPauseFrames, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPServerTableIndex=sNTPServerTableIndex, dataBridgingAvailability=dataBridgingAvailability, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, searchStateLinked=searchStateLinked, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, dNSServerPortNumber=dNSServerPortNumber, tDDControl=tDDControl, groupID=groupID, masterSlaveMode=masterSlaveMode, configurationInstancedTableNumber=configurationInstancedTableNumber, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, iPVersion=iPVersion, sNMPCommunityString=sNMPCommunityString, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, nIDULanPortStatusTrap=nIDULanPortStatusTrap, hTTPSPortNumber=hTTPSPortNumber, deviceMSN=deviceMSN, mgmtInstancedTableNumber=mgmtInstancedTableNumber, licenseUnitSerialNumber=licenseUnitSerialNumber, encryption=encryption, softwareVersion=softwareVersion, unitOutOfCalibration=unitOutOfCalibration, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, sNMPPortNumber=sNMPPortNumber, authorizationControlGroup=authorizationControlGroup, extendedSpectrumScanning=extendedSpectrumScanning, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNTPServerStatus=sNTPServerStatus, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, frequencyVariant=frequencyVariant, phyControlInstancedTableNumber=phyControlInstancedTableNumber, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, auxPortAcceptedQLRx=auxPortAcceptedQLRx, managementNetworkAccessEnabled=managementNetworkAccessEnabled, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, altitude=altitude, portAllocationMismatchLinked=portAllocationMismatchLinked, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, ptp670=ptp670, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, license=license, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, versionsGroup=versionsGroup, alarmInstancedTableEntry=alarmInstancedTableEntry, sMTPServerPortNumber=sMTPServerPortNumber, userRole=userRole, dNSServerInternetAddress=dNSServerInternetAddress, syslogStateTrap=syslogStateTrap, phyControlGroup=phyControlGroup, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, sNTPPollInterval=sNTPPollInterval, transparentClockPort=transparentClockPort, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfs=dfs, regulatoryBand=regulatoryBand, remoteUnitNameLinked=remoteUnitNameLinked, searchState=searchState, antennaSelection=antennaSelection, dataPortWirelessDownAlert=dataPortWirelessDownAlert, authorizationMethod=authorizationMethod, accessMethod=accessMethod, userPassword=userPassword, transmitterChannels=transmitterChannels, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, l2CPPriorityTable=l2CPPriorityTable, dfsPeaks=dfsPeaks, tDDSynchronizationStatus=tDDSynchronizationStatus, txColorCode=txColorCode, linkSymmetry=linkSymmetry, sNTPState=sNTPState, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, licenseBandwidthCap=licenseBandwidthCap, tDDSynchronizationMode=tDDSynchronizationMode, deviceMACAddress=deviceMACAddress, tDMGroup=tDMGroup, supplementaryGroup=supplementaryGroup, cableDiagnosticsGroup=cableDiagnosticsGroup, capacityVariantMismatch=capacityVariantMismatch, nIDULanPortStatus=nIDULanPortStatus, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, licenseEncryption=licenseEncryption, sNTPSyncTrap=sNTPSyncTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, licenseInstancedTableIndex=licenseInstancedTableIndex, configurationGroup=configurationGroup, vLANManagementPriority=vLANManagementPriority, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, tempPcb=tempPcb, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, tFTPServerPortNumber=tFTPServerPortNumber, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, licenseIPv6Support=licenseIPv6Support, lowestTDMModulationMode=lowestTDMModulationMode, syncETracking=syncETracking, licenseTLSRekey=licenseTLSRekey, sNMPv3Enable=sNMPv3Enable, transmitModulationModeLinked=transmitModulationModeLinked, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, linkLoss=linkLoss, dfsTableNumber=dfsTableNumber, dataBridgingStatusAlarm=dataBridgingStatusAlarm, encryptionGroup=encryptionGroup, tDMChannelStatus=tDMChannelStatus, maximumNumberOfSlaves=maximumNumberOfSlaves, alarmInstancedTable=alarmInstancedTable, ptmp=ptmp, remoteInternetAddressLinked=remoteInternetAddressLinked, snmpControl=snmpControl, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, authorizationControlTableEntry=authorizationControlTableEntry, auxPortSSMTx=auxPortSSMTx, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, hardwareVersion=hardwareVersion, licenseInstancedTableEntry=licenseInstancedTableEntry, dNSServerTable=dNSServerTable, alarmsGroup=alarmsGroup, apc=apc, mABNominalTransmitCapacity=mABNominalTransmitCapacity, mgmtInstancedTableEntry=mgmtInstancedTableEntry, ptpGroups=ptpGroups, mABNominalModulationMode=mABNominalModulationMode, auxPortQLRx=auxPortQLRx, supplementary=supplementary, longitude=longitude, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, wirelessOutAllOctets=wirelessOutAllOctets, pubStats=pubStats)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", l2CPPriorityTableEntry=l2CPPriorityTableEntry, userTableIndex=userTableIndex, authorizationControlTableIndex=authorizationControlTableIndex, installationMode=installationMode, transmitDataRate=transmitDataRate, phyControl=phyControl, subnetMask=subnetMask, licenseVersion=licenseVersion, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, licenseMaxLinkRange=licenseMaxLinkRange, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, aAAControlGroup=aAAControlGroup, sFPPortQLTx=sFPPortQLTx, installArmState=installArmState, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, snmpControlGroup=snmpControlGroup, rangingMode=rangingMode, gatewayIPAddress=gatewayIPAddress, systemReset=systemReset, sFPPortStatusTrap=sFPPortStatusTrap, licenseHCMPSupport=licenseHCMPSupport, sNTPServerTableEntry=sNTPServerTableEntry, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, vectorErrorLinked=vectorErrorLinked, incompatibleMasterAndSlave=incompatibleMasterAndSlave, remoteMACAddressLinked=remoteMACAddressLinked, sntp=sntp, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, mainPSUPortQLTx=mainPSUPortQLTx, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, rawReceivePowerLinked=rawReceivePowerLinked, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, secureModeAlarm=secureModeAlarm, mABState=mABState, pubInstancedStatsTable=pubInstancedStatsTable, auxPortStatusTrap=auxPortStatusTrap, routerProtocolsGroup=routerProtocolsGroup, ethernetPriorityTableEntry=ethernetPriorityTableEntry, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPServerTimeout=sNTPServerTimeout, cableDiagnosticsControl=cableDiagnosticsControl, licenseCountry=licenseCountry, configurationInstancedTableEntry=configurationInstancedTableEntry, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, byteErrorRatio=byteErrorRatio, syslogControlGroup=syslogControlGroup, smtpGroup=smtpGroup, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, byteErrorRatioLinked=byteErrorRatioLinked, encryptionAlgorithm=encryptionAlgorithm, sntpGroup=sntpGroup, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, resetGroup=resetGroup, alarmInstancedTableNumber=alarmInstancedTableNumber, whitelistRMEnabled=whitelistRMEnabled, systemClock=systemClock, packetsFromInternalStack=packetsFromInternalStack, sFPPortStatus=sFPPortStatus, sFPErrorTrap=sFPErrorTrap, PYSNMP_MODULE_ID=cambium)
