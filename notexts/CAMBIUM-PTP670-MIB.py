...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", reset=reset, sMTPServerInternetAddressType=sMTPServerInternetAddressType, hardwareVersion=hardwareVersion, encryptionGroup=encryptionGroup, sNTPLastSync=sNTPLastSync, sFPPortStatus=sFPPortStatus, oOBPriorityQueueMapping=oOBPriorityQueueMapping, cableDiagPair2Distance=cableDiagPair2Distance, pubInstancedStatsTable=pubInstancedStatsTable, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, packetsToInternalStack=packetsToInternalStack, tDMInterfaceControl=tDMInterfaceControl, channelBandwidth=channelBandwidth, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, mainPSUPortStatus=mainPSUPortStatus, tDMChannelStatusTrap=tDMChannelStatusTrap, dfsTable=dfsTable, nIDULanPortStatusTrap=nIDULanPortStatusTrap, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, cableDiagnosticsResultTable=cableDiagnosticsResultTable, ethernetInstancedTableIndex=ethernetInstancedTableIndex, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, portAllocationMismatchTrap=portAllocationMismatchTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, iPv6PrefixLength=iPv6PrefixLength, sNTPServerTableIndex=sNTPServerTableIndex, phyControlInstancedTableEntry=phyControlInstancedTableEntry, licenseGroupAccess=licenseGroupAccess, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, mainPSUPortSSMTx=mainPSUPortSSMTx, dfs=dfs, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, remoteUnitName=remoteUnitName, tFTPClient=tFTPClient, daylightSaving=daylightSaving, ethernetPriorityTable=ethernetPriorityTable, alarmsGroup=alarmsGroup, cableDiagnosticsGroup=cableDiagnosticsGroup, userTable=userTable, aAAControlGroup=aAAControlGroup, sNTPServerInternetAddressType=sNTPServerInternetAddressType, masterSlaveMode=masterSlaveMode, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, alarmInstancedTableIndex=alarmInstancedTableIndex, licenseEncryption=licenseEncryption, licenseInstancedTableIndex=licenseInstancedTableIndex, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, auxPortDisabledWarning=auxPortDisabledWarning, lowestTDMModulationMode=lowestTDMModulationMode, accessMethod=accessMethod, auxPortSSMTx=auxPortSSMTx, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, mgmtInstancedTableEntry=mgmtInstancedTableEntry, sNMPPortNumber=sNMPPortNumber, softwareVersion=softwareVersion, rxColorCode=rxColorCode, configurationInstancedTable=configurationInstancedTable, sFPPortQLTx=sFPPortQLTx, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, rangeLinked=rangeLinked, tdmTableIndex=tdmTableIndex, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, alarmInstancedTableNumber=alarmInstancedTableNumber, licenseSFPPortSupport=licenseSFPPortSupport, installStatusLinked=installStatusLinked, cableDiagnosticsControl=cableDiagnosticsControl, syslogState=syslogState, sNTPServerInternetAddress=sNTPServerInternetAddress, licenseIEEE1588Support=licenseIEEE1588Support, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, hTTPAccessEnabled=hTTPAccessEnabled, dNSServerTable=dNSServerTable, configuration=configuration, subbandLowestFrequency=subbandLowestFrequency, ethernet=ethernet, byteErrorRatio=byteErrorRatio, whitelistRMEnabled=whitelistRMEnabled, cableDiagPair4Results=cableDiagPair4Results, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, wirelessOutOctets=wirelessOutOctets, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, phyStatus=phyStatus, phyInstancedStatusTable=phyInstancedStatusTable, sNTPServerTimeout=sNTPServerTimeout, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, auxPortAllocation=auxPortAllocation, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, installArmStateTrap=installArmStateTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, sFPErrorTrap=sFPErrorTrap, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, configurationInstancedTableNumber=configurationInstancedTableNumber, ethernetGroup=ethernetGroup, extendedSpectrumScanning=extendedSpectrumScanning, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ptpTraps=ptpTraps, mABHoldoffPeriod=mABHoldoffPeriod, snmpControlGroup=snmpControlGroup, licenseTLSRekey=licenseTLSRekey, wirelessLinkStatus=wirelessLinkStatus, transmitDataRateLinked=transmitDataRateLinked, transmitModulationModeLinked=transmitModulationModeLinked, remoteMACAddress=remoteMACAddress, sFPPortSyncERxStatus=sFPPortSyncERxStatus, userTableEntry=userTableEntry, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, txMABFrames=txMABFrames, rawReceivePowerLinked=rawReceivePowerLinked, sNTPState=sNTPState, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, wirelessOutEthernetOctets=wirelessOutEthernetOctets, erroredSeconds=erroredSeconds, cableDiagPair4Distance=cableDiagPair4Distance, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPSync=sNTPSync, antennaGain=antennaGain, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, transmitPowerLinked=transmitPowerLinked, cableDiagnosticsWarning=cableDiagnosticsWarning, sFPPortSSMTx=sFPPortSSMTx, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, ptpCompliance=ptpCompliance, targetRange=targetRange, transmitDataRate=transmitDataRate, vLANManagementVID=vLANManagementVID, iPv4Address=iPv4Address, phyControlInstancedTable=phyControlInstancedTable, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, dfsPeaks=dfsPeaks, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPEnabledTraps=sNMPEnabledTraps, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, authorizationControlGroup=authorizationControlGroup, sFPError=sFPError, remoteInternetAddressType=remoteInternetAddressType, mainPSUPortQLRx=mainPSUPortQLRx, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, authorizationControlTable=authorizationControlTable, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, linkSymmetry=linkSymmetry, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, transmitModulationMode=transmitModulationMode, installArmState=installArmState, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, mABProtocolVID=mABProtocolVID, tDMConfigurationMismatch=tDMConfigurationMismatch, sFPPortAutoMdix=sFPPortAutoMdix, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, tDMEnabledChannels=tDMEnabledChannels, wirelessLinkAvailability=wirelessLinkAvailability, syslogControl=syslogControl, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, authorizationControlTableNumber=authorizationControlTableNumber, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, bridgeGroup=bridgeGroup, searchState=searchState, sNTPPollInterval=sNTPPollInterval, authorizationMethod=authorizationMethod, deviceESN=deviceESN, alarmInstancedTable=alarmInstancedTable, severelyErroredSeconds=severelyErroredSeconds, subbandHighestFrequency=subbandHighestFrequency, alarmInstancedTableEntry=alarmInstancedTableEntry, phyControlGroup=phyControlGroup, sFPPortStatusTrap=sFPPortStatusTrap, nIDULanPortStatus=nIDULanPortStatus, capacityVariantMismatch=capacityVariantMismatch, mABProtocolVLANPriority=mABProtocolVLANPriority, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, tDMInterfaceStatus=tDMInterfaceStatus, sFPPortQLRx=sFPPortQLRx, syslogStateTrap=syslogStateTrap, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, ethernetInstancedTableNumber=ethernetInstancedTableNumber, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, auxPortAcceptedQLRx=auxPortAcceptedQLRx, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, userName=userName, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, aggregateDataRate=aggregateDataRate, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, receiveChannel=receiveChannel, receiveModulationModeDetail=receiveModulationModeDetail, ethernetInstancedTable=ethernetInstancedTable, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, incompatibleRegulatoryBands=incompatibleRegulatoryBands, pubStats=pubStats, ethernetPriorityTableEntry=ethernetPriorityTableEntry, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, licenseOOBManagementSupport=licenseOOBManagementSupport, receiveModulationModeLinked=receiveModulationModeLinked, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, txColorCode=txColorCode, transmitPower=transmitPower, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, cableDiagnostics=cableDiagnostics, tempPcb=tempPcb, sMTPSourceEmailAddress=sMTPSourceEmailAddress, systemClock=systemClock, secureModeAlarm=secureModeAlarm, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, ptpGroups=ptpGroups, installStatus=installStatus, notificationsGroup=notificationsGroup, configurationGroup=configurationGroup, sFPPortAutoNegotiation=sFPPortAutoNegotiation, sNMPv3Enable=sNMPv3Enable, searchStateLinked=searchStateLinked, dNSServerInternetAddressType=dNSServerInternetAddressType, sNTPServerTableNumber=sNTPServerTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, iPVersion=iPVersion, vLANManagementPriority=vLANManagementPriority, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortPauseFrames=dataPortPauseFrames, cableDiagPair1Results=cableDiagPair1Results, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ethernetInstancedTableEntry=ethernetInstancedTableEntry, whitelistRMMacAddress=whitelistRMMacAddress, dNSGroup=dNSGroup, dNS=dNS, dataBridgingStatus=dataBridgingStatus, sMTPEmailAlert=sMTPEmailAlert, managementNetworkAccessEnabled=managementNetworkAccessEnabled, tFTPServerInternetAddressType=tFTPServerInternetAddressType, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, linkModeOptimizationMismatch=linkModeOptimizationMismatch, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, syslogClientTrap=syslogClientTrap, sntpGroup=sntpGroup, licenseVersion=licenseVersion, byteErrorRatioLinked=byteErrorRatioLinked, aggregateDataRateLinked=aggregateDataRateLinked, maximumTransmitPower=maximumTransmitPower, encryptionAlgorithm=encryptionAlgorithm, timeZone=timeZone, ethernetStatisticsTable=ethernetStatisticsTable, dfsTableEntry=dfsTableEntry, phyControl=phyControl, configurationInstancedTableEntry=configurationInstancedTableEntry, transparentClock=transparentClock)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", gatewayIPAddress=gatewayIPAddress, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, lowestDataModulationMode=lowestDataModulationMode, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, sNTPServerRetries=sNTPServerRetries, syncETrackingState=syncETrackingState, tDMChannelLineCode=tDMChannelLineCode, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, licenseHCMPSupport=licenseHCMPSupport, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, encryption=encryption, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, secureModeAlarmTrap=secureModeAlarmTrap, mABMaintenanceLevel=mABMaintenanceLevel, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, installationMode=installationMode, sNTPSyncTrap=sNTPSyncTrap, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, licenseBandwidthCap=licenseBandwidthCap, ptpTrapPrefix=ptpTrapPrefix, channelChangeTrap=channelChangeTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, licenseSecurityLevel=licenseSecurityLevel, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, syslogClient=syslogClient, mainPSUPortQLTx=mainPSUPortQLTx, auxPortSyncERxStatus=auxPortSyncERxStatus, sNMPCommunityString=sNMPCommunityString, dataBridgingStatusAlarm=dataBridgingStatusAlarm, cableDiagPair3Results=cableDiagPair3Results, latitude=latitude, dSCPManagementPriority=dSCPManagementPriority, linkName=linkName, receivePowerLinked=receivePowerLinked, sNTPServerTable=sNTPServerTable, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, dNSServerTableEntry=dNSServerTableEntry, mPLSTCPriorityTable=mPLSTCPriorityTable, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, telnetAccessEnabled=telnetAccessEnabled, subnetMask=subnetMask, tDDControlGroup=tDDControlGroup, receiveFreqMHz=receiveFreqMHz, altitude=altitude, apc=apc, siteName=siteName, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, userPassword=userPassword, supplementaryGroup=supplementaryGroup, tDDSynchronizationMode=tDDSynchronizationMode, enableTransmission=enableTransmission, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, auxPortQLTx=auxPortQLTx, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, iPv6Address=iPv6Address, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, antennaSelection=antennaSelection, ptp670=ptp670, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNMPTrapTableIndex=sNMPTrapTableIndex, vectorError=vectorError, wirelessLinkStatusLinked=wirelessLinkStatusLinked, tDMChannelLoopback=tDMChannelLoopback, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, dNSServerInternetAddress=dNSServerInternetAddress, tdmTableEntry=tdmTableEntry, userEnabled=userEnabled, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, l2CPPriorityTable=l2CPPriorityTable, dfsTableIndex=dfsTableIndex, cableDiagPair3Distance=cableDiagPair3Distance, linkLoss=linkLoss, sNTPServerStatus=sNTPServerStatus, transparentClockVID=transparentClockVID, licenseIPv6Support=licenseIPv6Support, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, dNSResolver=dNSResolver, userTableNumber=userTableNumber, mainPSUPortAutoMdix=mainPSUPortAutoMdix, blacklistRMEnabled=blacklistRMEnabled, sntp=sntp, mainPSUPortAllocation=mainPSUPortAllocation, linkLossLinked=linkLossLinked, signalStrengthRatio=signalStrengthRatio, deviceMACAddress=deviceMACAddress, tdmTableNumber=tdmTableNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sFPPortAllocation=sFPPortAllocation, useVLANForMABProtocol=useVLANForMABProtocol, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, smtpGroup=smtpGroup, mABState=mABState, licenseRARSupport=licenseRARSupport, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, authorizationControl=authorizationControl, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, wirelessTopology=wirelessTopology, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, smtp=smtp, licenseInstancedTableNumber=licenseInstancedTableNumber, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, licenseIssueNumber=licenseIssueNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, productVariant=productVariant, regulatoryBandTrap=regulatoryBandTrap, configurationInstancedTableIndex=configurationInstancedTableIndex, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, mgmtInstancedTable=mgmtInstancedTable, unitIdentification=unitIdentification, receiveDataRate=receiveDataRate, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, ethernetPriorityTableNumber=ethernetPriorityTableNumber, receivePower=receivePower, snmpControl=snmpControl, tDDControl=tDDControl, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, tDMChannelCableLength=tDMChannelCableLength, auxPortStatus=auxPortStatus, unitOutOfCalibration=unitOutOfCalibration, packetsFromInternalStack=packetsFromInternalStack, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, enabledDiagnosticAlarms=enabledDiagnosticAlarms, apcGroup=apcGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, licenseTrialPeriod=licenseTrialPeriod, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, unitIdentificationGroup=unitIdentificationGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tFTPServerInternetAddress=tFTPServerInternetAddress, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, sNMPTrapTableEntry=sNMPTrapTableEntry, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, ethernetStatisticsDataSource=ethernetStatisticsDataSource, eIRP=eIRP, maxLinkRangeExceeded=maxLinkRangeExceeded, licenseSyncESupport=licenseSyncESupport, cableDiagPair2Results=cableDiagPair2Results, dataBridgingStatusLinked=dataBridgingStatusLinked, phyControlInstancedTableNumber=phyControlInstancedTableNumber, supplementary=supplementary, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, ptmp=ptmp, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, mABTransmissionInterval=mABTransmissionInterval, bridge=bridge, cambium=cambium, useVLANForManagementInterfaces=useVLANForManagementInterfaces, unitName=unitName, productName=productName, licenseGasGroup=licenseGasGroup, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, sMTPServerInternetAddress=sMTPServerInternetAddress, nIDULanPortAutoMdix=nIDULanPortAutoMdix, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, hTTPSPortNumber=hTTPSPortNumber, regulatoryBand=regulatoryBand, remoteInternetAddressLinked=remoteInternetAddressLinked, transmitterChannels=transmitterChannels, portAllocationMismatchLinked=portAllocationMismatchLinked, portAllocationMismatch=portAllocationMismatch, systemReset=systemReset, bootVersion=bootVersion, managementGroup=managementGroup, qOSPriorityScheme=qOSPriorityScheme, phyControlInstancedTableIndex=phyControlInstancedTableIndex, sNMPTrapVersion=sNMPTrapVersion, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, remoteUnitNameLinked=remoteUnitNameLinked, tdmTable=tdmTable, license=license, maximumNumberOfSlaves=maximumNumberOfSlaves, dNSServerTableIndex=dNSServerTableIndex, capacityVariantMismatchLinked=capacityVariantMismatchLinked, licenseCountry=licenseCountry, dfsTableNumber=dfsTableNumber, range=range, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, syncESlavePort=syncESlavePort, transmitChannel=transmitChannel, licenseUnitSerialNumber=licenseUnitSerialNumber, tDMChannelStatus=tDMChannelStatus, remoteMACAddressLinked=remoteMACAddressLinked, l2CPPriorityTableIndex=l2CPPriorityTableIndex, rawReceivePower=rawReceivePower, licenseInstancedTableEntry=licenseInstancedTableEntry, sNTPPrimaryServer=sNTPPrimaryServer, wirelessOutAllOctets=wirelessOutAllOctets, sFPPortDisabledWarning=sFPPortDisabledWarning, authorizationControlTableEntry=authorizationControlTableEntry, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, hCMPLinkSymmetry=hCMPLinkSymmetry, lbtDetectedTrap=lbtDetectedTrap, frequencyVariant=frequencyVariant, vectorErrorLinked=vectorErrorLinked, licenseMaxLinkRange=licenseMaxLinkRange, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, blacklistRMMacAddress=blacklistRMMacAddress, cableDiagnosticsPorts=cableDiagnosticsPorts, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sMTPEnabledMessages=sMTPEnabledMessages, routerProtocols=routerProtocols, sMTPServerPortNumber=sMTPServerPortNumber, aAAControl=aAAControl, sNTPServerTableEntry=sNTPServerTableEntry, dNSServerTableNumber=dNSServerTableNumber, hCMPMaximumLinkRange=hCMPMaximumLinkRange, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, userRole=userRole, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, deviceMSN=deviceMSN, incompatibleMasterAndSlave=incompatibleMasterAndSlave, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dataBridgingAvailability=dataBridgingAvailability, signalStrengthRatioLinked=signalStrengthRatioLinked, unavailableSeconds=unavailableSeconds, groupID=groupID, licenseTDDSyncSupport=licenseTDDSyncSupport, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, authorizationControlTableIndex=authorizationControlTableIndex, licenseInstancedTable=licenseInstancedTable, cableLoss=cableLoss, sNMPTrapInternetAddress=sNMPTrapInternetAddress, localPacketFiltering=localPacketFiltering, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, telnetPortNumber=telnetPortNumber, installStatusTrap=installStatusTrap, licenseGroup=licenseGroup, remoteInternetAddress=remoteInternetAddress, syncETracking=syncETracking, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, syslogControlGroup=syslogControlGroup, routerProtocolsGroup=routerProtocolsGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", managementPortWirelessDownAlert=managementPortWirelessDownAlert, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, ptp=ptp, rangingMode=rangingMode, tDM=tDM, versions=versions, resetGroup=resetGroup, versionsGroup=versionsGroup, auxPortQLRx=auxPortQLRx, transmitFreqMHz=transmitFreqMHz, targetMACAddress=targetMACAddress, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, dfsMeans=dfsMeans, mainPSUPortStatusTrap=mainPSUPortStatusTrap, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, secondarySoftwareVersion=secondarySoftwareVersion, alarms=alarms, PYSNMP_MODULE_ID=cambium, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, licenseRegulatoryBandsList=licenseRegulatoryBandsList, mABNominalModulationMode=mABNominalModulationMode, mgmtInstancedTableNumber=mgmtInstancedTableNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dNSServerPortNumber=dNSServerPortNumber, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, phyStatusGroup=phyStatusGroup, receiveModulationMode=receiveModulationMode, auxPortStatusTrap=auxPortStatusTrap, hTTPPortNumber=hTTPPortNumber, receiveDataRateLinked=receiveDataRateLinked, linkModeOptimization=linkModeOptimization, tFTPServerPortNumber=tFTPServerPortNumber, mABNominalTransmitCapacity=mABNominalTransmitCapacity, transmitFreqKHz=transmitFreqKHz, licenseCapacity=licenseCapacity, sNTPServerPortNumber=sNTPServerPortNumber, syncEEquipmentClock=syncEEquipmentClock, transparentClockVLAN=transparentClockVLAN, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, dfsGroup=dfsGroup, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, auxPortConfigurationMismatch=auxPortConfigurationMismatch, transparentClockPort=transparentClockPort, userTableIndex=userTableIndex, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, mgmtInstancedTableIndex=mgmtInstancedTableIndex, iPv6GatewayAddress=iPv6GatewayAddress, receiveFreqKHz=receiveFreqKHz, tDDSynchronizationAlarm=tDDSynchronizationAlarm, capacityVariantMismatchTrap=capacityVariantMismatchTrap, sNMPTrapTable=sNMPTrapTable, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, management=management, pubStatsGroup=pubStatsGroup, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, cableDiagPair1Distance=cableDiagPair1Distance, longitude=longitude, dNSPrimaryServer=dNSPrimaryServer, tDMGroup=tDMGroup)
