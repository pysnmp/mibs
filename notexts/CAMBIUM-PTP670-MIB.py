...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", alarmsGroup=alarmsGroup, licenseCapacity=licenseCapacity, tdmTableEntry=tdmTableEntry, syncETracking=syncETracking, licenseVersion=licenseVersion, licenseIPv6Support=licenseIPv6Support, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, packetsFromInternalStack=packetsFromInternalStack, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, iPv6PrefixLength=iPv6PrefixLength, sMTPServerInternetAddress=sMTPServerInternetAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, authorizationControlTableEntry=authorizationControlTableEntry, cableDiagnosticsPorts=cableDiagnosticsPorts, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, regulatoryBandTrap=regulatoryBandTrap, installArmStateTrap=installArmStateTrap, sMTPEmailAlert=sMTPEmailAlert, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, erroredSeconds=erroredSeconds, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, l2CPPriorityTable=l2CPPriorityTable, mABHoldoffPeriod=mABHoldoffPeriod, dNSServerTableEntry=dNSServerTableEntry, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, dNSResolver=dNSResolver, tdmTableNumber=tdmTableNumber, secureModeAlarm=secureModeAlarm, searchStateLinked=searchStateLinked, remoteUnitName=remoteUnitName, mainPSUPortStatus=mainPSUPortStatus, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, auxPortAllocation=auxPortAllocation, dNSServerInternetAddress=dNSServerInternetAddress, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, vectorErrorLinked=vectorErrorLinked, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, tDMInterfaceStatus=tDMInterfaceStatus, tDMChannelStatus=tDMChannelStatus, userRole=userRole, hTTPSPortNumber=hTTPSPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, transmitDataRateLinked=transmitDataRateLinked, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, ptpCompliance=ptpCompliance, dNS=dNS, ethernetPriorityTableEntry=ethernetPriorityTableEntry, authorizationControlTableIndex=authorizationControlTableIndex, useVLANForMABProtocol=useVLANForMABProtocol, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, linkSymmetry=linkSymmetry, linkModeOptimization=linkModeOptimization, syslogLocalWrappedTrap=syslogLocalWrappedTrap, searchState=searchState, notificationsGroup=notificationsGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, routerProtocolsGroup=routerProtocolsGroup, wirelessOutAllOctets=wirelessOutAllOctets, severelyErroredSeconds=severelyErroredSeconds, dNSServerTable=dNSServerTable, eIRP=eIRP, targetRange=targetRange, bridge=bridge, installArmState=installArmState, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, licenseRegulatoryBandsList=licenseRegulatoryBandsList, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, unitIdentificationGroup=unitIdentificationGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptmp=ptmp, wirelessLinkStatus=wirelessLinkStatus, cableDiagnosticsWarning=cableDiagnosticsWarning, iPv6GatewayAddress=iPv6GatewayAddress, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, licenseCountry=licenseCountry, dNSServerTableNumber=dNSServerTableNumber, nIDULanPortAutoMdix=nIDULanPortAutoMdix, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, transmitDataRate=transmitDataRate, transmitFreqKHz=transmitFreqKHz, tDMChannelLoopback=tDMChannelLoopback, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, routerProtocols=routerProtocols, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, localPacketFiltering=localPacketFiltering, byteErrorRatioLinked=byteErrorRatioLinked, rangingMode=rangingMode, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, configurationInstancedTable=configurationInstancedTable, mABState=mABState, sNTPPrimaryServer=sNTPPrimaryServer, sFPPortStatusTrap=sFPPortStatusTrap, antennaSelection=antennaSelection, auxPortStatusTrap=auxPortStatusTrap, transmitterChannels=transmitterChannels, dSCPManagementPriority=dSCPManagementPriority, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, signalStrengthRatioLinked=signalStrengthRatioLinked, daylightSaving=daylightSaving, apcGroup=apcGroup, syncETrackingState=syncETrackingState, aAAControlGroup=aAAControlGroup, sNMPEnabledTraps=sNMPEnabledTraps, pubStatsGroup=pubStatsGroup, sFPError=sFPError, mgmtInstancedTableIndex=mgmtInstancedTableIndex, receivePowerLinked=receivePowerLinked, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, installStatus=installStatus, transmitFreqMHz=transmitFreqMHz, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapTable=sNMPTrapTable, alarmInstancedTableIndex=alarmInstancedTableIndex, dfs=dfs, phyControlInstancedTableNumber=phyControlInstancedTableNumber, cableDiagnosticsGroup=cableDiagnosticsGroup, ethernetStatisticsDataSource=ethernetStatisticsDataSource, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, licenseGroupAccess=licenseGroupAccess, tDDSynchronizationAlarm=tDDSynchronizationAlarm, mPLSTCPriorityTable=mPLSTCPriorityTable, userTableIndex=userTableIndex, txMABFrames=txMABFrames, alarmInstancedTableNumber=alarmInstancedTableNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, userTableNumber=userTableNumber, tFTPServerInternetAddress=tFTPServerInternetAddress, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNTPSyncTrap=sNTPSyncTrap, authorizationControlTable=authorizationControlTable, cableDiagPair2Distance=cableDiagPair2Distance, dataBridgingStatus=dataBridgingStatus, supplementary=supplementary, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, cableDiagnosticsControl=cableDiagnosticsControl, dfsPeaks=dfsPeaks, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, sNTPServerTableNumber=sNTPServerTableNumber, transparentClock=transparentClock, longitude=longitude, remoteInternetAddressType=remoteInternetAddressType, sNTPServerStatus=sNTPServerStatus, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, configurationInstancedTableNumber=configurationInstancedTableNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernetInstancedTableIndex=ethernetInstancedTableIndex, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, sNMPTrapPortNumber=sNMPTrapPortNumber, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, syncESlavePort=syncESlavePort, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, ethernet=ethernet, mainPSUPortAutoMdix=mainPSUPortAutoMdix, remoteMACAddress=remoteMACAddress, dfsMeans=dfsMeans, transmitModulationModeLinked=transmitModulationModeLinked, maxLinkRangeExceeded=maxLinkRangeExceeded, syslogControlGroup=syslogControlGroup, tDMInterfaceControl=tDMInterfaceControl, whitelistRMMacAddress=whitelistRMMacAddress, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, gatewayIPAddress=gatewayIPAddress, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, hTTPAccessEnabled=hTTPAccessEnabled, sFPPortAutoNegotiation=sFPPortAutoNegotiation, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, licenseEncryption=licenseEncryption, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, telnetPortNumber=telnetPortNumber, transparentClockPort=transparentClockPort, wirelessLinkAvailability=wirelessLinkAvailability, sMTPServerPortNumber=sMTPServerPortNumber, hTTPPortNumber=hTTPPortNumber, tDMChannelLineCode=tDMChannelLineCode, capacityVariantMismatchLinked=capacityVariantMismatchLinked, versionsGroup=versionsGroup, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, userTableEntry=userTableEntry, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, auxPortDisabledWarning=auxPortDisabledWarning, ethernetInstancedTable=ethernetInstancedTable, receiveDataRateLinked=receiveDataRateLinked, hTTPSAccessEnabled=hTTPSAccessEnabled, tDMChannelStatusTrap=tDMChannelStatusTrap, enableTransmission=enableTransmission, tDMGroup=tDMGroup, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, whitelistRMEnabled=whitelistRMEnabled, alarms=alarms, dataPortWirelessDownAlert=dataPortWirelessDownAlert, portAllocationMismatch=portAllocationMismatch, secondarySoftwareVersion=secondarySoftwareVersion, tDMEnabledChannels=tDMEnabledChannels, dfsTableNumber=dfsTableNumber, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, dNSServerPortNumber=dNSServerPortNumber, subbandHighestFrequency=subbandHighestFrequency, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, supplementaryGroup=supplementaryGroup, sFPPortAutoMdix=sFPPortAutoMdix, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tempPcb=tempPcb, userEnabled=userEnabled, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sFPPortSyncERxStatus=sFPPortSyncERxStatus, mABTransmissionInterval=mABTransmissionInterval, receiveDataRate=receiveDataRate, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, tDDSynchronizationMode=tDDSynchronizationMode, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, vLANManagementVID=vLANManagementVID, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, sNTPServerTimeout=sNTPServerTimeout, phyControl=phyControl, siteName=siteName, byteErrorRatio=byteErrorRatio, mgmtInstancedTableNumber=mgmtInstancedTableNumber, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, sNMPTrapTableNumber=sNMPTrapTableNumber, deviceMSN=deviceMSN, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, altitude=altitude, capacityVariantMismatch=capacityVariantMismatch, bridgeGroup=bridgeGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, unitIdentification=unitIdentification, channelChangeTrap=channelChangeTrap, phyControlInstancedTableIndex=phyControlInstancedTableIndex, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, rangeLinked=rangeLinked, sntpGroup=sntpGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", nIDULanPortStatusTrap=nIDULanPortStatusTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, l2CPPriorityTableEntry=l2CPPriorityTableEntry, nIDULanPortStatus=nIDULanPortStatus, transparentClockVLAN=transparentClockVLAN, cableDiagPair1Distance=cableDiagPair1Distance, userName=userName, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, wirelessOutOctets=wirelessOutOctets, blacklistRMEnabled=blacklistRMEnabled, installStatusLinked=installStatusLinked, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, antennaGain=antennaGain, phyStatusGroup=phyStatusGroup, phyInstancedStatusTable=phyInstancedStatusTable, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, dataBridgingStatusLinked=dataBridgingStatusLinked, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, sFPPortStatus=sFPPortStatus, managementNetworkAccessEnabled=managementNetworkAccessEnabled, licenseIEEE1588Support=licenseIEEE1588Support, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNMPPortNumber=sNMPPortNumber, mainPSUPortSSMTx=mainPSUPortSSMTx, transparentClockVID=transparentClockVID, noWirelessChannelAvailable=noWirelessChannelAvailable, syncEEquipmentClock=syncEEquipmentClock, userTable=userTable, mainPSUPortAllocation=mainPSUPortAllocation, cableDiagPair4Results=cableDiagPair4Results, softwareVersion=softwareVersion, capacityVariantMismatchTrap=capacityVariantMismatchTrap, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, masterSlaveMode=masterSlaveMode, mgmtInstancedTableEntry=mgmtInstancedTableEntry, transmitPowerLinked=transmitPowerLinked, licenseRARSupport=licenseRARSupport, tDDControlGroup=tDDControlGroup, authorizationControlTableNumber=authorizationControlTableNumber, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, license=license, authorizationControlGroup=authorizationControlGroup, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, phyControlInstancedTable=phyControlInstancedTable, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, mainPSUPortStatusTrap=mainPSUPortStatusTrap, sFPErrorTrap=sFPErrorTrap, secureModeAlarmTrap=secureModeAlarmTrap, alarmInstancedTable=alarmInstancedTable, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, receiveModulationMode=receiveModulationMode, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, licenseTLSRekey=licenseTLSRekey, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, licenseGasGroup=licenseGasGroup, oOBPriorityQueueMapping=oOBPriorityQueueMapping, dataBridgingAvailability=dataBridgingAvailability, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, receiveFreqMHz=receiveFreqMHz, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, tFTPServerPortNumber=tFTPServerPortNumber, dfsTableIndex=dfsTableIndex, tDMConfigurationMismatch=tDMConfigurationMismatch, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, pubInstancedStatsTable=pubInstancedStatsTable, cableDiagPair4Distance=cableDiagPair4Distance, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, installStatusTrap=installStatusTrap, syslogControl=syslogControl, sNTPLastSync=sNTPLastSync, syslogState=syslogState, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, linkLoss=linkLoss, cableDiagPair2Results=cableDiagPair2Results, auxPortQLTx=auxPortQLTx, sNMPTrapTableEntry=sNMPTrapTableEntry, ethernetInstancedTableEntry=ethernetInstancedTableEntry, snmpControlGroup=snmpControlGroup, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, snmpControl=snmpControl, sNTPServerPortNumber=sNTPServerPortNumber, cableDiagPair3Distance=cableDiagPair3Distance, syslogStateTrap=syslogStateTrap, ptpGroups=ptpGroups, auxPortSyncERxStatus=auxPortSyncERxStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsGroup=dfsGroup, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, sFPPortDisabledWarning=sFPPortDisabledWarning, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, channelBandwidth=channelBandwidth, remoteMACAddressLinked=remoteMACAddressLinked, receiveModulationModeDetail=receiveModulationModeDetail, deviceESN=deviceESN, encryption=encryption, tdmTable=tdmTable, maximumTransmitPower=maximumTransmitPower, configurationInstancedTableEntry=configurationInstancedTableEntry, productVariant=productVariant, lowestDataModulationMode=lowestDataModulationMode, portAllocationMismatchTrap=portAllocationMismatchTrap, systemReset=systemReset, l2CPPriorityTableIndex=l2CPPriorityTableIndex, subnetMask=subnetMask, qOSPriorityScheme=qOSPriorityScheme, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, PYSNMP_MODULE_ID=cambium, reset=reset, sNTPServerTableEntry=sNTPServerTableEntry, wirelessOutEthernetOctets=wirelessOutEthernetOctets, licenseOOBManagementSupport=licenseOOBManagementSupport, licenseInstancedTableEntry=licenseInstancedTableEntry, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, receiveModulationModeLinked=receiveModulationModeLinked, rxColorCode=rxColorCode, dNSServerTableIndex=dNSServerTableIndex, receiveChannel=receiveChannel, sNTPServerTableIndex=sNTPServerTableIndex, rawReceivePower=rawReceivePower, cableDiagPair3Results=cableDiagPair3Results, installationMode=installationMode, mABNominalTransmitCapacity=mABNominalTransmitCapacity, mainPSUPortQLRx=mainPSUPortQLRx, alarmInstancedTableEntry=alarmInstancedTableEntry, cableDiagPair1Results=cableDiagPair1Results, licenseHCMPSupport=licenseHCMPSupport, versions=versions, sNTPSync=sNTPSync, pubStats=pubStats, sNTPServerInternetAddressType=sNTPServerInternetAddressType, auxPortConfigurationMismatch=auxPortConfigurationMismatch, tDMChannelCableLength=tDMChannelCableLength, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, iPv4Address=iPv4Address, linkLossLinked=linkLossLinked, tdmTableIndex=tdmTableIndex, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, hardwareVersion=hardwareVersion, extendedSpectrumScanning=extendedSpectrumScanning, remoteUnitNameLinked=remoteUnitNameLinked, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, subbandLowestFrequency=subbandLowestFrequency, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, mgmtInstancedTable=mgmtInstancedTable, cableDiagnosticsResultTable=cableDiagnosticsResultTable, remoteInternetAddress=remoteInternetAddress, wirelessLinkStatusLinked=wirelessLinkStatusLinked, dNSServerInternetAddressType=dNSServerInternetAddressType, auxPortAcceptedQLRx=auxPortAcceptedQLRx, unitOutOfCalibration=unitOutOfCalibration, linkName=linkName, phyControlInstancedTableEntry=phyControlInstancedTableEntry, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, tDM=tDM, rawReceivePowerLinked=rawReceivePowerLinked, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, signalStrengthRatio=signalStrengthRatio, sNMPTrapVersion=sNMPTrapVersion, auxPortStatus=auxPortStatus, wirelessTopology=wirelessTopology, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, hCMPMaximumLinkRange=hCMPMaximumLinkRange, enabledDiagnosticAlarms=enabledDiagnosticAlarms, userPassword=userPassword, mABProtocolVID=mABProtocolVID, licenseMaxLinkRange=licenseMaxLinkRange, encryptionAlgorithm=encryptionAlgorithm, configuration=configuration, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, sMTPServerInternetAddressType=sMTPServerInternetAddressType, licenseBandwidthCap=licenseBandwidthCap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, vLANManagementPriority=vLANManagementPriority, apc=apc, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, sFPPortAllocation=sFPPortAllocation, mABProtocolVLANPriority=mABProtocolVLANPriority, aggregateDataRateLinked=aggregateDataRateLinked, licenseInstancedTable=licenseInstancedTable, management=management, unitName=unitName, targetMACAddress=targetMACAddress, packetsToInternalStack=packetsToInternalStack, txColorCode=txColorCode, smtpGroup=smtpGroup, portAllocationMismatchLinked=portAllocationMismatchLinked, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, phyControlGroup=phyControlGroup, encryptionGroup=encryptionGroup, incompatibleRegulatoryBands=incompatibleRegulatoryBands, resetGroup=resetGroup, iPv6Address=iPv6Address, sNTPState=sNTPState, lowestTDMModulationMode=lowestTDMModulationMode, blacklistRMMacAddress=blacklistRMMacAddress, tFTPServerInternetAddressType=tFTPServerInternetAddressType, licenseInstancedTableIndex=licenseInstancedTableIndex, mABMaintenanceLevel=mABMaintenanceLevel, licenseInstancedTableNumber=licenseInstancedTableNumber, cableDiagnostics=cableDiagnostics, systemClock=systemClock, transmitChannel=transmitChannel, sntp=sntp, range=range, sNMPTrapTableIndex=sNMPTrapTableIndex, licenseUnitSerialNumber=licenseUnitSerialNumber, tDDControl=tDDControl, configurationInstancedTableIndex=configurationInstancedTableIndex, sNTPServerRetries=sNTPServerRetries, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sFPPortQLRx=sFPPortQLRx, licenseSFPPortSupport=licenseSFPPortSupport, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNTPServerTable=sNTPServerTable, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, cambium=cambium, aggregateDataRate=aggregateDataRate, phyStatus=phyStatus, configurationGroup=configurationGroup, ethernetGroup=ethernetGroup, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, dNSPrimaryServer=dNSPrimaryServer, licenseGroup=licenseGroup, remoteInternetAddressLinked=remoteInternetAddressLinked, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, remoteMaximumTransmitPower=remoteMaximumTransmitPower, groupID=groupID, sNTPServerInternetAddress=sNTPServerInternetAddress, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, sNMPv3Enable=sNMPv3Enable, unavailableSeconds=unavailableSeconds, ptp=ptp, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, licenseTDDSyncSupport=licenseTDDSyncSupport, ethernetInstancedTableNumber=ethernetInstancedTableNumber, accessMethod=accessMethod, iPVersion=iPVersion, licenseTrialPeriod=licenseTrialPeriod, managementGroup=managementGroup, ethernetStatisticsTable=ethernetStatisticsTable, lbtDetectedTrap=lbtDetectedTrap, regulatoryBand=regulatoryBand, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, authorizationControl=authorizationControl, managementPortWirelessDownAlert=managementPortWirelessDownAlert, transmitPower=transmitPower, ptp670=ptp670, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, latitude=latitude, licenseIssueNumber=licenseIssueNumber, l2CPPriorityTableNumber=l2CPPriorityTableNumber, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, timeZone=timeZone, dataBridgingStatusAlarm=dataBridgingStatusAlarm, productName=productName, dataPortPauseFrames=dataPortPauseFrames, transmitModulationMode=transmitModulationMode, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, authorizationMethod=authorizationMethod, sNMPTrapInternetAddress=sNMPTrapInternetAddress, aAAControl=aAAControl, dNSGroup=dNSGroup, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, smtp=smtp, frequencyVariant=frequencyVariant, dfsTableEntry=dfsTableEntry, mainPSUPortQLTx=mainPSUPortQLTx, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, receiveFreqKHz=receiveFreqKHz, mABNominalModulationMode=mABNominalModulationMode, receivePower=receivePower, ptpTraps=ptpTraps, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, sFPPortSSMTx=sFPPortSSMTx, sNTPPollInterval=sNTPPollInterval, sNMPCommunityString=sNMPCommunityString, deviceMACAddress=deviceMACAddress, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, dfsTable=dfsTable, licenseSecurityLevel=licenseSecurityLevel, hCMPLinkSymmetry=hCMPLinkSymmetry, tFTPClient=tFTPClient, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, syslogClient=syslogClient, syslogClientTrap=syslogClientTrap, auxPortSSMTx=auxPortSSMTx, vectorError=vectorError, telnetAccessEnabled=telnetAccessEnabled, bootVersion=bootVersion, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, sFPPortQLTx=sFPPortQLTx, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, maximumNumberOfSlaves=maximumNumberOfSlaves, cableLoss=cableLoss, ethernetPriorityTable=ethernetPriorityTable, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, auxPortQLRx=auxPortQLRx, licenseSyncESupport=licenseSyncESupport)
