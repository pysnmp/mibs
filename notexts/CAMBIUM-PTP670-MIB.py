...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", dNSPrimaryServer=dNSPrimaryServer, subbandHighestFrequency=subbandHighestFrequency, auxPortStatus=auxPortStatus, licenseGasGroup=licenseGasGroup, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, phyControlInstancedTableIndex=phyControlInstancedTableIndex, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, aggregateDataRateLinked=aggregateDataRateLinked, siteName=siteName, portAllocationMismatchLinked=portAllocationMismatchLinked, sMTPEmailAlert=sMTPEmailAlert, tFTPServerInternetAddress=tFTPServerInternetAddress, transmitPowerLinked=transmitPowerLinked, tDMChannelLineCode=tDMChannelLineCode, auxPortAllocation=auxPortAllocation, range=range, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tDMGroup=tDMGroup, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, transparentClockVLAN=transparentClockVLAN, rangingMode=rangingMode, mainPSUPortQLRx=mainPSUPortQLRx, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, auxPortSSMTx=auxPortSSMTx, authorizationControlTable=authorizationControlTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, cableDiagnosticsControl=cableDiagnosticsControl, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, remoteUnitNameLinked=remoteUnitNameLinked, remoteUnitName=remoteUnitName, tDMChannelStatus=tDMChannelStatus, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsTableNumber=dfsTableNumber, licenseCountry=licenseCountry, hTTPSAccessEnabled=hTTPSAccessEnabled, l2CPPriorityTableNumber=l2CPPriorityTableNumber, syncEEquipmentClock=syncEEquipmentClock, sNTPServerTableEntry=sNTPServerTableEntry, managementNetworkAccessEnabled=managementNetworkAccessEnabled, telnetAccessEnabled=telnetAccessEnabled, sNMPPortNumber=sNMPPortNumber, userPassword=userPassword, mgmtInstancedTableNumber=mgmtInstancedTableNumber, receiveModulationModeLinked=receiveModulationModeLinked, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, oOBPriorityQueueMapping=oOBPriorityQueueMapping, sNTPSyncTrap=sNTPSyncTrap, subbandLowestFrequency=subbandLowestFrequency, longitude=longitude, signalStrengthRatioLinked=signalStrengthRatioLinked, ptmp=ptmp, aggregateDataRate=aggregateDataRate, cableDiagPair2Results=cableDiagPair2Results, hCMPLinkSymmetry=hCMPLinkSymmetry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tDMChannelCableLength=tDMChannelCableLength, sFPError=sFPError, ethernetGroup=ethernetGroup, licenseSecurityLevel=licenseSecurityLevel, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, transmitModulationModeLinked=transmitModulationModeLinked, sntp=sntp, installArmState=installArmState, managementGroup=managementGroup, phyInstancedStatusTable=phyInstancedStatusTable, configurationInstancedTableNumber=configurationInstancedTableNumber, pubStats=pubStats, tDMEnabledChannels=tDMEnabledChannels, remoteInternetAddress=remoteInternetAddress, nIDULanPortAutoMdix=nIDULanPortAutoMdix, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, userRole=userRole, mgmtInstancedTableEntry=mgmtInstancedTableEntry, sFPPortAutoMdix=sFPPortAutoMdix, hTTPPortNumber=hTTPPortNumber, severelyErroredSeconds=severelyErroredSeconds, receivePower=receivePower, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, linkSymmetry=linkSymmetry, snmpControl=snmpControl, antennaSelection=antennaSelection, whitelistRMMacAddress=whitelistRMMacAddress, alarmsGroup=alarmsGroup, mainPSUPortAutoMdix=mainPSUPortAutoMdix, sNMPTrapPortNumber=sNMPTrapPortNumber, extendedSpectrumScanning=extendedSpectrumScanning, dNSServerInternetAddressType=dNSServerInternetAddressType, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, dataBridgingStatusAlarm=dataBridgingStatusAlarm, dNSServerTableIndex=dNSServerTableIndex, smtpGroup=smtpGroup, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, cableDiagPair4Results=cableDiagPair4Results, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, daylightSaving=daylightSaving, iPVersion=iPVersion, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, auxPortStatusTrap=auxPortStatusTrap, unitIdentificationGroup=unitIdentificationGroup, dNS=dNS, whitelistRMEnabled=whitelistRMEnabled, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, rawReceivePower=rawReceivePower, dSCPManagementPriority=dSCPManagementPriority, notificationsGroup=notificationsGroup, pubStatsGroup=pubStatsGroup, mABMaintenanceLevel=mABMaintenanceLevel, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, remoteInternetAddressLinked=remoteInternetAddressLinked, nIDULanPortStatus=nIDULanPortStatus, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, ethernetInstancedTableIndex=ethernetInstancedTableIndex, vLANManagementPriority=vLANManagementPriority, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, ptpGroups=ptpGroups, ptp=ptp, licenseRegulatoryBandsList=licenseRegulatoryBandsList, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, dNSServerPortNumber=dNSServerPortNumber, sFPPortQLTx=sFPPortQLTx, aAAControlGroup=aAAControlGroup, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, hCMPMaximumLinkRange=hCMPMaximumLinkRange, incompatibleRegulatoryBands=incompatibleRegulatoryBands, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, mABTransmissionInterval=mABTransmissionInterval, sntpGroup=sntpGroup, supplementary=supplementary, tDDSynchronizationAlarm=tDDSynchronizationAlarm, signalStrengthRatio=signalStrengthRatio, cableDiagnostics=cableDiagnostics, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, bootVersion=bootVersion, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, cableDiagPair3Results=cableDiagPair3Results, configurationInstancedTableIndex=configurationInstancedTableIndex, deviceMSN=deviceMSN, encryptionGroup=encryptionGroup, mABState=mABState, tFTPServerPortNumber=tFTPServerPortNumber, ethernetInstancedTableNumber=ethernetInstancedTableNumber, linkLossLinked=linkLossLinked, transmitDataRate=transmitDataRate, versionsGroup=versionsGroup, sNTPLastSync=sNTPLastSync, alarms=alarms, authorizationControl=authorizationControl, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, qOSPriorityScheme=qOSPriorityScheme, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, hardwareVersion=hardwareVersion, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, licenseRARSupport=licenseRARSupport, dfsTableIndex=dfsTableIndex, channelChangeTrap=channelChangeTrap, phyStatusGroup=phyStatusGroup, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, cableDiagPair3Distance=cableDiagPair3Distance, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, transparentClockPort=transparentClockPort, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, mainPSUPortQLTx=mainPSUPortQLTx, phyControlInstancedTableNumber=phyControlInstancedTableNumber, alarmInstancedTable=alarmInstancedTable, sMTPEnabledMessages=sMTPEnabledMessages, blacklistRMEnabled=blacklistRMEnabled, localPacketFiltering=localPacketFiltering, routerProtocolsGroup=routerProtocolsGroup, sNMPEnabledTraps=sNMPEnabledTraps, sMTPServerInternetAddressType=sMTPServerInternetAddressType, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ptpTraps=ptpTraps, configurationInstancedTable=configurationInstancedTable, rangeLinked=rangeLinked, cableDiagnosticsResultTable=cableDiagnosticsResultTable, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, licenseEncryption=licenseEncryption, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, remoteInternetAddressType=remoteInternetAddressType, versions=versions, tdmTableNumber=tdmTableNumber, capacityVariantMismatch=capacityVariantMismatch, erroredSeconds=erroredSeconds, transmitterChannels=transmitterChannels, management=management, sNTPServerTableNumber=sNTPServerTableNumber, encryption=encryption, mgmtInstancedTableIndex=mgmtInstancedTableIndex, installStatusLinked=installStatusLinked, cableDiagPair1Distance=cableDiagPair1Distance, linkName=linkName, cableDiagPair2Distance=cableDiagPair2Distance, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, tdmTable=tdmTable, tDM=tDM, cableDiagnosticsWarning=cableDiagnosticsWarning, dataPortPauseFrames=dataPortPauseFrames, syslogLocalWrappedTrap=syslogLocalWrappedTrap, auxPortQLTx=auxPortQLTx, noWirelessChannelAvailable=noWirelessChannelAvailable, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, licenseCapacity=licenseCapacity, userName=userName, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, receiveFreqKHz=receiveFreqKHz, sFPPortStatus=sFPPortStatus, rxColorCode=rxColorCode, licenseOOBManagementSupport=licenseOOBManagementSupport, syslogClient=syslogClient, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, vectorError=vectorError, regulatoryBand=regulatoryBand, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, receiveFreqMHz=receiveFreqMHz, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, eIRP=eIRP, cableLoss=cableLoss, sNTPPrimaryServer=sNTPPrimaryServer, hTTPAccessEnabled=hTTPAccessEnabled, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, cableDiagPair1Results=cableDiagPair1Results, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, wirelessLinkStatusLinked=wirelessLinkStatusLinked, transmitModulationMode=transmitModulationMode, receiveDataRate=receiveDataRate, dataBridgingStatus=dataBridgingStatus, userTableEntry=userTableEntry, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, deviceMACAddress=deviceMACAddress, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, smtp=smtp, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, useVLANForMABProtocol=useVLANForMABProtocol, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, installStatus=installStatus, licenseIEEE1588Support=licenseIEEE1588Support, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, dNSServerTableEntry=dNSServerTableEntry, dfsPeaks=dfsPeaks, transmitChannel=transmitChannel, timeZone=timeZone, authorizationControlGroup=authorizationControlGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", iPv4Address=iPv4Address, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, wirelessOutAllOctets=wirelessOutAllOctets, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ptpTrapPrefix=ptpTrapPrefix, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, alarmInstancedTableNumber=alarmInstancedTableNumber, tDMInterfaceStatus=tDMInterfaceStatus, ethernetStatisticsDataSource=ethernetStatisticsDataSource, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, bridgeGroup=bridgeGroup, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, receiveModulationModeDetail=receiveModulationModeDetail, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ethernetPriorityTable=ethernetPriorityTable, telnetPortNumber=telnetPortNumber, lbtDetectedTrap=lbtDetectedTrap, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, sFPPortQLRx=sFPPortQLRx, authorizationControlTableIndex=authorizationControlTableIndex, licenseHCMPSupport=licenseHCMPSupport, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, wirelessLinkAvailability=wirelessLinkAvailability, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, transmitPower=transmitPower, licenseUnitSerialNumber=licenseUnitSerialNumber, receiveChannel=receiveChannel, iPv6Address=iPv6Address, sFPPortSSMTx=sFPPortSSMTx, packetsFromInternalStack=packetsFromInternalStack, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, byteErrorRatio=byteErrorRatio, syncESlavePort=syncESlavePort, syslogControl=syslogControl, altitude=altitude, reset=reset, unitIdentification=unitIdentification, transmitDataRateLinked=transmitDataRateLinked, encryptionAlgorithm=encryptionAlgorithm, ethernetInstancedTable=ethernetInstancedTable, sNMPv3Enable=sNMPv3Enable, userTableNumber=userTableNumber, packetsToInternalStack=packetsToInternalStack, authorizationMethod=authorizationMethod, targetRange=targetRange, sMTPSourceEmailAddress=sMTPSourceEmailAddress, enableTransmission=enableTransmission, auxPortSyncERxStatus=auxPortSyncERxStatus, productName=productName, lowestTDMModulationMode=lowestTDMModulationMode, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, syslogStateTrap=syslogStateTrap, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, licenseTLSRekey=licenseTLSRekey, mABProtocolVLANPriority=mABProtocolVLANPriority, receiveModulationMode=receiveModulationMode, sNMPTrapInternetAddress=sNMPTrapInternetAddress, gatewayIPAddress=gatewayIPAddress, byteErrorRatioLinked=byteErrorRatioLinked, installArmStateTrap=installArmStateTrap, tDMChannelLoopback=tDMChannelLoopback, softwareVersion=softwareVersion, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, txMABFrames=txMABFrames, tFTPClient=tFTPClient, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, apcGroup=apcGroup, mABProtocolVID=mABProtocolVID, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPServerInternetAddress=sNTPServerInternetAddress, syslogClientTrap=syslogClientTrap, unitOutOfCalibration=unitOutOfCalibration, sNTPServerStatus=sNTPServerStatus, ethernet=ethernet, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, deviceESN=deviceESN, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, ethernetStatisticsTable=ethernetStatisticsTable, bridge=bridge, hTTPSPortNumber=hTTPSPortNumber, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, snmpControlGroup=snmpControlGroup, auxPortAcceptedQLRx=auxPortAcceptedQLRx, iPDSCPPriorityTable=iPDSCPPriorityTable, cambium=cambium, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, phyControlInstancedTableEntry=phyControlInstancedTableEntry, authorizationControlTableEntry=authorizationControlTableEntry, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, tDMChannelStatusTrap=tDMChannelStatusTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, sNMPTrapTableNumber=sNMPTrapTableNumber, l2CPPriorityTableIndex=l2CPPriorityTableIndex, transmitFreqMHz=transmitFreqMHz, maximumNumberOfSlaves=maximumNumberOfSlaves, channelBandwidth=channelBandwidth, dNSResolver=dNSResolver, configuration=configuration, aAAControl=aAAControl, unitName=unitName, syslogState=syslogState, userEnabled=userEnabled, sNTPServerTable=sNTPServerTable, mainPSUPortStatus=mainPSUPortStatus, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, productVariant=productVariant, ptp670=ptp670, sNTPPollInterval=sNTPPollInterval, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, frequencyVariant=frequencyVariant, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, auxPortDisabledWarning=auxPortDisabledWarning, tDDControlGroup=tDDControlGroup, capacityVariantMismatchLinked=capacityVariantMismatchLinked, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, dataBridgingAvailability=dataBridgingAvailability, supplementaryGroup=supplementaryGroup, ethernetPriorityTableEntry=ethernetPriorityTableEntry, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, maxLinkRangeExceeded=maxLinkRangeExceeded, transmitFreqKHz=transmitFreqKHz, alarmInstancedTableEntry=alarmInstancedTableEntry, sMTPServerInternetAddress=sMTPServerInternetAddress, transparentClock=transparentClock, tDMConfigurationMismatch=tDMConfigurationMismatch, groupID=groupID, antennaGain=antennaGain, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, auxPortConfigurationMismatch=auxPortConfigurationMismatch, sNMPTrapVersion=sNMPTrapVersion, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, sFPPortStatusTrap=sFPPortStatusTrap, tDMInterfaceControl=tDMInterfaceControl, wirelessTopology=wirelessTopology, sNTPServerPortNumber=sNTPServerPortNumber, mABHoldoffPeriod=mABHoldoffPeriod, licenseInstancedTableEntry=licenseInstancedTableEntry, remoteMACAddressLinked=remoteMACAddressLinked, regulatoryBandTrap=regulatoryBandTrap, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, licenseTrialPeriod=licenseTrialPeriod, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, systemReset=systemReset, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, dfsTable=dfsTable, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, licenseIssueNumber=licenseIssueNumber, authorizationControlTableNumber=authorizationControlTableNumber, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, dfsGroup=dfsGroup, rawReceivePowerLinked=rawReceivePowerLinked, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, wirelessOutEthernetOctets=wirelessOutEthernetOctets, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, linkLoss=linkLoss, lowestDataModulationMode=lowestDataModulationMode, dataBridgingStatusLinked=dataBridgingStatusLinked, mPLSTCPriorityTable=mPLSTCPriorityTable, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, sFPPortDisabledWarning=sFPPortDisabledWarning, syncETracking=syncETracking, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, sNTPSync=sNTPSync, mABNominalTransmitCapacity=mABNominalTransmitCapacity, licenseSFPPortSupport=licenseSFPPortSupport, auxPortQLRx=auxPortQLRx, portAllocationMismatch=portAllocationMismatch, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, sNTPServerTimeout=sNTPServerTimeout, ethernetPriorityTableNumber=ethernetPriorityTableNumber, routerProtocols=routerProtocols, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, txColorCode=txColorCode, syslogControlGroup=syslogControlGroup, installStatusTrap=installStatusTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, dfsMeans=dfsMeans, transparentClockVID=transparentClockVID, licenseIPv6Support=licenseIPv6Support, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, secondarySoftwareVersion=secondarySoftwareVersion, userTable=userTable, syncETrackingState=syncETrackingState, wirelessLinkStatus=wirelessLinkStatus, tdmTableIndex=tdmTableIndex, licenseMaxLinkRange=licenseMaxLinkRange, sNTPServerInternetAddressType=sNTPServerInternetAddressType, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, blacklistRMMacAddress=blacklistRMMacAddress, sMTPServerPortNumber=sMTPServerPortNumber, secureModeAlarmTrap=secureModeAlarmTrap, license=license, sNTPServerTableIndex=sNTPServerTableIndex, cableDiagPair4Distance=cableDiagPair4Distance, iPv6PrefixLength=iPv6PrefixLength, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, alarmInstancedTableIndex=alarmInstancedTableIndex, portAllocationMismatchTrap=portAllocationMismatchTrap, dNSServerTableNumber=dNSServerTableNumber, receivePowerLinked=receivePowerLinked, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, phyStatus=phyStatus, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, ptpCompliance=ptpCompliance, linkModeOptimization=linkModeOptimization, searchStateLinked=searchStateLinked, mABNominalModulationMode=mABNominalModulationMode, subnetMask=subnetMask, PYSNMP_MODULE_ID=cambium, masterSlaveMode=masterSlaveMode, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, userTableIndex=userTableIndex, receiveDataRateLinked=receiveDataRateLinked, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, configurationGroup=configurationGroup, unavailableSeconds=unavailableSeconds, accessMethod=accessMethod, maximumTransmitPower=maximumTransmitPower, sFPErrorTrap=sFPErrorTrap, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, phyControlInstancedTable=phyControlInstancedTable, ethernetPriorityTableIndex=ethernetPriorityTableIndex, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, licenseTDDSyncSupport=licenseTDDSyncSupport, tDDControl=tDDControl, sNTPServerRetries=sNTPServerRetries, apc=apc, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sFPPortAllocation=sFPPortAllocation, installationMode=installationMode, tDDSynchronizationMode=tDDSynchronizationMode, mgmtInstancedTable=mgmtInstancedTable, dfs=dfs, sFPPortAutoNegotiation=sFPPortAutoNegotiation, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, ethernetInstancedTableEntry=ethernetInstancedTableEntry)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, managementPortWirelessDownAlert=managementPortWirelessDownAlert, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, dfsTableEntry=dfsTableEntry, configurationInstancedTableEntry=configurationInstancedTableEntry, licenseBandwidthCap=licenseBandwidthCap, phyControl=phyControl, capacityVariantMismatchTrap=capacityVariantMismatchTrap, sNMPCommunityString=sNMPCommunityString, l2CPPriorityTable=l2CPPriorityTable, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, vLANManagementVID=vLANManagementVID, dNSServerInternetAddress=dNSServerInternetAddress, targetMACAddress=targetMACAddress, licenseInstancedTable=licenseInstancedTable, tempPcb=tempPcb, secureModeAlarm=secureModeAlarm, phyControlGroup=phyControlGroup, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, systemClock=systemClock, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, wirelessOutOctets=wirelessOutOctets, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, licenseVersion=licenseVersion, cableDiagnosticsGroup=cableDiagnosticsGroup, iPv6GatewayAddress=iPv6GatewayAddress, licenseSyncESupport=licenseSyncESupport, nIDULanPortStatusTrap=nIDULanPortStatusTrap, latitude=latitude, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, mainPSUPortStatusTrap=mainPSUPortStatusTrap, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, searchState=searchState, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, sFPPortSyncERxStatus=sFPPortSyncERxStatus, licenseGroupAccess=licenseGroupAccess, resetGroup=resetGroup, mainPSUPortSSMTx=mainPSUPortSSMTx, pubInstancedStatsTable=pubInstancedStatsTable, licenseInstancedTableIndex=licenseInstancedTableIndex, remoteMACAddress=remoteMACAddress, sNMPTrapTable=sNMPTrapTable, tdmTableEntry=tdmTableEntry, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, vectorErrorLinked=vectorErrorLinked, dNSGroup=dNSGroup, sNTPState=sNTPState, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, licenseInstancedTableNumber=licenseInstancedTableNumber, mainPSUPortAllocation=mainPSUPortAllocation, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dNSServerTable=dNSServerTable, licenseGroup=licenseGroup, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, cableDiagnosticsPorts=cableDiagnosticsPorts)
