...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", managementNetworkAccessEnabled=managementNetworkAccessEnabled, encryptionAlgorithm=encryptionAlgorithm, wirelessLinkAvailability=wirelessLinkAvailability, capacityVariantMismatchTrap=capacityVariantMismatchTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, wirelessLinkStatusLinked=wirelessLinkStatusLinked, userTableNumber=userTableNumber, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, remoteInternetAddress=remoteInternetAddress, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, apcGroup=apcGroup, ethernetGroup=ethernetGroup, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, dataBridgingAvailability=dataBridgingAvailability, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, secondarySoftwareVersion=secondarySoftwareVersion, aAAControlGroup=aAAControlGroup, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, syslogControl=syslogControl, gatewayIPAddress=gatewayIPAddress, unitIdentification=unitIdentification, sNTPServerRetries=sNTPServerRetries, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, transmitFreqKHz=transmitFreqKHz, receivePower=receivePower, auxPortQLRx=auxPortQLRx, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, authorizationMethod=authorizationMethod, siteName=siteName, tDDControlGroup=tDDControlGroup, licenseCountry=licenseCountry, phyControl=phyControl, sMTPEmailAlert=sMTPEmailAlert, tDMGroup=tDMGroup, dNSServerPortNumber=dNSServerPortNumber, ptpGroups=ptpGroups, tdmTableEntry=tdmTableEntry, sFPPortAutoNegotiation=sFPPortAutoNegotiation, cableDiagnosticsGroup=cableDiagnosticsGroup, whitelistRMEnabled=whitelistRMEnabled, ptpTrapPrefix=ptpTrapPrefix, remoteMACAddressLinked=remoteMACAddressLinked, licenseSFPPortSupport=licenseSFPPortSupport, installStatus=installStatus, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, transparentClockVLAN=transparentClockVLAN, licenseGasGroup=licenseGasGroup, receiveFreqMHz=receiveFreqMHz, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, licenseInstancedTableNumber=licenseInstancedTableNumber, configurationInstancedTableIndex=configurationInstancedTableIndex, licenseOOBManagementSupport=licenseOOBManagementSupport, sNTPServerPortNumber=sNTPServerPortNumber, antennaGain=antennaGain, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, cableDiagnosticsResultTable=cableDiagnosticsResultTable, transparentClockPort=transparentClockPort, userPassword=userPassword, userTableEntry=userTableEntry, dNSGroup=dNSGroup, targetMACAddress=targetMACAddress, syncESlavePort=syncESlavePort, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, byteErrorRatio=byteErrorRatio, packetsFromInternalStack=packetsFromInternalStack, notificationsGroup=notificationsGroup, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, tDM=tDM, licenseIEEE1588Support=licenseIEEE1588Support, sFPError=sFPError, iPVersion=iPVersion, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, encryptionGroup=encryptionGroup, ptmp=ptmp, mainPSUPortSSMTx=mainPSUPortSSMTx, remoteInternetAddressType=remoteInternetAddressType, syslogState=syslogState, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, lowestTDMModulationMode=lowestTDMModulationMode, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, dataBridgingStatusLinked=dataBridgingStatusLinked, sFPPortSSMTx=sFPPortSSMTx, dSCPManagementPriority=dSCPManagementPriority, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, sNTPServerTableIndex=sNTPServerTableIndex, sFPPortAllocation=sFPPortAllocation, hTTPSAccessEnabled=hTTPSAccessEnabled, transparentClock=transparentClock, tdmTableNumber=tdmTableNumber, telnetPortNumber=telnetPortNumber, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, cableDiagPair2Distance=cableDiagPair2Distance, severelyErroredSeconds=severelyErroredSeconds, dfsGroup=dfsGroup, mgmtInstancedTableIndex=mgmtInstancedTableIndex, qOSPriorityScheme=qOSPriorityScheme, licenseMaxLinkRange=licenseMaxLinkRange, cableDiagnosticsControl=cableDiagnosticsControl, auxPortSSMTx=auxPortSSMTx, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, remoteUnitName=remoteUnitName, hTTPPortNumber=hTTPPortNumber, wirelessLinkStatus=wirelessLinkStatus, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, receiveDataRate=receiveDataRate, installArmStateTrap=installArmStateTrap, mainPSUPortQLTx=mainPSUPortQLTx, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sFPPortQLRx=sFPPortQLRx, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, auxPortStatusTrap=auxPortStatusTrap, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tdmTableIndex=tdmTableIndex, licenseGroup=licenseGroup, linkLossLinked=linkLossLinked, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, blacklistRMMacAddress=blacklistRMMacAddress, channelChangeTrap=channelChangeTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, sNMPEnabledTraps=sNMPEnabledTraps, cambium=cambium, capacityVariantMismatch=capacityVariantMismatch, aggregateDataRate=aggregateDataRate, linkModeOptimizationMismatch=linkModeOptimizationMismatch, transparentClockVID=transparentClockVID, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, transmitterChannels=transmitterChannels, sNMPTrapVersion=sNMPTrapVersion, phyStatusGroup=phyStatusGroup, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, extendedSpectrumScanning=extendedSpectrumScanning, mainPSUPortStatus=mainPSUPortStatus, mABNominalTransmitCapacity=mABNominalTransmitCapacity, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, syncETracking=syncETracking, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tDMChannelLineCode=tDMChannelLineCode, wirelessOutOctets=wirelessOutOctets, hCMPMaximumLinkRange=hCMPMaximumLinkRange, authorizationControlTableEntry=authorizationControlTableEntry, tdmTable=tdmTable, remoteMACAddress=remoteMACAddress, dfsTableEntry=dfsTableEntry, PYSNMP_MODULE_ID=cambium, hardwareVersion=hardwareVersion, hTTPSPortNumber=hTTPSPortNumber, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, routerProtocols=routerProtocols, accessMethod=accessMethod, dNSServerTableEntry=dNSServerTableEntry, iPv4Address=iPv4Address, telnetAccessEnabled=telnetAccessEnabled, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, licenseInstancedTableEntry=licenseInstancedTableEntry, iPv6Address=iPv6Address, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, linkLoss=linkLoss, lbtDetectedTrap=lbtDetectedTrap, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, altitude=altitude, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, syslogControlGroup=syslogControlGroup, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, enableTransmission=enableTransmission, wirelessOutEthernetOctets=wirelessOutEthernetOctets, sNTPServerTable=sNTPServerTable, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, longitude=longitude, mABState=mABState, authorizationControlTableNumber=authorizationControlTableNumber, rangeLinked=rangeLinked, licenseSecurityLevel=licenseSecurityLevel, bridge=bridge, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, userTableIndex=userTableIndex, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, packetsToInternalStack=packetsToInternalStack, mainPSUPortAllocation=mainPSUPortAllocation, sNTPServerInternetAddress=sNTPServerInternetAddress, sNMPv3Enable=sNMPv3Enable, transmitModulationMode=transmitModulationMode, authorizationControlTableIndex=authorizationControlTableIndex, phyControlInstancedTableIndex=phyControlInstancedTableIndex, eIRP=eIRP, tDMEnabledChannels=tDMEnabledChannels, receiveModulationMode=receiveModulationMode, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, installStatusLinked=installStatusLinked, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, pubStatsGroup=pubStatsGroup, bridgeGroup=bridgeGroup, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, ethernetInstancedTable=ethernetInstancedTable, cableDiagPair3Distance=cableDiagPair3Distance, syncEEquipmentClock=syncEEquipmentClock, sNMPTrapInternetAddress=sNMPTrapInternetAddress, licenseRegulatoryBandsList=licenseRegulatoryBandsList, capacityVariantMismatchLinked=capacityVariantMismatchLinked, auxPortDisabledWarning=auxPortDisabledWarning, rangingMode=rangingMode, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dataBridgingStatusAlarm=dataBridgingStatusAlarm, groupID=groupID, byteErrorRatioLinked=byteErrorRatioLinked, userName=userName, tDMChannelStatus=tDMChannelStatus, linkModeOptimization=linkModeOptimization, transmitModulationModeLinked=transmitModulationModeLinked, sFPErrorTrap=sFPErrorTrap, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, licenseEncryption=licenseEncryption, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, auxPortQLTx=auxPortQLTx, ptp=ptp, range=range, unitOutOfCalibration=unitOutOfCalibration, sNTPPollInterval=sNTPPollInterval, routerProtocolsGroup=routerProtocolsGroup, sFPPortAutoMdix=sFPPortAutoMdix, supplementaryGroup=supplementaryGroup, wirelessOutAllOctets=wirelessOutAllOctets, regulatoryBand=regulatoryBand, ptpTraps=ptpTraps, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, deviceMACAddress=deviceMACAddress, dNSPrimaryServer=dNSPrimaryServer, channelBandwidth=channelBandwidth, licenseHCMPSupport=licenseHCMPSupport, tDMChannelCableLength=tDMChannelCableLength, signalStrengthRatio=signalStrengthRatio, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, sntp=sntp, mgmtInstancedTable=mgmtInstancedTable, mgmtInstancedTableNumber=mgmtInstancedTableNumber, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, sNMPTrapTableNumber=sNMPTrapTableNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, dNSResolver=dNSResolver, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, transmitPowerLinked=transmitPowerLinked, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, cableDiagPair4Results=cableDiagPair4Results, phyInstancedStatusTable=phyInstancedStatusTable, cableDiagPair4Distance=cableDiagPair4Distance, mABTransmissionInterval=mABTransmissionInterval, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, installArmState=installArmState, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, enabledDiagnosticAlarms=enabledDiagnosticAlarms, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, ethernetPriorityTableEntry=ethernetPriorityTableEntry, productName=productName, softwareVersion=softwareVersion, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, alarmInstancedTableEntry=alarmInstancedTableEntry, licenseVersion=licenseVersion, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, iPv6GatewayAddress=iPv6GatewayAddress, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, licenseIPv6Support=licenseIPv6Support, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sMTPServerInternetAddress=sMTPServerInternetAddress, sFPPortStatus=sFPPortStatus, oOBPriorityQueueMapping=oOBPriorityQueueMapping, tFTPClient=tFTPClient, tDMChannelStatusTrap=tDMChannelStatusTrap, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, configuration=configuration, ethernetStatisticsDataSource=ethernetStatisticsDataSource, transmitPower=transmitPower, alarmInstancedTableNumber=alarmInstancedTableNumber, mABHoldoffPeriod=mABHoldoffPeriod, hTTPAccessEnabled=hTTPAccessEnabled, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, phyControlGroup=phyControlGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, masterSlaveMode=masterSlaveMode, cableLoss=cableLoss, dfsPeaks=dfsPeaks, licenseCapacity=licenseCapacity, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, auxPortAcceptedQLRx=auxPortAcceptedQLRx, sFPPortQLTx=sFPPortQLTx, tempPcb=tempPcb, receiveChannel=receiveChannel, searchState=searchState, sNMPTrapTableIndex=sNMPTrapTableIndex, licenseBandwidthCap=licenseBandwidthCap, portAllocationMismatch=portAllocationMismatch, smtpGroup=smtpGroup, maxLinkRangeExceeded=maxLinkRangeExceeded, syslogClientTrap=syslogClientTrap, portAllocationMismatchLinked=portAllocationMismatchLinked, sFPPortStatusTrap=sFPPortStatusTrap, receiveModulationModeLinked=receiveModulationModeLinked, productVariant=productVariant, erroredSeconds=erroredSeconds, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, hCMPLinkSymmetry=hCMPLinkSymmetry, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, licenseUnitSerialNumber=licenseUnitSerialNumber, ethernetInstancedTableNumber=ethernetInstancedTableNumber, sNTPState=sNTPState, licenseRARSupport=licenseRARSupport, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, sNMPTrapTable=sNMPTrapTable, licenseTLSRekey=licenseTLSRekey, receivePowerLinked=receivePowerLinked, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, rawReceivePowerLinked=rawReceivePowerLinked, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPSyncTrap=sNTPSyncTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, linkName=linkName, apc=apc, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, licenseSyncESupport=licenseSyncESupport, licenseTDDSyncSupport=licenseTDDSyncSupport, transmitFreqMHz=transmitFreqMHz, mainPSUPortQLRx=mainPSUPortQLRx, encryption=encryption, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, syslogClient=syslogClient, installationMode=installationMode, sNMPCommunityString=sNMPCommunityString, daylightSaving=daylightSaving, cableDiagnosticsWarning=cableDiagnosticsWarning, configurationInstancedTableEntry=configurationInstancedTableEntry, mABMaintenanceLevel=mABMaintenanceLevel, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, tFTPServerInternetAddress=tFTPServerInternetAddress, useVLANForMABProtocol=useVLANForMABProtocol, dfs=dfs, resetGroup=resetGroup, sFPPortSyncERxStatus=sFPPortSyncERxStatus, cableDiagPair2Results=cableDiagPair2Results, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, management=management, mABProtocolVLANPriority=mABProtocolVLANPriority, configurationInstancedTableNumber=configurationInstancedTableNumber, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, dNS=dNS, deviceESN=deviceESN, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, subnetMask=subnetMask, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, rxColorCode=rxColorCode, tDMConfigurationMismatch=tDMConfigurationMismatch, ethernetInstancedTableIndex=ethernetInstancedTableIndex, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, antennaSelection=antennaSelection, noWirelessChannelAvailable=noWirelessChannelAvailable, pubInstancedStatsTable=pubInstancedStatsTable, tDMInterfaceControl=tDMInterfaceControl, tDDControl=tDDControl, alarms=alarms, auxPortSyncERxStatus=auxPortSyncERxStatus, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, licenseGroupAccess=licenseGroupAccess, snmpControl=snmpControl, authorizationControl=authorizationControl, subbandLowestFrequency=subbandLowestFrequency, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, sNMPPortNumber=sNMPPortNumber, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, sNTPServerTableEntry=sNTPServerTableEntry, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dNSServerInternetAddress=dNSServerInternetAddress, localPacketFiltering=localPacketFiltering, vLANManagementVID=vLANManagementVID, vectorError=vectorError, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, tDMChannelLoopback=tDMChannelLoopback, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, configurationInstancedTable=configurationInstancedTable, supplementary=supplementary, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dataPortPauseFrames=dataPortPauseFrames, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, rawReceivePower=rawReceivePower, versionsGroup=versionsGroup, userTable=userTable, signalStrengthRatioLinked=signalStrengthRatioLinked, l2CPPriorityTable=l2CPPriorityTable, nIDULanPortStatus=nIDULanPortStatus, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, dfsMeans=dfsMeans, tFTPServerPortNumber=tFTPServerPortNumber, receiveModulationModeDetail=receiveModulationModeDetail, auxPortConfigurationMismatch=auxPortConfigurationMismatch, iPv6PrefixLength=iPv6PrefixLength, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receiveFreqKHz=receiveFreqKHz, frequencyVariant=frequencyVariant, ethernetInstancedTableEntry=ethernetInstancedTableEntry, searchStateLinked=searchStateLinked, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, sNTPLastSync=sNTPLastSync, aAAControl=aAAControl, ethernetPriorityTableIndex=ethernetPriorityTableIndex, licenseIssueNumber=licenseIssueNumber, deviceMSN=deviceMSN, alarmsGroup=alarmsGroup, tDMInterfaceStatus=tDMInterfaceStatus, vLANManagementPriority=vLANManagementPriority, sNTPSync=sNTPSync, regulatoryBandTrap=regulatoryBandTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, aggregateDataRateLinked=aggregateDataRateLinked, dNSServerInternetAddressType=dNSServerInternetAddressType, phyControlInstancedTableEntry=phyControlInstancedTableEntry, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, smtp=smtp, iPDSCPPriorityTable=iPDSCPPriorityTable, receiveDataRateLinked=receiveDataRateLinked, dfsTableNumber=dfsTableNumber, dfsTableIndex=dfsTableIndex, syncETrackingState=syncETrackingState, sFPPortDisabledWarning=sFPPortDisabledWarning, whitelistRMMacAddress=whitelistRMMacAddress, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, lowestDataModulationMode=lowestDataModulationMode, dNSServerTableIndex=dNSServerTableIndex, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, phyControlInstancedTableNumber=phyControlInstancedTableNumber, authorizationControlGroup=authorizationControlGroup, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, phyControlInstancedTable=phyControlInstancedTable, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, versions=versions, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfsTable=dfsTable, sNTPServerTimeout=sNTPServerTimeout, managementPortWirelessDownAlert=managementPortWirelessDownAlert, l2CPPriorityTableIndex=l2CPPriorityTableIndex, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, snmpControlGroup=snmpControlGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, auxPortStatus=auxPortStatus, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, installStatusTrap=installStatusTrap, sMTPEnabledMessages=sMTPEnabledMessages, cableDiagnosticsPorts=cableDiagnosticsPorts, secureModeAlarm=secureModeAlarm, remoteInternetAddressLinked=remoteInternetAddressLinked, nIDULanPortStatusTrap=nIDULanPortStatusTrap, transmitChannel=transmitChannel, cableDiagnostics=cableDiagnostics, targetRange=targetRange, ptpCompliance=ptpCompliance, mainPSUPortAutoMdix=mainPSUPortAutoMdix, authorizationControlTable=authorizationControlTable, unavailableSeconds=unavailableSeconds, ethernetPriorityTable=ethernetPriorityTable, incompatibleRegulatoryBands=incompatibleRegulatoryBands, tDDSynchronizationMode=tDDSynchronizationMode, mABNominalModulationMode=mABNominalModulationMode, alarmInstancedTable=alarmInstancedTable, sNTPServerTableNumber=sNTPServerTableNumber, dNSServerTable=dNSServerTable, dataBridgingStatus=dataBridgingStatus, sMTPServerInternetAddressType=sMTPServerInternetAddressType, mABProtocolVID=mABProtocolVID, reset=reset, blacklistRMEnabled=blacklistRMEnabled, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, mgmtInstancedTableEntry=mgmtInstancedTableEntry, license=license, configurationGroup=configurationGroup, phyStatus=phyStatus, nIDULanPortAutoMdix=nIDULanPortAutoMdix)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sNTPServerStatus=sNTPServerStatus, userEnabled=userEnabled, bootVersion=bootVersion, managementGroup=managementGroup, linkSymmetry=linkSymmetry, licenseInstancedTableIndex=licenseInstancedTableIndex, vectorErrorLinked=vectorErrorLinked, pubStats=pubStats, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, remoteUnitNameLinked=remoteUnitNameLinked, syslogStateTrap=syslogStateTrap, unitIdentificationGroup=unitIdentificationGroup, ethernetStatisticsTable=ethernetStatisticsTable, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, txMABFrames=txMABFrames, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, ethernet=ethernet, transmitDataRateLinked=transmitDataRateLinked, systemReset=systemReset, dNSServerTableNumber=dNSServerTableNumber, systemClock=systemClock, licenseTrialPeriod=licenseTrialPeriod, mainPSUPortStatusTrap=mainPSUPortStatusTrap, subbandHighestFrequency=subbandHighestFrequency, ptp670=ptp670, sNTPPrimaryServer=sNTPPrimaryServer, cableDiagPair1Results=cableDiagPair1Results, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, alarmInstancedTableIndex=alarmInstancedTableIndex, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, unitName=unitName, l2CPPriorityTableNumber=l2CPPriorityTableNumber, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, timeZone=timeZone, cableDiagPair1Distance=cableDiagPair1Distance, secureModeAlarmTrap=secureModeAlarmTrap, wirelessTopology=wirelessTopology, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, licenseInstancedTable=licenseInstancedTable, portAllocationMismatchTrap=portAllocationMismatchTrap, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, maximumNumberOfSlaves=maximumNumberOfSlaves, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPTrapPortNumber=sNMPTrapPortNumber, latitude=latitude, auxPortAllocation=auxPortAllocation, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, l2CPPriorityTableEntry=l2CPPriorityTableEntry, cableDiagPair3Results=cableDiagPair3Results, sntpGroup=sntpGroup, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, transmitDataRate=transmitDataRate, maximumTransmitPower=maximumTransmitPower, sMTPServerPortNumber=sMTPServerPortNumber, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, txColorCode=txColorCode, userRole=userRole, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap)
