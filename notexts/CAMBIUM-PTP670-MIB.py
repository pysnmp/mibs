...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", syslogStateTrap=syslogStateTrap, transmitFreqMHz=transmitFreqMHz, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, tFTPServerInternetAddress=tFTPServerInternetAddress, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, dNS=dNS, wirelessLinkStatusLinked=wirelessLinkStatusLinked, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNTPServerInternetAddress=sNTPServerInternetAddress, cableDiagnosticsPorts=cableDiagnosticsPorts, vLANManagementVID=vLANManagementVID, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, syslogClient=syslogClient, phyControlInstancedTable=phyControlInstancedTable, sNMPTrapTable=sNMPTrapTable, tDM=tDM, mainPSUPortAllocation=mainPSUPortAllocation, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, ethernetStatisticsTable=ethernetStatisticsTable, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, useVLANForMABProtocol=useVLANForMABProtocol, licenseIssueNumber=licenseIssueNumber, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, ethernet=ethernet, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, ptpCompliance=ptpCompliance, cableDiagnostics=cableDiagnostics, encryption=encryption, sNMPEnabledTraps=sNMPEnabledTraps, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, tDDSynchronizationAlarm=tDDSynchronizationAlarm, pubStatsGroup=pubStatsGroup, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, dNSServerPortNumber=dNSServerPortNumber, iPv6Address=iPv6Address, transparentClockPort=transparentClockPort, nIDULanPortAutoMdix=nIDULanPortAutoMdix, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, txMABFrames=txMABFrames, tDMConfigurationMismatch=tDMConfigurationMismatch, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, aggregateDataRate=aggregateDataRate, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, aAAControl=aAAControl, tdmTable=tdmTable, licenseInstancedTableNumber=licenseInstancedTableNumber, iPDSCPPriorityTable=iPDSCPPriorityTable, systemClock=systemClock, rangingMode=rangingMode, blacklistRMEnabled=blacklistRMEnabled, telnetAccessEnabled=telnetAccessEnabled, ptp=ptp, sNTPServerTableIndex=sNTPServerTableIndex, lbtDetectedTrap=lbtDetectedTrap, tDMInterfaceStatus=tDMInterfaceStatus, hTTPSPortNumber=hTTPSPortNumber, cableDiagPair1Results=cableDiagPair1Results, licenseSecurityLevel=licenseSecurityLevel, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, gatewayIPAddress=gatewayIPAddress, hCMPLinkSymmetry=hCMPLinkSymmetry, sNTPServerTimeout=sNTPServerTimeout, noWirelessChannelAvailable=noWirelessChannelAvailable, blacklistRMMacAddress=blacklistRMMacAddress, sFPPortAutoNegotiation=sFPPortAutoNegotiation, sNTPServerTableEntry=sNTPServerTableEntry, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, phyStatus=phyStatus, antennaSelection=antennaSelection, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, sNTPServerInternetAddressType=sNTPServerInternetAddressType, unitIdentification=unitIdentification, userTableEntry=userTableEntry, sNTPServerRetries=sNTPServerRetries, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, wirelessLinkStatus=wirelessLinkStatus, dfsGroup=dfsGroup, secureModeAlarm=secureModeAlarm, subbandHighestFrequency=subbandHighestFrequency, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, deviceMACAddress=deviceMACAddress, sFPPortQLTx=sFPPortQLTx, routerProtocolsGroup=routerProtocolsGroup, tdmTableIndex=tdmTableIndex, cableDiagPair1Distance=cableDiagPair1Distance, licenseInstancedTable=licenseInstancedTable, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, authorizationControlTable=authorizationControlTable, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, licenseIEEE1588Support=licenseIEEE1588Support, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, sNTPServerPortNumber=sNTPServerPortNumber, sNTPState=sNTPState, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, subnetMask=subnetMask, masterSlaveMode=masterSlaveMode, transmitterChannels=transmitterChannels, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sFPPortStatusTrap=sFPPortStatusTrap, l2CPPriorityTable=l2CPPriorityTable, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dNSPrimaryServer=dNSPrimaryServer, regulatoryBandTrap=regulatoryBandTrap, dNSServerTable=dNSServerTable, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, dNSGroup=dNSGroup, auxPortQLTx=auxPortQLTx, resetGroup=resetGroup, installStatusLinked=installStatusLinked, receivePowerLinked=receivePowerLinked, licenseSFPPortSupport=licenseSFPPortSupport, syncETracking=syncETracking, transparentClockVID=transparentClockVID, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, nIDULanPortStatusTrap=nIDULanPortStatusTrap, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, targetMACAddress=targetMACAddress, transmitModulationMode=transmitModulationMode, mgmtInstancedTableIndex=mgmtInstancedTableIndex, sFPError=sFPError, syslogClientTrap=syslogClientTrap, incompatibleRegulatoryBands=incompatibleRegulatoryBands, ptpTrapPrefix=ptpTrapPrefix, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, licenseIPv6Support=licenseIPv6Support, erroredSeconds=erroredSeconds, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, tFTPClient=tFTPClient, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, sNMPTrapVersion=sNMPTrapVersion, hCMPMaximumLinkRange=hCMPMaximumLinkRange, transparentClock=transparentClock, remoteInternetAddress=remoteInternetAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, dfsTableIndex=dfsTableIndex, tFTPServerInternetAddressType=tFTPServerInternetAddressType, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ethernetInstancedTable=ethernetInstancedTable, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, sFPPortQLRx=sFPPortQLRx, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, managementNetworkAccessEnabled=managementNetworkAccessEnabled, ethernetInstancedTableEntry=ethernetInstancedTableEntry, wirelessLinkAvailability=wirelessLinkAvailability, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, deviceMSN=deviceMSN, channelBandwidth=channelBandwidth, sntp=sntp, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, capacityVariantMismatchTrap=capacityVariantMismatchTrap, dfsTable=dfsTable, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, sNTPSync=sNTPSync, sMTPServerInternetAddressType=sMTPServerInternetAddressType, groupID=groupID, ptpTraps=ptpTraps, syslogControlGroup=syslogControlGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, authorizationMethod=authorizationMethod, qOSPriorityScheme=qOSPriorityScheme, alarmInstancedTableIndex=alarmInstancedTableIndex, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, licenseCountry=licenseCountry, antennaGain=antennaGain, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, apc=apc, receiveFreqKHz=receiveFreqKHz, phyControl=phyControl, dNSServerTableNumber=dNSServerTableNumber, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, sNTPSyncTrap=sNTPSyncTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, iPv4Address=iPv4Address, sFPErrorTrap=sFPErrorTrap, smtpGroup=smtpGroup, sMTPServerInternetAddress=sMTPServerInternetAddress, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, sNMPCommunityString=sNMPCommunityString, unavailableSeconds=unavailableSeconds, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, portAllocationMismatchLinked=portAllocationMismatchLinked, licenseHCMPSupport=licenseHCMPSupport, vectorErrorLinked=vectorErrorLinked, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, phyControlInstancedTableIndex=phyControlInstancedTableIndex, enabledDiagnosticAlarms=enabledDiagnosticAlarms, routerProtocols=routerProtocols, sFPPortDisabledWarning=sFPPortDisabledWarning, timeZone=timeZone, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dfs=dfs, sNMPTrapTableEntry=sNMPTrapTableEntry, tDMChannelLoopback=tDMChannelLoopback, mPLSTCPriorityTable=mPLSTCPriorityTable, remoteUnitName=remoteUnitName, dataBridgingStatusAlarm=dataBridgingStatusAlarm, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, frequencyVariant=frequencyVariant, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, snmpControlGroup=snmpControlGroup, vLANManagementPriority=vLANManagementPriority, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, l2CPPriorityTableEntry=l2CPPriorityTableEntry, l2CPPriorityTableNumber=l2CPPriorityTableNumber, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, dNSServerInternetAddressType=dNSServerInternetAddressType, cableLoss=cableLoss, cableDiagPair3Results=cableDiagPair3Results, licenseInstancedTableIndex=licenseInstancedTableIndex, dfsMeans=dfsMeans, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, encryptionGroup=encryptionGroup, managementPortWirelessDownAlert=managementPortWirelessDownAlert, channelChangeTrap=channelChangeTrap, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, receivePower=receivePower, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, cableDiagPair4Results=cableDiagPair4Results, alarmInstancedTableEntry=alarmInstancedTableEntry, deviceESN=deviceESN, sNMPPortNumber=sNMPPortNumber, maximumNumberOfSlaves=maximumNumberOfSlaves, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, linkName=linkName, cableDiagPair4Distance=cableDiagPair4Distance, license=license, searchState=searchState, licenseRegulatoryBandsList=licenseRegulatoryBandsList, sMTPEmailAlert=sMTPEmailAlert, tFTPServerPortNumber=tFTPServerPortNumber, rangeLinked=rangeLinked, dfsPeaks=dfsPeaks, userPassword=userPassword, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", userTableNumber=userTableNumber, userTable=userTable, configuration=configuration, alarms=alarms, softwareVersion=softwareVersion, longitude=longitude, licenseBandwidthCap=licenseBandwidthCap, transparentClockVLAN=transparentClockVLAN, dataPortWirelessDownAlert=dataPortWirelessDownAlert, auxPortAllocation=auxPortAllocation, sFPPortSyncERxStatus=sFPPortSyncERxStatus, installStatus=installStatus, auxPortStatus=auxPortStatus, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sntpGroup=sntpGroup, remoteInternetAddressLinked=remoteInternetAddressLinked, ethernetInstancedTableNumber=ethernetInstancedTableNumber, userName=userName, signalStrengthRatioLinked=signalStrengthRatioLinked, licenseEncryption=licenseEncryption, dataPortPauseFrames=dataPortPauseFrames, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, supplementaryGroup=supplementaryGroup, licenseTLSRekey=licenseTLSRekey, syslogState=syslogState, cableDiagnosticsResultTable=cableDiagnosticsResultTable, linkLossLinked=linkLossLinked, auxPortSyncERxStatus=auxPortSyncERxStatus, cableDiagPair3Distance=cableDiagPair3Distance, licenseGroupAccess=licenseGroupAccess, authorizationControlTableEntry=authorizationControlTableEntry, syncESlavePort=syncESlavePort, eIRP=eIRP, mainPSUPortQLRx=mainPSUPortQLRx, transmitModulationModeLinked=transmitModulationModeLinked, nIDULanPortStatus=nIDULanPortStatus, licenseOOBManagementSupport=licenseOOBManagementSupport, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, supplementary=supplementary, receiveDataRateLinked=receiveDataRateLinked, auxPortAcceptedQLRx=auxPortAcceptedQLRx, portAllocationMismatchTrap=portAllocationMismatchTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, auxPortQLRx=auxPortQLRx, whitelistRMEnabled=whitelistRMEnabled, tDDSynchronizationMode=tDDSynchronizationMode, auxPortStatusTrap=auxPortStatusTrap, packetsToInternalStack=packetsToInternalStack, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, hardwareVersion=hardwareVersion, capacityVariantMismatch=capacityVariantMismatch, encryptionAlgorithm=encryptionAlgorithm, tDMChannelStatusTrap=tDMChannelStatusTrap, transmitFreqKHz=transmitFreqKHz, licenseGasGroup=licenseGasGroup, extendedSpectrumScanning=extendedSpectrumScanning, regulatoryBand=regulatoryBand, ptp670=ptp670, ptmp=ptmp, localPacketFiltering=localPacketFiltering, licenseRARSupport=licenseRARSupport, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, auxPortConfigurationMismatch=auxPortConfigurationMismatch, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, receiveModulationModeLinked=receiveModulationModeLinked, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, pubInstancedStatsTable=pubInstancedStatsTable, wirelessTopology=wirelessTopology, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, unitName=unitName, dfsTableEntry=dfsTableEntry, latitude=latitude, management=management, dSCPManagementPriority=dSCPManagementPriority, sNMPTrapTableNumber=sNMPTrapTableNumber, wirelessOutAllOctets=wirelessOutAllOctets, mgmtInstancedTableEntry=mgmtInstancedTableEntry, phyInstancedStatusTable=phyInstancedStatusTable, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, altitude=altitude, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, rawReceivePowerLinked=rawReceivePowerLinked, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, packetsFromInternalStack=packetsFromInternalStack, managementGroup=managementGroup, sMTPEnabledMessages=sMTPEnabledMessages, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, ethernetPriorityTableNumber=ethernetPriorityTableNumber, syncEEquipmentClock=syncEEquipmentClock, licenseUnitSerialNumber=licenseUnitSerialNumber, wirelessOutEthernetOctets=wirelessOutEthernetOctets, productName=productName, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, dNSResolver=dNSResolver, tDMInterfaceControl=tDMInterfaceControl, bridgeGroup=bridgeGroup, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, iPv6GatewayAddress=iPv6GatewayAddress, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, byteErrorRatioLinked=byteErrorRatioLinked, licenseMaxLinkRange=licenseMaxLinkRange, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, dNSServerInternetAddress=dNSServerInternetAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, cableDiagnosticsGroup=cableDiagnosticsGroup, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, mainPSUPortStatusTrap=mainPSUPortStatusTrap, phyControlInstancedTableEntry=phyControlInstancedTableEntry, sNTPServerTable=sNTPServerTable, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, dNSServerTableIndex=dNSServerTableIndex, maximumTransmitPower=maximumTransmitPower, sNMPv3Enable=sNMPv3Enable, authorizationControlGroup=authorizationControlGroup, receiveModulationModeDetail=receiveModulationModeDetail, systemReset=systemReset, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, hTTPPortNumber=hTTPPortNumber, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, transmitDataRateLinked=transmitDataRateLinked, ptpGroups=ptpGroups, range=range, sFPPortAllocation=sFPPortAllocation, maxLinkRangeExceeded=maxLinkRangeExceeded, auxPortDisabledWarning=auxPortDisabledWarning, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, licenseSyncESupport=licenseSyncESupport, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, daylightSaving=daylightSaving, byteErrorRatio=byteErrorRatio, mABHoldoffPeriod=mABHoldoffPeriod, ethernetPriorityTableEntry=ethernetPriorityTableEntry, PYSNMP_MODULE_ID=cambium, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, tDMGroup=tDMGroup, mABState=mABState, dataBridgingStatusLinked=dataBridgingStatusLinked, mainPSUPortQLTx=mainPSUPortQLTx, mgmtInstancedTableNumber=mgmtInstancedTableNumber, linkSymmetry=linkSymmetry, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sMTPServerPortNumber=sMTPServerPortNumber, targetRange=targetRange, receiveChannel=receiveChannel, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, secureModeAlarmTrap=secureModeAlarmTrap, authorizationControlTableIndex=authorizationControlTableIndex, mABProtocolVID=mABProtocolVID, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, vectorError=vectorError, dNSServerTableEntry=dNSServerTableEntry, sNMPTrapTableIndex=sNMPTrapTableIndex, telnetPortNumber=telnetPortNumber, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, transmitPower=transmitPower, iPVersion=iPVersion, receiveModulationMode=receiveModulationMode, ethernetPriorityTableIndex=ethernetPriorityTableIndex, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, lowestDataModulationMode=lowestDataModulationMode, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, pubStats=pubStats, phyControlGroup=phyControlGroup, hTTPAccessEnabled=hTTPAccessEnabled, whitelistRMMacAddress=whitelistRMMacAddress, receiveDataRate=receiveDataRate, txColorCode=txColorCode, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, configurationInstancedTable=configurationInstancedTable, remoteInternetAddressType=remoteInternetAddressType, searchStateLinked=searchStateLinked, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, remoteUnitNameLinked=remoteUnitNameLinked, sNTPPrimaryServer=sNTPPrimaryServer, oOBPriorityQueueMapping=oOBPriorityQueueMapping, authorizationControlTableNumber=authorizationControlTableNumber, transmitDataRate=transmitDataRate, bootVersion=bootVersion, syslogControl=syslogControl, userTableIndex=userTableIndex, smtp=smtp, rxColorCode=rxColorCode, remoteMACAddress=remoteMACAddress, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, alarmsGroup=alarmsGroup, mABNominalTransmitCapacity=mABNominalTransmitCapacity, tDMChannelStatus=tDMChannelStatus, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, ethernetInstancedTableIndex=ethernetInstancedTableIndex, mainPSUPortSSMTx=mainPSUPortSSMTx, configurationGroup=configurationGroup, subbandLowestFrequency=subbandLowestFrequency, aAAControlGroup=aAAControlGroup, cableDiagnosticsWarning=cableDiagnosticsWarning, userRole=userRole, configurationInstancedTableEntry=configurationInstancedTableEntry, tDMChannelLineCode=tDMChannelLineCode, linkLoss=linkLoss, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, sNMPTrapInternetAddress=sNMPTrapInternetAddress, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, unitOutOfCalibration=unitOutOfCalibration, dataBridgingStatus=dataBridgingStatus, receiveFreqMHz=receiveFreqMHz, sNMPTrapPortNumber=sNMPTrapPortNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, userEnabled=userEnabled, cableDiagPair2Results=cableDiagPair2Results, tDDSynchronizationStatus=tDDSynchronizationStatus, tdmTableEntry=tdmTableEntry, tDMChannelCableLength=tDMChannelCableLength, licenseGroup=licenseGroup, tdmTableNumber=tdmTableNumber, mgmtInstancedTable=mgmtInstancedTable, tDDControl=tDDControl, enableTransmission=enableTransmission, licenseVersion=licenseVersion, remoteMACAddressLinked=remoteMACAddressLinked, mainPSUPortStatus=mainPSUPortStatus, alarmInstancedTableNumber=alarmInstancedTableNumber, syncETrackingState=syncETrackingState, sFPPortSSMTx=sFPPortSSMTx, configurationInstancedTableNumber=configurationInstancedTableNumber, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, snmpControl=snmpControl, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, wirelessOutOctets=wirelessOutOctets, transmitPowerLinked=transmitPowerLinked, linkModeOptimization=linkModeOptimization, ethernetStatisticsDataSource=ethernetStatisticsDataSource, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, tDDControlGroup=tDDControlGroup, siteName=siteName, reset=reset, linkModeOptimizationMismatch=linkModeOptimizationMismatch, productVariant=productVariant, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, auxPortSSMTx=auxPortSSMTx, hTTPSAccessEnabled=hTTPSAccessEnabled)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, phyControlInstancedTableNumber=phyControlInstancedTableNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, mABProtocolVLANPriority=mABProtocolVLANPriority, sNTPPollInterval=sNTPPollInterval, authorizationControl=authorizationControl, cableDiagnosticsControl=cableDiagnosticsControl, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ethernetGroup=ethernetGroup, ethernetPriorityTable=ethernetPriorityTable, installStatusTrap=installStatusTrap, notificationsGroup=notificationsGroup, installArmState=installArmState, installArmStateTrap=installArmStateTrap, cambium=cambium, rawReceivePower=rawReceivePower, licenseTrialPeriod=licenseTrialPeriod, sNTPServerTableNumber=sNTPServerTableNumber, iPv6PrefixLength=iPv6PrefixLength, lowestTDMModulationMode=lowestTDMModulationMode, cableDiagPair2Distance=cableDiagPair2Distance, sFPPortAutoMdix=sFPPortAutoMdix, secondarySoftwareVersion=secondarySoftwareVersion, phyStatusGroup=phyStatusGroup, portAllocationMismatch=portAllocationMismatch, sMTPSourceEmailAddress=sMTPSourceEmailAddress, mainPSUPortAutoMdix=mainPSUPortAutoMdix, apcGroup=apcGroup, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, mABTransmissionInterval=mABTransmissionInterval, severelyErroredSeconds=severelyErroredSeconds, sNTPLastSync=sNTPLastSync, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, bridge=bridge, unitIdentificationGroup=unitIdentificationGroup, sFPPortStatus=sFPPortStatus, installationMode=installationMode, versions=versions, configurationInstancedTableIndex=configurationInstancedTableIndex, aggregateDataRateLinked=aggregateDataRateLinked, licenseCapacity=licenseCapacity, capacityVariantMismatchLinked=capacityVariantMismatchLinked, tDMEnabledChannels=tDMEnabledChannels, dataBridgingAvailability=dataBridgingAvailability, dfsTableNumber=dfsTableNumber, signalStrengthRatio=signalStrengthRatio, mABNominalModulationMode=mABNominalModulationMode, versionsGroup=versionsGroup, accessMethod=accessMethod, licenseInstancedTableEntry=licenseInstancedTableEntry, sNTPServerStatus=sNTPServerStatus, mABMaintenanceLevel=mABMaintenanceLevel, tempPcb=tempPcb, transmitChannel=transmitChannel, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, licenseTDDSyncSupport=licenseTDDSyncSupport, alarmInstancedTable=alarmInstancedTable)
