...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, ptmp=ptmp, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, phyControl=phyControl, productVariant=productVariant, licenseCountry=licenseCountry, rangingMode=rangingMode, licenseSyncESupport=licenseSyncESupport, tempPcb=tempPcb, sNTPServerPortNumber=sNTPServerPortNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, tDDControlGroup=tDDControlGroup, versionsGroup=versionsGroup, regulatoryBand=regulatoryBand, remoteUnitNameLinked=remoteUnitNameLinked, tDMEnabledChannels=tDMEnabledChannels, l2CPPriorityTable=l2CPPriorityTable, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, userEnabled=userEnabled, auxPortSyncERxStatus=auxPortSyncERxStatus, smtpGroup=smtpGroup, cableDiagPair3Distance=cableDiagPair3Distance, portAllocationMismatchLinked=portAllocationMismatchLinked, unavailableSeconds=unavailableSeconds, transmitFreqMHz=transmitFreqMHz, capacityVariantMismatch=capacityVariantMismatch, nIDULanPortStatusTrap=nIDULanPortStatusTrap, iPVersion=iPVersion, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPPollInterval=sNTPPollInterval, sFPPortSSMTx=sFPPortSSMTx, wirelessLinkAvailability=wirelessLinkAvailability, dataBridgingAvailability=dataBridgingAvailability, tDDControl=tDDControl, sFPPortSyncERxStatus=sFPPortSyncERxStatus, maximumNumberOfSlaves=maximumNumberOfSlaves, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, PYSNMP_MODULE_ID=cambium, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, dNSPrimaryServer=dNSPrimaryServer, supplementary=supplementary, ethernetPriorityTableNumber=ethernetPriorityTableNumber, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, installArmState=installArmState, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, routerProtocolsGroup=routerProtocolsGroup, configurationInstancedTable=configurationInstancedTable, auxPortStatusTrap=auxPortStatusTrap, ethernetGroup=ethernetGroup, managementPortWirelessDownAlert=managementPortWirelessDownAlert, configurationInstancedTableNumber=configurationInstancedTableNumber, iPDSCPPriorityTable=iPDSCPPriorityTable, extendedSpectrumScanning=extendedSpectrumScanning, sMTPSourceEmailAddress=sMTPSourceEmailAddress, mainPSUPortQLRx=mainPSUPortQLRx, dfsTableIndex=dfsTableIndex, tDMInterfaceStatus=tDMInterfaceStatus, sFPPortAutoMdix=sFPPortAutoMdix, gatewayIPAddress=gatewayIPAddress, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, aggregateDataRate=aggregateDataRate, userTable=userTable, remoteMaximumTransmitPower=remoteMaximumTransmitPower, regulatoryBandTrap=regulatoryBandTrap, portAllocationMismatch=portAllocationMismatch, ptp670=ptp670, license=license, subbandLowestFrequency=subbandLowestFrequency, unitOutOfCalibration=unitOutOfCalibration, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, subnetMask=subnetMask, transmitDataRateLinked=transmitDataRateLinked, mABTransmissionInterval=mABTransmissionInterval, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, secureModeAlarmTrap=secureModeAlarmTrap, tDM=tDM, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, tDMChannelCableLength=tDMChannelCableLength, licenseSFPPortSupport=licenseSFPPortSupport, configurationInstancedTableEntry=configurationInstancedTableEntry, receivePower=receivePower, routerProtocols=routerProtocols, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, accessMethod=accessMethod, dNSServerTableNumber=dNSServerTableNumber, auxPortQLRx=auxPortQLRx, receiveFreqMHz=receiveFreqMHz, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, wirelessLinkStatusLinked=wirelessLinkStatusLinked, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, encryption=encryption, phyControlGroup=phyControlGroup, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, syncETracking=syncETracking, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, ethernetStatisticsTable=ethernetStatisticsTable, auxPortConfigurationMismatch=auxPortConfigurationMismatch, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, sNTPSync=sNTPSync, signalStrengthRatio=signalStrengthRatio, management=management, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNTPLastSync=sNTPLastSync, dataBridgingStatusAlarm=dataBridgingStatusAlarm, resetGroup=resetGroup, licenseOOBManagementSupport=licenseOOBManagementSupport, iPv6PrefixLength=iPv6PrefixLength, sNMPTrapTableEntry=sNMPTrapTableEntry, tDMChannelLoopback=tDMChannelLoopback, hTTPPortNumber=hTTPPortNumber, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, sMTPEnabledMessages=sMTPEnabledMessages, pubStatsGroup=pubStatsGroup, cambium=cambium, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, dNSGroup=dNSGroup, mainPSUPortQLTx=mainPSUPortQLTx, sFPPortQLTx=sFPPortQLTx, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, linkSymmetry=linkSymmetry, wirelessOutAllOctets=wirelessOutAllOctets, cableDiagnostics=cableDiagnostics, installStatusTrap=installStatusTrap, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, supplementaryGroup=supplementaryGroup, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, iPv4Address=iPv4Address, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, dNSResolver=dNSResolver, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, cableDiagnosticsResultTable=cableDiagnosticsResultTable, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, licenseInstancedTable=licenseInstancedTable, sFPPortStatus=sFPPortStatus, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, licenseTrialPeriod=licenseTrialPeriod, rawReceivePower=rawReceivePower, noWirelessChannelAvailable=noWirelessChannelAvailable, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, sNMPTrapInternetAddress=sNMPTrapInternetAddress, licenseInstancedTableIndex=licenseInstancedTableIndex, alarmInstancedTable=alarmInstancedTable, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, sNTPServerTableEntry=sNTPServerTableEntry, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, sNTPServerTableIndex=sNTPServerTableIndex, portAllocationMismatchTrap=portAllocationMismatchTrap, telnetAccessEnabled=telnetAccessEnabled, erroredSeconds=erroredSeconds, transmitterChannels=transmitterChannels, remoteInternetAddressLinked=remoteInternetAddressLinked, installStatus=installStatus, lowestDataModulationMode=lowestDataModulationMode, alarmsGroup=alarmsGroup, maximumTransmitPower=maximumTransmitPower, smtp=smtp, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, phyInstancedStatusTable=phyInstancedStatusTable, useVLANForMABProtocol=useVLANForMABProtocol, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, mABState=mABState, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, tDDSynchronizationMode=tDDSynchronizationMode, userPassword=userPassword, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sFPPortQLRx=sFPPortQLRx, transparentClockVID=transparentClockVID, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, deviceMACAddress=deviceMACAddress, receiveDataRateLinked=receiveDataRateLinked, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, qOSPriorityScheme=qOSPriorityScheme, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, syslogControlGroup=syslogControlGroup, sMTPEmailAlert=sMTPEmailAlert, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, alarms=alarms, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, range=range, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, linkModeOptimizationMismatch=linkModeOptimizationMismatch, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, apcGroup=apcGroup, syslogClientTrap=syslogClientTrap, sNMPPortNumber=sNMPPortNumber, hTTPAccessEnabled=hTTPAccessEnabled, dataBridgingStatus=dataBridgingStatus, licenseIPv6Support=licenseIPv6Support, ptpCompliance=ptpCompliance, receiveDataRate=receiveDataRate, tdmTable=tdmTable, licenseRARSupport=licenseRARSupport, frequencyVariant=frequencyVariant, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, ethernetInstancedTableEntry=ethernetInstancedTableEntry, bridge=bridge, dataPortPauseFrames=dataPortPauseFrames, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, dfsTableNumber=dfsTableNumber, authorizationControlGroup=authorizationControlGroup, transparentClockPort=transparentClockPort, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, userTableNumber=userTableNumber, userTableIndex=userTableIndex, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, dataBridgingStatusLinked=dataBridgingStatusLinked, sNTPServerRetries=sNTPServerRetries, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, receivePowerLinked=receivePowerLinked, mABNominalModulationMode=mABNominalModulationMode, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, cableDiagPair2Distance=cableDiagPair2Distance, auxPortDisabledWarning=auxPortDisabledWarning, ethernetPriorityTable=ethernetPriorityTable, oOBPriorityQueueMapping=oOBPriorityQueueMapping, cableLoss=cableLoss, dfs=dfs, nIDULanPortAutoMdix=nIDULanPortAutoMdix, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, txColorCode=txColorCode, aAAControl=aAAControl, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, tFTPServerInternetAddress=tFTPServerInternetAddress, linkModeOptimization=linkModeOptimization, incompatibleRegulatoryBands=incompatibleRegulatoryBands, licenseInstancedTableEntry=licenseInstancedTableEntry, severelyErroredSeconds=severelyErroredSeconds, sFPPortAllocation=sFPPortAllocation, transmitModulationModeLinked=transmitModulationModeLinked, configurationGroup=configurationGroup, authorizationMethod=authorizationMethod, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNTPServerStatus=sNTPServerStatus, phyStatusGroup=phyStatusGroup, ethernetInstancedTableIndex=ethernetInstancedTableIndex, auxPortSSMTx=auxPortSSMTx, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, lbtDetectedTrap=lbtDetectedTrap, tdmTableEntry=tdmTableEntry, lowestTDMModulationMode=lowestTDMModulationMode, syslogLocalWrappedTrap=syslogLocalWrappedTrap, phyControlInstancedTable=phyControlInstancedTable, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, reset=reset, mABMaintenanceLevel=mABMaintenanceLevel, mainPSUPortStatusTrap=mainPSUPortStatusTrap, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, sNTPServerTableNumber=sNTPServerTableNumber, authorizationControlTableEntry=authorizationControlTableEntry, sNTPServerTimeout=sNTPServerTimeout, transparentClockVLAN=transparentClockVLAN, productName=productName, phyControlInstancedTableIndex=phyControlInstancedTableIndex, sNMPv3Enable=sNMPv3Enable, iPv6Address=iPv6Address, sntp=sntp, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, syslogState=syslogState, linkLossLinked=linkLossLinked, mABNominalTransmitCapacity=mABNominalTransmitCapacity, licenseTLSRekey=licenseTLSRekey, sMTPServerPortNumber=sMTPServerPortNumber, aggregateDataRateLinked=aggregateDataRateLinked, packetsFromInternalStack=packetsFromInternalStack, auxPortAllocation=auxPortAllocation, telnetPortNumber=telnetPortNumber, groupID=groupID, sNMPEnabledTraps=sNMPEnabledTraps, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, phyControlInstancedTableNumber=phyControlInstancedTableNumber, tFTPServerInternetAddressType=tFTPServerInternetAddressType, cableDiagPair3Results=cableDiagPair3Results, deviceMSN=deviceMSN, auxPortAcceptedQLRx=auxPortAcceptedQLRx, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, notificationsGroup=notificationsGroup, blacklistRMMacAddress=blacklistRMMacAddress, dfsGroup=dfsGroup, alarmInstancedTableEntry=alarmInstancedTableEntry, mainPSUPortAutoMdix=mainPSUPortAutoMdix, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, dNSServerTableIndex=dNSServerTableIndex, byteErrorRatio=byteErrorRatio, eIRP=eIRP, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, cableDiagnosticsWarning=cableDiagnosticsWarning, sFPPortAutoNegotiation=sFPPortAutoNegotiation, channelBandwidth=channelBandwidth, authorizationControl=authorizationControl, sNMPTrapTable=sNMPTrapTable, sNTPServerInternetAddress=sNTPServerInternetAddress, ethernetPriorityTableIndex=ethernetPriorityTableIndex, ptp=ptp, licenseTDDSyncSupport=licenseTDDSyncSupport, mainPSUPortAllocation=mainPSUPortAllocation, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, cableDiagPair1Results=cableDiagPair1Results, syslogStateTrap=syslogStateTrap, transmitPower=transmitPower, vLANManagementVID=vLANManagementVID, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, pubInstancedStatsTable=pubInstancedStatsTable, rangeLinked=rangeLinked, authorizationControlTableIndex=authorizationControlTableIndex, mgmtInstancedTable=mgmtInstancedTable, dfsMeans=dfsMeans, iPv6GatewayAddress=iPv6GatewayAddress, installationMode=installationMode, rxColorCode=rxColorCode, dNSServerInternetAddressType=dNSServerInternetAddressType, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, bootVersion=bootVersion, hTTPSPortNumber=hTTPSPortNumber, transmitChannel=transmitChannel, licenseEncryption=licenseEncryption, receiveChannel=receiveChannel, cableDiagnosticsGroup=cableDiagnosticsGroup, configurationInstancedTableIndex=configurationInstancedTableIndex, licenseCapacity=licenseCapacity, ethernet=ethernet, maxLinkRangeExceeded=maxLinkRangeExceeded, sNMPTrapPortNumber=sNMPTrapPortNumber, remoteMACAddressLinked=remoteMACAddressLinked, dfsTableEntry=dfsTableEntry, tDMConfigurationMismatch=tDMConfigurationMismatch, mainPSUPortSSMTx=mainPSUPortSSMTx, cableDiagPair4Distance=cableDiagPair4Distance, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, syncETrackingState=syncETrackingState, longitude=longitude, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, auxPortQLTx=auxPortQLTx, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, licenseIssueNumber=licenseIssueNumber, antennaSelection=antennaSelection, unitIdentificationGroup=unitIdentificationGroup, masterSlaveMode=masterSlaveMode, mABProtocolVID=mABProtocolVID, transmitDataRate=transmitDataRate, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, userRole=userRole, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, licenseInstancedTableNumber=licenseInstancedTableNumber, syslogClient=syslogClient, installArmStateTrap=installArmStateTrap, tDMChannelLineCode=tDMChannelLineCode, byteErrorRatioLinked=byteErrorRatioLinked, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, channelChangeTrap=channelChangeTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, systemReset=systemReset, wirelessLinkStatus=wirelessLinkStatus, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, installStatusLinked=installStatusLinked, tDMGroup=tDMGroup, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, licenseGroupAccess=licenseGroupAccess, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, vectorError=vectorError, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, remoteInternetAddress=remoteInternetAddress, snmpControl=snmpControl, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, authorizationControlTableNumber=authorizationControlTableNumber, sNTPState=sNTPState, antennaGain=antennaGain, ethernetPriorityTableEntry=ethernetPriorityTableEntry, latitude=latitude, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, ptpTraps=ptpTraps, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, tFTPClient=tFTPClient, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, transmitModulationMode=transmitModulationMode, transparentClock=transparentClock, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, sFPPortStatusTrap=sFPPortStatusTrap, phyControlInstancedTableEntry=phyControlInstancedTableEntry, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, blacklistRMEnabled=blacklistRMEnabled, dNS=dNS, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, aAAControlGroup=aAAControlGroup, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, rawReceivePowerLinked=rawReceivePowerLinked, softwareVersion=softwareVersion, unitIdentification=unitIdentification, nIDULanPortStatus=nIDULanPortStatus, vLANManagementPriority=vLANManagementPriority, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, receiveFreqKHz=receiveFreqKHz, userTableEntry=userTableEntry, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, sNMPTrapTableNumber=sNMPTrapTableNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptpTrapPrefix=ptpTrapPrefix, dfsPeaks=dfsPeaks, capacityVariantMismatchTrap=capacityVariantMismatchTrap, licenseSecurityLevel=licenseSecurityLevel, transmitFreqKHz=transmitFreqKHz, receiveModulationModeLinked=receiveModulationModeLinked, dNSServerTable=dNSServerTable, snmpControlGroup=snmpControlGroup, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, systemClock=systemClock, hCMPLinkSymmetry=hCMPLinkSymmetry, linkName=linkName, txMABFrames=txMABFrames, subbandHighestFrequency=subbandHighestFrequency, vectorErrorLinked=vectorErrorLinked, transmitPowerLinked=transmitPowerLinked, tdmTableIndex=tdmTableIndex, licenseGasGroup=licenseGasGroup, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, licenseUnitSerialNumber=licenseUnitSerialNumber, sFPPortDisabledWarning=sFPPortDisabledWarning, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, cableDiagPair1Distance=cableDiagPair1Distance, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, sMTPServerInternetAddress=sMTPServerInternetAddress, wirelessOutOctets=wirelessOutOctets, timeZone=timeZone, cableDiagnosticsControl=cableDiagnosticsControl, ethernetInstancedTableNumber=ethernetInstancedTableNumber, mainPSUPortStatus=mainPSUPortStatus, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, configuration=configuration, mgmtInstancedTableEntry=mgmtInstancedTableEntry, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, dfsTable=dfsTable, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, apc=apc, syslogControl=syslogControl, unitName=unitName, dNSServerPortNumber=dNSServerPortNumber, mgmtInstancedTableIndex=mgmtInstancedTableIndex, auxPortStatus=auxPortStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, enableTransmission=enableTransmission, cableDiagPair4Results=cableDiagPair4Results, alarmInstancedTableNumber=alarmInstancedTableNumber, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, cableDiagPair2Results=cableDiagPair2Results, incompatibleMasterAndSlave=incompatibleMasterAndSlave, targetRange=targetRange, encryptionGroup=encryptionGroup, mABProtocolVLANPriority=mABProtocolVLANPriority, phyStatus=phyStatus, tDDSynchronizationStatus=tDDSynchronizationStatus, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, searchStateLinked=searchStateLinked, sNTPPrimaryServer=sNTPPrimaryServer, ptpGroups=ptpGroups, l2CPPriorityTableNumber=l2CPPriorityTableNumber, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, alarmInstancedTableIndex=alarmInstancedTableIndex, sFPError=sFPError, versions=versions, licenseBandwidthCap=licenseBandwidthCap, licenseIEEE1588Support=licenseIEEE1588Support, searchState=searchState, remoteInternetAddressType=remoteInternetAddressType, receiveModulationModeDetail=receiveModulationModeDetail, siteName=siteName, wirelessOutEthernetOctets=wirelessOutEthernetOctets, mABHoldoffPeriod=mABHoldoffPeriod, l2CPPriorityTableIndex=l2CPPriorityTableIndex, licenseHCMPSupport=licenseHCMPSupport, encryptionAlgorithm=encryptionAlgorithm, tDMInterfaceControl=tDMInterfaceControl, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, receiveModulationMode=receiveModulationMode, signalStrengthRatioLinked=signalStrengthRatioLinked, altitude=altitude)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", localPacketFiltering=localPacketFiltering, wirelessTopology=wirelessTopology, dSCPManagementPriority=dSCPManagementPriority, sMTPServerInternetAddressType=sMTPServerInternetAddressType, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, daylightSaving=daylightSaving, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, hardwareVersion=hardwareVersion, tDMChannelStatus=tDMChannelStatus, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, syncESlavePort=syncESlavePort, licenseMaxLinkRange=licenseMaxLinkRange, cableDiagnosticsPorts=cableDiagnosticsPorts, managementGroup=managementGroup, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, dNSServerTableEntry=dNSServerTableEntry, sNMPTrapVersion=sNMPTrapVersion, sNTPSyncTrap=sNTPSyncTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, dNSServerInternetAddress=dNSServerInternetAddress, secureModeAlarm=secureModeAlarm, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, dataPortWirelessDownAlert=dataPortWirelessDownAlert, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, sNTPServerTable=sNTPServerTable, tFTPServerPortNumber=tFTPServerPortNumber, sFPErrorTrap=sFPErrorTrap, ethernetStatisticsDataSource=ethernetStatisticsDataSource, mgmtInstancedTableNumber=mgmtInstancedTableNumber, deviceESN=deviceESN, capacityVariantMismatchLinked=capacityVariantMismatchLinked, tDMChannelStatusTrap=tDMChannelStatusTrap, licenseVersion=licenseVersion, useVLANForManagementInterfaces=useVLANForManagementInterfaces, managementNetworkAccessEnabled=managementNetworkAccessEnabled, targetMACAddress=targetMACAddress, pubStats=pubStats, remoteUnitName=remoteUnitName, remoteMACAddress=remoteMACAddress, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, whitelistRMEnabled=whitelistRMEnabled, bridgeGroup=bridgeGroup, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, tdmTableNumber=tdmTableNumber, sntpGroup=sntpGroup, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, authorizationControlTable=authorizationControlTable, linkLoss=linkLoss, whitelistRMMacAddress=whitelistRMMacAddress, tDDSynchronizationAlarm=tDDSynchronizationAlarm, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, hCMPMaximumLinkRange=hCMPMaximumLinkRange, licenseGroup=licenseGroup, packetsToInternalStack=packetsToInternalStack, userName=userName, secondarySoftwareVersion=secondarySoftwareVersion, ethernetInstancedTable=ethernetInstancedTable, syncEEquipmentClock=syncEEquipmentClock, sNMPCommunityString=sNMPCommunityString, licenseRegulatoryBandsList=licenseRegulatoryBandsList)
