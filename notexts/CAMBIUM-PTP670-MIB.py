...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, licenseUnitSerialNumber=licenseUnitSerialNumber, transmitPowerLinked=transmitPowerLinked, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, hCMPLinkSymmetry=hCMPLinkSymmetry, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataBridgingStatusAlarm=dataBridgingStatusAlarm, tDDSynchronizationMode=tDDSynchronizationMode, receivePowerLinked=receivePowerLinked, noWirelessChannelAvailable=noWirelessChannelAvailable, receiveFreqMHz=receiveFreqMHz, installationMode=installationMode, nIDULanPortStatusTrap=nIDULanPortStatusTrap, sNMPv3Enable=sNMPv3Enable, licenseRARSupport=licenseRARSupport, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, smtp=smtp, secureModeAlarmTrap=secureModeAlarmTrap, nIDULanPortStatus=nIDULanPortStatus, tempPcb=tempPcb, hCMPMaximumLinkRange=hCMPMaximumLinkRange, transmitDataRate=transmitDataRate, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, auxPortDisabledWarning=auxPortDisabledWarning, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, ptmp=ptmp, masterSlaveMode=masterSlaveMode, mainPSUPortQLRx=mainPSUPortQLRx, receiveModulationModeDetail=receiveModulationModeDetail, unitName=unitName, dataBridgingStatusLinked=dataBridgingStatusLinked, severelyErroredSeconds=severelyErroredSeconds, licenseIEEE1588Support=licenseIEEE1588Support, licenseInstancedTable=licenseInstancedTable, userRole=userRole, tDMChannelStatus=tDMChannelStatus, capacityVariantMismatchTrap=capacityVariantMismatchTrap, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, sNTPServerStatus=sNTPServerStatus, userEnabled=userEnabled, syslogControl=syslogControl, regulatoryBand=regulatoryBand, tDDControl=tDDControl, sNMPCommunityString=sNMPCommunityString, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, searchStateLinked=searchStateLinked, wirelessLinkAvailability=wirelessLinkAvailability, remoteInternetAddressLinked=remoteInternetAddressLinked, siteName=siteName, iPv4Address=iPv4Address, managementNetworkAccessEnabled=managementNetworkAccessEnabled, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, phyControl=phyControl, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, licenseVersion=licenseVersion, remoteUnitNameLinked=remoteUnitNameLinked, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, userTableEntry=userTableEntry, sNMPTrapTable=sNMPTrapTable, mABNominalModulationMode=mABNominalModulationMode, phyControlInstancedTableNumber=phyControlInstancedTableNumber, linkLossLinked=linkLossLinked, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, receiveDataRate=receiveDataRate, transparentClock=transparentClock, tDMChannelLineCode=tDMChannelLineCode, packetsFromInternalStack=packetsFromInternalStack, portAllocationMismatchLinked=portAllocationMismatchLinked, ethernetInstancedTableEntry=ethernetInstancedTableEntry, transparentClockVLAN=transparentClockVLAN, apcGroup=apcGroup, sNTPServerInternetAddressType=sNTPServerInternetAddressType, licenseSyncESupport=licenseSyncESupport, licenseTrialPeriod=licenseTrialPeriod, tDMInterfaceStatus=tDMInterfaceStatus, pubStats=pubStats, dNS=dNS, sntpGroup=sntpGroup, ptpGroups=ptpGroups, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, sNTPServerInternetAddress=sNTPServerInternetAddress, licenseGroupAccess=licenseGroupAccess, installArmState=installArmState, sNTPServerTableEntry=sNTPServerTableEntry, cableDiagPair4Results=cableDiagPair4Results, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, sNMPPortNumber=sNMPPortNumber, auxPortAcceptedQLRx=auxPortAcceptedQLRx, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, receiveModulationModeLinked=receiveModulationModeLinked, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNTPServerTimeout=sNTPServerTimeout, syslogStateTrap=syslogStateTrap, cableDiagPair3Distance=cableDiagPair3Distance, alarms=alarms, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, sFPPortQLTx=sFPPortQLTx, userName=userName, tDMChannelLoopback=tDMChannelLoopback, phyControlGroup=phyControlGroup, bridgeGroup=bridgeGroup, tDMGroup=tDMGroup, systemClock=systemClock, syslogClient=syslogClient, subnetMask=subnetMask, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, receiveFreqKHz=receiveFreqKHz, signalStrengthRatioLinked=signalStrengthRatioLinked, installStatus=installStatus, auxPortAllocation=auxPortAllocation, licenseTLSRekey=licenseTLSRekey, tFTPServerPortNumber=tFTPServerPortNumber, vectorError=vectorError, mgmtInstancedTableEntry=mgmtInstancedTableEntry, productName=productName, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, sNMPTrapVersion=sNMPTrapVersion, remoteUnitName=remoteUnitName, encryption=encryption, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, softwareVersion=softwareVersion, userTable=userTable, telnetPortNumber=telnetPortNumber, antennaSelection=antennaSelection, licenseGroup=licenseGroup, rangingMode=rangingMode, installStatusLinked=installStatusLinked, lowestDataModulationMode=lowestDataModulationMode, vLANManagementVID=vLANManagementVID, dNSServerTableIndex=dNSServerTableIndex, dfsPeaks=dfsPeaks, subbandHighestFrequency=subbandHighestFrequency, rawReceivePowerLinked=rawReceivePowerLinked, configurationInstancedTableNumber=configurationInstancedTableNumber, dataBridgingStatus=dataBridgingStatus, mPLSTCPriorityTable=mPLSTCPriorityTable, tdmTable=tdmTable, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, userTableNumber=userTableNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, snmpControl=snmpControl, byteErrorRatioLinked=byteErrorRatioLinked, regulatoryBandTrap=regulatoryBandTrap, accessMethod=accessMethod, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, mABTransmissionInterval=mABTransmissionInterval, sNTPServerPortNumber=sNTPServerPortNumber, tDMChannelCableLength=tDMChannelCableLength, transmitChannel=transmitChannel, secondarySoftwareVersion=secondarySoftwareVersion, wirelessOutEthernetOctets=wirelessOutEthernetOctets, managementGroup=managementGroup, auxPortSSMTx=auxPortSSMTx, licenseGasGroup=licenseGasGroup, dNSServerTableEntry=dNSServerTableEntry, linkModeOptimizationMismatch=linkModeOptimizationMismatch, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, receiveChannel=receiveChannel, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, cableDiagnosticsGroup=cableDiagnosticsGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, authorizationControlTableEntry=authorizationControlTableEntry, versions=versions, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, searchState=searchState, configurationGroup=configurationGroup, sNTPServerTable=sNTPServerTable, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, altitude=altitude, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, dfsMeans=dfsMeans, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, phyControlInstancedTableIndex=phyControlInstancedTableIndex, transmitModulationMode=transmitModulationMode, cableDiagPair1Distance=cableDiagPair1Distance, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, iPv6GatewayAddress=iPv6GatewayAddress, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, capacityVariantMismatchLinked=capacityVariantMismatchLinked, phyControlInstancedTable=phyControlInstancedTable, supplementary=supplementary, ethernetInstancedTable=ethernetInstancedTable, ethernet=ethernet, transmitFreqMHz=transmitFreqMHz, sNMPTrapPortNumber=sNMPTrapPortNumber, licenseSFPPortSupport=licenseSFPPortSupport, tDM=tDM, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, sMTPServerPortNumber=sMTPServerPortNumber, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, ethernetGroup=ethernetGroup, phyControlInstancedTableEntry=phyControlInstancedTableEntry, syncETracking=syncETracking, txMABFrames=txMABFrames, ethernetInstancedTableIndex=ethernetInstancedTableIndex, unavailableSeconds=unavailableSeconds, bridge=bridge, userPassword=userPassword, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, cableDiagPair3Results=cableDiagPair3Results, iPDSCPPriorityTable=iPDSCPPriorityTable, secureModeAlarm=secureModeAlarm, installStatusTrap=installStatusTrap, licenseTDDSyncSupport=licenseTDDSyncSupport, sNMPTrapTableEntry=sNMPTrapTableEntry, rawReceivePower=rawReceivePower, syncESlavePort=syncESlavePort, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, txColorCode=txColorCode, cableDiagnosticsWarning=cableDiagnosticsWarning, latitude=latitude, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, mABNominalTransmitCapacity=mABNominalTransmitCapacity, encryptionGroup=encryptionGroup, auxPortSyncERxStatus=auxPortSyncERxStatus, cableDiagPair2Results=cableDiagPair2Results, mgmtInstancedTableNumber=mgmtInstancedTableNumber, vLANManagementPriority=vLANManagementPriority, sNTPPrimaryServer=sNTPPrimaryServer, resetGroup=resetGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, blacklistRMMacAddress=blacklistRMMacAddress, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tDMChannelStatusTrap=tDMChannelStatusTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, vectorErrorLinked=vectorErrorLinked, maximumNumberOfSlaves=maximumNumberOfSlaves, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, configurationInstancedTableEntry=configurationInstancedTableEntry, localPacketFiltering=localPacketFiltering, dfsGroup=dfsGroup, remoteInternetAddress=remoteInternetAddress, alarmInstancedTableNumber=alarmInstancedTableNumber, ptp670=ptp670, license=license, sFPPortStatus=sFPPortStatus, licenseCapacity=licenseCapacity, packetsToInternalStack=packetsToInternalStack, sFPPortSyncERxStatus=sFPPortSyncERxStatus, dNSPrimaryServer=dNSPrimaryServer, oOBPriorityQueueMapping=oOBPriorityQueueMapping, alarmInstancedTable=alarmInstancedTable, mainPSUPortStatusTrap=mainPSUPortStatusTrap, ethernetStatisticsDataSource=ethernetStatisticsDataSource, lowestTDMModulationMode=lowestTDMModulationMode, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, cableDiagnosticsPorts=cableDiagnosticsPorts, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, versionsGroup=versionsGroup, dataBridgingAvailability=dataBridgingAvailability, sFPPortAllocation=sFPPortAllocation, rxColorCode=rxColorCode, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, mainPSUPortAutoMdix=mainPSUPortAutoMdix, antennaGain=antennaGain, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, systemReset=systemReset, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, transmitPower=transmitPower, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, deviceESN=deviceESN, qOSPriorityScheme=qOSPriorityScheme, iPVersion=iPVersion, maxLinkRangeExceeded=maxLinkRangeExceeded, ethernetPriorityTableNumber=ethernetPriorityTableNumber, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, byteErrorRatio=byteErrorRatio, syncEEquipmentClock=syncEEquipmentClock, iPv6Address=iPv6Address, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, capacityVariantMismatch=capacityVariantMismatch, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, wirelessOutAllOctets=wirelessOutAllOctets, blacklistRMEnabled=blacklistRMEnabled, dNSServerTable=dNSServerTable, range=range, ptp=ptp, transmitDataRateLinked=transmitDataRateLinked, remoteInternetAddressType=remoteInternetAddressType, licenseEncryption=licenseEncryption, authorizationControl=authorizationControl, remoteMACAddress=remoteMACAddress, dfsTableEntry=dfsTableEntry, sFPPortDisabledWarning=sFPPortDisabledWarning, dfsTable=dfsTable, sNTPState=sNTPState, mainPSUPortStatus=mainPSUPortStatus, dataPortPauseFrames=dataPortPauseFrames, ptpTrapPrefix=ptpTrapPrefix, authorizationControlTableNumber=authorizationControlTableNumber, sFPErrorTrap=sFPErrorTrap, deviceMSN=deviceMSN, transparentClockPort=transparentClockPort, tdmTableIndex=tdmTableIndex, licenseMaxLinkRange=licenseMaxLinkRange, hTTPPortNumber=hTTPPortNumber, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, dSCPManagementPriority=dSCPManagementPriority, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, tdmTableNumber=tdmTableNumber, cableDiagPair4Distance=cableDiagPair4Distance, dNSServerInternetAddress=dNSServerInternetAddress, transmitFreqKHz=transmitFreqKHz, sNTPLastSync=sNTPLastSync, snmpControlGroup=snmpControlGroup, syslogClientTrap=syslogClientTrap, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, signalStrengthRatio=signalStrengthRatio, licenseInstancedTableNumber=licenseInstancedTableNumber, notificationsGroup=notificationsGroup, whitelistRMMacAddress=whitelistRMMacAddress, enableTransmission=enableTransmission, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, mABMaintenanceLevel=mABMaintenanceLevel, installArmStateTrap=installArmStateTrap, licenseBandwidthCap=licenseBandwidthCap, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, linkLoss=linkLoss, whitelistRMEnabled=whitelistRMEnabled, mABProtocolVID=mABProtocolVID, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sMTPSourceEmailAddress=sMTPSourceEmailAddress, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, targetMACAddress=targetMACAddress, unitOutOfCalibration=unitOutOfCalibration, ethernetPriorityTable=ethernetPriorityTable, receivePower=receivePower, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sFPError=sFPError, dfs=dfs, sNTPServerTableNumber=sNTPServerTableNumber, reset=reset, extendedSpectrumScanning=extendedSpectrumScanning, dNSGroup=dNSGroup, wirelessLinkStatus=wirelessLinkStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, l2CPPriorityTableIndex=l2CPPriorityTableIndex, alarmInstancedTableIndex=alarmInstancedTableIndex, hTTPSPortNumber=hTTPSPortNumber, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, supplementaryGroup=supplementaryGroup, licenseRegulatoryBandsList=licenseRegulatoryBandsList, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, tDDControlGroup=tDDControlGroup, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, wirelessLinkStatusLinked=wirelessLinkStatusLinked, cableDiagnostics=cableDiagnostics, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, sFPPortAutoNegotiation=sFPPortAutoNegotiation, tDMConfigurationMismatch=tDMConfigurationMismatch, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, sNTPSyncTrap=sNTPSyncTrap, licenseHCMPSupport=licenseHCMPSupport, auxPortConfigurationMismatch=auxPortConfigurationMismatch, phyInstancedStatusTable=phyInstancedStatusTable, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, configurationInstancedTable=configurationInstancedTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPEnabledTraps=sNMPEnabledTraps, licenseInstancedTableEntry=licenseInstancedTableEntry, channelChangeTrap=channelChangeTrap, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, mABState=mABState, useVLANForMABProtocol=useVLANForMABProtocol, pubInstancedStatsTable=pubInstancedStatsTable, tFTPServerInternetAddress=tFTPServerInternetAddress, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, dfsTableNumber=dfsTableNumber, iPv6PrefixLength=iPv6PrefixLength, sFPPortAutoMdix=sFPPortAutoMdix, telnetAccessEnabled=telnetAccessEnabled, aAAControl=aAAControl, hTTPSAccessEnabled=hTTPSAccessEnabled, aAAControlGroup=aAAControlGroup, licenseOOBManagementSupport=licenseOOBManagementSupport, mainPSUPortQLTx=mainPSUPortQLTx, dNSServerTableNumber=dNSServerTableNumber, daylightSaving=daylightSaving, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, mainPSUPortSSMTx=mainPSUPortSSMTx, portAllocationMismatchTrap=portAllocationMismatchTrap, tDMInterfaceControl=tDMInterfaceControl, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, remoteMACAddressLinked=remoteMACAddressLinked, mgmtInstancedTable=mgmtInstancedTable, transparentClockVID=transparentClockVID, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, licenseInstancedTableIndex=licenseInstancedTableIndex, incompatibleMasterAndSlave=incompatibleMasterAndSlave, phyStatus=phyStatus, auxPortStatusTrap=auxPortStatusTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, linkName=linkName, cableDiagPair2Distance=cableDiagPair2Distance, eIRP=eIRP, wirelessOutOctets=wirelessOutOctets, hTTPAccessEnabled=hTTPAccessEnabled, sFPPortStatusTrap=sFPPortStatusTrap, linkModeOptimization=linkModeOptimization, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, sntp=sntp, dfsTableIndex=dfsTableIndex, incompatibleRegulatoryBands=incompatibleRegulatoryBands, cableLoss=cableLoss, nIDULanPortAutoMdix=nIDULanPortAutoMdix, tFTPServerInternetAddressType=tFTPServerInternetAddressType, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, groupID=groupID, authorizationControlTableIndex=authorizationControlTableIndex, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, sNTPPollInterval=sNTPPollInterval, syncETrackingState=syncETrackingState, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, aggregateDataRateLinked=aggregateDataRateLinked, alarmInstancedTableEntry=alarmInstancedTableEntry, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, tDDSynchronizationStatus=tDDSynchronizationStatus, transmitterChannels=transmitterChannels, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, cambium=cambium, ethernetInstancedTableNumber=ethernetInstancedTableNumber, deviceMACAddress=deviceMACAddress, l2CPPriorityTable=l2CPPriorityTable, receiveDataRateLinked=receiveDataRateLinked, erroredSeconds=erroredSeconds, tdmTableEntry=tdmTableEntry, authorizationControlTable=authorizationControlTable, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, sMTPEnabledMessages=sMTPEnabledMessages, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, mgmtInstancedTableIndex=mgmtInstancedTableIndex, cableDiagnosticsControl=cableDiagnosticsControl, pubStatsGroup=pubStatsGroup, ethernetStatisticsTable=ethernetStatisticsTable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, sNTPServerRetries=sNTPServerRetries, auxPortQLTx=auxPortQLTx, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, transmitModulationModeLinked=transmitModulationModeLinked, sNTPServerTableIndex=sNTPServerTableIndex, sNTPSync=sNTPSync, syslogControlGroup=syslogControlGroup, targetRange=targetRange, cableDiagnosticsResultTable=cableDiagnosticsResultTable, frequencyVariant=frequencyVariant, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, syslogState=syslogState, licenseIssueNumber=licenseIssueNumber, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, mainPSUPortAllocation=mainPSUPortAllocation, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, routerProtocolsGroup=routerProtocolsGroup, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, authorizationMethod=authorizationMethod, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, bootVersion=bootVersion, tDMEnabledChannels=tDMEnabledChannels, licenseSecurityLevel=licenseSecurityLevel, licenseIPv6Support=licenseIPv6Support, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, PYSNMP_MODULE_ID=cambium)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, management=management, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, linkSymmetry=linkSymmetry, hardwareVersion=hardwareVersion, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, l2CPPriorityTableNumber=l2CPPriorityTableNumber, aggregateDataRate=aggregateDataRate, dNSServerInternetAddressType=dNSServerInternetAddressType, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, licenseCountry=licenseCountry, smtpGroup=smtpGroup, dNSResolver=dNSResolver, lbtDetectedTrap=lbtDetectedTrap, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, longitude=longitude, auxPortQLRx=auxPortQLRx, wirelessTopology=wirelessTopology, mABProtocolVLANPriority=mABProtocolVLANPriority, receiveModulationMode=receiveModulationMode, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, configuration=configuration, ptpTraps=ptpTraps, cableDiagPair1Results=cableDiagPair1Results, channelBandwidth=channelBandwidth, apc=apc, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, configurationInstancedTableIndex=configurationInstancedTableIndex, timeZone=timeZone, tFTPClient=tFTPClient, sFPPortSSMTx=sFPPortSSMTx, alarmsGroup=alarmsGroup, ptpCompliance=ptpCompliance, syslogLocalWrappedTrap=syslogLocalWrappedTrap, maximumTransmitPower=maximumTransmitPower, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, phyStatusGroup=phyStatusGroup, gatewayIPAddress=gatewayIPAddress, rangeLinked=rangeLinked, enabledDiagnosticAlarms=enabledDiagnosticAlarms, routerProtocols=routerProtocols, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, unitIdentificationGroup=unitIdentificationGroup, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, subbandLowestFrequency=subbandLowestFrequency, mABHoldoffPeriod=mABHoldoffPeriod, userTableIndex=userTableIndex, portAllocationMismatch=portAllocationMismatch, auxPortStatus=auxPortStatus, encryptionAlgorithm=encryptionAlgorithm, unitIdentification=unitIdentification, dNSServerPortNumber=dNSServerPortNumber, sMTPEmailAlert=sMTPEmailAlert, sFPPortQLRx=sFPPortQLRx, authorizationControlGroup=authorizationControlGroup, productVariant=productVariant)
