...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", range=range, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, cableDiagPair3Distance=cableDiagPair3Distance, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, antennaGain=antennaGain, ethernetInstancedTable=ethernetInstancedTable, auxPortAcceptedQLRx=auxPortAcceptedQLRx, iPv4Address=iPv4Address, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, aAAControl=aAAControl, portAllocationMismatchTrap=portAllocationMismatchTrap, mABState=mABState, tFTPServerInternetAddress=tFTPServerInternetAddress, tDMGroup=tDMGroup, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, mABProtocolVLANPriority=mABProtocolVLANPriority, license=license, channelBandwidth=channelBandwidth, mABMaintenanceLevel=mABMaintenanceLevel, dataBridgingStatus=dataBridgingStatus, tDMChannelLoopback=tDMChannelLoopback, syslogControl=syslogControl, sMTPEmailAlert=sMTPEmailAlert, dSCPManagementPriority=dSCPManagementPriority, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, syslogStateTrap=syslogStateTrap, ethernet=ethernet, productName=productName, ptmp=ptmp, sNTPSync=sNTPSync, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, transmitModulationModeLinked=transmitModulationModeLinked, licenseRARSupport=licenseRARSupport, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, sFPPortAutoNegotiation=sFPPortAutoNegotiation, accessMethod=accessMethod, receiveModulationModeDetail=receiveModulationModeDetail, licenseTDDSyncSupport=licenseTDDSyncSupport, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ptpGroups=ptpGroups, nIDULanPortAutoMdix=nIDULanPortAutoMdix, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, dNSServerTable=dNSServerTable, secureModeAlarm=secureModeAlarm, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, configurationInstancedTable=configurationInstancedTable, licenseInstancedTable=licenseInstancedTable, auxPortConfigurationMismatch=auxPortConfigurationMismatch, apc=apc, iPv6GatewayAddress=iPv6GatewayAddress, licenseSecurityLevel=licenseSecurityLevel, masterSlaveMode=masterSlaveMode, sNMPTrapPortNumber=sNMPTrapPortNumber, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, syslogLocalWrappedTrap=syslogLocalWrappedTrap, authorizationControlTable=authorizationControlTable, sNMPTrapVersion=sNMPTrapVersion, searchStateLinked=searchStateLinked, dfsPeaks=dfsPeaks, dataBridgingAvailability=dataBridgingAvailability, unitIdentificationGroup=unitIdentificationGroup, txMABFrames=txMABFrames, receiveModulationModeLinked=receiveModulationModeLinked, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tDMInterfaceStatus=tDMInterfaceStatus, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, signalStrengthRatio=signalStrengthRatio, mgmtInstancedTableEntry=mgmtInstancedTableEntry, authorizationControl=authorizationControl, packetsToInternalStack=packetsToInternalStack, wirelessOutEthernetOctets=wirelessOutEthernetOctets, installArmState=installArmState, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, phyInstancedStatusTable=phyInstancedStatusTable, phyControlInstancedTable=phyControlInstancedTable, sNTPServerTimeout=sNTPServerTimeout, sMTPServerPortNumber=sMTPServerPortNumber, rawReceivePowerLinked=rawReceivePowerLinked, siteName=siteName, tdmTableIndex=tdmTableIndex, transparentClockVID=transparentClockVID, vectorError=vectorError, transmitFreqKHz=transmitFreqKHz, ethernetGroup=ethernetGroup, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, licenseEncryption=licenseEncryption, encryptionGroup=encryptionGroup, snmpControlGroup=snmpControlGroup, linkSymmetry=linkSymmetry, auxPortDisabledWarning=auxPortDisabledWarning, supplementary=supplementary, mABHoldoffPeriod=mABHoldoffPeriod, licenseBandwidthCap=licenseBandwidthCap, auxPortStatus=auxPortStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, configurationGroup=configurationGroup, targetMACAddress=targetMACAddress, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, transmitChannel=transmitChannel, subnetMask=subnetMask, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, maximumNumberOfSlaves=maximumNumberOfSlaves, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, syslogState=syslogState, configurationInstancedTableIndex=configurationInstancedTableIndex, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, packetsFromInternalStack=packetsFromInternalStack, lbtDetectedTrap=lbtDetectedTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sntp=sntp, tDDSynchronizationStatus=tDDSynchronizationStatus, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, mainPSUPortAutoMdix=mainPSUPortAutoMdix, ethernetPriorityTableIndex=ethernetPriorityTableIndex, dNSServerInternetAddress=dNSServerInternetAddress, configurationInstancedTableNumber=configurationInstancedTableNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, receiveModulationMode=receiveModulationMode, supplementaryGroup=supplementaryGroup, alarmInstancedTableIndex=alarmInstancedTableIndex, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, linkModeOptimization=linkModeOptimization, txColorCode=txColorCode, receiveDataRateLinked=receiveDataRateLinked, ethernetInstancedTableEntry=ethernetInstancedTableEntry, notificationsGroup=notificationsGroup, ptpTraps=ptpTraps, byteErrorRatioLinked=byteErrorRatioLinked, sNMPTrapTableNumber=sNMPTrapTableNumber, byteErrorRatio=byteErrorRatio, sNMPEnabledTraps=sNMPEnabledTraps, aggregateDataRate=aggregateDataRate, enableTransmission=enableTransmission, versionsGroup=versionsGroup, remoteUnitNameLinked=remoteUnitNameLinked, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, receiveDataRate=receiveDataRate, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, hTTPSPortNumber=hTTPSPortNumber, routerProtocolsGroup=routerProtocolsGroup, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, linkName=linkName, channelChangeTrap=channelChangeTrap, lowestTDMModulationMode=lowestTDMModulationMode, sNMPv3Enable=sNMPv3Enable, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, mABProtocolVID=mABProtocolVID, deviceMSN=deviceMSN, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, blacklistRMMacAddress=blacklistRMMacAddress, syncESlavePort=syncESlavePort, sNMPCommunityString=sNMPCommunityString, routerProtocols=routerProtocols, frequencyVariant=frequencyVariant, rangeLinked=rangeLinked, timeZone=timeZone, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, dNSServerInternetAddressType=dNSServerInternetAddressType, management=management, lowestDataModulationMode=lowestDataModulationMode, authorizationControlGroup=authorizationControlGroup, ptp670=ptp670, hTTPSAccessEnabled=hTTPSAccessEnabled, managementNetworkAccessEnabled=managementNetworkAccessEnabled, transparentClockPort=transparentClockPort, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, alarmsGroup=alarmsGroup, portAllocationMismatchLinked=portAllocationMismatchLinked, userTable=userTable, userTableEntry=userTableEntry, syncETrackingState=syncETrackingState, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, mPLSTCPriorityTable=mPLSTCPriorityTable, remoteInternetAddress=remoteInternetAddress, sFPPortSSMTx=sFPPortSSMTx, installStatusTrap=installStatusTrap, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, bridge=bridge, wirelessLinkStatus=wirelessLinkStatus, dNSServerPortNumber=dNSServerPortNumber, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, ethernetInstancedTableNumber=ethernetInstancedTableNumber, sntpGroup=sntpGroup, transmitModulationMode=transmitModulationMode, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, extendedSpectrumScanning=extendedSpectrumScanning, incompatibleRegulatoryBands=incompatibleRegulatoryBands, whitelistRMEnabled=whitelistRMEnabled, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, alarmInstancedTable=alarmInstancedTable, encryptionAlgorithm=encryptionAlgorithm, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, whitelistRMMacAddress=whitelistRMMacAddress, gatewayIPAddress=gatewayIPAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, mainPSUPortQLTx=mainPSUPortQLTx, tempPcb=tempPcb, wirelessOutOctets=wirelessOutOctets, sFPPortAllocation=sFPPortAllocation, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, licenseSFPPortSupport=licenseSFPPortSupport, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, sFPPortStatus=sFPPortStatus, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, vLANManagementPriority=vLANManagementPriority, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, dfsTableNumber=dfsTableNumber, longitude=longitude, latitude=latitude, licenseIEEE1588Support=licenseIEEE1588Support, transparentClock=transparentClock, dNSResolver=dNSResolver, sNTPServerPortNumber=sNTPServerPortNumber, sFPPortDisabledWarning=sFPPortDisabledWarning, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, daylightSaving=daylightSaving, tFTPServerPortNumber=tFTPServerPortNumber, cableDiagnosticsPorts=cableDiagnosticsPorts, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, sMTPServerInternetAddressType=sMTPServerInternetAddressType, licenseVersion=licenseVersion, aAAControlGroup=aAAControlGroup, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, systemReset=systemReset, tDMInterfaceControl=tDMInterfaceControl, transmitPower=transmitPower, cableLoss=cableLoss, vectorErrorLinked=vectorErrorLinked, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, tdmTable=tdmTable, dataBridgingStatusAlarm=dataBridgingStatusAlarm, ethernetStatisticsTable=ethernetStatisticsTable, licenseGroup=licenseGroup, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, regulatoryBandTrap=regulatoryBandTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, wirelessLinkStatusLinked=wirelessLinkStatusLinked, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, cableDiagPair3Results=cableDiagPair3Results, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, deviceESN=deviceESN, tDMConfigurationMismatch=tDMConfigurationMismatch, oOBPriorityQueueMapping=oOBPriorityQueueMapping, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, sMTPEnabledMessages=sMTPEnabledMessages, dNSPrimaryServer=dNSPrimaryServer, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, encryption=encryption, sNTPServerInternetAddressType=sNTPServerInternetAddressType, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, ptpCompliance=ptpCompliance, tDMChannelStatusTrap=tDMChannelStatusTrap, cableDiagPair2Distance=cableDiagPair2Distance, licenseInstancedTableNumber=licenseInstancedTableNumber, authorizationMethod=authorizationMethod, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, licenseMaxLinkRange=licenseMaxLinkRange, cableDiagnosticsResultTable=cableDiagnosticsResultTable, receiveFreqMHz=receiveFreqMHz, dNSServerTableEntry=dNSServerTableEntry, blacklistRMEnabled=blacklistRMEnabled, dNSServerTableNumber=dNSServerTableNumber, hCMPLinkSymmetry=hCMPLinkSymmetry, groupID=groupID, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, unitIdentification=unitIdentification, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, sNTPServerTableEntry=sNTPServerTableEntry, phyStatusGroup=phyStatusGroup, targetRange=targetRange, hTTPPortNumber=hTTPPortNumber, linkLossLinked=linkLossLinked, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, licenseGasGroup=licenseGasGroup, alarms=alarms, dataBridgingStatusLinked=dataBridgingStatusLinked, wirelessLinkAvailability=wirelessLinkAvailability, dataPortWirelessDownAlert=dataPortWirelessDownAlert, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, licenseTLSRekey=licenseTLSRekey, sNTPServerTable=sNTPServerTable, portAllocationMismatch=portAllocationMismatch, smtpGroup=smtpGroup, qOSPriorityScheme=qOSPriorityScheme, authorizationControlTableNumber=authorizationControlTableNumber, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, phyStatus=phyStatus, managementPortWirelessDownAlert=managementPortWirelessDownAlert, transmitterChannels=transmitterChannels, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, productVariant=productVariant, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, eIRP=eIRP, apcGroup=apcGroup, licenseTrialPeriod=licenseTrialPeriod, smtp=smtp, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, rawReceivePower=rawReceivePower, rxColorCode=rxColorCode, userName=userName, dNSGroup=dNSGroup, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, remoteMACAddress=remoteMACAddress, tDMEnabledChannels=tDMEnabledChannels, l2CPPriorityTableNumber=l2CPPriorityTableNumber, userTableNumber=userTableNumber, sNTPSyncTrap=sNTPSyncTrap, useVLANForMABProtocol=useVLANForMABProtocol, maximumTransmitPower=maximumTransmitPower, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, searchState=searchState, licenseIPv6Support=licenseIPv6Support, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, rangingMode=rangingMode, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, wirelessTopology=wirelessTopology, telnetAccessEnabled=telnetAccessEnabled, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, phyControlInstancedTableIndex=phyControlInstancedTableIndex, cableDiagPair1Results=cableDiagPair1Results, authorizationControlTableIndex=authorizationControlTableIndex, transparentClockVLAN=transparentClockVLAN, syncETracking=syncETracking, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, mgmtInstancedTable=mgmtInstancedTable, sNMPPortNumber=sNMPPortNumber, cableDiagnosticsControl=cableDiagnosticsControl, nIDULanPortStatusTrap=nIDULanPortStatusTrap, transmitDataRateLinked=transmitDataRateLinked, userPassword=userPassword, licenseGroupAccess=licenseGroupAccess, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, wirelessOutAllOctets=wirelessOutAllOctets, tDMChannelStatus=tDMChannelStatus, pubStats=pubStats, licenseOOBManagementSupport=licenseOOBManagementSupport, phyControlGroup=phyControlGroup, tDMChannelLineCode=tDMChannelLineCode, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, phyControl=phyControl, licenseCapacity=licenseCapacity, capacityVariantMismatchLinked=capacityVariantMismatchLinked, secureModeAlarmTrap=secureModeAlarmTrap, telnetPortNumber=telnetPortNumber, auxPortQLRx=auxPortQLRx, licenseInstancedTableEntry=licenseInstancedTableEntry, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, pubInstancedStatsTable=pubInstancedStatsTable, remoteMACAddressLinked=remoteMACAddressLinked, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, noWirelessChannelAvailable=noWirelessChannelAvailable, sFPPortQLRx=sFPPortQLRx, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, iPv6Address=iPv6Address, hCMPMaximumLinkRange=hCMPMaximumLinkRange, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, reset=reset, remoteInternetAddressType=remoteInternetAddressType, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, mgmtInstancedTableNumber=mgmtInstancedTableNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, maxLinkRangeExceeded=maxLinkRangeExceeded, licenseIssueNumber=licenseIssueNumber, vLANManagementVID=vLANManagementVID, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, transmitPowerLinked=transmitPowerLinked, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, configuration=configuration, systemClock=systemClock, syslogClient=syslogClient, ethernetStatisticsDataSource=ethernetStatisticsDataSource, sNTPLastSync=sNTPLastSync, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, regulatoryBand=regulatoryBand, mABTransmissionInterval=mABTransmissionInterval, mainPSUPortStatusTrap=mainPSUPortStatusTrap, pubStatsGroup=pubStatsGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPServerRetries=sNTPServerRetries, userRole=userRole, cambium=cambium, licenseCountry=licenseCountry, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sFPPortQLTx=sFPPortQLTx, erroredSeconds=erroredSeconds, unavailableSeconds=unavailableSeconds, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, syncEEquipmentClock=syncEEquipmentClock, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, dfsMeans=dfsMeans, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tFTPClient=tFTPClient, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, licenseUnitSerialNumber=licenseUnitSerialNumber, installationMode=installationMode, auxPortAllocation=auxPortAllocation, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, aggregateDataRateLinked=aggregateDataRateLinked, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNTPState=sNTPState, installArmStateTrap=installArmStateTrap, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, receivePowerLinked=receivePowerLinked, remoteUnitName=remoteUnitName, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, cableDiagnosticsGroup=cableDiagnosticsGroup, linkLoss=linkLoss, unitOutOfCalibration=unitOutOfCalibration, dfsTable=dfsTable, tDM=tDM, userTableIndex=userTableIndex, sNTPServerStatus=sNTPServerStatus, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sFPPortStatusTrap=sFPPortStatusTrap, cableDiagnostics=cableDiagnostics, licenseHCMPSupport=licenseHCMPSupport, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, mainPSUPortSSMTx=mainPSUPortSSMTx, l2CPPriorityTable=l2CPPriorityTable, ethernetInstancedTableIndex=ethernetInstancedTableIndex, antennaSelection=antennaSelection, hTTPAccessEnabled=hTTPAccessEnabled, alarmInstancedTableNumber=alarmInstancedTableNumber, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, sNTPPollInterval=sNTPPollInterval, sNTPServerInternetAddress=sNTPServerInternetAddress, cableDiagPair2Results=cableDiagPair2Results, capacityVariantMismatch=capacityVariantMismatch, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, licenseRegulatoryBandsList=licenseRegulatoryBandsList, tDMChannelCableLength=tDMChannelCableLength, severelyErroredSeconds=severelyErroredSeconds, sNMPTrapTableIndex=sNMPTrapTableIndex, phyControlInstancedTableNumber=phyControlInstancedTableNumber, dfs=dfs, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, iPVersion=iPVersion, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, ptpTrapPrefix=ptpTrapPrefix, dfsGroup=dfsGroup, authorizationControlTableEntry=authorizationControlTableEntry, secondarySoftwareVersion=secondarySoftwareVersion, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, PYSNMP_MODULE_ID=cambium, sFPError=sFPError, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, cableDiagPair4Distance=cableDiagPair4Distance, syslogClientTrap=syslogClientTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, installStatusLinked=installStatusLinked, receiveFreqKHz=receiveFreqKHz, dfsTableEntry=dfsTableEntry, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sFPErrorTrap=sFPErrorTrap, tdmTableEntry=tdmTableEntry, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, mainPSUPortAllocation=mainPSUPortAllocation, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, l2CPPriorityTableEntry=l2CPPriorityTableEntry, alarmInstancedTableEntry=alarmInstancedTableEntry, mABNominalTransmitCapacity=mABNominalTransmitCapacity, resetGroup=resetGroup, localPacketFiltering=localPacketFiltering, dataPortPauseFrames=dataPortPauseFrames, tDDSynchronizationMode=tDDSynchronizationMode, mainPSUPortQLRx=mainPSUPortQLRx, cableDiagnosticsWarning=cableDiagnosticsWarning, tdmTableNumber=tdmTableNumber, cableDiagPair1Distance=cableDiagPair1Distance, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, transmitDataRate=transmitDataRate, bridgeGroup=bridgeGroup, signalStrengthRatioLinked=signalStrengthRatioLinked, iPv6PrefixLength=iPv6PrefixLength, auxPortStatusTrap=auxPortStatusTrap, sNTPPrimaryServer=sNTPPrimaryServer, dfsTableIndex=dfsTableIndex)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", auxPortQLTx=auxPortQLTx, hardwareVersion=hardwareVersion, tDDControl=tDDControl, sFPPortSyncERxStatus=sFPPortSyncERxStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, versions=versions, tDDControlGroup=tDDControlGroup, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, sFPPortAutoMdix=sFPPortAutoMdix, sNTPServerTableNumber=sNTPServerTableNumber, sNMPTrapTable=sNMPTrapTable, tFTPServerInternetAddressType=tFTPServerInternetAddressType, softwareVersion=softwareVersion, mABNominalModulationMode=mABNominalModulationMode, licenseSyncESupport=licenseSyncESupport, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, transmitFreqMHz=transmitFreqMHz, subbandLowestFrequency=subbandLowestFrequency, iPDSCPPriorityTable=iPDSCPPriorityTable, mainPSUPortStatus=mainPSUPortStatus, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, remoteInternetAddressLinked=remoteInternetAddressLinked, managementGroup=managementGroup, auxPortSyncERxStatus=auxPortSyncERxStatus, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, auxPortSSMTx=auxPortSSMTx, dNSServerTableIndex=dNSServerTableIndex, userEnabled=userEnabled, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, altitude=altitude, snmpControl=snmpControl, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, configurationInstancedTableEntry=configurationInstancedTableEntry, ethernetPriorityTableNumber=ethernetPriorityTableNumber, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, licenseInstancedTableIndex=licenseInstancedTableIndex, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNTPServerTableIndex=sNTPServerTableIndex, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, capacityVariantMismatchTrap=capacityVariantMismatchTrap, phyControlInstancedTableEntry=phyControlInstancedTableEntry, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, nIDULanPortStatus=nIDULanPortStatus, subbandHighestFrequency=subbandHighestFrequency, syslogControlGroup=syslogControlGroup, bootVersion=bootVersion, receiveChannel=receiveChannel, unitName=unitName, ptp=ptp, deviceMACAddress=deviceMACAddress, mgmtInstancedTableIndex=mgmtInstancedTableIndex, receivePower=receivePower, ethernetPriorityTable=ethernetPriorityTable, dNS=dNS, cableDiagPair4Results=cableDiagPair4Results, installStatus=installStatus)
