...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", range=range, syslogStateTrap=syslogStateTrap, tDMChannelStatusTrap=tDMChannelStatusTrap, receiveChannel=receiveChannel, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, sMTPServerInternetAddressType=sMTPServerInternetAddressType, remoteMaximumTransmitPower=remoteMaximumTransmitPower, versions=versions, mABNominalTransmitCapacity=mABNominalTransmitCapacity, alarmInstancedTableEntry=alarmInstancedTableEntry, wirelessOutAllOctets=wirelessOutAllOctets, sFPPortSSMTx=sFPPortSSMTx, authorizationControlTable=authorizationControlTable, license=license, tFTPClient=tFTPClient, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, searchStateLinked=searchStateLinked, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, licenseGroup=licenseGroup, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, cableDiagPair1Distance=cableDiagPair1Distance, pubInstancedStatsTable=pubInstancedStatsTable, syslogClient=syslogClient, phyControlInstancedTableNumber=phyControlInstancedTableNumber, cableDiagPair1Results=cableDiagPair1Results, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, sNTPServerTable=sNTPServerTable, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, mABState=mABState, snmpControlGroup=snmpControlGroup, managementGroup=managementGroup, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, channelBandwidth=channelBandwidth, packetsFromInternalStack=packetsFromInternalStack, dfs=dfs, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, mainPSUPortStatusTrap=mainPSUPortStatusTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, receiveFreqMHz=receiveFreqMHz, mABHoldoffPeriod=mABHoldoffPeriod, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, licenseInstancedTableIndex=licenseInstancedTableIndex, telnetAccessEnabled=telnetAccessEnabled, auxPortAllocation=auxPortAllocation, noWirelessChannelAvailable=noWirelessChannelAvailable, frequencyVariant=frequencyVariant, unitName=unitName, lbtDetectedTrap=lbtDetectedTrap, sNTPState=sNTPState, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, timeZone=timeZone, sNTPServerTableNumber=sNTPServerTableNumber, transmitModulationModeLinked=transmitModulationModeLinked, mainPSUPortAutoMdix=mainPSUPortAutoMdix, auxPortSSMTx=auxPortSSMTx, resetGroup=resetGroup, tDMConfigurationMismatch=tDMConfigurationMismatch, routerProtocolsGroup=routerProtocolsGroup, installArmStateTrap=installArmStateTrap, useVLANForMABProtocol=useVLANForMABProtocol, licenseHCMPSupport=licenseHCMPSupport, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, licenseGroupAccess=licenseGroupAccess, byteErrorRatio=byteErrorRatio, tDDControl=tDDControl, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, authorizationControl=authorizationControl, routerProtocols=routerProtocols, licenseBandwidthCap=licenseBandwidthCap, licenseIPv6Support=licenseIPv6Support, linkLoss=linkLoss, dNSServerTableEntry=dNSServerTableEntry, dSCPManagementPriority=dSCPManagementPriority, phyStatus=phyStatus, ethernet=ethernet, licenseRARSupport=licenseRARSupport, secureModeAlarmTrap=secureModeAlarmTrap, enableTransmission=enableTransmission, mainPSUPortStatus=mainPSUPortStatus, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, licenseVersion=licenseVersion, txColorCode=txColorCode, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, licenseIEEE1588Support=licenseIEEE1588Support, dNSPrimaryServer=dNSPrimaryServer, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, dataBridgingAvailability=dataBridgingAvailability, ptpTraps=ptpTraps, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, hTTPSAccessEnabled=hTTPSAccessEnabled, dfsPeaks=dfsPeaks, auxPortStatus=auxPortStatus, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, licenseCountry=licenseCountry, targetMACAddress=targetMACAddress, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, erroredSeconds=erroredSeconds, aAAControlGroup=aAAControlGroup, syncESlavePort=syncESlavePort, regulatoryBandTrap=regulatoryBandTrap, configurationInstancedTableNumber=configurationInstancedTableNumber, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, configurationInstancedTable=configurationInstancedTable, sFPPortAutoMdix=sFPPortAutoMdix, sMTPServerInternetAddress=sMTPServerInternetAddress, remoteUnitNameLinked=remoteUnitNameLinked, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, transparentClockPort=transparentClockPort, ethernetStatisticsTable=ethernetStatisticsTable, linkSymmetry=linkSymmetry, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, qOSPriorityScheme=qOSPriorityScheme, sNMPv3Enable=sNMPv3Enable, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, whitelistRMEnabled=whitelistRMEnabled, dataPortPauseFrames=dataPortPauseFrames, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, userRole=userRole, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, hCMPMaximumLinkRange=hCMPMaximumLinkRange, mABProtocolVLANPriority=mABProtocolVLANPriority, licenseEncryption=licenseEncryption, aAAControl=aAAControl, reset=reset, sFPPortAutoNegotiation=sFPPortAutoNegotiation, licenseGasGroup=licenseGasGroup, ptpTrapPrefix=ptpTrapPrefix, receiveModulationModeDetail=receiveModulationModeDetail, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, bridgeGroup=bridgeGroup, smtpGroup=smtpGroup, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, installStatus=installStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sFPPortStatus=sFPPortStatus, systemClock=systemClock, encryptionGroup=encryptionGroup, maximumTransmitPower=maximumTransmitPower, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, aggregateDataRate=aggregateDataRate, cableDiagPair4Distance=cableDiagPair4Distance, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, ethernetStatisticsDataSource=ethernetStatisticsDataSource, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, dNSGroup=dNSGroup, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, snmpControl=snmpControl, notificationsGroup=notificationsGroup, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dNSServerInternetAddress=dNSServerInternetAddress, l2CPPriorityTableNumber=l2CPPriorityTableNumber, cambium=cambium, dNSServerTableIndex=dNSServerTableIndex, daylightSaving=daylightSaving, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, ethernetInstancedTableNumber=ethernetInstancedTableNumber, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, licenseTLSRekey=licenseTLSRekey, sntpGroup=sntpGroup, transparentClockVID=transparentClockVID, dfsTable=dfsTable, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, remoteInternetAddressLinked=remoteInternetAddressLinked, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, txMABFrames=txMABFrames, sFPPortAllocation=sFPPortAllocation, mABProtocolVID=mABProtocolVID, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, cableDiagnosticsGroup=cableDiagnosticsGroup, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, mPLSTCPriorityTable=mPLSTCPriorityTable, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, mABMaintenanceLevel=mABMaintenanceLevel, phyInstancedStatusTable=phyInstancedStatusTable, alarmInstancedTable=alarmInstancedTable, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, secureModeAlarm=secureModeAlarm, maximumNumberOfSlaves=maximumNumberOfSlaves, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, installArmState=installArmState, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, auxPortSyncERxStatus=auxPortSyncERxStatus, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, remoteUnitName=remoteUnitName, l2CPPriorityTableEntry=l2CPPriorityTableEntry, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, dataBridgingStatusAlarm=dataBridgingStatusAlarm, installStatusLinked=installStatusLinked, auxPortAcceptedQLRx=auxPortAcceptedQLRx, accessMethod=accessMethod, auxPortDisabledWarning=auxPortDisabledWarning, capacityVariantMismatchLinked=capacityVariantMismatchLinked, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, alarmInstancedTableIndex=alarmInstancedTableIndex, encryption=encryption, tdmTableEntry=tdmTableEntry, antennaSelection=antennaSelection, licenseUnitSerialNumber=licenseUnitSerialNumber, linkModeOptimization=linkModeOptimization, alarmsGroup=alarmsGroup, phyControlInstancedTableIndex=phyControlInstancedTableIndex, linkName=linkName, ethernetPriorityTable=ethernetPriorityTable, remoteInternetAddressType=remoteInternetAddressType, signalStrengthRatioLinked=signalStrengthRatioLinked, auxPortQLTx=auxPortQLTx, capacityVariantMismatch=capacityVariantMismatch, sNTPServerPortNumber=sNTPServerPortNumber, transmitFreqMHz=transmitFreqMHz, iPDSCPPriorityTable=iPDSCPPriorityTable, sFPPortDisabledWarning=sFPPortDisabledWarning, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, channelChangeTrap=channelChangeTrap, productName=productName, ptp=ptp, subbandHighestFrequency=subbandHighestFrequency, licenseSecurityLevel=licenseSecurityLevel, installationMode=installationMode, management=management, sNTPServerTableIndex=sNTPServerTableIndex, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, unavailableSeconds=unavailableSeconds, signalStrengthRatio=signalStrengthRatio, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, lowestDataModulationMode=lowestDataModulationMode, softwareVersion=softwareVersion, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, ethernetInstancedTableEntry=ethernetInstancedTableEntry, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, auxPortStatusTrap=auxPortStatusTrap, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, licenseOOBManagementSupport=licenseOOBManagementSupport, receiveModulationModeLinked=receiveModulationModeLinked, userTableEntry=userTableEntry, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, authorizationControlGroup=authorizationControlGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", licenseSFPPortSupport=licenseSFPPortSupport, iPv6PrefixLength=iPv6PrefixLength, dfsTableEntry=dfsTableEntry, sNMPTrapTableEntry=sNMPTrapTableEntry, alarmInstancedTableNumber=alarmInstancedTableNumber, receivePower=receivePower, nIDULanPortStatus=nIDULanPortStatus, encryptionAlgorithm=encryptionAlgorithm, l2CPPriorityTable=l2CPPriorityTable, whitelistRMMacAddress=whitelistRMMacAddress, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, receiveDataRateLinked=receiveDataRateLinked, mainPSUPortSSMTx=mainPSUPortSSMTx, sFPErrorTrap=sFPErrorTrap, sNTPServerStatus=sNTPServerStatus, ptp670=ptp670, ethernetInstancedTable=ethernetInstancedTable, dNSServerPortNumber=dNSServerPortNumber, syslogState=syslogState, phyStatusGroup=phyStatusGroup, deviceESN=deviceESN, phyControlInstancedTableEntry=phyControlInstancedTableEntry, dataBridgingStatus=dataBridgingStatus, authorizationControlTableNumber=authorizationControlTableNumber, wirelessLinkStatus=wirelessLinkStatus, cableDiagPair3Results=cableDiagPair3Results, tDMGroup=tDMGroup, dNS=dNS, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, wirelessOutEthernetOctets=wirelessOutEthernetOctets, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, rawReceivePowerLinked=rawReceivePowerLinked, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, secondarySoftwareVersion=secondarySoftwareVersion, dfsGroup=dfsGroup, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, cableDiagPair3Distance=cableDiagPair3Distance, groupID=groupID, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, bootVersion=bootVersion, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, iPv6Address=iPv6Address, managementPortWirelessDownAlert=managementPortWirelessDownAlert, syslogClientTrap=syslogClientTrap, ptmp=ptmp, sNMPTrapTable=sNMPTrapTable, telnetPortNumber=telnetPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, tdmTableIndex=tdmTableIndex, userEnabled=userEnabled, portAllocationMismatch=portAllocationMismatch, userTable=userTable, sFPPortSyncERxStatus=sFPPortSyncERxStatus, licenseTDDSyncSupport=licenseTDDSyncSupport, l2CPPriorityTableIndex=l2CPPriorityTableIndex, transmitFreqKHz=transmitFreqKHz, dfsMeans=dfsMeans, sNMPEnabledTraps=sNMPEnabledTraps, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, mainPSUPortQLTx=mainPSUPortQLTx, sNTPServerInternetAddress=sNTPServerInternetAddress, mABNominalModulationMode=mABNominalModulationMode, sFPPortStatusTrap=sFPPortStatusTrap, dNSResolver=dNSResolver, deviceMACAddress=deviceMACAddress, pubStats=pubStats, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, deviceMSN=deviceMSN, syncETrackingState=syncETrackingState, tDDSynchronizationAlarm=tDDSynchronizationAlarm, byteErrorRatioLinked=byteErrorRatioLinked, userTableIndex=userTableIndex, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, hardwareVersion=hardwareVersion, authorizationControlTableEntry=authorizationControlTableEntry, wirelessTopology=wirelessTopology, nIDULanPortStatusTrap=nIDULanPortStatusTrap, phyControlInstancedTable=phyControlInstancedTable, receivePowerLinked=receivePowerLinked, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, transmitModulationMode=transmitModulationMode, oOBPriorityQueueMapping=oOBPriorityQueueMapping, portAllocationMismatchTrap=portAllocationMismatchTrap, syslogControl=syslogControl, mgmtInstancedTableNumber=mgmtInstancedTableNumber, sNMPTrapVersion=sNMPTrapVersion, userTableNumber=userTableNumber, unitIdentificationGroup=unitIdentificationGroup, productVariant=productVariant, ethernetInstancedTableIndex=ethernetInstancedTableIndex, versionsGroup=versionsGroup, apc=apc, remoteMACAddressLinked=remoteMACAddressLinked, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, sMTPServerPortNumber=sMTPServerPortNumber, sNTPPollInterval=sNTPPollInterval, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, wirelessLinkAvailability=wirelessLinkAvailability, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, maxLinkRangeExceeded=maxLinkRangeExceeded, sNMPTrapPortNumber=sNMPTrapPortNumber, blacklistRMMacAddress=blacklistRMMacAddress, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, authorizationMethod=authorizationMethod, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, vLANManagementVID=vLANManagementVID, tdmTable=tdmTable, transmitDataRateLinked=transmitDataRateLinked, wirelessLinkStatusLinked=wirelessLinkStatusLinked, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, syncEEquipmentClock=syncEEquipmentClock, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, remoteMACAddress=remoteMACAddress, bridge=bridge, rxColorCode=rxColorCode, licenseMaxLinkRange=licenseMaxLinkRange, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, sNMPCommunityString=sNMPCommunityString, transparentClockVLAN=transparentClockVLAN, tDMInterfaceStatus=tDMInterfaceStatus, licenseRegulatoryBandsList=licenseRegulatoryBandsList, vectorErrorLinked=vectorErrorLinked, ptpGroups=ptpGroups, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, licenseSyncESupport=licenseSyncESupport, targetRange=targetRange, subnetMask=subnetMask, unitOutOfCalibration=unitOutOfCalibration, sFPPortQLRx=sFPPortQLRx, subbandLowestFrequency=subbandLowestFrequency, sFPPortQLTx=sFPPortQLTx, mgmtInstancedTableIndex=mgmtInstancedTableIndex, tdmTableNumber=tdmTableNumber, sNTPPrimaryServer=sNTPPrimaryServer, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, sntp=sntp, auxPortConfigurationMismatch=auxPortConfigurationMismatch, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, cableDiagPair2Results=cableDiagPair2Results, tDMInterfaceControl=tDMInterfaceControl, sNMPTrapTableIndex=sNMPTrapTableIndex, licenseCapacity=licenseCapacity, localPacketFiltering=localPacketFiltering, cableDiagPair2Distance=cableDiagPair2Distance, hTTPSPortNumber=hTTPSPortNumber, cableDiagnostics=cableDiagnostics, vLANManagementPriority=vLANManagementPriority, vectorError=vectorError, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, dNSServerInternetAddressType=dNSServerInternetAddressType, altitude=altitude, tFTPServerPortNumber=tFTPServerPortNumber, tDM=tDM, tDDSynchronizationMode=tDDSynchronizationMode, tDMChannelLoopback=tDMChannelLoopback, configuration=configuration, alarms=alarms, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, cableDiagPair4Results=cableDiagPair4Results, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, searchState=searchState, PYSNMP_MODULE_ID=cambium, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, latitude=latitude, wirelessOutOctets=wirelessOutOctets, userPassword=userPassword, ethernetGroup=ethernetGroup, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dNSServerTableNumber=dNSServerTableNumber, phyControl=phyControl, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, transmitterChannels=transmitterChannels, dataBridgingStatusLinked=dataBridgingStatusLinked, tDMChannelStatus=tDMChannelStatus, cableLoss=cableLoss, syncETracking=syncETracking, hTTPPortNumber=hTTPPortNumber, transparentClock=transparentClock, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, rawReceivePower=rawReceivePower, sNTPLastSync=sNTPLastSync, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, installStatusTrap=installStatusTrap, mgmtInstancedTableEntry=mgmtInstancedTableEntry, cableDiagnosticsPorts=cableDiagnosticsPorts, severelyErroredSeconds=severelyErroredSeconds, transmitChannel=transmitChannel, linkLossLinked=linkLossLinked, hTTPAccessEnabled=hTTPAccessEnabled, sNTPServerTimeout=sNTPServerTimeout, regulatoryBand=regulatoryBand, dfsTableNumber=dfsTableNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNTPSyncTrap=sNTPSyncTrap, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, blacklistRMEnabled=blacklistRMEnabled, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, packetsToInternalStack=packetsToInternalStack, cableDiagnosticsResultTable=cableDiagnosticsResultTable, cableDiagnosticsControl=cableDiagnosticsControl, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, tDDControlGroup=tDDControlGroup, licenseInstancedTableEntry=licenseInstancedTableEntry, licenseInstancedTable=licenseInstancedTable, eIRP=eIRP, licenseTrialPeriod=licenseTrialPeriod, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, licenseInstancedTableNumber=licenseInstancedTableNumber, extendedSpectrumScanning=extendedSpectrumScanning, tDDSynchronizationStatus=tDDSynchronizationStatus, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, phyControlGroup=phyControlGroup, nIDULanPortAutoMdix=nIDULanPortAutoMdix, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, authorizationControlTableIndex=authorizationControlTableIndex, sMTPEmailAlert=sMTPEmailAlert, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, iPv4Address=iPv4Address, tDMEnabledChannels=tDMEnabledChannels, incompatibleMasterAndSlave=incompatibleMasterAndSlave, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, tempPcb=tempPcb, sNTPSync=sNTPSync, capacityVariantMismatchTrap=capacityVariantMismatchTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, cableDiagnosticsWarning=cableDiagnosticsWarning, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, antennaGain=antennaGain, sNMPTrapInternetAddress=sNMPTrapInternetAddress, mgmtInstancedTable=mgmtInstancedTable, siteName=siteName, unitIdentification=unitIdentification, remoteInternetAddress=remoteInternetAddress, systemReset=systemReset, supplementary=supplementary, syslogControlGroup=syslogControlGroup, gatewayIPAddress=gatewayIPAddress, sMTPEnabledMessages=sMTPEnabledMessages, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, masterSlaveMode=masterSlaveMode, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, apcGroup=apcGroup, tDMChannelCableLength=tDMChannelCableLength, incompatibleRegulatoryBands=incompatibleRegulatoryBands, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, receiveDataRate=receiveDataRate, mainPSUPortAllocation=mainPSUPortAllocation, dNSServerTable=dNSServerTable, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, supplementaryGroup=supplementaryGroup, sNTPServerRetries=sNTPServerRetries, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, transmitPowerLinked=transmitPowerLinked, rangeLinked=rangeLinked, sNMPPortNumber=sNMPPortNumber, dfsTableIndex=dfsTableIndex, hCMPLinkSymmetry=hCMPLinkSymmetry, ethernetPriorityTableNumber=ethernetPriorityTableNumber, receiveFreqKHz=receiveFreqKHz, configurationInstancedTableEntry=configurationInstancedTableEntry, ptpCompliance=ptpCompliance, sNTPServerTableEntry=sNTPServerTableEntry, configurationInstancedTableIndex=configurationInstancedTableIndex, aggregateDataRateLinked=aggregateDataRateLinked, userName=userName, licenseIssueNumber=licenseIssueNumber, tFTPServerInternetAddress=tFTPServerInternetAddress, lowestTDMModulationMode=lowestTDMModulationMode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, transmitDataRate=transmitDataRate, transmitPower=transmitPower, configurationGroup=configurationGroup, managementNetworkAccessEnabled=managementNetworkAccessEnabled, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, useVLANForManagementInterfaces=useVLANForManagementInterfaces, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, mainPSUPortQLRx=mainPSUPortQLRx, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, longitude=longitude, auxPortQLRx=auxPortQLRx, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tDMChannelLineCode=tDMChannelLineCode, rangingMode=rangingMode, sFPError=sFPError, mABTransmissionInterval=mABTransmissionInterval, smtp=smtp, ethernetPriorityTableEntry=ethernetPriorityTableEntry, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, iPVersion=iPVersion, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, iPv6GatewayAddress=iPv6GatewayAddress, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, receiveModulationMode=receiveModulationMode, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, portAllocationMismatchLinked=portAllocationMismatchLinked, pubStatsGroup=pubStatsGroup, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap)
