...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", userRole=userRole, alarmsGroup=alarmsGroup, licenseTLSRekey=licenseTLSRekey, sMTPEmailAlert=sMTPEmailAlert, snmpControlGroup=snmpControlGroup, phyControlInstancedTableIndex=phyControlInstancedTableIndex, searchStateLinked=searchStateLinked, licenseRARSupport=licenseRARSupport, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, configurationGroup=configurationGroup, userTableNumber=userTableNumber, tempPcb=tempPcb, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, mainPSUPortQLTx=mainPSUPortQLTx, mABProtocolVLANPriority=mABProtocolVLANPriority, syncETracking=syncETracking, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, ptp=ptp, tFTPServerPortNumber=tFTPServerPortNumber, userTableIndex=userTableIndex, transmitterChannels=transmitterChannels, userName=userName, installArmState=installArmState, licenseInstancedTableNumber=licenseInstancedTableNumber, dNSServerTable=dNSServerTable, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, vLANManagementPriority=vLANManagementPriority, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, nIDULanPortStatusTrap=nIDULanPortStatusTrap, auxPortConfigurationMismatch=auxPortConfigurationMismatch, userEnabled=userEnabled, cableDiagPair2Results=cableDiagPair2Results, hTTPSPortNumber=hTTPSPortNumber, supplementaryGroup=supplementaryGroup, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, deviceMACAddress=deviceMACAddress, dataBridgingAvailability=dataBridgingAvailability, unitOutOfCalibration=unitOutOfCalibration, receiveFreqMHz=receiveFreqMHz, sntpGroup=sntpGroup, transmitDataRate=transmitDataRate, licenseInstancedTableIndex=licenseInstancedTableIndex, l2CPPriorityTableNumber=l2CPPriorityTableNumber, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, sNMPCommunityString=sNMPCommunityString, tDMConfigurationMismatch=tDMConfigurationMismatch, licenseCountry=licenseCountry, sFPError=sFPError, remoteMACAddressLinked=remoteMACAddressLinked, configuration=configuration, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, sNTPServerTable=sNTPServerTable, remoteUnitNameLinked=remoteUnitNameLinked, wirelessOutEthernetOctets=wirelessOutEthernetOctets, mainPSUPortAllocation=mainPSUPortAllocation, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, ethernetPriorityTable=ethernetPriorityTable, tdmTableEntry=tdmTableEntry, useVLANForMABProtocol=useVLANForMABProtocol, transmitModulationModeLinked=transmitModulationModeLinked, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, packetsToInternalStack=packetsToInternalStack, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, authorizationMethod=authorizationMethod, cambium=cambium, phyInstancedStatusTable=phyInstancedStatusTable, userTable=userTable, l2CPPriorityTable=l2CPPriorityTable, linkSymmetry=linkSymmetry, licenseSFPPortSupport=licenseSFPPortSupport, cableDiagnosticsControl=cableDiagnosticsControl, auxPortDisabledWarning=auxPortDisabledWarning, linkModeOptimization=linkModeOptimization, aggregateDataRateLinked=aggregateDataRateLinked, cableLoss=cableLoss, ptpCompliance=ptpCompliance, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, tDMChannelLoopback=tDMChannelLoopback, auxPortSSMTx=auxPortSSMTx, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, routerProtocolsGroup=routerProtocolsGroup, smtp=smtp, tDMGroup=tDMGroup, userPassword=userPassword, byteErrorRatioLinked=byteErrorRatioLinked, lowestDataModulationMode=lowestDataModulationMode, ethernetInstancedTableIndex=ethernetInstancedTableIndex, unitIdentification=unitIdentification, tDDSynchronizationStatus=tDDSynchronizationStatus, versions=versions, dNSServerTableIndex=dNSServerTableIndex, sNTPServerTableNumber=sNTPServerTableNumber, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, licenseSecurityLevel=licenseSecurityLevel, wirelessOutOctets=wirelessOutOctets, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, receiveModulationModeDetail=receiveModulationModeDetail, managementGroup=managementGroup, dfs=dfs, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, ptpTraps=ptpTraps, lbtDetectedTrap=lbtDetectedTrap, remoteInternetAddressType=remoteInternetAddressType, syslogControl=syslogControl, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, antennaSelection=antennaSelection, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, sNTPPrimaryServer=sNTPPrimaryServer, softwareVersion=softwareVersion, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, iPv6Address=iPv6Address, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, qOSPriorityScheme=qOSPriorityScheme, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, sNTPServerPortNumber=sNTPServerPortNumber, sNTPServerTimeout=sNTPServerTimeout, tDMInterfaceControl=tDMInterfaceControl, systemClock=systemClock, secureModeAlarmTrap=secureModeAlarmTrap, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, dfsPeaks=dfsPeaks, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, tdmTable=tdmTable, tDM=tDM, transmitFreqMHz=transmitFreqMHz, channelChangeTrap=channelChangeTrap, aggregateDataRate=aggregateDataRate, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, transmitDataRateLinked=transmitDataRateLinked, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, installStatusLinked=installStatusLinked, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, channelBandwidth=channelBandwidth, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, sNTPState=sNTPState, sNMPTrapInternetAddress=sNMPTrapInternetAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPServerInternetAddress=tFTPServerInternetAddress, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, lowestTDMModulationMode=lowestTDMModulationMode, mgmtInstancedTableNumber=mgmtInstancedTableNumber, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, deviceMSN=deviceMSN, ethernet=ethernet, notificationsGroup=notificationsGroup, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, receiveModulationModeLinked=receiveModulationModeLinked, tDMChannelLineCode=tDMChannelLineCode, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, mainPSUPortStatusTrap=mainPSUPortStatusTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, transmitPower=transmitPower, tFTPServerInternetAddressType=tFTPServerInternetAddressType, wirelessTopology=wirelessTopology, configurationInstancedTableEntry=configurationInstancedTableEntry, dfsTableIndex=dfsTableIndex, eIRP=eIRP, nIDULanPortStatus=nIDULanPortStatus, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, remoteUnitName=remoteUnitName, vLANManagementVID=vLANManagementVID, sNMPv3Enable=sNMPv3Enable, hardwareVersion=hardwareVersion, secondarySoftwareVersion=secondarySoftwareVersion, targetMACAddress=targetMACAddress, mABState=mABState, unavailableSeconds=unavailableSeconds, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, daylightSaving=daylightSaving, sMTPServerInternetAddress=sMTPServerInternetAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, ethernetStatisticsTable=ethernetStatisticsTable, licenseGasGroup=licenseGasGroup, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, targetRange=targetRange, licenseInstancedTableEntry=licenseInstancedTableEntry, ethernetInstancedTableEntry=ethernetInstancedTableEntry, sMTPSourceEmailAddress=sMTPSourceEmailAddress, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, remoteInternetAddress=remoteInternetAddress, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, linkLoss=linkLoss, dNSServerPortNumber=dNSServerPortNumber, iPv6GatewayAddress=iPv6GatewayAddress, licenseSyncESupport=licenseSyncESupport, sMTPEnabledMessages=sMTPEnabledMessages, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sFPPortSyncERxStatus=sFPPortSyncERxStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sMTPServerPortNumber=sMTPServerPortNumber, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, siteName=siteName, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, licenseGroupAccess=licenseGroupAccess, iPVersion=iPVersion, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sMTPServerInternetAddressType=sMTPServerInternetAddressType, useVLANForManagementInterfaces=useVLANForManagementInterfaces, frequencyVariant=frequencyVariant, alarmInstancedTableIndex=alarmInstancedTableIndex, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, rxColorCode=rxColorCode, licenseInstancedTable=licenseInstancedTable, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, cableDiagnosticsWarning=cableDiagnosticsWarning, maximumNumberOfSlaves=maximumNumberOfSlaves, cableDiagPair3Distance=cableDiagPair3Distance, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, ptpTrapPrefix=ptpTrapPrefix, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, auxPortStatusTrap=auxPortStatusTrap, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, supplementary=supplementary, mainPSUPortQLRx=mainPSUPortQLRx, iPDSCPPriorityTable=iPDSCPPriorityTable, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, pubInstancedStatsTable=pubInstancedStatsTable, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, txColorCode=txColorCode, dSCPManagementPriority=dSCPManagementPriority, remoteMaximumTransmitPower=remoteMaximumTransmitPower, PYSNMP_MODULE_ID=cambium, mABProtocolVID=mABProtocolVID, sNMPTrapVersion=sNMPTrapVersion, sFPPortDisabledWarning=sFPPortDisabledWarning, hTTPSAccessEnabled=hTTPSAccessEnabled, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, management=management, receivePowerLinked=receivePowerLinked, transparentClockPort=transparentClockPort, phyControlInstancedTable=phyControlInstancedTable, wirelessOutAllOctets=wirelessOutAllOctets, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, alarmInstancedTableNumber=alarmInstancedTableNumber, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, dNSServerInternetAddressType=dNSServerInternetAddressType, enabledDiagnosticAlarms=enabledDiagnosticAlarms, apc=apc, capacityVariantMismatch=capacityVariantMismatch, cableDiagnosticsPorts=cableDiagnosticsPorts, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, hTTPAccessEnabled=hTTPAccessEnabled, maximumTransmitPower=maximumTransmitPower)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, dataPortPauseFrames=dataPortPauseFrames, phyControlInstancedTableNumber=phyControlInstancedTableNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, resetGroup=resetGroup, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, subnetMask=subnetMask, telnetAccessEnabled=telnetAccessEnabled, sNTPServerInternetAddressType=sNTPServerInternetAddressType, authorizationControlTableIndex=authorizationControlTableIndex, deviceESN=deviceESN, extendedSpectrumScanning=extendedSpectrumScanning, cableDiagPair3Results=cableDiagPair3Results, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, sFPPortAutoMdix=sFPPortAutoMdix, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, tDDControl=tDDControl, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, cableDiagPair2Distance=cableDiagPair2Distance, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, linkLossLinked=linkLossLinked, sNMPTrapTableEntry=sNMPTrapTableEntry, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, wirelessLinkAvailability=wirelessLinkAvailability, systemReset=systemReset, productVariant=productVariant, dfsMeans=dfsMeans, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNTPServerTableIndex=sNTPServerTableIndex, linkName=linkName, dNSPrimaryServer=dNSPrimaryServer, bridge=bridge, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, dNSServerInternetAddress=dNSServerInternetAddress, rawReceivePowerLinked=rawReceivePowerLinked, sNTPSyncTrap=sNTPSyncTrap, txMABFrames=txMABFrames, nIDULanPortAutoMdix=nIDULanPortAutoMdix, tDMInterfaceStatus=tDMInterfaceStatus, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, remoteInternetAddressLinked=remoteInternetAddressLinked, secureModeAlarm=secureModeAlarm, sNTPPollInterval=sNTPPollInterval, packetsFromInternalStack=packetsFromInternalStack, aAAControl=aAAControl, dfsGroup=dfsGroup, masterSlaveMode=masterSlaveMode, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, licenseCapacity=licenseCapacity, encryptionAlgorithm=encryptionAlgorithm, licenseMaxLinkRange=licenseMaxLinkRange, tFTPClient=tFTPClient, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, sFPErrorTrap=sFPErrorTrap, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, pubStats=pubStats, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, antennaGain=antennaGain, alarmInstancedTable=alarmInstancedTable, sNTPServerStatus=sNTPServerStatus, syslogControlGroup=syslogControlGroup, auxPortAcceptedQLRx=auxPortAcceptedQLRx, groupID=groupID, authorizationControl=authorizationControl, mABNominalModulationMode=mABNominalModulationMode, remoteMACAddress=remoteMACAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, licenseHCMPSupport=licenseHCMPSupport, managementNetworkAccessEnabled=managementNetworkAccessEnabled, dNSResolver=dNSResolver, ethernetStatisticsDataSource=ethernetStatisticsDataSource, accessMethod=accessMethod, mPLSTCPriorityTable=mPLSTCPriorityTable, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, cableDiagPair4Distance=cableDiagPair4Distance, syncESlavePort=syncESlavePort, unitIdentificationGroup=unitIdentificationGroup, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, blacklistRMEnabled=blacklistRMEnabled, dNSGroup=dNSGroup, tDMChannelStatus=tDMChannelStatus, ethernetPriorityTableNumber=ethernetPriorityTableNumber, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, wirelessLinkStatus=wirelessLinkStatus, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, auxPortAllocation=auxPortAllocation, mgmtInstancedTableEntry=mgmtInstancedTableEntry, rangingMode=rangingMode, phyControl=phyControl, receiveDataRate=receiveDataRate, tDMChannelStatusTrap=tDMChannelStatusTrap, dfsTableEntry=dfsTableEntry, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, dNS=dNS, enableTransmission=enableTransmission, pubStatsGroup=pubStatsGroup, sNMPTrapTable=sNMPTrapTable, iPv6PrefixLength=iPv6PrefixLength, longitude=longitude, rangeLinked=rangeLinked, ethernetGroup=ethernetGroup, sNTPLastSync=sNTPLastSync, tDMChannelCableLength=tDMChannelCableLength, hTTPPortNumber=hTTPPortNumber, auxPortStatus=auxPortStatus, installStatus=installStatus, dataBridgingStatusLinked=dataBridgingStatusLinked, alarms=alarms, configurationInstancedTableNumber=configurationInstancedTableNumber, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, severelyErroredSeconds=severelyErroredSeconds, tDDControlGroup=tDDControlGroup, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, transparentClockVID=transparentClockVID, sNMPTrapPortNumber=sNMPTrapPortNumber, whitelistRMEnabled=whitelistRMEnabled, cableDiagnostics=cableDiagnostics, auxPortQLRx=auxPortQLRx, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, byteErrorRatio=byteErrorRatio, licenseIEEE1588Support=licenseIEEE1588Support, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, encryptionGroup=encryptionGroup, capacityVariantMismatchLinked=capacityVariantMismatchLinked, timeZone=timeZone, transparentClock=transparentClock, syncETrackingState=syncETrackingState, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, managementPortWirelessDownAlert=managementPortWirelessDownAlert, dfsTable=dfsTable, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, phyStatus=phyStatus, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, cableDiagPair1Distance=cableDiagPair1Distance, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, telnetPortNumber=telnetPortNumber, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, licenseOOBManagementSupport=licenseOOBManagementSupport, hCMPLinkSymmetry=hCMPLinkSymmetry, phyStatusGroup=phyStatusGroup, tDDSynchronizationMode=tDDSynchronizationMode, sFPPortQLTx=sFPPortQLTx, blacklistRMMacAddress=blacklistRMMacAddress, bridgeGroup=bridgeGroup, syncEEquipmentClock=syncEEquipmentClock, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, licenseEncryption=licenseEncryption, authorizationControlTable=authorizationControlTable, subbandHighestFrequency=subbandHighestFrequency, authorizationControlGroup=authorizationControlGroup, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, sFPPortAutoNegotiation=sFPPortAutoNegotiation, auxPortSyncERxStatus=auxPortSyncERxStatus, range=range, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, alarmInstancedTableEntry=alarmInstancedTableEntry, receiveModulationMode=receiveModulationMode, productName=productName, sNMPTrapTableIndex=sNMPTrapTableIndex, syslogStateTrap=syslogStateTrap, licenseBandwidthCap=licenseBandwidthCap, searchState=searchState, sNMPPortNumber=sNMPPortNumber, receiveChannel=receiveChannel, vectorErrorLinked=vectorErrorLinked, dNSServerTableEntry=dNSServerTableEntry, ptp670=ptp670, vectorError=vectorError, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, licenseIPv6Support=licenseIPv6Support, cableDiagPair1Results=cableDiagPair1Results, portAllocationMismatch=portAllocationMismatch, regulatoryBand=regulatoryBand, dataBridgingStatus=dataBridgingStatus, portAllocationMismatchTrap=portAllocationMismatchTrap, cableDiagnosticsResultTable=cableDiagnosticsResultTable, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, receivePower=receivePower, licenseRegulatoryBandsList=licenseRegulatoryBandsList, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, ptmp=ptmp, license=license, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, installStatusTrap=installStatusTrap, sntp=sntp, sNTPServerRetries=sNTPServerRetries, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, transmitFreqKHz=transmitFreqKHz, sNTPSync=sNTPSync, ethernetInstancedTableNumber=ethernetInstancedTableNumber, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, mABTransmissionInterval=mABTransmissionInterval, versionsGroup=versionsGroup, incompatibleRegulatoryBands=incompatibleRegulatoryBands, syslogClient=syslogClient, licenseIssueNumber=licenseIssueNumber, apcGroup=apcGroup, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, sFPPortStatusTrap=sFPPortStatusTrap, signalStrengthRatio=signalStrengthRatio, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, snmpControl=snmpControl, syslogLocalWrappedTrap=syslogLocalWrappedTrap, whitelistRMMacAddress=whitelistRMMacAddress, mainPSUPortStatus=mainPSUPortStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, syslogClientTrap=syslogClientTrap, encryption=encryption, dataBridgingStatusAlarm=dataBridgingStatusAlarm, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, aAAControlGroup=aAAControlGroup, l2CPPriorityTableIndex=l2CPPriorityTableIndex, mgmtInstancedTableIndex=mgmtInstancedTableIndex, configurationInstancedTableIndex=configurationInstancedTableIndex, authorizationControlTableEntry=authorizationControlTableEntry, linkModeOptimizationMismatch=linkModeOptimizationMismatch, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, ethernetInstancedTable=ethernetInstancedTable, mgmtInstancedTable=mgmtInstancedTable, licenseUnitSerialNumber=licenseUnitSerialNumber, ptpGroups=ptpGroups, auxPortQLTx=auxPortQLTx, tdmTableNumber=tdmTableNumber, mainPSUPortAutoMdix=mainPSUPortAutoMdix, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, transmitModulationMode=transmitModulationMode, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, transparentClockVLAN=transparentClockVLAN, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, dfsTableNumber=dfsTableNumber, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, sFPPortSSMTx=sFPPortSSMTx, latitude=latitude, tDMEnabledChannels=tDMEnabledChannels, gatewayIPAddress=gatewayIPAddress, wirelessLinkStatusLinked=wirelessLinkStatusLinked, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, mABMaintenanceLevel=mABMaintenanceLevel, rawReceivePower=rawReceivePower, regulatoryBandTrap=regulatoryBandTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, maxLinkRangeExceeded=maxLinkRangeExceeded, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, receiveDataRateLinked=receiveDataRateLinked, tdmTableIndex=tdmTableIndex, sFPPortStatus=sFPPortStatus, receiveFreqKHz=receiveFreqKHz, localPacketFiltering=localPacketFiltering, capacityVariantMismatchTrap=capacityVariantMismatchTrap, configurationInstancedTable=configurationInstancedTable, ethernetPriorityTableEntry=ethernetPriorityTableEntry, licenseVersion=licenseVersion, unitName=unitName, sFPPortAllocation=sFPPortAllocation, syslogState=syslogState, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, transmitPowerLinked=transmitPowerLinked, installArmStateTrap=installArmStateTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, installationMode=installationMode, transmitChannel=transmitChannel, cableDiagnosticsGroup=cableDiagnosticsGroup, sFPPortQLRx=sFPPortQLRx, authorizationControlTableNumber=authorizationControlTableNumber, subbandLowestFrequency=subbandLowestFrequency, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, sNMPEnabledTraps=sNMPEnabledTraps, oOBPriorityQueueMapping=oOBPriorityQueueMapping, mABNominalTransmitCapacity=mABNominalTransmitCapacity, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, licenseGroup=licenseGroup, licenseTDDSyncSupport=licenseTDDSyncSupport, cableDiagPair4Results=cableDiagPair4Results, altitude=altitude, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, bootVersion=bootVersion, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, routerProtocols=routerProtocols, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, userTableEntry=userTableEntry, portAllocationMismatchLinked=portAllocationMismatchLinked, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, hCMPMaximumLinkRange=hCMPMaximumLinkRange, mainPSUPortSSMTx=mainPSUPortSSMTx, smtpGroup=smtpGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, signalStrengthRatioLinked=signalStrengthRatioLinked, licenseTrialPeriod=licenseTrialPeriod, iPv4Address=iPv4Address, dNSServerTableNumber=dNSServerTableNumber, phyControlGroup=phyControlGroup, sNTPServerTableEntry=sNTPServerTableEntry, mABHoldoffPeriod=mABHoldoffPeriod, reset=reset, erroredSeconds=erroredSeconds, phyControlInstancedTableEntry=phyControlInstancedTableEntry)
