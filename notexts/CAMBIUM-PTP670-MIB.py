...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, tDDSynchronizationAlarm=tDDSynchronizationAlarm, phyStatus=phyStatus, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, remoteInternetAddressLinked=remoteInternetAddressLinked, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, maximumTransmitPower=maximumTransmitPower, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, tDMEnabledChannels=tDMEnabledChannels, ptp=ptp, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, smtpGroup=smtpGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapPortNumber=sNMPTrapPortNumber, receiveFreqKHz=receiveFreqKHz, apcGroup=apcGroup, tDMChannelStatusTrap=tDMChannelStatusTrap, hTTPAccessEnabled=hTTPAccessEnabled, linkLossLinked=linkLossLinked, smtp=smtp, iPv4Address=iPv4Address, receivePower=receivePower, syslogControlGroup=syslogControlGroup, receiveFreqMHz=receiveFreqMHz, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, wirelessLinkAvailability=wirelessLinkAvailability, frequencyVariant=frequencyVariant, enableTransmission=enableTransmission, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, sFPPortStatusTrap=sFPPortStatusTrap, dSCPManagementPriority=dSCPManagementPriority, transmitDataRateLinked=transmitDataRateLinked, phyControlInstancedTableNumber=phyControlInstancedTableNumber, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, iPDSCPPriorityTable=iPDSCPPriorityTable, sMTPServerPortNumber=sMTPServerPortNumber, sNTPServerPortNumber=sNTPServerPortNumber, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, dfsTableIndex=dfsTableIndex, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, dataPortPauseFrames=dataPortPauseFrames, licenseVersion=licenseVersion, licenseGasGroup=licenseGasGroup, encryptionAlgorithm=encryptionAlgorithm, tDDControl=tDDControl, userTableEntry=userTableEntry, dNSServerInternetAddressType=dNSServerInternetAddressType, dataBridgingStatusLinked=dataBridgingStatusLinked, dfsGroup=dfsGroup, routerProtocolsGroup=routerProtocolsGroup, receiveModulationModeDetail=receiveModulationModeDetail, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, tempPcb=tempPcb, iPVersion=iPVersion, mainPSUPortQLRx=mainPSUPortQLRx, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, cableDiagPair3Results=cableDiagPair3Results, management=management, sNTPServerStatus=sNTPServerStatus, tDMChannelCableLength=tDMChannelCableLength, transmitModulationModeLinked=transmitModulationModeLinked, cambium=cambium, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNTPServerTimeout=sNTPServerTimeout, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, licenseOOBManagementSupport=licenseOOBManagementSupport, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, phyControl=phyControl, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, configurationGroup=configurationGroup, wirelessOutOctets=wirelessOutOctets, configurationInstancedTableIndex=configurationInstancedTableIndex, lbtDetectedTrap=lbtDetectedTrap, sntp=sntp, cableDiagnosticsControl=cableDiagnosticsControl, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, resetGroup=resetGroup, aAAControlGroup=aAAControlGroup, lowestTDMModulationMode=lowestTDMModulationMode, sNTPLastSync=sNTPLastSync, tDMChannelStatus=tDMChannelStatus, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, pubStats=pubStats, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, dNSServerTable=dNSServerTable, capacityVariantMismatch=capacityVariantMismatch, cableDiagPair1Results=cableDiagPair1Results, regulatoryBandTrap=regulatoryBandTrap, syslogStateTrap=syslogStateTrap, nIDULanPortStatus=nIDULanPortStatus, licenseTLSRekey=licenseTLSRekey, ethernetPriorityTableIndex=ethernetPriorityTableIndex, whitelistRMEnabled=whitelistRMEnabled, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, remoteMaximumTransmitPower=remoteMaximumTransmitPower, alarmInstancedTableEntry=alarmInstancedTableEntry, l2CPPriorityTableNumber=l2CPPriorityTableNumber, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, ethernetInstancedTableNumber=ethernetInstancedTableNumber, sNTPPollInterval=sNTPPollInterval, hTTPPortNumber=hTTPPortNumber, userEnabled=userEnabled, authorizationControlTableEntry=authorizationControlTableEntry, antennaGain=antennaGain, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, accessMethod=accessMethod, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, vLANManagementPriority=vLANManagementPriority, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, useVLANForMABProtocol=useVLANForMABProtocol, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, masterSlaveMode=masterSlaveMode, notificationsGroup=notificationsGroup, mABProtocolVID=mABProtocolVID, mABHoldoffPeriod=mABHoldoffPeriod, alarmInstancedTableIndex=alarmInstancedTableIndex, transmitModulationMode=transmitModulationMode, ptpTrapPrefix=ptpTrapPrefix, wirelessOutEthernetOctets=wirelessOutEthernetOctets, licenseInstancedTable=licenseInstancedTable, syncETracking=syncETracking, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, ethernetStatisticsTable=ethernetStatisticsTable, alarmInstancedTableNumber=alarmInstancedTableNumber, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, incompatibleRegulatoryBands=incompatibleRegulatoryBands, iPv6PrefixLength=iPv6PrefixLength, l2CPPriorityTableIndex=l2CPPriorityTableIndex, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, configurationInstancedTableNumber=configurationInstancedTableNumber, cableDiagnosticsGroup=cableDiagnosticsGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, latitude=latitude, sNMPEnabledTraps=sNMPEnabledTraps, bootVersion=bootVersion, userTable=userTable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, auxPortSyncERxStatus=auxPortSyncERxStatus, pubInstancedStatsTable=pubInstancedStatsTable, unitName=unitName, mainPSUPortAutoMdix=mainPSUPortAutoMdix, targetRange=targetRange, unavailableSeconds=unavailableSeconds, cableDiagPair2Distance=cableDiagPair2Distance, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, sFPPortAutoNegotiation=sFPPortAutoNegotiation, licenseSecurityLevel=licenseSecurityLevel, ethernetInstancedTable=ethernetInstancedTable, tFTPClient=tFTPClient, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, supplementaryGroup=supplementaryGroup, l2CPPriorityTableEntry=l2CPPriorityTableEntry, linkModeOptimization=linkModeOptimization, alarms=alarms, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, auxPortQLRx=auxPortQLRx, searchStateLinked=searchStateLinked, sNMPTrapVersion=sNMPTrapVersion, siteName=siteName, authorizationControl=authorizationControl, remoteInternetAddress=remoteInternetAddress, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, ptpTraps=ptpTraps, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, searchState=searchState, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, managementGroup=managementGroup, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, subbandLowestFrequency=subbandLowestFrequency, supplementary=supplementary, productVariant=productVariant, auxPortAcceptedQLRx=auxPortAcceptedQLRx, mainPSUPortSSMTx=mainPSUPortSSMTx, auxPortStatusTrap=auxPortStatusTrap, sMTPEmailAlert=sMTPEmailAlert, userTableNumber=userTableNumber, mainPSUPortStatusTrap=mainPSUPortStatusTrap, encryption=encryption, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, authorizationControlTableIndex=authorizationControlTableIndex, dNSServerPortNumber=dNSServerPortNumber, receiveModulationModeLinked=receiveModulationModeLinked, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, licenseInstancedTableEntry=licenseInstancedTableEntry, signalStrengthRatio=signalStrengthRatio, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, sNMPv3Enable=sNMPv3Enable, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, systemClock=systemClock, byteErrorRatio=byteErrorRatio, packetsFromInternalStack=packetsFromInternalStack, nIDULanPortAutoMdix=nIDULanPortAutoMdix, dfsPeaks=dfsPeaks, bridgeGroup=bridgeGroup, sFPPortAutoMdix=sFPPortAutoMdix, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, transmitDataRate=transmitDataRate, versionsGroup=versionsGroup, sFPPortSSMTx=sFPPortSSMTx, transmitFreqMHz=transmitFreqMHz, licenseIPv6Support=licenseIPv6Support, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, licenseGroupAccess=licenseGroupAccess, sNTPSyncTrap=sNTPSyncTrap, sNTPServerTable=sNTPServerTable, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, auxPortConfigurationMismatch=auxPortConfigurationMismatch, iPv6Address=iPv6Address, softwareVersion=softwareVersion, tDDSynchronizationMode=tDDSynchronizationMode, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, ethernetStatisticsDataSource=ethernetStatisticsDataSource, linkSymmetry=linkSymmetry, aAAControl=aAAControl, unitIdentificationGroup=unitIdentificationGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, receiveModulationMode=receiveModulationMode, phyControlGroup=phyControlGroup, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, hardwareVersion=hardwareVersion, managementNetworkAccessEnabled=managementNetworkAccessEnabled, licenseInstancedTableIndex=licenseInstancedTableIndex, installStatusTrap=installStatusTrap, dataBridgingStatus=dataBridgingStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, maxLinkRangeExceeded=maxLinkRangeExceeded, tFTPServerInternetAddress=tFTPServerInternetAddress, channelBandwidth=channelBandwidth, sNTPServerTableNumber=sNTPServerTableNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, dNSPrimaryServer=dNSPrimaryServer, auxPortStatus=auxPortStatus, systemReset=systemReset, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, remoteUnitNameLinked=remoteUnitNameLinked, mainPSUPortQLTx=mainPSUPortQLTx, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, licenseCapacity=licenseCapacity, subnetMask=subnetMask, byteErrorRatioLinked=byteErrorRatioLinked)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, installArmStateTrap=installArmStateTrap, phyControlInstancedTableIndex=phyControlInstancedTableIndex, tdmTableIndex=tdmTableIndex, installArmState=installArmState, transmitChannel=transmitChannel, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, sMTPSourceEmailAddress=sMTPSourceEmailAddress, subbandHighestFrequency=subbandHighestFrequency, ethernetPriorityTable=ethernetPriorityTable, productName=productName, dataBridgingStatusAlarm=dataBridgingStatusAlarm, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, tFTPServerPortNumber=tFTPServerPortNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, deviceESN=deviceESN, linkName=linkName, portAllocationMismatch=portAllocationMismatch, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, licenseUnitSerialNumber=licenseUnitSerialNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, dfs=dfs, ptpGroups=ptpGroups, rxColorCode=rxColorCode, ethernetPriorityTableNumber=ethernetPriorityTableNumber, licenseSFPPortSupport=licenseSFPPortSupport, sFPError=sFPError, licenseSyncESupport=licenseSyncESupport, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, userTableIndex=userTableIndex, syslogControl=syslogControl, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, licenseBandwidthCap=licenseBandwidthCap, capacityVariantMismatchLinked=capacityVariantMismatchLinked, mABProtocolVLANPriority=mABProtocolVLANPriority, sNTPSync=sNTPSync, telnetAccessEnabled=telnetAccessEnabled, sNMPTrapTableEntry=sNMPTrapTableEntry, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, useVLANForManagementInterfaces=useVLANForManagementInterfaces, auxPortQLTx=auxPortQLTx, mABMaintenanceLevel=mABMaintenanceLevel, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, wirelessTopology=wirelessTopology, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, dNSResolver=dNSResolver, licenseIEEE1588Support=licenseIEEE1588Support, hTTPSPortNumber=hTTPSPortNumber, routerProtocols=routerProtocols, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tDMGroup=tDMGroup, rangeLinked=rangeLinked, mABNominalModulationMode=mABNominalModulationMode, syslogClientTrap=syslogClientTrap, blacklistRMMacAddress=blacklistRMMacAddress, dfsMeans=dfsMeans, installStatus=installStatus, localPacketFiltering=localPacketFiltering, receiveDataRateLinked=receiveDataRateLinked, portAllocationMismatchTrap=portAllocationMismatchTrap, deviceMACAddress=deviceMACAddress, remoteInternetAddressType=remoteInternetAddressType, tDMChannelLoopback=tDMChannelLoopback, eIRP=eIRP, blacklistRMEnabled=blacklistRMEnabled, aggregateDataRate=aggregateDataRate, cableDiagPair3Distance=cableDiagPair3Distance, licenseCountry=licenseCountry, tdmTableEntry=tdmTableEntry, bridge=bridge, aggregateDataRateLinked=aggregateDataRateLinked, hCMPMaximumLinkRange=hCMPMaximumLinkRange, packetsToInternalStack=packetsToInternalStack, linkLoss=linkLoss, erroredSeconds=erroredSeconds, severelyErroredSeconds=severelyErroredSeconds, configurationInstancedTable=configurationInstancedTable, tDM=tDM, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, cableDiagnosticsResultTable=cableDiagnosticsResultTable, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, maximumNumberOfSlaves=maximumNumberOfSlaves, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, capacityVariantMismatchTrap=capacityVariantMismatchTrap, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, ptmp=ptmp, configuration=configuration, sFPPortStatus=sFPPortStatus, sNTPState=sNTPState, pubStatsGroup=pubStatsGroup, wirelessOutAllOctets=wirelessOutAllOctets, dfsTableNumber=dfsTableNumber, licenseMaxLinkRange=licenseMaxLinkRange, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, longitude=longitude, sFPErrorTrap=sFPErrorTrap, remoteUnitName=remoteUnitName, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, dNS=dNS, secondarySoftwareVersion=secondarySoftwareVersion, vectorErrorLinked=vectorErrorLinked, cableDiagPair2Results=cableDiagPair2Results, versions=versions, installStatusLinked=installStatusLinked, rangingMode=rangingMode, tDDSynchronizationStatus=tDDSynchronizationStatus, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, userName=userName, l2CPPriorityTable=l2CPPriorityTable, dNSServerInternetAddress=dNSServerInternetAddress, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sFPPortAllocation=sFPPortAllocation, timeZone=timeZone, mABState=mABState, secureModeAlarm=secureModeAlarm, tFTPServerInternetAddressType=tFTPServerInternetAddressType, mgmtInstancedTableIndex=mgmtInstancedTableIndex, sNTPServerTableEntry=sNTPServerTableEntry, authorizationControlGroup=authorizationControlGroup, remoteMACAddress=remoteMACAddress, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, alarmInstancedTable=alarmInstancedTable, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, channelChangeTrap=channelChangeTrap, transparentClockVID=transparentClockVID, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, cableDiagPair4Distance=cableDiagPair4Distance, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, phyControlInstancedTable=phyControlInstancedTable, lowestDataModulationMode=lowestDataModulationMode, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, mABTransmissionInterval=mABTransmissionInterval, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPServerInternetAddress=sNTPServerInternetAddress, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, licenseTDDSyncSupport=licenseTDDSyncSupport, sNMPCommunityString=sNMPCommunityString, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, daylightSaving=daylightSaving, wirelessLinkStatusLinked=wirelessLinkStatusLinked, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, phyControlInstancedTableEntry=phyControlInstancedTableEntry, groupID=groupID, syncESlavePort=syncESlavePort, oOBPriorityQueueMapping=oOBPriorityQueueMapping, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, rawReceivePower=rawReceivePower, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, userRole=userRole, sNTPServerTableIndex=sNTPServerTableIndex, mABNominalTransmitCapacity=mABNominalTransmitCapacity, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, receivePowerLinked=receivePowerLinked, snmpControl=snmpControl, sNTPServerInternetAddressType=sNTPServerInternetAddressType, authorizationControlTableNumber=authorizationControlTableNumber, mPLSTCPriorityTable=mPLSTCPriorityTable, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, mainPSUPortStatus=mainPSUPortStatus, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, authorizationControlTable=authorizationControlTable, transparentClock=transparentClock, sntpGroup=sntpGroup, receiveDataRate=receiveDataRate, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, licenseTrialPeriod=licenseTrialPeriod, syncEEquipmentClock=syncEEquipmentClock, cableDiagPair1Distance=cableDiagPair1Distance, cableDiagnosticsWarning=cableDiagnosticsWarning, sMTPEnabledMessages=sMTPEnabledMessages, tDDControlGroup=tDDControlGroup, qOSPriorityScheme=qOSPriorityScheme, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, vLANManagementVID=vLANManagementVID, secureModeAlarmTrap=secureModeAlarmTrap, dataBridgingAvailability=dataBridgingAvailability, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, cableDiagPair4Results=cableDiagPair4Results, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, sNMPPortNumber=sNMPPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, mgmtInstancedTable=mgmtInstancedTable, syslogState=syslogState, transparentClockPort=transparentClockPort, sFPPortQLTx=sFPPortQLTx, ethernetGroup=ethernetGroup, phyInstancedStatusTable=phyInstancedStatusTable, dNSServerTableEntry=dNSServerTableEntry, sNTPServerRetries=sNTPServerRetries, licenseGroup=licenseGroup, managementPortWirelessDownAlert=managementPortWirelessDownAlert, targetMACAddress=targetMACAddress, authorizationMethod=authorizationMethod, apc=apc, mgmtInstancedTableEntry=mgmtInstancedTableEntry, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, licenseRARSupport=licenseRARSupport, nIDULanPortStatusTrap=nIDULanPortStatusTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, licenseInstancedTableNumber=licenseInstancedTableNumber, userPassword=userPassword, antennaSelection=antennaSelection, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, receiveChannel=receiveChannel, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, cableDiagnostics=cableDiagnostics, tdmTableNumber=tdmTableNumber, mgmtInstancedTableNumber=mgmtInstancedTableNumber, txColorCode=txColorCode, linkModeOptimizationMismatch=linkModeOptimizationMismatch, unitOutOfCalibration=unitOutOfCalibration, rawReceivePowerLinked=rawReceivePowerLinked, ptp670=ptp670, PYSNMP_MODULE_ID=cambium, transparentClockVLAN=transparentClockVLAN, unitIdentification=unitIdentification, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, ethernetInstancedTableIndex=ethernetInstancedTableIndex, alarmsGroup=alarmsGroup, hCMPLinkSymmetry=hCMPLinkSymmetry, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, dfsTableEntry=dfsTableEntry, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, dNSServerTableNumber=dNSServerTableNumber, transmitFreqKHz=transmitFreqKHz, auxPortDisabledWarning=auxPortDisabledWarning, sFPPortQLRx=sFPPortQLRx, vectorError=vectorError, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, sNMPTrapTable=sNMPTrapTable, sFPPortDisabledWarning=sFPPortDisabledWarning, ethernet=ethernet, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tdmTable=tdmTable, whitelistRMMacAddress=whitelistRMMacAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, transmitPowerLinked=transmitPowerLinked, cableLoss=cableLoss)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", mainPSUPortAllocation=mainPSUPortAllocation, sFPPortSyncERxStatus=sFPPortSyncERxStatus, licenseRegulatoryBandsList=licenseRegulatoryBandsList, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, reset=reset, syncETrackingState=syncETrackingState, dNSGroup=dNSGroup, portAllocationMismatchLinked=portAllocationMismatchLinked, sMTPServerInternetAddressType=sMTPServerInternetAddressType, licenseHCMPSupport=licenseHCMPSupport, deviceMSN=deviceMSN, signalStrengthRatioLinked=signalStrengthRatioLinked, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, syslogClient=syslogClient, encryptionGroup=encryptionGroup, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, licenseEncryption=licenseEncryption, auxPortAllocation=auxPortAllocation, dfsTable=dfsTable, licenseIssueNumber=licenseIssueNumber, extendedSpectrumScanning=extendedSpectrumScanning, tDMChannelLineCode=tDMChannelLineCode, configurationInstancedTableEntry=configurationInstancedTableEntry, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, txMABFrames=txMABFrames, license=license, altitude=altitude, phyStatusGroup=phyStatusGroup, ethernetPriorityTableEntry=ethernetPriorityTableEntry, tDMInterfaceControl=tDMInterfaceControl, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, transmitPower=transmitPower, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, tDMInterfaceStatus=tDMInterfaceStatus, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, auxPortSSMTx=auxPortSSMTx, sNTPPrimaryServer=sNTPPrimaryServer, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, range=range, gatewayIPAddress=gatewayIPAddress, ptpCompliance=ptpCompliance, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, installationMode=installationMode, wirelessLinkStatus=wirelessLinkStatus, ethernetInstancedTableEntry=ethernetInstancedTableEntry, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, snmpControlGroup=snmpControlGroup, remoteMACAddressLinked=remoteMACAddressLinked, cableDiagnosticsPorts=cableDiagnosticsPorts, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, dNSServerTableIndex=dNSServerTableIndex, transmitterChannels=transmitterChannels, iPv6GatewayAddress=iPv6GatewayAddress, tDMConfigurationMismatch=tDMConfigurationMismatch, telnetPortNumber=telnetPortNumber, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, regulatoryBand=regulatoryBand, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap)
