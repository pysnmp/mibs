...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Unsigned32, IpAddress, TimeTicks, Counter32, NotificationType, Gauge32, ObjectIdentity, ModuleIdentity, Counter64, iso, MibIdentifier, enterprises, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Unsigned32", "IpAddress", "TimeTicks", "Counter32", "NotificationType", "Gauge32", "ObjectIdentity", "ModuleIdentity", "Counter64", "iso", "MibIdentifier", "enterprises", "Integer32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", txMABFrames=txMABFrames, syncETracking=syncETracking, installationMode=installationMode, userName=userName, iPv6GatewayAddress=iPv6GatewayAddress, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, tDMChannelStatus=tDMChannelStatus, ptpGroups=ptpGroups, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, tDM=tDM, sNTPServerInternetAddressType=sNTPServerInternetAddressType, routerProtocolsGroup=routerProtocolsGroup, configurationInstancedTableIndex=configurationInstancedTableIndex, syslogLocalWrappedTrap=syslogLocalWrappedTrap, aggregateDataRateLinked=aggregateDataRateLinked, eIRP=eIRP, signalStrengthRatio=signalStrengthRatio, ptmp=ptmp, transmitDataRate=transmitDataRate, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, transparentClockPort=transparentClockPort, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sFPPortQLTx=sFPPortQLTx, sNTPServerStatus=sNTPServerStatus, portAllocationMismatch=portAllocationMismatch, bridgeGroup=bridgeGroup, phyControl=phyControl, deviceMACAddress=deviceMACAddress, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, dNSResolver=dNSResolver, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, transparentClockVID=transparentClockVID, antennaGain=antennaGain, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, receiveFreqMHz=receiveFreqMHz, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, targetRange=targetRange, ptpCompliance=ptpCompliance, unitName=unitName, capacityVariantMismatchTrap=capacityVariantMismatchTrap, configurationInstancedTableEntry=configurationInstancedTableEntry, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNTPLastSync=sNTPLastSync, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, ethernetPriorityTable=ethernetPriorityTable, userEnabled=userEnabled, dataPortPauseFrames=dataPortPauseFrames, dNSServerTableIndex=dNSServerTableIndex, nIDULanPortStatusTrap=nIDULanPortStatusTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, mABTransmissionInterval=mABTransmissionInterval, unitOutOfCalibration=unitOutOfCalibration, sFPError=sFPError, blacklistRMEnabled=blacklistRMEnabled, txColorCode=txColorCode, sFPPortDisabledWarning=sFPPortDisabledWarning, dfsTableIndex=dfsTableIndex, dfsTable=dfsTable, cableDiagPair1Results=cableDiagPair1Results, sMTPEnabledMessages=sMTPEnabledMessages, cableDiagnosticsGroup=cableDiagnosticsGroup, aAAControl=aAAControl, daylightSaving=daylightSaving, ptpTraps=ptpTraps, sntp=sntp, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, userPassword=userPassword, ethernetPriorityTableIndex=ethernetPriorityTableIndex, localPacketFiltering=localPacketFiltering, mainPSUPortStatus=mainPSUPortStatus, dNSServerTableEntry=dNSServerTableEntry, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, mABMaintenanceLevel=mABMaintenanceLevel, encryption=encryption, receiveModulationModeLinked=receiveModulationModeLinked, licenseTDDSyncSupport=licenseTDDSyncSupport, phyInstancedStatusTable=phyInstancedStatusTable, snmpControl=snmpControl, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, sNMPTrapTable=sNMPTrapTable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, syslogStateTrap=syslogStateTrap, phyStatus=phyStatus, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, phyControlInstancedTableNumber=phyControlInstancedTableNumber, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNMPPortNumber=sNMPPortNumber, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, mABProtocolVID=mABProtocolVID, pubStatsGroup=pubStatsGroup, altitude=altitude, managementNetworkAccessEnabled=managementNetworkAccessEnabled, hTTPPortNumber=hTTPPortNumber, wirelessTopology=wirelessTopology, sFPPortSSMTx=sFPPortSSMTx, deviceMSN=deviceMSN, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, receiveFreqKHz=receiveFreqKHz, vLANManagementVID=vLANManagementVID, auxPortStatus=auxPortStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, licenseTLSRekey=licenseTLSRekey, vLANManagementPriority=vLANManagementPriority, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, versionsGroup=versionsGroup, tFTPServerPortNumber=tFTPServerPortNumber, wirelessLinkStatus=wirelessLinkStatus, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, tDMChannelStatusTrap=tDMChannelStatusTrap, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, dfsPeaks=dfsPeaks, configuration=configuration, sNTPServerTable=sNTPServerTable, dNS=dNS, mainPSUPortQLRx=mainPSUPortQLRx, capacityVariantMismatch=capacityVariantMismatch, groupID=groupID, wirelessLinkStatusLinked=wirelessLinkStatusLinked, sMTPServerPortNumber=sMTPServerPortNumber, mABNominalTransmitCapacity=mABNominalTransmitCapacity, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, snmpControlGroup=snmpControlGroup, tDMInterfaceStatus=tDMInterfaceStatus, apcGroup=apcGroup, auxPortQLRx=auxPortQLRx, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, transmitPowerLinked=transmitPowerLinked, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPPrimaryServer=sNTPPrimaryServer, pubInstancedStatsTable=pubInstancedStatsTable, sNTPSync=sNTPSync, masterSlaveMode=masterSlaveMode, licenseUnitSerialNumber=licenseUnitSerialNumber, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, sFPPortStatus=sFPPortStatus, maxLinkRangeExceeded=maxLinkRangeExceeded, receivePowerLinked=receivePowerLinked, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, secureModeAlarmTrap=secureModeAlarmTrap, remoteInternetAddressType=remoteInternetAddressType, mgmtInstancedTableIndex=mgmtInstancedTableIndex, remoteInternetAddressLinked=remoteInternetAddressLinked, packetsToInternalStack=packetsToInternalStack, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, mABNominalModulationMode=mABNominalModulationMode, smtpGroup=smtpGroup, cableDiagnosticsResultTable=cableDiagnosticsResultTable, rxColorCode=rxColorCode, transmitDataRateLinked=transmitDataRateLinked, syslogState=syslogState, gatewayIPAddress=gatewayIPAddress, extendedSpectrumScanning=extendedSpectrumScanning, dNSServerTableNumber=dNSServerTableNumber, receivePower=receivePower, licenseBandwidthCap=licenseBandwidthCap, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, ethernetInstancedTable=ethernetInstancedTable, encryptionAlgorithm=encryptionAlgorithm, configurationInstancedTableNumber=configurationInstancedTableNumber, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, capacityVariantMismatchLinked=capacityVariantMismatchLinked, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, smtp=smtp, mPLSTCPriorityTable=mPLSTCPriorityTable, sNMPCommunityString=sNMPCommunityString, authorizationMethod=authorizationMethod, authorizationControlTableNumber=authorizationControlTableNumber, sntpGroup=sntpGroup, licenseInstancedTableEntry=licenseInstancedTableEntry, cableDiagPair2Results=cableDiagPair2Results, tFTPServerInternetAddress=tFTPServerInternetAddress, syslogClientTrap=syslogClientTrap, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, alarms=alarms, cableDiagPair2Distance=cableDiagPair2Distance, tDDSynchronizationStatus=tDDSynchronizationStatus, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, auxPortConfigurationMismatch=auxPortConfigurationMismatch, transmitterChannels=transmitterChannels, phyControlInstancedTableEntry=phyControlInstancedTableEntry, cableDiagPair4Results=cableDiagPair4Results, receiveDataRateLinked=receiveDataRateLinked, receiveChannel=receiveChannel, dfsGroup=dfsGroup, ethernetInstancedTableEntry=ethernetInstancedTableEntry, linkName=linkName, dataBridgingStatusLinked=dataBridgingStatusLinked, sNMPTrapTableEntry=sNMPTrapTableEntry, licenseCountry=licenseCountry, transmitChannel=transmitChannel, dNSServerPortNumber=dNSServerPortNumber, licenseIEEE1588Support=licenseIEEE1588Support, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, licenseRegulatoryBandsList=licenseRegulatoryBandsList, bridge=bridge, notificationsGroup=notificationsGroup, oOBPriorityQueueMapping=oOBPriorityQueueMapping, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, authorizationControlGroup=authorizationControlGroup, tempPcb=tempPcb, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, ptp=ptp, tDMChannelLineCode=tDMChannelLineCode, dataBridgingAvailability=dataBridgingAvailability, sNTPSyncTrap=sNTPSyncTrap, antennaSelection=antennaSelection, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, tDMInterfaceControl=tDMInterfaceControl, configurationInstancedTable=configurationInstancedTable, dfsTableEntry=dfsTableEntry, cableDiagnostics=cableDiagnostics, userTableEntry=userTableEntry, cableDiagPair3Results=cableDiagPair3Results, useVLANForMABProtocol=useVLANForMABProtocol, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, rawReceivePowerLinked=rawReceivePowerLinked, installArmStateTrap=installArmStateTrap, sFPPortAutoNegotiation=sFPPortAutoNegotiation, secureModeAlarm=secureModeAlarm, portAllocationMismatchTrap=portAllocationMismatchTrap, PYSNMP_MODULE_ID=cambium, range=range, reset=reset, incompatibleRegulatoryBands=incompatibleRegulatoryBands, rawReceivePower=rawReceivePower, tDMChannelCableLength=tDMChannelCableLength, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sFPPortAutoMdix=sFPPortAutoMdix, latitude=latitude, tdmTable=tdmTable, rangingMode=rangingMode, phyStatusGroup=phyStatusGroup, linkModeOptimization=linkModeOptimization, dNSPrimaryServer=dNSPrimaryServer, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, tdmTableNumber=tdmTableNumber, userTable=userTable, bootVersion=bootVersion, portAllocationMismatchLinked=portAllocationMismatchLinked, accessMethod=accessMethod)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, hardwareVersion=hardwareVersion, sNMPv3Enable=sNMPv3Enable, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, softwareVersion=softwareVersion, systemClock=systemClock, sNTPServerTableNumber=sNTPServerTableNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, syncESlavePort=syncESlavePort, licenseHCMPSupport=licenseHCMPSupport, qOSPriorityScheme=qOSPriorityScheme, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, syncETrackingState=syncETrackingState, dfs=dfs, authorizationControlTable=authorizationControlTable, linkSymmetry=linkSymmetry, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, signalStrengthRatioLinked=signalStrengthRatioLinked, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, productName=productName, maximumTransmitPower=maximumTransmitPower, licenseTrialPeriod=licenseTrialPeriod, mainPSUPortStatusTrap=mainPSUPortStatusTrap, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, ptpTrapPrefix=ptpTrapPrefix, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, whitelistRMMacAddress=whitelistRMMacAddress, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dNSServerInternetAddress=dNSServerInternetAddress, l2CPPriorityTableIndex=l2CPPriorityTableIndex, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, hTTPSPortNumber=hTTPSPortNumber, dSCPManagementPriority=dSCPManagementPriority, maximumNumberOfSlaves=maximumNumberOfSlaves, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, remoteMACAddress=remoteMACAddress, byteErrorRatio=byteErrorRatio, iPVersion=iPVersion, sNTPServerRetries=sNTPServerRetries, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, licenseEncryption=licenseEncryption, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, management=management, configurationGroup=configurationGroup, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, tDMConfigurationMismatch=tDMConfigurationMismatch, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPServerInternetAddress=sMTPServerInternetAddress, installStatusTrap=installStatusTrap, cambium=cambium, vectorError=vectorError, productVariant=productVariant, dfsMeans=dfsMeans, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, systemReset=systemReset, byteErrorRatioLinked=byteErrorRatioLinked, wirelessOutAllOctets=wirelessOutAllOctets, receiveModulationMode=receiveModulationMode, packetsFromInternalStack=packetsFromInternalStack, cableLoss=cableLoss, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, erroredSeconds=erroredSeconds, hCMPLinkSymmetry=hCMPLinkSymmetry, licenseInstancedTableNumber=licenseInstancedTableNumber, licenseGroupAccess=licenseGroupAccess, licenseSFPPortSupport=licenseSFPPortSupport, syslogClient=syslogClient, telnetAccessEnabled=telnetAccessEnabled, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, licenseCapacity=licenseCapacity, mABHoldoffPeriod=mABHoldoffPeriod, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sMTPServerInternetAddressType=sMTPServerInternetAddressType, supplementary=supplementary, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, licenseIPv6Support=licenseIPv6Support, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ethernet=ethernet, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, tDMGroup=tDMGroup, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, userTableIndex=userTableIndex, cableDiagnosticsWarning=cableDiagnosticsWarning, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, userRole=userRole, auxPortDisabledWarning=auxPortDisabledWarning, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, alarmInstancedTableNumber=alarmInstancedTableNumber, supplementaryGroup=supplementaryGroup, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, routerProtocols=routerProtocols, cableDiagPair1Distance=cableDiagPair1Distance, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, transparentClock=transparentClock, licenseMaxLinkRange=licenseMaxLinkRange, tDDControlGroup=tDDControlGroup, auxPortAcceptedQLRx=auxPortAcceptedQLRx, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, tdmTableIndex=tdmTableIndex, secondarySoftwareVersion=secondarySoftwareVersion, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, aAAControlGroup=aAAControlGroup, licenseVersion=licenseVersion, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, linkLossLinked=linkLossLinked, ethernetPriorityTableEntry=ethernetPriorityTableEntry, licenseSecurityLevel=licenseSecurityLevel, ethernetStatisticsDataSource=ethernetStatisticsDataSource, cableDiagPair3Distance=cableDiagPair3Distance, severelyErroredSeconds=severelyErroredSeconds, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, dataBridgingStatus=dataBridgingStatus, hTTPAccessEnabled=hTTPAccessEnabled, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, wirelessOutOctets=wirelessOutOctets, apc=apc, targetMACAddress=targetMACAddress, frequencyVariant=frequencyVariant, wirelessOutEthernetOctets=wirelessOutEthernetOctets, managementGroup=managementGroup, subbandLowestFrequency=subbandLowestFrequency, tFTPClient=tFTPClient, versions=versions, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, tdmTableEntry=tdmTableEntry, sNTPPollInterval=sNTPPollInterval, alarmInstancedTableIndex=alarmInstancedTableIndex, phyControlInstancedTableIndex=phyControlInstancedTableIndex, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transparentClockVLAN=transparentClockVLAN, mgmtInstancedTable=mgmtInstancedTable, tDMEnabledChannels=tDMEnabledChannels, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNTPState=sNTPState, sNTPServerTableEntry=sNTPServerTableEntry, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, unitIdentificationGroup=unitIdentificationGroup, telnetPortNumber=telnetPortNumber, blacklistRMMacAddress=blacklistRMMacAddress, licenseGroup=licenseGroup, mainPSUPortQLTx=mainPSUPortQLTx, tDDSynchronizationMode=tDDSynchronizationMode, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, encryptionGroup=encryptionGroup, installStatusLinked=installStatusLinked, license=license, sNMPEnabledTraps=sNMPEnabledTraps, sFPPortSyncERxStatus=sFPPortSyncERxStatus, iPv4Address=iPv4Address, whitelistRMEnabled=whitelistRMEnabled, alarmInstancedTableEntry=alarmInstancedTableEntry, managementPortWirelessDownAlert=managementPortWirelessDownAlert, licenseSyncESupport=licenseSyncESupport, sMTPEmailAlert=sMTPEmailAlert, dNSServerInternetAddressType=dNSServerInternetAddressType, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, searchStateLinked=searchStateLinked, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, iPv6PrefixLength=iPv6PrefixLength, lowestTDMModulationMode=lowestTDMModulationMode, mainPSUPortAllocation=mainPSUPortAllocation, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, receiveModulationModeDetail=receiveModulationModeDetail, mABState=mABState, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, wirelessLinkAvailability=wirelessLinkAvailability, dataBridgingStatusAlarm=dataBridgingStatusAlarm, cableDiagnosticsPorts=cableDiagnosticsPorts, syslogControlGroup=syslogControlGroup, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, licenseGasGroup=licenseGasGroup, mABProtocolVLANPriority=mABProtocolVLANPriority, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, tDMChannelLoopback=tDMChannelLoopback, resetGroup=resetGroup, enableTransmission=enableTransmission, iPv6Address=iPv6Address, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ethernetInstancedTableNumber=ethernetInstancedTableNumber, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, l2CPPriorityTable=l2CPPriorityTable, ethernetInstancedTableIndex=ethernetInstancedTableIndex, remoteUnitName=remoteUnitName, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, subbandHighestFrequency=subbandHighestFrequency, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, authorizationControl=authorizationControl, licenseRARSupport=licenseRARSupport, cableDiagPair4Distance=cableDiagPair4Distance, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, sFPPortStatusTrap=sFPPortStatusTrap, sNTPServerTimeout=sNTPServerTimeout, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, pubStats=pubStats, transmitFreqKHz=transmitFreqKHz, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, auxPortStatusTrap=auxPortStatusTrap, ethernetStatisticsTable=ethernetStatisticsTable, phyControlGroup=phyControlGroup, auxPortAllocation=auxPortAllocation, vectorErrorLinked=vectorErrorLinked, licenseInstancedTable=licenseInstancedTable, l2CPPriorityTableNumber=l2CPPriorityTableNumber, userTableNumber=userTableNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, remoteInternetAddress=remoteInternetAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, subnetMask=subnetMask, deviceESN=deviceESN, installStatus=installStatus, transmitModulationModeLinked=transmitModulationModeLinked, linkLoss=linkLoss, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, mgmtInstancedTableNumber=mgmtInstancedTableNumber, transmitModulationMode=transmitModulationMode, timeZone=timeZone, authorizationControlTableIndex=authorizationControlTableIndex, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, alarmInstancedTable=alarmInstancedTable, dNSServerTable=dNSServerTable, auxPortSSMTx=auxPortSSMTx, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, syslogControl=syslogControl, searchState=searchState, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, regulatoryBand=regulatoryBand, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, aggregateDataRate=aggregateDataRate, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, auxPortSyncERxStatus=auxPortSyncERxStatus, cableDiagnosticsControl=cableDiagnosticsControl, mgmtInstancedTableEntry=mgmtInstancedTableEntry, channelChangeTrap=channelChangeTrap, receiveDataRate=receiveDataRate, unavailableSeconds=unavailableSeconds, dataPortWirelessDownAlert=dataPortWirelessDownAlert)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sFPPortQLRx=sFPPortQLRx, lbtDetectedTrap=lbtDetectedTrap, sNTPServerTableIndex=sNTPServerTableIndex, lowestDataModulationMode=lowestDataModulationMode, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, syncEEquipmentClock=syncEEquipmentClock, siteName=siteName, hCMPMaximumLinkRange=hCMPMaximumLinkRange, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sFPErrorTrap=sFPErrorTrap, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, dfsTableNumber=dfsTableNumber, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, longitude=longitude, unitIdentification=unitIdentification, sFPPortAllocation=sFPPortAllocation, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, licenseIssueNumber=licenseIssueNumber, transmitFreqMHz=transmitFreqMHz, sNMPTrapVersion=sNMPTrapVersion, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, ethernetGroup=ethernetGroup, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, regulatoryBandTrap=regulatoryBandTrap, installArmState=installArmState, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNTPServerInternetAddress=sNTPServerInternetAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, tDDControl=tDDControl, licenseInstancedTableIndex=licenseInstancedTableIndex, iPDSCPPriorityTable=iPDSCPPriorityTable, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, nIDULanPortAutoMdix=nIDULanPortAutoMdix, licenseOOBManagementSupport=licenseOOBManagementSupport, nIDULanPortStatus=nIDULanPortStatus, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, sNMPTrapPortNumber=sNMPTrapPortNumber, authorizationControlTableEntry=authorizationControlTableEntry, auxPortQLTx=auxPortQLTx, ptp670=ptp670, alarmsGroup=alarmsGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, remoteMACAddressLinked=remoteMACAddressLinked, dNSGroup=dNSGroup, tFTPServerInternetAddressType=tFTPServerInternetAddressType, rangeLinked=rangeLinked, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, channelBandwidth=channelBandwidth, transmitPower=transmitPower, sNTPServerPortNumber=sNTPServerPortNumber, mainPSUPortAutoMdix=mainPSUPortAutoMdix, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, mainPSUPortSSMTx=mainPSUPortSSMTx, phyControlInstancedTable=phyControlInstancedTable, remoteUnitNameLinked=remoteUnitNameLinked)
