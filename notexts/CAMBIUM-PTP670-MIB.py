...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", l2CPPriorityTableIndex=l2CPPriorityTableIndex, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, txColorCode=txColorCode, userTableEntry=userTableEntry, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, pubInstancedStatsTable=pubInstancedStatsTable, dfsPeaks=dfsPeaks, wirelessLinkAvailability=wirelessLinkAvailability, mainPSUPortStatus=mainPSUPortStatus, dataBridgingStatusLinked=dataBridgingStatusLinked, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, ethernetInstancedTableEntry=ethernetInstancedTableEntry, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, sFPPortAllocation=sFPPortAllocation, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, unitOutOfCalibration=unitOutOfCalibration, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, erroredSeconds=erroredSeconds, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, configurationGroup=configurationGroup, hTTPPortNumber=hTTPPortNumber, channelBandwidth=channelBandwidth, routerProtocolsGroup=routerProtocolsGroup, cableDiagPair3Distance=cableDiagPair3Distance, oOBPriorityQueueMapping=oOBPriorityQueueMapping, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, enableTransmission=enableTransmission, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, whitelistRMMacAddress=whitelistRMMacAddress, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, dNSServerInternetAddress=dNSServerInternetAddress, mABHoldoffPeriod=mABHoldoffPeriod, alarms=alarms, receivePower=receivePower, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, phyControl=phyControl, encryption=encryption, systemClock=systemClock, tdmTable=tdmTable, bridge=bridge, sNMPEnabledTraps=sNMPEnabledTraps, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNTPServerTimeout=sNTPServerTimeout, sNTPPrimaryServer=sNTPPrimaryServer, userName=userName, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sMTPEnabledMessages=sMTPEnabledMessages, ethernet=ethernet, installArmStateTrap=installArmStateTrap, auxPortAcceptedQLRx=auxPortAcceptedQLRx, vectorError=vectorError, nIDULanPortStatusTrap=nIDULanPortStatusTrap, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, dfsTableEntry=dfsTableEntry, dNSServerTable=dNSServerTable, maxLinkRangeExceeded=maxLinkRangeExceeded, regulatoryBand=regulatoryBand, cableDiagPair4Distance=cableDiagPair4Distance, configuration=configuration, cableDiagnostics=cableDiagnostics, alarmInstancedTable=alarmInstancedTable, cableDiagnosticsGroup=cableDiagnosticsGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, signalStrengthRatioLinked=signalStrengthRatioLinked, licenseSecurityLevel=licenseSecurityLevel, licenseSFPPortSupport=licenseSFPPortSupport, packetsToInternalStack=packetsToInternalStack, tFTPClient=tFTPClient, licenseIPv6Support=licenseIPv6Support, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, sMTPServerInternetAddressType=sMTPServerInternetAddressType, licenseSyncESupport=licenseSyncESupport, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, gatewayIPAddress=gatewayIPAddress, frequencyVariant=frequencyVariant, installArmState=installArmState, dNSServerTableEntry=dNSServerTableEntry, sNMPTrapVersion=sNMPTrapVersion, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, installStatusLinked=installStatusLinked, auxPortQLTx=auxPortQLTx, maximumNumberOfSlaves=maximumNumberOfSlaves, transmitChannel=transmitChannel, authorizationControlTableEntry=authorizationControlTableEntry, ptp=ptp, tDDSynchronizationMode=tDDSynchronizationMode, mgmtInstancedTableIndex=mgmtInstancedTableIndex, daylightSaving=daylightSaving, phyInstancedStatusTable=phyInstancedStatusTable, cableDiagnosticsResultTable=cableDiagnosticsResultTable, lowestTDMModulationMode=lowestTDMModulationMode, remoteUnitNameLinked=remoteUnitNameLinked, authorizationMethod=authorizationMethod, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, sntp=sntp, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, dNSServerTableIndex=dNSServerTableIndex, bootVersion=bootVersion, mgmtInstancedTableEntry=mgmtInstancedTableEntry, sFPPortQLRx=sFPPortQLRx, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapTable=sNMPTrapTable, vLANManagementPriority=vLANManagementPriority, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, dfsGroup=dfsGroup, auxPortQLRx=auxPortQLRx, aggregateDataRateLinked=aggregateDataRateLinked, management=management, receiveFreqKHz=receiveFreqKHz, ethernetPriorityTableIndex=ethernetPriorityTableIndex, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, licenseGroup=licenseGroup, alarmInstancedTableNumber=alarmInstancedTableNumber, timeZone=timeZone, sNTPServerInternetAddress=sNTPServerInternetAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, auxPortStatus=auxPortStatus, phyControlInstancedTable=phyControlInstancedTable, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, transparentClockVLAN=transparentClockVLAN, tDMEnabledChannels=tDMEnabledChannels, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, linkName=linkName, sMTPSourceEmailAddress=sMTPSourceEmailAddress, searchState=searchState, userEnabled=userEnabled, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, remoteInternetAddressLinked=remoteInternetAddressLinked, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, iPv6PrefixLength=iPv6PrefixLength, vectorErrorLinked=vectorErrorLinked, tDMChannelCableLength=tDMChannelCableLength, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, sNTPServerTable=sNTPServerTable, authorizationControlTable=authorizationControlTable, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, authorizationControl=authorizationControl, lbtDetectedTrap=lbtDetectedTrap, tdmTableEntry=tdmTableEntry, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, remoteUnitName=remoteUnitName, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, transmitDataRateLinked=transmitDataRateLinked, tDMChannelLineCode=tDMChannelLineCode, incompatibleRegulatoryBands=incompatibleRegulatoryBands, tDMInterfaceControl=tDMInterfaceControl, sNMPTrapTableNumber=sNMPTrapTableNumber, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, syncEEquipmentClock=syncEEquipmentClock, secondarySoftwareVersion=secondarySoftwareVersion, alarmInstancedTableEntry=alarmInstancedTableEntry, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, extendedSpectrumScanning=extendedSpectrumScanning, dataBridgingAvailability=dataBridgingAvailability, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, managementNetworkAccessEnabled=managementNetworkAccessEnabled, auxPortSyncERxStatus=auxPortSyncERxStatus, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, cambium=cambium, sMTPServerInternetAddress=sMTPServerInternetAddress, transmitDataRate=transmitDataRate, lowestDataModulationMode=lowestDataModulationMode, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, mABTransmissionInterval=mABTransmissionInterval, licenseTrialPeriod=licenseTrialPeriod, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, mainPSUPortAllocation=mainPSUPortAllocation, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, secureModeAlarmTrap=secureModeAlarmTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, tDDControl=tDDControl, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, dataBridgingStatusAlarm=dataBridgingStatusAlarm, transparentClockPort=transparentClockPort, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, rxColorCode=rxColorCode, antennaSelection=antennaSelection, cableDiagPair1Distance=cableDiagPair1Distance, phyControlInstancedTableNumber=phyControlInstancedTableNumber, sNTPServerStatus=sNTPServerStatus, remoteMACAddress=remoteMACAddress, sNMPPortNumber=sNMPPortNumber, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, ethernetPriorityTableEntry=ethernetPriorityTableEntry, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, licenseUnitSerialNumber=licenseUnitSerialNumber, transmitFreqKHz=transmitFreqKHz, ptmp=ptmp, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, l2CPPriorityTableEntry=l2CPPriorityTableEntry, routerProtocols=routerProtocols, userTableNumber=userTableNumber, sNTPServerInternetAddressType=sNTPServerInternetAddressType, useVLANForMABProtocol=useVLANForMABProtocol, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, dSCPManagementPriority=dSCPManagementPriority, iPv4Address=iPv4Address, tFTPServerInternetAddress=tFTPServerInternetAddress, auxPortSSMTx=auxPortSSMTx, qOSPriorityScheme=qOSPriorityScheme, antennaGain=antennaGain, sFPError=sFPError, mgmtInstancedTable=mgmtInstancedTable, vLANManagementVID=vLANManagementVID, syslogControlGroup=syslogControlGroup, licenseInstancedTableIndex=licenseInstancedTableIndex, mainPSUPortQLRx=mainPSUPortQLRx, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, deviceESN=deviceESN, sNMPCommunityString=sNMPCommunityString, wirelessTopology=wirelessTopology, configurationInstancedTableIndex=configurationInstancedTableIndex, licenseInstancedTableNumber=licenseInstancedTableNumber, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, sNTPServerRetries=sNTPServerRetries, sFPPortAutoMdix=sFPPortAutoMdix, receivePowerLinked=receivePowerLinked, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sntpGroup=sntpGroup, aAAControlGroup=aAAControlGroup, configurationInstancedTableNumber=configurationInstancedTableNumber, hTTPAccessEnabled=hTTPAccessEnabled, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, mPLSTCPriorityTable=mPLSTCPriorityTable, aggregateDataRate=aggregateDataRate, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sFPPortQLTx=sFPPortQLTx, versionsGroup=versionsGroup, tempPcb=tempPcb, ethernetPriorityTable=ethernetPriorityTable, capacityVariantMismatchTrap=capacityVariantMismatchTrap, sNTPServerTableEntry=sNTPServerTableEntry, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, supplementary=supplementary, tDDControlGroup=tDDControlGroup, targetMACAddress=targetMACAddress, signalStrengthRatio=signalStrengthRatio)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", linkLoss=linkLoss, supplementaryGroup=supplementaryGroup, dfsTable=dfsTable, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, licenseRegulatoryBandsList=licenseRegulatoryBandsList, license=license, blacklistRMEnabled=blacklistRMEnabled, subbandLowestFrequency=subbandLowestFrequency, targetRange=targetRange, mgmtInstancedTableNumber=mgmtInstancedTableNumber, ethernetInstancedTable=ethernetInstancedTable, cableDiagPair2Distance=cableDiagPair2Distance, ethernetPriorityTableNumber=ethernetPriorityTableNumber, dNSPrimaryServer=dNSPrimaryServer, dNSServerPortNumber=dNSServerPortNumber, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, syncETracking=syncETracking, alarmInstancedTableIndex=alarmInstancedTableIndex, tDMChannelStatus=tDMChannelStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ethernetGroup=ethernetGroup, sFPPortStatusTrap=sFPPortStatusTrap, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, mABMaintenanceLevel=mABMaintenanceLevel, dNSGroup=dNSGroup, ethernetStatisticsTable=ethernetStatisticsTable, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, deviceMSN=deviceMSN, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, channelChangeTrap=channelChangeTrap, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, ethernetInstancedTableIndex=ethernetInstancedTableIndex, installationMode=installationMode, aAAControl=aAAControl, hardwareVersion=hardwareVersion, mABNominalTransmitCapacity=mABNominalTransmitCapacity, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, cableDiagnosticsWarning=cableDiagnosticsWarning, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, mABNominalModulationMode=mABNominalModulationMode, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, ptpGroups=ptpGroups, syslogLocalWrappedTrap=syslogLocalWrappedTrap, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, sNMPv3Enable=sNMPv3Enable, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, nIDULanPortAutoMdix=nIDULanPortAutoMdix, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, tDMInterfaceStatus=tDMInterfaceStatus, dfsMeans=dfsMeans, unitName=unitName, licenseCountry=licenseCountry, sMTPEmailAlert=sMTPEmailAlert, groupID=groupID, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, encryptionAlgorithm=encryptionAlgorithm, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, licenseInstancedTable=licenseInstancedTable, authorizationControlTableNumber=authorizationControlTableNumber, userTable=userTable, sNMPTrapTableIndex=sNMPTrapTableIndex, telnetPortNumber=telnetPortNumber, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, wirelessOutOctets=wirelessOutOctets, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, auxPortConfigurationMismatch=auxPortConfigurationMismatch, regulatoryBandTrap=regulatoryBandTrap, rangingMode=rangingMode, cableDiagnosticsPorts=cableDiagnosticsPorts, siteName=siteName, snmpControlGroup=snmpControlGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, unavailableSeconds=unavailableSeconds, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, unitIdentification=unitIdentification, transmitPowerLinked=transmitPowerLinked, dNS=dNS, licenseVersion=licenseVersion, configurationInstancedTableEntry=configurationInstancedTableEntry, subnetMask=subnetMask, severelyErroredSeconds=severelyErroredSeconds, licenseTDDSyncSupport=licenseTDDSyncSupport, transmitModulationMode=transmitModulationMode, encryptionGroup=encryptionGroup, versions=versions, syncESlavePort=syncESlavePort, blacklistRMMacAddress=blacklistRMMacAddress, authorizationControlGroup=authorizationControlGroup, licenseHCMPSupport=licenseHCMPSupport, syslogState=syslogState, sFPErrorTrap=sFPErrorTrap, licenseInstancedTableEntry=licenseInstancedTableEntry, receiveModulationMode=receiveModulationMode, transparentClock=transparentClock, smtp=smtp, licenseIssueNumber=licenseIssueNumber, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tFTPServerPortNumber=tFTPServerPortNumber, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, snmpControl=snmpControl, dNSServerInternetAddressType=dNSServerInternetAddressType, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tDMChannelStatusTrap=tDMChannelStatusTrap, byteErrorRatio=byteErrorRatio, nIDULanPortStatus=nIDULanPortStatus, auxPortDisabledWarning=auxPortDisabledWarning, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, receiveModulationModeLinked=receiveModulationModeLinked, altitude=altitude, secureModeAlarm=secureModeAlarm, cableDiagPair2Results=cableDiagPair2Results, licenseEncryption=licenseEncryption, subbandHighestFrequency=subbandHighestFrequency, remoteMACAddressLinked=remoteMACAddressLinked, apc=apc, managementGroup=managementGroup, mainPSUPortStatusTrap=mainPSUPortStatusTrap, linkModeOptimization=linkModeOptimization, cableDiagPair1Results=cableDiagPair1Results, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, linkLossLinked=linkLossLinked, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, transmitModulationModeLinked=transmitModulationModeLinked, ptp670=ptp670, userRole=userRole, mABProtocolVLANPriority=mABProtocolVLANPriority, smtpGroup=smtpGroup, remoteInternetAddress=remoteInternetAddress, phyControlGroup=phyControlGroup, sNTPState=sNTPState, licenseMaxLinkRange=licenseMaxLinkRange, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, linkModeOptimizationMismatch=linkModeOptimizationMismatch, syncETrackingState=syncETrackingState, userTableIndex=userTableIndex, licenseGroupAccess=licenseGroupAccess, tdmTableNumber=tdmTableNumber, hCMPLinkSymmetry=hCMPLinkSymmetry, systemReset=systemReset, tDMGroup=tDMGroup, sMTPServerPortNumber=sMTPServerPortNumber, capacityVariantMismatch=capacityVariantMismatch, rangeLinked=rangeLinked, licenseTLSRekey=licenseTLSRekey, licenseIEEE1588Support=licenseIEEE1588Support, tFTPServerInternetAddressType=tFTPServerInternetAddressType, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, auxPortStatusTrap=auxPortStatusTrap, phyStatusGroup=phyStatusGroup, dfsTableIndex=dfsTableIndex, cableDiagPair4Results=cableDiagPair4Results, dNSServerTableNumber=dNSServerTableNumber, portAllocationMismatchTrap=portAllocationMismatchTrap, licenseRARSupport=licenseRARSupport, dataPortPauseFrames=dataPortPauseFrames, byteErrorRatioLinked=byteErrorRatioLinked, dNSResolver=dNSResolver, deviceMACAddress=deviceMACAddress, transmitFreqMHz=transmitFreqMHz, longitude=longitude, phyControlInstancedTableEntry=phyControlInstancedTableEntry, dfsTableNumber=dfsTableNumber, mABProtocolVID=mABProtocolVID, capacityVariantMismatchLinked=capacityVariantMismatchLinked, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, PYSNMP_MODULE_ID=cambium, notificationsGroup=notificationsGroup, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, iPVersion=iPVersion, wirelessOutAllOctets=wirelessOutAllOctets, mABState=mABState, ethernetInstancedTableNumber=ethernetInstancedTableNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, bridgeGroup=bridgeGroup, masterSlaveMode=masterSlaveMode, transmitterChannels=transmitterChannels, sNTPServerTableNumber=sNTPServerTableNumber, maximumTransmitPower=maximumTransmitPower, sFPPortDisabledWarning=sFPPortDisabledWarning, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, eIRP=eIRP, linkSymmetry=linkSymmetry, l2CPPriorityTable=l2CPPriorityTable, receiveFreqMHz=receiveFreqMHz, accessMethod=accessMethod, portAllocationMismatch=portAllocationMismatch, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, installStatusTrap=installStatusTrap, tDM=tDM, dataPortWirelessDownAlert=dataPortWirelessDownAlert, l2CPPriorityTableNumber=l2CPPriorityTableNumber, auxPortAllocation=auxPortAllocation, hTTPSPortNumber=hTTPSPortNumber, mainPSUPortQLTx=mainPSUPortQLTx, transparentClockVID=transparentClockVID, receiveModulationModeDetail=receiveModulationModeDetail, receiveChannel=receiveChannel, sNTPPollInterval=sNTPPollInterval, receiveDataRate=receiveDataRate, latitude=latitude, iPDSCPPriorityTable=iPDSCPPriorityTable, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, cableDiagPair3Results=cableDiagPair3Results, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, sNTPLastSync=sNTPLastSync, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, wirelessOutEthernetOctets=wirelessOutEthernetOctets, transmitPower=transmitPower, hCMPMaximumLinkRange=hCMPMaximumLinkRange, licenseGasGroup=licenseGasGroup, sNMPTrapInternetAddress=sNMPTrapInternetAddress, cableLoss=cableLoss, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, pubStatsGroup=pubStatsGroup, unitIdentificationGroup=unitIdentificationGroup, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, iPv6GatewayAddress=iPv6GatewayAddress, configurationInstancedTable=configurationInstancedTable, sNTPSync=sNTPSync, wirelessLinkStatus=wirelessLinkStatus, sFPPortSyncERxStatus=sFPPortSyncERxStatus, sNTPServerPortNumber=sNTPServerPortNumber, sFPPortAutoNegotiation=sFPPortAutoNegotiation, syslogClient=syslogClient, range=range, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, iPv6Address=iPv6Address, phyControlInstancedTableIndex=phyControlInstancedTableIndex, resetGroup=resetGroup, licenseCapacity=licenseCapacity, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, sFPPortStatus=sFPPortStatus, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, tdmTableIndex=tdmTableIndex, sFPPortSSMTx=sFPPortSSMTx, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", tDMChannelLoopback=tDMChannelLoopback, sNTPServerTableIndex=sNTPServerTableIndex, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, remoteInternetAddressType=remoteInternetAddressType, sNMPTrapTableEntry=sNMPTrapTableEntry, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, syslogControl=syslogControl, alarmsGroup=alarmsGroup, syslogStateTrap=syslogStateTrap, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, txMABFrames=txMABFrames, mainPSUPortAutoMdix=mainPSUPortAutoMdix, phyStatus=phyStatus, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, authorizationControlTableIndex=authorizationControlTableIndex, whitelistRMEnabled=whitelistRMEnabled, searchStateLinked=searchStateLinked, rawReceivePower=rawReceivePower, packetsFromInternalStack=packetsFromInternalStack, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, dfs=dfs, installStatus=installStatus, licenseOOBManagementSupport=licenseOOBManagementSupport, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, rawReceivePowerLinked=rawReceivePowerLinked, ethernetStatisticsDataSource=ethernetStatisticsDataSource, apcGroup=apcGroup, sNTPSyncTrap=sNTPSyncTrap, wirelessLinkStatusLinked=wirelessLinkStatusLinked, softwareVersion=softwareVersion, receiveDataRateLinked=receiveDataRateLinked, telnetAccessEnabled=telnetAccessEnabled, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, licenseBandwidthCap=licenseBandwidthCap, tDMConfigurationMismatch=tDMConfigurationMismatch, reset=reset, ptpTraps=ptpTraps, mainPSUPortSSMTx=mainPSUPortSSMTx, dataBridgingStatus=dataBridgingStatus, cableDiagnosticsControl=cableDiagnosticsControl, ptpTrapPrefix=ptpTrapPrefix, productName=productName, userPassword=userPassword, ptpCompliance=ptpCompliance, productVariant=productVariant, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, portAllocationMismatchLinked=portAllocationMismatchLinked, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, pubStats=pubStats, managementPortWirelessDownAlert=managementPortWirelessDownAlert, localPacketFiltering=localPacketFiltering, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, syslogClientTrap=syslogClientTrap, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade)
