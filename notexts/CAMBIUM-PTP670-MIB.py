...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", phyInstancedStatusTable=phyInstancedStatusTable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, telnetAccessEnabled=telnetAccessEnabled, oOBPriorityQueueMapping=oOBPriorityQueueMapping, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, vectorError=vectorError, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, cableDiagnosticsControl=cableDiagnosticsControl, bridgeGroup=bridgeGroup, tdmTable=tdmTable, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, syslogClient=syslogClient, mainPSUPortStatusTrap=mainPSUPortStatusTrap, dfsMeans=dfsMeans, cableDiagPair4Results=cableDiagPair4Results, cableDiagnosticsResultTable=cableDiagnosticsResultTable, managementGroup=managementGroup, erroredSeconds=erroredSeconds, deviceESN=deviceESN, licenseCountry=licenseCountry, range=range, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, dNSGroup=dNSGroup, ethernetGroup=ethernetGroup, secondarySoftwareVersion=secondarySoftwareVersion, apcGroup=apcGroup, userTable=userTable, supplementaryGroup=supplementaryGroup, receiveDataRate=receiveDataRate, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, sNTPServerTableNumber=sNTPServerTableNumber, signalStrengthRatio=signalStrengthRatio, sNTPPrimaryServer=sNTPPrimaryServer, tDMChannelCableLength=tDMChannelCableLength, linkLossLinked=linkLossLinked, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNTPSync=sNTPSync, useVLANForMABProtocol=useVLANForMABProtocol, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dNSServerPortNumber=dNSServerPortNumber, mgmtInstancedTableNumber=mgmtInstancedTableNumber, rawReceivePower=rawReceivePower, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, remoteUnitName=remoteUnitName, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, license=license, licenseMaxLinkRange=licenseMaxLinkRange, txColorCode=txColorCode, signalStrengthRatioLinked=signalStrengthRatioLinked, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, routerProtocolsGroup=routerProtocolsGroup, transmitModulationMode=transmitModulationMode, secureModeAlarmTrap=secureModeAlarmTrap, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, tFTPServerInternetAddress=tFTPServerInternetAddress, antennaSelection=antennaSelection, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, userPassword=userPassword, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, licenseEncryption=licenseEncryption, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, licenseSyncESupport=licenseSyncESupport, byteErrorRatio=byteErrorRatio, whitelistRMEnabled=whitelistRMEnabled, smtp=smtp, localPacketFiltering=localPacketFiltering, auxPortStatus=auxPortStatus, syslogControl=syslogControl, snmpControlGroup=snmpControlGroup, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, pubInstancedStatsTable=pubInstancedStatsTable, licenseRegulatoryBandsList=licenseRegulatoryBandsList, alarmInstancedTableIndex=alarmInstancedTableIndex, hCMPMaximumLinkRange=hCMPMaximumLinkRange, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, installationMode=installationMode, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, licenseHCMPSupport=licenseHCMPSupport, maximumTransmitPower=maximumTransmitPower, authorizationControlTable=authorizationControlTable, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, transmitPowerLinked=transmitPowerLinked, sNTPServerPortNumber=sNTPServerPortNumber, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, remoteMACAddress=remoteMACAddress, altitude=altitude, sNMPTrapTable=sNMPTrapTable, syncETrackingState=syncETrackingState, licenseSecurityLevel=licenseSecurityLevel, byteErrorRatioLinked=byteErrorRatioLinked, dfsTableEntry=dfsTableEntry, phyControlInstancedTable=phyControlInstancedTable, licenseBandwidthCap=licenseBandwidthCap, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, portAllocationMismatchLinked=portAllocationMismatchLinked, l2CPPriorityTableIndex=l2CPPriorityTableIndex, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, phyStatusGroup=phyStatusGroup, encryptionGroup=encryptionGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, cableDiagPair1Distance=cableDiagPair1Distance, auxPortQLTx=auxPortQLTx, sFPPortStatus=sFPPortStatus, whitelistRMMacAddress=whitelistRMMacAddress, syslogClientTrap=syslogClientTrap, tDDControlGroup=tDDControlGroup, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, linkLoss=linkLoss, l2CPPriorityTable=l2CPPriorityTable, lowestDataModulationMode=lowestDataModulationMode, eIRP=eIRP, accessMethod=accessMethod, sNTPServerRetries=sNTPServerRetries, blacklistRMMacAddress=blacklistRMMacAddress, sntp=sntp, transparentClockPort=transparentClockPort, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, hardwareVersion=hardwareVersion, sNMPCommunityString=sNMPCommunityString, phyControl=phyControl, sFPPortSSMTx=sFPPortSSMTx, siteName=siteName, tDMChannelLineCode=tDMChannelLineCode, cableDiagnostics=cableDiagnostics, mainPSUPortQLTx=mainPSUPortQLTx, transmitDataRate=transmitDataRate, mgmtInstancedTableEntry=mgmtInstancedTableEntry, dataPortPauseFrames=dataPortPauseFrames, rawReceivePowerLinked=rawReceivePowerLinked, regulatoryBand=regulatoryBand, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sFPPortAutoMdix=sFPPortAutoMdix, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, tFTPServerInternetAddressType=tFTPServerInternetAddressType, transmitPower=transmitPower, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, ethernetStatisticsDataSource=ethernetStatisticsDataSource, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, nIDULanPortStatus=nIDULanPortStatus, subnetMask=subnetMask, lowestTDMModulationMode=lowestTDMModulationMode, sMTPEmailAlert=sMTPEmailAlert, dNSResolver=dNSResolver, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, targetRange=targetRange, linkModeOptimization=linkModeOptimization, ethernetInstancedTableNumber=ethernetInstancedTableNumber, sNTPServerStatus=sNTPServerStatus, transmitModulationModeLinked=transmitModulationModeLinked, installStatus=installStatus, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, hCMPLinkSymmetry=hCMPLinkSymmetry, management=management, enableTransmission=enableTransmission, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, receiveModulationMode=receiveModulationMode, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, aAAControl=aAAControl, syncEEquipmentClock=syncEEquipmentClock, iPDSCPPriorityTable=iPDSCPPriorityTable, unitIdentificationGroup=unitIdentificationGroup, phyControlInstancedTableIndex=phyControlInstancedTableIndex, auxPortStatusTrap=auxPortStatusTrap, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, userEnabled=userEnabled, dfs=dfs, bootVersion=bootVersion, sFPPortQLRx=sFPPortQLRx, mABProtocolVLANPriority=mABProtocolVLANPriority, mABProtocolVID=mABProtocolVID, ptp=ptp, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, hTTPAccessEnabled=hTTPAccessEnabled, searchStateLinked=searchStateLinked, iPv6GatewayAddress=iPv6GatewayAddress, licenseGroupAccess=licenseGroupAccess, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, syslogControlGroup=syslogControlGroup, unavailableSeconds=unavailableSeconds, notificationsGroup=notificationsGroup, receivePowerLinked=receivePowerLinked, hTTPSPortNumber=hTTPSPortNumber, packetsToInternalStack=packetsToInternalStack, sNMPTrapTableEntry=sNMPTrapTableEntry, l2CPPriorityTableNumber=l2CPPriorityTableNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, wirelessOutOctets=wirelessOutOctets, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, dNS=dNS, sntpGroup=sntpGroup, dfsTableIndex=dfsTableIndex, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, productVariant=productVariant, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, auxPortSyncERxStatus=auxPortSyncERxStatus, receiveModulationModeDetail=receiveModulationModeDetail, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sFPPortStatusTrap=sFPPortStatusTrap, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, capacityVariantMismatchLinked=capacityVariantMismatchLinked, dataPortWirelessDownAlert=dataPortWirelessDownAlert, licenseRARSupport=licenseRARSupport, timeZone=timeZone, syslogState=syslogState, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, sMTPServerPortNumber=sMTPServerPortNumber, licenseIPv6Support=licenseIPv6Support, licenseGasGroup=licenseGasGroup, tDMEnabledChannels=tDMEnabledChannels, dNSServerInternetAddress=dNSServerInternetAddress, subbandHighestFrequency=subbandHighestFrequency, dNSServerInternetAddressType=dNSServerInternetAddressType, phyStatus=phyStatus, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, linkName=linkName, userTableEntry=userTableEntry, dfsTable=dfsTable, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, cableDiagPair3Distance=cableDiagPair3Distance, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, auxPortAcceptedQLRx=auxPortAcceptedQLRx, sFPPortSyncERxStatus=sFPPortSyncERxStatus, extendedSpectrumScanning=extendedSpectrumScanning, qOSPriorityScheme=qOSPriorityScheme, dfsTableNumber=dfsTableNumber, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, ethernetPriorityTableNumber=ethernetPriorityTableNumber, portAllocationMismatch=portAllocationMismatch, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, linkModeOptimizationMismatch=linkModeOptimizationMismatch, unitName=unitName, userRole=userRole, remoteUnitNameLinked=remoteUnitNameLinked, transparentClockVID=transparentClockVID, apc=apc, rangeLinked=rangeLinked)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", transmitterChannels=transmitterChannels, tDMInterfaceStatus=tDMInterfaceStatus, licenseInstancedTableIndex=licenseInstancedTableIndex, cableDiagPair4Distance=cableDiagPair4Distance, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, tFTPServerPortNumber=tFTPServerPortNumber, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, licenseOOBManagementSupport=licenseOOBManagementSupport, auxPortQLRx=auxPortQLRx, linkSymmetry=linkSymmetry, dfsGroup=dfsGroup, ethernet=ethernet, transmitDataRateLinked=transmitDataRateLinked, regulatoryBandTrap=regulatoryBandTrap, transparentClockVLAN=transparentClockVLAN, packetsFromInternalStack=packetsFromInternalStack, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, installStatusLinked=installStatusLinked, deviceMACAddress=deviceMACAddress, authorizationMethod=authorizationMethod, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, subbandLowestFrequency=subbandLowestFrequency, sNTPServerTableIndex=sNTPServerTableIndex, portAllocationMismatchTrap=portAllocationMismatchTrap, sFPPortAllocation=sFPPortAllocation, sNMPTrapPortNumber=sNMPTrapPortNumber, deviceMSN=deviceMSN, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, channelBandwidth=channelBandwidth, versions=versions, telnetPortNumber=telnetPortNumber, systemReset=systemReset, vLANManagementPriority=vLANManagementPriority, channelChangeTrap=channelChangeTrap, auxPortDisabledWarning=auxPortDisabledWarning, sNTPPollInterval=sNTPPollInterval, wirelessTopology=wirelessTopology, nIDULanPortStatusTrap=nIDULanPortStatusTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, iPv6Address=iPv6Address, licenseIEEE1588Support=licenseIEEE1588Support, transparentClock=transparentClock, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNTPServerTable=sNTPServerTable, licenseTDDSyncSupport=licenseTDDSyncSupport, mainPSUPortSSMTx=mainPSUPortSSMTx, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, alarmInstancedTable=alarmInstancedTable, PYSNMP_MODULE_ID=cambium, dNSServerTableIndex=dNSServerTableIndex, sMTPServerInternetAddress=sMTPServerInternetAddress, sFPPortDisabledWarning=sFPPortDisabledWarning, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, cableDiagPair3Results=cableDiagPair3Results, cableLoss=cableLoss, licenseInstancedTable=licenseInstancedTable, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, sNTPLastSync=sNTPLastSync, receiveDataRateLinked=receiveDataRateLinked, phyControlInstancedTableNumber=phyControlInstancedTableNumber, dNSServerTable=dNSServerTable, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, ethernetInstancedTableEntry=ethernetInstancedTableEntry, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, ptpTrapPrefix=ptpTrapPrefix, managementPortWirelessDownAlert=managementPortWirelessDownAlert, receiveFreqKHz=receiveFreqKHz, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, configurationInstancedTableIndex=configurationInstancedTableIndex, alarmInstancedTableEntry=alarmInstancedTableEntry, capacityVariantMismatchTrap=capacityVariantMismatchTrap, aAAControlGroup=aAAControlGroup, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, mABHoldoffPeriod=mABHoldoffPeriod, configurationInstancedTableEntry=configurationInstancedTableEntry, mABMaintenanceLevel=mABMaintenanceLevel, ethernetPriorityTableIndex=ethernetPriorityTableIndex, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, tDM=tDM, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, sNMPTrapVersion=sNMPTrapVersion, alarmsGroup=alarmsGroup, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, severelyErroredSeconds=severelyErroredSeconds, smtpGroup=smtpGroup, mgmtInstancedTableIndex=mgmtInstancedTableIndex, userTableIndex=userTableIndex, maxLinkRangeExceeded=maxLinkRangeExceeded, tDMChannelStatusTrap=tDMChannelStatusTrap, sFPPortQLTx=sFPPortQLTx, licenseIssueNumber=licenseIssueNumber, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, dSCPManagementPriority=dSCPManagementPriority, licenseGroup=licenseGroup, cableDiagnosticsGroup=cableDiagnosticsGroup, rangingMode=rangingMode, incompatibleMasterAndSlave=incompatibleMasterAndSlave, cableDiagnosticsPorts=cableDiagnosticsPorts, encryptionAlgorithm=encryptionAlgorithm, sNTPServerTimeout=sNTPServerTimeout, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, mainPSUPortQLRx=mainPSUPortQLRx, cableDiagPair2Distance=cableDiagPair2Distance, mainPSUPortAllocation=mainPSUPortAllocation, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, sFPPortAutoNegotiation=sFPPortAutoNegotiation, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, incompatibleRegulatoryBands=incompatibleRegulatoryBands, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, aggregateDataRateLinked=aggregateDataRateLinked, cableDiagPair1Results=cableDiagPair1Results, dataBridgingAvailability=dataBridgingAvailability, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, tDMChannelLoopback=tDMChannelLoopback, sNTPServerTableEntry=sNTPServerTableEntry, dataBridgingStatus=dataBridgingStatus, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, cambium=cambium, ethernetPriorityTable=ethernetPriorityTable, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, tDDSynchronizationAlarm=tDDSynchronizationAlarm, mPLSTCPriorityTable=mPLSTCPriorityTable, dNSServerTableEntry=dNSServerTableEntry, resetGroup=resetGroup, txMABFrames=txMABFrames, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, frequencyVariant=frequencyVariant, unitOutOfCalibration=unitOutOfCalibration, mainPSUPortStatus=mainPSUPortStatus, bridge=bridge, blacklistRMEnabled=blacklistRMEnabled, secureModeAlarm=secureModeAlarm, gatewayIPAddress=gatewayIPAddress, receivePower=receivePower, snmpControl=snmpControl, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, alarmInstancedTableNumber=alarmInstancedTableNumber, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, alarms=alarms, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, remoteMACAddressLinked=remoteMACAddressLinked, tDMConfigurationMismatch=tDMConfigurationMismatch, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, pubStatsGroup=pubStatsGroup, sNTPSyncTrap=sNTPSyncTrap, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, cableDiagnosticsWarning=cableDiagnosticsWarning, sNMPv3Enable=sNMPv3Enable, sNTPState=sNTPState, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dfsPeaks=dfsPeaks, licenseInstancedTableNumber=licenseInstancedTableNumber, authorizationControlTableNumber=authorizationControlTableNumber, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, mgmtInstancedTable=mgmtInstancedTable, ethernetInstancedTableIndex=ethernetInstancedTableIndex, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, reset=reset, licenseSFPPortSupport=licenseSFPPortSupport, installArmStateTrap=installArmStateTrap, ethernetStatisticsTable=ethernetStatisticsTable, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, tFTPClient=tFTPClient, sMTPServerInternetAddressType=sMTPServerInternetAddressType, masterSlaveMode=masterSlaveMode, authorizationControlGroup=authorizationControlGroup, antennaGain=antennaGain, dNSServerTableNumber=dNSServerTableNumber, dataBridgingStatusLinked=dataBridgingStatusLinked, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, capacityVariantMismatch=capacityVariantMismatch, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, mABTransmissionInterval=mABTransmissionInterval, groupID=groupID, iPv6PrefixLength=iPv6PrefixLength, wirelessLinkStatus=wirelessLinkStatus, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, syncETracking=syncETracking, ptp670=ptp670, sFPErrorTrap=sFPErrorTrap, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, auxPortAllocation=auxPortAllocation, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, userName=userName, iPv4Address=iPv4Address, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, productName=productName, ptpTraps=ptpTraps, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, daylightSaving=daylightSaving, noWirelessChannelAvailable=noWirelessChannelAvailable, remoteInternetAddress=remoteInternetAddress, supplementary=supplementary, tDDSynchronizationStatus=tDDSynchronizationStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapTableNumber=sNMPTrapTableNumber, remoteInternetAddressType=remoteInternetAddressType, sNMPTrapTableIndex=sNMPTrapTableIndex, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, iPVersion=iPVersion, installStatusTrap=installStatusTrap, receiveChannel=receiveChannel, wirelessOutEthernetOctets=wirelessOutEthernetOctets, pubStats=pubStats, dataBridgingStatusAlarm=dataBridgingStatusAlarm, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, managementNetworkAccessEnabled=managementNetworkAccessEnabled, auxPortConfigurationMismatch=auxPortConfigurationMismatch, versionsGroup=versionsGroup, auxPortSSMTx=auxPortSSMTx, encryption=encryption, hTTPSAccessEnabled=hTTPSAccessEnabled, softwareVersion=softwareVersion, syslogStateTrap=syslogStateTrap, ptpGroups=ptpGroups, licenseVersion=licenseVersion, syncESlavePort=syncESlavePort, authorizationControlTableEntry=authorizationControlTableEntry, configurationInstancedTable=configurationInstancedTable, configurationInstancedTableNumber=configurationInstancedTableNumber, mainPSUPortAutoMdix=mainPSUPortAutoMdix, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, authorizationControlTableIndex=authorizationControlTableIndex, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, vectorErrorLinked=vectorErrorLinked, receiveFreqMHz=receiveFreqMHz, cableDiagPair2Results=cableDiagPair2Results, hTTPPortNumber=hTTPPortNumber, aggregateDataRate=aggregateDataRate, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, wirelessOutAllOctets=wirelessOutAllOctets, sNMPEnabledTraps=sNMPEnabledTraps, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, ptpCompliance=ptpCompliance, sNTPServerInternetAddress=sNTPServerInternetAddress, mABNominalModulationMode=mABNominalModulationMode, tDMChannelStatus=tDMChannelStatus)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, wirelessLinkAvailability=wirelessLinkAvailability, tDMInterfaceControl=tDMInterfaceControl, targetMACAddress=targetMACAddress, rxColorCode=rxColorCode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tDDControl=tDDControl, configurationGroup=configurationGroup, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, tdmTableEntry=tdmTableEntry, phyControlInstancedTableEntry=phyControlInstancedTableEntry, dNSPrimaryServer=dNSPrimaryServer, licenseCapacity=licenseCapacity, unitIdentification=unitIdentification, mABNominalTransmitCapacity=mABNominalTransmitCapacity, installArmState=installArmState, transmitFreqMHz=transmitFreqMHz, ethernetInstancedTable=ethernetInstancedTable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, transmitChannel=transmitChannel, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, receiveModulationModeLinked=receiveModulationModeLinked, wirelessLinkStatusLinked=wirelessLinkStatusLinked, tDDSynchronizationMode=tDDSynchronizationMode, sNTPServerInternetAddressType=sNTPServerInternetAddressType, userTableNumber=userTableNumber, maximumNumberOfSlaves=maximumNumberOfSlaves, vLANManagementVID=vLANManagementVID, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, tDMGroup=tDMGroup, sFPError=sFPError, latitude=latitude, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, sNMPPortNumber=sNMPPortNumber, tdmTableNumber=tdmTableNumber, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, sMTPEnabledMessages=sMTPEnabledMessages, licenseTLSRekey=licenseTLSRekey, systemClock=systemClock, tdmTableIndex=tdmTableIndex, mABState=mABState, licenseInstancedTableEntry=licenseInstancedTableEntry, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, nIDULanPortAutoMdix=nIDULanPortAutoMdix, authorizationControl=authorizationControl, longitude=longitude, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, routerProtocols=routerProtocols, ptmp=ptmp, remoteInternetAddressLinked=remoteInternetAddressLinked, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, phyControlGroup=phyControlGroup, licenseTrialPeriod=licenseTrialPeriod, licenseUnitSerialNumber=licenseUnitSerialNumber, tempPcb=tempPcb, lbtDetectedTrap=lbtDetectedTrap, transmitFreqKHz=transmitFreqKHz, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, configuration=configuration, searchState=searchState)
