...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sFPPortAutoMdix=sFPPortAutoMdix, groupID=groupID, tDMChannelLineCode=tDMChannelLineCode, licenseTLSRekey=licenseTLSRekey, regulatoryBandTrap=regulatoryBandTrap, range=range, siteName=siteName, sFPPortAutoNegotiation=sFPPortAutoNegotiation, targetRange=targetRange, mABMaintenanceLevel=mABMaintenanceLevel, ethernetInstancedTableIndex=ethernetInstancedTableIndex, transmitFreqKHz=transmitFreqKHz, managementNetworkAccessEnabled=managementNetworkAccessEnabled, mABTransmissionInterval=mABTransmissionInterval, ethernetPriorityTableIndex=ethernetPriorityTableIndex, tempPcb=tempPcb, sNTPPollInterval=sNTPPollInterval, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, sFPPortStatus=sFPPortStatus, license=license, sntpGroup=sntpGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, linkName=linkName, snmpControlGroup=snmpControlGroup, auxPortAllocation=auxPortAllocation, licenseUnitSerialNumber=licenseUnitSerialNumber, hardwareVersion=hardwareVersion, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, telnetAccessEnabled=telnetAccessEnabled, licenseRARSupport=licenseRARSupport, apc=apc, phyInstancedStatusTable=phyInstancedStatusTable, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, capacityVariantMismatchTrap=capacityVariantMismatchTrap, dNSGroup=dNSGroup, regulatoryBand=regulatoryBand, alarms=alarms, lowestTDMModulationMode=lowestTDMModulationMode, sMTPServerInternetAddressType=sMTPServerInternetAddressType, tFTPClient=tFTPClient, mgmtInstancedTableEntry=mgmtInstancedTableEntry, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, ptmp=ptmp, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dfsTableIndex=dfsTableIndex, deviceESN=deviceESN, sFPError=sFPError, useVLANForMABProtocol=useVLANForMABProtocol, telnetPortNumber=telnetPortNumber, authorizationControl=authorizationControl, linkSymmetry=linkSymmetry, wirelessLinkAvailability=wirelessLinkAvailability, iPv4Address=iPv4Address, softwareVersion=softwareVersion, ptpGroups=ptpGroups, licenseIEEE1588Support=licenseIEEE1588Support, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, PYSNMP_MODULE_ID=cambium, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, syncEEquipmentClock=syncEEquipmentClock, sMTPServerInternetAddress=sMTPServerInternetAddress, receiveDataRateLinked=receiveDataRateLinked, sNTPServerStatus=sNTPServerStatus, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, licenseCapacity=licenseCapacity, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, sNMPPortNumber=sNMPPortNumber, antennaGain=antennaGain, tDMGroup=tDMGroup, hTTPAccessEnabled=hTTPAccessEnabled, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, dataBridgingStatus=dataBridgingStatus, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, aggregateDataRateLinked=aggregateDataRateLinked, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, accessMethod=accessMethod, iPv6GatewayAddress=iPv6GatewayAddress, auxPortQLRx=auxPortQLRx, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, linkModeOptimization=linkModeOptimization, authorizationControlGroup=authorizationControlGroup, tdmTableIndex=tdmTableIndex, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, authorizationControlTableNumber=authorizationControlTableNumber, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, vectorErrorLinked=vectorErrorLinked, apcGroup=apcGroup, userTableEntry=userTableEntry, authorizationControlTable=authorizationControlTable, receivePowerLinked=receivePowerLinked, oOBPriorityQueueMapping=oOBPriorityQueueMapping, iPDSCPPriorityTable=iPDSCPPriorityTable, localPacketFiltering=localPacketFiltering, syncETrackingState=syncETrackingState, remoteMACAddress=remoteMACAddress, managementPortWirelessDownAlert=managementPortWirelessDownAlert, mainPSUPortStatusTrap=mainPSUPortStatusTrap, dNSResolver=dNSResolver, byteErrorRatioLinked=byteErrorRatioLinked, sNTPServerTableNumber=sNTPServerTableNumber, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, configuration=configuration, licenseInstancedTableIndex=licenseInstancedTableIndex, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, ethernet=ethernet, enableTransmission=enableTransmission, licenseInstancedTableNumber=licenseInstancedTableNumber, nIDULanPortAutoMdix=nIDULanPortAutoMdix, wirelessLinkStatusLinked=wirelessLinkStatusLinked, ptp=ptp, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, sFPPortStatusTrap=sFPPortStatusTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, reset=reset, syncESlavePort=syncESlavePort, ethernetGroup=ethernetGroup, dNSServerTableIndex=dNSServerTableIndex, phyControlInstancedTableNumber=phyControlInstancedTableNumber, aAAControlGroup=aAAControlGroup, searchStateLinked=searchStateLinked, alarmInstancedTable=alarmInstancedTable, rangeLinked=rangeLinked, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, unitIdentification=unitIdentification, unitOutOfCalibration=unitOutOfCalibration, remoteInternetAddressType=remoteInternetAddressType, tdmTableEntry=tdmTableEntry, mPLSTCPriorityTable=mPLSTCPriorityTable, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNTPServerTimeout=sNTPServerTimeout, licenseSFPPortSupport=licenseSFPPortSupport, iPv6Address=iPv6Address, masterSlaveMode=masterSlaveMode, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, tDMInterfaceControl=tDMInterfaceControl, tDDSynchronizationMode=tDDSynchronizationMode, tDMChannelLoopback=tDMChannelLoopback, installStatus=installStatus, mainPSUPortQLRx=mainPSUPortQLRx, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, mABProtocolVLANPriority=mABProtocolVLANPriority, alarmInstancedTableNumber=alarmInstancedTableNumber, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, smtp=smtp, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, phyStatus=phyStatus, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, maximumTransmitPower=maximumTransmitPower, dataBridgingAvailability=dataBridgingAvailability, tDDControl=tDDControl, installStatusLinked=installStatusLinked, phyControlInstancedTableEntry=phyControlInstancedTableEntry, enabledDiagnosticAlarms=enabledDiagnosticAlarms, licenseOOBManagementSupport=licenseOOBManagementSupport, licenseGroup=licenseGroup, tdmTableNumber=tdmTableNumber, authorizationControlTableIndex=authorizationControlTableIndex, dataBridgingStatusLinked=dataBridgingStatusLinked, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, deviceMACAddress=deviceMACAddress, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, noWirelessChannelAvailable=noWirelessChannelAvailable, phyControl=phyControl, encryption=encryption, dfs=dfs, tDMInterfaceStatus=tDMInterfaceStatus, sNMPTrapInternetAddress=sNMPTrapInternetAddress, phyStatusGroup=phyStatusGroup, sNTPLastSync=sNTPLastSync, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, smtpGroup=smtpGroup, receiveFreqMHz=receiveFreqMHz, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, sNTPServerRetries=sNTPServerRetries, hCMPLinkSymmetry=hCMPLinkSymmetry, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, dNSServerTableEntry=dNSServerTableEntry, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, syslogClientTrap=syslogClientTrap, signalStrengthRatioLinked=signalStrengthRatioLinked, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, severelyErroredSeconds=severelyErroredSeconds, routerProtocolsGroup=routerProtocolsGroup, hTTPSPortNumber=hTTPSPortNumber, sFPPortQLTx=sFPPortQLTx, channelBandwidth=channelBandwidth, userRole=userRole, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, linkLoss=linkLoss, systemClock=systemClock, sNMPTrapTableIndex=sNMPTrapTableIndex, cableDiagPair4Results=cableDiagPair4Results, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, cableLoss=cableLoss, sNTPServerTable=sNTPServerTable, auxPortStatusTrap=auxPortStatusTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, eIRP=eIRP, cableDiagPair1Results=cableDiagPair1Results, maximumNumberOfSlaves=maximumNumberOfSlaves, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, useVLANForManagementInterfaces=useVLANForManagementInterfaces, notificationsGroup=notificationsGroup, aggregateDataRate=aggregateDataRate, licenseIssueNumber=licenseIssueNumber, dNSServerTableNumber=dNSServerTableNumber, blacklistRMEnabled=blacklistRMEnabled, licenseEncryption=licenseEncryption, ethernetInstancedTable=ethernetInstancedTable, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, ptpTrapPrefix=ptpTrapPrefix, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, wirelessOutAllOctets=wirelessOutAllOctets, configurationGroup=configurationGroup, sNMPv3Enable=sNMPv3Enable, nIDULanPortStatusTrap=nIDULanPortStatusTrap, whitelistRMMacAddress=whitelistRMMacAddress, sMTPEmailAlert=sMTPEmailAlert, cableDiagnosticsControl=cableDiagnosticsControl, installArmState=installArmState, cableDiagPair4Distance=cableDiagPair4Distance, subnetMask=subnetMask, dfsPeaks=dfsPeaks, timeZone=timeZone, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, pubStatsGroup=pubStatsGroup, nIDULanPortStatus=nIDULanPortStatus, mABState=mABState, vLANManagementPriority=vLANManagementPriority, cableDiagPair1Distance=cableDiagPair1Distance, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, portAllocationMismatchLinked=portAllocationMismatchLinked, syslogLocalWrappedTrap=syslogLocalWrappedTrap, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, dataPortPauseFrames=dataPortPauseFrames, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, tDMChannelCableLength=tDMChannelCableLength, transparentClockPort=transparentClockPort, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, systemReset=systemReset)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", productVariant=productVariant, licenseGroupAccess=licenseGroupAccess, sNMPTrapTableEntry=sNMPTrapTableEntry, tDM=tDM, rangingMode=rangingMode, signalStrengthRatio=signalStrengthRatio, sNTPSyncTrap=sNTPSyncTrap, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, ethernetPriorityTableNumber=ethernetPriorityTableNumber, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, portAllocationMismatchTrap=portAllocationMismatchTrap, receiveDataRate=receiveDataRate, subbandHighestFrequency=subbandHighestFrequency, cableDiagPair2Distance=cableDiagPair2Distance, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, licenseVersion=licenseVersion, mgmtInstancedTableIndex=mgmtInstancedTableIndex, configurationInstancedTableNumber=configurationInstancedTableNumber, longitude=longitude, supplementaryGroup=supplementaryGroup, auxPortQLTx=auxPortQLTx, wirelessOutEthernetOctets=wirelessOutEthernetOctets, auxPortSyncERxStatus=auxPortSyncERxStatus, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, mgmtInstancedTable=mgmtInstancedTable, sMTPServerPortNumber=sMTPServerPortNumber, phyControlGroup=phyControlGroup, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, alarmsGroup=alarmsGroup, dNSServerPortNumber=dNSServerPortNumber, sNTPServerInternetAddress=sNTPServerInternetAddress, alarmInstancedTableEntry=alarmInstancedTableEntry, encryptionGroup=encryptionGroup, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, transmitterChannels=transmitterChannels, sFPPortSyncERxStatus=sFPPortSyncERxStatus, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, cableDiagnosticsGroup=cableDiagnosticsGroup, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, syslogControlGroup=syslogControlGroup, auxPortStatus=auxPortStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, ptpCompliance=ptpCompliance, capacityVariantMismatchLinked=capacityVariantMismatchLinked, ptpTraps=ptpTraps, tDDSynchronizationAlarm=tDDSynchronizationAlarm, mainPSUPortAllocation=mainPSUPortAllocation, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, sFPErrorTrap=sFPErrorTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tDMConfigurationMismatch=tDMConfigurationMismatch, iPv6PrefixLength=iPv6PrefixLength, receiveModulationModeLinked=receiveModulationModeLinked, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, tDMChannelStatus=tDMChannelStatus, installationMode=installationMode, licenseGasGroup=licenseGasGroup, cableDiagPair3Distance=cableDiagPair3Distance, daylightSaving=daylightSaving, remoteInternetAddressLinked=remoteInternetAddressLinked, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, receiveChannel=receiveChannel, receiveFreqKHz=receiveFreqKHz, dfsTable=dfsTable, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, aAAControl=aAAControl, linkLossLinked=linkLossLinked, bridge=bridge, authorizationControlTableEntry=authorizationControlTableEntry, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, syslogState=syslogState, userPassword=userPassword, cableDiagnosticsWarning=cableDiagnosticsWarning, sNTPSync=sNTPSync, vLANManagementVID=vLANManagementVID, sFPPortDisabledWarning=sFPPortDisabledWarning, mABNominalTransmitCapacity=mABNominalTransmitCapacity, sFPPortSSMTx=sFPPortSSMTx, licenseSecurityLevel=licenseSecurityLevel, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, erroredSeconds=erroredSeconds, userTableIndex=userTableIndex, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, licenseTDDSyncSupport=licenseTDDSyncSupport, dNS=dNS, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, remoteUnitName=remoteUnitName, antennaSelection=antennaSelection, sNMPCommunityString=sNMPCommunityString, licenseInstancedTableEntry=licenseInstancedTableEntry, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, bridgeGroup=bridgeGroup, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, ethernetPriorityTable=ethernetPriorityTable, ethernetPriorityTableEntry=ethernetPriorityTableEntry, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, mainPSUPortStatus=mainPSUPortStatus, incompatibleRegulatoryBands=incompatibleRegulatoryBands, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, ptp670=ptp670, auxPortConfigurationMismatch=auxPortConfigurationMismatch, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitModulationMode=transmitModulationMode, userTableNumber=userTableNumber, hTTPPortNumber=hTTPPortNumber, remoteUnitNameLinked=remoteUnitNameLinked, sNTPServerInternetAddressType=sNTPServerInternetAddressType, snmpControl=snmpControl, maxLinkRangeExceeded=maxLinkRangeExceeded, userEnabled=userEnabled, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, encryptionAlgorithm=encryptionAlgorithm, cableDiagPair2Results=cableDiagPair2Results, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, byteErrorRatio=byteErrorRatio, installArmStateTrap=installArmStateTrap, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, rxColorCode=rxColorCode, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, tDMChannelStatusTrap=tDMChannelStatusTrap, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, wirelessOutOctets=wirelessOutOctets, auxPortSSMTx=auxPortSSMTx, dataPortWirelessDownAlert=dataPortWirelessDownAlert, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, alarmInstancedTableIndex=alarmInstancedTableIndex, licenseHCMPSupport=licenseHCMPSupport, rawReceivePower=rawReceivePower, pubStats=pubStats, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dNSServerTable=dNSServerTable, cableDiagnosticsPorts=cableDiagnosticsPorts, subbandLowestFrequency=subbandLowestFrequency, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, frequencyVariant=frequencyVariant, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tFTPServerInternetAddress=tFTPServerInternetAddress, packetsFromInternalStack=packetsFromInternalStack, licenseInstancedTable=licenseInstancedTable, transmitPowerLinked=transmitPowerLinked, tDDSynchronizationStatus=tDDSynchronizationStatus, secondarySoftwareVersion=secondarySoftwareVersion, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, configurationInstancedTableIndex=configurationInstancedTableIndex, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, transmitDataRate=transmitDataRate, syslogClient=syslogClient, txColorCode=txColorCode, authorizationMethod=authorizationMethod, gatewayIPAddress=gatewayIPAddress, dSCPManagementPriority=dSCPManagementPriority, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, transmitPower=transmitPower, secureModeAlarm=secureModeAlarm, remoteMACAddressLinked=remoteMACAddressLinked, packetsToInternalStack=packetsToInternalStack, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, dfsTableEntry=dfsTableEntry, iPVersion=iPVersion, dfsGroup=dfsGroup, hCMPMaximumLinkRange=hCMPMaximumLinkRange, ethernetInstancedTableEntry=ethernetInstancedTableEntry, deviceMSN=deviceMSN, pubInstancedStatsTable=pubInstancedStatsTable, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, receiveModulationMode=receiveModulationMode, sntp=sntp, syncETracking=syncETracking, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, sMTPEnabledMessages=sMTPEnabledMessages, versions=versions, transmitChannel=transmitChannel, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, txMABFrames=txMABFrames, sNTPServerTableIndex=sNTPServerTableIndex, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, ethernetInstancedTableNumber=ethernetInstancedTableNumber, sNMPTrapVersion=sNMPTrapVersion, portAllocationMismatch=portAllocationMismatch, tDDControlGroup=tDDControlGroup, wirelessTopology=wirelessTopology, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, phyControlInstancedTableIndex=phyControlInstancedTableIndex, receivePower=receivePower, cambium=cambium, versionsGroup=versionsGroup, resetGroup=resetGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNMPTrapTable=sNMPTrapTable, sNMPTrapTableNumber=sNMPTrapTableNumber, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, sNTPState=sNTPState, capacityVariantMismatch=capacityVariantMismatch, mainPSUPortQLTx=mainPSUPortQLTx, sNTPServerPortNumber=sNTPServerPortNumber, l2CPPriorityTable=l2CPPriorityTable, altitude=altitude, auxPortAcceptedQLRx=auxPortAcceptedQLRx, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, tdmTable=tdmTable, dNSPrimaryServer=dNSPrimaryServer, licenseRegulatoryBandsList=licenseRegulatoryBandsList, mABProtocolVID=mABProtocolVID, licenseBandwidthCap=licenseBandwidthCap, sNTPServerTableEntry=sNTPServerTableEntry, rawReceivePowerLinked=rawReceivePowerLinked, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, licenseIPv6Support=licenseIPv6Support, cableDiagnosticsResultTable=cableDiagnosticsResultTable, secureModeAlarmTrap=secureModeAlarmTrap, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, management=management, tFTPServerPortNumber=tFTPServerPortNumber, productName=productName, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, mgmtInstancedTableNumber=mgmtInstancedTableNumber, bootVersion=bootVersion, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, sFPPortAllocation=sFPPortAllocation, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, transmitFreqMHz=transmitFreqMHz, unavailableSeconds=unavailableSeconds, extendedSpectrumScanning=extendedSpectrumScanning, transparentClockVID=transparentClockVID, syslogStateTrap=syslogStateTrap, dfsTableNumber=dfsTableNumber, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, userTable=userTable, wirelessLinkStatus=wirelessLinkStatus, sNMPTrapPortNumber=sNMPTrapPortNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", vectorError=vectorError, configurationInstancedTableEntry=configurationInstancedTableEntry, dataBridgingStatusAlarm=dataBridgingStatusAlarm, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, remoteInternetAddress=remoteInternetAddress, l2CPPriorityTableEntry=l2CPPriorityTableEntry, phyControlInstancedTable=phyControlInstancedTable, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, userName=userName, receiveModulationModeDetail=receiveModulationModeDetail, transmitModulationModeLinked=transmitModulationModeLinked, configurationInstancedTable=configurationInstancedTable, sNTPPrimaryServer=sNTPPrimaryServer, whitelistRMEnabled=whitelistRMEnabled, cableDiagnostics=cableDiagnostics, targetMACAddress=targetMACAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, searchState=searchState, qOSPriorityScheme=qOSPriorityScheme, licenseSyncESupport=licenseSyncESupport, licenseMaxLinkRange=licenseMaxLinkRange, dNSServerInternetAddress=dNSServerInternetAddress, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, syslogControl=syslogControl, supplementary=supplementary, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, dNSServerInternetAddressType=dNSServerInternetAddressType, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, l2CPPriorityTableNumber=l2CPPriorityTableNumber, licenseCountry=licenseCountry, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sFPPortQLRx=sFPPortQLRx, unitName=unitName, routerProtocols=routerProtocols, transparentClock=transparentClock, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, lbtDetectedTrap=lbtDetectedTrap, transmitDataRateLinked=transmitDataRateLinked, transparentClockVLAN=transparentClockVLAN, ethernetStatisticsTable=ethernetStatisticsTable, managementGroup=managementGroup, ethernetStatisticsDataSource=ethernetStatisticsDataSource, mainPSUPortAutoMdix=mainPSUPortAutoMdix, mainPSUPortSSMTx=mainPSUPortSSMTx, licenseTrialPeriod=licenseTrialPeriod, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, auxPortDisabledWarning=auxPortDisabledWarning, sNMPEnabledTraps=sNMPEnabledTraps, blacklistRMMacAddress=blacklistRMMacAddress, channelChangeTrap=channelChangeTrap, unitIdentificationGroup=unitIdentificationGroup, dfsMeans=dfsMeans, lowestDataModulationMode=lowestDataModulationMode, mABNominalModulationMode=mABNominalModulationMode, mABHoldoffPeriod=mABHoldoffPeriod, installStatusTrap=installStatusTrap, cableDiagPair3Results=cableDiagPair3Results, tDMEnabledChannels=tDMEnabledChannels, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, latitude=latitude)
