...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", dNSResolver=dNSResolver, installArmStateTrap=installArmStateTrap, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, nIDULanPortStatusTrap=nIDULanPortStatusTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, transmitDataRate=transmitDataRate, tDMChannelLineCode=tDMChannelLineCode, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, authorizationControl=authorizationControl, mgmtInstancedTable=mgmtInstancedTable, sFPPortSSMTx=sFPPortSSMTx, bootVersion=bootVersion, cableDiagPair3Results=cableDiagPair3Results, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, mABProtocolVLANPriority=mABProtocolVLANPriority, licenseUnitSerialNumber=licenseUnitSerialNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, useVLANForMABProtocol=useVLANForMABProtocol, ethernetPriorityTable=ethernetPriorityTable, auxPortSSMTx=auxPortSSMTx, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, deviceMACAddress=deviceMACAddress, syslogStateTrap=syslogStateTrap, dNSGroup=dNSGroup, rawReceivePowerLinked=rawReceivePowerLinked, sNTPServerInternetAddress=sNTPServerInternetAddress, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, antennaGain=antennaGain, iPVersion=iPVersion, searchStateLinked=searchStateLinked, mABProtocolVID=mABProtocolVID, licenseSecurityLevel=licenseSecurityLevel, sNTPServerTableIndex=sNTPServerTableIndex, configurationGroup=configurationGroup, remoteMACAddress=remoteMACAddress, tDMChannelStatus=tDMChannelStatus, installationMode=installationMode, sNTPServerTableNumber=sNTPServerTableNumber, wirelessOutAllOctets=wirelessOutAllOctets, sMTPServerInternetAddress=sMTPServerInternetAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, licenseSyncESupport=licenseSyncESupport, cableDiagPair4Results=cableDiagPair4Results, syncEEquipmentClock=syncEEquipmentClock, apcGroup=apcGroup, receiveChannel=receiveChannel, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, byteErrorRatioLinked=byteErrorRatioLinked, cableDiagnosticsPorts=cableDiagnosticsPorts, daylightSaving=daylightSaving, oOBPriorityQueueMapping=oOBPriorityQueueMapping, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, productName=productName, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, transparentClockVID=transparentClockVID, secureModeAlarmTrap=secureModeAlarmTrap, maximumTransmitPower=maximumTransmitPower, unavailableSeconds=unavailableSeconds, dNSServerTableNumber=dNSServerTableNumber, snmpControlGroup=snmpControlGroup, blacklistRMMacAddress=blacklistRMMacAddress, linkName=linkName, authorizationControlTableIndex=authorizationControlTableIndex, hCMPLinkSymmetry=hCMPLinkSymmetry, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, channelBandwidth=channelBandwidth, supplementaryGroup=supplementaryGroup, licenseTLSRekey=licenseTLSRekey, encryptionGroup=encryptionGroup, tdmTableNumber=tdmTableNumber, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, maxLinkRangeExceeded=maxLinkRangeExceeded, capacityVariantMismatch=capacityVariantMismatch, ethernetStatisticsTable=ethernetStatisticsTable, remoteUnitName=remoteUnitName, vLANManagementPriority=vLANManagementPriority, mainPSUPortQLTx=mainPSUPortQLTx, secondarySoftwareVersion=secondarySoftwareVersion, tDM=tDM, receivePowerLinked=receivePowerLinked, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNMPTrapInternetAddress=sNMPTrapInternetAddress, tFTPClient=tFTPClient, routerProtocolsGroup=routerProtocolsGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, sMTPEmailAlert=sMTPEmailAlert, range=range, latitude=latitude, regulatoryBandTrap=regulatoryBandTrap, userEnabled=userEnabled, ethernetPriorityTableIndex=ethernetPriorityTableIndex, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, ptpTrapPrefix=ptpTrapPrefix, receiveModulationModeDetail=receiveModulationModeDetail, tDDSynchronizationStatus=tDDSynchronizationStatus, capacityVariantMismatchLinked=capacityVariantMismatchLinked, licenseRegulatoryBandsList=licenseRegulatoryBandsList, tDMConfigurationMismatch=tDMConfigurationMismatch, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, alarmInstancedTableNumber=alarmInstancedTableNumber, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, sMTPServerPortNumber=sMTPServerPortNumber, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, dNSPrimaryServer=dNSPrimaryServer, dfsGroup=dfsGroup, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, dNSServerTableEntry=dNSServerTableEntry, syncETracking=syncETracking, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, ethernet=ethernet, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, license=license, encryption=encryption, auxPortConfigurationMismatch=auxPortConfigurationMismatch, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, iPv6GatewayAddress=iPv6GatewayAddress, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, aAAControlGroup=aAAControlGroup, ethernetPriorityTableNumber=ethernetPriorityTableNumber, alarmsGroup=alarmsGroup, transparentClock=transparentClock, nIDULanPortStatus=nIDULanPortStatus, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, unitIdentificationGroup=unitIdentificationGroup, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, licenseVersion=licenseVersion, sNTPLastSync=sNTPLastSync, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receivePower=receivePower, mgmtInstancedTableIndex=mgmtInstancedTableIndex, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, extendedSpectrumScanning=extendedSpectrumScanning, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, auxPortDisabledWarning=auxPortDisabledWarning, capacityVariantMismatchTrap=capacityVariantMismatchTrap, pubInstancedStatsTable=pubInstancedStatsTable, telnetPortNumber=telnetPortNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, authorizationControlTableNumber=authorizationControlTableNumber, aggregateDataRateLinked=aggregateDataRateLinked, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, authorizationControlTable=authorizationControlTable, dfsPeaks=dfsPeaks, sNTPServerRetries=sNTPServerRetries, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, wirelessLinkAvailability=wirelessLinkAvailability, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, deviceESN=deviceESN, systemReset=systemReset, licenseRARSupport=licenseRARSupport, mainPSUPortAllocation=mainPSUPortAllocation, linkSymmetry=linkSymmetry, linkModeOptimization=linkModeOptimization, tDMInterfaceControl=tDMInterfaceControl, l2CPPriorityTable=l2CPPriorityTable, userTable=userTable, licenseTDDSyncSupport=licenseTDDSyncSupport, cableLoss=cableLoss, dNS=dNS, receiveFreqMHz=receiveFreqMHz, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, sFPPortStatusTrap=sFPPortStatusTrap, nIDULanPortAutoMdix=nIDULanPortAutoMdix, dNSServerTableIndex=dNSServerTableIndex, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, PYSNMP_MODULE_ID=cambium, licenseMaxLinkRange=licenseMaxLinkRange, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, wirelessOutOctets=wirelessOutOctets, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, phyControlInstancedTableEntry=phyControlInstancedTableEntry, transmitChannel=transmitChannel, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, transmitPowerLinked=transmitPowerLinked, lowestTDMModulationMode=lowestTDMModulationMode, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, aAAControl=aAAControl, licenseCapacity=licenseCapacity, tFTPServerPortNumber=tFTPServerPortNumber, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, vectorError=vectorError, blacklistRMEnabled=blacklistRMEnabled, ethernetStatisticsDataSource=ethernetStatisticsDataSource, cableDiagPair1Results=cableDiagPair1Results, whitelistRMMacAddress=whitelistRMMacAddress, sNTPSync=sNTPSync, mainPSUPortStatus=mainPSUPortStatus, phyControlInstancedTableNumber=phyControlInstancedTableNumber, routerProtocols=routerProtocols, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, syslogClient=syslogClient, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, transparentClockVLAN=transparentClockVLAN, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, mgmtInstancedTableNumber=mgmtInstancedTableNumber, syslogControl=syslogControl, smtp=smtp, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, auxPortSyncERxStatus=auxPortSyncERxStatus, sNTPServerTableEntry=sNTPServerTableEntry, auxPortAcceptedQLRx=auxPortAcceptedQLRx, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, configurationInstancedTableEntry=configurationInstancedTableEntry, cableDiagPair4Distance=cableDiagPair4Distance, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, frequencyVariant=frequencyVariant, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, licenseInstancedTableIndex=licenseInstancedTableIndex, sntpGroup=sntpGroup, eIRP=eIRP, txColorCode=txColorCode, phyControlInstancedTableIndex=phyControlInstancedTableIndex, alarms=alarms, userPassword=userPassword, licenseInstancedTable=licenseInstancedTable, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, sNTPServerInternetAddressType=sNTPServerInternetAddressType, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNMPCommunityString=sNMPCommunityString, packetsFromInternalStack=packetsFromInternalStack, ethernetInstancedTableNumber=ethernetInstancedTableNumber, receiveModulationModeLinked=receiveModulationModeLinked, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogState=syslogState, pubStats=pubStats, whitelistRMEnabled=whitelistRMEnabled, authorizationControlTableEntry=authorizationControlTableEntry, l2CPPriorityTableNumber=l2CPPriorityTableNumber, supplementary=supplementary, managementGroup=managementGroup, configurationInstancedTableIndex=configurationInstancedTableIndex, systemClock=systemClock, installStatusLinked=installStatusLinked, gatewayIPAddress=gatewayIPAddress, sFPError=sFPError, phyControlGroup=phyControlGroup, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, phyControl=phyControl, transmitModulationModeLinked=transmitModulationModeLinked, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, licenseIPv6Support=licenseIPv6Support, sNMPTrapTableIndex=sNMPTrapTableIndex)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", mABTransmissionInterval=mABTransmissionInterval, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, management=management, rangeLinked=rangeLinked, altitude=altitude, accessMethod=accessMethod, licenseGroupAccess=licenseGroupAccess, cableDiagnostics=cableDiagnostics, secureModeAlarm=secureModeAlarm, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dataBridgingStatusLinked=dataBridgingStatusLinked, licenseInstancedTableNumber=licenseInstancedTableNumber, packetsToInternalStack=packetsToInternalStack, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, licenseCountry=licenseCountry, tDDControl=tDDControl, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapPortNumber=sNMPTrapPortNumber, remoteUnitNameLinked=remoteUnitNameLinked, hardwareVersion=hardwareVersion, bridge=bridge, reset=reset, tdmTableEntry=tdmTableEntry, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, cableDiagPair2Distance=cableDiagPair2Distance, remoteInternetAddress=remoteInternetAddress, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, mPLSTCPriorityTable=mPLSTCPriorityTable, mainPSUPortQLRx=mainPSUPortQLRx, licenseEncryption=licenseEncryption, sFPPortAllocation=sFPPortAllocation, dataBridgingAvailability=dataBridgingAvailability, masterSlaveMode=masterSlaveMode, sNMPTrapVersion=sNMPTrapVersion, tDMChannelCableLength=tDMChannelCableLength, tDDSynchronizationMode=tDDSynchronizationMode, remoteMACAddressLinked=remoteMACAddressLinked, transmitterChannels=transmitterChannels, mABNominalTransmitCapacity=mABNominalTransmitCapacity, phyControlInstancedTable=phyControlInstancedTable, portAllocationMismatch=portAllocationMismatch, timeZone=timeZone, ptmp=ptmp, subbandHighestFrequency=subbandHighestFrequency, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, dfsTableIndex=dfsTableIndex, auxPortQLTx=auxPortQLTx, sNTPState=sNTPState, maximumNumberOfSlaves=maximumNumberOfSlaves, cableDiagnosticsControl=cableDiagnosticsControl, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dSCPManagementPriority=dSCPManagementPriority, mABNominalModulationMode=mABNominalModulationMode, pubStatsGroup=pubStatsGroup, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, bridgeGroup=bridgeGroup, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, mABMaintenanceLevel=mABMaintenanceLevel, transmitModulationMode=transmitModulationMode, sNTPServerPortNumber=sNTPServerPortNumber, dfsMeans=dfsMeans, txMABFrames=txMABFrames, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, ptpGroups=ptpGroups, syncESlavePort=syncESlavePort, targetMACAddress=targetMACAddress, licenseOOBManagementSupport=licenseOOBManagementSupport, noWirelessChannelAvailable=noWirelessChannelAvailable, subbandLowestFrequency=subbandLowestFrequency, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNMPv3Enable=sNMPv3Enable, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, sFPPortQLTx=sFPPortQLTx, rangingMode=rangingMode, sFPPortSyncERxStatus=sFPPortSyncERxStatus, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, qOSPriorityScheme=qOSPriorityScheme, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, vLANManagementVID=vLANManagementVID, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, subnetMask=subnetMask, phyInstancedStatusTable=phyInstancedStatusTable, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, auxPortQLRx=auxPortQLRx, userTableEntry=userTableEntry, tDMChannelLoopback=tDMChannelLoopback, licenseTrialPeriod=licenseTrialPeriod, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, licenseInstancedTableEntry=licenseInstancedTableEntry, cambium=cambium, notificationsGroup=notificationsGroup, mainPSUPortAutoMdix=mainPSUPortAutoMdix, sNTPServerStatus=sNTPServerStatus, incompatibleRegulatoryBands=incompatibleRegulatoryBands, cableDiagPair3Distance=cableDiagPair3Distance, dNSServerInternetAddress=dNSServerInternetAddress, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, alarmInstancedTableEntry=alarmInstancedTableEntry, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, mgmtInstancedTableEntry=mgmtInstancedTableEntry, sNMPPortNumber=sNMPPortNumber, tdmTableIndex=tdmTableIndex, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, receiveDataRate=receiveDataRate, receiveFreqKHz=receiveFreqKHz, useVLANForManagementInterfaces=useVLANForManagementInterfaces, byteErrorRatio=byteErrorRatio, syslogClientTrap=syslogClientTrap, cableDiagnosticsResultTable=cableDiagnosticsResultTable, localPacketFiltering=localPacketFiltering, sMTPServerInternetAddressType=sMTPServerInternetAddressType, versionsGroup=versionsGroup, licenseHCMPSupport=licenseHCMPSupport, tdmTable=tdmTable, dataBridgingStatusAlarm=dataBridgingStatusAlarm, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sFPPortAutoNegotiation=sFPPortAutoNegotiation, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, apc=apc, installStatus=installStatus, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, signalStrengthRatioLinked=signalStrengthRatioLinked, transmitFreqKHz=transmitFreqKHz, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, incompatibleMasterAndSlave=incompatibleMasterAndSlave, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, tFTPServerInternetAddressType=tFTPServerInternetAddressType, installArmState=installArmState, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, productVariant=productVariant, licenseGroup=licenseGroup, sNTPSyncTrap=sNTPSyncTrap, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, tempPcb=tempPcb, cableDiagPair1Distance=cableDiagPair1Distance, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, licenseIEEE1588Support=licenseIEEE1588Support, antennaSelection=antennaSelection, alarmInstancedTable=alarmInstancedTable, tDDControlGroup=tDDControlGroup, authorizationControlGroup=authorizationControlGroup, auxPortStatus=auxPortStatus, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, wirelessOutEthernetOctets=wirelessOutEthernetOctets, sNMPTrapTableNumber=sNMPTrapTableNumber, channelChangeTrap=channelChangeTrap, licenseGasGroup=licenseGasGroup, remoteInternetAddressLinked=remoteInternetAddressLinked, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, hTTPPortNumber=hTTPPortNumber, rxColorCode=rxColorCode, userName=userName, sNTPServerTimeout=sNTPServerTimeout, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, hTTPSPortNumber=hTTPSPortNumber, ethernetInstancedTable=ethernetInstancedTable, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsTable=dfsTable, iPDSCPPriorityTable=iPDSCPPriorityTable, sNTPServerTable=sNTPServerTable, dfsTableNumber=dfsTableNumber, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, iPv4Address=iPv4Address, portAllocationMismatchLinked=portAllocationMismatchLinked, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, sFPPortQLRx=sFPPortQLRx, userTableNumber=userTableNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, l2CPPriorityTableIndex=l2CPPriorityTableIndex, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, mainPSUPortStatusTrap=mainPSUPortStatusTrap, auxPortAllocation=auxPortAllocation, hCMPMaximumLinkRange=hCMPMaximumLinkRange, mABHoldoffPeriod=mABHoldoffPeriod, licenseIssueNumber=licenseIssueNumber, dfs=dfs, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, versions=versions, tDMEnabledChannels=tDMEnabledChannels, ethernetGroup=ethernetGroup, ptpCompliance=ptpCompliance, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, managementPortWirelessDownAlert=managementPortWirelessDownAlert, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, alarmInstancedTableIndex=alarmInstancedTableIndex, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, configurationInstancedTableNumber=configurationInstancedTableNumber, transparentClockPort=transparentClockPort, sntp=sntp, transmitPower=transmitPower, tDMGroup=tDMGroup, sFPErrorTrap=sFPErrorTrap, rawReceivePower=rawReceivePower, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userTableIndex=userTableIndex, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, installStatusTrap=installStatusTrap, phyStatus=phyStatus, cableDiagPair2Results=cableDiagPair2Results, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, ethernetInstancedTableIndex=ethernetInstancedTableIndex, sNTPPrimaryServer=sNTPPrimaryServer, dataPortPauseFrames=dataPortPauseFrames, userRole=userRole, mABState=mABState, dNSServerTable=dNSServerTable, phyStatusGroup=phyStatusGroup, auxPortStatusTrap=auxPortStatusTrap, encryptionAlgorithm=encryptionAlgorithm, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, telnetAccessEnabled=telnetAccessEnabled, hTTPAccessEnabled=hTTPAccessEnabled, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, ethernetPriorityTableEntry=ethernetPriorityTableEntry, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, sFPPortAutoMdix=sFPPortAutoMdix, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dNSServerInternetAddressType=dNSServerInternetAddressType, erroredSeconds=erroredSeconds, licenseSFPPortSupport=licenseSFPPortSupport, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, ptp670=ptp670, severelyErroredSeconds=severelyErroredSeconds, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, iPv6Address=iPv6Address, managementNetworkAccessEnabled=managementNetworkAccessEnabled, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, regulatoryBand=regulatoryBand, licenseBandwidthCap=licenseBandwidthCap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, linkLossLinked=linkLossLinked, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, wirelessTopology=wirelessTopology, syncETrackingState=syncETrackingState, mainPSUPortSSMTx=mainPSUPortSSMTx, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, syslogControlGroup=syslogControlGroup, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, receiveDataRateLinked=receiveDataRateLinked, lbtDetectedTrap=lbtDetectedTrap, authorizationMethod=authorizationMethod, smtpGroup=smtpGroup, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, configurationInstancedTable=configurationInstancedTable, resetGroup=resetGroup, searchState=searchState, dfsTableEntry=dfsTableEntry, sNMPTrapTable=sNMPTrapTable, cableDiagnosticsWarning=cableDiagnosticsWarning, ptpTraps=ptpTraps, sNTPPollInterval=sNTPPollInterval, vectorErrorLinked=vectorErrorLinked, portAllocationMismatchTrap=portAllocationMismatchTrap, remoteInternetAddressType=remoteInternetAddressType, targetRange=targetRange, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tDMChannelStatusTrap=tDMChannelStatusTrap, groupID=groupID, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, sFPPortStatus=sFPPortStatus, transmitDataRateLinked=transmitDataRateLinked, dataBridgingStatus=dataBridgingStatus, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, tDMInterfaceStatus=tDMInterfaceStatus, siteName=siteName, transmitFreqMHz=transmitFreqMHz, unitIdentification=unitIdentification, sFPPortDisabledWarning=sFPPortDisabledWarning, configuration=configuration, linkLoss=linkLoss, ethernetInstancedTableEntry=ethernetInstancedTableEntry, unitOutOfCalibration=unitOutOfCalibration, dNSServerPortNumber=dNSServerPortNumber, signalStrengthRatio=signalStrengthRatio, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, deviceMSN=deviceMSN, softwareVersion=softwareVersion, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, snmpControl=snmpControl, longitude=longitude, wirelessLinkStatusLinked=wirelessLinkStatusLinked, enableTransmission=enableTransmission, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, aggregateDataRate=aggregateDataRate, cableDiagnosticsGroup=cableDiagnosticsGroup, sMTPEnabledMessages=sMTPEnabledMessages, unitName=unitName, wirelessLinkStatus=wirelessLinkStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, tFTPServerInternetAddress=tFTPServerInternetAddress, ptp=ptp, receiveModulationMode=receiveModulationMode, iPv6PrefixLength=iPv6PrefixLength, lowestDataModulationMode=lowestDataModulationMode, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry)
