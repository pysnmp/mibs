...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", versions=versions, targetRange=targetRange, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, unitIdentification=unitIdentification, licenseVersion=licenseVersion, aAAControlGroup=aAAControlGroup, transmitChannel=transmitChannel, maximumTransmitPower=maximumTransmitPower, ethernetInstancedTableIndex=ethernetInstancedTableIndex, authorizationMethod=authorizationMethod, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, ethernetInstancedTableEntry=ethernetInstancedTableEntry, dNS=dNS, bootVersion=bootVersion, mABHoldoffPeriod=mABHoldoffPeriod, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, lowestDataModulationMode=lowestDataModulationMode, l2CPPriorityTableEntry=l2CPPriorityTableEntry, tFTPServerInternetAddress=tFTPServerInternetAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, configurationInstancedTableIndex=configurationInstancedTableIndex, userName=userName, cableDiagnosticsControl=cableDiagnosticsControl, managementGroup=managementGroup, receiveFreqMHz=receiveFreqMHz, reset=reset, dfsGroup=dfsGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, wirelessOutAllOctets=wirelessOutAllOctets, txColorCode=txColorCode, phyControlInstancedTableNumber=phyControlInstancedTableNumber, accessMethod=accessMethod, nIDULanPortStatusTrap=nIDULanPortStatusTrap, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, remoteMACAddress=remoteMACAddress, secureModeAlarm=secureModeAlarm, installStatusLinked=installStatusLinked, sFPError=sFPError, sFPPortSyncERxStatus=sFPPortSyncERxStatus, mPLSTCPriorityTable=mPLSTCPriorityTable, tDMChannelStatus=tDMChannelStatus, userEnabled=userEnabled, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, PYSNMP_MODULE_ID=cambium, supplementary=supplementary, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, licenseHCMPSupport=licenseHCMPSupport, useVLANForMABProtocol=useVLANForMABProtocol, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, sFPPortStatus=sFPPortStatus, blacklistRMMacAddress=blacklistRMMacAddress, tFTPServerPortNumber=tFTPServerPortNumber, systemReset=systemReset, sFPErrorTrap=sFPErrorTrap, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, phyControlInstancedTableEntry=phyControlInstancedTableEntry, mABState=mABState, productName=productName, mABMaintenanceLevel=mABMaintenanceLevel, mainPSUPortAllocation=mainPSUPortAllocation, localPacketFiltering=localPacketFiltering, ptpTrapPrefix=ptpTrapPrefix, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dSCPManagementPriority=dSCPManagementPriority, tFTPClient=tFTPClient, pubStats=pubStats, syncETracking=syncETracking, dataBridgingStatus=dataBridgingStatus, alarms=alarms, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, transparentClockVID=transparentClockVID, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, signalStrengthRatioLinked=signalStrengthRatioLinked, licenseSFPPortSupport=licenseSFPPortSupport, alarmsGroup=alarmsGroup, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, siteName=siteName, sNTPPollInterval=sNTPPollInterval, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, wirelessLinkStatus=wirelessLinkStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, unitIdentificationGroup=unitIdentificationGroup, cableDiagnostics=cableDiagnostics, tDMChannelLoopback=tDMChannelLoopback, installArmStateTrap=installArmStateTrap, configurationInstancedTableEntry=configurationInstancedTableEntry, installStatus=installStatus, dfsTable=dfsTable, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, signalStrengthRatio=signalStrengthRatio, licenseSecurityLevel=licenseSecurityLevel, cableDiagPair1Results=cableDiagPair1Results, sNTPSync=sNTPSync, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, sNTPServerTableIndex=sNTPServerTableIndex, l2CPPriorityTableIndex=l2CPPriorityTableIndex, whitelistRMEnabled=whitelistRMEnabled, sMTPEmailAlert=sMTPEmailAlert, remoteUnitName=remoteUnitName, dataBridgingAvailability=dataBridgingAvailability, oOBPriorityQueueMapping=oOBPriorityQueueMapping, userTableIndex=userTableIndex, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, phyControlInstancedTable=phyControlInstancedTable, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, regulatoryBand=regulatoryBand, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, authorizationControl=authorizationControl, dfs=dfs, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, subbandLowestFrequency=subbandLowestFrequency, syncESlavePort=syncESlavePort, capacityVariantMismatch=capacityVariantMismatch, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, tdmTableNumber=tdmTableNumber, telnetPortNumber=telnetPortNumber, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, wirelessOutOctets=wirelessOutOctets, encryption=encryption, timeZone=timeZone, iPv6PrefixLength=iPv6PrefixLength, aAAControl=aAAControl, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, iPv6GatewayAddress=iPv6GatewayAddress, cableDiagPair2Results=cableDiagPair2Results, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, ptpTraps=ptpTraps, sNMPTrapTableEntry=sNMPTrapTableEntry, auxPortQLRx=auxPortQLRx, cambium=cambium, enableTransmission=enableTransmission, linkLoss=linkLoss, licenseInstancedTableEntry=licenseInstancedTableEntry, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, secureModeAlarmTrap=secureModeAlarmTrap, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, wirelessLinkAvailability=wirelessLinkAvailability, sFPPortSSMTx=sFPPortSSMTx, ethernetPriorityTableNumber=ethernetPriorityTableNumber, snmpControl=snmpControl, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, latitude=latitude, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, remoteMaximumTransmitPower=remoteMaximumTransmitPower, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, syslogState=syslogState, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, authorizationControlTable=authorizationControlTable, versionsGroup=versionsGroup, receivePowerLinked=receivePowerLinked, channelChangeTrap=channelChangeTrap, sFPPortQLTx=sFPPortQLTx, licenseGroupAccess=licenseGroupAccess, transmitPower=transmitPower, dNSServerTable=dNSServerTable, unitOutOfCalibration=unitOutOfCalibration, sNTPPrimaryServer=sNTPPrimaryServer, hTTPSAccessEnabled=hTTPSAccessEnabled, installArmState=installArmState, mgmtInstancedTableIndex=mgmtInstancedTableIndex, encryptionGroup=encryptionGroup, userPassword=userPassword, regulatoryBandTrap=regulatoryBandTrap, mABProtocolVLANPriority=mABProtocolVLANPriority, vectorErrorLinked=vectorErrorLinked, incompatibleRegulatoryBands=incompatibleRegulatoryBands, longitude=longitude, dNSServerTableIndex=dNSServerTableIndex, alarmInstancedTable=alarmInstancedTable, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, smtpGroup=smtpGroup, sMTPServerPortNumber=sMTPServerPortNumber, transparentClockVLAN=transparentClockVLAN, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, authorizationControlGroup=authorizationControlGroup, dataPortPauseFrames=dataPortPauseFrames, phyInstancedStatusTable=phyInstancedStatusTable, cableDiagPair3Results=cableDiagPair3Results, cableDiagPair4Results=cableDiagPair4Results, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, dfsTableEntry=dfsTableEntry, notificationsGroup=notificationsGroup, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, sNTPServerInternetAddress=sNTPServerInternetAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, phyControl=phyControl, linkName=linkName, frequencyVariant=frequencyVariant, dNSServerTableNumber=dNSServerTableNumber, ethernetStatisticsTable=ethernetStatisticsTable, auxPortQLTx=auxPortQLTx, whitelistRMMacAddress=whitelistRMMacAddress, ptp670=ptp670, portAllocationMismatchLinked=portAllocationMismatchLinked, remoteUnitNameLinked=remoteUnitNameLinked, hCMPMaximumLinkRange=hCMPMaximumLinkRange, sNMPTrapTableIndex=sNMPTrapTableIndex, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, license=license, syslogStateTrap=syslogStateTrap, vLANManagementVID=vLANManagementVID, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, iPv6Address=iPv6Address, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, rawReceivePower=rawReceivePower, receiveFreqKHz=receiveFreqKHz, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, searchState=searchState, antennaGain=antennaGain, syslogControl=syslogControl, mainPSUPortAutoMdix=mainPSUPortAutoMdix, remoteInternetAddressType=remoteInternetAddressType, auxPortSSMTx=auxPortSSMTx, hTTPSPortNumber=hTTPSPortNumber, byteErrorRatioLinked=byteErrorRatioLinked, capacityVariantMismatchLinked=capacityVariantMismatchLinked, sNMPCommunityString=sNMPCommunityString, licenseMaxLinkRange=licenseMaxLinkRange, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, dNSServerInternetAddressType=dNSServerInternetAddressType, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapPortNumber=sNMPTrapPortNumber, deviceESN=deviceESN, erroredSeconds=erroredSeconds, syslogClient=syslogClient, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, mainPSUPortQLTx=mainPSUPortQLTx, wirelessLinkStatusLinked=wirelessLinkStatusLinked, ptpGroups=ptpGroups, cableDiagPair4Distance=cableDiagPair4Distance, ptmp=ptmp, hTTPPortNumber=hTTPPortNumber, tDDControl=tDDControl, txMABFrames=txMABFrames, sFPPortAllocation=sFPPortAllocation, dNSServerInternetAddress=dNSServerInternetAddress, sFPPortStatusTrap=sFPPortStatusTrap, tDDControlGroup=tDDControlGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", tDDSynchronizationMode=tDDSynchronizationMode, licenseTDDSyncSupport=licenseTDDSyncSupport, linkModeOptimizationMismatch=linkModeOptimizationMismatch, deviceMACAddress=deviceMACAddress, managementPortWirelessDownAlert=managementPortWirelessDownAlert, hCMPLinkSymmetry=hCMPLinkSymmetry, daylightSaving=daylightSaving, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, wirelessOutEthernetOctets=wirelessOutEthernetOctets, licenseIEEE1588Support=licenseIEEE1588Support, auxPortConfigurationMismatch=auxPortConfigurationMismatch, subbandHighestFrequency=subbandHighestFrequency, supplementaryGroup=supplementaryGroup, portAllocationMismatchTrap=portAllocationMismatchTrap, sFPPortDisabledWarning=sFPPortDisabledWarning, rangeLinked=rangeLinked, sFPPortAutoNegotiation=sFPPortAutoNegotiation, tDMEnabledChannels=tDMEnabledChannels, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, apcGroup=apcGroup, sNTPServerTableNumber=sNTPServerTableNumber, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, searchStateLinked=searchStateLinked, authorizationControlTableNumber=authorizationControlTableNumber, auxPortAllocation=auxPortAllocation, telnetAccessEnabled=telnetAccessEnabled, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, byteErrorRatio=byteErrorRatio, sNTPServerTimeout=sNTPServerTimeout, remoteInternetAddress=remoteInternetAddress, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, syncEEquipmentClock=syncEEquipmentClock, dfsTableIndex=dfsTableIndex, licenseIPv6Support=licenseIPv6Support, mABTransmissionInterval=mABTransmissionInterval, wirelessTopology=wirelessTopology, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, l2CPPriorityTable=l2CPPriorityTable, rawReceivePowerLinked=rawReceivePowerLinked, masterSlaveMode=masterSlaveMode, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, sNMPEnabledTraps=sNMPEnabledTraps, mainPSUPortStatusTrap=mainPSUPortStatusTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, deviceMSN=deviceMSN, tDMGroup=tDMGroup, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, transmitModulationModeLinked=transmitModulationModeLinked, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, groupID=groupID, remoteInternetAddressLinked=remoteInternetAddressLinked, tempPcb=tempPcb, aggregateDataRate=aggregateDataRate, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, mgmtInstancedTableEntry=mgmtInstancedTableEntry, authorizationControlTableIndex=authorizationControlTableIndex, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, receiveDataRateLinked=receiveDataRateLinked, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, tDM=tDM, gatewayIPAddress=gatewayIPAddress, alarmInstancedTableIndex=alarmInstancedTableIndex, linkModeOptimization=linkModeOptimization, sNMPTrapInternetAddress=sNMPTrapInternetAddress, receiveDataRate=receiveDataRate, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, packetsFromInternalStack=packetsFromInternalStack, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, tdmTableEntry=tdmTableEntry, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, resetGroup=resetGroup, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, ethernet=ethernet, sFPPortQLRx=sFPPortQLRx, softwareVersion=softwareVersion, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, ptpCompliance=ptpCompliance, userTableEntry=userTableEntry, cableDiagPair2Distance=cableDiagPair2Distance, dNSServerTableEntry=dNSServerTableEntry, sNTPServerPortNumber=sNTPServerPortNumber, dNSResolver=dNSResolver, userTableNumber=userTableNumber, altitude=altitude, tDMConfigurationMismatch=tDMConfigurationMismatch, productVariant=productVariant, tDMInterfaceStatus=tDMInterfaceStatus, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, sNTPServerRetries=sNTPServerRetries, licenseUnitSerialNumber=licenseUnitSerialNumber, encryptionAlgorithm=encryptionAlgorithm, cableDiagnosticsWarning=cableDiagnosticsWarning, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, mainPSUPortSSMTx=mainPSUPortSSMTx, receiveChannel=receiveChannel, transmitModulationMode=transmitModulationMode, dfsTableNumber=dfsTableNumber, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, licenseSyncESupport=licenseSyncESupport, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, maxLinkRangeExceeded=maxLinkRangeExceeded, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, licenseTLSRekey=licenseTLSRekey, transparentClock=transparentClock, sntpGroup=sntpGroup, smtp=smtp, configurationInstancedTable=configurationInstancedTable, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, tdmTable=tdmTable, packetsToInternalStack=packetsToInternalStack, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tDMInterfaceControl=tDMInterfaceControl, cableDiagnosticsGroup=cableDiagnosticsGroup, licenseGroup=licenseGroup, vectorError=vectorError, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, mgmtInstancedTableNumber=mgmtInstancedTableNumber, sNTPServerStatus=sNTPServerStatus, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, cableDiagnosticsPorts=cableDiagnosticsPorts, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, sNMPTrapTable=sNMPTrapTable, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, dataBridgingStatusAlarm=dataBridgingStatusAlarm, ethernetGroup=ethernetGroup, tDMChannelCableLength=tDMChannelCableLength, licenseBandwidthCap=licenseBandwidthCap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tDMChannelLineCode=tDMChannelLineCode, severelyErroredSeconds=severelyErroredSeconds, blacklistRMEnabled=blacklistRMEnabled, sMTPServerInternetAddress=sMTPServerInternetAddress, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, licenseInstancedTableIndex=licenseInstancedTableIndex, transparentClockPort=transparentClockPort, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, routerProtocols=routerProtocols, sNMPv3Enable=sNMPv3Enable, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, mABNominalTransmitCapacity=mABNominalTransmitCapacity, capacityVariantMismatchTrap=capacityVariantMismatchTrap, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, ethernetInstancedTableNumber=ethernetInstancedTableNumber, configuration=configuration, userTable=userTable, portAllocationMismatch=portAllocationMismatch, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, hardwareVersion=hardwareVersion, snmpControlGroup=snmpControlGroup, configurationGroup=configurationGroup, ptp=ptp, ethernetInstancedTable=ethernetInstancedTable, eIRP=eIRP, pubStatsGroup=pubStatsGroup, tDMChannelStatusTrap=tDMChannelStatusTrap, ethernetStatisticsDataSource=ethernetStatisticsDataSource, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, phyStatus=phyStatus, rangingMode=rangingMode, sntp=sntp, tDDSynchronizationStatus=tDDSynchronizationStatus, syslogClientTrap=syslogClientTrap, dNSPrimaryServer=dNSPrimaryServer, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, subnetMask=subnetMask, mainPSUPortQLRx=mainPSUPortQLRx, aggregateDataRateLinked=aggregateDataRateLinked, sNTPSyncTrap=sNTPSyncTrap, auxPortStatusTrap=auxPortStatusTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, authorizationControlTableEntry=authorizationControlTableEntry, tdmTableIndex=tdmTableIndex, licenseInstancedTableNumber=licenseInstancedTableNumber, rxColorCode=rxColorCode, nIDULanPortStatus=nIDULanPortStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, userRole=userRole, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, receiveModulationModeDetail=receiveModulationModeDetail, secondarySoftwareVersion=secondarySoftwareVersion, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, maximumNumberOfSlaves=maximumNumberOfSlaves, pubInstancedStatsTable=pubInstancedStatsTable, licenseEncryption=licenseEncryption, dNSServerPortNumber=dNSServerPortNumber, phyControlInstancedTableIndex=phyControlInstancedTableIndex, receiveModulationModeLinked=receiveModulationModeLinked, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, lbtDetectedTrap=lbtDetectedTrap, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, cableDiagPair1Distance=cableDiagPair1Distance, syslogLocalWrappedTrap=syslogLocalWrappedTrap, iPv4Address=iPv4Address, hTTPAccessEnabled=hTTPAccessEnabled, sNTPServerTable=sNTPServerTable, dNSGroup=dNSGroup, installStatusTrap=installStatusTrap, sNTPState=sNTPState, dataPortWirelessDownAlert=dataPortWirelessDownAlert, antennaSelection=antennaSelection, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, mABNominalModulationMode=mABNominalModulationMode, remoteMACAddressLinked=remoteMACAddressLinked, transmitDataRateLinked=transmitDataRateLinked, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, installationMode=installationMode, dataBridgingStatusLinked=dataBridgingStatusLinked, transmitPowerLinked=transmitPowerLinked, management=management, licenseOOBManagementSupport=licenseOOBManagementSupport, licenseRegulatoryBandsList=licenseRegulatoryBandsList, systemClock=systemClock, auxPortDisabledWarning=auxPortDisabledWarning, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, transmitFreqKHz=transmitFreqKHz, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, sMTPSourceEmailAddress=sMTPSourceEmailAddress, auxPortSyncERxStatus=auxPortSyncERxStatus, mgmtInstancedTable=mgmtInstancedTable, licenseIssueNumber=licenseIssueNumber, cableLoss=cableLoss, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, licenseGasGroup=licenseGasGroup, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, sNMPTrapVersion=sNMPTrapVersion, noWirelessChannelAvailable=noWirelessChannelAvailable, phyStatusGroup=phyStatusGroup, dfsPeaks=dfsPeaks, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, range=range, licenseCountry=licenseCountry, licenseCapacity=licenseCapacity, syncETrackingState=syncETrackingState, routerProtocolsGroup=routerProtocolsGroup, channelBandwidth=channelBandwidth, tFTPServerInternetAddressType=tFTPServerInternetAddressType)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", receiveModulationMode=receiveModulationMode, dfsMeans=dfsMeans, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, ethernetPriorityTable=ethernetPriorityTable, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, mainPSUPortStatus=mainPSUPortStatus, bridge=bridge, auxPortAcceptedQLRx=auxPortAcceptedQLRx, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, linkSymmetry=linkSymmetry, mABProtocolVID=mABProtocolVID, managementNetworkAccessEnabled=managementNetworkAccessEnabled, linkLossLinked=linkLossLinked, vLANManagementPriority=vLANManagementPriority, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, licenseInstancedTable=licenseInstancedTable, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, transmitDataRate=transmitDataRate, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, unavailableSeconds=unavailableSeconds, cableDiagnosticsResultTable=cableDiagnosticsResultTable, lowestTDMModulationMode=lowestTDMModulationMode, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, alarmInstancedTableEntry=alarmInstancedTableEntry, apc=apc, transmitterChannels=transmitterChannels, receivePower=receivePower, enabledDiagnosticAlarms=enabledDiagnosticAlarms, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, transmitFreqMHz=transmitFreqMHz, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, unitName=unitName, iPDSCPPriorityTable=iPDSCPPriorityTable, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, iPVersion=iPVersion, configurationInstancedTableNumber=configurationInstancedTableNumber, qOSPriorityScheme=qOSPriorityScheme, licenseRARSupport=licenseRARSupport, sNTPLastSync=sNTPLastSync, extendedSpectrumScanning=extendedSpectrumScanning, targetMACAddress=targetMACAddress, sNMPPortNumber=sNMPPortNumber, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, phyControlGroup=phyControlGroup, cableDiagPair3Distance=cableDiagPair3Distance, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, syslogControlGroup=syslogControlGroup, alarmInstancedTableNumber=alarmInstancedTableNumber, auxPortStatus=auxPortStatus, bridgeGroup=bridgeGroup, sNTPServerTableEntry=sNTPServerTableEntry, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, nIDULanPortAutoMdix=nIDULanPortAutoMdix, licenseTrialPeriod=licenseTrialPeriod, sFPPortAutoMdix=sFPPortAutoMdix)
