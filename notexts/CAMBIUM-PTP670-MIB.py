...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", dNSServerTableIndex=dNSServerTableIndex, sNTPServerInternetAddressType=sNTPServerInternetAddressType, licenseTDDSyncSupport=licenseTDDSyncSupport, alarmInstancedTableEntry=alarmInstancedTableEntry, alarmInstancedTable=alarmInstancedTable, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, licenseIssueNumber=licenseIssueNumber, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, cableDiagPair1Results=cableDiagPair1Results, syslogState=syslogState, installArmState=installArmState, routerProtocolsGroup=routerProtocolsGroup, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, txMABFrames=txMABFrames, cambium=cambium, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, erroredSeconds=erroredSeconds, wirelessTopology=wirelessTopology, sNMPTrapTable=sNMPTrapTable, sNTPServerRetries=sNTPServerRetries, receivePowerLinked=receivePowerLinked, auxPortQLTx=auxPortQLTx, dataBridgingStatusLinked=dataBridgingStatusLinked, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tDMChannelLoopback=tDMChannelLoopback, vectorError=vectorError, dNS=dNS, pubStatsGroup=pubStatsGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dataPortPauseFrames=dataPortPauseFrames, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, incompatibleRegulatoryBands=incompatibleRegulatoryBands, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, installStatusLinked=installStatusLinked, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, syslogControl=syslogControl, licenseGroupAccess=licenseGroupAccess, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, dataBridgingAvailability=dataBridgingAvailability, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, accessMethod=accessMethod, management=management, hardwareVersion=hardwareVersion, sNMPTrapInternetAddress=sNMPTrapInternetAddress, tDDControlGroup=tDDControlGroup, sNTPState=sNTPState, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, sFPPortAutoNegotiation=sFPPortAutoNegotiation, maximumTransmitPower=maximumTransmitPower, encryptionGroup=encryptionGroup, tDMChannelStatus=tDMChannelStatus, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, encryptionAlgorithm=encryptionAlgorithm, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, sFPError=sFPError, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNTPServerStatus=sNTPServerStatus, licenseHCMPSupport=licenseHCMPSupport, installArmStateTrap=installArmStateTrap, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, auxPortStatusTrap=auxPortStatusTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, secureModeAlarmTrap=secureModeAlarmTrap, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, aAAControlGroup=aAAControlGroup, syncETracking=syncETracking, sMTPEmailAlert=sMTPEmailAlert, iPv6GatewayAddress=iPv6GatewayAddress, receiveFreqKHz=receiveFreqKHz, mainPSUPortStatusTrap=mainPSUPortStatusTrap, configurationInstancedTableIndex=configurationInstancedTableIndex, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, licenseCapacity=licenseCapacity, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataBridgingStatusAlarm=dataBridgingStatusAlarm, cableDiagnosticsWarning=cableDiagnosticsWarning, remoteUnitName=remoteUnitName, cableLoss=cableLoss, ethernetPriorityTableNumber=ethernetPriorityTableNumber, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sFPPortSSMTx=sFPPortSSMTx, auxPortQLRx=auxPortQLRx, linkModeOptimization=linkModeOptimization, wirelessOutEthernetOctets=wirelessOutEthernetOctets, regulatoryBand=regulatoryBand, remoteUnitNameLinked=remoteUnitNameLinked, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, bridge=bridge, transparentClockVLAN=transparentClockVLAN, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, wirelessLinkAvailability=wirelessLinkAvailability, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, tDMInterfaceControl=tDMInterfaceControl, dfs=dfs, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, searchState=searchState, systemReset=systemReset, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, auxPortStatus=auxPortStatus, auxPortAllocation=auxPortAllocation, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, dfsGroup=dfsGroup, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, supplementaryGroup=supplementaryGroup, transparentClock=transparentClock, cableDiagnosticsGroup=cableDiagnosticsGroup, sFPPortStatus=sFPPortStatus, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, licenseCountry=licenseCountry, licenseSyncESupport=licenseSyncESupport, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, receivePower=receivePower, resetGroup=resetGroup, licenseMaxLinkRange=licenseMaxLinkRange, receiveDataRate=receiveDataRate, userName=userName, tDMGroup=tDMGroup, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, sNMPTrapTableNumber=sNMPTrapTableNumber, configurationInstancedTableNumber=configurationInstancedTableNumber, capacityVariantMismatch=capacityVariantMismatch, hCMPMaximumLinkRange=hCMPMaximumLinkRange, mgmtInstancedTableNumber=mgmtInstancedTableNumber, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, dfsTableEntry=dfsTableEntry, tFTPClient=tFTPClient, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, snmpControlGroup=snmpControlGroup, maxLinkRangeExceeded=maxLinkRangeExceeded, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, unitOutOfCalibration=unitOutOfCalibration, latitude=latitude, licenseTLSRekey=licenseTLSRekey, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, phyStatusGroup=phyStatusGroup, syncETrackingState=syncETrackingState, licenseOOBManagementSupport=licenseOOBManagementSupport, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, groupID=groupID, phyInstancedStatusTable=phyInstancedStatusTable, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, frequencyVariant=frequencyVariant, sNTPServerTableNumber=sNTPServerTableNumber, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, maximumNumberOfSlaves=maximumNumberOfSlaves, packetsFromInternalStack=packetsFromInternalStack, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, configuration=configuration, dataBridgingStatus=dataBridgingStatus, vLANManagementPriority=vLANManagementPriority, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, dfsTableIndex=dfsTableIndex, severelyErroredSeconds=severelyErroredSeconds, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, tDMConfigurationMismatch=tDMConfigurationMismatch, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, userTableEntry=userTableEntry, transparentClockVID=transparentClockVID, ptp=ptp, authorizationMethod=authorizationMethod, dNSServerPortNumber=dNSServerPortNumber, tdmTableEntry=tdmTableEntry, portAllocationMismatch=portAllocationMismatch, sntpGroup=sntpGroup, subnetMask=subnetMask, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, phyControlGroup=phyControlGroup, tDMChannelLineCode=tDMChannelLineCode, iPv6Address=iPv6Address, iPVersion=iPVersion, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, remoteMACAddressLinked=remoteMACAddressLinked, wirelessLinkStatusLinked=wirelessLinkStatusLinked, dfsTable=dfsTable, mgmtInstancedTable=mgmtInstancedTable, sFPPortDisabledWarning=sFPPortDisabledWarning, l2CPPriorityTableEntry=l2CPPriorityTableEntry, channelChangeTrap=channelChangeTrap, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, targetRange=targetRange, deviceESN=deviceESN, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, portAllocationMismatchTrap=portAllocationMismatchTrap, sNTPPollInterval=sNTPPollInterval, siteName=siteName, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, transmitModulationModeLinked=transmitModulationModeLinked, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, tdmTable=tdmTable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, cableDiagPair1Distance=cableDiagPair1Distance, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, receiveModulationModeDetail=receiveModulationModeDetail, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, userTable=userTable, phyStatus=phyStatus, userEnabled=userEnabled, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, configurationInstancedTableEntry=configurationInstancedTableEntry, alarmInstancedTableNumber=alarmInstancedTableNumber, cableDiagPair3Results=cableDiagPair3Results, sNMPPortNumber=sNMPPortNumber, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, aggregateDataRate=aggregateDataRate, remoteInternetAddressType=remoteInternetAddressType, channelBandwidth=channelBandwidth, packetsToInternalStack=packetsToInternalStack, targetMACAddress=targetMACAddress, installationMode=installationMode, ethernetInstancedTable=ethernetInstancedTable, receiveModulationMode=receiveModulationMode, sNTPLastSync=sNTPLastSync, unitIdentification=unitIdentification, range=range, whitelistRMMacAddress=whitelistRMMacAddress, transmitDataRate=transmitDataRate, licenseUnitSerialNumber=licenseUnitSerialNumber, tDMEnabledChannels=tDMEnabledChannels, syslogClient=syslogClient, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, signalStrengthRatioLinked=signalStrengthRatioLinked, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, receiveChannel=receiveChannel, nIDULanPortStatusTrap=nIDULanPortStatusTrap, cableDiagnosticsControl=cableDiagnosticsControl, mainPSUPortQLTx=mainPSUPortQLTx, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, licenseIPv6Support=licenseIPv6Support, tDMChannelCableLength=tDMChannelCableLength, mPLSTCPriorityTable=mPLSTCPriorityTable, hTTPAccessEnabled=hTTPAccessEnabled, linkSymmetry=linkSymmetry, syslogStateTrap=syslogStateTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", hTTPPortNumber=hTTPPortNumber, unitName=unitName, auxPortConfigurationMismatch=auxPortConfigurationMismatch, sntp=sntp, antennaSelection=antennaSelection, authorizationControlTableNumber=authorizationControlTableNumber, configurationInstancedTable=configurationInstancedTable, tDDSynchronizationStatus=tDDSynchronizationStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, transmitPowerLinked=transmitPowerLinked, phyControlInstancedTableNumber=phyControlInstancedTableNumber, whitelistRMEnabled=whitelistRMEnabled, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sFPPortQLTx=sFPPortQLTx, receiveDataRateLinked=receiveDataRateLinked, qOSPriorityScheme=qOSPriorityScheme, ethernetStatisticsDataSource=ethernetStatisticsDataSource, tDMInterfaceStatus=tDMInterfaceStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, phyControlInstancedTable=phyControlInstancedTable, alarms=alarms, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, capacityVariantMismatchTrap=capacityVariantMismatchTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, authorizationControlTableIndex=authorizationControlTableIndex, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, phyControlInstancedTableEntry=phyControlInstancedTableEntry, ethernetPriorityTableIndex=ethernetPriorityTableIndex, transmitChannel=transmitChannel, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, iPv4Address=iPv4Address, mABProtocolVID=mABProtocolVID, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, ethernetPriorityTable=ethernetPriorityTable, l2CPPriorityTable=l2CPPriorityTable, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, installStatusTrap=installStatusTrap, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, portAllocationMismatchLinked=portAllocationMismatchLinked, configurationGroup=configurationGroup, tFTPServerInternetAddress=tFTPServerInternetAddress, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, sNTPServerTableIndex=sNTPServerTableIndex, sNMPv3Enable=sNMPv3Enable, subbandHighestFrequency=subbandHighestFrequency, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, mainPSUPortAutoMdix=mainPSUPortAutoMdix, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, syncESlavePort=syncESlavePort, sNTPServerPortNumber=sNTPServerPortNumber, tDDSynchronizationMode=tDDSynchronizationMode, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, byteErrorRatio=byteErrorRatio, mABNominalModulationMode=mABNominalModulationMode, syslogClientTrap=syslogClientTrap, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, cableDiagnostics=cableDiagnostics, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, cableDiagPair2Distance=cableDiagPair2Distance, ethernetInstancedTableEntry=ethernetInstancedTableEntry, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, smtp=smtp, secureModeAlarm=secureModeAlarm, ethernetGroup=ethernetGroup, dNSServerInternetAddressType=dNSServerInternetAddressType, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, deviceMSN=deviceMSN, syncEEquipmentClock=syncEEquipmentClock, sNMPEnabledTraps=sNMPEnabledTraps, tdmTableIndex=tdmTableIndex, transmitterChannels=transmitterChannels, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, telnetPortNumber=telnetPortNumber, sFPPortAutoMdix=sFPPortAutoMdix, sFPPortSyncERxStatus=sFPPortSyncERxStatus, linkLossLinked=linkLossLinked, cableDiagPair4Results=cableDiagPair4Results, dNSServerInternetAddress=dNSServerInternetAddress, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, PYSNMP_MODULE_ID=cambium, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sFPPortAllocation=sFPPortAllocation, transmitFreqKHz=transmitFreqKHz, rawReceivePower=rawReceivePower, tDDControl=tDDControl, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, apc=apc, aAAControl=aAAControl, transparentClockPort=transparentClockPort, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, mgmtInstancedTableEntry=mgmtInstancedTableEntry, mainPSUPortAllocation=mainPSUPortAllocation, sNMPTrapPortNumber=sNMPTrapPortNumber, byteErrorRatioLinked=byteErrorRatioLinked, lbtDetectedTrap=lbtDetectedTrap, nIDULanPortStatus=nIDULanPortStatus, ethernetStatisticsTable=ethernetStatisticsTable, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, auxPortSyncERxStatus=auxPortSyncERxStatus, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, userTableIndex=userTableIndex, managementNetworkAccessEnabled=managementNetworkAccessEnabled, rawReceivePowerLinked=rawReceivePowerLinked, userRole=userRole, routerProtocols=routerProtocols, remoteInternetAddressLinked=remoteInternetAddressLinked, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, longitude=longitude, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, snmpControl=snmpControl, eIRP=eIRP, managementPortWirelessDownAlert=managementPortWirelessDownAlert, cableDiagPair4Distance=cableDiagPair4Distance, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ptpTrapPrefix=ptpTrapPrefix, encryption=encryption, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, authorizationControl=authorizationControl, txColorCode=txColorCode, blacklistRMEnabled=blacklistRMEnabled, tFTPServerPortNumber=tFTPServerPortNumber, managementGroup=managementGroup, dNSResolver=dNSResolver, useVLANForMABProtocol=useVLANForMABProtocol, secondarySoftwareVersion=secondarySoftwareVersion, licenseGasGroup=licenseGasGroup, licenseInstancedTable=licenseInstancedTable, dNSServerTableNumber=dNSServerTableNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, iPDSCPPriorityTable=iPDSCPPriorityTable, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, licenseInstancedTableEntry=licenseInstancedTableEntry, sMTPServerInternetAddress=sMTPServerInternetAddress, licenseEncryption=licenseEncryption, wirelessOutAllOctets=wirelessOutAllOctets, masterSlaveMode=masterSlaveMode, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, tDMChannelStatusTrap=tDMChannelStatusTrap, ethernet=ethernet, transmitFreqMHz=transmitFreqMHz, cableDiagnosticsResultTable=cableDiagnosticsResultTable, tFTPServerInternetAddressType=tFTPServerInternetAddressType, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, mABState=mABState, productVariant=productVariant, systemClock=systemClock, alarmInstancedTableIndex=alarmInstancedTableIndex, sFPErrorTrap=sFPErrorTrap, blacklistRMMacAddress=blacklistRMMacAddress, licenseTrialPeriod=licenseTrialPeriod, sNTPSync=sNTPSync, hCMPLinkSymmetry=hCMPLinkSymmetry, enableTransmission=enableTransmission, tdmTableNumber=tdmTableNumber, authorizationControlGroup=authorizationControlGroup, mgmtInstancedTableIndex=mgmtInstancedTableIndex, mABNominalTransmitCapacity=mABNominalTransmitCapacity, sFPPortStatusTrap=sFPPortStatusTrap, linkLoss=linkLoss, mABTransmissionInterval=mABTransmissionInterval, wirelessLinkStatus=wirelessLinkStatus, licenseVersion=licenseVersion, licenseRegulatoryBandsList=licenseRegulatoryBandsList, sNTPServerInternetAddress=sNTPServerInternetAddress, sNTPServerTableEntry=sNTPServerTableEntry, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, transmitModulationMode=transmitModulationMode, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, pubInstancedStatsTable=pubInstancedStatsTable, vLANManagementVID=vLANManagementVID, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, signalStrengthRatio=signalStrengthRatio, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, mABHoldoffPeriod=mABHoldoffPeriod, hTTPSPortNumber=hTTPSPortNumber, mABMaintenanceLevel=mABMaintenanceLevel, dfsPeaks=dfsPeaks, antennaGain=antennaGain, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, userTableNumber=userTableNumber, localPacketFiltering=localPacketFiltering, licenseInstancedTableIndex=licenseInstancedTableIndex, licenseRARSupport=licenseRARSupport, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, remoteMaximumTransmitPower=remoteMaximumTransmitPower, extendedSpectrumScanning=extendedSpectrumScanning, nIDULanPortAutoMdix=nIDULanPortAutoMdix, sFPPortQLRx=sFPPortQLRx, dNSServerTable=dNSServerTable, dNSGroup=dNSGroup, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, dNSServerTableEntry=dNSServerTableEntry, wirelessOutOctets=wirelessOutOctets, dfsTableNumber=dfsTableNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, receiveFreqMHz=receiveFreqMHz, ptmp=ptmp, telnetAccessEnabled=telnetAccessEnabled, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, licenseSFPPortSupport=licenseSFPPortSupport, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, softwareVersion=softwareVersion, timeZone=timeZone, deviceMACAddress=deviceMACAddress, installStatus=installStatus, sMTPServerPortNumber=sMTPServerPortNumber, mainPSUPortSSMTx=mainPSUPortSSMTx, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, rangingMode=rangingMode, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, daylightSaving=daylightSaving, capacityVariantMismatchLinked=capacityVariantMismatchLinked, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tDM=tDM, tempPcb=tempPcb, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, licenseInstancedTableNumber=licenseInstancedTableNumber, lowestDataModulationMode=lowestDataModulationMode, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, productName=productName, remoteMACAddress=remoteMACAddress, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, pubStats=pubStats, ethernetInstancedTableIndex=ethernetInstancedTableIndex, aggregateDataRateLinked=aggregateDataRateLinked, licenseBandwidthCap=licenseBandwidthCap, rxColorCode=rxColorCode, hTTPSAccessEnabled=hTTPSAccessEnabled, auxPortDisabledWarning=auxPortDisabledWarning, vectorErrorLinked=vectorErrorLinked, searchStateLinked=searchStateLinked, sNMPCommunityString=sNMPCommunityString, alarmsGroup=alarmsGroup, oOBPriorityQueueMapping=oOBPriorityQueueMapping, licenseGroup=licenseGroup, reset=reset, versions=versions, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, cableDiagnosticsPorts=cableDiagnosticsPorts, transmitPower=transmitPower, license=license, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, bridgeGroup=bridgeGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", ptpCompliance=ptpCompliance, sNTPServerTimeout=sNTPServerTimeout, ptpGroups=ptpGroups, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, sMTPEnabledMessages=sMTPEnabledMessages, smtpGroup=smtpGroup, ptpTraps=ptpTraps, syslogLocalWrappedTrap=syslogLocalWrappedTrap, licenseIEEE1588Support=licenseIEEE1588Support, authorizationControlTable=authorizationControlTable, licenseSecurityLevel=licenseSecurityLevel, cableDiagPair3Distance=cableDiagPair3Distance, gatewayIPAddress=gatewayIPAddress, bootVersion=bootVersion, ethernetInstancedTableNumber=ethernetInstancedTableNumber, iPv6PrefixLength=iPv6PrefixLength, subbandLowestFrequency=subbandLowestFrequency, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, remoteInternetAddress=remoteInternetAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, ptp670=ptp670, auxPortSSMTx=auxPortSSMTx, dfsMeans=dfsMeans, auxPortAcceptedQLRx=auxPortAcceptedQLRx, transmitDataRateLinked=transmitDataRateLinked, dSCPManagementPriority=dSCPManagementPriority, cableDiagPair2Results=cableDiagPair2Results, linkName=linkName, dNSPrimaryServer=dNSPrimaryServer, sNTPSyncTrap=sNTPSyncTrap, sNTPServerTable=sNTPServerTable, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, versionsGroup=versionsGroup, supplementary=supplementary, mainPSUPortStatus=mainPSUPortStatus, apcGroup=apcGroup, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, lowestTDMModulationMode=lowestTDMModulationMode, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPServerInternetAddressType=sMTPServerInternetAddressType, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, regulatoryBandTrap=regulatoryBandTrap, userPassword=userPassword, unitIdentificationGroup=unitIdentificationGroup, mainPSUPortQLRx=mainPSUPortQLRx, unavailableSeconds=unavailableSeconds, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, syslogControlGroup=syslogControlGroup, authorizationControlTableEntry=authorizationControlTableEntry, mABProtocolVLANPriority=mABProtocolVLANPriority, phyControl=phyControl, receiveModulationModeLinked=receiveModulationModeLinked, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, sNTPPrimaryServer=sNTPPrimaryServer, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, phyControlInstancedTableIndex=phyControlInstancedTableIndex, notificationsGroup=notificationsGroup, rangeLinked=rangeLinked, altitude=altitude)
