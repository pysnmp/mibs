...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", daylightSaving=daylightSaving, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, mgmtInstancedTableIndex=mgmtInstancedTableIndex, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNTPSyncTrap=sNTPSyncTrap, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, alarmsGroup=alarmsGroup, wirelessLinkStatusLinked=wirelessLinkStatusLinked, cableDiagPair3Results=cableDiagPair3Results, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, dfsTableEntry=dfsTableEntry, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, maximumTransmitPower=maximumTransmitPower, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, transmitterChannels=transmitterChannels, phyControlInstancedTableNumber=phyControlInstancedTableNumber, sNTPSync=sNTPSync, cambium=cambium, licenseInstancedTableEntry=licenseInstancedTableEntry, iPv4Address=iPv4Address, wirelessOutEthernetOctets=wirelessOutEthernetOctets, ethernetPriorityTable=ethernetPriorityTable, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, installationMode=installationMode, subbandHighestFrequency=subbandHighestFrequency, ethernetGroup=ethernetGroup, phyControlGroup=phyControlGroup, syslogControlGroup=syslogControlGroup, licenseTDDSyncSupport=licenseTDDSyncSupport, dNSGroup=dNSGroup, syncETracking=syncETracking, tFTPServerPortNumber=tFTPServerPortNumber, lowestDataModulationMode=lowestDataModulationMode, tDMInterfaceControl=tDMInterfaceControl, dataPortWirelessDownAlert=dataPortWirelessDownAlert, signalStrengthRatioLinked=signalStrengthRatioLinked, lbtDetectedTrap=lbtDetectedTrap, dataBridgingStatus=dataBridgingStatus, configurationGroup=configurationGroup, sFPPortStatus=sFPPortStatus, phyControlInstancedTable=phyControlInstancedTable, receiveFreqMHz=receiveFreqMHz, reset=reset, remoteMACAddressLinked=remoteMACAddressLinked, installStatusTrap=installStatusTrap, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, sFPPortStatusTrap=sFPPortStatusTrap, deviceMACAddress=deviceMACAddress, linkLossLinked=linkLossLinked, userTable=userTable, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, licenseIssueNumber=licenseIssueNumber, hardwareVersion=hardwareVersion, sFPPortSSMTx=sFPPortSSMTx, dataBridgingStatusAlarm=dataBridgingStatusAlarm, licenseSecurityLevel=licenseSecurityLevel, sFPPortSyncERxStatus=sFPPortSyncERxStatus, supplementaryGroup=supplementaryGroup, signalStrengthRatio=signalStrengthRatio, licenseUnitSerialNumber=licenseUnitSerialNumber, syncEEquipmentClock=syncEEquipmentClock, latitude=latitude, configurationInstancedTable=configurationInstancedTable, dNSServerInternetAddress=dNSServerInternetAddress, rxColorCode=rxColorCode, sMTPServerInternetAddress=sMTPServerInternetAddress, sNMPTrapTable=sNMPTrapTable, dNS=dNS, mABProtocolVID=mABProtocolVID, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, snmpControl=snmpControl, configurationInstancedTableNumber=configurationInstancedTableNumber, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, ptpTraps=ptpTraps, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, dfsTable=dfsTable, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, systemReset=systemReset, tdmTableEntry=tdmTableEntry, tDDSynchronizationStatus=tDDSynchronizationStatus, mainPSUPortSSMTx=mainPSUPortSSMTx, l2CPPriorityTableIndex=l2CPPriorityTableIndex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sMTPServerPortNumber=sMTPServerPortNumber, cableDiagPair2Results=cableDiagPair2Results, tdmTableNumber=tdmTableNumber, auxPortStatus=auxPortStatus, auxPortQLRx=auxPortQLRx, tdmTable=tdmTable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, cableLoss=cableLoss, syslogControl=syslogControl, unitName=unitName, frequencyVariant=frequencyVariant, hTTPSAccessEnabled=hTTPSAccessEnabled, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, licenseSFPPortSupport=licenseSFPPortSupport, sNTPServerTimeout=sNTPServerTimeout, sNTPServerTableEntry=sNTPServerTableEntry, deviceMSN=deviceMSN, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, dNSServerTable=dNSServerTable, iPDSCPPriorityTable=iPDSCPPriorityTable, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, tDDSynchronizationMode=tDDSynchronizationMode, packetsFromInternalStack=packetsFromInternalStack, smtp=smtp, sNTPServerPortNumber=sNTPServerPortNumber, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, transparentClockVID=transparentClockVID, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, altitude=altitude, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, cableDiagPair4Results=cableDiagPair4Results, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, notificationsGroup=notificationsGroup, byteErrorRatio=byteErrorRatio, dSCPManagementPriority=dSCPManagementPriority, subnetMask=subnetMask, linkModeOptimization=linkModeOptimization, syslogLocalWrappedTrap=syslogLocalWrappedTrap, targetRange=targetRange, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, license=license, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, nIDULanPortStatus=nIDULanPortStatus, dNSServerTableNumber=dNSServerTableNumber, syslogClientTrap=syslogClientTrap, phyControl=phyControl, ptp=ptp, dataBridgingAvailability=dataBridgingAvailability, sFPPortAllocation=sFPPortAllocation, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, remoteUnitNameLinked=remoteUnitNameLinked, transmitDataRateLinked=transmitDataRateLinked, authorizationControl=authorizationControl, lowestTDMModulationMode=lowestTDMModulationMode, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, remoteInternetAddressLinked=remoteInternetAddressLinked, regulatoryBandTrap=regulatoryBandTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, regulatoryBand=regulatoryBand, ethernetPriorityTableNumber=ethernetPriorityTableNumber, dfsMeans=dfsMeans, wirelessLinkAvailability=wirelessLinkAvailability, mPLSTCPriorityTable=mPLSTCPriorityTable, licenseInstancedTable=licenseInstancedTable, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, dfsGroup=dfsGroup, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, tDMChannelStatus=tDMChannelStatus, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, mABHoldoffPeriod=mABHoldoffPeriod, routerProtocolsGroup=routerProtocolsGroup, siteName=siteName, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, dNSServerTableEntry=dNSServerTableEntry, unitOutOfCalibration=unitOutOfCalibration, sNTPState=sNTPState, managementPortWirelessDownAlert=managementPortWirelessDownAlert, mABProtocolVLANPriority=mABProtocolVLANPriority, authorizationControlGroup=authorizationControlGroup, receiveFreqKHz=receiveFreqKHz, l2CPPriorityTable=l2CPPriorityTable, sFPPortAutoNegotiation=sFPPortAutoNegotiation, vLANManagementPriority=vLANManagementPriority, sNTPLastSync=sNTPLastSync, mABTransmissionInterval=mABTransmissionInterval, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, hTTPPortNumber=hTTPPortNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, mainPSUPortQLRx=mainPSUPortQLRx, maxLinkRangeExceeded=maxLinkRangeExceeded, packetsToInternalStack=packetsToInternalStack, subbandLowestFrequency=subbandLowestFrequency, management=management, pubStatsGroup=pubStatsGroup, licenseOOBManagementSupport=licenseOOBManagementSupport, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, aAAControl=aAAControl, whitelistRMMacAddress=whitelistRMMacAddress, licenseGasGroup=licenseGasGroup, snmpControlGroup=snmpControlGroup, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, incompatibleRegulatoryBands=incompatibleRegulatoryBands, licenseBandwidthCap=licenseBandwidthCap, cableDiagPair1Distance=cableDiagPair1Distance, syslogStateTrap=syslogStateTrap, authorizationMethod=authorizationMethod, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, tFTPClient=tFTPClient, rangingMode=rangingMode, installStatusLinked=installStatusLinked, phyControlInstancedTableIndex=phyControlInstancedTableIndex, antennaSelection=antennaSelection, softwareVersion=softwareVersion, ptpTrapPrefix=ptpTrapPrefix, sMTPEnabledMessages=sMTPEnabledMessages, configuration=configuration, sNTPServerTableNumber=sNTPServerTableNumber, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, licenseGroupAccess=licenseGroupAccess, timeZone=timeZone, sntp=sntp, sFPPortQLRx=sFPPortQLRx, hTTPSPortNumber=hTTPSPortNumber, auxPortQLTx=auxPortQLTx, cableDiagnosticsResultTable=cableDiagnosticsResultTable, transparentClockPort=transparentClockPort, tDDControlGroup=tDDControlGroup, encryptionGroup=encryptionGroup, alarms=alarms, authorizationControlTableIndex=authorizationControlTableIndex, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, tDMEnabledChannels=tDMEnabledChannels, userName=userName, l2CPPriorityTableEntry=l2CPPriorityTableEntry, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, apcGroup=apcGroup, tDMInterfaceStatus=tDMInterfaceStatus, sNTPServerStatus=sNTPServerStatus, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, sNMPPortNumber=sNMPPortNumber, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, versions=versions, portAllocationMismatchTrap=portAllocationMismatchTrap, oOBPriorityQueueMapping=oOBPriorityQueueMapping, linkModeOptimizationMismatch=linkModeOptimizationMismatch, licenseRegulatoryBandsList=licenseRegulatoryBandsList, licenseSyncESupport=licenseSyncESupport, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, useVLANForManagementInterfaces=useVLANForManagementInterfaces, licenseVersion=licenseVersion, licenseInstancedTableNumber=licenseInstancedTableNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", tdmTableIndex=tdmTableIndex, transmitPowerLinked=transmitPowerLinked, wirelessOutOctets=wirelessOutOctets, encryptionAlgorithm=encryptionAlgorithm, authorizationControlTableNumber=authorizationControlTableNumber, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, receiveDataRate=receiveDataRate, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, secureModeAlarm=secureModeAlarm, receiveModulationModeDetail=receiveModulationModeDetail, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, telnetAccessEnabled=telnetAccessEnabled, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, versionsGroup=versionsGroup, capacityVariantMismatch=capacityVariantMismatch, remoteInternetAddress=remoteInternetAddress, ethernetStatisticsTable=ethernetStatisticsTable, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, userPassword=userPassword, iPv6PrefixLength=iPv6PrefixLength, l2CPPriorityTableNumber=l2CPPriorityTableNumber, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, accessMethod=accessMethod, ethernet=ethernet, licenseIPv6Support=licenseIPv6Support, capacityVariantMismatchLinked=capacityVariantMismatchLinked, nIDULanPortAutoMdix=nIDULanPortAutoMdix, sFPPortDisabledWarning=sFPPortDisabledWarning, wirelessTopology=wirelessTopology, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, auxPortSyncERxStatus=auxPortSyncERxStatus, receivePower=receivePower, mABMaintenanceLevel=mABMaintenanceLevel, ethernetPriorityTableIndex=ethernetPriorityTableIndex, enabledDiagnosticAlarms=enabledDiagnosticAlarms, portAllocationMismatch=portAllocationMismatch, licenseHCMPSupport=licenseHCMPSupport, sMTPSourceEmailAddress=sMTPSourceEmailAddress, auxPortSSMTx=auxPortSSMTx, dfsTableIndex=dfsTableIndex, localPacketFiltering=localPacketFiltering, remoteMaximumTransmitPower=remoteMaximumTransmitPower, cableDiagPair4Distance=cableDiagPair4Distance, pubInstancedStatsTable=pubInstancedStatsTable, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, longitude=longitude, sNTPPollInterval=sNTPPollInterval, ethernetInstancedTableIndex=ethernetInstancedTableIndex, phyInstancedStatusTable=phyInstancedStatusTable, sNMPEnabledTraps=sNMPEnabledTraps, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, mABState=mABState, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, receivePowerLinked=receivePowerLinked, severelyErroredSeconds=severelyErroredSeconds, phyStatusGroup=phyStatusGroup, sntpGroup=sntpGroup, tDMConfigurationMismatch=tDMConfigurationMismatch, telnetPortNumber=telnetPortNumber, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dfs=dfs, userTableIndex=userTableIndex, dNSServerInternetAddressType=dNSServerInternetAddressType, sNMPv3Enable=sNMPv3Enable, wirelessOutAllOctets=wirelessOutAllOctets, PYSNMP_MODULE_ID=cambium, dNSServerTableIndex=dNSServerTableIndex, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, erroredSeconds=erroredSeconds, sNMPCommunityString=sNMPCommunityString, vLANManagementVID=vLANManagementVID, portAllocationMismatchLinked=portAllocationMismatchLinked, transparentClock=transparentClock, tempPcb=tempPcb, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, ethernetInstancedTableNumber=ethernetInstancedTableNumber, ptmp=ptmp, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPServerInternetAddressType=sNTPServerInternetAddressType, installArmState=installArmState, resetGroup=resetGroup, userTableEntry=userTableEntry, sFPError=sFPError, sNMPTrapInternetAddress=sNMPTrapInternetAddress, cableDiagnostics=cableDiagnostics, dfsTableNumber=dfsTableNumber, qOSPriorityScheme=qOSPriorityScheme, vectorError=vectorError, bootVersion=bootVersion, rawReceivePowerLinked=rawReceivePowerLinked, auxPortConfigurationMismatch=auxPortConfigurationMismatch, unitIdentification=unitIdentification, managementNetworkAccessEnabled=managementNetworkAccessEnabled, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, cableDiagnosticsWarning=cableDiagnosticsWarning, alarmInstancedTableEntry=alarmInstancedTableEntry, ethernetInstancedTable=ethernetInstancedTable, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, syncESlavePort=syncESlavePort, enableTransmission=enableTransmission, sNMPTrapTableEntry=sNMPTrapTableEntry, txColorCode=txColorCode, tDMChannelStatusTrap=tDMChannelStatusTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, userEnabled=userEnabled, tDDControl=tDDControl, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, userRole=userRole, sFPPortQLTx=sFPPortQLTx, secondarySoftwareVersion=secondarySoftwareVersion, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, sNTPServerTableIndex=sNTPServerTableIndex, rangeLinked=rangeLinked, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, mgmtInstancedTableNumber=mgmtInstancedTableNumber, installStatus=installStatus, iPVersion=iPVersion, syslogState=syslogState, mABNominalTransmitCapacity=mABNominalTransmitCapacity, licenseInstancedTableIndex=licenseInstancedTableIndex, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, mainPSUPortAllocation=mainPSUPortAllocation, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, userTableNumber=userTableNumber, range=range, ethernetPriorityTableEntry=ethernetPriorityTableEntry, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, pubStats=pubStats, vectorErrorLinked=vectorErrorLinked, iPv6GatewayAddress=iPv6GatewayAddress, txMABFrames=txMABFrames, tDMChannelLoopback=tDMChannelLoopback, aAAControlGroup=aAAControlGroup, dNSServerPortNumber=dNSServerPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, configurationInstancedTableEntry=configurationInstancedTableEntry, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, mgmtInstancedTable=mgmtInstancedTable, phyControlInstancedTableEntry=phyControlInstancedTableEntry, dfsPeaks=dfsPeaks, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ptp670=ptp670, sNTPPrimaryServer=sNTPPrimaryServer, licenseTrialPeriod=licenseTrialPeriod, remoteUnitName=remoteUnitName, capacityVariantMismatchTrap=capacityVariantMismatchTrap, licenseMaxLinkRange=licenseMaxLinkRange, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, receiveModulationModeLinked=receiveModulationModeLinked, hCMPMaximumLinkRange=hCMPMaximumLinkRange, auxPortAllocation=auxPortAllocation, sFPPortAutoMdix=sFPPortAutoMdix, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, transmitChannel=transmitChannel, dataBridgingStatusLinked=dataBridgingStatusLinked, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogClient=syslogClient, transmitFreqKHz=transmitFreqKHz, phyStatus=phyStatus, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, cableDiagnosticsControl=cableDiagnosticsControl, sNTPServerTable=sNTPServerTable, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, blacklistRMEnabled=blacklistRMEnabled, auxPortStatusTrap=auxPortStatusTrap, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, supplementary=supplementary, mgmtInstancedTableEntry=mgmtInstancedTableEntry, searchState=searchState, deviceESN=deviceESN, ethernetInstancedTableEntry=ethernetInstancedTableEntry, licenseTLSRekey=licenseTLSRekey, licenseRARSupport=licenseRARSupport, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, licenseEncryption=licenseEncryption, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, aggregateDataRateLinked=aggregateDataRateLinked, routerProtocols=routerProtocols, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, tFTPServerInternetAddress=tFTPServerInternetAddress, receiveDataRateLinked=receiveDataRateLinked, channelBandwidth=channelBandwidth, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, remoteMACAddress=remoteMACAddress, groupID=groupID, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, cableDiagnosticsPorts=cableDiagnosticsPorts, unavailableSeconds=unavailableSeconds, linkName=linkName, tDDSynchronizationAlarm=tDDSynchronizationAlarm, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, cableDiagPair3Distance=cableDiagPair3Distance, noWirelessChannelAvailable=noWirelessChannelAvailable, mainPSUPortAutoMdix=mainPSUPortAutoMdix, apc=apc, licenseIEEE1588Support=licenseIEEE1588Support, aggregateDataRate=aggregateDataRate, tDM=tDM, gatewayIPAddress=gatewayIPAddress, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, remoteInternetAddressType=remoteInternetAddressType, blacklistRMMacAddress=blacklistRMMacAddress, rawReceivePower=rawReceivePower, tDMChannelCableLength=tDMChannelCableLength, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, bridgeGroup=bridgeGroup, ethernetStatisticsDataSource=ethernetStatisticsDataSource, transmitPower=transmitPower, installArmStateTrap=installArmStateTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, extendedSpectrumScanning=extendedSpectrumScanning, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, wirelessLinkStatus=wirelessLinkStatus, alarmInstancedTableNumber=alarmInstancedTableNumber, ptpCompliance=ptpCompliance, hCMPLinkSymmetry=hCMPLinkSymmetry, searchStateLinked=searchStateLinked, dNSResolver=dNSResolver, licenseCapacity=licenseCapacity, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, transmitModulationModeLinked=transmitModulationModeLinked, productVariant=productVariant, useVLANForMABProtocol=useVLANForMABProtocol, sNTPServerInternetAddress=sNTPServerInternetAddress, dNSPrimaryServer=dNSPrimaryServer, auxPortAcceptedQLRx=auxPortAcceptedQLRx, hTTPAccessEnabled=hTTPAccessEnabled, dataPortPauseFrames=dataPortPauseFrames, eIRP=eIRP, alarmInstancedTableIndex=alarmInstancedTableIndex)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, mainPSUPortStatusTrap=mainPSUPortStatusTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, bridge=bridge, unitIdentificationGroup=unitIdentificationGroup, targetMACAddress=targetMACAddress, authorizationControlTable=authorizationControlTable, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, cableDiagnosticsGroup=cableDiagnosticsGroup, smtpGroup=smtpGroup, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, receiveChannel=receiveChannel, receiveModulationMode=receiveModulationMode, auxPortDisabledWarning=auxPortDisabledWarning, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, nIDULanPortStatusTrap=nIDULanPortStatusTrap, maximumNumberOfSlaves=maximumNumberOfSlaves, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, ptpGroups=ptpGroups, iPv6Address=iPv6Address, sFPErrorTrap=sFPErrorTrap, byteErrorRatioLinked=byteErrorRatioLinked, sNMPTrapVersion=sNMPTrapVersion, transmitModulationMode=transmitModulationMode, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, sMTPEmailAlert=sMTPEmailAlert, sNTPServerRetries=sNTPServerRetries, licenseGroup=licenseGroup, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, channelChangeTrap=channelChangeTrap, transmitFreqMHz=transmitFreqMHz, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, authorizationControlTableEntry=authorizationControlTableEntry, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, antennaGain=antennaGain, mainPSUPortStatus=mainPSUPortStatus, mABNominalModulationMode=mABNominalModulationMode, syncETrackingState=syncETrackingState, secureModeAlarmTrap=secureModeAlarmTrap, cableDiagPair1Results=cableDiagPair1Results, whitelistRMEnabled=whitelistRMEnabled, transparentClockVLAN=transparentClockVLAN, alarmInstancedTable=alarmInstancedTable, tDMGroup=tDMGroup, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, managementGroup=managementGroup, linkLoss=linkLoss, mainPSUPortQLTx=mainPSUPortQLTx, linkSymmetry=linkSymmetry, cableDiagPair2Distance=cableDiagPair2Distance, masterSlaveMode=masterSlaveMode, encryption=encryption, systemClock=systemClock, licenseCountry=licenseCountry, transmitDataRate=transmitDataRate, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, configurationInstancedTableIndex=configurationInstancedTableIndex, productName=productName, tDMChannelLineCode=tDMChannelLineCode, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap)
