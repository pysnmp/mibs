...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", receiveModulationModeDetail=receiveModulationModeDetail, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, sNTPLastSync=sNTPLastSync, syslogStateTrap=syslogStateTrap, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, secondarySoftwareVersion=secondarySoftwareVersion, mainPSUPortStatusTrap=mainPSUPortStatusTrap, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, tDMChannelLineCode=tDMChannelLineCode, mainPSUPortAllocation=mainPSUPortAllocation, managementGroup=managementGroup, tDMChannelLoopback=tDMChannelLoopback, tDMChannelCableLength=tDMChannelCableLength, auxPortQLRx=auxPortQLRx, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, sNTPServerStatus=sNTPServerStatus, timeZone=timeZone, capacityVariantMismatchTrap=capacityVariantMismatchTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, wirelessOutOctets=wirelessOutOctets, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, wirelessOutEthernetOctets=wirelessOutEthernetOctets, dNSServerTableEntry=dNSServerTableEntry, smtpGroup=smtpGroup, syslogControlGroup=syslogControlGroup, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, mainPSUPortAutoMdix=mainPSUPortAutoMdix, sNTPSyncTrap=sNTPSyncTrap, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, blacklistRMMacAddress=blacklistRMMacAddress, cableDiagnosticsPorts=cableDiagnosticsPorts, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, userTableEntry=userTableEntry, ethernetStatisticsTable=ethernetStatisticsTable, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, wirelessTopology=wirelessTopology, phyControlInstancedTableNumber=phyControlInstancedTableNumber, mABTransmissionInterval=mABTransmissionInterval, sntp=sntp, sNTPServerInternetAddressType=sNTPServerInternetAddressType, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, dfsPeaks=dfsPeaks, transmitPower=transmitPower, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, versions=versions, phyControlInstancedTableEntry=phyControlInstancedTableEntry, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, sNMPPortNumber=sNMPPortNumber, ethernetPriorityTable=ethernetPriorityTable, configurationGroup=configurationGroup, sNTPState=sNTPState, sMTPServerPortNumber=sMTPServerPortNumber, secureModeAlarm=secureModeAlarm, dataPortPauseFrames=dataPortPauseFrames, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, bridge=bridge, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, wirelessLinkStatusLinked=wirelessLinkStatusLinked, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPServerTableEntry=sNTPServerTableEntry, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, receivePowerLinked=receivePowerLinked, tDDControlGroup=tDDControlGroup, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, tDM=tDM, syncEEquipmentClock=syncEEquipmentClock, regulatoryBandTrap=regulatoryBandTrap, unitName=unitName, antennaGain=antennaGain, authorizationControlTableIndex=authorizationControlTableIndex, licenseSyncESupport=licenseSyncESupport, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, mPLSTCPriorityTable=mPLSTCPriorityTable, hTTPAccessEnabled=hTTPAccessEnabled, licenseTDDSyncSupport=licenseTDDSyncSupport, remoteInternetAddressType=remoteInternetAddressType, rxColorCode=rxColorCode, sNTPServerInternetAddress=sNTPServerInternetAddress, configuration=configuration, packetsToInternalStack=packetsToInternalStack, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, phyStatusGroup=phyStatusGroup, linkModeOptimization=linkModeOptimization, dfsMeans=dfsMeans, remoteInternetAddress=remoteInternetAddress, pubStats=pubStats, sFPPortSyncERxStatus=sFPPortSyncERxStatus, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, aAAControl=aAAControl, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, antennaSelection=antennaSelection, transmitModulationMode=transmitModulationMode, sFPPortQLRx=sFPPortQLRx, tempPcb=tempPcb, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, phyControlInstancedTable=phyControlInstancedTable, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, userPassword=userPassword, auxPortAcceptedQLRx=auxPortAcceptedQLRx, sNMPTrapTableEntry=sNMPTrapTableEntry, licenseOOBManagementSupport=licenseOOBManagementSupport, transmitFreqKHz=transmitFreqKHz, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, bridgeGroup=bridgeGroup, range=range, tDMInterfaceStatus=tDMInterfaceStatus, oOBPriorityQueueMapping=oOBPriorityQueueMapping, userEnabled=userEnabled, installationMode=installationMode, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, syslogClient=syslogClient, sMTPServerInternetAddress=sMTPServerInternetAddress, ethernet=ethernet, wirelessOutAllOctets=wirelessOutAllOctets, frequencyVariant=frequencyVariant, receiveDataRateLinked=receiveDataRateLinked, hCMPLinkSymmetry=hCMPLinkSymmetry, maximumTransmitPower=maximumTransmitPower, licenseIssueNumber=licenseIssueNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, licenseVersion=licenseVersion, authorizationControlTableNumber=authorizationControlTableNumber, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, tDMInterfaceControl=tDMInterfaceControl, licenseIEEE1588Support=licenseIEEE1588Support, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, authorizationControlGroup=authorizationControlGroup, ethernetInstancedTableNumber=ethernetInstancedTableNumber, rangingMode=rangingMode, tDMGroup=tDMGroup, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, tDDSynchronizationMode=tDDSynchronizationMode, ethernetGroup=ethernetGroup, dfsTable=dfsTable, licenseSecurityLevel=licenseSecurityLevel, sNTPServerTimeout=sNTPServerTimeout, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, qOSPriorityScheme=qOSPriorityScheme, tDMChannelStatusTrap=tDMChannelStatusTrap, syncETrackingState=syncETrackingState, licenseSFPPortSupport=licenseSFPPortSupport, siteName=siteName, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, licenseRARSupport=licenseRARSupport, mABNominalModulationMode=mABNominalModulationMode, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, byteErrorRatio=byteErrorRatio, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, sNTPPrimaryServer=sNTPPrimaryServer, iPv4Address=iPv4Address, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, receiveModulationMode=receiveModulationMode, dNSResolver=dNSResolver, bootVersion=bootVersion, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, reset=reset, groupID=groupID, subnetMask=subnetMask, notificationsGroup=notificationsGroup, cableDiagPair4Distance=cableDiagPair4Distance, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, tdmTableEntry=tdmTableEntry, transmitPowerLinked=transmitPowerLinked, lowestTDMModulationMode=lowestTDMModulationMode, l2CPPriorityTable=l2CPPriorityTable, phyStatus=phyStatus, syslogState=syslogState, sMTPEmailAlert=sMTPEmailAlert, targetRange=targetRange, sNMPEnabledTraps=sNMPEnabledTraps, latitude=latitude, dNS=dNS, licenseGroup=licenseGroup, dNSPrimaryServer=dNSPrimaryServer, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, cableDiagPair1Distance=cableDiagPair1Distance, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, iPVersion=iPVersion, cableDiagPair3Results=cableDiagPair3Results, userTable=userTable, ptpCompliance=ptpCompliance, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, ptpTraps=ptpTraps, dataBridgingStatusAlarm=dataBridgingStatusAlarm, snmpControl=snmpControl, tDDControl=tDDControl, linkLoss=linkLoss, cableDiagPair3Distance=cableDiagPair3Distance, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, transmitDataRateLinked=transmitDataRateLinked, nIDULanPortStatusTrap=nIDULanPortStatusTrap, telnetPortNumber=telnetPortNumber, licenseRegulatoryBandsList=licenseRegulatoryBandsList, syncETracking=syncETracking, phyControlGroup=phyControlGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, mABMaintenanceLevel=mABMaintenanceLevel, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, nIDULanPortAutoMdix=nIDULanPortAutoMdix, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, ethernetPriorityTableNumber=ethernetPriorityTableNumber, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, deviceESN=deviceESN, l2CPPriorityTableNumber=l2CPPriorityTableNumber, alarmsGroup=alarmsGroup, encryptionGroup=encryptionGroup, auxPortDisabledWarning=auxPortDisabledWarning, sNMPTrapVersion=sNMPTrapVersion, sMTPServerInternetAddressType=sMTPServerInternetAddressType, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, rawReceivePowerLinked=rawReceivePowerLinked, resetGroup=resetGroup, remoteMACAddressLinked=remoteMACAddressLinked, severelyErroredSeconds=severelyErroredSeconds, alarmInstancedTable=alarmInstancedTable, accessMethod=accessMethod, telnetAccessEnabled=telnetAccessEnabled, signalStrengthRatio=signalStrengthRatio, masterSlaveMode=masterSlaveMode, mainPSUPortQLTx=mainPSUPortQLTx, transparentClockVID=transparentClockVID, auxPortAllocation=auxPortAllocation, channelBandwidth=channelBandwidth, signalStrengthRatioLinked=signalStrengthRatioLinked, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, managementNetworkAccessEnabled=managementNetworkAccessEnabled, hardwareVersion=hardwareVersion, versionsGroup=versionsGroup, subbandLowestFrequency=subbandLowestFrequency, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, deviceMSN=deviceMSN, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, cableDiagnosticsWarning=cableDiagnosticsWarning, dNSServerInternetAddressType=dNSServerInternetAddressType, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", dfsTableNumber=dfsTableNumber, auxPortQLTx=auxPortQLTx, sFPPortAllocation=sFPPortAllocation, maxLinkRangeExceeded=maxLinkRangeExceeded, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, authorizationControlTable=authorizationControlTable, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, whitelistRMMacAddress=whitelistRMMacAddress, sFPPortQLTx=sFPPortQLTx, tDMEnabledChannels=tDMEnabledChannels, ptmp=ptmp, cambium=cambium, remoteInternetAddressLinked=remoteInternetAddressLinked, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, installStatus=installStatus, unitOutOfCalibration=unitOutOfCalibration, mABState=mABState, pubInstancedStatsTable=pubInstancedStatsTable, tFTPClient=tFTPClient, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, userName=userName, sNTPSync=sNTPSync, cableDiagPair2Results=cableDiagPair2Results, dNSServerTableIndex=dNSServerTableIndex, extendedSpectrumScanning=extendedSpectrumScanning, snmpControlGroup=snmpControlGroup, sNTPServerTableNumber=sNTPServerTableNumber, mABProtocolVID=mABProtocolVID, cableDiagnostics=cableDiagnostics, supplementaryGroup=supplementaryGroup, tdmTableNumber=tdmTableNumber, sntpGroup=sntpGroup, targetMACAddress=targetMACAddress, vLANManagementPriority=vLANManagementPriority, hCMPMaximumLinkRange=hCMPMaximumLinkRange, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, sMTPSourceEmailAddress=sMTPSourceEmailAddress, transparentClockPort=transparentClockPort, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, tFTPServerPortNumber=tFTPServerPortNumber, vectorError=vectorError, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, remoteUnitName=remoteUnitName, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, licenseBandwidthCap=licenseBandwidthCap, phyControl=phyControl, ethernetPriorityTableEntry=ethernetPriorityTableEntry, secureModeAlarmTrap=secureModeAlarmTrap, syslogClientTrap=syslogClientTrap, enableTransmission=enableTransmission, configurationInstancedTableEntry=configurationInstancedTableEntry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, iPv6Address=iPv6Address, txColorCode=txColorCode, sFPError=sFPError, sNTPPollInterval=sNTPPollInterval, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, management=management, sNMPCommunityString=sNMPCommunityString, txMABFrames=txMABFrames, installStatusTrap=installStatusTrap, ptpTrapPrefix=ptpTrapPrefix, licenseInstancedTableNumber=licenseInstancedTableNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, wirelessLinkStatus=wirelessLinkStatus, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, receiveFreqKHz=receiveFreqKHz, receiveModulationModeLinked=receiveModulationModeLinked, tDMChannelStatus=tDMChannelStatus, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, capacityVariantMismatchLinked=capacityVariantMismatchLinked, dNSGroup=dNSGroup, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, dfsTableIndex=dfsTableIndex, alarmInstancedTableIndex=alarmInstancedTableIndex, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, incompatibleRegulatoryBands=incompatibleRegulatoryBands, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, licenseInstancedTable=licenseInstancedTable, licenseHCMPSupport=licenseHCMPSupport, ptp670=ptp670, sNMPv3Enable=sNMPv3Enable, licenseGroupAccess=licenseGroupAccess, unitIdentificationGroup=unitIdentificationGroup, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, channelChangeTrap=channelChangeTrap, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, systemClock=systemClock, sNMPTrapTableIndex=sNMPTrapTableIndex, linkLossLinked=linkLossLinked, transmitDataRate=transmitDataRate, mainPSUPortSSMTx=mainPSUPortSSMTx, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, tDMConfigurationMismatch=tDMConfigurationMismatch, iPv6GatewayAddress=iPv6GatewayAddress, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sMTPEnabledMessages=sMTPEnabledMessages, routerProtocolsGroup=routerProtocolsGroup, supplementary=supplementary, sNTPServerTableIndex=sNTPServerTableIndex, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, alarms=alarms, PYSNMP_MODULE_ID=cambium, alarmInstancedTableEntry=alarmInstancedTableEntry, syslogControl=syslogControl, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, rangeLinked=rangeLinked, ethernetStatisticsDataSource=ethernetStatisticsDataSource, pubStatsGroup=pubStatsGroup, linkName=linkName, cableDiagnosticsGroup=cableDiagnosticsGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, erroredSeconds=erroredSeconds, tdmTableIndex=tdmTableIndex, useVLANForManagementInterfaces=useVLANForManagementInterfaces, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, configurationInstancedTable=configurationInstancedTable, iPv6PrefixLength=iPv6PrefixLength, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, blacklistRMEnabled=blacklistRMEnabled, dNSServerInternetAddress=dNSServerInternetAddress, auxPortStatus=auxPortStatus, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, receiveDataRate=receiveDataRate, vectorErrorLinked=vectorErrorLinked, apc=apc, dataBridgingStatus=dataBridgingStatus, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, auxPortStatusTrap=auxPortStatusTrap, phyControlInstancedTableIndex=phyControlInstancedTableIndex, aAAControlGroup=aAAControlGroup, configurationInstancedTableNumber=configurationInstancedTableNumber, licenseIPv6Support=licenseIPv6Support, linkSymmetry=linkSymmetry, tFTPServerInternetAddress=tFTPServerInternetAddress, localPacketFiltering=localPacketFiltering, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, alarmInstancedTableNumber=alarmInstancedTableNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, remoteMACAddress=remoteMACAddress, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, dataBridgingStatusLinked=dataBridgingStatusLinked, ethernetInstancedTable=ethernetInstancedTable, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, vLANManagementVID=vLANManagementVID, mABProtocolVLANPriority=mABProtocolVLANPriority, whitelistRMEnabled=whitelistRMEnabled, licenseMaxLinkRange=licenseMaxLinkRange, enabledDiagnosticAlarms=enabledDiagnosticAlarms, cableDiagPair2Distance=cableDiagPair2Distance, authorizationMethod=authorizationMethod, unitIdentification=unitIdentification, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, productName=productName, longitude=longitude, mgmtInstancedTableIndex=mgmtInstancedTableIndex, nIDULanPortStatus=nIDULanPortStatus, installArmState=installArmState, mABNominalTransmitCapacity=mABNominalTransmitCapacity, sFPPortDisabledWarning=sFPPortDisabledWarning, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, transmitFreqMHz=transmitFreqMHz, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, dfs=dfs, auxPortSyncERxStatus=auxPortSyncERxStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, cableDiagnosticsResultTable=cableDiagnosticsResultTable, ethernetInstancedTableIndex=ethernetInstancedTableIndex, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sFPPortAutoMdix=sFPPortAutoMdix, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, regulatoryBand=regulatoryBand, mgmtInstancedTableNumber=mgmtInstancedTableNumber, sFPPortStatus=sFPPortStatus, tFTPServerInternetAddressType=tFTPServerInternetAddressType, encryption=encryption, sFPPortStatusTrap=sFPPortStatusTrap, dSCPManagementPriority=dSCPManagementPriority, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, mgmtInstancedTableEntry=mgmtInstancedTableEntry, encryptionAlgorithm=encryptionAlgorithm, unavailableSeconds=unavailableSeconds, managementPortWirelessDownAlert=managementPortWirelessDownAlert, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, rawReceivePower=rawReceivePower, eIRP=eIRP, cableLoss=cableLoss, altitude=altitude, sNTPServerTable=sNTPServerTable, authorizationControlTableEntry=authorizationControlTableEntry, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, productVariant=productVariant, searchStateLinked=searchStateLinked, licenseCountry=licenseCountry, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, sNTPServerPortNumber=sNTPServerPortNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, aggregateDataRateLinked=aggregateDataRateLinked, byteErrorRatioLinked=byteErrorRatioLinked, remoteUnitNameLinked=remoteUnitNameLinked, sFPPortSSMTx=sFPPortSSMTx, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, lbtDetectedTrap=lbtDetectedTrap, sFPPortAutoNegotiation=sFPPortAutoNegotiation, maximumNumberOfSlaves=maximumNumberOfSlaves, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, transmitModulationModeLinked=transmitModulationModeLinked, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, dNSServerTableNumber=dNSServerTableNumber, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNTPServerRetries=sNTPServerRetries, hTTPSPortNumber=hTTPSPortNumber, cableDiagPair1Results=cableDiagPair1Results, phyInstancedStatusTable=phyInstancedStatusTable, cableDiagPair4Results=cableDiagPair4Results, licenseGasGroup=licenseGasGroup, licenseInstancedTableIndex=licenseInstancedTableIndex, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, installStatusLinked=installStatusLinked, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, packetsFromInternalStack=packetsFromInternalStack, hTTPSAccessEnabled=hTTPSAccessEnabled, portAllocationMismatchLinked=portAllocationMismatchLinked, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, licenseUnitSerialNumber=licenseUnitSerialNumber, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, transmitChannel=transmitChannel, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataBridgingAvailability=dataBridgingAvailability, license=license, portAllocationMismatchTrap=portAllocationMismatchTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, searchState=searchState, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, mainPSUPortQLRx=mainPSUPortQLRx, auxPortSSMTx=auxPortSSMTx, userRole=userRole, ptp=ptp, portAllocationMismatch=portAllocationMismatch, iPDSCPPriorityTable=iPDSCPPriorityTable, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, hTTPPortNumber=hTTPPortNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", lowestDataModulationMode=lowestDataModulationMode, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, receiveFreqMHz=receiveFreqMHz, mainPSUPortStatus=mainPSUPortStatus, receivePower=receivePower, mABHoldoffPeriod=mABHoldoffPeriod, userTableIndex=userTableIndex, licenseEncryption=licenseEncryption, licenseTLSRekey=licenseTLSRekey, apcGroup=apcGroup, transmitterChannels=transmitterChannels, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, softwareVersion=softwareVersion, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, subbandHighestFrequency=subbandHighestFrequency, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, licenseTrialPeriod=licenseTrialPeriod, licenseInstancedTableEntry=licenseInstancedTableEntry, systemReset=systemReset, aggregateDataRate=aggregateDataRate, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, useVLANForMABProtocol=useVLANForMABProtocol, userTableNumber=userTableNumber, tdmTable=tdmTable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, cableDiagnosticsControl=cableDiagnosticsControl, dfsTableEntry=dfsTableEntry, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, smtp=smtp, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, ptpGroups=ptpGroups, routerProtocols=routerProtocols, transparentClockVLAN=transparentClockVLAN, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, syncESlavePort=syncESlavePort, ethernetInstancedTableEntry=ethernetInstancedTableEntry, wirelessLinkAvailability=wirelessLinkAvailability, installArmStateTrap=installArmStateTrap, gatewayIPAddress=gatewayIPAddress, mgmtInstancedTable=mgmtInstancedTable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dNSServerTable=dNSServerTable, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, deviceMACAddress=deviceMACAddress, capacityVariantMismatch=capacityVariantMismatch, auxPortConfigurationMismatch=auxPortConfigurationMismatch, receiveChannel=receiveChannel, transparentClock=transparentClock, dfsGroup=dfsGroup, sNMPTrapTable=sNMPTrapTable, licenseCapacity=licenseCapacity, authorizationControl=authorizationControl, configurationInstancedTableIndex=configurationInstancedTableIndex, sFPErrorTrap=sFPErrorTrap, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, dNSServerPortNumber=dNSServerPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, daylightSaving=daylightSaving)
