...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, reset=reset, userTable=userTable, maximumTransmitPower=maximumTransmitPower, licenseIssueNumber=licenseIssueNumber, ethernetInstancedTable=ethernetInstancedTable, tdmTableEntry=tdmTableEntry, ethernetPriorityTable=ethernetPriorityTable, sMTPServerPortNumber=sMTPServerPortNumber, pubInstancedStatsTable=pubInstancedStatsTable, erroredSeconds=erroredSeconds, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, auxPortQLTx=auxPortQLTx, tDMInterfaceStatus=tDMInterfaceStatus, txColorCode=txColorCode, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, userPassword=userPassword, tDM=tDM, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, latitude=latitude, linkLoss=linkLoss, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, unavailableSeconds=unavailableSeconds, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, sFPPortAutoNegotiation=sFPPortAutoNegotiation, cableDiagnosticsWarning=cableDiagnosticsWarning, sFPPortQLTx=sFPPortQLTx, receiveFreqMHz=receiveFreqMHz, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, lowestTDMModulationMode=lowestTDMModulationMode, phyControlGroup=phyControlGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapTableNumber=sNMPTrapTableNumber, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, iPv6Address=iPv6Address, incompatibleMasterAndSlave=incompatibleMasterAndSlave, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, phyControlInstancedTableNumber=phyControlInstancedTableNumber, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, apcGroup=apcGroup, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, ptpCompliance=ptpCompliance, vLANManagementVID=vLANManagementVID, sNTPServerTimeout=sNTPServerTimeout, sMTPEmailAlert=sMTPEmailAlert, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, sFPPortSSMTx=sFPPortSSMTx, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPTrapTable=sNMPTrapTable, receiveDataRate=receiveDataRate, l2CPPriorityTableEntry=l2CPPriorityTableEntry, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, dataPortPauseFrames=dataPortPauseFrames, whitelistRMMacAddress=whitelistRMMacAddress, iPv6GatewayAddress=iPv6GatewayAddress, cableDiagnosticsControl=cableDiagnosticsControl, cableDiagPair3Distance=cableDiagPair3Distance, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, mABTransmissionInterval=mABTransmissionInterval, aggregateDataRateLinked=aggregateDataRateLinked, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, dfsTable=dfsTable, byteErrorRatio=byteErrorRatio, wirelessOutAllOctets=wirelessOutAllOctets, licenseTDDSyncSupport=licenseTDDSyncSupport, sNTPSyncTrap=sNTPSyncTrap, auxPortQLRx=auxPortQLRx, dNSResolver=dNSResolver, capacityVariantMismatchTrap=capacityVariantMismatchTrap, dNSServerTableNumber=dNSServerTableNumber, blacklistRMEnabled=blacklistRMEnabled, portAllocationMismatchTrap=portAllocationMismatchTrap, receivePowerLinked=receivePowerLinked, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, wirelessOutEthernetOctets=wirelessOutEthernetOctets, sNTPServerTableIndex=sNTPServerTableIndex, deviceMACAddress=deviceMACAddress, syslogClientTrap=syslogClientTrap, licenseBandwidthCap=licenseBandwidthCap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, dfs=dfs, tDDControl=tDDControl, cableDiagPair1Results=cableDiagPair1Results, antennaGain=antennaGain, sFPPortSyncERxStatus=sFPPortSyncERxStatus, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, whitelistRMEnabled=whitelistRMEnabled, sNMPCommunityString=sNMPCommunityString, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, tempPcb=tempPcb, regulatoryBandTrap=regulatoryBandTrap, secureModeAlarmTrap=secureModeAlarmTrap, configurationInstancedTable=configurationInstancedTable, sNTPServerInternetAddressType=sNTPServerInternetAddressType, versionsGroup=versionsGroup, tDMConfigurationMismatch=tDMConfigurationMismatch, syslogClient=syslogClient, linkName=linkName, receiveFreqKHz=receiveFreqKHz, receiveChannel=receiveChannel, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, sNTPLastSync=sNTPLastSync, sntp=sntp, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, wirelessLinkAvailability=wirelessLinkAvailability, license=license, range=range, dNSServerTable=dNSServerTable, remoteInternetAddressType=remoteInternetAddressType, receiveModulationModeLinked=receiveModulationModeLinked, sMTPSourceEmailAddress=sMTPSourceEmailAddress, blacklistRMMacAddress=blacklistRMMacAddress, installArmStateTrap=installArmStateTrap, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, tDMGroup=tDMGroup, mPLSTCPriorityTable=mPLSTCPriorityTable, telnetPortNumber=telnetPortNumber, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, frequencyVariant=frequencyVariant, syslogState=syslogState, licenseTrialPeriod=licenseTrialPeriod, routerProtocolsGroup=routerProtocolsGroup, altitude=altitude, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ethernetStatisticsDataSource=ethernetStatisticsDataSource, licenseCapacity=licenseCapacity, targetMACAddress=targetMACAddress, dNS=dNS, configurationInstancedTableIndex=configurationInstancedTableIndex, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, licenseVersion=licenseVersion, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, mABMaintenanceLevel=mABMaintenanceLevel, mgmtInstancedTableIndex=mgmtInstancedTableIndex, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, auxPortStatusTrap=auxPortStatusTrap, sFPErrorTrap=sFPErrorTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, auxPortAcceptedQLRx=auxPortAcceptedQLRx, mainPSUPortStatus=mainPSUPortStatus, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, authorizationMethod=authorizationMethod, dataBridgingStatusAlarm=dataBridgingStatusAlarm, alarmInstancedTableEntry=alarmInstancedTableEntry, sntpGroup=sntpGroup, remoteMACAddressLinked=remoteMACAddressLinked, dfsTableIndex=dfsTableIndex, channelBandwidth=channelBandwidth, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitFreqMHz=transmitFreqMHz, searchStateLinked=searchStateLinked, licenseMaxLinkRange=licenseMaxLinkRange, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, licenseSecurityLevel=licenseSecurityLevel, tDDSynchronizationMode=tDDSynchronizationMode, smtp=smtp, licenseGroupAccess=licenseGroupAccess, incompatibleRegulatoryBands=incompatibleRegulatoryBands, phyControlInstancedTableIndex=phyControlInstancedTableIndex, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, cableDiagnosticsResultTable=cableDiagnosticsResultTable, mainPSUPortSSMTx=mainPSUPortSSMTx, mainPSUPortStatusTrap=mainPSUPortStatusTrap, antennaSelection=antennaSelection, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, mABProtocolVLANPriority=mABProtocolVLANPriority, mainPSUPortAutoMdix=mainPSUPortAutoMdix, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, telnetAccessEnabled=telnetAccessEnabled, useVLANForMABProtocol=useVLANForMABProtocol, phyControlInstancedTableEntry=phyControlInstancedTableEntry, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tDMChannelStatusTrap=tDMChannelStatusTrap, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, linkModeOptimizationMismatch=linkModeOptimizationMismatch, capacityVariantMismatch=capacityVariantMismatch, dfsMeans=dfsMeans, syncETracking=syncETracking, enableTransmission=enableTransmission, systemReset=systemReset, authorizationControlTable=authorizationControlTable, vectorError=vectorError, transmitModulationMode=transmitModulationMode, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, qOSPriorityScheme=qOSPriorityScheme, auxPortDisabledWarning=auxPortDisabledWarning, sNTPServerRetries=sNTPServerRetries, ptpGroups=ptpGroups, auxPortSyncERxStatus=auxPortSyncERxStatus, rangingMode=rangingMode, syncEEquipmentClock=syncEEquipmentClock, configurationInstancedTableNumber=configurationInstancedTableNumber, licenseInstancedTableIndex=licenseInstancedTableIndex, accessMethod=accessMethod, resetGroup=resetGroup, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, licenseCountry=licenseCountry, searchState=searchState, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, secureModeAlarm=secureModeAlarm, wirelessTopology=wirelessTopology, sNTPServerTable=sNTPServerTable, phyControlInstancedTable=phyControlInstancedTable, sMTPEnabledMessages=sMTPEnabledMessages, packetsFromInternalStack=packetsFromInternalStack, managementGroup=managementGroup, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, hTTPPortNumber=hTTPPortNumber, iPv6PrefixLength=iPv6PrefixLength, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, longitude=longitude, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, ethernetPriorityTableEntry=ethernetPriorityTableEntry, bridgeGroup=bridgeGroup, cableDiagnostics=cableDiagnostics, l2CPPriorityTableNumber=l2CPPriorityTableNumber, portAllocationMismatch=portAllocationMismatch, licenseGroup=licenseGroup, alarmInstancedTableIndex=alarmInstancedTableIndex, ptmp=ptmp, licenseGasGroup=licenseGasGroup, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, sNTPState=sNTPState, sNMPTrapInternetAddress=sNMPTrapInternetAddress, licenseIEEE1588Support=licenseIEEE1588Support, sNTPServerTableEntry=sNTPServerTableEntry, routerProtocols=routerProtocols, auxPortAllocation=auxPortAllocation, sNMPTrapTableEntry=sNMPTrapTableEntry)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", transmitPowerLinked=transmitPowerLinked, licenseRARSupport=licenseRARSupport, installationMode=installationMode, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sFPPortStatus=sFPPortStatus, signalStrengthRatioLinked=signalStrengthRatioLinked, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, installStatusLinked=installStatusLinked, licenseIPv6Support=licenseIPv6Support, transparentClockVID=transparentClockVID, tdmTableIndex=tdmTableIndex, linkModeOptimization=linkModeOptimization, targetRange=targetRange, unitName=unitName, ethernetStatisticsTable=ethernetStatisticsTable, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, authorizationControlTableNumber=authorizationControlTableNumber, transmitDataRate=transmitDataRate, managementPortWirelessDownAlert=managementPortWirelessDownAlert, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, channelChangeTrap=channelChangeTrap, syslogControlGroup=syslogControlGroup, vectorErrorLinked=vectorErrorLinked, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, cableDiagPair4Results=cableDiagPair4Results, lowestDataModulationMode=lowestDataModulationMode, siteName=siteName, productVariant=productVariant, sNTPPollInterval=sNTPPollInterval, pubStats=pubStats, mABProtocolVID=mABProtocolVID, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, licenseTLSRekey=licenseTLSRekey, sNTPSync=sNTPSync, mgmtInstancedTableEntry=mgmtInstancedTableEntry, snmpControl=snmpControl, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, localPacketFiltering=localPacketFiltering, dfsTableEntry=dfsTableEntry, receiveModulationModeDetail=receiveModulationModeDetail, sNTPPrimaryServer=sNTPPrimaryServer, encryptionAlgorithm=encryptionAlgorithm, phyStatusGroup=phyStatusGroup, supplementaryGroup=supplementaryGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, remoteUnitName=remoteUnitName, tDDControlGroup=tDDControlGroup, sNTPServerInternetAddress=sNTPServerInternetAddress, sFPPortStatusTrap=sFPPortStatusTrap, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, useVLANForManagementInterfaces=useVLANForManagementInterfaces, wirelessLinkStatusLinked=wirelessLinkStatusLinked, tFTPClient=tFTPClient, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, licenseUnitSerialNumber=licenseUnitSerialNumber, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ethernetInstancedTableIndex=ethernetInstancedTableIndex, sNMPTrapVersion=sNMPTrapVersion, syncESlavePort=syncESlavePort, severelyErroredSeconds=severelyErroredSeconds, tdmTableNumber=tdmTableNumber, ethernetInstancedTableNumber=ethernetInstancedTableNumber, dfsPeaks=dfsPeaks, ptpTrapPrefix=ptpTrapPrefix, tDMChannelCableLength=tDMChannelCableLength, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, remoteUnitNameLinked=remoteUnitNameLinked, deviceESN=deviceESN, installStatusTrap=installStatusTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, receiveModulationMode=receiveModulationMode, snmpControlGroup=snmpControlGroup, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, licenseHCMPSupport=licenseHCMPSupport, tDDSynchronizationStatus=tDDSynchronizationStatus, nIDULanPortStatusTrap=nIDULanPortStatusTrap, phyInstancedStatusTable=phyInstancedStatusTable, sNTPServerTableNumber=sNTPServerTableNumber, dSCPManagementPriority=dSCPManagementPriority, mABNominalModulationMode=mABNominalModulationMode, rangeLinked=rangeLinked, mABState=mABState, l2CPPriorityTable=l2CPPriorityTable, cableLoss=cableLoss, tFTPServerPortNumber=tFTPServerPortNumber, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, subbandLowestFrequency=subbandLowestFrequency, transmitChannel=transmitChannel, subnetMask=subnetMask, receiveDataRateLinked=receiveDataRateLinked, byteErrorRatioLinked=byteErrorRatioLinked, aggregateDataRate=aggregateDataRate, ethernetPriorityTableNumber=ethernetPriorityTableNumber, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, cableDiagPair2Results=cableDiagPair2Results, tFTPServerInternetAddressType=tFTPServerInternetAddressType, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, transmitModulationModeLinked=transmitModulationModeLinked, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, sFPPortDisabledWarning=sFPPortDisabledWarning, sMTPServerInternetAddress=sMTPServerInternetAddress, subbandHighestFrequency=subbandHighestFrequency, versions=versions, transmitterChannels=transmitterChannels, softwareVersion=softwareVersion, mainPSUPortAllocation=mainPSUPortAllocation, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, tDMInterfaceControl=tDMInterfaceControl, oOBPriorityQueueMapping=oOBPriorityQueueMapping, wirelessLinkStatus=wirelessLinkStatus, encryption=encryption, licenseSyncESupport=licenseSyncESupport, bootVersion=bootVersion, phyControl=phyControl, maxLinkRangeExceeded=maxLinkRangeExceeded, noWirelessChannelAvailable=noWirelessChannelAvailable, mgmtInstancedTable=mgmtInstancedTable, packetsToInternalStack=packetsToInternalStack, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, iPv4Address=iPv4Address, auxPortStatus=auxPortStatus, timeZone=timeZone, userTableIndex=userTableIndex, licenseInstancedTable=licenseInstancedTable, masterSlaveMode=masterSlaveMode, ptp670=ptp670, tFTPServerInternetAddress=tFTPServerInternetAddress, encryptionGroup=encryptionGroup, cableDiagnosticsPorts=cableDiagnosticsPorts, hCMPMaximumLinkRange=hCMPMaximumLinkRange, hCMPLinkSymmetry=hCMPLinkSymmetry, smtpGroup=smtpGroup, hTTPSPortNumber=hTTPSPortNumber, apc=apc, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, tdmTable=tdmTable, hardwareVersion=hardwareVersion, dataBridgingAvailability=dataBridgingAvailability, sNTPServerStatus=sNTPServerStatus, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, dNSServerTableIndex=dNSServerTableIndex, userName=userName, auxPortConfigurationMismatch=auxPortConfigurationMismatch, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, dNSServerTableEntry=dNSServerTableEntry, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, maximumNumberOfSlaves=maximumNumberOfSlaves, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, notificationsGroup=notificationsGroup, tDMChannelStatus=tDMChannelStatus, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, mgmtInstancedTableNumber=mgmtInstancedTableNumber, dfsGroup=dfsGroup, groupID=groupID, dfsTableNumber=dfsTableNumber, secondarySoftwareVersion=secondarySoftwareVersion, dNSServerInternetAddress=dNSServerInternetAddress, dNSServerPortNumber=dNSServerPortNumber, authorizationControlTableEntry=authorizationControlTableEntry, aAAControlGroup=aAAControlGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, eIRP=eIRP, cableDiagPair4Distance=cableDiagPair4Distance, receivePower=receivePower, sNTPServerPortNumber=sNTPServerPortNumber, dNSServerInternetAddressType=dNSServerInternetAddressType, cambium=cambium, unitOutOfCalibration=unitOutOfCalibration, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, licenseSFPPortSupport=licenseSFPPortSupport, mainPSUPortQLTx=mainPSUPortQLTx, authorizationControl=authorizationControl, lbtDetectedTrap=lbtDetectedTrap, configurationInstancedTableEntry=configurationInstancedTableEntry, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, hTTPSAccessEnabled=hTTPSAccessEnabled, pubStatsGroup=pubStatsGroup, sFPError=sFPError, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, configurationGroup=configurationGroup, alarmInstancedTableNumber=alarmInstancedTableNumber, ethernetInstancedTableEntry=ethernetInstancedTableEntry, dataPortWirelessDownAlert=dataPortWirelessDownAlert, syslogStateTrap=syslogStateTrap, dataBridgingStatusLinked=dataBridgingStatusLinked, signalStrengthRatio=signalStrengthRatio, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, installStatus=installStatus, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, licenseInstancedTableEntry=licenseInstancedTableEntry, transmitDataRateLinked=transmitDataRateLinked, userTableNumber=userTableNumber, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, PYSNMP_MODULE_ID=cambium, aAAControl=aAAControl, transparentClock=transparentClock, licenseEncryption=licenseEncryption, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, sFPPortQLRx=sFPPortQLRx, alarms=alarms, sFPPortAutoMdix=sFPPortAutoMdix, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, management=management, ptpTraps=ptpTraps, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, installArmState=installArmState, linkLossLinked=linkLossLinked, ethernetPriorityTableIndex=ethernetPriorityTableIndex, supplementary=supplementary, mABHoldoffPeriod=mABHoldoffPeriod, licenseInstancedTableNumber=licenseInstancedTableNumber, unitIdentificationGroup=unitIdentificationGroup, userTableEntry=userTableEntry, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, transmitFreqKHz=transmitFreqKHz, sNMPPortNumber=sNMPPortNumber, cableDiagnosticsGroup=cableDiagnosticsGroup, transparentClockPort=transparentClockPort, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, rxColorCode=rxColorCode, remoteInternetAddressLinked=remoteInternetAddressLinked, alarmInstancedTable=alarmInstancedTable, licenseOOBManagementSupport=licenseOOBManagementSupport, daylightSaving=daylightSaving, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, authorizationControlTableIndex=authorizationControlTableIndex, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, bridge=bridge, extendedSpectrumScanning=extendedSpectrumScanning, txMABFrames=txMABFrames, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, remoteMACAddress=remoteMACAddress, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, sNMPEnabledTraps=sNMPEnabledTraps, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, hTTPAccessEnabled=hTTPAccessEnabled, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, transparentClockVLAN=transparentClockVLAN, ptp=ptp, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", userEnabled=userEnabled, rawReceivePower=rawReceivePower, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, iPVersion=iPVersion, vLANManagementPriority=vLANManagementPriority, userRole=userRole, productName=productName, nIDULanPortStatus=nIDULanPortStatus, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, l2CPPriorityTableIndex=l2CPPriorityTableIndex, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, systemClock=systemClock, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, deviceMSN=deviceMSN, licenseRegulatoryBandsList=licenseRegulatoryBandsList, dNSPrimaryServer=dNSPrimaryServer, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, dataBridgingStatus=dataBridgingStatus, managementNetworkAccessEnabled=managementNetworkAccessEnabled, sNMPv3Enable=sNMPv3Enable, phyStatus=phyStatus, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, sFPPortAllocation=sFPPortAllocation, cableDiagPair1Distance=cableDiagPair1Distance, cableDiagPair2Distance=cableDiagPair2Distance, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, ethernetGroup=ethernetGroup, tDMChannelLineCode=tDMChannelLineCode, regulatoryBand=regulatoryBand, mABNominalTransmitCapacity=mABNominalTransmitCapacity, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, cableDiagPair3Results=cableDiagPair3Results, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, auxPortSSMTx=auxPortSSMTx, tDMEnabledChannels=tDMEnabledChannels, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, nIDULanPortAutoMdix=nIDULanPortAutoMdix, wirelessOutOctets=wirelessOutOctets, alarmsGroup=alarmsGroup, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, portAllocationMismatchLinked=portAllocationMismatchLinked, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, gatewayIPAddress=gatewayIPAddress, linkSymmetry=linkSymmetry, dNSGroup=dNSGroup, capacityVariantMismatchLinked=capacityVariantMismatchLinked, ethernet=ethernet, authorizationControlGroup=authorizationControlGroup, unitIdentification=unitIdentification, sNMPTrapTableIndex=sNMPTrapTableIndex, tDMChannelLoopback=tDMChannelLoopback, rawReceivePowerLinked=rawReceivePowerLinked, remoteMaximumTransmitPower=remoteMaximumTransmitPower, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, remoteInternetAddress=remoteInternetAddress, syslogControl=syslogControl, mainPSUPortQLRx=mainPSUPortQLRx, configuration=configuration, transmitPower=transmitPower, syncETrackingState=syncETrackingState)
