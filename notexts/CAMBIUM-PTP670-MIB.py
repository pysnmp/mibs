...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sMTPServerPortNumber=sMTPServerPortNumber, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, dSCPManagementPriority=dSCPManagementPriority, cableDiagPair1Distance=cableDiagPair1Distance, remoteUnitNameLinked=remoteUnitNameLinked, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dataBridgingAvailability=dataBridgingAvailability, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, vLANManagementPriority=vLANManagementPriority, licenseSFPPortSupport=licenseSFPPortSupport, wirelessLinkStatusLinked=wirelessLinkStatusLinked, remoteInternetAddressType=remoteInternetAddressType, dataBridgingStatus=dataBridgingStatus, alarmsGroup=alarmsGroup, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, transmitPower=transmitPower, dNSGroup=dNSGroup, capacityVariantMismatchTrap=capacityVariantMismatchTrap, mABState=mABState, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, licenseIssueNumber=licenseIssueNumber, linkLoss=linkLoss, packetsToInternalStack=packetsToInternalStack, iPv6Address=iPv6Address, syslogControl=syslogControl, masterSlaveMode=masterSlaveMode, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, vectorError=vectorError, userEnabled=userEnabled, auxPortStatusTrap=auxPortStatusTrap, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, dNSServerTable=dNSServerTable, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, tDDSynchronizationStatus=tDDSynchronizationStatus, cableDiagPair1Results=cableDiagPair1Results, hCMPLinkSymmetry=hCMPLinkSymmetry, licenseMaxLinkRange=licenseMaxLinkRange, transmitFreqMHz=transmitFreqMHz, installArmState=installArmState, tDMChannelStatusTrap=tDMChannelStatusTrap, notificationsGroup=notificationsGroup, daylightSaving=daylightSaving, unitIdentification=unitIdentification, sNTPServerPortNumber=sNTPServerPortNumber, bootVersion=bootVersion, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, licenseTDDSyncSupport=licenseTDDSyncSupport, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, linkSymmetry=linkSymmetry, sFPPortQLTx=sFPPortQLTx, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, configuration=configuration, sMTPEnabledMessages=sMTPEnabledMessages, targetRange=targetRange, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, remoteMACAddressLinked=remoteMACAddressLinked, hardwareVersion=hardwareVersion, systemReset=systemReset, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tFTPServerPortNumber=tFTPServerPortNumber, linkModeOptimization=linkModeOptimization, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, vectorErrorLinked=vectorErrorLinked, receiveFreqMHz=receiveFreqMHz, PYSNMP_MODULE_ID=cambium, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, useVLANForMABProtocol=useVLANForMABProtocol, licenseInstancedTable=licenseInstancedTable, altitude=altitude, dataBridgingStatusLinked=dataBridgingStatusLinked, cableDiagPair2Distance=cableDiagPair2Distance, cableDiagnosticsResultTable=cableDiagnosticsResultTable, targetMACAddress=targetMACAddress, latitude=latitude, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNTPServerStatus=sNTPServerStatus, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, receiveFreqKHz=receiveFreqKHz, dNSServerTableEntry=dNSServerTableEntry, byteErrorRatio=byteErrorRatio, transmitModulationModeLinked=transmitModulationModeLinked, installArmStateTrap=installArmStateTrap, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, cableDiagnosticsPorts=cableDiagnosticsPorts, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, dNSServerInternetAddressType=dNSServerInternetAddressType, remoteUnitName=remoteUnitName, supplementary=supplementary, phyControlInstancedTableIndex=phyControlInstancedTableIndex, sNTPServerTable=sNTPServerTable, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, signalStrengthRatio=signalStrengthRatio, channelBandwidth=channelBandwidth, cableDiagnosticsControl=cableDiagnosticsControl, gatewayIPAddress=gatewayIPAddress, mainPSUPortAllocation=mainPSUPortAllocation, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, authorizationControlTable=authorizationControlTable, lbtDetectedTrap=lbtDetectedTrap, mABProtocolVID=mABProtocolVID, supplementaryGroup=supplementaryGroup, sNTPState=sNTPState, mABMaintenanceLevel=mABMaintenanceLevel, licenseCountry=licenseCountry, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, userRole=userRole, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, hTTPSPortNumber=hTTPSPortNumber, phyControlInstancedTableNumber=phyControlInstancedTableNumber, tdmTableIndex=tdmTableIndex, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, tFTPClient=tFTPClient, antennaSelection=antennaSelection, whitelistRMMacAddress=whitelistRMMacAddress, auxPortSSMTx=auxPortSSMTx, ptpCompliance=ptpCompliance, managementGroup=managementGroup, smtpGroup=smtpGroup, licenseRARSupport=licenseRARSupport, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataBridgingStatusAlarm=dataBridgingStatusAlarm, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, aggregateDataRateLinked=aggregateDataRateLinked, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, cableDiagPair3Results=cableDiagPair3Results, configurationInstancedTableEntry=configurationInstancedTableEntry, licenseIEEE1588Support=licenseIEEE1588Support, siteName=siteName, licenseSecurityLevel=licenseSecurityLevel, subbandHighestFrequency=subbandHighestFrequency, extendedSpectrumScanning=extendedSpectrumScanning, auxPortAcceptedQLRx=auxPortAcceptedQLRx, tDMEnabledChannels=tDMEnabledChannels, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, mgmtInstancedTable=mgmtInstancedTable, wirelessTopology=wirelessTopology, iPDSCPPriorityTable=iPDSCPPriorityTable, unavailableSeconds=unavailableSeconds, ethernetPriorityTable=ethernetPriorityTable, noWirelessChannelAvailable=noWirelessChannelAvailable, phyInstancedStatusTable=phyInstancedStatusTable, authorizationControlTableNumber=authorizationControlTableNumber, vLANManagementVID=vLANManagementVID, wirelessLinkAvailability=wirelessLinkAvailability, iPVersion=iPVersion, rangingMode=rangingMode, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, management=management, userTableIndex=userTableIndex, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, maximumTransmitPower=maximumTransmitPower, rangeLinked=rangeLinked, dfs=dfs, smtp=smtp, dNSServerTableIndex=dNSServerTableIndex, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, erroredSeconds=erroredSeconds, sNMPTrapInternetAddress=sNMPTrapInternetAddress, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, syslogStateTrap=syslogStateTrap, bridge=bridge, sNTPServerTableNumber=sNTPServerTableNumber, iPv6PrefixLength=iPv6PrefixLength, license=license, sFPPortSyncERxStatus=sFPPortSyncERxStatus, phyStatus=phyStatus, auxPortQLRx=auxPortQLRx, ethernetInstancedTable=ethernetInstancedTable, configurationInstancedTableNumber=configurationInstancedTableNumber, mgmtInstancedTableIndex=mgmtInstancedTableIndex, licenseOOBManagementSupport=licenseOOBManagementSupport, sFPPortAllocation=sFPPortAllocation, ethernetInstancedTableNumber=ethernetInstancedTableNumber, sFPPortAutoNegotiation=sFPPortAutoNegotiation, tDM=tDM, apc=apc, licenseInstancedTableEntry=licenseInstancedTableEntry, sNMPCommunityString=sNMPCommunityString, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, alarmInstancedTableNumber=alarmInstancedTableNumber, enableTransmission=enableTransmission, sNTPPrimaryServer=sNTPPrimaryServer, useVLANForManagementInterfaces=useVLANForManagementInterfaces, receivePowerLinked=receivePowerLinked, searchState=searchState, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, cableDiagPair4Distance=cableDiagPair4Distance, dNSServerInternetAddress=dNSServerInternetAddress, ptpTrapPrefix=ptpTrapPrefix, remoteMACAddress=remoteMACAddress, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, sFPPortStatus=sFPPortStatus, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, sMTPServerInternetAddress=sMTPServerInternetAddress, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, configurationInstancedTableIndex=configurationInstancedTableIndex, maximumNumberOfSlaves=maximumNumberOfSlaves, receiveDataRateLinked=receiveDataRateLinked, subbandLowestFrequency=subbandLowestFrequency, snmpControl=snmpControl, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, tDDControl=tDDControl, licenseIPv6Support=licenseIPv6Support, deviceMSN=deviceMSN, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, transparentClockPort=transparentClockPort, sNTPServerTableIndex=sNTPServerTableIndex, syslogClient=syslogClient, encryptionGroup=encryptionGroup, tDMInterfaceStatus=tDMInterfaceStatus, dfsPeaks=dfsPeaks, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, auxPortAllocation=auxPortAllocation, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, sNMPTrapTableNumber=sNMPTrapTableNumber, mABProtocolVLANPriority=mABProtocolVLANPriority, dfsTable=dfsTable, deviceMACAddress=deviceMACAddress, mABTransmissionInterval=mABTransmissionInterval, cableDiagnostics=cableDiagnostics, iPv6GatewayAddress=iPv6GatewayAddress, telnetPortNumber=telnetPortNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, mainPSUPortStatusTrap=mainPSUPortStatusTrap, receiveModulationModeDetail=receiveModulationModeDetail, capacityVariantMismatchLinked=capacityVariantMismatchLinked, secureModeAlarmTrap=secureModeAlarmTrap, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, licenseCapacity=licenseCapacity, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, mABHoldoffPeriod=mABHoldoffPeriod, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, sNMPTrapTableEntry=sNMPTrapTableEntry, l2CPPriorityTable=l2CPPriorityTable, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, transmitPowerLinked=transmitPowerLinked, cableDiagPair2Results=cableDiagPair2Results, licenseHCMPSupport=licenseHCMPSupport, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, rawReceivePower=rawReceivePower)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", tdmTable=tdmTable, tdmTableEntry=tdmTableEntry, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, nIDULanPortAutoMdix=nIDULanPortAutoMdix, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, subnetMask=subnetMask, dfsMeans=dfsMeans, rawReceivePowerLinked=rawReceivePowerLinked, userTable=userTable, managementPortWirelessDownAlert=managementPortWirelessDownAlert, aggregateDataRate=aggregateDataRate, tDMChannelCableLength=tDMChannelCableLength, dNS=dNS, licenseInstancedTableIndex=licenseInstancedTableIndex, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, ptpTraps=ptpTraps, aAAControlGroup=aAAControlGroup, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, capacityVariantMismatch=capacityVariantMismatch, transparentClock=transparentClock, dfsTableEntry=dfsTableEntry, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, sNTPServerInternetAddress=sNTPServerInternetAddress, receivePower=receivePower, auxPortQLTx=auxPortQLTx, lowestDataModulationMode=lowestDataModulationMode, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, auxPortStatus=auxPortStatus, installStatus=installStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, authorizationControlGroup=authorizationControlGroup, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, hTTPAccessEnabled=hTTPAccessEnabled, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, secondarySoftwareVersion=secondarySoftwareVersion, accessMethod=accessMethod, sFPPortSSMTx=sFPPortSSMTx, sNTPServerRetries=sNTPServerRetries, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, authorizationControlTableIndex=authorizationControlTableIndex, phyControl=phyControl, whitelistRMEnabled=whitelistRMEnabled, ptpGroups=ptpGroups, mainPSUPortQLRx=mainPSUPortQLRx, blacklistRMEnabled=blacklistRMEnabled, sNMPTrapTableIndex=sNMPTrapTableIndex, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, syncESlavePort=syncESlavePort, phyStatusGroup=phyStatusGroup, ethernetStatisticsDataSource=ethernetStatisticsDataSource, transmitModulationMode=transmitModulationMode, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, receiveChannel=receiveChannel, ethernetStatisticsTable=ethernetStatisticsTable, timeZone=timeZone, tDDSynchronizationAlarm=tDDSynchronizationAlarm, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, versions=versions, licenseGroup=licenseGroup, l2CPPriorityTableNumber=l2CPPriorityTableNumber, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, alarms=alarms, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, receiveDataRate=receiveDataRate, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, reset=reset, tDMInterfaceControl=tDMInterfaceControl, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, mainPSUPortAutoMdix=mainPSUPortAutoMdix, antennaGain=antennaGain, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, dNSServerTableNumber=dNSServerTableNumber, portAllocationMismatch=portAllocationMismatch, sFPError=sFPError, licenseGasGroup=licenseGasGroup, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, unitIdentificationGroup=unitIdentificationGroup, sNTPSync=sNTPSync, transmitDataRate=transmitDataRate, syslogLocalWrappedTrap=syslogLocalWrappedTrap, snmpControlGroup=snmpControlGroup, resetGroup=resetGroup, cableDiagnosticsWarning=cableDiagnosticsWarning, dataPortWirelessDownAlert=dataPortWirelessDownAlert, packetsFromInternalStack=packetsFromInternalStack, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, txMABFrames=txMABFrames, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, remoteInternetAddressLinked=remoteInternetAddressLinked, pubInstancedStatsTable=pubInstancedStatsTable, nIDULanPortStatus=nIDULanPortStatus, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, userTableEntry=userTableEntry, alarmInstancedTableIndex=alarmInstancedTableIndex, auxPortDisabledWarning=auxPortDisabledWarning, linkModeOptimizationMismatch=linkModeOptimizationMismatch, transparentClockVID=transparentClockVID, portAllocationMismatchTrap=portAllocationMismatchTrap, sFPPortDisabledWarning=sFPPortDisabledWarning, syncEEquipmentClock=syncEEquipmentClock, byteErrorRatioLinked=byteErrorRatioLinked, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, transparentClockVLAN=transparentClockVLAN, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, ethernetInstancedTableIndex=ethernetInstancedTableIndex, apcGroup=apcGroup, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, dfsTableIndex=dfsTableIndex, tDMChannelLoopback=tDMChannelLoopback, sNMPTrapPortNumber=sNMPTrapPortNumber, sntp=sntp, licenseRegulatoryBandsList=licenseRegulatoryBandsList, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, cableDiagPair4Results=cableDiagPair4Results, deviceESN=deviceESN, systemClock=systemClock, ethernetPriorityTableNumber=ethernetPriorityTableNumber, licenseSyncESupport=licenseSyncESupport, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, searchStateLinked=searchStateLinked, rxColorCode=rxColorCode, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, alarmInstancedTable=alarmInstancedTable, softwareVersion=softwareVersion, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, remoteMaximumTransmitPower=remoteMaximumTransmitPower, mainPSUPortQLTx=mainPSUPortQLTx, licenseInstancedTableNumber=licenseInstancedTableNumber, sntpGroup=sntpGroup, mgmtInstancedTableNumber=mgmtInstancedTableNumber, tDDSynchronizationMode=tDDSynchronizationMode, wirelessOutOctets=wirelessOutOctets, remoteInternetAddress=remoteInternetAddress, syncETracking=syncETracking, receiveModulationMode=receiveModulationMode, sNTPLastSync=sNTPLastSync, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, sMTPEmailAlert=sMTPEmailAlert, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ethernetInstancedTableEntry=ethernetInstancedTableEntry, transmitDataRateLinked=transmitDataRateLinked, sNTPServerTimeout=sNTPServerTimeout, transmitterChannels=transmitterChannels, longitude=longitude, range=range, ethernetPriorityTableEntry=ethernetPriorityTableEntry, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, licenseBandwidthCap=licenseBandwidthCap, pubStatsGroup=pubStatsGroup, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, sFPPortQLRx=sFPPortQLRx, mainPSUPortSSMTx=mainPSUPortSSMTx, tDMConfigurationMismatch=tDMConfigurationMismatch, nIDULanPortStatusTrap=nIDULanPortStatusTrap, tDMGroup=tDMGroup, hTTPPortNumber=hTTPPortNumber, aAAControl=aAAControl, syslogClientTrap=syslogClientTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, cableLoss=cableLoss, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, telnetAccessEnabled=telnetAccessEnabled, syncETrackingState=syncETrackingState, sFPPortStatusTrap=sFPPortStatusTrap, installationMode=installationMode, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, cableDiagnosticsGroup=cableDiagnosticsGroup, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, unitOutOfCalibration=unitOutOfCalibration, ethernet=ethernet, syslogControlGroup=syslogControlGroup, linkName=linkName, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, licenseGroupAccess=licenseGroupAccess, qOSPriorityScheme=qOSPriorityScheme, pubStats=pubStats, userName=userName, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, encryptionAlgorithm=encryptionAlgorithm, cableDiagPair3Distance=cableDiagPair3Distance, alarmInstancedTableEntry=alarmInstancedTableEntry, authorizationControlTableEntry=authorizationControlTableEntry, transmitFreqKHz=transmitFreqKHz, tDDControlGroup=tDDControlGroup, installStatusLinked=installStatusLinked, dNSPrimaryServer=dNSPrimaryServer, userTableNumber=userTableNumber, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, maxLinkRangeExceeded=maxLinkRangeExceeded, ethernetGroup=ethernetGroup, routerProtocolsGroup=routerProtocolsGroup, sMTPServerInternetAddressType=sMTPServerInternetAddressType, dfsTableNumber=dfsTableNumber, blacklistRMMacAddress=blacklistRMMacAddress, installStatusTrap=installStatusTrap, sNTPSyncTrap=sNTPSyncTrap, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, sFPPortAutoMdix=sFPPortAutoMdix, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, severelyErroredSeconds=severelyErroredSeconds, txColorCode=txColorCode, sNMPTrapVersion=sNMPTrapVersion, licenseUnitSerialNumber=licenseUnitSerialNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, licenseTLSRekey=licenseTLSRekey, phyControlInstancedTable=phyControlInstancedTable, sNMPPortNumber=sNMPPortNumber, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, dataPortPauseFrames=dataPortPauseFrames, authorizationControl=authorizationControl, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, regulatoryBandTrap=regulatoryBandTrap, authorizationMethod=authorizationMethod, licenseEncryption=licenseEncryption, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, cambium=cambium, syslogState=syslogState, frequencyVariant=frequencyVariant, ptp=ptp, localPacketFiltering=localPacketFiltering, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, mABNominalModulationMode=mABNominalModulationMode, encryption=encryption, tDMChannelLineCode=tDMChannelLineCode, eIRP=eIRP, productVariant=productVariant, sNMPTrapTable=sNMPTrapTable, incompatibleRegulatoryBands=incompatibleRegulatoryBands, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, dNSResolver=dNSResolver, signalStrengthRatioLinked=signalStrengthRatioLinked, sNMPv3Enable=sNMPv3Enable, ptp670=ptp670, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, channelChangeTrap=channelChangeTrap, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, phyControlGroup=phyControlGroup, oOBPriorityQueueMapping=oOBPriorityQueueMapping, regulatoryBand=regulatoryBand, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, versionsGroup=versionsGroup, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, wirelessOutAllOctets=wirelessOutAllOctets, routerProtocols=routerProtocols, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", tDMChannelStatus=tDMChannelStatus, dNSServerPortNumber=dNSServerPortNumber, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, tFTPServerInternetAddress=tFTPServerInternetAddress, tFTPServerInternetAddressType=tFTPServerInternetAddressType, phyControlInstancedTableEntry=phyControlInstancedTableEntry, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, ptmp=ptmp, l2CPPriorityTableIndex=l2CPPriorityTableIndex, mainPSUPortStatus=mainPSUPortStatus, portAllocationMismatchLinked=portAllocationMismatchLinked, sNTPServerTableEntry=sNTPServerTableEntry, auxPortConfigurationMismatch=auxPortConfigurationMismatch, auxPortSyncERxStatus=auxPortSyncERxStatus, transmitChannel=transmitChannel, unitName=unitName, mPLSTCPriorityTable=mPLSTCPriorityTable, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, mABNominalTransmitCapacity=mABNominalTransmitCapacity, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, managementNetworkAccessEnabled=managementNetworkAccessEnabled, groupID=groupID, lowestTDMModulationMode=lowestTDMModulationMode, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, dfsGroup=dfsGroup, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, configurationInstancedTable=configurationInstancedTable, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, userPassword=userPassword, licenseTrialPeriod=licenseTrialPeriod, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, tdmTableNumber=tdmTableNumber, sNTPPollInterval=sNTPPollInterval, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tempPcb=tempPcb, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, wirelessLinkStatus=wirelessLinkStatus, productName=productName, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, sNMPEnabledTraps=sNMPEnabledTraps, wirelessOutEthernetOctets=wirelessOutEthernetOctets, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, iPv4Address=iPv4Address, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, licenseVersion=licenseVersion, receiveModulationModeLinked=receiveModulationModeLinked, sFPErrorTrap=sFPErrorTrap, configurationGroup=configurationGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, mgmtInstancedTableEntry=mgmtInstancedTableEntry, bridgeGroup=bridgeGroup, ethernetPriorityTableIndex=ethernetPriorityTableIndex, linkLossLinked=linkLossLinked, secureModeAlarm=secureModeAlarm, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, hCMPMaximumLinkRange=hCMPMaximumLinkRange)
