...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", wirelessLinkStatusLinked=wirelessLinkStatusLinked, syslogStateTrap=syslogStateTrap, userTableEntry=userTableEntry, useVLANForMABProtocol=useVLANForMABProtocol, tDDSynchronizationStatus=tDDSynchronizationStatus, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, sNMPTrapTableEntry=sNMPTrapTableEntry, bridge=bridge, targetRange=targetRange, transmitFreqKHz=transmitFreqKHz, tDMGroup=tDMGroup, configuration=configuration, productName=productName, cableDiagPair4Distance=cableDiagPair4Distance, pubStats=pubStats, wirelessTopology=wirelessTopology, managementPortWirelessDownAlert=managementPortWirelessDownAlert, cableDiagPair2Distance=cableDiagPair2Distance, dNSResolver=dNSResolver, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, sNTPServerTableEntry=sNTPServerTableEntry, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, mABNominalTransmitCapacity=mABNominalTransmitCapacity, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, management=management, secureModeAlarmTrap=secureModeAlarmTrap, subbandHighestFrequency=subbandHighestFrequency, portAllocationMismatch=portAllocationMismatch, syslogControlGroup=syslogControlGroup, supplementary=supplementary, transparentClockVID=transparentClockVID, deviceMSN=deviceMSN, hTTPSAccessEnabled=hTTPSAccessEnabled, versionsGroup=versionsGroup, receivePowerLinked=receivePowerLinked, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, deviceESN=deviceESN, antennaGain=antennaGain, syslogClient=syslogClient, sFPPortQLRx=sFPPortQLRx, tFTPClient=tFTPClient, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, tDM=tDM, alarmsGroup=alarmsGroup, l2CPPriorityTable=l2CPPriorityTable, sNMPEnabledTraps=sNMPEnabledTraps, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, aAAControlGroup=aAAControlGroup, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, cableDiagnosticsGroup=cableDiagnosticsGroup, sMTPServerInternetAddress=sMTPServerInternetAddress, userTable=userTable, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, dNSServerInternetAddress=dNSServerInternetAddress, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, transmitPower=transmitPower, licenseGasGroup=licenseGasGroup, licenseIEEE1588Support=licenseIEEE1588Support, sNMPTrapVersion=sNMPTrapVersion, mABState=mABState, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, syslogLocalWrappedTrap=syslogLocalWrappedTrap, supplementaryGroup=supplementaryGroup, sNTPServerRetries=sNTPServerRetries, sNMPTrapPortNumber=sNMPTrapPortNumber, mainPSUPortQLTx=mainPSUPortQLTx, wirelessLinkAvailability=wirelessLinkAvailability, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, signalStrengthRatioLinked=signalStrengthRatioLinked, remoteInternetAddressType=remoteInternetAddressType, installArmStateTrap=installArmStateTrap, cableDiagnosticsPorts=cableDiagnosticsPorts, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, iPv6GatewayAddress=iPv6GatewayAddress, bridgeGroup=bridgeGroup, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, capacityVariantMismatch=capacityVariantMismatch, tDMChannelLineCode=tDMChannelLineCode, iPVersion=iPVersion, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, transmitterChannels=transmitterChannels, licenseInstancedTableNumber=licenseInstancedTableNumber, linkModeOptimization=linkModeOptimization, sNMPTrapTableNumber=sNMPTrapTableNumber, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, receivePower=receivePower, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, nIDULanPortAutoMdix=nIDULanPortAutoMdix, encryption=encryption, pubStatsGroup=pubStatsGroup, linkSymmetry=linkSymmetry, linkLossLinked=linkLossLinked, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, snmpControl=snmpControl, accessMethod=accessMethod, syslogClientTrap=syslogClientTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, transmitDataRate=transmitDataRate, dfsTableNumber=dfsTableNumber, longitude=longitude, licenseTLSRekey=licenseTLSRekey, auxPortStatusTrap=auxPortStatusTrap, secondarySoftwareVersion=secondarySoftwareVersion, signalStrengthRatio=signalStrengthRatio, byteErrorRatioLinked=byteErrorRatioLinked, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, transparentClockPort=transparentClockPort, sFPPortStatus=sFPPortStatus, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, ethernetStatisticsTable=ethernetStatisticsTable, tDDControl=tDDControl, phyControlInstancedTableNumber=phyControlInstancedTableNumber, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, dNSServerTableEntry=dNSServerTableEntry, cableDiagPair3Distance=cableDiagPair3Distance, ethernetPriorityTableNumber=ethernetPriorityTableNumber, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, gatewayIPAddress=gatewayIPAddress, l2CPPriorityTableNumber=l2CPPriorityTableNumber, receiveFreqKHz=receiveFreqKHz, iPv4Address=iPv4Address, receiveDataRate=receiveDataRate, tdmTableEntry=tdmTableEntry, sMTPEmailAlert=sMTPEmailAlert, sNTPServerTableIndex=sNTPServerTableIndex, bootVersion=bootVersion, resetGroup=resetGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, sNTPPollInterval=sNTPPollInterval, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, mainPSUPortSSMTx=mainPSUPortSSMTx, sNMPTrapTableIndex=sNMPTrapTableIndex, dataBridgingStatus=dataBridgingStatus, dataBridgingStatusAlarm=dataBridgingStatusAlarm, dfs=dfs, sNMPv3Enable=sNMPv3Enable, linkLoss=linkLoss, licenseGroup=licenseGroup, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, tDMChannelLoopback=tDMChannelLoopback, txColorCode=txColorCode, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, auxPortDisabledWarning=auxPortDisabledWarning, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, sFPPortAutoMdix=sFPPortAutoMdix, dNS=dNS, transmitModulationModeLinked=transmitModulationModeLinked, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, alarmInstancedTable=alarmInstancedTable, PYSNMP_MODULE_ID=cambium, sMTPServerPortNumber=sMTPServerPortNumber, vLANManagementVID=vLANManagementVID, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, sFPErrorTrap=sFPErrorTrap, licenseOOBManagementSupport=licenseOOBManagementSupport, syncETrackingState=syncETrackingState, syncEEquipmentClock=syncEEquipmentClock, alarms=alarms, rxColorCode=rxColorCode, rawReceivePowerLinked=rawReceivePowerLinked, ptpGroups=ptpGroups, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, mABNominalModulationMode=mABNominalModulationMode, blacklistRMEnabled=blacklistRMEnabled, rangeLinked=rangeLinked, sNTPPrimaryServer=sNTPPrimaryServer, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, transparentClockVLAN=transparentClockVLAN, reset=reset, subnetMask=subnetMask, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, masterSlaveMode=masterSlaveMode, sNTPServerTableNumber=sNTPServerTableNumber, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, receiveChannel=receiveChannel, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNMPPortNumber=sNMPPortNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, mgmtInstancedTableEntry=mgmtInstancedTableEntry, dataPortPauseFrames=dataPortPauseFrames, sMTPSourceEmailAddress=sMTPSourceEmailAddress, portAllocationMismatchTrap=portAllocationMismatchTrap, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, regulatoryBand=regulatoryBand, unitIdentification=unitIdentification, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, licenseRegulatoryBandsList=licenseRegulatoryBandsList, phyControlInstancedTableEntry=phyControlInstancedTableEntry, dNSPrimaryServer=dNSPrimaryServer, blacklistRMMacAddress=blacklistRMMacAddress, authorizationControlTableEntry=authorizationControlTableEntry, auxPortQLTx=auxPortQLTx, sFPPortDisabledWarning=sFPPortDisabledWarning, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, snmpControlGroup=snmpControlGroup, dfsPeaks=dfsPeaks, ethernetInstancedTable=ethernetInstancedTable, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, dfsTable=dfsTable, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, configurationGroup=configurationGroup, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, secureModeAlarm=secureModeAlarm, ptmp=ptmp, phyControlInstancedTable=phyControlInstancedTable, mABProtocolVID=mABProtocolVID, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, ethernet=ethernet, authorizationControl=authorizationControl, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, sNTPServerInternetAddressType=sNTPServerInternetAddressType, aggregateDataRateLinked=aggregateDataRateLinked, systemClock=systemClock, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, rangingMode=rangingMode, channelBandwidth=channelBandwidth, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, capacityVariantMismatchLinked=capacityVariantMismatchLinked, sNMPTrapInternetAddress=sNMPTrapInternetAddress, licenseInstancedTable=licenseInstancedTable, tDMChannelCableLength=tDMChannelCableLength, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, transmitChannel=transmitChannel, extendedSpectrumScanning=extendedSpectrumScanning, vectorError=vectorError, tempPcb=tempPcb, tDDSynchronizationMode=tDDSynchronizationMode, configurationInstancedTableEntry=configurationInstancedTableEntry, authorizationMethod=authorizationMethod, receiveModulationMode=receiveModulationMode, subbandLowestFrequency=subbandLowestFrequency, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, remoteUnitNameLinked=remoteUnitNameLinked, lowestDataModulationMode=lowestDataModulationMode)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", routerProtocolsGroup=routerProtocolsGroup, sNMPTrapTable=sNMPTrapTable, licenseCountry=licenseCountry, transmitPowerLinked=transmitPowerLinked, sNTPSyncTrap=sNTPSyncTrap, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dNSGroup=dNSGroup, phyControlInstancedTableIndex=phyControlInstancedTableIndex, vectorErrorLinked=vectorErrorLinked, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, dNSServerTableNumber=dNSServerTableNumber, transmitDataRateLinked=transmitDataRateLinked, dataBridgingAvailability=dataBridgingAvailability, syncETracking=syncETracking, systemReset=systemReset, wirelessOutAllOctets=wirelessOutAllOctets, mainPSUPortAllocation=mainPSUPortAllocation, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, channelChangeTrap=channelChangeTrap, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, mABTransmissionInterval=mABTransmissionInterval, userName=userName, userPassword=userPassword, localPacketFiltering=localPacketFiltering, tFTPServerInternetAddressType=tFTPServerInternetAddressType, mainPSUPortStatus=mainPSUPortStatus, mainPSUPortStatusTrap=mainPSUPortStatusTrap, mABMaintenanceLevel=mABMaintenanceLevel, phyStatusGroup=phyStatusGroup, mgmtInstancedTable=mgmtInstancedTable, managementGroup=managementGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, licenseRARSupport=licenseRARSupport, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, apc=apc, licenseSecurityLevel=licenseSecurityLevel, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, byteErrorRatio=byteErrorRatio, receiveModulationModeLinked=receiveModulationModeLinked, sntpGroup=sntpGroup, licenseHCMPSupport=licenseHCMPSupport, authorizationControlTableNumber=authorizationControlTableNumber, auxPortAcceptedQLRx=auxPortAcceptedQLRx, linkModeOptimizationMismatch=linkModeOptimizationMismatch, mABProtocolVLANPriority=mABProtocolVLANPriority, deviceMACAddress=deviceMACAddress, altitude=altitude, configurationInstancedTable=configurationInstancedTable, dNSServerTable=dNSServerTable, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, unitIdentificationGroup=unitIdentificationGroup, userEnabled=userEnabled, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, sNTPServerTable=sNTPServerTable, cableDiagPair1Distance=cableDiagPair1Distance, nIDULanPortStatusTrap=nIDULanPortStatusTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, tdmTable=tdmTable, ethernetStatisticsDataSource=ethernetStatisticsDataSource, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, cableDiagPair2Results=cableDiagPair2Results, license=license, capacityVariantMismatchTrap=capacityVariantMismatchTrap, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, syslogControl=syslogControl, ethernetGroup=ethernetGroup, tDMEnabledChannels=tDMEnabledChannels, tDMChannelStatus=tDMChannelStatus, searchState=searchState, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, cableDiagPair1Results=cableDiagPair1Results, cableDiagPair4Results=cableDiagPair4Results, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, cableDiagPair3Results=cableDiagPair3Results, licenseGroupAccess=licenseGroupAccess, telnetPortNumber=telnetPortNumber, hTTPAccessEnabled=hTTPAccessEnabled, sFPPortSyncERxStatus=sFPPortSyncERxStatus, maximumTransmitPower=maximumTransmitPower, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sFPPortStatusTrap=sFPPortStatusTrap, hCMPLinkSymmetry=hCMPLinkSymmetry, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, ethernetPriorityTable=ethernetPriorityTable, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, dfsTableIndex=dfsTableIndex, remoteUnitName=remoteUnitName, auxPortSSMTx=auxPortSSMTx, aggregateDataRate=aggregateDataRate, sNTPServerTimeout=sNTPServerTimeout, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, pubInstancedStatsTable=pubInstancedStatsTable, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, userTableIndex=userTableIndex, enableTransmission=enableTransmission, hardwareVersion=hardwareVersion, licenseInstancedTableIndex=licenseInstancedTableIndex, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tDMInterfaceControl=tDMInterfaceControl, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, syslogState=syslogState, sntp=sntp, frequencyVariant=frequencyVariant, tDDSynchronizationAlarm=tDDSynchronizationAlarm, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, dataBridgingStatusLinked=dataBridgingStatusLinked, whitelistRMMacAddress=whitelistRMMacAddress, licenseVersion=licenseVersion, useVLANForManagementInterfaces=useVLANForManagementInterfaces, authorizationControlGroup=authorizationControlGroup, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, antennaSelection=antennaSelection, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, rawReceivePower=rawReceivePower, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, tDMInterfaceStatus=tDMInterfaceStatus, tFTPServerPortNumber=tFTPServerPortNumber, configurationInstancedTableNumber=configurationInstancedTableNumber, cambium=cambium, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sFPError=sFPError, latitude=latitude, tDMChannelStatusTrap=tDMChannelStatusTrap, cableDiagnosticsControl=cableDiagnosticsControl, iPv6Address=iPv6Address, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, noWirelessChannelAvailable=noWirelessChannelAvailable, enabledDiagnosticAlarms=enabledDiagnosticAlarms, remoteInternetAddress=remoteInternetAddress, productVariant=productVariant, userRole=userRole, installArmState=installArmState, phyStatus=phyStatus, dNSServerInternetAddressType=dNSServerInternetAddressType, alarmInstancedTableEntry=alarmInstancedTableEntry, cableDiagnosticsResultTable=cableDiagnosticsResultTable, softwareVersion=softwareVersion, receiveModulationModeDetail=receiveModulationModeDetail, authorizationControlTable=authorizationControlTable, ethernetPriorityTableEntry=ethernetPriorityTableEntry, installationMode=installationMode, sNTPLastSync=sNTPLastSync, ptpTraps=ptpTraps, cableDiagnosticsWarning=cableDiagnosticsWarning, txMABFrames=txMABFrames, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, smtpGroup=smtpGroup, linkName=linkName, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, remoteMaximumTransmitPower=remoteMaximumTransmitPower, lowestTDMModulationMode=lowestTDMModulationMode, eIRP=eIRP, dSCPManagementPriority=dSCPManagementPriority, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, l2CPPriorityTableEntry=l2CPPriorityTableEntry, alarmInstancedTableNumber=alarmInstancedTableNumber, ethernetInstancedTableNumber=ethernetInstancedTableNumber, cableLoss=cableLoss, iPv6PrefixLength=iPv6PrefixLength, ethernetInstancedTableEntry=ethernetInstancedTableEntry, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, wirelessLinkStatus=wirelessLinkStatus, apcGroup=apcGroup, sFPPortSSMTx=sFPPortSSMTx, managementNetworkAccessEnabled=managementNetworkAccessEnabled, nIDULanPortStatus=nIDULanPortStatus, packetsToInternalStack=packetsToInternalStack, wirelessOutEthernetOctets=wirelessOutEthernetOctets, siteName=siteName, sNTPSync=sNTPSync, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, erroredSeconds=erroredSeconds, sMTPEnabledMessages=sMTPEnabledMessages, sNTPServerPortNumber=sNTPServerPortNumber, encryptionGroup=encryptionGroup, tDMConfigurationMismatch=tDMConfigurationMismatch, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, sFPPortAllocation=sFPPortAllocation, phyInstancedStatusTable=phyInstancedStatusTable, dNSServerTableIndex=dNSServerTableIndex, hTTPSPortNumber=hTTPSPortNumber, receiveDataRateLinked=receiveDataRateLinked, auxPortConfigurationMismatch=auxPortConfigurationMismatch, userTableNumber=userTableNumber, licenseIPv6Support=licenseIPv6Support, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, dfsGroup=dfsGroup, sNTPServerStatus=sNTPServerStatus, severelyErroredSeconds=severelyErroredSeconds, ethernetPriorityTableIndex=ethernetPriorityTableIndex, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, ptpTrapPrefix=ptpTrapPrefix, configurationInstancedTableIndex=configurationInstancedTableIndex, installStatus=installStatus, transmitModulationMode=transmitModulationMode, vLANManagementPriority=vLANManagementPriority, lbtDetectedTrap=lbtDetectedTrap, timeZone=timeZone, routerProtocols=routerProtocols, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, smtp=smtp, licenseEncryption=licenseEncryption, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, range=range, auxPortAllocation=auxPortAllocation, syncESlavePort=syncESlavePort, remoteMACAddressLinked=remoteMACAddressLinked, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, mainPSUPortQLRx=mainPSUPortQLRx, wirelessOutOctets=wirelessOutOctets, ptpCompliance=ptpCompliance, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, licenseIssueNumber=licenseIssueNumber, qOSPriorityScheme=qOSPriorityScheme, licenseMaxLinkRange=licenseMaxLinkRange, incompatibleRegulatoryBands=incompatibleRegulatoryBands, mainPSUPortAutoMdix=mainPSUPortAutoMdix, tDDControlGroup=tDDControlGroup, mgmtInstancedTableIndex=mgmtInstancedTableIndex, oOBPriorityQueueMapping=oOBPriorityQueueMapping, aAAControl=aAAControl, unitName=unitName, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, versions=versions, unitOutOfCalibration=unitOutOfCalibration, licenseTDDSyncSupport=licenseTDDSyncSupport, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, installStatusLinked=installStatusLinked, hCMPMaximumLinkRange=hCMPMaximumLinkRange, packetsFromInternalStack=packetsFromInternalStack, remoteMACAddress=remoteMACAddress, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, mABHoldoffPeriod=mABHoldoffPeriod, licenseInstancedTableEntry=licenseInstancedTableEntry, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, licenseUnitSerialNumber=licenseUnitSerialNumber, hTTPPortNumber=hTTPPortNumber, ptp670=ptp670, mgmtInstancedTableNumber=mgmtInstancedTableNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, sFPPortQLTx=sFPPortQLTx, remoteInternetAddressLinked=remoteInternetAddressLinked, authorizationControlTableIndex=authorizationControlTableIndex, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, sNTPState=sNTPState, sNMPCommunityString=sNMPCommunityString, portAllocationMismatchLinked=portAllocationMismatchLinked, tdmTableIndex=tdmTableIndex, tdmTableNumber=tdmTableNumber, auxPortQLRx=auxPortQLRx, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, transmitFreqMHz=transmitFreqMHz, sNTPServerInternetAddress=sNTPServerInternetAddress, phyControlGroup=phyControlGroup, licenseBandwidthCap=licenseBandwidthCap, ptp=ptp, whitelistRMEnabled=whitelistRMEnabled, mPLSTCPriorityTable=mPLSTCPriorityTable, sFPPortAutoNegotiation=sFPPortAutoNegotiation, groupID=groupID, notificationsGroup=notificationsGroup, l2CPPriorityTableIndex=l2CPPriorityTableIndex, targetMACAddress=targetMACAddress, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, auxPortSyncERxStatus=auxPortSyncERxStatus, receiveFreqMHz=receiveFreqMHz, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, unavailableSeconds=unavailableSeconds, encryptionAlgorithm=encryptionAlgorithm, dfsMeans=dfsMeans, ethernetInstancedTableIndex=ethernetInstancedTableIndex, licenseTrialPeriod=licenseTrialPeriod, transparentClock=transparentClock, searchStateLinked=searchStateLinked, auxPortStatus=auxPortStatus, daylightSaving=daylightSaving, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, licenseSFPPortSupport=licenseSFPPortSupport, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, phyControl=phyControl, telnetAccessEnabled=telnetAccessEnabled, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, licenseSyncESupport=licenseSyncESupport, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, dfsTableEntry=dfsTableEntry, tFTPServerInternetAddress=tFTPServerInternetAddress, licenseCapacity=licenseCapacity, alarmInstancedTableIndex=alarmInstancedTableIndex, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, maximumNumberOfSlaves=maximumNumberOfSlaves, cableDiagnostics=cableDiagnostics, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, regulatoryBandTrap=regulatoryBandTrap, maxLinkRangeExceeded=maxLinkRangeExceeded, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, dNSServerPortNumber=dNSServerPortNumber, installStatusTrap=installStatusTrap)
