...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", dataBridgingStatus=dataBridgingStatus, vectorError=vectorError, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, pubStats=pubStats, transmitModulationModeLinked=transmitModulationModeLinked, tdmTableNumber=tdmTableNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, bootVersion=bootVersion, l2CPPriorityTableEntry=l2CPPriorityTableEntry, subbandHighestFrequency=subbandHighestFrequency, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, alarmInstancedTable=alarmInstancedTable, cableDiagnosticsGroup=cableDiagnosticsGroup, portAllocationMismatch=portAllocationMismatch, productVariant=productVariant, sNMPTrapVersion=sNMPTrapVersion, dNSResolver=dNSResolver, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, unavailableSeconds=unavailableSeconds, deviceESN=deviceESN, cableDiagPair2Distance=cableDiagPair2Distance, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, sFPPortAllocation=sFPPortAllocation, extendedSpectrumScanning=extendedSpectrumScanning, authorizationControlTableNumber=authorizationControlTableNumber, smtp=smtp, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, ethernetPriorityTableIndex=ethernetPriorityTableIndex, cableDiagnosticsControl=cableDiagnosticsControl, dNSServerTable=dNSServerTable, blacklistRMMacAddress=blacklistRMMacAddress, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, dNSServerTableIndex=dNSServerTableIndex, userPassword=userPassword, configurationInstancedTableEntry=configurationInstancedTableEntry, ethernetInstancedTableNumber=ethernetInstancedTableNumber, tDM=tDM, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, auxPortConfigurationMismatch=auxPortConfigurationMismatch, txColorCode=txColorCode, lowestDataModulationMode=lowestDataModulationMode, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, resetGroup=resetGroup, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, deviceMSN=deviceMSN, lbtDetectedTrap=lbtDetectedTrap, auxPortQLRx=auxPortQLRx, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, sFPPortStatusTrap=sFPPortStatusTrap, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, remoteInternetAddressType=remoteInternetAddressType, cableDiagPair4Distance=cableDiagPair4Distance, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, sNTPSyncTrap=sNTPSyncTrap, licenseCapacity=licenseCapacity, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, transparentClockVLAN=transparentClockVLAN, licenseTLSRekey=licenseTLSRekey, tDMEnabledChannels=tDMEnabledChannels, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, maximumTransmitPower=maximumTransmitPower, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, ethernetPriorityTableNumber=ethernetPriorityTableNumber, gatewayIPAddress=gatewayIPAddress, secureModeAlarm=secureModeAlarm, sNTPServerPortNumber=sNTPServerPortNumber, alarmInstancedTableNumber=alarmInstancedTableNumber, txMABFrames=txMABFrames, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, configurationInstancedTableNumber=configurationInstancedTableNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, authorizationControlTableEntry=authorizationControlTableEntry, dataBridgingAvailability=dataBridgingAvailability, capacityVariantMismatchLinked=capacityVariantMismatchLinked, remoteMACAddress=remoteMACAddress, auxPortSyncERxStatus=auxPortSyncERxStatus, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, transmitChannel=transmitChannel, userRole=userRole, transmitPowerLinked=transmitPowerLinked, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, receiveFreqKHz=receiveFreqKHz, licenseSecurityLevel=licenseSecurityLevel, frequencyVariant=frequencyVariant, enableTransmission=enableTransmission, syncEEquipmentClock=syncEEquipmentClock, maximumNumberOfSlaves=maximumNumberOfSlaves, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, transmitDataRateLinked=transmitDataRateLinked, capacityVariantMismatch=capacityVariantMismatch, auxPortSSMTx=auxPortSSMTx, sNTPServerTableEntry=sNTPServerTableEntry, syslogStateTrap=syslogStateTrap, remoteInternetAddressLinked=remoteInternetAddressLinked, cableLoss=cableLoss, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, range=range, licenseIEEE1588Support=licenseIEEE1588Support, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, sNMPTrapInternetAddress=sNMPTrapInternetAddress, systemClock=systemClock, wirelessOutOctets=wirelessOutOctets, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, remoteUnitName=remoteUnitName, sNMPv3Enable=sNMPv3Enable, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, licenseTDDSyncSupport=licenseTDDSyncSupport, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, sNTPSync=sNTPSync, sFPPortSyncERxStatus=sFPPortSyncERxStatus, alarmInstancedTableIndex=alarmInstancedTableIndex, alarmsGroup=alarmsGroup, vLANManagementPriority=vLANManagementPriority, antennaSelection=antennaSelection, l2CPPriorityTableNumber=l2CPPriorityTableNumber, licenseUnitSerialNumber=licenseUnitSerialNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, dNSServerInternetAddress=dNSServerInternetAddress, whitelistRMEnabled=whitelistRMEnabled, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, transmitterChannels=transmitterChannels, subbandLowestFrequency=subbandLowestFrequency, dataPortPauseFrames=dataPortPauseFrames, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNMPTrapTable=sNMPTrapTable, iPv6GatewayAddress=iPv6GatewayAddress, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, hTTPAccessEnabled=hTTPAccessEnabled, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, ptpTraps=ptpTraps, syslogControlGroup=syslogControlGroup, cableDiagPair1Distance=cableDiagPair1Distance, authorizationControl=authorizationControl, systemReset=systemReset, searchState=searchState, linkLossLinked=linkLossLinked, receiveFreqMHz=receiveFreqMHz, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, iPVersion=iPVersion, phyStatusGroup=phyStatusGroup, mABNominalModulationMode=mABNominalModulationMode, tdmTableEntry=tdmTableEntry, transmitDataRate=transmitDataRate, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, userName=userName, whitelistRMMacAddress=whitelistRMMacAddress, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, dNS=dNS, iPv4Address=iPv4Address, ethernetStatisticsTable=ethernetStatisticsTable, licenseInstancedTableIndex=licenseInstancedTableIndex, sFPError=sFPError, routerProtocolsGroup=routerProtocolsGroup, tDMChannelStatusTrap=tDMChannelStatusTrap, sFPPortSSMTx=sFPPortSSMTx, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, versionsGroup=versionsGroup, smtpGroup=smtpGroup, qOSPriorityScheme=qOSPriorityScheme, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, antennaGain=antennaGain, dNSServerPortNumber=dNSServerPortNumber, dfsGroup=dfsGroup, mABNominalTransmitCapacity=mABNominalTransmitCapacity, aAAControl=aAAControl, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, dNSPrimaryServer=dNSPrimaryServer, sFPPortAutoMdix=sFPPortAutoMdix, receiveModulationMode=receiveModulationMode, mgmtInstancedTableNumber=mgmtInstancedTableNumber, maxLinkRangeExceeded=maxLinkRangeExceeded, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, licenseVersion=licenseVersion, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, installArmState=installArmState, packetsFromInternalStack=packetsFromInternalStack, sNTPServerInternetAddressType=sNTPServerInternetAddressType, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, PYSNMP_MODULE_ID=cambium, unitIdentificationGroup=unitIdentificationGroup, sNTPServerTable=sNTPServerTable, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, bridgeGroup=bridgeGroup, transparentClockVID=transparentClockVID, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, authorizationControlTable=authorizationControlTable, daylightSaving=daylightSaving, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, tDDControl=tDDControl, rangingMode=rangingMode, tdmTable=tdmTable, tDMChannelCableLength=tDMChannelCableLength, sNMPCommunityString=sNMPCommunityString, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, productName=productName, managementPortWirelessDownAlert=managementPortWirelessDownAlert, licenseInstancedTable=licenseInstancedTable, receiveDataRateLinked=receiveDataRateLinked, sMTPServerInternetAddress=sMTPServerInternetAddress, mABState=mABState, cableDiagPair2Results=cableDiagPair2Results, dNSServerInternetAddressType=dNSServerInternetAddressType, dfsTableIndex=dfsTableIndex, dfs=dfs, timeZone=timeZone, transmitFreqKHz=transmitFreqKHz, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, licenseCountry=licenseCountry, transmitModulationMode=transmitModulationMode, accessMethod=accessMethod, installStatusLinked=installStatusLinked, tDMConfigurationMismatch=tDMConfigurationMismatch, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, licenseInstancedTableEntry=licenseInstancedTableEntry, rawReceivePowerLinked=rawReceivePowerLinked, installArmStateTrap=installArmStateTrap, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, sMTPServerInternetAddressType=sMTPServerInternetAddressType, apcGroup=apcGroup, snmpControlGroup=snmpControlGroup, auxPortQLTx=auxPortQLTx, ptpTrapPrefix=ptpTrapPrefix, receiveModulationModeDetail=receiveModulationModeDetail, auxPortDisabledWarning=auxPortDisabledWarning, unitIdentification=unitIdentification, userTableIndex=userTableIndex, signalStrengthRatio=signalStrengthRatio, licenseIssueNumber=licenseIssueNumber, installationMode=installationMode, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, managementGroup=managementGroup, linkModeOptimization=linkModeOptimization, remoteMACAddressLinked=remoteMACAddressLinked, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, supplementaryGroup=supplementaryGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", remoteMaximumTransmitPower=remoteMaximumTransmitPower, tDMChannelStatus=tDMChannelStatus, portAllocationMismatchTrap=portAllocationMismatchTrap, ptmp=ptmp, incompatibleMasterAndSlave=incompatibleMasterAndSlave, mABTransmissionInterval=mABTransmissionInterval, mABProtocolVID=mABProtocolVID, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, configurationInstancedTable=configurationInstancedTable, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, mainPSUPortSSMTx=mainPSUPortSSMTx, licenseBandwidthCap=licenseBandwidthCap, aggregateDataRate=aggregateDataRate, licenseEncryption=licenseEncryption, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, mainPSUPortQLRx=mainPSUPortQLRx, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, sNMPTrapTableNumber=sNMPTrapTableNumber, syncETracking=syncETracking, unitName=unitName, authorizationControlGroup=authorizationControlGroup, licenseIPv6Support=licenseIPv6Support, licenseGasGroup=licenseGasGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, secureModeAlarmTrap=secureModeAlarmTrap, sntp=sntp, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, sFPPortStatus=sFPPortStatus, ptpCompliance=ptpCompliance, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, licenseGroup=licenseGroup, dSCPManagementPriority=dSCPManagementPriority, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, ethernetInstancedTable=ethernetInstancedTable, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, hardwareVersion=hardwareVersion, ethernetInstancedTableIndex=ethernetInstancedTableIndex, ptp670=ptp670, phyControl=phyControl, ptpGroups=ptpGroups, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, remoteInternetAddress=remoteInternetAddress, apc=apc, sNTPServerTableNumber=sNTPServerTableNumber, licenseSyncESupport=licenseSyncESupport, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, transparentClock=transparentClock, sNMPTrapTableIndex=sNMPTrapTableIndex, userTableNumber=userTableNumber, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, syslogClientTrap=syslogClientTrap, sNTPServerStatus=sNTPServerStatus, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, linkSymmetry=linkSymmetry, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, linkName=linkName, tFTPServerInternetAddressType=tFTPServerInternetAddressType, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, supplementary=supplementary, channelBandwidth=channelBandwidth, auxPortStatus=auxPortStatus, configuration=configuration, reset=reset, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, tDMGroup=tDMGroup, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, cableDiagPair3Distance=cableDiagPair3Distance, iPDSCPPriorityTable=iPDSCPPriorityTable, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, tDDSynchronizationAlarm=tDDSynchronizationAlarm, licenseSFPPortSupport=licenseSFPPortSupport, licenseOOBManagementSupport=licenseOOBManagementSupport, siteName=siteName, licenseMaxLinkRange=licenseMaxLinkRange, telnetPortNumber=telnetPortNumber, tDMChannelLoopback=tDMChannelLoopback, sFPPortDisabledWarning=sFPPortDisabledWarning, phyInstancedStatusTable=phyInstancedStatusTable, tempPcb=tempPcb, dfsTableNumber=dfsTableNumber, alarms=alarms, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, nIDULanPortStatus=nIDULanPortStatus, syslogClient=syslogClient, cableDiagnosticsPorts=cableDiagnosticsPorts, licenseHCMPSupport=licenseHCMPSupport, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, eIRP=eIRP, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, licenseTrialPeriod=licenseTrialPeriod, receiveDataRate=receiveDataRate, mainPSUPortStatusTrap=mainPSUPortStatusTrap, receivePower=receivePower, severelyErroredSeconds=severelyErroredSeconds, alarmInstancedTableEntry=alarmInstancedTableEntry, ptp=ptp, aggregateDataRateLinked=aggregateDataRateLinked, snmpControl=snmpControl, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, license=license, cambium=cambium, tDMInterfaceStatus=tDMInterfaceStatus, ethernetGroup=ethernetGroup, licenseRegulatoryBandsList=licenseRegulatoryBandsList, installStatus=installStatus, dfsTableEntry=dfsTableEntry, oOBPriorityQueueMapping=oOBPriorityQueueMapping, nIDULanPortAutoMdix=nIDULanPortAutoMdix, pubInstancedStatsTable=pubInstancedStatsTable, mgmtInstancedTableIndex=mgmtInstancedTableIndex, versions=versions, rangeLinked=rangeLinked, authorizationControlTableIndex=authorizationControlTableIndex, phyControlInstancedTable=phyControlInstancedTable, tdmTableIndex=tdmTableIndex, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dfsPeaks=dfsPeaks, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, sMTPEnabledMessages=sMTPEnabledMessages, wirelessTopology=wirelessTopology, syslogState=syslogState, sMTPEmailAlert=sMTPEmailAlert, phyControlInstancedTableIndex=phyControlInstancedTableIndex, sNTPServerTimeout=sNTPServerTimeout, unitOutOfCalibration=unitOutOfCalibration, phyControlInstancedTableEntry=phyControlInstancedTableEntry, licenseGroupAccess=licenseGroupAccess, tDMChannelLineCode=tDMChannelLineCode, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, lowestTDMModulationMode=lowestTDMModulationMode, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, cableDiagnostics=cableDiagnostics, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, userTable=userTable, telnetAccessEnabled=telnetAccessEnabled, hTTPSPortNumber=hTTPSPortNumber, dataBridgingStatusAlarm=dataBridgingStatusAlarm, receiveChannel=receiveChannel, hCMPMaximumLinkRange=hCMPMaximumLinkRange, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, sntpGroup=sntpGroup, sNMPPortNumber=sNMPPortNumber, auxPortAcceptedQLRx=auxPortAcceptedQLRx, authorizationMethod=authorizationMethod, mABMaintenanceLevel=mABMaintenanceLevel, installStatusTrap=installStatusTrap, longitude=longitude, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, licenseRARSupport=licenseRARSupport, notificationsGroup=notificationsGroup, hTTPPortNumber=hTTPPortNumber, syslogControl=syslogControl, configurationGroup=configurationGroup, mainPSUPortStatus=mainPSUPortStatus, latitude=latitude, management=management, encryption=encryption, tDDSynchronizationStatus=tDDSynchronizationStatus, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, sFPPortAutoNegotiation=sFPPortAutoNegotiation, linkModeOptimizationMismatch=linkModeOptimizationMismatch, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, targetMACAddress=targetMACAddress, aAAControlGroup=aAAControlGroup, targetRange=targetRange, syncESlavePort=syncESlavePort, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, linkLoss=linkLoss, iPv6PrefixLength=iPv6PrefixLength, phyStatus=phyStatus, managementNetworkAccessEnabled=managementNetworkAccessEnabled, vectorErrorLinked=vectorErrorLinked, tDMInterfaceControl=tDMInterfaceControl, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPServerTableIndex=sNTPServerTableIndex, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, cableDiagnosticsResultTable=cableDiagnosticsResultTable, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNTPServerRetries=sNTPServerRetries, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, vLANManagementVID=vLANManagementVID, blacklistRMEnabled=blacklistRMEnabled, phyControlGroup=phyControlGroup, regulatoryBandTrap=regulatoryBandTrap, userEnabled=userEnabled, encryptionAlgorithm=encryptionAlgorithm, searchStateLinked=searchStateLinked, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, sNTPState=sNTPState, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, masterSlaveMode=masterSlaveMode, channelChangeTrap=channelChangeTrap, mainPSUPortAllocation=mainPSUPortAllocation, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, sNTPPollInterval=sNTPPollInterval, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, wirelessLinkAvailability=wirelessLinkAvailability, cableDiagPair1Results=cableDiagPair1Results, receivePowerLinked=receivePowerLinked, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, wirelessLinkStatus=wirelessLinkStatus, tFTPServerInternetAddress=tFTPServerInternetAddress, dfsTable=dfsTable, auxPortAllocation=auxPortAllocation, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, configurationInstancedTableIndex=configurationInstancedTableIndex, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, signalStrengthRatioLinked=signalStrengthRatioLinked, sNTPPrimaryServer=sNTPPrimaryServer, sFPPortQLTx=sFPPortQLTx, byteErrorRatioLinked=byteErrorRatioLinked, capacityVariantMismatchTrap=capacityVariantMismatchTrap, tDDControlGroup=tDDControlGroup, ethernetInstancedTableEntry=ethernetInstancedTableEntry, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, routerProtocols=routerProtocols, deviceMACAddress=deviceMACAddress, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, sNTPLastSync=sNTPLastSync, pubStatsGroup=pubStatsGroup, wirelessOutEthernetOctets=wirelessOutEthernetOctets, cableDiagPair3Results=cableDiagPair3Results, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, cableDiagnosticsWarning=cableDiagnosticsWarning, licenseInstancedTableNumber=licenseInstancedTableNumber, localPacketFiltering=localPacketFiltering, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, hCMPLinkSymmetry=hCMPLinkSymmetry, ethernetPriorityTable=ethernetPriorityTable, ethernet=ethernet, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, hTTPSAccessEnabled=hTTPSAccessEnabled, portAllocationMismatchLinked=portAllocationMismatchLinked)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", incompatibleRegulatoryBands=incompatibleRegulatoryBands, mainPSUPortQLTx=mainPSUPortQLTx, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, regulatoryBand=regulatoryBand, auxPortStatusTrap=auxPortStatusTrap, transmitFreqMHz=transmitFreqMHz, sMTPServerPortNumber=sMTPServerPortNumber, mainPSUPortAutoMdix=mainPSUPortAutoMdix, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, encryptionGroup=encryptionGroup, ethernetStatisticsDataSource=ethernetStatisticsDataSource, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, iPv6Address=iPv6Address, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sFPPortQLRx=sFPPortQLRx, erroredSeconds=erroredSeconds, groupID=groupID, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tDDSynchronizationMode=tDDSynchronizationMode, dNSGroup=dNSGroup, transmitPower=transmitPower, wirelessLinkStatusLinked=wirelessLinkStatusLinked, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, subnetMask=subnetMask, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, sFPErrorTrap=sFPErrorTrap, rawReceivePower=rawReceivePower, tFTPClient=tFTPClient, userTableEntry=userTableEntry, mgmtInstancedTable=mgmtInstancedTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataBridgingStatusLinked=dataBridgingStatusLinked, rxColorCode=rxColorCode, secondarySoftwareVersion=secondarySoftwareVersion, useVLANForManagementInterfaces=useVLANForManagementInterfaces, mgmtInstancedTableEntry=mgmtInstancedTableEntry, l2CPPriorityTable=l2CPPriorityTable, mPLSTCPriorityTable=mPLSTCPriorityTable, useVLANForMABProtocol=useVLANForMABProtocol, mABHoldoffPeriod=mABHoldoffPeriod, syncETrackingState=syncETrackingState, sNMPEnabledTraps=sNMPEnabledTraps, dNSServerTableNumber=dNSServerTableNumber, cableDiagPair4Results=cableDiagPair4Results, packetsToInternalStack=packetsToInternalStack, transparentClockPort=transparentClockPort, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, tFTPServerPortNumber=tFTPServerPortNumber, phyControlInstancedTableNumber=phyControlInstancedTableNumber, remoteUnitNameLinked=remoteUnitNameLinked, receiveModulationModeLinked=receiveModulationModeLinked, altitude=altitude, mABProtocolVLANPriority=mABProtocolVLANPriority, dfsMeans=dfsMeans, wirelessOutAllOctets=wirelessOutAllOctets, dNSServerTableEntry=dNSServerTableEntry, byteErrorRatio=byteErrorRatio, enabledDiagnosticAlarms=enabledDiagnosticAlarms, softwareVersion=softwareVersion, bridge=bridge, nIDULanPortStatusTrap=nIDULanPortStatusTrap)
