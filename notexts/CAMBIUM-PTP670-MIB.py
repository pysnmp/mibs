...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, smtp=smtp, licenseSFPPortSupport=licenseSFPPortSupport, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, mgmtInstancedTable=mgmtInstancedTable, transmitDataRateLinked=transmitDataRateLinked, cableDiagPair1Distance=cableDiagPair1Distance, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, receiveDataRate=receiveDataRate, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, bridge=bridge, auxPortSyncERxStatus=auxPortSyncERxStatus, rxColorCode=rxColorCode, sFPPortQLRx=sFPPortQLRx, syslogControlGroup=syslogControlGroup, sFPError=sFPError, dfsTableEntry=dfsTableEntry, tDDControlGroup=tDDControlGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, altitude=altitude, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, aAAControlGroup=aAAControlGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, productVariant=productVariant, dataBridgingStatusAlarm=dataBridgingStatusAlarm, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, dNSPrimaryServer=dNSPrimaryServer, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, userTableIndex=userTableIndex, ptp670=ptp670, cableDiagPair4Distance=cableDiagPair4Distance, license=license, configurationGroup=configurationGroup, phyControlInstancedTableNumber=phyControlInstancedTableNumber, pubStatsGroup=pubStatsGroup, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, licenseInstancedTableIndex=licenseInstancedTableIndex, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, rawReceivePower=rawReceivePower, ethernetPriorityTableEntry=ethernetPriorityTableEntry, mPLSTCPriorityTable=mPLSTCPriorityTable, tFTPClient=tFTPClient, aggregateDataRateLinked=aggregateDataRateLinked, resetGroup=resetGroup, packetsFromInternalStack=packetsFromInternalStack, remoteUnitName=remoteUnitName, targetMACAddress=targetMACAddress, syncEEquipmentClock=syncEEquipmentClock, tFTPServerInternetAddress=tFTPServerInternetAddress, dataBridgingAvailability=dataBridgingAvailability, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, transmitModulationModeLinked=transmitModulationModeLinked, sMTPServerInternetAddress=sMTPServerInternetAddress, reset=reset, enableTransmission=enableTransmission, tDMInterfaceStatus=tDMInterfaceStatus, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, dfsGroup=dfsGroup, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, sFPPortStatus=sFPPortStatus, ptmp=ptmp, iPv6GatewayAddress=iPv6GatewayAddress, cableDiagPair4Results=cableDiagPair4Results, capacityVariantMismatch=capacityVariantMismatch, dNSServerInternetAddress=dNSServerInternetAddress, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, installStatus=installStatus, iPv6Address=iPv6Address, sFPPortStatusTrap=sFPPortStatusTrap, sNTPServerTableIndex=sNTPServerTableIndex, ptpCompliance=ptpCompliance, transmitFreqKHz=transmitFreqKHz, sFPPortQLTx=sFPPortQLTx, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, telnetPortNumber=telnetPortNumber, wirelessOutOctets=wirelessOutOctets, routerProtocols=routerProtocols, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, cableDiagnosticsGroup=cableDiagnosticsGroup, ethernetStatisticsDataSource=ethernetStatisticsDataSource, tDMEnabledChannels=tDMEnabledChannels, syslogStateTrap=syslogStateTrap, whitelistRMEnabled=whitelistRMEnabled, unitIdentificationGroup=unitIdentificationGroup, hTTPPortNumber=hTTPPortNumber, sNMPTrapTable=sNMPTrapTable, receivePowerLinked=receivePowerLinked, licenseGroupAccess=licenseGroupAccess, mainPSUPortStatusTrap=mainPSUPortStatusTrap, dSCPManagementPriority=dSCPManagementPriority, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, snmpControl=snmpControl, sntp=sntp, dfsTable=dfsTable, tempPcb=tempPcb, dNSServerTableNumber=dNSServerTableNumber, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, ethernetStatisticsTable=ethernetStatisticsTable, systemReset=systemReset, sNTPLastSync=sNTPLastSync, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, rangeLinked=rangeLinked, smtpGroup=smtpGroup, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, receiveFreqKHz=receiveFreqKHz, siteName=siteName, txMABFrames=txMABFrames, receiveChannel=receiveChannel, auxPortQLRx=auxPortQLRx, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, hTTPSPortNumber=hTTPSPortNumber, frequencyVariant=frequencyVariant, cableDiagPair2Results=cableDiagPair2Results, iPVersion=iPVersion, vectorError=vectorError, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, secureModeAlarm=secureModeAlarm, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, phyInstancedStatusTable=phyInstancedStatusTable, mgmtInstancedTableIndex=mgmtInstancedTableIndex, wirelessOutAllOctets=wirelessOutAllOctets, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, remoteUnitNameLinked=remoteUnitNameLinked, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, licenseGasGroup=licenseGasGroup, sNTPState=sNTPState, enabledDiagnosticAlarms=enabledDiagnosticAlarms, authorizationControlTableNumber=authorizationControlTableNumber, ethernetInstancedTable=ethernetInstancedTable, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, qOSPriorityScheme=qOSPriorityScheme, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, sntpGroup=sntpGroup, sNMPEnabledTraps=sNMPEnabledTraps, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, routerProtocolsGroup=routerProtocolsGroup, tDMConfigurationMismatch=tDMConfigurationMismatch, sNTPServerInternetAddressType=sNTPServerInternetAddressType, severelyErroredSeconds=severelyErroredSeconds, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, vLANManagementPriority=vLANManagementPriority, syncESlavePort=syncESlavePort, wirelessLinkStatusLinked=wirelessLinkStatusLinked, dfsMeans=dfsMeans, sNMPCommunityString=sNMPCommunityString, productName=productName, hardwareVersion=hardwareVersion, licenseTrialPeriod=licenseTrialPeriod, tdmTable=tdmTable, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, licenseHCMPSupport=licenseHCMPSupport, signalStrengthRatio=signalStrengthRatio, dNSServerTableEntry=dNSServerTableEntry, maximumNumberOfSlaves=maximumNumberOfSlaves, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, syslogClient=syslogClient, nIDULanPortAutoMdix=nIDULanPortAutoMdix, sNTPSyncTrap=sNTPSyncTrap, versionsGroup=versionsGroup, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, daylightSaving=daylightSaving, secureModeAlarmTrap=secureModeAlarmTrap, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, channelBandwidth=channelBandwidth, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, phyControlInstancedTable=phyControlInstancedTable, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, hCMPLinkSymmetry=hCMPLinkSymmetry, management=management, remoteInternetAddressType=remoteInternetAddressType, phyControl=phyControl, packetsToInternalStack=packetsToInternalStack, authorizationControlTableEntry=authorizationControlTableEntry, userName=userName, managementGroup=managementGroup, dfsTableIndex=dfsTableIndex, mainPSUPortAllocation=mainPSUPortAllocation, masterSlaveMode=masterSlaveMode, sNTPServerTableNumber=sNTPServerTableNumber, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, channelChangeTrap=channelChangeTrap, vLANManagementVID=vLANManagementVID, transmitPowerLinked=transmitPowerLinked, transmitPower=transmitPower, alarmInstancedTable=alarmInstancedTable, cableLoss=cableLoss, sNMPTrapVersion=sNMPTrapVersion, cableDiagPair1Results=cableDiagPair1Results, linkModeOptimization=linkModeOptimization, transmitterChannels=transmitterChannels, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, userTable=userTable, transparentClockVID=transparentClockVID, sFPPortAutoNegotiation=sFPPortAutoNegotiation, sNMPTrapTableIndex=sNMPTrapTableIndex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapInternetAddress=sNMPTrapInternetAddress, receiveFreqMHz=receiveFreqMHz, iPv4Address=iPv4Address, tDMInterfaceControl=tDMInterfaceControl, subbandHighestFrequency=subbandHighestFrequency, wirelessLinkStatus=wirelessLinkStatus, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, byteErrorRatio=byteErrorRatio, iPv6PrefixLength=iPv6PrefixLength, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, dfsPeaks=dfsPeaks, remoteMACAddressLinked=remoteMACAddressLinked, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, auxPortStatus=auxPortStatus, linkLossLinked=linkLossLinked, managementNetworkAccessEnabled=managementNetworkAccessEnabled, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, transmitFreqMHz=transmitFreqMHz, sFPPortSSMTx=sFPPortSSMTx, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, licenseInstancedTableNumber=licenseInstancedTableNumber, lowestTDMModulationMode=lowestTDMModulationMode, authorizationControlGroup=authorizationControlGroup, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, maximumTransmitPower=maximumTransmitPower, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, receiveModulationMode=receiveModulationMode, licenseRARSupport=licenseRARSupport, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, auxPortStatusTrap=auxPortStatusTrap, alarmInstancedTableNumber=alarmInstancedTableNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, transparentClock=transparentClock, cableDiagnosticsWarning=cableDiagnosticsWarning, dNSResolver=dNSResolver, alarms=alarms, licenseSyncESupport=licenseSyncESupport, noWirelessChannelAvailable=noWirelessChannelAvailable, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, l2CPPriorityTable=l2CPPriorityTable, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, alarmsGroup=alarmsGroup, userEnabled=userEnabled)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", deviceESN=deviceESN, mainPSUPortQLRx=mainPSUPortQLRx, configuration=configuration, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, syslogClientTrap=syslogClientTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, sNTPServerStatus=sNTPServerStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, remoteMaximumTransmitPower=remoteMaximumTransmitPower, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, licenseIssueNumber=licenseIssueNumber, transparentClockPort=transparentClockPort, syncETrackingState=syncETrackingState, tdmTableEntry=tdmTableEntry, searchStateLinked=searchStateLinked, licenseEncryption=licenseEncryption, auxPortSSMTx=auxPortSSMTx, sFPPortAutoMdix=sFPPortAutoMdix, auxPortAllocation=auxPortAllocation, capacityVariantMismatchLinked=capacityVariantMismatchLinked, tDMChannelLoopback=tDMChannelLoopback, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, mgmtInstancedTableNumber=mgmtInstancedTableNumber, mABMaintenanceLevel=mABMaintenanceLevel, pubInstancedStatsTable=pubInstancedStatsTable, ethernetInstancedTableIndex=ethernetInstancedTableIndex, systemClock=systemClock, phyControlGroup=phyControlGroup, licenseInstancedTable=licenseInstancedTable, tDMChannelCableLength=tDMChannelCableLength, remoteMACAddress=remoteMACAddress, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, installStatusTrap=installStatusTrap, dataBridgingStatus=dataBridgingStatus, auxPortQLTx=auxPortQLTx, localPacketFiltering=localPacketFiltering, notificationsGroup=notificationsGroup, txColorCode=txColorCode, mABNominalTransmitCapacity=mABNominalTransmitCapacity, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ethernetPriorityTable=ethernetPriorityTable, mainPSUPortStatus=mainPSUPortStatus, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, mainPSUPortSSMTx=mainPSUPortSSMTx, mainPSUPortQLTx=mainPSUPortQLTx, ethernetPriorityTableIndex=ethernetPriorityTableIndex, hTTPAccessEnabled=hTTPAccessEnabled, installArmState=installArmState, latitude=latitude, licenseOOBManagementSupport=licenseOOBManagementSupport, auxPortDisabledWarning=auxPortDisabledWarning, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, lbtDetectedTrap=lbtDetectedTrap, installArmStateTrap=installArmStateTrap, phyControlInstancedTableEntry=phyControlInstancedTableEntry, installationMode=installationMode, versions=versions, tDM=tDM, licenseTLSRekey=licenseTLSRekey, sFPPortSyncERxStatus=sFPPortSyncERxStatus, configurationInstancedTableIndex=configurationInstancedTableIndex, encryptionGroup=encryptionGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, linkModeOptimizationMismatch=linkModeOptimizationMismatch, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, sNTPSync=sNTPSync, incompatibleRegulatoryBands=incompatibleRegulatoryBands, wirelessLinkAvailability=wirelessLinkAvailability, pubStats=pubStats, hTTPSAccessEnabled=hTTPSAccessEnabled, mABState=mABState, licenseTDDSyncSupport=licenseTDDSyncSupport, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, syslogControl=syslogControl, syslogLocalWrappedTrap=syslogLocalWrappedTrap, blacklistRMEnabled=blacklistRMEnabled, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, sNTPServerTable=sNTPServerTable, sNTPServerRetries=sNTPServerRetries, vectorErrorLinked=vectorErrorLinked, lowestDataModulationMode=lowestDataModulationMode, dNSServerPortNumber=dNSServerPortNumber, authorizationControlTable=authorizationControlTable, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, aAAControl=aAAControl, licenseInstancedTableEntry=licenseInstancedTableEntry, tFTPServerPortNumber=tFTPServerPortNumber, licenseSecurityLevel=licenseSecurityLevel, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, wirelessTopology=wirelessTopology, syslogState=syslogState, regulatoryBandTrap=regulatoryBandTrap, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, telnetAccessEnabled=telnetAccessEnabled, oOBPriorityQueueMapping=oOBPriorityQueueMapping, sMTPServerPortNumber=sMTPServerPortNumber, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, sFPPortDisabledWarning=sFPPortDisabledWarning, linkLoss=linkLoss, ptpTrapPrefix=ptpTrapPrefix, remoteInternetAddress=remoteInternetAddress, syncETracking=syncETracking, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, configurationInstancedTable=configurationInstancedTable, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, rawReceivePowerLinked=rawReceivePowerLinked, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, authorizationControlTableIndex=authorizationControlTableIndex, apc=apc, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tDMChannelStatus=tDMChannelStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, aggregateDataRate=aggregateDataRate, sMTPServerInternetAddressType=sMTPServerInternetAddressType, ethernetInstancedTableEntry=ethernetInstancedTableEntry, sNMPTrapTableEntry=sNMPTrapTableEntry, userPassword=userPassword, sNTPPollInterval=sNTPPollInterval, authorizationControl=authorizationControl, secondarySoftwareVersion=secondarySoftwareVersion, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, phyControlInstancedTableIndex=phyControlInstancedTableIndex, authorizationMethod=authorizationMethod, blacklistRMMacAddress=blacklistRMMacAddress, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, linkName=linkName, dNSServerInternetAddressType=dNSServerInternetAddressType, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, configurationInstancedTableEntry=configurationInstancedTableEntry, portAllocationMismatchTrap=portAllocationMismatchTrap, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, tDMGroup=tDMGroup, auxPortConfigurationMismatch=auxPortConfigurationMismatch, deviceMACAddress=deviceMACAddress, transmitDataRate=transmitDataRate, extendedSpectrumScanning=extendedSpectrumScanning, sMTPEmailAlert=sMTPEmailAlert, cableDiagnosticsResultTable=cableDiagnosticsResultTable, dataBridgingStatusLinked=dataBridgingStatusLinked, receiveDataRateLinked=receiveDataRateLinked, snmpControlGroup=snmpControlGroup, alarmInstancedTableEntry=alarmInstancedTableEntry, erroredSeconds=erroredSeconds, mABTransmissionInterval=mABTransmissionInterval, l2CPPriorityTableNumber=l2CPPriorityTableNumber, licenseIPv6Support=licenseIPv6Support, phyStatus=phyStatus, dataPortPauseFrames=dataPortPauseFrames, receiveModulationModeLinked=receiveModulationModeLinked, iPDSCPPriorityTable=iPDSCPPriorityTable, incompatibleMasterAndSlave=incompatibleMasterAndSlave, longitude=longitude, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, licenseGroup=licenseGroup, mABProtocolVID=mABProtocolVID, l2CPPriorityTableIndex=l2CPPriorityTableIndex, supplementaryGroup=supplementaryGroup, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, antennaSelection=antennaSelection, apcGroup=apcGroup, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, remoteInternetAddressLinked=remoteInternetAddressLinked, ethernetInstancedTableNumber=ethernetInstancedTableNumber, tDMChannelStatusTrap=tDMChannelStatusTrap, tdmTableIndex=tdmTableIndex, licenseBandwidthCap=licenseBandwidthCap, bootVersion=bootVersion, dNSServerTableIndex=dNSServerTableIndex, cableDiagPair3Results=cableDiagPair3Results, portAllocationMismatch=portAllocationMismatch, tdmTableNumber=tdmTableNumber, supplementary=supplementary, nIDULanPortStatusTrap=nIDULanPortStatusTrap, mABProtocolVLANPriority=mABProtocolVLANPriority, capacityVariantMismatchTrap=capacityVariantMismatchTrap, sNTPServerTableEntry=sNTPServerTableEntry, mABHoldoffPeriod=mABHoldoffPeriod, userRole=userRole, timeZone=timeZone, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, ptp=ptp, unitIdentification=unitIdentification, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, range=range, hCMPMaximumLinkRange=hCMPMaximumLinkRange, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ethernet=ethernet, sFPErrorTrap=sFPErrorTrap, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, ptpGroups=ptpGroups, tDDSynchronizationMode=tDDSynchronizationMode, mainPSUPortAutoMdix=mainPSUPortAutoMdix, subbandLowestFrequency=subbandLowestFrequency, licenseCountry=licenseCountry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, sNTPServerPortNumber=sNTPServerPortNumber, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, groupID=groupID, alarmInstancedTableIndex=alarmInstancedTableIndex, l2CPPriorityTableEntry=l2CPPriorityTableEntry, ptpTraps=ptpTraps, cableDiagPair3Distance=cableDiagPair3Distance, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, PYSNMP_MODULE_ID=cambium, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, encryption=encryption, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, installStatusLinked=installStatusLinked, unavailableSeconds=unavailableSeconds, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, phyStatusGroup=phyStatusGroup, auxPortAcceptedQLRx=auxPortAcceptedQLRx, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, mgmtInstancedTableEntry=mgmtInstancedTableEntry, wirelessOutEthernetOctets=wirelessOutEthernetOctets, dNS=dNS, softwareVersion=softwareVersion, managementPortWirelessDownAlert=managementPortWirelessDownAlert, useVLANForMABProtocol=useVLANForMABProtocol, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, encryptionAlgorithm=encryptionAlgorithm, gatewayIPAddress=gatewayIPAddress, cableDiagPair2Distance=cableDiagPair2Distance, subnetMask=subnetMask, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, licenseIEEE1588Support=licenseIEEE1588Support, sFPPortAllocation=sFPPortAllocation, tDDSynchronizationAlarm=tDDSynchronizationAlarm, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, transparentClockVLAN=transparentClockVLAN, receivePower=receivePower, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, mABNominalModulationMode=mABNominalModulationMode, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, dNSGroup=dNSGroup, tDMChannelLineCode=tDMChannelLineCode, licenseVersion=licenseVersion)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sNTPPrimaryServer=sNTPPrimaryServer, linkSymmetry=linkSymmetry, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, signalStrengthRatioLinked=signalStrengthRatioLinked, cableDiagnostics=cableDiagnostics, sNTPServerTimeout=sNTPServerTimeout, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, nIDULanPortStatus=nIDULanPortStatus, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, targetRange=targetRange, sNMPPortNumber=sNMPPortNumber, regulatoryBand=regulatoryBand, transmitModulationMode=transmitModulationMode, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, licenseMaxLinkRange=licenseMaxLinkRange, portAllocationMismatchLinked=portAllocationMismatchLinked, dfs=dfs, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, accessMethod=accessMethod, ethernetGroup=ethernetGroup, searchState=searchState, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, whitelistRMMacAddress=whitelistRMMacAddress, cambium=cambium, dfsTableNumber=dfsTableNumber, tFTPServerInternetAddressType=tFTPServerInternetAddressType, transmitChannel=transmitChannel, maxLinkRangeExceeded=maxLinkRangeExceeded, bridgeGroup=bridgeGroup, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, cableDiagnosticsPorts=cableDiagnosticsPorts, unitOutOfCalibration=unitOutOfCalibration, sMTPEnabledMessages=sMTPEnabledMessages, licenseRegulatoryBandsList=licenseRegulatoryBandsList, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, sNTPServerInternetAddress=sNTPServerInternetAddress, tDDControl=tDDControl, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, byteErrorRatioLinked=byteErrorRatioLinked, userTableEntry=userTableEntry, antennaGain=antennaGain, sNMPv3Enable=sNMPv3Enable, cableDiagnosticsControl=cableDiagnosticsControl, licenseCapacity=licenseCapacity, userTableNumber=userTableNumber, unitName=unitName, dNSServerTable=dNSServerTable, receiveModulationModeDetail=receiveModulationModeDetail, configurationInstancedTableNumber=configurationInstancedTableNumber, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, eIRP=eIRP, licenseUnitSerialNumber=licenseUnitSerialNumber, ethernetPriorityTableNumber=ethernetPriorityTableNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, deviceMSN=deviceMSN, rangingMode=rangingMode)
