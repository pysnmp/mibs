...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNMPv3Enable=sNMPv3Enable, supplementary=supplementary, tFTPServerInternetAddress=tFTPServerInternetAddress, dNSServerTableEntry=dNSServerTableEntry, sNMPEnabledTraps=sNMPEnabledTraps, syslogClientTrap=syslogClientTrap, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, sNMPPortNumber=sNMPPortNumber, routerProtocolsGroup=routerProtocolsGroup, dNSGroup=dNSGroup, phyStatus=phyStatus, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, blacklistRMEnabled=blacklistRMEnabled, dNSServerPortNumber=dNSServerPortNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, mPLSTCPriorityTable=mPLSTCPriorityTable, licenseSecurityLevel=licenseSecurityLevel, syslogClient=syslogClient, sNTPSyncTrap=sNTPSyncTrap, resetGroup=resetGroup, userTableIndex=userTableIndex, licenseSyncESupport=licenseSyncESupport, sFPPortQLRx=sFPPortQLRx, alarmInstancedTableEntry=alarmInstancedTableEntry, syncEEquipmentClock=syncEEquipmentClock, syslogLocalWrappedTrap=syslogLocalWrappedTrap, maximumTransmitPower=maximumTransmitPower, dataBridgingStatus=dataBridgingStatus, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, tDMGroup=tDMGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, severelyErroredSeconds=severelyErroredSeconds, notificationsGroup=notificationsGroup, dNSServerInternetAddress=dNSServerInternetAddress, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, systemClock=systemClock, ethernetStatisticsDataSource=ethernetStatisticsDataSource, dNSPrimaryServer=dNSPrimaryServer, sNMPTrapTableNumber=sNMPTrapTableNumber, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, transmitModulationModeLinked=transmitModulationModeLinked, configuration=configuration, ethernetPriorityTableEntry=ethernetPriorityTableEntry, reset=reset, licenseRARSupport=licenseRARSupport, managementGroup=managementGroup, licenseSFPPortSupport=licenseSFPPortSupport, sntpGroup=sntpGroup, sntp=sntp, transparentClockVID=transparentClockVID, alarmsGroup=alarmsGroup, groupID=groupID, ethernetInstancedTableEntry=ethernetInstancedTableEntry, tDDControl=tDDControl, tdmTableIndex=tdmTableIndex, licenseInstancedTableNumber=licenseInstancedTableNumber, capacityVariantMismatchTrap=capacityVariantMismatchTrap, auxPortAllocation=auxPortAllocation, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, PYSNMP_MODULE_ID=cambium, encryptionGroup=encryptionGroup, licenseCountry=licenseCountry, tDDSynchronizationMode=tDDSynchronizationMode, mABState=mABState, wirelessLinkStatusLinked=wirelessLinkStatusLinked, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, txMABFrames=txMABFrames, managementPortWirelessDownAlert=managementPortWirelessDownAlert, tdmTable=tdmTable, installStatusLinked=installStatusLinked, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, mABHoldoffPeriod=mABHoldoffPeriod, mABProtocolVID=mABProtocolVID, licenseInstancedTableEntry=licenseInstancedTableEntry, rxColorCode=rxColorCode, cableDiagPair1Distance=cableDiagPair1Distance, sFPPortQLTx=sFPPortQLTx, telnetPortNumber=telnetPortNumber, authorizationControlTableIndex=authorizationControlTableIndex, alarmInstancedTableIndex=alarmInstancedTableIndex, sNMPTrapVersion=sNMPTrapVersion, ethernetInstancedTableNumber=ethernetInstancedTableNumber, receivePowerLinked=receivePowerLinked, linkLossLinked=linkLossLinked, transparentClockPort=transparentClockPort, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, softwareVersion=softwareVersion, sFPErrorTrap=sFPErrorTrap, bridgeGroup=bridgeGroup, dfsMeans=dfsMeans, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, remoteMACAddressLinked=remoteMACAddressLinked, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, receiveModulationModeDetail=receiveModulationModeDetail, whitelistRMMacAddress=whitelistRMMacAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, dNSResolver=dNSResolver, sFPPortAutoMdix=sFPPortAutoMdix, auxPortDisabledWarning=auxPortDisabledWarning, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapTable=sNMPTrapTable, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, wirelessLinkStatus=wirelessLinkStatus, alarms=alarms, licenseMaxLinkRange=licenseMaxLinkRange, licenseTDDSyncSupport=licenseTDDSyncSupport, snmpControlGroup=snmpControlGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ethernetPriorityTableIndex=ethernetPriorityTableIndex, hTTPSPortNumber=hTTPSPortNumber, mgmtInstancedTableIndex=mgmtInstancedTableIndex, auxPortSSMTx=auxPortSSMTx, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, altitude=altitude, phyInstancedStatusTable=phyInstancedStatusTable, pubInstancedStatsTable=pubInstancedStatsTable, managementNetworkAccessEnabled=managementNetworkAccessEnabled, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, deviceESN=deviceESN, frequencyVariant=frequencyVariant, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, sFPPortDisabledWarning=sFPPortDisabledWarning, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, dfsPeaks=dfsPeaks, capacityVariantMismatch=capacityVariantMismatch, ptp670=ptp670, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, ethernetGroup=ethernetGroup, ptp=ptp, dataBridgingStatusAlarm=dataBridgingStatusAlarm, sFPPortAutoNegotiation=sFPPortAutoNegotiation, signalStrengthRatio=signalStrengthRatio, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, bridge=bridge, tdmTableEntry=tdmTableEntry, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, auxPortAcceptedQLRx=auxPortAcceptedQLRx, telnetAccessEnabled=telnetAccessEnabled, cableDiagPair1Results=cableDiagPair1Results, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, rangeLinked=rangeLinked, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, antennaGain=antennaGain, configurationInstancedTable=configurationInstancedTable, licenseIssueNumber=licenseIssueNumber, vectorError=vectorError, portAllocationMismatchLinked=portAllocationMismatchLinked, mgmtInstancedTable=mgmtInstancedTable, ptpCompliance=ptpCompliance, tDM=tDM, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, userTableNumber=userTableNumber, licenseHCMPSupport=licenseHCMPSupport, licenseCapacity=licenseCapacity, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, cableDiagnosticsResultTable=cableDiagnosticsResultTable, hardwareVersion=hardwareVersion, cableDiagnostics=cableDiagnostics, sNMPTrapTableEntry=sNMPTrapTableEntry, pubStats=pubStats, ethernetInstancedTableIndex=ethernetInstancedTableIndex, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, hTTPPortNumber=hTTPPortNumber, erroredSeconds=erroredSeconds, aggregateDataRate=aggregateDataRate, userPassword=userPassword, portAllocationMismatch=portAllocationMismatch, targetMACAddress=targetMACAddress, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, receiveDataRate=receiveDataRate, snmpControl=snmpControl, ptmp=ptmp, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNTPServerTableIndex=sNTPServerTableIndex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, unitName=unitName, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, licenseRegulatoryBandsList=licenseRegulatoryBandsList, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, receiveModulationModeLinked=receiveModulationModeLinked, linkName=linkName, dataPortPauseFrames=dataPortPauseFrames, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, dfsGroup=dfsGroup, receivePower=receivePower, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, systemReset=systemReset, mainPSUPortQLRx=mainPSUPortQLRx, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, antennaSelection=antennaSelection, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, tDMChannelStatus=tDMChannelStatus, mainPSUPortAllocation=mainPSUPortAllocation, targetRange=targetRange, tDMChannelLineCode=tDMChannelLineCode, licenseEncryption=licenseEncryption, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, secondarySoftwareVersion=secondarySoftwareVersion, unavailableSeconds=unavailableSeconds, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, licenseVersion=licenseVersion, siteName=siteName, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, vectorErrorLinked=vectorErrorLinked, mABTransmissionInterval=mABTransmissionInterval, syslogState=syslogState, l2CPPriorityTableNumber=l2CPPriorityTableNumber, mABProtocolVLANPriority=mABProtocolVLANPriority, auxPortConfigurationMismatch=auxPortConfigurationMismatch, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, userRole=userRole, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dfsTableNumber=dfsTableNumber, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, txColorCode=txColorCode, rawReceivePowerLinked=rawReceivePowerLinked, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, installationMode=installationMode, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, cableDiagnosticsGroup=cableDiagnosticsGroup, transmitFreqMHz=transmitFreqMHz, useVLANForManagementInterfaces=useVLANForManagementInterfaces, phyControl=phyControl, mainPSUPortQLTx=mainPSUPortQLTx, sNTPServerInternetAddressType=sNTPServerInternetAddressType, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, regulatoryBand=regulatoryBand, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, hCMPLinkSymmetry=hCMPLinkSymmetry, lbtDetectedTrap=lbtDetectedTrap, sFPError=sFPError, vLANManagementVID=vLANManagementVID, tFTPClient=tFTPClient)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", dataBridgingAvailability=dataBridgingAvailability, subbandHighestFrequency=subbandHighestFrequency, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, authorizationControlTableNumber=authorizationControlTableNumber, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, range=range, authorizationControlGroup=authorizationControlGroup, apc=apc, configurationGroup=configurationGroup, nIDULanPortStatusTrap=nIDULanPortStatusTrap, routerProtocols=routerProtocols, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, remoteInternetAddressLinked=remoteInternetAddressLinked, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, sNTPPollInterval=sNTPPollInterval, sNTPServerTableEntry=sNTPServerTableEntry, mgmtInstancedTableNumber=mgmtInstancedTableNumber, remoteMACAddress=remoteMACAddress, versionsGroup=versionsGroup, daylightSaving=daylightSaving, cableDiagPair3Distance=cableDiagPair3Distance, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, linkLoss=linkLoss, linkSymmetry=linkSymmetry, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, receiveFreqKHz=receiveFreqKHz, auxPortStatusTrap=auxPortStatusTrap, smtp=smtp, searchStateLinked=searchStateLinked, remoteInternetAddress=remoteInternetAddress, transmitModulationMode=transmitModulationMode, tempPcb=tempPcb, mABMaintenanceLevel=mABMaintenanceLevel, packetsToInternalStack=packetsToInternalStack, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, userName=userName, syncETrackingState=syncETrackingState, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, transmitPower=transmitPower, tFTPServerPortNumber=tFTPServerPortNumber, deviceMSN=deviceMSN, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, phyControlInstancedTableIndex=phyControlInstancedTableIndex, tDDSynchronizationAlarm=tDDSynchronizationAlarm, gatewayIPAddress=gatewayIPAddress, syncESlavePort=syncESlavePort, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, wirelessOutEthernetOctets=wirelessOutEthernetOctets, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, licenseGasGroup=licenseGasGroup, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, maxLinkRangeExceeded=maxLinkRangeExceeded, mgmtInstancedTableEntry=mgmtInstancedTableEntry, dfsTableEntry=dfsTableEntry, licenseBandwidthCap=licenseBandwidthCap, useVLANForMABProtocol=useVLANForMABProtocol, phyControlInstancedTableEntry=phyControlInstancedTableEntry, portAllocationMismatchTrap=portAllocationMismatchTrap, mainPSUPortSSMTx=mainPSUPortSSMTx, phyStatusGroup=phyStatusGroup, management=management, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, mainPSUPortAutoMdix=mainPSUPortAutoMdix, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, wirelessOutOctets=wirelessOutOctets, ethernetStatisticsTable=ethernetStatisticsTable, versions=versions, remoteUnitName=remoteUnitName, subbandLowestFrequency=subbandLowestFrequency, enabledDiagnosticAlarms=enabledDiagnosticAlarms, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, userEnabled=userEnabled, deviceMACAddress=deviceMACAddress, ptpTraps=ptpTraps, tDMInterfaceControl=tDMInterfaceControl, ptpGroups=ptpGroups, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, encryption=encryption, licenseInstancedTableIndex=licenseInstancedTableIndex, sNTPPrimaryServer=sNTPPrimaryServer, licenseOOBManagementSupport=licenseOOBManagementSupport, receiveFreqMHz=receiveFreqMHz, cableDiagnosticsWarning=cableDiagnosticsWarning, licenseInstancedTable=licenseInstancedTable, maximumNumberOfSlaves=maximumNumberOfSlaves, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, productName=productName, iPv6Address=iPv6Address, configurationInstancedTableIndex=configurationInstancedTableIndex, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, licenseUnitSerialNumber=licenseUnitSerialNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, userTable=userTable, sNTPSync=sNTPSync, vLANManagementPriority=vLANManagementPriority, tDMInterfaceStatus=tDMInterfaceStatus, lowestDataModulationMode=lowestDataModulationMode, sFPPortAllocation=sFPPortAllocation, smtpGroup=smtpGroup, incompatibleRegulatoryBands=incompatibleRegulatoryBands, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, iPVersion=iPVersion, dataBridgingStatusLinked=dataBridgingStatusLinked, linkModeOptimization=linkModeOptimization, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, ethernetPriorityTable=ethernetPriorityTable, cableDiagPair3Results=cableDiagPair3Results, wirelessOutAllOctets=wirelessOutAllOctets, cableLoss=cableLoss, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, channelChangeTrap=channelChangeTrap, receiveModulationMode=receiveModulationMode, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, latitude=latitude, cableDiagnosticsPorts=cableDiagnosticsPorts, sNTPServerTable=sNTPServerTable, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNTPServerRetries=sNTPServerRetries, channelBandwidth=channelBandwidth, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sFPPortStatusTrap=sFPPortStatusTrap, iPv4Address=iPv4Address, sNMPTrapTableIndex=sNMPTrapTableIndex, hCMPMaximumLinkRange=hCMPMaximumLinkRange, licenseTLSRekey=licenseTLSRekey, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, regulatoryBandTrap=regulatoryBandTrap, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, aggregateDataRateLinked=aggregateDataRateLinked, auxPortQLRx=auxPortQLRx, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, userTableEntry=userTableEntry, sNMPTrapInternetAddress=sNMPTrapInternetAddress, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, transmitDataRate=transmitDataRate, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, configurationInstancedTableNumber=configurationInstancedTableNumber, authorizationControl=authorizationControl, timeZone=timeZone, remoteUnitNameLinked=remoteUnitNameLinked, license=license, unitOutOfCalibration=unitOutOfCalibration, receiveDataRateLinked=receiveDataRateLinked, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, licenseGroupAccess=licenseGroupAccess, transmitDataRateLinked=transmitDataRateLinked, transmitChannel=transmitChannel, longitude=longitude, authorizationControlTableEntry=authorizationControlTableEntry, lowestTDMModulationMode=lowestTDMModulationMode, authorizationMethod=authorizationMethod, authorizationControlTable=authorizationControlTable, pubStatsGroup=pubStatsGroup, licenseIEEE1588Support=licenseIEEE1588Support, l2CPPriorityTable=l2CPPriorityTable, sNTPServerTableNumber=sNTPServerTableNumber, qOSPriorityScheme=qOSPriorityScheme, dSCPManagementPriority=dSCPManagementPriority, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, aAAControlGroup=aAAControlGroup, nIDULanPortAutoMdix=nIDULanPortAutoMdix, syslogStateTrap=syslogStateTrap, installArmStateTrap=installArmStateTrap, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, rawReceivePower=rawReceivePower, cableDiagPair2Results=cableDiagPair2Results, transparentClock=transparentClock, unitIdentification=unitIdentification, sFPPortSyncERxStatus=sFPPortSyncERxStatus, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, productVariant=productVariant, eIRP=eIRP, subnetMask=subnetMask, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, transparentClockVLAN=transparentClockVLAN, ethernetInstancedTable=ethernetInstancedTable, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, cambium=cambium, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, receiveChannel=receiveChannel, masterSlaveMode=masterSlaveMode, installStatus=installStatus, mainPSUPortStatus=mainPSUPortStatus, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, auxPortStatus=auxPortStatus, byteErrorRatio=byteErrorRatio, aAAControl=aAAControl, configurationInstancedTableEntry=configurationInstancedTableEntry, sFPPortStatus=sFPPortStatus, secureModeAlarmTrap=secureModeAlarmTrap, installArmState=installArmState, bootVersion=bootVersion, whitelistRMEnabled=whitelistRMEnabled, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, accessMethod=accessMethod, dfsTable=dfsTable, transmitFreqKHz=transmitFreqKHz, dNS=dNS, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, sNTPServerInternetAddress=sNTPServerInternetAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, sNTPLastSync=sNTPLastSync, alarmInstancedTable=alarmInstancedTable, sNMPCommunityString=sNMPCommunityString, syslogControlGroup=syslogControlGroup, syslogControl=syslogControl, sMTPServerPortNumber=sMTPServerPortNumber, phyControlInstancedTable=phyControlInstancedTable, sNMPTrapPortNumber=sNMPTrapPortNumber, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, licenseIPv6Support=licenseIPv6Support, iPv6GatewayAddress=iPv6GatewayAddress, transmitterChannels=transmitterChannels, enableTransmission=enableTransmission, capacityVariantMismatchLinked=capacityVariantMismatchLinked, cableDiagPair2Distance=cableDiagPair2Distance, secureModeAlarm=secureModeAlarm, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, signalStrengthRatioLinked=signalStrengthRatioLinked, blacklistRMMacAddress=blacklistRMMacAddress, wirelessLinkAvailability=wirelessLinkAvailability, cableDiagPair4Results=cableDiagPair4Results, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, sNTPServerTimeout=sNTPServerTimeout, l2CPPriorityTableEntry=l2CPPriorityTableEntry, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, linkModeOptimizationMismatch=linkModeOptimizationMismatch, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, encryptionAlgorithm=encryptionAlgorithm, tDMChannelLoopback=tDMChannelLoopback, dfs=dfs, apcGroup=apcGroup, mABNominalModulationMode=mABNominalModulationMode)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, oOBPriorityQueueMapping=oOBPriorityQueueMapping, rangingMode=rangingMode, unitIdentificationGroup=unitIdentificationGroup, ptpTrapPrefix=ptpTrapPrefix, phyControlInstancedTableNumber=phyControlInstancedTableNumber, sNTPState=sNTPState, hTTPSAccessEnabled=hTTPSAccessEnabled, remoteInternetAddressType=remoteInternetAddressType, syncETracking=syncETracking, alarmInstancedTableNumber=alarmInstancedTableNumber, installStatusTrap=installStatusTrap, transmitPowerLinked=transmitPowerLinked, dNSServerTableIndex=dNSServerTableIndex, searchState=searchState, licenseGroup=licenseGroup, extendedSpectrumScanning=extendedSpectrumScanning, cableDiagPair4Distance=cableDiagPair4Distance, sNTPServerPortNumber=sNTPServerPortNumber, hTTPAccessEnabled=hTTPAccessEnabled, sNTPServerStatus=sNTPServerStatus, ethernet=ethernet, tDMChannelStatusTrap=tDMChannelStatusTrap, dfsTableIndex=dfsTableIndex, auxPortQLTx=auxPortQLTx, tDMChannelCableLength=tDMChannelCableLength, dNSServerTable=dNSServerTable, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, auxPortSyncERxStatus=auxPortSyncERxStatus, ethernetPriorityTableNumber=ethernetPriorityTableNumber, licenseTrialPeriod=licenseTrialPeriod, mainPSUPortStatusTrap=mainPSUPortStatusTrap, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, dNSServerInternetAddressType=dNSServerInternetAddressType, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, dNSServerTableNumber=dNSServerTableNumber, wirelessTopology=wirelessTopology, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, localPacketFiltering=localPacketFiltering, byteErrorRatioLinked=byteErrorRatioLinked, nIDULanPortStatus=nIDULanPortStatus, cableDiagnosticsControl=cableDiagnosticsControl, tDMEnabledChannels=tDMEnabledChannels, sMTPServerInternetAddress=sMTPServerInternetAddress, tDDControlGroup=tDDControlGroup, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, tdmTableNumber=tdmTableNumber, tDMConfigurationMismatch=tDMConfigurationMismatch, packetsFromInternalStack=packetsFromInternalStack, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, supplementaryGroup=supplementaryGroup, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, mABNominalTransmitCapacity=mABNominalTransmitCapacity, sFPPortSSMTx=sFPPortSSMTx, phyControlGroup=phyControlGroup, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, iPv6PrefixLength=iPv6PrefixLength, sMTPEnabledMessages=sMTPEnabledMessages, iPDSCPPriorityTable=iPDSCPPriorityTable, tDDSynchronizationStatus=tDDSynchronizationStatus)
