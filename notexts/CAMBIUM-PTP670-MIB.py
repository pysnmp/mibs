...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, hardwareVersion=hardwareVersion, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, managementNetworkAccessEnabled=managementNetworkAccessEnabled, licenseMaxLinkRange=licenseMaxLinkRange, ptpGroups=ptpGroups, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, licenseCapacity=licenseCapacity, tFTPServerPortNumber=tFTPServerPortNumber, hCMPLinkSymmetry=hCMPLinkSymmetry, whitelistRMEnabled=whitelistRMEnabled, sNMPTrapInternetAddress=sNMPTrapInternetAddress, tFTPServerInternetAddress=tFTPServerInternetAddress, wirelessOutEthernetOctets=wirelessOutEthernetOctets, sFPErrorTrap=sFPErrorTrap, telnetAccessEnabled=telnetAccessEnabled, receiveModulationModeDetail=receiveModulationModeDetail, mainPSUPortStatus=mainPSUPortStatus, wirelessOutAllOctets=wirelessOutAllOctets, subbandLowestFrequency=subbandLowestFrequency, licenseBandwidthCap=licenseBandwidthCap, rawReceivePower=rawReceivePower, mgmtInstancedTableEntry=mgmtInstancedTableEntry, alarmInstancedTableIndex=alarmInstancedTableIndex, sNMPTrapVersion=sNMPTrapVersion, rawReceivePowerLinked=rawReceivePowerLinked, userRole=userRole, tdmTableEntry=tdmTableEntry, vectorError=vectorError, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, sNTPServerTableNumber=sNTPServerTableNumber, userTableIndex=userTableIndex, licenseRARSupport=licenseRARSupport, mABMaintenanceLevel=mABMaintenanceLevel, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, licenseTrialPeriod=licenseTrialPeriod, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, sNTPState=sNTPState, licenseRegulatoryBandsList=licenseRegulatoryBandsList, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, mPLSTCPriorityTable=mPLSTCPriorityTable, auxPortAcceptedQLRx=auxPortAcceptedQLRx, ptp=ptp, configuration=configuration, PYSNMP_MODULE_ID=cambium, ethernetPriorityTableIndex=ethernetPriorityTableIndex, groupID=groupID, installArmStateTrap=installArmStateTrap, dNSServerInternetAddress=dNSServerInternetAddress, sNTPServerStatus=sNTPServerStatus, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, tDMChannelCableLength=tDMChannelCableLength, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, licenseHCMPSupport=licenseHCMPSupport, licenseInstancedTableEntry=licenseInstancedTableEntry, alarmInstancedTableNumber=alarmInstancedTableNumber, remoteUnitName=remoteUnitName, accessMethod=accessMethod, syslogLocalWrappedTrap=syslogLocalWrappedTrap, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, deviceESN=deviceESN, dataBridgingStatus=dataBridgingStatus, linkLossLinked=linkLossLinked, configurationInstancedTable=configurationInstancedTable, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, dfsTableNumber=dfsTableNumber, mainPSUPortStatusTrap=mainPSUPortStatusTrap, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, cableDiagPair2Results=cableDiagPair2Results, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, encryptionAlgorithm=encryptionAlgorithm, daylightSaving=daylightSaving, transmitterChannels=transmitterChannels, masterSlaveMode=masterSlaveMode, unitName=unitName, cableDiagnosticsResultTable=cableDiagnosticsResultTable, authorizationControlTable=authorizationControlTable, snmpControlGroup=snmpControlGroup, managementPortWirelessDownAlert=managementPortWirelessDownAlert, deviceMACAddress=deviceMACAddress, userEnabled=userEnabled, alarms=alarms, sFPPortSSMTx=sFPPortSSMTx, tDMChannelLineCode=tDMChannelLineCode, softwareVersion=softwareVersion, tDDSynchronizationMode=tDDSynchronizationMode, vectorErrorLinked=vectorErrorLinked, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, vLANManagementPriority=vLANManagementPriority, dNSGroup=dNSGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, licenseOOBManagementSupport=licenseOOBManagementSupport, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, regulatoryBand=regulatoryBand, sFPPortAutoMdix=sFPPortAutoMdix, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, tdmTableIndex=tdmTableIndex, bootVersion=bootVersion, mABTransmissionInterval=mABTransmissionInterval, sNMPTrapTableEntry=sNMPTrapTableEntry, wirelessOutOctets=wirelessOutOctets, altitude=altitude, linkName=linkName, transmitFreqMHz=transmitFreqMHz, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, sMTPServerInternetAddress=sMTPServerInternetAddress, supplementary=supplementary, sntp=sntp, dfsTableIndex=dfsTableIndex, syncEEquipmentClock=syncEEquipmentClock, encryptionGroup=encryptionGroup, licenseInstancedTableIndex=licenseInstancedTableIndex, sNMPCommunityString=sNMPCommunityString, management=management, snmpControl=snmpControl, l2CPPriorityTableNumber=l2CPPriorityTableNumber, syslogClient=syslogClient, packetsFromInternalStack=packetsFromInternalStack, dNSServerInternetAddressType=dNSServerInternetAddressType, dataBridgingStatusAlarm=dataBridgingStatusAlarm, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, cableDiagPair2Distance=cableDiagPair2Distance, latitude=latitude, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, cableDiagPair3Distance=cableDiagPair3Distance, deviceMSN=deviceMSN, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, remoteInternetAddress=remoteInternetAddress, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, sMTPEmailAlert=sMTPEmailAlert, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, remoteMACAddress=remoteMACAddress, dNSServerPortNumber=dNSServerPortNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, licenseGasGroup=licenseGasGroup, mABProtocolVLANPriority=mABProtocolVLANPriority, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, signalStrengthRatio=signalStrengthRatio, transparentClock=transparentClock, wirelessLinkStatusLinked=wirelessLinkStatusLinked, routerProtocolsGroup=routerProtocolsGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, aggregateDataRate=aggregateDataRate, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, antennaSelection=antennaSelection, syslogStateTrap=syslogStateTrap, rxColorCode=rxColorCode, auxPortStatus=auxPortStatus, sMTPEnabledMessages=sMTPEnabledMessages, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, phyControlInstancedTableNumber=phyControlInstancedTableNumber, tDMGroup=tDMGroup, capacityVariantMismatchLinked=capacityVariantMismatchLinked, authorizationControlTableEntry=authorizationControlTableEntry, maximumTransmitPower=maximumTransmitPower, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, portAllocationMismatchLinked=portAllocationMismatchLinked, alarmInstancedTableEntry=alarmInstancedTableEntry, remoteMACAddressLinked=remoteMACAddressLinked, frequencyVariant=frequencyVariant, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, sNMPEnabledTraps=sNMPEnabledTraps, userPassword=userPassword, siteName=siteName, sFPPortStatusTrap=sFPPortStatusTrap, alarmInstancedTable=alarmInstancedTable, packetsToInternalStack=packetsToInternalStack, authorizationControlGroup=authorizationControlGroup, receiveModulationMode=receiveModulationMode, sNTPServerTableIndex=sNTPServerTableIndex, apc=apc, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, licenseGroupAccess=licenseGroupAccess, installationMode=installationMode, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, installStatus=installStatus, dNSServerTable=dNSServerTable, subbandHighestFrequency=subbandHighestFrequency, licenseIEEE1588Support=licenseIEEE1588Support, auxPortAllocation=auxPortAllocation, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, lowestTDMModulationMode=lowestTDMModulationMode, unitIdentificationGroup=unitIdentificationGroup, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, l2CPPriorityTable=l2CPPriorityTable, licenseSyncESupport=licenseSyncESupport, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, sMTPSourceEmailAddress=sMTPSourceEmailAddress, phyStatus=phyStatus, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, licenseGroup=licenseGroup, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, license=license, routerProtocols=routerProtocols, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, phyControlGroup=phyControlGroup, licenseTLSRekey=licenseTLSRekey, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, licenseInstancedTable=licenseInstancedTable, receiveFreqMHz=receiveFreqMHz, sNTPServerRetries=sNTPServerRetries, userTable=userTable, ptpTraps=ptpTraps, signalStrengthRatioLinked=signalStrengthRatioLinked, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, timeZone=timeZone, antennaGain=antennaGain, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, rangeLinked=rangeLinked, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, configurationGroup=configurationGroup, bridge=bridge, sMTPServerPortNumber=sMTPServerPortNumber, range=range, sNTPLastSync=sNTPLastSync, auxPortQLTx=auxPortQLTx, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, sNTPServerTable=sNTPServerTable, lbtDetectedTrap=lbtDetectedTrap, sFPPortAllocation=sFPPortAllocation, regulatoryBandTrap=regulatoryBandTrap, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, mainPSUPortAllocation=mainPSUPortAllocation, pubStats=pubStats, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, searchState=searchState, gatewayIPAddress=gatewayIPAddress, licenseEncryption=licenseEncryption, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, licenseCountry=licenseCountry, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, transparentClockPort=transparentClockPort, tDM=tDM, txMABFrames=txMABFrames, sNTPPrimaryServer=sNTPPrimaryServer, linkModeOptimization=linkModeOptimization)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, configurationInstancedTableIndex=configurationInstancedTableIndex, transmitChannel=transmitChannel, searchStateLinked=searchStateLinked, tempPcb=tempPcb, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, syncESlavePort=syncESlavePort, phyStatusGroup=phyStatusGroup, transmitPower=transmitPower, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapTable=sNMPTrapTable, dNSPrimaryServer=dNSPrimaryServer, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, ethernetPriorityTable=ethernetPriorityTable, unitIdentification=unitIdentification, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, managementGroup=managementGroup, syslogClientTrap=syslogClientTrap, sFPError=sFPError, vLANManagementVID=vLANManagementVID, unavailableSeconds=unavailableSeconds, sNTPServerTableEntry=sNTPServerTableEntry, dataBridgingAvailability=dataBridgingAvailability, transmitModulationModeLinked=transmitModulationModeLinked, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, cableDiagnosticsPorts=cableDiagnosticsPorts, nIDULanPortStatusTrap=nIDULanPortStatusTrap, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, iPv4Address=iPv4Address, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, systemClock=systemClock, ptmp=ptmp, telnetPortNumber=telnetPortNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, licenseSecurityLevel=licenseSecurityLevel, blacklistRMEnabled=blacklistRMEnabled, unitOutOfCalibration=unitOutOfCalibration, dfs=dfs, wirelessTopology=wirelessTopology, receiveFreqKHz=receiveFreqKHz, useVLANForMABProtocol=useVLANForMABProtocol, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, syncETrackingState=syncETrackingState, cableDiagPair1Results=cableDiagPair1Results, ptpCompliance=ptpCompliance, reset=reset, dfsMeans=dfsMeans, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, smtpGroup=smtpGroup, ethernetInstancedTable=ethernetInstancedTable, secureModeAlarm=secureModeAlarm, longitude=longitude, userTableEntry=userTableEntry, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, maximumNumberOfSlaves=maximumNumberOfSlaves, cableDiagPair4Distance=cableDiagPair4Distance, sNTPSyncTrap=sNTPSyncTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPPortNumber=sNMPPortNumber, receiveChannel=receiveChannel, receiveModulationModeLinked=receiveModulationModeLinked, receivePower=receivePower, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, wirelessLinkAvailability=wirelessLinkAvailability, phyControlInstancedTable=phyControlInstancedTable, bridgeGroup=bridgeGroup, sNTPServerPortNumber=sNTPServerPortNumber, transparentClockVID=transparentClockVID, tDMChannelStatus=tDMChannelStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, byteErrorRatioLinked=byteErrorRatioLinked, configurationInstancedTableNumber=configurationInstancedTableNumber, mABNominalTransmitCapacity=mABNominalTransmitCapacity, dfsGroup=dfsGroup, tDMInterfaceControl=tDMInterfaceControl, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, resetGroup=resetGroup, channelChangeTrap=channelChangeTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tDDControlGroup=tDDControlGroup, receiveDataRateLinked=receiveDataRateLinked, useVLANForManagementInterfaces=useVLANForManagementInterfaces, authorizationControlTableIndex=authorizationControlTableIndex, mainPSUPortQLTx=mainPSUPortQLTx, aAAControl=aAAControl, auxPortSyncERxStatus=auxPortSyncERxStatus, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, incompatibleRegulatoryBands=incompatibleRegulatoryBands, alarmsGroup=alarmsGroup, hTTPSPortNumber=hTTPSPortNumber, linkLoss=linkLoss, ptpTrapPrefix=ptpTrapPrefix, linkModeOptimizationMismatch=linkModeOptimizationMismatch, l2CPPriorityTableIndex=l2CPPriorityTableIndex, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, dNSServerTableIndex=dNSServerTableIndex, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, iPv6PrefixLength=iPv6PrefixLength, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, phyControl=phyControl, iPVersion=iPVersion, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sFPPortSyncERxStatus=sFPPortSyncERxStatus, lowestDataModulationMode=lowestDataModulationMode, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, cableDiagnosticsControl=cableDiagnosticsControl, remoteInternetAddressType=remoteInternetAddressType, authorizationControl=authorizationControl, auxPortConfigurationMismatch=auxPortConfigurationMismatch, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, authorizationMethod=authorizationMethod, auxPortStatusTrap=auxPortStatusTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, blacklistRMMacAddress=blacklistRMMacAddress, licenseIssueNumber=licenseIssueNumber, tDMEnabledChannels=tDMEnabledChannels, syslogState=syslogState, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, capacityVariantMismatchTrap=capacityVariantMismatchTrap, hTTPAccessEnabled=hTTPAccessEnabled, cableDiagPair4Results=cableDiagPair4Results, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, mgmtInstancedTableIndex=mgmtInstancedTableIndex, versions=versions, smtp=smtp, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dNS=dNS, txColorCode=txColorCode, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, secondarySoftwareVersion=secondarySoftwareVersion, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, capacityVariantMismatch=capacityVariantMismatch, targetRange=targetRange, receivePowerLinked=receivePowerLinked, sFPPortDisabledWarning=sFPPortDisabledWarning, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, mainPSUPortQLRx=mainPSUPortQLRx, enableTransmission=enableTransmission, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ethernetInstancedTableEntry=ethernetInstancedTableEntry, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, maxLinkRangeExceeded=maxLinkRangeExceeded, iPv6Address=iPv6Address, ethernetInstancedTableNumber=ethernetInstancedTableNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, licenseVersion=licenseVersion, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, licenseTDDSyncSupport=licenseTDDSyncSupport, nIDULanPortStatus=nIDULanPortStatus, dNSServerTableEntry=dNSServerTableEntry, ethernetStatisticsTable=ethernetStatisticsTable, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, cableDiagPair3Results=cableDiagPair3Results, remoteMaximumTransmitPower=remoteMaximumTransmitPower, l2CPPriorityTableEntry=l2CPPriorityTableEntry, dfsPeaks=dfsPeaks, licenseIPv6Support=licenseIPv6Support, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, hTTPSAccessEnabled=hTTPSAccessEnabled, transmitModulationMode=transmitModulationMode, oOBPriorityQueueMapping=oOBPriorityQueueMapping, rangingMode=rangingMode, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, wirelessLinkStatus=wirelessLinkStatus, licenseUnitSerialNumber=licenseUnitSerialNumber, pubStatsGroup=pubStatsGroup, mABNominalModulationMode=mABNominalModulationMode, licenseInstancedTableNumber=licenseInstancedTableNumber, cableLoss=cableLoss, receiveDataRate=receiveDataRate, dNSServerTableNumber=dNSServerTableNumber, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, whitelistRMMacAddress=whitelistRMMacAddress, severelyErroredSeconds=severelyErroredSeconds, installArmState=installArmState, sNTPServerInternetAddress=sNTPServerInternetAddress, tFTPClient=tFTPClient, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, syslogControl=syslogControl, productVariant=productVariant, iPv6GatewayAddress=iPv6GatewayAddress, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, mainPSUPortSSMTx=mainPSUPortSSMTx, mABState=mABState, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, mABHoldoffPeriod=mABHoldoffPeriod, byteErrorRatio=byteErrorRatio, sNTPServerTimeout=sNTPServerTimeout, ethernetInstancedTableIndex=ethernetInstancedTableIndex, ethernetPriorityTableEntry=ethernetPriorityTableEntry, mainPSUPortAutoMdix=mainPSUPortAutoMdix, cambium=cambium, dfsTableEntry=dfsTableEntry, userName=userName, transmitFreqKHz=transmitFreqKHz, tDMInterfaceStatus=tDMInterfaceStatus, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, phyControlInstancedTableIndex=phyControlInstancedTableIndex, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, extendedSpectrumScanning=extendedSpectrumScanning, mABProtocolVID=mABProtocolVID, sFPPortAutoNegotiation=sFPPortAutoNegotiation, mgmtInstancedTableNumber=mgmtInstancedTableNumber, hTTPPortNumber=hTTPPortNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, aAAControlGroup=aAAControlGroup, auxPortDisabledWarning=auxPortDisabledWarning, userTableNumber=userTableNumber, cableDiagnosticsWarning=cableDiagnosticsWarning, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, pubInstancedStatsTable=pubInstancedStatsTable, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, ethernetStatisticsDataSource=ethernetStatisticsDataSource, licenseSFPPortSupport=licenseSFPPortSupport, cableDiagnosticsGroup=cableDiagnosticsGroup, ethernet=ethernet, cableDiagPair1Distance=cableDiagPair1Distance, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, cableDiagnostics=cableDiagnostics, productName=productName, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, portAllocationMismatch=portAllocationMismatch, versionsGroup=versionsGroup, channelBandwidth=channelBandwidth, sFPPortStatus=sFPPortStatus, authorizationControlTableNumber=authorizationControlTableNumber, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, tDMChannelLoopback=tDMChannelLoopback, sntpGroup=sntpGroup, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, phyInstancedStatusTable=phyInstancedStatusTable, supplementaryGroup=supplementaryGroup, syncETracking=syncETracking, transmitPowerLinked=transmitPowerLinked, transmitDataRateLinked=transmitDataRateLinked, installStatusLinked=installStatusLinked, sNTPPollInterval=sNTPPollInterval)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", syslogControlGroup=syslogControlGroup, iPDSCPPriorityTable=iPDSCPPriorityTable, dSCPManagementPriority=dSCPManagementPriority, sNTPSync=sNTPSync, dataPortPauseFrames=dataPortPauseFrames, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, tDDControl=tDDControl, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, dNSResolver=dNSResolver, dataBridgingStatusLinked=dataBridgingStatusLinked, aggregateDataRateLinked=aggregateDataRateLinked, targetMACAddress=targetMACAddress, tdmTable=tdmTable, sFPPortQLRx=sFPPortQLRx, sNMPv3Enable=sNMPv3Enable, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, subnetMask=subnetMask, qOSPriorityScheme=qOSPriorityScheme, mgmtInstancedTable=mgmtInstancedTable, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, tdmTableNumber=tdmTableNumber, phyControlInstancedTableEntry=phyControlInstancedTableEntry, tDMConfigurationMismatch=tDMConfigurationMismatch, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ethernetGroup=ethernetGroup, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, notificationsGroup=notificationsGroup, nIDULanPortAutoMdix=nIDULanPortAutoMdix, linkSymmetry=linkSymmetry, auxPortQLRx=auxPortQLRx, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, transmitDataRate=transmitDataRate, localPacketFiltering=localPacketFiltering, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, remoteInternetAddressLinked=remoteInternetAddressLinked, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, hCMPMaximumLinkRange=hCMPMaximumLinkRange, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, remoteUnitNameLinked=remoteUnitNameLinked, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, erroredSeconds=erroredSeconds, portAllocationMismatchTrap=portAllocationMismatchTrap, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, apcGroup=apcGroup, tDMChannelStatusTrap=tDMChannelStatusTrap, ptp670=ptp670, transparentClockVLAN=transparentClockVLAN, encryption=encryption, configurationInstancedTableEntry=configurationInstancedTableEntry, sFPPortQLTx=sFPPortQLTx, auxPortSSMTx=auxPortSSMTx, eIRP=eIRP, installStatusTrap=installStatusTrap, dfsTable=dfsTable, secureModeAlarmTrap=secureModeAlarmTrap, systemReset=systemReset, sNTPServerInternetAddressType=sNTPServerInternetAddressType, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert)
