...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, ethernetStatisticsTable=ethernetStatisticsTable, cableDiagPair2Results=cableDiagPair2Results, mainPSUPortAllocation=mainPSUPortAllocation, tDMInterfaceStatus=tDMInterfaceStatus, hCMPMaximumLinkRange=hCMPMaximumLinkRange, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, packetsToInternalStack=packetsToInternalStack, licenseGroupAccess=licenseGroupAccess, linkSymmetry=linkSymmetry, hardwareVersion=hardwareVersion, sMTPEnabledMessages=sMTPEnabledMessages, syncESlavePort=syncESlavePort, targetRange=targetRange, ethernetPriorityTableIndex=ethernetPriorityTableIndex, tDDSynchronizationMode=tDDSynchronizationMode, dfsTableIndex=dfsTableIndex, unitIdentification=unitIdentification, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, auxPortStatusTrap=auxPortStatusTrap, bridgeGroup=bridgeGroup, signalStrengthRatio=signalStrengthRatio, syncETracking=syncETracking, sFPPortStatus=sFPPortStatus, remoteInternetAddress=remoteInternetAddress, mABHoldoffPeriod=mABHoldoffPeriod, dNSServerInternetAddress=dNSServerInternetAddress, nIDULanPortStatus=nIDULanPortStatus, aAAControl=aAAControl, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, phyStatus=phyStatus, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, rangingMode=rangingMode, notificationsGroup=notificationsGroup, tDMChannelLoopback=tDMChannelLoopback, licenseBandwidthCap=licenseBandwidthCap, channelBandwidth=channelBandwidth, lbtDetectedTrap=lbtDetectedTrap, tDMChannelCableLength=tDMChannelCableLength, tFTPClient=tFTPClient, sMTPServerInternetAddress=sMTPServerInternetAddress, versionsGroup=versionsGroup, licenseSyncESupport=licenseSyncESupport, supplementaryGroup=supplementaryGroup, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, transparentClockPort=transparentClockPort, enabledDiagnosticAlarms=enabledDiagnosticAlarms, userTable=userTable, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, versions=versions, subnetMask=subnetMask, licenseMaxLinkRange=licenseMaxLinkRange, phyInstancedStatusTable=phyInstancedStatusTable, mABProtocolVID=mABProtocolVID, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, alarmInstancedTableEntry=alarmInstancedTableEntry, tDM=tDM, tFTPServerPortNumber=tFTPServerPortNumber, txColorCode=txColorCode, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, dNSServerInternetAddressType=dNSServerInternetAddressType, regulatoryBandTrap=regulatoryBandTrap, oOBPriorityQueueMapping=oOBPriorityQueueMapping, licenseRegulatoryBandsList=licenseRegulatoryBandsList, range=range, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, iPv6Address=iPv6Address, syncETrackingState=syncETrackingState, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, auxPortDisabledWarning=auxPortDisabledWarning, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, erroredSeconds=erroredSeconds, userName=userName, dfsGroup=dfsGroup, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, sNTPState=sNTPState, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, tdmTable=tdmTable, cableDiagnosticsControl=cableDiagnosticsControl, linkLoss=linkLoss, transmitChannel=transmitChannel, transmitModulationMode=transmitModulationMode, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, dataPortWirelessDownAlert=dataPortWirelessDownAlert, phyControlInstancedTableNumber=phyControlInstancedTableNumber, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, unitIdentificationGroup=unitIdentificationGroup, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, sFPPortAllocation=sFPPortAllocation, wirelessLinkAvailability=wirelessLinkAvailability, licenseUnitSerialNumber=licenseUnitSerialNumber, cableDiagnosticsGroup=cableDiagnosticsGroup, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, sFPPortAutoNegotiation=sFPPortAutoNegotiation, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, mainPSUPortStatus=mainPSUPortStatus, wirelessLinkStatusLinked=wirelessLinkStatusLinked, linkModeOptimizationMismatch=linkModeOptimizationMismatch, gatewayIPAddress=gatewayIPAddress, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, configurationInstancedTableEntry=configurationInstancedTableEntry, deviceESN=deviceESN, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, syslogStateTrap=syslogStateTrap, cambium=cambium, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, auxPortAllocation=auxPortAllocation, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, iPv6PrefixLength=iPv6PrefixLength, userEnabled=userEnabled, wirelessTopology=wirelessTopology, sMTPServerPortNumber=sMTPServerPortNumber, authorizationControl=authorizationControl, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, userTableNumber=userTableNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, sFPPortAutoMdix=sFPPortAutoMdix, smtpGroup=smtpGroup, cableDiagnostics=cableDiagnostics, authorizationControlTableNumber=authorizationControlTableNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, capacityVariantMismatchLinked=capacityVariantMismatchLinked, phyControlInstancedTable=phyControlInstancedTable, linkName=linkName, mABState=mABState, longitude=longitude, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, licenseHCMPSupport=licenseHCMPSupport, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPCommunityString=sNMPCommunityString, sNMPTrapTableEntry=sNMPTrapTableEntry, licenseIEEE1588Support=licenseIEEE1588Support, licenseInstancedTable=licenseInstancedTable, licenseIssueNumber=licenseIssueNumber, secondarySoftwareVersion=secondarySoftwareVersion, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, blacklistRMEnabled=blacklistRMEnabled, tempPcb=tempPcb, tDMInterfaceControl=tDMInterfaceControl, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapVersion=sNMPTrapVersion, sFPErrorTrap=sFPErrorTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNTPSyncTrap=sNTPSyncTrap, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, regulatoryBand=regulatoryBand, sNMPPortNumber=sNMPPortNumber, portAllocationMismatch=portAllocationMismatch, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sMTPServerInternetAddressType=sMTPServerInternetAddressType, auxPortSSMTx=auxPortSSMTx, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, searchStateLinked=searchStateLinked, mainPSUPortAutoMdix=mainPSUPortAutoMdix, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, extendedSpectrumScanning=extendedSpectrumScanning, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, mABMaintenanceLevel=mABMaintenanceLevel, subbandLowestFrequency=subbandLowestFrequency, mABNominalModulationMode=mABNominalModulationMode, accessMethod=accessMethod, reset=reset, aggregateDataRate=aggregateDataRate, remoteMaximumTransmitPower=remoteMaximumTransmitPower, licenseSFPPortSupport=licenseSFPPortSupport, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, wirelessLinkStatus=wirelessLinkStatus, mainPSUPortSSMTx=mainPSUPortSSMTx, sNMPTrapTable=sNMPTrapTable, masterSlaveMode=masterSlaveMode, authorizationControlTableEntry=authorizationControlTableEntry, phyStatusGroup=phyStatusGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, sNTPServerTableEntry=sNTPServerTableEntry, packetsFromInternalStack=packetsFromInternalStack, useVLANForManagementInterfaces=useVLANForManagementInterfaces, syncEEquipmentClock=syncEEquipmentClock, management=management, wirelessOutEthernetOctets=wirelessOutEthernetOctets, remoteUnitNameLinked=remoteUnitNameLinked, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, mainPSUPortQLTx=mainPSUPortQLTx, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, configuration=configuration, unitOutOfCalibration=unitOutOfCalibration, receiveFreqMHz=receiveFreqMHz, linkModeOptimization=linkModeOptimization, aAAControlGroup=aAAControlGroup, receivePower=receivePower, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, rxColorCode=rxColorCode, tDMChannelStatus=tDMChannelStatus, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, phyControlInstancedTableEntry=phyControlInstancedTableEntry, bridge=bridge, capacityVariantMismatch=capacityVariantMismatch, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, byteErrorRatioLinked=byteErrorRatioLinked, licenseGroup=licenseGroup, antennaSelection=antennaSelection, aggregateDataRateLinked=aggregateDataRateLinked, sNTPServerTable=sNTPServerTable, hTTPPortNumber=hTTPPortNumber, managementGroup=managementGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, licenseCapacity=licenseCapacity, license=license, capacityVariantMismatchTrap=capacityVariantMismatchTrap, sNTPSync=sNTPSync, remoteInternetAddressLinked=remoteInternetAddressLinked, syslogClientTrap=syslogClientTrap, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, mABNominalTransmitCapacity=mABNominalTransmitCapacity, licenseOOBManagementSupport=licenseOOBManagementSupport, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, dNSServerTable=dNSServerTable, authorizationControlGroup=authorizationControlGroup, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, alarmsGroup=alarmsGroup, whitelistRMEnabled=whitelistRMEnabled, mgmtInstancedTableIndex=mgmtInstancedTableIndex, qOSPriorityScheme=qOSPriorityScheme, sNTPServerStatus=sNTPServerStatus, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, l2CPPriorityTableEntry=l2CPPriorityTableEntry, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, bootVersion=bootVersion, tDDControl=tDDControl, l2CPPriorityTableNumber=l2CPPriorityTableNumber, licenseIPv6Support=licenseIPv6Support, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, tDDSynchronizationAlarm=tDDSynchronizationAlarm, groupID=groupID, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, dfsTableNumber=dfsTableNumber, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNTPServerTableIndex=sNTPServerTableIndex, ethernetInstancedTableEntry=ethernetInstancedTableEntry, ptpTraps=ptpTraps, auxPortConfigurationMismatch=auxPortConfigurationMismatch, sntp=sntp, systemClock=systemClock, dataPortPauseFrames=dataPortPauseFrames, receivePowerLinked=receivePowerLinked, auxPortSyncERxStatus=auxPortSyncERxStatus, blacklistRMMacAddress=blacklistRMMacAddress, phyControlInstancedTableIndex=phyControlInstancedTableIndex, iPDSCPPriorityTable=iPDSCPPriorityTable, mgmtInstancedTable=mgmtInstancedTable, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNTPServerTableNumber=sNTPServerTableNumber, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, configurationInstancedTable=configurationInstancedTable, maximumTransmitPower=maximumTransmitPower, transparentClock=transparentClock, altitude=altitude, rawReceivePower=rawReceivePower, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, secureModeAlarmTrap=secureModeAlarmTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, tDMChannelStatusTrap=tDMChannelStatusTrap, cableDiagPair1Results=cableDiagPair1Results, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, dNSResolver=dNSResolver, nIDULanPortStatusTrap=nIDULanPortStatusTrap, alarms=alarms, tDMChannelLineCode=tDMChannelLineCode, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, encryptionAlgorithm=encryptionAlgorithm, sMTPEmailAlert=sMTPEmailAlert, managementNetworkAccessEnabled=managementNetworkAccessEnabled, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, licenseInstancedTableIndex=licenseInstancedTableIndex, receiveChannel=receiveChannel, targetMACAddress=targetMACAddress, telnetPortNumber=telnetPortNumber, userRole=userRole, licenseCountry=licenseCountry, dataBridgingAvailability=dataBridgingAvailability, cableDiagnosticsWarning=cableDiagnosticsWarning, latitude=latitude, portAllocationMismatchTrap=portAllocationMismatchTrap, vLANManagementPriority=vLANManagementPriority, tDMGroup=tDMGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, phyControlGroup=phyControlGroup, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, sFPError=sFPError, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, dfsTable=dfsTable, maxLinkRangeExceeded=maxLinkRangeExceeded, PYSNMP_MODULE_ID=cambium, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, licenseSecurityLevel=licenseSecurityLevel, dNSServerPortNumber=dNSServerPortNumber, auxPortAcceptedQLRx=auxPortAcceptedQLRx, cableDiagPair3Results=cableDiagPair3Results, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, installationMode=installationMode, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, transmitModulationModeLinked=transmitModulationModeLinked, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, tDMEnabledChannels=tDMEnabledChannels, ptpGroups=ptpGroups, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, transmitPower=transmitPower, vectorErrorLinked=vectorErrorLinked, syslogControl=syslogControl, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, routerProtocols=routerProtocols, authorizationControlTable=authorizationControlTable, authorizationControlTableIndex=authorizationControlTableIndex, alarmInstancedTableNumber=alarmInstancedTableNumber, mABTransmissionInterval=mABTransmissionInterval, sFPPortQLTx=sFPPortQLTx, resetGroup=resetGroup, ethernetStatisticsDataSource=ethernetStatisticsDataSource, transmitPowerLinked=transmitPowerLinked, ethernet=ethernet, sNTPPrimaryServer=sNTPPrimaryServer, userTableIndex=userTableIndex, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, ethernetGroup=ethernetGroup, pubStats=pubStats, dNSGroup=dNSGroup, unitName=unitName, supplementary=supplementary, localPacketFiltering=localPacketFiltering, transmitterChannels=transmitterChannels, nIDULanPortAutoMdix=nIDULanPortAutoMdix, sFPPortQLRx=sFPPortQLRx, licenseTrialPeriod=licenseTrialPeriod, remoteMACAddressLinked=remoteMACAddressLinked, transmitDataRateLinked=transmitDataRateLinked, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, receiveModulationMode=receiveModulationMode, ethernetPriorityTable=ethernetPriorityTable, portAllocationMismatchLinked=portAllocationMismatchLinked, cableDiagnosticsResultTable=cableDiagnosticsResultTable, byteErrorRatio=byteErrorRatio, useVLANForMABProtocol=useVLANForMABProtocol, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, cableDiagPair2Distance=cableDiagPair2Distance, sFPPortStatusTrap=sFPPortStatusTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, enableTransmission=enableTransmission, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, transmitFreqMHz=transmitFreqMHz, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, mgmtInstancedTableNumber=mgmtInstancedTableNumber, l2CPPriorityTable=l2CPPriorityTable, pubStatsGroup=pubStatsGroup, signalStrengthRatioLinked=signalStrengthRatioLinked, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, sFPPortSSMTx=sFPPortSSMTx, unavailableSeconds=unavailableSeconds, dNSServerTableIndex=dNSServerTableIndex, licenseEncryption=licenseEncryption, sNMPTrapTableIndex=sNMPTrapTableIndex, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, mABProtocolVLANPriority=mABProtocolVLANPriority, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, wirelessOutOctets=wirelessOutOctets, lowestDataModulationMode=lowestDataModulationMode, auxPortQLTx=auxPortQLTx, receiveModulationModeLinked=receiveModulationModeLinked, receiveDataRateLinked=receiveDataRateLinked, tDDSynchronizationStatus=tDDSynchronizationStatus, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, cableDiagPair4Distance=cableDiagPair4Distance, incompatibleRegulatoryBands=incompatibleRegulatoryBands, timeZone=timeZone, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNTPServerInternetAddress=sNTPServerInternetAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, maximumNumberOfSlaves=maximumNumberOfSlaves, daylightSaving=daylightSaving, deviceMACAddress=deviceMACAddress, routerProtocolsGroup=routerProtocolsGroup, ptpCompliance=ptpCompliance, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, channelChangeTrap=channelChangeTrap, auxPortStatus=auxPortStatus, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, receiveModulationModeDetail=receiveModulationModeDetail, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, softwareVersion=softwareVersion, ethernetInstancedTableIndex=ethernetInstancedTableIndex, licenseGasGroup=licenseGasGroup, secureModeAlarm=secureModeAlarm, vLANManagementVID=vLANManagementVID, ptp670=ptp670, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, licenseInstancedTableNumber=licenseInstancedTableNumber, encryptionGroup=encryptionGroup, productName=productName, transmitDataRate=transmitDataRate, receiveFreqKHz=receiveFreqKHz, telnetAccessEnabled=telnetAccessEnabled, iPv4Address=iPv4Address, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, vectorError=vectorError, hTTPSAccessEnabled=hTTPSAccessEnabled, phyControl=phyControl, transparentClockVID=transparentClockVID, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, frequencyVariant=frequencyVariant, apcGroup=apcGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, severelyErroredSeconds=severelyErroredSeconds, alarmInstancedTableIndex=alarmInstancedTableIndex, mgmtInstancedTableEntry=mgmtInstancedTableEntry, cableDiagPair4Results=cableDiagPair4Results, ethernetPriorityTableEntry=ethernetPriorityTableEntry, transparentClockVLAN=transparentClockVLAN, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPv3Enable=sNMPv3Enable, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPServerRetries=sNTPServerRetries, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, installStatus=installStatus, dataBridgingStatusLinked=dataBridgingStatusLinked, remoteInternetAddressType=remoteInternetAddressType, configurationInstancedTableIndex=configurationInstancedTableIndex, remoteMACAddress=remoteMACAddress, tdmTableIndex=tdmTableIndex, dfsPeaks=dfsPeaks, sNMPEnabledTraps=sNMPEnabledTraps, sNTPServerPortNumber=sNTPServerPortNumber, tDDControlGroup=tDDControlGroup, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, deviceMSN=deviceMSN, dfs=dfs, sFPPortDisabledWarning=sFPPortDisabledWarning, ethernetInstancedTable=ethernetInstancedTable, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, sNTPLastSync=sNTPLastSync, snmpControlGroup=snmpControlGroup, siteName=siteName, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, dNS=dNS, l2CPPriorityTableIndex=l2CPPriorityTableIndex, tDMConfigurationMismatch=tDMConfigurationMismatch, sNTPServerTimeout=sNTPServerTimeout, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tdmTableNumber=tdmTableNumber, ptmp=ptmp, hCMPLinkSymmetry=hCMPLinkSymmetry, cableLoss=cableLoss, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, smtp=smtp, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, tdmTableEntry=tdmTableEntry, dataBridgingStatusAlarm=dataBridgingStatusAlarm, mainPSUPortStatusTrap=mainPSUPortStatusTrap, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, antennaGain=antennaGain, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, licenseInstancedTableEntry=licenseInstancedTableEntry, dNSPrimaryServer=dNSPrimaryServer, cableDiagPair1Distance=cableDiagPair1Distance, receiveDataRate=receiveDataRate, installArmStateTrap=installArmStateTrap, alarmInstancedTable=alarmInstancedTable, pubInstancedStatsTable=pubInstancedStatsTable, userTableEntry=userTableEntry, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, dataBridgingStatus=dataBridgingStatus, syslogState=syslogState, auxPortQLRx=auxPortQLRx, cableDiagnosticsPorts=cableDiagnosticsPorts, subbandHighestFrequency=subbandHighestFrequency, dSCPManagementPriority=dSCPManagementPriority, encryption=encryption, systemReset=systemReset)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", remoteUnitName=remoteUnitName, licenseTDDSyncSupport=licenseTDDSyncSupport, userPassword=userPassword, syslogControlGroup=syslogControlGroup, dNSServerTableEntry=dNSServerTableEntry, licenseRARSupport=licenseRARSupport, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, mainPSUPortQLRx=mainPSUPortQLRx, searchState=searchState, whitelistRMMacAddress=whitelistRMMacAddress, hTTPAccessEnabled=hTTPAccessEnabled, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, dfsMeans=dfsMeans, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, transmitFreqKHz=transmitFreqKHz, wirelessOutAllOctets=wirelessOutAllOctets, rangeLinked=rangeLinked, cableDiagPair3Distance=cableDiagPair3Distance, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, licenseVersion=licenseVersion, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, snmpControl=snmpControl, linkLossLinked=linkLossLinked, hTTPSPortNumber=hTTPSPortNumber, dNSServerTableNumber=dNSServerTableNumber, configurationInstancedTableNumber=configurationInstancedTableNumber, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, productVariant=productVariant, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, apc=apc, licenseTLSRekey=licenseTLSRekey, txMABFrames=txMABFrames, sntpGroup=sntpGroup, syslogClient=syslogClient, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, tFTPServerInternetAddress=tFTPServerInternetAddress, iPv6GatewayAddress=iPv6GatewayAddress, installStatusLinked=installStatusLinked, sNTPPollInterval=sNTPPollInterval, rawReceivePowerLinked=rawReceivePowerLinked, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, eIRP=eIRP, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, installStatusTrap=installStatusTrap, sFPPortSyncERxStatus=sFPPortSyncERxStatus, iPVersion=iPVersion, ethernetInstancedTableNumber=ethernetInstancedTableNumber, authorizationMethod=authorizationMethod, configurationGroup=configurationGroup, ptp=ptp, installArmState=installArmState, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, dfsTableEntry=dfsTableEntry, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, lowestTDMModulationMode=lowestTDMModulationMode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod)
