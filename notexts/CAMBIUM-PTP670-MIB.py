...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", frequencyVariant=frequencyVariant, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, phyControlGroup=phyControlGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tDMEnabledChannels=tDMEnabledChannels, sNTPServerPortNumber=sNTPServerPortNumber, licenseInstancedTable=licenseInstancedTable, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, mABProtocolVID=mABProtocolVID, tDDSynchronizationMode=tDDSynchronizationMode, dNSServerTableNumber=dNSServerTableNumber, linkLossLinked=linkLossLinked, licenseSecurityLevel=licenseSecurityLevel, ptpTraps=ptpTraps, byteErrorRatioLinked=byteErrorRatioLinked, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, incompatibleRegulatoryBands=incompatibleRegulatoryBands, aAAControl=aAAControl, mABMaintenanceLevel=mABMaintenanceLevel, signalStrengthRatioLinked=signalStrengthRatioLinked, unitOutOfCalibration=unitOutOfCalibration, l2CPPriorityTableNumber=l2CPPriorityTableNumber, tDM=tDM, managementPortWirelessDownAlert=managementPortWirelessDownAlert, packetsToInternalStack=packetsToInternalStack, dataPortPauseFrames=dataPortPauseFrames, deviceESN=deviceESN, iPv6PrefixLength=iPv6PrefixLength, licenseGasGroup=licenseGasGroup, sFPPortStatus=sFPPortStatus, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, versionsGroup=versionsGroup, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, syslogLocalWrappedTrap=syslogLocalWrappedTrap, userName=userName, snmpControlGroup=snmpControlGroup, transmitterChannels=transmitterChannels, receiveFreqKHz=receiveFreqKHz, dataBridgingStatusLinked=dataBridgingStatusLinked, sNTPSync=sNTPSync, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, encryptionAlgorithm=encryptionAlgorithm, ethernetInstancedTable=ethernetInstancedTable, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, tDMChannelLineCode=tDMChannelLineCode, dNSGroup=dNSGroup, mainPSUPortStatusTrap=mainPSUPortStatusTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sntpGroup=sntpGroup, siteName=siteName, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, sNTPState=sNTPState, telnetPortNumber=telnetPortNumber, notificationsGroup=notificationsGroup, tFTPServerInternetAddress=tFTPServerInternetAddress, secondarySoftwareVersion=secondarySoftwareVersion, dataBridgingStatusAlarm=dataBridgingStatusAlarm, cableLoss=cableLoss, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, configurationInstancedTableIndex=configurationInstancedTableIndex, rawReceivePower=rawReceivePower, sFPPortDisabledWarning=sFPPortDisabledWarning, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, regulatoryBand=regulatoryBand, receiveDataRate=receiveDataRate, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, mABHoldoffPeriod=mABHoldoffPeriod, licenseIPv6Support=licenseIPv6Support, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, tDMConfigurationMismatch=tDMConfigurationMismatch, licenseInstancedTableIndex=licenseInstancedTableIndex, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, userRole=userRole, installStatus=installStatus, gatewayIPAddress=gatewayIPAddress, phyControl=phyControl, sNTPPrimaryServer=sNTPPrimaryServer, channelChangeTrap=channelChangeTrap, phyInstancedStatusTable=phyInstancedStatusTable, dNSServerInternetAddress=dNSServerInternetAddress, nIDULanPortAutoMdix=nIDULanPortAutoMdix, mABNominalModulationMode=mABNominalModulationMode, whitelistRMMacAddress=whitelistRMMacAddress, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, sFPPortQLRx=sFPPortQLRx, receiveModulationModeDetail=receiveModulationModeDetail, erroredSeconds=erroredSeconds, userTableNumber=userTableNumber, tdmTableNumber=tdmTableNumber, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, capacityVariantMismatchLinked=capacityVariantMismatchLinked, wirelessOutOctets=wirelessOutOctets, encryptionGroup=encryptionGroup, sFPPortAutoNegotiation=sFPPortAutoNegotiation, aggregateDataRateLinked=aggregateDataRateLinked, iPVersion=iPVersion, auxPortSyncERxStatus=auxPortSyncERxStatus, sNTPServerTableIndex=sNTPServerTableIndex, syslogStateTrap=syslogStateTrap, transmitModulationMode=transmitModulationMode, portAllocationMismatch=portAllocationMismatch, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, transmitDataRate=transmitDataRate, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, configurationGroup=configurationGroup, masterSlaveMode=masterSlaveMode, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, pubStatsGroup=pubStatsGroup, softwareVersion=softwareVersion, sNTPServerTableEntry=sNTPServerTableEntry, phyStatus=phyStatus, hCMPMaximumLinkRange=hCMPMaximumLinkRange, secureModeAlarm=secureModeAlarm, installStatusLinked=installStatusLinked, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, mainPSUPortQLRx=mainPSUPortQLRx, maximumNumberOfSlaves=maximumNumberOfSlaves, sNTPPollInterval=sNTPPollInterval, latitude=latitude, incompatibleMasterAndSlave=incompatibleMasterAndSlave, encryption=encryption, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, reset=reset, licenseRARSupport=licenseRARSupport, smtpGroup=smtpGroup, dNSResolver=dNSResolver, dfs=dfs, ethernetInstancedTableIndex=ethernetInstancedTableIndex, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, remoteInternetAddress=remoteInternetAddress, mainPSUPortStatus=mainPSUPortStatus, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, hardwareVersion=hardwareVersion, wirelessOutEthernetOctets=wirelessOutEthernetOctets, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, tdmTableEntry=tdmTableEntry, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, sntp=sntp, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, ptp=ptp, alarmInstancedTableIndex=alarmInstancedTableIndex, iPv4Address=iPv4Address, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, management=management, syslogState=syslogState, dataBridgingStatus=dataBridgingStatus, ptpCompliance=ptpCompliance, whitelistRMEnabled=whitelistRMEnabled, versions=versions, dNSServerTableIndex=dNSServerTableIndex, mainPSUPortAllocation=mainPSUPortAllocation, cableDiagPair1Results=cableDiagPair1Results, targetRange=targetRange, mainPSUPortQLTx=mainPSUPortQLTx, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, ethernetInstancedTableNumber=ethernetInstancedTableNumber, auxPortAcceptedQLRx=auxPortAcceptedQLRx, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, daylightSaving=daylightSaving, licenseVersion=licenseVersion, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, cableDiagPair2Results=cableDiagPair2Results, remoteMACAddressLinked=remoteMACAddressLinked, mABNominalTransmitCapacity=mABNominalTransmitCapacity, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, altitude=altitude, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, hTTPPortNumber=hTTPPortNumber, licenseTLSRekey=licenseTLSRekey, packetsFromInternalStack=packetsFromInternalStack, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, transmitPowerLinked=transmitPowerLinked, tDMChannelStatusTrap=tDMChannelStatusTrap, auxPortStatusTrap=auxPortStatusTrap, auxPortDisabledWarning=auxPortDisabledWarning, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, dNSServerInternetAddressType=dNSServerInternetAddressType, rxColorCode=rxColorCode, licenseCapacity=licenseCapacity, sNTPServerInternetAddress=sNTPServerInternetAddress, syslogClientTrap=syslogClientTrap, receiveChannel=receiveChannel, sNMPEnabledTraps=sNMPEnabledTraps, syslogControl=syslogControl, hCMPLinkSymmetry=hCMPLinkSymmetry, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, alarmsGroup=alarmsGroup, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, sNTPServerTimeout=sNTPServerTimeout, ptpTrapPrefix=ptpTrapPrefix, mgmtInstancedTable=mgmtInstancedTable, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, rangeLinked=rangeLinked, syslogControlGroup=syslogControlGroup, unitIdentification=unitIdentification, remoteMACAddress=remoteMACAddress, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, portAllocationMismatchTrap=portAllocationMismatchTrap, alarms=alarms, auxPortAllocation=auxPortAllocation, tDDControl=tDDControl, sFPPortAutoMdix=sFPPortAutoMdix, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, tFTPServerPortNumber=tFTPServerPortNumber, licenseBandwidthCap=licenseBandwidthCap, receiveModulationModeLinked=receiveModulationModeLinked, wirelessTopology=wirelessTopology, transparentClockPort=transparentClockPort, transparentClockVID=transparentClockVID, authorizationControl=authorizationControl, mgmtInstancedTableEntry=mgmtInstancedTableEntry, dNSServerTableEntry=dNSServerTableEntry, sNMPTrapPortNumber=sNMPTrapPortNumber, receivePowerLinked=receivePowerLinked, ethernetPriorityTable=ethernetPriorityTable, sMTPEnabledMessages=sMTPEnabledMessages, alarmInstancedTable=alarmInstancedTable, licenseIEEE1588Support=licenseIEEE1588Support, sNTPServerTableNumber=sNTPServerTableNumber, licenseIssueNumber=licenseIssueNumber, authorizationControlTable=authorizationControlTable, targetMACAddress=targetMACAddress, tDMChannelCableLength=tDMChannelCableLength, rangingMode=rangingMode, nIDULanPortStatusTrap=nIDULanPortStatusTrap, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, byteErrorRatio=byteErrorRatio, bootVersion=bootVersion, licenseTDDSyncSupport=licenseTDDSyncSupport, licenseCountry=licenseCountry, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, apcGroup=apcGroup, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, phyStatusGroup=phyStatusGroup, syslogClient=syslogClient, sNMPPortNumber=sNMPPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, syncESlavePort=syncESlavePort, alarmInstancedTableNumber=alarmInstancedTableNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, cableDiagPair2Distance=cableDiagPair2Distance, dNSServerTable=dNSServerTable, iPv6Address=iPv6Address, licenseHCMPSupport=licenseHCMPSupport, wirelessOutAllOctets=wirelessOutAllOctets, blacklistRMMacAddress=blacklistRMMacAddress, severelyErroredSeconds=severelyErroredSeconds, transmitFreqMHz=transmitFreqMHz, receiveDataRateLinked=receiveDataRateLinked, hTTPAccessEnabled=hTTPAccessEnabled, hTTPSAccessEnabled=hTTPSAccessEnabled, cableDiagnostics=cableDiagnostics, auxPortQLTx=auxPortQLTx, licenseEncryption=licenseEncryption, cableDiagPair3Distance=cableDiagPair3Distance, tDMChannelLoopback=tDMChannelLoopback, tFTPClient=tFTPClient, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, linkLoss=linkLoss, installStatusTrap=installStatusTrap, antennaSelection=antennaSelection, systemReset=systemReset, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, managementGroup=managementGroup, linkName=linkName, deviceMACAddress=deviceMACAddress, vectorErrorLinked=vectorErrorLinked, lbtDetectedTrap=lbtDetectedTrap, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, sFPPortStatusTrap=sFPPortStatusTrap, licenseTrialPeriod=licenseTrialPeriod, mgmtInstancedTableNumber=mgmtInstancedTableNumber, dNSPrimaryServer=dNSPrimaryServer, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, receiveModulationMode=receiveModulationMode, sFPError=sFPError, remoteMaximumTransmitPower=remoteMaximumTransmitPower, subnetMask=subnetMask, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, secureModeAlarmTrap=secureModeAlarmTrap, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, sMTPServerPortNumber=sMTPServerPortNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, iPDSCPPriorityTable=iPDSCPPriorityTable, ethernetInstancedTableEntry=ethernetInstancedTableEntry, cableDiagnosticsGroup=cableDiagnosticsGroup, ptmp=ptmp, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, signalStrengthRatio=signalStrengthRatio, localPacketFiltering=localPacketFiltering, groupID=groupID, sFPPortSyncERxStatus=sFPPortSyncERxStatus, routerProtocols=routerProtocols, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, auxPortSSMTx=auxPortSSMTx, mABState=mABState, sNMPTrapTableEntry=sNMPTrapTableEntry, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, dfsMeans=dfsMeans, vLANManagementPriority=vLANManagementPriority, deviceMSN=deviceMSN, licenseInstancedTableEntry=licenseInstancedTableEntry, channelBandwidth=channelBandwidth, dataPortWirelessDownAlert=dataPortWirelessDownAlert, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, qOSPriorityScheme=qOSPriorityScheme, auxPortQLRx=auxPortQLRx, unitIdentificationGroup=unitIdentificationGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, license=license, transmitDataRateLinked=transmitDataRateLinked, mABTransmissionInterval=mABTransmissionInterval, cableDiagnosticsControl=cableDiagnosticsControl, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, userTableEntry=userTableEntry, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, licenseGroupAccess=licenseGroupAccess, unavailableSeconds=unavailableSeconds, licenseRegulatoryBandsList=licenseRegulatoryBandsList, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, sNMPTrapTableIndex=sNMPTrapTableIndex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, auxPortConfigurationMismatch=auxPortConfigurationMismatch, transparentClock=transparentClock, linkModeOptimization=linkModeOptimization, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, receiveFreqMHz=receiveFreqMHz, antennaGain=antennaGain, tdmTable=tdmTable, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, sFPPortSSMTx=sFPPortSSMTx, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, syncETrackingState=syncETrackingState, timeZone=timeZone, pubStats=pubStats, bridge=bridge, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, phyControlInstancedTableNumber=phyControlInstancedTableNumber, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, cableDiagnosticsResultTable=cableDiagnosticsResultTable, ptp670=ptp670, sNMPv3Enable=sNMPv3Enable, sFPPortAllocation=sFPPortAllocation, rawReceivePowerLinked=rawReceivePowerLinked, sFPPortQLTx=sFPPortQLTx, l2CPPriorityTable=l2CPPriorityTable, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, ethernetStatisticsDataSource=ethernetStatisticsDataSource, vectorError=vectorError, sNMPTrapTable=sNMPTrapTable, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, userTableIndex=userTableIndex, licenseUnitSerialNumber=licenseUnitSerialNumber, iPv6GatewayAddress=iPv6GatewayAddress, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, syncETracking=syncETracking, transmitModulationModeLinked=transmitModulationModeLinked, sFPErrorTrap=sFPErrorTrap, configurationInstancedTable=configurationInstancedTable, unitName=unitName, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, systemClock=systemClock, installArmStateTrap=installArmStateTrap, pubInstancedStatsTable=pubInstancedStatsTable, mainPSUPortSSMTx=mainPSUPortSSMTx, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, authorizationMethod=authorizationMethod, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, authorizationControlTableIndex=authorizationControlTableIndex, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, transmitFreqKHz=transmitFreqKHz, sNMPCommunityString=sNMPCommunityString, phyControlInstancedTable=phyControlInstancedTable, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, sNTPServerTable=sNTPServerTable, licenseOOBManagementSupport=licenseOOBManagementSupport, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, cableDiagPair1Distance=cableDiagPair1Distance, configurationInstancedTableNumber=configurationInstancedTableNumber, ethernet=ethernet, productName=productName, licenseSFPPortSupport=licenseSFPPortSupport, eIRP=eIRP, dfsTableIndex=dfsTableIndex, configuration=configuration, tDDSynchronizationStatus=tDDSynchronizationStatus, cableDiagPair4Results=cableDiagPair4Results, remoteUnitNameLinked=remoteUnitNameLinked, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, subbandLowestFrequency=subbandLowestFrequency, dataBridgingAvailability=dataBridgingAvailability, enableTransmission=enableTransmission, transmitPower=transmitPower, dfsTableEntry=dfsTableEntry, cambium=cambium, l2CPPriorityTableIndex=l2CPPriorityTableIndex, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, phyControlInstancedTableIndex=phyControlInstancedTableIndex, tempPcb=tempPcb, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, blacklistRMEnabled=blacklistRMEnabled, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dfsTableNumber=dfsTableNumber, dNS=dNS, maximumTransmitPower=maximumTransmitPower, useVLANForMABProtocol=useVLANForMABProtocol, licenseGroup=licenseGroup, sNTPServerStatus=sNTPServerStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, cableDiagnosticsWarning=cableDiagnosticsWarning, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, managementNetworkAccessEnabled=managementNetworkAccessEnabled, subbandHighestFrequency=subbandHighestFrequency, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, cableDiagPair4Distance=cableDiagPair4Distance, tDMInterfaceControl=tDMInterfaceControl, remoteUnitName=remoteUnitName, supplementaryGroup=supplementaryGroup, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, dNSServerPortNumber=dNSServerPortNumber, cableDiagPair3Results=cableDiagPair3Results, configurationInstancedTableEntry=configurationInstancedTableEntry, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, tDMChannelStatus=tDMChannelStatus, regulatoryBandTrap=regulatoryBandTrap, lowestDataModulationMode=lowestDataModulationMode, smtp=smtp, authorizationControlTableNumber=authorizationControlTableNumber, supplementary=supplementary, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, productVariant=productVariant, ethernetStatisticsTable=ethernetStatisticsTable, installationMode=installationMode, wirelessLinkStatus=wirelessLinkStatus, txMABFrames=txMABFrames, userTable=userTable, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, resetGroup=resetGroup, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, authorizationControlGroup=authorizationControlGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, licenseInstancedTableNumber=licenseInstancedTableNumber, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, tdmTableIndex=tdmTableIndex, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, receivePower=receivePower, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dfsGroup=dfsGroup, telnetAccessEnabled=telnetAccessEnabled, noWirelessChannelAvailable=noWirelessChannelAvailable, licenseMaxLinkRange=licenseMaxLinkRange, aAAControlGroup=aAAControlGroup, txColorCode=txColorCode, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, maxLinkRangeExceeded=maxLinkRangeExceeded, nIDULanPortStatus=nIDULanPortStatus, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, wirelessLinkAvailability=wirelessLinkAvailability, alarmInstancedTableEntry=alarmInstancedTableEntry, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, PYSNMP_MODULE_ID=cambium, hTTPSPortNumber=hTTPSPortNumber, sNTPLastSync=sNTPLastSync, authorizationControlTableEntry=authorizationControlTableEntry, userEnabled=userEnabled, sNMPTrapVersion=sNMPTrapVersion, portAllocationMismatchLinked=portAllocationMismatchLinked, bridgeGroup=bridgeGroup, mainPSUPortAutoMdix=mainPSUPortAutoMdix)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, extendedSpectrumScanning=extendedSpectrumScanning, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, linkSymmetry=linkSymmetry, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, transparentClockVLAN=transparentClockVLAN, sMTPEmailAlert=sMTPEmailAlert, tDMInterfaceStatus=tDMInterfaceStatus, phyControlInstancedTableEntry=phyControlInstancedTableEntry, sNTPSyncTrap=sNTPSyncTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, ethernetPriorityTableNumber=ethernetPriorityTableNumber, dfsTable=dfsTable, enabledDiagnosticAlarms=enabledDiagnosticAlarms, accessMethod=accessMethod, capacityVariantMismatch=capacityVariantMismatch, range=range, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, syncEEquipmentClock=syncEEquipmentClock, installArmState=installArmState, dSCPManagementPriority=dSCPManagementPriority, transmitChannel=transmitChannel, searchState=searchState, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, mgmtInstancedTableIndex=mgmtInstancedTableIndex, licenseSyncESupport=licenseSyncESupport, searchStateLinked=searchStateLinked, ptpGroups=ptpGroups, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, routerProtocolsGroup=routerProtocolsGroup, dfsPeaks=dfsPeaks, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, vLANManagementVID=vLANManagementVID, lowestTDMModulationMode=lowestTDMModulationMode, auxPortStatus=auxPortStatus, capacityVariantMismatchTrap=capacityVariantMismatchTrap, longitude=longitude, userPassword=userPassword, tDDSynchronizationAlarm=tDDSynchronizationAlarm, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, aggregateDataRate=aggregateDataRate, remoteInternetAddressType=remoteInternetAddressType, cableDiagnosticsPorts=cableDiagnosticsPorts, tDDControlGroup=tDDControlGroup, wirelessLinkStatusLinked=wirelessLinkStatusLinked, sNTPServerRetries=sNTPServerRetries, ethernetGroup=ethernetGroup, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, oOBPriorityQueueMapping=oOBPriorityQueueMapping, tDMGroup=tDMGroup, remoteInternetAddressLinked=remoteInternetAddressLinked, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, mABProtocolVLANPriority=mABProtocolVLANPriority, apc=apc, snmpControl=snmpControl, sNMPTrapInternetAddress=sNMPTrapInternetAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces)
