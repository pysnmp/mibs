...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", linkModeOptimization=linkModeOptimization, licenseTLSRekey=licenseTLSRekey, mgmtInstancedTable=mgmtInstancedTable, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, sntpGroup=sntpGroup, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, resetGroup=resetGroup, dNSGroup=dNSGroup, telnetAccessEnabled=telnetAccessEnabled, sFPErrorTrap=sFPErrorTrap, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, ethernet=ethernet, licenseRARSupport=licenseRARSupport, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, iPv6GatewayAddress=iPv6GatewayAddress, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ethernetPriorityTableIndex=ethernetPriorityTableIndex, tdmTableIndex=tdmTableIndex, telnetPortNumber=telnetPortNumber, ptpTraps=ptpTraps, mainPSUPortAutoMdix=mainPSUPortAutoMdix, sNMPTrapTableIndex=sNMPTrapTableIndex, configurationInstancedTableNumber=configurationInstancedTableNumber, mPLSTCPriorityTable=mPLSTCPriorityTable, auxPortSSMTx=auxPortSSMTx, mainPSUPortStatus=mainPSUPortStatus, signalStrengthRatio=signalStrengthRatio, mgmtInstancedTableIndex=mgmtInstancedTableIndex, hCMPMaximumLinkRange=hCMPMaximumLinkRange, alarmsGroup=alarmsGroup, hTTPSPortNumber=hTTPSPortNumber, dNSResolver=dNSResolver, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, dataBridgingAvailability=dataBridgingAvailability, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, frequencyVariant=frequencyVariant, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, cableDiagnosticsResultTable=cableDiagnosticsResultTable, altitude=altitude, ptp=ptp, configurationInstancedTable=configurationInstancedTable, rawReceivePower=rawReceivePower, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, licenseBandwidthCap=licenseBandwidthCap, installStatusTrap=installStatusTrap, blacklistRMMacAddress=blacklistRMMacAddress, smtp=smtp, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, linkLossLinked=linkLossLinked, remoteUnitName=remoteUnitName, licenseGroupAccess=licenseGroupAccess, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, eIRP=eIRP, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, sntp=sntp, cableDiagPair4Distance=cableDiagPair4Distance, syslogControlGroup=syslogControlGroup, dNSPrimaryServer=dNSPrimaryServer, tDMConfigurationMismatch=tDMConfigurationMismatch, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, remoteUnitNameLinked=remoteUnitNameLinked, managementNetworkAccessEnabled=managementNetworkAccessEnabled, l2CPPriorityTableEntry=l2CPPriorityTableEntry, channelChangeTrap=channelChangeTrap, maximumTransmitPower=maximumTransmitPower, licenseSecurityLevel=licenseSecurityLevel, linkLoss=linkLoss, mgmtInstancedTableEntry=mgmtInstancedTableEntry, vLANManagementPriority=vLANManagementPriority, transparentClockVLAN=transparentClockVLAN, licenseInstancedTableNumber=licenseInstancedTableNumber, mainPSUPortAllocation=mainPSUPortAllocation, license=license, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, channelBandwidth=channelBandwidth, licenseTrialPeriod=licenseTrialPeriod, dfsTableNumber=dfsTableNumber, mABNominalTransmitCapacity=mABNominalTransmitCapacity, dNSServerInternetAddress=dNSServerInternetAddress, transmitPowerLinked=transmitPowerLinked, sNMPTrapTable=sNMPTrapTable, transmitFreqMHz=transmitFreqMHz, sNMPTrapInternetAddress=sNMPTrapInternetAddress, alarmInstancedTableIndex=alarmInstancedTableIndex, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, PYSNMP_MODULE_ID=cambium, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, sMTPServerInternetAddressType=sMTPServerInternetAddressType, authorizationControlTableIndex=authorizationControlTableIndex, maxLinkRangeExceeded=maxLinkRangeExceeded, hardwareVersion=hardwareVersion, dNSServerTableIndex=dNSServerTableIndex, lowestTDMModulationMode=lowestTDMModulationMode, sNMPv3Enable=sNMPv3Enable, licenseInstancedTableEntry=licenseInstancedTableEntry, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, userTableNumber=userTableNumber, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, licenseUnitSerialNumber=licenseUnitSerialNumber, cableDiagnosticsPorts=cableDiagnosticsPorts, versionsGroup=versionsGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, syslogStateTrap=syslogStateTrap, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, configurationInstancedTableEntry=configurationInstancedTableEntry, aAAControlGroup=aAAControlGroup, dfsTable=dfsTable, tDMChannelLoopback=tDMChannelLoopback, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, encryptionGroup=encryptionGroup, sNTPServerRetries=sNTPServerRetries, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, alarmInstancedTableNumber=alarmInstancedTableNumber, licenseCapacity=licenseCapacity, rangingMode=rangingMode, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, lbtDetectedTrap=lbtDetectedTrap, authorizationControlGroup=authorizationControlGroup, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, cambium=cambium, phyControlInstancedTableEntry=phyControlInstancedTableEntry, dNSServerTableNumber=dNSServerTableNumber, tDMChannelStatus=tDMChannelStatus, cableDiagPair2Distance=cableDiagPair2Distance, syslogClient=syslogClient, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, transmitChannel=transmitChannel, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sFPPortSSMTx=sFPPortSSMTx, receiveModulationModeLinked=receiveModulationModeLinked, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, dNSServerTable=dNSServerTable, ethernetStatisticsDataSource=ethernetStatisticsDataSource, incompatibleRegulatoryBands=incompatibleRegulatoryBands, sFPPortStatus=sFPPortStatus, dataBridgingStatus=dataBridgingStatus, aggregateDataRate=aggregateDataRate, userTableIndex=userTableIndex, dNSServerPortNumber=dNSServerPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, remoteMACAddress=remoteMACAddress, wirelessLinkStatus=wirelessLinkStatus, aAAControl=aAAControl, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, auxPortAcceptedQLRx=auxPortAcceptedQLRx, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, sMTPServerPortNumber=sMTPServerPortNumber, remoteInternetAddressLinked=remoteInternetAddressLinked, wirelessLinkAvailability=wirelessLinkAvailability, gatewayIPAddress=gatewayIPAddress, sFPPortQLRx=sFPPortQLRx, receiveModulationMode=receiveModulationMode, deviceESN=deviceESN, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, sNTPServerInternetAddressType=sNTPServerInternetAddressType, tdmTableEntry=tdmTableEntry, tDMGroup=tDMGroup, sFPPortAutoMdix=sFPPortAutoMdix, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, enableTransmission=enableTransmission, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, sNMPTrapTableNumber=sNMPTrapTableNumber, licenseMaxLinkRange=licenseMaxLinkRange, tDM=tDM, dfs=dfs, tDMInterfaceStatus=tDMInterfaceStatus, auxPortDisabledWarning=auxPortDisabledWarning, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptmp=ptmp, transmitFreqKHz=transmitFreqKHz, cableDiagPair2Results=cableDiagPair2Results, sNMPEnabledTraps=sNMPEnabledTraps, remoteInternetAddressType=remoteInternetAddressType, wirelessOutOctets=wirelessOutOctets, userRole=userRole, tDMEnabledChannels=tDMEnabledChannels, sNTPSyncTrap=sNTPSyncTrap, tDMInterfaceControl=tDMInterfaceControl, userTable=userTable, ethernetInstancedTableEntry=ethernetInstancedTableEntry, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, mABTransmissionInterval=mABTransmissionInterval, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, oOBPriorityQueueMapping=oOBPriorityQueueMapping, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, phyControlInstancedTableNumber=phyControlInstancedTableNumber, snmpControl=snmpControl, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, ethernetInstancedTable=ethernetInstancedTable, sFPPortStatusTrap=sFPPortStatusTrap, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, configurationInstancedTableIndex=configurationInstancedTableIndex, receiveModulationModeDetail=receiveModulationModeDetail, sNTPServerTable=sNTPServerTable, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, txColorCode=txColorCode, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, sNTPServerStatus=sNTPServerStatus, systemReset=systemReset, userPassword=userPassword, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, unitIdentification=unitIdentification, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, transparentClock=transparentClock, licenseTDDSyncSupport=licenseTDDSyncSupport, ethernetInstancedTableIndex=ethernetInstancedTableIndex, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, auxPortAllocation=auxPortAllocation, wirelessOutEthernetOctets=wirelessOutEthernetOctets, l2CPPriorityTable=l2CPPriorityTable, hTTPPortNumber=hTTPPortNumber, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, sNTPServerTableNumber=sNTPServerTableNumber, cableDiagnosticsControl=cableDiagnosticsControl, sNTPServerTableIndex=sNTPServerTableIndex, phyStatusGroup=phyStatusGroup, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, cableDiagnosticsWarning=cableDiagnosticsWarning, bridge=bridge, sNTPSync=sNTPSync, alarmInstancedTable=alarmInstancedTable, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, remoteInternetAddress=remoteInternetAddress, mABProtocolVID=mABProtocolVID, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, authorizationControlTableNumber=authorizationControlTableNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, pubStatsGroup=pubStatsGroup, packetsFromInternalStack=packetsFromInternalStack, deviceMSN=deviceMSN, tdmTable=tdmTable, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, masterSlaveMode=masterSlaveMode, tDMChannelCableLength=tDMChannelCableLength, management=management, syncESlavePort=syncESlavePort, nIDULanPortAutoMdix=nIDULanPortAutoMdix, sNTPPrimaryServer=sNTPPrimaryServer, hTTPSAccessEnabled=hTTPSAccessEnabled, licenseGroup=licenseGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", subbandHighestFrequency=subbandHighestFrequency, wirelessOutAllOctets=wirelessOutAllOctets, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, sNTPServerPortNumber=sNTPServerPortNumber, tDDControl=tDDControl, softwareVersion=softwareVersion, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, authorizationControlTableEntry=authorizationControlTableEntry, sFPPortAutoNegotiation=sFPPortAutoNegotiation, iPv4Address=iPv4Address, ethernetPriorityTableNumber=ethernetPriorityTableNumber, portAllocationMismatch=portAllocationMismatch, wirelessLinkStatusLinked=wirelessLinkStatusLinked, syncETrackingState=syncETrackingState, dNSServerInternetAddressType=dNSServerInternetAddressType, sNTPServerTimeout=sNTPServerTimeout, iPv6PrefixLength=iPv6PrefixLength, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, sFPPortAllocation=sFPPortAllocation, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, byteErrorRatio=byteErrorRatio, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, mABMaintenanceLevel=mABMaintenanceLevel, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, sNTPServerTableEntry=sNTPServerTableEntry, antennaGain=antennaGain, useVLANForMABProtocol=useVLANForMABProtocol, portAllocationMismatchTrap=portAllocationMismatchTrap, unavailableSeconds=unavailableSeconds, tdmTableNumber=tdmTableNumber, dNSServerTableEntry=dNSServerTableEntry, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, cableDiagPair3Results=cableDiagPair3Results, receiveDataRate=receiveDataRate, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, reset=reset, unitName=unitName, dataPortPauseFrames=dataPortPauseFrames, mainPSUPortStatusTrap=mainPSUPortStatusTrap, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, auxPortQLRx=auxPortQLRx, nIDULanPortStatus=nIDULanPortStatus, subbandLowestFrequency=subbandLowestFrequency, auxPortStatusTrap=auxPortStatusTrap, mABProtocolVLANPriority=mABProtocolVLANPriority, phyStatus=phyStatus, routerProtocolsGroup=routerProtocolsGroup, installationMode=installationMode, vectorErrorLinked=vectorErrorLinked, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, ptpTrapPrefix=ptpTrapPrefix, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, mainPSUPortQLTx=mainPSUPortQLTx, sNTPState=sNTPState, dfsTableIndex=dfsTableIndex, linkName=linkName, secureModeAlarm=secureModeAlarm, range=range, dNS=dNS, routerProtocols=routerProtocols, tDDControlGroup=tDDControlGroup, licenseGasGroup=licenseGasGroup, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, phyControlInstancedTable=phyControlInstancedTable, vLANManagementVID=vLANManagementVID, sNMPPortNumber=sNMPPortNumber, auxPortConfigurationMismatch=auxPortConfigurationMismatch, ptpGroups=ptpGroups, tDMChannelStatusTrap=tDMChannelStatusTrap, sFPPortSyncERxStatus=sFPPortSyncERxStatus, ethernetGroup=ethernetGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, syslogControl=syslogControl, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, auxPortStatus=auxPortStatus, qOSPriorityScheme=qOSPriorityScheme, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, managementPortWirelessDownAlert=managementPortWirelessDownAlert, authorizationMethod=authorizationMethod, secureModeAlarmTrap=secureModeAlarmTrap, antennaSelection=antennaSelection, pubInstancedStatsTable=pubInstancedStatsTable, phyControlInstancedTableIndex=phyControlInstancedTableIndex, sFPError=sFPError, sNMPTrapVersion=sNMPTrapVersion, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, sMTPEmailAlert=sMTPEmailAlert, syncETracking=syncETracking, ethernetPriorityTableEntry=ethernetPriorityTableEntry, receiveChannel=receiveChannel, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, productName=productName, unitOutOfCalibration=unitOutOfCalibration, sFPPortDisabledWarning=sFPPortDisabledWarning, nIDULanPortStatusTrap=nIDULanPortStatusTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, subnetMask=subnetMask, receivePower=receivePower, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, dfsGroup=dfsGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, erroredSeconds=erroredSeconds, cableLoss=cableLoss, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, authorizationControlTable=authorizationControlTable, l2CPPriorityTableNumber=l2CPPriorityTableNumber, licenseSyncESupport=licenseSyncESupport, ptpCompliance=ptpCompliance, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, licenseIEEE1588Support=licenseIEEE1588Support, packetsToInternalStack=packetsToInternalStack, installStatusLinked=installStatusLinked, smtpGroup=smtpGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, longitude=longitude, signalStrengthRatioLinked=signalStrengthRatioLinked, searchState=searchState, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, systemClock=systemClock, iPv6Address=iPv6Address, ptp670=ptp670, alarmInstancedTableEntry=alarmInstancedTableEntry, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, ethernetInstancedTableNumber=ethernetInstancedTableNumber, productVariant=productVariant, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPServerInternetAddress=sNTPServerInternetAddress, linkModeOptimizationMismatch=linkModeOptimizationMismatch, installArmStateTrap=installArmStateTrap, ethernetStatisticsTable=ethernetStatisticsTable, receiveDataRateLinked=receiveDataRateLinked, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, hCMPLinkSymmetry=hCMPLinkSymmetry, receivePowerLinked=receivePowerLinked, tFTPServerInternetAddress=tFTPServerInternetAddress, tempPcb=tempPcb, syslogClientTrap=syslogClientTrap, lowestDataModulationMode=lowestDataModulationMode, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, searchStateLinked=searchStateLinked, wirelessTopology=wirelessTopology, maximumNumberOfSlaves=maximumNumberOfSlaves, localPacketFiltering=localPacketFiltering, tFTPClient=tFTPClient, dfsTableEntry=dfsTableEntry, noWirelessChannelAvailable=noWirelessChannelAvailable, encryptionAlgorithm=encryptionAlgorithm, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, licenseIPv6Support=licenseIPv6Support, configuration=configuration, sNMPTrapPortNumber=sNMPTrapPortNumber, byteErrorRatioLinked=byteErrorRatioLinked, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, licenseCountry=licenseCountry, whitelistRMMacAddress=whitelistRMMacAddress, tDMChannelLineCode=tDMChannelLineCode, receiveFreqKHz=receiveFreqKHz, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, rangeLinked=rangeLinked, unitIdentificationGroup=unitIdentificationGroup, auxPortQLTx=auxPortQLTx, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, supplementary=supplementary, transparentClockVID=transparentClockVID, sFPPortQLTx=sFPPortQLTx, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, rawReceivePowerLinked=rawReceivePowerLinked, blacklistRMEnabled=blacklistRMEnabled, siteName=siteName, mgmtInstancedTableNumber=mgmtInstancedTableNumber, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, phyInstancedStatusTable=phyInstancedStatusTable, timeZone=timeZone, iPVersion=iPVersion, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, iPDSCPPriorityTable=iPDSCPPriorityTable, sNTPPollInterval=sNTPPollInterval, deviceMACAddress=deviceMACAddress, transmitModulationMode=transmitModulationMode, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, userTableEntry=userTableEntry, encryption=encryption, licenseInstancedTableIndex=licenseInstancedTableIndex, groupID=groupID, snmpControlGroup=snmpControlGroup, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, regulatoryBandTrap=regulatoryBandTrap, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, extendedSpectrumScanning=extendedSpectrumScanning, licenseSFPPortSupport=licenseSFPPortSupport, sNMPCommunityString=sNMPCommunityString, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, dfsMeans=dfsMeans, userEnabled=userEnabled, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, daylightSaving=daylightSaving, dSCPManagementPriority=dSCPManagementPriority, cableDiagPair1Distance=cableDiagPair1Distance, receiveFreqMHz=receiveFreqMHz, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, cableDiagPair3Distance=cableDiagPair3Distance, licenseIssueNumber=licenseIssueNumber, mABState=mABState, authorizationControl=authorizationControl, targetRange=targetRange, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, licenseOOBManagementSupport=licenseOOBManagementSupport, dfsPeaks=dfsPeaks, mainPSUPortSSMTx=mainPSUPortSSMTx, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, sNTPLastSync=sNTPLastSync, accessMethod=accessMethod, tFTPServerPortNumber=tFTPServerPortNumber, remoteMACAddressLinked=remoteMACAddressLinked, cableDiagnosticsGroup=cableDiagnosticsGroup, ethernetPriorityTable=ethernetPriorityTable, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataBridgingStatusAlarm=dataBridgingStatusAlarm, incompatibleMasterAndSlave=incompatibleMasterAndSlave, txMABFrames=txMABFrames, severelyErroredSeconds=severelyErroredSeconds, bridgeGroup=bridgeGroup, transmitPower=transmitPower, notificationsGroup=notificationsGroup, mABHoldoffPeriod=mABHoldoffPeriod, alarms=alarms, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, hTTPAccessEnabled=hTTPAccessEnabled, transparentClockPort=transparentClockPort, portAllocationMismatchLinked=portAllocationMismatchLinked)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, capacityVariantMismatch=capacityVariantMismatch, versions=versions, licenseRegulatoryBandsList=licenseRegulatoryBandsList, bootVersion=bootVersion, transmitModulationModeLinked=transmitModulationModeLinked, apcGroup=apcGroup, licenseVersion=licenseVersion, cableDiagnostics=cableDiagnostics, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, vectorError=vectorError, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, aggregateDataRateLinked=aggregateDataRateLinked, latitude=latitude, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, syslogState=syslogState, whitelistRMEnabled=whitelistRMEnabled, phyControl=phyControl, transmitDataRateLinked=transmitDataRateLinked, linkSymmetry=linkSymmetry, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, syncEEquipmentClock=syncEEquipmentClock, licenseEncryption=licenseEncryption, transmitterChannels=transmitterChannels, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, auxPortSyncERxStatus=auxPortSyncERxStatus, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, sMTPSourceEmailAddress=sMTPSourceEmailAddress, cableDiagPair1Results=cableDiagPair1Results, sMTPServerInternetAddress=sMTPServerInternetAddress, capacityVariantMismatchTrap=capacityVariantMismatchTrap, mainPSUPortQLRx=mainPSUPortQLRx, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, installStatus=installStatus, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, transmitDataRate=transmitDataRate, supplementaryGroup=supplementaryGroup, secondarySoftwareVersion=secondarySoftwareVersion, cableDiagPair4Results=cableDiagPair4Results, tDDSynchronizationMode=tDDSynchronizationMode, configurationGroup=configurationGroup, dataBridgingStatusLinked=dataBridgingStatusLinked, regulatoryBand=regulatoryBand, userName=userName, managementGroup=managementGroup, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, apc=apc, pubStats=pubStats, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, mABNominalModulationMode=mABNominalModulationMode, tFTPServerInternetAddressType=tFTPServerInternetAddressType, phyControlGroup=phyControlGroup, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, licenseHCMPSupport=licenseHCMPSupport, installArmState=installArmState, capacityVariantMismatchLinked=capacityVariantMismatchLinked, rxColorCode=rxColorCode, licenseInstancedTable=licenseInstancedTable, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, targetMACAddress=targetMACAddress)
