...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", timeZone=timeZone, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, hTTPSPortNumber=hTTPSPortNumber, aAAControlGroup=aAAControlGroup, dSCPManagementPriority=dSCPManagementPriority, managementGroup=managementGroup, mABTransmissionInterval=mABTransmissionInterval, eIRP=eIRP, lbtDetectedTrap=lbtDetectedTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, incompatibleRegulatoryBands=incompatibleRegulatoryBands, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, dfsTableNumber=dfsTableNumber, tdmTable=tdmTable, ptp670=ptp670, sNTPServerStatus=sNTPServerStatus, sFPErrorTrap=sFPErrorTrap, oOBPriorityQueueMapping=oOBPriorityQueueMapping, mABState=mABState, licenseVersion=licenseVersion, ethernetPriorityTableNumber=ethernetPriorityTableNumber, licenseIssueNumber=licenseIssueNumber, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, iPv6GatewayAddress=iPv6GatewayAddress, licenseInstancedTableEntry=licenseInstancedTableEntry, userTableIndex=userTableIndex, portAllocationMismatchTrap=portAllocationMismatchTrap, installArmStateTrap=installArmStateTrap, licenseIEEE1588Support=licenseIEEE1588Support, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNTPServerInternetAddressType=sNTPServerInternetAddressType, tdmTableEntry=tdmTableEntry, license=license, nIDULanPortAutoMdix=nIDULanPortAutoMdix, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, mainPSUPortStatusTrap=mainPSUPortStatusTrap, cableDiagnosticsGroup=cableDiagnosticsGroup, dataBridgingStatusAlarm=dataBridgingStatusAlarm, iPVersion=iPVersion, productName=productName, dataBridgingStatusLinked=dataBridgingStatusLinked, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, syslogStateTrap=syslogStateTrap, receiveFreqMHz=receiveFreqMHz, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, mainPSUPortAutoMdix=mainPSUPortAutoMdix, mainPSUPortQLRx=mainPSUPortQLRx, sNTPServerPortNumber=sNTPServerPortNumber, bridgeGroup=bridgeGroup, byteErrorRatio=byteErrorRatio, snmpControlGroup=snmpControlGroup, bridge=bridge, l2CPPriorityTableIndex=l2CPPriorityTableIndex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sFPPortAllocation=sFPPortAllocation, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, tDDControlGroup=tDDControlGroup, licenseTDDSyncSupport=licenseTDDSyncSupport, configurationGroup=configurationGroup, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sFPPortSSMTx=sFPPortSSMTx, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, linkName=linkName, ethernetInstancedTable=ethernetInstancedTable, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, receivePower=receivePower, alarmInstancedTable=alarmInstancedTable, mABProtocolVID=mABProtocolVID, configurationInstancedTableNumber=configurationInstancedTableNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sMTPEnabledMessages=sMTPEnabledMessages, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, auxPortAllocation=auxPortAllocation, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, packetsFromInternalStack=packetsFromInternalStack, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, sNTPSync=sNTPSync, secureModeAlarm=secureModeAlarm, authorizationMethod=authorizationMethod, sNTPLastSync=sNTPLastSync, altitude=altitude, siteName=siteName, ethernetStatisticsDataSource=ethernetStatisticsDataSource, linkModeOptimizationMismatch=linkModeOptimizationMismatch, cableDiagPair2Distance=cableDiagPair2Distance, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, remoteInternetAddressLinked=remoteInternetAddressLinked, wirelessOutAllOctets=wirelessOutAllOctets, licenseInstancedTableIndex=licenseInstancedTableIndex, cambium=cambium, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, remoteInternetAddress=remoteInternetAddress, phyStatus=phyStatus, notificationsGroup=notificationsGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, secureModeAlarmTrap=secureModeAlarmTrap, auxPortSyncERxStatus=auxPortSyncERxStatus, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, installArmState=installArmState, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, systemReset=systemReset, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, transmitPowerLinked=transmitPowerLinked, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, iPv6PrefixLength=iPv6PrefixLength, tDMInterfaceControl=tDMInterfaceControl, ethernetPriorityTableIndex=ethernetPriorityTableIndex, mgmtInstancedTableNumber=mgmtInstancedTableNumber, licenseGasGroup=licenseGasGroup, userRole=userRole, cableDiagPair1Results=cableDiagPair1Results, receiveModulationModeDetail=receiveModulationModeDetail, mPLSTCPriorityTable=mPLSTCPriorityTable, deviceMACAddress=deviceMACAddress, dNSPrimaryServer=dNSPrimaryServer, licenseRARSupport=licenseRARSupport, ethernetInstancedTableIndex=ethernetInstancedTableIndex, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tDMChannelStatusTrap=tDMChannelStatusTrap, signalStrengthRatioLinked=signalStrengthRatioLinked, licenseGroup=licenseGroup, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, apc=apc, l2CPPriorityTable=l2CPPriorityTable, localPacketFiltering=localPacketFiltering, transmitModulationModeLinked=transmitModulationModeLinked, receiveModulationMode=receiveModulationMode, unitIdentificationGroup=unitIdentificationGroup, secondarySoftwareVersion=secondarySoftwareVersion, telnetPortNumber=telnetPortNumber, erroredSeconds=erroredSeconds, tDMChannelLineCode=tDMChannelLineCode, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, wirelessOutOctets=wirelessOutOctets, sFPPortAutoNegotiation=sFPPortAutoNegotiation, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sMTPEmailAlert=sMTPEmailAlert, sFPPortAutoMdix=sFPPortAutoMdix, tDMChannelStatus=tDMChannelStatus, sFPPortQLTx=sFPPortQLTx, sNTPPrimaryServer=sNTPPrimaryServer, maxLinkRangeExceeded=maxLinkRangeExceeded, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, alarmInstancedTableNumber=alarmInstancedTableNumber, hCMPLinkSymmetry=hCMPLinkSymmetry, maximumNumberOfSlaves=maximumNumberOfSlaves, encryptionGroup=encryptionGroup, sNMPTrapVersion=sNMPTrapVersion, subbandHighestFrequency=subbandHighestFrequency, sNTPPollInterval=sNTPPollInterval, alarmsGroup=alarmsGroup, dataBridgingAvailability=dataBridgingAvailability, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, cableDiagPair4Distance=cableDiagPair4Distance, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, dfsTableIndex=dfsTableIndex, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, qOSPriorityScheme=qOSPriorityScheme, l2CPPriorityTableNumber=l2CPPriorityTableNumber, transparentClockVLAN=transparentClockVLAN, sMTPServerPortNumber=sMTPServerPortNumber, userEnabled=userEnabled, syslogClient=syslogClient, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, remoteUnitName=remoteUnitName, auxPortStatus=auxPortStatus, linkLossLinked=linkLossLinked, transmitFreqKHz=transmitFreqKHz, cableDiagnosticsResultTable=cableDiagnosticsResultTable, authorizationControlTableEntry=authorizationControlTableEntry, phyControlInstancedTable=phyControlInstancedTable, tFTPServerInternetAddressType=tFTPServerInternetAddressType, transmitPower=transmitPower, vLANManagementPriority=vLANManagementPriority, mABProtocolVLANPriority=mABProtocolVLANPriority, bootVersion=bootVersion, whitelistRMEnabled=whitelistRMEnabled, installStatusLinked=installStatusLinked, blacklistRMMacAddress=blacklistRMMacAddress, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, cableLoss=cableLoss, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, authorizationControlTableIndex=authorizationControlTableIndex, mainPSUPortSSMTx=mainPSUPortSSMTx, dNSServerInternetAddressType=dNSServerInternetAddressType, sNTPServerInternetAddress=sNTPServerInternetAddress, sFPError=sFPError, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, ethernetInstancedTableNumber=ethernetInstancedTableNumber, cableDiagPair3Distance=cableDiagPair3Distance, dNSServerPortNumber=dNSServerPortNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, cableDiagnostics=cableDiagnostics, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, apcGroup=apcGroup, byteErrorRatioLinked=byteErrorRatioLinked, mgmtInstancedTableIndex=mgmtInstancedTableIndex, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, phyControlInstancedTableEntry=phyControlInstancedTableEntry, transparentClockVID=transparentClockVID, alarms=alarms, deviceESN=deviceESN, cableDiagnosticsPorts=cableDiagnosticsPorts, channelBandwidth=channelBandwidth, hTTPAccessEnabled=hTTPAccessEnabled, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, dataPortPauseFrames=dataPortPauseFrames, whitelistRMMacAddress=whitelistRMMacAddress, transmitDataRate=transmitDataRate, auxPortSSMTx=auxPortSSMTx, linkModeOptimization=linkModeOptimization, packetsToInternalStack=packetsToInternalStack, wirelessLinkStatus=wirelessLinkStatus, ptpCompliance=ptpCompliance, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, linkLoss=linkLoss, rawReceivePower=rawReceivePower, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, configuration=configuration, remoteInternetAddressType=remoteInternetAddressType, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, unitOutOfCalibration=unitOutOfCalibration, hCMPMaximumLinkRange=hCMPMaximumLinkRange, licenseBandwidthCap=licenseBandwidthCap, sNMPTrapPortNumber=sNMPTrapPortNumber, iPDSCPPriorityTable=iPDSCPPriorityTable, managementNetworkAccessEnabled=managementNetworkAccessEnabled, licenseIPv6Support=licenseIPv6Support, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, configurationInstancedTableIndex=configurationInstancedTableIndex, range=range, channelChangeTrap=channelChangeTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sNMPTrapTableNumber=sNMPTrapTableNumber, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ptpTraps=ptpTraps, frequencyVariant=frequencyVariant, dNSGroup=dNSGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, telnetAccessEnabled=telnetAccessEnabled, mgmtInstancedTable=mgmtInstancedTable, accessMethod=accessMethod, unitName=unitName, sNTPServerTable=sNTPServerTable, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, licenseTrialPeriod=licenseTrialPeriod, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, dfs=dfs, longitude=longitude, dNSResolver=dNSResolver, linkSymmetry=linkSymmetry, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tDMChannelLoopback=tDMChannelLoopback, groupID=groupID, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, ethernetInstancedTableEntry=ethernetInstancedTableEntry, resetGroup=resetGroup, portAllocationMismatchLinked=portAllocationMismatchLinked, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, transmitDataRateLinked=transmitDataRateLinked, dNSServerTable=dNSServerTable, sFPPortStatus=sFPPortStatus, ethernetStatisticsTable=ethernetStatisticsTable, tDMConfigurationMismatch=tDMConfigurationMismatch, mainPSUPortQLTx=mainPSUPortQLTx, tFTPServerPortNumber=tFTPServerPortNumber, cableDiagPair4Results=cableDiagPair4Results, mABMaintenanceLevel=mABMaintenanceLevel, transmitFreqMHz=transmitFreqMHz, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfsPeaks=dfsPeaks, smtpGroup=smtpGroup, txMABFrames=txMABFrames, unitIdentification=unitIdentification, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, vectorErrorLinked=vectorErrorLinked, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, cableDiagnosticsControl=cableDiagnosticsControl, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, tDDSynchronizationMode=tDDSynchronizationMode, searchState=searchState, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, auxPortQLTx=auxPortQLTx, alarmInstancedTableEntry=alarmInstancedTableEntry, mABHoldoffPeriod=mABHoldoffPeriod, regulatoryBandTrap=regulatoryBandTrap, remoteMACAddress=remoteMACAddress, licenseMaxLinkRange=licenseMaxLinkRange, auxPortDisabledWarning=auxPortDisabledWarning, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, aAAControl=aAAControl, subnetMask=subnetMask, sNMPCommunityString=sNMPCommunityString, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, phyControlInstancedTableNumber=phyControlInstancedTableNumber, authorizationControlTable=authorizationControlTable, tDMChannelCableLength=tDMChannelCableLength, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, severelyErroredSeconds=severelyErroredSeconds, tDM=tDM, portAllocationMismatch=portAllocationMismatch, receiveDataRate=receiveDataRate, sFPPortSyncERxStatus=sFPPortSyncERxStatus, gatewayIPAddress=gatewayIPAddress, hardwareVersion=hardwareVersion, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, receiveDataRateLinked=receiveDataRateLinked, subbandLowestFrequency=subbandLowestFrequency, useVLANForMABProtocol=useVLANForMABProtocol, latitude=latitude, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, userTableEntry=userTableEntry, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, authorizationControl=authorizationControl, cableDiagnosticsWarning=cableDiagnosticsWarning, aggregateDataRateLinked=aggregateDataRateLinked, capacityVariantMismatchLinked=capacityVariantMismatchLinked, dfsMeans=dfsMeans, phyControlInstancedTableIndex=phyControlInstancedTableIndex, versionsGroup=versionsGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, mainPSUPortStatus=mainPSUPortStatus, alarmInstancedTableIndex=alarmInstancedTableIndex, installStatus=installStatus, rxColorCode=rxColorCode, sFPPortStatusTrap=sFPPortStatusTrap, wirelessTopology=wirelessTopology, sNMPPortNumber=sNMPPortNumber, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, sNMPv3Enable=sNMPv3Enable, antennaSelection=antennaSelection, rangingMode=rangingMode, dNSServerTableNumber=dNSServerTableNumber, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, ptpTrapPrefix=ptpTrapPrefix, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, tDDControl=tDDControl, routerProtocolsGroup=routerProtocolsGroup, authorizationControlTableNumber=authorizationControlTableNumber, sntpGroup=sntpGroup, tempPcb=tempPcb, receivePowerLinked=receivePowerLinked, licenseInstancedTableNumber=licenseInstancedTableNumber, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, txColorCode=txColorCode, systemClock=systemClock, management=management, auxPortAcceptedQLRx=auxPortAcceptedQLRx, dNSServerTableEntry=dNSServerTableEntry, regulatoryBand=regulatoryBand, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, PYSNMP_MODULE_ID=cambium, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, masterSlaveMode=masterSlaveMode, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, wirelessLinkAvailability=wirelessLinkAvailability, receiveFreqKHz=receiveFreqKHz, authorizationControlGroup=authorizationControlGroup, capacityVariantMismatchTrap=capacityVariantMismatchTrap, transparentClockPort=transparentClockPort, tdmTableNumber=tdmTableNumber, remoteMACAddressLinked=remoteMACAddressLinked, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, sNMPEnabledTraps=sNMPEnabledTraps, syslogControlGroup=syslogControlGroup, hTTPPortNumber=hTTPPortNumber, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, syncETrackingState=syncETrackingState, ethernetGroup=ethernetGroup, encryptionAlgorithm=encryptionAlgorithm, ethernetPriorityTable=ethernetPriorityTable, iPv6Address=iPv6Address, phyInstancedStatusTable=phyInstancedStatusTable, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPSyncTrap=sNTPSyncTrap, pubInstancedStatsTable=pubInstancedStatsTable, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tDDSynchronizationStatus=tDDSynchronizationStatus, syslogState=syslogState, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, syslogClientTrap=syslogClientTrap, cableDiagPair3Results=cableDiagPair3Results, supplementaryGroup=supplementaryGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, rawReceivePowerLinked=rawReceivePowerLinked, auxPortConfigurationMismatch=auxPortConfigurationMismatch, userTable=userTable, licenseSFPPortSupport=licenseSFPPortSupport, licenseOOBManagementSupport=licenseOOBManagementSupport, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, sNTPState=sNTPState, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, iPv4Address=iPv4Address, mainPSUPortAllocation=mainPSUPortAllocation, auxPortStatusTrap=auxPortStatusTrap, sNMPTrapTable=sNMPTrapTable, capacityVariantMismatch=capacityVariantMismatch, userName=userName, sntp=sntp, cableDiagPair1Distance=cableDiagPair1Distance, phyControl=phyControl, ptp=ptp, tdmTableIndex=tdmTableIndex, wirelessLinkStatusLinked=wirelessLinkStatusLinked, sFPPortQLRx=sFPPortQLRx, encryption=encryption, licenseRegulatoryBandsList=licenseRegulatoryBandsList, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, signalStrengthRatio=signalStrengthRatio, licenseHCMPSupport=licenseHCMPSupport, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, wirelessOutEthernetOctets=wirelessOutEthernetOctets, configurationInstancedTableEntry=configurationInstancedTableEntry, auxPortQLRx=auxPortQLRx, syslogLocalWrappedTrap=syslogLocalWrappedTrap, lowestTDMModulationMode=lowestTDMModulationMode, transmitterChannels=transmitterChannels, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, dNSServerInternetAddress=dNSServerInternetAddress, phyStatusGroup=phyStatusGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, maximumTransmitPower=maximumTransmitPower, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, enableTransmission=enableTransmission, routerProtocols=routerProtocols, sNMPTrapInternetAddress=sNMPTrapInternetAddress, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, licenseInstancedTable=licenseInstancedTable, licenseSyncESupport=licenseSyncESupport, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, vLANManagementVID=vLANManagementVID, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, licenseTLSRekey=licenseTLSRekey, ptmp=ptmp, smtp=smtp, syncEEquipmentClock=syncEEquipmentClock, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, blacklistRMEnabled=blacklistRMEnabled, sNTPServerTableNumber=sNTPServerTableNumber, nIDULanPortStatus=nIDULanPortStatus, remoteUnitNameLinked=remoteUnitNameLinked, licenseEncryption=licenseEncryption, licenseCapacity=licenseCapacity, tFTPClient=tFTPClient, userPassword=userPassword, mABNominalModulationMode=mABNominalModulationMode, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, tFTPServerInternetAddress=tFTPServerInternetAddress, deviceMSN=deviceMSN, snmpControl=snmpControl, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dfsTableEntry=dfsTableEntry, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, tDMInterfaceStatus=tDMInterfaceStatus, licenseUnitSerialNumber=licenseUnitSerialNumber, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, cableDiagPair2Results=cableDiagPair2Results, transmitChannel=transmitChannel, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, receiveModulationModeLinked=receiveModulationModeLinked, sNTPServerTableEntry=sNTPServerTableEntry, dNSServerTableIndex=dNSServerTableIndex, installStatusTrap=installStatusTrap, ethernet=ethernet, daylightSaving=daylightSaving, configurationInstancedTable=configurationInstancedTable, licenseCountry=licenseCountry, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, softwareVersion=softwareVersion, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, productVariant=productVariant, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, receiveChannel=receiveChannel, antennaGain=antennaGain)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", userTableNumber=userTableNumber, targetRange=targetRange, mABNominalTransmitCapacity=mABNominalTransmitCapacity, incompatibleMasterAndSlave=incompatibleMasterAndSlave, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, sNTPServerTimeout=sNTPServerTimeout, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, extendedSpectrumScanning=extendedSpectrumScanning, sNMPTrapTableIndex=sNMPTrapTableIndex, syslogControl=syslogControl, phyControlGroup=phyControlGroup, sNTPServerRetries=sNTPServerRetries, tDMGroup=tDMGroup, lowestDataModulationMode=lowestDataModulationMode, sMTPServerInternetAddress=sMTPServerInternetAddress, searchStateLinked=searchStateLinked, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, ptpGroups=ptpGroups, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, unavailableSeconds=unavailableSeconds, hTTPSAccessEnabled=hTTPSAccessEnabled, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, nIDULanPortStatusTrap=nIDULanPortStatusTrap, syncETracking=syncETracking, managementPortWirelessDownAlert=managementPortWirelessDownAlert, dfsGroup=dfsGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, pubStatsGroup=pubStatsGroup, supplementary=supplementary, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, licenseSecurityLevel=licenseSecurityLevel, mgmtInstancedTableEntry=mgmtInstancedTableEntry, sFPPortDisabledWarning=sFPPortDisabledWarning, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, pubStats=pubStats, targetMACAddress=targetMACAddress, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, dataBridgingStatus=dataBridgingStatus, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, rangeLinked=rangeLinked, syncESlavePort=syncESlavePort, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, vectorError=vectorError, transparentClock=transparentClock, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, sNTPServerTableIndex=sNTPServerTableIndex, aggregateDataRate=aggregateDataRate, installationMode=installationMode, licenseGroupAccess=licenseGroupAccess, useVLANForManagementInterfaces=useVLANForManagementInterfaces, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, dNS=dNS, dfsTable=dfsTable, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, tDMEnabledChannels=tDMEnabledChannels, transmitModulationMode=transmitModulationMode, reset=reset, versions=versions)
