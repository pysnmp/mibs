...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", mainPSUPortStatus=mainPSUPortStatus, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, transmitFreqKHz=transmitFreqKHz, tDMInterfaceControl=tDMInterfaceControl, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, transmitPower=transmitPower, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, dNSGroup=dNSGroup, sFPPortQLRx=sFPPortQLRx, tdmTableIndex=tdmTableIndex, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, sNTPServerInternetAddress=sNTPServerInternetAddress, remoteUnitNameLinked=remoteUnitNameLinked, iPv6PrefixLength=iPv6PrefixLength, hCMPMaximumLinkRange=hCMPMaximumLinkRange, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, regulatoryBand=regulatoryBand, productName=productName, dataBridgingStatusLinked=dataBridgingStatusLinked, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, resetGroup=resetGroup, sntp=sntp, userEnabled=userEnabled, extendedSpectrumScanning=extendedSpectrumScanning, licenseInstancedTable=licenseInstancedTable, mainPSUPortQLTx=mainPSUPortQLTx, auxPortSyncERxStatus=auxPortSyncERxStatus, tDMChannelLineCode=tDMChannelLineCode, ethernetPriorityTableIndex=ethernetPriorityTableIndex, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, licenseInstancedTableIndex=licenseInstancedTableIndex, ethernetInstancedTableEntry=ethernetInstancedTableEntry, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, cableDiagPair4Distance=cableDiagPair4Distance, snmpControl=snmpControl, deviceMSN=deviceMSN, dNSPrimaryServer=dNSPrimaryServer, regulatoryBandTrap=regulatoryBandTrap, rawReceivePower=rawReceivePower, targetMACAddress=targetMACAddress, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, licenseSecurityLevel=licenseSecurityLevel, hTTPPortNumber=hTTPPortNumber, linkLoss=linkLoss, remoteMaximumTransmitPower=remoteMaximumTransmitPower, phyControlInstancedTable=phyControlInstancedTable, aggregateDataRateLinked=aggregateDataRateLinked, ptp=ptp, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, versionsGroup=versionsGroup, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, cableLoss=cableLoss, iPv6GatewayAddress=iPv6GatewayAddress, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, remoteInternetAddressType=remoteInternetAddressType, bridge=bridge, subnetMask=subnetMask, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, userTable=userTable, secondarySoftwareVersion=secondarySoftwareVersion, configuration=configuration, authorizationControlTableIndex=authorizationControlTableIndex, wirelessTopology=wirelessTopology, syslogControl=syslogControl, tempPcb=tempPcb, tdmTable=tdmTable, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, softwareVersion=softwareVersion, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, licenseSyncESupport=licenseSyncESupport, daylightSaving=daylightSaving, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, range=range, mABNominalModulationMode=mABNominalModulationMode, sFPPortSSMTx=sFPPortSSMTx, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, alarmInstancedTableEntry=alarmInstancedTableEntry, sMTPServerInternetAddress=sMTPServerInternetAddress, tDMInterfaceStatus=tDMInterfaceStatus, hardwareVersion=hardwareVersion, tDDControl=tDDControl, supplementary=supplementary, installArmState=installArmState, reset=reset, maximumTransmitPower=maximumTransmitPower, transmitDataRate=transmitDataRate, sNMPEnabledTraps=sNMPEnabledTraps, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, transmitFreqMHz=transmitFreqMHz, syslogStateTrap=syslogStateTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, ethernetPriorityTableEntry=ethernetPriorityTableEntry, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, pubStats=pubStats, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, transmitModulationMode=transmitModulationMode, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, remoteInternetAddress=remoteInternetAddress, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, licenseCapacity=licenseCapacity, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, nIDULanPortAutoMdix=nIDULanPortAutoMdix, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sMTPSourceEmailAddress=sMTPSourceEmailAddress, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, nIDULanPortStatus=nIDULanPortStatus, linkModeOptimization=linkModeOptimization, ptp670=ptp670, alarmInstancedTableIndex=alarmInstancedTableIndex, sMTPEnabledMessages=sMTPEnabledMessages, dNSServerTableIndex=dNSServerTableIndex, sNTPPollInterval=sNTPPollInterval, l2CPPriorityTable=l2CPPriorityTable, dataBridgingStatusAlarm=dataBridgingStatusAlarm, rawReceivePowerLinked=rawReceivePowerLinked, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPTrapInternetAddress=sNMPTrapInternetAddress, deviceMACAddress=deviceMACAddress, receivePowerLinked=receivePowerLinked, antennaGain=antennaGain, phyControlGroup=phyControlGroup, sFPError=sFPError, signalStrengthRatio=signalStrengthRatio, dfsGroup=dfsGroup, ethernetGroup=ethernetGroup, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, licenseCountry=licenseCountry, licenseRegulatoryBandsList=licenseRegulatoryBandsList, capacityVariantMismatchTrap=capacityVariantMismatchTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, mABTransmissionInterval=mABTransmissionInterval, rangingMode=rangingMode, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, whitelistRMEnabled=whitelistRMEnabled, mgmtInstancedTable=mgmtInstancedTable, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, configurationInstancedTable=configurationInstancedTable, licenseIEEE1588Support=licenseIEEE1588Support, phyStatus=phyStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, licenseGroupAccess=licenseGroupAccess, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, installStatusLinked=installStatusLinked, authorizationControlTableNumber=authorizationControlTableNumber, byteErrorRatio=byteErrorRatio, licenseTLSRekey=licenseTLSRekey, cableDiagnosticsWarning=cableDiagnosticsWarning, sNTPServerTableEntry=sNTPServerTableEntry, receiveChannel=receiveChannel, license=license, enableTransmission=enableTransmission, tDMConfigurationMismatch=tDMConfigurationMismatch, remoteInternetAddressLinked=remoteInternetAddressLinked, authorizationMethod=authorizationMethod, auxPortAcceptedQLRx=auxPortAcceptedQLRx, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, rangeLinked=rangeLinked, receiveModulationModeDetail=receiveModulationModeDetail, alarmsGroup=alarmsGroup, managementGroup=managementGroup, mainPSUPortAllocation=mainPSUPortAllocation, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, iPVersion=iPVersion, mPLSTCPriorityTable=mPLSTCPriorityTable, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, wirelessOutEthernetOctets=wirelessOutEthernetOctets, latitude=latitude, remoteMACAddress=remoteMACAddress, sFPPortAutoNegotiation=sFPPortAutoNegotiation, auxPortConfigurationMismatch=auxPortConfigurationMismatch, iPDSCPPriorityTable=iPDSCPPriorityTable, dataBridgingAvailability=dataBridgingAvailability, dfsTableNumber=dfsTableNumber, l2CPPriorityTableNumber=l2CPPriorityTableNumber, authorizationControl=authorizationControl, hTTPSPortNumber=hTTPSPortNumber, linkSymmetry=linkSymmetry, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, transmitPowerLinked=transmitPowerLinked, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, apc=apc, transparentClockVID=transparentClockVID, sNTPServerTimeout=sNTPServerTimeout, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, apcGroup=apcGroup, cableDiagPair1Results=cableDiagPair1Results, signalStrengthRatioLinked=signalStrengthRatioLinked, dNSResolver=dNSResolver, licenseVersion=licenseVersion, tDMEnabledChannels=tDMEnabledChannels, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, routerProtocolsGroup=routerProtocolsGroup, unitName=unitName, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tDDSynchronizationMode=tDDSynchronizationMode, maxLinkRangeExceeded=maxLinkRangeExceeded, licenseMaxLinkRange=licenseMaxLinkRange, severelyErroredSeconds=severelyErroredSeconds, alarmInstancedTableNumber=alarmInstancedTableNumber, capacityVariantMismatch=capacityVariantMismatch, sNTPServerRetries=sNTPServerRetries, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, sMTPServerPortNumber=sMTPServerPortNumber, aggregateDataRate=aggregateDataRate, dNS=dNS, sFPPortAllocation=sFPPortAllocation, dNSServerInternetAddress=dNSServerInternetAddress, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, phyStatusGroup=phyStatusGroup, wirelessOutAllOctets=wirelessOutAllOctets, secureModeAlarm=secureModeAlarm, eIRP=eIRP, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, transmitterChannels=transmitterChannels, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, unavailableSeconds=unavailableSeconds, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, cableDiagPair3Distance=cableDiagPair3Distance, remoteMACAddressLinked=remoteMACAddressLinked, nIDULanPortStatusTrap=nIDULanPortStatusTrap, syncETrackingState=syncETrackingState, ethernet=ethernet, mainPSUPortQLRx=mainPSUPortQLRx, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tdmTableNumber=tdmTableNumber, mgmtInstancedTableIndex=mgmtInstancedTableIndex, installArmStateTrap=installArmStateTrap, wirelessLinkAvailability=wirelessLinkAvailability, incompatibleRegulatoryBands=incompatibleRegulatoryBands, sNMPTrapTableNumber=sNMPTrapTableNumber, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, sNMPTrapTable=sNMPTrapTable, sNTPServerTableNumber=sNTPServerTableNumber, configurationInstancedTableEntry=configurationInstancedTableEntry)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, userTableEntry=userTableEntry, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ethernetStatisticsTable=ethernetStatisticsTable, wirelessLinkStatus=wirelessLinkStatus, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, dfs=dfs, tDMGroup=tDMGroup, aAAControl=aAAControl, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, syslogClientTrap=syslogClientTrap, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, transmitChannel=transmitChannel, telnetAccessEnabled=telnetAccessEnabled, aAAControlGroup=aAAControlGroup, cableDiagPair1Distance=cableDiagPair1Distance, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, authorizationControlTable=authorizationControlTable, iPv4Address=iPv4Address, sNTPServerStatus=sNTPServerStatus, smtp=smtp, licenseRARSupport=licenseRARSupport, subbandHighestFrequency=subbandHighestFrequency, cableDiagnosticsControl=cableDiagnosticsControl, versions=versions, mABProtocolVID=mABProtocolVID, txMABFrames=txMABFrames, systemClock=systemClock, notificationsGroup=notificationsGroup, accessMethod=accessMethod, dataPortPauseFrames=dataPortPauseFrames, portAllocationMismatch=portAllocationMismatch, vectorError=vectorError, altitude=altitude, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, dfsTableEntry=dfsTableEntry, auxPortStatusTrap=auxPortStatusTrap, authorizationControlTableEntry=authorizationControlTableEntry, dNSServerTable=dNSServerTable, phyControlInstancedTableIndex=phyControlInstancedTableIndex, syslogClient=syslogClient, managementPortWirelessDownAlert=managementPortWirelessDownAlert, ethernetInstancedTableIndex=ethernetInstancedTableIndex, sNTPPrimaryServer=sNTPPrimaryServer, configurationInstancedTableNumber=configurationInstancedTableNumber, tFTPServerInternetAddressType=tFTPServerInternetAddressType, installStatusTrap=installStatusTrap, auxPortStatus=auxPortStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sFPPortQLTx=sFPPortQLTx, sNTPState=sNTPState, sNMPTrapTableEntry=sNMPTrapTableEntry, phyInstancedStatusTable=phyInstancedStatusTable, whitelistRMMacAddress=whitelistRMMacAddress, receiveDataRate=receiveDataRate, receiveDataRateLinked=receiveDataRateLinked, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, mgmtInstancedTableEntry=mgmtInstancedTableEntry, syslogControlGroup=syslogControlGroup, licenseInstancedTableNumber=licenseInstancedTableNumber, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, syncEEquipmentClock=syncEEquipmentClock, sNTPServerTable=sNTPServerTable, noWirelessChannelAvailable=noWirelessChannelAvailable, iPv6Address=iPv6Address, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, alarmInstancedTable=alarmInstancedTable, managementNetworkAccessEnabled=managementNetworkAccessEnabled, ethernetStatisticsDataSource=ethernetStatisticsDataSource, installStatus=installStatus, sFPErrorTrap=sFPErrorTrap, targetRange=targetRange, configurationGroup=configurationGroup, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, mABMaintenanceLevel=mABMaintenanceLevel, licenseUnitSerialNumber=licenseUnitSerialNumber, vLANManagementPriority=vLANManagementPriority, capacityVariantMismatchLinked=capacityVariantMismatchLinked, qOSPriorityScheme=qOSPriorityScheme, channelBandwidth=channelBandwidth, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, blacklistRMEnabled=blacklistRMEnabled, wirelessOutOctets=wirelessOutOctets, receiveModulationModeLinked=receiveModulationModeLinked, receivePower=receivePower, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, licenseSFPPortSupport=licenseSFPPortSupport, mainPSUPortSSMTx=mainPSUPortSSMTx, sNTPSync=sNTPSync, dataPortWirelessDownAlert=dataPortWirelessDownAlert, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, oOBPriorityQueueMapping=oOBPriorityQueueMapping, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, sNTPServerInternetAddressType=sNTPServerInternetAddressType, syncETracking=syncETracking, bridgeGroup=bridgeGroup, tDM=tDM, dNSServerPortNumber=dNSServerPortNumber, auxPortSSMTx=auxPortSSMTx, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, sNMPCommunityString=sNMPCommunityString, supplementaryGroup=supplementaryGroup, unitIdentificationGroup=unitIdentificationGroup, auxPortQLTx=auxPortQLTx, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, syslogState=syslogState, auxPortAllocation=auxPortAllocation, pubStatsGroup=pubStatsGroup, mainPSUPortStatusTrap=mainPSUPortStatusTrap, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, cableDiagPair4Results=cableDiagPair4Results, vectorErrorLinked=vectorErrorLinked, routerProtocols=routerProtocols, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, syslogLocalWrappedTrap=syslogLocalWrappedTrap, bootVersion=bootVersion, dfsPeaks=dfsPeaks, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, tdmTableEntry=tdmTableEntry, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, ptpTraps=ptpTraps, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, configurationInstancedTableIndex=configurationInstancedTableIndex, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, subbandLowestFrequency=subbandLowestFrequency, management=management, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, wirelessLinkStatusLinked=wirelessLinkStatusLinked, transparentClockPort=transparentClockPort, unitIdentification=unitIdentification, searchState=searchState, tFTPClient=tFTPClient, dfsTable=dfsTable, auxPortQLRx=auxPortQLRx, dNSServerTableEntry=dNSServerTableEntry, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNTPServerPortNumber=sNTPServerPortNumber, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, vLANManagementVID=vLANManagementVID, dataBridgingStatus=dataBridgingStatus, sNTPSyncTrap=sNTPSyncTrap, tFTPServerInternetAddress=tFTPServerInternetAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, userName=userName, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, mainPSUPortAutoMdix=mainPSUPortAutoMdix, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, licenseHCMPSupport=licenseHCMPSupport, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sFPPortAutoMdix=sFPPortAutoMdix, cableDiagnosticsGroup=cableDiagnosticsGroup, deviceESN=deviceESN, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, licenseBandwidthCap=licenseBandwidthCap, gatewayIPAddress=gatewayIPAddress, remoteUnitName=remoteUnitName, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNMPPortNumber=sNMPPortNumber, systemReset=systemReset, secureModeAlarmTrap=secureModeAlarmTrap, cableDiagnostics=cableDiagnostics, licenseIssueNumber=licenseIssueNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, transmitDataRateLinked=transmitDataRateLinked, linkName=linkName, packetsToInternalStack=packetsToInternalStack, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, packetsFromInternalStack=packetsFromInternalStack, transparentClockVLAN=transparentClockVLAN, licenseInstancedTableEntry=licenseInstancedTableEntry, tDMChannelStatus=tDMChannelStatus, sFPPortDisabledWarning=sFPPortDisabledWarning, pubInstancedStatsTable=pubInstancedStatsTable, portAllocationMismatchTrap=portAllocationMismatchTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, productVariant=productVariant, longitude=longitude, cableDiagPair2Results=cableDiagPair2Results, authorizationControlGroup=authorizationControlGroup, linkLossLinked=linkLossLinked, sMTPEmailAlert=sMTPEmailAlert, tFTPServerPortNumber=tFTPServerPortNumber, portAllocationMismatchLinked=portAllocationMismatchLinked, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, syncESlavePort=syncESlavePort, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, licenseTDDSyncSupport=licenseTDDSyncSupport, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, mABHoldoffPeriod=mABHoldoffPeriod, mABProtocolVLANPriority=mABProtocolVLANPriority, frequencyVariant=frequencyVariant, dSCPManagementPriority=dSCPManagementPriority, installationMode=installationMode, blacklistRMMacAddress=blacklistRMMacAddress, sntpGroup=sntpGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, ptpGroups=ptpGroups, sNMPv3Enable=sNMPv3Enable, sNMPTrapVersion=sNMPTrapVersion, mABState=mABState, cableDiagPair3Results=cableDiagPair3Results, hTTPAccessEnabled=hTTPAccessEnabled, ptpCompliance=ptpCompliance, ethernetInstancedTableNumber=ethernetInstancedTableNumber, PYSNMP_MODULE_ID=cambium, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, localPacketFiltering=localPacketFiltering, licenseGasGroup=licenseGasGroup, auxPortDisabledWarning=auxPortDisabledWarning, mgmtInstancedTableNumber=mgmtInstancedTableNumber, transparentClock=transparentClock, siteName=siteName, hTTPSAccessEnabled=hTTPSAccessEnabled, cableDiagnosticsPorts=cableDiagnosticsPorts, userTableIndex=userTableIndex, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, licenseTrialPeriod=licenseTrialPeriod, tDMChannelCableLength=tDMChannelCableLength, mABNominalTransmitCapacity=mABNominalTransmitCapacity, receiveFreqKHz=receiveFreqKHz, cableDiagnosticsResultTable=cableDiagnosticsResultTable, searchStateLinked=searchStateLinked, unitOutOfCalibration=unitOutOfCalibration, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, sMTPServerInternetAddressType=sMTPServerInternetAddressType, lowestDataModulationMode=lowestDataModulationMode, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, cambium=cambium, tDDSynchronizationStatus=tDDSynchronizationStatus, cableDiagPair2Distance=cableDiagPair2Distance, maximumNumberOfSlaves=maximumNumberOfSlaves, receiveFreqMHz=receiveFreqMHz, transmitModulationModeLinked=transmitModulationModeLinked, alarms=alarms, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, receiveModulationMode=receiveModulationMode, phyControlInstancedTableEntry=phyControlInstancedTableEntry, phyControlInstancedTableNumber=phyControlInstancedTableNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, dNSServerTableNumber=dNSServerTableNumber, dfsMeans=dfsMeans, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, useVLANForMABProtocol=useVLANForMABProtocol, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, sNTPLastSync=sNTPLastSync, userPassword=userPassword, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, txColorCode=txColorCode, telnetPortNumber=telnetPortNumber, sFPPortStatus=sFPPortStatus, timeZone=timeZone, ethernetPriorityTable=ethernetPriorityTable, encryptionAlgorithm=encryptionAlgorithm, sNTPServerTableIndex=sNTPServerTableIndex, licenseIPv6Support=licenseIPv6Support, encryptionGroup=encryptionGroup, smtpGroup=smtpGroup, lowestTDMModulationMode=lowestTDMModulationMode, snmpControlGroup=snmpControlGroup, dfsTableIndex=dfsTableIndex, sFPPortSyncERxStatus=sFPPortSyncERxStatus, antennaSelection=antennaSelection, ptmp=ptmp, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, encryption=encryption, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, licenseEncryption=licenseEncryption, dNSServerInternetAddressType=dNSServerInternetAddressType, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ptpTrapPrefix=ptpTrapPrefix, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, tDMChannelStatusTrap=tDMChannelStatusTrap, licenseGroup=licenseGroup, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, phyControl=phyControl, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, userRole=userRole, lbtDetectedTrap=lbtDetectedTrap, masterSlaveMode=masterSlaveMode, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, ethernetInstancedTable=ethernetInstancedTable, erroredSeconds=erroredSeconds, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, tDMChannelLoopback=tDMChannelLoopback, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, tDDControlGroup=tDDControlGroup, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, sFPPortStatusTrap=sFPPortStatusTrap, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, groupID=groupID, userTableNumber=userTableNumber, channelChangeTrap=channelChangeTrap, hCMPLinkSymmetry=hCMPLinkSymmetry, rxColorCode=rxColorCode, licenseOOBManagementSupport=licenseOOBManagementSupport, byteErrorRatioLinked=byteErrorRatioLinked, linkModeOptimizationMismatch=linkModeOptimizationMismatch)
