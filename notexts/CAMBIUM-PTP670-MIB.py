...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, alarmInstancedTableIndex=alarmInstancedTableIndex, remoteUnitName=remoteUnitName, mABProtocolVID=mABProtocolVID, tDMInterfaceStatus=tDMInterfaceStatus, sFPPortSyncERxStatus=sFPPortSyncERxStatus, sNTPSync=sNTPSync, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, blacklistRMMacAddress=blacklistRMMacAddress, ethernetPriorityTableNumber=ethernetPriorityTableNumber, cableDiagPair3Results=cableDiagPair3Results, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, sMTPEmailAlert=sMTPEmailAlert, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, useVLANForMABProtocol=useVLANForMABProtocol, tFTPServerInternetAddress=tFTPServerInternetAddress, licenseTLSRekey=licenseTLSRekey, tDMChannelStatusTrap=tDMChannelStatusTrap, alarms=alarms, reset=reset, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, capacityVariantMismatchTrap=capacityVariantMismatchTrap, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, erroredSeconds=erroredSeconds, auxPortStatus=auxPortStatus, userName=userName, phyControl=phyControl, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, tDMConfigurationMismatch=tDMConfigurationMismatch, licenseIEEE1588Support=licenseIEEE1588Support, wirelessOutOctets=wirelessOutOctets, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, cableDiagPair4Results=cableDiagPair4Results, phyControlInstancedTableNumber=phyControlInstancedTableNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNTPServerTableEntry=sNTPServerTableEntry, alarmInstancedTableEntry=alarmInstancedTableEntry, tDMInterfaceControl=tDMInterfaceControl, searchStateLinked=searchStateLinked, bootVersion=bootVersion, daylightSaving=daylightSaving, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, licenseRegulatoryBandsList=licenseRegulatoryBandsList, cableDiagnostics=cableDiagnostics, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, dNSGroup=dNSGroup, remoteMACAddress=remoteMACAddress, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, installStatus=installStatus, tdmTableEntry=tdmTableEntry, deviceMSN=deviceMSN, dfs=dfs, sNMPTrapTableNumber=sNMPTrapTableNumber, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, encryptionAlgorithm=encryptionAlgorithm, dfsPeaks=dfsPeaks, dNSServerTableNumber=dNSServerTableNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ethernetInstancedTableEntry=ethernetInstancedTableEntry, packetsFromInternalStack=packetsFromInternalStack, productVariant=productVariant, alarmInstancedTableNumber=alarmInstancedTableNumber, receiveDataRate=receiveDataRate, aAAControlGroup=aAAControlGroup, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, mABMaintenanceLevel=mABMaintenanceLevel, whitelistRMEnabled=whitelistRMEnabled, sNTPPrimaryServer=sNTPPrimaryServer, ptp670=ptp670, localPacketFiltering=localPacketFiltering, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, configurationInstancedTableNumber=configurationInstancedTableNumber, antennaGain=antennaGain, nIDULanPortStatus=nIDULanPortStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, licenseCountry=licenseCountry, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, channelBandwidth=channelBandwidth, licenseMaxLinkRange=licenseMaxLinkRange, rawReceivePower=rawReceivePower, dataPortPauseFrames=dataPortPauseFrames, cableLoss=cableLoss, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, lowestDataModulationMode=lowestDataModulationMode, management=management, mainPSUPortStatusTrap=mainPSUPortStatusTrap, sNTPServerRetries=sNTPServerRetries, qOSPriorityScheme=qOSPriorityScheme, licenseUnitSerialNumber=licenseUnitSerialNumber, linkSymmetry=linkSymmetry, transmitFreqMHz=transmitFreqMHz, sNMPTrapTableIndex=sNMPTrapTableIndex, sFPError=sFPError, regulatoryBandTrap=regulatoryBandTrap, receiveModulationMode=receiveModulationMode, mainPSUPortQLRx=mainPSUPortQLRx, cableDiagPair1Distance=cableDiagPair1Distance, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, license=license, subbandLowestFrequency=subbandLowestFrequency, rawReceivePowerLinked=rawReceivePowerLinked, subnetMask=subnetMask, ptmp=ptmp, mABNominalModulationMode=mABNominalModulationMode, iPv6Address=iPv6Address, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, hCMPMaximumLinkRange=hCMPMaximumLinkRange, licenseTrialPeriod=licenseTrialPeriod, remoteInternetAddress=remoteInternetAddress, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, mainPSUPortSSMTx=mainPSUPortSSMTx, receiveChannel=receiveChannel, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, cableDiagPair4Distance=cableDiagPair4Distance, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, linkName=linkName, dataBridgingStatusAlarm=dataBridgingStatusAlarm, linkLoss=linkLoss, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, dNSServerInternetAddress=dNSServerInternetAddress, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, wirelessTopology=wirelessTopology, syslogClient=syslogClient, dNS=dNS, capacityVariantMismatch=capacityVariantMismatch, syslogControl=syslogControl, deviceMACAddress=deviceMACAddress, installStatusTrap=installStatusTrap, wirelessOutEthernetOctets=wirelessOutEthernetOctets, transmitModulationMode=transmitModulationMode, ethernetStatisticsTable=ethernetStatisticsTable, dataBridgingStatusLinked=dataBridgingStatusLinked, receiveModulationModeDetail=receiveModulationModeDetail, eIRP=eIRP, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, hTTPPortNumber=hTTPPortNumber, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, licenseGroupAccess=licenseGroupAccess, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, groupID=groupID, wirelessLinkStatusLinked=wirelessLinkStatusLinked, searchState=searchState, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, licenseInstancedTableEntry=licenseInstancedTableEntry, supplementaryGroup=supplementaryGroup, signalStrengthRatioLinked=signalStrengthRatioLinked, auxPortDisabledWarning=auxPortDisabledWarning, receiveModulationModeLinked=receiveModulationModeLinked, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, iPVersion=iPVersion, unitName=unitName, gatewayIPAddress=gatewayIPAddress, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, sNTPServerTimeout=sNTPServerTimeout, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, tDMChannelLineCode=tDMChannelLineCode, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, capacityVariantMismatchLinked=capacityVariantMismatchLinked, licenseGroup=licenseGroup, remoteInternetAddressLinked=remoteInternetAddressLinked, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tFTPServerPortNumber=tFTPServerPortNumber, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sMTPServerPortNumber=sMTPServerPortNumber, licenseBandwidthCap=licenseBandwidthCap, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, mainPSUPortStatus=mainPSUPortStatus, ptpGroups=ptpGroups, configurationInstancedTableEntry=configurationInstancedTableEntry, receiveFreqMHz=receiveFreqMHz, wirelessLinkAvailability=wirelessLinkAvailability, dNSServerPortNumber=dNSServerPortNumber, syncETracking=syncETracking, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, byteErrorRatioLinked=byteErrorRatioLinked, sFPPortQLTx=sFPPortQLTx, managementNetworkAccessEnabled=managementNetworkAccessEnabled, transmitModulationModeLinked=transmitModulationModeLinked, snmpControlGroup=snmpControlGroup, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, rangingMode=rangingMode, incompatibleRegulatoryBands=incompatibleRegulatoryBands, userTableIndex=userTableIndex, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, sNTPServerInternetAddressType=sNTPServerInternetAddressType, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, unavailableSeconds=unavailableSeconds, cableDiagPair1Results=cableDiagPair1Results, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, packetsToInternalStack=packetsToInternalStack, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, channelChangeTrap=channelChangeTrap, vectorErrorLinked=vectorErrorLinked, mABTransmissionInterval=mABTransmissionInterval, aAAControl=aAAControl, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, dfsTableIndex=dfsTableIndex, accessMethod=accessMethod, authorizationControlTableNumber=authorizationControlTableNumber, byteErrorRatio=byteErrorRatio, maxLinkRangeExceeded=maxLinkRangeExceeded, signalStrengthRatio=signalStrengthRatio, transmitPowerLinked=transmitPowerLinked, linkModeOptimizationMismatch=linkModeOptimizationMismatch, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, notificationsGroup=notificationsGroup, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, sNTPServerTableIndex=sNTPServerTableIndex, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, targetMACAddress=targetMACAddress, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, dfsTable=dfsTable, syslogLocalWrappedTrap=syslogLocalWrappedTrap, configurationInstancedTableIndex=configurationInstancedTableIndex, mainPSUPortAutoMdix=mainPSUPortAutoMdix, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, frequencyVariant=frequencyVariant, sNMPPortNumber=sNMPPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, bridgeGroup=bridgeGroup, smtp=smtp, tDDControl=tDDControl, licenseSecurityLevel=licenseSecurityLevel, latitude=latitude, ethernet=ethernet, tDMChannelStatus=tDMChannelStatus, phyControlInstancedTableEntry=phyControlInstancedTableEntry, receivePowerLinked=receivePowerLinked, userTable=userTable)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", dSCPManagementPriority=dSCPManagementPriority, cableDiagnosticsWarning=cableDiagnosticsWarning, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, tFTPClient=tFTPClient, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, sFPPortSSMTx=sFPPortSSMTx, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, resetGroup=resetGroup, tDMChannelCableLength=tDMChannelCableLength, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, dfsTableNumber=dfsTableNumber, pubInstancedStatsTable=pubInstancedStatsTable, cableDiagnosticsPorts=cableDiagnosticsPorts, sFPPortQLRx=sFPPortQLRx, hTTPSPortNumber=hTTPSPortNumber, mgmtInstancedTableNumber=mgmtInstancedTableNumber, syncETrackingState=syncETrackingState, receivePower=receivePower, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, telnetAccessEnabled=telnetAccessEnabled, sNTPServerPortNumber=sNTPServerPortNumber, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sFPPortAllocation=sFPPortAllocation, configuration=configuration, cableDiagnosticsGroup=cableDiagnosticsGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, tDDControlGroup=tDDControlGroup, syslogControlGroup=syslogControlGroup, mgmtInstancedTableEntry=mgmtInstancedTableEntry, mABState=mABState, ethernetInstancedTableNumber=ethernetInstancedTableNumber, sFPErrorTrap=sFPErrorTrap, userEnabled=userEnabled, phyControlGroup=phyControlGroup, hardwareVersion=hardwareVersion, sMTPServerInternetAddressType=sMTPServerInternetAddressType, txMABFrames=txMABFrames, mABHoldoffPeriod=mABHoldoffPeriod, cableDiagPair2Distance=cableDiagPair2Distance, linkModeOptimization=linkModeOptimization, tdmTable=tdmTable, tdmTableNumber=tdmTableNumber, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, maximumNumberOfSlaves=maximumNumberOfSlaves, auxPortAllocation=auxPortAllocation, portAllocationMismatchLinked=portAllocationMismatchLinked, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, hTTPAccessEnabled=hTTPAccessEnabled, longitude=longitude, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, ptp=ptp, dNSServerTableEntry=dNSServerTableEntry, sNMPTrapTable=sNMPTrapTable, sNTPState=sNTPState, dfsMeans=dfsMeans, siteName=siteName, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, installStatusLinked=installStatusLinked, range=range, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, ethernetStatisticsDataSource=ethernetStatisticsDataSource, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, tDDSynchronizationMode=tDDSynchronizationMode, noWirelessChannelAvailable=noWirelessChannelAvailable, sNTPPollInterval=sNTPPollInterval, cableDiagPair3Distance=cableDiagPair3Distance, apcGroup=apcGroup, dNSServerTable=dNSServerTable, mgmtInstancedTableIndex=mgmtInstancedTableIndex, cambium=cambium, authorizationControlTable=authorizationControlTable, unitOutOfCalibration=unitOutOfCalibration, vLANManagementPriority=vLANManagementPriority, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, extendedSpectrumScanning=extendedSpectrumScanning, severelyErroredSeconds=severelyErroredSeconds, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tFTPServerInternetAddressType=tFTPServerInternetAddressType, encryption=encryption, regulatoryBand=regulatoryBand, auxPortConfigurationMismatch=auxPortConfigurationMismatch, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ptpTraps=ptpTraps, syslogState=syslogState, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, rangeLinked=rangeLinked, authorizationControlGroup=authorizationControlGroup, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, licenseOOBManagementSupport=licenseOOBManagementSupport, tDMGroup=tDMGroup, sNTPLastSync=sNTPLastSync, transparentClockPort=transparentClockPort, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tDM=tDM, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, ptpCompliance=ptpCompliance, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, l2CPPriorityTable=l2CPPriorityTable, dNSServerTableIndex=dNSServerTableIndex, sNTPServerTableNumber=sNTPServerTableNumber, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, auxPortQLTx=auxPortQLTx, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, sNMPTrapTableEntry=sNMPTrapTableEntry, portAllocationMismatch=portAllocationMismatch, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, iPv6GatewayAddress=iPv6GatewayAddress, encryptionGroup=encryptionGroup, phyStatus=phyStatus, systemClock=systemClock, tempPcb=tempPcb, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, configurationGroup=configurationGroup, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, sFPPortDisabledWarning=sFPPortDisabledWarning, mainPSUPortAllocation=mainPSUPortAllocation, sNMPv3Enable=sNMPv3Enable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPCommunityString=sNMPCommunityString, altitude=altitude, hCMPLinkSymmetry=hCMPLinkSymmetry, subbandHighestFrequency=subbandHighestFrequency, snmpControl=snmpControl, mABProtocolVLANPriority=mABProtocolVLANPriority, unitIdentificationGroup=unitIdentificationGroup, transmitPower=transmitPower, enableTransmission=enableTransmission, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, lowestTDMModulationMode=lowestTDMModulationMode, dataPortWirelessDownAlert=dataPortWirelessDownAlert, phyStatusGroup=phyStatusGroup, ethernetPriorityTable=ethernetPriorityTable, softwareVersion=softwareVersion, alarmInstancedTable=alarmInstancedTable, phyControlInstancedTableIndex=phyControlInstancedTableIndex, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPServerStatus=sNTPServerStatus, unitIdentification=unitIdentification, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, licenseTDDSyncSupport=licenseTDDSyncSupport, tdmTableIndex=tdmTableIndex, PYSNMP_MODULE_ID=cambium, productName=productName, auxPortQLRx=auxPortQLRx, apc=apc, telnetPortNumber=telnetPortNumber, licenseIPv6Support=licenseIPv6Support, installationMode=installationMode, managementGroup=managementGroup, versionsGroup=versionsGroup, maximumTransmitPower=maximumTransmitPower, receiveFreqKHz=receiveFreqKHz, aggregateDataRateLinked=aggregateDataRateLinked, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, licenseIssueNumber=licenseIssueNumber, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, secureModeAlarmTrap=secureModeAlarmTrap, licenseHCMPSupport=licenseHCMPSupport, cableDiagnosticsResultTable=cableDiagnosticsResultTable, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, sMTPSourceEmailAddress=sMTPSourceEmailAddress, wirelessOutAllOctets=wirelessOutAllOctets, deviceESN=deviceESN, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, configurationInstancedTable=configurationInstancedTable, blacklistRMEnabled=blacklistRMEnabled, licenseInstancedTableNumber=licenseInstancedTableNumber, transmitDataRateLinked=transmitDataRateLinked, supplementary=supplementary, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, licenseRARSupport=licenseRARSupport, sNTPServerInternetAddress=sNTPServerInternetAddress, licenseSyncESupport=licenseSyncESupport, useVLANForManagementInterfaces=useVLANForManagementInterfaces, l2CPPriorityTableEntry=l2CPPriorityTableEntry, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, mPLSTCPriorityTable=mPLSTCPriorityTable, ethernetInstancedTable=ethernetInstancedTable, txColorCode=txColorCode, timeZone=timeZone, sNTPSyncTrap=sNTPSyncTrap, linkLossLinked=linkLossLinked, transparentClockVID=transparentClockVID, sFPPortStatusTrap=sFPPortStatusTrap, secondarySoftwareVersion=secondarySoftwareVersion, installArmState=installArmState, licenseGasGroup=licenseGasGroup, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sMTPEnabledMessages=sMTPEnabledMessages, userTableNumber=userTableNumber, aggregateDataRate=aggregateDataRate, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, licenseInstancedTable=licenseInstancedTable, transmitChannel=transmitChannel, vLANManagementVID=vLANManagementVID, portAllocationMismatchTrap=portAllocationMismatchTrap, antennaSelection=antennaSelection, whitelistRMMacAddress=whitelistRMMacAddress, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, installArmStateTrap=installArmStateTrap, tDMChannelLoopback=tDMChannelLoopback, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, nIDULanPortAutoMdix=nIDULanPortAutoMdix, authorizationControl=authorizationControl, sFPPortStatus=sFPPortStatus, dfsTableEntry=dfsTableEntry, targetRange=targetRange, sntp=sntp, userPassword=userPassword, remoteInternetAddressType=remoteInternetAddressType, sNTPServerTable=sNTPServerTable, cableDiagPair2Results=cableDiagPair2Results, phyControlInstancedTable=phyControlInstancedTable, dNSResolver=dNSResolver, smtpGroup=smtpGroup, oOBPriorityQueueMapping=oOBPriorityQueueMapping, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, mainPSUPortQLTx=mainPSUPortQLTx, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, authorizationControlTableEntry=authorizationControlTableEntry, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, secureModeAlarm=secureModeAlarm, authorizationControlTableIndex=authorizationControlTableIndex, licenseVersion=licenseVersion, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, transparentClock=transparentClock, l2CPPriorityTableNumber=l2CPPriorityTableNumber, auxPortAcceptedQLRx=auxPortAcceptedQLRx, ethernetPriorityTableIndex=ethernetPriorityTableIndex, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, dNSServerInternetAddressType=dNSServerInternetAddressType, syslogStateTrap=syslogStateTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, tDMEnabledChannels=tDMEnabledChannels, licenseInstancedTableIndex=licenseInstancedTableIndex, syslogClientTrap=syslogClientTrap, syncEEquipmentClock=syncEEquipmentClock, incompatibleMasterAndSlave=incompatibleMasterAndSlave, phyInstancedStatusTable=phyInstancedStatusTable, ethernetGroup=ethernetGroup, sNMPTrapVersion=sNMPTrapVersion, pubStatsGroup=pubStatsGroup, systemReset=systemReset, pubStats=pubStats)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, sFPPortAutoMdix=sFPPortAutoMdix, sFPPortAutoNegotiation=sFPPortAutoNegotiation, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, remoteMACAddressLinked=remoteMACAddressLinked, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, iPv6PrefixLength=iPv6PrefixLength, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, routerProtocols=routerProtocols, versions=versions, auxPortSyncERxStatus=auxPortSyncERxStatus, wirelessLinkStatus=wirelessLinkStatus, auxPortSSMTx=auxPortSSMTx, enabledDiagnosticAlarms=enabledDiagnosticAlarms, auxPortStatusTrap=auxPortStatusTrap, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, mABNominalTransmitCapacity=mABNominalTransmitCapacity, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, transmitFreqKHz=transmitFreqKHz, dfsGroup=dfsGroup, ethernetInstancedTableIndex=ethernetInstancedTableIndex, transparentClockVLAN=transparentClockVLAN, nIDULanPortStatusTrap=nIDULanPortStatusTrap, routerProtocolsGroup=routerProtocolsGroup, cableDiagnosticsControl=cableDiagnosticsControl, licenseSFPPortSupport=licenseSFPPortSupport, syncESlavePort=syncESlavePort, sMTPServerInternetAddress=sMTPServerInternetAddress, lbtDetectedTrap=lbtDetectedTrap, licenseEncryption=licenseEncryption, receiveDataRateLinked=receiveDataRateLinked, masterSlaveMode=masterSlaveMode, iPDSCPPriorityTable=iPDSCPPriorityTable, vectorError=vectorError, mgmtInstancedTable=mgmtInstancedTable, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, sntpGroup=sntpGroup, dNSPrimaryServer=dNSPrimaryServer, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, remoteUnitNameLinked=remoteUnitNameLinked, rxColorCode=rxColorCode, authorizationMethod=authorizationMethod, transmitterChannels=transmitterChannels, alarmsGroup=alarmsGroup, userRole=userRole, dataBridgingStatus=dataBridgingStatus, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, userTableEntry=userTableEntry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitDataRate=transmitDataRate, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, dataBridgingAvailability=dataBridgingAvailability, licenseCapacity=licenseCapacity, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, bridge=bridge, ptpTrapPrefix=ptpTrapPrefix, iPv4Address=iPv4Address)
