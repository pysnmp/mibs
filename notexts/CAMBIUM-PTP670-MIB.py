...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", cableDiagPair3Distance=cableDiagPair3Distance, linkLoss=linkLoss, iPDSCPPriorityTable=iPDSCPPriorityTable, smtp=smtp, syncESlavePort=syncESlavePort, searchState=searchState, whitelistRMEnabled=whitelistRMEnabled, erroredSeconds=erroredSeconds, userPassword=userPassword, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, receiveModulationModeDetail=receiveModulationModeDetail, cableDiagPair2Results=cableDiagPair2Results, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, configurationInstancedTable=configurationInstancedTable, phyControlInstancedTableIndex=phyControlInstancedTableIndex, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, sNMPEnabledTraps=sNMPEnabledTraps, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, sNMPPortNumber=sNMPPortNumber, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, notificationsGroup=notificationsGroup, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, authorizationControlTableIndex=authorizationControlTableIndex, sNTPPollInterval=sNTPPollInterval, sFPPortSyncERxStatus=sFPPortSyncERxStatus, sNTPLastSync=sNTPLastSync, siteName=siteName, licenseInstancedTable=licenseInstancedTable, mgmtInstancedTableEntry=mgmtInstancedTableEntry, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, auxPortSyncERxStatus=auxPortSyncERxStatus, ethernetPriorityTableEntry=ethernetPriorityTableEntry, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, cableDiagPair1Results=cableDiagPair1Results, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, softwareVersion=softwareVersion, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, configurationInstancedTableEntry=configurationInstancedTableEntry, unitIdentification=unitIdentification, remoteMaximumTransmitPower=remoteMaximumTransmitPower, encryption=encryption, oOBPriorityQueueMapping=oOBPriorityQueueMapping, management=management, sFPPortQLRx=sFPPortQLRx, transparentClockVID=transparentClockVID, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, licenseBandwidthCap=licenseBandwidthCap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, mABHoldoffPeriod=mABHoldoffPeriod, licenseGroup=licenseGroup, sFPPortStatusTrap=sFPPortStatusTrap, licenseRARSupport=licenseRARSupport, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, blacklistRMEnabled=blacklistRMEnabled, sFPPortAutoNegotiation=sFPPortAutoNegotiation, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, installArmState=installArmState, auxPortQLTx=auxPortQLTx, userName=userName, alarmInstancedTableIndex=alarmInstancedTableIndex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dNSServerInternetAddressType=dNSServerInternetAddressType, authorizationControlTableNumber=authorizationControlTableNumber, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, sNTPSync=sNTPSync, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, targetRange=targetRange, tFTPServerInternetAddress=tFTPServerInternetAddress, sNTPServerTableEntry=sNTPServerTableEntry, userEnabled=userEnabled, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, tDDSynchronizationStatus=tDDSynchronizationStatus, alarmInstancedTableNumber=alarmInstancedTableNumber, remoteUnitNameLinked=remoteUnitNameLinked, installationMode=installationMode, deviceMSN=deviceMSN, sMTPServerInternetAddress=sMTPServerInternetAddress, portAllocationMismatch=portAllocationMismatch, cableDiagPair3Results=cableDiagPair3Results, dNSResolver=dNSResolver, license=license, dNSServerInternetAddress=dNSServerInternetAddress, remoteUnitName=remoteUnitName, authorizationControlGroup=authorizationControlGroup, mABMaintenanceLevel=mABMaintenanceLevel, signalStrengthRatio=signalStrengthRatio, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, sNTPPrimaryServer=sNTPPrimaryServer, sMTPSourceEmailAddress=sMTPSourceEmailAddress, nIDULanPortAutoMdix=nIDULanPortAutoMdix, linkModeOptimization=linkModeOptimization, deviceMACAddress=deviceMACAddress, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, userRole=userRole, wirelessOutAllOctets=wirelessOutAllOctets, nIDULanPortStatus=nIDULanPortStatus, severelyErroredSeconds=severelyErroredSeconds, receiveModulationMode=receiveModulationMode, managementNetworkAccessEnabled=managementNetworkAccessEnabled, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, cableDiagnosticsControl=cableDiagnosticsControl, dfsTable=dfsTable, ethernetPriorityTableIndex=ethernetPriorityTableIndex, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, alarms=alarms, latitude=latitude, tDDSynchronizationMode=tDDSynchronizationMode, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ptpTrapPrefix=ptpTrapPrefix, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, sNTPServerPortNumber=sNTPServerPortNumber, cableDiagPair2Distance=cableDiagPair2Distance, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, resetGroup=resetGroup, cableDiagnostics=cableDiagnostics, userTableIndex=userTableIndex, sFPPortAllocation=sFPPortAllocation, targetMACAddress=targetMACAddress, sNTPServerTimeout=sNTPServerTimeout, phyStatus=phyStatus, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ethernetStatisticsTable=ethernetStatisticsTable, smtpGroup=smtpGroup, cableLoss=cableLoss, tDM=tDM, txMABFrames=txMABFrames, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, rangingMode=rangingMode, userTableNumber=userTableNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, phyControlGroup=phyControlGroup, remoteMACAddressLinked=remoteMACAddressLinked, ptp670=ptp670, subbandLowestFrequency=subbandLowestFrequency, packetsFromInternalStack=packetsFromInternalStack, mABState=mABState, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, cableDiagPair4Results=cableDiagPair4Results, tDMInterfaceStatus=tDMInterfaceStatus, configurationInstancedTableIndex=configurationInstancedTableIndex, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, byteErrorRatio=byteErrorRatio, altitude=altitude, channelBandwidth=channelBandwidth, tDMInterfaceControl=tDMInterfaceControl, lowestTDMModulationMode=lowestTDMModulationMode, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, vLANManagementVID=vLANManagementVID, sNTPServerTableNumber=sNTPServerTableNumber, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, installArmStateTrap=installArmStateTrap, gatewayIPAddress=gatewayIPAddress, rxColorCode=rxColorCode, snmpControl=snmpControl, tFTPServerPortNumber=tFTPServerPortNumber, configurationInstancedTableNumber=configurationInstancedTableNumber, licenseIssueNumber=licenseIssueNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, whitelistRMMacAddress=whitelistRMMacAddress, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, sNMPTrapPortNumber=sNMPTrapPortNumber, unavailableSeconds=unavailableSeconds, maxLinkRangeExceeded=maxLinkRangeExceeded, secureModeAlarmTrap=secureModeAlarmTrap, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, ethernetStatisticsDataSource=ethernetStatisticsDataSource, tDMChannelStatus=tDMChannelStatus, transparentClockVLAN=transparentClockVLAN, syslogLocalWrappedTrap=syslogLocalWrappedTrap, licenseCountry=licenseCountry, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, hTTPSPortNumber=hTTPSPortNumber, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, mainPSUPortQLTx=mainPSUPortQLTx, licenseVersion=licenseVersion, syslogClientTrap=syslogClientTrap, tDMChannelLineCode=tDMChannelLineCode, dNSServerTableIndex=dNSServerTableIndex, auxPortAllocation=auxPortAllocation, maximumNumberOfSlaves=maximumNumberOfSlaves, transmitPower=transmitPower, groupID=groupID, auxPortConfigurationMismatch=auxPortConfigurationMismatch, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, licenseOOBManagementSupport=licenseOOBManagementSupport, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, capacityVariantMismatchTrap=capacityVariantMismatchTrap, bootVersion=bootVersion, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, pubInstancedStatsTable=pubInstancedStatsTable, capacityVariantMismatchLinked=capacityVariantMismatchLinked, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, iPVersion=iPVersion, syncETracking=syncETracking, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, receiveFreqMHz=receiveFreqMHz, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, transmitterChannels=transmitterChannels, userTable=userTable, lbtDetectedTrap=lbtDetectedTrap, mgmtInstancedTable=mgmtInstancedTable, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, tDMChannelCableLength=tDMChannelCableLength, licenseSyncESupport=licenseSyncESupport, transmitChannel=transmitChannel, linkSymmetry=linkSymmetry, sFPErrorTrap=sFPErrorTrap, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, sMTPEmailAlert=sMTPEmailAlert, mainPSUPortAllocation=mainPSUPortAllocation, dfsTableIndex=dfsTableIndex, sNMPTrapVersion=sNMPTrapVersion, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, mgmtInstancedTableIndex=mgmtInstancedTableIndex, regulatoryBandTrap=regulatoryBandTrap, sFPPortQLTx=sFPPortQLTx, transmitModulationModeLinked=transmitModulationModeLinked, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, auxPortStatusTrap=auxPortStatusTrap, dfsTableEntry=dfsTableEntry, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, dfsTableNumber=dfsTableNumber, maximumTransmitPower=maximumTransmitPower, wirelessOutOctets=wirelessOutOctets, mainPSUPortQLRx=mainPSUPortQLRx, dNSServerPortNumber=dNSServerPortNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, cambium=cambium, alarmInstancedTableEntry=alarmInstancedTableEntry, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, licenseTDDSyncSupport=licenseTDDSyncSupport, receivePowerLinked=receivePowerLinked, telnetPortNumber=telnetPortNumber, sNTPServerTable=sNTPServerTable, dfsGroup=dfsGroup, remoteInternetAddress=remoteInternetAddress, pubStats=pubStats, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", licenseTrialPeriod=licenseTrialPeriod, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, transmitModulationMode=transmitModulationMode, sMTPEnabledMessages=sMTPEnabledMessages, licenseGasGroup=licenseGasGroup, receiveFreqKHz=receiveFreqKHz, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, aAAControl=aAAControl, syncETrackingState=syncETrackingState, channelChangeTrap=channelChangeTrap, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, unitOutOfCalibration=unitOutOfCalibration, linkName=linkName, sNTPServerTableIndex=sNTPServerTableIndex, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sntp=sntp, iPv6GatewayAddress=iPv6GatewayAddress, antennaSelection=antennaSelection, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, cableDiagnosticsPorts=cableDiagnosticsPorts, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, licenseUnitSerialNumber=licenseUnitSerialNumber, telnetAccessEnabled=telnetAccessEnabled, tempPcb=tempPcb, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, useVLANForMABProtocol=useVLANForMABProtocol, unitIdentificationGroup=unitIdentificationGroup, wirelessLinkStatusLinked=wirelessLinkStatusLinked, vLANManagementPriority=vLANManagementPriority, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, supplementary=supplementary, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, dataPortPauseFrames=dataPortPauseFrames, sNMPTrapTableEntry=sNMPTrapTableEntry, licenseIEEE1588Support=licenseIEEE1588Support, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, ethernetInstancedTableNumber=ethernetInstancedTableNumber, txColorCode=txColorCode, l2CPPriorityTableEntry=l2CPPriorityTableEntry, ptpGroups=ptpGroups, wirelessTopology=wirelessTopology, receiveDataRateLinked=receiveDataRateLinked, sMTPServerInternetAddressType=sMTPServerInternetAddressType, licenseTLSRekey=licenseTLSRekey, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, transmitFreqKHz=transmitFreqKHz, mPLSTCPriorityTable=mPLSTCPriorityTable, deviceESN=deviceESN, subbandHighestFrequency=subbandHighestFrequency, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, configurationGroup=configurationGroup, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, linkLossLinked=linkLossLinked, cableDiagPair4Distance=cableDiagPair4Distance, receivePower=receivePower, systemReset=systemReset, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, vectorError=vectorError, dNS=dNS, transparentClock=transparentClock, range=range, sFPPortAutoMdix=sFPPortAutoMdix, receiveDataRate=receiveDataRate, mABProtocolVID=mABProtocolVID, dNSServerTableEntry=dNSServerTableEntry, dfsMeans=dfsMeans, licenseIPv6Support=licenseIPv6Support, cableDiagnosticsResultTable=cableDiagnosticsResultTable, aggregateDataRate=aggregateDataRate, licenseSecurityLevel=licenseSecurityLevel, extendedSpectrumScanning=extendedSpectrumScanning, installStatusTrap=installStatusTrap, ethernet=ethernet, dNSServerTable=dNSServerTable, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, licenseInstancedTableNumber=licenseInstancedTableNumber, ptpTraps=ptpTraps, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, rawReceivePowerLinked=rawReceivePowerLinked, sNMPTrapTable=sNMPTrapTable, sNTPSyncTrap=sNTPSyncTrap, transmitPowerLinked=transmitPowerLinked, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dNSGroup=dNSGroup, transmitDataRateLinked=transmitDataRateLinked, cableDiagPair1Distance=cableDiagPair1Distance, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, antennaGain=antennaGain, iPv4Address=iPv4Address, auxPortSSMTx=auxPortSSMTx, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, cableDiagnosticsGroup=cableDiagnosticsGroup, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, managementPortWirelessDownAlert=managementPortWirelessDownAlert, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, nIDULanPortStatusTrap=nIDULanPortStatusTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, tdmTable=tdmTable, phyInstancedStatusTable=phyInstancedStatusTable, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, dNSPrimaryServer=dNSPrimaryServer, ethernetPriorityTable=ethernetPriorityTable, tFTPClient=tFTPClient, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, PYSNMP_MODULE_ID=cambium, ethernetInstancedTableEntry=ethernetInstancedTableEntry, aggregateDataRateLinked=aggregateDataRateLinked, l2CPPriorityTable=l2CPPriorityTable, portAllocationMismatchLinked=portAllocationMismatchLinked, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, transparentClockPort=transparentClockPort, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, unitName=unitName, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, routerProtocolsGroup=routerProtocolsGroup, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, sNTPServerRetries=sNTPServerRetries, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, wirelessOutEthernetOctets=wirelessOutEthernetOctets, phyStatusGroup=phyStatusGroup, authorizationMethod=authorizationMethod, syncEEquipmentClock=syncEEquipmentClock, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, sNTPState=sNTPState, supplementaryGroup=supplementaryGroup, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, dfs=dfs, auxPortDisabledWarning=auxPortDisabledWarning, daylightSaving=daylightSaving, ethernetGroup=ethernetGroup, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, productVariant=productVariant, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, packetsToInternalStack=packetsToInternalStack, dataBridgingStatusLinked=dataBridgingStatusLinked, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, versionsGroup=versionsGroup, remoteMACAddress=remoteMACAddress, licenseGroupAccess=licenseGroupAccess, mABProtocolVLANPriority=mABProtocolVLANPriority, cableDiagnosticsWarning=cableDiagnosticsWarning, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tDMChannelStatusTrap=tDMChannelStatusTrap, blacklistRMMacAddress=blacklistRMMacAddress, mainPSUPortSSMTx=mainPSUPortSSMTx, incompatibleRegulatoryBands=incompatibleRegulatoryBands, iPv6Address=iPv6Address, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, licenseMaxLinkRange=licenseMaxLinkRange, bridgeGroup=bridgeGroup, licenseInstancedTableIndex=licenseInstancedTableIndex, apcGroup=apcGroup, auxPortAcceptedQLRx=auxPortAcceptedQLRx, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, tdmTableEntry=tdmTableEntry, byteErrorRatioLinked=byteErrorRatioLinked, ptpCompliance=ptpCompliance, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, timeZone=timeZone, vectorErrorLinked=vectorErrorLinked, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, dataBridgingAvailability=dataBridgingAvailability, lowestDataModulationMode=lowestDataModulationMode, ethernetPriorityTableNumber=ethernetPriorityTableNumber, phyControlInstancedTableNumber=phyControlInstancedTableNumber, snmpControlGroup=snmpControlGroup, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, productName=productName, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, licenseSFPPortSupport=licenseSFPPortSupport, encryptionGroup=encryptionGroup, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, aAAControlGroup=aAAControlGroup, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, sMTPServerPortNumber=sMTPServerPortNumber, sNMPCommunityString=sNMPCommunityString, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sntpGroup=sntpGroup, licenseCapacity=licenseCapacity, l2CPPriorityTableIndex=l2CPPriorityTableIndex, mABTransmissionInterval=mABTransmissionInterval, iPv6PrefixLength=iPv6PrefixLength, rangeLinked=rangeLinked, mgmtInstancedTableNumber=mgmtInstancedTableNumber, enableTransmission=enableTransmission, systemClock=systemClock, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNMPTrapTableIndex=sNMPTrapTableIndex, hardwareVersion=hardwareVersion, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tdmTableNumber=tdmTableNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, alarmInstancedTable=alarmInstancedTable, hTTPSAccessEnabled=hTTPSAccessEnabled, signalStrengthRatioLinked=signalStrengthRatioLinked, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, tDMConfigurationMismatch=tDMConfigurationMismatch, tFTPServerInternetAddressType=tFTPServerInternetAddressType, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, licenseRegulatoryBandsList=licenseRegulatoryBandsList, tDMChannelLoopback=tDMChannelLoopback, secureModeAlarm=secureModeAlarm, sNMPv3Enable=sNMPv3Enable, auxPortStatus=auxPortStatus, sFPError=sFPError, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tDDControlGroup=tDDControlGroup, dataBridgingStatusAlarm=dataBridgingStatusAlarm, dSCPManagementPriority=dSCPManagementPriority, phyControlInstancedTableEntry=phyControlInstancedTableEntry, localPacketFiltering=localPacketFiltering, hCMPMaximumLinkRange=hCMPMaximumLinkRange, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, ethernetInstancedTableIndex=ethernetInstancedTableIndex, remoteInternetAddressLinked=remoteInternetAddressLinked, tDDControl=tDDControl, licenseEncryption=licenseEncryption, frequencyVariant=frequencyVariant, qOSPriorityScheme=qOSPriorityScheme, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, managementGroup=managementGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, authorizationControl=authorizationControl, mainPSUPortAutoMdix=mainPSUPortAutoMdix, dataPortWirelessDownAlert=dataPortWirelessDownAlert, pubStatsGroup=pubStatsGroup, wirelessLinkStatus=wirelessLinkStatus, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, dataBridgingStatus=dataBridgingStatus, searchStateLinked=searchStateLinked, userTableEntry=userTableEntry, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, ptp=ptp, authorizationControlTable=authorizationControlTable, sFPPortDisabledWarning=sFPPortDisabledWarning, configuration=configuration, capacityVariantMismatch=capacityVariantMismatch, noWirelessChannelAvailable=noWirelessChannelAvailable, syslogStateTrap=syslogStateTrap, mABNominalTransmitCapacity=mABNominalTransmitCapacity)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", authorizationControlTableEntry=authorizationControlTableEntry, phyControl=phyControl, regulatoryBand=regulatoryBand, wirelessLinkAvailability=wirelessLinkAvailability, enabledDiagnosticAlarms=enabledDiagnosticAlarms, reset=reset, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, installStatusLinked=installStatusLinked, sNTPServerStatus=sNTPServerStatus, transmitDataRate=transmitDataRate, masterSlaveMode=masterSlaveMode, encryptionAlgorithm=encryptionAlgorithm, receiveModulationModeLinked=receiveModulationModeLinked, routerProtocols=routerProtocols, dfsPeaks=dfsPeaks, sFPPortSSMTx=sFPPortSSMTx, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, rawReceivePower=rawReceivePower, secondarySoftwareVersion=secondarySoftwareVersion, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, syslogClient=syslogClient, phyControlInstancedTable=phyControlInstancedTable, tDMGroup=tDMGroup, portAllocationMismatchTrap=portAllocationMismatchTrap, hTTPAccessEnabled=hTTPAccessEnabled, versions=versions, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, tdmTableIndex=tdmTableIndex, ethernetInstancedTable=ethernetInstancedTable, licenseHCMPSupport=licenseHCMPSupport, apc=apc, auxPortQLRx=auxPortQLRx, ptmp=ptmp, hTTPPortNumber=hTTPPortNumber, mainPSUPortStatus=mainPSUPortStatus, syslogControlGroup=syslogControlGroup, sFPPortStatus=sFPPortStatus, receiveChannel=receiveChannel, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, syslogState=syslogState, tDMEnabledChannels=tDMEnabledChannels, accessMethod=accessMethod, mainPSUPortStatusTrap=mainPSUPortStatusTrap, dNSServerTableNumber=dNSServerTableNumber, mABNominalModulationMode=mABNominalModulationMode, subnetMask=subnetMask, installStatus=installStatus, syslogControl=syslogControl, longitude=longitude, hCMPLinkSymmetry=hCMPLinkSymmetry, sNTPServerInternetAddress=sNTPServerInternetAddress, transmitFreqMHz=transmitFreqMHz, remoteInternetAddressType=remoteInternetAddressType, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, eIRP=eIRP, alarmsGroup=alarmsGroup, licenseInstancedTableEntry=licenseInstancedTableEntry, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, bridge=bridge)
