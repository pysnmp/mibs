...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", licenseEncryption=licenseEncryption, aggregateDataRate=aggregateDataRate, sNMPEnabledTraps=sNMPEnabledTraps, gatewayIPAddress=gatewayIPAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, linkName=linkName, channelChangeTrap=channelChangeTrap, ethernetInstancedTableEntry=ethernetInstancedTableEntry, dfsTableNumber=dfsTableNumber, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, qOSPriorityScheme=qOSPriorityScheme, nIDULanPortStatus=nIDULanPortStatus, wirelessOutEthernetOctets=wirelessOutEthernetOctets, versions=versions, userTableNumber=userTableNumber, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, tDMChannelStatus=tDMChannelStatus, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, groupID=groupID, antennaSelection=antennaSelection, capacityVariantMismatchLinked=capacityVariantMismatchLinked, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, PYSNMP_MODULE_ID=cambium, authorizationMethod=authorizationMethod, licenseTDDSyncSupport=licenseTDDSyncSupport, unitIdentificationGroup=unitIdentificationGroup, transparentClockVLAN=transparentClockVLAN, supplementary=supplementary, accessMethod=accessMethod, licenseInstancedTableNumber=licenseInstancedTableNumber, configurationInstancedTableEntry=configurationInstancedTableEntry, transmitPower=transmitPower, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sFPPortQLTx=sFPPortQLTx, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, dfs=dfs, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, hTTPSPortNumber=hTTPSPortNumber, wirelessOutOctets=wirelessOutOctets, routerProtocols=routerProtocols, phyControlInstancedTableNumber=phyControlInstancedTableNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, cableDiagnostics=cableDiagnostics, remoteUnitName=remoteUnitName, hTTPAccessEnabled=hTTPAccessEnabled, linkLossLinked=linkLossLinked, mABNominalTransmitCapacity=mABNominalTransmitCapacity, cableDiagPair3Results=cableDiagPair3Results, hCMPMaximumLinkRange=hCMPMaximumLinkRange, ptp670=ptp670, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNMPTrapTableEntry=sNMPTrapTableEntry, tDMGroup=tDMGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sMTPEmailAlert=sMTPEmailAlert, antennaGain=antennaGain, localPacketFiltering=localPacketFiltering, installArmState=installArmState, capacityVariantMismatch=capacityVariantMismatch, receiveChannel=receiveChannel, notificationsGroup=notificationsGroup, wirelessLinkStatusLinked=wirelessLinkStatusLinked, sNTPState=sNTPState, licenseTLSRekey=licenseTLSRekey, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, mABMaintenanceLevel=mABMaintenanceLevel, mABProtocolVLANPriority=mABProtocolVLANPriority, targetMACAddress=targetMACAddress, apcGroup=apcGroup, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, sNMPTrapTableIndex=sNMPTrapTableIndex, cableDiagnosticsGroup=cableDiagnosticsGroup, receivePower=receivePower, l2CPPriorityTable=l2CPPriorityTable, wirelessTopology=wirelessTopology, iPVersion=iPVersion, encryption=encryption, mainPSUPortAllocation=mainPSUPortAllocation, pubStatsGroup=pubStatsGroup, licenseBandwidthCap=licenseBandwidthCap, snmpControl=snmpControl, iPv6GatewayAddress=iPv6GatewayAddress, licenseInstancedTableEntry=licenseInstancedTableEntry, iPv6PrefixLength=iPv6PrefixLength, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, dfsTableEntry=dfsTableEntry, sNTPPrimaryServer=sNTPPrimaryServer, transparentClockPort=transparentClockPort, unavailableSeconds=unavailableSeconds, ptpTraps=ptpTraps, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, lowestTDMModulationMode=lowestTDMModulationMode, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, phyControlInstancedTable=phyControlInstancedTable, dfsGroup=dfsGroup, cableDiagPair2Results=cableDiagPair2Results, cableDiagPair2Distance=cableDiagPair2Distance, mgmtInstancedTable=mgmtInstancedTable, receivePowerLinked=receivePowerLinked, timeZone=timeZone, mainPSUPortAutoMdix=mainPSUPortAutoMdix, unitIdentification=unitIdentification, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, mgmtInstancedTableNumber=mgmtInstancedTableNumber, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, enableTransmission=enableTransmission, auxPortSyncERxStatus=auxPortSyncERxStatus, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, erroredSeconds=erroredSeconds, channelBandwidth=channelBandwidth, dataPortWirelessDownAlert=dataPortWirelessDownAlert, license=license, sNTPServerTableEntry=sNTPServerTableEntry, installationMode=installationMode, sNTPLastSync=sNTPLastSync, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, regulatoryBandTrap=regulatoryBandTrap, daylightSaving=daylightSaving, aAAControl=aAAControl, tDMInterfaceStatus=tDMInterfaceStatus, dNS=dNS, syslogControlGroup=syslogControlGroup, supplementaryGroup=supplementaryGroup, tempPcb=tempPcb, configuration=configuration, secondarySoftwareVersion=secondarySoftwareVersion, apc=apc, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, wirelessOutAllOctets=wirelessOutAllOctets, licenseIPv6Support=licenseIPv6Support, deviceMSN=deviceMSN, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, tFTPServerPortNumber=tFTPServerPortNumber, tdmTableNumber=tdmTableNumber, userTable=userTable, sNMPv3Enable=sNMPv3Enable, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, dNSServerPortNumber=dNSServerPortNumber, sNMPPortNumber=sNMPPortNumber, licenseSFPPortSupport=licenseSFPPortSupport, sFPPortQLRx=sFPPortQLRx, packetsFromInternalStack=packetsFromInternalStack, phyControlInstancedTableEntry=phyControlInstancedTableEntry, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, vLANManagementPriority=vLANManagementPriority, aAAControlGroup=aAAControlGroup, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, mainPSUPortSSMTx=mainPSUPortSSMTx, sNMPTrapPortNumber=sNMPTrapPortNumber, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, phyControl=phyControl, linkSymmetry=linkSymmetry, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, transmitModulationMode=transmitModulationMode, sFPPortAutoNegotiation=sFPPortAutoNegotiation, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, receiveDataRateLinked=receiveDataRateLinked, ethernetInstancedTable=ethernetInstancedTable, mainPSUPortQLTx=mainPSUPortQLTx, auxPortQLRx=auxPortQLRx, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, authorizationControlTable=authorizationControlTable, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, cableDiagPair1Results=cableDiagPair1Results, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, byteErrorRatio=byteErrorRatio, cableDiagPair3Distance=cableDiagPair3Distance, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, softwareVersion=softwareVersion, transparentClock=transparentClock, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, ethernetPriorityTableIndex=ethernetPriorityTableIndex, syncESlavePort=syncESlavePort, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, sFPPortAllocation=sFPPortAllocation, sNMPCommunityString=sNMPCommunityString, installStatusLinked=installStatusLinked, whitelistRMMacAddress=whitelistRMMacAddress, installArmStateTrap=installArmStateTrap, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, configurationInstancedTableIndex=configurationInstancedTableIndex, pubStats=pubStats, licenseIEEE1588Support=licenseIEEE1588Support, dataBridgingStatusAlarm=dataBridgingStatusAlarm, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, searchStateLinked=searchStateLinked, licenseTrialPeriod=licenseTrialPeriod, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, cableLoss=cableLoss, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, smtpGroup=smtpGroup, rawReceivePowerLinked=rawReceivePowerLinked, mABNominalModulationMode=mABNominalModulationMode, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, sMTPServerInternetAddress=sMTPServerInternetAddress, ethernetGroup=ethernetGroup, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, sNMPTrapVersion=sNMPTrapVersion, sNTPServerPortNumber=sNTPServerPortNumber, installStatusTrap=installStatusTrap, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, hCMPLinkSymmetry=hCMPLinkSymmetry, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, sFPPortSyncERxStatus=sFPPortSyncERxStatus, maximumTransmitPower=maximumTransmitPower, oOBPriorityQueueMapping=oOBPriorityQueueMapping, dSCPManagementPriority=dSCPManagementPriority, authorizationControlTableEntry=authorizationControlTableEntry, encryptionAlgorithm=encryptionAlgorithm, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, iPv4Address=iPv4Address, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, alarmInstancedTableIndex=alarmInstancedTableIndex, altitude=altitude, sntp=sntp, portAllocationMismatch=portAllocationMismatch, auxPortConfigurationMismatch=auxPortConfigurationMismatch, tDMInterfaceControl=tDMInterfaceControl, cableDiagnosticsControl=cableDiagnosticsControl, userName=userName, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, systemReset=systemReset, pubInstancedStatsTable=pubInstancedStatsTable, phyStatus=phyStatus, authorizationControl=authorizationControl, licenseCapacity=licenseCapacity, subbandLowestFrequency=subbandLowestFrequency, receiveFreqMHz=receiveFreqMHz, phyControlGroup=phyControlGroup, transparentClockVID=transparentClockVID, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, remoteInternetAddressType=remoteInternetAddressType, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, syslogControl=syslogControl, remoteUnitNameLinked=remoteUnitNameLinked, ethernetInstancedTableNumber=ethernetInstancedTableNumber, sNTPServerTable=sNTPServerTable, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, sNTPServerRetries=sNTPServerRetries, authorizationControlTableNumber=authorizationControlTableNumber, tDDSynchronizationMode=tDDSynchronizationMode, tdmTable=tdmTable, mainPSUPortStatus=mainPSUPortStatus, licenseGasGroup=licenseGasGroup, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sMTPEnabledMessages=sMTPEnabledMessages, subbandHighestFrequency=subbandHighestFrequency, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, installStatus=installStatus, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tDMChannelCableLength=tDMChannelCableLength, tdmTableEntry=tdmTableEntry, capacityVariantMismatchTrap=capacityVariantMismatchTrap, tDMChannelLineCode=tDMChannelLineCode, cableDiagnosticsWarning=cableDiagnosticsWarning, dNSPrimaryServer=dNSPrimaryServer, dNSServerTableNumber=dNSServerTableNumber, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, productName=productName, managementPortWirelessDownAlert=managementPortWirelessDownAlert, extendedSpectrumScanning=extendedSpectrumScanning, dfsTableIndex=dfsTableIndex, sFPPortStatusTrap=sFPPortStatusTrap, signalStrengthRatio=signalStrengthRatio, phyStatusGroup=phyStatusGroup, subnetMask=subnetMask, sFPPortStatus=sFPPortStatus, dNSServerTableIndex=dNSServerTableIndex, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, rangingMode=rangingMode, lowestDataModulationMode=lowestDataModulationMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tdmTableIndex=tdmTableIndex, iPv6Address=iPv6Address, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, ethernetStatisticsDataSource=ethernetStatisticsDataSource, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, wirelessLinkStatus=wirelessLinkStatus, rawReceivePower=rawReceivePower, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, configurationGroup=configurationGroup, licenseSecurityLevel=licenseSecurityLevel, aggregateDataRateLinked=aggregateDataRateLinked, txColorCode=txColorCode, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, latitude=latitude, licenseVersion=licenseVersion, cableDiagnosticsResultTable=cableDiagnosticsResultTable, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, unitOutOfCalibration=unitOutOfCalibration, sFPPortAutoMdix=sFPPortAutoMdix, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, hTTPSAccessEnabled=hTTPSAccessEnabled, wirelessLinkAvailability=wirelessLinkAvailability, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, transmitterChannels=transmitterChannels, mgmtInstancedTableIndex=mgmtInstancedTableIndex, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ptpTrapPrefix=ptpTrapPrefix, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, mgmtInstancedTableEntry=mgmtInstancedTableEntry, licenseRegulatoryBandsList=licenseRegulatoryBandsList, sNMPTrapTableNumber=sNMPTrapTableNumber, phyControlInstancedTableIndex=phyControlInstancedTableIndex, productVariant=productVariant, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, syslogClient=syslogClient, ptp=ptp, tDDControl=tDDControl, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, sFPErrorTrap=sFPErrorTrap, managementNetworkAccessEnabled=managementNetworkAccessEnabled, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, syslogStateTrap=syslogStateTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, mainPSUPortStatusTrap=mainPSUPortStatusTrap, snmpControlGroup=snmpControlGroup, sFPPortDisabledWarning=sFPPortDisabledWarning, l2CPPriorityTableNumber=l2CPPriorityTableNumber, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, transmitDataRateLinked=transmitDataRateLinked, nIDULanPortAutoMdix=nIDULanPortAutoMdix, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, versionsGroup=versionsGroup, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, remoteMACAddressLinked=remoteMACAddressLinked, noWirelessChannelAvailable=noWirelessChannelAvailable, licenseInstancedTable=licenseInstancedTable, frequencyVariant=frequencyVariant, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, vLANManagementVID=vLANManagementVID, mPLSTCPriorityTable=mPLSTCPriorityTable, txMABFrames=txMABFrames, alarmInstancedTableEntry=alarmInstancedTableEntry, regulatoryBand=regulatoryBand, sNTPSync=sNTPSync, rxColorCode=rxColorCode, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, auxPortStatus=auxPortStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, syncETracking=syncETracking, receiveFreqKHz=receiveFreqKHz, tDMConfigurationMismatch=tDMConfigurationMismatch, mainPSUPortQLRx=mainPSUPortQLRx, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, syslogState=syslogState, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, dNSResolver=dNSResolver, auxPortStatusTrap=auxPortStatusTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, management=management, transmitModulationModeLinked=transmitModulationModeLinked, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, tDM=tDM, ptpGroups=ptpGroups, tFTPClient=tFTPClient, linkModeOptimizationMismatch=linkModeOptimizationMismatch, packetsToInternalStack=packetsToInternalStack, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, lbtDetectedTrap=lbtDetectedTrap, licenseMaxLinkRange=licenseMaxLinkRange, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, cableDiagPair4Results=cableDiagPair4Results, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, reset=reset, sNTPServerInternetAddress=sNTPServerInternetAddress, receiveDataRate=receiveDataRate, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tDMChannelStatusTrap=tDMChannelStatusTrap, sNTPServerStatus=sNTPServerStatus, ptpCompliance=ptpCompliance, mABProtocolVID=mABProtocolVID, vectorErrorLinked=vectorErrorLinked, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, userTableEntry=userTableEntry, signalStrengthRatioLinked=signalStrengthRatioLinked, hTTPPortNumber=hTTPPortNumber, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, sNTPSyncTrap=sNTPSyncTrap, syncEEquipmentClock=syncEEquipmentClock, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, ethernetPriorityTable=ethernetPriorityTable, dataBridgingAvailability=dataBridgingAvailability, tFTPServerInternetAddress=tFTPServerInternetAddress, cableDiagnosticsPorts=cableDiagnosticsPorts, dataBridgingStatusLinked=dataBridgingStatusLinked, linkLoss=linkLoss, userTableIndex=userTableIndex, remoteInternetAddressLinked=remoteInternetAddressLinked, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, dataPortPauseFrames=dataPortPauseFrames, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, licenseUnitSerialNumber=licenseUnitSerialNumber, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, systemClock=systemClock, licenseGroup=licenseGroup, linkModeOptimization=linkModeOptimization, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, ptmp=ptmp, sFPError=sFPError, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, severelyErroredSeconds=severelyErroredSeconds, syslogLocalWrappedTrap=syslogLocalWrappedTrap, incompatibleRegulatoryBands=incompatibleRegulatoryBands, userEnabled=userEnabled, transmitFreqMHz=transmitFreqMHz, ethernetStatisticsTable=ethernetStatisticsTable, targetRange=targetRange, telnetAccessEnabled=telnetAccessEnabled, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, dNSServerInternetAddress=dNSServerInternetAddress, tDDControlGroup=tDDControlGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, maxLinkRangeExceeded=maxLinkRangeExceeded, auxPortDisabledWarning=auxPortDisabledWarning, dNSGroup=dNSGroup, sNMPTrapTable=sNMPTrapTable, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPServerTableIndex=sNTPServerTableIndex, licenseGroupAccess=licenseGroupAccess, dNSServerTableEntry=dNSServerTableEntry, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, deviceMACAddress=deviceMACAddress, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, blacklistRMEnabled=blacklistRMEnabled, portAllocationMismatchLinked=portAllocationMismatchLinked, alarmInstancedTableNumber=alarmInstancedTableNumber, unitName=unitName, alarmInstancedTable=alarmInstancedTable, ethernetInstancedTableIndex=ethernetInstancedTableIndex, nIDULanPortStatusTrap=nIDULanPortStatusTrap, remoteMACAddress=remoteMACAddress, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, ethernet=ethernet, rangeLinked=rangeLinked, auxPortAcceptedQLRx=auxPortAcceptedQLRx, sFPPortSSMTx=sFPPortSSMTx, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, dfsPeaks=dfsPeaks, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, auxPortAllocation=auxPortAllocation, sMTPServerPortNumber=sMTPServerPortNumber, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, tDDSynchronizationAlarm=tDDSynchronizationAlarm, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, mABHoldoffPeriod=mABHoldoffPeriod, sMTPServerInternetAddressType=sMTPServerInternetAddressType, smtp=smtp, resetGroup=resetGroup, siteName=siteName, portAllocationMismatchTrap=portAllocationMismatchTrap, receiveModulationModeDetail=receiveModulationModeDetail, userRole=userRole, configurationInstancedTableNumber=configurationInstancedTableNumber, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, hardwareVersion=hardwareVersion, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, range=range, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, cableDiagPair4Distance=cableDiagPair4Distance, alarmsGroup=alarmsGroup, licenseRARSupport=licenseRARSupport, transmitChannel=transmitChannel, userPassword=userPassword, cableDiagPair1Distance=cableDiagPair1Distance, sNTPServerTimeout=sNTPServerTimeout, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, dataBridgingStatus=dataBridgingStatus, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, telnetPortNumber=telnetPortNumber, authorizationControlTableIndex=authorizationControlTableIndex, cambium=cambium, alarms=alarms, syslogClientTrap=syslogClientTrap, transmitPowerLinked=transmitPowerLinked)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", ethernetPriorityTableEntry=ethernetPriorityTableEntry, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, dNSServerTable=dNSServerTable, blacklistRMMacAddress=blacklistRMMacAddress, vectorError=vectorError, configurationInstancedTable=configurationInstancedTable, licenseInstancedTableIndex=licenseInstancedTableIndex, eIRP=eIRP, secureModeAlarmTrap=secureModeAlarmTrap, auxPortQLTx=auxPortQLTx, dfsMeans=dfsMeans, maximumNumberOfSlaves=maximumNumberOfSlaves, ethernetPriorityTableNumber=ethernetPriorityTableNumber, transmitFreqKHz=transmitFreqKHz, tDMChannelLoopback=tDMChannelLoopback, auxPortSSMTx=auxPortSSMTx, sNTPServerTableNumber=sNTPServerTableNumber, licenseOOBManagementSupport=licenseOOBManagementSupport, dNSServerInternetAddressType=dNSServerInternetAddressType, useVLANForMABProtocol=useVLANForMABProtocol, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, transmitDataRate=transmitDataRate, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, mABState=mABState, l2CPPriorityTableIndex=l2CPPriorityTableIndex, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, dfsTable=dfsTable, mABTransmissionInterval=mABTransmissionInterval, byteErrorRatioLinked=byteErrorRatioLinked, licenseHCMPSupport=licenseHCMPSupport, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, longitude=longitude, tFTPServerInternetAddressType=tFTPServerInternetAddressType, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, secureModeAlarm=secureModeAlarm, encryptionGroup=encryptionGroup, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, bootVersion=bootVersion, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, managementGroup=managementGroup, routerProtocolsGroup=routerProtocolsGroup, sntpGroup=sntpGroup, bridgeGroup=bridgeGroup, authorizationControlGroup=authorizationControlGroup, tDMEnabledChannels=tDMEnabledChannels, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, whitelistRMEnabled=whitelistRMEnabled, deviceESN=deviceESN, bridge=bridge, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, sNTPPollInterval=sNTPPollInterval, receiveModulationModeLinked=receiveModulationModeLinked, phyInstancedStatusTable=phyInstancedStatusTable, licenseIssueNumber=licenseIssueNumber, licenseCountry=licenseCountry, searchState=searchState, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, masterSlaveMode=masterSlaveMode, remoteInternetAddress=remoteInternetAddress, receiveModulationMode=receiveModulationMode, licenseSyncESupport=licenseSyncESupport, syncETrackingState=syncETrackingState)
