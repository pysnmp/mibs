...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", extendedSpectrumScanning=extendedSpectrumScanning, tempPcb=tempPcb, syslogState=syslogState, sFPPortStatus=sFPPortStatus, bootVersion=bootVersion, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, mABTransmissionInterval=mABTransmissionInterval, dfsTableIndex=dfsTableIndex, deviceMSN=deviceMSN, alarmInstancedTableEntry=alarmInstancedTableEntry, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, severelyErroredSeconds=severelyErroredSeconds, receiveChannel=receiveChannel, receivePowerLinked=receivePowerLinked, tDMChannelStatusTrap=tDMChannelStatusTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, tDM=tDM, signalStrengthRatioLinked=signalStrengthRatioLinked, longitude=longitude, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, sNMPTrapTableEntry=sNMPTrapTableEntry, sntp=sntp, cableDiagnosticsResultTable=cableDiagnosticsResultTable, userEnabled=userEnabled, sntpGroup=sntpGroup, pubStatsGroup=pubStatsGroup, phyInstancedStatusTable=phyInstancedStatusTable, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, apcGroup=apcGroup, aggregateDataRate=aggregateDataRate, sFPPortSyncERxStatus=sFPPortSyncERxStatus, receiveDataRateLinked=receiveDataRateLinked, sNMPTrapVersion=sNMPTrapVersion, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, sNMPTrapPortNumber=sNMPTrapPortNumber, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, auxPortQLTx=auxPortQLTx, auxPortDisabledWarning=auxPortDisabledWarning, sNTPPrimaryServer=sNTPPrimaryServer, sMTPServerInternetAddressType=sMTPServerInternetAddressType, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, management=management, sFPPortAutoMdix=sFPPortAutoMdix, linkLossLinked=linkLossLinked, sNTPSync=sNTPSync, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, aAAControlGroup=aAAControlGroup, cambium=cambium, portAllocationMismatchTrap=portAllocationMismatchTrap, hardwareVersion=hardwareVersion, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, tFTPClient=tFTPClient, l2CPPriorityTableEntry=l2CPPriorityTableEntry, portAllocationMismatch=portAllocationMismatch, licenseInstancedTableIndex=licenseInstancedTableIndex, receiveDataRate=receiveDataRate, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, iPv6Address=iPv6Address, ethernetPriorityTable=ethernetPriorityTable, receivePower=receivePower, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, snmpControl=snmpControl, sMTPEmailAlert=sMTPEmailAlert, auxPortStatus=auxPortStatus, maximumTransmitPower=maximumTransmitPower, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, unitName=unitName, mABState=mABState, latitude=latitude, dataBridgingAvailability=dataBridgingAvailability, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, configurationInstancedTableEntry=configurationInstancedTableEntry, cableDiagPair3Results=cableDiagPair3Results, reset=reset, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, license=license, tDMGroup=tDMGroup, licenseGasGroup=licenseGasGroup, hTTPSPortNumber=hTTPSPortNumber, oOBPriorityQueueMapping=oOBPriorityQueueMapping, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ptpTraps=ptpTraps, ethernetPriorityTableIndex=ethernetPriorityTableIndex, cableDiagPair2Results=cableDiagPair2Results, subnetMask=subnetMask, phyControlInstancedTableNumber=phyControlInstancedTableNumber, syncETracking=syncETracking, sFPPortQLRx=sFPPortQLRx, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, pubInstancedStatsTable=pubInstancedStatsTable, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, mainPSUPortAutoMdix=mainPSUPortAutoMdix, vLANManagementPriority=vLANManagementPriority, sNTPLastSync=sNTPLastSync, userTableEntry=userTableEntry, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, bridge=bridge, phyControlInstancedTableEntry=phyControlInstancedTableEntry, lbtDetectedTrap=lbtDetectedTrap, ptpCompliance=ptpCompliance, vectorError=vectorError, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, signalStrengthRatio=signalStrengthRatio, remoteUnitNameLinked=remoteUnitNameLinked, ptpGroups=ptpGroups, phyControlInstancedTableIndex=phyControlInstancedTableIndex, wirelessOutOctets=wirelessOutOctets, blacklistRMEnabled=blacklistRMEnabled, dNSServerInternetAddressType=dNSServerInternetAddressType, licenseIPv6Support=licenseIPv6Support, l2CPPriorityTableNumber=l2CPPriorityTableNumber, transmitModulationModeLinked=transmitModulationModeLinked, ptmp=ptmp, unitIdentification=unitIdentification, transmitDataRateLinked=transmitDataRateLinked, tDMChannelLineCode=tDMChannelLineCode, timeZone=timeZone, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, deviceESN=deviceESN, phyStatusGroup=phyStatusGroup, licenseSyncESupport=licenseSyncESupport, notificationsGroup=notificationsGroup, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, licenseTDDSyncSupport=licenseTDDSyncSupport, licenseGroup=licenseGroup, tDMChannelStatus=tDMChannelStatus, installArmStateTrap=installArmStateTrap, auxPortAcceptedQLRx=auxPortAcceptedQLRx, mainPSUPortStatusTrap=mainPSUPortStatusTrap, dfsGroup=dfsGroup, sNMPPortNumber=sNMPPortNumber, ethernetGroup=ethernetGroup, sFPPortStatusTrap=sFPPortStatusTrap, nIDULanPortStatusTrap=nIDULanPortStatusTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, versionsGroup=versionsGroup, masterSlaveMode=masterSlaveMode, dNSServerTableNumber=dNSServerTableNumber, sFPPortQLTx=sFPPortQLTx, daylightSaving=daylightSaving, auxPortConfigurationMismatch=auxPortConfigurationMismatch, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, nIDULanPortAutoMdix=nIDULanPortAutoMdix, groupID=groupID, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, licenseTrialPeriod=licenseTrialPeriod, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, lowestTDMModulationMode=lowestTDMModulationMode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, licenseMaxLinkRange=licenseMaxLinkRange, accessMethod=accessMethod, whitelistRMMacAddress=whitelistRMMacAddress, sMTPServerPortNumber=sMTPServerPortNumber, unitIdentificationGroup=unitIdentificationGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, tDMChannelCableLength=tDMChannelCableLength, sNTPServerStatus=sNTPServerStatus, cableDiagPair4Distance=cableDiagPair4Distance, packetsFromInternalStack=packetsFromInternalStack, alarms=alarms, linkSymmetry=linkSymmetry, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, installationMode=installationMode, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, configurationGroup=configurationGroup, systemClock=systemClock, telnetPortNumber=telnetPortNumber, cableDiagPair1Distance=cableDiagPair1Distance, installStatusTrap=installStatusTrap, dNSServerTableIndex=dNSServerTableIndex, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, productName=productName, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, qOSPriorityScheme=qOSPriorityScheme, linkModeOptimizationMismatch=linkModeOptimizationMismatch, auxPortQLRx=auxPortQLRx, smtp=smtp, range=range, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, licenseRARSupport=licenseRARSupport, ethernet=ethernet, dNS=dNS, cableDiagPair3Distance=cableDiagPair3Distance, mABProtocolVLANPriority=mABProtocolVLANPriority, receiveModulationModeDetail=receiveModulationModeDetail, capacityVariantMismatch=capacityVariantMismatch, receiveFreqMHz=receiveFreqMHz, dfsTable=dfsTable, alarmInstancedTable=alarmInstancedTable, wirelessTopology=wirelessTopology, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, authorizationControlTableIndex=authorizationControlTableIndex, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, tdmTableIndex=tdmTableIndex, syncESlavePort=syncESlavePort, rxColorCode=rxColorCode, tdmTableEntry=tdmTableEntry, nIDULanPortStatus=nIDULanPortStatus, channelChangeTrap=channelChangeTrap, transmitPower=transmitPower, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tDDControl=tDDControl, hCMPMaximumLinkRange=hCMPMaximumLinkRange, dataPortPauseFrames=dataPortPauseFrames, dNSServerPortNumber=dNSServerPortNumber, dfs=dfs, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, antennaSelection=antennaSelection, linkModeOptimization=linkModeOptimization, licenseIssueNumber=licenseIssueNumber, siteName=siteName, aAAControl=aAAControl, tDDSynchronizationAlarm=tDDSynchronizationAlarm, lowestDataModulationMode=lowestDataModulationMode, secondarySoftwareVersion=secondarySoftwareVersion, ethernetInstancedTableEntry=ethernetInstancedTableEntry, ethernetInstancedTableIndex=ethernetInstancedTableIndex, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, snmpControlGroup=snmpControlGroup, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, mainPSUPortQLTx=mainPSUPortQLTx, pubStats=pubStats, encryptionGroup=encryptionGroup, mgmtInstancedTableNumber=mgmtInstancedTableNumber, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, auxPortSyncERxStatus=auxPortSyncERxStatus, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, wirelessOutEthernetOctets=wirelessOutEthernetOctets, hTTPPortNumber=hTTPPortNumber, tDMConfigurationMismatch=tDMConfigurationMismatch, transparentClockVID=transparentClockVID, dataBridgingStatus=dataBridgingStatus, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, cableDiagPair4Results=cableDiagPair4Results)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, ptpTrapPrefix=ptpTrapPrefix, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, sNMPv3Enable=sNMPv3Enable, licenseVersion=licenseVersion, sNMPCommunityString=sNMPCommunityString, byteErrorRatioLinked=byteErrorRatioLinked, phyStatus=phyStatus, encryptionAlgorithm=encryptionAlgorithm, licenseInstancedTable=licenseInstancedTable, sNMPTrapTable=sNMPTrapTable, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, tFTPServerInternetAddress=tFTPServerInternetAddress, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, licenseTLSRekey=licenseTLSRekey, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, linkLoss=linkLoss, sNTPServerTableNumber=sNTPServerTableNumber, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, userPassword=userPassword, authorizationMethod=authorizationMethod, syslogClientTrap=syslogClientTrap, syncEEquipmentClock=syncEEquipmentClock, transparentClock=transparentClock, versions=versions, tDDSynchronizationMode=tDDSynchronizationMode, mABMaintenanceLevel=mABMaintenanceLevel, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, auxPortSSMTx=auxPortSSMTx, licenseOOBManagementSupport=licenseOOBManagementSupport, searchStateLinked=searchStateLinked, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, transmitModulationMode=transmitModulationMode, syslogControlGroup=syslogControlGroup, sNTPServerTableEntry=sNTPServerTableEntry, iPv6GatewayAddress=iPv6GatewayAddress, whitelistRMEnabled=whitelistRMEnabled, dNSPrimaryServer=dNSPrimaryServer, auxPortAllocation=auxPortAllocation, encryption=encryption, hTTPAccessEnabled=hTTPAccessEnabled, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, sNTPServerTimeout=sNTPServerTimeout, sNMPTrapTableNumber=sNMPTrapTableNumber, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, incompatibleRegulatoryBands=incompatibleRegulatoryBands, regulatoryBand=regulatoryBand, telnetAccessEnabled=telnetAccessEnabled, transmitterChannels=transmitterChannels, maxLinkRangeExceeded=maxLinkRangeExceeded, vectorErrorLinked=vectorErrorLinked, alarmInstancedTableNumber=alarmInstancedTableNumber, altitude=altitude, receiveModulationModeLinked=receiveModulationModeLinked, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, sNMPEnabledTraps=sNMPEnabledTraps, managementPortWirelessDownAlert=managementPortWirelessDownAlert, channelBandwidth=channelBandwidth, localPacketFiltering=localPacketFiltering, tDMInterfaceControl=tDMInterfaceControl, txMABFrames=txMABFrames, licenseCountry=licenseCountry, ptp=ptp, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, wirelessOutAllOctets=wirelessOutAllOctets, installStatusLinked=installStatusLinked, transmitPowerLinked=transmitPowerLinked, remoteMACAddressLinked=remoteMACAddressLinked, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, ethernetPriorityTableNumber=ethernetPriorityTableNumber, useVLANForMABProtocol=useVLANForMABProtocol, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, rawReceivePower=rawReceivePower, managementGroup=managementGroup, cableDiagnosticsGroup=cableDiagnosticsGroup, licenseInstancedTableNumber=licenseInstancedTableNumber, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPTrapTableIndex=sNMPTrapTableIndex, dNSServerTable=dNSServerTable, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, sNTPServerPortNumber=sNTPServerPortNumber, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, tFTPServerInternetAddressType=tFTPServerInternetAddressType, regulatoryBandTrap=regulatoryBandTrap, remoteInternetAddress=remoteInternetAddress, userRole=userRole, sFPErrorTrap=sFPErrorTrap, mgmtInstancedTableIndex=mgmtInstancedTableIndex, licenseHCMPSupport=licenseHCMPSupport, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, sMTPEnabledMessages=sMTPEnabledMessages, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, userTable=userTable, tDDSynchronizationStatus=tDDSynchronizationStatus, mABNominalTransmitCapacity=mABNominalTransmitCapacity, sNTPServerTableIndex=sNTPServerTableIndex, syslogControl=syslogControl, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, sNMPTrapInternetAddress=sNMPTrapInternetAddress, productVariant=productVariant, apc=apc, licenseInstancedTableEntry=licenseInstancedTableEntry, sNTPServerInternetAddressType=sNTPServerInternetAddressType, authorizationControlTable=authorizationControlTable, targetRange=targetRange, resetGroup=resetGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, transmitFreqKHz=transmitFreqKHz, licenseIEEE1588Support=licenseIEEE1588Support, rangingMode=rangingMode, dSCPManagementPriority=dSCPManagementPriority, packetsToInternalStack=packetsToInternalStack, eIRP=eIRP, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, byteErrorRatio=byteErrorRatio, routerProtocols=routerProtocols, dNSGroup=dNSGroup, mainPSUPortQLRx=mainPSUPortQLRx, configurationInstancedTable=configurationInstancedTable, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, ethernetInstancedTable=ethernetInstancedTable, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, phyControlInstancedTable=phyControlInstancedTable, installArmState=installArmState, mPLSTCPriorityTable=mPLSTCPriorityTable, ethernetStatisticsTable=ethernetStatisticsTable, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, subbandLowestFrequency=subbandLowestFrequency, maximumNumberOfSlaves=maximumNumberOfSlaves, deviceMACAddress=deviceMACAddress, gatewayIPAddress=gatewayIPAddress, dNSResolver=dNSResolver, routerProtocolsGroup=routerProtocolsGroup, sNTPPollInterval=sNTPPollInterval, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, alarmInstancedTableIndex=alarmInstancedTableIndex, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, userName=userName, subbandHighestFrequency=subbandHighestFrequency, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, licenseBandwidthCap=licenseBandwidthCap, tdmTableNumber=tdmTableNumber, configurationInstancedTableNumber=configurationInstancedTableNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tdmTable=tdmTable, l2CPPriorityTable=l2CPPriorityTable, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, dfsTableEntry=dfsTableEntry, installStatus=installStatus, tDMChannelLoopback=tDMChannelLoopback, phyControl=phyControl, capacityVariantMismatchLinked=capacityVariantMismatchLinked, frequencyVariant=frequencyVariant, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, phyControlGroup=phyControlGroup, sNTPServerRetries=sNTPServerRetries, mgmtInstancedTableEntry=mgmtInstancedTableEntry, syslogStateTrap=syslogStateTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, receiveModulationMode=receiveModulationMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, transmitFreqMHz=transmitFreqMHz, mgmtInstancedTable=mgmtInstancedTable, licenseSecurityLevel=licenseSecurityLevel, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ethernetInstancedTableNumber=ethernetInstancedTableNumber, tDMEnabledChannels=tDMEnabledChannels, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, mainPSUPortSSMTx=mainPSUPortSSMTx, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, smtpGroup=smtpGroup, transmitChannel=transmitChannel, tDMInterfaceStatus=tDMInterfaceStatus, blacklistRMMacAddress=blacklistRMMacAddress, vLANManagementVID=vLANManagementVID, ethernetStatisticsDataSource=ethernetStatisticsDataSource, sFPError=sFPError, sFPPortSSMTx=sFPPortSSMTx, licenseEncryption=licenseEncryption, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, mABProtocolVID=mABProtocolVID, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sFPPortDisabledWarning=sFPPortDisabledWarning, licenseSFPPortSupport=licenseSFPPortSupport, licenseRegulatoryBandsList=licenseRegulatoryBandsList, syslogClient=syslogClient, dfsMeans=dfsMeans, licenseGroupAccess=licenseGroupAccess, hCMPLinkSymmetry=hCMPLinkSymmetry, authorizationControl=authorizationControl, sFPPortAutoNegotiation=sFPPortAutoNegotiation, cableDiagnosticsPorts=cableDiagnosticsPorts, tFTPServerPortNumber=tFTPServerPortNumber, dNSServerTableEntry=dNSServerTableEntry, supplementaryGroup=supplementaryGroup, cableLoss=cableLoss, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, mainPSUPortAllocation=mainPSUPortAllocation, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, transparentClockPort=transparentClockPort, sNTPSyncTrap=sNTPSyncTrap, remoteUnitName=remoteUnitName, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, licenseUnitSerialNumber=licenseUnitSerialNumber, wirelessLinkStatusLinked=wirelessLinkStatusLinked, supplementary=supplementary, sNTPServerInternetAddress=sNTPServerInternetAddress, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, alarmsGroup=alarmsGroup, erroredSeconds=erroredSeconds, remoteMACAddress=remoteMACAddress, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, portAllocationMismatchLinked=portAllocationMismatchLinked, secureModeAlarm=secureModeAlarm, sMTPServerInternetAddress=sMTPServerInternetAddress, managementNetworkAccessEnabled=managementNetworkAccessEnabled, dNSServerInternetAddress=dNSServerInternetAddress, transmitDataRate=transmitDataRate, txColorCode=txColorCode, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataBridgingStatusAlarm=dataBridgingStatusAlarm, aggregateDataRateLinked=aggregateDataRateLinked, cableDiagnosticsWarning=cableDiagnosticsWarning, auxPortStatusTrap=auxPortStatusTrap, configurationInstancedTableIndex=configurationInstancedTableIndex, iPDSCPPriorityTable=iPDSCPPriorityTable, mABNominalModulationMode=mABNominalModulationMode, sNTPState=sNTPState, wirelessLinkAvailability=wirelessLinkAvailability, ptp670=ptp670, systemReset=systemReset, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, secureModeAlarmTrap=secureModeAlarmTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", unavailableSeconds=unavailableSeconds, targetMACAddress=targetMACAddress, licenseCapacity=licenseCapacity, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, capacityVariantMismatchTrap=capacityVariantMismatchTrap, tDDControlGroup=tDDControlGroup, cableDiagnostics=cableDiagnostics, userTableNumber=userTableNumber, wirelessLinkStatus=wirelessLinkStatus, PYSNMP_MODULE_ID=cambium, antennaGain=antennaGain, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dataBridgingStatusLinked=dataBridgingStatusLinked, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, cableDiagPair1Results=cableDiagPair1Results, softwareVersion=softwareVersion, iPVersion=iPVersion, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, cableDiagnosticsControl=cableDiagnosticsControl, useVLANForManagementInterfaces=useVLANForManagementInterfaces, iPv4Address=iPv4Address, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, receiveFreqKHz=receiveFreqKHz, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, rangeLinked=rangeLinked, unitOutOfCalibration=unitOutOfCalibration, searchState=searchState, remoteInternetAddressLinked=remoteInternetAddressLinked, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, syncETrackingState=syncETrackingState, authorizationControlGroup=authorizationControlGroup, configuration=configuration, dfsTableNumber=dfsTableNumber, rawReceivePowerLinked=rawReceivePowerLinked, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, iPv6PrefixLength=iPv6PrefixLength, sFPPortAllocation=sFPPortAllocation, remoteInternetAddressType=remoteInternetAddressType, sNTPServerTable=sNTPServerTable, enableTransmission=enableTransmission, incompatibleMasterAndSlave=incompatibleMasterAndSlave, authorizationControlTableEntry=authorizationControlTableEntry, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, mABHoldoffPeriod=mABHoldoffPeriod, dfsPeaks=dfsPeaks, linkName=linkName, syslogLocalWrappedTrap=syslogLocalWrappedTrap, transparentClockVLAN=transparentClockVLAN, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, mainPSUPortStatus=mainPSUPortStatus, authorizationControlTableNumber=authorizationControlTableNumber, cableDiagPair2Distance=cableDiagPair2Distance, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, userTableIndex=userTableIndex, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, bridgeGroup=bridgeGroup, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport)
