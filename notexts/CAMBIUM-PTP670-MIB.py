...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sNTPPrimaryServer=sNTPPrimaryServer, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, auxPortConfigurationMismatch=auxPortConfigurationMismatch, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, severelyErroredSeconds=severelyErroredSeconds, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, wirelessOutEthernetOctets=wirelessOutEthernetOctets, deviceMSN=deviceMSN, subnetMask=subnetMask, mainPSUPortStatus=mainPSUPortStatus, receiveDataRate=receiveDataRate, whitelistRMEnabled=whitelistRMEnabled, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, mainPSUPortAllocation=mainPSUPortAllocation, sMTPEmailAlert=sMTPEmailAlert, phyControlInstancedTableEntry=phyControlInstancedTableEntry, bootVersion=bootVersion, sMTPEnabledMessages=sMTPEnabledMessages, smtp=smtp, blacklistRMMacAddress=blacklistRMMacAddress, receiveFreqKHz=receiveFreqKHz, mgmtInstancedTableEntry=mgmtInstancedTableEntry, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, regulatoryBandTrap=regulatoryBandTrap, sNMPv3Enable=sNMPv3Enable, auxPortSyncERxStatus=auxPortSyncERxStatus, phyControlInstancedTableIndex=phyControlInstancedTableIndex, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, auxPortAllocation=auxPortAllocation, tDDControl=tDDControl, tempPcb=tempPcb, ethernetPriorityTableEntry=ethernetPriorityTableEntry, transmitPowerLinked=transmitPowerLinked, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, incompatibleRegulatoryBands=incompatibleRegulatoryBands, userTableIndex=userTableIndex, dataBridgingStatusAlarm=dataBridgingStatusAlarm, versions=versions, licenseGroupAccess=licenseGroupAccess, antennaSelection=antennaSelection, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, remoteUnitNameLinked=remoteUnitNameLinked, signalStrengthRatio=signalStrengthRatio, receivePower=receivePower, authorizationControlTableNumber=authorizationControlTableNumber, productVariant=productVariant, receiveModulationModeLinked=receiveModulationModeLinked, phyControl=phyControl, wirelessLinkStatusLinked=wirelessLinkStatusLinked, receiveFreqMHz=receiveFreqMHz, ethernetStatisticsTable=ethernetStatisticsTable, sNMPTrapTableNumber=sNMPTrapTableNumber, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, sFPPortDisabledWarning=sFPPortDisabledWarning, mABHoldoffPeriod=mABHoldoffPeriod, regulatoryBand=regulatoryBand, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, wirelessOutOctets=wirelessOutOctets, snmpControlGroup=snmpControlGroup, linkName=linkName, dNSServerInternetAddressType=dNSServerInternetAddressType, tDM=tDM, tDMInterfaceStatus=tDMInterfaceStatus, bridge=bridge, hTTPSPortNumber=hTTPSPortNumber, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, sNMPTrapTableEntry=sNMPTrapTableEntry, licenseRegulatoryBandsList=licenseRegulatoryBandsList, sNTPSync=sNTPSync, sMTPServerInternetAddress=sMTPServerInternetAddress, licenseIEEE1588Support=licenseIEEE1588Support, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, latitude=latitude, rxColorCode=rxColorCode, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, hTTPAccessEnabled=hTTPAccessEnabled, mgmtInstancedTableIndex=mgmtInstancedTableIndex, configurationInstancedTableNumber=configurationInstancedTableNumber, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, syncESlavePort=syncESlavePort, lowestDataModulationMode=lowestDataModulationMode, rangeLinked=rangeLinked, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPServerTimeout=sNTPServerTimeout, dfsTableIndex=dfsTableIndex, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, iPv6PrefixLength=iPv6PrefixLength, altitude=altitude, iPv6GatewayAddress=iPv6GatewayAddress, remoteUnitName=remoteUnitName, mABNominalModulationMode=mABNominalModulationMode, sNMPPortNumber=sNMPPortNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, aggregateDataRate=aggregateDataRate, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, mABProtocolVID=mABProtocolVID, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, encryptionAlgorithm=encryptionAlgorithm, mainPSUPortStatusTrap=mainPSUPortStatusTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, dfsTable=dfsTable, licenseOOBManagementSupport=licenseOOBManagementSupport, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, targetMACAddress=targetMACAddress, capacityVariantMismatchTrap=capacityVariantMismatchTrap, dNSServerTable=dNSServerTable, installArmState=installArmState, localPacketFiltering=localPacketFiltering, capacityVariantMismatchLinked=capacityVariantMismatchLinked, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, licenseInstancedTable=licenseInstancedTable, remoteInternetAddress=remoteInternetAddress, siteName=siteName, dNSServerTableNumber=dNSServerTableNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, sFPPortQLTx=sFPPortQLTx, receiveModulationModeDetail=receiveModulationModeDetail, tDDControlGroup=tDDControlGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, cableDiagnosticsResultTable=cableDiagnosticsResultTable, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, sFPPortAutoMdix=sFPPortAutoMdix, linkModeOptimizationMismatch=linkModeOptimizationMismatch, routerProtocolsGroup=routerProtocolsGroup, wirelessLinkAvailability=wirelessLinkAvailability, sNTPPollInterval=sNTPPollInterval, managementGroup=managementGroup, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, tDMChannelLoopback=tDMChannelLoopback, installStatus=installStatus, ptp670=ptp670, dataPortPauseFrames=dataPortPauseFrames, apc=apc, packetsFromInternalStack=packetsFromInternalStack, installStatusLinked=installStatusLinked, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, portAllocationMismatchTrap=portAllocationMismatchTrap, licenseCountry=licenseCountry, auxPortStatus=auxPortStatus, transmitDataRate=transmitDataRate, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, sNMPTrapVersion=sNMPTrapVersion, syslogStateTrap=syslogStateTrap, ethernetPriorityTable=ethernetPriorityTable, sFPPortQLRx=sFPPortQLRx, dNS=dNS, remoteInternetAddressType=remoteInternetAddressType, licenseSecurityLevel=licenseSecurityLevel, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, vectorErrorLinked=vectorErrorLinked, bridgeGroup=bridgeGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, notificationsGroup=notificationsGroup, cableDiagPair4Results=cableDiagPair4Results, blacklistRMEnabled=blacklistRMEnabled, phyStatusGroup=phyStatusGroup, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, l2CPPriorityTableNumber=l2CPPriorityTableNumber, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, iPv4Address=iPv4Address, transmitPower=transmitPower, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, alarmInstancedTableEntry=alarmInstancedTableEntry, sntpGroup=sntpGroup, systemClock=systemClock, licenseVersion=licenseVersion, packetsToInternalStack=packetsToInternalStack, dataBridgingStatus=dataBridgingStatus, txColorCode=txColorCode, cableLoss=cableLoss, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, nIDULanPortStatus=nIDULanPortStatus, tFTPServerPortNumber=tFTPServerPortNumber, ethernetInstancedTableIndex=ethernetInstancedTableIndex, snmpControl=snmpControl, dfsTableNumber=dfsTableNumber, iPv6Address=iPv6Address, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, receiveChannel=receiveChannel, auxPortAcceptedQLRx=auxPortAcceptedQLRx, mABProtocolVLANPriority=mABProtocolVLANPriority, sMTPServerInternetAddressType=sMTPServerInternetAddressType, licenseInstancedTableIndex=licenseInstancedTableIndex, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, syslogControlGroup=syslogControlGroup, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, telnetPortNumber=telnetPortNumber, sntp=sntp, receiveDataRateLinked=receiveDataRateLinked, tFTPServerInternetAddressType=tFTPServerInternetAddressType, configurationInstancedTableIndex=configurationInstancedTableIndex, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, mgmtInstancedTableNumber=mgmtInstancedTableNumber, cableDiagPair2Distance=cableDiagPair2Distance, syslogClient=syslogClient, whitelistRMMacAddress=whitelistRMMacAddress, userEnabled=userEnabled, cableDiagnosticsPorts=cableDiagnosticsPorts, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, reset=reset, sFPError=sFPError, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, receivePowerLinked=receivePowerLinked, transmitModulationModeLinked=transmitModulationModeLinked, qOSPriorityScheme=qOSPriorityScheme, licenseIPv6Support=licenseIPv6Support, configurationInstancedTableEntry=configurationInstancedTableEntry, cableDiagPair1Distance=cableDiagPair1Distance, erroredSeconds=erroredSeconds, aAAControl=aAAControl, tdmTableEntry=tdmTableEntry, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, sFPPortAllocation=sFPPortAllocation, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, receiveModulationMode=receiveModulationMode, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, subbandLowestFrequency=subbandLowestFrequency, transmitFreqKHz=transmitFreqKHz, licenseGasGroup=licenseGasGroup, licenseGroup=licenseGroup, mgmtInstancedTable=mgmtInstancedTable, hardwareVersion=hardwareVersion, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, byteErrorRatioLinked=byteErrorRatioLinked, mainPSUPortQLRx=mainPSUPortQLRx, tDMConfigurationMismatch=tDMConfigurationMismatch, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, transmitFreqMHz=transmitFreqMHz, pubInstancedStatsTable=pubInstancedStatsTable, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, mainPSUPortAutoMdix=mainPSUPortAutoMdix, licenseTDDSyncSupport=licenseTDDSyncSupport, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, tDMChannelCableLength=tDMChannelCableLength, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, sNTPServerInternetAddress=sNTPServerInternetAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", tDMChannelLineCode=tDMChannelLineCode, portAllocationMismatchLinked=portAllocationMismatchLinked, cableDiagPair4Distance=cableDiagPair4Distance, authorizationControlTableIndex=authorizationControlTableIndex, sNTPServerTableNumber=sNTPServerTableNumber, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, licenseEncryption=licenseEncryption, deviceMACAddress=deviceMACAddress, mainPSUPortSSMTx=mainPSUPortSSMTx, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, l2CPPriorityTableEntry=l2CPPriorityTableEntry, ptpTrapPrefix=ptpTrapPrefix, dfs=dfs, remoteMaximumTransmitPower=remoteMaximumTransmitPower, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, byteErrorRatio=byteErrorRatio, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, licenseUnitSerialNumber=licenseUnitSerialNumber, linkLoss=linkLoss, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, phyControlInstancedTable=phyControlInstancedTable, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPServerPortNumber=sMTPServerPortNumber, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, userTableNumber=userTableNumber, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, l2CPPriorityTableIndex=l2CPPriorityTableIndex, tFTPClient=tFTPClient, accessMethod=accessMethod, licenseHCMPSupport=licenseHCMPSupport, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, cableDiagnosticsWarning=cableDiagnosticsWarning, masterSlaveMode=masterSlaveMode, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, licenseInstancedTableEntry=licenseInstancedTableEntry, mABState=mABState, pubStatsGroup=pubStatsGroup, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, dataBridgingStatusLinked=dataBridgingStatusLinked, tFTPServerInternetAddress=tFTPServerInternetAddress, useVLANForMABProtocol=useVLANForMABProtocol, aggregateDataRateLinked=aggregateDataRateLinked, sNTPServerTableEntry=sNTPServerTableEntry, userRole=userRole, installationMode=installationMode, alarmsGroup=alarmsGroup, dNSResolver=dNSResolver, nIDULanPortStatusTrap=nIDULanPortStatusTrap, sFPPortStatus=sFPPortStatus, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, cableDiagPair1Results=cableDiagPair1Results, phyControlInstancedTableNumber=phyControlInstancedTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, transparentClockVID=transparentClockVID, licenseBandwidthCap=licenseBandwidthCap, unitIdentificationGroup=unitIdentificationGroup, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, userName=userName, lowestTDMModulationMode=lowestTDMModulationMode, installStatusTrap=installStatusTrap, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, tDMChannelStatus=tDMChannelStatus, ptpTraps=ptpTraps, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, longitude=longitude, tdmTable=tdmTable, configurationInstancedTable=configurationInstancedTable, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, cableDiagPair3Distance=cableDiagPair3Distance, frequencyVariant=frequencyVariant, wirelessLinkStatus=wirelessLinkStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, aAAControlGroup=aAAControlGroup, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, sNMPTrapTable=sNMPTrapTable, licenseIssueNumber=licenseIssueNumber, maximumTransmitPower=maximumTransmitPower, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, dNSServerInternetAddress=dNSServerInternetAddress, sNTPServerInternetAddressType=sNTPServerInternetAddressType, cambium=cambium, auxPortDisabledWarning=auxPortDisabledWarning, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, tDMGroup=tDMGroup, phyControlGroup=phyControlGroup, iPVersion=iPVersion, tdmTableIndex=tdmTableIndex, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, transmitterChannels=transmitterChannels, secondarySoftwareVersion=secondarySoftwareVersion, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, hCMPLinkSymmetry=hCMPLinkSymmetry, authorizationControlTable=authorizationControlTable, rangingMode=rangingMode, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, linkModeOptimization=linkModeOptimization, l2CPPriorityTable=l2CPPriorityTable, timeZone=timeZone, dfsPeaks=dfsPeaks, resetGroup=resetGroup, ethernetGroup=ethernetGroup, dNSServerTableEntry=dNSServerTableEntry, lbtDetectedTrap=lbtDetectedTrap, tDDSynchronizationMode=tDDSynchronizationMode, gatewayIPAddress=gatewayIPAddress, cableDiagnostics=cableDiagnostics, sNMPTrapInternetAddress=sNMPTrapInternetAddress, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, systemReset=systemReset, eIRP=eIRP, syslogState=syslogState, pubStats=pubStats, linkLossLinked=linkLossLinked, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, transmitChannel=transmitChannel, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, syslogControl=syslogControl, encryptionGroup=encryptionGroup, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, authorizationControl=authorizationControl, sNTPSyncTrap=sNTPSyncTrap, encryption=encryption, maximumNumberOfSlaves=maximumNumberOfSlaves, userTable=userTable, mABMaintenanceLevel=mABMaintenanceLevel, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, ethernet=ethernet, vLANManagementVID=vLANManagementVID, unitIdentification=unitIdentification, remoteMACAddress=remoteMACAddress, unitOutOfCalibration=unitOutOfCalibration, management=management, auxPortQLRx=auxPortQLRx, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, syslogClientTrap=syslogClientTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, linkSymmetry=linkSymmetry, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, tDMChannelStatusTrap=tDMChannelStatusTrap, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, sNTPServerPortNumber=sNTPServerPortNumber, alarmInstancedTableIndex=alarmInstancedTableIndex, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dNSGroup=dNSGroup, txMABFrames=txMABFrames, sNMPTrapTableIndex=sNMPTrapTableIndex, transparentClockPort=transparentClockPort, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dfsMeans=dfsMeans, transparentClockVLAN=transparentClockVLAN, hCMPMaximumLinkRange=hCMPMaximumLinkRange, syncETrackingState=syncETrackingState, cableDiagPair3Results=cableDiagPair3Results, license=license, enableTransmission=enableTransmission, searchState=searchState, wirelessTopology=wirelessTopology, transmitModulationMode=transmitModulationMode, managementNetworkAccessEnabled=managementNetworkAccessEnabled, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, iPDSCPPriorityTable=iPDSCPPriorityTable, sNMPCommunityString=sNMPCommunityString, smtpGroup=smtpGroup, antennaGain=antennaGain, ptp=ptp, authorizationMethod=authorizationMethod, sMTPSourceEmailAddress=sMTPSourceEmailAddress, phyStatus=phyStatus, remoteInternetAddressLinked=remoteInternetAddressLinked, userTableEntry=userTableEntry, unitName=unitName, mPLSTCPriorityTable=mPLSTCPriorityTable, licenseCapacity=licenseCapacity, hTTPPortNumber=hTTPPortNumber, sFPPortSSMTx=sFPPortSSMTx, ptpGroups=ptpGroups, mABNominalTransmitCapacity=mABNominalTransmitCapacity, extendedSpectrumScanning=extendedSpectrumScanning, sNTPServerStatus=sNTPServerStatus, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, tdmTableNumber=tdmTableNumber, sNTPLastSync=sNTPLastSync, alarmInstancedTable=alarmInstancedTable, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, productName=productName, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, licenseMaxLinkRange=licenseMaxLinkRange, sNTPState=sNTPState, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, ethernetPriorityTableIndex=ethernetPriorityTableIndex, syncEEquipmentClock=syncEEquipmentClock, ethernetPriorityTableNumber=ethernetPriorityTableNumber, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, portAllocationMismatch=portAllocationMismatch, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, daylightSaving=daylightSaving, tDMInterfaceControl=tDMInterfaceControl, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, apcGroup=apcGroup, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, subbandHighestFrequency=subbandHighestFrequency, dataBridgingAvailability=dataBridgingAvailability, remoteMACAddressLinked=remoteMACAddressLinked, sFPPortAutoNegotiation=sFPPortAutoNegotiation, ethernetInstancedTableNumber=ethernetInstancedTableNumber, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, phyInstancedStatusTable=phyInstancedStatusTable, licenseTrialPeriod=licenseTrialPeriod, ptpCompliance=ptpCompliance, sNTPServerRetries=sNTPServerRetries, transmitDataRateLinked=transmitDataRateLinked, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, syncETracking=syncETracking, configurationGroup=configurationGroup, licenseSyncESupport=licenseSyncESupport, ethernetInstancedTable=ethernetInstancedTable, supplementaryGroup=supplementaryGroup, alarms=alarms, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, range=range, sNTPServerTable=sNTPServerTable, rawReceivePower=rawReceivePower, unavailableSeconds=unavailableSeconds, sNMPEnabledTraps=sNMPEnabledTraps, groupID=groupID, mainPSUPortQLTx=mainPSUPortQLTx, channelChangeTrap=channelChangeTrap, sFPPortSyncERxStatus=sFPPortSyncERxStatus, PYSNMP_MODULE_ID=cambium, dfsGroup=dfsGroup, versionsGroup=versionsGroup, auxPortQLTx=auxPortQLTx, ethernetInstancedTableEntry=ethernetInstancedTableEntry, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, telnetAccessEnabled=telnetAccessEnabled, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, dataPortWirelessDownAlert=dataPortWirelessDownAlert, authorizationControlTableEntry=authorizationControlTableEntry, alarmInstancedTableNumber=alarmInstancedTableNumber, deviceESN=deviceESN, ptmp=ptmp, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sFPErrorTrap=sFPErrorTrap, capacityVariantMismatch=capacityVariantMismatch)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", cableDiagPair2Results=cableDiagPair2Results, tDMEnabledChannels=tDMEnabledChannels, dfsTableEntry=dfsTableEntry, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, dNSServerPortNumber=dNSServerPortNumber, oOBPriorityQueueMapping=oOBPriorityQueueMapping, rawReceivePowerLinked=rawReceivePowerLinked, supplementary=supplementary, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, userPassword=userPassword, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, routerProtocols=routerProtocols, softwareVersion=softwareVersion, enabledDiagnosticAlarms=enabledDiagnosticAlarms, vectorError=vectorError, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, wirelessOutAllOctets=wirelessOutAllOctets, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dSCPManagementPriority=dSCPManagementPriority, secureModeAlarmTrap=secureModeAlarmTrap, configuration=configuration, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, channelBandwidth=channelBandwidth, managementPortWirelessDownAlert=managementPortWirelessDownAlert, incompatibleMasterAndSlave=incompatibleMasterAndSlave, licenseInstancedTableNumber=licenseInstancedTableNumber, ethernetStatisticsDataSource=ethernetStatisticsDataSource, licenseRARSupport=licenseRARSupport, cableDiagnosticsControl=cableDiagnosticsControl, secureModeAlarm=secureModeAlarm, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, transparentClock=transparentClock, dNSPrimaryServer=dNSPrimaryServer, licenseTLSRekey=licenseTLSRekey, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, tDDSynchronizationAlarm=tDDSynchronizationAlarm, auxPortStatusTrap=auxPortStatusTrap, authorizationControlGroup=authorizationControlGroup, cableDiagnosticsGroup=cableDiagnosticsGroup, maxLinkRangeExceeded=maxLinkRangeExceeded, installArmStateTrap=installArmStateTrap, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, sNTPServerTableIndex=sNTPServerTableIndex, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, mABTransmissionInterval=mABTransmissionInterval, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, licenseSFPPortSupport=licenseSFPPortSupport, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, vLANManagementPriority=vLANManagementPriority, searchStateLinked=searchStateLinked, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, nIDULanPortAutoMdix=nIDULanPortAutoMdix, auxPortSSMTx=auxPortSSMTx, targetRange=targetRange, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, signalStrengthRatioLinked=signalStrengthRatioLinked, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, dNSServerTableIndex=dNSServerTableIndex, sFPPortStatusTrap=sFPPortStatusTrap)
