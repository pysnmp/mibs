...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", cableDiagPair4Results=cableDiagPair4Results, mainPSUPortStatusTrap=mainPSUPortStatusTrap, regulatoryBand=regulatoryBand, receiveModulationModeDetail=receiveModulationModeDetail, auxPortStatus=auxPortStatus, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, tDMChannelCableLength=tDMChannelCableLength, phyControlInstancedTableEntry=phyControlInstancedTableEntry, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, transparentClockVLAN=transparentClockVLAN, tFTPClient=tFTPClient, sNTPLastSync=sNTPLastSync, authorizationControlTableIndex=authorizationControlTableIndex, licenseIssueNumber=licenseIssueNumber, licenseIEEE1588Support=licenseIEEE1588Support, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dNSServerTableIndex=dNSServerTableIndex, sFPPortSyncERxStatus=sFPPortSyncERxStatus, lbtDetectedTrap=lbtDetectedTrap, userPassword=userPassword, mainPSUPortAllocation=mainPSUPortAllocation, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, licenseTDDSyncSupport=licenseTDDSyncSupport, licenseGasGroup=licenseGasGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, licenseUnitSerialNumber=licenseUnitSerialNumber, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, sFPErrorTrap=sFPErrorTrap, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, txColorCode=txColorCode, authorizationMethod=authorizationMethod, dataBridgingStatusLinked=dataBridgingStatusLinked, vectorErrorLinked=vectorErrorLinked, dNSServerPortNumber=dNSServerPortNumber, mgmtInstancedTableEntry=mgmtInstancedTableEntry, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, dataBridgingStatusAlarm=dataBridgingStatusAlarm, auxPortSyncERxStatus=auxPortSyncERxStatus, mABTransmissionInterval=mABTransmissionInterval, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, vectorError=vectorError, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, licenseTLSRekey=licenseTLSRekey, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, auxPortQLTx=auxPortQLTx, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, routerProtocolsGroup=routerProtocolsGroup, ethernetPriorityTableNumber=ethernetPriorityTableNumber, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, wirelessLinkStatusLinked=wirelessLinkStatusLinked, transmitDataRate=transmitDataRate, dNSServerTableNumber=dNSServerTableNumber, licenseSFPPortSupport=licenseSFPPortSupport, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, antennaGain=antennaGain, cableDiagPair3Distance=cableDiagPair3Distance, secureModeAlarm=secureModeAlarm, ptpCompliance=ptpCompliance, ptpTrapPrefix=ptpTrapPrefix, transmitPowerLinked=transmitPowerLinked, mABProtocolVLANPriority=mABProtocolVLANPriority, transmitFreqMHz=transmitFreqMHz, linkLossLinked=linkLossLinked, licenseRARSupport=licenseRARSupport, oOBPriorityQueueMapping=oOBPriorityQueueMapping, phyControlInstancedTableIndex=phyControlInstancedTableIndex, mainPSUPortQLRx=mainPSUPortQLRx, sNTPServerPortNumber=sNTPServerPortNumber, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, ptp670=ptp670, phyControlGroup=phyControlGroup, remoteUnitName=remoteUnitName, alarmsGroup=alarmsGroup, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, unavailableSeconds=unavailableSeconds, secureModeAlarmTrap=secureModeAlarmTrap, dfsTable=dfsTable, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, cableDiagnosticsGroup=cableDiagnosticsGroup, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, tDDControl=tDDControl, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, sNTPServerTable=sNTPServerTable, sNTPPrimaryServer=sNTPPrimaryServer, PYSNMP_MODULE_ID=cambium, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, syncEEquipmentClock=syncEEquipmentClock, tDMGroup=tDMGroup, licenseIPv6Support=licenseIPv6Support, byteErrorRatio=byteErrorRatio, management=management, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, accessMethod=accessMethod, signalStrengthRatio=signalStrengthRatio, dfsGroup=dfsGroup, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, cableDiagnosticsPorts=cableDiagnosticsPorts, dataPortPauseFrames=dataPortPauseFrames, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, ptmp=ptmp, transparentClockPort=transparentClockPort, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, portAllocationMismatchTrap=portAllocationMismatchTrap, erroredSeconds=erroredSeconds, licenseGroup=licenseGroup, mgmtInstancedTable=mgmtInstancedTable, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, transmitPower=transmitPower, daylightSaving=daylightSaving, dfsTableIndex=dfsTableIndex, apc=apc, packetsToInternalStack=packetsToInternalStack, transmitFreqKHz=transmitFreqKHz, tDDSynchronizationMode=tDDSynchronizationMode, tdmTableNumber=tdmTableNumber, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, dNSServerInternetAddressType=dNSServerInternetAddressType, latitude=latitude, alarmInstancedTableEntry=alarmInstancedTableEntry, auxPortConfigurationMismatch=auxPortConfigurationMismatch, transparentClock=transparentClock, hTTPSPortNumber=hTTPSPortNumber, subnetMask=subnetMask, hardwareVersion=hardwareVersion, tDDControlGroup=tDDControlGroup, ethernetStatisticsTable=ethernetStatisticsTable, phyStatusGroup=phyStatusGroup, licenseInstancedTableEntry=licenseInstancedTableEntry, receivePowerLinked=receivePowerLinked, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, remoteMaximumTransmitPower=remoteMaximumTransmitPower, secondarySoftwareVersion=secondarySoftwareVersion, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, signalStrengthRatioLinked=signalStrengthRatioLinked, aAAControl=aAAControl, iPv6PrefixLength=iPv6PrefixLength, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, tDMInterfaceControl=tDMInterfaceControl, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, ptpTraps=ptpTraps, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, mPLSTCPriorityTable=mPLSTCPriorityTable, qOSPriorityScheme=qOSPriorityScheme, managementPortWirelessDownAlert=managementPortWirelessDownAlert, dNSServerTable=dNSServerTable, capacityVariantMismatch=capacityVariantMismatch, unitIdentificationGroup=unitIdentificationGroup, sNTPServerInternetAddress=sNTPServerInternetAddress, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, searchState=searchState, resetGroup=resetGroup, ethernet=ethernet, licenseRegulatoryBandsList=licenseRegulatoryBandsList, remoteMACAddress=remoteMACAddress, installStatusLinked=installStatusLinked, dfsMeans=dfsMeans, ptp=ptp, dataBridgingStatus=dataBridgingStatus, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, receiveDataRateLinked=receiveDataRateLinked, bridgeGroup=bridgeGroup, systemReset=systemReset, cableDiagPair4Distance=cableDiagPair4Distance, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, eIRP=eIRP, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, maximumTransmitPower=maximumTransmitPower, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, localPacketFiltering=localPacketFiltering, tDDSynchronizationStatus=tDDSynchronizationStatus, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, tDMEnabledChannels=tDMEnabledChannels, versions=versions, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, sNTPServerTimeout=sNTPServerTimeout, useVLANForMABProtocol=useVLANForMABProtocol, licenseBandwidthCap=licenseBandwidthCap, phyControlInstancedTableNumber=phyControlInstancedTableNumber, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sFPError=sFPError, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, sntpGroup=sntpGroup, altitude=altitude, lowestDataModulationMode=lowestDataModulationMode, smtpGroup=smtpGroup, sFPPortQLRx=sFPPortQLRx, enableTransmission=enableTransmission, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, licenseEncryption=licenseEncryption, hTTPSAccessEnabled=hTTPSAccessEnabled, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, reset=reset, ethernetPriorityTableIndex=ethernetPriorityTableIndex, remoteInternetAddressType=remoteInternetAddressType, portAllocationMismatch=portAllocationMismatch, mABState=mABState, smtp=smtp, supplementary=supplementary, dfsPeaks=dfsPeaks, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, pubStats=pubStats, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, remoteInternetAddress=remoteInternetAddress, sNTPSync=sNTPSync, targetMACAddress=targetMACAddress, managementNetworkAccessEnabled=managementNetworkAccessEnabled, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, sNMPTrapInternetAddress=sNMPTrapInternetAddress, extendedSpectrumScanning=extendedSpectrumScanning, transmitChannel=transmitChannel, snmpControl=snmpControl, sNMPv3Enable=sNMPv3Enable, sNMPTrapTableIndex=sNMPTrapTableIndex, sFPPortDisabledWarning=sFPPortDisabledWarning, tdmTableEntry=tdmTableEntry, iPv4Address=iPv4Address, mainPSUPortSSMTx=mainPSUPortSSMTx, deviceMSN=deviceMSN, sFPPortQLTx=sFPPortQLTx, sFPPortStatusTrap=sFPPortStatusTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, remoteUnitNameLinked=remoteUnitNameLinked, apcGroup=apcGroup, ptpGroups=ptpGroups, cableDiagPair2Results=cableDiagPair2Results, sFPPortAutoNegotiation=sFPPortAutoNegotiation, capacityVariantMismatchLinked=capacityVariantMismatchLinked, snmpControlGroup=snmpControlGroup, authorizationControlTableEntry=authorizationControlTableEntry, maxLinkRangeExceeded=maxLinkRangeExceeded, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, wirelessOutOctets=wirelessOutOctets, aggregateDataRate=aggregateDataRate, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, auxPortDisabledWarning=auxPortDisabledWarning, tFTPServerInternetAddressType=tFTPServerInternetAddressType, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sNTPServerTableNumber=sNTPServerTableNumber, wirelessOutEthernetOctets=wirelessOutEthernetOctets, cableLoss=cableLoss, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapTableEntry=sNMPTrapTableEntry, dNSGroup=dNSGroup, tDMConfigurationMismatch=tDMConfigurationMismatch, receiveModulationModeLinked=receiveModulationModeLinked, tDDSynchronizationAlarm=tDDSynchronizationAlarm, versionsGroup=versionsGroup, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, tDMChannelLineCode=tDMChannelLineCode, useVLANForManagementInterfaces=useVLANForManagementInterfaces, wirelessLinkAvailability=wirelessLinkAvailability, aAAControlGroup=aAAControlGroup, searchStateLinked=searchStateLinked, userTableNumber=userTableNumber, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, l2CPPriorityTableEntry=l2CPPriorityTableEntry, ethernetGroup=ethernetGroup, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, userName=userName, rawReceivePower=rawReceivePower, sMTPServerInternetAddress=sMTPServerInternetAddress, tFTPServerInternetAddress=tFTPServerInternetAddress, licenseInstancedTableNumber=licenseInstancedTableNumber, cableDiagPair3Results=cableDiagPair3Results, sNTPServerRetries=sNTPServerRetries, authorizationControlTable=authorizationControlTable, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, channelBandwidth=channelBandwidth, sNTPServerTableEntry=sNTPServerTableEntry, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, cableDiagPair1Results=cableDiagPair1Results, gatewayIPAddress=gatewayIPAddress, dNSServerTableEntry=dNSServerTableEntry, syncESlavePort=syncESlavePort, whitelistRMEnabled=whitelistRMEnabled, dfs=dfs, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, userEnabled=userEnabled, licenseVersion=licenseVersion, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, iPv6GatewayAddress=iPv6GatewayAddress, nIDULanPortStatus=nIDULanPortStatus, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, receiveChannel=receiveChannel, sNTPServerInternetAddressType=sNTPServerInternetAddressType, whitelistRMMacAddress=whitelistRMMacAddress, alarmInstancedTable=alarmInstancedTable, syncETracking=syncETracking, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPSyncTrap=sNTPSyncTrap, syslogState=syslogState, configurationInstancedTableNumber=configurationInstancedTableNumber, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, cambium=cambium, licenseInstancedTableIndex=licenseInstancedTableIndex, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, dSCPManagementPriority=dSCPManagementPriority, encryptionAlgorithm=encryptionAlgorithm, auxPortAllocation=auxPortAllocation, dfsTableNumber=dfsTableNumber, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, configuration=configuration, maximumNumberOfSlaves=maximumNumberOfSlaves, unitOutOfCalibration=unitOutOfCalibration, cableDiagPair2Distance=cableDiagPair2Distance, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, authorizationControl=authorizationControl, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, linkSymmetry=linkSymmetry, capacityVariantMismatchTrap=capacityVariantMismatchTrap, tDMInterfaceStatus=tDMInterfaceStatus, userTable=userTable, targetRange=targetRange, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sntp=sntp, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, phyControl=phyControl, sMTPEnabledMessages=sMTPEnabledMessages, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sFPPortStatus=sFPPortStatus, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, antennaSelection=antennaSelection, wirelessOutAllOctets=wirelessOutAllOctets, sMTPEmailAlert=sMTPEmailAlert, dNSPrimaryServer=dNSPrimaryServer, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, managementGroup=managementGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, l2CPPriorityTableNumber=l2CPPriorityTableNumber, syslogControlGroup=syslogControlGroup, subbandLowestFrequency=subbandLowestFrequency, ethernetInstancedTableNumber=ethernetInstancedTableNumber, remoteMACAddressLinked=remoteMACAddressLinked, receivePower=receivePower, tDM=tDM, licenseInstancedTable=licenseInstancedTable, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, nIDULanPortStatusTrap=nIDULanPortStatusTrap, unitName=unitName, rangeLinked=rangeLinked, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, rawReceivePowerLinked=rawReceivePowerLinked, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, bootVersion=bootVersion, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, transmitDataRateLinked=transmitDataRateLinked, alarmInstancedTableIndex=alarmInstancedTableIndex, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, syslogClient=syslogClient, hTTPAccessEnabled=hTTPAccessEnabled, phyStatus=phyStatus, licenseHCMPSupport=licenseHCMPSupport, mABHoldoffPeriod=mABHoldoffPeriod, hCMPMaximumLinkRange=hCMPMaximumLinkRange, encryption=encryption, vLANManagementVID=vLANManagementVID, groupID=groupID, configurationInstancedTableEntry=configurationInstancedTableEntry, sNMPTrapTableNumber=sNMPTrapTableNumber, syslogStateTrap=syslogStateTrap, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, licenseTrialPeriod=licenseTrialPeriod, cableDiagnosticsWarning=cableDiagnosticsWarning, mainPSUPortStatus=mainPSUPortStatus, blacklistRMMacAddress=blacklistRMMacAddress, userTableEntry=userTableEntry, userRole=userRole, auxPortQLRx=auxPortQLRx, transmitterChannels=transmitterChannels, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, tDMChannelStatusTrap=tDMChannelStatusTrap, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, mABNominalModulationMode=mABNominalModulationMode, hCMPLinkSymmetry=hCMPLinkSymmetry, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, receiveDataRate=receiveDataRate, sNMPCommunityString=sNMPCommunityString, transparentClockVID=transparentClockVID, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, installStatus=installStatus, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, unitIdentification=unitIdentification, cableDiagnosticsResultTable=cableDiagnosticsResultTable, licenseSyncESupport=licenseSyncESupport, nIDULanPortAutoMdix=nIDULanPortAutoMdix, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, license=license, sFPPortAllocation=sFPPortAllocation, regulatoryBandTrap=regulatoryBandTrap, hTTPPortNumber=hTTPPortNumber, aggregateDataRateLinked=aggregateDataRateLinked, incompatibleMasterAndSlave=incompatibleMasterAndSlave, installStatusTrap=installStatusTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, mABProtocolVID=mABProtocolVID, installArmState=installArmState, vLANManagementPriority=vLANManagementPriority, dfsTableEntry=dfsTableEntry, configurationInstancedTable=configurationInstancedTable, iPVersion=iPVersion, syncETrackingState=syncETrackingState, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, linkLoss=linkLoss, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, iPv6Address=iPv6Address, productVariant=productVariant, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, severelyErroredSeconds=severelyErroredSeconds, ethernetInstancedTableEntry=ethernetInstancedTableEntry, mgmtInstancedTableNumber=mgmtInstancedTableNumber, sNMPTrapTable=sNMPTrapTable, systemClock=systemClock, bridge=bridge, iPDSCPPriorityTable=iPDSCPPriorityTable, licenseCapacity=licenseCapacity, licenseCountry=licenseCountry, sMTPServerPortNumber=sMTPServerPortNumber, deviceESN=deviceESN, tdmTable=tdmTable, longitude=longitude, configurationInstancedTableIndex=configurationInstancedTableIndex, dataPortWirelessDownAlert=dataPortWirelessDownAlert, portAllocationMismatchLinked=portAllocationMismatchLinked, siteName=siteName, pubStatsGroup=pubStatsGroup, phyInstancedStatusTable=phyInstancedStatusTable, linkName=linkName, licenseGroupAccess=licenseGroupAccess, tdmTableIndex=tdmTableIndex, transmitModulationModeLinked=transmitModulationModeLinked, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, cableDiagnosticsControl=cableDiagnosticsControl, dataBridgingAvailability=dataBridgingAvailability, rangingMode=rangingMode, mABMaintenanceLevel=mABMaintenanceLevel, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, userTableIndex=userTableIndex, cableDiagPair1Distance=cableDiagPair1Distance, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNMPEnabledTraps=sNMPEnabledTraps, sNTPState=sNTPState, packetsFromInternalStack=packetsFromInternalStack, linkModeOptimization=linkModeOptimization, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, phyControlInstancedTable=phyControlInstancedTable, authorizationControlGroup=authorizationControlGroup, remoteInternetAddressLinked=remoteInternetAddressLinked, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, receiveFreqMHz=receiveFreqMHz, receiveFreqKHz=receiveFreqKHz, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, sMTPServerInternetAddressType=sMTPServerInternetAddressType, ethernetPriorityTable=ethernetPriorityTable, sNTPServerTableIndex=sNTPServerTableIndex, cableDiagnostics=cableDiagnostics, configurationGroup=configurationGroup, telnetAccessEnabled=telnetAccessEnabled, alarmInstancedTableNumber=alarmInstancedTableNumber, notificationsGroup=notificationsGroup, dNSServerInternetAddress=dNSServerInternetAddress, tDMChannelStatus=tDMChannelStatus, sNMPTrapVersion=sNMPTrapVersion, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, lowestTDMModulationMode=lowestTDMModulationMode, alarms=alarms, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, mainPSUPortAutoMdix=mainPSUPortAutoMdix, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tempPcb=tempPcb, supplementaryGroup=supplementaryGroup, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, softwareVersion=softwareVersion, wirelessLinkStatus=wirelessLinkStatus, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, txMABFrames=txMABFrames)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", auxPortSSMTx=auxPortSSMTx, syslogClientTrap=syslogClientTrap, byteErrorRatioLinked=byteErrorRatioLinked, rxColorCode=rxColorCode, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, wirelessTopology=wirelessTopology, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, telnetPortNumber=telnetPortNumber, licenseMaxLinkRange=licenseMaxLinkRange, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, sNTPServerStatus=sNTPServerStatus, l2CPPriorityTable=l2CPPriorityTable, sFPPortSSMTx=sFPPortSSMTx, subbandHighestFrequency=subbandHighestFrequency, licenseOOBManagementSupport=licenseOOBManagementSupport, channelChangeTrap=channelChangeTrap, masterSlaveMode=masterSlaveMode, receiveModulationMode=receiveModulationMode, auxPortAcceptedQLRx=auxPortAcceptedQLRx, range=range, mainPSUPortQLTx=mainPSUPortQLTx, blacklistRMEnabled=blacklistRMEnabled, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, timeZone=timeZone, ethernetInstancedTableIndex=ethernetInstancedTableIndex, licenseSecurityLevel=licenseSecurityLevel, installArmStateTrap=installArmStateTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, mgmtInstancedTableIndex=mgmtInstancedTableIndex, deviceMACAddress=deviceMACAddress, frequencyVariant=frequencyVariant, transmitModulationMode=transmitModulationMode, tDMChannelLoopback=tDMChannelLoopback, ethernetInstancedTable=ethernetInstancedTable, incompatibleRegulatoryBands=incompatibleRegulatoryBands, authorizationControlTableNumber=authorizationControlTableNumber, pubInstancedStatsTable=pubInstancedStatsTable, productName=productName, syslogControl=syslogControl, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, installationMode=installationMode, sNMPPortNumber=sNMPPortNumber, sFPPortAutoMdix=sFPPortAutoMdix, tFTPServerPortNumber=tFTPServerPortNumber, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, encryptionGroup=encryptionGroup, ethernetStatisticsDataSource=ethernetStatisticsDataSource, dNSResolver=dNSResolver, routerProtocols=routerProtocols, mABNominalTransmitCapacity=mABNominalTransmitCapacity, sNTPPollInterval=sNTPPollInterval, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, dNS=dNS, auxPortStatusTrap=auxPortStatusTrap)
