...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", mainPSUPortStatus=mainPSUPortStatus, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, remoteInternetAddressLinked=remoteInternetAddressLinked, receivePowerLinked=receivePowerLinked, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, sFPPortAllocation=sFPPortAllocation, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, regulatoryBandTrap=regulatoryBandTrap, mgmtInstancedTableEntry=mgmtInstancedTableEntry, capacityVariantMismatch=capacityVariantMismatch, remoteInternetAddressType=remoteInternetAddressType, alarmInstancedTable=alarmInstancedTable, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, ethernetInstancedTableNumber=ethernetInstancedTableNumber, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, licenseRegulatoryBandsList=licenseRegulatoryBandsList, phyControlInstancedTableIndex=phyControlInstancedTableIndex, management=management, sFPPortQLRx=sFPPortQLRx, userEnabled=userEnabled, wirelessLinkStatus=wirelessLinkStatus, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, tDMChannelCableLength=tDMChannelCableLength, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, nIDULanPortStatusTrap=nIDULanPortStatusTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, mABNominalTransmitCapacity=mABNominalTransmitCapacity, sNMPTrapTableEntry=sNMPTrapTableEntry, dNSGroup=dNSGroup, targetRange=targetRange, hCMPMaximumLinkRange=hCMPMaximumLinkRange, tFTPServerPortNumber=tFTPServerPortNumber, accessMethod=accessMethod, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, configurationInstancedTableEntry=configurationInstancedTableEntry, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, tDMChannelLoopback=tDMChannelLoopback, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, transmitPower=transmitPower, regulatoryBand=regulatoryBand, wirelessOutEthernetOctets=wirelessOutEthernetOctets, iPv6Address=iPv6Address, sNTPServerTableEntry=sNTPServerTableEntry, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, iPVersion=iPVersion, dataPortWirelessDownAlert=dataPortWirelessDownAlert, portAllocationMismatchLinked=portAllocationMismatchLinked, cableDiagPair2Results=cableDiagPair2Results, remoteInternetAddress=remoteInternetAddress, transparentClockVID=transparentClockVID, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, aggregateDataRate=aggregateDataRate, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, maximumNumberOfSlaves=maximumNumberOfSlaves, sNMPCommunityString=sNMPCommunityString, severelyErroredSeconds=severelyErroredSeconds, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, alarmInstancedTableIndex=alarmInstancedTableIndex, ptpTrapPrefix=ptpTrapPrefix, dfsTableEntry=dfsTableEntry, rangeLinked=rangeLinked, useVLANForManagementInterfaces=useVLANForManagementInterfaces, bridgeGroup=bridgeGroup, bridge=bridge, supplementary=supplementary, whitelistRMMacAddress=whitelistRMMacAddress, lowestDataModulationMode=lowestDataModulationMode, deviceESN=deviceESN, phyControlGroup=phyControlGroup, tFTPServerInternetAddress=tFTPServerInternetAddress, mainPSUPortStatusTrap=mainPSUPortStatusTrap, linkLoss=linkLoss, authorizationControl=authorizationControl, remoteMaximumTransmitPower=remoteMaximumTransmitPower, signalStrengthRatioLinked=signalStrengthRatioLinked, linkName=linkName, tFTPServerInternetAddressType=tFTPServerInternetAddressType, ethernet=ethernet, nIDULanPortAutoMdix=nIDULanPortAutoMdix, userTableIndex=userTableIndex, sNMPTrapTable=sNMPTrapTable, tDMInterfaceControl=tDMInterfaceControl, wirelessLinkAvailability=wirelessLinkAvailability, sntp=sntp, auxPortDisabledWarning=auxPortDisabledWarning, snmpControl=snmpControl, aAAControlGroup=aAAControlGroup, sFPPortSyncERxStatus=sFPPortSyncERxStatus, managementGroup=managementGroup, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, auxPortQLRx=auxPortQLRx, unavailableSeconds=unavailableSeconds, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, mABNominalModulationMode=mABNominalModulationMode, productVariant=productVariant, transmitFreqKHz=transmitFreqKHz, deviceMACAddress=deviceMACAddress, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, alarmInstancedTableNumber=alarmInstancedTableNumber, cambium=cambium, licenseCapacity=licenseCapacity, transmitDataRate=transmitDataRate, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, subnetMask=subnetMask, systemClock=systemClock, auxPortSyncERxStatus=auxPortSyncERxStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, noWirelessChannelAvailable=noWirelessChannelAvailable, mgmtInstancedTableIndex=mgmtInstancedTableIndex, licenseTrialPeriod=licenseTrialPeriod, masterSlaveMode=masterSlaveMode, receiveFreqKHz=receiveFreqKHz, bootVersion=bootVersion, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, gatewayIPAddress=gatewayIPAddress, vectorErrorLinked=vectorErrorLinked, installStatusLinked=installStatusLinked, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, sMTPServerInternetAddress=sMTPServerInternetAddress, auxPortAllocation=auxPortAllocation, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, groupID=groupID, mainPSUPortAllocation=mainPSUPortAllocation, userTableEntry=userTableEntry, userPassword=userPassword, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, tDMChannelStatus=tDMChannelStatus, sNMPTrapInternetAddress=sNMPTrapInternetAddress, wirelessOutOctets=wirelessOutOctets, installStatusTrap=installStatusTrap, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, remoteUnitName=remoteUnitName, alarmInstancedTableEntry=alarmInstancedTableEntry, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, mgmtInstancedTable=mgmtInstancedTable, licenseTLSRekey=licenseTLSRekey, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, remoteMACAddressLinked=remoteMACAddressLinked, range=range, sNTPSyncTrap=sNTPSyncTrap, dNS=dNS, licenseRARSupport=licenseRARSupport, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, vLANManagementPriority=vLANManagementPriority, sNMPTrapPortNumber=sNMPTrapPortNumber, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, searchStateLinked=searchStateLinked, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, smtpGroup=smtpGroup, aAAControl=aAAControl, configurationInstancedTable=configurationInstancedTable, cableDiagPair3Distance=cableDiagPair3Distance, syslogClient=syslogClient, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, mgmtInstancedTableNumber=mgmtInstancedTableNumber, mABProtocolVID=mABProtocolVID, hCMPLinkSymmetry=hCMPLinkSymmetry, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, versionsGroup=versionsGroup, mABHoldoffPeriod=mABHoldoffPeriod, cableDiagPair3Results=cableDiagPair3Results, dNSServerInternetAddress=dNSServerInternetAddress, nIDULanPortStatus=nIDULanPortStatus, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, sNTPLastSync=sNTPLastSync, sFPPortQLTx=sFPPortQLTx, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, eIRP=eIRP, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, transmitDataRateLinked=transmitDataRateLinked, licenseGroupAccess=licenseGroupAccess, managementPortWirelessDownAlert=managementPortWirelessDownAlert, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, dNSServerTableIndex=dNSServerTableIndex, iPv4Address=iPv4Address, tDDControlGroup=tDDControlGroup, dataBridgingStatusAlarm=dataBridgingStatusAlarm, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, alarmsGroup=alarmsGroup, rawReceivePowerLinked=rawReceivePowerLinked, pubStats=pubStats, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNTPSync=sNTPSync, qOSPriorityScheme=qOSPriorityScheme, auxPortSSMTx=auxPortSSMTx, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, telnetAccessEnabled=telnetAccessEnabled, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, transmitterChannels=transmitterChannels, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, searchState=searchState, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, aggregateDataRateLinked=aggregateDataRateLinked, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, managementNetworkAccessEnabled=managementNetworkAccessEnabled, ptp=ptp, sntpGroup=sntpGroup, transmitPowerLinked=transmitPowerLinked, unitName=unitName, authorizationControlTable=authorizationControlTable, ethernetPriorityTable=ethernetPriorityTable, incompatibleRegulatoryBands=incompatibleRegulatoryBands, packetsFromInternalStack=packetsFromInternalStack, tDDControl=tDDControl, subbandHighestFrequency=subbandHighestFrequency, incompatibleMasterAndSlave=incompatibleMasterAndSlave, antennaSelection=antennaSelection, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, licenseHCMPSupport=licenseHCMPSupport, maxLinkRangeExceeded=maxLinkRangeExceeded, supplementaryGroup=supplementaryGroup, syncESlavePort=syncESlavePort, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dfsTable=dfsTable, userTable=userTable, productName=productName, mainPSUPortAutoMdix=mainPSUPortAutoMdix, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, receiveChannel=receiveChannel, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, capacityVariantMismatchTrap=capacityVariantMismatchTrap, altitude=altitude, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, configurationGroup=configurationGroup, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, transmitFreqMHz=transmitFreqMHz, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, siteName=siteName, frequencyVariant=frequencyVariant, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, license=license, auxPortStatusTrap=auxPortStatusTrap, subbandLowestFrequency=subbandLowestFrequency, lbtDetectedTrap=lbtDetectedTrap, dfs=dfs)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, encryptionAlgorithm=encryptionAlgorithm, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, tdmTable=tdmTable, transparentClockVLAN=transparentClockVLAN, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, longitude=longitude, dSCPManagementPriority=dSCPManagementPriority, cableLoss=cableLoss, rxColorCode=rxColorCode, byteErrorRatioLinked=byteErrorRatioLinked, ethernetInstancedTable=ethernetInstancedTable, packetsToInternalStack=packetsToInternalStack, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, sNTPServerTableIndex=sNTPServerTableIndex, authorizationMethod=authorizationMethod, dfsTableNumber=dfsTableNumber, secondarySoftwareVersion=secondarySoftwareVersion, auxPortStatus=auxPortStatus, transparentClockPort=transparentClockPort, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, authorizationControlTableNumber=authorizationControlTableNumber, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, timeZone=timeZone, blacklistRMEnabled=blacklistRMEnabled, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, maximumTransmitPower=maximumTransmitPower, sNMPTrapVersion=sNMPTrapVersion, extendedSpectrumScanning=extendedSpectrumScanning, tdmTableIndex=tdmTableIndex, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, iPv6PrefixLength=iPv6PrefixLength, signalStrengthRatio=signalStrengthRatio, telnetPortNumber=telnetPortNumber, systemReset=systemReset, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogStateTrap=syslogStateTrap, secureModeAlarm=secureModeAlarm, sMTPEmailAlert=sMTPEmailAlert, installStatus=installStatus, receiveDataRate=receiveDataRate, dNSPrimaryServer=dNSPrimaryServer, tFTPClient=tFTPClient, installArmStateTrap=installArmStateTrap, dNSServerInternetAddressType=dNSServerInternetAddressType, ethernetGroup=ethernetGroup, mainPSUPortQLTx=mainPSUPortQLTx, l2CPPriorityTableEntry=l2CPPriorityTableEntry, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, tDMConfigurationMismatch=tDMConfigurationMismatch, licenseMaxLinkRange=licenseMaxLinkRange, sNTPServerInternetAddressType=sNTPServerInternetAddressType, ethernetStatisticsTable=ethernetStatisticsTable, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, notificationsGroup=notificationsGroup, sMTPEnabledMessages=sMTPEnabledMessages, remoteMACAddress=remoteMACAddress, encryptionGroup=encryptionGroup, PYSNMP_MODULE_ID=cambium, localPacketFiltering=localPacketFiltering, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, licenseInstancedTableIndex=licenseInstancedTableIndex, versions=versions, apc=apc, syslogControl=syslogControl, tDMChannelStatusTrap=tDMChannelStatusTrap, sNTPServerTimeout=sNTPServerTimeout, linkLossLinked=linkLossLinked, receiveDataRateLinked=receiveDataRateLinked, authorizationControlTableIndex=authorizationControlTableIndex, mABProtocolVLANPriority=mABProtocolVLANPriority, dNSServerTableEntry=dNSServerTableEntry, secureModeAlarmTrap=secureModeAlarmTrap, phyControl=phyControl, routerProtocolsGroup=routerProtocolsGroup, dataBridgingStatus=dataBridgingStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, authorizationControlTableEntry=authorizationControlTableEntry, licenseSecurityLevel=licenseSecurityLevel, vectorError=vectorError, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, targetMACAddress=targetMACAddress, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, l2CPPriorityTableNumber=l2CPPriorityTableNumber, tDMEnabledChannels=tDMEnabledChannels, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, configuration=configuration, resetGroup=resetGroup, capacityVariantMismatchLinked=capacityVariantMismatchLinked, configurationInstancedTableIndex=configurationInstancedTableIndex, userTableNumber=userTableNumber, authorizationControlGroup=authorizationControlGroup, ptp670=ptp670, licenseSyncESupport=licenseSyncESupport, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, apcGroup=apcGroup, licenseSFPPortSupport=licenseSFPPortSupport, enabledDiagnosticAlarms=enabledDiagnosticAlarms, unitIdentificationGroup=unitIdentificationGroup, rawReceivePower=rawReceivePower, licenseInstancedTable=licenseInstancedTable, syslogClientTrap=syslogClientTrap, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, syslogLocalWrappedTrap=syslogLocalWrappedTrap, latitude=latitude, tempPcb=tempPcb, syncETracking=syncETracking, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, installArmState=installArmState, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, sMTPServerInternetAddressType=sMTPServerInternetAddressType, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, receivePower=receivePower, channelChangeTrap=channelChangeTrap, sFPPortStatus=sFPPortStatus, antennaGain=antennaGain, licenseTDDSyncSupport=licenseTDDSyncSupport, sFPError=sFPError, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, txMABFrames=txMABFrames, hTTPSPortNumber=hTTPSPortNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, tDMChannelLineCode=tDMChannelLineCode, encryption=encryption, sFPPortSSMTx=sFPPortSSMTx, tDDSynchronizationMode=tDDSynchronizationMode, receiveFreqMHz=receiveFreqMHz, licenseIEEE1588Support=licenseIEEE1588Support, licenseVersion=licenseVersion, cableDiagnosticsControl=cableDiagnosticsControl, dataBridgingStatusLinked=dataBridgingStatusLinked, dfsPeaks=dfsPeaks, ptmp=ptmp, transmitChannel=transmitChannel, licenseUnitSerialNumber=licenseUnitSerialNumber, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, dNSServerTableNumber=dNSServerTableNumber, userRole=userRole, mABState=mABState, routerProtocols=routerProtocols, licenseGasGroup=licenseGasGroup, licenseInstancedTableNumber=licenseInstancedTableNumber, sFPPortAutoNegotiation=sFPPortAutoNegotiation, licenseIPv6Support=licenseIPv6Support, ptpGroups=ptpGroups, sNMPPortNumber=sNMPPortNumber, ptpTraps=ptpTraps, sNMPv3Enable=sNMPv3Enable, dNSServerPortNumber=dNSServerPortNumber, cableDiagPair4Distance=cableDiagPair4Distance, licenseGroup=licenseGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, cableDiagnostics=cableDiagnostics, sNTPServerTable=sNTPServerTable, dfsGroup=dfsGroup, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tdmTableNumber=tdmTableNumber, syncETrackingState=syncETrackingState, ethernetPriorityTableEntry=ethernetPriorityTableEntry, iPDSCPPriorityTable=iPDSCPPriorityTable, sNTPServerTableNumber=sNTPServerTableNumber, cableDiagPair2Distance=cableDiagPair2Distance, cableDiagnosticsWarning=cableDiagnosticsWarning, pubInstancedStatsTable=pubInstancedStatsTable, byteErrorRatio=byteErrorRatio, cableDiagPair1Distance=cableDiagPair1Distance, iPv6GatewayAddress=iPv6GatewayAddress, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, dNSServerTable=dNSServerTable, receiveModulationModeLinked=receiveModulationModeLinked, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, receiveModulationModeDetail=receiveModulationModeDetail, wirelessOutAllOctets=wirelessOutAllOctets, unitIdentification=unitIdentification, sNTPServerStatus=sNTPServerStatus, linkSymmetry=linkSymmetry, mABTransmissionInterval=mABTransmissionInterval, ethernetInstancedTableEntry=ethernetInstancedTableEntry, dfsMeans=dfsMeans, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, linkModeOptimization=linkModeOptimization, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, phyControlInstancedTableNumber=phyControlInstancedTableNumber, phyStatus=phyStatus, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, transparentClock=transparentClock, sFPPortAutoMdix=sFPPortAutoMdix, softwareVersion=softwareVersion, ethernetStatisticsDataSource=ethernetStatisticsDataSource, wirelessLinkStatusLinked=wirelessLinkStatusLinked, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, smtp=smtp, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, sFPPortDisabledWarning=sFPPortDisabledWarning, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, phyControlInstancedTableEntry=phyControlInstancedTableEntry, sNTPPrimaryServer=sNTPPrimaryServer, oOBPriorityQueueMapping=oOBPriorityQueueMapping, txColorCode=txColorCode, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, transmitModulationModeLinked=transmitModulationModeLinked, cableDiagnosticsResultTable=cableDiagnosticsResultTable, tdmTableEntry=tdmTableEntry, hTTPPortNumber=hTTPPortNumber, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, sNTPState=sNTPState, mainPSUPortSSMTx=mainPSUPortSSMTx, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, remoteUnitNameLinked=remoteUnitNameLinked, dNSResolver=dNSResolver, portAllocationMismatchTrap=portAllocationMismatchTrap, licenseBandwidthCap=licenseBandwidthCap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNTPServerPortNumber=sNTPServerPortNumber, transmitModulationMode=transmitModulationMode, licenseCountry=licenseCountry, syncEEquipmentClock=syncEEquipmentClock, cableDiagnosticsPorts=cableDiagnosticsPorts, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, hTTPAccessEnabled=hTTPAccessEnabled, phyControlInstancedTable=phyControlInstancedTable, syslogState=syslogState, auxPortQLTx=auxPortQLTx, whitelistRMEnabled=whitelistRMEnabled, tDM=tDM, cableDiagnosticsGroup=cableDiagnosticsGroup, wirelessTopology=wirelessTopology, erroredSeconds=erroredSeconds, alarms=alarms, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, auxPortConfigurationMismatch=auxPortConfigurationMismatch, dfsTableIndex=dfsTableIndex, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, portAllocationMismatch=portAllocationMismatch, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", hardwareVersion=hardwareVersion, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, blacklistRMMacAddress=blacklistRMMacAddress, sNTPPollInterval=sNTPPollInterval, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, auxPortAcceptedQLRx=auxPortAcceptedQLRx, vLANManagementVID=vLANManagementVID, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, sMTPServerPortNumber=sMTPServerPortNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, configurationInstancedTableNumber=configurationInstancedTableNumber, sNTPServerInternetAddress=sNTPServerInternetAddress, daylightSaving=daylightSaving, phyStatusGroup=phyStatusGroup, sNTPServerRetries=sNTPServerRetries, dataPortPauseFrames=dataPortPauseFrames, deviceMSN=deviceMSN, tDMInterfaceStatus=tDMInterfaceStatus, userName=userName, reset=reset, sFPPortStatusTrap=sFPPortStatusTrap, snmpControlGroup=snmpControlGroup, tDMGroup=tDMGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, mABMaintenanceLevel=mABMaintenanceLevel, l2CPPriorityTable=l2CPPriorityTable, cableDiagPair1Results=cableDiagPair1Results, enableTransmission=enableTransmission, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, mainPSUPortQLRx=mainPSUPortQLRx, ptpCompliance=ptpCompliance, cableDiagPair4Results=cableDiagPair4Results, rangingMode=rangingMode, unitOutOfCalibration=unitOutOfCalibration, lowestTDMModulationMode=lowestTDMModulationMode, installationMode=installationMode, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, ethernetPriorityTableIndex=ethernetPriorityTableIndex, syslogControlGroup=syslogControlGroup, channelBandwidth=channelBandwidth, pubStatsGroup=pubStatsGroup, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, useVLANForMABProtocol=useVLANForMABProtocol, receiveModulationMode=receiveModulationMode, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, licenseOOBManagementSupport=licenseOOBManagementSupport, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, licenseIssueNumber=licenseIssueNumber, sFPErrorTrap=sFPErrorTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, licenseEncryption=licenseEncryption, licenseInstancedTableEntry=licenseInstancedTableEntry, phyInstancedStatusTable=phyInstancedStatusTable, dataBridgingAvailability=dataBridgingAvailability, ethernetInstancedTableIndex=ethernetInstancedTableIndex, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap)
