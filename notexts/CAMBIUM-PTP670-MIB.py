...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", phyControlInstancedTable=phyControlInstancedTable, maximumNumberOfSlaves=maximumNumberOfSlaves, linkModeOptimizationMismatch=linkModeOptimizationMismatch, iPDSCPPriorityTable=iPDSCPPriorityTable, erroredSeconds=erroredSeconds, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, alarmInstancedTable=alarmInstancedTable, bridge=bridge, sNTPServerInternetAddress=sNTPServerInternetAddress, installArmStateTrap=installArmStateTrap, cableDiagPair2Distance=cableDiagPair2Distance, mgmtInstancedTableIndex=mgmtInstancedTableIndex, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, ptpTrapPrefix=ptpTrapPrefix, sntpGroup=sntpGroup, sFPErrorTrap=sFPErrorTrap, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, wirelessTopology=wirelessTopology, packetsToInternalStack=packetsToInternalStack, installStatusLinked=installStatusLinked, dNSServerTableNumber=dNSServerTableNumber, productName=productName, userName=userName, ethernetInstancedTableIndex=ethernetInstancedTableIndex, alarmInstancedTableEntry=alarmInstancedTableEntry, mainPSUPortStatusTrap=mainPSUPortStatusTrap, pubStatsGroup=pubStatsGroup, authorizationControlGroup=authorizationControlGroup, licenseMaxLinkRange=licenseMaxLinkRange, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, mgmtInstancedTableEntry=mgmtInstancedTableEntry, mABState=mABState, mABTransmissionInterval=mABTransmissionInterval, PYSNMP_MODULE_ID=cambium, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, userTableNumber=userTableNumber, cableDiagnosticsPorts=cableDiagnosticsPorts, tDMGroup=tDMGroup, sFPPortAutoNegotiation=sFPPortAutoNegotiation, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, timeZone=timeZone, tDDSynchronizationMode=tDDSynchronizationMode, tdmTableEntry=tdmTableEntry, auxPortStatusTrap=auxPortStatusTrap, syncESlavePort=syncESlavePort, supplementaryGroup=supplementaryGroup, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, syslogControl=syslogControl, dfs=dfs, lbtDetectedTrap=lbtDetectedTrap, remoteMACAddress=remoteMACAddress, aAAControlGroup=aAAControlGroup, alarms=alarms, bridgeGroup=bridgeGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, byteErrorRatio=byteErrorRatio, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, sFPPortAllocation=sFPPortAllocation, mgmtInstancedTable=mgmtInstancedTable, searchState=searchState, sNTPServerTableNumber=sNTPServerTableNumber, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, cableDiagPair2Results=cableDiagPair2Results, qOSPriorityScheme=qOSPriorityScheme, incompatibleRegulatoryBands=incompatibleRegulatoryBands, receiveFreqMHz=receiveFreqMHz, ethernetInstancedTable=ethernetInstancedTable, tdmTableNumber=tdmTableNumber, dataBridgingStatus=dataBridgingStatus, dataBridgingAvailability=dataBridgingAvailability, wirelessOutOctets=wirelessOutOctets, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, blacklistRMEnabled=blacklistRMEnabled, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, authorizationControlTable=authorizationControlTable, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, ptpTraps=ptpTraps, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, sNMPTrapTableIndex=sNMPTrapTableIndex, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, sNMPTrapTable=sNMPTrapTable, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, resetGroup=resetGroup, licenseTrialPeriod=licenseTrialPeriod, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, unitOutOfCalibration=unitOutOfCalibration, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, auxPortStatus=auxPortStatus, transparentClockVID=transparentClockVID, rawReceivePower=rawReceivePower, tDMChannelCableLength=tDMChannelCableLength, hTTPPortNumber=hTTPPortNumber, wirelessLinkStatus=wirelessLinkStatus, licenseVersion=licenseVersion, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPServerTable=sNTPServerTable, configurationInstancedTableIndex=configurationInstancedTableIndex, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, linkName=linkName, managementNetworkAccessEnabled=managementNetworkAccessEnabled, useVLANForManagementInterfaces=useVLANForManagementInterfaces, authorizationControl=authorizationControl, dfsTableIndex=dfsTableIndex, remoteInternetAddressLinked=remoteInternetAddressLinked, phyInstancedStatusTable=phyInstancedStatusTable, mABNominalModulationMode=mABNominalModulationMode, tFTPServerPortNumber=tFTPServerPortNumber, sNTPServerTableEntry=sNTPServerTableEntry, phyControlGroup=phyControlGroup, supplementary=supplementary, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, sNTPSync=sNTPSync, ptpGroups=ptpGroups, receivePower=receivePower, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, portAllocationMismatch=portAllocationMismatch, alarmInstancedTableIndex=alarmInstancedTableIndex, sMTPServerPortNumber=sMTPServerPortNumber, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, cableDiagnosticsResultTable=cableDiagnosticsResultTable, auxPortSSMTx=auxPortSSMTx, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, licenseGroupAccess=licenseGroupAccess, sFPPortQLTx=sFPPortQLTx, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, phyControlInstancedTableEntry=phyControlInstancedTableEntry, tDMChannelLoopback=tDMChannelLoopback, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, deviceMACAddress=deviceMACAddress, dataBridgingStatusLinked=dataBridgingStatusLinked, phyControlInstancedTableNumber=phyControlInstancedTableNumber, wirelessOutAllOctets=wirelessOutAllOctets, rxColorCode=rxColorCode, receiveModulationModeLinked=receiveModulationModeLinked, transmitPower=transmitPower, dfsGroup=dfsGroup, sFPError=sFPError, ethernetStatisticsTable=ethernetStatisticsTable, sNTPLastSync=sNTPLastSync, syslogClient=syslogClient, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, ethernetGroup=ethernetGroup, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, tDMEnabledChannels=tDMEnabledChannels, cableDiagPair3Distance=cableDiagPair3Distance, phyStatusGroup=phyStatusGroup, licenseUnitSerialNumber=licenseUnitSerialNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, accessMethod=accessMethod, licenseCapacity=licenseCapacity, syncETracking=syncETracking, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, tDDSynchronizationAlarm=tDDSynchronizationAlarm, syslogControlGroup=syslogControlGroup, iPv4Address=iPv4Address, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, cableDiagPair1Distance=cableDiagPair1Distance, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, tDMChannelLineCode=tDMChannelLineCode, alarmsGroup=alarmsGroup, receiveModulationMode=receiveModulationMode, range=range, syslogLocalWrappedTrap=syslogLocalWrappedTrap, licenseRegulatoryBandsList=licenseRegulatoryBandsList, sNTPState=sNTPState, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, installationMode=installationMode, receivePowerLinked=receivePowerLinked, snmpControlGroup=snmpControlGroup, installArmState=installArmState, dNSServerInternetAddressType=dNSServerInternetAddressType, dfsMeans=dfsMeans, linkModeOptimization=linkModeOptimization, byteErrorRatioLinked=byteErrorRatioLinked, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, siteName=siteName, aAAControl=aAAControl, tDDSynchronizationStatus=tDDSynchronizationStatus, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, sNTPServerTimeout=sNTPServerTimeout, licenseRARSupport=licenseRARSupport, dNSServerInternetAddress=dNSServerInternetAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, versionsGroup=versionsGroup, antennaSelection=antennaSelection, tdmTable=tdmTable, wirelessLinkStatusLinked=wirelessLinkStatusLinked, targetRange=targetRange, mainPSUPortAllocation=mainPSUPortAllocation, dNS=dNS, licenseEncryption=licenseEncryption, authorizationControlTableNumber=authorizationControlTableNumber, sNMPTrapVersion=sNMPTrapVersion, tDMConfigurationMismatch=tDMConfigurationMismatch, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, license=license, rawReceivePowerLinked=rawReceivePowerLinked, lowestDataModulationMode=lowestDataModulationMode, useVLANForMABProtocol=useVLANForMABProtocol, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, sNMPEnabledTraps=sNMPEnabledTraps, configurationInstancedTable=configurationInstancedTable, hTTPSAccessEnabled=hTTPSAccessEnabled, whitelistRMMacAddress=whitelistRMMacAddress, userTableIndex=userTableIndex, userPassword=userPassword, subbandLowestFrequency=subbandLowestFrequency, systemClock=systemClock, licenseBandwidthCap=licenseBandwidthCap, sNMPPortNumber=sNMPPortNumber, deviceESN=deviceESN, dNSServerPortNumber=dNSServerPortNumber, enableTransmission=enableTransmission, vLANManagementPriority=vLANManagementPriority, rangeLinked=rangeLinked, sMTPServerInternetAddress=sMTPServerInternetAddress, bootVersion=bootVersion, unitIdentificationGroup=unitIdentificationGroup, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, linkLoss=linkLoss, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, iPVersion=iPVersion, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, smtpGroup=smtpGroup, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, sNTPPrimaryServer=sNTPPrimaryServer, wirelessOutEthernetOctets=wirelessOutEthernetOctets, licenseIEEE1588Support=licenseIEEE1588Support, sFPPortStatus=sFPPortStatus, sNTPServerTableIndex=sNTPServerTableIndex, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, l2CPPriorityTable=l2CPPriorityTable, mainPSUPortSSMTx=mainPSUPortSSMTx, mABNominalTransmitCapacity=mABNominalTransmitCapacity, tDDControlGroup=tDDControlGroup, cableLoss=cableLoss, notificationsGroup=notificationsGroup, dNSServerTable=dNSServerTable, remoteInternetAddress=remoteInternetAddress, tFTPClient=tFTPClient)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, licenseOOBManagementSupport=licenseOOBManagementSupport, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, longitude=longitude, ethernet=ethernet, licenseHCMPSupport=licenseHCMPSupport, transmitModulationModeLinked=transmitModulationModeLinked, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, hardwareVersion=hardwareVersion, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, sFPPortSSMTx=sFPPortSSMTx, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, transmitDataRate=transmitDataRate, versions=versions, tempPcb=tempPcb, transmitterChannels=transmitterChannels, altitude=altitude, apcGroup=apcGroup, userRole=userRole, txColorCode=txColorCode, hCMPLinkSymmetry=hCMPLinkSymmetry, licenseIPv6Support=licenseIPv6Support, antennaGain=antennaGain, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, userTable=userTable, subnetMask=subnetMask, installStatus=installStatus, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, mABProtocolVID=mABProtocolVID, reset=reset, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, licenseCountry=licenseCountry, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, phyStatus=phyStatus, sNTPServerPortNumber=sNTPServerPortNumber, managementGroup=managementGroup, sNMPv3Enable=sNMPv3Enable, iPv6PrefixLength=iPv6PrefixLength, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, nIDULanPortStatus=nIDULanPortStatus, remoteMACAddressLinked=remoteMACAddressLinked, auxPortConfigurationMismatch=auxPortConfigurationMismatch, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, mABProtocolVLANPriority=mABProtocolVLANPriority, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, aggregateDataRateLinked=aggregateDataRateLinked, iPv6Address=iPv6Address, licenseTLSRekey=licenseTLSRekey, l2CPPriorityTableEntry=l2CPPriorityTableEntry, managementPortWirelessDownAlert=managementPortWirelessDownAlert, telnetPortNumber=telnetPortNumber, sNMPCommunityString=sNMPCommunityString, extendedSpectrumScanning=extendedSpectrumScanning, hTTPSPortNumber=hTTPSPortNumber, ptp=ptp, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, ethernetPriorityTable=ethernetPriorityTable, aggregateDataRate=aggregateDataRate, sNMPTrapPortNumber=sNMPTrapPortNumber, mainPSUPortQLRx=mainPSUPortQLRx, phyControlInstancedTableIndex=phyControlInstancedTableIndex, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, channelBandwidth=channelBandwidth, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, receiveChannel=receiveChannel, l2CPPriorityTableIndex=l2CPPriorityTableIndex, maximumTransmitPower=maximumTransmitPower, licenseInstancedTable=licenseInstancedTable, snmpControl=snmpControl, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, masterSlaveMode=masterSlaveMode, ethernetStatisticsDataSource=ethernetStatisticsDataSource, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, vectorErrorLinked=vectorErrorLinked, signalStrengthRatioLinked=signalStrengthRatioLinked, sMTPServerInternetAddressType=sMTPServerInternetAddressType, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, mainPSUPortQLTx=mainPSUPortQLTx, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, sNTPSyncTrap=sNTPSyncTrap, mABMaintenanceLevel=mABMaintenanceLevel, apc=apc, sFPPortSyncERxStatus=sFPPortSyncERxStatus, cableDiagnosticsWarning=cableDiagnosticsWarning, licenseInstancedTableEntry=licenseInstancedTableEntry, unitIdentification=unitIdentification, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, phyControl=phyControl, tDMInterfaceControl=tDMInterfaceControl, cambium=cambium, sFPPortStatusTrap=sFPPortStatusTrap, wirelessLinkAvailability=wirelessLinkAvailability, transparentClockVLAN=transparentClockVLAN, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, daylightSaving=daylightSaving, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, targetMACAddress=targetMACAddress, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, subbandHighestFrequency=subbandHighestFrequency, enabledDiagnosticAlarms=enabledDiagnosticAlarms, mgmtInstancedTableNumber=mgmtInstancedTableNumber, dNSServerTableIndex=dNSServerTableIndex, productVariant=productVariant, telnetAccessEnabled=telnetAccessEnabled, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, userEnabled=userEnabled, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPTrapInternetAddress=sNMPTrapInternetAddress, encryptionGroup=encryptionGroup, localPacketFiltering=localPacketFiltering, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, ptp670=ptp670, nIDULanPortAutoMdix=nIDULanPortAutoMdix, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, signalStrengthRatio=signalStrengthRatio, dfsTableEntry=dfsTableEntry, dSCPManagementPriority=dSCPManagementPriority, capacityVariantMismatchLinked=capacityVariantMismatchLinked, pubStats=pubStats, licenseTDDSyncSupport=licenseTDDSyncSupport, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, tdmTableIndex=tdmTableIndex, licenseInstancedTableIndex=licenseInstancedTableIndex, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, ethernetInstancedTableEntry=ethernetInstancedTableEntry, systemReset=systemReset, cableDiagnosticsControl=cableDiagnosticsControl, sMTPEmailAlert=sMTPEmailAlert, licenseInstancedTableNumber=licenseInstancedTableNumber, userTableEntry=userTableEntry, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, transmitFreqKHz=transmitFreqKHz, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, frequencyVariant=frequencyVariant, rangingMode=rangingMode, ethernetPriorityTableIndex=ethernetPriorityTableIndex, linkSymmetry=linkSymmetry, cableDiagnosticsGroup=cableDiagnosticsGroup, mABHoldoffPeriod=mABHoldoffPeriod, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, configurationGroup=configurationGroup, capacityVariantMismatch=capacityVariantMismatch, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, latitude=latitude, ethernetInstancedTableNumber=ethernetInstancedTableNumber, tDMInterfaceStatus=tDMInterfaceStatus, whitelistRMEnabled=whitelistRMEnabled, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, lowestTDMModulationMode=lowestTDMModulationMode, transmitDataRateLinked=transmitDataRateLinked, transmitChannel=transmitChannel, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, sNTPServerStatus=sNTPServerStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, licenseGasGroup=licenseGasGroup, management=management, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, portAllocationMismatchLinked=portAllocationMismatchLinked, smtp=smtp, severelyErroredSeconds=severelyErroredSeconds, ptpCompliance=ptpCompliance, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, licenseIssueNumber=licenseIssueNumber, unitName=unitName, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, vectorError=vectorError, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, groupID=groupID, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, unavailableSeconds=unavailableSeconds, auxPortAcceptedQLRx=auxPortAcceptedQLRx, syslogClientTrap=syslogClientTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, authorizationControlTableIndex=authorizationControlTableIndex, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, maxLinkRangeExceeded=maxLinkRangeExceeded, remoteInternetAddressType=remoteInternetAddressType, configuration=configuration, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, configurationInstancedTableNumber=configurationInstancedTableNumber, authorizationControlTableEntry=authorizationControlTableEntry, syslogState=syslogState, transparentClockPort=transparentClockPort, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, sNMPTrapTableEntry=sNMPTrapTableEntry, receiveDataRateLinked=receiveDataRateLinked, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, channelChangeTrap=channelChangeTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, auxPortQLRx=auxPortQLRx, linkLossLinked=linkLossLinked, softwareVersion=softwareVersion, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, eIRP=eIRP, cableDiagPair1Results=cableDiagPair1Results, receiveDataRate=receiveDataRate, dNSServerTableEntry=dNSServerTableEntry, tDMChannelStatus=tDMChannelStatus, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, auxPortQLTx=auxPortQLTx, vLANManagementVID=vLANManagementVID, sFPPortAutoMdix=sFPPortAutoMdix, regulatoryBandTrap=regulatoryBandTrap, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, routerProtocolsGroup=routerProtocolsGroup, pubInstancedStatsTable=pubInstancedStatsTable, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tDM=tDM, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, ptmp=ptmp, oOBPriorityQueueMapping=oOBPriorityQueueMapping, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, alarmInstancedTableNumber=alarmInstancedTableNumber, sMTPEnabledMessages=sMTPEnabledMessages, transmitPowerLinked=transmitPowerLinked, cableDiagPair3Results=cableDiagPair3Results, receiveFreqKHz=receiveFreqKHz, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, transparentClock=transparentClock, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsTable=dfsTable, ethernetPriorityTableNumber=ethernetPriorityTableNumber, secureModeAlarm=secureModeAlarm, sNTPPollInterval=sNTPPollInterval, syncETrackingState=syncETrackingState, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dNSResolver=dNSResolver, mainPSUPortStatus=mainPSUPortStatus, auxPortAllocation=auxPortAllocation, cableDiagnostics=cableDiagnostics, dfsPeaks=dfsPeaks, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, txMABFrames=txMABFrames)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", tDMChannelStatusTrap=tDMChannelStatusTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, packetsFromInternalStack=packetsFromInternalStack, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, regulatoryBand=regulatoryBand, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, portAllocationMismatchTrap=portAllocationMismatchTrap, mainPSUPortAutoMdix=mainPSUPortAutoMdix, authorizationMethod=authorizationMethod, licenseSecurityLevel=licenseSecurityLevel, gatewayIPAddress=gatewayIPAddress, sFPPortQLRx=sFPPortQLRx, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, transmitModulationMode=transmitModulationMode, sFPPortDisabledWarning=sFPPortDisabledWarning, tDDControl=tDDControl, cableDiagPair4Distance=cableDiagPair4Distance, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, searchStateLinked=searchStateLinked, encryptionAlgorithm=encryptionAlgorithm, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, hCMPMaximumLinkRange=hCMPMaximumLinkRange, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, nIDULanPortStatusTrap=nIDULanPortStatusTrap, dNSGroup=dNSGroup, sNTPServerRetries=sNTPServerRetries, syncEEquipmentClock=syncEEquipmentClock, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, syslogStateTrap=syslogStateTrap, remoteUnitName=remoteUnitName, capacityVariantMismatchTrap=capacityVariantMismatchTrap, dataPortPauseFrames=dataPortPauseFrames, sntp=sntp, licenseSFPPortSupport=licenseSFPPortSupport, iPv6GatewayAddress=iPv6GatewayAddress, secureModeAlarmTrap=secureModeAlarmTrap, routerProtocols=routerProtocols, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, blacklistRMMacAddress=blacklistRMMacAddress, tFTPServerInternetAddress=tFTPServerInternetAddress, licenseSyncESupport=licenseSyncESupport, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, installStatusTrap=installStatusTrap, deviceMSN=deviceMSN, secondarySoftwareVersion=secondarySoftwareVersion, licenseGroup=licenseGroup, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dfsTableNumber=dfsTableNumber, dNSPrimaryServer=dNSPrimaryServer, auxPortDisabledWarning=auxPortDisabledWarning, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, transmitFreqMHz=transmitFreqMHz, receiveModulationModeDetail=receiveModulationModeDetail, remoteUnitNameLinked=remoteUnitNameLinked, hTTPAccessEnabled=hTTPAccessEnabled, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, dataBridgingStatusAlarm=dataBridgingStatusAlarm, auxPortSyncERxStatus=auxPortSyncERxStatus, cableDiagPair4Results=cableDiagPair4Results, tFTPServerInternetAddressType=tFTPServerInternetAddressType, encryption=encryption, configurationInstancedTableEntry=configurationInstancedTableEntry)
