...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", altitude=altitude, hCMPLinkSymmetry=hCMPLinkSymmetry, licenseEncryption=licenseEncryption, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, mABState=mABState, routerProtocolsGroup=routerProtocolsGroup, aggregateDataRateLinked=aggregateDataRateLinked, dataBridgingStatusLinked=dataBridgingStatusLinked, aAAControl=aAAControl, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, encryptionGroup=encryptionGroup, alarmInstancedTableNumber=alarmInstancedTableNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, remoteUnitNameLinked=remoteUnitNameLinked, transparentClockPort=transparentClockPort, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, installStatusTrap=installStatusTrap, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, longitude=longitude, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, signalStrengthRatioLinked=signalStrengthRatioLinked, productName=productName, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sMTPServerInternetAddress=sMTPServerInternetAddress, management=management, auxPortQLTx=auxPortQLTx, remoteInternetAddressType=remoteInternetAddressType, syslogStateTrap=syslogStateTrap, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, sNTPServerTableEntry=sNTPServerTableEntry, sMTPServerInternetAddressType=sMTPServerInternetAddressType, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, phyControlInstancedTableNumber=phyControlInstancedTableNumber, mABProtocolVID=mABProtocolVID, hardwareVersion=hardwareVersion, subnetMask=subnetMask, ethernetInstancedTableNumber=ethernetInstancedTableNumber, deviceMACAddress=deviceMACAddress, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, syslogClientTrap=syslogClientTrap, iPv6Address=iPv6Address, targetMACAddress=targetMACAddress, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, licenseSyncESupport=licenseSyncESupport, licenseInstancedTableIndex=licenseInstancedTableIndex, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, license=license, iPv4Address=iPv4Address, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, auxPortAcceptedQLRx=auxPortAcceptedQLRx, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, nIDULanPortStatusTrap=nIDULanPortStatusTrap, sFPPortQLTx=sFPPortQLTx, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, receivePowerLinked=receivePowerLinked, transmitChannel=transmitChannel, regulatoryBand=regulatoryBand, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, auxPortStatusTrap=auxPortStatusTrap, antennaGain=antennaGain, regulatoryBandTrap=regulatoryBandTrap, authorizationControlTableIndex=authorizationControlTableIndex, channelChangeTrap=channelChangeTrap, tDDControlGroup=tDDControlGroup, latitude=latitude, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, receiveFreqMHz=receiveFreqMHz, auxPortSSMTx=auxPortSSMTx, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, qOSPriorityScheme=qOSPriorityScheme, useVLANForMABProtocol=useVLANForMABProtocol, extendedSpectrumScanning=extendedSpectrumScanning, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, hTTPSAccessEnabled=hTTPSAccessEnabled, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, wirelessOutOctets=wirelessOutOctets, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, tdmTable=tdmTable, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, phyControlInstancedTableIndex=phyControlInstancedTableIndex, userPassword=userPassword, cableDiagnostics=cableDiagnostics, dataBridgingStatusAlarm=dataBridgingStatusAlarm, byteErrorRatioLinked=byteErrorRatioLinked, remoteMACAddress=remoteMACAddress, mainPSUPortSSMTx=mainPSUPortSSMTx, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, auxPortConfigurationMismatch=auxPortConfigurationMismatch, mABTransmissionInterval=mABTransmissionInterval, alarmInstancedTableEntry=alarmInstancedTableEntry, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, dNS=dNS, tdmTableEntry=tdmTableEntry, pubInstancedStatsTable=pubInstancedStatsTable, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, cableDiagPair3Distance=cableDiagPair3Distance, txMABFrames=txMABFrames, sntp=sntp, installArmState=installArmState, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, snmpControl=snmpControl, phyControlInstancedTable=phyControlInstancedTable, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, tDMChannelCableLength=tDMChannelCableLength, unitIdentificationGroup=unitIdentificationGroup, eIRP=eIRP, nIDULanPortAutoMdix=nIDULanPortAutoMdix, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, dNSServerInternetAddressType=dNSServerInternetAddressType, syslogControlGroup=syslogControlGroup, configurationInstancedTableEntry=configurationInstancedTableEntry, sNTPServerPortNumber=sNTPServerPortNumber, sNMPTrapInternetAddress=sNMPTrapInternetAddress, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, authorizationMethod=authorizationMethod, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, userRole=userRole, configuration=configuration, unitIdentification=unitIdentification, capacityVariantMismatch=capacityVariantMismatch, dataBridgingStatus=dataBridgingStatus, auxPortAllocation=auxPortAllocation, hTTPAccessEnabled=hTTPAccessEnabled, installationMode=installationMode, licenseGroup=licenseGroup, receiveModulationModeLinked=receiveModulationModeLinked, gatewayIPAddress=gatewayIPAddress, tDMGroup=tDMGroup, mPLSTCPriorityTable=mPLSTCPriorityTable, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, sNTPLastSync=sNTPLastSync, encryption=encryption, sNTPServerTableIndex=sNTPServerTableIndex, hCMPMaximumLinkRange=hCMPMaximumLinkRange, packetsToInternalStack=packetsToInternalStack, daylightSaving=daylightSaving, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, supplementaryGroup=supplementaryGroup, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, licenseInstancedTableNumber=licenseInstancedTableNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, blacklistRMEnabled=blacklistRMEnabled, encryptionAlgorithm=encryptionAlgorithm, tDMChannelStatusTrap=tDMChannelStatusTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, portAllocationMismatchTrap=portAllocationMismatchTrap, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, installArmStateTrap=installArmStateTrap, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, tFTPServerPortNumber=tFTPServerPortNumber, licenseRegulatoryBandsList=licenseRegulatoryBandsList, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, transparentClockVLAN=transparentClockVLAN, syncETracking=syncETracking, searchStateLinked=searchStateLinked, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, mainPSUPortAllocation=mainPSUPortAllocation, linkLossLinked=linkLossLinked, dfsTableIndex=dfsTableIndex, mgmtInstancedTable=mgmtInstancedTable, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dNSServerPortNumber=dNSServerPortNumber, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, phyStatus=phyStatus, userEnabled=userEnabled, iPv6GatewayAddress=iPv6GatewayAddress, cableDiagPair1Distance=cableDiagPair1Distance, PYSNMP_MODULE_ID=cambium, receiveDataRateLinked=receiveDataRateLinked, sFPPortSSMTx=sFPPortSSMTx, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, ptp670=ptp670, dfsGroup=dfsGroup, dfs=dfs, packetsFromInternalStack=packetsFromInternalStack, sNMPEnabledTraps=sNMPEnabledTraps, sNTPServerRetries=sNTPServerRetries, masterSlaveMode=masterSlaveMode, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, systemClock=systemClock, sNTPServerTableNumber=sNTPServerTableNumber, licenseSecurityLevel=licenseSecurityLevel, syncETrackingState=syncETrackingState, sMTPEmailAlert=sMTPEmailAlert, notificationsGroup=notificationsGroup, rawReceivePower=rawReceivePower, cableDiagnosticsGroup=cableDiagnosticsGroup, licenseIEEE1588Support=licenseIEEE1588Support, remoteInternetAddress=remoteInternetAddress, sNTPState=sNTPState, wirelessOutAllOctets=wirelessOutAllOctets, ethernetGroup=ethernetGroup, remoteUnitName=remoteUnitName, sNMPPortNumber=sNMPPortNumber, transparentClock=transparentClock, userTableIndex=userTableIndex, tFTPClient=tFTPClient, sNMPv3Enable=sNMPv3Enable, sMTPEnabledMessages=sMTPEnabledMessages, licenseRARSupport=licenseRARSupport, ptpTrapPrefix=ptpTrapPrefix, transmitFreqMHz=transmitFreqMHz, tDDSynchronizationStatus=tDDSynchronizationStatus, siteName=siteName, alarmInstancedTableIndex=alarmInstancedTableIndex, sNTPSync=sNTPSync, sFPPortAutoMdix=sFPPortAutoMdix, incompatibleRegulatoryBands=incompatibleRegulatoryBands, mainPSUPortQLRx=mainPSUPortQLRx, remoteMACAddressLinked=remoteMACAddressLinked, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, dNSGroup=dNSGroup, dNSServerTable=dNSServerTable, resetGroup=resetGroup, systemReset=systemReset, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, tDMChannelLineCode=tDMChannelLineCode, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, tDMChannelStatus=tDMChannelStatus, licenseOOBManagementSupport=licenseOOBManagementSupport, tDDControl=tDDControl, sNMPTrapTableNumber=sNMPTrapTableNumber, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, cableDiagPair4Distance=cableDiagPair4Distance, dNSServerTableEntry=dNSServerTableEntry, transmitDataRate=transmitDataRate, linkModeOptimizationMismatch=linkModeOptimizationMismatch, l2CPPriorityTableNumber=l2CPPriorityTableNumber, whitelistRMMacAddress=whitelistRMMacAddress, configurationInstancedTableNumber=configurationInstancedTableNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tDMChannelLoopback=tDMChannelLoopback, cableDiagPair2Results=cableDiagPair2Results, authorizationControlTableEntry=authorizationControlTableEntry, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, transparentClockVID=transparentClockVID, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, installStatusLinked=installStatusLinked)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", subbandLowestFrequency=subbandLowestFrequency, blacklistRMMacAddress=blacklistRMMacAddress, searchState=searchState, versions=versions, transmitModulationModeLinked=transmitModulationModeLinked, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, syslogControl=syslogControl, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, telnetAccessEnabled=telnetAccessEnabled, portAllocationMismatch=portAllocationMismatch, hTTPPortNumber=hTTPPortNumber, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, wirelessLinkAvailability=wirelessLinkAvailability, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, tFTPServerInternetAddressType=tFTPServerInternetAddressType, range=range, mainPSUPortQLTx=mainPSUPortQLTx, telnetPortNumber=telnetPortNumber, userName=userName, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, cableDiagnosticsWarning=cableDiagnosticsWarning, cableDiagnosticsPorts=cableDiagnosticsPorts, portAllocationMismatchLinked=portAllocationMismatchLinked, timeZone=timeZone, whitelistRMEnabled=whitelistRMEnabled, vLANManagementVID=vLANManagementVID, tempPcb=tempPcb, auxPortStatus=auxPortStatus, sNMPTrapTable=sNMPTrapTable, apcGroup=apcGroup, phyControl=phyControl, transmitModulationMode=transmitModulationMode, accessMethod=accessMethod, mABMaintenanceLevel=mABMaintenanceLevel, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, bootVersion=bootVersion, authorizationControl=authorizationControl, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, sNMPTrapPortNumber=sNMPTrapPortNumber, iPv6PrefixLength=iPv6PrefixLength, rawReceivePowerLinked=rawReceivePowerLinked, ethernetStatisticsTable=ethernetStatisticsTable, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tDMEnabledChannels=tDMEnabledChannels, frequencyVariant=frequencyVariant, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, incompatibleMasterAndSlave=incompatibleMasterAndSlave, wirelessLinkStatusLinked=wirelessLinkStatusLinked, lbtDetectedTrap=lbtDetectedTrap, subbandHighestFrequency=subbandHighestFrequency, capacityVariantMismatchTrap=capacityVariantMismatchTrap, antennaSelection=antennaSelection, tDMInterfaceControl=tDMInterfaceControl, enabledDiagnosticAlarms=enabledDiagnosticAlarms, mABNominalTransmitCapacity=mABNominalTransmitCapacity, sNTPServerInternetAddressType=sNTPServerInternetAddressType, transmitFreqKHz=transmitFreqKHz, versionsGroup=versionsGroup, sNTPServerTimeout=sNTPServerTimeout, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, authorizationControlTable=authorizationControlTable, authorizationControlGroup=authorizationControlGroup, installStatus=installStatus, receiveChannel=receiveChannel, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, linkName=linkName, pubStats=pubStats, mABNominalModulationMode=mABNominalModulationMode, snmpControlGroup=snmpControlGroup, alarms=alarms, mainPSUPortAutoMdix=mainPSUPortAutoMdix, phyControlGroup=phyControlGroup, secureModeAlarmTrap=secureModeAlarmTrap, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, sFPPortSyncERxStatus=sFPPortSyncERxStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, licenseGasGroup=licenseGasGroup, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, dfsMeans=dfsMeans, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, maxLinkRangeExceeded=maxLinkRangeExceeded, phyInstancedStatusTable=phyInstancedStatusTable, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, channelBandwidth=channelBandwidth, licenseSFPPortSupport=licenseSFPPortSupport, alarmInstancedTable=alarmInstancedTable, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, productVariant=productVariant, mABProtocolVLANPriority=mABProtocolVLANPriority, authorizationControlTableNumber=authorizationControlTableNumber, wirelessOutEthernetOctets=wirelessOutEthernetOctets, smtp=smtp, configurationInstancedTable=configurationInstancedTable, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sFPPortQLRx=sFPPortQLRx, receivePower=receivePower, dfsTableEntry=dfsTableEntry, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, userTable=userTable, iPVersion=iPVersion, mgmtInstancedTableEntry=mgmtInstancedTableEntry, rxColorCode=rxColorCode, auxPortQLRx=auxPortQLRx, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, tDMConfigurationMismatch=tDMConfigurationMismatch, mABHoldoffPeriod=mABHoldoffPeriod, dSCPManagementPriority=dSCPManagementPriority, userTableNumber=userTableNumber, configurationGroup=configurationGroup, sNTPSyncTrap=sNTPSyncTrap, linkSymmetry=linkSymmetry, sFPPortAutoNegotiation=sFPPortAutoNegotiation, bridgeGroup=bridgeGroup, licenseTDDSyncSupport=licenseTDDSyncSupport, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, sFPError=sFPError, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, dataPortPauseFrames=dataPortPauseFrames, reset=reset, remoteInternetAddressLinked=remoteInternetAddressLinked, dfsTableNumber=dfsTableNumber, tdmTableIndex=tdmTableIndex, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, licenseMaxLinkRange=licenseMaxLinkRange, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, cambium=cambium, smtpGroup=smtpGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sMTPSourceEmailAddress=sMTPSourceEmailAddress, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, receiveDataRate=receiveDataRate, dNSPrimaryServer=dNSPrimaryServer, dfsPeaks=dfsPeaks, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, ethernetInstancedTableIndex=ethernetInstancedTableIndex, cableLoss=cableLoss, linkModeOptimization=linkModeOptimization, sNMPTrapVersion=sNMPTrapVersion, sNTPServerStatus=sNTPServerStatus, groupID=groupID, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, sFPPortStatusTrap=sFPPortStatusTrap, nIDULanPortStatus=nIDULanPortStatus, licenseHCMPSupport=licenseHCMPSupport, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, txColorCode=txColorCode, transmitDataRateLinked=transmitDataRateLinked, mgmtInstancedTableNumber=mgmtInstancedTableNumber, syslogState=syslogState, licenseTrialPeriod=licenseTrialPeriod, mainPSUPortStatusTrap=mainPSUPortStatusTrap, wirelessLinkStatus=wirelessLinkStatus, dNSServerInternetAddress=dNSServerInternetAddress, receiveFreqKHz=receiveFreqKHz, ethernetInstancedTableEntry=ethernetInstancedTableEntry, unitName=unitName, tdmTableNumber=tdmTableNumber, licenseVersion=licenseVersion, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, auxPortSyncERxStatus=auxPortSyncERxStatus, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, licenseGroupAccess=licenseGroupAccess, managementGroup=managementGroup, sFPPortAllocation=sFPPortAllocation, aggregateDataRate=aggregateDataRate, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, sFPPortStatus=sFPPortStatus, ptpCompliance=ptpCompliance, managementPortWirelessDownAlert=managementPortWirelessDownAlert, ptmp=ptmp, ethernetPriorityTableNumber=ethernetPriorityTableNumber, secondarySoftwareVersion=secondarySoftwareVersion, licenseUnitSerialNumber=licenseUnitSerialNumber, licenseInstancedTableEntry=licenseInstancedTableEntry, licenseIssueNumber=licenseIssueNumber, maximumTransmitPower=maximumTransmitPower, linkLoss=linkLoss, sMTPServerPortNumber=sMTPServerPortNumber, licenseCountry=licenseCountry, maximumNumberOfSlaves=maximumNumberOfSlaves, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, licenseInstancedTable=licenseInstancedTable, ethernetStatisticsDataSource=ethernetStatisticsDataSource, licenseTLSRekey=licenseTLSRekey, transmitPowerLinked=transmitPowerLinked, l2CPPriorityTable=l2CPPriorityTable, targetRange=targetRange, rangingMode=rangingMode, hTTPSPortNumber=hTTPSPortNumber, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, phyStatusGroup=phyStatusGroup, capacityVariantMismatchLinked=capacityVariantMismatchLinked, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, syslogLocalWrappedTrap=syslogLocalWrappedTrap, vectorErrorLinked=vectorErrorLinked, sNTPServerInternetAddress=sNTPServerInternetAddress, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, rangeLinked=rangeLinked, dNSServerTableIndex=dNSServerTableIndex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, noWirelessChannelAvailable=noWirelessChannelAvailable, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, unitOutOfCalibration=unitOutOfCalibration, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, tDMInterfaceStatus=tDMInterfaceStatus, sNMPCommunityString=sNMPCommunityString, cableDiagPair4Results=cableDiagPair4Results, erroredSeconds=erroredSeconds, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, ethernetPriorityTable=ethernetPriorityTable, syncESlavePort=syncESlavePort, unavailableSeconds=unavailableSeconds, byteErrorRatio=byteErrorRatio, pubStatsGroup=pubStatsGroup, cableDiagnosticsResultTable=cableDiagnosticsResultTable, syncEEquipmentClock=syncEEquipmentClock, syslogClient=syslogClient, apc=apc, bridge=bridge, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, configurationInstancedTableIndex=configurationInstancedTableIndex, sFPPortDisabledWarning=sFPPortDisabledWarning, lowestTDMModulationMode=lowestTDMModulationMode, routerProtocols=routerProtocols, userTableEntry=userTableEntry, mainPSUPortStatus=mainPSUPortStatus, oOBPriorityQueueMapping=oOBPriorityQueueMapping, deviceMSN=deviceMSN, secureModeAlarm=secureModeAlarm, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, vectorError=vectorError, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, localPacketFiltering=localPacketFiltering, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, sNTPServerTable=sNTPServerTable, receiveModulationModeDetail=receiveModulationModeDetail, lowestDataModulationMode=lowestDataModulationMode, cableDiagPair1Results=cableDiagPair1Results, tFTPServerInternetAddress=tFTPServerInternetAddress, cableDiagPair2Distance=cableDiagPair2Distance, enableTransmission=enableTransmission, sFPErrorTrap=sFPErrorTrap, aAAControlGroup=aAAControlGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", vLANManagementPriority=vLANManagementPriority, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tDDSynchronizationMode=tDDSynchronizationMode, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, l2CPPriorityTableEntry=l2CPPriorityTableEntry, softwareVersion=softwareVersion, licenseBandwidthCap=licenseBandwidthCap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, supplementary=supplementary, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNTPPollInterval=sNTPPollInterval, dNSResolver=dNSResolver, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, cableDiagnosticsControl=cableDiagnosticsControl, wirelessTopology=wirelessTopology, phyControlInstancedTableEntry=phyControlInstancedTableEntry, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, managementNetworkAccessEnabled=managementNetworkAccessEnabled, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, ptpTraps=ptpTraps, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, licenseIPv6Support=licenseIPv6Support, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sntpGroup=sntpGroup, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, alarmsGroup=alarmsGroup, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, receiveModulationMode=receiveModulationMode, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, sNMPTrapTableEntry=sNMPTrapTableEntry, auxPortDisabledWarning=auxPortDisabledWarning, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, tDM=tDM, mgmtInstancedTableIndex=mgmtInstancedTableIndex, dfsTable=dfsTable, iPDSCPPriorityTable=iPDSCPPriorityTable, ethernetPriorityTableEntry=ethernetPriorityTableEntry, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, transmitPower=transmitPower, dataBridgingAvailability=dataBridgingAvailability, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, dNSServerTableNumber=dNSServerTableNumber, cableDiagPair3Results=cableDiagPair3Results, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, ptp=ptp, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, signalStrengthRatio=signalStrengthRatio, deviceESN=deviceESN, licenseCapacity=licenseCapacity, sNTPPrimaryServer=sNTPPrimaryServer, transmitterChannels=transmitterChannels, ethernetInstancedTable=ethernetInstancedTable, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, ptpGroups=ptpGroups, dataPortWirelessDownAlert=dataPortWirelessDownAlert, severelyErroredSeconds=severelyErroredSeconds, ethernet=ethernet)
