...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, regulatoryBand=regulatoryBand, tDMChannelLineCode=tDMChannelLineCode, cableDiagPair1Distance=cableDiagPair1Distance, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, dfsTable=dfsTable, pubInstancedStatsTable=pubInstancedStatsTable, notificationsGroup=notificationsGroup, supplementary=supplementary, sMTPServerInternetAddress=sMTPServerInternetAddress, sNMPCommunityString=sNMPCommunityString, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, licenseInstancedTableIndex=licenseInstancedTableIndex, tDMChannelStatusTrap=tDMChannelStatusTrap, mainPSUPortSSMTx=mainPSUPortSSMTx, incompatibleRegulatoryBands=incompatibleRegulatoryBands, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, byteErrorRatio=byteErrorRatio, remoteInternetAddressType=remoteInternetAddressType, encryption=encryption, systemReset=systemReset, userName=userName, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, range=range, syslogClient=syslogClient, whitelistRMEnabled=whitelistRMEnabled, sNTPServerTable=sNTPServerTable, licenseUnitSerialNumber=licenseUnitSerialNumber, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, transmitPowerLinked=transmitPowerLinked, tDMGroup=tDMGroup, secureModeAlarmTrap=secureModeAlarmTrap, licenseIssueNumber=licenseIssueNumber, dfsTableEntry=dfsTableEntry, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, linkLoss=linkLoss, tDDControlGroup=tDDControlGroup, tdmTableEntry=tdmTableEntry, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, erroredSeconds=erroredSeconds, cableDiagPair4Distance=cableDiagPair4Distance, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, dNSServerInternetAddress=dNSServerInternetAddress, installStatusLinked=installStatusLinked, wirelessOutEthernetOctets=wirelessOutEthernetOctets, auxPortSSMTx=auxPortSSMTx, siteName=siteName, tDDControl=tDDControl, bootVersion=bootVersion, managementGroup=managementGroup, hardwareVersion=hardwareVersion, dfsPeaks=dfsPeaks, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, sNTPServerTableNumber=sNTPServerTableNumber, phyStatusGroup=phyStatusGroup, mainPSUPortAutoMdix=mainPSUPortAutoMdix, frequencyVariant=frequencyVariant, routerProtocols=routerProtocols, licenseInstancedTable=licenseInstancedTable, cableDiagnosticsGroup=cableDiagnosticsGroup, mainPSUPortQLTx=mainPSUPortQLTx, sFPPortQLRx=sFPPortQLRx, licenseGasGroup=licenseGasGroup, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, sNTPServerStatus=sNTPServerStatus, sNMPTrapTable=sNMPTrapTable, txMABFrames=txMABFrames, packetsToInternalStack=packetsToInternalStack, apcGroup=apcGroup, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, cableDiagnosticsResultTable=cableDiagnosticsResultTable, syncETracking=syncETracking, productName=productName, transmitModulationMode=transmitModulationMode, versions=versions, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNTPPollInterval=sNTPPollInterval, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, dataBridgingStatus=dataBridgingStatus, gatewayIPAddress=gatewayIPAddress, sNTPState=sNTPState, maxLinkRangeExceeded=maxLinkRangeExceeded, installStatus=installStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, tDM=tDM, enableTransmission=enableTransmission, sNTPLastSync=sNTPLastSync, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, unavailableSeconds=unavailableSeconds, sMTPServerPortNumber=sMTPServerPortNumber, mPLSTCPriorityTable=mPLSTCPriorityTable, ptpTraps=ptpTraps, authorizationControlGroup=authorizationControlGroup, linkModeOptimization=linkModeOptimization, cableDiagPair2Results=cableDiagPair2Results, syslogControlGroup=syslogControlGroup, cableDiagPair1Results=cableDiagPair1Results, whitelistRMMacAddress=whitelistRMMacAddress, subbandHighestFrequency=subbandHighestFrequency, dSCPManagementPriority=dSCPManagementPriority, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, userRole=userRole, timeZone=timeZone, sFPPortStatusTrap=sFPPortStatusTrap, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, wirelessLinkStatusLinked=wirelessLinkStatusLinked, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, pubStatsGroup=pubStatsGroup, dfsMeans=dfsMeans, l2CPPriorityTable=l2CPPriorityTable, license=license, authorizationControl=authorizationControl, tDMChannelLoopback=tDMChannelLoopback, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, unitName=unitName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, licenseSFPPortSupport=licenseSFPPortSupport, transmitFreqKHz=transmitFreqKHz, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, byteErrorRatioLinked=byteErrorRatioLinked, userEnabled=userEnabled, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tdmTable=tdmTable, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, userPassword=userPassword, portAllocationMismatchLinked=portAllocationMismatchLinked, receivePowerLinked=receivePowerLinked, sNTPServerTableIndex=sNTPServerTableIndex, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, sNMPTrapPortNumber=sNMPTrapPortNumber, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, iPv6PrefixLength=iPv6PrefixLength, vectorError=vectorError, targetMACAddress=targetMACAddress, dfsTableNumber=dfsTableNumber, dfsGroup=dfsGroup, managementPortWirelessDownAlert=managementPortWirelessDownAlert, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, sNMPTrapTableEntry=sNMPTrapTableEntry, antennaGain=antennaGain, mABTransmissionInterval=mABTransmissionInterval, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, phyControlInstancedTable=phyControlInstancedTable, receiveFreqMHz=receiveFreqMHz, snmpControlGroup=snmpControlGroup, sNMPPortNumber=sNMPPortNumber, mABMaintenanceLevel=mABMaintenanceLevel, ptpGroups=ptpGroups, tFTPServerPortNumber=tFTPServerPortNumber, wirelessOutOctets=wirelessOutOctets, transmitChannel=transmitChannel, rxColorCode=rxColorCode, auxPortQLTx=auxPortQLTx, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, aggregateDataRate=aggregateDataRate, dNSServerInternetAddressType=dNSServerInternetAddressType, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, resetGroup=resetGroup, transmitModulationModeLinked=transmitModulationModeLinked, mABProtocolVID=mABProtocolVID, dataBridgingStatusLinked=dataBridgingStatusLinked, dNSServerTable=dNSServerTable, ethernetPriorityTableIndex=ethernetPriorityTableIndex, wirelessLinkStatus=wirelessLinkStatus, mgmtInstancedTableIndex=mgmtInstancedTableIndex, capacityVariantMismatch=capacityVariantMismatch, vLANManagementVID=vLANManagementVID, syslogControl=syslogControl, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, iPv6Address=iPv6Address, sMTPServerInternetAddressType=sMTPServerInternetAddressType, latitude=latitude, alarmsGroup=alarmsGroup, linkLossLinked=linkLossLinked, ethernetInstancedTableIndex=ethernetInstancedTableIndex, userTableNumber=userTableNumber, cableDiagPair3Results=cableDiagPair3Results, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, hCMPMaximumLinkRange=hCMPMaximumLinkRange, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, configuration=configuration, linkSymmetry=linkSymmetry, receiveModulationModeLinked=receiveModulationModeLinked, supplementaryGroup=supplementaryGroup, severelyErroredSeconds=severelyErroredSeconds, remoteUnitName=remoteUnitName, dfs=dfs, rangeLinked=rangeLinked, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, alarmInstancedTableIndex=alarmInstancedTableIndex, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, syncEEquipmentClock=syncEEquipmentClock, dfsTableIndex=dfsTableIndex, unitOutOfCalibration=unitOutOfCalibration, remoteMACAddressLinked=remoteMACAddressLinked, channelChangeTrap=channelChangeTrap, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, ethernet=ethernet, transparentClockVID=transparentClockVID, mgmtInstancedTableNumber=mgmtInstancedTableNumber, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, sNMPEnabledTraps=sNMPEnabledTraps, tFTPServerInternetAddressType=tFTPServerInternetAddressType, aAAControlGroup=aAAControlGroup, subbandLowestFrequency=subbandLowestFrequency, transmitDataRateLinked=transmitDataRateLinked, sNTPSync=sNTPSync, cableDiagPair4Results=cableDiagPair4Results, blacklistRMMacAddress=blacklistRMMacAddress, dataPortPauseFrames=dataPortPauseFrames, eIRP=eIRP, wirelessTopology=wirelessTopology, versionsGroup=versionsGroup, groupID=groupID, userTableEntry=userTableEntry, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sFPPortDisabledWarning=sFPPortDisabledWarning, sNMPTrapTableNumber=sNMPTrapTableNumber, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, licenseOOBManagementSupport=licenseOOBManagementSupport, channelBandwidth=channelBandwidth, remoteUnitNameLinked=remoteUnitNameLinked, smtpGroup=smtpGroup, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, phyStatus=phyStatus, rawReceivePower=rawReceivePower, dNSServerTableNumber=dNSServerTableNumber, licenseSyncESupport=licenseSyncESupport, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, mainPSUPortStatus=mainPSUPortStatus, receiveModulationMode=receiveModulationMode, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, authorizationControlTableIndex=authorizationControlTableIndex, lbtDetectedTrap=lbtDetectedTrap, auxPortStatus=auxPortStatus, transmitDataRate=transmitDataRate)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", iPv4Address=iPv4Address, licenseRegulatoryBandsList=licenseRegulatoryBandsList, ptmp=ptmp, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, aAAControl=aAAControl, qOSPriorityScheme=qOSPriorityScheme, tDMChannelStatus=tDMChannelStatus, installArmStateTrap=installArmStateTrap, regulatoryBandTrap=regulatoryBandTrap, tFTPClient=tFTPClient, wirelessLinkAvailability=wirelessLinkAvailability, licenseInstancedTableNumber=licenseInstancedTableNumber, mABNominalModulationMode=mABNominalModulationMode, receiveChannel=receiveChannel, auxPortDisabledWarning=auxPortDisabledWarning, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, deviceMSN=deviceMSN, capacityVariantMismatchTrap=capacityVariantMismatchTrap, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, configurationGroup=configurationGroup, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, ethernetInstancedTableEntry=ethernetInstancedTableEntry, sMTPEnabledMessages=sMTPEnabledMessages, pubStats=pubStats, authorizationControlTableNumber=authorizationControlTableNumber, licenseIPv6Support=licenseIPv6Support, sNTPServerTimeout=sNTPServerTimeout, receiveDataRate=receiveDataRate, nIDULanPortStatusTrap=nIDULanPortStatusTrap, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, deviceMACAddress=deviceMACAddress, sFPPortStatus=sFPPortStatus, signalStrengthRatioLinked=signalStrengthRatioLinked, tDDSynchronizationMode=tDDSynchronizationMode, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, licenseTrialPeriod=licenseTrialPeriod, transmitterChannels=transmitterChannels, txColorCode=txColorCode, receiveDataRateLinked=receiveDataRateLinked, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, sntpGroup=sntpGroup, nIDULanPortAutoMdix=nIDULanPortAutoMdix, antennaSelection=antennaSelection, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, systemClock=systemClock, lowestDataModulationMode=lowestDataModulationMode, mABNominalTransmitCapacity=mABNominalTransmitCapacity, wirelessOutAllOctets=wirelessOutAllOctets, auxPortQLRx=auxPortQLRx, management=management, transmitPower=transmitPower, ptpCompliance=ptpCompliance, licenseSecurityLevel=licenseSecurityLevel, ptpTrapPrefix=ptpTrapPrefix, ethernetGroup=ethernetGroup, licenseIEEE1588Support=licenseIEEE1588Support, encryptionAlgorithm=encryptionAlgorithm, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, smtp=smtp, ethernetPriorityTable=ethernetPriorityTable, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, oOBPriorityQueueMapping=oOBPriorityQueueMapping, licenseTDDSyncSupport=licenseTDDSyncSupport, licenseRARSupport=licenseRARSupport, configurationInstancedTableEntry=configurationInstancedTableEntry, masterSlaveMode=masterSlaveMode, authorizationControlTable=authorizationControlTable, dataBridgingStatusAlarm=dataBridgingStatusAlarm, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, transmitFreqMHz=transmitFreqMHz, sNTPPrimaryServer=sNTPPrimaryServer, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, sNMPv3Enable=sNMPv3Enable, phyControlInstancedTableIndex=phyControlInstancedTableIndex, secondarySoftwareVersion=secondarySoftwareVersion, sFPPortSyncERxStatus=sFPPortSyncERxStatus, licenseMaxLinkRange=licenseMaxLinkRange, unitIdentification=unitIdentification, cableDiagnosticsWarning=cableDiagnosticsWarning, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, licenseTLSRekey=licenseTLSRekey, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, sNTPServerRetries=sNTPServerRetries, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, accessMethod=accessMethod, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, auxPortAcceptedQLRx=auxPortAcceptedQLRx, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, installArmState=installArmState, mgmtInstancedTable=mgmtInstancedTable, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, auxPortSyncERxStatus=auxPortSyncERxStatus, mainPSUPortStatusTrap=mainPSUPortStatusTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, licenseGroupAccess=licenseGroupAccess, auxPortConfigurationMismatch=auxPortConfigurationMismatch, installationMode=installationMode, linkName=linkName, sNTPServerTableEntry=sNTPServerTableEntry, maximumTransmitPower=maximumTransmitPower, remoteInternetAddress=remoteInternetAddress, syslogState=syslogState, sFPPortAutoMdix=sFPPortAutoMdix, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, aggregateDataRateLinked=aggregateDataRateLinked, PYSNMP_MODULE_ID=cambium, mainPSUPortQLRx=mainPSUPortQLRx, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, targetRange=targetRange, useVLANForManagementInterfaces=useVLANForManagementInterfaces, vectorErrorLinked=vectorErrorLinked, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, hTTPAccessEnabled=hTTPAccessEnabled, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, ethernetPriorityTableNumber=ethernetPriorityTableNumber, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, ethernetInstancedTable=ethernetInstancedTable, sFPError=sFPError, tdmTableNumber=tdmTableNumber, tempPcb=tempPcb, sNMPTrapInternetAddress=sNMPTrapInternetAddress, mABHoldoffPeriod=mABHoldoffPeriod, syncETrackingState=syncETrackingState, secureModeAlarm=secureModeAlarm, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, cambium=cambium, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, licenseGroup=licenseGroup, configurationInstancedTableIndex=configurationInstancedTableIndex, tDMInterfaceControl=tDMInterfaceControl, tDMEnabledChannels=tDMEnabledChannels, lowestTDMModulationMode=lowestTDMModulationMode, apc=apc, unitIdentificationGroup=unitIdentificationGroup, alarms=alarms, licenseCapacity=licenseCapacity, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, sFPPortAllocation=sFPPortAllocation, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, hCMPLinkSymmetry=hCMPLinkSymmetry, extendedSpectrumScanning=extendedSpectrumScanning, daylightSaving=daylightSaving, ethernetStatisticsDataSource=ethernetStatisticsDataSource, portAllocationMismatchTrap=portAllocationMismatchTrap, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, syslogLocalWrappedTrap=syslogLocalWrappedTrap, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, installStatusTrap=installStatusTrap, maximumNumberOfSlaves=maximumNumberOfSlaves, vLANManagementPriority=vLANManagementPriority, localPacketFiltering=localPacketFiltering, remoteInternetAddressLinked=remoteInternetAddressLinked, remoteMACAddress=remoteMACAddress, l2CPPriorityTableEntry=l2CPPriorityTableEntry, tDMConfigurationMismatch=tDMConfigurationMismatch, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, receivePower=receivePower, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ethernetInstancedTableNumber=ethernetInstancedTableNumber, iPVersion=iPVersion, transparentClockPort=transparentClockPort, cableLoss=cableLoss, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dNSPrimaryServer=dNSPrimaryServer, transparentClockVLAN=transparentClockVLAN, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sMTPEmailAlert=sMTPEmailAlert, syncESlavePort=syncESlavePort, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, tDMChannelCableLength=tDMChannelCableLength, hTTPSPortNumber=hTTPSPortNumber, sNMPTrapVersion=sNMPTrapVersion, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, packetsFromInternalStack=packetsFromInternalStack, syslogStateTrap=syslogStateTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, bridgeGroup=bridgeGroup, telnetAccessEnabled=telnetAccessEnabled, ptp670=ptp670, phyControl=phyControl, deviceESN=deviceESN, dNSResolver=dNSResolver, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, userTableIndex=userTableIndex, mgmtInstancedTableEntry=mgmtInstancedTableEntry, sNTPServerPortNumber=sNTPServerPortNumber, encryptionGroup=encryptionGroup, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, phyControlInstancedTableNumber=phyControlInstancedTableNumber, receiveFreqKHz=receiveFreqKHz, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, mainPSUPortAllocation=mainPSUPortAllocation, licenseHCMPSupport=licenseHCMPSupport, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, searchState=searchState, syslogClientTrap=syslogClientTrap, configurationInstancedTable=configurationInstancedTable, searchStateLinked=searchStateLinked, dNSServerTableIndex=dNSServerTableIndex, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, sFPPortSSMTx=sFPPortSSMTx, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, iPDSCPPriorityTable=iPDSCPPriorityTable, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, dNS=dNS, tdmTableIndex=tdmTableIndex, sntp=sntp, nIDULanPortStatus=nIDULanPortStatus, signalStrengthRatio=signalStrengthRatio, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, productVariant=productVariant, licenseBandwidthCap=licenseBandwidthCap, sNTPSyncTrap=sNTPSyncTrap, snmpControl=snmpControl, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, routerProtocolsGroup=routerProtocolsGroup, cableDiagnosticsControl=cableDiagnosticsControl, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, phyControlGroup=phyControlGroup, licenseInstancedTableEntry=licenseInstancedTableEntry, dataPortWirelessDownAlert=dataPortWirelessDownAlert, enabledDiagnosticAlarms=enabledDiagnosticAlarms, rawReceivePowerLinked=rawReceivePowerLinked, noWirelessChannelAvailable=noWirelessChannelAvailable, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, transparentClock=transparentClock, dataBridgingAvailability=dataBridgingAvailability, authorizationMethod=authorizationMethod, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, alarmInstancedTable=alarmInstancedTable, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, mABProtocolVLANPriority=mABProtocolVLANPriority, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, ethernetStatisticsTable=ethernetStatisticsTable)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, receiveModulationModeDetail=receiveModulationModeDetail, alarmInstancedTableEntry=alarmInstancedTableEntry, telnetPortNumber=telnetPortNumber, dNSGroup=dNSGroup, cableDiagPair2Distance=cableDiagPair2Distance, bridge=bridge, configurationInstancedTableNumber=configurationInstancedTableNumber, cableDiagPair3Distance=cableDiagPair3Distance, iPv6GatewayAddress=iPv6GatewayAddress, tDMInterfaceStatus=tDMInterfaceStatus, auxPortAllocation=auxPortAllocation, tFTPServerInternetAddress=tFTPServerInternetAddress, phyInstancedStatusTable=phyInstancedStatusTable, hTTPPortNumber=hTTPPortNumber, sFPErrorTrap=sFPErrorTrap, alarmInstancedTableNumber=alarmInstancedTableNumber, sNTPServerInternetAddress=sNTPServerInternetAddress, auxPortStatusTrap=auxPortStatusTrap, capacityVariantMismatchLinked=capacityVariantMismatchLinked, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, licenseEncryption=licenseEncryption, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, authorizationControlTableEntry=authorizationControlTableEntry, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, licenseVersion=licenseVersion, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, portAllocationMismatch=portAllocationMismatch, softwareVersion=softwareVersion, rangingMode=rangingMode, dNSServerTableEntry=dNSServerTableEntry, reset=reset, dNSServerPortNumber=dNSServerPortNumber, licenseCountry=licenseCountry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, sFPPortAutoNegotiation=sFPPortAutoNegotiation, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, ptp=ptp, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, ethernetPriorityTableEntry=ethernetPriorityTableEntry, managementNetworkAccessEnabled=managementNetworkAccessEnabled, phyControlInstancedTableEntry=phyControlInstancedTableEntry, userTable=userTable, longitude=longitude, altitude=altitude, subnetMask=subnetMask, blacklistRMEnabled=blacklistRMEnabled, cableDiagnosticsPorts=cableDiagnosticsPorts, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, useVLANForMABProtocol=useVLANForMABProtocol, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, remoteMaximumTransmitPower=remoteMaximumTransmitPower, cableDiagnostics=cableDiagnostics, mABState=mABState, sFPPortQLTx=sFPPortQLTx, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled)
