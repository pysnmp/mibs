...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", phyInstancedStatusTable=phyInstancedStatusTable, remoteUnitName=remoteUnitName, sNMPTrapTable=sNMPTrapTable, versionsGroup=versionsGroup, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, licenseBandwidthCap=licenseBandwidthCap, remoteMACAddress=remoteMACAddress, syslogControlGroup=syslogControlGroup, receivePower=receivePower, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, nIDULanPortStatus=nIDULanPortStatus, extendedSpectrumScanning=extendedSpectrumScanning, syslogControl=syslogControl, licenseTrialPeriod=licenseTrialPeriod, sMTPServerInternetAddressType=sMTPServerInternetAddressType, supplementary=supplementary, searchState=searchState, whitelistRMEnabled=whitelistRMEnabled, alarmInstancedTableIndex=alarmInstancedTableIndex, auxPortSyncERxStatus=auxPortSyncERxStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernetGroup=ethernetGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, licenseSFPPortSupport=licenseSFPPortSupport, ptp670=ptp670, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, ptpCompliance=ptpCompliance, lowestTDMModulationMode=lowestTDMModulationMode, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, dNS=dNS, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, oOBPriorityQueueMapping=oOBPriorityQueueMapping, rangeLinked=rangeLinked, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, sMTPServerInternetAddress=sMTPServerInternetAddress, aggregateDataRateLinked=aggregateDataRateLinked, sFPPortQLTx=sFPPortQLTx, unitOutOfCalibration=unitOutOfCalibration, cableDiagnosticsGroup=cableDiagnosticsGroup, tDMGroup=tDMGroup, dataBridgingStatus=dataBridgingStatus, receiveModulationModeLinked=receiveModulationModeLinked, phyControl=phyControl, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, licenseInstancedTableEntry=licenseInstancedTableEntry, apc=apc, mainPSUPortStatusTrap=mainPSUPortStatusTrap, dSCPManagementPriority=dSCPManagementPriority, auxPortQLTx=auxPortQLTx, sNTPState=sNTPState, licenseGroupAccess=licenseGroupAccess, alarmInstancedTableNumber=alarmInstancedTableNumber, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, sFPPortAllocation=sFPPortAllocation, tDMEnabledChannels=tDMEnabledChannels, transmitModulationModeLinked=transmitModulationModeLinked, licenseGasGroup=licenseGasGroup, PYSNMP_MODULE_ID=cambium, receivePowerLinked=receivePowerLinked, licenseSyncESupport=licenseSyncESupport, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, dNSGroup=dNSGroup, transparentClock=transparentClock, snmpControlGroup=snmpControlGroup, maxLinkRangeExceeded=maxLinkRangeExceeded, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, ptpGroups=ptpGroups, licenseVersion=licenseVersion, ethernet=ethernet, ethernetInstancedTableIndex=ethernetInstancedTableIndex, syslogLocalWrappedTrap=syslogLocalWrappedTrap, syslogStateTrap=syslogStateTrap, tDM=tDM, cableDiagPair4Distance=cableDiagPair4Distance, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, userName=userName, sFPPortStatusTrap=sFPPortStatusTrap, mainPSUPortAutoMdix=mainPSUPortAutoMdix, cableDiagPair3Distance=cableDiagPair3Distance, ptpTraps=ptpTraps, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, transmitDataRateLinked=transmitDataRateLinked, mainPSUPortStatus=mainPSUPortStatus, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, linkLoss=linkLoss, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, rawReceivePowerLinked=rawReceivePowerLinked, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, packetsFromInternalStack=packetsFromInternalStack, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, dNSPrimaryServer=dNSPrimaryServer, signalStrengthRatio=signalStrengthRatio, bridge=bridge, licenseMaxLinkRange=licenseMaxLinkRange, cambium=cambium, deviceMSN=deviceMSN, auxPortAcceptedQLRx=auxPortAcceptedQLRx, rxColorCode=rxColorCode, rawReceivePower=rawReceivePower, tDMChannelCableLength=tDMChannelCableLength, tFTPServerPortNumber=tFTPServerPortNumber, sNTPServerRetries=sNTPServerRetries, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, daylightSaving=daylightSaving, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, bridgeGroup=bridgeGroup, sNTPServerTableEntry=sNTPServerTableEntry, alarms=alarms, capacityVariantMismatchTrap=capacityVariantMismatchTrap, pubInstancedStatsTable=pubInstancedStatsTable, qOSPriorityScheme=qOSPriorityScheme, l2CPPriorityTableEntry=l2CPPriorityTableEntry, dNSServerTableIndex=dNSServerTableIndex, notificationsGroup=notificationsGroup, installStatusLinked=installStatusLinked, dNSServerInternetAddressType=dNSServerInternetAddressType, sntp=sntp, longitude=longitude, tFTPServerInternetAddressType=tFTPServerInternetAddressType, tdmTableIndex=tdmTableIndex, authorizationMethod=authorizationMethod, management=management, transmitFreqKHz=transmitFreqKHz, sNTPLastSync=sNTPLastSync, mainPSUPortQLRx=mainPSUPortQLRx, channelBandwidth=channelBandwidth, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, phyControlInstancedTableEntry=phyControlInstancedTableEntry, syncESlavePort=syncESlavePort, sFPPortSSMTx=sFPPortSSMTx, sNTPServerPortNumber=sNTPServerPortNumber, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, auxPortSSMTx=auxPortSSMTx, hardwareVersion=hardwareVersion, secureModeAlarm=secureModeAlarm, mgmtInstancedTableEntry=mgmtInstancedTableEntry, sNTPSyncTrap=sNTPSyncTrap, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, managementNetworkAccessEnabled=managementNetworkAccessEnabled, receiveFreqKHz=receiveFreqKHz, mABState=mABState, tdmTableNumber=tdmTableNumber, tDMChannelLineCode=tDMChannelLineCode, hTTPPortNumber=hTTPPortNumber, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, regulatoryBandTrap=regulatoryBandTrap, ethernetStatisticsTable=ethernetStatisticsTable, unitName=unitName, useVLANForMABProtocol=useVLANForMABProtocol, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, mABProtocolVLANPriority=mABProtocolVLANPriority, tdmTableEntry=tdmTableEntry, cableLoss=cableLoss, sMTPServerPortNumber=sMTPServerPortNumber, maximumTransmitPower=maximumTransmitPower, sFPPortDisabledWarning=sFPPortDisabledWarning, incompatibleMasterAndSlave=incompatibleMasterAndSlave, reset=reset, authorizationControlGroup=authorizationControlGroup, masterSlaveMode=masterSlaveMode, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, userTable=userTable, sFPErrorTrap=sFPErrorTrap, snmpControl=snmpControl, userTableEntry=userTableEntry, portAllocationMismatch=portAllocationMismatch, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, phyControlInstancedTableIndex=phyControlInstancedTableIndex, portAllocationMismatchLinked=portAllocationMismatchLinked, managementPortWirelessDownAlert=managementPortWirelessDownAlert, capacityVariantMismatch=capacityVariantMismatch, telnetAccessEnabled=telnetAccessEnabled, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, sNMPTrapTableEntry=sNMPTrapTableEntry, auxPortConfigurationMismatch=auxPortConfigurationMismatch, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, sFPPortSyncERxStatus=sFPPortSyncERxStatus, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, mainPSUPortAllocation=mainPSUPortAllocation, auxPortDisabledWarning=auxPortDisabledWarning, sNTPServerInternetAddress=sNTPServerInternetAddress, configurationInstancedTable=configurationInstancedTable, userEnabled=userEnabled, aAAControl=aAAControl, syncETracking=syncETracking, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, erroredSeconds=erroredSeconds, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tDMInterfaceStatus=tDMInterfaceStatus, hTTPAccessEnabled=hTTPAccessEnabled, pubStats=pubStats, sNMPTrapVersion=sNMPTrapVersion, transmitModulationMode=transmitModulationMode, tDMConfigurationMismatch=tDMConfigurationMismatch, licenseIPv6Support=licenseIPv6Support, mgmtInstancedTableNumber=mgmtInstancedTableNumber, versions=versions, deviceESN=deviceESN, subbandLowestFrequency=subbandLowestFrequency, routerProtocols=routerProtocols, licenseGroup=licenseGroup, installStatus=installStatus, licenseIssueNumber=licenseIssueNumber, tDDControl=tDDControl, sNMPPortNumber=sNMPPortNumber, hTTPSPortNumber=hTTPSPortNumber, pubStatsGroup=pubStatsGroup, tDDControlGroup=tDDControlGroup, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, localPacketFiltering=localPacketFiltering, configurationGroup=configurationGroup, transparentClockPort=transparentClockPort, txMABFrames=txMABFrames, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, searchStateLinked=searchStateLinked, mgmtInstancedTableIndex=mgmtInstancedTableIndex, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, linkLossLinked=linkLossLinked, hTTPSAccessEnabled=hTTPSAccessEnabled, licenseInstancedTableNumber=licenseInstancedTableNumber, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNTPServerTableIndex=sNTPServerTableIndex, auxPortQLRx=auxPortQLRx, cableDiagPair3Results=cableDiagPair3Results, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, mABProtocolVID=mABProtocolVID, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, receiveChannel=receiveChannel, hCMPLinkSymmetry=hCMPLinkSymmetry, authorizationControlTableEntry=authorizationControlTableEntry, licenseTLSRekey=licenseTLSRekey, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, unitIdentificationGroup=unitIdentificationGroup, licenseHCMPSupport=licenseHCMPSupport, managementGroup=managementGroup, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, dNSServerTableEntry=dNSServerTableEntry, mainPSUPortSSMTx=mainPSUPortSSMTx, licenseRARSupport=licenseRARSupport, wirelessLinkAvailability=wirelessLinkAvailability)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", frequencyVariant=frequencyVariant, wirelessOutAllOctets=wirelessOutAllOctets, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, syncEEquipmentClock=syncEEquipmentClock, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, dfs=dfs, encryptionAlgorithm=encryptionAlgorithm, sNTPServerTimeout=sNTPServerTimeout, byteErrorRatio=byteErrorRatio, secondarySoftwareVersion=secondarySoftwareVersion, iPVersion=iPVersion, vLANManagementVID=vLANManagementVID, phyControlInstancedTable=phyControlInstancedTable, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, cableDiagnosticsResultTable=cableDiagnosticsResultTable, userTableIndex=userTableIndex, remoteInternetAddressLinked=remoteInternetAddressLinked, encryptionGroup=encryptionGroup, configurationInstancedTableIndex=configurationInstancedTableIndex, ptpTrapPrefix=ptpTrapPrefix, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, subnetMask=subnetMask, mgmtInstancedTable=mgmtInstancedTable, ptmp=ptmp, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, installArmStateTrap=installArmStateTrap, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, authorizationControlTable=authorizationControlTable, licenseEncryption=licenseEncryption, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, nIDULanPortAutoMdix=nIDULanPortAutoMdix, dfsMeans=dfsMeans, iPv6GatewayAddress=iPv6GatewayAddress, severelyErroredSeconds=severelyErroredSeconds, dataBridgingStatusAlarm=dataBridgingStatusAlarm, linkName=linkName, tDMChannelLoopback=tDMChannelLoopback, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, tdmTable=tdmTable, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, sMTPEmailAlert=sMTPEmailAlert, lbtDetectedTrap=lbtDetectedTrap, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, syslogClientTrap=syslogClientTrap, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, iPDSCPPriorityTable=iPDSCPPriorityTable, mPLSTCPriorityTable=mPLSTCPriorityTable, syslogState=syslogState, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, receiveFreqMHz=receiveFreqMHz, aggregateDataRate=aggregateDataRate, useVLANForManagementInterfaces=useVLANForManagementInterfaces, channelChangeTrap=channelChangeTrap, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, remoteMACAddressLinked=remoteMACAddressLinked, vectorError=vectorError, dataPortPauseFrames=dataPortPauseFrames, sNMPTrapTableNumber=sNMPTrapTableNumber, mABHoldoffPeriod=mABHoldoffPeriod, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, unavailableSeconds=unavailableSeconds, licenseRegulatoryBandsList=licenseRegulatoryBandsList, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, vectorErrorLinked=vectorErrorLinked, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dNSServerTableNumber=dNSServerTableNumber, cableDiagnosticsPorts=cableDiagnosticsPorts, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, licenseCapacity=licenseCapacity, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, dNSResolver=dNSResolver, targetRange=targetRange, licenseInstancedTable=licenseInstancedTable, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, antennaSelection=antennaSelection, licenseTDDSyncSupport=licenseTDDSyncSupport, capacityVariantMismatchLinked=capacityVariantMismatchLinked, ethernetPriorityTableIndex=ethernetPriorityTableIndex, systemClock=systemClock, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, transmitDataRate=transmitDataRate, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, cableDiagnosticsControl=cableDiagnosticsControl, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, dNSServerTable=dNSServerTable, ethernetInstancedTableEntry=ethernetInstancedTableEntry, iPv6Address=iPv6Address, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, noWirelessChannelAvailable=noWirelessChannelAvailable, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, userRole=userRole, licenseSecurityLevel=licenseSecurityLevel, linkSymmetry=linkSymmetry, productVariant=productVariant, eIRP=eIRP, authorizationControlTableIndex=authorizationControlTableIndex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfsTableEntry=dfsTableEntry, alarmInstancedTable=alarmInstancedTable, license=license, cableDiagnostics=cableDiagnostics, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, userTableNumber=userTableNumber, installArmState=installArmState, incompatibleRegulatoryBands=incompatibleRegulatoryBands, txColorCode=txColorCode, sNTPPollInterval=sNTPPollInterval, dNSServerPortNumber=dNSServerPortNumber, tDMChannelStatus=tDMChannelStatus, dataPortWirelessDownAlert=dataPortWirelessDownAlert, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, configurationInstancedTableEntry=configurationInstancedTableEntry, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, phyStatusGroup=phyStatusGroup, groupID=groupID, systemReset=systemReset, telnetPortNumber=telnetPortNumber, transmitChannel=transmitChannel, wirelessLinkStatusLinked=wirelessLinkStatusLinked, cableDiagPair2Distance=cableDiagPair2Distance, dfsTableNumber=dfsTableNumber, linkModeOptimization=linkModeOptimization, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, wirelessOutOctets=wirelessOutOctets, ethernetPriorityTableEntry=ethernetPriorityTableEntry, phyControlGroup=phyControlGroup, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, packetsToInternalStack=packetsToInternalStack, tDMInterfaceControl=tDMInterfaceControl, ethernetPriorityTable=ethernetPriorityTable, cableDiagPair4Results=cableDiagPair4Results, wirelessLinkStatus=wirelessLinkStatus, auxPortStatusTrap=auxPortStatusTrap, authorizationControlTableNumber=authorizationControlTableNumber, auxPortAllocation=auxPortAllocation, iPv6PrefixLength=iPv6PrefixLength, ptp=ptp, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPSync=sNTPSync, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, transmitterChannels=transmitterChannels, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, timeZone=timeZone, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, licenseInstancedTableIndex=licenseInstancedTableIndex, sFPError=sFPError, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, dfsTableIndex=dfsTableIndex, l2CPPriorityTableIndex=l2CPPriorityTableIndex, deviceMACAddress=deviceMACAddress, rangingMode=rangingMode, resetGroup=resetGroup, sFPPortStatus=sFPPortStatus, sNTPPrimaryServer=sNTPPrimaryServer, remoteInternetAddress=remoteInternetAddress, range=range, siteName=siteName, portAllocationMismatchTrap=portAllocationMismatchTrap, dfsGroup=dfsGroup, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, sNTPServerInternetAddressType=sNTPServerInternetAddressType, tempPcb=tempPcb, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ethernetPriorityTableNumber=ethernetPriorityTableNumber, smtpGroup=smtpGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, latitude=latitude, regulatoryBand=regulatoryBand, remoteInternetAddressType=remoteInternetAddressType, mABTransmissionInterval=mABTransmissionInterval, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, installStatusTrap=installStatusTrap, transmitPowerLinked=transmitPowerLinked, blacklistRMEnabled=blacklistRMEnabled, sFPPortAutoMdix=sFPPortAutoMdix, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, receiveModulationModeDetail=receiveModulationModeDetail, supplementaryGroup=supplementaryGroup, ethernetInstancedTable=ethernetInstancedTable, ethernetInstancedTableNumber=ethernetInstancedTableNumber, lowestDataModulationMode=lowestDataModulationMode, bootVersion=bootVersion, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, antennaGain=antennaGain, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, smtp=smtp, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, transparentClockVLAN=transparentClockVLAN, transmitPower=transmitPower, sNTPServerStatus=sNTPServerStatus, sntpGroup=sntpGroup, dNSServerInternetAddress=dNSServerInternetAddress, receiveDataRateLinked=receiveDataRateLinked, cableDiagnosticsWarning=cableDiagnosticsWarning, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, sNTPServerTable=sNTPServerTable, dataBridgingStatusLinked=dataBridgingStatusLinked, tFTPClient=tFTPClient, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, byteErrorRatioLinked=byteErrorRatioLinked, gatewayIPAddress=gatewayIPAddress, nIDULanPortStatusTrap=nIDULanPortStatusTrap, accessMethod=accessMethod, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, dfsTable=dfsTable, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, sNMPEnabledTraps=sNMPEnabledTraps, alarmsGroup=alarmsGroup, vLANManagementPriority=vLANManagementPriority, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, userPassword=userPassword, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, unitIdentification=unitIdentification, routerProtocolsGroup=routerProtocolsGroup, sNTPServerTableNumber=sNTPServerTableNumber, licenseUnitSerialNumber=licenseUnitSerialNumber, l2CPPriorityTableNumber=l2CPPriorityTableNumber, installationMode=installationMode, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, dfsPeaks=dfsPeaks, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, cableDiagPair1Results=cableDiagPair1Results, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, targetMACAddress=targetMACAddress, mainPSUPortQLTx=mainPSUPortQLTx, dataBridgingAvailability=dataBridgingAvailability, l2CPPriorityTable=l2CPPriorityTable, softwareVersion=softwareVersion)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sFPPortQLRx=sFPPortQLRx, receiveModulationMode=receiveModulationMode, signalStrengthRatioLinked=signalStrengthRatioLinked, altitude=altitude, licenseIEEE1588Support=licenseIEEE1588Support, hCMPMaximumLinkRange=hCMPMaximumLinkRange, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, aAAControlGroup=aAAControlGroup, subbandHighestFrequency=subbandHighestFrequency, encryption=encryption, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, enableTransmission=enableTransmission, receiveDataRate=receiveDataRate, syncETrackingState=syncETrackingState, wirelessOutEthernetOctets=wirelessOutEthernetOctets, apcGroup=apcGroup, sNMPCommunityString=sNMPCommunityString, sMTPSourceEmailAddress=sMTPSourceEmailAddress, cableDiagPair2Results=cableDiagPair2Results, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, transparentClockVID=transparentClockVID, tDMChannelStatusTrap=tDMChannelStatusTrap, authorizationControl=authorizationControl, alarmInstancedTableEntry=alarmInstancedTableEntry, tFTPServerInternetAddress=tFTPServerInternetAddress, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, remoteUnitNameLinked=remoteUnitNameLinked, syslogClient=syslogClient, mABNominalModulationMode=mABNominalModulationMode, auxPortStatus=auxPortStatus, sNMPv3Enable=sNMPv3Enable, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, ethernetStatisticsDataSource=ethernetStatisticsDataSource, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, configuration=configuration, wirelessTopology=wirelessTopology, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, sNMPTrapTableIndex=sNMPTrapTableIndex, tDDSynchronizationMode=tDDSynchronizationMode, whitelistRMMacAddress=whitelistRMMacAddress, phyControlInstancedTableNumber=phyControlInstancedTableNumber, blacklistRMMacAddress=blacklistRMMacAddress, cableDiagPair1Distance=cableDiagPair1Distance, secureModeAlarmTrap=secureModeAlarmTrap, configurationInstancedTableNumber=configurationInstancedTableNumber, maximumNumberOfSlaves=maximumNumberOfSlaves, licenseCountry=licenseCountry, transmitFreqMHz=transmitFreqMHz, licenseOOBManagementSupport=licenseOOBManagementSupport, iPv4Address=iPv4Address, sFPPortAutoNegotiation=sFPPortAutoNegotiation, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, phyStatus=phyStatus, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, sMTPEnabledMessages=sMTPEnabledMessages, productName=productName, mABNominalTransmitCapacity=mABNominalTransmitCapacity, mABMaintenanceLevel=mABMaintenanceLevel, tDDSynchronizationAlarm=tDDSynchronizationAlarm)
