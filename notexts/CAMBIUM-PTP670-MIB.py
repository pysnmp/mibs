...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", encryption=encryption, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, auxPortAllocation=auxPortAllocation, whitelistRMEnabled=whitelistRMEnabled, auxPortSyncERxStatus=auxPortSyncERxStatus, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, rawReceivePower=rawReceivePower, range=range, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, receiveDataRate=receiveDataRate, licenseInstancedTable=licenseInstancedTable, userRole=userRole, timeZone=timeZone, sNTPServerTable=sNTPServerTable, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, latitude=latitude, wirelessTopology=wirelessTopology, tDMChannelLoopback=tDMChannelLoopback, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dNSServerTable=dNSServerTable, remoteUnitName=remoteUnitName, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, tdmTable=tdmTable, sFPPortSyncERxStatus=sFPPortSyncERxStatus, dfsTableIndex=dfsTableIndex, licenseCapacity=licenseCapacity, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, licenseTLSRekey=licenseTLSRekey, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, receiveModulationModeDetail=receiveModulationModeDetail, sFPPortStatus=sFPPortStatus, mainPSUPortStatus=mainPSUPortStatus, transmitPower=transmitPower, syncETrackingState=syncETrackingState, unitName=unitName, license=license, resetGroup=resetGroup, txColorCode=txColorCode, ptmp=ptmp, sNMPv3Enable=sNMPv3Enable, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, syslogClient=syslogClient, tFTPServerPortNumber=tFTPServerPortNumber, transmitFreqMHz=transmitFreqMHz, sFPPortAutoMdix=sFPPortAutoMdix, channelChangeTrap=channelChangeTrap, mABState=mABState, targetRange=targetRange, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, tDMChannelCableLength=tDMChannelCableLength, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, mgmtInstancedTableIndex=mgmtInstancedTableIndex, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, aAAControl=aAAControl, licenseMaxLinkRange=licenseMaxLinkRange, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, sntpGroup=sntpGroup, sNTPServerInternetAddress=sNTPServerInternetAddress, phyControlInstancedTableNumber=phyControlInstancedTableNumber, userTableNumber=userTableNumber, unitIdentification=unitIdentification, phyStatusGroup=phyStatusGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, aggregateDataRate=aggregateDataRate, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, licenseIEEE1588Support=licenseIEEE1588Support, apc=apc, searchState=searchState, incompatibleMasterAndSlave=incompatibleMasterAndSlave, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, ptpTrapPrefix=ptpTrapPrefix, maximumTransmitPower=maximumTransmitPower, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, tDMInterfaceControl=tDMInterfaceControl, linkName=linkName, mABNominalTransmitCapacity=mABNominalTransmitCapacity, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, management=management, eIRP=eIRP, wirelessLinkAvailability=wirelessLinkAvailability, ptp670=ptp670, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, sFPPortAutoNegotiation=sFPPortAutoNegotiation, wirelessOutOctets=wirelessOutOctets, productName=productName, transmitPowerLinked=transmitPowerLinked, encryptionGroup=encryptionGroup, receiveModulationMode=receiveModulationMode, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, auxPortStatus=auxPortStatus, licenseIssueNumber=licenseIssueNumber, managementNetworkAccessEnabled=managementNetworkAccessEnabled, tFTPServerInternetAddressType=tFTPServerInternetAddressType, linkModeOptimizationMismatch=linkModeOptimizationMismatch, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, enableTransmission=enableTransmission, dataBridgingStatusLinked=dataBridgingStatusLinked, sMTPEnabledMessages=sMTPEnabledMessages, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, incompatibleRegulatoryBands=incompatibleRegulatoryBands, syslogControlGroup=syslogControlGroup, qOSPriorityScheme=qOSPriorityScheme, tdmTableIndex=tdmTableIndex, whitelistRMMacAddress=whitelistRMMacAddress, phyInstancedStatusTable=phyInstancedStatusTable, sMTPServerInternetAddress=sMTPServerInternetAddress, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, managementGroup=managementGroup, useVLANForMABProtocol=useVLANForMABProtocol, antennaSelection=antennaSelection, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, tdmTableNumber=tdmTableNumber, ethernetPriorityTableIndex=ethernetPriorityTableIndex, encryptionAlgorithm=encryptionAlgorithm, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, unitOutOfCalibration=unitOutOfCalibration, sNMPTrapTable=sNMPTrapTable, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, byteErrorRatio=byteErrorRatio, receivePower=receivePower, smtpGroup=smtpGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, rawReceivePowerLinked=rawReceivePowerLinked, phyControlInstancedTable=phyControlInstancedTable, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, deviceESN=deviceESN, routerProtocolsGroup=routerProtocolsGroup, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, sNMPTrapVersion=sNMPTrapVersion, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, mgmtInstancedTable=mgmtInstancedTable, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, installStatusTrap=installStatusTrap, aAAControlGroup=aAAControlGroup, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, dNS=dNS, mABNominalModulationMode=mABNominalModulationMode, cableDiagnosticsGroup=cableDiagnosticsGroup, auxPortQLRx=auxPortQLRx, accessMethod=accessMethod, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, receiveFreqKHz=receiveFreqKHz, ethernetInstancedTable=ethernetInstancedTable, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, alarmInstancedTableEntry=alarmInstancedTableEntry, capacityVariantMismatchLinked=capacityVariantMismatchLinked, authorizationControlGroup=authorizationControlGroup, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, daylightSaving=daylightSaving, dataBridgingStatusAlarm=dataBridgingStatusAlarm, hTTPAccessEnabled=hTTPAccessEnabled, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, sNTPPollInterval=sNTPPollInterval, linkLossLinked=linkLossLinked, licenseBandwidthCap=licenseBandwidthCap, auxPortStatusTrap=auxPortStatusTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, hardwareVersion=hardwareVersion, cableDiagPair4Results=cableDiagPair4Results, licenseInstancedTableIndex=licenseInstancedTableIndex, unavailableSeconds=unavailableSeconds, packetsFromInternalStack=packetsFromInternalStack, cambium=cambium, ethernetInstancedTableIndex=ethernetInstancedTableIndex, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, licenseSyncESupport=licenseSyncESupport, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, remoteInternetAddress=remoteInternetAddress, portAllocationMismatch=portAllocationMismatch, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, ethernetPriorityTableNumber=ethernetPriorityTableNumber, mainPSUPortQLRx=mainPSUPortQLRx, ptpTraps=ptpTraps, dfsTableEntry=dfsTableEntry, cableDiagPair2Distance=cableDiagPair2Distance, tDDSynchronizationAlarm=tDDSynchronizationAlarm, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, sNTPServerPortNumber=sNTPServerPortNumber, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, tDMConfigurationMismatch=tDMConfigurationMismatch, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, vectorErrorLinked=vectorErrorLinked, licenseRARSupport=licenseRARSupport, licenseGroup=licenseGroup, alarms=alarms, sNTPSync=sNTPSync, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, cableDiagnosticsWarning=cableDiagnosticsWarning, cableDiagnosticsControl=cableDiagnosticsControl, blacklistRMMacAddress=blacklistRMMacAddress, syslogClientTrap=syslogClientTrap, searchStateLinked=searchStateLinked, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, longitude=longitude, packetsToInternalStack=packetsToInternalStack, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, transparentClockVLAN=transparentClockVLAN, mainPSUPortStatusTrap=mainPSUPortStatusTrap, licenseTDDSyncSupport=licenseTDDSyncSupport, ethernetGroup=ethernetGroup, mainPSUPortQLTx=mainPSUPortQLTx, sFPErrorTrap=sFPErrorTrap, sFPPortQLTx=sFPPortQLTx, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, linkSymmetry=linkSymmetry, capacityVariantMismatch=capacityVariantMismatch, deviceMSN=deviceMSN, tDDSynchronizationMode=tDDSynchronizationMode, dNSResolver=dNSResolver, installStatusLinked=installStatusLinked, subnetMask=subnetMask, ethernetInstancedTableNumber=ethernetInstancedTableNumber, txMABFrames=txMABFrames, licenseSFPPortSupport=licenseSFPPortSupport, versions=versions, deviceMACAddress=deviceMACAddress, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, licenseTrialPeriod=licenseTrialPeriod, secureModeAlarmTrap=secureModeAlarmTrap, cableLoss=cableLoss, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, ethernet=ethernet, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, sFPPortStatusTrap=sFPPortStatusTrap, nIDULanPortStatus=nIDULanPortStatus, sNTPServerTableNumber=sNTPServerTableNumber, mABTransmissionInterval=mABTransmissionInterval, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, vLANManagementPriority=vLANManagementPriority, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, mainPSUPortAllocation=mainPSUPortAllocation, vLANManagementVID=vLANManagementVID, alarmInstancedTable=alarmInstancedTable, nIDULanPortStatusTrap=nIDULanPortStatusTrap, licenseGasGroup=licenseGasGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, receiveModulationModeLinked=receiveModulationModeLinked, ptpGroups=ptpGroups, targetMACAddress=targetMACAddress, dNSServerTableNumber=dNSServerTableNumber, bootVersion=bootVersion, lbtDetectedTrap=lbtDetectedTrap, userTable=userTable, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, sNTPServerTableIndex=sNTPServerTableIndex)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", receiveDataRateLinked=receiveDataRateLinked, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, licenseInstancedTableEntry=licenseInstancedTableEntry, dataBridgingStatus=dataBridgingStatus, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, iPv6GatewayAddress=iPv6GatewayAddress, aggregateDataRateLinked=aggregateDataRateLinked, severelyErroredSeconds=severelyErroredSeconds, lowestTDMModulationMode=lowestTDMModulationMode, syslogState=syslogState, signalStrengthRatioLinked=signalStrengthRatioLinked, reset=reset, portAllocationMismatchLinked=portAllocationMismatchLinked, sNMPEnabledTraps=sNMPEnabledTraps, hCMPMaximumLinkRange=hCMPMaximumLinkRange, iPv6Address=iPv6Address, tFTPClient=tFTPClient, configurationInstancedTableEntry=configurationInstancedTableEntry, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, wirelessOutEthernetOctets=wirelessOutEthernetOctets, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, licenseUnitSerialNumber=licenseUnitSerialNumber, dNSServerInternetAddressType=dNSServerInternetAddressType, syslogControl=syslogControl, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, noWirelessChannelAvailable=noWirelessChannelAvailable, sNTPServerTimeout=sNTPServerTimeout, iPVersion=iPVersion, authorizationControlTableNumber=authorizationControlTableNumber, dfsPeaks=dfsPeaks, subbandLowestFrequency=subbandLowestFrequency, linkLoss=linkLoss, vectorError=vectorError, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNTPServerStatus=sNTPServerStatus, wirelessLinkStatusLinked=wirelessLinkStatusLinked, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, mPLSTCPriorityTable=mPLSTCPriorityTable, cableDiagPair3Distance=cableDiagPair3Distance, auxPortDisabledWarning=auxPortDisabledWarning, authorizationControlTableEntry=authorizationControlTableEntry, mABMaintenanceLevel=mABMaintenanceLevel, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, ethernetInstancedTableEntry=ethernetInstancedTableEntry, userName=userName, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, dfsGroup=dfsGroup, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, transparentClockPort=transparentClockPort, remoteUnitNameLinked=remoteUnitNameLinked, ethernetStatisticsTable=ethernetStatisticsTable, sNTPSyncTrap=sNTPSyncTrap, capacityVariantMismatchTrap=capacityVariantMismatchTrap, alarmsGroup=alarmsGroup, gatewayIPAddress=gatewayIPAddress, remoteInternetAddressType=remoteInternetAddressType, nIDULanPortAutoMdix=nIDULanPortAutoMdix, cableDiagPair1Distance=cableDiagPair1Distance, licenseVersion=licenseVersion, licenseEncryption=licenseEncryption, lowestDataModulationMode=lowestDataModulationMode, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, managementPortWirelessDownAlert=managementPortWirelessDownAlert, auxPortAcceptedQLRx=auxPortAcceptedQLRx, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, syncEEquipmentClock=syncEEquipmentClock, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, snmpControlGroup=snmpControlGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, configurationInstancedTable=configurationInstancedTable, apcGroup=apcGroup, alarmInstancedTableIndex=alarmInstancedTableIndex, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, productVariant=productVariant, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, pubStatsGroup=pubStatsGroup, antennaGain=antennaGain, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, rangingMode=rangingMode, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tdmTableEntry=tdmTableEntry, hTTPSPortNumber=hTTPSPortNumber, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, userEnabled=userEnabled, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, hTTPPortNumber=hTTPPortNumber, regulatoryBandTrap=regulatoryBandTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sMTPEmailAlert=sMTPEmailAlert, cableDiagnosticsResultTable=cableDiagnosticsResultTable, PYSNMP_MODULE_ID=cambium, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, sNMPTrapTableEntry=sNMPTrapTableEntry, userTableIndex=userTableIndex, dNSPrimaryServer=dNSPrimaryServer, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, telnetAccessEnabled=telnetAccessEnabled, softwareVersion=softwareVersion, maxLinkRangeExceeded=maxLinkRangeExceeded, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ptpCompliance=ptpCompliance, cableDiagPair3Results=cableDiagPair3Results, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, authorizationControlTableIndex=authorizationControlTableIndex, sNMPTrapPortNumber=sNMPTrapPortNumber, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, ethernetStatisticsDataSource=ethernetStatisticsDataSource, byteErrorRatioLinked=byteErrorRatioLinked, cableDiagPair1Results=cableDiagPair1Results, authorizationControlTable=authorizationControlTable, dfsMeans=dfsMeans, sNTPServerTableEntry=sNTPServerTableEntry, configuration=configuration, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, installArmStateTrap=installArmStateTrap, systemClock=systemClock, tDDControl=tDDControl, pubStats=pubStats, portAllocationMismatchTrap=portAllocationMismatchTrap, phyControl=phyControl, iPv4Address=iPv4Address, transmitModulationMode=transmitModulationMode, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, iPv6PrefixLength=iPv6PrefixLength, iPDSCPPriorityTable=iPDSCPPriorityTable, phyControlGroup=phyControlGroup, tDMInterfaceStatus=tDMInterfaceStatus, sNTPServerInternetAddressType=sNTPServerInternetAddressType, wirelessLinkStatus=wirelessLinkStatus, dNSServerTableIndex=dNSServerTableIndex, syslogLocalWrappedTrap=syslogLocalWrappedTrap, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, remoteInternetAddressLinked=remoteInternetAddressLinked, dfsTableNumber=dfsTableNumber, receivePowerLinked=receivePowerLinked, dNSServerPortNumber=dNSServerPortNumber, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNTPLastSync=sNTPLastSync, pubInstancedStatsTable=pubInstancedStatsTable, licenseOOBManagementSupport=licenseOOBManagementSupport, supplementaryGroup=supplementaryGroup, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, sNMPTrapInternetAddress=sNMPTrapInternetAddress, rxColorCode=rxColorCode, dataBridgingAvailability=dataBridgingAvailability, linkModeOptimization=linkModeOptimization, sNTPServerRetries=sNTPServerRetries, hCMPLinkSymmetry=hCMPLinkSymmetry, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, cableDiagnostics=cableDiagnostics, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, siteName=siteName, sFPPortAllocation=sFPPortAllocation, smtp=smtp, licenseInstancedTableNumber=licenseInstancedTableNumber, bridgeGroup=bridgeGroup, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, wirelessOutAllOctets=wirelessOutAllOctets, frequencyVariant=frequencyVariant, tDDControlGroup=tDDControlGroup, bridge=bridge, phyControlInstancedTableEntry=phyControlInstancedTableEntry, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tDMChannelLineCode=tDMChannelLineCode, masterSlaveMode=masterSlaveMode, mainPSUPortAutoMdix=mainPSUPortAutoMdix, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, transmitDataRateLinked=transmitDataRateLinked, authorizationControl=authorizationControl, alarmInstancedTableNumber=alarmInstancedTableNumber, phyStatus=phyStatus, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, transmitterChannels=transmitterChannels, ptp=ptp, sFPPortSSMTx=sFPPortSSMTx, telnetPortNumber=telnetPortNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, erroredSeconds=erroredSeconds, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, transmitModulationModeLinked=transmitModulationModeLinked, sMTPServerPortNumber=sMTPServerPortNumber, sNMPCommunityString=sNMPCommunityString, authorizationMethod=authorizationMethod, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, mgmtInstancedTableEntry=mgmtInstancedTableEntry, mABProtocolVLANPriority=mABProtocolVLANPriority, secondarySoftwareVersion=secondarySoftwareVersion, syslogStateTrap=syslogStateTrap, transparentClock=transparentClock, licenseRegulatoryBandsList=licenseRegulatoryBandsList, installationMode=installationMode, mABProtocolVID=mABProtocolVID, l2CPPriorityTableNumber=l2CPPriorityTableNumber, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, configurationInstancedTableNumber=configurationInstancedTableNumber, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, mABHoldoffPeriod=mABHoldoffPeriod, installStatus=installStatus, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, auxPortQLTx=auxPortQLTx, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, snmpControl=snmpControl, userTableEntry=userTableEntry, dNSServerInternetAddress=dNSServerInternetAddress, mgmtInstancedTableNumber=mgmtInstancedTableNumber, systemReset=systemReset, rangeLinked=rangeLinked, receiveChannel=receiveChannel, dNSGroup=dNSGroup, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, subbandHighestFrequency=subbandHighestFrequency, licenseSecurityLevel=licenseSecurityLevel, sNMPTrapTableNumber=sNMPTrapTableNumber, localPacketFiltering=localPacketFiltering, receiveFreqMHz=receiveFreqMHz, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, dNSServerTableEntry=dNSServerTableEntry, enabledDiagnosticAlarms=enabledDiagnosticAlarms, syncETracking=syncETracking, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, licenseIPv6Support=licenseIPv6Support, cableDiagPair4Distance=cableDiagPair4Distance, ethernetPriorityTableEntry=ethernetPriorityTableEntry, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, l2CPPriorityTable=l2CPPriorityTable, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, cableDiagPair2Results=cableDiagPair2Results, transparentClockVID=transparentClockVID, licenseCountry=licenseCountry, oOBPriorityQueueMapping=oOBPriorityQueueMapping, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, installArmState=installArmState, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, versionsGroup=versionsGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sFPError=sFPError, mainPSUPortSSMTx=mainPSUPortSSMTx, signalStrengthRatio=signalStrengthRatio, sNTPPrimaryServer=sNTPPrimaryServer, l2CPPriorityTableEntry=l2CPPriorityTableEntry, remoteMACAddressLinked=remoteMACAddressLinked, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, l2CPPriorityTableIndex=l2CPPriorityTableIndex, supplementary=supplementary)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", dSCPManagementPriority=dSCPManagementPriority, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, userPassword=userPassword, regulatoryBand=regulatoryBand, tDMEnabledChannels=tDMEnabledChannels, hTTPSAccessEnabled=hTTPSAccessEnabled, unitIdentificationGroup=unitIdentificationGroup, sMTPServerInternetAddressType=sMTPServerInternetAddressType, licenseGroupAccess=licenseGroupAccess, dataPortPauseFrames=dataPortPauseFrames, configurationGroup=configurationGroup, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, dfsTable=dfsTable, dfs=dfs, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPTrapTableIndex=sNMPTrapTableIndex, blacklistRMEnabled=blacklistRMEnabled, groupID=groupID, phyControlInstancedTableIndex=phyControlInstancedTableIndex, transmitDataRate=transmitDataRate, altitude=altitude, tDMChannelStatus=tDMChannelStatus, sNTPState=sNTPState, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, remoteMACAddress=remoteMACAddress, sntp=sntp, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, secureModeAlarm=secureModeAlarm, licenseHCMPSupport=licenseHCMPSupport, transmitChannel=transmitChannel, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, maximumNumberOfSlaves=maximumNumberOfSlaves, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, dataPortWirelessDownAlert=dataPortWirelessDownAlert, auxPortSSMTx=auxPortSSMTx, syncESlavePort=syncESlavePort, tDMChannelStatusTrap=tDMChannelStatusTrap, tFTPServerInternetAddress=tFTPServerInternetAddress, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, auxPortConfigurationMismatch=auxPortConfigurationMismatch, sFPPortQLRx=sFPPortQLRx, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tempPcb=tempPcb, configurationInstancedTableIndex=configurationInstancedTableIndex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPPortNumber=sNMPPortNumber, ethernetPriorityTable=ethernetPriorityTable, extendedSpectrumScanning=extendedSpectrumScanning, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, tDMGroup=tDMGroup, notificationsGroup=notificationsGroup, sFPPortDisabledWarning=sFPPortDisabledWarning, transmitFreqKHz=transmitFreqKHz, tDM=tDM, routerProtocols=routerProtocols, cableDiagnosticsPorts=cableDiagnosticsPorts, channelBandwidth=channelBandwidth, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames)
