...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", supplementary=supplementary, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, syncETrackingState=syncETrackingState, mgmtInstancedTableIndex=mgmtInstancedTableIndex, cableDiagnostics=cableDiagnostics, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, syslogControlGroup=syslogControlGroup, mainPSUPortAllocation=mainPSUPortAllocation, phyControlInstancedTableIndex=phyControlInstancedTableIndex, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, tDMChannelStatusTrap=tDMChannelStatusTrap, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, tDMInterfaceStatus=tDMInterfaceStatus, supplementaryGroup=supplementaryGroup, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, sNMPTrapTable=sNMPTrapTable, licenseTLSRekey=licenseTLSRekey, localPacketFiltering=localPacketFiltering, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, licenseRARSupport=licenseRARSupport, userName=userName, license=license, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, searchState=searchState, cableDiagnosticsPorts=cableDiagnosticsPorts, wirelessOutOctets=wirelessOutOctets, subbandLowestFrequency=subbandLowestFrequency, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, sFPPortStatus=sFPPortStatus, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, mainPSUPortSSMTx=mainPSUPortSSMTx, rangeLinked=rangeLinked, ptpCompliance=ptpCompliance, cableLoss=cableLoss, bridge=bridge, phyStatusGroup=phyStatusGroup, ethernet=ethernet, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, ethernetPriorityTableIndex=ethernetPriorityTableIndex, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, licenseCountry=licenseCountry, targetRange=targetRange, cableDiagPair2Distance=cableDiagPair2Distance, sFPPortSSMTx=sFPPortSSMTx, pubStats=pubStats, hTTPSAccessEnabled=hTTPSAccessEnabled, smtp=smtp, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, tDMChannelLoopback=tDMChannelLoopback, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, licenseOOBManagementSupport=licenseOOBManagementSupport, tFTPServerInternetAddressType=tFTPServerInternetAddressType, mABNominalModulationMode=mABNominalModulationMode, mainPSUPortQLTx=mainPSUPortQLTx, dNSServerInternetAddress=dNSServerInternetAddress, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, whitelistRMMacAddress=whitelistRMMacAddress, reset=reset, aAAControlGroup=aAAControlGroup, routerProtocolsGroup=routerProtocolsGroup, mABProtocolVID=mABProtocolVID, configurationInstancedTableEntry=configurationInstancedTableEntry, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, dNSServerTableEntry=dNSServerTableEntry, sNTPServerPortNumber=sNTPServerPortNumber, iPDSCPPriorityTable=iPDSCPPriorityTable, alarms=alarms, smtpGroup=smtpGroup, receiveDataRateLinked=receiveDataRateLinked, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, transmitModulationMode=transmitModulationMode, txColorCode=txColorCode, transmitDataRate=transmitDataRate, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dNSServerTableIndex=dNSServerTableIndex, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, dSCPManagementPriority=dSCPManagementPriority, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, dfsMeans=dfsMeans, maximumNumberOfSlaves=maximumNumberOfSlaves, channelChangeTrap=channelChangeTrap, cableDiagnosticsGroup=cableDiagnosticsGroup, ethernetInstancedTable=ethernetInstancedTable, licenseTDDSyncSupport=licenseTDDSyncSupport, receiveModulationMode=receiveModulationMode, bridgeGroup=bridgeGroup, deviceESN=deviceESN, iPv4Address=iPv4Address, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sntp=sntp, sNTPState=sNTPState, sNMPTrapTableNumber=sNMPTrapTableNumber, licenseMaxLinkRange=licenseMaxLinkRange, phyControl=phyControl, licenseInstancedTableNumber=licenseInstancedTableNumber, licenseEncryption=licenseEncryption, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, sNTPServerTable=sNTPServerTable, installStatusLinked=installStatusLinked, useVLANForManagementInterfaces=useVLANForManagementInterfaces, authorizationControlTable=authorizationControlTable, iPv6GatewayAddress=iPv6GatewayAddress, dNSServerTable=dNSServerTable, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, dNSServerPortNumber=dNSServerPortNumber, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, cableDiagnosticsControl=cableDiagnosticsControl, whitelistRMEnabled=whitelistRMEnabled, sNTPServerTimeout=sNTPServerTimeout, auxPortSSMTx=auxPortSSMTx, ethernetPriorityTableEntry=ethernetPriorityTableEntry, enableTransmission=enableTransmission, auxPortAllocation=auxPortAllocation, alarmInstancedTableIndex=alarmInstancedTableIndex, configurationGroup=configurationGroup, mABMaintenanceLevel=mABMaintenanceLevel, wirelessTopology=wirelessTopology, blacklistRMEnabled=blacklistRMEnabled, receiveChannel=receiveChannel, wirelessOutEthernetOctets=wirelessOutEthernetOctets, encryption=encryption, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, secureModeAlarmTrap=secureModeAlarmTrap, lowestDataModulationMode=lowestDataModulationMode, sMTPEnabledMessages=sMTPEnabledMessages, sFPErrorTrap=sFPErrorTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, cableDiagPair3Distance=cableDiagPair3Distance, siteName=siteName, pubStatsGroup=pubStatsGroup, installationMode=installationMode, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, syslogStateTrap=syslogStateTrap, sNTPServerStatus=sNTPServerStatus, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, eIRP=eIRP, syslogClient=syslogClient, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, syslogState=syslogState, dfsTableNumber=dfsTableNumber, mgmtInstancedTable=mgmtInstancedTable, dataBridgingAvailability=dataBridgingAvailability, linkLossLinked=linkLossLinked, remoteUnitName=remoteUnitName, dfsPeaks=dfsPeaks, productVariant=productVariant, userRole=userRole, hCMPLinkSymmetry=hCMPLinkSymmetry, ethernetGroup=ethernetGroup, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, licenseGroup=licenseGroup, transmitFreqKHz=transmitFreqKHz, ptpTrapPrefix=ptpTrapPrefix, wirelessOutAllOctets=wirelessOutAllOctets, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, extendedSpectrumScanning=extendedSpectrumScanning, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, auxPortAcceptedQLRx=auxPortAcceptedQLRx, l2CPPriorityTableNumber=l2CPPriorityTableNumber, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, tFTPServerInternetAddress=tFTPServerInternetAddress, userPassword=userPassword, ethernetInstancedTableIndex=ethernetInstancedTableIndex, sNMPTrapPortNumber=sNMPTrapPortNumber, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, tDMGroup=tDMGroup, tDDSynchronizationMode=tDDSynchronizationMode, linkModeOptimization=linkModeOptimization, wirelessLinkAvailability=wirelessLinkAvailability, iPv6PrefixLength=iPv6PrefixLength, telnetPortNumber=telnetPortNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, transmitDataRateLinked=transmitDataRateLinked, bootVersion=bootVersion, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, remoteInternetAddress=remoteInternetAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, vectorErrorLinked=vectorErrorLinked, latitude=latitude, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapTableIndex=sNMPTrapTableIndex, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, erroredSeconds=erroredSeconds, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, linkLoss=linkLoss, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, subnetMask=subnetMask, remoteInternetAddressType=remoteInternetAddressType, sNTPSync=sNTPSync, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, iPv6Address=iPv6Address, remoteUnitNameLinked=remoteUnitNameLinked, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tDDControlGroup=tDDControlGroup, sNMPCommunityString=sNMPCommunityString, receivePower=receivePower, ptpGroups=ptpGroups, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, regulatoryBandTrap=regulatoryBandTrap, configurationInstancedTable=configurationInstancedTable, tDDSynchronizationStatus=tDDSynchronizationStatus, telnetAccessEnabled=telnetAccessEnabled, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, sFPPortAutoMdix=sFPPortAutoMdix, capacityVariantMismatch=capacityVariantMismatch, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, mainPSUPortAutoMdix=mainPSUPortAutoMdix, sNMPTrapInternetAddress=sNMPTrapInternetAddress, hTTPPortNumber=hTTPPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tDM=tDM, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, txMABFrames=txMABFrames, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, licenseSFPPortSupport=licenseSFPPortSupport, sNMPTrapTableEntry=sNMPTrapTableEntry, systemReset=systemReset, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, rawReceivePowerLinked=rawReceivePowerLinked, sNTPPollInterval=sNTPPollInterval, cableDiagPair3Results=cableDiagPair3Results, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, apcGroup=apcGroup, cableDiagnosticsResultTable=cableDiagnosticsResultTable, remoteMACAddressLinked=remoteMACAddressLinked, hTTPSPortNumber=hTTPSPortNumber, tempPcb=tempPcb, timeZone=timeZone, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ethernetPriorityTable=ethernetPriorityTable, resetGroup=resetGroup, sFPError=sFPError, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, syncEEquipmentClock=syncEEquipmentClock, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, mABHoldoffPeriod=mABHoldoffPeriod, mainPSUPortStatus=mainPSUPortStatus, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, capacityVariantMismatchLinked=capacityVariantMismatchLinked, dfs=dfs, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, packetsFromInternalStack=packetsFromInternalStack, authorizationControlGroup=authorizationControlGroup, secureModeAlarm=secureModeAlarm, dNSServerTableNumber=dNSServerTableNumber, remoteMACAddress=remoteMACAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, subbandHighestFrequency=subbandHighestFrequency, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, tFTPServerPortNumber=tFTPServerPortNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tdmTableIndex=tdmTableIndex, antennaGain=antennaGain, userTable=userTable, sNTPServerInternetAddressType=sNTPServerInternetAddressType, licenseBandwidthCap=licenseBandwidthCap, mABState=mABState, sNTPLastSync=sNTPLastSync, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, receiveDataRate=receiveDataRate, authorizationControlTableIndex=authorizationControlTableIndex, configuration=configuration, lowestTDMModulationMode=lowestTDMModulationMode, cableDiagPair1Distance=cableDiagPair1Distance, mABProtocolVLANPriority=mABProtocolVLANPriority, tDDControl=tDDControl, auxPortStatusTrap=auxPortStatusTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, targetMACAddress=targetMACAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, softwareVersion=softwareVersion, portAllocationMismatchTrap=portAllocationMismatchTrap, packetsToInternalStack=packetsToInternalStack, systemClock=systemClock, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, linkName=linkName, licenseRegulatoryBandsList=licenseRegulatoryBandsList, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, managementPortWirelessDownAlert=managementPortWirelessDownAlert, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, sNTPSyncTrap=sNTPSyncTrap, dataBridgingStatusAlarm=dataBridgingStatusAlarm, mPLSTCPriorityTable=mPLSTCPriorityTable, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, capacityVariantMismatchTrap=capacityVariantMismatchTrap, vLANManagementPriority=vLANManagementPriority, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, transmitPowerLinked=transmitPowerLinked, licenseInstancedTableIndex=licenseInstancedTableIndex, sMTPEmailAlert=sMTPEmailAlert, rxColorCode=rxColorCode, sFPPortStatusTrap=sFPPortStatusTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ptpTraps=ptpTraps, userEnabled=userEnabled, signalStrengthRatio=signalStrengthRatio, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, wirelessLinkStatus=wirelessLinkStatus, dfsTableEntry=dfsTableEntry, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, alarmInstancedTableEntry=alarmInstancedTableEntry, sNMPPortNumber=sNMPPortNumber, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, receiveFreqKHz=receiveFreqKHz, licenseCapacity=licenseCapacity, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, licenseSyncESupport=licenseSyncESupport, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, configurationInstancedTableNumber=configurationInstancedTableNumber, licenseSecurityLevel=licenseSecurityLevel, sNTPServerTableEntry=sNTPServerTableEntry, phyControlInstancedTableEntry=phyControlInstancedTableEntry, sFPPortDisabledWarning=sFPPortDisabledWarning, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, accessMethod=accessMethod, tdmTable=tdmTable, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, unavailableSeconds=unavailableSeconds, licenseVersion=licenseVersion, longitude=longitude, rangingMode=rangingMode, sFPPortSyncERxStatus=sFPPortSyncERxStatus, productName=productName, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, wirelessLinkStatusLinked=wirelessLinkStatusLinked, ethernetStatisticsDataSource=ethernetStatisticsDataSource, receiveModulationModeLinked=receiveModulationModeLinked, licenseUnitSerialNumber=licenseUnitSerialNumber, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, transmitModulationModeLinked=transmitModulationModeLinked, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, unitIdentification=unitIdentification, encryptionGroup=encryptionGroup, tDMChannelStatus=tDMChannelStatus, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, snmpControlGroup=snmpControlGroup, sNTPServerInternetAddress=sNTPServerInternetAddress, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, cableDiagPair4Results=cableDiagPair4Results, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sFPPortAllocation=sFPPortAllocation, tDMChannelLineCode=tDMChannelLineCode, phyInstancedStatusTable=phyInstancedStatusTable, tDMConfigurationMismatch=tDMConfigurationMismatch, userTableEntry=userTableEntry, channelBandwidth=channelBandwidth, dfsTableIndex=dfsTableIndex, tDDSynchronizationAlarm=tDDSynchronizationAlarm, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, ptmp=ptmp, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, maximumTransmitPower=maximumTransmitPower, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, maxLinkRangeExceeded=maxLinkRangeExceeded, dataBridgingStatus=dataBridgingStatus, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, deviceMSN=deviceMSN, lbtDetectedTrap=lbtDetectedTrap, vectorError=vectorError, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, aAAControl=aAAControl, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, receiveFreqMHz=receiveFreqMHz, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, auxPortDisabledWarning=auxPortDisabledWarning, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, groupID=groupID, configurationInstancedTableIndex=configurationInstancedTableIndex, alarmsGroup=alarmsGroup, licenseTrialPeriod=licenseTrialPeriod, range=range, managementGroup=managementGroup, versions=versions, cambium=cambium, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, ethernetStatisticsTable=ethernetStatisticsTable, management=management, tdmTableEntry=tdmTableEntry, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, userTableNumber=userTableNumber, iPVersion=iPVersion, transmitChannel=transmitChannel, sNTPServerRetries=sNTPServerRetries, severelyErroredSeconds=severelyErroredSeconds, licenseIssueNumber=licenseIssueNumber, dfsTable=dfsTable, installArmStateTrap=installArmStateTrap, nIDULanPortStatus=nIDULanPortStatus, managementNetworkAccessEnabled=managementNetworkAccessEnabled, versionsGroup=versionsGroup, licenseGasGroup=licenseGasGroup, remoteInternetAddressLinked=remoteInternetAddressLinked, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, licenseGroupAccess=licenseGroupAccess, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, receivePowerLinked=receivePowerLinked, dNSGroup=dNSGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, transmitPower=transmitPower, sNMPv3Enable=sNMPv3Enable, auxPortSyncERxStatus=auxPortSyncERxStatus, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, sNTPServerTableNumber=sNTPServerTableNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, notificationsGroup=notificationsGroup, mgmtInstancedTableEntry=mgmtInstancedTableEntry, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, tFTPClient=tFTPClient, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, deviceMACAddress=deviceMACAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, altitude=altitude, authorizationMethod=authorizationMethod, linkSymmetry=linkSymmetry, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, syncESlavePort=syncESlavePort, oOBPriorityQueueMapping=oOBPriorityQueueMapping, hardwareVersion=hardwareVersion, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, transmitterChannels=transmitterChannels, noWirelessChannelAvailable=noWirelessChannelAvailable, mainPSUPortQLRx=mainPSUPortQLRx, masterSlaveMode=masterSlaveMode, tDMEnabledChannels=tDMEnabledChannels, hCMPMaximumLinkRange=hCMPMaximumLinkRange, transparentClockVLAN=transparentClockVLAN, apc=apc, rawReceivePower=rawReceivePower, phyControlGroup=phyControlGroup, auxPortQLTx=auxPortQLTx, qOSPriorityScheme=qOSPriorityScheme, auxPortConfigurationMismatch=auxPortConfigurationMismatch, unitOutOfCalibration=unitOutOfCalibration, syslogControl=syslogControl, authorizationControlTableEntry=authorizationControlTableEntry, sFPPortQLTx=sFPPortQLTx, installArmState=installArmState, tdmTableNumber=tdmTableNumber, dNS=dNS, ethernetInstancedTableEntry=ethernetInstancedTableEntry, sMTPServerInternetAddress=sMTPServerInternetAddress, phyControlInstancedTableNumber=phyControlInstancedTableNumber, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, cableDiagPair1Results=cableDiagPair1Results, mABNominalTransmitCapacity=mABNominalTransmitCapacity, cableDiagPair4Distance=cableDiagPair4Distance, cableDiagPair2Results=cableDiagPair2Results, portAllocationMismatch=portAllocationMismatch, blacklistRMMacAddress=blacklistRMMacAddress, hTTPAccessEnabled=hTTPAccessEnabled, auxPortStatus=auxPortStatus, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, licenseIEEE1588Support=licenseIEEE1588Support, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, alarmInstancedTableNumber=alarmInstancedTableNumber, incompatibleRegulatoryBands=incompatibleRegulatoryBands, unitIdentificationGroup=unitIdentificationGroup, gatewayIPAddress=gatewayIPAddress, mABTransmissionInterval=mABTransmissionInterval, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, tDMChannelCableLength=tDMChannelCableLength, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, sMTPServerInternetAddressType=sMTPServerInternetAddressType, tDMInterfaceControl=tDMInterfaceControl, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, l2CPPriorityTable=l2CPPriorityTable, dNSResolver=dNSResolver, mainPSUPortStatusTrap=mainPSUPortStatusTrap, transparentClock=transparentClock, sMTPServerPortNumber=sMTPServerPortNumber, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, useVLANForMABProtocol=useVLANForMABProtocol, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, licenseHCMPSupport=licenseHCMPSupport, licenseInstancedTableEntry=licenseInstancedTableEntry, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, dataPortWirelessDownAlert=dataPortWirelessDownAlert, receiveModulationModeDetail=receiveModulationModeDetail, sNTPPrimaryServer=sNTPPrimaryServer, byteErrorRatio=byteErrorRatio, aggregateDataRate=aggregateDataRate, dataPortPauseFrames=dataPortPauseFrames, nIDULanPortAutoMdix=nIDULanPortAutoMdix)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", installStatusTrap=installStatusTrap, licenseInstancedTable=licenseInstancedTable, ptp670=ptp670, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNTPServerTableIndex=sNTPServerTableIndex, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, installStatus=installStatus, routerProtocols=routerProtocols, sntpGroup=sntpGroup, daylightSaving=daylightSaving, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, dataBridgingStatusLinked=dataBridgingStatusLinked, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, phyControlInstancedTable=phyControlInstancedTable, transparentClockVID=transparentClockVID, dfsGroup=dfsGroup, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, dNSServerInternetAddressType=dNSServerInternetAddressType, ptp=ptp, PYSNMP_MODULE_ID=cambium, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, sFPPortQLRx=sFPPortQLRx, snmpControl=snmpControl, nIDULanPortStatusTrap=nIDULanPortStatusTrap, mgmtInstancedTableNumber=mgmtInstancedTableNumber, syncETracking=syncETracking, transmitFreqMHz=transmitFreqMHz, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, syslogClientTrap=syslogClientTrap, phyStatus=phyStatus, dNSPrimaryServer=dNSPrimaryServer, regulatoryBand=regulatoryBand, frequencyVariant=frequencyVariant, encryptionAlgorithm=encryptionAlgorithm, userTableIndex=userTableIndex, portAllocationMismatchLinked=portAllocationMismatchLinked, signalStrengthRatioLinked=signalStrengthRatioLinked, secondarySoftwareVersion=secondarySoftwareVersion, transparentClockPort=transparentClockPort, sFPPortAutoNegotiation=sFPPortAutoNegotiation, sNMPTrapVersion=sNMPTrapVersion, antennaSelection=antennaSelection, auxPortQLRx=auxPortQLRx, l2CPPriorityTableIndex=l2CPPriorityTableIndex, alarmInstancedTable=alarmInstancedTable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, searchStateLinked=searchStateLinked, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, byteErrorRatioLinked=byteErrorRatioLinked, authorizationControlTableNumber=authorizationControlTableNumber, ethernetInstancedTableNumber=ethernetInstancedTableNumber, pubInstancedStatsTable=pubInstancedStatsTable, vLANManagementVID=vLANManagementVID, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, cableDiagnosticsWarning=cableDiagnosticsWarning, authorizationControl=authorizationControl, licenseIPv6Support=licenseIPv6Support, l2CPPriorityTableEntry=l2CPPriorityTableEntry, aggregateDataRateLinked=aggregateDataRateLinked, unitName=unitName)
