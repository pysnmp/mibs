...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, supplementary=supplementary, receiveModulationModeLinked=receiveModulationModeLinked, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, byteErrorRatioLinked=byteErrorRatioLinked, installArmState=installArmState, pubStats=pubStats, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, syslogClientTrap=syslogClientTrap, dfsMeans=dfsMeans, authorizationControlGroup=authorizationControlGroup, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, systemClock=systemClock, ptp670=ptp670, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, sFPPortDisabledWarning=sFPPortDisabledWarning, receiveFreqMHz=receiveFreqMHz, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, mABHoldoffPeriod=mABHoldoffPeriod, sNMPTrapInternetAddress=sNMPTrapInternetAddress, channelBandwidth=channelBandwidth, transmitFreqMHz=transmitFreqMHz, license=license, notificationsGroup=notificationsGroup, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, portAllocationMismatch=portAllocationMismatch, secureModeAlarmTrap=secureModeAlarmTrap, linkSymmetry=linkSymmetry, packetsFromInternalStack=packetsFromInternalStack, sntpGroup=sntpGroup, l2CPPriorityTableEntry=l2CPPriorityTableEntry, bridgeGroup=bridgeGroup, subbandHighestFrequency=subbandHighestFrequency, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, vLANManagementPriority=vLANManagementPriority, sMTPServerInternetAddress=sMTPServerInternetAddress, cableDiagPair1Distance=cableDiagPair1Distance, installStatus=installStatus, sNMPv3Enable=sNMPv3Enable, unitIdentificationGroup=unitIdentificationGroup, telnetAccessEnabled=telnetAccessEnabled, phyControlInstancedTableNumber=phyControlInstancedTableNumber, eIRP=eIRP, sNMPPortNumber=sNMPPortNumber, authorizationControlTableNumber=authorizationControlTableNumber, phyControlInstancedTableIndex=phyControlInstancedTableIndex, licenseRARSupport=licenseRARSupport, subbandLowestFrequency=subbandLowestFrequency, latitude=latitude, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, rawReceivePower=rawReceivePower, transmitModulationMode=transmitModulationMode, dfsPeaks=dfsPeaks, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, installStatusLinked=installStatusLinked, remoteMACAddressLinked=remoteMACAddressLinked, bootVersion=bootVersion, dNSServerTableIndex=dNSServerTableIndex, sMTPServerInternetAddressType=sMTPServerInternetAddressType, pubInstancedStatsTable=pubInstancedStatsTable, licenseVersion=licenseVersion, syncESlavePort=syncESlavePort, configurationInstancedTableNumber=configurationInstancedTableNumber, userTableNumber=userTableNumber, tDMChannelLoopback=tDMChannelLoopback, wirelessLinkStatus=wirelessLinkStatus, sMTPServerPortNumber=sMTPServerPortNumber, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, mABProtocolVLANPriority=mABProtocolVLANPriority, smtp=smtp, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, tFTPClient=tFTPClient, sFPPortQLTx=sFPPortQLTx, management=management, remoteInternetAddressType=remoteInternetAddressType, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, oOBPriorityQueueMapping=oOBPriorityQueueMapping, sNTPServerRetries=sNTPServerRetries, licenseEncryption=licenseEncryption, deviceMSN=deviceMSN, sNTPServerPortNumber=sNTPServerPortNumber, subnetMask=subnetMask, tDMInterfaceControl=tDMInterfaceControl, unitOutOfCalibration=unitOutOfCalibration, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, auxPortStatusTrap=auxPortStatusTrap, dfs=dfs, mgmtInstancedTableIndex=mgmtInstancedTableIndex, licenseInstancedTableNumber=licenseInstancedTableNumber, hTTPAccessEnabled=hTTPAccessEnabled, sNTPSync=sNTPSync, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, auxPortQLRx=auxPortQLRx, sFPPortAllocation=sFPPortAllocation, tDMInterfaceStatus=tDMInterfaceStatus, auxPortSyncERxStatus=auxPortSyncERxStatus, sFPPortSyncERxStatus=sFPPortSyncERxStatus, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, syslogState=syslogState, configurationInstancedTable=configurationInstancedTable, whitelistRMEnabled=whitelistRMEnabled, sNTPServerTimeout=sNTPServerTimeout, maximumTransmitPower=maximumTransmitPower, tDMChannelCableLength=tDMChannelCableLength, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, siteName=siteName, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, sFPPortQLRx=sFPPortQLRx, licenseSecurityLevel=licenseSecurityLevel, aAAControlGroup=aAAControlGroup, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, portAllocationMismatchTrap=portAllocationMismatchTrap, wirelessLinkAvailability=wirelessLinkAvailability, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, dataBridgingStatusLinked=dataBridgingStatusLinked, sFPPortStatus=sFPPortStatus, sNTPServerTableIndex=sNTPServerTableIndex, syslogClient=syslogClient, dfsTable=dfsTable, snmpControl=snmpControl, iPv6PrefixLength=iPv6PrefixLength, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, configurationGroup=configurationGroup, searchState=searchState, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ptpTraps=ptpTraps, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, apcGroup=apcGroup, iPv4Address=iPv4Address, apc=apc, frequencyVariant=frequencyVariant, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, transparentClockVID=transparentClockVID, phyControlInstancedTable=phyControlInstancedTable, syslogControl=syslogControl, ethernetGroup=ethernetGroup, productVariant=productVariant, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, auxPortSSMTx=auxPortSSMTx, phyControl=phyControl, alarmInstancedTableEntry=alarmInstancedTableEntry, mainPSUPortStatus=mainPSUPortStatus, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tDMGroup=tDMGroup, mainPSUPortAutoMdix=mainPSUPortAutoMdix, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, licenseGasGroup=licenseGasGroup, mABTransmissionInterval=mABTransmissionInterval, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapTableIndex=sNMPTrapTableIndex, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, licenseSFPPortSupport=licenseSFPPortSupport, wirelessOutAllOctets=wirelessOutAllOctets, sMTPEnabledMessages=sMTPEnabledMessages, telnetPortNumber=telnetPortNumber, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, tFTPServerPortNumber=tFTPServerPortNumber, receiveFreqKHz=receiveFreqKHz, sNMPTrapTableEntry=sNMPTrapTableEntry, syncETracking=syncETracking, vectorErrorLinked=vectorErrorLinked, sNTPState=sNTPState, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, licenseCapacity=licenseCapacity, installStatusTrap=installStatusTrap, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, dfsGroup=dfsGroup, aggregateDataRate=aggregateDataRate, alarmInstancedTable=alarmInstancedTable, ethernetInstancedTableIndex=ethernetInstancedTableIndex, cableDiagPair2Distance=cableDiagPair2Distance, receivePowerLinked=receivePowerLinked, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, incompatibleRegulatoryBands=incompatibleRegulatoryBands, transmitPower=transmitPower, maximumNumberOfSlaves=maximumNumberOfSlaves, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tDMEnabledChannels=tDMEnabledChannels, licenseBandwidthCap=licenseBandwidthCap, auxPortStatus=auxPortStatus, userRole=userRole, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, cambium=cambium, aggregateDataRateLinked=aggregateDataRateLinked, useVLANForMABProtocol=useVLANForMABProtocol, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, hardwareVersion=hardwareVersion, dNSServerPortNumber=dNSServerPortNumber, tDMConfigurationMismatch=tDMConfigurationMismatch, linkName=linkName, channelChangeTrap=channelChangeTrap, licenseGroupAccess=licenseGroupAccess, sNTPServerTableEntry=sNTPServerTableEntry, lbtDetectedTrap=lbtDetectedTrap, hTTPPortNumber=hTTPPortNumber, sNTPSyncTrap=sNTPSyncTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, accessMethod=accessMethod, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, licenseSyncESupport=licenseSyncESupport, extendedSpectrumScanning=extendedSpectrumScanning, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, whitelistRMMacAddress=whitelistRMMacAddress, severelyErroredSeconds=severelyErroredSeconds, linkLossLinked=linkLossLinked, configurationInstancedTableIndex=configurationInstancedTableIndex, tdmTableNumber=tdmTableNumber, productName=productName, hCMPMaximumLinkRange=hCMPMaximumLinkRange, transparentClock=transparentClock, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, blacklistRMEnabled=blacklistRMEnabled, tDDSynchronizationMode=tDDSynchronizationMode, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, capacityVariantMismatchLinked=capacityVariantMismatchLinked, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, licenseMaxLinkRange=licenseMaxLinkRange, userName=userName, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, unitIdentification=unitIdentification, sFPPortSSMTx=sFPPortSSMTx, wirelessOutEthernetOctets=wirelessOutEthernetOctets, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, dSCPManagementPriority=dSCPManagementPriority, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, transmitDataRateLinked=transmitDataRateLinked, cableDiagPair2Results=cableDiagPair2Results, wirelessLinkStatusLinked=wirelessLinkStatusLinked, cableDiagPair3Distance=cableDiagPair3Distance, mABState=mABState, cableDiagnosticsPorts=cableDiagnosticsPorts)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", cableDiagnosticsGroup=cableDiagnosticsGroup, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, dataBridgingStatusAlarm=dataBridgingStatusAlarm, ethernet=ethernet, licenseCountry=licenseCountry, auxPortAllocation=auxPortAllocation, groupID=groupID, auxPortQLTx=auxPortQLTx, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, installArmStateTrap=installArmStateTrap, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, tFTPServerInternetAddress=tFTPServerInternetAddress, sMTPEmailAlert=sMTPEmailAlert, dNSPrimaryServer=dNSPrimaryServer, managementNetworkAccessEnabled=managementNetworkAccessEnabled, dNSServerTableEntry=dNSServerTableEntry, tDDControlGroup=tDDControlGroup, dNSServerInternetAddressType=dNSServerInternetAddressType, alarms=alarms, signalStrengthRatio=signalStrengthRatio, targetMACAddress=targetMACAddress, iPv6Address=iPv6Address, transparentClockPort=transparentClockPort, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, dNSServerTable=dNSServerTable, licenseInstancedTableEntry=licenseInstancedTableEntry, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, aAAControl=aAAControl, authorizationMethod=authorizationMethod, encryptionAlgorithm=encryptionAlgorithm, targetRange=targetRange, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, cableDiagPair4Results=cableDiagPair4Results, licenseTLSRekey=licenseTLSRekey, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, dNSResolver=dNSResolver, authorizationControlTableIndex=authorizationControlTableIndex, packetsToInternalStack=packetsToInternalStack, tDMChannelStatusTrap=tDMChannelStatusTrap, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, remoteUnitName=remoteUnitName, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, range=range, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, receiveModulationMode=receiveModulationMode, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, hCMPLinkSymmetry=hCMPLinkSymmetry, dataBridgingStatus=dataBridgingStatus, receiveModulationModeDetail=receiveModulationModeDetail, sNTPPollInterval=sNTPPollInterval, sntp=sntp, transmitPowerLinked=transmitPowerLinked, dNS=dNS, tDMChannelLineCode=tDMChannelLineCode, licenseTrialPeriod=licenseTrialPeriod, masterSlaveMode=masterSlaveMode, antennaSelection=antennaSelection, configurationInstancedTableEntry=configurationInstancedTableEntry, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, transmitChannel=transmitChannel, alarmInstancedTableIndex=alarmInstancedTableIndex, antennaGain=antennaGain, iPv6GatewayAddress=iPv6GatewayAddress, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, supplementaryGroup=supplementaryGroup, versionsGroup=versionsGroup, ptpTrapPrefix=ptpTrapPrefix, mainPSUPortStatusTrap=mainPSUPortStatusTrap, daylightSaving=daylightSaving, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, tdmTableIndex=tdmTableIndex, mainPSUPortSSMTx=mainPSUPortSSMTx, txColorCode=txColorCode, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, licenseInstancedTable=licenseInstancedTable, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, userTableEntry=userTableEntry, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, blacklistRMMacAddress=blacklistRMMacAddress, rangeLinked=rangeLinked, capacityVariantMismatch=capacityVariantMismatch, transmitModulationModeLinked=transmitModulationModeLinked, ethernetPriorityTableNumber=ethernetPriorityTableNumber, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, mPLSTCPriorityTable=mPLSTCPriorityTable, secureModeAlarm=secureModeAlarm, userTableIndex=userTableIndex, portAllocationMismatchLinked=portAllocationMismatchLinked, auxPortConfigurationMismatch=auxPortConfigurationMismatch, receiveDataRate=receiveDataRate, sFPPortStatusTrap=sFPPortStatusTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, txMABFrames=txMABFrames, qOSPriorityScheme=qOSPriorityScheme, licenseInstancedTableIndex=licenseInstancedTableIndex, tDMChannelStatus=tDMChannelStatus, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPServerInternetAddressType=sNTPServerInternetAddressType, auxPortAcceptedQLRx=auxPortAcceptedQLRx, ptpGroups=ptpGroups, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, sFPError=sFPError, systemReset=systemReset, versions=versions, l2CPPriorityTableNumber=l2CPPriorityTableNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, transmitDataRate=transmitDataRate, licenseIEEE1588Support=licenseIEEE1588Support, authorizationControlTableEntry=authorizationControlTableEntry, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, licenseUnitSerialNumber=licenseUnitSerialNumber, ptmp=ptmp, smtpGroup=smtpGroup, remoteInternetAddress=remoteInternetAddress, capacityVariantMismatchTrap=capacityVariantMismatchTrap, PYSNMP_MODULE_ID=cambium, gatewayIPAddress=gatewayIPAddress, wirelessOutOctets=wirelessOutOctets, cableDiagPair4Distance=cableDiagPair4Distance, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, tDM=tDM, receivePower=receivePower, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, deviceMACAddress=deviceMACAddress, ethernetPriorityTable=ethernetPriorityTable, tFTPServerInternetAddressType=tFTPServerInternetAddressType, licenseIPv6Support=licenseIPv6Support, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, licenseOOBManagementSupport=licenseOOBManagementSupport, licenseHCMPSupport=licenseHCMPSupport, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, byteErrorRatio=byteErrorRatio, ethernetInstancedTable=ethernetInstancedTable, bridge=bridge, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, mABNominalTransmitCapacity=mABNominalTransmitCapacity, nIDULanPortAutoMdix=nIDULanPortAutoMdix, sNTPLastSync=sNTPLastSync, encryption=encryption, phyInstancedStatusTable=phyInstancedStatusTable, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, altitude=altitude, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, mainPSUPortQLTx=mainPSUPortQLTx, mABNominalModulationMode=mABNominalModulationMode, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, searchStateLinked=searchStateLinked, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, sFPPortAutoNegotiation=sFPPortAutoNegotiation, linkLoss=linkLoss, ethernetStatisticsDataSource=ethernetStatisticsDataSource, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, sFPErrorTrap=sFPErrorTrap, vLANManagementVID=vLANManagementVID, dfsTableIndex=dfsTableIndex, mgmtInstancedTableEntry=mgmtInstancedTableEntry, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, managementGroup=managementGroup, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, transmitterChannels=transmitterChannels, mgmtInstancedTableNumber=mgmtInstancedTableNumber, ptp=ptp, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, longitude=longitude, nIDULanPortStatus=nIDULanPortStatus, dataPortPauseFrames=dataPortPauseFrames, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, syslogLocalWrappedTrap=syslogLocalWrappedTrap, signalStrengthRatioLinked=signalStrengthRatioLinked, sNMPTrapTableNumber=sNMPTrapTableNumber, mainPSUPortAllocation=mainPSUPortAllocation, tDDControl=tDDControl, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, cableDiagnostics=cableDiagnostics, routerProtocols=routerProtocols, tempPcb=tempPcb, alarmInstancedTableNumber=alarmInstancedTableNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, dNSGroup=dNSGroup, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, pubStatsGroup=pubStatsGroup, cableDiagPair3Results=cableDiagPair3Results, routerProtocolsGroup=routerProtocolsGroup, mABProtocolVID=mABProtocolVID, dfsTableEntry=dfsTableEntry, hTTPSPortNumber=hTTPSPortNumber, receiveChannel=receiveChannel, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, syncETrackingState=syncETrackingState, licenseIssueNumber=licenseIssueNumber, rawReceivePowerLinked=rawReceivePowerLinked, phyControlInstancedTableEntry=phyControlInstancedTableEntry, dNSServerTableNumber=dNSServerTableNumber, userTable=userTable, syncEEquipmentClock=syncEEquipmentClock, reset=reset, transparentClockVLAN=transparentClockVLAN, phyStatus=phyStatus, wirelessTopology=wirelessTopology, resetGroup=resetGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, mABMaintenanceLevel=mABMaintenanceLevel, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, cableLoss=cableLoss, installationMode=installationMode, phyStatusGroup=phyStatusGroup, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, sNTPServerTableNumber=sNTPServerTableNumber, sNTPPrimaryServer=sNTPPrimaryServer, sNTPServerStatus=sNTPServerStatus, syslogControlGroup=syslogControlGroup, dataBridgingAvailability=dataBridgingAvailability, tdmTable=tdmTable, cableDiagPair1Results=cableDiagPair1Results, ethernetPriorityTableIndex=ethernetPriorityTableIndex, l2CPPriorityTableIndex=l2CPPriorityTableIndex, iPVersion=iPVersion, timeZone=timeZone, ethernetStatisticsTable=ethernetStatisticsTable, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, l2CPPriorityTable=l2CPPriorityTable, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, licenseGroup=licenseGroup, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, secondarySoftwareVersion=secondarySoftwareVersion, cableDiagnosticsWarning=cableDiagnosticsWarning, regulatoryBandTrap=regulatoryBandTrap, syslogStateTrap=syslogStateTrap, lowestDataModulationMode=lowestDataModulationMode, rxColorCode=rxColorCode, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, mainPSUPortQLRx=mainPSUPortQLRx, cableDiagnosticsControl=cableDiagnosticsControl, alarmsGroup=alarmsGroup, ethernetInstancedTableNumber=ethernetInstancedTableNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", authorizationControlTable=authorizationControlTable, encryptionGroup=encryptionGroup, dfsTableNumber=dfsTableNumber, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, softwareVersion=softwareVersion, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, vectorError=vectorError, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, sNMPTrapPortNumber=sNMPTrapPortNumber, maxLinkRangeExceeded=maxLinkRangeExceeded, enableTransmission=enableTransmission, snmpControlGroup=snmpControlGroup, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, phyControlGroup=phyControlGroup, remoteInternetAddressLinked=remoteInternetAddressLinked, ptpCompliance=ptpCompliance, managementPortWirelessDownAlert=managementPortWirelessDownAlert, dNSServerInternetAddress=dNSServerInternetAddress, unitName=unitName, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, sNMPEnabledTraps=sNMPEnabledTraps, unavailableSeconds=unavailableSeconds, licenseRegulatoryBandsList=licenseRegulatoryBandsList, sNMPTrapVersion=sNMPTrapVersion, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, erroredSeconds=erroredSeconds, sNMPCommunityString=sNMPCommunityString, remoteMACAddress=remoteMACAddress, userEnabled=userEnabled, sFPPortAutoMdix=sFPPortAutoMdix, tdmTableEntry=tdmTableEntry, configuration=configuration, deviceESN=deviceESN, remoteUnitNameLinked=remoteUnitNameLinked, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, nIDULanPortStatusTrap=nIDULanPortStatusTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, receiveDataRateLinked=receiveDataRateLinked, localPacketFiltering=localPacketFiltering, mgmtInstancedTable=mgmtInstancedTable, transmitFreqKHz=transmitFreqKHz, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, sNMPTrapTable=sNMPTrapTable, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ethernetInstancedTableEntry=ethernetInstancedTableEntry, userPassword=userPassword, authorizationControl=authorizationControl, cableDiagnosticsResultTable=cableDiagnosticsResultTable, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, hTTPSAccessEnabled=hTTPSAccessEnabled, regulatoryBand=regulatoryBand, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, lowestTDMModulationMode=lowestTDMModulationMode, auxPortDisabledWarning=auxPortDisabledWarning, rangingMode=rangingMode, licenseTDDSyncSupport=licenseTDDSyncSupport, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, sNTPServerTable=sNTPServerTable, linkModeOptimization=linkModeOptimization, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry)
