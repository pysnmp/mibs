...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", pubInstancedStatsTable=pubInstancedStatsTable, eIRP=eIRP, altitude=altitude, mABProtocolVID=mABProtocolVID, subbandLowestFrequency=subbandLowestFrequency, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, cableDiagnosticsPorts=cableDiagnosticsPorts, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, receivePowerLinked=receivePowerLinked, userName=userName, extendedSpectrumScanning=extendedSpectrumScanning, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, sNTPServerInternetAddress=sNTPServerInternetAddress, pubStats=pubStats, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, auxPortQLTx=auxPortQLTx, cableDiagnostics=cableDiagnostics, tDMInterfaceControl=tDMInterfaceControl, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, sFPPortAutoNegotiation=sFPPortAutoNegotiation, cableDiagnosticsResultTable=cableDiagnosticsResultTable, licenseRegulatoryBandsList=licenseRegulatoryBandsList, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, rangingMode=rangingMode, tDMConfigurationMismatch=tDMConfigurationMismatch, iPDSCPPriorityTable=iPDSCPPriorityTable, signalStrengthRatio=signalStrengthRatio, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, deviceMACAddress=deviceMACAddress, authorizationControlTableEntry=authorizationControlTableEntry, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, sNMPPortNumber=sNMPPortNumber, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, softwareVersion=softwareVersion, ptpCompliance=ptpCompliance, regulatoryBandTrap=regulatoryBandTrap, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, syncESlavePort=syncESlavePort, wirelessOutEthernetOctets=wirelessOutEthernetOctets, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, snmpControlGroup=snmpControlGroup, transmitFreqMHz=transmitFreqMHz, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, dfsTableIndex=dfsTableIndex, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, txColorCode=txColorCode, lbtDetectedTrap=lbtDetectedTrap, rangeLinked=rangeLinked, transmitDataRateLinked=transmitDataRateLinked, sNTPSync=sNTPSync, sNTPServerTableNumber=sNTPServerTableNumber, rxColorCode=rxColorCode, searchStateLinked=searchStateLinked, licenseTLSRekey=licenseTLSRekey, regulatoryBand=regulatoryBand, deviceESN=deviceESN, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, installStatusTrap=installStatusTrap, sNMPEnabledTraps=sNMPEnabledTraps, receivePower=receivePower, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, dSCPManagementPriority=dSCPManagementPriority, installStatus=installStatus, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, subnetMask=subnetMask, authorizationMethod=authorizationMethod, blacklistRMEnabled=blacklistRMEnabled, mgmtInstancedTableNumber=mgmtInstancedTableNumber, cableDiagPair1Results=cableDiagPair1Results, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, mainPSUPortStatusTrap=mainPSUPortStatusTrap, iPv6PrefixLength=iPv6PrefixLength, licenseMaxLinkRange=licenseMaxLinkRange, receiveModulationMode=receiveModulationMode, installArmState=installArmState, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, wirelessLinkStatus=wirelessLinkStatus, mainPSUPortQLRx=mainPSUPortQLRx, sNMPTrapPortNumber=sNMPTrapPortNumber, smtp=smtp, ptmp=ptmp, ptp670=ptp670, remoteUnitName=remoteUnitName, sNTPServerInternetAddressType=sNTPServerInternetAddressType, transparentClockPort=transparentClockPort, licenseEncryption=licenseEncryption, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tDMChannelLoopback=tDMChannelLoopback, ethernetInstancedTableNumber=ethernetInstancedTableNumber, nIDULanPortAutoMdix=nIDULanPortAutoMdix, tDM=tDM, dataBridgingStatusLinked=dataBridgingStatusLinked, cableDiagPair2Distance=cableDiagPair2Distance, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, packetsToInternalStack=packetsToInternalStack, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, managementPortWirelessDownAlert=managementPortWirelessDownAlert, telnetAccessEnabled=telnetAccessEnabled, sMTPServerInternetAddressType=sMTPServerInternetAddressType, linkModeOptimization=linkModeOptimization, PYSNMP_MODULE_ID=cambium, unitOutOfCalibration=unitOutOfCalibration, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, configurationInstancedTable=configurationInstancedTable, wirelessLinkAvailability=wirelessLinkAvailability, cableDiagPair1Distance=cableDiagPair1Distance, phyControlInstancedTableEntry=phyControlInstancedTableEntry, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sFPPortAllocation=sFPPortAllocation, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, phyControlInstancedTableNumber=phyControlInstancedTableNumber, cableDiagPair4Distance=cableDiagPair4Distance, dfsTableNumber=dfsTableNumber, syslogClient=syslogClient, tFTPServerInternetAddressType=tFTPServerInternetAddressType, alarms=alarms, reset=reset, userTableIndex=userTableIndex, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, wirelessTopology=wirelessTopology, unitName=unitName, hardwareVersion=hardwareVersion, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tDMChannelStatus=tDMChannelStatus, tDMChannelCableLength=tDMChannelCableLength, antennaSelection=antennaSelection, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, sMTPEmailAlert=sMTPEmailAlert, userRole=userRole, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, managementGroup=managementGroup, apc=apc, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, licenseOOBManagementSupport=licenseOOBManagementSupport, linkSymmetry=linkSymmetry, licenseRARSupport=licenseRARSupport, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, licenseCountry=licenseCountry, secureModeAlarm=secureModeAlarm, dfsTable=dfsTable, secureModeAlarmTrap=secureModeAlarmTrap, licenseSFPPortSupport=licenseSFPPortSupport, ptpTrapPrefix=ptpTrapPrefix, syslogClientTrap=syslogClientTrap, dNSServerTableIndex=dNSServerTableIndex, nIDULanPortStatus=nIDULanPortStatus, license=license, iPv6Address=iPv6Address, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNMPCommunityString=sNMPCommunityString, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, alarmInstancedTable=alarmInstancedTable, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, wirelessLinkStatusLinked=wirelessLinkStatusLinked, userPassword=userPassword, installArmStateTrap=installArmStateTrap, vectorErrorLinked=vectorErrorLinked, sNTPServerTable=sNTPServerTable, mgmtInstancedTableIndex=mgmtInstancedTableIndex, dataBridgingStatusAlarm=dataBridgingStatusAlarm, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, mainPSUPortAllocation=mainPSUPortAllocation, nIDULanPortStatusTrap=nIDULanPortStatusTrap, mABState=mABState, linkLossLinked=linkLossLinked, maxLinkRangeExceeded=maxLinkRangeExceeded, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, searchState=searchState, wirelessOutOctets=wirelessOutOctets, whitelistRMEnabled=whitelistRMEnabled, mABTransmissionInterval=mABTransmissionInterval, tDMEnabledChannels=tDMEnabledChannels, dfsPeaks=dfsPeaks, receiveModulationModeLinked=receiveModulationModeLinked, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, ethernetPriorityTableEntry=ethernetPriorityTableEntry, lowestDataModulationMode=lowestDataModulationMode, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, ethernet=ethernet, dNS=dNS, oOBPriorityQueueMapping=oOBPriorityQueueMapping, routerProtocols=routerProtocols, licenseSyncESupport=licenseSyncESupport, iPv4Address=iPv4Address, groupID=groupID, channelChangeTrap=channelChangeTrap, userTable=userTable, licenseIssueNumber=licenseIssueNumber, timeZone=timeZone, mainPSUPortSSMTx=mainPSUPortSSMTx, sFPPortDisabledWarning=sFPPortDisabledWarning, capacityVariantMismatch=capacityVariantMismatch, syncETrackingState=syncETrackingState, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, tFTPServerPortNumber=tFTPServerPortNumber, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, transmitPower=transmitPower, transmitModulationMode=transmitModulationMode, dataBridgingStatus=dataBridgingStatus, tDMInterfaceStatus=tDMInterfaceStatus, maximumNumberOfSlaves=maximumNumberOfSlaves, antennaGain=antennaGain, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, l2CPPriorityTable=l2CPPriorityTable, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, portAllocationMismatchTrap=portAllocationMismatchTrap, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, subbandHighestFrequency=subbandHighestFrequency, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, severelyErroredSeconds=severelyErroredSeconds, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, installStatusLinked=installStatusLinked, versionsGroup=versionsGroup, alarmInstancedTableNumber=alarmInstancedTableNumber, txMABFrames=txMABFrames, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, remoteMACAddress=remoteMACAddress, sNTPSyncTrap=sNTPSyncTrap, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, licenseInstancedTableNumber=licenseInstancedTableNumber, aggregateDataRate=aggregateDataRate, licenseBandwidthCap=licenseBandwidthCap, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, maximumTransmitPower=maximumTransmitPower, tFTPServerInternetAddress=tFTPServerInternetAddress, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, productVariant=productVariant, mABNominalModulationMode=mABNominalModulationMode, cambium=cambium, dNSServerPortNumber=dNSServerPortNumber, packetsFromInternalStack=packetsFromInternalStack, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", dataBridgingAvailability=dataBridgingAvailability, hTTPPortNumber=hTTPPortNumber, sFPPortAutoMdix=sFPPortAutoMdix, tDDControl=tDDControl, licenseIEEE1588Support=licenseIEEE1588Support, capacityVariantMismatchTrap=capacityVariantMismatchTrap, aggregateDataRateLinked=aggregateDataRateLinked, licenseGroupAccess=licenseGroupAccess, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, dNSServerTableNumber=dNSServerTableNumber, daylightSaving=daylightSaving, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, phyInstancedStatusTable=phyInstancedStatusTable, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNTPLastSync=sNTPLastSync, dataPortPauseFrames=dataPortPauseFrames, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, tdmTable=tdmTable, remoteUnitNameLinked=remoteUnitNameLinked, auxPortAcceptedQLRx=auxPortAcceptedQLRx, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, linkModeOptimizationMismatch=linkModeOptimizationMismatch, cableDiagPair3Results=cableDiagPair3Results, sNMPTrapInternetAddress=sNMPTrapInternetAddress, licenseInstancedTableEntry=licenseInstancedTableEntry, sNTPState=sNTPState, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, pubStatsGroup=pubStatsGroup, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, qOSPriorityScheme=qOSPriorityScheme, wirelessOutAllOctets=wirelessOutAllOctets, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, configurationGroup=configurationGroup, transmitterChannels=transmitterChannels, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, sFPPortSyncERxStatus=sFPPortSyncERxStatus, useVLANForMABProtocol=useVLANForMABProtocol, licenseVersion=licenseVersion, transmitModulationModeLinked=transmitModulationModeLinked, userTableEntry=userTableEntry, accessMethod=accessMethod, hCMPLinkSymmetry=hCMPLinkSymmetry, phyStatus=phyStatus, sMTPServerPortNumber=sMTPServerPortNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, portAllocationMismatch=portAllocationMismatch, vLANManagementPriority=vLANManagementPriority, tDMGroup=tDMGroup, transparentClockVID=transparentClockVID, rawReceivePowerLinked=rawReceivePowerLinked, licenseGasGroup=licenseGasGroup, encryptionGroup=encryptionGroup, configuration=configuration, capacityVariantMismatchLinked=capacityVariantMismatchLinked, localPacketFiltering=localPacketFiltering, phyStatusGroup=phyStatusGroup, hTTPAccessEnabled=hTTPAccessEnabled, dNSPrimaryServer=dNSPrimaryServer, tDDControlGroup=tDDControlGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, auxPortStatus=auxPortStatus, versions=versions, frequencyVariant=frequencyVariant, transmitPowerLinked=transmitPowerLinked, resetGroup=resetGroup, bootVersion=bootVersion, mainPSUPortAutoMdix=mainPSUPortAutoMdix, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPPollInterval=sNTPPollInterval, tempPcb=tempPcb, supplementaryGroup=supplementaryGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sFPErrorTrap=sFPErrorTrap, ethernetGroup=ethernetGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, remoteInternetAddress=remoteInternetAddress, snmpControl=snmpControl, receiveModulationModeDetail=receiveModulationModeDetail, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, phyControl=phyControl, alarmInstancedTableEntry=alarmInstancedTableEntry, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, cableDiagPair3Distance=cableDiagPair3Distance, ethernetInstancedTable=ethernetInstancedTable, tDMChannelLineCode=tDMChannelLineCode, targetRange=targetRange, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, mABHoldoffPeriod=mABHoldoffPeriod, alarmsGroup=alarmsGroup, installationMode=installationMode, incompatibleMasterAndSlave=incompatibleMasterAndSlave, bridge=bridge, l2CPPriorityTableEntry=l2CPPriorityTableEntry, mABNominalTransmitCapacity=mABNominalTransmitCapacity, cableLoss=cableLoss, dNSResolver=dNSResolver, mainPSUPortStatus=mainPSUPortStatus, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, authorizationControl=authorizationControl, rawReceivePower=rawReceivePower, receiveDataRateLinked=receiveDataRateLinked, tDDSynchronizationMode=tDDSynchronizationMode, aAAControl=aAAControl, receiveFreqKHz=receiveFreqKHz, management=management, ethernetPriorityTable=ethernetPriorityTable, sNMPTrapTableNumber=sNMPTrapTableNumber, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, supplementary=supplementary, gatewayIPAddress=gatewayIPAddress, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, licenseCapacity=licenseCapacity, authorizationControlTableIndex=authorizationControlTableIndex, userTableNumber=userTableNumber, enableTransmission=enableTransmission, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, useVLANForManagementInterfaces=useVLANForManagementInterfaces, range=range, hCMPMaximumLinkRange=hCMPMaximumLinkRange, transparentClock=transparentClock, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, tFTPClient=tFTPClient, tDDSynchronizationAlarm=tDDSynchronizationAlarm, mgmtInstancedTableEntry=mgmtInstancedTableEntry, phyControlGroup=phyControlGroup, authorizationControlTable=authorizationControlTable, sntpGroup=sntpGroup, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, licenseTrialPeriod=licenseTrialPeriod, ptp=ptp, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapTable=sNMPTrapTable, sMTPServerInternetAddress=sMTPServerInternetAddress, whitelistRMMacAddress=whitelistRMMacAddress, userEnabled=userEnabled, configurationInstancedTableIndex=configurationInstancedTableIndex, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, auxPortQLRx=auxPortQLRx, authorizationControlTableNumber=authorizationControlTableNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, apcGroup=apcGroup, cableDiagnosticsWarning=cableDiagnosticsWarning, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, licenseUnitSerialNumber=licenseUnitSerialNumber, mgmtInstancedTable=mgmtInstancedTable, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, hTTPSPortNumber=hTTPSPortNumber, auxPortDisabledWarning=auxPortDisabledWarning, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sFPPortQLRx=sFPPortQLRx, ethernetStatisticsDataSource=ethernetStatisticsDataSource, sFPPortQLTx=sFPPortQLTx, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, siteName=siteName, sNTPServerTableEntry=sNTPServerTableEntry, byteErrorRatioLinked=byteErrorRatioLinked, configurationInstancedTableNumber=configurationInstancedTableNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tdmTableNumber=tdmTableNumber, dNSServerTableEntry=dNSServerTableEntry, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, notificationsGroup=notificationsGroup, linkName=linkName, auxPortSyncERxStatus=auxPortSyncERxStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, licenseIPv6Support=licenseIPv6Support, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, licenseInstancedTableIndex=licenseInstancedTableIndex, latitude=latitude, deviceMSN=deviceMSN, sNTPServerStatus=sNTPServerStatus, ethernetInstancedTableIndex=ethernetInstancedTableIndex, auxPortSSMTx=auxPortSSMTx, dfsGroup=dfsGroup, unitIdentificationGroup=unitIdentificationGroup, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, portAllocationMismatchLinked=portAllocationMismatchLinked, erroredSeconds=erroredSeconds, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, cableDiagnosticsControl=cableDiagnosticsControl, dNSGroup=dNSGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, sNTPServerTimeout=sNTPServerTimeout, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, dNSServerInternetAddress=dNSServerInternetAddress, routerProtocolsGroup=routerProtocolsGroup, mABProtocolVLANPriority=mABProtocolVLANPriority, cableDiagnosticsGroup=cableDiagnosticsGroup, secondarySoftwareVersion=secondarySoftwareVersion, sNTPServerRetries=sNTPServerRetries, sNTPServerTableIndex=sNTPServerTableIndex, telnetPortNumber=telnetPortNumber, iPv6GatewayAddress=iPv6GatewayAddress, remoteInternetAddressLinked=remoteInternetAddressLinked, transmitFreqKHz=transmitFreqKHz, licenseSecurityLevel=licenseSecurityLevel, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, transparentClockVLAN=transparentClockVLAN, smtpGroup=smtpGroup, syslogStateTrap=syslogStateTrap, unitIdentification=unitIdentification, cableDiagPair2Results=cableDiagPair2Results, receiveFreqMHz=receiveFreqMHz, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNTPServerPortNumber=sNTPServerPortNumber, sNMPv3Enable=sNMPv3Enable, dNSServerInternetAddressType=dNSServerInternetAddressType, sFPPortStatus=sFPPortStatus, bridgeGroup=bridgeGroup, blacklistRMMacAddress=blacklistRMMacAddress, sFPPortStatusTrap=sFPPortStatusTrap, dfs=dfs, syslogControlGroup=syslogControlGroup, dfsTableEntry=dfsTableEntry, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, receiveDataRate=receiveDataRate, sFPPortSSMTx=sFPPortSSMTx, syslogState=syslogState, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ethernetInstancedTableEntry=ethernetInstancedTableEntry, dNSServerTable=dNSServerTable, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ethernetStatisticsTable=ethernetStatisticsTable, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, alarmInstancedTableIndex=alarmInstancedTableIndex, mPLSTCPriorityTable=mPLSTCPriorityTable, configurationInstancedTableEntry=configurationInstancedTableEntry, phyControlInstancedTable=phyControlInstancedTable, productName=productName, tdmTableIndex=tdmTableIndex, systemReset=systemReset, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, phyControlInstancedTableIndex=phyControlInstancedTableIndex, sntp=sntp, sNMPTrapVersion=sNMPTrapVersion, licenseInstancedTable=licenseInstancedTable, channelBandwidth=channelBandwidth, sMTPEnabledMessages=sMTPEnabledMessages)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", l2CPPriorityTableIndex=l2CPPriorityTableIndex, transmitChannel=transmitChannel, syncEEquipmentClock=syncEEquipmentClock, licenseTDDSyncSupport=licenseTDDSyncSupport, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, cableDiagPair4Results=cableDiagPair4Results, sFPError=sFPError, dfsMeans=dfsMeans, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, iPVersion=iPVersion, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, ptpTraps=ptpTraps, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, remoteMACAddressLinked=remoteMACAddressLinked, signalStrengthRatioLinked=signalStrengthRatioLinked, mainPSUPortQLTx=mainPSUPortQLTx, managementNetworkAccessEnabled=managementNetworkAccessEnabled, tdmTableEntry=tdmTableEntry, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, unavailableSeconds=unavailableSeconds, vectorError=vectorError, byteErrorRatio=byteErrorRatio, licenseGroup=licenseGroup, auxPortAllocation=auxPortAllocation, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, encryptionAlgorithm=encryptionAlgorithm, lowestTDMModulationMode=lowestTDMModulationMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPPrimaryServer=sNTPPrimaryServer, tDMChannelStatusTrap=tDMChannelStatusTrap, receiveChannel=receiveChannel, incompatibleRegulatoryBands=incompatibleRegulatoryBands, masterSlaveMode=masterSlaveMode, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, remoteInternetAddressType=remoteInternetAddressType, auxPortStatusTrap=auxPortStatusTrap, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, systemClock=systemClock, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, syncETracking=syncETracking, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, linkLoss=linkLoss, auxPortConfigurationMismatch=auxPortConfigurationMismatch, transmitDataRate=transmitDataRate, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, aAAControlGroup=aAAControlGroup, authorizationControlGroup=authorizationControlGroup, targetMACAddress=targetMACAddress, ptpGroups=ptpGroups, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, licenseHCMPSupport=licenseHCMPSupport, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, mABMaintenanceLevel=mABMaintenanceLevel, longitude=longitude, syslogControl=syslogControl, vLANManagementVID=vLANManagementVID, encryption=encryption)
