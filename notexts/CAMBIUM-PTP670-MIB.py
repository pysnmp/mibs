...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, transparentClock=transparentClock, alarmInstancedTableNumber=alarmInstancedTableNumber, targetRange=targetRange, transparentClockPort=transparentClockPort, tdmTable=tdmTable, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, dfsTableEntry=dfsTableEntry, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, l2CPPriorityTable=l2CPPriorityTable, licenseInstancedTableEntry=licenseInstancedTableEntry, licenseBandwidthCap=licenseBandwidthCap, reset=reset, ptpGroups=ptpGroups, configurationInstancedTable=configurationInstancedTable, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, incompatibleMasterAndSlave=incompatibleMasterAndSlave, authorizationMethod=authorizationMethod, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, dNSGroup=dNSGroup, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, pubStatsGroup=pubStatsGroup, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, lowestDataModulationMode=lowestDataModulationMode, versions=versions, receiveFreqMHz=receiveFreqMHz, licenseGasGroup=licenseGasGroup, licenseSecurityLevel=licenseSecurityLevel, wirelessLinkStatusLinked=wirelessLinkStatusLinked, incompatibleRegulatoryBands=incompatibleRegulatoryBands, ethernet=ethernet, dSCPManagementPriority=dSCPManagementPriority, configurationInstancedTableIndex=configurationInstancedTableIndex, apcGroup=apcGroup, licenseCapacity=licenseCapacity, aggregateDataRate=aggregateDataRate, nIDULanPortStatusTrap=nIDULanPortStatusTrap, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, phyInstancedStatusTable=phyInstancedStatusTable, licenseIPv6Support=licenseIPv6Support, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPLastSync=sNTPLastSync, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, notificationsGroup=notificationsGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, phyControlInstancedTableEntry=phyControlInstancedTableEntry, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, tDMChannelLineCode=tDMChannelLineCode, userName=userName, sMTPServerPortNumber=sMTPServerPortNumber, userTableIndex=userTableIndex, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNTPSyncTrap=sNTPSyncTrap, mgmtInstancedTable=mgmtInstancedTable, qOSPriorityScheme=qOSPriorityScheme, whitelistRMMacAddress=whitelistRMMacAddress, dataBridgingStatus=dataBridgingStatus, sNTPServerTableIndex=sNTPServerTableIndex, mABMaintenanceLevel=mABMaintenanceLevel, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sFPPortAutoMdix=sFPPortAutoMdix, masterSlaveMode=masterSlaveMode, authorizationControlTableIndex=authorizationControlTableIndex, tempPcb=tempPcb, cableDiagPair2Results=cableDiagPair2Results, deviceESN=deviceESN, licenseTrialPeriod=licenseTrialPeriod, transmitFreqKHz=transmitFreqKHz, configuration=configuration, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, dfs=dfs, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, tdmTableIndex=tdmTableIndex, sntp=sntp, routerProtocols=routerProtocols, transparentClockVLAN=transparentClockVLAN, tDM=tDM, cableDiagPair4Results=cableDiagPair4Results, phyControlInstancedTableNumber=phyControlInstancedTableNumber, snmpControlGroup=snmpControlGroup, iPv6GatewayAddress=iPv6GatewayAddress, auxPortStatusTrap=auxPortStatusTrap, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, managementNetworkAccessEnabled=managementNetworkAccessEnabled, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, nIDULanPortStatus=nIDULanPortStatus, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, licenseInstancedTableIndex=licenseInstancedTableIndex, mABTransmissionInterval=mABTransmissionInterval, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, ptmp=ptmp, mABState=mABState, ethernetInstancedTable=ethernetInstancedTable, targetMACAddress=targetMACAddress, auxPortSyncERxStatus=auxPortSyncERxStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, iPv4Address=iPv4Address, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, bridgeGroup=bridgeGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, userTableNumber=userTableNumber, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, transmitFreqMHz=transmitFreqMHz, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, snmpControl=snmpControl, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, licenseHCMPSupport=licenseHCMPSupport, dataBridgingStatusAlarm=dataBridgingStatusAlarm, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, regulatoryBandTrap=regulatoryBandTrap, hTTPAccessEnabled=hTTPAccessEnabled, tFTPClient=tFTPClient, accessMethod=accessMethod, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, sFPErrorTrap=sFPErrorTrap, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, receivePower=receivePower, authorizationControlTableNumber=authorizationControlTableNumber, remoteInternetAddressType=remoteInternetAddressType, groupID=groupID, auxPortConfigurationMismatch=auxPortConfigurationMismatch, signalStrengthRatioLinked=signalStrengthRatioLinked, licenseRARSupport=licenseRARSupport, dfsGroup=dfsGroup, erroredSeconds=erroredSeconds, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, licenseEncryption=licenseEncryption, hTTPSAccessEnabled=hTTPSAccessEnabled, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, sNTPServerStatus=sNTPServerStatus, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, systemClock=systemClock, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, tDDSynchronizationStatus=tDDSynchronizationStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, wirelessOutEthernetOctets=wirelessOutEthernetOctets, sNMPPortNumber=sNMPPortNumber, PYSNMP_MODULE_ID=cambium, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, installStatusTrap=installStatusTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, cableDiagnosticsResultTable=cableDiagnosticsResultTable, maximumNumberOfSlaves=maximumNumberOfSlaves, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, unitIdentificationGroup=unitIdentificationGroup, portAllocationMismatch=portAllocationMismatch, authorizationControl=authorizationControl, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, sMTPEmailAlert=sMTPEmailAlert, userTableEntry=userTableEntry, extendedSpectrumScanning=extendedSpectrumScanning, timeZone=timeZone, mainPSUPortSSMTx=mainPSUPortSSMTx, sFPPortAllocation=sFPPortAllocation, softwareVersion=softwareVersion, authorizationControlTable=authorizationControlTable, rxColorCode=rxColorCode, syslogClient=syslogClient, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNTPServerTimeout=sNTPServerTimeout, resetGroup=resetGroup, management=management, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, searchStateLinked=searchStateLinked, byteErrorRatioLinked=byteErrorRatioLinked, sMTPSourceEmailAddress=sMTPSourceEmailAddress, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, syncETracking=syncETracking, ethernetStatisticsDataSource=ethernetStatisticsDataSource, unitName=unitName, sFPPortSyncERxStatus=sFPPortSyncERxStatus, licenseVersion=licenseVersion, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, tDMInterfaceControl=tDMInterfaceControl, auxPortSSMTx=auxPortSSMTx, ethernetGroup=ethernetGroup, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, rangeLinked=rangeLinked, receiveModulationModeDetail=receiveModulationModeDetail, blacklistRMMacAddress=blacklistRMMacAddress, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, mABNominalTransmitCapacity=mABNominalTransmitCapacity, alarmInstancedTableEntry=alarmInstancedTableEntry, licenseUnitSerialNumber=licenseUnitSerialNumber, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, installArmState=installArmState, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, enableTransmission=enableTransmission, subbandHighestFrequency=subbandHighestFrequency, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, systemReset=systemReset, licenseGroup=licenseGroup, installArmStateTrap=installArmStateTrap, syslogControlGroup=syslogControlGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, licenseTLSRekey=licenseTLSRekey, txColorCode=txColorCode, dfsTableNumber=dfsTableNumber, auxPortQLRx=auxPortQLRx, subbandLowestFrequency=subbandLowestFrequency, tDMEnabledChannels=tDMEnabledChannels, encryptionGroup=encryptionGroup, frequencyVariant=frequencyVariant, sMTPServerInternetAddress=sMTPServerInternetAddress, channelBandwidth=channelBandwidth, sNMPTrapTableEntry=sNMPTrapTableEntry, rawReceivePowerLinked=rawReceivePowerLinked, vLANManagementPriority=vLANManagementPriority, mainPSUPortStatusTrap=mainPSUPortStatusTrap, configurationInstancedTableEntry=configurationInstancedTableEntry, phyControl=phyControl, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, gatewayIPAddress=gatewayIPAddress, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, linkName=linkName, noWirelessChannelAvailable=noWirelessChannelAvailable, ethernetPriorityTable=ethernetPriorityTable, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, transparentClockVID=transparentClockVID, linkLoss=linkLoss, licenseCountry=licenseCountry, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, license=license, channelChangeTrap=channelChangeTrap, userTable=userTable, maxLinkRangeExceeded=maxLinkRangeExceeded, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sFPPortSSMTx=sFPPortSSMTx, licenseOOBManagementSupport=licenseOOBManagementSupport, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, receiveDataRateLinked=receiveDataRateLinked, tDMGroup=tDMGroup, tDMInterfaceStatus=tDMInterfaceStatus, alarmInstancedTable=alarmInstancedTable, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, bootVersion=bootVersion, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, remoteMACAddress=remoteMACAddress, cambium=cambium, tDDControl=tDDControl, linkModeOptimization=linkModeOptimization)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", mPLSTCPriorityTable=mPLSTCPriorityTable, antennaGain=antennaGain, tDDControlGroup=tDDControlGroup, capacityVariantMismatch=capacityVariantMismatch, useVLANForMABProtocol=useVLANForMABProtocol, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, wirelessLinkAvailability=wirelessLinkAvailability, siteName=siteName, wirelessTopology=wirelessTopology, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, authorizationControlTableEntry=authorizationControlTableEntry, aggregateDataRateLinked=aggregateDataRateLinked, vLANManagementVID=vLANManagementVID, mABHoldoffPeriod=mABHoldoffPeriod, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, productVariant=productVariant, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, sFPPortStatus=sFPPortStatus, tdmTableEntry=tdmTableEntry, hardwareVersion=hardwareVersion, licenseGroupAccess=licenseGroupAccess, supplementary=supplementary, nIDULanPortAutoMdix=nIDULanPortAutoMdix, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, supplementaryGroup=supplementaryGroup, syslogStateTrap=syslogStateTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, cableDiagPair2Distance=cableDiagPair2Distance, sNMPTrapPortNumber=sNMPTrapPortNumber, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, whitelistRMEnabled=whitelistRMEnabled, userEnabled=userEnabled, transmitPower=transmitPower, tDMConfigurationMismatch=tDMConfigurationMismatch, ptp=ptp, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, syncETrackingState=syncETrackingState, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, searchState=searchState, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, sNMPTrapTableNumber=sNMPTrapTableNumber, userPassword=userPassword, receivePowerLinked=receivePowerLinked, cableLoss=cableLoss, cableDiagnosticsWarning=cableDiagnosticsWarning, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, wirelessOutOctets=wirelessOutOctets, blacklistRMEnabled=blacklistRMEnabled, cableDiagnosticsGroup=cableDiagnosticsGroup, syslogClientTrap=syslogClientTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, alarms=alarms, sNMPCommunityString=sNMPCommunityString, tFTPServerInternetAddress=tFTPServerInternetAddress, iPv6PrefixLength=iPv6PrefixLength, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, mainPSUPortAutoMdix=mainPSUPortAutoMdix, sNMPTrapVersion=sNMPTrapVersion, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, cableDiagPair1Distance=cableDiagPair1Distance, transmitModulationMode=transmitModulationMode, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tDMChannelStatus=tDMChannelStatus, installStatus=installStatus, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, packetsFromInternalStack=packetsFromInternalStack, auxPortDisabledWarning=auxPortDisabledWarning, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, productName=productName, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, sNTPServerTableEntry=sNTPServerTableEntry, sNMPv3Enable=sNMPv3Enable, iPDSCPPriorityTable=iPDSCPPriorityTable, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, hCMPLinkSymmetry=hCMPLinkSymmetry, apc=apc, ethernetInstancedTableIndex=ethernetInstancedTableIndex, sNTPServerRetries=sNTPServerRetries, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, capacityVariantMismatchLinked=capacityVariantMismatchLinked, sMTPEnabledMessages=sMTPEnabledMessages, cableDiagPair4Distance=cableDiagPair4Distance, sntpGroup=sntpGroup, iPv6Address=iPv6Address, sFPPortStatusTrap=sFPPortStatusTrap, sNTPSync=sNTPSync, dNS=dNS, bridge=bridge, remoteMACAddressLinked=remoteMACAddressLinked, sNTPServerPortNumber=sNTPServerPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, eIRP=eIRP, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, unitOutOfCalibration=unitOutOfCalibration, mainPSUPortQLRx=mainPSUPortQLRx, deviceMSN=deviceMSN, authorizationControlGroup=authorizationControlGroup, cableDiagnostics=cableDiagnostics, linkLossLinked=linkLossLinked, tFTPServerInternetAddressType=tFTPServerInternetAddressType, auxPortStatus=auxPortStatus, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, capacityVariantMismatchTrap=capacityVariantMismatchTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, rangingMode=rangingMode, dfsTable=dfsTable, licenseInstancedTableNumber=licenseInstancedTableNumber, packetsToInternalStack=packetsToInternalStack, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNMPEnabledTraps=sNMPEnabledTraps, tDDSynchronizationMode=tDDSynchronizationMode, dataBridgingAvailability=dataBridgingAvailability, dfsPeaks=dfsPeaks, syncEEquipmentClock=syncEEquipmentClock, portAllocationMismatchLinked=portAllocationMismatchLinked, sNMPTrapTable=sNMPTrapTable, sNTPServerInternetAddress=sNTPServerInternetAddress, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, userRole=userRole, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, dNSServerInternetAddress=dNSServerInternetAddress, lbtDetectedTrap=lbtDetectedTrap, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, cableDiagPair3Results=cableDiagPair3Results, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, mainPSUPortAllocation=mainPSUPortAllocation, ptp670=ptp670, transmitModulationModeLinked=transmitModulationModeLinked, cableDiagPair1Results=cableDiagPair1Results, receiveModulationMode=receiveModulationMode, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, unitIdentification=unitIdentification, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, licenseRegulatoryBandsList=licenseRegulatoryBandsList, versionsGroup=versionsGroup, mgmtInstancedTableEntry=mgmtInstancedTableEntry, sFPPortQLRx=sFPPortQLRx, iPVersion=iPVersion, configurationInstancedTableNumber=configurationInstancedTableNumber, configurationGroup=configurationGroup, remoteUnitName=remoteUnitName, lowestTDMModulationMode=lowestTDMModulationMode, mABNominalModulationMode=mABNominalModulationMode, tDMChannelLoopback=tDMChannelLoopback, receiveDataRate=receiveDataRate, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, mgmtInstancedTableNumber=mgmtInstancedTableNumber, vectorError=vectorError, daylightSaving=daylightSaving, dNSServerTableIndex=dNSServerTableIndex, dNSServerPortNumber=dNSServerPortNumber, phyStatus=phyStatus, sNTPPollInterval=sNTPPollInterval, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, encryption=encryption, phyControlInstancedTable=phyControlInstancedTable, receiveFreqKHz=receiveFreqKHz, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, remoteInternetAddressLinked=remoteInternetAddressLinked, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, aAAControl=aAAControl, auxPortAllocation=auxPortAllocation, antennaSelection=antennaSelection, dNSServerTableNumber=dNSServerTableNumber, sFPPortDisabledWarning=sFPPortDisabledWarning, subnetMask=subnetMask, pubInstancedStatsTable=pubInstancedStatsTable, cableDiagPair3Distance=cableDiagPair3Distance, remoteUnitNameLinked=remoteUnitNameLinked, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, wirelessLinkStatus=wirelessLinkStatus, ethernetInstancedTableNumber=ethernetInstancedTableNumber, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, licenseSFPPortSupport=licenseSFPPortSupport, transmitDataRate=transmitDataRate, longitude=longitude, installStatusLinked=installStatusLinked, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, oOBPriorityQueueMapping=oOBPriorityQueueMapping, transmitPowerLinked=transmitPowerLinked, sFPPortQLTx=sFPPortQLTx, receiveModulationModeLinked=receiveModulationModeLinked, syslogState=syslogState, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sFPError=sFPError, sNMPTrapInternetAddress=sNMPTrapInternetAddress, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, txMABFrames=txMABFrames, tFTPServerPortNumber=tFTPServerPortNumber, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, mainPSUPortStatus=mainPSUPortStatus, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, sNTPServerTableNumber=sNTPServerTableNumber, unavailableSeconds=unavailableSeconds, phyControlInstancedTableIndex=phyControlInstancedTableIndex, transmitChannel=transmitChannel, secureModeAlarmTrap=secureModeAlarmTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, licenseTDDSyncSupport=licenseTDDSyncSupport, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, dNSServerTableEntry=dNSServerTableEntry, hCMPMaximumLinkRange=hCMPMaximumLinkRange, receiveChannel=receiveChannel, tdmTableNumber=tdmTableNumber, telnetAccessEnabled=telnetAccessEnabled, pubStats=pubStats, ptpCompliance=ptpCompliance, ethernetPriorityTableNumber=ethernetPriorityTableNumber, licenseIssueNumber=licenseIssueNumber, severelyErroredSeconds=severelyErroredSeconds, sFPPortAutoNegotiation=sFPPortAutoNegotiation, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, auxPortQLTx=auxPortQLTx, licenseInstancedTable=licenseInstancedTable, mABProtocolVLANPriority=mABProtocolVLANPriority, ethernetStatisticsTable=ethernetStatisticsTable, dfsTableIndex=dfsTableIndex, mainPSUPortQLTx=mainPSUPortQLTx, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, latitude=latitude, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, portAllocationMismatchTrap=portAllocationMismatchTrap, licenseSyncESupport=licenseSyncESupport, routerProtocolsGroup=routerProtocolsGroup, dNSPrimaryServer=dNSPrimaryServer, localPacketFiltering=localPacketFiltering, ptpTrapPrefix=ptpTrapPrefix, remoteMaximumTransmitPower=remoteMaximumTransmitPower, secureModeAlarm=secureModeAlarm, installationMode=installationMode, rawReceivePower=rawReceivePower, wirelessOutAllOctets=wirelessOutAllOctets, ethernetInstancedTableEntry=ethernetInstancedTableEntry, phyControlGroup=phyControlGroup, tDMChannelCableLength=tDMChannelCableLength)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", linkModeOptimizationMismatch=linkModeOptimizationMismatch, regulatoryBand=regulatoryBand, cableDiagnosticsPorts=cableDiagnosticsPorts, syslogControl=syslogControl, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, sMTPServerInternetAddressType=sMTPServerInternetAddressType, managementPortWirelessDownAlert=managementPortWirelessDownAlert, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, hTTPPortNumber=hTTPPortNumber, managementGroup=managementGroup, sNTPServerTable=sNTPServerTable, signalStrengthRatio=signalStrengthRatio, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, tDMChannelStatusTrap=tDMChannelStatusTrap, dataPortPauseFrames=dataPortPauseFrames, ethernetPriorityTableEntry=ethernetPriorityTableEntry, transmitterChannels=transmitterChannels, vectorErrorLinked=vectorErrorLinked, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, phyStatusGroup=phyStatusGroup, smtpGroup=smtpGroup, licenseIEEE1588Support=licenseIEEE1588Support, l2CPPriorityTableNumber=l2CPPriorityTableNumber, remoteInternetAddress=remoteInternetAddress, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, linkSymmetry=linkSymmetry, cableDiagnosticsControl=cableDiagnosticsControl, mgmtInstancedTableIndex=mgmtInstancedTableIndex, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, altitude=altitude, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, telnetPortNumber=telnetPortNumber, alarmInstancedTableIndex=alarmInstancedTableIndex, alarmsGroup=alarmsGroup, byteErrorRatio=byteErrorRatio, smtp=smtp, transmitDataRateLinked=transmitDataRateLinked, mABProtocolVID=mABProtocolVID, aAAControlGroup=aAAControlGroup, encryptionAlgorithm=encryptionAlgorithm, licenseMaxLinkRange=licenseMaxLinkRange, ptpTraps=ptpTraps, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, syncESlavePort=syncESlavePort, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, dfsMeans=dfsMeans, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, deviceMACAddress=deviceMACAddress, range=range, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, maximumTransmitPower=maximumTransmitPower, dataBridgingStatusLinked=dataBridgingStatusLinked, hTTPSPortNumber=hTTPSPortNumber, dNSServerInternetAddressType=dNSServerInternetAddressType, dNSServerTable=dNSServerTable, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, dNSResolver=dNSResolver, sNTPState=sNTPState, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, auxPortAcceptedQLRx=auxPortAcceptedQLRx, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, sNTPPrimaryServer=sNTPPrimaryServer)
