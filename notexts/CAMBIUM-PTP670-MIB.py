...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sFPPortSyncERxStatus=sFPPortSyncERxStatus, cableDiagnosticsGroup=cableDiagnosticsGroup, license=license, sNMPTrapTableEntry=sNMPTrapTableEntry, linkLoss=linkLoss, ptpCompliance=ptpCompliance, tDMInterfaceControl=tDMInterfaceControl, sFPPortDisabledWarning=sFPPortDisabledWarning, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, dNSServerInternetAddress=dNSServerInternetAddress, auxPortQLTx=auxPortQLTx, ptpTrapPrefix=ptpTrapPrefix, receivePower=receivePower, sFPPortAutoMdix=sFPPortAutoMdix, remoteMACAddressLinked=remoteMACAddressLinked, mainPSUPortAutoMdix=mainPSUPortAutoMdix, licenseSFPPortSupport=licenseSFPPortSupport, sNMPEnabledTraps=sNMPEnabledTraps, supplementary=supplementary, deviceMSN=deviceMSN, tdmTable=tdmTable, tdmTableNumber=tdmTableNumber, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, cableDiagPair4Distance=cableDiagPair4Distance, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, transparentClock=transparentClock, mgmtInstancedTableIndex=mgmtInstancedTableIndex, severelyErroredSeconds=severelyErroredSeconds, installStatus=installStatus, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, extendedSpectrumScanning=extendedSpectrumScanning, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, licenseMaxLinkRange=licenseMaxLinkRange, aAAControlGroup=aAAControlGroup, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, tDM=tDM, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, enabledDiagnosticAlarms=enabledDiagnosticAlarms, management=management, signalStrengthRatioLinked=signalStrengthRatioLinked, licenseBandwidthCap=licenseBandwidthCap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, dNSPrimaryServer=dNSPrimaryServer, licenseCapacity=licenseCapacity, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sFPPortQLTx=sFPPortQLTx, dataPortPauseFrames=dataPortPauseFrames, phyControlInstancedTable=phyControlInstancedTable, transmitFreqKHz=transmitFreqKHz, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, systemClock=systemClock, longitude=longitude, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, userEnabled=userEnabled, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, sNMPTrapPortNumber=sNMPTrapPortNumber, userRole=userRole, licenseInstancedTableNumber=licenseInstancedTableNumber, sFPErrorTrap=sFPErrorTrap, alarmInstancedTable=alarmInstancedTable, userTableNumber=userTableNumber, alarmInstancedTableNumber=alarmInstancedTableNumber, dNSServerTableEntry=dNSServerTableEntry, mABTransmissionInterval=mABTransmissionInterval, tDMChannelLineCode=tDMChannelLineCode, routerProtocols=routerProtocols, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sFPPortSSMTx=sFPPortSSMTx, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, authorizationControlTableIndex=authorizationControlTableIndex, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, alarmInstancedTableEntry=alarmInstancedTableEntry, authorizationControlTable=authorizationControlTable, mPLSTCPriorityTable=mPLSTCPriorityTable, wirelessTopology=wirelessTopology, latitude=latitude, packetsToInternalStack=packetsToInternalStack, auxPortStatusTrap=auxPortStatusTrap, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, installStatusLinked=installStatusLinked, secondarySoftwareVersion=secondarySoftwareVersion, ptp=ptp, licenseInstancedTableEntry=licenseInstancedTableEntry, searchState=searchState, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, sNMPTrapTable=sNMPTrapTable, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, sFPPortQLRx=sFPPortQLRx, remoteUnitNameLinked=remoteUnitNameLinked, dataPortWirelessDownAlert=dataPortWirelessDownAlert, smtpGroup=smtpGroup, antennaSelection=antennaSelection, ethernetPriorityTableNumber=ethernetPriorityTableNumber, linkSymmetry=linkSymmetry, transmitDataRate=transmitDataRate, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, dNSServerTableIndex=dNSServerTableIndex, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, incompatibleRegulatoryBands=incompatibleRegulatoryBands, dSCPManagementPriority=dSCPManagementPriority, ethernetInstancedTableEntry=ethernetInstancedTableEntry, whitelistRMMacAddress=whitelistRMMacAddress, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, hTTPSAccessEnabled=hTTPSAccessEnabled, tDDSynchronizationMode=tDDSynchronizationMode, dfsTableNumber=dfsTableNumber, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, installStatusTrap=installStatusTrap, sntpGroup=sntpGroup, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, masterSlaveMode=masterSlaveMode, alarmsGroup=alarmsGroup, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, receiveModulationMode=receiveModulationMode, tFTPServerPortNumber=tFTPServerPortNumber, tFTPClient=tFTPClient, auxPortStatus=auxPortStatus, siteName=siteName, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, capacityVariantMismatchLinked=capacityVariantMismatchLinked, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, deviceMACAddress=deviceMACAddress, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, cableDiagPair2Results=cableDiagPair2Results, sNMPPortNumber=sNMPPortNumber, range=range, sMTPSourceEmailAddress=sMTPSourceEmailAddress, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, cableDiagPair3Results=cableDiagPair3Results, mgmtInstancedTableEntry=mgmtInstancedTableEntry, authorizationControlTableEntry=authorizationControlTableEntry, eIRP=eIRP, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sMTPServerInternetAddress=sMTPServerInternetAddress, packetsFromInternalStack=packetsFromInternalStack, sNTPServerPortNumber=sNTPServerPortNumber, encryptionAlgorithm=encryptionAlgorithm, ptpTraps=ptpTraps, secureModeAlarm=secureModeAlarm, reset=reset, syncEEquipmentClock=syncEEquipmentClock, mgmtInstancedTable=mgmtInstancedTable, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, sMTPEnabledMessages=sMTPEnabledMessages, vectorError=vectorError, dNS=dNS, tDMChannelLoopback=tDMChannelLoopback, wirelessLinkStatus=wirelessLinkStatus, licenseTrialPeriod=licenseTrialPeriod, mABNominalTransmitCapacity=mABNominalTransmitCapacity, transparentClockVLAN=transparentClockVLAN, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, ptp670=ptp670, supplementaryGroup=supplementaryGroup, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, remoteInternetAddress=remoteInternetAddress, installArmState=installArmState, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, sNMPTrapTableNumber=sNMPTrapTableNumber, lowestTDMModulationMode=lowestTDMModulationMode, mainPSUPortQLTx=mainPSUPortQLTx, vectorErrorLinked=vectorErrorLinked, transparentClockPort=transparentClockPort, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, unitOutOfCalibration=unitOutOfCalibration, phyControlInstancedTableNumber=phyControlInstancedTableNumber, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, aggregateDataRateLinked=aggregateDataRateLinked, dNSServerTable=dNSServerTable, licenseTDDSyncSupport=licenseTDDSyncSupport, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, rawReceivePowerLinked=rawReceivePowerLinked, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, daylightSaving=daylightSaving, cableLoss=cableLoss, byteErrorRatio=byteErrorRatio, configurationInstancedTableEntry=configurationInstancedTableEntry, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, nIDULanPortStatus=nIDULanPortStatus, licenseInstancedTableIndex=licenseInstancedTableIndex, productName=productName, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, licenseSyncESupport=licenseSyncESupport, transmitPower=transmitPower, aAAControl=aAAControl, resetGroup=resetGroup, receiveChannel=receiveChannel, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, licenseHCMPSupport=licenseHCMPSupport, sNMPTrapVersion=sNMPTrapVersion, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, configuration=configuration, mABNominalModulationMode=mABNominalModulationMode, ethernetPriorityTableIndex=ethernetPriorityTableIndex, iPVersion=iPVersion, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, versions=versions, versionsGroup=versionsGroup, receiveFreqKHz=receiveFreqKHz, wirelessOutEthernetOctets=wirelessOutEthernetOctets, sFPPortAllocation=sFPPortAllocation, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, unitName=unitName, syncETrackingState=syncETrackingState, enableTransmission=enableTransmission, sNTPServerTable=sNTPServerTable, licenseGroupAccess=licenseGroupAccess, licenseOOBManagementSupport=licenseOOBManagementSupport, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, ptmp=ptmp, userTableIndex=userTableIndex, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, sFPPortStatusTrap=sFPPortStatusTrap, cableDiagPair4Results=cableDiagPair4Results, dfsTable=dfsTable, wirelessLinkStatusLinked=wirelessLinkStatusLinked, syslogClientTrap=syslogClientTrap, transmitModulationMode=transmitModulationMode, sNTPServerTableIndex=sNTPServerTableIndex, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, snmpControl=snmpControl, iPDSCPPriorityTable=iPDSCPPriorityTable, cableDiagnosticsWarning=cableDiagnosticsWarning, ethernetStatisticsTable=ethernetStatisticsTable, capacityVariantMismatchTrap=capacityVariantMismatchTrap, frequencyVariant=frequencyVariant, syncESlavePort=syncESlavePort, transmitChannel=transmitChannel, sNTPServerInternetAddress=sNTPServerInternetAddress, sNTPSyncTrap=sNTPSyncTrap, sFPError=sFPError, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, syslogControl=syslogControl, altitude=altitude, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, cableDiagnostics=cableDiagnostics, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, txColorCode=txColorCode, remoteInternetAddressType=remoteInternetAddressType, iPv4Address=iPv4Address, txMABFrames=txMABFrames)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", regulatoryBandTrap=regulatoryBandTrap, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, configurationInstancedTable=configurationInstancedTable, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, sNTPServerRetries=sNTPServerRetries, snmpControlGroup=snmpControlGroup, oOBPriorityQueueMapping=oOBPriorityQueueMapping, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, wirelessLinkAvailability=wirelessLinkAvailability, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ethernetPriorityTable=ethernetPriorityTable, licenseIEEE1588Support=licenseIEEE1588Support, licenseSecurityLevel=licenseSecurityLevel, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, receiveModulationModeLinked=receiveModulationModeLinked, authorizationControlTableNumber=authorizationControlTableNumber, qOSPriorityScheme=qOSPriorityScheme, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, receivePowerLinked=receivePowerLinked, localPacketFiltering=localPacketFiltering, sNTPServerTimeout=sNTPServerTimeout, tFTPServerInternetAddressType=tFTPServerInternetAddressType, ethernetGroup=ethernetGroup, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, receiveDataRateLinked=receiveDataRateLinked, lbtDetectedTrap=lbtDetectedTrap, unavailableSeconds=unavailableSeconds, mgmtInstancedTableNumber=mgmtInstancedTableNumber, searchStateLinked=searchStateLinked, auxPortConfigurationMismatch=auxPortConfigurationMismatch, signalStrengthRatio=signalStrengthRatio, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, tempPcb=tempPcb, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, authorizationControlGroup=authorizationControlGroup, sMTPEmailAlert=sMTPEmailAlert, receiveModulationModeDetail=receiveModulationModeDetail, dfsTableEntry=dfsTableEntry, transmitFreqMHz=transmitFreqMHz, apc=apc, remoteUnitName=remoteUnitName, cableDiagPair2Distance=cableDiagPair2Distance, userPassword=userPassword, tDDControl=tDDControl, softwareVersion=softwareVersion, cambium=cambium, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, phyControlGroup=phyControlGroup, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, antennaGain=antennaGain, phyInstancedStatusTable=phyInstancedStatusTable, mABState=mABState, gatewayIPAddress=gatewayIPAddress, dfsMeans=dfsMeans, portAllocationMismatchTrap=portAllocationMismatchTrap, hCMPLinkSymmetry=hCMPLinkSymmetry, rxColorCode=rxColorCode, auxPortSSMTx=auxPortSSMTx, sNTPPollInterval=sNTPPollInterval, cableDiagPair3Distance=cableDiagPair3Distance, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, sNTPServerTableEntry=sNTPServerTableEntry, dfsPeaks=dfsPeaks, bridgeGroup=bridgeGroup, auxPortAllocation=auxPortAllocation, auxPortSyncERxStatus=auxPortSyncERxStatus, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, hCMPMaximumLinkRange=hCMPMaximumLinkRange, useVLANForMABProtocol=useVLANForMABProtocol, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, byteErrorRatioLinked=byteErrorRatioLinked, nIDULanPortAutoMdix=nIDULanPortAutoMdix, wirelessOutOctets=wirelessOutOctets, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, subbandLowestFrequency=subbandLowestFrequency, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, tFTPServerInternetAddress=tFTPServerInternetAddress, routerProtocolsGroup=routerProtocolsGroup, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, bridge=bridge, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, lowestDataModulationMode=lowestDataModulationMode, userTable=userTable, licenseIPv6Support=licenseIPv6Support, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, regulatoryBand=regulatoryBand, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, managementNetworkAccessEnabled=managementNetworkAccessEnabled, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, cableDiagPair1Distance=cableDiagPair1Distance, ethernetInstancedTable=ethernetInstancedTable, tDMInterfaceStatus=tDMInterfaceStatus, tDDControlGroup=tDDControlGroup, mainPSUPortQLRx=mainPSUPortQLRx, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, transmitPowerLinked=transmitPowerLinked, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, sNTPServerStatus=sNTPServerStatus, syslogClient=syslogClient, linkName=linkName, licenseUnitSerialNumber=licenseUnitSerialNumber, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, receiveDataRate=receiveDataRate, tDMChannelCableLength=tDMChannelCableLength, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, licenseRegulatoryBandsList=licenseRegulatoryBandsList, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, noWirelessChannelAvailable=noWirelessChannelAvailable, maxLinkRangeExceeded=maxLinkRangeExceeded, syncETracking=syncETracking, sNTPState=sNTPState, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, ethernet=ethernet, dNSGroup=dNSGroup, pubStatsGroup=pubStatsGroup, ethernetStatisticsDataSource=ethernetStatisticsDataSource, sNMPCommunityString=sNMPCommunityString, blacklistRMMacAddress=blacklistRMMacAddress, deviceESN=deviceESN, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sntp=sntp, licenseCountry=licenseCountry, syslogState=syslogState, dfsTableIndex=dfsTableIndex, tdmTableEntry=tdmTableEntry, hTTPPortNumber=hTTPPortNumber, licenseEncryption=licenseEncryption, mABHoldoffPeriod=mABHoldoffPeriod, encryptionGroup=encryptionGroup, maximumTransmitPower=maximumTransmitPower, smtp=smtp, hardwareVersion=hardwareVersion, ethernetInstancedTableIndex=ethernetInstancedTableIndex, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, targetMACAddress=targetMACAddress, rangeLinked=rangeLinked, incompatibleMasterAndSlave=incompatibleMasterAndSlave, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, sMTPServerPortNumber=sMTPServerPortNumber, dfsGroup=dfsGroup, systemReset=systemReset, notificationsGroup=notificationsGroup, syslogStateTrap=syslogStateTrap, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, installArmStateTrap=installArmStateTrap, groupID=groupID, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, phyControlInstancedTableIndex=phyControlInstancedTableIndex, telnetPortNumber=telnetPortNumber, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, PYSNMP_MODULE_ID=cambium, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, transmitModulationModeLinked=transmitModulationModeLinked, licenseInstancedTable=licenseInstancedTable, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, transmitDataRateLinked=transmitDataRateLinked, dNSServerInternetAddressType=dNSServerInternetAddressType, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, subnetMask=subnetMask, cableDiagPair1Results=cableDiagPair1Results, unitIdentification=unitIdentification, tDDSynchronizationStatus=tDDSynchronizationStatus, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, mainPSUPortAllocation=mainPSUPortAllocation, iPv6PrefixLength=iPv6PrefixLength, sFPPortStatus=sFPPortStatus, channelBandwidth=channelBandwidth, blacklistRMEnabled=blacklistRMEnabled, cableDiagnosticsPorts=cableDiagnosticsPorts, l2CPPriorityTableEntry=l2CPPriorityTableEntry, targetRange=targetRange, tDMChannelStatus=tDMChannelStatus, dNSServerPortNumber=dNSServerPortNumber, encryption=encryption, sNMPv3Enable=sNMPv3Enable, accessMethod=accessMethod, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, remoteMACAddress=remoteMACAddress, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, transparentClockVID=transparentClockVID, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfs=dfs, productVariant=productVariant, alarmInstancedTableIndex=alarmInstancedTableIndex, vLANManagementVID=vLANManagementVID, remoteMaximumTransmitPower=remoteMaximumTransmitPower, managementPortWirelessDownAlert=managementPortWirelessDownAlert, remoteInternetAddressLinked=remoteInternetAddressLinked, auxPortQLRx=auxPortQLRx, installationMode=installationMode, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, phyStatusGroup=phyStatusGroup, configurationGroup=configurationGroup, tDMEnabledChannels=tDMEnabledChannels, bootVersion=bootVersion, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, licenseTLSRekey=licenseTLSRekey, mABMaintenanceLevel=mABMaintenanceLevel, dNSResolver=dNSResolver, userTableEntry=userTableEntry, dataBridgingAvailability=dataBridgingAvailability, l2CPPriorityTableNumber=l2CPPriorityTableNumber, l2CPPriorityTableIndex=l2CPPriorityTableIndex, iPv6GatewayAddress=iPv6GatewayAddress, mABProtocolVID=mABProtocolVID, licenseRARSupport=licenseRARSupport, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, configurationInstancedTableNumber=configurationInstancedTableNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, capacityVariantMismatch=capacityVariantMismatch, cableDiagnosticsResultTable=cableDiagnosticsResultTable, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, mainPSUPortStatusTrap=mainPSUPortStatusTrap, dataBridgingStatusAlarm=dataBridgingStatusAlarm, sNTPLastSync=sNTPLastSync, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, secureModeAlarmTrap=secureModeAlarmTrap, subbandHighestFrequency=subbandHighestFrequency, mABProtocolVLANPriority=mABProtocolVLANPriority, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, sNTPPrimaryServer=sNTPPrimaryServer, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, alarms=alarms, erroredSeconds=erroredSeconds, sNTPSync=sNTPSync, phyControlInstancedTableEntry=phyControlInstancedTableEntry, tDMConfigurationMismatch=tDMConfigurationMismatch, telnetAccessEnabled=telnetAccessEnabled, sNTPServerTableNumber=sNTPServerTableNumber, licenseGasGroup=licenseGasGroup, tDMChannelStatusTrap=tDMChannelStatusTrap, linkModeOptimization=linkModeOptimization, syslogLocalWrappedTrap=syslogLocalWrappedTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", l2CPPriorityTable=l2CPPriorityTable, mainPSUPortStatus=mainPSUPortStatus, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, authorizationControl=authorizationControl, pubInstancedStatsTable=pubInstancedStatsTable, portAllocationMismatchLinked=portAllocationMismatchLinked, maximumNumberOfSlaves=maximumNumberOfSlaves, receiveFreqMHz=receiveFreqMHz, aggregateDataRate=aggregateDataRate, apcGroup=apcGroup, userName=userName, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, rawReceivePower=rawReceivePower, phyStatus=phyStatus, pubStats=pubStats, auxPortDisabledWarning=auxPortDisabledWarning, sNTPServerInternetAddressType=sNTPServerInternetAddressType, cableDiagnosticsControl=cableDiagnosticsControl, ptpGroups=ptpGroups, unitIdentificationGroup=unitIdentificationGroup, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, configurationInstancedTableIndex=configurationInstancedTableIndex, managementGroup=managementGroup, rangingMode=rangingMode, wirelessOutAllOctets=wirelessOutAllOctets, phyControl=phyControl, iPv6Address=iPv6Address, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, transmitterChannels=transmitterChannels, timeZone=timeZone, licenseGroup=licenseGroup, ethernetInstancedTableNumber=ethernetInstancedTableNumber, hTTPAccessEnabled=hTTPAccessEnabled, syslogControlGroup=syslogControlGroup, licenseVersion=licenseVersion, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, linkLossLinked=linkLossLinked, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, licenseIssueNumber=licenseIssueNumber, hTTPSPortNumber=hTTPSPortNumber, tDMGroup=tDMGroup, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, mainPSUPortSSMTx=mainPSUPortSSMTx, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, dNSServerTableNumber=dNSServerTableNumber, vLANManagementPriority=vLANManagementPriority, channelChangeTrap=channelChangeTrap, whitelistRMEnabled=whitelistRMEnabled, authorizationMethod=authorizationMethod, dataBridgingStatus=dataBridgingStatus, tdmTableIndex=tdmTableIndex, dataBridgingStatusLinked=dataBridgingStatusLinked, portAllocationMismatch=portAllocationMismatch, sFPPortAutoNegotiation=sFPPortAutoNegotiation, nIDULanPortStatusTrap=nIDULanPortStatusTrap, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, auxPortAcceptedQLRx=auxPortAcceptedQLRx, ethernetPriorityTableEntry=ethernetPriorityTableEntry, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry)
