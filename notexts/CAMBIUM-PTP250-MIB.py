...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", pubStatsGroup=pubStatsGroup, ptp=ptp, nTPSync=nTPSync, fixedModMode=fixedModMode, noiseFloor=noiseFloor, configuration=configuration, noWirelessChannelAvailable=noWirelessChannelAvailable, ptmp=ptmp, ptpCompliance=ptpCompliance, productName=productName, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, searchState=searchState, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, ethernetGroup=ethernetGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, cableLoss=cableLoss, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, channelSelection=channelSelection, timeZone=timeZone, vectorError=vectorError, linkLoss=linkLoss, sNMPCommunityString=sNMPCommunityString, signalStrengthRatio=signalStrengthRatio, subnetMask=subnetMask, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, nTPState=nTPState, configuredModulationMode=configuredModulationMode, linkName=linkName, productVariant=productVariant, measuredRange=measuredRange, licence=licence, nTPLastSync=nTPLastSync, ptpGroups=ptpGroups, extendedFreqMHz=extendedFreqMHz, nTPServerIp=nTPServerIp, vlanId=vlanId, nTPServerPortNumber=nTPServerPortNumber, hardwareVersion=hardwareVersion, receiveModulationMode=receiveModulationMode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, pubStats=pubStats, ethernet=ethernet, dataPortStatus=dataPortStatus, snmpControlGroup=snmpControlGroup, transmitPower=transmitPower, managementGroup=managementGroup, masterSlaveMode=masterSlaveMode, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPServerPortNumber=tFTPServerPortNumber, tFTPServerIPAddress=tFTPServerIPAddress, receivePower=receivePower, smtp=smtp, regionCode=regionCode, versionsGroup=versionsGroup, nTPPollInterval=nTPPollInterval, channelBandwidth=channelBandwidth, ntpGroup=ntpGroup, phyStatus=phyStatus, sNMPTrapVersion=sNMPTrapVersion, receiveDataRate=receiveDataRate, remoteIPAddress=remoteIPAddress, licenceGroup=licenceGroup, alarms=alarms, ptp250=ptp250, maximumTransmitPower=maximumTransmitPower, cambium=cambium, sNMPTrapTable=sNMPTrapTable, sMTPServerIPAddress=sMTPServerIPAddress, linkStatusTrap=linkStatusTrap, snmpControl=snmpControl, extendedChannel=extendedChannel, versions=versions, sNMPEnabledTraps=sNMPEnabledTraps, smtpGroup=smtpGroup, radarDetectTrap=radarDetectTrap, dualPayload=dualPayload, sNMPCommunityOid=sNMPCommunityOid, softwareVersion=softwareVersion, remoteMACAddress=remoteMACAddress, wirelessLinkStatus=wirelessLinkStatus, sNMPCommunityTableIndex=sNMPCommunityTableIndex, bootVersion=bootVersion, dataPortStatusTrap=dataPortStatusTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, aggregateDataRate=aggregateDataRate, PYSNMP_MODULE_ID=cambium, alarmsGroup=alarmsGroup, systemClock=systemClock, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, ptpTraps=ptpTraps, phyStatusGroup=phyStatusGroup, currentFreqMHz=currentFreqMHz, ntp=ntp, iPAddress=iPAddress, sNMPCommunityAccess=sNMPCommunityAccess, sMTPEnabledMessages=sMTPEnabledMessages, sNMPCommunityTable=sNMPCommunityTable, configurationGroup=configurationGroup, siteName=siteName, vlanTagging=vlanTagging, ptpTrapPrefix=ptpTrapPrefix, sMTPSourceEmailAddress=sMTPSourceEmailAddress, antennaGain=antennaGain, gatewayIPAddress=gatewayIPAddress, radarDetectChannel=radarDetectChannel, currentChannel=currentChannel, installArmStateTrap=installArmStateTrap, sNMPTrapCommunity=sNMPTrapCommunity, sNMPCommunityTableEntry=sNMPCommunityTableEntry, vlanPriority=vlanPriority, notificationsGroup=notificationsGroup, installArmState=installArmState, band=band, configuredRange=configuredRange, transmitModulationMode=transmitModulationMode, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitDataRate=transmitDataRate, sMTPServerPortNumber=sMTPServerPortNumber, management=management)
