...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", linkStatusTrap=linkStatusTrap, remoteMACAddress=remoteMACAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, vlanId=vlanId, ptmp=ptmp, sNMPTrapTableEntry=sNMPTrapTableEntry, installArmStateTrap=installArmStateTrap, ethernet=ethernet, sMTPEnabledMessages=sMTPEnabledMessages, ptpTrapPrefix=ptpTrapPrefix, managementGroup=managementGroup, sNMPTrapCommunity=sNMPTrapCommunity, sNMPTrapTable=sNMPTrapTable, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, measuredRange=measuredRange, antennaGain=antennaGain, productName=productName, aggregateDataRate=aggregateDataRate, ptpTraps=ptpTraps, radarDetectChannel=radarDetectChannel, nTPPollInterval=nTPPollInterval, transmitDataRate=transmitDataRate, smtpGroup=smtpGroup, extendedFreqMHz=extendedFreqMHz, nTPServerIp=nTPServerIp, productVariant=productVariant, iPAddress=iPAddress, licence=licence, sNMPCommunityTable=sNMPCommunityTable, snmpControlGroup=snmpControlGroup, linkLoss=linkLoss, linkName=linkName, sNMPCommunityTableNumber=sNMPCommunityTableNumber, configuration=configuration, receiveModulationMode=receiveModulationMode, installArmState=installArmState, systemClock=systemClock, regionCode=regionCode, sMTPServerIPAddress=sMTPServerIPAddress, dataPortStatusTrap=dataPortStatusTrap, nTPSync=nTPSync, vlanTagging=vlanTagging, notificationsGroup=notificationsGroup, licenceGroup=licenceGroup, searchState=searchState, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortAutoNegotiation=dataPortAutoNegotiation, channelBandwidth=channelBandwidth, ptp250=ptp250, sNMPCommunityString=sNMPCommunityString, phyStatusGroup=phyStatusGroup, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapPortNumber=sNMPTrapPortNumber, ptpCompliance=ptpCompliance, currentFreqMHz=currentFreqMHz, band=band, currentChannel=currentChannel, sNMPTrapTableIndex=sNMPTrapTableIndex, configuredModulationMode=configuredModulationMode, softwareVersion=softwareVersion, smtp=smtp, sNMPCommunityTableEntry=sNMPCommunityTableEntry, alarmsGroup=alarmsGroup, pubStats=pubStats, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ntpGroup=ntpGroup, fixedModMode=fixedModMode, tFTPServerPortNumber=tFTPServerPortNumber, cambium=cambium, versionsGroup=versionsGroup, tFTPServerIPAddress=tFTPServerIPAddress, nTPLastSync=nTPLastSync, vlanPriority=vlanPriority, nTPState=nTPState, versions=versions, ptpGroups=ptpGroups, transmitModulationMode=transmitModulationMode, sMTPServerPortNumber=sMTPServerPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, ntp=ntp, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, maximumTransmitPower=maximumTransmitPower, receivePower=receivePower, sNMPTrapVersion=sNMPTrapVersion, receiveDataRate=receiveDataRate, wirelessLinkStatus=wirelessLinkStatus, ptp=ptp, alarms=alarms, radarDetectTrap=radarDetectTrap, cableLoss=cableLoss, siteName=siteName, snmpControl=snmpControl, pubStatsGroup=pubStatsGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, channelSelection=channelSelection, vectorError=vectorError, dataPortStatus=dataPortStatus, transmitPower=transmitPower, ethernetGroup=ethernetGroup, gatewayIPAddress=gatewayIPAddress, masterSlaveMode=masterSlaveMode, hardwareVersion=hardwareVersion, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, remoteIPAddress=remoteIPAddress, signalStrengthRatio=signalStrengthRatio, sNMPCommunityTableIndex=sNMPCommunityTableIndex, noiseFloor=noiseFloor, phyStatus=phyStatus, sNMPCommunityAccess=sNMPCommunityAccess, extendedChannel=extendedChannel, PYSNMP_MODULE_ID=cambium, sNMPTrapTableNumber=sNMPTrapTableNumber, subnetMask=subnetMask, nTPServerPortNumber=nTPServerPortNumber, timeZone=timeZone, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, configuredRange=configuredRange, bootVersion=bootVersion, sNMPCommunityOid=sNMPCommunityOid, configurationGroup=configurationGroup, management=management, dualPayload=dualPayload)
