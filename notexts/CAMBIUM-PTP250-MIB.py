...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", tFTPServerPortNumber=tFTPServerPortNumber, nTPState=nTPState, aggregateDataRate=aggregateDataRate, sMTPSourceEmailAddress=sMTPSourceEmailAddress, gatewayIPAddress=gatewayIPAddress, nTPServerIp=nTPServerIp, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPCommunityAccess=sNMPCommunityAccess, dataPortAutoNegotiation=dataPortAutoNegotiation, phyStatus=phyStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, nTPSync=nTPSync, ethernetGroup=ethernetGroup, sNMPCommunityTable=sNMPCommunityTable, transmitDataRate=transmitDataRate, receiveModulationMode=receiveModulationMode, sNMPTrapCommunity=sNMPTrapCommunity, alarms=alarms, management=management, productVariant=productVariant, smtpGroup=smtpGroup, ptpGroups=ptpGroups, snmpControlGroup=snmpControlGroup, currentFreqMHz=currentFreqMHz, vlanTagging=vlanTagging, dataPortStatusTrap=dataPortStatusTrap, sMTPEnabledMessages=sMTPEnabledMessages, installArmStateTrap=installArmStateTrap, sNMPEnabledTraps=sNMPEnabledTraps, alarmsGroup=alarmsGroup, ptpCompliance=ptpCompliance, timeZone=timeZone, nTPServerPortNumber=nTPServerPortNumber, channelSelection=channelSelection, remoteIPAddress=remoteIPAddress, signalStrengthRatio=signalStrengthRatio, ptp250=ptp250, sMTPServerIPAddress=sMTPServerIPAddress, productName=productName, wirelessLinkStatus=wirelessLinkStatus, PYSNMP_MODULE_ID=cambium, vlanId=vlanId, pubStatsGroup=pubStatsGroup, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sNMPCommunityString=sNMPCommunityString, ntp=ntp, linkStatusTrap=linkStatusTrap, configuration=configuration, ethernet=ethernet, antennaGain=antennaGain, sNMPTrapVersion=sNMPTrapVersion, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, versionsGroup=versionsGroup, noiseFloor=noiseFloor, phyStatusGroup=phyStatusGroup, receiveDataRate=receiveDataRate, systemClock=systemClock, ptp=ptp, ptpTraps=ptpTraps, tFTPServerIPAddress=tFTPServerIPAddress, extendedFreqMHz=extendedFreqMHz, notificationsGroup=notificationsGroup, ptpTrapPrefix=ptpTrapPrefix, vlanPriority=vlanPriority, band=band, snmpControl=snmpControl, sNMPTrapTable=sNMPTrapTable, sNMPCommunityTableIndex=sNMPCommunityTableIndex, noWirelessChannelAvailable=noWirelessChannelAvailable, transmitModulationMode=transmitModulationMode, radarDetectTrap=radarDetectTrap, hardwareVersion=hardwareVersion, bootVersion=bootVersion, nTPPollInterval=nTPPollInterval, dataPortStatus=dataPortStatus, iPAddress=iPAddress, masterSlaveMode=masterSlaveMode, configuredModulationMode=configuredModulationMode, dualPayload=dualPayload, licence=licence, remoteMACAddress=remoteMACAddress, linkLoss=linkLoss, vectorError=vectorError, sMTPServerPortNumber=sMTPServerPortNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, searchState=searchState, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, configuredRange=configuredRange, siteName=siteName, sNMPTrapTableEntry=sNMPTrapTableEntry, ptmp=ptmp, nTPLastSync=nTPLastSync, ntpGroup=ntpGroup, smtp=smtp, measuredRange=measuredRange, linkName=linkName, sNMPTrapIPAddress=sNMPTrapIPAddress, fixedModMode=fixedModMode, maximumTransmitPower=maximumTransmitPower, sNMPCommunityOid=sNMPCommunityOid, installArmState=installArmState, receivePower=receivePower, cableLoss=cableLoss, sNMPTrapTableIndex=sNMPTrapTableIndex, cambium=cambium, managementGroup=managementGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, licenceGroup=licenceGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, extendedChannel=extendedChannel, pubStats=pubStats, channelBandwidth=channelBandwidth, versions=versions, regionCode=regionCode, sNMPTrapPortNumber=sNMPTrapPortNumber, subnetMask=subnetMask, configurationGroup=configurationGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, radarDetectChannel=radarDetectChannel, sNMPCommunityTableEntry=sNMPCommunityTableEntry, softwareVersion=softwareVersion, currentChannel=currentChannel, transmitPower=transmitPower)
