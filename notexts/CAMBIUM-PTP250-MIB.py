...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", nTPLastSync=nTPLastSync, maximumTransmitPower=maximumTransmitPower, wirelessLinkStatus=wirelessLinkStatus, systemClock=systemClock, snmpControlGroup=snmpControlGroup, radarDetectChannel=radarDetectChannel, sNMPCommunityTableIndex=sNMPCommunityTableIndex, versionsGroup=versionsGroup, sMTPServerPortNumber=sMTPServerPortNumber, managementGroup=managementGroup, aggregateDataRate=aggregateDataRate, notificationsGroup=notificationsGroup, transmitModulationMode=transmitModulationMode, nTPState=nTPState, sMTPEnabledMessages=sMTPEnabledMessages, extendedChannel=extendedChannel, bootVersion=bootVersion, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapVersion=sNMPTrapVersion, masterSlaveMode=masterSlaveMode, subnetMask=subnetMask, timeZone=timeZone, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ptp=ptp, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, alarmsGroup=alarmsGroup, sNMPCommunityTable=sNMPCommunityTable, alarms=alarms, currentFreqMHz=currentFreqMHz, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPEnabledTraps=sNMPEnabledTraps, productVariant=productVariant, sNMPCommunityTableNumber=sNMPCommunityTableNumber, ptmp=ptmp, licence=licence, receiveDataRate=receiveDataRate, radarDetectTrap=radarDetectTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, searchState=searchState, nTPServerPortNumber=nTPServerPortNumber, vectorError=vectorError, ethernetGroup=ethernetGroup, nTPSync=nTPSync, dataPortStatus=dataPortStatus, linkLoss=linkLoss, ntp=ntp, remoteMACAddress=remoteMACAddress, configuration=configuration, ethernet=ethernet, vlanId=vlanId, band=band, tFTPServerIPAddress=tFTPServerIPAddress, sNMPCommunityAccess=sNMPCommunityAccess, nTPPollInterval=nTPPollInterval, siteName=siteName, sNMPTrapTableEntry=sNMPTrapTableEntry, configurationGroup=configurationGroup, phyStatus=phyStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, receivePower=receivePower, tFTPServerPortNumber=tFTPServerPortNumber, nTPServerIp=nTPServerIp, productName=productName, sNMPCommunityOid=sNMPCommunityOid, linkStatusTrap=linkStatusTrap, smtp=smtp, regionCode=regionCode, sNMPTrapIPAddress=sNMPTrapIPAddress, ntpGroup=ntpGroup, receiveModulationMode=receiveModulationMode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, transmitDataRate=transmitDataRate, dualPayload=dualPayload, ptpGroups=ptpGroups, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, cableLoss=cableLoss, sNMPCommunityTableEntry=sNMPCommunityTableEntry, measuredRange=measuredRange, installArmState=installArmState, sNMPTrapCommunity=sNMPTrapCommunity, dataPortStatusTrap=dataPortStatusTrap, vlanPriority=vlanPriority, pubStatsGroup=pubStatsGroup, licenceGroup=licenceGroup, iPAddress=iPAddress, gatewayIPAddress=gatewayIPAddress, ptpTraps=ptpTraps, versions=versions, ptpCompliance=ptpCompliance, noiseFloor=noiseFloor, channelBandwidth=channelBandwidth, transmitPower=transmitPower, sMTPSourceEmailAddress=sMTPSourceEmailAddress, remoteIPAddress=remoteIPAddress, smtpGroup=smtpGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, currentChannel=currentChannel, antennaGain=antennaGain, management=management, vlanTagging=vlanTagging, signalStrengthRatio=signalStrengthRatio, configuredRange=configuredRange, softwareVersion=softwareVersion, ptpTrapPrefix=ptpTrapPrefix, ptp250=ptp250, snmpControl=snmpControl, cambium=cambium, noWirelessChannelAvailable=noWirelessChannelAvailable, linkName=linkName, PYSNMP_MODULE_ID=cambium, channelSelection=channelSelection, fixedModMode=fixedModMode, sNMPTrapTable=sNMPTrapTable, sNMPCommunityString=sNMPCommunityString, phyStatusGroup=phyStatusGroup, extendedFreqMHz=extendedFreqMHz, configuredModulationMode=configuredModulationMode, installArmStateTrap=installArmStateTrap, sMTPServerIPAddress=sMTPServerIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, pubStats=pubStats, hardwareVersion=hardwareVersion)
