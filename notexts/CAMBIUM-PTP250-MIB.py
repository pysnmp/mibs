...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", maximumTransmitPower=maximumTransmitPower, iPAddress=iPAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, linkLoss=linkLoss, aggregateDataRate=aggregateDataRate, nTPServerIp=nTPServerIp, sNMPTrapCommunity=sNMPTrapCommunity, sNMPCommunityAccess=sNMPCommunityAccess, sMTPEnabledMessages=sMTPEnabledMessages, ptmp=ptmp, ptpTrapPrefix=ptpTrapPrefix, systemClock=systemClock, extendedChannel=extendedChannel, wirelessLinkStatus=wirelessLinkStatus, alarms=alarms, notificationsGroup=notificationsGroup, fixedModMode=fixedModMode, sNMPTrapIPAddress=sNMPTrapIPAddress, ptpCompliance=ptpCompliance, pubStatsGroup=pubStatsGroup, productName=productName, versionsGroup=versionsGroup, sNMPCommunityTableEntry=sNMPCommunityTableEntry, dataPortStatus=dataPortStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, band=band, productVariant=productVariant, noiseFloor=noiseFloor, linkStatusTrap=linkStatusTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapTableIndex=sNMPTrapTableIndex, currentChannel=currentChannel, vlanTagging=vlanTagging, masterSlaveMode=masterSlaveMode, subnetMask=subnetMask, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, installArmStateTrap=installArmStateTrap, nTPSync=nTPSync, remoteIPAddress=remoteIPAddress, sNMPCommunityTableNumber=sNMPCommunityTableNumber, vlanPriority=vlanPriority, radarDetectChannel=radarDetectChannel, ntpGroup=ntpGroup, remoteMACAddress=remoteMACAddress, signalStrengthRatio=signalStrengthRatio, gatewayIPAddress=gatewayIPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, smtpGroup=smtpGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, ptpTraps=ptpTraps, vectorError=vectorError, sMTPSourceEmailAddress=sMTPSourceEmailAddress, softwareVersion=softwareVersion, tFTPServerPortNumber=tFTPServerPortNumber, regionCode=regionCode, smtp=smtp, cambium=cambium, transmitModulationMode=transmitModulationMode, sMTPServerIPAddress=sMTPServerIPAddress, channelSelection=channelSelection, measuredRange=measuredRange, radarDetectTrap=radarDetectTrap, snmpControlGroup=snmpControlGroup, configurationGroup=configurationGroup, ethernet=ethernet, sNMPTrapTable=sNMPTrapTable, vlanId=vlanId, receiveDataRate=receiveDataRate, searchState=searchState, PYSNMP_MODULE_ID=cambium, licence=licence, receiveModulationMode=receiveModulationMode, sNMPCommunityTable=sNMPCommunityTable, extendedFreqMHz=extendedFreqMHz, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, licenceGroup=licenceGroup, channelBandwidth=channelBandwidth, dualPayload=dualPayload, noWirelessChannelAvailable=noWirelessChannelAvailable, managementGroup=managementGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, installArmState=installArmState, sNMPTrapPortNumber=sNMPTrapPortNumber, versions=versions, ptpGroups=ptpGroups, ethernetGroup=ethernetGroup, hardwareVersion=hardwareVersion, transmitPower=transmitPower, phyStatus=phyStatus, receivePower=receivePower, configuredModulationMode=configuredModulationMode, configuredRange=configuredRange, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortStatusTrap=dataPortStatusTrap, phyStatusGroup=phyStatusGroup, tFTPServerIPAddress=tFTPServerIPAddress, sNMPEnabledTraps=sNMPEnabledTraps, transmitDataRate=transmitDataRate, sNMPTrapVersion=sNMPTrapVersion, pubStats=pubStats, timeZone=timeZone, ntp=ntp, nTPState=nTPState, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sMTPServerPortNumber=sMTPServerPortNumber, currentFreqMHz=currentFreqMHz, configuration=configuration, linkName=linkName, management=management, nTPPollInterval=nTPPollInterval, sNMPCommunityOid=sNMPCommunityOid, bootVersion=bootVersion, alarmsGroup=alarmsGroup, nTPLastSync=nTPLastSync, siteName=siteName, nTPServerPortNumber=nTPServerPortNumber, ptp=ptp, cableLoss=cableLoss, ptp250=ptp250, snmpControl=snmpControl, antennaGain=antennaGain, sNMPCommunityString=sNMPCommunityString)
