...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", ntpGroup=ntpGroup, sNMPTrapCommunity=sNMPTrapCommunity, measuredRange=measuredRange, cableLoss=cableLoss, ethernet=ethernet, smtpGroup=smtpGroup, channelSelection=channelSelection, phyStatusGroup=phyStatusGroup, linkLoss=linkLoss, signalStrengthRatio=signalStrengthRatio, systemClock=systemClock, iPAddress=iPAddress, nTPSync=nTPSync, nTPState=nTPState, dataPortAutoNegotiation=dataPortAutoNegotiation, ptpTraps=ptpTraps, antennaGain=antennaGain, wirelessLinkStatus=wirelessLinkStatus, ptpCompliance=ptpCompliance, ptmp=ptmp, licence=licence, sNMPTrapTable=sNMPTrapTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitModulationMode=transmitModulationMode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, linkStatusTrap=linkStatusTrap, remoteIPAddress=remoteIPAddress, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortStatusTrap=dataPortStatusTrap, nTPLastSync=nTPLastSync, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, licenceGroup=licenceGroup, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sNMPCommunityString=sNMPCommunityString, productName=productName, band=band, channelBandwidth=channelBandwidth, ptp250=ptp250, transmitPower=transmitPower, configuration=configuration, configuredModulationMode=configuredModulationMode, PYSNMP_MODULE_ID=cambium, vlanTagging=vlanTagging, sNMPEnabledTraps=sNMPEnabledTraps, notificationsGroup=notificationsGroup, hardwareVersion=hardwareVersion, tFTPServerPortNumber=tFTPServerPortNumber, installArmState=installArmState, management=management, dataPortStatus=dataPortStatus, regionCode=regionCode, nTPServerIp=nTPServerIp, snmpControlGroup=snmpControlGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, noiseFloor=noiseFloor, alarmsGroup=alarmsGroup, timeZone=timeZone, ethernetGroup=ethernetGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPCommunityTableEntry=sNMPCommunityTableEntry, fixedModMode=fixedModMode, currentChannel=currentChannel, receiveDataRate=receiveDataRate, vectorError=vectorError, dualPayload=dualPayload, sNMPTrapIPAddress=sNMPTrapIPAddress, versionsGroup=versionsGroup, searchState=searchState, transmitDataRate=transmitDataRate, productVariant=productVariant, siteName=siteName, sNMPCommunityAccess=sNMPCommunityAccess, snmpControl=snmpControl, ntp=ntp, phyStatus=phyStatus, pubStats=pubStats, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, nTPPollInterval=nTPPollInterval, aggregateDataRate=aggregateDataRate, sNMPTrapVersion=sNMPTrapVersion, pubStatsGroup=pubStatsGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPCommunityOid=sNMPCommunityOid, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, versions=versions, configuredRange=configuredRange, nTPServerPortNumber=nTPServerPortNumber, subnetMask=subnetMask, sNMPTrapTableIndex=sNMPTrapTableIndex, installArmStateTrap=installArmStateTrap, receiveModulationMode=receiveModulationMode, ptp=ptp, masterSlaveMode=masterSlaveMode, extendedChannel=extendedChannel, vlanId=vlanId, sMTPEnabledMessages=sMTPEnabledMessages, tFTPServerIPAddress=tFTPServerIPAddress, bootVersion=bootVersion, cambium=cambium, alarms=alarms, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, radarDetectTrap=radarDetectTrap, smtp=smtp, receivePower=receivePower, sMTPServerIPAddress=sMTPServerIPAddress, softwareVersion=softwareVersion, managementGroup=managementGroup, vlanPriority=vlanPriority, sNMPTrapPortNumber=sNMPTrapPortNumber, configurationGroup=configurationGroup, remoteMACAddress=remoteMACAddress, sMTPServerPortNumber=sMTPServerPortNumber, maximumTransmitPower=maximumTransmitPower, noWirelessChannelAvailable=noWirelessChannelAvailable, ptpGroups=ptpGroups, gatewayIPAddress=gatewayIPAddress, extendedFreqMHz=extendedFreqMHz, linkName=linkName, currentFreqMHz=currentFreqMHz, sNMPCommunityTable=sNMPCommunityTable, radarDetectChannel=radarDetectChannel, sNMPCommunityTableNumber=sNMPCommunityTableNumber)
