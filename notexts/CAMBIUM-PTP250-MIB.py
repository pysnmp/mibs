...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", hardwareVersion=hardwareVersion, cableLoss=cableLoss, alarms=alarms, managementGroup=managementGroup, licence=licence, systemClock=systemClock, nTPServerIp=nTPServerIp, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sNMPCommunityTable=sNMPCommunityTable, sNMPTrapTableNumber=sNMPTrapTableNumber, nTPLastSync=nTPLastSync, iPAddress=iPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptpTrapPrefix=ptpTrapPrefix, dataPortStatus=dataPortStatus, linkStatusTrap=linkStatusTrap, sNMPEnabledTraps=sNMPEnabledTraps, sNMPCommunityTableEntry=sNMPCommunityTableEntry, tFTPServerPortNumber=tFTPServerPortNumber, phyStatus=phyStatus, configuredModulationMode=configuredModulationMode, linkName=linkName, phyStatusGroup=phyStatusGroup, sNMPCommunityString=sNMPCommunityString, productName=productName, smtpGroup=smtpGroup, configuredRange=configuredRange, ptp250=ptp250, fixedModMode=fixedModMode, remoteMACAddress=remoteMACAddress, vlanId=vlanId, installArmStateTrap=installArmStateTrap, snmpControlGroup=snmpControlGroup, linkLoss=linkLoss, productVariant=productVariant, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, extendedChannel=extendedChannel, transmitModulationMode=transmitModulationMode, antennaGain=antennaGain, configurationGroup=configurationGroup, ethernetGroup=ethernetGroup, wirelessLinkStatus=wirelessLinkStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ptpCompliance=ptpCompliance, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPCommunityOid=sNMPCommunityOid, sNMPTrapVersion=sNMPTrapVersion, currentFreqMHz=currentFreqMHz, management=management, versionsGroup=versionsGroup, licenceGroup=licenceGroup, notificationsGroup=notificationsGroup, ptpGroups=ptpGroups, signalStrengthRatio=signalStrengthRatio, sMTPServerPortNumber=sMTPServerPortNumber, receiveModulationMode=receiveModulationMode, channelSelection=channelSelection, remoteIPAddress=remoteIPAddress, receivePower=receivePower, noWirelessChannelAvailable=noWirelessChannelAvailable, dualPayload=dualPayload, pubStatsGroup=pubStatsGroup, timeZone=timeZone, searchState=searchState, sNMPTrapCommunity=sNMPTrapCommunity, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, alarmsGroup=alarmsGroup, receiveDataRate=receiveDataRate, channelBandwidth=channelBandwidth, ethernet=ethernet, dataPortStatusTrap=dataPortStatusTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, nTPServerPortNumber=nTPServerPortNumber, ntp=ntp, ntpGroup=ntpGroup, vlanTagging=vlanTagging, ptpTraps=ptpTraps, gatewayIPAddress=gatewayIPAddress, vlanPriority=vlanPriority, installArmState=installArmState, radarDetectTrap=radarDetectTrap, nTPPollInterval=nTPPollInterval, vectorError=vectorError, sMTPEnabledMessages=sMTPEnabledMessages, pubStats=pubStats, sNMPCommunityTableIndex=sNMPCommunityTableIndex, radarDetectChannel=radarDetectChannel, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, cambium=cambium, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPTrapTableIndex=sNMPTrapTableIndex, extendedFreqMHz=extendedFreqMHz, ptmp=ptmp, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, siteName=siteName, nTPSync=nTPSync, smtp=smtp, bootVersion=bootVersion, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPCommunityAccess=sNMPCommunityAccess, snmpControl=snmpControl, transmitPower=transmitPower, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapTable=sNMPTrapTable, band=band, measuredRange=measuredRange, transmitDataRate=transmitDataRate, sNMPTrapIPAddress=sNMPTrapIPAddress, maximumTransmitPower=maximumTransmitPower, regionCode=regionCode, noiseFloor=noiseFloor, ptp=ptp, PYSNMP_MODULE_ID=cambium, nTPState=nTPState, aggregateDataRate=aggregateDataRate, tFTPServerIPAddress=tFTPServerIPAddress, currentChannel=currentChannel, softwareVersion=softwareVersion, configuration=configuration, masterSlaveMode=masterSlaveMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, subnetMask=subnetMask, versions=versions)
