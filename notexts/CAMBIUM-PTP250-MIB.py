...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPTrapTable=sNMPTrapTable, notificationsGroup=notificationsGroup, snmpControl=snmpControl, productName=productName, gatewayIPAddress=gatewayIPAddress, currentFreqMHz=currentFreqMHz, configuration=configuration, timeZone=timeZone, ptp=ptp, sNMPCommunityTable=sNMPCommunityTable, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPServerPortNumber=sMTPServerPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, ntpGroup=ntpGroup, regionCode=regionCode, cambium=cambium, searchState=searchState, nTPServerPortNumber=nTPServerPortNumber, extendedChannel=extendedChannel, sNMPCommunityTableNumber=sNMPCommunityTableNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, radarDetectChannel=radarDetectChannel, hardwareVersion=hardwareVersion, nTPState=nTPState, softwareVersion=softwareVersion, sNMPEnabledTraps=sNMPEnabledTraps, vectorError=vectorError, dualPayload=dualPayload, receiveModulationMode=receiveModulationMode, alarmsGroup=alarmsGroup, smtpGroup=smtpGroup, siteName=siteName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, signalStrengthRatio=signalStrengthRatio, sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPServerPortNumber=tFTPServerPortNumber, ptpCompliance=ptpCompliance, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPCommunityTableEntry=sNMPCommunityTableEntry, vlanPriority=vlanPriority, currentChannel=currentChannel, ethernetGroup=ethernetGroup, versionsGroup=versionsGroup, configuredRange=configuredRange, nTPSync=nTPSync, fixedModMode=fixedModMode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, aggregateDataRate=aggregateDataRate, channelSelection=channelSelection, management=management, installArmState=installArmState, band=band, sNMPCommunityString=sNMPCommunityString, linkStatusTrap=linkStatusTrap, sNMPCommunityOid=sNMPCommunityOid, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, managementGroup=managementGroup, channelBandwidth=channelBandwidth, extendedFreqMHz=extendedFreqMHz, licence=licence, measuredRange=measuredRange, phyStatusGroup=phyStatusGroup, subnetMask=subnetMask, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptp250=ptp250, sNMPTrapVersion=sNMPTrapVersion, remoteMACAddress=remoteMACAddress, PYSNMP_MODULE_ID=cambium, ntp=ntp, antennaGain=antennaGain, receiveDataRate=receiveDataRate, phyStatus=phyStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, transmitPower=transmitPower, versions=versions, noiseFloor=noiseFloor, ptpGroups=ptpGroups, nTPLastSync=nTPLastSync, pubStatsGroup=pubStatsGroup, wirelessLinkStatus=wirelessLinkStatus, linkName=linkName, remoteIPAddress=remoteIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, configuredModulationMode=configuredModulationMode, alarms=alarms, sNMPTrapTableNumber=sNMPTrapTableNumber, installArmStateTrap=installArmStateTrap, transmitModulationMode=transmitModulationMode, dataPortStatusTrap=dataPortStatusTrap, sNMPCommunityTableIndex=sNMPCommunityTableIndex, ptmp=ptmp, maximumTransmitPower=maximumTransmitPower, sMTPServerIPAddress=sMTPServerIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, smtp=smtp, nTPPollInterval=nTPPollInterval, transmitDataRate=transmitDataRate, masterSlaveMode=masterSlaveMode, vlanTagging=vlanTagging, vlanId=vlanId, configurationGroup=configurationGroup, ptpTraps=ptpTraps, tFTPServerIPAddress=tFTPServerIPAddress, snmpControlGroup=snmpControlGroup, bootVersion=bootVersion, dataPortStatus=dataPortStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapCommunity=sNMPTrapCommunity, sNMPTrapPortNumber=sNMPTrapPortNumber, pubStats=pubStats, licenceGroup=licenceGroup, iPAddress=iPAddress, linkLoss=linkLoss, radarDetectTrap=radarDetectTrap, ethernet=ethernet, systemClock=systemClock, ptpTrapPrefix=ptpTrapPrefix, sNMPCommunityAccess=sNMPCommunityAccess, nTPServerIp=nTPServerIp, productVariant=productVariant, receivePower=receivePower, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, cableLoss=cableLoss)
