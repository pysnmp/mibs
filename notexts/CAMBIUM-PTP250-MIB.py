...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPTrapTableIndex=sNMPTrapTableIndex, remoteIPAddress=remoteIPAddress, ntp=ntp, snmpControlGroup=snmpControlGroup, sNMPCommunityOid=sNMPCommunityOid, sNMPTrapCommunity=sNMPTrapCommunity, aggregateDataRate=aggregateDataRate, smtp=smtp, sNMPTrapTableNumber=sNMPTrapTableNumber, pubStatsGroup=pubStatsGroup, alarms=alarms, hardwareVersion=hardwareVersion, dataPortAutoNegotiation=dataPortAutoNegotiation, systemClock=systemClock, ptp=ptp, sNMPTrapVersion=sNMPTrapVersion, ethernet=ethernet, remoteMACAddress=remoteMACAddress, linkName=linkName, productName=productName, notificationsGroup=notificationsGroup, fixedModMode=fixedModMode, nTPState=nTPState, nTPLastSync=nTPLastSync, management=management, masterSlaveMode=masterSlaveMode, ntpGroup=ntpGroup, sNMPCommunityTableEntry=sNMPCommunityTableEntry, alarmsGroup=alarmsGroup, vectorError=vectorError, transmitPower=transmitPower, noWirelessChannelAvailable=noWirelessChannelAvailable, vlanTagging=vlanTagging, dataPortStatusTrap=dataPortStatusTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, extendedChannel=extendedChannel, softwareVersion=softwareVersion, sNMPTrapIPAddress=sNMPTrapIPAddress, cableLoss=cableLoss, configuredRange=configuredRange, dataPortStatus=dataPortStatus, configurationGroup=configurationGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPCommunityAccess=sNMPCommunityAccess, ptp250=ptp250, channelBandwidth=channelBandwidth, tFTPServerPortNumber=tFTPServerPortNumber, signalStrengthRatio=signalStrengthRatio, radarDetectChannel=radarDetectChannel, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, wirelessLinkStatus=wirelessLinkStatus, phyStatusGroup=phyStatusGroup, iPAddress=iPAddress, transmitModulationMode=transmitModulationMode, antennaGain=antennaGain, nTPServerIp=nTPServerIp, nTPSync=nTPSync, nTPServerPortNumber=nTPServerPortNumber, receiveDataRate=receiveDataRate, ptpTraps=ptpTraps, sMTPEnabledMessages=sMTPEnabledMessages, ptpGroups=ptpGroups, configuredModulationMode=configuredModulationMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPCommunityString=sNMPCommunityString, ptmp=ptmp, versions=versions, pubStats=pubStats, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ptpTrapPrefix=ptpTrapPrefix, searchState=searchState, currentChannel=currentChannel, noiseFloor=noiseFloor, dualPayload=dualPayload, tFTPServerIPAddress=tFTPServerIPAddress, maximumTransmitPower=maximumTransmitPower, radarDetectTrap=radarDetectTrap, receivePower=receivePower, currentFreqMHz=currentFreqMHz, ethernetGroup=ethernetGroup, productVariant=productVariant, licence=licence, sMTPServerIPAddress=sMTPServerIPAddress, transmitDataRate=transmitDataRate, sNMPTrapTableEntry=sNMPTrapTableEntry, measuredRange=measuredRange, smtpGroup=smtpGroup, PYSNMP_MODULE_ID=cambium, snmpControl=snmpControl, sNMPCommunityTableIndex=sNMPCommunityTableIndex, cambium=cambium, sMTPServerPortNumber=sMTPServerPortNumber, configuration=configuration, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPCommunityTableNumber=sNMPCommunityTableNumber, timeZone=timeZone, phyStatus=phyStatus, bootVersion=bootVersion, extendedFreqMHz=extendedFreqMHz, sNMPCommunityTable=sNMPCommunityTable, installArmStateTrap=installArmStateTrap, nTPPollInterval=nTPPollInterval, managementGroup=managementGroup, vlanPriority=vlanPriority, linkLoss=linkLoss, sNMPTrapTable=sNMPTrapTable, vlanId=vlanId, receiveModulationMode=receiveModulationMode, subnetMask=subnetMask, ptpCompliance=ptpCompliance, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, channelSelection=channelSelection, licenceGroup=licenceGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, band=band, versionsGroup=versionsGroup, sNMPEnabledTraps=sNMPEnabledTraps, linkStatusTrap=linkStatusTrap, siteName=siteName, sNMPTrapPortNumber=sNMPTrapPortNumber, regionCode=regionCode, gatewayIPAddress=gatewayIPAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, installArmState=installArmState)
