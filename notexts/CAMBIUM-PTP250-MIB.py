...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", linkName=linkName, receiveDataRate=receiveDataRate, radarDetectTrap=radarDetectTrap, ptpTraps=ptpTraps, gatewayIPAddress=gatewayIPAddress, ptmp=ptmp, dataPortAutoNegotiation=dataPortAutoNegotiation, wirelessLinkStatus=wirelessLinkStatus, nTPServerIp=nTPServerIp, alarmsGroup=alarmsGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPCommunityTableEntry=sNMPCommunityTableEntry, currentChannel=currentChannel, PYSNMP_MODULE_ID=cambium, band=band, sNMPCommunityOid=sNMPCommunityOid, ptpCompliance=ptpCompliance, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPCommunityTableIndex=sNMPCommunityTableIndex, ptpTrapPrefix=ptpTrapPrefix, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, alarms=alarms, sMTPServerIPAddress=sMTPServerIPAddress, linkStatusTrap=linkStatusTrap, ethernetGroup=ethernetGroup, noiseFloor=noiseFloor, channelSelection=channelSelection, configuredModulationMode=configuredModulationMode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, receivePower=receivePower, sNMPTrapTable=sNMPTrapTable, transmitDataRate=transmitDataRate, sNMPTrapTableIndex=sNMPTrapTableIndex, hardwareVersion=hardwareVersion, vlanTagging=vlanTagging, regionCode=regionCode, ptp250=ptp250, tFTPServerIPAddress=tFTPServerIPAddress, configuredRange=configuredRange, remoteIPAddress=remoteIPAddress, productVariant=productVariant, aggregateDataRate=aggregateDataRate, dataPortStatus=dataPortStatus, managementGroup=managementGroup, searchState=searchState, nTPSync=nTPSync, phyStatusGroup=phyStatusGroup, softwareVersion=softwareVersion, sNMPTrapCommunity=sNMPTrapCommunity, remoteMACAddress=remoteMACAddress, fixedModMode=fixedModMode, vlanId=vlanId, licenceGroup=licenceGroup, ethernet=ethernet, sNMPEnabledTraps=sNMPEnabledTraps, transmitPower=transmitPower, sMTPEnabledMessages=sMTPEnabledMessages, versions=versions, sNMPCommunityTableNumber=sNMPCommunityTableNumber, ptpGroups=ptpGroups, ptp=ptp, vectorError=vectorError, pubStatsGroup=pubStatsGroup, currentFreqMHz=currentFreqMHz, bootVersion=bootVersion, configuration=configuration, snmpControlGroup=snmpControlGroup, masterSlaveMode=masterSlaveMode, management=management, sNMPTrapIPAddress=sNMPTrapIPAddress, dualPayload=dualPayload, vlanPriority=vlanPriority, radarDetectChannel=radarDetectChannel, nTPServerPortNumber=nTPServerPortNumber, notificationsGroup=notificationsGroup, snmpControl=snmpControl, versionsGroup=versionsGroup, receiveModulationMode=receiveModulationMode, extendedFreqMHz=extendedFreqMHz, iPAddress=iPAddress, maximumTransmitPower=maximumTransmitPower, pubStats=pubStats, installArmState=installArmState, systemClock=systemClock, productName=productName, subnetMask=subnetMask, signalStrengthRatio=signalStrengthRatio, sNMPTrapVersion=sNMPTrapVersion, sNMPCommunityTable=sNMPCommunityTable, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, smtpGroup=smtpGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPCommunityString=sNMPCommunityString, channelBandwidth=channelBandwidth, licence=licence, configurationGroup=configurationGroup, nTPLastSync=nTPLastSync, timeZone=timeZone, antennaGain=antennaGain, transmitModulationMode=transmitModulationMode, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortStatusTrap=dataPortStatusTrap, nTPPollInterval=nTPPollInterval, extendedChannel=extendedChannel, measuredRange=measuredRange, cableLoss=cableLoss, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPCommunityAccess=sNMPCommunityAccess, siteName=siteName, nTPState=nTPState, cambium=cambium, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ntpGroup=ntpGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, linkLoss=linkLoss, tFTPServerPortNumber=tFTPServerPortNumber, phyStatus=phyStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, installArmStateTrap=installArmStateTrap, smtp=smtp, ntp=ntp)
