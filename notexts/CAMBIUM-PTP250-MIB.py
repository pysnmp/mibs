...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", installArmState=installArmState, cambium=cambium, ntpGroup=ntpGroup, ptp=ptp, remoteIPAddress=remoteIPAddress, ptpGroups=ptpGroups, ntp=ntp, noiseFloor=noiseFloor, productName=productName, wirelessLinkStatus=wirelessLinkStatus, aggregateDataRate=aggregateDataRate, band=band, sNMPTrapVersion=sNMPTrapVersion, searchState=searchState, smtpGroup=smtpGroup, ethernetGroup=ethernetGroup, receivePower=receivePower, pubStats=pubStats, nTPPollInterval=nTPPollInterval, sNMPTrapTableEntry=sNMPTrapTableEntry, iPAddress=iPAddress, channelBandwidth=channelBandwidth, productVariant=productVariant, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, licenceGroup=licenceGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, versions=versions, sNMPCommunityTable=sNMPCommunityTable, regionCode=regionCode, sNMPCommunityTableEntry=sNMPCommunityTableEntry, currentFreqMHz=currentFreqMHz, notificationsGroup=notificationsGroup, linkLoss=linkLoss, receiveDataRate=receiveDataRate, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, cableLoss=cableLoss, snmpControl=snmpControl, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPCommunityAccess=sNMPCommunityAccess, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPCommunityOid=sNMPCommunityOid, measuredRange=measuredRange, sNMPTrapTable=sNMPTrapTable, dataPortStatusTrap=dataPortStatusTrap, transmitDataRate=transmitDataRate, channelSelection=channelSelection, sNMPCommunityTableIndex=sNMPCommunityTableIndex, radarDetectChannel=radarDetectChannel, noWirelessChannelAvailable=noWirelessChannelAvailable, systemClock=systemClock, vlanId=vlanId, nTPSync=nTPSync, sNMPTrapTableIndex=sNMPTrapTableIndex, configuredRange=configuredRange, extendedChannel=extendedChannel, vlanPriority=vlanPriority, phyStatusGroup=phyStatusGroup, receiveModulationMode=receiveModulationMode, installArmStateTrap=installArmStateTrap, siteName=siteName, dataPortStatus=dataPortStatus, softwareVersion=softwareVersion, versionsGroup=versionsGroup, sNMPTrapCommunity=sNMPTrapCommunity, phyStatus=phyStatus, currentChannel=currentChannel, ethernet=ethernet, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ptp250=ptp250, subnetMask=subnetMask, tFTPServerPortNumber=tFTPServerPortNumber, ptmp=ptmp, nTPLastSync=nTPLastSync, transmitModulationMode=transmitModulationMode, hardwareVersion=hardwareVersion, pubStatsGroup=pubStatsGroup, timeZone=timeZone, dualPayload=dualPayload, snmpControlGroup=snmpControlGroup, fixedModMode=fixedModMode, dataPortAutoNegotiation=dataPortAutoNegotiation, extendedFreqMHz=extendedFreqMHz, nTPServerIp=nTPServerIp, ptpTrapPrefix=ptpTrapPrefix, sMTPServerPortNumber=sMTPServerPortNumber, alarmsGroup=alarmsGroup, remoteMACAddress=remoteMACAddress, configuredModulationMode=configuredModulationMode, PYSNMP_MODULE_ID=cambium, nTPServerPortNumber=nTPServerPortNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPEnabledTraps=sNMPEnabledTraps, sMTPServerIPAddress=sMTPServerIPAddress, configurationGroup=configurationGroup, sMTPEnabledMessages=sMTPEnabledMessages, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, management=management, configuration=configuration, signalStrengthRatio=signalStrengthRatio, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, maximumTransmitPower=maximumTransmitPower, managementGroup=managementGroup, linkStatusTrap=linkStatusTrap, linkName=linkName, radarDetectTrap=radarDetectTrap, bootVersion=bootVersion, masterSlaveMode=masterSlaveMode, sNMPCommunityString=sNMPCommunityString, licence=licence, ptpCompliance=ptpCompliance, gatewayIPAddress=gatewayIPAddress, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, nTPState=nTPState, transmitPower=transmitPower, alarms=alarms, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, vectorError=vectorError, sNMPCommunityTableNumber=sNMPCommunityTableNumber, smtp=smtp, ptpTraps=ptpTraps, vlanTagging=vlanTagging, antennaGain=antennaGain)
