...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", tFTPServerIPAddress=tFTPServerIPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, hardwareVersion=hardwareVersion, band=band, subnetMask=subnetMask, ntpGroup=ntpGroup, ptp250=ptp250, siteName=siteName, searchState=searchState, nTPServerIp=nTPServerIp, nTPLastSync=nTPLastSync, channelBandwidth=channelBandwidth, bootVersion=bootVersion, managementGroup=managementGroup, licence=licence, configuredModulationMode=configuredModulationMode, sNMPTrapVersion=sNMPTrapVersion, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapTableIndex=sNMPTrapTableIndex, vectorError=vectorError, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sNMPCommunityTableIndex=sNMPCommunityTableIndex, noiseFloor=noiseFloor, sNMPCommunityAccess=sNMPCommunityAccess, alarmsGroup=alarmsGroup, linkStatusTrap=linkStatusTrap, aggregateDataRate=aggregateDataRate, masterSlaveMode=masterSlaveMode, linkLoss=linkLoss, dataPortStatus=dataPortStatus, extendedChannel=extendedChannel, dualPayload=dualPayload, pubStats=pubStats, iPAddress=iPAddress, softwareVersion=softwareVersion, sMTPEnabledMessages=sMTPEnabledMessages, transmitPower=transmitPower, sMTPServerPortNumber=sMTPServerPortNumber, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, systemClock=systemClock, signalStrengthRatio=signalStrengthRatio, regionCode=regionCode, configuredRange=configuredRange, ntp=ntp, nTPSync=nTPSync, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapCommunity=sNMPTrapCommunity, ptpGroups=ptpGroups, nTPState=nTPState, smtpGroup=smtpGroup, notificationsGroup=notificationsGroup, configurationGroup=configurationGroup, configuration=configuration, cableLoss=cableLoss, nTPServerPortNumber=nTPServerPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernet=ethernet, vlanId=vlanId, smtp=smtp, sNMPTrapIPAddress=sNMPTrapIPAddress, channelSelection=channelSelection, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPCommunityTable=sNMPCommunityTable, productVariant=productVariant, dataPortStatusTrap=dataPortStatusTrap, phyStatus=phyStatus, sNMPCommunityOid=sNMPCommunityOid, nTPPollInterval=nTPPollInterval, measuredRange=measuredRange, ptp=ptp, installArmStateTrap=installArmStateTrap, versions=versions, versionsGroup=versionsGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, licenceGroup=licenceGroup, radarDetectChannel=radarDetectChannel, alarms=alarms, PYSNMP_MODULE_ID=cambium, receiveDataRate=receiveDataRate, ethernetGroup=ethernetGroup, currentFreqMHz=currentFreqMHz, receivePower=receivePower, snmpControl=snmpControl, ptpTraps=ptpTraps, maximumTransmitPower=maximumTransmitPower, timeZone=timeZone, snmpControlGroup=snmpControlGroup, phyStatusGroup=phyStatusGroup, receiveModulationMode=receiveModulationMode, wirelessLinkStatus=wirelessLinkStatus, gatewayIPAddress=gatewayIPAddress, remoteMACAddress=remoteMACAddress, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, antennaGain=antennaGain, sNMPTrapTableEntry=sNMPTrapTableEntry, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptpCompliance=ptpCompliance, transmitDataRate=transmitDataRate, radarDetectTrap=radarDetectTrap, vlanTagging=vlanTagging, ptpTrapPrefix=ptpTrapPrefix, sNMPEnabledTraps=sNMPEnabledTraps, vlanPriority=vlanPriority, ptmp=ptmp, extendedFreqMHz=extendedFreqMHz, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, fixedModMode=fixedModMode, sNMPCommunityString=sNMPCommunityString, sNMPTrapTable=sNMPTrapTable, currentChannel=currentChannel, remoteIPAddress=remoteIPAddress, transmitModulationMode=transmitModulationMode, cambium=cambium, management=management, installArmState=installArmState, linkName=linkName, pubStatsGroup=pubStatsGroup, productName=productName)
