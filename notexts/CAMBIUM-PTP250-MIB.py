...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", tFTPServerPortNumber=tFTPServerPortNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, signalStrengthRatio=signalStrengthRatio, remoteMACAddress=remoteMACAddress, sNMPCommunityString=sNMPCommunityString, licence=licence, noiseFloor=noiseFloor, management=management, versions=versions, antennaGain=antennaGain, PYSNMP_MODULE_ID=cambium, noWirelessChannelAvailable=noWirelessChannelAvailable, phyStatus=phyStatus, searchState=searchState, nTPServerIp=nTPServerIp, licenceGroup=licenceGroup, ptmp=ptmp, regionCode=regionCode, channelSelection=channelSelection, gatewayIPAddress=gatewayIPAddress, ptpTraps=ptpTraps, installArmState=installArmState, ptpCompliance=ptpCompliance, softwareVersion=softwareVersion, sNMPCommunityTableEntry=sNMPCommunityTableEntry, nTPSync=nTPSync, sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, band=band, ptpTrapPrefix=ptpTrapPrefix, radarDetectChannel=radarDetectChannel, cambium=cambium, sNMPCommunityTableNumber=sNMPCommunityTableNumber, alarmsGroup=alarmsGroup, configuration=configuration, sNMPTrapTableEntry=sNMPTrapTableEntry, receiveModulationMode=receiveModulationMode, ethernet=ethernet, iPAddress=iPAddress, ntpGroup=ntpGroup, radarDetectTrap=radarDetectTrap, maximumTransmitPower=maximumTransmitPower, vlanTagging=vlanTagging, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, nTPLastSync=nTPLastSync, sMTPSourceEmailAddress=sMTPSourceEmailAddress, phyStatusGroup=phyStatusGroup, notificationsGroup=notificationsGroup, vectorError=vectorError, wirelessLinkStatus=wirelessLinkStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, nTPState=nTPState, pubStats=pubStats, cableLoss=cableLoss, subnetMask=subnetMask, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapVersion=sNMPTrapVersion, sNMPCommunityOid=sNMPCommunityOid, ethernetGroup=ethernetGroup, extendedChannel=extendedChannel, sNMPCommunityTableIndex=sNMPCommunityTableIndex, configuredModulationMode=configuredModulationMode, nTPServerPortNumber=nTPServerPortNumber, productVariant=productVariant, sNMPCommunityTable=sNMPCommunityTable, dataPortAutoNegotiation=dataPortAutoNegotiation, installArmStateTrap=installArmStateTrap, receivePower=receivePower, extendedFreqMHz=extendedFreqMHz, transmitModulationMode=transmitModulationMode, sNMPTrapCommunity=sNMPTrapCommunity, transmitPower=transmitPower, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, productName=productName, sNMPTrapPortNumber=sNMPTrapPortNumber, ptp250=ptp250, sNMPCommunityAccess=sNMPCommunityAccess, currentFreqMHz=currentFreqMHz, snmpControl=snmpControl, hardwareVersion=hardwareVersion, systemClock=systemClock, channelBandwidth=channelBandwidth, masterSlaveMode=masterSlaveMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPServerPortNumber=sMTPServerPortNumber, ptp=ptp, remoteIPAddress=remoteIPAddress, linkName=linkName, linkStatusTrap=linkStatusTrap, aggregateDataRate=aggregateDataRate, dataPortStatus=dataPortStatus, dataPortStatusTrap=dataPortStatusTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, versionsGroup=versionsGroup, sMTPEnabledMessages=sMTPEnabledMessages, bootVersion=bootVersion, receiveDataRate=receiveDataRate, siteName=siteName, currentChannel=currentChannel, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, measuredRange=measuredRange, nTPPollInterval=nTPPollInterval, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapTable=sNMPTrapTable, snmpControlGroup=snmpControlGroup, transmitDataRate=transmitDataRate, fixedModMode=fixedModMode, configuredRange=configuredRange, linkLoss=linkLoss, vlanPriority=vlanPriority, sNMPTrapTableIndex=sNMPTrapTableIndex, timeZone=timeZone, dualPayload=dualPayload, managementGroup=managementGroup, smtpGroup=smtpGroup, alarms=alarms, ntp=ntp, sMTPServerIPAddress=sMTPServerIPAddress, pubStatsGroup=pubStatsGroup, vlanId=vlanId, configurationGroup=configurationGroup, ptpGroups=ptpGroups, smtp=smtp)
