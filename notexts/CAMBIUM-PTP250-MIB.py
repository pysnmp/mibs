...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", extendedChannel=extendedChannel, sMTPServerIPAddress=sMTPServerIPAddress, notificationsGroup=notificationsGroup, installArmState=installArmState, hardwareVersion=hardwareVersion, ntp=ntp, nTPServerIp=nTPServerIp, phyStatusGroup=phyStatusGroup, bootVersion=bootVersion, ptpTraps=ptpTraps, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, nTPServerPortNumber=nTPServerPortNumber, cableLoss=cableLoss, antennaGain=antennaGain, wirelessLinkStatus=wirelessLinkStatus, phyStatus=phyStatus, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPEnabledTraps=sNMPEnabledTraps, ntpGroup=ntpGroup, tFTPServerPortNumber=tFTPServerPortNumber, nTPState=nTPState, signalStrengthRatio=signalStrengthRatio, configurationGroup=configurationGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, subnetMask=subnetMask, nTPPollInterval=nTPPollInterval, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, productName=productName, productVariant=productVariant, sMTPServerPortNumber=sMTPServerPortNumber, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sNMPTrapTable=sNMPTrapTable, sNMPCommunityString=sNMPCommunityString, aggregateDataRate=aggregateDataRate, licence=licence, dataPortStatusTrap=dataPortStatusTrap, remoteMACAddress=remoteMACAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, searchState=searchState, measuredRange=measuredRange, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, nTPLastSync=nTPLastSync, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, vlanTagging=vlanTagging, transmitDataRate=transmitDataRate, versionsGroup=versionsGroup, ptpGroups=ptpGroups, sNMPTrapTableEntry=sNMPTrapTableEntry, channelBandwidth=channelBandwidth, vectorError=vectorError, maximumTransmitPower=maximumTransmitPower, sNMPTrapIPAddress=sNMPTrapIPAddress, nTPSync=nTPSync, regionCode=regionCode, PYSNMP_MODULE_ID=cambium, ethernet=ethernet, sMTPEnabledMessages=sMTPEnabledMessages, configuredModulationMode=configuredModulationMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, remoteIPAddress=remoteIPAddress, smtp=smtp, siteName=siteName, ethernetGroup=ethernetGroup, transmitPower=transmitPower, softwareVersion=softwareVersion, ptp=ptp, fixedModMode=fixedModMode, radarDetectTrap=radarDetectTrap, alarmsGroup=alarmsGroup, ptpCompliance=ptpCompliance, cambium=cambium, sNMPCommunityOid=sNMPCommunityOid, tFTPServerIPAddress=tFTPServerIPAddress, extendedFreqMHz=extendedFreqMHz, sNMPTrapVersion=sNMPTrapVersion, snmpControlGroup=snmpControlGroup, gatewayIPAddress=gatewayIPAddress, band=band, pubStats=pubStats, dualPayload=dualPayload, ptmp=ptmp, sNMPTrapTableIndex=sNMPTrapTableIndex, pubStatsGroup=pubStatsGroup, linkStatusTrap=linkStatusTrap, channelSelection=channelSelection, linkLoss=linkLoss, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, smtpGroup=smtpGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, receiveDataRate=receiveDataRate, iPAddress=iPAddress, configuration=configuration, receivePower=receivePower, sNMPCommunityAccess=sNMPCommunityAccess, configuredRange=configuredRange, noWirelessChannelAvailable=noWirelessChannelAvailable, currentChannel=currentChannel, ptpTrapPrefix=ptpTrapPrefix, transmitModulationMode=transmitModulationMode, timeZone=timeZone, versions=versions, installArmStateTrap=installArmStateTrap, management=management, alarms=alarms, ptp250=ptp250, sNMPCommunityTable=sNMPCommunityTable, sNMPTrapCommunity=sNMPTrapCommunity, snmpControl=snmpControl, linkName=linkName, systemClock=systemClock, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sNMPCommunityTableIndex=sNMPCommunityTableIndex, dataPortStatus=dataPortStatus, masterSlaveMode=masterSlaveMode, licenceGroup=licenceGroup, receiveModulationMode=receiveModulationMode, noiseFloor=noiseFloor, managementGroup=managementGroup, radarDetectChannel=radarDetectChannel, currentFreqMHz=currentFreqMHz, sNMPTrapPortNumber=sNMPTrapPortNumber, vlanPriority=vlanPriority, vlanId=vlanId)
