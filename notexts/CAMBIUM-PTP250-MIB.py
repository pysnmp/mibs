...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", configuredRange=configuredRange, ntpGroup=ntpGroup, notificationsGroup=notificationsGroup, nTPServerPortNumber=nTPServerPortNumber, bootVersion=bootVersion, cableLoss=cableLoss, currentChannel=currentChannel, timeZone=timeZone, PYSNMP_MODULE_ID=cambium, sNMPCommunityString=sNMPCommunityString, maximumTransmitPower=maximumTransmitPower, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, antennaGain=antennaGain, subnetMask=subnetMask, installArmState=installArmState, dataPortStatus=dataPortStatus, versions=versions, transmitDataRate=transmitDataRate, softwareVersion=softwareVersion, sNMPCommunityTableIndex=sNMPCommunityTableIndex, radarDetectTrap=radarDetectTrap, configuration=configuration, configurationGroup=configurationGroup, systemClock=systemClock, sNMPTrapTableEntry=sNMPTrapTableEntry, managementGroup=managementGroup, installArmStateTrap=installArmStateTrap, linkStatusTrap=linkStatusTrap, wirelessLinkStatus=wirelessLinkStatus, sNMPCommunityTableNumber=sNMPCommunityTableNumber, ethernetGroup=ethernetGroup, pubStatsGroup=pubStatsGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, extendedChannel=extendedChannel, currentFreqMHz=currentFreqMHz, sNMPTrapIPAddress=sNMPTrapIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, gatewayIPAddress=gatewayIPAddress, ptp250=ptp250, receiveModulationMode=receiveModulationMode, cambium=cambium, nTPPollInterval=nTPPollInterval, noiseFloor=noiseFloor, sNMPCommunityTable=sNMPCommunityTable, productVariant=productVariant, management=management, linkLoss=linkLoss, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, iPAddress=iPAddress, productName=productName, nTPState=nTPState, ptpCompliance=ptpCompliance, ethernet=ethernet, radarDetectChannel=radarDetectChannel, sNMPCommunityAccess=sNMPCommunityAccess, nTPServerIp=nTPServerIp, masterSlaveMode=masterSlaveMode, nTPLastSync=nTPLastSync, ptp=ptp, ptpTrapPrefix=ptpTrapPrefix, siteName=siteName, noWirelessChannelAvailable=noWirelessChannelAvailable, phyStatus=phyStatus, channelBandwidth=channelBandwidth, sNMPTrapVersion=sNMPTrapVersion, licence=licence, sNMPEnabledTraps=sNMPEnabledTraps, configuredModulationMode=configuredModulationMode, sNMPCommunityOid=sNMPCommunityOid, receivePower=receivePower, remoteMACAddress=remoteMACAddress, channelSelection=channelSelection, aggregateDataRate=aggregateDataRate, transmitModulationMode=transmitModulationMode, snmpControl=snmpControl, transmitPower=transmitPower, pubStats=pubStats, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dualPayload=dualPayload, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, measuredRange=measuredRange, vlanTagging=vlanTagging, alarms=alarms, smtp=smtp, smtpGroup=smtpGroup, snmpControlGroup=snmpControlGroup, sNMPCommunityTableEntry=sNMPCommunityTableEntry, ptpGroups=ptpGroups, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, hardwareVersion=hardwareVersion, extendedFreqMHz=extendedFreqMHz, receiveDataRate=receiveDataRate, sNMPTrapTable=sNMPTrapTable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, band=band, tFTPServerPortNumber=tFTPServerPortNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, vectorError=vectorError, versionsGroup=versionsGroup, vlanPriority=vlanPriority, alarmsGroup=alarmsGroup, sMTPServerPortNumber=sMTPServerPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, licenceGroup=licenceGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, linkName=linkName, fixedModMode=fixedModMode, signalStrengthRatio=signalStrengthRatio, searchState=searchState, ntp=ntp, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptpTraps=ptpTraps, ptmp=ptmp, phyStatusGroup=phyStatusGroup, vlanId=vlanId, sNMPTrapCommunity=sNMPTrapCommunity, nTPSync=nTPSync, regionCode=regionCode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataPortStatusTrap=dataPortStatusTrap, remoteIPAddress=remoteIPAddress)
