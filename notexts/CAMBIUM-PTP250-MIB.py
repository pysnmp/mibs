...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPCommunityAccess=sNMPCommunityAccess, hardwareVersion=hardwareVersion, dataPortStatus=dataPortStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, phyStatusGroup=phyStatusGroup, channelBandwidth=channelBandwidth, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, licenceGroup=licenceGroup, installArmState=installArmState, gatewayIPAddress=gatewayIPAddress, vlanId=vlanId, ptpTraps=ptpTraps, linkLoss=linkLoss, sNMPTrapIPAddress=sNMPTrapIPAddress, searchState=searchState, sNMPTrapPortNumber=sNMPTrapPortNumber, productVariant=productVariant, noiseFloor=noiseFloor, ethernet=ethernet, sNMPTrapTable=sNMPTrapTable, systemClock=systemClock, remoteMACAddress=remoteMACAddress, cambium=cambium, nTPState=nTPState, ptp=ptp, sMTPServerPortNumber=sMTPServerPortNumber, linkStatusTrap=linkStatusTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, currentChannel=currentChannel, remoteIPAddress=remoteIPAddress, sNMPCommunityTable=sNMPCommunityTable, siteName=siteName, pubStatsGroup=pubStatsGroup, sNMPTrapCommunity=sNMPTrapCommunity, linkName=linkName, nTPSync=nTPSync, band=band, configuration=configuration, measuredRange=measuredRange, maximumTransmitPower=maximumTransmitPower, tFTPServerIPAddress=tFTPServerIPAddress, vectorError=vectorError, ptp250=ptp250, sNMPEnabledTraps=sNMPEnabledTraps, versions=versions, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, channelSelection=channelSelection, vlanTagging=vlanTagging, sMTPEnabledMessages=sMTPEnabledMessages, transmitDataRate=transmitDataRate, ntp=ntp, antennaGain=antennaGain, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPCommunityTableEntry=sNMPCommunityTableEntry, ptpCompliance=ptpCompliance, configuredModulationMode=configuredModulationMode, configurationGroup=configurationGroup, ptpTrapPrefix=ptpTrapPrefix, smtpGroup=smtpGroup, notificationsGroup=notificationsGroup, sNMPTrapVersion=sNMPTrapVersion, smtp=smtp, managementGroup=managementGroup, radarDetectChannel=radarDetectChannel, licence=licence, alarms=alarms, pubStats=pubStats, configuredRange=configuredRange, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receivePower=receivePower, dataPortStatusTrap=dataPortStatusTrap, regionCode=regionCode, alarmsGroup=alarmsGroup, softwareVersion=softwareVersion, wirelessLinkStatus=wirelessLinkStatus, sMTPServerIPAddress=sMTPServerIPAddress, snmpControl=snmpControl, sNMPTrapTableIndex=sNMPTrapTableIndex, dualPayload=dualPayload, extendedFreqMHz=extendedFreqMHz, bootVersion=bootVersion, phyStatus=phyStatus, ptpGroups=ptpGroups, noWirelessChannelAvailable=noWirelessChannelAvailable, nTPLastSync=nTPLastSync, nTPServerPortNumber=nTPServerPortNumber, snmpControlGroup=snmpControlGroup, currentFreqMHz=currentFreqMHz, ntpGroup=ntpGroup, PYSNMP_MODULE_ID=cambium, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, masterSlaveMode=masterSlaveMode, receiveModulationMode=receiveModulationMode, aggregateDataRate=aggregateDataRate, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sNMPTrapTableNumber=sNMPTrapTableNumber, timeZone=timeZone, installArmStateTrap=installArmStateTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPCommunityOid=sNMPCommunityOid, fixedModMode=fixedModMode, iPAddress=iPAddress, cableLoss=cableLoss, sNMPTrapTableEntry=sNMPTrapTableEntry, extendedChannel=extendedChannel, management=management, signalStrengthRatio=signalStrengthRatio, transmitModulationMode=transmitModulationMode, productName=productName, versionsGroup=versionsGroup, sNMPCommunityTableNumber=sNMPCommunityTableNumber, ptmp=ptmp, dataPortAutoNegotiation=dataPortAutoNegotiation, nTPServerIp=nTPServerIp, sNMPCommunityString=sNMPCommunityString, receiveDataRate=receiveDataRate, transmitPower=transmitPower, vlanPriority=vlanPriority, tFTPServerPortNumber=tFTPServerPortNumber, ethernetGroup=ethernetGroup, nTPPollInterval=nTPPollInterval, sMTPSourceEmailAddress=sMTPSourceEmailAddress, radarDetectTrap=radarDetectTrap, subnetMask=subnetMask)
