...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", masterSlaveMode=masterSlaveMode, linkStatusTrap=linkStatusTrap, sMTPEnabledMessages=sMTPEnabledMessages, tFTPServerIPAddress=tFTPServerIPAddress, siteName=siteName, pubStatsGroup=pubStatsGroup, dataPortStatus=dataPortStatus, ptp250=ptp250, sNMPTrapTable=sNMPTrapTable, installArmState=installArmState, licence=licence, productVariant=productVariant, sNMPTrapIPAddress=sNMPTrapIPAddress, dualPayload=dualPayload, searchState=searchState, ethernetGroup=ethernetGroup, ptpTraps=ptpTraps, signalStrengthRatio=signalStrengthRatio, wirelessLinkStatus=wirelessLinkStatus, ptpTrapPrefix=ptpTrapPrefix, ptpCompliance=ptpCompliance, cableLoss=cableLoss, phyStatusGroup=phyStatusGroup, sNMPCommunityTableEntry=sNMPCommunityTableEntry, ethernet=ethernet, sNMPCommunityTable=sNMPCommunityTable, sNMPTrapPortNumber=sNMPTrapPortNumber, pubStats=pubStats, smtp=smtp, gatewayIPAddress=gatewayIPAddress, sNMPCommunityOid=sNMPCommunityOid, nTPServerIp=nTPServerIp, band=band, bootVersion=bootVersion, nTPState=nTPState, productName=productName, vlanId=vlanId, extendedChannel=extendedChannel, dataPortStatusTrap=dataPortStatusTrap, configuredRange=configuredRange, currentFreqMHz=currentFreqMHz, sNMPEnabledTraps=sNMPEnabledTraps, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, iPAddress=iPAddress, noiseFloor=noiseFloor, sNMPCommunityTableIndex=sNMPCommunityTableIndex, linkLoss=linkLoss, configuredModulationMode=configuredModulationMode, subnetMask=subnetMask, snmpControlGroup=snmpControlGroup, aggregateDataRate=aggregateDataRate, vlanTagging=vlanTagging, alarms=alarms, sNMPCommunityString=sNMPCommunityString, receivePower=receivePower, smtpGroup=smtpGroup, ptpGroups=ptpGroups, channelBandwidth=channelBandwidth, ptmp=ptmp, transmitModulationMode=transmitModulationMode, transmitDataRate=transmitDataRate, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, maximumTransmitPower=maximumTransmitPower, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, vectorError=vectorError, sNMPTrapTableEntry=sNMPTrapTableEntry, vlanPriority=vlanPriority, receiveModulationMode=receiveModulationMode, nTPLastSync=nTPLastSync, fixedModMode=fixedModMode, alarmsGroup=alarmsGroup, managementGroup=managementGroup, versions=versions, timeZone=timeZone, cambium=cambium, currentChannel=currentChannel, sMTPServerIPAddress=sMTPServerIPAddress, ptp=ptp, nTPPollInterval=nTPPollInterval, PYSNMP_MODULE_ID=cambium, management=management, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, installArmStateTrap=installArmStateTrap, regionCode=regionCode, snmpControl=snmpControl, versionsGroup=versionsGroup, ntpGroup=ntpGroup, phyStatus=phyStatus, transmitPower=transmitPower, dataPortAutoNegotiation=dataPortAutoNegotiation, remoteMACAddress=remoteMACAddress, tFTPServerPortNumber=tFTPServerPortNumber, radarDetectTrap=radarDetectTrap, sNMPCommunityAccess=sNMPCommunityAccess, nTPSync=nTPSync, antennaGain=antennaGain, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, notificationsGroup=notificationsGroup, sNMPCommunityTableNumber=sNMPCommunityTableNumber, channelSelection=channelSelection, sNMPTrapCommunity=sNMPTrapCommunity, radarDetectChannel=radarDetectChannel, sNMPTrapVersion=sNMPTrapVersion, measuredRange=measuredRange, receiveDataRate=receiveDataRate, configuration=configuration, licenceGroup=licenceGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, remoteIPAddress=remoteIPAddress, extendedFreqMHz=extendedFreqMHz, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, nTPServerPortNumber=nTPServerPortNumber, configurationGroup=configurationGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, softwareVersion=softwareVersion, hardwareVersion=hardwareVersion, systemClock=systemClock, linkName=linkName, noWirelessChannelAvailable=noWirelessChannelAvailable, ntp=ntp)
