...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", notificationsGroup=notificationsGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, receiveDataRate=receiveDataRate, linkLoss=linkLoss, linkName=linkName, installArmState=installArmState, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitDataRate=transmitDataRate, snmpControl=snmpControl, sNMPCommunityTableIndex=sNMPCommunityTableIndex, masterSlaveMode=masterSlaveMode, sNMPTrapCommunity=sNMPTrapCommunity, configuredModulationMode=configuredModulationMode, sNMPCommunityAccess=sNMPCommunityAccess, licence=licence, licenceGroup=licenceGroup, aggregateDataRate=aggregateDataRate, ethernetGroup=ethernetGroup, ptpTrapPrefix=ptpTrapPrefix, gatewayIPAddress=gatewayIPAddress, cableLoss=cableLoss, ptpCompliance=ptpCompliance, radarDetectTrap=radarDetectTrap, transmitModulationMode=transmitModulationMode, versions=versions, band=band, configuration=configuration, dualPayload=dualPayload, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ptp250=ptp250, nTPServerIp=nTPServerIp, ptpGroups=ptpGroups, PYSNMP_MODULE_ID=cambium, remoteMACAddress=remoteMACAddress, phyStatusGroup=phyStatusGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receivePower=receivePower, searchState=searchState, nTPPollInterval=nTPPollInterval, sNMPEnabledTraps=sNMPEnabledTraps, channelSelection=channelSelection, pubStats=pubStats, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, regionCode=regionCode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPCommunityTableEntry=sNMPCommunityTableEntry, alarms=alarms, snmpControlGroup=snmpControlGroup, managementGroup=managementGroup, ethernet=ethernet, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sMTPEnabledMessages=sMTPEnabledMessages, ntpGroup=ntpGroup, vectorError=vectorError, tFTPServerIPAddress=tFTPServerIPAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, siteName=siteName, subnetMask=subnetMask, sNMPCommunityOid=sNMPCommunityOid, nTPServerPortNumber=nTPServerPortNumber, measuredRange=measuredRange, nTPLastSync=nTPLastSync, receiveModulationMode=receiveModulationMode, management=management, linkStatusTrap=linkStatusTrap, noiseFloor=noiseFloor, configurationGroup=configurationGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, installArmStateTrap=installArmStateTrap, productName=productName, cambium=cambium, extendedFreqMHz=extendedFreqMHz, wirelessLinkStatus=wirelessLinkStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, smtpGroup=smtpGroup, configuredRange=configuredRange, ntp=ntp, sNMPTrapIPAddress=sNMPTrapIPAddress, fixedModMode=fixedModMode, timeZone=timeZone, bootVersion=bootVersion, sNMPTrapTableIndex=sNMPTrapTableIndex, maximumTransmitPower=maximumTransmitPower, nTPSync=nTPSync, vlanTagging=vlanTagging, extendedChannel=extendedChannel, smtp=smtp, versionsGroup=versionsGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapVersion=sNMPTrapVersion, systemClock=systemClock, alarmsGroup=alarmsGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortStatusTrap=dataPortStatusTrap, nTPState=nTPState, ptmp=ptmp, antennaGain=antennaGain, iPAddress=iPAddress, currentChannel=currentChannel, tFTPServerPortNumber=tFTPServerPortNumber, ptp=ptp, signalStrengthRatio=signalStrengthRatio, hardwareVersion=hardwareVersion, vlanId=vlanId, radarDetectChannel=radarDetectChannel, dataPortStatus=dataPortStatus, pubStatsGroup=pubStatsGroup, vlanPriority=vlanPriority, productVariant=productVariant, sNMPCommunityTable=sNMPCommunityTable, channelBandwidth=channelBandwidth, sMTPServerPortNumber=sMTPServerPortNumber, transmitPower=transmitPower, sNMPCommunityString=sNMPCommunityString, sMTPServerIPAddress=sMTPServerIPAddress, softwareVersion=softwareVersion, sNMPTrapTable=sNMPTrapTable, ptpTraps=ptpTraps, sNMPTrapTableEntry=sNMPTrapTableEntry, remoteIPAddress=remoteIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, currentFreqMHz=currentFreqMHz, phyStatus=phyStatus)
