...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", timeZone=timeZone, nTPState=nTPState, sNMPCommunityAccess=sNMPCommunityAccess, installArmState=installArmState, searchState=searchState, sMTPEnabledMessages=sMTPEnabledMessages, nTPLastSync=nTPLastSync, aggregateDataRate=aggregateDataRate, dataPortAutoNegotiation=dataPortAutoNegotiation, ptp=ptp, radarDetectTrap=radarDetectTrap, sNMPTrapTable=sNMPTrapTable, siteName=siteName, sMTPServerIPAddress=sMTPServerIPAddress, remoteIPAddress=remoteIPAddress, gatewayIPAddress=gatewayIPAddress, currentChannel=currentChannel, alarms=alarms, installArmStateTrap=installArmStateTrap, vlanId=vlanId, sNMPCommunityTableEntry=sNMPCommunityTableEntry, tFTPServerIPAddress=tFTPServerIPAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPServerPortNumber=tFTPServerPortNumber, cambium=cambium, sNMPTrapCommunity=sNMPTrapCommunity, ntpGroup=ntpGroup, sMTPServerPortNumber=sMTPServerPortNumber, dualPayload=dualPayload, ptp250=ptp250, extendedChannel=extendedChannel, band=band, bootVersion=bootVersion, ptpGroups=ptpGroups, extendedFreqMHz=extendedFreqMHz, currentFreqMHz=currentFreqMHz, nTPServerPortNumber=nTPServerPortNumber, channelSelection=channelSelection, smtpGroup=smtpGroup, snmpControlGroup=snmpControlGroup, linkStatusTrap=linkStatusTrap, remoteMACAddress=remoteMACAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptpTraps=ptpTraps, dataPortStatus=dataPortStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, licenceGroup=licenceGroup, configuredModulationMode=configuredModulationMode, vlanTagging=vlanTagging, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptpCompliance=ptpCompliance, sNMPCommunityOid=sNMPCommunityOid, ethernetGroup=ethernetGroup, productVariant=productVariant, receiveDataRate=receiveDataRate, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapTableEntry=sNMPTrapTableEntry, pubStatsGroup=pubStatsGroup, measuredRange=measuredRange, regionCode=regionCode, phyStatus=phyStatus, pubStats=pubStats, configuredRange=configuredRange, signalStrengthRatio=signalStrengthRatio, systemClock=systemClock, configurationGroup=configurationGroup, notificationsGroup=notificationsGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPCommunityString=sNMPCommunityString, nTPPollInterval=nTPPollInterval, snmpControl=snmpControl, antennaGain=antennaGain, transmitPower=transmitPower, sNMPTrapPortNumber=sNMPTrapPortNumber, noiseFloor=noiseFloor, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, channelBandwidth=channelBandwidth, phyStatusGroup=phyStatusGroup, cableLoss=cableLoss, softwareVersion=softwareVersion, versions=versions, management=management, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, wirelessLinkStatus=wirelessLinkStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapIPAddress=sNMPTrapIPAddress, smtp=smtp, receiveModulationMode=receiveModulationMode, fixedModMode=fixedModMode, PYSNMP_MODULE_ID=cambium, ethernet=ethernet, productName=productName, sNMPCommunityTable=sNMPCommunityTable, iPAddress=iPAddress, sNMPCommunityTableIndex=sNMPCommunityTableIndex, managementGroup=managementGroup, ptmp=ptmp, versionsGroup=versionsGroup, subnetMask=subnetMask, maximumTransmitPower=maximumTransmitPower, dataPortStatusTrap=dataPortStatusTrap, sNMPCommunityTableNumber=sNMPCommunityTableNumber, nTPServerIp=nTPServerIp, masterSlaveMode=masterSlaveMode, vectorError=vectorError, sMTPSourceEmailAddress=sMTPSourceEmailAddress, receivePower=receivePower, nTPSync=nTPSync, configuration=configuration, radarDetectChannel=radarDetectChannel, linkName=linkName, linkLoss=linkLoss, alarmsGroup=alarmsGroup, licence=licence, ntp=ntp, vlanPriority=vlanPriority, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitModulationMode=transmitModulationMode, transmitDataRate=transmitDataRate, hardwareVersion=hardwareVersion, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ptpTrapPrefix=ptpTrapPrefix)
