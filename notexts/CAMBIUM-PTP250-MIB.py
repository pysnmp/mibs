...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", nTPPollInterval=nTPPollInterval, licence=licence, sNMPCommunityTable=sNMPCommunityTable, configuration=configuration, ptpTraps=ptpTraps, receivePower=receivePower, installArmState=installArmState, licenceGroup=licenceGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ntpGroup=ntpGroup, band=band, nTPServerIp=nTPServerIp, channelSelection=channelSelection, PYSNMP_MODULE_ID=cambium, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sNMPCommunityTableIndex=sNMPCommunityTableIndex, productName=productName, gatewayIPAddress=gatewayIPAddress, dataPortStatusTrap=dataPortStatusTrap, productVariant=productVariant, extendedFreqMHz=extendedFreqMHz, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, linkLoss=linkLoss, hardwareVersion=hardwareVersion, bootVersion=bootVersion, measuredRange=measuredRange, sNMPEnabledTraps=sNMPEnabledTraps, dualPayload=dualPayload, vlanTagging=vlanTagging, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptmp=ptmp, ptp=ptp, sNMPTrapCommunity=sNMPTrapCommunity, configuredRange=configuredRange, tFTPServerIPAddress=tFTPServerIPAddress, versionsGroup=versionsGroup, notificationsGroup=notificationsGroup, ethernetGroup=ethernetGroup, antennaGain=antennaGain, transmitModulationMode=transmitModulationMode, iPAddress=iPAddress, timeZone=timeZone, extendedChannel=extendedChannel, managementGroup=managementGroup, nTPLastSync=nTPLastSync, currentChannel=currentChannel, smtp=smtp, sMTPEnabledMessages=sMTPEnabledMessages, radarDetectChannel=radarDetectChannel, ptp250=ptp250, fixedModMode=fixedModMode, ptpGroups=ptpGroups, regionCode=regionCode, cableLoss=cableLoss, aggregateDataRate=aggregateDataRate, maximumTransmitPower=maximumTransmitPower, sNMPTrapTableEntry=sNMPTrapTableEntry, alarms=alarms, linkName=linkName, phyStatus=phyStatus, signalStrengthRatio=signalStrengthRatio, sNMPTrapIPAddress=sNMPTrapIPAddress, snmpControl=snmpControl, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernet=ethernet, nTPState=nTPState, systemClock=systemClock, sNMPTrapTable=sNMPTrapTable, pubStatsGroup=pubStatsGroup, noiseFloor=noiseFloor, phyStatusGroup=phyStatusGroup, vlanPriority=vlanPriority, vlanId=vlanId, ntp=ntp, vectorError=vectorError, pubStats=pubStats, channelBandwidth=channelBandwidth, smtpGroup=smtpGroup, searchState=searchState, configurationGroup=configurationGroup, sMTPServerPortNumber=sMTPServerPortNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortStatus=dataPortStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapVersion=sNMPTrapVersion, radarDetectTrap=radarDetectTrap, wirelessLinkStatus=wirelessLinkStatus, ptpCompliance=ptpCompliance, softwareVersion=softwareVersion, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sMTPServerIPAddress=sMTPServerIPAddress, snmpControlGroup=snmpControlGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPServerPortNumber=tFTPServerPortNumber, linkStatusTrap=linkStatusTrap, sNMPCommunityAccess=sNMPCommunityAccess, configuredModulationMode=configuredModulationMode, masterSlaveMode=masterSlaveMode, transmitDataRate=transmitDataRate, subnetMask=subnetMask, remoteIPAddress=remoteIPAddress, receiveModulationMode=receiveModulationMode, receiveDataRate=receiveDataRate, currentFreqMHz=currentFreqMHz, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPCommunityString=sNMPCommunityString, sNMPCommunityOid=sNMPCommunityOid, nTPServerPortNumber=nTPServerPortNumber, cambium=cambium, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, remoteMACAddress=remoteMACAddress, management=management, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, ptpTrapPrefix=ptpTrapPrefix, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, siteName=siteName, transmitPower=transmitPower, installArmStateTrap=installArmStateTrap, alarmsGroup=alarmsGroup, versions=versions, sNMPTrapTableIndex=sNMPTrapTableIndex, nTPSync=nTPSync)
