...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", pubStats=pubStats, signalStrengthRatio=signalStrengthRatio, bootVersion=bootVersion, phyStatus=phyStatus, measuredRange=measuredRange, ntp=ntp, ptpCompliance=ptpCompliance, systemClock=systemClock, dataPortStatusTrap=dataPortStatusTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, receiveModulationMode=receiveModulationMode, ptpTrapPrefix=ptpTrapPrefix, dualPayload=dualPayload, managementGroup=managementGroup, vectorError=vectorError, sMTPEnabledMessages=sMTPEnabledMessages, installArmStateTrap=installArmStateTrap, vlanId=vlanId, transmitPower=transmitPower, masterSlaveMode=masterSlaveMode, cableLoss=cableLoss, snmpControlGroup=snmpControlGroup, sNMPTrapTable=sNMPTrapTable, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortStatus=dataPortStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, snmpControl=snmpControl, configuration=configuration, smtpGroup=smtpGroup, transmitDataRate=transmitDataRate, vlanTagging=vlanTagging, sMTPSourceEmailAddress=sMTPSourceEmailAddress, nTPLastSync=nTPLastSync, currentChannel=currentChannel, sNMPCommunityOid=sNMPCommunityOid, antennaGain=antennaGain, alarmsGroup=alarmsGroup, iPAddress=iPAddress, extendedChannel=extendedChannel, sNMPTrapPortNumber=sNMPTrapPortNumber, siteName=siteName, nTPPollInterval=nTPPollInterval, sNMPTrapTableIndex=sNMPTrapTableIndex, pubStatsGroup=pubStatsGroup, receiveDataRate=receiveDataRate, extendedFreqMHz=extendedFreqMHz, noiseFloor=noiseFloor, softwareVersion=softwareVersion, gatewayIPAddress=gatewayIPAddress, productVariant=productVariant, radarDetectChannel=radarDetectChannel, sNMPCommunityString=sNMPCommunityString, PYSNMP_MODULE_ID=cambium, sMTPServerIPAddress=sMTPServerIPAddress, wirelessLinkStatus=wirelessLinkStatus, tFTPServerPortNumber=tFTPServerPortNumber, installArmState=installArmState, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, radarDetectTrap=radarDetectTrap, ntpGroup=ntpGroup, vlanPriority=vlanPriority, sNMPTrapCommunity=sNMPTrapCommunity, ethernetGroup=ethernetGroup, alarms=alarms, ptpTraps=ptpTraps, smtp=smtp, sMTPServerPortNumber=sMTPServerPortNumber, tFTPServerIPAddress=tFTPServerIPAddress, ethernet=ethernet, aggregateDataRate=aggregateDataRate, remoteMACAddress=remoteMACAddress, receivePower=receivePower, transmitModulationMode=transmitModulationMode, linkName=linkName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, regionCode=regionCode, phyStatusGroup=phyStatusGroup, licenceGroup=licenceGroup, remoteIPAddress=remoteIPAddress, ptpGroups=ptpGroups, hardwareVersion=hardwareVersion, sNMPCommunityAccess=sNMPCommunityAccess, sNMPCommunityTableNumber=sNMPCommunityTableNumber, notificationsGroup=notificationsGroup, linkLoss=linkLoss, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, channelSelection=channelSelection, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, searchState=searchState, linkStatusTrap=linkStatusTrap, fixedModMode=fixedModMode, ptmp=ptmp, currentFreqMHz=currentFreqMHz, nTPState=nTPState, maximumTransmitPower=maximumTransmitPower, ptp250=ptp250, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, ptp=ptp, nTPServerPortNumber=nTPServerPortNumber, sNMPCommunityTable=sNMPCommunityTable, channelBandwidth=channelBandwidth, productName=productName, configuredRange=configuredRange, timeZone=timeZone, nTPSync=nTPSync, band=band, licence=licence, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, cambium=cambium, nTPServerIp=nTPServerIp, configuredModulationMode=configuredModulationMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPCommunityTableIndex=sNMPCommunityTableIndex, configurationGroup=configurationGroup, subnetMask=subnetMask, management=management, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapVersion=sNMPTrapVersion, versionsGroup=versionsGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, versions=versions, sNMPCommunityTableEntry=sNMPCommunityTableEntry)
