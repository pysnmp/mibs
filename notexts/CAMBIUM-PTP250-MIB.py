...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", linkLoss=linkLoss, sNMPTrapTableEntry=sNMPTrapTableEntry, subnetMask=subnetMask, ptpCompliance=ptpCompliance, vlanTagging=vlanTagging, installArmState=installArmState, dataPortStatusTrap=dataPortStatusTrap, signalStrengthRatio=signalStrengthRatio, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, receivePower=receivePower, ptpTrapPrefix=ptpTrapPrefix, fixedModMode=fixedModMode, configuredModulationMode=configuredModulationMode, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sNMPCommunityAccess=sNMPCommunityAccess, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ntpGroup=ntpGroup, regionCode=regionCode, sNMPEnabledTraps=sNMPEnabledTraps, ptp250=ptp250, sNMPTrapIPAddress=sNMPTrapIPAddress, channelBandwidth=channelBandwidth, softwareVersion=softwareVersion, cambium=cambium, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapCommunity=sNMPTrapCommunity, tFTPServerIPAddress=tFTPServerIPAddress, antennaGain=antennaGain, cableLoss=cableLoss, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, gatewayIPAddress=gatewayIPAddress, dualPayload=dualPayload, productName=productName, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, transmitPower=transmitPower, licenceGroup=licenceGroup, remoteMACAddress=remoteMACAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPCommunityOid=sNMPCommunityOid, vlanPriority=vlanPriority, nTPLastSync=nTPLastSync, productVariant=productVariant, iPAddress=iPAddress, sNMPTrapVersion=sNMPTrapVersion, management=management, configuration=configuration, phyStatusGroup=phyStatusGroup, versions=versions, configurationGroup=configurationGroup, extendedFreqMHz=extendedFreqMHz, bootVersion=bootVersion, extendedChannel=extendedChannel, versionsGroup=versionsGroup, systemClock=systemClock, nTPServerPortNumber=nTPServerPortNumber, radarDetectChannel=radarDetectChannel, sNMPTrapPortNumber=sNMPTrapPortNumber, ptmp=ptmp, measuredRange=measuredRange, ntp=ntp, sNMPCommunityTableNumber=sNMPCommunityTableNumber, transmitModulationMode=transmitModulationMode, snmpControl=snmpControl, radarDetectTrap=radarDetectTrap, currentChannel=currentChannel, alarms=alarms, sNMPCommunityTable=sNMPCommunityTable, linkName=linkName, currentFreqMHz=currentFreqMHz, band=band, remoteIPAddress=remoteIPAddress, ptp=ptp, receiveDataRate=receiveDataRate, searchState=searchState, sNMPTrapTable=sNMPTrapTable, sNMPCommunityTableIndex=sNMPCommunityTableIndex, smtpGroup=smtpGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, transmitDataRate=transmitDataRate, nTPServerIp=nTPServerIp, aggregateDataRate=aggregateDataRate, snmpControlGroup=snmpControlGroup, ethernet=ethernet, pubStatsGroup=pubStatsGroup, nTPPollInterval=nTPPollInterval, sNMPCommunityString=sNMPCommunityString, phyStatus=phyStatus, pubStats=pubStats, ptpGroups=ptpGroups, nTPState=nTPState, sNMPTrapTableIndex=sNMPTrapTableIndex, masterSlaveMode=masterSlaveMode, alarmsGroup=alarmsGroup, managementGroup=managementGroup, sMTPServerIPAddress=sMTPServerIPAddress, licence=licence, maximumTransmitPower=maximumTransmitPower, smtp=smtp, receiveModulationMode=receiveModulationMode, hardwareVersion=hardwareVersion, tFTPServerPortNumber=tFTPServerPortNumber, configuredRange=configuredRange, channelSelection=channelSelection, dataPortAutoNegotiation=dataPortAutoNegotiation, nTPSync=nTPSync, siteName=siteName, timeZone=timeZone, dataPortStatus=dataPortStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPServerPortNumber=sMTPServerPortNumber, notificationsGroup=notificationsGroup, vlanId=vlanId, sMTPSourceEmailAddress=sMTPSourceEmailAddress, linkStatusTrap=linkStatusTrap, installArmStateTrap=installArmStateTrap, ethernetGroup=ethernetGroup, ptpTraps=ptpTraps, PYSNMP_MODULE_ID=cambium, sMTPEnabledMessages=sMTPEnabledMessages, vectorError=vectorError, wirelessLinkStatus=wirelessLinkStatus, noiseFloor=noiseFloor)
