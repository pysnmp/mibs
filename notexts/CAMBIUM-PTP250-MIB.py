...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, installArmState=installArmState, signalStrengthRatio=signalStrengthRatio, remoteIPAddress=remoteIPAddress, ptpGroups=ptpGroups, versionsGroup=versionsGroup, sNMPCommunityTableIndex=sNMPCommunityTableIndex, radarDetectTrap=radarDetectTrap, sNMPCommunityTableNumber=sNMPCommunityTableNumber, installArmStateTrap=installArmStateTrap, transmitPower=transmitPower, linkName=linkName, sMTPServerIPAddress=sMTPServerIPAddress, extendedFreqMHz=extendedFreqMHz, sMTPSourceEmailAddress=sMTPSourceEmailAddress, cableLoss=cableLoss, ptpCompliance=ptpCompliance, masterSlaveMode=masterSlaveMode, configuration=configuration, ptpTraps=ptpTraps, timeZone=timeZone, searchState=searchState, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, alarms=alarms, configuredRange=configuredRange, transmitModulationMode=transmitModulationMode, vlanId=vlanId, ethernetGroup=ethernetGroup, snmpControlGroup=snmpControlGroup, noiseFloor=noiseFloor, sNMPCommunityTableEntry=sNMPCommunityTableEntry, dataPortStatus=dataPortStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapPortNumber=sNMPTrapPortNumber, aggregateDataRate=aggregateDataRate, cambium=cambium, dataPortAutoNegotiation=dataPortAutoNegotiation, phyStatusGroup=phyStatusGroup, licence=licence, sNMPTrapTable=sNMPTrapTable, maximumTransmitPower=maximumTransmitPower, versions=versions, sNMPTrapVersion=sNMPTrapVersion, hardwareVersion=hardwareVersion, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, phyStatus=phyStatus, nTPServerIp=nTPServerIp, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, vlanTagging=vlanTagging, ethernet=ethernet, sNMPCommunityTable=sNMPCommunityTable, ntpGroup=ntpGroup, bootVersion=bootVersion, ntp=ntp, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, extendedChannel=extendedChannel, sNMPCommunityString=sNMPCommunityString, configuredModulationMode=configuredModulationMode, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, softwareVersion=softwareVersion, vlanPriority=vlanPriority, channelSelection=channelSelection, tFTPServerIPAddress=tFTPServerIPAddress, sNMPCommunityOid=sNMPCommunityOid, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPEnabledTraps=sNMPEnabledTraps, receivePower=receivePower, smtpGroup=smtpGroup, ptmp=ptmp, dualPayload=dualPayload, sNMPCommunityAccess=sNMPCommunityAccess, systemClock=systemClock, configurationGroup=configurationGroup, linkStatusTrap=linkStatusTrap, nTPLastSync=nTPLastSync, nTPSync=nTPSync, linkLoss=linkLoss, pubStatsGroup=pubStatsGroup, management=management, ptpTrapPrefix=ptpTrapPrefix, subnetMask=subnetMask, managementGroup=managementGroup, PYSNMP_MODULE_ID=cambium, nTPServerPortNumber=nTPServerPortNumber, dataPortStatusTrap=dataPortStatusTrap, alarmsGroup=alarmsGroup, productVariant=productVariant, fixedModMode=fixedModMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, noWirelessChannelAvailable=noWirelessChannelAvailable, currentChannel=currentChannel, band=band, currentFreqMHz=currentFreqMHz, productName=productName, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, siteName=siteName, nTPPollInterval=nTPPollInterval, pubStats=pubStats, transmitDataRate=transmitDataRate, gatewayIPAddress=gatewayIPAddress, remoteMACAddress=remoteMACAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, smtp=smtp, snmpControl=snmpControl, licenceGroup=licenceGroup, receiveModulationMode=receiveModulationMode, notificationsGroup=notificationsGroup, radarDetectChannel=radarDetectChannel, ptp250=ptp250, sNMPTrapCommunity=sNMPTrapCommunity, antennaGain=antennaGain, ptp=ptp, sMTPServerPortNumber=sMTPServerPortNumber, vectorError=vectorError, tFTPServerPortNumber=tFTPServerPortNumber, receiveDataRate=receiveDataRate, wirelessLinkStatus=wirelessLinkStatus, regionCode=regionCode, sMTPEnabledMessages=sMTPEnabledMessages, channelBandwidth=channelBandwidth, measuredRange=measuredRange, nTPState=nTPState, sNMPTrapTableEntry=sNMPTrapTableEntry, iPAddress=iPAddress)
