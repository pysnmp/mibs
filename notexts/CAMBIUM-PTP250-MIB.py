...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPTrapPortNumber=sNMPTrapPortNumber, ptpGroups=ptpGroups, extendedFreqMHz=extendedFreqMHz, dataPortStatusTrap=dataPortStatusTrap, sNMPTrapVersion=sNMPTrapVersion, PYSNMP_MODULE_ID=cambium, nTPPollInterval=nTPPollInterval, softwareVersion=softwareVersion, timeZone=timeZone, sMTPSourceEmailAddress=sMTPSourceEmailAddress, nTPServerIp=nTPServerIp, fixedModMode=fixedModMode, phyStatus=phyStatus, ethernetGroup=ethernetGroup, managementGroup=managementGroup, ptpCompliance=ptpCompliance, radarDetectTrap=radarDetectTrap, receiveDataRate=receiveDataRate, vectorError=vectorError, sNMPCommunityTableEntry=sNMPCommunityTableEntry, receivePower=receivePower, hardwareVersion=hardwareVersion, sNMPTrapCommunity=sNMPTrapCommunity, aggregateDataRate=aggregateDataRate, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, phyStatusGroup=phyStatusGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, installArmState=installArmState, vlanPriority=vlanPriority, sNMPEnabledTraps=sNMPEnabledTraps, extendedChannel=extendedChannel, notificationsGroup=notificationsGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, versions=versions, nTPState=nTPState, transmitPower=transmitPower, systemClock=systemClock, currentChannel=currentChannel, vlanId=vlanId, ntpGroup=ntpGroup, tFTPServerPortNumber=tFTPServerPortNumber, sNMPCommunityTableIndex=sNMPCommunityTableIndex, measuredRange=measuredRange, sNMPTrapTable=sNMPTrapTable, smtp=smtp, sNMPCommunityAccess=sNMPCommunityAccess, linkLoss=linkLoss, bootVersion=bootVersion, productName=productName, configuredModulationMode=configuredModulationMode, pubStats=pubStats, transmitModulationMode=transmitModulationMode, wirelessLinkStatus=wirelessLinkStatus, ptpTraps=ptpTraps, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dualPayload=dualPayload, siteName=siteName, masterSlaveMode=masterSlaveMode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPCommunityTable=sNMPCommunityTable, noiseFloor=noiseFloor, receiveModulationMode=receiveModulationMode, configuration=configuration, sNMPCommunityString=sNMPCommunityString, sMTPServerIPAddress=sMTPServerIPAddress, nTPSync=nTPSync, antennaGain=antennaGain, nTPServerPortNumber=nTPServerPortNumber, channelSelection=channelSelection, radarDetectChannel=radarDetectChannel, ethernet=ethernet, snmpControl=snmpControl, band=band, subnetMask=subnetMask, sNMPTrapTableEntry=sNMPTrapTableEntry, ptp=ptp, transmitDataRate=transmitDataRate, cableLoss=cableLoss, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, currentFreqMHz=currentFreqMHz, iPAddress=iPAddress, pubStatsGroup=pubStatsGroup, remoteMACAddress=remoteMACAddress, nTPLastSync=nTPLastSync, channelBandwidth=channelBandwidth, alarms=alarms, vlanTagging=vlanTagging, sNMPTrapTableIndex=sNMPTrapTableIndex, licenceGroup=licenceGroup, sMTPEnabledMessages=sMTPEnabledMessages, licence=licence, configurationGroup=configurationGroup, searchState=searchState, signalStrengthRatio=signalStrengthRatio, smtpGroup=smtpGroup, gatewayIPAddress=gatewayIPAddress, versionsGroup=versionsGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ntp=ntp, tFTPServerIPAddress=tFTPServerIPAddress, sNMPCommunityOid=sNMPCommunityOid, installArmStateTrap=installArmStateTrap, sNMPCommunityTableNumber=sNMPCommunityTableNumber, ptp250=ptp250, productVariant=productVariant, ptpTrapPrefix=ptpTrapPrefix, maximumTransmitPower=maximumTransmitPower, cambium=cambium, management=management, sMTPServerPortNumber=sMTPServerPortNumber, remoteIPAddress=remoteIPAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, configuredRange=configuredRange, alarmsGroup=alarmsGroup, ptmp=ptmp, linkStatusTrap=linkStatusTrap, snmpControlGroup=snmpControlGroup, dataPortStatus=dataPortStatus, regionCode=regionCode, sNMPTrapTableNumber=sNMPTrapTableNumber, linkName=linkName, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement)
