...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", receiveModulationMode=receiveModulationMode, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sNMPTrapTableNumber=sNMPTrapTableNumber, channelBandwidth=channelBandwidth, sNMPTrapTableIndex=sNMPTrapTableIndex, receiveDataRate=receiveDataRate, ptmp=ptmp, sMTPSourceEmailAddress=sMTPSourceEmailAddress, configuration=configuration, sNMPCommunityTableNumber=sNMPCommunityTableNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapCommunity=sNMPTrapCommunity, configuredModulationMode=configuredModulationMode, versionsGroup=versionsGroup, notificationsGroup=notificationsGroup, configuredRange=configuredRange, nTPState=nTPState, iPAddress=iPAddress, dataPortStatusTrap=dataPortStatusTrap, management=management, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, nTPLastSync=nTPLastSync, channelSelection=channelSelection, linkLoss=linkLoss, currentFreqMHz=currentFreqMHz, sNMPTrapIPAddress=sNMPTrapIPAddress, ntpGroup=ntpGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, noiseFloor=noiseFloor, extendedChannel=extendedChannel, remoteIPAddress=remoteIPAddress, snmpControl=snmpControl, phyStatus=phyStatus, hardwareVersion=hardwareVersion, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, nTPServerIp=nTPServerIp, ptpCompliance=ptpCompliance, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, configurationGroup=configurationGroup, sNMPCommunityString=sNMPCommunityString, smtpGroup=smtpGroup, vlanId=vlanId, receivePower=receivePower, ethernetGroup=ethernetGroup, currentChannel=currentChannel, ptp250=ptp250, productName=productName, nTPServerPortNumber=nTPServerPortNumber, installArmStateTrap=installArmStateTrap, tFTPServerPortNumber=tFTPServerPortNumber, radarDetectTrap=radarDetectTrap, phyStatusGroup=phyStatusGroup, regionCode=regionCode, sNMPEnabledTraps=sNMPEnabledTraps, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, gatewayIPAddress=gatewayIPAddress, radarDetectChannel=radarDetectChannel, nTPPollInterval=nTPPollInterval, transmitPower=transmitPower, ptpTraps=ptpTraps, sNMPTrapTableEntry=sNMPTrapTableEntry, nTPSync=nTPSync, transmitDataRate=transmitDataRate, productVariant=productVariant, alarmsGroup=alarmsGroup, PYSNMP_MODULE_ID=cambium, dualPayload=dualPayload, transmitModulationMode=transmitModulationMode, versions=versions, vectorError=vectorError, noWirelessChannelAvailable=noWirelessChannelAvailable, alarms=alarms, cambium=cambium, timeZone=timeZone, searchState=searchState, sMTPEnabledMessages=sMTPEnabledMessages, linkName=linkName, ptpGroups=ptpGroups, sNMPCommunityOid=sNMPCommunityOid, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, aggregateDataRate=aggregateDataRate, masterSlaveMode=masterSlaveMode, smtp=smtp, sNMPTrapVersion=sNMPTrapVersion, installArmState=installArmState, sNMPCommunityTable=sNMPCommunityTable, ethernet=ethernet, antennaGain=antennaGain, sNMPCommunityTableEntry=sNMPCommunityTableEntry, ptpTrapPrefix=ptpTrapPrefix, sMTPServerIPAddress=sMTPServerIPAddress, systemClock=systemClock, measuredRange=measuredRange, siteName=siteName, snmpControlGroup=snmpControlGroup, subnetMask=subnetMask, ntp=ntp, linkStatusTrap=linkStatusTrap, bootVersion=bootVersion, signalStrengthRatio=signalStrengthRatio, licenceGroup=licenceGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, managementGroup=managementGroup, vlanTagging=vlanTagging, remoteMACAddress=remoteMACAddress, fixedModMode=fixedModMode, tFTPServerIPAddress=tFTPServerIPAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortStatus=dataPortStatus, ptp=ptp, cableLoss=cableLoss, band=band, extendedFreqMHz=extendedFreqMHz, licence=licence, softwareVersion=softwareVersion, sNMPTrapPortNumber=sNMPTrapPortNumber, wirelessLinkStatus=wirelessLinkStatus, pubStats=pubStats, sNMPTrapTable=sNMPTrapTable, pubStatsGroup=pubStatsGroup, sNMPCommunityAccess=sNMPCommunityAccess, vlanPriority=vlanPriority, maximumTransmitPower=maximumTransmitPower, sMTPServerPortNumber=sMTPServerPortNumber)
