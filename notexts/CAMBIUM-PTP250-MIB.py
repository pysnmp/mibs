...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", cableLoss=cableLoss, sNMPCommunityTable=sNMPCommunityTable, sNMPTrapCommunity=sNMPTrapCommunity, nTPState=nTPState, phyStatusGroup=phyStatusGroup, sNMPCommunityOid=sNMPCommunityOid, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, measuredRange=measuredRange, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPCommunityTableNumber=sNMPCommunityTableNumber, ptpCompliance=ptpCompliance, installArmState=installArmState, tFTPServerPortNumber=tFTPServerPortNumber, transmitDataRate=transmitDataRate, regionCode=regionCode, ptpGroups=ptpGroups, nTPLastSync=nTPLastSync, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sNMPTrapIPAddress=sNMPTrapIPAddress, licenceGroup=licenceGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, searchState=searchState, systemClock=systemClock, ptp=ptp, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, iPAddress=iPAddress, sMTPServerPortNumber=sMTPServerPortNumber, channelSelection=channelSelection, hardwareVersion=hardwareVersion, ptmp=ptmp, notificationsGroup=notificationsGroup, vlanId=vlanId, transmitPower=transmitPower, dataPortStatusTrap=dataPortStatusTrap, masterSlaveMode=masterSlaveMode, maximumTransmitPower=maximumTransmitPower, nTPPollInterval=nTPPollInterval, sNMPTrapTable=sNMPTrapTable, remoteIPAddress=remoteIPAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, linkStatusTrap=linkStatusTrap, smtp=smtp, receivePower=receivePower, ethernetGroup=ethernetGroup, configuration=configuration, ptpTrapPrefix=ptpTrapPrefix, PYSNMP_MODULE_ID=cambium, timeZone=timeZone, sNMPTrapPortNumber=sNMPTrapPortNumber, vlanTagging=vlanTagging, nTPServerPortNumber=nTPServerPortNumber, radarDetectChannel=radarDetectChannel, bootVersion=bootVersion, sNMPCommunityString=sNMPCommunityString, configuredModulationMode=configuredModulationMode, antennaGain=antennaGain, sNMPTrapTableIndex=sNMPTrapTableIndex, subnetMask=subnetMask, remoteMACAddress=remoteMACAddress, wirelessLinkStatus=wirelessLinkStatus, configurationGroup=configurationGroup, channelBandwidth=channelBandwidth, nTPServerIp=nTPServerIp, signalStrengthRatio=signalStrengthRatio, transmitModulationMode=transmitModulationMode, ptp250=ptp250, dataPortStatus=dataPortStatus, configuredRange=configuredRange, softwareVersion=softwareVersion, sNMPTrapVersion=sNMPTrapVersion, ethernet=ethernet, snmpControl=snmpControl, band=band, aggregateDataRate=aggregateDataRate, phyStatus=phyStatus, pubStatsGroup=pubStatsGroup, installArmStateTrap=installArmStateTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPCommunityAccess=sNMPCommunityAccess, linkLoss=linkLoss, management=management, sMTPSourceEmailAddress=sMTPSourceEmailAddress, managementGroup=managementGroup, linkName=linkName, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, extendedChannel=extendedChannel, sMTPServerIPAddress=sMTPServerIPAddress, alarms=alarms, nTPSync=nTPSync, alarmsGroup=alarmsGroup, dualPayload=dualPayload, productName=productName, radarDetectTrap=radarDetectTrap, receiveModulationMode=receiveModulationMode, sMTPEnabledMessages=sMTPEnabledMessages, ntp=ntp, sNMPTrapTableNumber=sNMPTrapTableNumber, receiveDataRate=receiveDataRate, versions=versions, tFTPServerIPAddress=tFTPServerIPAddress, gatewayIPAddress=gatewayIPAddress, smtpGroup=smtpGroup, licence=licence, currentFreqMHz=currentFreqMHz, snmpControlGroup=snmpControlGroup, fixedModMode=fixedModMode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ntpGroup=ntpGroup, sNMPCommunityTableIndex=sNMPCommunityTableIndex, noiseFloor=noiseFloor, vlanPriority=vlanPriority, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, productVariant=productVariant, extendedFreqMHz=extendedFreqMHz, pubStats=pubStats, vectorError=vectorError, versionsGroup=versionsGroup, ptpTraps=ptpTraps, siteName=siteName, currentChannel=currentChannel, sNMPEnabledTraps=sNMPEnabledTraps, cambium=cambium)
