...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, nTPLastSync=nTPLastSync, vlanTagging=vlanTagging, vectorError=vectorError, notificationsGroup=notificationsGroup, cableLoss=cableLoss, sNMPCommunityString=sNMPCommunityString, nTPState=nTPState, systemClock=systemClock, nTPSync=nTPSync, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPTrapVersion=sNMPTrapVersion, antennaGain=antennaGain, management=management, transmitPower=transmitPower, currentFreqMHz=currentFreqMHz, ptpCompliance=ptpCompliance, sNMPTrapIPAddress=sNMPTrapIPAddress, ptpTrapPrefix=ptpTrapPrefix, snmpControlGroup=snmpControlGroup, ethernetGroup=ethernetGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPCommunityOid=sNMPCommunityOid, smtp=smtp, tFTPServerIPAddress=tFTPServerIPAddress, ptpGroups=ptpGroups, tFTPServerPortNumber=tFTPServerPortNumber, linkLoss=linkLoss, iPAddress=iPAddress, radarDetectTrap=radarDetectTrap, sNMPCommunityTableNumber=sNMPCommunityTableNumber, masterSlaveMode=masterSlaveMode, siteName=siteName, bootVersion=bootVersion, aggregateDataRate=aggregateDataRate, managementGroup=managementGroup, hardwareVersion=hardwareVersion, sNMPTrapCommunity=sNMPTrapCommunity, vlanId=vlanId, searchState=searchState, wirelessLinkStatus=wirelessLinkStatus, phyStatusGroup=phyStatusGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPCommunityAccess=sNMPCommunityAccess, ptp250=ptp250, nTPServerPortNumber=nTPServerPortNumber, alarmsGroup=alarmsGroup, signalStrengthRatio=signalStrengthRatio, productVariant=productVariant, sNMPTrapTable=sNMPTrapTable, currentChannel=currentChannel, snmpControl=snmpControl, configuration=configuration, installArmState=installArmState, dualPayload=dualPayload, nTPPollInterval=nTPPollInterval, ntp=ntp, productName=productName, transmitModulationMode=transmitModulationMode, versions=versions, linkName=linkName, maximumTransmitPower=maximumTransmitPower, noWirelessChannelAvailable=noWirelessChannelAvailable, configuredModulationMode=configuredModulationMode, gatewayIPAddress=gatewayIPAddress, PYSNMP_MODULE_ID=cambium, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernet=ethernet, sNMPTrapTableIndex=sNMPTrapTableIndex, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPEnabledTraps=sNMPEnabledTraps, sMTPServerPortNumber=sMTPServerPortNumber, ptpTraps=ptpTraps, fixedModMode=fixedModMode, sNMPCommunityTableIndex=sNMPCommunityTableIndex, cambium=cambium, versionsGroup=versionsGroup, extendedFreqMHz=extendedFreqMHz, timeZone=timeZone, sNMPTrapTableNumber=sNMPTrapTableNumber, channelBandwidth=channelBandwidth, nTPServerIp=nTPServerIp, dataPortStatus=dataPortStatus, smtpGroup=smtpGroup, phyStatus=phyStatus, sNMPCommunityTableEntry=sNMPCommunityTableEntry, receiveModulationMode=receiveModulationMode, alarms=alarms, sNMPCommunityTable=sNMPCommunityTable, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, transmitDataRate=transmitDataRate, pubStatsGroup=pubStatsGroup, ptmp=ptmp, radarDetectChannel=radarDetectChannel, softwareVersion=softwareVersion, measuredRange=measuredRange, installArmStateTrap=installArmStateTrap, channelSelection=channelSelection, ptp=ptp, band=band, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, extendedChannel=extendedChannel, licenceGroup=licenceGroup, ntpGroup=ntpGroup, sMTPServerIPAddress=sMTPServerIPAddress, remoteIPAddress=remoteIPAddress, subnetMask=subnetMask, configurationGroup=configurationGroup, configuredRange=configuredRange, sMTPEnabledMessages=sMTPEnabledMessages, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, pubStats=pubStats, remoteMACAddress=remoteMACAddress, regionCode=regionCode, vlanPriority=vlanPriority, dataPortStatusTrap=dataPortStatusTrap, linkStatusTrap=linkStatusTrap, receiveDataRate=receiveDataRate, licence=licence, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapPortNumber=sNMPTrapPortNumber, noiseFloor=noiseFloor, receivePower=receivePower)
