...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", maximumTransmitPower=maximumTransmitPower, sNMPTrapVersion=sNMPTrapVersion, noiseFloor=noiseFloor, signalStrengthRatio=signalStrengthRatio, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPEnabledTraps=sNMPEnabledTraps, receiveDataRate=receiveDataRate, sNMPCommunityAccess=sNMPCommunityAccess, installArmStateTrap=installArmStateTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapPortNumber=sNMPTrapPortNumber, vlanTagging=vlanTagging, ethernetGroup=ethernetGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, smtpGroup=smtpGroup, iPAddress=iPAddress, management=management, wirelessLinkStatus=wirelessLinkStatus, ntp=ntp, phyStatus=phyStatus, notificationsGroup=notificationsGroup, sMTPEnabledMessages=sMTPEnabledMessages, nTPState=nTPState, remoteMACAddress=remoteMACAddress, softwareVersion=softwareVersion, PYSNMP_MODULE_ID=cambium, versionsGroup=versionsGroup, versions=versions, smtp=smtp, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPServerIPAddress=tFTPServerIPAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPServerPortNumber=tFTPServerPortNumber, sNMPCommunityTable=sNMPCommunityTable, extendedChannel=extendedChannel, nTPServerPortNumber=nTPServerPortNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, alarmsGroup=alarmsGroup, pubStats=pubStats, dualPayload=dualPayload, transmitPower=transmitPower, measuredRange=measuredRange, sMTPServerIPAddress=sMTPServerIPAddress, licenceGroup=licenceGroup, transmitModulationMode=transmitModulationMode, vectorError=vectorError, band=band, radarDetectTrap=radarDetectTrap, configuredModulationMode=configuredModulationMode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, searchState=searchState, sNMPCommunityOid=sNMPCommunityOid, nTPPollInterval=nTPPollInterval, aggregateDataRate=aggregateDataRate, configuration=configuration, extendedFreqMHz=extendedFreqMHz, sNMPCommunityString=sNMPCommunityString, dataPortStatusTrap=dataPortStatusTrap, alarms=alarms, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptp=ptp, ptpTrapPrefix=ptpTrapPrefix, radarDetectChannel=radarDetectChannel, nTPServerIp=nTPServerIp, remoteIPAddress=remoteIPAddress, hardwareVersion=hardwareVersion, linkLoss=linkLoss, nTPSync=nTPSync, installArmState=installArmState, sNMPTrapTableIndex=sNMPTrapTableIndex, receivePower=receivePower, antennaGain=antennaGain, linkName=linkName, sMTPServerPortNumber=sMTPServerPortNumber, sNMPCommunityTableEntry=sNMPCommunityTableEntry, productName=productName, phyStatusGroup=phyStatusGroup, vlanPriority=vlanPriority, ethernet=ethernet, linkStatusTrap=linkStatusTrap, sNMPTrapTable=sNMPTrapTable, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vlanId=vlanId, snmpControl=snmpControl, snmpControlGroup=snmpControlGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, managementGroup=managementGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, currentChannel=currentChannel, sNMPCommunityTableIndex=sNMPCommunityTableIndex, configurationGroup=configurationGroup, ptp250=ptp250, ptpCompliance=ptpCompliance, ptmp=ptmp, licence=licence, productVariant=productVariant, siteName=siteName, cambium=cambium, channelSelection=channelSelection, sNMPTrapIPAddress=sNMPTrapIPAddress, transmitDataRate=transmitDataRate, subnetMask=subnetMask, channelBandwidth=channelBandwidth, systemClock=systemClock, pubStatsGroup=pubStatsGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, regionCode=regionCode, ptpGroups=ptpGroups, ptpTraps=ptpTraps, ntpGroup=ntpGroup, cableLoss=cableLoss, configuredRange=configuredRange, receiveModulationMode=receiveModulationMode, masterSlaveMode=masterSlaveMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, currentFreqMHz=currentFreqMHz, sNMPTrapCommunity=sNMPTrapCommunity, dataPortStatus=dataPortStatus, bootVersion=bootVersion, gatewayIPAddress=gatewayIPAddress, fixedModMode=fixedModMode, nTPLastSync=nTPLastSync, sNMPCommunityTableNumber=sNMPCommunityTableNumber, timeZone=timeZone)
