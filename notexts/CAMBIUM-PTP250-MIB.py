...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", ptpTraps=ptpTraps, sMTPServerPortNumber=sMTPServerPortNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortAutoNegotiation=dataPortAutoNegotiation, vectorError=vectorError, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, configuredModulationMode=configuredModulationMode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, regionCode=regionCode, nTPServerPortNumber=nTPServerPortNumber, signalStrengthRatio=signalStrengthRatio, sNMPTrapPortNumber=sNMPTrapPortNumber, ptpCompliance=ptpCompliance, transmitDataRate=transmitDataRate, dataPortStatusTrap=dataPortStatusTrap, nTPLastSync=nTPLastSync, dataPortStatus=dataPortStatus, timeZone=timeZone, antennaGain=antennaGain, ptpTrapPrefix=ptpTrapPrefix, configurationGroup=configurationGroup, vlanPriority=vlanPriority, sNMPTrapCommunity=sNMPTrapCommunity, productVariant=productVariant, radarDetectChannel=radarDetectChannel, productName=productName, receiveModulationMode=receiveModulationMode, sNMPCommunityTableEntry=sNMPCommunityTableEntry, fixedModMode=fixedModMode, receivePower=receivePower, sNMPTrapVersion=sNMPTrapVersion, cableLoss=cableLoss, aggregateDataRate=aggregateDataRate, extendedChannel=extendedChannel, sNMPTrapIPAddress=sNMPTrapIPAddress, nTPPollInterval=nTPPollInterval, transmitModulationMode=transmitModulationMode, sNMPCommunityAccess=sNMPCommunityAccess, linkName=linkName, smtp=smtp, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptp250=ptp250, pubStatsGroup=pubStatsGroup, channelSelection=channelSelection, ethernet=ethernet, channelBandwidth=channelBandwidth, wirelessLinkStatus=wirelessLinkStatus, measuredRange=measuredRange, installArmState=installArmState, searchState=searchState, ptmp=ptmp, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, masterSlaveMode=masterSlaveMode, sNMPTrapTableIndex=sNMPTrapTableIndex, smtpGroup=smtpGroup, nTPSync=nTPSync, vlanTagging=vlanTagging, sNMPCommunityString=sNMPCommunityString, phyStatus=phyStatus, vlanId=vlanId, managementGroup=managementGroup, snmpControlGroup=snmpControlGroup, subnetMask=subnetMask, gatewayIPAddress=gatewayIPAddress, remoteIPAddress=remoteIPAddress, sNMPCommunityTableNumber=sNMPCommunityTableNumber, installArmStateTrap=installArmStateTrap, ethernetGroup=ethernetGroup, sNMPTrapTable=sNMPTrapTable, band=band, linkStatusTrap=linkStatusTrap, pubStats=pubStats, PYSNMP_MODULE_ID=cambium, remoteMACAddress=remoteMACAddress, versions=versions, transmitPower=transmitPower, radarDetectTrap=radarDetectTrap, sMTPServerIPAddress=sMTPServerIPAddress, sNMPEnabledTraps=sNMPEnabledTraps, sMTPEnabledMessages=sMTPEnabledMessages, hardwareVersion=hardwareVersion, alarmsGroup=alarmsGroup, extendedFreqMHz=extendedFreqMHz, iPAddress=iPAddress, ntpGroup=ntpGroup, configuredRange=configuredRange, sNMPCommunityTableIndex=sNMPCommunityTableIndex, systemClock=systemClock, receiveDataRate=receiveDataRate, maximumTransmitPower=maximumTransmitPower, linkLoss=linkLoss, nTPServerIp=nTPServerIp, phyStatusGroup=phyStatusGroup, sNMPCommunityTable=sNMPCommunityTable, sNMPCommunityOid=sNMPCommunityOid, dualPayload=dualPayload, noWirelessChannelAvailable=noWirelessChannelAvailable, siteName=siteName, ptpGroups=ptpGroups, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, snmpControl=snmpControl, configuration=configuration, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, management=management, ptp=ptp, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, licenceGroup=licenceGroup, currentChannel=currentChannel, alarms=alarms, noiseFloor=noiseFloor, notificationsGroup=notificationsGroup, tFTPServerPortNumber=tFTPServerPortNumber, nTPState=nTPState, currentFreqMHz=currentFreqMHz, softwareVersion=softwareVersion, bootVersion=bootVersion, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, versionsGroup=versionsGroup, licence=licence, sNMPTrapTableNumber=sNMPTrapTableNumber, ntp=ntp, cambium=cambium)
