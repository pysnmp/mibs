...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, extendedChannel=extendedChannel, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, maximumTransmitPower=maximumTransmitPower, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPCommunityTableIndex=sNMPCommunityTableIndex, managementGroup=managementGroup, vlanPriority=vlanPriority, ptpGroups=ptpGroups, dataPortStatusTrap=dataPortStatusTrap, alarmsGroup=alarmsGroup, vlanTagging=vlanTagging, productName=productName, vectorError=vectorError, receiveModulationMode=receiveModulationMode, nTPLastSync=nTPLastSync, transmitPower=transmitPower, radarDetectTrap=radarDetectTrap, aggregateDataRate=aggregateDataRate, currentChannel=currentChannel, sMTPSourceEmailAddress=sMTPSourceEmailAddress, phyStatusGroup=phyStatusGroup, nTPServerPortNumber=nTPServerPortNumber, sNMPCommunityTableEntry=sNMPCommunityTableEntry, phyStatus=phyStatus, timeZone=timeZone, dataPortAutoNegotiation=dataPortAutoNegotiation, alarms=alarms, currentFreqMHz=currentFreqMHz, sNMPCommunityString=sNMPCommunityString, pubStatsGroup=pubStatsGroup, transmitModulationMode=transmitModulationMode, nTPPollInterval=nTPPollInterval, management=management, configuredModulationMode=configuredModulationMode, versions=versions, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sNMPCommunityTable=sNMPCommunityTable, remoteIPAddress=remoteIPAddress, extendedFreqMHz=extendedFreqMHz, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, nTPState=nTPState, channelBandwidth=channelBandwidth, nTPServerIp=nTPServerIp, band=band, sNMPTrapPortNumber=sNMPTrapPortNumber, linkStatusTrap=linkStatusTrap, receivePower=receivePower, searchState=searchState, hardwareVersion=hardwareVersion, vlanId=vlanId, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPEnabledTraps=sNMPEnabledTraps, configuredRange=configuredRange, ntp=ntp, licenceGroup=licenceGroup, softwareVersion=softwareVersion, ptp250=ptp250, sMTPServerPortNumber=sMTPServerPortNumber, channelSelection=channelSelection, sNMPCommunityOid=sNMPCommunityOid, fixedModMode=fixedModMode, licence=licence, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortStatus=dataPortStatus, noiseFloor=noiseFloor, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapVersion=sNMPTrapVersion, ptp=ptp, pubStats=pubStats, sNMPCommunityAccess=sNMPCommunityAccess, ntpGroup=ntpGroup, sNMPTrapCommunity=sNMPTrapCommunity, ethernetGroup=ethernetGroup, configurationGroup=configurationGroup, linkName=linkName, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapTableIndex=sNMPTrapTableIndex, dualPayload=dualPayload, sMTPServerIPAddress=sMTPServerIPAddress, nTPSync=nTPSync, remoteMACAddress=remoteMACAddress, radarDetectChannel=radarDetectChannel, notificationsGroup=notificationsGroup, linkLoss=linkLoss, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, PYSNMP_MODULE_ID=cambium, smtp=smtp, productVariant=productVariant, regionCode=regionCode, antennaGain=antennaGain, ethernet=ethernet, snmpControlGroup=snmpControlGroup, systemClock=systemClock, sNMPTrapTable=sNMPTrapTable, signalStrengthRatio=signalStrengthRatio, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, receiveDataRate=receiveDataRate, smtpGroup=smtpGroup, measuredRange=measuredRange, noWirelessChannelAvailable=noWirelessChannelAvailable, snmpControl=snmpControl, siteName=siteName, versionsGroup=versionsGroup, configuration=configuration, subnetMask=subnetMask, wirelessLinkStatus=wirelessLinkStatus, ptpTraps=ptpTraps, ptmp=ptmp, installArmState=installArmState, tFTPServerPortNumber=tFTPServerPortNumber, masterSlaveMode=masterSlaveMode, transmitDataRate=transmitDataRate, bootVersion=bootVersion, cambium=cambium, cableLoss=cableLoss, iPAddress=iPAddress, gatewayIPAddress=gatewayIPAddress, installArmStateTrap=installArmStateTrap, ptpCompliance=ptpCompliance)
