...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sMTPServerPortNumber=sMTPServerPortNumber, radarDetectTrap=radarDetectTrap, licence=licence, sNMPCommunityTable=sNMPCommunityTable, versions=versions, extendedFreqMHz=extendedFreqMHz, tFTPServerPortNumber=tFTPServerPortNumber, bootVersion=bootVersion, notificationsGroup=notificationsGroup, fixedModMode=fixedModMode, timeZone=timeZone, sNMPEnabledTraps=sNMPEnabledTraps, aggregateDataRate=aggregateDataRate, tFTPServerIPAddress=tFTPServerIPAddress, sNMPCommunityTableNumber=sNMPCommunityTableNumber, regionCode=regionCode, measuredRange=measuredRange, vlanPriority=vlanPriority, currentFreqMHz=currentFreqMHz, phyStatus=phyStatus, nTPLastSync=nTPLastSync, dataPortStatus=dataPortStatus, installArmStateTrap=installArmStateTrap, subnetMask=subnetMask, nTPServerIp=nTPServerIp, remoteMACAddress=remoteMACAddress, transmitDataRate=transmitDataRate, linkStatusTrap=linkStatusTrap, linkName=linkName, ethernet=ethernet, iPAddress=iPAddress, linkLoss=linkLoss, sNMPTrapTable=sNMPTrapTable, gatewayIPAddress=gatewayIPAddress, nTPPollInterval=nTPPollInterval, ntp=ntp, ptpTraps=ptpTraps, phyStatusGroup=phyStatusGroup, transmitModulationMode=transmitModulationMode, signalStrengthRatio=signalStrengthRatio, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapTableNumber=sNMPTrapTableNumber, remoteIPAddress=remoteIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, dualPayload=dualPayload, managementGroup=managementGroup, smtp=smtp, sNMPTrapTableIndex=sNMPTrapTableIndex, vlanId=vlanId, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, versionsGroup=versionsGroup, ethernetGroup=ethernetGroup, masterSlaveMode=masterSlaveMode, sNMPTrapPortNumber=sNMPTrapPortNumber, vectorError=vectorError, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, radarDetectChannel=radarDetectChannel, antennaGain=antennaGain, receiveModulationMode=receiveModulationMode, configuration=configuration, ptpCompliance=ptpCompliance, configurationGroup=configurationGroup, siteName=siteName, dataPortStatusTrap=dataPortStatusTrap, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapCommunity=sNMPTrapCommunity, wirelessLinkStatus=wirelessLinkStatus, sMTPServerIPAddress=sMTPServerIPAddress, receiveDataRate=receiveDataRate, sMTPSourceEmailAddress=sMTPSourceEmailAddress, pubStats=pubStats, band=band, smtpGroup=smtpGroup, cambium=cambium, ntpGroup=ntpGroup, productName=productName, PYSNMP_MODULE_ID=cambium, snmpControl=snmpControl, currentChannel=currentChannel, sNMPTrapTableEntry=sNMPTrapTableEntry, management=management, installArmState=installArmState, systemClock=systemClock, receivePower=receivePower, ptp=ptp, channelSelection=channelSelection, nTPState=nTPState, alarms=alarms, productVariant=productVariant, maximumTransmitPower=maximumTransmitPower, sNMPCommunityTableIndex=sNMPCommunityTableIndex, ptpTrapPrefix=ptpTrapPrefix, ptp250=ptp250, noiseFloor=noiseFloor, configuredRange=configuredRange, dataPortAutoNegotiation=dataPortAutoNegotiation, vlanTagging=vlanTagging, nTPSync=nTPSync, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, licenceGroup=licenceGroup, softwareVersion=softwareVersion, sNMPCommunityAccess=sNMPCommunityAccess, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, alarmsGroup=alarmsGroup, channelBandwidth=channelBandwidth, sNMPCommunityString=sNMPCommunityString, sNMPCommunityOid=sNMPCommunityOid, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, searchState=searchState, transmitPower=transmitPower, noWirelessChannelAvailable=noWirelessChannelAvailable, ptpGroups=ptpGroups, nTPServerPortNumber=nTPServerPortNumber, ptmp=ptmp, hardwareVersion=hardwareVersion, pubStatsGroup=pubStatsGroup, extendedChannel=extendedChannel, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, cableLoss=cableLoss, snmpControlGroup=snmpControlGroup, sNMPCommunityTableEntry=sNMPCommunityTableEntry, configuredModulationMode=configuredModulationMode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapVersion=sNMPTrapVersion)
