...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", aggregateDataRate=aggregateDataRate, dataPortAutoNegotiation=dataPortAutoNegotiation, PYSNMP_MODULE_ID=cambium, sNMPTrapTable=sNMPTrapTable, transmitModulationMode=transmitModulationMode, ptpCompliance=ptpCompliance, snmpControl=snmpControl, nTPState=nTPState, nTPServerPortNumber=nTPServerPortNumber, dataPortStatusTrap=dataPortStatusTrap, vlanPriority=vlanPriority, searchState=searchState, phyStatus=phyStatus, ptp250=ptp250, softwareVersion=softwareVersion, configuration=configuration, band=band, ptp=ptp, ptpGroups=ptpGroups, pubStatsGroup=pubStatsGroup, linkStatusTrap=linkStatusTrap, sNMPEnabledTraps=sNMPEnabledTraps, notificationsGroup=notificationsGroup, channelBandwidth=channelBandwidth, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, alarmsGroup=alarmsGroup, sNMPCommunityString=sNMPCommunityString, productVariant=productVariant, ptmp=ptmp, sNMPTrapTableNumber=sNMPTrapTableNumber, signalStrengthRatio=signalStrengthRatio, cambium=cambium, fixedModMode=fixedModMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ntp=ntp, sMTPSourceEmailAddress=sMTPSourceEmailAddress, management=management, bootVersion=bootVersion, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapTableIndex=sNMPTrapTableIndex, linkLoss=linkLoss, nTPSync=nTPSync, receiveDataRate=receiveDataRate, masterSlaveMode=masterSlaveMode, subnetMask=subnetMask, sMTPServerPortNumber=sMTPServerPortNumber, vlanId=vlanId, nTPLastSync=nTPLastSync, versionsGroup=versionsGroup, managementGroup=managementGroup, sMTPServerIPAddress=sMTPServerIPAddress, alarms=alarms, cableLoss=cableLoss, gatewayIPAddress=gatewayIPAddress, tFTPServerIPAddress=tFTPServerIPAddress, sMTPEnabledMessages=sMTPEnabledMessages, dualPayload=dualPayload, linkName=linkName, systemClock=systemClock, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitPower=transmitPower, snmpControlGroup=snmpControlGroup, vlanTagging=vlanTagging, ntpGroup=ntpGroup, configurationGroup=configurationGroup, channelSelection=channelSelection, receiveModulationMode=receiveModulationMode, configuredRange=configuredRange, receivePower=receivePower, timeZone=timeZone, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vectorError=vectorError, sNMPCommunityTableNumber=sNMPCommunityTableNumber, installArmStateTrap=installArmStateTrap, iPAddress=iPAddress, smtpGroup=smtpGroup, wirelessLinkStatus=wirelessLinkStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, licenceGroup=licenceGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, noiseFloor=noiseFloor, radarDetectChannel=radarDetectChannel, configuredModulationMode=configuredModulationMode, sNMPTrapVersion=sNMPTrapVersion, remoteMACAddress=remoteMACAddress, installArmState=installArmState, sNMPCommunityTableEntry=sNMPCommunityTableEntry, regionCode=regionCode, sNMPCommunityTableIndex=sNMPCommunityTableIndex, hardwareVersion=hardwareVersion, currentFreqMHz=currentFreqMHz, pubStats=pubStats, nTPPollInterval=nTPPollInterval, maximumTransmitPower=maximumTransmitPower, licence=licence, siteName=siteName, ethernet=ethernet, dataPortStatus=dataPortStatus, ptpTraps=ptpTraps, productName=productName, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, currentChannel=currentChannel, sNMPTrapTableEntry=sNMPTrapTableEntry, antennaGain=antennaGain, sNMPCommunityTable=sNMPCommunityTable, ethernetGroup=ethernetGroup, smtp=smtp, extendedChannel=extendedChannel, sNMPTrapCommunity=sNMPTrapCommunity, noWirelessChannelAvailable=noWirelessChannelAvailable, radarDetectTrap=radarDetectTrap, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, remoteIPAddress=remoteIPAddress, sNMPCommunityAccess=sNMPCommunityAccess, nTPServerIp=nTPServerIp, transmitDataRate=transmitDataRate, extendedFreqMHz=extendedFreqMHz, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPCommunityOid=sNMPCommunityOid, measuredRange=measuredRange, phyStatusGroup=phyStatusGroup, versions=versions, sNMPTrapPortNumber=sNMPTrapPortNumber)
