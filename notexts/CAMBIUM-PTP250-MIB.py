...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPTrapIPAddress=sNMPTrapIPAddress, systemClock=systemClock, subnetMask=subnetMask, tFTPServerPortNumber=tFTPServerPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, ethernetGroup=ethernetGroup, nTPServerPortNumber=nTPServerPortNumber, notificationsGroup=notificationsGroup, ptpCompliance=ptpCompliance, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, cableLoss=cableLoss, phyStatus=phyStatus, snmpControlGroup=snmpControlGroup, transmitPower=transmitPower, ntp=ntp, sNMPTrapTableNumber=sNMPTrapTableNumber, linkName=linkName, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, installArmState=installArmState, nTPLastSync=nTPLastSync, managementGroup=managementGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, extendedFreqMHz=extendedFreqMHz, sNMPCommunityString=sNMPCommunityString, ptpGroups=ptpGroups, ptp250=ptp250, vlanId=vlanId, sNMPTrapTableIndex=sNMPTrapTableIndex, wirelessLinkStatus=wirelessLinkStatus, pubStats=pubStats, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, masterSlaveMode=masterSlaveMode, phyStatusGroup=phyStatusGroup, sNMPTrapCommunity=sNMPTrapCommunity, linkStatusTrap=linkStatusTrap, PYSNMP_MODULE_ID=cambium, radarDetectTrap=radarDetectTrap, cambium=cambium, currentChannel=currentChannel, alarmsGroup=alarmsGroup, licence=licence, receiveModulationMode=receiveModulationMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, remoteMACAddress=remoteMACAddress, channelBandwidth=channelBandwidth, vlanPriority=vlanPriority, sNMPTrapTable=sNMPTrapTable, configuredRange=configuredRange, ptmp=ptmp, sMTPServerIPAddress=sMTPServerIPAddress, remoteIPAddress=remoteIPAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, pubStatsGroup=pubStatsGroup, configurationGroup=configurationGroup, aggregateDataRate=aggregateDataRate, productName=productName, regionCode=regionCode, measuredRange=measuredRange, vectorError=vectorError, sNMPCommunityOid=sNMPCommunityOid, versions=versions, noiseFloor=noiseFloor, sNMPCommunityTableNumber=sNMPCommunityTableNumber, smtp=smtp, ptp=ptp, maximumTransmitPower=maximumTransmitPower, siteName=siteName, dataPortStatus=dataPortStatus, searchState=searchState, timeZone=timeZone, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, nTPSync=nTPSync, sNMPTrapVersion=sNMPTrapVersion, sNMPCommunityTableIndex=sNMPCommunityTableIndex, currentFreqMHz=currentFreqMHz, noWirelessChannelAvailable=noWirelessChannelAvailable, channelSelection=channelSelection, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, snmpControl=snmpControl, versionsGroup=versionsGroup, iPAddress=iPAddress, band=band, tFTPServerIPAddress=tFTPServerIPAddress, configuredModulationMode=configuredModulationMode, bootVersion=bootVersion, ptpTrapPrefix=ptpTrapPrefix, transmitModulationMode=transmitModulationMode, nTPServerIp=nTPServerIp, transmitDataRate=transmitDataRate, sMTPServerPortNumber=sMTPServerPortNumber, radarDetectChannel=radarDetectChannel, receiveDataRate=receiveDataRate, gatewayIPAddress=gatewayIPAddress, fixedModMode=fixedModMode, management=management, dataPortAutoNegotiation=dataPortAutoNegotiation, productVariant=productVariant, ethernet=ethernet, installArmStateTrap=installArmStateTrap, ptpTraps=ptpTraps, dualPayload=dualPayload, licenceGroup=licenceGroup, antennaGain=antennaGain, sNMPCommunityAccess=sNMPCommunityAccess, nTPState=nTPState, smtpGroup=smtpGroup, receivePower=receivePower, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sNMPCommunityTable=sNMPCommunityTable, softwareVersion=softwareVersion, signalStrengthRatio=signalStrengthRatio, hardwareVersion=hardwareVersion, nTPPollInterval=nTPPollInterval, ntpGroup=ntpGroup, vlanTagging=vlanTagging, dataPortStatusTrap=dataPortStatusTrap, configuration=configuration, extendedChannel=extendedChannel, sNMPTrapTableEntry=sNMPTrapTableEntry, linkLoss=linkLoss, alarms=alarms, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText)
