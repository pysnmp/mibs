...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", maximumTransmitPower=maximumTransmitPower, management=management, vlanId=vlanId, cableLoss=cableLoss, ntp=ntp, ptpTrapPrefix=ptpTrapPrefix, nTPState=nTPState, measuredRange=measuredRange, installArmState=installArmState, remoteMACAddress=remoteMACAddress, transmitModulationMode=transmitModulationMode, sMTPServerPortNumber=sMTPServerPortNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, vectorError=vectorError, receivePower=receivePower, linkLoss=linkLoss, sNMPTrapVersion=sNMPTrapVersion, versions=versions, sMTPEnabledMessages=sMTPEnabledMessages, hardwareVersion=hardwareVersion, licence=licence, snmpControl=snmpControl, receiveDataRate=receiveDataRate, nTPSync=nTPSync, timeZone=timeZone, tFTPServerIPAddress=tFTPServerIPAddress, pubStatsGroup=pubStatsGroup, linkName=linkName, tFTPServerPortNumber=tFTPServerPortNumber, alarms=alarms, ptmp=ptmp, installArmStateTrap=installArmStateTrap, noiseFloor=noiseFloor, alarmsGroup=alarmsGroup, subnetMask=subnetMask, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ptpTraps=ptpTraps, versionsGroup=versionsGroup, masterSlaveMode=masterSlaveMode, siteName=siteName, vlanTagging=vlanTagging, fixedModMode=fixedModMode, smtp=smtp, channelSelection=channelSelection, receiveModulationMode=receiveModulationMode, wirelessLinkStatus=wirelessLinkStatus, sNMPEnabledTraps=sNMPEnabledTraps, sNMPCommunityTableEntry=sNMPCommunityTableEntry, dataPortAutoNegotiation=dataPortAutoNegotiation, signalStrengthRatio=signalStrengthRatio, aggregateDataRate=aggregateDataRate, sNMPCommunityAccess=sNMPCommunityAccess, ptp250=ptp250, sNMPCommunityTable=sNMPCommunityTable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, remoteIPAddress=remoteIPAddress, iPAddress=iPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, transmitPower=transmitPower, sNMPCommunityTableNumber=sNMPCommunityTableNumber, nTPLastSync=nTPLastSync, extendedChannel=extendedChannel, transmitDataRate=transmitDataRate, ntpGroup=ntpGroup, nTPServerIp=nTPServerIp, snmpControlGroup=snmpControlGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, softwareVersion=softwareVersion, noWirelessChannelAvailable=noWirelessChannelAvailable, configuredModulationMode=configuredModulationMode, PYSNMP_MODULE_ID=cambium, sMTPServerIPAddress=sMTPServerIPAddress, radarDetectChannel=radarDetectChannel, ptpGroups=ptpGroups, nTPPollInterval=nTPPollInterval, ptp=ptp, searchState=searchState, vlanPriority=vlanPriority, channelBandwidth=channelBandwidth, gatewayIPAddress=gatewayIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, productName=productName, phyStatusGroup=phyStatusGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, radarDetectTrap=radarDetectTrap, antennaGain=antennaGain, sNMPCommunityOid=sNMPCommunityOid, pubStats=pubStats, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, band=band, managementGroup=managementGroup, dataPortStatus=dataPortStatus, phyStatus=phyStatus, productVariant=productVariant, sNMPTrapCommunity=sNMPTrapCommunity, currentFreqMHz=currentFreqMHz, sNMPTrapTable=sNMPTrapTable, extendedFreqMHz=extendedFreqMHz, smtpGroup=smtpGroup, bootVersion=bootVersion, configuredRange=configuredRange, sNMPCommunityString=sNMPCommunityString, systemClock=systemClock, licenceGroup=licenceGroup, ptpCompliance=ptpCompliance, regionCode=regionCode, ethernet=ethernet, cambium=cambium, ethernetGroup=ethernetGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPCommunityTableIndex=sNMPCommunityTableIndex, dualPayload=dualPayload, notificationsGroup=notificationsGroup, nTPServerPortNumber=nTPServerPortNumber, configuration=configuration, linkStatusTrap=linkStatusTrap, configurationGroup=configurationGroup, dataPortStatusTrap=dataPortStatusTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, currentChannel=currentChannel)
