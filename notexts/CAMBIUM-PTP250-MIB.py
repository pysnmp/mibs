...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", ptpTrapPrefix=ptpTrapPrefix, sNMPTrapTable=sNMPTrapTable, snmpControl=snmpControl, linkStatusTrap=linkStatusTrap, receiveDataRate=receiveDataRate, sNMPTrapPortNumber=sNMPTrapPortNumber, licenceGroup=licenceGroup, channelSelection=channelSelection, snmpControlGroup=snmpControlGroup, vectorError=vectorError, productName=productName, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, wirelessLinkStatus=wirelessLinkStatus, sNMPEnabledTraps=sNMPEnabledTraps, dataPortStatusTrap=dataPortStatusTrap, transmitPower=transmitPower, transmitDataRate=transmitDataRate, remoteIPAddress=remoteIPAddress, ethernet=ethernet, configurationGroup=configurationGroup, nTPLastSync=nTPLastSync, alarmsGroup=alarmsGroup, dataPortStatus=dataPortStatus, productVariant=productVariant, measuredRange=measuredRange, dataPortAutoNegotiation=dataPortAutoNegotiation, ptpGroups=ptpGroups, managementGroup=managementGroup, nTPServerPortNumber=nTPServerPortNumber, band=band, ptpTraps=ptpTraps, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, configuration=configuration, subnetMask=subnetMask, timeZone=timeZone, transmitModulationMode=transmitModulationMode, siteName=siteName, gatewayIPAddress=gatewayIPAddress, cableLoss=cableLoss, nTPSync=nTPSync, signalStrengthRatio=signalStrengthRatio, receiveModulationMode=receiveModulationMode, searchState=searchState, radarDetectChannel=radarDetectChannel, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, phyStatus=phyStatus, management=management, smtp=smtp, sNMPTrapTableNumber=sNMPTrapTableNumber, masterSlaveMode=masterSlaveMode, ntpGroup=ntpGroup, linkName=linkName, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, versions=versions, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPCommunityAccess=sNMPCommunityAccess, installArmStateTrap=installArmStateTrap, pubStats=pubStats, noiseFloor=noiseFloor, currentFreqMHz=currentFreqMHz, sMTPSourceEmailAddress=sMTPSourceEmailAddress, fixedModMode=fixedModMode, phyStatusGroup=phyStatusGroup, hardwareVersion=hardwareVersion, sNMPCommunityOid=sNMPCommunityOid, systemClock=systemClock, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, softwareVersion=softwareVersion, notificationsGroup=notificationsGroup, extendedFreqMHz=extendedFreqMHz, sMTPEnabledMessages=sMTPEnabledMessages, installArmState=installArmState, ethernetGroup=ethernetGroup, licence=licence, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, cambium=cambium, dualPayload=dualPayload, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPCommunityTableNumber=sNMPCommunityTableNumber, linkLoss=linkLoss, sNMPTrapCommunity=sNMPTrapCommunity, iPAddress=iPAddress, smtpGroup=smtpGroup, configuredModulationMode=configuredModulationMode, sNMPCommunityTableEntry=sNMPCommunityTableEntry, vlanPriority=vlanPriority, currentChannel=currentChannel, radarDetectTrap=radarDetectTrap, sNMPCommunityTable=sNMPCommunityTable, ptp250=ptp250, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, nTPState=nTPState, channelBandwidth=channelBandwidth, regionCode=regionCode, remoteMACAddress=remoteMACAddress, tFTPServerPortNumber=tFTPServerPortNumber, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sNMPCommunityString=sNMPCommunityString, bootVersion=bootVersion, vlanTagging=vlanTagging, sMTPServerPortNumber=sMTPServerPortNumber, ptp=ptp, sNMPTrapVersion=sNMPTrapVersion, maximumTransmitPower=maximumTransmitPower, noWirelessChannelAvailable=noWirelessChannelAvailable, nTPPollInterval=nTPPollInterval, ntp=ntp, extendedChannel=extendedChannel, ptmp=ptmp, versionsGroup=versionsGroup, ptpCompliance=ptpCompliance, pubStatsGroup=pubStatsGroup, receivePower=receivePower, tFTPServerIPAddress=tFTPServerIPAddress, PYSNMP_MODULE_ID=cambium, aggregateDataRate=aggregateDataRate, antennaGain=antennaGain, vlanId=vlanId, sMTPServerIPAddress=sMTPServerIPAddress, alarms=alarms, nTPServerIp=nTPServerIp, configuredRange=configuredRange)
