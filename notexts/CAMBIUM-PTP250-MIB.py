...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", transmitModulationMode=transmitModulationMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, vlanId=vlanId, sNMPCommunityTableIndex=sNMPCommunityTableIndex, nTPState=nTPState, notificationsGroup=notificationsGroup, ethernet=ethernet, configuredModulationMode=configuredModulationMode, dataPortAutoNegotiation=dataPortAutoNegotiation, timeZone=timeZone, band=band, dataPortStatusTrap=dataPortStatusTrap, sNMPCommunityTable=sNMPCommunityTable, extendedChannel=extendedChannel, phyStatus=phyStatus, vlanTagging=vlanTagging, productVariant=productVariant, tFTPServerPortNumber=tFTPServerPortNumber, transmitDataRate=transmitDataRate, tFTPServerIPAddress=tFTPServerIPAddress, smtpGroup=smtpGroup, nTPPollInterval=nTPPollInterval, snmpControlGroup=snmpControlGroup, searchState=searchState, configurationGroup=configurationGroup, radarDetectTrap=radarDetectTrap, ntp=ntp, sNMPTrapCommunity=sNMPTrapCommunity, ntpGroup=ntpGroup, transmitPower=transmitPower, licence=licence, installArmState=installArmState, receiveDataRate=receiveDataRate, installArmStateTrap=installArmStateTrap, wirelessLinkStatus=wirelessLinkStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPCommunityString=sNMPCommunityString, aggregateDataRate=aggregateDataRate, ptp250=ptp250, alarms=alarms, configuredRange=configuredRange, iPAddress=iPAddress, vectorError=vectorError, cambium=cambium, phyStatusGroup=phyStatusGroup, receivePower=receivePower, ptp=ptp, ethernetGroup=ethernetGroup, remoteIPAddress=remoteIPAddress, alarmsGroup=alarmsGroup, fixedModMode=fixedModMode, sNMPCommunityAccess=sNMPCommunityAccess, sNMPTrapTableIndex=sNMPTrapTableIndex, linkStatusTrap=linkStatusTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, ptpTraps=ptpTraps, PYSNMP_MODULE_ID=cambium, subnetMask=subnetMask, sNMPTrapTable=sNMPTrapTable, ptpCompliance=ptpCompliance, channelBandwidth=channelBandwidth, receiveModulationMode=receiveModulationMode, versionsGroup=versionsGroup, nTPLastSync=nTPLastSync, sMTPServerIPAddress=sMTPServerIPAddress, measuredRange=measuredRange, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPEnabledTraps=sNMPEnabledTraps, management=management, remoteMACAddress=remoteMACAddress, maximumTransmitPower=maximumTransmitPower, channelSelection=channelSelection, pubStatsGroup=pubStatsGroup, versions=versions, bootVersion=bootVersion, nTPSync=nTPSync, ptpTrapPrefix=ptpTrapPrefix, extendedFreqMHz=extendedFreqMHz, sNMPCommunityOid=sNMPCommunityOid, sNMPTrapVersion=sNMPTrapVersion, signalStrengthRatio=signalStrengthRatio, regionCode=regionCode, currentFreqMHz=currentFreqMHz, sMTPEnabledMessages=sMTPEnabledMessages, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, gatewayIPAddress=gatewayIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, antennaGain=antennaGain, linkName=linkName, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, pubStats=pubStats, currentChannel=currentChannel, cableLoss=cableLoss, configuration=configuration, noiseFloor=noiseFloor, smtp=smtp, ptpGroups=ptpGroups, snmpControl=snmpControl, ptmp=ptmp, sNMPCommunityTableNumber=sNMPCommunityTableNumber, systemClock=systemClock, linkLoss=linkLoss, masterSlaveMode=masterSlaveMode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapTableEntry=sNMPTrapTableEntry, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, productName=productName, managementGroup=managementGroup, hardwareVersion=hardwareVersion, vlanPriority=vlanPriority, licenceGroup=licenceGroup, dataPortStatus=dataPortStatus, nTPServerIp=nTPServerIp, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sMTPServerPortNumber=sMTPServerPortNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dualPayload=dualPayload, sMTPSourceEmailAddress=sMTPSourceEmailAddress, nTPServerPortNumber=nTPServerPortNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, softwareVersion=softwareVersion, radarDetectChannel=radarDetectChannel, siteName=siteName)
