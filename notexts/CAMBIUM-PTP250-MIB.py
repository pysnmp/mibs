...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", alarmsGroup=alarmsGroup, softwareVersion=softwareVersion, masterSlaveMode=masterSlaveMode, nTPSync=nTPSync, measuredRange=measuredRange, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, configuration=configuration, regionCode=regionCode, sNMPTrapPortNumber=sNMPTrapPortNumber, receiveModulationMode=receiveModulationMode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, vlanId=vlanId, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, management=management, ethernet=ethernet, ntpGroup=ntpGroup, remoteMACAddress=remoteMACAddress, noiseFloor=noiseFloor, smtpGroup=smtpGroup, currentChannel=currentChannel, extendedChannel=extendedChannel, tFTPServerPortNumber=tFTPServerPortNumber, installArmStateTrap=installArmStateTrap, sNMPCommunityAccess=sNMPCommunityAccess, dualPayload=dualPayload, ntp=ntp, gatewayIPAddress=gatewayIPAddress, sNMPTrapCommunity=sNMPTrapCommunity, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sNMPCommunityTableNumber=sNMPCommunityTableNumber, iPAddress=iPAddress, nTPLastSync=nTPLastSync, linkStatusTrap=linkStatusTrap, systemClock=systemClock, configuredRange=configuredRange, linkLoss=linkLoss, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapTableEntry=sNMPTrapTableEntry, sMTPServerPortNumber=sMTPServerPortNumber, snmpControlGroup=snmpControlGroup, sMTPEnabledMessages=sMTPEnabledMessages, ptpCompliance=ptpCompliance, radarDetectChannel=radarDetectChannel, snmpControl=snmpControl, versionsGroup=versionsGroup, cambium=cambium, aggregateDataRate=aggregateDataRate, ptpGroups=ptpGroups, licenceGroup=licenceGroup, band=band, phyStatus=phyStatus, sNMPCommunityTable=sNMPCommunityTable, searchState=searchState, configurationGroup=configurationGroup, ethernetGroup=ethernetGroup, notificationsGroup=notificationsGroup, channelBandwidth=channelBandwidth, channelSelection=channelSelection, alarms=alarms, installArmState=installArmState, nTPState=nTPState, ptp=ptp, extendedFreqMHz=extendedFreqMHz, nTPServerPortNumber=nTPServerPortNumber, maximumTransmitPower=maximumTransmitPower, ptp250=ptp250, productVariant=productVariant, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, vlanTagging=vlanTagging, ptmp=ptmp, wirelessLinkStatus=wirelessLinkStatus, tFTPServerIPAddress=tFTPServerIPAddress, managementGroup=managementGroup, subnetMask=subnetMask, nTPServerIp=nTPServerIp, transmitDataRate=transmitDataRate, receiveDataRate=receiveDataRate, PYSNMP_MODULE_ID=cambium, transmitPower=transmitPower, currentFreqMHz=currentFreqMHz, timeZone=timeZone, productName=productName, transmitModulationMode=transmitModulationMode, siteName=siteName, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, nTPPollInterval=nTPPollInterval, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, configuredModulationMode=configuredModulationMode, vlanPriority=vlanPriority, smtp=smtp, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortStatusTrap=dataPortStatusTrap, sMTPServerIPAddress=sMTPServerIPAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPEnabledTraps=sNMPEnabledTraps, pubStatsGroup=pubStatsGroup, versions=versions, pubStats=pubStats, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataPortStatus=dataPortStatus, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapTable=sNMPTrapTable, receivePower=receivePower, ptpTraps=ptpTraps, radarDetectTrap=radarDetectTrap, licence=licence, sNMPCommunityString=sNMPCommunityString, sNMPCommunityOid=sNMPCommunityOid, hardwareVersion=hardwareVersion, antennaGain=antennaGain, phyStatusGroup=phyStatusGroup, remoteIPAddress=remoteIPAddress, vectorError=vectorError, bootVersion=bootVersion, fixedModMode=fixedModMode, linkName=linkName, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, signalStrengthRatio=signalStrengthRatio, sNMPTrapVersion=sNMPTrapVersion, cableLoss=cableLoss, sNMPCommunityTableEntry=sNMPCommunityTableEntry, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex)
