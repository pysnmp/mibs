...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPTrapTable=sNMPTrapTable, versions=versions, timeZone=timeZone, alarms=alarms, nTPLastSync=nTPLastSync, iPAddress=iPAddress, dataPortStatus=dataPortStatus, sMTPEnabledMessages=sMTPEnabledMessages, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, searchState=searchState, sMTPSourceEmailAddress=sMTPSourceEmailAddress, phyStatusGroup=phyStatusGroup, dataPortStatusTrap=dataPortStatusTrap, transmitPower=transmitPower, fixedModMode=fixedModMode, sNMPCommunityString=sNMPCommunityString, ptp250=ptp250, ntpGroup=ntpGroup, sNMPCommunityTableNumber=sNMPCommunityTableNumber, pubStats=pubStats, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, wirelessLinkStatus=wirelessLinkStatus, gatewayIPAddress=gatewayIPAddress, radarDetectChannel=radarDetectChannel, sNMPTrapCommunity=sNMPTrapCommunity, noiseFloor=noiseFloor, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, linkStatusTrap=linkStatusTrap, smtpGroup=smtpGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPCommunityTableIndex=sNMPCommunityTableIndex, band=band, installArmState=installArmState, sMTPServerPortNumber=sMTPServerPortNumber, productVariant=productVariant, receiveDataRate=receiveDataRate, ethernetGroup=ethernetGroup, sNMPTrapVersion=sNMPTrapVersion, versionsGroup=versionsGroup, nTPPollInterval=nTPPollInterval, configuredModulationMode=configuredModulationMode, antennaGain=antennaGain, vlanId=vlanId, transmitDataRate=transmitDataRate, vlanTagging=vlanTagging, sNMPCommunityOid=sNMPCommunityOid, ptmp=ptmp, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, masterSlaveMode=masterSlaveMode, snmpControlGroup=snmpControlGroup, alarmsGroup=alarmsGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, configuration=configuration, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, pubStatsGroup=pubStatsGroup, extendedChannel=extendedChannel, cambium=cambium, aggregateDataRate=aggregateDataRate, linkLoss=linkLoss, remoteIPAddress=remoteIPAddress, radarDetectTrap=radarDetectTrap, management=management, sNMPCommunityAccess=sNMPCommunityAccess, ethernet=ethernet, ptpTrapPrefix=ptpTrapPrefix, installArmStateTrap=installArmStateTrap, licence=licence, configuredRange=configuredRange, systemClock=systemClock, regionCode=regionCode, licenceGroup=licenceGroup, nTPServerIp=nTPServerIp, measuredRange=measuredRange, remoteMACAddress=remoteMACAddress, PYSNMP_MODULE_ID=cambium, snmpControl=snmpControl, sNMPCommunityTableEntry=sNMPCommunityTableEntry, transmitModulationMode=transmitModulationMode, subnetMask=subnetMask, hardwareVersion=hardwareVersion, configurationGroup=configurationGroup, signalStrengthRatio=signalStrengthRatio, currentFreqMHz=currentFreqMHz, ntp=ntp, cableLoss=cableLoss, currentChannel=currentChannel, phyStatus=phyStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, softwareVersion=softwareVersion, ptpTraps=ptpTraps, sNMPEnabledTraps=sNMPEnabledTraps, maximumTransmitPower=maximumTransmitPower, ptpCompliance=ptpCompliance, productName=productName, channelBandwidth=channelBandwidth, nTPState=nTPState, receiveModulationMode=receiveModulationMode, vlanPriority=vlanPriority, extendedFreqMHz=extendedFreqMHz, tFTPServerIPAddress=tFTPServerIPAddress, dualPayload=dualPayload, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkName=linkName, notificationsGroup=notificationsGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, bootVersion=bootVersion, ptpGroups=ptpGroups, receivePower=receivePower, nTPServerPortNumber=nTPServerPortNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, managementGroup=managementGroup, sNMPCommunityTable=sNMPCommunityTable, ptp=ptp, channelSelection=channelSelection, nTPSync=nTPSync, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, vectorError=vectorError, smtp=smtp, sMTPServerIPAddress=sMTPServerIPAddress, siteName=siteName)
