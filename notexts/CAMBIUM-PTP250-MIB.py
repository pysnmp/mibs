...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", snmpControlGroup=snmpControlGroup, sNMPCommunityTableNumber=sNMPCommunityTableNumber, licenceGroup=licenceGroup, management=management, extendedFreqMHz=extendedFreqMHz, sNMPTrapIPAddress=sNMPTrapIPAddress, noiseFloor=noiseFloor, remoteMACAddress=remoteMACAddress, tFTPServerPortNumber=tFTPServerPortNumber, vlanId=vlanId, sNMPCommunityString=sNMPCommunityString, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sMTPServerIPAddress=sMTPServerIPAddress, antennaGain=antennaGain, subnetMask=subnetMask, linkStatusTrap=linkStatusTrap, pubStatsGroup=pubStatsGroup, linkName=linkName, systemClock=systemClock, ptpTrapPrefix=ptpTrapPrefix, ptp=ptp, aggregateDataRate=aggregateDataRate, nTPState=nTPState, softwareVersion=softwareVersion, siteName=siteName, productVariant=productVariant, receivePower=receivePower, sNMPCommunityTableIndex=sNMPCommunityTableIndex, ptpTraps=ptpTraps, sNMPTrapCommunity=sNMPTrapCommunity, hardwareVersion=hardwareVersion, alarmsGroup=alarmsGroup, installArmStateTrap=installArmStateTrap, ntpGroup=ntpGroup, nTPLastSync=nTPLastSync, sNMPCommunityTableEntry=sNMPCommunityTableEntry, channelSelection=channelSelection, currentChannel=currentChannel, sNMPTrapTableEntry=sNMPTrapTableEntry, cableLoss=cableLoss, channelBandwidth=channelBandwidth, configuredModulationMode=configuredModulationMode, radarDetectTrap=radarDetectTrap, band=band, currentFreqMHz=currentFreqMHz, sNMPTrapTable=sNMPTrapTable, dualPayload=dualPayload, wirelessLinkStatus=wirelessLinkStatus, sNMPCommunityTable=sNMPCommunityTable, pubStats=pubStats, bootVersion=bootVersion, nTPPollInterval=nTPPollInterval, searchState=searchState, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, managementGroup=managementGroup, iPAddress=iPAddress, dataPortStatus=dataPortStatus, ptpGroups=ptpGroups, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, nTPServerPortNumber=nTPServerPortNumber, vlanPriority=vlanPriority, installArmState=installArmState, snmpControl=snmpControl, sMTPEnabledMessages=sMTPEnabledMessages, phyStatusGroup=phyStatusGroup, timeZone=timeZone, transmitModulationMode=transmitModulationMode, versionsGroup=versionsGroup, configurationGroup=configurationGroup, extendedChannel=extendedChannel, dataPortStatusTrap=dataPortStatusTrap, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapTableIndex=sNMPTrapTableIndex, remoteIPAddress=remoteIPAddress, receiveDataRate=receiveDataRate, linkLoss=linkLoss, configuration=configuration, noWirelessChannelAvailable=noWirelessChannelAvailable, vectorError=vectorError, smtp=smtp, sMTPServerPortNumber=sMTPServerPortNumber, measuredRange=measuredRange, vlanTagging=vlanTagging, sNMPTrapPortNumber=sNMPTrapPortNumber, radarDetectChannel=radarDetectChannel, smtpGroup=smtpGroup, fixedModMode=fixedModMode, maximumTransmitPower=maximumTransmitPower, sNMPTrapTableNumber=sNMPTrapTableNumber, receiveModulationMode=receiveModulationMode, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, nTPServerIp=nTPServerIp, ptmp=ptmp, sMTPSourceEmailAddress=sMTPSourceEmailAddress, transmitPower=transmitPower, ethernet=ethernet, phyStatus=phyStatus, tFTPServerIPAddress=tFTPServerIPAddress, versions=versions, productName=productName, notificationsGroup=notificationsGroup, cambium=cambium, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, signalStrengthRatio=signalStrengthRatio, configuredRange=configuredRange, regionCode=regionCode, PYSNMP_MODULE_ID=cambium, ptpCompliance=ptpCompliance, alarms=alarms, sNMPCommunityOid=sNMPCommunityOid, ptp250=ptp250, ethernetGroup=ethernetGroup, nTPSync=nTPSync, licence=licence, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, transmitDataRate=transmitDataRate, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ntp=ntp, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapVersion=sNMPTrapVersion, masterSlaveMode=masterSlaveMode, sNMPCommunityAccess=sNMPCommunityAccess, gatewayIPAddress=gatewayIPAddress)
