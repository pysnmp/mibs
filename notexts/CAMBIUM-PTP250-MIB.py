...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPCommunityAccess=sNMPCommunityAccess, transmitModulationMode=transmitModulationMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortStatusTrap=dataPortStatusTrap, timeZone=timeZone, nTPSync=nTPSync, vectorError=vectorError, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, linkLoss=linkLoss, remoteMACAddress=remoteMACAddress, sNMPTrapCommunity=sNMPTrapCommunity, nTPLastSync=nTPLastSync, ntpGroup=ntpGroup, sNMPCommunityOid=sNMPCommunityOid, sMTPSourceEmailAddress=sMTPSourceEmailAddress, versions=versions, sNMPTrapPortNumber=sNMPTrapPortNumber, fixedModMode=fixedModMode, ptp=ptp, smtpGroup=smtpGroup, remoteIPAddress=remoteIPAddress, tFTPServerPortNumber=tFTPServerPortNumber, linkStatusTrap=linkStatusTrap, channelBandwidth=channelBandwidth, productName=productName, sNMPTrapTable=sNMPTrapTable, sMTPServerPortNumber=sMTPServerPortNumber, ptpCompliance=ptpCompliance, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, extendedChannel=extendedChannel, nTPPollInterval=nTPPollInterval, receiveDataRate=receiveDataRate, linkName=linkName, sNMPTrapTableNumber=sNMPTrapTableNumber, phyStatusGroup=phyStatusGroup, productVariant=productVariant, searchState=searchState, sMTPServerIPAddress=sMTPServerIPAddress, configuredRange=configuredRange, snmpControlGroup=snmpControlGroup, sNMPCommunityTableEntry=sNMPCommunityTableEntry, ptp250=ptp250, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapVersion=sNMPTrapVersion, snmpControl=snmpControl, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, maximumTransmitPower=maximumTransmitPower, receiveModulationMode=receiveModulationMode, ntp=ntp, transmitPower=transmitPower, sNMPCommunityTable=sNMPCommunityTable, smtp=smtp, PYSNMP_MODULE_ID=cambium, regionCode=regionCode, nTPServerPortNumber=nTPServerPortNumber, configurationGroup=configurationGroup, nTPState=nTPState, vlanPriority=vlanPriority, receivePower=receivePower, bootVersion=bootVersion, noiseFloor=noiseFloor, cambium=cambium, notificationsGroup=notificationsGroup, antennaGain=antennaGain, alarmsGroup=alarmsGroup, systemClock=systemClock, gatewayIPAddress=gatewayIPAddress, licence=licence, configuration=configuration, management=management, softwareVersion=softwareVersion, installArmState=installArmState, tFTPServerIPAddress=tFTPServerIPAddress, licenceGroup=licenceGroup, iPAddress=iPAddress, sNMPCommunityTableIndex=sNMPCommunityTableIndex, channelSelection=channelSelection, pubStats=pubStats, cableLoss=cableLoss, wirelessLinkStatus=wirelessLinkStatus, sNMPCommunityString=sNMPCommunityString, hardwareVersion=hardwareVersion, radarDetectChannel=radarDetectChannel, siteName=siteName, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, versionsGroup=versionsGroup, phyStatus=phyStatus, subnetMask=subnetMask, measuredRange=measuredRange, sNMPCommunityTableNumber=sNMPCommunityTableNumber, vlanId=vlanId, ethernet=ethernet, managementGroup=managementGroup, sMTPEnabledMessages=sMTPEnabledMessages, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, aggregateDataRate=aggregateDataRate, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, alarms=alarms, band=band, extendedFreqMHz=extendedFreqMHz, configuredModulationMode=configuredModulationMode, sNMPEnabledTraps=sNMPEnabledTraps, radarDetectTrap=radarDetectTrap, vlanTagging=vlanTagging, pubStatsGroup=pubStatsGroup, masterSlaveMode=masterSlaveMode, nTPServerIp=nTPServerIp, currentChannel=currentChannel, dataPortAutoNegotiation=dataPortAutoNegotiation, ptpTraps=ptpTraps, dataPortStatus=dataPortStatus, signalStrengthRatio=signalStrengthRatio, installArmStateTrap=installArmStateTrap, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, ethernetGroup=ethernetGroup, ptmp=ptmp, dualPayload=dualPayload, currentFreqMHz=currentFreqMHz, ptpGroups=ptpGroups, sNMPTrapTableIndex=sNMPTrapTableIndex, transmitDataRate=transmitDataRate)
