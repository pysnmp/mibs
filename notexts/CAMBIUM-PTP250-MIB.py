...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapTableEntry=sNMPTrapTableEntry, ethernetGroup=ethernetGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, antennaGain=antennaGain, ptp=ptp, phyStatusGroup=phyStatusGroup, bootVersion=bootVersion, systemClock=systemClock, aggregateDataRate=aggregateDataRate, masterSlaveMode=masterSlaveMode, channelBandwidth=channelBandwidth, band=band, pubStats=pubStats, measuredRange=measuredRange, receivePower=receivePower, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, phyStatus=phyStatus, sMTPServerIPAddress=sMTPServerIPAddress, remoteMACAddress=remoteMACAddress, linkName=linkName, nTPLastSync=nTPLastSync, productName=productName, remoteIPAddress=remoteIPAddress, nTPServerIp=nTPServerIp, ethernet=ethernet, sNMPTrapTable=sNMPTrapTable, gatewayIPAddress=gatewayIPAddress, productVariant=productVariant, receiveModulationMode=receiveModulationMode, linkStatusTrap=linkStatusTrap, fixedModMode=fixedModMode, PYSNMP_MODULE_ID=cambium, searchState=searchState, nTPPollInterval=nTPPollInterval, sNMPTrapCommunity=sNMPTrapCommunity, management=management, extendedChannel=extendedChannel, softwareVersion=softwareVersion, alarms=alarms, pubStatsGroup=pubStatsGroup, sNMPEnabledTraps=sNMPEnabledTraps, wirelessLinkStatus=wirelessLinkStatus, nTPSync=nTPSync, noiseFloor=noiseFloor, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, transmitModulationMode=transmitModulationMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sMTPEnabledMessages=sMTPEnabledMessages, maximumTransmitPower=maximumTransmitPower, configuration=configuration, linkLoss=linkLoss, timeZone=timeZone, installArmState=installArmState, sNMPCommunityTable=sNMPCommunityTable, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPTrapTableNumber=sNMPTrapTableNumber, radarDetectTrap=radarDetectTrap, versions=versions, ptpGroups=ptpGroups, noWirelessChannelAvailable=noWirelessChannelAvailable, currentFreqMHz=currentFreqMHz, smtp=smtp, nTPServerPortNumber=nTPServerPortNumber, sNMPCommunityString=sNMPCommunityString, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, extendedFreqMHz=extendedFreqMHz, subnetMask=subnetMask, sNMPCommunityOid=sNMPCommunityOid, dataPortStatusTrap=dataPortStatusTrap, sNMPTrapVersion=sNMPTrapVersion, sNMPCommunityAccess=sNMPCommunityAccess, cambium=cambium, channelSelection=channelSelection, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapPortNumber=sNMPTrapPortNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, snmpControlGroup=snmpControlGroup, signalStrengthRatio=signalStrengthRatio, receiveDataRate=receiveDataRate, currentChannel=currentChannel, cableLoss=cableLoss, ntp=ntp, siteName=siteName, licenceGroup=licenceGroup, hardwareVersion=hardwareVersion, smtpGroup=smtpGroup, tFTPServerIPAddress=tFTPServerIPAddress, managementGroup=managementGroup, vectorError=vectorError, sMTPServerPortNumber=sMTPServerPortNumber, ptp250=ptp250, installArmStateTrap=installArmStateTrap, ptmp=ptmp, snmpControl=snmpControl, nTPState=nTPState, regionCode=regionCode, ptpCompliance=ptpCompliance, configuredModulationMode=configuredModulationMode, alarmsGroup=alarmsGroup, versionsGroup=versionsGroup, configurationGroup=configurationGroup, sNMPCommunityTableEntry=sNMPCommunityTableEntry, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, configuredRange=configuredRange, dataPortStatus=dataPortStatus, dualPayload=dualPayload, ptpTraps=ptpTraps, notificationsGroup=notificationsGroup, vlanTagging=vlanTagging, ptpTrapPrefix=ptpTrapPrefix, tFTPServerPortNumber=tFTPServerPortNumber, licence=licence, vlanPriority=vlanPriority, vlanId=vlanId, sNMPCommunityTableIndex=sNMPCommunityTableIndex, radarDetectChannel=radarDetectChannel, iPAddress=iPAddress, ntpGroup=ntpGroup, transmitDataRate=transmitDataRate, transmitPower=transmitPower)
