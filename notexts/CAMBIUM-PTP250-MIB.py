...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPCommunityOid=sNMPCommunityOid, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, currentFreqMHz=currentFreqMHz, versions=versions, cambium=cambium, smtpGroup=smtpGroup, sNMPCommunityTableIndex=sNMPCommunityTableIndex, receiveModulationMode=receiveModulationMode, snmpControlGroup=snmpControlGroup, remoteIPAddress=remoteIPAddress, sNMPCommunityTable=sNMPCommunityTable, remoteMACAddress=remoteMACAddress, bootVersion=bootVersion, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, productVariant=productVariant, cableLoss=cableLoss, subnetMask=subnetMask, sNMPTrapVersion=sNMPTrapVersion, ntp=ntp, ptp=ptp, sNMPTrapPortNumber=sNMPTrapPortNumber, masterSlaveMode=masterSlaveMode, nTPLastSync=nTPLastSync, managementGroup=managementGroup, softwareVersion=softwareVersion, band=band, gatewayIPAddress=gatewayIPAddress, phyStatusGroup=phyStatusGroup, ptpCompliance=ptpCompliance, tFTPServerPortNumber=tFTPServerPortNumber, transmitModulationMode=transmitModulationMode, alarms=alarms, extendedChannel=extendedChannel, sNMPCommunityTableNumber=sNMPCommunityTableNumber, vectorError=vectorError, nTPServerPortNumber=nTPServerPortNumber, nTPState=nTPState, vlanTagging=vlanTagging, configuredModulationMode=configuredModulationMode, receiveDataRate=receiveDataRate, transmitPower=transmitPower, phyStatus=phyStatus, currentChannel=currentChannel, ptmp=ptmp, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sNMPCommunityString=sNMPCommunityString, extendedFreqMHz=extendedFreqMHz, sMTPEnabledMessages=sMTPEnabledMessages, maximumTransmitPower=maximumTransmitPower, sMTPServerIPAddress=sMTPServerIPAddress, regionCode=regionCode, versionsGroup=versionsGroup, linkStatusTrap=linkStatusTrap, ethernet=ethernet, ptpTraps=ptpTraps, configuration=configuration, ptpGroups=ptpGroups, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, antennaGain=antennaGain, fixedModMode=fixedModMode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, linkName=linkName, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapCommunity=sNMPTrapCommunity, dataPortAutoNegotiation=dataPortAutoNegotiation, measuredRange=measuredRange, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, ptp250=ptp250, noWirelessChannelAvailable=noWirelessChannelAvailable, receivePower=receivePower, sNMPCommunityAccess=sNMPCommunityAccess, siteName=siteName, sNMPTrapTableEntry=sNMPTrapTableEntry, hardwareVersion=hardwareVersion, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, vlanPriority=vlanPriority, sNMPTrapIPAddress=sNMPTrapIPAddress, productName=productName, timeZone=timeZone, dataPortStatusTrap=dataPortStatusTrap, nTPSync=nTPSync, tFTPServerIPAddress=tFTPServerIPAddress, snmpControl=snmpControl, nTPServerIp=nTPServerIp, nTPPollInterval=nTPPollInterval, linkLoss=linkLoss, configuredRange=configuredRange, channelSelection=channelSelection, channelBandwidth=channelBandwidth, iPAddress=iPAddress, sNMPTrapTable=sNMPTrapTable, radarDetectTrap=radarDetectTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, notificationsGroup=notificationsGroup, PYSNMP_MODULE_ID=cambium, ntpGroup=ntpGroup, licence=licence, vlanId=vlanId, radarDetectChannel=radarDetectChannel, management=management, installArmStateTrap=installArmStateTrap, systemClock=systemClock, sMTPServerPortNumber=sMTPServerPortNumber, pubStatsGroup=pubStatsGroup, dataPortStatus=dataPortStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, signalStrengthRatio=signalStrengthRatio, transmitDataRate=transmitDataRate, sNMPEnabledTraps=sNMPEnabledTraps, licenceGroup=licenceGroup, dualPayload=dualPayload, noiseFloor=noiseFloor, alarmsGroup=alarmsGroup, wirelessLinkStatus=wirelessLinkStatus, configurationGroup=configurationGroup, pubStats=pubStats, aggregateDataRate=aggregateDataRate, smtp=smtp, searchState=searchState, installArmState=installArmState, ethernetGroup=ethernetGroup)
