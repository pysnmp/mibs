...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", extendedChannel=extendedChannel, linkLoss=linkLoss, searchState=searchState, sNMPCommunityTable=sNMPCommunityTable, sNMPCommunityAccess=sNMPCommunityAccess, siteName=siteName, linkStatusTrap=linkStatusTrap, sNMPCommunityTableEntry=sNMPCommunityTableEntry, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptpCompliance=ptpCompliance, antennaGain=antennaGain, dualPayload=dualPayload, management=management, subnetMask=subnetMask, nTPSync=nTPSync, sNMPCommunityString=sNMPCommunityString, ethernetGroup=ethernetGroup, managementGroup=managementGroup, configuration=configuration, signalStrengthRatio=signalStrengthRatio, sMTPEnabledMessages=sMTPEnabledMessages, ntp=ntp, sNMPTrapIPAddress=sNMPTrapIPAddress, bootVersion=bootVersion, maximumTransmitPower=maximumTransmitPower, softwareVersion=softwareVersion, currentChannel=currentChannel, fixedModMode=fixedModMode, extendedFreqMHz=extendedFreqMHz, ptpTraps=ptpTraps, installArmStateTrap=installArmStateTrap, currentFreqMHz=currentFreqMHz, wirelessLinkStatus=wirelessLinkStatus, cableLoss=cableLoss, sNMPCommunityTableIndex=sNMPCommunityTableIndex, nTPLastSync=nTPLastSync, configuredModulationMode=configuredModulationMode, licenceGroup=licenceGroup, ethernet=ethernet, smtpGroup=smtpGroup, transmitPower=transmitPower, remoteIPAddress=remoteIPAddress, versionsGroup=versionsGroup, vlanTagging=vlanTagging, regionCode=regionCode, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortStatusTrap=dataPortStatusTrap, snmpControlGroup=snmpControlGroup, smtp=smtp, radarDetectTrap=radarDetectTrap, phyStatus=phyStatus, band=band, notificationsGroup=notificationsGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, noiseFloor=noiseFloor, sNMPEnabledTraps=sNMPEnabledTraps, aggregateDataRate=aggregateDataRate, phyStatusGroup=phyStatusGroup, vectorError=vectorError, remoteMACAddress=remoteMACAddress, sNMPTrapTable=sNMPTrapTable, snmpControl=snmpControl, ptpTrapPrefix=ptpTrapPrefix, transmitDataRate=transmitDataRate, transmitModulationMode=transmitModulationMode, sNMPCommunityTableNumber=sNMPCommunityTableNumber, gatewayIPAddress=gatewayIPAddress, channelSelection=channelSelection, pubStats=pubStats, nTPPollInterval=nTPPollInterval, receiveDataRate=receiveDataRate, configuredRange=configuredRange, measuredRange=measuredRange, nTPServerPortNumber=nTPServerPortNumber, channelBandwidth=channelBandwidth, systemClock=systemClock, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, productVariant=productVariant, receiveModulationMode=receiveModulationMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortStatus=dataPortStatus, sNMPCommunityOid=sNMPCommunityOid, tFTPServerPortNumber=tFTPServerPortNumber, ptp=ptp, productName=productName, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, vlanPriority=vlanPriority, sMTPServerPortNumber=sMTPServerPortNumber, versions=versions, linkName=linkName, receivePower=receivePower, sNMPTrapTableIndex=sNMPTrapTableIndex, sMTPSourceEmailAddress=sMTPSourceEmailAddress, timeZone=timeZone, hardwareVersion=hardwareVersion, ptmp=ptmp, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPTrapVersion=sNMPTrapVersion, iPAddress=iPAddress, configurationGroup=configurationGroup, alarmsGroup=alarmsGroup, alarms=alarms, sNMPTrapCommunity=sNMPTrapCommunity, tFTPServerIPAddress=tFTPServerIPAddress, ntpGroup=ntpGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPServerIPAddress=sMTPServerIPAddress, nTPState=nTPState, ptp250=ptp250, dataPortAutoNegotiation=dataPortAutoNegotiation, nTPServerIp=nTPServerIp, sNMPTrapTableEntry=sNMPTrapTableEntry, cambium=cambium, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, masterSlaveMode=masterSlaveMode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, PYSNMP_MODULE_ID=cambium, licence=licence, radarDetectChannel=radarDetectChannel, pubStatsGroup=pubStatsGroup, ptpGroups=ptpGroups, vlanId=vlanId, installArmState=installArmState)
