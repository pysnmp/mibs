...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", productName=productName, nTPState=nTPState, ptp250=ptp250, sNMPTrapTableIndex=sNMPTrapTableIndex, signalStrengthRatio=signalStrengthRatio, licenceGroup=licenceGroup, PYSNMP_MODULE_ID=cambium, management=management, snmpControl=snmpControl, alarmsGroup=alarmsGroup, productVariant=productVariant, masterSlaveMode=masterSlaveMode, ptpTrapPrefix=ptpTrapPrefix, sNMPCommunityAccess=sNMPCommunityAccess, nTPServerIp=nTPServerIp, vlanId=vlanId, sMTPServerIPAddress=sMTPServerIPAddress, channelBandwidth=channelBandwidth, pubStats=pubStats, ntp=ntp, cableLoss=cableLoss, ethernetGroup=ethernetGroup, currentFreqMHz=currentFreqMHz, receiveModulationMode=receiveModulationMode, cambium=cambium, sMTPEnabledMessages=sMTPEnabledMessages, versions=versions, measuredRange=measuredRange, configuredModulationMode=configuredModulationMode, sNMPTrapTableNumber=sNMPTrapTableNumber, pubStatsGroup=pubStatsGroup, transmitModulationMode=transmitModulationMode, ptpTraps=ptpTraps, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, channelSelection=channelSelection, sNMPCommunityTableIndex=sNMPCommunityTableIndex, ntpGroup=ntpGroup, remoteMACAddress=remoteMACAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, configurationGroup=configurationGroup, receiveDataRate=receiveDataRate, configuration=configuration, dataPortStatusTrap=dataPortStatusTrap, vlanPriority=vlanPriority, dataPortStatus=dataPortStatus, installArmStateTrap=installArmStateTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, extendedFreqMHz=extendedFreqMHz, sNMPCommunityTableEntry=sNMPCommunityTableEntry, antennaGain=antennaGain, nTPPollInterval=nTPPollInterval, wirelessLinkStatus=wirelessLinkStatus, ptmp=ptmp, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, phyStatusGroup=phyStatusGroup, linkStatusTrap=linkStatusTrap, dualPayload=dualPayload, remoteIPAddress=remoteIPAddress, sNMPTrapTable=sNMPTrapTable, currentChannel=currentChannel, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, gatewayIPAddress=gatewayIPAddress, maximumTransmitPower=maximumTransmitPower, regionCode=regionCode, tFTPServerPortNumber=tFTPServerPortNumber, phyStatus=phyStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, vlanTagging=vlanTagging, licence=licence, snmpControlGroup=snmpControlGroup, extendedChannel=extendedChannel, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, nTPServerPortNumber=nTPServerPortNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptpCompliance=ptpCompliance, nTPLastSync=nTPLastSync, sNMPTrapVersion=sNMPTrapVersion, ptp=ptp, systemClock=systemClock, noiseFloor=noiseFloor, alarms=alarms, sNMPTrapTableEntry=sNMPTrapTableEntry, radarDetectChannel=radarDetectChannel, sNMPCommunityString=sNMPCommunityString, receivePower=receivePower, managementGroup=managementGroup, timeZone=timeZone, sNMPEnabledTraps=sNMPEnabledTraps, siteName=siteName, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sMTPServerPortNumber=sMTPServerPortNumber, subnetMask=subnetMask, nTPSync=nTPSync, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPCommunityTable=sNMPCommunityTable, hardwareVersion=hardwareVersion, ethernet=ethernet, tFTPServerIPAddress=tFTPServerIPAddress, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sNMPTrapCommunity=sNMPTrapCommunity, transmitDataRate=transmitDataRate, sNMPCommunityOid=sNMPCommunityOid, versionsGroup=versionsGroup, notificationsGroup=notificationsGroup, aggregateDataRate=aggregateDataRate, ptpGroups=ptpGroups, radarDetectTrap=radarDetectTrap, linkLoss=linkLoss, configuredRange=configuredRange, linkName=linkName, band=band, transmitPower=transmitPower, smtp=smtp, searchState=searchState, fixedModMode=fixedModMode, softwareVersion=softwareVersion, bootVersion=bootVersion, smtpGroup=smtpGroup, installArmState=installArmState, vectorError=vectorError, iPAddress=iPAddress)
