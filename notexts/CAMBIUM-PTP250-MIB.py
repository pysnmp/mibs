...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", transmitModulationMode=transmitModulationMode, channelSelection=channelSelection, receiveDataRate=receiveDataRate, vlanPriority=vlanPriority, sNMPCommunityOid=sNMPCommunityOid, licence=licence, nTPServerPortNumber=nTPServerPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, nTPLastSync=nTPLastSync, smtp=smtp, currentChannel=currentChannel, extendedFreqMHz=extendedFreqMHz, licenceGroup=licenceGroup, radarDetectTrap=radarDetectTrap, vlanTagging=vlanTagging, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, ptpTrapPrefix=ptpTrapPrefix, tFTPServerIPAddress=tFTPServerIPAddress, dataPortStatus=dataPortStatus, remoteMACAddress=remoteMACAddress, configuration=configuration, management=management, aggregateDataRate=aggregateDataRate, masterSlaveMode=masterSlaveMode, ptp=ptp, signalStrengthRatio=signalStrengthRatio, versionsGroup=versionsGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, bootVersion=bootVersion, wirelessLinkStatus=wirelessLinkStatus, PYSNMP_MODULE_ID=cambium, sNMPTrapVersion=sNMPTrapVersion, band=band, alarmsGroup=alarmsGroup, productName=productName, nTPServerIp=nTPServerIp, sMTPServerIPAddress=sMTPServerIPAddress, channelBandwidth=channelBandwidth, receiveModulationMode=receiveModulationMode, sNMPTrapCommunity=sNMPTrapCommunity, nTPPollInterval=nTPPollInterval, smtpGroup=smtpGroup, snmpControl=snmpControl, systemClock=systemClock, regionCode=regionCode, nTPSync=nTPSync, transmitDataRate=transmitDataRate, ptmp=ptmp, vlanId=vlanId, installArmState=installArmState, remoteIPAddress=remoteIPAddress, vectorError=vectorError, phyStatus=phyStatus, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, receivePower=receivePower, phyStatusGroup=phyStatusGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, ntp=ntp, configuredRange=configuredRange, noiseFloor=noiseFloor, sNMPTrapPortNumber=sNMPTrapPortNumber, ntpGroup=ntpGroup, sNMPCommunityAccess=sNMPCommunityAccess, transmitPower=transmitPower, managementGroup=managementGroup, fixedModMode=fixedModMode, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPEnabledTraps=sNMPEnabledTraps, antennaGain=antennaGain, sNMPTrapTable=sNMPTrapTable, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, noWirelessChannelAvailable=noWirelessChannelAvailable, timeZone=timeZone, sNMPCommunityTableEntry=sNMPCommunityTableEntry, ptpTraps=ptpTraps, configurationGroup=configurationGroup, ethernet=ethernet, tFTPServerPortNumber=tFTPServerPortNumber, radarDetectChannel=radarDetectChannel, sNMPCommunityTableNumber=sNMPCommunityTableNumber, alarms=alarms, softwareVersion=softwareVersion, subnetMask=subnetMask, measuredRange=measuredRange, sMTPServerPortNumber=sMTPServerPortNumber, gatewayIPAddress=gatewayIPAddress, pubStatsGroup=pubStatsGroup, snmpControlGroup=snmpControlGroup, productVariant=productVariant, ethernetGroup=ethernetGroup, hardwareVersion=hardwareVersion, linkLoss=linkLoss, ptpCompliance=ptpCompliance, iPAddress=iPAddress, linkStatusTrap=linkStatusTrap, ptp250=ptp250, dualPayload=dualPayload, configuredModulationMode=configuredModulationMode, maximumTransmitPower=maximumTransmitPower, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapIPAddress=sNMPTrapIPAddress, installArmStateTrap=installArmStateTrap, versions=versions, dataPortStatusTrap=dataPortStatusTrap, nTPState=nTPState, searchState=searchState, cableLoss=cableLoss, siteName=siteName, sNMPCommunityTable=sNMPCommunityTable, sNMPCommunityTableIndex=sNMPCommunityTableIndex, pubStats=pubStats, sNMPTrapTableEntry=sNMPTrapTableEntry, ptpGroups=ptpGroups, linkName=linkName, sNMPCommunityString=sNMPCommunityString, dataPortAutoNegotiation=dataPortAutoNegotiation, currentFreqMHz=currentFreqMHz, extendedChannel=extendedChannel, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, notificationsGroup=notificationsGroup, cambium=cambium)
