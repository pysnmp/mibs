...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", masterSlaveMode=masterSlaveMode, channelSelection=channelSelection, vlanId=vlanId, dataPortStatusTrap=dataPortStatusTrap, ptpGroups=ptpGroups, iPAddress=iPAddress, remoteMACAddress=remoteMACAddress, nTPState=nTPState, nTPServerIp=nTPServerIp, smtpGroup=smtpGroup, signalStrengthRatio=signalStrengthRatio, gatewayIPAddress=gatewayIPAddress, management=management, configurationGroup=configurationGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, receivePower=receivePower, ptmp=ptmp, transmitDataRate=transmitDataRate, cambium=cambium, sNMPCommunityTableIndex=sNMPCommunityTableIndex, tFTPServerIPAddress=tFTPServerIPAddress, smtp=smtp, sNMPCommunityString=sNMPCommunityString, vectorError=vectorError, sNMPCommunityOid=sNMPCommunityOid, productVariant=productVariant, alarms=alarms, antennaGain=antennaGain, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, receiveModulationMode=receiveModulationMode, cableLoss=cableLoss, sMTPServerIPAddress=sMTPServerIPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptpCompliance=ptpCompliance, dataPortAutoNegotiation=dataPortAutoNegotiation, licence=licence, pubStats=pubStats, linkName=linkName, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sNMPTrapCommunity=sNMPTrapCommunity, dataPortStatus=dataPortStatus, ptp250=ptp250, sNMPTrapTableNumber=sNMPTrapTableNumber, notificationsGroup=notificationsGroup, subnetMask=subnetMask, ethernet=ethernet, linkLoss=linkLoss, regionCode=regionCode, transmitModulationMode=transmitModulationMode, timeZone=timeZone, sNMPTrapIPAddress=sNMPTrapIPAddress, noiseFloor=noiseFloor, sMTPEnabledMessages=sMTPEnabledMessages, nTPLastSync=nTPLastSync, ptp=ptp, extendedFreqMHz=extendedFreqMHz, nTPSync=nTPSync, searchState=searchState, ptpTraps=ptpTraps, nTPPollInterval=nTPPollInterval, extendedChannel=extendedChannel, configuredModulationMode=configuredModulationMode, aggregateDataRate=aggregateDataRate, currentFreqMHz=currentFreqMHz, configuredRange=configuredRange, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, band=band, installArmStateTrap=installArmStateTrap, snmpControl=snmpControl, sNMPTrapTable=sNMPTrapTable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, receiveDataRate=receiveDataRate, fixedModMode=fixedModMode, PYSNMP_MODULE_ID=cambium, vlanTagging=vlanTagging, siteName=siteName, phyStatus=phyStatus, sNMPCommunityAccess=sNMPCommunityAccess, licenceGroup=licenceGroup, pubStatsGroup=pubStatsGroup, radarDetectTrap=radarDetectTrap, managementGroup=managementGroup, sNMPTrapVersion=sNMPTrapVersion, versions=versions, ethernetGroup=ethernetGroup, currentChannel=currentChannel, remoteIPAddress=remoteIPAddress, phyStatusGroup=phyStatusGroup, bootVersion=bootVersion, installArmState=installArmState, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, versionsGroup=versionsGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, nTPServerPortNumber=nTPServerPortNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPServerPortNumber=tFTPServerPortNumber, wirelessLinkStatus=wirelessLinkStatus, ntpGroup=ntpGroup, hardwareVersion=hardwareVersion, configuration=configuration, softwareVersion=softwareVersion, systemClock=systemClock, sNMPCommunityTable=sNMPCommunityTable, dualPayload=dualPayload, sNMPTrapPortNumber=sNMPTrapPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, radarDetectChannel=radarDetectChannel, linkStatusTrap=linkStatusTrap, alarmsGroup=alarmsGroup, sMTPServerPortNumber=sMTPServerPortNumber, snmpControlGroup=snmpControlGroup, channelBandwidth=channelBandwidth, transmitPower=transmitPower, productName=productName, maximumTransmitPower=maximumTransmitPower, measuredRange=measuredRange, ptpTrapPrefix=ptpTrapPrefix, sNMPEnabledTraps=sNMPEnabledTraps, sNMPCommunityTableEntry=sNMPCommunityTableEntry, vlanPriority=vlanPriority, ntp=ntp)
