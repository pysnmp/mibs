...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", snmpControlGroup=snmpControlGroup, radarDetectChannel=radarDetectChannel, extendedFreqMHz=extendedFreqMHz, ptp250=ptp250, nTPSync=nTPSync, linkStatusTrap=linkStatusTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPCommunityTable=sNMPCommunityTable, siteName=siteName, tFTPServerPortNumber=tFTPServerPortNumber, managementGroup=managementGroup, vectorError=vectorError, nTPLastSync=nTPLastSync, receiveModulationMode=receiveModulationMode, measuredRange=measuredRange, timeZone=timeZone, bootVersion=bootVersion, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPServerIPAddress=tFTPServerIPAddress, smtpGroup=smtpGroup, nTPServerPortNumber=nTPServerPortNumber, subnetMask=subnetMask, notificationsGroup=notificationsGroup, cableLoss=cableLoss, productVariant=productVariant, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, phyStatus=phyStatus, sNMPEnabledTraps=sNMPEnabledTraps, vlanPriority=vlanPriority, management=management, sNMPCommunityString=sNMPCommunityString, radarDetectTrap=radarDetectTrap, ptpTrapPrefix=ptpTrapPrefix, sNMPCommunityAccess=sNMPCommunityAccess, transmitPower=transmitPower, noWirelessChannelAvailable=noWirelessChannelAvailable, ptpCompliance=ptpCompliance, sNMPTrapIPAddress=sNMPTrapIPAddress, versions=versions, wirelessLinkStatus=wirelessLinkStatus, regionCode=regionCode, ptpTraps=ptpTraps, licenceGroup=licenceGroup, snmpControl=snmpControl, configurationGroup=configurationGroup, sMTPServerPortNumber=sMTPServerPortNumber, sNMPCommunityTableNumber=sNMPCommunityTableNumber, linkLoss=linkLoss, currentChannel=currentChannel, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, noiseFloor=noiseFloor, sNMPTrapTableNumber=sNMPTrapTableNumber, ntp=ntp, dataPortAutoNegotiation=dataPortAutoNegotiation, systemClock=systemClock, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sNMPTrapTableIndex=sNMPTrapTableIndex, vlanId=vlanId, remoteIPAddress=remoteIPAddress, transmitDataRate=transmitDataRate, searchState=searchState, ptp=ptp, channelSelection=channelSelection, nTPServerIp=nTPServerIp, sMTPEnabledMessages=sMTPEnabledMessages, alarmsGroup=alarmsGroup, receivePower=receivePower, antennaGain=antennaGain, sNMPTrapCommunity=sNMPTrapCommunity, sNMPTrapVersion=sNMPTrapVersion, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, alarms=alarms, configuredModulationMode=configuredModulationMode, iPAddress=iPAddress, PYSNMP_MODULE_ID=cambium, dualPayload=dualPayload, softwareVersion=softwareVersion, licence=licence, pubStatsGroup=pubStatsGroup, linkName=linkName, configuration=configuration, phyStatusGroup=phyStatusGroup, signalStrengthRatio=signalStrengthRatio, aggregateDataRate=aggregateDataRate, pubStats=pubStats, masterSlaveMode=masterSlaveMode, ntpGroup=ntpGroup, receiveDataRate=receiveDataRate, currentFreqMHz=currentFreqMHz, transmitModulationMode=transmitModulationMode, smtp=smtp, channelBandwidth=channelBandwidth, sNMPTrapTableEntry=sNMPTrapTableEntry, ptpGroups=ptpGroups, nTPPollInterval=nTPPollInterval, hardwareVersion=hardwareVersion, sMTPServerIPAddress=sMTPServerIPAddress, versionsGroup=versionsGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPCommunityOid=sNMPCommunityOid, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortStatus=dataPortStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernet=ethernet, installArmStateTrap=installArmStateTrap, gatewayIPAddress=gatewayIPAddress, remoteMACAddress=remoteMACAddress, band=band, sNMPCommunityTableIndex=sNMPCommunityTableIndex, maximumTransmitPower=maximumTransmitPower, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, configuredRange=configuredRange, ptmp=ptmp, cambium=cambium, nTPState=nTPState, vlanTagging=vlanTagging, sNMPTrapTable=sNMPTrapTable, fixedModMode=fixedModMode, productName=productName, extendedChannel=extendedChannel, ethernetGroup=ethernetGroup, installArmState=installArmState, dataPortStatusTrap=dataPortStatusTrap)
