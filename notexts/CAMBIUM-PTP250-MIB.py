...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPCommunityString=sNMPCommunityString, sNMPTrapTableIndex=sNMPTrapTableIndex, PYSNMP_MODULE_ID=cambium, sNMPTrapTableEntry=sNMPTrapTableEntry, transmitModulationMode=transmitModulationMode, ptp=ptp, versions=versions, smtpGroup=smtpGroup, licence=licence, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapCommunity=sNMPTrapCommunity, ptpGroups=ptpGroups, vlanTagging=vlanTagging, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, subnetMask=subnetMask, currentChannel=currentChannel, vectorError=vectorError, nTPSync=nTPSync, searchState=searchState, configuration=configuration, vlanPriority=vlanPriority, snmpControl=snmpControl, ntpGroup=ntpGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ptpTrapPrefix=ptpTrapPrefix, sNMPCommunityOid=sNMPCommunityOid, linkStatusTrap=linkStatusTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, timeZone=timeZone, channelBandwidth=channelBandwidth, radarDetectChannel=radarDetectChannel, transmitDataRate=transmitDataRate, sNMPCommunityTableEntry=sNMPCommunityTableEntry, ethernet=ethernet, sNMPCommunityTableNumber=sNMPCommunityTableNumber, dualPayload=dualPayload, phyStatusGroup=phyStatusGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transmitPower=transmitPower, wirelessLinkStatus=wirelessLinkStatus, sNMPCommunityTable=sNMPCommunityTable, gatewayIPAddress=gatewayIPAddress, configurationGroup=configurationGroup, sNMPCommunityTableIndex=sNMPCommunityTableIndex, dataPortStatusTrap=dataPortStatusTrap, fixedModMode=fixedModMode, receiveDataRate=receiveDataRate, productName=productName, ptp250=ptp250, vlanId=vlanId, productVariant=productVariant, ptmp=ptmp, remoteIPAddress=remoteIPAddress, softwareVersion=softwareVersion, regionCode=regionCode, configuredModulationMode=configuredModulationMode, systemClock=systemClock, maximumTransmitPower=maximumTransmitPower, sNMPEnabledTraps=sNMPEnabledTraps, managementGroup=managementGroup, linkName=linkName, aggregateDataRate=aggregateDataRate, phyStatus=phyStatus, linkLoss=linkLoss, iPAddress=iPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPServerIPAddress=sMTPServerIPAddress, channelSelection=channelSelection, sMTPSourceEmailAddress=sMTPSourceEmailAddress, alarmsGroup=alarmsGroup, sMTPServerPortNumber=sMTPServerPortNumber, nTPState=nTPState, siteName=siteName, versionsGroup=versionsGroup, sNMPTrapTable=sNMPTrapTable, notificationsGroup=notificationsGroup, snmpControlGroup=snmpControlGroup, alarms=alarms, nTPLastSync=nTPLastSync, tFTPServerIPAddress=tFTPServerIPAddress, smtp=smtp, nTPServerPortNumber=nTPServerPortNumber, radarDetectTrap=radarDetectTrap, signalStrengthRatio=signalStrengthRatio, ntp=ntp, management=management, receivePower=receivePower, cambium=cambium, noiseFloor=noiseFloor, ethernetGroup=ethernetGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, band=band, installArmStateTrap=installArmStateTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapVersion=sNMPTrapVersion, hardwareVersion=hardwareVersion, installArmState=installArmState, remoteMACAddress=remoteMACAddress, tFTPServerPortNumber=tFTPServerPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, receiveModulationMode=receiveModulationMode, ptpCompliance=ptpCompliance, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPCommunityAccess=sNMPCommunityAccess, currentFreqMHz=currentFreqMHz, measuredRange=measuredRange, pubStats=pubStats, cableLoss=cableLoss, extendedChannel=extendedChannel, antennaGain=antennaGain, masterSlaveMode=masterSlaveMode, nTPPollInterval=nTPPollInterval, dataPortStatus=dataPortStatus, nTPServerIp=nTPServerIp, noWirelessChannelAvailable=noWirelessChannelAvailable, configuredRange=configuredRange, extendedFreqMHz=extendedFreqMHz, bootVersion=bootVersion, licenceGroup=licenceGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, pubStatsGroup=pubStatsGroup, ptpTraps=ptpTraps)
