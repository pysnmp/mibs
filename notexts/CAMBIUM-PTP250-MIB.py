...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", configuredModulationMode=configuredModulationMode, sNMPEnabledTraps=sNMPEnabledTraps, ethernet=ethernet, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapTableEntry=sNMPTrapTableEntry, timeZone=timeZone, regionCode=regionCode, ethernetGroup=ethernetGroup, antennaGain=antennaGain, softwareVersion=softwareVersion, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, radarDetectTrap=radarDetectTrap, sNMPCommunityTable=sNMPCommunityTable, radarDetectChannel=radarDetectChannel, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, subnetMask=subnetMask, licenceGroup=licenceGroup, cableLoss=cableLoss, extendedFreqMHz=extendedFreqMHz, productVariant=productVariant, cambium=cambium, receiveModulationMode=receiveModulationMode, sNMPTrapVersion=sNMPTrapVersion, linkLoss=linkLoss, sNMPTrapCommunity=sNMPTrapCommunity, nTPPollInterval=nTPPollInterval, masterSlaveMode=masterSlaveMode, management=management, sNMPCommunityString=sNMPCommunityString, transmitDataRate=transmitDataRate, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, vlanId=vlanId, receiveDataRate=receiveDataRate, ptpGroups=ptpGroups, tFTPServerIPAddress=tFTPServerIPAddress, snmpControl=snmpControl, noWirelessChannelAvailable=noWirelessChannelAvailable, versionsGroup=versionsGroup, sNMPCommunityAccess=sNMPCommunityAccess, extendedChannel=extendedChannel, searchState=searchState, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, licence=licence, siteName=siteName, receivePower=receivePower, productName=productName, signalStrengthRatio=signalStrengthRatio, sMTPServerIPAddress=sMTPServerIPAddress, dataPortStatusTrap=dataPortStatusTrap, gatewayIPAddress=gatewayIPAddress, maximumTransmitPower=maximumTransmitPower, channelBandwidth=channelBandwidth, transmitPower=transmitPower, notificationsGroup=notificationsGroup, alarms=alarms, sMTPEnabledMessages=sMTPEnabledMessages, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, linkName=linkName, versions=versions, transmitModulationMode=transmitModulationMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ptpTraps=ptpTraps, sMTPServerPortNumber=sMTPServerPortNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPCommunityOid=sNMPCommunityOid, sNMPCommunityTableEntry=sNMPCommunityTableEntry, dualPayload=dualPayload, pubStats=pubStats, vectorError=vectorError, bootVersion=bootVersion, dataPortStatus=dataPortStatus, vlanPriority=vlanPriority, sNMPCommunityTableIndex=sNMPCommunityTableIndex, nTPSync=nTPSync, smtpGroup=smtpGroup, installArmState=installArmState, dataPortAutoNegotiation=dataPortAutoNegotiation, noiseFloor=noiseFloor, sNMPTrapPortNumber=sNMPTrapPortNumber, channelSelection=channelSelection, PYSNMP_MODULE_ID=cambium, band=band, ptpTrapPrefix=ptpTrapPrefix, hardwareVersion=hardwareVersion, wirelessLinkStatus=wirelessLinkStatus, installArmStateTrap=installArmStateTrap, sNMPTrapTable=sNMPTrapTable, sNMPTrapTableNumber=sNMPTrapTableNumber, remoteIPAddress=remoteIPAddress, nTPState=nTPState, phyStatusGroup=phyStatusGroup, configuration=configuration, measuredRange=measuredRange, pubStatsGroup=pubStatsGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, vlanTagging=vlanTagging, systemClock=systemClock, ptp=ptp, currentFreqMHz=currentFreqMHz, nTPLastSync=nTPLastSync, ntp=ntp, smtp=smtp, remoteMACAddress=remoteMACAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, nTPServerPortNumber=nTPServerPortNumber, phyStatus=phyStatus, nTPServerIp=nTPServerIp, aggregateDataRate=aggregateDataRate, snmpControlGroup=snmpControlGroup, sNMPCommunityTableNumber=sNMPCommunityTableNumber, fixedModMode=fixedModMode, ntpGroup=ntpGroup, linkStatusTrap=linkStatusTrap, currentChannel=currentChannel, iPAddress=iPAddress, ptpCompliance=ptpCompliance, configuredRange=configuredRange, managementGroup=managementGroup, ptmp=ptmp, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptp250=ptp250, configurationGroup=configurationGroup, alarmsGroup=alarmsGroup)
