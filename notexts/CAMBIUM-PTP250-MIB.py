...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", ptp=ptp, systemClock=systemClock, vectorError=vectorError, installArmState=installArmState, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, band=band, channelBandwidth=channelBandwidth, transmitDataRate=transmitDataRate, measuredRange=measuredRange, searchState=searchState, regionCode=regionCode, receivePower=receivePower, sNMPTrapVersion=sNMPTrapVersion, linkStatusTrap=linkStatusTrap, nTPSync=nTPSync, sNMPTrapTableEntry=sNMPTrapTableEntry, ethernet=ethernet, pubStatsGroup=pubStatsGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, radarDetectTrap=radarDetectTrap, snmpControl=snmpControl, vlanPriority=vlanPriority, sNMPEnabledTraps=sNMPEnabledTraps, configuration=configuration, productVariant=productVariant, nTPServerIp=nTPServerIp, phyStatusGroup=phyStatusGroup, ptpCompliance=ptpCompliance, gatewayIPAddress=gatewayIPAddress, linkName=linkName, currentFreqMHz=currentFreqMHz, snmpControlGroup=snmpControlGroup, wirelessLinkStatus=wirelessLinkStatus, dualPayload=dualPayload, signalStrengthRatio=signalStrengthRatio, sNMPCommunityAccess=sNMPCommunityAccess, configuredRange=configuredRange, ptpTraps=ptpTraps, productName=productName, sNMPCommunityString=sNMPCommunityString, phyStatus=phyStatus, siteName=siteName, antennaGain=antennaGain, sNMPTrapPortNumber=sNMPTrapPortNumber, installArmStateTrap=installArmStateTrap, configuredModulationMode=configuredModulationMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, smtpGroup=smtpGroup, receiveModulationMode=receiveModulationMode, sNMPTrapTableNumber=sNMPTrapTableNumber, maximumTransmitPower=maximumTransmitPower, smtp=smtp, managementGroup=managementGroup, sNMPCommunityTable=sNMPCommunityTable, ethernetGroup=ethernetGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapCommunity=sNMPTrapCommunity, dataPortStatusTrap=dataPortStatusTrap, iPAddress=iPAddress, ptmp=ptmp, nTPServerPortNumber=nTPServerPortNumber, remoteMACAddress=remoteMACAddress, channelSelection=channelSelection, versions=versions, sNMPTrapTable=sNMPTrapTable, noiseFloor=noiseFloor, licence=licence, licenceGroup=licenceGroup, remoteIPAddress=remoteIPAddress, pubStats=pubStats, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sNMPCommunityTableEntry=sNMPCommunityTableEntry, PYSNMP_MODULE_ID=cambium, linkLoss=linkLoss, dataPortStatus=dataPortStatus, vlanId=vlanId, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPServerPortNumber=tFTPServerPortNumber, ntp=ntp, fixedModMode=fixedModMode, dataPortAutoNegotiation=dataPortAutoNegotiation, ptpTrapPrefix=ptpTrapPrefix, transmitPower=transmitPower, nTPState=nTPState, nTPLastSync=nTPLastSync, cambium=cambium, nTPPollInterval=nTPPollInterval, vlanTagging=vlanTagging, alarmsGroup=alarmsGroup, hardwareVersion=hardwareVersion, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, softwareVersion=softwareVersion, extendedFreqMHz=extendedFreqMHz, sNMPCommunityTableIndex=sNMPCommunityTableIndex, management=management, configurationGroup=configurationGroup, tFTPServerIPAddress=tFTPServerIPAddress, alarms=alarms, sNMPCommunityOid=sNMPCommunityOid, radarDetectChannel=radarDetectChannel, cableLoss=cableLoss, bootVersion=bootVersion, extendedChannel=extendedChannel, timeZone=timeZone, currentChannel=currentChannel, masterSlaveMode=masterSlaveMode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, subnetMask=subnetMask, sMTPEnabledMessages=sMTPEnabledMessages, receiveDataRate=receiveDataRate, sNMPTrapTableIndex=sNMPTrapTableIndex, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, notificationsGroup=notificationsGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, sMTPServerPortNumber=sMTPServerPortNumber, ptp250=ptp250, versionsGroup=versionsGroup, sMTPServerIPAddress=sMTPServerIPAddress, ptpGroups=ptpGroups, transmitModulationMode=transmitModulationMode, ntpGroup=ntpGroup, aggregateDataRate=aggregateDataRate)
