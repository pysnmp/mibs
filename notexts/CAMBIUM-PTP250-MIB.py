...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", ptpTraps=ptpTraps, ptpCompliance=ptpCompliance, versions=versions, nTPLastSync=nTPLastSync, hardwareVersion=hardwareVersion, maximumTransmitPower=maximumTransmitPower, radarDetectTrap=radarDetectTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPEnabledTraps=sNMPEnabledTraps, versionsGroup=versionsGroup, cableLoss=cableLoss, transmitPower=transmitPower, vectorError=vectorError, sNMPTrapCommunity=sNMPTrapCommunity, ptpTrapPrefix=ptpTrapPrefix, sMTPServerIPAddress=sMTPServerIPAddress, noiseFloor=noiseFloor, extendedFreqMHz=extendedFreqMHz, linkName=linkName, ethernet=ethernet, snmpControl=snmpControl, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, bootVersion=bootVersion, measuredRange=measuredRange, regionCode=regionCode, productVariant=productVariant, alarmsGroup=alarmsGroup, signalStrengthRatio=signalStrengthRatio, channelBandwidth=channelBandwidth, sMTPServerPortNumber=sMTPServerPortNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, remoteMACAddress=remoteMACAddress, radarDetectChannel=radarDetectChannel, nTPServerPortNumber=nTPServerPortNumber, cambium=cambium, ptp250=ptp250, sNMPTrapTableEntry=sNMPTrapTableEntry, siteName=siteName, PYSNMP_MODULE_ID=cambium, gatewayIPAddress=gatewayIPAddress, sNMPTrapTable=sNMPTrapTable, configurationGroup=configurationGroup, vlanPriority=vlanPriority, smtp=smtp, nTPState=nTPState, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, transmitModulationMode=transmitModulationMode, pubStats=pubStats, nTPServerIp=nTPServerIp, currentChannel=currentChannel, nTPPollInterval=nTPPollInterval, alarms=alarms, receiveModulationMode=receiveModulationMode, receiveDataRate=receiveDataRate, dataPortStatusTrap=dataPortStatusTrap, linkStatusTrap=linkStatusTrap, subnetMask=subnetMask, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPCommunityOid=sNMPCommunityOid, iPAddress=iPAddress, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapTableIndex=sNMPTrapTableIndex, licence=licence, licenceGroup=licenceGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, snmpControlGroup=snmpControlGroup, notificationsGroup=notificationsGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapVersion=sNMPTrapVersion, sNMPCommunityTableNumber=sNMPCommunityTableNumber, systemClock=systemClock, sNMPTrapIPAddress=sNMPTrapIPAddress, linkLoss=linkLoss, transmitDataRate=transmitDataRate, dataPortStatus=dataPortStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tFTPServerIPAddress=tFTPServerIPAddress, channelSelection=channelSelection, ntp=ntp, ntpGroup=ntpGroup, phyStatus=phyStatus, pubStatsGroup=pubStatsGroup, receivePower=receivePower, configuration=configuration, smtpGroup=smtpGroup, remoteIPAddress=remoteIPAddress, fixedModMode=fixedModMode, sNMPCommunityTableIndex=sNMPCommunityTableIndex, aggregateDataRate=aggregateDataRate, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ptmp=ptmp, softwareVersion=softwareVersion, sNMPCommunityTable=sNMPCommunityTable, wirelessLinkStatus=wirelessLinkStatus, sNMPCommunityTableEntry=sNMPCommunityTableEntry, management=management, productName=productName, installArmStateTrap=installArmStateTrap, masterSlaveMode=masterSlaveMode, band=band, vlanTagging=vlanTagging, ethernetGroup=ethernetGroup, managementGroup=managementGroup, antennaGain=antennaGain, tFTPServerPortNumber=tFTPServerPortNumber, ptpGroups=ptpGroups, sNMPCommunityString=sNMPCommunityString, ptp=ptp, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, phyStatusGroup=phyStatusGroup, searchState=searchState, dualPayload=dualPayload, sNMPCommunityAccess=sNMPCommunityAccess, timeZone=timeZone, configuredModulationMode=configuredModulationMode, vlanId=vlanId, configuredRange=configuredRange, extendedChannel=extendedChannel, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, installArmState=installArmState, nTPSync=nTPSync, currentFreqMHz=currentFreqMHz)
