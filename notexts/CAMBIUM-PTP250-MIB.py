...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", maximumTransmitPower=maximumTransmitPower, vlanId=vlanId, ptpTrapPrefix=ptpTrapPrefix, aggregateDataRate=aggregateDataRate, productVariant=productVariant, sNMPTrapTableIndex=sNMPTrapTableIndex, installArmStateTrap=installArmStateTrap, ptpGroups=ptpGroups, configuration=configuration, band=band, dataPortStatusTrap=dataPortStatusTrap, tFTPServerIPAddress=tFTPServerIPAddress, sNMPCommunityTableEntry=sNMPCommunityTableEntry, transmitDataRate=transmitDataRate, signalStrengthRatio=signalStrengthRatio, sNMPTrapTableNumber=sNMPTrapTableNumber, masterSlaveMode=masterSlaveMode, sNMPTrapIPAddress=sNMPTrapIPAddress, ptp250=ptp250, dualPayload=dualPayload, nTPServerIp=nTPServerIp, cableLoss=cableLoss, sMTPSourceEmailAddress=sMTPSourceEmailAddress, managementGroup=managementGroup, sNMPTrapTable=sNMPTrapTable, configuredModulationMode=configuredModulationMode, nTPState=nTPState, configuredRange=configuredRange, timeZone=timeZone, siteName=siteName, remoteIPAddress=remoteIPAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, remoteMACAddress=remoteMACAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, fixedModMode=fixedModMode, ptp=ptp, receiveModulationMode=receiveModulationMode, receiveDataRate=receiveDataRate, ntpGroup=ntpGroup, sNMPCommunityAccess=sNMPCommunityAccess, noiseFloor=noiseFloor, sNMPCommunityTable=sNMPCommunityTable, radarDetectChannel=radarDetectChannel, regionCode=regionCode, vectorError=vectorError, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, snmpControlGroup=snmpControlGroup, hardwareVersion=hardwareVersion, sNMPTrapTableEntry=sNMPTrapTableEntry, licenceGroup=licenceGroup, iPAddress=iPAddress, vlanTagging=vlanTagging, vlanPriority=vlanPriority, radarDetectTrap=radarDetectTrap, snmpControl=snmpControl, linkName=linkName, sMTPEnabledMessages=sMTPEnabledMessages, extendedFreqMHz=extendedFreqMHz, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapPortNumber=sNMPTrapPortNumber, transmitModulationMode=transmitModulationMode, extendedChannel=extendedChannel, receivePower=receivePower, versions=versions, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, antennaGain=antennaGain, ethernet=ethernet, sNMPCommunityTableIndex=sNMPCommunityTableIndex, dataPortStatus=dataPortStatus, gatewayIPAddress=gatewayIPAddress, installArmState=installArmState, productName=productName, sMTPServerIPAddress=sMTPServerIPAddress, sMTPServerPortNumber=sMTPServerPortNumber, management=management, nTPPollInterval=nTPPollInterval, systemClock=systemClock, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, alarms=alarms, phyStatusGroup=phyStatusGroup, cambium=cambium, smtpGroup=smtpGroup, subnetMask=subnetMask, nTPLastSync=nTPLastSync, versionsGroup=versionsGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, notificationsGroup=notificationsGroup, phyStatus=phyStatus, pubStatsGroup=pubStatsGroup, smtp=smtp, linkLoss=linkLoss, channelBandwidth=channelBandwidth, configurationGroup=configurationGroup, currentFreqMHz=currentFreqMHz, ptpCompliance=ptpCompliance, wirelessLinkStatus=wirelessLinkStatus, channelSelection=channelSelection, ntp=ntp, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ptpTraps=ptpTraps, ethernetGroup=ethernetGroup, currentChannel=currentChannel, ptmp=ptmp, searchState=searchState, sNMPCommunityOid=sNMPCommunityOid, tFTPServerPortNumber=tFTPServerPortNumber, sNMPCommunityString=sNMPCommunityString, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapCommunity=sNMPTrapCommunity, PYSNMP_MODULE_ID=cambium, nTPServerPortNumber=nTPServerPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, nTPSync=nTPSync, softwareVersion=softwareVersion, sNMPCommunityTableNumber=sNMPCommunityTableNumber, pubStats=pubStats, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapVersion=sNMPTrapVersion, licence=licence, bootVersion=bootVersion, measuredRange=measuredRange, linkStatusTrap=linkStatusTrap, transmitPower=transmitPower, alarmsGroup=alarmsGroup)
