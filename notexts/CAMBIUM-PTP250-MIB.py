...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", linkLoss=linkLoss, smtp=smtp, searchState=searchState, sMTPServerPortNumber=sMTPServerPortNumber, sNMPCommunityString=sNMPCommunityString, noiseFloor=noiseFloor, ptpGroups=ptpGroups, configuredRange=configuredRange, vlanPriority=vlanPriority, vlanTagging=vlanTagging, channelBandwidth=channelBandwidth, nTPPollInterval=nTPPollInterval, sNMPEnabledTraps=sNMPEnabledTraps, systemClock=systemClock, notificationsGroup=notificationsGroup, sMTPServerIPAddress=sMTPServerIPAddress, configurationGroup=configurationGroup, fixedModMode=fixedModMode, installArmStateTrap=installArmStateTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapIPAddress=sNMPTrapIPAddress, hardwareVersion=hardwareVersion, receivePower=receivePower, gatewayIPAddress=gatewayIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, snmpControl=snmpControl, tFTPServerPortNumber=tFTPServerPortNumber, vectorError=vectorError, siteName=siteName, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, currentChannel=currentChannel, iPAddress=iPAddress, sNMPCommunityAccess=sNMPCommunityAccess, linkStatusTrap=linkStatusTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapCommunity=sNMPTrapCommunity, extendedChannel=extendedChannel, receiveDataRate=receiveDataRate, sNMPTrapPortNumber=sNMPTrapPortNumber, ntp=ntp, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, aggregateDataRate=aggregateDataRate, softwareVersion=softwareVersion, ethernet=ethernet, band=band, management=management, managementGroup=managementGroup, ptpTraps=ptpTraps, radarDetectChannel=radarDetectChannel, sNMPTrapTable=sNMPTrapTable, tFTPServerIPAddress=tFTPServerIPAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPCommunityOid=sNMPCommunityOid, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, licence=licence, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, transmitPower=transmitPower, antennaGain=antennaGain, pubStatsGroup=pubStatsGroup, wirelessLinkStatus=wirelessLinkStatus, installArmState=installArmState, sNMPCommunityTable=sNMPCommunityTable, nTPServerPortNumber=nTPServerPortNumber, ptp=ptp, bootVersion=bootVersion, configuration=configuration, noWirelessChannelAvailable=noWirelessChannelAvailable, currentFreqMHz=currentFreqMHz, PYSNMP_MODULE_ID=cambium, remoteIPAddress=remoteIPAddress, extendedFreqMHz=extendedFreqMHz, nTPState=nTPState, transmitDataRate=transmitDataRate, masterSlaveMode=masterSlaveMode, sNMPCommunityTableNumber=sNMPCommunityTableNumber, measuredRange=measuredRange, phyStatusGroup=phyStatusGroup, licenceGroup=licenceGroup, radarDetectTrap=radarDetectTrap, sNMPTrapVersion=sNMPTrapVersion, signalStrengthRatio=signalStrengthRatio, ntpGroup=ntpGroup, ethernetGroup=ethernetGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, productVariant=productVariant, versions=versions, maximumTransmitPower=maximumTransmitPower, vlanId=vlanId, versionsGroup=versionsGroup, remoteMACAddress=remoteMACAddress, cambium=cambium, receiveModulationMode=receiveModulationMode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, pubStats=pubStats, nTPSync=nTPSync, transmitModulationMode=transmitModulationMode, dualPayload=dualPayload, alarms=alarms, sMTPEnabledMessages=sMTPEnabledMessages, ptmp=ptmp, sNMPCommunityTableEntry=sNMPCommunityTableEntry, ptp250=ptp250, ptpTrapPrefix=ptpTrapPrefix, linkName=linkName, dataPortStatusTrap=dataPortStatusTrap, dataPortStatus=dataPortStatus, subnetMask=subnetMask, ptpCompliance=ptpCompliance, timeZone=timeZone, phyStatus=phyStatus, alarmsGroup=alarmsGroup, sNMPCommunityTableIndex=sNMPCommunityTableIndex, snmpControlGroup=snmpControlGroup, smtpGroup=smtpGroup, cableLoss=cableLoss, productName=productName, nTPServerIp=nTPServerIp, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, regionCode=regionCode, channelSelection=channelSelection, nTPLastSync=nTPLastSync, sNMPTrapTableEntry=sNMPTrapTableEntry, configuredModulationMode=configuredModulationMode)
