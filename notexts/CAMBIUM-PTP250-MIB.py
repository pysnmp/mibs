...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", wirelessLinkStatus=wirelessLinkStatus, configuredModulationMode=configuredModulationMode, aggregateDataRate=aggregateDataRate, ntp=ntp, nTPSync=nTPSync, nTPLastSync=nTPLastSync, ptpTrapPrefix=ptpTrapPrefix, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPTrapCommunity=sNMPTrapCommunity, sNMPCommunityAccess=sNMPCommunityAccess, transmitDataRate=transmitDataRate, extendedFreqMHz=extendedFreqMHz, dataPortStatus=dataPortStatus, ptp=ptp, receiveDataRate=receiveDataRate, versionsGroup=versionsGroup, installArmState=installArmState, receiveModulationMode=receiveModulationMode, sNMPCommunityTableNumber=sNMPCommunityTableNumber, ntpGroup=ntpGroup, gatewayIPAddress=gatewayIPAddress, remoteMACAddress=remoteMACAddress, radarDetectTrap=radarDetectTrap, sMTPServerPortNumber=sMTPServerPortNumber, systemClock=systemClock, ptpTraps=ptpTraps, ethernetGroup=ethernetGroup, licenceGroup=licenceGroup, dualPayload=dualPayload, management=management, masterSlaveMode=masterSlaveMode, sNMPCommunityString=sNMPCommunityString, antennaGain=antennaGain, vlanTagging=vlanTagging, tFTPServerPortNumber=tFTPServerPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, cambium=cambium, snmpControlGroup=snmpControlGroup, ethernet=ethernet, pubStatsGroup=pubStatsGroup, PYSNMP_MODULE_ID=cambium, signalStrengthRatio=signalStrengthRatio, vlanId=vlanId, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPTrapIPAddress=sNMPTrapIPAddress, productName=productName, noiseFloor=noiseFloor, nTPState=nTPState, hardwareVersion=hardwareVersion, vectorError=vectorError, subnetMask=subnetMask, channelBandwidth=channelBandwidth, dataPortAutoNegotiation=dataPortAutoNegotiation, siteName=siteName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPCommunityTableEntry=sNMPCommunityTableEntry, channelSelection=channelSelection, phyStatus=phyStatus, fixedModMode=fixedModMode, sNMPCommunityTableIndex=sNMPCommunityTableIndex, nTPServerPortNumber=nTPServerPortNumber, sNMPCommunityOid=sNMPCommunityOid, sNMPTrapVersion=sNMPTrapVersion, alarmsGroup=alarmsGroup, cableLoss=cableLoss, tFTPServerIPAddress=tFTPServerIPAddress, ptp250=ptp250, linkLoss=linkLoss, vlanPriority=vlanPriority, snmpControl=snmpControl, timeZone=timeZone, linkStatusTrap=linkStatusTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortStatusTrap=dataPortStatusTrap, ptpCompliance=ptpCompliance, nTPServerIp=nTPServerIp, alarms=alarms, sNMPTrapTable=sNMPTrapTable, maximumTransmitPower=maximumTransmitPower, currentChannel=currentChannel, searchState=searchState, currentFreqMHz=currentFreqMHz, nTPPollInterval=nTPPollInterval, softwareVersion=softwareVersion, bootVersion=bootVersion, ptpGroups=ptpGroups, receivePower=receivePower, configuredRange=configuredRange, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkName=linkName, extendedChannel=extendedChannel, notificationsGroup=notificationsGroup, transmitPower=transmitPower, versions=versions, configuration=configuration, band=band, iPAddress=iPAddress, pubStats=pubStats, sNMPCommunityTable=sNMPCommunityTable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, installArmStateTrap=installArmStateTrap, smtpGroup=smtpGroup, radarDetectChannel=radarDetectChannel, measuredRange=measuredRange, productVariant=productVariant, managementGroup=managementGroup, smtp=smtp, sNMPTrapPortNumber=sNMPTrapPortNumber, regionCode=regionCode, sNMPEnabledTraps=sNMPEnabledTraps, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, transmitModulationMode=transmitModulationMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, remoteIPAddress=remoteIPAddress, phyStatusGroup=phyStatusGroup, sMTPEnabledMessages=sMTPEnabledMessages, configurationGroup=configurationGroup, ptmp=ptmp, licence=licence, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex)
