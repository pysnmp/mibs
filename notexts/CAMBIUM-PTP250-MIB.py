...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPEnabledTraps=sNMPEnabledTraps, bootVersion=bootVersion, phyStatus=phyStatus, maximumTransmitPower=maximumTransmitPower, receiveDataRate=receiveDataRate, iPAddress=iPAddress, ptp=ptp, sNMPTrapTableEntry=sNMPTrapTableEntry, smtpGroup=smtpGroup, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapTableIndex=sNMPTrapTableIndex, measuredRange=measuredRange, extendedChannel=extendedChannel, sNMPTrapPortNumber=sNMPTrapPortNumber, nTPSync=nTPSync, sNMPTrapTableNumber=sNMPTrapTableNumber, radarDetectChannel=radarDetectChannel, nTPPollInterval=nTPPollInterval, linkStatusTrap=linkStatusTrap, configuredRange=configuredRange, ethernetGroup=ethernetGroup, smtp=smtp, receivePower=receivePower, alarms=alarms, sNMPTrapVersion=sNMPTrapVersion, siteName=siteName, regionCode=regionCode, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPCommunityAccess=sNMPCommunityAccess, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ptpTraps=ptpTraps, radarDetectTrap=radarDetectTrap, searchState=searchState, sNMPCommunityTableNumber=sNMPCommunityTableNumber, managementGroup=managementGroup, dualPayload=dualPayload, productVariant=productVariant, nTPState=nTPState, vlanPriority=vlanPriority, sMTPServerPortNumber=sMTPServerPortNumber, aggregateDataRate=aggregateDataRate, PYSNMP_MODULE_ID=cambium, linkLoss=linkLoss, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, noiseFloor=noiseFloor, sNMPCommunityTableIndex=sNMPCommunityTableIndex, signalStrengthRatio=signalStrengthRatio, systemClock=systemClock, nTPLastSync=nTPLastSync, dataPortStatus=dataPortStatus, nTPServerPortNumber=nTPServerPortNumber, band=band, vectorError=vectorError, sMTPServerIPAddress=sMTPServerIPAddress, currentChannel=currentChannel, ptmp=ptmp, configuration=configuration, ntp=ntp, sNMPTrapTable=sNMPTrapTable, management=management, ethernet=ethernet, pubStatsGroup=pubStatsGroup, transmitDataRate=transmitDataRate, versionsGroup=versionsGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, cambium=cambium, noWirelessChannelAvailable=noWirelessChannelAvailable, ntpGroup=ntpGroup, cableLoss=cableLoss, vlanId=vlanId, currentFreqMHz=currentFreqMHz, softwareVersion=softwareVersion, versions=versions, configurationGroup=configurationGroup, dataPortStatusTrap=dataPortStatusTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, licenceGroup=licenceGroup, receiveModulationMode=receiveModulationMode, ptp250=ptp250, hardwareVersion=hardwareVersion, fixedModMode=fixedModMode, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, pubStats=pubStats, dataPortAutoNegotiation=dataPortAutoNegotiation, channelSelection=channelSelection, timeZone=timeZone, channelBandwidth=channelBandwidth, sNMPTrapCommunity=sNMPTrapCommunity, phyStatusGroup=phyStatusGroup, remoteMACAddress=remoteMACAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, antennaGain=antennaGain, subnetMask=subnetMask, installArmStateTrap=installArmStateTrap, transmitPower=transmitPower, installArmState=installArmState, remoteIPAddress=remoteIPAddress, nTPServerIp=nTPServerIp, sMTPSourceEmailAddress=sMTPSourceEmailAddress, configuredModulationMode=configuredModulationMode, masterSlaveMode=masterSlaveMode, notificationsGroup=notificationsGroup, productName=productName, gatewayIPAddress=gatewayIPAddress, ptpCompliance=ptpCompliance, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, extendedFreqMHz=extendedFreqMHz, wirelessLinkStatus=wirelessLinkStatus, transmitModulationMode=transmitModulationMode, sNMPCommunityOid=sNMPCommunityOid, sNMPCommunityString=sNMPCommunityString, sNMPCommunityTableEntry=sNMPCommunityTableEntry, ptpTrapPrefix=ptpTrapPrefix, vlanTagging=vlanTagging, tFTPServerPortNumber=tFTPServerPortNumber, snmpControlGroup=snmpControlGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPServerIPAddress=tFTPServerIPAddress, linkName=linkName, sNMPCommunityTable=sNMPCommunityTable, licence=licence, snmpControl=snmpControl, ptpGroups=ptpGroups, alarmsGroup=alarmsGroup)
