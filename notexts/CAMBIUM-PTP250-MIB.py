...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", cambium=cambium, configurationGroup=configurationGroup, regionCode=regionCode, masterSlaveMode=masterSlaveMode, ntpGroup=ntpGroup, maximumTransmitPower=maximumTransmitPower, aggregateDataRate=aggregateDataRate, sNMPTrapIPAddress=sNMPTrapIPAddress, fixedModMode=fixedModMode, ptpCompliance=ptpCompliance, systemClock=systemClock, dualPayload=dualPayload, channelSelection=channelSelection, hardwareVersion=hardwareVersion, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPEnabledTraps=sNMPEnabledTraps, timeZone=timeZone, noWirelessChannelAvailable=noWirelessChannelAvailable, band=band, sNMPCommunityTableEntry=sNMPCommunityTableEntry, management=management, versions=versions, licenceGroup=licenceGroup, nTPServerPortNumber=nTPServerPortNumber, sNMPTrapTable=sNMPTrapTable, linkName=linkName, noiseFloor=noiseFloor, configuredRange=configuredRange, sMTPServerIPAddress=sMTPServerIPAddress, subnetMask=subnetMask, transmitModulationMode=transmitModulationMode, nTPLastSync=nTPLastSync, bootVersion=bootVersion, linkStatusTrap=linkStatusTrap, vectorError=vectorError, installArmStateTrap=installArmStateTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, nTPPollInterval=nTPPollInterval, remoteMACAddress=remoteMACAddress, sNMPTrapVersion=sNMPTrapVersion, ntp=ntp, remoteIPAddress=remoteIPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, snmpControl=snmpControl, versionsGroup=versionsGroup, PYSNMP_MODULE_ID=cambium, linkLoss=linkLoss, ptmp=ptmp, ptpTrapPrefix=ptpTrapPrefix, ptpTraps=ptpTraps, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, searchState=searchState, receiveModulationMode=receiveModulationMode, configuredModulationMode=configuredModulationMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, currentFreqMHz=currentFreqMHz, phyStatusGroup=phyStatusGroup, ptpGroups=ptpGroups, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, softwareVersion=softwareVersion, phyStatus=phyStatus, channelBandwidth=channelBandwidth, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortStatusTrap=dataPortStatusTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, ethernet=ethernet, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, nTPServerIp=nTPServerIp, wirelessLinkStatus=wirelessLinkStatus, sMTPServerPortNumber=sMTPServerPortNumber, ethernetGroup=ethernetGroup, productName=productName, siteName=siteName, vlanTagging=vlanTagging, sNMPCommunityTableIndex=sNMPCommunityTableIndex, smtp=smtp, nTPState=nTPState, nTPSync=nTPSync, sNMPTrapTableNumber=sNMPTrapTableNumber, tFTPServerPortNumber=tFTPServerPortNumber, pubStats=pubStats, sNMPTrapPortNumber=sNMPTrapPortNumber, installArmState=installArmState, snmpControlGroup=snmpControlGroup, vlanPriority=vlanPriority, sNMPCommunityAccess=sNMPCommunityAccess, alarms=alarms, dataPortStatus=dataPortStatus, antennaGain=antennaGain, productVariant=productVariant, sMTPEnabledMessages=sMTPEnabledMessages, vlanId=vlanId, smtpGroup=smtpGroup, configuration=configuration, notificationsGroup=notificationsGroup, gatewayIPAddress=gatewayIPAddress, sNMPCommunityString=sNMPCommunityString, receivePower=receivePower, extendedFreqMHz=extendedFreqMHz, alarmsGroup=alarmsGroup, licence=licence, signalStrengthRatio=signalStrengthRatio, iPAddress=iPAddress, pubStatsGroup=pubStatsGroup, radarDetectTrap=radarDetectTrap, transmitPower=transmitPower, radarDetectChannel=radarDetectChannel, managementGroup=managementGroup, currentChannel=currentChannel, measuredRange=measuredRange, ptp=ptp, sNMPCommunityTable=sNMPCommunityTable, sNMPTrapTableEntry=sNMPTrapTableEntry, extendedChannel=extendedChannel, sNMPTrapCommunity=sNMPTrapCommunity, sNMPCommunityTableNumber=sNMPCommunityTableNumber, ptp250=ptp250, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPCommunityOid=sNMPCommunityOid, tFTPServerIPAddress=tFTPServerIPAddress, receiveDataRate=receiveDataRate, transmitDataRate=transmitDataRate, cableLoss=cableLoss)
