...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", aggregateDataRate=aggregateDataRate, installArmStateTrap=installArmStateTrap, fixedModMode=fixedModMode, remoteIPAddress=remoteIPAddress, receiveDataRate=receiveDataRate, nTPState=nTPState, linkStatusTrap=linkStatusTrap, pubStats=pubStats, ptpTrapPrefix=ptpTrapPrefix, extendedChannel=extendedChannel, sNMPEnabledTraps=sNMPEnabledTraps, sNMPCommunityOid=sNMPCommunityOid, ptp250=ptp250, notificationsGroup=notificationsGroup, sNMPCommunityTable=sNMPCommunityTable, hardwareVersion=hardwareVersion, ptpTraps=ptpTraps, regionCode=regionCode, radarDetectTrap=radarDetectTrap, searchState=searchState, noiseFloor=noiseFloor, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, extendedFreqMHz=extendedFreqMHz, ntp=ntp, sNMPTrapTableEntry=sNMPTrapTableEntry, channelSelection=channelSelection, licence=licence, subnetMask=subnetMask, systemClock=systemClock, transmitPower=transmitPower, transmitModulationMode=transmitModulationMode, gatewayIPAddress=gatewayIPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, radarDetectChannel=radarDetectChannel, transmitDataRate=transmitDataRate, ptpGroups=ptpGroups, configuration=configuration, ethernet=ethernet, versionsGroup=versionsGroup, measuredRange=measuredRange, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ethernetGroup=ethernetGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, licenceGroup=licenceGroup, linkName=linkName, antennaGain=antennaGain, versions=versions, iPAddress=iPAddress, ptmp=ptmp, alarms=alarms, receivePower=receivePower, phyStatusGroup=phyStatusGroup, nTPLastSync=nTPLastSync, sMTPEnabledMessages=sMTPEnabledMessages, pubStatsGroup=pubStatsGroup, smtp=smtp, currentFreqMHz=currentFreqMHz, vlanTagging=vlanTagging, ntpGroup=ntpGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, vlanId=vlanId, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortStatus=dataPortStatus, configuredModulationMode=configuredModulationMode, alarmsGroup=alarmsGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, snmpControlGroup=snmpControlGroup, masterSlaveMode=masterSlaveMode, sNMPCommunityTableNumber=sNMPCommunityTableNumber, signalStrengthRatio=signalStrengthRatio, tFTPServerPortNumber=tFTPServerPortNumber, remoteMACAddress=remoteMACAddress, nTPServerIp=nTPServerIp, ptp=ptp, tFTPServerIPAddress=tFTPServerIPAddress, nTPSync=nTPSync, smtpGroup=smtpGroup, installArmState=installArmState, productName=productName, receiveModulationMode=receiveModulationMode, sNMPTrapTableIndex=sNMPTrapTableIndex, nTPServerPortNumber=nTPServerPortNumber, PYSNMP_MODULE_ID=cambium, sNMPCommunityTableIndex=sNMPCommunityTableIndex, dualPayload=dualPayload, management=management, band=band, sNMPTrapVersion=sNMPTrapVersion, wirelessLinkStatus=wirelessLinkStatus, maximumTransmitPower=maximumTransmitPower, ptpCompliance=ptpCompliance, configuredRange=configuredRange, snmpControl=snmpControl, sMTPServerIPAddress=sMTPServerIPAddress, vlanPriority=vlanPriority, softwareVersion=softwareVersion, dataPortStatusTrap=dataPortStatusTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, configurationGroup=configurationGroup, cableLoss=cableLoss, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, vectorError=vectorError, sNMPTrapCommunity=sNMPTrapCommunity, managementGroup=managementGroup, timeZone=timeZone, bootVersion=bootVersion, sNMPCommunityString=sNMPCommunityString, phyStatus=phyStatus, nTPPollInterval=nTPPollInterval, currentChannel=currentChannel, sNMPCommunityAccess=sNMPCommunityAccess, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapTable=sNMPTrapTable, cambium=cambium, siteName=siteName, channelBandwidth=channelBandwidth, productVariant=productVariant, linkLoss=linkLoss, sMTPServerPortNumber=sMTPServerPortNumber, sNMPCommunityTableEntry=sNMPCommunityTableEntry)
