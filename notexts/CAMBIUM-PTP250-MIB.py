...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", cableLoss=cableLoss, vectorError=vectorError, extendedFreqMHz=extendedFreqMHz, productVariant=productVariant, extendedChannel=extendedChannel, linkStatusTrap=linkStatusTrap, sNMPTrapVersion=sNMPTrapVersion, sNMPCommunityAccess=sNMPCommunityAccess, versionsGroup=versionsGroup, PYSNMP_MODULE_ID=cambium, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, receivePower=receivePower, wirelessLinkStatus=wirelessLinkStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, transmitModulationMode=transmitModulationMode, tFTPServerIPAddress=tFTPServerIPAddress, sNMPCommunityTableIndex=sNMPCommunityTableIndex, softwareVersion=softwareVersion, searchState=searchState, sNMPEnabledTraps=sNMPEnabledTraps, ntp=ntp, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, cambium=cambium, management=management, ptpGroups=ptpGroups, installArmState=installArmState, smtp=smtp, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, measuredRange=measuredRange, nTPState=nTPState, sMTPSourceEmailAddress=sMTPSourceEmailAddress, vlanPriority=vlanPriority, currentFreqMHz=currentFreqMHz, sNMPCommunityTableEntry=sNMPCommunityTableEntry, configuredModulationMode=configuredModulationMode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, pubStatsGroup=pubStatsGroup, snmpControl=snmpControl, sMTPEnabledMessages=sMTPEnabledMessages, ethernet=ethernet, configuration=configuration, sNMPTrapTable=sNMPTrapTable, noiseFloor=noiseFloor, ptpCompliance=ptpCompliance, licence=licence, vlanId=vlanId, sNMPTrapCommunity=sNMPTrapCommunity, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortStatus=dataPortStatus, iPAddress=iPAddress, sNMPCommunityString=sNMPCommunityString, sNMPCommunityTableNumber=sNMPCommunityTableNumber, maximumTransmitPower=maximumTransmitPower, vlanTagging=vlanTagging, receiveModulationMode=receiveModulationMode, bootVersion=bootVersion, managementGroup=managementGroup, dualPayload=dualPayload, ptpTraps=ptpTraps, snmpControlGroup=snmpControlGroup, currentChannel=currentChannel, configurationGroup=configurationGroup, ptp250=ptp250, band=band, sNMPTrapPortNumber=sNMPTrapPortNumber, gatewayIPAddress=gatewayIPAddress, nTPPollInterval=nTPPollInterval, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPServerIPAddress=sMTPServerIPAddress, sNMPCommunityTable=sNMPCommunityTable, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, channelSelection=channelSelection, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, fixedModMode=fixedModMode, nTPSync=nTPSync, remoteMACAddress=remoteMACAddress, alarmsGroup=alarmsGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, nTPLastSync=nTPLastSync, phyStatus=phyStatus, radarDetectChannel=radarDetectChannel, productName=productName, channelBandwidth=channelBandwidth, sNMPTrapTableIndex=sNMPTrapTableIndex, hardwareVersion=hardwareVersion, remoteIPAddress=remoteIPAddress, linkName=linkName, tFTPServerPortNumber=tFTPServerPortNumber, licenceGroup=licenceGroup, transmitPower=transmitPower, configuredRange=configuredRange, smtpGroup=smtpGroup, ptmp=ptmp, masterSlaveMode=masterSlaveMode, dataPortAutoNegotiation=dataPortAutoNegotiation, sMTPServerPortNumber=sMTPServerPortNumber, sNMPCommunityOid=sNMPCommunityOid, versions=versions, nTPServerPortNumber=nTPServerPortNumber, signalStrengthRatio=signalStrengthRatio, subnetMask=subnetMask, nTPServerIp=nTPServerIp, linkLoss=linkLoss, radarDetectTrap=radarDetectTrap, ptpTrapPrefix=ptpTrapPrefix, notificationsGroup=notificationsGroup, ntpGroup=ntpGroup, ethernetGroup=ethernetGroup, receiveDataRate=receiveDataRate, transmitDataRate=transmitDataRate, alarms=alarms, pubStats=pubStats, phyStatusGroup=phyStatusGroup, antennaGain=antennaGain, sNMPTrapTableEntry=sNMPTrapTableEntry, installArmStateTrap=installArmStateTrap, ptp=ptp, systemClock=systemClock, timeZone=timeZone, regionCode=regionCode, siteName=siteName, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortStatusTrap=dataPortStatusTrap, aggregateDataRate=aggregateDataRate)
