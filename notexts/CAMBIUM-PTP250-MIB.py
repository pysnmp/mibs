...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPTrapTableEntry=sNMPTrapTableEntry, nTPSync=nTPSync, phyStatus=phyStatus, vlanPriority=vlanPriority, sNMPCommunityTable=sNMPCommunityTable, dataPortAutoNegotiation=dataPortAutoNegotiation, notificationsGroup=notificationsGroup, snmpControlGroup=snmpControlGroup, aggregateDataRate=aggregateDataRate, ntpGroup=ntpGroup, softwareVersion=softwareVersion, installArmState=installArmState, cambium=cambium, dataPortStatusTrap=dataPortStatusTrap, transmitPower=transmitPower, ptp250=ptp250, installArmStateTrap=installArmStateTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, configurationGroup=configurationGroup, pubStats=pubStats, fixedModMode=fixedModMode, receiveModulationMode=receiveModulationMode, signalStrengthRatio=signalStrengthRatio, nTPServerPortNumber=nTPServerPortNumber, sNMPCommunityString=sNMPCommunityString, sNMPTrapVersion=sNMPTrapVersion, smtp=smtp, sNMPTrapTable=sNMPTrapTable, ptpTraps=ptpTraps, vectorError=vectorError, transmitDataRate=transmitDataRate, sNMPCommunityOid=sNMPCommunityOid, remoteMACAddress=remoteMACAddress, nTPServerIp=nTPServerIp, sNMPTrapTableIndex=sNMPTrapTableIndex, ntp=ntp, snmpControl=snmpControl, currentChannel=currentChannel, masterSlaveMode=masterSlaveMode, transmitModulationMode=transmitModulationMode, sMTPServerPortNumber=sMTPServerPortNumber, channelBandwidth=channelBandwidth, bootVersion=bootVersion, systemClock=systemClock, alarmsGroup=alarmsGroup, sNMPTrapCommunity=sNMPTrapCommunity, nTPLastSync=nTPLastSync, sNMPCommunityAccess=sNMPCommunityAccess, configuration=configuration, ptpTrapPrefix=ptpTrapPrefix, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, vlanTagging=vlanTagging, ptpCompliance=ptpCompliance, band=band, licenceGroup=licenceGroup, productVariant=productVariant, searchState=searchState, extendedChannel=extendedChannel, receiveDataRate=receiveDataRate, smtpGroup=smtpGroup, iPAddress=iPAddress, nTPState=nTPState, sNMPTrapIPAddress=sNMPTrapIPAddress, dualPayload=dualPayload, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, configuredModulationMode=configuredModulationMode, maximumTransmitPower=maximumTransmitPower, ptp=ptp, versionsGroup=versionsGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPCommunityTableNumber=sNMPCommunityTableNumber, ethernetGroup=ethernetGroup, ptpGroups=ptpGroups, vlanId=vlanId, managementGroup=managementGroup, dataPortStatus=dataPortStatus, currentFreqMHz=currentFreqMHz, productName=productName, tFTPServerIPAddress=tFTPServerIPAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, siteName=siteName, phyStatusGroup=phyStatusGroup, PYSNMP_MODULE_ID=cambium, management=management, subnetMask=subnetMask, ethernet=ethernet, nTPPollInterval=nTPPollInterval, channelSelection=channelSelection, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, linkName=linkName, timeZone=timeZone, noiseFloor=noiseFloor, antennaGain=antennaGain, radarDetectTrap=radarDetectTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sMTPSourceEmailAddress=sMTPSourceEmailAddress, alarms=alarms, radarDetectChannel=radarDetectChannel, wirelessLinkStatus=wirelessLinkStatus, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPEnabledTraps=sNMPEnabledTraps, pubStatsGroup=pubStatsGroup, gatewayIPAddress=gatewayIPAddress, receivePower=receivePower, ptmp=ptmp, sMTPEnabledMessages=sMTPEnabledMessages, configuredRange=configuredRange, licence=licence, sMTPServerIPAddress=sMTPServerIPAddress, linkStatusTrap=linkStatusTrap, remoteIPAddress=remoteIPAddress, measuredRange=measuredRange, tFTPServerPortNumber=tFTPServerPortNumber, linkLoss=linkLoss, extendedFreqMHz=extendedFreqMHz, sNMPCommunityTableIndex=sNMPCommunityTableIndex, hardwareVersion=hardwareVersion, regionCode=regionCode, versions=versions, cableLoss=cableLoss)
