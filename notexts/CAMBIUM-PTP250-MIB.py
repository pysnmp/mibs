...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, phyStatusGroup=phyStatusGroup, transmitModulationMode=transmitModulationMode, nTPServerPortNumber=nTPServerPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPCommunityAccess=sNMPCommunityAccess, timeZone=timeZone, licenceGroup=licenceGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, versions=versions, ethernetGroup=ethernetGroup, vlanTagging=vlanTagging, alarmsGroup=alarmsGroup, management=management, transmitPower=transmitPower, maximumTransmitPower=maximumTransmitPower, smtp=smtp, alarms=alarms, vlanPriority=vlanPriority, receiveDataRate=receiveDataRate, linkLoss=linkLoss, sNMPTrapVersion=sNMPTrapVersion, sNMPCommunityTable=sNMPCommunityTable, masterSlaveMode=masterSlaveMode, phyStatus=phyStatus, vectorError=vectorError, nTPPollInterval=nTPPollInterval, antennaGain=antennaGain, remoteIPAddress=remoteIPAddress, ntpGroup=ntpGroup, cambium=cambium, band=band, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPCommunityString=sNMPCommunityString, dataPortStatusTrap=dataPortStatusTrap, transmitDataRate=transmitDataRate, installArmState=installArmState, snmpControlGroup=snmpControlGroup, fixedModMode=fixedModMode, sNMPCommunityTableNumber=sNMPCommunityTableNumber, notificationsGroup=notificationsGroup, nTPServerIp=nTPServerIp, ptp=ptp, sNMPCommunityTableEntry=sNMPCommunityTableEntry, dataPortStatus=dataPortStatus, searchState=searchState, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, bootVersion=bootVersion, ptpTrapPrefix=ptpTrapPrefix, remoteMACAddress=remoteMACAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, configuration=configuration, linkStatusTrap=linkStatusTrap, sMTPEnabledMessages=sMTPEnabledMessages, productVariant=productVariant, sNMPTrapTable=sNMPTrapTable, snmpControl=snmpControl, nTPSync=nTPSync, hardwareVersion=hardwareVersion, vlanId=vlanId, sNMPTrapPortNumber=sNMPTrapPortNumber, tFTPServerPortNumber=tFTPServerPortNumber, sNMPCommunityTableIndex=sNMPCommunityTableIndex, radarDetectTrap=radarDetectTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, configuredRange=configuredRange, PYSNMP_MODULE_ID=cambium, licence=licence, systemClock=systemClock, versionsGroup=versionsGroup, channelSelection=channelSelection, regionCode=regionCode, nTPState=nTPState, nTPLastSync=nTPLastSync, noiseFloor=noiseFloor, softwareVersion=softwareVersion, dualPayload=dualPayload, ptp250=ptp250, configuredModulationMode=configuredModulationMode, sNMPTrapTableEntry=sNMPTrapTableEntry, receiveModulationMode=receiveModulationMode, installArmStateTrap=installArmStateTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, ptmp=ptmp, extendedFreqMHz=extendedFreqMHz, ntp=ntp, signalStrengthRatio=signalStrengthRatio, subnetMask=subnetMask, channelBandwidth=channelBandwidth, radarDetectChannel=radarDetectChannel, gatewayIPAddress=gatewayIPAddress, sNMPTrapCommunity=sNMPTrapCommunity, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, aggregateDataRate=aggregateDataRate, sNMPCommunityOid=sNMPCommunityOid, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, pubStatsGroup=pubStatsGroup, ptpTraps=ptpTraps, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, wirelessLinkStatus=wirelessLinkStatus, ptpCompliance=ptpCompliance, managementGroup=managementGroup, productName=productName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, cableLoss=cableLoss, smtpGroup=smtpGroup, sNMPEnabledTraps=sNMPEnabledTraps, iPAddress=iPAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, receivePower=receivePower, extendedChannel=extendedChannel, configurationGroup=configurationGroup, currentFreqMHz=currentFreqMHz, ethernet=ethernet, linkName=linkName, sMTPSourceEmailAddress=sMTPSourceEmailAddress, currentChannel=currentChannel, sMTPServerIPAddress=sMTPServerIPAddress, siteName=siteName, pubStats=pubStats, tFTPServerIPAddress=tFTPServerIPAddress, measuredRange=measuredRange, ptpGroups=ptpGroups)
