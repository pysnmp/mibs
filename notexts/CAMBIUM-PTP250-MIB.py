...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", ptpCompliance=ptpCompliance, sNMPCommunityTableIndex=sNMPCommunityTableIndex, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, alarmsGroup=alarmsGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, pubStats=pubStats, wirelessLinkStatus=wirelessLinkStatus, alarms=alarms, ptpTrapPrefix=ptpTrapPrefix, currentChannel=currentChannel, linkName=linkName, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortStatus=dataPortStatus, dualPayload=dualPayload, transmitModulationMode=transmitModulationMode, ptp=ptp, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapTable=sNMPTrapTable, smtp=smtp, subnetMask=subnetMask, cableLoss=cableLoss, radarDetectTrap=radarDetectTrap, ptp250=ptp250, configuredRange=configuredRange, vlanTagging=vlanTagging, siteName=siteName, sNMPTrapPortNumber=sNMPTrapPortNumber, signalStrengthRatio=signalStrengthRatio, configurationGroup=configurationGroup, productName=productName, snmpControl=snmpControl, ethernetGroup=ethernetGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, installArmState=installArmState, nTPServerIp=nTPServerIp, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapCommunity=sNMPTrapCommunity, receivePower=receivePower, transmitPower=transmitPower, regionCode=regionCode, transmitDataRate=transmitDataRate, receiveDataRate=receiveDataRate, versions=versions, nTPServerPortNumber=nTPServerPortNumber, sNMPCommunityAccess=sNMPCommunityAccess, band=band, antennaGain=antennaGain, masterSlaveMode=masterSlaveMode, systemClock=systemClock, ethernet=ethernet, bootVersion=bootVersion, licenceGroup=licenceGroup, ptpTraps=ptpTraps, sMTPServerPortNumber=sMTPServerPortNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, maximumTransmitPower=maximumTransmitPower, installArmStateTrap=installArmStateTrap, sNMPCommunityTableNumber=sNMPCommunityTableNumber, linkLoss=linkLoss, nTPLastSync=nTPLastSync, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPCommunityOid=sNMPCommunityOid, managementGroup=managementGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ntp=ntp, sNMPEnabledTraps=sNMPEnabledTraps, licence=licence, channelSelection=channelSelection, hardwareVersion=hardwareVersion, dataPortStatusTrap=dataPortStatusTrap, vlanId=vlanId, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPServerPortNumber=tFTPServerPortNumber, receiveModulationMode=receiveModulationMode, radarDetectChannel=radarDetectChannel, nTPState=nTPState, productVariant=productVariant, vectorError=vectorError, currentFreqMHz=currentFreqMHz, linkStatusTrap=linkStatusTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, gatewayIPAddress=gatewayIPAddress, configuration=configuration, ptmp=ptmp, aggregateDataRate=aggregateDataRate, management=management, phyStatusGroup=phyStatusGroup, searchState=searchState, remoteIPAddress=remoteIPAddress, sNMPTrapVersion=sNMPTrapVersion, softwareVersion=softwareVersion, pubStatsGroup=pubStatsGroup, extendedChannel=extendedChannel, nTPSync=nTPSync, sNMPCommunityTableEntry=sNMPCommunityTableEntry, timeZone=timeZone, sNMPCommunityTable=sNMPCommunityTable, smtpGroup=smtpGroup, sNMPCommunityString=sNMPCommunityString, sNMPTrapTableNumber=sNMPTrapTableNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, ntpGroup=ntpGroup, snmpControlGroup=snmpControlGroup, nTPPollInterval=nTPPollInterval, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ptpGroups=ptpGroups, extendedFreqMHz=extendedFreqMHz, phyStatus=phyStatus, notificationsGroup=notificationsGroup, remoteMACAddress=remoteMACAddress, cambium=cambium, noiseFloor=noiseFloor, versionsGroup=versionsGroup, channelBandwidth=channelBandwidth, PYSNMP_MODULE_ID=cambium, vlanPriority=vlanPriority, fixedModMode=fixedModMode, tFTPServerIPAddress=tFTPServerIPAddress, iPAddress=iPAddress, configuredModulationMode=configuredModulationMode, measuredRange=measuredRange)
