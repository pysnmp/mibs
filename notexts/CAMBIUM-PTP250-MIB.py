...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPCommunityTableIndex=sNMPCommunityTableIndex, maximumTransmitPower=maximumTransmitPower, extendedChannel=extendedChannel, snmpControl=snmpControl, fixedModMode=fixedModMode, pubStatsGroup=pubStatsGroup, ntpGroup=ntpGroup, sMTPServerPortNumber=sMTPServerPortNumber, configurationGroup=configurationGroup, nTPLastSync=nTPLastSync, channelBandwidth=channelBandwidth, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, phyStatusGroup=phyStatusGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, extendedFreqMHz=extendedFreqMHz, signalStrengthRatio=signalStrengthRatio, linkLoss=linkLoss, vlanId=vlanId, smtp=smtp, nTPPollInterval=nTPPollInterval, PYSNMP_MODULE_ID=cambium, licence=licence, configuredRange=configuredRange, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapVersion=sNMPTrapVersion, alarms=alarms, ntp=ntp, management=management, ptpTraps=ptpTraps, installArmState=installArmState, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sMTPServerIPAddress=sMTPServerIPAddress, ptpTrapPrefix=ptpTrapPrefix, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptp250=ptp250, vlanPriority=vlanPriority, receiveModulationMode=receiveModulationMode, vlanTagging=vlanTagging, ptpCompliance=ptpCompliance, snmpControlGroup=snmpControlGroup, vectorError=vectorError, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, transmitModulationMode=transmitModulationMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapTable=sNMPTrapTable, receiveDataRate=receiveDataRate, ptpGroups=ptpGroups, sNMPTrapIPAddress=sNMPTrapIPAddress, cableLoss=cableLoss, remoteMACAddress=remoteMACAddress, tFTPServerPortNumber=tFTPServerPortNumber, measuredRange=measuredRange, configuredModulationMode=configuredModulationMode, subnetMask=subnetMask, sNMPEnabledTraps=sNMPEnabledTraps, searchState=searchState, aggregateDataRate=aggregateDataRate, nTPSync=nTPSync, licenceGroup=licenceGroup, nTPState=nTPState, ptp=ptp, versions=versions, softwareVersion=softwareVersion, sMTPEnabledMessages=sMTPEnabledMessages, productName=productName, managementGroup=managementGroup, wirelessLinkStatus=wirelessLinkStatus, systemClock=systemClock, bootVersion=bootVersion, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, currentFreqMHz=currentFreqMHz, tFTPServerIPAddress=tFTPServerIPAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPCommunityOid=sNMPCommunityOid, sNMPCommunityTableNumber=sNMPCommunityTableNumber, dataPortStatusTrap=dataPortStatusTrap, antennaGain=antennaGain, band=band, timeZone=timeZone, linkStatusTrap=linkStatusTrap, sNMPCommunityString=sNMPCommunityString, ptmp=ptmp, phyStatus=phyStatus, nTPServerIp=nTPServerIp, masterSlaveMode=masterSlaveMode, versionsGroup=versionsGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, nTPServerPortNumber=nTPServerPortNumber, remoteIPAddress=remoteIPAddress, ethernetGroup=ethernetGroup, linkName=linkName, smtpGroup=smtpGroup, iPAddress=iPAddress, hardwareVersion=hardwareVersion, sNMPCommunityAccess=sNMPCommunityAccess, dataPortAutoNegotiation=dataPortAutoNegotiation, installArmStateTrap=installArmStateTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, alarmsGroup=alarmsGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, notificationsGroup=notificationsGroup, sNMPTrapCommunity=sNMPTrapCommunity, channelSelection=channelSelection, transmitDataRate=transmitDataRate, dataPortStatus=dataPortStatus, radarDetectTrap=radarDetectTrap, gatewayIPAddress=gatewayIPAddress, sNMPCommunityTableEntry=sNMPCommunityTableEntry, regionCode=regionCode, ethernet=ethernet, currentChannel=currentChannel, sNMPTrapTableIndex=sNMPTrapTableIndex, siteName=siteName, dualPayload=dualPayload, radarDetectChannel=radarDetectChannel, productVariant=productVariant, pubStats=pubStats, receivePower=receivePower, configuration=configuration, transmitPower=transmitPower, noiseFloor=noiseFloor, cambium=cambium, sNMPCommunityTable=sNMPCommunityTable)
