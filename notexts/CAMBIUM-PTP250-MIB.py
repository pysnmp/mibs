...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", configuration=configuration, licence=licence, transmitModulationMode=transmitModulationMode, radarDetectChannel=radarDetectChannel, sNMPCommunityTable=sNMPCommunityTable, ptpCompliance=ptpCompliance, vlanPriority=vlanPriority, systemClock=systemClock, ptpGroups=ptpGroups, linkName=linkName, noiseFloor=noiseFloor, management=management, productName=productName, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitDataRate=transmitDataRate, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, snmpControl=snmpControl, ntpGroup=ntpGroup, searchState=searchState, cambium=cambium, channelSelection=channelSelection, channelBandwidth=channelBandwidth, siteName=siteName, sNMPCommunityTableNumber=sNMPCommunityTableNumber, subnetMask=subnetMask, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPCommunityTableIndex=sNMPCommunityTableIndex, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapTable=sNMPTrapTable, configuredModulationMode=configuredModulationMode, sMTPEnabledMessages=sMTPEnabledMessages, sMTPSourceEmailAddress=sMTPSourceEmailAddress, fixedModMode=fixedModMode, licenceGroup=licenceGroup, nTPSync=nTPSync, cableLoss=cableLoss, ptp=ptp, pubStatsGroup=pubStatsGroup, currentFreqMHz=currentFreqMHz, sNMPTrapVersion=sNMPTrapVersion, nTPState=nTPState, band=band, vlanId=vlanId, nTPPollInterval=nTPPollInterval, remoteMACAddress=remoteMACAddress, timeZone=timeZone, sMTPServerIPAddress=sMTPServerIPAddress, linkLoss=linkLoss, PYSNMP_MODULE_ID=cambium, smtpGroup=smtpGroup, currentChannel=currentChannel, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, nTPLastSync=nTPLastSync, sNMPTrapPortNumber=sNMPTrapPortNumber, measuredRange=measuredRange, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPServerPortNumber=sMTPServerPortNumber, bootVersion=bootVersion, versions=versions, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, vectorError=vectorError, hardwareVersion=hardwareVersion, extendedFreqMHz=extendedFreqMHz, transmitPower=transmitPower, snmpControlGroup=snmpControlGroup, extendedChannel=extendedChannel, configurationGroup=configurationGroup, linkStatusTrap=linkStatusTrap, ptp250=ptp250, vlanTagging=vlanTagging, pubStats=pubStats, sNMPEnabledTraps=sNMPEnabledTraps, antennaGain=antennaGain, receivePower=receivePower, receiveModulationMode=receiveModulationMode, regionCode=regionCode, nTPServerPortNumber=nTPServerPortNumber, alarmsGroup=alarmsGroup, ethernetGroup=ethernetGroup, productVariant=productVariant, phyStatus=phyStatus, ethernet=ethernet, maximumTransmitPower=maximumTransmitPower, sNMPCommunityOid=sNMPCommunityOid, versionsGroup=versionsGroup, masterSlaveMode=masterSlaveMode, remoteIPAddress=remoteIPAddress, dualPayload=dualPayload, installArmState=installArmState, installArmStateTrap=installArmStateTrap, sNMPTrapCommunity=sNMPTrapCommunity, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sNMPCommunityString=sNMPCommunityString, notificationsGroup=notificationsGroup, wirelessLinkStatus=wirelessLinkStatus, radarDetectTrap=radarDetectTrap, sNMPCommunityAccess=sNMPCommunityAccess, ptmp=ptmp, nTPServerIp=nTPServerIp, sNMPTrapTableIndex=sNMPTrapTableIndex, gatewayIPAddress=gatewayIPAddress, alarms=alarms, iPAddress=iPAddress, ntp=ntp, receiveDataRate=receiveDataRate, phyStatusGroup=phyStatusGroup, configuredRange=configuredRange, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPServerPortNumber=tFTPServerPortNumber, softwareVersion=softwareVersion, aggregateDataRate=aggregateDataRate, ptpTraps=ptpTraps, signalStrengthRatio=signalStrengthRatio, dataPortStatusTrap=dataPortStatusTrap, tFTPServerIPAddress=tFTPServerIPAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortStatus=dataPortStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, managementGroup=managementGroup, smtp=smtp, noWirelessChannelAvailable=noWirelessChannelAvailable)
