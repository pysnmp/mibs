...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortStatusTrap=dataPortStatusTrap, ntpGroup=ntpGroup, configuredModulationMode=configuredModulationMode, sNMPCommunityOid=sNMPCommunityOid, snmpControl=snmpControl, pubStats=pubStats, nTPServerPortNumber=nTPServerPortNumber, installArmState=installArmState, softwareVersion=softwareVersion, currentChannel=currentChannel, configurationGroup=configurationGroup, nTPServerIp=nTPServerIp, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, noWirelessChannelAvailable=noWirelessChannelAvailable, ethernet=ethernet, regionCode=regionCode, searchState=searchState, installArmStateTrap=installArmStateTrap, versionsGroup=versionsGroup, notificationsGroup=notificationsGroup, receiveModulationMode=receiveModulationMode, ptp=ptp, sNMPCommunityTableEntry=sNMPCommunityTableEntry, noiseFloor=noiseFloor, phyStatus=phyStatus, ptpTrapPrefix=ptpTrapPrefix, sMTPServerIPAddress=sMTPServerIPAddress, fixedModMode=fixedModMode, tFTPServerIPAddress=tFTPServerIPAddress, channelSelection=channelSelection, sNMPCommunityTableIndex=sNMPCommunityTableIndex, ptpCompliance=ptpCompliance, wirelessLinkStatus=wirelessLinkStatus, systemClock=systemClock, pubStatsGroup=pubStatsGroup, currentFreqMHz=currentFreqMHz, managementGroup=managementGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, linkStatusTrap=linkStatusTrap, radarDetectTrap=radarDetectTrap, transmitDataRate=transmitDataRate, sNMPEnabledTraps=sNMPEnabledTraps, sMTPServerPortNumber=sMTPServerPortNumber, alarms=alarms, dataPortStatus=dataPortStatus, configuredRange=configuredRange, bootVersion=bootVersion, sNMPTrapCommunity=sNMPTrapCommunity, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, maximumTransmitPower=maximumTransmitPower, ptp250=ptp250, dataPortAutoNegotiation=dataPortAutoNegotiation, vectorError=vectorError, ethernetGroup=ethernetGroup, masterSlaveMode=masterSlaveMode, ptmp=ptmp, cableLoss=cableLoss, transmitPower=transmitPower, licenceGroup=licenceGroup, versions=versions, measuredRange=measuredRange, sNMPTrapIPAddress=sNMPTrapIPAddress, management=management, vlanTagging=vlanTagging, siteName=siteName, tFTPServerPortNumber=tFTPServerPortNumber, linkLoss=linkLoss, sNMPCommunityTableNumber=sNMPCommunityTableNumber, nTPPollInterval=nTPPollInterval, receiveDataRate=receiveDataRate, remoteMACAddress=remoteMACAddress, aggregateDataRate=aggregateDataRate, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, productVariant=productVariant, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, transmitModulationMode=transmitModulationMode, radarDetectChannel=radarDetectChannel, nTPSync=nTPSync, PYSNMP_MODULE_ID=cambium, productName=productName, hardwareVersion=hardwareVersion, receivePower=receivePower, sNMPCommunityString=sNMPCommunityString, extendedFreqMHz=extendedFreqMHz, sNMPCommunityAccess=sNMPCommunityAccess, antennaGain=antennaGain, snmpControlGroup=snmpControlGroup, phyStatusGroup=phyStatusGroup, ptpTraps=ptpTraps, sMTPEnabledMessages=sMTPEnabledMessages, timeZone=timeZone, sMTPSourceEmailAddress=sMTPSourceEmailAddress, signalStrengthRatio=signalStrengthRatio, alarmsGroup=alarmsGroup, iPAddress=iPAddress, ptpGroups=ptpGroups, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dualPayload=dualPayload, sNMPTrapVersion=sNMPTrapVersion, smtp=smtp, channelBandwidth=channelBandwidth, sNMPTrapTable=sNMPTrapTable, ntp=ntp, nTPState=nTPState, extendedChannel=extendedChannel, smtpGroup=smtpGroup, sNMPCommunityTable=sNMPCommunityTable, sNMPTrapTableIndex=sNMPTrapTableIndex, configuration=configuration, vlanPriority=vlanPriority, licence=licence, linkName=linkName, cambium=cambium, gatewayIPAddress=gatewayIPAddress, remoteIPAddress=remoteIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, subnetMask=subnetMask, nTPLastSync=nTPLastSync, sNMPTrapTableNumber=sNMPTrapTableNumber, vlanId=vlanId, band=band)
