...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", ethernet=ethernet, configuredModulationMode=configuredModulationMode, extendedChannel=extendedChannel, linkLoss=linkLoss, sNMPTrapCommunity=sNMPTrapCommunity, sNMPTrapVersion=sNMPTrapVersion, channelBandwidth=channelBandwidth, dataPortAutoNegotiation=dataPortAutoNegotiation, vectorError=vectorError, sNMPCommunityAccess=sNMPCommunityAccess, receiveDataRate=receiveDataRate, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, configuredRange=configuredRange, nTPServerPortNumber=nTPServerPortNumber, alarmsGroup=alarmsGroup, signalStrengthRatio=signalStrengthRatio, sNMPCommunityTableIndex=sNMPCommunityTableIndex, ptpTraps=ptpTraps, gatewayIPAddress=gatewayIPAddress, remoteMACAddress=remoteMACAddress, ptp=ptp, vlanPriority=vlanPriority, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPServerPortNumber=tFTPServerPortNumber, snmpControl=snmpControl, searchState=searchState, sNMPTrapTableIndex=sNMPTrapTableIndex, aggregateDataRate=aggregateDataRate, maximumTransmitPower=maximumTransmitPower, nTPSync=nTPSync, vlanTagging=vlanTagging, ptpGroups=ptpGroups, installArmState=installArmState, receivePower=receivePower, management=management, nTPServerIp=nTPServerIp, transmitPower=transmitPower, dualPayload=dualPayload, sNMPCommunityOid=sNMPCommunityOid, ntpGroup=ntpGroup, smtp=smtp, alarms=alarms, channelSelection=channelSelection, sNMPCommunityTable=sNMPCommunityTable, regionCode=regionCode, measuredRange=measuredRange, sNMPCommunityTableEntry=sNMPCommunityTableEntry, linkStatusTrap=linkStatusTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, currentFreqMHz=currentFreqMHz, masterSlaveMode=masterSlaveMode, noiseFloor=noiseFloor, PYSNMP_MODULE_ID=cambium, licence=licence, configurationGroup=configurationGroup, productName=productName, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, bootVersion=bootVersion, versions=versions, remoteIPAddress=remoteIPAddress, timeZone=timeZone, installArmStateTrap=installArmStateTrap, systemClock=systemClock, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, notificationsGroup=notificationsGroup, vlanId=vlanId, nTPState=nTPState, iPAddress=iPAddress, nTPLastSync=nTPLastSync, managementGroup=managementGroup, softwareVersion=softwareVersion, subnetMask=subnetMask, snmpControlGroup=snmpControlGroup, configuration=configuration, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ethernetGroup=ethernetGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, phyStatus=phyStatus, siteName=siteName, sMTPEnabledMessages=sMTPEnabledMessages, transmitModulationMode=transmitModulationMode, extendedFreqMHz=extendedFreqMHz, ptp250=ptp250, nTPPollInterval=nTPPollInterval, sNMPTrapTableNumber=sNMPTrapTableNumber, band=band, sMTPServerPortNumber=sMTPServerPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPCommunityTableNumber=sNMPCommunityTableNumber, pubStatsGroup=pubStatsGroup, ptpCompliance=ptpCompliance, receiveModulationMode=receiveModulationMode, radarDetectChannel=radarDetectChannel, linkName=linkName, sNMPCommunityString=sNMPCommunityString, antennaGain=antennaGain, pubStats=pubStats, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sMTPServerIPAddress=sMTPServerIPAddress, transmitDataRate=transmitDataRate, cableLoss=cableLoss, dataPortStatus=dataPortStatus, ptpTrapPrefix=ptpTrapPrefix, versionsGroup=versionsGroup, phyStatusGroup=phyStatusGroup, smtpGroup=smtpGroup, tFTPServerIPAddress=tFTPServerIPAddress, productVariant=productVariant, fixedModMode=fixedModMode, licenceGroup=licenceGroup, sNMPTrapTable=sNMPTrapTable, ptmp=ptmp, currentChannel=currentChannel, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapTableEntry=sNMPTrapTableEntry, hardwareVersion=hardwareVersion, wirelessLinkStatus=wirelessLinkStatus, ntp=ntp, dataPortStatusTrap=dataPortStatusTrap, cambium=cambium, sNMPEnabledTraps=sNMPEnabledTraps, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, radarDetectTrap=radarDetectTrap)
