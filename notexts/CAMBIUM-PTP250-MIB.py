...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, installArmStateTrap=installArmStateTrap, fixedModMode=fixedModMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, siteName=siteName, ptpCompliance=ptpCompliance, receivePower=receivePower, masterSlaveMode=masterSlaveMode, configurationGroup=configurationGroup, radarDetectTrap=radarDetectTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptmp=ptmp, ptpTrapPrefix=ptpTrapPrefix, dataPortStatusTrap=dataPortStatusTrap, ptp=ptp, vlanId=vlanId, vlanPriority=vlanPriority, sNMPCommunityAccess=sNMPCommunityAccess, sNMPTrapCommunity=sNMPTrapCommunity, nTPServerIp=nTPServerIp, transmitModulationMode=transmitModulationMode, subnetMask=subnetMask, currentFreqMHz=currentFreqMHz, transmitPower=transmitPower, wirelessLinkStatus=wirelessLinkStatus, systemClock=systemClock, cambium=cambium, productVariant=productVariant, hardwareVersion=hardwareVersion, sNMPCommunityTableIndex=sNMPCommunityTableIndex, dualPayload=dualPayload, ntpGroup=ntpGroup, nTPLastSync=nTPLastSync, gatewayIPAddress=gatewayIPAddress, installArmState=installArmState, band=band, iPAddress=iPAddress, pubStatsGroup=pubStatsGroup, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapVersion=sNMPTrapVersion, sMTPServerIPAddress=sMTPServerIPAddress, vectorError=vectorError, receiveModulationMode=receiveModulationMode, versionsGroup=versionsGroup, softwareVersion=softwareVersion, ntp=ntp, radarDetectChannel=radarDetectChannel, nTPPollInterval=nTPPollInterval, phyStatus=phyStatus, versions=versions, ptpGroups=ptpGroups, cableLoss=cableLoss, sNMPTrapTableIndex=sNMPTrapTableIndex, licence=licence, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitDataRate=transmitDataRate, channelSelection=channelSelection, sNMPCommunityTable=sNMPCommunityTable, sNMPCommunityString=sNMPCommunityString, configuredRange=configuredRange, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, bootVersion=bootVersion, ethernetGroup=ethernetGroup, sNMPCommunityOid=sNMPCommunityOid, tFTPServerPortNumber=tFTPServerPortNumber, measuredRange=measuredRange, sNMPTrapPortNumber=sNMPTrapPortNumber, linkName=linkName, ptpTraps=ptpTraps, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortStatus=dataPortStatus, remoteMACAddress=remoteMACAddress, sNMPTrapTable=sNMPTrapTable, tFTPServerIPAddress=tFTPServerIPAddress, remoteIPAddress=remoteIPAddress, pubStats=pubStats, extendedFreqMHz=extendedFreqMHz, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapIPAddress=sNMPTrapIPAddress, snmpControl=snmpControl, configuredModulationMode=configuredModulationMode, sNMPCommunityTableNumber=sNMPCommunityTableNumber, configuration=configuration, phyStatusGroup=phyStatusGroup, alarmsGroup=alarmsGroup, sNMPCommunityTableEntry=sNMPCommunityTableEntry, snmpControlGroup=snmpControlGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, regionCode=regionCode, timeZone=timeZone, ethernet=ethernet, maximumTransmitPower=maximumTransmitPower, alarms=alarms, extendedChannel=extendedChannel, antennaGain=antennaGain, vlanTagging=vlanTagging, sNMPTrapTableEntry=sNMPTrapTableEntry, noiseFloor=noiseFloor, productName=productName, nTPState=nTPState, receiveDataRate=receiveDataRate, notificationsGroup=notificationsGroup, currentChannel=currentChannel, nTPServerPortNumber=nTPServerPortNumber, linkStatusTrap=linkStatusTrap, smtp=smtp, smtpGroup=smtpGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, searchState=searchState, licenceGroup=licenceGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, nTPSync=nTPSync, ptp250=ptp250, aggregateDataRate=aggregateDataRate, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, signalStrengthRatio=signalStrengthRatio, managementGroup=managementGroup, linkLoss=linkLoss, channelBandwidth=channelBandwidth, management=management, PYSNMP_MODULE_ID=cambium)
