...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", snmpControl=snmpControl, sMTPServerPortNumber=sMTPServerPortNumber, pubStatsGroup=pubStatsGroup, softwareVersion=softwareVersion, productName=productName, sNMPTrapCommunity=sNMPTrapCommunity, subnetMask=subnetMask, notificationsGroup=notificationsGroup, transmitModulationMode=transmitModulationMode, licence=licence, searchState=searchState, sNMPCommunityTableEntry=sNMPCommunityTableEntry, ptmp=ptmp, receiveModulationMode=receiveModulationMode, noiseFloor=noiseFloor, licenceGroup=licenceGroup, smtpGroup=smtpGroup, ptpTrapPrefix=ptpTrapPrefix, gatewayIPAddress=gatewayIPAddress, linkName=linkName, installArmStateTrap=installArmStateTrap, pubStats=pubStats, band=band, sNMPTrapTableNumber=sNMPTrapTableNumber, ntp=ntp, transmitPower=transmitPower, radarDetectTrap=radarDetectTrap, alarms=alarms, systemClock=systemClock, sNMPCommunityString=sNMPCommunityString, sNMPTrapIPAddress=sNMPTrapIPAddress, dualPayload=dualPayload, PYSNMP_MODULE_ID=cambium, vlanTagging=vlanTagging, nTPPollInterval=nTPPollInterval, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, noWirelessChannelAvailable=noWirelessChannelAvailable, phyStatusGroup=phyStatusGroup, tFTPServerPortNumber=tFTPServerPortNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, aggregateDataRate=aggregateDataRate, sNMPTrapTable=sNMPTrapTable, sNMPCommunityAccess=sNMPCommunityAccess, smtp=smtp, versionsGroup=versionsGroup, ethernetGroup=ethernetGroup, versions=versions, sNMPEnabledTraps=sNMPEnabledTraps, remoteIPAddress=remoteIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ethernet=ethernet, linkStatusTrap=linkStatusTrap, productVariant=productVariant, siteName=siteName, vectorError=vectorError, sMTPEnabledMessages=sMTPEnabledMessages, hardwareVersion=hardwareVersion, vlanId=vlanId, configuration=configuration, channelBandwidth=channelBandwidth, installArmState=installArmState, nTPLastSync=nTPLastSync, sMTPServerIPAddress=sMTPServerIPAddress, nTPServerIp=nTPServerIp, antennaGain=antennaGain, wirelessLinkStatus=wirelessLinkStatus, bootVersion=bootVersion, vlanPriority=vlanPriority, configurationGroup=configurationGroup, sNMPCommunityTableNumber=sNMPCommunityTableNumber, fixedModMode=fixedModMode, regionCode=regionCode, ptpTraps=ptpTraps, extendedFreqMHz=extendedFreqMHz, iPAddress=iPAddress, cambium=cambium, configuredModulationMode=configuredModulationMode, configuredRange=configuredRange, channelSelection=channelSelection, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, transmitDataRate=transmitDataRate, radarDetectChannel=radarDetectChannel, ptp250=ptp250, masterSlaveMode=masterSlaveMode, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, nTPSync=nTPSync, currentFreqMHz=currentFreqMHz, timeZone=timeZone, linkLoss=linkLoss, sMTPSourceEmailAddress=sMTPSourceEmailAddress, maximumTransmitPower=maximumTransmitPower, receivePower=receivePower, sNMPCommunityTableIndex=sNMPCommunityTableIndex, ptpGroups=ptpGroups, managementGroup=managementGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPCommunityTable=sNMPCommunityTable, snmpControlGroup=snmpControlGroup, nTPState=nTPState, ptp=ptp, dataPortStatusTrap=dataPortStatusTrap, receiveDataRate=receiveDataRate, tFTPServerIPAddress=tFTPServerIPAddress, measuredRange=measuredRange, alarmsGroup=alarmsGroup, signalStrengthRatio=signalStrengthRatio, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, phyStatus=phyStatus, sNMPTrapVersion=sNMPTrapVersion, sNMPCommunityOid=sNMPCommunityOid, cableLoss=cableLoss, remoteMACAddress=remoteMACAddress, management=management, ntpGroup=ntpGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, nTPServerPortNumber=nTPServerPortNumber, dataPortStatus=dataPortStatus, currentChannel=currentChannel, ptpCompliance=ptpCompliance, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPTrapTableIndex=sNMPTrapTableIndex, extendedChannel=extendedChannel)
