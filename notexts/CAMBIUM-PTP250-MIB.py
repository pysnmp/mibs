...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", smtp=smtp, sNMPCommunityAccess=sNMPCommunityAccess, bootVersion=bootVersion, systemClock=systemClock, radarDetectTrap=radarDetectTrap, remoteMACAddress=remoteMACAddress, sNMPEnabledTraps=sNMPEnabledTraps, receiveDataRate=receiveDataRate, notificationsGroup=notificationsGroup, currentChannel=currentChannel, timeZone=timeZone, ptp=ptp, ntpGroup=ntpGroup, vlanPriority=vlanPriority, sNMPCommunityString=sNMPCommunityString, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapTableNumber=sNMPTrapTableNumber, productName=productName, channelSelection=channelSelection, hardwareVersion=hardwareVersion, tFTPServerIPAddress=tFTPServerIPAddress, installArmState=installArmState, ntp=ntp, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, signalStrengthRatio=signalStrengthRatio, sNMPTrapIPAddress=sNMPTrapIPAddress, ethernet=ethernet, productVariant=productVariant, installArmStateTrap=installArmStateTrap, versions=versions, ptpGroups=ptpGroups, versionsGroup=versionsGroup, configurationGroup=configurationGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPServerIPAddress=sMTPServerIPAddress, pubStatsGroup=pubStatsGroup, measuredRange=measuredRange, dataPortStatusTrap=dataPortStatusTrap, sNMPCommunityTableNumber=sNMPCommunityTableNumber, channelBandwidth=channelBandwidth, pubStats=pubStats, nTPSync=nTPSync, management=management, ptpTraps=ptpTraps, managementGroup=managementGroup, PYSNMP_MODULE_ID=cambium, masterSlaveMode=masterSlaveMode, band=band, ptp250=ptp250, iPAddress=iPAddress, transmitPower=transmitPower, phyStatusGroup=phyStatusGroup, nTPPollInterval=nTPPollInterval, sNMPCommunityTableIndex=sNMPCommunityTableIndex, cableLoss=cableLoss, sNMPTrapVersion=sNMPTrapVersion, tFTPServerPortNumber=tFTPServerPortNumber, softwareVersion=softwareVersion, fixedModMode=fixedModMode, gatewayIPAddress=gatewayIPAddress, subnetMask=subnetMask, licenceGroup=licenceGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPCommunityTable=sNMPCommunityTable, receivePower=receivePower, sMTPServerPortNumber=sMTPServerPortNumber, ptmp=ptmp, nTPLastSync=nTPLastSync, wirelessLinkStatus=wirelessLinkStatus, sNMPCommunityTableEntry=sNMPCommunityTableEntry, linkLoss=linkLoss, extendedChannel=extendedChannel, ptpTrapPrefix=ptpTrapPrefix, extendedFreqMHz=extendedFreqMHz, nTPState=nTPState, nTPServerPortNumber=nTPServerPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, ptpCompliance=ptpCompliance, configuredRange=configuredRange, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, aggregateDataRate=aggregateDataRate, sNMPTrapTableEntry=sNMPTrapTableEntry, currentFreqMHz=currentFreqMHz, linkStatusTrap=linkStatusTrap, transmitModulationMode=transmitModulationMode, maximumTransmitPower=maximumTransmitPower, receiveModulationMode=receiveModulationMode, linkName=linkName, sNMPCommunityOid=sNMPCommunityOid, licence=licence, sNMPTrapTable=sNMPTrapTable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, remoteIPAddress=remoteIPAddress, regionCode=regionCode, snmpControl=snmpControl, ethernetGroup=ethernetGroup, searchState=searchState, transmitDataRate=transmitDataRate, alarms=alarms, noWirelessChannelAvailable=noWirelessChannelAvailable, cambium=cambium, dataPortAutoNegotiation=dataPortAutoNegotiation, radarDetectChannel=radarDetectChannel, dualPayload=dualPayload, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sMTPEnabledMessages=sMTPEnabledMessages, alarmsGroup=alarmsGroup, vlanId=vlanId, snmpControlGroup=snmpControlGroup, smtpGroup=smtpGroup, configuration=configuration, antennaGain=antennaGain, siteName=siteName, configuredModulationMode=configuredModulationMode, vlanTagging=vlanTagging, phyStatus=phyStatus, noiseFloor=noiseFloor, dataPortStatus=dataPortStatus, nTPServerIp=nTPServerIp, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPTrapCommunity=sNMPTrapCommunity, vectorError=vectorError)
