...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", noWirelessChannelAvailable=noWirelessChannelAvailable, configuredModulationMode=configuredModulationMode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, radarDetectChannel=radarDetectChannel, transmitPower=transmitPower, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPServerIPAddress=tFTPServerIPAddress, nTPServerPortNumber=nTPServerPortNumber, versionsGroup=versionsGroup, timeZone=timeZone, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, masterSlaveMode=masterSlaveMode, channelSelection=channelSelection, maximumTransmitPower=maximumTransmitPower, snmpControlGroup=snmpControlGroup, subnetMask=subnetMask, nTPServerIp=nTPServerIp, sNMPTrapPortNumber=sNMPTrapPortNumber, sMTPServerIPAddress=sMTPServerIPAddress, ptp=ptp, linkStatusTrap=linkStatusTrap, band=band, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, remoteIPAddress=remoteIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPEnabledTraps=sNMPEnabledTraps, ntp=ntp, licence=licence, nTPLastSync=nTPLastSync, dualPayload=dualPayload, measuredRange=measuredRange, vectorError=vectorError, transmitDataRate=transmitDataRate, radarDetectTrap=radarDetectTrap, ethernet=ethernet, sMTPEnabledMessages=sMTPEnabledMessages, regionCode=regionCode, transmitModulationMode=transmitModulationMode, extendedFreqMHz=extendedFreqMHz, sNMPCommunityString=sNMPCommunityString, fixedModMode=fixedModMode, antennaGain=antennaGain, phyStatus=phyStatus, siteName=siteName, cableLoss=cableLoss, linkLoss=linkLoss, nTPState=nTPState, linkName=linkName, pubStats=pubStats, ethernetGroup=ethernetGroup, configurationGroup=configurationGroup, extendedChannel=extendedChannel, sNMPCommunityOid=sNMPCommunityOid, sMTPSourceEmailAddress=sMTPSourceEmailAddress, smtpGroup=smtpGroup, noiseFloor=noiseFloor, configuredRange=configuredRange, versions=versions, ptpTrapPrefix=ptpTrapPrefix, configuration=configuration, managementGroup=managementGroup, ntpGroup=ntpGroup, alarmsGroup=alarmsGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, PYSNMP_MODULE_ID=cambium, sNMPTrapVersion=sNMPTrapVersion, dataPortStatus=dataPortStatus, bootVersion=bootVersion, channelBandwidth=channelBandwidth, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, currentChannel=currentChannel, productVariant=productVariant, iPAddress=iPAddress, aggregateDataRate=aggregateDataRate, ptpGroups=ptpGroups, sNMPTrapTable=sNMPTrapTable, vlanId=vlanId, sNMPTrapTableNumber=sNMPTrapTableNumber, vlanTagging=vlanTagging, dataPortStatusTrap=dataPortStatusTrap, phyStatusGroup=phyStatusGroup, nTPSync=nTPSync, receiveModulationMode=receiveModulationMode, notificationsGroup=notificationsGroup, vlanPriority=vlanPriority, ptmp=ptmp, remoteMACAddress=remoteMACAddress, tFTPServerPortNumber=tFTPServerPortNumber, gatewayIPAddress=gatewayIPAddress, signalStrengthRatio=signalStrengthRatio, sNMPTrapTableEntry=sNMPTrapTableEntry, pubStatsGroup=pubStatsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, ptpTraps=ptpTraps, sNMPCommunityTableNumber=sNMPCommunityTableNumber, installArmStateTrap=installArmStateTrap, nTPPollInterval=nTPPollInterval, hardwareVersion=hardwareVersion, receiveDataRate=receiveDataRate, wirelessLinkStatus=wirelessLinkStatus, alarms=alarms, smtp=smtp, sNMPCommunityTableEntry=sNMPCommunityTableEntry, management=management, sNMPTrapCommunity=sNMPTrapCommunity, sNMPCommunityTableIndex=sNMPCommunityTableIndex, receivePower=receivePower, snmpControl=snmpControl, cambium=cambium, systemClock=systemClock, currentFreqMHz=currentFreqMHz, sMTPServerPortNumber=sMTPServerPortNumber, ptp250=ptp250, ptpCompliance=ptpCompliance, installArmState=installArmState, searchState=searchState, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, productName=productName, licenceGroup=licenceGroup, sNMPCommunityTable=sNMPCommunityTable, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPCommunityAccess=sNMPCommunityAccess, softwareVersion=softwareVersion)
