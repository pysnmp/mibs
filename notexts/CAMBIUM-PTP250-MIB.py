...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", linkName=linkName, installArmStateTrap=installArmStateTrap, bootVersion=bootVersion, ntp=ntp, nTPSync=nTPSync, sNMPTrapTableEntry=sNMPTrapTableEntry, alarmsGroup=alarmsGroup, pubStatsGroup=pubStatsGroup, timeZone=timeZone, phyStatusGroup=phyStatusGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ptmp=ptmp, versions=versions, transmitPower=transmitPower, vectorError=vectorError, linkStatusTrap=linkStatusTrap, sNMPTrapTable=sNMPTrapTable, vlanTagging=vlanTagging, managementGroup=managementGroup, subnetMask=subnetMask, currentFreqMHz=currentFreqMHz, snmpControl=snmpControl, ptpGroups=ptpGroups, ethernetGroup=ethernetGroup, remoteMACAddress=remoteMACAddress, dualPayload=dualPayload, receivePower=receivePower, configuredRange=configuredRange, licence=licence, notificationsGroup=notificationsGroup, sNMPCommunityTable=sNMPCommunityTable, siteName=siteName, productVariant=productVariant, iPAddress=iPAddress, dataPortStatusTrap=dataPortStatusTrap, smtpGroup=smtpGroup, ptpCompliance=ptpCompliance, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortStatus=dataPortStatus, sNMPCommunityOid=sNMPCommunityOid, noiseFloor=noiseFloor, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, PYSNMP_MODULE_ID=cambium, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, signalStrengthRatio=signalStrengthRatio, ptpTrapPrefix=ptpTrapPrefix, alarms=alarms, masterSlaveMode=masterSlaveMode, regionCode=regionCode, hardwareVersion=hardwareVersion, extendedFreqMHz=extendedFreqMHz, nTPServerIp=nTPServerIp, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPCommunityAccess=sNMPCommunityAccess, snmpControlGroup=snmpControlGroup, radarDetectChannel=radarDetectChannel, ptpTraps=ptpTraps, ntpGroup=ntpGroup, smtp=smtp, measuredRange=measuredRange, management=management, sNMPTrapVersion=sNMPTrapVersion, currentChannel=currentChannel, linkLoss=linkLoss, transmitDataRate=transmitDataRate, phyStatus=phyStatus, ptp250=ptp250, vlanId=vlanId, maximumTransmitPower=maximumTransmitPower, remoteIPAddress=remoteIPAddress, sMTPEnabledMessages=sMTPEnabledMessages, searchState=searchState, sNMPTrapCommunity=sNMPTrapCommunity, sMTPServerPortNumber=sMTPServerPortNumber, receiveDataRate=receiveDataRate, systemClock=systemClock, nTPState=nTPState, configurationGroup=configurationGroup, cambium=cambium, antennaGain=antennaGain, productName=productName, radarDetectTrap=radarDetectTrap, nTPLastSync=nTPLastSync, vlanPriority=vlanPriority, extendedChannel=extendedChannel, cableLoss=cableLoss, licenceGroup=licenceGroup, configuration=configuration, noWirelessChannelAvailable=noWirelessChannelAvailable, ethernet=ethernet, wirelessLinkStatus=wirelessLinkStatus, sNMPCommunityTableNumber=sNMPCommunityTableNumber, nTPPollInterval=nTPPollInterval, softwareVersion=softwareVersion, versionsGroup=versionsGroup, sMTPServerIPAddress=sMTPServerIPAddress, installArmState=installArmState, channelBandwidth=channelBandwidth, band=band, sNMPCommunityString=sNMPCommunityString, receiveModulationMode=receiveModulationMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, transmitModulationMode=transmitModulationMode, sNMPTrapTableIndex=sNMPTrapTableIndex, tFTPServerPortNumber=tFTPServerPortNumber, gatewayIPAddress=gatewayIPAddress, sNMPCommunityTableIndex=sNMPCommunityTableIndex, nTPServerPortNumber=nTPServerPortNumber, fixedModMode=fixedModMode, configuredModulationMode=configuredModulationMode, sNMPCommunityTableEntry=sNMPCommunityTableEntry, pubStats=pubStats, channelSelection=channelSelection, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapTableNumber=sNMPTrapTableNumber, aggregateDataRate=aggregateDataRate, sNMPEnabledTraps=sNMPEnabledTraps, tFTPServerIPAddress=tFTPServerIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ptp=ptp, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement)
