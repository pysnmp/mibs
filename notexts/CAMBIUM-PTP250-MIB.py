...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", pubStats=pubStats, vlanId=vlanId, ptmp=ptmp, nTPSync=nTPSync, sNMPCommunityTableIndex=sNMPCommunityTableIndex, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, systemClock=systemClock, pubStatsGroup=pubStatsGroup, tFTPServerPortNumber=tFTPServerPortNumber, transmitModulationMode=transmitModulationMode, PYSNMP_MODULE_ID=cambium, dualPayload=dualPayload, nTPServerPortNumber=nTPServerPortNumber, smtp=smtp, transmitDataRate=transmitDataRate, sNMPCommunityTable=sNMPCommunityTable, ntpGroup=ntpGroup, dataPortStatus=dataPortStatus, ethernet=ethernet, sNMPTrapTableNumber=sNMPTrapTableNumber, configuredRange=configuredRange, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, maximumTransmitPower=maximumTransmitPower, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, smtpGroup=smtpGroup, ethernetGroup=ethernetGroup, alarms=alarms, signalStrengthRatio=signalStrengthRatio, vectorError=vectorError, ptpTraps=ptpTraps, phyStatusGroup=phyStatusGroup, remoteIPAddress=remoteIPAddress, channelBandwidth=channelBandwidth, remoteMACAddress=remoteMACAddress, snmpControl=snmpControl, cambium=cambium, masterSlaveMode=masterSlaveMode, hardwareVersion=hardwareVersion, nTPPollInterval=nTPPollInterval, radarDetectChannel=radarDetectChannel, licence=licence, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPEnabledTraps=sNMPEnabledTraps, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortStatusTrap=dataPortStatusTrap, managementGroup=managementGroup, siteName=siteName, ptp250=ptp250, aggregateDataRate=aggregateDataRate, productVariant=productVariant, configurationGroup=configurationGroup, nTPLastSync=nTPLastSync, management=management, receivePower=receivePower, sMTPEnabledMessages=sMTPEnabledMessages, sNMPCommunityAccess=sNMPCommunityAccess, band=band, vlanPriority=vlanPriority, iPAddress=iPAddress, alarmsGroup=alarmsGroup, ptpGroups=ptpGroups, transmitPower=transmitPower, fixedModMode=fixedModMode, ptp=ptp, gatewayIPAddress=gatewayIPAddress, extendedFreqMHz=extendedFreqMHz, sMTPServerPortNumber=sMTPServerPortNumber, currentFreqMHz=currentFreqMHz, subnetMask=subnetMask, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPCommunityString=sNMPCommunityString, sNMPCommunityOid=sNMPCommunityOid, sNMPTrapTable=sNMPTrapTable, sNMPTrapCommunity=sNMPTrapCommunity, cableLoss=cableLoss, phyStatus=phyStatus, sNMPTrapVersion=sNMPTrapVersion, extendedChannel=extendedChannel, sNMPTrapTableEntry=sNMPTrapTableEntry, antennaGain=antennaGain, snmpControlGroup=snmpControlGroup, nTPState=nTPState, softwareVersion=softwareVersion, channelSelection=channelSelection, vlanTagging=vlanTagging, sNMPCommunityTableNumber=sNMPCommunityTableNumber, ptpCompliance=ptpCompliance, receiveDataRate=receiveDataRate, licenceGroup=licenceGroup, wirelessLinkStatus=wirelessLinkStatus, searchState=searchState, nTPServerIp=nTPServerIp, radarDetectTrap=radarDetectTrap, versionsGroup=versionsGroup, notificationsGroup=notificationsGroup, noiseFloor=noiseFloor, linkStatusTrap=linkStatusTrap, linkLoss=linkLoss, ntp=ntp, timeZone=timeZone, linkName=linkName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, bootVersion=bootVersion, ptpTrapPrefix=ptpTrapPrefix, productName=productName, installArmState=installArmState, receiveModulationMode=receiveModulationMode, noWirelessChannelAvailable=noWirelessChannelAvailable, measuredRange=measuredRange, configuredModulationMode=configuredModulationMode, versions=versions, tFTPServerIPAddress=tFTPServerIPAddress, configuration=configuration, regionCode=regionCode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapPortNumber=sNMPTrapPortNumber, currentChannel=currentChannel, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPCommunityTableEntry=sNMPCommunityTableEntry, installArmStateTrap=installArmStateTrap, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress)
