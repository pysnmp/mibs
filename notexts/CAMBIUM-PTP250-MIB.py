...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", ethernetGroup=ethernetGroup, ptpGroups=ptpGroups, radarDetectTrap=radarDetectTrap, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, gatewayIPAddress=gatewayIPAddress, currentFreqMHz=currentFreqMHz, versionsGroup=versionsGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, ptp250=ptp250, configuration=configuration, dataPortStatus=dataPortStatus, remoteIPAddress=remoteIPAddress, band=band, vlanPriority=vlanPriority, vlanId=vlanId, configuredRange=configuredRange, smtp=smtp, snmpControl=snmpControl, measuredRange=measuredRange, versions=versions, productName=productName, vlanTagging=vlanTagging, currentChannel=currentChannel, radarDetectChannel=radarDetectChannel, linkName=linkName, timeZone=timeZone, sNMPCommunityTableEntry=sNMPCommunityTableEntry, regionCode=regionCode, PYSNMP_MODULE_ID=cambium, extendedChannel=extendedChannel, fixedModMode=fixedModMode, dataPortStatusTrap=dataPortStatusTrap, smtpGroup=smtpGroup, ptpTraps=ptpTraps, transmitPower=transmitPower, transmitModulationMode=transmitModulationMode, linkStatusTrap=linkStatusTrap, antennaGain=antennaGain, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, nTPLastSync=nTPLastSync, receiveDataRate=receiveDataRate, ptp=ptp, ntp=ntp, cambium=cambium, maximumTransmitPower=maximumTransmitPower, sNMPCommunityAccess=sNMPCommunityAccess, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, channelBandwidth=channelBandwidth, nTPState=nTPState, alarms=alarms, ntpGroup=ntpGroup, extendedFreqMHz=extendedFreqMHz, pubStatsGroup=pubStatsGroup, channelSelection=channelSelection, sNMPTrapCommunity=sNMPTrapCommunity, phyStatusGroup=phyStatusGroup, aggregateDataRate=aggregateDataRate, ethernet=ethernet, licenceGroup=licenceGroup, vectorError=vectorError, receiveModulationMode=receiveModulationMode, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dualPayload=dualPayload, productVariant=productVariant, sMTPServerIPAddress=sMTPServerIPAddress, hardwareVersion=hardwareVersion, managementGroup=managementGroup, noiseFloor=noiseFloor, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, notificationsGroup=notificationsGroup, alarmsGroup=alarmsGroup, sNMPTrapTable=sNMPTrapTable, sNMPCommunityString=sNMPCommunityString, subnetMask=subnetMask, sNMPTrapTableIndex=sNMPTrapTableIndex, cableLoss=cableLoss, nTPServerPortNumber=nTPServerPortNumber, sMTPServerPortNumber=sMTPServerPortNumber, nTPSync=nTPSync, siteName=siteName, masterSlaveMode=masterSlaveMode, nTPServerIp=nTPServerIp, ptpTrapPrefix=ptpTrapPrefix, sMTPEnabledMessages=sMTPEnabledMessages, tFTPServerPortNumber=tFTPServerPortNumber, sNMPCommunityTable=sNMPCommunityTable, softwareVersion=softwareVersion, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, wirelessLinkStatus=wirelessLinkStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, remoteMACAddress=remoteMACAddress, searchState=searchState, noWirelessChannelAvailable=noWirelessChannelAvailable, licence=licence, signalStrengthRatio=signalStrengthRatio, receivePower=receivePower, management=management, pubStats=pubStats, configurationGroup=configurationGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, configuredModulationMode=configuredModulationMode, installArmStateTrap=installArmStateTrap, iPAddress=iPAddress, sNMPCommunityTableIndex=sNMPCommunityTableIndex, linkLoss=linkLoss, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapVersion=sNMPTrapVersion, nTPPollInterval=nTPPollInterval, bootVersion=bootVersion, sNMPEnabledTraps=sNMPEnabledTraps, ptmp=ptmp, phyStatus=phyStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, installArmState=installArmState, sNMPCommunityOid=sNMPCommunityOid, dataPortAutoNegotiation=dataPortAutoNegotiation, snmpControlGroup=snmpControlGroup, systemClock=systemClock, sNMPTrapPortNumber=sNMPTrapPortNumber, transmitDataRate=transmitDataRate, ptpCompliance=ptpCompliance)
