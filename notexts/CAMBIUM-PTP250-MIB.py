...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", alarmsGroup=alarmsGroup, configuredModulationMode=configuredModulationMode, tFTPServerPortNumber=tFTPServerPortNumber, ethernetGroup=ethernetGroup, searchState=searchState, measuredRange=measuredRange, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkStatusTrap=linkStatusTrap, ptpGroups=ptpGroups, band=band, antennaGain=antennaGain, smtp=smtp, dataPortStatus=dataPortStatus, ptpTraps=ptpTraps, installArmState=installArmState, aggregateDataRate=aggregateDataRate, productName=productName, timeZone=timeZone, sNMPTrapPortNumber=sNMPTrapPortNumber, smtpGroup=smtpGroup, softwareVersion=softwareVersion, cableLoss=cableLoss, sNMPCommunityTable=sNMPCommunityTable, iPAddress=iPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptpTrapPrefix=ptpTrapPrefix, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapTableEntry=sNMPTrapTableEntry, radarDetectTrap=radarDetectTrap, ntp=ntp, sNMPTrapTable=sNMPTrapTable, nTPPollInterval=nTPPollInterval, sMTPEnabledMessages=sMTPEnabledMessages, signalStrengthRatio=signalStrengthRatio, regionCode=regionCode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, fixedModMode=fixedModMode, managementGroup=managementGroup, siteName=siteName, sMTPServerIPAddress=sMTPServerIPAddress, nTPSync=nTPSync, vectorError=vectorError, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPCommunityTableEntry=sNMPCommunityTableEntry, extendedChannel=extendedChannel, extendedFreqMHz=extendedFreqMHz, pubStats=pubStats, sNMPCommunityTableNumber=sNMPCommunityTableNumber, vlanPriority=vlanPriority, dataPortStatusTrap=dataPortStatusTrap, alarms=alarms, channelSelection=channelSelection, installArmStateTrap=installArmStateTrap, channelBandwidth=channelBandwidth, ptpCompliance=ptpCompliance, sNMPCommunityOid=sNMPCommunityOid, receiveModulationMode=receiveModulationMode, ntpGroup=ntpGroup, nTPLastSync=nTPLastSync, sNMPCommunityTableIndex=sNMPCommunityTableIndex, transmitModulationMode=transmitModulationMode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, phyStatus=phyStatus, licence=licence, configuredRange=configuredRange, linkLoss=linkLoss, sMTPServerPortNumber=sMTPServerPortNumber, cambium=cambium, sNMPCommunityString=sNMPCommunityString, vlanId=vlanId, transmitDataRate=transmitDataRate, masterSlaveMode=masterSlaveMode, productVariant=productVariant, noiseFloor=noiseFloor, vlanTagging=vlanTagging, snmpControlGroup=snmpControlGroup, ptp250=ptp250, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPCommunityAccess=sNMPCommunityAccess, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, currentChannel=currentChannel, linkName=linkName, systemClock=systemClock, configurationGroup=configurationGroup, tFTPServerIPAddress=tFTPServerIPAddress, nTPServerPortNumber=nTPServerPortNumber, nTPServerIp=nTPServerIp, ethernet=ethernet, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, remoteMACAddress=remoteMACAddress, currentFreqMHz=currentFreqMHz, noWirelessChannelAvailable=noWirelessChannelAvailable, dualPayload=dualPayload, snmpControl=snmpControl, sNMPTrapTableNumber=sNMPTrapTableNumber, configuration=configuration, versionsGroup=versionsGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, gatewayIPAddress=gatewayIPAddress, receiveDataRate=receiveDataRate, radarDetectChannel=radarDetectChannel, sNMPTrapCommunity=sNMPTrapCommunity, receivePower=receivePower, licenceGroup=licenceGroup, sNMPTrapVersion=sNMPTrapVersion, ptmp=ptmp, pubStatsGroup=pubStatsGroup, management=management, maximumTransmitPower=maximumTransmitPower, transmitPower=transmitPower, nTPState=nTPState, versions=versions, wirelessLinkStatus=wirelessLinkStatus, dataPortAutoNegotiation=dataPortAutoNegotiation, PYSNMP_MODULE_ID=cambium, subnetMask=subnetMask, hardwareVersion=hardwareVersion, phyStatusGroup=phyStatusGroup, bootVersion=bootVersion, notificationsGroup=notificationsGroup, ptp=ptp, remoteIPAddress=remoteIPAddress)
