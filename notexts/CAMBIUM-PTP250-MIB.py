...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", phyStatus=phyStatus, radarDetectTrap=radarDetectTrap, licenceGroup=licenceGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, alarmsGroup=alarmsGroup, ptp=ptp, receivePower=receivePower, sNMPCommunityOid=sNMPCommunityOid, maximumTransmitPower=maximumTransmitPower, sMTPSourceEmailAddress=sMTPSourceEmailAddress, searchState=searchState, nTPState=nTPState, cambium=cambium, remoteIPAddress=remoteIPAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPCommunityAccess=sNMPCommunityAccess, sNMPEnabledTraps=sNMPEnabledTraps, phyStatusGroup=phyStatusGroup, ethernetGroup=ethernetGroup, currentChannel=currentChannel, sNMPCommunityTableEntry=sNMPCommunityTableEntry, nTPServerIp=nTPServerIp, tFTPServerPortNumber=tFTPServerPortNumber, nTPPollInterval=nTPPollInterval, channelBandwidth=channelBandwidth, remoteMACAddress=remoteMACAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, configurationGroup=configurationGroup, ptp250=ptp250, siteName=siteName, linkName=linkName, PYSNMP_MODULE_ID=cambium, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapCommunity=sNMPTrapCommunity, sNMPCommunityString=sNMPCommunityString, vlanPriority=vlanPriority, aggregateDataRate=aggregateDataRate, gatewayIPAddress=gatewayIPAddress, ptmp=ptmp, configuredRange=configuredRange, configuredModulationMode=configuredModulationMode, nTPServerPortNumber=nTPServerPortNumber, installArmState=installArmState, ntpGroup=ntpGroup, transmitPower=transmitPower, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, installArmStateTrap=installArmStateTrap, management=management, pubStatsGroup=pubStatsGroup, hardwareVersion=hardwareVersion, extendedChannel=extendedChannel, wirelessLinkStatus=wirelessLinkStatus, vectorError=vectorError, bootVersion=bootVersion, snmpControlGroup=snmpControlGroup, signalStrengthRatio=signalStrengthRatio, sNMPCommunityTableNumber=sNMPCommunityTableNumber, ptpCompliance=ptpCompliance, ntp=ntp, channelSelection=channelSelection, softwareVersion=softwareVersion, nTPLastSync=nTPLastSync, sNMPTrapTableEntry=sNMPTrapTableEntry, productVariant=productVariant, iPAddress=iPAddress, sNMPTrapTable=sNMPTrapTable, ptpTrapPrefix=ptpTrapPrefix, sMTPEnabledMessages=sMTPEnabledMessages, configuration=configuration, sNMPCommunityTableIndex=sNMPCommunityTableIndex, timeZone=timeZone, snmpControl=snmpControl, dualPayload=dualPayload, smtpGroup=smtpGroup, ptpTraps=ptpTraps, receiveModulationMode=receiveModulationMode, extendedFreqMHz=extendedFreqMHz, alarms=alarms, nTPSync=nTPSync, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptpGroups=ptpGroups, sMTPServerPortNumber=sMTPServerPortNumber, currentFreqMHz=currentFreqMHz, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapVersion=sNMPTrapVersion, cableLoss=cableLoss, transmitModulationMode=transmitModulationMode, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, versions=versions, pubStats=pubStats, vlanId=vlanId, vlanTagging=vlanTagging, sNMPTrapPortNumber=sNMPTrapPortNumber, antennaGain=antennaGain, linkStatusTrap=linkStatusTrap, licence=licence, sMTPServerIPAddress=sMTPServerIPAddress, dataPortStatus=dataPortStatus, band=band, sNMPCommunityTable=sNMPCommunityTable, noiseFloor=noiseFloor, managementGroup=managementGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, receiveDataRate=receiveDataRate, smtp=smtp, linkLoss=linkLoss, masterSlaveMode=masterSlaveMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, systemClock=systemClock, fixedModMode=fixedModMode, regionCode=regionCode, transmitDataRate=transmitDataRate, radarDetectChannel=radarDetectChannel, sNMPTrapTableIndex=sNMPTrapTableIndex, versionsGroup=versionsGroup, dataPortStatusTrap=dataPortStatusTrap, notificationsGroup=notificationsGroup, productName=productName, subnetMask=subnetMask, measuredRange=measuredRange, ethernet=ethernet, tFTPServerIPAddress=tFTPServerIPAddress)
