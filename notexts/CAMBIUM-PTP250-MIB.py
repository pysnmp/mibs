...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPCommunityTableEntry=sNMPCommunityTableEntry, receiveModulationMode=receiveModulationMode, ptp250=ptp250, linkStatusTrap=linkStatusTrap, sNMPCommunityString=sNMPCommunityString, subnetMask=subnetMask, sNMPCommunityTable=sNMPCommunityTable, receivePower=receivePower, band=band, notificationsGroup=notificationsGroup, sNMPTrapCommunity=sNMPTrapCommunity, vlanTagging=vlanTagging, dualPayload=dualPayload, licence=licence, bootVersion=bootVersion, linkLoss=linkLoss, nTPLastSync=nTPLastSync, PYSNMP_MODULE_ID=cambium, alarms=alarms, antennaGain=antennaGain, cambium=cambium, versions=versions, nTPServerIp=nTPServerIp, transmitPower=transmitPower, versionsGroup=versionsGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptp=ptp, dataPortAutoNegotiation=dataPortAutoNegotiation, timeZone=timeZone, sNMPTrapPortNumber=sNMPTrapPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, configuration=configuration, sNMPCommunityOid=sNMPCommunityOid, sNMPTrapTableNumber=sNMPTrapTableNumber, cableLoss=cableLoss, sNMPTrapTable=sNMPTrapTable, softwareVersion=softwareVersion, ntpGroup=ntpGroup, noiseFloor=noiseFloor, licenceGroup=licenceGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, fixedModMode=fixedModMode, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernetGroup=ethernetGroup, management=management, ptpTrapPrefix=ptpTrapPrefix, productName=productName, regionCode=regionCode, sNMPTrapIPAddress=sNMPTrapIPAddress, ptpGroups=ptpGroups, radarDetectTrap=radarDetectTrap, radarDetectChannel=radarDetectChannel, hardwareVersion=hardwareVersion, remoteIPAddress=remoteIPAddress, snmpControl=snmpControl, nTPState=nTPState, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receiveDataRate=receiveDataRate, snmpControlGroup=snmpControlGroup, currentChannel=currentChannel, ethernet=ethernet, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, vlanPriority=vlanPriority, maximumTransmitPower=maximumTransmitPower, pubStatsGroup=pubStatsGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, extendedFreqMHz=extendedFreqMHz, nTPPollInterval=nTPPollInterval, vectorError=vectorError, managementGroup=managementGroup, channelSelection=channelSelection, alarmsGroup=alarmsGroup, configurationGroup=configurationGroup, signalStrengthRatio=signalStrengthRatio, sMTPEnabledMessages=sMTPEnabledMessages, aggregateDataRate=aggregateDataRate, installArmStateTrap=installArmStateTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, systemClock=systemClock, currentFreqMHz=currentFreqMHz, vlanId=vlanId, smtpGroup=smtpGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, linkName=linkName, ptpCompliance=ptpCompliance, sNMPTrapVersion=sNMPTrapVersion, ptmp=ptmp, transmitModulationMode=transmitModulationMode, iPAddress=iPAddress, configuredModulationMode=configuredModulationMode, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, channelBandwidth=channelBandwidth, nTPServerPortNumber=nTPServerPortNumber, remoteMACAddress=remoteMACAddress, tFTPServerPortNumber=tFTPServerPortNumber, dataPortStatusTrap=dataPortStatusTrap, dataPortStatus=dataPortStatus, nTPSync=nTPSync, installArmState=installArmState, searchState=searchState, productVariant=productVariant, sNMPEnabledTraps=sNMPEnabledTraps, extendedChannel=extendedChannel, ntp=ntp, ptpTraps=ptpTraps, tFTPServerIPAddress=tFTPServerIPAddress, wirelessLinkStatus=wirelessLinkStatus, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sMTPServerIPAddress=sMTPServerIPAddress, sNMPCommunityTableNumber=sNMPCommunityTableNumber, configuredRange=configuredRange, siteName=siteName, phyStatus=phyStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, transmitDataRate=transmitDataRate, gatewayIPAddress=gatewayIPAddress, measuredRange=measuredRange, sNMPTrapTableEntry=sNMPTrapTableEntry, pubStats=pubStats, sNMPCommunityAccess=sNMPCommunityAccess, smtp=smtp, phyStatusGroup=phyStatusGroup, sMTPServerPortNumber=sMTPServerPortNumber, masterSlaveMode=masterSlaveMode)
