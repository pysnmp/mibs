...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", radarDetectTrap=radarDetectTrap, subnetMask=subnetMask, currentFreqMHz=currentFreqMHz, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sNMPTrapTableIndex=sNMPTrapTableIndex, configurationGroup=configurationGroup, vlanPriority=vlanPriority, phyStatus=phyStatus, sNMPTrapVersion=sNMPTrapVersion, licenceGroup=licenceGroup, transmitModulationMode=transmitModulationMode, channelSelection=channelSelection, sNMPCommunityString=sNMPCommunityString, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPServerPortNumber=sMTPServerPortNumber, linkLoss=linkLoss, ethernet=ethernet, snmpControlGroup=snmpControlGroup, band=band, tFTPServerPortNumber=tFTPServerPortNumber, PYSNMP_MODULE_ID=cambium, productName=productName, remoteIPAddress=remoteIPAddress, currentChannel=currentChannel, receivePower=receivePower, sNMPTrapTableEntry=sNMPTrapTableEntry, ptp250=ptp250, receiveDataRate=receiveDataRate, productVariant=productVariant, masterSlaveMode=masterSlaveMode, sNMPCommunityOid=sNMPCommunityOid, pubStats=pubStats, dataPortStatus=dataPortStatus, gatewayIPAddress=gatewayIPAddress, configuredModulationMode=configuredModulationMode, vectorError=vectorError, siteName=siteName, licence=licence, sNMPCommunityTableEntry=sNMPCommunityTableEntry, linkStatusTrap=linkStatusTrap, configuredRange=configuredRange, versions=versions, noiseFloor=noiseFloor, sNMPCommunityAccess=sNMPCommunityAccess, phyStatusGroup=phyStatusGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, radarDetectChannel=radarDetectChannel, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernetGroup=ethernetGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapTable=sNMPTrapTable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPEnabledTraps=sNMPEnabledTraps, ntp=ntp, dataPortStatusTrap=dataPortStatusTrap, hardwareVersion=hardwareVersion, alarmsGroup=alarmsGroup, signalStrengthRatio=signalStrengthRatio, nTPState=nTPState, sNMPTrapTableNumber=sNMPTrapTableNumber, management=management, managementGroup=managementGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, nTPServerPortNumber=nTPServerPortNumber, softwareVersion=softwareVersion, iPAddress=iPAddress, pubStatsGroup=pubStatsGroup, snmpControl=snmpControl, fixedModMode=fixedModMode, searchState=searchState, extendedChannel=extendedChannel, timeZone=timeZone, ptpGroups=ptpGroups, receiveModulationMode=receiveModulationMode, extendedFreqMHz=extendedFreqMHz, nTPSync=nTPSync, systemClock=systemClock, installArmState=installArmState, tFTPServerIPAddress=tFTPServerIPAddress, versionsGroup=versionsGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPCommunityTableNumber=sNMPCommunityTableNumber, maximumTransmitPower=maximumTransmitPower, ptmp=ptmp, wirelessLinkStatus=wirelessLinkStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, linkName=linkName, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transmitPower=transmitPower, transmitDataRate=transmitDataRate, dualPayload=dualPayload, ptp=ptp, sNMPCommunityTable=sNMPCommunityTable, notificationsGroup=notificationsGroup, remoteMACAddress=remoteMACAddress, nTPLastSync=nTPLastSync, smtp=smtp, vlanTagging=vlanTagging, antennaGain=antennaGain, ptpTraps=ptpTraps, regionCode=regionCode, dataPortAutoNegotiation=dataPortAutoNegotiation, bootVersion=bootVersion, configuration=configuration, sMTPEnabledMessages=sMTPEnabledMessages, smtpGroup=smtpGroup, measuredRange=measuredRange, aggregateDataRate=aggregateDataRate, sNMPTrapCommunity=sNMPTrapCommunity, channelBandwidth=channelBandwidth, alarms=alarms, vlanId=vlanId, sMTPServerIPAddress=sMTPServerIPAddress, cambium=cambium, installArmStateTrap=installArmStateTrap, nTPPollInterval=nTPPollInterval, ptpCompliance=ptpCompliance, ntpGroup=ntpGroup, nTPServerIp=nTPServerIp, ptpTrapPrefix=ptpTrapPrefix, cableLoss=cableLoss, sNMPTrapIPAddress=sNMPTrapIPAddress)
