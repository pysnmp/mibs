...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", bootVersion=bootVersion, management=management, installArmState=installArmState, antennaGain=antennaGain, vlanId=vlanId, sMTPServerPortNumber=sMTPServerPortNumber, sNMPCommunityAccess=sNMPCommunityAccess, aggregateDataRate=aggregateDataRate, nTPSync=nTPSync, ethernet=ethernet, linkStatusTrap=linkStatusTrap, noiseFloor=noiseFloor, productVariant=productVariant, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPTrapTable=sNMPTrapTable, phyStatusGroup=phyStatusGroup, snmpControlGroup=snmpControlGroup, productName=productName, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortStatus=dataPortStatus, ptp=ptp, ethernetGroup=ethernetGroup, configurationGroup=configurationGroup, configuredRange=configuredRange, sNMPTrapTableNumber=sNMPTrapTableNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, extendedFreqMHz=extendedFreqMHz, configuredModulationMode=configuredModulationMode, nTPState=nTPState, versionsGroup=versionsGroup, ptpTraps=ptpTraps, pubStatsGroup=pubStatsGroup, hardwareVersion=hardwareVersion, masterSlaveMode=masterSlaveMode, snmpControl=snmpControl, regionCode=regionCode, sNMPTrapPortNumber=sNMPTrapPortNumber, fixedModMode=fixedModMode, softwareVersion=softwareVersion, dataPortStatusTrap=dataPortStatusTrap, sNMPEnabledTraps=sNMPEnabledTraps, alarmsGroup=alarmsGroup, ptmp=ptmp, sNMPTrapCommunity=sNMPTrapCommunity, receivePower=receivePower, transmitModulationMode=transmitModulationMode, band=band, siteName=siteName, extendedChannel=extendedChannel, vlanTagging=vlanTagging, sNMPCommunityTableEntry=sNMPCommunityTableEntry, currentChannel=currentChannel, nTPServerPortNumber=nTPServerPortNumber, timeZone=timeZone, radarDetectTrap=radarDetectTrap, receiveDataRate=receiveDataRate, signalStrengthRatio=signalStrengthRatio, nTPLastSync=nTPLastSync, transmitPower=transmitPower, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptpTrapPrefix=ptpTrapPrefix, notificationsGroup=notificationsGroup, sNMPCommunityTable=sNMPCommunityTable, measuredRange=measuredRange, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPTrapVersion=sNMPTrapVersion, smtp=smtp, gatewayIPAddress=gatewayIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, vlanPriority=vlanPriority, dualPayload=dualPayload, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPCommunityTableIndex=sNMPCommunityTableIndex, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, PYSNMP_MODULE_ID=cambium, cableLoss=cableLoss, remoteIPAddress=remoteIPAddress, iPAddress=iPAddress, licence=licence, currentFreqMHz=currentFreqMHz, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, systemClock=systemClock, linkName=linkName, maximumTransmitPower=maximumTransmitPower, channelSelection=channelSelection, linkLoss=linkLoss, alarms=alarms, ptpGroups=ptpGroups, tFTPServerIPAddress=tFTPServerIPAddress, ntpGroup=ntpGroup, searchState=searchState, ntp=ntp, channelBandwidth=channelBandwidth, vectorError=vectorError, installArmStateTrap=installArmStateTrap, tFTPServerPortNumber=tFTPServerPortNumber, managementGroup=managementGroup, receiveModulationMode=receiveModulationMode, sNMPCommunityTableNumber=sNMPCommunityTableNumber, wirelessLinkStatus=wirelessLinkStatus, nTPPollInterval=nTPPollInterval, sNMPCommunityOid=sNMPCommunityOid, licenceGroup=licenceGroup, subnetMask=subnetMask, transmitDataRate=transmitDataRate, configuration=configuration, pubStats=pubStats, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sMTPServerIPAddress=sMTPServerIPAddress, sNMPCommunityString=sNMPCommunityString, radarDetectChannel=radarDetectChannel, nTPServerIp=nTPServerIp, sNMPTrapTableEntry=sNMPTrapTableEntry, ptp250=ptp250, phyStatus=phyStatus, versions=versions, smtpGroup=smtpGroup, sMTPEnabledMessages=sMTPEnabledMessages, remoteMACAddress=remoteMACAddress, ptpCompliance=ptpCompliance, sNMPTrapTableIndex=sNMPTrapTableIndex, cambium=cambium)
