...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", alarmsGroup=alarmsGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPServerIPAddress=tFTPServerIPAddress, sNMPCommunityTableIndex=sNMPCommunityTableIndex, channelSelection=channelSelection, dataPortStatus=dataPortStatus, ptpGroups=ptpGroups, linkName=linkName, receiveModulationMode=receiveModulationMode, gatewayIPAddress=gatewayIPAddress, noiseFloor=noiseFloor, dataPortStatusTrap=dataPortStatusTrap, bootVersion=bootVersion, cableLoss=cableLoss, productName=productName, configurationGroup=configurationGroup, vlanPriority=vlanPriority, vlanId=vlanId, linkStatusTrap=linkStatusTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, managementGroup=managementGroup, ntpGroup=ntpGroup, smtpGroup=smtpGroup, configuredModulationMode=configuredModulationMode, pubStatsGroup=pubStatsGroup, measuredRange=measuredRange, transmitDataRate=transmitDataRate, sNMPCommunityString=sNMPCommunityString, ptp250=ptp250, wirelessLinkStatus=wirelessLinkStatus, nTPServerPortNumber=nTPServerPortNumber, aggregateDataRate=aggregateDataRate, sNMPCommunityOid=sNMPCommunityOid, smtp=smtp, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ptpTrapPrefix=ptpTrapPrefix, ptpTraps=ptpTraps, currentChannel=currentChannel, transmitPower=transmitPower, pubStats=pubStats, ptpCompliance=ptpCompliance, sNMPTrapTableNumber=sNMPTrapTableNumber, linkLoss=linkLoss, radarDetectTrap=radarDetectTrap, versionsGroup=versionsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, siteName=siteName, sNMPCommunityAccess=sNMPCommunityAccess, receiveDataRate=receiveDataRate, notificationsGroup=notificationsGroup, sNMPTrapCommunity=sNMPTrapCommunity, ptp=ptp, PYSNMP_MODULE_ID=cambium, searchState=searchState, transmitModulationMode=transmitModulationMode, sNMPTrapTable=sNMPTrapTable, ethernet=ethernet, phyStatusGroup=phyStatusGroup, configuration=configuration, remoteIPAddress=remoteIPAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapVersion=sNMPTrapVersion, tFTPServerPortNumber=tFTPServerPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, ntp=ntp, nTPPollInterval=nTPPollInterval, subnetMask=subnetMask, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, sNMPCommunityTable=sNMPCommunityTable, cambium=cambium, installArmState=installArmState, sMTPServerPortNumber=sMTPServerPortNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, currentFreqMHz=currentFreqMHz, hardwareVersion=hardwareVersion, systemClock=systemClock, timeZone=timeZone, configuredRange=configuredRange, masterSlaveMode=masterSlaveMode, antennaGain=antennaGain, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, nTPLastSync=nTPLastSync, licence=licence, regionCode=regionCode, vectorError=vectorError, licenceGroup=licenceGroup, remoteMACAddress=remoteMACAddress, signalStrengthRatio=signalStrengthRatio, extendedFreqMHz=extendedFreqMHz, nTPState=nTPState, nTPSync=nTPSync, alarms=alarms, channelBandwidth=channelBandwidth, ethernetGroup=ethernetGroup, productVariant=productVariant, sNMPCommunityTableEntry=sNMPCommunityTableEntry, receivePower=receivePower, radarDetectChannel=radarDetectChannel, sNMPTrapTableEntry=sNMPTrapTableEntry, sMTPSourceEmailAddress=sMTPSourceEmailAddress, softwareVersion=softwareVersion, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, installArmStateTrap=installArmStateTrap, snmpControlGroup=snmpControlGroup, management=management, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPServerIPAddress=sMTPServerIPAddress, phyStatus=phyStatus, band=band, dualPayload=dualPayload, iPAddress=iPAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, versions=versions, maximumTransmitPower=maximumTransmitPower, snmpControl=snmpControl, sNMPCommunityTableNumber=sNMPCommunityTableNumber, fixedModMode=fixedModMode, nTPServerIp=nTPServerIp, extendedChannel=extendedChannel, vlanTagging=vlanTagging, ptmp=ptmp)
