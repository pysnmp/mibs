...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", installArmState=installArmState, ntp=ntp, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, masterSlaveMode=masterSlaveMode, channelBandwidth=channelBandwidth, currentChannel=currentChannel, nTPServerPortNumber=nTPServerPortNumber, receiveModulationMode=receiveModulationMode, noWirelessChannelAvailable=noWirelessChannelAvailable, currentFreqMHz=currentFreqMHz, aggregateDataRate=aggregateDataRate, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, softwareVersion=softwareVersion, ptpCompliance=ptpCompliance, versionsGroup=versionsGroup, nTPSync=nTPSync, configuration=configuration, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, productVariant=productVariant, nTPPollInterval=nTPPollInterval, ethernet=ethernet, configuredRange=configuredRange, maximumTransmitPower=maximumTransmitPower, nTPLastSync=nTPLastSync, antennaGain=antennaGain, transmitModulationMode=transmitModulationMode, sNMPCommunityTableNumber=sNMPCommunityTableNumber, licenceGroup=licenceGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, linkName=linkName, receivePower=receivePower, ptpTrapPrefix=ptpTrapPrefix, radarDetectChannel=radarDetectChannel, smtp=smtp, vlanPriority=vlanPriority, hardwareVersion=hardwareVersion, fixedModMode=fixedModMode, transmitDataRate=transmitDataRate, radarDetectTrap=radarDetectTrap, sNMPTrapTable=sNMPTrapTable, sNMPEnabledTraps=sNMPEnabledTraps, notificationsGroup=notificationsGroup, ethernetGroup=ethernetGroup, dataPortStatusTrap=dataPortStatusTrap, linkLoss=linkLoss, subnetMask=subnetMask, sMTPServerPortNumber=sMTPServerPortNumber, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapVersion=sNMPTrapVersion, tFTPServerPortNumber=tFTPServerPortNumber, management=management, versions=versions, dataPortAutoNegotiation=dataPortAutoNegotiation, nTPState=nTPState, ptp250=ptp250, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, vlanTagging=vlanTagging, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, bootVersion=bootVersion, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, PYSNMP_MODULE_ID=cambium, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, cambium=cambium, licence=licence, transmitPower=transmitPower, productName=productName, ptpGroups=ptpGroups, phyStatusGroup=phyStatusGroup, smtpGroup=smtpGroup, cableLoss=cableLoss, searchState=searchState, sNMPTrapPortNumber=sNMPTrapPortNumber, measuredRange=measuredRange, dualPayload=dualPayload, pubStatsGroup=pubStatsGroup, receiveDataRate=receiveDataRate, gatewayIPAddress=gatewayIPAddress, dataPortStatus=dataPortStatus, extendedChannel=extendedChannel, alarmsGroup=alarmsGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPCommunityTableIndex=sNMPCommunityTableIndex, phyStatus=phyStatus, band=band, systemClock=systemClock, sNMPCommunityString=sNMPCommunityString, configuredModulationMode=configuredModulationMode, iPAddress=iPAddress, remoteMACAddress=remoteMACAddress, sNMPCommunityTableEntry=sNMPCommunityTableEntry, tFTPServerIPAddress=tFTPServerIPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ntpGroup=ntpGroup, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapCommunity=sNMPTrapCommunity, sNMPCommunityTable=sNMPCommunityTable, nTPServerIp=nTPServerIp, noiseFloor=noiseFloor, linkStatusTrap=linkStatusTrap, sNMPCommunityAccess=sNMPCommunityAccess, alarms=alarms, siteName=siteName, timeZone=timeZone, ptmp=ptmp, installArmStateTrap=installArmStateTrap, extendedFreqMHz=extendedFreqMHz, ptpTraps=ptpTraps, signalStrengthRatio=signalStrengthRatio, remoteIPAddress=remoteIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, channelSelection=channelSelection, wirelessLinkStatus=wirelessLinkStatus, snmpControlGroup=snmpControlGroup, configurationGroup=configurationGroup, regionCode=regionCode, vectorError=vectorError, ptp=ptp, managementGroup=managementGroup, vlanId=vlanId, sNMPCommunityOid=sNMPCommunityOid, snmpControl=snmpControl, pubStats=pubStats, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement)
