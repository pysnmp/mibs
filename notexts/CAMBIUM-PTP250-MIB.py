...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", gatewayIPAddress=gatewayIPAddress, fixedModMode=fixedModMode, sNMPTrapCommunity=sNMPTrapCommunity, searchState=searchState, tFTPServerIPAddress=tFTPServerIPAddress, remoteMACAddress=remoteMACAddress, transmitModulationMode=transmitModulationMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptpGroups=ptpGroups, pubStats=pubStats, installArmState=installArmState, nTPState=nTPState, nTPServerIp=nTPServerIp, cableLoss=cableLoss, licence=licence, channelSelection=channelSelection, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, ptpTrapPrefix=ptpTrapPrefix, PYSNMP_MODULE_ID=cambium, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sNMPCommunityAccess=sNMPCommunityAccess, extendedFreqMHz=extendedFreqMHz, measuredRange=measuredRange, vlanTagging=vlanTagging, maximumTransmitPower=maximumTransmitPower, radarDetectTrap=radarDetectTrap, channelBandwidth=channelBandwidth, notificationsGroup=notificationsGroup, sNMPTrapTable=sNMPTrapTable, currentFreqMHz=currentFreqMHz, sNMPCommunityTableNumber=sNMPCommunityTableNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptpCompliance=ptpCompliance, vlanPriority=vlanPriority, sNMPCommunityOid=sNMPCommunityOid, nTPServerPortNumber=nTPServerPortNumber, softwareVersion=softwareVersion, configurationGroup=configurationGroup, sNMPTrapVersion=sNMPTrapVersion, nTPLastSync=nTPLastSync, vlanId=vlanId, snmpControl=snmpControl, ptp250=ptp250, ntpGroup=ntpGroup, ethernet=ethernet, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, pubStatsGroup=pubStatsGroup, vectorError=vectorError, installArmStateTrap=installArmStateTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, wirelessLinkStatus=wirelessLinkStatus, sMTPEnabledMessages=sMTPEnabledMessages, systemClock=systemClock, sNMPEnabledTraps=sNMPEnabledTraps, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, currentChannel=currentChannel, cambium=cambium, receivePower=receivePower, sNMPCommunityTable=sNMPCommunityTable, sNMPTrapPortNumber=sNMPTrapPortNumber, linkName=linkName, sNMPTrapTableIndex=sNMPTrapTableIndex, configuredRange=configuredRange, regionCode=regionCode, noWirelessChannelAvailable=noWirelessChannelAvailable, nTPPollInterval=nTPPollInterval, dataPortStatus=dataPortStatus, siteName=siteName, alarmsGroup=alarmsGroup, linkStatusTrap=linkStatusTrap, alarms=alarms, phyStatus=phyStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPCommunityString=sNMPCommunityString, productName=productName, transmitDataRate=transmitDataRate, ptpTraps=ptpTraps, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, bootVersion=bootVersion, sNMPTrapIPAddress=sNMPTrapIPAddress, timeZone=timeZone, ethernetGroup=ethernetGroup, smtpGroup=smtpGroup, phyStatusGroup=phyStatusGroup, versions=versions, ptp=ptp, sNMPCommunityTableIndex=sNMPCommunityTableIndex, ntp=ntp, productVariant=productVariant, noiseFloor=noiseFloor, hardwareVersion=hardwareVersion, band=band, sMTPServerPortNumber=sMTPServerPortNumber, receiveDataRate=receiveDataRate, remoteIPAddress=remoteIPAddress, snmpControlGroup=snmpControlGroup, aggregateDataRate=aggregateDataRate, ptmp=ptmp, tFTPServerPortNumber=tFTPServerPortNumber, linkLoss=linkLoss, nTPSync=nTPSync, dataPortStatusTrap=dataPortStatusTrap, signalStrengthRatio=signalStrengthRatio, receiveModulationMode=receiveModulationMode, managementGroup=managementGroup, management=management, dualPayload=dualPayload, licenceGroup=licenceGroup, smtp=smtp, subnetMask=subnetMask, sMTPServerIPAddress=sMTPServerIPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, transmitPower=transmitPower, configuredModulationMode=configuredModulationMode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, configuration=configuration, iPAddress=iPAddress, versionsGroup=versionsGroup, antennaGain=antennaGain, radarDetectChannel=radarDetectChannel, extendedChannel=extendedChannel, sNMPTrapTableEntry=sNMPTrapTableEntry, masterSlaveMode=masterSlaveMode)
