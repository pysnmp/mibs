...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", phyStatus=phyStatus, licenceGroup=licenceGroup, maximumTransmitPower=maximumTransmitPower, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, siteName=siteName, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, vlanPriority=vlanPriority, receivePower=receivePower, cambium=cambium, band=band, versionsGroup=versionsGroup, sNMPTrapTable=sNMPTrapTable, sNMPTrapTableNumber=sNMPTrapTableNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPCommunityTableNumber=sNMPCommunityTableNumber, linkStatusTrap=linkStatusTrap, linkName=linkName, phyStatusGroup=phyStatusGroup, snmpControlGroup=snmpControlGroup, sMTPServerIPAddress=sMTPServerIPAddress, smtpGroup=smtpGroup, nTPLastSync=nTPLastSync, hardwareVersion=hardwareVersion, sNMPCommunityString=sNMPCommunityString, alarms=alarms, ntpGroup=ntpGroup, channelBandwidth=channelBandwidth, linkLoss=linkLoss, systemClock=systemClock, nTPServerPortNumber=nTPServerPortNumber, ptmp=ptmp, currentChannel=currentChannel, sNMPTrapTableIndex=sNMPTrapTableIndex, regionCode=regionCode, radarDetectChannel=radarDetectChannel, sNMPCommunityTableIndex=sNMPCommunityTableIndex, cableLoss=cableLoss, tFTPServerPortNumber=tFTPServerPortNumber, management=management, configuredModulationMode=configuredModulationMode, sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitModulationMode=transmitModulationMode, productName=productName, noiseFloor=noiseFloor, bootVersion=bootVersion, snmpControl=snmpControl, notificationsGroup=notificationsGroup, softwareVersion=softwareVersion, aggregateDataRate=aggregateDataRate, dataPortStatusTrap=dataPortStatusTrap, ptpGroups=ptpGroups, sNMPCommunityAccess=sNMPCommunityAccess, PYSNMP_MODULE_ID=cambium, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ptpTrapPrefix=ptpTrapPrefix, configurationGroup=configurationGroup, configuredRange=configuredRange, installArmStateTrap=installArmStateTrap, ptp250=ptp250, installArmState=installArmState, subnetMask=subnetMask, sNMPCommunityTable=sNMPCommunityTable, antennaGain=antennaGain, timeZone=timeZone, pubStatsGroup=pubStatsGroup, wirelessLinkStatus=wirelessLinkStatus, licence=licence, dualPayload=dualPayload, vlanId=vlanId, radarDetectTrap=radarDetectTrap, currentFreqMHz=currentFreqMHz, vectorError=vectorError, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPCommunityTableEntry=sNMPCommunityTableEntry, pubStats=pubStats, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, nTPServerIp=nTPServerIp, extendedFreqMHz=extendedFreqMHz, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, productVariant=productVariant, nTPPollInterval=nTPPollInterval, ntp=ntp, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortStatus=dataPortStatus, signalStrengthRatio=signalStrengthRatio, sNMPTrapCommunity=sNMPTrapCommunity, transmitDataRate=transmitDataRate, nTPState=nTPState, remoteMACAddress=remoteMACAddress, nTPSync=nTPSync, receiveDataRate=receiveDataRate, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, searchState=searchState, gatewayIPAddress=gatewayIPAddress, transmitPower=transmitPower, configuration=configuration, measuredRange=measuredRange, iPAddress=iPAddress, ethernet=ethernet, dataPortAutoNegotiation=dataPortAutoNegotiation, ptp=ptp, sMTPServerPortNumber=sMTPServerPortNumber, managementGroup=managementGroup, fixedModMode=fixedModMode, ethernetGroup=ethernetGroup, receiveModulationMode=receiveModulationMode, alarmsGroup=alarmsGroup, vlanTagging=vlanTagging, sMTPEnabledMessages=sMTPEnabledMessages, tFTPServerIPAddress=tFTPServerIPAddress, extendedChannel=extendedChannel, versions=versions, masterSlaveMode=masterSlaveMode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPEnabledTraps=sNMPEnabledTraps, remoteIPAddress=remoteIPAddress, sNMPCommunityOid=sNMPCommunityOid, ptpCompliance=ptpCompliance, ptpTraps=ptpTraps, channelSelection=channelSelection, smtp=smtp, sNMPTrapVersion=sNMPTrapVersion)
