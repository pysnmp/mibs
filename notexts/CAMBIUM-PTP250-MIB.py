...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", siteName=siteName, configuredModulationMode=configuredModulationMode, receiveModulationMode=receiveModulationMode, measuredRange=measuredRange, sNMPCommunityTableNumber=sNMPCommunityTableNumber, configurationGroup=configurationGroup, sMTPServerIPAddress=sMTPServerIPAddress, ptpTrapPrefix=ptpTrapPrefix, dataPortAutoNegotiation=dataPortAutoNegotiation, nTPServerIp=nTPServerIp, extendedChannel=extendedChannel, snmpControl=snmpControl, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, productVariant=productVariant, transmitModulationMode=transmitModulationMode, sMTPEnabledMessages=sMTPEnabledMessages, pubStatsGroup=pubStatsGroup, ntp=ntp, sNMPCommunityOid=sNMPCommunityOid, vectorError=vectorError, fixedModMode=fixedModMode, sNMPTrapIPAddress=sNMPTrapIPAddress, noiseFloor=noiseFloor, sNMPTrapTableNumber=sNMPTrapTableNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, phyStatus=phyStatus, alarms=alarms, sNMPTrapPortNumber=sNMPTrapPortNumber, nTPSync=nTPSync, managementGroup=managementGroup, masterSlaveMode=masterSlaveMode, nTPLastSync=nTPLastSync, snmpControlGroup=snmpControlGroup, sNMPTrapVersion=sNMPTrapVersion, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, PYSNMP_MODULE_ID=cambium, configuration=configuration, remoteIPAddress=remoteIPAddress, tFTPServerIPAddress=tFTPServerIPAddress, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sNMPCommunityAccess=sNMPCommunityAccess, pubStats=pubStats, bootVersion=bootVersion, signalStrengthRatio=signalStrengthRatio, ptp250=ptp250, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, installArmStateTrap=installArmStateTrap, searchState=searchState, sNMPCommunityString=sNMPCommunityString, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, radarDetectTrap=radarDetectTrap, versionsGroup=versionsGroup, radarDetectChannel=radarDetectChannel, ptpCompliance=ptpCompliance, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, antennaGain=antennaGain, ethernet=ethernet, gatewayIPAddress=gatewayIPAddress, remoteMACAddress=remoteMACAddress, sMTPServerPortNumber=sMTPServerPortNumber, ptmp=ptmp, iPAddress=iPAddress, dualPayload=dualPayload, alarmsGroup=alarmsGroup, sNMPTrapCommunity=sNMPTrapCommunity, notificationsGroup=notificationsGroup, transmitPower=transmitPower, currentChannel=currentChannel, ptpTraps=ptpTraps, sNMPTrapTable=sNMPTrapTable, cambium=cambium, channelSelection=channelSelection, sMTPSourceEmailAddress=sMTPSourceEmailAddress, hardwareVersion=hardwareVersion, band=band, installArmState=installArmState, receiveDataRate=receiveDataRate, timeZone=timeZone, sNMPTrapTableEntry=sNMPTrapTableEntry, configuredRange=configuredRange, nTPPollInterval=nTPPollInterval, softwareVersion=softwareVersion, licenceGroup=licenceGroup, currentFreqMHz=currentFreqMHz, ptp=ptp, smtp=smtp, vlanId=vlanId, sNMPCommunityTable=sNMPCommunityTable, phyStatusGroup=phyStatusGroup, productName=productName, channelBandwidth=channelBandwidth, systemClock=systemClock, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPServerPortNumber=tFTPServerPortNumber, linkLoss=linkLoss, sNMPEnabledTraps=sNMPEnabledTraps, vlanPriority=vlanPriority, cableLoss=cableLoss, dataPortStatus=dataPortStatus, receivePower=receivePower, aggregateDataRate=aggregateDataRate, ethernetGroup=ethernetGroup, extendedFreqMHz=extendedFreqMHz, sNMPTrapTableIndex=sNMPTrapTableIndex, transmitDataRate=transmitDataRate, nTPState=nTPState, ntpGroup=ntpGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, versions=versions, ptpGroups=ptpGroups, maximumTransmitPower=maximumTransmitPower, regionCode=regionCode, licence=licence, sNMPCommunityTableEntry=sNMPCommunityTableEntry, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, vlanTagging=vlanTagging, linkName=linkName, wirelessLinkStatus=wirelessLinkStatus, linkStatusTrap=linkStatusTrap, subnetMask=subnetMask, smtpGroup=smtpGroup, nTPServerPortNumber=nTPServerPortNumber, management=management, dataPortStatusTrap=dataPortStatusTrap)
