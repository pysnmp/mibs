...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPCommunityTableNumber=sNMPCommunityTableNumber, alarms=alarms, remoteIPAddress=remoteIPAddress, band=band, siteName=siteName, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapPortNumber=sNMPTrapPortNumber, searchState=searchState, ptp=ptp, linkName=linkName, receiveDataRate=receiveDataRate, ntpGroup=ntpGroup, versions=versions, snmpControlGroup=snmpControlGroup, transmitModulationMode=transmitModulationMode, tFTPServerIPAddress=tFTPServerIPAddress, notificationsGroup=notificationsGroup, versionsGroup=versionsGroup, subnetMask=subnetMask, installArmState=installArmState, ptp250=ptp250, pubStatsGroup=pubStatsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapTableNumber=sNMPTrapTableNumber, configuredRange=configuredRange, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, receiveModulationMode=receiveModulationMode, aggregateDataRate=aggregateDataRate, antennaGain=antennaGain, phyStatusGroup=phyStatusGroup, sNMPTrapTable=sNMPTrapTable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, nTPServerIp=nTPServerIp, installArmStateTrap=installArmStateTrap, systemClock=systemClock, remoteMACAddress=remoteMACAddress, management=management, vlanPriority=vlanPriority, dataPortStatus=dataPortStatus, ethernet=ethernet, productName=productName, fixedModMode=fixedModMode, ntp=ntp, bootVersion=bootVersion, ptpCompliance=ptpCompliance, vlanTagging=vlanTagging, channelSelection=channelSelection, ptmp=ptmp, hardwareVersion=hardwareVersion, currentChannel=currentChannel, tFTPServerPortNumber=tFTPServerPortNumber, smtp=smtp, channelBandwidth=channelBandwidth, nTPState=nTPState, vectorError=vectorError, transmitPower=transmitPower, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ethernetGroup=ethernetGroup, sNMPCommunityTable=sNMPCommunityTable, configurationGroup=configurationGroup, transmitDataRate=transmitDataRate, ptpGroups=ptpGroups, sNMPCommunityString=sNMPCommunityString, radarDetectChannel=radarDetectChannel, ptpTraps=ptpTraps, PYSNMP_MODULE_ID=cambium, nTPServerPortNumber=nTPServerPortNumber, cambium=cambium, managementGroup=managementGroup, sNMPCommunityOid=sNMPCommunityOid, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sNMPTrapTableIndex=sNMPTrapTableIndex, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapVersion=sNMPTrapVersion, dataPortStatusTrap=dataPortStatusTrap, timeZone=timeZone, measuredRange=measuredRange, sNMPCommunityTableIndex=sNMPCommunityTableIndex, snmpControl=snmpControl, linkLoss=linkLoss, sMTPSourceEmailAddress=sMTPSourceEmailAddress, vlanId=vlanId, extendedChannel=extendedChannel, sMTPServerPortNumber=sMTPServerPortNumber, softwareVersion=softwareVersion, wirelessLinkStatus=wirelessLinkStatus, radarDetectTrap=radarDetectTrap, dualPayload=dualPayload, masterSlaveMode=masterSlaveMode, extendedFreqMHz=extendedFreqMHz, sMTPEnabledMessages=sMTPEnabledMessages, licence=licence, gatewayIPAddress=gatewayIPAddress, currentFreqMHz=currentFreqMHz, sNMPCommunityAccess=sNMPCommunityAccess, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPTrapTableEntry=sNMPTrapTableEntry, receivePower=receivePower, licenceGroup=licenceGroup, linkStatusTrap=linkStatusTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapIPAddress=sNMPTrapIPAddress, regionCode=regionCode, sMTPServerIPAddress=sMTPServerIPAddress, nTPLastSync=nTPLastSync, nTPSync=nTPSync, alarmsGroup=alarmsGroup, smtpGroup=smtpGroup, configuredModulationMode=configuredModulationMode, configuration=configuration, noWirelessChannelAvailable=noWirelessChannelAvailable, signalStrengthRatio=signalStrengthRatio, nTPPollInterval=nTPPollInterval, sNMPTrapCommunity=sNMPTrapCommunity, phyStatus=phyStatus, productVariant=productVariant, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, noiseFloor=noiseFloor, iPAddress=iPAddress, sNMPEnabledTraps=sNMPEnabledTraps, cableLoss=cableLoss, maximumTransmitPower=maximumTransmitPower, pubStats=pubStats)
