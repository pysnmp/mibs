...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", configuredRange=configuredRange, ptp=ptp, sNMPEnabledTraps=sNMPEnabledTraps, ethernet=ethernet, nTPServerPortNumber=nTPServerPortNumber, remoteMACAddress=remoteMACAddress, radarDetectChannel=radarDetectChannel, sNMPTrapVersion=sNMPTrapVersion, maximumTransmitPower=maximumTransmitPower, sNMPTrapTableNumber=sNMPTrapTableNumber, nTPPollInterval=nTPPollInterval, cableLoss=cableLoss, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, systemClock=systemClock, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sMTPSourceEmailAddress=sMTPSourceEmailAddress, phyStatusGroup=phyStatusGroup, sMTPServerIPAddress=sMTPServerIPAddress, sNMPCommunityOid=sNMPCommunityOid, pubStatsGroup=pubStatsGroup, sNMPCommunityString=sNMPCommunityString, sNMPCommunityAccess=sNMPCommunityAccess, nTPSync=nTPSync, ptpTrapPrefix=ptpTrapPrefix, PYSNMP_MODULE_ID=cambium, installArmState=installArmState, nTPState=nTPState, hardwareVersion=hardwareVersion, bootVersion=bootVersion, receiveDataRate=receiveDataRate, vlanTagging=vlanTagging, channelSelection=channelSelection, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, smtp=smtp, ntpGroup=ntpGroup, receivePower=receivePower, sMTPEnabledMessages=sMTPEnabledMessages, noWirelessChannelAvailable=noWirelessChannelAvailable, linkName=linkName, radarDetectTrap=radarDetectTrap, phyStatus=phyStatus, receiveModulationMode=receiveModulationMode, ptpGroups=ptpGroups, antennaGain=antennaGain, configuration=configuration, productVariant=productVariant, notificationsGroup=notificationsGroup, transmitModulationMode=transmitModulationMode, transmitPower=transmitPower, gatewayIPAddress=gatewayIPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, noiseFloor=noiseFloor, nTPServerIp=nTPServerIp, tFTPServerIPAddress=tFTPServerIPAddress, regionCode=regionCode, configuredModulationMode=configuredModulationMode, dataPortStatus=dataPortStatus, smtpGroup=smtpGroup, vlanPriority=vlanPriority, extendedFreqMHz=extendedFreqMHz, linkStatusTrap=linkStatusTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernetGroup=ethernetGroup, nTPLastSync=nTPLastSync, currentChannel=currentChannel, siteName=siteName, fixedModMode=fixedModMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPCommunityTableIndex=sNMPCommunityTableIndex, extendedChannel=extendedChannel, configurationGroup=configurationGroup, snmpControlGroup=snmpControlGroup, subnetMask=subnetMask, searchState=searchState, tFTPServerPortNumber=tFTPServerPortNumber, softwareVersion=softwareVersion, wirelessLinkStatus=wirelessLinkStatus, channelBandwidth=channelBandwidth, dataPortStatusTrap=dataPortStatusTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, ntp=ntp, sNMPCommunityTable=sNMPCommunityTable, sNMPTrapTable=sNMPTrapTable, masterSlaveMode=masterSlaveMode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptpCompliance=ptpCompliance, currentFreqMHz=currentFreqMHz, dualPayload=dualPayload, sMTPServerPortNumber=sMTPServerPortNumber, alarmsGroup=alarmsGroup, snmpControl=snmpControl, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, iPAddress=iPAddress, measuredRange=measuredRange, band=band, linkLoss=linkLoss, vlanId=vlanId, versions=versions, ptpTraps=ptpTraps, cambium=cambium, remoteIPAddress=remoteIPAddress, licence=licence, managementGroup=managementGroup, management=management, installArmStateTrap=installArmStateTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, signalStrengthRatio=signalStrengthRatio, transmitDataRate=transmitDataRate, ptmp=ptmp, licenceGroup=licenceGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, alarms=alarms, sNMPTrapCommunity=sNMPTrapCommunity, dataPortAutoNegotiation=dataPortAutoNegotiation, timeZone=timeZone, productName=productName, pubStats=pubStats, sNMPCommunityTableNumber=sNMPCommunityTableNumber, ptp250=ptp250, versionsGroup=versionsGroup, aggregateDataRate=aggregateDataRate, vectorError=vectorError)
