...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", iPAddress=iPAddress, bootVersion=bootVersion, aggregateDataRate=aggregateDataRate, dataPortAutoNegotiation=dataPortAutoNegotiation, nTPSync=nTPSync, searchState=searchState, sMTPServerIPAddress=sMTPServerIPAddress, ptmp=ptmp, licenceGroup=licenceGroup, receivePower=receivePower, vlanPriority=vlanPriority, sNMPCommunityOid=sNMPCommunityOid, regionCode=regionCode, radarDetectTrap=radarDetectTrap, gatewayIPAddress=gatewayIPAddress, ethernet=ethernet, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receiveModulationMode=receiveModulationMode, linkStatusTrap=linkStatusTrap, ptpCompliance=ptpCompliance, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPCommunityTableIndex=sNMPCommunityTableIndex, ethernetGroup=ethernetGroup, transmitModulationMode=transmitModulationMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dualPayload=dualPayload, currentChannel=currentChannel, notificationsGroup=notificationsGroup, smtpGroup=smtpGroup, nTPState=nTPState, systemClock=systemClock, fixedModMode=fixedModMode, subnetMask=subnetMask, ptp250=ptp250, softwareVersion=softwareVersion, receiveDataRate=receiveDataRate, channelSelection=channelSelection, sNMPTrapTable=sNMPTrapTable, sNMPCommunityString=sNMPCommunityString, cambium=cambium, band=band, dataPortStatus=dataPortStatus, pubStats=pubStats, nTPPollInterval=nTPPollInterval, sNMPEnabledTraps=sNMPEnabledTraps, smtp=smtp, snmpControlGroup=snmpControlGroup, ptpGroups=ptpGroups, vectorError=vectorError, transmitDataRate=transmitDataRate, sMTPEnabledMessages=sMTPEnabledMessages, radarDetectChannel=radarDetectChannel, sNMPTrapPortNumber=sNMPTrapPortNumber, phyStatus=phyStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, licence=licence, timeZone=timeZone, ptpTrapPrefix=ptpTrapPrefix, pubStatsGroup=pubStatsGroup, hardwareVersion=hardwareVersion, snmpControl=snmpControl, noiseFloor=noiseFloor, measuredRange=measuredRange, vlanTagging=vlanTagging, managementGroup=managementGroup, configurationGroup=configurationGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, cableLoss=cableLoss, configuredModulationMode=configuredModulationMode, tFTPServerPortNumber=tFTPServerPortNumber, sNMPCommunityTableEntry=sNMPCommunityTableEntry, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, maximumTransmitPower=maximumTransmitPower, sNMPCommunityTable=sNMPCommunityTable, remoteIPAddress=remoteIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, alarmsGroup=alarmsGroup, signalStrengthRatio=signalStrengthRatio, extendedChannel=extendedChannel, antennaGain=antennaGain, sNMPCommunityTableNumber=sNMPCommunityTableNumber, alarms=alarms, noWirelessChannelAvailable=noWirelessChannelAvailable, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, transmitPower=transmitPower, extendedFreqMHz=extendedFreqMHz, productName=productName, management=management, versions=versions, configuration=configuration, dataPortStatusTrap=dataPortStatusTrap, channelBandwidth=channelBandwidth, sNMPTrapCommunity=sNMPTrapCommunity, nTPLastSync=nTPLastSync, siteName=siteName, linkLoss=linkLoss, installArmStateTrap=installArmStateTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, remoteMACAddress=remoteMACAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, sMTPServerPortNumber=sMTPServerPortNumber, ntpGroup=ntpGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, masterSlaveMode=masterSlaveMode, PYSNMP_MODULE_ID=cambium, phyStatusGroup=phyStatusGroup, sNMPCommunityAccess=sNMPCommunityAccess, currentFreqMHz=currentFreqMHz, linkName=linkName, productVariant=productVariant, installArmState=installArmState, nTPServerPortNumber=nTPServerPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, tFTPServerIPAddress=tFTPServerIPAddress, ntp=ntp, ptpTraps=ptpTraps, sNMPTrapTableEntry=sNMPTrapTableEntry, ptp=ptp, sNMPTrapVersion=sNMPTrapVersion, vlanId=vlanId, wirelessLinkStatus=wirelessLinkStatus, nTPServerIp=nTPServerIp, configuredRange=configuredRange, versionsGroup=versionsGroup)
