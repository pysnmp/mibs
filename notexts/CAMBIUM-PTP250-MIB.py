...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", ntpGroup=ntpGroup, linkStatusTrap=linkStatusTrap, fixedModMode=fixedModMode, transmitModulationMode=transmitModulationMode, channelBandwidth=channelBandwidth, smtpGroup=smtpGroup, tFTPServerPortNumber=tFTPServerPortNumber, bootVersion=bootVersion, siteName=siteName, sNMPCommunityString=sNMPCommunityString, ptpTrapPrefix=ptpTrapPrefix, phyStatusGroup=phyStatusGroup, dataPortStatus=dataPortStatus, receivePower=receivePower, extendedFreqMHz=extendedFreqMHz, ptmp=ptmp, configuredModulationMode=configuredModulationMode, installArmStateTrap=installArmStateTrap, versions=versions, licence=licence, productVariant=productVariant, radarDetectChannel=radarDetectChannel, band=band, ptp=ptp, vlanId=vlanId, dualPayload=dualPayload, sMTPEnabledMessages=sMTPEnabledMessages, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, configuredRange=configuredRange, licenceGroup=licenceGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, receiveModulationMode=receiveModulationMode, channelSelection=channelSelection, sMTPSourceEmailAddress=sMTPSourceEmailAddress, remoteMACAddress=remoteMACAddress, softwareVersion=softwareVersion, dataPortStatusTrap=dataPortStatusTrap, ethernet=ethernet, vectorError=vectorError, cableLoss=cableLoss, currentChannel=currentChannel, sMTPServerPortNumber=sMTPServerPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, nTPPollInterval=nTPPollInterval, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitDataRate=transmitDataRate, PYSNMP_MODULE_ID=cambium, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, currentFreqMHz=currentFreqMHz, measuredRange=measuredRange, nTPServerIp=nTPServerIp, sNMPCommunityAccess=sNMPCommunityAccess, ptpTraps=ptpTraps, nTPState=nTPState, transmitPower=transmitPower, nTPLastSync=nTPLastSync, ptp250=ptp250, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, managementGroup=managementGroup, sMTPServerIPAddress=sMTPServerIPAddress, nTPSync=nTPSync, notificationsGroup=notificationsGroup, receiveDataRate=receiveDataRate, sNMPCommunityOid=sNMPCommunityOid, ptpCompliance=ptpCompliance, alarms=alarms, maximumTransmitPower=maximumTransmitPower, searchState=searchState, sNMPTrapCommunity=sNMPTrapCommunity, ethernetGroup=ethernetGroup, alarmsGroup=alarmsGroup, productName=productName, dataPortAutoNegotiation=dataPortAutoNegotiation, radarDetectTrap=radarDetectTrap, subnetMask=subnetMask, management=management, sNMPTrapTableIndex=sNMPTrapTableIndex, systemClock=systemClock, installArmState=installArmState, versionsGroup=versionsGroup, configurationGroup=configurationGroup, antennaGain=antennaGain, wirelessLinkStatus=wirelessLinkStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, vlanTagging=vlanTagging, iPAddress=iPAddress, gatewayIPAddress=gatewayIPAddress, extendedChannel=extendedChannel, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapVersion=sNMPTrapVersion, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sNMPTrapIPAddress=sNMPTrapIPAddress, cambium=cambium, remoteIPAddress=remoteIPAddress, configuration=configuration, signalStrengthRatio=signalStrengthRatio, pubStats=pubStats, sNMPTrapTable=sNMPTrapTable, linkName=linkName, smtp=smtp, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapPortNumber=sNMPTrapPortNumber, noiseFloor=noiseFloor, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPCommunityTableNumber=sNMPCommunityTableNumber, snmpControl=snmpControl, vlanPriority=vlanPriority, ptpGroups=ptpGroups, sNMPCommunityTableEntry=sNMPCommunityTableEntry, masterSlaveMode=masterSlaveMode, pubStatsGroup=pubStatsGroup, ntp=ntp, sNMPCommunityTable=sNMPCommunityTable, sNMPTrapTableEntry=sNMPTrapTableEntry, timeZone=timeZone, nTPServerPortNumber=nTPServerPortNumber, linkLoss=linkLoss, regionCode=regionCode, phyStatus=phyStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, snmpControlGroup=snmpControlGroup, hardwareVersion=hardwareVersion, aggregateDataRate=aggregateDataRate)
