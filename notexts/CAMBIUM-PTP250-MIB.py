...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, configuredRange=configuredRange, nTPPollInterval=nTPPollInterval, linkLoss=linkLoss, hardwareVersion=hardwareVersion, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, extendedChannel=extendedChannel, alarms=alarms, notificationsGroup=notificationsGroup, sNMPCommunityTable=sNMPCommunityTable, ptpCompliance=ptpCompliance, extendedFreqMHz=extendedFreqMHz, ptpTraps=ptpTraps, management=management, productName=productName, receiveDataRate=receiveDataRate, radarDetectTrap=radarDetectTrap, installArmStateTrap=installArmStateTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ntp=ntp, ntpGroup=ntpGroup, maximumTransmitPower=maximumTransmitPower, nTPServerIp=nTPServerIp, linkName=linkName, sMTPServerPortNumber=sMTPServerPortNumber, cableLoss=cableLoss, channelSelection=channelSelection, antennaGain=antennaGain, phyStatusGroup=phyStatusGroup, wirelessLinkStatus=wirelessLinkStatus, cambium=cambium, versions=versions, nTPLastSync=nTPLastSync, softwareVersion=softwareVersion, gatewayIPAddress=gatewayIPAddress, sNMPCommunityTableNumber=sNMPCommunityTableNumber, licenceGroup=licenceGroup, remoteIPAddress=remoteIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPTrapVersion=sNMPTrapVersion, configuration=configuration, tFTPServerIPAddress=tFTPServerIPAddress, productVariant=productVariant, transmitModulationMode=transmitModulationMode, noWirelessChannelAvailable=noWirelessChannelAvailable, receiveModulationMode=receiveModulationMode, snmpControlGroup=snmpControlGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sMTPEnabledMessages=sMTPEnabledMessages, phyStatus=phyStatus, ptpGroups=ptpGroups, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, fixedModMode=fixedModMode, ethernet=ethernet, signalStrengthRatio=signalStrengthRatio, measuredRange=measuredRange, licence=licence, transmitPower=transmitPower, ethernetGroup=ethernetGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, timeZone=timeZone, dataPortStatusTrap=dataPortStatusTrap, bootVersion=bootVersion, pubStats=pubStats, versionsGroup=versionsGroup, nTPServerPortNumber=nTPServerPortNumber, sNMPTrapCommunity=sNMPTrapCommunity, managementGroup=managementGroup, ptpTrapPrefix=ptpTrapPrefix, linkStatusTrap=linkStatusTrap, sNMPCommunityOid=sNMPCommunityOid, currentChannel=currentChannel, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPServerPortNumber=tFTPServerPortNumber, aggregateDataRate=aggregateDataRate, masterSlaveMode=masterSlaveMode, smtpGroup=smtpGroup, sNMPTrapTable=sNMPTrapTable, systemClock=systemClock, pubStatsGroup=pubStatsGroup, radarDetectChannel=radarDetectChannel, vlanPriority=vlanPriority, dataPortStatus=dataPortStatus, PYSNMP_MODULE_ID=cambium, subnetMask=subnetMask, dualPayload=dualPayload, configurationGroup=configurationGroup, ptp250=ptp250, ptmp=ptmp, sNMPEnabledTraps=sNMPEnabledTraps, sMTPServerIPAddress=sMTPServerIPAddress, snmpControl=snmpControl, configuredModulationMode=configuredModulationMode, vlanId=vlanId, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitDataRate=transmitDataRate, vlanTagging=vlanTagging, nTPSync=nTPSync, dataPortAutoNegotiation=dataPortAutoNegotiation, noiseFloor=noiseFloor, regionCode=regionCode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, installArmState=installArmState, sNMPTrapTableIndex=sNMPTrapTableIndex, channelBandwidth=channelBandwidth, receivePower=receivePower, siteName=siteName, sNMPCommunityTableEntry=sNMPCommunityTableEntry, searchState=searchState, ptp=ptp, alarmsGroup=alarmsGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, remoteMACAddress=remoteMACAddress, currentFreqMHz=currentFreqMHz, sNMPCommunityAccess=sNMPCommunityAccess, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sNMPCommunityString=sNMPCommunityString, nTPState=nTPState, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, smtp=smtp, vectorError=vectorError, band=band, iPAddress=iPAddress)
