...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", hardwareVersion=hardwareVersion, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sNMPTrapCommunity=sNMPTrapCommunity, installArmStateTrap=installArmStateTrap, vlanId=vlanId, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sNMPTrapTableEntry=sNMPTrapTableEntry, transmitDataRate=transmitDataRate, versions=versions, ethernetGroup=ethernetGroup, configuredRange=configuredRange, remoteIPAddress=remoteIPAddress, masterSlaveMode=masterSlaveMode, sNMPTrapVersion=sNMPTrapVersion, ptpCompliance=ptpCompliance, currentFreqMHz=currentFreqMHz, bootVersion=bootVersion, transmitPower=transmitPower, timeZone=timeZone, ptmp=ptmp, cableLoss=cableLoss, measuredRange=measuredRange, radarDetectTrap=radarDetectTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, phyStatus=phyStatus, licence=licence, pubStatsGroup=pubStatsGroup, PYSNMP_MODULE_ID=cambium, transmitModulationMode=transmitModulationMode, antennaGain=antennaGain, phyStatusGroup=phyStatusGroup, ptpGroups=ptpGroups, tFTPServerPortNumber=tFTPServerPortNumber, configurationGroup=configurationGroup, vectorError=vectorError, dataPortStatusTrap=dataPortStatusTrap, remoteMACAddress=remoteMACAddress, sNMPCommunityOid=sNMPCommunityOid, noWirelessChannelAvailable=noWirelessChannelAvailable, ntpGroup=ntpGroup, dataPortStatus=dataPortStatus, currentChannel=currentChannel, radarDetectChannel=radarDetectChannel, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPCommunityAccess=sNMPCommunityAccess, sNMPCommunityTable=sNMPCommunityTable, ntp=ntp, subnetMask=subnetMask, productName=productName, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, maximumTransmitPower=maximumTransmitPower, smtp=smtp, snmpControlGroup=snmpControlGroup, nTPServerIp=nTPServerIp, extendedChannel=extendedChannel, sMTPSourceEmailAddress=sMTPSourceEmailAddress, linkName=linkName, fixedModMode=fixedModMode, cambium=cambium, notificationsGroup=notificationsGroup, nTPSync=nTPSync, channelBandwidth=channelBandwidth, band=band, configuredModulationMode=configuredModulationMode, noiseFloor=noiseFloor, sMTPServerIPAddress=sMTPServerIPAddress, alarms=alarms, sNMPCommunityTableIndex=sNMPCommunityTableIndex, dataPortAutoNegotiation=dataPortAutoNegotiation, receiveDataRate=receiveDataRate, sNMPCommunityString=sNMPCommunityString, extendedFreqMHz=extendedFreqMHz, smtpGroup=smtpGroup, nTPServerPortNumber=nTPServerPortNumber, licenceGroup=licenceGroup, versionsGroup=versionsGroup, ptpTrapPrefix=ptpTrapPrefix, searchState=searchState, sNMPTrapTable=sNMPTrapTable, ptp250=ptp250, ptpTraps=ptpTraps, pubStats=pubStats, vlanTagging=vlanTagging, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPServerPortNumber=sMTPServerPortNumber, managementGroup=managementGroup, installArmState=installArmState, vlanPriority=vlanPriority, productVariant=productVariant, nTPPollInterval=nTPPollInterval, tFTPServerIPAddress=tFTPServerIPAddress, systemClock=systemClock, gatewayIPAddress=gatewayIPAddress, dualPayload=dualPayload, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, linkStatusTrap=linkStatusTrap, siteName=siteName, ethernet=ethernet, channelSelection=channelSelection, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, nTPLastSync=nTPLastSync, configuration=configuration, linkLoss=linkLoss, sNMPTrapTableIndex=sNMPTrapTableIndex, signalStrengthRatio=signalStrengthRatio, alarmsGroup=alarmsGroup, softwareVersion=softwareVersion, management=management, snmpControl=snmpControl, nTPState=nTPState, aggregateDataRate=aggregateDataRate, sMTPEnabledMessages=sMTPEnabledMessages, regionCode=regionCode, wirelessLinkStatus=wirelessLinkStatus, iPAddress=iPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapIPAddress=sNMPTrapIPAddress, receivePower=receivePower, ptp=ptp, receiveModulationMode=receiveModulationMode, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapPortNumber=sNMPTrapPortNumber)
