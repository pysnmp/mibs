...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", linkStatusTrap=linkStatusTrap, channelBandwidth=channelBandwidth, ptp=ptp, transmitPower=transmitPower, nTPState=nTPState, tFTPServerIPAddress=tFTPServerIPAddress, snmpControl=snmpControl, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, productName=productName, radarDetectTrap=radarDetectTrap, sNMPCommunityOid=sNMPCommunityOid, extendedFreqMHz=extendedFreqMHz, transmitModulationMode=transmitModulationMode, management=management, ptpTrapPrefix=ptpTrapPrefix, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, PYSNMP_MODULE_ID=cambium, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPCommunityTable=sNMPCommunityTable, antennaGain=antennaGain, cableLoss=cableLoss, ptpCompliance=ptpCompliance, configuration=configuration, siteName=siteName, phyStatus=phyStatus, subnetMask=subnetMask, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ptmp=ptmp, sNMPTrapTableEntry=sNMPTrapTableEntry, timeZone=timeZone, extendedChannel=extendedChannel, vlanTagging=vlanTagging, notificationsGroup=notificationsGroup, masterSlaveMode=masterSlaveMode, installArmState=installArmState, ptp250=ptp250, cambium=cambium, configuredModulationMode=configuredModulationMode, receiveModulationMode=receiveModulationMode, sNMPTrapCommunity=sNMPTrapCommunity, linkName=linkName, vectorError=vectorError, nTPServerIp=nTPServerIp, smtp=smtp, channelSelection=channelSelection, currentFreqMHz=currentFreqMHz, vlanId=vlanId, aggregateDataRate=aggregateDataRate, radarDetectChannel=radarDetectChannel, alarmsGroup=alarmsGroup, fixedModMode=fixedModMode, ethernetGroup=ethernetGroup, sMTPServerPortNumber=sMTPServerPortNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, snmpControlGroup=snmpControlGroup, regionCode=regionCode, dataPortStatusTrap=dataPortStatusTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ptpGroups=ptpGroups, nTPLastSync=nTPLastSync, smtpGroup=smtpGroup, sNMPEnabledTraps=sNMPEnabledTraps, sNMPCommunityAccess=sNMPCommunityAccess, phyStatusGroup=phyStatusGroup, searchState=searchState, configuredRange=configuredRange, sNMPCommunityTableNumber=sNMPCommunityTableNumber, nTPServerPortNumber=nTPServerPortNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, versions=versions, linkLoss=linkLoss, sNMPTrapVersion=sNMPTrapVersion, receivePower=receivePower, sMTPSourceEmailAddress=sMTPSourceEmailAddress, measuredRange=measuredRange, signalStrengthRatio=signalStrengthRatio, managementGroup=managementGroup, sNMPTrapTable=sNMPTrapTable, bootVersion=bootVersion, nTPPollInterval=nTPPollInterval, sMTPServerIPAddress=sMTPServerIPAddress, versionsGroup=versionsGroup, sNMPCommunityString=sNMPCommunityString, softwareVersion=softwareVersion, maximumTransmitPower=maximumTransmitPower, ntp=ntp, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ntpGroup=ntpGroup, gatewayIPAddress=gatewayIPAddress, systemClock=systemClock, vlanPriority=vlanPriority, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPCommunityTableEntry=sNMPCommunityTableEntry, alarms=alarms, remoteIPAddress=remoteIPAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, configurationGroup=configurationGroup, licence=licence, hardwareVersion=hardwareVersion, installArmStateTrap=installArmStateTrap, iPAddress=iPAddress, sNMPCommunityTableIndex=sNMPCommunityTableIndex, currentChannel=currentChannel, ptpTraps=ptpTraps, noiseFloor=noiseFloor, sNMPTrapTableIndex=sNMPTrapTableIndex, licenceGroup=licenceGroup, receiveDataRate=receiveDataRate, ethernet=ethernet, nTPSync=nTPSync, dataPortStatus=dataPortStatus, tFTPServerPortNumber=tFTPServerPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, transmitDataRate=transmitDataRate, noWirelessChannelAvailable=noWirelessChannelAvailable, pubStatsGroup=pubStatsGroup, band=band, remoteMACAddress=remoteMACAddress, pubStats=pubStats, wirelessLinkStatus=wirelessLinkStatus, dataPortAutoNegotiation=dataPortAutoNegotiation, dualPayload=dualPayload, productVariant=productVariant)
