...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPCommunityTableNumber=sNMPCommunityTableNumber, ethernetGroup=ethernetGroup, alarmsGroup=alarmsGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPCommunityTable=sNMPCommunityTable, sNMPTrapIPAddress=sNMPTrapIPAddress, bootVersion=bootVersion, searchState=searchState, iPAddress=iPAddress, radarDetectTrap=radarDetectTrap, sMTPServerIPAddress=sMTPServerIPAddress, managementGroup=managementGroup, receivePower=receivePower, ntpGroup=ntpGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, currentChannel=currentChannel, ntp=ntp, ptp=ptp, ethernet=ethernet, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPEnabledTraps=sNMPEnabledTraps, snmpControl=snmpControl, dataPortStatus=dataPortStatus, nTPPollInterval=nTPPollInterval, remoteIPAddress=remoteIPAddress, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, installArmStateTrap=installArmStateTrap, maximumTransmitPower=maximumTransmitPower, alarms=alarms, siteName=siteName, configurationGroup=configurationGroup, cambium=cambium, currentFreqMHz=currentFreqMHz, cableLoss=cableLoss, versions=versions, nTPSync=nTPSync, ptpCompliance=ptpCompliance, vlanPriority=vlanPriority, installArmState=installArmState, linkStatusTrap=linkStatusTrap, vlanId=vlanId, fixedModMode=fixedModMode, receiveModulationMode=receiveModulationMode, extendedFreqMHz=extendedFreqMHz, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapTable=sNMPTrapTable, productName=productName, sNMPTrapTableIndex=sNMPTrapTableIndex, transmitDataRate=transmitDataRate, snmpControlGroup=snmpControlGroup, signalStrengthRatio=signalStrengthRatio, sNMPCommunityAccess=sNMPCommunityAccess, band=band, measuredRange=measuredRange, receiveDataRate=receiveDataRate, vectorError=vectorError, tFTPServerIPAddress=tFTPServerIPAddress, ptpTraps=ptpTraps, radarDetectChannel=radarDetectChannel, smtpGroup=smtpGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, softwareVersion=softwareVersion, phyStatus=phyStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, remoteMACAddress=remoteMACAddress, sNMPCommunityTableIndex=sNMPCommunityTableIndex, hardwareVersion=hardwareVersion, linkName=linkName, versionsGroup=versionsGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, pubStatsGroup=pubStatsGroup, channelBandwidth=channelBandwidth, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortStatusTrap=dataPortStatusTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, productVariant=productVariant, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dualPayload=dualPayload, sNMPCommunityString=sNMPCommunityString, masterSlaveMode=masterSlaveMode, aggregateDataRate=aggregateDataRate, gatewayIPAddress=gatewayIPAddress, phyStatusGroup=phyStatusGroup, sNMPCommunityTableEntry=sNMPCommunityTableEntry, nTPServerIp=nTPServerIp, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPCommunityOid=sNMPCommunityOid, licence=licence, licenceGroup=licenceGroup, configuredRange=configuredRange, ptpTrapPrefix=ptpTrapPrefix, channelSelection=channelSelection, wirelessLinkStatus=wirelessLinkStatus, configuration=configuration, pubStats=pubStats, ptmp=ptmp, nTPServerPortNumber=nTPServerPortNumber, ptp250=ptp250, configuredModulationMode=configuredModulationMode, nTPState=nTPState, management=management, antennaGain=antennaGain, nTPLastSync=nTPLastSync, notificationsGroup=notificationsGroup, ptpGroups=ptpGroups, subnetMask=subnetMask, vlanTagging=vlanTagging, extendedChannel=extendedChannel, linkLoss=linkLoss, transmitPower=transmitPower, transmitModulationMode=transmitModulationMode, smtp=smtp, noiseFloor=noiseFloor, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapVersion=sNMPTrapVersion, systemClock=systemClock, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortAutoNegotiation=dataPortAutoNegotiation, regionCode=regionCode, sNMPTrapCommunity=sNMPTrapCommunity, sMTPEnabledMessages=sMTPEnabledMessages, timeZone=timeZone, PYSNMP_MODULE_ID=cambium)
