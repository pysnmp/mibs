...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", noiseFloor=noiseFloor, ntpGroup=ntpGroup, channelBandwidth=channelBandwidth, receiveModulationMode=receiveModulationMode, extendedFreqMHz=extendedFreqMHz, sNMPCommunityTableNumber=sNMPCommunityTableNumber, linkName=linkName, masterSlaveMode=masterSlaveMode, snmpControl=snmpControl, dataPortAutoNegotiation=dataPortAutoNegotiation, nTPServerPortNumber=nTPServerPortNumber, licence=licence, receiveDataRate=receiveDataRate, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, antennaGain=antennaGain, sMTPServerPortNumber=sMTPServerPortNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dualPayload=dualPayload, measuredRange=measuredRange, band=band, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptpTraps=ptpTraps, ptpCompliance=ptpCompliance, sNMPTrapTable=sNMPTrapTable, hardwareVersion=hardwareVersion, sNMPTrapTableNumber=sNMPTrapTableNumber, ptpGroups=ptpGroups, sNMPTrapVersion=sNMPTrapVersion, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sMTPEnabledMessages=sMTPEnabledMessages, nTPState=nTPState, sNMPTrapTableEntry=sNMPTrapTableEntry, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, cambium=cambium, maximumTransmitPower=maximumTransmitPower, transmitPower=transmitPower, timeZone=timeZone, sNMPCommunityTableEntry=sNMPCommunityTableEntry, vlanPriority=vlanPriority, sNMPCommunityAccess=sNMPCommunityAccess, configurationGroup=configurationGroup, subnetMask=subnetMask, bootVersion=bootVersion, nTPServerIp=nTPServerIp, ptpTrapPrefix=ptpTrapPrefix, iPAddress=iPAddress, sNMPTrapCommunity=sNMPTrapCommunity, sNMPCommunityTable=sNMPCommunityTable, snmpControlGroup=snmpControlGroup, ptp250=ptp250, linkStatusTrap=linkStatusTrap, signalStrengthRatio=signalStrengthRatio, vlanTagging=vlanTagging, channelSelection=channelSelection, transmitModulationMode=transmitModulationMode, dataPortStatus=dataPortStatus, sNMPCommunityOid=sNMPCommunityOid, ethernet=ethernet, searchState=searchState, versions=versions, receivePower=receivePower, sNMPTrapTableIndex=sNMPTrapTableIndex, installArmState=installArmState, linkLoss=linkLoss, sNMPTrapPortNumber=sNMPTrapPortNumber, regionCode=regionCode, sNMPEnabledTraps=sNMPEnabledTraps, alarms=alarms, smtpGroup=smtpGroup, sNMPCommunityTableIndex=sNMPCommunityTableIndex, installArmStateTrap=installArmStateTrap, nTPPollInterval=nTPPollInterval, wirelessLinkStatus=wirelessLinkStatus, tFTPServerIPAddress=tFTPServerIPAddress, currentFreqMHz=currentFreqMHz, radarDetectChannel=radarDetectChannel, tFTPServerPortNumber=tFTPServerPortNumber, productName=productName, productVariant=productVariant, alarmsGroup=alarmsGroup, radarDetectTrap=radarDetectTrap, management=management, configuredModulationMode=configuredModulationMode, sNMPTrapIPAddress=sNMPTrapIPAddress, pubStats=pubStats, licenceGroup=licenceGroup, ntp=ntp, notificationsGroup=notificationsGroup, nTPLastSync=nTPLastSync, nTPSync=nTPSync, ptmp=ptmp, transmitDataRate=transmitDataRate, phyStatus=phyStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, gatewayIPAddress=gatewayIPAddress, ptp=ptp, vectorError=vectorError, ethernetGroup=ethernetGroup, siteName=siteName, systemClock=systemClock, remoteIPAddress=remoteIPAddress, vlanId=vlanId, noWirelessChannelAvailable=noWirelessChannelAvailable, softwareVersion=softwareVersion, dataPortStatusTrap=dataPortStatusTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPCommunityString=sNMPCommunityString, cableLoss=cableLoss, aggregateDataRate=aggregateDataRate, fixedModMode=fixedModMode, smtp=smtp, remoteMACAddress=remoteMACAddress, configuredRange=configuredRange, pubStatsGroup=pubStatsGroup, PYSNMP_MODULE_ID=cambium, sMTPServerIPAddress=sMTPServerIPAddress, managementGroup=managementGroup, versionsGroup=versionsGroup, currentChannel=currentChannel, configuration=configuration, extendedChannel=extendedChannel, phyStatusGroup=phyStatusGroup)
