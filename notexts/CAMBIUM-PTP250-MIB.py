...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, alarmsGroup=alarmsGroup, channelBandwidth=channelBandwidth, vectorError=vectorError, snmpControlGroup=snmpControlGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, configurationGroup=configurationGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPCommunityAccess=sNMPCommunityAccess, measuredRange=measuredRange, productVariant=productVariant, vlanPriority=vlanPriority, radarDetectChannel=radarDetectChannel, receivePower=receivePower, tFTPServerPortNumber=tFTPServerPortNumber, ptp=ptp, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptmp=ptmp, configuredRange=configuredRange, linkName=linkName, installArmState=installArmState, ethernet=ethernet, sNMPCommunityTable=sNMPCommunityTable, notificationsGroup=notificationsGroup, currentFreqMHz=currentFreqMHz, versionsGroup=versionsGroup, transmitPower=transmitPower, signalStrengthRatio=signalStrengthRatio, masterSlaveMode=masterSlaveMode, band=band, snmpControl=snmpControl, dataPortStatus=dataPortStatus, hardwareVersion=hardwareVersion, transmitDataRate=transmitDataRate, pubStats=pubStats, configuredModulationMode=configuredModulationMode, antennaGain=antennaGain, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPCommunityString=sNMPCommunityString, remoteIPAddress=remoteIPAddress, licence=licence, ptpGroups=ptpGroups, licenceGroup=licenceGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, extendedChannel=extendedChannel, nTPServerIp=nTPServerIp, configuration=configuration, remoteMACAddress=remoteMACAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, transmitModulationMode=transmitModulationMode, gatewayIPAddress=gatewayIPAddress, nTPPollInterval=nTPPollInterval, dataPortAutoNegotiation=dataPortAutoNegotiation, sMTPSourceEmailAddress=sMTPSourceEmailAddress, linkLoss=linkLoss, iPAddress=iPAddress, cambium=cambium, regionCode=regionCode, wirelessLinkStatus=wirelessLinkStatus, noiseFloor=noiseFloor, sMTPEnabledMessages=sMTPEnabledMessages, sMTPServerPortNumber=sMTPServerPortNumber, tFTPServerIPAddress=tFTPServerIPAddress, siteName=siteName, nTPState=nTPState, receiveDataRate=receiveDataRate, nTPSync=nTPSync, channelSelection=channelSelection, cableLoss=cableLoss, ptpCompliance=ptpCompliance, sNMPCommunityTableNumber=sNMPCommunityTableNumber, pubStatsGroup=pubStatsGroup, sNMPTrapTable=sNMPTrapTable, sNMPTrapCommunity=sNMPTrapCommunity, ptpTrapPrefix=ptpTrapPrefix, extendedFreqMHz=extendedFreqMHz, smtp=smtp, ethernetGroup=ethernetGroup, dataPortStatusTrap=dataPortStatusTrap, alarms=alarms, installArmStateTrap=installArmStateTrap, versions=versions, vlanId=vlanId, PYSNMP_MODULE_ID=cambium, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapPortNumber=sNMPTrapPortNumber, radarDetectTrap=radarDetectTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, management=management, managementGroup=managementGroup, timeZone=timeZone, ptp250=ptp250, phyStatus=phyStatus, sNMPEnabledTraps=sNMPEnabledTraps, ptpTraps=ptpTraps, sNMPCommunityTableEntry=sNMPCommunityTableEntry, phyStatusGroup=phyStatusGroup, currentChannel=currentChannel, ntpGroup=ntpGroup, dualPayload=dualPayload, nTPServerPortNumber=nTPServerPortNumber, maximumTransmitPower=maximumTransmitPower, sNMPTrapIPAddress=sNMPTrapIPAddress, softwareVersion=softwareVersion, bootVersion=bootVersion, linkStatusTrap=linkStatusTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, subnetMask=subnetMask, sNMPCommunityOid=sNMPCommunityOid, systemClock=systemClock, sNMPCommunityTableIndex=sNMPCommunityTableIndex, nTPLastSync=nTPLastSync, smtpGroup=smtpGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, receiveModulationMode=receiveModulationMode, ntp=ntp, productName=productName, fixedModMode=fixedModMode, sNMPTrapTableIndex=sNMPTrapTableIndex, searchState=searchState, aggregateDataRate=aggregateDataRate, sMTPServerIPAddress=sMTPServerIPAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, vlanTagging=vlanTagging)
