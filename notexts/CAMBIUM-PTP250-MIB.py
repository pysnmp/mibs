...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", subnetMask=subnetMask, sNMPCommunityOid=sNMPCommunityOid, noiseFloor=noiseFloor, cambium=cambium, sNMPCommunityTableIndex=sNMPCommunityTableIndex, gatewayIPAddress=gatewayIPAddress, linkLoss=linkLoss, sNMPCommunityTableEntry=sNMPCommunityTableEntry, ptpGroups=ptpGroups, ptpCompliance=ptpCompliance, systemClock=systemClock, ptpTrapPrefix=ptpTrapPrefix, management=management, iPAddress=iPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, installArmStateTrap=installArmStateTrap, linkStatusTrap=linkStatusTrap, versions=versions, timeZone=timeZone, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, receivePower=receivePower, configuredRange=configuredRange, regionCode=regionCode, pubStatsGroup=pubStatsGroup, band=band, searchState=searchState, managementGroup=managementGroup, alarms=alarms, PYSNMP_MODULE_ID=cambium, antennaGain=antennaGain, transmitDataRate=transmitDataRate, wirelessLinkStatus=wirelessLinkStatus, fixedModMode=fixedModMode, vectorError=vectorError, radarDetectChannel=radarDetectChannel, receiveDataRate=receiveDataRate, ptpTraps=ptpTraps, dataPortStatus=dataPortStatus, radarDetectTrap=radarDetectTrap, signalStrengthRatio=signalStrengthRatio, phyStatusGroup=phyStatusGroup, ptp=ptp, remoteIPAddress=remoteIPAddress, tFTPServerIPAddress=tFTPServerIPAddress, licenceGroup=licenceGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, vlanTagging=vlanTagging, currentChannel=currentChannel, pubStats=pubStats, siteName=siteName, receiveModulationMode=receiveModulationMode, bootVersion=bootVersion, aggregateDataRate=aggregateDataRate, configurationGroup=configurationGroup, sMTPEnabledMessages=sMTPEnabledMessages, maximumTransmitPower=maximumTransmitPower, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapCommunity=sNMPTrapCommunity, nTPSync=nTPSync, productName=productName, extendedFreqMHz=extendedFreqMHz, ntp=ntp, noWirelessChannelAvailable=noWirelessChannelAvailable, productVariant=productVariant, nTPState=nTPState, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapTable=sNMPTrapTable, smtp=smtp, ntpGroup=ntpGroup, tFTPServerPortNumber=tFTPServerPortNumber, remoteMACAddress=remoteMACAddress, sMTPServerPortNumber=sMTPServerPortNumber, nTPServerIp=nTPServerIp, ptp250=ptp250, linkName=linkName, softwareVersion=softwareVersion, vlanPriority=vlanPriority, configuration=configuration, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, alarmsGroup=alarmsGroup, snmpControl=snmpControl, dataPortStatusTrap=dataPortStatusTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, smtpGroup=smtpGroup, sNMPCommunityTable=sNMPCommunityTable, cableLoss=cableLoss, sNMPTrapTableNumber=sNMPTrapTableNumber, nTPPollInterval=nTPPollInterval, phyStatus=phyStatus, snmpControlGroup=snmpControlGroup, licence=licence, nTPLastSync=nTPLastSync, dualPayload=dualPayload, currentFreqMHz=currentFreqMHz, notificationsGroup=notificationsGroup, channelBandwidth=channelBandwidth, sNMPCommunityString=sNMPCommunityString, sMTPServerIPAddress=sMTPServerIPAddress, ethernetGroup=ethernetGroup, transmitPower=transmitPower, sMTPSourceEmailAddress=sMTPSourceEmailAddress, hardwareVersion=hardwareVersion, sNMPCommunityAccess=sNMPCommunityAccess, sNMPTrapTableIndex=sNMPTrapTableIndex, configuredModulationMode=configuredModulationMode, ethernet=ethernet, sNMPTrapTableEntry=sNMPTrapTableEntry, transmitModulationMode=transmitModulationMode, versionsGroup=versionsGroup, sNMPEnabledTraps=sNMPEnabledTraps, vlanId=vlanId, sNMPCommunityTableNumber=sNMPCommunityTableNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, channelSelection=channelSelection, measuredRange=measuredRange, masterSlaveMode=masterSlaveMode, installArmState=installArmState, ptmp=ptmp, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, nTPServerPortNumber=nTPServerPortNumber, sNMPTrapVersion=sNMPTrapVersion, extendedChannel=extendedChannel)
