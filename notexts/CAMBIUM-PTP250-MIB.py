...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, nTPSync=nTPSync, sNMPTrapCommunity=sNMPTrapCommunity, tFTPServerIPAddress=tFTPServerIPAddress, antennaGain=antennaGain, dataPortStatus=dataPortStatus, signalStrengthRatio=signalStrengthRatio, ntpGroup=ntpGroup, cambium=cambium, licenceGroup=licenceGroup, searchState=searchState, fixedModMode=fixedModMode, linkLoss=linkLoss, ethernet=ethernet, productName=productName, phyStatus=phyStatus, ptpCompliance=ptpCompliance, sNMPTrapVersion=sNMPTrapVersion, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapTable=sNMPTrapTable, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, radarDetectTrap=radarDetectTrap, timeZone=timeZone, configurationGroup=configurationGroup, tFTPServerPortNumber=tFTPServerPortNumber, nTPPollInterval=nTPPollInterval, configuredRange=configuredRange, alarms=alarms, sNMPCommunityTableIndex=sNMPCommunityTableIndex, maximumTransmitPower=maximumTransmitPower, ptpGroups=ptpGroups, cableLoss=cableLoss, aggregateDataRate=aggregateDataRate, remoteMACAddress=remoteMACAddress, sNMPCommunityTableNumber=sNMPCommunityTableNumber, vlanId=vlanId, currentFreqMHz=currentFreqMHz, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPServerPortNumber=sMTPServerPortNumber, notificationsGroup=notificationsGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, gatewayIPAddress=gatewayIPAddress, management=management, sNMPCommunityOid=sNMPCommunityOid, measuredRange=measuredRange, nTPServerIp=nTPServerIp, sNMPTrapTableEntry=sNMPTrapTableEntry, siteName=siteName, band=band, PYSNMP_MODULE_ID=cambium, ptpTrapPrefix=ptpTrapPrefix, licence=licence, linkStatusTrap=linkStatusTrap, sNMPCommunityAccess=sNMPCommunityAccess, linkName=linkName, noiseFloor=noiseFloor, transmitDataRate=transmitDataRate, configuredModulationMode=configuredModulationMode, sNMPCommunityString=sNMPCommunityString, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, nTPState=nTPState, extendedFreqMHz=extendedFreqMHz, sMTPSourceEmailAddress=sMTPSourceEmailAddress, receiveModulationMode=receiveModulationMode, dataPortStatusTrap=dataPortStatusTrap, smtpGroup=smtpGroup, softwareVersion=softwareVersion, receiveDataRate=receiveDataRate, radarDetectChannel=radarDetectChannel, sMTPServerIPAddress=sMTPServerIPAddress, snmpControl=snmpControl, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, pubStatsGroup=pubStatsGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, versionsGroup=versionsGroup, remoteIPAddress=remoteIPAddress, ptpTraps=ptpTraps, sNMPTrapIPAddress=sNMPTrapIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, extendedChannel=extendedChannel, ptmp=ptmp, ethernetGroup=ethernetGroup, receivePower=receivePower, currentChannel=currentChannel, sMTPEnabledMessages=sMTPEnabledMessages, ptp=ptp, pubStats=pubStats, hardwareVersion=hardwareVersion, regionCode=regionCode, smtp=smtp, managementGroup=managementGroup, sNMPCommunityTable=sNMPCommunityTable, masterSlaveMode=masterSlaveMode, vectorError=vectorError, transmitModulationMode=transmitModulationMode, transmitPower=transmitPower, alarmsGroup=alarmsGroup, installArmState=installArmState, nTPServerPortNumber=nTPServerPortNumber, bootVersion=bootVersion, sNMPTrapTableIndex=sNMPTrapTableIndex, channelBandwidth=channelBandwidth, versions=versions, channelSelection=channelSelection, vlanTagging=vlanTagging, sNMPTrapTableNumber=sNMPTrapTableNumber, configuration=configuration, ptp250=ptp250, systemClock=systemClock, iPAddress=iPAddress, productVariant=productVariant, ntp=ntp, wirelessLinkStatus=wirelessLinkStatus, subnetMask=subnetMask, sNMPCommunityTableEntry=sNMPCommunityTableEntry, vlanPriority=vlanPriority, dualPayload=dualPayload, phyStatusGroup=phyStatusGroup, snmpControlGroup=snmpControlGroup, sNMPEnabledTraps=sNMPEnabledTraps, installArmStateTrap=installArmStateTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, nTPLastSync=nTPLastSync)
