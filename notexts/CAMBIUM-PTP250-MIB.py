...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", vlanPriority=vlanPriority, managementGroup=managementGroup, sNMPCommunityTableIndex=sNMPCommunityTableIndex, snmpControl=snmpControl, receiveDataRate=receiveDataRate, tFTPServerIPAddress=tFTPServerIPAddress, channelBandwidth=channelBandwidth, receivePower=receivePower, dataPortStatus=dataPortStatus, sNMPCommunityTable=sNMPCommunityTable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataPortStatusTrap=dataPortStatusTrap, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapTableIndex=sNMPTrapTableIndex, snmpControlGroup=snmpControlGroup, versions=versions, remoteIPAddress=remoteIPAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, ntpGroup=ntpGroup, ptpTraps=ptpTraps, sNMPTrapVersion=sNMPTrapVersion, regionCode=regionCode, systemClock=systemClock, ptpCompliance=ptpCompliance, nTPServerIp=nTPServerIp, smtp=smtp, phyStatusGroup=phyStatusGroup, cableLoss=cableLoss, licenceGroup=licenceGroup, PYSNMP_MODULE_ID=cambium, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPCommunityTableNumber=sNMPCommunityTableNumber, linkStatusTrap=linkStatusTrap, measuredRange=measuredRange, sNMPTrapPortNumber=sNMPTrapPortNumber, extendedChannel=extendedChannel, receiveModulationMode=receiveModulationMode, ethernetGroup=ethernetGroup, ptmp=ptmp, vlanTagging=vlanTagging, installArmState=installArmState, radarDetectChannel=radarDetectChannel, configuredRange=configuredRange, extendedFreqMHz=extendedFreqMHz, sNMPTrapTable=sNMPTrapTable, sNMPCommunityTableEntry=sNMPCommunityTableEntry, hardwareVersion=hardwareVersion, smtpGroup=smtpGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, nTPLastSync=nTPLastSync, pubStatsGroup=pubStatsGroup, sNMPEnabledTraps=sNMPEnabledTraps, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapTableNumber=sNMPTrapTableNumber, band=band, sNMPTrapIPAddress=sNMPTrapIPAddress, iPAddress=iPAddress, softwareVersion=softwareVersion, transmitDataRate=transmitDataRate, ptpTrapPrefix=ptpTrapPrefix, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, nTPState=nTPState, vlanId=vlanId, maximumTransmitPower=maximumTransmitPower, nTPPollInterval=nTPPollInterval, dualPayload=dualPayload, tFTPServerPortNumber=tFTPServerPortNumber, currentFreqMHz=currentFreqMHz, sMTPServerIPAddress=sMTPServerIPAddress, sNMPCommunityAccess=sNMPCommunityAccess, installArmStateTrap=installArmStateTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, alarms=alarms, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, vectorError=vectorError, cambium=cambium, sNMPCommunityString=sNMPCommunityString, configuration=configuration, gatewayIPAddress=gatewayIPAddress, searchState=searchState, bootVersion=bootVersion, configurationGroup=configurationGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, configuredModulationMode=configuredModulationMode, licence=licence, timeZone=timeZone, subnetMask=subnetMask, ptpGroups=ptpGroups, sMTPServerPortNumber=sMTPServerPortNumber, wirelessLinkStatus=wirelessLinkStatus, phyStatus=phyStatus, ethernet=ethernet, nTPServerPortNumber=nTPServerPortNumber, ptp=ptp, sNMPCommunityOid=sNMPCommunityOid, antennaGain=antennaGain, linkLoss=linkLoss, currentChannel=currentChannel, channelSelection=channelSelection, noiseFloor=noiseFloor, linkName=linkName, ptp250=ptp250, ntp=ntp, productName=productName, management=management, signalStrengthRatio=signalStrengthRatio, nTPSync=nTPSync, transmitPower=transmitPower, remoteMACAddress=remoteMACAddress, radarDetectTrap=radarDetectTrap, notificationsGroup=notificationsGroup, productVariant=productVariant, siteName=siteName, fixedModMode=fixedModMode, pubStats=pubStats, aggregateDataRate=aggregateDataRate, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, masterSlaveMode=masterSlaveMode, sNMPTrapCommunity=sNMPTrapCommunity, transmitModulationMode=transmitModulationMode, alarmsGroup=alarmsGroup, versionsGroup=versionsGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement)
