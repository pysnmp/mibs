...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", snmpControl=snmpControl, searchState=searchState, linkLoss=linkLoss, configurationGroup=configurationGroup, alarms=alarms, ptpTraps=ptpTraps, signalStrengthRatio=signalStrengthRatio, radarDetectChannel=radarDetectChannel, installArmState=installArmState, pubStats=pubStats, iPAddress=iPAddress, managementGroup=managementGroup, sNMPCommunityTable=sNMPCommunityTable, ethernetGroup=ethernetGroup, productVariant=productVariant, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ptp=ptp, systemClock=systemClock, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, band=band, pubStatsGroup=pubStatsGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapTableIndex=sNMPTrapTableIndex, receiveModulationMode=receiveModulationMode, channelBandwidth=channelBandwidth, notificationsGroup=notificationsGroup, tFTPServerIPAddress=tFTPServerIPAddress, sMTPEnabledMessages=sMTPEnabledMessages, tFTPServerPortNumber=tFTPServerPortNumber, masterSlaveMode=masterSlaveMode, sNMPTrapTableEntry=sNMPTrapTableEntry, configuredRange=configuredRange, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ptp250=ptp250, antennaGain=antennaGain, phyStatus=phyStatus, licenceGroup=licenceGroup, versionsGroup=versionsGroup, ptpTrapPrefix=ptpTrapPrefix, aggregateDataRate=aggregateDataRate, cableLoss=cableLoss, extendedFreqMHz=extendedFreqMHz, phyStatusGroup=phyStatusGroup, transmitModulationMode=transmitModulationMode, measuredRange=measuredRange, noiseFloor=noiseFloor, dualPayload=dualPayload, sNMPCommunityTableIndex=sNMPCommunityTableIndex, transmitPower=transmitPower, timeZone=timeZone, vlanTagging=vlanTagging, bootVersion=bootVersion, sNMPCommunityTableEntry=sNMPCommunityTableEntry, vlanPriority=vlanPriority, cambium=cambium, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, hardwareVersion=hardwareVersion, receiveDataRate=receiveDataRate, nTPServerPortNumber=nTPServerPortNumber, ntpGroup=ntpGroup, linkName=linkName, currentChannel=currentChannel, wirelessLinkStatus=wirelessLinkStatus, alarmsGroup=alarmsGroup, sMTPServerPortNumber=sMTPServerPortNumber, radarDetectTrap=radarDetectTrap, smtp=smtp, sMTPSourceEmailAddress=sMTPSourceEmailAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, regionCode=regionCode, nTPSync=nTPSync, softwareVersion=softwareVersion, ptpGroups=ptpGroups, vectorError=vectorError, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapPortNumber=sNMPTrapPortNumber, management=management, configuredModulationMode=configuredModulationMode, snmpControlGroup=snmpControlGroup, versions=versions, ptpCompliance=ptpCompliance, productName=productName, subnetMask=subnetMask, sNMPCommunityOid=sNMPCommunityOid, remoteIPAddress=remoteIPAddress, ntp=ntp, transmitDataRate=transmitDataRate, vlanId=vlanId, sNMPEnabledTraps=sNMPEnabledTraps, nTPLastSync=nTPLastSync, sNMPTrapVersion=sNMPTrapVersion, ptmp=ptmp, smtpGroup=smtpGroup, dataPortStatusTrap=dataPortStatusTrap, sNMPCommunityString=sNMPCommunityString, remoteMACAddress=remoteMACAddress, PYSNMP_MODULE_ID=cambium, gatewayIPAddress=gatewayIPAddress, receivePower=receivePower, sNMPCommunityAccess=sNMPCommunityAccess, sNMPTrapCommunity=sNMPTrapCommunity, channelSelection=channelSelection, sNMPTrapIPAddress=sNMPTrapIPAddress, configuration=configuration, extendedChannel=extendedChannel, licence=licence, sNMPCommunityTableNumber=sNMPCommunityTableNumber, nTPServerIp=nTPServerIp, maximumTransmitPower=maximumTransmitPower, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapTable=sNMPTrapTable, siteName=siteName, fixedModMode=fixedModMode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, currentFreqMHz=currentFreqMHz, dataPortStatus=dataPortStatus, ethernet=ethernet, nTPState=nTPState, sMTPServerIPAddress=sMTPServerIPAddress, linkStatusTrap=linkStatusTrap, nTPPollInterval=nTPPollInterval, installArmStateTrap=installArmStateTrap)
