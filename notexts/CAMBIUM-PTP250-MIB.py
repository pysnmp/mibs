...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", radarDetectChannel=radarDetectChannel, channelSelection=channelSelection, sNMPTrapVersion=sNMPTrapVersion, dataPortStatus=dataPortStatus, licenceGroup=licenceGroup, nTPSync=nTPSync, transmitDataRate=transmitDataRate, sNMPTrapTable=sNMPTrapTable, bootVersion=bootVersion, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, nTPLastSync=nTPLastSync, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ntp=ntp, tFTPServerIPAddress=tFTPServerIPAddress, smtp=smtp, licence=licence, remoteMACAddress=remoteMACAddress, nTPPollInterval=nTPPollInterval, configuredRange=configuredRange, ethernet=ethernet, alarmsGroup=alarmsGroup, hardwareVersion=hardwareVersion, channelBandwidth=channelBandwidth, configurationGroup=configurationGroup, sNMPEnabledTraps=sNMPEnabledTraps, sNMPCommunityTableEntry=sNMPCommunityTableEntry, pubStatsGroup=pubStatsGroup, ptpTraps=ptpTraps, ptp250=ptp250, ptmp=ptmp, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, linkLoss=linkLoss, antennaGain=antennaGain, sNMPCommunityTable=sNMPCommunityTable, aggregateDataRate=aggregateDataRate, sNMPTrapPortNumber=sNMPTrapPortNumber, systemClock=systemClock, iPAddress=iPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, management=management, ptp=ptp, sNMPTrapTableNumber=sNMPTrapTableNumber, smtpGroup=smtpGroup, sNMPCommunityAccess=sNMPCommunityAccess, radarDetectTrap=radarDetectTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPCommunityString=sNMPCommunityString, gatewayIPAddress=gatewayIPAddress, managementGroup=managementGroup, sMTPEnabledMessages=sMTPEnabledMessages, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortStatusTrap=dataPortStatusTrap, nTPServerIp=nTPServerIp, sNMPCommunityTableNumber=sNMPCommunityTableNumber, phyStatus=phyStatus, sNMPTrapCommunity=sNMPTrapCommunity, extendedFreqMHz=extendedFreqMHz, snmpControl=snmpControl, sNMPTrapIPAddress=sNMPTrapIPAddress, timeZone=timeZone, siteName=siteName, productName=productName, vlanId=vlanId, sNMPTrapTableEntry=sNMPTrapTableEntry, productVariant=productVariant, nTPState=nTPState, wirelessLinkStatus=wirelessLinkStatus, extendedChannel=extendedChannel, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, configuredModulationMode=configuredModulationMode, nTPServerPortNumber=nTPServerPortNumber, snmpControlGroup=snmpControlGroup, vlanPriority=vlanPriority, maximumTransmitPower=maximumTransmitPower, cableLoss=cableLoss, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ptpGroups=ptpGroups, ethernetGroup=ethernetGroup, receivePower=receivePower, subnetMask=subnetMask, dataPortAutoNegotiation=dataPortAutoNegotiation, notificationsGroup=notificationsGroup, masterSlaveMode=masterSlaveMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPServerIPAddress=sMTPServerIPAddress, installArmState=installArmState, installArmStateTrap=installArmStateTrap, cambium=cambium, PYSNMP_MODULE_ID=cambium, sNMPCommunityTableIndex=sNMPCommunityTableIndex, measuredRange=measuredRange, band=band, phyStatusGroup=phyStatusGroup, linkName=linkName, sMTPSourceEmailAddress=sMTPSourceEmailAddress, fixedModMode=fixedModMode, searchState=searchState, sMTPServerPortNumber=sMTPServerPortNumber, tFTPServerPortNumber=tFTPServerPortNumber, dualPayload=dualPayload, versions=versions, vlanTagging=vlanTagging, softwareVersion=softwareVersion, configuration=configuration, alarms=alarms, vectorError=vectorError, regionCode=regionCode, sNMPTrapTableIndex=sNMPTrapTableIndex, transmitModulationMode=transmitModulationMode, currentFreqMHz=currentFreqMHz, linkStatusTrap=linkStatusTrap, signalStrengthRatio=signalStrengthRatio, sNMPCommunityOid=sNMPCommunityOid, versionsGroup=versionsGroup, transmitPower=transmitPower, receiveModulationMode=receiveModulationMode, currentChannel=currentChannel, ptpTrapPrefix=ptpTrapPrefix, pubStats=pubStats, noiseFloor=noiseFloor, ntpGroup=ntpGroup, ptpCompliance=ptpCompliance, remoteIPAddress=remoteIPAddress, receiveDataRate=receiveDataRate)
