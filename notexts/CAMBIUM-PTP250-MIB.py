...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPTrapTable=sNMPTrapTable, ntp=ntp, linkStatusTrap=linkStatusTrap, sNMPTrapVersion=sNMPTrapVersion, ptpCompliance=ptpCompliance, regionCode=regionCode, managementGroup=managementGroup, nTPSync=nTPSync, vlanPriority=vlanPriority, configuration=configuration, vlanId=vlanId, tFTPServerIPAddress=tFTPServerIPAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, systemClock=systemClock, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, maximumTransmitPower=maximumTransmitPower, receiveModulationMode=receiveModulationMode, sNMPCommunityTableEntry=sNMPCommunityTableEntry, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, siteName=siteName, antennaGain=antennaGain, hardwareVersion=hardwareVersion, band=band, vectorError=vectorError, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, installArmStateTrap=installArmStateTrap, currentChannel=currentChannel, management=management, subnetMask=subnetMask, ptp250=ptp250, sNMPCommunityString=sNMPCommunityString, nTPPollInterval=nTPPollInterval, extendedChannel=extendedChannel, measuredRange=measuredRange, versionsGroup=versionsGroup, nTPLastSync=nTPLastSync, licenceGroup=licenceGroup, sMTPEnabledMessages=sMTPEnabledMessages, productVariant=productVariant, sNMPTrapCommunity=sNMPTrapCommunity, configurationGroup=configurationGroup, nTPServerPortNumber=nTPServerPortNumber, notificationsGroup=notificationsGroup, iPAddress=iPAddress, pubStatsGroup=pubStatsGroup, radarDetectChannel=radarDetectChannel, dualPayload=dualPayload, vlanTagging=vlanTagging, transmitPower=transmitPower, sNMPCommunityTable=sNMPCommunityTable, ptmp=ptmp, fixedModMode=fixedModMode, sNMPEnabledTraps=sNMPEnabledTraps, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, cambium=cambium, smtp=smtp, sNMPTrapTableEntry=sNMPTrapTableEntry, snmpControlGroup=snmpControlGroup, noiseFloor=noiseFloor, tFTPServerPortNumber=tFTPServerPortNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, remoteMACAddress=remoteMACAddress, configuredModulationMode=configuredModulationMode, channelSelection=channelSelection, bootVersion=bootVersion, radarDetectTrap=radarDetectTrap, extendedFreqMHz=extendedFreqMHz, sNMPCommunityTableNumber=sNMPCommunityTableNumber, installArmState=installArmState, ptp=ptp, currentFreqMHz=currentFreqMHz, sMTPSourceEmailAddress=sMTPSourceEmailAddress, linkName=linkName, noWirelessChannelAvailable=noWirelessChannelAvailable, alarmsGroup=alarmsGroup, productName=productName, PYSNMP_MODULE_ID=cambium, sNMPTrapTableNumber=sNMPTrapTableNumber, receiveDataRate=receiveDataRate, sNMPTrapIPAddress=sNMPTrapIPAddress, snmpControl=snmpControl, phyStatusGroup=phyStatusGroup, nTPServerIp=nTPServerIp, dataPortAutoNegotiation=dataPortAutoNegotiation, ethernetGroup=ethernetGroup, nTPState=nTPState, dataPortStatusTrap=dataPortStatusTrap, ethernet=ethernet, alarms=alarms, channelBandwidth=channelBandwidth, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptpTraps=ptpTraps, ptpGroups=ptpGroups, sNMPCommunityAccess=sNMPCommunityAccess, transmitModulationMode=transmitModulationMode, receivePower=receivePower, smtpGroup=smtpGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, softwareVersion=softwareVersion, versions=versions, configuredRange=configuredRange, dataPortStatus=dataPortStatus, sMTPServerIPAddress=sMTPServerIPAddress, masterSlaveMode=masterSlaveMode, gatewayIPAddress=gatewayIPAddress, wirelessLinkStatus=wirelessLinkStatus, remoteIPAddress=remoteIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transmitDataRate=transmitDataRate, sMTPServerPortNumber=sMTPServerPortNumber, linkLoss=linkLoss, timeZone=timeZone, ptpTrapPrefix=ptpTrapPrefix, sNMPCommunityOid=sNMPCommunityOid, pubStats=pubStats, phyStatus=phyStatus, searchState=searchState, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sNMPTrapTableIndex=sNMPTrapTableIndex, ntpGroup=ntpGroup, licence=licence, aggregateDataRate=aggregateDataRate, signalStrengthRatio=signalStrengthRatio, cableLoss=cableLoss)
