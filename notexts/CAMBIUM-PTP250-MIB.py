...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPTrapTable=sNMPTrapTable, configuredRange=configuredRange, dataPortStatusTrap=dataPortStatusTrap, systemClock=systemClock, sNMPCommunityTable=sNMPCommunityTable, remoteMACAddress=remoteMACAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, receiveModulationMode=receiveModulationMode, PYSNMP_MODULE_ID=cambium, timeZone=timeZone, linkStatusTrap=linkStatusTrap, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sNMPCommunityTableEntry=sNMPCommunityTableEntry, notificationsGroup=notificationsGroup, subnetMask=subnetMask, sNMPTrapCommunity=sNMPTrapCommunity, currentChannel=currentChannel, linkLoss=linkLoss, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, signalStrengthRatio=signalStrengthRatio, antennaGain=antennaGain, channelSelection=channelSelection, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPEnabledTraps=sNMPEnabledTraps, cableLoss=cableLoss, ptp250=ptp250, transmitModulationMode=transmitModulationMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPCommunityOid=sNMPCommunityOid, sMTPEnabledMessages=sMTPEnabledMessages, receivePower=receivePower, configurationGroup=configurationGroup, channelBandwidth=channelBandwidth, vectorError=vectorError, licenceGroup=licenceGroup, ethernetGroup=ethernetGroup, iPAddress=iPAddress, dualPayload=dualPayload, cambium=cambium, dataPortStatus=dataPortStatus, gatewayIPAddress=gatewayIPAddress, pubStats=pubStats, hardwareVersion=hardwareVersion, sNMPCommunityTableNumber=sNMPCommunityTableNumber, bootVersion=bootVersion, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapIPAddress=sNMPTrapIPAddress, smtpGroup=smtpGroup, ptp=ptp, pubStatsGroup=pubStatsGroup, radarDetectTrap=radarDetectTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, masterSlaveMode=masterSlaveMode, searchState=searchState, vlanTagging=vlanTagging, measuredRange=measuredRange, nTPServerPortNumber=nTPServerPortNumber, alarms=alarms, versionsGroup=versionsGroup, siteName=siteName, tFTPServerPortNumber=tFTPServerPortNumber, snmpControlGroup=snmpControlGroup, nTPServerIp=nTPServerIp, nTPState=nTPState, installArmStateTrap=installArmStateTrap, ntp=ntp, fixedModMode=fixedModMode, sNMPTrapTableEntry=sNMPTrapTableEntry, licence=licence, phyStatus=phyStatus, receiveDataRate=receiveDataRate, radarDetectChannel=radarDetectChannel, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, nTPSync=nTPSync, sMTPSourceEmailAddress=sMTPSourceEmailAddress, installArmState=installArmState, extendedChannel=extendedChannel, productName=productName, ptpCompliance=ptpCompliance, ptpGroups=ptpGroups, alarmsGroup=alarmsGroup, maximumTransmitPower=maximumTransmitPower, remoteIPAddress=remoteIPAddress, management=management, sMTPServerPortNumber=sMTPServerPortNumber, smtp=smtp, regionCode=regionCode, extendedFreqMHz=extendedFreqMHz, currentFreqMHz=currentFreqMHz, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, vlanPriority=vlanPriority, wirelessLinkStatus=wirelessLinkStatus, versions=versions, sNMPCommunityAccess=sNMPCommunityAccess, vlanId=vlanId, productVariant=productVariant, configuredModulationMode=configuredModulationMode, sNMPCommunityString=sNMPCommunityString, band=band, dataPortAutoNegotiation=dataPortAutoNegotiation, ethernet=ethernet, aggregateDataRate=aggregateDataRate, linkName=linkName, nTPPollInterval=nTPPollInterval, sNMPTrapTableIndex=sNMPTrapTableIndex, transmitPower=transmitPower, phyStatusGroup=phyStatusGroup, ptpTrapPrefix=ptpTrapPrefix, managementGroup=managementGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, snmpControl=snmpControl, ptpTraps=ptpTraps, transmitDataRate=transmitDataRate, softwareVersion=softwareVersion, sMTPServerIPAddress=sMTPServerIPAddress, ntpGroup=ntpGroup, tFTPServerIPAddress=tFTPServerIPAddress, noiseFloor=noiseFloor, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapVersion=sNMPTrapVersion, nTPLastSync=nTPLastSync, configuration=configuration, ptmp=ptmp)
