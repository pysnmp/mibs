...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", versions=versions, masterSlaveMode=masterSlaveMode, sNMPEnabledTraps=sNMPEnabledTraps, nTPServerPortNumber=nTPServerPortNumber, versionsGroup=versionsGroup, subnetMask=subnetMask, sNMPTrapCommunity=sNMPTrapCommunity, transmitPower=transmitPower, maximumTransmitPower=maximumTransmitPower, nTPSync=nTPSync, ptp250=ptp250, dataPortStatus=dataPortStatus, extendedChannel=extendedChannel, aggregateDataRate=aggregateDataRate, bootVersion=bootVersion, ntpGroup=ntpGroup, installArmState=installArmState, band=band, tFTPServerIPAddress=tFTPServerIPAddress, gatewayIPAddress=gatewayIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, receiveDataRate=receiveDataRate, managementGroup=managementGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, smtpGroup=smtpGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPServerPortNumber=sMTPServerPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, remoteMACAddress=remoteMACAddress, currentFreqMHz=currentFreqMHz, ntp=ntp, ethernet=ethernet, notificationsGroup=notificationsGroup, radarDetectChannel=radarDetectChannel, PYSNMP_MODULE_ID=cambium, sNMPCommunityTable=sNMPCommunityTable, linkName=linkName, softwareVersion=softwareVersion, configuredModulationMode=configuredModulationMode, management=management, ptpCompliance=ptpCompliance, systemClock=systemClock, channelSelection=channelSelection, tFTPServerPortNumber=tFTPServerPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, productVariant=productVariant, productName=productName, sNMPTrapTableIndex=sNMPTrapTableIndex, cableLoss=cableLoss, regionCode=regionCode, sNMPTrapVersion=sNMPTrapVersion, ptpTrapPrefix=ptpTrapPrefix, noWirelessChannelAvailable=noWirelessChannelAvailable, phyStatusGroup=phyStatusGroup, pubStats=pubStats, alarms=alarms, iPAddress=iPAddress, sNMPCommunityTableNumber=sNMPCommunityTableNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, nTPState=nTPState, searchState=searchState, antennaGain=antennaGain, channelBandwidth=channelBandwidth, transmitModulationMode=transmitModulationMode, alarmsGroup=alarmsGroup, receiveModulationMode=receiveModulationMode, sNMPCommunityAccess=sNMPCommunityAccess, nTPPollInterval=nTPPollInterval, sNMPCommunityOid=sNMPCommunityOid, siteName=siteName, wirelessLinkStatus=wirelessLinkStatus, remoteIPAddress=remoteIPAddress, vlanId=vlanId, smtp=smtp, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sNMPCommunityString=sNMPCommunityString, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapPortNumber=sNMPTrapPortNumber, installArmStateTrap=installArmStateTrap, vlanTagging=vlanTagging, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ptpGroups=ptpGroups, measuredRange=measuredRange, ptmp=ptmp, signalStrengthRatio=signalStrengthRatio, vectorError=vectorError, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sNMPTrapIPAddress=sNMPTrapIPAddress, transmitDataRate=transmitDataRate, licence=licence, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapTable=sNMPTrapTable, dualPayload=dualPayload, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, configuredRange=configuredRange, ethernetGroup=ethernetGroup, fixedModMode=fixedModMode, receivePower=receivePower, extendedFreqMHz=extendedFreqMHz, timeZone=timeZone, licenceGroup=licenceGroup, nTPLastSync=nTPLastSync, currentChannel=currentChannel, ptpTraps=ptpTraps, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, cambium=cambium, vlanPriority=vlanPriority, linkLoss=linkLoss, nTPServerIp=nTPServerIp, dataPortStatusTrap=dataPortStatusTrap, configuration=configuration, snmpControl=snmpControl, noiseFloor=noiseFloor, hardwareVersion=hardwareVersion, snmpControlGroup=snmpControlGroup, configurationGroup=configurationGroup, ptp=ptp, linkStatusTrap=linkStatusTrap, pubStatsGroup=pubStatsGroup, radarDetectTrap=radarDetectTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, phyStatus=phyStatus)
