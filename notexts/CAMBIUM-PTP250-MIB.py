...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", transmitModulationMode=transmitModulationMode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPServerPortNumber=sMTPServerPortNumber, linkStatusTrap=linkStatusTrap, sMTPServerIPAddress=sMTPServerIPAddress, managementGroup=managementGroup, remoteIPAddress=remoteIPAddress, subnetMask=subnetMask, sNMPCommunityString=sNMPCommunityString, receiveDataRate=receiveDataRate, smtpGroup=smtpGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, antennaGain=antennaGain, ptp=ptp, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, nTPServerPortNumber=nTPServerPortNumber, masterSlaveMode=masterSlaveMode, phyStatus=phyStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, bootVersion=bootVersion, ptp250=ptp250, ntpGroup=ntpGroup, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sMTPEnabledMessages=sMTPEnabledMessages, transmitDataRate=transmitDataRate, pubStatsGroup=pubStatsGroup, sNMPTrapVersion=sNMPTrapVersion, smtp=smtp, noiseFloor=noiseFloor, configuredModulationMode=configuredModulationMode, radarDetectChannel=radarDetectChannel, iPAddress=iPAddress, alarmsGroup=alarmsGroup, ptpGroups=ptpGroups, licence=licence, nTPServerIp=nTPServerIp, channelSelection=channelSelection, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, productName=productName, notificationsGroup=notificationsGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, phyStatusGroup=phyStatusGroup, sNMPTrapCommunity=sNMPTrapCommunity, extendedFreqMHz=extendedFreqMHz, transmitPower=transmitPower, ptpTraps=ptpTraps, systemClock=systemClock, versions=versions, cableLoss=cableLoss, wirelessLinkStatus=wirelessLinkStatus, currentChannel=currentChannel, signalStrengthRatio=signalStrengthRatio, receivePower=receivePower, productVariant=productVariant, nTPSync=nTPSync, ptpCompliance=ptpCompliance, sNMPTrapTable=sNMPTrapTable, tFTPServerPortNumber=tFTPServerPortNumber, vlanId=vlanId, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, snmpControl=snmpControl, maximumTransmitPower=maximumTransmitPower, configurationGroup=configurationGroup, sNMPCommunityTableEntry=sNMPCommunityTableEntry, tFTPServerIPAddress=tFTPServerIPAddress, alarms=alarms, currentFreqMHz=currentFreqMHz, sNMPCommunityOid=sNMPCommunityOid, sNMPEnabledTraps=sNMPEnabledTraps, cambium=cambium, snmpControlGroup=snmpControlGroup, ntp=ntp, linkName=linkName, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, PYSNMP_MODULE_ID=cambium, versionsGroup=versionsGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, configuredRange=configuredRange, ptmp=ptmp, regionCode=regionCode, nTPPollInterval=nTPPollInterval, sNMPCommunityTableNumber=sNMPCommunityTableNumber, timeZone=timeZone, vlanPriority=vlanPriority, dataPortAutoNegotiation=dataPortAutoNegotiation, ethernetGroup=ethernetGroup, sNMPCommunityAccess=sNMPCommunityAccess, fixedModMode=fixedModMode, extendedChannel=extendedChannel, gatewayIPAddress=gatewayIPAddress, receiveModulationMode=receiveModulationMode, sNMPCommunityTable=sNMPCommunityTable, softwareVersion=softwareVersion, dualPayload=dualPayload, vectorError=vectorError, hardwareVersion=hardwareVersion, aggregateDataRate=aggregateDataRate, dataPortStatus=dataPortStatus, radarDetectTrap=radarDetectTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, band=band, sNMPTrapIPAddress=sNMPTrapIPAddress, pubStats=pubStats, configuration=configuration, channelBandwidth=channelBandwidth, vlanTagging=vlanTagging, installArmState=installArmState, measuredRange=measuredRange, ethernet=ethernet, remoteMACAddress=remoteMACAddress, management=management, siteName=siteName, noWirelessChannelAvailable=noWirelessChannelAvailable, installArmStateTrap=installArmStateTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortStatusTrap=dataPortStatusTrap, nTPLastSync=nTPLastSync, ptpTrapPrefix=ptpTrapPrefix, licenceGroup=licenceGroup, nTPState=nTPState, linkLoss=linkLoss, searchState=searchState)
