...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapTableIndex=sNMPTrapTableIndex, dualPayload=dualPayload, cableLoss=cableLoss, linkLoss=linkLoss, radarDetectChannel=radarDetectChannel, nTPState=nTPState, sMTPServerIPAddress=sMTPServerIPAddress, wirelessLinkStatus=wirelessLinkStatus, remoteIPAddress=remoteIPAddress, regionCode=regionCode, currentChannel=currentChannel, sNMPTrapIPAddress=sNMPTrapIPAddress, nTPSync=nTPSync, sNMPTrapTableEntry=sNMPTrapTableEntry, licenceGroup=licenceGroup, siteName=siteName, extendedFreqMHz=extendedFreqMHz, iPAddress=iPAddress, configuration=configuration, productName=productName, PYSNMP_MODULE_ID=cambium, pubStats=pubStats, sMTPEnabledMessages=sMTPEnabledMessages, sMTPServerPortNumber=sMTPServerPortNumber, linkStatusTrap=linkStatusTrap, management=management, channelSelection=channelSelection, sNMPCommunityTableNumber=sNMPCommunityTableNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, alarms=alarms, versionsGroup=versionsGroup, ethernetGroup=ethernetGroup, ptpGroups=ptpGroups, vlanPriority=vlanPriority, searchState=searchState, ptpTrapPrefix=ptpTrapPrefix, antennaGain=antennaGain, subnetMask=subnetMask, transmitModulationMode=transmitModulationMode, vlanId=vlanId, timeZone=timeZone, configuredModulationMode=configuredModulationMode, masterSlaveMode=masterSlaveMode, maximumTransmitPower=maximumTransmitPower, alarmsGroup=alarmsGroup, smtp=smtp, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPEnabledTraps=sNMPEnabledTraps, aggregateDataRate=aggregateDataRate, ptpCompliance=ptpCompliance, band=band, transmitPower=transmitPower, configuredRange=configuredRange, hardwareVersion=hardwareVersion, sNMPCommunityAccess=sNMPCommunityAccess, licence=licence, ptp250=ptp250, sNMPTrapVersion=sNMPTrapVersion, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPCommunityTableEntry=sNMPCommunityTableEntry, nTPServerIp=nTPServerIp, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, snmpControlGroup=snmpControlGroup, versions=versions, nTPServerPortNumber=nTPServerPortNumber, installArmStateTrap=installArmStateTrap, configurationGroup=configurationGroup, remoteMACAddress=remoteMACAddress, dataPortStatus=dataPortStatus, ptmp=ptmp, sNMPCommunityTableIndex=sNMPCommunityTableIndex, ethernet=ethernet, currentFreqMHz=currentFreqMHz, systemClock=systemClock, extendedChannel=extendedChannel, sNMPCommunityTable=sNMPCommunityTable, channelBandwidth=channelBandwidth, sNMPCommunityString=sNMPCommunityString, fixedModMode=fixedModMode, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapCommunity=sNMPTrapCommunity, dataPortAutoNegotiation=dataPortAutoNegotiation, nTPPollInterval=nTPPollInterval, cambium=cambium, ptp=ptp, radarDetectTrap=radarDetectTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPCommunityOid=sNMPCommunityOid, vectorError=vectorError, notificationsGroup=notificationsGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ntpGroup=ntpGroup, measuredRange=measuredRange, noWirelessChannelAvailable=noWirelessChannelAvailable, receiveModulationMode=receiveModulationMode, productVariant=productVariant, receivePower=receivePower, pubStatsGroup=pubStatsGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapTable=sNMPTrapTable, snmpControl=snmpControl, noiseFloor=noiseFloor, installArmState=installArmState, phyStatus=phyStatus, nTPLastSync=nTPLastSync, transmitDataRate=transmitDataRate, softwareVersion=softwareVersion, signalStrengthRatio=signalStrengthRatio, ntp=ntp, tFTPServerIPAddress=tFTPServerIPAddress, vlanTagging=vlanTagging, gatewayIPAddress=gatewayIPAddress, ptpTraps=ptpTraps, receiveDataRate=receiveDataRate, dataPortStatusTrap=dataPortStatusTrap, phyStatusGroup=phyStatusGroup, smtpGroup=smtpGroup, managementGroup=managementGroup, linkName=linkName, bootVersion=bootVersion, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus)
