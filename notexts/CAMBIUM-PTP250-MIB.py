...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", siteName=siteName, ethernet=ethernet, sNMPTrapIPAddress=sNMPTrapIPAddress, nTPState=nTPState, management=management, currentChannel=currentChannel, masterSlaveMode=masterSlaveMode, alarms=alarms, ntpGroup=ntpGroup, transmitDataRate=transmitDataRate, channelBandwidth=channelBandwidth, managementGroup=managementGroup, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapVersion=sNMPTrapVersion, hardwareVersion=hardwareVersion, sNMPCommunityString=sNMPCommunityString, fixedModMode=fixedModMode, signalStrengthRatio=signalStrengthRatio, vectorError=vectorError, smtpGroup=smtpGroup, vlanPriority=vlanPriority, PYSNMP_MODULE_ID=cambium, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortStatus=dataPortStatus, cableLoss=cableLoss, sNMPCommunityTable=sNMPCommunityTable, snmpControlGroup=snmpControlGroup, snmpControl=snmpControl, ptpTraps=ptpTraps, sNMPTrapPortNumber=sNMPTrapPortNumber, linkName=linkName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, receiveDataRate=receiveDataRate, configurationGroup=configurationGroup, vlanId=vlanId, bootVersion=bootVersion, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, versions=versions, ptp=ptp, ptpTrapPrefix=ptpTrapPrefix, licence=licence, sNMPTrapTableNumber=sNMPTrapTableNumber, phyStatusGroup=phyStatusGroup, versionsGroup=versionsGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, receiveModulationMode=receiveModulationMode, sMTPServerIPAddress=sMTPServerIPAddress, radarDetectTrap=radarDetectTrap, gatewayIPAddress=gatewayIPAddress, alarmsGroup=alarmsGroup, linkLoss=linkLoss, wirelessLinkStatus=wirelessLinkStatus, extendedChannel=extendedChannel, iPAddress=iPAddress, sNMPEnabledTraps=sNMPEnabledTraps, measuredRange=measuredRange, phyStatus=phyStatus, configuredRange=configuredRange, productVariant=productVariant, softwareVersion=softwareVersion, notificationsGroup=notificationsGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, remoteMACAddress=remoteMACAddress, timeZone=timeZone, dataPortStatusTrap=dataPortStatusTrap, transmitModulationMode=transmitModulationMode, linkStatusTrap=linkStatusTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPCommunityTableIndex=sNMPCommunityTableIndex, ethernetGroup=ethernetGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, aggregateDataRate=aggregateDataRate, ptpCompliance=ptpCompliance, band=band, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapTableEntry=sNMPTrapTableEntry, dualPayload=dualPayload, ptp250=ptp250, noWirelessChannelAvailable=noWirelessChannelAvailable, extendedFreqMHz=extendedFreqMHz, productName=productName, vlanTagging=vlanTagging, sNMPTrapTable=sNMPTrapTable, sNMPCommunityAccess=sNMPCommunityAccess, sNMPCommunityTableEntry=sNMPCommunityTableEntry, nTPLastSync=nTPLastSync, nTPServerIp=nTPServerIp, licenceGroup=licenceGroup, installArmState=installArmState, nTPServerPortNumber=nTPServerPortNumber, tFTPServerIPAddress=tFTPServerIPAddress, pubStatsGroup=pubStatsGroup, subnetMask=subnetMask, sNMPCommunityOid=sNMPCommunityOid, ptpGroups=ptpGroups, tFTPServerPortNumber=tFTPServerPortNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, channelSelection=channelSelection, searchState=searchState, ntp=ntp, regionCode=regionCode, remoteIPAddress=remoteIPAddress, installArmStateTrap=installArmStateTrap, sMTPServerPortNumber=sMTPServerPortNumber, nTPSync=nTPSync, noiseFloor=noiseFloor, cambium=cambium, receivePower=receivePower, systemClock=systemClock, ptmp=ptmp, sNMPCommunityTableNumber=sNMPCommunityTableNumber, currentFreqMHz=currentFreqMHz, nTPPollInterval=nTPPollInterval, maximumTransmitPower=maximumTransmitPower, pubStats=pubStats, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapCommunity=sNMPTrapCommunity, configuration=configuration, antennaGain=antennaGain, transmitPower=transmitPower, radarDetectChannel=radarDetectChannel, smtp=smtp, configuredModulationMode=configuredModulationMode)
