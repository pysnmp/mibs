...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", licence=licence, regionCode=regionCode, smtp=smtp, transmitPower=transmitPower, ptpCompliance=ptpCompliance, iPAddress=iPAddress, ntpGroup=ntpGroup, antennaGain=antennaGain, vectorError=vectorError, installArmStateTrap=installArmStateTrap, ptpTrapPrefix=ptpTrapPrefix, ethernetGroup=ethernetGroup, phyStatusGroup=phyStatusGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, measuredRange=measuredRange, subnetMask=subnetMask, radarDetectChannel=radarDetectChannel, configuration=configuration, sNMPTrapTableNumber=sNMPTrapTableNumber, productName=productName, licenceGroup=licenceGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, alarmsGroup=alarmsGroup, receiveModulationMode=receiveModulationMode, pubStatsGroup=pubStatsGroup, phyStatus=phyStatus, nTPSync=nTPSync, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, managementGroup=managementGroup, remoteIPAddress=remoteIPAddress, sNMPCommunityAccess=sNMPCommunityAccess, snmpControlGroup=snmpControlGroup, installArmState=installArmState, vlanTagging=vlanTagging, softwareVersion=softwareVersion, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receiveDataRate=receiveDataRate, PYSNMP_MODULE_ID=cambium, sNMPCommunityTable=sNMPCommunityTable, siteName=siteName, currentFreqMHz=currentFreqMHz, nTPPollInterval=nTPPollInterval, vlanId=vlanId, ptp250=ptp250, sNMPCommunityString=sNMPCommunityString, ptp=ptp, noWirelessChannelAvailable=noWirelessChannelAvailable, timeZone=timeZone, sNMPTrapPortNumber=sNMPTrapPortNumber, versionsGroup=versionsGroup, aggregateDataRate=aggregateDataRate, channelBandwidth=channelBandwidth, ntp=ntp, remoteMACAddress=remoteMACAddress, extendedChannel=extendedChannel, nTPServerIp=nTPServerIp, vlanPriority=vlanPriority, maximumTransmitPower=maximumTransmitPower, snmpControl=snmpControl, alarms=alarms, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapVersion=sNMPTrapVersion, masterSlaveMode=masterSlaveMode, ptmp=ptmp, searchState=searchState, currentChannel=currentChannel, sMTPEnabledMessages=sMTPEnabledMessages, dataPortStatusTrap=dataPortStatusTrap, sNMPCommunityTableIndex=sNMPCommunityTableIndex, configuredModulationMode=configuredModulationMode, fixedModMode=fixedModMode, sNMPEnabledTraps=sNMPEnabledTraps, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortStatus=dataPortStatus, systemClock=systemClock, ptpTraps=ptpTraps, noiseFloor=noiseFloor, sNMPTrapTableIndex=sNMPTrapTableIndex, sMTPServerIPAddress=sMTPServerIPAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapTable=sNMPTrapTable, cambium=cambium, sNMPCommunityOid=sNMPCommunityOid, radarDetectTrap=radarDetectTrap, tFTPServerIPAddress=tFTPServerIPAddress, sNMPCommunityTableNumber=sNMPCommunityTableNumber, bootVersion=bootVersion, band=band, linkLoss=linkLoss, channelSelection=channelSelection, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, productVariant=productVariant, smtpGroup=smtpGroup, nTPLastSync=nTPLastSync, gatewayIPAddress=gatewayIPAddress, wirelessLinkStatus=wirelessLinkStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapIPAddress=sNMPTrapIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, transmitModulationMode=transmitModulationMode, signalStrengthRatio=signalStrengthRatio, dualPayload=dualPayload, pubStats=pubStats, configuredRange=configuredRange, cableLoss=cableLoss, notificationsGroup=notificationsGroup, linkName=linkName, extendedFreqMHz=extendedFreqMHz, sNMPTrapCommunity=sNMPTrapCommunity, linkStatusTrap=linkStatusTrap, configurationGroup=configurationGroup, ethernet=ethernet, tFTPServerPortNumber=tFTPServerPortNumber, sNMPCommunityTableEntry=sNMPCommunityTableEntry, ptpGroups=ptpGroups, receivePower=receivePower, hardwareVersion=hardwareVersion, nTPServerPortNumber=nTPServerPortNumber, sMTPServerPortNumber=sMTPServerPortNumber, nTPState=nTPState, transmitDataRate=transmitDataRate, versions=versions, management=management)
