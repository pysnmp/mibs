...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapTableNumber=sNMPTrapTableNumber, signalStrengthRatio=signalStrengthRatio, sNMPTrapIPAddress=sNMPTrapIPAddress, ptpTrapPrefix=ptpTrapPrefix, nTPServerIp=nTPServerIp, sNMPTrapVersion=sNMPTrapVersion, nTPPollInterval=nTPPollInterval, configuredModulationMode=configuredModulationMode, notificationsGroup=notificationsGroup, vlanPriority=vlanPriority, transmitModulationMode=transmitModulationMode, smtp=smtp, receivePower=receivePower, ethernetGroup=ethernetGroup, dataPortStatusTrap=dataPortStatusTrap, ntpGroup=ntpGroup, masterSlaveMode=masterSlaveMode, tFTPServerIPAddress=tFTPServerIPAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, licenceGroup=licenceGroup, pubStatsGroup=pubStatsGroup, linkName=linkName, remoteMACAddress=remoteMACAddress, remoteIPAddress=remoteIPAddress, sNMPCommunityTableIndex=sNMPCommunityTableIndex, ptmp=ptmp, nTPSync=nTPSync, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkLoss=linkLoss, managementGroup=managementGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, nTPLastSync=nTPLastSync, configurationGroup=configurationGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, nTPState=nTPState, cambium=cambium, installArmState=installArmState, alarmsGroup=alarmsGroup, channelSelection=channelSelection, sNMPCommunityTableNumber=sNMPCommunityTableNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortAutoNegotiation=dataPortAutoNegotiation, currentFreqMHz=currentFreqMHz, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, licence=licence, noiseFloor=noiseFloor, gatewayIPAddress=gatewayIPAddress, ptp=ptp, versionsGroup=versionsGroup, sNMPCommunityString=sNMPCommunityString, band=band, radarDetectChannel=radarDetectChannel, versions=versions, wirelessLinkStatus=wirelessLinkStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapTableEntry=sNMPTrapTableEntry, snmpControlGroup=snmpControlGroup, configuration=configuration, extendedChannel=extendedChannel, ptp250=ptp250, PYSNMP_MODULE_ID=cambium, iPAddress=iPAddress, measuredRange=measuredRange, sNMPCommunityTable=sNMPCommunityTable, extendedFreqMHz=extendedFreqMHz, receiveModulationMode=receiveModulationMode, nTPServerPortNumber=nTPServerPortNumber, alarms=alarms, cableLoss=cableLoss, productName=productName, timeZone=timeZone, receiveDataRate=receiveDataRate, phyStatus=phyStatus, transmitPower=transmitPower, channelBandwidth=channelBandwidth, sMTPEnabledMessages=sMTPEnabledMessages, installArmStateTrap=installArmStateTrap, smtpGroup=smtpGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, vlanTagging=vlanTagging, transmitDataRate=transmitDataRate, aggregateDataRate=aggregateDataRate, maximumTransmitPower=maximumTransmitPower, dualPayload=dualPayload, ptpTraps=ptpTraps, linkStatusTrap=linkStatusTrap, searchState=searchState, siteName=siteName, vectorError=vectorError, snmpControl=snmpControl, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapCommunity=sNMPTrapCommunity, vlanId=vlanId, productVariant=productVariant, sNMPCommunityAccess=sNMPCommunityAccess, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, currentChannel=currentChannel, management=management, ptpCompliance=ptpCompliance, ptpGroups=ptpGroups, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sNMPTrapTable=sNMPTrapTable, subnetMask=subnetMask, ethernet=ethernet, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, phyStatusGroup=phyStatusGroup, ntp=ntp, sMTPServerPortNumber=sMTPServerPortNumber, radarDetectTrap=radarDetectTrap, softwareVersion=softwareVersion, dataPortStatus=dataPortStatus, hardwareVersion=hardwareVersion, regionCode=regionCode, pubStats=pubStats, fixedModMode=fixedModMode, sNMPCommunityOid=sNMPCommunityOid, bootVersion=bootVersion, sNMPTrapTableIndex=sNMPTrapTableIndex, systemClock=systemClock, tFTPServerPortNumber=tFTPServerPortNumber, configuredRange=configuredRange, antennaGain=antennaGain)
