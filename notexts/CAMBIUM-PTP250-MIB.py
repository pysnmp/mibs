...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", maximumTransmitPower=maximumTransmitPower, currentChannel=currentChannel, ethernet=ethernet, configuredRange=configuredRange, antennaGain=antennaGain, licence=licence, smtp=smtp, sNMPTrapIPAddress=sNMPTrapIPAddress, vlanId=vlanId, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, nTPLastSync=nTPLastSync, alarms=alarms, versions=versions, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapTableNumber=sNMPTrapTableNumber, vectorError=vectorError, nTPServerPortNumber=nTPServerPortNumber, extendedFreqMHz=extendedFreqMHz, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, installArmState=installArmState, linkStatusTrap=linkStatusTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortAutoNegotiation=dataPortAutoNegotiation, nTPServerIp=nTPServerIp, currentFreqMHz=currentFreqMHz, ntpGroup=ntpGroup, gatewayIPAddress=gatewayIPAddress, cambium=cambium, wirelessLinkStatus=wirelessLinkStatus, sNMPTrapTable=sNMPTrapTable, sNMPCommunityTableNumber=sNMPCommunityTableNumber, productName=productName, aggregateDataRate=aggregateDataRate, extendedChannel=extendedChannel, softwareVersion=softwareVersion, configuration=configuration, management=management, sMTPServerPortNumber=sMTPServerPortNumber, systemClock=systemClock, PYSNMP_MODULE_ID=cambium, ptpGroups=ptpGroups, transmitPower=transmitPower, pubStats=pubStats, nTPSync=nTPSync, sNMPTrapTableIndex=sNMPTrapTableIndex, masterSlaveMode=masterSlaveMode, sMTPEnabledMessages=sMTPEnabledMessages, searchState=searchState, managementGroup=managementGroup, tFTPServerIPAddress=tFTPServerIPAddress, ptp=ptp, remoteIPAddress=remoteIPAddress, sNMPCommunityAccess=sNMPCommunityAccess, measuredRange=measuredRange, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, vlanPriority=vlanPriority, dualPayload=dualPayload, sNMPCommunityTableIndex=sNMPCommunityTableIndex, subnetMask=subnetMask, linkName=linkName, channelSelection=channelSelection, hardwareVersion=hardwareVersion, ntp=ntp, receivePower=receivePower, remoteMACAddress=remoteMACAddress, licenceGroup=licenceGroup, regionCode=regionCode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPServerIPAddress=sMTPServerIPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapTableEntry=sNMPTrapTableEntry, noiseFloor=noiseFloor, fixedModMode=fixedModMode, tFTPServerPortNumber=tFTPServerPortNumber, ptpCompliance=ptpCompliance, nTPState=nTPState, phyStatusGroup=phyStatusGroup, timeZone=timeZone, installArmStateTrap=installArmStateTrap, iPAddress=iPAddress, transmitModulationMode=transmitModulationMode, receiveModulationMode=receiveModulationMode, cableLoss=cableLoss, sNMPEnabledTraps=sNMPEnabledTraps, sNMPCommunityTable=sNMPCommunityTable, snmpControlGroup=snmpControlGroup, configurationGroup=configurationGroup, band=band, dataPortStatusTrap=dataPortStatusTrap, channelBandwidth=channelBandwidth, radarDetectChannel=radarDetectChannel, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, transmitDataRate=transmitDataRate, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, productVariant=productVariant, snmpControl=snmpControl, smtpGroup=smtpGroup, ptp250=ptp250, ptmp=ptmp, sNMPCommunityOid=sNMPCommunityOid, radarDetectTrap=radarDetectTrap, dataPortStatus=dataPortStatus, alarmsGroup=alarmsGroup, notificationsGroup=notificationsGroup, pubStatsGroup=pubStatsGroup, ptpTrapPrefix=ptpTrapPrefix, signalStrengthRatio=signalStrengthRatio, sNMPTrapPortNumber=sNMPTrapPortNumber, linkLoss=linkLoss, receiveDataRate=receiveDataRate, configuredModulationMode=configuredModulationMode, ptpTraps=ptpTraps, sNMPCommunityTableEntry=sNMPCommunityTableEntry, vlanTagging=vlanTagging, bootVersion=bootVersion, sNMPTrapCommunity=sNMPTrapCommunity, versionsGroup=versionsGroup, sNMPCommunityString=sNMPCommunityString, ethernetGroup=ethernetGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, nTPPollInterval=nTPPollInterval, phyStatus=phyStatus, siteName=siteName)
