...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", ptmp=ptmp, sNMPTrapTable=sNMPTrapTable, gatewayIPAddress=gatewayIPAddress, currentFreqMHz=currentFreqMHz, transmitModulationMode=transmitModulationMode, maximumTransmitPower=maximumTransmitPower, linkLoss=linkLoss, sMTPServerPortNumber=sMTPServerPortNumber, bootVersion=bootVersion, sNMPCommunityOid=sNMPCommunityOid, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortStatus=dataPortStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, measuredRange=measuredRange, phyStatusGroup=phyStatusGroup, iPAddress=iPAddress, sNMPCommunityTableIndex=sNMPCommunityTableIndex, versionsGroup=versionsGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, extendedFreqMHz=extendedFreqMHz, noWirelessChannelAvailable=noWirelessChannelAvailable, productName=productName, management=management, sNMPCommunityTable=sNMPCommunityTable, installArmStateTrap=installArmStateTrap, radarDetectTrap=radarDetectTrap, sNMPCommunityString=sNMPCommunityString, tFTPServerPortNumber=tFTPServerPortNumber, fixedModMode=fixedModMode, aggregateDataRate=aggregateDataRate, channelSelection=channelSelection, linkName=linkName, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, hardwareVersion=hardwareVersion, pubStats=pubStats, tFTPServerIPAddress=tFTPServerIPAddress, subnetMask=subnetMask, pubStatsGroup=pubStatsGroup, snmpControlGroup=snmpControlGroup, alarms=alarms, nTPServerIp=nTPServerIp, phyStatus=phyStatus, currentChannel=currentChannel, PYSNMP_MODULE_ID=cambium, ptp250=ptp250, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, vectorError=vectorError, channelBandwidth=channelBandwidth, nTPLastSync=nTPLastSync, productVariant=productVariant, sNMPEnabledTraps=sNMPEnabledTraps, masterSlaveMode=masterSlaveMode, smtp=smtp, vlanId=vlanId, systemClock=systemClock, antennaGain=antennaGain, receivePower=receivePower, configuredModulationMode=configuredModulationMode, notificationsGroup=notificationsGroup, nTPPollInterval=nTPPollInterval, nTPServerPortNumber=nTPServerPortNumber, licenceGroup=licenceGroup, ethernetGroup=ethernetGroup, softwareVersion=softwareVersion, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPCommunityAccess=sNMPCommunityAccess, radarDetectChannel=radarDetectChannel, configurationGroup=configurationGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPEnabledMessages=sMTPEnabledMessages, ptpTrapPrefix=ptpTrapPrefix, siteName=siteName, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, regionCode=regionCode, dataPortStatusTrap=dataPortStatusTrap, ntp=ntp, nTPSync=nTPSync, configuredRange=configuredRange, remoteIPAddress=remoteIPAddress, ptpTraps=ptpTraps, remoteMACAddress=remoteMACAddress, cambium=cambium, smtpGroup=smtpGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapCommunity=sNMPTrapCommunity, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, alarmsGroup=alarmsGroup, receiveModulationMode=receiveModulationMode, linkStatusTrap=linkStatusTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, installArmState=installArmState, sNMPTrapTableEntry=sNMPTrapTableEntry, receiveDataRate=receiveDataRate, snmpControl=snmpControl, sNMPCommunityTableNumber=sNMPCommunityTableNumber, licence=licence, cableLoss=cableLoss, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapVersion=sNMPTrapVersion, transmitDataRate=transmitDataRate, sNMPCommunityTableEntry=sNMPCommunityTableEntry, vlanTagging=vlanTagging, dataPortAutoNegotiation=dataPortAutoNegotiation, transmitPower=transmitPower, dualPayload=dualPayload, extendedChannel=extendedChannel, ptp=ptp, nTPState=nTPState, signalStrengthRatio=signalStrengthRatio, ntpGroup=ntpGroup, wirelessLinkStatus=wirelessLinkStatus, searchState=searchState, versions=versions, band=band, managementGroup=managementGroup, vlanPriority=vlanPriority, configuration=configuration, ptpGroups=ptpGroups, noiseFloor=noiseFloor, timeZone=timeZone, ethernet=ethernet, ptpCompliance=ptpCompliance)
