...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", vlanId=vlanId, nTPLastSync=nTPLastSync, versions=versions, nTPState=nTPState, ptpTrapPrefix=ptpTrapPrefix, wirelessLinkStatus=wirelessLinkStatus, sNMPCommunityTable=sNMPCommunityTable, linkName=linkName, maximumTransmitPower=maximumTransmitPower, currentChannel=currentChannel, sNMPCommunityTableIndex=sNMPCommunityTableIndex, softwareVersion=softwareVersion, currentFreqMHz=currentFreqMHz, sNMPTrapCommunity=sNMPTrapCommunity, nTPSync=nTPSync, bootVersion=bootVersion, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPCommunityOid=sNMPCommunityOid, sNMPCommunityTableEntry=sNMPCommunityTableEntry, receiveDataRate=receiveDataRate, transmitDataRate=transmitDataRate, signalStrengthRatio=signalStrengthRatio, tFTPServerPortNumber=tFTPServerPortNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, vlanTagging=vlanTagging, dualPayload=dualPayload, sMTPSourceEmailAddress=sMTPSourceEmailAddress, productVariant=productVariant, cambium=cambium, ethernet=ethernet, gatewayIPAddress=gatewayIPAddress, sMTPServerPortNumber=sMTPServerPortNumber, transmitModulationMode=transmitModulationMode, antennaGain=antennaGain, hardwareVersion=hardwareVersion, noiseFloor=noiseFloor, channelSelection=channelSelection, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, receiveModulationMode=receiveModulationMode, aggregateDataRate=aggregateDataRate, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, configuredRange=configuredRange, nTPServerIp=nTPServerIp, licence=licence, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, extendedChannel=extendedChannel, installArmState=installArmState, extendedFreqMHz=extendedFreqMHz, systemClock=systemClock, remoteMACAddress=remoteMACAddress, pubStatsGroup=pubStatsGroup, productName=productName, ethernetGroup=ethernetGroup, sMTPEnabledMessages=sMTPEnabledMessages, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ptpGroups=ptpGroups, radarDetectTrap=radarDetectTrap, versionsGroup=versionsGroup, subnetMask=subnetMask, sNMPTrapPortNumber=sNMPTrapPortNumber, ptmp=ptmp, alarmsGroup=alarmsGroup, configuration=configuration, linkStatusTrap=linkStatusTrap, configuredModulationMode=configuredModulationMode, smtp=smtp, installArmStateTrap=installArmStateTrap, ntp=ntp, transmitPower=transmitPower, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapTable=sNMPTrapTable, nTPServerPortNumber=nTPServerPortNumber, managementGroup=managementGroup, smtpGroup=smtpGroup, licenceGroup=licenceGroup, cableLoss=cableLoss, sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptp=ptp, sNMPEnabledTraps=sNMPEnabledTraps, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, management=management, pubStats=pubStats, channelBandwidth=channelBandwidth, sMTPServerIPAddress=sMTPServerIPAddress, snmpControlGroup=snmpControlGroup, vlanPriority=vlanPriority, nTPPollInterval=nTPPollInterval, configurationGroup=configurationGroup, remoteIPAddress=remoteIPAddress, alarms=alarms, siteName=siteName, masterSlaveMode=masterSlaveMode, radarDetectChannel=radarDetectChannel, sNMPTrapTableNumber=sNMPTrapTableNumber, ptp250=ptp250, ntpGroup=ntpGroup, PYSNMP_MODULE_ID=cambium, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPCommunityTableNumber=sNMPCommunityTableNumber, vectorError=vectorError, sNMPCommunityString=sNMPCommunityString, measuredRange=measuredRange, notificationsGroup=notificationsGroup, dataPortStatusTrap=dataPortStatusTrap, iPAddress=iPAddress, sNMPTrapVersion=sNMPTrapVersion, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkLoss=linkLoss, ptpCompliance=ptpCompliance, band=band, searchState=searchState, sNMPCommunityAccess=sNMPCommunityAccess, fixedModMode=fixedModMode, snmpControl=snmpControl, ptpTraps=ptpTraps, timeZone=timeZone, phyStatusGroup=phyStatusGroup, regionCode=regionCode, dataPortStatus=dataPortStatus, receivePower=receivePower, phyStatus=phyStatus)
