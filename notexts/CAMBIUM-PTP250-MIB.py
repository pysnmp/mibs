...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", notificationsGroup=notificationsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, ntp=ntp, sNMPCommunityTable=sNMPCommunityTable, searchState=searchState, sMTPEnabledMessages=sMTPEnabledMessages, nTPServerIp=nTPServerIp, snmpControl=snmpControl, nTPState=nTPState, extendedChannel=extendedChannel, radarDetectTrap=radarDetectTrap, transmitModulationMode=transmitModulationMode, gatewayIPAddress=gatewayIPAddress, installArmState=installArmState, linkStatusTrap=linkStatusTrap, sNMPCommunityOid=sNMPCommunityOid, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, currentFreqMHz=currentFreqMHz, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, systemClock=systemClock, licence=licence, wirelessLinkStatus=wirelessLinkStatus, productVariant=productVariant, channelBandwidth=channelBandwidth, nTPSync=nTPSync, sNMPCommunityTableIndex=sNMPCommunityTableIndex, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, configuredModulationMode=configuredModulationMode, band=band, sNMPCommunityTableEntry=sNMPCommunityTableEntry, ptpCompliance=ptpCompliance, sNMPTrapTableEntry=sNMPTrapTableEntry, cableLoss=cableLoss, measuredRange=measuredRange, ptp250=ptp250, versionsGroup=versionsGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPServerPortNumber=sMTPServerPortNumber, pubStats=pubStats, cambium=cambium, nTPServerPortNumber=nTPServerPortNumber, alarmsGroup=alarmsGroup, dataPortStatusTrap=dataPortStatusTrap, masterSlaveMode=masterSlaveMode, snmpControlGroup=snmpControlGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapVersion=sNMPTrapVersion, siteName=siteName, phyStatusGroup=phyStatusGroup, linkName=linkName, vlanPriority=vlanPriority, installArmStateTrap=installArmStateTrap, radarDetectChannel=radarDetectChannel, receivePower=receivePower, dataPortStatus=dataPortStatus, regionCode=regionCode, phyStatus=phyStatus, productName=productName, transmitPower=transmitPower, managementGroup=managementGroup, noiseFloor=noiseFloor, ptpTrapPrefix=ptpTrapPrefix, tFTPServerPortNumber=tFTPServerPortNumber, maximumTransmitPower=maximumTransmitPower, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, configurationGroup=configurationGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, smtpGroup=smtpGroup, channelSelection=channelSelection, antennaGain=antennaGain, remoteIPAddress=remoteIPAddress, vectorError=vectorError, alarms=alarms, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, receiveModulationMode=receiveModulationMode, iPAddress=iPAddress, sNMPTrapTable=sNMPTrapTable, configuredRange=configuredRange, softwareVersion=softwareVersion, bootVersion=bootVersion, transmitDataRate=transmitDataRate, aggregateDataRate=aggregateDataRate, vlanTagging=vlanTagging, vlanId=vlanId, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapCommunity=sNMPTrapCommunity, receiveDataRate=receiveDataRate, sNMPEnabledTraps=sNMPEnabledTraps, fixedModMode=fixedModMode, ptp=ptp, timeZone=timeZone, nTPPollInterval=nTPPollInterval, extendedFreqMHz=extendedFreqMHz, ethernetGroup=ethernetGroup, signalStrengthRatio=signalStrengthRatio, remoteMACAddress=remoteMACAddress, dualPayload=dualPayload, sNMPCommunityAccess=sNMPCommunityAccess, ptpGroups=ptpGroups, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sNMPCommunityString=sNMPCommunityString, sMTPServerIPAddress=sMTPServerIPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ethernet=ethernet, subnetMask=subnetMask, configuration=configuration, PYSNMP_MODULE_ID=cambium, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, nTPLastSync=nTPLastSync, hardwareVersion=hardwareVersion, ntpGroup=ntpGroup, pubStatsGroup=pubStatsGroup, management=management, linkLoss=linkLoss, sNMPTrapIPAddress=sNMPTrapIPAddress, currentChannel=currentChannel, versions=versions, ptmp=ptmp, sNMPTrapPortNumber=sNMPTrapPortNumber, smtp=smtp, licenceGroup=licenceGroup, ptpTraps=ptpTraps)
