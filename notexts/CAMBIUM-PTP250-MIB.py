...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", snmpControlGroup=snmpControlGroup, systemClock=systemClock, ptmp=ptmp, radarDetectTrap=radarDetectTrap, linkName=linkName, productVariant=productVariant, dataPortStatus=dataPortStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, configuredModulationMode=configuredModulationMode, channelBandwidth=channelBandwidth, sNMPTrapTable=sNMPTrapTable, sNMPCommunityTable=sNMPCommunityTable, ptp=ptp, radarDetectChannel=radarDetectChannel, alarmsGroup=alarmsGroup, maximumTransmitPower=maximumTransmitPower, smtp=smtp, sNMPCommunityTableEntry=sNMPCommunityTableEntry, transmitPower=transmitPower, versionsGroup=versionsGroup, nTPServerIp=nTPServerIp, timeZone=timeZone, dataPortAutoNegotiation=dataPortAutoNegotiation, nTPLastSync=nTPLastSync, smtpGroup=smtpGroup, extendedChannel=extendedChannel, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, configuration=configuration, ptp250=ptp250, extendedFreqMHz=extendedFreqMHz, regionCode=regionCode, sNMPTrapTableIndex=sNMPTrapTableIndex, bootVersion=bootVersion, alarms=alarms, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, licenceGroup=licenceGroup, tFTPServerIPAddress=tFTPServerIPAddress, sNMPCommunityOid=sNMPCommunityOid, ptpCompliance=ptpCompliance, receiveDataRate=receiveDataRate, PYSNMP_MODULE_ID=cambium, configuredRange=configuredRange, ethernet=ethernet, licence=licence, sNMPTrapPortNumber=sNMPTrapPortNumber, phyStatus=phyStatus, measuredRange=measuredRange, installArmState=installArmState, ptpGroups=ptpGroups, ethernetGroup=ethernetGroup, fixedModMode=fixedModMode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, versions=versions, searchState=searchState, gatewayIPAddress=gatewayIPAddress, siteName=siteName, aggregateDataRate=aggregateDataRate, masterSlaveMode=masterSlaveMode, ntpGroup=ntpGroup, cableLoss=cableLoss, dataPortStatusTrap=dataPortStatusTrap, transmitDataRate=transmitDataRate, receiveModulationMode=receiveModulationMode, vlanPriority=vlanPriority, subnetMask=subnetMask, nTPSync=nTPSync, installArmStateTrap=installArmStateTrap, noiseFloor=noiseFloor, hardwareVersion=hardwareVersion, receivePower=receivePower, nTPState=nTPState, configurationGroup=configurationGroup, band=band, managementGroup=managementGroup, sNMPTrapVersion=sNMPTrapVersion, phyStatusGroup=phyStatusGroup, wirelessLinkStatus=wirelessLinkStatus, sNMPCommunityTableIndex=sNMPCommunityTableIndex, signalStrengthRatio=signalStrengthRatio, management=management, linkStatusTrap=linkStatusTrap, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, sMTPEnabledMessages=sMTPEnabledMessages, vectorError=vectorError, nTPServerPortNumber=nTPServerPortNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, pubStatsGroup=pubStatsGroup, cambium=cambium, sNMPCommunityTableNumber=sNMPCommunityTableNumber, snmpControl=snmpControl, dualPayload=dualPayload, sNMPCommunityAccess=sNMPCommunityAccess, antennaGain=antennaGain, productName=productName, pubStats=pubStats, ptpTraps=ptpTraps, vlanId=vlanId, iPAddress=iPAddress, remoteMACAddress=remoteMACAddress, transmitModulationMode=transmitModulationMode, sNMPTrapCommunity=sNMPTrapCommunity, ntp=ntp, currentFreqMHz=currentFreqMHz, sMTPServerPortNumber=sMTPServerPortNumber, currentChannel=currentChannel, sNMPEnabledTraps=sNMPEnabledTraps, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, linkLoss=linkLoss, sMTPServerIPAddress=sMTPServerIPAddress, softwareVersion=softwareVersion, vlanTagging=vlanTagging, notificationsGroup=notificationsGroup, remoteIPAddress=remoteIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptpTrapPrefix=ptpTrapPrefix, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPCommunityString=sNMPCommunityString, nTPPollInterval=nTPPollInterval, channelSelection=channelSelection)
