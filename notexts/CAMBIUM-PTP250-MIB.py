...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", aggregateDataRate=aggregateDataRate, band=band, measuredRange=measuredRange, sMTPEnabledMessages=sMTPEnabledMessages, sNMPCommunityOid=sNMPCommunityOid, ptp250=ptp250, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, remoteMACAddress=remoteMACAddress, ethernet=ethernet, configuration=configuration, sNMPTrapPortNumber=sNMPTrapPortNumber, wirelessLinkStatus=wirelessLinkStatus, licence=licence, remoteIPAddress=remoteIPAddress, sMTPServerPortNumber=sMTPServerPortNumber, sNMPCommunityTableIndex=sNMPCommunityTableIndex, phyStatus=phyStatus, ptpTraps=ptpTraps, gatewayIPAddress=gatewayIPAddress, linkStatusTrap=linkStatusTrap, ptpTrapPrefix=ptpTrapPrefix, receiveModulationMode=receiveModulationMode, sNMPTrapTableIndex=sNMPTrapTableIndex, linkName=linkName, radarDetectChannel=radarDetectChannel, licenceGroup=licenceGroup, signalStrengthRatio=signalStrengthRatio, nTPServerPortNumber=nTPServerPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, alarmsGroup=alarmsGroup, sNMPCommunityAccess=sNMPCommunityAccess, nTPServerIp=nTPServerIp, ntp=ntp, sNMPTrapIPAddress=sNMPTrapIPAddress, siteName=siteName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, timeZone=timeZone, ptmp=ptmp, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, configuredRange=configuredRange, transmitModulationMode=transmitModulationMode, ptp=ptp, ptpGroups=ptpGroups, nTPState=nTPState, sNMPEnabledTraps=sNMPEnabledTraps, ethernetGroup=ethernetGroup, snmpControlGroup=snmpControlGroup, regionCode=regionCode, nTPPollInterval=nTPPollInterval, sNMPCommunityTableNumber=sNMPCommunityTableNumber, smtp=smtp, dataPortStatus=dataPortStatus, snmpControl=snmpControl, sNMPCommunityString=sNMPCommunityString, currentFreqMHz=currentFreqMHz, sNMPCommunityTableEntry=sNMPCommunityTableEntry, ntpGroup=ntpGroup, nTPSync=nTPSync, radarDetectTrap=radarDetectTrap, sNMPTrapVersion=sNMPTrapVersion, maximumTransmitPower=maximumTransmitPower, vlanPriority=vlanPriority, linkLoss=linkLoss, vlanTagging=vlanTagging, currentChannel=currentChannel, productName=productName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tFTPServerPortNumber=tFTPServerPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, subnetMask=subnetMask, channelBandwidth=channelBandwidth, phyStatusGroup=phyStatusGroup, receivePower=receivePower, sNMPTrapTable=sNMPTrapTable, transmitPower=transmitPower, notificationsGroup=notificationsGroup, alarms=alarms, cableLoss=cableLoss, PYSNMP_MODULE_ID=cambium, versions=versions, vlanId=vlanId, sNMPCommunityTable=sNMPCommunityTable, bootVersion=bootVersion, hardwareVersion=hardwareVersion, channelSelection=channelSelection, pubStatsGroup=pubStatsGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapCommunity=sNMPTrapCommunity, vectorError=vectorError, ptpCompliance=ptpCompliance, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, masterSlaveMode=masterSlaveMode, tFTPServerIPAddress=tFTPServerIPAddress, noiseFloor=noiseFloor, management=management, smtpGroup=smtpGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, versionsGroup=versionsGroup, extendedFreqMHz=extendedFreqMHz, searchState=searchState, systemClock=systemClock, softwareVersion=softwareVersion, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sMTPServerIPAddress=sMTPServerIPAddress, productVariant=productVariant, sNMPTrapTableEntry=sNMPTrapTableEntry, transmitDataRate=transmitDataRate, installArmStateTrap=installArmStateTrap, cambium=cambium, configurationGroup=configurationGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, extendedChannel=extendedChannel, configuredModulationMode=configuredModulationMode, managementGroup=managementGroup, iPAddress=iPAddress, dualPayload=dualPayload, fixedModMode=fixedModMode, dataPortStatusTrap=dataPortStatusTrap, pubStats=pubStats, antennaGain=antennaGain, installArmState=installArmState, receiveDataRate=receiveDataRate, nTPLastSync=nTPLastSync)
