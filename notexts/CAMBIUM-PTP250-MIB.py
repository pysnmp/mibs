...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", bootVersion=bootVersion, transmitModulationMode=transmitModulationMode, sMTPServerIPAddress=sMTPServerIPAddress, nTPServerIp=nTPServerIp, ethernetGroup=ethernetGroup, receiveModulationMode=receiveModulationMode, licence=licence, versionsGroup=versionsGroup, masterSlaveMode=masterSlaveMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPCommunityTable=sNMPCommunityTable, nTPSync=nTPSync, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPCommunityTableEntry=sNMPCommunityTableEntry, smtpGroup=smtpGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, nTPLastSync=nTPLastSync, sMTPServerPortNumber=sMTPServerPortNumber, pubStatsGroup=pubStatsGroup, aggregateDataRate=aggregateDataRate, alarms=alarms, measuredRange=measuredRange, vlanTagging=vlanTagging, sNMPTrapVersion=sNMPTrapVersion, configuredRange=configuredRange, configurationGroup=configurationGroup, systemClock=systemClock, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapPortNumber=sNMPTrapPortNumber, management=management, channelBandwidth=channelBandwidth, noiseFloor=noiseFloor, sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPServerPortNumber=tFTPServerPortNumber, currentFreqMHz=currentFreqMHz, ptp250=ptp250, ptp=ptp, cableLoss=cableLoss, productName=productName, nTPState=nTPState, smtp=smtp, cambium=cambium, ethernet=ethernet, hardwareVersion=hardwareVersion, vlanId=vlanId, nTPPollInterval=nTPPollInterval, linkStatusTrap=linkStatusTrap, alarmsGroup=alarmsGroup, sNMPCommunityOid=sNMPCommunityOid, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, receiveDataRate=receiveDataRate, remoteMACAddress=remoteMACAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, managementGroup=managementGroup, tFTPServerIPAddress=tFTPServerIPAddress, band=band, receivePower=receivePower, snmpControl=snmpControl, transmitDataRate=transmitDataRate, sNMPTrapTableIndex=sNMPTrapTableIndex, maximumTransmitPower=maximumTransmitPower, sMTPSourceEmailAddress=sMTPSourceEmailAddress, transmitPower=transmitPower, fixedModMode=fixedModMode, channelSelection=channelSelection, extendedChannel=extendedChannel, sNMPCommunityTableIndex=sNMPCommunityTableIndex, ntpGroup=ntpGroup, sMTPEnabledMessages=sMTPEnabledMessages, licenceGroup=licenceGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, productVariant=productVariant, siteName=siteName, sNMPTrapCommunity=sNMPTrapCommunity, currentChannel=currentChannel, ntp=ntp, ptpTraps=ptpTraps, subnetMask=subnetMask, extendedFreqMHz=extendedFreqMHz, wirelessLinkStatus=wirelessLinkStatus, PYSNMP_MODULE_ID=cambium, antennaGain=antennaGain, dualPayload=dualPayload, snmpControlGroup=snmpControlGroup, softwareVersion=softwareVersion, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, pubStats=pubStats, sNMPCommunityAccess=sNMPCommunityAccess, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortStatus=dataPortStatus, searchState=searchState, dataPortStatusTrap=dataPortStatusTrap, installArmState=installArmState, radarDetectChannel=radarDetectChannel, ptpTrapPrefix=ptpTrapPrefix, ptpCompliance=ptpCompliance, vectorError=vectorError, configuration=configuration, signalStrengthRatio=signalStrengthRatio, vlanPriority=vlanPriority, nTPServerPortNumber=nTPServerPortNumber, gatewayIPAddress=gatewayIPAddress, sNMPCommunityTableNumber=sNMPCommunityTableNumber, ptpGroups=ptpGroups, sNMPCommunityString=sNMPCommunityString, remoteIPAddress=remoteIPAddress, phyStatus=phyStatus, sNMPTrapTable=sNMPTrapTable, linkName=linkName, regionCode=regionCode, linkLoss=linkLoss, ptmp=ptmp, configuredModulationMode=configuredModulationMode, radarDetectTrap=radarDetectTrap, timeZone=timeZone, dataPortAutoNegotiation=dataPortAutoNegotiation, phyStatusGroup=phyStatusGroup, iPAddress=iPAddress, notificationsGroup=notificationsGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, installArmStateTrap=installArmStateTrap, versions=versions)
