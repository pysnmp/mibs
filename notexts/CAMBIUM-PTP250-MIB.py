...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", remoteMACAddress=remoteMACAddress, configuredModulationMode=configuredModulationMode, dataPortAutoNegotiation=dataPortAutoNegotiation, nTPLastSync=nTPLastSync, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, channelSelection=channelSelection, licence=licence, sNMPCommunityTableIndex=sNMPCommunityTableIndex, ntp=ntp, signalStrengthRatio=signalStrengthRatio, siteName=siteName, ptmp=ptmp, currentChannel=currentChannel, alarms=alarms, dualPayload=dualPayload, productVariant=productVariant, transmitDataRate=transmitDataRate, PYSNMP_MODULE_ID=cambium, nTPState=nTPState, alarmsGroup=alarmsGroup, linkStatusTrap=linkStatusTrap, pubStatsGroup=pubStatsGroup, antennaGain=antennaGain, nTPServerIp=nTPServerIp, channelBandwidth=channelBandwidth, sNMPTrapTable=sNMPTrapTable, masterSlaveMode=masterSlaveMode, ntpGroup=ntpGroup, phyStatusGroup=phyStatusGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, management=management, ethernet=ethernet, measuredRange=measuredRange, tFTPServerPortNumber=tFTPServerPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tFTPServerIPAddress=tFTPServerIPAddress, gatewayIPAddress=gatewayIPAddress, noiseFloor=noiseFloor, sNMPCommunityTableNumber=sNMPCommunityTableNumber, subnetMask=subnetMask, snmpControl=snmpControl, softwareVersion=softwareVersion, hardwareVersion=hardwareVersion, smtp=smtp, regionCode=regionCode, transmitModulationMode=transmitModulationMode, sMTPServerIPAddress=sMTPServerIPAddress, remoteIPAddress=remoteIPAddress, receiveDataRate=receiveDataRate, productName=productName, managementGroup=managementGroup, nTPServerPortNumber=nTPServerPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapIPAddress=sNMPTrapIPAddress, vlanPriority=vlanPriority, notificationsGroup=notificationsGroup, vlanId=vlanId, radarDetectChannel=radarDetectChannel, ptpTraps=ptpTraps, sMTPServerPortNumber=sMTPServerPortNumber, ptp=ptp, ptp250=ptp250, configuredRange=configuredRange, sNMPTrapCommunity=sNMPTrapCommunity, sNMPCommunityTable=sNMPCommunityTable, sNMPTrapVersion=sNMPTrapVersion, dataPortStatusTrap=dataPortStatusTrap, extendedChannel=extendedChannel, sNMPTrapTableEntry=sNMPTrapTableEntry, installArmState=installArmState, sNMPCommunityString=sNMPCommunityString, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, nTPPollInterval=nTPPollInterval, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernetGroup=ethernetGroup, sNMPCommunityOid=sNMPCommunityOid, sNMPCommunityAccess=sNMPCommunityAccess, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, vectorError=vectorError, band=band, linkLoss=linkLoss, ptpTrapPrefix=ptpTrapPrefix, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, licenceGroup=licenceGroup, currentFreqMHz=currentFreqMHz, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, maximumTransmitPower=maximumTransmitPower, aggregateDataRate=aggregateDataRate, radarDetectTrap=radarDetectTrap, smtpGroup=smtpGroup, configuration=configuration, receiveModulationMode=receiveModulationMode, dataPortStatus=dataPortStatus, cableLoss=cableLoss, nTPSync=nTPSync, cambium=cambium, installArmStateTrap=installArmStateTrap, ptpCompliance=ptpCompliance, wirelessLinkStatus=wirelessLinkStatus, iPAddress=iPAddress, phyStatus=phyStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, versionsGroup=versionsGroup, vlanTagging=vlanTagging, systemClock=systemClock, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, searchState=searchState, timeZone=timeZone, sNMPEnabledTraps=sNMPEnabledTraps, bootVersion=bootVersion, snmpControlGroup=snmpControlGroup, ptpGroups=ptpGroups, linkName=linkName, sMTPEnabledMessages=sMTPEnabledMessages, extendedFreqMHz=extendedFreqMHz, fixedModMode=fixedModMode, versions=versions, pubStats=pubStats, receivePower=receivePower, sNMPCommunityTableEntry=sNMPCommunityTableEntry, transmitPower=transmitPower, configurationGroup=configurationGroup)
