...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", subnetMask=subnetMask, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPCommunityTable=sNMPCommunityTable, linkLoss=linkLoss, sNMPCommunityAccess=sNMPCommunityAccess, nTPPollInterval=nTPPollInterval, bootVersion=bootVersion, nTPLastSync=nTPLastSync, productName=productName, ptmp=ptmp, phyStatusGroup=phyStatusGroup, currentFreqMHz=currentFreqMHz, dataPortStatus=dataPortStatus, tFTPServerPortNumber=tFTPServerPortNumber, sMTPServerPortNumber=sMTPServerPortNumber, sNMPCommunityOid=sNMPCommunityOid, siteName=siteName, configuredModulationMode=configuredModulationMode, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapTableIndex=sNMPTrapTableIndex, remoteMACAddress=remoteMACAddress, ptp=ptp, sNMPTrapVersion=sNMPTrapVersion, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, nTPState=nTPState, sNMPCommunityString=sNMPCommunityString, vlanPriority=vlanPriority, installArmState=installArmState, sNMPTrapCommunity=sNMPTrapCommunity, softwareVersion=softwareVersion, configuration=configuration, smtp=smtp, licence=licence, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, versions=versions, cableLoss=cableLoss, iPAddress=iPAddress, versionsGroup=versionsGroup, radarDetectChannel=radarDetectChannel, ntp=ntp, ptpGroups=ptpGroups, dataPortStatusTrap=dataPortStatusTrap, aggregateDataRate=aggregateDataRate, sNMPTrapTableEntry=sNMPTrapTableEntry, linkStatusTrap=linkStatusTrap, nTPServerPortNumber=nTPServerPortNumber, searchState=searchState, alarmsGroup=alarmsGroup, extendedFreqMHz=extendedFreqMHz, timeZone=timeZone, signalStrengthRatio=signalStrengthRatio, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptpTraps=ptpTraps, ethernet=ethernet, management=management, sMTPServerIPAddress=sMTPServerIPAddress, ptpTrapPrefix=ptpTrapPrefix, fixedModMode=fixedModMode, sNMPTrapPortNumber=sNMPTrapPortNumber, antennaGain=antennaGain, vectorError=vectorError, regionCode=regionCode, sMTPEnabledMessages=sMTPEnabledMessages, systemClock=systemClock, transmitDataRate=transmitDataRate, sNMPCommunityTableIndex=sNMPCommunityTableIndex, cambium=cambium, measuredRange=measuredRange, sMTPSourceEmailAddress=sMTPSourceEmailAddress, phyStatus=phyStatus, extendedChannel=extendedChannel, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, channelBandwidth=channelBandwidth, snmpControl=snmpControl, licenceGroup=licenceGroup, ptp250=ptp250, ptpCompliance=ptpCompliance, sNMPTrapTable=sNMPTrapTable, smtpGroup=smtpGroup, noiseFloor=noiseFloor, dualPayload=dualPayload, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, wirelessLinkStatus=wirelessLinkStatus, snmpControlGroup=snmpControlGroup, installArmStateTrap=installArmStateTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitPower=transmitPower, hardwareVersion=hardwareVersion, pubStats=pubStats, vlanId=vlanId, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPCommunityTableEntry=sNMPCommunityTableEntry, alarms=alarms, configurationGroup=configurationGroup, pubStatsGroup=pubStatsGroup, productVariant=productVariant, transmitModulationMode=transmitModulationMode, receivePower=receivePower, managementGroup=managementGroup, gatewayIPAddress=gatewayIPAddress, masterSlaveMode=masterSlaveMode, currentChannel=currentChannel, ethernetGroup=ethernetGroup, radarDetectTrap=radarDetectTrap, PYSNMP_MODULE_ID=cambium, receiveDataRate=receiveDataRate, sNMPCommunityTableNumber=sNMPCommunityTableNumber, channelSelection=channelSelection, configuredRange=configuredRange, vlanTagging=vlanTagging, notificationsGroup=notificationsGroup, linkName=linkName, receiveModulationMode=receiveModulationMode, maximumTransmitPower=maximumTransmitPower, nTPServerIp=nTPServerIp, remoteIPAddress=remoteIPAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapIPAddress=sNMPTrapIPAddress, ntpGroup=ntpGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPServerIPAddress=tFTPServerIPAddress, nTPSync=nTPSync, band=band)
