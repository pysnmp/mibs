...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sMTPServerIPAddress=sMTPServerIPAddress, dataPortStatus=dataPortStatus, ethernetGroup=ethernetGroup, band=band, linkStatusTrap=linkStatusTrap, snmpControlGroup=snmpControlGroup, siteName=siteName, sNMPCommunityTableNumber=sNMPCommunityTableNumber, ptpGroups=ptpGroups, subnetMask=subnetMask, tFTPServerIPAddress=tFTPServerIPAddress, antennaGain=antennaGain, hardwareVersion=hardwareVersion, sMTPServerPortNumber=sMTPServerPortNumber, remoteMACAddress=remoteMACAddress, tFTPServerPortNumber=tFTPServerPortNumber, nTPPollInterval=nTPPollInterval, versions=versions, nTPServerIp=nTPServerIp, configurationGroup=configurationGroup, sNMPCommunityTableEntry=sNMPCommunityTableEntry, radarDetectChannel=radarDetectChannel, remoteIPAddress=remoteIPAddress, snmpControl=snmpControl, productVariant=productVariant, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ntp=ntp, sNMPTrapTableNumber=sNMPTrapTableNumber, maximumTransmitPower=maximumTransmitPower, vlanTagging=vlanTagging, alarmsGroup=alarmsGroup, searchState=searchState, dataPortAutoNegotiation=dataPortAutoNegotiation, transmitModulationMode=transmitModulationMode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, configuredModulationMode=configuredModulationMode, vectorError=vectorError, radarDetectTrap=radarDetectTrap, masterSlaveMode=masterSlaveMode, linkName=linkName, ptp=ptp, configuration=configuration, sNMPCommunityTable=sNMPCommunityTable, sNMPTrapVersion=sNMPTrapVersion, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, notificationsGroup=notificationsGroup, sNMPCommunityOid=sNMPCommunityOid, receiveModulationMode=receiveModulationMode, smtp=smtp, aggregateDataRate=aggregateDataRate, linkLoss=linkLoss, nTPLastSync=nTPLastSync, ptmp=ptmp, gatewayIPAddress=gatewayIPAddress, dualPayload=dualPayload, phyStatus=phyStatus, ptpTraps=ptpTraps, cambium=cambium, alarms=alarms, measuredRange=measuredRange, pubStats=pubStats, ethernet=ethernet, managementGroup=managementGroup, cableLoss=cableLoss, channelBandwidth=channelBandwidth, smtpGroup=smtpGroup, sMTPEnabledMessages=sMTPEnabledMessages, licence=licence, PYSNMP_MODULE_ID=cambium, currentFreqMHz=currentFreqMHz, installArmStateTrap=installArmStateTrap, sNMPTrapCommunity=sNMPTrapCommunity, transmitDataRate=transmitDataRate, ptp250=ptp250, receivePower=receivePower, nTPSync=nTPSync, pubStatsGroup=pubStatsGroup, installArmState=installArmState, management=management, transmitPower=transmitPower, sNMPCommunityTableIndex=sNMPCommunityTableIndex, wirelessLinkStatus=wirelessLinkStatus, iPAddress=iPAddress, dataPortStatusTrap=dataPortStatusTrap, bootVersion=bootVersion, configuredRange=configuredRange, sNMPCommunityAccess=sNMPCommunityAccess, nTPState=nTPState, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, licenceGroup=licenceGroup, sNMPCommunityString=sNMPCommunityString, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapTable=sNMPTrapTable, currentChannel=currentChannel, vlanPriority=vlanPriority, systemClock=systemClock, receiveDataRate=receiveDataRate, channelSelection=channelSelection, regionCode=regionCode, nTPServerPortNumber=nTPServerPortNumber, signalStrengthRatio=signalStrengthRatio, vlanId=vlanId, sNMPTrapIPAddress=sNMPTrapIPAddress, extendedChannel=extendedChannel, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapPortNumber=sNMPTrapPortNumber, ntpGroup=ntpGroup, fixedModMode=fixedModMode, ptpCompliance=ptpCompliance, sNMPTrapTableIndex=sNMPTrapTableIndex, productName=productName, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, phyStatusGroup=phyStatusGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, extendedFreqMHz=extendedFreqMHz, noiseFloor=noiseFloor, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, versionsGroup=versionsGroup, timeZone=timeZone, softwareVersion=softwareVersion)
