...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", aggregateDataRate=aggregateDataRate, sNMPEnabledTraps=sNMPEnabledTraps, configurationGroup=configurationGroup, extendedFreqMHz=extendedFreqMHz, systemClock=systemClock, gatewayIPAddress=gatewayIPAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, linkName=linkName, sNMPTrapPortNumber=sNMPTrapPortNumber, ptmp=ptmp, dataPortAutoNegotiation=dataPortAutoNegotiation, radarDetectChannel=radarDetectChannel, licence=licence, versions=versions, nTPState=nTPState, transmitModulationMode=transmitModulationMode, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sNMPTrapTable=sNMPTrapTable, sMTPServerIPAddress=sMTPServerIPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, PYSNMP_MODULE_ID=cambium, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapTableNumber=sNMPTrapTableNumber, remoteMACAddress=remoteMACAddress, productVariant=productVariant, transmitPower=transmitPower, ethernet=ethernet, softwareVersion=softwareVersion, ptp=ptp, vlanTagging=vlanTagging, band=band, nTPSync=nTPSync, sMTPServerPortNumber=sMTPServerPortNumber, sNMPCommunityString=sNMPCommunityString, snmpControlGroup=snmpControlGroup, installArmStateTrap=installArmStateTrap, pubStats=pubStats, smtp=smtp, siteName=siteName, measuredRange=measuredRange, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, currentChannel=currentChannel, channelSelection=channelSelection, versionsGroup=versionsGroup, sNMPCommunityOid=sNMPCommunityOid, antennaGain=antennaGain, installArmState=installArmState, hardwareVersion=hardwareVersion, sNMPTrapIPAddress=sNMPTrapIPAddress, cableLoss=cableLoss, radarDetectTrap=radarDetectTrap, smtpGroup=smtpGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, linkStatusTrap=linkStatusTrap, alarmsGroup=alarmsGroup, licenceGroup=licenceGroup, notificationsGroup=notificationsGroup, ethernetGroup=ethernetGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapVersion=sNMPTrapVersion, configuredRange=configuredRange, vlanId=vlanId, dataPortStatusTrap=dataPortStatusTrap, cambium=cambium, sNMPTrapTableIndex=sNMPTrapTableIndex, alarms=alarms, regionCode=regionCode, maximumTransmitPower=maximumTransmitPower, configuredModulationMode=configuredModulationMode, receivePower=receivePower, sNMPCommunityTableEntry=sNMPCommunityTableEntry, iPAddress=iPAddress, pubStatsGroup=pubStatsGroup, vectorError=vectorError, snmpControl=snmpControl, noiseFloor=noiseFloor, vlanPriority=vlanPriority, nTPPollInterval=nTPPollInterval, phyStatus=phyStatus, nTPServerIp=nTPServerIp, extendedChannel=extendedChannel, ptp250=ptp250, ptpTraps=ptpTraps, sNMPCommunityTableNumber=sNMPCommunityTableNumber, management=management, nTPServerPortNumber=nTPServerPortNumber, transmitDataRate=transmitDataRate, dualPayload=dualPayload, timeZone=timeZone, ptpGroups=ptpGroups, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPCommunityAccess=sNMPCommunityAccess, sNMPTrapCommunity=sNMPTrapCommunity, sMTPEnabledMessages=sMTPEnabledMessages, channelBandwidth=channelBandwidth, bootVersion=bootVersion, receiveDataRate=receiveDataRate, ntpGroup=ntpGroup, managementGroup=managementGroup, ptpCompliance=ptpCompliance, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, nTPLastSync=nTPLastSync, currentFreqMHz=currentFreqMHz, dataPortStatus=dataPortStatus, configuration=configuration, sNMPCommunityTable=sNMPCommunityTable, remoteIPAddress=remoteIPAddress, fixedModMode=fixedModMode, productName=productName, signalStrengthRatio=signalStrengthRatio, phyStatusGroup=phyStatusGroup, subnetMask=subnetMask, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPServerPortNumber=tFTPServerPortNumber, linkLoss=linkLoss, searchState=searchState, ntp=ntp, masterSlaveMode=masterSlaveMode, receiveModulationMode=receiveModulationMode, wirelessLinkStatus=wirelessLinkStatus)
