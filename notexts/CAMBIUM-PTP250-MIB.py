...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", signalStrengthRatio=signalStrengthRatio, sNMPCommunityOid=sNMPCommunityOid, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPCommunityTableNumber=sNMPCommunityTableNumber, productVariant=productVariant, transmitDataRate=transmitDataRate, alarmsGroup=alarmsGroup, configuredRange=configuredRange, smtp=smtp, extendedFreqMHz=extendedFreqMHz, nTPServerIp=nTPServerIp, nTPPollInterval=nTPPollInterval, bootVersion=bootVersion, sNMPTrapCommunity=sNMPTrapCommunity, versionsGroup=versionsGroup, ethernetGroup=ethernetGroup, sNMPCommunityTableEntry=sNMPCommunityTableEntry, tFTPServerIPAddress=tFTPServerIPAddress, ptpGroups=ptpGroups, ptp250=ptp250, subnetMask=subnetMask, productName=productName, managementGroup=managementGroup, sMTPServerIPAddress=sMTPServerIPAddress, extendedChannel=extendedChannel, sNMPTrapTableEntry=sNMPTrapTableEntry, noiseFloor=noiseFloor, dataPortStatus=dataPortStatus, softwareVersion=softwareVersion, pubStatsGroup=pubStatsGroup, antennaGain=antennaGain, receiveModulationMode=receiveModulationMode, sNMPCommunityTable=sNMPCommunityTable, channelSelection=channelSelection, ethernet=ethernet, cableLoss=cableLoss, maximumTransmitPower=maximumTransmitPower, sNMPEnabledTraps=sNMPEnabledTraps, alarms=alarms, management=management, notificationsGroup=notificationsGroup, installArmState=installArmState, licenceGroup=licenceGroup, sNMPCommunityString=sNMPCommunityString, remoteIPAddress=remoteIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dualPayload=dualPayload, configuration=configuration, band=band, transmitModulationMode=transmitModulationMode, licence=licence, linkName=linkName, cambium=cambium, iPAddress=iPAddress, ntp=ntp, ptmp=ptmp, vlanId=vlanId, nTPLastSync=nTPLastSync, sNMPCommunityAccess=sNMPCommunityAccess, PYSNMP_MODULE_ID=cambium, ptpTraps=ptpTraps, fixedModMode=fixedModMode, masterSlaveMode=masterSlaveMode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, measuredRange=measuredRange, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, snmpControl=snmpControl, nTPServerPortNumber=nTPServerPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, gatewayIPAddress=gatewayIPAddress, receivePower=receivePower, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptpTrapPrefix=ptpTrapPrefix, vlanPriority=vlanPriority, linkStatusTrap=linkStatusTrap, phyStatusGroup=phyStatusGroup, configurationGroup=configurationGroup, installArmStateTrap=installArmStateTrap, nTPSync=nTPSync, tFTPServerPortNumber=tFTPServerPortNumber, snmpControlGroup=snmpControlGroup, ntpGroup=ntpGroup, dataPortStatusTrap=dataPortStatusTrap, remoteMACAddress=remoteMACAddress, ptpCompliance=ptpCompliance, searchState=searchState, receiveDataRate=receiveDataRate, aggregateDataRate=aggregateDataRate, vectorError=vectorError, sNMPTrapTableIndex=sNMPTrapTableIndex, pubStats=pubStats, regionCode=regionCode, sNMPTrapTable=sNMPTrapTable, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, transmitPower=transmitPower, linkLoss=linkLoss, sMTPServerPortNumber=sMTPServerPortNumber, phyStatus=phyStatus, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapPortNumber=sNMPTrapPortNumber, configuredModulationMode=configuredModulationMode, systemClock=systemClock, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, currentFreqMHz=currentFreqMHz, nTPState=nTPState, sNMPCommunityTableIndex=sNMPCommunityTableIndex, versions=versions, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, smtpGroup=smtpGroup, radarDetectTrap=radarDetectTrap, radarDetectChannel=radarDetectChannel, channelBandwidth=channelBandwidth, sNMPTrapIPAddress=sNMPTrapIPAddress, wirelessLinkStatus=wirelessLinkStatus, vlanTagging=vlanTagging, noWirelessChannelAvailable=noWirelessChannelAvailable, hardwareVersion=hardwareVersion, currentChannel=currentChannel, ptp=ptp, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, siteName=siteName, timeZone=timeZone)
