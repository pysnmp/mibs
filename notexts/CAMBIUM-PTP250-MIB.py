...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", noWirelessChannelAvailable=noWirelessChannelAvailable, nTPPollInterval=nTPPollInterval, vlanTagging=vlanTagging, smtpGroup=smtpGroup, signalStrengthRatio=signalStrengthRatio, sNMPEnabledTraps=sNMPEnabledTraps, softwareVersion=softwareVersion, sNMPCommunityTableEntry=sNMPCommunityTableEntry, remoteIPAddress=remoteIPAddress, nTPLastSync=nTPLastSync, ptp250=ptp250, receivePower=receivePower, band=band, phyStatusGroup=phyStatusGroup, bootVersion=bootVersion, sNMPTrapTableEntry=sNMPTrapTableEntry, configuredRange=configuredRange, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPCommunityString=sNMPCommunityString, alarmsGroup=alarmsGroup, snmpControlGroup=snmpControlGroup, PYSNMP_MODULE_ID=cambium, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, channelSelection=channelSelection, alarms=alarms, vectorError=vectorError, ntp=ntp, measuredRange=measuredRange, sNMPCommunityOid=sNMPCommunityOid, sNMPTrapCommunity=sNMPTrapCommunity, linkStatusTrap=linkStatusTrap, licenceGroup=licenceGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkName=linkName, nTPSync=nTPSync, ptpTrapPrefix=ptpTrapPrefix, antennaGain=antennaGain, nTPState=nTPState, systemClock=systemClock, configurationGroup=configurationGroup, masterSlaveMode=masterSlaveMode, versions=versions, sMTPSourceEmailAddress=sMTPSourceEmailAddress, installArmStateTrap=installArmStateTrap, sNMPCommunityTableIndex=sNMPCommunityTableIndex, channelBandwidth=channelBandwidth, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, currentChannel=currentChannel, cambium=cambium, cableLoss=cableLoss, regionCode=regionCode, siteName=siteName, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitModulationMode=transmitModulationMode, dataPortStatus=dataPortStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, receiveModulationMode=receiveModulationMode, sNMPTrapVersion=sNMPTrapVersion, fixedModMode=fixedModMode, sMTPEnabledMessages=sMTPEnabledMessages, wirelessLinkStatus=wirelessLinkStatus, configuredModulationMode=configuredModulationMode, productName=productName, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, transmitDataRate=transmitDataRate, timeZone=timeZone, currentFreqMHz=currentFreqMHz, configuration=configuration, noiseFloor=noiseFloor, extendedChannel=extendedChannel, smtp=smtp, installArmState=installArmState, licence=licence, phyStatus=phyStatus, transmitPower=transmitPower, searchState=searchState, ptpTraps=ptpTraps, remoteMACAddress=remoteMACAddress, aggregateDataRate=aggregateDataRate, snmpControl=snmpControl, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPTrapTable=sNMPTrapTable, tFTPServerIPAddress=tFTPServerIPAddress, dataPortStatusTrap=dataPortStatusTrap, sMTPServerPortNumber=sMTPServerPortNumber, gatewayIPAddress=gatewayIPAddress, receiveDataRate=receiveDataRate, sNMPCommunityTableNumber=sNMPCommunityTableNumber, vlanId=vlanId, linkLoss=linkLoss, ethernet=ethernet, versionsGroup=versionsGroup, dualPayload=dualPayload, sNMPCommunityTable=sNMPCommunityTable, radarDetectChannel=radarDetectChannel, management=management, managementGroup=managementGroup, subnetMask=subnetMask, ptp=ptp, hardwareVersion=hardwareVersion, sNMPCommunityAccess=sNMPCommunityAccess, productVariant=productVariant, ptpGroups=ptpGroups, sNMPTrapIPAddress=sNMPTrapIPAddress, nTPServerPortNumber=nTPServerPortNumber, extendedFreqMHz=extendedFreqMHz, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ethernetGroup=ethernetGroup, iPAddress=iPAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, vlanPriority=vlanPriority, ptpCompliance=ptpCompliance, nTPServerIp=nTPServerIp, pubStatsGroup=pubStatsGroup, sMTPServerIPAddress=sMTPServerIPAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, maximumTransmitPower=maximumTransmitPower, pubStats=pubStats, ntpGroup=ntpGroup, notificationsGroup=notificationsGroup, ptmp=ptmp, radarDetectTrap=radarDetectTrap)
