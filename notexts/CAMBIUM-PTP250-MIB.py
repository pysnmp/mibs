...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", configurationGroup=configurationGroup, dataPortStatusTrap=dataPortStatusTrap, vlanPriority=vlanPriority, ptpTrapPrefix=ptpTrapPrefix, tFTPServerIPAddress=tFTPServerIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, radarDetectTrap=radarDetectTrap, phyStatus=phyStatus, vlanTagging=vlanTagging, sMTPServerPortNumber=sMTPServerPortNumber, sNMPCommunityString=sNMPCommunityString, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, nTPServerPortNumber=nTPServerPortNumber, licenceGroup=licenceGroup, configuredModulationMode=configuredModulationMode, noWirelessChannelAvailable=noWirelessChannelAvailable, pubStats=pubStats, installArmStateTrap=installArmStateTrap, ptp250=ptp250, nTPState=nTPState, configuration=configuration, phyStatusGroup=phyStatusGroup, versions=versions, signalStrengthRatio=signalStrengthRatio, bootVersion=bootVersion, smtpGroup=smtpGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sMTPServerIPAddress=sMTPServerIPAddress, searchState=searchState, ntpGroup=ntpGroup, softwareVersion=softwareVersion, ptpCompliance=ptpCompliance, extendedFreqMHz=extendedFreqMHz, licence=licence, ethernetGroup=ethernetGroup, radarDetectChannel=radarDetectChannel, nTPSync=nTPSync, snmpControl=snmpControl, snmpControlGroup=snmpControlGroup, noiseFloor=noiseFloor, sNMPTrapIPAddress=sNMPTrapIPAddress, ethernet=ethernet, sNMPCommunityTableIndex=sNMPCommunityTableIndex, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, receiveDataRate=receiveDataRate, alarmsGroup=alarmsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPCommunityTableNumber=sNMPCommunityTableNumber, cableLoss=cableLoss, fixedModMode=fixedModMode, sNMPEnabledTraps=sNMPEnabledTraps, receivePower=receivePower, timeZone=timeZone, management=management, productName=productName, tFTPServerPortNumber=tFTPServerPortNumber, subnetMask=subnetMask, sNMPTrapTableNumber=sNMPTrapTableNumber, nTPPollInterval=nTPPollInterval, sNMPTrapVersion=sNMPTrapVersion, transmitPower=transmitPower, channelBandwidth=channelBandwidth, transmitModulationMode=transmitModulationMode, iPAddress=iPAddress, sMTPEnabledMessages=sMTPEnabledMessages, antennaGain=antennaGain, receiveModulationMode=receiveModulationMode, installArmState=installArmState, wirelessLinkStatus=wirelessLinkStatus, remoteIPAddress=remoteIPAddress, ntp=ntp, gatewayIPAddress=gatewayIPAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPCommunityTableEntry=sNMPCommunityTableEntry, smtp=smtp, measuredRange=measuredRange, ptmp=ptmp, currentFreqMHz=currentFreqMHz, ptpTraps=ptpTraps, linkStatusTrap=linkStatusTrap, versionsGroup=versionsGroup, sNMPTrapCommunity=sNMPTrapCommunity, configuredRange=configuredRange, remoteMACAddress=remoteMACAddress, dualPayload=dualPayload, vectorError=vectorError, band=band, nTPServerIp=nTPServerIp, channelSelection=channelSelection, aggregateDataRate=aggregateDataRate, PYSNMP_MODULE_ID=cambium, ptp=ptp, maximumTransmitPower=maximumTransmitPower, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapTable=sNMPTrapTable, vlanId=vlanId, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, productVariant=productVariant, regionCode=regionCode, cambium=cambium, sNMPTrapTableIndex=sNMPTrapTableIndex, masterSlaveMode=masterSlaveMode, extendedChannel=extendedChannel, systemClock=systemClock, sNMPCommunityOid=sNMPCommunityOid, alarms=alarms, linkLoss=linkLoss, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transmitDataRate=transmitDataRate, currentChannel=currentChannel, sNMPCommunityTable=sNMPCommunityTable, siteName=siteName, hardwareVersion=hardwareVersion, ptpGroups=ptpGroups, nTPLastSync=nTPLastSync, notificationsGroup=notificationsGroup, managementGroup=managementGroup, linkName=linkName, dataPortStatus=dataPortStatus, sNMPCommunityAccess=sNMPCommunityAccess, pubStatsGroup=pubStatsGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus)
