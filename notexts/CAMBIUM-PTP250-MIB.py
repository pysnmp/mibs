...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, transmitModulationMode=transmitModulationMode, sNMPEnabledTraps=sNMPEnabledTraps, management=management, hardwareVersion=hardwareVersion, iPAddress=iPAddress, currentChannel=currentChannel, sMTPServerPortNumber=sMTPServerPortNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, ntp=ntp, dataPortStatus=dataPortStatus, snmpControl=snmpControl, linkStatusTrap=linkStatusTrap, timeZone=timeZone, PYSNMP_MODULE_ID=cambium, ethernet=ethernet, radarDetectChannel=radarDetectChannel, nTPSync=nTPSync, configuredModulationMode=configuredModulationMode, siteName=siteName, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortStatusTrap=dataPortStatusTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, phyStatus=phyStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, versionsGroup=versionsGroup, snmpControlGroup=snmpControlGroup, searchState=searchState, sNMPTrapPortNumber=sNMPTrapPortNumber, linkName=linkName, aggregateDataRate=aggregateDataRate, nTPLastSync=nTPLastSync, nTPState=nTPState, wirelessLinkStatus=wirelessLinkStatus, ptpGroups=ptpGroups, ptpTrapPrefix=ptpTrapPrefix, nTPServerIp=nTPServerIp, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ntpGroup=ntpGroup, radarDetectTrap=radarDetectTrap, installArmState=installArmState, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, managementGroup=managementGroup, sNMPCommunityTableIndex=sNMPCommunityTableIndex, productName=productName, sNMPTrapCommunity=sNMPTrapCommunity, alarmsGroup=alarmsGroup, licence=licence, cableLoss=cableLoss, sNMPCommunityTableNumber=sNMPCommunityTableNumber, configurationGroup=configurationGroup, licenceGroup=licenceGroup, smtpGroup=smtpGroup, band=band, tFTPServerPortNumber=tFTPServerPortNumber, receiveModulationMode=receiveModulationMode, receivePower=receivePower, tFTPServerIPAddress=tFTPServerIPAddress, vlanId=vlanId, sMTPEnabledMessages=sMTPEnabledMessages, pubStats=pubStats, gatewayIPAddress=gatewayIPAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, nTPPollInterval=nTPPollInterval, softwareVersion=softwareVersion, subnetMask=subnetMask, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, bootVersion=bootVersion, remoteIPAddress=remoteIPAddress, notificationsGroup=notificationsGroup, vectorError=vectorError, productVariant=productVariant, transmitDataRate=transmitDataRate, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, versions=versions, sNMPCommunityString=sNMPCommunityString, systemClock=systemClock, measuredRange=measuredRange, ptpCompliance=ptpCompliance, sNMPCommunityTableEntry=sNMPCommunityTableEntry, receiveDataRate=receiveDataRate, configuration=configuration, ptp250=ptp250, vlanTagging=vlanTagging, antennaGain=antennaGain, linkLoss=linkLoss, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapVersion=sNMPTrapVersion, ptp=ptp, signalStrengthRatio=signalStrengthRatio, maximumTransmitPower=maximumTransmitPower, extendedChannel=extendedChannel, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, masterSlaveMode=masterSlaveMode, ethernetGroup=ethernetGroup, cambium=cambium, smtp=smtp, installArmStateTrap=installArmStateTrap, phyStatusGroup=phyStatusGroup, ptmp=ptmp, extendedFreqMHz=extendedFreqMHz, channelSelection=channelSelection, dualPayload=dualPayload, vlanPriority=vlanPriority, sMTPSourceEmailAddress=sMTPSourceEmailAddress, channelBandwidth=channelBandwidth, alarms=alarms, noiseFloor=noiseFloor, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, transmitPower=transmitPower, remoteMACAddress=remoteMACAddress, regionCode=regionCode, sNMPCommunityAccess=sNMPCommunityAccess, configuredRange=configuredRange, fixedModMode=fixedModMode, sNMPTrapTable=sNMPTrapTable, nTPServerPortNumber=nTPServerPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPCommunityTable=sNMPCommunityTable, pubStatsGroup=pubStatsGroup, sNMPCommunityOid=sNMPCommunityOid, sNMPTrapTableNumber=sNMPTrapTableNumber, currentFreqMHz=currentFreqMHz, ptpTraps=ptpTraps)
