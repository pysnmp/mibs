...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", receivePower=receivePower, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, receiveModulationMode=receiveModulationMode, currentFreqMHz=currentFreqMHz, vlanId=vlanId, nTPPollInterval=nTPPollInterval, extendedChannel=extendedChannel, hardwareVersion=hardwareVersion, vlanPriority=vlanPriority, tFTPServerIPAddress=tFTPServerIPAddress, vectorError=vectorError, channelSelection=channelSelection, gatewayIPAddress=gatewayIPAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapCommunity=sNMPTrapCommunity, extendedFreqMHz=extendedFreqMHz, dualPayload=dualPayload, sNMPTrapTable=sNMPTrapTable, systemClock=systemClock, licence=licence, ptmp=ptmp, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, versionsGroup=versionsGroup, pubStatsGroup=pubStatsGroup, snmpControl=snmpControl, linkName=linkName, sNMPCommunityTableIndex=sNMPCommunityTableIndex, pubStats=pubStats, wirelessLinkStatus=wirelessLinkStatus, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, searchState=searchState, ptp250=ptp250, sNMPEnabledTraps=sNMPEnabledTraps, ptpTraps=ptpTraps, versions=versions, signalStrengthRatio=signalStrengthRatio, sMTPServerPortNumber=sMTPServerPortNumber, nTPLastSync=nTPLastSync, remoteMACAddress=remoteMACAddress, installArmStateTrap=installArmStateTrap, dataPortStatus=dataPortStatus, smtpGroup=smtpGroup, phyStatus=phyStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, transmitModulationMode=transmitModulationMode, vlanTagging=vlanTagging, bootVersion=bootVersion, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, alarms=alarms, cambium=cambium, transmitDataRate=transmitDataRate, productVariant=productVariant, currentChannel=currentChannel, sMTPServerIPAddress=sMTPServerIPAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, alarmsGroup=alarmsGroup, phyStatusGroup=phyStatusGroup, receiveDataRate=receiveDataRate, sNMPCommunityString=sNMPCommunityString, masterSlaveMode=masterSlaveMode, band=band, regionCode=regionCode, sNMPCommunityTableNumber=sNMPCommunityTableNumber, configuredRange=configuredRange, sNMPTrapTableEntry=sNMPTrapTableEntry, siteName=siteName, cableLoss=cableLoss, linkStatusTrap=linkStatusTrap, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapTableNumber=sNMPTrapTableNumber, nTPServerPortNumber=nTPServerPortNumber, measuredRange=measuredRange, ntp=ntp, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, nTPState=nTPState, softwareVersion=softwareVersion, radarDetectTrap=radarDetectTrap, ptpGroups=ptpGroups, ethernet=ethernet, ptpCompliance=ptpCompliance, sNMPCommunityOid=sNMPCommunityOid, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ptpTrapPrefix=ptpTrapPrefix, ntpGroup=ntpGroup, sNMPCommunityAccess=sNMPCommunityAccess, nTPSync=nTPSync, timeZone=timeZone, dataPortStatusTrap=dataPortStatusTrap, iPAddress=iPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkLoss=linkLoss, dataPortAutoNegotiation=dataPortAutoNegotiation, fixedModMode=fixedModMode, productName=productName, ethernetGroup=ethernetGroup, configuredModulationMode=configuredModulationMode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, subnetMask=subnetMask, ptp=ptp, PYSNMP_MODULE_ID=cambium, licenceGroup=licenceGroup, notificationsGroup=notificationsGroup, sNMPCommunityTableEntry=sNMPCommunityTableEntry, noiseFloor=noiseFloor, smtp=smtp, sNMPCommunityTable=sNMPCommunityTable, managementGroup=managementGroup, remoteIPAddress=remoteIPAddress, radarDetectChannel=radarDetectChannel, sMTPEnabledMessages=sMTPEnabledMessages, configurationGroup=configurationGroup, tFTPServerPortNumber=tFTPServerPortNumber, nTPServerIp=nTPServerIp, maximumTransmitPower=maximumTransmitPower, management=management, channelBandwidth=channelBandwidth, aggregateDataRate=aggregateDataRate, snmpControlGroup=snmpControlGroup, configuration=configuration, antennaGain=antennaGain, installArmState=installArmState, transmitPower=transmitPower, sNMPTrapTableIndex=sNMPTrapTableIndex)
