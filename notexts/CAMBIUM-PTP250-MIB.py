...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", noiseFloor=noiseFloor, nTPSync=nTPSync, snmpControl=snmpControl, phyStatusGroup=phyStatusGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, hardwareVersion=hardwareVersion, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, remoteIPAddress=remoteIPAddress, ptpCompliance=ptpCompliance, ethernetGroup=ethernetGroup, ntp=ntp, band=band, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, ntpGroup=ntpGroup, alarmsGroup=alarmsGroup, receiveDataRate=receiveDataRate, channelSelection=channelSelection, pubStatsGroup=pubStatsGroup, channelBandwidth=channelBandwidth, transmitModulationMode=transmitModulationMode, timeZone=timeZone, alarms=alarms, tFTPServerIPAddress=tFTPServerIPAddress, configuration=configuration, sNMPCommunityOid=sNMPCommunityOid, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, installArmState=installArmState, installArmStateTrap=installArmStateTrap, receivePower=receivePower, notificationsGroup=notificationsGroup, bootVersion=bootVersion, management=management, dualPayload=dualPayload, ptpTraps=ptpTraps, licenceGroup=licenceGroup, remoteMACAddress=remoteMACAddress, receiveModulationMode=receiveModulationMode, systemClock=systemClock, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapTableIndex=sNMPTrapTableIndex, vlanId=vlanId, snmpControlGroup=snmpControlGroup, sNMPTrapTable=sNMPTrapTable, versions=versions, signalStrengthRatio=signalStrengthRatio, softwareVersion=softwareVersion, ptpTrapPrefix=ptpTrapPrefix, linkLoss=linkLoss, sNMPCommunityAccess=sNMPCommunityAccess, productName=productName, sNMPCommunityString=sNMPCommunityString, sNMPEnabledTraps=sNMPEnabledTraps, antennaGain=antennaGain, vectorError=vectorError, nTPServerIp=nTPServerIp, ptp=ptp, regionCode=regionCode, iPAddress=iPAddress, sNMPCommunityTableEntry=sNMPCommunityTableEntry, searchState=searchState, aggregateDataRate=aggregateDataRate, productVariant=productVariant, radarDetectChannel=radarDetectChannel, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, smtp=smtp, vlanPriority=vlanPriority, ptp250=ptp250, sNMPCommunityTable=sNMPCommunityTable, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, configurationGroup=configurationGroup, sNMPCommunityTableNumber=sNMPCommunityTableNumber, masterSlaveMode=masterSlaveMode, phyStatus=phyStatus, transmitPower=transmitPower, subnetMask=subnetMask, gatewayIPAddress=gatewayIPAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, transmitDataRate=transmitDataRate, radarDetectTrap=radarDetectTrap, managementGroup=managementGroup, measuredRange=measuredRange, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, nTPLastSync=nTPLastSync, linkName=linkName, cambium=cambium, ethernet=ethernet, linkStatusTrap=linkStatusTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, extendedChannel=extendedChannel, nTPServerPortNumber=nTPServerPortNumber, ptpGroups=ptpGroups, configuredModulationMode=configuredModulationMode, smtpGroup=smtpGroup, cableLoss=cableLoss, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPCommunityTableIndex=sNMPCommunityTableIndex, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, licence=licence, dataPortStatusTrap=dataPortStatusTrap, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, sMTPServerIPAddress=sMTPServerIPAddress, versionsGroup=versionsGroup, maximumTransmitPower=maximumTransmitPower, wirelessLinkStatus=wirelessLinkStatus, sNMPTrapCommunity=sNMPTrapCommunity, ptmp=ptmp, siteName=siteName, sNMPTrapVersion=sNMPTrapVersion, currentFreqMHz=currentFreqMHz, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortStatus=dataPortStatus, fixedModMode=fixedModMode, nTPPollInterval=nTPPollInterval, nTPState=nTPState, extendedFreqMHz=extendedFreqMHz, PYSNMP_MODULE_ID=cambium, currentChannel=currentChannel, pubStats=pubStats, configuredRange=configuredRange, vlanTagging=vlanTagging, tFTPServerPortNumber=tFTPServerPortNumber)
