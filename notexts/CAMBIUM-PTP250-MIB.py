...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", phyStatus=phyStatus, ptp=ptp, remoteIPAddress=remoteIPAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, receiveDataRate=receiveDataRate, timeZone=timeZone, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, hardwareVersion=hardwareVersion, sMTPServerPortNumber=sMTPServerPortNumber, sNMPCommunityString=sNMPCommunityString, alarmsGroup=alarmsGroup, cambium=cambium, gatewayIPAddress=gatewayIPAddress, transmitPower=transmitPower, radarDetectChannel=radarDetectChannel, ptmp=ptmp, regionCode=regionCode, ptpTraps=ptpTraps, snmpControl=snmpControl, snmpControlGroup=snmpControlGroup, tFTPServerPortNumber=tFTPServerPortNumber, dualPayload=dualPayload, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapCommunity=sNMPTrapCommunity, noiseFloor=noiseFloor, ptp250=ptp250, nTPLastSync=nTPLastSync, productVariant=productVariant, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, measuredRange=measuredRange, sNMPTrapTableNumber=sNMPTrapTableNumber, pubStatsGroup=pubStatsGroup, antennaGain=antennaGain, sNMPCommunityAccess=sNMPCommunityAccess, extendedChannel=extendedChannel, alarms=alarms, licenceGroup=licenceGroup, iPAddress=iPAddress, fixedModMode=fixedModMode, extendedFreqMHz=extendedFreqMHz, nTPServerIp=nTPServerIp, phyStatusGroup=phyStatusGroup, vlanPriority=vlanPriority, configuredRange=configuredRange, aggregateDataRate=aggregateDataRate, sNMPTrapIPAddress=sNMPTrapIPAddress, ethernetGroup=ethernetGroup, searchState=searchState, licence=licence, ntpGroup=ntpGroup, ptpTrapPrefix=ptpTrapPrefix, radarDetectTrap=radarDetectTrap, maximumTransmitPower=maximumTransmitPower, PYSNMP_MODULE_ID=cambium, sNMPTrapTableEntry=sNMPTrapTableEntry, band=band, subnetMask=subnetMask, linkName=linkName, configuredModulationMode=configuredModulationMode, installArmState=installArmState, softwareVersion=softwareVersion, vlanId=vlanId, versions=versions, versionsGroup=versionsGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, management=management, channelSelection=channelSelection, cableLoss=cableLoss, currentFreqMHz=currentFreqMHz, signalStrengthRatio=signalStrengthRatio, nTPPollInterval=nTPPollInterval, ethernet=ethernet, ptpCompliance=ptpCompliance, productName=productName, tFTPServerIPAddress=tFTPServerIPAddress, receiveModulationMode=receiveModulationMode, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sNMPTrapPortNumber=sNMPTrapPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, configuration=configuration, configurationGroup=configurationGroup, ntp=ntp, nTPServerPortNumber=nTPServerPortNumber, installArmStateTrap=installArmStateTrap, sNMPCommunityOid=sNMPCommunityOid, sNMPTrapTableIndex=sNMPTrapTableIndex, nTPState=nTPState, systemClock=systemClock, vlanTagging=vlanTagging, transmitDataRate=transmitDataRate, pubStats=pubStats, sNMPCommunityTable=sNMPCommunityTable, remoteMACAddress=remoteMACAddress, managementGroup=managementGroup, transmitModulationMode=transmitModulationMode, sNMPCommunityTableNumber=sNMPCommunityTableNumber, ptpGroups=ptpGroups, linkStatusTrap=linkStatusTrap, bootVersion=bootVersion, wirelessLinkStatus=wirelessLinkStatus, dataPortStatus=dataPortStatus, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPTrapTable=sNMPTrapTable, receivePower=receivePower, smtpGroup=smtpGroup, dataPortStatusTrap=dataPortStatusTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sMTPServerIPAddress=sMTPServerIPAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, currentChannel=currentChannel, sNMPEnabledTraps=sNMPEnabledTraps, siteName=siteName, nTPSync=nTPSync, smtp=smtp, sNMPTrapVersion=sNMPTrapVersion, notificationsGroup=notificationsGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPCommunityTableEntry=sNMPCommunityTableEntry, channelBandwidth=channelBandwidth, linkLoss=linkLoss, masterSlaveMode=masterSlaveMode, vectorError=vectorError)
