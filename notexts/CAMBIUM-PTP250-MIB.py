...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", linkName=linkName, maximumTransmitPower=maximumTransmitPower, linkLoss=linkLoss, vlanId=vlanId, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPEnabledTraps=sNMPEnabledTraps, radarDetectChannel=radarDetectChannel, sNMPTrapTableNumber=sNMPTrapTableNumber, aggregateDataRate=aggregateDataRate, transmitDataRate=transmitDataRate, radarDetectTrap=radarDetectTrap, sNMPCommunityAccess=sNMPCommunityAccess, ntp=ntp, nTPLastSync=nTPLastSync, vlanTagging=vlanTagging, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vectorError=vectorError, measuredRange=measuredRange, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, fixedModMode=fixedModMode, siteName=siteName, sNMPCommunityTableIndex=sNMPCommunityTableIndex, cambium=cambium, snmpControl=snmpControl, nTPPollInterval=nTPPollInterval, band=band, remoteIPAddress=remoteIPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, configuredRange=configuredRange, channelBandwidth=channelBandwidth, dataPortStatusTrap=dataPortStatusTrap, productVariant=productVariant, ptp250=ptp250, sNMPCommunityTable=sNMPCommunityTable, currentFreqMHz=currentFreqMHz, currentChannel=currentChannel, receiveDataRate=receiveDataRate, licenceGroup=licenceGroup, sNMPCommunityString=sNMPCommunityString, phyStatus=phyStatus, ethernetGroup=ethernetGroup, tFTPServerIPAddress=tFTPServerIPAddress, PYSNMP_MODULE_ID=cambium, smtpGroup=smtpGroup, remoteMACAddress=remoteMACAddress, sNMPTrapVersion=sNMPTrapVersion, noWirelessChannelAvailable=noWirelessChannelAvailable, installArmState=installArmState, sNMPTrapPortNumber=sNMPTrapPortNumber, regionCode=regionCode, configurationGroup=configurationGroup, productName=productName, searchState=searchState, sNMPCommunityOid=sNMPCommunityOid, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapIPAddress=sNMPTrapIPAddress, gatewayIPAddress=gatewayIPAddress, ptmp=ptmp, ptpTraps=ptpTraps, noiseFloor=noiseFloor, nTPServerPortNumber=nTPServerPortNumber, configuration=configuration, pubStats=pubStats, transmitPower=transmitPower, versionsGroup=versionsGroup, ptpGroups=ptpGroups, sNMPTrapCommunity=sNMPTrapCommunity, ethernet=ethernet, systemClock=systemClock, softwareVersion=softwareVersion, bootVersion=bootVersion, subnetMask=subnetMask, versions=versions, configuredModulationMode=configuredModulationMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, signalStrengthRatio=signalStrengthRatio, sNMPCommunityTableNumber=sNMPCommunityTableNumber, ntpGroup=ntpGroup, nTPServerIp=nTPServerIp, sMTPServerIPAddress=sMTPServerIPAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, pubStatsGroup=pubStatsGroup, iPAddress=iPAddress, receiveModulationMode=receiveModulationMode, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, alarmsGroup=alarmsGroup, channelSelection=channelSelection, antennaGain=antennaGain, ptpTrapPrefix=ptpTrapPrefix, installArmStateTrap=installArmStateTrap, wirelessLinkStatus=wirelessLinkStatus, hardwareVersion=hardwareVersion, tFTPServerPortNumber=tFTPServerPortNumber, dataPortStatus=dataPortStatus, sMTPEnabledMessages=sMTPEnabledMessages, extendedFreqMHz=extendedFreqMHz, ptpCompliance=ptpCompliance, sNMPTrapTable=sNMPTrapTable, alarms=alarms, sNMPTrapTableIndex=sNMPTrapTableIndex, phyStatusGroup=phyStatusGroup, smtp=smtp, licence=licence, nTPState=nTPState, ptp=ptp, management=management, transmitModulationMode=transmitModulationMode, nTPSync=nTPSync, cableLoss=cableLoss, sMTPServerPortNumber=sMTPServerPortNumber, linkStatusTrap=linkStatusTrap, vlanPriority=vlanPriority, snmpControlGroup=snmpControlGroup, dualPayload=dualPayload, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receivePower=receivePower, timeZone=timeZone, notificationsGroup=notificationsGroup, masterSlaveMode=masterSlaveMode, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPCommunityTableEntry=sNMPCommunityTableEntry, managementGroup=managementGroup, extendedChannel=extendedChannel)
