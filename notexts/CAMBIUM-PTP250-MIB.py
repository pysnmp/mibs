...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", currentFreqMHz=currentFreqMHz, pubStatsGroup=pubStatsGroup, currentChannel=currentChannel, dataPortStatusTrap=dataPortStatusTrap, smtpGroup=smtpGroup, nTPSync=nTPSync, ptmp=ptmp, remoteMACAddress=remoteMACAddress, configuredModulationMode=configuredModulationMode, nTPPollInterval=nTPPollInterval, gatewayIPAddress=gatewayIPAddress, signalStrengthRatio=signalStrengthRatio, transmitPower=transmitPower, searchState=searchState, ptpCompliance=ptpCompliance, vectorError=vectorError, nTPLastSync=nTPLastSync, ptpTraps=ptpTraps, sNMPCommunityTableEntry=sNMPCommunityTableEntry, extendedFreqMHz=extendedFreqMHz, sNMPCommunityAccess=sNMPCommunityAccess, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sNMPCommunityString=sNMPCommunityString, antennaGain=antennaGain, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernet=ethernet, versionsGroup=versionsGroup, vlanPriority=vlanPriority, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, PYSNMP_MODULE_ID=cambium, transmitDataRate=transmitDataRate, phyStatus=phyStatus, ethernetGroup=ethernetGroup, alarmsGroup=alarmsGroup, systemClock=systemClock, remoteIPAddress=remoteIPAddress, dataPortStatus=dataPortStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, aggregateDataRate=aggregateDataRate, sNMPCommunityOid=sNMPCommunityOid, subnetMask=subnetMask, fixedModMode=fixedModMode, channelSelection=channelSelection, masterSlaveMode=masterSlaveMode, sNMPEnabledTraps=sNMPEnabledTraps, managementGroup=managementGroup, nTPState=nTPState, siteName=siteName, bootVersion=bootVersion, management=management, receiveDataRate=receiveDataRate, wirelessLinkStatus=wirelessLinkStatus, nTPServerPortNumber=nTPServerPortNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, snmpControl=snmpControl, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, measuredRange=measuredRange, snmpControlGroup=snmpControlGroup, ntp=ntp, softwareVersion=softwareVersion, maximumTransmitPower=maximumTransmitPower, productVariant=productVariant, cableLoss=cableLoss, installArmStateTrap=installArmStateTrap, channelBandwidth=channelBandwidth, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, productName=productName, cambium=cambium, iPAddress=iPAddress, ptp250=ptp250, vlanTagging=vlanTagging, configurationGroup=configurationGroup, linkLoss=linkLoss, alarms=alarms, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, pubStats=pubStats, configuredRange=configuredRange, smtp=smtp, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapCommunity=sNMPTrapCommunity, sNMPTrapTableEntry=sNMPTrapTableEntry, receiveModulationMode=receiveModulationMode, hardwareVersion=hardwareVersion, installArmState=installArmState, licenceGroup=licenceGroup, ptpTrapPrefix=ptpTrapPrefix, vlanId=vlanId, linkName=linkName, receivePower=receivePower, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, noWirelessChannelAvailable=noWirelessChannelAvailable, licence=licence, sNMPTrapTable=sNMPTrapTable, sMTPServerIPAddress=sMTPServerIPAddress, dualPayload=dualPayload, tFTPServerIPAddress=tFTPServerIPAddress, sMTPEnabledMessages=sMTPEnabledMessages, radarDetectChannel=radarDetectChannel, transmitModulationMode=transmitModulationMode, sNMPTrapTableIndex=sNMPTrapTableIndex, phyStatusGroup=phyStatusGroup, tFTPServerPortNumber=tFTPServerPortNumber, ptp=ptp, ntpGroup=ntpGroup, radarDetectTrap=radarDetectTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, band=band, extendedChannel=extendedChannel, configuration=configuration, ptpGroups=ptpGroups, noiseFloor=noiseFloor, nTPServerIp=nTPServerIp, timeZone=timeZone, sNMPCommunityTableIndex=sNMPCommunityTableIndex, notificationsGroup=notificationsGroup, sNMPCommunityTable=sNMPCommunityTable, sNMPTrapVersion=sNMPTrapVersion, versions=versions, regionCode=regionCode, linkStatusTrap=linkStatusTrap)
