...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", PYSNMP_MODULE_ID=cambium, ptp250=ptp250, phyStatusGroup=phyStatusGroup, radarDetectTrap=radarDetectTrap, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sNMPCommunityTable=sNMPCommunityTable, ethernetGroup=ethernetGroup, wirelessLinkStatus=wirelessLinkStatus, versions=versions, ptpTrapPrefix=ptpTrapPrefix, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, cableLoss=cableLoss, sNMPCommunityAccess=sNMPCommunityAccess, sNMPCommunityTableEntry=sNMPCommunityTableEntry, smtpGroup=smtpGroup, vlanId=vlanId, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, linkStatusTrap=linkStatusTrap, systemClock=systemClock, maximumTransmitPower=maximumTransmitPower, nTPServerIp=nTPServerIp, bootVersion=bootVersion, aggregateDataRate=aggregateDataRate, configuredModulationMode=configuredModulationMode, channelSelection=channelSelection, snmpControlGroup=snmpControlGroup, ptmp=ptmp, sNMPTrapTable=sNMPTrapTable, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sNMPTrapTableNumber=sNMPTrapTableNumber, nTPServerPortNumber=nTPServerPortNumber, currentFreqMHz=currentFreqMHz, managementGroup=managementGroup, channelBandwidth=channelBandwidth, snmpControl=snmpControl, iPAddress=iPAddress, radarDetectChannel=radarDetectChannel, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, notificationsGroup=notificationsGroup, sNMPEnabledTraps=sNMPEnabledTraps, cambium=cambium, sNMPCommunityOid=sNMPCommunityOid, pubStats=pubStats, ntp=ntp, noWirelessChannelAvailable=noWirelessChannelAvailable, regionCode=regionCode, hardwareVersion=hardwareVersion, ntpGroup=ntpGroup, timeZone=timeZone, vlanTagging=vlanTagging, transmitModulationMode=transmitModulationMode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortAutoNegotiation=dataPortAutoNegotiation, installArmState=installArmState, sNMPTrapVersion=sNMPTrapVersion, productVariant=productVariant, versionsGroup=versionsGroup, installArmStateTrap=installArmStateTrap, sMTPServerIPAddress=sMTPServerIPAddress, antennaGain=antennaGain, sMTPServerPortNumber=sMTPServerPortNumber, remoteIPAddress=remoteIPAddress, extendedChannel=extendedChannel, sNMPTrapPortNumber=sNMPTrapPortNumber, siteName=siteName, gatewayIPAddress=gatewayIPAddress, sMTPEnabledMessages=sMTPEnabledMessages, dualPayload=dualPayload, extendedFreqMHz=extendedFreqMHz, vlanPriority=vlanPriority, masterSlaveMode=masterSlaveMode, alarmsGroup=alarmsGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, nTPLastSync=nTPLastSync, receiveDataRate=receiveDataRate, linkName=linkName, linkLoss=linkLoss, phyStatus=phyStatus, ethernet=ethernet, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, remoteMACAddress=remoteMACAddress, sNMPCommunityString=sNMPCommunityString, nTPState=nTPState, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ptpCompliance=ptpCompliance, productName=productName, ptp=ptp, management=management, ptpTraps=ptpTraps, ptpGroups=ptpGroups, licence=licence, band=band, signalStrengthRatio=signalStrengthRatio, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, nTPSync=nTPSync, subnetMask=subnetMask, measuredRange=measuredRange, softwareVersion=softwareVersion, tFTPServerIPAddress=tFTPServerIPAddress, transmitDataRate=transmitDataRate, transmitPower=transmitPower, configurationGroup=configurationGroup, fixedModMode=fixedModMode, licenceGroup=licenceGroup, nTPPollInterval=nTPPollInterval, currentChannel=currentChannel, sNMPTrapTableIndex=sNMPTrapTableIndex, smtp=smtp, sNMPTrapTableEntry=sNMPTrapTableEntry, configuredRange=configuredRange, dataPortStatusTrap=dataPortStatusTrap, receivePower=receivePower, noiseFloor=noiseFloor, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, vectorError=vectorError, tFTPServerPortNumber=tFTPServerPortNumber, dataPortStatus=dataPortStatus, receiveModulationMode=receiveModulationMode, configuration=configuration, alarms=alarms, sNMPTrapCommunity=sNMPTrapCommunity, pubStatsGroup=pubStatsGroup, searchState=searchState)
