...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", managementGroup=managementGroup, PYSNMP_MODULE_ID=cambium, dataPortStatus=dataPortStatus, ethernet=ethernet, installArmStateTrap=installArmStateTrap, radarDetectTrap=radarDetectTrap, sNMPCommunityAccess=sNMPCommunityAccess, radarDetectChannel=radarDetectChannel, transmitDataRate=transmitDataRate, alarms=alarms, sMTPSourceEmailAddress=sMTPSourceEmailAddress, receiveDataRate=receiveDataRate, linkName=linkName, nTPLastSync=nTPLastSync, ethernetGroup=ethernetGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, snmpControlGroup=snmpControlGroup, productVariant=productVariant, management=management, configurationGroup=configurationGroup, receiveModulationMode=receiveModulationMode, sNMPTrapCommunity=sNMPTrapCommunity, transmitPower=transmitPower, currentChannel=currentChannel, smtpGroup=smtpGroup, ptpTrapPrefix=ptpTrapPrefix, sNMPCommunityTable=sNMPCommunityTable, measuredRange=measuredRange, vlanPriority=vlanPriority, aggregateDataRate=aggregateDataRate, sMTPServerIPAddress=sMTPServerIPAddress, notificationsGroup=notificationsGroup, nTPServerIp=nTPServerIp, searchState=searchState, ptp250=ptp250, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPServerPortNumber=tFTPServerPortNumber, versions=versions, masterSlaveMode=masterSlaveMode, versionsGroup=versionsGroup, nTPSync=nTPSync, timeZone=timeZone, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, pubStatsGroup=pubStatsGroup, ntp=ntp, snmpControl=snmpControl, tFTPServerIPAddress=tFTPServerIPAddress, ptpGroups=ptpGroups, maximumTransmitPower=maximumTransmitPower, productName=productName, channelBandwidth=channelBandwidth, licence=licence, ptpTraps=ptpTraps, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapTableIndex=sNMPTrapTableIndex, vlanTagging=vlanTagging, nTPPollInterval=nTPPollInterval, sNMPTrapPortNumber=sNMPTrapPortNumber, sMTPServerPortNumber=sMTPServerPortNumber, wirelessLinkStatus=wirelessLinkStatus, siteName=siteName, phyStatus=phyStatus, softwareVersion=softwareVersion, band=band, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitModulationMode=transmitModulationMode, vlanId=vlanId, pubStats=pubStats, subnetMask=subnetMask, nTPState=nTPState, extendedFreqMHz=extendedFreqMHz, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, channelSelection=channelSelection, configuredRange=configuredRange, bootVersion=bootVersion, iPAddress=iPAddress, currentFreqMHz=currentFreqMHz, gatewayIPAddress=gatewayIPAddress, sMTPEnabledMessages=sMTPEnabledMessages, remoteIPAddress=remoteIPAddress, noiseFloor=noiseFloor, configuredModulationMode=configuredModulationMode, alarmsGroup=alarmsGroup, vectorError=vectorError, cableLoss=cableLoss, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, signalStrengthRatio=signalStrengthRatio, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPCommunityTableEntry=sNMPCommunityTableEntry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptmp=ptmp, remoteMACAddress=remoteMACAddress, smtp=smtp, extendedChannel=extendedChannel, hardwareVersion=hardwareVersion, receivePower=receivePower, sNMPCommunityString=sNMPCommunityString, ntpGroup=ntpGroup, ptpCompliance=ptpCompliance, antennaGain=antennaGain, sNMPCommunityTableNumber=sNMPCommunityTableNumber, licenceGroup=licenceGroup, sNMPCommunityOid=sNMPCommunityOid, systemClock=systemClock, configuration=configuration, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, installArmState=installArmState, ptp=ptp, sNMPTrapTable=sNMPTrapTable, fixedModMode=fixedModMode, sNMPTrapTableEntry=sNMPTrapTableEntry, dualPayload=dualPayload, linkLoss=linkLoss, dataPortStatusTrap=dataPortStatusTrap, sNMPCommunityTableIndex=sNMPCommunityTableIndex, cambium=cambium, regionCode=regionCode, sNMPTrapVersion=sNMPTrapVersion, phyStatusGroup=phyStatusGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, linkStatusTrap=linkStatusTrap, nTPServerPortNumber=nTPServerPortNumber)
