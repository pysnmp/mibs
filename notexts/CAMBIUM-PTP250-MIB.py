...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPTrapVersion=sNMPTrapVersion, gatewayIPAddress=gatewayIPAddress, radarDetectChannel=radarDetectChannel, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dualPayload=dualPayload, sNMPCommunityOid=sNMPCommunityOid, snmpControlGroup=snmpControlGroup, vlanId=vlanId, bootVersion=bootVersion, sNMPTrapTableNumber=sNMPTrapTableNumber, configuredRange=configuredRange, hardwareVersion=hardwareVersion, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPCommunityTableEntry=sNMPCommunityTableEntry, wirelessLinkStatus=wirelessLinkStatus, nTPServerIp=nTPServerIp, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, nTPLastSync=nTPLastSync, ntpGroup=ntpGroup, configuredModulationMode=configuredModulationMode, remoteMACAddress=remoteMACAddress, licenceGroup=licenceGroup, regionCode=regionCode, tFTPServerIPAddress=tFTPServerIPAddress, sMTPServerPortNumber=sMTPServerPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, systemClock=systemClock, subnetMask=subnetMask, receivePower=receivePower, dataPortStatusTrap=dataPortStatusTrap, ptpTraps=ptpTraps, sMTPEnabledMessages=sMTPEnabledMessages, configurationGroup=configurationGroup, nTPPollInterval=nTPPollInterval, remoteIPAddress=remoteIPAddress, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapCommunity=sNMPTrapCommunity, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, cambium=cambium, receiveModulationMode=receiveModulationMode, iPAddress=iPAddress, transmitModulationMode=transmitModulationMode, management=management, installArmState=installArmState, sNMPCommunityString=sNMPCommunityString, linkStatusTrap=linkStatusTrap, maximumTransmitPower=maximumTransmitPower, antennaGain=antennaGain, PYSNMP_MODULE_ID=cambium, vlanPriority=vlanPriority, nTPServerPortNumber=nTPServerPortNumber, extendedFreqMHz=extendedFreqMHz, snmpControl=snmpControl, sNMPTrapTable=sNMPTrapTable, noWirelessChannelAvailable=noWirelessChannelAvailable, radarDetectTrap=radarDetectTrap, nTPState=nTPState, signalStrengthRatio=signalStrengthRatio, configuration=configuration, vectorError=vectorError, pubStatsGroup=pubStatsGroup, nTPSync=nTPSync, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, installArmStateTrap=installArmStateTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, productName=productName, notificationsGroup=notificationsGroup, phyStatusGroup=phyStatusGroup, linkName=linkName, linkLoss=linkLoss, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, receiveDataRate=receiveDataRate, noiseFloor=noiseFloor, currentFreqMHz=currentFreqMHz, ntp=ntp, timeZone=timeZone, alarms=alarms, sNMPCommunityTable=sNMPCommunityTable, ptmp=ptmp, searchState=searchState, channelBandwidth=channelBandwidth, aggregateDataRate=aggregateDataRate, fixedModMode=fixedModMode, masterSlaveMode=masterSlaveMode, ethernetGroup=ethernetGroup, currentChannel=currentChannel, cableLoss=cableLoss, softwareVersion=softwareVersion, siteName=siteName, managementGroup=managementGroup, ethernet=ethernet, smtp=smtp, ptp250=ptp250, transmitDataRate=transmitDataRate, sNMPTrapPortNumber=sNMPTrapPortNumber, vlanTagging=vlanTagging, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPTrapTableIndex=sNMPTrapTableIndex, smtpGroup=smtpGroup, versions=versions, sNMPCommunityTableNumber=sNMPCommunityTableNumber, alarmsGroup=alarmsGroup, ptpCompliance=ptpCompliance, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sNMPEnabledTraps=sNMPEnabledTraps, extendedChannel=extendedChannel, sNMPCommunityAccess=sNMPCommunityAccess, channelSelection=channelSelection, band=band, licence=licence, dataPortAutoNegotiation=dataPortAutoNegotiation, measuredRange=measuredRange, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, productVariant=productVariant, pubStats=pubStats, transmitPower=transmitPower, ptpTrapPrefix=ptpTrapPrefix, ptp=ptp, ptpGroups=ptpGroups, versionsGroup=versionsGroup, sMTPServerIPAddress=sMTPServerIPAddress, phyStatus=phyStatus, dataPortStatus=dataPortStatus)
