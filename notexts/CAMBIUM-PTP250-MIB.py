...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", softwareVersion=softwareVersion, notificationsGroup=notificationsGroup, receivePower=receivePower, radarDetectChannel=radarDetectChannel, iPAddress=iPAddress, ptp250=ptp250, searchState=searchState, transmitModulationMode=transmitModulationMode, systemClock=systemClock, sNMPCommunityTableEntry=sNMPCommunityTableEntry, wirelessLinkStatus=wirelessLinkStatus, hardwareVersion=hardwareVersion, sNMPCommunityTableIndex=sNMPCommunityTableIndex, noWirelessChannelAvailable=noWirelessChannelAvailable, snmpControl=snmpControl, smtp=smtp, masterSlaveMode=masterSlaveMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, channelBandwidth=channelBandwidth, pubStats=pubStats, channelSelection=channelSelection, dataPortStatus=dataPortStatus, ntp=ntp, linkLoss=linkLoss, configuredRange=configuredRange, installArmState=installArmState, pubStatsGroup=pubStatsGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, linkName=linkName, aggregateDataRate=aggregateDataRate, sNMPTrapTableNumber=sNMPTrapTableNumber, ptpGroups=ptpGroups, sNMPTrapVersion=sNMPTrapVersion, receiveDataRate=receiveDataRate, nTPServerIp=nTPServerIp, vectorError=vectorError, tFTPServerIPAddress=tFTPServerIPAddress, extendedChannel=extendedChannel, dualPayload=dualPayload, sNMPCommunityAccess=sNMPCommunityAccess, antennaGain=antennaGain, radarDetectTrap=radarDetectTrap, vlanPriority=vlanPriority, configuredModulationMode=configuredModulationMode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, installArmStateTrap=installArmStateTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, linkStatusTrap=linkStatusTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, sMTPServerIPAddress=sMTPServerIPAddress, vlanTagging=vlanTagging, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapCommunity=sNMPTrapCommunity, sNMPCommunityString=sNMPCommunityString, snmpControlGroup=snmpControlGroup, licence=licence, sNMPEnabledTraps=sNMPEnabledTraps, band=band, siteName=siteName, ptpCompliance=ptpCompliance, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, timeZone=timeZone, versions=versions, sNMPCommunityOid=sNMPCommunityOid, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, managementGroup=managementGroup, ntpGroup=ntpGroup, nTPLastSync=nTPLastSync, noiseFloor=noiseFloor, nTPSync=nTPSync, ethernet=ethernet, management=management, bootVersion=bootVersion, sNMPCommunityTable=sNMPCommunityTable, transmitPower=transmitPower, sMTPEnabledMessages=sMTPEnabledMessages, subnetMask=subnetMask, signalStrengthRatio=signalStrengthRatio, alarms=alarms, nTPState=nTPState, gatewayIPAddress=gatewayIPAddress, configuration=configuration, ethernetGroup=ethernetGroup, sNMPCommunityTableNumber=sNMPCommunityTableNumber, smtpGroup=smtpGroup, ptpTraps=ptpTraps, licenceGroup=licenceGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, productVariant=productVariant, ptp=ptp, ptmp=ptmp, remoteIPAddress=remoteIPAddress, alarmsGroup=alarmsGroup, versionsGroup=versionsGroup, extendedFreqMHz=extendedFreqMHz, remoteMACAddress=remoteMACAddress, cambium=cambium, maximumTransmitPower=maximumTransmitPower, sMTPServerPortNumber=sMTPServerPortNumber, nTPPollInterval=nTPPollInterval, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, productName=productName, measuredRange=measuredRange, currentFreqMHz=currentFreqMHz, tFTPServerPortNumber=tFTPServerPortNumber, vlanId=vlanId, cableLoss=cableLoss, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, configurationGroup=configurationGroup, fixedModMode=fixedModMode, sNMPTrapPortNumber=sNMPTrapPortNumber, phyStatus=phyStatus, transmitDataRate=transmitDataRate, regionCode=regionCode, receiveModulationMode=receiveModulationMode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, PYSNMP_MODULE_ID=cambium, nTPServerPortNumber=nTPServerPortNumber, sNMPTrapTable=sNMPTrapTable, phyStatusGroup=phyStatusGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, currentChannel=currentChannel, dataPortStatusTrap=dataPortStatusTrap)
