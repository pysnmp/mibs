...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", versionsGroup=versionsGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, pubStatsGroup=pubStatsGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, configurationGroup=configurationGroup, pubStats=pubStats, PYSNMP_MODULE_ID=cambium, cableLoss=cableLoss, phyStatusGroup=phyStatusGroup, ptp=ptp, subnetMask=subnetMask, sNMPCommunityString=sNMPCommunityString, noiseFloor=noiseFloor, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, installArmStateTrap=installArmStateTrap, nTPPollInterval=nTPPollInterval, aggregateDataRate=aggregateDataRate, gatewayIPAddress=gatewayIPAddress, vlanPriority=vlanPriority, receiveDataRate=receiveDataRate, sNMPTrapTable=sNMPTrapTable, sNMPTrapCommunity=sNMPTrapCommunity, vlanId=vlanId, sNMPTrapPortNumber=sNMPTrapPortNumber, smtpGroup=smtpGroup, band=band, configuration=configuration, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, productVariant=productVariant, tFTPServerPortNumber=tFTPServerPortNumber, linkLoss=linkLoss, maximumTransmitPower=maximumTransmitPower, extendedChannel=extendedChannel, sNMPTrapVersion=sNMPTrapVersion, radarDetectTrap=radarDetectTrap, sNMPCommunityOid=sNMPCommunityOid, ptpCompliance=ptpCompliance, vlanTagging=vlanTagging, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, phyStatus=phyStatus, sNMPCommunityTableNumber=sNMPCommunityTableNumber, nTPLastSync=nTPLastSync, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPCommunityAccess=sNMPCommunityAccess, sNMPCommunityTable=sNMPCommunityTable, sNMPCommunityTableEntry=sNMPCommunityTableEntry, transmitModulationMode=transmitModulationMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, transmitDataRate=transmitDataRate, installArmState=installArmState, softwareVersion=softwareVersion, iPAddress=iPAddress, currentFreqMHz=currentFreqMHz, notificationsGroup=notificationsGroup, timeZone=timeZone, measuredRange=measuredRange, receivePower=receivePower, masterSlaveMode=masterSlaveMode, sMTPEnabledMessages=sMTPEnabledMessages, nTPState=nTPState, linkStatusTrap=linkStatusTrap, snmpControlGroup=snmpControlGroup, ptpTraps=ptpTraps, linkName=linkName, management=management, remoteIPAddress=remoteIPAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, ntp=ntp, vectorError=vectorError, nTPServerIp=nTPServerIp, hardwareVersion=hardwareVersion, nTPSync=nTPSync, smtp=smtp, configuredModulationMode=configuredModulationMode, productName=productName, channelBandwidth=channelBandwidth, radarDetectChannel=radarDetectChannel, sNMPTrapTableNumber=sNMPTrapTableNumber, alarms=alarms, ntpGroup=ntpGroup, systemClock=systemClock, configuredRange=configuredRange, alarmsGroup=alarmsGroup, remoteMACAddress=remoteMACAddress, transmitPower=transmitPower, snmpControl=snmpControl, licence=licence, dataPortStatusTrap=dataPortStatusTrap, versions=versions, wirelessLinkStatus=wirelessLinkStatus, regionCode=regionCode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, signalStrengthRatio=signalStrengthRatio, sMTPServerIPAddress=sMTPServerIPAddress, ethernetGroup=ethernetGroup, ptp250=ptp250, dataPortStatus=dataPortStatus, bootVersion=bootVersion, channelSelection=channelSelection, nTPServerPortNumber=nTPServerPortNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dualPayload=dualPayload, licenceGroup=licenceGroup, antennaGain=antennaGain, extendedFreqMHz=extendedFreqMHz, ptmp=ptmp, sNMPCommunityTableIndex=sNMPCommunityTableIndex, searchState=searchState, managementGroup=managementGroup, receiveModulationMode=receiveModulationMode, ptpTrapPrefix=ptpTrapPrefix, ptpGroups=ptpGroups, cambium=cambium, currentChannel=currentChannel, fixedModMode=fixedModMode, siteName=siteName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ethernet=ethernet, sMTPServerPortNumber=sMTPServerPortNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap)
