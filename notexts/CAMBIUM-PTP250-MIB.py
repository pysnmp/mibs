...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", channelBandwidth=channelBandwidth, installArmStateTrap=installArmStateTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, management=management, antennaGain=antennaGain, aggregateDataRate=aggregateDataRate, receivePower=receivePower, versionsGroup=versionsGroup, installArmState=installArmState, bootVersion=bootVersion, currentFreqMHz=currentFreqMHz, sNMPTrapTable=sNMPTrapTable, searchState=searchState, productName=productName, ptp=ptp, alarms=alarms, sMTPEnabledMessages=sMTPEnabledMessages, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, band=band, sNMPCommunityString=sNMPCommunityString, ptmp=ptmp, maximumTransmitPower=maximumTransmitPower, linkName=linkName, remoteMACAddress=remoteMACAddress, gatewayIPAddress=gatewayIPAddress, extendedFreqMHz=extendedFreqMHz, measuredRange=measuredRange, smtp=smtp, channelSelection=channelSelection, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vlanId=vlanId, snmpControl=snmpControl, wirelessLinkStatus=wirelessLinkStatus, pubStatsGroup=pubStatsGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPTrapCommunity=sNMPTrapCommunity, sNMPTrapVersion=sNMPTrapVersion, vlanPriority=vlanPriority, smtpGroup=smtpGroup, timeZone=timeZone, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, cambium=cambium, phyStatus=phyStatus, tFTPServerPortNumber=tFTPServerPortNumber, regionCode=regionCode, nTPState=nTPState, receiveModulationMode=receiveModulationMode, nTPServerIp=nTPServerIp, snmpControlGroup=snmpControlGroup, configuredRange=configuredRange, ptpTrapPrefix=ptpTrapPrefix, sNMPCommunityTableNumber=sNMPCommunityTableNumber, vectorError=vectorError, radarDetectChannel=radarDetectChannel, radarDetectTrap=radarDetectTrap, managementGroup=managementGroup, transmitPower=transmitPower, sNMPCommunityTableIndex=sNMPCommunityTableIndex, noiseFloor=noiseFloor, fixedModMode=fixedModMode, receiveDataRate=receiveDataRate, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, licence=licence, alarmsGroup=alarmsGroup, ptp250=ptp250, dualPayload=dualPayload, ntp=ntp, masterSlaveMode=masterSlaveMode, ptpCompliance=ptpCompliance, currentChannel=currentChannel, linkLoss=linkLoss, ethernetGroup=ethernetGroup, notificationsGroup=notificationsGroup, versions=versions, PYSNMP_MODULE_ID=cambium, ethernet=ethernet, ntpGroup=ntpGroup, transmitModulationMode=transmitModulationMode, cableLoss=cableLoss, dataPortStatusTrap=dataPortStatusTrap, sMTPServerIPAddress=sMTPServerIPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tFTPServerIPAddress=tFTPServerIPAddress, dataPortStatus=dataPortStatus, configuration=configuration, siteName=siteName, nTPSync=nTPSync, sNMPCommunityTable=sNMPCommunityTable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPCommunityTableEntry=sNMPCommunityTableEntry, iPAddress=iPAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, signalStrengthRatio=signalStrengthRatio, hardwareVersion=hardwareVersion, nTPPollInterval=nTPPollInterval, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, extendedChannel=extendedChannel, transmitDataRate=transmitDataRate, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPCommunityOid=sNMPCommunityOid, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, configuredModulationMode=configuredModulationMode, productVariant=productVariant, nTPServerPortNumber=nTPServerPortNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, remoteIPAddress=remoteIPAddress, subnetMask=subnetMask, configurationGroup=configurationGroup, ptpTraps=ptpTraps, nTPLastSync=nTPLastSync, systemClock=systemClock, linkStatusTrap=linkStatusTrap, phyStatusGroup=phyStatusGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, pubStats=pubStats, ptpGroups=ptpGroups, sNMPCommunityAccess=sNMPCommunityAccess, vlanTagging=vlanTagging, softwareVersion=softwareVersion, licenceGroup=licenceGroup, sNMPTrapTableIndex=sNMPTrapTableIndex)
