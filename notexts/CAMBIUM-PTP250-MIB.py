...
# ASN.1 source CAMBIUM-PTP250-MIB
# Source digest sha256:a25a1d05ae55bc387696ef43e3e0f46835676110647d67f958125a2c9ea23dfb
...
if mibBuilder.loadTexts: cambium.setLastUpdated('2012-12-07 09:35')
...
sNMPCommunityTable = MibTable((1, 3, 6, 1, 4, 1, 17713, 250, 8, 2), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: sNMPCommunityTable.setStatus('current')
sNMPCommunityTableEntry = MibTableRow((1, 3, 6, 1, 4, 1, 17713, 250, 8, 2, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "CAMBIUM-PTP250-MIB", "sNMPCommunityTableIndex"))
if mibBuilder.loadTexts: sNMPCommunityTableEntry.setStatus('current')
sNMPTrapTable = MibTable((1, 3, 6, 1, 4, 1, 17713, 250, 8, 4), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: sNMPTrapTable.setStatus('current')
sNMPTrapTableEntry = MibTableRow((1, 3, 6, 1, 4, 1, 17713, 250, 8, 4, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "CAMBIUM-PTP250-MIB", "sNMPTrapTableIndex"))
...
sNMPCommunityTableIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 17713, 250, 8, 2, 1, 1), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 2))).setMaxAccess("notaccessible")
...
sNMPTrapTableIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 17713, 250, 8, 4, 1, 1), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 2))).setMaxAccess("notaccessible")
...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", PYSNMP_MODULE_ID=cambium, aggregateDataRate=aggregateDataRate, alarms=alarms, alarmsGroup=alarmsGroup, antennaGain=antennaGain, band=band, bootVersion=bootVersion, cableLoss=cableLoss, cambium=cambium, channelBandwidth=channelBandwidth, channelSelection=channelSelection, configuration=configuration, configurationGroup=configurationGroup, configuredModulationMode=configuredModulationMode, configuredRange=configuredRange, currentChannel=currentChannel, currentFreqMHz=currentFreqMHz, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortStatus=dataPortStatus, dataPortStatusTrap=dataPortStatusTrap, dualPayload=dualPayload, ethernet=ethernet, ethernetGroup=ethernetGroup, extendedChannel=extendedChannel, extendedFreqMHz=extendedFreqMHz, fixedModMode=fixedModMode, gatewayIPAddress=gatewayIPAddress, hardwareVersion=hardwareVersion, iPAddress=iPAddress, installArmState=installArmState, installArmStateTrap=installArmStateTrap, licence=licence, licenceGroup=licenceGroup, linkLoss=linkLoss, linkName=linkName, linkStatusTrap=linkStatusTrap, management=management, managementGroup=managementGroup, masterSlaveMode=masterSlaveMode, maximumTransmitPower=maximumTransmitPower, measuredRange=measuredRange, nTPLastSync=nTPLastSync, nTPPollInterval=nTPPollInterval, nTPServerIp=nTPServerIp, nTPServerPortNumber=nTPServerPortNumber, nTPState=nTPState, nTPSync=nTPSync, noWirelessChannelAvailable=noWirelessChannelAvailable, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, noiseFloor=noiseFloor, notificationsGroup=notificationsGroup, ntp=ntp, ntpGroup=ntpGroup, phyStatus=phyStatus, phyStatusGroup=phyStatusGroup, productName=productName, productVariant=productVariant, ptmp=ptmp, ptp250=ptp250, ptp=ptp, ptpCompliance=ptpCompliance, ptpGroups=ptpGroups, ptpTrapPrefix=ptpTrapPrefix, ptpTraps=ptpTraps, pubStats=pubStats, pubStatsGroup=pubStatsGroup, radarDetectChannel=radarDetectChannel, radarDetectTrap=radarDetectTrap, receiveDataRate=receiveDataRate, receiveModulationMode=receiveModulationMode, receivePower=receivePower, regionCode=regionCode, remoteIPAddress=remoteIPAddress, remoteMACAddress=remoteMACAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPEnabledMessages=sMTPEnabledMessages, sMTPServerIPAddress=sMTPServerIPAddress, sMTPServerPortNumber=sMTPServerPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPCommunityAccess=sNMPCommunityAccess, sNMPCommunityOid=sNMPCommunityOid, sNMPCommunityString=sNMPCommunityString, sNMPCommunityTable=sNMPCommunityTable, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapCommunity=sNMPTrapCommunity, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPTrapTable=sNMPTrapTable, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapVersion=sNMPTrapVersion, searchState=searchState, signalStrengthRatio=signalStrengthRatio, siteName=siteName, smtp=smtp, smtpGroup=smtpGroup, snmpControl=snmpControl, snmpControlGroup=snmpControlGroup, softwareVersion=softwareVersion, subnetMask=subnetMask, systemClock=systemClock, tFTPServerIPAddress=tFTPServerIPAddress, tFTPServerPortNumber=tFTPServerPortNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, timeZone=timeZone, transmitDataRate=transmitDataRate, transmitModulationMode=transmitModulationMode, transmitPower=transmitPower, vectorError=vectorError, versions=versions, versionsGroup=versionsGroup, vlanId=vlanId, vlanPriority=vlanPriority, vlanTagging=vlanTagging, wirelessLinkStatus=wirelessLinkStatus)
