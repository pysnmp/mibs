...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", notificationsGroup=notificationsGroup, ptp250=ptp250, sMTPServerPortNumber=sMTPServerPortNumber, sNMPCommunityOid=sNMPCommunityOid, configuredModulationMode=configuredModulationMode, alarmsGroup=alarmsGroup, versions=versions, radarDetectTrap=radarDetectTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, systemClock=systemClock, linkLoss=linkLoss, sMTPServerIPAddress=sMTPServerIPAddress, siteName=siteName, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, receiveDataRate=receiveDataRate, ptmp=ptmp, nTPState=nTPState, dualPayload=dualPayload, gatewayIPAddress=gatewayIPAddress, currentChannel=currentChannel, sNMPCommunityTableNumber=sNMPCommunityTableNumber, channelBandwidth=channelBandwidth, ptpCompliance=ptpCompliance, ntp=ntp, receivePower=receivePower, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ethernetGroup=ethernetGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, maximumTransmitPower=maximumTransmitPower, regionCode=regionCode, snmpControl=snmpControl, masterSlaveMode=masterSlaveMode, hardwareVersion=hardwareVersion, sNMPCommunityAccess=sNMPCommunityAccess, nTPLastSync=nTPLastSync, pubStats=pubStats, linkName=linkName, sMTPEnabledMessages=sMTPEnabledMessages, antennaGain=antennaGain, licence=licence, softwareVersion=softwareVersion, nTPServerIp=nTPServerIp, smtpGroup=smtpGroup, aggregateDataRate=aggregateDataRate, channelSelection=channelSelection, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, phyStatus=phyStatus, vlanId=vlanId, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ptpGroups=ptpGroups, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapTable=sNMPTrapTable, PYSNMP_MODULE_ID=cambium, noWirelessChannelAvailable=noWirelessChannelAvailable, transmitDataRate=transmitDataRate, nTPPollInterval=nTPPollInterval, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, wirelessLinkStatus=wirelessLinkStatus, alarms=alarms, dataPortStatus=dataPortStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, vectorError=vectorError, productName=productName, installArmStateTrap=installArmStateTrap, cambium=cambium, noiseFloor=noiseFloor, smtp=smtp, transmitPower=transmitPower, iPAddress=iPAddress, remoteIPAddress=remoteIPAddress, licenceGroup=licenceGroup, vlanTagging=vlanTagging, management=management, linkStatusTrap=linkStatusTrap, snmpControlGroup=snmpControlGroup, currentFreqMHz=currentFreqMHz, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortStatusTrap=dataPortStatusTrap, sNMPCommunityString=sNMPCommunityString, extendedChannel=extendedChannel, subnetMask=subnetMask, configuredRange=configuredRange, sNMPCommunityTableEntry=sNMPCommunityTableEntry, configuration=configuration, dataPortAutoNegotiation=dataPortAutoNegotiation, searchState=searchState, fixedModMode=fixedModMode, extendedFreqMHz=extendedFreqMHz, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapCommunity=sNMPTrapCommunity, timeZone=timeZone, vlanPriority=vlanPriority, remoteMACAddress=remoteMACAddress, band=band, phyStatusGroup=phyStatusGroup, measuredRange=measuredRange, bootVersion=bootVersion, ethernet=ethernet, installArmState=installArmState, ntpGroup=ntpGroup, ptp=ptp, sNMPCommunityTable=sNMPCommunityTable, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPCommunityTableIndex=sNMPCommunityTableIndex, ptpTrapPrefix=ptpTrapPrefix, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, transmitModulationMode=transmitModulationMode, configurationGroup=configurationGroup, sNMPEnabledTraps=sNMPEnabledTraps, nTPSync=nTPSync, cableLoss=cableLoss, signalStrengthRatio=signalStrengthRatio, receiveModulationMode=receiveModulationMode, nTPServerPortNumber=nTPServerPortNumber, versionsGroup=versionsGroup, ptpTraps=ptpTraps, managementGroup=managementGroup, pubStatsGroup=pubStatsGroup, productVariant=productVariant, radarDetectChannel=radarDetectChannel)
