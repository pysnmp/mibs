...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", subnetMask=subnetMask, hardwareVersion=hardwareVersion, extendedChannel=extendedChannel, ptmp=ptmp, installArmStateTrap=installArmStateTrap, sNMPTrapTable=sNMPTrapTable, versionsGroup=versionsGroup, remoteMACAddress=remoteMACAddress, nTPLastSync=nTPLastSync, receivePower=receivePower, currentChannel=currentChannel, linkName=linkName, channelSelection=channelSelection, searchState=searchState, linkStatusTrap=linkStatusTrap, cableLoss=cableLoss, configuredRange=configuredRange, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernetGroup=ethernetGroup, maximumTransmitPower=maximumTransmitPower, masterSlaveMode=masterSlaveMode, sNMPCommunityTableNumber=sNMPCommunityTableNumber, aggregateDataRate=aggregateDataRate, bootVersion=bootVersion, radarDetectTrap=radarDetectTrap, ptpCompliance=ptpCompliance, vectorError=vectorError, tFTPServerIPAddress=tFTPServerIPAddress, antennaGain=antennaGain, snmpControl=snmpControl, ntpGroup=ntpGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, smtp=smtp, fixedModMode=fixedModMode, nTPPollInterval=nTPPollInterval, transmitPower=transmitPower, sNMPTrapTableEntry=sNMPTrapTableEntry, noiseFloor=noiseFloor, sNMPTrapIPAddress=sNMPTrapIPAddress, vlanId=vlanId, dualPayload=dualPayload, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortStatusTrap=dataPortStatusTrap, sMTPServerIPAddress=sMTPServerIPAddress, ntp=ntp, vlanPriority=vlanPriority, systemClock=systemClock, transmitDataRate=transmitDataRate, sNMPCommunityTableEntry=sNMPCommunityTableEntry, currentFreqMHz=currentFreqMHz, vlanTagging=vlanTagging, pubStats=pubStats, sNMPTrapVersion=sNMPTrapVersion, gatewayIPAddress=gatewayIPAddress, transmitModulationMode=transmitModulationMode, nTPSync=nTPSync, iPAddress=iPAddress, licenceGroup=licenceGroup, versions=versions, sNMPEnabledTraps=sNMPEnabledTraps, alarmsGroup=alarmsGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, PYSNMP_MODULE_ID=cambium, productVariant=productVariant, pubStatsGroup=pubStatsGroup, snmpControlGroup=snmpControlGroup, configurationGroup=configurationGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptpGroups=ptpGroups, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ethernet=ethernet, sNMPCommunityOid=sNMPCommunityOid, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, installArmState=installArmState, nTPServerIp=nTPServerIp, softwareVersion=softwareVersion, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, remoteIPAddress=remoteIPAddress, licence=licence, receiveModulationMode=receiveModulationMode, ptpTraps=ptpTraps, ptp250=ptp250, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, phyStatusGroup=phyStatusGroup, linkLoss=linkLoss, dataPortAutoNegotiation=dataPortAutoNegotiation, receiveDataRate=receiveDataRate, dataPortStatus=dataPortStatus, nTPServerPortNumber=nTPServerPortNumber, sNMPCommunityString=sNMPCommunityString, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPCommunityTable=sNMPCommunityTable, band=band, signalStrengthRatio=signalStrengthRatio, managementGroup=managementGroup, cambium=cambium, nTPState=nTPState, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, regionCode=regionCode, sNMPTrapCommunity=sNMPTrapCommunity, configuredModulationMode=configuredModulationMode, wirelessLinkStatus=wirelessLinkStatus, tFTPServerPortNumber=tFTPServerPortNumber, ptp=ptp, sNMPCommunityAccess=sNMPCommunityAccess, alarms=alarms, radarDetectChannel=radarDetectChannel, timeZone=timeZone, notificationsGroup=notificationsGroup, management=management, configuration=configuration, sNMPTrapTableIndex=sNMPTrapTableIndex, measuredRange=measuredRange, sNMPCommunityTableIndex=sNMPCommunityTableIndex, ptpTrapPrefix=ptpTrapPrefix, channelBandwidth=channelBandwidth, siteName=siteName, phyStatus=phyStatus, sMTPEnabledMessages=sMTPEnabledMessages, extendedFreqMHz=extendedFreqMHz, productName=productName, smtpGroup=smtpGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText)
