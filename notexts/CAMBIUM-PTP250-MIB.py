...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPTrapPortNumber=sNMPTrapPortNumber, nTPLastSync=nTPLastSync, transmitPower=transmitPower, fixedModMode=fixedModMode, ptp=ptp, sNMPCommunityTable=sNMPCommunityTable, systemClock=systemClock, searchState=searchState, sNMPTrapTableNumber=sNMPTrapTableNumber, PYSNMP_MODULE_ID=cambium, sMTPServerIPAddress=sMTPServerIPAddress, cableLoss=cableLoss, ptpGroups=ptpGroups, extendedChannel=extendedChannel, sNMPTrapCommunity=sNMPTrapCommunity, pubStatsGroup=pubStatsGroup, timeZone=timeZone, subnetMask=subnetMask, versions=versions, vlanPriority=vlanPriority, softwareVersion=softwareVersion, sNMPCommunityOid=sNMPCommunityOid, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, wirelessLinkStatus=wirelessLinkStatus, ethernet=ethernet, nTPSync=nTPSync, alarms=alarms, sNMPCommunityString=sNMPCommunityString, transmitDataRate=transmitDataRate, aggregateDataRate=aggregateDataRate, management=management, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sNMPTrapVersion=sNMPTrapVersion, sMTPSourceEmailAddress=sMTPSourceEmailAddress, transmitModulationMode=transmitModulationMode, notificationsGroup=notificationsGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPServerPortNumber=tFTPServerPortNumber, productName=productName, ethernetGroup=ethernetGroup, dataPortStatusTrap=dataPortStatusTrap, tFTPServerIPAddress=tFTPServerIPAddress, sMTPServerPortNumber=sMTPServerPortNumber, band=band, currentFreqMHz=currentFreqMHz, installArmState=installArmState, vlanId=vlanId, sNMPCommunityTableIndex=sNMPCommunityTableIndex, licence=licence, iPAddress=iPAddress, nTPPollInterval=nTPPollInterval, pubStats=pubStats, ptpCompliance=ptpCompliance, masterSlaveMode=masterSlaveMode, dualPayload=dualPayload, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sMTPEnabledMessages=sMTPEnabledMessages, installArmStateTrap=installArmStateTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, nTPServerPortNumber=nTPServerPortNumber, configuredModulationMode=configuredModulationMode, radarDetectTrap=radarDetectTrap, configuration=configuration, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, linkStatusTrap=linkStatusTrap, channelBandwidth=channelBandwidth, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortAutoNegotiation=dataPortAutoNegotiation, ptpTrapPrefix=ptpTrapPrefix, currentChannel=currentChannel, extendedFreqMHz=extendedFreqMHz, ntpGroup=ntpGroup, snmpControlGroup=snmpControlGroup, gatewayIPAddress=gatewayIPAddress, regionCode=regionCode, linkName=linkName, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPEnabledTraps=sNMPEnabledTraps, linkLoss=linkLoss, noiseFloor=noiseFloor, sNMPTrapTable=sNMPTrapTable, ptp250=ptp250, ptmp=ptmp, managementGroup=managementGroup, nTPServerIp=nTPServerIp, signalStrengthRatio=signalStrengthRatio, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ntp=ntp, vlanTagging=vlanTagging, bootVersion=bootVersion, dataPortStatus=dataPortStatus, nTPState=nTPState, phyStatusGroup=phyStatusGroup, smtpGroup=smtpGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, measuredRange=measuredRange, remoteMACAddress=remoteMACAddress, cambium=cambium, snmpControl=snmpControl, antennaGain=antennaGain, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, receiveModulationMode=receiveModulationMode, alarmsGroup=alarmsGroup, siteName=siteName, smtp=smtp, versionsGroup=versionsGroup, ptpTraps=ptpTraps, sNMPCommunityTableEntry=sNMPCommunityTableEntry, receivePower=receivePower, productVariant=productVariant, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, configurationGroup=configurationGroup, maximumTransmitPower=maximumTransmitPower, remoteIPAddress=remoteIPAddress, hardwareVersion=hardwareVersion, licenceGroup=licenceGroup, receiveDataRate=receiveDataRate, radarDetectChannel=radarDetectChannel, vectorError=vectorError, sNMPCommunityAccess=sNMPCommunityAccess, configuredRange=configuredRange, channelSelection=channelSelection, phyStatus=phyStatus)
