...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", transmitDataRate=transmitDataRate, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tFTPServerIPAddress=tFTPServerIPAddress, phyStatus=phyStatus, channelSelection=channelSelection, nTPSync=nTPSync, sNMPCommunityTable=sNMPCommunityTable, noiseFloor=noiseFloor, sNMPTrapTableNumber=sNMPTrapTableNumber, vectorError=vectorError, sNMPCommunityOid=sNMPCommunityOid, management=management, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, gatewayIPAddress=gatewayIPAddress, configuredModulationMode=configuredModulationMode, aggregateDataRate=aggregateDataRate, ptpTraps=ptpTraps, regionCode=regionCode, sMTPServerIPAddress=sMTPServerIPAddress, iPAddress=iPAddress, hardwareVersion=hardwareVersion, extendedFreqMHz=extendedFreqMHz, vlanId=vlanId, configurationGroup=configurationGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPCommunityAccess=sNMPCommunityAccess, ntpGroup=ntpGroup, tFTPServerPortNumber=tFTPServerPortNumber, receivePower=receivePower, wirelessLinkStatus=wirelessLinkStatus, licenceGroup=licenceGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, ptpGroups=ptpGroups, antennaGain=antennaGain, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortStatusTrap=dataPortStatusTrap, smtp=smtp, timeZone=timeZone, ptp=ptp, configuration=configuration, productName=productName, nTPState=nTPState, receiveModulationMode=receiveModulationMode, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, signalStrengthRatio=signalStrengthRatio, dataPortAutoNegotiation=dataPortAutoNegotiation, noWirelessChannelAvailable=noWirelessChannelAvailable, maximumTransmitPower=maximumTransmitPower, versions=versions, radarDetectTrap=radarDetectTrap, sNMPEnabledTraps=sNMPEnabledTraps, snmpControlGroup=snmpControlGroup, siteName=siteName, alarms=alarms, band=band, sNMPTrapIPAddress=sNMPTrapIPAddress, extendedChannel=extendedChannel, transmitModulationMode=transmitModulationMode, masterSlaveMode=masterSlaveMode, ptmp=ptmp, receiveDataRate=receiveDataRate, sNMPTrapTableIndex=sNMPTrapTableIndex, linkLoss=linkLoss, sNMPCommunityTableNumber=sNMPCommunityTableNumber, linkStatusTrap=linkStatusTrap, notificationsGroup=notificationsGroup, installArmState=installArmState, sNMPTrapCommunity=sNMPTrapCommunity, dualPayload=dualPayload, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, pubStatsGroup=pubStatsGroup, searchState=searchState, softwareVersion=softwareVersion, sMTPServerPortNumber=sMTPServerPortNumber, systemClock=systemClock, nTPLastSync=nTPLastSync, nTPServerIp=nTPServerIp, fixedModMode=fixedModMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapTable=sNMPTrapTable, vlanTagging=vlanTagging, channelBandwidth=channelBandwidth, nTPServerPortNumber=nTPServerPortNumber, currentChannel=currentChannel, currentFreqMHz=currentFreqMHz, nTPPollInterval=nTPPollInterval, configuredRange=configuredRange, sNMPCommunityTableIndex=sNMPCommunityTableIndex, phyStatusGroup=phyStatusGroup, vlanPriority=vlanPriority, cambium=cambium, sNMPCommunityTableEntry=sNMPCommunityTableEntry, snmpControl=snmpControl, dataPortStatus=dataPortStatus, productVariant=productVariant, ethernetGroup=ethernetGroup, sNMPTrapVersion=sNMPTrapVersion, measuredRange=measuredRange, transmitPower=transmitPower, alarmsGroup=alarmsGroup, ethernet=ethernet, bootVersion=bootVersion, pubStats=pubStats, ptpTrapPrefix=ptpTrapPrefix, remoteMACAddress=remoteMACAddress, installArmStateTrap=installArmStateTrap, ntp=ntp, linkName=linkName, remoteIPAddress=remoteIPAddress, PYSNMP_MODULE_ID=cambium, managementGroup=managementGroup, radarDetectChannel=radarDetectChannel, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPCommunityString=sNMPCommunityString, licence=licence, smtpGroup=smtpGroup, versionsGroup=versionsGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ptpCompliance=ptpCompliance, ptp250=ptp250, subnetMask=subnetMask, cableLoss=cableLoss, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText)
