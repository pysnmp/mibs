...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", ethernet=ethernet, licence=licence, ptp=ptp, productName=productName, radarDetectChannel=radarDetectChannel, configuration=configuration, linkLoss=linkLoss, management=management, managementGroup=managementGroup, ptpTraps=ptpTraps, linkName=linkName, ptpCompliance=ptpCompliance, versions=versions, iPAddress=iPAddress, configuredRange=configuredRange, transmitPower=transmitPower, currentFreqMHz=currentFreqMHz, nTPState=nTPState, cambium=cambium, ntp=ntp, receiveModulationMode=receiveModulationMode, subnetMask=subnetMask, remoteIPAddress=remoteIPAddress, maximumTransmitPower=maximumTransmitPower, sNMPCommunityAccess=sNMPCommunityAccess, sMTPServerPortNumber=sMTPServerPortNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, versionsGroup=versionsGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, sMTPServerIPAddress=sMTPServerIPAddress, snmpControlGroup=snmpControlGroup, ptmp=ptmp, measuredRange=measuredRange, signalStrengthRatio=signalStrengthRatio, linkStatusTrap=linkStatusTrap, vlanTagging=vlanTagging, licenceGroup=licenceGroup, smtp=smtp, radarDetectTrap=radarDetectTrap, extendedFreqMHz=extendedFreqMHz, siteName=siteName, productVariant=productVariant, extendedChannel=extendedChannel, sNMPTrapTableEntry=sNMPTrapTableEntry, notificationsGroup=notificationsGroup, sNMPEnabledTraps=sNMPEnabledTraps, cableLoss=cableLoss, wirelessLinkStatus=wirelessLinkStatus, channelBandwidth=channelBandwidth, alarmsGroup=alarmsGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, noiseFloor=noiseFloor, receiveDataRate=receiveDataRate, ptpTrapPrefix=ptpTrapPrefix, band=band, receivePower=receivePower, remoteMACAddress=remoteMACAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, gatewayIPAddress=gatewayIPAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPCommunityTable=sNMPCommunityTable, nTPServerIp=nTPServerIp, alarms=alarms, sNMPTrapIPAddress=sNMPTrapIPAddress, channelSelection=channelSelection, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPServerPortNumber=tFTPServerPortNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, antennaGain=antennaGain, PYSNMP_MODULE_ID=cambium, nTPSync=nTPSync, sNMPTrapPortNumber=sNMPTrapPortNumber, timeZone=timeZone, sNMPTrapVersion=sNMPTrapVersion, currentChannel=currentChannel, configuredModulationMode=configuredModulationMode, pubStats=pubStats, sMTPEnabledMessages=sMTPEnabledMessages, dualPayload=dualPayload, dataPortStatusTrap=dataPortStatusTrap, fixedModMode=fixedModMode, transmitModulationMode=transmitModulationMode, sNMPCommunityOid=sNMPCommunityOid, ntpGroup=ntpGroup, installArmState=installArmState, transmitDataRate=transmitDataRate, bootVersion=bootVersion, masterSlaveMode=masterSlaveMode, configurationGroup=configurationGroup, searchState=searchState, nTPServerPortNumber=nTPServerPortNumber, regionCode=regionCode, pubStatsGroup=pubStatsGroup, ptpGroups=ptpGroups, vectorError=vectorError, sNMPTrapTable=sNMPTrapTable, softwareVersion=softwareVersion, sNMPCommunityTableIndex=sNMPCommunityTableIndex, dataPortAutoNegotiation=dataPortAutoNegotiation, nTPPollInterval=nTPPollInterval, phyStatus=phyStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, phyStatusGroup=phyStatusGroup, ptp250=ptp250, sNMPTrapCommunity=sNMPTrapCommunity, systemClock=systemClock, sMTPSourceEmailAddress=sMTPSourceEmailAddress, installArmStateTrap=installArmStateTrap, vlanPriority=vlanPriority, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, aggregateDataRate=aggregateDataRate, smtpGroup=smtpGroup, nTPLastSync=nTPLastSync, ethernetGroup=ethernetGroup, sNMPCommunityTableNumber=sNMPCommunityTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, hardwareVersion=hardwareVersion, sNMPCommunityString=sNMPCommunityString, dataPortStatus=dataPortStatus, snmpControl=snmpControl, sNMPCommunityTableEntry=sNMPCommunityTableEntry, vlanId=vlanId)
