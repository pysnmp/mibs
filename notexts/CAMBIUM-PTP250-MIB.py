...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapCommunity=sNMPTrapCommunity, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vlanPriority=vlanPriority, sNMPCommunityAccess=sNMPCommunityAccess, siteName=siteName, versionsGroup=versionsGroup, productName=productName, alarms=alarms, transmitDataRate=transmitDataRate, hardwareVersion=hardwareVersion, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPCommunityTable=sNMPCommunityTable, radarDetectTrap=radarDetectTrap, wirelessLinkStatus=wirelessLinkStatus, receiveModulationMode=receiveModulationMode, nTPServerIp=nTPServerIp, gatewayIPAddress=gatewayIPAddress, installArmStateTrap=installArmStateTrap, sNMPCommunityOid=sNMPCommunityOid, softwareVersion=softwareVersion, phyStatusGroup=phyStatusGroup, sMTPServerPortNumber=sMTPServerPortNumber, iPAddress=iPAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, remoteIPAddress=remoteIPAddress, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sNMPTrapTableIndex=sNMPTrapTableIndex, sMTPEnabledMessages=sMTPEnabledMessages, sMTPServerIPAddress=sMTPServerIPAddress, sNMPEnabledTraps=sNMPEnabledTraps, phyStatus=phyStatus, ptpTraps=ptpTraps, ethernet=ethernet, versions=versions, ptpCompliance=ptpCompliance, measuredRange=measuredRange, management=management, subnetMask=subnetMask, snmpControlGroup=snmpControlGroup, PYSNMP_MODULE_ID=cambium, channelSelection=channelSelection, cambium=cambium, masterSlaveMode=masterSlaveMode, linkName=linkName, configurationGroup=configurationGroup, regionCode=regionCode, nTPServerPortNumber=nTPServerPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, maximumTransmitPower=maximumTransmitPower, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, configuredRange=configuredRange, licenceGroup=licenceGroup, channelBandwidth=channelBandwidth, nTPSync=nTPSync, noWirelessChannelAvailable=noWirelessChannelAvailable, configuration=configuration, configuredModulationMode=configuredModulationMode, linkStatusTrap=linkStatusTrap, ptmp=ptmp, aggregateDataRate=aggregateDataRate, licence=licence, dataPortStatus=dataPortStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, extendedFreqMHz=extendedFreqMHz, productVariant=productVariant, ethernetGroup=ethernetGroup, vectorError=vectorError, installArmState=installArmState, managementGroup=managementGroup, nTPPollInterval=nTPPollInterval, pubStats=pubStats, sNMPCommunityString=sNMPCommunityString, cableLoss=cableLoss, nTPState=nTPState, receivePower=receivePower, snmpControl=snmpControl, transmitModulationMode=transmitModulationMode, receiveDataRate=receiveDataRate, alarmsGroup=alarmsGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, systemClock=systemClock, noiseFloor=noiseFloor, sNMPCommunityTableNumber=sNMPCommunityTableNumber, antennaGain=antennaGain, ntpGroup=ntpGroup, vlanTagging=vlanTagging, smtp=smtp, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapVersion=sNMPTrapVersion, currentChannel=currentChannel, dualPayload=dualPayload, smtpGroup=smtpGroup, extendedChannel=extendedChannel, timeZone=timeZone, tFTPServerIPAddress=tFTPServerIPAddress, vlanId=vlanId, ptpTrapPrefix=ptpTrapPrefix, sNMPCommunityTableIndex=sNMPCommunityTableIndex, searchState=searchState, ptp250=ptp250, notificationsGroup=notificationsGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, pubStatsGroup=pubStatsGroup, fixedModMode=fixedModMode, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, remoteMACAddress=remoteMACAddress, sNMPTrapTable=sNMPTrapTable, linkLoss=linkLoss, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transmitPower=transmitPower, dataPortAutoNegotiation=dataPortAutoNegotiation, ptpGroups=ptpGroups, ptp=ptp, band=band, ntp=ntp, currentFreqMHz=currentFreqMHz, dataPortStatusTrap=dataPortStatusTrap, signalStrengthRatio=signalStrengthRatio, nTPLastSync=nTPLastSync, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, bootVersion=bootVersion, sMTPSourceEmailAddress=sMTPSourceEmailAddress, radarDetectChannel=radarDetectChannel)
