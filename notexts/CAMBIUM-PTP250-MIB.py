...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", timeZone=timeZone, configuredModulationMode=configuredModulationMode, receiveModulationMode=receiveModulationMode, signalStrengthRatio=signalStrengthRatio, currentFreqMHz=currentFreqMHz, tFTPServerPortNumber=tFTPServerPortNumber, currentChannel=currentChannel, radarDetectChannel=radarDetectChannel, managementGroup=managementGroup, smtpGroup=smtpGroup, ntpGroup=ntpGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, phyStatusGroup=phyStatusGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, maximumTransmitPower=maximumTransmitPower, noWirelessChannelAvailable=noWirelessChannelAvailable, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tFTPServerIPAddress=tFTPServerIPAddress, searchState=searchState, dualPayload=dualPayload, remoteMACAddress=remoteMACAddress, ptmp=ptmp, sNMPCommunityTableEntry=sNMPCommunityTableEntry, smtp=smtp, sMTPServerIPAddress=sMTPServerIPAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, installArmStateTrap=installArmStateTrap, subnetMask=subnetMask, sNMPCommunityString=sNMPCommunityString, vlanId=vlanId, sNMPTrapVersion=sNMPTrapVersion, snmpControl=snmpControl, alarmsGroup=alarmsGroup, productName=productName, configuredRange=configuredRange, receiveDataRate=receiveDataRate, hardwareVersion=hardwareVersion, gatewayIPAddress=gatewayIPAddress, linkStatusTrap=linkStatusTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, nTPPollInterval=nTPPollInterval, sMTPServerPortNumber=sMTPServerPortNumber, ethernet=ethernet, snmpControlGroup=snmpControlGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPCommunityAccess=sNMPCommunityAccess, sNMPCommunityTable=sNMPCommunityTable, configurationGroup=configurationGroup, versionsGroup=versionsGroup, sNMPCommunityTableNumber=sNMPCommunityTableNumber, extendedChannel=extendedChannel, linkName=linkName, transmitPower=transmitPower, softwareVersion=softwareVersion, productVariant=productVariant, licenceGroup=licenceGroup, licence=licence, sNMPCommunityTableIndex=sNMPCommunityTableIndex, bootVersion=bootVersion, iPAddress=iPAddress, ntp=ntp, antennaGain=antennaGain, fixedModMode=fixedModMode, receivePower=receivePower, cableLoss=cableLoss, ptpTrapPrefix=ptpTrapPrefix, vlanPriority=vlanPriority, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, systemClock=systemClock, nTPState=nTPState, management=management, siteName=siteName, channelSelection=channelSelection, nTPSync=nTPSync, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, alarms=alarms, PYSNMP_MODULE_ID=cambium, ptpGroups=ptpGroups, regionCode=regionCode, masterSlaveMode=masterSlaveMode, cambium=cambium, channelBandwidth=channelBandwidth, ptp250=ptp250, transmitDataRate=transmitDataRate, sNMPEnabledTraps=sNMPEnabledTraps, phyStatus=phyStatus, dataPortStatusTrap=dataPortStatusTrap, wirelessLinkStatus=wirelessLinkStatus, ptpCompliance=ptpCompliance, notificationsGroup=notificationsGroup, band=band, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, nTPServerPortNumber=nTPServerPortNumber, pubStatsGroup=pubStatsGroup, linkLoss=linkLoss, configuration=configuration, installArmState=installArmState, noiseFloor=noiseFloor, ethernetGroup=ethernetGroup, sNMPTrapCommunity=sNMPTrapCommunity, sNMPTrapPortNumber=sNMPTrapPortNumber, measuredRange=measuredRange, pubStats=pubStats, extendedFreqMHz=extendedFreqMHz, remoteIPAddress=remoteIPAddress, sNMPCommunityOid=sNMPCommunityOid, sNMPTrapTableNumber=sNMPTrapTableNumber, ptpTraps=ptpTraps, dataPortStatus=dataPortStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, vectorError=vectorError, nTPLastSync=nTPLastSync, sNMPTrapTable=sNMPTrapTable, aggregateDataRate=aggregateDataRate, radarDetectTrap=radarDetectTrap, nTPServerIp=nTPServerIp, vlanTagging=vlanTagging, ptp=ptp, transmitModulationMode=transmitModulationMode, versions=versions)
