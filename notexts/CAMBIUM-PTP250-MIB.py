...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", nTPServerPortNumber=nTPServerPortNumber, configurationGroup=configurationGroup, vlanPriority=vlanPriority, radarDetectChannel=radarDetectChannel, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapCommunity=sNMPTrapCommunity, receiveModulationMode=receiveModulationMode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, subnetMask=subnetMask, management=management, radarDetectTrap=radarDetectTrap, siteName=siteName, sNMPEnabledTraps=sNMPEnabledTraps, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, installArmStateTrap=installArmStateTrap, phyStatus=phyStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, cableLoss=cableLoss, wirelessLinkStatus=wirelessLinkStatus, ptp=ptp, sMTPServerIPAddress=sMTPServerIPAddress, snmpControl=snmpControl, measuredRange=measuredRange, ptmp=ptmp, versionsGroup=versionsGroup, bootVersion=bootVersion, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, vlanId=vlanId, gatewayIPAddress=gatewayIPAddress, receivePower=receivePower, extendedFreqMHz=extendedFreqMHz, pubStatsGroup=pubStatsGroup, hardwareVersion=hardwareVersion, PYSNMP_MODULE_ID=cambium, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, regionCode=regionCode, smtp=smtp, sNMPTrapTable=sNMPTrapTable, configuredModulationMode=configuredModulationMode, licenceGroup=licenceGroup, sNMPCommunityOid=sNMPCommunityOid, signalStrengthRatio=signalStrengthRatio, channelBandwidth=channelBandwidth, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernet=ethernet, ptpCompliance=ptpCompliance, managementGroup=managementGroup, sNMPCommunityString=sNMPCommunityString, linkName=linkName, dataPortStatus=dataPortStatus, maximumTransmitPower=maximumTransmitPower, currentFreqMHz=currentFreqMHz, ptpGroups=ptpGroups, transmitModulationMode=transmitModulationMode, linkStatusTrap=linkStatusTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, extendedChannel=extendedChannel, configuration=configuration, nTPPollInterval=nTPPollInterval, antennaGain=antennaGain, sNMPCommunityAccess=sNMPCommunityAccess, dualPayload=dualPayload, pubStats=pubStats, remoteMACAddress=remoteMACAddress, smtpGroup=smtpGroup, configuredRange=configuredRange, remoteIPAddress=remoteIPAddress, sNMPCommunityTableNumber=sNMPCommunityTableNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapVersion=sNMPTrapVersion, cambium=cambium, sNMPTrapTableEntry=sNMPTrapTableEntry, snmpControlGroup=snmpControlGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, transmitDataRate=transmitDataRate, fixedModMode=fixedModMode, vlanTagging=vlanTagging, tFTPServerPortNumber=tFTPServerPortNumber, productVariant=productVariant, ptpTrapPrefix=ptpTrapPrefix, noiseFloor=noiseFloor, timeZone=timeZone, sNMPCommunityTableEntry=sNMPCommunityTableEntry, alarmsGroup=alarmsGroup, versions=versions, alarms=alarms, iPAddress=iPAddress, notificationsGroup=notificationsGroup, phyStatusGroup=phyStatusGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, installArmState=installArmState, ptpTraps=ptpTraps, currentChannel=currentChannel, ptp250=ptp250, sMTPEnabledMessages=sMTPEnabledMessages, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ethernetGroup=ethernetGroup, nTPLastSync=nTPLastSync, searchState=searchState, aggregateDataRate=aggregateDataRate, nTPState=nTPState, sNMPTrapTableIndex=sNMPTrapTableIndex, transmitPower=transmitPower, ntpGroup=ntpGroup, sNMPCommunityTableIndex=sNMPCommunityTableIndex, dataPortStatusTrap=dataPortStatusTrap, productName=productName, vectorError=vectorError, licence=licence, sMTPServerPortNumber=sMTPServerPortNumber, linkLoss=linkLoss, channelSelection=channelSelection, sNMPCommunityTable=sNMPCommunityTable, masterSlaveMode=masterSlaveMode, band=band, nTPServerIp=nTPServerIp, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ntp=ntp, receiveDataRate=receiveDataRate, systemClock=systemClock, nTPSync=nTPSync, softwareVersion=softwareVersion)
