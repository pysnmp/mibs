...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", PYSNMP_MODULE_ID=cambium, sNMPCommunityOid=sNMPCommunityOid, extendedFreqMHz=extendedFreqMHz, dataPortStatusTrap=dataPortStatusTrap, versions=versions, iPAddress=iPAddress, vlanPriority=vlanPriority, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, remoteIPAddress=remoteIPAddress, nTPState=nTPState, nTPSync=nTPSync, pubStats=pubStats, transmitDataRate=transmitDataRate, licenceGroup=licenceGroup, ethernet=ethernet, receiveDataRate=receiveDataRate, measuredRange=measuredRange, sNMPTrapVersion=sNMPTrapVersion, configuredRange=configuredRange, ptp250=ptp250, currentChannel=currentChannel, phyStatusGroup=phyStatusGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, nTPLastSync=nTPLastSync, sNMPCommunityString=sNMPCommunityString, sNMPTrapIPAddress=sNMPTrapIPAddress, ptpTraps=ptpTraps, snmpControlGroup=snmpControlGroup, productName=productName, alarms=alarms, timeZone=timeZone, remoteMACAddress=remoteMACAddress, smtpGroup=smtpGroup, signalStrengthRatio=signalStrengthRatio, gatewayIPAddress=gatewayIPAddress, linkName=linkName, siteName=siteName, channelSelection=channelSelection, pubStatsGroup=pubStatsGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, vlanTagging=vlanTagging, sNMPCommunityTableNumber=sNMPCommunityTableNumber, notificationsGroup=notificationsGroup, nTPPollInterval=nTPPollInterval, hardwareVersion=hardwareVersion, sNMPTrapTableEntry=sNMPTrapTableEntry, ptp=ptp, sNMPTrapTableNumber=sNMPTrapTableNumber, radarDetectTrap=radarDetectTrap, linkLoss=linkLoss, installArmStateTrap=installArmStateTrap, maximumTransmitPower=maximumTransmitPower, sMTPServerIPAddress=sMTPServerIPAddress, systemClock=systemClock, sMTPEnabledMessages=sMTPEnabledMessages, sNMPCommunityAccess=sNMPCommunityAccess, sNMPCommunityTableEntry=sNMPCommunityTableEntry, management=management, installArmState=installArmState, receiveModulationMode=receiveModulationMode, alarmsGroup=alarmsGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernetGroup=ethernetGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, configuredModulationMode=configuredModulationMode, configurationGroup=configurationGroup, masterSlaveMode=masterSlaveMode, fixedModMode=fixedModMode, transmitModulationMode=transmitModulationMode, noiseFloor=noiseFloor, aggregateDataRate=aggregateDataRate, sNMPTrapCommunity=sNMPTrapCommunity, searchState=searchState, nTPServerPortNumber=nTPServerPortNumber, ntp=ntp, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapTableIndex=sNMPTrapTableIndex, band=band, licence=licence, versionsGroup=versionsGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, vlanId=vlanId, phyStatus=phyStatus, cambium=cambium, extendedChannel=extendedChannel, radarDetectChannel=radarDetectChannel, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptpTrapPrefix=ptpTrapPrefix, regionCode=regionCode, productVariant=productVariant, tFTPServerIPAddress=tFTPServerIPAddress, nTPServerIp=nTPServerIp, currentFreqMHz=currentFreqMHz, antennaGain=antennaGain, ptmp=ptmp, tFTPServerPortNumber=tFTPServerPortNumber, sMTPServerPortNumber=sMTPServerPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, bootVersion=bootVersion, ptpGroups=ptpGroups, sNMPCommunityTable=sNMPCommunityTable, receivePower=receivePower, subnetMask=subnetMask, ntpGroup=ntpGroup, linkStatusTrap=linkStatusTrap, ptpCompliance=ptpCompliance, channelBandwidth=channelBandwidth, vectorError=vectorError, sMTPSourceEmailAddress=sMTPSourceEmailAddress, wirelessLinkStatus=wirelessLinkStatus, snmpControl=snmpControl, smtp=smtp, sNMPCommunityTableIndex=sNMPCommunityTableIndex, configuration=configuration, dataPortStatus=dataPortStatus, transmitPower=transmitPower, cableLoss=cableLoss, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPEnabledTraps=sNMPEnabledTraps, dualPayload=dualPayload, softwareVersion=softwareVersion, sNMPTrapTable=sNMPTrapTable, managementGroup=managementGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText)
