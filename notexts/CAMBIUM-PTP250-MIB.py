...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", masterSlaveMode=masterSlaveMode, radarDetectChannel=radarDetectChannel, dataPortStatus=dataPortStatus, ptpTrapPrefix=ptpTrapPrefix, currentFreqMHz=currentFreqMHz, PYSNMP_MODULE_ID=cambium, sMTPServerIPAddress=sMTPServerIPAddress, dataPortStatusTrap=dataPortStatusTrap, linkLoss=linkLoss, iPAddress=iPAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, softwareVersion=softwareVersion, managementGroup=managementGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, configuredRange=configuredRange, radarDetectTrap=radarDetectTrap, subnetMask=subnetMask, gatewayIPAddress=gatewayIPAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapCommunity=sNMPTrapCommunity, vlanTagging=vlanTagging, nTPLastSync=nTPLastSync, sNMPTrapPortNumber=sNMPTrapPortNumber, searchState=searchState, ptp250=ptp250, sNMPCommunityTableEntry=sNMPCommunityTableEntry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, maximumTransmitPower=maximumTransmitPower, siteName=siteName, ntp=ntp, vlanPriority=vlanPriority, channelSelection=channelSelection, tFTPServerIPAddress=tFTPServerIPAddress, licenceGroup=licenceGroup, ptp=ptp, hardwareVersion=hardwareVersion, receiveModulationMode=receiveModulationMode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, pubStats=pubStats, sNMPTrapTableIndex=sNMPTrapTableIndex, band=band, ethernetGroup=ethernetGroup, antennaGain=antennaGain, sNMPEnabledTraps=sNMPEnabledTraps, fixedModMode=fixedModMode, dualPayload=dualPayload, aggregateDataRate=aggregateDataRate, sNMPCommunityAccess=sNMPCommunityAccess, transmitModulationMode=transmitModulationMode, snmpControlGroup=snmpControlGroup, smtp=smtp, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sNMPCommunityOid=sNMPCommunityOid, configuration=configuration, productName=productName, extendedChannel=extendedChannel, noiseFloor=noiseFloor, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, licence=licence, linkName=linkName, productVariant=productVariant, vectorError=vectorError, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, timeZone=timeZone, receivePower=receivePower, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, transmitPower=transmitPower, vlanId=vlanId, signalStrengthRatio=signalStrengthRatio, phyStatusGroup=phyStatusGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, installArmState=installArmState, phyStatus=phyStatus, ptpCompliance=ptpCompliance, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sMTPEnabledMessages=sMTPEnabledMessages, ptmp=ptmp, transmitDataRate=transmitDataRate, ptpTraps=ptpTraps, installArmStateTrap=installArmStateTrap, nTPSync=nTPSync, regionCode=regionCode, linkStatusTrap=linkStatusTrap, alarmsGroup=alarmsGroup, channelBandwidth=channelBandwidth, remoteMACAddress=remoteMACAddress, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapTable=sNMPTrapTable, sNMPTrapTableEntry=sNMPTrapTableEntry, cableLoss=cableLoss, nTPServerIp=nTPServerIp, tFTPServerPortNumber=tFTPServerPortNumber, wirelessLinkStatus=wirelessLinkStatus, notificationsGroup=notificationsGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, bootVersion=bootVersion, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ntpGroup=ntpGroup, extendedFreqMHz=extendedFreqMHz, systemClock=systemClock, nTPState=nTPState, snmpControl=snmpControl, sNMPCommunityString=sNMPCommunityString, management=management, sMTPServerPortNumber=sMTPServerPortNumber, alarms=alarms, configuredModulationMode=configuredModulationMode, smtpGroup=smtpGroup, nTPServerPortNumber=nTPServerPortNumber, ethernet=ethernet, remoteIPAddress=remoteIPAddress, pubStatsGroup=pubStatsGroup, versionsGroup=versionsGroup, measuredRange=measuredRange, noWirelessChannelAvailable=noWirelessChannelAvailable, cambium=cambium, currentChannel=currentChannel, versions=versions, ptpGroups=ptpGroups, nTPPollInterval=nTPPollInterval, configurationGroup=configurationGroup, receiveDataRate=receiveDataRate, sNMPCommunityTable=sNMPCommunityTable)
