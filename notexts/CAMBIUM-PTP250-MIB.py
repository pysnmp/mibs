...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", transmitDataRate=transmitDataRate, management=management, noWirelessChannelAvailable=noWirelessChannelAvailable, ptpGroups=ptpGroups, alarmsGroup=alarmsGroup, sNMPCommunityString=sNMPCommunityString, dataPortStatus=dataPortStatus, configurationGroup=configurationGroup, snmpControlGroup=snmpControlGroup, sNMPCommunityTableEntry=sNMPCommunityTableEntry, ethernet=ethernet, sNMPCommunityTable=sNMPCommunityTable, configuredModulationMode=configuredModulationMode, linkName=linkName, siteName=siteName, band=band, phyStatus=phyStatus, linkLoss=linkLoss, vlanId=vlanId, sNMPEnabledTraps=sNMPEnabledTraps, remoteIPAddress=remoteIPAddress, ethernetGroup=ethernetGroup, smtpGroup=smtpGroup, sNMPTrapVersion=sNMPTrapVersion, ptp250=ptp250, vlanPriority=vlanPriority, cableLoss=cableLoss, vlanTagging=vlanTagging, sNMPTrapPortNumber=sNMPTrapPortNumber, vectorError=vectorError, nTPLastSync=nTPLastSync, sNMPCommunityTableIndex=sNMPCommunityTableIndex, transmitPower=transmitPower, versions=versions, tFTPServerPortNumber=tFTPServerPortNumber, searchState=searchState, softwareVersion=softwareVersion, currentChannel=currentChannel, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, pubStats=pubStats, wirelessLinkStatus=wirelessLinkStatus, productName=productName, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, radarDetectChannel=radarDetectChannel, measuredRange=measuredRange, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, versionsGroup=versionsGroup, ntpGroup=ntpGroup, smtp=smtp, configuredRange=configuredRange, productVariant=productVariant, dataPortStatusTrap=dataPortStatusTrap, sNMPCommunityOid=sNMPCommunityOid, systemClock=systemClock, nTPSync=nTPSync, cambium=cambium, sNMPTrapTableIndex=sNMPTrapTableIndex, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, channelBandwidth=channelBandwidth, nTPServerPortNumber=nTPServerPortNumber, maximumTransmitPower=maximumTransmitPower, managementGroup=managementGroup, ptpTraps=ptpTraps, iPAddress=iPAddress, sMTPEnabledMessages=sMTPEnabledMessages, licence=licence, sMTPServerPortNumber=sMTPServerPortNumber, bootVersion=bootVersion, gatewayIPAddress=gatewayIPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, linkStatusTrap=linkStatusTrap, ptpCompliance=ptpCompliance, licenceGroup=licenceGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, signalStrengthRatio=signalStrengthRatio, pubStatsGroup=pubStatsGroup, masterSlaveMode=masterSlaveMode, tFTPServerIPAddress=tFTPServerIPAddress, receiveDataRate=receiveDataRate, extendedChannel=extendedChannel, receiveModulationMode=receiveModulationMode, ptmp=ptmp, sNMPTrapTable=sNMPTrapTable, dualPayload=dualPayload, sMTPServerIPAddress=sMTPServerIPAddress, nTPPollInterval=nTPPollInterval, fixedModMode=fixedModMode, noiseFloor=noiseFloor, installArmStateTrap=installArmStateTrap, timeZone=timeZone, sNMPCommunityTableNumber=sNMPCommunityTableNumber, PYSNMP_MODULE_ID=cambium, snmpControl=snmpControl, remoteMACAddress=remoteMACAddress, installArmState=installArmState, extendedFreqMHz=extendedFreqMHz, aggregateDataRate=aggregateDataRate, sNMPTrapTableNumber=sNMPTrapTableNumber, ptpTrapPrefix=ptpTrapPrefix, transmitModulationMode=transmitModulationMode, currentFreqMHz=currentFreqMHz, subnetMask=subnetMask, receivePower=receivePower, channelSelection=channelSelection, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, nTPState=nTPState, configuration=configuration, nTPServerIp=nTPServerIp, antennaGain=antennaGain, sNMPCommunityAccess=sNMPCommunityAccess, notificationsGroup=notificationsGroup, sNMPTrapCommunity=sNMPTrapCommunity, ptp=ptp, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ntp=ntp, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, phyStatusGroup=phyStatusGroup, hardwareVersion=hardwareVersion, radarDetectTrap=radarDetectTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, alarms=alarms, sNMPTrapIPAddress=sNMPTrapIPAddress, regionCode=regionCode)
