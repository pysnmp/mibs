...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", ethernet=ethernet, ptpTrapPrefix=ptpTrapPrefix, ptpCompliance=ptpCompliance, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, timeZone=timeZone, phyStatus=phyStatus, installArmState=installArmState, PYSNMP_MODULE_ID=cambium, measuredRange=measuredRange, sMTPServerPortNumber=sMTPServerPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, transmitDataRate=transmitDataRate, bootVersion=bootVersion, productVariant=productVariant, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPCommunityTableEntry=sNMPCommunityTableEntry, configuredModulationMode=configuredModulationMode, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptpTraps=ptpTraps, vectorError=vectorError, smtpGroup=smtpGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, versions=versions, configurationGroup=configurationGroup, channelSelection=channelSelection, sNMPTrapIPAddress=sNMPTrapIPAddress, phyStatusGroup=phyStatusGroup, sNMPTrapCommunity=sNMPTrapCommunity, receiveDataRate=receiveDataRate, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, currentFreqMHz=currentFreqMHz, radarDetectChannel=radarDetectChannel, extendedFreqMHz=extendedFreqMHz, ethernetGroup=ethernetGroup, sNMPEnabledTraps=sNMPEnabledTraps, currentChannel=currentChannel, configuration=configuration, aggregateDataRate=aggregateDataRate, sNMPCommunityAccess=sNMPCommunityAccess, receivePower=receivePower, dualPayload=dualPayload, ptpGroups=ptpGroups, transmitPower=transmitPower, radarDetectTrap=radarDetectTrap, versionsGroup=versionsGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPServerIPAddress=sMTPServerIPAddress, subnetMask=subnetMask, nTPServerPortNumber=nTPServerPortNumber, cambium=cambium, managementGroup=managementGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, licence=licence, nTPState=nTPState, nTPLastSync=nTPLastSync, nTPServerIp=nTPServerIp, smtp=smtp, snmpControl=snmpControl, snmpControlGroup=snmpControlGroup, cableLoss=cableLoss, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, wirelessLinkStatus=wirelessLinkStatus, signalStrengthRatio=signalStrengthRatio, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ptmp=ptmp, sNMPCommunityString=sNMPCommunityString, sNMPCommunityTableNumber=sNMPCommunityTableNumber, vlanPriority=vlanPriority, sNMPTrapTable=sNMPTrapTable, ntp=ntp, sNMPTrapTableNumber=sNMPTrapTableNumber, channelBandwidth=channelBandwidth, dataPortStatusTrap=dataPortStatusTrap, sNMPTrapVersion=sNMPTrapVersion, productName=productName, notificationsGroup=notificationsGroup, hardwareVersion=hardwareVersion, vlanId=vlanId, ntpGroup=ntpGroup, licenceGroup=licenceGroup, vlanTagging=vlanTagging, tFTPServerIPAddress=tFTPServerIPAddress, sNMPCommunityTableIndex=sNMPCommunityTableIndex, configuredRange=configuredRange, pubStats=pubStats, band=band, pubStatsGroup=pubStatsGroup, masterSlaveMode=masterSlaveMode, nTPPollInterval=nTPPollInterval, ptp250=ptp250, alarmsGroup=alarmsGroup, remoteMACAddress=remoteMACAddress, searchState=searchState, tFTPServerPortNumber=tFTPServerPortNumber, sNMPCommunityTable=sNMPCommunityTable, siteName=siteName, nTPSync=nTPSync, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPCommunityOid=sNMPCommunityOid, dataPortStatus=dataPortStatus, installArmStateTrap=installArmStateTrap, softwareVersion=softwareVersion, management=management, sNMPTrapTableEntry=sNMPTrapTableEntry, linkLoss=linkLoss, noiseFloor=noiseFloor, regionCode=regionCode, maximumTransmitPower=maximumTransmitPower, iPAddress=iPAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, extendedChannel=extendedChannel, sMTPSourceEmailAddress=sMTPSourceEmailAddress, antennaGain=antennaGain, transmitModulationMode=transmitModulationMode, ptp=ptp, sNMPTrapPortNumber=sNMPTrapPortNumber, systemClock=systemClock, linkName=linkName, receiveModulationMode=receiveModulationMode, linkStatusTrap=linkStatusTrap, alarms=alarms, remoteIPAddress=remoteIPAddress, fixedModMode=fixedModMode, gatewayIPAddress=gatewayIPAddress)
