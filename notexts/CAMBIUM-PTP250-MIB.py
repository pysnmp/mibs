...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", ptpTraps=ptpTraps, radarDetectChannel=radarDetectChannel, systemClock=systemClock, receiveModulationMode=receiveModulationMode, productName=productName, gatewayIPAddress=gatewayIPAddress, sNMPCommunityString=sNMPCommunityString, alarmsGroup=alarmsGroup, phyStatus=phyStatus, channelBandwidth=channelBandwidth, ptp250=ptp250, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, transmitDataRate=transmitDataRate, sNMPEnabledTraps=sNMPEnabledTraps, nTPPollInterval=nTPPollInterval, ptpTrapPrefix=ptpTrapPrefix, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, radarDetectTrap=radarDetectTrap, extendedFreqMHz=extendedFreqMHz, sNMPTrapIPAddress=sNMPTrapIPAddress, licenceGroup=licenceGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, configuration=configuration, aggregateDataRate=aggregateDataRate, dataPortStatus=dataPortStatus, searchState=searchState, nTPState=nTPState, antennaGain=antennaGain, fixedModMode=fixedModMode, phyStatusGroup=phyStatusGroup, versions=versions, nTPServerPortNumber=nTPServerPortNumber, bootVersion=bootVersion, managementGroup=managementGroup, configuredRange=configuredRange, vlanId=vlanId, tFTPServerIPAddress=tFTPServerIPAddress, siteName=siteName, currentFreqMHz=currentFreqMHz, ethernetGroup=ethernetGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, maximumTransmitPower=maximumTransmitPower, iPAddress=iPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, cambium=cambium, linkLoss=linkLoss, licence=licence, nTPSync=nTPSync, linkName=linkName, sNMPCommunityOid=sNMPCommunityOid, management=management, remoteIPAddress=remoteIPAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortAutoNegotiation=dataPortAutoNegotiation, measuredRange=measuredRange, ntp=ntp, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, band=band, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sNMPTrapVersion=sNMPTrapVersion, notificationsGroup=notificationsGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, vectorError=vectorError, vlanPriority=vlanPriority, ptmp=ptmp, transmitPower=transmitPower, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, linkStatusTrap=linkStatusTrap, pubStats=pubStats, signalStrengthRatio=signalStrengthRatio, snmpControl=snmpControl, masterSlaveMode=masterSlaveMode, sNMPCommunityTable=sNMPCommunityTable, alarms=alarms, transmitModulationMode=transmitModulationMode, snmpControlGroup=snmpControlGroup, installArmStateTrap=installArmStateTrap, dataPortStatusTrap=dataPortStatusTrap, channelSelection=channelSelection, vlanTagging=vlanTagging, sNMPTrapCommunity=sNMPTrapCommunity, receiveDataRate=receiveDataRate, currentChannel=currentChannel, ptp=ptp, sMTPServerIPAddress=sMTPServerIPAddress, receivePower=receivePower, softwareVersion=softwareVersion, hardwareVersion=hardwareVersion, nTPLastSync=nTPLastSync, nTPServerIp=nTPServerIp, sMTPEnabledMessages=sMTPEnabledMessages, productVariant=productVariant, sMTPServerPortNumber=sMTPServerPortNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ptpCompliance=ptpCompliance, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sNMPTrapTable=sNMPTrapTable, noiseFloor=noiseFloor, remoteMACAddress=remoteMACAddress, versionsGroup=versionsGroup, extendedChannel=extendedChannel, regionCode=regionCode, configuredModulationMode=configuredModulationMode, installArmState=installArmState, ntpGroup=ntpGroup, PYSNMP_MODULE_ID=cambium, sNMPCommunityTableIndex=sNMPCommunityTableIndex, timeZone=timeZone, tFTPServerPortNumber=tFTPServerPortNumber, subnetMask=subnetMask, smtp=smtp, dualPayload=dualPayload, cableLoss=cableLoss, ethernet=ethernet, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, ptpGroups=ptpGroups, smtpGroup=smtpGroup, wirelessLinkStatus=wirelessLinkStatus, configurationGroup=configurationGroup, pubStatsGroup=pubStatsGroup, sNMPCommunityAccess=sNMPCommunityAccess)
