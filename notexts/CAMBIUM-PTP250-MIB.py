...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", smtp=smtp, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPCommunityString=sNMPCommunityString, nTPServerIp=nTPServerIp, radarDetectChannel=radarDetectChannel, pubStats=pubStats, sNMPTrapTable=sNMPTrapTable, fixedModMode=fixedModMode, sMTPServerIPAddress=sMTPServerIPAddress, alarms=alarms, remoteMACAddress=remoteMACAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, extendedChannel=extendedChannel, sNMPCommunityTableEntry=sNMPCommunityTableEntry, measuredRange=measuredRange, tFTPServerIPAddress=tFTPServerIPAddress, dataPortStatus=dataPortStatus, linkLoss=linkLoss, noWirelessChannelAvailable=noWirelessChannelAvailable, masterSlaveMode=masterSlaveMode, remoteIPAddress=remoteIPAddress, iPAddress=iPAddress, pubStatsGroup=pubStatsGroup, sMTPEnabledMessages=sMTPEnabledMessages, configurationGroup=configurationGroup, linkName=linkName, regionCode=regionCode, transmitModulationMode=transmitModulationMode, sNMPCommunityOid=sNMPCommunityOid, versionsGroup=versionsGroup, ptmp=ptmp, ethernet=ethernet, sNMPTrapCommunity=sNMPTrapCommunity, nTPLastSync=nTPLastSync, receivePower=receivePower, configuredRange=configuredRange, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPCommunityTable=sNMPCommunityTable, ntpGroup=ntpGroup, phyStatusGroup=phyStatusGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, signalStrengthRatio=signalStrengthRatio, timeZone=timeZone, vlanId=vlanId, noiseFloor=noiseFloor, dualPayload=dualPayload, sMTPServerPortNumber=sMTPServerPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, band=band, PYSNMP_MODULE_ID=cambium, ptp250=ptp250, snmpControl=snmpControl, tFTPServerPortNumber=tFTPServerPortNumber, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, productName=productName, dataPortStatusTrap=dataPortStatusTrap, sNMPCommunityAccess=sNMPCommunityAccess, sNMPTrapIPAddress=sNMPTrapIPAddress, softwareVersion=softwareVersion, ptpCompliance=ptpCompliance, configuration=configuration, transmitDataRate=transmitDataRate, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitPower=transmitPower, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkStatusTrap=linkStatusTrap, management=management, ptp=ptp, sNMPTrapPortNumber=sNMPTrapPortNumber, productVariant=productVariant, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapVersion=sNMPTrapVersion, receiveDataRate=receiveDataRate, configuredModulationMode=configuredModulationMode, snmpControlGroup=snmpControlGroup, ptpGroups=ptpGroups, versions=versions, siteName=siteName, channelSelection=channelSelection, ptpTraps=ptpTraps, hardwareVersion=hardwareVersion, nTPState=nTPState, nTPPollInterval=nTPPollInterval, installArmState=installArmState, receiveModulationMode=receiveModulationMode, radarDetectTrap=radarDetectTrap, cambium=cambium, vlanPriority=vlanPriority, dataPortAutoNegotiation=dataPortAutoNegotiation, smtpGroup=smtpGroup, systemClock=systemClock, currentFreqMHz=currentFreqMHz, nTPServerPortNumber=nTPServerPortNumber, alarmsGroup=alarmsGroup, licenceGroup=licenceGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, phyStatus=phyStatus, searchState=searchState, gatewayIPAddress=gatewayIPAddress, aggregateDataRate=aggregateDataRate, maximumTransmitPower=maximumTransmitPower, licence=licence, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, vectorError=vectorError, sNMPTrapTableNumber=sNMPTrapTableNumber, ethernetGroup=ethernetGroup, nTPSync=nTPSync, cableLoss=cableLoss, bootVersion=bootVersion, currentChannel=currentChannel, subnetMask=subnetMask, sNMPCommunityTableIndex=sNMPCommunityTableIndex, extendedFreqMHz=extendedFreqMHz, wirelessLinkStatus=wirelessLinkStatus, installArmStateTrap=installArmStateTrap, managementGroup=managementGroup, ptpTrapPrefix=ptpTrapPrefix, antennaGain=antennaGain, vlanTagging=vlanTagging, channelBandwidth=channelBandwidth, notificationsGroup=notificationsGroup, ntp=ntp)
