...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", extendedFreqMHz=extendedFreqMHz, snmpControl=snmpControl, dualPayload=dualPayload, ptp250=ptp250, nTPServerIp=nTPServerIp, wirelessLinkStatus=wirelessLinkStatus, sNMPTrapVersion=sNMPTrapVersion, ntp=ntp, alarms=alarms, ptpCompliance=ptpCompliance, remoteIPAddress=remoteIPAddress, productName=productName, dataPortStatus=dataPortStatus, band=band, radarDetectTrap=radarDetectTrap, ptp=ptp, channelSelection=channelSelection, sNMPTrapTableIndex=sNMPTrapTableIndex, phyStatusGroup=phyStatusGroup, timeZone=timeZone, notificationsGroup=notificationsGroup, ethernetGroup=ethernetGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receiveDataRate=receiveDataRate, smtpGroup=smtpGroup, nTPServerPortNumber=nTPServerPortNumber, sNMPTrapTable=sNMPTrapTable, sMTPServerPortNumber=sMTPServerPortNumber, smtp=smtp, configuredModulationMode=configuredModulationMode, regionCode=regionCode, systemClock=systemClock, gatewayIPAddress=gatewayIPAddress, cambium=cambium, vlanId=vlanId, searchState=searchState, vlanPriority=vlanPriority, versionsGroup=versionsGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, maximumTransmitPower=maximumTransmitPower, subnetMask=subnetMask, sNMPCommunityString=sNMPCommunityString, linkName=linkName, nTPSync=nTPSync, nTPPollInterval=nTPPollInterval, noiseFloor=noiseFloor, ntpGroup=ntpGroup, linkLoss=linkLoss, installArmState=installArmState, ptmp=ptmp, sNMPEnabledTraps=sNMPEnabledTraps, cableLoss=cableLoss, sNMPCommunityTable=sNMPCommunityTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPEnabledMessages=sMTPEnabledMessages, vlanTagging=vlanTagging, antennaGain=antennaGain, remoteMACAddress=remoteMACAddress, transmitModulationMode=transmitModulationMode, extendedChannel=extendedChannel, PYSNMP_MODULE_ID=cambium, nTPState=nTPState, sNMPTrapTableNumber=sNMPTrapTableNumber, receivePower=receivePower, hardwareVersion=hardwareVersion, sMTPServerIPAddress=sMTPServerIPAddress, transmitDataRate=transmitDataRate, nTPLastSync=nTPLastSync, alarmsGroup=alarmsGroup, signalStrengthRatio=signalStrengthRatio, snmpControlGroup=snmpControlGroup, pubStatsGroup=pubStatsGroup, sNMPCommunityTableIndex=sNMPCommunityTableIndex, linkStatusTrap=linkStatusTrap, transmitPower=transmitPower, ethernet=ethernet, versions=versions, sNMPTrapIPAddress=sNMPTrapIPAddress, bootVersion=bootVersion, softwareVersion=softwareVersion, dataPortStatusTrap=dataPortStatusTrap, phyStatus=phyStatus, ptpGroups=ptpGroups, configurationGroup=configurationGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, vectorError=vectorError, ptpTraps=ptpTraps, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPCommunityOid=sNMPCommunityOid, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPServerIPAddress=tFTPServerIPAddress, pubStats=pubStats, radarDetectChannel=radarDetectChannel, sNMPCommunityTableEntry=sNMPCommunityTableEntry, managementGroup=managementGroup, siteName=siteName, masterSlaveMode=masterSlaveMode, receiveModulationMode=receiveModulationMode, measuredRange=measuredRange, licenceGroup=licenceGroup, iPAddress=iPAddress, sNMPTrapCommunity=sNMPTrapCommunity, productVariant=productVariant, configuration=configuration, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPServerPortNumber=tFTPServerPortNumber, sNMPCommunityTableNumber=sNMPCommunityTableNumber, installArmStateTrap=installArmStateTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, licence=licence, currentFreqMHz=currentFreqMHz, management=management, configuredRange=configuredRange, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptpTrapPrefix=ptpTrapPrefix, sNMPCommunityAccess=sNMPCommunityAccess, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, aggregateDataRate=aggregateDataRate, channelBandwidth=channelBandwidth, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, currentChannel=currentChannel, fixedModMode=fixedModMode)
