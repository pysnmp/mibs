...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", installArmState=installArmState, gatewayIPAddress=gatewayIPAddress, timeZone=timeZone, ptpTraps=ptpTraps, cambium=cambium, signalStrengthRatio=signalStrengthRatio, sNMPTrapPortNumber=sNMPTrapPortNumber, aggregateDataRate=aggregateDataRate, sNMPTrapTable=sNMPTrapTable, sNMPTrapIPAddress=sNMPTrapIPAddress, regionCode=regionCode, linkStatusTrap=linkStatusTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, ptpTrapPrefix=ptpTrapPrefix, linkName=linkName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, iPAddress=iPAddress, dualPayload=dualPayload, sNMPTrapCommunity=sNMPTrapCommunity, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sMTPServerIPAddress=sMTPServerIPAddress, wirelessLinkStatus=wirelessLinkStatus, dataPortStatusTrap=dataPortStatusTrap, sMTPEnabledMessages=sMTPEnabledMessages, configurationGroup=configurationGroup, extendedFreqMHz=extendedFreqMHz, versionsGroup=versionsGroup, nTPServerIp=nTPServerIp, channelBandwidth=channelBandwidth, sNMPCommunityTable=sNMPCommunityTable, productVariant=productVariant, pubStats=pubStats, phyStatus=phyStatus, snmpControl=snmpControl, sNMPCommunityString=sNMPCommunityString, bootVersion=bootVersion, fixedModMode=fixedModMode, linkLoss=linkLoss, nTPServerPortNumber=nTPServerPortNumber, managementGroup=managementGroup, ptpGroups=ptpGroups, ethernet=ethernet, maximumTransmitPower=maximumTransmitPower, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, radarDetectChannel=radarDetectChannel, cableLoss=cableLoss, masterSlaveMode=masterSlaveMode, configuredRange=configuredRange, currentChannel=currentChannel, tFTPServerIPAddress=tFTPServerIPAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPTrapVersion=sNMPTrapVersion, receiveDataRate=receiveDataRate, vlanId=vlanId, versions=versions, productName=productName, sNMPEnabledTraps=sNMPEnabledTraps, vlanPriority=vlanPriority, systemClock=systemClock, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, subnetMask=subnetMask, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, pubStatsGroup=pubStatsGroup, hardwareVersion=hardwareVersion, alarms=alarms, receiveModulationMode=receiveModulationMode, ntpGroup=ntpGroup, nTPState=nTPState, sMTPServerPortNumber=sMTPServerPortNumber, vectorError=vectorError, receivePower=receivePower, transmitModulationMode=transmitModulationMode, smtpGroup=smtpGroup, ptmp=ptmp, phyStatusGroup=phyStatusGroup, sNMPCommunityAccess=sNMPCommunityAccess, nTPSync=nTPSync, dataPortAutoNegotiation=dataPortAutoNegotiation, radarDetectTrap=radarDetectTrap, ptp=ptp, extendedChannel=extendedChannel, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, remoteMACAddress=remoteMACAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, smtp=smtp, sNMPCommunityOid=sNMPCommunityOid, nTPPollInterval=nTPPollInterval, ethernetGroup=ethernetGroup, softwareVersion=softwareVersion, licenceGroup=licenceGroup, remoteIPAddress=remoteIPAddress, siteName=siteName, sMTPSourceEmailAddress=sMTPSourceEmailAddress, channelSelection=channelSelection, vlanTagging=vlanTagging, management=management, antennaGain=antennaGain, PYSNMP_MODULE_ID=cambium, band=band, ptp250=ptp250, sNMPTrapTableIndex=sNMPTrapTableIndex, searchState=searchState, tFTPServerPortNumber=tFTPServerPortNumber, currentFreqMHz=currentFreqMHz, noWirelessChannelAvailable=noWirelessChannelAvailable, notificationsGroup=notificationsGroup, configuredModulationMode=configuredModulationMode, dataPortStatus=dataPortStatus, configuration=configuration, ntp=ntp, transmitPower=transmitPower, transmitDataRate=transmitDataRate, alarmsGroup=alarmsGroup, ptpCompliance=ptpCompliance, installArmStateTrap=installArmStateTrap, licence=licence, noiseFloor=noiseFloor, nTPLastSync=nTPLastSync, sNMPCommunityTableEntry=sNMPCommunityTableEntry, snmpControlGroup=snmpControlGroup, measuredRange=measuredRange, sNMPCommunityTableIndex=sNMPCommunityTableIndex)
