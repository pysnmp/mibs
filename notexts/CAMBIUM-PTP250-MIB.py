...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPCommunityTableEntry=sNMPCommunityTableEntry, nTPPollInterval=nTPPollInterval, linkStatusTrap=linkStatusTrap, vectorError=vectorError, sNMPCommunityString=sNMPCommunityString, fixedModMode=fixedModMode, sNMPCommunityAccess=sNMPCommunityAccess, sNMPTrapTable=sNMPTrapTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPEnabledTraps=sNMPEnabledTraps, ptp250=ptp250, vlanTagging=vlanTagging, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, configuredModulationMode=configuredModulationMode, aggregateDataRate=aggregateDataRate, configuration=configuration, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tFTPServerIPAddress=tFTPServerIPAddress, currentFreqMHz=currentFreqMHz, masterSlaveMode=masterSlaveMode, configurationGroup=configurationGroup, management=management, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, nTPServerIp=nTPServerIp, signalStrengthRatio=signalStrengthRatio, ptpGroups=ptpGroups, noWirelessChannelAvailable=noWirelessChannelAvailable, installArmStateTrap=installArmStateTrap, installArmState=installArmState, sNMPCommunityTable=sNMPCommunityTable, iPAddress=iPAddress, phyStatus=phyStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPTrapVersion=sNMPTrapVersion, PYSNMP_MODULE_ID=cambium, channelBandwidth=channelBandwidth, nTPSync=nTPSync, regionCode=regionCode, ethernet=ethernet, sNMPTrapTableNumber=sNMPTrapTableNumber, vlanId=vlanId, alarmsGroup=alarmsGroup, notificationsGroup=notificationsGroup, receiveModulationMode=receiveModulationMode, ntpGroup=ntpGroup, pubStats=pubStats, sMTPServerIPAddress=sMTPServerIPAddress, maximumTransmitPower=maximumTransmitPower, transmitPower=transmitPower, linkName=linkName, sNMPTrapTableEntry=sNMPTrapTableEntry, noiseFloor=noiseFloor, radarDetectTrap=radarDetectTrap, bootVersion=bootVersion, cableLoss=cableLoss, linkLoss=linkLoss, extendedChannel=extendedChannel, extendedFreqMHz=extendedFreqMHz, ntp=ntp, licenceGroup=licenceGroup, ptp=ptp, band=band, sNMPCommunityOid=sNMPCommunityOid, productVariant=productVariant, sNMPTrapCommunity=sNMPTrapCommunity, softwareVersion=softwareVersion, channelSelection=channelSelection, systemClock=systemClock, ptmp=ptmp, measuredRange=measuredRange, siteName=siteName, subnetMask=subnetMask, configuredRange=configuredRange, receivePower=receivePower, ptpCompliance=ptpCompliance, radarDetectChannel=radarDetectChannel, alarms=alarms, dataPortStatus=dataPortStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sMTPServerPortNumber=sMTPServerPortNumber, transmitModulationMode=transmitModulationMode, sNMPTrapIPAddress=sNMPTrapIPAddress, managementGroup=managementGroup, ptpTraps=ptpTraps, receiveDataRate=receiveDataRate, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ethernetGroup=ethernetGroup, productName=productName, versions=versions, hardwareVersion=hardwareVersion, snmpControlGroup=snmpControlGroup, pubStatsGroup=pubStatsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, snmpControl=snmpControl, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, transmitDataRate=transmitDataRate, remoteIPAddress=remoteIPAddress, vlanPriority=vlanPriority, currentChannel=currentChannel, sNMPTrapTableIndex=sNMPTrapTableIndex, nTPLastSync=nTPLastSync, phyStatusGroup=phyStatusGroup, searchState=searchState, sMTPEnabledMessages=sMTPEnabledMessages, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dualPayload=dualPayload, dataPortStatusTrap=dataPortStatusTrap, nTPState=nTPState, wirelessLinkStatus=wirelessLinkStatus, timeZone=timeZone, antennaGain=antennaGain, ptpTrapPrefix=ptpTrapPrefix, nTPServerPortNumber=nTPServerPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, versionsGroup=versionsGroup, cambium=cambium, gatewayIPAddress=gatewayIPAddress, smtpGroup=smtpGroup, remoteMACAddress=remoteMACAddress, smtp=smtp, licence=licence, tFTPServerPortNumber=tFTPServerPortNumber)
