...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", hardwareVersion=hardwareVersion, configurationGroup=configurationGroup, wirelessLinkStatus=wirelessLinkStatus, masterSlaveMode=masterSlaveMode, sNMPCommunityString=sNMPCommunityString, sNMPTrapIPAddress=sNMPTrapIPAddress, nTPServerPortNumber=nTPServerPortNumber, siteName=siteName, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, radarDetectTrap=radarDetectTrap, cambium=cambium, channelBandwidth=channelBandwidth, sNMPCommunityAccess=sNMPCommunityAccess, sNMPCommunityOid=sNMPCommunityOid, channelSelection=channelSelection, configuration=configuration, ptp250=ptp250, versionsGroup=versionsGroup, nTPPollInterval=nTPPollInterval, dataPortStatusTrap=dataPortStatusTrap, snmpControl=snmpControl, sNMPCommunityTableEntry=sNMPCommunityTableEntry, aggregateDataRate=aggregateDataRate, ptpTraps=ptpTraps, installArmStateTrap=installArmStateTrap, phyStatusGroup=phyStatusGroup, ethernetGroup=ethernetGroup, transmitModulationMode=transmitModulationMode, sNMPCommunityTableNumber=sNMPCommunityTableNumber, systemClock=systemClock, phyStatus=phyStatus, sMTPServerPortNumber=sMTPServerPortNumber, vlanPriority=vlanPriority, smtpGroup=smtpGroup, licenceGroup=licenceGroup, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, nTPState=nTPState, receivePower=receivePower, transmitDataRate=transmitDataRate, ethernet=ethernet, ptp=ptp, alarms=alarms, searchState=searchState, nTPLastSync=nTPLastSync, versions=versions, remoteMACAddress=remoteMACAddress, vlanTagging=vlanTagging, sNMPTrapTableNumber=sNMPTrapTableNumber, ntp=ntp, vlanId=vlanId, dataPortAutoNegotiation=dataPortAutoNegotiation, noiseFloor=noiseFloor, linkStatusTrap=linkStatusTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, PYSNMP_MODULE_ID=cambium, productVariant=productVariant, regionCode=regionCode, sNMPCommunityTable=sNMPCommunityTable, configuredRange=configuredRange, radarDetectChannel=radarDetectChannel, antennaGain=antennaGain, sNMPTrapPortNumber=sNMPTrapPortNumber, measuredRange=measuredRange, nTPSync=nTPSync, managementGroup=managementGroup, notificationsGroup=notificationsGroup, snmpControlGroup=snmpControlGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, extendedFreqMHz=extendedFreqMHz, sMTPEnabledMessages=sMTPEnabledMessages, transmitPower=transmitPower, remoteIPAddress=remoteIPAddress, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sNMPEnabledTraps=sNMPEnabledTraps, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapTable=sNMPTrapTable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, receiveModulationMode=receiveModulationMode, ptpCompliance=ptpCompliance, cableLoss=cableLoss, ptpGroups=ptpGroups, maximumTransmitPower=maximumTransmitPower, ntpGroup=ntpGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, licence=licence, ptmp=ptmp, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, pubStats=pubStats, sNMPTrapVersion=sNMPTrapVersion, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, fixedModMode=fixedModMode, smtp=smtp, linkName=linkName, timeZone=timeZone, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, signalStrengthRatio=signalStrengthRatio, pubStatsGroup=pubStatsGroup, extendedChannel=extendedChannel, linkLoss=linkLoss, sNMPTrapCommunity=sNMPTrapCommunity, productName=productName, band=band, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, subnetMask=subnetMask, vectorError=vectorError, configuredModulationMode=configuredModulationMode, dualPayload=dualPayload, currentChannel=currentChannel, alarmsGroup=alarmsGroup, iPAddress=iPAddress, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, softwareVersion=softwareVersion, bootVersion=bootVersion, nTPServerIp=nTPServerIp, management=management, ptpTrapPrefix=ptpTrapPrefix, receiveDataRate=receiveDataRate, gatewayIPAddress=gatewayIPAddress, dataPortStatus=dataPortStatus, currentFreqMHz=currentFreqMHz, installArmState=installArmState)
