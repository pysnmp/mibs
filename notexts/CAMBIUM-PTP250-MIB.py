...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", linkName=linkName, ptp=ptp, nTPLastSync=nTPLastSync, nTPServerPortNumber=nTPServerPortNumber, versions=versions, cableLoss=cableLoss, remoteMACAddress=remoteMACAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, nTPSync=nTPSync, configuredModulationMode=configuredModulationMode, configurationGroup=configurationGroup, searchState=searchState, sNMPTrapTableNumber=sNMPTrapTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, smtp=smtp, transmitModulationMode=transmitModulationMode, ptpTrapPrefix=ptpTrapPrefix, radarDetectTrap=radarDetectTrap, dualPayload=dualPayload, sNMPCommunityTableEntry=sNMPCommunityTableEntry, transmitDataRate=transmitDataRate, vlanId=vlanId, cambium=cambium, ptmp=ptmp, masterSlaveMode=masterSlaveMode, ethernet=ethernet, currentChannel=currentChannel, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPCommunityTableNumber=sNMPCommunityTableNumber, nTPPollInterval=nTPPollInterval, extendedChannel=extendedChannel, sMTPServerPortNumber=sMTPServerPortNumber, currentFreqMHz=currentFreqMHz, snmpControlGroup=snmpControlGroup, ethernetGroup=ethernetGroup, signalStrengthRatio=signalStrengthRatio, noiseFloor=noiseFloor, sNMPCommunityTableIndex=sNMPCommunityTableIndex, remoteIPAddress=remoteIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, notificationsGroup=notificationsGroup, sNMPCommunityString=sNMPCommunityString, radarDetectChannel=radarDetectChannel, siteName=siteName, sNMPCommunityTable=sNMPCommunityTable, sMTPEnabledMessages=sMTPEnabledMessages, installArmStateTrap=installArmStateTrap, pubStatsGroup=pubStatsGroup, regionCode=regionCode, configuredRange=configuredRange, linkLoss=linkLoss, dataPortStatusTrap=dataPortStatusTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapTable=sNMPTrapTable, sNMPTrapTableEntry=sNMPTrapTableEntry, receiveDataRate=receiveDataRate, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, receivePower=receivePower, measuredRange=measuredRange, tFTPServerIPAddress=tFTPServerIPAddress, pubStats=pubStats, linkStatusTrap=linkStatusTrap, ptpGroups=ptpGroups, installArmState=installArmState, wirelessLinkStatus=wirelessLinkStatus, licence=licence, sMTPServerIPAddress=sMTPServerIPAddress, bootVersion=bootVersion, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, PYSNMP_MODULE_ID=cambium, management=management, channelSelection=channelSelection, alarms=alarms, hardwareVersion=hardwareVersion, aggregateDataRate=aggregateDataRate, smtpGroup=smtpGroup, systemClock=systemClock, subnetMask=subnetMask, dataPortStatus=dataPortStatus, receiveModulationMode=receiveModulationMode, tFTPServerPortNumber=tFTPServerPortNumber, vectorError=vectorError, configuration=configuration, ptpTraps=ptpTraps, productName=productName, channelBandwidth=channelBandwidth, ptp250=ptp250, sNMPCommunityAccess=sNMPCommunityAccess, sNMPTrapVersion=sNMPTrapVersion, sNMPEnabledTraps=sNMPEnabledTraps, timeZone=timeZone, softwareVersion=softwareVersion, fixedModMode=fixedModMode, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, vlanPriority=vlanPriority, ntp=ntp, iPAddress=iPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, versionsGroup=versionsGroup, licenceGroup=licenceGroup, alarmsGroup=alarmsGroup, ptpCompliance=ptpCompliance, maximumTransmitPower=maximumTransmitPower, phyStatusGroup=phyStatusGroup, gatewayIPAddress=gatewayIPAddress, extendedFreqMHz=extendedFreqMHz, antennaGain=antennaGain, sNMPCommunityOid=sNMPCommunityOid, sNMPTrapTableIndex=sNMPTrapTableIndex, snmpControl=snmpControl, transmitPower=transmitPower, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, nTPState=nTPState, dataPortAutoNegotiation=dataPortAutoNegotiation, managementGroup=managementGroup, vlanTagging=vlanTagging, band=band, ntpGroup=ntpGroup, sNMPTrapCommunity=sNMPTrapCommunity, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, nTPServerIp=nTPServerIp, phyStatus=phyStatus, productVariant=productVariant)
