...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", linkLoss=linkLoss, linkStatusTrap=linkStatusTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, vlanPriority=vlanPriority, gatewayIPAddress=gatewayIPAddress, sMTPServerIPAddress=sMTPServerIPAddress, extendedFreqMHz=extendedFreqMHz, remoteMACAddress=remoteMACAddress, radarDetectTrap=radarDetectTrap, sNMPEnabledTraps=sNMPEnabledTraps, versions=versions, ptp250=ptp250, configuredModulationMode=configuredModulationMode, phyStatusGroup=phyStatusGroup, ntpGroup=ntpGroup, dataPortStatusTrap=dataPortStatusTrap, currentFreqMHz=currentFreqMHz, managementGroup=managementGroup, measuredRange=measuredRange, smtp=smtp, channelBandwidth=channelBandwidth, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, searchState=searchState, sNMPTrapVersion=sNMPTrapVersion, nTPPollInterval=nTPPollInterval, band=band, pubStats=pubStats, configuration=configuration, alarmsGroup=alarmsGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPCommunityTable=sNMPCommunityTable, antennaGain=antennaGain, remoteIPAddress=remoteIPAddress, productVariant=productVariant, ptpTrapPrefix=ptpTrapPrefix, smtpGroup=smtpGroup, wirelessLinkStatus=wirelessLinkStatus, receiveDataRate=receiveDataRate, ethernet=ethernet, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPCommunityTableIndex=sNMPCommunityTableIndex, maximumTransmitPower=maximumTransmitPower, vlanTagging=vlanTagging, alarms=alarms, sNMPTrapPortNumber=sNMPTrapPortNumber, nTPState=nTPState, configuredRange=configuredRange, currentChannel=currentChannel, dataPortStatus=dataPortStatus, linkName=linkName, timeZone=timeZone, sNMPTrapTable=sNMPTrapTable, receivePower=receivePower, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, installArmState=installArmState, sMTPEnabledMessages=sMTPEnabledMessages, noWirelessChannelAvailable=noWirelessChannelAvailable, phyStatus=phyStatus, vectorError=vectorError, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ethernetGroup=ethernetGroup, tFTPServerIPAddress=tFTPServerIPAddress, ptp=ptp, cableLoss=cableLoss, sNMPTrapIPAddress=sNMPTrapIPAddress, ptmp=ptmp, vlanId=vlanId, productName=productName, receiveModulationMode=receiveModulationMode, sNMPTrapCommunity=sNMPTrapCommunity, transmitModulationMode=transmitModulationMode, noiseFloor=noiseFloor, snmpControl=snmpControl, PYSNMP_MODULE_ID=cambium, fixedModMode=fixedModMode, tFTPServerPortNumber=tFTPServerPortNumber, versionsGroup=versionsGroup, siteName=siteName, transmitPower=transmitPower, snmpControlGroup=snmpControlGroup, signalStrengthRatio=signalStrengthRatio, nTPSync=nTPSync, sMTPServerPortNumber=sMTPServerPortNumber, nTPServerPortNumber=nTPServerPortNumber, iPAddress=iPAddress, sNMPCommunityTableEntry=sNMPCommunityTableEntry, subnetMask=subnetMask, dataPortAutoNegotiation=dataPortAutoNegotiation, systemClock=systemClock, transmitDataRate=transmitDataRate, sNMPTrapTableIndex=sNMPTrapTableIndex, management=management, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, installArmStateTrap=installArmStateTrap, aggregateDataRate=aggregateDataRate, dualPayload=dualPayload, sNMPCommunityOid=sNMPCommunityOid, channelSelection=channelSelection, softwareVersion=softwareVersion, licence=licence, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sNMPCommunityString=sNMPCommunityString, nTPServerIp=nTPServerIp, sNMPTrapTableEntry=sNMPTrapTableEntry, nTPLastSync=nTPLastSync, ntp=ntp, sNMPCommunityAccess=sNMPCommunityAccess, extendedChannel=extendedChannel, cambium=cambium, ptpGroups=ptpGroups, masterSlaveMode=masterSlaveMode, configurationGroup=configurationGroup, pubStatsGroup=pubStatsGroup, ptpTraps=ptpTraps, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, radarDetectChannel=radarDetectChannel, licenceGroup=licenceGroup, bootVersion=bootVersion, notificationsGroup=notificationsGroup, hardwareVersion=hardwareVersion, regionCode=regionCode, ptpCompliance=ptpCompliance)
