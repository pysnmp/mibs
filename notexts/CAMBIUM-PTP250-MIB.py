...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", ethernet=ethernet, notificationsGroup=notificationsGroup, receivePower=receivePower, channelSelection=channelSelection, PYSNMP_MODULE_ID=cambium, ntp=ntp, aggregateDataRate=aggregateDataRate, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, noiseFloor=noiseFloor, ntpGroup=ntpGroup, nTPPollInterval=nTPPollInterval, systemClock=systemClock, sNMPTrapIPAddress=sNMPTrapIPAddress, ptpCompliance=ptpCompliance, antennaGain=antennaGain, vlanTagging=vlanTagging, transmitModulationMode=transmitModulationMode, snmpControl=snmpControl, tFTPServerIPAddress=tFTPServerIPAddress, ptpTraps=ptpTraps, phyStatus=phyStatus, installArmStateTrap=installArmStateTrap, remoteMACAddress=remoteMACAddress, ptpGroups=ptpGroups, dualPayload=dualPayload, configuration=configuration, snmpControlGroup=snmpControlGroup, band=band, timeZone=timeZone, productVariant=productVariant, maximumTransmitPower=maximumTransmitPower, versions=versions, sNMPCommunityTableNumber=sNMPCommunityTableNumber, currentFreqMHz=currentFreqMHz, ptpTrapPrefix=ptpTrapPrefix, alarmsGroup=alarmsGroup, productName=productName, hardwareVersion=hardwareVersion, sNMPCommunityOid=sNMPCommunityOid, nTPServerPortNumber=nTPServerPortNumber, cambium=cambium, installArmState=installArmState, iPAddress=iPAddress, sNMPCommunityString=sNMPCommunityString, sNMPTrapVersion=sNMPTrapVersion, ptp=ptp, gatewayIPAddress=gatewayIPAddress, linkLoss=linkLoss, signalStrengthRatio=signalStrengthRatio, siteName=siteName, ptmp=ptmp, ptp250=ptp250, receiveModulationMode=receiveModulationMode, remoteIPAddress=remoteIPAddress, extendedChannel=extendedChannel, sNMPTrapPortNumber=sNMPTrapPortNumber, versionsGroup=versionsGroup, licence=licence, sNMPTrapTable=sNMPTrapTable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, alarms=alarms, extendedFreqMHz=extendedFreqMHz, pubStats=pubStats, sMTPServerPortNumber=sMTPServerPortNumber, masterSlaveMode=masterSlaveMode, softwareVersion=softwareVersion, management=management, phyStatusGroup=phyStatusGroup, regionCode=regionCode, channelBandwidth=channelBandwidth, subnetMask=subnetMask, configuredModulationMode=configuredModulationMode, smtpGroup=smtpGroup, tFTPServerPortNumber=tFTPServerPortNumber, sNMPCommunityAccess=sNMPCommunityAccess, fixedModMode=fixedModMode, sNMPTrapCommunity=sNMPTrapCommunity, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortStatusTrap=dataPortStatusTrap, licenceGroup=licenceGroup, sMTPEnabledMessages=sMTPEnabledMessages, sNMPEnabledTraps=sNMPEnabledTraps, ethernetGroup=ethernetGroup, configuredRange=configuredRange, nTPState=nTPState, sMTPServerIPAddress=sMTPServerIPAddress, vlanPriority=vlanPriority, linkStatusTrap=linkStatusTrap, bootVersion=bootVersion, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, vectorError=vectorError, configurationGroup=configurationGroup, smtp=smtp, transmitPower=transmitPower, currentChannel=currentChannel, nTPLastSync=nTPLastSync, vlanId=vlanId, receiveDataRate=receiveDataRate, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, wirelessLinkStatus=wirelessLinkStatus, dataPortStatus=dataPortStatus, measuredRange=measuredRange, radarDetectChannel=radarDetectChannel, sNMPCommunityTable=sNMPCommunityTable, managementGroup=managementGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, transmitDataRate=transmitDataRate, linkName=linkName, searchState=searchState, nTPSync=nTPSync, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, pubStatsGroup=pubStatsGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapTableIndex=sNMPTrapTableIndex, cableLoss=cableLoss, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, radarDetectTrap=radarDetectTrap, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sNMPTrapTableNumber=sNMPTrapTableNumber, nTPServerIp=nTPServerIp)
