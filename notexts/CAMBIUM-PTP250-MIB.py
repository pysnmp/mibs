...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPCommunityTableNumber=sNMPCommunityTableNumber, ptp=ptp, snmpControl=snmpControl, systemClock=systemClock, tFTPServerIPAddress=tFTPServerIPAddress, channelSelection=channelSelection, currentChannel=currentChannel, nTPServerPortNumber=nTPServerPortNumber, sNMPCommunityOid=sNMPCommunityOid, sNMPTrapPortNumber=sNMPTrapPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, installArmState=installArmState, versionsGroup=versionsGroup, ptpGroups=ptpGroups, cableLoss=cableLoss, transmitDataRate=transmitDataRate, sNMPTrapTableIndex=sNMPTrapTableIndex, installArmStateTrap=installArmStateTrap, notificationsGroup=notificationsGroup, fixedModMode=fixedModMode, iPAddress=iPAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, alarms=alarms, dataPortAutoNegotiation=dataPortAutoNegotiation, nTPServerIp=nTPServerIp, versions=versions, searchState=searchState, ptp250=ptp250, snmpControlGroup=snmpControlGroup, gatewayIPAddress=gatewayIPAddress, ptpTrapPrefix=ptpTrapPrefix, masterSlaveMode=masterSlaveMode, sNMPEnabledTraps=sNMPEnabledTraps, cambium=cambium, transmitPower=transmitPower, managementGroup=managementGroup, sNMPCommunityTable=sNMPCommunityTable, licence=licence, sMTPEnabledMessages=sMTPEnabledMessages, vectorError=vectorError, sMTPServerPortNumber=sMTPServerPortNumber, smtp=smtp, ntp=ntp, tFTPServerPortNumber=tFTPServerPortNumber, radarDetectTrap=radarDetectTrap, siteName=siteName, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPCommunityTableEntry=sNMPCommunityTableEntry, remoteMACAddress=remoteMACAddress, configuredRange=configuredRange, sNMPTrapCommunity=sNMPTrapCommunity, regionCode=regionCode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, linkStatusTrap=linkStatusTrap, phyStatusGroup=phyStatusGroup, noiseFloor=noiseFloor, sNMPTrapTableNumber=sNMPTrapTableNumber, ptpCompliance=ptpCompliance, licenceGroup=licenceGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, timeZone=timeZone, sNMPTrapTable=sNMPTrapTable, radarDetectChannel=radarDetectChannel, nTPState=nTPState, nTPPollInterval=nTPPollInterval, signalStrengthRatio=signalStrengthRatio, sNMPCommunityTableIndex=sNMPCommunityTableIndex, dataPortStatusTrap=dataPortStatusTrap, antennaGain=antennaGain, sNMPTrapIPAddress=sNMPTrapIPAddress, extendedFreqMHz=extendedFreqMHz, hardwareVersion=hardwareVersion, linkLoss=linkLoss, dualPayload=dualPayload, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, bootVersion=bootVersion, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, aggregateDataRate=aggregateDataRate, measuredRange=measuredRange, nTPLastSync=nTPLastSync, remoteIPAddress=remoteIPAddress, pubStatsGroup=pubStatsGroup, receivePower=receivePower, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPCommunityString=sNMPCommunityString, PYSNMP_MODULE_ID=cambium, ethernet=ethernet, transmitModulationMode=transmitModulationMode, softwareVersion=softwareVersion, configuredModulationMode=configuredModulationMode, vlanPriority=vlanPriority, ptmp=ptmp, alarmsGroup=alarmsGroup, linkName=linkName, receiveModulationMode=receiveModulationMode, nTPSync=nTPSync, sNMPCommunityAccess=sNMPCommunityAccess, productName=productName, sNMPTrapVersion=sNMPTrapVersion, receiveDataRate=receiveDataRate, subnetMask=subnetMask, management=management, maximumTransmitPower=maximumTransmitPower, ethernetGroup=ethernetGroup, smtpGroup=smtpGroup, pubStats=pubStats, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, wirelessLinkStatus=wirelessLinkStatus, sMTPServerIPAddress=sMTPServerIPAddress, productVariant=productVariant, vlanTagging=vlanTagging, phyStatus=phyStatus, ntpGroup=ntpGroup, ptpTraps=ptpTraps, configurationGroup=configurationGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, band=band, extendedChannel=extendedChannel, vlanId=vlanId, dataPortStatus=dataPortStatus, configuration=configuration, channelBandwidth=channelBandwidth, currentFreqMHz=currentFreqMHz, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex)
