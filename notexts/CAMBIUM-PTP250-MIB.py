...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, vectorError=vectorError, currentFreqMHz=currentFreqMHz, nTPPollInterval=nTPPollInterval, antennaGain=antennaGain, cableLoss=cableLoss, transmitPower=transmitPower, remoteIPAddress=remoteIPAddress, extendedFreqMHz=extendedFreqMHz, fixedModMode=fixedModMode, ptp250=ptp250, managementGroup=managementGroup, noiseFloor=noiseFloor, subnetMask=subnetMask, ptpTrapPrefix=ptpTrapPrefix, wirelessLinkStatus=wirelessLinkStatus, ethernetGroup=ethernetGroup, productName=productName, ptpTraps=ptpTraps, receiveDataRate=receiveDataRate, management=management, receiveModulationMode=receiveModulationMode, signalStrengthRatio=signalStrengthRatio, nTPServerIp=nTPServerIp, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPServerIPAddress=tFTPServerIPAddress, nTPState=nTPState, channelSelection=channelSelection, sNMPCommunityAccess=sNMPCommunityAccess, nTPSync=nTPSync, sNMPCommunityTable=sNMPCommunityTable, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapIPAddress=sNMPTrapIPAddress, bootVersion=bootVersion, alarmsGroup=alarmsGroup, dualPayload=dualPayload, ptp=ptp, nTPLastSync=nTPLastSync, dataPortAutoNegotiation=dataPortAutoNegotiation, smtpGroup=smtpGroup, sNMPCommunityTableEntry=sNMPCommunityTableEntry, vlanPriority=vlanPriority, pubStats=pubStats, vlanTagging=vlanTagging, versionsGroup=versionsGroup, softwareVersion=softwareVersion, sMTPSourceEmailAddress=sMTPSourceEmailAddress, transmitModulationMode=transmitModulationMode, ptpGroups=ptpGroups, notificationsGroup=notificationsGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, radarDetectTrap=radarDetectTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, regionCode=regionCode, nTPServerPortNumber=nTPServerPortNumber, aggregateDataRate=aggregateDataRate, ntpGroup=ntpGroup, smtp=smtp, productVariant=productVariant, sNMPEnabledTraps=sNMPEnabledTraps, measuredRange=measuredRange, vlanId=vlanId, ptpCompliance=ptpCompliance, snmpControlGroup=snmpControlGroup, sNMPTrapCommunity=sNMPTrapCommunity, licence=licence, timeZone=timeZone, band=band, currentChannel=currentChannel, sMTPServerPortNumber=sMTPServerPortNumber, ntp=ntp, phyStatus=phyStatus, linkName=linkName, cambium=cambium, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, configurationGroup=configurationGroup, radarDetectChannel=radarDetectChannel, maximumTransmitPower=maximumTransmitPower, configuredRange=configuredRange, extendedChannel=extendedChannel, installArmState=installArmState, configuredModulationMode=configuredModulationMode, remoteMACAddress=remoteMACAddress, sNMPTrapTable=sNMPTrapTable, tFTPServerPortNumber=tFTPServerPortNumber, gatewayIPAddress=gatewayIPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, receivePower=receivePower, ethernet=ethernet, dataPortStatusTrap=dataPortStatusTrap, snmpControl=snmpControl, sNMPCommunityOid=sNMPCommunityOid, linkStatusTrap=linkStatusTrap, alarms=alarms, transmitDataRate=transmitDataRate, iPAddress=iPAddress, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortStatus=dataPortStatus, phyStatusGroup=phyStatusGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, pubStatsGroup=pubStatsGroup, systemClock=systemClock, searchState=searchState, channelBandwidth=channelBandwidth, versions=versions, linkLoss=linkLoss, sNMPCommunityTableIndex=sNMPCommunityTableIndex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptmp=ptmp, installArmStateTrap=installArmStateTrap, hardwareVersion=hardwareVersion, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPCommunityString=sNMPCommunityString, sMTPServerIPAddress=sMTPServerIPAddress, PYSNMP_MODULE_ID=cambium, siteName=siteName, masterSlaveMode=masterSlaveMode, configuration=configuration, licenceGroup=licenceGroup)
