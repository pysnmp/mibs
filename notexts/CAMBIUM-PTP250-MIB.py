...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", licenceGroup=licenceGroup, phyStatusGroup=phyStatusGroup, sNMPTrapCommunity=sNMPTrapCommunity, linkName=linkName, sNMPTrapIPAddress=sNMPTrapIPAddress, antennaGain=antennaGain, alarms=alarms, vlanId=vlanId, sNMPCommunityString=sNMPCommunityString, smtpGroup=smtpGroup, nTPServerIp=nTPServerIp, timeZone=timeZone, phyStatus=phyStatus, productVariant=productVariant, management=management, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkStatusTrap=linkStatusTrap, sNMPCommunityOid=sNMPCommunityOid, sNMPTrapTableIndex=sNMPTrapTableIndex, channelBandwidth=channelBandwidth, smtp=smtp, noiseFloor=noiseFloor, sNMPCommunityTableIndex=sNMPCommunityTableIndex, measuredRange=measuredRange, radarDetectTrap=radarDetectTrap, ptpTrapPrefix=ptpTrapPrefix, ethernet=ethernet, productName=productName, ptmp=ptmp, ntp=ntp, PYSNMP_MODULE_ID=cambium, alarmsGroup=alarmsGroup, vlanPriority=vlanPriority, radarDetectChannel=radarDetectChannel, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, remoteMACAddress=remoteMACAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, wirelessLinkStatus=wirelessLinkStatus, maximumTransmitPower=maximumTransmitPower, searchState=searchState, ptpGroups=ptpGroups, ptp250=ptp250, transmitModulationMode=transmitModulationMode, sNMPCommunityTableEntry=sNMPCommunityTableEntry, regionCode=regionCode, masterSlaveMode=masterSlaveMode, remoteIPAddress=remoteIPAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, nTPLastSync=nTPLastSync, transmitDataRate=transmitDataRate, sNMPTrapVersion=sNMPTrapVersion, iPAddress=iPAddress, gatewayIPAddress=gatewayIPAddress, vlanTagging=vlanTagging, sNMPCommunityTable=sNMPCommunityTable, nTPState=nTPState, nTPPollInterval=nTPPollInterval, pubStats=pubStats, hardwareVersion=hardwareVersion, signalStrengthRatio=signalStrengthRatio, versions=versions, ntpGroup=ntpGroup, installArmState=installArmState, dataPortStatus=dataPortStatus, sNMPTrapTable=sNMPTrapTable, licence=licence, softwareVersion=softwareVersion, sMTPServerPortNumber=sMTPServerPortNumber, siteName=siteName, vectorError=vectorError, ethernetGroup=ethernetGroup, configuredModulationMode=configuredModulationMode, configuredRange=configuredRange, snmpControlGroup=snmpControlGroup, tFTPServerPortNumber=tFTPServerPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPServerIPAddress=tFTPServerIPAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, managementGroup=managementGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, transmitPower=transmitPower, cableLoss=cableLoss, sMTPSourceEmailAddress=sMTPSourceEmailAddress, currentChannel=currentChannel, configurationGroup=configurationGroup, subnetMask=subnetMask, extendedFreqMHz=extendedFreqMHz, configuration=configuration, systemClock=systemClock, nTPSync=nTPSync, snmpControl=snmpControl, sNMPCommunityTableNumber=sNMPCommunityTableNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, nTPServerPortNumber=nTPServerPortNumber, pubStatsGroup=pubStatsGroup, cambium=cambium, sMTPEnabledMessages=sMTPEnabledMessages, sNMPCommunityAccess=sNMPCommunityAccess, dataPortStatusTrap=dataPortStatusTrap, channelSelection=channelSelection, sNMPTrapTableEntry=sNMPTrapTableEntry, receiveModulationMode=receiveModulationMode, ptpCompliance=ptpCompliance, extendedChannel=extendedChannel, bootVersion=bootVersion, band=band, ptp=ptp, receivePower=receivePower, notificationsGroup=notificationsGroup, ptpTraps=ptpTraps, dataPortAutoNegotiation=dataPortAutoNegotiation, installArmStateTrap=installArmStateTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPEnabledTraps=sNMPEnabledTraps, fixedModMode=fixedModMode, aggregateDataRate=aggregateDataRate, currentFreqMHz=currentFreqMHz, versionsGroup=versionsGroup, sMTPServerIPAddress=sMTPServerIPAddress, dualPayload=dualPayload, linkLoss=linkLoss, receiveDataRate=receiveDataRate, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName)
