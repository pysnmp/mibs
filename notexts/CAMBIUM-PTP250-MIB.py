...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", smtp=smtp, noiseFloor=noiseFloor, licence=licence, linkName=linkName, versions=versions, transmitPower=transmitPower, radarDetectChannel=radarDetectChannel, phyStatus=phyStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapPortNumber=sNMPTrapPortNumber, configuredModulationMode=configuredModulationMode, productVariant=productVariant, systemClock=systemClock, productName=productName, notificationsGroup=notificationsGroup, remoteIPAddress=remoteIPAddress, vectorError=vectorError, tFTPServerPortNumber=tFTPServerPortNumber, alarmsGroup=alarmsGroup, managementGroup=managementGroup, nTPServerPortNumber=nTPServerPortNumber, configuredRange=configuredRange, vlanTagging=vlanTagging, snmpControl=snmpControl, sNMPTrapIPAddress=sNMPTrapIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, remoteMACAddress=remoteMACAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, channelSelection=channelSelection, linkLoss=linkLoss, receiveDataRate=receiveDataRate, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, nTPSync=nTPSync, licenceGroup=licenceGroup, dualPayload=dualPayload, nTPPollInterval=nTPPollInterval, ptp=ptp, ptpGroups=ptpGroups, noWirelessChannelAvailable=noWirelessChannelAvailable, versionsGroup=versionsGroup, sNMPTrapVersion=sNMPTrapVersion, cableLoss=cableLoss, ptpCompliance=ptpCompliance, PYSNMP_MODULE_ID=cambium, configurationGroup=configurationGroup, iPAddress=iPAddress, subnetMask=subnetMask, nTPServerIp=nTPServerIp, linkStatusTrap=linkStatusTrap, sNMPCommunityTable=sNMPCommunityTable, channelBandwidth=channelBandwidth, siteName=siteName, dataPortStatusTrap=dataPortStatusTrap, receivePower=receivePower, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapTableIndex=sNMPTrapTableIndex, configuration=configuration, measuredRange=measuredRange, sNMPCommunityTableNumber=sNMPCommunityTableNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, nTPLastSync=nTPLastSync, softwareVersion=softwareVersion, sMTPServerPortNumber=sMTPServerPortNumber, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sMTPServerIPAddress=sMTPServerIPAddress, aggregateDataRate=aggregateDataRate, sNMPCommunityString=sNMPCommunityString, cambium=cambium, tFTPServerIPAddress=tFTPServerIPAddress, pubStatsGroup=pubStatsGroup, extendedFreqMHz=extendedFreqMHz, bootVersion=bootVersion, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, phyStatusGroup=phyStatusGroup, hardwareVersion=hardwareVersion, sNMPTrapCommunity=sNMPTrapCommunity, alarms=alarms, ntp=ntp, fixedModMode=fixedModMode, dataPortStatus=dataPortStatus, receiveModulationMode=receiveModulationMode, sNMPCommunityOid=sNMPCommunityOid, ptpTraps=ptpTraps, installArmState=installArmState, maximumTransmitPower=maximumTransmitPower, transmitDataRate=transmitDataRate, sNMPEnabledTraps=sNMPEnabledTraps, ethernet=ethernet, management=management, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, searchState=searchState, timeZone=timeZone, installArmStateTrap=installArmStateTrap, pubStats=pubStats, transmitModulationMode=transmitModulationMode, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapTableNumber=sNMPTrapTableNumber, vlanId=vlanId, ptp250=ptp250, smtpGroup=smtpGroup, snmpControlGroup=snmpControlGroup, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapTable=sNMPTrapTable, ptmp=ptmp, sMTPEnabledMessages=sMTPEnabledMessages, radarDetectTrap=radarDetectTrap, currentFreqMHz=currentFreqMHz, sNMPCommunityAccess=sNMPCommunityAccess, ptpTrapPrefix=ptpTrapPrefix, wirelessLinkStatus=wirelessLinkStatus, band=band, vlanPriority=vlanPriority, gatewayIPAddress=gatewayIPAddress, antennaGain=antennaGain, masterSlaveMode=masterSlaveMode, regionCode=regionCode, signalStrengthRatio=signalStrengthRatio, extendedChannel=extendedChannel, nTPState=nTPState, ntpGroup=ntpGroup, ethernetGroup=ethernetGroup, currentChannel=currentChannel)
