...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", tFTPServerPortNumber=tFTPServerPortNumber, managementGroup=managementGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, phyStatus=phyStatus, sMTPServerPortNumber=sMTPServerPortNumber, smtp=smtp, configurationGroup=configurationGroup, linkName=linkName, tFTPServerIPAddress=tFTPServerIPAddress, pubStats=pubStats, fixedModMode=fixedModMode, hardwareVersion=hardwareVersion, versionsGroup=versionsGroup, signalStrengthRatio=signalStrengthRatio, sMTPServerIPAddress=sMTPServerIPAddress, currentChannel=currentChannel, extendedFreqMHz=extendedFreqMHz, gatewayIPAddress=gatewayIPAddress, maximumTransmitPower=maximumTransmitPower, transmitDataRate=transmitDataRate, extendedChannel=extendedChannel, nTPServerIp=nTPServerIp, transmitModulationMode=transmitModulationMode, snmpControl=snmpControl, antennaGain=antennaGain, subnetMask=subnetMask, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapIPAddress=sNMPTrapIPAddress, aggregateDataRate=aggregateDataRate, cableLoss=cableLoss, systemClock=systemClock, configuration=configuration, radarDetectChannel=radarDetectChannel, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPEnabledMessages=sMTPEnabledMessages, transmitPower=transmitPower, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPTrapTableIndex=sNMPTrapTableIndex, ptp250=ptp250, vlanTagging=vlanTagging, alarmsGroup=alarmsGroup, vlanPriority=vlanPriority, remoteMACAddress=remoteMACAddress, configuredModulationMode=configuredModulationMode, vectorError=vectorError, dualPayload=dualPayload, softwareVersion=softwareVersion, ethernetGroup=ethernetGroup, siteName=siteName, linkLoss=linkLoss, sNMPTrapTableEntry=sNMPTrapTableEntry, ntpGroup=ntpGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, vlanId=vlanId, channelSelection=channelSelection, pubStatsGroup=pubStatsGroup, ethernet=ethernet, remoteIPAddress=remoteIPAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, searchState=searchState, versions=versions, notificationsGroup=notificationsGroup, currentFreqMHz=currentFreqMHz, sNMPTrapTableNumber=sNMPTrapTableNumber, alarms=alarms, nTPServerPortNumber=nTPServerPortNumber, receivePower=receivePower, sNMPTrapPortNumber=sNMPTrapPortNumber, snmpControlGroup=snmpControlGroup, ptpTrapPrefix=ptpTrapPrefix, masterSlaveMode=masterSlaveMode, receiveModulationMode=receiveModulationMode, nTPSync=nTPSync, dataPortStatusTrap=dataPortStatusTrap, ptpGroups=ptpGroups, band=band, ntp=ntp, phyStatusGroup=phyStatusGroup, sNMPCommunityOid=sNMPCommunityOid, wirelessLinkStatus=wirelessLinkStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPCommunityTableNumber=sNMPCommunityTableNumber, ptp=ptp, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sNMPCommunityTableEntry=sNMPCommunityTableEntry, nTPLastSync=nTPLastSync, sNMPCommunityString=sNMPCommunityString, bootVersion=bootVersion, licence=licence, noiseFloor=noiseFloor, channelBandwidth=channelBandwidth, smtpGroup=smtpGroup, ptmp=ptmp, iPAddress=iPAddress, nTPPollInterval=nTPPollInterval, sNMPEnabledTraps=sNMPEnabledTraps, sNMPCommunityTable=sNMPCommunityTable, linkStatusTrap=linkStatusTrap, receiveDataRate=receiveDataRate, configuredRange=configuredRange, sNMPTrapTable=sNMPTrapTable, management=management, productVariant=productVariant, regionCode=regionCode, licenceGroup=licenceGroup, cambium=cambium, dataPortStatus=dataPortStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, measuredRange=measuredRange, timeZone=timeZone, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, radarDetectTrap=radarDetectTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPCommunityAccess=sNMPCommunityAccess, sNMPTrapCommunity=sNMPTrapCommunity, ptpTraps=ptpTraps, productName=productName, ptpCompliance=ptpCompliance, installArmStateTrap=installArmStateTrap, nTPState=nTPState, PYSNMP_MODULE_ID=cambium, installArmState=installArmState)
