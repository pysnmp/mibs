...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", ptmp=ptmp, sNMPCommunityAccess=sNMPCommunityAccess, regionCode=regionCode, sNMPTrapTableNumber=sNMPTrapTableNumber, searchState=searchState, transmitModulationMode=transmitModulationMode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, linkName=linkName, extendedChannel=extendedChannel, gatewayIPAddress=gatewayIPAddress, vlanPriority=vlanPriority, sNMPTrapCommunity=sNMPTrapCommunity, signalStrengthRatio=signalStrengthRatio, snmpControl=snmpControl, phyStatus=phyStatus, sNMPCommunityTableIndex=sNMPCommunityTableIndex, nTPSync=nTPSync, vlanTagging=vlanTagging, maximumTransmitPower=maximumTransmitPower, sNMPCommunityOid=sNMPCommunityOid, receiveDataRate=receiveDataRate, versionsGroup=versionsGroup, currentChannel=currentChannel, noWirelessChannelAvailable=noWirelessChannelAvailable, versions=versions, currentFreqMHz=currentFreqMHz, radarDetectChannel=radarDetectChannel, nTPLastSync=nTPLastSync, configuredRange=configuredRange, receivePower=receivePower, remoteIPAddress=remoteIPAddress, ptp250=ptp250, smtpGroup=smtpGroup, configuredModulationMode=configuredModulationMode, band=band, alarms=alarms, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPServerIPAddress=tFTPServerIPAddress, productVariant=productVariant, siteName=siteName, ptpCompliance=ptpCompliance, PYSNMP_MODULE_ID=cambium, sMTPServerPortNumber=sMTPServerPortNumber, antennaGain=antennaGain, cableLoss=cableLoss, tFTPServerPortNumber=tFTPServerPortNumber, ptpTrapPrefix=ptpTrapPrefix, channelBandwidth=channelBandwidth, systemClock=systemClock, ntpGroup=ntpGroup, alarmsGroup=alarmsGroup, nTPServerPortNumber=nTPServerPortNumber, bootVersion=bootVersion, ntp=ntp, linkStatusTrap=linkStatusTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPCommunityString=sNMPCommunityString, sNMPCommunityTable=sNMPCommunityTable, smtp=smtp, nTPState=nTPState, managementGroup=managementGroup, pubStats=pubStats, channelSelection=channelSelection, hardwareVersion=hardwareVersion, configuration=configuration, aggregateDataRate=aggregateDataRate, vectorError=vectorError, sNMPTrapVersion=sNMPTrapVersion, vlanId=vlanId, measuredRange=measuredRange, masterSlaveMode=masterSlaveMode, remoteMACAddress=remoteMACAddress, iPAddress=iPAddress, nTPPollInterval=nTPPollInterval, dataPortStatusTrap=dataPortStatusTrap, management=management, ptpTraps=ptpTraps, transmitDataRate=transmitDataRate, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPTrapTable=sNMPTrapTable, configurationGroup=configurationGroup, sNMPEnabledTraps=sNMPEnabledTraps, sMTPEnabledMessages=sMTPEnabledMessages, ptp=ptp, installArmState=installArmState, extendedFreqMHz=extendedFreqMHz, sNMPCommunityTableNumber=sNMPCommunityTableNumber, fixedModMode=fixedModMode, sNMPTrapPortNumber=sNMPTrapPortNumber, radarDetectTrap=radarDetectTrap, sNMPCommunityTableEntry=sNMPCommunityTableEntry, licence=licence, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, noiseFloor=noiseFloor, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, notificationsGroup=notificationsGroup, pubStatsGroup=pubStatsGroup, dataPortStatus=dataPortStatus, phyStatusGroup=phyStatusGroup, snmpControlGroup=snmpControlGroup, transmitPower=transmitPower, linkLoss=linkLoss, dualPayload=dualPayload, softwareVersion=softwareVersion, installArmStateTrap=installArmStateTrap, licenceGroup=licenceGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPServerIPAddress=sMTPServerIPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, productName=productName, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapIPAddress=sNMPTrapIPAddress, nTPServerIp=nTPServerIp, ethernet=ethernet, subnetMask=subnetMask, timeZone=timeZone, ethernetGroup=ethernetGroup, receiveModulationMode=receiveModulationMode, cambium=cambium, dataPortAutoNegotiation=dataPortAutoNegotiation, wirelessLinkStatus=wirelessLinkStatus, ptpGroups=ptpGroups)
