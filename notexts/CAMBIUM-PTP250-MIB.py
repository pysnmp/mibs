...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", phyStatusGroup=phyStatusGroup, configuredModulationMode=configuredModulationMode, band=band, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkName=linkName, sMTPSourceEmailAddress=sMTPSourceEmailAddress, searchState=searchState, sMTPServerIPAddress=sMTPServerIPAddress, ethernetGroup=ethernetGroup, licence=licence, noiseFloor=noiseFloor, sNMPTrapIPAddress=sNMPTrapIPAddress, dualPayload=dualPayload, PYSNMP_MODULE_ID=cambium, notificationsGroup=notificationsGroup, radarDetectChannel=radarDetectChannel, masterSlaveMode=masterSlaveMode, configurationGroup=configurationGroup, remoteIPAddress=remoteIPAddress, hardwareVersion=hardwareVersion, maximumTransmitPower=maximumTransmitPower, channelBandwidth=channelBandwidth, ptpGroups=ptpGroups, tFTPServerIPAddress=tFTPServerIPAddress, extendedChannel=extendedChannel, sNMPTrapTableNumber=sNMPTrapTableNumber, linkStatusTrap=linkStatusTrap, ntpGroup=ntpGroup, currentChannel=currentChannel, sNMPCommunityTable=sNMPCommunityTable, receiveDataRate=receiveDataRate, sNMPTrapTableIndex=sNMPTrapTableIndex, alarms=alarms, receivePower=receivePower, cambium=cambium, transmitDataRate=transmitDataRate, transmitPower=transmitPower, cableLoss=cableLoss, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, pubStatsGroup=pubStatsGroup, configuredRange=configuredRange, siteName=siteName, snmpControlGroup=snmpControlGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, systemClock=systemClock, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, wirelessLinkStatus=wirelessLinkStatus, sNMPEnabledTraps=sNMPEnabledTraps, nTPLastSync=nTPLastSync, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sMTPEnabledMessages=sMTPEnabledMessages, nTPSync=nTPSync, ethernet=ethernet, subnetMask=subnetMask, installArmStateTrap=installArmStateTrap, fixedModMode=fixedModMode, vectorError=vectorError, remoteMACAddress=remoteMACAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, nTPServerIp=nTPServerIp, dataPortAutoNegotiation=dataPortAutoNegotiation, transmitModulationMode=transmitModulationMode, configuration=configuration, versions=versions, ptmp=ptmp, sNMPTrapPortNumber=sNMPTrapPortNumber, iPAddress=iPAddress, vlanPriority=vlanPriority, sNMPCommunityAccess=sNMPCommunityAccess, vlanId=vlanId, sNMPTrapTableEntry=sNMPTrapTableEntry, alarmsGroup=alarmsGroup, receiveModulationMode=receiveModulationMode, nTPState=nTPState, smtp=smtp, dataPortStatusTrap=dataPortStatusTrap, dataPortStatus=dataPortStatus, gatewayIPAddress=gatewayIPAddress, tFTPServerPortNumber=tFTPServerPortNumber, installArmState=installArmState, licenceGroup=licenceGroup, channelSelection=channelSelection, sNMPTrapVersion=sNMPTrapVersion, antennaGain=antennaGain, regionCode=regionCode, snmpControl=snmpControl, ptp250=ptp250, phyStatus=phyStatus, radarDetectTrap=radarDetectTrap, sNMPCommunityOid=sNMPCommunityOid, sNMPTrapCommunity=sNMPTrapCommunity, currentFreqMHz=currentFreqMHz, sNMPCommunityString=sNMPCommunityString, measuredRange=measuredRange, ptp=ptp, managementGroup=managementGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, nTPServerPortNumber=nTPServerPortNumber, extendedFreqMHz=extendedFreqMHz, smtpGroup=smtpGroup, ntp=ntp, softwareVersion=softwareVersion, aggregateDataRate=aggregateDataRate, bootVersion=bootVersion, ptpTraps=ptpTraps, ptpTrapPrefix=ptpTrapPrefix, productName=productName, versionsGroup=versionsGroup, ptpCompliance=ptpCompliance, vlanTagging=vlanTagging, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, productVariant=productVariant, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapTable=sNMPTrapTable, sNMPCommunityTableNumber=sNMPCommunityTableNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, pubStats=pubStats, management=management, signalStrengthRatio=signalStrengthRatio, nTPPollInterval=nTPPollInterval, linkLoss=linkLoss, timeZone=timeZone)
