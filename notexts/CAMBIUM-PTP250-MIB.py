...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", channelBandwidth=channelBandwidth, sNMPCommunityOid=sNMPCommunityOid, hardwareVersion=hardwareVersion, ethernet=ethernet, noWirelessChannelAvailable=noWirelessChannelAvailable, radarDetectTrap=radarDetectTrap, searchState=searchState, linkName=linkName, vlanId=vlanId, configuration=configuration, licence=licence, channelSelection=channelSelection, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, signalStrengthRatio=signalStrengthRatio, sNMPTrapVersion=sNMPTrapVersion, nTPServerIp=nTPServerIp, PYSNMP_MODULE_ID=cambium, wirelessLinkStatus=wirelessLinkStatus, sNMPCommunityTable=sNMPCommunityTable, dataPortAutoNegotiation=dataPortAutoNegotiation, softwareVersion=softwareVersion, cambium=cambium, versions=versions, iPAddress=iPAddress, currentChannel=currentChannel, configuredModulationMode=configuredModulationMode, receiveModulationMode=receiveModulationMode, sNMPCommunityTableNumber=sNMPCommunityTableNumber, snmpControl=snmpControl, antennaGain=antennaGain, vlanPriority=vlanPriority, alarms=alarms, licenceGroup=licenceGroup, tFTPServerPortNumber=tFTPServerPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, remoteIPAddress=remoteIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPCommunityString=sNMPCommunityString, extendedFreqMHz=extendedFreqMHz, transmitDataRate=transmitDataRate, ptp=ptp, subnetMask=subnetMask, sNMPCommunityAccess=sNMPCommunityAccess, sNMPTrapTableIndex=sNMPTrapTableIndex, ptp250=ptp250, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernetGroup=ethernetGroup, siteName=siteName, smtp=smtp, pubStats=pubStats, sNMPTrapTableEntry=sNMPTrapTableEntry, currentFreqMHz=currentFreqMHz, ptpCompliance=ptpCompliance, smtpGroup=smtpGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, receivePower=receivePower, linkStatusTrap=linkStatusTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, managementGroup=managementGroup, band=band, installArmState=installArmState, nTPState=nTPState, linkLoss=linkLoss, versionsGroup=versionsGroup, dualPayload=dualPayload, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, masterSlaveMode=masterSlaveMode, fixedModMode=fixedModMode, ntp=ntp, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, receiveDataRate=receiveDataRate, systemClock=systemClock, dataPortStatusTrap=dataPortStatusTrap, configuredRange=configuredRange, management=management, nTPLastSync=nTPLastSync, alarmsGroup=alarmsGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPCommunityTableIndex=sNMPCommunityTableIndex, productVariant=productVariant, sMTPServerPortNumber=sMTPServerPortNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, noiseFloor=noiseFloor, vectorError=vectorError, bootVersion=bootVersion, nTPServerPortNumber=nTPServerPortNumber, installArmStateTrap=installArmStateTrap, sNMPTrapTable=sNMPTrapTable, vlanTagging=vlanTagging, sMTPServerIPAddress=sMTPServerIPAddress, ptmp=ptmp, productName=productName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, nTPPollInterval=nTPPollInterval, remoteMACAddress=remoteMACAddress, ptpGroups=ptpGroups, sNMPTrapIPAddress=sNMPTrapIPAddress, ntpGroup=ntpGroup, timeZone=timeZone, snmpControlGroup=snmpControlGroup, ptpTrapPrefix=ptpTrapPrefix, aggregateDataRate=aggregateDataRate, sNMPCommunityTableEntry=sNMPCommunityTableEntry, ptpTraps=ptpTraps, configurationGroup=configurationGroup, dataPortStatus=dataPortStatus, transmitModulationMode=transmitModulationMode, phyStatus=phyStatus, regionCode=regionCode, sNMPTrapCommunity=sNMPTrapCommunity, radarDetectChannel=radarDetectChannel, nTPSync=nTPSync, transmitPower=transmitPower, maximumTransmitPower=maximumTransmitPower, notificationsGroup=notificationsGroup, phyStatusGroup=phyStatusGroup, gatewayIPAddress=gatewayIPAddress, extendedChannel=extendedChannel, sMTPEnabledMessages=sMTPEnabledMessages, tFTPServerIPAddress=tFTPServerIPAddress, cableLoss=cableLoss, pubStatsGroup=pubStatsGroup, measuredRange=measuredRange)
