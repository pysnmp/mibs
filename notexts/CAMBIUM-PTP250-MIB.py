...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", pubStatsGroup=pubStatsGroup, phyStatus=phyStatus, masterSlaveMode=masterSlaveMode, sNMPCommunityTable=sNMPCommunityTable, sNMPTrapTableEntry=sNMPTrapTableEntry, ptpTraps=ptpTraps, subnetMask=subnetMask, linkLoss=linkLoss, fixedModMode=fixedModMode, transmitModulationMode=transmitModulationMode, versionsGroup=versionsGroup, ptp250=ptp250, sMTPEnabledMessages=sMTPEnabledMessages, searchState=searchState, dataPortStatusTrap=dataPortStatusTrap, cableLoss=cableLoss, vlanId=vlanId, ethernetGroup=ethernetGroup, antennaGain=antennaGain, sNMPCommunityAccess=sNMPCommunityAccess, nTPServerIp=nTPServerIp, remoteMACAddress=remoteMACAddress, signalStrengthRatio=signalStrengthRatio, sNMPCommunityTableNumber=sNMPCommunityTableNumber, siteName=siteName, extendedChannel=extendedChannel, softwareVersion=softwareVersion, sNMPTrapIPAddress=sNMPTrapIPAddress, ptpGroups=ptpGroups, transmitPower=transmitPower, currentFreqMHz=currentFreqMHz, radarDetectChannel=radarDetectChannel, bootVersion=bootVersion, installArmStateTrap=installArmStateTrap, gatewayIPAddress=gatewayIPAddress, measuredRange=measuredRange, management=management, nTPPollInterval=nTPPollInterval, configuredModulationMode=configuredModulationMode, productVariant=productVariant, snmpControl=snmpControl, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPCommunityTableEntry=sNMPCommunityTableEntry, ethernet=ethernet, configuredRange=configuredRange, ptmp=ptmp, transmitDataRate=transmitDataRate, systemClock=systemClock, productName=productName, ptpTrapPrefix=ptpTrapPrefix, channelBandwidth=channelBandwidth, phyStatusGroup=phyStatusGroup, ntpGroup=ntpGroup, radarDetectTrap=radarDetectTrap, licenceGroup=licenceGroup, dualPayload=dualPayload, sNMPTrapTableNumber=sNMPTrapTableNumber, band=band, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapVersion=sNMPTrapVersion, vlanTagging=vlanTagging, nTPServerPortNumber=nTPServerPortNumber, currentChannel=currentChannel, sNMPTrapTable=sNMPTrapTable, smtp=smtp, nTPState=nTPState, sMTPServerPortNumber=sMTPServerPortNumber, PYSNMP_MODULE_ID=cambium, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, noiseFloor=noiseFloor, aggregateDataRate=aggregateDataRate, sNMPCommunityOid=sNMPCommunityOid, notificationsGroup=notificationsGroup, vlanPriority=vlanPriority, vectorError=vectorError, ptp=ptp, wirelessLinkStatus=wirelessLinkStatus, sNMPCommunityString=sNMPCommunityString, installArmState=installArmState, regionCode=regionCode, sNMPEnabledTraps=sNMPEnabledTraps, remoteIPAddress=remoteIPAddress, dataPortStatus=dataPortStatus, receiveDataRate=receiveDataRate, maximumTransmitPower=maximumTransmitPower, pubStats=pubStats, snmpControlGroup=snmpControlGroup, alarms=alarms, configuration=configuration, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, receivePower=receivePower, noWirelessChannelAvailable=noWirelessChannelAvailable, extendedFreqMHz=extendedFreqMHz, sMTPServerIPAddress=sMTPServerIPAddress, sNMPCommunityTableIndex=sNMPCommunityTableIndex, tFTPServerIPAddress=tFTPServerIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, nTPLastSync=nTPLastSync, linkStatusTrap=linkStatusTrap, configurationGroup=configurationGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, nTPSync=nTPSync, cambium=cambium, sNMPTrapPortNumber=sNMPTrapPortNumber, hardwareVersion=hardwareVersion, sNMPTrapCommunity=sNMPTrapCommunity, linkName=linkName, tFTPServerPortNumber=tFTPServerPortNumber, iPAddress=iPAddress, receiveModulationMode=receiveModulationMode, dataPortAutoNegotiation=dataPortAutoNegotiation, alarmsGroup=alarmsGroup, channelSelection=channelSelection, versions=versions, managementGroup=managementGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ptpCompliance=ptpCompliance, ntp=ntp, licence=licence, timeZone=timeZone, smtpGroup=smtpGroup)
