...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", dataPortAutoNegotiation=dataPortAutoNegotiation, ptp250=ptp250, signalStrengthRatio=signalStrengthRatio, phyStatusGroup=phyStatusGroup, configurationGroup=configurationGroup, sNMPCommunityString=sNMPCommunityString, alarms=alarms, receiveModulationMode=receiveModulationMode, sNMPTrapPortNumber=sNMPTrapPortNumber, masterSlaveMode=masterSlaveMode, vlanTagging=vlanTagging, smtpGroup=smtpGroup, sNMPCommunityTable=sNMPCommunityTable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dualPayload=dualPayload, sNMPTrapTableIndex=sNMPTrapTableIndex, systemClock=systemClock, versions=versions, iPAddress=iPAddress, sNMPCommunityTableEntry=sNMPCommunityTableEntry, nTPState=nTPState, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, vectorError=vectorError, timeZone=timeZone, regionCode=regionCode, extendedChannel=extendedChannel, nTPServerPortNumber=nTPServerPortNumber, remoteMACAddress=remoteMACAddress, sNMPCommunityTableNumber=sNMPCommunityTableNumber, nTPLastSync=nTPLastSync, noiseFloor=noiseFloor, ptpTraps=ptpTraps, productVariant=productVariant, noWirelessChannelAvailable=noWirelessChannelAvailable, antennaGain=antennaGain, alarmsGroup=alarmsGroup, PYSNMP_MODULE_ID=cambium, notificationsGroup=notificationsGroup, transmitPower=transmitPower, productName=productName, cambium=cambium, ptpGroups=ptpGroups, pubStats=pubStats, cableLoss=cableLoss, sNMPCommunityTableIndex=sNMPCommunityTableIndex, radarDetectTrap=radarDetectTrap, linkLoss=linkLoss, ptmp=ptmp, tFTPServerPortNumber=tFTPServerPortNumber, licenceGroup=licenceGroup, maximumTransmitPower=maximumTransmitPower, wirelessLinkStatus=wirelessLinkStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, snmpControl=snmpControl, remoteIPAddress=remoteIPAddress, configuration=configuration, managementGroup=managementGroup, currentChannel=currentChannel, bootVersion=bootVersion, sMTPEnabledMessages=sMTPEnabledMessages, configuredRange=configuredRange, configuredModulationMode=configuredModulationMode, currentFreqMHz=currentFreqMHz, softwareVersion=softwareVersion, transmitDataRate=transmitDataRate, linkStatusTrap=linkStatusTrap, sNMPTrapTable=sNMPTrapTable, sNMPTrapVersion=sNMPTrapVersion, gatewayIPAddress=gatewayIPAddress, installArmState=installArmState, sNMPCommunityAccess=sNMPCommunityAccess, ptp=ptp, sMTPServerIPAddress=sMTPServerIPAddress, transmitModulationMode=transmitModulationMode, sMTPServerPortNumber=sMTPServerPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, siteName=siteName, band=band, tFTPServerIPAddress=tFTPServerIPAddress, ntpGroup=ntpGroup, channelBandwidth=channelBandwidth, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, pubStatsGroup=pubStatsGroup, extendedFreqMHz=extendedFreqMHz, channelSelection=channelSelection, receivePower=receivePower, management=management, searchState=searchState, nTPPollInterval=nTPPollInterval, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, licence=licence, smtp=smtp, phyStatus=phyStatus, ptpCompliance=ptpCompliance, sNMPEnabledTraps=sNMPEnabledTraps, installArmStateTrap=installArmStateTrap, nTPSync=nTPSync, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, fixedModMode=fixedModMode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortStatus=dataPortStatus, vlanId=vlanId, snmpControlGroup=snmpControlGroup, receiveDataRate=receiveDataRate, sMTPSourceEmailAddress=sMTPSourceEmailAddress, radarDetectChannel=radarDetectChannel, nTPServerIp=nTPServerIp, ethernetGroup=ethernetGroup, versionsGroup=versionsGroup, ethernet=ethernet, sNMPCommunityOid=sNMPCommunityOid, ntp=ntp, ptpTrapPrefix=ptpTrapPrefix, dataPortStatusTrap=dataPortStatusTrap, linkName=linkName, sNMPTrapTableNumber=sNMPTrapTableNumber, subnetMask=subnetMask, hardwareVersion=hardwareVersion, aggregateDataRate=aggregateDataRate, vlanPriority=vlanPriority, measuredRange=measuredRange, sNMPTrapCommunity=sNMPTrapCommunity, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex)
