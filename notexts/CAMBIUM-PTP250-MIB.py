...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", tFTPServerIPAddress=tFTPServerIPAddress, sNMPCommunityTableIndex=sNMPCommunityTableIndex, management=management, currentChannel=currentChannel, vectorError=vectorError, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, masterSlaveMode=masterSlaveMode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sMTPSourceEmailAddress=sMTPSourceEmailAddress, notificationsGroup=notificationsGroup, configuredRange=configuredRange, ntpGroup=ntpGroup, gatewayIPAddress=gatewayIPAddress, channelSelection=channelSelection, remoteIPAddress=remoteIPAddress, nTPServerIp=nTPServerIp, vlanPriority=vlanPriority, transmitPower=transmitPower, ptpGroups=ptpGroups, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, aggregateDataRate=aggregateDataRate, linkName=linkName, siteName=siteName, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPCommunityAccess=sNMPCommunityAccess, managementGroup=managementGroup, cableLoss=cableLoss, versions=versions, ptpTrapPrefix=ptpTrapPrefix, subnetMask=subnetMask, band=band, transmitDataRate=transmitDataRate, configuredModulationMode=configuredModulationMode, vlanTagging=vlanTagging, snmpControl=snmpControl, antennaGain=antennaGain, dataPortStatus=dataPortStatus, snmpControlGroup=snmpControlGroup, alarms=alarms, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, nTPLastSync=nTPLastSync, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPCommunityString=sNMPCommunityString, ptmp=ptmp, phyStatusGroup=phyStatusGroup, extendedFreqMHz=extendedFreqMHz, nTPState=nTPState, ntp=ntp, bootVersion=bootVersion, linkStatusTrap=linkStatusTrap, hardwareVersion=hardwareVersion, licence=licence, noiseFloor=noiseFloor, ptp=ptp, vlanId=vlanId, ethernetGroup=ethernetGroup, maximumTransmitPower=maximumTransmitPower, iPAddress=iPAddress, nTPSync=nTPSync, alarmsGroup=alarmsGroup, sMTPServerIPAddress=sMTPServerIPAddress, versionsGroup=versionsGroup, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapTable=sNMPTrapTable, signalStrengthRatio=signalStrengthRatio, ethernet=ethernet, PYSNMP_MODULE_ID=cambium, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortStatusTrap=dataPortStatusTrap, configuration=configuration, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapVersion=sNMPTrapVersion, sNMPCommunityTable=sNMPCommunityTable, dualPayload=dualPayload, sNMPCommunityTableNumber=sNMPCommunityTableNumber, radarDetectTrap=radarDetectTrap, ptp250=ptp250, sNMPCommunityOid=sNMPCommunityOid, currentFreqMHz=currentFreqMHz, noWirelessChannelAvailable=noWirelessChannelAvailable, pubStats=pubStats, smtpGroup=smtpGroup, configurationGroup=configurationGroup, cambium=cambium, smtp=smtp, sMTPServerPortNumber=sMTPServerPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapIPAddress=sNMPTrapIPAddress, productName=productName, channelBandwidth=channelBandwidth, softwareVersion=softwareVersion, remoteMACAddress=remoteMACAddress, fixedModMode=fixedModMode, receivePower=receivePower, dataPortAutoNegotiation=dataPortAutoNegotiation, nTPServerPortNumber=nTPServerPortNumber, ptpCompliance=ptpCompliance, productVariant=productVariant, sNMPTrapPortNumber=sNMPTrapPortNumber, ptpTraps=ptpTraps, extendedChannel=extendedChannel, wirelessLinkStatus=wirelessLinkStatus, licenceGroup=licenceGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapCommunity=sNMPTrapCommunity, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, radarDetectChannel=radarDetectChannel, systemClock=systemClock, installArmState=installArmState, searchState=searchState, pubStatsGroup=pubStatsGroup, measuredRange=measuredRange, sNMPTrapTableNumber=sNMPTrapTableNumber, linkLoss=linkLoss, timeZone=timeZone, regionCode=regionCode, phyStatus=phyStatus, transmitModulationMode=transmitModulationMode, receiveModulationMode=receiveModulationMode, installArmStateTrap=installArmStateTrap, receiveDataRate=receiveDataRate, nTPPollInterval=nTPPollInterval)
