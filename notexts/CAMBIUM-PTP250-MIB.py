...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", fixedModMode=fixedModMode, iPAddress=iPAddress, nTPLastSync=nTPLastSync, band=band, dataPortStatusTrap=dataPortStatusTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, ptp=ptp, ethernet=ethernet, smtp=smtp, configuredRange=configuredRange, ptpGroups=ptpGroups, extendedChannel=extendedChannel, linkName=linkName, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, installArmStateTrap=installArmStateTrap, linkLoss=linkLoss, cableLoss=cableLoss, receiveDataRate=receiveDataRate, configuration=configuration, notificationsGroup=notificationsGroup, productName=productName, noiseFloor=noiseFloor, ptpTraps=ptpTraps, sNMPCommunityTableNumber=sNMPCommunityTableNumber, pubStatsGroup=pubStatsGroup, management=management, sNMPTrapTable=sNMPTrapTable, productVariant=productVariant, signalStrengthRatio=signalStrengthRatio, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ptmp=ptmp, nTPSync=nTPSync, masterSlaveMode=masterSlaveMode, licence=licence, sNMPCommunityAccess=sNMPCommunityAccess, smtpGroup=smtpGroup, snmpControlGroup=snmpControlGroup, vlanPriority=vlanPriority, nTPServerPortNumber=nTPServerPortNumber, nTPPollInterval=nTPPollInterval, linkStatusTrap=linkStatusTrap, tFTPServerIPAddress=tFTPServerIPAddress, softwareVersion=softwareVersion, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, nTPState=nTPState, measuredRange=measuredRange, sMTPServerPortNumber=sMTPServerPortNumber, remoteMACAddress=remoteMACAddress, currentFreqMHz=currentFreqMHz, sNMPTrapVersion=sNMPTrapVersion, snmpControl=snmpControl, systemClock=systemClock, aggregateDataRate=aggregateDataRate, timeZone=timeZone, sNMPTrapTableIndex=sNMPTrapTableIndex, currentChannel=currentChannel, ntpGroup=ntpGroup, installArmState=installArmState, bootVersion=bootVersion, licenceGroup=licenceGroup, sMTPServerIPAddress=sMTPServerIPAddress, sNMPCommunityOid=sNMPCommunityOid, PYSNMP_MODULE_ID=cambium, remoteIPAddress=remoteIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dualPayload=dualPayload, sNMPCommunityTableIndex=sNMPCommunityTableIndex, phyStatus=phyStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ethernetGroup=ethernetGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, antennaGain=antennaGain, versions=versions, transmitPower=transmitPower, sMTPEnabledMessages=sMTPEnabledMessages, transmitDataRate=transmitDataRate, pubStats=pubStats, sNMPCommunityString=sNMPCommunityString, nTPServerIp=nTPServerIp, vectorError=vectorError, noWirelessChannelAvailable=noWirelessChannelAvailable, searchState=searchState, radarDetectChannel=radarDetectChannel, sNMPTrapCommunity=sNMPTrapCommunity, siteName=siteName, phyStatusGroup=phyStatusGroup, vlanTagging=vlanTagging, wirelessLinkStatus=wirelessLinkStatus, channelBandwidth=channelBandwidth, versionsGroup=versionsGroup, managementGroup=managementGroup, sNMPEnabledTraps=sNMPEnabledTraps, dataPortStatus=dataPortStatus, vlanId=vlanId, sNMPCommunityTable=sNMPCommunityTable, transmitModulationMode=transmitModulationMode, configuredModulationMode=configuredModulationMode, radarDetectTrap=radarDetectTrap, ptpTrapPrefix=ptpTrapPrefix, extendedFreqMHz=extendedFreqMHz, alarmsGroup=alarmsGroup, receivePower=receivePower, subnetMask=subnetMask, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, gatewayIPAddress=gatewayIPAddress, hardwareVersion=hardwareVersion, regionCode=regionCode, tFTPServerPortNumber=tFTPServerPortNumber, alarms=alarms, receiveModulationMode=receiveModulationMode, configurationGroup=configurationGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ntp=ntp, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sNMPTrapIPAddress=sNMPTrapIPAddress, channelSelection=channelSelection, maximumTransmitPower=maximumTransmitPower, ptp250=ptp250, sNMPTrapTableEntry=sNMPTrapTableEntry, cambium=cambium, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ptpCompliance=ptpCompliance)
