...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", siteName=siteName, vlanPriority=vlanPriority, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPCommunityOid=sNMPCommunityOid, cableLoss=cableLoss, sNMPCommunityTable=sNMPCommunityTable, ntpGroup=ntpGroup, sMTPServerPortNumber=sMTPServerPortNumber, pubStats=pubStats, sNMPTrapTableNumber=sNMPTrapTableNumber, versionsGroup=versionsGroup, timeZone=timeZone, snmpControlGroup=snmpControlGroup, band=band, productName=productName, ptpTrapPrefix=ptpTrapPrefix, receivePower=receivePower, sNMPTrapIPAddress=sNMPTrapIPAddress, vlanId=vlanId, ptpCompliance=ptpCompliance, phyStatus=phyStatus, extendedFreqMHz=extendedFreqMHz, sNMPTrapTable=sNMPTrapTable, managementGroup=managementGroup, remoteIPAddress=remoteIPAddress, currentFreqMHz=currentFreqMHz, snmpControl=snmpControl, sNMPCommunityTableEntry=sNMPCommunityTableEntry, smtpGroup=smtpGroup, sMTPEnabledMessages=sMTPEnabledMessages, iPAddress=iPAddress, management=management, productVariant=productVariant, ntp=ntp, ptp250=ptp250, linkName=linkName, sNMPTrapTableIndex=sNMPTrapTableIndex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, receiveModulationMode=receiveModulationMode, nTPPollInterval=nTPPollInterval, dataPortStatus=dataPortStatus, wirelessLinkStatus=wirelessLinkStatus, cambium=cambium, extendedChannel=extendedChannel, nTPServerPortNumber=nTPServerPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, channelBandwidth=channelBandwidth, sMTPServerIPAddress=sMTPServerIPAddress, fixedModMode=fixedModMode, vectorError=vectorError, transmitPower=transmitPower, alarms=alarms, hardwareVersion=hardwareVersion, signalStrengthRatio=signalStrengthRatio, ethernetGroup=ethernetGroup, remoteMACAddress=remoteMACAddress, configurationGroup=configurationGroup, phyStatusGroup=phyStatusGroup, gatewayIPAddress=gatewayIPAddress, nTPState=nTPState, ethernet=ethernet, regionCode=regionCode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, pubStatsGroup=pubStatsGroup, configuration=configuration, subnetMask=subnetMask, nTPLastSync=nTPLastSync, configuredModulationMode=configuredModulationMode, linkStatusTrap=linkStatusTrap, aggregateDataRate=aggregateDataRate, ptmp=ptmp, installArmStateTrap=installArmStateTrap, notificationsGroup=notificationsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, linkLoss=linkLoss, licence=licence, sNMPTrapVersion=sNMPTrapVersion, ptpTraps=ptpTraps, sMTPSourceEmailAddress=sMTPSourceEmailAddress, transmitDataRate=transmitDataRate, dualPayload=dualPayload, sNMPTrapPortNumber=sNMPTrapPortNumber, nTPServerIp=nTPServerIp, dataPortStatusTrap=dataPortStatusTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPCommunityAccess=sNMPCommunityAccess, tFTPServerPortNumber=tFTPServerPortNumber, searchState=searchState, channelSelection=channelSelection, systemClock=systemClock, radarDetectChannel=radarDetectChannel, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, PYSNMP_MODULE_ID=cambium, configuredRange=configuredRange, sNMPCommunityTableNumber=sNMPCommunityTableNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, alarmsGroup=alarmsGroup, receiveDataRate=receiveDataRate, sNMPTrapCommunity=sNMPTrapCommunity, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tFTPServerIPAddress=tFTPServerIPAddress, ptpGroups=ptpGroups, currentChannel=currentChannel, measuredRange=measuredRange, nTPSync=nTPSync, masterSlaveMode=masterSlaveMode, noiseFloor=noiseFloor, versions=versions, vlanTagging=vlanTagging, radarDetectTrap=radarDetectTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, transmitModulationMode=transmitModulationMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPCommunityString=sNMPCommunityString, licenceGroup=licenceGroup, smtp=smtp, softwareVersion=softwareVersion, sNMPCommunityTableIndex=sNMPCommunityTableIndex, ptp=ptp, antennaGain=antennaGain, bootVersion=bootVersion, maximumTransmitPower=maximumTransmitPower, installArmState=installArmState)
