...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", extendedChannel=extendedChannel, ptmp=ptmp, nTPState=nTPState, sMTPServerIPAddress=sMTPServerIPAddress, versions=versions, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, phyStatusGroup=phyStatusGroup, snmpControl=snmpControl, productVariant=productVariant, vectorError=vectorError, sNMPCommunityTable=sNMPCommunityTable, tFTPServerPortNumber=tFTPServerPortNumber, vlanPriority=vlanPriority, configuredRange=configuredRange, sNMPCommunityString=sNMPCommunityString, systemClock=systemClock, alarms=alarms, transmitPower=transmitPower, ptp250=ptp250, siteName=siteName, currentFreqMHz=currentFreqMHz, linkName=linkName, transmitModulationMode=transmitModulationMode, sNMPCommunityTableNumber=sNMPCommunityTableNumber, smtp=smtp, ptpTraps=ptpTraps, sNMPTrapVersion=sNMPTrapVersion, licenceGroup=licenceGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, ntp=ntp, sNMPTrapTable=sNMPTrapTable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, smtpGroup=smtpGroup, sNMPCommunityAccess=sNMPCommunityAccess, radarDetectTrap=radarDetectTrap, sNMPCommunityTableEntry=sNMPCommunityTableEntry, maximumTransmitPower=maximumTransmitPower, phyStatus=phyStatus, masterSlaveMode=masterSlaveMode, ptpCompliance=ptpCompliance, softwareVersion=softwareVersion, timeZone=timeZone, notificationsGroup=notificationsGroup, dataPortStatus=dataPortStatus, vlanId=vlanId, dataPortStatusTrap=dataPortStatusTrap, aggregateDataRate=aggregateDataRate, band=band, extendedFreqMHz=extendedFreqMHz, ethernetGroup=ethernetGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapCommunity=sNMPTrapCommunity, nTPServerPortNumber=nTPServerPortNumber, sMTPServerPortNumber=sMTPServerPortNumber, linkLoss=linkLoss, channelSelection=channelSelection, transmitDataRate=transmitDataRate, linkStatusTrap=linkStatusTrap, nTPPollInterval=nTPPollInterval, cableLoss=cableLoss, iPAddress=iPAddress, ethernet=ethernet, remoteMACAddress=remoteMACAddress, ptpGroups=ptpGroups, nTPSync=nTPSync, licence=licence, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPEnabledMessages=sMTPEnabledMessages, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, management=management, ntpGroup=ntpGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, pubStatsGroup=pubStatsGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, cambium=cambium, gatewayIPAddress=gatewayIPAddress, ptpTrapPrefix=ptpTrapPrefix, managementGroup=managementGroup, installArmState=installArmState, nTPServerIp=nTPServerIp, fixedModMode=fixedModMode, sNMPTrapTableNumber=sNMPTrapTableNumber, bootVersion=bootVersion, searchState=searchState, installArmStateTrap=installArmStateTrap, sNMPCommunityOid=sNMPCommunityOid, sNMPCommunityTableIndex=sNMPCommunityTableIndex, configuredModulationMode=configuredModulationMode, measuredRange=measuredRange, radarDetectChannel=radarDetectChannel, channelBandwidth=channelBandwidth, regionCode=regionCode, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapPortNumber=sNMPTrapPortNumber, nTPLastSync=nTPLastSync, versionsGroup=versionsGroup, hardwareVersion=hardwareVersion, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, subnetMask=subnetMask, remoteIPAddress=remoteIPAddress, signalStrengthRatio=signalStrengthRatio, vlanTagging=vlanTagging, dualPayload=dualPayload, pubStats=pubStats, wirelessLinkStatus=wirelessLinkStatus, antennaGain=antennaGain, snmpControlGroup=snmpControlGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, configuration=configuration, sNMPTrapTableEntry=sNMPTrapTableEntry, receiveDataRate=receiveDataRate, productName=productName, receivePower=receivePower, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, noiseFloor=noiseFloor, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tFTPServerIPAddress=tFTPServerIPAddress, receiveModulationMode=receiveModulationMode, currentChannel=currentChannel, configurationGroup=configurationGroup, alarmsGroup=alarmsGroup, ptp=ptp, PYSNMP_MODULE_ID=cambium)
