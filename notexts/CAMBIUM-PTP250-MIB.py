...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ptp250=ptp250, ethernet=ethernet, remoteMACAddress=remoteMACAddress, productName=productName, fixedModMode=fixedModMode, sNMPTrapTableEntry=sNMPTrapTableEntry, ntp=ntp, nTPServerIp=nTPServerIp, channelSelection=channelSelection, sNMPCommunityOid=sNMPCommunityOid, systemClock=systemClock, ptpTrapPrefix=ptpTrapPrefix, ptmp=ptmp, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, smtpGroup=smtpGroup, managementGroup=managementGroup, signalStrengthRatio=signalStrengthRatio, hardwareVersion=hardwareVersion, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, licence=licence, sNMPTrapVersion=sNMPTrapVersion, ethernetGroup=ethernetGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, nTPLastSync=nTPLastSync, installArmStateTrap=installArmStateTrap, cambium=cambium, PYSNMP_MODULE_ID=cambium, dualPayload=dualPayload, tFTPServerPortNumber=tFTPServerPortNumber, band=band, snmpControlGroup=snmpControlGroup, vlanId=vlanId, configuredRange=configuredRange, dataPortStatus=dataPortStatus, pubStatsGroup=pubStatsGroup, aggregateDataRate=aggregateDataRate, vlanTagging=vlanTagging, extendedChannel=extendedChannel, transmitModulationMode=transmitModulationMode, sNMPCommunityAccess=sNMPCommunityAccess, siteName=siteName, installArmState=installArmState, masterSlaveMode=masterSlaveMode, sNMPTrapCommunity=sNMPTrapCommunity, cableLoss=cableLoss, transmitDataRate=transmitDataRate, receiveDataRate=receiveDataRate, notificationsGroup=notificationsGroup, ptpTraps=ptpTraps, configuration=configuration, maximumTransmitPower=maximumTransmitPower, productVariant=productVariant, vectorError=vectorError, sNMPCommunityString=sNMPCommunityString, sMTPServerIPAddress=sMTPServerIPAddress, antennaGain=antennaGain, licenceGroup=licenceGroup, sNMPCommunityTableEntry=sNMPCommunityTableEntry, nTPState=nTPState, softwareVersion=softwareVersion, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, regionCode=regionCode, currentChannel=currentChannel, timeZone=timeZone, nTPServerPortNumber=nTPServerPortNumber, remoteIPAddress=remoteIPAddress, receivePower=receivePower, wirelessLinkStatus=wirelessLinkStatus, alarmsGroup=alarmsGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, ptpCompliance=ptpCompliance, smtp=smtp, sNMPCommunityTable=sNMPCommunityTable, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, gatewayIPAddress=gatewayIPAddress, sNMPTrapTable=sNMPTrapTable, versionsGroup=versionsGroup, channelBandwidth=channelBandwidth, receiveModulationMode=receiveModulationMode, phyStatus=phyStatus, ptp=ptp, management=management, phyStatusGroup=phyStatusGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, configurationGroup=configurationGroup, alarms=alarms, snmpControl=snmpControl, transmitPower=transmitPower, linkLoss=linkLoss, radarDetectChannel=radarDetectChannel, tFTPServerIPAddress=tFTPServerIPAddress, searchState=searchState, ntpGroup=ntpGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, configuredModulationMode=configuredModulationMode, nTPPollInterval=nTPPollInterval, linkStatusTrap=linkStatusTrap, sNMPCommunityTableIndex=sNMPCommunityTableIndex, dataPortStatusTrap=dataPortStatusTrap, vlanPriority=vlanPriority, extendedFreqMHz=extendedFreqMHz, ptpGroups=ptpGroups, linkName=linkName, currentFreqMHz=currentFreqMHz, noiseFloor=noiseFloor, pubStats=pubStats, versions=versions, sMTPServerPortNumber=sMTPServerPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, subnetMask=subnetMask, sMTPEnabledMessages=sMTPEnabledMessages, dataPortAutoNegotiation=dataPortAutoNegotiation, radarDetectTrap=radarDetectTrap, measuredRange=measuredRange, sNMPTrapTableIndex=sNMPTrapTableIndex, bootVersion=bootVersion, iPAddress=iPAddress, sNMPEnabledTraps=sNMPEnabledTraps, nTPSync=nTPSync, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, noWirelessChannelAvailable=noWirelessChannelAvailable)
