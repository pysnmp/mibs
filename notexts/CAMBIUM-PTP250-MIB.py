...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", tFTPServerPortNumber=tFTPServerPortNumber, configuredModulationMode=configuredModulationMode, vectorError=vectorError, dualPayload=dualPayload, cambium=cambium, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sNMPTrapTable=sNMPTrapTable, sNMPTrapIPAddress=sNMPTrapIPAddress, cableLoss=cableLoss, productVariant=productVariant, receivePower=receivePower, management=management, wirelessLinkStatus=wirelessLinkStatus, remoteIPAddress=remoteIPAddress, band=band, managementGroup=managementGroup, extendedChannel=extendedChannel, linkLoss=linkLoss, configurationGroup=configurationGroup, currentFreqMHz=currentFreqMHz, ptpTrapPrefix=ptpTrapPrefix, ptpCompliance=ptpCompliance, pubStats=pubStats, snmpControl=snmpControl, antennaGain=antennaGain, measuredRange=measuredRange, nTPState=nTPState, sMTPEnabledMessages=sMTPEnabledMessages, dataPortStatus=dataPortStatus, maximumTransmitPower=maximumTransmitPower, ntpGroup=ntpGroup, sMTPServerIPAddress=sMTPServerIPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, alarmsGroup=alarmsGroup, linkName=linkName, productName=productName, hardwareVersion=hardwareVersion, aggregateDataRate=aggregateDataRate, vlanTagging=vlanTagging, installArmStateTrap=installArmStateTrap, versions=versions, nTPLastSync=nTPLastSync, fixedModMode=fixedModMode, ethernet=ethernet, searchState=searchState, configuredRange=configuredRange, receiveModulationMode=receiveModulationMode, ntp=ntp, radarDetectTrap=radarDetectTrap, systemClock=systemClock, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, extendedFreqMHz=extendedFreqMHz, smtp=smtp, sNMPTrapPortNumber=sNMPTrapPortNumber, currentChannel=currentChannel, masterSlaveMode=masterSlaveMode, pubStatsGroup=pubStatsGroup, alarms=alarms, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sMTPServerPortNumber=sMTPServerPortNumber, licenceGroup=licenceGroup, ptp250=ptp250, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, installArmState=installArmState, tFTPServerIPAddress=tFTPServerIPAddress, remoteMACAddress=remoteMACAddress, nTPServerPortNumber=nTPServerPortNumber, sNMPTrapVersion=sNMPTrapVersion, sNMPCommunityAccess=sNMPCommunityAccess, sNMPCommunityString=sNMPCommunityString, siteName=siteName, PYSNMP_MODULE_ID=cambium, signalStrengthRatio=signalStrengthRatio, bootVersion=bootVersion, channelSelection=channelSelection, dataPortAutoNegotiation=dataPortAutoNegotiation, gatewayIPAddress=gatewayIPAddress, configuration=configuration, vlanId=vlanId, dataPortStatusTrap=dataPortStatusTrap, iPAddress=iPAddress, snmpControlGroup=snmpControlGroup, nTPPollInterval=nTPPollInterval, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPCommunityOid=sNMPCommunityOid, nTPSync=nTPSync, sNMPCommunityTable=sNMPCommunityTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ethernetGroup=ethernetGroup, timeZone=timeZone, transmitDataRate=transmitDataRate, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, versionsGroup=versionsGroup, radarDetectChannel=radarDetectChannel, channelBandwidth=channelBandwidth, transmitPower=transmitPower, subnetMask=subnetMask, phyStatusGroup=phyStatusGroup, notificationsGroup=notificationsGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, regionCode=regionCode, ptpTraps=ptpTraps, sNMPCommunityTableIndex=sNMPCommunityTableIndex, ptmp=ptmp, linkStatusTrap=linkStatusTrap, ptpGroups=ptpGroups, sNMPEnabledTraps=sNMPEnabledTraps, vlanPriority=vlanPriority, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, licence=licence, sNMPTrapTableNumber=sNMPTrapTableNumber, receiveDataRate=receiveDataRate, ptp=ptp, sNMPTrapTableEntry=sNMPTrapTableEntry, softwareVersion=softwareVersion, transmitModulationMode=transmitModulationMode, nTPServerIp=nTPServerIp, noiseFloor=noiseFloor, sNMPTrapCommunity=sNMPTrapCommunity, phyStatus=phyStatus, smtpGroup=smtpGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, noWirelessChannelAvailable=noWirelessChannelAvailable)
