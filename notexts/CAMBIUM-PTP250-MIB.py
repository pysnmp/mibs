...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", nTPState=nTPState, nTPPollInterval=nTPPollInterval, licenceGroup=licenceGroup, subnetMask=subnetMask, sNMPEnabledTraps=sNMPEnabledTraps, vlanTagging=vlanTagging, cambium=cambium, sMTPServerIPAddress=sMTPServerIPAddress, sNMPCommunityTable=sNMPCommunityTable, phyStatus=phyStatus, masterSlaveMode=masterSlaveMode, antennaGain=antennaGain, vectorError=vectorError, phyStatusGroup=phyStatusGroup, nTPServerIp=nTPServerIp, ptpCompliance=ptpCompliance, measuredRange=measuredRange, configuredRange=configuredRange, management=management, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, installArmState=installArmState, hardwareVersion=hardwareVersion, bootVersion=bootVersion, sNMPTrapTableEntry=sNMPTrapTableEntry, pubStats=pubStats, versions=versions, extendedChannel=extendedChannel, fixedModMode=fixedModMode, aggregateDataRate=aggregateDataRate, maximumTransmitPower=maximumTransmitPower, sNMPCommunityTableIndex=sNMPCommunityTableIndex, receiveDataRate=receiveDataRate, snmpControl=snmpControl, ptmp=ptmp, ptpTraps=ptpTraps, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptpGroups=ptpGroups, nTPLastSync=nTPLastSync, notificationsGroup=notificationsGroup, sNMPCommunityString=sNMPCommunityString, linkName=linkName, systemClock=systemClock, sNMPTrapTableNumber=sNMPTrapTableNumber, sMTPServerPortNumber=sMTPServerPortNumber, productName=productName, configuration=configuration, currentFreqMHz=currentFreqMHz, currentChannel=currentChannel, sNMPTrapPortNumber=sNMPTrapPortNumber, vlanPriority=vlanPriority, receivePower=receivePower, managementGroup=managementGroup, sNMPCommunityAccess=sNMPCommunityAccess, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortStatus=dataPortStatus, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, alarmsGroup=alarmsGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, smtpGroup=smtpGroup, sNMPCommunityOid=sNMPCommunityOid, PYSNMP_MODULE_ID=cambium, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, channelSelection=channelSelection, cableLoss=cableLoss, siteName=siteName, nTPServerPortNumber=nTPServerPortNumber, receiveModulationMode=receiveModulationMode, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, channelBandwidth=channelBandwidth, ptp250=ptp250, remoteIPAddress=remoteIPAddress, extendedFreqMHz=extendedFreqMHz, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapTableIndex=sNMPTrapTableIndex, noiseFloor=noiseFloor, softwareVersion=softwareVersion, searchState=searchState, transmitDataRate=transmitDataRate, ntpGroup=ntpGroup, timeZone=timeZone, ethernet=ethernet, licence=licence, sNMPTrapCommunity=sNMPTrapCommunity, radarDetectChannel=radarDetectChannel, sMTPSourceEmailAddress=sMTPSourceEmailAddress, nTPSync=nTPSync, radarDetectTrap=radarDetectTrap, vlanId=vlanId, regionCode=regionCode, linkStatusTrap=linkStatusTrap, configurationGroup=configurationGroup, sNMPTrapTable=sNMPTrapTable, configuredModulationMode=configuredModulationMode, wirelessLinkStatus=wirelessLinkStatus, dataPortStatusTrap=dataPortStatusTrap, alarms=alarms, sNMPCommunityTableNumber=sNMPCommunityTableNumber, remoteMACAddress=remoteMACAddress, versionsGroup=versionsGroup, snmpControlGroup=snmpControlGroup, linkLoss=linkLoss, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, smtp=smtp, pubStatsGroup=pubStatsGroup, transmitModulationMode=transmitModulationMode, band=band, dualPayload=dualPayload, sNMPCommunityTableEntry=sNMPCommunityTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ntp=ntp, transmitPower=transmitPower, ethernetGroup=ethernetGroup, tFTPServerPortNumber=tFTPServerPortNumber, installArmStateTrap=installArmStateTrap, ptp=ptp, tFTPServerIPAddress=tFTPServerIPAddress, sMTPEnabledMessages=sMTPEnabledMessages, gatewayIPAddress=gatewayIPAddress, productVariant=productVariant, signalStrengthRatio=signalStrengthRatio, iPAddress=iPAddress)
