...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", linkName=linkName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, nTPLastSync=nTPLastSync, radarDetectChannel=radarDetectChannel, ethernet=ethernet, currentChannel=currentChannel, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, measuredRange=measuredRange, hardwareVersion=hardwareVersion, alarms=alarms, timeZone=timeZone, ntp=ntp, installArmStateTrap=installArmStateTrap, productName=productName, transmitModulationMode=transmitModulationMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, subnetMask=subnetMask, ethernetGroup=ethernetGroup, remoteMACAddress=remoteMACAddress, ptpGroups=ptpGroups, antennaGain=antennaGain, sMTPEnabledMessages=sMTPEnabledMessages, receivePower=receivePower, signalStrengthRatio=signalStrengthRatio, bootVersion=bootVersion, aggregateDataRate=aggregateDataRate, sNMPCommunityTable=sNMPCommunityTable, cableLoss=cableLoss, sMTPServerPortNumber=sMTPServerPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, alarmsGroup=alarmsGroup, linkLoss=linkLoss, productVariant=productVariant, snmpControl=snmpControl, vlanId=vlanId, maximumTransmitPower=maximumTransmitPower, phyStatusGroup=phyStatusGroup, managementGroup=managementGroup, vlanPriority=vlanPriority, sNMPCommunityAccess=sNMPCommunityAccess, receiveModulationMode=receiveModulationMode, pubStats=pubStats, installArmState=installArmState, masterSlaveMode=masterSlaveMode, extendedFreqMHz=extendedFreqMHz, phyStatus=phyStatus, iPAddress=iPAddress, ntpGroup=ntpGroup, versions=versions, sNMPTrapVersion=sNMPTrapVersion, configuration=configuration, vlanTagging=vlanTagging, configurationGroup=configurationGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, nTPState=nTPState, dataPortStatusTrap=dataPortStatusTrap, radarDetectTrap=radarDetectTrap, sNMPCommunityTableIndex=sNMPCommunityTableIndex, smtpGroup=smtpGroup, configuredRange=configuredRange, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, nTPSync=nTPSync, ptp250=ptp250, pubStatsGroup=pubStatsGroup, nTPPollInterval=nTPPollInterval, licenceGroup=licenceGroup, tFTPServerIPAddress=tFTPServerIPAddress, sNMPEnabledTraps=sNMPEnabledTraps, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, currentFreqMHz=currentFreqMHz, sNMPTrapPortNumber=sNMPTrapPortNumber, nTPServerPortNumber=nTPServerPortNumber, sNMPCommunityTableEntry=sNMPCommunityTableEntry, dualPayload=dualPayload, noiseFloor=noiseFloor, dataPortAutoNegotiation=dataPortAutoNegotiation, ptmp=ptmp, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPCommunityString=sNMPCommunityString, remoteIPAddress=remoteIPAddress, regionCode=regionCode, smtp=smtp, linkStatusTrap=linkStatusTrap, configuredModulationMode=configuredModulationMode, ptp=ptp, gatewayIPAddress=gatewayIPAddress, licence=licence, ptpTraps=ptpTraps, notificationsGroup=notificationsGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, fixedModMode=fixedModMode, sNMPTrapTableNumber=sNMPTrapTableNumber, softwareVersion=softwareVersion, channelBandwidth=channelBandwidth, sNMPTrapTable=sNMPTrapTable, sNMPCommunityTableNumber=sNMPCommunityTableNumber, management=management, sNMPCommunityOid=sNMPCommunityOid, band=band, vectorError=vectorError, sNMPTrapTableIndex=sNMPTrapTableIndex, extendedChannel=extendedChannel, systemClock=systemClock, tFTPServerPortNumber=tFTPServerPortNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, cambium=cambium, wirelessLinkStatus=wirelessLinkStatus, ptpTrapPrefix=ptpTrapPrefix, ptpCompliance=ptpCompliance, nTPServerIp=nTPServerIp, sNMPTrapCommunity=sNMPTrapCommunity, channelSelection=channelSelection, receiveDataRate=receiveDataRate, searchState=searchState, snmpControlGroup=snmpControlGroup, transmitDataRate=transmitDataRate, sMTPServerIPAddress=sMTPServerIPAddress, PYSNMP_MODULE_ID=cambium, sNMPTrapTableEntry=sNMPTrapTableEntry, versionsGroup=versionsGroup, transmitPower=transmitPower, siteName=siteName, dataPortStatus=dataPortStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex)
