...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", ptp250=ptp250, fixedModMode=fixedModMode, vlanTagging=vlanTagging, transmitPower=transmitPower, tFTPServerPortNumber=tFTPServerPortNumber, radarDetectChannel=radarDetectChannel, sNMPCommunityTableEntry=sNMPCommunityTableEntry, cableLoss=cableLoss, sNMPCommunityOid=sNMPCommunityOid, linkLoss=linkLoss, vlanId=vlanId, linkStatusTrap=linkStatusTrap, extendedChannel=extendedChannel, softwareVersion=softwareVersion, ptpTraps=ptpTraps, phyStatus=phyStatus, sMTPEnabledMessages=sMTPEnabledMessages, alarmsGroup=alarmsGroup, band=band, systemClock=systemClock, productName=productName, ethernet=ethernet, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, licence=licence, tFTPServerIPAddress=tFTPServerIPAddress, licenceGroup=licenceGroup, versionsGroup=versionsGroup, gatewayIPAddress=gatewayIPAddress, nTPSync=nTPSync, subnetMask=subnetMask, currentFreqMHz=currentFreqMHz, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, searchState=searchState, ntpGroup=ntpGroup, ptpGroups=ptpGroups, channelSelection=channelSelection, siteName=siteName, smtp=smtp, vectorError=vectorError, vlanPriority=vlanPriority, antennaGain=antennaGain, configuredRange=configuredRange, wirelessLinkStatus=wirelessLinkStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, nTPServerIp=nTPServerIp, transmitModulationMode=transmitModulationMode, nTPLastSync=nTPLastSync, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortAutoNegotiation=dataPortAutoNegotiation, ntp=ntp, aggregateDataRate=aggregateDataRate, installArmStateTrap=installArmStateTrap, sNMPTrapTable=sNMPTrapTable, configurationGroup=configurationGroup, nTPPollInterval=nTPPollInterval, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapIPAddress=sNMPTrapIPAddress, hardwareVersion=hardwareVersion, snmpControl=snmpControl, sNMPEnabledTraps=sNMPEnabledTraps, signalStrengthRatio=signalStrengthRatio, extendedFreqMHz=extendedFreqMHz, sMTPSourceEmailAddress=sMTPSourceEmailAddress, linkName=linkName, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapVersion=sNMPTrapVersion, cambium=cambium, smtpGroup=smtpGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, notificationsGroup=notificationsGroup, sNMPCommunityTableIndex=sNMPCommunityTableIndex, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, masterSlaveMode=masterSlaveMode, receivePower=receivePower, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, alarms=alarms, maximumTransmitPower=maximumTransmitPower, sNMPCommunityAccess=sNMPCommunityAccess, nTPServerPortNumber=nTPServerPortNumber, radarDetectTrap=radarDetectTrap, pubStats=pubStats, timeZone=timeZone, remoteMACAddress=remoteMACAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, regionCode=regionCode, noiseFloor=noiseFloor, sNMPTrapCommunity=sNMPTrapCommunity, snmpControlGroup=snmpControlGroup, transmitDataRate=transmitDataRate, nTPState=nTPState, sNMPCommunityTable=sNMPCommunityTable, remoteIPAddress=remoteIPAddress, receiveDataRate=receiveDataRate, ptp=ptp, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ptpCompliance=ptpCompliance, iPAddress=iPAddress, bootVersion=bootVersion, sNMPCommunityString=sNMPCommunityString, PYSNMP_MODULE_ID=cambium, configuredModulationMode=configuredModulationMode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, versions=versions, dataPortStatus=dataPortStatus, dataPortStatusTrap=dataPortStatusTrap, sMTPServerIPAddress=sMTPServerIPAddress, installArmState=installArmState, productVariant=productVariant, dualPayload=dualPayload, sNMPCommunityTableNumber=sNMPCommunityTableNumber, pubStatsGroup=pubStatsGroup, phyStatusGroup=phyStatusGroup, ethernetGroup=ethernetGroup, measuredRange=measuredRange, currentChannel=currentChannel, receiveModulationMode=receiveModulationMode, management=management, managementGroup=managementGroup, configuration=configuration, channelBandwidth=channelBandwidth, ptmp=ptmp)
