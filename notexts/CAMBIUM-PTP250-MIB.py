...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", ptpGroups=ptpGroups, ptp250=ptp250, PYSNMP_MODULE_ID=cambium, sNMPTrapCommunity=sNMPTrapCommunity, managementGroup=managementGroup, phyStatus=phyStatus, receiveDataRate=receiveDataRate, ptp=ptp, tFTPServerIPAddress=tFTPServerIPAddress, timeZone=timeZone, ethernetGroup=ethernetGroup, systemClock=systemClock, hardwareVersion=hardwareVersion, noiseFloor=noiseFloor, sNMPTrapIPAddress=sNMPTrapIPAddress, linkLoss=linkLoss, phyStatusGroup=phyStatusGroup, aggregateDataRate=aggregateDataRate, band=band, softwareVersion=softwareVersion, cambium=cambium, iPAddress=iPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, nTPSync=nTPSync, masterSlaveMode=masterSlaveMode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, signalStrengthRatio=signalStrengthRatio, licence=licence, radarDetectTrap=radarDetectTrap, configuration=configuration, sNMPTrapTableNumber=sNMPTrapTableNumber, snmpControl=snmpControl, productName=productName, nTPServerIp=nTPServerIp, sNMPTrapTable=sNMPTrapTable, dataPortStatus=dataPortStatus, subnetMask=subnetMask, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, searchState=searchState, bootVersion=bootVersion, transmitDataRate=transmitDataRate, remoteMACAddress=remoteMACAddress, channelSelection=channelSelection, pubStats=pubStats, sNMPCommunityTableEntry=sNMPCommunityTableEntry, maximumTransmitPower=maximumTransmitPower, nTPState=nTPState, notificationsGroup=notificationsGroup, receiveModulationMode=receiveModulationMode, sNMPTrapPortNumber=sNMPTrapPortNumber, ptmp=ptmp, sNMPTrapVersion=sNMPTrapVersion, versions=versions, gatewayIPAddress=gatewayIPAddress, snmpControlGroup=snmpControlGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPCommunityAccess=sNMPCommunityAccess, ntp=ntp, sMTPServerPortNumber=sMTPServerPortNumber, transmitModulationMode=transmitModulationMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPEnabledTraps=sNMPEnabledTraps, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPCommunityOid=sNMPCommunityOid, sMTPEnabledMessages=sMTPEnabledMessages, currentFreqMHz=currentFreqMHz, sNMPCommunityString=sNMPCommunityString, installArmStateTrap=installArmStateTrap, management=management, nTPServerPortNumber=nTPServerPortNumber, installArmState=installArmState, measuredRange=measuredRange, alarms=alarms, channelBandwidth=channelBandwidth, vlanId=vlanId, tFTPServerPortNumber=tFTPServerPortNumber, versionsGroup=versionsGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, configuredRange=configuredRange, nTPPollInterval=nTPPollInterval, fixedModMode=fixedModMode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptpCompliance=ptpCompliance, alarmsGroup=alarmsGroup, vlanPriority=vlanPriority, dualPayload=dualPayload, configuredModulationMode=configuredModulationMode, licenceGroup=licenceGroup, receivePower=receivePower, productVariant=productVariant, dataPortAutoNegotiation=dataPortAutoNegotiation, remoteIPAddress=remoteIPAddress, vectorError=vectorError, smtpGroup=smtpGroup, siteName=siteName, currentChannel=currentChannel, smtp=smtp, ethernet=ethernet, ntpGroup=ntpGroup, sNMPCommunityTableNumber=sNMPCommunityTableNumber, extendedFreqMHz=extendedFreqMHz, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptpTrapPrefix=ptpTrapPrefix, configurationGroup=configurationGroup, vlanTagging=vlanTagging, regionCode=regionCode, ptpTraps=ptpTraps, sNMPTrapTableEntry=sNMPTrapTableEntry, wirelessLinkStatus=wirelessLinkStatus, linkStatusTrap=linkStatusTrap, cableLoss=cableLoss, transmitPower=transmitPower, extendedChannel=extendedChannel, dataPortStatusTrap=dataPortStatusTrap, antennaGain=antennaGain, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPServerIPAddress=sMTPServerIPAddress, linkName=linkName, sNMPCommunityTableIndex=sNMPCommunityTableIndex, pubStatsGroup=pubStatsGroup, nTPLastSync=nTPLastSync, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPCommunityTable=sNMPCommunityTable, radarDetectChannel=radarDetectChannel)
