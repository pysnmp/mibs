...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", systemClock=systemClock, sNMPEnabledTraps=sNMPEnabledTraps, ptmp=ptmp, nTPLastSync=nTPLastSync, pubStatsGroup=pubStatsGroup, receiveDataRate=receiveDataRate, snmpControlGroup=snmpControlGroup, timeZone=timeZone, sNMPCommunityTableEntry=sNMPCommunityTableEntry, ptp250=ptp250, tFTPServerIPAddress=tFTPServerIPAddress, receiveModulationMode=receiveModulationMode, cambium=cambium, configuredModulationMode=configuredModulationMode, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, channelSelection=channelSelection, siteName=siteName, dataPortStatus=dataPortStatus, channelBandwidth=channelBandwidth, dataPortAutoNegotiation=dataPortAutoNegotiation, searchState=searchState, sNMPTrapPortNumber=sNMPTrapPortNumber, notificationsGroup=notificationsGroup, band=band, remoteIPAddress=remoteIPAddress, sNMPCommunityString=sNMPCommunityString, sNMPCommunityTableNumber=sNMPCommunityTableNumber, extendedChannel=extendedChannel, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapCommunity=sNMPTrapCommunity, aggregateDataRate=aggregateDataRate, cableLoss=cableLoss, iPAddress=iPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, wirelessLinkStatus=wirelessLinkStatus, vlanTagging=vlanTagging, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, nTPSync=nTPSync, alarmsGroup=alarmsGroup, dualPayload=dualPayload, ptp=ptp, smtpGroup=smtpGroup, softwareVersion=softwareVersion, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, linkStatusTrap=linkStatusTrap, dataPortStatusTrap=dataPortStatusTrap, transmitPower=transmitPower, sMTPServerIPAddress=sMTPServerIPAddress, sNMPCommunityTable=sNMPCommunityTable, vlanId=vlanId, productVariant=productVariant, vectorError=vectorError, regionCode=regionCode, gatewayIPAddress=gatewayIPAddress, ethernet=ethernet, licence=licence, ptpCompliance=ptpCompliance, sNMPTrapTableEntry=sNMPTrapTableEntry, nTPPollInterval=nTPPollInterval, sNMPTrapIPAddress=sNMPTrapIPAddress, maximumTransmitPower=maximumTransmitPower, managementGroup=managementGroup, phyStatusGroup=phyStatusGroup, sNMPCommunityAccess=sNMPCommunityAccess, ptpGroups=ptpGroups, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptpTrapPrefix=ptpTrapPrefix, transmitModulationMode=transmitModulationMode, transmitDataRate=transmitDataRate, measuredRange=measuredRange, phyStatus=phyStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPEnabledMessages=sMTPEnabledMessages, hardwareVersion=hardwareVersion, fixedModMode=fixedModMode, productName=productName, nTPServerIp=nTPServerIp, noWirelessChannelAvailable=noWirelessChannelAvailable, currentChannel=currentChannel, nTPState=nTPState, versions=versions, nTPServerPortNumber=nTPServerPortNumber, pubStats=pubStats, sNMPTrapTable=sNMPTrapTable, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ptpTraps=ptpTraps, tFTPServerPortNumber=tFTPServerPortNumber, currentFreqMHz=currentFreqMHz, alarms=alarms, noiseFloor=noiseFloor, antennaGain=antennaGain, sNMPTrapVersion=sNMPTrapVersion, extendedFreqMHz=extendedFreqMHz, subnetMask=subnetMask, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ntpGroup=ntpGroup, versionsGroup=versionsGroup, masterSlaveMode=masterSlaveMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, installArmStateTrap=installArmStateTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, radarDetectTrap=radarDetectTrap, snmpControl=snmpControl, management=management, installArmState=installArmState, linkLoss=linkLoss, licenceGroup=licenceGroup, linkName=linkName, sNMPCommunityOid=sNMPCommunityOid, remoteMACAddress=remoteMACAddress, vlanPriority=vlanPriority, configuration=configuration, radarDetectChannel=radarDetectChannel, PYSNMP_MODULE_ID=cambium, bootVersion=bootVersion, configuredRange=configuredRange, ethernetGroup=ethernetGroup, receivePower=receivePower, signalStrengthRatio=signalStrengthRatio, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPCommunityTableIndex=sNMPCommunityTableIndex, ntp=ntp, smtp=smtp, configurationGroup=configurationGroup)
