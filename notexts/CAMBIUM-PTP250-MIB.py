...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sMTPServerIPAddress=sMTPServerIPAddress, ethernetGroup=ethernetGroup, nTPPollInterval=nTPPollInterval, nTPLastSync=nTPLastSync, sNMPCommunityTableIndex=sNMPCommunityTableIndex, ntp=ntp, currentChannel=currentChannel, ptpCompliance=ptpCompliance, sNMPCommunityAccess=sNMPCommunityAccess, versionsGroup=versionsGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPCommunityTable=sNMPCommunityTable, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, radarDetectChannel=radarDetectChannel, phyStatusGroup=phyStatusGroup, receiveModulationMode=receiveModulationMode, ethernet=ethernet, sMTPEnabledMessages=sMTPEnabledMessages, searchState=searchState, sNMPCommunityOid=sNMPCommunityOid, antennaGain=antennaGain, nTPState=nTPState, vlanPriority=vlanPriority, channelSelection=channelSelection, wirelessLinkStatus=wirelessLinkStatus, fixedModMode=fixedModMode, measuredRange=measuredRange, cableLoss=cableLoss, ntpGroup=ntpGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, receiveDataRate=receiveDataRate, transmitPower=transmitPower, alarms=alarms, bootVersion=bootVersion, productVariant=productVariant, receivePower=receivePower, configurationGroup=configurationGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, linkName=linkName, licenceGroup=licenceGroup, tFTPServerPortNumber=tFTPServerPortNumber, dataPortStatus=dataPortStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, cambium=cambium, remoteMACAddress=remoteMACAddress, linkLoss=linkLoss, ptpTrapPrefix=ptpTrapPrefix, sNMPEnabledTraps=sNMPEnabledTraps, configuredModulationMode=configuredModulationMode, band=band, dualPayload=dualPayload, sNMPCommunityTableEntry=sNMPCommunityTableEntry, vectorError=vectorError, ptmp=ptmp, sNMPCommunityTableNumber=sNMPCommunityTableNumber, snmpControl=snmpControl, management=management, noiseFloor=noiseFloor, installArmStateTrap=installArmStateTrap, extendedFreqMHz=extendedFreqMHz, productName=productName, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, hardwareVersion=hardwareVersion, transmitModulationMode=transmitModulationMode, vlanTagging=vlanTagging, alarmsGroup=alarmsGroup, configuration=configuration, sNMPTrapTable=sNMPTrapTable, aggregateDataRate=aggregateDataRate, licence=licence, remoteIPAddress=remoteIPAddress, vlanId=vlanId, extendedChannel=extendedChannel, ptpGroups=ptpGroups, radarDetectTrap=radarDetectTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, iPAddress=iPAddress, versions=versions, pubStats=pubStats, ptp=ptp, signalStrengthRatio=signalStrengthRatio, pubStatsGroup=pubStatsGroup, transmitDataRate=transmitDataRate, subnetMask=subnetMask, phyStatus=phyStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ptp250=ptp250, smtp=smtp, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, installArmState=installArmState, snmpControlGroup=snmpControlGroup, gatewayIPAddress=gatewayIPAddress, notificationsGroup=notificationsGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, nTPServerIp=nTPServerIp, linkStatusTrap=linkStatusTrap, channelBandwidth=channelBandwidth, masterSlaveMode=masterSlaveMode, sNMPCommunityString=sNMPCommunityString, configuredRange=configuredRange, sNMPTrapVersion=sNMPTrapVersion, ptpTraps=ptpTraps, regionCode=regionCode, maximumTransmitPower=maximumTransmitPower, dataPortStatusTrap=dataPortStatusTrap, nTPSync=nTPSync, managementGroup=managementGroup, siteName=siteName, smtpGroup=smtpGroup, softwareVersion=softwareVersion, tFTPServerIPAddress=tFTPServerIPAddress, currentFreqMHz=currentFreqMHz, sNMPTrapCommunity=sNMPTrapCommunity, systemClock=systemClock, nTPServerPortNumber=nTPServerPortNumber, timeZone=timeZone, PYSNMP_MODULE_ID=cambium)
