...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", timeZone=timeZone, aggregateDataRate=aggregateDataRate, transmitModulationMode=transmitModulationMode, sNMPCommunityTableEntry=sNMPCommunityTableEntry, ntp=ntp, sNMPTrapIPAddress=sNMPTrapIPAddress, installArmState=installArmState, sNMPTrapTableIndex=sNMPTrapTableIndex, measuredRange=measuredRange, wirelessLinkStatus=wirelessLinkStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, snmpControlGroup=snmpControlGroup, snmpControl=snmpControl, nTPState=nTPState, regionCode=regionCode, fixedModMode=fixedModMode, pubStatsGroup=pubStatsGroup, ethernetGroup=ethernetGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, configuration=configuration, remoteMACAddress=remoteMACAddress, systemClock=systemClock, vlanTagging=vlanTagging, phyStatusGroup=phyStatusGroup, nTPServerIp=nTPServerIp, smtpGroup=smtpGroup, vlanId=vlanId, signalStrengthRatio=signalStrengthRatio, iPAddress=iPAddress, masterSlaveMode=masterSlaveMode, sNMPTrapTable=sNMPTrapTable, linkLoss=linkLoss, receiveDataRate=receiveDataRate, sNMPCommunityTable=sNMPCommunityTable, sNMPTrapCommunity=sNMPTrapCommunity, nTPSync=nTPSync, ptp=ptp, antennaGain=antennaGain, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, nTPPollInterval=nTPPollInterval, transmitPower=transmitPower, band=band, productName=productName, currentChannel=currentChannel, configurationGroup=configurationGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptpGroups=ptpGroups, linkName=linkName, sNMPCommunityString=sNMPCommunityString, ntpGroup=ntpGroup, sNMPCommunityTableIndex=sNMPCommunityTableIndex, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receiveModulationMode=receiveModulationMode, bootVersion=bootVersion, remoteIPAddress=remoteIPAddress, radarDetectChannel=radarDetectChannel, smtp=smtp, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortStatus=dataPortStatus, nTPServerPortNumber=nTPServerPortNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, channelSelection=channelSelection, receivePower=receivePower, licence=licence, notificationsGroup=notificationsGroup, configuredRange=configuredRange, channelBandwidth=channelBandwidth, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, management=management, extendedFreqMHz=extendedFreqMHz, searchState=searchState, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPServerPortNumber=sMTPServerPortNumber, cableLoss=cableLoss, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sNMPCommunityOid=sNMPCommunityOid, installArmStateTrap=installArmStateTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, ptp250=ptp250, gatewayIPAddress=gatewayIPAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, extendedChannel=extendedChannel, maximumTransmitPower=maximumTransmitPower, hardwareVersion=hardwareVersion, configuredModulationMode=configuredModulationMode, dataPortStatusTrap=dataPortStatusTrap, sNMPTrapVersion=sNMPTrapVersion, sNMPCommunityAccess=sNMPCommunityAccess, sMTPEnabledMessages=sMTPEnabledMessages, softwareVersion=softwareVersion, versionsGroup=versionsGroup, noiseFloor=noiseFloor, sMTPServerIPAddress=sMTPServerIPAddress, nTPLastSync=nTPLastSync, sNMPTrapTableEntry=sNMPTrapTableEntry, ptpTraps=ptpTraps, vectorError=vectorError, ptpTrapPrefix=ptpTrapPrefix, linkStatusTrap=linkStatusTrap, subnetMask=subnetMask, managementGroup=managementGroup, productVariant=productVariant, cambium=cambium, pubStats=pubStats, transmitDataRate=transmitDataRate, vlanPriority=vlanPriority, radarDetectTrap=radarDetectTrap, tFTPServerPortNumber=tFTPServerPortNumber, licenceGroup=licenceGroup, siteName=siteName, sNMPEnabledTraps=sNMPEnabledTraps, versions=versions, alarms=alarms, ptpCompliance=ptpCompliance, tFTPServerIPAddress=tFTPServerIPAddress, alarmsGroup=alarmsGroup, PYSNMP_MODULE_ID=cambium, ptmp=ptmp, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ethernet=ethernet, dualPayload=dualPayload, phyStatus=phyStatus, currentFreqMHz=currentFreqMHz)
