...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", vlanPriority=vlanPriority, ptpTrapPrefix=ptpTrapPrefix, configuredRange=configuredRange, dataPortStatusTrap=dataPortStatusTrap, noiseFloor=noiseFloor, antennaGain=antennaGain, configuredModulationMode=configuredModulationMode, ethernet=ethernet, vectorError=vectorError, alarmsGroup=alarmsGroup, extendedFreqMHz=extendedFreqMHz, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, fixedModMode=fixedModMode, vlanId=vlanId, subnetMask=subnetMask, ntpGroup=ntpGroup, ethernetGroup=ethernetGroup, remoteIPAddress=remoteIPAddress, nTPLastSync=nTPLastSync, linkStatusTrap=linkStatusTrap, vlanTagging=vlanTagging, transmitDataRate=transmitDataRate, sNMPCommunityTableEntry=sNMPCommunityTableEntry, bootVersion=bootVersion, gatewayIPAddress=gatewayIPAddress, sNMPCommunityString=sNMPCommunityString, iPAddress=iPAddress, sMTPEnabledMessages=sMTPEnabledMessages, masterSlaveMode=masterSlaveMode, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sNMPTrapTableEntry=sNMPTrapTableEntry, currentChannel=currentChannel, alarms=alarms, linkName=linkName, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapVersion=sNMPTrapVersion, tFTPServerPortNumber=tFTPServerPortNumber, timeZone=timeZone, dualPayload=dualPayload, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitPower=transmitPower, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, nTPState=nTPState, wirelessLinkStatus=wirelessLinkStatus, sNMPTrapCommunity=sNMPTrapCommunity, searchState=searchState, regionCode=regionCode, phyStatus=phyStatus, versions=versions, nTPPollInterval=nTPPollInterval, snmpControl=snmpControl, notificationsGroup=notificationsGroup, radarDetectTrap=radarDetectTrap, smtpGroup=smtpGroup, ptpTraps=ptpTraps, ptpGroups=ptpGroups, PYSNMP_MODULE_ID=cambium, installArmStateTrap=installArmStateTrap, currentFreqMHz=currentFreqMHz, systemClock=systemClock, siteName=siteName, hardwareVersion=hardwareVersion, band=band, installArmState=installArmState, sNMPCommunityOid=sNMPCommunityOid, receiveModulationMode=receiveModulationMode, nTPSync=nTPSync, nTPServerIp=nTPServerIp, licenceGroup=licenceGroup, radarDetectChannel=radarDetectChannel, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, channelSelection=channelSelection, management=management, phyStatusGroup=phyStatusGroup, pubStats=pubStats, productVariant=productVariant, ptp250=ptp250, snmpControlGroup=snmpControlGroup, ntp=ntp, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapTable=sNMPTrapTable, measuredRange=measuredRange, receiveDataRate=receiveDataRate, smtp=smtp, licence=licence, channelBandwidth=channelBandwidth, dataPortStatus=dataPortStatus, signalStrengthRatio=signalStrengthRatio, pubStatsGroup=pubStatsGroup, linkLoss=linkLoss, sNMPCommunityTable=sNMPCommunityTable, sNMPCommunityAccess=sNMPCommunityAccess, tFTPServerIPAddress=tFTPServerIPAddress, ptpCompliance=ptpCompliance, configuration=configuration, nTPServerPortNumber=nTPServerPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, ptmp=ptmp, sMTPSourceEmailAddress=sMTPSourceEmailAddress, softwareVersion=softwareVersion, sNMPEnabledTraps=sNMPEnabledTraps, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptp=ptp, managementGroup=managementGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, extendedChannel=extendedChannel, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, maximumTransmitPower=maximumTransmitPower, productName=productName, remoteMACAddress=remoteMACAddress, receivePower=receivePower, sNMPCommunityTableNumber=sNMPCommunityTableNumber, cableLoss=cableLoss, aggregateDataRate=aggregateDataRate, sNMPTrapIPAddress=sNMPTrapIPAddress, configurationGroup=configurationGroup, versionsGroup=versionsGroup, sMTPServerPortNumber=sMTPServerPortNumber, cambium=cambium, sMTPServerIPAddress=sMTPServerIPAddress, transmitModulationMode=transmitModulationMode)
