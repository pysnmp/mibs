...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", snmpControlGroup=snmpControlGroup, tFTPServerPortNumber=tFTPServerPortNumber, phyStatus=phyStatus, receiveModulationMode=receiveModulationMode, ptp250=ptp250, ethernet=ethernet, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapTable=sNMPTrapTable, sNMPCommunityAccess=sNMPCommunityAccess, pubStats=pubStats, ptpTrapPrefix=ptpTrapPrefix, configuredRange=configuredRange, linkStatusTrap=linkStatusTrap, regionCode=regionCode, linkName=linkName, sNMPTrapTableEntry=sNMPTrapTableEntry, antennaGain=antennaGain, sNMPTrapCommunity=sNMPTrapCommunity, smtpGroup=smtpGroup, nTPServerPortNumber=nTPServerPortNumber, linkLoss=linkLoss, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapTableNumber=sNMPTrapTableNumber, wirelessLinkStatus=wirelessLinkStatus, installArmState=installArmState, gatewayIPAddress=gatewayIPAddress, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sNMPTrapIPAddress=sNMPTrapIPAddress, notificationsGroup=notificationsGroup, installArmStateTrap=installArmStateTrap, productName=productName, versions=versions, dataPortAutoNegotiation=dataPortAutoNegotiation, hardwareVersion=hardwareVersion, channelSelection=channelSelection, sMTPServerIPAddress=sMTPServerIPAddress, aggregateDataRate=aggregateDataRate, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ptpTraps=ptpTraps, phyStatusGroup=phyStatusGroup, ptpCompliance=ptpCompliance, dualPayload=dualPayload, sNMPCommunityString=sNMPCommunityString, sNMPTrapPortNumber=sNMPTrapPortNumber, snmpControl=snmpControl, transmitModulationMode=transmitModulationMode, tFTPServerIPAddress=tFTPServerIPAddress, timeZone=timeZone, sMTPServerPortNumber=sMTPServerPortNumber, sNMPCommunityTableIndex=sNMPCommunityTableIndex, nTPLastSync=nTPLastSync, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPEnabledMessages=sMTPEnabledMessages, vlanTagging=vlanTagging, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, pubStatsGroup=pubStatsGroup, vectorError=vectorError, nTPPollInterval=nTPPollInterval, iPAddress=iPAddress, configuration=configuration, channelBandwidth=channelBandwidth, extendedFreqMHz=extendedFreqMHz, alarms=alarms, transmitDataRate=transmitDataRate, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, nTPSync=nTPSync, radarDetectChannel=radarDetectChannel, configurationGroup=configurationGroup, vlanPriority=vlanPriority, cableLoss=cableLoss, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, softwareVersion=softwareVersion, noWirelessChannelAvailable=noWirelessChannelAvailable, ntp=ntp, smtp=smtp, searchState=searchState, ptpGroups=ptpGroups, band=band, ptp=ptp, licence=licence, systemClock=systemClock, currentFreqMHz=currentFreqMHz, management=management, subnetMask=subnetMask, sNMPCommunityTableNumber=sNMPCommunityTableNumber, PYSNMP_MODULE_ID=cambium, radarDetectTrap=radarDetectTrap, cambium=cambium, ntpGroup=ntpGroup, receivePower=receivePower, managementGroup=managementGroup, bootVersion=bootVersion, signalStrengthRatio=signalStrengthRatio, sNMPCommunityOid=sNMPCommunityOid, noiseFloor=noiseFloor, transmitPower=transmitPower, measuredRange=measuredRange, versionsGroup=versionsGroup, licenceGroup=licenceGroup, siteName=siteName, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, fixedModMode=fixedModMode, remoteIPAddress=remoteIPAddress, vlanId=vlanId, maximumTransmitPower=maximumTransmitPower, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapVersion=sNMPTrapVersion, receiveDataRate=receiveDataRate, nTPState=nTPState, ptmp=ptmp, configuredModulationMode=configuredModulationMode, remoteMACAddress=remoteMACAddress, dataPortStatusTrap=dataPortStatusTrap, alarmsGroup=alarmsGroup, productVariant=productVariant, nTPServerIp=nTPServerIp, ethernetGroup=ethernetGroup, extendedChannel=extendedChannel, masterSlaveMode=masterSlaveMode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortStatus=dataPortStatus, currentChannel=currentChannel, sNMPCommunityTable=sNMPCommunityTable)
