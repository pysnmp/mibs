...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", band=band, ptpGroups=ptpGroups, currentChannel=currentChannel, extendedFreqMHz=extendedFreqMHz, smtpGroup=smtpGroup, ptmp=ptmp, channelBandwidth=channelBandwidth, sNMPCommunityTableEntry=sNMPCommunityTableEntry, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, nTPState=nTPState, dataPortStatusTrap=dataPortStatusTrap, snmpControl=snmpControl, receiveModulationMode=receiveModulationMode, radarDetectChannel=radarDetectChannel, radarDetectTrap=radarDetectTrap, vlanTagging=vlanTagging, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, linkStatusTrap=linkStatusTrap, nTPSync=nTPSync, bootVersion=bootVersion, extendedChannel=extendedChannel, ethernet=ethernet, sMTPEnabledMessages=sMTPEnabledMessages, aggregateDataRate=aggregateDataRate, productName=productName, sNMPCommunityString=sNMPCommunityString, sNMPCommunityOid=sNMPCommunityOid, tFTPServerIPAddress=tFTPServerIPAddress, installArmStateTrap=installArmStateTrap, measuredRange=measuredRange, hardwareVersion=hardwareVersion, sNMPTrapTableIndex=sNMPTrapTableIndex, iPAddress=iPAddress, management=management, smtp=smtp, pubStats=pubStats, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, configurationGroup=configurationGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ethernetGroup=ethernetGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, phyStatusGroup=phyStatusGroup, timeZone=timeZone, ptp=ptp, snmpControlGroup=snmpControlGroup, sNMPCommunityAccess=sNMPCommunityAccess, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortStatus=dataPortStatus, transmitDataRate=transmitDataRate, fixedModMode=fixedModMode, regionCode=regionCode, vectorError=vectorError, nTPServerIp=nTPServerIp, dualPayload=dualPayload, noiseFloor=noiseFloor, sNMPCommunityTableIndex=sNMPCommunityTableIndex, versionsGroup=versionsGroup, nTPServerPortNumber=nTPServerPortNumber, tFTPServerPortNumber=tFTPServerPortNumber, ptp250=ptp250, ptpCompliance=ptpCompliance, configuration=configuration, siteName=siteName, ntpGroup=ntpGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, softwareVersion=softwareVersion, managementGroup=managementGroup, phyStatus=phyStatus, currentFreqMHz=currentFreqMHz, notificationsGroup=notificationsGroup, searchState=searchState, receiveDataRate=receiveDataRate, sMTPServerIPAddress=sMTPServerIPAddress, licenceGroup=licenceGroup, configuredModulationMode=configuredModulationMode, antennaGain=antennaGain, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPCommunityTable=sNMPCommunityTable, vlanId=vlanId, wirelessLinkStatus=wirelessLinkStatus, sNMPTrapVersion=sNMPTrapVersion, alarmsGroup=alarmsGroup, ntp=ntp, sNMPTrapIPAddress=sNMPTrapIPAddress, pubStatsGroup=pubStatsGroup, channelSelection=channelSelection, installArmState=installArmState, vlanPriority=vlanPriority, nTPLastSync=nTPLastSync, ptpTrapPrefix=ptpTrapPrefix, ptpTraps=ptpTraps, remoteIPAddress=remoteIPAddress, receivePower=receivePower, nTPPollInterval=nTPPollInterval, linkLoss=linkLoss, productVariant=productVariant, dataPortAutoNegotiation=dataPortAutoNegotiation, transmitPower=transmitPower, linkName=linkName, cambium=cambium, alarms=alarms, sMTPServerPortNumber=sMTPServerPortNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, licence=licence, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapTable=sNMPTrapTable, subnetMask=subnetMask, configuredRange=configuredRange, sNMPTrapCommunity=sNMPTrapCommunity, maximumTransmitPower=maximumTransmitPower, remoteMACAddress=remoteMACAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, systemClock=systemClock, cableLoss=cableLoss, sNMPCommunityTableNumber=sNMPCommunityTableNumber, masterSlaveMode=masterSlaveMode, PYSNMP_MODULE_ID=cambium, gatewayIPAddress=gatewayIPAddress, versions=versions, signalStrengthRatio=signalStrengthRatio, transmitModulationMode=transmitModulationMode)
