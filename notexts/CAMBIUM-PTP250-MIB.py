...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, nTPServerPortNumber=nTPServerPortNumber, remoteMACAddress=remoteMACAddress, pubStats=pubStats, vlanPriority=vlanPriority, signalStrengthRatio=signalStrengthRatio, gatewayIPAddress=gatewayIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, managementGroup=managementGroup, maximumTransmitPower=maximumTransmitPower, configuration=configuration, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, installArmState=installArmState, sNMPTrapTableNumber=sNMPTrapTableNumber, cambium=cambium, ptmp=ptmp, productName=productName, radarDetectChannel=radarDetectChannel, snmpControlGroup=snmpControlGroup, extendedChannel=extendedChannel, sNMPTrapVersion=sNMPTrapVersion, nTPSync=nTPSync, extendedFreqMHz=extendedFreqMHz, bootVersion=bootVersion, ptp250=ptp250, transmitDataRate=transmitDataRate, phyStatusGroup=phyStatusGroup, sNMPCommunityTableEntry=sNMPCommunityTableEntry, hardwareVersion=hardwareVersion, measuredRange=measuredRange, linkLoss=linkLoss, systemClock=systemClock, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dualPayload=dualPayload, vectorError=vectorError, subnetMask=subnetMask, receivePower=receivePower, wirelessLinkStatus=wirelessLinkStatus, licenceGroup=licenceGroup, ptp=ptp, antennaGain=antennaGain, channelSelection=channelSelection, nTPServerIp=nTPServerIp, nTPState=nTPState, versionsGroup=versionsGroup, sNMPCommunityOid=sNMPCommunityOid, sNMPCommunityString=sNMPCommunityString, masterSlaveMode=masterSlaveMode, fixedModMode=fixedModMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ntp=ntp, tFTPServerPortNumber=tFTPServerPortNumber, currentChannel=currentChannel, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, alarms=alarms, softwareVersion=softwareVersion, vlanTagging=vlanTagging, sNMPCommunityAccess=sNMPCommunityAccess, receiveDataRate=receiveDataRate, siteName=siteName, receiveModulationMode=receiveModulationMode, smtp=smtp, currentFreqMHz=currentFreqMHz, sMTPServerPortNumber=sMTPServerPortNumber, ntpGroup=ntpGroup, linkStatusTrap=linkStatusTrap, noiseFloor=noiseFloor, ptpCompliance=ptpCompliance, alarmsGroup=alarmsGroup, snmpControl=snmpControl, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vlanId=vlanId, sNMPCommunityTable=sNMPCommunityTable, management=management, configuredRange=configuredRange, searchState=searchState, nTPLastSync=nTPLastSync, sNMPEnabledTraps=sNMPEnabledTraps, versions=versions, transmitPower=transmitPower, sNMPTrapTableIndex=sNMPTrapTableIndex, sMTPEnabledMessages=sMTPEnabledMessages, dataPortStatusTrap=dataPortStatusTrap, configurationGroup=configurationGroup, smtpGroup=smtpGroup, ptpTrapPrefix=ptpTrapPrefix, phyStatus=phyStatus, ptpTraps=ptpTraps, cableLoss=cableLoss, productVariant=productVariant, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPCommunityTableNumber=sNMPCommunityTableNumber, aggregateDataRate=aggregateDataRate, band=band, tFTPServerIPAddress=tFTPServerIPAddress, channelBandwidth=channelBandwidth, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, remoteIPAddress=remoteIPAddress, iPAddress=iPAddress, linkName=linkName, transmitModulationMode=transmitModulationMode, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, configuredModulationMode=configuredModulationMode, sNMPTrapPortNumber=sNMPTrapPortNumber, PYSNMP_MODULE_ID=cambium, sNMPTrapTable=sNMPTrapTable, dataPortStatus=dataPortStatus, notificationsGroup=notificationsGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapCommunity=sNMPTrapCommunity, ethernet=ethernet, nTPPollInterval=nTPPollInterval, sNMPCommunityTableIndex=sNMPCommunityTableIndex, regionCode=regionCode, ethernetGroup=ethernetGroup, timeZone=timeZone, pubStatsGroup=pubStatsGroup, ptpGroups=ptpGroups, installArmStateTrap=installArmStateTrap, radarDetectTrap=radarDetectTrap, licence=licence)
