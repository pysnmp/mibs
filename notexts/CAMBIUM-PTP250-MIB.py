...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", linkStatusTrap=linkStatusTrap, vlanPriority=vlanPriority, dualPayload=dualPayload, measuredRange=measuredRange, sNMPCommunityTableEntry=sNMPCommunityTableEntry, channelSelection=channelSelection, ptp250=ptp250, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, hardwareVersion=hardwareVersion, sMTPEnabledMessages=sMTPEnabledMessages, remoteIPAddress=remoteIPAddress, nTPServerPortNumber=nTPServerPortNumber, remoteMACAddress=remoteMACAddress, sNMPEnabledTraps=sNMPEnabledTraps, signalStrengthRatio=signalStrengthRatio, aggregateDataRate=aggregateDataRate, PYSNMP_MODULE_ID=cambium, regionCode=regionCode, snmpControlGroup=snmpControlGroup, vlanId=vlanId, siteName=siteName, wirelessLinkStatus=wirelessLinkStatus, nTPSync=nTPSync, phyStatus=phyStatus, currentFreqMHz=currentFreqMHz, sNMPTrapTable=sNMPTrapTable, iPAddress=iPAddress, masterSlaveMode=masterSlaveMode, ptpGroups=ptpGroups, extendedChannel=extendedChannel, transmitPower=transmitPower, phyStatusGroup=phyStatusGroup, notificationsGroup=notificationsGroup, nTPLastSync=nTPLastSync, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptmp=ptmp, channelBandwidth=channelBandwidth, management=management, nTPState=nTPState, versionsGroup=versionsGroup, vlanTagging=vlanTagging, cableLoss=cableLoss, configuration=configuration, ntpGroup=ntpGroup, versions=versions, smtp=smtp, subnetMask=subnetMask, receivePower=receivePower, dataPortStatusTrap=dataPortStatusTrap, ntp=ntp, tFTPServerPortNumber=tFTPServerPortNumber, antennaGain=antennaGain, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPCommunityOid=sNMPCommunityOid, ethernet=ethernet, band=band, noiseFloor=noiseFloor, ethernetGroup=ethernetGroup, pubStats=pubStats, receiveDataRate=receiveDataRate, installArmStateTrap=installArmStateTrap, sNMPCommunityAccess=sNMPCommunityAccess, managementGroup=managementGroup, nTPPollInterval=nTPPollInterval, sNMPCommunityTableNumber=sNMPCommunityTableNumber, nTPServerIp=nTPServerIp, linkLoss=linkLoss, receiveModulationMode=receiveModulationMode, transmitModulationMode=transmitModulationMode, currentChannel=currentChannel, radarDetectTrap=radarDetectTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, radarDetectChannel=radarDetectChannel, searchState=searchState, gatewayIPAddress=gatewayIPAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, alarmsGroup=alarmsGroup, sNMPCommunityTableIndex=sNMPCommunityTableIndex, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, cambium=cambium, bootVersion=bootVersion, pubStatsGroup=pubStatsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapIPAddress=sNMPTrapIPAddress, snmpControl=snmpControl, extendedFreqMHz=extendedFreqMHz, sMTPServerPortNumber=sMTPServerPortNumber, configuredRange=configuredRange, configuredModulationMode=configuredModulationMode, ptpTraps=ptpTraps, tFTPServerIPAddress=tFTPServerIPAddress, systemClock=systemClock, smtpGroup=smtpGroup, productVariant=productVariant, sNMPTrapCommunity=sNMPTrapCommunity, timeZone=timeZone, linkName=linkName, dataPortStatus=dataPortStatus, sMTPServerIPAddress=sMTPServerIPAddress, ptpCompliance=ptpCompliance, sNMPCommunityTable=sNMPCommunityTable, sNMPTrapTableNumber=sNMPTrapTableNumber, licenceGroup=licenceGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPCommunityString=sNMPCommunityString, licence=licence, maximumTransmitPower=maximumTransmitPower, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, softwareVersion=softwareVersion, productName=productName, transmitDataRate=transmitDataRate, configurationGroup=configurationGroup, ptp=ptp, alarms=alarms, installArmState=installArmState, fixedModMode=fixedModMode, vectorError=vectorError, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapVersion=sNMPTrapVersion, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex)
