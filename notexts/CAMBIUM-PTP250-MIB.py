...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", transmitPower=transmitPower, noiseFloor=noiseFloor, cambium=cambium, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, timeZone=timeZone, softwareVersion=softwareVersion, pubStatsGroup=pubStatsGroup, transmitDataRate=transmitDataRate, linkName=linkName, systemClock=systemClock, sNMPTrapTableNumber=sNMPTrapTableNumber, vectorError=vectorError, ptp=ptp, receiveDataRate=receiveDataRate, receiveModulationMode=receiveModulationMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, versionsGroup=versionsGroup, alarms=alarms, sNMPCommunityTableEntry=sNMPCommunityTableEntry, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, productVariant=productVariant, radarDetectTrap=radarDetectTrap, vlanTagging=vlanTagging, subnetMask=subnetMask, sNMPCommunityAccess=sNMPCommunityAccess, extendedFreqMHz=extendedFreqMHz, channelBandwidth=channelBandwidth, antennaGain=antennaGain, regionCode=regionCode, sNMPTrapVersion=sNMPTrapVersion, band=band, gatewayIPAddress=gatewayIPAddress, managementGroup=managementGroup, dataPortStatusTrap=dataPortStatusTrap, dataPortStatus=dataPortStatus, sNMPEnabledTraps=sNMPEnabledTraps, productName=productName, sNMPTrapCommunity=sNMPTrapCommunity, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, remoteIPAddress=remoteIPAddress, configuredModulationMode=configuredModulationMode, vlanId=vlanId, snmpControlGroup=snmpControlGroup, masterSlaveMode=masterSlaveMode, measuredRange=measuredRange, snmpControl=snmpControl, nTPState=nTPState, bootVersion=bootVersion, licenceGroup=licenceGroup, cableLoss=cableLoss, channelSelection=channelSelection, wirelessLinkStatus=wirelessLinkStatus, currentFreqMHz=currentFreqMHz, nTPSync=nTPSync, configuration=configuration, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, phyStatus=phyStatus, pubStats=pubStats, tFTPServerPortNumber=tFTPServerPortNumber, extendedChannel=extendedChannel, ptmp=ptmp, fixedModMode=fixedModMode, nTPLastSync=nTPLastSync, ntp=ntp, remoteMACAddress=remoteMACAddress, ethernet=ethernet, sMTPEnabledMessages=sMTPEnabledMessages, transmitModulationMode=transmitModulationMode, ntpGroup=ntpGroup, configuredRange=configuredRange, searchState=searchState, sNMPCommunityOid=sNMPCommunityOid, smtpGroup=smtpGroup, PYSNMP_MODULE_ID=cambium, noWirelessChannelAvailable=noWirelessChannelAvailable, nTPServerPortNumber=nTPServerPortNumber, siteName=siteName, linkLoss=linkLoss, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, smtp=smtp, alarmsGroup=alarmsGroup, vlanPriority=vlanPriority, dualPayload=dualPayload, nTPServerIp=nTPServerIp, ptpTrapPrefix=ptpTrapPrefix, currentChannel=currentChannel, sNMPCommunityTableNumber=sNMPCommunityTableNumber, linkStatusTrap=linkStatusTrap, installArmStateTrap=installArmStateTrap, receivePower=receivePower, ptpGroups=ptpGroups, tFTPServerIPAddress=tFTPServerIPAddress, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sNMPTrapIPAddress=sNMPTrapIPAddress, signalStrengthRatio=signalStrengthRatio, ptp250=ptp250, configurationGroup=configurationGroup, notificationsGroup=notificationsGroup, installArmState=installArmState, sMTPServerPortNumber=sMTPServerPortNumber, ethernetGroup=ethernetGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPCommunityTable=sNMPCommunityTable, maximumTransmitPower=maximumTransmitPower, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, hardwareVersion=hardwareVersion, iPAddress=iPAddress, licence=licence, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPCommunityString=sNMPCommunityString, management=management, sNMPTrapTable=sNMPTrapTable, radarDetectChannel=radarDetectChannel, dataPortAutoNegotiation=dataPortAutoNegotiation, phyStatusGroup=phyStatusGroup, sMTPServerIPAddress=sMTPServerIPAddress, nTPPollInterval=nTPPollInterval, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, versions=versions, ptpTraps=ptpTraps, ptpCompliance=ptpCompliance, aggregateDataRate=aggregateDataRate)
