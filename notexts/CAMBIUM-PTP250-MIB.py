...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, signalStrengthRatio=signalStrengthRatio, dualPayload=dualPayload, managementGroup=managementGroup, configuredRange=configuredRange, ptpCompliance=ptpCompliance, productName=productName, searchState=searchState, ptp250=ptp250, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapTableIndex=sNMPTrapTableIndex, aggregateDataRate=aggregateDataRate, sNMPTrapPortNumber=sNMPTrapPortNumber, systemClock=systemClock, sMTPSourceEmailAddress=sMTPSourceEmailAddress, cambium=cambium, linkStatusTrap=linkStatusTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, smtp=smtp, hardwareVersion=hardwareVersion, installArmState=installArmState, snmpControl=snmpControl, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, radarDetectTrap=radarDetectTrap, ethernetGroup=ethernetGroup, linkLoss=linkLoss, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ntp=ntp, sNMPCommunityOid=sNMPCommunityOid, vectorError=vectorError, PYSNMP_MODULE_ID=cambium, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, alarmsGroup=alarmsGroup, iPAddress=iPAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sNMPCommunityAccess=sNMPCommunityAccess, channelSelection=channelSelection, nTPServerIp=nTPServerIp, receiveDataRate=receiveDataRate, transmitDataRate=transmitDataRate, masterSlaveMode=masterSlaveMode, management=management, antennaGain=antennaGain, productVariant=productVariant, cableLoss=cableLoss, receivePower=receivePower, pubStats=pubStats, licence=licence, ntpGroup=ntpGroup, sMTPServerIPAddress=sMTPServerIPAddress, remoteIPAddress=remoteIPAddress, sNMPTrapCommunity=sNMPTrapCommunity, fixedModMode=fixedModMode, alarms=alarms, nTPState=nTPState, phyStatusGroup=phyStatusGroup, sNMPCommunityTable=sNMPCommunityTable, remoteMACAddress=remoteMACAddress, currentChannel=currentChannel, currentFreqMHz=currentFreqMHz, timeZone=timeZone, nTPServerPortNumber=nTPServerPortNumber, noiseFloor=noiseFloor, sNMPCommunityTableIndex=sNMPCommunityTableIndex, ptpTrapPrefix=ptpTrapPrefix, softwareVersion=softwareVersion, ptp=ptp, ptpTraps=ptpTraps, configuredModulationMode=configuredModulationMode, subnetMask=subnetMask, vlanPriority=vlanPriority, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, transmitModulationMode=transmitModulationMode, ptpGroups=ptpGroups, phyStatus=phyStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, licenceGroup=licenceGroup, configurationGroup=configurationGroup, sNMPEnabledTraps=sNMPEnabledTraps, vlanTagging=vlanTagging, snmpControlGroup=snmpControlGroup, channelBandwidth=channelBandwidth, sNMPTrapTable=sNMPTrapTable, nTPLastSync=nTPLastSync, siteName=siteName, extendedChannel=extendedChannel, sNMPCommunityString=sNMPCommunityString, tFTPServerIPAddress=tFTPServerIPAddress, linkName=linkName, pubStatsGroup=pubStatsGroup, tFTPServerPortNumber=tFTPServerPortNumber, installArmStateTrap=installArmStateTrap, vlanId=vlanId, configuration=configuration, receiveModulationMode=receiveModulationMode, versionsGroup=versionsGroup, dataPortStatus=dataPortStatus, sNMPTrapVersion=sNMPTrapVersion, maximumTransmitPower=maximumTransmitPower, radarDetectChannel=radarDetectChannel, wirelessLinkStatus=wirelessLinkStatus, versions=versions, ethernet=ethernet, sNMPTrapTableEntry=sNMPTrapTableEntry, sMTPServerPortNumber=sMTPServerPortNumber, transmitPower=transmitPower, sNMPCommunityTableEntry=sNMPCommunityTableEntry, bootVersion=bootVersion, notificationsGroup=notificationsGroup, smtpGroup=smtpGroup, regionCode=regionCode, ptmp=ptmp, dataPortStatusTrap=dataPortStatusTrap, nTPSync=nTPSync, sMTPEnabledMessages=sMTPEnabledMessages, gatewayIPAddress=gatewayIPAddress, extendedFreqMHz=extendedFreqMHz, nTPPollInterval=nTPPollInterval, measuredRange=measuredRange, band=band, sNMPTrapTableNumber=sNMPTrapTableNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText)
