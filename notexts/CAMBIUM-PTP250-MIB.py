...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPEnabledTraps=sNMPEnabledTraps, licenceGroup=licenceGroup, cableLoss=cableLoss, vlanId=vlanId, snmpControl=snmpControl, linkStatusTrap=linkStatusTrap, nTPServerPortNumber=nTPServerPortNumber, bootVersion=bootVersion, PYSNMP_MODULE_ID=cambium, sNMPTrapTableNumber=sNMPTrapTableNumber, vlanPriority=vlanPriority, noiseFloor=noiseFloor, pubStatsGroup=pubStatsGroup, receiveDataRate=receiveDataRate, ptpTraps=ptpTraps, pubStats=pubStats, configurationGroup=configurationGroup, radarDetectTrap=radarDetectTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, configuredModulationMode=configuredModulationMode, management=management, iPAddress=iPAddress, receivePower=receivePower, subnetMask=subnetMask, nTPServerIp=nTPServerIp, remoteMACAddress=remoteMACAddress, sNMPCommunityAccess=sNMPCommunityAccess, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPServerPortNumber=tFTPServerPortNumber, sNMPCommunityString=sNMPCommunityString, softwareVersion=softwareVersion, tFTPServerIPAddress=tFTPServerIPAddress, transmitDataRate=transmitDataRate, extendedChannel=extendedChannel, configuration=configuration, ethernet=ethernet, timeZone=timeZone, extendedFreqMHz=extendedFreqMHz, alarmsGroup=alarmsGroup, nTPLastSync=nTPLastSync, cambium=cambium, currentFreqMHz=currentFreqMHz, alarms=alarms, sNMPTrapTableEntry=sNMPTrapTableEntry, wirelessLinkStatus=wirelessLinkStatus, antennaGain=antennaGain, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sNMPCommunityOid=sNMPCommunityOid, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, band=band, phyStatusGroup=phyStatusGroup, aggregateDataRate=aggregateDataRate, regionCode=regionCode, sNMPCommunityTableNumber=sNMPCommunityTableNumber, ntp=ntp, managementGroup=managementGroup, systemClock=systemClock, masterSlaveMode=masterSlaveMode, ptmp=ptmp, measuredRange=measuredRange, productName=productName, sNMPTrapTable=sNMPTrapTable, linkLoss=linkLoss, sNMPTrapIPAddress=sNMPTrapIPAddress, remoteIPAddress=remoteIPAddress, vectorError=vectorError, gatewayIPAddress=gatewayIPAddress, dualPayload=dualPayload, installArmStateTrap=installArmStateTrap, productVariant=productVariant, currentChannel=currentChannel, ptp250=ptp250, dataPortStatusTrap=dataPortStatusTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, licence=licence, ptpCompliance=ptpCompliance, transmitPower=transmitPower, searchState=searchState, noWirelessChannelAvailable=noWirelessChannelAvailable, channelSelection=channelSelection, smtpGroup=smtpGroup, ntpGroup=ntpGroup, dataPortStatus=dataPortStatus, configuredRange=configuredRange, versionsGroup=versionsGroup, nTPState=nTPState, ptpTrapPrefix=ptpTrapPrefix, sMTPEnabledMessages=sMTPEnabledMessages, sNMPCommunityTableEntry=sNMPCommunityTableEntry, versions=versions, sMTPSourceEmailAddress=sMTPSourceEmailAddress, linkName=linkName, ptpGroups=ptpGroups, sNMPCommunityTable=sNMPCommunityTable, smtp=smtp, receiveModulationMode=receiveModulationMode, snmpControlGroup=snmpControlGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, signalStrengthRatio=signalStrengthRatio, channelBandwidth=channelBandwidth, sMTPServerIPAddress=sMTPServerIPAddress, nTPSync=nTPSync, phyStatus=phyStatus, sNMPTrapCommunity=sNMPTrapCommunity, vlanTagging=vlanTagging, hardwareVersion=hardwareVersion, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, siteName=siteName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, fixedModMode=fixedModMode, sNMPTrapVersion=sNMPTrapVersion, radarDetectChannel=radarDetectChannel, sMTPServerPortNumber=sMTPServerPortNumber, notificationsGroup=notificationsGroup, maximumTransmitPower=maximumTransmitPower, transmitModulationMode=transmitModulationMode, ethernetGroup=ethernetGroup, ptp=ptp, installArmState=installArmState, nTPPollInterval=nTPPollInterval, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapTableIndex=sNMPTrapTableIndex)
