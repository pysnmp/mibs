...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPTrapVersion=sNMPTrapVersion, masterSlaveMode=masterSlaveMode, receiveDataRate=receiveDataRate, sMTPServerPortNumber=sMTPServerPortNumber, linkLoss=linkLoss, versionsGroup=versionsGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPCommunityAccess=sNMPCommunityAccess, dataPortStatus=dataPortStatus, iPAddress=iPAddress, productVariant=productVariant, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, smtpGroup=smtpGroup, nTPServerPortNumber=nTPServerPortNumber, ptpCompliance=ptpCompliance, managementGroup=managementGroup, gatewayIPAddress=gatewayIPAddress, extendedChannel=extendedChannel, softwareVersion=softwareVersion, bootVersion=bootVersion, wirelessLinkStatus=wirelessLinkStatus, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, aggregateDataRate=aggregateDataRate, vlanPriority=vlanPriority, remoteIPAddress=remoteIPAddress, extendedFreqMHz=extendedFreqMHz, sNMPCommunityTableEntry=sNMPCommunityTableEntry, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, maximumTransmitPower=maximumTransmitPower, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapCommunity=sNMPTrapCommunity, cableLoss=cableLoss, ntp=ntp, snmpControlGroup=snmpControlGroup, phyStatusGroup=phyStatusGroup, hardwareVersion=hardwareVersion, licenceGroup=licenceGroup, configuredRange=configuredRange, ptp=ptp, signalStrengthRatio=signalStrengthRatio, channelBandwidth=channelBandwidth, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPCommunityTableNumber=sNMPCommunityTableNumber, linkName=linkName, band=band, linkStatusTrap=linkStatusTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, vlanTagging=vlanTagging, transmitPower=transmitPower, versions=versions, ptmp=ptmp, sNMPTrapTableIndex=sNMPTrapTableIndex, nTPLastSync=nTPLastSync, receivePower=receivePower, nTPPollInterval=nTPPollInterval, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, pubStats=pubStats, vlanId=vlanId, pubStatsGroup=pubStatsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortStatusTrap=dataPortStatusTrap, productName=productName, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapTable=sNMPTrapTable, ethernet=ethernet, sNMPEnabledTraps=sNMPEnabledTraps, siteName=siteName, transmitModulationMode=transmitModulationMode, snmpControl=snmpControl, sNMPCommunityOid=sNMPCommunityOid, nTPSync=nTPSync, noiseFloor=noiseFloor, sNMPCommunityTableIndex=sNMPCommunityTableIndex, radarDetectTrap=radarDetectTrap, configurationGroup=configurationGroup, ethernetGroup=ethernetGroup, subnetMask=subnetMask, phyStatus=phyStatus, dualPayload=dualPayload, currentChannel=currentChannel, alarmsGroup=alarmsGroup, radarDetectChannel=radarDetectChannel, cambium=cambium, sNMPTrapPortNumber=sNMPTrapPortNumber, notificationsGroup=notificationsGroup, systemClock=systemClock, timeZone=timeZone, currentFreqMHz=currentFreqMHz, ptp250=ptp250, PYSNMP_MODULE_ID=cambium, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, nTPState=nTPState, channelSelection=channelSelection, smtp=smtp, sMTPEnabledMessages=sMTPEnabledMessages, searchState=searchState, transmitDataRate=transmitDataRate, management=management, ptpTrapPrefix=ptpTrapPrefix, measuredRange=measuredRange, regionCode=regionCode, sNMPCommunityString=sNMPCommunityString, remoteMACAddress=remoteMACAddress, configuration=configuration, alarms=alarms, vectorError=vectorError, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, fixedModMode=fixedModMode, installArmStateTrap=installArmStateTrap, licence=licence, installArmState=installArmState, receiveModulationMode=receiveModulationMode, sNMPCommunityTable=sNMPCommunityTable, antennaGain=antennaGain, tFTPServerPortNumber=tFTPServerPortNumber, nTPServerIp=nTPServerIp, ptpGroups=ptpGroups, ptpTraps=ptpTraps, ntpGroup=ntpGroup, configuredModulationMode=configuredModulationMode)
