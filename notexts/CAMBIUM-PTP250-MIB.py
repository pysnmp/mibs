...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortStatus=dataPortStatus, nTPSync=nTPSync, ntp=ntp, managementGroup=managementGroup, smtp=smtp, configurationGroup=configurationGroup, nTPServerPortNumber=nTPServerPortNumber, alarms=alarms, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ethernet=ethernet, linkStatusTrap=linkStatusTrap, vlanTagging=vlanTagging, pubStatsGroup=pubStatsGroup, fixedModMode=fixedModMode, sNMPEnabledTraps=sNMPEnabledTraps, systemClock=systemClock, cambium=cambium, nTPPollInterval=nTPPollInterval, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPServerPortNumber=tFTPServerPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, licenceGroup=licenceGroup, pubStats=pubStats, phyStatus=phyStatus, sNMPCommunityTableEntry=sNMPCommunityTableEntry, remoteMACAddress=remoteMACAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, masterSlaveMode=masterSlaveMode, ptpCompliance=ptpCompliance, extendedFreqMHz=extendedFreqMHz, sNMPTrapTableIndex=sNMPTrapTableIndex, band=band, sNMPTrapTable=sNMPTrapTable, ethernetGroup=ethernetGroup, sMTPEnabledMessages=sMTPEnabledMessages, sNMPCommunityTable=sNMPCommunityTable, cableLoss=cableLoss, ptp=ptp, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptpGroups=ptpGroups, sNMPTrapPortNumber=sNMPTrapPortNumber, aggregateDataRate=aggregateDataRate, configuredRange=configuredRange, channelBandwidth=channelBandwidth, sNMPTrapIPAddress=sNMPTrapIPAddress, ntpGroup=ntpGroup, snmpControlGroup=snmpControlGroup, transmitModulationMode=transmitModulationMode, transmitDataRate=transmitDataRate, radarDetectTrap=radarDetectTrap, signalStrengthRatio=signalStrengthRatio, siteName=siteName, softwareVersion=softwareVersion, searchState=searchState, nTPServerIp=nTPServerIp, wirelessLinkStatus=wirelessLinkStatus, sNMPCommunityTableNumber=sNMPCommunityTableNumber, dataPortStatusTrap=dataPortStatusTrap, nTPState=nTPState, snmpControl=snmpControl, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPServerIPAddress=sMTPServerIPAddress, sNMPCommunityAccess=sNMPCommunityAccess, regionCode=regionCode, receiveDataRate=receiveDataRate, vectorError=vectorError, sNMPCommunityTableIndex=sNMPCommunityTableIndex, phyStatusGroup=phyStatusGroup, smtpGroup=smtpGroup, ptmp=ptmp, iPAddress=iPAddress, sNMPCommunityString=sNMPCommunityString, dataPortAutoNegotiation=dataPortAutoNegotiation, gatewayIPAddress=gatewayIPAddress, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapCommunity=sNMPTrapCommunity, dualPayload=dualPayload, sNMPTrapTableEntry=sNMPTrapTableEntry, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, licence=licence, currentChannel=currentChannel, sNMPCommunityOid=sNMPCommunityOid, vlanPriority=vlanPriority, sNMPTrapVersion=sNMPTrapVersion, noiseFloor=noiseFloor, radarDetectChannel=radarDetectChannel, tFTPServerIPAddress=tFTPServerIPAddress, linkName=linkName, currentFreqMHz=currentFreqMHz, notificationsGroup=notificationsGroup, vlanId=vlanId, productVariant=productVariant, installArmState=installArmState, extendedChannel=extendedChannel, timeZone=timeZone, remoteIPAddress=remoteIPAddress, alarmsGroup=alarmsGroup, nTPLastSync=nTPLastSync, antennaGain=antennaGain, transmitPower=transmitPower, receiveModulationMode=receiveModulationMode, versionsGroup=versionsGroup, ptpTrapPrefix=ptpTrapPrefix, installArmStateTrap=installArmStateTrap, ptpTraps=ptpTraps, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, bootVersion=bootVersion, configuration=configuration, productName=productName, hardwareVersion=hardwareVersion, management=management, PYSNMP_MODULE_ID=cambium, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, linkLoss=linkLoss, subnetMask=subnetMask, configuredModulationMode=configuredModulationMode, maximumTransmitPower=maximumTransmitPower, ptp250=ptp250, receivePower=receivePower, channelSelection=channelSelection, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, versions=versions, measuredRange=measuredRange)
