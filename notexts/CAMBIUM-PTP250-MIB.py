...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", management=management, phyStatus=phyStatus, ptp=ptp, receivePower=receivePower, snmpControl=snmpControl, extendedChannel=extendedChannel, sNMPTrapTableEntry=sNMPTrapTableEntry, ptmp=ptmp, vlanTagging=vlanTagging, regionCode=regionCode, linkName=linkName, softwareVersion=softwareVersion, ntp=ntp, sNMPCommunityTableEntry=sNMPCommunityTableEntry, extendedFreqMHz=extendedFreqMHz, sNMPTrapCommunity=sNMPTrapCommunity, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPCommunityTable=sNMPCommunityTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, nTPPollInterval=nTPPollInterval, licenceGroup=licenceGroup, transmitDataRate=transmitDataRate, productVariant=productVariant, PYSNMP_MODULE_ID=cambium, phyStatusGroup=phyStatusGroup, configuration=configuration, dataPortStatus=dataPortStatus, sNMPCommunityTableNumber=sNMPCommunityTableNumber, ethernetGroup=ethernetGroup, gatewayIPAddress=gatewayIPAddress, measuredRange=measuredRange, currentChannel=currentChannel, vectorError=vectorError, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, channelSelection=channelSelection, cambium=cambium, smtpGroup=smtpGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortAutoNegotiation=dataPortAutoNegotiation, siteName=siteName, configurationGroup=configurationGroup, cableLoss=cableLoss, notificationsGroup=notificationsGroup, transmitPower=transmitPower, radarDetectChannel=radarDetectChannel, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPEnabledTraps=sNMPEnabledTraps, noiseFloor=noiseFloor, subnetMask=subnetMask, ptpTrapPrefix=ptpTrapPrefix, pubStatsGroup=pubStatsGroup, masterSlaveMode=masterSlaveMode, antennaGain=antennaGain, sNMPTrapTableNumber=sNMPTrapTableNumber, wirelessLinkStatus=wirelessLinkStatus, linkLoss=linkLoss, ptpTraps=ptpTraps, dualPayload=dualPayload, configuredRange=configuredRange, installArmStateTrap=installArmStateTrap, licence=licence, searchState=searchState, radarDetectTrap=radarDetectTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, pubStats=pubStats, receiveDataRate=receiveDataRate, transmitModulationMode=transmitModulationMode, systemClock=systemClock, dataPortStatusTrap=dataPortStatusTrap, managementGroup=managementGroup, nTPLastSync=nTPLastSync, configuredModulationMode=configuredModulationMode, ntpGroup=ntpGroup, snmpControlGroup=snmpControlGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, alarms=alarms, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapTable=sNMPTrapTable, bootVersion=bootVersion, ptpGroups=ptpGroups, sNMPCommunityOid=sNMPCommunityOid, vlanPriority=vlanPriority, sNMPTrapVersion=sNMPTrapVersion, nTPServerIp=nTPServerIp, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ethernet=ethernet, sNMPCommunityTableIndex=sNMPCommunityTableIndex, tFTPServerPortNumber=tFTPServerPortNumber, iPAddress=iPAddress, productName=productName, nTPSync=nTPSync, receiveModulationMode=receiveModulationMode, tFTPServerIPAddress=tFTPServerIPAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPCommunityAccess=sNMPCommunityAccess, nTPState=nTPState, linkStatusTrap=linkStatusTrap, signalStrengthRatio=signalStrengthRatio, currentFreqMHz=currentFreqMHz, alarmsGroup=alarmsGroup, ptpCompliance=ptpCompliance, smtp=smtp, installArmState=installArmState, versions=versions, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, fixedModMode=fixedModMode, ptp250=ptp250, remoteIPAddress=remoteIPAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPServerIPAddress=sMTPServerIPAddress, remoteMACAddress=remoteMACAddress, aggregateDataRate=aggregateDataRate, versionsGroup=versionsGroup, maximumTransmitPower=maximumTransmitPower, timeZone=timeZone, hardwareVersion=hardwareVersion, sMTPServerPortNumber=sMTPServerPortNumber, channelBandwidth=channelBandwidth, nTPServerPortNumber=nTPServerPortNumber, vlanId=vlanId, sNMPCommunityString=sNMPCommunityString, band=band)
