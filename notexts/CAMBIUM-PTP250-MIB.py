...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", receivePower=receivePower, ptpCompliance=ptpCompliance, sNMPCommunityTableIndex=sNMPCommunityTableIndex, pubStatsGroup=pubStatsGroup, productVariant=productVariant, snmpControlGroup=snmpControlGroup, PYSNMP_MODULE_ID=cambium, ptpTrapPrefix=ptpTrapPrefix, sNMPCommunityTable=sNMPCommunityTable, cableLoss=cableLoss, dataPortStatusTrap=dataPortStatusTrap, noiseFloor=noiseFloor, nTPServerPortNumber=nTPServerPortNumber, linkStatusTrap=linkStatusTrap, ntpGroup=ntpGroup, versions=versions, signalStrengthRatio=signalStrengthRatio, configuredModulationMode=configuredModulationMode, aggregateDataRate=aggregateDataRate, smtp=smtp, regionCode=regionCode, ethernetGroup=ethernetGroup, systemClock=systemClock, subnetMask=subnetMask, vlanPriority=vlanPriority, cambium=cambium, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, nTPLastSync=nTPLastSync, versionsGroup=versionsGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, measuredRange=measuredRange, gatewayIPAddress=gatewayIPAddress, configurationGroup=configurationGroup, siteName=siteName, iPAddress=iPAddress, wirelessLinkStatus=wirelessLinkStatus, currentFreqMHz=currentFreqMHz, searchState=searchState, nTPState=nTPState, channelBandwidth=channelBandwidth, ptp=ptp, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, antennaGain=antennaGain, sNMPCommunityString=sNMPCommunityString, transmitDataRate=transmitDataRate, alarmsGroup=alarmsGroup, remoteMACAddress=remoteMACAddress, productName=productName, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapIPAddress=sNMPTrapIPAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, licenceGroup=licenceGroup, timeZone=timeZone, fixedModMode=fixedModMode, dualPayload=dualPayload, ptpGroups=ptpGroups, nTPServerIp=nTPServerIp, installArmState=installArmState, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapVersion=sNMPTrapVersion, tFTPServerIPAddress=tFTPServerIPAddress, linkName=linkName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPCommunityAccess=sNMPCommunityAccess, ptmp=ptmp, sMTPSourceEmailAddress=sMTPSourceEmailAddress, licence=licence, sMTPServerPortNumber=sMTPServerPortNumber, extendedChannel=extendedChannel, radarDetectChannel=radarDetectChannel, sNMPTrapTableIndex=sNMPTrapTableIndex, hardwareVersion=hardwareVersion, softwareVersion=softwareVersion, receiveDataRate=receiveDataRate, installArmStateTrap=installArmStateTrap, vlanId=vlanId, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, alarms=alarms, sNMPTrapTableEntry=sNMPTrapTableEntry, sMTPServerIPAddress=sMTPServerIPAddress, extendedFreqMHz=extendedFreqMHz, configuredRange=configuredRange, tFTPServerPortNumber=tFTPServerPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, phyStatusGroup=phyStatusGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapTable=sNMPTrapTable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, transmitPower=transmitPower, receiveModulationMode=receiveModulationMode, snmpControl=snmpControl, ptpTraps=ptpTraps, band=band, radarDetectTrap=radarDetectTrap, pubStats=pubStats, maximumTransmitPower=maximumTransmitPower, vlanTagging=vlanTagging, managementGroup=managementGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernet=ethernet, transmitModulationMode=transmitModulationMode, bootVersion=bootVersion, notificationsGroup=notificationsGroup, nTPPollInterval=nTPPollInterval, nTPSync=nTPSync, remoteIPAddress=remoteIPAddress, dataPortStatus=dataPortStatus, masterSlaveMode=masterSlaveMode, sNMPCommunityTableNumber=sNMPCommunityTableNumber, currentChannel=currentChannel, sNMPCommunityOid=sNMPCommunityOid, sNMPCommunityTableEntry=sNMPCommunityTableEntry, ntp=ntp, linkLoss=linkLoss, vectorError=vectorError, sNMPTrapCommunity=sNMPTrapCommunity, phyStatus=phyStatus, smtpGroup=smtpGroup, channelSelection=channelSelection, ptp250=ptp250, configuration=configuration, management=management, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus)
