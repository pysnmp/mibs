...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tFTPServerPortNumber=tFTPServerPortNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPServerIPAddress=tFTPServerIPAddress, licence=licence, configuredModulationMode=configuredModulationMode, sNMPEnabledTraps=sNMPEnabledTraps, cambium=cambium, installArmState=installArmState, aggregateDataRate=aggregateDataRate, linkStatusTrap=linkStatusTrap, sNMPTrapVersion=sNMPTrapVersion, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ethernetGroup=ethernetGroup, phyStatusGroup=phyStatusGroup, extendedFreqMHz=extendedFreqMHz, sNMPCommunityOid=sNMPCommunityOid, productName=productName, softwareVersion=softwareVersion, sNMPCommunityTableEntry=sNMPCommunityTableEntry, remoteMACAddress=remoteMACAddress, gatewayIPAddress=gatewayIPAddress, PYSNMP_MODULE_ID=cambium, alarmsGroup=alarmsGroup, hardwareVersion=hardwareVersion, receivePower=receivePower, configuration=configuration, siteName=siteName, smtp=smtp, transmitPower=transmitPower, linkLoss=linkLoss, nTPLastSync=nTPLastSync, sNMPCommunityTableIndex=sNMPCommunityTableIndex, vlanPriority=vlanPriority, sMTPSourceEmailAddress=sMTPSourceEmailAddress, masterSlaveMode=masterSlaveMode, cableLoss=cableLoss, ptpGroups=ptpGroups, ntp=ntp, searchState=searchState, sNMPTrapTableIndex=sNMPTrapTableIndex, smtpGroup=smtpGroup, ptpTrapPrefix=ptpTrapPrefix, versions=versions, iPAddress=iPAddress, productVariant=productVariant, dualPayload=dualPayload, configuredRange=configuredRange, snmpControlGroup=snmpControlGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapTable=sNMPTrapTable, band=band, nTPState=nTPState, linkName=linkName, sNMPTrapIPAddress=sNMPTrapIPAddress, antennaGain=antennaGain, transmitModulationMode=transmitModulationMode, ptpCompliance=ptpCompliance, nTPSync=nTPSync, receiveModulationMode=receiveModulationMode, dataPortStatusTrap=dataPortStatusTrap, vlanTagging=vlanTagging, nTPServerIp=nTPServerIp, channelSelection=channelSelection, pubStatsGroup=pubStatsGroup, notificationsGroup=notificationsGroup, nTPServerPortNumber=nTPServerPortNumber, configurationGroup=configurationGroup, phyStatus=phyStatus, vlanId=vlanId, currentChannel=currentChannel, managementGroup=managementGroup, bootVersion=bootVersion, ptmp=ptmp, currentFreqMHz=currentFreqMHz, sNMPCommunityString=sNMPCommunityString, pubStats=pubStats, noiseFloor=noiseFloor, dataPortAutoNegotiation=dataPortAutoNegotiation, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, measuredRange=measuredRange, sNMPCommunityTableNumber=sNMPCommunityTableNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, management=management, ethernet=ethernet, licenceGroup=licenceGroup, dataPortStatus=dataPortStatus, systemClock=systemClock, subnetMask=subnetMask, remoteIPAddress=remoteIPAddress, ptp=ptp, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ptpTraps=ptpTraps, noWirelessChannelAvailable=noWirelessChannelAvailable, radarDetectTrap=radarDetectTrap, alarms=alarms, timeZone=timeZone, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, snmpControl=snmpControl, channelBandwidth=channelBandwidth, radarDetectChannel=radarDetectChannel, sNMPCommunityAccess=sNMPCommunityAccess, signalStrengthRatio=signalStrengthRatio, ptp250=ptp250, sNMPTrapPortNumber=sNMPTrapPortNumber, wirelessLinkStatus=wirelessLinkStatus, nTPPollInterval=nTPPollInterval, sNMPTrapTableNumber=sNMPTrapTableNumber, vectorError=vectorError, receiveDataRate=receiveDataRate, installArmStateTrap=installArmStateTrap, fixedModMode=fixedModMode, sMTPServerIPAddress=sMTPServerIPAddress, extendedChannel=extendedChannel, transmitDataRate=transmitDataRate, ntpGroup=ntpGroup, sNMPTrapCommunity=sNMPTrapCommunity, sNMPCommunityTable=sNMPCommunityTable, maximumTransmitPower=maximumTransmitPower, sMTPServerPortNumber=sMTPServerPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, regionCode=regionCode, versionsGroup=versionsGroup)
