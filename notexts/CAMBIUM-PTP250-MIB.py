...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", ptp=ptp, channelBandwidth=channelBandwidth, alarmsGroup=alarmsGroup, dualPayload=dualPayload, sNMPTrapTableIndex=sNMPTrapTableIndex, vlanPriority=vlanPriority, configuration=configuration, alarms=alarms, nTPServerIp=nTPServerIp, transmitDataRate=transmitDataRate, maximumTransmitPower=maximumTransmitPower, antennaGain=antennaGain, tFTPServerIPAddress=tFTPServerIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, aggregateDataRate=aggregateDataRate, installArmStateTrap=installArmStateTrap, phyStatus=phyStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPTrapCommunity=sNMPTrapCommunity, regionCode=regionCode, noiseFloor=noiseFloor, softwareVersion=softwareVersion, ntpGroup=ntpGroup, signalStrengthRatio=signalStrengthRatio, extendedChannel=extendedChannel, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ptpCompliance=ptpCompliance, sNMPTrapTable=sNMPTrapTable, radarDetectChannel=radarDetectChannel, ntp=ntp, subnetMask=subnetMask, nTPPollInterval=nTPPollInterval, vlanId=vlanId, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPServerPortNumber=tFTPServerPortNumber, vlanTagging=vlanTagging, snmpControl=snmpControl, nTPServerPortNumber=nTPServerPortNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, pubStats=pubStats, searchState=searchState, dataPortStatus=dataPortStatus, licenceGroup=licenceGroup, extendedFreqMHz=extendedFreqMHz, bootVersion=bootVersion, ptpTraps=ptpTraps, configuredModulationMode=configuredModulationMode, PYSNMP_MODULE_ID=cambium, ethernet=ethernet, notificationsGroup=notificationsGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, linkName=linkName, ethernetGroup=ethernetGroup, pubStatsGroup=pubStatsGroup, sNMPCommunityTableIndex=sNMPCommunityTableIndex, dataPortStatusTrap=dataPortStatusTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkLoss=linkLoss, cableLoss=cableLoss, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, transmitPower=transmitPower, licence=licence, sNMPCommunityOid=sNMPCommunityOid, installArmState=installArmState, iPAddress=iPAddress, systemClock=systemClock, smtp=smtp, fixedModMode=fixedModMode, ptpGroups=ptpGroups, sMTPEnabledMessages=sMTPEnabledMessages, ptp250=ptp250, productVariant=productVariant, smtpGroup=smtpGroup, currentChannel=currentChannel, currentFreqMHz=currentFreqMHz, gatewayIPAddress=gatewayIPAddress, receivePower=receivePower, sNMPCommunityTableEntry=sNMPCommunityTableEntry, ptmp=ptmp, nTPSync=nTPSync, vectorError=vectorError, nTPLastSync=nTPLastSync, sNMPTrapTableNumber=sNMPTrapTableNumber, timeZone=timeZone, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, band=band, management=management, managementGroup=managementGroup, ptpTrapPrefix=ptpTrapPrefix, versionsGroup=versionsGroup, productName=productName, cambium=cambium, channelSelection=channelSelection, receiveModulationMode=receiveModulationMode, versions=versions, snmpControlGroup=snmpControlGroup, remoteMACAddress=remoteMACAddress, phyStatusGroup=phyStatusGroup, sNMPCommunityString=sNMPCommunityString, remoteIPAddress=remoteIPAddress, configurationGroup=configurationGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPCommunityTable=sNMPCommunityTable, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapVersion=sNMPTrapVersion, receiveDataRate=receiveDataRate, measuredRange=measuredRange, masterSlaveMode=masterSlaveMode, sNMPTrapTableEntry=sNMPTrapTableEntry, transmitModulationMode=transmitModulationMode, sNMPCommunityAccess=sNMPCommunityAccess, sMTPServerPortNumber=sMTPServerPortNumber, nTPState=nTPState, siteName=siteName, wirelessLinkStatus=wirelessLinkStatus, hardwareVersion=hardwareVersion, sNMPTrapIPAddress=sNMPTrapIPAddress, linkStatusTrap=linkStatusTrap, sMTPServerIPAddress=sMTPServerIPAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, radarDetectTrap=radarDetectTrap, configuredRange=configuredRange, sNMPCommunityTableNumber=sNMPCommunityTableNumber)
