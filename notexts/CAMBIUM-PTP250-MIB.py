...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPCommunityTableIndex=sNMPCommunityTableIndex, ethernet=ethernet, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, hardwareVersion=hardwareVersion, antennaGain=antennaGain, ptpTraps=ptpTraps, cambium=cambium, cableLoss=cableLoss, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPCommunityOid=sNMPCommunityOid, signalStrengthRatio=signalStrengthRatio, smtpGroup=smtpGroup, alarms=alarms, maximumTransmitPower=maximumTransmitPower, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, configurationGroup=configurationGroup, extendedChannel=extendedChannel, searchState=searchState, remoteIPAddress=remoteIPAddress, masterSlaveMode=masterSlaveMode, sNMPCommunityString=sNMPCommunityString, ptpGroups=ptpGroups, versionsGroup=versionsGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, installArmStateTrap=installArmStateTrap, sNMPTrapCommunity=sNMPTrapCommunity, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPCommunityTableEntry=sNMPCommunityTableEntry, ethernetGroup=ethernetGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, phyStatus=phyStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, vectorError=vectorError, nTPServerIp=nTPServerIp, dataPortStatus=dataPortStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, PYSNMP_MODULE_ID=cambium, ntp=ntp, channelBandwidth=channelBandwidth, remoteMACAddress=remoteMACAddress, sNMPTrapTable=sNMPTrapTable, productVariant=productVariant, linkLoss=linkLoss, noiseFloor=noiseFloor, softwareVersion=softwareVersion, phyStatusGroup=phyStatusGroup, sNMPEnabledTraps=sNMPEnabledTraps, configuredModulationMode=configuredModulationMode, versions=versions, management=management, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, measuredRange=measuredRange, ptp250=ptp250, sNMPCommunityTable=sNMPCommunityTable, regionCode=regionCode, siteName=siteName, pubStats=pubStats, vlanTagging=vlanTagging, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, band=band, transmitDataRate=transmitDataRate, configuration=configuration, snmpControl=snmpControl, dataPortStatusTrap=dataPortStatusTrap, systemClock=systemClock, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, ptmp=ptmp, transmitPower=transmitPower, dataPortAutoNegotiation=dataPortAutoNegotiation, installArmState=installArmState, managementGroup=managementGroup, nTPServerPortNumber=nTPServerPortNumber, dualPayload=dualPayload, linkStatusTrap=linkStatusTrap, productName=productName, sMTPServerPortNumber=sMTPServerPortNumber, transmitModulationMode=transmitModulationMode, channelSelection=channelSelection, radarDetectChannel=radarDetectChannel, sNMPCommunityAccess=sNMPCommunityAccess, ptpCompliance=ptpCompliance, wirelessLinkStatus=wirelessLinkStatus, licence=licence, nTPLastSync=nTPLastSync, alarmsGroup=alarmsGroup, ptpTrapPrefix=ptpTrapPrefix, extendedFreqMHz=extendedFreqMHz, configuredRange=configuredRange, fixedModMode=fixedModMode, sNMPTrapVersion=sNMPTrapVersion, ptp=ptp, sNMPTrapPortNumber=sNMPTrapPortNumber, nTPState=nTPState, receiveModulationMode=receiveModulationMode, tFTPServerPortNumber=tFTPServerPortNumber, sMTPServerIPAddress=sMTPServerIPAddress, subnetMask=subnetMask, ntpGroup=ntpGroup, nTPSync=nTPSync, bootVersion=bootVersion, currentChannel=currentChannel, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, currentFreqMHz=currentFreqMHz, notificationsGroup=notificationsGroup, linkName=linkName, aggregateDataRate=aggregateDataRate, snmpControlGroup=snmpControlGroup, pubStatsGroup=pubStatsGroup, gatewayIPAddress=gatewayIPAddress, timeZone=timeZone, receiveDataRate=receiveDataRate, vlanId=vlanId, radarDetectTrap=radarDetectTrap, smtp=smtp, nTPPollInterval=nTPPollInterval, vlanPriority=vlanPriority, licenceGroup=licenceGroup, iPAddress=iPAddress, receivePower=receivePower, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapIPAddress=sNMPTrapIPAddress)
