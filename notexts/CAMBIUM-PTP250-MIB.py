...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", extendedFreqMHz=extendedFreqMHz, fixedModMode=fixedModMode, receiveDataRate=receiveDataRate, sMTPServerPortNumber=sMTPServerPortNumber, receiveModulationMode=receiveModulationMode, licenceGroup=licenceGroup, sNMPCommunityTableNumber=sNMPCommunityTableNumber, ethernetGroup=ethernetGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, currentChannel=currentChannel, noiseFloor=noiseFloor, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapTableEntry=sNMPTrapTableEntry, management=management, nTPLastSync=nTPLastSync, transmitDataRate=transmitDataRate, cambium=cambium, gatewayIPAddress=gatewayIPAddress, cableLoss=cableLoss, bootVersion=bootVersion, radarDetectTrap=radarDetectTrap, softwareVersion=softwareVersion, sNMPTrapTable=sNMPTrapTable, sNMPTrapTableNumber=sNMPTrapTableNumber, masterSlaveMode=masterSlaveMode, productName=productName, wirelessLinkStatus=wirelessLinkStatus, dataPortStatus=dataPortStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, vectorError=vectorError, configuration=configuration, installArmStateTrap=installArmStateTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, subnetMask=subnetMask, ethernet=ethernet, smtp=smtp, tFTPServerIPAddress=tFTPServerIPAddress, ptpCompliance=ptpCompliance, ptp250=ptp250, ptpGroups=ptpGroups, receivePower=receivePower, nTPSync=nTPSync, sNMPTrapCommunity=sNMPTrapCommunity, linkLoss=linkLoss, sNMPCommunityTable=sNMPCommunityTable, extendedChannel=extendedChannel, installArmState=installArmState, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ptpTrapPrefix=ptpTrapPrefix, aggregateDataRate=aggregateDataRate, productVariant=productVariant, ptmp=ptmp, smtpGroup=smtpGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, channelBandwidth=channelBandwidth, configuredModulationMode=configuredModulationMode, channelSelection=channelSelection, regionCode=regionCode, nTPPollInterval=nTPPollInterval, band=band, remoteIPAddress=remoteIPAddress, alarms=alarms, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPCommunityTableEntry=sNMPCommunityTableEntry, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, nTPState=nTPState, ptp=ptp, remoteMACAddress=remoteMACAddress, timeZone=timeZone, searchState=searchState, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPCommunityTableIndex=sNMPCommunityTableIndex, sNMPCommunityAccess=sNMPCommunityAccess, antennaGain=antennaGain, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPServerPortNumber=tFTPServerPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, licence=licence, sNMPEnabledTraps=sNMPEnabledTraps, managementGroup=managementGroup, pubStats=pubStats, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapTableIndex=sNMPTrapTableIndex, versions=versions, configurationGroup=configurationGroup, iPAddress=iPAddress, notificationsGroup=notificationsGroup, maximumTransmitPower=maximumTransmitPower, nTPServerIp=nTPServerIp, sNMPCommunityString=sNMPCommunityString, sMTPEnabledMessages=sMTPEnabledMessages, sNMPCommunityOid=sNMPCommunityOid, ntpGroup=ntpGroup, dataPortStatusTrap=dataPortStatusTrap, snmpControlGroup=snmpControlGroup, signalStrengthRatio=signalStrengthRatio, vlanPriority=vlanPriority, ntp=ntp, transmitPower=transmitPower, vlanId=vlanId, linkStatusTrap=linkStatusTrap, nTPServerPortNumber=nTPServerPortNumber, systemClock=systemClock, PYSNMP_MODULE_ID=cambium, radarDetectChannel=radarDetectChannel, dualPayload=dualPayload, hardwareVersion=hardwareVersion, snmpControl=snmpControl, measuredRange=measuredRange, configuredRange=configuredRange, versionsGroup=versionsGroup, pubStatsGroup=pubStatsGroup, phyStatusGroup=phyStatusGroup, phyStatus=phyStatus, alarmsGroup=alarmsGroup, linkName=linkName, currentFreqMHz=currentFreqMHz, ptpTraps=ptpTraps, siteName=siteName, vlanTagging=vlanTagging, transmitModulationMode=transmitModulationMode, sMTPServerIPAddress=sMTPServerIPAddress)
