...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", measuredRange=measuredRange, tFTPServerPortNumber=tFTPServerPortNumber, bootVersion=bootVersion, regionCode=regionCode, ptp=ptp, noWirelessChannelAvailable=noWirelessChannelAvailable, dualPayload=dualPayload, configurationGroup=configurationGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, receiveDataRate=receiveDataRate, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitDataRate=transmitDataRate, versions=versions, dataPortStatus=dataPortStatus, smtpGroup=smtpGroup, configuration=configuration, PYSNMP_MODULE_ID=cambium, phyStatusGroup=phyStatusGroup, sNMPTrapTable=sNMPTrapTable, maximumTransmitPower=maximumTransmitPower, sNMPCommunityTableNumber=sNMPCommunityTableNumber, productName=productName, sNMPCommunityTable=sNMPCommunityTable, sNMPTrapCommunity=sNMPTrapCommunity, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, alarms=alarms, vlanId=vlanId, linkLoss=linkLoss, cambium=cambium, nTPLastSync=nTPLastSync, currentChannel=currentChannel, notificationsGroup=notificationsGroup, timeZone=timeZone, ethernet=ethernet, ptpTraps=ptpTraps, gatewayIPAddress=gatewayIPAddress, management=management, nTPPollInterval=nTPPollInterval, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, extendedFreqMHz=extendedFreqMHz, sNMPCommunityTableEntry=sNMPCommunityTableEntry, radarDetectChannel=radarDetectChannel, managementGroup=managementGroup, extendedChannel=extendedChannel, nTPServerIp=nTPServerIp, smtp=smtp, dataPortStatusTrap=dataPortStatusTrap, ethernetGroup=ethernetGroup, softwareVersion=softwareVersion, snmpControlGroup=snmpControlGroup, searchState=searchState, ptp250=ptp250, alarmsGroup=alarmsGroup, noiseFloor=noiseFloor, hardwareVersion=hardwareVersion, configuredRange=configuredRange, masterSlaveMode=masterSlaveMode, tFTPServerIPAddress=tFTPServerIPAddress, channelSelection=channelSelection, iPAddress=iPAddress, pubStatsGroup=pubStatsGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, installArmStateTrap=installArmStateTrap, remoteMACAddress=remoteMACAddress, fixedModMode=fixedModMode, transmitModulationMode=transmitModulationMode, nTPSync=nTPSync, cableLoss=cableLoss, configuredModulationMode=configuredModulationMode, ptpGroups=ptpGroups, linkStatusTrap=linkStatusTrap, versionsGroup=versionsGroup, phyStatus=phyStatus, vectorError=vectorError, nTPState=nTPState, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPServerIPAddress=sMTPServerIPAddress, sNMPCommunityAccess=sNMPCommunityAccess, sNMPCommunityOid=sNMPCommunityOid, transmitPower=transmitPower, wirelessLinkStatus=wirelessLinkStatus, siteName=siteName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, linkName=linkName, nTPServerPortNumber=nTPServerPortNumber, licenceGroup=licenceGroup, productVariant=productVariant, systemClock=systemClock, dataPortAutoNegotiation=dataPortAutoNegotiation, installArmState=installArmState, signalStrengthRatio=signalStrengthRatio, sNMPEnabledTraps=sNMPEnabledTraps, sMTPServerPortNumber=sMTPServerPortNumber, remoteIPAddress=remoteIPAddress, ntp=ntp, pubStats=pubStats, licence=licence, band=band, radarDetectTrap=radarDetectTrap, sMTPEnabledMessages=sMTPEnabledMessages, sNMPCommunityString=sNMPCommunityString, sNMPTrapVersion=sNMPTrapVersion, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapIPAddress=sNMPTrapIPAddress, vlanTagging=vlanTagging, antennaGain=antennaGain, receiveModulationMode=receiveModulationMode, aggregateDataRate=aggregateDataRate, ntpGroup=ntpGroup, snmpControl=snmpControl, sNMPCommunityTableIndex=sNMPCommunityTableIndex, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ptpCompliance=ptpCompliance, vlanPriority=vlanPriority, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapTableEntry=sNMPTrapTableEntry, channelBandwidth=channelBandwidth, currentFreqMHz=currentFreqMHz, subnetMask=subnetMask, sNMPTrapPortNumber=sNMPTrapPortNumber, ptmp=ptmp, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receivePower=receivePower)
