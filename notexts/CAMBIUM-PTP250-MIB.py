...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", installArmState=installArmState, wirelessLinkStatus=wirelessLinkStatus, alarms=alarms, nTPPollInterval=nTPPollInterval, antennaGain=antennaGain, masterSlaveMode=masterSlaveMode, searchState=searchState, configuredModulationMode=configuredModulationMode, sNMPTrapPortNumber=sNMPTrapPortNumber, snmpControlGroup=snmpControlGroup, smtpGroup=smtpGroup, radarDetectTrap=radarDetectTrap, ptpTrapPrefix=ptpTrapPrefix, iPAddress=iPAddress, noiseFloor=noiseFloor, receiveDataRate=receiveDataRate, gatewayIPAddress=gatewayIPAddress, hardwareVersion=hardwareVersion, nTPLastSync=nTPLastSync, dataPortStatusTrap=dataPortStatusTrap, sNMPCommunityTableEntry=sNMPCommunityTableEntry, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, productName=productName, remoteIPAddress=remoteIPAddress, smtp=smtp, sNMPCommunityTable=sNMPCommunityTable, ptmp=ptmp, versionsGroup=versionsGroup, tFTPServerPortNumber=tFTPServerPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapTableIndex=sNMPTrapTableIndex, regionCode=regionCode, dualPayload=dualPayload, linkName=linkName, configurationGroup=configurationGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, licenceGroup=licenceGroup, phyStatusGroup=phyStatusGroup, productVariant=productVariant, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptpCompliance=ptpCompliance, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapCommunity=sNMPTrapCommunity, nTPState=nTPState, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, cambium=cambium, snmpControl=snmpControl, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, measuredRange=measuredRange, sNMPCommunityTableIndex=sNMPCommunityTableIndex, management=management, linkStatusTrap=linkStatusTrap, installArmStateTrap=installArmStateTrap, signalStrengthRatio=signalStrengthRatio, sMTPServerPortNumber=sMTPServerPortNumber, siteName=siteName, systemClock=systemClock, sNMPEnabledTraps=sNMPEnabledTraps, channelSelection=channelSelection, receiveModulationMode=receiveModulationMode, extendedFreqMHz=extendedFreqMHz, vlanId=vlanId, sNMPTrapVersion=sNMPTrapVersion, ethernetGroup=ethernetGroup, transmitPower=transmitPower, aggregateDataRate=aggregateDataRate, channelBandwidth=channelBandwidth, radarDetectChannel=radarDetectChannel, licence=licence, ntp=ntp, sNMPTrapTableNumber=sNMPTrapTableNumber, cableLoss=cableLoss, dataPortAutoNegotiation=dataPortAutoNegotiation, softwareVersion=softwareVersion, fixedModMode=fixedModMode, bootVersion=bootVersion, versions=versions, alarmsGroup=alarmsGroup, tFTPServerIPAddress=tFTPServerIPAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, nTPSync=nTPSync, currentFreqMHz=currentFreqMHz, pubStatsGroup=pubStatsGroup, ethernet=ethernet, nTPServerPortNumber=nTPServerPortNumber, sNMPCommunityOid=sNMPCommunityOid, pubStats=pubStats, vlanTagging=vlanTagging, timeZone=timeZone, sNMPCommunityTableNumber=sNMPCommunityTableNumber, remoteMACAddress=remoteMACAddress, maximumTransmitPower=maximumTransmitPower, ntpGroup=ntpGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, managementGroup=managementGroup, ptp=ptp, sNMPTrapIPAddress=sNMPTrapIPAddress, PYSNMP_MODULE_ID=cambium, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataPortStatus=dataPortStatus, vlanPriority=vlanPriority, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ptpGroups=ptpGroups, notificationsGroup=notificationsGroup, subnetMask=subnetMask, ptp250=ptp250, band=band, sNMPCommunityString=sNMPCommunityString, sMTPServerIPAddress=sMTPServerIPAddress, receivePower=receivePower, sNMPTrapTable=sNMPTrapTable, linkLoss=linkLoss, vectorError=vectorError, ptpTraps=ptpTraps, transmitModulationMode=transmitModulationMode, nTPServerIp=nTPServerIp, transmitDataRate=transmitDataRate, extendedChannel=extendedChannel, configuredRange=configuredRange, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, currentChannel=currentChannel, phyStatus=phyStatus, configuration=configuration, sNMPCommunityAccess=sNMPCommunityAccess)
