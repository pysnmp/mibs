...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPCommunityAccess=sNMPCommunityAccess, noWirelessChannelAvailable=noWirelessChannelAvailable, wirelessLinkStatus=wirelessLinkStatus, hardwareVersion=hardwareVersion, versionsGroup=versionsGroup, sNMPTrapCommunity=sNMPTrapCommunity, sNMPCommunityTable=sNMPCommunityTable, antennaGain=antennaGain, nTPState=nTPState, nTPPollInterval=nTPPollInterval, sNMPCommunityTableNumber=sNMPCommunityTableNumber, ptmp=ptmp, cambium=cambium, vectorError=vectorError, iPAddress=iPAddress, transmitDataRate=transmitDataRate, licenceGroup=licenceGroup, channelSelection=channelSelection, sNMPTrapIPAddress=sNMPTrapIPAddress, receivePower=receivePower, aggregateDataRate=aggregateDataRate, transmitModulationMode=transmitModulationMode, vlanId=vlanId, configuration=configuration, alarmsGroup=alarmsGroup, ptpTrapPrefix=ptpTrapPrefix, installArmState=installArmState, snmpControl=snmpControl, transmitPower=transmitPower, currentChannel=currentChannel, measuredRange=measuredRange, currentFreqMHz=currentFreqMHz, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkLoss=linkLoss, ethernet=ethernet, timeZone=timeZone, sNMPTrapTableNumber=sNMPTrapTableNumber, masterSlaveMode=masterSlaveMode, licence=licence, regionCode=regionCode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPEnabledTraps=sNMPEnabledTraps, management=management, gatewayIPAddress=gatewayIPAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, ntpGroup=ntpGroup, remoteIPAddress=remoteIPAddress, productName=productName, maximumTransmitPower=maximumTransmitPower, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, pubStats=pubStats, sMTPEnabledMessages=sMTPEnabledMessages, systemClock=systemClock, installArmStateTrap=installArmStateTrap, sMTPServerIPAddress=sMTPServerIPAddress, noiseFloor=noiseFloor, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ptpGroups=ptpGroups, extendedFreqMHz=extendedFreqMHz, extendedChannel=extendedChannel, bootVersion=bootVersion, tFTPServerPortNumber=tFTPServerPortNumber, ptp=ptp, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, cableLoss=cableLoss, ptpTraps=ptpTraps, smtp=smtp, subnetMask=subnetMask, vlanTagging=vlanTagging, ethernetGroup=ethernetGroup, managementGroup=managementGroup, siteName=siteName, softwareVersion=softwareVersion, phyStatusGroup=phyStatusGroup, sNMPCommunityString=sNMPCommunityString, linkName=linkName, sMTPServerPortNumber=sMTPServerPortNumber, radarDetectChannel=radarDetectChannel, dataPortStatusTrap=dataPortStatusTrap, band=band, productVariant=productVariant, sNMPCommunityTableEntry=sNMPCommunityTableEntry, sNMPTrapVersion=sNMPTrapVersion, configuredRange=configuredRange, channelBandwidth=channelBandwidth, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortAutoNegotiation=dataPortAutoNegotiation, smtpGroup=smtpGroup, remoteMACAddress=remoteMACAddress, ptpCompliance=ptpCompliance, nTPServerIp=nTPServerIp, snmpControlGroup=snmpControlGroup, pubStatsGroup=pubStatsGroup, ptp250=ptp250, ntp=ntp, sNMPCommunityOid=sNMPCommunityOid, radarDetectTrap=radarDetectTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, notificationsGroup=notificationsGroup, signalStrengthRatio=signalStrengthRatio, sMTPSourceEmailAddress=sMTPSourceEmailAddress, PYSNMP_MODULE_ID=cambium, sNMPTrapTableIndex=sNMPTrapTableIndex, dualPayload=dualPayload, dataPortStatus=dataPortStatus, alarms=alarms, nTPServerPortNumber=nTPServerPortNumber, versions=versions, receiveDataRate=receiveDataRate, tFTPServerIPAddress=tFTPServerIPAddress, sNMPCommunityTableIndex=sNMPCommunityTableIndex, configuredModulationMode=configuredModulationMode, searchState=searchState, fixedModMode=fixedModMode, sNMPTrapTable=sNMPTrapTable, configurationGroup=configurationGroup, phyStatus=phyStatus, receiveModulationMode=receiveModulationMode, nTPLastSync=nTPLastSync, nTPSync=nTPSync, linkStatusTrap=linkStatusTrap, vlanPriority=vlanPriority)
