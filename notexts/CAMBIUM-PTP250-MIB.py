...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", ntp=ntp, sNMPCommunityOid=sNMPCommunityOid, configuration=configuration, nTPPollInterval=nTPPollInterval, ptpTraps=ptpTraps, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptp=ptp, phyStatus=phyStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, hardwareVersion=hardwareVersion, notificationsGroup=notificationsGroup, radarDetectTrap=radarDetectTrap, measuredRange=measuredRange, sNMPTrapVersion=sNMPTrapVersion, tFTPServerIPAddress=tFTPServerIPAddress, masterSlaveMode=masterSlaveMode, dataPortStatusTrap=dataPortStatusTrap, nTPServerIp=nTPServerIp, nTPSync=nTPSync, versions=versions, antennaGain=antennaGain, gatewayIPAddress=gatewayIPAddress, bootVersion=bootVersion, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortStatus=dataPortStatus, nTPServerPortNumber=nTPServerPortNumber, productVariant=productVariant, pubStats=pubStats, cambium=cambium, transmitDataRate=transmitDataRate, sNMPEnabledTraps=sNMPEnabledTraps, nTPLastSync=nTPLastSync, remoteIPAddress=remoteIPAddress, nTPState=nTPState, wirelessLinkStatus=wirelessLinkStatus, sNMPCommunityTableNumber=sNMPCommunityTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkName=linkName, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, management=management, linkStatusTrap=linkStatusTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sMTPSourceEmailAddress=sMTPSourceEmailAddress, alarmsGroup=alarmsGroup, transmitModulationMode=transmitModulationMode, aggregateDataRate=aggregateDataRate, ethernetGroup=ethernetGroup, cableLoss=cableLoss, snmpControl=snmpControl, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, snmpControlGroup=snmpControlGroup, vlanId=vlanId, linkLoss=linkLoss, searchState=searchState, installArmState=installArmState, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapCommunity=sNMPTrapCommunity, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptpCompliance=ptpCompliance, radarDetectChannel=radarDetectChannel, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, currentFreqMHz=currentFreqMHz, sNMPTrapTable=sNMPTrapTable, band=band, currentChannel=currentChannel, sNMPCommunityAccess=sNMPCommunityAccess, receivePower=receivePower, channelBandwidth=channelBandwidth, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapTableNumber=sNMPTrapTableNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPCommunityString=sNMPCommunityString, licenceGroup=licenceGroup, configuredRange=configuredRange, ptmp=ptmp, dataPortAutoNegotiation=dataPortAutoNegotiation, vectorError=vectorError, installArmStateTrap=installArmStateTrap, smtpGroup=smtpGroup, sNMPCommunityTableEntry=sNMPCommunityTableEntry, receiveDataRate=receiveDataRate, versionsGroup=versionsGroup, channelSelection=channelSelection, sNMPCommunityTableIndex=sNMPCommunityTableIndex, remoteMACAddress=remoteMACAddress, systemClock=systemClock, alarms=alarms, regionCode=regionCode, ethernet=ethernet, siteName=siteName, iPAddress=iPAddress, extendedFreqMHz=extendedFreqMHz, ptp250=ptp250, signalStrengthRatio=signalStrengthRatio, maximumTransmitPower=maximumTransmitPower, licence=licence, transmitPower=transmitPower, managementGroup=managementGroup, subnetMask=subnetMask, configurationGroup=configurationGroup, noiseFloor=noiseFloor, fixedModMode=fixedModMode, vlanPriority=vlanPriority, receiveModulationMode=receiveModulationMode, vlanTagging=vlanTagging, phyStatusGroup=phyStatusGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, pubStatsGroup=pubStatsGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, timeZone=timeZone, sNMPCommunityTable=sNMPCommunityTable, configuredModulationMode=configuredModulationMode, PYSNMP_MODULE_ID=cambium, extendedChannel=extendedChannel, sMTPServerIPAddress=sMTPServerIPAddress, smtp=smtp, ntpGroup=ntpGroup, dualPayload=dualPayload, ptpGroups=ptpGroups, productName=productName, softwareVersion=softwareVersion, sMTPServerPortNumber=sMTPServerPortNumber, sMTPEnabledMessages=sMTPEnabledMessages)
