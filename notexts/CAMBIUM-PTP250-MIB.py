...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sNMPCommunityTable=sNMPCommunityTable, dualPayload=dualPayload, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, antennaGain=antennaGain, receivePower=receivePower, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, radarDetectTrap=radarDetectTrap, receiveDataRate=receiveDataRate, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPCommunityAccess=sNMPCommunityAccess, noiseFloor=noiseFloor, configurationGroup=configurationGroup, dataPortStatus=dataPortStatus, installArmState=installArmState, sNMPCommunityOid=sNMPCommunityOid, extendedChannel=extendedChannel, nTPSync=nTPSync, snmpControlGroup=snmpControlGroup, tFTPServerIPAddress=tFTPServerIPAddress, regionCode=regionCode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, phyStatusGroup=phyStatusGroup, configuredRange=configuredRange, cambium=cambium, vlanId=vlanId, sNMPTrapTable=sNMPTrapTable, ptp250=ptp250, ptmp=ptmp, currentChannel=currentChannel, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPCommunityTableEntry=sNMPCommunityTableEntry, dataPortStatusTrap=dataPortStatusTrap, vectorError=vectorError, nTPPollInterval=nTPPollInterval, softwareVersion=softwareVersion, timeZone=timeZone, sNMPTrapIPAddress=sNMPTrapIPAddress, sMTPServerPortNumber=sMTPServerPortNumber, pubStatsGroup=pubStatsGroup, configuration=configuration, smtp=smtp, sNMPTrapTableEntry=sNMPTrapTableEntry, licenceGroup=licenceGroup, ethernetGroup=ethernetGroup, linkStatusTrap=linkStatusTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, extendedFreqMHz=extendedFreqMHz, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapCommunity=sNMPTrapCommunity, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPEnabledTraps=sNMPEnabledTraps, ptp=ptp, productName=productName, management=management, hardwareVersion=hardwareVersion, remoteMACAddress=remoteMACAddress, sNMPCommunityTableIndex=sNMPCommunityTableIndex, pubStats=pubStats, PYSNMP_MODULE_ID=cambium, channelSelection=channelSelection, subnetMask=subnetMask, maximumTransmitPower=maximumTransmitPower, sNMPTrapVersion=sNMPTrapVersion, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPCommunityString=sNMPCommunityString, vlanPriority=vlanPriority, alarmsGroup=alarmsGroup, nTPState=nTPState, siteName=siteName, ntpGroup=ntpGroup, nTPServerPortNumber=nTPServerPortNumber, versions=versions, transmitPower=transmitPower, installArmStateTrap=installArmStateTrap, snmpControl=snmpControl, ptpCompliance=ptpCompliance, ptpTrapPrefix=ptpTrapPrefix, ptpGroups=ptpGroups, fixedModMode=fixedModMode, sMTPEnabledMessages=sMTPEnabledMessages, smtpGroup=smtpGroup, phyStatus=phyStatus, ptpTraps=ptpTraps, managementGroup=managementGroup, vlanTagging=vlanTagging, tFTPServerPortNumber=tFTPServerPortNumber, gatewayIPAddress=gatewayIPAddress, bootVersion=bootVersion, aggregateDataRate=aggregateDataRate, masterSlaveMode=masterSlaveMode, channelBandwidth=channelBandwidth, currentFreqMHz=currentFreqMHz, receiveModulationMode=receiveModulationMode, configuredModulationMode=configuredModulationMode, ethernet=ethernet, ntp=ntp, cableLoss=cableLoss, transmitDataRate=transmitDataRate, productVariant=productVariant, band=band, systemClock=systemClock, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkName=linkName, nTPLastSync=nTPLastSync, versionsGroup=versionsGroup, nTPServerIp=nTPServerIp, iPAddress=iPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, searchState=searchState, sNMPCommunityTableNumber=sNMPCommunityTableNumber, measuredRange=measuredRange, linkLoss=linkLoss, remoteIPAddress=remoteIPAddress, radarDetectChannel=radarDetectChannel, sMTPServerIPAddress=sMTPServerIPAddress, wirelessLinkStatus=wirelessLinkStatus, dataPortAutoNegotiation=dataPortAutoNegotiation, transmitModulationMode=transmitModulationMode, sNMPTrapTableIndex=sNMPTrapTableIndex, licence=licence, alarms=alarms, notificationsGroup=notificationsGroup, signalStrengthRatio=signalStrengthRatio)
