...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", snmpControl=snmpControl, extendedChannel=extendedChannel, ptp=ptp, radarDetectTrap=radarDetectTrap, ptpCompliance=ptpCompliance, smtpGroup=smtpGroup, gatewayIPAddress=gatewayIPAddress, receiveDataRate=receiveDataRate, remoteMACAddress=remoteMACAddress, sNMPTrapVersion=sNMPTrapVersion, sNMPCommunityTable=sNMPCommunityTable, vectorError=vectorError, ptpTraps=ptpTraps, configuredModulationMode=configuredModulationMode, PYSNMP_MODULE_ID=cambium, ptp250=ptp250, channelSelection=channelSelection, receivePower=receivePower, installArmStateTrap=installArmStateTrap, linkLoss=linkLoss, ntp=ntp, dualPayload=dualPayload, dataPortStatusTrap=dataPortStatusTrap, productVariant=productVariant, channelBandwidth=channelBandwidth, sNMPTrapTableEntry=sNMPTrapTableEntry, fixedModMode=fixedModMode, snmpControlGroup=snmpControlGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, alarms=alarms, radarDetectChannel=radarDetectChannel, transmitPower=transmitPower, management=management, sNMPCommunityOid=sNMPCommunityOid, masterSlaveMode=masterSlaveMode, softwareVersion=softwareVersion, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapCommunity=sNMPTrapCommunity, ptmp=ptmp, sNMPCommunityTableIndex=sNMPCommunityTableIndex, ethernet=ethernet, aggregateDataRate=aggregateDataRate, transmitDataRate=transmitDataRate, configurationGroup=configurationGroup, siteName=siteName, remoteIPAddress=remoteIPAddress, wirelessLinkStatus=wirelessLinkStatus, sMTPServerPortNumber=sMTPServerPortNumber, ethernetGroup=ethernetGroup, vlanId=vlanId, extendedFreqMHz=extendedFreqMHz, cambium=cambium, dataPortStatus=dataPortStatus, pubStats=pubStats, sNMPCommunityTableNumber=sNMPCommunityTableNumber, nTPState=nTPState, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapTable=sNMPTrapTable, noiseFloor=noiseFloor, band=band, nTPSync=nTPSync, sNMPCommunityString=sNMPCommunityString, signalStrengthRatio=signalStrengthRatio, pubStatsGroup=pubStatsGroup, systemClock=systemClock, bootVersion=bootVersion, cableLoss=cableLoss, notificationsGroup=notificationsGroup, iPAddress=iPAddress, timeZone=timeZone, ptpGroups=ptpGroups, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, nTPServerPortNumber=nTPServerPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, currentChannel=currentChannel, configuration=configuration, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, antennaGain=antennaGain, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, licence=licence, receiveModulationMode=receiveModulationMode, transmitModulationMode=transmitModulationMode, installArmState=installArmState, licenceGroup=licenceGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, hardwareVersion=hardwareVersion, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, versions=versions, sNMPTrapIPAddress=sNMPTrapIPAddress, alarmsGroup=alarmsGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPServerPortNumber=tFTPServerPortNumber, measuredRange=measuredRange, vlanPriority=vlanPriority, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, managementGroup=managementGroup, maximumTransmitPower=maximumTransmitPower, sNMPTrapTableNumber=sNMPTrapTableNumber, ntpGroup=ntpGroup, versionsGroup=versionsGroup, linkName=linkName, sNMPCommunityTableEntry=sNMPCommunityTableEntry, configuredRange=configuredRange, nTPLastSync=nTPLastSync, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, nTPPollInterval=nTPPollInterval, dataPortAutoNegotiation=dataPortAutoNegotiation, productName=productName, smtp=smtp, nTPServerIp=nTPServerIp, subnetMask=subnetMask, phyStatus=phyStatus, vlanTagging=vlanTagging, regionCode=regionCode, sMTPEnabledMessages=sMTPEnabledMessages, currentFreqMHz=currentFreqMHz, sNMPCommunityAccess=sNMPCommunityAccess, searchState=searchState, sMTPServerIPAddress=sMTPServerIPAddress, linkStatusTrap=linkStatusTrap, phyStatusGroup=phyStatusGroup, tFTPServerIPAddress=tFTPServerIPAddress)
