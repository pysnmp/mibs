...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", linkLoss=linkLoss, dualPayload=dualPayload, antennaGain=antennaGain, subnetMask=subnetMask, tFTPServerPortNumber=tFTPServerPortNumber, snmpControl=snmpControl, receivePower=receivePower, radarDetectChannel=radarDetectChannel, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, pubStats=pubStats, nTPServerPortNumber=nTPServerPortNumber, sNMPTrapTable=sNMPTrapTable, channelBandwidth=channelBandwidth, iPAddress=iPAddress, channelSelection=channelSelection, masterSlaveMode=masterSlaveMode, noWirelessChannelAvailable=noWirelessChannelAvailable, transmitDataRate=transmitDataRate, sMTPSourceEmailAddress=sMTPSourceEmailAddress, remoteMACAddress=remoteMACAddress, currentFreqMHz=currentFreqMHz, sNMPCommunityString=sNMPCommunityString, productName=productName, nTPPollInterval=nTPPollInterval, sNMPCommunityTable=sNMPCommunityTable, nTPSync=nTPSync, linkStatusTrap=linkStatusTrap, ptp=ptp, sNMPTrapTableIndex=sNMPTrapTableIndex, ethernetGroup=ethernetGroup, PYSNMP_MODULE_ID=cambium, vlanTagging=vlanTagging, management=management, sMTPServerPortNumber=sMTPServerPortNumber, configuredModulationMode=configuredModulationMode, versions=versions, sNMPTrapPortNumber=sNMPTrapPortNumber, softwareVersion=softwareVersion, ptpTraps=ptpTraps, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPCommunityTableNumber=sNMPCommunityTableNumber, vlanId=vlanId, sNMPTrapIPAddress=sNMPTrapIPAddress, configuration=configuration, searchState=searchState, installArmStateTrap=installArmStateTrap, ptpGroups=ptpGroups, fixedModMode=fixedModMode, radarDetectTrap=radarDetectTrap, siteName=siteName, vectorError=vectorError, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, versionsGroup=versionsGroup, pubStatsGroup=pubStatsGroup, systemClock=systemClock, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, ptpTrapPrefix=ptpTrapPrefix, notificationsGroup=notificationsGroup, vlanPriority=vlanPriority, transmitModulationMode=transmitModulationMode, licence=licence, noiseFloor=noiseFloor, installArmState=installArmState, currentChannel=currentChannel, nTPState=nTPState, regionCode=regionCode, sMTPServerIPAddress=sMTPServerIPAddress, bootVersion=bootVersion, timeZone=timeZone, remoteIPAddress=remoteIPAddress, sNMPTrapVersion=sNMPTrapVersion, nTPLastSync=nTPLastSync, smtpGroup=smtpGroup, configuredRange=configuredRange, phyStatus=phyStatus, tFTPServerIPAddress=tFTPServerIPAddress, alarmsGroup=alarmsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPCommunityOid=sNMPCommunityOid, ptp250=ptp250, linkName=linkName, signalStrengthRatio=signalStrengthRatio, receiveModulationMode=receiveModulationMode, gatewayIPAddress=gatewayIPAddress, maximumTransmitPower=maximumTransmitPower, sNMPTrapTableNumber=sNMPTrapTableNumber, aggregateDataRate=aggregateDataRate, productVariant=productVariant, sNMPCommunityAccess=sNMPCommunityAccess, wirelessLinkStatus=wirelessLinkStatus, receiveDataRate=receiveDataRate, sNMPCommunityTableEntry=sNMPCommunityTableEntry, measuredRange=measuredRange, ptmp=ptmp, ntp=ntp, extendedChannel=extendedChannel, sNMPTrapCommunity=sNMPTrapCommunity, ptpCompliance=ptpCompliance, extendedFreqMHz=extendedFreqMHz, hardwareVersion=hardwareVersion, ntpGroup=ntpGroup, smtp=smtp, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortStatus=dataPortStatus, cambium=cambium, managementGroup=managementGroup, cableLoss=cableLoss, phyStatusGroup=phyStatusGroup, licenceGroup=licenceGroup, configurationGroup=configurationGroup, transmitPower=transmitPower, dataPortStatusTrap=dataPortStatusTrap, ethernet=ethernet, snmpControlGroup=snmpControlGroup, band=band, sNMPEnabledTraps=sNMPEnabledTraps, sNMPCommunityTableIndex=sNMPCommunityTableIndex, nTPServerIp=nTPServerIp, alarms=alarms, sMTPEnabledMessages=sMTPEnabledMessages, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex)
