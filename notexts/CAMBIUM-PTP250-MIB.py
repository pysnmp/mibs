...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", iPAddress=iPAddress, channelBandwidth=channelBandwidth, subnetMask=subnetMask, currentChannel=currentChannel, pubStats=pubStats, sMTPServerIPAddress=sMTPServerIPAddress, fixedModMode=fixedModMode, dualPayload=dualPayload, band=band, smtp=smtp, radarDetectTrap=radarDetectTrap, antennaGain=antennaGain, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, nTPServerIp=nTPServerIp, receiveModulationMode=receiveModulationMode, sMTPEnabledMessages=sMTPEnabledMessages, notificationsGroup=notificationsGroup, aggregateDataRate=aggregateDataRate, remoteMACAddress=remoteMACAddress, managementGroup=managementGroup, dataPortStatusTrap=dataPortStatusTrap, extendedFreqMHz=extendedFreqMHz, timeZone=timeZone, sNMPTrapTable=sNMPTrapTable, ptpTrapPrefix=ptpTrapPrefix, smtpGroup=smtpGroup, productVariant=productVariant, searchState=searchState, sNMPTrapVersion=sNMPTrapVersion, management=management, configurationGroup=configurationGroup, transmitDataRate=transmitDataRate, linkName=linkName, sNMPCommunityTableIndex=sNMPCommunityTableIndex, ptmp=ptmp, alarms=alarms, gatewayIPAddress=gatewayIPAddress, sNMPCommunityTableNumber=sNMPCommunityTableNumber, cableLoss=cableLoss, ntpGroup=ntpGroup, configuration=configuration, radarDetectChannel=radarDetectChannel, signalStrengthRatio=signalStrengthRatio, nTPState=nTPState, sNMPTrapIPAddress=sNMPTrapIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, remoteIPAddress=remoteIPAddress, receivePower=receivePower, sNMPTrapPortNumber=sNMPTrapPortNumber, wirelessLinkStatus=wirelessLinkStatus, tFTPServerPortNumber=tFTPServerPortNumber, transmitPower=transmitPower, snmpControl=snmpControl, sNMPCommunityAccess=sNMPCommunityAccess, systemClock=systemClock, hardwareVersion=hardwareVersion, pubStatsGroup=pubStatsGroup, siteName=siteName, vlanId=vlanId, vlanPriority=vlanPriority, sNMPCommunityTable=sNMPCommunityTable, maximumTransmitPower=maximumTransmitPower, alarmsGroup=alarmsGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, linkStatusTrap=linkStatusTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, extendedChannel=extendedChannel, snmpControlGroup=snmpControlGroup, licence=licence, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptpTraps=ptpTraps, licenceGroup=licenceGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, nTPPollInterval=nTPPollInterval, tFTPServerIPAddress=tFTPServerIPAddress, sNMPCommunityOid=sNMPCommunityOid, configuredRange=configuredRange, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, currentFreqMHz=currentFreqMHz, sNMPCommunityTableEntry=sNMPCommunityTableEntry, nTPServerPortNumber=nTPServerPortNumber, versionsGroup=versionsGroup, regionCode=regionCode, measuredRange=measuredRange, ntp=ntp, nTPSync=nTPSync, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, transmitModulationMode=transmitModulationMode, dataPortAutoNegotiation=dataPortAutoNegotiation, ptpGroups=ptpGroups, channelSelection=channelSelection, linkLoss=linkLoss, nTPLastSync=nTPLastSync, phyStatusGroup=phyStatusGroup, ptp250=ptp250, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, phyStatus=phyStatus, receiveDataRate=receiveDataRate, noiseFloor=noiseFloor, PYSNMP_MODULE_ID=cambium, versions=versions, ethernetGroup=ethernetGroup, ptp=ptp, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapTableEntry=sNMPTrapTableEntry, bootVersion=bootVersion, installArmState=installArmState, softwareVersion=softwareVersion, sNMPCommunityString=sNMPCommunityString, sMTPServerPortNumber=sMTPServerPortNumber, vlanTagging=vlanTagging, productName=productName, configuredModulationMode=configuredModulationMode, vectorError=vectorError, ptpCompliance=ptpCompliance, masterSlaveMode=masterSlaveMode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortStatus=dataPortStatus, ethernet=ethernet, installArmStateTrap=installArmStateTrap, sNMPTrapCommunity=sNMPTrapCommunity, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, cambium=cambium)
