...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", cambium=cambium, ptpTrapPrefix=ptpTrapPrefix, sNMPCommunityTableEntry=sNMPCommunityTableEntry, pubStatsGroup=pubStatsGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, phyStatusGroup=phyStatusGroup, linkName=linkName, extendedChannel=extendedChannel, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, hardwareVersion=hardwareVersion, ptmp=ptmp, transmitDataRate=transmitDataRate, smtpGroup=smtpGroup, nTPServerPortNumber=nTPServerPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, currentFreqMHz=currentFreqMHz, ptpGroups=ptpGroups, installArmStateTrap=installArmStateTrap, notificationsGroup=notificationsGroup, ptp=ptp, pubStats=pubStats, sNMPCommunityTable=sNMPCommunityTable, currentChannel=currentChannel, vectorError=vectorError, receiveModulationMode=receiveModulationMode, maximumTransmitPower=maximumTransmitPower, ptpCompliance=ptpCompliance, configuredModulationMode=configuredModulationMode, snmpControl=snmpControl, sNMPCommunityOid=sNMPCommunityOid, cableLoss=cableLoss, vlanPriority=vlanPriority, bootVersion=bootVersion, antennaGain=antennaGain, alarms=alarms, dataPortStatusTrap=dataPortStatusTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, PYSNMP_MODULE_ID=cambium, transmitModulationMode=transmitModulationMode, receiveDataRate=receiveDataRate, licence=licence, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, iPAddress=iPAddress, installArmState=installArmState, sNMPTrapTable=sNMPTrapTable, versionsGroup=versionsGroup, nTPServerIp=nTPServerIp, management=management, wirelessLinkStatus=wirelessLinkStatus, phyStatus=phyStatus, sMTPServerPortNumber=sMTPServerPortNumber, masterSlaveMode=masterSlaveMode, linkLoss=linkLoss, regionCode=regionCode, sNMPCommunityTableNumber=sNMPCommunityTableNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, softwareVersion=softwareVersion, nTPPollInterval=nTPPollInterval, dataPortStatus=dataPortStatus, channelSelection=channelSelection, alarmsGroup=alarmsGroup, channelBandwidth=channelBandwidth, nTPLastSync=nTPLastSync, timeZone=timeZone, extendedFreqMHz=extendedFreqMHz, nTPState=nTPState, ethernetGroup=ethernetGroup, measuredRange=measuredRange, receivePower=receivePower, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sMTPServerIPAddress=sMTPServerIPAddress, gatewayIPAddress=gatewayIPAddress, productVariant=productVariant, sNMPTrapVersion=sNMPTrapVersion, aggregateDataRate=aggregateDataRate, searchState=searchState, dualPayload=dualPayload, transmitPower=transmitPower, managementGroup=managementGroup, ntpGroup=ntpGroup, ntp=ntp, linkStatusTrap=linkStatusTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, smtp=smtp, vlanId=vlanId, configuredRange=configuredRange, ptp250=ptp250, configuration=configuration, nTPSync=nTPSync, sNMPTrapTableEntry=sNMPTrapTableEntry, radarDetectTrap=radarDetectTrap, licenceGroup=licenceGroup, fixedModMode=fixedModMode, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPCommunityAccess=sNMPCommunityAccess, tFTPServerPortNumber=tFTPServerPortNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, remoteMACAddress=remoteMACAddress, sNMPTrapCommunity=sNMPTrapCommunity, sNMPEnabledTraps=sNMPEnabledTraps, sNMPCommunityTableIndex=sNMPCommunityTableIndex, vlanTagging=vlanTagging, remoteIPAddress=remoteIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, systemClock=systemClock, productName=productName, ethernet=ethernet, band=band, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, noiseFloor=noiseFloor, siteName=siteName, signalStrengthRatio=signalStrengthRatio, configurationGroup=configurationGroup, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, subnetMask=subnetMask, snmpControlGroup=snmpControlGroup, ptpTraps=ptpTraps, versions=versions, sNMPCommunityString=sNMPCommunityString, radarDetectChannel=radarDetectChannel)
