...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", signalStrengthRatio=signalStrengthRatio, ptpTrapPrefix=ptpTrapPrefix, ethernetGroup=ethernetGroup, nTPState=nTPState, licenceGroup=licenceGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, snmpControl=snmpControl, vlanTagging=vlanTagging, sNMPTrapIPAddress=sNMPTrapIPAddress, alarms=alarms, channelSelection=channelSelection, smtpGroup=smtpGroup, nTPLastSync=nTPLastSync, productVariant=productVariant, receivePower=receivePower, siteName=siteName, regionCode=regionCode, transmitModulationMode=transmitModulationMode, extendedChannel=extendedChannel, antennaGain=antennaGain, ptpGroups=ptpGroups, dualPayload=dualPayload, sNMPTrapTableEntry=sNMPTrapTableEntry, aggregateDataRate=aggregateDataRate, linkLoss=linkLoss, dataPortStatus=dataPortStatus, nTPServerPortNumber=nTPServerPortNumber, managementGroup=managementGroup, ptpTraps=ptpTraps, searchState=searchState, wirelessLinkStatus=wirelessLinkStatus, ptmp=ptmp, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, remoteIPAddress=remoteIPAddress, configuration=configuration, notificationsGroup=notificationsGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapTable=sNMPTrapTable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transmitPower=transmitPower, ptpCompliance=ptpCompliance, dataPortAutoNegotiation=dataPortAutoNegotiation, fixedModMode=fixedModMode, linkStatusTrap=linkStatusTrap, sMTPServerPortNumber=sMTPServerPortNumber, sNMPCommunityOid=sNMPCommunityOid, linkName=linkName, smtp=smtp, sNMPCommunityTable=sNMPCommunityTable, softwareVersion=softwareVersion, configuredModulationMode=configuredModulationMode, receiveModulationMode=receiveModulationMode, maximumTransmitPower=maximumTransmitPower, nTPSync=nTPSync, currentFreqMHz=currentFreqMHz, channelBandwidth=channelBandwidth, alarmsGroup=alarmsGroup, snmpControlGroup=snmpControlGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernet=ethernet, radarDetectChannel=radarDetectChannel, tFTPServerIPAddress=tFTPServerIPAddress, versionsGroup=versionsGroup, sNMPCommunityAccess=sNMPCommunityAccess, sMTPServerIPAddress=sMTPServerIPAddress, noiseFloor=noiseFloor, versions=versions, measuredRange=measuredRange, installArmState=installArmState, configuredRange=configuredRange, sNMPTrapVersion=sNMPTrapVersion, extendedFreqMHz=extendedFreqMHz, ntp=ntp, sNMPCommunityTableIndex=sNMPCommunityTableIndex, ptp=ptp, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, transmitDataRate=transmitDataRate, nTPServerIp=nTPServerIp, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, management=management, hardwareVersion=hardwareVersion, sNMPCommunityString=sNMPCommunityString, licence=licence, band=band, gatewayIPAddress=gatewayIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, masterSlaveMode=masterSlaveMode, vectorError=vectorError, vlanPriority=vlanPriority, bootVersion=bootVersion, systemClock=systemClock, remoteMACAddress=remoteMACAddress, sNMPCommunityTableNumber=sNMPCommunityTableNumber, installArmStateTrap=installArmStateTrap, pubStats=pubStats, PYSNMP_MODULE_ID=cambium, pubStatsGroup=pubStatsGroup, vlanId=vlanId, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, receiveDataRate=receiveDataRate, productName=productName, sMTPEnabledMessages=sMTPEnabledMessages, ntpGroup=ntpGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPCommunityTableEntry=sNMPCommunityTableEntry, phyStatusGroup=phyStatusGroup, currentChannel=currentChannel, subnetMask=subnetMask, dataPortStatusTrap=dataPortStatusTrap, configurationGroup=configurationGroup, tFTPServerPortNumber=tFTPServerPortNumber, timeZone=timeZone, ptp250=ptp250, sNMPTrapCommunity=sNMPTrapCommunity, radarDetectTrap=radarDetectTrap, phyStatus=phyStatus, iPAddress=iPAddress, nTPPollInterval=nTPPollInterval, cambium=cambium, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPEnabledTraps=sNMPEnabledTraps, cableLoss=cableLoss)
