...
mibBuilder.exportSymbols("CAMBIUM-PTP250-MIB", sMTPServerIPAddress=sMTPServerIPAddress, aggregateDataRate=aggregateDataRate, signalStrengthRatio=signalStrengthRatio, dataPortStatusTrap=dataPortStatusTrap, ptpTraps=ptpTraps, smtp=smtp, pubStats=pubStats, linkLoss=linkLoss, sNMPCommunityAccess=sNMPCommunityAccess, subnetMask=subnetMask, ptp=ptp, ptpCompliance=ptpCompliance, vlanId=vlanId, extendedFreqMHz=extendedFreqMHz, installArmStateTrap=installArmStateTrap, vectorError=vectorError, ptmp=ptmp, sNMPTrapTableNumber=sNMPTrapTableNumber, bootVersion=bootVersion, configuredRange=configuredRange, dataPortAutoNegotiation=dataPortAutoNegotiation, ptpTrapPrefix=ptpTrapPrefix, searchState=searchState, sNMPCommunityString=sNMPCommunityString, ptp250=ptp250, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, currentChannel=currentChannel, sNMPCommunityTable=sNMPCommunityTable, maximumTransmitPower=maximumTransmitPower, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, extendedChannel=extendedChannel, remoteMACAddress=remoteMACAddress, configuration=configuration, cableLoss=cableLoss, alarmsGroup=alarmsGroup, smtpGroup=smtpGroup, sNMPCommunityTableIndex=sNMPCommunityTableIndex, noiseFloor=noiseFloor, nTPServerIp=nTPServerIp, wirelessLinkStatus=wirelessLinkStatus, cambium=cambium, productName=productName, receiveDataRate=receiveDataRate, linkStatusTrap=linkStatusTrap, configuredModulationMode=configuredModulationMode, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapVersion=sNMPTrapVersion, pubStatsGroup=pubStatsGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, nTPPollInterval=nTPPollInterval, nTPServerPortNumber=nTPServerPortNumber, band=band, sMTPEnabledMessages=sMTPEnabledMessages, sNMPCommunityTableNumber=sNMPCommunityTableNumber, sNMPEnabledTraps=sNMPEnabledTraps, dataPortStatus=dataPortStatus, channelBandwidth=channelBandwidth, management=management, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, linkName=linkName, sNMPTrapTable=sNMPTrapTable, sNMPCommunityOid=sNMPCommunityOid, hardwareVersion=hardwareVersion, transmitDataRate=transmitDataRate, licence=licence, softwareVersion=softwareVersion, transmitModulationMode=transmitModulationMode, alarms=alarms, phyStatusGroup=phyStatusGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, installArmState=installArmState, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, remoteIPAddress=remoteIPAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPTrapCommunity=sNMPTrapCommunity, configurationGroup=configurationGroup, nTPLastSync=nTPLastSync, ethernetGroup=ethernetGroup, antennaGain=antennaGain, snmpControl=snmpControl, PYSNMP_MODULE_ID=cambium, ntp=ntp, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, measuredRange=measuredRange, phyStatus=phyStatus, systemClock=systemClock, sNMPTrapTableEntry=sNMPTrapTableEntry, dualPayload=dualPayload, transmitPower=transmitPower, ethernet=ethernet, ptpGroups=ptpGroups, siteName=siteName, gatewayIPAddress=gatewayIPAddress, sNMPCommunityTableEntry=sNMPCommunityTableEntry, vlanTagging=vlanTagging, timeZone=timeZone, masterSlaveMode=masterSlaveMode, sMTPServerPortNumber=sMTPServerPortNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, managementGroup=managementGroup, fixedModMode=fixedModMode, snmpControlGroup=snmpControlGroup, iPAddress=iPAddress, tFTPServerPortNumber=tFTPServerPortNumber, licenceGroup=licenceGroup, currentFreqMHz=currentFreqMHz, receivePower=receivePower, sNMPTrapPortNumber=sNMPTrapPortNumber, versionsGroup=versionsGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, nTPSync=nTPSync, receiveModulationMode=receiveModulationMode, radarDetectChannel=radarDetectChannel, sNMPTrapIPAddress=sNMPTrapIPAddress, versions=versions, nTPState=nTPState, notificationsGroup=notificationsGroup, ntpGroup=ntpGroup, channelSelection=channelSelection, productVariant=productVariant, vlanPriority=vlanPriority, radarDetectTrap=radarDetectTrap, regionCode=regionCode)
