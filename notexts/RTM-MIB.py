...
# ASN.1 source RTM-MIB
# Source digest sha256:535ab4d913d0383c3ac441403973243fe37d81695bd572760c27b61c77e77bff
...
trapConfigTable = MibTable((1, 3, 6, 1, 4, 1, 351, 120, 1, 1), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: trapConfigTable.setStatus('mandatory')
trapConfigEntry = MibTableRow((1, 3, 6, 1, 4, 1, 351, 120, 1, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "RTM-MIB", "managerIPaddress"))
...
trapUploadTable = MibTable((1, 3, 6, 1, 4, 1, 351, 120, 1, 4), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: trapUploadTable.setStatus('mandatory')
trapUploadEntry = MibTableRow((1, 3, 6, 1, 4, 1, 351, 120, 1, 4, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "RTM-MIB", "trapManagerIPaddress"))
...
recoverTrapTable = MibTable((1, 3, 6, 1, 4, 1, 351, 120, 1, 5), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: recoverTrapTable.setStatus('mandatory')
recoverTrapEntry = MibTableRow((1, 3, 6, 1, 4, 1, 351, 120, 1, 5, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "RTM-MIB", "recoverTrapSequenceNum"))
...
mibBuilder.exportSymbols("RTM-MIB", endOfQueueFlag=endOfQueueFlag, lastSequenceNumber=lastSequenceNumber, managerIPaddress=managerIPaddress, managerNumOfValidEntries=managerNumOfValidEntries, managerPortNumber=managerPortNumber, managerRowStatus=managerRowStatus, nextTrapSeqNum=nextTrapSeqNum, readingTrapsFlag=readingTrapsFlag, recoverTrapEntry=recoverTrapEntry, recoverTrapPduString=recoverTrapPduString, recoverTrapSequenceNum=recoverTrapSequenceNum, recoverTrapTable=recoverTrapTable, rtm=rtm, trapConfigEntry=trapConfigEntry, trapConfigTable=trapConfigTable, trapManagerIPaddress=trapManagerIPaddress, trapPduString=trapPduString, trapSequenceNum=trapSequenceNum, trapUploadEntry=trapUploadEntry, trapUploadTable=trapUploadTable, trapsConfig=trapsConfig)
