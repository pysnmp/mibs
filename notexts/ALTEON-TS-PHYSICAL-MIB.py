...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, trunkGroupNewCfgState=trunkGroupNewCfgState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, vlanNewCfgDelete=vlanNewCfgDelete, mirrOperMirroredPort=mirrOperMirroredPort, stgCurCfgIndex=stgCurCfgIndex, stgCurCfgPortTable=stgCurCfgPortTable, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortNewCfgTableEntry=agPortNewCfgTableEntry, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, agPortCurCfgState=agPortCurCfgState, portStatsIndx=portStatsIndx, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, mirrOperType=mirrOperType, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, vlans=vlans, pmCurCfgTimeout=pmCurCfgTimeout, agPortCurCfgTableEntry=agPortCurCfgTableEntry, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, agPortCurCfgPrefLink=agPortCurCfgPrefLink, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, vlanNewCfgPorts=vlanNewCfgPorts, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mirrVlanMirr=mirrVlanMirr, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmCurCfgState=pmCurCfgState, agPortNewCfgPrefLink=agPortNewCfgPrefLink, vlanNewCfgVlanId=vlanNewCfgVlanId, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, portStatsTable=portStatsTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, agPortNewCfgTable=agPortNewCfgTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, pmNewCfgMirroredPort=pmNewCfgMirroredPort, agPortNewCfgState=agPortNewCfgState, stgCurCfgState=stgCurCfgState, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portCpuStats=portCpuStats, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portStatsPhyIfInOctets=portStatsPhyIfInOctets, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, vlanCurCfgPorts=vlanCurCfgPorts, agPortCurCfgTable=agPortCurCfgTable, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, trunkgroup=trunkgroup, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portInfoPhyIfMtu=portInfoPhyIfMtu, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, vlanCurCfgState=vlanCurCfgState, spannTreeGrpCfg=spannTreeGrpCfg, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, portInfoIndx=portInfoIndx, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, portInfoMode=portInfoMode, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanNewCfgStg=vlanNewCfgStg, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portInfoFlowCtrl=portInfoFlowCtrl, mirrOperMonitoringPort=mirrOperMonitoringPort, stgCurCfgPortState=stgCurCfgPortState, pmCurCfgMirroredPort=pmCurCfgMirroredPort, mirrPortMirr=mirrPortMirr, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, vlanMaxEnt=vlanMaxEnt, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, agPortNewCfgVlanTag=agPortNewCfgVlanTag, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, pmNewCfgPortMirrState=pmNewCfgPortMirrState, agPortCurCfgIndx=agPortCurCfgIndx, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portStatsPhyIfInErrors=portStatsPhyIfInErrors, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, agPortCurCfgStp=agPortCurCfgStp, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, portCpuStatsUtilTable=portCpuStatsUtilTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, agPortCurCfgBackLink=agPortCurCfgBackLink, stgNewCfgPortIndex=stgNewCfgPortIndex, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanNewCfgJumbo=vlanNewCfgJumbo, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mirrOperState=mirrOperState, agPortNewCfgBwmContract=agPortNewCfgBwmContract, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, port_info=port_info, portCpuStatsUtilIndx=portCpuStatsUtilIndx, portInfoSpeed=portInfoSpeed, portStatsTableEntry=portStatsTableEntry, agPortTableMaxEnt=agPortTableMaxEnt, agPortNewCfgIndx=agPortNewCfgIndx, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, agPortConfig=agPortConfig, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, agPortNewCfgRmon=agPortNewCfgRmon, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgCurCfgStgIndex=stgCurCfgStgIndex, agPortCurCfgPortName=agPortCurCfgPortName, vlanNewCfgAddPort=vlanNewCfgAddPort, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, portInfoTableEntry=portInfoTableEntry, port_stats=port_stats, agPortNewCfgPortName=agPortNewCfgPortName, vlanCurCfgTable=vlanCurCfgTable, portInfoPhyIfType=portInfoPhyIfType, portmirroring=portmirroring, mirroring=mirroring, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, vlanNewCfgState=vlanNewCfgState, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, agPortCurCfgRmon=agPortCurCfgRmon, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, mirrOper=mirrOper, vlanCurCfgStg=vlanCurCfgStg, portInfoLink=portInfoLink, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, trunkGroupCurCfgState=trunkGroupCurCfgState, agPortNewCfgPVID=agPortNewCfgPVID, agPortCurCfgVlanTag=agPortCurCfgVlanTag, stgCurCfgPortIndex=stgCurCfgPortIndex, agPortNewCfgStp=agPortNewCfgStp, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, stgNewCfgState=stgNewCfgState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, stgNewCfgAddVlan=stgNewCfgAddVlan, portInfoPhyIfLastChange=portInfoPhyIfLastChange, agPortNewCfgBackLink=agPortNewCfgBackLink, stgNewCfgIndex=stgNewCfgIndex, agPortCurCfgBwmContract=agPortCurCfgBwmContract, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, stgNewCfgPortTable=stgNewCfgPortTable, mirrOperTimeout=mirrOperTimeout, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanNewCfgTable=vlanNewCfgTable, stgNewCfgPortState=stgNewCfgPortState, agPortCurCfgPVID=agPortCurCfgPVID, portInfoTable=portInfoTable, stgNewCfgTable=stgNewCfgTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmNewCfgTimeout=pmNewCfgTimeout, stgCurCfgTable=stgCurCfgTable, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, pmNewCfgState=pmNewCfgState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex)
