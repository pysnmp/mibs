...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", portInfoTable=portInfoTable, agPortCurCfgPrefLink=agPortCurCfgPrefLink, vlanNewCfgVlanName=vlanNewCfgVlanName, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, agPortCurCfgPortName=agPortCurCfgPortName, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, mirrOperMirroredPort=mirrOperMirroredPort, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, pmCurCfgState=pmCurCfgState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgCurCfgIndex=stgCurCfgIndex, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, stgNewCfgPortTable=stgNewCfgPortTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, portInfoLink=portInfoLink, pmCurCfgMirroredPort=pmCurCfgMirroredPort, portInfoPhyIfDescr=portInfoPhyIfDescr, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanNewCfgState=vlanNewCfgState, agPortCurCfgState=agPortCurCfgState, vlanNewCfgDelete=vlanNewCfgDelete, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgTableEntry=stgCurCfgTableEntry, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, portInfoPhyIfMtu=portInfoPhyIfMtu, pmNewCfgMirroredPort=pmNewCfgMirroredPort, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, portStatsPhyIfInErrors=portStatsPhyIfInErrors, vlanNewCfgAddPort=vlanNewCfgAddPort, portmirroring=portmirroring, stgCurCfgTable=stgCurCfgTable, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, vlanCurCfgPorts=vlanCurCfgPorts, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, agPortNewCfgTable=agPortNewCfgTable, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgIndex=stgNewCfgIndex, portCpuStatsUtilTable=portCpuStatsUtilTable, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, agPortCurCfgIndx=agPortCurCfgIndx, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, portInfoIndx=portInfoIndx, agPortCurCfgBwmContract=agPortCurCfgBwmContract, trunkgroup=trunkgroup, stgCurCfgState=stgCurCfgState, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, pmCurCfgTimeout=pmCurCfgTimeout, agPortNewCfgPortName=agPortNewCfgPortName, port_stats=port_stats, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, port_info=port_info, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, agPortCurCfgVlanTag=agPortCurCfgVlanTag, mirroring=mirroring, vlanNewCfgPorts=vlanNewCfgPorts, portInfoPhyIfLastChange=portInfoPhyIfLastChange, agPortCurCfgTable=agPortCurCfgTable, vlanNewCfgStg=vlanNewCfgStg, vlanNewCfgTable=vlanNewCfgTable, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortCurCfgBackLink=agPortCurCfgBackLink, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgTableEntry=stgNewCfgTableEntry, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, vlanCurCfgBwmContract=vlanCurCfgBwmContract, agPortNewCfgBackLink=agPortNewCfgBackLink, portInfoTableEntry=portInfoTableEntry, agPortConfig=agPortConfig, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, agPortNewCfgIndx=agPortNewCfgIndx, portInfoSpeed=portInfoSpeed, stgCurCfgPortState=stgCurCfgPortState, vlans=vlans, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, portCpuStatsUtilIndx=portCpuStatsUtilIndx, agPortNewCfgState=agPortNewCfgState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mirrOper=mirrOper, agPortNewCfgPrefLink=agPortNewCfgPrefLink, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, agPortNewCfgPVID=agPortNewCfgPVID, agPortCurCfgStp=agPortCurCfgStp, mirrOperState=mirrOperState, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, portInfoFlowCtrl=portInfoFlowCtrl, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, trunkGroupNewCfgState=trunkGroupNewCfgState, agPortNewCfgRmon=agPortNewCfgRmon, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, agPortNewCfgTableEntry=agPortNewCfgTableEntry, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, vlanCurCfgVlanName=vlanCurCfgVlanName, portStatsIndx=portStatsIndx, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, agPortNewCfgVlanTag=agPortNewCfgVlanTag, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, mirrOperType=mirrOperType, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, portInfoPhyIfType=portInfoPhyIfType, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, pmNewCfgState=pmNewCfgState, mirrVlanMirr=mirrVlanMirr, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgPortTable=stgCurCfgPortTable, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mirrPortMirr=mirrPortMirr, agPortCurCfgPVID=agPortCurCfgPVID, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, stgNewCfgPortState=stgNewCfgPortState, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, agPortNewCfgStp=agPortNewCfgStp, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mirrOperMonitoringPort=mirrOperMonitoringPort, pmNewCfgTimeout=pmNewCfgTimeout, vlanCurCfgTable=vlanCurCfgTable, vlanCurCfgVlanId=vlanCurCfgVlanId, portStatsTable=portStatsTable, portStatsPhyIfInOctets=portStatsPhyIfInOctets, portStatsTableEntry=portStatsTableEntry, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, agPortCurCfgRmon=agPortCurCfgRmon, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mirrOperTimeout=mirrOperTimeout, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portCpuStats=portCpuStats, agPortTableMaxEnt=agPortTableMaxEnt, stgCurCfgPortIndex=stgCurCfgPortIndex, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, agPortNewCfgBwmContract=agPortNewCfgBwmContract, vlanCurCfgState=vlanCurCfgState, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, portInfoMode=portInfoMode, agPortCurCfgTableEntry=agPortCurCfgTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgAddVlan=stgNewCfgAddVlan, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, stgNewCfgStgIndex=stgNewCfgStgIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, stgNewCfgTable=stgNewCfgTable, spannTreeGrpCfg=spannTreeGrpCfg, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanMaxEnt=vlanMaxEnt, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanCurCfgStg=vlanCurCfgStg, stgNewCfgState=stgNewCfgState, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl)
