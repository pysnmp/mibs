...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", vlanNewCfgStg=vlanNewCfgStg, mirrOperType=mirrOperType, agPortNewCfgPrefLink=agPortNewCfgPrefLink, stgNewCfgTableEntry=stgNewCfgTableEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, agPortNewCfgPVID=agPortNewCfgPVID, stgNewCfgTable=stgNewCfgTable, agPortCurCfgRmon=agPortCurCfgRmon, stgCurCfgStgIndex=stgCurCfgStgIndex, portStatsPhyIfInOctets=portStatsPhyIfInOctets, portmirroring=portmirroring, agPortCurCfgIndx=agPortCurCfgIndx, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, agPortNewCfgTable=agPortNewCfgTable, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, stgNewCfgPortState=stgNewCfgPortState, pmCurCfgMirroredPort=pmCurCfgMirroredPort, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, agPortCurCfgVlanTag=agPortCurCfgVlanTag, mirrOperState=mirrOperState, pmNewCfgState=pmNewCfgState, portInfoLink=portInfoLink, vlanMaxEnt=vlanMaxEnt, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, portCpuStats=portCpuStats, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, agPortCurCfgTable=agPortCurCfgTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, agPortTableMaxEnt=agPortTableMaxEnt, vlanCurCfgStg=vlanCurCfgStg, agPortNewCfgIndx=agPortNewCfgIndx, pmNewCfgMirroredPort=pmNewCfgMirroredPort, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, agPortCurCfgPVID=agPortCurCfgPVID, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, mirroring=mirroring, agPortNewCfgStp=agPortNewCfgStp, mirrOper=mirrOper, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, portInfoFlowCtrl=portInfoFlowCtrl, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, pmCurCfgState=pmCurCfgState, port_info=port_info, spannTreeGrpCfg=spannTreeGrpCfg, trunkGroupCurCfgState=trunkGroupCurCfgState, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgTableEntry=stgCurCfgTableEntry, portStatsTableEntry=portStatsTableEntry, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortCurCfgState=agPortCurCfgState, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, vlanNewCfgVlanName=vlanNewCfgVlanName, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, agPortCurCfgBackLink=agPortCurCfgBackLink, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgState=stgNewCfgState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, agPortNewCfgBwmContract=agPortNewCfgBwmContract, portInfoTableEntry=portInfoTableEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portInfoPhyIfDescr=portInfoPhyIfDescr, portInfoSpeed=portInfoSpeed, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, vlanCurCfgJumbo=vlanCurCfgJumbo, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, port_stats=port_stats, agPortCurCfgPrefLink=agPortCurCfgPrefLink, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portStatsPhyIfInErrors=portStatsPhyIfInErrors, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, vlanCurCfgVlanId=vlanCurCfgVlanId, mirrOperMirroredPort=mirrOperMirroredPort, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, agPortNewCfgState=agPortNewCfgState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mirrPortMirr=mirrPortMirr, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, portInfoPhyIfMtu=portInfoPhyIfMtu, pmCurCfgTimeout=pmCurCfgTimeout, agPortCurCfgPortName=agPortCurCfgPortName, mirrVlanMirr=mirrVlanMirr, portStatsTable=portStatsTable, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, agPortCurCfgTableEntry=agPortCurCfgTableEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, agPortNewCfgBackLink=agPortNewCfgBackLink, stgCurCfgTable=stgCurCfgTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, stgNewCfgPortIndex=stgNewCfgPortIndex, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mirrOperTimeout=mirrOperTimeout, agPortNewCfgPortName=agPortNewCfgPortName, portInfoPhyIfType=portInfoPhyIfType, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, stgCurCfgPortTable=stgCurCfgPortTable, portStatsIndx=portStatsIndx, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portCpuStatsUtilTable=portCpuStatsUtilTable, vlanNewCfgJumbo=vlanNewCfgJumbo, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgCurCfgPortIndex=stgCurCfgPortIndex, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, agPortNewCfgTableEntry=agPortNewCfgTableEntry, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanCurCfgTable=vlanCurCfgTable, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portInfoTable=portInfoTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portCpuStatsUtilIndx=portCpuStatsUtilIndx, portInfoIndx=portInfoIndx, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, stgCurCfgPortState=stgCurCfgPortState, trunkgroup=trunkgroup, vlanNewCfgAddPort=vlanNewCfgAddPort, portInfoMode=portInfoMode, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgState=stgCurCfgState, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanNewCfgTable=vlanNewCfgTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, vlanCurCfgState=vlanCurCfgState, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanNewCfgPorts=vlanNewCfgPorts, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, stgNewCfgStgIndex=stgNewCfgStgIndex, agPortCurCfgBwmContract=agPortCurCfgBwmContract, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, stgCurCfgIndex=stgCurCfgIndex, agPortNewCfgVlanTag=agPortNewCfgVlanTag, stgNewCfgPortTable=stgNewCfgPortTable, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, vlans=vlans, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, pmNewCfgTimeout=pmNewCfgTimeout, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, vlanCurCfgPorts=vlanCurCfgPorts, agPortCurCfgStp=agPortCurCfgStp, vlanNewCfgState=vlanNewCfgState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, agPortNewCfgRmon=agPortNewCfgRmon, agPortConfig=agPortConfig, portInfoPhyIfLastChange=portInfoPhyIfLastChange, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry)
