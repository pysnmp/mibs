...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", portInfoFlowCtrl=portInfoFlowCtrl, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, agPortCurCfgBackLink=agPortCurCfgBackLink, stgNewCfgIndex=stgNewCfgIndex, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, portInfoIndx=portInfoIndx, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mirrOperState=mirrOperState, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, mirrOperTimeout=mirrOperTimeout, vlanCurCfgTableEntry=vlanCurCfgTableEntry, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portInfoPhyIfMtu=portInfoPhyIfMtu, stgNewCfgPortState=stgNewCfgPortState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, pmNewCfgMirroredPort=pmNewCfgMirroredPort, pmCurCfgTimeout=pmCurCfgTimeout, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, agPortNewCfgBackLink=agPortNewCfgBackLink, trunkGroupNewCfgTable=trunkGroupNewCfgTable, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanNewCfgStg=vlanNewCfgStg, mirrOperType=mirrOperType, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgCurCfgState=stgCurCfgState, agPortCurCfgPVID=agPortCurCfgPVID, portStatsPhyIfInErrors=portStatsPhyIfInErrors, mirrOper=mirrOper, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, pmNewCfgState=pmNewCfgState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, portInfoSpeed=portInfoSpeed, agPortCurCfgRmon=agPortCurCfgRmon, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, agPortCurCfgState=agPortCurCfgState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanMaxEnt=vlanMaxEnt, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanCurCfgPorts=vlanCurCfgPorts, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, portStatsIndx=portStatsIndx, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, agPortCurCfgIndx=agPortCurCfgIndx, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, vlans=vlans, portInfoLink=portInfoLink, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanNewCfgVlanName=vlanNewCfgVlanName, portStatsTableEntry=portStatsTableEntry, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, portInfoPhyIfDescr=portInfoPhyIfDescr, vlanCurCfgJumbo=vlanCurCfgJumbo, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, agPortNewCfgBwmContract=agPortNewCfgBwmContract, agPortTableMaxEnt=agPortTableMaxEnt, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, agPortNewCfgStp=agPortNewCfgStp, portInfoPhyIfType=portInfoPhyIfType, vlanNewCfgState=vlanNewCfgState, trunkGroupNewCfgState=trunkGroupNewCfgState, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, agPortNewCfgPVID=agPortNewCfgPVID, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, mirrPortMirr=mirrPortMirr, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, stgNewCfgStgIndex=stgNewCfgStgIndex, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, stgNewCfgState=stgNewCfgState, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, agPortCurCfgTableEntry=agPortCurCfgTableEntry, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, stgCurCfgIndex=stgCurCfgIndex, agPortCurCfgStp=agPortCurCfgStp, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, agPortNewCfgVlanTag=agPortNewCfgVlanTag, mirroring=mirroring, pmNewCfgTimeout=pmNewCfgTimeout, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgTable=stgNewCfgTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState, agPortNewCfgPrefLink=agPortNewCfgPrefLink, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, agPortConfig=agPortConfig, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, vlanCurCfgTable=vlanCurCfgTable, vlanNewCfgPorts=vlanNewCfgPorts, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, agPortNewCfgState=agPortNewCfgState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, agPortNewCfgIndx=agPortNewCfgIndx, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mirrOperMirroredPort=mirrOperMirroredPort, stgCurCfgPortState=stgCurCfgPortState, portInfoTableEntry=portInfoTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, vlanCurCfgStg=vlanCurCfgStg, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, agPortNewCfgPortName=agPortNewCfgPortName, vlanNewCfgJumbo=vlanNewCfgJumbo, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, portInfoMode=portInfoMode, vlanCurCfgVlanName=vlanCurCfgVlanName, spannTreeGrpCfg=spannTreeGrpCfg, portInfoTable=portInfoTable, agPortCurCfgVlanTag=agPortCurCfgVlanTag, vlanCurCfgState=vlanCurCfgState, vlanNewCfgVlanId=vlanNewCfgVlanId, port_info=port_info, stgNewCfgTableEntry=stgNewCfgTableEntry, portCpuStatsUtilTable=portCpuStatsUtilTable, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, mirrVlanMirr=mirrVlanMirr, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmCurCfgMirroredPort=pmCurCfgMirroredPort, agPortNewCfgTableEntry=agPortNewCfgTableEntry, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgPortTable=stgCurCfgPortTable, agPortCurCfgTable=agPortCurCfgTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portInfoPhyIfLastChange=portInfoPhyIfLastChange, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, trunkgroup=trunkgroup, portCpuStats=portCpuStats, agPortCurCfgPortName=agPortCurCfgPortName, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, portmirroring=portmirroring, port_stats=port_stats, stgNewCfgAddVlan=stgNewCfgAddVlan, portCpuStatsUtilIndx=portCpuStatsUtilIndx, agPortNewCfgTable=agPortNewCfgTable, stgNewCfgPortTable=stgNewCfgPortTable, stgCurCfgPortIndex=stgCurCfgPortIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgCurCfgTableEntry=stgCurCfgTableEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, portStatsPhyIfInOctets=portStatsPhyIfInOctets, mirrOperMonitoringPort=mirrOperMonitoringPort, stgCurCfgTable=stgCurCfgTable, pmCurCfgState=pmCurCfgState, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, agPortCurCfgPrefLink=agPortCurCfgPrefLink, agPortNewCfgRmon=agPortNewCfgRmon, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, agPortCurCfgBwmContract=agPortCurCfgBwmContract, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portStatsTable=portStatsTable, vlanNewCfgTable=vlanNewCfgTable)
