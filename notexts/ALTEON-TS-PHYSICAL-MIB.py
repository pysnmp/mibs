...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", agPortCurCfgState=agPortCurCfgState, vlanNewCfgDelete=vlanNewCfgDelete, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, mirrOperState=mirrOperState, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, vlanCurCfgTable=vlanCurCfgTable, trunkGroupCurCfgState=trunkGroupCurCfgState, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, trunkgroup=trunkgroup, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portInfoPhyIfLastChange=portInfoPhyIfLastChange, vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgStgIndex=stgNewCfgStgIndex, portStatsTableEntry=portStatsTableEntry, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, agPortNewCfgPVID=agPortNewCfgPVID, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, trunkGroupNewCfgState=trunkGroupNewCfgState, portInfoSpeed=portInfoSpeed, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgNewCfgPortState=stgNewCfgPortState, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanMaxEnt=vlanMaxEnt, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, agPortCurCfgVlanTag=agPortCurCfgVlanTag, pmCurCfgPortMirrState=pmCurCfgPortMirrState, port_stats=port_stats, portStatsPhyIfInErrors=portStatsPhyIfInErrors, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanNewCfgVlanName=vlanNewCfgVlanName, agPortNewCfgBwmContract=agPortNewCfgBwmContract, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portInfoMode=portInfoMode, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, vlanCurCfgVlanId=vlanCurCfgVlanId, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, agPortConfig=agPortConfig, vlanNewCfgTable=vlanNewCfgTable, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portStatsIndx=portStatsIndx, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, mirroring=mirroring, vlanCurCfgJumbo=vlanCurCfgJumbo, portInfoTable=portInfoTable, vlanNewCfgStg=vlanNewCfgStg, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, mirrOperTimeout=mirrOperTimeout, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, vlanNewCfgState=vlanNewCfgState, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, agPortNewCfgState=agPortNewCfgState, vlanCurCfgPorts=vlanCurCfgPorts, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, agPortCurCfgTable=agPortCurCfgTable, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, agPortNewCfgBackLink=agPortNewCfgBackLink, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, agPortNewCfgPrefLink=agPortNewCfgPrefLink, agPortCurCfgPortName=agPortCurCfgPortName, portStatsTable=portStatsTable, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, stgCurCfgIndex=stgCurCfgIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgCurCfgStgIndex=stgCurCfgStgIndex, portInfoTableEntry=portInfoTableEntry, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, agPortCurCfgIndx=agPortCurCfgIndx, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgTableEntry=stgNewCfgTableEntry, mirrVlanMirr=mirrVlanMirr, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portCpuStatsUtilIndx=portCpuStatsUtilIndx, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, portStatsPhyIfInOctets=portStatsPhyIfInOctets, agPortNewCfgPortName=agPortNewCfgPortName, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, mirrOperMirroredPort=mirrOperMirroredPort, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, portInfoPhyIfType=portInfoPhyIfType, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmCurCfgTimeout=pmCurCfgTimeout, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, agPortCurCfgRmon=agPortCurCfgRmon, stgNewCfgPortTable=stgNewCfgPortTable, vlanCurCfgState=vlanCurCfgState, port_info=port_info, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, agPortNewCfgTable=agPortNewCfgTable, pmCurCfgState=pmCurCfgState, pmNewCfgMirroredPort=pmNewCfgMirroredPort, agPortCurCfgTableEntry=agPortCurCfgTableEntry, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, portmirroring=portmirroring, agPortNewCfgTableEntry=agPortNewCfgTableEntry, vlanCurCfgStg=vlanCurCfgStg, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmNewCfgPortMirrState=pmNewCfgPortMirrState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mirrOper=mirrOper, agPortCurCfgBackLink=agPortCurCfgBackLink, vlans=vlans, agPortNewCfgStp=agPortNewCfgStp, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, stgCurCfgTableEntry=stgCurCfgTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, agPortCurCfgPrefLink=agPortCurCfgPrefLink, agPortNewCfgRmon=agPortNewCfgRmon, stgCurCfgTable=stgCurCfgTable, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, agPortCurCfgBwmContract=agPortCurCfgBwmContract, portInfoPhyIfMtu=portInfoPhyIfMtu, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portInfoIndx=portInfoIndx, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, portInfoPhyIfDescr=portInfoPhyIfDescr, mirrOperMonitoringPort=mirrOperMonitoringPort, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, vlanNewCfgAddPort=vlanNewCfgAddPort, portInfoLink=portInfoLink, stgCurCfgPortState=stgCurCfgPortState, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, agPortNewCfgIndx=agPortNewCfgIndx, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portInfoFlowCtrl=portInfoFlowCtrl, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, stgNewCfgTable=stgNewCfgTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, portCpuStats=portCpuStats, stgNewCfgState=stgNewCfgState, mirrPortMirr=mirrPortMirr, agPortNewCfgVlanTag=agPortNewCfgVlanTag, pmNewCfgState=pmNewCfgState, pmNewCfgTimeout=pmNewCfgTimeout, pmCurCfgMirroredPort=pmCurCfgMirroredPort, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mirrOperType=mirrOperType, agPortCurCfgPVID=agPortCurCfgPVID, spannTreeGrpCfg=spannTreeGrpCfg, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, stgNewCfgAddVlan=stgNewCfgAddVlan, stgCurCfgPortTable=stgCurCfgPortTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, stgNewCfgIndex=stgNewCfgIndex, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, agPortCurCfgStp=agPortCurCfgStp, vlanNewCfgJumbo=vlanNewCfgJumbo, stgCurCfgState=stgCurCfgState, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, agPortTableMaxEnt=agPortTableMaxEnt, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portCpuStatsUtilTable=portCpuStatsUtilTable, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract)
