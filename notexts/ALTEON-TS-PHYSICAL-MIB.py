...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", stgCurCfgStgIndex=stgCurCfgStgIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanNewCfgStg=vlanNewCfgStg, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, pmCurCfgState=pmCurCfgState, agPortTableMaxEnt=agPortTableMaxEnt, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, pmCurCfgMirroredPort=pmCurCfgMirroredPort, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, stgNewCfgPortIndex=stgNewCfgPortIndex, portCpuStatsUtilIndx=portCpuStatsUtilIndx, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgTable=stgNewCfgTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, agPortCurCfgRmon=agPortCurCfgRmon, stgNewCfgAddVlan=stgNewCfgAddVlan, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mirrOperType=mirrOperType, agPortNewCfgPrefLink=agPortNewCfgPrefLink, agPortNewCfgBwmContract=agPortNewCfgBwmContract, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mirroring=mirroring, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, agPortNewCfgTableEntry=agPortNewCfgTableEntry, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, agPortNewCfgStp=agPortNewCfgStp, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanNewCfgTable=vlanNewCfgTable, portInfoSpeed=portInfoSpeed, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, port_stats=port_stats, agPortCurCfgStp=agPortCurCfgStp, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, portInfoMode=portInfoMode, stgNewCfgState=stgNewCfgState, agPortCurCfgPVID=agPortCurCfgPVID, agPortCurCfgTableEntry=agPortCurCfgTableEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portInfoIndx=portInfoIndx, agPortNewCfgPortName=agPortNewCfgPortName, trunkGroupCurCfgState=trunkGroupCurCfgState, agPortCurCfgTable=agPortCurCfgTable, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanNewCfgState=vlanNewCfgState, agPortCurCfgIndx=agPortCurCfgIndx, stgNewCfgPortState=stgNewCfgPortState, agPortNewCfgRmon=agPortNewCfgRmon, agPortCurCfgBackLink=agPortCurCfgBackLink, portCpuStats=portCpuStats, portInfoFlowCtrl=portInfoFlowCtrl, portInfoPhyIfType=portInfoPhyIfType, vlanNewCfgVlanId=vlanNewCfgVlanId, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, pmNewCfgMirroredPort=pmNewCfgMirroredPort, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, mirrOper=mirrOper, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, mirrOperMirroredPort=mirrOperMirroredPort, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, stgCurCfgIndex=stgCurCfgIndex, agPortCurCfgPortName=agPortCurCfgPortName, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, portStatsTableEntry=portStatsTableEntry, stgCurCfgTable=stgCurCfgTable, stgNewCfgStgIndex=stgNewCfgStgIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgPortIndex=stgCurCfgPortIndex, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, vlanMaxEnt=vlanMaxEnt, vlanCurCfgVlanId=vlanCurCfgVlanId, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portStatsTable=portStatsTable, vlans=vlans, stgCurCfgPortState=stgCurCfgPortState, agPortCurCfgPrefLink=agPortCurCfgPrefLink, vlanNewCfgPorts=vlanNewCfgPorts, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, vlanCurCfgState=vlanCurCfgState, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portStatsPhyIfInOctets=portStatsPhyIfInOctets, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, trunkGroupNewCfgState=trunkGroupNewCfgState, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, agPortNewCfgVlanTag=agPortNewCfgVlanTag, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, portStatsPhyIfInErrors=portStatsPhyIfInErrors, agPortCurCfgBwmContract=agPortCurCfgBwmContract, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mirrOperState=mirrOperState, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, stgNewCfgPortTable=stgNewCfgPortTable, mirrOperTimeout=mirrOperTimeout, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, vlanCurCfgTable=vlanCurCfgTable, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, portInfoPhyIfMtu=portInfoPhyIfMtu, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, agPortNewCfgIndx=agPortNewCfgIndx, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgIndex=stgNewCfgIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portStatsIndx=portStatsIndx, mirrOperMonitoringPort=mirrOperMonitoringPort, portmirroring=portmirroring, agPortNewCfgBackLink=agPortNewCfgBackLink, vlanNewCfgJumbo=vlanNewCfgJumbo, agPortNewCfgState=agPortNewCfgState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, agPortCurCfgState=agPortCurCfgState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, spannTreeGrpCfg=spannTreeGrpCfg, mirrPortMirr=mirrPortMirr, portCpuStatsUtilTable=portCpuStatsUtilTable, agPortCurCfgVlanTag=agPortCurCfgVlanTag, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, port_info=port_info, portInfoLink=portInfoLink, pmNewCfgState=pmNewCfgState, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgCurCfgPortTable=stgCurCfgPortTable, mirrVlanMirr=mirrVlanMirr, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portInfoPhyIfLastChange=portInfoPhyIfLastChange, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, agPortConfig=agPortConfig, stgCurCfgState=stgCurCfgState, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, agPortNewCfgTable=agPortNewCfgTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, portInfoTable=portInfoTable, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, pmNewCfgTimeout=pmNewCfgTimeout, agPortNewCfgPVID=agPortNewCfgPVID, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgTableEntry=stgNewCfgTableEntry, pmCurCfgTimeout=pmCurCfgTimeout, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, portInfoTableEntry=portInfoTableEntry, vlanCurCfgStg=vlanCurCfgStg, stgCurCfgTableEntry=stgCurCfgTableEntry, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, trunkgroup=trunkgroup, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts)
