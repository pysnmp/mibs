...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, port_info=port_info, stgCurCfgTable=stgCurCfgTable, trunkGroupNewCfgTable=trunkGroupNewCfgTable, agPortCurCfgTableEntry=agPortCurCfgTableEntry, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, portInfoLink=portInfoLink, vlanCurCfgBwmContract=vlanCurCfgBwmContract, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, pmNewCfgState=pmNewCfgState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, portCpuStatsUtilTable=portCpuStatsUtilTable, agPortNewCfgTableEntry=agPortNewCfgTableEntry, portStatsPhyIfInOctets=portStatsPhyIfInOctets, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgCurCfgPortState=stgCurCfgPortState, portInfoTable=portInfoTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanCurCfgTable=vlanCurCfgTable, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, agPortNewCfgTable=agPortNewCfgTable, portInfoPhyIfDescr=portInfoPhyIfDescr, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, portInfoPhyIfType=portInfoPhyIfType, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmNewCfgMirroredPort=pmNewCfgMirroredPort, trunkgroup=trunkgroup, portInfoIndx=portInfoIndx, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, vlanNewCfgJumbo=vlanNewCfgJumbo, pmCurCfgMirroredPort=pmCurCfgMirroredPort, vlans=vlans, agPortCurCfgRmon=agPortCurCfgRmon, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, stgNewCfgPortTable=stgNewCfgPortTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, portStatsTableEntry=portStatsTableEntry, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, mirrPortMirr=mirrPortMirr, agPortConfig=agPortConfig, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, portInfoPhyIfMtu=portInfoPhyIfMtu, stgCurCfgIndex=stgCurCfgIndex, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, portmirroring=portmirroring, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, portInfoFlowCtrl=portInfoFlowCtrl, stgCurCfgState=stgCurCfgState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgNewCfgPortState=stgNewCfgPortState, agPortNewCfgPortName=agPortNewCfgPortName, agPortNewCfgRmon=agPortNewCfgRmon, stgNewCfgTable=stgNewCfgTable, vlanNewCfgVlanName=vlanNewCfgVlanName, spannTreeGrpCfg=spannTreeGrpCfg, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, portInfoSpeed=portInfoSpeed, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, portStatsIndx=portStatsIndx, pmCurCfgState=pmCurCfgState, portInfoTableEntry=portInfoTableEntry, stgNewCfgIndex=stgNewCfgIndex, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanCurCfgVlanName=vlanCurCfgVlanName, agPortNewCfgVlanTag=agPortNewCfgVlanTag, agPortNewCfgStp=agPortNewCfgStp, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, vlanNewCfgTable=vlanNewCfgTable, agPortCurCfgTable=agPortCurCfgTable, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, portInfoPhyIfLastChange=portInfoPhyIfLastChange, mirrOperMirroredPort=mirrOperMirroredPort, portStatsTable=portStatsTable, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, vlanCurCfgPorts=vlanCurCfgPorts, mirrOperType=mirrOperType, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, agPortTableMaxEnt=agPortTableMaxEnt, stgNewCfgPortIndex=stgNewCfgPortIndex, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, mirrOper=mirrOper, trunkGroupCurCfgState=trunkGroupCurCfgState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, agPortCurCfgState=agPortCurCfgState, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, vlanCurCfgJumbo=vlanCurCfgJumbo, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, portInfoMode=portInfoMode, mirrVlanMirr=mirrVlanMirr, portCpuStats=portCpuStats, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortCurCfgStp=agPortCurCfgStp, vlanNewCfgPorts=vlanNewCfgPorts, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, agPortNewCfgIndx=agPortNewCfgIndx, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgState=stgNewCfgState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, agPortNewCfgPrefLink=agPortNewCfgPrefLink, agPortCurCfgVlanTag=agPortCurCfgVlanTag, port_stats=port_stats, vlanCurCfgStg=vlanCurCfgStg, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, agPortCurCfgBackLink=agPortCurCfgBackLink, agPortCurCfgBwmContract=agPortCurCfgBwmContract, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, mirroring=mirroring, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, pmCurCfgTimeout=pmCurCfgTimeout, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanCurCfgState=vlanCurCfgState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortNewCfgState=agPortNewCfgState, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, agPortNewCfgBwmContract=agPortNewCfgBwmContract, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, vlanNewCfgVlanId=vlanNewCfgVlanId, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanNewCfgDelete=vlanNewCfgDelete, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, agPortCurCfgIndx=agPortCurCfgIndx, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, mirrOperTimeout=mirrOperTimeout, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, agPortCurCfgPVID=agPortCurCfgPVID, agPortCurCfgPortName=agPortCurCfgPortName, pmNewCfgTimeout=pmNewCfgTimeout, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, agPortNewCfgPVID=agPortNewCfgPVID, portStatsPhyIfInErrors=portStatsPhyIfInErrors, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portCpuStatsUtilIndx=portCpuStatsUtilIndx, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgStgIndex=stgNewCfgStgIndex, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, agPortCurCfgPrefLink=agPortCurCfgPrefLink, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanNewCfgState=vlanNewCfgState, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, agPortNewCfgBackLink=agPortNewCfgBackLink, vlanMaxEnt=vlanMaxEnt, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, mirrOperState=mirrOperState, stgCurCfgPortTable=stgCurCfgPortTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgCurCfgPortIndex=stgCurCfgPortIndex, stgCurCfgStgIndex=stgCurCfgStgIndex)
