...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, vlanCurCfgStg=vlanCurCfgStg, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, agPortNewCfgVlanTag=agPortNewCfgVlanTag, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, vlanNewCfgVlanName=vlanNewCfgVlanName, mirrOperTimeout=mirrOperTimeout, portStatsTable=portStatsTable, agPortCurCfgVlanTag=agPortCurCfgVlanTag, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgCurCfgIndex=stgCurCfgIndex, portStatsIndx=portStatsIndx, vlanNewCfgBwmContract=vlanNewCfgBwmContract, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portInfoTable=portInfoTable, stgNewCfgTable=stgNewCfgTable, vlanCurCfgState=vlanCurCfgState, vlanCurCfgVlanName=vlanCurCfgVlanName, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, agPortCurCfgRmon=agPortCurCfgRmon, portInfoFlowCtrl=portInfoFlowCtrl, portStatsPhyIfInOctets=portStatsPhyIfInOctets, portInfoSpeed=portInfoSpeed, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, stgCurCfgState=stgCurCfgState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgPortTable=stgNewCfgPortTable, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mirrVlanMirr=mirrVlanMirr, portCpuStatsUtilTable=portCpuStatsUtilTable, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, pmCurCfgMirroredPort=pmCurCfgMirroredPort, mirrPortMirr=mirrPortMirr, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanCurCfgPorts=vlanCurCfgPorts, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, pmNewCfgMirroredPort=pmNewCfgMirroredPort, stgCurCfgStgIndex=stgCurCfgStgIndex, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanNewCfgAddPort=vlanNewCfgAddPort, port_info=port_info, agPortNewCfgPrefLink=agPortNewCfgPrefLink, mirrOper=mirrOper, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgTable=stgCurCfgTable, portStatsTableEntry=portStatsTableEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portInfoTableEntry=portInfoTableEntry, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, agPortTableMaxEnt=agPortTableMaxEnt, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, pmCurCfgTimeout=pmCurCfgTimeout, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgStgIndex=stgNewCfgStgIndex, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, agPortCurCfgStp=agPortCurCfgStp, agPortNewCfgBwmContract=agPortNewCfgBwmContract, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, vlanNewCfgJumbo=vlanNewCfgJumbo, portInfoPhyIfType=portInfoPhyIfType, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, portInfoIndx=portInfoIndx, agPortCurCfgPVID=agPortCurCfgPVID, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, mirrOperState=mirrOperState, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, trunkgroup=trunkgroup, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, agPortNewCfgState=agPortNewCfgState, trunkGroupCurCfgState=trunkGroupCurCfgState, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, agPortNewCfgIndx=agPortNewCfgIndx, agPortNewCfgPortName=agPortNewCfgPortName, stgCurCfgPortState=stgCurCfgPortState, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, vlanNewCfgTable=vlanNewCfgTable, portInfoMode=portInfoMode, stgNewCfgIndex=stgNewCfgIndex, port_stats=port_stats, agPortNewCfgPVID=agPortNewCfgPVID, agPortNewCfgTable=agPortNewCfgTable, agPortNewCfgRmon=agPortNewCfgRmon, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, portInfoPhyIfDescr=portInfoPhyIfDescr, stgCurCfgPortIndex=stgCurCfgPortIndex, mirrOperMirroredPort=mirrOperMirroredPort, portInfoPhyIfMtu=portInfoPhyIfMtu, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, vlanCurCfgTable=vlanCurCfgTable, stgNewCfgState=stgNewCfgState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, portInfoPhyIfLastChange=portInfoPhyIfLastChange, agPortCurCfgState=agPortCurCfgState, pmCurCfgState=pmCurCfgState, vlanMaxEnt=vlanMaxEnt, stgCurCfgPortTable=stgCurCfgPortTable, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, spannTreeGrpCfg=spannTreeGrpCfg, mirroring=mirroring, portInfoLink=portInfoLink, pmNewCfgPortMirrState=pmNewCfgPortMirrState, agPortNewCfgStp=agPortNewCfgStp, trunkGroupNewCfgTable=trunkGroupNewCfgTable, agPortCurCfgBackLink=agPortCurCfgBackLink, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, agPortCurCfgPortName=agPortCurCfgPortName, agPortCurCfgBwmContract=agPortCurCfgBwmContract, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, portStatsPhyIfInErrors=portStatsPhyIfInErrors, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, portCpuStatsUtilIndx=portCpuStatsUtilIndx, trunkGroupTableMaxSize=trunkGroupTableMaxSize, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, agPortCurCfgPrefLink=agPortCurCfgPrefLink, agPortNewCfgBackLink=agPortNewCfgBackLink, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, pmNewCfgTimeout=pmNewCfgTimeout, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mirrOperType=mirrOperType, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmNewCfgState=pmNewCfgState, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, agPortCurCfgTableEntry=agPortCurCfgTableEntry, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, portmirroring=portmirroring, vlanNewCfgState=vlanNewCfgState, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, agPortCurCfgTable=agPortCurCfgTable, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlans=vlans, agPortCurCfgIndx=agPortCurCfgIndx, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgPortState=stgNewCfgPortState, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, vlanNewCfgDelete=vlanNewCfgDelete, vlanNewCfgStg=vlanNewCfgStg, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, agPortConfig=agPortConfig, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, agPortNewCfgTableEntry=agPortNewCfgTableEntry, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portCpuStats=portCpuStats)
