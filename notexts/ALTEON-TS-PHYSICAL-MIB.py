...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", agPortNewCfgBackLink=agPortNewCfgBackLink, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, agPortCurCfgPVID=agPortCurCfgPVID, vlanCurCfgJumbo=vlanCurCfgJumbo, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanNewCfgTable=vlanNewCfgTable, agPortCurCfgVlanTag=agPortCurCfgVlanTag, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, agPortNewCfgBwmContract=agPortNewCfgBwmContract, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portCpuStats=portCpuStats, agPortNewCfgTable=agPortNewCfgTable, portmirroring=portmirroring, stgNewCfgAddVlan=stgNewCfgAddVlan, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, agPortCurCfgIndx=agPortCurCfgIndx, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, vlanMaxEnt=vlanMaxEnt, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, agPortNewCfgPortName=agPortNewCfgPortName, stgCurCfgIndex=stgCurCfgIndex, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portInfoLink=portInfoLink, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, mirrOperTimeout=mirrOperTimeout, vlanCurCfgTable=vlanCurCfgTable, portStatsPhyIfInOctets=portStatsPhyIfInOctets, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, portInfoPhyIfLastChange=portInfoPhyIfLastChange, agPortNewCfgTableEntry=agPortNewCfgTableEntry, portInfoMode=portInfoMode, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mirrOper=mirrOper, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, agPortNewCfgIndx=agPortNewCfgIndx, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, portInfoTable=portInfoTable, agPortNewCfgPVID=agPortNewCfgPVID, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgNewCfgTable=stgNewCfgTable, stgNewCfgPortTable=stgNewCfgPortTable, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, portInfoPhyIfType=portInfoPhyIfType, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmNewCfgTimeout=pmNewCfgTimeout, mirrVlanMirr=mirrVlanMirr, stgCurCfgTable=stgCurCfgTable, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, agPortCurCfgTable=agPortCurCfgTable, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, pmCurCfgState=pmCurCfgState, portStatsTable=portStatsTable, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, stgCurCfgPortIndex=stgCurCfgPortIndex, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, vlanNewCfgJumbo=vlanNewCfgJumbo, stgNewCfgStgIndex=stgNewCfgStgIndex, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgCurCfgPortTable=stgCurCfgPortTable, agPortCurCfgPrefLink=agPortCurCfgPrefLink, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portStatsPhyIfInErrors=portStatsPhyIfInErrors, vlanNewCfgStg=vlanNewCfgStg, agPortNewCfgRmon=agPortNewCfgRmon, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanNewCfgPorts=vlanNewCfgPorts, pmCurCfgMirroredPort=pmCurCfgMirroredPort, vlanCurCfgTableEntry=vlanCurCfgTableEntry, agPortNewCfgVlanTag=agPortNewCfgVlanTag, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, portStatsIndx=portStatsIndx, agPortTableMaxEnt=agPortTableMaxEnt, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, agPortCurCfgStp=agPortCurCfgStp, vlanNewCfgDelete=vlanNewCfgDelete, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, mirrOperMonitoringPort=mirrOperMonitoringPort, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, pmNewCfgMirroredPort=pmNewCfgMirroredPort, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgPortState=stgNewCfgPortState, portCpuStatsUtilTable=portCpuStatsUtilTable, agPortConfig=agPortConfig, stgCurCfgState=stgCurCfgState, portInfoPhyIfDescr=portInfoPhyIfDescr, mirrOperState=mirrOperState, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, stgCurCfgTableEntry=stgCurCfgTableEntry, portInfoPhyIfMtu=portInfoPhyIfMtu, mirroring=mirroring, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, stgNewCfgState=stgNewCfgState, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, port_info=port_info, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, mirrPortMirr=mirrPortMirr, agPortCurCfgBwmContract=agPortCurCfgBwmContract, spannTreeGrpCfg=spannTreeGrpCfg, vlans=vlans, agPortCurCfgPortName=agPortCurCfgPortName, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmCurCfgTimeout=pmCurCfgTimeout, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, stgCurCfgPortState=stgCurCfgPortState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, portInfoFlowCtrl=portInfoFlowCtrl, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanCurCfgVlanName=vlanCurCfgVlanName, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, stgNewCfgIndex=stgNewCfgIndex, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, mirrOperMirroredPort=mirrOperMirroredPort, agPortNewCfgStp=agPortNewCfgStp, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portInfoTableEntry=portInfoTableEntry, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portInfoIndx=portInfoIndx, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanCurCfgVlanId=vlanCurCfgVlanId, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, portInfoSpeed=portInfoSpeed, port_stats=port_stats, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mirrOperType=mirrOperType, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, agPortNewCfgPrefLink=agPortNewCfgPrefLink, agPortCurCfgBackLink=agPortCurCfgBackLink, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, trunkGroupNewCfgState=trunkGroupNewCfgState, trunkgroup=trunkgroup, vlanNewCfgState=vlanNewCfgState, pmNewCfgState=pmNewCfgState, portStatsTableEntry=portStatsTableEntry, agPortCurCfgRmon=agPortCurCfgRmon, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, portCpuStatsUtilIndx=portCpuStatsUtilIndx, agPortNewCfgState=agPortNewCfgState, vlanCurCfgState=vlanCurCfgState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, agPortCurCfgState=agPortCurCfgState, agPortCurCfgTableEntry=agPortCurCfgTableEntry, stgCurCfgStgIndex=stgCurCfgStgIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards)
