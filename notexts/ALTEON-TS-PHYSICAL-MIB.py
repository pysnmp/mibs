...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", stgCurCfgPortIndex=stgCurCfgPortIndex, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanNewCfgPorts=vlanNewCfgPorts, agPortCurCfgBackLink=agPortCurCfgBackLink, vlanNewCfgBwmContract=vlanNewCfgBwmContract, agPortTableMaxEnt=agPortTableMaxEnt, agPortNewCfgIndx=agPortNewCfgIndx, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmCurCfgTimeout=pmCurCfgTimeout, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mirrOper=mirrOper, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portStatsIndx=portStatsIndx, stgNewCfgPortTable=stgNewCfgPortTable, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, stgNewCfgStgIndex=stgNewCfgStgIndex, spannTreeGrpCfg=spannTreeGrpCfg, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, agPortNewCfgBwmContract=agPortNewCfgBwmContract, portInfoTableEntry=portInfoTableEntry, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portInfoLink=portInfoLink, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, pmNewCfgMirroredPort=pmNewCfgMirroredPort, mirroring=mirroring, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, portStatsPhyIfInErrors=portStatsPhyIfInErrors, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, agPortNewCfgTable=agPortNewCfgTable, vlanCurCfgStg=vlanCurCfgStg, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, agPortCurCfgIndx=agPortCurCfgIndx, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, mirrOperMirroredPort=mirrOperMirroredPort, stgCurCfgPortTable=stgCurCfgPortTable, stgCurCfgPortState=stgCurCfgPortState, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, stgCurCfgIndex=stgCurCfgIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, vlanCurCfgTable=vlanCurCfgTable, vlanCurCfgVlanId=vlanCurCfgVlanId, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, agPortConfig=agPortConfig, portCpuStatsUtilIndx=portCpuStatsUtilIndx, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, pmNewCfgTimeout=pmNewCfgTimeout, portmirroring=portmirroring, agPortCurCfgStp=agPortCurCfgStp, vlanNewCfgTable=vlanNewCfgTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgNewCfgTable=stgNewCfgTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, portInfoIndx=portInfoIndx, portInfoPhyIfType=portInfoPhyIfType, mirrOperMonitoringPort=mirrOperMonitoringPort, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portInfoFlowCtrl=portInfoFlowCtrl, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgState=stgNewCfgState, agPortCurCfgPortName=agPortCurCfgPortName, agPortCurCfgPrefLink=agPortCurCfgPrefLink, mirrOperState=mirrOperState, agPortNewCfgRmon=agPortNewCfgRmon, vlanNewCfgVlanId=vlanNewCfgVlanId, pmCurCfgPortMirrState=pmCurCfgPortMirrState, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, agPortCurCfgRmon=agPortCurCfgRmon, stgCurCfgTableEntry=stgCurCfgTableEntry, portInfoPhyIfLastChange=portInfoPhyIfLastChange, portInfoTable=portInfoTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanNewCfgState=vlanNewCfgState, vlanNewCfgDelete=vlanNewCfgDelete, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, vlanNewCfgAddPort=vlanNewCfgAddPort, portInfoPhyIfMtu=portInfoPhyIfMtu, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, mirrVlanMirr=mirrVlanMirr, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, portInfoMode=portInfoMode, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, agPortCurCfgTableEntry=agPortCurCfgTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanNewCfgStg=vlanNewCfgStg, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mirrOperTimeout=mirrOperTimeout, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, trunkGroupCurCfgState=trunkGroupCurCfgState, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, pmNewCfgState=pmNewCfgState, portCpuStats=portCpuStats, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, stgNewCfgIndex=stgNewCfgIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanCurCfgVlanName=vlanCurCfgVlanName, portCpuStatsUtilTable=portCpuStatsUtilTable, mirrPortMirr=mirrPortMirr, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, port_info=port_info, agPortCurCfgVlanTag=agPortCurCfgVlanTag, portStatsPhyIfInOctets=portStatsPhyIfInOctets, vlanCurCfgPorts=vlanCurCfgPorts, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, agPortNewCfgPVID=agPortNewCfgPVID, stgCurCfgTable=stgCurCfgTable, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, trunkGroupNewCfgState=trunkGroupNewCfgState, agPortNewCfgPortName=agPortNewCfgPortName, agPortNewCfgTableEntry=agPortNewCfgTableEntry, pmCurCfgMirroredPort=pmCurCfgMirroredPort, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, portInfoPhyIfDescr=portInfoPhyIfDescr, vlanMaxEnt=vlanMaxEnt, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, agPortNewCfgBackLink=agPortNewCfgBackLink, vlanNewCfgJumbo=vlanNewCfgJumbo, stgNewCfgPortState=stgNewCfgPortState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, portStatsTable=portStatsTable, agPortCurCfgTable=agPortCurCfgTable, vlanCurCfgState=vlanCurCfgState, agPortCurCfgState=agPortCurCfgState, stgNewCfgAddVlan=stgNewCfgAddVlan, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, stgCurCfgStgIndex=stgCurCfgStgIndex, trunkgroup=trunkgroup, agPortNewCfgStp=agPortNewCfgStp, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, port_stats=port_stats, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, trunkGroupTableMaxSize=trunkGroupTableMaxSize, agPortNewCfgVlanTag=agPortNewCfgVlanTag, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, agPortNewCfgState=agPortNewCfgState, agPortCurCfgPVID=agPortCurCfgPVID, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, pmCurCfgState=pmCurCfgState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portStatsTableEntry=portStatsTableEntry, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, agPortNewCfgPrefLink=agPortNewCfgPrefLink, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgCurCfgState=stgCurCfgState, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, mirrOperType=mirrOperType, portInfoSpeed=portInfoSpeed, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, stgNewCfgTableEntry=stgNewCfgTableEntry, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, vlanCurCfgJumbo=vlanCurCfgJumbo, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, agPortCurCfgBwmContract=agPortCurCfgBwmContract, vlans=vlans)
