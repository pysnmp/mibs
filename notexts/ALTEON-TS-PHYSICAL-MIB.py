...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", vlanCurCfgTable=vlanCurCfgTable, stgNewCfgState=stgNewCfgState, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, agPortCurCfgPVID=agPortCurCfgPVID, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmCurCfgTimeout=pmCurCfgTimeout, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portInfoPhyIfMtu=portInfoPhyIfMtu, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, agPortNewCfgRmon=agPortNewCfgRmon, stgCurCfgTableEntry=stgCurCfgTableEntry, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, agPortCurCfgIndx=agPortCurCfgIndx, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, portCpuStats=portCpuStats, agPortCurCfgBwmContract=agPortCurCfgBwmContract, stgCurCfgStgIndex=stgCurCfgStgIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, agPortCurCfgVlanTag=agPortCurCfgVlanTag, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgTable=stgNewCfgTable, portInfoFlowCtrl=portInfoFlowCtrl, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, vlanNewCfgBwmContract=vlanNewCfgBwmContract, port_info=port_info, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, agPortCurCfgStp=agPortCurCfgStp, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgPortState=stgNewCfgPortState, portCpuStatsUtilTable=portCpuStatsUtilTable, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, vlans=vlans, agPortCurCfgRmon=agPortCurCfgRmon, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgCurCfgIndex=stgCurCfgIndex, portInfoSpeed=portInfoSpeed, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, mirroring=mirroring, portmirroring=portmirroring, agPortTableMaxEnt=agPortTableMaxEnt, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portInfoPhyIfType=portInfoPhyIfType, portInfoPhyIfLastChange=portInfoPhyIfLastChange, mirrOperTimeout=mirrOperTimeout, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, trunkgroup=trunkgroup, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, portInfoTable=portInfoTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, mirrOperMonitoringPort=mirrOperMonitoringPort, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, port_stats=port_stats, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, pmCurCfgMirroredPort=pmCurCfgMirroredPort, portInfoMode=portInfoMode, agPortNewCfgVlanTag=agPortNewCfgVlanTag, agPortCurCfgPortName=agPortCurCfgPortName, agPortNewCfgIndx=agPortNewCfgIndx, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, vlanCurCfgVlanId=vlanCurCfgVlanId, agPortNewCfgState=agPortNewCfgState, agPortCurCfgBackLink=agPortCurCfgBackLink, portInfoLink=portInfoLink, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, spannTreeGrpCfg=spannTreeGrpCfg, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, vlanNewCfgState=vlanNewCfgState, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, mirrOperType=mirrOperType, mirrPortMirr=mirrPortMirr, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgPortTable=stgNewCfgPortTable, portStatsIndx=portStatsIndx, agPortCurCfgTable=agPortCurCfgTable, agPortNewCfgTable=agPortNewCfgTable, pmNewCfgState=pmNewCfgState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgNewCfgIndex=stgNewCfgIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, mirrOperState=mirrOperState, vlanNewCfgTable=vlanNewCfgTable, vlanCurCfgJumbo=vlanCurCfgJumbo, mirrOper=mirrOper, agPortNewCfgBackLink=agPortNewCfgBackLink, pmNewCfgTimeout=pmNewCfgTimeout, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, pmNewCfgMirroredPort=pmNewCfgMirroredPort, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, portStatsPhyIfInErrors=portStatsPhyIfInErrors, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, vlanCurCfgStg=vlanCurCfgStg, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanCurCfgPorts=vlanCurCfgPorts, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, trunkGroupNewCfgState=trunkGroupNewCfgState, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portCpuStatsUtilIndx=portCpuStatsUtilIndx, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, agPortConfig=agPortConfig, vlanMaxEnt=vlanMaxEnt, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, stgNewCfgPortIndex=stgNewCfgPortIndex, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, trunkGroupCurCfgState=trunkGroupCurCfgState, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, agPortCurCfgState=agPortCurCfgState, vlanCurCfgState=vlanCurCfgState, agPortNewCfgBwmContract=agPortNewCfgBwmContract, vlanNewCfgVlanId=vlanNewCfgVlanId, portStatsTableEntry=portStatsTableEntry, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, vlanCurCfgVlanName=vlanCurCfgVlanName, mirrVlanMirr=mirrVlanMirr, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mirrOperMirroredPort=mirrOperMirroredPort, agPortNewCfgPVID=agPortNewCfgPVID, portStatsPhyIfInOctets=portStatsPhyIfInOctets, agPortNewCfgPortName=agPortNewCfgPortName, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanNewCfgRemovePort=vlanNewCfgRemovePort, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, agPortNewCfgPrefLink=agPortNewCfgPrefLink, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, stgCurCfgPortState=stgCurCfgPortState, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, portInfoIndx=portInfoIndx, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, stgCurCfgPortTable=stgCurCfgPortTable, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmCurCfgState=pmCurCfgState, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, agPortNewCfgTableEntry=agPortNewCfgTableEntry, agPortCurCfgPrefLink=agPortCurCfgPrefLink, agPortNewCfgStp=agPortNewCfgStp, stgCurCfgTable=stgCurCfgTable, portInfoTableEntry=portInfoTableEntry, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, stgCurCfgState=stgCurCfgState, vlanNewCfgPorts=vlanNewCfgPorts, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, agPortCurCfgTableEntry=agPortCurCfgTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portStatsTable=portStatsTable)
