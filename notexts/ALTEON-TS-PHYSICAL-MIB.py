...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, portStatsIndx=portStatsIndx, agPortCurCfgVlanTag=agPortCurCfgVlanTag, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, agPortNewCfgStp=agPortNewCfgStp, stgNewCfgPortState=stgNewCfgPortState, agPortNewCfgPrefLink=agPortNewCfgPrefLink, agPortNewCfgPortName=agPortNewCfgPortName, stgNewCfgStgIndex=stgNewCfgStgIndex, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, pmCurCfgState=pmCurCfgState, portInfoPhyIfDescr=portInfoPhyIfDescr, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, vlanCurCfgTable=vlanCurCfgTable, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanNewCfgTable=vlanNewCfgTable, agPortCurCfgPortName=agPortCurCfgPortName, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanNewCfgDelete=vlanNewCfgDelete, agPortNewCfgState=agPortNewCfgState, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portStatsTable=portStatsTable, stgNewCfgAddVlan=stgNewCfgAddVlan, agPortCurCfgBwmContract=agPortCurCfgBwmContract, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, portInfoFlowCtrl=portInfoFlowCtrl, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, mirrOperState=mirrOperState, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, trunkGroupCurCfgState=trunkGroupCurCfgState, agPortNewCfgBwmContract=agPortNewCfgBwmContract, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, agPortNewCfgTable=agPortNewCfgTable, vlanCurCfgVlanName=vlanCurCfgVlanName, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, portInfoTable=portInfoTable, pmNewCfgTimeout=pmNewCfgTimeout, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, pmNewCfgState=pmNewCfgState, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, pmCurCfgMirroredPort=pmCurCfgMirroredPort, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanNewCfgVlanName=vlanNewCfgVlanName, agPortCurCfgState=agPortCurCfgState, vlans=vlans, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mirrOperMirroredPort=mirrOperMirroredPort, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mirrOper=mirrOper, agPortCurCfgRmon=agPortCurCfgRmon, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portInfoPhyIfMtu=portInfoPhyIfMtu, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, agPortTableMaxEnt=agPortTableMaxEnt, portInfoSpeed=portInfoSpeed, portInfoIndx=portInfoIndx, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, trunkGroupNewCfgTable=trunkGroupNewCfgTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portInfoLink=portInfoLink, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, agPortCurCfgStp=agPortCurCfgStp, stgNewCfgState=stgNewCfgState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCurCfgIndex=stgCurCfgIndex, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, mirroring=mirroring, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmCurCfgTimeout=pmCurCfgTimeout, spannTreeGrpCfg=spannTreeGrpCfg, agPortNewCfgPVID=agPortNewCfgPVID, agPortCurCfgPVID=agPortCurCfgPVID, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, agPortCurCfgTable=agPortCurCfgTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, port_info=port_info, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, vlanCurCfgState=vlanCurCfgState, stgNewCfgTableEntry=stgNewCfgTableEntry, stgCurCfgPortTable=stgCurCfgPortTable, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, mirrVlanMirr=mirrVlanMirr, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgPortIndex=stgNewCfgPortIndex, agPortNewCfgTableEntry=agPortNewCfgTableEntry, vlanCurCfgJumbo=vlanCurCfgJumbo, agPortNewCfgRmon=agPortNewCfgRmon, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, portCpuStatsUtilIndx=portCpuStatsUtilIndx, agPortCurCfgTableEntry=agPortCurCfgTableEntry, vlanNewCfgAddPort=vlanNewCfgAddPort, agPortCurCfgIndx=agPortCurCfgIndx, agPortCurCfgPrefLink=agPortCurCfgPrefLink, mirrOperType=mirrOperType, stgCurCfgState=stgCurCfgState, pmNewCfgMirroredPort=pmNewCfgMirroredPort, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, agPortNewCfgBackLink=agPortNewCfgBackLink, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanNewCfgStg=vlanNewCfgStg, stgCurCfgTableEntry=stgCurCfgTableEntry, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, vlanCurCfgPorts=vlanCurCfgPorts, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, portStatsPhyIfInOctets=portStatsPhyIfInOctets, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, mirrOperTimeout=mirrOperTimeout, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanNewCfgJumbo=vlanNewCfgJumbo, portInfoTableEntry=portInfoTableEntry, stgNewCfgTable=stgNewCfgTable, stgCurCfgStgIndex=stgCurCfgStgIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgCurCfgPortState=stgCurCfgPortState, trunkgroup=trunkgroup, stgNewCfgPortTable=stgNewCfgPortTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, portStatsPhyIfInErrors=portStatsPhyIfInErrors, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, vlanNewCfgPorts=vlanNewCfgPorts, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanNewCfgState=vlanNewCfgState, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, agPortConfig=agPortConfig, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, stgCurCfgTable=stgCurCfgTable, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, agPortCurCfgBackLink=agPortCurCfgBackLink, mirrPortMirr=mirrPortMirr, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, agPortNewCfgVlanTag=agPortNewCfgVlanTag, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanCurCfgStg=vlanCurCfgStg, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, mirrOperMonitoringPort=mirrOperMonitoringPort, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, portInfoMode=portInfoMode, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, agPortNewCfgIndx=agPortNewCfgIndx, port_stats=port_stats, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanMaxEnt=vlanMaxEnt, portStatsTableEntry=portStatsTableEntry, portCpuStatsUtilTable=portCpuStatsUtilTable, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, portInfoPhyIfType=portInfoPhyIfType, portCpuStats=portCpuStats, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgNewCfgIndex=stgNewCfgIndex, portmirroring=portmirroring, portInfoPhyIfLastChange=portInfoPhyIfLastChange, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1)
