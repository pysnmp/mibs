...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portStatsPhyIfInOctets=portStatsPhyIfInOctets, portInfoMode=portInfoMode, portCpuStatsUtilTable=portCpuStatsUtilTable, stgNewCfgPortIndex=stgNewCfgPortIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, agPortCurCfgRmon=agPortCurCfgRmon, portInfoFlowCtrl=portInfoFlowCtrl, agPortCurCfgBwmContract=agPortCurCfgBwmContract, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, portInfoPhyIfLastChange=portInfoPhyIfLastChange, portInfoIndx=portInfoIndx, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, port_stats=port_stats, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, agPortNewCfgPVID=agPortNewCfgPVID, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portCpuStats=portCpuStats, agPortNewCfgTable=agPortNewCfgTable, agPortNewCfgBackLink=agPortNewCfgBackLink, agPortNewCfgPrefLink=agPortNewCfgPrefLink, vlanCurCfgState=vlanCurCfgState, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, stgCurCfgTableEntry=stgCurCfgTableEntry, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, mirrOperState=mirrOperState, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, vlanNewCfgState=vlanNewCfgState, pmCurCfgState=pmCurCfgState, mirrOperMonitoringPort=mirrOperMonitoringPort, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, vlanCurCfgVlanId=vlanCurCfgVlanId, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portStatsPhyIfInErrors=portStatsPhyIfInErrors, agPortCurCfgPVID=agPortCurCfgPVID, spannTreeGrpCfg=spannTreeGrpCfg, portStatsIndx=portStatsIndx, vlans=vlans, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, portInfoSpeed=portInfoSpeed, stgCurCfgPortState=stgCurCfgPortState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, agPortCurCfgStp=agPortCurCfgStp, vlanNewCfgTable=vlanNewCfgTable, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, agPortCurCfgTableEntry=agPortCurCfgTableEntry, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mirrVlanMirr=mirrVlanMirr, stgNewCfgIndex=stgNewCfgIndex, portStatsTable=portStatsTable, stgCurCfgPortTable=stgCurCfgPortTable, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgTable=stgCurCfgTable, portInfoPhyIfDescr=portInfoPhyIfDescr, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanNewCfgStg=vlanNewCfgStg, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgNewCfgState=stgNewCfgState, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, vlanNewCfgDelete=vlanNewCfgDelete, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, vlanNewCfgPorts=vlanNewCfgPorts, agPortNewCfgStp=agPortNewCfgStp, stgNewCfgTable=stgNewCfgTable, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mirrOperType=mirrOperType, agPortCurCfgIndx=agPortCurCfgIndx, agPortCurCfgPrefLink=agPortCurCfgPrefLink, agPortNewCfgState=agPortNewCfgState, port_info=port_info, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortCurCfgVlanTag=agPortCurCfgVlanTag, pmNewCfgState=pmNewCfgState, vlanNewCfgJumbo=vlanNewCfgJumbo, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanCurCfgPorts=vlanCurCfgPorts, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanNewCfgVlanId=vlanNewCfgVlanId, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, stgNewCfgPortTable=stgNewCfgPortTable, portmirroring=portmirroring, pmNewCfgMirroredPort=pmNewCfgMirroredPort, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, vlanCurCfgStg=vlanCurCfgStg, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, agPortCurCfgBackLink=agPortCurCfgBackLink, vlanCurCfgJumbo=vlanCurCfgJumbo, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, vlanMaxEnt=vlanMaxEnt, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, agPortNewCfgIndx=agPortNewCfgIndx, mirrOperTimeout=mirrOperTimeout, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, agPortNewCfgPortName=agPortNewCfgPortName, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, pmCurCfgMirroredPort=pmCurCfgMirroredPort, stgCurCfgIndex=stgCurCfgIndex, agPortConfig=agPortConfig, trunkgroup=trunkgroup, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanCurCfgTable=vlanCurCfgTable, trunkGroupNewCfgState=trunkGroupNewCfgState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, portInfoLink=portInfoLink, stgCurCfgPortIndex=stgCurCfgPortIndex, agPortCurCfgState=agPortCurCfgState, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, agPortCurCfgPortName=agPortCurCfgPortName, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mirroring=mirroring, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, mirrOperMirroredPort=mirrOperMirroredPort, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portInfoPhyIfMtu=portInfoPhyIfMtu, stgNewCfgPortState=stgNewCfgPortState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgState=stgCurCfgState, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portInfoPhyIfType=portInfoPhyIfType, mirrPortMirr=mirrPortMirr, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portCpuStatsUtilIndx=portCpuStatsUtilIndx, portInfoTable=portInfoTable, agPortCurCfgTable=agPortCurCfgTable, stgNewCfgTableEntry=stgNewCfgTableEntry, agPortTableMaxEnt=agPortTableMaxEnt, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, trunkGroupCurCfgState=trunkGroupCurCfgState, agPortNewCfgBwmContract=agPortNewCfgBwmContract, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, stgNewCfgStgIndex=stgNewCfgStgIndex, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmCurCfgTimeout=pmCurCfgTimeout, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portInfoTableEntry=portInfoTableEntry, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, agPortNewCfgRmon=agPortNewCfgRmon, agPortNewCfgVlanTag=agPortNewCfgVlanTag, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, agPortNewCfgTableEntry=agPortNewCfgTableEntry, portStatsTableEntry=portStatsTableEntry, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mirrOper=mirrOper, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, pmNewCfgTimeout=pmNewCfgTimeout, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable)
