...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", pmCurCfgTimeout=pmCurCfgTimeout, mirrOperTimeout=mirrOperTimeout, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, vlanCurCfgVlanId=vlanCurCfgVlanId, pmNewCfgState=pmNewCfgState, vlanNewCfgPorts=vlanNewCfgPorts, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, portStatsTableEntry=portStatsTableEntry, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, agPortCurCfgPrefLink=agPortCurCfgPrefLink, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, agPortTableMaxEnt=agPortTableMaxEnt, portCpuStatsUtilIndx=portCpuStatsUtilIndx, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanNewCfgBwmContract=vlanNewCfgBwmContract, pmCurCfgPortMirrState=pmCurCfgPortMirrState, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, stgNewCfgTableEntry=stgNewCfgTableEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanCurCfgPorts=vlanCurCfgPorts, portStatsPhyIfInOctets=portStatsPhyIfInOctets, stgCurCfgTable=stgCurCfgTable, agPortNewCfgBwmContract=agPortNewCfgBwmContract, vlanNewCfgStg=vlanNewCfgStg, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mirrPortMirr=mirrPortMirr, mirrOperState=mirrOperState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgStgIndex=stgNewCfgStgIndex, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portInfoLink=portInfoLink, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortNewCfgState=agPortNewCfgState, stgNewCfgState=stgNewCfgState, stgNewCfgPortState=stgNewCfgPortState, spannTreeGrpCfg=spannTreeGrpCfg, agPortCurCfgIndx=agPortCurCfgIndx, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, portInfoPhyIfLastChange=portInfoPhyIfLastChange, agPortCurCfgState=agPortCurCfgState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, stgNewCfgPortTable=stgNewCfgPortTable, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, stgNewCfgIndex=stgNewCfgIndex, agPortCurCfgBackLink=agPortCurCfgBackLink, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, mirrOperMirroredPort=mirrOperMirroredPort, portInfoTableEntry=portInfoTableEntry, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, agPortCurCfgRmon=agPortCurCfgRmon, vlanCurCfgTable=vlanCurCfgTable, vlanNewCfgAddPort=vlanNewCfgAddPort, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, pmNewCfgMirroredPort=pmNewCfgMirroredPort, pmCurCfgState=pmCurCfgState, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, agPortNewCfgPrefLink=agPortNewCfgPrefLink, port_info=port_info, agPortNewCfgVlanTag=agPortNewCfgVlanTag, agPortConfig=agPortConfig, agPortCurCfgPortName=agPortCurCfgPortName, agPortCurCfgStp=agPortCurCfgStp, pmNewCfgTimeout=pmNewCfgTimeout, portInfoIndx=portInfoIndx, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, agPortNewCfgStp=agPortNewCfgStp, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, agPortNewCfgIndx=agPortNewCfgIndx, stgNewCfgPortIndex=stgNewCfgPortIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, agPortNewCfgTable=agPortNewCfgTable, vlanCurCfgStg=vlanCurCfgStg, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portInfoFlowCtrl=portInfoFlowCtrl, portStatsPhyIfInErrors=portStatsPhyIfInErrors, vlanNewCfgVlanName=vlanNewCfgVlanName, agPortCurCfgTableEntry=agPortCurCfgTableEntry, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, vlanNewCfgDelete=vlanNewCfgDelete, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgState=stgCurCfgState, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, portStatsTable=portStatsTable, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, portmirroring=portmirroring, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, portInfoPhyIfType=portInfoPhyIfType, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, stgCurCfgStgIndex=stgCurCfgStgIndex, portInfoMode=portInfoMode, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, stgCurCfgPortTable=stgCurCfgPortTable, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, agPortCurCfgTable=agPortCurCfgTable, agPortCurCfgVlanTag=agPortCurCfgVlanTag, mirrOper=mirrOper, agPortNewCfgPortName=agPortNewCfgPortName, agPortNewCfgRmon=agPortNewCfgRmon, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, port_stats=port_stats, agPortCurCfgPVID=agPortCurCfgPVID, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, portCpuStats=portCpuStats, agPortCurCfgBwmContract=agPortCurCfgBwmContract, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgTable=stgNewCfgTable, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, vlans=vlans, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgIndex=stgCurCfgIndex, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, pmCurCfgMirroredPort=pmCurCfgMirroredPort, agPortNewCfgPVID=agPortNewCfgPVID, stgNewCfgAddVlan=stgNewCfgAddVlan, portInfoPhyIfMtu=portInfoPhyIfMtu, stgCurCfgPortState=stgCurCfgPortState, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanNewCfgState=vlanNewCfgState, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, mirroring=mirroring, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, vlanCurCfgState=vlanCurCfgState, portStatsIndx=portStatsIndx, agPortNewCfgBackLink=agPortNewCfgBackLink, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, stgCurCfgPortIndex=stgCurCfgPortIndex, stgCurCfgTableEntry=stgCurCfgTableEntry, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, agPortNewCfgTableEntry=agPortNewCfgTableEntry, portInfoPhyIfDescr=portInfoPhyIfDescr, portInfoTable=portInfoTable, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, trunkgroup=trunkgroup, mirrVlanMirr=mirrVlanMirr, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, portCpuStatsUtilTable=portCpuStatsUtilTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanNewCfgTable=vlanNewCfgTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, vlanMaxEnt=vlanMaxEnt, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlanCurCfgTableEntry=vlanCurCfgTableEntry, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, mirrOperType=mirrOperType, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, portInfoSpeed=portInfoSpeed, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort)
