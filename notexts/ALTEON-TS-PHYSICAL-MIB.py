...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", pmCurCfgTimeout=pmCurCfgTimeout, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portInfoPhyIfDescr=portInfoPhyIfDescr, portInfoMode=portInfoMode, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, mirrOperState=mirrOperState, pmNewCfgTimeout=pmNewCfgTimeout, vlanNewCfgState=vlanNewCfgState, stgCurCfgTable=stgCurCfgTable, agPortCurCfgRmon=agPortCurCfgRmon, portInfoFlowCtrl=portInfoFlowCtrl, agPortNewCfgPortName=agPortNewCfgPortName, mirrOperTimeout=mirrOperTimeout, mirrOperType=mirrOperType, trunkGroupNewCfgState=trunkGroupNewCfgState, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, vlanNewCfgPorts=vlanNewCfgPorts, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, vlans=vlans, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, agPortCurCfgBackLink=agPortCurCfgBackLink, vlanMaxEnt=vlanMaxEnt, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanNewCfgStg=vlanNewCfgStg, portInfoLink=portInfoLink, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, stgNewCfgPortIndex=stgNewCfgPortIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, stgCurCfgIndex=stgCurCfgIndex, portInfoTable=portInfoTable, portInfoTableEntry=portInfoTableEntry, agPortNewCfgRmon=agPortNewCfgRmon, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanNewCfgJumbo=vlanNewCfgJumbo, stgNewCfgAddVlan=stgNewCfgAddVlan, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, agPortNewCfgPVID=agPortNewCfgPVID, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, portInfoSpeed=portInfoSpeed, vlanCurCfgState=vlanCurCfgState, portInfoPhyIfLastChange=portInfoPhyIfLastChange, agPortCurCfgTable=agPortCurCfgTable, portInfoPhyIfMtu=portInfoPhyIfMtu, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, agPortNewCfgStp=agPortNewCfgStp, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, port_info=port_info, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, vlanNewCfgVlanId=vlanNewCfgVlanId, pmNewCfgState=pmNewCfgState, vlanNewCfgVlanName=vlanNewCfgVlanName, agPortCurCfgIndx=agPortCurCfgIndx, stgCurCfgState=stgCurCfgState, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgIndex=stgNewCfgIndex, portStatsTableEntry=portStatsTableEntry, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, agPortCurCfgPrefLink=agPortCurCfgPrefLink, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, agPortCurCfgPortName=agPortCurCfgPortName, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, portInfoPhyIfType=portInfoPhyIfType, portStatsIndx=portStatsIndx, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, agPortCurCfgStp=agPortCurCfgStp, stgCurCfgPortTable=stgCurCfgPortTable, vlanNewCfgAddPort=vlanNewCfgAddPort, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, portStatsTable=portStatsTable, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, pmNewCfgMirroredPort=pmNewCfgMirroredPort, agPortNewCfgTable=agPortNewCfgTable, agPortCurCfgPVID=agPortCurCfgPVID, vlanCurCfgPorts=vlanCurCfgPorts, port_stats=port_stats, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgPortState=stgCurCfgPortState, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, vlanNewCfgTable=vlanNewCfgTable, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmCurCfgMirroredPort=pmCurCfgMirroredPort, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, mirrPortMirr=mirrPortMirr, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanCurCfgStg=vlanCurCfgStg, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortNewCfgBackLink=agPortNewCfgBackLink, agPortConfig=agPortConfig, mirrVlanMirr=mirrVlanMirr, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanNewCfgBwmContract=vlanNewCfgBwmContract, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, stgNewCfgPortState=stgNewCfgPortState, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, agPortNewCfgBwmContract=agPortNewCfgBwmContract, agPortCurCfgVlanTag=agPortCurCfgVlanTag, stgNewCfgTableEntry=stgNewCfgTableEntry, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, agPortCurCfgState=agPortCurCfgState, mirrOperMirroredPort=mirrOperMirroredPort, mirroring=mirroring, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, pmCurCfgState=pmCurCfgState, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, stgNewCfgState=stgNewCfgState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, vlanNewCfgRemovePort=vlanNewCfgRemovePort, spannTreeGrpCfg=spannTreeGrpCfg, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portCpuStats=portCpuStats, portmirroring=portmirroring, vlanCurCfgTable=vlanCurCfgTable, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portCpuStatsUtilIndx=portCpuStatsUtilIndx, portStatsPhyIfInErrors=portStatsPhyIfInErrors, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, agPortNewCfgState=agPortNewCfgState, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgPortTable=stgNewCfgPortTable, stgCurCfgPortIndex=stgCurCfgPortIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portCpuStatsUtilTable=portCpuStatsUtilTable, trunkgroup=trunkgroup, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, agPortNewCfgIndx=agPortNewCfgIndx, agPortNewCfgPrefLink=agPortNewCfgPrefLink, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgNewCfgTable=stgNewCfgTable, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, portInfoIndx=portInfoIndx, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mirrOper=mirrOper, agPortCurCfgBwmContract=agPortCurCfgBwmContract, portStatsPhyIfInOctets=portStatsPhyIfInOctets, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, agPortNewCfgVlanTag=agPortNewCfgVlanTag, agPortCurCfgTableEntry=agPortCurCfgTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, agPortNewCfgTableEntry=agPortNewCfgTableEntry, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortTableMaxEnt=agPortTableMaxEnt, pmNewCfgPortMirrState=pmNewCfgPortMirrState, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode)
