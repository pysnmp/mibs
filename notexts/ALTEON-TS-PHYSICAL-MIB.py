...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanNewCfgVlanName=vlanNewCfgVlanName, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, portInfoPhyIfMtu=portInfoPhyIfMtu, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, agPortCurCfgBackLink=agPortCurCfgBackLink, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgTableEntry=stgNewCfgTableEntry, mirroring=mirroring, vlanNewCfgState=vlanNewCfgState, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, vlanCurCfgVlanName=vlanCurCfgVlanName, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, pmCurCfgMirroredPort=pmCurCfgMirroredPort, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, stgCurCfgIndex=stgCurCfgIndex, pmNewCfgMirroredPort=pmNewCfgMirroredPort, stgNewCfgState=stgNewCfgState, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, spannTreeGrpCfg=spannTreeGrpCfg, agPortCurCfgTableEntry=agPortCurCfgTableEntry, portStatsTable=portStatsTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, portStatsTableEntry=portStatsTableEntry, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, vlanCurCfgTable=vlanCurCfgTable, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, agPortNewCfgIndx=agPortNewCfgIndx, agPortNewCfgState=agPortNewCfgState, agPortNewCfgTable=agPortNewCfgTable, agPortNewCfgPVID=agPortNewCfgPVID, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, portInfoLink=portInfoLink, portStatsPhyIfInErrors=portStatsPhyIfInErrors, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, pmNewCfgState=pmNewCfgState, portInfoIndx=portInfoIndx, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, agPortNewCfgBwmContract=agPortNewCfgBwmContract, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, portStatsIndx=portStatsIndx, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortCurCfgPVID=agPortCurCfgPVID, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgIndex=stgNewCfgIndex, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mirrPortMirr=mirrPortMirr, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, agPortNewCfgBackLink=agPortNewCfgBackLink, vlanMaxEnt=vlanMaxEnt, portCpuStatsUtilTable=portCpuStatsUtilTable, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portInfoFlowCtrl=portInfoFlowCtrl, stgNewCfgStgIndex=stgNewCfgStgIndex, agPortNewCfgStp=agPortNewCfgStp, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, agPortCurCfgStp=agPortCurCfgStp, stgCurCfgState=stgCurCfgState, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, trunkGroupNewCfgState=trunkGroupNewCfgState, mirrOper=mirrOper, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanCurCfgJumbo=vlanCurCfgJumbo, agPortCurCfgIndx=agPortCurCfgIndx, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgPortTable=stgCurCfgPortTable, port_info=port_info, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, agPortCurCfgVlanTag=agPortCurCfgVlanTag, pmCurCfgTimeout=pmCurCfgTimeout, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, agPortNewCfgRmon=agPortNewCfgRmon, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, stgCurCfgStgIndex=stgCurCfgStgIndex, mirrVlanMirr=mirrVlanMirr, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portInfoSpeed=portInfoSpeed, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgPortTable=stgNewCfgPortTable, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, agPortCurCfgState=agPortCurCfgState, agPortCurCfgBwmContract=agPortCurCfgBwmContract, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portInfoMode=portInfoMode, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, agPortNewCfgPrefLink=agPortNewCfgPrefLink, vlanNewCfgPorts=vlanNewCfgPorts, agPortCurCfgPortName=agPortCurCfgPortName, portInfoPhyIfLastChange=portInfoPhyIfLastChange, mirrOperMirroredPort=mirrOperMirroredPort, stgCurCfgTable=stgCurCfgTable, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portInfoTableEntry=portInfoTableEntry, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, agPortCurCfgTable=agPortCurCfgTable, agPortNewCfgVlanTag=agPortNewCfgVlanTag, vlanNewCfgJumbo=vlanNewCfgJumbo, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanCurCfgVlanId=vlanCurCfgVlanId, agPortCurCfgPrefLink=agPortCurCfgPrefLink, mirrOperTimeout=mirrOperTimeout, portInfoTable=portInfoTable, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, portCpuStats=portCpuStats, vlanNewCfgTable=vlanNewCfgTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mirrOperState=mirrOperState, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, stgCurCfgPortIndex=stgCurCfgPortIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, agPortTableMaxEnt=agPortTableMaxEnt, portInfoPhyIfDescr=portInfoPhyIfDescr, trunkGroupTableMaxSize=trunkGroupTableMaxSize, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgNewCfgPortState=stgNewCfgPortState, portmirroring=portmirroring, port_stats=port_stats, trunkgroup=trunkgroup, portStatsPhyIfInOctets=portStatsPhyIfInOctets, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, vlanCurCfgState=vlanCurCfgState, pmNewCfgTimeout=pmNewCfgTimeout, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, portCpuStatsUtilIndx=portCpuStatsUtilIndx, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, vlans=vlans, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgNewCfgTable=stgNewCfgTable, portInfoPhyIfType=portInfoPhyIfType, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgNewCfgPortIndex=stgNewCfgPortIndex, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, stgCurCfgTableEntry=stgCurCfgTableEntry, mirrOperType=mirrOperType, stgCurCfgPortState=stgCurCfgPortState, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, mirrOperMonitoringPort=mirrOperMonitoringPort, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, vlanCurCfgStg=vlanCurCfgStg, vlanCurCfgPorts=vlanCurCfgPorts, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, agPortNewCfgTableEntry=agPortNewCfgTableEntry, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, agPortNewCfgPortName=agPortNewCfgPortName, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, vlanCurCfgTableEntry=vlanCurCfgTableEntry, agPortCurCfgRmon=agPortCurCfgRmon, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmCurCfgState=pmCurCfgState, agPortConfig=agPortConfig)
