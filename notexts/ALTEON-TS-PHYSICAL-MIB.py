...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", portCpuStats=portCpuStats, mirroring=mirroring, vlanNewCfgVlanId=vlanNewCfgVlanId, port_stats=port_stats, agPortNewCfgIndx=agPortNewCfgIndx, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, agPortNewCfgPVID=agPortNewCfgPVID, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, spannTreeGrpCfg=spannTreeGrpCfg, vlanNewCfgJumbo=vlanNewCfgJumbo, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, portInfoPhyIfType=portInfoPhyIfType, vlanCurCfgState=vlanCurCfgState, portInfoSpeed=portInfoSpeed, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortCurCfgStp=agPortCurCfgStp, agPortNewCfgStp=agPortNewCfgStp, agPortNewCfgBwmContract=agPortNewCfgBwmContract, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, mirrOperMirroredPort=mirrOperMirroredPort, mirrVlanMirr=mirrVlanMirr, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, vlanNewCfgDelete=vlanNewCfgDelete, agPortCurCfgPVID=agPortCurCfgPVID, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, stgNewCfgIndex=stgNewCfgIndex, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, agPortNewCfgBackLink=agPortNewCfgBackLink, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, vlanMaxEnt=vlanMaxEnt, vlans=vlans, portStatsTable=portStatsTable, agPortNewCfgTable=agPortNewCfgTable, vlanNewCfgStg=vlanNewCfgStg, stgCurCfgPortState=stgCurCfgPortState, stgNewCfgTableEntry=stgNewCfgTableEntry, portStatsPhyIfInErrors=portStatsPhyIfInErrors, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, agPortConfig=agPortConfig, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgPortIndex=stgNewCfgPortIndex, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, portInfoMode=portInfoMode, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, mirrPortMirr=mirrPortMirr, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgTable=stgCurCfgTable, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, agPortNewCfgRmon=agPortNewCfgRmon, agPortCurCfgVlanTag=agPortCurCfgVlanTag, agPortCurCfgTable=agPortCurCfgTable, vlanNewCfgTable=vlanNewCfgTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanNewCfgPorts=vlanNewCfgPorts, mirrOperState=mirrOperState, agPortCurCfgTableEntry=agPortCurCfgTableEntry, stgNewCfgTable=stgNewCfgTable, portStatsTableEntry=portStatsTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, agPortNewCfgVlanTag=agPortNewCfgVlanTag, pmNewCfgMirroredPort=pmNewCfgMirroredPort, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portInfoIndx=portInfoIndx, vlanCurCfgVlanName=vlanCurCfgVlanName, portInfoFlowCtrl=portInfoFlowCtrl, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, trunkgroup=trunkgroup, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgNewCfgPortState=stgNewCfgPortState, stgCurCfgPortIndex=stgCurCfgPortIndex, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, agPortNewCfgPrefLink=agPortNewCfgPrefLink, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, portCpuStatsUtilIndx=portCpuStatsUtilIndx, stgCurCfgStgIndex=stgCurCfgStgIndex, portmirroring=portmirroring, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanCurCfgTable=vlanCurCfgTable, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, vlanCurCfgJumbo=vlanCurCfgJumbo, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, vlanCurCfgStg=vlanCurCfgStg, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, port_info=port_info, agPortCurCfgIndx=agPortCurCfgIndx, pmCurCfgState=pmCurCfgState, stgNewCfgState=stgNewCfgState, stgCurCfgState=stgCurCfgState, agPortNewCfgState=agPortNewCfgState, agPortCurCfgBackLink=agPortCurCfgBackLink, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mirrOper=mirrOper, vlanCurCfgVlanId=vlanCurCfgVlanId, stgCurCfgTableEntry=stgCurCfgTableEntry, mirrOperType=mirrOperType, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, stgNewCfgPortTable=stgNewCfgPortTable, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, portInfoTable=portInfoTable, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, agPortTableMaxEnt=agPortTableMaxEnt, vlanNewCfgVlanName=vlanNewCfgVlanName, agPortCurCfgBwmContract=agPortCurCfgBwmContract, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, portInfoPhyIfLastChange=portInfoPhyIfLastChange, trunkGroupCurCfgState=trunkGroupCurCfgState, agPortCurCfgPrefLink=agPortCurCfgPrefLink, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanNewCfgState=vlanNewCfgState, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, agPortCurCfgPortName=agPortCurCfgPortName, pmCurCfgMirroredPort=pmCurCfgMirroredPort, vlanNewCfgAddPort=vlanNewCfgAddPort, pmNewCfgTimeout=pmNewCfgTimeout, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portCpuStatsUtilTable=portCpuStatsUtilTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, agPortNewCfgPortName=agPortNewCfgPortName, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState, agPortCurCfgRmon=agPortCurCfgRmon, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, portStatsIndx=portStatsIndx, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, agPortNewCfgTableEntry=agPortNewCfgTableEntry, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCurCfgIndex=stgCurCfgIndex, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, portInfoLink=portInfoLink, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, portInfoTableEntry=portInfoTableEntry, pmCurCfgTimeout=pmCurCfgTimeout, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, mirrOperTimeout=mirrOperTimeout, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, portInfoPhyIfDescr=portInfoPhyIfDescr, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, pmNewCfgState=pmNewCfgState, stgCurCfgPortTable=stgCurCfgPortTable, portStatsPhyIfInOctets=portStatsPhyIfInOctets, portInfoPhyIfMtu=portInfoPhyIfMtu, agPortCurCfgState=agPortCurCfgState)
