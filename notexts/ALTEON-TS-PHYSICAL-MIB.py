...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", portInfoPhyIfType=portInfoPhyIfType, mirrOperType=mirrOperType, trunkgroup=trunkgroup, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, mirroring=mirroring, stgNewCfgPortState=stgNewCfgPortState, portInfoTable=portInfoTable, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanNewCfgVlanName=vlanNewCfgVlanName, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, vlanNewCfgBwmContract=vlanNewCfgBwmContract, pmCurCfgMirroredPort=pmCurCfgMirroredPort, agPortCurCfgRmon=agPortCurCfgRmon, agPortNewCfgBwmContract=agPortNewCfgBwmContract, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanNewCfgPorts=vlanNewCfgPorts, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortNewCfgBackLink=agPortNewCfgBackLink, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, stgNewCfgIndex=stgNewCfgIndex, vlanCurCfgStg=vlanCurCfgStg, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, agPortConfig=agPortConfig, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, pmNewCfgTimeout=pmNewCfgTimeout, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mirrOper=mirrOper, agPortCurCfgStp=agPortCurCfgStp, mirrPortMirr=mirrPortMirr, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portCpuStatsUtilTable=portCpuStatsUtilTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgCurCfgState=stgCurCfgState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanNewCfgState=vlanNewCfgState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, trunkGroupTableMaxSize=trunkGroupTableMaxSize, agPortCurCfgTable=agPortCurCfgTable, port_info=port_info, vlanNewCfgDelete=vlanNewCfgDelete, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, vlanCurCfgJumbo=vlanCurCfgJumbo, spannTreeGrpCfg=spannTreeGrpCfg, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, portInfoPhyIfDescr=portInfoPhyIfDescr, vlanMaxEnt=vlanMaxEnt, stgNewCfgPortIndex=stgNewCfgPortIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgTableEntry=stgNewCfgTableEntry, agPortCurCfgPrefLink=agPortCurCfgPrefLink, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portInfoTableEntry=portInfoTableEntry, agPortNewCfgRmon=agPortNewCfgRmon, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, stgCurCfgTableEntry=stgCurCfgTableEntry, agPortNewCfgPrefLink=agPortNewCfgPrefLink, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanNewCfgAddPort=vlanNewCfgAddPort, agPortCurCfgBackLink=agPortCurCfgBackLink, portStatsPhyIfInOctets=portStatsPhyIfInOctets, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, stgCurCfgTable=stgCurCfgTable, agPortTableMaxEnt=agPortTableMaxEnt, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortNewCfgPVID=agPortNewCfgPVID, stgNewCfgPortTable=stgNewCfgPortTable, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, stgNewCfgTable=stgNewCfgTable, agPortCurCfgVlanTag=agPortCurCfgVlanTag, vlans=vlans, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, agPortCurCfgIndx=agPortCurCfgIndx, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmNewCfgState=pmNewCfgState, pmNewCfgMirroredPort=pmNewCfgMirroredPort, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanNewCfgTable=vlanNewCfgTable, portStatsPhyIfInErrors=portStatsPhyIfInErrors, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, stgCurCfgPortState=stgCurCfgPortState, pmCurCfgTimeout=pmCurCfgTimeout, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mirrOperState=mirrOperState, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, portInfoMode=portInfoMode, agPortNewCfgStp=agPortNewCfgStp, agPortNewCfgVlanTag=agPortNewCfgVlanTag, trunkGroupNewCfgTable=trunkGroupNewCfgTable, agPortCurCfgBwmContract=agPortCurCfgBwmContract, agPortNewCfgState=agPortNewCfgState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portInfoLink=portInfoLink, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, vlanNewCfgJumbo=vlanNewCfgJumbo, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portInfoPhyIfMtu=portInfoPhyIfMtu, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, agPortNewCfgPortName=agPortNewCfgPortName, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, mirrOperMirroredPort=mirrOperMirroredPort, portInfoIndx=portInfoIndx, portmirroring=portmirroring, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, vlanCurCfgTable=vlanCurCfgTable, agPortNewCfgTable=agPortNewCfgTable, portInfoPhyIfLastChange=portInfoPhyIfLastChange, agPortCurCfgPVID=agPortCurCfgPVID, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, port_stats=port_stats, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, agPortCurCfgPortName=agPortCurCfgPortName, portStatsIndx=portStatsIndx, stgNewCfgState=stgNewCfgState, portStatsTable=portStatsTable, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, stgCurCfgIndex=stgCurCfgIndex, portCpuStats=portCpuStats, agPortCurCfgTableEntry=agPortCurCfgTableEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanCurCfgState=vlanCurCfgState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgCurCfgPortIndex=stgCurCfgPortIndex, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, mirrVlanMirr=mirrVlanMirr, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, portStatsTableEntry=portStatsTableEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, stgCurCfgStgIndex=stgCurCfgStgIndex, stgCurCfgPortTable=stgCurCfgPortTable, mirrOperTimeout=mirrOperTimeout, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanCurCfgVlanId=vlanCurCfgVlanId, trunkGroupNewCfgState=trunkGroupNewCfgState, agPortNewCfgIndx=agPortNewCfgIndx, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, portInfoFlowCtrl=portInfoFlowCtrl, agPortNewCfgTableEntry=agPortNewCfgTableEntry, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, pmCurCfgState=pmCurCfgState, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, portInfoSpeed=portInfoSpeed, agPortCurCfgState=agPortCurCfgState, vlanNewCfgStg=vlanNewCfgStg, portCpuStatsUtilIndx=portCpuStatsUtilIndx, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds)
