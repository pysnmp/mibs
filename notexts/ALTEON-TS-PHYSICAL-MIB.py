...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", portInfoTable=portInfoTable, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portStatsPhyIfInOctets=portStatsPhyIfInOctets, mirrOperType=mirrOperType, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portStatsTableEntry=portStatsTableEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, stgNewCfgPortState=stgNewCfgPortState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, stgNewCfgPortTable=stgNewCfgPortTable, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, agPortTableMaxEnt=agPortTableMaxEnt, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, mirrOperMonitoringPort=mirrOperMonitoringPort, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortNewCfgStp=agPortNewCfgStp, agPortCurCfgState=agPortCurCfgState, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, agPortNewCfgBwmContract=agPortNewCfgBwmContract, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, agPortNewCfgTable=agPortNewCfgTable, pmNewCfgState=pmNewCfgState, stgCurCfgTableEntry=stgCurCfgTableEntry, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, portInfoSpeed=portInfoSpeed, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, agPortCurCfgPVID=agPortCurCfgPVID, stgCurCfgPortState=stgCurCfgPortState, portmirroring=portmirroring, pmNewCfgTimeout=pmNewCfgTimeout, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, spannTreeGrpCfg=spannTreeGrpCfg, agPortConfig=agPortConfig, portInfoPhyIfLastChange=portInfoPhyIfLastChange, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, agPortNewCfgTableEntry=agPortNewCfgTableEntry, stgCurCfgPortTable=stgCurCfgPortTable, portCpuStatsUtilIndx=portCpuStatsUtilIndx, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portInfoFlowCtrl=portInfoFlowCtrl, vlanCurCfgTableEntry=vlanCurCfgTableEntry, agPortCurCfgRmon=agPortCurCfgRmon, portInfoIndx=portInfoIndx, agPortCurCfgPrefLink=agPortCurCfgPrefLink, agPortCurCfgStp=agPortCurCfgStp, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, agPortNewCfgBackLink=agPortNewCfgBackLink, agPortNewCfgVlanTag=agPortNewCfgVlanTag, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgIndex=stgNewCfgIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkgroup=trunkgroup, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, agPortNewCfgPVID=agPortNewCfgPVID, vlanNewCfgState=vlanNewCfgState, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanCurCfgStg=vlanCurCfgStg, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanMaxEnt=vlanMaxEnt, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, agPortCurCfgBwmContract=agPortCurCfgBwmContract, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, stgNewCfgTable=stgNewCfgTable, agPortNewCfgIndx=agPortNewCfgIndx, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanCurCfgVlanId=vlanCurCfgVlanId, portCpuStatsUtilTable=portCpuStatsUtilTable, portInfoMode=portInfoMode, agPortCurCfgBackLink=agPortCurCfgBackLink, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanCurCfgPorts=vlanCurCfgPorts, vlanNewCfgVlanName=vlanNewCfgVlanName, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, portStatsTable=portStatsTable, mirrOper=mirrOper, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgAddVlan=stgNewCfgAddVlan, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portStatsPhyIfInErrors=portStatsPhyIfInErrors, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanCurCfgState=vlanCurCfgState, agPortNewCfgState=agPortNewCfgState, pmNewCfgMirroredPort=pmNewCfgMirroredPort, mirrVlanMirr=mirrVlanMirr, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, stgCurCfgTable=stgCurCfgTable, agPortCurCfgVlanTag=agPortCurCfgVlanTag, portInfoPhyIfType=portInfoPhyIfType, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mirrOperState=mirrOperState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portCpuStats=portCpuStats, portInfoPhyIfMtu=portInfoPhyIfMtu, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgPortIndex=stgNewCfgPortIndex, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, agPortCurCfgIndx=agPortCurCfgIndx, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, portInfoPhyIfDescr=portInfoPhyIfDescr, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanCurCfgTable=vlanCurCfgTable, agPortNewCfgPortName=agPortNewCfgPortName, port_info=port_info, stgNewCfgState=stgNewCfgState, mirrPortMirr=mirrPortMirr, agPortNewCfgRmon=agPortNewCfgRmon, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mirroring=mirroring, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, mirrOperMirroredPort=mirrOperMirroredPort, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, portStatsIndx=portStatsIndx, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, agPortNewCfgPrefLink=agPortNewCfgPrefLink, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, portInfoTableEntry=portInfoTableEntry, vlanNewCfgBwmContract=vlanNewCfgBwmContract, port_stats=port_stats, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgState=stgCurCfgState, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, pmCurCfgMirroredPort=pmCurCfgMirroredPort, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmCurCfgState=pmCurCfgState, mirrOperTimeout=mirrOperTimeout, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, stgCurCfgIndex=stgCurCfgIndex, agPortCurCfgPortName=agPortCurCfgPortName, vlanNewCfgStg=vlanNewCfgStg, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, agPortCurCfgTable=agPortCurCfgTable, vlanNewCfgJumbo=vlanNewCfgJumbo, agPortCurCfgTableEntry=agPortCurCfgTableEntry, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, stgNewCfgTableEntry=stgNewCfgTableEntry, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, portInfoLink=portInfoLink, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, trunkGroupCurCfgState=trunkGroupCurCfgState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanCurCfgJumbo=vlanCurCfgJumbo, pmCurCfgTimeout=pmCurCfgTimeout, pmNewCfgPortMirrState=pmNewCfgPortMirrState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, vlans=vlans, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts)
