...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", vlanCurCfgPorts=vlanCurCfgPorts, portInfoPhyIfType=portInfoPhyIfType, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, vlanNewCfgVlanId=vlanNewCfgVlanId, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, portStatsPhyIfInErrors=portStatsPhyIfInErrors, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgCurCfgPortTable=stgCurCfgPortTable, agPortCurCfgBwmContract=agPortCurCfgBwmContract, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, spannTreeGrpCfg=spannTreeGrpCfg, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, stgCurCfgTable=stgCurCfgTable, agPortCurCfgTableEntry=agPortCurCfgTableEntry, mirrOperTimeout=mirrOperTimeout, stgNewCfgIndex=stgNewCfgIndex, agPortNewCfgPVID=agPortNewCfgPVID, portStatsTableEntry=portStatsTableEntry, portStatsIndx=portStatsIndx, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, vlanMaxEnt=vlanMaxEnt, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, agPortNewCfgStp=agPortNewCfgStp, mirrOperType=mirrOperType, portInfoPhyIfMtu=portInfoPhyIfMtu, agPortNewCfgState=agPortNewCfgState, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portCpuStats=portCpuStats, agPortCurCfgState=agPortCurCfgState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgPortTable=stgNewCfgPortTable, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, agPortCurCfgPVID=agPortCurCfgPVID, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portInfoIndx=portInfoIndx, portInfoTable=portInfoTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, agPortCurCfgPrefLink=agPortCurCfgPrefLink, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, vlanNewCfgVlanName=vlanNewCfgVlanName, agPortNewCfgRmon=agPortNewCfgRmon, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, agPortNewCfgPortName=agPortNewCfgPortName, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgCurCfgPortIndex=stgCurCfgPortIndex, agPortCurCfgPortName=agPortCurCfgPortName, stgCurCfgTableEntry=stgCurCfgTableEntry, portInfoMode=portInfoMode, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, vlanCurCfgState=vlanCurCfgState, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, pmCurCfgTimeout=pmCurCfgTimeout, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, trunkGroupTableMaxSize=trunkGroupTableMaxSize, agPortNewCfgVlanTag=agPortNewCfgVlanTag, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgAddVlan=stgNewCfgAddVlan, trunkgroup=trunkgroup, pmCurCfgMirroredPort=pmCurCfgMirroredPort, mirrOper=mirrOper, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmNewCfgState=pmNewCfgState, mirrOperMirroredPort=mirrOperMirroredPort, pmCurCfgState=pmCurCfgState, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanNewCfgPorts=vlanNewCfgPorts, stgCurCfgIndex=stgCurCfgIndex, stgCurCfgState=stgCurCfgState, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, portStatsTable=portStatsTable, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortCurCfgTable=agPortCurCfgTable, agPortCurCfgRmon=agPortCurCfgRmon, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgPortIndex=stgNewCfgPortIndex, port_stats=port_stats, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, vlanCurCfgTable=vlanCurCfgTable, port_info=port_info, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, vlanNewCfgJumbo=vlanNewCfgJumbo, portCpuStatsUtilIndx=portCpuStatsUtilIndx, portInfoPhyIfLastChange=portInfoPhyIfLastChange, stgNewCfgState=stgNewCfgState, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, pmNewCfgMirroredPort=pmNewCfgMirroredPort, vlanNewCfgStg=vlanNewCfgStg, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, agPortNewCfgBwmContract=agPortNewCfgBwmContract, stgNewCfgPortState=stgNewCfgPortState, pmNewCfgTimeout=pmNewCfgTimeout, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, agPortConfig=agPortConfig, agPortCurCfgStp=agPortCurCfgStp, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, mirrOperMonitoringPort=mirrOperMonitoringPort, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgTable=stgNewCfgTable, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanNewCfgRemovePort=vlanNewCfgRemovePort, agPortNewCfgPrefLink=agPortNewCfgPrefLink, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanCurCfgJumbo=vlanCurCfgJumbo, portInfoFlowCtrl=portInfoFlowCtrl, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, vlanCurCfgStg=vlanCurCfgStg, stgNewCfgStgIndex=stgNewCfgStgIndex, portCpuStatsUtilTable=portCpuStatsUtilTable, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, portInfoSpeed=portInfoSpeed, agPortCurCfgBackLink=agPortCurCfgBackLink, portmirroring=portmirroring, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortCurCfgIndx=agPortCurCfgIndx, portStatsPhyIfInOctets=portStatsPhyIfInOctets, vlans=vlans, agPortTableMaxEnt=agPortTableMaxEnt, agPortCurCfgVlanTag=agPortCurCfgVlanTag, agPortNewCfgTableEntry=agPortNewCfgTableEntry, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mirrVlanMirr=mirrVlanMirr, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mirrPortMirr=mirrPortMirr, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mirrOperState=mirrOperState, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgCurCfgStgIndex=stgCurCfgStgIndex, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, vlanNewCfgState=vlanNewCfgState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgCurCfgPortState=stgCurCfgPortState, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, agPortNewCfgBackLink=agPortNewCfgBackLink, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, agPortNewCfgIndx=agPortNewCfgIndx, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, portInfoTableEntry=portInfoTableEntry, mirroring=mirroring, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, portInfoLink=portInfoLink, agPortNewCfgTable=agPortNewCfgTable, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgTable=vlanNewCfgTable)
