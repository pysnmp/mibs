...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mirrVlanMirr=mirrVlanMirr, agPortTableMaxEnt=agPortTableMaxEnt, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, spannTreeGrpCfg=spannTreeGrpCfg, stgCurCfgPortIndex=stgCurCfgPortIndex, agPortConfig=agPortConfig, vlanNewCfgState=vlanNewCfgState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, mirrOperTimeout=mirrOperTimeout, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, portInfoSpeed=portInfoSpeed, portCpuStats=portCpuStats, vlanCurCfgPorts=vlanCurCfgPorts, portInfoPhyIfDescr=portInfoPhyIfDescr, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mirrPortMirr=mirrPortMirr, vlanCurCfgVlanId=vlanCurCfgVlanId, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, vlanNewCfgJumbo=vlanNewCfgJumbo, agPortCurCfgIndx=agPortCurCfgIndx, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portInfoLink=portInfoLink, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, agPortCurCfgPrefLink=agPortCurCfgPrefLink, agPortCurCfgRmon=agPortCurCfgRmon, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, agPortCurCfgTable=agPortCurCfgTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanNewCfgStg=vlanNewCfgStg, agPortNewCfgBwmContract=agPortNewCfgBwmContract, pmNewCfgMirroredPort=pmNewCfgMirroredPort, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portInfoPhyIfType=portInfoPhyIfType, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgPortTable=stgNewCfgPortTable, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, stgCurCfgStgIndex=stgCurCfgStgIndex, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, vlanNewCfgVlanId=vlanNewCfgVlanId, mirroring=mirroring, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, pmCurCfgTimeout=pmCurCfgTimeout, trunkGroupNewCfgTable=trunkGroupNewCfgTable, agPortCurCfgTableEntry=agPortCurCfgTableEntry, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, vlans=vlans, portInfoFlowCtrl=portInfoFlowCtrl, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portmirroring=portmirroring, trunkGroupNewCfgState=trunkGroupNewCfgState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portStatsPhyIfInErrors=portStatsPhyIfInErrors, vlanNewCfgPorts=vlanNewCfgPorts, stgCurCfgIndex=stgCurCfgIndex, agPortNewCfgBackLink=agPortNewCfgBackLink, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, port_info=port_info, agPortNewCfgPortName=agPortNewCfgPortName, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, mirrOperMirroredPort=mirrOperMirroredPort, vlanCurCfgTable=vlanCurCfgTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portInfoPhyIfLastChange=portInfoPhyIfLastChange, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, stgCurCfgState=stgCurCfgState, agPortNewCfgPrefLink=agPortNewCfgPrefLink, pmCurCfgState=pmCurCfgState, port_stats=port_stats, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgState=stgNewCfgState, stgNewCfgStgIndex=stgNewCfgStgIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, pmNewCfgTimeout=pmNewCfgTimeout, portInfoMode=portInfoMode, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgNewCfgTable=stgNewCfgTable, vlanNewCfgVlanName=vlanNewCfgVlanName, agPortNewCfgRmon=agPortNewCfgRmon, stgCurCfgTableEntry=stgCurCfgTableEntry, portCpuStatsUtilTable=portCpuStatsUtilTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, agPortCurCfgState=agPortCurCfgState, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portStatsTable=portStatsTable, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, agPortCurCfgBackLink=agPortCurCfgBackLink, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmCurCfgMirroredPort=pmCurCfgMirroredPort, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portCpuStatsUtilIndx=portCpuStatsUtilIndx, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, trunkGroupCurCfgTable=trunkGroupCurCfgTable, agPortNewCfgStp=agPortNewCfgStp, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, portStatsTableEntry=portStatsTableEntry, trunkgroup=trunkgroup, agPortCurCfgStp=agPortCurCfgStp, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, vlanCurCfgJumbo=vlanCurCfgJumbo, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, vlanMaxEnt=vlanMaxEnt, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, stgNewCfgIndex=stgNewCfgIndex, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgDelete=vlanNewCfgDelete, agPortNewCfgPVID=agPortNewCfgPVID, agPortCurCfgBwmContract=agPortCurCfgBwmContract, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portInfoTableEntry=portInfoTableEntry, agPortNewCfgState=agPortNewCfgState, stgNewCfgPortState=stgNewCfgPortState, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, stgCurCfgPortState=stgCurCfgPortState, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, agPortNewCfgTableEntry=agPortNewCfgTableEntry, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, mirrOper=mirrOper, agPortCurCfgPVID=agPortCurCfgPVID, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, vlanCurCfgState=vlanCurCfgState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portInfoTable=portInfoTable, vlanNewCfgTable=vlanNewCfgTable, agPortNewCfgVlanTag=agPortNewCfgVlanTag, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, portStatsIndx=portStatsIndx, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, agPortCurCfgVlanTag=agPortCurCfgVlanTag, stgCurCfgPortTable=stgCurCfgPortTable, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortCurCfgPortName=agPortCurCfgPortName, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, portStatsPhyIfInOctets=portStatsPhyIfInOctets, mirrOperState=mirrOperState, mirrOperType=mirrOperType, pmNewCfgState=pmNewCfgState, portInfoPhyIfMtu=portInfoPhyIfMtu, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, vlanCurCfgVlanName=vlanCurCfgVlanName, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgTable=stgCurCfgTable, portInfoIndx=portInfoIndx, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, agPortNewCfgIndx=agPortNewCfgIndx, agPortNewCfgTable=agPortNewCfgTable)
