...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", trunkGroupNewCfgTable=trunkGroupNewCfgTable, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, portInfoPhyIfDescr=portInfoPhyIfDescr, stgNewCfgStgIndex=stgNewCfgStgIndex, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, stgNewCfgPortState=stgNewCfgPortState, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, mirrOperState=mirrOperState, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanCurCfgJumbo=vlanCurCfgJumbo, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, mirroring=mirroring, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, pmNewCfgTimeout=pmNewCfgTimeout, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, agPortConfig=agPortConfig, vlanMaxEnt=vlanMaxEnt, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupCurCfgState=trunkGroupCurCfgState, agPortNewCfgTableEntry=agPortNewCfgTableEntry, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, pmCurCfgTimeout=pmCurCfgTimeout, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portInfoPhyIfLastChange=portInfoPhyIfLastChange, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortCurCfgRmon=agPortCurCfgRmon, pmNewCfgMirroredPort=pmNewCfgMirroredPort, portInfoMode=portInfoMode, mirrVlanMirr=mirrVlanMirr, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, agPortCurCfgTableEntry=agPortCurCfgTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, trunkGroupNewCfgState=trunkGroupNewCfgState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mirrOperTimeout=mirrOperTimeout, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanCurCfgTable=vlanCurCfgTable, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, portInfoTableEntry=portInfoTableEntry, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portCpuStats=portCpuStats, stgCurCfgState=stgCurCfgState, stgNewCfgTable=stgNewCfgTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, portInfoIndx=portInfoIndx, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mirrOperMonitoringPort=mirrOperMonitoringPort, vlanCurCfgVlanName=vlanCurCfgVlanName, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, portInfoTable=portInfoTable, portStatsTableEntry=portStatsTableEntry, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanNewCfgState=vlanNewCfgState, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, vlanNewCfgAddPort=vlanNewCfgAddPort, agPortNewCfgPrefLink=agPortNewCfgPrefLink, vlanNewCfgTable=vlanNewCfgTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, agPortCurCfgState=agPortCurCfgState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgPortTable=stgNewCfgPortTable, agPortNewCfgState=agPortNewCfgState, vlanNewCfgJumbo=vlanNewCfgJumbo, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgStgIndex=stgCurCfgStgIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, agPortNewCfgRmon=agPortNewCfgRmon, agPortNewCfgPortName=agPortNewCfgPortName, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, stgCurCfgPortState=stgCurCfgPortState, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, portStatsPhyIfInErrors=portStatsPhyIfInErrors, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, agPortCurCfgTable=agPortCurCfgTable, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, pmCurCfgMirroredPort=pmCurCfgMirroredPort, trunkgroup=trunkgroup, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanCurCfgState=vlanCurCfgState, agPortCurCfgIndx=agPortCurCfgIndx, mirrOperMirroredPort=mirrOperMirroredPort, stgNewCfgIndex=stgNewCfgIndex, agPortCurCfgBackLink=agPortCurCfgBackLink, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portInfoLink=portInfoLink, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, pmNewCfgState=pmNewCfgState, portmirroring=portmirroring, portStatsTable=portStatsTable, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, portStatsPhyIfInOctets=portStatsPhyIfInOctets, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanNewCfgVlanId=vlanNewCfgVlanId, portCpuStatsUtilTable=portCpuStatsUtilTable, stgCurCfgPortIndex=stgCurCfgPortIndex, spannTreeGrpCfg=spannTreeGrpCfg, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgState=stgNewCfgState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, agPortNewCfgIndx=agPortNewCfgIndx, stgCurCfgPortTable=stgCurCfgPortTable, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, agPortNewCfgStp=agPortNewCfgStp, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, portStatsIndx=portStatsIndx, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mirrPortMirr=mirrPortMirr, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, agPortCurCfgBwmContract=agPortCurCfgBwmContract, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, agPortCurCfgStp=agPortCurCfgStp, portInfoPhyIfMtu=portInfoPhyIfMtu, portInfoFlowCtrl=portInfoFlowCtrl, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, vlanNewCfgStg=vlanNewCfgStg, pmCurCfgState=pmCurCfgState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, agPortNewCfgVlanTag=agPortNewCfgVlanTag, stgCurCfgTable=stgCurCfgTable, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, vlanCurCfgStg=vlanCurCfgStg, agPortNewCfgPVID=agPortNewCfgPVID, portInfoPhyIfType=portInfoPhyIfType, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, agPortTableMaxEnt=agPortTableMaxEnt, agPortCurCfgVlanTag=agPortCurCfgVlanTag, mirrOperType=mirrOperType, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, agPortNewCfgBwmContract=agPortNewCfgBwmContract, agPortNewCfgTable=agPortNewCfgTable, vlanCurCfgPorts=vlanCurCfgPorts, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mirrOper=mirrOper, port_info=port_info, vlanNewCfgDelete=vlanNewCfgDelete, stgCurCfgTableEntry=stgCurCfgTableEntry, vlans=vlans, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCurCfgIndex=stgCurCfgIndex, port_stats=port_stats, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, vlanNewCfgPorts=vlanNewCfgPorts, portCpuStatsUtilIndx=portCpuStatsUtilIndx, agPortCurCfgPrefLink=agPortCurCfgPrefLink, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, agPortCurCfgPVID=agPortCurCfgPVID, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, portInfoSpeed=portInfoSpeed, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, agPortNewCfgBackLink=agPortNewCfgBackLink, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, agPortCurCfgPortName=agPortCurCfgPortName)
