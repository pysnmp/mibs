...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", pmNewCfgTimeout=pmNewCfgTimeout, stgNewCfgIndex=stgNewCfgIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portCpuStatsUtilTable=portCpuStatsUtilTable, mirrVlanMirr=mirrVlanMirr, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, trunkGroupNewCfgState=trunkGroupNewCfgState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, vlanCurCfgState=vlanCurCfgState, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, agPortCurCfgBackLink=agPortCurCfgBackLink, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, agPortCurCfgState=agPortCurCfgState, pmNewCfgMirroredPort=pmNewCfgMirroredPort, mirrOperState=mirrOperState, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portStatsPhyIfInOctets=portStatsPhyIfInOctets, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, agPortNewCfgVlanTag=agPortNewCfgVlanTag, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, vlanNewCfgAddPort=vlanNewCfgAddPort, mirrPortMirr=mirrPortMirr, agPortCurCfgStp=agPortCurCfgStp, pmCurCfgState=pmCurCfgState, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portStatsTableEntry=portStatsTableEntry, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, agPortCurCfgPrefLink=agPortCurCfgPrefLink, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, portInfoIndx=portInfoIndx, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, portInfoPhyIfDescr=portInfoPhyIfDescr, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portCpuStats=portCpuStats, stgNewCfgPortTable=stgNewCfgPortTable, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, mirrOperMonitoringPort=mirrOperMonitoringPort, stgNewCfgTableEntry=stgNewCfgTableEntry, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, stgCurCfgPortState=stgCurCfgPortState, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, stgNewCfgPortState=stgNewCfgPortState, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, stgCurCfgPortTable=stgCurCfgPortTable, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, agPortCurCfgTableEntry=agPortCurCfgTableEntry, vlanNewCfgTable=vlanNewCfgTable, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, portmirroring=portmirroring, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, portInfoLink=portInfoLink, stgNewCfgState=stgNewCfgState, stgCurCfgPortIndex=stgCurCfgPortIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, agPortCurCfgIndx=agPortCurCfgIndx, agPortNewCfgPortName=agPortNewCfgPortName, mirrOperMirroredPort=mirrOperMirroredPort, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, portInfoPhyIfType=portInfoPhyIfType, mirrOperType=mirrOperType, portInfoTableEntry=portInfoTableEntry, vlanCurCfgStg=vlanCurCfgStg, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, agPortCurCfgPortName=agPortCurCfgPortName, portStatsPhyIfInErrors=portStatsPhyIfInErrors, portStatsIndx=portStatsIndx, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portStatsTable=portStatsTable, mirrOperTimeout=mirrOperTimeout, spannTreeGrpCfg=spannTreeGrpCfg, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, stgNewCfgTable=stgNewCfgTable, agPortNewCfgBackLink=agPortNewCfgBackLink, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, vlanNewCfgBwmContract=vlanNewCfgBwmContract, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanCurCfgPorts=vlanCurCfgPorts, pmNewCfgPortMirrState=pmNewCfgPortMirrState, agPortCurCfgPVID=agPortCurCfgPVID, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mirroring=mirroring, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgPortIndex=stgNewCfgPortIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, agPortNewCfgRmon=agPortNewCfgRmon, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, port_stats=port_stats, portInfoFlowCtrl=portInfoFlowCtrl, vlans=vlans, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgState=stgCurCfgState, agPortCurCfgRmon=agPortCurCfgRmon, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portInfoTable=portInfoTable, portInfoPhyIfMtu=portInfoPhyIfMtu, vlanCurCfgVlanId=vlanCurCfgVlanId, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, trunkgroup=trunkgroup, pmCurCfgMirroredPort=pmCurCfgMirroredPort, agPortNewCfgStp=agPortNewCfgStp, agPortCurCfgBwmContract=agPortCurCfgBwmContract, agPortCurCfgVlanTag=agPortCurCfgVlanTag, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, stgCurCfgTable=stgCurCfgTable, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, agPortConfig=agPortConfig, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, pmNewCfgState=pmNewCfgState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, stgCurCfgStgIndex=stgCurCfgStgIndex, portInfoMode=portInfoMode, vlanNewCfgPorts=vlanNewCfgPorts, vlanNewCfgState=vlanNewCfgState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, agPortNewCfgTableEntry=agPortNewCfgTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, portInfoPhyIfLastChange=portInfoPhyIfLastChange, agPortNewCfgState=agPortNewCfgState, port_info=port_info, agPortNewCfgPVID=agPortNewCfgPVID, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, portInfoSpeed=portInfoSpeed, agPortNewCfgTable=agPortNewCfgTable, agPortCurCfgTable=agPortCurCfgTable, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, vlanNewCfgDelete=vlanNewCfgDelete, stgCurCfgIndex=stgCurCfgIndex, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmCurCfgTimeout=pmCurCfgTimeout, stgNewCfgAddVlan=stgNewCfgAddVlan, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, vlanCurCfgTable=vlanCurCfgTable, agPortNewCfgPrefLink=agPortNewCfgPrefLink, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portCpuStatsUtilIndx=portCpuStatsUtilIndx, agPortNewCfgBwmContract=agPortNewCfgBwmContract, vlanCurCfgTableEntry=vlanCurCfgTableEntry, agPortNewCfgIndx=agPortNewCfgIndx, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, agPortTableMaxEnt=agPortTableMaxEnt, mirrOper=mirrOper, vlanMaxEnt=vlanMaxEnt)
