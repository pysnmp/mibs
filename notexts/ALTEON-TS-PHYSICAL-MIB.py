...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, vlanCurCfgStg=vlanCurCfgStg, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portInfoTableEntry=portInfoTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, agPortNewCfgState=agPortNewCfgState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, portInfoPhyIfType=portInfoPhyIfType, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portCpuStatsUtilIndx=portCpuStatsUtilIndx, vlanCurCfgTableEntry=vlanCurCfgTableEntry, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmCurCfgMirroredPort=pmCurCfgMirroredPort, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, stgNewCfgTableEntry=stgNewCfgTableEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgCurCfgState=stgCurCfgState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, mirrPortMirr=mirrPortMirr, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, mirrOperState=mirrOperState, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, vlanNewCfgStg=vlanNewCfgStg, stgCurCfgTable=stgCurCfgTable, agPortCurCfgVlanTag=agPortCurCfgVlanTag, agPortCurCfgBackLink=agPortCurCfgBackLink, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, vlanNewCfgTable=vlanNewCfgTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portInfoFlowCtrl=portInfoFlowCtrl, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, portInfoLink=portInfoLink, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, portStatsTableEntry=portStatsTableEntry, agPortNewCfgTableEntry=agPortNewCfgTableEntry, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, portInfoIndx=portInfoIndx, mirrVlanMirr=mirrVlanMirr, trunkGroupNewCfgState=trunkGroupNewCfgState, trunkGroupCurCfgState=trunkGroupCurCfgState, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, vlanCurCfgState=vlanCurCfgState, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, agPortCurCfgIndx=agPortCurCfgIndx, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, stgCurCfgIndex=stgCurCfgIndex, stgCurCfgPortTable=stgCurCfgPortTable, agPortCurCfgPrefLink=agPortCurCfgPrefLink, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, vlanNewCfgDelete=vlanNewCfgDelete, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, trunkgroup=trunkgroup, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanNewCfgVlanName=vlanNewCfgVlanName, portInfoPhyIfMtu=portInfoPhyIfMtu, agPortTableMaxEnt=agPortTableMaxEnt, portStatsPhyIfInOctets=portStatsPhyIfInOctets, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgNewCfgPortState=stgNewCfgPortState, vlanCurCfgVlanName=vlanCurCfgVlanName, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portCpuStats=portCpuStats, portStatsPhyIfInErrors=portStatsPhyIfInErrors, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgCurCfgPortState=stgCurCfgPortState, pmNewCfgMirroredPort=pmNewCfgMirroredPort, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, vlanNewCfgState=vlanNewCfgState, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, vlanNewCfgPorts=vlanNewCfgPorts, agPortCurCfgPortName=agPortCurCfgPortName, vlanCurCfgTable=vlanCurCfgTable, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, port_stats=port_stats, agPortNewCfgBwmContract=agPortNewCfgBwmContract, stgNewCfgPortTable=stgNewCfgPortTable, portInfoPhyIfLastChange=portInfoPhyIfLastChange, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, stgNewCfgPortIndex=stgNewCfgPortIndex, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, spannTreeGrpCfg=spannTreeGrpCfg, pmCurCfgState=pmCurCfgState, mirrOperMirroredPort=mirrOperMirroredPort, mirrOper=mirrOper, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, agPortNewCfgVlanTag=agPortNewCfgVlanTag, agPortNewCfgPrefLink=agPortNewCfgPrefLink, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, agPortNewCfgPVID=agPortNewCfgPVID, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, portInfoMode=portInfoMode, vlans=vlans, stgNewCfgAddVlan=stgNewCfgAddVlan, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, agPortNewCfgStp=agPortNewCfgStp, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, agPortNewCfgIndx=agPortNewCfgIndx, portInfoSpeed=portInfoSpeed, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, agPortCurCfgStp=agPortCurCfgStp, agPortCurCfgPVID=agPortCurCfgPVID, agPortNewCfgPortName=agPortNewCfgPortName, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, pmNewCfgTimeout=pmNewCfgTimeout, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portCpuStatsUtilTable=portCpuStatsUtilTable, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, agPortCurCfgState=agPortCurCfgState, agPortCurCfgRmon=agPortCurCfgRmon, agPortCurCfgTable=agPortCurCfgTable, vlanMaxEnt=vlanMaxEnt, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, agPortNewCfgTable=agPortNewCfgTable, stgNewCfgState=stgNewCfgState, port_info=port_info, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portStatsIndx=portStatsIndx, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, agPortNewCfgRmon=agPortNewCfgRmon, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, pmCurCfgTimeout=pmCurCfgTimeout, stgCurCfgStgIndex=stgCurCfgStgIndex, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, mirrOperMonitoringPort=mirrOperMonitoringPort, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, agPortCurCfgBwmContract=agPortCurCfgBwmContract, vlanNewCfgAddPort=vlanNewCfgAddPort, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, mirrOperTimeout=mirrOperTimeout, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanNewCfgBwmContract=vlanNewCfgBwmContract, agPortConfig=agPortConfig, portStatsTable=portStatsTable, stgNewCfgStgIndex=stgNewCfgStgIndex, stgNewCfgTable=stgNewCfgTable, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, stgCurCfgTableEntry=stgCurCfgTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, stgNewCfgIndex=stgNewCfgIndex, mirroring=mirroring, portInfoPhyIfDescr=portInfoPhyIfDescr, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mirrOperType=mirrOperType, vlanCurCfgPorts=vlanCurCfgPorts, vlanNewCfgTableEntry=vlanNewCfgTableEntry, agPortNewCfgBackLink=agPortNewCfgBackLink, stgCurCfgPortIndex=stgCurCfgPortIndex, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, portInfoTable=portInfoTable, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, pmNewCfgState=pmNewCfgState, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, agPortCurCfgTableEntry=agPortCurCfgTableEntry, portmirroring=portmirroring)
