...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, pmCurCfgState=pmCurCfgState, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, portInfoIndx=portInfoIndx, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlans=vlans, agPortCurCfgStp=agPortCurCfgStp, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, vlanCurCfgTable=vlanCurCfgTable, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, mirrOperState=mirrOperState, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgVlanId=vlanNewCfgVlanId, agPortCurCfgRmon=agPortCurCfgRmon, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, portInfoFlowCtrl=portInfoFlowCtrl, mirrOperType=mirrOperType, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, mirrVlanMirr=mirrVlanMirr, agPortNewCfgBackLink=agPortNewCfgBackLink, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupCurCfgState=trunkGroupCurCfgState, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgState=stgCurCfgState, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, stgNewCfgIndex=stgNewCfgIndex, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmNewCfgState=pmNewCfgState, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, agPortNewCfgRmon=agPortNewCfgRmon, port_info=port_info, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, pmCurCfgTimeout=pmCurCfgTimeout, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, vlanMaxEnt=vlanMaxEnt, agPortNewCfgPVID=agPortNewCfgPVID, stgNewCfgStgIndex=stgNewCfgStgIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgState=stgNewCfgState, mirrOperTimeout=mirrOperTimeout, agPortCurCfgPrefLink=agPortCurCfgPrefLink, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgPortTable=stgCurCfgPortTable, stgNewCfgPortState=stgNewCfgPortState, stgCurCfgStgIndex=stgCurCfgStgIndex, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanCurCfgState=vlanCurCfgState, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, vlanNewCfgTable=vlanNewCfgTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portCpuStatsUtilIndx=portCpuStatsUtilIndx, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portmirroring=portmirroring, agPortCurCfgTableEntry=agPortCurCfgTableEntry, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portInfoPhyIfLastChange=portInfoPhyIfLastChange, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, spannTreeGrpCfg=spannTreeGrpCfg, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgCurCfgIndex=stgCurCfgIndex, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, agPortNewCfgTable=agPortNewCfgTable, portInfoTableEntry=portInfoTableEntry, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, portInfoPhyIfMtu=portInfoPhyIfMtu, agPortCurCfgBackLink=agPortCurCfgBackLink, vlanNewCfgJumbo=vlanNewCfgJumbo, stgNewCfgPortIndex=stgNewCfgPortIndex, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgTable=stgCurCfgTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgCurCfgTableEntry=stgCurCfgTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, agPortCurCfgPVID=agPortCurCfgPVID, portInfoSpeed=portInfoSpeed, mirrPortMirr=mirrPortMirr, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, portInfoPhyIfDescr=portInfoPhyIfDescr, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, trunkGroupNewCfgState=trunkGroupNewCfgState, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, trunkgroup=trunkgroup, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, agPortCurCfgTable=agPortCurCfgTable, vlanCurCfgVlanId=vlanCurCfgVlanId, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgPortTable=stgNewCfgPortTable, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, mirrOperMonitoringPort=mirrOperMonitoringPort, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, agPortNewCfgPrefLink=agPortNewCfgPrefLink, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, agPortNewCfgBwmContract=agPortNewCfgBwmContract, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, mirrOper=mirrOper, agPortNewCfgState=agPortNewCfgState, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, mirroring=mirroring, stgCurCfgPortState=stgCurCfgPortState, vlanNewCfgState=vlanNewCfgState, mirrOperMirroredPort=mirrOperMirroredPort, portInfoTable=portInfoTable, stgNewCfgTableEntry=stgNewCfgTableEntry, agPortNewCfgTableEntry=agPortNewCfgTableEntry, agPortTableMaxEnt=agPortTableMaxEnt, agPortCurCfgIndx=agPortCurCfgIndx, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgTable=stgNewCfgTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, portStatsIndx=portStatsIndx, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, portStatsTable=portStatsTable, agPortNewCfgStp=agPortNewCfgStp, portStatsPhyIfInOctets=portStatsPhyIfInOctets, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, stgCurCfgPortIndex=stgCurCfgPortIndex, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, pmCurCfgMirroredPort=pmCurCfgMirroredPort, vlanCurCfgVlanName=vlanCurCfgVlanName, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, agPortConfig=agPortConfig, portStatsTableEntry=portStatsTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, vlanNewCfgDelete=vlanNewCfgDelete, portCpuStatsUtilTable=portCpuStatsUtilTable, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, pmNewCfgTimeout=pmNewCfgTimeout, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanNewCfgStg=vlanNewCfgStg, agPortCurCfgBwmContract=agPortCurCfgBwmContract, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portInfoPhyIfType=portInfoPhyIfType, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, agPortCurCfgPortName=agPortCurCfgPortName, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, agPortCurCfgState=agPortCurCfgState, portCpuStats=portCpuStats, portInfoLink=portInfoLink, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortNewCfgVlanTag=agPortNewCfgVlanTag, agPortNewCfgPortName=agPortNewCfgPortName, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portInfoMode=portInfoMode, port_stats=port_stats, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgPorts=vlanNewCfgPorts, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, agPortCurCfgVlanTag=agPortCurCfgVlanTag, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portStatsPhyIfInErrors=portStatsPhyIfInErrors, pmNewCfgMirroredPort=pmNewCfgMirroredPort, agPortNewCfgIndx=agPortNewCfgIndx, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanNewCfgTableEntry=vlanNewCfgTableEntry)
