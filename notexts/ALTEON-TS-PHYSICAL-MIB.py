...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, portInfoLink=portInfoLink, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, portInfoTable=portInfoTable, port_stats=port_stats, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, mirrPortMirr=mirrPortMirr, agPortNewCfgPrefLink=agPortNewCfgPrefLink, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, agPortCurCfgBackLink=agPortCurCfgBackLink, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, mirrOper=mirrOper, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portInfoTableEntry=portInfoTableEntry, vlanNewCfgStg=vlanNewCfgStg, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, spannTreeGrpCfg=spannTreeGrpCfg, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, mirrOperType=mirrOperType, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, agPortNewCfgVlanTag=agPortNewCfgVlanTag, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portmirroring=portmirroring, agPortCurCfgTable=agPortCurCfgTable, agPortNewCfgTable=agPortNewCfgTable, portInfoFlowCtrl=portInfoFlowCtrl, portCpuStats=portCpuStats, vlanNewCfgJumbo=vlanNewCfgJumbo, portInfoPhyIfType=portInfoPhyIfType, agPortCurCfgPortName=agPortCurCfgPortName, pmNewCfgTimeout=pmNewCfgTimeout, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanCurCfgVlanName=vlanCurCfgVlanName, portStatsPhyIfInOctets=portStatsPhyIfInOctets, port_info=port_info, agPortNewCfgIndx=agPortNewCfgIndx, trunkgroup=trunkgroup, portStatsTable=portStatsTable, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, vlanNewCfgPorts=vlanNewCfgPorts, mirrVlanMirr=mirrVlanMirr, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portStatsPhyIfInErrors=portStatsPhyIfInErrors, stgNewCfgStgIndex=stgNewCfgStgIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmCurCfgMirroredPort=pmCurCfgMirroredPort, agPortNewCfgTableEntry=agPortNewCfgTableEntry, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, stgCurCfgPortState=stgCurCfgPortState, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgTable=stgCurCfgTable, pmCurCfgTimeout=pmCurCfgTimeout, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, portStatsIndx=portStatsIndx, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, agPortCurCfgTableEntry=agPortCurCfgTableEntry, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, portStatsTableEntry=portStatsTableEntry, agPortCurCfgVlanTag=agPortCurCfgVlanTag, agPortNewCfgState=agPortNewCfgState, stgNewCfgTable=stgNewCfgTable, stgCurCfgPortTable=stgCurCfgPortTable, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, agPortNewCfgBackLink=agPortNewCfgBackLink, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, vlanCurCfgTable=vlanCurCfgTable, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, portInfoPhyIfDescr=portInfoPhyIfDescr, stgNewCfgState=stgNewCfgState, portInfoSpeed=portInfoSpeed, agPortNewCfgPVID=agPortNewCfgPVID, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, pmNewCfgState=pmNewCfgState, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, mirroring=mirroring, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, vlans=vlans, agPortTableMaxEnt=agPortTableMaxEnt, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanCurCfgStg=vlanCurCfgStg, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, agPortConfig=agPortConfig, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, mirrOperTimeout=mirrOperTimeout, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanNewCfgState=vlanNewCfgState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mirrOperState=mirrOperState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgIndex=stgNewCfgIndex, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, agPortCurCfgRmon=agPortCurCfgRmon, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, pmCurCfgState=pmCurCfgState, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mirrOperMonitoringPort=mirrOperMonitoringPort, mirrOperMirroredPort=mirrOperMirroredPort, agPortCurCfgState=agPortCurCfgState, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, vlanCurCfgState=vlanCurCfgState, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, pmNewCfgMirroredPort=pmNewCfgMirroredPort, portInfoMode=portInfoMode, vlanNewCfgTable=vlanNewCfgTable, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgIndex=stgCurCfgIndex, agPortCurCfgPrefLink=agPortCurCfgPrefLink, stgNewCfgAddVlan=stgNewCfgAddVlan, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgPortState=stgNewCfgPortState, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, portInfoPhyIfMtu=portInfoPhyIfMtu, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgPortTable=stgNewCfgPortTable, agPortCurCfgPVID=agPortCurCfgPVID, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, agPortNewCfgPortName=agPortNewCfgPortName, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, portInfoIndx=portInfoIndx, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, portCpuStatsUtilTable=portCpuStatsUtilTable, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, agPortNewCfgBwmContract=agPortNewCfgBwmContract, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, agPortCurCfgIndx=agPortCurCfgIndx, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, stgCurCfgState=stgCurCfgState, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanCurCfgPorts=vlanCurCfgPorts, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, agPortNewCfgStp=agPortNewCfgStp, vlanNewCfgVlanName=vlanNewCfgVlanName, agPortNewCfgRmon=agPortNewCfgRmon, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, vlanMaxEnt=vlanMaxEnt, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, portCpuStatsUtilIndx=portCpuStatsUtilIndx, agPortCurCfgBwmContract=agPortCurCfgBwmContract, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, agPortCurCfgStp=agPortCurCfgStp, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, portInfoPhyIfLastChange=portInfoPhyIfLastChange, vlanNewCfgBwmContract=vlanNewCfgBwmContract)
