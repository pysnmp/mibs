...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portCpuStats=portCpuStats, agPortNewCfgTable=agPortNewCfgTable, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, vlanMaxEnt=vlanMaxEnt, portStatsIndx=portStatsIndx, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, portInfoSpeed=portInfoSpeed, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, agPortCurCfgBackLink=agPortCurCfgBackLink, pmCurCfgMirroredPort=pmCurCfgMirroredPort, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, vlanNewCfgPorts=vlanNewCfgPorts, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, agPortCurCfgVlanTag=agPortCurCfgVlanTag, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, vlanNewCfgJumbo=vlanNewCfgJumbo, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portInfoFlowCtrl=portInfoFlowCtrl, agPortCurCfgState=agPortCurCfgState, portInfoPhyIfType=portInfoPhyIfType, vlanNewCfgDelete=vlanNewCfgDelete, portmirroring=portmirroring, vlanCurCfgState=vlanCurCfgState, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, stgNewCfgPortTable=stgNewCfgPortTable, portCpuStatsUtilIndx=portCpuStatsUtilIndx, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mirroring=mirroring, mirrVlanMirr=mirrVlanMirr, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, vlanNewCfgAddPort=vlanNewCfgAddPort, pmNewCfgState=pmNewCfgState, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanCurCfgTable=vlanCurCfgTable, portInfoTableEntry=portInfoTableEntry, agPortNewCfgPVID=agPortNewCfgPVID, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, vlanCurCfgJumbo=vlanCurCfgJumbo, port_info=port_info, vlanNewCfgRemovePort=vlanNewCfgRemovePort, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, agPortNewCfgIndx=agPortNewCfgIndx, mirrOper=mirrOper, mirrOperMirroredPort=mirrOperMirroredPort, agPortCurCfgTable=agPortCurCfgTable, agPortCurCfgPortName=agPortCurCfgPortName, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, agPortNewCfgPortName=agPortNewCfgPortName, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, agPortNewCfgTableEntry=agPortNewCfgTableEntry, agPortConfig=agPortConfig, portInfoTable=portInfoTable, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, agPortTableMaxEnt=agPortTableMaxEnt, agPortNewCfgRmon=agPortNewCfgRmon, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, pmNewCfgMirroredPort=pmNewCfgMirroredPort, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portInfoLink=portInfoLink, portInfoIndx=portInfoIndx, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanNewCfgStg=vlanNewCfgStg, pmCurCfgTimeout=pmCurCfgTimeout, stgNewCfgPortState=stgNewCfgPortState, stgCurCfgIndex=stgCurCfgIndex, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, stgNewCfgAddVlan=stgNewCfgAddVlan, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, agPortNewCfgPrefLink=agPortNewCfgPrefLink, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgTableEntry=stgNewCfgTableEntry, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, vlanCurCfgPorts=vlanCurCfgPorts, stgCurCfgPortState=stgCurCfgPortState, mirrOperState=mirrOperState, portCpuStatsUtilTable=portCpuStatsUtilTable, stgCurCfgStgIndex=stgCurCfgStgIndex, portInfoMode=portInfoMode, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, agPortCurCfgBwmContract=agPortCurCfgBwmContract, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, portStatsTable=portStatsTable, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, agPortCurCfgStp=agPortCurCfgStp, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, agPortNewCfgStp=agPortNewCfgStp, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, portStatsPhyIfInErrors=portStatsPhyIfInErrors, spannTreeGrpCfg=spannTreeGrpCfg, pmCurCfgState=pmCurCfgState, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mirrOperTimeout=mirrOperTimeout, stgCurCfgState=stgCurCfgState, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgPortIndex=stgNewCfgPortIndex, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, port_stats=port_stats, portInfoPhyIfMtu=portInfoPhyIfMtu, mirrPortMirr=mirrPortMirr, trunkGroupTableMaxSize=trunkGroupTableMaxSize, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanCurCfgVlanName=vlanCurCfgVlanName, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlans=vlans, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, stgCurCfgTable=stgCurCfgTable, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, agPortNewCfgBackLink=agPortNewCfgBackLink, agPortCurCfgTableEntry=agPortCurCfgTableEntry, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgState=vlanNewCfgState, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, trunkgroup=trunkgroup, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, portInfoPhyIfDescr=portInfoPhyIfDescr, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, stgCurCfgPortTable=stgCurCfgPortTable, stgCurCfgPortIndex=stgCurCfgPortIndex, agPortCurCfgPVID=agPortCurCfgPVID, agPortCurCfgPrefLink=agPortCurCfgPrefLink, stgNewCfgState=stgNewCfgState, portStatsTableEntry=portStatsTableEntry, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, stgNewCfgTable=stgNewCfgTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortNewCfgState=agPortNewCfgState, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortNewCfgBwmContract=agPortNewCfgBwmContract, trunkGroupNewCfgTable=trunkGroupNewCfgTable, agPortCurCfgIndx=agPortCurCfgIndx, agPortCurCfgRmon=agPortCurCfgRmon, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, portInfoPhyIfLastChange=portInfoPhyIfLastChange, pmNewCfgTimeout=pmNewCfgTimeout, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, vlanCurCfgStg=vlanCurCfgStg, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, stgNewCfgIndex=stgNewCfgIndex, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, portStatsPhyIfInOctets=portStatsPhyIfInOctets, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, agPortNewCfgVlanTag=agPortNewCfgVlanTag, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mirrOperType=mirrOperType, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgNewCfgStgIndex=stgNewCfgStgIndex, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable)
