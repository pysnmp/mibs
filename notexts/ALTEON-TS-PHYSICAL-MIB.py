...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", portStatsTableEntry=portStatsTableEntry, portInfoPhyIfMtu=portInfoPhyIfMtu, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgCurCfgIndex=stgCurCfgIndex, portCpuStatsUtilTable=portCpuStatsUtilTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, port_stats=port_stats, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mirrOperType=mirrOperType, vlanNewCfgPorts=vlanNewCfgPorts, vlanNewCfgJumbo=vlanNewCfgJumbo, mirrOperMirroredPort=mirrOperMirroredPort, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortConfig=agPortConfig, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, agPortNewCfgPrefLink=agPortNewCfgPrefLink, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, portmirroring=portmirroring, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, agPortNewCfgBwmContract=agPortNewCfgBwmContract, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, agPortNewCfgPVID=agPortNewCfgPVID, stgNewCfgIndex=stgNewCfgIndex, portInfoPhyIfDescr=portInfoPhyIfDescr, portInfoSpeed=portInfoSpeed, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, portInfoMode=portInfoMode, agPortCurCfgBackLink=agPortCurCfgBackLink, agPortCurCfgVlanTag=agPortCurCfgVlanTag, vlanNewCfgTable=vlanNewCfgTable, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortNewCfgRmon=agPortNewCfgRmon, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, agPortNewCfgVlanTag=agPortNewCfgVlanTag, vlans=vlans, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmNewCfgMirroredPort=pmNewCfgMirroredPort, vlanNewCfgAddPort=vlanNewCfgAddPort, agPortCurCfgPortName=agPortCurCfgPortName, portStatsPhyIfInOctets=portStatsPhyIfInOctets, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, agPortCurCfgPVID=agPortCurCfgPVID, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, mirrOper=mirrOper, stgCurCfgState=stgCurCfgState, portInfoFlowCtrl=portInfoFlowCtrl, agPortCurCfgState=agPortCurCfgState, stgNewCfgState=stgNewCfgState, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, stgNewCfgTable=stgNewCfgTable, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, vlanCurCfgTable=vlanCurCfgTable, stgNewCfgAddVlan=stgNewCfgAddVlan, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, port_info=port_info, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, portInfoTable=portInfoTable, portInfoIndx=portInfoIndx, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmCurCfgPortMirrState=pmCurCfgPortMirrState, agPortNewCfgIndx=agPortNewCfgIndx, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, agPortCurCfgBwmContract=agPortCurCfgBwmContract, vlanNewCfgStg=vlanNewCfgStg, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, agPortCurCfgTableEntry=agPortCurCfgTableEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, agPortNewCfgPortName=agPortNewCfgPortName, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, vlanNewCfgBwmContract=vlanNewCfgBwmContract, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, portCpuStatsUtilIndx=portCpuStatsUtilIndx, trunkgroup=trunkgroup, agPortNewCfgState=agPortNewCfgState, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, stgCurCfgTable=stgCurCfgTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, agPortCurCfgTable=agPortCurCfgTable, vlanCurCfgStg=vlanCurCfgStg, agPortCurCfgPrefLink=agPortCurCfgPrefLink, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, pmNewCfgTimeout=pmNewCfgTimeout, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portCpuStats=portCpuStats, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, stgNewCfgPortTable=stgNewCfgPortTable, agPortCurCfgIndx=agPortCurCfgIndx, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, mirrVlanMirr=mirrVlanMirr, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanNewCfgDelete=vlanNewCfgDelete, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgNewCfgPortState=stgNewCfgPortState, portInfoLink=portInfoLink, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, agPortCurCfgStp=agPortCurCfgStp, portInfoPhyIfType=portInfoPhyIfType, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, agPortNewCfgStp=agPortNewCfgStp, vlanMaxEnt=vlanMaxEnt, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanCurCfgJumbo=vlanCurCfgJumbo, agPortCurCfgRmon=agPortCurCfgRmon, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portStatsPhyIfInErrors=portStatsPhyIfInErrors, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, agPortNewCfgTable=agPortNewCfgTable, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, trunkGroupNewCfgState=trunkGroupNewCfgState, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, vlanNewCfgState=vlanNewCfgState, pmNewCfgState=pmNewCfgState, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgCurCfgPortState=stgCurCfgPortState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, agPortTableMaxEnt=agPortTableMaxEnt, agPortNewCfgTableEntry=agPortNewCfgTableEntry, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portInfoTableEntry=portInfoTableEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgCurCfgPortTable=stgCurCfgPortTable, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanCurCfgState=vlanCurCfgState, agPortNewCfgBackLink=agPortNewCfgBackLink, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mirrOperState=mirrOperState, vlanNewCfgVlanId=vlanNewCfgVlanId, portStatsTable=portStatsTable, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, pmCurCfgMirroredPort=pmCurCfgMirroredPort, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, trunkGroupCurCfgState=trunkGroupCurCfgState, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, spannTreeGrpCfg=spannTreeGrpCfg, stgNewCfgTableEntry=stgNewCfgTableEntry, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portInfoPhyIfLastChange=portInfoPhyIfLastChange, mirrOperTimeout=mirrOperTimeout, pmCurCfgState=pmCurCfgState, portStatsIndx=portStatsIndx, mirrPortMirr=mirrPortMirr, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, pmCurCfgTimeout=pmCurCfgTimeout, mirroring=mirroring, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen)
