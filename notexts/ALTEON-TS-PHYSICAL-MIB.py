...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, vlanMaxEnt=vlanMaxEnt, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgCurCfgStgIndex=stgCurCfgStgIndex, port_stats=port_stats, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, agPortNewCfgPVID=agPortNewCfgPVID, agPortNewCfgState=agPortNewCfgState, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, portInfoPhyIfLastChange=portInfoPhyIfLastChange, portStatsTable=portStatsTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, agPortNewCfgPrefLink=agPortNewCfgPrefLink, vlanNewCfgPorts=vlanNewCfgPorts, mirrOperType=mirrOperType, agPortTableMaxEnt=agPortTableMaxEnt, stgCurCfgTableEntry=stgCurCfgTableEntry, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgPortState=stgNewCfgPortState, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, agPortCurCfgStp=agPortCurCfgStp, vlanNewCfgJumbo=vlanNewCfgJumbo, agPortCurCfgTable=agPortCurCfgTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, agPortConfig=agPortConfig, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portStatsIndx=portStatsIndx, pmCurCfgMirroredPort=pmCurCfgMirroredPort, portmirroring=portmirroring, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, agPortNewCfgTable=agPortNewCfgTable, stgNewCfgIndex=stgNewCfgIndex, portStatsPhyIfInOctets=portStatsPhyIfInOctets, mirrOperTimeout=mirrOperTimeout, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, stgNewCfgTable=stgNewCfgTable, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortNewCfgBwmContract=agPortNewCfgBwmContract, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortCurCfgBackLink=agPortCurCfgBackLink, spannTreeGrpCfg=spannTreeGrpCfg, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, agPortCurCfgIndx=agPortCurCfgIndx, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, portCpuStatsUtilTable=portCpuStatsUtilTable, stgCurCfgIndex=stgCurCfgIndex, stgCurCfgPortTable=stgCurCfgPortTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, stgCurCfgTable=stgCurCfgTable, mirrPortMirr=mirrPortMirr, mirrOperMirroredPort=mirrOperMirroredPort, agPortNewCfgIndx=agPortNewCfgIndx, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, agPortNewCfgRmon=agPortNewCfgRmon, portStatsTableEntry=portStatsTableEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, portInfoPhyIfType=portInfoPhyIfType, pmCurCfgState=pmCurCfgState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, vlans=vlans, mirrVlanMirr=mirrVlanMirr, stgCurCfgPortState=stgCurCfgPortState, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, stgNewCfgTableEntry=stgNewCfgTableEntry, agPortCurCfgPrefLink=agPortCurCfgPrefLink, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, portInfoFlowCtrl=portInfoFlowCtrl, agPortCurCfgState=agPortCurCfgState, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, vlanNewCfgTable=vlanNewCfgTable, mirrOper=mirrOper, mirroring=mirroring, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, agPortNewCfgTableEntry=agPortNewCfgTableEntry, agPortCurCfgPortName=agPortCurCfgPortName, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, vlanCurCfgStg=vlanCurCfgStg, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, stgNewCfgAddVlan=stgNewCfgAddVlan, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, portCpuStatsUtilIndx=portCpuStatsUtilIndx, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgPortIndex=stgNewCfgPortIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, vlanNewCfgState=vlanNewCfgState, pmNewCfgMirroredPort=pmNewCfgMirroredPort, vlanCurCfgTable=vlanCurCfgTable, pmNewCfgTimeout=pmNewCfgTimeout, agPortCurCfgRmon=agPortCurCfgRmon, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanCurCfgVlanId=vlanCurCfgVlanId, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanNewCfgVlanName=vlanNewCfgVlanName, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanCurCfgPorts=vlanCurCfgPorts, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, portInfoTable=portInfoTable, agPortCurCfgPVID=agPortCurCfgPVID, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, agPortNewCfgBackLink=agPortNewCfgBackLink, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, agPortNewCfgStp=agPortNewCfgStp, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, portInfoIndx=portInfoIndx, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, stgCurCfgState=stgCurCfgState, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, portInfoTableEntry=portInfoTableEntry, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, port_info=port_info, vlanNewCfgVlanId=vlanNewCfgVlanId, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanCurCfgState=vlanCurCfgState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, agPortNewCfgVlanTag=agPortNewCfgVlanTag, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanCurCfgJumbo=vlanCurCfgJumbo, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, vlanNewCfgTableEntry=vlanNewCfgTableEntry, agPortCurCfgTableEntry=agPortCurCfgTableEntry, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, stgNewCfgPortTable=stgNewCfgPortTable, portInfoLink=portInfoLink, agPortCurCfgVlanTag=agPortCurCfgVlanTag, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, trunkGroupNewCfgState=trunkGroupNewCfgState, portStatsPhyIfInErrors=portStatsPhyIfInErrors, trunkGroupCurCfgState=trunkGroupCurCfgState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgNewCfgState=stgNewCfgState, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanNewCfgStg=vlanNewCfgStg, trunkgroup=trunkgroup, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, portCpuStats=portCpuStats, agPortCurCfgBwmContract=agPortCurCfgBwmContract, portInfoMode=portInfoMode, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmCurCfgTimeout=pmCurCfgTimeout, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, agPortNewCfgPortName=agPortNewCfgPortName, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portInfoPhyIfMtu=portInfoPhyIfMtu, mirrOperState=mirrOperState, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, portInfoSpeed=portInfoSpeed, pmNewCfgState=pmNewCfgState)
