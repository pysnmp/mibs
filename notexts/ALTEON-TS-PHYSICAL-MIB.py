...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", stgNewCfgStgIndex=stgNewCfgStgIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, agPortCurCfgBwmContract=agPortCurCfgBwmContract, trunkGroupTableMaxSize=trunkGroupTableMaxSize, port_info=port_info, stgNewCfgPortTable=stgNewCfgPortTable, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, portStatsPhyIfInErrors=portStatsPhyIfInErrors, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, mirrVlanMirr=mirrVlanMirr, vlanCurCfgVlanId=vlanCurCfgVlanId, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, agPortCurCfgVlanTag=agPortCurCfgVlanTag, agPortNewCfgIndx=agPortNewCfgIndx, pmNewCfgMirroredPort=pmNewCfgMirroredPort, agPortNewCfgVlanTag=agPortNewCfgVlanTag, portStatsTableEntry=portStatsTableEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, agPortCurCfgBackLink=agPortCurCfgBackLink, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, portCpuStatsUtilIndx=portCpuStatsUtilIndx, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, agPortCurCfgStp=agPortCurCfgStp, mirrOperMirroredPort=mirrOperMirroredPort, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCurCfgPortState=stgCurCfgPortState, stgCurCfgIndex=stgCurCfgIndex, vlanCurCfgVlanName=vlanCurCfgVlanName, vlans=vlans, agPortNewCfgTable=agPortNewCfgTable, agPortNewCfgBwmContract=agPortNewCfgBwmContract, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, agPortCurCfgState=agPortCurCfgState, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, vlanNewCfgJumbo=vlanNewCfgJumbo, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, stgNewCfgTable=stgNewCfgTable, vlanNewCfgState=vlanNewCfgState, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanCurCfgStg=vlanCurCfgStg, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portInfoSpeed=portInfoSpeed, portInfoPhyIfType=portInfoPhyIfType, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portInfoPhyIfLastChange=portInfoPhyIfLastChange, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, agPortNewCfgState=agPortNewCfgState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, vlanCurCfgJumbo=vlanCurCfgJumbo, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanMaxEnt=vlanMaxEnt, portStatsPhyIfInOctets=portStatsPhyIfInOctets, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, portStatsTable=portStatsTable, vlanNewCfgPorts=vlanNewCfgPorts, vlanNewCfgAddPort=vlanNewCfgAddPort, agPortConfig=agPortConfig, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, portCpuStats=portCpuStats, stgNewCfgAddVlan=stgNewCfgAddVlan, spannTreeGrpCfg=spannTreeGrpCfg, portInfoPhyIfMtu=portInfoPhyIfMtu, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, mirroring=mirroring, stgCurCfgStgIndex=stgCurCfgStgIndex, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portInfoFlowCtrl=portInfoFlowCtrl, agPortNewCfgPVID=agPortNewCfgPVID, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, trunkgroup=trunkgroup, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, stgNewCfgTableEntry=stgNewCfgTableEntry, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portCpuStatsUtilTable=portCpuStatsUtilTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, agPortTableMaxEnt=agPortTableMaxEnt, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, stgCurCfgPortTable=stgCurCfgPortTable, agPortNewCfgStp=agPortNewCfgStp, vlanNewCfgVlanName=vlanNewCfgVlanName, portInfoTable=portInfoTable, agPortCurCfgTable=agPortCurCfgTable, port_stats=port_stats, agPortNewCfgPortName=agPortNewCfgPortName, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, mirrOperState=mirrOperState, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, pmCurCfgMirroredPort=pmCurCfgMirroredPort, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, portInfoTableEntry=portInfoTableEntry, portInfoLink=portInfoLink, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgPortState=stgNewCfgPortState, mirrPortMirr=mirrPortMirr, agPortCurCfgPVID=agPortCurCfgPVID, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, agPortNewCfgPrefLink=agPortNewCfgPrefLink, pmCurCfgState=pmCurCfgState, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, stgCurCfgState=stgCurCfgState, stgCurCfgTable=stgCurCfgTable, portmirroring=portmirroring, mirrOperMonitoringPort=mirrOperMonitoringPort, vlanCurCfgPorts=vlanCurCfgPorts, portInfoMode=portInfoMode, pmCurCfgTimeout=pmCurCfgTimeout, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, agPortCurCfgPortName=agPortCurCfgPortName, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgCurCfgTableEntry=stgCurCfgTableEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, agPortCurCfgRmon=agPortCurCfgRmon, vlanCurCfgTable=vlanCurCfgTable, portStatsIndx=portStatsIndx, mirrOperTimeout=mirrOperTimeout, vlanNewCfgBwmContract=vlanNewCfgBwmContract, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, trunkGroupNewCfgState=trunkGroupNewCfgState, agPortCurCfgPrefLink=agPortCurCfgPrefLink, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, portInfoPhyIfDescr=portInfoPhyIfDescr, vlanNewCfgTable=vlanNewCfgTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, agPortCurCfgTableEntry=agPortCurCfgTableEntry, mirrOper=mirrOper, agPortNewCfgTableEntry=agPortNewCfgTableEntry, stgNewCfgPortIndex=stgNewCfgPortIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, stgNewCfgState=stgNewCfgState, agPortNewCfgRmon=agPortNewCfgRmon, pmNewCfgState=pmNewCfgState, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, mirrOperType=mirrOperType, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgIndex=stgNewCfgIndex, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, vlanNewCfgDelete=vlanNewCfgDelete, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, portInfoIndx=portInfoIndx, agPortNewCfgBackLink=agPortNewCfgBackLink, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, agPortCurCfgIndx=agPortCurCfgIndx, vlanCurCfgState=vlanCurCfgState, pmNewCfgTimeout=pmNewCfgTimeout)
