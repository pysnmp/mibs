...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, agPortNewCfgIndx=agPortNewCfgIndx, vlanNewCfgRemovePort=vlanNewCfgRemovePort, port_info=port_info, mirrOperState=mirrOperState, agPortCurCfgPortName=agPortCurCfgPortName, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, agPortNewCfgBwmContract=agPortNewCfgBwmContract, agPortTableMaxEnt=agPortTableMaxEnt, agPortNewCfgBackLink=agPortNewCfgBackLink, agPortCurCfgPrefLink=agPortCurCfgPrefLink, agPortCurCfgTableEntry=agPortCurCfgTableEntry, agPortNewCfgRmon=agPortNewCfgRmon, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portInfoTableEntry=portInfoTableEntry, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, trunkGroupCurCfgState=trunkGroupCurCfgState, portInfoIndx=portInfoIndx, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, pmCurCfgTimeout=pmCurCfgTimeout, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, stgNewCfgTable=stgNewCfgTable, agPortCurCfgIndx=agPortCurCfgIndx, stgCurCfgState=stgCurCfgState, mirrVlanMirr=mirrVlanMirr, pmNewCfgPortMirrState=pmNewCfgPortMirrState, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, vlanNewCfgState=vlanNewCfgState, agPortCurCfgPVID=agPortCurCfgPVID, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, portInfoLink=portInfoLink, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanNewCfgDelete=vlanNewCfgDelete, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, stgNewCfgStgIndex=stgNewCfgStgIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, trunkgroup=trunkgroup, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portCpuStatsUtilIndx=portCpuStatsUtilIndx, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanMaxEnt=vlanMaxEnt, vlanNewCfgJumbo=vlanNewCfgJumbo, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, agPortNewCfgState=agPortNewCfgState, stgNewCfgTableEntry=stgNewCfgTableEntry, agPortCurCfgState=agPortCurCfgState, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portInfoFlowCtrl=portInfoFlowCtrl, agPortNewCfgTable=agPortNewCfgTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCurCfgTableEntry=stgCurCfgTableEntry, mirrPortMirr=mirrPortMirr, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portStatsTable=portStatsTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanNewCfgBwmContract=vlanNewCfgBwmContract, agPortCurCfgBackLink=agPortCurCfgBackLink, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgTable=stgCurCfgTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, vlanCurCfgTable=vlanCurCfgTable, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, stgCurCfgPortIndex=stgCurCfgPortIndex, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortNewCfgPrefLink=agPortNewCfgPrefLink, vlanNewCfgVlanId=vlanNewCfgVlanId, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmCurCfgState=pmCurCfgState, vlanCurCfgPorts=vlanCurCfgPorts, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanNewCfgAddPort=vlanNewCfgAddPort, pmNewCfgTimeout=pmNewCfgTimeout, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, vlanCurCfgVlanName=vlanCurCfgVlanName, mirrOper=mirrOper, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, stgNewCfgPortState=stgNewCfgPortState, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgNewCfgPortTable=stgNewCfgPortTable, agPortCurCfgVlanTag=agPortCurCfgVlanTag, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, agPortCurCfgStp=agPortCurCfgStp, agPortNewCfgPVID=agPortNewCfgPVID, pmNewCfgMirroredPort=pmNewCfgMirroredPort, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlans=vlans, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, portmirroring=portmirroring, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgAddVlan=stgNewCfgAddVlan, mirrOperTimeout=mirrOperTimeout, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, spannTreeGrpCfg=spannTreeGrpCfg, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgPortTable=stgCurCfgPortTable, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, mirrOperType=mirrOperType, portInfoTable=portInfoTable, portInfoMode=portInfoMode, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portInfoPhyIfMtu=portInfoPhyIfMtu, pmCurCfgMirroredPort=pmCurCfgMirroredPort, agPortCurCfgTable=agPortCurCfgTable, port_stats=port_stats, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, agPortNewCfgTableEntry=agPortNewCfgTableEntry, agPortNewCfgStp=agPortNewCfgStp, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portCpuStats=portCpuStats, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, vlanCurCfgState=vlanCurCfgState, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, portInfoPhyIfLastChange=portInfoPhyIfLastChange, agPortNewCfgPortName=agPortNewCfgPortName, agPortCurCfgBwmContract=agPortCurCfgBwmContract, vlanCurCfgStg=vlanCurCfgStg, portCpuStatsUtilTable=portCpuStatsUtilTable, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, portStatsIndx=portStatsIndx, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, vlanCurCfgVlanId=vlanCurCfgVlanId, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portStatsPhyIfInErrors=portStatsPhyIfInErrors, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, agPortConfig=agPortConfig, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, mirrOperMirroredPort=mirrOperMirroredPort, agPortCurCfgRmon=agPortCurCfgRmon, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanNewCfgStg=vlanNewCfgStg, vlanNewCfgTable=vlanNewCfgTable, pmNewCfgState=pmNewCfgState, portStatsTableEntry=portStatsTableEntry, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, portInfoPhyIfType=portInfoPhyIfType, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, stgCurCfgIndex=stgCurCfgIndex, portInfoSpeed=portInfoSpeed, stgCurCfgPortState=stgCurCfgPortState, portStatsPhyIfInOctets=portStatsPhyIfInOctets, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, stgNewCfgState=stgNewCfgState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mirroring=mirroring, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortNewCfgVlanTag=agPortNewCfgVlanTag, stgNewCfgPortIndex=stgNewCfgPortIndex, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry)
