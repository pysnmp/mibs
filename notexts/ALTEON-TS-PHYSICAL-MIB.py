...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", mirrOperTimeout=mirrOperTimeout, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanNewCfgStg=vlanNewCfgStg, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, pmCurCfgMirroredPort=pmCurCfgMirroredPort, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgNewCfgState=stgNewCfgState, stgCurCfgTableEntry=stgCurCfgTableEntry, vlans=vlans, pmNewCfgMirroredPort=pmNewCfgMirroredPort, mirrPortMirr=mirrPortMirr, agPortNewCfgPrefLink=agPortNewCfgPrefLink, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, portInfoMode=portInfoMode, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, vlanCurCfgStg=vlanCurCfgStg, pmNewCfgPortMirrState=pmNewCfgPortMirrState, agPortNewCfgTableEntry=agPortNewCfgTableEntry, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, agPortConfig=agPortConfig, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgTable=stgNewCfgTable, portInfoTableEntry=portInfoTableEntry, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, mirrOper=mirrOper, agPortCurCfgBwmContract=agPortCurCfgBwmContract, vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, agPortNewCfgIndx=agPortNewCfgIndx, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, portInfoPhyIfLastChange=portInfoPhyIfLastChange, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgPortState=stgNewCfgPortState, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portInfoPhyIfDescr=portInfoPhyIfDescr, vlanMaxEnt=vlanMaxEnt, stgNewCfgTableEntry=stgNewCfgTableEntry, portInfoFlowCtrl=portInfoFlowCtrl, agPortCurCfgVlanTag=agPortCurCfgVlanTag, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mirrOperState=mirrOperState, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, pmNewCfgTimeout=pmNewCfgTimeout, stgNewCfgIndex=stgNewCfgIndex, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, agPortNewCfgPVID=agPortNewCfgPVID, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mirrOperMonitoringPort=mirrOperMonitoringPort, pmCurCfgState=pmCurCfgState, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmNewCfgState=pmNewCfgState, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, portInfoTable=portInfoTable, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portStatsPhyIfInErrors=portStatsPhyIfInErrors, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortNewCfgState=agPortNewCfgState, portStatsIndx=portStatsIndx, pmCurCfgTimeout=pmCurCfgTimeout, mirrOperType=mirrOperType, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, vlanCurCfgState=vlanCurCfgState, agPortCurCfgTableEntry=agPortCurCfgTableEntry, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, agPortNewCfgRmon=agPortNewCfgRmon, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, agPortCurCfgRmon=agPortCurCfgRmon, portStatsTableEntry=portStatsTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, port_stats=port_stats, stgCurCfgPortIndex=stgCurCfgPortIndex, agPortNewCfgBackLink=agPortNewCfgBackLink, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, agPortCurCfgState=agPortCurCfgState, agPortCurCfgTable=agPortCurCfgTable, vlanNewCfgState=vlanNewCfgState, mirrVlanMirr=mirrVlanMirr, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, agPortCurCfgBackLink=agPortCurCfgBackLink, portmirroring=portmirroring, agPortCurCfgPortName=agPortCurCfgPortName, stgNewCfgPortTable=stgNewCfgPortTable, agPortCurCfgIndx=agPortCurCfgIndx, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, port_info=port_info, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, vlanNewCfgPorts=vlanNewCfgPorts, vlanCurCfgVlanId=vlanCurCfgVlanId, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, vlanCurCfgJumbo=vlanCurCfgJumbo, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, agPortCurCfgPrefLink=agPortCurCfgPrefLink, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanNewCfgTable=vlanNewCfgTable, agPortNewCfgVlanTag=agPortNewCfgVlanTag, trunkGroupCurCfgState=trunkGroupCurCfgState, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgIndex=stgCurCfgIndex, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgPortTable=stgCurCfgPortTable, portInfoSpeed=portInfoSpeed, trunkgroup=trunkgroup, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portStatsPhyIfInOctets=portStatsPhyIfInOctets, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, agPortCurCfgStp=agPortCurCfgStp, portCpuStats=portCpuStats, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, stgNewCfgStgIndex=stgNewCfgStgIndex, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, agPortNewCfgBwmContract=agPortNewCfgBwmContract, agPortNewCfgTable=agPortNewCfgTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, stgCurCfgPortState=stgCurCfgPortState, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portInfoIndx=portInfoIndx, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, agPortTableMaxEnt=agPortTableMaxEnt, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, stgCurCfgTable=stgCurCfgTable, portInfoLink=portInfoLink, agPortNewCfgPortName=agPortNewCfgPortName, spannTreeGrpCfg=spannTreeGrpCfg, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupNewCfgState=trunkGroupNewCfgState, mirrOperMirroredPort=mirrOperMirroredPort, vlanNewCfgAddPort=vlanNewCfgAddPort, portInfoPhyIfType=portInfoPhyIfType, portStatsTable=portStatsTable, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portCpuStatsUtilIndx=portCpuStatsUtilIndx, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, mirroring=mirroring, agPortNewCfgStp=agPortNewCfgStp, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanCurCfgTable=vlanCurCfgTable, agPortCurCfgPVID=agPortCurCfgPVID, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, vlanNewCfgDelete=vlanNewCfgDelete, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portCpuStatsUtilTable=portCpuStatsUtilTable, stgNewCfgPortIndex=stgNewCfgPortIndex, stgCurCfgState=stgCurCfgState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, portInfoPhyIfMtu=portInfoPhyIfMtu)
