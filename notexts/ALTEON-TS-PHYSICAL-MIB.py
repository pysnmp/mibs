...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portInfoTable=portInfoTable, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, portInfoPhyIfType=portInfoPhyIfType, pmCurCfgTimeout=pmCurCfgTimeout, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, vlanCurCfgPorts=vlanCurCfgPorts, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, vlanCurCfgTable=vlanCurCfgTable, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, portInfoPhyIfLastChange=portInfoPhyIfLastChange, agPortCurCfgPVID=agPortCurCfgPVID, portStatsTableEntry=portStatsTableEntry, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, mirroring=mirroring, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, port_info=port_info, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mirrOperType=mirrOperType, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, port_stats=port_stats, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, vlanNewCfgTableEntry=vlanNewCfgTableEntry, agPortNewCfgTableEntry=agPortNewCfgTableEntry, agPortCurCfgBackLink=agPortCurCfgBackLink, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, agPortNewCfgStp=agPortNewCfgStp, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, agPortNewCfgPVID=agPortNewCfgPVID, vlanNewCfgPorts=vlanNewCfgPorts, agPortCurCfgTable=agPortCurCfgTable, trunkgroup=trunkgroup, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, stgNewCfgIndex=stgNewCfgIndex, agPortConfig=agPortConfig, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanNewCfgVlanId=vlanNewCfgVlanId, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, pmCurCfgState=pmCurCfgState, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanNewCfgDelete=vlanNewCfgDelete, portInfoPhyIfMtu=portInfoPhyIfMtu, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, agPortNewCfgVlanTag=agPortNewCfgVlanTag, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, vlanNewCfgAddPort=vlanNewCfgAddPort, agPortCurCfgState=agPortCurCfgState, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, vlanCurCfgBwmContract=vlanCurCfgBwmContract, agPortNewCfgPortName=agPortNewCfgPortName, stgCurCfgPortTable=stgCurCfgPortTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanCurCfgStg=vlanCurCfgStg, portInfoMode=portInfoMode, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, portCpuStats=portCpuStats, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, agPortNewCfgTable=agPortNewCfgTable, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, agPortCurCfgTableEntry=agPortCurCfgTableEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, vlanNewCfgState=vlanNewCfgState, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, portInfoLink=portInfoLink, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCurCfgTable=stgCurCfgTable, pmCurCfgMirroredPort=pmCurCfgMirroredPort, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanNewCfgVlanName=vlanNewCfgVlanName, portCpuStatsUtilTable=portCpuStatsUtilTable, pmNewCfgTimeout=pmNewCfgTimeout, agPortNewCfgIndx=agPortNewCfgIndx, agPortNewCfgBwmContract=agPortNewCfgBwmContract, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanCurCfgState=vlanCurCfgState, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, agPortCurCfgPrefLink=agPortCurCfgPrefLink, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, stgCurCfgPortState=stgCurCfgPortState, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, agPortCurCfgRmon=agPortCurCfgRmon, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, mirrOper=mirrOper, mirrVlanMirr=mirrVlanMirr, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, portmirroring=portmirroring, mirrPortMirr=mirrPortMirr, stgCurCfgIndex=stgCurCfgIndex, stgCurCfgState=stgCurCfgState, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, vlanNewCfgJumbo=vlanNewCfgJumbo, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, agPortCurCfgIndx=agPortCurCfgIndx, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgNewCfgPortIndex=stgNewCfgPortIndex, portStatsIndx=portStatsIndx, agPortTableMaxEnt=agPortTableMaxEnt, portStatsPhyIfInOctets=portStatsPhyIfInOctets, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, agPortNewCfgRmon=agPortNewCfgRmon, stgNewCfgPortTable=stgNewCfgPortTable, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, stgNewCfgTableEntry=stgNewCfgTableEntry, agPortCurCfgBwmContract=agPortCurCfgBwmContract, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanMaxEnt=vlanMaxEnt, portInfoSpeed=portInfoSpeed, agPortCurCfgVlanTag=agPortCurCfgVlanTag, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, portCpuStatsUtilIndx=portCpuStatsUtilIndx, stgNewCfgState=stgNewCfgState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgPortState=stgNewCfgPortState, portInfoPhyIfDescr=portInfoPhyIfDescr, spannTreeGrpCfg=spannTreeGrpCfg, agPortCurCfgPortName=agPortCurCfgPortName, agPortNewCfgBackLink=agPortNewCfgBackLink, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, pmNewCfgMirroredPort=pmNewCfgMirroredPort, mirrOperState=mirrOperState, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portStatsTable=portStatsTable, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanNewCfgStg=vlanNewCfgStg, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, stgNewCfgTable=stgNewCfgTable, portInfoTableEntry=portInfoTableEntry, portInfoIndx=portInfoIndx, agPortCurCfgStp=agPortCurCfgStp, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mirrOperMirroredPort=mirrOperMirroredPort, agPortNewCfgState=agPortNewCfgState, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portStatsPhyIfInErrors=portStatsPhyIfInErrors, mirrOperTimeout=mirrOperTimeout, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portInfoFlowCtrl=portInfoFlowCtrl, trunkGroupCurCfgState=trunkGroupCurCfgState, agPortNewCfgPrefLink=agPortNewCfgPrefLink, stgNewCfgAddVlan=stgNewCfgAddVlan, vlans=vlans, pmNewCfgState=pmNewCfgState, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, mirrOperMonitoringPort=mirrOperMonitoringPort, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, stgNewCfgStgIndex=stgNewCfgStgIndex)
