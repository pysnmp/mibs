...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", port_info=port_info, vlanNewCfgJumbo=vlanNewCfgJumbo, portInfoPhyIfLastChange=portInfoPhyIfLastChange, pmNewCfgMirroredPort=pmNewCfgMirroredPort, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, agPortNewCfgStp=agPortNewCfgStp, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgTable=stgNewCfgTable, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, vlanNewCfgAddPort=vlanNewCfgAddPort, portInfoTableEntry=portInfoTableEntry, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, agPortTableMaxEnt=agPortTableMaxEnt, agPortNewCfgState=agPortNewCfgState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mirrOper=mirrOper, vlanNewCfgDelete=vlanNewCfgDelete, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, vlanCurCfgVlanName=vlanCurCfgVlanName, agPortCurCfgIndx=agPortCurCfgIndx, agPortNewCfgRmon=agPortNewCfgRmon, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, stgCurCfgPortState=stgCurCfgPortState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmCurCfgTimeout=pmCurCfgTimeout, portInfoTable=portInfoTable, portStatsIndx=portStatsIndx, agPortNewCfgPortName=agPortNewCfgPortName, portStatsPhyIfInErrors=portStatsPhyIfInErrors, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, trunkGroupNewCfgState=trunkGroupNewCfgState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanNewCfgBwmContract=vlanNewCfgBwmContract, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, portInfoPhyIfDescr=portInfoPhyIfDescr, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, agPortCurCfgStp=agPortCurCfgStp, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portCpuStatsUtilTable=portCpuStatsUtilTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanNewCfgTable=vlanNewCfgTable, portCpuStats=portCpuStats, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, pmCurCfgMirroredPort=pmCurCfgMirroredPort, agPortCurCfgPrefLink=agPortCurCfgPrefLink, portStatsTable=portStatsTable, vlanNewCfgVlanName=vlanNewCfgVlanName, agPortCurCfgTableEntry=agPortCurCfgTableEntry, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmNewCfgState=pmNewCfgState, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, vlanMaxEnt=vlanMaxEnt, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, agPortCurCfgRmon=agPortCurCfgRmon, stgNewCfgAddVlan=stgNewCfgAddVlan, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortNewCfgBwmContract=agPortNewCfgBwmContract, stgNewCfgState=stgNewCfgState, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, agPortCurCfgBackLink=agPortCurCfgBackLink, trunkGroupCurCfgState=trunkGroupCurCfgState, portInfoPhyIfType=portInfoPhyIfType, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, agPortCurCfgState=agPortCurCfgState, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, agPortNewCfgVlanTag=agPortNewCfgVlanTag, stgNewCfgPortIndex=stgNewCfgPortIndex, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, mirrOperType=mirrOperType, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, agPortCurCfgPortName=agPortCurCfgPortName, mirrVlanMirr=mirrVlanMirr, agPortNewCfgTableEntry=agPortNewCfgTableEntry, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, stgCurCfgState=stgCurCfgState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, portInfoFlowCtrl=portInfoFlowCtrl, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, vlanCurCfgJumbo=vlanCurCfgJumbo, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, pmNewCfgTimeout=pmNewCfgTimeout, portInfoPhyIfMtu=portInfoPhyIfMtu, portStatsTableEntry=portStatsTableEntry, spannTreeGrpCfg=spannTreeGrpCfg, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, port_stats=port_stats, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portCpuStatsUtilIndx=portCpuStatsUtilIndx, stgCurCfgStgIndex=stgCurCfgStgIndex, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, agPortNewCfgIndx=agPortNewCfgIndx, stgNewCfgStgIndex=stgNewCfgStgIndex, mirrOperMirroredPort=mirrOperMirroredPort, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portInfoSpeed=portInfoSpeed, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, portStatsPhyIfInOctets=portStatsPhyIfInOctets, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, vlanCurCfgStg=vlanCurCfgStg, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, vlanNewCfgVlanId=vlanNewCfgVlanId, agPortCurCfgBwmContract=agPortCurCfgBwmContract, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, agPortCurCfgVlanTag=agPortCurCfgVlanTag, vlanNewCfgState=vlanNewCfgState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, agPortNewCfgTable=agPortNewCfgTable, agPortNewCfgPVID=agPortNewCfgPVID, stgCurCfgTable=stgCurCfgTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgPortTable=stgCurCfgPortTable, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgPortState=stgNewCfgPortState, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, vlanCurCfgState=vlanCurCfgState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, mirrPortMirr=mirrPortMirr, stgCurCfgTableEntry=stgCurCfgTableEntry, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, trunkgroup=trunkgroup, stgNewCfgIndex=stgNewCfgIndex, agPortCurCfgTable=agPortCurCfgTable, mirroring=mirroring, vlanCurCfgVlanId=vlanCurCfgVlanId, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, agPortConfig=agPortConfig, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, portInfoMode=portInfoMode, vlanCurCfgTable=vlanCurCfgTable, portmirroring=portmirroring, vlans=vlans, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, agPortNewCfgPrefLink=agPortNewCfgPrefLink, portInfoIndx=portInfoIndx, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanNewCfgStg=vlanNewCfgStg, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, mirrOperState=mirrOperState, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgNewCfgPortTable=stgNewCfgPortTable, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanCurCfgPorts=vlanCurCfgPorts, mirrOperTimeout=mirrOperTimeout, pmCurCfgState=pmCurCfgState, agPortNewCfgBackLink=agPortNewCfgBackLink, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, portInfoLink=portInfoLink, mirrOperMonitoringPort=mirrOperMonitoringPort, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortCurCfgPVID=agPortCurCfgPVID, trunkGroupTableMaxSize=trunkGroupTableMaxSize, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, vlanNewCfgPorts=vlanNewCfgPorts, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards)
