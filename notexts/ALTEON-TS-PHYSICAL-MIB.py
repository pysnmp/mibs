...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, portInfoIndx=portInfoIndx, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, stgNewCfgTable=stgNewCfgTable, agPortNewCfgBwmContract=agPortNewCfgBwmContract, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, spannTreeGrpCfg=spannTreeGrpCfg, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, portCpuStatsUtilTable=portCpuStatsUtilTable, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, agPortNewCfgTableEntry=agPortNewCfgTableEntry, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, agPortNewCfgPortName=agPortNewCfgPortName, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortNewCfgBackLink=agPortNewCfgBackLink, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, agPortCurCfgBwmContract=agPortCurCfgBwmContract, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, vlanNewCfgPorts=vlanNewCfgPorts, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, vlanNewCfgDelete=vlanNewCfgDelete, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, agPortNewCfgRmon=agPortNewCfgRmon, stgCurCfgStgIndex=stgCurCfgStgIndex, agPortCurCfgTable=agPortCurCfgTable, stgNewCfgAddVlan=stgNewCfgAddVlan, mirroring=mirroring, agPortNewCfgPrefLink=agPortNewCfgPrefLink, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortCurCfgPrefLink=agPortCurCfgPrefLink, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, mirrOperType=mirrOperType, mirrOperTimeout=mirrOperTimeout, portInfoMode=portInfoMode, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, stgCurCfgPortState=stgCurCfgPortState, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgIndex=stgNewCfgIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portInfoTable=portInfoTable, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgState=stgNewCfgState, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mirrVlanMirr=mirrVlanMirr, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanNewCfgJumbo=vlanNewCfgJumbo, portStatsPhyIfInErrors=portStatsPhyIfInErrors, trunkGroupNewCfgTable=trunkGroupNewCfgTable, port_info=port_info, portInfoPhyIfMtu=portInfoPhyIfMtu, stgCurCfgTableEntry=stgCurCfgTableEntry, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, portStatsPhyIfInOctets=portStatsPhyIfInOctets, stgNewCfgTableEntry=stgNewCfgTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanCurCfgVlanName=vlanCurCfgVlanName, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, pmNewCfgState=pmNewCfgState, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, portInfoFlowCtrl=portInfoFlowCtrl, portStatsIndx=portStatsIndx, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, vlanNewCfgStg=vlanNewCfgStg, agPortCurCfgPVID=agPortCurCfgPVID, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, pmCurCfgPortMirrState=pmCurCfgPortMirrState, agPortCurCfgIndx=agPortCurCfgIndx, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, portInfoTableEntry=portInfoTableEntry, mirrOper=mirrOper, vlanNewCfgAddPort=vlanNewCfgAddPort, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, agPortNewCfgTable=agPortNewCfgTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, agPortTableMaxEnt=agPortTableMaxEnt, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, trunkGroupCurCfgState=trunkGroupCurCfgState, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, pmNewCfgMirroredPort=pmNewCfgMirroredPort, vlanCurCfgStg=vlanCurCfgStg, vlanCurCfgVlanId=vlanCurCfgVlanId, portCpuStatsUtilIndx=portCpuStatsUtilIndx, agPortCurCfgVlanTag=agPortCurCfgVlanTag, vlanMaxEnt=vlanMaxEnt, pmCurCfgTimeout=pmCurCfgTimeout, port_stats=port_stats, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, stgNewCfgPortIndex=stgNewCfgPortIndex, pmCurCfgState=pmCurCfgState, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, mirrOperMirroredPort=mirrOperMirroredPort, stgNewCfgPortState=stgNewCfgPortState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgNewCfgStgIndex=stgNewCfgStgIndex, agPortCurCfgBackLink=agPortCurCfgBackLink, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, portmirroring=portmirroring, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, agPortCurCfgPortName=agPortCurCfgPortName, mirrPortMirr=mirrPortMirr, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, stgCurCfgPortIndex=stgCurCfgPortIndex, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, agPortNewCfgPVID=agPortNewCfgPVID, stgNewCfgPortTable=stgNewCfgPortTable, vlanNewCfgVlanName=vlanNewCfgVlanName, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, portStatsTable=portStatsTable, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, stgCurCfgState=stgCurCfgState, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, pmNewCfgTimeout=pmNewCfgTimeout, pmCurCfgMirroredPort=pmCurCfgMirroredPort, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, portStatsTableEntry=portStatsTableEntry, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portInfoLink=portInfoLink, vlans=vlans, agPortCurCfgStp=agPortCurCfgStp, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, mirrOperState=mirrOperState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, agPortCurCfgTableEntry=agPortCurCfgTableEntry, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, vlanCurCfgTable=vlanCurCfgTable, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, stgCurCfgPortTable=stgCurCfgPortTable, vlanNewCfgState=vlanNewCfgState, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, agPortNewCfgVlanTag=agPortNewCfgVlanTag, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, vlanNewCfgTable=vlanNewCfgTable, portCpuStats=portCpuStats, agPortNewCfgIndx=agPortNewCfgIndx, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, agPortConfig=agPortConfig, agPortNewCfgState=agPortNewCfgState, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, portInfoPhyIfType=portInfoPhyIfType, trunkgroup=trunkgroup, portInfoSpeed=portInfoSpeed, stgCurCfgIndex=stgCurCfgIndex, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, vlanCurCfgState=vlanCurCfgState, agPortCurCfgState=agPortCurCfgState, agPortCurCfgRmon=agPortCurCfgRmon, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, stgCurCfgTable=stgCurCfgTable, portInfoPhyIfLastChange=portInfoPhyIfLastChange, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, agPortNewCfgStp=agPortNewCfgStp)
