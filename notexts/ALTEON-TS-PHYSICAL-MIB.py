...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", mirrPortMirr=mirrPortMirr, portmirroring=portmirroring, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, agPortCurCfgVlanTag=agPortCurCfgVlanTag, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, vlanNewCfgRemovePort=vlanNewCfgRemovePort, agPortCurCfgPrefLink=agPortCurCfgPrefLink, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgTableEntry=stgNewCfgTableEntry, portInfoLink=portInfoLink, portInfoPhyIfType=portInfoPhyIfType, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, stgNewCfgState=stgNewCfgState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgCurCfgPortState=stgCurCfgPortState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlanCurCfgVlanId=vlanCurCfgVlanId, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, agPortNewCfgBackLink=agPortNewCfgBackLink, trunkGroupCurCfgTable=trunkGroupCurCfgTable, agPortCurCfgTable=agPortCurCfgTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, port_info=port_info, stgCurCfgPortIndex=stgCurCfgPortIndex, portInfoSpeed=portInfoSpeed, agPortCurCfgPVID=agPortCurCfgPVID, vlans=vlans, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mirrOperState=mirrOperState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, vlanCurCfgStg=vlanCurCfgStg, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgPortTable=stgNewCfgPortTable, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, agPortNewCfgState=agPortNewCfgState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, pmNewCfgState=pmNewCfgState, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, pmNewCfgMirroredPort=pmNewCfgMirroredPort, stgCurCfgTableEntry=stgCurCfgTableEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, trunkGroupCurCfgState=trunkGroupCurCfgState, portInfoMode=portInfoMode, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portStatsTable=portStatsTable, portStatsPhyIfInOctets=portStatsPhyIfInOctets, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, portInfoIndx=portInfoIndx, agPortCurCfgTableEntry=agPortCurCfgTableEntry, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, vlanMaxEnt=vlanMaxEnt, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, agPortNewCfgStp=agPortNewCfgStp, agPortNewCfgPrefLink=agPortNewCfgPrefLink, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, trunkgroup=trunkgroup, agPortCurCfgStp=agPortCurCfgStp, vlanCurCfgPorts=vlanCurCfgPorts, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, pmNewCfgTimeout=pmNewCfgTimeout, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, portStatsTableEntry=portStatsTableEntry, agPortNewCfgBwmContract=agPortNewCfgBwmContract, agPortTableMaxEnt=agPortTableMaxEnt, stgNewCfgIndex=stgNewCfgIndex, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, portCpuStatsUtilTable=portCpuStatsUtilTable, port_stats=port_stats, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, stgCurCfgStgIndex=stgCurCfgStgIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanNewCfgDelete=vlanNewCfgDelete, portInfoFlowCtrl=portInfoFlowCtrl, spannTreeGrpCfg=spannTreeGrpCfg, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, stgCurCfgState=stgCurCfgState, vlanNewCfgTable=vlanNewCfgTable, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, agPortCurCfgBackLink=agPortCurCfgBackLink, mirrOperMonitoringPort=mirrOperMonitoringPort, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portInfoTable=portInfoTable, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, mirroring=mirroring, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, agPortNewCfgTableEntry=agPortNewCfgTableEntry, portStatsPhyIfInErrors=portStatsPhyIfInErrors, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, agPortNewCfgVlanTag=agPortNewCfgVlanTag, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, portCpuStats=portCpuStats, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, vlanNewCfgState=vlanNewCfgState, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgNewCfgTable=stgNewCfgTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgPortState=stgNewCfgPortState, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanCurCfgState=vlanCurCfgState, vlanNewCfgAddPort=vlanNewCfgAddPort, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, agPortNewCfgPVID=agPortNewCfgPVID, agPortConfig=agPortConfig, vlanCurCfgTable=vlanCurCfgTable, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, agPortNewCfgTable=agPortNewCfgTable, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, pmCurCfgTimeout=pmCurCfgTimeout, mirrOper=mirrOper, agPortCurCfgIndx=agPortCurCfgIndx, pmCurCfgState=pmCurCfgState, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, mirrOperMirroredPort=mirrOperMirroredPort, agPortNewCfgPortName=agPortNewCfgPortName, agPortCurCfgState=agPortCurCfgState, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, agPortCurCfgPortName=agPortCurCfgPortName, agPortCurCfgRmon=agPortCurCfgRmon, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgIndex=stgCurCfgIndex, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, vlanNewCfgJumbo=vlanNewCfgJumbo, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, vlanNewCfgStg=vlanNewCfgStg, portInfoPhyIfLastChange=portInfoPhyIfLastChange, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portStatsIndx=portStatsIndx, pmCurCfgMirroredPort=pmCurCfgMirroredPort, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, agPortCurCfgBwmContract=agPortCurCfgBwmContract, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, stgCurCfgPortTable=stgCurCfgPortTable, mirrOperType=mirrOperType, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, agPortNewCfgRmon=agPortNewCfgRmon, portInfoTableEntry=portInfoTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, agPortNewCfgIndx=agPortNewCfgIndx, portCpuStatsUtilIndx=portCpuStatsUtilIndx, stgCurCfgTable=stgCurCfgTable, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, mirrVlanMirr=mirrVlanMirr, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanNewCfgPorts=vlanNewCfgPorts, mirrOperTimeout=mirrOperTimeout, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, portInfoPhyIfMtu=portInfoPhyIfMtu, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, vlanNewCfgTableEntry=vlanNewCfgTableEntry)
