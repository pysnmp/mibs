...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", vlanCurCfgVlanName=vlanCurCfgVlanName, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, agPortNewCfgTable=agPortNewCfgTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, agPortCurCfgState=agPortCurCfgState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanCurCfgVlanId=vlanCurCfgVlanId, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, portInfoTable=portInfoTable, pmCurCfgMirroredPort=pmCurCfgMirroredPort, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, trunkGroupCurCfgState=trunkGroupCurCfgState, portCpuStatsUtilTable=portCpuStatsUtilTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, portInfoPhyIfMtu=portInfoPhyIfMtu, agPortCurCfgBwmContract=agPortCurCfgBwmContract, agPortCurCfgBackLink=agPortCurCfgBackLink, vlanCurCfgTable=vlanCurCfgTable, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, agPortCurCfgVlanTag=agPortCurCfgVlanTag, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, stgCurCfgTable=stgCurCfgTable, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, spannTreeGrpCfg=spannTreeGrpCfg, trunkGroupNewCfgState=trunkGroupNewCfgState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortCurCfgPortName=agPortCurCfgPortName, stgCurCfgPortState=stgCurCfgPortState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, agPortNewCfgState=agPortNewCfgState, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portInfoFlowCtrl=portInfoFlowCtrl, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgPortTable=stgNewCfgPortTable, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, portStatsTable=portStatsTable, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, port_info=port_info, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, portInfoLink=portInfoLink, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, agPortConfig=agPortConfig, mirrOperMirroredPort=mirrOperMirroredPort, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, agPortNewCfgPortName=agPortNewCfgPortName, vlanCurCfgJumbo=vlanCurCfgJumbo, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, stgNewCfgState=stgNewCfgState, mirrPortMirr=mirrPortMirr, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, portInfoSpeed=portInfoSpeed, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, pmNewCfgTimeout=pmNewCfgTimeout, pmNewCfgState=pmNewCfgState, agPortCurCfgTable=agPortCurCfgTable, vlanCurCfgStg=vlanCurCfgStg, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgTable=stgNewCfgTable, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, portInfoIndx=portInfoIndx, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgPortIndex=stgCurCfgPortIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmCurCfgState=pmCurCfgState, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, portInfoTableEntry=portInfoTableEntry, agPortNewCfgRmon=agPortNewCfgRmon, agPortNewCfgPrefLink=agPortNewCfgPrefLink, portInfoPhyIfLastChange=portInfoPhyIfLastChange, stgNewCfgPortState=stgNewCfgPortState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, agPortCurCfgRmon=agPortCurCfgRmon, vlans=vlans, stgNewCfgIndex=stgNewCfgIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, agPortNewCfgBackLink=agPortNewCfgBackLink, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, stgCurCfgStgIndex=stgCurCfgStgIndex, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, vlanNewCfgVlanName=vlanNewCfgVlanName, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, mirroring=mirroring, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgCurCfgTableEntry=stgCurCfgTableEntry, portStatsPhyIfInErrors=portStatsPhyIfInErrors, mirrOperState=mirrOperState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, agPortNewCfgStp=agPortNewCfgStp, portInfoPhyIfType=portInfoPhyIfType, mirrVlanMirr=mirrVlanMirr, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, portCpuStats=portCpuStats, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, portmirroring=portmirroring, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgState=stgCurCfgState, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, vlanCurCfgBwmContract=vlanCurCfgBwmContract, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, vlanNewCfgJumbo=vlanNewCfgJumbo, pmNewCfgMirroredPort=pmNewCfgMirroredPort, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, portStatsIndx=portStatsIndx, agPortCurCfgPVID=agPortCurCfgPVID, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlanMaxEnt=vlanMaxEnt, agPortNewCfgVlanTag=agPortNewCfgVlanTag, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanNewCfgVlanId=vlanNewCfgVlanId, portCpuStatsUtilIndx=portCpuStatsUtilIndx, vlanNewCfgTable=vlanNewCfgTable, port_stats=port_stats, agPortCurCfgStp=agPortCurCfgStp, mirrOperType=mirrOperType, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, pmCurCfgPortMirrState=pmCurCfgPortMirrState, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, portStatsPhyIfInOctets=portStatsPhyIfInOctets, agPortNewCfgBwmContract=agPortNewCfgBwmContract, stgNewCfgTableEntry=stgNewCfgTableEntry, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, agPortNewCfgTableEntry=agPortNewCfgTableEntry, stgCurCfgIndex=stgCurCfgIndex, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, vlanNewCfgPorts=vlanNewCfgPorts, agPortCurCfgPrefLink=agPortCurCfgPrefLink, vlanCurCfgState=vlanCurCfgState, stgCurCfgPortTable=stgCurCfgPortTable, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, mirrOperTimeout=mirrOperTimeout, agPortCurCfgTableEntry=agPortCurCfgTableEntry, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, vlanNewCfgDelete=vlanNewCfgDelete, portInfoMode=portInfoMode, agPortCurCfgIndx=agPortCurCfgIndx, stgNewCfgPortIndex=stgNewCfgPortIndex, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portInfoPhyIfDescr=portInfoPhyIfDescr, mirrOper=mirrOper, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, agPortNewCfgIndx=agPortNewCfgIndx, portStatsTableEntry=portStatsTableEntry, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, trunkgroup=trunkgroup, vlanNewCfgStg=vlanNewCfgStg, agPortTableMaxEnt=agPortTableMaxEnt, agPortNewCfgPVID=agPortNewCfgPVID, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmCurCfgTimeout=pmCurCfgTimeout, stgNewCfgAddVlan=stgNewCfgAddVlan, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanNewCfgState=vlanNewCfgState, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, vlanNewCfgAddPort=vlanNewCfgAddPort, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1)
