...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", portInfoTable=portInfoTable, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanNewCfgBwmContract=vlanNewCfgBwmContract, pmNewCfgTimeout=pmNewCfgTimeout, stgCurCfgPortIndex=stgCurCfgPortIndex, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, vlanNewCfgDelete=vlanNewCfgDelete, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgCurCfgState=stgCurCfgState, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, mirroring=mirroring, mirrOperMonitoringPort=mirrOperMonitoringPort, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, spannTreeGrpCfg=spannTreeGrpCfg, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portInfoTableEntry=portInfoTableEntry, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgCurCfgPortState=stgCurCfgPortState, stgNewCfgTable=stgNewCfgTable, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, mirrOperTimeout=mirrOperTimeout, agPortNewCfgStp=agPortNewCfgStp, agPortCurCfgVlanTag=agPortCurCfgVlanTag, agPortConfig=agPortConfig, portStatsPhyIfInOctets=portStatsPhyIfInOctets, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, stgCurCfgIndex=stgCurCfgIndex, agPortNewCfgState=agPortNewCfgState, stgNewCfgPortIndex=stgNewCfgPortIndex, agPortCurCfgPVID=agPortCurCfgPVID, port_info=port_info, stgCurCfgTable=stgCurCfgTable, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, agPortCurCfgIndx=agPortCurCfgIndx, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portStatsPhyIfInErrors=portStatsPhyIfInErrors, stgNewCfgIndex=stgNewCfgIndex, vlanNewCfgStg=vlanNewCfgStg, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, mirrOperState=mirrOperState, mirrPortMirr=mirrPortMirr, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, agPortNewCfgPortName=agPortNewCfgPortName, stgNewCfgState=stgNewCfgState, vlanNewCfgVlanId=vlanNewCfgVlanId, portInfoSpeed=portInfoSpeed, agPortNewCfgBwmContract=agPortNewCfgBwmContract, agPortCurCfgState=agPortCurCfgState, trunkGroupNewCfgState=trunkGroupNewCfgState, agPortNewCfgBackLink=agPortNewCfgBackLink, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgCurCfgTableEntry=stgCurCfgTableEntry, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portInfoLink=portInfoLink, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, agPortNewCfgPrefLink=agPortNewCfgPrefLink, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, agPortCurCfgBackLink=agPortCurCfgBackLink, vlanCurCfgTable=vlanCurCfgTable, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, agPortCurCfgTableEntry=agPortCurCfgTableEntry, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, vlanCurCfgVlanName=vlanCurCfgVlanName, pmNewCfgState=pmNewCfgState, agPortNewCfgIndx=agPortNewCfgIndx, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgNewCfgPortState=stgNewCfgPortState, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, agPortCurCfgPrefLink=agPortCurCfgPrefLink, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, vlanCurCfgVlanId=vlanCurCfgVlanId, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, vlanNewCfgState=vlanNewCfgState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portStatsTable=portStatsTable, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, agPortNewCfgTableEntry=agPortNewCfgTableEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, agPortCurCfgBwmContract=agPortCurCfgBwmContract, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portInfoPhyIfType=portInfoPhyIfType, portInfoPhyIfLastChange=portInfoPhyIfLastChange, vlanNewCfgPorts=vlanNewCfgPorts, agPortNewCfgVlanTag=agPortNewCfgVlanTag, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, vlans=vlans, stgNewCfgTableEntry=stgNewCfgTableEntry, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmCurCfgState=pmCurCfgState, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanNewCfgTable=vlanNewCfgTable, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanMaxEnt=vlanMaxEnt, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, agPortNewCfgPVID=agPortNewCfgPVID, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portStatsTableEntry=portStatsTableEntry, stgCurCfgPortTable=stgCurCfgPortTable, mirrOper=mirrOper, agPortCurCfgStp=agPortCurCfgStp, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, mirrVlanMirr=mirrVlanMirr, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, pmCurCfgMirroredPort=pmCurCfgMirroredPort, portCpuStatsUtilTable=portCpuStatsUtilTable, port_stats=port_stats, portInfoFlowCtrl=portInfoFlowCtrl, mirrOperMirroredPort=mirrOperMirroredPort, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, vlanCurCfgState=vlanCurCfgState, pmCurCfgTimeout=pmCurCfgTimeout, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, portInfoIndx=portInfoIndx, vlanCurCfgStg=vlanCurCfgStg, stgNewCfgAddVlan=stgNewCfgAddVlan, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, portmirroring=portmirroring, vlanNewCfgVlanName=vlanNewCfgVlanName, agPortNewCfgTable=agPortNewCfgTable, vlanNewCfgJumbo=vlanNewCfgJumbo, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, portInfoMode=portInfoMode, vlanNewCfgAddPort=vlanNewCfgAddPort, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, agPortCurCfgTable=agPortCurCfgTable, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portStatsIndx=portStatsIndx, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, portCpuStats=portCpuStats, pmNewCfgMirroredPort=pmNewCfgMirroredPort, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, portInfoPhyIfMtu=portInfoPhyIfMtu, agPortNewCfgRmon=agPortNewCfgRmon, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, portInfoPhyIfDescr=portInfoPhyIfDescr, mirrOperType=mirrOperType, trunkgroup=trunkgroup, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, agPortTableMaxEnt=agPortTableMaxEnt, agPortCurCfgRmon=agPortCurCfgRmon, agPortCurCfgPortName=agPortCurCfgPortName, portCpuStatsUtilIndx=portCpuStatsUtilIndx, stgNewCfgPortTable=stgNewCfgPortTable, trunkGroupCurCfgState=trunkGroupCurCfgState)
