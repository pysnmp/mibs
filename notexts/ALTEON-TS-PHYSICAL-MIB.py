...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", agPortCurCfgStp=agPortCurCfgStp, port_stats=port_stats, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, agPortNewCfgTable=agPortNewCfgTable, portInfoSpeed=portInfoSpeed, agPortCurCfgVlanTag=agPortCurCfgVlanTag, agPortCurCfgRmon=agPortCurCfgRmon, portInfoFlowCtrl=portInfoFlowCtrl, vlanCurCfgVlanName=vlanCurCfgVlanName, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portInfoLink=portInfoLink, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanCurCfgState=vlanCurCfgState, stgNewCfgAddVlan=stgNewCfgAddVlan, agPortNewCfgPortName=agPortNewCfgPortName, pmNewCfgState=pmNewCfgState, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, mirrOperMirroredPort=mirrOperMirroredPort, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, portCpuStatsUtilTable=portCpuStatsUtilTable, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgTable=stgNewCfgTable, vlanMaxEnt=vlanMaxEnt, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, mirrOper=mirrOper, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgState=stgNewCfgState, agPortNewCfgState=agPortNewCfgState, agPortCurCfgTable=agPortCurCfgTable, stgCurCfgPortState=stgCurCfgPortState, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, stgNewCfgStgIndex=stgNewCfgStgIndex, agPortNewCfgRmon=agPortNewCfgRmon, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, vlanNewCfgVlanName=vlanNewCfgVlanName, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, stgCurCfgStgIndex=stgCurCfgStgIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, agPortNewCfgPVID=agPortNewCfgPVID, portStatsPhyIfInOctets=portStatsPhyIfInOctets, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, portInfoPhyIfMtu=portInfoPhyIfMtu, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmCurCfgTimeout=pmCurCfgTimeout, agPortNewCfgTableEntry=agPortNewCfgTableEntry, vlanCurCfgStg=vlanCurCfgStg, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, stgNewCfgTableEntry=stgNewCfgTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanNewCfgState=vlanNewCfgState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortCurCfgPortName=agPortCurCfgPortName, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupCurCfgState=trunkGroupCurCfgState, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, stgCurCfgTable=stgCurCfgTable, portStatsTable=portStatsTable, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, stgNewCfgPortState=stgNewCfgPortState, agPortNewCfgBwmContract=agPortNewCfgBwmContract, portmirroring=portmirroring, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgIndex=stgNewCfgIndex, portCpuStats=portCpuStats, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, pmNewCfgMirroredPort=pmNewCfgMirroredPort, portInfoPhyIfLastChange=portInfoPhyIfLastChange, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portStatsPhyIfInErrors=portStatsPhyIfInErrors, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, agPortNewCfgIndx=agPortNewCfgIndx, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mirrOperType=mirrOperType, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgStg=vlanNewCfgStg, portInfoTable=portInfoTable, stgCurCfgPortTable=stgCurCfgPortTable, portInfoTableEntry=portInfoTableEntry, agPortCurCfgState=agPortCurCfgState, vlanCurCfgVlanId=vlanCurCfgVlanId, agPortTableMaxEnt=agPortTableMaxEnt, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, portStatsIndx=portStatsIndx, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, agPortCurCfgBackLink=agPortCurCfgBackLink, stgNewCfgPortTable=stgNewCfgPortTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, agPortCurCfgBwmContract=agPortCurCfgBwmContract, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, mirrOperTimeout=mirrOperTimeout, mirrOperState=mirrOperState, portStatsTableEntry=portStatsTableEntry, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, vlanNewCfgJumbo=vlanNewCfgJumbo, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, agPortCurCfgPVID=agPortCurCfgPVID, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, pmCurCfgState=pmCurCfgState, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, agPortNewCfgStp=agPortNewCfgStp, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, mirrOperMonitoringPort=mirrOperMonitoringPort, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, agPortCurCfgIndx=agPortCurCfgIndx, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, mirrVlanMirr=mirrVlanMirr, agPortCurCfgPrefLink=agPortCurCfgPrefLink, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, agPortNewCfgPrefLink=agPortNewCfgPrefLink, vlanCurCfgJumbo=vlanCurCfgJumbo, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portInfoIndx=portInfoIndx, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, trunkgroup=trunkgroup, vlanCurCfgTable=vlanCurCfgTable, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupNewCfgState=trunkGroupNewCfgState, portCpuStatsUtilIndx=portCpuStatsUtilIndx, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, stgCurCfgIndex=stgCurCfgIndex, agPortConfig=agPortConfig, portInfoMode=portInfoMode, agPortNewCfgVlanTag=agPortNewCfgVlanTag, spannTreeGrpCfg=spannTreeGrpCfg, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanNewCfgDelete=vlanNewCfgDelete, vlans=vlans, portInfoPhyIfType=portInfoPhyIfType, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, port_info=port_info, mirroring=mirroring, agPortCurCfgTableEntry=agPortCurCfgTableEntry, agPortNewCfgBackLink=agPortNewCfgBackLink, mirrPortMirr=mirrPortMirr, stgCurCfgState=stgCurCfgState, pmNewCfgTimeout=pmNewCfgTimeout, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, vlanNewCfgAddPort=vlanNewCfgAddPort, stgCurCfgPortIndex=stgCurCfgPortIndex, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, pmCurCfgMirroredPort=pmCurCfgMirroredPort, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap)
