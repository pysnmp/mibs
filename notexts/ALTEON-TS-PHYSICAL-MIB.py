...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", vlanCurCfgPorts=vlanCurCfgPorts, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, portInfoPhyIfDescr=portInfoPhyIfDescr, portStatsPhyIfInOctets=portStatsPhyIfInOctets, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, agPortNewCfgBackLink=agPortNewCfgBackLink, portInfoMode=portInfoMode, agPortCurCfgTableEntry=agPortCurCfgTableEntry, portInfoTableEntry=portInfoTableEntry, agPortCurCfgPortName=agPortCurCfgPortName, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanNewCfgStg=vlanNewCfgStg, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgPortState=stgCurCfgPortState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgTableEntry=stgNewCfgTableEntry, agPortCurCfgStp=agPortCurCfgStp, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, agPortNewCfgTable=agPortNewCfgTable, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, pmCurCfgState=pmCurCfgState, portCpuStats=portCpuStats, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, portStatsPhyIfInErrors=portStatsPhyIfInErrors, vlanCurCfgState=vlanCurCfgState, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, vlanCurCfgVlanId=vlanCurCfgVlanId, agPortCurCfgVlanTag=agPortCurCfgVlanTag, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanNewCfgTableEntry=vlanNewCfgTableEntry, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, agPortNewCfgPrefLink=agPortNewCfgPrefLink, stgCurCfgState=stgCurCfgState, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, agPortNewCfgStp=agPortNewCfgStp, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, agPortCurCfgIndx=agPortCurCfgIndx, portStatsIndx=portStatsIndx, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgStgIndex=stgCurCfgStgIndex, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, pmCurCfgMirroredPort=pmCurCfgMirroredPort, stgCurCfgTable=stgCurCfgTable, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, portInfoSpeed=portInfoSpeed, vlanCurCfgTable=vlanCurCfgTable, trunkgroup=trunkgroup, agPortNewCfgBwmContract=agPortNewCfgBwmContract, spannTreeGrpCfg=spannTreeGrpCfg, mirroring=mirroring, trunkGroupNewCfgState=trunkGroupNewCfgState, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, portmirroring=portmirroring, agPortCurCfgRmon=agPortCurCfgRmon, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mirrOperType=mirrOperType, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgTable=stgNewCfgTable, agPortCurCfgTable=agPortCurCfgTable, agPortNewCfgPortName=agPortNewCfgPortName, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, vlanNewCfgVlanId=vlanNewCfgVlanId, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmNewCfgTimeout=pmNewCfgTimeout, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, stgNewCfgPortState=stgNewCfgPortState, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, vlanNewCfgState=vlanNewCfgState, vlanNewCfgDelete=vlanNewCfgDelete, agPortNewCfgState=agPortNewCfgState, vlanNewCfgVlanName=vlanNewCfgVlanName, mirrPortMirr=mirrPortMirr, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, agPortNewCfgVlanTag=agPortNewCfgVlanTag, agPortTableMaxEnt=agPortTableMaxEnt, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portInfoPhyIfType=portInfoPhyIfType, agPortNewCfgPVID=agPortNewCfgPVID, vlanNewCfgBwmContract=vlanNewCfgBwmContract, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mirrOperState=mirrOperState, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, port_stats=port_stats, portCpuStatsUtilIndx=portCpuStatsUtilIndx, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgCurCfgIndex=stgCurCfgIndex, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, portInfoFlowCtrl=portInfoFlowCtrl, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, portInfoIndx=portInfoIndx, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, agPortConfig=agPortConfig, mirrOperTimeout=mirrOperTimeout, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanCurCfgVlanName=vlanCurCfgVlanName, pmNewCfgState=pmNewCfgState, vlanNewCfgPorts=vlanNewCfgPorts, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portStatsTable=portStatsTable, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, vlanNewCfgTable=vlanNewCfgTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portInfoPhyIfMtu=portInfoPhyIfMtu, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, vlanCurCfgStg=vlanCurCfgStg, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, vlans=vlans, stgNewCfgIndex=stgNewCfgIndex, mirrVlanMirr=mirrVlanMirr, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgNewCfgPortTable=stgNewCfgPortTable, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mirrOperMirroredPort=mirrOperMirroredPort, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portInfoLink=portInfoLink, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, mirrOper=mirrOper, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, trunkGroupNewCfgTable=trunkGroupNewCfgTable, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, port_info=port_info, agPortNewCfgTableEntry=agPortNewCfgTableEntry, stgNewCfgState=stgNewCfgState, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, agPortCurCfgBwmContract=agPortCurCfgBwmContract, portInfoPhyIfLastChange=portInfoPhyIfLastChange, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, agPortCurCfgPrefLink=agPortCurCfgPrefLink, portInfoTable=portInfoTable, agPortCurCfgBackLink=agPortCurCfgBackLink, vlanMaxEnt=vlanMaxEnt, stgNewCfgPortIndex=stgNewCfgPortIndex, portCpuStatsUtilTable=portCpuStatsUtilTable, agPortCurCfgState=agPortCurCfgState, stgCurCfgPortTable=stgCurCfgPortTable, pmCurCfgTimeout=pmCurCfgTimeout, pmNewCfgMirroredPort=pmNewCfgMirroredPort, portStatsTableEntry=portStatsTableEntry, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, agPortCurCfgPVID=agPortCurCfgPVID, agPortNewCfgIndx=agPortNewCfgIndx, agPortNewCfgRmon=agPortNewCfgRmon, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1)
