...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanNewCfgVlanName=vlanNewCfgVlanName, agPortCurCfgPrefLink=agPortCurCfgPrefLink, vlanNewCfgTable=vlanNewCfgTable, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portStatsPhyIfInErrors=portStatsPhyIfInErrors, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanNewCfgPorts=vlanNewCfgPorts, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, agPortNewCfgVlanTag=agPortNewCfgVlanTag, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, agPortCurCfgStp=agPortCurCfgStp, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, vlanNewCfgVlanId=vlanNewCfgVlanId, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, agPortCurCfgState=agPortCurCfgState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, agPortCurCfgTableEntry=agPortCurCfgTableEntry, agPortNewCfgPVID=agPortNewCfgPVID, vlanNewCfgStg=vlanNewCfgStg, pmCurCfgPortMirrState=pmCurCfgPortMirrState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, vlans=vlans, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, agPortCurCfgIndx=agPortCurCfgIndx, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, portInfoPhyIfDescr=portInfoPhyIfDescr, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortNewCfgState=agPortNewCfgState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, portInfoTable=portInfoTable, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, portInfoSpeed=portInfoSpeed, portInfoPhyIfLastChange=portInfoPhyIfLastChange, stgNewCfgAddVlan=stgNewCfgAddVlan, agPortCurCfgPortName=agPortCurCfgPortName, vlanNewCfgAddPort=vlanNewCfgAddPort, mirrPortMirr=mirrPortMirr, agPortConfig=agPortConfig, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, agPortNewCfgBwmContract=agPortNewCfgBwmContract, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmCurCfgTimeout=pmCurCfgTimeout, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, stgCurCfgTable=stgCurCfgTable, portCpuStatsUtilTable=portCpuStatsUtilTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, pmNewCfgPortMirrState=pmNewCfgPortMirrState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, agPortNewCfgPrefLink=agPortNewCfgPrefLink, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, vlanCurCfgTable=vlanCurCfgTable, vlanCurCfgVlanName=vlanCurCfgVlanName, pmNewCfgState=pmNewCfgState, agPortNewCfgIndx=agPortNewCfgIndx, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, portStatsTable=portStatsTable, portInfoLink=portInfoLink, stgNewCfgPortIndex=stgNewCfgPortIndex, agPortCurCfgVlanTag=agPortCurCfgVlanTag, mirroring=mirroring, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanMaxEnt=vlanMaxEnt, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupCurCfgState=trunkGroupCurCfgState, portmirroring=portmirroring, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, pmNewCfgMirroredPort=pmNewCfgMirroredPort, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, vlanCurCfgState=vlanCurCfgState, pmNewCfgTimeout=pmNewCfgTimeout, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, mirrOperTimeout=mirrOperTimeout, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgIndex=stgNewCfgIndex, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, agPortTableMaxEnt=agPortTableMaxEnt, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portInfoTableEntry=portInfoTableEntry, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, stgNewCfgStgIndex=stgNewCfgStgIndex, mirrOper=mirrOper, port_stats=port_stats, agPortNewCfgPortName=agPortNewCfgPortName, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, stgCurCfgPortState=stgCurCfgPortState, vlanCurCfgStg=vlanCurCfgStg, portCpuStatsUtilIndx=portCpuStatsUtilIndx, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, portInfoPhyIfType=portInfoPhyIfType, mirrOperMirroredPort=mirrOperMirroredPort, portInfoFlowCtrl=portInfoFlowCtrl, stgCurCfgPortIndex=stgCurCfgPortIndex, agPortCurCfgBwmContract=agPortCurCfgBwmContract, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, agPortNewCfgRmon=agPortNewCfgRmon, agPortCurCfgTable=agPortCurCfgTable, agPortCurCfgPVID=agPortCurCfgPVID, stgNewCfgTable=stgNewCfgTable, agPortCurCfgBackLink=agPortCurCfgBackLink, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, agPortNewCfgTableEntry=agPortNewCfgTableEntry, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, trunkGroupNewCfgState=trunkGroupNewCfgState, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, vlanNewCfgDelete=vlanNewCfgDelete, stgCurCfgState=stgCurCfgState, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, pmCurCfgMirroredPort=pmCurCfgMirroredPort, stgNewCfgState=stgNewCfgState, stgCurCfgPortTable=stgCurCfgPortTable, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, agPortCurCfgRmon=agPortCurCfgRmon, agPortNewCfgStp=agPortNewCfgStp, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, mirrOperType=mirrOperType, portStatsIndx=portStatsIndx, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgNewCfgPortState=stgNewCfgPortState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, pmCurCfgState=pmCurCfgState, portInfoMode=portInfoMode, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, portStatsTableEntry=portStatsTableEntry, portStatsPhyIfInOctets=portStatsPhyIfInOctets, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, stgCurCfgStgIndex=stgCurCfgStgIndex, portInfoIndx=portInfoIndx, vlanNewCfgState=vlanNewCfgState, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, agPortNewCfgBackLink=agPortNewCfgBackLink, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, mirrOperState=mirrOperState, spannTreeGrpCfg=spannTreeGrpCfg, stgNewCfgPortTable=stgNewCfgPortTable, mirrVlanMirr=mirrVlanMirr, trunkgroup=trunkgroup, port_info=port_info, portInfoPhyIfMtu=portInfoPhyIfMtu, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, agPortNewCfgTable=agPortNewCfgTable, stgCurCfgTableEntry=stgCurCfgTableEntry, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, portCpuStats=portCpuStats)
