...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", vlanCurCfgJumbo=vlanCurCfgJumbo, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mirroring=mirroring, pmNewCfgState=pmNewCfgState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, trunkgroup=trunkgroup, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, agPortCurCfgVlanTag=agPortCurCfgVlanTag, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, stgNewCfgIndex=stgNewCfgIndex, mirrOper=mirrOper, agPortNewCfgIndx=agPortNewCfgIndx, portInfoTableEntry=portInfoTableEntry, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portStatsTable=portStatsTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mirrOperState=mirrOperState, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanCurCfgVlanId=vlanCurCfgVlanId, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, portCpuStats=portCpuStats, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mirrOperTimeout=mirrOperTimeout, stgNewCfgState=stgNewCfgState, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, agPortNewCfgStp=agPortNewCfgStp, portStatsPhyIfInOctets=portStatsPhyIfInOctets, mirrOperType=mirrOperType, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, pmCurCfgState=pmCurCfgState, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, agPortNewCfgVlanTag=agPortNewCfgVlanTag, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, trunkGroupNewCfgTable=trunkGroupNewCfgTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, agPortCurCfgBwmContract=agPortCurCfgBwmContract, agPortCurCfgPVID=agPortCurCfgPVID, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, agPortCurCfgRmon=agPortCurCfgRmon, agPortNewCfgBwmContract=agPortNewCfgBwmContract, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, agPortNewCfgState=agPortNewCfgState, portStatsTableEntry=portStatsTableEntry, portInfoLink=portInfoLink, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, agPortNewCfgPVID=agPortNewCfgPVID, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, stgNewCfgTable=stgNewCfgTable, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, port_info=port_info, agPortNewCfgBackLink=agPortNewCfgBackLink, trunkGroupTableMaxSize=trunkGroupTableMaxSize, agPortCurCfgPrefLink=agPortCurCfgPrefLink, stgNewCfgAddVlan=stgNewCfgAddVlan, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, stgNewCfgTableEntry=stgNewCfgTableEntry, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, portInfoPhyIfMtu=portInfoPhyIfMtu, agPortConfig=agPortConfig, vlanNewCfgDelete=vlanNewCfgDelete, pmCurCfgMirroredPort=pmCurCfgMirroredPort, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, stgNewCfgPortIndex=stgNewCfgPortIndex, stgCurCfgPortTable=stgCurCfgPortTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanNewCfgStg=vlanNewCfgStg, trunkGroupNewCfgState=trunkGroupNewCfgState, mirrPortMirr=mirrPortMirr, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, agPortNewCfgRmon=agPortNewCfgRmon, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, agPortCurCfgStp=agPortCurCfgStp, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, vlanNewCfgJumbo=vlanNewCfgJumbo, agPortCurCfgTable=agPortCurCfgTable, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, mirrVlanMirr=mirrVlanMirr, agPortCurCfgIndx=agPortCurCfgIndx, vlanNewCfgPorts=vlanNewCfgPorts, agPortTableMaxEnt=agPortTableMaxEnt, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, agPortNewCfgPortName=agPortNewCfgPortName, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, pmNewCfgMirroredPort=pmNewCfgMirroredPort, pmCurCfgTimeout=pmCurCfgTimeout, portStatsIndx=portStatsIndx, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, agPortNewCfgTableEntry=agPortNewCfgTableEntry, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, portmirroring=portmirroring, vlans=vlans, portInfoMode=portInfoMode, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, stgCurCfgPortIndex=stgCurCfgPortIndex, portCpuStatsUtilTable=portCpuStatsUtilTable, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgPortState=stgNewCfgPortState, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portCpuStatsUtilIndx=portCpuStatsUtilIndx, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, portInfoPhyIfLastChange=portInfoPhyIfLastChange, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, port_stats=port_stats, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portInfoIndx=portInfoIndx, portStatsPhyIfInErrors=portStatsPhyIfInErrors, stgCurCfgTable=stgCurCfgTable, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, mirrOperMirroredPort=mirrOperMirroredPort, stgNewCfgPortTable=stgNewCfgPortTable, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, portInfoTable=portInfoTable, vlanNewCfgState=vlanNewCfgState, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portInfoSpeed=portInfoSpeed, vlanCurCfgTable=vlanCurCfgTable, stgCurCfgIndex=stgCurCfgIndex, vlanMaxEnt=vlanMaxEnt, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgCurCfgState=stgCurCfgState, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortCurCfgPortName=agPortCurCfgPortName, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, vlanCurCfgState=vlanCurCfgState, vlanCurCfgPorts=vlanCurCfgPorts, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, vlanNewCfgTable=vlanNewCfgTable, portInfoFlowCtrl=portInfoFlowCtrl, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, agPortCurCfgBackLink=agPortCurCfgBackLink, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portInfoPhyIfType=portInfoPhyIfType, pmNewCfgTimeout=pmNewCfgTimeout, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, vlanNewCfgAddPort=vlanNewCfgAddPort, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanCurCfgStg=vlanCurCfgStg, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, agPortCurCfgTableEntry=agPortCurCfgTableEntry, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, spannTreeGrpCfg=spannTreeGrpCfg, stgCurCfgPortState=stgCurCfgPortState, agPortNewCfgPrefLink=agPortNewCfgPrefLink, stgCurCfgStgIndex=stgCurCfgStgIndex, agPortCurCfgState=agPortCurCfgState, agPortNewCfgTable=agPortNewCfgTable)
