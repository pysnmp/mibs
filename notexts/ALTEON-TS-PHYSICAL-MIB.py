...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, agPortNewCfgStp=agPortNewCfgStp, trunkgroup=trunkgroup, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, agPortNewCfgPortName=agPortNewCfgPortName, mirrPortMirr=mirrPortMirr, stgNewCfgStgIndex=stgNewCfgStgIndex, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, agPortCurCfgTable=agPortCurCfgTable, agPortNewCfgTable=agPortNewCfgTable, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, agPortCurCfgPrefLink=agPortCurCfgPrefLink, stgNewCfgTableEntry=stgNewCfgTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgCurCfgTable=stgCurCfgTable, agPortNewCfgVlanTag=agPortNewCfgVlanTag, agPortNewCfgBwmContract=agPortNewCfgBwmContract, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, vlans=vlans, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, portInfoLink=portInfoLink, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, vlanCurCfgTable=vlanCurCfgTable, stgNewCfgAddVlan=stgNewCfgAddVlan, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanCurCfgState=vlanCurCfgState, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, agPortNewCfgRmon=agPortNewCfgRmon, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, agPortConfig=agPortConfig, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, pmNewCfgMirroredPort=pmNewCfgMirroredPort, agPortNewCfgPVID=agPortNewCfgPVID, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, agPortCurCfgState=agPortCurCfgState, vlanCurCfgJumbo=vlanCurCfgJumbo, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, portCpuStats=portCpuStats, pmCurCfgTimeout=pmCurCfgTimeout, mirrVlanMirr=mirrVlanMirr, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, vlanNewCfgJumbo=vlanNewCfgJumbo, portInfoPhyIfLastChange=portInfoPhyIfLastChange, stgCurCfgState=stgCurCfgState, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, portCpuStatsUtilTable=portCpuStatsUtilTable, mirrOper=mirrOper, portCpuStatsUtilIndx=portCpuStatsUtilIndx, pmNewCfgState=pmNewCfgState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, agPortCurCfgBwmContract=agPortCurCfgBwmContract, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, portStatsPhyIfInErrors=portStatsPhyIfInErrors, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, port_stats=port_stats, agPortCurCfgIndx=agPortCurCfgIndx, stgCurCfgIndex=stgCurCfgIndex, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, stgNewCfgPortState=stgNewCfgPortState, portStatsTableEntry=portStatsTableEntry, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, stgCurCfgTableEntry=stgCurCfgTableEntry, mirroring=mirroring, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmCurCfgMirroredPort=pmCurCfgMirroredPort, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, portInfoTableEntry=portInfoTableEntry, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, pmNewCfgTimeout=pmNewCfgTimeout, portStatsIndx=portStatsIndx, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, vlanCurCfgPorts=vlanCurCfgPorts, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, vlanNewCfgTable=vlanNewCfgTable, stgNewCfgPortTable=stgNewCfgPortTable, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, vlanCurCfgVlanName=vlanCurCfgVlanName, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgState=stgNewCfgState, portmirroring=portmirroring, agPortCurCfgBackLink=agPortCurCfgBackLink, agPortNewCfgState=agPortNewCfgState, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanCurCfgStg=vlanCurCfgStg, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgCurCfgPortIndex=stgCurCfgPortIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgCurCfgPortState=stgCurCfgPortState, portStatsTable=portStatsTable, vlanNewCfgState=vlanNewCfgState, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, vlanNewCfgDelete=vlanNewCfgDelete, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mirrOperMirroredPort=mirrOperMirroredPort, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, portInfoPhyIfType=portInfoPhyIfType, portInfoFlowCtrl=portInfoFlowCtrl, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mirrOperType=mirrOperType, portInfoIndx=portInfoIndx, vlanNewCfgAddPort=vlanNewCfgAddPort, spannTreeGrpCfg=spannTreeGrpCfg, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, agPortCurCfgTableEntry=agPortCurCfgTableEntry, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, port_info=port_info, portStatsPhyIfInOctets=portStatsPhyIfInOctets, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portInfoTable=portInfoTable, mirrOperMonitoringPort=mirrOperMonitoringPort, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, portInfoPhyIfMtu=portInfoPhyIfMtu, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, agPortNewCfgIndx=agPortNewCfgIndx, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanMaxEnt=vlanMaxEnt, stgNewCfgTable=stgNewCfgTable, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, mirrOperState=mirrOperState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, agPortCurCfgPortName=agPortCurCfgPortName, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, agPortCurCfgPVID=agPortCurCfgPVID, stgCurCfgStgIndex=stgCurCfgStgIndex, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, portInfoSpeed=portInfoSpeed, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, agPortNewCfgBackLink=agPortNewCfgBackLink, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, agPortCurCfgStp=agPortCurCfgStp, portInfoPhyIfDescr=portInfoPhyIfDescr, stgNewCfgIndex=stgNewCfgIndex, stgCurCfgPortTable=stgCurCfgPortTable, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, stgNewCfgPortIndex=stgNewCfgPortIndex, agPortCurCfgRmon=agPortCurCfgRmon, agPortNewCfgPrefLink=agPortNewCfgPrefLink, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portInfoMode=portInfoMode, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupCurCfgState=trunkGroupCurCfgState, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, agPortNewCfgTableEntry=agPortNewCfgTableEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, agPortCurCfgVlanTag=agPortCurCfgVlanTag, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, agPortTableMaxEnt=agPortTableMaxEnt, mirrOperTimeout=mirrOperTimeout, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmCurCfgState=pmCurCfgState, trunkGroupTableMaxSize=trunkGroupTableMaxSize)
