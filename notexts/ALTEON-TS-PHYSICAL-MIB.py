...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", pmNewCfgPortMirrState=pmNewCfgPortMirrState, agPortCurCfgPortName=agPortCurCfgPortName, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, port_info=port_info, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupCurCfgState=trunkGroupCurCfgState, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, agPortCurCfgPVID=agPortCurCfgPVID, agPortNewCfgPrefLink=agPortNewCfgPrefLink, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, pmCurCfgState=pmCurCfgState, agPortNewCfgTableEntry=agPortNewCfgTableEntry, pmCurCfgTimeout=pmCurCfgTimeout, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, agPortCurCfgTable=agPortCurCfgTable, mirrVlanMirr=mirrVlanMirr, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, agPortTableMaxEnt=agPortTableMaxEnt, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanNewCfgVlanName=vlanNewCfgVlanName, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, agPortNewCfgVlanTag=agPortNewCfgVlanTag, agPortCurCfgTableEntry=agPortCurCfgTableEntry, port_stats=port_stats, stgCurCfgIndex=stgCurCfgIndex, vlanMaxEnt=vlanMaxEnt, stgNewCfgState=stgNewCfgState, vlans=vlans, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mirroring=mirroring, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, agPortCurCfgPrefLink=agPortCurCfgPrefLink, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, agPortNewCfgBackLink=agPortNewCfgBackLink, vlanNewCfgDelete=vlanNewCfgDelete, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, portStatsIndx=portStatsIndx, mirrOperType=mirrOperType, stgCurCfgPortTable=stgCurCfgPortTable, spannTreeGrpCfg=spannTreeGrpCfg, agPortCurCfgBwmContract=agPortCurCfgBwmContract, mirrOperMirroredPort=mirrOperMirroredPort, vlanCurCfgStg=vlanCurCfgStg, portInfoFlowCtrl=portInfoFlowCtrl, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, agPortCurCfgBackLink=agPortCurCfgBackLink, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, stgCurCfgStgIndex=stgCurCfgStgIndex, agPortNewCfgStp=agPortNewCfgStp, pmNewCfgMirroredPort=pmNewCfgMirroredPort, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portInfoMode=portInfoMode, vlanCurCfgVlanName=vlanCurCfgVlanName, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgTable=stgNewCfgTable, stgCurCfgPortIndex=stgCurCfgPortIndex, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, agPortNewCfgPortName=agPortNewCfgPortName, vlanCurCfgState=vlanCurCfgState, portCpuStatsUtilIndx=portCpuStatsUtilIndx, portInfoLink=portInfoLink, stgNewCfgAddVlan=stgNewCfgAddVlan, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portmirroring=portmirroring, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgNewCfgPortTable=stgNewCfgPortTable, pmNewCfgState=pmNewCfgState, portStatsTable=portStatsTable, agPortCurCfgIndx=agPortCurCfgIndx, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, portStatsPhyIfInOctets=portStatsPhyIfInOctets, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, portInfoSpeed=portInfoSpeed, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, portInfoTableEntry=portInfoTableEntry, portInfoPhyIfMtu=portInfoPhyIfMtu, pmCurCfgMirroredPort=pmCurCfgMirroredPort, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgPortState=stgCurCfgPortState, trunkgroup=trunkgroup, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgState=stgCurCfgState, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgPortState=stgNewCfgPortState, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, stgCurCfgTable=stgCurCfgTable, agPortConfig=agPortConfig, agPortNewCfgTable=agPortNewCfgTable, stgNewCfgStgIndex=stgNewCfgStgIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, agPortCurCfgRmon=agPortCurCfgRmon, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portInfoIndx=portInfoIndx, vlanNewCfgStg=vlanNewCfgStg, vlanCurCfgTable=vlanCurCfgTable, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, stgNewCfgPortIndex=stgNewCfgPortIndex, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, agPortCurCfgState=agPortCurCfgState, mirrPortMirr=mirrPortMirr, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, portInfoPhyIfLastChange=portInfoPhyIfLastChange, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, portCpuStatsUtilTable=portCpuStatsUtilTable, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mirrOperState=mirrOperState, portCpuStats=portCpuStats, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, agPortNewCfgIndx=agPortNewCfgIndx, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, vlanCurCfgJumbo=vlanCurCfgJumbo, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, agPortCurCfgVlanTag=agPortCurCfgVlanTag, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, agPortNewCfgBwmContract=agPortNewCfgBwmContract, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, portInfoTable=portInfoTable, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, agPortNewCfgState=agPortNewCfgState, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, vlanNewCfgState=vlanNewCfgState, vlanCurCfgVlanId=vlanCurCfgVlanId, pmNewCfgTimeout=pmNewCfgTimeout, trunkGroupNewCfgState=trunkGroupNewCfgState, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portStatsPhyIfInErrors=portStatsPhyIfInErrors, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgIndex=stgNewCfgIndex, portInfoPhyIfDescr=portInfoPhyIfDescr, portInfoPhyIfType=portInfoPhyIfType, vlanNewCfgTable=vlanNewCfgTable, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortCurCfgStp=agPortCurCfgStp, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, mirrOper=mirrOper, agPortNewCfgPVID=agPortNewCfgPVID, portStatsTableEntry=portStatsTableEntry, mirrOperTimeout=mirrOperTimeout, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, agPortNewCfgRmon=agPortNewCfgRmon, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, stgCurCfgTableEntry=stgCurCfgTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2)
