...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlanCurCfgState=vlanCurCfgState, stgNewCfgPortIndex=stgNewCfgPortIndex, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, agPortConfig=agPortConfig, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, agPortCurCfgPortName=agPortCurCfgPortName, pmCurCfgMirroredPort=pmCurCfgMirroredPort, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, portInfoPhyIfLastChange=portInfoPhyIfLastChange, vlanCurCfgVlanId=vlanCurCfgVlanId, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portCpuStatsUtilTable=portCpuStatsUtilTable, port_info=port_info, portInfoPhyIfMtu=portInfoPhyIfMtu, pmNewCfgState=pmNewCfgState, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, portCpuStatsUtilIndx=portCpuStatsUtilIndx, agPortCurCfgIndx=agPortCurCfgIndx, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, portInfoFlowCtrl=portInfoFlowCtrl, agPortCurCfgPVID=agPortCurCfgPVID, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portInfoSpeed=portInfoSpeed, stgCurCfgTable=stgCurCfgTable, vlanCurCfgVlanName=vlanCurCfgVlanName, agPortCurCfgBwmContract=agPortCurCfgBwmContract, portInfoTable=portInfoTable, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, agPortCurCfgTable=agPortCurCfgTable, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanNewCfgJumbo=vlanNewCfgJumbo, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, portInfoPhyIfDescr=portInfoPhyIfDescr, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, portmirroring=portmirroring, pmNewCfgMirroredPort=pmNewCfgMirroredPort, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mirroring=mirroring, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgCurCfgPortTable=stgCurCfgPortTable, portInfoPhyIfType=portInfoPhyIfType, vlans=vlans, vlanNewCfgPorts=vlanNewCfgPorts, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, vlanNewCfgVlanName=vlanNewCfgVlanName, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, stgNewCfgState=stgNewCfgState, mirrOper=mirrOper, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, mirrOperState=mirrOperState, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, portStatsPhyIfInOctets=portStatsPhyIfInOctets, portStatsPhyIfInErrors=portStatsPhyIfInErrors, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanCurCfgStg=vlanCurCfgStg, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mirrVlanMirr=mirrVlanMirr, agPortCurCfgVlanTag=agPortCurCfgVlanTag, agPortNewCfgVlanTag=agPortNewCfgVlanTag, agPortCurCfgState=agPortCurCfgState, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, portStatsTable=portStatsTable, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, port_stats=port_stats, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, stgNewCfgPortState=stgNewCfgPortState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, portInfoLink=portInfoLink, agPortNewCfgPortName=agPortNewCfgPortName, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, stgNewCfgPortTable=stgNewCfgPortTable, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, agPortNewCfgTableEntry=agPortNewCfgTableEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portStatsTableEntry=portStatsTableEntry, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, stgNewCfgTableEntry=stgNewCfgTableEntry, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, agPortNewCfgTable=agPortNewCfgTable, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanNewCfgState=vlanNewCfgState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portInfoTableEntry=portInfoTableEntry, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, vlanCurCfgPorts=vlanCurCfgPorts, vlanNewCfgAddPort=vlanNewCfgAddPort, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortTableMaxEnt=agPortTableMaxEnt, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, agPortCurCfgPrefLink=agPortCurCfgPrefLink, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmCurCfgState=pmCurCfgState, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, vlanCurCfgTable=vlanCurCfgTable, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgCurCfgTableEntry=stgCurCfgTableEntry, mirrPortMirr=mirrPortMirr, spannTreeGrpCfg=spannTreeGrpCfg, vlanNewCfgStg=vlanNewCfgStg, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanMaxEnt=vlanMaxEnt, agPortCurCfgBackLink=agPortCurCfgBackLink, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, vlanNewCfgVlanId=vlanNewCfgVlanId, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, agPortCurCfgTableEntry=agPortCurCfgTableEntry, trunkgroup=trunkgroup, stgCurCfgState=stgCurCfgState, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, portStatsIndx=portStatsIndx, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, stgNewCfgIndex=stgNewCfgIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgCurCfgPortIndex=stgCurCfgPortIndex, agPortNewCfgIndx=agPortNewCfgIndx, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, stgCurCfgPortState=stgCurCfgPortState, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, trunkGroupCurCfgState=trunkGroupCurCfgState, agPortNewCfgRmon=agPortNewCfgRmon, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, agPortNewCfgPrefLink=agPortNewCfgPrefLink, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, pmNewCfgTimeout=pmNewCfgTimeout, agPortNewCfgStp=agPortNewCfgStp, agPortCurCfgStp=agPortCurCfgStp, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, portCpuStats=portCpuStats, agPortNewCfgBwmContract=agPortNewCfgBwmContract, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, mirrOperMirroredPort=mirrOperMirroredPort, mirrOperType=mirrOperType, stgCurCfgIndex=stgCurCfgIndex, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgAddVlan=stgNewCfgAddVlan, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortNewCfgPVID=agPortNewCfgPVID, agPortNewCfgBackLink=agPortNewCfgBackLink, agPortNewCfgState=agPortNewCfgState, portInfoIndx=portInfoIndx, pmCurCfgTimeout=pmCurCfgTimeout, agPortCurCfgRmon=agPortCurCfgRmon, vlanNewCfgDelete=vlanNewCfgDelete, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, mirrOperTimeout=mirrOperTimeout, stgNewCfgTable=stgNewCfgTable, portInfoMode=portInfoMode, vlanNewCfgTable=vlanNewCfgTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts)
