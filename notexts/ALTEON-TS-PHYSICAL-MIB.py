...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", portInfoIndx=portInfoIndx, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, stgCurCfgState=stgCurCfgState, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, stgCurCfgTable=stgCurCfgTable, mirroring=mirroring, agPortCurCfgState=agPortCurCfgState, agPortNewCfgPVID=agPortNewCfgPVID, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, agPortCurCfgPrefLink=agPortCurCfgPrefLink, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortNewCfgIndx=agPortNewCfgIndx, trunkgroup=trunkgroup, mirrOperType=mirrOperType, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, mirrOperTimeout=mirrOperTimeout, agPortNewCfgState=agPortNewCfgState, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, agPortConfig=agPortConfig, agPortCurCfgStp=agPortCurCfgStp, stgNewCfgState=stgNewCfgState, mirrPortMirr=mirrPortMirr, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, agPortCurCfgBackLink=agPortCurCfgBackLink, pmCurCfgTimeout=pmCurCfgTimeout, portInfoMode=portInfoMode, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, agPortCurCfgTableEntry=agPortCurCfgTableEntry, vlans=vlans, stgNewCfgTableEntry=stgNewCfgTableEntry, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, mirrOper=mirrOper, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgCurCfgPortTable=stgCurCfgPortTable, portInfoTableEntry=portInfoTableEntry, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, portInfoFlowCtrl=portInfoFlowCtrl, vlanCurCfgVlanId=vlanCurCfgVlanId, agPortTableMaxEnt=agPortTableMaxEnt, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, portmirroring=portmirroring, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgPortTable=stgNewCfgPortTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portCpuStatsUtilIndx=portCpuStatsUtilIndx, stgCurCfgPortIndex=stgCurCfgPortIndex, mirrOperMirroredPort=mirrOperMirroredPort, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, portStatsPhyIfInOctets=portStatsPhyIfInOctets, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmCurCfgMirroredPort=pmCurCfgMirroredPort, vlanCurCfgJumbo=vlanCurCfgJumbo, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, portInfoPhyIfType=portInfoPhyIfType, vlanNewCfgTable=vlanNewCfgTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portCpuStats=portCpuStats, portInfoLink=portInfoLink, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mirrOperState=mirrOperState, vlanCurCfgPorts=vlanCurCfgPorts, vlanNewCfgState=vlanNewCfgState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portCpuStatsUtilTable=portCpuStatsUtilTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, trunkGroupCurCfgState=trunkGroupCurCfgState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgTable=stgNewCfgTable, vlanCurCfgVlanName=vlanCurCfgVlanName, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, pmNewCfgState=pmNewCfgState, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, agPortCurCfgPortName=agPortCurCfgPortName, stgCurCfgTableEntry=stgCurCfgTableEntry, agPortCurCfgRmon=agPortCurCfgRmon, portStatsTable=portStatsTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgCurCfgPortState=stgCurCfgPortState, agPortNewCfgVlanTag=agPortNewCfgVlanTag, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, stgCurCfgStgIndex=stgCurCfgStgIndex, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, stgNewCfgStgIndex=stgNewCfgStgIndex, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, agPortNewCfgBackLink=agPortNewCfgBackLink, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, port_info=port_info, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, portInfoPhyIfMtu=portInfoPhyIfMtu, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanMaxEnt=vlanMaxEnt, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, agPortCurCfgPVID=agPortCurCfgPVID, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, vlanNewCfgVlanName=vlanNewCfgVlanName, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, vlanNewCfgAddPort=vlanNewCfgAddPort, agPortCurCfgIndx=agPortCurCfgIndx, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, agPortCurCfgTable=agPortCurCfgTable, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgNewCfgPortState=stgNewCfgPortState, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portInfoPhyIfLastChange=portInfoPhyIfLastChange, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortNewCfgStp=agPortNewCfgStp, agPortCurCfgBwmContract=agPortCurCfgBwmContract, agPortNewCfgBwmContract=agPortNewCfgBwmContract, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, vlanCurCfgStg=vlanCurCfgStg, vlanCurCfgTable=vlanCurCfgTable, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgIndex=stgNewCfgIndex, portInfoTable=portInfoTable, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, portStatsIndx=portStatsIndx, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, agPortNewCfgPortName=agPortNewCfgPortName, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, pmNewCfgMirroredPort=pmNewCfgMirroredPort, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, agPortNewCfgRmon=agPortNewCfgRmon, vlanCurCfgState=vlanCurCfgState, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, agPortNewCfgPrefLink=agPortNewCfgPrefLink, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, spannTreeGrpCfg=spannTreeGrpCfg, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portInfoPhyIfDescr=portInfoPhyIfDescr, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmNewCfgTimeout=pmNewCfgTimeout, vlanNewCfgDelete=vlanNewCfgDelete, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, agPortNewCfgTableEntry=agPortNewCfgTableEntry, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, vlanNewCfgRemovePort=vlanNewCfgRemovePort, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, port_stats=port_stats, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, portStatsPhyIfInErrors=portStatsPhyIfInErrors, agPortCurCfgVlanTag=agPortCurCfgVlanTag, stgCurCfgIndex=stgCurCfgIndex, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portInfoSpeed=portInfoSpeed, stgNewCfgPortIndex=stgNewCfgPortIndex, portStatsTableEntry=portStatsTableEntry, pmCurCfgState=pmCurCfgState, agPortNewCfgTable=agPortNewCfgTable, mirrVlanMirr=mirrVlanMirr, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanNewCfgStg=vlanNewCfgStg)
