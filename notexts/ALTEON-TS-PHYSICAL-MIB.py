...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", agPortCurCfgState=agPortCurCfgState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgPortState=stgCurCfgPortState, stgCurCfgStgIndex=stgCurCfgStgIndex, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portInfoPhyIfLastChange=portInfoPhyIfLastChange, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, stgNewCfgTable=stgNewCfgTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, agPortTableMaxEnt=agPortTableMaxEnt, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, agPortNewCfgPortName=agPortNewCfgPortName, mirrVlanMirr=mirrVlanMirr, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, agPortNewCfgPVID=agPortNewCfgPVID, mirrOperMonitoringPort=mirrOperMonitoringPort, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, vlanCurCfgStg=vlanCurCfgStg, agPortCurCfgPVID=agPortCurCfgPVID, stgNewCfgIndex=stgNewCfgIndex, portInfoLink=portInfoLink, vlanCurCfgTable=vlanCurCfgTable, stgCurCfgPortIndex=stgCurCfgPortIndex, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, agPortNewCfgTableEntry=agPortNewCfgTableEntry, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, mirrPortMirr=mirrPortMirr, vlanCurCfgPorts=vlanCurCfgPorts, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, agPortCurCfgStp=agPortCurCfgStp, vlanNewCfgVlanName=vlanNewCfgVlanName, pmCurCfgTimeout=pmCurCfgTimeout, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, stgCurCfgTable=stgCurCfgTable, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgAddPort=vlanNewCfgAddPort, agPortCurCfgVlanTag=agPortCurCfgVlanTag, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, agPortCurCfgIndx=agPortCurCfgIndx, stgNewCfgPortState=stgNewCfgPortState, trunkGroupNewCfgState=trunkGroupNewCfgState, portStatsTable=portStatsTable, pmNewCfgState=pmNewCfgState, stgNewCfgTableEntry=stgNewCfgTableEntry, agPortNewCfgState=agPortNewCfgState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, agPortCurCfgPortName=agPortCurCfgPortName, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanNewCfgStg=vlanNewCfgStg, portInfoPhyIfMtu=portInfoPhyIfMtu, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, agPortCurCfgBwmContract=agPortCurCfgBwmContract, vlanCurCfgVlanName=vlanCurCfgVlanName, portCpuStatsUtilTable=portCpuStatsUtilTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, mirrOperTimeout=mirrOperTimeout, pmNewCfgTimeout=pmNewCfgTimeout, agPortCurCfgRmon=agPortCurCfgRmon, portInfoSpeed=portInfoSpeed, portInfoPhyIfType=portInfoPhyIfType, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, pmCurCfgState=pmCurCfgState, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portStatsPhyIfInOctets=portStatsPhyIfInOctets, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, vlanNewCfgState=vlanNewCfgState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, pmNewCfgMirroredPort=pmNewCfgMirroredPort, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, agPortCurCfgBackLink=agPortCurCfgBackLink, agPortCurCfgTable=agPortCurCfgTable, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, port_stats=port_stats, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, portStatsTableEntry=portStatsTableEntry, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanCurCfgState=vlanCurCfgState, port_info=port_info, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgStgIndex=stgNewCfgStgIndex, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, agPortCurCfgPrefLink=agPortCurCfgPrefLink, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, mirrOper=mirrOper, mirrOperMirroredPort=mirrOperMirroredPort, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portInfoMode=portInfoMode, portInfoTable=portInfoTable, stgCurCfgTableEntry=stgCurCfgTableEntry, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, stgCurCfgState=stgCurCfgState, agPortNewCfgStp=agPortNewCfgStp, agPortNewCfgVlanTag=agPortNewCfgVlanTag, pmCurCfgMirroredPort=pmCurCfgMirroredPort, agPortNewCfgIndx=agPortNewCfgIndx, portStatsIndx=portStatsIndx, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, portCpuStatsUtilIndx=portCpuStatsUtilIndx, agPortNewCfgBwmContract=agPortNewCfgBwmContract, vlanCurCfgJumbo=vlanCurCfgJumbo, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, stgNewCfgAddVlan=stgNewCfgAddVlan, pmNewCfgPortMirrState=pmNewCfgPortMirrState, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, mirroring=mirroring, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portInfoPhyIfDescr=portInfoPhyIfDescr, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, mirrOperType=mirrOperType, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, mirrOperState=mirrOperState, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, portCpuStats=portCpuStats, agPortCurCfgTableEntry=agPortCurCfgTableEntry, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, trunkgroup=trunkgroup, agPortNewCfgBackLink=agPortNewCfgBackLink, trunkGroupCurCfgState=trunkGroupCurCfgState, agPortNewCfgTable=agPortNewCfgTable, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portmirroring=portmirroring, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, stgNewCfgState=stgNewCfgState, portInfoFlowCtrl=portInfoFlowCtrl, vlanNewCfgPorts=vlanNewCfgPorts, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgCurCfgPortTable=stgCurCfgPortTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanNewCfgDelete=vlanNewCfgDelete, spannTreeGrpCfg=spannTreeGrpCfg, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, portInfoIndx=portInfoIndx, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, stgNewCfgPortTable=stgNewCfgPortTable, stgCurCfgIndex=stgCurCfgIndex, portInfoTableEntry=portInfoTableEntry, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgNewCfgPortIndex=stgNewCfgPortIndex, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, agPortNewCfgPrefLink=agPortNewCfgPrefLink, agPortNewCfgRmon=agPortNewCfgRmon, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, vlanCurCfgVlanId=vlanCurCfgVlanId, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, portStatsPhyIfInErrors=portStatsPhyIfInErrors, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlans=vlans, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanMaxEnt=vlanMaxEnt, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, agPortConfig=agPortConfig)
