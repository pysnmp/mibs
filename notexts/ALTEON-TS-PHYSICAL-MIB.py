...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", pmCurCfgState=pmCurCfgState, agPortNewCfgBackLink=agPortNewCfgBackLink, portCpuStats=portCpuStats, spannTreeGrpCfg=spannTreeGrpCfg, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgPortTable=stgNewCfgPortTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portCpuStatsUtilTable=portCpuStatsUtilTable, vlanNewCfgPorts=vlanNewCfgPorts, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mirrOperType=mirrOperType, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, vlanCurCfgTable=vlanCurCfgTable, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgTable=stgNewCfgTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, agPortCurCfgPrefLink=agPortCurCfgPrefLink, agPortCurCfgPortName=agPortCurCfgPortName, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, portInfoSpeed=portInfoSpeed, agPortNewCfgTableEntry=agPortNewCfgTableEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, stgCurCfgTable=stgCurCfgTable, pmCurCfgMirroredPort=pmCurCfgMirroredPort, trunkGroupTableMaxSize=trunkGroupTableMaxSize, agPortNewCfgBwmContract=agPortNewCfgBwmContract, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portStatsIndx=portStatsIndx, vlanCurCfgState=vlanCurCfgState, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlans=vlans, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, agPortNewCfgStp=agPortNewCfgStp, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, agPortNewCfgTable=agPortNewCfgTable, mirrOperMirroredPort=mirrOperMirroredPort, agPortCurCfgState=agPortCurCfgState, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmNewCfgTimeout=pmNewCfgTimeout, agPortCurCfgIndx=agPortCurCfgIndx, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, agPortCurCfgPVID=agPortCurCfgPVID, vlanCurCfgPorts=vlanCurCfgPorts, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, vlanMaxEnt=vlanMaxEnt, vlanCurCfgVlanId=vlanCurCfgVlanId, trunkGroupCurCfgState=trunkGroupCurCfgState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmNewCfgState=pmNewCfgState, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, portStatsTableEntry=portStatsTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, agPortCurCfgVlanTag=agPortCurCfgVlanTag, agPortNewCfgVlanTag=agPortNewCfgVlanTag, stgCurCfgPortState=stgCurCfgPortState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, portInfoTable=portInfoTable, mirrPortMirr=mirrPortMirr, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, stgNewCfgPortState=stgNewCfgPortState, portStatsPhyIfInErrors=portStatsPhyIfInErrors, mirrOperTimeout=mirrOperTimeout, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, vlanNewCfgTableEntry=vlanNewCfgTableEntry, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, stgNewCfgState=stgNewCfgState, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, agPortNewCfgPortName=agPortNewCfgPortName, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, port_info=port_info, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCurCfgPortTable=stgCurCfgPortTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, vlanCurCfgVlanName=vlanCurCfgVlanName, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmNewCfgMirroredPort=pmNewCfgMirroredPort, stgNewCfgTableEntry=stgNewCfgTableEntry, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, pmCurCfgTimeout=pmCurCfgTimeout, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, portInfoPhyIfMtu=portInfoPhyIfMtu, portInfoPhyIfType=portInfoPhyIfType, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, mirrOper=mirrOper, trunkgroup=trunkgroup, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, agPortCurCfgBwmContract=agPortCurCfgBwmContract, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanCurCfgStg=vlanCurCfgStg, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgIndex=stgCurCfgIndex, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, stgNewCfgAddVlan=stgNewCfgAddVlan, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, mirrOperMonitoringPort=mirrOperMonitoringPort, portInfoMode=portInfoMode, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, agPortNewCfgPrefLink=agPortNewCfgPrefLink, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, agPortCurCfgTableEntry=agPortCurCfgTableEntry, stgCurCfgStgIndex=stgCurCfgStgIndex, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, portInfoFlowCtrl=portInfoFlowCtrl, vlanCurCfgTableEntry=vlanCurCfgTableEntry, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, portmirroring=portmirroring, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, agPortCurCfgBackLink=agPortCurCfgBackLink, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanNewCfgTable=vlanNewCfgTable, agPortNewCfgIndx=agPortNewCfgIndx, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, mirrOperState=mirrOperState, portCpuStatsUtilIndx=portCpuStatsUtilIndx, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanNewCfgStg=vlanNewCfgStg, portStatsTable=portStatsTable, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, port_stats=port_stats, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, trunkGroupNewCfgTable=trunkGroupNewCfgTable, trunkGroupNewCfgState=trunkGroupNewCfgState, agPortNewCfgState=agPortNewCfgState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portInfoPhyIfLastChange=portInfoPhyIfLastChange, portInfoLink=portInfoLink, pmNewCfgPortMirrState=pmNewCfgPortMirrState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanNewCfgVlanName=vlanNewCfgVlanName, mirrVlanMirr=mirrVlanMirr, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, vlanNewCfgState=vlanNewCfgState, portStatsPhyIfInOctets=portStatsPhyIfInOctets, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, agPortCurCfgRmon=agPortCurCfgRmon, stgNewCfgIndex=stgNewCfgIndex, agPortTableMaxEnt=agPortTableMaxEnt, agPortConfig=agPortConfig, agPortNewCfgPVID=agPortNewCfgPVID, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portInfoTableEntry=portInfoTableEntry, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, agPortCurCfgStp=agPortCurCfgStp, agPortCurCfgTable=agPortCurCfgTable, portInfoIndx=portInfoIndx, agPortNewCfgRmon=agPortNewCfgRmon, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, mirroring=mirroring, stgCurCfgState=stgCurCfgState, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl)
