...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, agPortCurCfgIndx=agPortCurCfgIndx, vlanCurCfgState=vlanCurCfgState, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, agPortNewCfgRmon=agPortNewCfgRmon, stgNewCfgStgIndex=stgNewCfgStgIndex, portStatsPhyIfInErrors=portStatsPhyIfInErrors, portStatsTableEntry=portStatsTableEntry, portInfoPhyIfType=portInfoPhyIfType, trunkGroupCurCfgState=trunkGroupCurCfgState, agPortCurCfgPVID=agPortCurCfgPVID, stgCurCfgPortTable=stgCurCfgPortTable, portStatsIndx=portStatsIndx, port_stats=port_stats, stgCurCfgStgIndex=stgCurCfgStgIndex, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, portmirroring=portmirroring, stgNewCfgTableEntry=stgNewCfgTableEntry, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, agPortNewCfgTableEntry=agPortNewCfgTableEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgNewCfgIndex=stgNewCfgIndex, vlanMaxEnt=vlanMaxEnt, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, portInfoLink=portInfoLink, agPortNewCfgIndx=agPortNewCfgIndx, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, stgNewCfgTable=stgNewCfgTable, pmNewCfgMirroredPort=pmNewCfgMirroredPort, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, agPortNewCfgVlanTag=agPortNewCfgVlanTag, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portInfoPhyIfLastChange=portInfoPhyIfLastChange, trunkgroup=trunkgroup, agPortCurCfgTableEntry=agPortCurCfgTableEntry, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, agPortCurCfgPortName=agPortCurCfgPortName, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, vlans=vlans, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmCurCfgTimeout=pmCurCfgTimeout, vlanNewCfgStg=vlanNewCfgStg, vlanCurCfgStg=vlanCurCfgStg, portCpuStatsUtilIndx=portCpuStatsUtilIndx, portInfoSpeed=portInfoSpeed, stgNewCfgAddVlan=stgNewCfgAddVlan, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mirroring=mirroring, mirrOperMonitoringPort=mirrOperMonitoringPort, port_info=port_info, vlanNewCfgVlanId=vlanNewCfgVlanId, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, agPortTableMaxEnt=agPortTableMaxEnt, agPortNewCfgState=agPortNewCfgState, mirrPortMirr=mirrPortMirr, stgCurCfgIndex=stgCurCfgIndex, agPortNewCfgPrefLink=agPortNewCfgPrefLink, agPortNewCfgStp=agPortNewCfgStp, agPortCurCfgTable=agPortCurCfgTable, stgNewCfgPortTable=stgNewCfgPortTable, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, vlanNewCfgPorts=vlanNewCfgPorts, pmNewCfgTimeout=pmNewCfgTimeout, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portStatsPhyIfInOctets=portStatsPhyIfInOctets, portCpuStats=portCpuStats, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, vlanNewCfgDelete=vlanNewCfgDelete, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, pmNewCfgState=pmNewCfgState, mirrOper=mirrOper, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portStatsTable=portStatsTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, agPortNewCfgTable=agPortNewCfgTable, pmCurCfgMirroredPort=pmCurCfgMirroredPort, agPortCurCfgRmon=agPortCurCfgRmon, spannTreeGrpCfg=spannTreeGrpCfg, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, agPortNewCfgBwmContract=agPortNewCfgBwmContract, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, mirrOperType=mirrOperType, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, stgNewCfgState=stgNewCfgState, vlanCurCfgVlanId=vlanCurCfgVlanId, trunkGroupNewCfgState=trunkGroupNewCfgState, pmCurCfgState=pmCurCfgState, agPortCurCfgBackLink=agPortCurCfgBackLink, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgCurCfgTableEntry=stgCurCfgTableEntry, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, portInfoFlowCtrl=portInfoFlowCtrl, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanNewCfgTable=vlanNewCfgTable, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, trunkGroupCurCfgTable=trunkGroupCurCfgTable, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, agPortCurCfgStp=agPortCurCfgStp, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portInfoPhyIfMtu=portInfoPhyIfMtu, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, mirrOperTimeout=mirrOperTimeout, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, mirrVlanMirr=mirrVlanMirr, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortCurCfgVlanTag=agPortCurCfgVlanTag, vlanNewCfgState=vlanNewCfgState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, agPortNewCfgPortName=agPortNewCfgPortName, portInfoIndx=portInfoIndx, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portInfoTable=portInfoTable, stgNewCfgPortIndex=stgNewCfgPortIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, agPortNewCfgPVID=agPortNewCfgPVID, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portInfoMode=portInfoMode, vlanCurCfgTable=vlanCurCfgTable, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, agPortConfig=agPortConfig, vlanCurCfgJumbo=vlanCurCfgJumbo, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, agPortCurCfgBwmContract=agPortCurCfgBwmContract, stgCurCfgState=stgCurCfgState, mirrOperMirroredPort=mirrOperMirroredPort, stgNewCfgPortState=stgNewCfgPortState, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, stgCurCfgTable=stgCurCfgTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCurCfgPortIndex=stgCurCfgPortIndex, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portInfoTableEntry=portInfoTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, mirrOperState=mirrOperState, stgCurCfgPortState=stgCurCfgPortState, agPortCurCfgPrefLink=agPortCurCfgPrefLink, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, agPortNewCfgBackLink=agPortNewCfgBackLink, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portCpuStatsUtilTable=portCpuStatsUtilTable, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortCurCfgState=agPortCurCfgState)
