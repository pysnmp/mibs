...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, trunkgroup=trunkgroup, agPortNewCfgRmon=agPortNewCfgRmon, agPortCurCfgStp=agPortCurCfgStp, vlanCurCfgPorts=vlanCurCfgPorts, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, vlanNewCfgPorts=vlanNewCfgPorts, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, agPortCurCfgBwmContract=agPortCurCfgBwmContract, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portInfoMode=portInfoMode, stgCurCfgIndex=stgCurCfgIndex, vlanNewCfgDelete=vlanNewCfgDelete, portInfoPhyIfDescr=portInfoPhyIfDescr, portStatsTableEntry=portStatsTableEntry, port_info=port_info, agPortCurCfgVlanTag=agPortCurCfgVlanTag, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortTableMaxEnt=agPortTableMaxEnt, portInfoPhyIfMtu=portInfoPhyIfMtu, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, stgNewCfgStgIndex=stgNewCfgStgIndex, agPortNewCfgTable=agPortNewCfgTable, portStatsPhyIfInOctets=portStatsPhyIfInOctets, mirrPortMirr=mirrPortMirr, agPortNewCfgState=agPortNewCfgState, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portCpuStatsUtilIndx=portCpuStatsUtilIndx, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, agPortCurCfgTableEntry=agPortCurCfgTableEntry, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, vlans=vlans, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, mirrOper=mirrOper, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, agPortNewCfgBwmContract=agPortNewCfgBwmContract, stgCurCfgStgIndex=stgCurCfgStgIndex, portStatsIndx=portStatsIndx, agPortCurCfgIndx=agPortCurCfgIndx, stgNewCfgIndex=stgNewCfgIndex, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanMaxEnt=vlanMaxEnt, agPortCurCfgPortName=agPortCurCfgPortName, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, agPortNewCfgPVID=agPortNewCfgPVID, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmNewCfgMirroredPort=pmNewCfgMirroredPort, stgNewCfgAddVlan=stgNewCfgAddVlan, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, mirrVlanMirr=mirrVlanMirr, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, mirrOperTimeout=mirrOperTimeout, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, vlanNewCfgAddPort=vlanNewCfgAddPort, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, vlanNewCfgBwmContract=vlanNewCfgBwmContract, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, portmirroring=portmirroring, agPortNewCfgTableEntry=agPortNewCfgTableEntry, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, stgNewCfgPortState=stgNewCfgPortState, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanNewCfgStg=vlanNewCfgStg, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, agPortNewCfgPortName=agPortNewCfgPortName, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgNewCfgTable=stgNewCfgTable, portInfoIndx=portInfoIndx, vlanCurCfgState=vlanCurCfgState, agPortNewCfgBackLink=agPortNewCfgBackLink, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portInfoPhyIfType=portInfoPhyIfType, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, agPortNewCfgPrefLink=agPortNewCfgPrefLink, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portInfoFlowCtrl=portInfoFlowCtrl, pmNewCfgTimeout=pmNewCfgTimeout, stgCurCfgPortTable=stgCurCfgPortTable, stgNewCfgState=stgNewCfgState, mirroring=mirroring, vlanNewCfgVlanId=vlanNewCfgVlanId, spannTreeGrpCfg=spannTreeGrpCfg, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, portStatsPhyIfInErrors=portStatsPhyIfInErrors, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, pmCurCfgState=pmCurCfgState, port_stats=port_stats, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, portInfoTableEntry=portInfoTableEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanNewCfgTable=vlanNewCfgTable, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgTableEntry=stgCurCfgTableEntry, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, stgNewCfgPortIndex=stgNewCfgPortIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgCurCfgTable=stgCurCfgTable, mirrOperState=mirrOperState, stgNewCfgTableEntry=stgNewCfgTableEntry, agPortNewCfgStp=agPortNewCfgStp, stgCurCfgPortState=stgCurCfgPortState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, agPortCurCfgPrefLink=agPortCurCfgPrefLink, mirrOperMirroredPort=mirrOperMirroredPort, vlanCurCfgStg=vlanCurCfgStg, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, portInfoSpeed=portInfoSpeed, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, portCpuStatsUtilTable=portCpuStatsUtilTable, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, pmCurCfgTimeout=pmCurCfgTimeout, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmCurCfgMirroredPort=pmCurCfgMirroredPort, agPortNewCfgIndx=agPortNewCfgIndx, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, agPortCurCfgState=agPortCurCfgState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, trunkGroupTableMaxSize=trunkGroupTableMaxSize, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, agPortNewCfgVlanTag=agPortNewCfgVlanTag, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, vlanCurCfgVlanId=vlanCurCfgVlanId, agPortCurCfgPVID=agPortCurCfgPVID, agPortCurCfgBackLink=agPortCurCfgBackLink, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, portInfoLink=portInfoLink, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, stgNewCfgPortTable=stgNewCfgPortTable, stgCurCfgState=stgCurCfgState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portStatsTable=portStatsTable, agPortCurCfgTable=agPortCurCfgTable, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mirrOperType=mirrOperType, vlanCurCfgTable=vlanCurCfgTable, agPortCurCfgRmon=agPortCurCfgRmon, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, portInfoTable=portInfoTable, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portInfoPhyIfLastChange=portInfoPhyIfLastChange, pmNewCfgState=pmNewCfgState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portCpuStats=portCpuStats, agPortConfig=agPortConfig, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, vlanNewCfgState=vlanNewCfgState, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex)
