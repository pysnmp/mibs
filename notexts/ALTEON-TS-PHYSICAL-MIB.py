...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgStgIndex=stgCurCfgStgIndex, agPortNewCfgIndx=agPortNewCfgIndx, port_info=port_info, agPortNewCfgVlanTag=agPortNewCfgVlanTag, vlanCurCfgPorts=vlanCurCfgPorts, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, agPortCurCfgPrefLink=agPortCurCfgPrefLink, trunkgroup=trunkgroup, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, stgNewCfgIndex=stgNewCfgIndex, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, vlanCurCfgTable=vlanCurCfgTable, vlanCurCfgStg=vlanCurCfgStg, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, vlanNewCfgVlanName=vlanNewCfgVlanName, pmNewCfgState=pmNewCfgState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, mirrOperType=mirrOperType, stgNewCfgTable=stgNewCfgTable, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, agPortCurCfgTableEntry=agPortCurCfgTableEntry, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, portCpuStatsUtilTable=portCpuStatsUtilTable, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, mirrOperMirroredPort=mirrOperMirroredPort, agPortCurCfgTable=agPortCurCfgTable, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, agPortNewCfgPrefLink=agPortNewCfgPrefLink, pmCurCfgPortMirrState=pmCurCfgPortMirrState, agPortNewCfgTableEntry=agPortNewCfgTableEntry, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portInfoPhyIfMtu=portInfoPhyIfMtu, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgPortTable=stgNewCfgPortTable, agPortNewCfgState=agPortNewCfgState, portInfoPhyIfDescr=portInfoPhyIfDescr, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, stgNewCfgPortState=stgNewCfgPortState, agPortNewCfgTable=agPortNewCfgTable, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, pmCurCfgMirroredPort=pmCurCfgMirroredPort, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, stgNewCfgStgIndex=stgNewCfgStgIndex, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portStatsTable=portStatsTable, agPortNewCfgRmon=agPortNewCfgRmon, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, portInfoIndx=portInfoIndx, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, agPortNewCfgBackLink=agPortNewCfgBackLink, portInfoFlowCtrl=portInfoFlowCtrl, agPortCurCfgBwmContract=agPortCurCfgBwmContract, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portInfoLink=portInfoLink, stgCurCfgTable=stgCurCfgTable, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, agPortCurCfgBackLink=agPortCurCfgBackLink, portCpuStatsUtilIndx=portCpuStatsUtilIndx, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, vlanNewCfgPorts=vlanNewCfgPorts, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portInfoTableEntry=portInfoTableEntry, vlanNewCfgStg=vlanNewCfgStg, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgNewCfgAddVlan=stgNewCfgAddVlan, portInfoMode=portInfoMode, vlanCurCfgState=vlanCurCfgState, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, pmCurCfgState=pmCurCfgState, agPortTableMaxEnt=agPortTableMaxEnt, agPortNewCfgPortName=agPortNewCfgPortName, portInfoTable=portInfoTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portCpuStats=portCpuStats, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, portInfoSpeed=portInfoSpeed, stgNewCfgPortIndex=stgNewCfgPortIndex, portInfoPhyIfLastChange=portInfoPhyIfLastChange, portStatsPhyIfInOctets=portStatsPhyIfInOctets, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, agPortNewCfgBwmContract=agPortNewCfgBwmContract, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, stgCurCfgState=stgCurCfgState, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, agPortCurCfgState=agPortCurCfgState, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, mirrOperMonitoringPort=mirrOperMonitoringPort, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, agPortCurCfgPVID=agPortCurCfgPVID, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, agPortConfig=agPortConfig, agPortCurCfgIndx=agPortCurCfgIndx, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, port_stats=port_stats, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanNewCfgAddPort=vlanNewCfgAddPort, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, vlanMaxEnt=vlanMaxEnt, vlanCurCfgJumbo=vlanCurCfgJumbo, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgPortState=stgCurCfgPortState, mirroring=mirroring, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mirrOperState=mirrOperState, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, spannTreeGrpCfg=spannTreeGrpCfg, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, portInfoPhyIfType=portInfoPhyIfType, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, portmirroring=portmirroring, vlans=vlans, mirrPortMirr=mirrPortMirr, stgCurCfgTableEntry=stgCurCfgTableEntry, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, agPortCurCfgRmon=agPortCurCfgRmon, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, pmCurCfgTimeout=pmCurCfgTimeout, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmNewCfgTimeout=pmNewCfgTimeout, agPortNewCfgStp=agPortNewCfgStp, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, vlanCurCfgVlanId=vlanCurCfgVlanId, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanNewCfgJumbo=vlanNewCfgJumbo, mirrOper=mirrOper, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, agPortCurCfgPortName=agPortCurCfgPortName, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, stgCurCfgPortTable=stgCurCfgPortTable, portStatsTableEntry=portStatsTableEntry, mirrOperTimeout=mirrOperTimeout, agPortCurCfgStp=agPortCurCfgStp, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, agPortCurCfgVlanTag=agPortCurCfgVlanTag, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, mirrVlanMirr=mirrVlanMirr, agPortNewCfgPVID=agPortNewCfgPVID, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanNewCfgState=vlanNewCfgState, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgDelete=vlanNewCfgDelete, portStatsPhyIfInErrors=portStatsPhyIfInErrors, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, pmNewCfgMirroredPort=pmNewCfgMirroredPort, stgNewCfgState=stgNewCfgState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portStatsIndx=portStatsIndx, trunkGroupNewCfgState=trunkGroupNewCfgState, stgCurCfgIndex=stgCurCfgIndex, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable)
