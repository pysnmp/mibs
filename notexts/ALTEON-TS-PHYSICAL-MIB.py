...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgCurCfgPortIndex=stgCurCfgPortIndex, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, agPortNewCfgIndx=agPortNewCfgIndx, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortNewCfgBackLink=agPortNewCfgBackLink, agPortNewCfgTableEntry=agPortNewCfgTableEntry, pmNewCfgMirroredPort=pmNewCfgMirroredPort, mirrVlanMirr=mirrVlanMirr, vlanNewCfgPorts=vlanNewCfgPorts, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgNewCfgTableEntry=stgNewCfgTableEntry, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, spannTreeGrpCfg=spannTreeGrpCfg, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, agPortNewCfgBwmContract=agPortNewCfgBwmContract, portCpuStats=portCpuStats, agPortCurCfgBwmContract=agPortCurCfgBwmContract, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portInfoTableEntry=portInfoTableEntry, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, pmNewCfgTimeout=pmNewCfgTimeout, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, mirrOperTimeout=mirrOperTimeout, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, agPortCurCfgState=agPortCurCfgState, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mirrOperState=mirrOperState, agPortNewCfgVlanTag=agPortNewCfgVlanTag, vlanCurCfgTable=vlanCurCfgTable, portInfoMode=portInfoMode, portInfoLink=portInfoLink, trunkgroup=trunkgroup, agPortTableMaxEnt=agPortTableMaxEnt, agPortCurCfgTableEntry=agPortCurCfgTableEntry, stgNewCfgState=stgNewCfgState, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portStatsTableEntry=portStatsTableEntry, agPortCurCfgVlanTag=agPortCurCfgVlanTag, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgStgIndex=stgNewCfgStgIndex, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, mirrOperMonitoringPort=mirrOperMonitoringPort, vlanNewCfgStg=vlanNewCfgStg, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanNewCfgAddPort=vlanNewCfgAddPort, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, vlanNewCfgState=vlanNewCfgState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, agPortNewCfgStp=agPortNewCfgStp, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, portInfoIndx=portInfoIndx, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, port_info=port_info, vlanMaxEnt=vlanMaxEnt, portInfoTable=portInfoTable, mirrOperMirroredPort=mirrOperMirroredPort, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, stgCurCfgTableEntry=stgCurCfgTableEntry, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, agPortNewCfgPVID=agPortNewCfgPVID, pmCurCfgMirroredPort=pmCurCfgMirroredPort, agPortNewCfgPrefLink=agPortNewCfgPrefLink, mirroring=mirroring, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, pmCurCfgState=pmCurCfgState, vlanCurCfgStg=vlanCurCfgStg, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, vlanNewCfgDelete=vlanNewCfgDelete, vlanCurCfgPorts=vlanCurCfgPorts, stgCurCfgState=stgCurCfgState, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, stgCurCfgPortState=stgCurCfgPortState, agPortCurCfgTable=agPortCurCfgTable, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, agPortCurCfgPVID=agPortCurCfgPVID, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, portStatsPhyIfInOctets=portStatsPhyIfInOctets, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, vlanCurCfgVlanName=vlanCurCfgVlanName, portInfoPhyIfType=portInfoPhyIfType, portStatsTable=portStatsTable, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, portInfoSpeed=portInfoSpeed, stgNewCfgIndex=stgNewCfgIndex, portCpuStatsUtilTable=portCpuStatsUtilTable, vlanNewCfgVlanName=vlanNewCfgVlanName, pmCurCfgTimeout=pmCurCfgTimeout, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, portInfoPhyIfMtu=portInfoPhyIfMtu, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlans=vlans, stgNewCfgTable=stgNewCfgTable, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, agPortNewCfgPortName=agPortNewCfgPortName, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, agPortNewCfgTable=agPortNewCfgTable, stgNewCfgAddVlan=stgNewCfgAddVlan, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, port_stats=port_stats, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgNewCfgPortState=stgNewCfgPortState, vlanNewCfgJumbo=vlanNewCfgJumbo, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portStatsIndx=portStatsIndx, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, agPortNewCfgState=agPortNewCfgState, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, agPortCurCfgBackLink=agPortCurCfgBackLink, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgNewCfgPortTable=stgNewCfgPortTable, agPortConfig=agPortConfig, agPortCurCfgPortName=agPortCurCfgPortName, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portInfoFlowCtrl=portInfoFlowCtrl, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, stgCurCfgTable=stgCurCfgTable, trunkGroupCurCfgState=trunkGroupCurCfgState, agPortCurCfgStp=agPortCurCfgStp, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, agPortCurCfgPrefLink=agPortCurCfgPrefLink, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mirrPortMirr=mirrPortMirr, agPortCurCfgRmon=agPortCurCfgRmon, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgCurCfgIndex=stgCurCfgIndex, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortCurCfgIndx=agPortCurCfgIndx, portStatsPhyIfInErrors=portStatsPhyIfInErrors, stgNewCfgPortIndex=stgNewCfgPortIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, portInfoPhyIfLastChange=portInfoPhyIfLastChange, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mirrOperType=mirrOperType, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portmirroring=portmirroring, portCpuStatsUtilIndx=portCpuStatsUtilIndx, stgCurCfgPortTable=stgCurCfgPortTable, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, vlanCurCfgState=vlanCurCfgState, pmNewCfgState=pmNewCfgState, vlanNewCfgTable=vlanNewCfgTable, mirrOper=mirrOper, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, agPortNewCfgRmon=agPortNewCfgRmon)
