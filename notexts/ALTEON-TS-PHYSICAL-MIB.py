...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", agPortConfig=agPortConfig, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, agPortNewCfgBackLink=agPortNewCfgBackLink, mirrOperTimeout=mirrOperTimeout, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portInfoFlowCtrl=portInfoFlowCtrl, mirrOperType=mirrOperType, stgCurCfgStgIndex=stgCurCfgStgIndex, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portInfoTableEntry=portInfoTableEntry, vlanCurCfgStg=vlanCurCfgStg, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, agPortCurCfgTableEntry=agPortCurCfgTableEntry, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, trunkGroupNewCfgTable=trunkGroupNewCfgTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portmirroring=portmirroring, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, portStatsIndx=portStatsIndx, trunkGroupNewCfgState=trunkGroupNewCfgState, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, vlanNewCfgPorts=vlanNewCfgPorts, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanNewCfgVlanName=vlanNewCfgVlanName, agPortCurCfgBackLink=agPortCurCfgBackLink, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, agPortNewCfgTableEntry=agPortNewCfgTableEntry, pmNewCfgTimeout=pmNewCfgTimeout, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mirrVlanMirr=mirrVlanMirr, agPortNewCfgIndx=agPortNewCfgIndx, agPortNewCfgStp=agPortNewCfgStp, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, vlanNewCfgDelete=vlanNewCfgDelete, portInfoSpeed=portInfoSpeed, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, agPortNewCfgPrefLink=agPortNewCfgPrefLink, agPortCurCfgPVID=agPortCurCfgPVID, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portCpuStatsUtilIndx=portCpuStatsUtilIndx, portInfoMode=portInfoMode, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanNewCfgJumbo=vlanNewCfgJumbo, agPortCurCfgPrefLink=agPortCurCfgPrefLink, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, pmNewCfgState=pmNewCfgState, portInfoPhyIfMtu=portInfoPhyIfMtu, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, agPortNewCfgPortName=agPortNewCfgPortName, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, portInfoPhyIfLastChange=portInfoPhyIfLastChange, stgCurCfgState=stgCurCfgState, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgTable=stgNewCfgTable, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, stgNewCfgIndex=stgNewCfgIndex, portStatsTableEntry=portStatsTableEntry, vlanNewCfgState=vlanNewCfgState, stgCurCfgPortState=stgCurCfgPortState, agPortCurCfgVlanTag=agPortCurCfgVlanTag, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, stgCurCfgIndex=stgCurCfgIndex, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortCurCfgIndx=agPortCurCfgIndx, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgPortTable=stgNewCfgPortTable, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, trunkgroup=trunkgroup, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portCpuStatsUtilTable=portCpuStatsUtilTable, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, mirrPortMirr=mirrPortMirr, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanCurCfgTable=vlanCurCfgTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mirrOperMirroredPort=mirrOperMirroredPort, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, pmNewCfgMirroredPort=pmNewCfgMirroredPort, agPortCurCfgStp=agPortCurCfgStp, agPortNewCfgState=agPortNewCfgState, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, portCpuStats=portCpuStats, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, mirrOper=mirrOper, portInfoLink=portInfoLink, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, trunkGroupCurCfgState=trunkGroupCurCfgState, portStatsTable=portStatsTable, agPortNewCfgPVID=agPortNewCfgPVID, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, port_stats=port_stats, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, agPortNewCfgRmon=agPortNewCfgRmon, agPortCurCfgBwmContract=agPortCurCfgBwmContract, port_info=port_info, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, vlanNewCfgAddPort=vlanNewCfgAddPort, mirroring=mirroring, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, stgCurCfgTable=stgCurCfgTable, agPortTableMaxEnt=agPortTableMaxEnt, stgNewCfgPortState=stgNewCfgPortState, mirrOperMonitoringPort=mirrOperMonitoringPort, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, spannTreeGrpCfg=spannTreeGrpCfg, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, stgNewCfgState=stgNewCfgState, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortNewCfgBwmContract=agPortNewCfgBwmContract, portStatsPhyIfInErrors=portStatsPhyIfInErrors, portInfoIndx=portInfoIndx, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, vlanCurCfgState=vlanCurCfgState, portInfoPhyIfDescr=portInfoPhyIfDescr, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portInfoTable=portInfoTable, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmCurCfgMirroredPort=pmCurCfgMirroredPort, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, vlans=vlans, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, portInfoPhyIfType=portInfoPhyIfType, vlanNewCfgTable=vlanNewCfgTable, agPortCurCfgRmon=agPortCurCfgRmon, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, agPortCurCfgState=agPortCurCfgState, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, vlanMaxEnt=vlanMaxEnt, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgNewCfgStgIndex=stgNewCfgStgIndex, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, agPortNewCfgVlanTag=agPortNewCfgVlanTag, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanCurCfgPorts=vlanCurCfgPorts, agPortCurCfgPortName=agPortCurCfgPortName, pmCurCfgState=pmCurCfgState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgCurCfgTableEntry=stgCurCfgTableEntry, agPortNewCfgTable=agPortNewCfgTable, pmCurCfgTimeout=pmCurCfgTimeout, mirrOperState=mirrOperState, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, agPortCurCfgTable=agPortCurCfgTable, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, portStatsPhyIfInOctets=portStatsPhyIfInOctets, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgCurCfgPortTable=stgCurCfgPortTable, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, stgNewCfgPortIndex=stgNewCfgPortIndex, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, stgNewCfgAddVlan=stgNewCfgAddVlan)
