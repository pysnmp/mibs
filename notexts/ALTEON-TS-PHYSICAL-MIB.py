...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, agPortTableMaxEnt=agPortTableMaxEnt, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, portCpuStatsUtilTable=portCpuStatsUtilTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, agPortCurCfgIndx=agPortCurCfgIndx, agPortNewCfgIndx=agPortNewCfgIndx, portStatsPhyIfInErrors=portStatsPhyIfInErrors, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, mirrOper=mirrOper, mirrPortMirr=mirrPortMirr, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, mirrOperType=mirrOperType, mirrOperTimeout=mirrOperTimeout, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mirroring=mirroring, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, mirrOperMirroredPort=mirrOperMirroredPort, vlanNewCfgVlanName=vlanNewCfgVlanName, portmirroring=portmirroring, portCpuStatsUtilIndx=portCpuStatsUtilIndx, vlanCurCfgPorts=vlanCurCfgPorts, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, agPortCurCfgPVID=agPortCurCfgPVID, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, trunkGroupCurCfgTable=trunkGroupCurCfgTable, agPortNewCfgPortName=agPortNewCfgPortName, agPortCurCfgTable=agPortCurCfgTable, pmCurCfgTimeout=pmCurCfgTimeout, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, agPortConfig=agPortConfig, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, stgNewCfgPortState=stgNewCfgPortState, portInfoPhyIfMtu=portInfoPhyIfMtu, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, agPortCurCfgState=agPortCurCfgState, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, agPortCurCfgTableEntry=agPortCurCfgTableEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, pmNewCfgTimeout=pmNewCfgTimeout, stgNewCfgTable=stgNewCfgTable, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, mirrVlanMirr=mirrVlanMirr, portStatsTable=portStatsTable, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portInfoFlowCtrl=portInfoFlowCtrl, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, stgCurCfgPortIndex=stgCurCfgPortIndex, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, port_info=port_info, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgIndex=stgNewCfgIndex, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, agPortCurCfgPortName=agPortCurCfgPortName, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portStatsTableEntry=portStatsTableEntry, vlanNewCfgTable=vlanNewCfgTable, agPortNewCfgStp=agPortNewCfgStp, trunkgroup=trunkgroup, stgNewCfgState=stgNewCfgState, stgNewCfgPortIndex=stgNewCfgPortIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, agPortCurCfgStp=agPortCurCfgStp, portStatsIndx=portStatsIndx, portInfoTable=portInfoTable, pmCurCfgState=pmCurCfgState, portInfoSpeed=portInfoSpeed, agPortNewCfgRmon=agPortNewCfgRmon, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, agPortCurCfgPrefLink=agPortCurCfgPrefLink, portInfoIndx=portInfoIndx, portInfoPhyIfType=portInfoPhyIfType, stgCurCfgState=stgCurCfgState, portInfoPhyIfLastChange=portInfoPhyIfLastChange, mirrOperState=mirrOperState, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, stgCurCfgPortState=stgCurCfgPortState, portStatsPhyIfInOctets=portStatsPhyIfInOctets, vlanMaxEnt=vlanMaxEnt, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanCurCfgStg=vlanCurCfgStg, portInfoMode=portInfoMode, stgCurCfgStgIndex=stgCurCfgStgIndex, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, vlanNewCfgPorts=vlanNewCfgPorts, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmNewCfgMirroredPort=pmNewCfgMirroredPort, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, vlans=vlans, agPortNewCfgTableEntry=agPortNewCfgTableEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, vlanNewCfgStg=vlanNewCfgStg, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portCpuStats=portCpuStats, portInfoLink=portInfoLink, agPortNewCfgState=agPortNewCfgState, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanCurCfgTable=vlanCurCfgTable, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, spannTreeGrpCfg=spannTreeGrpCfg, agPortCurCfgBwmContract=agPortCurCfgBwmContract, agPortCurCfgRmon=agPortCurCfgRmon, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgCurCfgIndex=stgCurCfgIndex, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, agPortNewCfgTable=agPortNewCfgTable, agPortNewCfgBackLink=agPortNewCfgBackLink, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, agPortCurCfgVlanTag=agPortCurCfgVlanTag, stgCurCfgTable=stgCurCfgTable, agPortNewCfgPVID=agPortNewCfgPVID, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, stgNewCfgStgIndex=stgNewCfgStgIndex, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, vlanNewCfgDelete=vlanNewCfgDelete, agPortNewCfgPrefLink=agPortNewCfgPrefLink, pmCurCfgMirroredPort=pmCurCfgMirroredPort, stgCurCfgPortTable=stgCurCfgPortTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, agPortNewCfgVlanTag=agPortNewCfgVlanTag, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanCurCfgState=vlanCurCfgState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, trunkGroupTableMaxSize=trunkGroupTableMaxSize, port_stats=port_stats, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, portInfoPhyIfDescr=portInfoPhyIfDescr, vlanNewCfgJumbo=vlanNewCfgJumbo, agPortCurCfgBackLink=agPortCurCfgBackLink, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, agPortNewCfgBwmContract=agPortNewCfgBwmContract, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanNewCfgState=vlanNewCfgState, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portInfoTableEntry=portInfoTableEntry, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, pmNewCfgState=pmNewCfgState, stgNewCfgPortTable=stgNewCfgPortTable, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort)
