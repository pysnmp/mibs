...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, portStatsTableEntry=portStatsTableEntry, stgCurCfgPortTable=stgCurCfgPortTable, mirroring=mirroring, agPortCurCfgPrefLink=agPortCurCfgPrefLink, portStatsIndx=portStatsIndx, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, vlanNewCfgPorts=vlanNewCfgPorts, portInfoPhyIfLastChange=portInfoPhyIfLastChange, pmNewCfgTimeout=pmNewCfgTimeout, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupCurCfgState=trunkGroupCurCfgState, agPortCurCfgTableEntry=agPortCurCfgTableEntry, agPortNewCfgBackLink=agPortNewCfgBackLink, vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, agPortNewCfgPortName=agPortNewCfgPortName, vlanNewCfgVlanId=vlanNewCfgVlanId, agPortNewCfgBwmContract=agPortNewCfgBwmContract, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mirrPortMirr=mirrPortMirr, vlanNewCfgState=vlanNewCfgState, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, agPortCurCfgStp=agPortCurCfgStp, portStatsPhyIfInErrors=portStatsPhyIfInErrors, mirrOperType=mirrOperType, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, mirrOperState=mirrOperState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, agPortCurCfgRmon=agPortCurCfgRmon, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, portInfoPhyIfType=portInfoPhyIfType, mirrOperTimeout=mirrOperTimeout, portInfoTableEntry=portInfoTableEntry, agPortNewCfgStp=agPortNewCfgStp, stgNewCfgPortTable=stgNewCfgPortTable, portInfoPhyIfMtu=portInfoPhyIfMtu, mirrVlanMirr=mirrVlanMirr, mirrOperMonitoringPort=mirrOperMonitoringPort, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, portInfoLink=portInfoLink, stgNewCfgPortIndex=stgNewCfgPortIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanNewCfgDelete=vlanNewCfgDelete, stgCurCfgIndex=stgCurCfgIndex, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanCurCfgTable=vlanCurCfgTable, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portCpuStatsUtilIndx=portCpuStatsUtilIndx, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanCurCfgStg=vlanCurCfgStg, agPortCurCfgBwmContract=agPortCurCfgBwmContract, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, pmCurCfgTimeout=pmCurCfgTimeout, pmNewCfgState=pmNewCfgState, agPortCurCfgPortName=agPortCurCfgPortName, agPortTableMaxEnt=agPortTableMaxEnt, stgCurCfgStgIndex=stgCurCfgStgIndex, spannTreeGrpCfg=spannTreeGrpCfg, portCpuStatsUtilTable=portCpuStatsUtilTable, portCpuStats=portCpuStats, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, agPortNewCfgRmon=agPortNewCfgRmon, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, stgNewCfgIndex=stgNewCfgIndex, portmirroring=portmirroring, stgNewCfgPortState=stgNewCfgPortState, portInfoSpeed=portInfoSpeed, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, vlanCurCfgPorts=vlanCurCfgPorts, agPortNewCfgTable=agPortNewCfgTable, agPortNewCfgIndx=agPortNewCfgIndx, pmCurCfgState=pmCurCfgState, agPortNewCfgPrefLink=agPortNewCfgPrefLink, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, mirrOper=mirrOper, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, agPortCurCfgState=agPortCurCfgState, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, mirrOperMirroredPort=mirrOperMirroredPort, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, vlanNewCfgVlanName=vlanNewCfgVlanName, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, portInfoTable=portInfoTable, port_stats=port_stats, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portInfoFlowCtrl=portInfoFlowCtrl, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanNewCfgJumbo=vlanNewCfgJumbo, agPortConfig=agPortConfig, vlans=vlans, agPortCurCfgIndx=agPortCurCfgIndx, stgNewCfgState=stgNewCfgState, vlanNewCfgStg=vlanNewCfgStg, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, agPortCurCfgVlanTag=agPortCurCfgVlanTag, agPortCurCfgTable=agPortCurCfgTable, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgTableEntry=stgCurCfgTableEntry, agPortNewCfgVlanTag=agPortNewCfgVlanTag, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, agPortNewCfgState=agPortNewCfgState, stgCurCfgPortIndex=stgCurCfgPortIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanNewCfgTable=vlanNewCfgTable, stgCurCfgPortState=stgCurCfgPortState, agPortNewCfgTableEntry=agPortNewCfgTableEntry, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, pmNewCfgMirroredPort=pmNewCfgMirroredPort, vlanCurCfgJumbo=vlanCurCfgJumbo, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, port_info=port_info, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgStgIndex=stgNewCfgStgIndex, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, agPortNewCfgPVID=agPortNewCfgPVID, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, agPortCurCfgBackLink=agPortCurCfgBackLink, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, vlanCurCfgState=vlanCurCfgState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, stgCurCfgTable=stgCurCfgTable, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, portStatsPhyIfInOctets=portStatsPhyIfInOctets, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, portInfoPhyIfDescr=portInfoPhyIfDescr, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, trunkGroupNewCfgState=trunkGroupNewCfgState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, vlanNewCfgAddPort=vlanNewCfgAddPort, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, portInfoIndx=portInfoIndx, trunkGroupTableMaxSize=trunkGroupTableMaxSize, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanMaxEnt=vlanMaxEnt, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, stgNewCfgTable=stgNewCfgTable, pmCurCfgMirroredPort=pmCurCfgMirroredPort, stgCurCfgState=stgCurCfgState, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, trunkgroup=trunkgroup, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portStatsTable=portStatsTable, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, agPortCurCfgPVID=agPortCurCfgPVID, portInfoMode=portInfoMode)
