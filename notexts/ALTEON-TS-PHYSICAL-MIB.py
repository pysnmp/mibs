...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", trunkGroupCurCfgTable=trunkGroupCurCfgTable, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, agPortNewCfgVlanTag=agPortNewCfgVlanTag, mirrOperTimeout=mirrOperTimeout, portCpuStatsUtilIndx=portCpuStatsUtilIndx, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portCpuStatsUtilTable=portCpuStatsUtilTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmCurCfgPortMirrState=pmCurCfgPortMirrState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, stgNewCfgTable=stgNewCfgTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portInfoIndx=portInfoIndx, portStatsTableEntry=portStatsTableEntry, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupTableMaxSize=trunkGroupTableMaxSize, agPortConfig=agPortConfig, trunkgroup=trunkgroup, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, mirrOperState=mirrOperState, pmCurCfgState=pmCurCfgState, stgNewCfgPortIndex=stgNewCfgPortIndex, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, vlanCurCfgJumbo=vlanCurCfgJumbo, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, agPortNewCfgPortName=agPortNewCfgPortName, stgCurCfgTableEntry=stgCurCfgTableEntry, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, pmCurCfgMirroredPort=pmCurCfgMirroredPort, mirrOperType=mirrOperType, vlanNewCfgStg=vlanNewCfgStg, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, stgNewCfgAddVlan=stgNewCfgAddVlan, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, spannTreeGrpCfg=spannTreeGrpCfg, stgNewCfgState=stgNewCfgState, agPortCurCfgStp=agPortCurCfgStp, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, stgCurCfgPortTable=stgCurCfgPortTable, portInfoPhyIfMtu=portInfoPhyIfMtu, vlans=vlans, agPortTableMaxEnt=agPortTableMaxEnt, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, vlanNewCfgState=vlanNewCfgState, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, portmirroring=portmirroring, port_stats=port_stats, vlanCurCfgStg=vlanCurCfgStg, vlanCurCfgPorts=vlanCurCfgPorts, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, agPortNewCfgRmon=agPortNewCfgRmon, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, agPortCurCfgPrefLink=agPortCurCfgPrefLink, vlanNewCfgBwmContract=vlanNewCfgBwmContract, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, mirrPortMirr=mirrPortMirr, agPortNewCfgStp=agPortNewCfgStp, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, agPortCurCfgBwmContract=agPortCurCfgBwmContract, vlanCurCfgTable=vlanCurCfgTable, agPortNewCfgTableEntry=agPortNewCfgTableEntry, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, pmNewCfgTimeout=pmNewCfgTimeout, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanNewCfgVlanName=vlanNewCfgVlanName, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, vlanNewCfgJumbo=vlanNewCfgJumbo, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, portInfoLink=portInfoLink, agPortCurCfgTable=agPortCurCfgTable, stgCurCfgState=stgCurCfgState, stgCurCfgStgIndex=stgCurCfgStgIndex, mirrOperMirroredPort=mirrOperMirroredPort, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanCurCfgVlanId=vlanCurCfgVlanId, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, agPortCurCfgState=agPortCurCfgState, stgNewCfgPortTable=stgNewCfgPortTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, agPortCurCfgVlanTag=agPortCurCfgVlanTag, vlanNewCfgTable=vlanNewCfgTable, agPortNewCfgPVID=agPortNewCfgPVID, trunkGroupCurCfgState=trunkGroupCurCfgState, portInfoPhyIfType=portInfoPhyIfType, vlanCurCfgState=vlanCurCfgState, portInfoSpeed=portInfoSpeed, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, vlanNewCfgPorts=vlanNewCfgPorts, portStatsPhyIfInErrors=portStatsPhyIfInErrors, pmNewCfgMirroredPort=pmNewCfgMirroredPort, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portInfoMode=portInfoMode, stgCurCfgTable=stgCurCfgTable, vlanNewCfgAddPort=vlanNewCfgAddPort, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, portStatsPhyIfInOctets=portStatsPhyIfInOctets, portStatsIndx=portStatsIndx, mirrOperMonitoringPort=mirrOperMonitoringPort, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, agPortCurCfgRmon=agPortCurCfgRmon, pmCurCfgTimeout=pmCurCfgTimeout, agPortNewCfgState=agPortNewCfgState, mirrOper=mirrOper, agPortNewCfgBwmContract=agPortNewCfgBwmContract, agPortNewCfgIndx=agPortNewCfgIndx, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, agPortCurCfgIndx=agPortCurCfgIndx, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, agPortCurCfgPortName=agPortCurCfgPortName, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portInfoTable=portInfoTable, agPortCurCfgTableEntry=agPortCurCfgTableEntry, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, agPortCurCfgPVID=agPortCurCfgPVID, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portInfoFlowCtrl=portInfoFlowCtrl, agPortNewCfgTable=agPortNewCfgTable, mirroring=mirroring, portStatsTable=portStatsTable, portInfoPhyIfDescr=portInfoPhyIfDescr, stgNewCfgStgIndex=stgNewCfgStgIndex, portCpuStats=portCpuStats, stgNewCfgPortState=stgNewCfgPortState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmNewCfgState=pmNewCfgState, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, portInfoPhyIfLastChange=portInfoPhyIfLastChange, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, stgCurCfgPortIndex=stgCurCfgPortIndex, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, agPortCurCfgBackLink=agPortCurCfgBackLink, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, portInfoTableEntry=portInfoTableEntry, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, stgCurCfgIndex=stgCurCfgIndex, vlanMaxEnt=vlanMaxEnt, stgCurCfgPortState=stgCurCfgPortState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, agPortNewCfgPrefLink=agPortNewCfgPrefLink, agPortNewCfgBackLink=agPortNewCfgBackLink, port_info=port_info, stgNewCfgIndex=stgNewCfgIndex, mirrVlanMirr=mirrVlanMirr)
