...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, pmCurCfgTimeout=pmCurCfgTimeout, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, portInfoMode=portInfoMode, portStatsTableEntry=portStatsTableEntry, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, mirrOperType=mirrOperType, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, portStatsTable=portStatsTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, agPortNewCfgRmon=agPortNewCfgRmon, mirroring=mirroring, portInfoLink=portInfoLink, stgCurCfgState=stgCurCfgState, stgNewCfgPortIndex=stgNewCfgPortIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanCurCfgVlanId=vlanCurCfgVlanId, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, stgCurCfgPortState=stgCurCfgPortState, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, portInfoPhyIfLastChange=portInfoPhyIfLastChange, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, portInfoIndx=portInfoIndx, agPortNewCfgState=agPortNewCfgState, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, vlanCurCfgJumbo=vlanCurCfgJumbo, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, mirrOperTimeout=mirrOperTimeout, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, pmNewCfgMirroredPort=pmNewCfgMirroredPort, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgStgIndex=stgNewCfgStgIndex, agPortCurCfgRmon=agPortCurCfgRmon, portInfoFlowCtrl=portInfoFlowCtrl, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, vlanCurCfgPorts=vlanCurCfgPorts, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgNewCfgPortState=stgNewCfgPortState, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, mirrVlanMirr=mirrVlanMirr, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanCurCfgState=vlanCurCfgState, mirrOperState=mirrOperState, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanNewCfgAddPort=vlanNewCfgAddPort, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortNewCfgBwmContract=agPortNewCfgBwmContract, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanCurCfgStg=vlanCurCfgStg, trunkgroup=trunkgroup, port_stats=port_stats, agPortCurCfgTable=agPortCurCfgTable, pmCurCfgState=pmCurCfgState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, agPortCurCfgBackLink=agPortCurCfgBackLink, spannTreeGrpCfg=spannTreeGrpCfg, pmNewCfgState=pmNewCfgState, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanCurCfgTable=vlanCurCfgTable, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, portInfoPhyIfMtu=portInfoPhyIfMtu, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanNewCfgDelete=vlanNewCfgDelete, agPortNewCfgPVID=agPortNewCfgPVID, vlanNewCfgPorts=vlanNewCfgPorts, agPortNewCfgVlanTag=agPortNewCfgVlanTag, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, agPortConfig=agPortConfig, agPortCurCfgVlanTag=agPortCurCfgVlanTag, stgCurCfgPortIndex=stgCurCfgPortIndex, stgCurCfgTableEntry=stgCurCfgTableEntry, agPortCurCfgTableEntry=agPortCurCfgTableEntry, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, portInfoPhyIfType=portInfoPhyIfType, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portStatsPhyIfInErrors=portStatsPhyIfInErrors, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, stgNewCfgIndex=stgNewCfgIndex, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, agPortTableMaxEnt=agPortTableMaxEnt, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mirrOperMirroredPort=mirrOperMirroredPort, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, agPortNewCfgTable=agPortNewCfgTable, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, vlanNewCfgStg=vlanNewCfgStg, agPortCurCfgStp=agPortCurCfgStp, portCpuStatsUtilTable=portCpuStatsUtilTable, stgNewCfgTableEntry=stgNewCfgTableEntry, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, portInfoTableEntry=portInfoTableEntry, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, trunkGroupCurCfgTable=trunkGroupCurCfgTable, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, agPortCurCfgBwmContract=agPortCurCfgBwmContract, vlanNewCfgJumbo=vlanNewCfgJumbo, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgNewCfgState=stgNewCfgState, portInfoSpeed=portInfoSpeed, portStatsPhyIfInOctets=portStatsPhyIfInOctets, vlanMaxEnt=vlanMaxEnt, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, agPortCurCfgIndx=agPortCurCfgIndx, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mirrPortMirr=mirrPortMirr, pmNewCfgTimeout=pmNewCfgTimeout, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, portStatsIndx=portStatsIndx, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, stgNewCfgPortTable=stgNewCfgPortTable, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, agPortCurCfgState=agPortCurCfgState, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portCpuStatsUtilIndx=portCpuStatsUtilIndx, portCpuStats=portCpuStats, agPortNewCfgStp=agPortNewCfgStp, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, portInfoTable=portInfoTable, agPortNewCfgBackLink=agPortNewCfgBackLink, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlans=vlans, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, trunkGroupNewCfgState=trunkGroupNewCfgState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, agPortCurCfgPVID=agPortCurCfgPVID, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, agPortCurCfgPortName=agPortCurCfgPortName, mirrOperMonitoringPort=mirrOperMonitoringPort, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, vlanNewCfgState=vlanNewCfgState, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, mirrOper=mirrOper, agPortNewCfgPortName=agPortNewCfgPortName, pmCurCfgMirroredPort=pmCurCfgMirroredPort, stgCurCfgPortTable=stgCurCfgPortTable, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, stgCurCfgTable=stgCurCfgTable, agPortNewCfgIndx=agPortNewCfgIndx, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, vlanNewCfgBwmContract=vlanNewCfgBwmContract, agPortNewCfgPrefLink=agPortNewCfgPrefLink, port_info=port_info, stgNewCfgTable=stgNewCfgTable, stgNewCfgAddVlan=stgNewCfgAddVlan, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, agPortCurCfgPrefLink=agPortCurCfgPrefLink, vlanNewCfgVlanId=vlanNewCfgVlanId, portmirroring=portmirroring, agPortNewCfgTableEntry=agPortNewCfgTableEntry, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort)
