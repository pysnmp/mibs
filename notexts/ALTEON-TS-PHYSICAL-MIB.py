...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupCurCfgState=trunkGroupCurCfgState, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, agPortNewCfgBackLink=agPortNewCfgBackLink, mirroring=mirroring, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, portStatsPhyIfInErrors=portStatsPhyIfInErrors, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, trunkGroupTableMaxSize=trunkGroupTableMaxSize, agPortCurCfgRmon=agPortCurCfgRmon, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgNewCfgPortTable=stgNewCfgPortTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mirrOperState=mirrOperState, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlanNewCfgJumbo=vlanNewCfgJumbo, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, stgCurCfgTable=stgCurCfgTable, portInfoIndx=portInfoIndx, portStatsTableEntry=portStatsTableEntry, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, portInfoMode=portInfoMode, vlanNewCfgState=vlanNewCfgState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, portInfoFlowCtrl=portInfoFlowCtrl, portInfoTable=portInfoTable, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, portCpuStats=portCpuStats, portStatsIndx=portStatsIndx, vlans=vlans, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, portInfoPhyIfLastChange=portInfoPhyIfLastChange, vlanNewCfgDelete=vlanNewCfgDelete, stgCurCfgTableEntry=stgCurCfgTableEntry, mirrOperMonitoringPort=mirrOperMonitoringPort, port_info=port_info, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, agPortNewCfgRmon=agPortNewCfgRmon, agPortCurCfgBackLink=agPortCurCfgBackLink, stgCurCfgStgIndex=stgCurCfgStgIndex, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, agPortNewCfgBwmContract=agPortNewCfgBwmContract, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, agPortNewCfgState=agPortNewCfgState, vlanNewCfgAddPort=vlanNewCfgAddPort, agPortCurCfgPortName=agPortCurCfgPortName, agPortCurCfgTableEntry=agPortCurCfgTableEntry, vlanCurCfgState=vlanCurCfgState, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, agPortCurCfgPrefLink=agPortCurCfgPrefLink, agPortNewCfgIndx=agPortNewCfgIndx, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanNewCfgBwmContract=vlanNewCfgBwmContract, agPortCurCfgIndx=agPortCurCfgIndx, portInfoSpeed=portInfoSpeed, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, agPortNewCfgPVID=agPortNewCfgPVID, stgCurCfgIndex=stgCurCfgIndex, port_stats=port_stats, portCpuStatsUtilIndx=portCpuStatsUtilIndx, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, agPortConfig=agPortConfig, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, mirrOperMirroredPort=mirrOperMirroredPort, mirrPortMirr=mirrPortMirr, vlanCurCfgPorts=vlanCurCfgPorts, pmNewCfgState=pmNewCfgState, agPortNewCfgTableEntry=agPortNewCfgTableEntry, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmCurCfgTimeout=pmCurCfgTimeout, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, trunkgroup=trunkgroup, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmCurCfgState=pmCurCfgState, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, stgCurCfgPortTable=stgCurCfgPortTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, agPortNewCfgVlanTag=agPortNewCfgVlanTag, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, stgCurCfgState=stgCurCfgState, vlanNewCfgVlanName=vlanNewCfgVlanName, pmNewCfgTimeout=pmNewCfgTimeout, mirrOperType=mirrOperType, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanCurCfgTable=vlanCurCfgTable, stgCurCfgPortState=stgCurCfgPortState, agPortCurCfgPVID=agPortCurCfgPVID, mirrVlanMirr=mirrVlanMirr, mirrOperTimeout=mirrOperTimeout, vlanMaxEnt=vlanMaxEnt, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, portStatsTable=portStatsTable, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, pmCurCfgMirroredPort=pmCurCfgMirroredPort, agPortNewCfgPortName=agPortNewCfgPortName, vlanNewCfgVlanId=vlanNewCfgVlanId, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, vlanCurCfgStg=vlanCurCfgStg, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, mirrOper=mirrOper, spannTreeGrpCfg=spannTreeGrpCfg, agPortNewCfgPrefLink=agPortNewCfgPrefLink, vlanNewCfgStg=vlanNewCfgStg, trunkGroupNewCfgTable=trunkGroupNewCfgTable, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, stgNewCfgIndex=stgNewCfgIndex, portInfoTableEntry=portInfoTableEntry, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, agPortNewCfgTable=agPortNewCfgTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, portInfoPhyIfType=portInfoPhyIfType, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, agPortCurCfgStp=agPortCurCfgStp, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, agPortCurCfgTable=agPortCurCfgTable, stgNewCfgPortIndex=stgNewCfgPortIndex, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, agPortCurCfgState=agPortCurCfgState, agPortCurCfgBwmContract=agPortCurCfgBwmContract, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portCpuStatsUtilTable=portCpuStatsUtilTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, agPortNewCfgStp=agPortNewCfgStp, portStatsPhyIfInOctets=portStatsPhyIfInOctets, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, pmNewCfgMirroredPort=pmNewCfgMirroredPort, portInfoPhyIfMtu=portInfoPhyIfMtu, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portmirroring=portmirroring, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgNewCfgTableEntry=stgNewCfgTableEntry, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, stgNewCfgTable=stgNewCfgTable, vlanNewCfgTable=vlanNewCfgTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgPortState=stgNewCfgPortState, vlanNewCfgPorts=vlanNewCfgPorts, portInfoLink=portInfoLink, stgNewCfgState=stgNewCfgState, vlanCurCfgVlanId=vlanCurCfgVlanId, agPortTableMaxEnt=agPortTableMaxEnt, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, stgCurCfgPortIndex=stgCurCfgPortIndex, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, stgNewCfgStgIndex=stgNewCfgStgIndex, agPortCurCfgVlanTag=agPortCurCfgVlanTag)
