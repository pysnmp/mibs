...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, vlanCurCfgVlanId=vlanCurCfgVlanId, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, agPortCurCfgTableEntry=agPortCurCfgTableEntry, stgNewCfgTable=stgNewCfgTable, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, agPortCurCfgPrefLink=agPortCurCfgPrefLink, stgNewCfgTableEntry=stgNewCfgTableEntry, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mirrOper=mirrOper, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgTable=stgCurCfgTable, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, mirrOperMonitoringPort=mirrOperMonitoringPort, vlanCurCfgPorts=vlanCurCfgPorts, agPortCurCfgVlanTag=agPortCurCfgVlanTag, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, agPortCurCfgBackLink=agPortCurCfgBackLink, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portInfoMode=portInfoMode, stgNewCfgStgIndex=stgNewCfgStgIndex, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, portStatsPhyIfInOctets=portStatsPhyIfInOctets, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, stgCurCfgPortState=stgCurCfgPortState, portCpuStatsUtilTable=portCpuStatsUtilTable, stgNewCfgIndex=stgNewCfgIndex, stgCurCfgPortTable=stgCurCfgPortTable, portCpuStats=portCpuStats, agPortCurCfgBwmContract=agPortCurCfgBwmContract, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portInfoPhyIfType=portInfoPhyIfType, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, mirrOperType=mirrOperType, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, agPortTableMaxEnt=agPortTableMaxEnt, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, vlanCurCfgStg=vlanCurCfgStg, stgCurCfgIndex=stgCurCfgIndex, agPortCurCfgRmon=agPortCurCfgRmon, agPortNewCfgBackLink=agPortNewCfgBackLink, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanNewCfgState=vlanNewCfgState, stgCurCfgState=stgCurCfgState, agPortNewCfgPrefLink=agPortNewCfgPrefLink, agPortNewCfgVlanTag=agPortNewCfgVlanTag, portCpuStatsUtilIndx=portCpuStatsUtilIndx, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, vlanCurCfgBwmContract=vlanCurCfgBwmContract, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, stgCurCfgStgIndex=stgCurCfgStgIndex, portInfoPhyIfDescr=portInfoPhyIfDescr, mirrOperState=mirrOperState, pmCurCfgTimeout=pmCurCfgTimeout, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portInfoTable=portInfoTable, agPortNewCfgTableEntry=agPortNewCfgTableEntry, portStatsTable=portStatsTable, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, agPortCurCfgPortName=agPortCurCfgPortName, pmNewCfgMirroredPort=pmNewCfgMirroredPort, portInfoSpeed=portInfoSpeed, vlanNewCfgVlanId=vlanNewCfgVlanId, portInfoTableEntry=portInfoTableEntry, agPortCurCfgTable=agPortCurCfgTable, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, agPortNewCfgStp=agPortNewCfgStp, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, trunkGroupNewCfgState=trunkGroupNewCfgState, spannTreeGrpCfg=spannTreeGrpCfg, port_stats=port_stats, agPortCurCfgIndx=agPortCurCfgIndx, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, trunkgroup=trunkgroup, agPortNewCfgPVID=agPortNewCfgPVID, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, port_info=port_info, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgNewCfgState=stgNewCfgState, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mirroring=mirroring, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgPortState=stgNewCfgPortState, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanCurCfgVlanName=vlanCurCfgVlanName, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, stgNewCfgPortTable=stgNewCfgPortTable, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgNewCfgAddVlan=stgNewCfgAddVlan, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, portInfoPhyIfLastChange=portInfoPhyIfLastChange, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, mirrPortMirr=mirrPortMirr, portInfoPhyIfMtu=portInfoPhyIfMtu, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, agPortCurCfgState=agPortCurCfgState, portInfoFlowCtrl=portInfoFlowCtrl, portStatsTableEntry=portStatsTableEntry, agPortNewCfgTable=agPortNewCfgTable, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanNewCfgDelete=vlanNewCfgDelete, pmNewCfgState=pmNewCfgState, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, stgNewCfgPortIndex=stgNewCfgPortIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanNewCfgPorts=vlanNewCfgPorts, agPortConfig=agPortConfig, pmCurCfgState=pmCurCfgState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portInfoLink=portInfoLink, pmNewCfgTimeout=pmNewCfgTimeout, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, agPortCurCfgPVID=agPortCurCfgPVID, agPortNewCfgState=agPortNewCfgState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanCurCfgJumbo=vlanCurCfgJumbo, mirrVlanMirr=mirrVlanMirr, agPortNewCfgPortName=agPortNewCfgPortName, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mirrOperTimeout=mirrOperTimeout, agPortNewCfgBwmContract=agPortNewCfgBwmContract, vlanCurCfgState=vlanCurCfgState, portInfoIndx=portInfoIndx, agPortNewCfgIndx=agPortNewCfgIndx, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, vlanCurCfgTable=vlanCurCfgTable, portStatsPhyIfInErrors=portStatsPhyIfInErrors, vlans=vlans, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, stgCurCfgPortIndex=stgCurCfgPortIndex, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, agPortNewCfgRmon=agPortNewCfgRmon, pmCurCfgMirroredPort=pmCurCfgMirroredPort, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portmirroring=portmirroring, vlanMaxEnt=vlanMaxEnt, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, portStatsIndx=portStatsIndx, mirrOperMirroredPort=mirrOperMirroredPort, vlanNewCfgStg=vlanNewCfgStg, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, agPortCurCfgStp=agPortCurCfgStp, pmNewCfgPortMirrState=pmNewCfgPortMirrState)
