...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, agPortCurCfgBackLink=agPortCurCfgBackLink, vlanCurCfgVlanId=vlanCurCfgVlanId, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, mirrOperType=mirrOperType, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portInfoLink=portInfoLink, stgCurCfgPortState=stgCurCfgPortState, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgStgIndex=stgNewCfgStgIndex, agPortCurCfgPrefLink=agPortCurCfgPrefLink, pmCurCfgState=pmCurCfgState, vlanCurCfgTable=vlanCurCfgTable, stgCurCfgPortIndex=stgCurCfgPortIndex, portInfoTable=portInfoTable, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, agPortCurCfgPVID=agPortCurCfgPVID, agPortNewCfgIndx=agPortNewCfgIndx, agPortNewCfgTableEntry=agPortNewCfgTableEntry, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portStatsTable=portStatsTable, vlanCurCfgState=vlanCurCfgState, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, stgNewCfgAddVlan=stgNewCfgAddVlan, mirrOperState=mirrOperState, agPortTableMaxEnt=agPortTableMaxEnt, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgTableEntry=stgNewCfgTableEntry, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, stgNewCfgIndex=stgNewCfgIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mirrVlanMirr=mirrVlanMirr, portInfoPhyIfType=portInfoPhyIfType, agPortCurCfgTableEntry=agPortCurCfgTableEntry, stgCurCfgPortTable=stgCurCfgPortTable, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, mirrOper=mirrOper, agPortNewCfgState=agPortNewCfgState, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, portStatsPhyIfInErrors=portStatsPhyIfInErrors, spannTreeGrpCfg=spannTreeGrpCfg, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, mirroring=mirroring, stgCurCfgState=stgCurCfgState, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, vlanCurCfgStg=vlanCurCfgStg, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, vlanNewCfgTable=vlanNewCfgTable, pmCurCfgMirroredPort=pmCurCfgMirroredPort, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, agPortCurCfgIndx=agPortCurCfgIndx, agPortNewCfgRmon=agPortNewCfgRmon, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, agPortCurCfgRmon=agPortCurCfgRmon, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, vlanNewCfgAddPort=vlanNewCfgAddPort, agPortNewCfgPortName=agPortNewCfgPortName, vlanNewCfgState=vlanNewCfgState, agPortCurCfgPortName=agPortCurCfgPortName, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, agPortNewCfgPrefLink=agPortNewCfgPrefLink, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupCurCfgState=trunkGroupCurCfgState, portInfoPhyIfLastChange=portInfoPhyIfLastChange, agPortCurCfgVlanTag=agPortCurCfgVlanTag, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, agPortCurCfgState=agPortCurCfgState, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portInfoSpeed=portInfoSpeed, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portInfoPhyIfMtu=portInfoPhyIfMtu, vlanCurCfgPorts=vlanCurCfgPorts, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, portCpuStatsUtilTable=portCpuStatsUtilTable, portStatsTableEntry=portStatsTableEntry, vlanMaxEnt=vlanMaxEnt, agPortCurCfgStp=agPortCurCfgStp, portStatsIndx=portStatsIndx, vlanNewCfgPorts=vlanNewCfgPorts, agPortNewCfgPVID=agPortNewCfgPVID, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, pmNewCfgTimeout=pmNewCfgTimeout, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmNewCfgState=pmNewCfgState, stgCurCfgTable=stgCurCfgTable, mirrOperTimeout=mirrOperTimeout, agPortNewCfgTable=agPortNewCfgTable, vlanNewCfgJumbo=vlanNewCfgJumbo, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, mirrOperMirroredPort=mirrOperMirroredPort, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, portCpuStatsUtilIndx=portCpuStatsUtilIndx, portStatsPhyIfInOctets=portStatsPhyIfInOctets, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, port_stats=port_stats, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, agPortCurCfgBwmContract=agPortCurCfgBwmContract, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, agPortCurCfgTable=agPortCurCfgTable, agPortNewCfgBwmContract=agPortNewCfgBwmContract, pmNewCfgMirroredPort=pmNewCfgMirroredPort, stgNewCfgPortIndex=stgNewCfgPortIndex, pmCurCfgTimeout=pmCurCfgTimeout, vlanCurCfgJumbo=vlanCurCfgJumbo, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, trunkGroupNewCfgState=trunkGroupNewCfgState, agPortConfig=agPortConfig, vlans=vlans, agPortNewCfgBackLink=agPortNewCfgBackLink, portmirroring=portmirroring, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgNewCfgState=stgNewCfgState, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portInfoTableEntry=portInfoTableEntry, mirrOperMonitoringPort=mirrOperMonitoringPort, portInfoIndx=portInfoIndx, mirrPortMirr=mirrPortMirr, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, vlanNewCfgStg=vlanNewCfgStg, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portInfoMode=portInfoMode, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, portInfoFlowCtrl=portInfoFlowCtrl, stgNewCfgPortState=stgNewCfgPortState, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, stgNewCfgPortTable=stgNewCfgPortTable, agPortNewCfgVlanTag=agPortNewCfgVlanTag, portCpuStats=portCpuStats, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, stgNewCfgTable=stgNewCfgTable, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, port_info=port_info, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgIndex=stgCurCfgIndex, trunkgroup=trunkgroup, agPortNewCfgStp=agPortNewCfgStp)
