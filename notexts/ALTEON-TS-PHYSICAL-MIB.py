...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, port_info=port_info, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, vlanNewCfgTable=vlanNewCfgTable, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, agPortCurCfgTable=agPortCurCfgTable, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, portStatsPhyIfInOctets=portStatsPhyIfInOctets, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, spannTreeGrpCfg=spannTreeGrpCfg, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, agPortCurCfgRmon=agPortCurCfgRmon, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, portStatsPhyIfInErrors=portStatsPhyIfInErrors, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, portInfoIndx=portInfoIndx, vlanNewCfgJumbo=vlanNewCfgJumbo, agPortCurCfgIndx=agPortCurCfgIndx, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, stgNewCfgTable=stgNewCfgTable, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, stgCurCfgTable=stgCurCfgTable, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, portInfoSpeed=portInfoSpeed, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portStatsIndx=portStatsIndx, vlans=vlans, agPortNewCfgState=agPortNewCfgState, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, portInfoPhyIfMtu=portInfoPhyIfMtu, agPortNewCfgPVID=agPortNewCfgPVID, stgCurCfgState=stgCurCfgState, vlanCurCfgVlanName=vlanCurCfgVlanName, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mirrPortMirr=mirrPortMirr, agPortCurCfgVlanTag=agPortCurCfgVlanTag, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, vlanNewCfgStg=vlanNewCfgStg, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, agPortNewCfgBwmContract=agPortNewCfgBwmContract, stgCurCfgStgIndex=stgCurCfgStgIndex, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, portCpuStatsUtilTable=portCpuStatsUtilTable, mirrVlanMirr=mirrVlanMirr, vlanNewCfgDelete=vlanNewCfgDelete, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgIndex=stgCurCfgIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgNewCfgPortIndex=stgNewCfgPortIndex, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, mirroring=mirroring, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portInfoPhyIfLastChange=portInfoPhyIfLastChange, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, trunkGroupCurCfgState=trunkGroupCurCfgState, portmirroring=portmirroring, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portInfoTableEntry=portInfoTableEntry, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmNewCfgState=pmNewCfgState, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, agPortCurCfgStp=agPortCurCfgStp, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, portInfoTable=portInfoTable, mirrOper=mirrOper, agPortNewCfgIndx=agPortNewCfgIndx, pmCurCfgMirroredPort=pmCurCfgMirroredPort, stgNewCfgPortState=stgNewCfgPortState, agPortNewCfgRmon=agPortNewCfgRmon, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, vlanCurCfgState=vlanCurCfgState, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, portCpuStats=portCpuStats, stgCurCfgPortTable=stgCurCfgPortTable, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, pmNewCfgTimeout=pmNewCfgTimeout, portStatsTable=portStatsTable, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgStgIndex=stgNewCfgStgIndex, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, agPortCurCfgPortName=agPortCurCfgPortName, agPortTableMaxEnt=agPortTableMaxEnt, stgCurCfgTableEntry=stgCurCfgTableEntry, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, agPortNewCfgTableEntry=agPortNewCfgTableEntry, mirrOperType=mirrOperType, portStatsTableEntry=portStatsTableEntry, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portInfoPhyIfDescr=portInfoPhyIfDescr, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, stgCurCfgPortState=stgCurCfgPortState, stgNewCfgState=stgNewCfgState, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portInfoLink=portInfoLink, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, agPortNewCfgVlanTag=agPortNewCfgVlanTag, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, mirrOperTimeout=mirrOperTimeout, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, agPortCurCfgPVID=agPortCurCfgPVID, vlanMaxEnt=vlanMaxEnt, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmCurCfgTimeout=pmCurCfgTimeout, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanCurCfgTable=vlanCurCfgTable, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, agPortCurCfgPrefLink=agPortCurCfgPrefLink, agPortNewCfgPrefLink=agPortNewCfgPrefLink, agPortCurCfgTableEntry=agPortCurCfgTableEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, trunkgroup=trunkgroup, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, agPortCurCfgBwmContract=agPortCurCfgBwmContract, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portInfoFlowCtrl=portInfoFlowCtrl, pmCurCfgState=pmCurCfgState, agPortNewCfgTable=agPortNewCfgTable, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanNewCfgState=vlanNewCfgState, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, agPortNewCfgStp=agPortNewCfgStp, vlanCurCfgPorts=vlanCurCfgPorts, portCpuStatsUtilIndx=portCpuStatsUtilIndx, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanCurCfgStg=vlanCurCfgStg, mirrOperMirroredPort=mirrOperMirroredPort, agPortNewCfgBackLink=agPortNewCfgBackLink, pmNewCfgMirroredPort=pmNewCfgMirroredPort, mirrOperState=mirrOperState, vlanCurCfgJumbo=vlanCurCfgJumbo, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, agPortCurCfgState=agPortCurCfgState, agPortConfig=agPortConfig, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, trunkGroupNewCfgState=trunkGroupNewCfgState, portInfoPhyIfType=portInfoPhyIfType, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgTableEntry=stgNewCfgTableEntry, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, stgNewCfgPortTable=stgNewCfgPortTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, port_stats=port_stats, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, agPortNewCfgPortName=agPortNewCfgPortName, portInfoMode=portInfoMode, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, agPortCurCfgBackLink=agPortCurCfgBackLink, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second)
