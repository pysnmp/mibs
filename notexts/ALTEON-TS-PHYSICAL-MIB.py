...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", agPortNewCfgPrefLink=agPortNewCfgPrefLink, portInfoPhyIfType=portInfoPhyIfType, portCpuStats=portCpuStats, stgNewCfgStgIndex=stgNewCfgStgIndex, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, stgNewCfgPortState=stgNewCfgPortState, portStatsTableEntry=portStatsTableEntry, agPortCurCfgPVID=agPortCurCfgPVID, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, agPortCurCfgStp=agPortCurCfgStp, stgNewCfgAddVlan=stgNewCfgAddVlan, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, stgNewCfgState=stgNewCfgState, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, portStatsIndx=portStatsIndx, vlanNewCfgBwmContract=vlanNewCfgBwmContract, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, agPortConfig=agPortConfig, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, agPortCurCfgBackLink=agPortCurCfgBackLink, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, vlanNewCfgStg=vlanNewCfgStg, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, pmCurCfgState=pmCurCfgState, mirrOper=mirrOper, mirroring=mirroring, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, portStatsPhyIfInOctets=portStatsPhyIfInOctets, agPortCurCfgVlanTag=agPortCurCfgVlanTag, mirrOperState=mirrOperState, portInfoIndx=portInfoIndx, agPortNewCfgPVID=agPortNewCfgPVID, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, agPortCurCfgRmon=agPortCurCfgRmon, stgCurCfgTableEntry=stgCurCfgTableEntry, agPortCurCfgTable=agPortCurCfgTable, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, mirrOperMirroredPort=mirrOperMirroredPort, mirrOperMonitoringPort=mirrOperMonitoringPort, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanNewCfgState=vlanNewCfgState, agPortNewCfgTableEntry=agPortNewCfgTableEntry, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, portInfoPhyIfLastChange=portInfoPhyIfLastChange, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, agPortNewCfgTable=agPortNewCfgTable, vlanCurCfgState=vlanCurCfgState, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, mirrOperType=mirrOperType, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, spannTreeGrpCfg=spannTreeGrpCfg, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, agPortNewCfgIndx=agPortNewCfgIndx, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, stgCurCfgState=stgCurCfgState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, stgCurCfgTable=stgCurCfgTable, vlanCurCfgStg=vlanCurCfgStg, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, portInfoLink=portInfoLink, agPortNewCfgState=agPortNewCfgState, agPortCurCfgIndx=agPortCurCfgIndx, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, mirrOperTimeout=mirrOperTimeout, portCpuStatsUtilTable=portCpuStatsUtilTable, stgCurCfgPortState=stgCurCfgPortState, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmCurCfgMirroredPort=pmCurCfgMirroredPort, agPortCurCfgPrefLink=agPortCurCfgPrefLink, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, trunkGroupNewCfgState=trunkGroupNewCfgState, portInfoPhyIfMtu=portInfoPhyIfMtu, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, trunkGroupCurCfgState=trunkGroupCurCfgState, portCpuStatsUtilIndx=portCpuStatsUtilIndx, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgPortTable=stgCurCfgPortTable, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, portStatsTable=portStatsTable, vlanCurCfgVlanId=vlanCurCfgVlanId, agPortCurCfgBwmContract=agPortCurCfgBwmContract, portInfoPhyIfDescr=portInfoPhyIfDescr, vlans=vlans, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portmirroring=portmirroring, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgPortTable=stgNewCfgPortTable, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, agPortNewCfgVlanTag=agPortNewCfgVlanTag, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mirrVlanMirr=mirrVlanMirr, pmNewCfgMirroredPort=pmNewCfgMirroredPort, portInfoMode=portInfoMode, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portStatsPhyIfInErrors=portStatsPhyIfInErrors, pmCurCfgTimeout=pmCurCfgTimeout, agPortCurCfgState=agPortCurCfgState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, trunkgroup=trunkgroup, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, agPortNewCfgBwmContract=agPortNewCfgBwmContract, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, vlanNewCfgVlanId=vlanNewCfgVlanId, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, agPortCurCfgTableEntry=agPortCurCfgTableEntry, portInfoSpeed=portInfoSpeed, vlanMaxEnt=vlanMaxEnt, vlanNewCfgDelete=vlanNewCfgDelete, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, agPortNewCfgPortName=agPortNewCfgPortName, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, trunkGroupCurCfgTable=trunkGroupCurCfgTable, agPortNewCfgBackLink=agPortNewCfgBackLink, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, agPortNewCfgStp=agPortNewCfgStp, portInfoTableEntry=portInfoTableEntry, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, vlanCurCfgTable=vlanCurCfgTable, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, stgNewCfgIndex=stgNewCfgIndex, agPortTableMaxEnt=agPortTableMaxEnt, agPortNewCfgRmon=agPortNewCfgRmon, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, vlanNewCfgTable=vlanNewCfgTable, port_stats=port_stats, mirrPortMirr=mirrPortMirr, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgCurCfgIndex=stgCurCfgIndex, port_info=port_info, pmNewCfgTimeout=pmNewCfgTimeout, stgNewCfgPortIndex=stgNewCfgPortIndex, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, stgNewCfgTableEntry=stgNewCfgTableEntry, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, vlanNewCfgJumbo=vlanNewCfgJumbo, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, pmNewCfgState=pmNewCfgState, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgNewCfgTable=stgNewCfgTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portInfoFlowCtrl=portInfoFlowCtrl, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, stgCurCfgPortIndex=stgCurCfgPortIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, agPortCurCfgPortName=agPortCurCfgPortName, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgAddPort=vlanNewCfgAddPort, portInfoTable=portInfoTable, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete)
