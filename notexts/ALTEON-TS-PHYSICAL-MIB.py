...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", stgCurCfgTable=stgCurCfgTable, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanNewCfgTable=vlanNewCfgTable, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, agPortTableMaxEnt=agPortTableMaxEnt, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, vlanNewCfgState=vlanNewCfgState, portInfoMode=portInfoMode, mirrOper=mirrOper, stgNewCfgIndex=stgNewCfgIndex, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, pmCurCfgMirroredPort=pmCurCfgMirroredPort, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, agPortCurCfgRmon=agPortCurCfgRmon, stgCurCfgIndex=stgCurCfgIndex, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupNewCfgState=trunkGroupNewCfgState, portmirroring=portmirroring, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, agPortConfig=agPortConfig, stgNewCfgAddVlan=stgNewCfgAddVlan, agPortCurCfgVlanTag=agPortCurCfgVlanTag, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, agPortNewCfgBackLink=agPortNewCfgBackLink, port_stats=port_stats, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgPortIndex=stgCurCfgPortIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgPortTable=stgNewCfgPortTable, portInfoSpeed=portInfoSpeed, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, stgNewCfgTable=stgNewCfgTable, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, agPortNewCfgPVID=agPortNewCfgPVID, vlanCurCfgState=vlanCurCfgState, pmCurCfgState=pmCurCfgState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, agPortCurCfgStp=agPortCurCfgStp, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, vlanMaxEnt=vlanMaxEnt, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portInfoTable=portInfoTable, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, mirrOperState=mirrOperState, portStatsIndx=portStatsIndx, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, portCpuStatsUtilTable=portCpuStatsUtilTable, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, agPortCurCfgBackLink=agPortCurCfgBackLink, stgCurCfgStgIndex=stgCurCfgStgIndex, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, vlanNewCfgVlanId=vlanNewCfgVlanId, agPortNewCfgStp=agPortNewCfgStp, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, agPortNewCfgIndx=agPortNewCfgIndx, trunkGroupTableMaxSize=trunkGroupTableMaxSize, spannTreeGrpCfg=spannTreeGrpCfg, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, port_info=port_info, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, agPortCurCfgIndx=agPortCurCfgIndx, portStatsPhyIfInErrors=portStatsPhyIfInErrors, agPortNewCfgTableEntry=agPortNewCfgTableEntry, pmNewCfgMirroredPort=pmNewCfgMirroredPort, agPortCurCfgBwmContract=agPortCurCfgBwmContract, vlans=vlans, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, stgNewCfgPortState=stgNewCfgPortState, mirrOperMonitoringPort=mirrOperMonitoringPort, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, stgCurCfgPortState=stgCurCfgPortState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortCurCfgPVID=agPortCurCfgPVID, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, vlanCurCfgTable=vlanCurCfgTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, agPortNewCfgBwmContract=agPortNewCfgBwmContract, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanCurCfgStg=vlanCurCfgStg, portInfoTableEntry=portInfoTableEntry, vlanCurCfgJumbo=vlanCurCfgJumbo, portCpuStats=portCpuStats, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portInfoLink=portInfoLink, portStatsPhyIfInOctets=portStatsPhyIfInOctets, mirrOperTimeout=mirrOperTimeout, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, trunkGroupCurCfgState=trunkGroupCurCfgState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mirrOperType=mirrOperType, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, stgCurCfgPortTable=stgCurCfgPortTable, portInfoIndx=portInfoIndx, agPortCurCfgTable=agPortCurCfgTable, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, stgCurCfgTableEntry=stgCurCfgTableEntry, mirrPortMirr=mirrPortMirr, pmNewCfgTimeout=pmNewCfgTimeout, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, portInfoPhyIfMtu=portInfoPhyIfMtu, portCpuStatsUtilIndx=portCpuStatsUtilIndx, stgNewCfgStgIndex=stgNewCfgStgIndex, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, trunkgroup=trunkgroup, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, stgNewCfgTableEntry=stgNewCfgTableEntry, mirrOperMirroredPort=mirrOperMirroredPort, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, stgNewCfgPortIndex=stgNewCfgPortIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portInfoFlowCtrl=portInfoFlowCtrl, portInfoPhyIfLastChange=portInfoPhyIfLastChange, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, agPortCurCfgState=agPortCurCfgState, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, agPortCurCfgPortName=agPortCurCfgPortName, vlanNewCfgJumbo=vlanNewCfgJumbo, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, stgNewCfgState=stgNewCfgState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgState=stgCurCfgState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmCurCfgTimeout=pmCurCfgTimeout, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, agPortNewCfgVlanTag=agPortNewCfgVlanTag, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanCurCfgVlanName=vlanCurCfgVlanName, mirroring=mirroring, agPortNewCfgState=agPortNewCfgState, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, agPortCurCfgTableEntry=agPortCurCfgTableEntry, mirrVlanMirr=mirrVlanMirr, portStatsTable=portStatsTable, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, agPortCurCfgPrefLink=agPortCurCfgPrefLink, agPortNewCfgRmon=agPortNewCfgRmon, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portInfoPhyIfType=portInfoPhyIfType, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, agPortNewCfgTable=agPortNewCfgTable, vlanNewCfgPorts=vlanNewCfgPorts, pmNewCfgState=pmNewCfgState, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, agPortNewCfgPortName=agPortNewCfgPortName, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanNewCfgDelete=vlanNewCfgDelete, agPortNewCfgPrefLink=agPortNewCfgPrefLink, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, portStatsTableEntry=portStatsTableEntry)
