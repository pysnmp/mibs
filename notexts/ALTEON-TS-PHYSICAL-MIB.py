...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portCpuStatsUtilTable=portCpuStatsUtilTable, agPortNewCfgTableEntry=agPortNewCfgTableEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, portStatsPhyIfInErrors=portStatsPhyIfInErrors, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgTableEntry=stgCurCfgTableEntry, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanNewCfgVlanName=vlanNewCfgVlanName, portmirroring=portmirroring, agPortCurCfgVlanTag=agPortCurCfgVlanTag, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, stgNewCfgPortIndex=stgNewCfgPortIndex, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, pmNewCfgState=pmNewCfgState, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupCurCfgTable=trunkGroupCurCfgTable, agPortNewCfgStp=agPortNewCfgStp, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgCurCfgStgIndex=stgCurCfgStgIndex, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgNewCfgIndex=stgNewCfgIndex, vlanNewCfgTable=vlanNewCfgTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portInfoMode=portInfoMode, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortCurCfgPVID=agPortCurCfgPVID, portStatsIndx=portStatsIndx, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, pmNewCfgTimeout=pmNewCfgTimeout, stgNewCfgPortTable=stgNewCfgPortTable, agPortTableMaxEnt=agPortTableMaxEnt, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mirrOperState=mirrOperState, pmNewCfgMirroredPort=pmNewCfgMirroredPort, agPortCurCfgTableEntry=agPortCurCfgTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portStatsTableEntry=portStatsTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanNewCfgDelete=vlanNewCfgDelete, agPortCurCfgState=agPortCurCfgState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, vlanMaxEnt=vlanMaxEnt, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, stgNewCfgPortState=stgNewCfgPortState, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, agPortCurCfgBackLink=agPortCurCfgBackLink, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, portInfoFlowCtrl=portInfoFlowCtrl, agPortConfig=agPortConfig, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, trunkGroupCurCfgState=trunkGroupCurCfgState, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgPortState=stgCurCfgPortState, port_stats=port_stats, mirrOperTimeout=mirrOperTimeout, agPortCurCfgStp=agPortCurCfgStp, agPortNewCfgPVID=agPortNewCfgPVID, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, mirrOperType=mirrOperType, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, vlanNewCfgStg=vlanNewCfgStg, spannTreeGrpCfg=spannTreeGrpCfg, portInfoIndx=portInfoIndx, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, portInfoPhyIfMtu=portInfoPhyIfMtu, vlans=vlans, vlanNewCfgJumbo=vlanNewCfgJumbo, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, agPortCurCfgPortName=agPortCurCfgPortName, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, stgCurCfgTable=stgCurCfgTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, agPortNewCfgBwmContract=agPortNewCfgBwmContract, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, mirrOperMirroredPort=mirrOperMirroredPort, vlanCurCfgPorts=vlanCurCfgPorts, agPortNewCfgVlanTag=agPortNewCfgVlanTag, stgCurCfgPortTable=stgCurCfgPortTable, portCpuStats=portCpuStats, stgCurCfgIndex=stgCurCfgIndex, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, port_info=port_info, agPortNewCfgBackLink=agPortNewCfgBackLink, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, agPortNewCfgPrefLink=agPortNewCfgPrefLink, portInfoPhyIfType=portInfoPhyIfType, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, agPortCurCfgTable=agPortCurCfgTable, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, stgNewCfgStgIndex=stgNewCfgStgIndex, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, portInfoTable=portInfoTable, agPortCurCfgBwmContract=agPortCurCfgBwmContract, vlanCurCfgVlanId=vlanCurCfgVlanId, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, mirrVlanMirr=mirrVlanMirr, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, mirrPortMirr=mirrPortMirr, trunkgroup=trunkgroup, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, agPortNewCfgIndx=agPortNewCfgIndx, agPortNewCfgRmon=agPortNewCfgRmon, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanNewCfgState=vlanNewCfgState, agPortNewCfgState=agPortNewCfgState, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, agPortNewCfgPortName=agPortNewCfgPortName, portInfoTableEntry=portInfoTableEntry, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, vlanCurCfgStg=vlanCurCfgStg, stgCurCfgState=stgCurCfgState, agPortCurCfgPrefLink=agPortCurCfgPrefLink, portCpuStatsUtilIndx=portCpuStatsUtilIndx, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, portInfoSpeed=portInfoSpeed, portInfoPhyIfDescr=portInfoPhyIfDescr, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, pmCurCfgMirroredPort=pmCurCfgMirroredPort, mirroring=mirroring, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portInfoLink=portInfoLink, agPortCurCfgRmon=agPortCurCfgRmon, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, portInfoPhyIfLastChange=portInfoPhyIfLastChange, portStatsTable=portStatsTable, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, vlanNewCfgAddPort=vlanNewCfgAddPort, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, stgNewCfgTable=stgNewCfgTable, portStatsPhyIfInOctets=portStatsPhyIfInOctets, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mirrOper=mirrOper, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanCurCfgTable=vlanCurCfgTable, pmCurCfgState=pmCurCfgState, vlanCurCfgState=vlanCurCfgState, stgNewCfgTableEntry=stgNewCfgTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, trunkGroupNewCfgState=trunkGroupNewCfgState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgNewCfgState=stgNewCfgState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, agPortCurCfgIndx=agPortCurCfgIndx, agPortNewCfgTable=agPortNewCfgTable, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, pmCurCfgTimeout=pmCurCfgTimeout, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress)
