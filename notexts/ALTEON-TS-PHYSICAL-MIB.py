...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", agPortCurCfgRmon=agPortCurCfgRmon, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, vlanNewCfgPorts=vlanNewCfgPorts, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgStgIndex=stgNewCfgStgIndex, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, stgNewCfgPortState=stgNewCfgPortState, portInfoMode=portInfoMode, agPortNewCfgTableEntry=agPortNewCfgTableEntry, portInfoTable=portInfoTable, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portStatsTableEntry=portStatsTableEntry, pmCurCfgMirroredPort=pmCurCfgMirroredPort, portInfoFlowCtrl=portInfoFlowCtrl, agPortCurCfgState=agPortCurCfgState, agPortCurCfgIndx=agPortCurCfgIndx, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, mirrOperMirroredPort=mirrOperMirroredPort, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, spannTreeGrpCfg=spannTreeGrpCfg, agPortCurCfgTableEntry=agPortCurCfgTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, vlanMaxEnt=vlanMaxEnt, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, stgCurCfgPortState=stgCurCfgPortState, vlanNewCfgDelete=vlanNewCfgDelete, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, vlanCurCfgState=vlanCurCfgState, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, agPortCurCfgPortName=agPortCurCfgPortName, pmCurCfgTimeout=pmCurCfgTimeout, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, port_stats=port_stats, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, mirrOperState=mirrOperState, agPortNewCfgState=agPortNewCfgState, agPortNewCfgPortName=agPortNewCfgPortName, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, portInfoPhyIfLastChange=portInfoPhyIfLastChange, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanCurCfgJumbo=vlanCurCfgJumbo, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, stgNewCfgState=stgNewCfgState, port_info=port_info, agPortNewCfgStp=agPortNewCfgStp, mirrOperTimeout=mirrOperTimeout, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mirrOperType=mirrOperType, agPortCurCfgStp=agPortCurCfgStp, agPortNewCfgTable=agPortNewCfgTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, agPortCurCfgBackLink=agPortCurCfgBackLink, portCpuStats=portCpuStats, vlanNewCfgVlanName=vlanNewCfgVlanName, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, agPortNewCfgPrefLink=agPortNewCfgPrefLink, vlanNewCfgVlanId=vlanNewCfgVlanId, agPortNewCfgBackLink=agPortNewCfgBackLink, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, agPortConfig=agPortConfig, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, mirrPortMirr=mirrPortMirr, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, agPortNewCfgPVID=agPortNewCfgPVID, stgCurCfgIndex=stgCurCfgIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, portStatsPhyIfInErrors=portStatsPhyIfInErrors, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, trunkGroupTableMaxSize=trunkGroupTableMaxSize, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanNewCfgTable=vlanNewCfgTable, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, stgNewCfgTableEntry=stgNewCfgTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, pmCurCfgState=pmCurCfgState, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, agPortNewCfgVlanTag=agPortNewCfgVlanTag, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, portStatsIndx=portStatsIndx, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, trunkgroup=trunkgroup, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, stgCurCfgStgIndex=stgCurCfgStgIndex, portInfoLink=portInfoLink, portmirroring=portmirroring, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, pmNewCfgState=pmNewCfgState, pmNewCfgMirroredPort=pmNewCfgMirroredPort, mirrOper=mirrOper, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, vlanNewCfgStg=vlanNewCfgStg, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, portInfoIndx=portInfoIndx, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, portInfoSpeed=portInfoSpeed, mirroring=mirroring, agPortNewCfgBwmContract=agPortNewCfgBwmContract, vlanCurCfgTable=vlanCurCfgTable, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCurCfgTable=stgCurCfgTable, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, stgNewCfgPortIndex=stgNewCfgPortIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portInfoPhyIfType=portInfoPhyIfType, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, portStatsPhyIfInOctets=portStatsPhyIfInOctets, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portInfoPhyIfMtu=portInfoPhyIfMtu, stgCurCfgPortTable=stgCurCfgPortTable, agPortCurCfgPrefLink=agPortCurCfgPrefLink, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanCurCfgStg=vlanCurCfgStg, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgTable=stgNewCfgTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlans=vlans, agPortTableMaxEnt=agPortTableMaxEnt, stgNewCfgIndex=stgNewCfgIndex, portCpuStatsUtilTable=portCpuStatsUtilTable, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, vlanNewCfgJumbo=vlanNewCfgJumbo, agPortNewCfgRmon=agPortNewCfgRmon, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portStatsTable=portStatsTable, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanNewCfgState=vlanNewCfgState, pmNewCfgTimeout=pmNewCfgTimeout, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, agPortCurCfgTable=agPortCurCfgTable, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, portCpuStatsUtilIndx=portCpuStatsUtilIndx, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgPortTable=stgNewCfgPortTable, agPortNewCfgIndx=agPortNewCfgIndx, agPortCurCfgPVID=agPortCurCfgPVID, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, portInfoTableEntry=portInfoTableEntry, agPortCurCfgVlanTag=agPortCurCfgVlanTag, agPortCurCfgBwmContract=agPortCurCfgBwmContract, mirrOperMonitoringPort=mirrOperMonitoringPort, vlanNewCfgBwmContract=vlanNewCfgBwmContract, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, mirrVlanMirr=mirrVlanMirr, stgCurCfgPortIndex=stgCurCfgPortIndex, stgCurCfgState=stgCurCfgState)
