...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanNewCfgVlanId=vlanNewCfgVlanId, pmCurCfgMirroredPort=pmCurCfgMirroredPort, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, pmNewCfgState=pmNewCfgState, pmCurCfgState=pmCurCfgState, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, stgNewCfgAddVlan=stgNewCfgAddVlan, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, stgNewCfgTable=stgNewCfgTable, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, trunkGroupCurCfgState=trunkGroupCurCfgState, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, mirrOperState=mirrOperState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlans=vlans, agPortCurCfgPortName=agPortCurCfgPortName, agPortCurCfgRmon=agPortCurCfgRmon, agPortCurCfgBwmContract=agPortCurCfgBwmContract, mirrOperType=mirrOperType, agPortCurCfgIndx=agPortCurCfgIndx, mirrOperTimeout=mirrOperTimeout, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, agPortTableMaxEnt=agPortTableMaxEnt, mirrOper=mirrOper, stgCurCfgPortIndex=stgCurCfgPortIndex, agPortNewCfgBwmContract=agPortNewCfgBwmContract, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, vlanNewCfgAddPort=vlanNewCfgAddPort, spannTreeGrpCfg=spannTreeGrpCfg, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, port_stats=port_stats, agPortCurCfgPVID=agPortCurCfgPVID, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, portInfoSpeed=portInfoSpeed, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, portInfoPhyIfType=portInfoPhyIfType, portStatsTableEntry=portStatsTableEntry, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portInfoTableEntry=portInfoTableEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgNewCfgPortState=stgNewCfgPortState, trunkgroup=trunkgroup, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortNewCfgRmon=agPortNewCfgRmon, agPortCurCfgTableEntry=agPortCurCfgTableEntry, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portInfoPhyIfLastChange=portInfoPhyIfLastChange, mirroring=mirroring, agPortNewCfgBackLink=agPortNewCfgBackLink, stgCurCfgState=stgCurCfgState, agPortNewCfgIndx=agPortNewCfgIndx, portInfoPhyIfMtu=portInfoPhyIfMtu, pmNewCfgMirroredPort=pmNewCfgMirroredPort, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portCpuStatsUtilIndx=portCpuStatsUtilIndx, pmNewCfgTimeout=pmNewCfgTimeout, portInfoTable=portInfoTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmCurCfgTimeout=pmCurCfgTimeout, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, agPortCurCfgPrefLink=agPortCurCfgPrefLink, mirrPortMirr=mirrPortMirr, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portInfoMode=portInfoMode, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortCurCfgState=agPortCurCfgState, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, vlanMaxEnt=vlanMaxEnt, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupNewCfgState=trunkGroupNewCfgState, portStatsPhyIfInOctets=portStatsPhyIfInOctets, vlanNewCfgPorts=vlanNewCfgPorts, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mirrVlanMirr=mirrVlanMirr, portInfoFlowCtrl=portInfoFlowCtrl, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, agPortNewCfgPrefLink=agPortNewCfgPrefLink, vlanNewCfgStg=vlanNewCfgStg, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, agPortConfig=agPortConfig, stgCurCfgTable=stgCurCfgTable, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portStatsIndx=portStatsIndx, agPortCurCfgStp=agPortCurCfgStp, agPortNewCfgPortName=agPortNewCfgPortName, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, agPortNewCfgStp=agPortNewCfgStp, stgCurCfgPortTable=stgCurCfgPortTable, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgNewCfgPortTable=stgNewCfgPortTable, vlanNewCfgVlanName=vlanNewCfgVlanName, port_info=port_info, trunkGroupTableMaxSize=trunkGroupTableMaxSize, agPortNewCfgTable=agPortNewCfgTable, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgState=stgNewCfgState, vlanCurCfgPorts=vlanCurCfgPorts, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, vlanNewCfgTable=vlanNewCfgTable, portStatsPhyIfInErrors=portStatsPhyIfInErrors, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, vlanCurCfgVlanId=vlanCurCfgVlanId, stgCurCfgPortState=stgCurCfgPortState, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, agPortNewCfgState=agPortNewCfgState, agPortNewCfgTableEntry=agPortNewCfgTableEntry, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgStgIndex=stgNewCfgStgIndex, agPortCurCfgTable=agPortCurCfgTable, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, portInfoLink=portInfoLink, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgPortIndex=stgNewCfgPortIndex, agPortNewCfgVlanTag=agPortNewCfgVlanTag, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portInfoIndx=portInfoIndx, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, vlanNewCfgJumbo=vlanNewCfgJumbo, stgNewCfgTableEntry=stgNewCfgTableEntry, mirrOperMirroredPort=mirrOperMirroredPort, vlanNewCfgDelete=vlanNewCfgDelete, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, portStatsTable=portStatsTable, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, vlanCurCfgTable=vlanCurCfgTable, vlanNewCfgState=vlanNewCfgState, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, agPortNewCfgPVID=agPortNewCfgPVID, agPortCurCfgBackLink=agPortCurCfgBackLink, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgStgIndex=stgCurCfgStgIndex, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, stgCurCfgIndex=stgCurCfgIndex, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanCurCfgState=vlanCurCfgState, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanCurCfgStg=vlanCurCfgStg, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, portmirroring=portmirroring, agPortCurCfgVlanTag=agPortCurCfgVlanTag, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, portCpuStatsUtilTable=portCpuStatsUtilTable, portCpuStats=portCpuStats, stgNewCfgIndex=stgNewCfgIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress)
