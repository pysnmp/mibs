...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, portInfoTable=portInfoTable, vlanCurCfgJumbo=vlanCurCfgJumbo, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, agPortCurCfgBackLink=agPortCurCfgBackLink, portStatsIndx=portStatsIndx, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, pmNewCfgMirroredPort=pmNewCfgMirroredPort, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgCurCfgTable=stgCurCfgTable, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, agPortCurCfgIndx=agPortCurCfgIndx, agPortNewCfgTableEntry=agPortNewCfgTableEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, agPortNewCfgIndx=agPortNewCfgIndx, mirrPortMirr=mirrPortMirr, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, portStatsTable=portStatsTable, vlanNewCfgVlanName=vlanNewCfgVlanName, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, stgNewCfgStgIndex=stgNewCfgStgIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, pmNewCfgState=pmNewCfgState, agPortCurCfgVlanTag=agPortCurCfgVlanTag, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanNewCfgStg=vlanNewCfgStg, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, portInfoPhyIfMtu=portInfoPhyIfMtu, mirrOperMonitoringPort=mirrOperMonitoringPort, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portInfoIndx=portInfoIndx, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, stgCurCfgStgIndex=stgCurCfgStgIndex, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, agPortNewCfgBackLink=agPortNewCfgBackLink, stgCurCfgIndex=stgCurCfgIndex, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, portInfoPhyIfLastChange=portInfoPhyIfLastChange, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portmirroring=portmirroring, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, stgCurCfgState=stgCurCfgState, stgCurCfgPortTable=stgCurCfgPortTable, vlans=vlans, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, spannTreeGrpCfg=spannTreeGrpCfg, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portInfoLink=portInfoLink, agPortCurCfgTable=agPortCurCfgTable, portStatsPhyIfInOctets=portStatsPhyIfInOctets, portInfoFlowCtrl=portInfoFlowCtrl, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, pmCurCfgMirroredPort=pmCurCfgMirroredPort, portCpuStatsUtilIndx=portCpuStatsUtilIndx, stgNewCfgState=stgNewCfgState, stgNewCfgPortIndex=stgNewCfgPortIndex, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mirrVlanMirr=mirrVlanMirr, trunkGroupNewCfgTable=trunkGroupNewCfgTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, agPortNewCfgTable=agPortNewCfgTable, agPortNewCfgBwmContract=agPortNewCfgBwmContract, vlanCurCfgVlanName=vlanCurCfgVlanName, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgNewCfgPortTable=stgNewCfgPortTable, portInfoSpeed=portInfoSpeed, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, pmNewCfgPortMirrState=pmNewCfgPortMirrState, agPortCurCfgStp=agPortCurCfgStp, agPortCurCfgPortName=agPortCurCfgPortName, stgCurCfgTableEntry=stgCurCfgTableEntry, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, portInfoPhyIfType=portInfoPhyIfType, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, portStatsPhyIfInErrors=portStatsPhyIfInErrors, agPortTableMaxEnt=agPortTableMaxEnt, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, agPortConfig=agPortConfig, stgNewCfgAddVlan=stgNewCfgAddVlan, agPortNewCfgStp=agPortNewCfgStp, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, mirrOper=mirrOper, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portInfoMode=portInfoMode, mirrOperMirroredPort=mirrOperMirroredPort, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, vlanNewCfgDelete=vlanNewCfgDelete, agPortCurCfgBwmContract=agPortCurCfgBwmContract, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, trunkGroupTableMaxSize=trunkGroupTableMaxSize, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, stgNewCfgIndex=stgNewCfgIndex, vlanNewCfgState=vlanNewCfgState, agPortCurCfgTableEntry=agPortCurCfgTableEntry, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanCurCfgPorts=vlanCurCfgPorts, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, stgNewCfgPortState=stgNewCfgPortState, vlanCurCfgTable=vlanCurCfgTable, vlanCurCfgStg=vlanCurCfgStg, mirrOperState=mirrOperState, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, trunkgroup=trunkgroup, portStatsTableEntry=portStatsTableEntry, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, agPortNewCfgPVID=agPortNewCfgPVID, stgNewCfgTable=stgNewCfgTable, vlanNewCfgTable=vlanNewCfgTable, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, pmCurCfgState=pmCurCfgState, stgCurCfgPortState=stgCurCfgPortState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mirrOperTimeout=mirrOperTimeout, mirroring=mirroring, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, trunkGroupCurCfgState=trunkGroupCurCfgState, portInfoTableEntry=portInfoTableEntry, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, pmNewCfgTimeout=pmNewCfgTimeout, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, vlanNewCfgBwmContract=vlanNewCfgBwmContract, agPortCurCfgPrefLink=agPortCurCfgPrefLink, vlanCurCfgState=vlanCurCfgState, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, vlanNewCfgPorts=vlanNewCfgPorts, agPortNewCfgVlanTag=agPortNewCfgVlanTag, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, portInfoPhyIfDescr=portInfoPhyIfDescr, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, mirrOperType=mirrOperType, agPortNewCfgRmon=agPortNewCfgRmon, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, portCpuStatsUtilTable=portCpuStatsUtilTable, agPortNewCfgPortName=agPortNewCfgPortName, agPortCurCfgPVID=agPortCurCfgPVID, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, agPortCurCfgState=agPortCurCfgState, port_info=port_info, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, agPortNewCfgState=agPortNewCfgState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portCpuStats=portCpuStats, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, vlanMaxEnt=vlanMaxEnt, vlanCurCfgVlanId=vlanCurCfgVlanId, agPortNewCfgPrefLink=agPortNewCfgPrefLink, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, agPortCurCfgRmon=agPortCurCfgRmon, pmCurCfgTimeout=pmCurCfgTimeout, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupNewCfgState=trunkGroupNewCfgState, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, port_stats=port_stats, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry)
