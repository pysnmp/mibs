...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", agPortCurCfgTable=agPortCurCfgTable, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, vlanCurCfgState=vlanCurCfgState, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgPortState=stgNewCfgPortState, vlanNewCfgJumbo=vlanNewCfgJumbo, portCpuStatsUtilIndx=portCpuStatsUtilIndx, vlanNewCfgPorts=vlanNewCfgPorts, trunkgroup=trunkgroup, agPortCurCfgRmon=agPortCurCfgRmon, agPortCurCfgPortName=agPortCurCfgPortName, pmNewCfgTimeout=pmNewCfgTimeout, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portInfoTable=portInfoTable, port_info=port_info, stgNewCfgAddVlan=stgNewCfgAddVlan, agPortCurCfgVlanTag=agPortCurCfgVlanTag, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, agPortNewCfgIndx=agPortNewCfgIndx, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCurCfgState=stgCurCfgState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portInfoPhyIfDescr=portInfoPhyIfDescr, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, agPortNewCfgPortName=agPortNewCfgPortName, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanNewCfgStg=vlanNewCfgStg, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgPortState=stgCurCfgPortState, portInfoLink=portInfoLink, mirroring=mirroring, stgCurCfgPortIndex=stgCurCfgPortIndex, portStatsPhyIfInErrors=portStatsPhyIfInErrors, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, portStatsTableEntry=portStatsTableEntry, port_stats=port_stats, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, spannTreeGrpCfg=spannTreeGrpCfg, vlanNewCfgState=vlanNewCfgState, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgNewCfgTable=stgNewCfgTable, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, pmNewCfgMirroredPort=pmNewCfgMirroredPort, stgNewCfgPortTable=stgNewCfgPortTable, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, agPortNewCfgPrefLink=agPortNewCfgPrefLink, portStatsPhyIfInOctets=portStatsPhyIfInOctets, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, vlanNewCfgRemovePort=vlanNewCfgRemovePort, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mirrPortMirr=mirrPortMirr, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, stgNewCfgStgIndex=stgNewCfgStgIndex, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, mirrVlanMirr=mirrVlanMirr, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmCurCfgState=pmCurCfgState, vlanNewCfgVlanName=vlanNewCfgVlanName, mirrOper=mirrOper, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, agPortCurCfgPVID=agPortCurCfgPVID, pmCurCfgMirroredPort=pmCurCfgMirroredPort, portInfoPhyIfType=portInfoPhyIfType, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, mirrOperMonitoringPort=mirrOperMonitoringPort, mirrOperMirroredPort=mirrOperMirroredPort, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, agPortCurCfgTableEntry=agPortCurCfgTableEntry, vlanMaxEnt=vlanMaxEnt, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, agPortNewCfgTable=agPortNewCfgTable, portInfoPhyIfMtu=portInfoPhyIfMtu, stgNewCfgPortIndex=stgNewCfgPortIndex, agPortCurCfgBwmContract=agPortCurCfgBwmContract, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, portInfoPhyIfLastChange=portInfoPhyIfLastChange, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, vlanCurCfgPorts=vlanCurCfgPorts, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, vlanCurCfgStg=vlanCurCfgStg, portCpuStatsUtilTable=portCpuStatsUtilTable, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, agPortConfig=agPortConfig, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortCurCfgStp=agPortCurCfgStp, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, agPortCurCfgPrefLink=agPortCurCfgPrefLink, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, portInfoFlowCtrl=portInfoFlowCtrl, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, agPortCurCfgState=agPortCurCfgState, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, vlanCurCfgJumbo=vlanCurCfgJumbo, portInfoIndx=portInfoIndx, stgNewCfgState=stgNewCfgState, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mirrOperType=mirrOperType, portmirroring=portmirroring, vlanNewCfgTable=vlanNewCfgTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, agPortNewCfgStp=agPortNewCfgStp, portStatsTable=portStatsTable, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, agPortCurCfgIndx=agPortCurCfgIndx, trunkGroupNewCfgState=trunkGroupNewCfgState, agPortNewCfgState=agPortNewCfgState, agPortNewCfgVlanTag=agPortNewCfgVlanTag, portInfoTableEntry=portInfoTableEntry, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanCurCfgTable=vlanCurCfgTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, agPortNewCfgTableEntry=agPortNewCfgTableEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanNewCfgAddPort=vlanNewCfgAddPort, pmCurCfgTimeout=pmCurCfgTimeout, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, vlanCurCfgVlanName=vlanCurCfgVlanName, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgCurCfgPortTable=stgCurCfgPortTable, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, agPortNewCfgPVID=agPortNewCfgPVID, agPortNewCfgBwmContract=agPortNewCfgBwmContract, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, agPortCurCfgBackLink=agPortCurCfgBackLink, vlanNewCfgDelete=vlanNewCfgDelete, portStatsIndx=portStatsIndx, stgCurCfgTable=stgCurCfgTable, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, agPortTableMaxEnt=agPortTableMaxEnt, agPortNewCfgBackLink=agPortNewCfgBackLink, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlans=vlans, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, portInfoSpeed=portInfoSpeed, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, agPortNewCfgRmon=agPortNewCfgRmon, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, pmNewCfgState=pmNewCfgState, stgCurCfgStgIndex=stgCurCfgStgIndex, portInfoMode=portInfoMode, mirrOperTimeout=mirrOperTimeout, mirrOperState=mirrOperState, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, portCpuStats=portCpuStats)
