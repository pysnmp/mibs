...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mirrOperMirroredPort=mirrOperMirroredPort, vlanNewCfgStg=vlanNewCfgStg, portInfoSpeed=portInfoSpeed, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, stgNewCfgIndex=stgNewCfgIndex, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, stgCurCfgState=stgCurCfgState, mirrVlanMirr=mirrVlanMirr, pmNewCfgState=pmNewCfgState, pmCurCfgState=pmCurCfgState, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, portStatsTable=portStatsTable, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portCpuStats=portCpuStats, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, agPortNewCfgState=agPortNewCfgState, portInfoFlowCtrl=portInfoFlowCtrl, portInfoPhyIfMtu=portInfoPhyIfMtu, agPortCurCfgStp=agPortCurCfgStp, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgPortIndex=stgCurCfgPortIndex, portInfoIndx=portInfoIndx, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, mirrPortMirr=mirrPortMirr, portInfoTable=portInfoTable, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanCurCfgTable=vlanCurCfgTable, portStatsIndx=portStatsIndx, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, agPortCurCfgPortName=agPortCurCfgPortName, stgNewCfgState=stgNewCfgState, agPortNewCfgIndx=agPortNewCfgIndx, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, mirrOper=mirrOper, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkgroup=trunkgroup, stgCurCfgPortTable=stgCurCfgPortTable, agPortCurCfgPVID=agPortCurCfgPVID, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, mirroring=mirroring, vlanNewCfgJumbo=vlanNewCfgJumbo, portCpuStatsUtilIndx=portCpuStatsUtilIndx, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, portInfoMode=portInfoMode, portStatsPhyIfInOctets=portStatsPhyIfInOctets, vlanNewCfgAddPort=vlanNewCfgAddPort, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, portInfoTableEntry=portInfoTableEntry, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, agPortCurCfgRmon=agPortCurCfgRmon, vlans=vlans, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmNewCfgMirroredPort=pmNewCfgMirroredPort, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, stgNewCfgPortIndex=stgNewCfgPortIndex, portInfoLink=portInfoLink, agPortCurCfgIndx=agPortCurCfgIndx, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, agPortCurCfgPrefLink=agPortCurCfgPrefLink, stgNewCfgStgIndex=stgNewCfgStgIndex, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, pmNewCfgTimeout=pmNewCfgTimeout, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, vlanCurCfgVlanName=vlanCurCfgVlanName, agPortNewCfgVlanTag=agPortNewCfgVlanTag, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanNewCfgTable=vlanNewCfgTable, portCpuStatsUtilTable=portCpuStatsUtilTable, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, portStatsPhyIfInErrors=portStatsPhyIfInErrors, pmCurCfgMirroredPort=pmCurCfgMirroredPort, agPortNewCfgStp=agPortNewCfgStp, portInfoPhyIfLastChange=portInfoPhyIfLastChange, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portmirroring=portmirroring, portStatsTableEntry=portStatsTableEntry, agPortCurCfgBwmContract=agPortCurCfgBwmContract, stgCurCfgTableEntry=stgCurCfgTableEntry, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, agPortCurCfgBackLink=agPortCurCfgBackLink, agPortCurCfgVlanTag=agPortCurCfgVlanTag, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmCurCfgTimeout=pmCurCfgTimeout, vlanCurCfgPorts=vlanCurCfgPorts, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgCurCfgTable=stgCurCfgTable, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, stgNewCfgPortState=stgNewCfgPortState, stgCurCfgPortState=stgCurCfgPortState, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanNewCfgPorts=vlanNewCfgPorts, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, portInfoPhyIfDescr=portInfoPhyIfDescr, vlanNewCfgState=vlanNewCfgState, mirrOperTimeout=mirrOperTimeout, port_stats=port_stats, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, agPortNewCfgPortName=agPortNewCfgPortName, stgNewCfgAddVlan=stgNewCfgAddVlan, agPortNewCfgBwmContract=agPortNewCfgBwmContract, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, agPortCurCfgTableEntry=agPortCurCfgTableEntry, mirrOperType=mirrOperType, agPortNewCfgPrefLink=agPortNewCfgPrefLink, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, agPortCurCfgTable=agPortCurCfgTable, vlanMaxEnt=vlanMaxEnt, agPortNewCfgTable=agPortNewCfgTable, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgTable=stgNewCfgTable, agPortNewCfgPVID=agPortNewCfgPVID, agPortNewCfgTableEntry=agPortNewCfgTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, portInfoPhyIfType=portInfoPhyIfType, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, agPortCurCfgState=agPortCurCfgState, agPortNewCfgRmon=agPortNewCfgRmon, mirrOperState=mirrOperState, spannTreeGrpCfg=spannTreeGrpCfg, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanCurCfgStg=vlanCurCfgStg, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgIndex=stgCurCfgIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, port_info=port_info, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, stgNewCfgPortTable=stgNewCfgPortTable, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, agPortTableMaxEnt=agPortTableMaxEnt, agPortNewCfgBackLink=agPortNewCfgBackLink, vlanCurCfgState=vlanCurCfgState, vlanCurCfgVlanId=vlanCurCfgVlanId, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, vlanNewCfgRemovePort=vlanNewCfgRemovePort, agPortConfig=agPortConfig, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort)
