...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, agPortNewCfgBwmContract=agPortNewCfgBwmContract, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, trunkGroupCurCfgState=trunkGroupCurCfgState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, agPortCurCfgPortName=agPortCurCfgPortName, stgNewCfgPortState=stgNewCfgPortState, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, portInfoFlowCtrl=portInfoFlowCtrl, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, vlanCurCfgVlanName=vlanCurCfgVlanName, pmCurCfgTimeout=pmCurCfgTimeout, vlanNewCfgAddPort=vlanNewCfgAddPort, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, vlanCurCfgStg=vlanCurCfgStg, portInfoPhyIfMtu=portInfoPhyIfMtu, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, mirrPortMirr=mirrPortMirr, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanMaxEnt=vlanMaxEnt, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portStatsTableEntry=portStatsTableEntry, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, vlanNewCfgVlanId=vlanNewCfgVlanId, portInfoLink=portInfoLink, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, agPortNewCfgIndx=agPortNewCfgIndx, stgCurCfgTable=stgCurCfgTable, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanNewCfgBwmContract=vlanNewCfgBwmContract, agPortCurCfgStp=agPortCurCfgStp, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgNewCfgIndex=stgNewCfgIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, agPortCurCfgVlanTag=agPortCurCfgVlanTag, vlanCurCfgTable=vlanCurCfgTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, portInfoPhyIfType=portInfoPhyIfType, agPortCurCfgTable=agPortCurCfgTable, trunkgroup=trunkgroup, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mirrOperTimeout=mirrOperTimeout, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, portStatsIndx=portStatsIndx, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, agPortNewCfgState=agPortNewCfgState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgNewCfgPortIndex=stgNewCfgPortIndex, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, agPortCurCfgIndx=agPortCurCfgIndx, stgCurCfgPortState=stgCurCfgPortState, portInfoMode=portInfoMode, agPortNewCfgPVID=agPortNewCfgPVID, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, pmCurCfgMirroredPort=pmCurCfgMirroredPort, portInfoIndx=portInfoIndx, portInfoPhyIfDescr=portInfoPhyIfDescr, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portCpuStatsUtilIndx=portCpuStatsUtilIndx, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanCurCfgPorts=vlanCurCfgPorts, portStatsPhyIfInErrors=portStatsPhyIfInErrors, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, mirroring=mirroring, agPortNewCfgTableEntry=agPortNewCfgTableEntry, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portCpuStatsUtilTable=portCpuStatsUtilTable, stgCurCfgIndex=stgCurCfgIndex, vlanCurCfgJumbo=vlanCurCfgJumbo, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, spannTreeGrpCfg=spannTreeGrpCfg, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, stgNewCfgTable=stgNewCfgTable, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, mirrOperMonitoringPort=mirrOperMonitoringPort, portInfoTable=portInfoTable, mirrOperMirroredPort=mirrOperMirroredPort, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, portInfoPhyIfLastChange=portInfoPhyIfLastChange, vlanNewCfgTable=vlanNewCfgTable, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, agPortCurCfgRmon=agPortCurCfgRmon, agPortCurCfgBwmContract=agPortCurCfgBwmContract, port_info=port_info, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, agPortCurCfgBackLink=agPortCurCfgBackLink, agPortNewCfgPortName=agPortNewCfgPortName, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, vlanNewCfgPorts=vlanNewCfgPorts, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, agPortNewCfgPrefLink=agPortNewCfgPrefLink, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, port_stats=port_stats, vlanNewCfgState=vlanNewCfgState, stgNewCfgState=stgNewCfgState, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, mirrOperType=mirrOperType, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, agPortNewCfgRmon=agPortNewCfgRmon, pmNewCfgTimeout=pmNewCfgTimeout, stgNewCfgStgIndex=stgNewCfgStgIndex, agPortNewCfgBackLink=agPortNewCfgBackLink, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, stgCurCfgPortIndex=stgCurCfgPortIndex, pmNewCfgMirroredPort=pmNewCfgMirroredPort, agPortNewCfgStp=agPortNewCfgStp, mirrOperState=mirrOperState, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, portCpuStats=portCpuStats, portInfoSpeed=portInfoSpeed, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanCurCfgState=vlanCurCfgState, agPortConfig=agPortConfig, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portInfoTableEntry=portInfoTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanNewCfgStg=vlanNewCfgStg, vlanNewCfgJumbo=vlanNewCfgJumbo, stgCurCfgPortTable=stgCurCfgPortTable, agPortCurCfgState=agPortCurCfgState, agPortNewCfgTable=agPortNewCfgTable, mirrVlanMirr=mirrVlanMirr, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portStatsTable=portStatsTable, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, pmNewCfgState=pmNewCfgState, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, pmCurCfgState=pmCurCfgState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlans=vlans, portmirroring=portmirroring, agPortCurCfgTableEntry=agPortCurCfgTableEntry, stgNewCfgPortTable=stgNewCfgPortTable, agPortNewCfgVlanTag=agPortNewCfgVlanTag, portStatsPhyIfInOctets=portStatsPhyIfInOctets, mirrOper=mirrOper, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgState=stgCurCfgState, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, agPortCurCfgPVID=agPortCurCfgPVID, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, agPortCurCfgPrefLink=agPortCurCfgPrefLink, agPortTableMaxEnt=agPortTableMaxEnt)
