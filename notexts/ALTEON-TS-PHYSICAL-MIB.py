...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, port_stats=port_stats, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, stgNewCfgPortTable=stgNewCfgPortTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portCpuStats=portCpuStats, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, agPortCurCfgPortName=agPortCurCfgPortName, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgTable=stgCurCfgTable, portInfoIndx=portInfoIndx, vlanCurCfgStg=vlanCurCfgStg, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, agPortNewCfgTable=agPortNewCfgTable, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, agPortNewCfgTableEntry=agPortNewCfgTableEntry, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, vlanCurCfgTable=vlanCurCfgTable, vlanCurCfgVlanId=vlanCurCfgVlanId, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, mirrOperTimeout=mirrOperTimeout, stgNewCfgState=stgNewCfgState, vlanNewCfgVlanId=vlanNewCfgVlanId, agPortCurCfgPVID=agPortCurCfgPVID, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, portmirroring=portmirroring, agPortCurCfgIndx=agPortCurCfgIndx, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, portStatsPhyIfInOctets=portStatsPhyIfInOctets, pmCurCfgMirroredPort=pmCurCfgMirroredPort, agPortNewCfgBackLink=agPortNewCfgBackLink, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanNewCfgTable=vlanNewCfgTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, agPortConfig=agPortConfig, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, agPortCurCfgBwmContract=agPortCurCfgBwmContract, vlanCurCfgState=vlanCurCfgState, pmCurCfgState=pmCurCfgState, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, agPortNewCfgRmon=agPortNewCfgRmon, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, port_info=port_info, stgNewCfgPortIndex=stgNewCfgPortIndex, agPortCurCfgStp=agPortCurCfgStp, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, vlanMaxEnt=vlanMaxEnt, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, stgNewCfgIndex=stgNewCfgIndex, vlanNewCfgState=vlanNewCfgState, pmNewCfgTimeout=pmNewCfgTimeout, trunkGroupCurCfgState=trunkGroupCurCfgState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, agPortNewCfgState=agPortNewCfgState, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, stgCurCfgPortState=stgCurCfgPortState, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, portInfoPhyIfType=portInfoPhyIfType, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, portInfoLink=portInfoLink, trunkgroup=trunkgroup, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, mirrOperMonitoringPort=mirrOperMonitoringPort, portInfoTableEntry=portInfoTableEntry, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, portStatsTable=portStatsTable, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, agPortCurCfgRmon=agPortCurCfgRmon, vlanNewCfgStg=vlanNewCfgStg, trunkGroupNewCfgState=trunkGroupNewCfgState, mirrPortMirr=mirrPortMirr, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portInfoPhyIfMtu=portInfoPhyIfMtu, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, vlanCurCfgVlanName=vlanCurCfgVlanName, portCpuStatsUtilTable=portCpuStatsUtilTable, agPortTableMaxEnt=agPortTableMaxEnt, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, agPortNewCfgVlanTag=agPortNewCfgVlanTag, agPortCurCfgTable=agPortCurCfgTable, stgNewCfgPortState=stgNewCfgPortState, pmCurCfgTimeout=pmCurCfgTimeout, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, stgCurCfgStgIndex=stgCurCfgStgIndex, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, portInfoTable=portInfoTable, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, pmNewCfgMirroredPort=pmNewCfgMirroredPort, mirrOperMirroredPort=mirrOperMirroredPort, vlanCurCfgPorts=vlanCurCfgPorts, agPortCurCfgVlanTag=agPortCurCfgVlanTag, mirrOper=mirrOper, vlanCurCfgJumbo=vlanCurCfgJumbo, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgStgIndex=stgNewCfgStgIndex, spannTreeGrpCfg=spannTreeGrpCfg, vlans=vlans, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, agPortNewCfgPortName=agPortNewCfgPortName, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCurCfgPortTable=stgCurCfgPortTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portStatsIndx=portStatsIndx, agPortNewCfgStp=agPortNewCfgStp, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, agPortCurCfgBackLink=agPortCurCfgBackLink, agPortNewCfgPrefLink=agPortNewCfgPrefLink, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgState=stgCurCfgState, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, agPortNewCfgBwmContract=agPortNewCfgBwmContract, stgNewCfgTable=stgNewCfgTable, portStatsTableEntry=portStatsTableEntry, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, agPortNewCfgPVID=agPortNewCfgPVID, mirroring=mirroring, agPortCurCfgTableEntry=agPortCurCfgTableEntry, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, agPortCurCfgState=agPortCurCfgState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, agPortCurCfgPrefLink=agPortCurCfgPrefLink, vlanNewCfgJumbo=vlanNewCfgJumbo, portInfoMode=portInfoMode, stgCurCfgIndex=stgCurCfgIndex, mirrOperState=mirrOperState, portInfoSpeed=portInfoSpeed, portCpuStatsUtilIndx=portCpuStatsUtilIndx, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgTableEntry=stgNewCfgTableEntry, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, portInfoPhyIfLastChange=portInfoPhyIfLastChange, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, mirrOperType=mirrOperType, portInfoFlowCtrl=portInfoFlowCtrl, agPortNewCfgIndx=agPortNewCfgIndx, stgNewCfgAddVlan=stgNewCfgAddVlan, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, vlanNewCfgVlanName=vlanNewCfgVlanName, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmNewCfgState=pmNewCfgState, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portStatsPhyIfInErrors=portStatsPhyIfInErrors, mirrVlanMirr=mirrVlanMirr, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode)
