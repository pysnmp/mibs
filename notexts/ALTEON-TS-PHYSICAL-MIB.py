...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", agPortCurCfgBackLink=agPortCurCfgBackLink, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanCurCfgJumbo=vlanCurCfgJumbo, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, pmNewCfgState=pmNewCfgState, portInfoSpeed=portInfoSpeed, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, vlanNewCfgVlanName=vlanNewCfgVlanName, mirrOper=mirrOper, mirrVlanMirr=mirrVlanMirr, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, stgCurCfgTableEntry=stgCurCfgTableEntry, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, agPortCurCfgPortName=agPortCurCfgPortName, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanMaxEnt=vlanMaxEnt, portStatsTableEntry=portStatsTableEntry, agPortNewCfgTableEntry=agPortNewCfgTableEntry, trunkgroup=trunkgroup, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, stgNewCfgState=stgNewCfgState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, stgCurCfgStgIndex=stgCurCfgStgIndex, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, stgCurCfgTable=stgCurCfgTable, agPortCurCfgPrefLink=agPortCurCfgPrefLink, spannTreeGrpCfg=spannTreeGrpCfg, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, pmCurCfgState=pmCurCfgState, vlanNewCfgStg=vlanNewCfgStg, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, agPortCurCfgPVID=agPortCurCfgPVID, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mirrOperType=mirrOperType, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portInfoPhyIfLastChange=portInfoPhyIfLastChange, portStatsIndx=portStatsIndx, stgCurCfgPortState=stgCurCfgPortState, agPortNewCfgRmon=agPortNewCfgRmon, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, agPortCurCfgVlanTag=agPortCurCfgVlanTag, agPortNewCfgIndx=agPortNewCfgIndx, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portInfoPhyIfMtu=portInfoPhyIfMtu, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, agPortCurCfgState=agPortCurCfgState, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, vlanNewCfgTableEntry=vlanNewCfgTableEntry, agPortCurCfgTableEntry=agPortCurCfgTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, pmNewCfgTimeout=pmNewCfgTimeout, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, portInfoLink=portInfoLink, vlanNewCfgDelete=vlanNewCfgDelete, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, agPortNewCfgVlanTag=agPortNewCfgVlanTag, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgIndex=stgNewCfgIndex, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, vlanCurCfgTable=vlanCurCfgTable, pmCurCfgMirroredPort=pmCurCfgMirroredPort, stgNewCfgPortState=stgNewCfgPortState, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, mirrOperMirroredPort=mirrOperMirroredPort, portInfoFlowCtrl=portInfoFlowCtrl, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortConfig=agPortConfig, vlanCurCfgPorts=vlanCurCfgPorts, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, agPortNewCfgStp=agPortNewCfgStp, port_stats=port_stats, vlanNewCfgAddPort=vlanNewCfgAddPort, portStatsTable=portStatsTable, mirroring=mirroring, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, stgNewCfgPortTable=stgNewCfgPortTable, vlanNewCfgTable=vlanNewCfgTable, stgCurCfgPortIndex=stgCurCfgPortIndex, agPortCurCfgTable=agPortCurCfgTable, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, portCpuStatsUtilIndx=portCpuStatsUtilIndx, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portCpuStats=portCpuStats, vlanCurCfgVlanId=vlanCurCfgVlanId, portCpuStatsUtilTable=portCpuStatsUtilTable, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, agPortCurCfgStp=agPortCurCfgStp, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, agPortCurCfgBwmContract=agPortCurCfgBwmContract, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, mirrOperTimeout=mirrOperTimeout, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mirrOperState=mirrOperState, agPortNewCfgState=agPortNewCfgState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, agPortNewCfgPrefLink=agPortNewCfgPrefLink, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, trunkGroupCurCfgTable=trunkGroupCurCfgTable, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, stgNewCfgTableEntry=stgNewCfgTableEntry, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, pmNewCfgMirroredPort=pmNewCfgMirroredPort, vlanNewCfgPorts=vlanNewCfgPorts, portInfoTableEntry=portInfoTableEntry, agPortNewCfgPortName=agPortNewCfgPortName, agPortNewCfgBwmContract=agPortNewCfgBwmContract, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, agPortNewCfgBackLink=agPortNewCfgBackLink, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portInfoMode=portInfoMode, portInfoPhyIfType=portInfoPhyIfType, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanNewCfgVlanId=vlanNewCfgVlanId, mirrPortMirr=mirrPortMirr, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, portInfoTable=portInfoTable, vlanCurCfgState=vlanCurCfgState, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, mirrOperMonitoringPort=mirrOperMonitoringPort, portStatsPhyIfInErrors=portStatsPhyIfInErrors, stgCurCfgState=stgCurCfgState, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, agPortCurCfgRmon=agPortCurCfgRmon, stgCurCfgIndex=stgCurCfgIndex, portInfoIndx=portInfoIndx, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortTableMaxEnt=agPortTableMaxEnt, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, pmCurCfgTimeout=pmCurCfgTimeout, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgNewCfgTable=stgNewCfgTable, vlans=vlans, pmCurCfgPortMirrState=pmCurCfgPortMirrState, agPortCurCfgIndx=agPortCurCfgIndx, vlanNewCfgState=vlanNewCfgState, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, agPortNewCfgPVID=agPortNewCfgPVID, vlanCurCfgStg=vlanCurCfgStg, port_info=port_info, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, agPortNewCfgTable=agPortNewCfgTable, trunkGroupCurCfgState=trunkGroupCurCfgState, portmirroring=portmirroring, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portStatsPhyIfInOctets=portStatsPhyIfInOctets, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, stgCurCfgPortTable=stgCurCfgPortTable, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, stgNewCfgPortIndex=stgNewCfgPortIndex)
