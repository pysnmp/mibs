...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", vlanNewCfgAddPort=vlanNewCfgAddPort, vlanCurCfgVlanName=vlanCurCfgVlanName, agPortCurCfgPrefLink=agPortCurCfgPrefLink, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, stgCurCfgStgIndex=stgCurCfgStgIndex, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portStatsIndx=portStatsIndx, portCpuStatsUtilIndx=portCpuStatsUtilIndx, agPortCurCfgIndx=agPortCurCfgIndx, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, agPortCurCfgStp=agPortCurCfgStp, stgNewCfgStgIndex=stgNewCfgStgIndex, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, portInfoSpeed=portInfoSpeed, mirrOperMonitoringPort=mirrOperMonitoringPort, stgCurCfgPortIndex=stgCurCfgPortIndex, pmNewCfgState=pmNewCfgState, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgPortState=stgNewCfgPortState, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, stgCurCfgState=stgCurCfgState, agPortNewCfgPrefLink=agPortNewCfgPrefLink, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portStatsTable=portStatsTable, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mirrOper=mirrOper, stgNewCfgTableEntry=stgNewCfgTableEntry, vlans=vlans, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgTable=stgNewCfgTable, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanNewCfgState=vlanNewCfgState, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgCurCfgPortTable=stgCurCfgPortTable, agPortNewCfgRmon=agPortNewCfgRmon, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, vlanNewCfgVlanName=vlanNewCfgVlanName, port_stats=port_stats, portInfoTable=portInfoTable, vlanCurCfgTable=vlanCurCfgTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, portInfoIndx=portInfoIndx, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanMaxEnt=vlanMaxEnt, agPortCurCfgRmon=agPortCurCfgRmon, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmCurCfgMirroredPort=pmCurCfgMirroredPort, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, agPortConfig=agPortConfig, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, agPortNewCfgStp=agPortNewCfgStp, mirrOperType=mirrOperType, portInfoMode=portInfoMode, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, stgNewCfgState=stgNewCfgState, portStatsTableEntry=portStatsTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, agPortNewCfgState=agPortNewCfgState, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, stgNewCfgPortTable=stgNewCfgPortTable, vlanNewCfgTable=vlanNewCfgTable, vlanCurCfgJumbo=vlanCurCfgJumbo, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, pmCurCfgState=pmCurCfgState, portCpuStatsUtilTable=portCpuStatsUtilTable, trunkgroup=trunkgroup, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, vlanNewCfgDelete=vlanNewCfgDelete, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mirroring=mirroring, vlanCurCfgStg=vlanCurCfgStg, pmCurCfgTimeout=pmCurCfgTimeout, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mirrOperState=mirrOperState, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, spannTreeGrpCfg=spannTreeGrpCfg, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanNewCfgStg=vlanNewCfgStg, stgCurCfgPortState=stgCurCfgPortState, portStatsPhyIfInErrors=portStatsPhyIfInErrors, agPortCurCfgBackLink=agPortCurCfgBackLink, vlanCurCfgState=vlanCurCfgState, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmNewCfgPortMirrState=pmNewCfgPortMirrState, agPortCurCfgState=agPortCurCfgState, portInfoFlowCtrl=portInfoFlowCtrl, agPortCurCfgPortName=agPortCurCfgPortName, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, agPortNewCfgTable=agPortNewCfgTable, agPortNewCfgBwmContract=agPortNewCfgBwmContract, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, portInfoPhyIfType=portInfoPhyIfType, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portCpuStats=portCpuStats, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, portmirroring=portmirroring, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portInfoPhyIfMtu=portInfoPhyIfMtu, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portInfoLink=portInfoLink, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, agPortNewCfgPortName=agPortNewCfgPortName, agPortCurCfgPVID=agPortCurCfgPVID, stgNewCfgAddVlan=stgNewCfgAddVlan, agPortCurCfgTableEntry=agPortCurCfgTableEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, agPortNewCfgTableEntry=agPortNewCfgTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmNewCfgTimeout=pmNewCfgTimeout, stgNewCfgIndex=stgNewCfgIndex, agPortCurCfgTable=agPortCurCfgTable, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, agPortNewCfgBackLink=agPortNewCfgBackLink, agPortNewCfgPVID=agPortNewCfgPVID, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, agPortNewCfgVlanTag=agPortNewCfgVlanTag, agPortCurCfgBwmContract=agPortCurCfgBwmContract, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, agPortNewCfgIndx=agPortNewCfgIndx, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, portInfoPhyIfLastChange=portInfoPhyIfLastChange, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, mirrOperMirroredPort=mirrOperMirroredPort, portStatsPhyIfInOctets=portStatsPhyIfInOctets, mirrOperTimeout=mirrOperTimeout, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, portInfoTableEntry=portInfoTableEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanCurCfgPorts=vlanCurCfgPorts, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, port_info=port_info, agPortTableMaxEnt=agPortTableMaxEnt, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, stgCurCfgTable=stgCurCfgTable, mirrPortMirr=mirrPortMirr, agPortCurCfgVlanTag=agPortCurCfgVlanTag, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, mirrVlanMirr=mirrVlanMirr, pmNewCfgMirroredPort=pmNewCfgMirroredPort, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts)
