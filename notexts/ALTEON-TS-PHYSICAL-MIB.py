...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, portInfoTableEntry=portInfoTableEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portCpuStatsUtilIndx=portCpuStatsUtilIndx, stgNewCfgPortIndex=stgNewCfgPortIndex, portStatsPhyIfInErrors=portStatsPhyIfInErrors, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanCurCfgState=vlanCurCfgState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portCpuStats=portCpuStats, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, pmCurCfgState=pmCurCfgState, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanNewCfgState=vlanNewCfgState, agPortCurCfgPortName=agPortCurCfgPortName, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, vlanNewCfgStg=vlanNewCfgStg, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, portStatsTableEntry=portStatsTableEntry, agPortCurCfgTable=agPortCurCfgTable, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgTableEntry=stgNewCfgTableEntry, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, agPortCurCfgVlanTag=agPortCurCfgVlanTag, stgNewCfgAddVlan=stgNewCfgAddVlan, mirrOperMirroredPort=mirrOperMirroredPort, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, mirroring=mirroring, stgCurCfgTableEntry=stgCurCfgTableEntry, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortCurCfgIndx=agPortCurCfgIndx, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, trunkgroup=trunkgroup, mirrOperState=mirrOperState, stgNewCfgState=stgNewCfgState, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, vlanNewCfgPorts=vlanNewCfgPorts, vlanCurCfgVlanName=vlanCurCfgVlanName, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmNewCfgState=pmNewCfgState, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, mirrOperTimeout=mirrOperTimeout, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, portInfoPhyIfType=portInfoPhyIfType, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, port_info=port_info, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, stgCurCfgPortTable=stgCurCfgPortTable, portInfoMode=portInfoMode, mirrOper=mirrOper, vlanMaxEnt=vlanMaxEnt, agPortNewCfgTableEntry=agPortNewCfgTableEntry, portCpuStatsUtilTable=portCpuStatsUtilTable, portStatsPhyIfInOctets=portStatsPhyIfInOctets, agPortNewCfgStp=agPortNewCfgStp, agPortCurCfgPVID=agPortCurCfgPVID, vlanCurCfgTable=vlanCurCfgTable, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portInfoPhyIfMtu=portInfoPhyIfMtu, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, vlanCurCfgStg=vlanCurCfgStg, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, vlanNewCfgDelete=vlanNewCfgDelete, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, vlanNewCfgJumbo=vlanNewCfgJumbo, agPortCurCfgRmon=agPortCurCfgRmon, vlanNewCfgTableEntry=vlanNewCfgTableEntry, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, vlanNewCfgVlanName=vlanNewCfgVlanName, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, agPortCurCfgStp=agPortCurCfgStp, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, portInfoTable=portInfoTable, stgCurCfgPortState=stgCurCfgPortState, agPortCurCfgTableEntry=agPortCurCfgTableEntry, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, mirrOperType=mirrOperType, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgCurCfgState=stgCurCfgState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, vlans=vlans, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, agPortNewCfgBwmContract=agPortNewCfgBwmContract, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, agPortNewCfgState=agPortNewCfgState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanNewCfgBwmContract=vlanNewCfgBwmContract, agPortCurCfgBackLink=agPortCurCfgBackLink, portStatsIndx=portStatsIndx, stgCurCfgTable=stgCurCfgTable, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmCurCfgMirroredPort=pmCurCfgMirroredPort, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, agPortCurCfgPrefLink=agPortCurCfgPrefLink, portInfoIndx=portInfoIndx, agPortNewCfgVlanTag=agPortNewCfgVlanTag, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, agPortCurCfgBwmContract=agPortCurCfgBwmContract, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgNewCfgTable=stgNewCfgTable, agPortNewCfgPrefLink=agPortNewCfgPrefLink, vlanNewCfgTable=vlanNewCfgTable, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, trunkGroupNewCfgTable=trunkGroupNewCfgTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgCurCfgPortIndex=stgCurCfgPortIndex, agPortNewCfgRmon=agPortNewCfgRmon, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, mirrPortMirr=mirrPortMirr, agPortNewCfgTable=agPortNewCfgTable, portInfoLink=portInfoLink, vlanNewCfgAddPort=vlanNewCfgAddPort, agPortConfig=agPortConfig, spannTreeGrpCfg=spannTreeGrpCfg, portInfoPhyIfDescr=portInfoPhyIfDescr, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgIndex=stgCurCfgIndex, mirrVlanMirr=mirrVlanMirr, agPortNewCfgBackLink=agPortNewCfgBackLink, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, pmNewCfgMirroredPort=pmNewCfgMirroredPort, agPortNewCfgPVID=agPortNewCfgPVID, stgNewCfgIndex=stgNewCfgIndex, agPortTableMaxEnt=agPortTableMaxEnt, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, stgCurCfgStgIndex=stgCurCfgStgIndex, port_stats=port_stats, agPortNewCfgPortName=agPortNewCfgPortName, pmNewCfgTimeout=pmNewCfgTimeout, portmirroring=portmirroring, portInfoFlowCtrl=portInfoFlowCtrl, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, portStatsTable=portStatsTable, trunkGroupCurCfgState=trunkGroupCurCfgState, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanCurCfgPorts=vlanCurCfgPorts, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, agPortNewCfgIndx=agPortNewCfgIndx, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgPortState=stgNewCfgPortState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, portInfoPhyIfLastChange=portInfoPhyIfLastChange, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, agPortCurCfgState=agPortCurCfgState, vlanNewCfgVlanId=vlanNewCfgVlanId, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, stgNewCfgPortTable=stgNewCfgPortTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portInfoSpeed=portInfoSpeed, pmCurCfgTimeout=pmCurCfgTimeout)
