...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", agPortNewCfgIndx=agPortNewCfgIndx, agPortCurCfgBwmContract=agPortCurCfgBwmContract, vlanMaxEnt=vlanMaxEnt, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, stgNewCfgIndex=stgNewCfgIndex, trunkgroup=trunkgroup, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, agPortCurCfgPVID=agPortCurCfgPVID, vlanCurCfgVlanId=vlanCurCfgVlanId, agPortNewCfgStp=agPortNewCfgStp, mirrPortMirr=mirrPortMirr, agPortCurCfgStp=agPortCurCfgStp, stgCurCfgPortTable=stgCurCfgPortTable, stgNewCfgStgIndex=stgNewCfgStgIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portmirroring=portmirroring, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, trunkGroupNewCfgState=trunkGroupNewCfgState, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, pmCurCfgTimeout=pmCurCfgTimeout, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, mirrVlanMirr=mirrVlanMirr, agPortCurCfgVlanTag=agPortCurCfgVlanTag, agPortNewCfgBackLink=agPortNewCfgBackLink, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanCurCfgState=vlanCurCfgState, mirrOperMirroredPort=mirrOperMirroredPort, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, stgCurCfgIndex=stgCurCfgIndex, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, portInfoSpeed=portInfoSpeed, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, agPortCurCfgIndx=agPortCurCfgIndx, portCpuStats=portCpuStats, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, agPortNewCfgPrefLink=agPortNewCfgPrefLink, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, pmCurCfgState=pmCurCfgState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portInfoFlowCtrl=portInfoFlowCtrl, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, agPortNewCfgVlanTag=agPortNewCfgVlanTag, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanNewCfgState=vlanNewCfgState, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, stgNewCfgPortIndex=stgNewCfgPortIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, agPortNewCfgTable=agPortNewCfgTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, portInfoMode=portInfoMode, agPortNewCfgRmon=agPortNewCfgRmon, stgNewCfgTable=stgNewCfgTable, agPortCurCfgTableEntry=agPortCurCfgTableEntry, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, pmNewCfgTimeout=pmNewCfgTimeout, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, pmCurCfgMirroredPort=pmCurCfgMirroredPort, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanCurCfgStg=vlanCurCfgStg, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, agPortNewCfgBwmContract=agPortNewCfgBwmContract, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, portInfoTable=portInfoTable, mirrOperState=mirrOperState, spannTreeGrpCfg=spannTreeGrpCfg, mirrOperTimeout=mirrOperTimeout, portStatsPhyIfInOctets=portStatsPhyIfInOctets, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portInfoIndx=portInfoIndx, stgCurCfgState=stgCurCfgState, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanCurCfgVlanName=vlanCurCfgVlanName, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, portCpuStatsUtilTable=portCpuStatsUtilTable, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, agPortCurCfgRmon=agPortCurCfgRmon, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, portCpuStatsUtilIndx=portCpuStatsUtilIndx, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupCurCfgState=trunkGroupCurCfgState, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, vlanNewCfgDelete=vlanNewCfgDelete, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgCurCfgPortState=stgCurCfgPortState, portInfoPhyIfDescr=portInfoPhyIfDescr, portInfoTableEntry=portInfoTableEntry, vlanNewCfgTable=vlanNewCfgTable, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, vlanCurCfgTable=vlanCurCfgTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgTableEntry=stgCurCfgTableEntry, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, mirrOperType=mirrOperType, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portStatsTable=portStatsTable, agPortNewCfgTableEntry=agPortNewCfgTableEntry, agPortCurCfgPortName=agPortCurCfgPortName, agPortNewCfgPortName=agPortNewCfgPortName, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgPortTable=stgNewCfgPortTable, agPortConfig=agPortConfig, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanNewCfgRemovePort=vlanNewCfgRemovePort, agPortCurCfgBackLink=agPortCurCfgBackLink, mirroring=mirroring, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, pmNewCfgState=pmNewCfgState, portInfoPhyIfMtu=portInfoPhyIfMtu, mirrOper=mirrOper, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portInfoLink=portInfoLink, agPortNewCfgPVID=agPortNewCfgPVID, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanNewCfgPorts=vlanNewCfgPorts, agPortNewCfgState=agPortNewCfgState, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgPortState=stgNewCfgPortState, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanNewCfgJumbo=vlanNewCfgJumbo, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portInfoPhyIfLastChange=portInfoPhyIfLastChange, vlanCurCfgPorts=vlanCurCfgPorts, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, mirrOperMonitoringPort=mirrOperMonitoringPort, port_stats=port_stats, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, vlanNewCfgStg=vlanNewCfgStg, portStatsIndx=portStatsIndx, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortCurCfgTable=agPortCurCfgTable, stgNewCfgState=stgNewCfgState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgTable=stgCurCfgTable, agPortCurCfgState=agPortCurCfgState, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, portInfoPhyIfType=portInfoPhyIfType, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, agPortTableMaxEnt=agPortTableMaxEnt, port_info=port_info, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmNewCfgMirroredPort=pmNewCfgMirroredPort, vlanNewCfgVlanId=vlanNewCfgVlanId, portStatsPhyIfInErrors=portStatsPhyIfInErrors, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, stgNewCfgAddVlan=stgNewCfgAddVlan, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, portStatsTableEntry=portStatsTableEntry, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, agPortCurCfgPrefLink=agPortCurCfgPrefLink, stgCurCfgPortIndex=stgCurCfgPortIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlans=vlans)
