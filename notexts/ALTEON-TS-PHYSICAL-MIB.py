...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", agPortConfig=agPortConfig, agPortCurCfgPrefLink=agPortCurCfgPrefLink, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanNewCfgJumbo=vlanNewCfgJumbo, portInfoMode=portInfoMode, vlanNewCfgVlanId=vlanNewCfgVlanId, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, mirrOper=mirrOper, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, vlans=vlans, agPortCurCfgBackLink=agPortCurCfgBackLink, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, agPortCurCfgBwmContract=agPortCurCfgBwmContract, portStatsIndx=portStatsIndx, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mirrPortMirr=mirrPortMirr, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, vlanCurCfgVlanName=vlanCurCfgVlanName, mirroring=mirroring, agPortTableMaxEnt=agPortTableMaxEnt, agPortCurCfgIndx=agPortCurCfgIndx, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, vlanCurCfgTableEntry=vlanCurCfgTableEntry, agPortCurCfgState=agPortCurCfgState, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portInfoPhyIfDescr=portInfoPhyIfDescr, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, spannTreeGrpCfg=spannTreeGrpCfg, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgCurCfgIndex=stgCurCfgIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portInfoFlowCtrl=portInfoFlowCtrl, mirrOperMirroredPort=mirrOperMirroredPort, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, vlanCurCfgStg=vlanCurCfgStg, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, vlanCurCfgPorts=vlanCurCfgPorts, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmNewCfgState=pmNewCfgState, mirrOperState=mirrOperState, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, agPortNewCfgPortName=agPortNewCfgPortName, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, mirrOperTimeout=mirrOperTimeout, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, portInfoLink=portInfoLink, vlanNewCfgStg=vlanNewCfgStg, agPortNewCfgBackLink=agPortNewCfgBackLink, stgCurCfgTable=stgCurCfgTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, portStatsPhyIfInErrors=portStatsPhyIfInErrors, pmNewCfgMirroredPort=pmNewCfgMirroredPort, trunkGroupNewCfgState=trunkGroupNewCfgState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, portInfoPhyIfLastChange=portInfoPhyIfLastChange, mirrOperType=mirrOperType, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, agPortNewCfgState=agPortNewCfgState, agPortNewCfgStp=agPortNewCfgStp, vlanNewCfgDelete=vlanNewCfgDelete, vlanNewCfgBwmContract=vlanNewCfgBwmContract, port_stats=port_stats, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, pmCurCfgMirroredPort=pmCurCfgMirroredPort, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portCpuStatsUtilTable=portCpuStatsUtilTable, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, agPortNewCfgPrefLink=agPortNewCfgPrefLink, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortCurCfgRmon=agPortCurCfgRmon, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, portInfoTableEntry=portInfoTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, portCpuStats=portCpuStats, vlanNewCfgPorts=vlanNewCfgPorts, pmCurCfgTimeout=pmCurCfgTimeout, stgNewCfgPortState=stgNewCfgPortState, mirrVlanMirr=mirrVlanMirr, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, stgCurCfgState=stgCurCfgState, vlanCurCfgTable=vlanCurCfgTable, portStatsTable=portStatsTable, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, agPortCurCfgPVID=agPortCurCfgPVID, agPortCurCfgTableEntry=agPortCurCfgTableEntry, vlanNewCfgAddPort=vlanNewCfgAddPort, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, agPortNewCfgVlanTag=agPortNewCfgVlanTag, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, agPortNewCfgTableEntry=agPortNewCfgTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, port_info=port_info, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, agPortCurCfgStp=agPortCurCfgStp, stgCurCfgPortIndex=stgCurCfgPortIndex, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, stgCurCfgTableEntry=stgCurCfgTableEntry, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanNewCfgTable=vlanNewCfgTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgStgIndex=stgCurCfgStgIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgPortState=stgCurCfgPortState, agPortNewCfgBwmContract=agPortNewCfgBwmContract, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, pmCurCfgState=pmCurCfgState, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, portStatsTableEntry=portStatsTableEntry, trunkgroup=trunkgroup, agPortNewCfgIndx=agPortNewCfgIndx, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, stgNewCfgStgIndex=stgNewCfgStgIndex, pmNewCfgTimeout=pmNewCfgTimeout, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, stgCurCfgPortTable=stgCurCfgPortTable, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanNewCfgVlanName=vlanNewCfgVlanName, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, stgNewCfgTable=stgNewCfgTable, portInfoIndx=portInfoIndx, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portInfoPhyIfMtu=portInfoPhyIfMtu, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, agPortCurCfgPortName=agPortCurCfgPortName, stgNewCfgTableEntry=stgNewCfgTableEntry, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, vlanMaxEnt=vlanMaxEnt, agPortCurCfgTable=agPortCurCfgTable, stgNewCfgIndex=stgNewCfgIndex, trunkGroupTableMaxSize=trunkGroupTableMaxSize, agPortNewCfgPVID=agPortNewCfgPVID, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, vlanCurCfgState=vlanCurCfgState, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, agPortNewCfgTable=agPortNewCfgTable, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portInfoSpeed=portInfoSpeed, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, stgNewCfgPortTable=stgNewCfgPortTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanNewCfgState=vlanNewCfgState, agPortNewCfgRmon=agPortNewCfgRmon, stgNewCfgState=stgNewCfgState, portmirroring=portmirroring, portCpuStatsUtilIndx=portCpuStatsUtilIndx, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portInfoTable=portInfoTable, portStatsPhyIfInOctets=portStatsPhyIfInOctets, vlanCurCfgJumbo=vlanCurCfgJumbo, portInfoPhyIfType=portInfoPhyIfType, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, agPortCurCfgVlanTag=agPortCurCfgVlanTag)
