...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", vlanMaxEnt=vlanMaxEnt, vlanNewCfgState=vlanNewCfgState, vlanNewCfgPorts=vlanNewCfgPorts, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, trunkgroup=trunkgroup, agPortNewCfgRmon=agPortNewCfgRmon, vlanCurCfgTable=vlanCurCfgTable, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, mirroring=mirroring, vlanCurCfgPorts=vlanCurCfgPorts, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgCurCfgTable=stgCurCfgTable, agPortNewCfgTable=agPortNewCfgTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, agPortNewCfgState=agPortNewCfgState, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, stgCurCfgPortTable=stgCurCfgPortTable, agPortNewCfgTableEntry=agPortNewCfgTableEntry, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, mirrOperMirroredPort=mirrOperMirroredPort, vlans=vlans, spannTreeGrpCfg=spannTreeGrpCfg, agPortCurCfgPortName=agPortCurCfgPortName, vlanCurCfgVlanId=vlanCurCfgVlanId, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, vlanNewCfgAddPort=vlanNewCfgAddPort, stgCurCfgIndex=stgCurCfgIndex, agPortCurCfgTableEntry=agPortCurCfgTableEntry, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portInfoTableEntry=portInfoTableEntry, portInfoFlowCtrl=portInfoFlowCtrl, vlanNewCfgDelete=vlanNewCfgDelete, portInfoIndx=portInfoIndx, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, mirrOperState=mirrOperState, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanCurCfgBwmContract=vlanCurCfgBwmContract, port_info=port_info, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, stgCurCfgPortIndex=stgCurCfgPortIndex, portInfoPhyIfMtu=portInfoPhyIfMtu, port_stats=port_stats, agPortNewCfgBackLink=agPortNewCfgBackLink, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, portStatsPhyIfInOctets=portStatsPhyIfInOctets, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, vlanCurCfgVlanName=vlanCurCfgVlanName, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, vlanNewCfgStg=vlanNewCfgStg, portInfoLink=portInfoLink, pmCurCfgTimeout=pmCurCfgTimeout, pmNewCfgTimeout=pmNewCfgTimeout, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, agPortCurCfgIndx=agPortCurCfgIndx, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, agPortConfig=agPortConfig, vlanNewCfgTable=vlanNewCfgTable, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgTable=stgNewCfgTable, agPortNewCfgPortName=agPortNewCfgPortName, agPortNewCfgPrefLink=agPortNewCfgPrefLink, agPortNewCfgBwmContract=agPortNewCfgBwmContract, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortCurCfgBwmContract=agPortCurCfgBwmContract, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, agPortCurCfgVlanTag=agPortCurCfgVlanTag, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, agPortCurCfgRmon=agPortCurCfgRmon, agPortNewCfgIndx=agPortNewCfgIndx, stgCurCfgStgIndex=stgCurCfgStgIndex, portInfoPhyIfType=portInfoPhyIfType, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, portInfoSpeed=portInfoSpeed, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mirrOperType=mirrOperType, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portStatsIndx=portStatsIndx, stgNewCfgTableEntry=stgNewCfgTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, mirrOperMonitoringPort=mirrOperMonitoringPort, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, agPortCurCfgPVID=agPortCurCfgPVID, portInfoPhyIfDescr=portInfoPhyIfDescr, portCpuStatsUtilTable=portCpuStatsUtilTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, agPortCurCfgBackLink=agPortCurCfgBackLink, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, mirrVlanMirr=mirrVlanMirr, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mirrPortMirr=mirrPortMirr, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgIndex=stgNewCfgIndex, portInfoPhyIfLastChange=portInfoPhyIfLastChange, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, vlanCurCfgJumbo=vlanCurCfgJumbo, pmNewCfgMirroredPort=pmNewCfgMirroredPort, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mirrOperTimeout=mirrOperTimeout, agPortCurCfgStp=agPortCurCfgStp, portCpuStatsUtilIndx=portCpuStatsUtilIndx, stgCurCfgState=stgCurCfgState, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, vlanCurCfgStg=vlanCurCfgStg, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, vlanCurCfgState=vlanCurCfgState, stgNewCfgPortState=stgNewCfgPortState, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portInfoTable=portInfoTable, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, agPortCurCfgTable=agPortCurCfgTable, portStatsTableEntry=portStatsTableEntry, portCpuStats=portCpuStats, mirrOper=mirrOper, stgCurCfgTableEntry=stgCurCfgTableEntry, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, agPortNewCfgPVID=agPortNewCfgPVID, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, stgNewCfgPortTable=stgNewCfgPortTable, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, portStatsTable=portStatsTable, pmCurCfgMirroredPort=pmCurCfgMirroredPort, agPortCurCfgPrefLink=agPortCurCfgPrefLink, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, stgCurCfgPortState=stgCurCfgPortState, agPortTableMaxEnt=agPortTableMaxEnt, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portmirroring=portmirroring, stgNewCfgAddVlan=stgNewCfgAddVlan, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, trunkGroupCurCfgTable=trunkGroupCurCfgTable, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, pmNewCfgState=pmNewCfgState, trunkGroupCurCfgState=trunkGroupCurCfgState, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, agPortCurCfgState=agPortCurCfgState, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, stgNewCfgState=stgNewCfgState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, agPortNewCfgStp=agPortNewCfgStp, vlanNewCfgVlanId=vlanNewCfgVlanId, agPortNewCfgVlanTag=agPortNewCfgVlanTag, pmCurCfgState=pmCurCfgState, portStatsPhyIfInErrors=portStatsPhyIfInErrors, stgNewCfgPortIndex=stgNewCfgPortIndex, portInfoMode=portInfoMode, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts)
