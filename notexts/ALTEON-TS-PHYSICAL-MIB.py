...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", pmNewCfgPortMirrState=pmNewCfgPortMirrState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgTable=stgNewCfgTable, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, portmirroring=portmirroring, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanNewCfgTable=vlanNewCfgTable, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, agPortCurCfgPortName=agPortCurCfgPortName, agPortNewCfgTable=agPortNewCfgTable, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, agPortCurCfgState=agPortCurCfgState, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgIndex=stgNewCfgIndex, agPortNewCfgState=agPortNewCfgState, stgCurCfgTableEntry=stgCurCfgTableEntry, portInfoFlowCtrl=portInfoFlowCtrl, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, mirrPortMirr=mirrPortMirr, portCpuStatsUtilIndx=portCpuStatsUtilIndx, vlanMaxEnt=vlanMaxEnt, vlanNewCfgState=vlanNewCfgState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgTableEntry=stgNewCfgTableEntry, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, agPortNewCfgPVID=agPortNewCfgPVID, stgCurCfgPortTable=stgCurCfgPortTable, stgCurCfgPortState=stgCurCfgPortState, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, portInfoLink=portInfoLink, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, port_info=port_info, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, pmNewCfgTimeout=pmNewCfgTimeout, agPortCurCfgPrefLink=agPortCurCfgPrefLink, portStatsTable=portStatsTable, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanCurCfgState=vlanCurCfgState, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanNewCfgStg=vlanNewCfgStg, agPortNewCfgRmon=agPortNewCfgRmon, trunkgroup=trunkgroup, pmCurCfgMirroredPort=pmCurCfgMirroredPort, vlanCurCfgJumbo=vlanCurCfgJumbo, trunkGroupCurCfgState=trunkGroupCurCfgState, portStatsTableEntry=portStatsTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, agPortNewCfgBwmContract=agPortNewCfgBwmContract, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, vlanNewCfgTableEntry=vlanNewCfgTableEntry, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, agPortCurCfgRmon=agPortCurCfgRmon, vlanNewCfgVlanName=vlanNewCfgVlanName, pmNewCfgMirroredPort=pmNewCfgMirroredPort, vlanCurCfgTable=vlanCurCfgTable, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, agPortCurCfgTableEntry=agPortCurCfgTableEntry, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, pmCurCfgState=pmCurCfgState, agPortNewCfgStp=agPortNewCfgStp, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, vlanCurCfgTableEntry=vlanCurCfgTableEntry, agPortCurCfgPVID=agPortCurCfgPVID, pmNewCfgState=pmNewCfgState, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portInfoPhyIfLastChange=portInfoPhyIfLastChange, trunkGroupCurCfgTable=trunkGroupCurCfgTable, spannTreeGrpCfg=spannTreeGrpCfg, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mirrOperMirroredPort=mirrOperMirroredPort, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, portStatsPhyIfInOctets=portStatsPhyIfInOctets, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmCurCfgTimeout=pmCurCfgTimeout, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, agPortNewCfgVlanTag=agPortNewCfgVlanTag, stgCurCfgTable=stgCurCfgTable, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, port_stats=port_stats, stgNewCfgPortIndex=stgNewCfgPortIndex, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanNewCfgJumbo=vlanNewCfgJumbo, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, vlanNewCfgBwmContract=vlanNewCfgBwmContract, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, agPortNewCfgIndx=agPortNewCfgIndx, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, agPortNewCfgTableEntry=agPortNewCfgTableEntry, portCpuStats=portCpuStats, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, stgNewCfgState=stgNewCfgState, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portInfoPhyIfDescr=portInfoPhyIfDescr, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, portInfoIndx=portInfoIndx, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, mirroring=mirroring, mirrOper=mirrOper, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, portInfoPhyIfMtu=portInfoPhyIfMtu, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mirrOperMonitoringPort=mirrOperMonitoringPort, portStatsPhyIfInErrors=portStatsPhyIfInErrors, agPortNewCfgPrefLink=agPortNewCfgPrefLink, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, agPortNewCfgPortName=agPortNewCfgPortName, vlanCurCfgPorts=vlanCurCfgPorts, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, vlanNewCfgPorts=vlanNewCfgPorts, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, stgNewCfgPortTable=stgNewCfgPortTable, agPortCurCfgVlanTag=agPortCurCfgVlanTag, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, agPortCurCfgStp=agPortCurCfgStp, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, portInfoSpeed=portInfoSpeed, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, agPortConfig=agPortConfig, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, agPortCurCfgIndx=agPortCurCfgIndx, agPortCurCfgBackLink=agPortCurCfgBackLink, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portInfoPhyIfType=portInfoPhyIfType, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, stgCurCfgState=stgCurCfgState, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanCurCfgStg=vlanCurCfgStg, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, portInfoTableEntry=portInfoTableEntry, vlanNewCfgAddPort=vlanNewCfgAddPort, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortNewCfgBackLink=agPortNewCfgBackLink, agPortCurCfgBwmContract=agPortCurCfgBwmContract, agPortCurCfgTable=agPortCurCfgTable, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, agPortTableMaxEnt=agPortTableMaxEnt, mirrOperState=mirrOperState, portInfoMode=portInfoMode, mirrOperTimeout=mirrOperTimeout, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, portCpuStatsUtilTable=portCpuStatsUtilTable, stgNewCfgPortState=stgNewCfgPortState, mirrOperType=mirrOperType, vlanNewCfgDelete=vlanNewCfgDelete, portInfoTable=portInfoTable, vlans=vlans, stgCurCfgPortIndex=stgCurCfgPortIndex, portStatsIndx=portStatsIndx, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, mirrVlanMirr=mirrVlanMirr)
