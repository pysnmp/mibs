...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, agPortNewCfgBwmContract=agPortNewCfgBwmContract, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, vlanCurCfgState=vlanCurCfgState, portInfoPhyIfType=portInfoPhyIfType, pmNewCfgState=pmNewCfgState, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, portCpuStatsUtilTable=portCpuStatsUtilTable, stgCurCfgIndex=stgCurCfgIndex, portInfoTableEntry=portInfoTableEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mirrPortMirr=mirrPortMirr, mirrVlanMirr=mirrVlanMirr, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, portInfoPhyIfMtu=portInfoPhyIfMtu, vlanMaxEnt=vlanMaxEnt, vlanNewCfgStg=vlanNewCfgStg, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgCurCfgPortTable=stgCurCfgPortTable, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, mirrOper=mirrOper, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, agPortNewCfgRmon=agPortNewCfgRmon, stgCurCfgTable=stgCurCfgTable, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, mirrOperType=mirrOperType, mirrOperMirroredPort=mirrOperMirroredPort, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portStatsPhyIfInErrors=portStatsPhyIfInErrors, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portInfoMode=portInfoMode, agPortCurCfgStp=agPortCurCfgStp, stgNewCfgTableEntry=stgNewCfgTableEntry, port_stats=port_stats, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, agPortCurCfgBackLink=agPortCurCfgBackLink, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanNewCfgBwmContract=vlanNewCfgBwmContract, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, agPortCurCfgRmon=agPortCurCfgRmon, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgState=stgNewCfgState, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanCurCfgTableEntry=vlanCurCfgTableEntry, agPortNewCfgPrefLink=agPortNewCfgPrefLink, stgNewCfgPortIndex=stgNewCfgPortIndex, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, portCpuStatsUtilIndx=portCpuStatsUtilIndx, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, vlanCurCfgTable=vlanCurCfgTable, portInfoTable=portInfoTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, agPortCurCfgVlanTag=agPortCurCfgVlanTag, stgCurCfgPortState=stgCurCfgPortState, agPortCurCfgIndx=agPortCurCfgIndx, agPortCurCfgTableEntry=agPortCurCfgTableEntry, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, mirrOperTimeout=mirrOperTimeout, agPortNewCfgBackLink=agPortNewCfgBackLink, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, pmCurCfgTimeout=pmCurCfgTimeout, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portInfoPhyIfDescr=portInfoPhyIfDescr, pmCurCfgMirroredPort=pmCurCfgMirroredPort, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, trunkgroup=trunkgroup, vlanNewCfgAddPort=vlanNewCfgAddPort, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, port_info=port_info, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, portmirroring=portmirroring, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, agPortCurCfgBwmContract=agPortCurCfgBwmContract, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, stgNewCfgPortTable=stgNewCfgPortTable, stgCurCfgPortIndex=stgCurCfgPortIndex, agPortCurCfgTable=agPortCurCfgTable, portStatsTableEntry=portStatsTableEntry, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgCurCfgTableEntry=stgCurCfgTableEntry, portInfoSpeed=portInfoSpeed, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupNewCfgState=trunkGroupNewCfgState, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, agPortConfig=agPortConfig, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, agPortNewCfgPVID=agPortNewCfgPVID, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, agPortCurCfgPortName=agPortCurCfgPortName, portStatsTable=portStatsTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, agPortNewCfgTableEntry=agPortNewCfgTableEntry, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portStatsIndx=portStatsIndx, stgNewCfgAddVlan=stgNewCfgAddVlan, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, vlanNewCfgDelete=vlanNewCfgDelete, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, vlans=vlans, pmNewCfgMirroredPort=pmNewCfgMirroredPort, agPortNewCfgPortName=agPortNewCfgPortName, mirroring=mirroring, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanNewCfgVlanId=vlanNewCfgVlanId, spannTreeGrpCfg=spannTreeGrpCfg, agPortCurCfgState=agPortCurCfgState, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, stgNewCfgPortState=stgNewCfgPortState, agPortNewCfgState=agPortNewCfgState, portCpuStats=portCpuStats, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, stgNewCfgStgIndex=stgNewCfgStgIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, mirrOperState=mirrOperState, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, portInfoIndx=portInfoIndx, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortNewCfgStp=agPortNewCfgStp, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, vlanCurCfgStg=vlanCurCfgStg, stgCurCfgState=stgCurCfgState, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portInfoFlowCtrl=portInfoFlowCtrl, portInfoLink=portInfoLink, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, portStatsPhyIfInOctets=portStatsPhyIfInOctets, pmCurCfgState=pmCurCfgState, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, agPortCurCfgPVID=agPortCurCfgPVID, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portInfoPhyIfLastChange=portInfoPhyIfLastChange, vlanCurCfgPorts=vlanCurCfgPorts, agPortNewCfgVlanTag=agPortNewCfgVlanTag, agPortCurCfgPrefLink=agPortCurCfgPrefLink, pmNewCfgTimeout=pmNewCfgTimeout, stgNewCfgTable=stgNewCfgTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, agPortNewCfgIndx=agPortNewCfgIndx, vlanNewCfgState=vlanNewCfgState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanNewCfgTable=vlanNewCfgTable, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, agPortNewCfgTable=agPortNewCfgTable, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, agPortTableMaxEnt=agPortTableMaxEnt, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, vlanNewCfgVlanName=vlanNewCfgVlanName, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen)
