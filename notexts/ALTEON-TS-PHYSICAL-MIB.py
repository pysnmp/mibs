...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", stgNewCfgPortTable=stgNewCfgPortTable, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, trunkgroup=trunkgroup, pmCurCfgState=pmCurCfgState, vlans=vlans, stgNewCfgAddVlan=stgNewCfgAddVlan, mirrPortMirr=mirrPortMirr, vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgStgIndex=stgNewCfgStgIndex, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanNewCfgStg=vlanNewCfgStg, portInfoMode=portInfoMode, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portStatsTable=portStatsTable, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, agPortCurCfgState=agPortCurCfgState, vlanNewCfgJumbo=vlanNewCfgJumbo, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, vlanNewCfgPorts=vlanNewCfgPorts, pmNewCfgTimeout=pmNewCfgTimeout, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanCurCfgJumbo=vlanCurCfgJumbo, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, trunkGroupNewCfgState=trunkGroupNewCfgState, agPortCurCfgIndx=agPortCurCfgIndx, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanMaxEnt=vlanMaxEnt, vlanNewCfgVlanId=vlanNewCfgVlanId, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portCpuStatsUtilTable=portCpuStatsUtilTable, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, port_stats=port_stats, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, agPortCurCfgPrefLink=agPortCurCfgPrefLink, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgPortTable=stgCurCfgPortTable, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, agPortNewCfgTableEntry=agPortNewCfgTableEntry, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgPortIndex=stgNewCfgPortIndex, mirrVlanMirr=mirrVlanMirr, portCpuStats=portCpuStats, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, agPortNewCfgTable=agPortNewCfgTable, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, mirrOperState=mirrOperState, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, agPortCurCfgStp=agPortCurCfgStp, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, vlanCurCfgStg=vlanCurCfgStg, pmNewCfgMirroredPort=pmNewCfgMirroredPort, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, agPortNewCfgRmon=agPortNewCfgRmon, agPortNewCfgState=agPortNewCfgState, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, pmCurCfgTimeout=pmCurCfgTimeout, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, agPortCurCfgRmon=agPortCurCfgRmon, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, portStatsPhyIfInErrors=portStatsPhyIfInErrors, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, vlanNewCfgAddPort=vlanNewCfgAddPort, mirrOperMirroredPort=mirrOperMirroredPort, stgCurCfgTableEntry=stgCurCfgTableEntry, portStatsPhyIfInOctets=portStatsPhyIfInOctets, agPortCurCfgTableEntry=agPortCurCfgTableEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portStatsIndx=portStatsIndx, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, stgNewCfgPortState=stgNewCfgPortState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, agPortCurCfgBackLink=agPortCurCfgBackLink, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, agPortNewCfgVlanTag=agPortNewCfgVlanTag, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, vlanNewCfgState=vlanNewCfgState, portInfoTable=portInfoTable, agPortCurCfgTable=agPortCurCfgTable, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, mirrOperMonitoringPort=mirrOperMonitoringPort, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgIndex=stgCurCfgIndex, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, agPortNewCfgPortName=agPortNewCfgPortName, portInfoSpeed=portInfoSpeed, agPortCurCfgPortName=agPortCurCfgPortName, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanCurCfgState=vlanCurCfgState, vlanCurCfgPorts=vlanCurCfgPorts, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, agPortNewCfgPVID=agPortNewCfgPVID, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, portInfoIndx=portInfoIndx, portInfoFlowCtrl=portInfoFlowCtrl, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, portInfoPhyIfDescr=portInfoPhyIfDescr, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, mirrOperTimeout=mirrOperTimeout, stgCurCfgPortIndex=stgCurCfgPortIndex, agPortCurCfgPVID=agPortCurCfgPVID, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, stgCurCfgState=stgCurCfgState, mirroring=mirroring, stgNewCfgIndex=stgNewCfgIndex, vlanNewCfgTable=vlanNewCfgTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, pmCurCfgMirroredPort=pmCurCfgMirroredPort, pmNewCfgState=pmNewCfgState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanCurCfgTable=vlanCurCfgTable, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, agPortNewCfgStp=agPortNewCfgStp, portInfoPhyIfMtu=portInfoPhyIfMtu, stgNewCfgTableEntry=stgNewCfgTableEntry, agPortCurCfgVlanTag=agPortCurCfgVlanTag, agPortCurCfgBwmContract=agPortCurCfgBwmContract, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, agPortNewCfgPrefLink=agPortNewCfgPrefLink, portCpuStatsUtilIndx=portCpuStatsUtilIndx, portInfoPhyIfLastChange=portInfoPhyIfLastChange, agPortConfig=agPortConfig, portInfoTableEntry=portInfoTableEntry, stgNewCfgState=stgNewCfgState, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, agPortTableMaxEnt=agPortTableMaxEnt, agPortNewCfgIndx=agPortNewCfgIndx, port_info=port_info, mirrOper=mirrOper, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, mirrOperType=mirrOperType, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, stgCurCfgTable=stgCurCfgTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, vlanCurCfgVlanId=vlanCurCfgVlanId, portInfoLink=portInfoLink, stgCurCfgPortState=stgCurCfgPortState, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, spannTreeGrpCfg=spannTreeGrpCfg, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, agPortNewCfgBwmContract=agPortNewCfgBwmContract, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portStatsTableEntry=portStatsTableEntry, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portmirroring=portmirroring, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, pmCurCfgPortMirrState=pmCurCfgPortMirrState, agPortNewCfgBackLink=agPortNewCfgBackLink, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portInfoPhyIfType=portInfoPhyIfType, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgNewCfgTable=stgNewCfgTable, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress)
