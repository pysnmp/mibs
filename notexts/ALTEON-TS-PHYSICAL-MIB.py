...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", agPortCurCfgPortName=agPortCurCfgPortName, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortCurCfgBwmContract=agPortCurCfgBwmContract, agPortCurCfgBackLink=agPortCurCfgBackLink, portCpuStatsUtilTable=portCpuStatsUtilTable, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, mirrOper=mirrOper, agPortCurCfgPrefLink=agPortCurCfgPrefLink, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, vlanNewCfgAddPort=vlanNewCfgAddPort, pmCurCfgTimeout=pmCurCfgTimeout, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, agPortCurCfgTableEntry=agPortCurCfgTableEntry, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, agPortNewCfgBackLink=agPortNewCfgBackLink, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgAddVlan=stgNewCfgAddVlan, stgCurCfgStgIndex=stgCurCfgStgIndex, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, pmCurCfgMirroredPort=pmCurCfgMirroredPort, port_stats=port_stats, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, spannTreeGrpCfg=spannTreeGrpCfg, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, portInfoPhyIfLastChange=portInfoPhyIfLastChange, stgCurCfgPortState=stgCurCfgPortState, pmNewCfgTimeout=pmNewCfgTimeout, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, vlanNewCfgState=vlanNewCfgState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, agPortNewCfgState=agPortNewCfgState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, agPortNewCfgStp=agPortNewCfgStp, portInfoLink=portInfoLink, portStatsTableEntry=portStatsTableEntry, vlanCurCfgJumbo=vlanCurCfgJumbo, mirrOperState=mirrOperState, portInfoMode=portInfoMode, portmirroring=portmirroring, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, vlanCurCfgVlanId=vlanCurCfgVlanId, agPortNewCfgIndx=agPortNewCfgIndx, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portStatsIndx=portStatsIndx, agPortNewCfgRmon=agPortNewCfgRmon, portStatsPhyIfInErrors=portStatsPhyIfInErrors, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, stgNewCfgPortState=stgNewCfgPortState, mirrPortMirr=mirrPortMirr, stgCurCfgPortTable=stgCurCfgPortTable, vlanCurCfgStg=vlanCurCfgStg, stgCurCfgPortIndex=stgCurCfgPortIndex, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, vlanCurCfgPorts=vlanCurCfgPorts, vlanNewCfgStg=vlanNewCfgStg, port_info=port_info, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, vlanNewCfgPorts=vlanNewCfgPorts, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, vlanNewCfgJumbo=vlanNewCfgJumbo, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanNewCfgDelete=vlanNewCfgDelete, portInfoIndx=portInfoIndx, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, agPortTableMaxEnt=agPortTableMaxEnt, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, stgNewCfgState=stgNewCfgState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgPortIndex=stgNewCfgPortIndex, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, stgNewCfgIndex=stgNewCfgIndex, portStatsTable=portStatsTable, agPortCurCfgIndx=agPortCurCfgIndx, agPortCurCfgPVID=agPortCurCfgPVID, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portInfoFlowCtrl=portInfoFlowCtrl, mirrOperMirroredPort=mirrOperMirroredPort, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, agPortNewCfgPortName=agPortNewCfgPortName, portCpuStatsUtilIndx=portCpuStatsUtilIndx, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mirrOperTimeout=mirrOperTimeout, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, portInfoTableEntry=portInfoTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, vlanMaxEnt=vlanMaxEnt, agPortCurCfgTable=agPortCurCfgTable, vlanCurCfgTable=vlanCurCfgTable, stgCurCfgIndex=stgCurCfgIndex, mirrOperType=mirrOperType, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, portInfoTable=portInfoTable, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, pmNewCfgMirroredPort=pmNewCfgMirroredPort, stgCurCfgState=stgCurCfgState, agPortNewCfgPrefLink=agPortNewCfgPrefLink, agPortNewCfgBwmContract=agPortNewCfgBwmContract, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, vlanNewCfgBwmContract=vlanNewCfgBwmContract, agPortCurCfgStp=agPortCurCfgStp, portInfoPhyIfType=portInfoPhyIfType, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, stgCurCfgTableEntry=stgCurCfgTableEntry, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portInfoPhyIfMtu=portInfoPhyIfMtu, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, trunkgroup=trunkgroup, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgCurCfgTable=stgCurCfgTable, portStatsPhyIfInOctets=portStatsPhyIfInOctets, agPortNewCfgTableEntry=agPortNewCfgTableEntry, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, mirrVlanMirr=mirrVlanMirr, vlanNewCfgTable=vlanNewCfgTable, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, vlans=vlans, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, vlanCurCfgState=vlanCurCfgState, vlanNewCfgVlanId=vlanNewCfgVlanId, agPortCurCfgState=agPortCurCfgState, stgNewCfgPortTable=stgNewCfgPortTable, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, pmNewCfgState=pmNewCfgState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgTable=stgNewCfgTable, portInfoSpeed=portInfoSpeed, agPortNewCfgPVID=agPortNewCfgPVID, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, mirroring=mirroring, vlanNewCfgTableEntry=vlanNewCfgTableEntry, agPortCurCfgVlanTag=agPortCurCfgVlanTag, portCpuStats=portCpuStats, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, agPortCurCfgRmon=agPortCurCfgRmon, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, agPortConfig=agPortConfig, agPortNewCfgVlanTag=agPortNewCfgVlanTag, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, stgNewCfgStgIndex=stgNewCfgStgIndex, pmCurCfgState=pmCurCfgState, agPortNewCfgTable=agPortNewCfgTable)
