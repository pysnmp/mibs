...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgPortTable=stgNewCfgPortTable, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, trunkGroupTableMaxSize=trunkGroupTableMaxSize, agPortCurCfgStp=agPortCurCfgStp, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, portCpuStatsUtilIndx=portCpuStatsUtilIndx, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgPortIndex=stgCurCfgPortIndex, mirroring=mirroring, agPortCurCfgPrefLink=agPortCurCfgPrefLink, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, mirrPortMirr=mirrPortMirr, portInfoPhyIfType=portInfoPhyIfType, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, agPortCurCfgState=agPortCurCfgState, mirrOperMirroredPort=mirrOperMirroredPort, agPortNewCfgTableEntry=agPortNewCfgTableEntry, vlanCurCfgTable=vlanCurCfgTable, agPortNewCfgStp=agPortNewCfgStp, stgNewCfgIndex=stgNewCfgIndex, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, agPortCurCfgIndx=agPortCurCfgIndx, portStatsPhyIfInErrors=portStatsPhyIfInErrors, port_stats=port_stats, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portStatsIndx=portStatsIndx, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, portCpuStatsUtilTable=portCpuStatsUtilTable, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, agPortCurCfgRmon=agPortCurCfgRmon, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmCurCfgState=pmCurCfgState, agPortCurCfgTable=agPortCurCfgTable, mirrOper=mirrOper, agPortCurCfgPVID=agPortCurCfgPVID, stgCurCfgTable=stgCurCfgTable, vlanCurCfgPorts=vlanCurCfgPorts, mirrOperType=mirrOperType, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, vlanCurCfgState=vlanCurCfgState, portInfoPhyIfLastChange=portInfoPhyIfLastChange, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, agPortCurCfgTableEntry=agPortCurCfgTableEntry, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, mirrOperMonitoringPort=mirrOperMonitoringPort, portInfoPhyIfMtu=portInfoPhyIfMtu, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, stgNewCfgPortIndex=stgNewCfgPortIndex, agPortCurCfgBackLink=agPortCurCfgBackLink, vlanNewCfgAddPort=vlanNewCfgAddPort, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, pmCurCfgMirroredPort=pmCurCfgMirroredPort, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortNewCfgState=agPortNewCfgState, portInfoIndx=portInfoIndx, agPortNewCfgIndx=agPortNewCfgIndx, pmNewCfgMirroredPort=pmNewCfgMirroredPort, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, trunkgroup=trunkgroup, vlanNewCfgStg=vlanNewCfgStg, agPortCurCfgBwmContract=agPortCurCfgBwmContract, stgNewCfgState=stgNewCfgState, mirrOperState=mirrOperState, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanNewCfgTable=vlanNewCfgTable, portStatsTable=portStatsTable, agPortTableMaxEnt=agPortTableMaxEnt, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portInfoTable=portInfoTable, vlanMaxEnt=vlanMaxEnt, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, trunkGroupCurCfgTable=trunkGroupCurCfgTable, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgCurCfgState=stgCurCfgState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgCurCfgPortTable=stgCurCfgPortTable, vlanCurCfgBwmContract=vlanCurCfgBwmContract, port_info=port_info, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgPortState=stgNewCfgPortState, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, stgCurCfgIndex=stgCurCfgIndex, portInfoSpeed=portInfoSpeed, portStatsTableEntry=portStatsTableEntry, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, mirrOperTimeout=mirrOperTimeout, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, stgNewCfgAddVlan=stgNewCfgAddVlan, vlans=vlans, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, agPortNewCfgBwmContract=agPortNewCfgBwmContract, stgCurCfgStgIndex=stgCurCfgStgIndex, agPortNewCfgPVID=agPortNewCfgPVID, stgNewCfgTable=stgNewCfgTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mirrVlanMirr=mirrVlanMirr, vlanNewCfgState=vlanNewCfgState, portInfoLink=portInfoLink, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmCurCfgTimeout=pmCurCfgTimeout, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, agPortNewCfgPrefLink=agPortNewCfgPrefLink, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmNewCfgTimeout=pmNewCfgTimeout, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, agPortNewCfgVlanTag=agPortNewCfgVlanTag, trunkGroupNewCfgTable=trunkGroupNewCfgTable, agPortNewCfgPortName=agPortNewCfgPortName, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, portInfoTableEntry=portInfoTableEntry, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, portCpuStats=portCpuStats, agPortNewCfgBackLink=agPortNewCfgBackLink, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, stgCurCfgPortState=stgCurCfgPortState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portStatsPhyIfInOctets=portStatsPhyIfInOctets, vlanNewCfgPorts=vlanNewCfgPorts, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portmirroring=portmirroring, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, agPortCurCfgPortName=agPortCurCfgPortName, stgCurCfgTableEntry=stgCurCfgTableEntry, agPortNewCfgTable=agPortNewCfgTable, pmNewCfgState=pmNewCfgState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, agPortCurCfgVlanTag=agPortCurCfgVlanTag, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, portInfoFlowCtrl=portInfoFlowCtrl, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, agPortConfig=agPortConfig, agPortNewCfgRmon=agPortNewCfgRmon, portInfoMode=portInfoMode, spannTreeGrpCfg=spannTreeGrpCfg, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg)
