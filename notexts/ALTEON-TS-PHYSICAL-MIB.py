...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", stgNewCfgAddVlan=stgNewCfgAddVlan, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, portInfoIndx=portInfoIndx, agPortNewCfgVlanTag=agPortNewCfgVlanTag, stgCurCfgPortState=stgCurCfgPortState, trunkGroupNewCfgState=trunkGroupNewCfgState, pmNewCfgMirroredPort=pmNewCfgMirroredPort, stgCurCfgPortTable=stgCurCfgPortTable, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, stgCurCfgState=stgCurCfgState, vlanCurCfgState=vlanCurCfgState, portCpuStatsUtilIndx=portCpuStatsUtilIndx, stgNewCfgIndex=stgNewCfgIndex, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, pmCurCfgTimeout=pmCurCfgTimeout, portInfoTable=portInfoTable, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, portInfoPhyIfMtu=portInfoPhyIfMtu, agPortTableMaxEnt=agPortTableMaxEnt, agPortConfig=agPortConfig, agPortCurCfgState=agPortCurCfgState, portInfoMode=portInfoMode, spannTreeGrpCfg=spannTreeGrpCfg, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, mirrOper=mirrOper, stgCurCfgPortIndex=stgCurCfgPortIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgTable=stgNewCfgTable, trunkgroup=trunkgroup, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, agPortCurCfgRmon=agPortCurCfgRmon, agPortCurCfgPortName=agPortCurCfgPortName, pmNewCfgPortMirrState=pmNewCfgPortMirrState, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, agPortNewCfgTableEntry=agPortNewCfgTableEntry, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, pmNewCfgTimeout=pmNewCfgTimeout, mirrOperState=mirrOperState, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portmirroring=portmirroring, vlanCurCfgStg=vlanCurCfgStg, agPortCurCfgTableEntry=agPortCurCfgTableEntry, portInfoFlowCtrl=portInfoFlowCtrl, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portStatsTable=portStatsTable, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portCpuStatsUtilTable=portCpuStatsUtilTable, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, vlanNewCfgPorts=vlanNewCfgPorts, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, portStatsPhyIfInOctets=portStatsPhyIfInOctets, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, vlanNewCfgBwmContract=vlanNewCfgBwmContract, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, agPortCurCfgPrefLink=agPortCurCfgPrefLink, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmNewCfgState=pmNewCfgState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portStatsPhyIfInErrors=portStatsPhyIfInErrors, portInfoPhyIfLastChange=portInfoPhyIfLastChange, stgNewCfgPortTable=stgNewCfgPortTable, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, vlanCurCfgJumbo=vlanCurCfgJumbo, agPortNewCfgRmon=agPortNewCfgRmon, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mirrVlanMirr=mirrVlanMirr, vlanNewCfgState=vlanNewCfgState, portInfoLink=portInfoLink, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, pmCurCfgState=pmCurCfgState, stgNewCfgState=stgNewCfgState, portStatsIndx=portStatsIndx, mirrOperMirroredPort=mirrOperMirroredPort, agPortCurCfgTable=agPortCurCfgTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mirrOperTimeout=mirrOperTimeout, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, portInfoTableEntry=portInfoTableEntry, vlanNewCfgStg=vlanNewCfgStg, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, port_stats=port_stats, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, agPortCurCfgPVID=agPortCurCfgPVID, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, portInfoSpeed=portInfoSpeed, agPortCurCfgBwmContract=agPortCurCfgBwmContract, stgCurCfgTableEntry=stgCurCfgTableEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, agPortNewCfgPVID=agPortNewCfgPVID, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portCpuStats=portCpuStats, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, agPortNewCfgState=agPortNewCfgState, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, agPortCurCfgStp=agPortCurCfgStp, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgPortState=stgNewCfgPortState, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, agPortCurCfgIndx=agPortCurCfgIndx, agPortNewCfgTable=agPortNewCfgTable, port_info=port_info, agPortNewCfgPortName=agPortNewCfgPortName, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, mirrPortMirr=mirrPortMirr, stgCurCfgIndex=stgCurCfgIndex, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgAddPort=vlanNewCfgAddPort, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, agPortCurCfgBackLink=agPortCurCfgBackLink, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, mirroring=mirroring, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, portStatsTableEntry=portStatsTableEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgStgIndex=stgNewCfgStgIndex, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, agPortNewCfgIndx=agPortNewCfgIndx, portInfoPhyIfType=portInfoPhyIfType, mirrOperMonitoringPort=mirrOperMonitoringPort, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, pmCurCfgMirroredPort=pmCurCfgMirroredPort, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, stgCurCfgStgIndex=stgCurCfgStgIndex, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, stgCurCfgTable=stgCurCfgTable, mirrOperType=mirrOperType, agPortNewCfgStp=agPortNewCfgStp, vlanNewCfgJumbo=vlanNewCfgJumbo, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanNewCfgVlanName=vlanNewCfgVlanName, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlans=vlans, vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanCurCfgTable=vlanCurCfgTable, vlanMaxEnt=vlanMaxEnt, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, agPortCurCfgVlanTag=agPortCurCfgVlanTag, agPortNewCfgPrefLink=agPortNewCfgPrefLink, vlanNewCfgDelete=vlanNewCfgDelete, agPortNewCfgBwmContract=agPortNewCfgBwmContract, agPortNewCfgBackLink=agPortNewCfgBackLink)
