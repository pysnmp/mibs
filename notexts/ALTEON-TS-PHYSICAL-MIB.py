...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", agPortNewCfgBackLink=agPortNewCfgBackLink, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortCurCfgPVID=agPortCurCfgPVID, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, stgCurCfgPortState=stgCurCfgPortState, vlanCurCfgState=vlanCurCfgState, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portInfoPhyIfDescr=portInfoPhyIfDescr, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgIndex=stgCurCfgIndex, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, trunkGroupCurCfgState=trunkGroupCurCfgState, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, spannTreeGrpCfg=spannTreeGrpCfg, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, mirrOper=mirrOper, agPortCurCfgIndx=agPortCurCfgIndx, stgNewCfgPortTable=stgNewCfgPortTable, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, agPortCurCfgTable=agPortCurCfgTable, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portStatsPhyIfInErrors=portStatsPhyIfInErrors, pmNewCfgState=pmNewCfgState, portStatsTableEntry=portStatsTableEntry, agPortNewCfgTableEntry=agPortNewCfgTableEntry, stgNewCfgState=stgNewCfgState, agPortNewCfgVlanTag=agPortNewCfgVlanTag, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, vlanNewCfgVlanName=vlanNewCfgVlanName, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, vlanCurCfgJumbo=vlanCurCfgJumbo, portInfoFlowCtrl=portInfoFlowCtrl, portCpuStatsUtilTable=portCpuStatsUtilTable, vlanNewCfgStg=vlanNewCfgStg, portInfoMode=portInfoMode, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, portInfoPhyIfLastChange=portInfoPhyIfLastChange, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgCurCfgPortTable=stgCurCfgPortTable, vlanNewCfgAddPort=vlanNewCfgAddPort, stgCurCfgState=stgCurCfgState, agPortCurCfgPortName=agPortCurCfgPortName, trunkGroupNewCfgTable=trunkGroupNewCfgTable, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanMaxEnt=vlanMaxEnt, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanNewCfgState=vlanNewCfgState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, agPortCurCfgPrefLink=agPortCurCfgPrefLink, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, agPortCurCfgState=agPortCurCfgState, agPortNewCfgTable=agPortNewCfgTable, stgNewCfgStgIndex=stgNewCfgStgIndex, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, agPortCurCfgBwmContract=agPortCurCfgBwmContract, agPortCurCfgVlanTag=agPortCurCfgVlanTag, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, port_info=port_info, agPortNewCfgPVID=agPortNewCfgPVID, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, portCpuStats=portCpuStats, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgPortIndex=stgNewCfgPortIndex, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mirrOperState=mirrOperState, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, portInfoPhyIfType=portInfoPhyIfType, stgNewCfgIndex=stgNewCfgIndex, mirrOperMonitoringPort=mirrOperMonitoringPort, mirrPortMirr=mirrPortMirr, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, agPortCurCfgStp=agPortCurCfgStp, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgNewCfgAddVlan=stgNewCfgAddVlan, mirroring=mirroring, stgCurCfgPortIndex=stgCurCfgPortIndex, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanNewCfgDelete=vlanNewCfgDelete, agPortNewCfgRmon=agPortNewCfgRmon, pmNewCfgMirroredPort=pmNewCfgMirroredPort, portInfoTableEntry=portInfoTableEntry, portmirroring=portmirroring, stgNewCfgTable=stgNewCfgTable, portInfoLink=portInfoLink, vlanNewCfgPorts=vlanNewCfgPorts, agPortNewCfgState=agPortNewCfgState, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, vlanNewCfgJumbo=vlanNewCfgJumbo, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, agPortCurCfgRmon=agPortCurCfgRmon, portInfoPhyIfMtu=portInfoPhyIfMtu, trunkGroupNewCfgState=trunkGroupNewCfgState, mirrOperType=mirrOperType, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, agPortCurCfgBackLink=agPortCurCfgBackLink, pmCurCfgMirroredPort=pmCurCfgMirroredPort, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgCurCfgStgIndex=stgCurCfgStgIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, agPortNewCfgPrefLink=agPortNewCfgPrefLink, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, agPortNewCfgIndx=agPortNewCfgIndx, port_stats=port_stats, agPortConfig=agPortConfig, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, agPortNewCfgBwmContract=agPortNewCfgBwmContract, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, agPortCurCfgTableEntry=agPortCurCfgTableEntry, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgPortState=stgNewCfgPortState, trunkgroup=trunkgroup, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, stgCurCfgTableEntry=stgCurCfgTableEntry, mirrOperMirroredPort=mirrOperMirroredPort, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, portStatsTable=portStatsTable, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgTable=stgCurCfgTable, agPortNewCfgPortName=agPortNewCfgPortName, portStatsIndx=portStatsIndx, portCpuStatsUtilIndx=portCpuStatsUtilIndx, pmCurCfgTimeout=pmCurCfgTimeout, portInfoTable=portInfoTable, portInfoIndx=portInfoIndx, vlans=vlans, vlanNewCfgTable=vlanNewCfgTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, agPortTableMaxEnt=agPortTableMaxEnt, mirrOperTimeout=mirrOperTimeout, portStatsPhyIfInOctets=portStatsPhyIfInOctets, vlanCurCfgTable=vlanCurCfgTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portInfoSpeed=portInfoSpeed, mirrVlanMirr=mirrVlanMirr, agPortNewCfgStp=agPortNewCfgStp, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmCurCfgState=pmCurCfgState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, pmNewCfgTimeout=pmNewCfgTimeout, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, vlanCurCfgStg=vlanCurCfgStg, trunkGroupTableMaxSize=trunkGroupTableMaxSize)
