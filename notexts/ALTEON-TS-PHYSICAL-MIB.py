...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", stgNewCfgIndex=stgNewCfgIndex, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, portStatsPhyIfInErrors=portStatsPhyIfInErrors, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, vlanNewCfgBwmContract=vlanNewCfgBwmContract, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, trunkGroupCurCfgState=trunkGroupCurCfgState, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, stgNewCfgAddVlan=stgNewCfgAddVlan, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, portInfoPhyIfType=portInfoPhyIfType, portStatsIndx=portStatsIndx, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, port_stats=port_stats, portCpuStatsUtilTable=portCpuStatsUtilTable, portmirroring=portmirroring, agPortNewCfgBackLink=agPortNewCfgBackLink, agPortNewCfgVlanTag=agPortNewCfgVlanTag, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, pmNewCfgTimeout=pmNewCfgTimeout, vlanNewCfgVlanId=vlanNewCfgVlanId, portCpuStatsUtilIndx=portCpuStatsUtilIndx, stgNewCfgStgIndex=stgNewCfgStgIndex, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, trunkGroupNewCfgState=trunkGroupNewCfgState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, trunkgroup=trunkgroup, vlanCurCfgVlanName=vlanCurCfgVlanName, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, mirroring=mirroring, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, portInfoFlowCtrl=portInfoFlowCtrl, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, agPortCurCfgBwmContract=agPortCurCfgBwmContract, mirrOperState=mirrOperState, vlanNewCfgVlanName=vlanNewCfgVlanName, mirrOperMirroredPort=mirrOperMirroredPort, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, portCpuStats=portCpuStats, vlanCurCfgTable=vlanCurCfgTable, mirrOperTimeout=mirrOperTimeout, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, vlanCurCfgBwmContract=vlanCurCfgBwmContract, agPortCurCfgPVID=agPortCurCfgPVID, vlanCurCfgJumbo=vlanCurCfgJumbo, portInfoPhyIfMtu=portInfoPhyIfMtu, agPortNewCfgIndx=agPortNewCfgIndx, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, portInfoMode=portInfoMode, agPortCurCfgBackLink=agPortCurCfgBackLink, stgNewCfgPortTable=stgNewCfgPortTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, agPortNewCfgTable=agPortNewCfgTable, stgCurCfgPortIndex=stgCurCfgPortIndex, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, agPortNewCfgPVID=agPortNewCfgPVID, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, vlanNewCfgState=vlanNewCfgState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanMaxEnt=vlanMaxEnt, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, agPortNewCfgRmon=agPortNewCfgRmon, vlanNewCfgStg=vlanNewCfgStg, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgPortState=stgCurCfgPortState, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmCurCfgMirroredPort=pmCurCfgMirroredPort, agPortNewCfgBwmContract=agPortNewCfgBwmContract, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanCurCfgState=vlanCurCfgState, stgCurCfgTableEntry=stgCurCfgTableEntry, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portStatsTableEntry=portStatsTableEntry, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, stgNewCfgTableEntry=stgNewCfgTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, mirrVlanMirr=mirrVlanMirr, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, vlans=vlans, vlanCurCfgVlanId=vlanCurCfgVlanId, stgCurCfgPortTable=stgCurCfgPortTable, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, agPortCurCfgPrefLink=agPortCurCfgPrefLink, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mirrPortMirr=mirrPortMirr, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, agPortTableMaxEnt=agPortTableMaxEnt, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, stgCurCfgState=stgCurCfgState, port_info=port_info, stgNewCfgState=stgNewCfgState, agPortCurCfgStp=agPortCurCfgStp, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, vlanNewCfgTable=vlanNewCfgTable, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, spannTreeGrpCfg=spannTreeGrpCfg, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, mirrOperType=mirrOperType, agPortNewCfgState=agPortNewCfgState, portInfoIndx=portInfoIndx, agPortNewCfgStp=agPortNewCfgStp, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, stgCurCfgTable=stgCurCfgTable, vlanNewCfgPorts=vlanNewCfgPorts, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, agPortCurCfgPortName=agPortCurCfgPortName, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, agPortCurCfgVlanTag=agPortCurCfgVlanTag, stgCurCfgStgIndex=stgCurCfgStgIndex, mirrOper=mirrOper, agPortNewCfgPortName=agPortNewCfgPortName, mirrOperMonitoringPort=mirrOperMonitoringPort, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortNewCfgTableEntry=agPortNewCfgTableEntry, portInfoSpeed=portInfoSpeed, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, agPortCurCfgIndx=agPortCurCfgIndx, stgNewCfgTable=stgNewCfgTable, pmNewCfgState=pmNewCfgState, portInfoTableEntry=portInfoTableEntry, agPortConfig=agPortConfig, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portInfoTable=portInfoTable, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, agPortCurCfgTable=agPortCurCfgTable, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, agPortNewCfgPrefLink=agPortNewCfgPrefLink, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, portStatsPhyIfInOctets=portStatsPhyIfInOctets, vlanCurCfgPorts=vlanCurCfgPorts, pmCurCfgTimeout=pmCurCfgTimeout, portInfoLink=portInfoLink, agPortCurCfgTableEntry=agPortCurCfgTableEntry, agPortCurCfgRmon=agPortCurCfgRmon, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgPortState=stgNewCfgPortState, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, agPortCurCfgState=agPortCurCfgState, vlanCurCfgStg=vlanCurCfgStg, portInfoPhyIfLastChange=portInfoPhyIfLastChange, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, vlanNewCfgJumbo=vlanNewCfgJumbo, portStatsTable=portStatsTable, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, pmNewCfgMirroredPort=pmNewCfgMirroredPort, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmCurCfgState=pmCurCfgState)
