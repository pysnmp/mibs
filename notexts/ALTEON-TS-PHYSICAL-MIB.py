...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgCurCfgTable=stgCurCfgTable, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portInfoPhyIfLastChange=portInfoPhyIfLastChange, agPortCurCfgBwmContract=agPortCurCfgBwmContract, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, portInfoPhyIfType=portInfoPhyIfType, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, vlanCurCfgVlanName=vlanCurCfgVlanName, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, mirrVlanMirr=mirrVlanMirr, agPortNewCfgState=agPortNewCfgState, portStatsIndx=portStatsIndx, pmCurCfgMirroredPort=pmCurCfgMirroredPort, agPortCurCfgTable=agPortCurCfgTable, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, pmNewCfgState=pmNewCfgState, agPortNewCfgRmon=agPortNewCfgRmon, agPortCurCfgIndx=agPortCurCfgIndx, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, agPortNewCfgBackLink=agPortNewCfgBackLink, portmirroring=portmirroring, stgCurCfgTableEntry=stgCurCfgTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, agPortNewCfgPortName=agPortNewCfgPortName, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgIndex=stgNewCfgIndex, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, agPortNewCfgStp=agPortNewCfgStp, spannTreeGrpCfg=spannTreeGrpCfg, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, agPortCurCfgVlanTag=agPortCurCfgVlanTag, vlanNewCfgStg=vlanNewCfgStg, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, port_stats=port_stats, stgCurCfgStgIndex=stgCurCfgStgIndex, portInfoMode=portInfoMode, stgNewCfgPortIndex=stgNewCfgPortIndex, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, mirrOperType=mirrOperType, agPortCurCfgRmon=agPortCurCfgRmon, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, portStatsPhyIfInOctets=portStatsPhyIfInOctets, mirrPortMirr=mirrPortMirr, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, vlanCurCfgVlanId=vlanCurCfgVlanId, agPortNewCfgPrefLink=agPortNewCfgPrefLink, agPortCurCfgStp=agPortCurCfgStp, agPortCurCfgTableEntry=agPortCurCfgTableEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, portInfoTableEntry=portInfoTableEntry, portInfoIndx=portInfoIndx, pmCurCfgState=pmCurCfgState, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mirrOper=mirrOper, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, agPortNewCfgTableEntry=agPortNewCfgTableEntry, agPortNewCfgBwmContract=agPortNewCfgBwmContract, mirrOperState=mirrOperState, stgNewCfgTableEntry=stgNewCfgTableEntry, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, agPortTableMaxEnt=agPortTableMaxEnt, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, portCpuStats=portCpuStats, stgCurCfgPortState=stgCurCfgPortState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanNewCfgDelete=vlanNewCfgDelete, portCpuStatsUtilTable=portCpuStatsUtilTable, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, agPortCurCfgBackLink=agPortCurCfgBackLink, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, mirrOperMirroredPort=mirrOperMirroredPort, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, agPortCurCfgPortName=agPortCurCfgPortName, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, mirrOperMonitoringPort=mirrOperMonitoringPort, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, mirrOperTimeout=mirrOperTimeout, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portInfoPhyIfDescr=portInfoPhyIfDescr, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanCurCfgTableEntry=vlanCurCfgTableEntry, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, vlanCurCfgStg=vlanCurCfgStg, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, portStatsTable=portStatsTable, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, portInfoFlowCtrl=portInfoFlowCtrl, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, stgNewCfgPortTable=stgNewCfgPortTable, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, agPortNewCfgTable=agPortNewCfgTable, vlanNewCfgState=vlanNewCfgState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portStatsTableEntry=portStatsTableEntry, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgIndex=stgCurCfgIndex, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, portInfoTable=portInfoTable, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, vlanCurCfgTable=vlanCurCfgTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, agPortNewCfgIndx=agPortNewCfgIndx, vlanNewCfgBwmContract=vlanNewCfgBwmContract, pmCurCfgTimeout=pmCurCfgTimeout, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmNewCfgTimeout=pmNewCfgTimeout, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmCurCfgPortMirrState=pmCurCfgPortMirrState, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanCurCfgJumbo=vlanCurCfgJumbo, agPortCurCfgState=agPortCurCfgState, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, agPortNewCfgPVID=agPortNewCfgPVID, portStatsPhyIfInErrors=portStatsPhyIfInErrors, stgCurCfgState=stgCurCfgState, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanNewCfgPorts=vlanNewCfgPorts, vlanNewCfgTable=vlanNewCfgTable, vlanCurCfgPorts=vlanCurCfgPorts, mirroring=mirroring, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, portInfoLink=portInfoLink, port_info=port_info, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, agPortConfig=agPortConfig, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, agPortCurCfgPrefLink=agPortCurCfgPrefLink, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, vlanMaxEnt=vlanMaxEnt, portCpuStatsUtilIndx=portCpuStatsUtilIndx, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgState=stgNewCfgState, vlans=vlans, vlanCurCfgState=vlanCurCfgState, agPortCurCfgPVID=agPortCurCfgPVID, stgCurCfgPortTable=stgCurCfgPortTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, agPortNewCfgVlanTag=agPortNewCfgVlanTag, pmNewCfgMirroredPort=pmNewCfgMirroredPort, portInfoPhyIfMtu=portInfoPhyIfMtu, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, stgNewCfgPortState=stgNewCfgPortState, trunkgroup=trunkgroup, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, vlanNewCfgVlanId=vlanNewCfgVlanId, portInfoSpeed=portInfoSpeed, stgNewCfgTable=stgNewCfgTable, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg)
