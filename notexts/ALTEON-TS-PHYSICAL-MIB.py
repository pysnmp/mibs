...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", stgNewCfgState=stgNewCfgState, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, pmNewCfgMirroredPort=pmNewCfgMirroredPort, pmCurCfgState=pmCurCfgState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mirrOperTimeout=mirrOperTimeout, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portStatsPhyIfInOctets=portStatsPhyIfInOctets, portInfoFlowCtrl=portInfoFlowCtrl, mirrOper=mirrOper, vlanCurCfgStg=vlanCurCfgStg, agPortCurCfgPVID=agPortCurCfgPVID, pmNewCfgState=pmNewCfgState, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanMaxEnt=vlanMaxEnt, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, stgNewCfgPortState=stgNewCfgPortState, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, portStatsPhyIfInErrors=portStatsPhyIfInErrors, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, portInfoPhyIfMtu=portInfoPhyIfMtu, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, agPortCurCfgTableEntry=agPortCurCfgTableEntry, pmCurCfgMirroredPort=pmCurCfgMirroredPort, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, mirrOperState=mirrOperState, pmNewCfgTimeout=pmNewCfgTimeout, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portCpuStatsUtilTable=portCpuStatsUtilTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, agPortNewCfgStp=agPortNewCfgStp, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanNewCfgStg=vlanNewCfgStg, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, stgCurCfgState=stgCurCfgState, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, agPortNewCfgBackLink=agPortNewCfgBackLink, vlanNewCfgJumbo=vlanNewCfgJumbo, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portInfoLink=portInfoLink, mirrOperMonitoringPort=mirrOperMonitoringPort, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgIndex=stgCurCfgIndex, agPortNewCfgIndx=agPortNewCfgIndx, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portCpuStats=portCpuStats, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, agPortCurCfgIndx=agPortCurCfgIndx, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, agPortCurCfgBackLink=agPortCurCfgBackLink, vlanCurCfgTable=vlanCurCfgTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portStatsIndx=portStatsIndx, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, agPortNewCfgTableEntry=agPortNewCfgTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, agPortNewCfgBwmContract=agPortNewCfgBwmContract, portStatsTable=portStatsTable, stgNewCfgPortTable=stgNewCfgPortTable, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, agPortTableMaxEnt=agPortTableMaxEnt, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanNewCfgDelete=vlanNewCfgDelete, portInfoIndx=portInfoIndx, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanCurCfgJumbo=vlanCurCfgJumbo, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, mirrPortMirr=mirrPortMirr, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, pmCurCfgTimeout=pmCurCfgTimeout, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, agPortNewCfgPrefLink=agPortNewCfgPrefLink, portmirroring=portmirroring, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, agPortCurCfgTable=agPortCurCfgTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, agPortConfig=agPortConfig, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgNewCfgTable=stgNewCfgTable, agPortNewCfgState=agPortNewCfgState, stgNewCfgTableEntry=stgNewCfgTableEntry, agPortCurCfgStp=agPortCurCfgStp, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, agPortNewCfgRmon=agPortNewCfgRmon, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, stgNewCfgStgIndex=stgNewCfgStgIndex, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, agPortCurCfgState=agPortCurCfgState, agPortNewCfgTable=agPortNewCfgTable, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, stgCurCfgTable=stgCurCfgTable, vlanNewCfgState=vlanNewCfgState, portStatsTableEntry=portStatsTableEntry, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, trunkGroupNewCfgState=trunkGroupNewCfgState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, portInfoSpeed=portInfoSpeed, mirrOperMirroredPort=mirrOperMirroredPort, stgCurCfgPortTable=stgCurCfgPortTable, stgCurCfgPortState=stgCurCfgPortState, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, mirrOperType=mirrOperType, portCpuStatsUtilIndx=portCpuStatsUtilIndx, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, mirrVlanMirr=mirrVlanMirr, spannTreeGrpCfg=spannTreeGrpCfg, stgCurCfgPortIndex=stgCurCfgPortIndex, portInfoPhyIfType=portInfoPhyIfType, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, port_info=port_info, portInfoPhyIfLastChange=portInfoPhyIfLastChange, agPortCurCfgPortName=agPortCurCfgPortName, vlanNewCfgTable=vlanNewCfgTable, agPortNewCfgVlanTag=agPortNewCfgVlanTag, agPortCurCfgRmon=agPortCurCfgRmon, vlanCurCfgState=vlanCurCfgState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, trunkgroup=trunkgroup, trunkGroupNewCfgTable=trunkGroupNewCfgTable, port_stats=port_stats, agPortCurCfgBwmContract=agPortCurCfgBwmContract, agPortNewCfgPortName=agPortNewCfgPortName, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portInfoMode=portInfoMode, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, agPortCurCfgVlanTag=agPortCurCfgVlanTag, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, vlanNewCfgTableEntry=vlanNewCfgTableEntry, agPortCurCfgPrefLink=agPortCurCfgPrefLink, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, vlans=vlans, portInfoTableEntry=portInfoTableEntry, vlanCurCfgPorts=vlanCurCfgPorts, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, stgNewCfgPortIndex=stgNewCfgPortIndex, mirroring=mirroring, stgNewCfgIndex=stgNewCfgIndex, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, agPortNewCfgPVID=agPortNewCfgPVID, portInfoTable=portInfoTable)
