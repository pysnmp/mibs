...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", mirrOperType=mirrOperType, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, stgNewCfgIndex=stgNewCfgIndex, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, stgNewCfgPortTable=stgNewCfgPortTable, pmNewCfgTimeout=pmNewCfgTimeout, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, agPortNewCfgTableEntry=agPortNewCfgTableEntry, portInfoPhyIfMtu=portInfoPhyIfMtu, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, agPortTableMaxEnt=agPortTableMaxEnt, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, pmCurCfgMirroredPort=pmCurCfgMirroredPort, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, trunkGroupCurCfgState=trunkGroupCurCfgState, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortNewCfgPrefLink=agPortNewCfgPrefLink, agPortCurCfgBackLink=agPortCurCfgBackLink, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, agPortConfig=agPortConfig, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, portInfoFlowCtrl=portInfoFlowCtrl, agPortCurCfgTable=agPortCurCfgTable, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, vlanNewCfgVlanId=vlanNewCfgVlanId, portInfoSpeed=portInfoSpeed, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, stgCurCfgPortState=stgCurCfgPortState, agPortCurCfgRmon=agPortCurCfgRmon, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanCurCfgTable=vlanCurCfgTable, stgNewCfgState=stgNewCfgState, agPortNewCfgRmon=agPortNewCfgRmon, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, stgNewCfgPortIndex=stgNewCfgPortIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, agPortCurCfgPVID=agPortCurCfgPVID, portInfoIndx=portInfoIndx, mirrPortMirr=mirrPortMirr, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, portInfoLink=portInfoLink, agPortNewCfgIndx=agPortNewCfgIndx, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, agPortNewCfgPortName=agPortNewCfgPortName, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, agPortCurCfgTableEntry=agPortCurCfgTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, portInfoMode=portInfoMode, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, stgNewCfgTableEntry=stgNewCfgTableEntry, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmCurCfgState=pmCurCfgState, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portStatsPhyIfInErrors=portStatsPhyIfInErrors, mirroring=mirroring, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, stgCurCfgState=stgCurCfgState, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, trunkGroupNewCfgTable=trunkGroupNewCfgTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mirrOperMonitoringPort=mirrOperMonitoringPort, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, agPortCurCfgVlanTag=agPortCurCfgVlanTag, agPortCurCfgStp=agPortCurCfgStp, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, mirrOperTimeout=mirrOperTimeout, vlanCurCfgVlanName=vlanCurCfgVlanName, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanNewCfgStg=vlanNewCfgStg, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, agPortNewCfgPVID=agPortNewCfgPVID, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, agPortNewCfgState=agPortNewCfgState, vlanMaxEnt=vlanMaxEnt, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, port_info=port_info, agPortNewCfgBackLink=agPortNewCfgBackLink, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, vlanNewCfgTable=vlanNewCfgTable, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanCurCfgJumbo=vlanCurCfgJumbo, vlans=vlans, pmCurCfgTimeout=pmCurCfgTimeout, trunkgroup=trunkgroup, vlanCurCfgVlanId=vlanCurCfgVlanId, portInfoPhyIfType=portInfoPhyIfType, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, vlanCurCfgState=vlanCurCfgState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mirrVlanMirr=mirrVlanMirr, mirrOperState=mirrOperState, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portCpuStatsUtilIndx=portCpuStatsUtilIndx, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portInfoTableEntry=portInfoTableEntry, portStatsTableEntry=portStatsTableEntry, pmNewCfgMirroredPort=pmNewCfgMirroredPort, portCpuStatsUtilTable=portCpuStatsUtilTable, stgCurCfgPortTable=stgCurCfgPortTable, stgNewCfgPortState=stgNewCfgPortState, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portmirroring=portmirroring, agPortNewCfgTable=agPortNewCfgTable, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, portStatsPhyIfInOctets=portStatsPhyIfInOctets, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mirrOperMirroredPort=mirrOperMirroredPort, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, trunkGroupTableMaxSize=trunkGroupTableMaxSize, agPortCurCfgState=agPortCurCfgState, portInfoPhyIfLastChange=portInfoPhyIfLastChange, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, vlanCurCfgStg=vlanCurCfgStg, mirrOper=mirrOper, agPortNewCfgStp=agPortNewCfgStp, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, stgCurCfgTable=stgCurCfgTable, agPortCurCfgBwmContract=agPortCurCfgBwmContract, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, port_stats=port_stats, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgState=pmNewCfgState, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, vlanNewCfgDelete=vlanNewCfgDelete, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, spannTreeGrpCfg=spannTreeGrpCfg, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, portStatsTable=portStatsTable, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortCurCfgPrefLink=agPortCurCfgPrefLink, vlanNewCfgState=vlanNewCfgState, agPortCurCfgPortName=agPortCurCfgPortName, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgTable=stgNewCfgTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, agPortCurCfgIndx=agPortCurCfgIndx, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanCurCfgPorts=vlanCurCfgPorts, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, portInfoPhyIfDescr=portInfoPhyIfDescr, stgCurCfgStgIndex=stgCurCfgStgIndex, portStatsIndx=portStatsIndx, stgCurCfgIndex=stgCurCfgIndex, portInfoTable=portInfoTable, agPortNewCfgVlanTag=agPortNewCfgVlanTag, vlanNewCfgPorts=vlanNewCfgPorts, agPortNewCfgBwmContract=agPortNewCfgBwmContract, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, vlanNewCfgJumbo=vlanNewCfgJumbo, portCpuStats=portCpuStats)
