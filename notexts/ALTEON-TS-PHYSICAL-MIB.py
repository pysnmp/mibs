...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", trunkGroupNewCfgState=trunkGroupNewCfgState, agPortNewCfgRmon=agPortNewCfgRmon, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, agPortNewCfgIndx=agPortNewCfgIndx, vlanCurCfgTableEntry=vlanCurCfgTableEntry, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, portInfoSpeed=portInfoSpeed, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, agPortCurCfgPrefLink=agPortCurCfgPrefLink, trunkGroupCurCfgState=trunkGroupCurCfgState, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, vlanCurCfgVlanId=vlanCurCfgVlanId, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortCurCfgVlanTag=agPortCurCfgVlanTag, portStatsPhyIfInOctets=portStatsPhyIfInOctets, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, vlanCurCfgPorts=vlanCurCfgPorts, portInfoPhyIfDescr=portInfoPhyIfDescr, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, agPortNewCfgBackLink=agPortNewCfgBackLink, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, spannTreeGrpCfg=spannTreeGrpCfg, portCpuStats=portCpuStats, mirrOperType=mirrOperType, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, port_stats=port_stats, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, pmCurCfgState=pmCurCfgState, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, agPortCurCfgTableEntry=agPortCurCfgTableEntry, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, agPortCurCfgIndx=agPortCurCfgIndx, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, mirrPortMirr=mirrPortMirr, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, portInfoPhyIfLastChange=portInfoPhyIfLastChange, agPortNewCfgBwmContract=agPortNewCfgBwmContract, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, port_info=port_info, portInfoLink=portInfoLink, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgTableEntry=stgCurCfgTableEntry, agPortNewCfgPVID=agPortNewCfgPVID, agPortCurCfgTable=agPortCurCfgTable, stgCurCfgStgIndex=stgCurCfgStgIndex, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, stgNewCfgPortTable=stgNewCfgPortTable, portStatsIndx=portStatsIndx, portInfoFlowCtrl=portInfoFlowCtrl, mirrOperMirroredPort=mirrOperMirroredPort, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, agPortTableMaxEnt=agPortTableMaxEnt, portInfoPhyIfMtu=portInfoPhyIfMtu, vlans=vlans, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanCurCfgTable=vlanCurCfgTable, mirroring=mirroring, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, pmCurCfgTimeout=pmCurCfgTimeout, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgPortTable=stgCurCfgPortTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, agPortCurCfgStp=agPortCurCfgStp, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, portmirroring=portmirroring, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mirrOper=mirrOper, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mirrVlanMirr=mirrVlanMirr, agPortNewCfgVlanTag=agPortNewCfgVlanTag, agPortNewCfgPrefLink=agPortNewCfgPrefLink, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, portInfoPhyIfType=portInfoPhyIfType, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanNewCfgTable=vlanNewCfgTable, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, vlanCurCfgState=vlanCurCfgState, stgCurCfgTable=stgCurCfgTable, agPortCurCfgPVID=agPortCurCfgPVID, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, agPortNewCfgStp=agPortNewCfgStp, portCpuStatsUtilIndx=portCpuStatsUtilIndx, vlanCurCfgStg=vlanCurCfgStg, portStatsTable=portStatsTable, agPortCurCfgPortName=agPortCurCfgPortName, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, agPortConfig=agPortConfig, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, agPortNewCfgTable=agPortNewCfgTable, pmNewCfgState=pmNewCfgState, stgNewCfgIndex=stgNewCfgIndex, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, mirrOperMonitoringPort=mirrOperMonitoringPort, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portInfoIndx=portInfoIndx, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, agPortNewCfgPortName=agPortNewCfgPortName, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanNewCfgJumbo=vlanNewCfgJumbo, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, stgNewCfgState=stgNewCfgState, agPortCurCfgBwmContract=agPortCurCfgBwmContract, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portInfoMode=portInfoMode, agPortCurCfgRmon=agPortCurCfgRmon, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanNewCfgState=vlanNewCfgState, portInfoTableEntry=portInfoTableEntry, agPortCurCfgState=agPortCurCfgState, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, vlanNewCfgDelete=vlanNewCfgDelete, agPortNewCfgTableEntry=agPortNewCfgTableEntry, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, stgCurCfgState=stgCurCfgState, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanNewCfgVlanName=vlanNewCfgVlanName, portStatsTableEntry=portStatsTableEntry, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, vlanNewCfgStg=vlanNewCfgStg, agPortNewCfgState=agPortNewCfgState, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanMaxEnt=vlanMaxEnt, stgNewCfgStgIndex=stgNewCfgStgIndex, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, portStatsPhyIfInErrors=portStatsPhyIfInErrors, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanNewCfgPorts=vlanNewCfgPorts, mirrOperState=mirrOperState, portInfoTable=portInfoTable, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, pmNewCfgMirroredPort=pmNewCfgMirroredPort, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkgroup=trunkgroup, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgPortState=stgNewCfgPortState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, pmCurCfgMirroredPort=pmCurCfgMirroredPort, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgTable=stgNewCfgTable, stgCurCfgPortState=stgCurCfgPortState, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, portCpuStatsUtilTable=portCpuStatsUtilTable, vlanNewCfgVlanId=vlanNewCfgVlanId, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, stgNewCfgPortIndex=stgNewCfgPortIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mirrOperTimeout=mirrOperTimeout, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, stgNewCfgAddVlan=stgNewCfgAddVlan, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, agPortCurCfgBackLink=agPortCurCfgBackLink, pmNewCfgTimeout=pmNewCfgTimeout, stgCurCfgIndex=stgCurCfgIndex, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second)
