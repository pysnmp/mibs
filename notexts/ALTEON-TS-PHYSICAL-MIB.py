...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", agPortCurCfgPVID=agPortCurCfgPVID, vlanCurCfgTable=vlanCurCfgTable, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portmirroring=portmirroring, agPortCurCfgTableEntry=agPortCurCfgTableEntry, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanCurCfgVlanName=vlanCurCfgVlanName, agPortCurCfgPrefLink=agPortCurCfgPrefLink, pmCurCfgState=pmCurCfgState, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, agPortCurCfgState=agPortCurCfgState, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, stgCurCfgPortTable=stgCurCfgPortTable, spannTreeGrpCfg=spannTreeGrpCfg, portStatsIndx=portStatsIndx, stgNewCfgPortState=stgNewCfgPortState, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, portInfoSpeed=portInfoSpeed, vlanCurCfgPorts=vlanCurCfgPorts, stgCurCfgIndex=stgCurCfgIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupNewCfgState=trunkGroupNewCfgState, agPortConfig=agPortConfig, portStatsPhyIfInOctets=portStatsPhyIfInOctets, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, agPortCurCfgBackLink=agPortCurCfgBackLink, mirrOper=mirrOper, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, port_stats=port_stats, stgNewCfgAddVlan=stgNewCfgAddVlan, agPortNewCfgRmon=agPortNewCfgRmon, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, trunkGroupCurCfgState=trunkGroupCurCfgState, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, agPortNewCfgStp=agPortNewCfgStp, stgNewCfgPortTable=stgNewCfgPortTable, mirrOperType=mirrOperType, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, vlanCurCfgStg=vlanCurCfgStg, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgTable=stgNewCfgTable, stgCurCfgPortState=stgCurCfgPortState, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, stgCurCfgState=stgCurCfgState, agPortCurCfgStp=agPortCurCfgStp, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmNewCfgMirroredPort=pmNewCfgMirroredPort, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portCpuStats=portCpuStats, agPortCurCfgBwmContract=agPortCurCfgBwmContract, pmCurCfgTimeout=pmCurCfgTimeout, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, agPortNewCfgPVID=agPortNewCfgPVID, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, agPortCurCfgIndx=agPortCurCfgIndx, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, mirrOperState=mirrOperState, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, vlans=vlans, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanNewCfgStg=vlanNewCfgStg, vlanCurCfgState=vlanCurCfgState, portCpuStatsUtilIndx=portCpuStatsUtilIndx, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portInfoPhyIfType=portInfoPhyIfType, agPortCurCfgVlanTag=agPortCurCfgVlanTag, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, stgNewCfgIndex=stgNewCfgIndex, port_info=port_info, vlanNewCfgPorts=vlanNewCfgPorts, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, stgCurCfgPortIndex=stgCurCfgPortIndex, portInfoLink=portInfoLink, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portStatsTableEntry=portStatsTableEntry, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, vlanNewCfgState=vlanNewCfgState, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, agPortNewCfgPrefLink=agPortNewCfgPrefLink, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgState=stgNewCfgState, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanCurCfgBwmContract=vlanCurCfgBwmContract, agPortCurCfgRmon=agPortCurCfgRmon, portCpuStatsUtilTable=portCpuStatsUtilTable, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, portInfoPhyIfMtu=portInfoPhyIfMtu, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, agPortTableMaxEnt=agPortTableMaxEnt, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, mirrOperTimeout=mirrOperTimeout, pmNewCfgState=pmNewCfgState, portInfoMode=portInfoMode, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, vlanCurCfgTableEntry=vlanCurCfgTableEntry, agPortNewCfgTable=agPortNewCfgTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanNewCfgVlanName=vlanNewCfgVlanName, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, stgCurCfgTable=stgCurCfgTable, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, portStatsTable=portStatsTable, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, vlanMaxEnt=vlanMaxEnt, agPortNewCfgState=agPortNewCfgState, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, trunkGroupTableMaxSize=trunkGroupTableMaxSize, agPortNewCfgBackLink=agPortNewCfgBackLink, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, mirrOperMonitoringPort=mirrOperMonitoringPort, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, agPortNewCfgIndx=agPortNewCfgIndx, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, agPortNewCfgVlanTag=agPortNewCfgVlanTag, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, portInfoIndx=portInfoIndx, vlanNewCfgDelete=vlanNewCfgDelete, mirrPortMirr=mirrPortMirr, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, trunkgroup=trunkgroup, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, trunkGroupCurCfgTable=trunkGroupCurCfgTable, agPortCurCfgTable=agPortCurCfgTable, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portStatsPhyIfInErrors=portStatsPhyIfInErrors, agPortNewCfgBwmContract=agPortNewCfgBwmContract, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, mirroring=mirroring, portInfoTable=portInfoTable, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, stgCurCfgTableEntry=stgCurCfgTableEntry, pmNewCfgTimeout=pmNewCfgTimeout, agPortCurCfgPortName=agPortCurCfgPortName, vlanCurCfgJumbo=vlanCurCfgJumbo, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanNewCfgVlanId=vlanNewCfgVlanId, portInfoTableEntry=portInfoTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, agPortNewCfgPortName=agPortNewCfgPortName, portInfoPhyIfDescr=portInfoPhyIfDescr, pmCurCfgMirroredPort=pmCurCfgMirroredPort, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portInfoFlowCtrl=portInfoFlowCtrl, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mirrOperMirroredPort=mirrOperMirroredPort, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, mirrVlanMirr=mirrVlanMirr, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, portInfoPhyIfLastChange=portInfoPhyIfLastChange, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, agPortNewCfgTableEntry=agPortNewCfgTableEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2)
