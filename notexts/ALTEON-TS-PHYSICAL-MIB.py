...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portCpuStats=portCpuStats, vlanMaxEnt=vlanMaxEnt, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, agPortNewCfgTableEntry=agPortNewCfgTableEntry, spannTreeGrpCfg=spannTreeGrpCfg, portInfoPhyIfDescr=portInfoPhyIfDescr, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgTable=stgNewCfgTable, trunkGroupCurCfgState=trunkGroupCurCfgState, portCpuStatsUtilIndx=portCpuStatsUtilIndx, stgCurCfgTableEntry=stgCurCfgTableEntry, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, mirrVlanMirr=mirrVlanMirr, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgStg=vlanNewCfgStg, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portInfoMode=portInfoMode, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, port_stats=port_stats, agPortNewCfgTable=agPortNewCfgTable, agPortCurCfgTable=agPortCurCfgTable, agPortCurCfgVlanTag=agPortCurCfgVlanTag, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, stgNewCfgPortState=stgNewCfgPortState, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, mirrOperMirroredPort=mirrOperMirroredPort, agPortCurCfgStp=agPortCurCfgStp, portInfoSpeed=portInfoSpeed, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, stgCurCfgPortTable=stgCurCfgPortTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortCurCfgRmon=agPortCurCfgRmon, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmNewCfgState=pmNewCfgState, agPortNewCfgBwmContract=agPortNewCfgBwmContract, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanNewCfgBwmContract=vlanNewCfgBwmContract, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanCurCfgJumbo=vlanCurCfgJumbo, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanCurCfgVlanName=vlanCurCfgVlanName, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portInfoTableEntry=portInfoTableEntry, portStatsPhyIfInOctets=portStatsPhyIfInOctets, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, vlanCurCfgStg=vlanCurCfgStg, stgNewCfgState=stgNewCfgState, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, agPortNewCfgStp=agPortNewCfgStp, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, agPortNewCfgPrefLink=agPortNewCfgPrefLink, vlanNewCfgVlanName=vlanNewCfgVlanName, portmirroring=portmirroring, vlanNewCfgTableEntry=vlanNewCfgTableEntry, agPortCurCfgPortName=agPortCurCfgPortName, agPortCurCfgIndx=agPortCurCfgIndx, pmCurCfgTimeout=pmCurCfgTimeout, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, port_info=port_info, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mirroring=mirroring, agPortCurCfgPVID=agPortCurCfgPVID, vlanNewCfgJumbo=vlanNewCfgJumbo, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, vlanCurCfgPorts=vlanCurCfgPorts, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, portInfoIndx=portInfoIndx, stgNewCfgTableEntry=stgNewCfgTableEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mirrPortMirr=mirrPortMirr, trunkgroup=trunkgroup, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, agPortNewCfgState=agPortNewCfgState, agPortNewCfgVlanTag=agPortNewCfgVlanTag, pmCurCfgState=pmCurCfgState, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portCpuStatsUtilTable=portCpuStatsUtilTable, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, portInfoPhyIfMtu=portInfoPhyIfMtu, mirrOperType=mirrOperType, vlanCurCfgState=vlanCurCfgState, agPortCurCfgPrefLink=agPortCurCfgPrefLink, mirrOperState=mirrOperState, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, agPortNewCfgBackLink=agPortNewCfgBackLink, stgCurCfgState=stgCurCfgState, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, stgCurCfgPortState=stgCurCfgPortState, portInfoFlowCtrl=portInfoFlowCtrl, agPortTableMaxEnt=agPortTableMaxEnt, portStatsPhyIfInErrors=portStatsPhyIfInErrors, agPortNewCfgPVID=agPortNewCfgPVID, agPortCurCfgBackLink=agPortCurCfgBackLink, agPortNewCfgRmon=agPortNewCfgRmon, portStatsTableEntry=portStatsTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, mirrOperTimeout=mirrOperTimeout, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portInfoTable=portInfoTable, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, vlanCurCfgTable=vlanCurCfgTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgStgIndex=stgNewCfgStgIndex, trunkGroupNewCfgTable=trunkGroupNewCfgTable, agPortConfig=agPortConfig, portInfoPhyIfLastChange=portInfoPhyIfLastChange, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, agPortCurCfgBwmContract=agPortCurCfgBwmContract, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, vlanNewCfgState=vlanNewCfgState, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmCurCfgPortMirrState=pmCurCfgPortMirrState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portStatsIndx=portStatsIndx, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, vlanNewCfgTable=vlanNewCfgTable, agPortCurCfgState=agPortCurCfgState, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, agPortCurCfgTableEntry=agPortCurCfgTableEntry, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, vlanNewCfgPorts=vlanNewCfgPorts, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, pmNewCfgMirroredPort=pmNewCfgMirroredPort, vlans=vlans, pmNewCfgTimeout=pmNewCfgTimeout, mirrOper=mirrOper, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, portInfoLink=portInfoLink, stgCurCfgTable=stgCurCfgTable, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, pmCurCfgMirroredPort=pmCurCfgMirroredPort, stgNewCfgPortTable=stgNewCfgPortTable, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, stgCurCfgIndex=stgCurCfgIndex, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgCurCfgPortIndex=stgCurCfgPortIndex, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, portInfoPhyIfType=portInfoPhyIfType, stgNewCfgIndex=stgNewCfgIndex, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, portStatsTable=portStatsTable, stgCurCfgStgIndex=stgCurCfgStgIndex, agPortNewCfgPortName=agPortNewCfgPortName, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, agPortNewCfgIndx=agPortNewCfgIndx)
