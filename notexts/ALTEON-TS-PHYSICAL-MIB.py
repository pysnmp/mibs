...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", stgCurCfgPortIndex=stgCurCfgPortIndex, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortCurCfgState=agPortCurCfgState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, agPortTableMaxEnt=agPortTableMaxEnt, vlanCurCfgState=vlanCurCfgState, vlanMaxEnt=vlanMaxEnt, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgAddVlan=stgNewCfgAddVlan, agPortCurCfgRmon=agPortCurCfgRmon, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgStgIndex=stgCurCfgStgIndex, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, vlanNewCfgVlanName=vlanNewCfgVlanName, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, portInfoMode=portInfoMode, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, portmirroring=portmirroring, vlanCurCfgTable=vlanCurCfgTable, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, agPortCurCfgBwmContract=agPortCurCfgBwmContract, pmCurCfgMirroredPort=pmCurCfgMirroredPort, pmNewCfgMirroredPort=pmNewCfgMirroredPort, stgCurCfgTableEntry=stgCurCfgTableEntry, agPortNewCfgTableEntry=agPortNewCfgTableEntry, agPortCurCfgPortName=agPortCurCfgPortName, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, mirrOperTimeout=mirrOperTimeout, stgNewCfgPortState=stgNewCfgPortState, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanCurCfgStg=vlanCurCfgStg, agPortNewCfgRmon=agPortNewCfgRmon, agPortCurCfgTableEntry=agPortCurCfgTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, portCpuStats=portCpuStats, vlanNewCfgVlanId=vlanNewCfgVlanId, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, stgNewCfgPortTable=stgNewCfgPortTable, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, stgCurCfgState=stgCurCfgState, agPortNewCfgPVID=agPortNewCfgPVID, vlanNewCfgAddPort=vlanNewCfgAddPort, pmNewCfgTimeout=pmNewCfgTimeout, stgCurCfgPortState=stgCurCfgPortState, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, vlanCurCfgVlanName=vlanCurCfgVlanName, mirroring=mirroring, mirrVlanMirr=mirrVlanMirr, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, pmCurCfgState=pmCurCfgState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portStatsTableEntry=portStatsTableEntry, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, agPortConfig=agPortConfig, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgState=stgNewCfgState, portInfoTableEntry=portInfoTableEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgTable=stgNewCfgTable, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, agPortNewCfgPrefLink=agPortNewCfgPrefLink, agPortNewCfgBwmContract=agPortNewCfgBwmContract, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, agPortCurCfgVlanTag=agPortCurCfgVlanTag, agPortNewCfgStp=agPortNewCfgStp, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portInfoFlowCtrl=portInfoFlowCtrl, agPortNewCfgVlanTag=agPortNewCfgVlanTag, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, stgCurCfgIndex=stgCurCfgIndex, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, port_info=port_info, vlanCurCfgPorts=vlanCurCfgPorts, mirrOperMirroredPort=mirrOperMirroredPort, mirrPortMirr=mirrPortMirr, agPortCurCfgPVID=agPortCurCfgPVID, mirrOper=mirrOper, trunkGroupNewCfgTable=trunkGroupNewCfgTable, agPortCurCfgPrefLink=agPortCurCfgPrefLink, pmCurCfgPortMirrState=pmCurCfgPortMirrState, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, portInfoTable=portInfoTable, trunkGroupNewCfgState=trunkGroupNewCfgState, portStatsPhyIfInErrors=portStatsPhyIfInErrors, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, port_stats=port_stats, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, vlanNewCfgState=vlanNewCfgState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portCpuStatsUtilTable=portCpuStatsUtilTable, agPortNewCfgBackLink=agPortNewCfgBackLink, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portInfoIndx=portInfoIndx, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, agPortNewCfgTable=agPortNewCfgTable, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanNewCfgDelete=vlanNewCfgDelete, portInfoPhyIfLastChange=portInfoPhyIfLastChange, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, agPortCurCfgBackLink=agPortCurCfgBackLink, portInfoSpeed=portInfoSpeed, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portStatsIndx=portStatsIndx, stgCurCfgTable=stgCurCfgTable, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, portStatsTable=portStatsTable, portInfoPhyIfDescr=portInfoPhyIfDescr, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgCurCfgPortTable=stgCurCfgPortTable, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, agPortNewCfgIndx=agPortNewCfgIndx, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, agPortCurCfgTable=agPortCurCfgTable, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portInfoLink=portInfoLink, mirrOperType=mirrOperType, vlanNewCfgTable=vlanNewCfgTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortCurCfgStp=agPortCurCfgStp, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, spannTreeGrpCfg=spannTreeGrpCfg, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, portStatsPhyIfInOctets=portStatsPhyIfInOctets, agPortNewCfgPortName=agPortNewCfgPortName, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, agPortNewCfgState=agPortNewCfgState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanNewCfgPorts=vlanNewCfgPorts, pmCurCfgTimeout=pmCurCfgTimeout, portCpuStatsUtilIndx=portCpuStatsUtilIndx, agPortCurCfgIndx=agPortCurCfgIndx, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, mirrOperState=mirrOperState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portInfoPhyIfMtu=portInfoPhyIfMtu, vlans=vlans, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, portInfoPhyIfType=portInfoPhyIfType, trunkgroup=trunkgroup, pmNewCfgState=pmNewCfgState)
