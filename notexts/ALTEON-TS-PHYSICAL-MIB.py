...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, vlanNewCfgState=vlanNewCfgState, vlanNewCfgAddPort=vlanNewCfgAddPort, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, pmNewCfgState=pmNewCfgState, mirrOperMirroredPort=mirrOperMirroredPort, portCpuStatsUtilIndx=portCpuStatsUtilIndx, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, stgNewCfgPortIndex=stgNewCfgPortIndex, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, port_stats=port_stats, portInfoLink=portInfoLink, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanCurCfgVlanId=vlanCurCfgVlanId, pmNewCfgPortMirrState=pmNewCfgPortMirrState, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, portCpuStatsUtilTable=portCpuStatsUtilTable, agPortCurCfgPrefLink=agPortCurCfgPrefLink, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, mirrOperType=mirrOperType, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, spannTreeGrpCfg=spannTreeGrpCfg, trunkgroup=trunkgroup, stgCurCfgStgIndex=stgCurCfgStgIndex, agPortCurCfgStp=agPortCurCfgStp, agPortNewCfgVlanTag=agPortNewCfgVlanTag, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, portInfoFlowCtrl=portInfoFlowCtrl, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, mirrPortMirr=mirrPortMirr, portInfoSpeed=portInfoSpeed, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, agPortNewCfgIndx=agPortNewCfgIndx, pmNewCfgTimeout=pmNewCfgTimeout, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanMaxEnt=vlanMaxEnt, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgState=stgNewCfgState, agPortNewCfgBwmContract=agPortNewCfgBwmContract, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCurCfgPortIndex=stgCurCfgPortIndex, stgCurCfgPortState=stgCurCfgPortState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, mirrOper=mirrOper, vlanNewCfgRemovePort=vlanNewCfgRemovePort, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, agPortNewCfgPortName=agPortNewCfgPortName, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portInfoIndx=portInfoIndx, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, portStatsTable=portStatsTable, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, vlanCurCfgState=vlanCurCfgState, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, agPortNewCfgStp=agPortNewCfgStp, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, vlanCurCfgTable=vlanCurCfgTable, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, agPortCurCfgBackLink=agPortCurCfgBackLink, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgNewCfgTable=stgNewCfgTable, agPortNewCfgBackLink=agPortNewCfgBackLink, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, stgCurCfgState=stgCurCfgState, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, vlanNewCfgTable=vlanNewCfgTable, agPortNewCfgTableEntry=agPortNewCfgTableEntry, agPortNewCfgRmon=agPortNewCfgRmon, pmCurCfgMirroredPort=pmCurCfgMirroredPort, agPortNewCfgState=agPortNewCfgState, vlanNewCfgPorts=vlanNewCfgPorts, portStatsTableEntry=portStatsTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, portInfoPhyIfLastChange=portInfoPhyIfLastChange, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgCurCfgPortTable=stgCurCfgPortTable, portInfoPhyIfMtu=portInfoPhyIfMtu, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, vlanNewCfgTableEntry=vlanNewCfgTableEntry, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, portStatsPhyIfInOctets=portStatsPhyIfInOctets, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, agPortCurCfgPortName=agPortCurCfgPortName, stgNewCfgIndex=stgNewCfgIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, portInfoPhyIfType=portInfoPhyIfType, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanCurCfgStg=vlanCurCfgStg, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portInfoMode=portInfoMode, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgTableEntry=stgNewCfgTableEntry, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, vlans=vlans, stgCurCfgTable=stgCurCfgTable, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, mirrVlanMirr=mirrVlanMirr, agPortNewCfgPVID=agPortNewCfgPVID, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, agPortConfig=agPortConfig, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, agPortCurCfgState=agPortCurCfgState, portStatsIndx=portStatsIndx, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, mirroring=mirroring, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mirrOperMonitoringPort=mirrOperMonitoringPort, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgStgIndex=stgNewCfgStgIndex, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, stgNewCfgAddVlan=stgNewCfgAddVlan, agPortCurCfgPVID=agPortCurCfgPVID, stgNewCfgPortState=stgNewCfgPortState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, trunkGroupCurCfgState=trunkGroupCurCfgState, mirrOperTimeout=mirrOperTimeout, pmCurCfgTimeout=pmCurCfgTimeout, vlanNewCfgVlanId=vlanNewCfgVlanId, portmirroring=portmirroring, portCpuStats=portCpuStats, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, agPortCurCfgBwmContract=agPortCurCfgBwmContract, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, vlanNewCfgVlanName=vlanNewCfgVlanName, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, portStatsPhyIfInErrors=portStatsPhyIfInErrors, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, agPortCurCfgTableEntry=agPortCurCfgTableEntry, agPortNewCfgTable=agPortNewCfgTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portInfoTable=portInfoTable, stgNewCfgPortTable=stgNewCfgPortTable, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, trunkGroupTableMaxSize=trunkGroupTableMaxSize, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, pmNewCfgMirroredPort=pmNewCfgMirroredPort, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, agPortCurCfgIndx=agPortCurCfgIndx, port_info=port_info, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgIndex=stgCurCfgIndex, mirrOperState=mirrOperState, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, pmCurCfgState=pmCurCfgState, agPortTableMaxEnt=agPortTableMaxEnt, agPortCurCfgTable=agPortCurCfgTable, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portInfoTableEntry=portInfoTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, trunkGroupCurCfgTable=trunkGroupCurCfgTable, agPortNewCfgPrefLink=agPortNewCfgPrefLink, agPortCurCfgRmon=agPortCurCfgRmon, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, agPortCurCfgVlanTag=agPortCurCfgVlanTag)
