...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, stgNewCfgTable=stgNewCfgTable, vlans=vlans, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, stgCurCfgIndex=stgCurCfgIndex, portCpuStatsUtilIndx=portCpuStatsUtilIndx, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portmirroring=portmirroring, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, agPortNewCfgIndx=agPortNewCfgIndx, mirrOperState=mirrOperState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mirrOperTimeout=mirrOperTimeout, agPortNewCfgState=agPortNewCfgState, vlanNewCfgAddPort=vlanNewCfgAddPort, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, portStatsPhyIfInErrors=portStatsPhyIfInErrors, stgCurCfgTable=stgCurCfgTable, agPortCurCfgPVID=agPortCurCfgPVID, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, agPortCurCfgBackLink=agPortCurCfgBackLink, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, mirrOperMirroredPort=mirrOperMirroredPort, stgCurCfgTableEntry=stgCurCfgTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, portInfoMode=portInfoMode, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, pmCurCfgMirroredPort=pmCurCfgMirroredPort, agPortTableMaxEnt=agPortTableMaxEnt, portStatsIndx=portStatsIndx, portInfoSpeed=portInfoSpeed, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, portStatsTable=portStatsTable, agPortCurCfgBwmContract=agPortCurCfgBwmContract, agPortCurCfgPortName=agPortCurCfgPortName, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, agPortNewCfgPrefLink=agPortNewCfgPrefLink, stgNewCfgTableEntry=stgNewCfgTableEntry, pmNewCfgTimeout=pmNewCfgTimeout, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmNewCfgState=pmNewCfgState, vlanCurCfgVlanName=vlanCurCfgVlanName, portInfoPhyIfType=portInfoPhyIfType, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortCurCfgVlanTag=agPortCurCfgVlanTag, agPortNewCfgVlanTag=agPortNewCfgVlanTag, portInfoPhyIfDescr=portInfoPhyIfDescr, vlanMaxEnt=vlanMaxEnt, stgNewCfgState=stgNewCfgState, stgCurCfgPortState=stgCurCfgPortState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, agPortNewCfgStp=agPortNewCfgStp, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, agPortNewCfgBackLink=agPortNewCfgBackLink, vlanCurCfgState=vlanCurCfgState, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgNewCfgIndex=stgNewCfgIndex, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, agPortNewCfgTableEntry=agPortNewCfgTableEntry, agPortCurCfgTableEntry=agPortCurCfgTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanNewCfgTable=vlanNewCfgTable, mirrOper=mirrOper, vlanCurCfgVlanId=vlanCurCfgVlanId, pmCurCfgTimeout=pmCurCfgTimeout, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, mirrVlanMirr=mirrVlanMirr, portInfoPhyIfMtu=portInfoPhyIfMtu, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, agPortNewCfgTable=agPortNewCfgTable, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanCurCfgPorts=vlanCurCfgPorts, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portStatsTableEntry=portStatsTableEntry, portInfoFlowCtrl=portInfoFlowCtrl, portInfoLink=portInfoLink, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortCurCfgRmon=agPortCurCfgRmon, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanCurCfgTableEntry=vlanCurCfgTableEntry, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, stgCurCfgPortTable=stgCurCfgPortTable, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, vlanCurCfgBwmContract=vlanCurCfgBwmContract, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, vlanCurCfgStg=vlanCurCfgStg, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, mirroring=mirroring, agPortCurCfgIndx=agPortCurCfgIndx, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanNewCfgVlanName=vlanNewCfgVlanName, agPortCurCfgTable=agPortCurCfgTable, agPortCurCfgState=agPortCurCfgState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, spannTreeGrpCfg=spannTreeGrpCfg, agPortNewCfgRmon=agPortNewCfgRmon, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanNewCfgPorts=vlanNewCfgPorts, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portStatsPhyIfInOctets=portStatsPhyIfInOctets, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, portInfoTableEntry=portInfoTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, trunkGroupNewCfgTable=trunkGroupNewCfgTable, port_stats=port_stats, vlanNewCfgState=vlanNewCfgState, vlanNewCfgDelete=vlanNewCfgDelete, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, agPortNewCfgPortName=agPortNewCfgPortName, vlanNewCfgStg=vlanNewCfgStg, trunkGroupCurCfgState=trunkGroupCurCfgState, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, pmCurCfgState=pmCurCfgState, vlanCurCfgTable=vlanCurCfgTable, port_info=port_info, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, agPortConfig=agPortConfig, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, portInfoPhyIfLastChange=portInfoPhyIfLastChange, mirrPortMirr=mirrPortMirr, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, trunkgroup=trunkgroup, agPortCurCfgStp=agPortCurCfgStp, pmNewCfgMirroredPort=pmNewCfgMirroredPort, stgCurCfgState=stgCurCfgState, stgNewCfgStgIndex=stgNewCfgStgIndex, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, agPortNewCfgBwmContract=agPortNewCfgBwmContract, stgNewCfgPortState=stgNewCfgPortState, portCpuStatsUtilTable=portCpuStatsUtilTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portInfoIndx=portInfoIndx, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, agPortNewCfgPVID=agPortNewCfgPVID, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, mirrOperType=mirrOperType, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, vlanCurCfgJumbo=vlanCurCfgJumbo, portInfoTable=portInfoTable, stgNewCfgPortTable=stgNewCfgPortTable, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, portCpuStats=portCpuStats, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, agPortCurCfgPrefLink=agPortCurCfgPrefLink)
