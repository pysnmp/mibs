...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, port_info=port_info, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, agPortCurCfgTableEntry=agPortCurCfgTableEntry, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, agPortNewCfgBackLink=agPortNewCfgBackLink, stgNewCfgAddVlan=stgNewCfgAddVlan, agPortCurCfgTable=agPortCurCfgTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanNewCfgState=vlanNewCfgState, agPortCurCfgPrefLink=agPortCurCfgPrefLink, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mirrOper=mirrOper, pmNewCfgMirroredPort=pmNewCfgMirroredPort, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, agPortCurCfgIndx=agPortCurCfgIndx, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, agPortNewCfgTableEntry=agPortNewCfgTableEntry, stgCurCfgTable=stgCurCfgTable, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portStatsTableEntry=portStatsTableEntry, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portInfoPhyIfLastChange=portInfoPhyIfLastChange, agPortCurCfgBackLink=agPortCurCfgBackLink, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, pmCurCfgState=pmCurCfgState, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgIndex=stgCurCfgIndex, portCpuStatsUtilTable=portCpuStatsUtilTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgCurCfgState=stgCurCfgState, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, agPortNewCfgStp=agPortNewCfgStp, portInfoTable=portInfoTable, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, agPortNewCfgTable=agPortNewCfgTable, vlanNewCfgPorts=vlanNewCfgPorts, vlanNewCfgTable=vlanNewCfgTable, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, agPortCurCfgVlanTag=agPortCurCfgVlanTag, agPortCurCfgRmon=agPortCurCfgRmon, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, portInfoPhyIfType=portInfoPhyIfType, vlanMaxEnt=vlanMaxEnt, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmCurCfgTimeout=pmCurCfgTimeout, mirrOperType=mirrOperType, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portInfoMode=portInfoMode, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, portmirroring=portmirroring, mirroring=mirroring, agPortCurCfgBwmContract=agPortCurCfgBwmContract, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, agPortNewCfgVlanTag=agPortNewCfgVlanTag, portStatsPhyIfInErrors=portStatsPhyIfInErrors, vlanCurCfgVlanId=vlanCurCfgVlanId, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, pmCurCfgMirroredPort=pmCurCfgMirroredPort, pmCurCfgPortMirrState=pmCurCfgPortMirrState, trunkGroupNewCfgState=trunkGroupNewCfgState, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCurCfgPortState=stgCurCfgPortState, vlanCurCfgJumbo=vlanCurCfgJumbo, portInfoPhyIfMtu=portInfoPhyIfMtu, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, vlans=vlans, portStatsTable=portStatsTable, vlanCurCfgState=vlanCurCfgState, stgNewCfgPortTable=stgNewCfgPortTable, trunkgroup=trunkgroup, agPortNewCfgState=agPortNewCfgState, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, portInfoIndx=portInfoIndx, vlanCurCfgTable=vlanCurCfgTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, portStatsPhyIfInOctets=portStatsPhyIfInOctets, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgIndex=stgNewCfgIndex, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgPortState=stgNewCfgPortState, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, mirrVlanMirr=mirrVlanMirr, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCurCfgPortTable=stgCurCfgPortTable, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, agPortCurCfgPVID=agPortCurCfgPVID, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmNewCfgState=pmNewCfgState, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, agPortNewCfgBwmContract=agPortNewCfgBwmContract, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortCurCfgStp=agPortCurCfgStp, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portInfoLink=portInfoLink, stgNewCfgState=stgNewCfgState, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortNewCfgIndx=agPortNewCfgIndx, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, portCpuStatsUtilIndx=portCpuStatsUtilIndx, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanNewCfgStg=vlanNewCfgStg, portStatsIndx=portStatsIndx, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, port_stats=port_stats, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, portInfoSpeed=portInfoSpeed, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, mirrOperMirroredPort=mirrOperMirroredPort, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, agPortCurCfgState=agPortCurCfgState, vlanCurCfgStg=vlanCurCfgStg, agPortTableMaxEnt=agPortTableMaxEnt, agPortNewCfgPortName=agPortNewCfgPortName, agPortCurCfgPortName=agPortCurCfgPortName, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, agPortNewCfgPrefLink=agPortNewCfgPrefLink, agPortNewCfgPVID=agPortNewCfgPVID, portInfoFlowCtrl=portInfoFlowCtrl, trunkGroupCurCfgTable=trunkGroupCurCfgTable, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, mirrOperState=mirrOperState, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, agPortNewCfgRmon=agPortNewCfgRmon, agPortConfig=agPortConfig, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portInfoTableEntry=portInfoTableEntry, portCpuStats=portCpuStats, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, mirrPortMirr=mirrPortMirr, pmNewCfgTimeout=pmNewCfgTimeout, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, trunkGroupCurCfgState=trunkGroupCurCfgState, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, stgCurCfgTableEntry=stgCurCfgTableEntry, spannTreeGrpCfg=spannTreeGrpCfg, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, vlanNewCfgJumbo=vlanNewCfgJumbo, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, stgNewCfgTable=stgNewCfgTable, mirrOperTimeout=mirrOperTimeout, vlanNewCfgAddPort=vlanNewCfgAddPort, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete)
