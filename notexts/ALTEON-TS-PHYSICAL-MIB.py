...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", stgCurCfgTable=stgCurCfgTable, agPortNewCfgBackLink=agPortNewCfgBackLink, portInfoPhyIfLastChange=portInfoPhyIfLastChange, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, portStatsIndx=portStatsIndx, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, trunkgroup=trunkgroup, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, vlanCurCfgState=vlanCurCfgState, agPortTableMaxEnt=agPortTableMaxEnt, stgNewCfgIndex=stgNewCfgIndex, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, portmirroring=portmirroring, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, trunkGroupCurCfgState=trunkGroupCurCfgState, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortConfig=agPortConfig, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, agPortCurCfgPortName=agPortCurCfgPortName, vlanNewCfgVlanName=vlanNewCfgVlanName, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgStgIndex=stgCurCfgStgIndex, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, stgNewCfgTable=stgNewCfgTable, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, stgNewCfgState=stgNewCfgState, portInfoMode=portInfoMode, vlanNewCfgJumbo=vlanNewCfgJumbo, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanCurCfgStg=vlanCurCfgStg, portStatsTableEntry=portStatsTableEntry, stgCurCfgTableEntry=stgCurCfgTableEntry, mirrOperMirroredPort=mirrOperMirroredPort, pmNewCfgState=pmNewCfgState, vlanCurCfgPorts=vlanCurCfgPorts, agPortNewCfgState=agPortNewCfgState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portStatsPhyIfInOctets=portStatsPhyIfInOctets, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, agPortNewCfgBwmContract=agPortNewCfgBwmContract, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, agPortNewCfgTableEntry=agPortNewCfgTableEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanMaxEnt=vlanMaxEnt, stgCurCfgPortState=stgCurCfgPortState, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, agPortNewCfgPVID=agPortNewCfgPVID, portInfoSpeed=portInfoSpeed, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, agPortNewCfgPrefLink=agPortNewCfgPrefLink, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, vlanNewCfgRemovePort=vlanNewCfgRemovePort, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmCurCfgMirroredPort=pmCurCfgMirroredPort, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, portCpuStats=portCpuStats, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, pmCurCfgState=pmCurCfgState, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, stgCurCfgPortIndex=stgCurCfgPortIndex, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, agPortCurCfgStp=agPortCurCfgStp, vlanCurCfgVlanId=vlanCurCfgVlanId, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, portInfoFlowCtrl=portInfoFlowCtrl, portStatsPhyIfInErrors=portStatsPhyIfInErrors, portCpuStatsUtilTable=portCpuStatsUtilTable, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanNewCfgState=vlanNewCfgState, mirrOperType=mirrOperType, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mirroring=mirroring, agPortCurCfgVlanTag=agPortCurCfgVlanTag, portStatsTable=portStatsTable, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, mirrVlanMirr=mirrVlanMirr, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, agPortNewCfgIndx=agPortNewCfgIndx, vlanCurCfgJumbo=vlanCurCfgJumbo, spannTreeGrpCfg=spannTreeGrpCfg, portCpuStatsUtilIndx=portCpuStatsUtilIndx, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, portInfoPhyIfMtu=portInfoPhyIfMtu, agPortCurCfgPrefLink=agPortCurCfgPrefLink, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgCurCfgState=stgCurCfgState, vlanNewCfgPorts=vlanNewCfgPorts, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, portInfoTableEntry=portInfoTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, port_info=port_info, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, portInfoLink=portInfoLink, portInfoPhyIfType=portInfoPhyIfType, agPortCurCfgTableEntry=agPortCurCfgTableEntry, mirrOperState=mirrOperState, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, trunkGroupNewCfgState=trunkGroupNewCfgState, agPortNewCfgTable=agPortNewCfgTable, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mirrOperTimeout=mirrOperTimeout, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanCurCfgTable=vlanCurCfgTable, mirrPortMirr=mirrPortMirr, agPortNewCfgVlanTag=agPortNewCfgVlanTag, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, agPortCurCfgState=agPortCurCfgState, vlanNewCfgVlanId=vlanNewCfgVlanId, portInfoIndx=portInfoIndx, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, stgCurCfgIndex=stgCurCfgIndex, stgCurCfgPortTable=stgCurCfgPortTable, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, agPortCurCfgTable=agPortCurCfgTable, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portInfoPhyIfDescr=portInfoPhyIfDescr, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, agPortNewCfgPortName=agPortNewCfgPortName, stgNewCfgStgIndex=stgNewCfgStgIndex, agPortCurCfgIndx=agPortCurCfgIndx, agPortCurCfgRmon=agPortCurCfgRmon, stgNewCfgPortIndex=stgNewCfgPortIndex, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, vlanCurCfgVlanName=vlanCurCfgVlanName, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, pmNewCfgMirroredPort=pmNewCfgMirroredPort, stgNewCfgPortTable=stgNewCfgPortTable, vlanNewCfgAddPort=vlanNewCfgAddPort, pmNewCfgTimeout=pmNewCfgTimeout, vlanNewCfgTable=vlanNewCfgTable, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, agPortCurCfgPVID=agPortCurCfgPVID, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlans=vlans, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, stgNewCfgAddVlan=stgNewCfgAddVlan, agPortCurCfgBwmContract=agPortCurCfgBwmContract, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, mirrOper=mirrOper, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, agPortNewCfgStp=agPortNewCfgStp, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmCurCfgTimeout=pmCurCfgTimeout, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgNewCfgPortState=stgNewCfgPortState, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portInfoTable=portInfoTable, port_stats=port_stats, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, agPortCurCfgBackLink=agPortCurCfgBackLink, agPortNewCfgRmon=agPortNewCfgRmon)
