...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", vlanNewCfgTableEntry=vlanNewCfgTableEntry, portInfoPhyIfType=portInfoPhyIfType, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, stgCurCfgState=stgCurCfgState, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, mirrOperType=mirrOperType, portStatsTable=portStatsTable, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, portStatsTableEntry=portStatsTableEntry, portInfoPhyIfMtu=portInfoPhyIfMtu, portInfoLink=portInfoLink, agPortNewCfgState=agPortNewCfgState, portCpuStatsUtilTable=portCpuStatsUtilTable, pmNewCfgMirroredPort=pmNewCfgMirroredPort, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portInfoPhyIfLastChange=portInfoPhyIfLastChange, stgCurCfgPortState=stgCurCfgPortState, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanNewCfgState=vlanNewCfgState, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, trunkgroup=trunkgroup, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, agPortCurCfgBackLink=agPortCurCfgBackLink, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgNewCfgIndex=stgNewCfgIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, agPortCurCfgRmon=agPortCurCfgRmon, vlans=vlans, agPortCurCfgPortName=agPortCurCfgPortName, agPortCurCfgPVID=agPortCurCfgPVID, vlanCurCfgVlanId=vlanCurCfgVlanId, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, stgNewCfgTableEntry=stgNewCfgTableEntry, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, portInfoTableEntry=portInfoTableEntry, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, agPortTableMaxEnt=agPortTableMaxEnt, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, agPortNewCfgBackLink=agPortNewCfgBackLink, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, portStatsPhyIfInErrors=portStatsPhyIfInErrors, mirrOperTimeout=mirrOperTimeout, trunkGroupCurCfgState=trunkGroupCurCfgState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgStg=vlanNewCfgStg, mirrPortMirr=mirrPortMirr, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgPortTable=stgCurCfgPortTable, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, pmCurCfgPortMirrState=pmCurCfgPortMirrState, agPortCurCfgTableEntry=agPortCurCfgTableEntry, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, portInfoPhyIfDescr=portInfoPhyIfDescr, stgNewCfgAddVlan=stgNewCfgAddVlan, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, trunkGroupNewCfgState=trunkGroupNewCfgState, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, mirroring=mirroring, vlanMaxEnt=vlanMaxEnt, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, vlanCurCfgTable=vlanCurCfgTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, agPortNewCfgVlanTag=agPortNewCfgVlanTag, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portCpuStats=portCpuStats, agPortNewCfgPortName=agPortNewCfgPortName, pmNewCfgTimeout=pmNewCfgTimeout, portInfoTable=portInfoTable, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, portInfoIndx=portInfoIndx, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portInfoFlowCtrl=portInfoFlowCtrl, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgTable=stgCurCfgTable, stgNewCfgState=stgNewCfgState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, portInfoSpeed=portInfoSpeed, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, agPortCurCfgBwmContract=agPortCurCfgBwmContract, agPortCurCfgPrefLink=agPortCurCfgPrefLink, portStatsIndx=portStatsIndx, stgNewCfgPortIndex=stgNewCfgPortIndex, agPortCurCfgIndx=agPortCurCfgIndx, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mirrOperMonitoringPort=mirrOperMonitoringPort, stgNewCfgPortTable=stgNewCfgPortTable, mirrOper=mirrOper, port_stats=port_stats, agPortCurCfgState=agPortCurCfgState, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, pmCurCfgMirroredPort=pmCurCfgMirroredPort, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, vlanCurCfgPorts=vlanCurCfgPorts, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, agPortNewCfgStp=agPortNewCfgStp, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, agPortNewCfgIndx=agPortNewCfgIndx, vlanNewCfgAddPort=vlanNewCfgAddPort, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, mirrOperMirroredPort=mirrOperMirroredPort, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, vlanNewCfgPorts=vlanNewCfgPorts, agPortNewCfgBwmContract=agPortNewCfgBwmContract, stgNewCfgTable=stgNewCfgTable, spannTreeGrpCfg=spannTreeGrpCfg, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, portCpuStatsUtilIndx=portCpuStatsUtilIndx, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, stgNewCfgStgIndex=stgNewCfgStgIndex, agPortNewCfgRmon=agPortNewCfgRmon, agPortNewCfgPrefLink=agPortNewCfgPrefLink, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, agPortCurCfgTable=agPortCurCfgTable, stgNewCfgPortState=stgNewCfgPortState, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, portInfoMode=portInfoMode, agPortCurCfgVlanTag=agPortCurCfgVlanTag, portStatsPhyIfInOctets=portStatsPhyIfInOctets, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgIndex=stgCurCfgIndex, agPortNewCfgTable=agPortNewCfgTable, port_info=port_info, pmNewCfgState=pmNewCfgState, mirrOperState=mirrOperState, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, pmCurCfgTimeout=pmCurCfgTimeout, vlanCurCfgState=vlanCurCfgState, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, stgCurCfgTableEntry=stgCurCfgTableEntry, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, agPortCurCfgStp=agPortCurCfgStp, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, vlanNewCfgTable=vlanNewCfgTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, agPortConfig=agPortConfig, agPortNewCfgTableEntry=agPortNewCfgTableEntry, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgCurCfgStgIndex=stgCurCfgStgIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, mirrVlanMirr=mirrVlanMirr, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, pmCurCfgState=pmCurCfgState, portmirroring=portmirroring, agPortNewCfgPVID=agPortNewCfgPVID)
