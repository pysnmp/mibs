...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", agPortCurCfgState=agPortCurCfgState, stgCurCfgPortIndex=stgCurCfgPortIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, mirrOperMonitoringPort=mirrOperMonitoringPort, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, stgCurCfgTable=stgCurCfgTable, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, agPortNewCfgVlanTag=agPortNewCfgVlanTag, vlanNewCfgVlanId=vlanNewCfgVlanId, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portmirroring=portmirroring, pmNewCfgState=pmNewCfgState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, agPortCurCfgIndx=agPortCurCfgIndx, agPortNewCfgBackLink=agPortNewCfgBackLink, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, portStatsIndx=portStatsIndx, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, mirrOperType=mirrOperType, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, agPortNewCfgBwmContract=agPortNewCfgBwmContract, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanCurCfgPorts=vlanCurCfgPorts, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, agPortNewCfgPrefLink=agPortNewCfgPrefLink, stgNewCfgState=stgNewCfgState, portInfoIndx=portInfoIndx, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mirrPortMirr=mirrPortMirr, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portCpuStatsUtilTable=portCpuStatsUtilTable, agPortNewCfgState=agPortNewCfgState, stgCurCfgState=stgCurCfgState, pmCurCfgState=pmCurCfgState, port_stats=port_stats, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlans=vlans, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, portStatsPhyIfInErrors=portStatsPhyIfInErrors, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portInfoLink=portInfoLink, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, agPortCurCfgBackLink=agPortCurCfgBackLink, portInfoPhyIfType=portInfoPhyIfType, trunkGroupNewCfgTable=trunkGroupNewCfgTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portInfoMode=portInfoMode, portStatsTableEntry=portStatsTableEntry, mirrVlanMirr=mirrVlanMirr, stgNewCfgPortIndex=stgNewCfgPortIndex, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, vlanCurCfgVlanId=vlanCurCfgVlanId, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgStgIndex=stgCurCfgStgIndex, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, vlanNewCfgTable=vlanNewCfgTable, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, vlanCurCfgState=vlanCurCfgState, vlanCurCfgStg=vlanCurCfgStg, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, agPortNewCfgTable=agPortNewCfgTable, mirrOper=mirrOper, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, spannTreeGrpCfg=spannTreeGrpCfg, vlanNewCfgState=vlanNewCfgState, mirrOperMirroredPort=mirrOperMirroredPort, mirrOperState=mirrOperState, vlanNewCfgVlanName=vlanNewCfgVlanName, agPortCurCfgTable=agPortCurCfgTable, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, agPortCurCfgStp=agPortCurCfgStp, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portStatsPhyIfInOctets=portStatsPhyIfInOctets, mirroring=mirroring, portCpuStatsUtilIndx=portCpuStatsUtilIndx, agPortCurCfgTableEntry=agPortCurCfgTableEntry, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, portCpuStats=portCpuStats, vlanNewCfgPorts=vlanNewCfgPorts, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgStgIndex=stgNewCfgStgIndex, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, portInfoPhyIfMtu=portInfoPhyIfMtu, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, pmNewCfgMirroredPort=pmNewCfgMirroredPort, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgIndex=stgCurCfgIndex, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, agPortCurCfgPrefLink=agPortCurCfgPrefLink, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgPortState=stgCurCfgPortState, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, vlanNewCfgAddPort=vlanNewCfgAddPort, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, agPortNewCfgIndx=agPortNewCfgIndx, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanNewCfgStg=vlanNewCfgStg, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, agPortCurCfgBwmContract=agPortCurCfgBwmContract, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgNewCfgTable=stgNewCfgTable, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, portInfoPhyIfLastChange=portInfoPhyIfLastChange, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, portStatsTable=portStatsTable, vlanCurCfgTable=vlanCurCfgTable, portInfoFlowCtrl=portInfoFlowCtrl, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmNewCfgTimeout=pmNewCfgTimeout, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, agPortNewCfgPVID=agPortNewCfgPVID, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, agPortCurCfgPortName=agPortCurCfgPortName, agPortCurCfgPVID=agPortCurCfgPVID, portInfoSpeed=portInfoSpeed, trunkgroup=trunkgroup, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, stgNewCfgTableEntry=stgNewCfgTableEntry, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, portInfoTableEntry=portInfoTableEntry, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortConfig=agPortConfig, stgNewCfgPortState=stgNewCfgPortState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanCurCfgJumbo=vlanCurCfgJumbo, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, mirrOperTimeout=mirrOperTimeout, vlanMaxEnt=vlanMaxEnt, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, stgCurCfgPortTable=stgCurCfgPortTable, pmCurCfgMirroredPort=pmCurCfgMirroredPort, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, portInfoTable=portInfoTable, vlanNewCfgJumbo=vlanNewCfgJumbo, agPortNewCfgTableEntry=agPortNewCfgTableEntry, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, agPortNewCfgPortName=agPortNewCfgPortName, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, agPortCurCfgRmon=agPortCurCfgRmon, agPortTableMaxEnt=agPortTableMaxEnt, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, port_info=port_info, agPortNewCfgRmon=agPortNewCfgRmon, agPortCurCfgVlanTag=agPortCurCfgVlanTag, agPortNewCfgStp=agPortNewCfgStp, stgNewCfgPortTable=stgNewCfgPortTable, pmCurCfgTimeout=pmCurCfgTimeout, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, stgNewCfgIndex=stgNewCfgIndex)
