...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", vlanCurCfgTable=vlanCurCfgTable, vlanNewCfgJumbo=vlanNewCfgJumbo, stgCurCfgPortState=stgCurCfgPortState, vlanNewCfgStg=vlanNewCfgStg, vlans=vlans, agPortNewCfgPVID=agPortNewCfgPVID, portStatsTable=portStatsTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmCurCfgTimeout=pmCurCfgTimeout, portStatsPhyIfInOctets=portStatsPhyIfInOctets, stgNewCfgPortState=stgNewCfgPortState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, agPortCurCfgVlanTag=agPortCurCfgVlanTag, pmCurCfgMirroredPort=pmCurCfgMirroredPort, portCpuStats=portCpuStats, vlanNewCfgRemovePort=vlanNewCfgRemovePort, agPortNewCfgTable=agPortNewCfgTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portInfoTable=portInfoTable, agPortCurCfgTableEntry=agPortCurCfgTableEntry, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, stgCurCfgPortTable=stgCurCfgPortTable, agPortNewCfgBwmContract=agPortNewCfgBwmContract, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, pmNewCfgTimeout=pmNewCfgTimeout, trunkgroup=trunkgroup, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, vlanNewCfgVlanName=vlanNewCfgVlanName, pmCurCfgState=pmCurCfgState, agPortCurCfgBwmContract=agPortCurCfgBwmContract, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgAddVlan=stgNewCfgAddVlan, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgStgIndex=stgNewCfgStgIndex, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, agPortNewCfgBackLink=agPortNewCfgBackLink, portInfoPhyIfMtu=portInfoPhyIfMtu, pmNewCfgMirroredPort=pmNewCfgMirroredPort, portStatsIndx=portStatsIndx, agPortCurCfgPortName=agPortCurCfgPortName, mirrOperState=mirrOperState, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, trunkGroupCurCfgState=trunkGroupCurCfgState, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, mirroring=mirroring, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, vlanCurCfgVlanName=vlanCurCfgVlanName, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, agPortNewCfgTableEntry=agPortNewCfgTableEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgCurCfgIndex=stgCurCfgIndex, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, stgNewCfgIndex=stgNewCfgIndex, pmNewCfgState=pmNewCfgState, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgState=stgNewCfgState, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portCpuStatsUtilIndx=portCpuStatsUtilIndx, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, vlanCurCfgBwmContract=vlanCurCfgBwmContract, agPortCurCfgRmon=agPortCurCfgRmon, agPortNewCfgStp=agPortNewCfgStp, portmirroring=portmirroring, portInfoTableEntry=portInfoTableEntry, portStatsTableEntry=portStatsTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgPortIndex=stgNewCfgPortIndex, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, portInfoIndx=portInfoIndx, vlanNewCfgAddPort=vlanNewCfgAddPort, agPortNewCfgRmon=agPortNewCfgRmon, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, portStatsPhyIfInErrors=portStatsPhyIfInErrors, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, mirrVlanMirr=mirrVlanMirr, stgCurCfgPortIndex=stgCurCfgPortIndex, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, agPortNewCfgState=agPortNewCfgState, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, stgNewCfgTable=stgNewCfgTable, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanNewCfgState=vlanNewCfgState, mirrOperTimeout=mirrOperTimeout, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portInfoPhyIfLastChange=portInfoPhyIfLastChange, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, vlanNewCfgPorts=vlanNewCfgPorts, agPortCurCfgTable=agPortCurCfgTable, agPortCurCfgStp=agPortCurCfgStp, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgCurCfgTableEntry=stgCurCfgTableEntry, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mirrOper=mirrOper, agPortCurCfgPVID=agPortCurCfgPVID, agPortNewCfgPrefLink=agPortNewCfgPrefLink, stgCurCfgStgIndex=stgCurCfgStgIndex, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, portInfoSpeed=portInfoSpeed, stgCurCfgTable=stgCurCfgTable, stgCurCfgState=stgCurCfgState, portInfoPhyIfType=portInfoPhyIfType, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, agPortCurCfgIndx=agPortCurCfgIndx, spannTreeGrpCfg=spannTreeGrpCfg, vlanCurCfgPorts=vlanCurCfgPorts, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, vlanCurCfgVlanId=vlanCurCfgVlanId, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, portInfoPhyIfDescr=portInfoPhyIfDescr, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgPortTable=stgNewCfgPortTable, agPortNewCfgVlanTag=agPortNewCfgVlanTag, vlanNewCfgDelete=vlanNewCfgDelete, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, mirrOperMirroredPort=mirrOperMirroredPort, mirrOperType=mirrOperType, agPortConfig=agPortConfig, agPortNewCfgIndx=agPortNewCfgIndx, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, port_stats=port_stats, portInfoLink=portInfoLink, mirrPortMirr=mirrPortMirr, vlanNewCfgBwmContract=vlanNewCfgBwmContract, agPortCurCfgBackLink=agPortCurCfgBackLink, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, portInfoFlowCtrl=portInfoFlowCtrl, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, vlanNewCfgTable=vlanNewCfgTable, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, portInfoMode=portInfoMode, vlanCurCfgStg=vlanCurCfgStg, vlanCurCfgState=vlanCurCfgState, agPortNewCfgPortName=agPortNewCfgPortName, agPortCurCfgState=agPortCurCfgState, agPortTableMaxEnt=agPortTableMaxEnt, agPortCurCfgPrefLink=agPortCurCfgPrefLink, mirrOperMonitoringPort=mirrOperMonitoringPort, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, port_info=port_info, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanMaxEnt=vlanMaxEnt, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portCpuStatsUtilTable=portCpuStatsUtilTable)
