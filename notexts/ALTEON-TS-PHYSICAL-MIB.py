...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, trunkGroupNewCfgState=trunkGroupNewCfgState, portInfoPhyIfLastChange=portInfoPhyIfLastChange, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, vlanCurCfgVlanId=vlanCurCfgVlanId, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, pmCurCfgMirroredPort=pmCurCfgMirroredPort, stgNewCfgPortIndex=stgNewCfgPortIndex, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, portStatsIndx=portStatsIndx, agPortNewCfgIndx=agPortNewCfgIndx, portCpuStats=portCpuStats, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgTable=stgNewCfgTable, agPortCurCfgTableEntry=agPortCurCfgTableEntry, vlanCurCfgStg=vlanCurCfgStg, stgCurCfgTable=stgCurCfgTable, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, agPortCurCfgPrefLink=agPortCurCfgPrefLink, portCpuStatsUtilTable=portCpuStatsUtilTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanMaxEnt=vlanMaxEnt, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgPortIndex=stgCurCfgPortIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, port_stats=port_stats, trunkgroup=trunkgroup, stgCurCfgState=stgCurCfgState, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortCurCfgTable=agPortCurCfgTable, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, mirrOperMirroredPort=mirrOperMirroredPort, agPortCurCfgIndx=agPortCurCfgIndx, portStatsTable=portStatsTable, agPortConfig=agPortConfig, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, stgNewCfgPortTable=stgNewCfgPortTable, vlans=vlans, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, mirroring=mirroring, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, agPortCurCfgState=agPortCurCfgState, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, mirrOperTimeout=mirrOperTimeout, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, pmNewCfgTimeout=pmNewCfgTimeout, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgStgIndex=stgNewCfgStgIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portInfoSpeed=portInfoSpeed, agPortNewCfgVlanTag=agPortNewCfgVlanTag, agPortNewCfgBwmContract=agPortNewCfgBwmContract, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, vlanCurCfgJumbo=vlanCurCfgJumbo, agPortNewCfgPortName=agPortNewCfgPortName, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mirrVlanMirr=mirrVlanMirr, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, stgNewCfgPortState=stgNewCfgPortState, vlanNewCfgTable=vlanNewCfgTable, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, stgCurCfgStgIndex=stgCurCfgStgIndex, agPortCurCfgPVID=agPortCurCfgPVID, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, pmNewCfgPortMirrState=pmNewCfgPortMirrState, agPortNewCfgPrefLink=agPortNewCfgPrefLink, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, agPortCurCfgRmon=agPortCurCfgRmon, agPortCurCfgVlanTag=agPortCurCfgVlanTag, agPortNewCfgTableEntry=agPortNewCfgTableEntry, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, pmNewCfgMirroredPort=pmNewCfgMirroredPort, portInfoIndx=portInfoIndx, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, portStatsPhyIfInOctets=portStatsPhyIfInOctets, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, pmCurCfgState=pmCurCfgState, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, pmCurCfgTimeout=pmCurCfgTimeout, agPortNewCfgState=agPortNewCfgState, stgNewCfgState=stgNewCfgState, mirrPortMirr=mirrPortMirr, agPortNewCfgRmon=agPortNewCfgRmon, pmNewCfgState=pmNewCfgState, agPortCurCfgBwmContract=agPortCurCfgBwmContract, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portStatsTableEntry=portStatsTableEntry, vlanNewCfgState=vlanNewCfgState, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, portCpuStatsUtilIndx=portCpuStatsUtilIndx, portInfoTable=portInfoTable, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portInfoLink=portInfoLink, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, trunkGroupCurCfgState=trunkGroupCurCfgState, portInfoPhyIfMtu=portInfoPhyIfMtu, vlanNewCfgStg=vlanNewCfgStg, mirrOper=mirrOper, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgCurCfgPortState=stgCurCfgPortState, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, agPortNewCfgPVID=agPortNewCfgPVID, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, port_info=port_info, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortCurCfgPortName=agPortCurCfgPortName, stgCurCfgPortTable=stgCurCfgPortTable, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, vlanNewCfgDelete=vlanNewCfgDelete, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, agPortTableMaxEnt=agPortTableMaxEnt, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgNewCfgAddVlan=stgNewCfgAddVlan, stgCurCfgTableEntry=stgCurCfgTableEntry, portInfoPhyIfType=portInfoPhyIfType, vlanNewCfgVlanId=vlanNewCfgVlanId, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, stgCurCfgIndex=stgCurCfgIndex, agPortNewCfgTable=agPortNewCfgTable, portInfoMode=portInfoMode, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanCurCfgState=vlanCurCfgState, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, vlanCurCfgTable=vlanCurCfgTable, agPortCurCfgStp=agPortCurCfgStp, stgNewCfgIndex=stgNewCfgIndex, spannTreeGrpCfg=spannTreeGrpCfg, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, mirrOperState=mirrOperState, stgNewCfgTableEntry=stgNewCfgTableEntry, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, portmirroring=portmirroring, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portStatsPhyIfInErrors=portStatsPhyIfInErrors, mirrOperType=mirrOperType, agPortNewCfgStp=agPortNewCfgStp, portInfoTableEntry=portInfoTableEntry, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanCurCfgBwmContract=vlanCurCfgBwmContract, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portInfoFlowCtrl=portInfoFlowCtrl, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortNewCfgBackLink=agPortNewCfgBackLink, agPortCurCfgBackLink=agPortCurCfgBackLink, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1)
