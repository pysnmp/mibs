...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", agPortCurCfgStp=agPortCurCfgStp, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, stgCurCfgTable=stgCurCfgTable, stgCurCfgStgIndex=stgCurCfgStgIndex, portInfoPhyIfType=portInfoPhyIfType, stgCurCfgPortState=stgCurCfgPortState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, agPortNewCfgTable=agPortNewCfgTable, portInfoTable=portInfoTable, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, vlanCurCfgVlanName=vlanCurCfgVlanName, agPortCurCfgBackLink=agPortCurCfgBackLink, stgNewCfgIndex=stgNewCfgIndex, portmirroring=portmirroring, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, agPortConfig=agPortConfig, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, stgCurCfgIndex=stgCurCfgIndex, agPortNewCfgState=agPortNewCfgState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, mirrVlanMirr=mirrVlanMirr, portInfoPhyIfDescr=portInfoPhyIfDescr, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgPortIndex=stgNewCfgPortIndex, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, mirrOperMonitoringPort=mirrOperMonitoringPort, mirrOper=mirrOper, agPortCurCfgPortName=agPortCurCfgPortName, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, vlanNewCfgTableEntry=vlanNewCfgTableEntry, agPortNewCfgPortName=agPortNewCfgPortName, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgPortState=stgNewCfgPortState, agPortNewCfgIndx=agPortNewCfgIndx, portCpuStats=portCpuStats, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, portInfoSpeed=portInfoSpeed, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgCurCfgState=stgCurCfgState, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, mirrOperMirroredPort=mirrOperMirroredPort, agPortCurCfgPVID=agPortCurCfgPVID, vlans=vlans, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, port_info=port_info, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, agPortNewCfgBackLink=agPortNewCfgBackLink, portInfoLink=portInfoLink, agPortCurCfgPrefLink=agPortCurCfgPrefLink, pmNewCfgState=pmNewCfgState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portCpuStatsUtilTable=portCpuStatsUtilTable, stgCurCfgPortTable=stgCurCfgPortTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mirrOperType=mirrOperType, vlanNewCfgPorts=vlanNewCfgPorts, mirrOperTimeout=mirrOperTimeout, agPortCurCfgTableEntry=agPortCurCfgTableEntry, spannTreeGrpCfg=spannTreeGrpCfg, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, agPortNewCfgStp=agPortNewCfgStp, trunkgroup=trunkgroup, vlanCurCfgJumbo=vlanCurCfgJumbo, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, pmNewCfgPortMirrState=pmNewCfgPortMirrState, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, agPortCurCfgBwmContract=agPortCurCfgBwmContract, agPortNewCfgPVID=agPortNewCfgPVID, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, vlanCurCfgPorts=vlanCurCfgPorts, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, vlanNewCfgJumbo=vlanNewCfgJumbo, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, port_stats=port_stats, stgNewCfgTable=stgNewCfgTable, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanMaxEnt=vlanMaxEnt, pmNewCfgMirroredPort=pmNewCfgMirroredPort, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, mirrPortMirr=mirrPortMirr, portInfoIndx=portInfoIndx, mirrOperState=mirrOperState, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgPortTable=stgNewCfgPortTable, stgNewCfgStgIndex=stgNewCfgStgIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, portInfoMode=portInfoMode, pmCurCfgMirroredPort=pmCurCfgMirroredPort, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, pmNewCfgTimeout=pmNewCfgTimeout, agPortCurCfgIndx=agPortCurCfgIndx, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, agPortNewCfgBwmContract=agPortNewCfgBwmContract, stgNewCfgTableEntry=stgNewCfgTableEntry, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portInfoPhyIfMtu=portInfoPhyIfMtu, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, mirroring=mirroring, portCpuStatsUtilIndx=portCpuStatsUtilIndx, stgCurCfgTableEntry=stgCurCfgTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, portStatsPhyIfInErrors=portStatsPhyIfInErrors, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, agPortCurCfgTable=agPortCurCfgTable, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, agPortCurCfgRmon=agPortCurCfgRmon, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, pmCurCfgState=pmCurCfgState, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, stgNewCfgAddVlan=stgNewCfgAddVlan, agPortNewCfgPrefLink=agPortNewCfgPrefLink, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlanCurCfgTable=vlanCurCfgTable, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, agPortNewCfgRmon=agPortNewCfgRmon, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, portStatsTableEntry=portStatsTableEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, agPortCurCfgState=agPortCurCfgState, vlanCurCfgStg=vlanCurCfgStg, portStatsTable=portStatsTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanNewCfgStg=vlanNewCfgStg, portStatsPhyIfInOctets=portStatsPhyIfInOctets, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, portInfoPhyIfLastChange=portInfoPhyIfLastChange, portInfoFlowCtrl=portInfoFlowCtrl, portInfoTableEntry=portInfoTableEntry, portStatsIndx=portStatsIndx, vlanCurCfgState=vlanCurCfgState, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, agPortTableMaxEnt=agPortTableMaxEnt, stgNewCfgState=stgNewCfgState, agPortCurCfgVlanTag=agPortCurCfgVlanTag, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, vlanNewCfgAddPort=vlanNewCfgAddPort, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, agPortNewCfgTableEntry=agPortNewCfgTableEntry, pmCurCfgTimeout=pmCurCfgTimeout, stgCurCfgPortIndex=stgCurCfgPortIndex, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, vlanNewCfgState=vlanNewCfgState, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, agPortNewCfgVlanTag=agPortNewCfgVlanTag, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, vlanNewCfgTable=vlanNewCfgTable, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, trunkGroupCurCfgTable=trunkGroupCurCfgTable)
