...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", portCpuStats=portCpuStats, agPortCurCfgIndx=agPortCurCfgIndx, portInfoFlowCtrl=portInfoFlowCtrl, agPortNewCfgPVID=agPortNewCfgPVID, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, mirrOperType=mirrOperType, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, port_info=port_info, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, agPortCurCfgVlanTag=agPortCurCfgVlanTag, stgCurCfgPortIndex=stgCurCfgPortIndex, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, stgNewCfgIndex=stgNewCfgIndex, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, portInfoMode=portInfoMode, agPortNewCfgIndx=agPortNewCfgIndx, agPortCurCfgRmon=agPortCurCfgRmon, agPortNewCfgBackLink=agPortNewCfgBackLink, agPortNewCfgPrefLink=agPortNewCfgPrefLink, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, portInfoPhyIfType=portInfoPhyIfType, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, agPortCurCfgTableEntry=agPortCurCfgTableEntry, agPortNewCfgRmon=agPortNewCfgRmon, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupNewCfgTable=trunkGroupNewCfgTable, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, agPortConfig=agPortConfig, mirroring=mirroring, trunkgroup=trunkgroup, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, mirrOperMonitoringPort=mirrOperMonitoringPort, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanNewCfgVlanName=vlanNewCfgVlanName, vlans=vlans, stgNewCfgPortState=stgNewCfgPortState, vlanNewCfgStg=vlanNewCfgStg, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, vlanNewCfgDelete=vlanNewCfgDelete, agPortNewCfgBwmContract=agPortNewCfgBwmContract, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgPortIndex=stgNewCfgPortIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, pmNewCfgState=pmNewCfgState, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, portCpuStatsUtilIndx=portCpuStatsUtilIndx, stgNewCfgStgIndex=stgNewCfgStgIndex, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, pmNewCfgTimeout=pmNewCfgTimeout, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, spannTreeGrpCfg=spannTreeGrpCfg, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, portInfoPhyIfLastChange=portInfoPhyIfLastChange, agPortNewCfgTableEntry=agPortNewCfgTableEntry, agPortCurCfgPortName=agPortCurCfgPortName, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portInfoSpeed=portInfoSpeed, portStatsIndx=portStatsIndx, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, stgCurCfgIndex=stgCurCfgIndex, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portInfoTable=portInfoTable, portInfoTableEntry=portInfoTableEntry, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmCurCfgMirroredPort=pmCurCfgMirroredPort, vlanCurCfgStg=vlanCurCfgStg, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portInfoLink=portInfoLink, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanCurCfgState=vlanCurCfgState, stgCurCfgTable=stgCurCfgTable, stgCurCfgPortTable=stgCurCfgPortTable, mirrPortMirr=mirrPortMirr, mirrOperMirroredPort=mirrOperMirroredPort, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, portCpuStatsUtilTable=portCpuStatsUtilTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, agPortCurCfgBwmContract=agPortCurCfgBwmContract, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portStatsTable=portStatsTable, agPortCurCfgPVID=agPortCurCfgPVID, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmCurCfgState=pmCurCfgState, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, agPortNewCfgPortName=agPortNewCfgPortName, portInfoPhyIfMtu=portInfoPhyIfMtu, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, vlanNewCfgJumbo=vlanNewCfgJumbo, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgNewCfgTable=stgNewCfgTable, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, portStatsPhyIfInErrors=portStatsPhyIfInErrors, pmCurCfgTimeout=pmCurCfgTimeout, agPortNewCfgVlanTag=agPortNewCfgVlanTag, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanNewCfgTable=vlanNewCfgTable, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgState=stgCurCfgState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, agPortCurCfgStp=agPortCurCfgStp, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, vlanNewCfgState=vlanNewCfgState, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portInfoPhyIfDescr=portInfoPhyIfDescr, mirrOperState=mirrOperState, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, mirrVlanMirr=mirrVlanMirr, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mirrOperTimeout=mirrOperTimeout, vlanCurCfgPorts=vlanCurCfgPorts, vlanMaxEnt=vlanMaxEnt, agPortCurCfgState=agPortCurCfgState, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, agPortCurCfgPrefLink=agPortCurCfgPrefLink, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, vlanNewCfgPorts=vlanNewCfgPorts, mirrOper=mirrOper, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, portStatsPhyIfInOctets=portStatsPhyIfInOctets, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, vlanCurCfgTable=vlanCurCfgTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, stgCurCfgTableEntry=stgCurCfgTableEntry, portInfoIndx=portInfoIndx, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, agPortCurCfgTable=agPortCurCfgTable, agPortNewCfgState=agPortNewCfgState, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, agPortNewCfgTable=agPortNewCfgTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, port_stats=port_stats, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, portmirroring=portmirroring, stgNewCfgState=stgNewCfgState, vlanCurCfgVlanId=vlanCurCfgVlanId, pmNewCfgMirroredPort=pmNewCfgMirroredPort, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portStatsTableEntry=portStatsTableEntry, agPortTableMaxEnt=agPortTableMaxEnt, stgNewCfgPortTable=stgNewCfgPortTable, agPortCurCfgBackLink=agPortCurCfgBackLink, stgCurCfgPortState=stgCurCfgPortState, agPortNewCfgStp=agPortNewCfgStp)
