...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", portStatsPhyIfInErrors=portStatsPhyIfInErrors, portInfoPhyIfLastChange=portInfoPhyIfLastChange, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, mirrOperType=mirrOperType, vlanCurCfgStg=vlanCurCfgStg, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, portStatsTable=portStatsTable, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, pmCurCfgTimeout=pmCurCfgTimeout, portStatsIndx=portStatsIndx, vlanNewCfgVlanId=vlanNewCfgVlanId, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, vlanNewCfgPorts=vlanNewCfgPorts, agPortNewCfgState=agPortNewCfgState, agPortNewCfgVlanTag=agPortNewCfgVlanTag, agPortCurCfgBwmContract=agPortCurCfgBwmContract, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, pmCurCfgState=pmCurCfgState, stgCurCfgTable=stgCurCfgTable, stgNewCfgState=stgNewCfgState, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, port_stats=port_stats, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portCpuStats=portCpuStats, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, vlanNewCfgTable=vlanNewCfgTable, vlanCurCfgVlanName=vlanCurCfgVlanName, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, stgNewCfgAddVlan=stgNewCfgAddVlan, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanNewCfgAddPort=vlanNewCfgAddPort, portInfoMode=portInfoMode, stgNewCfgTable=stgNewCfgTable, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, stgNewCfgStgIndex=stgNewCfgStgIndex, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanNewCfgJumbo=vlanNewCfgJumbo, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, agPortCurCfgRmon=agPortCurCfgRmon, stgCurCfgPortIndex=stgCurCfgPortIndex, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, mirrOperMirroredPort=mirrOperMirroredPort, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, pmCurCfgMirroredPort=pmCurCfgMirroredPort, stgCurCfgPortTable=stgCurCfgPortTable, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, vlanCurCfgBwmContract=vlanCurCfgBwmContract, agPortNewCfgPVID=agPortNewCfgPVID, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupNewCfgState=trunkGroupNewCfgState, portInfoTableEntry=portInfoTableEntry, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, vlanNewCfgStg=vlanNewCfgStg, agPortNewCfgPortName=agPortNewCfgPortName, vlanCurCfgJumbo=vlanCurCfgJumbo, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, agPortConfig=agPortConfig, port_info=port_info, agPortNewCfgBwmContract=agPortNewCfgBwmContract, portInfoPhyIfMtu=portInfoPhyIfMtu, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, vlanCurCfgVlanId=vlanCurCfgVlanId, pmNewCfgMirroredPort=pmNewCfgMirroredPort, agPortCurCfgTable=agPortCurCfgTable, stgCurCfgTableEntry=stgCurCfgTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanNewCfgBwmContract=vlanNewCfgBwmContract, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, agPortCurCfgBackLink=agPortCurCfgBackLink, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgCurCfgIndex=stgCurCfgIndex, portCpuStatsUtilTable=portCpuStatsUtilTable, vlanCurCfgState=vlanCurCfgState, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, vlanCurCfgPorts=vlanCurCfgPorts, pmNewCfgState=pmNewCfgState, stgNewCfgTableEntry=stgNewCfgTableEntry, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanMaxEnt=vlanMaxEnt, agPortNewCfgTableEntry=agPortNewCfgTableEntry, portInfoLink=portInfoLink, vlanNewCfgDelete=vlanNewCfgDelete, mirroring=mirroring, stgCurCfgState=stgCurCfgState, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, agPortCurCfgPVID=agPortCurCfgPVID, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, stgNewCfgIndex=stgNewCfgIndex, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, stgCurCfgPortState=stgCurCfgPortState, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, vlanNewCfgState=vlanNewCfgState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, mirrPortMirr=mirrPortMirr, agPortCurCfgState=agPortCurCfgState, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, portmirroring=portmirroring, agPortCurCfgStp=agPortCurCfgStp, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, mirrOperTimeout=mirrOperTimeout, stgNewCfgPortIndex=stgNewCfgPortIndex, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, vlanCurCfgTable=vlanCurCfgTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portStatsPhyIfInOctets=portStatsPhyIfInOctets, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, agPortNewCfgPrefLink=agPortNewCfgPrefLink, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, portInfoSpeed=portInfoSpeed, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, pmNewCfgTimeout=pmNewCfgTimeout, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mirrOper=mirrOper, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mirrVlanMirr=mirrVlanMirr, portInfoPhyIfType=portInfoPhyIfType, agPortNewCfgStp=agPortNewCfgStp, portInfoIndx=portInfoIndx, portStatsTableEntry=portStatsTableEntry, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, agPortCurCfgTableEntry=agPortCurCfgTableEntry, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, spannTreeGrpCfg=spannTreeGrpCfg, agPortCurCfgVlanTag=agPortCurCfgVlanTag, agPortNewCfgRmon=agPortNewCfgRmon, portInfoFlowCtrl=portInfoFlowCtrl, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, agPortNewCfgTable=agPortNewCfgTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mirrOperMonitoringPort=mirrOperMonitoringPort, vlanNewCfgVlanName=vlanNewCfgVlanName, agPortCurCfgIndx=agPortCurCfgIndx, stgCurCfgStgIndex=stgCurCfgStgIndex, portInfoTable=portInfoTable, trunkgroup=trunkgroup, agPortNewCfgIndx=agPortNewCfgIndx, stgNewCfgPortState=stgNewCfgPortState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, agPortCurCfgPortName=agPortCurCfgPortName, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, agPortTableMaxEnt=agPortTableMaxEnt, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, portCpuStatsUtilIndx=portCpuStatsUtilIndx, vlanCurCfgTableEntry=vlanCurCfgTableEntry, agPortCurCfgPrefLink=agPortCurCfgPrefLink, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, stgNewCfgPortTable=stgNewCfgPortTable, trunkGroupCurCfgState=trunkGroupCurCfgState, vlans=vlans, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, agPortNewCfgBackLink=agPortNewCfgBackLink, mirrOperState=mirrOperState, portInfoPhyIfDescr=portInfoPhyIfDescr, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode)
