...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, portInfoTableEntry=portInfoTableEntry, agPortNewCfgTableEntry=agPortNewCfgTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, stgNewCfgTable=stgNewCfgTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, vlanMaxEnt=vlanMaxEnt, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, agPortCurCfgRmon=agPortCurCfgRmon, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mirrOperMonitoringPort=mirrOperMonitoringPort, portStatsTable=portStatsTable, vlanNewCfgState=vlanNewCfgState, mirrPortMirr=mirrPortMirr, port_info=port_info, agPortNewCfgTable=agPortNewCfgTable, vlanNewCfgVlanId=vlanNewCfgVlanId, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, mirrVlanMirr=mirrVlanMirr, agPortNewCfgPortName=agPortNewCfgPortName, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, mirrOperTimeout=mirrOperTimeout, agPortNewCfgPVID=agPortNewCfgPVID, stgNewCfgAddVlan=stgNewCfgAddVlan, agPortCurCfgTableEntry=agPortCurCfgTableEntry, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, agPortNewCfgBwmContract=agPortNewCfgBwmContract, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgPortTable=stgNewCfgPortTable, agPortCurCfgBackLink=agPortCurCfgBackLink, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portCpuStats=portCpuStats, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, agPortCurCfgVlanTag=agPortCurCfgVlanTag, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, agPortTableMaxEnt=agPortTableMaxEnt, pmCurCfgMirroredPort=pmCurCfgMirroredPort, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portInfoIndx=portInfoIndx, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, vlanCurCfgVlanName=vlanCurCfgVlanName, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanCurCfgTable=vlanCurCfgTable, portInfoPhyIfMtu=portInfoPhyIfMtu, vlans=vlans, trunkgroup=trunkgroup, mirrOperMirroredPort=mirrOperMirroredPort, agPortNewCfgPrefLink=agPortNewCfgPrefLink, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, portStatsPhyIfInErrors=portStatsPhyIfInErrors, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, agPortNewCfgStp=agPortNewCfgStp, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, port_stats=port_stats, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanCurCfgJumbo=vlanCurCfgJumbo, portInfoLink=portInfoLink, agPortCurCfgStp=agPortCurCfgStp, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgPortState=stgNewCfgPortState, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, agPortCurCfgIndx=agPortCurCfgIndx, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, portInfoTable=portInfoTable, portInfoPhyIfType=portInfoPhyIfType, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, stgCurCfgPortIndex=stgCurCfgPortIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portmirroring=portmirroring, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portCpuStatsUtilTable=portCpuStatsUtilTable, agPortNewCfgIndx=agPortNewCfgIndx, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, stgCurCfgPortTable=stgCurCfgPortTable, agPortCurCfgState=agPortCurCfgState, vlanCurCfgPorts=vlanCurCfgPorts, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgPortState=stgCurCfgPortState, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, mirrOper=mirrOper, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, vlanNewCfgTable=vlanNewCfgTable, portInfoFlowCtrl=portInfoFlowCtrl, vlanCurCfgState=vlanCurCfgState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, pmCurCfgState=pmCurCfgState, mirrOperState=mirrOperState, vlanNewCfgPorts=vlanNewCfgPorts, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, pmNewCfgMirroredPort=pmNewCfgMirroredPort, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, agPortNewCfgState=agPortNewCfgState, stgCurCfgTable=stgCurCfgTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortNewCfgRmon=agPortNewCfgRmon, portStatsPhyIfInOctets=portStatsPhyIfInOctets, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, portInfoPhyIfLastChange=portInfoPhyIfLastChange, agPortCurCfgBwmContract=agPortCurCfgBwmContract, portInfoMode=portInfoMode, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, agPortCurCfgTable=agPortCurCfgTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, agPortNewCfgBackLink=agPortNewCfgBackLink, stgCurCfgState=stgCurCfgState, portStatsTableEntry=portStatsTableEntry, portStatsIndx=portStatsIndx, vlanNewCfgDelete=vlanNewCfgDelete, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, agPortCurCfgPrefLink=agPortCurCfgPrefLink, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, portCpuStatsUtilIndx=portCpuStatsUtilIndx, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mirroring=mirroring, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, agPortConfig=agPortConfig, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, vlanCurCfgVlanId=vlanCurCfgVlanId, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, mirrOperType=mirrOperType, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, vlanNewCfgStg=vlanNewCfgStg, spannTreeGrpCfg=spannTreeGrpCfg, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, pmNewCfgState=pmNewCfgState, pmNewCfgTimeout=pmNewCfgTimeout, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, stgNewCfgState=stgNewCfgState, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, agPortNewCfgVlanTag=agPortNewCfgVlanTag, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, agPortCurCfgPortName=agPortCurCfgPortName, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, pmCurCfgTimeout=pmCurCfgTimeout, vlanCurCfgStg=vlanCurCfgStg, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgNewCfgIndex=stgNewCfgIndex, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgStgIndex=stgNewCfgStgIndex, agPortCurCfgPVID=agPortCurCfgPVID, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portInfoSpeed=portInfoSpeed, vlanNewCfgRemovePort=vlanNewCfgRemovePort)
