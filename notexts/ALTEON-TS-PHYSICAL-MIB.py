...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, agPortCurCfgBwmContract=agPortCurCfgBwmContract, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanCurCfgState=vlanCurCfgState, agPortNewCfgTableEntry=agPortNewCfgTableEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgTableEntry=stgNewCfgTableEntry, mirrPortMirr=mirrPortMirr, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, mirrOperMonitoringPort=mirrOperMonitoringPort, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, agPortNewCfgRmon=agPortNewCfgRmon, stgCurCfgStgIndex=stgCurCfgStgIndex, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, pmNewCfgMirroredPort=pmNewCfgMirroredPort, portInfoMode=portInfoMode, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, trunkgroup=trunkgroup, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, agPortCurCfgIndx=agPortCurCfgIndx, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, portCpuStatsUtilTable=portCpuStatsUtilTable, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, vlanNewCfgTableEntry=vlanNewCfgTableEntry, agPortCurCfgPVID=agPortCurCfgPVID, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, spannTreeGrpCfg=spannTreeGrpCfg, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portStatsTable=portStatsTable, mirrOperState=mirrOperState, agPortNewCfgPortName=agPortNewCfgPortName, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, stgNewCfgState=stgNewCfgState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portCpuStatsUtilIndx=portCpuStatsUtilIndx, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, portStatsTableEntry=portStatsTableEntry, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, agPortCurCfgBackLink=agPortCurCfgBackLink, agPortTableMaxEnt=agPortTableMaxEnt, trunkGroupNewCfgState=trunkGroupNewCfgState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, pmNewCfgState=pmNewCfgState, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, agPortCurCfgPortName=agPortCurCfgPortName, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mirrOperMirroredPort=mirrOperMirroredPort, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, mirrOperTimeout=mirrOperTimeout, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgCurCfgState=stgCurCfgState, portCpuStats=portCpuStats, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, vlanNewCfgVlanId=vlanNewCfgVlanId, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgPortState=stgCurCfgPortState, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanNewCfgState=vlanNewCfgState, agPortCurCfgVlanTag=agPortCurCfgVlanTag, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, agPortCurCfgTableEntry=agPortCurCfgTableEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, agPortNewCfgPVID=agPortNewCfgPVID, vlanCurCfgStg=vlanCurCfgStg, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, vlanCurCfgVlanName=vlanCurCfgVlanName, portStatsIndx=portStatsIndx, agPortCurCfgState=agPortCurCfgState, agPortCurCfgRmon=agPortCurCfgRmon, vlanNewCfgDelete=vlanNewCfgDelete, agPortNewCfgBwmContract=agPortNewCfgBwmContract, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmCurCfgTimeout=pmCurCfgTimeout, stgNewCfgTable=stgNewCfgTable, portInfoPhyIfType=portInfoPhyIfType, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portInfoSpeed=portInfoSpeed, agPortNewCfgPrefLink=agPortNewCfgPrefLink, vlanNewCfgJumbo=vlanNewCfgJumbo, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, agPortNewCfgBackLink=agPortNewCfgBackLink, portStatsPhyIfInOctets=portStatsPhyIfInOctets, agPortCurCfgStp=agPortCurCfgStp, trunkGroupNewCfgTable=trunkGroupNewCfgTable, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, portInfoPhyIfLastChange=portInfoPhyIfLastChange, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, stgNewCfgPortState=stgNewCfgPortState, agPortNewCfgTable=agPortNewCfgTable, agPortCurCfgPrefLink=agPortCurCfgPrefLink, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, pmCurCfgState=pmCurCfgState, portInfoTableEntry=portInfoTableEntry, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, vlanMaxEnt=vlanMaxEnt, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, vlanCurCfgVlanId=vlanCurCfgVlanId, portInfoPhyIfDescr=portInfoPhyIfDescr, portInfoPhyIfMtu=portInfoPhyIfMtu, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portmirroring=portmirroring, port_info=port_info, stgCurCfgPortIndex=stgCurCfgPortIndex, agPortCurCfgTable=agPortCurCfgTable, stgCurCfgTable=stgCurCfgTable, stgNewCfgPortTable=stgNewCfgPortTable, portInfoLink=portInfoLink, stgNewCfgIndex=stgNewCfgIndex, stgCurCfgPortTable=stgCurCfgPortTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portStatsPhyIfInErrors=portStatsPhyIfInErrors, portInfoFlowCtrl=portInfoFlowCtrl, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, stgNewCfgPortIndex=stgNewCfgPortIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanCurCfgTable=vlanCurCfgTable, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, agPortNewCfgIndx=agPortNewCfgIndx, agPortNewCfgState=agPortNewCfgState, pmCurCfgMirroredPort=pmCurCfgMirroredPort, portInfoTable=portInfoTable, agPortNewCfgVlanTag=agPortNewCfgVlanTag, vlanNewCfgTable=vlanNewCfgTable, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, agPortNewCfgStp=agPortNewCfgStp, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, mirrVlanMirr=mirrVlanMirr, vlans=vlans, port_stats=port_stats, stgCurCfgIndex=stgCurCfgIndex, mirrOperType=mirrOperType, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, portInfoIndx=portInfoIndx, mirrOper=mirrOper, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, mirroring=mirroring, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, agPortConfig=agPortConfig, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, pmNewCfgTimeout=pmNewCfgTimeout, vlanNewCfgAddPort=vlanNewCfgAddPort)
