...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", portmirroring=portmirroring, agPortTableMaxEnt=agPortTableMaxEnt, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portInfoPhyIfMtu=portInfoPhyIfMtu, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, mirrOperType=mirrOperType, portInfoMode=portInfoMode, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgIndex=stgNewCfgIndex, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortConfig=agPortConfig, vlanNewCfgDelete=vlanNewCfgDelete, spannTreeGrpCfg=spannTreeGrpCfg, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, portInfoFlowCtrl=portInfoFlowCtrl, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, stgCurCfgPortTable=stgCurCfgPortTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgTable=stgNewCfgTable, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, trunkGroupCurCfgTable=trunkGroupCurCfgTable, agPortNewCfgPVID=agPortNewCfgPVID, stgCurCfgTableEntry=stgCurCfgTableEntry, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, agPortCurCfgBwmContract=agPortCurCfgBwmContract, vlans=vlans, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, vlanNewCfgStg=vlanNewCfgStg, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, agPortNewCfgBwmContract=agPortNewCfgBwmContract, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, portCpuStatsUtilIndx=portCpuStatsUtilIndx, agPortNewCfgTable=agPortNewCfgTable, mirrOperTimeout=mirrOperTimeout, pmCurCfgPortMirrState=pmCurCfgPortMirrState, agPortNewCfgBackLink=agPortNewCfgBackLink, stgCurCfgPortState=stgCurCfgPortState, stgNewCfgState=stgNewCfgState, vlanCurCfgVlanName=vlanCurCfgVlanName, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, trunkGroupNewCfgState=trunkGroupNewCfgState, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, stgNewCfgTableEntry=stgNewCfgTableEntry, mirrVlanMirr=mirrVlanMirr, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, agPortCurCfgState=agPortCurCfgState, portInfoTableEntry=portInfoTableEntry, stgNewCfgPortState=stgNewCfgPortState, portStatsIndx=portStatsIndx, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, mirrOperMirroredPort=mirrOperMirroredPort, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mirrOper=mirrOper, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgCurCfgPortIndex=stgCurCfgPortIndex, pmCurCfgTimeout=pmCurCfgTimeout, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, agPortNewCfgRmon=agPortNewCfgRmon, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, agPortCurCfgIndx=agPortCurCfgIndx, trunkGroupCurCfgState=trunkGroupCurCfgState, pmCurCfgMirroredPort=pmCurCfgMirroredPort, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanNewCfgVlanName=vlanNewCfgVlanName, agPortNewCfgStp=agPortNewCfgStp, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portCpuStatsUtilTable=portCpuStatsUtilTable, stgNewCfgPortIndex=stgNewCfgPortIndex, agPortCurCfgPrefLink=agPortCurCfgPrefLink, stgCurCfgState=stgCurCfgState, agPortCurCfgPVID=agPortCurCfgPVID, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgAddVlan=stgNewCfgAddVlan, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, pmCurCfgState=pmCurCfgState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, agPortCurCfgTable=agPortCurCfgTable, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, pmNewCfgTimeout=pmNewCfgTimeout, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCurCfgTable=stgCurCfgTable, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, agPortNewCfgPrefLink=agPortNewCfgPrefLink, vlanNewCfgJumbo=vlanNewCfgJumbo, agPortCurCfgBackLink=agPortCurCfgBackLink, vlanCurCfgTable=vlanCurCfgTable, agPortCurCfgVlanTag=agPortCurCfgVlanTag, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, agPortCurCfgStp=agPortCurCfgStp, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupTableMaxSize=trunkGroupTableMaxSize, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmNewCfgState=pmNewCfgState, vlanNewCfgState=vlanNewCfgState, port_info=port_info, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, port_stats=port_stats, pmNewCfgMirroredPort=pmNewCfgMirroredPort, portInfoSpeed=portInfoSpeed, stgCurCfgStgIndex=stgCurCfgStgIndex, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, portStatsPhyIfInOctets=portStatsPhyIfInOctets, mirroring=mirroring, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, portInfoIndx=portInfoIndx, vlanCurCfgState=vlanCurCfgState, agPortNewCfgTableEntry=agPortNewCfgTableEntry, mirrPortMirr=mirrPortMirr, agPortNewCfgState=agPortNewCfgState, agPortCurCfgRmon=agPortCurCfgRmon, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portInfoPhyIfType=portInfoPhyIfType, portInfoLink=portInfoLink, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlanNewCfgAddPort=vlanNewCfgAddPort, portStatsTableEntry=portStatsTableEntry, vlanNewCfgPorts=vlanNewCfgPorts, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, agPortNewCfgPortName=agPortNewCfgPortName, agPortCurCfgPortName=agPortCurCfgPortName, agPortNewCfgVlanTag=agPortNewCfgVlanTag, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, portInfoPhyIfLastChange=portInfoPhyIfLastChange, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, portStatsTable=portStatsTable, vlanMaxEnt=vlanMaxEnt, stgNewCfgPortTable=stgNewCfgPortTable, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, vlanCurCfgStg=vlanCurCfgStg, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, mirrOperState=mirrOperState, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, portStatsPhyIfInErrors=portStatsPhyIfInErrors, portCpuStats=portCpuStats, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, agPortCurCfgTableEntry=agPortCurCfgTableEntry, portInfoTable=portInfoTable, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, trunkgroup=trunkgroup, agPortNewCfgIndx=agPortNewCfgIndx, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanNewCfgTable=vlanNewCfgTable, stgCurCfgIndex=stgCurCfgIndex)
