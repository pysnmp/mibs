...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, portStatsPhyIfInErrors=portStatsPhyIfInErrors, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portInfoSpeed=portInfoSpeed, agPortNewCfgTable=agPortNewCfgTable, stgCurCfgIndex=stgCurCfgIndex, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, port_info=port_info, vlanNewCfgStg=vlanNewCfgStg, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, agPortCurCfgBackLink=agPortCurCfgBackLink, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, agPortNewCfgBwmContract=agPortNewCfgBwmContract, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, vlans=vlans, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, agPortCurCfgTableEntry=agPortCurCfgTableEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, port_stats=port_stats, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, vlanMaxEnt=vlanMaxEnt, agPortConfig=agPortConfig, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, mirrOperMonitoringPort=mirrOperMonitoringPort, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgPortState=stgNewCfgPortState, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortNewCfgPortName=agPortNewCfgPortName, portInfoPhyIfType=portInfoPhyIfType, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgPortIndex=stgNewCfgPortIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, agPortNewCfgPVID=agPortNewCfgPVID, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, portInfoPhyIfMtu=portInfoPhyIfMtu, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupCurCfgTable=trunkGroupCurCfgTable, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, pmNewCfgMirroredPort=pmNewCfgMirroredPort, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portInfoTable=portInfoTable, portCpuStats=portCpuStats, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, portCpuStatsUtilIndx=portCpuStatsUtilIndx, pmCurCfgMirroredPort=pmCurCfgMirroredPort, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, agPortNewCfgTableEntry=agPortNewCfgTableEntry, agPortNewCfgBackLink=agPortNewCfgBackLink, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, agPortNewCfgVlanTag=agPortNewCfgVlanTag, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portStatsTableEntry=portStatsTableEntry, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, vlanNewCfgTable=vlanNewCfgTable, agPortCurCfgPrefLink=agPortCurCfgPrefLink, portInfoMode=portInfoMode, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portInfoTableEntry=portInfoTableEntry, trunkgroup=trunkgroup, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portStatsTable=portStatsTable, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, portInfoIndx=portInfoIndx, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, mirrOper=mirrOper, agPortCurCfgRmon=agPortCurCfgRmon, vlanNewCfgBwmContract=vlanNewCfgBwmContract, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, agPortCurCfgTable=agPortCurCfgTable, mirrOperType=mirrOperType, portInfoPhyIfLastChange=portInfoPhyIfLastChange, mirrVlanMirr=mirrVlanMirr, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, agPortCurCfgIndx=agPortCurCfgIndx, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgState=stgCurCfgState, pmNewCfgTimeout=pmNewCfgTimeout, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanCurCfgVlanId=vlanCurCfgVlanId, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, agPortCurCfgBwmContract=agPortCurCfgBwmContract, mirrOperMirroredPort=mirrOperMirroredPort, vlanNewCfgPorts=vlanNewCfgPorts, agPortNewCfgStp=agPortNewCfgStp, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgState=vlanNewCfgState, vlanNewCfgJumbo=vlanNewCfgJumbo, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, stgCurCfgPortTable=stgCurCfgPortTable, stgNewCfgTable=stgNewCfgTable, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, agPortNewCfgPrefLink=agPortNewCfgPrefLink, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, agPortCurCfgStp=agPortCurCfgStp, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portInfoLink=portInfoLink, agPortNewCfgIndx=agPortNewCfgIndx, stgNewCfgTableEntry=stgNewCfgTableEntry, stgCurCfgStgIndex=stgCurCfgStgIndex, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortNewCfgRmon=agPortNewCfgRmon, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portStatsIndx=portStatsIndx, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, agPortCurCfgState=agPortCurCfgState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portCpuStatsUtilTable=portCpuStatsUtilTable, agPortCurCfgPVID=agPortCurCfgPVID, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, pmCurCfgState=pmCurCfgState, stgNewCfgStgIndex=stgNewCfgStgIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgPortTable=stgNewCfgPortTable, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portmirroring=portmirroring, agPortNewCfgState=agPortNewCfgState, agPortCurCfgVlanTag=agPortCurCfgVlanTag, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, vlanCurCfgState=vlanCurCfgState, portInfoFlowCtrl=portInfoFlowCtrl, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, vlanCurCfgTable=vlanCurCfgTable, agPortTableMaxEnt=agPortTableMaxEnt, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, mirrOperTimeout=mirrOperTimeout, vlanCurCfgVlanName=vlanCurCfgVlanName, mirrPortMirr=mirrPortMirr, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mirroring=mirroring, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, portStatsPhyIfInOctets=portStatsPhyIfInOctets, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, stgNewCfgState=stgNewCfgState, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, spannTreeGrpCfg=spannTreeGrpCfg, mirrOperState=mirrOperState, stgCurCfgPortState=stgCurCfgPortState, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, agPortCurCfgPortName=agPortCurCfgPortName, trunkGroupNewCfgState=trunkGroupNewCfgState, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmCurCfgTimeout=pmCurCfgTimeout, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, stgCurCfgTable=stgCurCfgTable, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, pmNewCfgState=pmNewCfgState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanCurCfgBwmContract=vlanCurCfgBwmContract)
