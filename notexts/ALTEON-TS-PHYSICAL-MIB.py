...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, agPortCurCfgIndx=agPortCurCfgIndx, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portStatsPhyIfInErrors=portStatsPhyIfInErrors, vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, agPortNewCfgBwmContract=agPortNewCfgBwmContract, agPortConfig=agPortConfig, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, agPortNewCfgVlanTag=agPortNewCfgVlanTag, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgTable=stgNewCfgTable, portInfoPhyIfType=portInfoPhyIfType, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, mirrPortMirr=mirrPortMirr, pmNewCfgMirroredPort=pmNewCfgMirroredPort, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, agPortCurCfgBwmContract=agPortCurCfgBwmContract, agPortCurCfgRmon=agPortCurCfgRmon, portStatsTableEntry=portStatsTableEntry, mirrOperMonitoringPort=mirrOperMonitoringPort, pmNewCfgState=pmNewCfgState, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, portInfoLink=portInfoLink, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, agPortCurCfgTableEntry=agPortCurCfgTableEntry, agPortCurCfgPrefLink=agPortCurCfgPrefLink, vlanNewCfgJumbo=vlanNewCfgJumbo, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, pmCurCfgPortMirrState=pmCurCfgPortMirrState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanCurCfgStg=vlanCurCfgStg, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, vlanNewCfgRemovePort=vlanNewCfgRemovePort, agPortNewCfgTableEntry=agPortNewCfgTableEntry, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, trunkGroupCurCfgState=trunkGroupCurCfgState, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, vlanNewCfgTable=vlanNewCfgTable, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, agPortTableMaxEnt=agPortTableMaxEnt, portInfoPhyIfLastChange=portInfoPhyIfLastChange, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, vlanNewCfgVlanName=vlanNewCfgVlanName, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmCurCfgMirroredPort=pmCurCfgMirroredPort, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, trunkgroup=trunkgroup, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, agPortCurCfgPortName=agPortCurCfgPortName, agPortCurCfgStp=agPortCurCfgStp, pmNewCfgTimeout=pmNewCfgTimeout, portCpuStatsUtilTable=portCpuStatsUtilTable, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, spannTreeGrpCfg=spannTreeGrpCfg, stgCurCfgTable=stgCurCfgTable, agPortNewCfgRmon=agPortNewCfgRmon, portInfoIndx=portInfoIndx, vlanCurCfgJumbo=vlanCurCfgJumbo, agPortCurCfgPVID=agPortCurCfgPVID, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmCurCfgState=pmCurCfgState, stgNewCfgState=stgNewCfgState, stgCurCfgPortIndex=stgCurCfgPortIndex, stgCurCfgPortTable=stgCurCfgPortTable, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, mirrOperType=mirrOperType, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, portInfoPhyIfDescr=portInfoPhyIfDescr, mirrOperTimeout=mirrOperTimeout, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, portCpuStats=portCpuStats, vlanCurCfgTable=vlanCurCfgTable, portStatsTable=portStatsTable, stgNewCfgAddVlan=stgNewCfgAddVlan, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, agPortCurCfgVlanTag=agPortCurCfgVlanTag, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, agPortNewCfgPortName=agPortNewCfgPortName, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, agPortCurCfgBackLink=agPortCurCfgBackLink, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portInfoMode=portInfoMode, agPortNewCfgBackLink=agPortNewCfgBackLink, agPortNewCfgTable=agPortNewCfgTable, portInfoPhyIfMtu=portInfoPhyIfMtu, stgCurCfgPortState=stgCurCfgPortState, portInfoFlowCtrl=portInfoFlowCtrl, portStatsPhyIfInOctets=portStatsPhyIfInOctets, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, port_stats=port_stats, stgCurCfgIndex=stgCurCfgIndex, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, vlanCurCfgPorts=vlanCurCfgPorts, portInfoSpeed=portInfoSpeed, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, mirrOper=mirrOper, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, vlanNewCfgState=vlanNewCfgState, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portInfoTable=portInfoTable, agPortNewCfgPrefLink=agPortNewCfgPrefLink, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgPortIndex=stgNewCfgPortIndex, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, portInfoTableEntry=portInfoTableEntry, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, mirrOperState=mirrOperState, agPortCurCfgState=agPortCurCfgState, port_info=port_info, stgCurCfgStgIndex=stgCurCfgStgIndex, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, vlanMaxEnt=vlanMaxEnt, stgNewCfgPortTable=stgNewCfgPortTable, mirroring=mirroring, vlanCurCfgState=vlanCurCfgState, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, agPortNewCfgState=agPortNewCfgState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mirrOperMirroredPort=mirrOperMirroredPort, stgNewCfgIndex=stgNewCfgIndex, pmCurCfgTimeout=pmCurCfgTimeout, portCpuStatsUtilIndx=portCpuStatsUtilIndx, agPortNewCfgPVID=agPortNewCfgPVID, stgNewCfgTableEntry=stgNewCfgTableEntry, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgPortState=stgNewCfgPortState, agPortNewCfgIndx=agPortNewCfgIndx, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, mirrVlanMirr=mirrVlanMirr, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, vlans=vlans, agPortCurCfgTable=agPortCurCfgTable, vlanNewCfgStg=vlanNewCfgStg, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, portStatsIndx=portStatsIndx, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, portmirroring=portmirroring, agPortNewCfgStp=agPortNewCfgStp, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, stgCurCfgState=stgCurCfgState)
