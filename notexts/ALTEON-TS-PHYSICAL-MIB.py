...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, stgNewCfgPortState=stgNewCfgPortState, stgCurCfgTable=stgCurCfgTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, trunkGroupCurCfgState=trunkGroupCurCfgState, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, trunkGroupNewCfgState=trunkGroupNewCfgState, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portCpuStatsUtilIndx=portCpuStatsUtilIndx, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, agPortNewCfgPortName=agPortNewCfgPortName, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanMaxEnt=vlanMaxEnt, agPortNewCfgRmon=agPortNewCfgRmon, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, agPortCurCfgStp=agPortCurCfgStp, vlanNewCfgStg=vlanNewCfgStg, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanCurCfgTable=vlanCurCfgTable, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, portStatsPhyIfInErrors=portStatsPhyIfInErrors, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, agPortCurCfgState=agPortCurCfgState, pmCurCfgTimeout=pmCurCfgTimeout, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, agPortNewCfgTable=agPortNewCfgTable, pmCurCfgState=pmCurCfgState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, vlanNewCfgState=vlanNewCfgState, port_info=port_info, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, vlanCurCfgVlanId=vlanCurCfgVlanId, portInfoPhyIfMtu=portInfoPhyIfMtu, agPortCurCfgVlanTag=agPortCurCfgVlanTag, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, vlanCurCfgState=vlanCurCfgState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portInfoPhyIfLastChange=portInfoPhyIfLastChange, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanCurCfgVlanName=vlanCurCfgVlanName, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, agPortTableMaxEnt=agPortTableMaxEnt, vlanNewCfgVlanName=vlanNewCfgVlanName, agPortNewCfgState=agPortNewCfgState, portStatsPhyIfInOctets=portStatsPhyIfInOctets, vlanNewCfgVlanId=vlanNewCfgVlanId, pmCurCfgPortMirrState=pmCurCfgPortMirrState, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, vlans=vlans, portmirroring=portmirroring, agPortNewCfgBwmContract=agPortNewCfgBwmContract, agPortCurCfgPrefLink=agPortCurCfgPrefLink, mirrVlanMirr=mirrVlanMirr, mirrPortMirr=mirrPortMirr, trunkgroup=trunkgroup, agPortCurCfgTable=agPortCurCfgTable, agPortNewCfgVlanTag=agPortNewCfgVlanTag, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, agPortCurCfgTableEntry=agPortCurCfgTableEntry, stgCurCfgPortTable=stgCurCfgPortTable, portInfoIndx=portInfoIndx, portInfoSpeed=portInfoSpeed, mirrOper=mirrOper, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, agPortConfig=agPortConfig, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, spannTreeGrpCfg=spannTreeGrpCfg, vlanNewCfgDelete=vlanNewCfgDelete, agPortCurCfgPVID=agPortCurCfgPVID, portCpuStats=portCpuStats, vlanCurCfgStg=vlanCurCfgStg, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, stgCurCfgTableEntry=stgCurCfgTableEntry, agPortCurCfgIndx=agPortCurCfgIndx, portStatsTable=portStatsTable, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, agPortNewCfgIndx=agPortNewCfgIndx, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, stgNewCfgTable=stgNewCfgTable, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, stgNewCfgStgIndex=stgNewCfgStgIndex, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanNewCfgTable=vlanNewCfgTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portInfoPhyIfType=portInfoPhyIfType, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, stgCurCfgPortState=stgCurCfgPortState, mirrOperMirroredPort=mirrOperMirroredPort, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, mirrOperState=mirrOperState, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, agPortCurCfgRmon=agPortCurCfgRmon, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, stgCurCfgPortIndex=stgCurCfgPortIndex, portInfoMode=portInfoMode, portInfoPhyIfDescr=portInfoPhyIfDescr, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, vlanNewCfgAddPort=vlanNewCfgAddPort, stgCurCfgIndex=stgCurCfgIndex, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, pmNewCfgTimeout=pmNewCfgTimeout, mirrOperType=mirrOperType, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortCurCfgPortName=agPortCurCfgPortName, agPortNewCfgStp=agPortNewCfgStp, portCpuStatsUtilTable=portCpuStatsUtilTable, portInfoTableEntry=portInfoTableEntry, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, pmCurCfgMirroredPort=pmCurCfgMirroredPort, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, agPortCurCfgBackLink=agPortCurCfgBackLink, portInfoLink=portInfoLink, mirroring=mirroring, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, stgNewCfgTableEntry=stgNewCfgTableEntry, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, agPortCurCfgBwmContract=agPortCurCfgBwmContract, stgNewCfgPortIndex=stgNewCfgPortIndex, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, pmNewCfgState=pmNewCfgState, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, agPortNewCfgPVID=agPortNewCfgPVID, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgIndex=stgNewCfgIndex, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, port_stats=port_stats, agPortNewCfgBackLink=agPortNewCfgBackLink, stgCurCfgStgIndex=stgCurCfgStgIndex, stgCurCfgState=stgCurCfgState, stgNewCfgState=stgNewCfgState, portInfoFlowCtrl=portInfoFlowCtrl, portInfoTable=portInfoTable, portStatsTableEntry=portStatsTableEntry, pmNewCfgMirroredPort=pmNewCfgMirroredPort, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portStatsIndx=portStatsIndx, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, pmNewCfgPortMirrState=pmNewCfgPortMirrState, agPortNewCfgTableEntry=agPortNewCfgTableEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mirrOperTimeout=mirrOperTimeout, agPortNewCfgPrefLink=agPortNewCfgPrefLink, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, stgNewCfgPortTable=stgNewCfgPortTable, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl)
