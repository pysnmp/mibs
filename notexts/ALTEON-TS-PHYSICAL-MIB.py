...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, stgNewCfgState=stgNewCfgState, stgCurCfgState=stgCurCfgState, stgCurCfgIndex=stgCurCfgIndex, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, portInfoMode=portInfoMode, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, portStatsTableEntry=portStatsTableEntry, portInfoLink=portInfoLink, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, stgNewCfgPortIndex=stgNewCfgPortIndex, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portInfoTable=portInfoTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, port_info=port_info, port_stats=port_stats, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, agPortNewCfgBwmContract=agPortNewCfgBwmContract, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portStatsTable=portStatsTable, agPortCurCfgPrefLink=agPortCurCfgPrefLink, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, agPortCurCfgTableEntry=agPortCurCfgTableEntry, agPortCurCfgBwmContract=agPortCurCfgBwmContract, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgCurCfgTable=stgCurCfgTable, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanCurCfgVlanName=vlanCurCfgVlanName, mirrOper=mirrOper, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, agPortNewCfgRmon=agPortNewCfgRmon, vlanCurCfgPorts=vlanCurCfgPorts, pmNewCfgMirroredPort=pmNewCfgMirroredPort, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, agPortTableMaxEnt=agPortTableMaxEnt, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, mirrOperType=mirrOperType, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portInfoPhyIfType=portInfoPhyIfType, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, agPortCurCfgVlanTag=agPortCurCfgVlanTag, agPortNewCfgState=agPortNewCfgState, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mirrVlanMirr=mirrVlanMirr, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portInfoIndx=portInfoIndx, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, portInfoTableEntry=portInfoTableEntry, mirrOperMirroredPort=mirrOperMirroredPort, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanCurCfgTable=vlanCurCfgTable, agPortCurCfgTable=agPortCurCfgTable, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, stgCurCfgPortIndex=stgCurCfgPortIndex, stgCurCfgTableEntry=stgCurCfgTableEntry, portCpuStatsUtilIndx=portCpuStatsUtilIndx, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, vlanNewCfgAddPort=vlanNewCfgAddPort, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, mirrPortMirr=mirrPortMirr, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmCurCfgMirroredPort=pmCurCfgMirroredPort, agPortNewCfgPrefLink=agPortNewCfgPrefLink, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgState=vlanNewCfgState, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanNewCfgVlanName=vlanNewCfgVlanName, agPortNewCfgVlanTag=agPortNewCfgVlanTag, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, agPortCurCfgIndx=agPortCurCfgIndx, vlanNewCfgDelete=vlanNewCfgDelete, spannTreeGrpCfg=spannTreeGrpCfg, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portInfoPhyIfDescr=portInfoPhyIfDescr, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, mirrOperTimeout=mirrOperTimeout, agPortNewCfgPVID=agPortNewCfgPVID, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmCurCfgState=pmCurCfgState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanNewCfgJumbo=vlanNewCfgJumbo, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, agPortCurCfgStp=agPortCurCfgStp, vlanNewCfgBwmContract=vlanNewCfgBwmContract, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, portCpuStatsUtilTable=portCpuStatsUtilTable, portInfoSpeed=portInfoSpeed, mirroring=mirroring, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, stgCurCfgPortState=stgCurCfgPortState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, stgNewCfgIndex=stgNewCfgIndex, agPortCurCfgState=agPortCurCfgState, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, stgNewCfgAddVlan=stgNewCfgAddVlan, stgCurCfgPortTable=stgCurCfgPortTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgTable=stgNewCfgTable, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, vlans=vlans, agPortNewCfgPortName=agPortNewCfgPortName, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, portInfoFlowCtrl=portInfoFlowCtrl, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, pmNewCfgTimeout=pmNewCfgTimeout, vlanCurCfgJumbo=vlanCurCfgJumbo, portInfoPhyIfMtu=portInfoPhyIfMtu, agPortNewCfgTableEntry=agPortNewCfgTableEntry, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, pmCurCfgTimeout=pmCurCfgTimeout, trunkGroupCurCfgState=trunkGroupCurCfgState, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, stgNewCfgTableEntry=stgNewCfgTableEntry, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortNewCfgBackLink=agPortNewCfgBackLink, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, agPortNewCfgTable=agPortNewCfgTable, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, agPortCurCfgRmon=agPortCurCfgRmon, portmirroring=portmirroring, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, portStatsIndx=portStatsIndx, pmCurCfgPortMirrState=pmCurCfgPortMirrState, trunkgroup=trunkgroup, portCpuStats=portCpuStats, agPortNewCfgIndx=agPortNewCfgIndx, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, agPortCurCfgPortName=agPortCurCfgPortName, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmNewCfgState=pmNewCfgState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mirrOperMonitoringPort=mirrOperMonitoringPort, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, vlanCurCfgState=vlanCurCfgState, vlanNewCfgTableEntry=vlanNewCfgTableEntry, agPortNewCfgStp=agPortNewCfgStp, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, portInfoPhyIfLastChange=portInfoPhyIfLastChange, agPortCurCfgPVID=agPortCurCfgPVID, vlanMaxEnt=vlanMaxEnt, agPortConfig=agPortConfig, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portStatsPhyIfInOctets=portStatsPhyIfInOctets, stgNewCfgPortTable=stgNewCfgPortTable, stgNewCfgPortState=stgNewCfgPortState, vlanCurCfgStg=vlanCurCfgStg, agPortCurCfgBackLink=agPortCurCfgBackLink, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, portStatsPhyIfInErrors=portStatsPhyIfInErrors, mirrOperState=mirrOperState, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState)
