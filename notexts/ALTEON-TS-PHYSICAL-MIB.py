...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", mirrPortMirr=mirrPortMirr, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, portStatsTable=portStatsTable, agPortCurCfgTable=agPortCurCfgTable, vlanCurCfgPorts=vlanCurCfgPorts, stgCurCfgIndex=stgCurCfgIndex, stgCurCfgPortState=stgCurCfgPortState, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, pmCurCfgMirroredPort=pmCurCfgMirroredPort, stgCurCfgPortTable=stgCurCfgPortTable, pmNewCfgTimeout=pmNewCfgTimeout, vlans=vlans, agPortNewCfgRmon=agPortNewCfgRmon, portCpuStats=portCpuStats, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, agPortNewCfgPortName=agPortNewCfgPortName, spannTreeGrpCfg=spannTreeGrpCfg, portInfoMode=portInfoMode, mirrOperTimeout=mirrOperTimeout, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanNewCfgJumbo=vlanNewCfgJumbo, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, portStatsPhyIfInOctets=portStatsPhyIfInOctets, agPortNewCfgIndx=agPortNewCfgIndx, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, agPortNewCfgState=agPortNewCfgState, agPortNewCfgTableEntry=agPortNewCfgTableEntry, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgTable=stgNewCfgTable, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, vlanCurCfgVlanName=vlanCurCfgVlanName, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanMaxEnt=vlanMaxEnt, portStatsTableEntry=portStatsTableEntry, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, mirrOperType=mirrOperType, agPortNewCfgBackLink=agPortNewCfgBackLink, portInfoPhyIfMtu=portInfoPhyIfMtu, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, agPortCurCfgBwmContract=agPortCurCfgBwmContract, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, agPortCurCfgVlanTag=agPortCurCfgVlanTag, portCpuStatsUtilIndx=portCpuStatsUtilIndx, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanCurCfgJumbo=vlanCurCfgJumbo, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, portInfoTableEntry=portInfoTableEntry, port_info=port_info, trunkGroupCurCfgState=trunkGroupCurCfgState, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgPortTable=stgNewCfgPortTable, agPortCurCfgPVID=agPortCurCfgPVID, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, agPortNewCfgVlanTag=agPortNewCfgVlanTag, portInfoTable=portInfoTable, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, stgCurCfgTable=stgCurCfgTable, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, vlanNewCfgVlanName=vlanNewCfgVlanName, agPortNewCfgPVID=agPortNewCfgPVID, portInfoLink=portInfoLink, stgNewCfgStgIndex=stgNewCfgStgIndex, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mirrOper=mirrOper, stgNewCfgPortIndex=stgNewCfgPortIndex, mirrVlanMirr=mirrVlanMirr, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portInfoPhyIfLastChange=portInfoPhyIfLastChange, vlanCurCfgTable=vlanCurCfgTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portStatsIndx=portStatsIndx, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, portInfoSpeed=portInfoSpeed, vlanNewCfgPorts=vlanNewCfgPorts, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portmirroring=portmirroring, stgNewCfgPortState=stgNewCfgPortState, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, stgCurCfgState=stgCurCfgState, trunkgroup=trunkgroup, stgNewCfgState=stgNewCfgState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, mirrOperMirroredPort=mirrOperMirroredPort, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mirroring=mirroring, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portInfoPhyIfType=portInfoPhyIfType, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, agPortNewCfgPrefLink=agPortNewCfgPrefLink, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portCpuStatsUtilTable=portCpuStatsUtilTable, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmCurCfgState=pmCurCfgState, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, agPortTableMaxEnt=agPortTableMaxEnt, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, port_stats=port_stats, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, agPortCurCfgIndx=agPortCurCfgIndx, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortNewCfgTable=agPortNewCfgTable, mirrOperState=mirrOperState, agPortCurCfgBackLink=agPortCurCfgBackLink, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, vlanNewCfgTable=vlanNewCfgTable, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, stgNewCfgIndex=stgNewCfgIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, pmNewCfgMirroredPort=pmNewCfgMirroredPort, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgTableEntry=stgNewCfgTableEntry, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortNewCfgStp=agPortNewCfgStp, stgCurCfgPortIndex=stgCurCfgPortIndex, pmCurCfgTimeout=pmCurCfgTimeout, agPortCurCfgStp=agPortCurCfgStp, agPortNewCfgBwmContract=agPortNewCfgBwmContract, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgState=vlanNewCfgState, portInfoFlowCtrl=portInfoFlowCtrl, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, vlanCurCfgState=vlanCurCfgState, portInfoIndx=portInfoIndx, agPortConfig=agPortConfig, pmNewCfgState=pmNewCfgState, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanNewCfgVlanId=vlanNewCfgVlanId, portStatsPhyIfInErrors=portStatsPhyIfInErrors, agPortCurCfgRmon=agPortCurCfgRmon, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, agPortCurCfgPrefLink=agPortCurCfgPrefLink, agPortCurCfgTableEntry=agPortCurCfgTableEntry, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanNewCfgStg=vlanNewCfgStg, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgAddVlan=stgNewCfgAddVlan, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, agPortCurCfgPortName=agPortCurCfgPortName, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, agPortCurCfgState=agPortCurCfgState, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2)
