...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portInfoPhyIfMtu=portInfoPhyIfMtu, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, portInfoIndx=portInfoIndx, agPortNewCfgIndx=agPortNewCfgIndx, agPortNewCfgState=agPortNewCfgState, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, port_info=port_info, vlanNewCfgJumbo=vlanNewCfgJumbo, stgNewCfgStgIndex=stgNewCfgStgIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, mirrOperType=mirrOperType, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, vlanMaxEnt=vlanMaxEnt, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, stgNewCfgAddVlan=stgNewCfgAddVlan, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, vlans=vlans, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, stgCurCfgPortIndex=stgCurCfgPortIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, agPortTableMaxEnt=agPortTableMaxEnt, vlanNewCfgState=vlanNewCfgState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgCurCfgTable=stgCurCfgTable, agPortCurCfgStp=agPortCurCfgStp, vlanNewCfgPorts=vlanNewCfgPorts, trunkgroup=trunkgroup, portStatsTableEntry=portStatsTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portInfoPhyIfLastChange=portInfoPhyIfLastChange, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, mirroring=mirroring, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, vlanCurCfgPorts=vlanCurCfgPorts, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, agPortNewCfgPVID=agPortNewCfgPVID, agPortCurCfgPVID=agPortCurCfgPVID, vlanNewCfgTable=vlanNewCfgTable, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, agPortCurCfgState=agPortCurCfgState, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, trunkGroupNewCfgState=trunkGroupNewCfgState, mirrPortMirr=mirrPortMirr, portInfoPhyIfType=portInfoPhyIfType, portStatsPhyIfInOctets=portStatsPhyIfInOctets, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, agPortCurCfgIndx=agPortCurCfgIndx, portInfoTable=portInfoTable, agPortNewCfgTableEntry=agPortNewCfgTableEntry, agPortCurCfgBackLink=agPortCurCfgBackLink, pmCurCfgTimeout=pmCurCfgTimeout, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, stgCurCfgIndex=stgCurCfgIndex, mirrOperMirroredPort=mirrOperMirroredPort, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, agPortNewCfgTable=agPortNewCfgTable, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, portStatsTable=portStatsTable, agPortNewCfgRmon=agPortNewCfgRmon, portmirroring=portmirroring, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, stgNewCfgPortTable=stgNewCfgPortTable, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgTableEntry=stgNewCfgTableEntry, mirrVlanMirr=mirrVlanMirr, agPortCurCfgPortName=agPortCurCfgPortName, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, stgNewCfgIndex=stgNewCfgIndex, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, mirrOper=mirrOper, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgAddPort=vlanNewCfgAddPort, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanCurCfgState=vlanCurCfgState, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, portCpuStats=portCpuStats, agPortNewCfgStp=agPortNewCfgStp, stgCurCfgTableEntry=stgCurCfgTableEntry, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgState=stgNewCfgState, mirrOperState=mirrOperState, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgPortState=stgNewCfgPortState, agPortNewCfgPrefLink=agPortNewCfgPrefLink, portCpuStatsUtilTable=portCpuStatsUtilTable, mirrOperMonitoringPort=mirrOperMonitoringPort, vlanCurCfgVlanId=vlanCurCfgVlanId, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgCurCfgState=stgCurCfgState, portInfoFlowCtrl=portInfoFlowCtrl, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, agPortNewCfgBwmContract=agPortNewCfgBwmContract, vlanCurCfgVlanName=vlanCurCfgVlanName, portCpuStatsUtilIndx=portCpuStatsUtilIndx, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, agPortNewCfgBackLink=agPortNewCfgBackLink, portInfoSpeed=portInfoSpeed, portInfoTableEntry=portInfoTableEntry, portInfoLink=portInfoLink, agPortCurCfgRmon=agPortCurCfgRmon, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, portStatsPhyIfInErrors=portStatsPhyIfInErrors, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanNewCfgStg=vlanNewCfgStg, agPortCurCfgBwmContract=agPortCurCfgBwmContract, mirrOperTimeout=mirrOperTimeout, stgCurCfgPortState=stgCurCfgPortState, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, pmCurCfgMirroredPort=pmCurCfgMirroredPort, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, portStatsIndx=portStatsIndx, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, pmNewCfgState=pmNewCfgState, agPortCurCfgTable=agPortCurCfgTable, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, agPortCurCfgVlanTag=agPortCurCfgVlanTag, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, pmNewCfgTimeout=pmNewCfgTimeout, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, stgCurCfgPortTable=stgCurCfgPortTable, agPortNewCfgVlanTag=agPortNewCfgVlanTag, pmCurCfgState=pmCurCfgState, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, vlanCurCfgTableEntry=vlanCurCfgTableEntry, agPortNewCfgPortName=agPortNewCfgPortName, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmNewCfgMirroredPort=pmNewCfgMirroredPort, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, vlanNewCfgRemovePort=vlanNewCfgRemovePort, agPortCurCfgPrefLink=agPortCurCfgPrefLink, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, portInfoMode=portInfoMode, agPortCurCfgTableEntry=agPortCurCfgTableEntry, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, spannTreeGrpCfg=spannTreeGrpCfg, vlanNewCfgVlanId=vlanNewCfgVlanId, agPortConfig=agPortConfig, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, port_stats=port_stats, vlanCurCfgTable=vlanCurCfgTable, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, stgNewCfgTable=stgNewCfgTable, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex)
