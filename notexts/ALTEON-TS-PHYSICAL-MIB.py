...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", pmCurCfgTimeout=pmCurCfgTimeout, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, mirrOperType=mirrOperType, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, mirrOperMonitoringPort=mirrOperMonitoringPort, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgPortState=stgNewCfgPortState, trunkgroup=trunkgroup, agPortNewCfgVlanTag=agPortNewCfgVlanTag, pmNewCfgMirroredPort=pmNewCfgMirroredPort, vlanCurCfgVlanId=vlanCurCfgVlanId, portInfoPhyIfDescr=portInfoPhyIfDescr, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, portStatsPhyIfInOctets=portStatsPhyIfInOctets, agPortNewCfgTableEntry=agPortNewCfgTableEntry, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, vlanCurCfgTable=vlanCurCfgTable, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, spannTreeGrpCfg=spannTreeGrpCfg, agPortTableMaxEnt=agPortTableMaxEnt, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mirrOperState=mirrOperState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, agPortNewCfgIndx=agPortNewCfgIndx, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortNewCfgTable=agPortNewCfgTable, stgNewCfgPortIndex=stgNewCfgPortIndex, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, stgCurCfgIndex=stgCurCfgIndex, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, agPortCurCfgPVID=agPortCurCfgPVID, portCpuStatsUtilTable=portCpuStatsUtilTable, stgNewCfgTableEntry=stgNewCfgTableEntry, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, agPortCurCfgState=agPortCurCfgState, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, agPortNewCfgPVID=agPortNewCfgPVID, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, agPortNewCfgPrefLink=agPortNewCfgPrefLink, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgPortIndex=stgCurCfgPortIndex, agPortCurCfgPortName=agPortCurCfgPortName, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanNewCfgTable=vlanNewCfgTable, trunkGroupNewCfgTable=trunkGroupNewCfgTable, agPortNewCfgState=agPortNewCfgState, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, stgCurCfgPortState=stgCurCfgPortState, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, portInfoPhyIfMtu=portInfoPhyIfMtu, agPortNewCfgBackLink=agPortNewCfgBackLink, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanNewCfgVlanId=vlanNewCfgVlanId, mirrPortMirr=mirrPortMirr, vlanCurCfgState=vlanCurCfgState, agPortCurCfgIndx=agPortCurCfgIndx, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, stgCurCfgTableEntry=stgCurCfgTableEntry, portStatsPhyIfInErrors=portStatsPhyIfInErrors, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanNewCfgDelete=vlanNewCfgDelete, mirroring=mirroring, stgCurCfgState=stgCurCfgState, vlanCurCfgPorts=vlanCurCfgPorts, agPortCurCfgPrefLink=agPortCurCfgPrefLink, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, mirrOper=mirrOper, mirrOperMirroredPort=mirrOperMirroredPort, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, pmCurCfgState=pmCurCfgState, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, portStatsIndx=portStatsIndx, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgIndex=stgNewCfgIndex, agPortCurCfgBackLink=agPortCurCfgBackLink, portInfoTable=portInfoTable, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, portmirroring=portmirroring, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, portCpuStatsUtilIndx=portCpuStatsUtilIndx, stgNewCfgState=stgNewCfgState, vlans=vlans, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, agPortCurCfgStp=agPortCurCfgStp, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanNewCfgState=vlanNewCfgState, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, portStatsTableEntry=portStatsTableEntry, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, portCpuStats=portCpuStats, portInfoIndx=portInfoIndx, mirrVlanMirr=mirrVlanMirr, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, pmNewCfgTimeout=pmNewCfgTimeout, portStatsTable=portStatsTable, port_stats=port_stats, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, stgNewCfgTable=stgNewCfgTable, pmCurCfgMirroredPort=pmCurCfgMirroredPort, portInfoMode=portInfoMode, mirrOperTimeout=mirrOperTimeout, portInfoLink=portInfoLink, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, portInfoPhyIfType=portInfoPhyIfType, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, vlanCurCfgJumbo=vlanCurCfgJumbo, portInfoTableEntry=portInfoTableEntry, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, agPortNewCfgRmon=agPortNewCfgRmon, portInfoFlowCtrl=portInfoFlowCtrl, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanCurCfgStg=vlanCurCfgStg, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, agPortCurCfgTable=agPortCurCfgTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgPortTable=stgNewCfgPortTable, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanNewCfgPorts=vlanNewCfgPorts, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, agPortCurCfgBwmContract=agPortCurCfgBwmContract, vlanMaxEnt=vlanMaxEnt, stgCurCfgPortTable=stgCurCfgPortTable, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, pmNewCfgState=pmNewCfgState, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, port_info=port_info, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portInfoSpeed=portInfoSpeed, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, agPortCurCfgRmon=agPortCurCfgRmon, trunkGroupNewCfgState=trunkGroupNewCfgState, portInfoPhyIfLastChange=portInfoPhyIfLastChange, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, vlanCurCfgVlanName=vlanCurCfgVlanName, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanNewCfgStg=vlanNewCfgStg, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgTable=stgCurCfgTable, agPortCurCfgTableEntry=agPortCurCfgTableEntry, agPortNewCfgPortName=agPortNewCfgPortName, agPortNewCfgStp=agPortNewCfgStp, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, agPortConfig=agPortConfig, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, agPortNewCfgBwmContract=agPortNewCfgBwmContract, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, stgNewCfgAddVlan=stgNewCfgAddVlan, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, agPortCurCfgVlanTag=agPortCurCfgVlanTag)
