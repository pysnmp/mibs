...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", portInfoTable=portInfoTable, stgCurCfgPortIndex=stgCurCfgPortIndex, portStatsTable=portStatsTable, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, agPortCurCfgState=agPortCurCfgState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, agPortNewCfgRmon=agPortNewCfgRmon, vlanNewCfgBwmContract=vlanNewCfgBwmContract, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, trunkgroup=trunkgroup, agPortNewCfgBackLink=agPortNewCfgBackLink, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, vlanCurCfgStg=vlanCurCfgStg, pmNewCfgState=pmNewCfgState, agPortNewCfgPVID=agPortNewCfgPVID, agPortCurCfgPVID=agPortCurCfgPVID, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, portInfoSpeed=portInfoSpeed, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgStgIndex=stgNewCfgStgIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, portInfoTableEntry=portInfoTableEntry, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgTableEntry=stgNewCfgTableEntry, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, portInfoMode=portInfoMode, agPortCurCfgBackLink=agPortCurCfgBackLink, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanNewCfgAddPort=vlanNewCfgAddPort, stgCurCfgPortTable=stgCurCfgPortTable, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, agPortNewCfgPrefLink=agPortNewCfgPrefLink, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, agPortCurCfgVlanTag=agPortCurCfgVlanTag, vlanCurCfgState=vlanCurCfgState, portCpuStatsUtilIndx=portCpuStatsUtilIndx, stgNewCfgPortState=stgNewCfgPortState, pmNewCfgTimeout=pmNewCfgTimeout, portInfoLink=portInfoLink, agPortNewCfgTableEntry=agPortNewCfgTableEntry, portInfoPhyIfLastChange=portInfoPhyIfLastChange, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, mirrOperMonitoringPort=mirrOperMonitoringPort, vlanNewCfgTable=vlanNewCfgTable, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, vlanNewCfgDelete=vlanNewCfgDelete, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, spannTreeGrpCfg=spannTreeGrpCfg, trunkGroupNewCfgState=trunkGroupNewCfgState, agPortCurCfgIndx=agPortCurCfgIndx, agPortNewCfgState=agPortNewCfgState, vlanCurCfgJumbo=vlanCurCfgJumbo, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, stgNewCfgPortTable=stgNewCfgPortTable, port_info=port_info, mirroring=mirroring, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, stgNewCfgIndex=stgNewCfgIndex, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanCurCfgTable=vlanCurCfgTable, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, portStatsTableEntry=portStatsTableEntry, agPortCurCfgTableEntry=agPortCurCfgTableEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mirrOperState=mirrOperState, portCpuStats=portCpuStats, pmNewCfgMirroredPort=pmNewCfgMirroredPort, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, stgCurCfgTable=stgCurCfgTable, agPortConfig=agPortConfig, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, mirrOperTimeout=mirrOperTimeout, vlanNewCfgRemovePort=vlanNewCfgRemovePort, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, vlanNewCfgStg=vlanNewCfgStg, agPortCurCfgPortName=agPortCurCfgPortName, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, portInfoPhyIfMtu=portInfoPhyIfMtu, vlanMaxEnt=vlanMaxEnt, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, agPortNewCfgIndx=agPortNewCfgIndx, agPortCurCfgRmon=agPortCurCfgRmon, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mirrOperType=mirrOperType, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, pmCurCfgTimeout=pmCurCfgTimeout, portInfoPhyIfType=portInfoPhyIfType, mirrOper=mirrOper, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanNewCfgTableEntry=vlanNewCfgTableEntry, agPortCurCfgStp=agPortCurCfgStp, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, portCpuStatsUtilTable=portCpuStatsUtilTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portInfoIndx=portInfoIndx, agPortNewCfgStp=agPortNewCfgStp, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, agPortNewCfgTable=agPortNewCfgTable, portmirroring=portmirroring, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portStatsPhyIfInErrors=portStatsPhyIfInErrors, mirrPortMirr=mirrPortMirr, agPortNewCfgPortName=agPortNewCfgPortName, agPortCurCfgPrefLink=agPortCurCfgPrefLink, vlanNewCfgPorts=vlanNewCfgPorts, mirrOperMirroredPort=mirrOperMirroredPort, stgCurCfgIndex=stgCurCfgIndex, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanCurCfgPorts=vlanCurCfgPorts, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, stgCurCfgState=stgCurCfgState, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, agPortCurCfgBwmContract=agPortCurCfgBwmContract, agPortNewCfgBwmContract=agPortNewCfgBwmContract, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, agPortNewCfgVlanTag=agPortNewCfgVlanTag, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, portInfoFlowCtrl=portInfoFlowCtrl, stgNewCfgState=stgNewCfgState, trunkGroupCurCfgState=trunkGroupCurCfgState, pmCurCfgMirroredPort=pmCurCfgMirroredPort, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portStatsPhyIfInOctets=portStatsPhyIfInOctets, port_stats=port_stats, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, portInfoPhyIfDescr=portInfoPhyIfDescr, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, mirrVlanMirr=mirrVlanMirr, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, agPortTableMaxEnt=agPortTableMaxEnt, portStatsIndx=portStatsIndx, vlanNewCfgJumbo=vlanNewCfgJumbo, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgNewCfgTable=stgNewCfgTable, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgPortState=stgCurCfgPortState, agPortCurCfgTable=agPortCurCfgTable, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmCurCfgState=pmCurCfgState, vlanNewCfgState=vlanNewCfgState, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlans=vlans, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, stgNewCfgPortIndex=stgNewCfgPortIndex, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, vlanNewCfgVlanId=vlanNewCfgVlanId, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards)
