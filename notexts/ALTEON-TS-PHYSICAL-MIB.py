...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", agPortNewCfgBackLink=agPortNewCfgBackLink, stgCurCfgTable=stgCurCfgTable, agPortNewCfgVlanTag=agPortNewCfgVlanTag, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, portCpuStatsUtilIndx=portCpuStatsUtilIndx, stgNewCfgAddVlan=stgNewCfgAddVlan, port_stats=port_stats, portInfoTableEntry=portInfoTableEntry, agPortCurCfgIndx=agPortCurCfgIndx, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, mirrOperTimeout=mirrOperTimeout, pmCurCfgTimeout=pmCurCfgTimeout, stgCurCfgPortState=stgCurCfgPortState, portmirroring=portmirroring, portInfoLink=portInfoLink, agPortNewCfgPortName=agPortNewCfgPortName, vlanCurCfgState=vlanCurCfgState, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portInfoPhyIfType=portInfoPhyIfType, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanCurCfgPorts=vlanCurCfgPorts, pmNewCfgTimeout=pmNewCfgTimeout, agPortNewCfgTableEntry=agPortNewCfgTableEntry, stgCurCfgState=stgCurCfgState, vlanNewCfgDelete=vlanNewCfgDelete, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanNewCfgAddPort=vlanNewCfgAddPort, portInfoIndx=portInfoIndx, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, agPortCurCfgStp=agPortCurCfgStp, agPortCurCfgPortName=agPortCurCfgPortName, pmCurCfgMirroredPort=pmCurCfgMirroredPort, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, mirrPortMirr=mirrPortMirr, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, agPortNewCfgPrefLink=agPortNewCfgPrefLink, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgPortState=stgNewCfgPortState, mirrOper=mirrOper, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgTableEntry=stgNewCfgTableEntry, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, portInfoSpeed=portInfoSpeed, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, vlanCurCfgTable=vlanCurCfgTable, vlanNewCfgTable=vlanNewCfgTable, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, portInfoTable=portInfoTable, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, stgCurCfgPortIndex=stgCurCfgPortIndex, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, vlanNewCfgRemovePort=vlanNewCfgRemovePort, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, agPortNewCfgIndx=agPortNewCfgIndx, agPortTableMaxEnt=agPortTableMaxEnt, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCurCfgIndex=stgCurCfgIndex, agPortNewCfgRmon=agPortNewCfgRmon, portStatsTable=portStatsTable, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, agPortCurCfgPVID=agPortCurCfgPVID, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanMaxEnt=vlanMaxEnt, portInfoFlowCtrl=portInfoFlowCtrl, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portInfoPhyIfMtu=portInfoPhyIfMtu, agPortCurCfgPrefLink=agPortCurCfgPrefLink, stgCurCfgPortTable=stgCurCfgPortTable, portStatsIndx=portStatsIndx, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, portCpuStatsUtilTable=portCpuStatsUtilTable, vlanCurCfgJumbo=vlanCurCfgJumbo, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, agPortCurCfgRmon=agPortCurCfgRmon, vlanNewCfgState=vlanNewCfgState, stgNewCfgState=stgNewCfgState, agPortNewCfgState=agPortNewCfgState, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, vlanNewCfgVlanId=vlanNewCfgVlanId, spannTreeGrpCfg=spannTreeGrpCfg, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, agPortNewCfgBwmContract=agPortNewCfgBwmContract, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, agPortCurCfgBwmContract=agPortCurCfgBwmContract, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, pmNewCfgState=pmNewCfgState, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, stgCurCfgStgIndex=stgCurCfgStgIndex, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, stgNewCfgPortIndex=stgNewCfgPortIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portInfoMode=portInfoMode, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, portInfoPhyIfLastChange=portInfoPhyIfLastChange, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, pmNewCfgMirroredPort=pmNewCfgMirroredPort, mirrOperType=mirrOperType, agPortNewCfgTable=agPortNewCfgTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, agPortNewCfgPVID=agPortNewCfgPVID, vlanCurCfgStg=vlanCurCfgStg, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanNewCfgPorts=vlanNewCfgPorts, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanNewCfgStg=vlanNewCfgStg, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgTableEntry=stgCurCfgTableEntry, trunkgroup=trunkgroup, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, portStatsTableEntry=portStatsTableEntry, mirrOperMonitoringPort=mirrOperMonitoringPort, mirroring=mirroring, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, agPortCurCfgBackLink=agPortCurCfgBackLink, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, mirrOperMirroredPort=mirrOperMirroredPort, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, stgNewCfgIndex=stgNewCfgIndex, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, agPortCurCfgTableEntry=agPortCurCfgTableEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgPortTable=stgNewCfgPortTable, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, mirrVlanMirr=mirrVlanMirr, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, pmNewCfgPortMirrState=pmNewCfgPortMirrState, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, portStatsPhyIfInOctets=portStatsPhyIfInOctets, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, pmCurCfgState=pmCurCfgState, portStatsPhyIfInErrors=portStatsPhyIfInErrors, agPortNewCfgStp=agPortNewCfgStp, agPortCurCfgTable=agPortCurCfgTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, portCpuStats=portCpuStats, stgNewCfgTable=stgNewCfgTable, port_info=port_info, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlans=vlans, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, agPortCurCfgVlanTag=agPortCurCfgVlanTag, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, agPortConfig=agPortConfig, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, agPortCurCfgState=agPortCurCfgState, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, stgNewCfgStgIndex=stgNewCfgStgIndex, mirrOperState=mirrOperState, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex)
