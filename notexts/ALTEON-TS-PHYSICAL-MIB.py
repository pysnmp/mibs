...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", portInfoIndx=portInfoIndx, vlanCurCfgTableEntry=vlanCurCfgTableEntry, port_info=port_info, stgCurCfgTable=stgCurCfgTable, portCpuStatsUtilTable=portCpuStatsUtilTable, stgNewCfgTable=stgNewCfgTable, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, mirrOperTimeout=mirrOperTimeout, mirrOperMirroredPort=mirrOperMirroredPort, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgNewCfgTableEntry=stgNewCfgTableEntry, agPortCurCfgState=agPortCurCfgState, agPortCurCfgRmon=agPortCurCfgRmon, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, vlanCurCfgJumbo=vlanCurCfgJumbo, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, mirroring=mirroring, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, agPortCurCfgIndx=agPortCurCfgIndx, stgNewCfgPortIndex=stgNewCfgPortIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, agPortNewCfgTable=agPortNewCfgTable, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, agPortNewCfgVlanTag=agPortNewCfgVlanTag, pmNewCfgTimeout=pmNewCfgTimeout, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, agPortNewCfgTableEntry=agPortNewCfgTableEntry, portCpuStats=portCpuStats, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mirrOperState=mirrOperState, pmNewCfgState=pmNewCfgState, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, agPortCurCfgVlanTag=agPortCurCfgVlanTag, mirrOperType=mirrOperType, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portStatsPhyIfInOctets=portStatsPhyIfInOctets, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, agPortNewCfgBwmContract=agPortNewCfgBwmContract, vlanNewCfgState=vlanNewCfgState, agPortCurCfgTableEntry=agPortCurCfgTableEntry, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmCurCfgState=pmCurCfgState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, mirrOper=mirrOper, mirrVlanMirr=mirrVlanMirr, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mirrOperMonitoringPort=mirrOperMonitoringPort, portStatsPhyIfInErrors=portStatsPhyIfInErrors, mirrPortMirr=mirrPortMirr, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, port_stats=port_stats, portInfoPhyIfLastChange=portInfoPhyIfLastChange, vlanNewCfgStg=vlanNewCfgStg, stgCurCfgPortIndex=stgCurCfgPortIndex, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, vlanCurCfgVlanName=vlanCurCfgVlanName, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, pmCurCfgPortMirrState=pmCurCfgPortMirrState, agPortNewCfgState=agPortNewCfgState, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgStgIndex=stgNewCfgStgIndex, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgAddVlan=stgNewCfgAddVlan, agPortNewCfgStp=agPortNewCfgStp, portInfoPhyIfDescr=portInfoPhyIfDescr, vlanNewCfgPorts=vlanNewCfgPorts, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmCurCfgMirroredPort=pmCurCfgMirroredPort, portCpuStatsUtilIndx=portCpuStatsUtilIndx, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, spannTreeGrpCfg=spannTreeGrpCfg, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, stgNewCfgIndex=stgNewCfgIndex, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, stgCurCfgStgIndex=stgCurCfgStgIndex, agPortCurCfgStp=agPortCurCfgStp, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanNewCfgBwmContract=vlanNewCfgBwmContract, agPortCurCfgPortName=agPortCurCfgPortName, stgNewCfgPortTable=stgNewCfgPortTable, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, agPortNewCfgPVID=agPortNewCfgPVID, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, portInfoPhyIfMtu=portInfoPhyIfMtu, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, portStatsIndx=portStatsIndx, trunkGroupCurCfgState=trunkGroupCurCfgState, pmNewCfgMirroredPort=pmNewCfgMirroredPort, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, portStatsTable=portStatsTable, trunkgroup=trunkgroup, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portInfoMode=portInfoMode, stgCurCfgPortTable=stgCurCfgPortTable, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, vlanCurCfgStg=vlanCurCfgStg, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, vlans=vlans, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, agPortCurCfgTable=agPortCurCfgTable, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, agPortCurCfgPVID=agPortCurCfgPVID, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, agPortNewCfgPortName=agPortNewCfgPortName, vlanNewCfgTable=vlanNewCfgTable, agPortTableMaxEnt=agPortTableMaxEnt, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgPortState=stgNewCfgPortState, portInfoFlowCtrl=portInfoFlowCtrl, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, agPortNewCfgIndx=agPortNewCfgIndx, agPortNewCfgBackLink=agPortNewCfgBackLink, stgNewCfgState=stgNewCfgState, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, portInfoLink=portInfoLink, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portInfoSpeed=portInfoSpeed, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanNewCfgJumbo=vlanNewCfgJumbo, agPortCurCfgBwmContract=agPortCurCfgBwmContract, stgCurCfgIndex=stgCurCfgIndex, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, portStatsTableEntry=portStatsTableEntry, vlanMaxEnt=vlanMaxEnt, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, stgCurCfgState=stgCurCfgState, portInfoTableEntry=portInfoTableEntry, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, vlanCurCfgState=vlanCurCfgState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, pmCurCfgTimeout=pmCurCfgTimeout, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanCurCfgTable=vlanCurCfgTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, agPortNewCfgRmon=agPortNewCfgRmon, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, agPortCurCfgPrefLink=agPortCurCfgPrefLink, agPortConfig=agPortConfig, stgCurCfgTableEntry=stgCurCfgTableEntry, portmirroring=portmirroring, agPortCurCfgBackLink=agPortCurCfgBackLink, agPortNewCfgPrefLink=agPortNewCfgPrefLink, stgCurCfgPortState=stgCurCfgPortState, portInfoTable=portInfoTable, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portInfoPhyIfType=portInfoPhyIfType)
