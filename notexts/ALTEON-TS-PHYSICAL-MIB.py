...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgTable=stgCurCfgTable, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, pmNewCfgMirroredPort=pmNewCfgMirroredPort, trunkgroup=trunkgroup, vlanNewCfgTableEntry=vlanNewCfgTableEntry, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, agPortCurCfgBwmContract=agPortCurCfgBwmContract, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portStatsTable=portStatsTable, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, portCpuStatsUtilIndx=portCpuStatsUtilIndx, vlanCurCfgTable=vlanCurCfgTable, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, stgNewCfgStgIndex=stgNewCfgStgIndex, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portCpuStatsUtilTable=portCpuStatsUtilTable, mirrVlanMirr=mirrVlanMirr, agPortNewCfgPrefLink=agPortNewCfgPrefLink, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portInfoMode=portInfoMode, portStatsTableEntry=portStatsTableEntry, portStatsPhyIfInOctets=portStatsPhyIfInOctets, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanNewCfgState=vlanNewCfgState, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, pmNewCfgTimeout=pmNewCfgTimeout, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, mirrOperTimeout=mirrOperTimeout, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, stgCurCfgPortState=stgCurCfgPortState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portStatsPhyIfInErrors=portStatsPhyIfInErrors, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgTable=vlanNewCfgTable, agPortNewCfgPortName=agPortNewCfgPortName, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanNewCfgPorts=vlanNewCfgPorts, vlanCurCfgVlanId=vlanCurCfgVlanId, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, portInfoPhyIfLastChange=portInfoPhyIfLastChange, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, port_info=port_info, trunkGroupCurCfgTable=trunkGroupCurCfgTable, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, port_stats=port_stats, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, agPortCurCfgTableEntry=agPortCurCfgTableEntry, agPortCurCfgVlanTag=agPortCurCfgVlanTag, agPortNewCfgPVID=agPortNewCfgPVID, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, portInfoLink=portInfoLink, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, agPortNewCfgRmon=agPortNewCfgRmon, agPortCurCfgPVID=agPortCurCfgPVID, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, agPortNewCfgIndx=agPortNewCfgIndx, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, agPortCurCfgBackLink=agPortCurCfgBackLink, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, agPortNewCfgVlanTag=agPortNewCfgVlanTag, agPortCurCfgRmon=agPortCurCfgRmon, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, vlans=vlans, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, stgCurCfgStgIndex=stgCurCfgStgIndex, mirrOper=mirrOper, pmNewCfgState=pmNewCfgState, stgNewCfgTableEntry=stgNewCfgTableEntry, portmirroring=portmirroring, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, portStatsIndx=portStatsIndx, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, agPortTableMaxEnt=agPortTableMaxEnt, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgNewCfgState=stgNewCfgState, portInfoPhyIfDescr=portInfoPhyIfDescr, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, stgCurCfgIndex=stgCurCfgIndex, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, stgCurCfgPortTable=stgCurCfgPortTable, mirrOperMirroredPort=mirrOperMirroredPort, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, mirroring=mirroring, agPortNewCfgTable=agPortNewCfgTable, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, agPortNewCfgState=agPortNewCfgState, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, portInfoTable=portInfoTable, agPortCurCfgState=agPortCurCfgState, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, pmNewCfgPortMirrState=pmNewCfgPortMirrState, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, vlanNewCfgJumbo=vlanNewCfgJumbo, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, agPortNewCfgBackLink=agPortNewCfgBackLink, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, vlanNewCfgStg=vlanNewCfgStg, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, portInfoSpeed=portInfoSpeed, portInfoFlowCtrl=portInfoFlowCtrl, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgPortState=stgNewCfgPortState, stgNewCfgAddVlan=stgNewCfgAddVlan, stgCurCfgPortIndex=stgCurCfgPortIndex, stgNewCfgTable=stgNewCfgTable, agPortCurCfgPrefLink=agPortCurCfgPrefLink, mirrOperType=mirrOperType, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, portInfoPhyIfMtu=portInfoPhyIfMtu, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, stgNewCfgIndex=stgNewCfgIndex, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, vlanCurCfgPorts=vlanCurCfgPorts, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgPortTable=stgNewCfgPortTable, vlanCurCfgJumbo=vlanCurCfgJumbo, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, portCpuStats=portCpuStats, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanMaxEnt=vlanMaxEnt, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, mirrOperState=mirrOperState, agPortNewCfgBwmContract=agPortNewCfgBwmContract, pmCurCfgMirroredPort=pmCurCfgMirroredPort, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, pmCurCfgTimeout=pmCurCfgTimeout, mirrOperMonitoringPort=mirrOperMonitoringPort, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, agPortCurCfgTable=agPortCurCfgTable, agPortCurCfgStp=agPortCurCfgStp, agPortConfig=agPortConfig, agPortCurCfgIndx=agPortCurCfgIndx, mirrPortMirr=mirrPortMirr, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgState=stgCurCfgState, portInfoIndx=portInfoIndx, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, pmCurCfgState=pmCurCfgState, vlanCurCfgState=vlanCurCfgState, vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgPortIndex=stgNewCfgPortIndex, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portInfoTableEntry=portInfoTableEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portInfoPhyIfType=portInfoPhyIfType, agPortNewCfgStp=agPortNewCfgStp, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, vlanNewCfgVlanId=vlanNewCfgVlanId, agPortNewCfgTableEntry=agPortNewCfgTableEntry, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, spannTreeGrpCfg=spannTreeGrpCfg, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgCurCfgTableEntry=stgCurCfgTableEntry, agPortCurCfgPortName=agPortCurCfgPortName)
