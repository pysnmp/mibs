...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", pmCurCfgMirroredPort=pmCurCfgMirroredPort, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, portInfoPhyIfDescr=portInfoPhyIfDescr, portStatsPhyIfInErrors=portStatsPhyIfInErrors, agPortNewCfgIndx=agPortNewCfgIndx, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, agPortNewCfgBackLink=agPortNewCfgBackLink, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, mirrOper=mirrOper, pmNewCfgTimeout=pmNewCfgTimeout, agPortNewCfgPortName=agPortNewCfgPortName, portInfoMode=portInfoMode, stgNewCfgAddVlan=stgNewCfgAddVlan, trunkGroupNewCfgState=trunkGroupNewCfgState, agPortCurCfgBackLink=agPortCurCfgBackLink, agPortCurCfgVlanTag=agPortCurCfgVlanTag, vlanNewCfgPorts=vlanNewCfgPorts, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, portCpuStats=portCpuStats, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmCurCfgState=pmCurCfgState, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mirrOperMirroredPort=mirrOperMirroredPort, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, stgNewCfgPortTable=stgNewCfgPortTable, agPortCurCfgTableEntry=agPortCurCfgTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, trunkGroupTableMaxSize=trunkGroupTableMaxSize, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, agPortNewCfgVlanTag=agPortNewCfgVlanTag, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, vlanCurCfgState=vlanCurCfgState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portInfoPhyIfLastChange=portInfoPhyIfLastChange, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanCurCfgVlanId=vlanCurCfgVlanId, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, agPortCurCfgIndx=agPortCurCfgIndx, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanCurCfgStg=vlanCurCfgStg, portStatsTableEntry=portStatsTableEntry, agPortNewCfgPrefLink=agPortNewCfgPrefLink, trunkGroupCurCfgState=trunkGroupCurCfgState, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, agPortTableMaxEnt=agPortTableMaxEnt, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, vlanCurCfgVlanName=vlanCurCfgVlanName, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portInfoTableEntry=portInfoTableEntry, agPortCurCfgPortName=agPortCurCfgPortName, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmNewCfgState=pmNewCfgState, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, vlanCurCfgTableEntry=vlanCurCfgTableEntry, agPortCurCfgRmon=agPortCurCfgRmon, vlanMaxEnt=vlanMaxEnt, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, stgCurCfgPortIndex=stgCurCfgPortIndex, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, vlanCurCfgJumbo=vlanCurCfgJumbo, agPortCurCfgBwmContract=agPortCurCfgBwmContract, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, trunkgroup=trunkgroup, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgCurCfgPortTable=stgCurCfgPortTable, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgTable=stgNewCfgTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, agPortCurCfgPrefLink=agPortCurCfgPrefLink, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortCurCfgStp=agPortCurCfgStp, portStatsPhyIfInOctets=portStatsPhyIfInOctets, stgCurCfgIndex=stgCurCfgIndex, mirrPortMirr=mirrPortMirr, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgCurCfgTableEntry=stgCurCfgTableEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portmirroring=portmirroring, portInfoFlowCtrl=portInfoFlowCtrl, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, agPortConfig=agPortConfig, stgNewCfgIndex=stgNewCfgIndex, portStatsIndx=portStatsIndx, mirrVlanMirr=mirrVlanMirr, portInfoLink=portInfoLink, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, vlanNewCfgVlanName=vlanNewCfgVlanName, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, stgNewCfgState=stgNewCfgState, vlanCurCfgTable=vlanCurCfgTable, agPortNewCfgState=agPortNewCfgState, mirrOperType=mirrOperType, mirroring=mirroring, stgCurCfgState=stgCurCfgState, portStatsTable=portStatsTable, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, portInfoTable=portInfoTable, agPortNewCfgTableEntry=agPortNewCfgTableEntry, vlanNewCfgState=vlanNewCfgState, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, spannTreeGrpCfg=spannTreeGrpCfg, portCpuStatsUtilTable=portCpuStatsUtilTable, pmNewCfgMirroredPort=pmNewCfgMirroredPort, agPortCurCfgTable=agPortCurCfgTable, stgCurCfgTable=stgCurCfgTable, port_stats=port_stats, portInfoPhyIfMtu=portInfoPhyIfMtu, vlanCurCfgPorts=vlanCurCfgPorts, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, agPortNewCfgBwmContract=agPortNewCfgBwmContract, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, portInfoIndx=portInfoIndx, agPortNewCfgRmon=agPortNewCfgRmon, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, vlanNewCfgJumbo=vlanNewCfgJumbo, vlans=vlans, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mirrOperMonitoringPort=mirrOperMonitoringPort, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, agPortNewCfgPVID=agPortNewCfgPVID, stgCurCfgPortState=stgCurCfgPortState, mirrOperState=mirrOperState, mirrOperTimeout=mirrOperTimeout, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanNewCfgStg=vlanNewCfgStg, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, agPortNewCfgTable=agPortNewCfgTable, agPortCurCfgPVID=agPortCurCfgPVID, agPortCurCfgState=agPortCurCfgState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, port_info=port_info, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, pmCurCfgTimeout=pmCurCfgTimeout, vlanNewCfgTable=vlanNewCfgTable, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, portCpuStatsUtilIndx=portCpuStatsUtilIndx, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, agPortNewCfgStp=agPortNewCfgStp, stgNewCfgPortIndex=stgNewCfgPortIndex, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, portInfoPhyIfType=portInfoPhyIfType, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgNewCfgPortState=stgNewCfgPortState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portInfoSpeed=portInfoSpeed, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgStgIndex=stgNewCfgStgIndex, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry)
