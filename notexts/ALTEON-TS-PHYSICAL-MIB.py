...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanNewCfgState=vlanNewCfgState, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupNewCfgState=trunkGroupNewCfgState, portStatsPhyIfInErrors=portStatsPhyIfInErrors, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, portInfoMode=portInfoMode, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortCurCfgBwmContract=agPortCurCfgBwmContract, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, mirrOperType=mirrOperType, stgNewCfgPortTable=stgNewCfgPortTable, portInfoTableEntry=portInfoTableEntry, portCpuStats=portCpuStats, vlanCurCfgTable=vlanCurCfgTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanCurCfgVlanName=vlanCurCfgVlanName, portInfoPhyIfLastChange=portInfoPhyIfLastChange, portStatsIndx=portStatsIndx, portInfoPhyIfMtu=portInfoPhyIfMtu, portInfoPhyIfType=portInfoPhyIfType, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, agPortNewCfgPrefLink=agPortNewCfgPrefLink, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, vlanNewCfgAddPort=vlanNewCfgAddPort, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, agPortTableMaxEnt=agPortTableMaxEnt, portmirroring=portmirroring, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, stgCurCfgPortState=stgCurCfgPortState, stgCurCfgIndex=stgCurCfgIndex, portCpuStatsUtilTable=portCpuStatsUtilTable, portStatsTable=portStatsTable, stgCurCfgState=stgCurCfgState, stgNewCfgAddVlan=stgNewCfgAddVlan, pmCurCfgState=pmCurCfgState, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, mirrOperMirroredPort=mirrOperMirroredPort, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, trunkGroupCurCfgState=trunkGroupCurCfgState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portInfoPhyIfDescr=portInfoPhyIfDescr, port_stats=port_stats, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgCurCfgPortTable=stgCurCfgPortTable, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portInfoIndx=portInfoIndx, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, agPortNewCfgIndx=agPortNewCfgIndx, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, agPortNewCfgBackLink=agPortNewCfgBackLink, agPortCurCfgPortName=agPortCurCfgPortName, vlanNewCfgStg=vlanNewCfgStg, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, agPortNewCfgVlanTag=agPortNewCfgVlanTag, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, vlanCurCfgJumbo=vlanCurCfgJumbo, portStatsTableEntry=portStatsTableEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, agPortCurCfgVlanTag=agPortCurCfgVlanTag, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, agPortNewCfgStp=agPortNewCfgStp, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, stgNewCfgStgIndex=stgNewCfgStgIndex, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, pmNewCfgState=pmNewCfgState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanMaxEnt=vlanMaxEnt, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, trunkgroup=trunkgroup, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, vlanNewCfgVlanName=vlanNewCfgVlanName, mirrOperTimeout=mirrOperTimeout, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, pmNewCfgMirroredPort=pmNewCfgMirroredPort, mirrVlanMirr=mirrVlanMirr, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, stgNewCfgTable=stgNewCfgTable, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, vlanNewCfgDelete=vlanNewCfgDelete, stgCurCfgStgIndex=stgCurCfgStgIndex, agPortNewCfgTable=agPortNewCfgTable, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, agPortNewCfgBwmContract=agPortNewCfgBwmContract, agPortCurCfgRmon=agPortCurCfgRmon, stgCurCfgTableEntry=stgCurCfgTableEntry, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, vlanNewCfgPorts=vlanNewCfgPorts, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, agPortCurCfgStp=agPortCurCfgStp, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, agPortCurCfgBackLink=agPortCurCfgBackLink, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, mirrOper=mirrOper, agPortCurCfgPrefLink=agPortCurCfgPrefLink, agPortCurCfgIndx=agPortCurCfgIndx, vlanCurCfgPorts=vlanCurCfgPorts, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, portCpuStatsUtilIndx=portCpuStatsUtilIndx, stgNewCfgState=stgNewCfgState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, agPortNewCfgPortName=agPortNewCfgPortName, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, vlanNewCfgTableEntry=vlanNewCfgTableEntry, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, portStatsPhyIfInOctets=portStatsPhyIfInOctets, agPortConfig=agPortConfig, agPortNewCfgRmon=agPortNewCfgRmon, stgNewCfgPortIndex=stgNewCfgPortIndex, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portInfoTable=portInfoTable, stgCurCfgTable=stgCurCfgTable, agPortCurCfgPVID=agPortCurCfgPVID, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, agPortCurCfgTable=agPortCurCfgTable, portInfoFlowCtrl=portInfoFlowCtrl, vlanNewCfgTable=vlanNewCfgTable, portInfoLink=portInfoLink, stgNewCfgPortState=stgNewCfgPortState, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, pmNewCfgTimeout=pmNewCfgTimeout, agPortNewCfgState=agPortNewCfgState, stgNewCfgIndex=stgNewCfgIndex, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, port_info=port_info, vlans=vlans, agPortCurCfgTableEntry=agPortCurCfgTableEntry, vlanCurCfgStg=vlanCurCfgStg, mirroring=mirroring, portInfoSpeed=portInfoSpeed, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, agPortNewCfgPVID=agPortNewCfgPVID, mirrOperState=mirrOperState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, spannTreeGrpCfg=spannTreeGrpCfg, vlanCurCfgState=vlanCurCfgState, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, agPortCurCfgState=agPortCurCfgState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, pmCurCfgMirroredPort=pmCurCfgMirroredPort, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, pmCurCfgTimeout=pmCurCfgTimeout, stgNewCfgTableEntry=stgNewCfgTableEntry, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, mirrPortMirr=mirrPortMirr, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, agPortNewCfgTableEntry=agPortNewCfgTableEntry, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState)
