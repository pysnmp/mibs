...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, mirrOperMonitoringPort=mirrOperMonitoringPort, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlans=vlans, vlanNewCfgState=vlanNewCfgState, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, agPortNewCfgTable=agPortNewCfgTable, stgCurCfgState=stgCurCfgState, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgCurCfgPortTable=stgCurCfgPortTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, port_stats=port_stats, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mirrVlanMirr=mirrVlanMirr, vlanNewCfgVlanName=vlanNewCfgVlanName, portInfoSpeed=portInfoSpeed, stgCurCfgTableEntry=stgCurCfgTableEntry, portmirroring=portmirroring, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, portInfoPhyIfLastChange=portInfoPhyIfLastChange, vlanCurCfgState=vlanCurCfgState, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, vlanNewCfgStg=vlanNewCfgStg, agPortCurCfgPrefLink=agPortCurCfgPrefLink, portInfoPhyIfType=portInfoPhyIfType, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, portInfoMode=portInfoMode, mirrOperTimeout=mirrOperTimeout, stgCurCfgTable=stgCurCfgTable, portInfoTableEntry=portInfoTableEntry, portStatsTable=portStatsTable, vlanCurCfgVlanId=vlanCurCfgVlanId, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, mirrOperMirroredPort=mirrOperMirroredPort, vlanCurCfgStg=vlanCurCfgStg, mirrOperType=mirrOperType, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, portInfoPhyIfDescr=portInfoPhyIfDescr, trunkGroupNewCfgTable=trunkGroupNewCfgTable, agPortNewCfgStp=agPortNewCfgStp, vlanNewCfgJumbo=vlanNewCfgJumbo, portStatsIndx=portStatsIndx, agPortNewCfgTableEntry=agPortNewCfgTableEntry, vlanCurCfgJumbo=vlanCurCfgJumbo, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, agPortNewCfgPrefLink=agPortNewCfgPrefLink, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, pmNewCfgPortMirrState=pmNewCfgPortMirrState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmCurCfgTimeout=pmCurCfgTimeout, portCpuStats=portCpuStats, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanNewCfgDelete=vlanNewCfgDelete, agPortNewCfgBackLink=agPortNewCfgBackLink, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, agPortCurCfgRmon=agPortCurCfgRmon, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkgroup=trunkgroup, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, stgCurCfgPortState=stgCurCfgPortState, stgNewCfgTable=stgNewCfgTable, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, port_info=port_info, agPortCurCfgBwmContract=agPortCurCfgBwmContract, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, mirrPortMirr=mirrPortMirr, agPortCurCfgStp=agPortCurCfgStp, pmNewCfgMirroredPort=pmNewCfgMirroredPort, stgCurCfgStgIndex=stgCurCfgStgIndex, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, agPortConfig=agPortConfig, mirrOper=mirrOper, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, agPortNewCfgPVID=agPortNewCfgPVID, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, portInfoPhyIfMtu=portInfoPhyIfMtu, portInfoTable=portInfoTable, mirrOperState=mirrOperState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portInfoIndx=portInfoIndx, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, agPortCurCfgPVID=agPortCurCfgPVID, vlanNewCfgAddPort=vlanNewCfgAddPort, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, agPortNewCfgVlanTag=agPortNewCfgVlanTag, agPortNewCfgBwmContract=agPortNewCfgBwmContract, agPortNewCfgRmon=agPortNewCfgRmon, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgPortState=stgNewCfgPortState, pmCurCfgState=pmCurCfgState, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, agPortCurCfgTableEntry=agPortCurCfgTableEntry, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, stgNewCfgIndex=stgNewCfgIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlanMaxEnt=vlanMaxEnt, vlanNewCfgPorts=vlanNewCfgPorts, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, agPortNewCfgPortName=agPortNewCfgPortName, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, stgNewCfgState=stgNewCfgState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, vlanNewCfgTable=vlanNewCfgTable, portStatsPhyIfInErrors=portStatsPhyIfInErrors, pmNewCfgState=pmNewCfgState, pmCurCfgMirroredPort=pmCurCfgMirroredPort, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portInfoFlowCtrl=portInfoFlowCtrl, agPortCurCfgState=agPortCurCfgState, agPortCurCfgIndx=agPortCurCfgIndx, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, agPortCurCfgBackLink=agPortCurCfgBackLink, portInfoLink=portInfoLink, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, trunkGroupCurCfgTable=trunkGroupCurCfgTable, agPortCurCfgTable=agPortCurCfgTable, mirroring=mirroring, portStatsPhyIfInOctets=portStatsPhyIfInOctets, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanCurCfgTable=vlanCurCfgTable, agPortCurCfgVlanTag=agPortCurCfgVlanTag, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, agPortNewCfgIndx=agPortNewCfgIndx, agPortNewCfgState=agPortNewCfgState, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, agPortTableMaxEnt=agPortTableMaxEnt, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, agPortCurCfgPortName=agPortCurCfgPortName, pmCurCfgPortMirrState=pmCurCfgPortMirrState, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgPortIndex=stgCurCfgPortIndex, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, stgNewCfgPortTable=stgNewCfgPortTable, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, pmNewCfgTimeout=pmNewCfgTimeout, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, portCpuStatsUtilTable=portCpuStatsUtilTable, spannTreeGrpCfg=spannTreeGrpCfg, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, portCpuStatsUtilIndx=portCpuStatsUtilIndx, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, portStatsTableEntry=portStatsTableEntry, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed)
