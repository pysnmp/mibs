...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, mirroring=mirroring, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, vlanNewCfgState=vlanNewCfgState, stgCurCfgPortTable=stgCurCfgPortTable, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portInfoPhyIfType=portInfoPhyIfType, portInfoPhyIfLastChange=portInfoPhyIfLastChange, agPortNewCfgIndx=agPortNewCfgIndx, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmCurCfgMirroredPort=pmCurCfgMirroredPort, stgNewCfgIndex=stgNewCfgIndex, vlanMaxEnt=vlanMaxEnt, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, portmirroring=portmirroring, port_stats=port_stats, stgNewCfgPortTable=stgNewCfgPortTable, mirrOperType=mirrOperType, spannTreeGrpCfg=spannTreeGrpCfg, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, portInfoPhyIfDescr=portInfoPhyIfDescr, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, portInfoMode=portInfoMode, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgPortIndex=stgNewCfgPortIndex, agPortCurCfgTableEntry=agPortCurCfgTableEntry, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, agPortCurCfgStp=agPortCurCfgStp, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, agPortNewCfgBwmContract=agPortNewCfgBwmContract, mirrPortMirr=mirrPortMirr, portInfoIndx=portInfoIndx, stgCurCfgPortState=stgCurCfgPortState, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, portStatsPhyIfInOctets=portStatsPhyIfInOctets, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, agPortCurCfgBwmContract=agPortCurCfgBwmContract, mirrOperMirroredPort=mirrOperMirroredPort, portInfoTable=portInfoTable, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, trunkGroupNewCfgState=trunkGroupNewCfgState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, vlanCurCfgTable=vlanCurCfgTable, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portInfoSpeed=portInfoSpeed, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, mirrOper=mirrOper, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgNewCfgStgIndex=stgNewCfgStgIndex, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, mirrOperMonitoringPort=mirrOperMonitoringPort, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, stgNewCfgState=stgNewCfgState, vlanNewCfgVlanName=vlanNewCfgVlanName, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgTableEntry=stgNewCfgTableEntry, agPortCurCfgPrefLink=agPortCurCfgPrefLink, mirrOperTimeout=mirrOperTimeout, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, vlanNewCfgAddPort=vlanNewCfgAddPort, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgPortState=stgNewCfgPortState, vlanNewCfgJumbo=vlanNewCfgJumbo, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, agPortNewCfgTableEntry=agPortNewCfgTableEntry, portStatsPhyIfInErrors=portStatsPhyIfInErrors, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanCurCfgVlanName=vlanCurCfgVlanName, agPortCurCfgRmon=agPortCurCfgRmon, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, vlanCurCfgPorts=vlanCurCfgPorts, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, stgCurCfgTable=stgCurCfgTable, stgNewCfgTable=stgNewCfgTable, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, portInfoTableEntry=portInfoTableEntry, portCpuStatsUtilIndx=portCpuStatsUtilIndx, vlanNewCfgVlanId=vlanNewCfgVlanId, pmNewCfgTimeout=pmNewCfgTimeout, agPortCurCfgPVID=agPortCurCfgPVID, agPortCurCfgTable=agPortCurCfgTable, trunkgroup=trunkgroup, vlanCurCfgVlanId=vlanCurCfgVlanId, portInfoFlowCtrl=portInfoFlowCtrl, agPortNewCfgTable=agPortNewCfgTable, portStatsTableEntry=portStatsTableEntry, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, portStatsTable=portStatsTable, agPortNewCfgPVID=agPortNewCfgPVID, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, portCpuStatsUtilTable=portCpuStatsUtilTable, agPortConfig=agPortConfig, agPortNewCfgBackLink=agPortNewCfgBackLink, vlanNewCfgStg=vlanNewCfgStg, agPortNewCfgState=agPortNewCfgState, agPortCurCfgVlanTag=agPortCurCfgVlanTag, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, pmNewCfgState=pmNewCfgState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgIndex=stgCurCfgIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, agPortCurCfgBackLink=agPortCurCfgBackLink, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlans=vlans, pmCurCfgTimeout=pmCurCfgTimeout, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmNewCfgMirroredPort=pmNewCfgMirroredPort, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, stgCurCfgState=stgCurCfgState, portStatsIndx=portStatsIndx, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmCurCfgState=pmCurCfgState, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, agPortNewCfgPrefLink=agPortNewCfgPrefLink, agPortNewCfgVlanTag=agPortNewCfgVlanTag, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, agPortCurCfgState=agPortCurCfgState, trunkGroupCurCfgState=trunkGroupCurCfgState, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, agPortCurCfgIndx=agPortCurCfgIndx, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portInfoLink=portInfoLink, mirrVlanMirr=mirrVlanMirr, agPortTableMaxEnt=agPortTableMaxEnt, vlanNewCfgTableEntry=vlanNewCfgTableEntry, agPortCurCfgPortName=agPortCurCfgPortName, stgCurCfgPortIndex=stgCurCfgPortIndex, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, mirrOperState=mirrOperState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, portCpuStats=portCpuStats, agPortNewCfgStp=agPortNewCfgStp, portInfoPhyIfMtu=portInfoPhyIfMtu, agPortNewCfgRmon=agPortNewCfgRmon, agPortNewCfgPortName=agPortNewCfgPortName, port_info=port_info, vlanCurCfgJumbo=vlanCurCfgJumbo, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanCurCfgState=vlanCurCfgState, vlanCurCfgStg=vlanCurCfgStg, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards)
