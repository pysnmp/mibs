...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", stgCurCfgIndex=stgCurCfgIndex, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, agPortNewCfgPortName=agPortNewCfgPortName, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mirrOperMirroredPort=mirrOperMirroredPort, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgTable=stgNewCfgTable, vlanNewCfgVlanName=vlanNewCfgVlanName, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, agPortCurCfgTableEntry=agPortCurCfgTableEntry, stgNewCfgState=stgNewCfgState, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, portInfoPhyIfMtu=portInfoPhyIfMtu, stgNewCfgTableEntry=stgNewCfgTableEntry, port_info=port_info, pmNewCfgMirroredPort=pmNewCfgMirroredPort, mirrPortMirr=mirrPortMirr, vlanMaxEnt=vlanMaxEnt, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, vlanNewCfgJumbo=vlanNewCfgJumbo, agPortCurCfgStp=agPortCurCfgStp, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgCurCfgPortIndex=stgCurCfgPortIndex, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, portInfoMode=portInfoMode, mirrOperState=mirrOperState, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, agPortCurCfgPrefLink=agPortCurCfgPrefLink, portInfoIndx=portInfoIndx, portmirroring=portmirroring, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portStatsIndx=portStatsIndx, agPortNewCfgBwmContract=agPortNewCfgBwmContract, agPortCurCfgVlanTag=agPortCurCfgVlanTag, agPortNewCfgState=agPortNewCfgState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, agPortConfig=agPortConfig, vlanCurCfgJumbo=vlanCurCfgJumbo, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, agPortNewCfgPrefLink=agPortNewCfgPrefLink, trunkGroupNewCfgState=trunkGroupNewCfgState, vlans=vlans, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, vlanNewCfgAddPort=vlanNewCfgAddPort, pmNewCfgPortMirrState=pmNewCfgPortMirrState, agPortNewCfgStp=agPortNewCfgStp, stgCurCfgTableEntry=stgCurCfgTableEntry, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgAddVlan=stgNewCfgAddVlan, agPortNewCfgPVID=agPortNewCfgPVID, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, stgCurCfgPortState=stgCurCfgPortState, portInfoPhyIfLastChange=portInfoPhyIfLastChange, mirrVlanMirr=mirrVlanMirr, vlanCurCfgState=vlanCurCfgState, stgNewCfgIndex=stgNewCfgIndex, vlanNewCfgPorts=vlanNewCfgPorts, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, agPortNewCfgIndx=agPortNewCfgIndx, agPortNewCfgTable=agPortNewCfgTable, vlanCurCfgTable=vlanCurCfgTable, trunkgroup=trunkgroup, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, agPortCurCfgIndx=agPortCurCfgIndx, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, agPortTableMaxEnt=agPortTableMaxEnt, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmCurCfgState=pmCurCfgState, portCpuStats=portCpuStats, portCpuStatsUtilIndx=portCpuStatsUtilIndx, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, portInfoPhyIfType=portInfoPhyIfType, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, agPortNewCfgVlanTag=agPortNewCfgVlanTag, portInfoSpeed=portInfoSpeed, mirrOperType=mirrOperType, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, stgCurCfgState=stgCurCfgState, mirroring=mirroring, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, agPortCurCfgBwmContract=agPortCurCfgBwmContract, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, stgNewCfgPortState=stgNewCfgPortState, portInfoLink=portInfoLink, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, portInfoFlowCtrl=portInfoFlowCtrl, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, agPortCurCfgState=agPortCurCfgState, vlanCurCfgVlanName=vlanCurCfgVlanName, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, stgCurCfgPortTable=stgCurCfgPortTable, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, spannTreeGrpCfg=spannTreeGrpCfg, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mirrOper=mirrOper, vlanCurCfgStg=vlanCurCfgStg, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portCpuStatsUtilTable=portCpuStatsUtilTable, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, portInfoTableEntry=portInfoTableEntry, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, vlanCurCfgVlanId=vlanCurCfgVlanId, pmCurCfgMirroredPort=pmCurCfgMirroredPort, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, stgNewCfgPortIndex=stgNewCfgPortIndex, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, port_stats=port_stats, agPortNewCfgTableEntry=agPortNewCfgTableEntry, vlanNewCfgState=vlanNewCfgState, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, agPortCurCfgTable=agPortCurCfgTable, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgStgIndex=stgNewCfgStgIndex, portStatsPhyIfInErrors=portStatsPhyIfInErrors, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanCurCfgPorts=vlanCurCfgPorts, portInfoTable=portInfoTable, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, agPortCurCfgRmon=agPortCurCfgRmon, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portStatsPhyIfInOctets=portStatsPhyIfInOctets, vlanNewCfgStg=vlanNewCfgStg, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, mirrOperTimeout=mirrOperTimeout, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, portStatsTable=portStatsTable, pmNewCfgTimeout=pmNewCfgTimeout, vlanNewCfgVlanId=vlanNewCfgVlanId, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, stgNewCfgPortTable=stgNewCfgPortTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmNewCfgState=pmNewCfgState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, agPortCurCfgBackLink=agPortCurCfgBackLink, trunkGroupCurCfgState=trunkGroupCurCfgState, portInfoPhyIfDescr=portInfoPhyIfDescr, stgCurCfgTable=stgCurCfgTable, pmCurCfgTimeout=pmCurCfgTimeout, agPortCurCfgPVID=agPortCurCfgPVID, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portStatsTableEntry=portStatsTableEntry, agPortCurCfgPortName=agPortCurCfgPortName, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, agPortNewCfgBackLink=agPortNewCfgBackLink, vlanNewCfgTable=vlanNewCfgTable, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, agPortNewCfgRmon=agPortNewCfgRmon)
