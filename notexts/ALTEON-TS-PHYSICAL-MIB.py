...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, agPortNewCfgRmon=agPortNewCfgRmon, vlans=vlans, pmCurCfgPortMirrState=pmCurCfgPortMirrState, agPortCurCfgStp=agPortCurCfgStp, agPortNewCfgIndx=agPortNewCfgIndx, vlanCurCfgJumbo=vlanCurCfgJumbo, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, agPortCurCfgPrefLink=agPortCurCfgPrefLink, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, agPortCurCfgVlanTag=agPortCurCfgVlanTag, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, vlanNewCfgTable=vlanNewCfgTable, agPortNewCfgPVID=agPortNewCfgPVID, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, agPortConfig=agPortConfig, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, agPortCurCfgRmon=agPortCurCfgRmon, stgNewCfgStgIndex=stgNewCfgStgIndex, portCpuStatsUtilTable=portCpuStatsUtilTable, portInfoPhyIfLastChange=portInfoPhyIfLastChange, portStatsPhyIfInErrors=portStatsPhyIfInErrors, portInfoMode=portInfoMode, pmNewCfgState=pmNewCfgState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, agPortTableMaxEnt=agPortTableMaxEnt, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mirrOper=mirrOper, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupCurCfgTable=trunkGroupCurCfgTable, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, agPortNewCfgTable=agPortNewCfgTable, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, stgNewCfgTable=stgNewCfgTable, trunkGroupNewCfgState=trunkGroupNewCfgState, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, agPortCurCfgPVID=agPortCurCfgPVID, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mirrOperTimeout=mirrOperTimeout, agPortCurCfgState=agPortCurCfgState, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, vlanNewCfgState=vlanNewCfgState, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, agPortNewCfgBackLink=agPortNewCfgBackLink, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, portInfoPhyIfType=portInfoPhyIfType, stgNewCfgTableEntry=stgNewCfgTableEntry, mirrVlanMirr=mirrVlanMirr, stgNewCfgPortTable=stgNewCfgPortTable, agPortNewCfgStp=agPortNewCfgStp, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, mirrPortMirr=mirrPortMirr, agPortNewCfgPrefLink=agPortNewCfgPrefLink, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, stgCurCfgPortState=stgCurCfgPortState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mirroring=mirroring, agPortNewCfgPortName=agPortNewCfgPortName, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, spannTreeGrpCfg=spannTreeGrpCfg, vlanCurCfgStg=vlanCurCfgStg, portInfoPhyIfMtu=portInfoPhyIfMtu, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, vlanCurCfgState=vlanCurCfgState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portInfoLink=portInfoLink, trunkGroupCurCfgState=trunkGroupCurCfgState, pmNewCfgMirroredPort=pmNewCfgMirroredPort, mirrOperMirroredPort=mirrOperMirroredPort, agPortCurCfgBwmContract=agPortCurCfgBwmContract, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, portCpuStatsUtilIndx=portCpuStatsUtilIndx, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, vlanNewCfgPorts=vlanNewCfgPorts, portStatsTable=portStatsTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, pmCurCfgMirroredPort=pmCurCfgMirroredPort, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmCurCfgState=pmCurCfgState, port_stats=port_stats, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, stgNewCfgPortState=stgNewCfgPortState, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, portInfoPhyIfDescr=portInfoPhyIfDescr, portmirroring=portmirroring, vlanNewCfgVlanId=vlanNewCfgVlanId, agPortCurCfgTable=agPortCurCfgTable, port_info=port_info, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, portStatsIndx=portStatsIndx, agPortNewCfgTableEntry=agPortNewCfgTableEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanNewCfgDelete=vlanNewCfgDelete, agPortNewCfgState=agPortNewCfgState, mirrOperType=mirrOperType, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, agPortNewCfgVlanTag=agPortNewCfgVlanTag, vlanCurCfgTable=vlanCurCfgTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanNewCfgStg=vlanNewCfgStg, portStatsPhyIfInOctets=portStatsPhyIfInOctets, stgCurCfgTable=stgCurCfgTable, stgCurCfgTableEntry=stgCurCfgTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portStatsTableEntry=portStatsTableEntry, mirrOperState=mirrOperState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portInfoIndx=portInfoIndx, stgNewCfgIndex=stgNewCfgIndex, agPortCurCfgBackLink=agPortCurCfgBackLink, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, stgCurCfgPortIndex=stgCurCfgPortIndex, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, portInfoFlowCtrl=portInfoFlowCtrl, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, stgCurCfgPortTable=stgCurCfgPortTable, vlanMaxEnt=vlanMaxEnt, agPortCurCfgTableEntry=agPortCurCfgTableEntry, vlanNewCfgVlanName=vlanNewCfgVlanName, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanNewCfgAddPort=vlanNewCfgAddPort, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, agPortCurCfgPortName=agPortCurCfgPortName, stgCurCfgIndex=stgCurCfgIndex, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmNewCfgTimeout=pmNewCfgTimeout, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, agPortNewCfgBwmContract=agPortNewCfgBwmContract, stgCurCfgState=stgCurCfgState, stgNewCfgState=stgNewCfgState, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, trunkgroup=trunkgroup, mirrOperMonitoringPort=mirrOperMonitoringPort, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, portInfoTableEntry=portInfoTableEntry, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, agPortCurCfgIndx=agPortCurCfgIndx, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanCurCfgPorts=vlanCurCfgPorts, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, pmCurCfgTimeout=pmCurCfgTimeout, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgAddVlan=stgNewCfgAddVlan, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, portCpuStats=portCpuStats, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, portInfoSpeed=portInfoSpeed, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, portInfoTable=portInfoTable, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode)
