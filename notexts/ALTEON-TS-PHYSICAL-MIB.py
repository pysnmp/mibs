...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", agPortNewCfgTableEntry=agPortNewCfgTableEntry, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, stgNewCfgStgIndex=stgNewCfgStgIndex, agPortNewCfgTable=agPortNewCfgTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkgroup=trunkgroup, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, vlanNewCfgJumbo=vlanNewCfgJumbo, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanCurCfgVlanId=vlanCurCfgVlanId, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, mirroring=mirroring, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, portInfoSpeed=portInfoSpeed, agPortCurCfgBwmContract=agPortCurCfgBwmContract, vlans=vlans, trunkGroupNewCfgState=trunkGroupNewCfgState, portInfoTable=portInfoTable, vlanCurCfgState=vlanCurCfgState, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgTable=stgCurCfgTable, agPortNewCfgBwmContract=agPortNewCfgBwmContract, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, agPortCurCfgPrefLink=agPortCurCfgPrefLink, mirrOperMirroredPort=mirrOperMirroredPort, agPortCurCfgStp=agPortCurCfgStp, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, pmCurCfgMirroredPort=pmCurCfgMirroredPort, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgIndex=stgNewCfgIndex, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, mirrOperTimeout=mirrOperTimeout, stgCurCfgState=stgCurCfgState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portCpuStatsUtilIndx=portCpuStatsUtilIndx, portStatsPhyIfInOctets=portStatsPhyIfInOctets, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, portStatsIndx=portStatsIndx, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, stgCurCfgIndex=stgCurCfgIndex, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanMaxEnt=vlanMaxEnt, portStatsPhyIfInErrors=portStatsPhyIfInErrors, mirrOper=mirrOper, mirrOperMonitoringPort=mirrOperMonitoringPort, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, agPortCurCfgBackLink=agPortCurCfgBackLink, stgNewCfgTable=stgNewCfgTable, mirrPortMirr=mirrPortMirr, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, stgCurCfgPortTable=stgCurCfgPortTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgPortIndex=stgNewCfgPortIndex, portInfoTableEntry=portInfoTableEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, portInfoIndx=portInfoIndx, vlanNewCfgDelete=vlanNewCfgDelete, mirrOperType=mirrOperType, portInfoPhyIfMtu=portInfoPhyIfMtu, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, agPortNewCfgState=agPortNewCfgState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanNewCfgBwmContract=vlanNewCfgBwmContract, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, portStatsTableEntry=portStatsTableEntry, portInfoMode=portInfoMode, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, vlanCurCfgTable=vlanCurCfgTable, agPortNewCfgRmon=agPortNewCfgRmon, pmNewCfgMirroredPort=pmNewCfgMirroredPort, vlanNewCfgTable=vlanNewCfgTable, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, agPortNewCfgPrefLink=agPortNewCfgPrefLink, agPortNewCfgVlanTag=agPortNewCfgVlanTag, stgNewCfgState=stgNewCfgState, agPortTableMaxEnt=agPortTableMaxEnt, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgPortTable=stgNewCfgPortTable, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, portCpuStatsUtilTable=portCpuStatsUtilTable, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, agPortCurCfgPVID=agPortCurCfgPVID, stgCurCfgTableEntry=stgCurCfgTableEntry, port_info=port_info, pmCurCfgState=pmCurCfgState, stgNewCfgAddVlan=stgNewCfgAddVlan, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, vlanNewCfgState=vlanNewCfgState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mirrOperState=mirrOperState, agPortNewCfgPVID=agPortNewCfgPVID, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortCurCfgTable=agPortCurCfgTable, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portInfoFlowCtrl=portInfoFlowCtrl, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portmirroring=portmirroring, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlanCurCfgJumbo=vlanCurCfgJumbo, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmNewCfgTimeout=pmNewCfgTimeout, trunkGroupTableMaxSize=trunkGroupTableMaxSize, agPortCurCfgPortName=agPortCurCfgPortName, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portInfoPhyIfLastChange=portInfoPhyIfLastChange, agPortCurCfgIndx=agPortCurCfgIndx, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, agPortNewCfgIndx=agPortNewCfgIndx, agPortCurCfgVlanTag=agPortCurCfgVlanTag, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, agPortConfig=agPortConfig, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, agPortNewCfgBackLink=agPortNewCfgBackLink, agPortNewCfgPortName=agPortNewCfgPortName, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portInfoPhyIfType=portInfoPhyIfType, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, spannTreeGrpCfg=spannTreeGrpCfg, stgNewCfgPortState=stgNewCfgPortState, agPortCurCfgState=agPortCurCfgState, stgCurCfgStgIndex=stgCurCfgStgIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portStatsTable=portStatsTable, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, stgCurCfgPortState=stgCurCfgPortState, mirrVlanMirr=mirrVlanMirr, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, agPortNewCfgStp=agPortNewCfgStp, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, vlanNewCfgStg=vlanNewCfgStg, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, pmCurCfgTimeout=pmCurCfgTimeout, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portInfoLink=portInfoLink, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, pmNewCfgState=pmNewCfgState, vlanCurCfgStg=vlanCurCfgStg, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portCpuStats=portCpuStats, agPortCurCfgTableEntry=agPortCurCfgTableEntry, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, vlanNewCfgTableEntry=vlanNewCfgTableEntry, port_stats=port_stats, agPortCurCfgRmon=agPortCurCfgRmon, vlanCurCfgPorts=vlanCurCfgPorts)
