...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", agPortCurCfgVlanTag=agPortCurCfgVlanTag, vlanNewCfgState=vlanNewCfgState, pmCurCfgTimeout=pmCurCfgTimeout, stgNewCfgPortTable=stgNewCfgPortTable, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgTable=stgNewCfgTable, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, agPortConfig=agPortConfig, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, pmNewCfgState=pmNewCfgState, vlanCurCfgVlanId=vlanCurCfgVlanId, agPortNewCfgTable=agPortNewCfgTable, trunkGroupCurCfgState=trunkGroupCurCfgState, agPortTableMaxEnt=agPortTableMaxEnt, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, portCpuStats=portCpuStats, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupNewCfgState=trunkGroupNewCfgState, pmNewCfgTimeout=pmNewCfgTimeout, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortNewCfgStp=agPortNewCfgStp, vlanCurCfgTable=vlanCurCfgTable, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, vlanCurCfgJumbo=vlanCurCfgJumbo, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, stgNewCfgStgIndex=stgNewCfgStgIndex, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, stgNewCfgIndex=stgNewCfgIndex, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, portmirroring=portmirroring, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, stgNewCfgPortState=stgNewCfgPortState, stgCurCfgPortState=stgCurCfgPortState, agPortNewCfgPrefLink=agPortNewCfgPrefLink, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, agPortNewCfgBwmContract=agPortNewCfgBwmContract, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, mirrVlanMirr=mirrVlanMirr, mirrOper=mirrOper, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, agPortNewCfgRmon=agPortNewCfgRmon, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortCurCfgStp=agPortCurCfgStp, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, portInfoPhyIfMtu=portInfoPhyIfMtu, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, stgNewCfgTableEntry=stgNewCfgTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, agPortCurCfgPortName=agPortCurCfgPortName, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, mirroring=mirroring, agPortCurCfgTableEntry=agPortCurCfgTableEntry, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, portStatsTableEntry=portStatsTableEntry, spannTreeGrpCfg=spannTreeGrpCfg, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, agPortCurCfgIndx=agPortCurCfgIndx, vlanCurCfgPorts=vlanCurCfgPorts, agPortNewCfgPVID=agPortNewCfgPVID, portInfoFlowCtrl=portInfoFlowCtrl, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, vlanNewCfgAddPort=vlanNewCfgAddPort, agPortCurCfgPVID=agPortCurCfgPVID, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, pmNewCfgMirroredPort=pmNewCfgMirroredPort, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, mirrOperType=mirrOperType, agPortNewCfgPortName=agPortNewCfgPortName, portInfoPhyIfType=portInfoPhyIfType, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgCurCfgPortTable=stgCurCfgPortTable, vlanNewCfgDelete=vlanNewCfgDelete, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mirrOperMirroredPort=mirrOperMirroredPort, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, vlanNewCfgVlanName=vlanNewCfgVlanName, pmCurCfgState=pmCurCfgState, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, vlans=vlans, agPortCurCfgBwmContract=agPortCurCfgBwmContract, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, portStatsPhyIfInErrors=portStatsPhyIfInErrors, mirrOperTimeout=mirrOperTimeout, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, agPortCurCfgRmon=agPortCurCfgRmon, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgPortIndex=stgNewCfgPortIndex, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, mirrPortMirr=mirrPortMirr, portInfoSpeed=portInfoSpeed, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, agPortNewCfgState=agPortNewCfgState, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, agPortCurCfgState=agPortCurCfgState, agPortCurCfgTable=agPortCurCfgTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgCurCfgTable=stgCurCfgTable, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portStatsPhyIfInOctets=portStatsPhyIfInOctets, portInfoLink=portInfoLink, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanCurCfgStg=vlanCurCfgStg, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, agPortNewCfgTableEntry=agPortNewCfgTableEntry, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, portStatsTable=portStatsTable, vlanCurCfgState=vlanCurCfgState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, port_info=port_info, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, mirrOperState=mirrOperState, agPortCurCfgBackLink=agPortCurCfgBackLink, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, portInfoTableEntry=portInfoTableEntry, stgCurCfgState=stgCurCfgState, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, agPortNewCfgVlanTag=agPortNewCfgVlanTag, stgCurCfgIndex=stgCurCfgIndex, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, vlanMaxEnt=vlanMaxEnt, portCpuStatsUtilTable=portCpuStatsUtilTable, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanNewCfgTable=vlanNewCfgTable, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, pmCurCfgMirroredPort=pmCurCfgMirroredPort, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portInfoPhyIfLastChange=portInfoPhyIfLastChange, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanNewCfgStg=vlanNewCfgStg, portStatsIndx=portStatsIndx, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portInfoIndx=portInfoIndx, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, trunkgroup=trunkgroup, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mirrOperMonitoringPort=mirrOperMonitoringPort, stgNewCfgState=stgNewCfgState, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, port_stats=port_stats, agPortNewCfgBackLink=agPortNewCfgBackLink, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, agPortCurCfgPrefLink=agPortCurCfgPrefLink, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portCpuStatsUtilIndx=portCpuStatsUtilIndx, stgNewCfgAddVlan=stgNewCfgAddVlan, portInfoMode=portInfoMode, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, portInfoTable=portInfoTable, agPortNewCfgIndx=agPortNewCfgIndx)
