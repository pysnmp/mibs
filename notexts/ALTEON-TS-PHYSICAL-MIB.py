...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, vlanNewCfgDelete=vlanNewCfgDelete, agPortNewCfgPortName=agPortNewCfgPortName, stgNewCfgTable=stgNewCfgTable, agPortNewCfgVlanTag=agPortNewCfgVlanTag, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, agPortNewCfgState=agPortNewCfgState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, vlanCurCfgPorts=vlanCurCfgPorts, agPortNewCfgTable=agPortNewCfgTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmNewCfgPortMirrState=pmNewCfgPortMirrState, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, mirrOperState=mirrOperState, portmirroring=portmirroring, trunkgroup=trunkgroup, vlanNewCfgJumbo=vlanNewCfgJumbo, portInfoPhyIfMtu=portInfoPhyIfMtu, portInfoPhyIfLastChange=portInfoPhyIfLastChange, portStatsTable=portStatsTable, pmNewCfgState=pmNewCfgState, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanCurCfgStg=vlanCurCfgStg, portStatsIndx=portStatsIndx, agPortCurCfgPortName=agPortCurCfgPortName, agPortCurCfgPrefLink=agPortCurCfgPrefLink, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, trunkGroupNewCfgState=trunkGroupNewCfgState, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, pmCurCfgState=pmCurCfgState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portInfoLink=portInfoLink, portInfoTable=portInfoTable, vlanCurCfgTable=vlanCurCfgTable, portCpuStats=portCpuStats, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, mirrOperMirroredPort=mirrOperMirroredPort, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, agPortNewCfgRmon=agPortNewCfgRmon, pmCurCfgMirroredPort=pmCurCfgMirroredPort, vlanCurCfgVlanId=vlanCurCfgVlanId, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, agPortNewCfgTableEntry=agPortNewCfgTableEntry, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portStatsPhyIfInOctets=portStatsPhyIfInOctets, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, port_info=port_info, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, mirroring=mirroring, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, agPortNewCfgPrefLink=agPortNewCfgPrefLink, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, agPortCurCfgRmon=agPortCurCfgRmon, agPortCurCfgBwmContract=agPortCurCfgBwmContract, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portInfoMode=portInfoMode, portInfoSpeed=portInfoSpeed, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, agPortCurCfgPVID=agPortCurCfgPVID, vlans=vlans, pmCurCfgTimeout=pmCurCfgTimeout, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, agPortNewCfgPVID=agPortNewCfgPVID, vlanNewCfgState=vlanNewCfgState, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, agPortCurCfgIndx=agPortCurCfgIndx, spannTreeGrpCfg=spannTreeGrpCfg, portStatsPhyIfInErrors=portStatsPhyIfInErrors, vlanCurCfgVlanName=vlanCurCfgVlanName, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgPortIndex=stgCurCfgPortIndex, agPortCurCfgBackLink=agPortCurCfgBackLink, stgCurCfgPortTable=stgCurCfgPortTable, portInfoPhyIfType=portInfoPhyIfType, stgCurCfgTable=stgCurCfgTable, stgNewCfgTableEntry=stgNewCfgTableEntry, pmNewCfgMirroredPort=pmNewCfgMirroredPort, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, stgNewCfgStgIndex=stgNewCfgStgIndex, portStatsTableEntry=portStatsTableEntry, mirrOper=mirrOper, stgNewCfgPortState=stgNewCfgPortState, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, stgNewCfgPortIndex=stgNewCfgPortIndex, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, portCpuStatsUtilTable=portCpuStatsUtilTable, mirrPortMirr=mirrPortMirr, mirrVlanMirr=mirrVlanMirr, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, vlanMaxEnt=vlanMaxEnt, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, agPortConfig=agPortConfig, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, portCpuStatsUtilIndx=portCpuStatsUtilIndx, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, stgCurCfgState=stgCurCfgState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portInfoPhyIfDescr=portInfoPhyIfDescr, vlanNewCfgVlanName=vlanNewCfgVlanName, pmNewCfgTimeout=pmNewCfgTimeout, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, agPortCurCfgVlanTag=agPortCurCfgVlanTag, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgIndex=stgCurCfgIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, vlanNewCfgTable=vlanNewCfgTable, trunkGroupNewCfgTable=trunkGroupNewCfgTable, agPortNewCfgBackLink=agPortNewCfgBackLink, vlanCurCfgState=vlanCurCfgState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mirrOperTimeout=mirrOperTimeout, agPortCurCfgState=agPortCurCfgState, agPortTableMaxEnt=agPortTableMaxEnt, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, stgCurCfgPortState=stgCurCfgPortState, stgNewCfgPortTable=stgNewCfgPortTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, stgNewCfgState=stgNewCfgState, agPortNewCfgStp=agPortNewCfgStp, agPortCurCfgStp=agPortCurCfgStp, agPortCurCfgTable=agPortCurCfgTable, agPortNewCfgIndx=agPortNewCfgIndx, trunkGroupCurCfgState=trunkGroupCurCfgState, mirrOperMonitoringPort=mirrOperMonitoringPort, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, port_stats=port_stats, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, portInfoFlowCtrl=portInfoFlowCtrl, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, mirrOperType=mirrOperType, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portInfoIndx=portInfoIndx, stgNewCfgIndex=stgNewCfgIndex, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, agPortNewCfgBwmContract=agPortNewCfgBwmContract, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, vlanNewCfgPorts=vlanNewCfgPorts, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, agPortCurCfgTableEntry=agPortCurCfgTableEntry, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, portInfoTableEntry=portInfoTableEntry)
