...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, mirrOperTimeout=mirrOperTimeout, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mirrPortMirr=mirrPortMirr, stgNewCfgPortTable=stgNewCfgPortTable, portInfoTable=portInfoTable, vlanCurCfgBwmContract=vlanCurCfgBwmContract, spannTreeGrpCfg=spannTreeGrpCfg, agPortCurCfgPVID=agPortCurCfgPVID, pmCurCfgState=pmCurCfgState, portInfoPhyIfMtu=portInfoPhyIfMtu, vlanNewCfgTableEntry=vlanNewCfgTableEntry, port_stats=port_stats, stgNewCfgPortIndex=stgNewCfgPortIndex, pmNewCfgMirroredPort=pmNewCfgMirroredPort, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, portInfoPhyIfType=portInfoPhyIfType, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgTable=stgCurCfgTable, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portInfoFlowCtrl=portInfoFlowCtrl, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, portInfoPhyIfDescr=portInfoPhyIfDescr, vlanCurCfgPorts=vlanCurCfgPorts, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanCurCfgState=vlanCurCfgState, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, trunkGroupNewCfgState=trunkGroupNewCfgState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, agPortCurCfgRmon=agPortCurCfgRmon, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, agPortCurCfgStp=agPortCurCfgStp, portInfoPhyIfLastChange=portInfoPhyIfLastChange, agPortCurCfgVlanTag=agPortCurCfgVlanTag, agPortNewCfgBwmContract=agPortNewCfgBwmContract, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portCpuStatsUtilTable=portCpuStatsUtilTable, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, vlanNewCfgVlanId=vlanNewCfgVlanId, pmCurCfgTimeout=pmCurCfgTimeout, portCpuStats=portCpuStats, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, agPortCurCfgTable=agPortCurCfgTable, mirrVlanMirr=mirrVlanMirr, agPortCurCfgBwmContract=agPortCurCfgBwmContract, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanNewCfgRemovePort=vlanNewCfgRemovePort, agPortNewCfgPVID=agPortNewCfgPVID, stgCurCfgPortTable=stgCurCfgPortTable, portStatsTable=portStatsTable, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, stgNewCfgStgIndex=stgNewCfgStgIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, mirrOperMonitoringPort=mirrOperMonitoringPort, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mirrOper=mirrOper, agPortTableMaxEnt=agPortTableMaxEnt, vlanCurCfgTable=vlanCurCfgTable, agPortCurCfgPortName=agPortCurCfgPortName, mirrOperState=mirrOperState, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, trunkgroup=trunkgroup, agPortNewCfgTable=agPortNewCfgTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, stgCurCfgTableEntry=stgCurCfgTableEntry, pmCurCfgMirroredPort=pmCurCfgMirroredPort, portStatsPhyIfInErrors=portStatsPhyIfInErrors, agPortNewCfgIndx=agPortNewCfgIndx, agPortNewCfgVlanTag=agPortNewCfgVlanTag, agPortCurCfgState=agPortCurCfgState, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, portInfoTableEntry=portInfoTableEntry, portStatsIndx=portStatsIndx, agPortNewCfgBackLink=agPortNewCfgBackLink, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, agPortNewCfgPrefLink=agPortNewCfgPrefLink, mirroring=mirroring, vlanNewCfgDelete=vlanNewCfgDelete, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgNewCfgPortState=stgNewCfgPortState, agPortNewCfgPortName=agPortNewCfgPortName, portStatsTableEntry=portStatsTableEntry, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, mirrOperType=mirrOperType, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgNewCfgState=stgNewCfgState, portCpuStatsUtilIndx=portCpuStatsUtilIndx, agPortCurCfgPrefLink=agPortCurCfgPrefLink, stgCurCfgStgIndex=stgCurCfgStgIndex, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanNewCfgAddPort=vlanNewCfgAddPort, vlans=vlans, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, agPortCurCfgTableEntry=agPortCurCfgTableEntry, portmirroring=portmirroring, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, pmNewCfgTimeout=pmNewCfgTimeout, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanNewCfgState=vlanNewCfgState, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupCurCfgState=trunkGroupCurCfgState, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, vlanCurCfgStg=vlanCurCfgStg, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, mirrOperMirroredPort=mirrOperMirroredPort, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portInfoMode=portInfoMode, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, port_info=port_info, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, agPortNewCfgTableEntry=agPortNewCfgTableEntry, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, stgNewCfgIndex=stgNewCfgIndex, vlanNewCfgTable=vlanNewCfgTable, agPortCurCfgBackLink=agPortCurCfgBackLink, portInfoSpeed=portInfoSpeed, stgCurCfgIndex=stgCurCfgIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgState=stgCurCfgState, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, portInfoLink=portInfoLink, vlanNewCfgPorts=vlanNewCfgPorts, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, portInfoIndx=portInfoIndx, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, portStatsPhyIfInOctets=portStatsPhyIfInOctets, vlanNewCfgBwmContract=vlanNewCfgBwmContract, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, agPortNewCfgState=agPortNewCfgState, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, pmNewCfgState=pmNewCfgState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgCurCfgPortState=stgCurCfgPortState, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, agPortNewCfgStp=agPortNewCfgStp, vlanMaxEnt=vlanMaxEnt, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, agPortNewCfgRmon=agPortNewCfgRmon, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, agPortCurCfgIndx=agPortCurCfgIndx, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, vlanCurCfgVlanName=vlanCurCfgVlanName, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, vlanNewCfgStg=vlanNewCfgStg, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, stgCurCfgPortIndex=stgCurCfgPortIndex, agPortConfig=agPortConfig, stgNewCfgTable=stgNewCfgTable)
