...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", vlanNewCfgJumbo=vlanNewCfgJumbo, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, stgNewCfgState=stgNewCfgState, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, vlanCurCfgState=vlanCurCfgState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portInfoMode=portInfoMode, agPortCurCfgVlanTag=agPortCurCfgVlanTag, portInfoFlowCtrl=portInfoFlowCtrl, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, portCpuStats=portCpuStats, mirroring=mirroring, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, agPortNewCfgState=agPortNewCfgState, agPortCurCfgPortName=agPortCurCfgPortName, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, portInfoTableEntry=portInfoTableEntry, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, agPortNewCfgTable=agPortNewCfgTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portInfoPhyIfLastChange=portInfoPhyIfLastChange, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, vlanNewCfgDelete=vlanNewCfgDelete, agPortCurCfgStp=agPortCurCfgStp, portInfoPhyIfDescr=portInfoPhyIfDescr, mirrOperTimeout=mirrOperTimeout, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, vlanNewCfgRemovePort=vlanNewCfgRemovePort, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, portInfoPhyIfMtu=portInfoPhyIfMtu, pmCurCfgTimeout=pmCurCfgTimeout, mirrVlanMirr=mirrVlanMirr, mirrOperType=mirrOperType, agPortCurCfgRmon=agPortCurCfgRmon, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, stgCurCfgIndex=stgCurCfgIndex, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, stgNewCfgIndex=stgNewCfgIndex, agPortNewCfgBackLink=agPortNewCfgBackLink, portInfoSpeed=portInfoSpeed, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, pmNewCfgTimeout=pmNewCfgTimeout, agPortNewCfgVlanTag=agPortNewCfgVlanTag, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mirrOperMonitoringPort=mirrOperMonitoringPort, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgTableEntry=stgNewCfgTableEntry, agPortCurCfgIndx=agPortCurCfgIndx, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmCurCfgMirroredPort=pmCurCfgMirroredPort, portStatsTable=portStatsTable, vlanCurCfgPorts=vlanCurCfgPorts, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgAddVlan=stgNewCfgAddVlan, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, agPortNewCfgStp=agPortNewCfgStp, vlanNewCfgVlanId=vlanNewCfgVlanId, portCpuStatsUtilIndx=portCpuStatsUtilIndx, stgCurCfgPortTable=stgCurCfgPortTable, stgCurCfgState=stgCurCfgState, stgNewCfgStgIndex=stgNewCfgStgIndex, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, agPortCurCfgBwmContract=agPortCurCfgBwmContract, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanCurCfgStg=vlanCurCfgStg, trunkGroupCurCfgState=trunkGroupCurCfgState, agPortCurCfgPVID=agPortCurCfgPVID, agPortNewCfgPortName=agPortNewCfgPortName, agPortCurCfgState=agPortCurCfgState, agPortNewCfgRmon=agPortNewCfgRmon, stgCurCfgPortState=stgCurCfgPortState, mirrOper=mirrOper, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmCurCfgState=pmCurCfgState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, vlanCurCfgTable=vlanCurCfgTable, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, port_stats=port_stats, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, vlanCurCfgVlanId=vlanCurCfgVlanId, portStatsPhyIfInOctets=portStatsPhyIfInOctets, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanNewCfgVlanName=vlanNewCfgVlanName, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, stgCurCfgTable=stgCurCfgTable, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, vlanMaxEnt=vlanMaxEnt, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, mirrOperState=mirrOperState, agPortNewCfgPrefLink=agPortNewCfgPrefLink, spannTreeGrpCfg=spannTreeGrpCfg, stgNewCfgPortTable=stgNewCfgPortTable, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, port_info=port_info, portmirroring=portmirroring, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, vlanNewCfgPorts=vlanNewCfgPorts, vlanNewCfgStg=vlanNewCfgStg, portInfoLink=portInfoLink, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, agPortNewCfgTableEntry=agPortNewCfgTableEntry, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portInfoTable=portInfoTable, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, agPortConfig=agPortConfig, pmNewCfgMirroredPort=pmNewCfgMirroredPort, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portStatsPhyIfInErrors=portStatsPhyIfInErrors, portInfoPhyIfType=portInfoPhyIfType, agPortCurCfgTable=agPortCurCfgTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, agPortCurCfgTableEntry=agPortCurCfgTableEntry, portStatsIndx=portStatsIndx, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanNewCfgState=vlanNewCfgState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, trunkgroup=trunkgroup, vlanCurCfgVlanName=vlanCurCfgVlanName, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, agPortNewCfgIndx=agPortNewCfgIndx, portStatsTableEntry=portStatsTableEntry, pmNewCfgState=pmNewCfgState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, agPortTableMaxEnt=agPortTableMaxEnt, agPortNewCfgPVID=agPortNewCfgPVID, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, pmCurCfgPortMirrState=pmCurCfgPortMirrState, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, vlans=vlans, agPortCurCfgBackLink=agPortCurCfgBackLink, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, stgNewCfgTable=stgNewCfgTable, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, stgNewCfgPortState=stgNewCfgPortState, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgCurCfgStgIndex=stgCurCfgStgIndex, agPortCurCfgPrefLink=agPortCurCfgPrefLink, portCpuStatsUtilTable=portCpuStatsUtilTable, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, agPortNewCfgBwmContract=agPortNewCfgBwmContract, portInfoIndx=portInfoIndx, stgCurCfgTableEntry=stgCurCfgTableEntry, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, vlanCurCfgJumbo=vlanCurCfgJumbo, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, mirrPortMirr=mirrPortMirr, mirrOperMirroredPort=mirrOperMirroredPort)
