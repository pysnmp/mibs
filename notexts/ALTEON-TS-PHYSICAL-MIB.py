...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, agPortCurCfgVlanTag=agPortCurCfgVlanTag, vlanNewCfgAddPort=vlanNewCfgAddPort, port_stats=port_stats, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, agPortCurCfgIndx=agPortCurCfgIndx, agPortNewCfgRmon=agPortNewCfgRmon, vlanMaxEnt=vlanMaxEnt, mirrPortMirr=mirrPortMirr, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, trunkGroupNewCfgState=trunkGroupNewCfgState, port_info=port_info, agPortCurCfgTableEntry=agPortCurCfgTableEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, portStatsPhyIfInOctets=portStatsPhyIfInOctets, agPortNewCfgIndx=agPortNewCfgIndx, trunkGroupTableMaxSize=trunkGroupTableMaxSize, agPortNewCfgPortName=agPortNewCfgPortName, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgNewCfgIndex=stgNewCfgIndex, agPortNewCfgTable=agPortNewCfgTable, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, portInfoTableEntry=portInfoTableEntry, stgNewCfgPortState=stgNewCfgPortState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portStatsIndx=portStatsIndx, agPortNewCfgVlanTag=agPortNewCfgVlanTag, pmNewCfgTimeout=pmNewCfgTimeout, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, trunkgroup=trunkgroup, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, vlanNewCfgVlanId=vlanNewCfgVlanId, mirrOperState=mirrOperState, stgCurCfgTableEntry=stgCurCfgTableEntry, portInfoPhyIfType=portInfoPhyIfType, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, portStatsPhyIfInErrors=portStatsPhyIfInErrors, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, portStatsTable=portStatsTable, mirrOperTimeout=mirrOperTimeout, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, mirroring=mirroring, vlanNewCfgState=vlanNewCfgState, mirrVlanMirr=mirrVlanMirr, agPortNewCfgStp=agPortNewCfgStp, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, agPortNewCfgTableEntry=agPortNewCfgTableEntry, portInfoFlowCtrl=portInfoFlowCtrl, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanCurCfgStg=vlanCurCfgStg, pmCurCfgMirroredPort=pmCurCfgMirroredPort, vlanNewCfgTableEntry=vlanNewCfgTableEntry, agPortCurCfgBackLink=agPortCurCfgBackLink, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, mirrOper=mirrOper, portCpuStats=portCpuStats, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, stgCurCfgPortState=stgCurCfgPortState, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, pmCurCfgState=pmCurCfgState, agPortNewCfgBackLink=agPortNewCfgBackLink, vlanCurCfgPorts=vlanCurCfgPorts, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgNewCfgAddVlan=stgNewCfgAddVlan, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanNewCfgDelete=vlanNewCfgDelete, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portInfoPhyIfLastChange=portInfoPhyIfLastChange, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, vlanCurCfgVlanId=vlanCurCfgVlanId, stgCurCfgPortTable=stgCurCfgPortTable, stgNewCfgPortTable=stgNewCfgPortTable, vlanCurCfgVlanName=vlanCurCfgVlanName, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, agPortTableMaxEnt=agPortTableMaxEnt, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, portInfoTable=portInfoTable, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, mirrOperMirroredPort=mirrOperMirroredPort, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanNewCfgJumbo=vlanNewCfgJumbo, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, stgCurCfgTable=stgCurCfgTable, stgNewCfgTable=stgNewCfgTable, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanNewCfgPorts=vlanNewCfgPorts, agPortCurCfgBwmContract=agPortCurCfgBwmContract, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, agPortCurCfgPrefLink=agPortCurCfgPrefLink, pmCurCfgTimeout=pmCurCfgTimeout, vlanNewCfgVlanName=vlanNewCfgVlanName, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, mirrOperType=mirrOperType, agPortNewCfgPrefLink=agPortNewCfgPrefLink, portmirroring=portmirroring, agPortCurCfgStp=agPortCurCfgStp, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, agPortCurCfgRmon=agPortCurCfgRmon, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, agPortCurCfgPVID=agPortCurCfgPVID, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, portInfoMode=portInfoMode, pmNewCfgMirroredPort=pmNewCfgMirroredPort, portInfoSpeed=portInfoSpeed, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, portStatsTableEntry=portStatsTableEntry, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, stgNewCfgState=stgNewCfgState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portInfoIndx=portInfoIndx, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, vlanNewCfgTable=vlanNewCfgTable, stgNewCfgStgIndex=stgNewCfgStgIndex, agPortNewCfgBwmContract=agPortNewCfgBwmContract, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portInfoLink=portInfoLink, pmNewCfgState=pmNewCfgState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgCurCfgStgIndex=stgCurCfgStgIndex, agPortCurCfgPortName=agPortCurCfgPortName, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, vlanCurCfgJumbo=vlanCurCfgJumbo, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, stgCurCfgIndex=stgCurCfgIndex, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, agPortConfig=agPortConfig, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanNewCfgStg=vlanNewCfgStg, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, agPortCurCfgState=agPortCurCfgState, portCpuStatsUtilIndx=portCpuStatsUtilIndx, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgState=stgCurCfgState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, portCpuStatsUtilTable=portCpuStatsUtilTable, vlanCurCfgTable=vlanCurCfgTable, portInfoPhyIfMtu=portInfoPhyIfMtu, spannTreeGrpCfg=spannTreeGrpCfg, mirrOperMonitoringPort=mirrOperMonitoringPort, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, agPortCurCfgTable=agPortCurCfgTable, vlans=vlans, agPortNewCfgState=agPortNewCfgState, stgNewCfgPortIndex=stgNewCfgPortIndex, agPortNewCfgPVID=agPortNewCfgPVID, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, vlanCurCfgState=vlanCurCfgState, portInfoPhyIfDescr=portInfoPhyIfDescr, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState)
