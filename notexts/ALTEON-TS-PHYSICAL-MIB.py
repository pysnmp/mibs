...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", mirrOperMirroredPort=mirrOperMirroredPort, port_stats=port_stats, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgCurCfgTable=stgCurCfgTable, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgStgIndex=stgNewCfgStgIndex, agPortTableMaxEnt=agPortTableMaxEnt, portStatsIndx=portStatsIndx, vlanNewCfgVlanName=vlanNewCfgVlanName, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, mirrPortMirr=mirrPortMirr, stgCurCfgPortIndex=stgCurCfgPortIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanNewCfgState=vlanNewCfgState, stgNewCfgPortTable=stgNewCfgPortTable, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, stgCurCfgPortState=stgCurCfgPortState, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortNewCfgBackLink=agPortNewCfgBackLink, stgNewCfgAddVlan=stgNewCfgAddVlan, mirrOper=mirrOper, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, agPortNewCfgBwmContract=agPortNewCfgBwmContract, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portStatsTable=portStatsTable, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanNewCfgBwmContract=vlanNewCfgBwmContract, agPortNewCfgStp=agPortNewCfgStp, agPortNewCfgTableEntry=agPortNewCfgTableEntry, agPortNewCfgTable=agPortNewCfgTable, pmCurCfgTimeout=pmCurCfgTimeout, stgNewCfgIndex=stgNewCfgIndex, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, agPortCurCfgState=agPortCurCfgState, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, agPortCurCfgTableEntry=agPortCurCfgTableEntry, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, vlanCurCfgStg=vlanCurCfgStg, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portInfoLink=portInfoLink, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgState=stgNewCfgState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portInfoPhyIfLastChange=portInfoPhyIfLastChange, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, stgCurCfgPortTable=stgCurCfgPortTable, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, agPortCurCfgRmon=agPortCurCfgRmon, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, trunkgroup=trunkgroup, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, agPortCurCfgPortName=agPortCurCfgPortName, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, agPortCurCfgStp=agPortCurCfgStp, portInfoMode=portInfoMode, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, vlanNewCfgVlanId=vlanNewCfgVlanId, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, stgCurCfgIndex=stgCurCfgIndex, stgCurCfgState=stgCurCfgState, agPortNewCfgVlanTag=agPortNewCfgVlanTag, agPortNewCfgRmon=agPortNewCfgRmon, portCpuStats=portCpuStats, vlanCurCfgVlanId=vlanCurCfgVlanId, agPortCurCfgTable=agPortCurCfgTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanNewCfgRemovePort=vlanNewCfgRemovePort, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, portInfoSpeed=portInfoSpeed, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, agPortNewCfgIndx=agPortNewCfgIndx, agPortCurCfgBwmContract=agPortCurCfgBwmContract, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, vlanNewCfgStg=vlanNewCfgStg, agPortCurCfgPVID=agPortCurCfgPVID, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, pmNewCfgMirroredPort=pmNewCfgMirroredPort, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, vlanCurCfgTable=vlanCurCfgTable, portInfoPhyIfType=portInfoPhyIfType, portInfoTableEntry=portInfoTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, portStatsTableEntry=portStatsTableEntry, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanNewCfgPorts=vlanNewCfgPorts, agPortConfig=agPortConfig, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlans=vlans, portCpuStatsUtilIndx=portCpuStatsUtilIndx, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, portInfoTable=portInfoTable, portStatsPhyIfInErrors=portStatsPhyIfInErrors, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, agPortCurCfgVlanTag=agPortCurCfgVlanTag, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmNewCfgState=pmNewCfgState, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, trunkGroupCurCfgTable=trunkGroupCurCfgTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, stgCurCfgTableEntry=stgCurCfgTableEntry, portInfoPhyIfDescr=portInfoPhyIfDescr, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, portStatsPhyIfInOctets=portStatsPhyIfInOctets, vlanCurCfgState=vlanCurCfgState, pmCurCfgState=pmCurCfgState, pmNewCfgTimeout=pmNewCfgTimeout, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, spannTreeGrpCfg=spannTreeGrpCfg, portInfoPhyIfMtu=portInfoPhyIfMtu, agPortNewCfgPrefLink=agPortNewCfgPrefLink, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, vlanNewCfgDelete=vlanNewCfgDelete, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgPortState=stgNewCfgPortState, mirrOperState=mirrOperState, portCpuStatsUtilTable=portCpuStatsUtilTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, portInfoFlowCtrl=portInfoFlowCtrl, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, vlanMaxEnt=vlanMaxEnt, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mirroring=mirroring, agPortNewCfgState=agPortNewCfgState, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, portmirroring=portmirroring, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, agPortCurCfgIndx=agPortCurCfgIndx, mirrOperType=mirrOperType, stgCurCfgStgIndex=stgCurCfgStgIndex, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mirrOperTimeout=mirrOperTimeout, agPortCurCfgPrefLink=agPortCurCfgPrefLink, vlanNewCfgTable=vlanNewCfgTable, agPortCurCfgBackLink=agPortCurCfgBackLink, agPortNewCfgPortName=agPortNewCfgPortName, trunkGroupCurCfgState=trunkGroupCurCfgState, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgTable=stgNewCfgTable, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, port_info=port_info, vlanCurCfgJumbo=vlanCurCfgJumbo, pmCurCfgMirroredPort=pmCurCfgMirroredPort, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portInfoIndx=portInfoIndx, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, mirrVlanMirr=mirrVlanMirr, agPortNewCfgPVID=agPortNewCfgPVID, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, vlanCurCfgVlanName=vlanCurCfgVlanName, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic)
