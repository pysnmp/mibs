...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", vlanNewCfgStg=vlanNewCfgStg, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, portInfoPhyIfLastChange=portInfoPhyIfLastChange, portStatsIndx=portStatsIndx, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanNewCfgTable=vlanNewCfgTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, agPortTableMaxEnt=agPortTableMaxEnt, agPortCurCfgPVID=agPortCurCfgPVID, stgNewCfgAddVlan=stgNewCfgAddVlan, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, vlanNewCfgVlanName=vlanNewCfgVlanName, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, pmNewCfgMirroredPort=pmNewCfgMirroredPort, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmNewCfgState=pmNewCfgState, mirrOperState=mirrOperState, agPortNewCfgPVID=agPortNewCfgPVID, vlanCurCfgState=vlanCurCfgState, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, stgCurCfgPortIndex=stgCurCfgPortIndex, agPortCurCfgPortName=agPortCurCfgPortName, agPortNewCfgIndx=agPortNewCfgIndx, stgCurCfgState=stgCurCfgState, vlanCurCfgVlanId=vlanCurCfgVlanId, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmCurCfgTimeout=pmCurCfgTimeout, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portInfoIndx=portInfoIndx, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, vlanCurCfgTable=vlanCurCfgTable, vlans=vlans, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, vlanMaxEnt=vlanMaxEnt, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, portCpuStatsUtilIndx=portCpuStatsUtilIndx, agPortCurCfgPrefLink=agPortCurCfgPrefLink, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, agPortNewCfgBackLink=agPortNewCfgBackLink, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, port_info=port_info, stgCurCfgStgIndex=stgCurCfgStgIndex, mirrPortMirr=mirrPortMirr, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, agPortNewCfgTableEntry=agPortNewCfgTableEntry, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, agPortConfig=agPortConfig, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portStatsPhyIfInOctets=portStatsPhyIfInOctets, vlanCurCfgVlanName=vlanCurCfgVlanName, mirrOperType=mirrOperType, agPortCurCfgBwmContract=agPortCurCfgBwmContract, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, agPortCurCfgBackLink=agPortCurCfgBackLink, agPortNewCfgVlanTag=agPortNewCfgVlanTag, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, stgCurCfgPortTable=stgCurCfgPortTable, trunkgroup=trunkgroup, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mirroring=mirroring, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, trunkGroupNewCfgTable=trunkGroupNewCfgTable, agPortNewCfgTable=agPortNewCfgTable, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgStgIndex=stgNewCfgStgIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, agPortNewCfgRmon=agPortNewCfgRmon, agPortCurCfgState=agPortCurCfgState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portInfoMode=portInfoMode, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, agPortCurCfgTable=agPortCurCfgTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, agPortCurCfgIndx=agPortCurCfgIndx, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, agPortCurCfgRmon=agPortCurCfgRmon, portmirroring=portmirroring, trunkGroupCurCfgState=trunkGroupCurCfgState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgCurCfgTable=stgCurCfgTable, agPortNewCfgBwmContract=agPortNewCfgBwmContract, portInfoTable=portInfoTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanNewCfgDelete=vlanNewCfgDelete, vlanNewCfgAddPort=vlanNewCfgAddPort, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portStatsTableEntry=portStatsTableEntry, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portCpuStats=portCpuStats, agPortNewCfgState=agPortNewCfgState, portInfoPhyIfType=portInfoPhyIfType, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, mirrOper=mirrOper, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgPortState=stgCurCfgPortState, stgCurCfgTableEntry=stgCurCfgTableEntry, mirrVlanMirr=mirrVlanMirr, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, port_stats=port_stats, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, stgNewCfgState=stgNewCfgState, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, mirrOperMonitoringPort=mirrOperMonitoringPort, vlanNewCfgPorts=vlanNewCfgPorts, pmNewCfgTimeout=pmNewCfgTimeout, agPortCurCfgStp=agPortCurCfgStp, portInfoFlowCtrl=portInfoFlowCtrl, portInfoPhyIfMtu=portInfoPhyIfMtu, mirrOperMirroredPort=mirrOperMirroredPort, agPortCurCfgVlanTag=agPortCurCfgVlanTag, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgNewCfgPortState=stgNewCfgPortState, vlanNewCfgState=vlanNewCfgState, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanCurCfgPorts=vlanCurCfgPorts, agPortCurCfgTableEntry=agPortCurCfgTableEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, portInfoLink=portInfoLink, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, stgNewCfgTable=stgNewCfgTable, pmCurCfgState=pmCurCfgState, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, stgNewCfgPortIndex=stgNewCfgPortIndex, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, portInfoPhyIfDescr=portInfoPhyIfDescr, portStatsTable=portStatsTable, agPortNewCfgStp=agPortNewCfgStp, stgNewCfgIndex=stgNewCfgIndex, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, portInfoTableEntry=portInfoTableEntry, stgNewCfgPortTable=stgNewCfgPortTable, mirrOperTimeout=mirrOperTimeout, portInfoSpeed=portInfoSpeed, vlanCurCfgJumbo=vlanCurCfgJumbo, portCpuStatsUtilTable=portCpuStatsUtilTable, spannTreeGrpCfg=spannTreeGrpCfg, agPortNewCfgPrefLink=agPortNewCfgPrefLink, stgCurCfgIndex=stgCurCfgIndex, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, pmCurCfgMirroredPort=pmCurCfgMirroredPort, agPortNewCfgPortName=agPortNewCfgPortName, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, vlanNewCfgVlanId=vlanNewCfgVlanId, portStatsPhyIfInErrors=portStatsPhyIfInErrors)
