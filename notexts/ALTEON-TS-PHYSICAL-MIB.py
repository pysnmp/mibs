...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", agPortNewCfgStp=agPortNewCfgStp, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgStgIndex=stgNewCfgStgIndex, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, portInfoTable=portInfoTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, vlanNewCfgVlanName=vlanNewCfgVlanName, portmirroring=portmirroring, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortConfig=agPortConfig, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgState=stgNewCfgState, vlanNewCfgTable=vlanNewCfgTable, portStatsTable=portStatsTable, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, mirrOperMirroredPort=mirrOperMirroredPort, portInfoPhyIfLastChange=portInfoPhyIfLastChange, pmCurCfgState=pmCurCfgState, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgPortState=stgCurCfgPortState, vlans=vlans, portInfoSpeed=portInfoSpeed, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, pmNewCfgMirroredPort=pmNewCfgMirroredPort, agPortCurCfgIndx=agPortCurCfgIndx, port_info=port_info, stgCurCfgState=stgCurCfgState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, stgCurCfgTableEntry=stgCurCfgTableEntry, agPortNewCfgPVID=agPortNewCfgPVID, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, agPortNewCfgPrefLink=agPortNewCfgPrefLink, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, mirrOper=mirrOper, agPortCurCfgVlanTag=agPortCurCfgVlanTag, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanCurCfgVlanId=vlanCurCfgVlanId, agPortNewCfgState=agPortNewCfgState, vlanNewCfgDelete=vlanNewCfgDelete, stgCurCfgIndex=stgCurCfgIndex, vlanCurCfgTable=vlanCurCfgTable, agPortNewCfgTable=agPortNewCfgTable, vlanCurCfgJumbo=vlanCurCfgJumbo, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, vlanMaxEnt=vlanMaxEnt, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, vlanNewCfgStg=vlanNewCfgStg, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, trunkGroupNewCfgState=trunkGroupNewCfgState, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, agPortNewCfgVlanTag=agPortNewCfgVlanTag, agPortCurCfgTable=agPortCurCfgTable, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, stgNewCfgPortIndex=stgNewCfgPortIndex, portCpuStats=portCpuStats, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, vlanNewCfgJumbo=vlanNewCfgJumbo, portInfoMode=portInfoMode, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portStatsPhyIfInErrors=portStatsPhyIfInErrors, mirrOperType=mirrOperType, pmCurCfgMirroredPort=pmCurCfgMirroredPort, agPortCurCfgPortName=agPortCurCfgPortName, stgNewCfgAddVlan=stgNewCfgAddVlan, agPortCurCfgPrefLink=agPortCurCfgPrefLink, vlanCurCfgPorts=vlanCurCfgPorts, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, agPortNewCfgIndx=agPortNewCfgIndx, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portStatsTableEntry=portStatsTableEntry, agPortNewCfgBwmContract=agPortNewCfgBwmContract, mirrVlanMirr=mirrVlanMirr, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanNewCfgPorts=vlanNewCfgPorts, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, agPortCurCfgBwmContract=agPortCurCfgBwmContract, vlanNewCfgState=vlanNewCfgState, stgNewCfgTableEntry=stgNewCfgTableEntry, pmCurCfgTimeout=pmCurCfgTimeout, agPortNewCfgTableEntry=agPortNewCfgTableEntry, pmNewCfgTimeout=pmNewCfgTimeout, stgNewCfgPortTable=stgNewCfgPortTable, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, portInfoFlowCtrl=portInfoFlowCtrl, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmNewCfgState=pmNewCfgState, portInfoTableEntry=portInfoTableEntry, stgNewCfgTable=stgNewCfgTable, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, trunkgroup=trunkgroup, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, agPortNewCfgPortName=agPortNewCfgPortName, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, portStatsIndx=portStatsIndx, portInfoIndx=portInfoIndx, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, agPortCurCfgState=agPortCurCfgState, vlanNewCfgAddPort=vlanNewCfgAddPort, portInfoPhyIfMtu=portInfoPhyIfMtu, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, agPortCurCfgStp=agPortCurCfgStp, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portCpuStatsUtilIndx=portCpuStatsUtilIndx, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, mirroring=mirroring, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, port_stats=port_stats, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portStatsPhyIfInOctets=portStatsPhyIfInOctets, agPortCurCfgRmon=agPortCurCfgRmon, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, agPortCurCfgBackLink=agPortCurCfgBackLink, agPortNewCfgRmon=agPortNewCfgRmon, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanCurCfgState=vlanCurCfgState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, agPortTableMaxEnt=agPortTableMaxEnt, portInfoPhyIfDescr=portInfoPhyIfDescr, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCurCfgPortTable=stgCurCfgPortTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mirrOperState=mirrOperState, stgCurCfgTable=stgCurCfgTable, portInfoLink=portInfoLink, agPortCurCfgPVID=agPortCurCfgPVID, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, portInfoPhyIfType=portInfoPhyIfType, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mirrPortMirr=mirrPortMirr, agPortNewCfgBackLink=agPortNewCfgBackLink, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, stgNewCfgPortState=stgNewCfgPortState, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, portCpuStatsUtilTable=portCpuStatsUtilTable, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, agPortCurCfgTableEntry=agPortCurCfgTableEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, trunkGroupTableMaxSize=trunkGroupTableMaxSize, spannTreeGrpCfg=spannTreeGrpCfg, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mirrOperTimeout=mirrOperTimeout, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, stgCurCfgStgIndex=stgCurCfgStgIndex)
