...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, agPortCurCfgTable=agPortCurCfgTable, stgCurCfgPortIndex=stgCurCfgPortIndex, portStatsPhyIfInErrors=portStatsPhyIfInErrors, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanNewCfgAddPort=vlanNewCfgAddPort, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mirroring=mirroring, portInfoMode=portInfoMode, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, mirrOper=mirrOper, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, agPortNewCfgStp=agPortNewCfgStp, pmNewCfgMirroredPort=pmNewCfgMirroredPort, agPortNewCfgVlanTag=agPortNewCfgVlanTag, stgNewCfgPortState=stgNewCfgPortState, vlanNewCfgPorts=vlanNewCfgPorts, portInfoIndx=portInfoIndx, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, stgNewCfgPortIndex=stgNewCfgPortIndex, agPortNewCfgRmon=agPortNewCfgRmon, stgCurCfgTableEntry=stgCurCfgTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, agPortCurCfgPortName=agPortCurCfgPortName, vlanNewCfgRemovePort=vlanNewCfgRemovePort, trunkgroup=trunkgroup, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, vlanCurCfgStg=vlanCurCfgStg, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portInfoTableEntry=portInfoTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, agPortCurCfgState=agPortCurCfgState, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, trunkGroupCurCfgState=trunkGroupCurCfgState, portInfoFlowCtrl=portInfoFlowCtrl, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, portInfoPhyIfMtu=portInfoPhyIfMtu, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, agPortCurCfgIndx=agPortCurCfgIndx, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, portmirroring=portmirroring, portInfoSpeed=portInfoSpeed, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mirrOperMirroredPort=mirrOperMirroredPort, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, stgNewCfgTable=stgNewCfgTable, vlans=vlans, stgNewCfgState=stgNewCfgState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, vlanNewCfgJumbo=vlanNewCfgJumbo, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanCurCfgTable=vlanCurCfgTable, portInfoPhyIfDescr=portInfoPhyIfDescr, vlanNewCfgState=vlanNewCfgState, portStatsPhyIfInOctets=portStatsPhyIfInOctets, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgAddVlan=stgNewCfgAddVlan, agPortNewCfgBwmContract=agPortNewCfgBwmContract, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, agPortNewCfgPrefLink=agPortNewCfgPrefLink, portStatsTable=portStatsTable, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, portCpuStatsUtilTable=portCpuStatsUtilTable, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, agPortNewCfgIndx=agPortNewCfgIndx, stgCurCfgPortTable=stgCurCfgPortTable, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, spannTreeGrpCfg=spannTreeGrpCfg, vlanCurCfgVlanName=vlanCurCfgVlanName, agPortCurCfgPrefLink=agPortCurCfgPrefLink, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortNewCfgPVID=agPortNewCfgPVID, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanNewCfgTable=vlanNewCfgTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, portStatsTableEntry=portStatsTableEntry, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, pmNewCfgState=pmNewCfgState, pmCurCfgMirroredPort=pmCurCfgMirroredPort, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, portCpuStats=portCpuStats, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portStatsIndx=portStatsIndx, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, agPortCurCfgStp=agPortCurCfgStp, agPortCurCfgPVID=agPortCurCfgPVID, mirrOperState=mirrOperState, stgNewCfgPortTable=stgNewCfgPortTable, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, stgCurCfgTable=stgCurCfgTable, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgIndex=stgCurCfgIndex, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, stgCurCfgPortState=stgCurCfgPortState, agPortCurCfgRmon=agPortCurCfgRmon, mirrOperTimeout=mirrOperTimeout, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, stgCurCfgState=stgCurCfgState, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mirrOperType=mirrOperType, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, mirrVlanMirr=mirrVlanMirr, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, portCpuStatsUtilIndx=portCpuStatsUtilIndx, vlanNewCfgVlanName=vlanNewCfgVlanName, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, agPortCurCfgBwmContract=agPortCurCfgBwmContract, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, agPortConfig=agPortConfig, port_info=port_info, agPortCurCfgTableEntry=agPortCurCfgTableEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portInfoPhyIfLastChange=portInfoPhyIfLastChange, pmCurCfgState=pmCurCfgState, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanMaxEnt=vlanMaxEnt, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, port_stats=port_stats, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, portInfoTable=portInfoTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, agPortCurCfgBackLink=agPortCurCfgBackLink, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, vlanCurCfgPorts=vlanCurCfgPorts, agPortNewCfgTable=agPortNewCfgTable, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, vlanCurCfgState=vlanCurCfgState, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, agPortNewCfgState=agPortNewCfgState, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mirrPortMirr=mirrPortMirr, agPortCurCfgVlanTag=agPortCurCfgVlanTag, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portInfoLink=portInfoLink, agPortNewCfgPortName=agPortNewCfgPortName, agPortNewCfgBackLink=agPortNewCfgBackLink, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgTableEntry=stgNewCfgTableEntry, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, agPortNewCfgTableEntry=agPortNewCfgTableEntry, pmCurCfgTimeout=pmCurCfgTimeout, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, portInfoPhyIfType=portInfoPhyIfType, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, agPortTableMaxEnt=agPortTableMaxEnt, vlanCurCfgJumbo=vlanCurCfgJumbo, pmNewCfgTimeout=pmNewCfgTimeout, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgNewCfgIndex=stgNewCfgIndex, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos)
