...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", portInfoPhyIfMtu=portInfoPhyIfMtu, mirrOperMirroredPort=mirrOperMirroredPort, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgTableEntry=stgCurCfgTableEntry, trunkGroupNewCfgTable=trunkGroupNewCfgTable, agPortConfig=agPortConfig, stgCurCfgState=stgCurCfgState, portInfoPhyIfDescr=portInfoPhyIfDescr, stgNewCfgPortTable=stgNewCfgPortTable, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, portInfoTableEntry=portInfoTableEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mirrVlanMirr=mirrVlanMirr, pmCurCfgPortMirrState=pmCurCfgPortMirrState, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, agPortNewCfgVlanTag=agPortNewCfgVlanTag, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, agPortNewCfgIndx=agPortNewCfgIndx, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, portStatsIndx=portStatsIndx, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portInfoFlowCtrl=portInfoFlowCtrl, stgNewCfgIndex=stgNewCfgIndex, agPortCurCfgTable=agPortCurCfgTable, agPortNewCfgStp=agPortNewCfgStp, vlanCurCfgVlanId=vlanCurCfgVlanId, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, pmCurCfgTimeout=pmCurCfgTimeout, portCpuStatsUtilIndx=portCpuStatsUtilIndx, vlanNewCfgState=vlanNewCfgState, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, portInfoPhyIfType=portInfoPhyIfType, agPortCurCfgIndx=agPortCurCfgIndx, mirrOperState=mirrOperState, agPortNewCfgState=agPortNewCfgState, vlanNewCfgStg=vlanNewCfgStg, vlanCurCfgTable=vlanCurCfgTable, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, portStatsPhyIfInErrors=portStatsPhyIfInErrors, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, vlanNewCfgVlanId=vlanNewCfgVlanId, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portInfoPhyIfLastChange=portInfoPhyIfLastChange, stgCurCfgPortTable=stgCurCfgPortTable, agPortCurCfgBwmContract=agPortCurCfgBwmContract, agPortCurCfgBackLink=agPortCurCfgBackLink, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, stgNewCfgTable=stgNewCfgTable, agPortCurCfgPVID=agPortCurCfgPVID, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, mirrPortMirr=mirrPortMirr, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, vlanNewCfgVlanName=vlanNewCfgVlanName, mirrOperTimeout=mirrOperTimeout, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, stgNewCfgPortState=stgNewCfgPortState, stgCurCfgTable=stgCurCfgTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, agPortNewCfgPVID=agPortNewCfgPVID, trunkgroup=trunkgroup, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, stgNewCfgPortIndex=stgNewCfgPortIndex, agPortNewCfgPortName=agPortNewCfgPortName, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, agPortCurCfgState=agPortCurCfgState, vlanCurCfgPorts=vlanCurCfgPorts, stgCurCfgPortIndex=stgCurCfgPortIndex, stgNewCfgStgIndex=stgNewCfgStgIndex, agPortCurCfgTableEntry=agPortCurCfgTableEntry, portInfoMode=portInfoMode, agPortCurCfgPrefLink=agPortCurCfgPrefLink, vlanCurCfgStg=vlanCurCfgStg, portCpuStatsUtilTable=portCpuStatsUtilTable, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, pmCurCfgMirroredPort=pmCurCfgMirroredPort, portCpuStats=portCpuStats, stgCurCfgStgIndex=stgCurCfgStgIndex, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portStatsTableEntry=portStatsTableEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgIndex=stgCurCfgIndex, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, vlanNewCfgPorts=vlanNewCfgPorts, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, portInfoIndx=portInfoIndx, pmNewCfgTimeout=pmNewCfgTimeout, agPortCurCfgVlanTag=agPortCurCfgVlanTag, vlanCurCfgState=vlanCurCfgState, agPortNewCfgBwmContract=agPortNewCfgBwmContract, portInfoLink=portInfoLink, agPortCurCfgRmon=agPortCurCfgRmon, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, agPortCurCfgPortName=agPortCurCfgPortName, vlanCurCfgJumbo=vlanCurCfgJumbo, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, spannTreeGrpCfg=spannTreeGrpCfg, portInfoSpeed=portInfoSpeed, portStatsTable=portStatsTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, vlanNewCfgBwmContract=vlanNewCfgBwmContract, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, mirrOperMonitoringPort=mirrOperMonitoringPort, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, agPortTableMaxEnt=agPortTableMaxEnt, trunkGroupTableMaxSize=trunkGroupTableMaxSize, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, port_info=port_info, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, pmNewCfgMirroredPort=pmNewCfgMirroredPort, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, pmCurCfgState=pmCurCfgState, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, portmirroring=portmirroring, vlanNewCfgTableEntry=vlanNewCfgTableEntry, agPortNewCfgRmon=agPortNewCfgRmon, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portStatsPhyIfInOctets=portStatsPhyIfInOctets, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, vlanCurCfgTableEntry=vlanCurCfgTableEntry, agPortNewCfgTable=agPortNewCfgTable, agPortNewCfgTableEntry=agPortNewCfgTableEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, vlanNewCfgJumbo=vlanNewCfgJumbo, mirroring=mirroring, vlanMaxEnt=vlanMaxEnt, pmNewCfgState=pmNewCfgState, port_stats=port_stats, agPortNewCfgBackLink=agPortNewCfgBackLink, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgPortState=stgCurCfgPortState, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, mirrOperType=mirrOperType, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, portInfoTable=portInfoTable, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, vlanNewCfgTable=vlanNewCfgTable, vlans=vlans, stgNewCfgState=stgNewCfgState, agPortCurCfgStp=agPortCurCfgStp, stgNewCfgTableEntry=stgNewCfgTableEntry, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, vlanNewCfgDelete=vlanNewCfgDelete, pmNewCfgPortMirrState=pmNewCfgPortMirrState, mirrOper=mirrOper, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanNewCfgAddPort=vlanNewCfgAddPort, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, agPortNewCfgPrefLink=agPortNewCfgPrefLink, vlanCurCfgBwmContract=vlanCurCfgBwmContract)
