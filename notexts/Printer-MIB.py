...
PrtConsoleColorTC, PrtMediaPathTypeTC, PrtAlertCodeTC, PrtConsoleDisableTC, PrtOutputTypeTC, PrtChannelTypeTC, PrtGeneralResetTC, PrtAlertGroupTC, PrtCoverStatusTC, PrtAlertTrainingLevelTC, PrtInputTypeTC, PrtMarkerSuppliesTypeTC, PrtInterpreterLangFamilyTC, PrtMarkerMarkTechTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtConsoleColorTC", "PrtMediaPathTypeTC", "PrtAlertCodeTC", "PrtConsoleDisableTC", "PrtOutputTypeTC", "PrtChannelTypeTC", "PrtGeneralResetTC", "PrtAlertGroupTC", "PrtCoverStatusTC", "PrtAlertTrainingLevelTC", "PrtInputTypeTC", "PrtMarkerSuppliesTypeTC", "PrtInterpreterLangFamilyTC", "PrtMarkerMarkTechTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtMediaPathTable=prtMediaPathTable, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtOutputType=prtOutputType, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtAlertDescription=prtAlertDescription, prtGeneralEntry=prtGeneralEntry, prtInputMediaColor=prtInputMediaColor, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtInputTable=prtInputTable, prtOutputOffsetStacking=prtOutputOffsetStacking, prtMarkerIndex=prtMarkerIndex, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtInputMediaWeight=prtInputMediaWeight, prtMediaPathStatus=prtMediaPathStatus, prtInterpreterDescription=prtInterpreterDescription, prtInterpreterLangLevel=prtInterpreterLangLevel, prtConsoleDisable=prtConsoleDisable, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, printerV1Alert=printerV1Alert, prtInterpreterIndex=prtInterpreterIndex, prtAlertTableGroup=prtAlertTableGroup, prtInputMediaGroup=prtInputMediaGroup, prtConsoleColor=prtConsoleColor, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtInputVersion=prtInputVersion, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtChannelType=prtChannelType, printmib=printmib, prtAlertCriticalEvents=prtAlertCriticalEvents, prtMarkerColorantEntry=prtMarkerColorantEntry, prtInterpreterGroup=prtInterpreterGroup, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtChannelV2Group=prtChannelV2Group, prtMarkerSouthMargin=prtMarkerSouthMargin, PrtChannelStateTC=PrtChannelStateTC, prtOutputDescription=prtOutputDescription, prtInterpreterVersion=prtInterpreterVersion, prtInputDimUnit=prtInputDimUnit, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtStorageRefTable=prtStorageRefTable, prtMarkerProcessColorants=prtMarkerProcessColorants, prtMarkerStatus=prtMarkerStatus, prtInputMediaType=prtInputMediaType, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtConsoleLights=prtConsoleLights, prtAlertSeverityLevel=prtAlertSeverityLevel, prtInterpreterEntry=prtInterpreterEntry, prtInputNextIndex=prtInputNextIndex, prtOutputIndex=prtOutputIndex, prtAlertTrainingLevel=prtAlertTrainingLevel, prtMarkerColorantRole=prtMarkerColorantRole, prtOutputVersion=prtOutputVersion, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtCoverDescription=prtCoverDescription, prtInputSerialNumber=prtInputSerialNumber, prtInputName=prtInputName, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtInputDescription=prtInputDescription, prtOutputMaxCapacity=prtOutputMaxCapacity, prtOutputBursting=prtOutputBursting, prtOutputPageCollated=prtOutputPageCollated, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtGeneralSerialNumber=prtGeneralSerialNumber, prtMarkerColorantValue=prtMarkerColorantValue, prtMediaPathIndex=prtMediaPathIndex, prtInterpreter=prtInterpreter, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtChannelGroup=prtChannelGroup, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtCoverTable=prtCoverTable, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, PresentOnOff=PresentOnOff, prtMarkerNorthMargin=prtMarkerNorthMargin, prtInterpreterLangFamily=prtInterpreterLangFamily, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtInputGroup=prtInputGroup, prtMarkerColorantGroup=prtMarkerColorantGroup, prtInputDefaultIndex=prtInputDefaultIndex, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, CapacityUnit=CapacityUnit, prtConsoleLocalization=prtConsoleLocalization, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtAlertGroupIndex=prtAlertGroupIndex, prtOutputDimUnit=prtOutputDimUnit, prtInputIndex=prtInputIndex, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtMarkerColorantTable=prtMarkerColorantTable, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtMIBCompliance=prtMIBCompliance, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtGeneralPrinterName=prtGeneralPrinterName, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtOutputVendorName=prtOutputVendorName, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtMIBConformance=prtMIBConformance, prtMediaPathGroup=prtMediaPathGroup, CodedCharSet=CodedCharSet, prtCoverIndex=prtCoverIndex, prtChannel=prtChannel, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtGeneralGroup=prtGeneralGroup, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtGeneralServicePerson=prtGeneralServicePerson, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtChannelStatus=prtChannelStatus, prtOutputStatus=prtOutputStatus, prtChannelIndex=prtChannelIndex, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtInputStatus=prtInputStatus, prtOutputDecollating=prtOutputDecollating, prtMarkerCounterUnit=prtMarkerCounterUnit, prtAlertAllEvents=prtAlertAllEvents, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtCoverStatus=prtCoverStatus, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtGeneralTable=prtGeneralTable, prtExtendedInputGroup=prtExtendedInputGroup, prtInputSwitchingGroup=prtInputSwitchingGroup, printerV2AlertPrefix=printerV2AlertPrefix, prtInputMediaFormParts=prtInputMediaFormParts, prtGeneralReset=prtGeneralReset, prtAlert=prtAlert, prtMIB2Groups=prtMIB2Groups, prtAlertGroup=prtAlertGroup, prtCover=prtCover, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, MediaUnit=MediaUnit, prtLocalization=prtLocalization, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtChannelIfIndex=prtChannelIfIndex, prtOutputName=prtOutputName, PYSNMP_MODULE_ID=printmib, prtOutputStackingOrder=prtOutputStackingOrder, prtOutputGroup=prtOutputGroup, prtChannelState=prtChannelState, prtInterpreterLangVersion=prtInterpreterLangVersion, prtAlertLocation=prtAlertLocation, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtLocalizationCountry=prtLocalizationCountry, prtDeviceRefIndex=prtDeviceRefIndex, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtMarkerMarkTech=prtMarkerMarkTech, prtMarker=prtMarker, prtMarkerEntry=prtMarkerEntry, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtStorageRefEntry=prtStorageRefEntry, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtAlertEntry=prtAlertEntry, prtAlertIndex=prtAlertIndex, PrtCapacityUnitTC=PrtCapacityUnitTC, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtMarkerSupplies=prtMarkerSupplies, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtMIBGroups=prtMIBGroups, prtConsoleGroup=prtConsoleGroup, prtStorageRefIndex=prtStorageRefIndex, prtInputMaxCapacity=prtInputMaxCapacity, prtInputMediaName=prtInputMediaName, prtMarkerTable=prtMarkerTable, SubUnitStatus=SubUnitStatus, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtMarkerColorantIndex=prtMarkerColorantIndex, prtMarkerEastMargin=prtMarkerEastMargin, prtMarkerColorantTonality=prtMarkerColorantTonality, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtMediaPath=prtMediaPath, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtConsoleLightIndex=prtConsoleLightIndex, prtDeviceRefEntry=prtDeviceRefEntry, prtConsoleOffTime=prtConsoleOffTime, prtChannelInformation=prtChannelInformation, prtAlertTimeGroup=prtAlertTimeGroup, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtConsoleLightTable=prtConsoleLightTable, prtInput=prtInput, PrtPrintOrientationTC=PrtPrintOrientationTC, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtMarkerWestMargin=prtMarkerWestMargin, prtOutputDefaultIndex=prtOutputDefaultIndex, prtInputVendorName=prtInputVendorName, prtChannelProtocolVersion=prtChannelProtocolVersion, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtInterpreterTable=prtInterpreterTable, prtAlertTrapGroup=prtAlertTrapGroup, prtOutput=prtOutput, prtLocalizationLanguage=prtLocalizationLanguage, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtOutputSerialNumber=prtOutputSerialNumber, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, PrtMediaUnitTC=PrtMediaUnitTC, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtMediaPathType=prtMediaPathType, prtAlertCode=prtAlertCode, prtOutputCapacityUnit=prtOutputCapacityUnit, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtInputEntry=prtInputEntry, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtAlertTime=prtAlertTime, prtInputType=prtInputType, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtCoverEntry=prtCoverEntry, prtGeneralConfigChanges=prtGeneralConfigChanges, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtMarkerSpotColorants=prtMarkerSpotColorants, prtChannelEntry=prtChannelEntry, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtChannelTable=prtChannelTable, prtMediaPathDescription=prtMediaPathDescription, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtLocalizationEntry=prtLocalizationEntry, prtDeviceRefTable=prtDeviceRefTable, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtMarkerSuppliesType=prtMarkerSuppliesType, prtConsoleLightEntry=prtConsoleLightEntry, prtMIB2Compliance=prtMIB2Compliance, prtConsoleOnTime=prtConsoleOnTime, prtInputCapacityUnit=prtInputCapacityUnit, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtLocalizationTable=prtLocalizationTable, prtMarkerColorant=prtMarkerColorant, prtMediaPathEntry=prtMediaPathEntry, prtAlertTable=prtAlertTable, prtGeneralV2Group=prtGeneralV2Group, prtInterpreterTwoWay=prtInterpreterTwoWay, prtExtendedOutputGroup=prtExtendedOutputGroup, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtInputModel=prtInputModel, prtOutputModel=prtOutputModel, printerV2Alert=printerV2Alert, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtInputCurrentLevel=prtInputCurrentLevel, prtMarkerLifeCount=prtMarkerLifeCount, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtAlertTableV2Group=prtAlertTableV2Group, prtOutputTable=prtOutputTable, prtMarkerGroup=prtMarkerGroup, prtInputSecurity=prtInputSecurity, prtOutputEntry=prtOutputEntry)
mibBuilder.exportSymbols("Printer-MIB", prtGeneral=prtGeneral, prtLocalizationIndex=prtLocalizationIndex, prtOutputSecurity=prtOutputSecurity, prtConsoleDescription=prtConsoleDescription)
