...
PrtChannelTypeTC, PrtMediaPathTypeTC, PrtAlertTrainingLevelTC, PrtMarkerMarkTechTC, PrtConsoleDisableTC, PrtGeneralResetTC, PrtAlertCodeTC, PrtConsoleColorTC, PrtInterpreterLangFamilyTC, PrtInputTypeTC, PrtMarkerSuppliesTypeTC, PrtOutputTypeTC, PrtCoverStatusTC, PrtAlertGroupTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtChannelTypeTC", "PrtMediaPathTypeTC", "PrtAlertTrainingLevelTC", "PrtMarkerMarkTechTC", "PrtConsoleDisableTC", "PrtGeneralResetTC", "PrtAlertCodeTC", "PrtConsoleColorTC", "PrtInterpreterLangFamilyTC", "PrtInputTypeTC", "PrtMarkerSuppliesTypeTC", "PrtOutputTypeTC", "PrtCoverStatusTC", "PrtAlertGroupTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtMarkerColorant=prtMarkerColorant, prtInputTable=prtInputTable, prtAlertIndex=prtAlertIndex, prtConsoleDisable=prtConsoleDisable, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtGeneralPrinterName=prtGeneralPrinterName, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtLocalizationTable=prtLocalizationTable, prtConsoleColor=prtConsoleColor, MediaUnit=MediaUnit, prtOutputTable=prtOutputTable, prtStorageRefIndex=prtStorageRefIndex, prtOutputDimUnit=prtOutputDimUnit, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtInputMediaGroup=prtInputMediaGroup, prtMarkerWestMargin=prtMarkerWestMargin, prtInputCapacityUnit=prtInputCapacityUnit, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtLocalizationIndex=prtLocalizationIndex, prtOutput=prtOutput, prtOutputDescription=prtOutputDescription, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtInputSecurity=prtInputSecurity, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtAlertTableV2Group=prtAlertTableV2Group, prtMarkerNorthMargin=prtMarkerNorthMargin, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtInterpreterLangVersion=prtInterpreterLangVersion, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtMarkerColorantGroup=prtMarkerColorantGroup, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtOutputBursting=prtOutputBursting, prtAlertAllEvents=prtAlertAllEvents, prtMarkerSuppliesType=prtMarkerSuppliesType, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtCoverTable=prtCoverTable, prtMediaPath=prtMediaPath, prtConsoleGroup=prtConsoleGroup, prtInputVersion=prtInputVersion, prtConsoleDescription=prtConsoleDescription, prtCoverIndex=prtCoverIndex, prtConsoleLightIndex=prtConsoleLightIndex, prtOutputSecurity=prtOutputSecurity, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, SubUnitStatus=SubUnitStatus, prtInputIndex=prtInputIndex, prtOutputType=prtOutputType, prtCover=prtCover, prtOutputVendorName=prtOutputVendorName, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtMarkerColorantEntry=prtMarkerColorantEntry, prtMarkerColorantTable=prtMarkerColorantTable, prtInterpreterIndex=prtInterpreterIndex, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtLocalization=prtLocalization, prtMarkerSuppliesClass=prtMarkerSuppliesClass, PresentOnOff=PresentOnOff, prtInputType=prtInputType, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtCoverEntry=prtCoverEntry, prtConsoleLights=prtConsoleLights, prtChannel=prtChannel, prtChannelInformation=prtChannelInformation, prtChannelIndex=prtChannelIndex, prtAlertTableGroup=prtAlertTableGroup, prtInputMediaType=prtInputMediaType, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtMarkerMarkTech=prtMarkerMarkTech, PrtPrintOrientationTC=PrtPrintOrientationTC, prtMarkerColorantRole=prtMarkerColorantRole, PrtCapacityUnitTC=PrtCapacityUnitTC, prtChannelState=prtChannelState, prtConsoleLightTable=prtConsoleLightTable, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, printmib=printmib, prtOutputName=prtOutputName, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtConsoleOffTime=prtConsoleOffTime, PrtChannelStateTC=PrtChannelStateTC, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtDeviceRefIndex=prtDeviceRefIndex, prtAlertTrainingLevel=prtAlertTrainingLevel, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtAlertTime=prtAlertTime, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtGeneralTable=prtGeneralTable, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtMediaPathEntry=prtMediaPathEntry, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtGeneralReset=prtGeneralReset, prtOutputEntry=prtOutputEntry, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtChannelIfIndex=prtChannelIfIndex, prtAlertSeverityLevel=prtAlertSeverityLevel, prtOutputVersion=prtOutputVersion, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtAlert=prtAlert, prtGeneralGroup=prtGeneralGroup, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtMIB2Groups=prtMIB2Groups, prtCoverDescription=prtCoverDescription, prtMarkerIndex=prtMarkerIndex, prtChannelV2Group=prtChannelV2Group, PrtMediaUnitTC=PrtMediaUnitTC, prtMarkerSpotColorants=prtMarkerSpotColorants, prtMIBCompliance=prtMIBCompliance, prtOutputModel=prtOutputModel, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtMarkerCounterUnit=prtMarkerCounterUnit, prtInterpreterDescription=prtInterpreterDescription, prtInterpreterGroup=prtInterpreterGroup, prtInputDescription=prtInputDescription, prtGeneral=prtGeneral, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtChannelTable=prtChannelTable, prtInputMediaFormParts=prtInputMediaFormParts, prtChannelType=prtChannelType, prtMIB2Compliance=prtMIB2Compliance, prtMarkerTable=prtMarkerTable, prtAlertTrapGroup=prtAlertTrapGroup, prtConsoleOnTime=prtConsoleOnTime, prtInputMediaName=prtInputMediaName, prtOutputGroup=prtOutputGroup, prtGeneralV2Group=prtGeneralV2Group, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtLocalizationLanguage=prtLocalizationLanguage, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtInput=prtInput, prtInterpreterTwoWay=prtInterpreterTwoWay, CapacityUnit=CapacityUnit, prtGeneralServicePerson=prtGeneralServicePerson, prtOutputSerialNumber=prtOutputSerialNumber, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtAlertLocation=prtAlertLocation, prtOutputPageCollated=prtOutputPageCollated, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtLocalizationEntry=prtLocalizationEntry, prtInputDimUnit=prtInputDimUnit, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtChannelStatus=prtChannelStatus, prtInterpreterLangLevel=prtInterpreterLangLevel, prtInputGroup=prtInputGroup, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtExtendedOutputGroup=prtExtendedOutputGroup, prtInputVendorName=prtInputVendorName, prtInterpreterEntry=prtInterpreterEntry, prtMarkerEastMargin=prtMarkerEastMargin, prtInterpreterLangFamily=prtInterpreterLangFamily, prtInputMediaColor=prtInputMediaColor, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtMediaPathTable=prtMediaPathTable, CodedCharSet=CodedCharSet, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtInputModel=prtInputModel, prtInputMaxCapacity=prtInputMaxCapacity, prtMarkerStatus=prtMarkerStatus, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtMarkerColorantValue=prtMarkerColorantValue, prtMIBConformance=prtMIBConformance, PYSNMP_MODULE_ID=printmib, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtMarkerLifeCount=prtMarkerLifeCount, prtMarkerColorantIndex=prtMarkerColorantIndex, prtInputSwitchingGroup=prtInputSwitchingGroup, prtMarker=prtMarker, prtDeviceRefEntry=prtDeviceRefEntry, prtMediaPathStatus=prtMediaPathStatus, prtInputSerialNumber=prtInputSerialNumber, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtChannelProtocolVersion=prtChannelProtocolVersion, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, printerV2Alert=printerV2Alert, prtOutputStackingOrder=prtOutputStackingOrder, prtAlertCriticalEvents=prtAlertCriticalEvents, prtInterpreterTable=prtInterpreterTable, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, printerV2AlertPrefix=printerV2AlertPrefix, printerV1Alert=printerV1Alert, prtExtendedInputGroup=prtExtendedInputGroup, prtOutputCapacityUnit=prtOutputCapacityUnit, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtMediaPathGroup=prtMediaPathGroup, prtAlertTimeGroup=prtAlertTimeGroup, prtStorageRefEntry=prtStorageRefEntry, prtAlertTable=prtAlertTable, prtOutputIndex=prtOutputIndex, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtInputMediaWeight=prtInputMediaWeight, prtMIBGroups=prtMIBGroups, prtAlertGroup=prtAlertGroup, prtGeneralSerialNumber=prtGeneralSerialNumber, prtMarkerSouthMargin=prtMarkerSouthMargin, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtInputStatus=prtInputStatus, prtConsoleLocalization=prtConsoleLocalization, prtMediaPathType=prtMediaPathType, prtInputEntry=prtInputEntry, prtMarkerGroup=prtMarkerGroup, prtStorageRefTable=prtStorageRefTable, prtInterpreter=prtInterpreter, prtMarkerColorantTonality=prtMarkerColorantTonality, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtAlertDescription=prtAlertDescription, prtOutputMaxCapacity=prtOutputMaxCapacity, prtInterpreterVersion=prtInterpreterVersion, prtMarkerSupplies=prtMarkerSupplies, prtGeneralEntry=prtGeneralEntry, prtOutputDecollating=prtOutputDecollating, prtAlertCode=prtAlertCode, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtInputCurrentLevel=prtInputCurrentLevel, prtMarkerEntry=prtMarkerEntry, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtChannelGroup=prtChannelGroup, prtInputName=prtInputName, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtConsoleLightEntry=prtConsoleLightEntry, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtInputNextIndex=prtInputNextIndex, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtOutputOffsetStacking=prtOutputOffsetStacking, prtAlertGroupIndex=prtAlertGroupIndex, prtChannelEntry=prtChannelEntry, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtAlertEntry=prtAlertEntry, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtMediaPathIndex=prtMediaPathIndex, prtInputDefaultIndex=prtInputDefaultIndex, prtOutputDefaultIndex=prtOutputDefaultIndex, prtMarkerProcessColorants=prtMarkerProcessColorants, prtCoverStatus=prtCoverStatus, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtGeneralConfigChanges=prtGeneralConfigChanges, prtOutputStatus=prtOutputStatus, prtDeviceRefTable=prtDeviceRefTable)
mibBuilder.exportSymbols("Printer-MIB", prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtMediaPathDescription=prtMediaPathDescription, prtLocalizationCountry=prtLocalizationCountry, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared)
