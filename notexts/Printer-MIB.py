...
PrtInputTypeTC, PrtAlertTrainingLevelTC, PrtConsoleColorTC, PrtAlertGroupTC, PrtOutputTypeTC, PrtCoverStatusTC, PrtChannelTypeTC, PrtMarkerMarkTechTC, PrtGeneralResetTC, PrtMarkerSuppliesTypeTC, PrtInterpreterLangFamilyTC, PrtMediaPathTypeTC, PrtConsoleDisableTC, PrtAlertCodeTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtInputTypeTC", "PrtAlertTrainingLevelTC", "PrtConsoleColorTC", "PrtAlertGroupTC", "PrtOutputTypeTC", "PrtCoverStatusTC", "PrtChannelTypeTC", "PrtMarkerMarkTechTC", "PrtGeneralResetTC", "PrtMarkerSuppliesTypeTC", "PrtInterpreterLangFamilyTC", "PrtMediaPathTypeTC", "PrtConsoleDisableTC", "PrtAlertCodeTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtInputName=prtInputName, prtMarkerLifeCount=prtMarkerLifeCount, prtCoverStatus=prtCoverStatus, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtDeviceRefTable=prtDeviceRefTable, prtOutputVendorName=prtOutputVendorName, prtStorageRefTable=prtStorageRefTable, prtOutputDecollating=prtOutputDecollating, prtAlert=prtAlert, prtConsoleOnTime=prtConsoleOnTime, prtOutputGroup=prtOutputGroup, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtGeneralSerialNumber=prtGeneralSerialNumber, prtMarkerColorantRole=prtMarkerColorantRole, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtLocalizationLanguage=prtLocalizationLanguage, prtAlertGroupIndex=prtAlertGroupIndex, prtInputCurrentLevel=prtInputCurrentLevel, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtInputDescription=prtInputDescription, prtMarkerWestMargin=prtMarkerWestMargin, prtMarkerMarkTech=prtMarkerMarkTech, prtGeneral=prtGeneral, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, PrtPrintOrientationTC=PrtPrintOrientationTC, prtAlertCriticalEvents=prtAlertCriticalEvents, prtInputEntry=prtInputEntry, prtLocalizationIndex=prtLocalizationIndex, prtInputType=prtInputType, prtInputMediaType=prtInputMediaType, prtOutputStackingOrder=prtOutputStackingOrder, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtMediaPathTable=prtMediaPathTable, prtInterpreterIndex=prtInterpreterIndex, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtGeneralServicePerson=prtGeneralServicePerson, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtInterpreterGroup=prtInterpreterGroup, prtInputDimUnit=prtInputDimUnit, prtInterpreterVersion=prtInterpreterVersion, prtAlertTrapGroup=prtAlertTrapGroup, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtInputModel=prtInputModel, prtMarkerSupplies=prtMarkerSupplies, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtMarkerProcessColorants=prtMarkerProcessColorants, prtMIBCompliance=prtMIBCompliance, prtOutputDescription=prtOutputDescription, prtInputGroup=prtInputGroup, prtInterpreterLangLevel=prtInterpreterLangLevel, prtInputNextIndex=prtInputNextIndex, prtConsoleColor=prtConsoleColor, prtInputMediaName=prtInputMediaName, PresentOnOff=PresentOnOff, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtGeneralEntry=prtGeneralEntry, prtOutput=prtOutput, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtInputMediaFormParts=prtInputMediaFormParts, prtMediaPathEntry=prtMediaPathEntry, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtGeneralGroup=prtGeneralGroup, prtOutputDefaultIndex=prtOutputDefaultIndex, SubUnitStatus=SubUnitStatus, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtAlertDescription=prtAlertDescription, prtInputSwitchingGroup=prtInputSwitchingGroup, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtInputMaxCapacity=prtInputMaxCapacity, prtConsoleLightIndex=prtConsoleLightIndex, prtMarkerIndex=prtMarkerIndex, prtMediaPath=prtMediaPath, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtDeviceRefEntry=prtDeviceRefEntry, prtConsoleGroup=prtConsoleGroup, prtMarkerSuppliesType=prtMarkerSuppliesType, prtOutputIndex=prtOutputIndex, prtMarkerColorantTonality=prtMarkerColorantTonality, prtMarkerSouthMargin=prtMarkerSouthMargin, prtInterpreterTable=prtInterpreterTable, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtInput=prtInput, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtMIB2Groups=prtMIB2Groups, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtInputTable=prtInputTable, prtInterpreter=prtInterpreter, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtMarkerEastMargin=prtMarkerEastMargin, prtOutputMaxCapacity=prtOutputMaxCapacity, prtConsoleOffTime=prtConsoleOffTime, prtInterpreterEntry=prtInterpreterEntry, prtMIBConformance=prtMIBConformance, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtInputSerialNumber=prtInputSerialNumber, prtChannelIfIndex=prtChannelIfIndex, prtAlertEntry=prtAlertEntry, prtMediaPathDescription=prtMediaPathDescription, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtOutputEntry=prtOutputEntry, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtChannelProtocolVersion=prtChannelProtocolVersion, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtConsoleLightTable=prtConsoleLightTable, prtMarkerPowerOnCount=prtMarkerPowerOnCount, PrtMediaUnitTC=PrtMediaUnitTC, prtMarkerColorantValue=prtMarkerColorantValue, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtOutputTable=prtOutputTable, prtAlertGroup=prtAlertGroup, PrtChannelStateTC=PrtChannelStateTC, prtMarkerStatus=prtMarkerStatus, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtInputDefaultIndex=prtInputDefaultIndex, prtMarkerGroup=prtMarkerGroup, CodedCharSet=CodedCharSet, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtMarkerColorantGroup=prtMarkerColorantGroup, prtCover=prtCover, printerV2AlertPrefix=printerV2AlertPrefix, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtMarkerColorantTable=prtMarkerColorantTable, prtChannelTable=prtChannelTable, prtConsoleLightEntry=prtConsoleLightEntry, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtMediaPathGroup=prtMediaPathGroup, prtInputVersion=prtInputVersion, prtOutputType=prtOutputType, PYSNMP_MODULE_ID=printmib, prtExtendedInputGroup=prtExtendedInputGroup, prtOutputOffsetStacking=prtOutputOffsetStacking, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtMarker=prtMarker, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtInputMediaGroup=prtInputMediaGroup, prtInterpreterDescription=prtInterpreterDescription, prtGeneralPrinterName=prtGeneralPrinterName, prtInputSecurity=prtInputSecurity, prtMediaPathType=prtMediaPathType, prtCoverEntry=prtCoverEntry, prtInputCapacityUnit=prtInputCapacityUnit, prtMarkerColorantEntry=prtMarkerColorantEntry, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtChannel=prtChannel, prtAlertCode=prtAlertCode, prtChannelV2Group=prtChannelV2Group, prtAlertLocation=prtAlertLocation, prtInputMediaColor=prtInputMediaColor, prtChannelState=prtChannelState, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtChannelInformation=prtChannelInformation, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, CapacityUnit=CapacityUnit, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtAlertTable=prtAlertTable, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtOutputBursting=prtOutputBursting, prtChannelIndex=prtChannelIndex, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtAlertTableV2Group=prtAlertTableV2Group, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtAlertTime=prtAlertTime, prtInputMediaWeight=prtInputMediaWeight, prtMarkerEntry=prtMarkerEntry, prtGeneralV2Group=prtGeneralV2Group, prtOutputDimUnit=prtOutputDimUnit, prtAlertIndex=prtAlertIndex, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtInputVendorName=prtInputVendorName, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtConsoleDescription=prtConsoleDescription, prtOutputCapacityUnit=prtOutputCapacityUnit, prtGeneralTable=prtGeneralTable, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtOutputModel=prtOutputModel, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtConsoleDisable=prtConsoleDisable, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtOutputName=prtOutputName, prtMediaPathIndex=prtMediaPathIndex, prtAlertTableGroup=prtAlertTableGroup, prtOutputVersion=prtOutputVersion, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtStorageRefIndex=prtStorageRefIndex, MediaUnit=MediaUnit, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtOutputSecurity=prtOutputSecurity, prtChannelType=prtChannelType, prtInterpreterLangFamily=prtInterpreterLangFamily, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtCoverTable=prtCoverTable, prtLocalizationTable=prtLocalizationTable, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtAlertAllEvents=prtAlertAllEvents, printerV2Alert=printerV2Alert, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtLocalizationEntry=prtLocalizationEntry, prtMarkerCounterUnit=prtMarkerCounterUnit, prtOutputStatus=prtOutputStatus, prtMarkerColorantIndex=prtMarkerColorantIndex, prtChannelEntry=prtChannelEntry, prtInterpreterTwoWay=prtInterpreterTwoWay, prtOutputPageCollated=prtOutputPageCollated, prtConsoleLights=prtConsoleLights, prtExtendedOutputGroup=prtExtendedOutputGroup, prtMediaPathStatus=prtMediaPathStatus, prtInputIndex=prtInputIndex, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtMarkerColorant=prtMarkerColorant, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtAlertSeverityLevel=prtAlertSeverityLevel, prtChannelGroup=prtChannelGroup, prtGeneralConfigChanges=prtGeneralConfigChanges, prtInterpreterLangVersion=prtInterpreterLangVersion, prtMarkerTable=prtMarkerTable, prtConsoleLocalization=prtConsoleLocalization, prtInputStatus=prtInputStatus, prtAlertTimeGroup=prtAlertTimeGroup, prtChannelStatus=prtChannelStatus, prtOutputSerialNumber=prtOutputSerialNumber, prtMIB2Compliance=prtMIB2Compliance, prtAlertTrainingLevel=prtAlertTrainingLevel, printerV1Alert=printerV1Alert, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtMIBGroups=prtMIBGroups, PrtCapacityUnitTC=PrtCapacityUnitTC, prtDeviceRefIndex=prtDeviceRefIndex, prtMarkerNorthMargin=prtMarkerNorthMargin, prtLocalizationCountry=prtLocalizationCountry, prtMarkerSpotColorants=prtMarkerSpotColorants, prtStorageRefEntry=prtStorageRefEntry, prtGeneralReset=prtGeneralReset, printmib=printmib)
mibBuilder.exportSymbols("Printer-MIB", prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtLocalization=prtLocalization, prtCoverDescription=prtCoverDescription, prtCoverIndex=prtCoverIndex)
