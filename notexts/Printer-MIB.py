...
PrtMarkerSuppliesTypeTC, PrtConsoleColorTC, PrtOutputTypeTC, PrtChannelTypeTC, PrtInputTypeTC, PrtAlertTrainingLevelTC, PrtAlertGroupTC, PrtAlertCodeTC, PrtInterpreterLangFamilyTC, PrtGeneralResetTC, PrtConsoleDisableTC, PrtCoverStatusTC, PrtMarkerMarkTechTC, PrtMediaPathTypeTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtMarkerSuppliesTypeTC", "PrtConsoleColorTC", "PrtOutputTypeTC", "PrtChannelTypeTC", "PrtInputTypeTC", "PrtAlertTrainingLevelTC", "PrtAlertGroupTC", "PrtAlertCodeTC", "PrtInterpreterLangFamilyTC", "PrtGeneralResetTC", "PrtConsoleDisableTC", "PrtCoverStatusTC", "PrtMarkerMarkTechTC", "PrtMediaPathTypeTC")
...
mibBuilder.exportSymbols("Printer-MIB", PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtChannel=prtChannel, prtInputSecurity=prtInputSecurity, prtOutputStatus=prtOutputStatus, prtMarkerProcessColorants=prtMarkerProcessColorants, prtOutputBursting=prtOutputBursting, prtInterpreterDescription=prtInterpreterDescription, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtAlertDescription=prtAlertDescription, prtInput=prtInput, prtInputDescription=prtInputDescription, prtInterpreterGroup=prtInterpreterGroup, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtInterpreterLangVersion=prtInterpreterLangVersion, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtMarkerMarkTech=prtMarkerMarkTech, prtConsoleDescription=prtConsoleDescription, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtChannelType=prtChannelType, prtConsoleOnTime=prtConsoleOnTime, prtOutputIndex=prtOutputIndex, PYSNMP_MODULE_ID=printmib, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtInputTable=prtInputTable, prtInputMediaFormParts=prtInputMediaFormParts, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtMediaPath=prtMediaPath, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtLocalizationLanguage=prtLocalizationLanguage, prtMarkerSpotColorants=prtMarkerSpotColorants, prtInputEntry=prtInputEntry, prtInputDefaultIndex=prtInputDefaultIndex, prtMarkerSuppliesType=prtMarkerSuppliesType, prtMediaPathEntry=prtMediaPathEntry, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtInputIndex=prtInputIndex, prtChannelGroup=prtChannelGroup, CapacityUnit=CapacityUnit, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtMarkerWestMargin=prtMarkerWestMargin, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtGeneral=prtGeneral, prtMarkerColorantRole=prtMarkerColorantRole, prtGeneralSerialNumber=prtGeneralSerialNumber, prtMarkerColorantTable=prtMarkerColorantTable, prtLocalization=prtLocalization, prtInputMediaType=prtInputMediaType, prtMarkerStatus=prtMarkerStatus, prtOutputDecollating=prtOutputDecollating, prtGeneralConfigChanges=prtGeneralConfigChanges, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtInterpreterLangLevel=prtInterpreterLangLevel, prtOutputDescription=prtOutputDescription, prtAlertCode=prtAlertCode, prtOutputCapacityUnit=prtOutputCapacityUnit, prtMediaPathDescription=prtMediaPathDescription, printmib=printmib, prtInputName=prtInputName, prtOutputSerialNumber=prtOutputSerialNumber, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtInputSwitchingGroup=prtInputSwitchingGroup, prtAlertTime=prtAlertTime, prtGeneralGroup=prtGeneralGroup, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtAlertCriticalEvents=prtAlertCriticalEvents, prtGeneralTable=prtGeneralTable, prtInputModel=prtInputModel, prtChannelIndex=prtChannelIndex, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtConsoleLightIndex=prtConsoleLightIndex, prtMarkerColorant=prtMarkerColorant, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtOutputMaxCapacity=prtOutputMaxCapacity, prtStorageRefEntry=prtStorageRefEntry, prtMarkerNorthMargin=prtMarkerNorthMargin, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, printerV1Alert=printerV1Alert, prtMarker=prtMarker, prtConsoleGroup=prtConsoleGroup, prtMediaPathTable=prtMediaPathTable, prtOutputModel=prtOutputModel, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtMarkerLifeCount=prtMarkerLifeCount, prtOutputPageCollated=prtOutputPageCollated, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtMediaPathGroup=prtMediaPathGroup, prtInputMediaWeight=prtInputMediaWeight, prtOutputName=prtOutputName, prtChannelState=prtChannelState, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtInterpreterTable=prtInterpreterTable, PrtCapacityUnitTC=PrtCapacityUnitTC, prtGeneralPrinterName=prtGeneralPrinterName, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtMediaPathStatus=prtMediaPathStatus, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtAlertSeverityLevel=prtAlertSeverityLevel, prtOutputTable=prtOutputTable, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtInterpreter=prtInterpreter, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtInterpreterLangFamily=prtInterpreterLangFamily, prtChannelProtocolVersion=prtChannelProtocolVersion, prtDeviceRefTable=prtDeviceRefTable, prtMIB2Groups=prtMIB2Groups, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtCover=prtCover, prtInputType=prtInputType, printerV2AlertPrefix=printerV2AlertPrefix, prtGeneralReset=prtGeneralReset, prtAlertTimeGroup=prtAlertTimeGroup, prtAlertTableGroup=prtAlertTableGroup, prtAlertAllEvents=prtAlertAllEvents, prtChannelIfIndex=prtChannelIfIndex, prtConsoleColor=prtConsoleColor, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtOutputVersion=prtOutputVersion, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtInputGroup=prtInputGroup, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtChannelTable=prtChannelTable, prtMIBConformance=prtMIBConformance, prtOutputSecurity=prtOutputSecurity, prtConsoleOffTime=prtConsoleOffTime, prtInputSerialNumber=prtInputSerialNumber, prtInputMediaColor=prtInputMediaColor, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, SubUnitStatus=SubUnitStatus, prtInterpreterTwoWay=prtInterpreterTwoWay, prtMIB2Compliance=prtMIB2Compliance, prtExtendedOutputGroup=prtExtendedOutputGroup, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtMarkerTable=prtMarkerTable, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtInterpreterIndex=prtInterpreterIndex, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtCoverTable=prtCoverTable, prtOutputGroup=prtOutputGroup, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtConsoleLights=prtConsoleLights, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtGeneralEntry=prtGeneralEntry, prtLocalizationTable=prtLocalizationTable, prtMarkerColorantValue=prtMarkerColorantValue, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtConsoleLightEntry=prtConsoleLightEntry, prtStorageRefIndex=prtStorageRefIndex, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtOutputDimUnit=prtOutputDimUnit, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtInterpreterEntry=prtInterpreterEntry, prtAlertTrainingLevel=prtAlertTrainingLevel, prtMarkerSouthMargin=prtMarkerSouthMargin, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtOutputVendorName=prtOutputVendorName, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtOutputOffsetStacking=prtOutputOffsetStacking, prtInterpreterVersion=prtInterpreterVersion, prtMarkerEntry=prtMarkerEntry, prtCoverStatus=prtCoverStatus, prtStorageRefTable=prtStorageRefTable, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtMarkerColorantTonality=prtMarkerColorantTonality, prtInputDimUnit=prtInputDimUnit, prtOutputEntry=prtOutputEntry, printerV2Alert=printerV2Alert, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtMIBGroups=prtMIBGroups, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtExtendedInputGroup=prtExtendedInputGroup, prtInputMediaGroup=prtInputMediaGroup, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, CodedCharSet=CodedCharSet, prtGeneralServicePerson=prtGeneralServicePerson, prtMarkerIndex=prtMarkerIndex, PrtMediaUnitTC=PrtMediaUnitTC, prtMediaPathIndex=prtMediaPathIndex, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtChannelEntry=prtChannelEntry, prtMarkerGroup=prtMarkerGroup, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtChannelInformation=prtChannelInformation, prtAlertEntry=prtAlertEntry, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtChannelStatus=prtChannelStatus, prtDeviceRefIndex=prtDeviceRefIndex, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtInputMaxCapacity=prtInputMaxCapacity, prtMarkerEastMargin=prtMarkerEastMargin, prtAlertTableV2Group=prtAlertTableV2Group, prtLocalizationIndex=prtLocalizationIndex, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtConsoleDisable=prtConsoleDisable, prtMarkerColorantEntry=prtMarkerColorantEntry, prtInputMediaName=prtInputMediaName, prtDeviceRefEntry=prtDeviceRefEntry, prtInputNextIndex=prtInputNextIndex, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtInputStatus=prtInputStatus, prtInputCurrentLevel=prtInputCurrentLevel, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtConsoleLightTable=prtConsoleLightTable, prtAlertLocation=prtAlertLocation, prtAlertTrapGroup=prtAlertTrapGroup, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, PresentOnOff=PresentOnOff, prtCoverEntry=prtCoverEntry, prtGeneralV2Group=prtGeneralV2Group, PrtChannelStateTC=PrtChannelStateTC, prtOutputStackingOrder=prtOutputStackingOrder, prtOutputDefaultIndex=prtOutputDefaultIndex, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtConsoleLocalization=prtConsoleLocalization, prtMediaPathType=prtMediaPathType, prtAlertTable=prtAlertTable, prtAlertIndex=prtAlertIndex, MediaUnit=MediaUnit, prtMarkerColorantGroup=prtMarkerColorantGroup, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtOutput=prtOutput, prtInputCapacityUnit=prtInputCapacityUnit, prtCoverDescription=prtCoverDescription, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtInputVendorName=prtInputVendorName, prtAlertGroupIndex=prtAlertGroupIndex, prtMIBCompliance=prtMIBCompliance, prtMarkerCounterUnit=prtMarkerCounterUnit, prtOutputType=prtOutputType, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtChannelV2Group=prtChannelV2Group, prtMarkerColorantIndex=prtMarkerColorantIndex, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtLocalizationCountry=prtLocalizationCountry, prtInputVersion=prtInputVersion, prtAlert=prtAlert, prtCoverIndex=prtCoverIndex, prtMarkerSupplies=prtMarkerSupplies)
mibBuilder.exportSymbols("Printer-MIB", prtLocalizationEntry=prtLocalizationEntry, prtAlertGroup=prtAlertGroup, prtOutputRemainingCapacity=prtOutputRemainingCapacity, PrtPrintOrientationTC=PrtPrintOrientationTC)
