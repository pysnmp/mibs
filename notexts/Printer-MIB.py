...
PrtMediaPathTypeTC, PrtOutputTypeTC, PrtAlertTrainingLevelTC, PrtInterpreterLangFamilyTC, PrtAlertGroupTC, PrtConsoleDisableTC, PrtMarkerSuppliesTypeTC, PrtAlertCodeTC, PrtCoverStatusTC, PrtChannelTypeTC, PrtGeneralResetTC, PrtMarkerMarkTechTC, PrtConsoleColorTC, PrtInputTypeTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtMediaPathTypeTC", "PrtOutputTypeTC", "PrtAlertTrainingLevelTC", "PrtInterpreterLangFamilyTC", "PrtAlertGroupTC", "PrtConsoleDisableTC", "PrtMarkerSuppliesTypeTC", "PrtAlertCodeTC", "PrtCoverStatusTC", "PrtChannelTypeTC", "PrtGeneralResetTC", "PrtMarkerMarkTechTC", "PrtConsoleColorTC", "PrtInputTypeTC")
...
mibBuilder.exportSymbols("Printer-MIB", printmib=printmib, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtLocalizationEntry=prtLocalizationEntry, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtInterpreterIndex=prtInterpreterIndex, prtAlertTableV2Group=prtAlertTableV2Group, SubUnitStatus=SubUnitStatus, PrtChannelStateTC=PrtChannelStateTC, prtChannelTable=prtChannelTable, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtMarkerGroup=prtMarkerGroup, prtInputVersion=prtInputVersion, prtCoverStatus=prtCoverStatus, prtStorageRefEntry=prtStorageRefEntry, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtChannel=prtChannel, prtGeneralTable=prtGeneralTable, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtInputIndex=prtInputIndex, prtInputCurrentLevel=prtInputCurrentLevel, prtInputSecurity=prtInputSecurity, prtAlertAllEvents=prtAlertAllEvents, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, printerV1Alert=printerV1Alert, prtInputModel=prtInputModel, prtChannelGroup=prtChannelGroup, prtMIB2Groups=prtMIB2Groups, prtInputName=prtInputName, prtMarkerMarkTech=prtMarkerMarkTech, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtAlert=prtAlert, prtAlertTableGroup=prtAlertTableGroup, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtInputEntry=prtInputEntry, prtAlertTime=prtAlertTime, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtInterpreterLangVersion=prtInterpreterLangVersion, prtMIBCompliance=prtMIBCompliance, prtOutputMaxCapacity=prtOutputMaxCapacity, prtConsoleLightTable=prtConsoleLightTable, prtGeneralConfigChanges=prtGeneralConfigChanges, prtGeneralEntry=prtGeneralEntry, prtChannelV2Group=prtChannelV2Group, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtOutputDimUnit=prtOutputDimUnit, prtInterpreterGroup=prtInterpreterGroup, prtOutputIndex=prtOutputIndex, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtMediaPathDescription=prtMediaPathDescription, prtMarkerNorthMargin=prtMarkerNorthMargin, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtOutputStatus=prtOutputStatus, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtAlertGroup=prtAlertGroup, prtGeneralServicePerson=prtGeneralServicePerson, prtMarkerCounterUnit=prtMarkerCounterUnit, prtConsoleLights=prtConsoleLights, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtOutputDefaultIndex=prtOutputDefaultIndex, prtAlertTrainingLevel=prtAlertTrainingLevel, prtCoverIndex=prtCoverIndex, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtInputMaxCapacity=prtInputMaxCapacity, prtInputSwitchingGroup=prtInputSwitchingGroup, prtOutputGroup=prtOutputGroup, prtInputMediaWeight=prtInputMediaWeight, prtInputMediaColor=prtInputMediaColor, prtChannelState=prtChannelState, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtMediaPathEntry=prtMediaPathEntry, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtAlertCriticalEvents=prtAlertCriticalEvents, prtCoverTable=prtCoverTable, prtMarkerColorant=prtMarkerColorant, prtOutputDescription=prtOutputDescription, prtConsoleOnTime=prtConsoleOnTime, prtConsoleDescription=prtConsoleDescription, prtAlertIndex=prtAlertIndex, prtConsoleGroup=prtConsoleGroup, prtGeneralV2Group=prtGeneralV2Group, prtInputType=prtInputType, prtMarkerLifeCount=prtMarkerLifeCount, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtGeneralSerialNumber=prtGeneralSerialNumber, prtMarkerSuppliesType=prtMarkerSuppliesType, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtLocalizationLanguage=prtLocalizationLanguage, prtChannelEntry=prtChannelEntry, prtLocalization=prtLocalization, prtInterpreterDescription=prtInterpreterDescription, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtInterpreterLangLevel=prtInterpreterLangLevel, prtExtendedInputGroup=prtExtendedInputGroup, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtAlertGroupIndex=prtAlertGroupIndex, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtMediaPathStatus=prtMediaPathStatus, prtMediaPath=prtMediaPath, prtInterpreterLangFamily=prtInterpreterLangFamily, prtExtendedOutputGroup=prtExtendedOutputGroup, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtMarkerColorantEntry=prtMarkerColorantEntry, PrtMediaUnitTC=PrtMediaUnitTC, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtInputTable=prtInputTable, prtMarkerWestMargin=prtMarkerWestMargin, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtConsoleOffTime=prtConsoleOffTime, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtLocalizationIndex=prtLocalizationIndex, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, PYSNMP_MODULE_ID=printmib, prtDeviceRefTable=prtDeviceRefTable, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtCoverEntry=prtCoverEntry, prtOutputTable=prtOutputTable, prtOutputVendorName=prtOutputVendorName, prtMediaPathGroup=prtMediaPathGroup, prtChannelStatus=prtChannelStatus, prtDeviceRefIndex=prtDeviceRefIndex, prtInputDimUnit=prtInputDimUnit, prtMarkerProcessColorants=prtMarkerProcessColorants, prtInputCapacityUnit=prtInputCapacityUnit, prtMIBConformance=prtMIBConformance, prtMarker=prtMarker, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtMarkerSpotColorants=prtMarkerSpotColorants, prtInterpreterVersion=prtInterpreterVersion, prtMarkerStatus=prtMarkerStatus, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtConsoleDisable=prtConsoleDisable, prtConsoleColor=prtConsoleColor, prtInputDescription=prtInputDescription, prtLocalizationTable=prtLocalizationTable, prtMediaPathIndex=prtMediaPathIndex, PrtPrintOrientationTC=PrtPrintOrientationTC, prtAlertDescription=prtAlertDescription, prtInputGroup=prtInputGroup, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtOutputPageCollated=prtOutputPageCollated, prtMediaPathType=prtMediaPathType, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtConsoleLocalization=prtConsoleLocalization, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtMarkerEntry=prtMarkerEntry, prtOutputOffsetStacking=prtOutputOffsetStacking, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtInputSerialNumber=prtInputSerialNumber, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtAlertEntry=prtAlertEntry, prtAlertTrapGroup=prtAlertTrapGroup, prtAlertTimeGroup=prtAlertTimeGroup, prtInputMediaFormParts=prtInputMediaFormParts, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtInputDefaultIndex=prtInputDefaultIndex, prtOutputCapacityUnit=prtOutputCapacityUnit, prtMarkerSouthMargin=prtMarkerSouthMargin, prtMediaPathTable=prtMediaPathTable, prtGeneralPrinterName=prtGeneralPrinterName, prtCover=prtCover, prtInputNextIndex=prtInputNextIndex, prtMIB2Compliance=prtMIB2Compliance, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtMarkerColorantGroup=prtMarkerColorantGroup, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtDeviceRefEntry=prtDeviceRefEntry, prtOutputModel=prtOutputModel, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtConsoleLightIndex=prtConsoleLightIndex, prtStorageRefTable=prtStorageRefTable, prtMarkerColorantRole=prtMarkerColorantRole, prtOutputBursting=prtOutputBursting, prtMarkerColorantValue=prtMarkerColorantValue, prtOutputDecollating=prtOutputDecollating, prtAlertCode=prtAlertCode, prtGeneral=prtGeneral, prtChannelIfIndex=prtChannelIfIndex, prtInterpreterTable=prtInterpreterTable, prtAlertTable=prtAlertTable, prtInputMediaGroup=prtInputMediaGroup, PresentOnOff=PresentOnOff, prtInputMediaName=prtInputMediaName, CapacityUnit=CapacityUnit, prtOutputType=prtOutputType, prtOutput=prtOutput, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtMIBGroups=prtMIBGroups, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtInterpreter=prtInterpreter, prtMarkerIndex=prtMarkerIndex, prtAlertLocation=prtAlertLocation, prtCoverDescription=prtCoverDescription, prtInputMediaType=prtInputMediaType, prtStorageRefIndex=prtStorageRefIndex, prtMarkerColorantTonality=prtMarkerColorantTonality, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtMarkerTable=prtMarkerTable, prtInputVendorName=prtInputVendorName, prtOutputStackingOrder=prtOutputStackingOrder, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtChannelInformation=prtChannelInformation, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, printerV2AlertPrefix=printerV2AlertPrefix, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtChannelIndex=prtChannelIndex, prtInputStatus=prtInputStatus, MediaUnit=MediaUnit, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtInput=prtInput, prtOutputVersion=prtOutputVersion, prtMarkerEastMargin=prtMarkerEastMargin, prtMarkerSupplies=prtMarkerSupplies, prtGeneralReset=prtGeneralReset, prtMarkerColorantIndex=prtMarkerColorantIndex, prtMarkerColorantTable=prtMarkerColorantTable, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtOutputName=prtOutputName, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtInterpreterTwoWay=prtInterpreterTwoWay, printerV2Alert=printerV2Alert, prtChannelProtocolVersion=prtChannelProtocolVersion, prtChannelType=prtChannelType, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtConsoleLightEntry=prtConsoleLightEntry, prtLocalizationCountry=prtLocalizationCountry, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtOutputSecurity=prtOutputSecurity, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtGeneralGroup=prtGeneralGroup, prtOutputFeaturesGroup=prtOutputFeaturesGroup, PrtCapacityUnitTC=PrtCapacityUnitTC, CodedCharSet=CodedCharSet, prtOutputEntry=prtOutputEntry, prtAlertSeverityLevel=prtAlertSeverityLevel, prtOutputSerialNumber=prtOutputSerialNumber)
mibBuilder.exportSymbols("Printer-MIB", PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtInterpreterEntry=prtInterpreterEntry)
