...
PrtAlertGroupTC, PrtMarkerSuppliesTypeTC, PrtConsoleColorTC, PrtGeneralResetTC, PrtInterpreterLangFamilyTC, PrtMarkerMarkTechTC, PrtAlertCodeTC, PrtOutputTypeTC, PrtCoverStatusTC, PrtInputTypeTC, PrtConsoleDisableTC, PrtChannelTypeTC, PrtMediaPathTypeTC, PrtAlertTrainingLevelTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtAlertGroupTC", "PrtMarkerSuppliesTypeTC", "PrtConsoleColorTC", "PrtGeneralResetTC", "PrtInterpreterLangFamilyTC", "PrtMarkerMarkTechTC", "PrtAlertCodeTC", "PrtOutputTypeTC", "PrtCoverStatusTC", "PrtInputTypeTC", "PrtConsoleDisableTC", "PrtChannelTypeTC", "PrtMediaPathTypeTC", "PrtAlertTrainingLevelTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, SubUnitStatus=SubUnitStatus, prtOutputType=prtOutputType, prtAlertGroupIndex=prtAlertGroupIndex, prtMarkerSuppliesType=prtMarkerSuppliesType, prtAlertTrainingLevel=prtAlertTrainingLevel, PrtCapacityUnitTC=PrtCapacityUnitTC, prtMediaPathEntry=prtMediaPathEntry, prtInterpreterTwoWay=prtInterpreterTwoWay, prtGeneralV2Group=prtGeneralV2Group, prtAlertTable=prtAlertTable, prtChannelV2Group=prtChannelV2Group, prtMarkerSouthMargin=prtMarkerSouthMargin, prtCoverStatus=prtCoverStatus, prtMediaPath=prtMediaPath, prtOutputGroup=prtOutputGroup, prtConsoleLocalization=prtConsoleLocalization, prtOutput=prtOutput, prtChannelIndex=prtChannelIndex, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtOutputDefaultIndex=prtOutputDefaultIndex, prtOutputTable=prtOutputTable, prtInputMediaFormParts=prtInputMediaFormParts, prtConsoleLights=prtConsoleLights, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtChannelType=prtChannelType, prtOutputIndex=prtOutputIndex, prtChannelProtocolVersion=prtChannelProtocolVersion, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtMediaPathGroup=prtMediaPathGroup, prtCoverIndex=prtCoverIndex, prtGeneralPrinterName=prtGeneralPrinterName, printerV2Alert=printerV2Alert, prtConsoleLightEntry=prtConsoleLightEntry, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtOutputDecollating=prtOutputDecollating, prtOutputVersion=prtOutputVersion, CodedCharSet=CodedCharSet, prtInterpreterTable=prtInterpreterTable, prtStorageRefTable=prtStorageRefTable, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtInputMediaColor=prtInputMediaColor, prtMarkerLifeCount=prtMarkerLifeCount, prtGeneralConfigChanges=prtGeneralConfigChanges, prtOutputStatus=prtOutputStatus, prtCover=prtCover, prtGeneralSerialNumber=prtGeneralSerialNumber, prtInputMediaWeight=prtInputMediaWeight, prtInputSwitchingGroup=prtInputSwitchingGroup, prtConsoleLightTable=prtConsoleLightTable, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtDeviceRefEntry=prtDeviceRefEntry, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtInputTable=prtInputTable, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtConsoleDisable=prtConsoleDisable, prtOutputName=prtOutputName, prtAlertEntry=prtAlertEntry, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, MediaUnit=MediaUnit, prtMarkerEastMargin=prtMarkerEastMargin, prtOutputPageCollated=prtOutputPageCollated, PYSNMP_MODULE_ID=printmib, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtLocalizationLanguage=prtLocalizationLanguage, prtInputSerialNumber=prtInputSerialNumber, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtChannelState=prtChannelState, prtMIBGroups=prtMIBGroups, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtOutputSecurity=prtOutputSecurity, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtInputType=prtInputType, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtConsoleGroup=prtConsoleGroup, PrtMediaUnitTC=PrtMediaUnitTC, prtMIB2Compliance=prtMIB2Compliance, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtInputModel=prtInputModel, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtInputCapacityUnit=prtInputCapacityUnit, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtInputMediaGroup=prtInputMediaGroup, prtConsoleOnTime=prtConsoleOnTime, prtDeviceRefIndex=prtDeviceRefIndex, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtOutputOffsetStacking=prtOutputOffsetStacking, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtMarkerIndex=prtMarkerIndex, prtMIBCompliance=prtMIBCompliance, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtChannel=prtChannel, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtChannelTable=prtChannelTable, prtMediaPathType=prtMediaPathType, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtInputNextIndex=prtInputNextIndex, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtInputSecurity=prtInputSecurity, prtInputMaxCapacity=prtInputMaxCapacity, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtAlertTimeGroup=prtAlertTimeGroup, prtInput=prtInput, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtLocalizationEntry=prtLocalizationEntry, prtMarkerEntry=prtMarkerEntry, prtGeneralTable=prtGeneralTable, prtMarkerSpotColorants=prtMarkerSpotColorants, prtAlertCriticalEvents=prtAlertCriticalEvents, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtMarkerColorant=prtMarkerColorant, prtInputName=prtInputName, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtAlertSeverityLevel=prtAlertSeverityLevel, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtMarkerSupplies=prtMarkerSupplies, printmib=printmib, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtMIBConformance=prtMIBConformance, prtOutputVendorName=prtOutputVendorName, prtGeneralGroup=prtGeneralGroup, CapacityUnit=CapacityUnit, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtMarker=prtMarker, prtLocalizationCountry=prtLocalizationCountry, PrtChannelStateTC=PrtChannelStateTC, PresentOnOff=PresentOnOff, prtMarkerColorantIndex=prtMarkerColorantIndex, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtMediaPathDescription=prtMediaPathDescription, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtAlertDescription=prtAlertDescription, prtMarkerGroup=prtMarkerGroup, prtInterpreterEntry=prtInterpreterEntry, prtChannelStatus=prtChannelStatus, prtAlertGroup=prtAlertGroup, prtCoverDescription=prtCoverDescription, prtInputMediaName=prtInputMediaName, prtAlert=prtAlert, prtMarkerColorantEntry=prtMarkerColorantEntry, prtExtendedInputGroup=prtExtendedInputGroup, prtGeneralReset=prtGeneralReset, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtInterpreterGroup=prtInterpreterGroup, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtAlertTrapGroup=prtAlertTrapGroup, prtInputDimUnit=prtInputDimUnit, prtAlertLocation=prtAlertLocation, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtInterpreterVersion=prtInterpreterVersion, PrtPrintOrientationTC=PrtPrintOrientationTC, prtStorageRefIndex=prtStorageRefIndex, prtGeneralServicePerson=prtGeneralServicePerson, prtInputStatus=prtInputStatus, prtOutputMaxCapacity=prtOutputMaxCapacity, prtMarkerSuppliesTable=prtMarkerSuppliesTable, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtLocalizationTable=prtLocalizationTable, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtMarkerColorantTable=prtMarkerColorantTable, prtInterpreterLangVersion=prtInterpreterLangVersion, prtOutputEntry=prtOutputEntry, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtExtendedOutputGroup=prtExtendedOutputGroup, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtLocalizationIndex=prtLocalizationIndex, prtMarkerStatus=prtMarkerStatus, prtChannelInformation=prtChannelInformation, prtInputVersion=prtInputVersion, prtGeneral=prtGeneral, prtMIB2Groups=prtMIB2Groups, prtMarkerColorantGroup=prtMarkerColorantGroup, prtChannelGroup=prtChannelGroup, printerV2AlertPrefix=printerV2AlertPrefix, prtStorageRefEntry=prtStorageRefEntry, prtOutputDescription=prtOutputDescription, prtOutputBursting=prtOutputBursting, prtMarkerMarkTech=prtMarkerMarkTech, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtCoverTable=prtCoverTable, prtInputCurrentLevel=prtInputCurrentLevel, prtChannelIfIndex=prtChannelIfIndex, prtInputMediaType=prtInputMediaType, prtAlertTableV2Group=prtAlertTableV2Group, prtInputEntry=prtInputEntry, prtOutputModel=prtOutputModel, prtConsoleDescription=prtConsoleDescription, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtAlertTime=prtAlertTime, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtInterpreterLangLevel=prtInterpreterLangLevel, prtInputGroup=prtInputGroup, prtAlertCode=prtAlertCode, prtMarkerTable=prtMarkerTable, prtDeviceRefTable=prtDeviceRefTable, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtAlertAllEvents=prtAlertAllEvents, prtConsoleOffTime=prtConsoleOffTime, prtInputVendorName=prtInputVendorName, prtOutputDimUnit=prtOutputDimUnit, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtInterpreter=prtInterpreter, prtConsoleLightIndex=prtConsoleLightIndex, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtMediaPathStatus=prtMediaPathStatus, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtInputDefaultIndex=prtInputDefaultIndex, prtOutputStackingOrder=prtOutputStackingOrder, prtInputDescription=prtInputDescription, prtMarkerCounterUnit=prtMarkerCounterUnit, prtInterpreterDescription=prtInterpreterDescription, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtOutputSerialNumber=prtOutputSerialNumber, prtOutputCapacityUnit=prtOutputCapacityUnit, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtMediaPathTable=prtMediaPathTable, printerV1Alert=printerV1Alert, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtMarkerWestMargin=prtMarkerWestMargin, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtInterpreterIndex=prtInterpreterIndex, prtAlertIndex=prtAlertIndex, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtInputIndex=prtInputIndex, prtConsoleColor=prtConsoleColor, prtMarkerColorantValue=prtMarkerColorantValue, prtAlertTableGroup=prtAlertTableGroup, prtMediaPathIndex=prtMediaPathIndex, prtMarkerColorantTonality=prtMarkerColorantTonality, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtMarkerColorantRole=prtMarkerColorantRole, prtInterpreterLangFamily=prtInterpreterLangFamily, prtMarkerProcessColorants=prtMarkerProcessColorants, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtMarkerNorthMargin=prtMarkerNorthMargin, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtGeneralEntry=prtGeneralEntry, prtLocalization=prtLocalization)
mibBuilder.exportSymbols("Printer-MIB", prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtChannelEntry=prtChannelEntry, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtCoverEntry=prtCoverEntry)
