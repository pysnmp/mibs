...
PrtMediaPathTypeTC, PrtAlertGroupTC, PrtConsoleDisableTC, PrtAlertTrainingLevelTC, PrtMarkerSuppliesTypeTC, PrtInputTypeTC, PrtChannelTypeTC, PrtOutputTypeTC, PrtConsoleColorTC, PrtCoverStatusTC, PrtMarkerMarkTechTC, PrtAlertCodeTC, PrtInterpreterLangFamilyTC, PrtGeneralResetTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtMediaPathTypeTC", "PrtAlertGroupTC", "PrtConsoleDisableTC", "PrtAlertTrainingLevelTC", "PrtMarkerSuppliesTypeTC", "PrtInputTypeTC", "PrtChannelTypeTC", "PrtOutputTypeTC", "PrtConsoleColorTC", "PrtCoverStatusTC", "PrtMarkerMarkTechTC", "PrtAlertCodeTC", "PrtInterpreterLangFamilyTC", "PrtGeneralResetTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtOutputIndex=prtOutputIndex, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtMarkerEntry=prtMarkerEntry, prtAlertTableV2Group=prtAlertTableV2Group, prtMarkerColorantRole=prtMarkerColorantRole, PrtPrintOrientationTC=PrtPrintOrientationTC, prtOutputPageCollated=prtOutputPageCollated, MediaUnit=MediaUnit, prtInterpreterTwoWay=prtInterpreterTwoWay, prtMarkerGroup=prtMarkerGroup, prtGeneralPrinterName=prtGeneralPrinterName, prtInputSerialNumber=prtInputSerialNumber, prtLocalizationCountry=prtLocalizationCountry, prtConsoleLightTable=prtConsoleLightTable, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtOutputModel=prtOutputModel, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtChannelIfIndex=prtChannelIfIndex, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtOutputSerialNumber=prtOutputSerialNumber, prtConsoleDescription=prtConsoleDescription, prtLocalization=prtLocalization, prtConsoleOffTime=prtConsoleOffTime, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtLocalizationLanguage=prtLocalizationLanguage, prtOutputVendorName=prtOutputVendorName, prtOutputGroup=prtOutputGroup, prtInterpreterIndex=prtInterpreterIndex, prtInterpreterEntry=prtInterpreterEntry, PrtMediaUnitTC=PrtMediaUnitTC, PYSNMP_MODULE_ID=printmib, prtInputVersion=prtInputVersion, prtInputMediaColor=prtInputMediaColor, prtChannelInformation=prtChannelInformation, prtConsoleColor=prtConsoleColor, prtMarkerSupplies=prtMarkerSupplies, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtDeviceRefIndex=prtDeviceRefIndex, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtMediaPath=prtMediaPath, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtConsoleOnTime=prtConsoleOnTime, prtExtendedInputGroup=prtExtendedInputGroup, prtMarkerColorantValue=prtMarkerColorantValue, prtLocalizationTable=prtLocalizationTable, prtAlertTrapGroup=prtAlertTrapGroup, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtOutputStatus=prtOutputStatus, prtInputMediaType=prtInputMediaType, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtMediaPathStatus=prtMediaPathStatus, prtInputCapacityUnit=prtInputCapacityUnit, prtChannelIndex=prtChannelIndex, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtInterpreterLangFamily=prtInterpreterLangFamily, prtMarkerSuppliesType=prtMarkerSuppliesType, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, printerV1Alert=printerV1Alert, prtInterpreterGroup=prtInterpreterGroup, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtOutputStackingOrder=prtOutputStackingOrder, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtMarkerMarkTech=prtMarkerMarkTech, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtAlertTrainingLevel=prtAlertTrainingLevel, prtConsoleGroup=prtConsoleGroup, prtMarkerNorthMargin=prtMarkerNorthMargin, prtMIB2Groups=prtMIB2Groups, prtInputVendorName=prtInputVendorName, prtInputModel=prtInputModel, prtMarkerColorantGroup=prtMarkerColorantGroup, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtChannelProtocolVersion=prtChannelProtocolVersion, prtCover=prtCover, prtInputCurrentLevel=prtInputCurrentLevel, prtMarkerColorantEntry=prtMarkerColorantEntry, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtMarkerProcessColorants=prtMarkerProcessColorants, CapacityUnit=CapacityUnit, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtInputName=prtInputName, prtMarkerWestMargin=prtMarkerWestMargin, prtMarkerEastMargin=prtMarkerEastMargin, prtInputMaxCapacity=prtInputMaxCapacity, printerV2AlertPrefix=printerV2AlertPrefix, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtAlertEntry=prtAlertEntry, prtInputMediaGroup=prtInputMediaGroup, prtGeneralV2Group=prtGeneralV2Group, prtMediaPathEntry=prtMediaPathEntry, prtConsoleLightEntry=prtConsoleLightEntry, prtMarkerSouthMargin=prtMarkerSouthMargin, prtAlertTableGroup=prtAlertTableGroup, prtGeneralSerialNumber=prtGeneralSerialNumber, PresentOnOff=PresentOnOff, prtAlertIndex=prtAlertIndex, prtAlertSeverityLevel=prtAlertSeverityLevel, prtInterpreterVersion=prtInterpreterVersion, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtStorageRefIndex=prtStorageRefIndex, prtInputGroup=prtInputGroup, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtLocalizationIndex=prtLocalizationIndex, prtInputType=prtInputType, prtMIBGroups=prtMIBGroups, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, PrtCapacityUnitTC=PrtCapacityUnitTC, prtInputMediaFormParts=prtInputMediaFormParts, prtOutputDecollating=prtOutputDecollating, prtMarkerSpotColorants=prtMarkerSpotColorants, prtMediaPathGroup=prtMediaPathGroup, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtMediaPathIndex=prtMediaPathIndex, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtGeneralConfigChanges=prtGeneralConfigChanges, prtOutputDefaultIndex=prtOutputDefaultIndex, prtCoverStatus=prtCoverStatus, prtGeneral=prtGeneral, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtStorageRefEntry=prtStorageRefEntry, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtChannelStatus=prtChannelStatus, prtInterpreterTable=prtInterpreterTable, prtInterpreterDescription=prtInterpreterDescription, prtInputStatus=prtInputStatus, prtOutputDescription=prtOutputDescription, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtAlertGroupIndex=prtAlertGroupIndex, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtInputMediaWeight=prtInputMediaWeight, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtDeviceRefTable=prtDeviceRefTable, prtMarkerIndex=prtMarkerIndex, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtChannelState=prtChannelState, prtMIBConformance=prtMIBConformance, prtInputDefaultIndex=prtInputDefaultIndex, prtExtendedOutputGroup=prtExtendedOutputGroup, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtConsoleLightIndex=prtConsoleLightIndex, CodedCharSet=CodedCharSet, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtCoverEntry=prtCoverEntry, prtMarkerColorantIndex=prtMarkerColorantIndex, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtInterpreterLangLevel=prtInterpreterLangLevel, prtLocalizationEntry=prtLocalizationEntry, prtMediaPathDescription=prtMediaPathDescription, prtInputMediaName=prtInputMediaName, prtGeneralReset=prtGeneralReset, prtInputEntry=prtInputEntry, prtInputDescription=prtInputDescription, prtInputTable=prtInputTable, prtAlertCode=prtAlertCode, prtMediaPathType=prtMediaPathType, prtAlertLocation=prtAlertLocation, printmib=printmib, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtOutputDimensionsGroup=prtOutputDimensionsGroup, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtOutputType=prtOutputType, prtMarkerColorant=prtMarkerColorant, prtAlertTime=prtAlertTime, prtChannelGroup=prtChannelGroup, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, PrtChannelStateTC=PrtChannelStateTC, prtGeneralServicePerson=prtGeneralServicePerson, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtOutputMaxCapacity=prtOutputMaxCapacity, prtAlertTable=prtAlertTable, prtInput=prtInput, prtConsoleLights=prtConsoleLights, prtAlertCriticalEvents=prtAlertCriticalEvents, prtOutputSecurity=prtOutputSecurity, prtOutputDimUnit=prtOutputDimUnit, SubUnitStatus=SubUnitStatus, prtInputNextIndex=prtInputNextIndex, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtChannelType=prtChannelType, prtChannelEntry=prtChannelEntry, prtMIB2Compliance=prtMIB2Compliance, prtAlertDescription=prtAlertDescription, prtOutputName=prtOutputName, prtInputIndex=prtInputIndex, prtCoverTable=prtCoverTable, prtMIBCompliance=prtMIBCompliance, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtMarkerCounterUnit=prtMarkerCounterUnit, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtOutput=prtOutput, prtMarkerTable=prtMarkerTable, prtConsoleLocalization=prtConsoleLocalization, prtMarkerColorantTable=prtMarkerColorantTable, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtInterpreterLangVersion=prtInterpreterLangVersion, prtChannel=prtChannel, prtAlertAllEvents=prtAlertAllEvents, prtInputSwitchingGroup=prtInputSwitchingGroup, prtOutputBursting=prtOutputBursting, prtChannelV2Group=prtChannelV2Group, prtInterpreter=prtInterpreter, prtGeneralGroup=prtGeneralGroup, prtOutputTable=prtOutputTable, prtAlert=prtAlert, prtMediaPathTable=prtMediaPathTable, prtCoverIndex=prtCoverIndex, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtInputSecurity=prtInputSecurity, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtAlertTimeGroup=prtAlertTimeGroup, prtMarkerLifeCount=prtMarkerLifeCount, prtGeneralTable=prtGeneralTable, prtConsoleDisable=prtConsoleDisable, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtDeviceRefEntry=prtDeviceRefEntry, prtInputDimUnit=prtInputDimUnit, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtCoverDescription=prtCoverDescription, prtOutputCapacityUnit=prtOutputCapacityUnit, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtOutputEntry=prtOutputEntry, prtMarkerColorantTonality=prtMarkerColorantTonality, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtOutputOffsetStacking=prtOutputOffsetStacking, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtMarker=prtMarker, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtAlertGroup=prtAlertGroup, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtStorageRefTable=prtStorageRefTable, printerV2Alert=printerV2Alert, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtGeneralEntry=prtGeneralEntry)
mibBuilder.exportSymbols("Printer-MIB", prtMarkerStatus=prtMarkerStatus, prtOutputVersion=prtOutputVersion, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtChannelTable=prtChannelTable)
