...
PrtInputTypeTC, PrtMarkerSuppliesTypeTC, PrtGeneralResetTC, PrtAlertCodeTC, PrtAlertTrainingLevelTC, PrtInterpreterLangFamilyTC, PrtCoverStatusTC, PrtConsoleColorTC, PrtConsoleDisableTC, PrtAlertGroupTC, PrtMarkerMarkTechTC, PrtMediaPathTypeTC, PrtChannelTypeTC, PrtOutputTypeTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtInputTypeTC", "PrtMarkerSuppliesTypeTC", "PrtGeneralResetTC", "PrtAlertCodeTC", "PrtAlertTrainingLevelTC", "PrtInterpreterLangFamilyTC", "PrtCoverStatusTC", "PrtConsoleColorTC", "PrtConsoleDisableTC", "PrtAlertGroupTC", "PrtMarkerMarkTechTC", "PrtMediaPathTypeTC", "PrtChannelTypeTC", "PrtOutputTypeTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtMIB2Groups=prtMIB2Groups, prtCover=prtCover, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtOutputBursting=prtOutputBursting, prtGeneralTable=prtGeneralTable, prtMarkerMarkTech=prtMarkerMarkTech, CodedCharSet=CodedCharSet, prtChannelIfIndex=prtChannelIfIndex, prtOutputName=prtOutputName, prtStorageRefSeqNumber=prtStorageRefSeqNumber, PresentOnOff=PresentOnOff, prtGeneral=prtGeneral, prtGeneralSerialNumber=prtGeneralSerialNumber, prtStorageRefIndex=prtStorageRefIndex, prtMarkerStatus=prtMarkerStatus, prtChannelInformation=prtChannelInformation, prtMarkerColorantGroup=prtMarkerColorantGroup, prtConsoleDisable=prtConsoleDisable, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtOutputMaxCapacity=prtOutputMaxCapacity, prtChannelEntry=prtChannelEntry, PrtMediaUnitTC=PrtMediaUnitTC, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtOutputDimensionsGroup=prtOutputDimensionsGroup, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtCoverTable=prtCoverTable, prtCoverDescription=prtCoverDescription, prtOutputSerialNumber=prtOutputSerialNumber, prtInterpreter=prtInterpreter, SubUnitStatus=SubUnitStatus, CapacityUnit=CapacityUnit, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtOutputOffsetStacking=prtOutputOffsetStacking, prtCoverStatus=prtCoverStatus, prtDeviceRefIndex=prtDeviceRefIndex, prtAlertTableV2Group=prtAlertTableV2Group, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtInputSerialNumber=prtInputSerialNumber, prtMarkerColorantEntry=prtMarkerColorantEntry, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtInputSwitchingGroup=prtInputSwitchingGroup, prtMarkerCounterUnit=prtMarkerCounterUnit, prtInputMediaGroup=prtInputMediaGroup, prtOutputCapacityUnit=prtOutputCapacityUnit, prtAlertCode=prtAlertCode, prtInterpreterIndex=prtInterpreterIndex, prtInputIndex=prtInputIndex, prtAlertTrainingLevel=prtAlertTrainingLevel, prtAlertTableGroup=prtAlertTableGroup, prtOutputType=prtOutputType, prtMediaPathIndex=prtMediaPathIndex, prtLocalizationIndex=prtLocalizationIndex, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtMarkerColorantRole=prtMarkerColorantRole, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtAlertTrapGroup=prtAlertTrapGroup, prtInputDimUnit=prtInputDimUnit, prtOutput=prtOutput, prtOutputIndex=prtOutputIndex, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtGeneralConfigChanges=prtGeneralConfigChanges, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtAlertEntry=prtAlertEntry, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtGeneralV2Group=prtGeneralV2Group, prtStorageRefEntry=prtStorageRefEntry, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtMarkerSpotColorants=prtMarkerSpotColorants, prtMarkerNorthMargin=prtMarkerNorthMargin, prtMediaPath=prtMediaPath, prtChannelStatus=prtChannelStatus, prtInterpreterLangLevel=prtInterpreterLangLevel, prtDeviceRefEntry=prtDeviceRefEntry, prtLocalizationTable=prtLocalizationTable, prtMarkerColorantValue=prtMarkerColorantValue, prtAlertSeverityLevel=prtAlertSeverityLevel, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtOutputEntry=prtOutputEntry, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, printerV2AlertPrefix=printerV2AlertPrefix, prtInputNextIndex=prtInputNextIndex, prtMarkerSouthMargin=prtMarkerSouthMargin, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, PrtCapacityUnitTC=PrtCapacityUnitTC, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtExtendedInputGroup=prtExtendedInputGroup, prtOutputPageCollated=prtOutputPageCollated, prtMarkerSupplies=prtMarkerSupplies, prtMediaPathTable=prtMediaPathTable, prtMediaPathGroup=prtMediaPathGroup, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtInputName=prtInputName, prtMarkerSuppliesType=prtMarkerSuppliesType, prtInputVersion=prtInputVersion, prtMIB2Compliance=prtMIB2Compliance, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtChannelIndex=prtChannelIndex, prtInputMediaName=prtInputMediaName, prtGeneralGroup=prtGeneralGroup, prtChannelGroup=prtChannelGroup, prtGeneralEntry=prtGeneralEntry, prtOutputVersion=prtOutputVersion, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtInterpreterDescription=prtInterpreterDescription, prtOutputSecurity=prtOutputSecurity, prtAlertTimeGroup=prtAlertTimeGroup, prtMarkerColorantTable=prtMarkerColorantTable, prtOutputDimUnit=prtOutputDimUnit, prtInputStatus=prtInputStatus, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtMarkerEastMargin=prtMarkerEastMargin, prtGeneralPrinterName=prtGeneralPrinterName, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtLocalizationEntry=prtLocalizationEntry, prtInterpreterLangVersion=prtInterpreterLangVersion, prtInterpreterGroup=prtInterpreterGroup, prtOutputDescription=prtOutputDescription, prtConsoleLights=prtConsoleLights, prtInterpreterTwoWay=prtInterpreterTwoWay, MediaUnit=MediaUnit, printmib=printmib, prtCoverEntry=prtCoverEntry, prtGeneralReset=prtGeneralReset, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtInputCurrentLevel=prtInputCurrentLevel, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtMarkerLifeCount=prtMarkerLifeCount, prtChannelState=prtChannelState, prtConsoleLocalization=prtConsoleLocalization, prtOutputStatus=prtOutputStatus, prtMarkerColorant=prtMarkerColorant, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtConsoleDescription=prtConsoleDescription, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtMediaPathEntry=prtMediaPathEntry, PrtChannelStateTC=PrtChannelStateTC, prtAlert=prtAlert, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, PrtPrintOrientationTC=PrtPrintOrientationTC, prtAlertGroup=prtAlertGroup, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtInterpreterTable=prtInterpreterTable, printerV2Alert=printerV2Alert, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtInputMaxCapacity=prtInputMaxCapacity, prtInputModel=prtInputModel, prtOutputModel=prtOutputModel, prtMarkerGroup=prtMarkerGroup, prtInputMediaType=prtInputMediaType, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtMarkerIndex=prtMarkerIndex, prtConsoleOffTime=prtConsoleOffTime, prtOutputDefaultIndex=prtOutputDefaultIndex, prtAlertLocation=prtAlertLocation, prtMediaPathStatus=prtMediaPathStatus, prtMIBGroups=prtMIBGroups, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtConsoleLightEntry=prtConsoleLightEntry, prtLocalizationLanguage=prtLocalizationLanguage, prtCoverIndex=prtCoverIndex, prtInputEntry=prtInputEntry, prtMarkerTable=prtMarkerTable, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtInputDefaultIndex=prtInputDefaultIndex, prtConsoleLightIndex=prtConsoleLightIndex, prtConsoleOnTime=prtConsoleOnTime, prtOutputVendorName=prtOutputVendorName, prtLocalization=prtLocalization, prtOutputGroup=prtOutputGroup, prtMIBCompliance=prtMIBCompliance, prtInputTable=prtInputTable, prtInterpreterVersion=prtInterpreterVersion, prtMarkerColorantIndex=prtMarkerColorantIndex, prtStorageRefTable=prtStorageRefTable, prtInputMediaWeight=prtInputMediaWeight, prtInputSecurity=prtInputSecurity, prtConsoleLightTable=prtConsoleLightTable, prtAlertGroupIndex=prtAlertGroupIndex, prtAlertTime=prtAlertTime, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtChannelTable=prtChannelTable, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtGeneralServicePerson=prtGeneralServicePerson, prtDeviceRefTable=prtDeviceRefTable, prtInputType=prtInputType, prtInputMediaFormParts=prtInputMediaFormParts, prtOutputStackingOrder=prtOutputStackingOrder, prtConsoleColor=prtConsoleColor, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtMarkerEntry=prtMarkerEntry, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtChannelType=prtChannelType, prtMarkerWestMargin=prtMarkerWestMargin, prtMediaPathType=prtMediaPathType, prtMIBConformance=prtMIBConformance, prtAlertTable=prtAlertTable, prtExtendedOutputGroup=prtExtendedOutputGroup, prtChannelV2Group=prtChannelV2Group, prtAlertDescription=prtAlertDescription, PYSNMP_MODULE_ID=printmib, prtAlertAllEvents=prtAlertAllEvents, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtAlertIndex=prtAlertIndex, prtAlertCriticalEvents=prtAlertCriticalEvents, prtLocalizationCountry=prtLocalizationCountry, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtOutputTable=prtOutputTable, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtMarkerColorantTonality=prtMarkerColorantTonality, prtMediaPathDescription=prtMediaPathDescription, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtConsoleGroup=prtConsoleGroup, printerV1Alert=printerV1Alert, prtMarker=prtMarker, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtInputVendorName=prtInputVendorName, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtChannelProtocolVersion=prtChannelProtocolVersion, prtInputCapacityUnit=prtInputCapacityUnit, prtChannel=prtChannel, prtInputGroup=prtInputGroup, prtOutputDecollating=prtOutputDecollating, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtMarkerProcessColorants=prtMarkerProcessColorants, prtInterpreterLangFamily=prtInterpreterLangFamily, prtInputDescription=prtInputDescription)
mibBuilder.exportSymbols("Printer-MIB", prtInterpreterEntry=prtInterpreterEntry, prtInputMediaColor=prtInputMediaColor, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtInput=prtInput)
