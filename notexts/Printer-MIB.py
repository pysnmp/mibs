...
PrtAlertCodeTC, PrtChannelTypeTC, PrtMediaPathTypeTC, PrtCoverStatusTC, PrtInterpreterLangFamilyTC, PrtOutputTypeTC, PrtAlertTrainingLevelTC, PrtAlertGroupTC, PrtMarkerSuppliesTypeTC, PrtMarkerMarkTechTC, PrtConsoleDisableTC, PrtInputTypeTC, PrtGeneralResetTC, PrtConsoleColorTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtAlertCodeTC", "PrtChannelTypeTC", "PrtMediaPathTypeTC", "PrtCoverStatusTC", "PrtInterpreterLangFamilyTC", "PrtOutputTypeTC", "PrtAlertTrainingLevelTC", "PrtAlertGroupTC", "PrtMarkerSuppliesTypeTC", "PrtMarkerMarkTechTC", "PrtConsoleDisableTC", "PrtInputTypeTC", "PrtGeneralResetTC", "PrtConsoleColorTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtAlertCode=prtAlertCode, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtOutputVersion=prtOutputVersion, PrtPrintOrientationTC=PrtPrintOrientationTC, prtMarkerTable=prtMarkerTable, prtOutputSecurity=prtOutputSecurity, printmib=printmib, prtInterpreterLangVersion=prtInterpreterLangVersion, prtGeneralReset=prtGeneralReset, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtExtendedOutputGroup=prtExtendedOutputGroup, prtAlertLocation=prtAlertLocation, prtInputName=prtInputName, prtCoverStatus=prtCoverStatus, prtDeviceRefTable=prtDeviceRefTable, prtInputStatus=prtInputStatus, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtMarkerEastMargin=prtMarkerEastMargin, prtInputDimUnit=prtInputDimUnit, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, PrtChannelStateTC=PrtChannelStateTC, prtMarkerLifeCount=prtMarkerLifeCount, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtOutputSerialNumber=prtOutputSerialNumber, prtOutputGroup=prtOutputGroup, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtInputNextIndex=prtInputNextIndex, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtCoverDescription=prtCoverDescription, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtConsoleLightTable=prtConsoleLightTable, prtMediaPathDescription=prtMediaPathDescription, prtGeneralGroup=prtGeneralGroup, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtMediaPathStatus=prtMediaPathStatus, prtMediaPathType=prtMediaPathType, CapacityUnit=CapacityUnit, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtOutputCapacityUnit=prtOutputCapacityUnit, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtMarkerEntry=prtMarkerEntry, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtMarkerIndex=prtMarkerIndex, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtLocalization=prtLocalization, prtChannelIndex=prtChannelIndex, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtGeneralEntry=prtGeneralEntry, prtMarkerColorantEntry=prtMarkerColorantEntry, prtMarkerColorantValue=prtMarkerColorantValue, prtAlertTableGroup=prtAlertTableGroup, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtOutput=prtOutput, prtAlertCriticalEvents=prtAlertCriticalEvents, PrtMediaUnitTC=PrtMediaUnitTC, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtMarkerCounterUnit=prtMarkerCounterUnit, prtChannelProtocolVersion=prtChannelProtocolVersion, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtMediaPath=prtMediaPath, prtChannelState=prtChannelState, prtMarkerGroup=prtMarkerGroup, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, PYSNMP_MODULE_ID=printmib, prtAlertTrapGroup=prtAlertTrapGroup, prtAlertGroup=prtAlertGroup, prtOutputMaxCapacity=prtOutputMaxCapacity, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtConsoleLightEntry=prtConsoleLightEntry, prtInputDescription=prtInputDescription, prtGeneralSerialNumber=prtGeneralSerialNumber, prtOutputType=prtOutputType, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtMarkerColorantRole=prtMarkerColorantRole, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtMarkerColorantGroup=prtMarkerColorantGroup, prtAlertDescription=prtAlertDescription, prtMediaPathGroup=prtMediaPathGroup, prtMarkerColorantIndex=prtMarkerColorantIndex, prtMediaPathIndex=prtMediaPathIndex, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtChannelStatus=prtChannelStatus, prtMIBCompliance=prtMIBCompliance, prtCoverIndex=prtCoverIndex, prtAlertTime=prtAlertTime, prtOutputEntry=prtOutputEntry, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtInputVersion=prtInputVersion, prtAlertTrainingLevel=prtAlertTrainingLevel, prtMarkerSouthMargin=prtMarkerSouthMargin, prtChannelInformation=prtChannelInformation, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtAlertEntry=prtAlertEntry, prtAlertIndex=prtAlertIndex, prtChannelEntry=prtChannelEntry, prtLocalizationIndex=prtLocalizationIndex, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtDeviceRefEntry=prtDeviceRefEntry, prtInputMediaWeight=prtInputMediaWeight, prtStorageRefTable=prtStorageRefTable, prtInterpreterVersion=prtInterpreterVersion, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtStorageRefEntry=prtStorageRefEntry, prtInputMediaType=prtInputMediaType, printerV2Alert=printerV2Alert, prtInterpreterTable=prtInterpreterTable, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtInterpreterEntry=prtInterpreterEntry, prtMarkerSuppliesType=prtMarkerSuppliesType, prtGeneralV2Group=prtGeneralV2Group, prtOutputDimUnit=prtOutputDimUnit, prtMIB2Compliance=prtMIB2Compliance, prtLocalizationLanguage=prtLocalizationLanguage, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtMarkerColorantTable=prtMarkerColorantTable, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtLocalizationCountry=prtLocalizationCountry, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtInputMediaColor=prtInputMediaColor, prtInputMediaFormParts=prtInputMediaFormParts, prtConsoleLights=prtConsoleLights, prtConsoleGroup=prtConsoleGroup, prtInterpreterLangLevel=prtInterpreterLangLevel, prtMarkerSpotColorants=prtMarkerSpotColorants, prtCover=prtCover, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtOutputBursting=prtOutputBursting, prtChannelV2Group=prtChannelV2Group, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtAlertGroupIndex=prtAlertGroupIndex, prtInputSerialNumber=prtInputSerialNumber, prtInterpreter=prtInterpreter, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtConsoleDescription=prtConsoleDescription, prtInputVendorName=prtInputVendorName, prtInputMediaGroup=prtInputMediaGroup, prtInterpreterDescription=prtInterpreterDescription, prtInputTable=prtInputTable, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtConsoleDisable=prtConsoleDisable, prtMarkerColorant=prtMarkerColorant, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtOutputOffsetStacking=prtOutputOffsetStacking, prtAlertTableV2Group=prtAlertTableV2Group, prtOutputDefaultIndex=prtOutputDefaultIndex, prtInputModel=prtInputModel, prtMIB2Groups=prtMIB2Groups, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtGeneralPrinterName=prtGeneralPrinterName, CodedCharSet=CodedCharSet, prtLocalizationEntry=prtLocalizationEntry, prtOutputStatus=prtOutputStatus, prtOutputModel=prtOutputModel, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtCoverTable=prtCoverTable, prtChannelIfIndex=prtChannelIfIndex, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtMarkerColorantTonality=prtMarkerColorantTonality, prtMarkerStatus=prtMarkerStatus, PresentOnOff=PresentOnOff, prtInputIndex=prtInputIndex, prtInputDefaultIndex=prtInputDefaultIndex, prtOutputDecollating=prtOutputDecollating, prtInputSecurity=prtInputSecurity, prtConsoleOffTime=prtConsoleOffTime, prtInputCapacityUnit=prtInputCapacityUnit, prtAlertTable=prtAlertTable, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtInputSwitchingGroup=prtInputSwitchingGroup, prtMarkerNorthMargin=prtMarkerNorthMargin, MediaUnit=MediaUnit, prtGeneralTable=prtGeneralTable, prtInput=prtInput, prtConsoleOnTime=prtConsoleOnTime, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtOutputIndex=prtOutputIndex, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtOutputName=prtOutputName, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtConsoleLocalization=prtConsoleLocalization, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtOutputDescription=prtOutputDescription, prtCoverEntry=prtCoverEntry, prtStorageRefIndex=prtStorageRefIndex, prtInputEntry=prtInputEntry, prtChannelType=prtChannelType, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtDeviceRefIndex=prtDeviceRefIndex, prtGeneralServicePerson=prtGeneralServicePerson, prtAlertSeverityLevel=prtAlertSeverityLevel, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtOutputStackingOrder=prtOutputStackingOrder, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtOutputVendorName=prtOutputVendorName, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtInterpreterGroup=prtInterpreterGroup, prtMarker=prtMarker, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtGeneral=prtGeneral, prtChannelTable=prtChannelTable, prtMarkerWestMargin=prtMarkerWestMargin, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtOutputTable=prtOutputTable, prtMIBConformance=prtMIBConformance, prtInputCurrentLevel=prtInputCurrentLevel, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtAlert=prtAlert, prtMIBGroups=prtMIBGroups, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtInputGroup=prtInputGroup, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtOutputPageCollated=prtOutputPageCollated, prtInterpreterIndex=prtInterpreterIndex, printerV2AlertPrefix=printerV2AlertPrefix, prtExtendedInputGroup=prtExtendedInputGroup, prtChannelGroup=prtChannelGroup, prtAlertTimeGroup=prtAlertTimeGroup, prtMarkerProcessColorants=prtMarkerProcessColorants, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtInputMaxCapacity=prtInputMaxCapacity, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtMarkerMarkTech=prtMarkerMarkTech, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtMarkerSupplies=prtMarkerSupplies, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtMediaPathEntry=prtMediaPathEntry, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtInputMediaName=prtInputMediaName, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtInputType=prtInputType, PrtCapacityUnitTC=PrtCapacityUnitTC, prtAlertAllEvents=prtAlertAllEvents, prtLocalizationTable=prtLocalizationTable, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtConsoleColor=prtConsoleColor, printerV1Alert=printerV1Alert, SubUnitStatus=SubUnitStatus, prtConsoleLightIndex=prtConsoleLightIndex, prtGeneralConfigChanges=prtGeneralConfigChanges)
mibBuilder.exportSymbols("Printer-MIB", prtInterpreterLangFamily=prtInterpreterLangFamily, prtInterpreterTwoWay=prtInterpreterTwoWay, prtChannel=prtChannel, prtMediaPathTable=prtMediaPathTable)
