...
PrtConsoleDisableTC, PrtOutputTypeTC, PrtMarkerSuppliesTypeTC, PrtMediaPathTypeTC, PrtAlertCodeTC, PrtAlertTrainingLevelTC, PrtChannelTypeTC, PrtCoverStatusTC, PrtGeneralResetTC, PrtInterpreterLangFamilyTC, PrtInputTypeTC, PrtConsoleColorTC, PrtAlertGroupTC, PrtMarkerMarkTechTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtConsoleDisableTC", "PrtOutputTypeTC", "PrtMarkerSuppliesTypeTC", "PrtMediaPathTypeTC", "PrtAlertCodeTC", "PrtAlertTrainingLevelTC", "PrtChannelTypeTC", "PrtCoverStatusTC", "PrtGeneralResetTC", "PrtInterpreterLangFamilyTC", "PrtInputTypeTC", "PrtConsoleColorTC", "PrtAlertGroupTC", "PrtMarkerMarkTechTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtGeneralConfigChanges=prtGeneralConfigChanges, prtStorageRefTable=prtStorageRefTable, prtLocalization=prtLocalization, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtMarkerSuppliesType=prtMarkerSuppliesType, prtLocalizationTable=prtLocalizationTable, prtMarkerNorthMargin=prtMarkerNorthMargin, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtMarkerColorantTonality=prtMarkerColorantTonality, prtChannelStatus=prtChannelStatus, prtAlertIndex=prtAlertIndex, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtInterpreterTwoWay=prtInterpreterTwoWay, prtLocalizationLanguage=prtLocalizationLanguage, prtInputVersion=prtInputVersion, prtOutputDescription=prtOutputDescription, prtMarkerIndex=prtMarkerIndex, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtChannelV2Group=prtChannelV2Group, prtConsoleDisable=prtConsoleDisable, prtInputMaxCapacity=prtInputMaxCapacity, prtOutputIndex=prtOutputIndex, prtInputIndex=prtInputIndex, prtInterpreterLangLevel=prtInterpreterLangLevel, prtOutput=prtOutput, CodedCharSet=CodedCharSet, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, SubUnitStatus=SubUnitStatus, prtInputDimUnit=prtInputDimUnit, prtMarkerColorantTable=prtMarkerColorantTable, prtAlertCriticalEvents=prtAlertCriticalEvents, prtAlertEntry=prtAlertEntry, prtAlertTimeGroup=prtAlertTimeGroup, prtCoverStatus=prtCoverStatus, prtMarkerLifeCount=prtMarkerLifeCount, prtMarkerColorantGroup=prtMarkerColorantGroup, prtOutputVendorName=prtOutputVendorName, prtMarkerMarkTech=prtMarkerMarkTech, prtMIB2Compliance=prtMIB2Compliance, prtInterpreterIndex=prtInterpreterIndex, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtCover=prtCover, prtConsoleOffTime=prtConsoleOffTime, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtCoverEntry=prtCoverEntry, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtMarkerStatus=prtMarkerStatus, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtMIB2Groups=prtMIB2Groups, prtInputMediaName=prtInputMediaName, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtAlertGroupIndex=prtAlertGroupIndex, prtOutputPageCollated=prtOutputPageCollated, printerV2AlertPrefix=printerV2AlertPrefix, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtInputTable=prtInputTable, prtOutputEntry=prtOutputEntry, prtMarkerCounterUnit=prtMarkerCounterUnit, prtConsoleLightIndex=prtConsoleLightIndex, prtMIBConformance=prtMIBConformance, prtOutputName=prtOutputName, prtStorageRefEntry=prtStorageRefEntry, prtChannelIfIndex=prtChannelIfIndex, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtMarkerWestMargin=prtMarkerWestMargin, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtLocalizationIndex=prtLocalizationIndex, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtCoverIndex=prtCoverIndex, prtMarkerProcessColorants=prtMarkerProcessColorants, PrtMediaUnitTC=PrtMediaUnitTC, PrtCapacityUnitTC=PrtCapacityUnitTC, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtInputMediaGroup=prtInputMediaGroup, prtInputGroup=prtInputGroup, prtAlertGroup=prtAlertGroup, prtInterpreterLangFamily=prtInterpreterLangFamily, prtDeviceRefTable=prtDeviceRefTable, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtMediaPath=prtMediaPath, prtAlertSeverityLevel=prtAlertSeverityLevel, prtAlertCode=prtAlertCode, prtOutputModel=prtOutputModel, prtDeviceRefEntry=prtDeviceRefEntry, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtAlertTrapGroup=prtAlertTrapGroup, prtInterpreterVersion=prtInterpreterVersion, prtMediaPathGroup=prtMediaPathGroup, prtInputNextIndex=prtInputNextIndex, prtInputCapacityUnit=prtInputCapacityUnit, prtAlertDescription=prtAlertDescription, prtConsoleGroup=prtConsoleGroup, prtInputSecurity=prtInputSecurity, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, CapacityUnit=CapacityUnit, prtGeneralPrinterName=prtGeneralPrinterName, prtInputDescription=prtInputDescription, prtAlertAllEvents=prtAlertAllEvents, prtOutputMaxCapacity=prtOutputMaxCapacity, prtInputSwitchingGroup=prtInputSwitchingGroup, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtConsoleLightTable=prtConsoleLightTable, prtExtendedOutputGroup=prtExtendedOutputGroup, prtOutputStackingOrder=prtOutputStackingOrder, prtConsoleDescription=prtConsoleDescription, prtChannelType=prtChannelType, prtInputDefaultIndex=prtInputDefaultIndex, prtMediaPathStatus=prtMediaPathStatus, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtMarkerColorantIndex=prtMarkerColorantIndex, prtAlertTrainingLevel=prtAlertTrainingLevel, prtExtendedInputGroup=prtExtendedInputGroup, prtInterpreterGroup=prtInterpreterGroup, prtMediaPathDescription=prtMediaPathDescription, prtMediaPathTable=prtMediaPathTable, prtStorageRefIndex=prtStorageRefIndex, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtMarker=prtMarker, printmib=printmib, prtMarkerColorant=prtMarkerColorant, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtGeneralEntry=prtGeneralEntry, prtGeneralReset=prtGeneralReset, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtOutputSerialNumber=prtOutputSerialNumber, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtAlertTable=prtAlertTable, prtInputModel=prtInputModel, prtOutputTable=prtOutputTable, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtGeneral=prtGeneral, prtOutputDecollating=prtOutputDecollating, prtInputMediaFormParts=prtInputMediaFormParts, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtMarkerSupplies=prtMarkerSupplies, prtInputStatus=prtInputStatus, prtOutputVersion=prtOutputVersion, prtInterpreterLangVersion=prtInterpreterLangVersion, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtAlertTime=prtAlertTime, prtInterpreterEntry=prtInterpreterEntry, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtMarkerColorantRole=prtMarkerColorantRole, PrtChannelStateTC=PrtChannelStateTC, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtGeneralGroup=prtGeneralGroup, prtInputMediaColor=prtInputMediaColor, prtChannelInformation=prtChannelInformation, prtInputVendorName=prtInputVendorName, prtMediaPathType=prtMediaPathType, prtOutputOffsetStacking=prtOutputOffsetStacking, prtChannelTable=prtChannelTable, prtInterpreterTable=prtInterpreterTable, prtInputEntry=prtInputEntry, prtChannelState=prtChannelState, prtMediaPathIndex=prtMediaPathIndex, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtMarkerSpotColorants=prtMarkerSpotColorants, prtConsoleLights=prtConsoleLights, prtInputName=prtInputName, PrtPrintOrientationTC=PrtPrintOrientationTC, prtOutputGroup=prtOutputGroup, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, printerV1Alert=printerV1Alert, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtOutputBursting=prtOutputBursting, PresentOnOff=PresentOnOff, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtOutputDimUnit=prtOutputDimUnit, prtGeneralServicePerson=prtGeneralServicePerson, prtAlertLocation=prtAlertLocation, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtConsoleColor=prtConsoleColor, prtLocalizationEntry=prtLocalizationEntry, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtMarkerColorantEntry=prtMarkerColorantEntry, prtGeneralTable=prtGeneralTable, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtConsoleOnTime=prtConsoleOnTime, prtAlert=prtAlert, prtGeneralSerialNumber=prtGeneralSerialNumber, printerV2Alert=printerV2Alert, prtOutputStatus=prtOutputStatus, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtMIBGroups=prtMIBGroups, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtChannelProtocolVersion=prtChannelProtocolVersion, prtMIBCompliance=prtMIBCompliance, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtChannel=prtChannel, prtMarkerEntry=prtMarkerEntry, prtMediaPathEntry=prtMediaPathEntry, prtAlertTableGroup=prtAlertTableGroup, prtAlertTableV2Group=prtAlertTableV2Group, prtInputSerialNumber=prtInputSerialNumber, prtDeviceRefIndex=prtDeviceRefIndex, prtOutputDefaultIndex=prtOutputDefaultIndex, prtInputCurrentLevel=prtInputCurrentLevel, prtLocalizationCountry=prtLocalizationCountry, prtInterpreter=prtInterpreter, prtConsoleLightEntry=prtConsoleLightEntry, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtGeneralV2Group=prtGeneralV2Group, prtMarkerEastMargin=prtMarkerEastMargin, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtInputType=prtInputType, prtOutputSecurity=prtOutputSecurity, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtMarkerGroup=prtMarkerGroup, prtChannelEntry=prtChannelEntry, prtLocalizationCharacterSet=prtLocalizationCharacterSet, MediaUnit=MediaUnit, prtInputMediaWeight=prtInputMediaWeight, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtConsoleLocalization=prtConsoleLocalization, prtMarkerSouthMargin=prtMarkerSouthMargin, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtMarkerTable=prtMarkerTable, prtInput=prtInput, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtChannelGroup=prtChannelGroup, prtOutputType=prtOutputType, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtCoverTable=prtCoverTable, prtChannelIndex=prtChannelIndex, PYSNMP_MODULE_ID=printmib, prtOutputCapacityUnit=prtOutputCapacityUnit, prtMarkerColorantValue=prtMarkerColorantValue, prtInterpreterDescription=prtInterpreterDescription)
mibBuilder.exportSymbols("Printer-MIB", prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtCoverDescription=prtCoverDescription, prtInputMediaType=prtInputMediaType, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber)
