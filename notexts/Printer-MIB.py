...
PrtConsoleColorTC, PrtChannelTypeTC, PrtMediaPathTypeTC, PrtAlertCodeTC, PrtGeneralResetTC, PrtConsoleDisableTC, PrtInterpreterLangFamilyTC, PrtMarkerSuppliesTypeTC, PrtCoverStatusTC, PrtOutputTypeTC, PrtMarkerMarkTechTC, PrtAlertTrainingLevelTC, PrtAlertGroupTC, PrtInputTypeTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtConsoleColorTC", "PrtChannelTypeTC", "PrtMediaPathTypeTC", "PrtAlertCodeTC", "PrtGeneralResetTC", "PrtConsoleDisableTC", "PrtInterpreterLangFamilyTC", "PrtMarkerSuppliesTypeTC", "PrtCoverStatusTC", "PrtOutputTypeTC", "PrtMarkerMarkTechTC", "PrtAlertTrainingLevelTC", "PrtAlertGroupTC", "PrtInputTypeTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtMediaPathEntry=prtMediaPathEntry, prtInterpreterIndex=prtInterpreterIndex, prtInterpreterLangVersion=prtInterpreterLangVersion, prtInterpreterGroup=prtInterpreterGroup, prtGeneralEntry=prtGeneralEntry, prtAlertDescription=prtAlertDescription, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtOutputGroup=prtOutputGroup, prtInputNextIndex=prtInputNextIndex, prtOutputType=prtOutputType, printerV1Alert=printerV1Alert, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtInterpreterDescription=prtInterpreterDescription, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtExtendedInputGroup=prtExtendedInputGroup, prtInputType=prtInputType, prtConsoleDescription=prtConsoleDescription, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtOutputSecurity=prtOutputSecurity, prtConsoleLocalization=prtConsoleLocalization, prtStorageRefEntry=prtStorageRefEntry, prtChannelGroup=prtChannelGroup, prtOutputDecollating=prtOutputDecollating, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtAlertTrainingLevel=prtAlertTrainingLevel, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtInputMediaColor=prtInputMediaColor, prtMediaPathIndex=prtMediaPathIndex, prtOutputSerialNumber=prtOutputSerialNumber, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtAlertTableGroup=prtAlertTableGroup, prtMIBGroups=prtMIBGroups, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtDeviceRefEntry=prtDeviceRefEntry, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtInputModel=prtInputModel, prtMediaPath=prtMediaPath, prtMarkerColorantIndex=prtMarkerColorantIndex, prtInputStatus=prtInputStatus, printmib=printmib, prtMarkerColorantValue=prtMarkerColorantValue, prtConsoleGroup=prtConsoleGroup, prtGeneralServicePerson=prtGeneralServicePerson, prtAlert=prtAlert, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtAlertLocation=prtAlertLocation, prtGeneralConfigChanges=prtGeneralConfigChanges, prtAlertTimeGroup=prtAlertTimeGroup, prtMarkerSupplies=prtMarkerSupplies, prtInputMaxCapacity=prtInputMaxCapacity, prtInputDescription=prtInputDescription, prtOutputEntry=prtOutputEntry, prtGeneralSerialNumber=prtGeneralSerialNumber, prtChannelProtocolVersion=prtChannelProtocolVersion, prtInputCurrentLevel=prtInputCurrentLevel, prtInputVersion=prtInputVersion, prtMarkerColorantTonality=prtMarkerColorantTonality, prtDeviceRefIndex=prtDeviceRefIndex, MediaUnit=MediaUnit, prtLocalizationEntry=prtLocalizationEntry, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtOutputName=prtOutputName, prtInputTable=prtInputTable, prtOutputDimUnit=prtOutputDimUnit, prtOutputStackingOrder=prtOutputStackingOrder, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtGeneralV2Group=prtGeneralV2Group, printerV2Alert=printerV2Alert, PrtChannelStateTC=PrtChannelStateTC, prtGeneral=prtGeneral, prtStorageRefTable=prtStorageRefTable, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtInputSerialNumber=prtInputSerialNumber, prtMarkerTable=prtMarkerTable, prtAlertTable=prtAlertTable, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtMarkerStatus=prtMarkerStatus, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtInterpreter=prtInterpreter, prtInterpreterTwoWay=prtInterpreterTwoWay, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtChannelType=prtChannelType, prtMIBCompliance=prtMIBCompliance, prtOutputPageCollated=prtOutputPageCollated, prtMarkerColorantGroup=prtMarkerColorantGroup, prtMediaPathType=prtMediaPathType, prtMarkerWestMargin=prtMarkerWestMargin, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtAlertGroupIndex=prtAlertGroupIndex, prtMediaPathGroup=prtMediaPathGroup, prtChannelState=prtChannelState, prtMarkerGroup=prtMarkerGroup, prtConsoleColor=prtConsoleColor, prtOutput=prtOutput, prtInputEntry=prtInputEntry, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtDeviceRefTable=prtDeviceRefTable, PrtMediaUnitTC=PrtMediaUnitTC, PresentOnOff=PresentOnOff, prtOutputModel=prtOutputModel, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtMIBConformance=prtMIBConformance, prtMediaPathDescription=prtMediaPathDescription, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtAlertGroup=prtAlertGroup, prtInputSecurity=prtInputSecurity, prtInputIndex=prtInputIndex, prtOutputDefaultIndex=prtOutputDefaultIndex, prtChannelV2Group=prtChannelV2Group, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, printerV2AlertPrefix=printerV2AlertPrefix, prtInputSwitchingGroup=prtInputSwitchingGroup, prtInputDefaultIndex=prtInputDefaultIndex, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtOutputTable=prtOutputTable, prtMarkerSouthMargin=prtMarkerSouthMargin, prtGeneralPrinterName=prtGeneralPrinterName, prtInputDimUnit=prtInputDimUnit, prtChannelIfIndex=prtChannelIfIndex, prtConsoleLightEntry=prtConsoleLightEntry, prtInputVendorName=prtInputVendorName, CapacityUnit=CapacityUnit, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtAlertAllEvents=prtAlertAllEvents, prtOutputStatus=prtOutputStatus, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtAlertSeverityLevel=prtAlertSeverityLevel, prtAlertTableV2Group=prtAlertTableV2Group, prtOutputDimensionsGroup=prtOutputDimensionsGroup, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtConsoleOffTime=prtConsoleOffTime, prtInputCapacityUnit=prtInputCapacityUnit, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtInputMediaName=prtInputMediaName, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtExtendedOutputGroup=prtExtendedOutputGroup, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtInterpreterLangFamily=prtInterpreterLangFamily, prtOutputCapacityUnit=prtOutputCapacityUnit, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtCoverIndex=prtCoverIndex, prtMarkerEastMargin=prtMarkerEastMargin, prtInterpreterEntry=prtInterpreterEntry, prtChannel=prtChannel, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtCoverDescription=prtCoverDescription, prtChannelEntry=prtChannelEntry, prtInputMediaWeight=prtInputMediaWeight, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtInputGroup=prtInputGroup, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtOutputIndex=prtOutputIndex, prtMediaPathTable=prtMediaPathTable, prtMIB2Compliance=prtMIB2Compliance, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtConsoleDisable=prtConsoleDisable, prtOutputOffsetStacking=prtOutputOffsetStacking, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtChannelStatus=prtChannelStatus, prtCoverStatus=prtCoverStatus, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtOutputMaxCapacity=prtOutputMaxCapacity, prtOutputBursting=prtOutputBursting, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtLocalizationLanguage=prtLocalizationLanguage, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtInputMediaFormParts=prtInputMediaFormParts, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtMarkerEntry=prtMarkerEntry, PrtPrintOrientationTC=PrtPrintOrientationTC, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtLocalizationCountry=prtLocalizationCountry, prtChannelTable=prtChannelTable, SubUnitStatus=SubUnitStatus, prtMIB2Groups=prtMIB2Groups, prtInputMediaGroup=prtInputMediaGroup, prtAlertCriticalEvents=prtAlertCriticalEvents, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtMarkerColorant=prtMarkerColorant, prtMarkerColorantEntry=prtMarkerColorantEntry, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtConsoleLightTable=prtConsoleLightTable, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtConsoleLightIndex=prtConsoleLightIndex, prtOutputVersion=prtOutputVersion, prtMarker=prtMarker, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtMarkerSuppliesType=prtMarkerSuppliesType, PrtCapacityUnitTC=PrtCapacityUnitTC, prtCover=prtCover, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtGeneralGroup=prtGeneralGroup, prtStorageRefIndex=prtStorageRefIndex, PYSNMP_MODULE_ID=printmib, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtMarkerProcessColorants=prtMarkerProcessColorants, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtConsoleLights=prtConsoleLights, CodedCharSet=CodedCharSet, prtMarkerIndex=prtMarkerIndex, prtMarkerCounterUnit=prtMarkerCounterUnit, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtAlertEntry=prtAlertEntry, prtInterpreterLangLevel=prtInterpreterLangLevel, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtCoverTable=prtCoverTable, prtInterpreterVersion=prtInterpreterVersion, prtInput=prtInput, prtMediaPathStatus=prtMediaPathStatus, prtChannelIndex=prtChannelIndex, prtGeneralTable=prtGeneralTable, prtLocalizationIndex=prtLocalizationIndex, prtChannelInformation=prtChannelInformation, prtAlertTime=prtAlertTime, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtLocalizationTable=prtLocalizationTable, prtAlertIndex=prtAlertIndex, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtMarkerNorthMargin=prtMarkerNorthMargin, prtMarkerColorantTable=prtMarkerColorantTable, prtMarkerMarkTech=prtMarkerMarkTech, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtAlertTrapGroup=prtAlertTrapGroup, prtInterpreterTable=prtInterpreterTable, prtInputName=prtInputName, prtGeneralReset=prtGeneralReset, prtAlertCode=prtAlertCode, prtMarkerSpotColorants=prtMarkerSpotColorants, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtOutputDescription=prtOutputDescription, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtConsoleOnTime=prtConsoleOnTime, prtCoverEntry=prtCoverEntry, prtLocalization=prtLocalization, prtMarkerColorantRole=prtMarkerColorantRole, prtMarkerLifeCount=prtMarkerLifeCount)
mibBuilder.exportSymbols("Printer-MIB", prtInputMediaType=prtInputMediaType, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtOutputVendorName=prtOutputVendorName, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC)
