...
PrtAlertGroupTC, PrtConsoleColorTC, PrtAlertCodeTC, PrtChannelTypeTC, PrtInputTypeTC, PrtInterpreterLangFamilyTC, PrtMediaPathTypeTC, PrtCoverStatusTC, PrtConsoleDisableTC, PrtGeneralResetTC, PrtMarkerSuppliesTypeTC, PrtAlertTrainingLevelTC, PrtOutputTypeTC, PrtMarkerMarkTechTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtAlertGroupTC", "PrtConsoleColorTC", "PrtAlertCodeTC", "PrtChannelTypeTC", "PrtInputTypeTC", "PrtInterpreterLangFamilyTC", "PrtMediaPathTypeTC", "PrtCoverStatusTC", "PrtConsoleDisableTC", "PrtGeneralResetTC", "PrtMarkerSuppliesTypeTC", "PrtAlertTrainingLevelTC", "PrtOutputTypeTC", "PrtMarkerMarkTechTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtGeneralSerialNumber=prtGeneralSerialNumber, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtInputMediaFormParts=prtInputMediaFormParts, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtInputMaxCapacity=prtInputMaxCapacity, prtOutputBursting=prtOutputBursting, prtConsoleDescription=prtConsoleDescription, prtConsoleOffTime=prtConsoleOffTime, prtMarkerGroup=prtMarkerGroup, prtMarkerColorant=prtMarkerColorant, prtOutput=prtOutput, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtMarkerSpotColorants=prtMarkerSpotColorants, PresentOnOff=PresentOnOff, prtDeviceRefTable=prtDeviceRefTable, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtAlertTimeGroup=prtAlertTimeGroup, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtInputMediaWeight=prtInputMediaWeight, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtLocalizationTable=prtLocalizationTable, prtMIBGroups=prtMIBGroups, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtAlertDescription=prtAlertDescription, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtGeneralConfigChanges=prtGeneralConfigChanges, PrtMediaUnitTC=PrtMediaUnitTC, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtAlertLocation=prtAlertLocation, prtDeviceRefEntry=prtDeviceRefEntry, prtOutputModel=prtOutputModel, prtInterpreterLangLevel=prtInterpreterLangLevel, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtOutputDefaultIndex=prtOutputDefaultIndex, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtMarkerSupplies=prtMarkerSupplies, prtInputModel=prtInputModel, prtOutputType=prtOutputType, prtMediaPathEntry=prtMediaPathEntry, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtInputMediaType=prtInputMediaType, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtAlertCode=prtAlertCode, printerV2AlertPrefix=printerV2AlertPrefix, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtAlert=prtAlert, prtInputTable=prtInputTable, prtMIBConformance=prtMIBConformance, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtOutputStatus=prtOutputStatus, prtStorageRefEntry=prtStorageRefEntry, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtMIBCompliance=prtMIBCompliance, prtDeviceRefIndex=prtDeviceRefIndex, prtInputMediaColor=prtInputMediaColor, prtConsoleLightIndex=prtConsoleLightIndex, prtChannelIfIndex=prtChannelIfIndex, prtConsoleOnTime=prtConsoleOnTime, prtInputSwitchingGroup=prtInputSwitchingGroup, prtAlertTrapGroup=prtAlertTrapGroup, prtInputDescription=prtInputDescription, prtMIB2Compliance=prtMIB2Compliance, prtChannelInformation=prtChannelInformation, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtInputStatus=prtInputStatus, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtOutputSecurity=prtOutputSecurity, prtChannelStatus=prtChannelStatus, prtMarkerEastMargin=prtMarkerEastMargin, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, PrtPrintOrientationTC=PrtPrintOrientationTC, prtGeneralCurrentOperator=prtGeneralCurrentOperator, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtMediaPathGroup=prtMediaPathGroup, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtChannelType=prtChannelType, printmib=printmib, prtInputVersion=prtInputVersion, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtOutputStackingOrder=prtOutputStackingOrder, prtCoverTable=prtCoverTable, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtInterpreterIndex=prtInterpreterIndex, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtInputGroup=prtInputGroup, prtCoverDescription=prtCoverDescription, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtCoverIndex=prtCoverIndex, prtGeneralV2Group=prtGeneralV2Group, prtMarkerColorantTonality=prtMarkerColorantTonality, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, SubUnitStatus=SubUnitStatus, prtOutputEntry=prtOutputEntry, prtMarkerColorantRole=prtMarkerColorantRole, prtMarkerColorantValue=prtMarkerColorantValue, prtAlertSeverityLevel=prtAlertSeverityLevel, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtLocalizationLanguage=prtLocalizationLanguage, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, printerV2Alert=printerV2Alert, prtInterpreterTwoWay=prtInterpreterTwoWay, prtAlertCriticalEvents=prtAlertCriticalEvents, prtExtendedInputGroup=prtExtendedInputGroup, prtGeneral=prtGeneral, prtAlertGroup=prtAlertGroup, prtMarkerMarkTech=prtMarkerMarkTech, prtInterpreterVersion=prtInterpreterVersion, prtOutputDescription=prtOutputDescription, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtMarkerColorantTable=prtMarkerColorantTable, printerV1Alert=printerV1Alert, prtMarker=prtMarker, prtOutputSerialNumber=prtOutputSerialNumber, prtConsoleDisable=prtConsoleDisable, MediaUnit=MediaUnit, CapacityUnit=CapacityUnit, prtOutputDimensionsGroup=prtOutputDimensionsGroup, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtMarkerColorantIndex=prtMarkerColorantIndex, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtAlertTrainingLevel=prtAlertTrainingLevel, prtMediaPath=prtMediaPath, prtMediaPathType=prtMediaPathType, prtMarkerSuppliesType=prtMarkerSuppliesType, prtMarkerSouthMargin=prtMarkerSouthMargin, prtGeneralTable=prtGeneralTable, prtCoverStatus=prtCoverStatus, prtLocalization=prtLocalization, prtStorageRefTable=prtStorageRefTable, prtInputCurrentLevel=prtInputCurrentLevel, prtInputSerialNumber=prtInputSerialNumber, prtOutputDimUnit=prtOutputDimUnit, prtGeneralServicePerson=prtGeneralServicePerson, prtOutputIndex=prtOutputIndex, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, CodedCharSet=CodedCharSet, prtMediaPathDescription=prtMediaPathDescription, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtMIB2Groups=prtMIB2Groups, prtInputNextIndex=prtInputNextIndex, PrtCapacityUnitTC=PrtCapacityUnitTC, prtCoverEntry=prtCoverEntry, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtCover=prtCover, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtChannelEntry=prtChannelEntry, PrtChannelStateTC=PrtChannelStateTC, prtAlertGroupIndex=prtAlertGroupIndex, prtChannel=prtChannel, prtGeneralPrinterName=prtGeneralPrinterName, prtLocalizationCountry=prtLocalizationCountry, prtInputMediaName=prtInputMediaName, prtChannelTable=prtChannelTable, prtMarkerStatus=prtMarkerStatus, prtChannelIndex=prtChannelIndex, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtInputEntry=prtInputEntry, prtInputDimUnit=prtInputDimUnit, prtMarkerProcessColorants=prtMarkerProcessColorants, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtOutputPageCollated=prtOutputPageCollated, prtInterpreterLangVersion=prtInterpreterLangVersion, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtAlertTable=prtAlertTable, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtAlertEntry=prtAlertEntry, prtMarkerTable=prtMarkerTable, prtConsoleColor=prtConsoleColor, prtAlertTableGroup=prtAlertTableGroup, prtInterpreterDescription=prtInterpreterDescription, prtInterpreterGroup=prtInterpreterGroup, prtChannelV2Group=prtChannelV2Group, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtInputDefaultIndex=prtInputDefaultIndex, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtInputCapacityUnit=prtInputCapacityUnit, prtLocalizationIndex=prtLocalizationIndex, prtInput=prtInput, prtStorageRefIndex=prtStorageRefIndex, prtLocalizationEntry=prtLocalizationEntry, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtOutputTable=prtOutputTable, prtMarkerCounterUnit=prtMarkerCounterUnit, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtMediaPathIndex=prtMediaPathIndex, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtInterpreter=prtInterpreter, prtConsoleLightTable=prtConsoleLightTable, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtConsoleLocalization=prtConsoleLocalization, prtMediaPathTable=prtMediaPathTable, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtOutputVendorName=prtOutputVendorName, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtMediaPathStatus=prtMediaPathStatus, prtOutputGroup=prtOutputGroup, prtAlertIndex=prtAlertIndex, prtAlertTableV2Group=prtAlertTableV2Group, prtGeneralReset=prtGeneralReset, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtConsoleLights=prtConsoleLights, prtInputName=prtInputName, prtMarkerColorantEntry=prtMarkerColorantEntry, PYSNMP_MODULE_ID=printmib, prtMarkerLifeCount=prtMarkerLifeCount, prtOutputOffsetStacking=prtOutputOffsetStacking, prtOutputName=prtOutputName, prtChannelState=prtChannelState, prtGeneralEntry=prtGeneralEntry, prtMarkerWestMargin=prtMarkerWestMargin, prtGeneralGroup=prtGeneralGroup, prtInputMediaGroup=prtInputMediaGroup, prtInputSecurity=prtInputSecurity, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtMarkerColorantGroup=prtMarkerColorantGroup, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtOutputVersion=prtOutputVersion, prtInterpreterLangFamily=prtInterpreterLangFamily, prtInputType=prtInputType, prtOutputMaxCapacity=prtOutputMaxCapacity, prtInterpreterTable=prtInterpreterTable, prtAlertAllEvents=prtAlertAllEvents, prtExtendedOutputGroup=prtExtendedOutputGroup, prtChannelGroup=prtChannelGroup, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtOutputCapacityUnit=prtOutputCapacityUnit, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtOutputDecollating=prtOutputDecollating, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtMarkerEntry=prtMarkerEntry, prtConsoleLightEntry=prtConsoleLightEntry, prtInterpreterEntry=prtInterpreterEntry, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtMarkerIndex=prtMarkerIndex, prtInputVendorName=prtInputVendorName, prtChannelProtocolVersion=prtChannelProtocolVersion)
mibBuilder.exportSymbols("Printer-MIB", prtInputIndex=prtInputIndex, prtConsoleGroup=prtConsoleGroup, prtMarkerNorthMargin=prtMarkerNorthMargin, prtAlertTime=prtAlertTime)
