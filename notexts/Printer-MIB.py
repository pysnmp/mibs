...
PrtChannelTypeTC, PrtMarkerMarkTechTC, PrtConsoleDisableTC, PrtConsoleColorTC, PrtMediaPathTypeTC, PrtAlertTrainingLevelTC, PrtOutputTypeTC, PrtGeneralResetTC, PrtAlertGroupTC, PrtCoverStatusTC, PrtInputTypeTC, PrtMarkerSuppliesTypeTC, PrtAlertCodeTC, PrtInterpreterLangFamilyTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtChannelTypeTC", "PrtMarkerMarkTechTC", "PrtConsoleDisableTC", "PrtConsoleColorTC", "PrtMediaPathTypeTC", "PrtAlertTrainingLevelTC", "PrtOutputTypeTC", "PrtGeneralResetTC", "PrtAlertGroupTC", "PrtCoverStatusTC", "PrtInputTypeTC", "PrtMarkerSuppliesTypeTC", "PrtAlertCodeTC", "PrtInterpreterLangFamilyTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtOutput=prtOutput, prtInputTable=prtInputTable, PrtChannelStateTC=PrtChannelStateTC, prtConsoleColor=prtConsoleColor, prtMarkerColorantEntry=prtMarkerColorantEntry, prtConsoleDisable=prtConsoleDisable, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtConsoleOnTime=prtConsoleOnTime, printerV1Alert=printerV1Alert, printerV2Alert=printerV2Alert, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtAlertTrainingLevel=prtAlertTrainingLevel, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtCoverTable=prtCoverTable, prtOutputIndex=prtOutputIndex, prtGeneralV2Group=prtGeneralV2Group, prtAlertAllEvents=prtAlertAllEvents, prtAlertTimeGroup=prtAlertTimeGroup, prtMarkerCounterUnit=prtMarkerCounterUnit, prtMarkerWestMargin=prtMarkerWestMargin, prtCoverStatus=prtCoverStatus, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, SubUnitStatus=SubUnitStatus, prtInputEntry=prtInputEntry, prtMarker=prtMarker, prtMediaPathTable=prtMediaPathTable, prtInputMediaFormParts=prtInputMediaFormParts, prtConsoleLightTable=prtConsoleLightTable, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtConsoleLightIndex=prtConsoleLightIndex, prtCoverDescription=prtCoverDescription, prtChannelGroup=prtChannelGroup, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtInputDescription=prtInputDescription, prtInput=prtInput, prtMIBCompliance=prtMIBCompliance, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtMarkerSupplies=prtMarkerSupplies, prtLocalization=prtLocalization, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtAlertTable=prtAlertTable, prtInterpreterEntry=prtInterpreterEntry, prtDeviceRefIndex=prtDeviceRefIndex, prtOutputCapacityUnit=prtOutputCapacityUnit, prtChannelStatus=prtChannelStatus, prtInterpreterLangLevel=prtInterpreterLangLevel, prtInterpreterVersion=prtInterpreterVersion, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtConsoleOffTime=prtConsoleOffTime, prtInputMediaColor=prtInputMediaColor, prtInterpreterGroup=prtInterpreterGroup, prtChannelIfIndex=prtChannelIfIndex, prtInputDefaultIndex=prtInputDefaultIndex, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtLocalizationIndex=prtLocalizationIndex, prtInputMediaName=prtInputMediaName, prtOutputVersion=prtOutputVersion, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtChannelTable=prtChannelTable, prtLocalizationEntry=prtLocalizationEntry, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtConsoleLights=prtConsoleLights, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtOutputType=prtOutputType, prtInputVendorName=prtInputVendorName, prtChannelEntry=prtChannelEntry, prtInputGroup=prtInputGroup, prtInputNextIndex=prtInputNextIndex, prtAlertLocation=prtAlertLocation, prtAlertTrapGroup=prtAlertTrapGroup, prtChannelV2Group=prtChannelV2Group, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtChannelInformation=prtChannelInformation, prtOutputDecollating=prtOutputDecollating, prtInterpreterTable=prtInterpreterTable, prtOutputSecurity=prtOutputSecurity, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtMarkerLifeCount=prtMarkerLifeCount, prtChannelState=prtChannelState, prtAlertCode=prtAlertCode, prtStorageRefEntry=prtStorageRefEntry, prtInputDimUnit=prtInputDimUnit, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtInputVersion=prtInputVersion, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtExtendedOutputGroup=prtExtendedOutputGroup, prtCover=prtCover, prtAlertTableGroup=prtAlertTableGroup, prtMarkerColorant=prtMarkerColorant, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtInputMediaType=prtInputMediaType, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtAlertGroup=prtAlertGroup, prtGeneralServicePerson=prtGeneralServicePerson, prtInterpreter=prtInterpreter, prtInputStatus=prtInputStatus, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtInputType=prtInputType, prtMediaPathType=prtMediaPathType, prtInterpreterIndex=prtInterpreterIndex, prtMarkerColorantRole=prtMarkerColorantRole, prtMarkerColorantIndex=prtMarkerColorantIndex, prtInputMaxCapacity=prtInputMaxCapacity, printmib=printmib, prtStorageRefIndex=prtStorageRefIndex, prtMarkerProcessColorants=prtMarkerProcessColorants, prtLocalizationLanguage=prtLocalizationLanguage, prtAlertDescription=prtAlertDescription, MediaUnit=MediaUnit, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtOutputStackingOrder=prtOutputStackingOrder, prtMIBGroups=prtMIBGroups, prtMarkerMarkTech=prtMarkerMarkTech, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, PrtCapacityUnitTC=PrtCapacityUnitTC, prtMediaPathDescription=prtMediaPathDescription, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtOutputDefaultIndex=prtOutputDefaultIndex, prtInputCurrentLevel=prtInputCurrentLevel, prtGeneralSerialNumber=prtGeneralSerialNumber, prtOutputStatus=prtOutputStatus, prtChannelProtocolVersion=prtChannelProtocolVersion, prtInputMediaGroup=prtInputMediaGroup, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtMarkerColorantValue=prtMarkerColorantValue, prtConsoleDescription=prtConsoleDescription, prtCoverEntry=prtCoverEntry, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtOutputOffsetStacking=prtOutputOffsetStacking, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtChannelIndex=prtChannelIndex, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, CodedCharSet=CodedCharSet, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtAlertGroupIndex=prtAlertGroupIndex, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtExtendedInputGroup=prtExtendedInputGroup, prtInputModel=prtInputModel, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtMarkerSouthMargin=prtMarkerSouthMargin, prtInputSwitchingGroup=prtInputSwitchingGroup, prtMarkerSuppliesType=prtMarkerSuppliesType, prtMediaPathStatus=prtMediaPathStatus, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtMIBConformance=prtMIBConformance, prtConsoleLocalization=prtConsoleLocalization, prtMediaPathIndex=prtMediaPathIndex, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtConsoleGroup=prtConsoleGroup, prtChannel=prtChannel, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtInputCapacityUnit=prtInputCapacityUnit, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtMarkerColorantGroup=prtMarkerColorantGroup, prtGeneralConfigChanges=prtGeneralConfigChanges, prtOutputEntry=prtOutputEntry, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtAlertCriticalEvents=prtAlertCriticalEvents, prtOutputMaxCapacity=prtOutputMaxCapacity, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtLocalizationCountry=prtLocalizationCountry, prtOutputDescription=prtOutputDescription, prtGeneralEntry=prtGeneralEntry, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtStorageRefTable=prtStorageRefTable, prtDeviceRefEntry=prtDeviceRefEntry, prtInputIndex=prtInputIndex, prtMarkerEastMargin=prtMarkerEastMargin, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtMediaPathGroup=prtMediaPathGroup, prtAlertTableV2Group=prtAlertTableV2Group, prtGeneralReset=prtGeneralReset, prtMarkerDefaultIndex=prtMarkerDefaultIndex, PrtMediaUnitTC=PrtMediaUnitTC, prtInterpreterLangVersion=prtInterpreterLangVersion, prtInterpreterTwoWay=prtInterpreterTwoWay, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtInputMediaWeight=prtInputMediaWeight, prtOutputBursting=prtOutputBursting, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtConsoleLightEntry=prtConsoleLightEntry, prtOutputDimUnit=prtOutputDimUnit, prtMediaPathEntry=prtMediaPathEntry, prtMarkerColorantTonality=prtMarkerColorantTonality, prtMarkerEntry=prtMarkerEntry, prtInterpreterLangFamily=prtInterpreterLangFamily, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtGeneralTable=prtGeneralTable, prtLocalizationTable=prtLocalizationTable, prtOutputGroup=prtOutputGroup, prtMediaPath=prtMediaPath, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtAlertEntry=prtAlertEntry, prtInputSecurity=prtInputSecurity, prtAlertTime=prtAlertTime, prtOutputModel=prtOutputModel, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtAlertIndex=prtAlertIndex, prtInputName=prtInputName, prtCoverIndex=prtCoverIndex, prtMarkerSpotColorants=prtMarkerSpotColorants, prtOutputName=prtOutputName, prtOutputSerialNumber=prtOutputSerialNumber, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtMarkerNorthMargin=prtMarkerNorthMargin, CapacityUnit=CapacityUnit, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtInterpreterDescription=prtInterpreterDescription, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, printerV2AlertPrefix=printerV2AlertPrefix, prtMarkerGroup=prtMarkerGroup, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtOutputVendorName=prtOutputVendorName, prtMarkerIndex=prtMarkerIndex, prtGeneralPrinterName=prtGeneralPrinterName, prtOutputPageCollated=prtOutputPageCollated, prtMarkerColorantTable=prtMarkerColorantTable, prtMIB2Compliance=prtMIB2Compliance, prtChannelType=prtChannelType, prtAlert=prtAlert, prtGeneralGroup=prtGeneralGroup, prtInputSerialNumber=prtInputSerialNumber, prtMarkerStatus=prtMarkerStatus, prtMIB2Groups=prtMIB2Groups, prtMarkerTable=prtMarkerTable, prtMarkerSuppliesClass=prtMarkerSuppliesClass, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, PresentOnOff=PresentOnOff, prtLocalizationCharacterSet=prtLocalizationCharacterSet, PrtPrintOrientationTC=PrtPrintOrientationTC, prtAlertSeverityLevel=prtAlertSeverityLevel, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtGeneral=prtGeneral)
mibBuilder.exportSymbols("Printer-MIB", prtDeviceRefTable=prtDeviceRefTable, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtOutputTable=prtOutputTable, PYSNMP_MODULE_ID=printmib)
