...
PrtOutputTypeTC, PrtGeneralResetTC, PrtConsoleDisableTC, PrtChannelTypeTC, PrtAlertGroupTC, PrtConsoleColorTC, PrtMediaPathTypeTC, PrtMarkerMarkTechTC, PrtAlertCodeTC, PrtInterpreterLangFamilyTC, PrtMarkerSuppliesTypeTC, PrtCoverStatusTC, PrtInputTypeTC, PrtAlertTrainingLevelTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtOutputTypeTC", "PrtGeneralResetTC", "PrtConsoleDisableTC", "PrtChannelTypeTC", "PrtAlertGroupTC", "PrtConsoleColorTC", "PrtMediaPathTypeTC", "PrtMarkerMarkTechTC", "PrtAlertCodeTC", "PrtInterpreterLangFamilyTC", "PrtMarkerSuppliesTypeTC", "PrtCoverStatusTC", "PrtInputTypeTC", "PrtAlertTrainingLevelTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtOutputType=prtOutputType, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtInputTable=prtInputTable, prtMediaPath=prtMediaPath, prtOutputTable=prtOutputTable, prtInputMediaColor=prtInputMediaColor, prtMarkerSouthMargin=prtMarkerSouthMargin, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, printerV1Alert=printerV1Alert, prtGeneralGroup=prtGeneralGroup, prtMarker=prtMarker, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtMediaPathEntry=prtMediaPathEntry, prtInterpreterLangFamily=prtInterpreterLangFamily, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtMarkerColorantEntry=prtMarkerColorantEntry, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtMarkerMarkTech=prtMarkerMarkTech, prtGeneralTable=prtGeneralTable, prtInputIndex=prtInputIndex, prtAlertTime=prtAlertTime, prtExtendedInputGroup=prtExtendedInputGroup, prtGeneralServicePerson=prtGeneralServicePerson, prtInputCapacityUnit=prtInputCapacityUnit, prtInputMediaFormParts=prtInputMediaFormParts, prtOutputStackingOrder=prtOutputStackingOrder, prtMIBGroups=prtMIBGroups, prtConsoleGroup=prtConsoleGroup, prtOutputDecollating=prtOutputDecollating, prtConsoleOnTime=prtConsoleOnTime, SubUnitStatus=SubUnitStatus, prtConsoleLights=prtConsoleLights, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtInputMediaType=prtInputMediaType, prtMarkerIndex=prtMarkerIndex, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtInputDefaultIndex=prtInputDefaultIndex, prtInputVendorName=prtInputVendorName, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtAlert=prtAlert, prtAlertTimeGroup=prtAlertTimeGroup, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtInputDimUnit=prtInputDimUnit, prtAlertDescription=prtAlertDescription, prtCoverTable=prtCoverTable, prtInputGroup=prtInputGroup, prtAlertSeverityLevel=prtAlertSeverityLevel, prtAlertTrapGroup=prtAlertTrapGroup, prtConsoleDescription=prtConsoleDescription, prtInputStatus=prtInputStatus, prtChannelV2Group=prtChannelV2Group, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtOutputOffsetStacking=prtOutputOffsetStacking, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtCoverStatus=prtCoverStatus, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtChannelEntry=prtChannelEntry, prtMarkerColorantValue=prtMarkerColorantValue, prtMarkerProcessColorants=prtMarkerProcessColorants, prtOutputBursting=prtOutputBursting, prtMarkerTable=prtMarkerTable, prtDeviceRefTable=prtDeviceRefTable, prtChannelTable=prtChannelTable, prtDeviceRefIndex=prtDeviceRefIndex, CapacityUnit=CapacityUnit, prtInputMediaGroup=prtInputMediaGroup, prtOutputSerialNumber=prtOutputSerialNumber, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtOutputGroup=prtOutputGroup, PYSNMP_MODULE_ID=printmib, prtGeneralEntry=prtGeneralEntry, PrtMediaUnitTC=PrtMediaUnitTC, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtInterpreterEntry=prtInterpreterEntry, CodedCharSet=CodedCharSet, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtAlertTrainingLevel=prtAlertTrainingLevel, prtMIBConformance=prtMIBConformance, prtMarkerSupplies=prtMarkerSupplies, prtAlertGroup=prtAlertGroup, prtLocalizationLanguage=prtLocalizationLanguage, prtDeviceRefEntry=prtDeviceRefEntry, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtCoverIndex=prtCoverIndex, prtOutputCapacityUnit=prtOutputCapacityUnit, prtLocalization=prtLocalization, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtConsoleLightEntry=prtConsoleLightEntry, prtAlertIndex=prtAlertIndex, prtAlertCode=prtAlertCode, prtInputDescription=prtInputDescription, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtOutputDimUnit=prtOutputDimUnit, prtConsoleOffTime=prtConsoleOffTime, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtOutput=prtOutput, prtGeneralPrinterName=prtGeneralPrinterName, prtInputNextIndex=prtInputNextIndex, printerV2AlertPrefix=printerV2AlertPrefix, prtOutputEntry=prtOutputEntry, printmib=printmib, prtOutputDescription=prtOutputDescription, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtCoverEntry=prtCoverEntry, prtConsoleLocalization=prtConsoleLocalization, prtInputSecurity=prtInputSecurity, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtInputType=prtInputType, prtInterpreterVersion=prtInterpreterVersion, prtMarkerNorthMargin=prtMarkerNorthMargin, prtAlertEntry=prtAlertEntry, prtLocalizationEntry=prtLocalizationEntry, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtConsoleDisable=prtConsoleDisable, prtInputModel=prtInputModel, prtInputVersion=prtInputVersion, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtLocalizationTable=prtLocalizationTable, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtInterpreterIndex=prtInterpreterIndex, prtInputEntry=prtInputEntry, prtMarkerSuppliesType=prtMarkerSuppliesType, prtInputMediaName=prtInputMediaName, prtGeneral=prtGeneral, prtMarkerCounterUnit=prtMarkerCounterUnit, prtOutputModel=prtOutputModel, prtInterpreterDescription=prtInterpreterDescription, prtAlertCriticalEvents=prtAlertCriticalEvents, prtAlertAllEvents=prtAlertAllEvents, PrtChannelStateTC=PrtChannelStateTC, prtOutputPageCollated=prtOutputPageCollated, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtAlertTableGroup=prtAlertTableGroup, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtOutputName=prtOutputName, prtMediaPathTable=prtMediaPathTable, prtAlertGroupIndex=prtAlertGroupIndex, prtMediaPathGroup=prtMediaPathGroup, prtMarkerEastMargin=prtMarkerEastMargin, prtAlertTableV2Group=prtAlertTableV2Group, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtConsoleLightIndex=prtConsoleLightIndex, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtMarkerColorant=prtMarkerColorant, prtMarkerColorantTonality=prtMarkerColorantTonality, prtInterpreter=prtInterpreter, prtMediaPathIndex=prtMediaPathIndex, prtOutputMaxCapacity=prtOutputMaxCapacity, PrtPrintOrientationTC=PrtPrintOrientationTC, prtOutputVersion=prtOutputVersion, prtChannelIndex=prtChannelIndex, PrtCapacityUnitTC=PrtCapacityUnitTC, PresentOnOff=PresentOnOff, prtInterpreterTable=prtInterpreterTable, prtInputMaxCapacity=prtInputMaxCapacity, prtChannelProtocolVersion=prtChannelProtocolVersion, prtStorageRefTable=prtStorageRefTable, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtInterpreterLangLevel=prtInterpreterLangLevel, prtInputSerialNumber=prtInputSerialNumber, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtMarkerColorantGroup=prtMarkerColorantGroup, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtMarkerWestMargin=prtMarkerWestMargin, prtCover=prtCover, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtMarkerColorantTable=prtMarkerColorantTable, prtOutputSecurity=prtOutputSecurity, prtConsoleLightTable=prtConsoleLightTable, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtChannel=prtChannel, prtInputMediaWeight=prtInputMediaWeight, prtGeneralConfigChanges=prtGeneralConfigChanges, prtChannelIfIndex=prtChannelIfIndex, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtExtendedOutputGroup=prtExtendedOutputGroup, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtMIB2Compliance=prtMIB2Compliance, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtInputName=prtInputName, prtInterpreterTwoWay=prtInterpreterTwoWay, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtLocalizationIndex=prtLocalizationIndex, prtInput=prtInput, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtConsoleColor=prtConsoleColor, prtInterpreterGroup=prtInterpreterGroup, prtMarkerSpotColorants=prtMarkerSpotColorants, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtGeneralReset=prtGeneralReset, prtMarkerSuppliesTable=prtMarkerSuppliesTable, MediaUnit=MediaUnit, prtMediaPathDescription=prtMediaPathDescription, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtMarkerColorantIndex=prtMarkerColorantIndex, prtMarkerColorantRole=prtMarkerColorantRole, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtChannelInformation=prtChannelInformation, prtMIBCompliance=prtMIBCompliance, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtChannelStatus=prtChannelStatus, prtInputSwitchingGroup=prtInputSwitchingGroup, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtStorageRefIndex=prtStorageRefIndex, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtMarkerStatus=prtMarkerStatus, prtChannelGroup=prtChannelGroup, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtStorageRefEntry=prtStorageRefEntry, prtLocalizationCountry=prtLocalizationCountry, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtAlertLocation=prtAlertLocation, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtCoverDescription=prtCoverDescription, prtMarkerGroup=prtMarkerGroup, prtMediaPathType=prtMediaPathType, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtOutputIndex=prtOutputIndex, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtChannelState=prtChannelState, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtMIB2Groups=prtMIB2Groups, prtMarkerLifeCount=prtMarkerLifeCount, printerV2Alert=printerV2Alert, prtOutputDefaultIndex=prtOutputDefaultIndex, prtChannelType=prtChannelType, prtGeneralV2Group=prtGeneralV2Group, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtInterpreterLangVersion=prtInterpreterLangVersion, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtGeneralSerialNumber=prtGeneralSerialNumber, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtMediaPathStatus=prtMediaPathStatus, prtInputCurrentLevel=prtInputCurrentLevel, prtAlertTable=prtAlertTable, prtOutputStatus=prtOutputStatus)
mibBuilder.exportSymbols("Printer-MIB", prtOutputVendorName=prtOutputVendorName, prtMarkerEntry=prtMarkerEntry, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability)
