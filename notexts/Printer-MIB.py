...
PrtAlertTrainingLevelTC, PrtAlertCodeTC, PrtGeneralResetTC, PrtChannelTypeTC, PrtMarkerSuppliesTypeTC, PrtConsoleDisableTC, PrtConsoleColorTC, PrtInterpreterLangFamilyTC, PrtAlertGroupTC, PrtInputTypeTC, PrtMediaPathTypeTC, PrtOutputTypeTC, PrtMarkerMarkTechTC, PrtCoverStatusTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtAlertTrainingLevelTC", "PrtAlertCodeTC", "PrtGeneralResetTC", "PrtChannelTypeTC", "PrtMarkerSuppliesTypeTC", "PrtConsoleDisableTC", "PrtConsoleColorTC", "PrtInterpreterLangFamilyTC", "PrtAlertGroupTC", "PrtInputTypeTC", "PrtMediaPathTypeTC", "PrtOutputTypeTC", "PrtMarkerMarkTechTC", "PrtCoverStatusTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtMarkerColorantTable=prtMarkerColorantTable, prtInputCurrentLevel=prtInputCurrentLevel, prtAlertTimeGroup=prtAlertTimeGroup, prtInputMediaGroup=prtInputMediaGroup, prtGeneral=prtGeneral, prtStorageRefEntry=prtStorageRefEntry, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtAlertTableV2Group=prtAlertTableV2Group, prtDeviceRefIndex=prtDeviceRefIndex, PrtCapacityUnitTC=PrtCapacityUnitTC, prtChannelStatus=prtChannelStatus, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtAlertGroupIndex=prtAlertGroupIndex, prtGeneralPrinterName=prtGeneralPrinterName, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtMarkerMarkTech=prtMarkerMarkTech, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtOutputMaxCapacity=prtOutputMaxCapacity, prtConsoleLightTable=prtConsoleLightTable, CodedCharSet=CodedCharSet, prtCoverStatus=prtCoverStatus, prtInput=prtInput, prtCoverTable=prtCoverTable, prtLocalizationLanguage=prtLocalizationLanguage, prtOutputVendorName=prtOutputVendorName, prtChannelIfIndex=prtChannelIfIndex, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, PrtPrintOrientationTC=PrtPrintOrientationTC, prtOutputDimUnit=prtOutputDimUnit, prtGeneralEntry=prtGeneralEntry, prtInterpreterTwoWay=prtInterpreterTwoWay, prtGeneralTable=prtGeneralTable, prtInputMediaName=prtInputMediaName, prtInputModel=prtInputModel, prtMarkerEntry=prtMarkerEntry, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtConsoleLocalization=prtConsoleLocalization, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtOutputTable=prtOutputTable, prtMarkerTable=prtMarkerTable, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtConsoleLights=prtConsoleLights, prtOutputName=prtOutputName, prtOutputVersion=prtOutputVersion, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtInputNextIndex=prtInputNextIndex, prtMarkerProcessColorants=prtMarkerProcessColorants, prtMarkerColorantValue=prtMarkerColorantValue, prtInterpreterTable=prtInterpreterTable, CapacityUnit=CapacityUnit, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtOutputPageCollated=prtOutputPageCollated, prtMarkerEastMargin=prtMarkerEastMargin, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtExtendedOutputGroup=prtExtendedOutputGroup, prtMarkerSouthMargin=prtMarkerSouthMargin, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtInterpreterLangVersion=prtInterpreterLangVersion, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtMIBGroups=prtMIBGroups, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtOutputType=prtOutputType, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtOutputGroup=prtOutputGroup, prtAlert=prtAlert, prtInputStatus=prtInputStatus, prtAlertTable=prtAlertTable, prtAlertLocation=prtAlertLocation, prtMarkerColorantEntry=prtMarkerColorantEntry, prtOutputSecurity=prtOutputSecurity, prtInputEntry=prtInputEntry, prtMarkerColorantRole=prtMarkerColorantRole, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, SubUnitStatus=SubUnitStatus, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtMarkerSupplies=prtMarkerSupplies, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtAlertDescription=prtAlertDescription, prtLocalizationIndex=prtLocalizationIndex, prtStorageRefIndex=prtStorageRefIndex, prtMarkerWestMargin=prtMarkerWestMargin, prtMediaPathTable=prtMediaPathTable, prtMarkerLifeCount=prtMarkerLifeCount, prtAlertEntry=prtAlertEntry, prtChannelTable=prtChannelTable, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtLocalizationEntry=prtLocalizationEntry, prtLocalizationCountry=prtLocalizationCountry, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtInputMaxCapacity=prtInputMaxCapacity, prtOutputCapacityUnit=prtOutputCapacityUnit, prtOutputStatus=prtOutputStatus, prtMarkerSuppliesClass=prtMarkerSuppliesClass, PresentOnOff=PresentOnOff, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtInputIndex=prtInputIndex, PYSNMP_MODULE_ID=printmib, prtInputSerialNumber=prtInputSerialNumber, prtInputVendorName=prtInputVendorName, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtInputDimUnit=prtInputDimUnit, prtInterpreterVersion=prtInterpreterVersion, prtChannelEntry=prtChannelEntry, prtGeneralV2Group=prtGeneralV2Group, prtOutputModel=prtOutputModel, prtConsoleOnTime=prtConsoleOnTime, prtAlertTrapGroup=prtAlertTrapGroup, prtGeneralGroup=prtGeneralGroup, prtInputSwitchingGroup=prtInputSwitchingGroup, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtInterpreterDescription=prtInterpreterDescription, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtConsoleLightIndex=prtConsoleLightIndex, PrtChannelStateTC=PrtChannelStateTC, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtMarkerSpotColorants=prtMarkerSpotColorants, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtAlertCriticalEvents=prtAlertCriticalEvents, prtLocalization=prtLocalization, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtInterpreterGroup=prtInterpreterGroup, prtInputMediaColor=prtInputMediaColor, prtOutputSerialNumber=prtOutputSerialNumber, prtOutputStackingOrder=prtOutputStackingOrder, prtMarkerStatus=prtMarkerStatus, prtGeneralServicePerson=prtGeneralServicePerson, prtChannelInformation=prtChannelInformation, prtAlertTableGroup=prtAlertTableGroup, prtGeneralConfigChanges=prtGeneralConfigChanges, prtChannelIndex=prtChannelIndex, prtMIBConformance=prtMIBConformance, prtInputDefaultIndex=prtInputDefaultIndex, printmib=printmib, prtConsoleOffTime=prtConsoleOffTime, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtAlertAllEvents=prtAlertAllEvents, prtMarkerColorantIndex=prtMarkerColorantIndex, prtInputCapacityUnit=prtInputCapacityUnit, prtInputMediaWeight=prtInputMediaWeight, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtMarkerNorthMargin=prtMarkerNorthMargin, prtConsoleLightEntry=prtConsoleLightEntry, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtMarkerColorantGroup=prtMarkerColorantGroup, prtOutputOffsetStacking=prtOutputOffsetStacking, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtMarkerColorantTonality=prtMarkerColorantTonality, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtAlertIndex=prtAlertIndex, prtMediaPathDescription=prtMediaPathDescription, prtGeneralReset=prtGeneralReset, prtMarkerIndex=prtMarkerIndex, prtCoverIndex=prtCoverIndex, PrtMediaUnitTC=PrtMediaUnitTC, prtOutputEntry=prtOutputEntry, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtMediaPathIndex=prtMediaPathIndex, prtConsoleDisable=prtConsoleDisable, prtInputSecurity=prtInputSecurity, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtInterpreterEntry=prtInterpreterEntry, prtChannelProtocolVersion=prtChannelProtocolVersion, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, printerV2Alert=printerV2Alert, prtMediaPathEntry=prtMediaPathEntry, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtOutput=prtOutput, prtInterpreterIndex=prtInterpreterIndex, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtMediaPath=prtMediaPath, prtChannel=prtChannel, prtLocalizationCharacterSet=prtLocalizationCharacterSet, printerV1Alert=printerV1Alert, prtLocalizationTable=prtLocalizationTable, prtMarkerGroup=prtMarkerGroup, prtMediaPathGroup=prtMediaPathGroup, prtInputMediaFormParts=prtInputMediaFormParts, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtMIB2Groups=prtMIB2Groups, prtConsoleDescription=prtConsoleDescription, prtDeviceRefTable=prtDeviceRefTable, prtMarkerSuppliesType=prtMarkerSuppliesType, prtAlertSeverityLevel=prtAlertSeverityLevel, prtAlertTrainingLevel=prtAlertTrainingLevel, prtAlertGroup=prtAlertGroup, prtInputMediaType=prtInputMediaType, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtInputTable=prtInputTable, prtInputGroup=prtInputGroup, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtMediaPathStatus=prtMediaPathStatus, prtCoverEntry=prtCoverEntry, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtGeneralSerialNumber=prtGeneralSerialNumber, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtOutputDefaultIndex=prtOutputDefaultIndex, prtMarkerCounterUnit=prtMarkerCounterUnit, prtExtendedInputGroup=prtExtendedInputGroup, prtOutputDescription=prtOutputDescription, prtOutputIndex=prtOutputIndex, prtChannelType=prtChannelType, printerV2AlertPrefix=printerV2AlertPrefix, prtStorageRefTable=prtStorageRefTable, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtConsoleColor=prtConsoleColor, prtInputName=prtInputName, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtOutputBursting=prtOutputBursting, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtMarkerColorant=prtMarkerColorant, prtChannelState=prtChannelState, prtMIB2Compliance=prtMIB2Compliance, MediaUnit=MediaUnit, prtChannelV2Group=prtChannelV2Group, prtCoverDescription=prtCoverDescription, prtOutputDecollating=prtOutputDecollating, prtInputDescription=prtInputDescription, prtMarker=prtMarker, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtAlertTime=prtAlertTime, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtChannelGroup=prtChannelGroup, prtDeviceRefEntry=prtDeviceRefEntry, prtInterpreter=prtInterpreter, prtConsoleGroup=prtConsoleGroup, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtCover=prtCover, prtAlertCode=prtAlertCode, prtInputVersion=prtInputVersion, prtMediaPathType=prtMediaPathType, prtMIBCompliance=prtMIBCompliance, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry)
mibBuilder.exportSymbols("Printer-MIB", prtInterpreterLangLevel=prtInterpreterLangLevel, prtInterpreterLangFamily=prtInterpreterLangFamily, prtInputType=prtInputType, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC)
