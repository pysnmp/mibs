...
PrtMediaPathTypeTC, PrtAlertGroupTC, PrtChannelTypeTC, PrtConsoleColorTC, PrtOutputTypeTC, PrtAlertTrainingLevelTC, PrtInterpreterLangFamilyTC, PrtInputTypeTC, PrtAlertCodeTC, PrtGeneralResetTC, PrtConsoleDisableTC, PrtMarkerMarkTechTC, PrtMarkerSuppliesTypeTC, PrtCoverStatusTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtMediaPathTypeTC", "PrtAlertGroupTC", "PrtChannelTypeTC", "PrtConsoleColorTC", "PrtOutputTypeTC", "PrtAlertTrainingLevelTC", "PrtInterpreterLangFamilyTC", "PrtInputTypeTC", "PrtAlertCodeTC", "PrtGeneralResetTC", "PrtConsoleDisableTC", "PrtMarkerMarkTechTC", "PrtMarkerSuppliesTypeTC", "PrtCoverStatusTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtMarkerNorthMargin=prtMarkerNorthMargin, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtMediaPathEntry=prtMediaPathEntry, prtMarkerColorantRole=prtMarkerColorantRole, prtChannelIndex=prtChannelIndex, printerV1Alert=printerV1Alert, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtOutputSecurity=prtOutputSecurity, prtInterpreterGroup=prtInterpreterGroup, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, PYSNMP_MODULE_ID=printmib, printerV2AlertPrefix=printerV2AlertPrefix, prtMarkerProcessColorants=prtMarkerProcessColorants, prtConsoleLocalization=prtConsoleLocalization, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtMediaPathTable=prtMediaPathTable, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtGeneralReset=prtGeneralReset, prtAlertSeverityLevel=prtAlertSeverityLevel, prtAlertTableGroup=prtAlertTableGroup, prtMIB2Groups=prtMIB2Groups, prtInputCurrentLevel=prtInputCurrentLevel, prtLocalization=prtLocalization, prtInterpreterTable=prtInterpreterTable, prtOutputVersion=prtOutputVersion, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtAlertTimeGroup=prtAlertTimeGroup, prtInputGroup=prtInputGroup, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtMarkerMarkTech=prtMarkerMarkTech, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtOutputIndex=prtOutputIndex, prtAlertTrapGroup=prtAlertTrapGroup, prtMarkerTable=prtMarkerTable, prtOutput=prtOutput, prtAlertTableV2Group=prtAlertTableV2Group, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtInputVersion=prtInputVersion, prtAlertTrainingLevel=prtAlertTrainingLevel, prtAlertIndex=prtAlertIndex, prtAlertDescription=prtAlertDescription, prtMediaPathType=prtMediaPathType, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtChannelTable=prtChannelTable, prtMIBConformance=prtMIBConformance, prtChannelState=prtChannelState, prtInputTable=prtInputTable, prtInputDimUnit=prtInputDimUnit, prtChannelEntry=prtChannelEntry, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtConsoleLightTable=prtConsoleLightTable, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtOutputType=prtOutputType, prtGeneralConfigChanges=prtGeneralConfigChanges, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtLocalizationTable=prtLocalizationTable, prtInputType=prtInputType, prtAlertLocation=prtAlertLocation, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtInputCapacityUnit=prtInputCapacityUnit, prtLocalizationLanguage=prtLocalizationLanguage, prtMarkerEntry=prtMarkerEntry, PrtChannelStateTC=PrtChannelStateTC, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtOutputDescription=prtOutputDescription, prtCoverEntry=prtCoverEntry, prtChannelInformation=prtChannelInformation, prtInterpreterVersion=prtInterpreterVersion, prtMarkerColorant=prtMarkerColorant, prtMarkerColorantTable=prtMarkerColorantTable, prtOutputTable=prtOutputTable, prtMarkerLifeCount=prtMarkerLifeCount, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtMarkerSuppliesType=prtMarkerSuppliesType, prtAlert=prtAlert, prtAlertCriticalEvents=prtAlertCriticalEvents, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtInputMediaType=prtInputMediaType, prtMarker=prtMarker, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtMarkerColorantEntry=prtMarkerColorantEntry, prtCoverIndex=prtCoverIndex, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtChannelStatus=prtChannelStatus, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtOutputPageCollated=prtOutputPageCollated, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtGeneralPrinterName=prtGeneralPrinterName, prtOutputEntry=prtOutputEntry, prtMarkerSpotColorants=prtMarkerSpotColorants, prtMediaPathStatus=prtMediaPathStatus, prtInputMediaWeight=prtInputMediaWeight, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtConsoleLightIndex=prtConsoleLightIndex, prtOutputStackingOrder=prtOutputStackingOrder, prtAlertEntry=prtAlertEntry, prtChannelGroup=prtChannelGroup, prtConsoleLights=prtConsoleLights, prtStorageRefTable=prtStorageRefTable, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtGeneralGroup=prtGeneralGroup, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtGeneralTable=prtGeneralTable, prtInputVendorName=prtInputVendorName, prtConsoleColor=prtConsoleColor, prtInterpreterDescription=prtInterpreterDescription, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtInputStatus=prtInputStatus, SubUnitStatus=SubUnitStatus, prtInterpreterLangVersion=prtInterpreterLangVersion, prtMIB2Compliance=prtMIB2Compliance, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtGeneralV2Group=prtGeneralV2Group, prtConsoleLightEntry=prtConsoleLightEntry, prtMediaPathGroup=prtMediaPathGroup, prtInputDescription=prtInputDescription, MediaUnit=MediaUnit, prtMarkerGroup=prtMarkerGroup, CapacityUnit=CapacityUnit, PrtMediaUnitTC=PrtMediaUnitTC, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtOutputDimUnit=prtOutputDimUnit, prtAlertCode=prtAlertCode, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtInputMediaColor=prtInputMediaColor, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, CodedCharSet=CodedCharSet, prtOutputMaxCapacity=prtOutputMaxCapacity, prtMarkerIndex=prtMarkerIndex, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtConsoleOnTime=prtConsoleOnTime, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtMarkerColorantGroup=prtMarkerColorantGroup, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtInterpreterIndex=prtInterpreterIndex, prtInterpreter=prtInterpreter, prtOutputCapacityUnit=prtOutputCapacityUnit, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtInputModel=prtInputModel, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtInterpreterTwoWay=prtInterpreterTwoWay, prtAlertTable=prtAlertTable, prtInputMaxCapacity=prtInputMaxCapacity, prtDeviceRefIndex=prtDeviceRefIndex, prtChannel=prtChannel, prtCoverDescription=prtCoverDescription, prtMarkerWestMargin=prtMarkerWestMargin, prtGeneral=prtGeneral, prtLocalizationEntry=prtLocalizationEntry, prtMarkerSupplies=prtMarkerSupplies, prtOutputGroup=prtOutputGroup, prtInterpreterLangLevel=prtInterpreterLangLevel, prtInput=prtInput, prtInputDefaultIndex=prtInputDefaultIndex, prtOutputStatus=prtOutputStatus, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtInputMediaName=prtInputMediaName, prtOutputName=prtOutputName, prtChannelProtocolVersion=prtChannelProtocolVersion, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtMarkerColorantTonality=prtMarkerColorantTonality, prtConsoleDescription=prtConsoleDescription, prtMIBCompliance=prtMIBCompliance, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtMediaPath=prtMediaPath, prtConsoleDisable=prtConsoleDisable, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtInputSecurity=prtInputSecurity, prtGeneralSerialNumber=prtGeneralSerialNumber, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtOutputDefaultIndex=prtOutputDefaultIndex, prtCoverStatus=prtCoverStatus, prtInputSwitchingGroup=prtInputSwitchingGroup, prtChannelV2Group=prtChannelV2Group, PresentOnOff=PresentOnOff, prtStorageRefSeqNumber=prtStorageRefSeqNumber, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtGeneralServicePerson=prtGeneralServicePerson, prtOutputModel=prtOutputModel, prtAlertAllEvents=prtAlertAllEvents, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtDeviceRefTable=prtDeviceRefTable, prtChannelType=prtChannelType, prtInterpreterEntry=prtInterpreterEntry, prtOutputBursting=prtOutputBursting, prtAlertGroup=prtAlertGroup, prtInputSerialNumber=prtInputSerialNumber, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtMarkerStatus=prtMarkerStatus, prtInputName=prtInputName, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtChannelIfIndex=prtChannelIfIndex, prtExtendedInputGroup=prtExtendedInputGroup, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtExtendedOutputGroup=prtExtendedOutputGroup, prtMarkerColorantValue=prtMarkerColorantValue, prtAlertTime=prtAlertTime, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtConsoleOffTime=prtConsoleOffTime, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtMarkerColorantIndex=prtMarkerColorantIndex, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtOutputDecollating=prtOutputDecollating, prtOutputOffsetStacking=prtOutputOffsetStacking, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtMarkerSouthMargin=prtMarkerSouthMargin, printerV2Alert=printerV2Alert, prtGeneralEntry=prtGeneralEntry, prtLocalizationCountry=prtLocalizationCountry, prtInputMediaFormParts=prtInputMediaFormParts, prtInputNextIndex=prtInputNextIndex, prtInputIndex=prtInputIndex, prtMediaPathIndex=prtMediaPathIndex, prtInterpreterLangFamily=prtInterpreterLangFamily, prtMIBGroups=prtMIBGroups, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtMarkerEastMargin=prtMarkerEastMargin, prtAlertGroupIndex=prtAlertGroupIndex, prtLocalizationIndex=prtLocalizationIndex, prtOutputSerialNumber=prtOutputSerialNumber, prtCover=prtCover, prtDeviceRefEntry=prtDeviceRefEntry, prtConsoleGroup=prtConsoleGroup, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, PrtPrintOrientationTC=PrtPrintOrientationTC, prtCoverTable=prtCoverTable, prtStorageRefIndex=prtStorageRefIndex, PrtCapacityUnitTC=PrtCapacityUnitTC, prtInputMediaGroup=prtInputMediaGroup, prtOutputVendorName=prtOutputVendorName, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, printmib=printmib)
mibBuilder.exportSymbols("Printer-MIB", prtMarkerCounterUnit=prtMarkerCounterUnit, prtMediaPathDescription=prtMediaPathDescription, prtInputEntry=prtInputEntry, prtStorageRefEntry=prtStorageRefEntry)
