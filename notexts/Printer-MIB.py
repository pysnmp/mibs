...
PrtConsoleColorTC, PrtCoverStatusTC, PrtOutputTypeTC, PrtAlertCodeTC, PrtInterpreterLangFamilyTC, PrtChannelTypeTC, PrtMarkerSuppliesTypeTC, PrtConsoleDisableTC, PrtAlertGroupTC, PrtAlertTrainingLevelTC, PrtGeneralResetTC, PrtMediaPathTypeTC, PrtInputTypeTC, PrtMarkerMarkTechTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtConsoleColorTC", "PrtCoverStatusTC", "PrtOutputTypeTC", "PrtAlertCodeTC", "PrtInterpreterLangFamilyTC", "PrtChannelTypeTC", "PrtMarkerSuppliesTypeTC", "PrtConsoleDisableTC", "PrtAlertGroupTC", "PrtAlertTrainingLevelTC", "PrtGeneralResetTC", "PrtMediaPathTypeTC", "PrtInputTypeTC", "PrtMarkerMarkTechTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtAlertDescription=prtAlertDescription, prtAlertTime=prtAlertTime, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtMIBCompliance=prtMIBCompliance, prtOutputPageCollated=prtOutputPageCollated, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtStorageRefEntry=prtStorageRefEntry, prtOutputEntry=prtOutputEntry, prtInterpreterTable=prtInterpreterTable, prtConsoleLocalization=prtConsoleLocalization, prtInputVendorName=prtInputVendorName, prtOutputOffsetStacking=prtOutputOffsetStacking, prtConsoleDisable=prtConsoleDisable, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtAlertTimeGroup=prtAlertTimeGroup, PrtPrintOrientationTC=PrtPrintOrientationTC, prtOutputBursting=prtOutputBursting, prtChannelInformation=prtChannelInformation, prtInputName=prtInputName, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, PrtChannelStateTC=PrtChannelStateTC, prtGeneralServicePerson=prtGeneralServicePerson, prtConsoleDescription=prtConsoleDescription, prtLocalization=prtLocalization, prtLocalizationIndex=prtLocalizationIndex, SubUnitStatus=SubUnitStatus, prtCover=prtCover, prtMarkerSpotColorants=prtMarkerSpotColorants, prtInputStatus=prtInputStatus, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtChannelEntry=prtChannelEntry, prtChannel=prtChannel, prtOutputDefaultIndex=prtOutputDefaultIndex, prtMarkerLifeCount=prtMarkerLifeCount, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtMarkerCounterUnit=prtMarkerCounterUnit, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtInputMediaType=prtInputMediaType, prtMarkerColorant=prtMarkerColorant, prtChannelV2Group=prtChannelV2Group, prtAlertTrapGroup=prtAlertTrapGroup, prtInputCurrentLevel=prtInputCurrentLevel, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtAlertTable=prtAlertTable, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtCoverIndex=prtCoverIndex, prtMIBConformance=prtMIBConformance, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtInputCapacityUnit=prtInputCapacityUnit, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtConsoleLightEntry=prtConsoleLightEntry, prtInterpreterDescription=prtInterpreterDescription, prtAlertGroup=prtAlertGroup, prtAlertCriticalEvents=prtAlertCriticalEvents, prtAlertCode=prtAlertCode, prtMediaPathGroup=prtMediaPathGroup, prtOutputMaxCapacity=prtOutputMaxCapacity, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtExtendedInputGroup=prtExtendedInputGroup, prtInputSwitchingGroup=prtInputSwitchingGroup, prtChannelTable=prtChannelTable, prtGeneralSerialNumber=prtGeneralSerialNumber, PresentOnOff=PresentOnOff, prtOutputType=prtOutputType, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtDeviceRefIndex=prtDeviceRefIndex, prtOutputModel=prtOutputModel, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtOutputDimUnit=prtOutputDimUnit, prtAlertSeverityLevel=prtAlertSeverityLevel, prtInterpreterGroup=prtInterpreterGroup, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtAlertEntry=prtAlertEntry, prtInputMaxCapacity=prtInputMaxCapacity, prtInputGroup=prtInputGroup, prtMarker=prtMarker, prtAlertAllEvents=prtAlertAllEvents, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtChannelType=prtChannelType, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtCoverStatus=prtCoverStatus, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtOutputDecollating=prtOutputDecollating, prtMarkerColorantEntry=prtMarkerColorantEntry, prtOutputStackingOrder=prtOutputStackingOrder, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtMediaPathTable=prtMediaPathTable, prtGeneralReset=prtGeneralReset, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtMarkerSuppliesType=prtMarkerSuppliesType, prtLocalizationLanguage=prtLocalizationLanguage, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtMIB2Compliance=prtMIB2Compliance, prtConsoleLightIndex=prtConsoleLightIndex, prtAlert=prtAlert, printerV1Alert=printerV1Alert, prtCoverDescription=prtCoverDescription, prtInputDescription=prtInputDescription, prtAlertTableV2Group=prtAlertTableV2Group, prtStorageRefTable=prtStorageRefTable, prtConsoleColor=prtConsoleColor, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtChannelIfIndex=prtChannelIfIndex, prtMIB2Groups=prtMIB2Groups, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtGeneral=prtGeneral, prtMarkerColorantValue=prtMarkerColorantValue, prtOutputGroup=prtOutputGroup, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtChannelProtocolVersion=prtChannelProtocolVersion, prtMarkerSouthMargin=prtMarkerSouthMargin, printerV2AlertPrefix=printerV2AlertPrefix, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtMarkerGroup=prtMarkerGroup, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtInput=prtInput, prtMIBGroups=prtMIBGroups, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtOutputTable=prtOutputTable, prtConsoleLights=prtConsoleLights, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtMediaPath=prtMediaPath, prtInterpreterTwoWay=prtInterpreterTwoWay, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtInputIndex=prtInputIndex, prtInputMediaColor=prtInputMediaColor, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtChannelGroup=prtChannelGroup, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtExtendedOutputGroup=prtExtendedOutputGroup, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, PrtMediaUnitTC=PrtMediaUnitTC, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtInputSecurity=prtInputSecurity, prtMarkerNorthMargin=prtMarkerNorthMargin, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtMarkerColorantTonality=prtMarkerColorantTonality, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, MediaUnit=MediaUnit, prtOutputVendorName=prtOutputVendorName, prtInputType=prtInputType, prtOutputSerialNumber=prtOutputSerialNumber, prtInputTable=prtInputTable, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtGeneralGroup=prtGeneralGroup, prtConsoleGroup=prtConsoleGroup, PrtCapacityUnitTC=PrtCapacityUnitTC, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtInputSerialNumber=prtInputSerialNumber, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtLocalizationCountry=prtLocalizationCountry, prtOutput=prtOutput, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtDeviceRefEntry=prtDeviceRefEntry, prtMarkerTable=prtMarkerTable, prtOutputDimensionsGroup=prtOutputDimensionsGroup, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtConsoleOffTime=prtConsoleOffTime, prtInterpreterLangFamily=prtInterpreterLangFamily, prtInputMediaGroup=prtInputMediaGroup, prtMarkerColorantGroup=prtMarkerColorantGroup, prtMarkerColorantIndex=prtMarkerColorantIndex, prtMediaPathDescription=prtMediaPathDescription, prtChannelState=prtChannelState, prtGeneralV2Group=prtGeneralV2Group, CapacityUnit=CapacityUnit, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtMediaPathEntry=prtMediaPathEntry, prtInputVersion=prtInputVersion, prtInterpreterVersion=prtInterpreterVersion, prtAlertGroupIndex=prtAlertGroupIndex, prtMarkerStatus=prtMarkerStatus, prtInputDimUnit=prtInputDimUnit, PYSNMP_MODULE_ID=printmib, printmib=printmib, prtInputDefaultIndex=prtInputDefaultIndex, prtStorageRefIndex=prtStorageRefIndex, prtOutputIndex=prtOutputIndex, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtConsoleOnTime=prtConsoleOnTime, prtAlertIndex=prtAlertIndex, prtInputNextIndex=prtInputNextIndex, prtOutputSecurity=prtOutputSecurity, prtInterpreterEntry=prtInterpreterEntry, prtAlertTrainingLevel=prtAlertTrainingLevel, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtMarkerColorantRole=prtMarkerColorantRole, prtLocalizationTable=prtLocalizationTable, printerV2Alert=printerV2Alert, prtMarkerEntry=prtMarkerEntry, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtInputModel=prtInputModel, prtOutputCapacityUnit=prtOutputCapacityUnit, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtMarkerMarkTech=prtMarkerMarkTech, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtLocalizationEntry=prtLocalizationEntry, prtInputMediaWeight=prtInputMediaWeight, prtInputMediaFormParts=prtInputMediaFormParts, prtAlertLocation=prtAlertLocation, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtCoverTable=prtCoverTable, prtInputEntry=prtInputEntry, prtInterpreterLangLevel=prtInterpreterLangLevel, prtMediaPathIndex=prtMediaPathIndex, prtInterpreterLangVersion=prtInterpreterLangVersion, prtChannelStatus=prtChannelStatus, prtAlertTableGroup=prtAlertTableGroup, prtCoverEntry=prtCoverEntry, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtConsoleLightTable=prtConsoleLightTable, prtMarkerProcessColorants=prtMarkerProcessColorants, prtMediaPathType=prtMediaPathType, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtInputMediaName=prtInputMediaName, prtMarkerIndex=prtMarkerIndex, prtMediaPathStatus=prtMediaPathStatus, prtMarkerWestMargin=prtMarkerWestMargin, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtOutputDescription=prtOutputDescription, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtOutputName=prtOutputName, prtMarkerColorantTable=prtMarkerColorantTable, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtMarkerEastMargin=prtMarkerEastMargin, prtOutputStatus=prtOutputStatus, prtDeviceRefTable=prtDeviceRefTable, CodedCharSet=CodedCharSet, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtGeneralEntry=prtGeneralEntry, prtInterpreter=prtInterpreter, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtMarkerSupplies=prtMarkerSupplies, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtGeneralPrinterName=prtGeneralPrinterName, prtChannelIndex=prtChannelIndex, prtInterpreterIndex=prtInterpreterIndex)
mibBuilder.exportSymbols("Printer-MIB", prtGeneralConfigChanges=prtGeneralConfigChanges, prtOutputVersion=prtOutputVersion, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtGeneralTable=prtGeneralTable)
