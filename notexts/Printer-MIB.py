...
PrtMarkerMarkTechTC, PrtInterpreterLangFamilyTC, PrtConsoleColorTC, PrtGeneralResetTC, PrtAlertGroupTC, PrtMediaPathTypeTC, PrtMarkerSuppliesTypeTC, PrtAlertTrainingLevelTC, PrtOutputTypeTC, PrtConsoleDisableTC, PrtAlertCodeTC, PrtInputTypeTC, PrtChannelTypeTC, PrtCoverStatusTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtMarkerMarkTechTC", "PrtInterpreterLangFamilyTC", "PrtConsoleColorTC", "PrtGeneralResetTC", "PrtAlertGroupTC", "PrtMediaPathTypeTC", "PrtMarkerSuppliesTypeTC", "PrtAlertTrainingLevelTC", "PrtOutputTypeTC", "PrtConsoleDisableTC", "PrtAlertCodeTC", "PrtInputTypeTC", "PrtChannelTypeTC", "PrtCoverStatusTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtAlertTableV2Group=prtAlertTableV2Group, prtInterpreterEntry=prtInterpreterEntry, prtMediaPathDescription=prtMediaPathDescription, prtConsoleGroup=prtConsoleGroup, prtAlertTable=prtAlertTable, prtOutputDimUnit=prtOutputDimUnit, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtInputMediaName=prtInputMediaName, prtInputSecurity=prtInputSecurity, prtInputDimUnit=prtInputDimUnit, prtInputVendorName=prtInputVendorName, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtInterpreterLangVersion=prtInterpreterLangVersion, prtMIBConformance=prtMIBConformance, printmib=printmib, prtInputEntry=prtInputEntry, prtOutputIndex=prtOutputIndex, prtOutputCapacityUnit=prtOutputCapacityUnit, prtMarkerMarkTech=prtMarkerMarkTech, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtMediaPathType=prtMediaPathType, prtChannelProtocolVersion=prtChannelProtocolVersion, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtAlertGroup=prtAlertGroup, prtMarkerCounterUnit=prtMarkerCounterUnit, prtMarkerSouthMargin=prtMarkerSouthMargin, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtInputVersion=prtInputVersion, prtOutputStackingOrder=prtOutputStackingOrder, prtAlertCriticalEvents=prtAlertCriticalEvents, prtMarkerStatus=prtMarkerStatus, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtAlertCode=prtAlertCode, prtConsoleLights=prtConsoleLights, printerV1Alert=printerV1Alert, prtAlertDescription=prtAlertDescription, prtChannelTable=prtChannelTable, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtInputMediaWeight=prtInputMediaWeight, CapacityUnit=CapacityUnit, prtInterpreterDescription=prtInterpreterDescription, prtOutputDescription=prtOutputDescription, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtInputType=prtInputType, prtOutputEntry=prtOutputEntry, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtGeneral=prtGeneral, prtGeneralReset=prtGeneralReset, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtAlertTimeGroup=prtAlertTimeGroup, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtAlertIndex=prtAlertIndex, prtStorageRefIndex=prtStorageRefIndex, prtStorageRefTable=prtStorageRefTable, prtOutputGroup=prtOutputGroup, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtConsoleOnTime=prtConsoleOnTime, prtInterpreterLangFamily=prtInterpreterLangFamily, prtLocalizationIndex=prtLocalizationIndex, prtExtendedOutputGroup=prtExtendedOutputGroup, PresentOnOff=PresentOnOff, prtChannelEntry=prtChannelEntry, prtInputCapacityUnit=prtInputCapacityUnit, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtMarkerGroup=prtMarkerGroup, prtInterpreterTwoWay=prtInterpreterTwoWay, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, CodedCharSet=CodedCharSet, prtInputNextIndex=prtInputNextIndex, prtMediaPathIndex=prtMediaPathIndex, prtOutputSerialNumber=prtOutputSerialNumber, PrtChannelStateTC=PrtChannelStateTC, prtChannelType=prtChannelType, prtMediaPathGroup=prtMediaPathGroup, prtChannelGroup=prtChannelGroup, prtConsoleLocalization=prtConsoleLocalization, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtInputMediaColor=prtInputMediaColor, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtMarkerColorantRole=prtMarkerColorantRole, prtMediaPath=prtMediaPath, prtInputModel=prtInputModel, prtInterpreter=prtInterpreter, prtMarkerColorantEntry=prtMarkerColorantEntry, printerV2Alert=printerV2Alert, prtInputDefaultIndex=prtInputDefaultIndex, prtMIBCompliance=prtMIBCompliance, prtMarkerProcessColorants=prtMarkerProcessColorants, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtChannelIfIndex=prtChannelIfIndex, prtCoverDescription=prtCoverDescription, prtOutputOffsetStacking=prtOutputOffsetStacking, prtMIB2Groups=prtMIB2Groups, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtGeneralSerialNumber=prtGeneralSerialNumber, prtCoverTable=prtCoverTable, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtChannelState=prtChannelState, prtAlertTime=prtAlertTime, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtCover=prtCover, PYSNMP_MODULE_ID=printmib, prtInputSwitchingGroup=prtInputSwitchingGroup, prtDeviceRefIndex=prtDeviceRefIndex, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtOutputStatus=prtOutputStatus, prtOutputDecollating=prtOutputDecollating, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtMarkerColorantGroup=prtMarkerColorantGroup, prtInputSerialNumber=prtInputSerialNumber, prtAlert=prtAlert, prtMarkerNorthMargin=prtMarkerNorthMargin, prtMarkerColorantValue=prtMarkerColorantValue, prtMarkerSpotColorants=prtMarkerSpotColorants, prtConsoleLightEntry=prtConsoleLightEntry, prtConsoleOffTime=prtConsoleOffTime, prtLocalizationTable=prtLocalizationTable, prtChannelInformation=prtChannelInformation, prtMarker=prtMarker, prtMarkerColorantTable=prtMarkerColorantTable, prtAlertGroupIndex=prtAlertGroupIndex, prtMIB2Compliance=prtMIB2Compliance, prtMarkerEntry=prtMarkerEntry, prtAlertTrapGroup=prtAlertTrapGroup, prtDeviceRefEntry=prtDeviceRefEntry, PrtMediaUnitTC=PrtMediaUnitTC, prtInputCurrentLevel=prtInputCurrentLevel, prtOutputTable=prtOutputTable, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtConsoleColor=prtConsoleColor, SubUnitStatus=SubUnitStatus, prtInputStatus=prtInputStatus, prtGeneralServicePerson=prtGeneralServicePerson, prtInputName=prtInputName, prtInputMediaFormParts=prtInputMediaFormParts, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtMarkerColorant=prtMarkerColorant, prtMediaPathTable=prtMediaPathTable, prtMarkerSuppliesType=prtMarkerSuppliesType, prtInterpreterIndex=prtInterpreterIndex, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtStorageRefEntry=prtStorageRefEntry, prtMarkerColorantTonality=prtMarkerColorantTonality, prtLocalizationLanguage=prtLocalizationLanguage, prtCoverEntry=prtCoverEntry, prtMediaPathStatus=prtMediaPathStatus, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtMIBGroups=prtMIBGroups, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtLocalizationEntry=prtLocalizationEntry, prtOutputModel=prtOutputModel, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, PrtCapacityUnitTC=PrtCapacityUnitTC, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtMarkerColorantIndex=prtMarkerColorantIndex, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtOutputName=prtOutputName, printerV2AlertPrefix=printerV2AlertPrefix, prtAlertTableGroup=prtAlertTableGroup, prtInterpreterTable=prtInterpreterTable, prtGeneralConfigChanges=prtGeneralConfigChanges, prtInterpreterLangLevel=prtInterpreterLangLevel, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtChannelIndex=prtChannelIndex, prtChannel=prtChannel, prtLocalizationCountry=prtLocalizationCountry, prtInputDescription=prtInputDescription, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtDeviceRefTable=prtDeviceRefTable, prtConsoleDisable=prtConsoleDisable, prtOutput=prtOutput, prtOutputVersion=prtOutputVersion, prtChannelV2Group=prtChannelV2Group, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtOutputVendorName=prtOutputVendorName, prtLocalization=prtLocalization, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtConsoleLightTable=prtConsoleLightTable, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtMarkerTable=prtMarkerTable, prtInput=prtInput, prtInputMediaGroup=prtInputMediaGroup, prtOutputBursting=prtOutputBursting, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtAlertSeverityLevel=prtAlertSeverityLevel, prtExtendedInputGroup=prtExtendedInputGroup, prtInputMediaType=prtInputMediaType, prtAlertLocation=prtAlertLocation, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtInputMaxCapacity=prtInputMaxCapacity, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtGeneralEntry=prtGeneralEntry, prtOutputType=prtOutputType, prtOutputPageCollated=prtOutputPageCollated, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, PrtPrintOrientationTC=PrtPrintOrientationTC, MediaUnit=MediaUnit, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtMarkerIndex=prtMarkerIndex, prtOutputMaxCapacity=prtOutputMaxCapacity, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtOutputSecurity=prtOutputSecurity, prtMarkerEastMargin=prtMarkerEastMargin, prtMediaPathEntry=prtMediaPathEntry, prtMarkerSupplies=prtMarkerSupplies, prtGeneralTable=prtGeneralTable, prtConsoleDescription=prtConsoleDescription, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtOutputDefaultIndex=prtOutputDefaultIndex, prtCoverIndex=prtCoverIndex, prtInputTable=prtInputTable, prtCoverStatus=prtCoverStatus, prtInterpreterVersion=prtInterpreterVersion, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtInputIndex=prtInputIndex, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtAlertEntry=prtAlertEntry, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtMarkerLifeCount=prtMarkerLifeCount, prtAlertTrainingLevel=prtAlertTrainingLevel, prtInputGroup=prtInputGroup, prtConsoleLightIndex=prtConsoleLightIndex, prtInterpreterGroup=prtInterpreterGroup, prtChannelStatus=prtChannelStatus, prtGeneralPrinterName=prtGeneralPrinterName, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtGeneralV2Group=prtGeneralV2Group, prtMarkerSuppliesClass=prtMarkerSuppliesClass)
mibBuilder.exportSymbols("Printer-MIB", PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtAlertAllEvents=prtAlertAllEvents, prtGeneralGroup=prtGeneralGroup, prtMarkerWestMargin=prtMarkerWestMargin)
