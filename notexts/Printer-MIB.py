...
PrtMarkerSuppliesTypeTC, PrtInputTypeTC, PrtMediaPathTypeTC, PrtAlertCodeTC, PrtChannelTypeTC, PrtOutputTypeTC, PrtInterpreterLangFamilyTC, PrtMarkerMarkTechTC, PrtGeneralResetTC, PrtConsoleDisableTC, PrtCoverStatusTC, PrtAlertTrainingLevelTC, PrtAlertGroupTC, PrtConsoleColorTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtMarkerSuppliesTypeTC", "PrtInputTypeTC", "PrtMediaPathTypeTC", "PrtAlertCodeTC", "PrtChannelTypeTC", "PrtOutputTypeTC", "PrtInterpreterLangFamilyTC", "PrtMarkerMarkTechTC", "PrtGeneralResetTC", "PrtConsoleDisableTC", "PrtCoverStatusTC", "PrtAlertTrainingLevelTC", "PrtAlertGroupTC", "PrtConsoleColorTC")
...
mibBuilder.exportSymbols("Printer-MIB", PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtLocalizationCountry=prtLocalizationCountry, prtOutputStackingOrder=prtOutputStackingOrder, prtInterpreter=prtInterpreter, prtChannelState=prtChannelState, prtInterpreterIndex=prtInterpreterIndex, prtInputDefaultIndex=prtInputDefaultIndex, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtInputVendorName=prtInputVendorName, prtInputTable=prtInputTable, prtInputType=prtInputType, prtMarkerEntry=prtMarkerEntry, prtMediaPathGroup=prtMediaPathGroup, prtMarkerMarkTech=prtMarkerMarkTech, prtMarkerColorantTonality=prtMarkerColorantTonality, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtChannelEntry=prtChannelEntry, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtOutput=prtOutput, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtMIBCompliance=prtMIBCompliance, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtLocalization=prtLocalization, prtMarkerSupplies=prtMarkerSupplies, prtMarkerEastMargin=prtMarkerEastMargin, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtMIBGroups=prtMIBGroups, prtCoverIndex=prtCoverIndex, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtInputSecurity=prtInputSecurity, prtAlertTrainingLevel=prtAlertTrainingLevel, prtOutputBursting=prtOutputBursting, prtMarker=prtMarker, prtAlertTrapGroup=prtAlertTrapGroup, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtCoverDescription=prtCoverDescription, prtMarkerSuppliesType=prtMarkerSuppliesType, prtOutputVendorName=prtOutputVendorName, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtInputEntry=prtInputEntry, prtOutputCapacityUnit=prtOutputCapacityUnit, prtCoverEntry=prtCoverEntry, CapacityUnit=CapacityUnit, prtConsoleLights=prtConsoleLights, prtInputCapacityUnit=prtInputCapacityUnit, prtChannelType=prtChannelType, prtAlertCode=prtAlertCode, PrtMediaUnitTC=PrtMediaUnitTC, prtInputMediaName=prtInputMediaName, prtAlertCriticalEvents=prtAlertCriticalEvents, prtDeviceRefIndex=prtDeviceRefIndex, prtMarkerColorant=prtMarkerColorant, SubUnitStatus=SubUnitStatus, prtStorageRefIndex=prtStorageRefIndex, prtChannelIfIndex=prtChannelIfIndex, prtGeneralGroup=prtGeneralGroup, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtInputIndex=prtInputIndex, prtConsoleLocalization=prtConsoleLocalization, prtOutputOffsetStacking=prtOutputOffsetStacking, prtAlertTableGroup=prtAlertTableGroup, prtLocalizationTable=prtLocalizationTable, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtGeneralV2Group=prtGeneralV2Group, MediaUnit=MediaUnit, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtInputMaxCapacity=prtInputMaxCapacity, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, PYSNMP_MODULE_ID=printmib, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtOutputEntry=prtOutputEntry, prtOutputStatus=prtOutputStatus, prtMarkerColorantValue=prtMarkerColorantValue, prtChannelTable=prtChannelTable, prtGeneralReset=prtGeneralReset, prtAlertGroup=prtAlertGroup, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtOutputType=prtOutputType, prtAlertLocation=prtAlertLocation, prtResponsiblePartyGroup=prtResponsiblePartyGroup, PrtCapacityUnitTC=PrtCapacityUnitTC, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtOutputGroup=prtOutputGroup, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtDeviceRefEntry=prtDeviceRefEntry, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtInputDescription=prtInputDescription, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtMarkerWestMargin=prtMarkerWestMargin, prtChannelProtocolVersion=prtChannelProtocolVersion, prtExtendedInputGroup=prtExtendedInputGroup, prtOutputTable=prtOutputTable, prtCover=prtCover, prtInputCurrentLevel=prtInputCurrentLevel, prtMediaPathDescription=prtMediaPathDescription, prtChannelIndex=prtChannelIndex, prtMarkerColorantEntry=prtMarkerColorantEntry, prtConsoleColor=prtConsoleColor, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtConsoleLightEntry=prtConsoleLightEntry, prtInput=prtInput, prtInterpreterTwoWay=prtInterpreterTwoWay, prtAlertDescription=prtAlertDescription, prtMarkerLifeCount=prtMarkerLifeCount, prtGeneral=prtGeneral, prtInputMediaGroup=prtInputMediaGroup, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtMIB2Compliance=prtMIB2Compliance, printmib=printmib, prtInputSwitchingGroup=prtInputSwitchingGroup, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtMarkerStatus=prtMarkerStatus, prtAlertTime=prtAlertTime, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtOutputDefaultIndex=prtOutputDefaultIndex, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtInterpreterGroup=prtInterpreterGroup, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtMarkerGroup=prtMarkerGroup, prtGeneralEntry=prtGeneralEntry, prtConsoleDisable=prtConsoleDisable, prtLocalizationEntry=prtLocalizationEntry, prtOutputName=prtOutputName, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtDeviceRefTable=prtDeviceRefTable, prtInterpreterLangVersion=prtInterpreterLangVersion, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtConsoleOnTime=prtConsoleOnTime, prtOutputMaxCapacity=prtOutputMaxCapacity, prtAlertTable=prtAlertTable, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtAlert=prtAlert, prtMarkerIndex=prtMarkerIndex, prtMarkerNorthMargin=prtMarkerNorthMargin, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtCoverStatus=prtCoverStatus, prtInterpreterEntry=prtInterpreterEntry, prtMarkerTable=prtMarkerTable, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtMediaPath=prtMediaPath, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtMIB2Groups=prtMIB2Groups, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtOutputVersion=prtOutputVersion, prtGeneralTable=prtGeneralTable, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtInputNextIndex=prtInputNextIndex, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtMarkerSouthMargin=prtMarkerSouthMargin, prtLocalizationLanguage=prtLocalizationLanguage, prtOutputSecurity=prtOutputSecurity, prtMarkerSpotColorants=prtMarkerSpotColorants, prtConsoleLightTable=prtConsoleLightTable, prtMIBConformance=prtMIBConformance, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtChannel=prtChannel, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtOutputDimUnit=prtOutputDimUnit, printerV2AlertPrefix=printerV2AlertPrefix, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtMediaPathTable=prtMediaPathTable, prtAlertEntry=prtAlertEntry, prtChannelInformation=prtChannelInformation, prtMediaPathEntry=prtMediaPathEntry, prtInputMediaType=prtInputMediaType, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, printerV1Alert=printerV1Alert, prtConsoleDescription=prtConsoleDescription, prtMarkerColorantGroup=prtMarkerColorantGroup, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtLocalizationIndex=prtLocalizationIndex, prtInputDimUnit=prtInputDimUnit, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtExtendedOutputGroup=prtExtendedOutputGroup, prtAlertIndex=prtAlertIndex, prtMarkerColorantIndex=prtMarkerColorantIndex, prtChannelGroup=prtChannelGroup, prtInterpreterLangLevel=prtInterpreterLangLevel, prtMarkerColorantRole=prtMarkerColorantRole, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, PresentOnOff=PresentOnOff, prtInputModel=prtInputModel, prtGeneralServicePerson=prtGeneralServicePerson, prtInputMediaWeight=prtInputMediaWeight, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtAlertSeverityLevel=prtAlertSeverityLevel, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtStorageRefEntry=prtStorageRefEntry, prtInputSerialNumber=prtInputSerialNumber, prtConsoleLightIndex=prtConsoleLightIndex, prtConsoleGroup=prtConsoleGroup, prtInputStatus=prtInputStatus, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtInterpreterTable=prtInterpreterTable, prtMediaPathStatus=prtMediaPathStatus, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtChannelV2Group=prtChannelV2Group, prtConsoleOffTime=prtConsoleOffTime, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtAlertAllEvents=prtAlertAllEvents, prtInputName=prtInputName, prtAlertGroupIndex=prtAlertGroupIndex, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtOutputIndex=prtOutputIndex, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtMediaPathType=prtMediaPathType, prtInputMediaFormParts=prtInputMediaFormParts, prtMarkerColorantTable=prtMarkerColorantTable, prtOutputSerialNumber=prtOutputSerialNumber, prtOutputDescription=prtOutputDescription, prtStorageRefTable=prtStorageRefTable, prtInterpreterLangFamily=prtInterpreterLangFamily, prtAlertTableV2Group=prtAlertTableV2Group, prtAlertTimeGroup=prtAlertTimeGroup, prtMarkerCounterUnit=prtMarkerCounterUnit, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtCoverTable=prtCoverTable, prtInputVersion=prtInputVersion, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtGeneralConfigChanges=prtGeneralConfigChanges, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, PrtChannelStateTC=PrtChannelStateTC, CodedCharSet=CodedCharSet, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, PrtPrintOrientationTC=PrtPrintOrientationTC, prtOutputDecollating=prtOutputDecollating, prtInputMediaColor=prtInputMediaColor, prtInterpreterDescription=prtInterpreterDescription, prtGeneralPrinterName=prtGeneralPrinterName, prtMarkerProcessColorants=prtMarkerProcessColorants, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtGeneralSerialNumber=prtGeneralSerialNumber, prtChannelStatus=prtChannelStatus, prtInterpreterVersion=prtInterpreterVersion, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtOutputModel=prtOutputModel, printerV2Alert=printerV2Alert)
mibBuilder.exportSymbols("Printer-MIB", prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtMediaPathIndex=prtMediaPathIndex, prtInputGroup=prtInputGroup, prtOutputPageCollated=prtOutputPageCollated)
