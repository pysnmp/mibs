...
PrtMarkerSuppliesTypeTC, PrtConsoleColorTC, PrtCoverStatusTC, PrtGeneralResetTC, PrtMarkerMarkTechTC, PrtInputTypeTC, PrtConsoleDisableTC, PrtAlertGroupTC, PrtInterpreterLangFamilyTC, PrtMediaPathTypeTC, PrtAlertTrainingLevelTC, PrtChannelTypeTC, PrtAlertCodeTC, PrtOutputTypeTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtMarkerSuppliesTypeTC", "PrtConsoleColorTC", "PrtCoverStatusTC", "PrtGeneralResetTC", "PrtMarkerMarkTechTC", "PrtInputTypeTC", "PrtConsoleDisableTC", "PrtAlertGroupTC", "PrtInterpreterLangFamilyTC", "PrtMediaPathTypeTC", "PrtAlertTrainingLevelTC", "PrtChannelTypeTC", "PrtAlertCodeTC", "PrtOutputTypeTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, SubUnitStatus=SubUnitStatus, printerV2Alert=printerV2Alert, prtMarkerColorantTonality=prtMarkerColorantTonality, prtOutputPageCollated=prtOutputPageCollated, prtAlertTableGroup=prtAlertTableGroup, prtInputDimUnit=prtInputDimUnit, prtOutputSecurity=prtOutputSecurity, prtOutputModel=prtOutputModel, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtMediaPath=prtMediaPath, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtGeneralConfigChanges=prtGeneralConfigChanges, prtCoverStatus=prtCoverStatus, prtInputMediaColor=prtInputMediaColor, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtAlertTrapGroup=prtAlertTrapGroup, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtChannelV2Group=prtChannelV2Group, printerV1Alert=printerV1Alert, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtAlertTimeGroup=prtAlertTimeGroup, CapacityUnit=CapacityUnit, prtMarkerSouthMargin=prtMarkerSouthMargin, prtInterpreterLangVersion=prtInterpreterLangVersion, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtOutputSerialNumber=prtOutputSerialNumber, prtAlertIndex=prtAlertIndex, prtMIB2Compliance=prtMIB2Compliance, prtOutputStatus=prtOutputStatus, prtInputCurrentLevel=prtInputCurrentLevel, prtInterpreterTwoWay=prtInterpreterTwoWay, prtInput=prtInput, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtConsoleLocalization=prtConsoleLocalization, prtInputIndex=prtInputIndex, prtGeneralCurrentOperator=prtGeneralCurrentOperator, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtOutputVersion=prtOutputVersion, prtMarkerCounterUnit=prtMarkerCounterUnit, prtMarkerProcessColorants=prtMarkerProcessColorants, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtAlertSeverityLevel=prtAlertSeverityLevel, prtOutputGroup=prtOutputGroup, prtChannelGroup=prtChannelGroup, CodedCharSet=CodedCharSet, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtInputMediaWeight=prtInputMediaWeight, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtInputMediaFormParts=prtInputMediaFormParts, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtOutputBursting=prtOutputBursting, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtChannelInformation=prtChannelInformation, prtMIB2Groups=prtMIB2Groups, prtStorageRefIndex=prtStorageRefIndex, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtLocalizationIndex=prtLocalizationIndex, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtMarkerColorant=prtMarkerColorant, prtChannelIfIndex=prtChannelIfIndex, prtInputGroup=prtInputGroup, prtAlertLocation=prtAlertLocation, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtOutputMaxCapacity=prtOutputMaxCapacity, prtConsoleLightIndex=prtConsoleLightIndex, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtInterpreter=prtInterpreter, prtOutputVendorName=prtOutputVendorName, prtConsoleGroup=prtConsoleGroup, prtMediaPathDescription=prtMediaPathDescription, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtAlertTime=prtAlertTime, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtInputModel=prtInputModel, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtInterpreterGroup=prtInterpreterGroup, prtInputTable=prtInputTable, prtGeneralReset=prtGeneralReset, prtOutput=prtOutput, prtMarkerColorantEntry=prtMarkerColorantEntry, prtOutputEntry=prtOutputEntry, prtCoverEntry=prtCoverEntry, PrtChannelStateTC=PrtChannelStateTC, prtInputMediaName=prtInputMediaName, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtMarkerWestMargin=prtMarkerWestMargin, prtMarkerSuppliesType=prtMarkerSuppliesType, prtLocalizationLanguage=prtLocalizationLanguage, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtGeneralServicePerson=prtGeneralServicePerson, prtDeviceRefEntry=prtDeviceRefEntry, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtOutputDecollating=prtOutputDecollating, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtOutputCapacityUnit=prtOutputCapacityUnit, prtChannelTable=prtChannelTable, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtOutputStackingOrder=prtOutputStackingOrder, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtChannelEntry=prtChannelEntry, prtMarkerNorthMargin=prtMarkerNorthMargin, prtChannelIndex=prtChannelIndex, prtInputVersion=prtInputVersion, prtConsoleLights=prtConsoleLights, MediaUnit=MediaUnit, prtInputStatus=prtInputStatus, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtAlertCriticalEvents=prtAlertCriticalEvents, prtMarkerLifeCount=prtMarkerLifeCount, prtConsoleOffTime=prtConsoleOffTime, prtInterpreterEntry=prtInterpreterEntry, prtInputMediaType=prtInputMediaType, prtExtendedOutputGroup=prtExtendedOutputGroup, PrtPrintOrientationTC=PrtPrintOrientationTC, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtDeviceRefIndex=prtDeviceRefIndex, prtLocalizationTable=prtLocalizationTable, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtAlertGroupIndex=prtAlertGroupIndex, prtOutputDimUnit=prtOutputDimUnit, prtCoverTable=prtCoverTable, prtAlertDescription=prtAlertDescription, prtInterpreterIndex=prtInterpreterIndex, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtGeneralTable=prtGeneralTable, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtConsoleDescription=prtConsoleDescription, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtOutputType=prtOutputType, prtGeneral=prtGeneral, prtMarkerIndex=prtMarkerIndex, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtMediaPathGroup=prtMediaPathGroup, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtConsoleLightEntry=prtConsoleLightEntry, prtMarkerColorantValue=prtMarkerColorantValue, prtMarkerSupplies=prtMarkerSupplies, prtChannelType=prtChannelType, prtCover=prtCover, prtAlertGroup=prtAlertGroup, PrtCapacityUnitTC=PrtCapacityUnitTC, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtLocalization=prtLocalization, PrtMediaUnitTC=PrtMediaUnitTC, prtChannelState=prtChannelState, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtGeneralV2Group=prtGeneralV2Group, prtChannelStatus=prtChannelStatus, prtMarkerColorantIndex=prtMarkerColorantIndex, prtOutputName=prtOutputName, prtChannel=prtChannel, prtAlertAllEvents=prtAlertAllEvents, prtInputDescription=prtInputDescription, prtAlertTableV2Group=prtAlertTableV2Group, prtCoverDescription=prtCoverDescription, prtOutputDescription=prtOutputDescription, prtGeneralPrinterName=prtGeneralPrinterName, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtInterpreterDescription=prtInterpreterDescription, prtConsoleOnTime=prtConsoleOnTime, prtInputMediaGroup=prtInputMediaGroup, printmib=printmib, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtMediaPathType=prtMediaPathType, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtAlertTrainingLevel=prtAlertTrainingLevel, prtGeneralSerialNumber=prtGeneralSerialNumber, prtStorageRefTable=prtStorageRefTable, prtInputType=prtInputType, prtInputCapacityUnit=prtInputCapacityUnit, printerV2AlertPrefix=printerV2AlertPrefix, prtMIBGroups=prtMIBGroups, prtInputNextIndex=prtInputNextIndex, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, PresentOnOff=PresentOnOff, prtMarkerStatus=prtMarkerStatus, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtDeviceRefTable=prtDeviceRefTable, prtMIBConformance=prtMIBConformance, prtCoverIndex=prtCoverIndex, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtStorageRefEntry=prtStorageRefEntry, prtInputSwitchingGroup=prtInputSwitchingGroup, prtOutputDefaultIndex=prtOutputDefaultIndex, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, PYSNMP_MODULE_ID=printmib, prtGeneralGroup=prtGeneralGroup, prtExtendedInputGroup=prtExtendedInputGroup, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtOutputTable=prtOutputTable, prtMarkerSpotColorants=prtMarkerSpotColorants, prtChannelProtocolVersion=prtChannelProtocolVersion, prtOutputIndex=prtOutputIndex, prtMIBCompliance=prtMIBCompliance, prtMarkerColorantTable=prtMarkerColorantTable, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtConsoleLightTable=prtConsoleLightTable, prtMarkerTable=prtMarkerTable, prtInputMaxCapacity=prtInputMaxCapacity, prtOutputOffsetStacking=prtOutputOffsetStacking, prtMarker=prtMarker, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtInterpreterLangFamily=prtInterpreterLangFamily, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtInputName=prtInputName, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtAlertEntry=prtAlertEntry, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtGeneralEntry=prtGeneralEntry, prtLocalizationEntry=prtLocalizationEntry, prtMediaPathIndex=prtMediaPathIndex, prtInterpreterVersion=prtInterpreterVersion, prtAlertCode=prtAlertCode, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtAlertTable=prtAlertTable, prtMarkerGroup=prtMarkerGroup, prtAlert=prtAlert, prtInputDefaultIndex=prtInputDefaultIndex, prtMarkerMarkTech=prtMarkerMarkTech, prtMediaPathEntry=prtMediaPathEntry, prtConsoleColor=prtConsoleColor, prtMarkerColorantGroup=prtMarkerColorantGroup, prtInputEntry=prtInputEntry, prtMediaPathStatus=prtMediaPathStatus, prtInterpreterLangLevel=prtInterpreterLangLevel, prtInputSecurity=prtInputSecurity, prtMarkerEastMargin=prtMarkerEastMargin, prtInterpreterTable=prtInterpreterTable, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtInputVendorName=prtInputVendorName, prtMarkerColorantRole=prtMarkerColorantRole, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtMarkerEntry=prtMarkerEntry, prtConsoleDisable=prtConsoleDisable)
mibBuilder.exportSymbols("Printer-MIB", prtInputSerialNumber=prtInputSerialNumber, prtMediaPathTable=prtMediaPathTable, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtLocalizationCountry=prtLocalizationCountry)
