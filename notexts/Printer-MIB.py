...
PrtOutputTypeTC, PrtCoverStatusTC, PrtChannelTypeTC, PrtGeneralResetTC, PrtMediaPathTypeTC, PrtInterpreterLangFamilyTC, PrtMarkerSuppliesTypeTC, PrtAlertTrainingLevelTC, PrtMarkerMarkTechTC, PrtAlertGroupTC, PrtAlertCodeTC, PrtInputTypeTC, PrtConsoleDisableTC, PrtConsoleColorTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtOutputTypeTC", "PrtCoverStatusTC", "PrtChannelTypeTC", "PrtGeneralResetTC", "PrtMediaPathTypeTC", "PrtInterpreterLangFamilyTC", "PrtMarkerSuppliesTypeTC", "PrtAlertTrainingLevelTC", "PrtMarkerMarkTechTC", "PrtAlertGroupTC", "PrtAlertCodeTC", "PrtInputTypeTC", "PrtConsoleDisableTC", "PrtConsoleColorTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtMarkerGroup=prtMarkerGroup, prtStorageRefTable=prtStorageRefTable, prtInputMediaType=prtInputMediaType, prtMarkerMarkTech=prtMarkerMarkTech, prtGeneralReset=prtGeneralReset, prtGeneralPrinterName=prtGeneralPrinterName, prtLocalizationIndex=prtLocalizationIndex, prtInterpreterLangFamily=prtInterpreterLangFamily, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtMarkerEastMargin=prtMarkerEastMargin, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtInputCapacityUnit=prtInputCapacityUnit, prtOutputVendorName=prtOutputVendorName, prtMarkerTable=prtMarkerTable, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtMarkerSpotColorants=prtMarkerSpotColorants, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtMediaPathDescription=prtMediaPathDescription, prtGeneralGroup=prtGeneralGroup, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, SubUnitStatus=SubUnitStatus, prtOutputDefaultIndex=prtOutputDefaultIndex, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtMediaPathTable=prtMediaPathTable, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, printmib=printmib, prtChannelType=prtChannelType, prtInterpreterLangVersion=prtInterpreterLangVersion, prtConsoleLightIndex=prtConsoleLightIndex, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtLocalization=prtLocalization, prtChannel=prtChannel, prtMediaPathStatus=prtMediaPathStatus, prtOutputCapacityUnit=prtOutputCapacityUnit, CapacityUnit=CapacityUnit, prtAlertTableGroup=prtAlertTableGroup, prtChannelV2Group=prtChannelV2Group, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtAlertTrapGroup=prtAlertTrapGroup, prtAlertLocation=prtAlertLocation, prtMediaPathGroup=prtMediaPathGroup, prtInputNextIndex=prtInputNextIndex, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtMediaPathEntry=prtMediaPathEntry, prtAlertTableV2Group=prtAlertTableV2Group, prtAlertSeverityLevel=prtAlertSeverityLevel, prtInterpreterEntry=prtInterpreterEntry, prtChannelState=prtChannelState, prtOutputEntry=prtOutputEntry, prtChannelGroup=prtChannelGroup, prtInput=prtInput, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtOutputGroup=prtOutputGroup, prtInputVersion=prtInputVersion, prtInputIndex=prtInputIndex, prtGeneral=prtGeneral, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtStorageRefIndex=prtStorageRefIndex, prtInputSecurity=prtInputSecurity, prtOutputSecurity=prtOutputSecurity, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtConsoleLights=prtConsoleLights, prtInterpreterLangLevel=prtInterpreterLangLevel, prtConsoleLightEntry=prtConsoleLightEntry, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtConsoleLightTable=prtConsoleLightTable, prtAlertIndex=prtAlertIndex, prtMarkerCounterUnit=prtMarkerCounterUnit, prtCoverTable=prtCoverTable, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtMIBGroups=prtMIBGroups, prtGeneralTable=prtGeneralTable, prtChannelProtocolVersion=prtChannelProtocolVersion, prtMarkerColorantGroup=prtMarkerColorantGroup, prtConsoleColor=prtConsoleColor, prtOutputName=prtOutputName, PrtChannelStateTC=PrtChannelStateTC, prtConsoleOffTime=prtConsoleOffTime, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtDeviceRefTable=prtDeviceRefTable, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtInterpreter=prtInterpreter, prtInputModel=prtInputModel, prtAlertTime=prtAlertTime, prtInputMediaWeight=prtInputMediaWeight, prtOutput=prtOutput, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtDeviceRefEntry=prtDeviceRefEntry, prtConsoleOnTime=prtConsoleOnTime, prtInputName=prtInputName, prtCover=prtCover, prtInputMediaFormParts=prtInputMediaFormParts, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, PrtMediaUnitTC=PrtMediaUnitTC, prtMediaPath=prtMediaPath, prtInterpreterTable=prtInterpreterTable, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtAlertCode=prtAlertCode, prtMediaPathType=prtMediaPathType, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtChannelInformation=prtChannelInformation, prtAlert=prtAlert, prtMIBConformance=prtMIBConformance, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtMarkerWestMargin=prtMarkerWestMargin, prtInterpreterVersion=prtInterpreterVersion, prtOutputDecollating=prtOutputDecollating, prtMarkerNorthMargin=prtMarkerNorthMargin, prtCoverStatus=prtCoverStatus, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtInputStatus=prtInputStatus, prtCoverIndex=prtCoverIndex, PYSNMP_MODULE_ID=printmib, PrtCapacityUnitTC=PrtCapacityUnitTC, prtInputMediaName=prtInputMediaName, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtOutputType=prtOutputType, prtOutputStatus=prtOutputStatus, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtOutputModel=prtOutputModel, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtAlertTable=prtAlertTable, prtOutputDimUnit=prtOutputDimUnit, MediaUnit=MediaUnit, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtChannelIfIndex=prtChannelIfIndex, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtInputTable=prtInputTable, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtAlertTrainingLevel=prtAlertTrainingLevel, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtAlertDescription=prtAlertDescription, prtOutputBursting=prtOutputBursting, prtMarkerColorantIndex=prtMarkerColorantIndex, printerV2AlertPrefix=printerV2AlertPrefix, prtInputVendorName=prtInputVendorName, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtChannelEntry=prtChannelEntry, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtChannelIndex=prtChannelIndex, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtMarkerColorantValue=prtMarkerColorantValue, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtAlertCriticalEvents=prtAlertCriticalEvents, prtMarkerColorantEntry=prtMarkerColorantEntry, prtCoverEntry=prtCoverEntry, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtConsoleDisable=prtConsoleDisable, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtChannelTable=prtChannelTable, prtOutputSerialNumber=prtOutputSerialNumber, prtMarkerColorantTonality=prtMarkerColorantTonality, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtInputCurrentLevel=prtInputCurrentLevel, prtMarkerSupplies=prtMarkerSupplies, prtMarkerColorantTable=prtMarkerColorantTable, prtInputSerialNumber=prtInputSerialNumber, prtExtendedInputGroup=prtExtendedInputGroup, prtLocalizationLanguage=prtLocalizationLanguage, prtInterpreterTwoWay=prtInterpreterTwoWay, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtInputDimUnit=prtInputDimUnit, prtGeneralConfigChanges=prtGeneralConfigChanges, prtInterpreterGroup=prtInterpreterGroup, prtOutputTable=prtOutputTable, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtOutputDescription=prtOutputDescription, prtOutputMaxCapacity=prtOutputMaxCapacity, prtLocalizationCountry=prtLocalizationCountry, prtInputMaxCapacity=prtInputMaxCapacity, printerV2Alert=printerV2Alert, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtGeneralV2Group=prtGeneralV2Group, prtMarkerEntry=prtMarkerEntry, prtChannelStatus=prtChannelStatus, prtMIB2Groups=prtMIB2Groups, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtGeneralServicePerson=prtGeneralServicePerson, prtGeneralSerialNumber=prtGeneralSerialNumber, prtConsoleLocalization=prtConsoleLocalization, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtDeviceRefIndex=prtDeviceRefIndex, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtMarkerProcessColorants=prtMarkerProcessColorants, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtAlertEntry=prtAlertEntry, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtMarkerColorantRole=prtMarkerColorantRole, prtAlertTimeGroup=prtAlertTimeGroup, prtGeneralEntry=prtGeneralEntry, prtInputSwitchingGroup=prtInputSwitchingGroup, prtAlertAllEvents=prtAlertAllEvents, prtOutputPageCollated=prtOutputPageCollated, prtMIB2Compliance=prtMIB2Compliance, prtMarkerColorant=prtMarkerColorant, prtInputEntry=prtInputEntry, prtStorageRefEntry=prtStorageRefEntry, prtOutputVersion=prtOutputVersion, prtCoverDescription=prtCoverDescription, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtInterpreterIndex=prtInterpreterIndex, prtOutputOffsetStacking=prtOutputOffsetStacking, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, printerV1Alert=printerV1Alert, prtConsoleGroup=prtConsoleGroup, prtMarkerLifeCount=prtMarkerLifeCount, prtInputType=prtInputType, prtMarkerSuppliesType=prtMarkerSuppliesType, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtMediaPathIndex=prtMediaPathIndex, prtInputGroup=prtInputGroup, prtOutputIndex=prtOutputIndex, prtLocalizationEntry=prtLocalizationEntry, prtInputMediaColor=prtInputMediaColor, prtOutputStackingOrder=prtOutputStackingOrder, prtMIBCompliance=prtMIBCompliance, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtInterpreterDescription=prtInterpreterDescription, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtMarkerIndex=prtMarkerIndex, prtMarkerSouthMargin=prtMarkerSouthMargin, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, PrtPrintOrientationTC=PrtPrintOrientationTC, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtInputDefaultIndex=prtInputDefaultIndex, prtInputDescription=prtInputDescription, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtConsoleDescription=prtConsoleDescription, prtLocalizationTable=prtLocalizationTable, prtMarker=prtMarker, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtInputMediaGroup=prtInputMediaGroup, CodedCharSet=CodedCharSet, PresentOnOff=PresentOnOff, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtAlertGroupIndex=prtAlertGroupIndex, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir)
mibBuilder.exportSymbols("Printer-MIB", prtExtendedOutputGroup=prtExtendedOutputGroup, prtAlertGroup=prtAlertGroup, prtMarkerStatus=prtMarkerStatus, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC)
