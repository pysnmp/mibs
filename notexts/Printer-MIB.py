...
PrtMarkerSuppliesTypeTC, PrtCoverStatusTC, PrtMediaPathTypeTC, PrtOutputTypeTC, PrtAlertGroupTC, PrtConsoleColorTC, PrtGeneralResetTC, PrtAlertTrainingLevelTC, PrtInterpreterLangFamilyTC, PrtInputTypeTC, PrtAlertCodeTC, PrtChannelTypeTC, PrtMarkerMarkTechTC, PrtConsoleDisableTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtMarkerSuppliesTypeTC", "PrtCoverStatusTC", "PrtMediaPathTypeTC", "PrtOutputTypeTC", "PrtAlertGroupTC", "PrtConsoleColorTC", "PrtGeneralResetTC", "PrtAlertTrainingLevelTC", "PrtInterpreterLangFamilyTC", "PrtInputTypeTC", "PrtAlertCodeTC", "PrtChannelTypeTC", "PrtMarkerMarkTechTC", "PrtConsoleDisableTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtOutputDimUnit=prtOutputDimUnit, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtOutputVersion=prtOutputVersion, prtMediaPathDescription=prtMediaPathDescription, prtOutputSerialNumber=prtOutputSerialNumber, prtInputDescription=prtInputDescription, prtExtendedInputGroup=prtExtendedInputGroup, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtMarkerCounterUnit=prtMarkerCounterUnit, prtMIB2Compliance=prtMIB2Compliance, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtInputVendorName=prtInputVendorName, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtMarkerColorantTable=prtMarkerColorantTable, prtOutputGroup=prtOutputGroup, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtMarkerNorthMargin=prtMarkerNorthMargin, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, PrtChannelStateTC=PrtChannelStateTC, prtMarkerWestMargin=prtMarkerWestMargin, prtMarkerSupplies=prtMarkerSupplies, prtMarkerGroup=prtMarkerGroup, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtInterpreterLangVersion=prtInterpreterLangVersion, prtInputGroup=prtInputGroup, prtConsoleLightIndex=prtConsoleLightIndex, prtChannelGroup=prtChannelGroup, prtStorageRefIndex=prtStorageRefIndex, prtInterpreterGroup=prtInterpreterGroup, prtCover=prtCover, prtGeneral=prtGeneral, prtInputCapacityUnit=prtInputCapacityUnit, prtMediaPath=prtMediaPath, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtChannelProtocolVersion=prtChannelProtocolVersion, prtMarkerIndex=prtMarkerIndex, prtGeneralServicePerson=prtGeneralServicePerson, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtGeneralConfigChanges=prtGeneralConfigChanges, prtOutputName=prtOutputName, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtAlertGroupIndex=prtAlertGroupIndex, prtOutputTable=prtOutputTable, prtChannelIfIndex=prtChannelIfIndex, prtOutputStatus=prtOutputStatus, prtGeneralTable=prtGeneralTable, prtInterpreterTable=prtInterpreterTable, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtInputMediaWeight=prtInputMediaWeight, prtExtendedOutputGroup=prtExtendedOutputGroup, prtAlertTrainingLevel=prtAlertTrainingLevel, prtGeneralV2Group=prtGeneralV2Group, prtMediaPathType=prtMediaPathType, prtMarkerColorantEntry=prtMarkerColorantEntry, prtOutputEntry=prtOutputEntry, prtMarkerColorant=prtMarkerColorant, prtInterpreterIndex=prtInterpreterIndex, prtOutputDecollating=prtOutputDecollating, prtStorageRefEntry=prtStorageRefEntry, prtOutputBursting=prtOutputBursting, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, printmib=printmib, prtDeviceRefTable=prtDeviceRefTable, prtInputMediaColor=prtInputMediaColor, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtInputMediaFormParts=prtInputMediaFormParts, prtGeneralSerialNumber=prtGeneralSerialNumber, prtMarkerColorantIndex=prtMarkerColorantIndex, prtMediaPathGroup=prtMediaPathGroup, prtConsoleOffTime=prtConsoleOffTime, prtOutputType=prtOutputType, prtConsoleLights=prtConsoleLights, prtAlertAllEvents=prtAlertAllEvents, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtOutputDefaultIndex=prtOutputDefaultIndex, prtDeviceRefEntry=prtDeviceRefEntry, prtMarkerTable=prtMarkerTable, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtMarkerSpotColorants=prtMarkerSpotColorants, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, MediaUnit=MediaUnit, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtGeneralEntry=prtGeneralEntry, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtChannelEntry=prtChannelEntry, prtAlertLocation=prtAlertLocation, printerV2Alert=printerV2Alert, prtMediaPathTable=prtMediaPathTable, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtOutputIndex=prtOutputIndex, prtOutputCapacityUnit=prtOutputCapacityUnit, prtAlertEntry=prtAlertEntry, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtInputMediaType=prtInputMediaType, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtMIBCompliance=prtMIBCompliance, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, PYSNMP_MODULE_ID=printmib, prtConsoleGroup=prtConsoleGroup, prtMarkerEastMargin=prtMarkerEastMargin, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtInputName=prtInputName, prtMarkerColorantTonality=prtMarkerColorantTonality, prtMarkerProcessColorants=prtMarkerProcessColorants, prtChannelState=prtChannelState, prtChannelIndex=prtChannelIndex, prtMIBGroups=prtMIBGroups, PresentOnOff=PresentOnOff, PrtMediaUnitTC=PrtMediaUnitTC, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtGeneralGroup=prtGeneralGroup, prtInput=prtInput, prtMIB2Groups=prtMIB2Groups, prtInputSerialNumber=prtInputSerialNumber, prtChannel=prtChannel, prtInterpreterTwoWay=prtInterpreterTwoWay, prtInputMaxCapacity=prtInputMaxCapacity, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtMarker=prtMarker, prtInterpreter=prtInterpreter, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtMarkerLifeCount=prtMarkerLifeCount, prtCoverIndex=prtCoverIndex, prtLocalization=prtLocalization, prtMarkerMarkTech=prtMarkerMarkTech, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtChannelV2Group=prtChannelV2Group, CapacityUnit=CapacityUnit, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtInputSwitchingGroup=prtInputSwitchingGroup, prtCoverTable=prtCoverTable, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtMediaPathIndex=prtMediaPathIndex, prtCoverEntry=prtCoverEntry, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtConsoleLocalization=prtConsoleLocalization, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtAlertSeverityLevel=prtAlertSeverityLevel, prtLocalizationTable=prtLocalizationTable, prtDeviceRefIndex=prtDeviceRefIndex, prtAlertTableGroup=prtAlertTableGroup, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, printerV1Alert=printerV1Alert, prtChannelType=prtChannelType, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, printerV2AlertPrefix=printerV2AlertPrefix, prtInputModel=prtInputModel, prtInputType=prtInputType, prtConsoleDescription=prtConsoleDescription, prtMarkerStatus=prtMarkerStatus, prtInterpreterEntry=prtInterpreterEntry, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtAlertCode=prtAlertCode, prtCoverStatus=prtCoverStatus, prtMediaPathStatus=prtMediaPathStatus, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtChannelStatus=prtChannelStatus, prtOutputModel=prtOutputModel, prtOutputPageCollated=prtOutputPageCollated, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtChannelInformation=prtChannelInformation, prtInputEntry=prtInputEntry, prtAlertTime=prtAlertTime, prtLocalizationLanguage=prtLocalizationLanguage, prtConsoleOnTime=prtConsoleOnTime, prtInterpreterDescription=prtInterpreterDescription, prtInterpreterVersion=prtInterpreterVersion, prtInputVersion=prtInputVersion, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtMarkerColorantGroup=prtMarkerColorantGroup, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtMediaPathEntry=prtMediaPathEntry, prtInterpreterLangLevel=prtInterpreterLangLevel, CodedCharSet=CodedCharSet, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtInputDimUnit=prtInputDimUnit, prtMarkerColorantRole=prtMarkerColorantRole, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtInputCurrentLevel=prtInputCurrentLevel, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, PrtPrintOrientationTC=PrtPrintOrientationTC, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtInputStatus=prtInputStatus, SubUnitStatus=SubUnitStatus, prtConsoleLightEntry=prtConsoleLightEntry, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtOutputMaxCapacity=prtOutputMaxCapacity, prtMarkerEntry=prtMarkerEntry, prtInputTable=prtInputTable, prtLocalizationCountry=prtLocalizationCountry, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtConsoleColor=prtConsoleColor, prtCoverDescription=prtCoverDescription, prtOutputOffsetStacking=prtOutputOffsetStacking, prtInterpreterLangFamily=prtInterpreterLangFamily, prtAlert=prtAlert, prtInputMediaGroup=prtInputMediaGroup, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtAlertTableV2Group=prtAlertTableV2Group, prtAlertTimeGroup=prtAlertTimeGroup, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtOutputDescription=prtOutputDescription, prtConsoleDisable=prtConsoleDisable, PrtCapacityUnitTC=PrtCapacityUnitTC, prtInputDefaultIndex=prtInputDefaultIndex, prtGeneralPrinterName=prtGeneralPrinterName, prtAlertDescription=prtAlertDescription, prtInputMediaName=prtInputMediaName, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtGeneralReset=prtGeneralReset, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtInputSecurity=prtInputSecurity, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtMarkerSouthMargin=prtMarkerSouthMargin, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtInputIndex=prtInputIndex, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtLocalizationEntry=prtLocalizationEntry, prtConsoleLightTable=prtConsoleLightTable, prtMarkerColorantValue=prtMarkerColorantValue, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtChannelTable=prtChannelTable, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtOutput=prtOutput, prtLocalizationIndex=prtLocalizationIndex, prtMIBConformance=prtMIBConformance, prtOutputSecurity=prtOutputSecurity, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtAlertGroup=prtAlertGroup, prtAlertTrapGroup=prtAlertTrapGroup, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtAlertIndex=prtAlertIndex, prtMarkerSuppliesType=prtMarkerSuppliesType, prtInputNextIndex=prtInputNextIndex, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtAlertTable=prtAlertTable, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit)
mibBuilder.exportSymbols("Printer-MIB", prtOutputStackingOrder=prtOutputStackingOrder, prtOutputVendorName=prtOutputVendorName, prtAlertCriticalEvents=prtAlertCriticalEvents, prtStorageRefTable=prtStorageRefTable)
