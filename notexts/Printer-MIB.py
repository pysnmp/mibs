...
PrtChannelTypeTC, PrtMediaPathTypeTC, PrtMarkerMarkTechTC, PrtInputTypeTC, PrtAlertCodeTC, PrtInterpreterLangFamilyTC, PrtMarkerSuppliesTypeTC, PrtGeneralResetTC, PrtOutputTypeTC, PrtAlertGroupTC, PrtCoverStatusTC, PrtAlertTrainingLevelTC, PrtConsoleDisableTC, PrtConsoleColorTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtChannelTypeTC", "PrtMediaPathTypeTC", "PrtMarkerMarkTechTC", "PrtInputTypeTC", "PrtAlertCodeTC", "PrtInterpreterLangFamilyTC", "PrtMarkerSuppliesTypeTC", "PrtGeneralResetTC", "PrtOutputTypeTC", "PrtAlertGroupTC", "PrtCoverStatusTC", "PrtAlertTrainingLevelTC", "PrtConsoleDisableTC", "PrtConsoleColorTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtGeneralTable=prtGeneralTable, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtChannelState=prtChannelState, prtInterpreterEntry=prtInterpreterEntry, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtOutput=prtOutput, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtMarkerNorthMargin=prtMarkerNorthMargin, prtAlert=prtAlert, prtExtendedOutputGroup=prtExtendedOutputGroup, printerV1Alert=printerV1Alert, PrtCapacityUnitTC=PrtCapacityUnitTC, prtChannelType=prtChannelType, prtAlertTableGroup=prtAlertTableGroup, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtOutputOffsetStacking=prtOutputOffsetStacking, prtInputDescription=prtInputDescription, prtChannelTable=prtChannelTable, prtChannelV2Group=prtChannelV2Group, prtAlertTime=prtAlertTime, prtMarkerProcessColorants=prtMarkerProcessColorants, prtMarkerEastMargin=prtMarkerEastMargin, printerV2Alert=printerV2Alert, prtMarkerStatus=prtMarkerStatus, prtCoverStatus=prtCoverStatus, prtInputName=prtInputName, CapacityUnit=CapacityUnit, prtConsoleLights=prtConsoleLights, prtInputType=prtInputType, prtMarkerColorantValue=prtMarkerColorantValue, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtInputCurrentLevel=prtInputCurrentLevel, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtMIB2Compliance=prtMIB2Compliance, prtOutputName=prtOutputName, prtConsoleGroup=prtConsoleGroup, prtLocalizationLanguage=prtLocalizationLanguage, prtAlertTimeGroup=prtAlertTimeGroup, prtChannelIndex=prtChannelIndex, prtInput=prtInput, prtInputDimUnit=prtInputDimUnit, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtInputIndex=prtInputIndex, prtLocalizationIndex=prtLocalizationIndex, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtInterpreterDescription=prtInterpreterDescription, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtOutputStatus=prtOutputStatus, printerV2AlertPrefix=printerV2AlertPrefix, prtMIBConformance=prtMIBConformance, prtCoverTable=prtCoverTable, PYSNMP_MODULE_ID=printmib, prtInterpreterGroup=prtInterpreterGroup, prtStorageRefEntry=prtStorageRefEntry, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtInputMediaFormParts=prtInputMediaFormParts, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtInputMediaName=prtInputMediaName, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtDeviceRefIndex=prtDeviceRefIndex, prtChannelInformation=prtChannelInformation, prtMarkerSupplies=prtMarkerSupplies, prtAlertIndex=prtAlertIndex, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtGeneralGroup=prtGeneralGroup, prtMarkerIndex=prtMarkerIndex, PrtPrintOrientationTC=PrtPrintOrientationTC, prtInputTable=prtInputTable, prtAlertGroupIndex=prtAlertGroupIndex, prtMarkerGroup=prtMarkerGroup, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtOutputDescription=prtOutputDescription, prtInterpreter=prtInterpreter, prtChannelGroup=prtChannelGroup, prtOutputMaxCapacity=prtOutputMaxCapacity, prtExtendedInputGroup=prtExtendedInputGroup, prtAlertCode=prtAlertCode, prtOutputTable=prtOutputTable, prtOutputSecurity=prtOutputSecurity, prtGeneralServicePerson=prtGeneralServicePerson, prtGeneralConfigChanges=prtGeneralConfigChanges, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtInterpreterLangFamily=prtInterpreterLangFamily, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtOutputDefaultIndex=prtOutputDefaultIndex, prtGeneralPrinterName=prtGeneralPrinterName, MediaUnit=MediaUnit, prtCover=prtCover, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtConsoleDisable=prtConsoleDisable, prtOutputSerialNumber=prtOutputSerialNumber, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, printmib=printmib, prtConsoleOffTime=prtConsoleOffTime, prtMarkerCounterUnit=prtMarkerCounterUnit, prtInputMediaType=prtInputMediaType, prtCoverEntry=prtCoverEntry, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtInputSerialNumber=prtInputSerialNumber, prtInterpreterIndex=prtInterpreterIndex, prtMIBCompliance=prtMIBCompliance, prtGeneralV2Group=prtGeneralV2Group, prtMarkerColorantTonality=prtMarkerColorantTonality, prtMarkerLifeCount=prtMarkerLifeCount, prtConsoleOnTime=prtConsoleOnTime, prtConsoleLightTable=prtConsoleLightTable, prtMarkerEntry=prtMarkerEntry, prtMarkerWestMargin=prtMarkerWestMargin, prtOutputGroup=prtOutputGroup, prtAlertLocation=prtAlertLocation, prtAlertTableV2Group=prtAlertTableV2Group, PrtMediaUnitTC=PrtMediaUnitTC, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtAlertEntry=prtAlertEntry, prtInputSwitchingGroup=prtInputSwitchingGroup, prtMarkerColorantEntry=prtMarkerColorantEntry, prtMarkerColorant=prtMarkerColorant, prtOutputVersion=prtOutputVersion, prtInterpreterLangLevel=prtInterpreterLangLevel, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtAlertTrapGroup=prtAlertTrapGroup, prtMarkerColorantTable=prtMarkerColorantTable, prtInputDefaultIndex=prtInputDefaultIndex, prtInputMediaColor=prtInputMediaColor, CodedCharSet=CodedCharSet, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, PresentOnOff=PresentOnOff, prtInterpreterVersion=prtInterpreterVersion, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtMediaPathTable=prtMediaPathTable, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtOutputBursting=prtOutputBursting, prtChannelEntry=prtChannelEntry, prtConsoleLightEntry=prtConsoleLightEntry, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, PrtChannelStateTC=PrtChannelStateTC, prtMarkerSouthMargin=prtMarkerSouthMargin, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtOutputPageCollated=prtOutputPageCollated, prtChannel=prtChannel, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtAlertCriticalEvents=prtAlertCriticalEvents, prtMIB2Groups=prtMIB2Groups, prtAlertGroup=prtAlertGroup, prtMarkerSuppliesType=prtMarkerSuppliesType, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtConsoleLocalization=prtConsoleLocalization, prtMediaPathEntry=prtMediaPathEntry, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtInputVendorName=prtInputVendorName, prtInputNextIndex=prtInputNextIndex, prtMarkerTable=prtMarkerTable, prtMarkerMarkTech=prtMarkerMarkTech, prtMarkerColorantGroup=prtMarkerColorantGroup, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtCoverIndex=prtCoverIndex, prtInputCapacityUnit=prtInputCapacityUnit, prtInputMediaGroup=prtInputMediaGroup, prtInputMediaWeight=prtInputMediaWeight, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtInputStatus=prtInputStatus, prtOutputIndex=prtOutputIndex, prtInterpreterTable=prtInterpreterTable, prtCoverDescription=prtCoverDescription, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtGeneralEntry=prtGeneralEntry, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtConsoleDescription=prtConsoleDescription, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtGeneralSerialNumber=prtGeneralSerialNumber, prtInputMaxCapacity=prtInputMaxCapacity, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtOutputVendorName=prtOutputVendorName, prtMarkerSpotColorants=prtMarkerSpotColorants, prtInputSecurity=prtInputSecurity, prtChannelStatus=prtChannelStatus, prtAlertAllEvents=prtAlertAllEvents, prtLocalizationCountry=prtLocalizationCountry, prtStorageRefIndex=prtStorageRefIndex, prtChannelIfIndex=prtChannelIfIndex, prtMIBGroups=prtMIBGroups, prtOutputStackingOrder=prtOutputStackingOrder, prtMediaPathStatus=prtMediaPathStatus, prtConsoleLightIndex=prtConsoleLightIndex, prtDeviceRefEntry=prtDeviceRefEntry, SubUnitStatus=SubUnitStatus, prtMediaPathIndex=prtMediaPathIndex, prtAlertTrainingLevel=prtAlertTrainingLevel, prtOutputEntry=prtOutputEntry, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtMarker=prtMarker, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtMediaPathType=prtMediaPathType, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtChannelProtocolVersion=prtChannelProtocolVersion, prtMarkerColorantRole=prtMarkerColorantRole, prtInterpreterLangVersion=prtInterpreterLangVersion, prtInputGroup=prtInputGroup, prtAlertTable=prtAlertTable, prtLocalization=prtLocalization, prtMediaPathGroup=prtMediaPathGroup, prtInputModel=prtInputModel, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtInputEntry=prtInputEntry, prtGeneral=prtGeneral, prtOutputDecollating=prtOutputDecollating, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtAlertDescription=prtAlertDescription, prtOutputType=prtOutputType, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtMediaPathDescription=prtMediaPathDescription, prtInterpreterTwoWay=prtInterpreterTwoWay, prtDeviceRefTable=prtDeviceRefTable, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtLocalizationEntry=prtLocalizationEntry, prtOutputCapacityUnit=prtOutputCapacityUnit, prtInputVersion=prtInputVersion, prtConsoleColor=prtConsoleColor, prtLocalizationTable=prtLocalizationTable, prtOutputDimUnit=prtOutputDimUnit, prtStorageRefTable=prtStorageRefTable, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtMediaPath=prtMediaPath, prtAlertSeverityLevel=prtAlertSeverityLevel, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC)
mibBuilder.exportSymbols("Printer-MIB", prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtMarkerColorantIndex=prtMarkerColorantIndex, prtGeneralReset=prtGeneralReset, prtOutputModel=prtOutputModel)
