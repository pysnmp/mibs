...
PrtCoverStatusTC, PrtMarkerSuppliesTypeTC, PrtGeneralResetTC, PrtInputTypeTC, PrtOutputTypeTC, PrtConsoleColorTC, PrtAlertCodeTC, PrtAlertGroupTC, PrtAlertTrainingLevelTC, PrtConsoleDisableTC, PrtChannelTypeTC, PrtMarkerMarkTechTC, PrtMediaPathTypeTC, PrtInterpreterLangFamilyTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtCoverStatusTC", "PrtMarkerSuppliesTypeTC", "PrtGeneralResetTC", "PrtInputTypeTC", "PrtOutputTypeTC", "PrtConsoleColorTC", "PrtAlertCodeTC", "PrtAlertGroupTC", "PrtAlertTrainingLevelTC", "PrtConsoleDisableTC", "PrtChannelTypeTC", "PrtMarkerMarkTechTC", "PrtMediaPathTypeTC", "PrtInterpreterLangFamilyTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtOutputDefaultIndex=prtOutputDefaultIndex, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtCover=prtCover, prtMarkerColorantValue=prtMarkerColorantValue, prtMIBConformance=prtMIBConformance, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtDeviceRefTable=prtDeviceRefTable, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtMediaPathDescription=prtMediaPathDescription, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtOutputGroup=prtOutputGroup, prtInput=prtInput, prtInputMediaName=prtInputMediaName, prtMarkerColorantTable=prtMarkerColorantTable, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtMarkerGroup=prtMarkerGroup, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtInputEntry=prtInputEntry, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, PrtChannelStateTC=PrtChannelStateTC, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtMarkerSuppliesType=prtMarkerSuppliesType, prtOutputType=prtOutputType, prtConsoleGroup=prtConsoleGroup, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtMediaPathTable=prtMediaPathTable, prtInputMaxCapacity=prtInputMaxCapacity, prtMarkerColorantRole=prtMarkerColorantRole, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtMarkerMarkTech=prtMarkerMarkTech, prtOutputDimensionsGroup=prtOutputDimensionsGroup, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtOutputOffsetStacking=prtOutputOffsetStacking, prtAlertTrapGroup=prtAlertTrapGroup, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtDeviceRefIndex=prtDeviceRefIndex, prtInterpreterLangVersion=prtInterpreterLangVersion, prtChannelType=prtChannelType, prtGeneralConfigChanges=prtGeneralConfigChanges, prtConsoleLightIndex=prtConsoleLightIndex, CodedCharSet=CodedCharSet, printmib=printmib, SubUnitStatus=SubUnitStatus, prtAlertTrainingLevel=prtAlertTrainingLevel, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtOutputStatus=prtOutputStatus, prtMarkerWestMargin=prtMarkerWestMargin, prtConsoleDescription=prtConsoleDescription, prtOutputTable=prtOutputTable, prtInputSerialNumber=prtInputSerialNumber, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtInputDefaultIndex=prtInputDefaultIndex, prtMIB2Compliance=prtMIB2Compliance, prtInputStatus=prtInputStatus, prtInputDimUnit=prtInputDimUnit, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtMarkerColorantTonality=prtMarkerColorantTonality, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtLocalizationLanguage=prtLocalizationLanguage, prtConsoleLightEntry=prtConsoleLightEntry, prtConsoleDisable=prtConsoleDisable, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, PrtMediaUnitTC=PrtMediaUnitTC, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtGeneralV2Group=prtGeneralV2Group, PYSNMP_MODULE_ID=printmib, prtGeneralReset=prtGeneralReset, prtInputVersion=prtInputVersion, prtAlert=prtAlert, prtExtendedOutputGroup=prtExtendedOutputGroup, prtMediaPathEntry=prtMediaPathEntry, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtInputIndex=prtInputIndex, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtAlertCode=prtAlertCode, prtGeneralEntry=prtGeneralEntry, prtMarkerColorantEntry=prtMarkerColorantEntry, prtAlertTime=prtAlertTime, printerV1Alert=printerV1Alert, prtLocalizationCountry=prtLocalizationCountry, prtAlertTableGroup=prtAlertTableGroup, prtMarkerSupplies=prtMarkerSupplies, prtInterpreterTwoWay=prtInterpreterTwoWay, prtInputName=prtInputName, prtConsoleLights=prtConsoleLights, prtStorageRefEntry=prtStorageRefEntry, prtStorageRefIndex=prtStorageRefIndex, prtMediaPathGroup=prtMediaPathGroup, prtChannelIndex=prtChannelIndex, prtLocalizationEntry=prtLocalizationEntry, prtMarkerColorantIndex=prtMarkerColorantIndex, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtMIBCompliance=prtMIBCompliance, prtAlertGroup=prtAlertGroup, prtLocalization=prtLocalization, prtGeneralPrinterName=prtGeneralPrinterName, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtInputMediaType=prtInputMediaType, prtOutputCapacityUnit=prtOutputCapacityUnit, prtInputSwitchingGroup=prtInputSwitchingGroup, prtMarkerLifeCount=prtMarkerLifeCount, prtCoverTable=prtCoverTable, prtInputMediaFormParts=prtInputMediaFormParts, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtCoverDescription=prtCoverDescription, prtConsoleLightTable=prtConsoleLightTable, prtAlertAllEvents=prtAlertAllEvents, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtLocalizationIndex=prtLocalizationIndex, MediaUnit=MediaUnit, prtGeneralSerialNumber=prtGeneralSerialNumber, prtChannelEntry=prtChannelEntry, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtOutputDescription=prtOutputDescription, prtInterpreterLangLevel=prtInterpreterLangLevel, prtInputSecurity=prtInputSecurity, prtMarkerProcessColorants=prtMarkerProcessColorants, prtConsoleLocalization=prtConsoleLocalization, prtOutputVendorName=prtOutputVendorName, prtInterpreterDescription=prtInterpreterDescription, prtGeneralTable=prtGeneralTable, prtOutputStackingOrder=prtOutputStackingOrder, prtInterpreterIndex=prtInterpreterIndex, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtOutputIndex=prtOutputIndex, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtMediaPathType=prtMediaPathType, prtInputCapacityUnit=prtInputCapacityUnit, prtInterpreterEntry=prtInterpreterEntry, prtOutputEntry=prtOutputEntry, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtOutput=prtOutput, prtInterpreterLangFamily=prtInterpreterLangFamily, PresentOnOff=PresentOnOff, prtMIBGroups=prtMIBGroups, prtInputDescription=prtInputDescription, prtChannel=prtChannel, prtOutputModel=prtOutputModel, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtCoverStatus=prtCoverStatus, printerV2AlertPrefix=printerV2AlertPrefix, prtInterpreterGroup=prtInterpreterGroup, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtDeviceRefEntry=prtDeviceRefEntry, prtOutputSerialNumber=prtOutputSerialNumber, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtMarkerSpotColorants=prtMarkerSpotColorants, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtChannelStatus=prtChannelStatus, prtCoverEntry=prtCoverEntry, prtMIB2Groups=prtMIB2Groups, prtAlertEntry=prtAlertEntry, prtInterpreterTable=prtInterpreterTable, printerV2Alert=printerV2Alert, prtExtendedInputGroup=prtExtendedInputGroup, prtOutputVersion=prtOutputVersion, prtMediaPathStatus=prtMediaPathStatus, prtConsoleOffTime=prtConsoleOffTime, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtGeneral=prtGeneral, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtCoverIndex=prtCoverIndex, prtOutputBursting=prtOutputBursting, prtInterpreter=prtInterpreter, prtInputVendorName=prtInputVendorName, prtMediaPath=prtMediaPath, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtOutputPageCollated=prtOutputPageCollated, prtMarkerEntry=prtMarkerEntry, prtAlertTableV2Group=prtAlertTableV2Group, prtMarkerTable=prtMarkerTable, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtAlertGroupIndex=prtAlertGroupIndex, prtInputMediaColor=prtInputMediaColor, prtChannelInformation=prtChannelInformation, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtInputMediaWeight=prtInputMediaWeight, prtAlertSeverityLevel=prtAlertSeverityLevel, prtAlertTimeGroup=prtAlertTimeGroup, PrtCapacityUnitTC=PrtCapacityUnitTC, prtStorageRefTable=prtStorageRefTable, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtChannelV2Group=prtChannelV2Group, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtChannelGroup=prtChannelGroup, prtAlertDescription=prtAlertDescription, CapacityUnit=CapacityUnit, prtAlertCriticalEvents=prtAlertCriticalEvents, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtMarkerSouthMargin=prtMarkerSouthMargin, prtMarkerEastMargin=prtMarkerEastMargin, prtMarker=prtMarker, prtMarkerColorantGroup=prtMarkerColorantGroup, prtInputCurrentLevel=prtInputCurrentLevel, prtMediaPathIndex=prtMediaPathIndex, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtChannelIfIndex=prtChannelIfIndex, PrtPrintOrientationTC=PrtPrintOrientationTC, prtAlertIndex=prtAlertIndex, prtGeneralServicePerson=prtGeneralServicePerson, prtInputGroup=prtInputGroup, prtOutputDimUnit=prtOutputDimUnit, prtMarkerNorthMargin=prtMarkerNorthMargin, prtConsoleColor=prtConsoleColor, prtInputMediaGroup=prtInputMediaGroup, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtMarkerStatus=prtMarkerStatus, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtAlertLocation=prtAlertLocation, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtOutputSecurity=prtOutputSecurity, prtOutputDecollating=prtOutputDecollating, prtChannelState=prtChannelState, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtInterpreterVersion=prtInterpreterVersion, prtInputModel=prtInputModel, prtGeneralGroup=prtGeneralGroup, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtChannelTable=prtChannelTable, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtLocalizationTable=prtLocalizationTable, prtInputTable=prtInputTable, prtOutputMaxCapacity=prtOutputMaxCapacity, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtMarkerIndex=prtMarkerIndex, prtMarkerCounterUnit=prtMarkerCounterUnit, prtInputNextIndex=prtInputNextIndex, prtConsoleOnTime=prtConsoleOnTime, prtAlertTable=prtAlertTable, prtOutputName=prtOutputName)
mibBuilder.exportSymbols("Printer-MIB", prtMarkerColorant=prtMarkerColorant, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtChannelProtocolVersion=prtChannelProtocolVersion, prtInputType=prtInputType)
