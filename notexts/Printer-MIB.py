...
PrtAlertGroupTC, PrtInterpreterLangFamilyTC, PrtAlertTrainingLevelTC, PrtConsoleColorTC, PrtGeneralResetTC, PrtMarkerSuppliesTypeTC, PrtChannelTypeTC, PrtMediaPathTypeTC, PrtAlertCodeTC, PrtMarkerMarkTechTC, PrtConsoleDisableTC, PrtInputTypeTC, PrtOutputTypeTC, PrtCoverStatusTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtAlertGroupTC", "PrtInterpreterLangFamilyTC", "PrtAlertTrainingLevelTC", "PrtConsoleColorTC", "PrtGeneralResetTC", "PrtMarkerSuppliesTypeTC", "PrtChannelTypeTC", "PrtMediaPathTypeTC", "PrtAlertCodeTC", "PrtMarkerMarkTechTC", "PrtConsoleDisableTC", "PrtInputTypeTC", "PrtOutputTypeTC", "PrtCoverStatusTC")
...
mibBuilder.exportSymbols("Printer-MIB", PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtStorageRefIndex=prtStorageRefIndex, prtAlertAllEvents=prtAlertAllEvents, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtOutput=prtOutput, prtAlertCode=prtAlertCode, prtDeviceRefEntry=prtDeviceRefEntry, prtMIB2Groups=prtMIB2Groups, prtOutputStackingOrder=prtOutputStackingOrder, prtOutputGroup=prtOutputGroup, prtInputStatus=prtInputStatus, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtExtendedInputGroup=prtExtendedInputGroup, MediaUnit=MediaUnit, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtConsoleLightTable=prtConsoleLightTable, printmib=printmib, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtInputSecurity=prtInputSecurity, prtInputTable=prtInputTable, prtInputMediaType=prtInputMediaType, prtOutputIndex=prtOutputIndex, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtChannelTable=prtChannelTable, prtConsoleLightIndex=prtConsoleLightIndex, prtOutputName=prtOutputName, prtInputDefaultIndex=prtInputDefaultIndex, printerV2Alert=printerV2Alert, prtChannelV2Group=prtChannelV2Group, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, CapacityUnit=CapacityUnit, prtInputModel=prtInputModel, prtInterpreterLangVersion=prtInterpreterLangVersion, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, PYSNMP_MODULE_ID=printmib, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtMIB2Compliance=prtMIB2Compliance, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtAlertLocation=prtAlertLocation, prtInputSerialNumber=prtInputSerialNumber, prtMediaPath=prtMediaPath, prtCoverIndex=prtCoverIndex, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtGeneralGroup=prtGeneralGroup, prtMediaPathIndex=prtMediaPathIndex, prtLocalization=prtLocalization, prtMarkerSuppliesType=prtMarkerSuppliesType, prtInterpreterTwoWay=prtInterpreterTwoWay, prtInterpreterGroup=prtInterpreterGroup, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtInputMaxCapacity=prtInputMaxCapacity, prtInputIndex=prtInputIndex, prtChannelEntry=prtChannelEntry, prtOutputSerialNumber=prtOutputSerialNumber, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtAlertGroupIndex=prtAlertGroupIndex, prtInputMediaColor=prtInputMediaColor, prtInputVendorName=prtInputVendorName, prtOutputRemainingCapacity=prtOutputRemainingCapacity, SubUnitStatus=SubUnitStatus, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtInputDimUnit=prtInputDimUnit, prtMarkerColorantEntry=prtMarkerColorantEntry, prtMarkerSupplies=prtMarkerSupplies, prtInterpreterLangLevel=prtInterpreterLangLevel, prtOutputEntry=prtOutputEntry, prtMediaPathGroup=prtMediaPathGroup, PrtMediaUnitTC=PrtMediaUnitTC, prtInputMediaFormParts=prtInputMediaFormParts, prtMarkerTable=prtMarkerTable, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtInputSwitchingGroup=prtInputSwitchingGroup, prtMarkerEntry=prtMarkerEntry, PrtPrintOrientationTC=PrtPrintOrientationTC, prtInputType=prtInputType, prtLocalizationLanguage=prtLocalizationLanguage, prtConsoleLocalization=prtConsoleLocalization, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtMediaPathTable=prtMediaPathTable, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtMarkerLifeCount=prtMarkerLifeCount, prtCoverTable=prtCoverTable, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtAlertTable=prtAlertTable, prtInput=prtInput, prtInputMediaWeight=prtInputMediaWeight, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtInputName=prtInputName, prtGeneralV2Group=prtGeneralV2Group, prtChannelState=prtChannelState, prtInputCurrentLevel=prtInputCurrentLevel, prtOutputVendorName=prtOutputVendorName, prtMarkerProcessColorants=prtMarkerProcessColorants, prtOutputType=prtOutputType, prtOutputStatus=prtOutputStatus, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtMarkerColorantTable=prtMarkerColorantTable, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtOutputBursting=prtOutputBursting, prtChannelIfIndex=prtChannelIfIndex, prtChannelIndex=prtChannelIndex, prtStorageRefTable=prtStorageRefTable, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtOutputOffsetStacking=prtOutputOffsetStacking, prtChannelType=prtChannelType, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtConsoleLightEntry=prtConsoleLightEntry, prtDeviceRefTable=prtDeviceRefTable, PrtCapacityUnitTC=PrtCapacityUnitTC, prtGeneralEntry=prtGeneralEntry, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtInputMediaGroup=prtInputMediaGroup, prtAlertTableGroup=prtAlertTableGroup, prtConsoleDisable=prtConsoleDisable, prtMediaPathDescription=prtMediaPathDescription, prtInputGroup=prtInputGroup, prtExtendedOutputGroup=prtExtendedOutputGroup, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtLocalizationIndex=prtLocalizationIndex, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtMarkerColorantGroup=prtMarkerColorantGroup, prtConsoleOffTime=prtConsoleOffTime, prtOutputTable=prtOutputTable, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtMarkerIndex=prtMarkerIndex, prtMarkerEastMargin=prtMarkerEastMargin, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtInterpreterTable=prtInterpreterTable, prtInterpreterVersion=prtInterpreterVersion, prtChannelGroup=prtChannelGroup, prtAlertGroup=prtAlertGroup, prtMarker=prtMarker, PresentOnOff=PresentOnOff, prtOutputDefaultIndex=prtOutputDefaultIndex, PrtChannelStateTC=PrtChannelStateTC, PrtSubUnitStatusTC=PrtSubUnitStatusTC, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtGeneralReset=prtGeneralReset, prtLocalizationEntry=prtLocalizationEntry, prtOutputModel=prtOutputModel, prtCover=prtCover, prtOutputVersion=prtOutputVersion, prtMarkerWestMargin=prtMarkerWestMargin, prtInterpreterDescription=prtInterpreterDescription, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtMarkerColorantIndex=prtMarkerColorantIndex, prtAlertCriticalEvents=prtAlertCriticalEvents, prtMarkerColorantRole=prtMarkerColorantRole, prtMarkerNorthMargin=prtMarkerNorthMargin, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtMarkerSouthMargin=prtMarkerSouthMargin, prtInterpreterIndex=prtInterpreterIndex, prtChannel=prtChannel, prtAlertTrainingLevel=prtAlertTrainingLevel, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtChannelStatus=prtChannelStatus, prtGeneral=prtGeneral, prtCoverEntry=prtCoverEntry, prtConsoleDescription=prtConsoleDescription, prtStorageRefEntry=prtStorageRefEntry, prtMediaPathEntry=prtMediaPathEntry, prtInputEntry=prtInputEntry, prtAlertTrapGroup=prtAlertTrapGroup, prtCoverStatus=prtCoverStatus, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtOutputSecurity=prtOutputSecurity, CodedCharSet=CodedCharSet, prtInputVersion=prtInputVersion, prtGeneralServicePerson=prtGeneralServicePerson, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtChannelProtocolVersion=prtChannelProtocolVersion, prtChannelInformation=prtChannelInformation, prtAlertTableV2Group=prtAlertTableV2Group, prtConsoleOnTime=prtConsoleOnTime, prtMarkerCounterUnit=prtMarkerCounterUnit, prtAlertDescription=prtAlertDescription, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, printerV1Alert=printerV1Alert, prtInputCapacityUnit=prtInputCapacityUnit, prtInterpreter=prtInterpreter, prtMarkerGroup=prtMarkerGroup, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtOutputMaxCapacity=prtOutputMaxCapacity, prtLocalizationCountry=prtLocalizationCountry, prtMarkerSpotColorants=prtMarkerSpotColorants, prtOutputDimUnit=prtOutputDimUnit, prtCoverDescription=prtCoverDescription, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtMediaPathStatus=prtMediaPathStatus, prtConsoleColor=prtConsoleColor, prtMIBGroups=prtMIBGroups, prtMarkerStatus=prtMarkerStatus, prtInterpreterEntry=prtInterpreterEntry, prtOutputDescription=prtOutputDescription, prtAlertTime=prtAlertTime, prtMIBConformance=prtMIBConformance, prtGeneralSerialNumber=prtGeneralSerialNumber, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtOutputPageCollated=prtOutputPageCollated, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtLocalizationTable=prtLocalizationTable, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtMarkerMarkTech=prtMarkerMarkTech, prtConsoleLights=prtConsoleLights, prtDeviceRefIndex=prtDeviceRefIndex, prtOutputCapacityUnit=prtOutputCapacityUnit, prtAlertIndex=prtAlertIndex, prtMarkerColorantValue=prtMarkerColorantValue, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtAlertTimeGroup=prtAlertTimeGroup, prtGeneralTable=prtGeneralTable, prtGeneralConfigChanges=prtGeneralConfigChanges, prtInputNextIndex=prtInputNextIndex, prtAlertEntry=prtAlertEntry, prtInputMediaName=prtInputMediaName, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtMediaPathType=prtMediaPathType, prtAlert=prtAlert, printerV2AlertPrefix=printerV2AlertPrefix, prtAlertSeverityLevel=prtAlertSeverityLevel, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtMarkerColorant=prtMarkerColorant, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtConsoleGroup=prtConsoleGroup, prtMarkerColorantTonality=prtMarkerColorantTonality, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtInputDescription=prtInputDescription, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtMIBCompliance=prtMIBCompliance, prtOutputDecollating=prtOutputDecollating)
mibBuilder.exportSymbols("Printer-MIB", PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtInterpreterLangFamily=prtInterpreterLangFamily, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtGeneralPrinterName=prtGeneralPrinterName)
