...
PrtOutputTypeTC, PrtMediaPathTypeTC, PrtInputTypeTC, PrtConsoleColorTC, PrtAlertCodeTC, PrtInterpreterLangFamilyTC, PrtAlertTrainingLevelTC, PrtMarkerMarkTechTC, PrtCoverStatusTC, PrtChannelTypeTC, PrtGeneralResetTC, PrtAlertGroupTC, PrtMarkerSuppliesTypeTC, PrtConsoleDisableTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtOutputTypeTC", "PrtMediaPathTypeTC", "PrtInputTypeTC", "PrtConsoleColorTC", "PrtAlertCodeTC", "PrtInterpreterLangFamilyTC", "PrtAlertTrainingLevelTC", "PrtMarkerMarkTechTC", "PrtCoverStatusTC", "PrtChannelTypeTC", "PrtGeneralResetTC", "PrtAlertGroupTC", "PrtMarkerSuppliesTypeTC", "PrtConsoleDisableTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtInputDefaultIndex=prtInputDefaultIndex, prtDeviceRefIndex=prtDeviceRefIndex, prtInputGroup=prtInputGroup, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtInputModel=prtInputModel, prtInterpreterVersion=prtInterpreterVersion, prtMarkerMarkTech=prtMarkerMarkTech, prtInputMediaWeight=prtInputMediaWeight, prtInterpreter=prtInterpreter, prtLocalizationIndex=prtLocalizationIndex, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtInputNextIndex=prtInputNextIndex, prtChannelGroup=prtChannelGroup, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtInputSerialNumber=prtInputSerialNumber, prtMarker=prtMarker, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, PrtPrintOrientationTC=PrtPrintOrientationTC, prtOutputSecurity=prtOutputSecurity, prtChannelIndex=prtChannelIndex, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtAlertLocation=prtAlertLocation, printerV2AlertPrefix=printerV2AlertPrefix, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtOutputOffsetStacking=prtOutputOffsetStacking, prtOutputStatus=prtOutputStatus, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtMediaPathGroup=prtMediaPathGroup, prtInput=prtInput, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtInputVendorName=prtInputVendorName, prtMarkerColorantRole=prtMarkerColorantRole, prtMarkerColorantGroup=prtMarkerColorantGroup, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtMarkerProcessColorants=prtMarkerProcessColorants, prtAlertIndex=prtAlertIndex, prtInputSwitchingGroup=prtInputSwitchingGroup, prtMediaPathEntry=prtMediaPathEntry, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtGeneralSerialNumber=prtGeneralSerialNumber, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtMarkerDefaultIndex=prtMarkerDefaultIndex, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtMarkerEastMargin=prtMarkerEastMargin, prtDeviceRefEntry=prtDeviceRefEntry, prtOutputPageCollated=prtOutputPageCollated, prtMarkerWestMargin=prtMarkerWestMargin, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtAlertCode=prtAlertCode, PresentOnOff=PresentOnOff, prtMarkerPowerOnCount=prtMarkerPowerOnCount, PrtCapacityUnitTC=PrtCapacityUnitTC, prtAlertTableGroup=prtAlertTableGroup, prtStorageRefIndex=prtStorageRefIndex, printerV2Alert=printerV2Alert, prtInputMediaColor=prtInputMediaColor, prtInputMediaType=prtInputMediaType, prtMIB2Groups=prtMIB2Groups, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtInterpreterDescription=prtInterpreterDescription, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtOutput=prtOutput, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtGeneral=prtGeneral, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtLocalizationTable=prtLocalizationTable, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtChannelType=prtChannelType, prtAlertGroupIndex=prtAlertGroupIndex, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtChannelState=prtChannelState, prtAlertCriticalEvents=prtAlertCriticalEvents, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtInputDimUnit=prtInputDimUnit, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtChannelV2Group=prtChannelV2Group, prtCoverIndex=prtCoverIndex, prtInputName=prtInputName, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtChannelTable=prtChannelTable, prtChannelIfIndex=prtChannelIfIndex, prtConsoleLightIndex=prtConsoleLightIndex, prtInputMaxCapacity=prtInputMaxCapacity, prtInputEntry=prtInputEntry, prtConsoleOffTime=prtConsoleOffTime, CodedCharSet=CodedCharSet, prtMarkerEntry=prtMarkerEntry, prtGeneralConfigChanges=prtGeneralConfigChanges, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtMIB2Compliance=prtMIB2Compliance, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtChannel=prtChannel, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtInputTable=prtInputTable, prtMediaPath=prtMediaPath, prtGeneralGroup=prtGeneralGroup, prtLocalizationCountry=prtLocalizationCountry, prtOutputDimensionsGroup=prtOutputDimensionsGroup, MediaUnit=MediaUnit, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtConsoleOnTime=prtConsoleOnTime, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtDeviceRefTable=prtDeviceRefTable, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtLocalization=prtLocalization, prtMarkerColorant=prtMarkerColorant, prtOutputName=prtOutputName, prtMarkerTable=prtMarkerTable, prtGeneralReset=prtGeneralReset, prtMarkerSuppliesType=prtMarkerSuppliesType, prtAlertEntry=prtAlertEntry, prtStorageRefTable=prtStorageRefTable, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtOutputVendorName=prtOutputVendorName, prtMarkerGroup=prtMarkerGroup, prtMarkerSpotColorants=prtMarkerSpotColorants, prtStorageRefEntry=prtStorageRefEntry, prtInputMediaFormParts=prtInputMediaFormParts, prtInputMediaGroup=prtInputMediaGroup, PYSNMP_MODULE_ID=printmib, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtInputCapacityUnit=prtInputCapacityUnit, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtOutputMaxCapacity=prtOutputMaxCapacity, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtGeneralPrinterName=prtGeneralPrinterName, prtInterpreterLangLevel=prtInterpreterLangLevel, prtConsoleGroup=prtConsoleGroup, prtMarkerColorantValue=prtMarkerColorantValue, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtInterpreterLangVersion=prtInterpreterLangVersion, prtConsoleLightTable=prtConsoleLightTable, prtAlertTime=prtAlertTime, prtOutputType=prtOutputType, prtInputCurrentLevel=prtInputCurrentLevel, PrtChannelStateTC=PrtChannelStateTC, prtMarkerStatus=prtMarkerStatus, prtOutputModel=prtOutputModel, prtMarkerSupplies=prtMarkerSupplies, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtMediaPathTable=prtMediaPathTable, prtConsoleLights=prtConsoleLights, prtAlertTimeGroup=prtAlertTimeGroup, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtInterpreterLangFamily=prtInterpreterLangFamily, prtConsoleDisable=prtConsoleDisable, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtAlertDescription=prtAlertDescription, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtInterpreterIndex=prtInterpreterIndex, prtMarkerIndex=prtMarkerIndex, prtConsoleDescription=prtConsoleDescription, prtMarkerLifeCount=prtMarkerLifeCount, prtMarkerColorantIndex=prtMarkerColorantIndex, prtInterpreterTwoWay=prtInterpreterTwoWay, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtConsoleLocalization=prtConsoleLocalization, prtAlertTrainingLevel=prtAlertTrainingLevel, prtInterpreterGroup=prtInterpreterGroup, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtMediaPathIndex=prtMediaPathIndex, prtMediaPathType=prtMediaPathType, prtOutputGroup=prtOutputGroup, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtOutputSerialNumber=prtOutputSerialNumber, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtChannelInformation=prtChannelInformation, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, printmib=printmib, prtMediaPathDescription=prtMediaPathDescription, prtGeneralTable=prtGeneralTable, prtCover=prtCover, prtInputDescription=prtInputDescription, prtOutputTable=prtOutputTable, prtInputType=prtInputType, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtGeneralServicePerson=prtGeneralServicePerson, CapacityUnit=CapacityUnit, prtOutputIndex=prtOutputIndex, prtCoverDescription=prtCoverDescription, prtAlertTable=prtAlertTable, prtLocalizationLanguage=prtLocalizationLanguage, prtMIBConformance=prtMIBConformance, prtExtendedInputGroup=prtExtendedInputGroup, prtOutputBursting=prtOutputBursting, prtConsoleColor=prtConsoleColor, prtInputStatus=prtInputStatus, prtInputVersion=prtInputVersion, prtChannelEntry=prtChannelEntry, prtGeneralEntry=prtGeneralEntry, prtMIBCompliance=prtMIBCompliance, prtGeneralV2Group=prtGeneralV2Group, prtMarkerNorthMargin=prtMarkerNorthMargin, prtAlertGroup=prtAlertGroup, prtInterpreterTable=prtInterpreterTable, prtMarkerSouthMargin=prtMarkerSouthMargin, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtChannelStatus=prtChannelStatus, prtInputSecurity=prtInputSecurity, prtOutputCapacityUnit=prtOutputCapacityUnit, prtOutputVersion=prtOutputVersion, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtMarkerColorantEntry=prtMarkerColorantEntry, prtAlert=prtAlert, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtAlertTrapGroup=prtAlertTrapGroup, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtConsoleLightEntry=prtConsoleLightEntry, prtOutputDefaultIndex=prtOutputDefaultIndex, prtLocalizationEntry=prtLocalizationEntry, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtInputMediaName=prtInputMediaName, PrtMediaUnitTC=PrtMediaUnitTC, prtInputIndex=prtInputIndex, prtOutputDescription=prtOutputDescription, prtMarkerCounterUnit=prtMarkerCounterUnit, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtMarkerColorantTable=prtMarkerColorantTable, prtOutputStackingOrder=prtOutputStackingOrder, prtMarkerColorantTonality=prtMarkerColorantTonality, prtChannelProtocolVersion=prtChannelProtocolVersion, prtMIBGroups=prtMIBGroups, prtMediaPathStatus=prtMediaPathStatus, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtCoverTable=prtCoverTable, prtCoverEntry=prtCoverEntry, prtOutputDimUnit=prtOutputDimUnit, printerV1Alert=printerV1Alert, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, SubUnitStatus=SubUnitStatus, prtAlertAllEvents=prtAlertAllEvents, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtOutputDecollating=prtOutputDecollating, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtInterpreterEntry=prtInterpreterEntry, prtOutputEntry=prtOutputEntry, prtAlertSeverityLevel=prtAlertSeverityLevel)
mibBuilder.exportSymbols("Printer-MIB", prtAlertTableV2Group=prtAlertTableV2Group, prtCoverStatus=prtCoverStatus, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtExtendedOutputGroup=prtExtendedOutputGroup)
