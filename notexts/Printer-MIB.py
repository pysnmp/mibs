...
PrtAlertTrainingLevelTC, PrtMarkerMarkTechTC, PrtOutputTypeTC, PrtInputTypeTC, PrtAlertGroupTC, PrtMarkerSuppliesTypeTC, PrtCoverStatusTC, PrtConsoleColorTC, PrtConsoleDisableTC, PrtGeneralResetTC, PrtChannelTypeTC, PrtAlertCodeTC, PrtInterpreterLangFamilyTC, PrtMediaPathTypeTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtAlertTrainingLevelTC", "PrtMarkerMarkTechTC", "PrtOutputTypeTC", "PrtInputTypeTC", "PrtAlertGroupTC", "PrtMarkerSuppliesTypeTC", "PrtCoverStatusTC", "PrtConsoleColorTC", "PrtConsoleDisableTC", "PrtGeneralResetTC", "PrtChannelTypeTC", "PrtAlertCodeTC", "PrtInterpreterLangFamilyTC", "PrtMediaPathTypeTC")
...
mibBuilder.exportSymbols("Printer-MIB", PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtOutputDefaultIndex=prtOutputDefaultIndex, prtOutputVendorName=prtOutputVendorName, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtMarkerSpotColorants=prtMarkerSpotColorants, prtInputName=prtInputName, prtAlertTable=prtAlertTable, prtOutputCapacityUnit=prtOutputCapacityUnit, prtOutputDescription=prtOutputDescription, prtMarkerSuppliesType=prtMarkerSuppliesType, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtStorageRefTable=prtStorageRefTable, prtChannelProtocolVersion=prtChannelProtocolVersion, prtConsoleLightEntry=prtConsoleLightEntry, prtAlertTime=prtAlertTime, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtOutputSecurity=prtOutputSecurity, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtStorageRefEntry=prtStorageRefEntry, prtInputVendorName=prtInputVendorName, prtAlertIndex=prtAlertIndex, prtMIBGroups=prtMIBGroups, prtChannelInformation=prtChannelInformation, prtGeneral=prtGeneral, prtMediaPath=prtMediaPath, prtInputSecurity=prtInputSecurity, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtInterpreterLangVersion=prtInterpreterLangVersion, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtChannel=prtChannel, prtInputStatus=prtInputStatus, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtMarkerIndex=prtMarkerIndex, prtGeneralConfigChanges=prtGeneralConfigChanges, prtInputDefaultIndex=prtInputDefaultIndex, prtGeneralTable=prtGeneralTable, PrtPrintOrientationTC=PrtPrintOrientationTC, prtMarkerEntry=prtMarkerEntry, prtChannelTable=prtChannelTable, prtMediaPathIndex=prtMediaPathIndex, prtInputDimUnit=prtInputDimUnit, prtChannelEntry=prtChannelEntry, prtOutputBursting=prtOutputBursting, prtMarkerTable=prtMarkerTable, prtAlertLocation=prtAlertLocation, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtConsoleDescription=prtConsoleDescription, SubUnitStatus=SubUnitStatus, prtAlertCriticalEvents=prtAlertCriticalEvents, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtMarkerWestMargin=prtMarkerWestMargin, prtConsoleLights=prtConsoleLights, prtConsoleDisable=prtConsoleDisable, printmib=printmib, prtOutputSerialNumber=prtOutputSerialNumber, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtChannelIfIndex=prtChannelIfIndex, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtConsoleLightIndex=prtConsoleLightIndex, prtConsoleOffTime=prtConsoleOffTime, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtInputCapacityUnit=prtInputCapacityUnit, prtMarkerColorant=prtMarkerColorant, prtLocalizationIndex=prtLocalizationIndex, prtMarkerMarkTech=prtMarkerMarkTech, prtMediaPathGroup=prtMediaPathGroup, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtOutputType=prtOutputType, prtMIBConformance=prtMIBConformance, prtExtendedInputGroup=prtExtendedInputGroup, prtInputTable=prtInputTable, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtGeneralV2Group=prtGeneralV2Group, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtMarkerGroup=prtMarkerGroup, prtInput=prtInput, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtInterpreterDescription=prtInterpreterDescription, prtMarkerColorantValue=prtMarkerColorantValue, prtInputGroup=prtInputGroup, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, CodedCharSet=CodedCharSet, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtInputDescription=prtInputDescription, prtOutputStatus=prtOutputStatus, prtMIB2Groups=prtMIB2Groups, prtInputMediaColor=prtInputMediaColor, prtMarkerEastMargin=prtMarkerEastMargin, prtChannelGroup=prtChannelGroup, prtMIBCompliance=prtMIBCompliance, prtOutputMaxCapacity=prtOutputMaxCapacity, PresentOnOff=PresentOnOff, prtMarkerColorantRole=prtMarkerColorantRole, prtConsoleOnTime=prtConsoleOnTime, prtLocalizationTable=prtLocalizationTable, prtOutputModel=prtOutputModel, prtMarkerNorthMargin=prtMarkerNorthMargin, prtInterpreterLangLevel=prtInterpreterLangLevel, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtCoverStatus=prtCoverStatus, prtInputCurrentLevel=prtInputCurrentLevel, prtAlertSeverityLevel=prtAlertSeverityLevel, prtGeneralReset=prtGeneralReset, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtAlertCode=prtAlertCode, printerV2Alert=printerV2Alert, prtExtendedOutputGroup=prtExtendedOutputGroup, PrtChannelStateTC=PrtChannelStateTC, prtInputEntry=prtInputEntry, prtAlert=prtAlert, prtInputType=prtInputType, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtMediaPathEntry=prtMediaPathEntry, prtInputMediaName=prtInputMediaName, prtMarkerProcessColorants=prtMarkerProcessColorants, prtInputSerialNumber=prtInputSerialNumber, prtMIB2Compliance=prtMIB2Compliance, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtConsoleLightTable=prtConsoleLightTable, prtOutput=prtOutput, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtInputMediaFormParts=prtInputMediaFormParts, prtOutputOffsetStacking=prtOutputOffsetStacking, PYSNMP_MODULE_ID=printmib, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtMarkerSouthMargin=prtMarkerSouthMargin, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtMediaPathType=prtMediaPathType, prtAlertGroupIndex=prtAlertGroupIndex, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, printerV1Alert=printerV1Alert, printerV2AlertPrefix=printerV2AlertPrefix, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtOutputVersion=prtOutputVersion, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtInterpreterIndex=prtInterpreterIndex, prtInterpreterTwoWay=prtInterpreterTwoWay, prtAlertGroup=prtAlertGroup, prtOutputIndex=prtOutputIndex, prtChannelV2Group=prtChannelV2Group, prtMarkerStatus=prtMarkerStatus, prtInputSwitchingGroup=prtInputSwitchingGroup, CapacityUnit=CapacityUnit, prtGeneralSerialNumber=prtGeneralSerialNumber, prtCover=prtCover, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtInputNextIndex=prtInputNextIndex, prtCoverEntry=prtCoverEntry, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtChannelState=prtChannelState, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtOutputGroup=prtOutputGroup, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtInterpreter=prtInterpreter, prtInterpreterVersion=prtInterpreterVersion, prtAlertTableGroup=prtAlertTableGroup, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtOutputName=prtOutputName, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtMarkerColorantTonality=prtMarkerColorantTonality, prtOutputTable=prtOutputTable, prtInterpreterLangFamily=prtInterpreterLangFamily, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtAlertEntry=prtAlertEntry, prtCoverIndex=prtCoverIndex, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtAlertTrainingLevel=prtAlertTrainingLevel, prtChannelStatus=prtChannelStatus, prtInputModel=prtInputModel, prtMarkerSupplies=prtMarkerSupplies, prtDeviceRefEntry=prtDeviceRefEntry, prtStorageRefSeqNumber=prtStorageRefSeqNumber, MediaUnit=MediaUnit, PrtMediaUnitTC=PrtMediaUnitTC, prtInputMaxCapacity=prtInputMaxCapacity, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtChannelIndex=prtChannelIndex, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtOutputEntry=prtOutputEntry, prtGeneralEntry=prtGeneralEntry, prtMediaPathDescription=prtMediaPathDescription, prtAlertTimeGroup=prtAlertTimeGroup, prtCoverDescription=prtCoverDescription, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtInputMediaGroup=prtInputMediaGroup, prtOutputDecollating=prtOutputDecollating, prtGeneralServicePerson=prtGeneralServicePerson, prtChannelType=prtChannelType, prtMarkerLifeCount=prtMarkerLifeCount, prtLocalizationCountry=prtLocalizationCountry, prtAlertTableV2Group=prtAlertTableV2Group, prtGeneralPrinterName=prtGeneralPrinterName, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtConsoleGroup=prtConsoleGroup, prtInputMediaType=prtInputMediaType, prtMarker=prtMarker, prtLocalization=prtLocalization, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtOutputDimUnit=prtOutputDimUnit, PrtCapacityUnitTC=PrtCapacityUnitTC, prtInputVersion=prtInputVersion, prtInputMediaWeight=prtInputMediaWeight, prtInterpreterTable=prtInterpreterTable, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtInputIndex=prtInputIndex, prtOutputPageCollated=prtOutputPageCollated, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtMarkerColorantGroup=prtMarkerColorantGroup, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtMediaPathTable=prtMediaPathTable, prtAlertAllEvents=prtAlertAllEvents, prtGeneralGroup=prtGeneralGroup, prtAlertDescription=prtAlertDescription, prtInterpreterEntry=prtInterpreterEntry, prtDeviceRefIndex=prtDeviceRefIndex, prtMarkerColorantEntry=prtMarkerColorantEntry, prtConsoleLocalization=prtConsoleLocalization, prtMarkerCounterUnit=prtMarkerCounterUnit, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtLocalizationEntry=prtLocalizationEntry, prtLocalizationLanguage=prtLocalizationLanguage, prtAlertTrapGroup=prtAlertTrapGroup, prtMediaPathStatus=prtMediaPathStatus, prtOutputStackingOrder=prtOutputStackingOrder, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtInterpreterGroup=prtInterpreterGroup, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtDeviceRefTable=prtDeviceRefTable, prtMarkerColorantTable=prtMarkerColorantTable, prtMarkerColorantIndex=prtMarkerColorantIndex, prtStorageRefIndex=prtStorageRefIndex, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir)
mibBuilder.exportSymbols("Printer-MIB", prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtConsoleColor=prtConsoleColor, prtCoverTable=prtCoverTable, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup)
