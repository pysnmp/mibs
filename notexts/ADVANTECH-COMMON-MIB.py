...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvPort=snmpTrapSrvPort, pciSlotTable=pciSlotTable, psLocation=psLocation, psManufacturer=psManufacturer, sysReleaseDate=sysReleaseDate, psSubsysVendorID=psSubsysVendorID, psVendorID=psVendorID, snmpTrapSrvIndex=snmpTrapSrvIndex, psModuleType=psModuleType, sysDeviceName=sysDeviceName, atMgmt=atMgmt, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psModulePorts=psModulePorts, sysFirstBootTime=sysFirstBootTime, psDisplayName=psDisplayName, sysBootCount=sysBootCount, pciSlotEntry=pciSlotEntry, psSubsysDeviceID=psSubsysDeviceID, psLength=psLength, sysModuleID=sysModuleID, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvTable=snmpTrapSrvTable, sysDescr=sysDescr, psState=psState, psIRQ=psIRQ, snmpTrapSrvEntry=snmpTrapSrvEntry, psDescr=psDescr, sysImageVersion=sysImageVersion, psClassCode=psClassCode, atPciConfig=atPciConfig, advantech=advantech, pciConfigObj=pciConfigObj, snmpTrapSrvNumber=snmpTrapSrvNumber, psBusIndex=psBusIndex, snmpTrapSrvIP=snmpTrapSrvIP, PYSNMP_MODULE_ID=advantechCommonMIB, atSystem=atSystem, psIndex=psIndex, psFunctionIndex=psFunctionIndex, advantechCommonMIB=advantechCommonMIB, psBaseAddress=psBaseAddress, sysBootTime=sysBootTime, snmpTrapSrvObj=snmpTrapSrvObj, psNumber=psNumber, psDeviceIndex=psDeviceIndex, psDeviceID=psDeviceID, snmpTrapSrvCommunity=snmpTrapSrvCommunity)
