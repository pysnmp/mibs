...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysDescr=sysDescr, atSystem=atSystem, sysFirstBootTime=sysFirstBootTime, psNumber=psNumber, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvIP=snmpTrapSrvIP, advantech=advantech, PYSNMP_MODULE_ID=advantechCommonMIB, psModuleType=psModuleType, psBaseAddress=psBaseAddress, psModulePorts=psModulePorts, psDeviceID=psDeviceID, psLength=psLength, psIndex=psIndex, snmpTrapSrvNumber=snmpTrapSrvNumber, pciSlotEntry=pciSlotEntry, psDescr=psDescr, psState=psState, atMgmt=atMgmt, psDisplayName=psDisplayName, atPciConfig=atPciConfig, sysReleaseDate=sysReleaseDate, psManufacturer=psManufacturer, psIRQ=psIRQ, pciConfigObj=pciConfigObj, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvObj=snmpTrapSrvObj, pciSlotTable=pciSlotTable, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvIndex=snmpTrapSrvIndex, psBusIndex=psBusIndex, sysModuleID=sysModuleID, psSubsysVendorID=psSubsysVendorID, psClassCode=psClassCode, psLocation=psLocation, sysDeviceName=sysDeviceName, sysBootCount=sysBootCount, psDeviceIndex=psDeviceIndex, psSubsysDeviceID=psSubsysDeviceID, psVendorID=psVendorID, psFunctionIndex=psFunctionIndex, snmpTrapVersion=snmpTrapVersion, sysBootTime=sysBootTime, sysImageVersion=sysImageVersion, snmpTrapSrvPort=snmpTrapSrvPort)
