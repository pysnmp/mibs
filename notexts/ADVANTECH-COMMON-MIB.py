...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psDeviceIndex=psDeviceIndex, snmpTrapSrvObj=snmpTrapSrvObj, pciSlotTable=pciSlotTable, psBaseAddress=psBaseAddress, psIndex=psIndex, psDeviceID=psDeviceID, psModulePorts=psModulePorts, sysDeviceName=sysDeviceName, psModuleType=psModuleType, sysModuleID=sysModuleID, snmpTrapSrvIndex=snmpTrapSrvIndex, sysFirstBootTime=sysFirstBootTime, psDisplayName=psDisplayName, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvEntry=snmpTrapSrvEntry, psDescr=psDescr, snmpTrapSrvNumber=snmpTrapSrvNumber, atSystem=atSystem, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvPort=snmpTrapSrvPort, pciSlotEntry=pciSlotEntry, psVendorID=psVendorID, pciConfigObj=pciConfigObj, psSubsysDeviceID=psSubsysDeviceID, psClassCode=psClassCode, snmpTrapSrvIP=snmpTrapSrvIP, psManufacturer=psManufacturer, psBusIndex=psBusIndex, sysReleaseDate=sysReleaseDate, psIRQ=psIRQ, sysImageVersion=sysImageVersion, psState=psState, sysBootCount=sysBootCount, sysBootTime=sysBootTime, advantechCommonMIB=advantechCommonMIB, psLocation=psLocation, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapVersion=snmpTrapVersion, psNumber=psNumber, sysDescr=sysDescr, advantech=advantech, psFunctionIndex=psFunctionIndex, psLength=psLength, psSubsysVendorID=psSubsysVendorID, atMgmt=atMgmt, atPciConfig=atPciConfig)
