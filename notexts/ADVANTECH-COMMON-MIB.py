...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysBootCount=sysBootCount, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psClassCode=psClassCode, snmpTrapSrvIP=snmpTrapSrvIP, psDeviceID=psDeviceID, sysReleaseDate=sysReleaseDate, psBaseAddress=psBaseAddress, psLength=psLength, psDisplayName=psDisplayName, snmpTrapSrvTable=snmpTrapSrvTable, psSubsysVendorID=psSubsysVendorID, atPciConfig=atPciConfig, psBusIndex=psBusIndex, advantechCommonMIB=advantechCommonMIB, pciSlotTable=pciSlotTable, snmpTrapSrvNumber=snmpTrapSrvNumber, psManufacturer=psManufacturer, psModulePorts=psModulePorts, pciSlotEntry=pciSlotEntry, sysBootTime=sysBootTime, pciConfigObj=pciConfigObj, snmpTrapSrvEntry=snmpTrapSrvEntry, sysImageVersion=sysImageVersion, snmpTrapVersion=snmpTrapVersion, psVendorID=psVendorID, psNumber=psNumber, psLocation=psLocation, psModuleType=psModuleType, advantech=advantech, snmpTrapSrvIndex=snmpTrapSrvIndex, sysModuleID=sysModuleID, psDescr=psDescr, psState=psState, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psSubsysDeviceID=psSubsysDeviceID, sysDescr=sysDescr, psIRQ=psIRQ, sysDeviceName=sysDeviceName, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvPort=snmpTrapSrvPort, psFunctionIndex=psFunctionIndex, snmpTrapSrvObj=snmpTrapSrvObj, atSystem=atSystem, psDeviceIndex=psDeviceIndex, sysFirstBootTime=sysFirstBootTime, atMgmt=atMgmt, psIndex=psIndex)
