...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psState=psState, atPciConfig=atPciConfig, psIRQ=psIRQ, snmpTrapSrvObj=snmpTrapSrvObj, pciConfigObj=pciConfigObj, psNumber=psNumber, sysBootCount=sysBootCount, sysModuleID=sysModuleID, PYSNMP_MODULE_ID=advantechCommonMIB, psVendorID=psVendorID, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvEntry=snmpTrapSrvEntry, psDisplayName=psDisplayName, snmpTrapSrvIndex=snmpTrapSrvIndex, psModuleType=psModuleType, sysFirstBootTime=sysFirstBootTime, sysBootTime=sysBootTime, snmpTrapVersion=snmpTrapVersion, psBusIndex=psBusIndex, psManufacturer=psManufacturer, psModulePorts=psModulePorts, sysDescr=sysDescr, snmpTrapSrvIP=snmpTrapSrvIP, psDeviceIndex=psDeviceIndex, psClassCode=psClassCode, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysDeviceName=sysDeviceName, snmpTrapSrvTable=snmpTrapSrvTable, psDescr=psDescr, atSystem=atSystem, psSubsysDeviceID=psSubsysDeviceID, pciSlotEntry=pciSlotEntry, psSubsysVendorID=psSubsysVendorID, sysReleaseDate=sysReleaseDate, psIndex=psIndex, pciSlotTable=pciSlotTable, psLength=psLength, psDeviceID=psDeviceID, snmpTrapSrvPort=snmpTrapSrvPort, psBaseAddress=psBaseAddress, sysImageVersion=sysImageVersion, atMgmt=atMgmt, advantechCommonMIB=advantechCommonMIB, psLocation=psLocation, advantech=advantech, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psFunctionIndex=psFunctionIndex)
