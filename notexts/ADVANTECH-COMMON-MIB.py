...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvCommunity=snmpTrapSrvCommunity, psLength=psLength, psDeviceIndex=psDeviceIndex, psFunctionIndex=psFunctionIndex, pciSlotTable=pciSlotTable, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvObj=snmpTrapSrvObj, psBusIndex=psBusIndex, sysReleaseDate=sysReleaseDate, psNumber=psNumber, psIndex=psIndex, psIRQ=psIRQ, atPciConfig=atPciConfig, psManufacturer=psManufacturer, atMgmt=atMgmt, psDisplayName=psDisplayName, sysImageVersion=sysImageVersion, snmpTrapSrvNumber=snmpTrapSrvNumber, psDescr=psDescr, psVendorID=psVendorID, psModuleType=psModuleType, pciSlotEntry=pciSlotEntry, advantech=advantech, psLocation=psLocation, sysDescr=sysDescr, psBaseAddress=psBaseAddress, atSystem=atSystem, sysDeviceName=sysDeviceName, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysBootCount=sysBootCount, psState=psState, psModulePorts=psModulePorts, sysModuleID=sysModuleID, psSubsysVendorID=psSubsysVendorID, psDeviceID=psDeviceID, snmpTrapVersion=snmpTrapVersion, pciConfigObj=pciConfigObj, sysBootTime=sysBootTime, psClassCode=psClassCode, PYSNMP_MODULE_ID=advantechCommonMIB, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvIP=snmpTrapSrvIP, psSubsysDeviceID=psSubsysDeviceID)
