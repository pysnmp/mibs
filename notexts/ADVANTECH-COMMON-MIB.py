...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", advantechCommonMIB=advantechCommonMIB, psLocation=psLocation, psDeviceID=psDeviceID, pciSlotEntry=pciSlotEntry, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, advantech=advantech, atSystem=atSystem, psIndex=psIndex, psModuleType=psModuleType, psModulePorts=psModulePorts, atPciConfig=atPciConfig, pciSlotTable=pciSlotTable, psBaseAddress=psBaseAddress, psVendorID=psVendorID, snmpTrapSrvTable=snmpTrapSrvTable, psIRQ=psIRQ, psDescr=psDescr, sysImageVersion=sysImageVersion, snmpTrapVersion=snmpTrapVersion, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvIP=snmpTrapSrvIP, psManufacturer=psManufacturer, psState=psState, snmpTrapSrvNumber=snmpTrapSrvNumber, psDisplayName=psDisplayName, snmpTrapSrvObj=snmpTrapSrvObj, psDeviceIndex=psDeviceIndex, sysBootCount=sysBootCount, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvCommunity=snmpTrapSrvCommunity, pciConfigObj=pciConfigObj, atMgmt=atMgmt, snmpTrapSrvPort=snmpTrapSrvPort, sysBootTime=sysBootTime, psNumber=psNumber, psSubsysDeviceID=psSubsysDeviceID, psBusIndex=psBusIndex, PYSNMP_MODULE_ID=advantechCommonMIB, psFunctionIndex=psFunctionIndex, sysDescr=sysDescr, psClassCode=psClassCode, sysModuleID=sysModuleID, psLength=psLength, sysDeviceName=sysDeviceName, sysReleaseDate=sysReleaseDate)
