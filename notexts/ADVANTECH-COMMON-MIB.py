...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psFunctionIndex=psFunctionIndex, atPciConfig=atPciConfig, sysModuleID=sysModuleID, psIndex=psIndex, snmpTrapVersion=snmpTrapVersion, advantechCommonMIB=advantechCommonMIB, sysImageVersion=sysImageVersion, psDeviceIndex=psDeviceIndex, psBusIndex=psBusIndex, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvIP=snmpTrapSrvIP, psDescr=psDescr, sysBootTime=sysBootTime, psNumber=psNumber, snmpTrapSrvPort=snmpTrapSrvPort, atMgmt=atMgmt, psBaseAddress=psBaseAddress, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysDeviceName=sysDeviceName, psSubsysDeviceID=psSubsysDeviceID, pciConfigObj=pciConfigObj, psVendorID=psVendorID, sysReleaseDate=sysReleaseDate, snmpTrapSrvIndex=snmpTrapSrvIndex, psModulePorts=psModulePorts, psManufacturer=psManufacturer, psLocation=psLocation, psModuleType=psModuleType, snmpTrapSrvNumber=snmpTrapSrvNumber, psDeviceID=psDeviceID, snmpTrapSrvTable=snmpTrapSrvTable, sysFirstBootTime=sysFirstBootTime, atSystem=atSystem, pciSlotTable=pciSlotTable, psClassCode=psClassCode, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psIRQ=psIRQ, PYSNMP_MODULE_ID=advantechCommonMIB, advantech=advantech, sysBootCount=sysBootCount, snmpTrapSrvObj=snmpTrapSrvObj, psDisplayName=psDisplayName, pciSlotEntry=pciSlotEntry, psLength=psLength, snmpTrapSrvEntry=snmpTrapSrvEntry, psState=psState, sysDescr=sysDescr)
