...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysModuleID=sysModuleID, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvPort=snmpTrapSrvPort, atPciConfig=atPciConfig, psVendorID=psVendorID, snmpTrapSrvCommunity=snmpTrapSrvCommunity, advantech=advantech, advantechCommonMIB=advantechCommonMIB, sysReleaseDate=sysReleaseDate, sysBootTime=sysBootTime, psDeviceIndex=psDeviceIndex, pciConfigObj=pciConfigObj, psState=psState, psFunctionIndex=psFunctionIndex, PYSNMP_MODULE_ID=advantechCommonMIB, psDescr=psDescr, psClassCode=psClassCode, psNumber=psNumber, psIndex=psIndex, psIRQ=psIRQ, psBaseAddress=psBaseAddress, sysFirstBootTime=sysFirstBootTime, pciSlotEntry=pciSlotEntry, psManufacturer=psManufacturer, psSubsysVendorID=psSubsysVendorID, atSystem=atSystem, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvTable=snmpTrapSrvTable, pciSlotTable=pciSlotTable, atMgmt=atMgmt, sysDescr=sysDescr, sysImageVersion=sysImageVersion, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvNumber=snmpTrapSrvNumber, sysDeviceName=sysDeviceName, psSubsysDeviceID=psSubsysDeviceID, psLocation=psLocation, psModulePorts=psModulePorts, sysBootCount=sysBootCount, psBusIndex=psBusIndex, psModuleType=psModuleType, psDisplayName=psDisplayName, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvIP=snmpTrapSrvIP, psLength=psLength, psDeviceID=psDeviceID)
