...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psIndex=psIndex, sysModuleID=sysModuleID, psState=psState, psBusIndex=psBusIndex, PYSNMP_MODULE_ID=advantechCommonMIB, pciSlotTable=pciSlotTable, snmpTrapSrvObj=snmpTrapSrvObj, psBaseAddress=psBaseAddress, psNumber=psNumber, sysDeviceName=sysDeviceName, psLocation=psLocation, atPciConfig=atPciConfig, psClassCode=psClassCode, snmpTrapSrvPort=snmpTrapSrvPort, pciSlotEntry=pciSlotEntry, psVendorID=psVendorID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysDescr=sysDescr, pciConfigObj=pciConfigObj, advantechCommonMIB=advantechCommonMIB, psDescr=psDescr, snmpTrapSrvTable=snmpTrapSrvTable, sysBootCount=sysBootCount, psDeviceID=psDeviceID, sysBootTime=sysBootTime, snmpTrapSrvNumber=snmpTrapSrvNumber, psLength=psLength, psDisplayName=psDisplayName, snmpTrapVersion=snmpTrapVersion, atSystem=atSystem, psSubsysDeviceID=psSubsysDeviceID, psSubsysVendorID=psSubsysVendorID, sysImageVersion=sysImageVersion, psIRQ=psIRQ, snmpTrapSrvIP=snmpTrapSrvIP, psFunctionIndex=psFunctionIndex, psModuleType=psModuleType, psManufacturer=psManufacturer, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysFirstBootTime=sysFirstBootTime, advantech=advantech, atMgmt=atMgmt, psModulePorts=psModulePorts, snmpTrapSrvEntry=snmpTrapSrvEntry, psDeviceIndex=psDeviceIndex, snmpTrapSrvIndex=snmpTrapSrvIndex, sysReleaseDate=sysReleaseDate)
