...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psManufacturer=psManufacturer, snmpTrapSrvObj=snmpTrapSrvObj, psIRQ=psIRQ, psState=psState, snmpTrapVersion=snmpTrapVersion, psSubsysVendorID=psSubsysVendorID, psLength=psLength, psBaseAddress=psBaseAddress, psNumber=psNumber, sysFirstBootTime=sysFirstBootTime, sysModuleID=sysModuleID, sysDeviceName=sysDeviceName, atMgmt=atMgmt, advantech=advantech, psClassCode=psClassCode, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvNumber=snmpTrapSrvNumber, psFunctionIndex=psFunctionIndex, snmpTrapSrvIP=snmpTrapSrvIP, psDisplayName=psDisplayName, psDescr=psDescr, pciSlotTable=pciSlotTable, sysDescr=sysDescr, psVendorID=psVendorID, psBusIndex=psBusIndex, sysBootTime=sysBootTime, pciConfigObj=pciConfigObj, psIndex=psIndex, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psDeviceIndex=psDeviceIndex, snmpTrapSrvIndex=snmpTrapSrvIndex, pciSlotEntry=pciSlotEntry, psModuleType=psModuleType, sysImageVersion=sysImageVersion, atSystem=atSystem, sysReleaseDate=sysReleaseDate, snmpTrapSrvPort=snmpTrapSrvPort, psLocation=psLocation, snmpTrapSrvTable=snmpTrapSrvTable, psDeviceID=psDeviceID, atPciConfig=atPciConfig, psModulePorts=psModulePorts, sysBootCount=sysBootCount, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication)
