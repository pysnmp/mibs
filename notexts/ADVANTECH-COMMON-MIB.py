...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ObjectIdentity, IpAddress, enterprises, TimeTicks, iso, NotificationType, ModuleIdentity, Unsigned32, Gauge32, Bits, Counter64, Integer32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ObjectIdentity", "IpAddress", "enterprises", "TimeTicks", "iso", "NotificationType", "ModuleIdentity", "Unsigned32", "Gauge32", "Bits", "Counter64", "Integer32", "MibIdentifier")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psFunctionIndex=psFunctionIndex, psLength=psLength, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psDisplayName=psDisplayName, psDeviceID=psDeviceID, psVendorID=psVendorID, psLocation=psLocation, psModulePorts=psModulePorts, snmpTrapSrvIP=snmpTrapSrvIP, psBusIndex=psBusIndex, pciConfigObj=pciConfigObj, pciSlotTable=pciSlotTable, PYSNMP_MODULE_ID=advantechCommonMIB, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvNumber=snmpTrapSrvNumber, sysDescr=sysDescr, sysImageVersion=sysImageVersion, psSubsysDeviceID=psSubsysDeviceID, psIndex=psIndex, atPciConfig=atPciConfig, psIRQ=psIRQ, snmpTrapSrvPort=snmpTrapSrvPort, atSystem=atSystem, sysDeviceName=sysDeviceName, snmpTrapSrvEntry=snmpTrapSrvEntry, psDeviceIndex=psDeviceIndex, snmpTrapSrvTable=snmpTrapSrvTable, psModuleType=psModuleType, snmpTrapSrvObj=snmpTrapSrvObj, sysModuleID=sysModuleID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psManufacturer=psManufacturer, snmpTrapSrvIndex=snmpTrapSrvIndex, advantechCommonMIB=advantechCommonMIB, psBaseAddress=psBaseAddress, advantech=advantech, psSubsysVendorID=psSubsysVendorID, sysBootTime=sysBootTime, snmpTrapVersion=snmpTrapVersion, pciSlotEntry=pciSlotEntry, psNumber=psNumber, psClassCode=psClassCode, psState=psState, sysBootCount=sysBootCount, sysReleaseDate=sysReleaseDate, psDescr=psDescr, atMgmt=atMgmt)
