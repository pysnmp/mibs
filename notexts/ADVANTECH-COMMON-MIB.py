...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvObj=snmpTrapSrvObj, psLocation=psLocation, psBaseAddress=psBaseAddress, PYSNMP_MODULE_ID=advantechCommonMIB, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvEntry=snmpTrapSrvEntry, psState=psState, psIndex=psIndex, atMgmt=atMgmt, psSubsysDeviceID=psSubsysDeviceID, psFunctionIndex=psFunctionIndex, pciConfigObj=pciConfigObj, sysImageVersion=sysImageVersion, snmpTrapSrvPort=snmpTrapSrvPort, sysBootTime=sysBootTime, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psDeviceIndex=psDeviceIndex, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psDisplayName=psDisplayName, psModulePorts=psModulePorts, psDescr=psDescr, psLength=psLength, pciSlotTable=pciSlotTable, atSystem=atSystem, sysDeviceName=sysDeviceName, psVendorID=psVendorID, psManufacturer=psManufacturer, pciSlotEntry=pciSlotEntry, sysBootCount=sysBootCount, snmpTrapSrvNumber=snmpTrapSrvNumber, sysReleaseDate=sysReleaseDate, advantech=advantech, psBusIndex=psBusIndex, sysDescr=sysDescr, snmpTrapVersion=snmpTrapVersion, psIRQ=psIRQ, snmpTrapSrvTable=snmpTrapSrvTable, psClassCode=psClassCode, sysModuleID=sysModuleID, psNumber=psNumber, psModuleType=psModuleType, snmpTrapSrvIP=snmpTrapSrvIP, psSubsysVendorID=psSubsysVendorID, psDeviceID=psDeviceID, atPciConfig=atPciConfig, snmpTrapSrvIndex=snmpTrapSrvIndex)
