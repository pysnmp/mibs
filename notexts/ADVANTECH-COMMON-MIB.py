...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", advantech=advantech, psDescr=psDescr, psModuleType=psModuleType, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvIndex=snmpTrapSrvIndex, psLocation=psLocation, psLength=psLength, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvNumber=snmpTrapSrvNumber, psBaseAddress=psBaseAddress, psSubsysDeviceID=psSubsysDeviceID, sysImageVersion=sysImageVersion, snmpTrapSrvIP=snmpTrapSrvIP, psDisplayName=psDisplayName, psVendorID=psVendorID, psDeviceID=psDeviceID, atSystem=atSystem, psModulePorts=psModulePorts, psManufacturer=psManufacturer, psClassCode=psClassCode, atPciConfig=atPciConfig, psSubsysVendorID=psSubsysVendorID, sysModuleID=sysModuleID, pciConfigObj=pciConfigObj, psIndex=psIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, atMgmt=atMgmt, snmpTrapSrvObj=snmpTrapSrvObj, psIRQ=psIRQ, sysBootTime=sysBootTime, snmpTrapSrvPort=snmpTrapSrvPort, sysDeviceName=sysDeviceName, pciSlotTable=pciSlotTable, sysFirstBootTime=sysFirstBootTime, PYSNMP_MODULE_ID=advantechCommonMIB, sysDescr=sysDescr, psFunctionIndex=psFunctionIndex, advantechCommonMIB=advantechCommonMIB, psDeviceIndex=psDeviceIndex, psBusIndex=psBusIndex, sysReleaseDate=sysReleaseDate, snmpTrapSrvEntry=snmpTrapSrvEntry, psState=psState, sysBootCount=sysBootCount, psNumber=psNumber, pciSlotEntry=pciSlotEntry)
