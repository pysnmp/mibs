...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvPort=snmpTrapSrvPort, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapVersion=snmpTrapVersion, psDescr=psDescr, psDeviceID=psDeviceID, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysDescr=sysDescr, sysImageVersion=sysImageVersion, atSystem=atSystem, psNumber=psNumber, psFunctionIndex=psFunctionIndex, psVendorID=psVendorID, psDeviceIndex=psDeviceIndex, pciConfigObj=pciConfigObj, psModuleType=psModuleType, sysModuleID=sysModuleID, psDisplayName=psDisplayName, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvNumber=snmpTrapSrvNumber, sysBootCount=sysBootCount, advantech=advantech, psState=psState, pciSlotTable=pciSlotTable, psBaseAddress=psBaseAddress, psClassCode=psClassCode, sysDeviceName=sysDeviceName, snmpTrapSrvIndex=snmpTrapSrvIndex, psIRQ=psIRQ, atMgmt=atMgmt, psBusIndex=psBusIndex, psManufacturer=psManufacturer, sysFirstBootTime=sysFirstBootTime, psSubsysVendorID=psSubsysVendorID, psModulePorts=psModulePorts, atPciConfig=atPciConfig, snmpTrapSrvIP=snmpTrapSrvIP, psLength=psLength, psLocation=psLocation, pciSlotEntry=pciSlotEntry, psSubsysDeviceID=psSubsysDeviceID, sysReleaseDate=sysReleaseDate, psIndex=psIndex, sysBootTime=sysBootTime, snmpTrapSrvObj=snmpTrapSrvObj)
