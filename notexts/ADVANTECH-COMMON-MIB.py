...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapVersion=snmpTrapVersion, snmpTrapSrvIndex=snmpTrapSrvIndex, psDisplayName=psDisplayName, psNumber=psNumber, psFunctionIndex=psFunctionIndex, psModulePorts=psModulePorts, snmpTrapSrvEntry=snmpTrapSrvEntry, psState=psState, psClassCode=psClassCode, sysFirstBootTime=sysFirstBootTime, sysBootTime=sysBootTime, psManufacturer=psManufacturer, psVendorID=psVendorID, snmpTrapSrvObj=snmpTrapSrvObj, advantech=advantech, PYSNMP_MODULE_ID=advantechCommonMIB, psBaseAddress=psBaseAddress, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psLength=psLength, psSubsysVendorID=psSubsysVendorID, psSubsysDeviceID=psSubsysDeviceID, sysReleaseDate=sysReleaseDate, advantechCommonMIB=advantechCommonMIB, psBusIndex=psBusIndex, psModuleType=psModuleType, pciConfigObj=pciConfigObj, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvNumber=snmpTrapSrvNumber, psDeviceID=psDeviceID, psIndex=psIndex, pciSlotEntry=pciSlotEntry, sysBootCount=sysBootCount, sysModuleID=sysModuleID, atMgmt=atMgmt, sysDescr=sysDescr, psDescr=psDescr, sysImageVersion=sysImageVersion, pciSlotTable=pciSlotTable, psIRQ=psIRQ, psDeviceIndex=psDeviceIndex, atSystem=atSystem, atPciConfig=atPciConfig, psLocation=psLocation, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvTable=snmpTrapSrvTable, sysDeviceName=sysDeviceName)
