...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psSubsysVendorID=psSubsysVendorID, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvNumber=snmpTrapSrvNumber, sysBootCount=sysBootCount, pciSlotEntry=pciSlotEntry, psDescr=psDescr, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, atSystem=atSystem, psIRQ=psIRQ, snmpTrapSrvIndex=snmpTrapSrvIndex, advantechCommonMIB=advantechCommonMIB, psLength=psLength, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psState=psState, sysBootTime=sysBootTime, atMgmt=atMgmt, snmpTrapSrvTable=snmpTrapSrvTable, psIndex=psIndex, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvEntry=snmpTrapSrvEntry, pciConfigObj=pciConfigObj, sysModuleID=sysModuleID, sysDeviceName=sysDeviceName, psNumber=psNumber, advantech=advantech, psBaseAddress=psBaseAddress, sysReleaseDate=sysReleaseDate, psDeviceIndex=psDeviceIndex, psSubsysDeviceID=psSubsysDeviceID, psManufacturer=psManufacturer, psFunctionIndex=psFunctionIndex, psModulePorts=psModulePorts, atPciConfig=atPciConfig, psLocation=psLocation, snmpTrapSrvPort=snmpTrapSrvPort, sysDescr=sysDescr, psBusIndex=psBusIndex, psModuleType=psModuleType, psDisplayName=psDisplayName, pciSlotTable=pciSlotTable, psVendorID=psVendorID, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvIP=snmpTrapSrvIP, psClassCode=psClassCode, psDeviceID=psDeviceID, sysImageVersion=sysImageVersion)
