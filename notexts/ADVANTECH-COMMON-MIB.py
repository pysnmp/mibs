...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysFirstBootTime=sysFirstBootTime, psIndex=psIndex, snmpTrapSrvObj=snmpTrapSrvObj, psDeviceIndex=psDeviceIndex, psDeviceID=psDeviceID, psFunctionIndex=psFunctionIndex, psState=psState, psModuleType=psModuleType, atMgmt=atMgmt, sysImageVersion=sysImageVersion, snmpTrapSrvPort=snmpTrapSrvPort, psSubsysVendorID=psSubsysVendorID, psBaseAddress=psBaseAddress, sysModuleID=sysModuleID, snmpTrapSrvCommunity=snmpTrapSrvCommunity, pciSlotTable=pciSlotTable, psVendorID=psVendorID, snmpTrapSrvEntry=snmpTrapSrvEntry, psLength=psLength, psIRQ=psIRQ, sysBootTime=sysBootTime, sysReleaseDate=sysReleaseDate, sysBootCount=sysBootCount, sysDescr=sysDescr, snmpTrapVersion=snmpTrapVersion, psManufacturer=psManufacturer, psDisplayName=psDisplayName, sysDeviceName=sysDeviceName, advantech=advantech, pciConfigObj=pciConfigObj, psLocation=psLocation, snmpTrapSrvNumber=snmpTrapSrvNumber, atPciConfig=atPciConfig, psBusIndex=psBusIndex, psClassCode=psClassCode, snmpTrapSrvIP=snmpTrapSrvIP, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvIndex=snmpTrapSrvIndex, pciSlotEntry=pciSlotEntry, snmpTrapSrvTable=snmpTrapSrvTable, psDescr=psDescr, atSystem=atSystem, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, advantechCommonMIB=advantechCommonMIB, psNumber=psNumber, psModulePorts=psModulePorts)
