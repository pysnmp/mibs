...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysImageVersion=sysImageVersion, pciSlotTable=pciSlotTable, psDeviceID=psDeviceID, psClassCode=psClassCode, snmpTrapSrvEntry=snmpTrapSrvEntry, psDeviceIndex=psDeviceIndex, snmpTrapSrvPort=snmpTrapSrvPort, psModulePorts=psModulePorts, atPciConfig=atPciConfig, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvNumber=snmpTrapSrvNumber, psSubsysDeviceID=psSubsysDeviceID, sysBootTime=sysBootTime, snmpTrapVersion=snmpTrapVersion, atSystem=atSystem, pciConfigObj=pciConfigObj, psDescr=psDescr, psState=psState, sysDescr=sysDescr, psNumber=psNumber, advantech=advantech, sysModuleID=sysModuleID, pciSlotEntry=pciSlotEntry, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, atMgmt=atMgmt, psSubsysVendorID=psSubsysVendorID, sysBootCount=sysBootCount, psVendorID=psVendorID, psLength=psLength, psDisplayName=psDisplayName, snmpTrapSrvIP=snmpTrapSrvIP, PYSNMP_MODULE_ID=advantechCommonMIB, advantechCommonMIB=advantechCommonMIB, psLocation=psLocation, psFunctionIndex=psFunctionIndex, snmpTrapSrvIndex=snmpTrapSrvIndex, sysDeviceName=sysDeviceName, snmpTrapSrvObj=snmpTrapSrvObj, psManufacturer=psManufacturer, psBaseAddress=psBaseAddress, psIRQ=psIRQ, psIndex=psIndex, psBusIndex=psBusIndex, sysReleaseDate=sysReleaseDate, psModuleType=psModuleType, sysFirstBootTime=sysFirstBootTime)
