...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psSubsysDeviceID=psSubsysDeviceID, pciSlotTable=pciSlotTable, snmpTrapSrvNumber=snmpTrapSrvNumber, psNumber=psNumber, pciSlotEntry=pciSlotEntry, advantechCommonMIB=advantechCommonMIB, sysReleaseDate=sysReleaseDate, snmpTrapSrvTable=snmpTrapSrvTable, psDescr=psDescr, sysModuleID=sysModuleID, psLocation=psLocation, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvPort=snmpTrapSrvPort, psModuleType=psModuleType, sysDescr=sysDescr, psIndex=psIndex, psVendorID=psVendorID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysFirstBootTime=sysFirstBootTime, atMgmt=atMgmt, psSubsysVendorID=psSubsysVendorID, advantech=advantech, psClassCode=psClassCode, sysDeviceName=sysDeviceName, psState=psState, psIRQ=psIRQ, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvIP=snmpTrapSrvIP, psDeviceID=psDeviceID, psManufacturer=psManufacturer, atSystem=atSystem, sysImageVersion=sysImageVersion, psBusIndex=psBusIndex, psBaseAddress=psBaseAddress, pciConfigObj=pciConfigObj, psModulePorts=psModulePorts, snmpTrapSrvEntry=snmpTrapSrvEntry, atPciConfig=atPciConfig, psDeviceIndex=psDeviceIndex, sysBootTime=sysBootTime, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapVersion=snmpTrapVersion, psLength=psLength, psFunctionIndex=psFunctionIndex, psDisplayName=psDisplayName, sysBootCount=sysBootCount, snmpTrapSrvCommunity=snmpTrapSrvCommunity)
