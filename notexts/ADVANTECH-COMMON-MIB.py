...
Integer32, Unsigned32, MibIdentifier, iso, TimeTicks, enterprises, IpAddress, ObjectIdentity, Counter32, Counter64, Bits, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "MibIdentifier", "iso", "TimeTicks", "enterprises", "IpAddress", "ObjectIdentity", "Counter32", "Counter64", "Bits", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psIndex=psIndex, sysReleaseDate=sysReleaseDate, sysBootTime=sysBootTime, snmpTrapSrvPort=snmpTrapSrvPort, psDeviceID=psDeviceID, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvIP=snmpTrapSrvIP, psBusIndex=psBusIndex, sysDescr=sysDescr, snmpTrapSrvTable=snmpTrapSrvTable, psSubsysDeviceID=psSubsysDeviceID, psVendorID=psVendorID, sysModuleID=sysModuleID, psClassCode=psClassCode, psModulePorts=psModulePorts, sysFirstBootTime=sysFirstBootTime, psDescr=psDescr, pciConfigObj=pciConfigObj, psIRQ=psIRQ, psDisplayName=psDisplayName, sysDeviceName=sysDeviceName, psLength=psLength, psManufacturer=psManufacturer, sysImageVersion=sysImageVersion, snmpTrapSrvEntry=snmpTrapSrvEntry, atSystem=atSystem, advantechCommonMIB=advantechCommonMIB, PYSNMP_MODULE_ID=advantechCommonMIB, atPciConfig=atPciConfig, pciSlotTable=pciSlotTable, psBaseAddress=psBaseAddress, snmpTrapSrvObj=snmpTrapSrvObj, psDeviceIndex=psDeviceIndex, psModuleType=psModuleType, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psNumber=psNumber, atMgmt=atMgmt, snmpTrapSrvNumber=snmpTrapSrvNumber, psFunctionIndex=psFunctionIndex, snmpTrapSrvIndex=snmpTrapSrvIndex, sysBootCount=sysBootCount, snmpTrapVersion=snmpTrapVersion, psState=psState, snmpTrapSrvCommunity=snmpTrapSrvCommunity, pciSlotEntry=pciSlotEntry, psLocation=psLocation, advantech=advantech)
