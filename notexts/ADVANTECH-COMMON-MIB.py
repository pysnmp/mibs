...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psSubsysVendorID=psSubsysVendorID, sysFirstBootTime=sysFirstBootTime, sysReleaseDate=sysReleaseDate, psIndex=psIndex, psClassCode=psClassCode, psDeviceID=psDeviceID, sysBootCount=sysBootCount, psSubsysDeviceID=psSubsysDeviceID, psBaseAddress=psBaseAddress, psModuleType=psModuleType, psBusIndex=psBusIndex, psDisplayName=psDisplayName, snmpTrapSrvTable=snmpTrapSrvTable, advantech=advantech, psNumber=psNumber, sysImageVersion=sysImageVersion, atMgmt=atMgmt, sysDescr=sysDescr, sysDeviceName=sysDeviceName, snmpTrapSrvIP=snmpTrapSrvIP, atSystem=atSystem, snmpTrapVersion=snmpTrapVersion, pciSlotEntry=pciSlotEntry, snmpTrapSrvNumber=snmpTrapSrvNumber, sysBootTime=sysBootTime, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psLength=psLength, snmpTrapSrvPort=snmpTrapSrvPort, sysModuleID=sysModuleID, pciSlotTable=pciSlotTable, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvIndex=snmpTrapSrvIndex, psLocation=psLocation, psManufacturer=psManufacturer, snmpTrapSrvEntry=snmpTrapSrvEntry, psIRQ=psIRQ, snmpTrapSrvObj=snmpTrapSrvObj, psModulePorts=psModulePorts, advantechCommonMIB=advantechCommonMIB, psFunctionIndex=psFunctionIndex, psDeviceIndex=psDeviceIndex, psState=psState, psDescr=psDescr, PYSNMP_MODULE_ID=advantechCommonMIB, pciConfigObj=pciConfigObj, atPciConfig=atPciConfig, psVendorID=psVendorID)
