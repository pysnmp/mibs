...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvIndex=snmpTrapSrvIndex, atSystem=atSystem, psManufacturer=psManufacturer, psIndex=psIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysModuleID=sysModuleID, PYSNMP_MODULE_ID=advantechCommonMIB, psDeviceID=psDeviceID, psDescr=psDescr, pciConfigObj=pciConfigObj, psClassCode=psClassCode, sysBootCount=sysBootCount, snmpTrapVersion=snmpTrapVersion, psSubsysVendorID=psSubsysVendorID, psBaseAddress=psBaseAddress, atMgmt=atMgmt, pciSlotTable=pciSlotTable, atPciConfig=atPciConfig, pciSlotEntry=pciSlotEntry, psVendorID=psVendorID, psLength=psLength, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psBusIndex=psBusIndex, sysDeviceName=sysDeviceName, psIRQ=psIRQ, psState=psState, sysFirstBootTime=sysFirstBootTime, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvTable=snmpTrapSrvTable, sysImageVersion=sysImageVersion, psModuleType=psModuleType, psFunctionIndex=psFunctionIndex, psNumber=psNumber, snmpTrapSrvNumber=snmpTrapSrvNumber, advantech=advantech, psDeviceIndex=psDeviceIndex, sysDescr=sysDescr, snmpTrapSrvIP=snmpTrapSrvIP, sysBootTime=sysBootTime, psDisplayName=psDisplayName, psModulePorts=psModulePorts, snmpTrapSrvObj=snmpTrapSrvObj, psLocation=psLocation, sysReleaseDate=sysReleaseDate)
