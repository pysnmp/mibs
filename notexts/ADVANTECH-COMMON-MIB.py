...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psLocation=psLocation, sysReleaseDate=sysReleaseDate, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psModulePorts=psModulePorts, pciSlotEntry=pciSlotEntry, psBaseAddress=psBaseAddress, snmpTrapSrvIndex=snmpTrapSrvIndex, atMgmt=atMgmt, psIRQ=psIRQ, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvPort=snmpTrapSrvPort, sysModuleID=sysModuleID, psLength=psLength, psBusIndex=psBusIndex, psManufacturer=psManufacturer, psDeviceIndex=psDeviceIndex, psFunctionIndex=psFunctionIndex, atSystem=atSystem, psIndex=psIndex, psVendorID=psVendorID, snmpTrapSrvObj=snmpTrapSrvObj, psNumber=psNumber, snmpTrapSrvTable=snmpTrapSrvTable, psState=psState, sysBootCount=sysBootCount, snmpTrapSrvIP=snmpTrapSrvIP, advantech=advantech, sysDeviceName=sysDeviceName, pciConfigObj=pciConfigObj, pciSlotTable=pciSlotTable, sysBootTime=sysBootTime, psModuleType=psModuleType, psDisplayName=psDisplayName, psDeviceID=psDeviceID, sysFirstBootTime=sysFirstBootTime, sysImageVersion=sysImageVersion, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvEntry=snmpTrapSrvEntry, psSubsysVendorID=psSubsysVendorID, psSubsysDeviceID=psSubsysDeviceID, psClassCode=psClassCode, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvNumber=snmpTrapSrvNumber, psDescr=psDescr, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysDescr=sysDescr, atPciConfig=atPciConfig)
