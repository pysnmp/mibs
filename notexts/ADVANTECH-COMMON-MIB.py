...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psManufacturer=psManufacturer, snmpTrapSrvEntry=snmpTrapSrvEntry, psDeviceIndex=psDeviceIndex, psLength=psLength, pciSlotTable=pciSlotTable, snmpTrapSrvIndex=snmpTrapSrvIndex, sysImageVersion=sysImageVersion, psNumber=psNumber, psVendorID=psVendorID, pciConfigObj=pciConfigObj, psIndex=psIndex, sysReleaseDate=sysReleaseDate, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psDeviceID=psDeviceID, pciSlotEntry=pciSlotEntry, psDescr=psDescr, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvNumber=snmpTrapSrvNumber, atPciConfig=atPciConfig, psIRQ=psIRQ, psModuleType=psModuleType, snmpTrapSrvTable=snmpTrapSrvTable, psBaseAddress=psBaseAddress, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysDescr=sysDescr, psDisplayName=psDisplayName, advantechCommonMIB=advantechCommonMIB, psSubsysDeviceID=psSubsysDeviceID, sysBootCount=sysBootCount, psState=psState, advantech=advantech, snmpTrapVersion=snmpTrapVersion, sysBootTime=sysBootTime, sysDeviceName=sysDeviceName, atSystem=atSystem, snmpTrapSrvPort=snmpTrapSrvPort, psFunctionIndex=psFunctionIndex, atMgmt=atMgmt, psLocation=psLocation, sysModuleID=sysModuleID, snmpTrapSrvObj=snmpTrapSrvObj, psModulePorts=psModulePorts, snmpTrapSrvIP=snmpTrapSrvIP, sysFirstBootTime=sysFirstBootTime, psBusIndex=psBusIndex, psClassCode=psClassCode)
