...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psSubsysVendorID=psSubsysVendorID, psIRQ=psIRQ, snmpTrapSrvObj=snmpTrapSrvObj, sysBootTime=sysBootTime, psSubsysDeviceID=psSubsysDeviceID, atMgmt=atMgmt, psBaseAddress=psBaseAddress, PYSNMP_MODULE_ID=advantechCommonMIB, sysDescr=sysDescr, psManufacturer=psManufacturer, advantechCommonMIB=advantechCommonMIB, snmpTrapVersion=snmpTrapVersion, psDescr=psDescr, psVendorID=psVendorID, sysReleaseDate=sysReleaseDate, psDeviceIndex=psDeviceIndex, psState=psState, snmpTrapSrvEntry=snmpTrapSrvEntry, psFunctionIndex=psFunctionIndex, sysDeviceName=sysDeviceName, psIndex=psIndex, atPciConfig=atPciConfig, snmpTrapSrvIndex=snmpTrapSrvIndex, sysImageVersion=sysImageVersion, psLocation=psLocation, psNumber=psNumber, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, pciConfigObj=pciConfigObj, sysModuleID=sysModuleID, snmpTrapSrvIP=snmpTrapSrvIP, pciSlotEntry=pciSlotEntry, psDisplayName=psDisplayName, pciSlotTable=pciSlotTable, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvPort=snmpTrapSrvPort, psModulePorts=psModulePorts, advantech=advantech, psBusIndex=psBusIndex, atSystem=atSystem, sysBootCount=sysBootCount, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psClassCode=psClassCode, psLength=psLength, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvNumber=snmpTrapSrvNumber, psDeviceID=psDeviceID, psModuleType=psModuleType)
