...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", atPciConfig=atPciConfig, psDisplayName=psDisplayName, psVendorID=psVendorID, psIRQ=psIRQ, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psState=psState, psManufacturer=psManufacturer, snmpTrapSrvNumber=snmpTrapSrvNumber, psBusIndex=psBusIndex, sysBootTime=sysBootTime, sysFirstBootTime=sysFirstBootTime, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psDescr=psDescr, psClassCode=psClassCode, psLocation=psLocation, atSystem=atSystem, snmpTrapVersion=snmpTrapVersion, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvEntry=snmpTrapSrvEntry, psNumber=psNumber, sysImageVersion=sysImageVersion, snmpTrapSrvIndex=snmpTrapSrvIndex, pciSlotTable=pciSlotTable, sysDescr=sysDescr, pciConfigObj=pciConfigObj, snmpTrapSrvIP=snmpTrapSrvIP, psIndex=psIndex, psModuleType=psModuleType, sysReleaseDate=sysReleaseDate, psSubsysVendorID=psSubsysVendorID, psBaseAddress=psBaseAddress, psFunctionIndex=psFunctionIndex, sysBootCount=sysBootCount, atMgmt=atMgmt, psLength=psLength, snmpTrapSrvPort=snmpTrapSrvPort, pciSlotEntry=pciSlotEntry, sysModuleID=sysModuleID, snmpTrapSrvTable=snmpTrapSrvTable, psDeviceID=psDeviceID, advantech=advantech, psModulePorts=psModulePorts, sysDeviceName=sysDeviceName, snmpTrapSrvObj=snmpTrapSrvObj, psDeviceIndex=psDeviceIndex, advantechCommonMIB=advantechCommonMIB)
