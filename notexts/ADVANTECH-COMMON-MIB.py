...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysDescr=sysDescr, psNumber=psNumber, snmpTrapSrvObj=snmpTrapSrvObj, advantech=advantech, sysModuleID=sysModuleID, psDeviceIndex=psDeviceIndex, psDescr=psDescr, psManufacturer=psManufacturer, psState=psState, snmpTrapSrvIP=snmpTrapSrvIP, psIRQ=psIRQ, psDeviceID=psDeviceID, atPciConfig=atPciConfig, atSystem=atSystem, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvTable=snmpTrapSrvTable, psSubsysDeviceID=psSubsysDeviceID, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvPort=snmpTrapSrvPort, sysReleaseDate=sysReleaseDate, psModulePorts=psModulePorts, atMgmt=atMgmt, sysBootTime=sysBootTime, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysDeviceName=sysDeviceName, sysBootCount=sysBootCount, pciSlotTable=pciSlotTable, psIndex=psIndex, snmpTrapSrvNumber=snmpTrapSrvNumber, psLength=psLength, psBusIndex=psBusIndex, snmpTrapVersion=snmpTrapVersion, psModuleType=psModuleType, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psBaseAddress=psBaseAddress, psLocation=psLocation, pciConfigObj=pciConfigObj, psFunctionIndex=psFunctionIndex, psDisplayName=psDisplayName, psVendorID=psVendorID, snmpTrapSrvIndex=snmpTrapSrvIndex, pciSlotEntry=pciSlotEntry, sysImageVersion=sysImageVersion, psClassCode=psClassCode, sysFirstBootTime=sysFirstBootTime, psSubsysVendorID=psSubsysVendorID, PYSNMP_MODULE_ID=advantechCommonMIB)
