...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psModuleType=psModuleType, snmpTrapSrvEntry=snmpTrapSrvEntry, psDeviceID=psDeviceID, pciSlotTable=pciSlotTable, sysBootCount=sysBootCount, advantech=advantech, psFunctionIndex=psFunctionIndex, psBaseAddress=psBaseAddress, sysDescr=sysDescr, psState=psState, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, atMgmt=atMgmt, snmpTrapVersion=snmpTrapVersion, psDescr=psDescr, snmpTrapSrvIP=snmpTrapSrvIP, pciConfigObj=pciConfigObj, psBusIndex=psBusIndex, psClassCode=psClassCode, sysBootTime=sysBootTime, atPciConfig=atPciConfig, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psIndex=psIndex, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvTable=snmpTrapSrvTable, psIRQ=psIRQ, snmpTrapSrvPort=snmpTrapSrvPort, sysModuleID=sysModuleID, psManufacturer=psManufacturer, PYSNMP_MODULE_ID=advantechCommonMIB, sysReleaseDate=sysReleaseDate, psDisplayName=psDisplayName, sysImageVersion=sysImageVersion, sysFirstBootTime=sysFirstBootTime, atSystem=atSystem, psVendorID=psVendorID, psSubsysVendorID=psSubsysVendorID, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvObj=snmpTrapSrvObj, psModulePorts=psModulePorts, psLocation=psLocation, pciSlotEntry=pciSlotEntry, psNumber=psNumber, snmpTrapSrvNumber=snmpTrapSrvNumber, psDeviceIndex=psDeviceIndex, psLength=psLength, sysDeviceName=sysDeviceName)
