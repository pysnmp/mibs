...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psVendorID=psVendorID, sysDescr=sysDescr, psDeviceID=psDeviceID, sysReleaseDate=sysReleaseDate, psIRQ=psIRQ, sysFirstBootTime=sysFirstBootTime, psManufacturer=psManufacturer, sysBootTime=sysBootTime, psFunctionIndex=psFunctionIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvIP=snmpTrapSrvIP, sysModuleID=sysModuleID, atMgmt=atMgmt, snmpTrapSrvTable=snmpTrapSrvTable, pciConfigObj=pciConfigObj, sysImageVersion=sysImageVersion, snmpTrapVersion=snmpTrapVersion, sysDeviceName=sysDeviceName, psSubsysVendorID=psSubsysVendorID, psSubsysDeviceID=psSubsysDeviceID, psDeviceIndex=psDeviceIndex, advantechCommonMIB=advantechCommonMIB, psModuleType=psModuleType, psDisplayName=psDisplayName, pciSlotEntry=pciSlotEntry, atPciConfig=atPciConfig, psState=psState, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvPort=snmpTrapSrvPort, psNumber=psNumber, snmpTrapSrvObj=snmpTrapSrvObj, psDescr=psDescr, psModulePorts=psModulePorts, psBaseAddress=psBaseAddress, psClassCode=psClassCode, psLength=psLength, atSystem=atSystem, advantech=advantech, pciSlotTable=pciSlotTable, psBusIndex=psBusIndex, psLocation=psLocation, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysBootCount=sysBootCount, psIndex=psIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvIndex=snmpTrapSrvIndex)
