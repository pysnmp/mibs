...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvIP=snmpTrapSrvIP, psDisplayName=psDisplayName, psLocation=psLocation, psLength=psLength, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psFunctionIndex=psFunctionIndex, advantech=advantech, psVendorID=psVendorID, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvTable=snmpTrapSrvTable, sysReleaseDate=sysReleaseDate, psBusIndex=psBusIndex, pciConfigObj=pciConfigObj, sysBootCount=sysBootCount, snmpTrapSrvObj=snmpTrapSrvObj, psSubsysDeviceID=psSubsysDeviceID, psDeviceIndex=psDeviceIndex, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvNumber=snmpTrapSrvNumber, psModuleType=psModuleType, psState=psState, pciSlotTable=pciSlotTable, snmpTrapSrvIndex=snmpTrapSrvIndex, advantechCommonMIB=advantechCommonMIB, psNumber=psNumber, sysDeviceName=sysDeviceName, snmpTrapSrvEntry=snmpTrapSrvEntry, psDescr=psDescr, psClassCode=psClassCode, psIRQ=psIRQ, pciSlotEntry=pciSlotEntry, psManufacturer=psManufacturer, sysBootTime=sysBootTime, sysModuleID=sysModuleID, atPciConfig=atPciConfig, psModulePorts=psModulePorts, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvPort=snmpTrapSrvPort, atMgmt=atMgmt, psIndex=psIndex, atSystem=atSystem, psBaseAddress=psBaseAddress, sysImageVersion=sysImageVersion, sysDescr=sysDescr, snmpTrapVersion=snmpTrapVersion, psDeviceID=psDeviceID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication)
