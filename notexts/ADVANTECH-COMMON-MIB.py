...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", advantech=advantech, psDeviceID=psDeviceID, sysFirstBootTime=sysFirstBootTime, atSystem=atSystem, sysBootCount=sysBootCount, advantechCommonMIB=advantechCommonMIB, psLocation=psLocation, snmpTrapSrvNumber=snmpTrapSrvNumber, psDeviceIndex=psDeviceIndex, psDisplayName=psDisplayName, psVendorID=psVendorID, atMgmt=atMgmt, psDescr=psDescr, psSubsysDeviceID=psSubsysDeviceID, sysImageVersion=sysImageVersion, psManufacturer=psManufacturer, psIndex=psIndex, psBusIndex=psBusIndex, psSubsysVendorID=psSubsysVendorID, psModulePorts=psModulePorts, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, pciSlotEntry=pciSlotEntry, psBaseAddress=psBaseAddress, pciConfigObj=pciConfigObj, psClassCode=psClassCode, psModuleType=psModuleType, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psFunctionIndex=psFunctionIndex, sysBootTime=sysBootTime, sysReleaseDate=sysReleaseDate, psIRQ=psIRQ, psNumber=psNumber, psState=psState, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvTable=snmpTrapSrvTable, atPciConfig=atPciConfig, pciSlotTable=pciSlotTable, snmpTrapSrvIndex=snmpTrapSrvIndex, sysDescr=sysDescr, sysDeviceName=sysDeviceName, snmpTrapVersion=snmpTrapVersion, psLength=psLength, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvObj=snmpTrapSrvObj, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvPort=snmpTrapSrvPort, sysModuleID=sysModuleID)
