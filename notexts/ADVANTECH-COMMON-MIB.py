...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psDeviceID=psDeviceID, psVendorID=psVendorID, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvNumber=snmpTrapSrvNumber, psNumber=psNumber, pciConfigObj=pciConfigObj, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvEntry=snmpTrapSrvEntry, sysBootCount=sysBootCount, sysFirstBootTime=sysFirstBootTime, psLocation=psLocation, psDeviceIndex=psDeviceIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psBusIndex=psBusIndex, atSystem=atSystem, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapVersion=snmpTrapVersion, atMgmt=atMgmt, sysBootTime=sysBootTime, psLength=psLength, pciSlotTable=pciSlotTable, psClassCode=psClassCode, psModuleType=psModuleType, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysReleaseDate=sysReleaseDate, psFunctionIndex=psFunctionIndex, snmpTrapSrvObj=snmpTrapSrvObj, advantech=advantech, sysDeviceName=sysDeviceName, sysDescr=sysDescr, psIRQ=psIRQ, psManufacturer=psManufacturer, psBaseAddress=psBaseAddress, psModulePorts=psModulePorts, pciSlotEntry=pciSlotEntry, atPciConfig=atPciConfig, psIndex=psIndex, snmpTrapSrvTable=snmpTrapSrvTable, sysModuleID=sysModuleID, sysImageVersion=sysImageVersion, snmpTrapSrvPort=snmpTrapSrvPort, psDescr=psDescr, psSubsysDeviceID=psSubsysDeviceID, PYSNMP_MODULE_ID=advantechCommonMIB, psState=psState, psDisplayName=psDisplayName)
