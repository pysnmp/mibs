...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysFirstBootTime=sysFirstBootTime, PYSNMP_MODULE_ID=advantechCommonMIB, psManufacturer=psManufacturer, psLength=psLength, psModuleType=psModuleType, advantechCommonMIB=advantechCommonMIB, sysDescr=sysDescr, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psIRQ=psIRQ, sysDeviceName=sysDeviceName, pciConfigObj=pciConfigObj, psDescr=psDescr, psDisplayName=psDisplayName, psState=psState, psDeviceID=psDeviceID, psLocation=psLocation, snmpTrapSrvObj=snmpTrapSrvObj, psVendorID=psVendorID, atPciConfig=atPciConfig, psSubsysDeviceID=psSubsysDeviceID, atMgmt=atMgmt, snmpTrapSrvNumber=snmpTrapSrvNumber, pciSlotEntry=pciSlotEntry, sysBootCount=sysBootCount, psClassCode=psClassCode, psDeviceIndex=psDeviceIndex, psBaseAddress=psBaseAddress, psIndex=psIndex, snmpTrapSrvPort=snmpTrapSrvPort, psFunctionIndex=psFunctionIndex, sysImageVersion=sysImageVersion, pciSlotTable=pciSlotTable, sysModuleID=sysModuleID, sysReleaseDate=sysReleaseDate, psSubsysVendorID=psSubsysVendorID, advantech=advantech, snmpTrapSrvIndex=snmpTrapSrvIndex, psNumber=psNumber, psBusIndex=psBusIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysBootTime=sysBootTime, snmpTrapSrvEntry=snmpTrapSrvEntry, psModulePorts=psModulePorts, snmpTrapSrvTable=snmpTrapSrvTable, atSystem=atSystem)
