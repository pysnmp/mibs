...
Gauge32, TimeTicks, NotificationType, Unsigned32, iso, Counter32, MibIdentifier, ObjectIdentity, Integer32, IpAddress, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, enterprises, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "TimeTicks", "NotificationType", "Unsigned32", "iso", "Counter32", "MibIdentifier", "ObjectIdentity", "Integer32", "IpAddress", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "enterprises", "Counter64")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psDisplayName=psDisplayName, advantechCommonMIB=advantechCommonMIB, psSubsysDeviceID=psSubsysDeviceID, sysBootCount=sysBootCount, snmpTrapSrvIndex=snmpTrapSrvIndex, psNumber=psNumber, psDescr=psDescr, psDeviceID=psDeviceID, psBaseAddress=psBaseAddress, psFunctionIndex=psFunctionIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvPort=snmpTrapSrvPort, psManufacturer=psManufacturer, pciConfigObj=pciConfigObj, psBusIndex=psBusIndex, snmpTrapVersion=snmpTrapVersion, psVendorID=psVendorID, psIRQ=psIRQ, sysImageVersion=sysImageVersion, psState=psState, PYSNMP_MODULE_ID=advantechCommonMIB, atMgmt=atMgmt, psModulePorts=psModulePorts, sysDescr=sysDescr, psLength=psLength, snmpTrapSrvNumber=snmpTrapSrvNumber, psModuleType=psModuleType, snmpTrapSrvCommunity=snmpTrapSrvCommunity, atPciConfig=atPciConfig, sysBootTime=sysBootTime, psIndex=psIndex, pciSlotTable=pciSlotTable, sysModuleID=sysModuleID, psClassCode=psClassCode, snmpTrapSrvTable=snmpTrapSrvTable, sysReleaseDate=sysReleaseDate, sysDeviceName=sysDeviceName, advantech=advantech, psLocation=psLocation, snmpTrapSrvIP=snmpTrapSrvIP, atSystem=atSystem, psSubsysVendorID=psSubsysVendorID, pciSlotEntry=pciSlotEntry, snmpTrapSrvObj=snmpTrapSrvObj, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psDeviceIndex=psDeviceIndex)
