...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvPort=snmpTrapSrvPort, psDeviceID=psDeviceID, atPciConfig=atPciConfig, psModulePorts=psModulePorts, PYSNMP_MODULE_ID=advantechCommonMIB, sysFirstBootTime=sysFirstBootTime, psBaseAddress=psBaseAddress, psBusIndex=psBusIndex, psDescr=psDescr, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvIP=snmpTrapSrvIP, sysDeviceName=sysDeviceName, psSubsysDeviceID=psSubsysDeviceID, psLocation=psLocation, psFunctionIndex=psFunctionIndex, sysModuleID=sysModuleID, snmpTrapSrvIndex=snmpTrapSrvIndex, pciSlotTable=pciSlotTable, advantechCommonMIB=advantechCommonMIB, psDeviceIndex=psDeviceIndex, psIRQ=psIRQ, advantech=advantech, psDisplayName=psDisplayName, psManufacturer=psManufacturer, sysBootCount=sysBootCount, sysBootTime=sysBootTime, psState=psState, snmpTrapVersion=snmpTrapVersion, sysReleaseDate=sysReleaseDate, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvTable=snmpTrapSrvTable, atSystem=atSystem, pciSlotEntry=pciSlotEntry, psNumber=psNumber, psClassCode=psClassCode, atMgmt=atMgmt, psIndex=psIndex, sysDescr=sysDescr, pciConfigObj=pciConfigObj, psLength=psLength, sysImageVersion=sysImageVersion, snmpTrapSrvEntry=snmpTrapSrvEntry, psVendorID=psVendorID, psModuleType=psModuleType, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication)
