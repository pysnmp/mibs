...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", PYSNMP_MODULE_ID=advantechCommonMIB, atSystem=atSystem, sysImageVersion=sysImageVersion, psIndex=psIndex, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvObj=snmpTrapSrvObj, sysReleaseDate=sysReleaseDate, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvIP=snmpTrapSrvIP, psBusIndex=psBusIndex, sysDescr=sysDescr, psBaseAddress=psBaseAddress, psModulePorts=psModulePorts, psIRQ=psIRQ, advantech=advantech, psDisplayName=psDisplayName, pciConfigObj=pciConfigObj, psFunctionIndex=psFunctionIndex, sysBootTime=sysBootTime, sysBootCount=sysBootCount, psDeviceID=psDeviceID, psVendorID=psVendorID, snmpTrapSrvNumber=snmpTrapSrvNumber, psClassCode=psClassCode, psManufacturer=psManufacturer, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psState=psState, pciSlotEntry=pciSlotEntry, psDescr=psDescr, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapVersion=snmpTrapVersion, pciSlotTable=pciSlotTable, psDeviceIndex=psDeviceIndex, psLength=psLength, psModuleType=psModuleType, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, advantechCommonMIB=advantechCommonMIB, sysModuleID=sysModuleID, psSubsysVendorID=psSubsysVendorID, atMgmt=atMgmt, psLocation=psLocation, psNumber=psNumber, snmpTrapSrvTable=snmpTrapSrvTable, sysDeviceName=sysDeviceName, atPciConfig=atPciConfig, snmpTrapSrvPort=snmpTrapSrvPort)
