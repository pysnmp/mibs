...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psManufacturer=psManufacturer, snmpTrapVersion=snmpTrapVersion, psDisplayName=psDisplayName, psVendorID=psVendorID, psLength=psLength, sysDeviceName=sysDeviceName, psSubsysDeviceID=psSubsysDeviceID, psModulePorts=psModulePorts, pciSlotTable=pciSlotTable, psFunctionIndex=psFunctionIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, psBaseAddress=psBaseAddress, psIndex=psIndex, sysBootTime=sysBootTime, psLocation=psLocation, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvTable=snmpTrapSrvTable, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvIP=snmpTrapSrvIP, atPciConfig=atPciConfig, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, atMgmt=atMgmt, psNumber=psNumber, sysReleaseDate=sysReleaseDate, advantechCommonMIB=advantechCommonMIB, sysDescr=sysDescr, psDescr=psDescr, psClassCode=psClassCode, sysBootCount=sysBootCount, sysImageVersion=sysImageVersion, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psDeviceID=psDeviceID, psIRQ=psIRQ, pciSlotEntry=pciSlotEntry, snmpTrapSrvNumber=snmpTrapSrvNumber, psModuleType=psModuleType, advantech=advantech, pciConfigObj=pciConfigObj, psDeviceIndex=psDeviceIndex, psBusIndex=psBusIndex, psSubsysVendorID=psSubsysVendorID, psState=psState, atSystem=atSystem, sysModuleID=sysModuleID, PYSNMP_MODULE_ID=advantechCommonMIB)
