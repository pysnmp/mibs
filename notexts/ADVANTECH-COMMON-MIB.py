...
Unsigned32, ModuleIdentity, Gauge32, Integer32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, enterprises, Counter32, Bits, TimeTicks, iso, NotificationType, Counter64, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ModuleIdentity", "Gauge32", "Integer32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "enterprises", "Counter32", "Bits", "TimeTicks", "iso", "NotificationType", "Counter64", "ObjectIdentity")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvCommunity=snmpTrapSrvCommunity, psNumber=psNumber, psIndex=psIndex, psDeviceIndex=psDeviceIndex, sysDescr=sysDescr, psLocation=psLocation, pciSlotTable=pciSlotTable, psManufacturer=psManufacturer, psState=psState, psDeviceID=psDeviceID, snmpTrapSrvNumber=snmpTrapSrvNumber, PYSNMP_MODULE_ID=advantechCommonMIB, atSystem=atSystem, psSubsysDeviceID=psSubsysDeviceID, psDescr=psDescr, sysImageVersion=sysImageVersion, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvPort=snmpTrapSrvPort, psFunctionIndex=psFunctionIndex, sysDeviceName=sysDeviceName, snmpTrapSrvObj=snmpTrapSrvObj, psVendorID=psVendorID, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvEntry=snmpTrapSrvEntry, advantechCommonMIB=advantechCommonMIB, psSubsysVendorID=psSubsysVendorID, sysBootCount=sysBootCount, psModuleType=psModuleType, psLength=psLength, pciConfigObj=pciConfigObj, psDisplayName=psDisplayName, snmpTrapVersion=snmpTrapVersion, psModulePorts=psModulePorts, snmpTrapSrvIP=snmpTrapSrvIP, sysBootTime=sysBootTime, sysModuleID=sysModuleID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvTable=snmpTrapSrvTable, psClassCode=psClassCode, atPciConfig=atPciConfig, pciSlotEntry=pciSlotEntry, psBusIndex=psBusIndex, psBaseAddress=psBaseAddress, psIRQ=psIRQ, sysReleaseDate=sysReleaseDate, atMgmt=atMgmt, advantech=advantech)
