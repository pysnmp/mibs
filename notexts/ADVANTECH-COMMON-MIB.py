...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psIndex=psIndex, advantechCommonMIB=advantechCommonMIB, pciConfigObj=pciConfigObj, psFunctionIndex=psFunctionIndex, sysBootCount=sysBootCount, psState=psState, psDeviceID=psDeviceID, sysFirstBootTime=sysFirstBootTime, psDescr=psDescr, snmpTrapSrvIP=snmpTrapSrvIP, sysModuleID=sysModuleID, snmpTrapSrvPort=snmpTrapSrvPort, psSubsysVendorID=psSubsysVendorID, psIRQ=psIRQ, psClassCode=psClassCode, advantech=advantech, psDisplayName=psDisplayName, psNumber=psNumber, snmpTrapSrvIndex=snmpTrapSrvIndex, sysDescr=sysDescr, atMgmt=atMgmt, psDeviceIndex=psDeviceIndex, sysDeviceName=sysDeviceName, snmpTrapSrvTable=snmpTrapSrvTable, psSubsysDeviceID=psSubsysDeviceID, psManufacturer=psManufacturer, snmpTrapSrvEntry=snmpTrapSrvEntry, psModulePorts=psModulePorts, pciSlotTable=pciSlotTable, sysBootTime=sysBootTime, sysReleaseDate=sysReleaseDate, psVendorID=psVendorID, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvCommunity=snmpTrapSrvCommunity, atPciConfig=atPciConfig, snmpTrapVersion=snmpTrapVersion, pciSlotEntry=pciSlotEntry, snmpTrapSrvNumber=snmpTrapSrvNumber, psBaseAddress=psBaseAddress, PYSNMP_MODULE_ID=advantechCommonMIB, psLocation=psLocation, psModuleType=psModuleType, psLength=psLength, atSystem=atSystem, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psBusIndex=psBusIndex, sysImageVersion=sysImageVersion)
