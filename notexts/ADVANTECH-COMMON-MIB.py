...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvObj=snmpTrapSrvObj, sysFirstBootTime=sysFirstBootTime, snmpTrapVersion=snmpTrapVersion, psIRQ=psIRQ, atSystem=atSystem, psBusIndex=psBusIndex, psDisplayName=psDisplayName, psModuleType=psModuleType, snmpTrapSrvNumber=snmpTrapSrvNumber, psModulePorts=psModulePorts, snmpTrapSrvIP=snmpTrapSrvIP, pciSlotTable=pciSlotTable, psBaseAddress=psBaseAddress, psLength=psLength, atPciConfig=atPciConfig, sysImageVersion=sysImageVersion, pciSlotEntry=pciSlotEntry, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysDescr=sysDescr, psLocation=psLocation, snmpTrapSrvIndex=snmpTrapSrvIndex, psManufacturer=psManufacturer, sysBootTime=sysBootTime, psNumber=psNumber, psIndex=psIndex, psDeviceID=psDeviceID, atMgmt=atMgmt, psState=psState, snmpTrapSrvPort=snmpTrapSrvPort, advantechCommonMIB=advantechCommonMIB, pciConfigObj=pciConfigObj, psFunctionIndex=psFunctionIndex, sysDeviceName=sysDeviceName, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psVendorID=psVendorID, psDescr=psDescr, sysModuleID=sysModuleID, psDeviceIndex=psDeviceIndex, snmpTrapSrvTable=snmpTrapSrvTable, psClassCode=psClassCode, psSubsysVendorID=psSubsysVendorID, sysReleaseDate=sysReleaseDate, sysBootCount=sysBootCount, snmpTrapSrvEntry=snmpTrapSrvEntry, psSubsysDeviceID=psSubsysDeviceID, advantech=advantech)
