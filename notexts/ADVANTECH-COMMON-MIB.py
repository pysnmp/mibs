...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psSubsysVendorID=psSubsysVendorID, psModulePorts=psModulePorts, sysBootCount=sysBootCount, psState=psState, sysImageVersion=sysImageVersion, pciSlotEntry=pciSlotEntry, psSubsysDeviceID=psSubsysDeviceID, psIndex=psIndex, snmpTrapSrvNumber=snmpTrapSrvNumber, advantech=advantech, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysBootTime=sysBootTime, atSystem=atSystem, snmpTrapSrvIndex=snmpTrapSrvIndex, psFunctionIndex=psFunctionIndex, atPciConfig=atPciConfig, psNumber=psNumber, snmpTrapSrvObj=snmpTrapSrvObj, sysDescr=sysDescr, psBusIndex=psBusIndex, psIRQ=psIRQ, psClassCode=psClassCode, psManufacturer=psManufacturer, psDescr=psDescr, snmpTrapSrvPort=snmpTrapSrvPort, PYSNMP_MODULE_ID=advantechCommonMIB, sysReleaseDate=sysReleaseDate, sysFirstBootTime=sysFirstBootTime, pciSlotTable=pciSlotTable, sysDeviceName=sysDeviceName, snmpTrapVersion=snmpTrapVersion, psBaseAddress=psBaseAddress, psDeviceID=psDeviceID, psDisplayName=psDisplayName, psDeviceIndex=psDeviceIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvIP=snmpTrapSrvIP, sysModuleID=sysModuleID, atMgmt=atMgmt, pciConfigObj=pciConfigObj, psLength=psLength, snmpTrapSrvTable=snmpTrapSrvTable, psLocation=psLocation, advantechCommonMIB=advantechCommonMIB, psVendorID=psVendorID, psModuleType=psModuleType)
