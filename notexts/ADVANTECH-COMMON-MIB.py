...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psBaseAddress=psBaseAddress, sysFirstBootTime=sysFirstBootTime, snmpTrapVersion=snmpTrapVersion, sysDeviceName=sysDeviceName, psState=psState, psSubsysDeviceID=psSubsysDeviceID, sysBootTime=sysBootTime, PYSNMP_MODULE_ID=advantechCommonMIB, sysModuleID=sysModuleID, snmpTrapSrvTable=snmpTrapSrvTable, psVendorID=psVendorID, pciConfigObj=pciConfigObj, psIRQ=psIRQ, atMgmt=atMgmt, psDeviceID=psDeviceID, sysDescr=sysDescr, psModulePorts=psModulePorts, atSystem=atSystem, psModuleType=psModuleType, advantech=advantech, psClassCode=psClassCode, snmpTrapSrvObj=snmpTrapSrvObj, psBusIndex=psBusIndex, sysReleaseDate=sysReleaseDate, snmpTrapSrvCommunity=snmpTrapSrvCommunity, pciSlotTable=pciSlotTable, psDescr=psDescr, psLength=psLength, snmpTrapSrvNumber=snmpTrapSrvNumber, psSubsysVendorID=psSubsysVendorID, psFunctionIndex=psFunctionIndex, snmpTrapSrvPort=snmpTrapSrvPort, psNumber=psNumber, psLocation=psLocation, psDeviceIndex=psDeviceIndex, pciSlotEntry=pciSlotEntry, sysImageVersion=sysImageVersion, psIndex=psIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, atPciConfig=atPciConfig, advantechCommonMIB=advantechCommonMIB, psDisplayName=psDisplayName, sysBootCount=sysBootCount, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psManufacturer=psManufacturer, snmpTrapSrvIndex=snmpTrapSrvIndex)
