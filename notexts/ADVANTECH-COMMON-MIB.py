...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysDeviceName=sysDeviceName, sysReleaseDate=sysReleaseDate, atSystem=atSystem, psBaseAddress=psBaseAddress, sysBootTime=sysBootTime, psIRQ=psIRQ, advantech=advantech, psDescr=psDescr, sysImageVersion=sysImageVersion, psDeviceID=psDeviceID, psBusIndex=psBusIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvIP=snmpTrapSrvIP, psClassCode=psClassCode, psDisplayName=psDisplayName, psNumber=psNumber, psDeviceIndex=psDeviceIndex, psFunctionIndex=psFunctionIndex, pciSlotTable=pciSlotTable, psIndex=psIndex, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvPort=snmpTrapSrvPort, psModuleType=psModuleType, sysBootCount=sysBootCount, pciConfigObj=pciConfigObj, pciSlotEntry=pciSlotEntry, psLocation=psLocation, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvTable=snmpTrapSrvTable, sysModuleID=sysModuleID, psVendorID=psVendorID, psModulePorts=psModulePorts, atPciConfig=atPciConfig, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psSubsysVendorID=psSubsysVendorID, snmpTrapVersion=snmpTrapVersion, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvObj=snmpTrapSrvObj, psLength=psLength, psState=psState, psManufacturer=psManufacturer, snmpTrapSrvIndex=snmpTrapSrvIndex, sysDescr=sysDescr, snmpTrapSrvEntry=snmpTrapSrvEntry, sysFirstBootTime=sysFirstBootTime, atMgmt=atMgmt)
