...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvObj=snmpTrapSrvObj, psDeviceIndex=psDeviceIndex, psSubsysDeviceID=psSubsysDeviceID, PYSNMP_MODULE_ID=advantechCommonMIB, psModuleType=psModuleType, psDisplayName=psDisplayName, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, pciSlotEntry=pciSlotEntry, psDeviceID=psDeviceID, advantechCommonMIB=advantechCommonMIB, sysReleaseDate=sysReleaseDate, snmpTrapSrvPort=snmpTrapSrvPort, psVendorID=psVendorID, snmpTrapSrvNumber=snmpTrapSrvNumber, psLength=psLength, sysDescr=sysDescr, sysBootCount=sysBootCount, psManufacturer=psManufacturer, sysBootTime=sysBootTime, psBusIndex=psBusIndex, psState=psState, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysDeviceName=sysDeviceName, psIndex=psIndex, atPciConfig=atPciConfig, pciSlotTable=pciSlotTable, snmpTrapVersion=snmpTrapVersion, sysFirstBootTime=sysFirstBootTime, sysImageVersion=sysImageVersion, advantech=advantech, atMgmt=atMgmt, psModulePorts=psModulePorts, psClassCode=psClassCode, psDescr=psDescr, snmpTrapSrvIndex=snmpTrapSrvIndex, pciConfigObj=pciConfigObj, psFunctionIndex=psFunctionIndex, sysModuleID=sysModuleID, atSystem=atSystem, snmpTrapSrvEntry=snmpTrapSrvEntry, psNumber=psNumber, psIRQ=psIRQ, psBaseAddress=psBaseAddress, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvIP=snmpTrapSrvIP, psLocation=psLocation, snmpTrapSrvTable=snmpTrapSrvTable)
