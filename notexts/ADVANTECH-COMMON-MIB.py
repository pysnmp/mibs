...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psClassCode=psClassCode, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvIndex=snmpTrapSrvIndex, psIRQ=psIRQ, psIndex=psIndex, snmpTrapSrvIP=snmpTrapSrvIP, sysFirstBootTime=sysFirstBootTime, sysBootCount=sysBootCount, pciSlotTable=pciSlotTable, sysBootTime=sysBootTime, atSystem=atSystem, psBusIndex=psBusIndex, snmpTrapSrvTable=snmpTrapSrvTable, psFunctionIndex=psFunctionIndex, psSubsysDeviceID=psSubsysDeviceID, sysImageVersion=sysImageVersion, PYSNMP_MODULE_ID=advantechCommonMIB, pciSlotEntry=pciSlotEntry, psSubsysVendorID=psSubsysVendorID, psDescr=psDescr, atMgmt=atMgmt, psState=psState, psModuleType=psModuleType, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psManufacturer=psManufacturer, psLocation=psLocation, psDeviceID=psDeviceID, sysDeviceName=sysDeviceName, pciConfigObj=pciConfigObj, advantechCommonMIB=advantechCommonMIB, psModulePorts=psModulePorts, psDeviceIndex=psDeviceIndex, psVendorID=psVendorID, sysDescr=sysDescr, atPciConfig=atPciConfig, psLength=psLength, psNumber=psNumber, sysReleaseDate=sysReleaseDate, psDisplayName=psDisplayName, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvEntry=snmpTrapSrvEntry, psBaseAddress=psBaseAddress, snmpTrapVersion=snmpTrapVersion, advantech=advantech, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysModuleID=sysModuleID)
