...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psSubsysDeviceID=psSubsysDeviceID, sysDeviceName=sysDeviceName, snmpTrapSrvTable=snmpTrapSrvTable, psDescr=psDescr, pciSlotEntry=pciSlotEntry, PYSNMP_MODULE_ID=advantechCommonMIB, psClassCode=psClassCode, snmpTrapSrvIP=snmpTrapSrvIP, psDeviceID=psDeviceID, psBusIndex=psBusIndex, psIRQ=psIRQ, sysFirstBootTime=sysFirstBootTime, psModuleType=psModuleType, psLength=psLength, pciConfigObj=pciConfigObj, psLocation=psLocation, psManufacturer=psManufacturer, atPciConfig=atPciConfig, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvObj=snmpTrapSrvObj, psNumber=psNumber, snmpTrapSrvEntry=snmpTrapSrvEntry, advantechCommonMIB=advantechCommonMIB, sysDescr=sysDescr, sysImageVersion=sysImageVersion, psIndex=psIndex, sysBootCount=sysBootCount, snmpTrapSrvIndex=snmpTrapSrvIndex, sysReleaseDate=sysReleaseDate, psVendorID=psVendorID, atSystem=atSystem, psModulePorts=psModulePorts, psState=psState, sysModuleID=sysModuleID, psFunctionIndex=psFunctionIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psDisplayName=psDisplayName, pciSlotTable=pciSlotTable, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psDeviceIndex=psDeviceIndex, psBaseAddress=psBaseAddress, psSubsysVendorID=psSubsysVendorID, advantech=advantech, snmpTrapVersion=snmpTrapVersion, sysBootTime=sysBootTime, atMgmt=atMgmt)
