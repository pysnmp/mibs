...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psLength=psLength, sysDeviceName=sysDeviceName, psVendorID=psVendorID, atSystem=atSystem, sysReleaseDate=sysReleaseDate, psIndex=psIndex, psBusIndex=psBusIndex, psLocation=psLocation, psState=psState, snmpTrapVersion=snmpTrapVersion, psFunctionIndex=psFunctionIndex, pciSlotEntry=pciSlotEntry, psDeviceID=psDeviceID, snmpTrapSrvEntry=snmpTrapSrvEntry, psDisplayName=psDisplayName, psSubsysVendorID=psSubsysVendorID, psModulePorts=psModulePorts, snmpTrapSrvNumber=snmpTrapSrvNumber, sysBootCount=sysBootCount, snmpTrapSrvCommunity=snmpTrapSrvCommunity, atMgmt=atMgmt, psManufacturer=psManufacturer, snmpTrapSrvPort=snmpTrapSrvPort, psNumber=psNumber, sysFirstBootTime=sysFirstBootTime, psIRQ=psIRQ, psSubsysDeviceID=psSubsysDeviceID, pciSlotTable=pciSlotTable, psClassCode=psClassCode, sysModuleID=sysModuleID, sysDescr=sysDescr, psDeviceIndex=psDeviceIndex, sysImageVersion=sysImageVersion, advantechCommonMIB=advantechCommonMIB, advantech=advantech, snmpTrapSrvObj=snmpTrapSrvObj, sysBootTime=sysBootTime, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvTable=snmpTrapSrvTable, psModuleType=psModuleType, snmpTrapSrvIP=snmpTrapSrvIP, psDescr=psDescr, psBaseAddress=psBaseAddress, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvIndex=snmpTrapSrvIndex, atPciConfig=atPciConfig, pciConfigObj=pciConfigObj)
