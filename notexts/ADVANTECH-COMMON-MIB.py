...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psSubsysVendorID=psSubsysVendorID, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psModulePorts=psModulePorts, psDeviceIndex=psDeviceIndex, psVendorID=psVendorID, snmpTrapSrvIndex=snmpTrapSrvIndex, sysReleaseDate=sysReleaseDate, sysBootTime=sysBootTime, snmpTrapSrvPort=snmpTrapSrvPort, psLength=psLength, psDisplayName=psDisplayName, psModuleType=psModuleType, atSystem=atSystem, PYSNMP_MODULE_ID=advantechCommonMIB, psFunctionIndex=psFunctionIndex, snmpTrapVersion=snmpTrapVersion, pciSlotTable=pciSlotTable, sysDescr=sysDescr, psBusIndex=psBusIndex, sysDeviceName=sysDeviceName, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvObj=snmpTrapSrvObj, psDescr=psDescr, psDeviceID=psDeviceID, psClassCode=psClassCode, psLocation=psLocation, psIRQ=psIRQ, psState=psState, sysImageVersion=sysImageVersion, sysBootCount=sysBootCount, psBaseAddress=psBaseAddress, sysFirstBootTime=sysFirstBootTime, psNumber=psNumber, sysModuleID=sysModuleID, pciSlotEntry=pciSlotEntry, psManufacturer=psManufacturer, atPciConfig=atPciConfig, snmpTrapSrvEntry=snmpTrapSrvEntry, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvIP=snmpTrapSrvIP, psIndex=psIndex, advantechCommonMIB=advantechCommonMIB, atMgmt=atMgmt, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvNumber=snmpTrapSrvNumber, pciConfigObj=pciConfigObj, advantech=advantech)
