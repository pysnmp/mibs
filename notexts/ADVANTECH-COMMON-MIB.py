...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysDeviceName=sysDeviceName, snmpTrapSrvCommunity=snmpTrapSrvCommunity, atSystem=atSystem, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvIP=snmpTrapSrvIP, sysImageVersion=sysImageVersion, psFunctionIndex=psFunctionIndex, psModuleType=psModuleType, snmpTrapSrvPort=snmpTrapSrvPort, psLocation=psLocation, sysReleaseDate=sysReleaseDate, advantechCommonMIB=advantechCommonMIB, snmpTrapVersion=snmpTrapVersion, psSubsysVendorID=psSubsysVendorID, psClassCode=psClassCode, snmpTrapSrvEntry=snmpTrapSrvEntry, psNumber=psNumber, sysDescr=sysDescr, sysModuleID=sysModuleID, PYSNMP_MODULE_ID=advantechCommonMIB, psDisplayName=psDisplayName, pciSlotEntry=pciSlotEntry, snmpTrapSrvIndex=snmpTrapSrvIndex, pciSlotTable=pciSlotTable, psLength=psLength, atPciConfig=atPciConfig, psIndex=psIndex, psDescr=psDescr, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvTable=snmpTrapSrvTable, psManufacturer=psManufacturer, psBaseAddress=psBaseAddress, snmpTrapSrvObj=snmpTrapSrvObj, psDeviceID=psDeviceID, psState=psState, psIRQ=psIRQ, psModulePorts=psModulePorts, pciConfigObj=pciConfigObj, atMgmt=atMgmt, psVendorID=psVendorID, snmpTrapSrvNumber=snmpTrapSrvNumber, sysBootCount=sysBootCount, psSubsysDeviceID=psSubsysDeviceID, psDeviceIndex=psDeviceIndex, psBusIndex=psBusIndex, sysBootTime=sysBootTime, advantech=advantech)
