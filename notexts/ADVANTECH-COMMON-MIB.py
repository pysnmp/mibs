...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psNumber=psNumber, psDeviceIndex=psDeviceIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psModuleType=psModuleType, psDescr=psDescr, psManufacturer=psManufacturer, snmpTrapSrvIndex=snmpTrapSrvIndex, atSystem=atSystem, psLocation=psLocation, psModulePorts=psModulePorts, pciSlotEntry=pciSlotEntry, psBusIndex=psBusIndex, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvNumber=snmpTrapSrvNumber, sysImageVersion=sysImageVersion, advantechCommonMIB=advantechCommonMIB, advantech=advantech, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvObj=snmpTrapSrvObj, psDisplayName=psDisplayName, psLength=psLength, sysModuleID=sysModuleID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysFirstBootTime=sysFirstBootTime, psIndex=psIndex, psIRQ=psIRQ, PYSNMP_MODULE_ID=advantechCommonMIB, psFunctionIndex=psFunctionIndex, atPciConfig=atPciConfig, sysDeviceName=sysDeviceName, snmpTrapSrvIP=snmpTrapSrvIP, psSubsysVendorID=psSubsysVendorID, sysBootTime=sysBootTime, psBaseAddress=psBaseAddress, sysBootCount=sysBootCount, sysDescr=sysDescr, sysReleaseDate=sysReleaseDate, snmpTrapSrvEntry=snmpTrapSrvEntry, psClassCode=psClassCode, psVendorID=psVendorID, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvTable=snmpTrapSrvTable, pciConfigObj=pciConfigObj, psDeviceID=psDeviceID, pciSlotTable=pciSlotTable, atMgmt=atMgmt, psState=psState)
