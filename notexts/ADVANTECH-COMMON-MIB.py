...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", advantechCommonMIB=advantechCommonMIB, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psDisplayName=psDisplayName, psLocation=psLocation, pciConfigObj=pciConfigObj, psDescr=psDescr, psNumber=psNumber, psModuleType=psModuleType, psDeviceID=psDeviceID, psFunctionIndex=psFunctionIndex, snmpTrapVersion=snmpTrapVersion, psModulePorts=psModulePorts, psSubsysVendorID=psSubsysVendorID, psManufacturer=psManufacturer, sysFirstBootTime=sysFirstBootTime, psIRQ=psIRQ, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psLength=psLength, sysModuleID=sysModuleID, psBaseAddress=psBaseAddress, pciSlotTable=pciSlotTable, sysDescr=sysDescr, psVendorID=psVendorID, psIndex=psIndex, atPciConfig=atPciConfig, advantech=advantech, psClassCode=psClassCode, snmpTrapSrvPort=snmpTrapSrvPort, psBusIndex=psBusIndex, snmpTrapSrvIndex=snmpTrapSrvIndex, pciSlotEntry=pciSlotEntry, sysImageVersion=sysImageVersion, sysReleaseDate=sysReleaseDate, snmpTrapSrvObj=snmpTrapSrvObj, sysDeviceName=sysDeviceName, sysBootCount=sysBootCount, atSystem=atSystem, atMgmt=atMgmt, snmpTrapSrvEntry=snmpTrapSrvEntry, psDeviceIndex=psDeviceIndex, psSubsysDeviceID=psSubsysDeviceID, sysBootTime=sysBootTime, snmpTrapSrvTable=snmpTrapSrvTable, psState=psState, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvNumber=snmpTrapSrvNumber)
