...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psLocation=psLocation, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvPort=snmpTrapSrvPort, psLength=psLength, psModuleType=psModuleType, sysDescr=sysDescr, atPciConfig=atPciConfig, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvNumber=snmpTrapSrvNumber, psDeviceIndex=psDeviceIndex, advantech=advantech, psVendorID=psVendorID, atMgmt=atMgmt, pciConfigObj=pciConfigObj, psManufacturer=psManufacturer, psDeviceID=psDeviceID, atSystem=atSystem, sysImageVersion=sysImageVersion, sysFirstBootTime=sysFirstBootTime, snmpTrapVersion=snmpTrapVersion, sysDeviceName=sysDeviceName, psBusIndex=psBusIndex, snmpTrapSrvIP=snmpTrapSrvIP, pciSlotTable=pciSlotTable, psIRQ=psIRQ, psModulePorts=psModulePorts, PYSNMP_MODULE_ID=advantechCommonMIB, pciSlotEntry=pciSlotEntry, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvEntry=snmpTrapSrvEntry, psDisplayName=psDisplayName, snmpTrapSrvObj=snmpTrapSrvObj, psFunctionIndex=psFunctionIndex, psIndex=psIndex, psSubsysDeviceID=psSubsysDeviceID, psNumber=psNumber, psSubsysVendorID=psSubsysVendorID, sysBootTime=sysBootTime, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psState=psState, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysModuleID=sysModuleID, sysBootCount=sysBootCount, sysReleaseDate=sysReleaseDate, psDescr=psDescr, psClassCode=psClassCode, psBaseAddress=psBaseAddress)
