...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvNumber=snmpTrapSrvNumber, atSystem=atSystem, psDeviceID=psDeviceID, atPciConfig=atPciConfig, sysBootCount=sysBootCount, psDisplayName=psDisplayName, psSubsysVendorID=psSubsysVendorID, psManufacturer=psManufacturer, psDeviceIndex=psDeviceIndex, pciSlotEntry=pciSlotEntry, psClassCode=psClassCode, sysBootTime=sysBootTime, psState=psState, psVendorID=psVendorID, psIndex=psIndex, sysImageVersion=sysImageVersion, psModulePorts=psModulePorts, sysFirstBootTime=sysFirstBootTime, psNumber=psNumber, advantech=advantech, psFunctionIndex=psFunctionIndex, pciConfigObj=pciConfigObj, snmpTrapSrvCommunity=snmpTrapSrvCommunity, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psLength=psLength, sysReleaseDate=sysReleaseDate, sysDeviceName=sysDeviceName, psBusIndex=psBusIndex, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvEntry=snmpTrapSrvEntry, psLocation=psLocation, sysDescr=sysDescr, snmpTrapSrvPort=snmpTrapSrvPort, sysModuleID=sysModuleID, psModuleType=psModuleType, advantechCommonMIB=advantechCommonMIB, atMgmt=atMgmt, psDescr=psDescr, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvTable=snmpTrapSrvTable, pciSlotTable=pciSlotTable, psBaseAddress=psBaseAddress, psIRQ=psIRQ)
