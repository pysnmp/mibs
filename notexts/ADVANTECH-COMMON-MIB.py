...
IpAddress, ModuleIdentity, MibIdentifier, TimeTicks, Counter64, NotificationType, ObjectIdentity, enterprises, Counter32, Unsigned32, Integer32, Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ModuleIdentity", "MibIdentifier", "TimeTicks", "Counter64", "NotificationType", "ObjectIdentity", "enterprises", "Counter32", "Unsigned32", "Integer32", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psManufacturer=psManufacturer, psModulePorts=psModulePorts, snmpTrapSrvNumber=snmpTrapSrvNumber, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvIndex=snmpTrapSrvIndex, PYSNMP_MODULE_ID=advantechCommonMIB, psSubsysVendorID=psSubsysVendorID, psDeviceIndex=psDeviceIndex, sysBootCount=sysBootCount, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psBaseAddress=psBaseAddress, psVendorID=psVendorID, advantechCommonMIB=advantechCommonMIB, sysDeviceName=sysDeviceName, snmpTrapSrvIP=snmpTrapSrvIP, psFunctionIndex=psFunctionIndex, pciConfigObj=pciConfigObj, psBusIndex=psBusIndex, snmpTrapSrvObj=snmpTrapSrvObj, sysModuleID=sysModuleID, psLength=psLength, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psClassCode=psClassCode, sysDescr=sysDescr, snmpTrapSrvPort=snmpTrapSrvPort, sysBootTime=sysBootTime, snmpTrapVersion=snmpTrapVersion, psDescr=psDescr, pciSlotTable=pciSlotTable, atPciConfig=atPciConfig, psModuleType=psModuleType, sysReleaseDate=sysReleaseDate, advantech=advantech, atSystem=atSystem, atMgmt=atMgmt, sysImageVersion=sysImageVersion, psDeviceID=psDeviceID, snmpTrapSrvEntry=snmpTrapSrvEntry, psIndex=psIndex, psLocation=psLocation, psDisplayName=psDisplayName, psIRQ=psIRQ, pciSlotEntry=pciSlotEntry, sysFirstBootTime=sysFirstBootTime, psNumber=psNumber, snmpTrapSrvTable=snmpTrapSrvTable, psState=psState)
