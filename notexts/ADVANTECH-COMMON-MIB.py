...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psSubsysVendorID=psSubsysVendorID, sysBootTime=sysBootTime, snmpTrapSrvPort=snmpTrapSrvPort, psBaseAddress=psBaseAddress, advantechCommonMIB=advantechCommonMIB, atMgmt=atMgmt, psDisplayName=psDisplayName, psIRQ=psIRQ, psLength=psLength, psDeviceIndex=psDeviceIndex, sysImageVersion=sysImageVersion, snmpTrapSrvIP=snmpTrapSrvIP, sysDeviceName=sysDeviceName, psSubsysDeviceID=psSubsysDeviceID, pciConfigObj=pciConfigObj, psState=psState, snmpTrapSrvTable=snmpTrapSrvTable, sysReleaseDate=sysReleaseDate, psClassCode=psClassCode, psNumber=psNumber, psIndex=psIndex, psBusIndex=psBusIndex, sysModuleID=sysModuleID, pciSlotEntry=pciSlotEntry, psManufacturer=psManufacturer, sysBootCount=sysBootCount, psLocation=psLocation, pciSlotTable=pciSlotTable, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvObj=snmpTrapSrvObj, psVendorID=psVendorID, atPciConfig=atPciConfig, psModulePorts=psModulePorts, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvNumber=snmpTrapSrvNumber, psModuleType=psModuleType, atSystem=atSystem, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysFirstBootTime=sysFirstBootTime, sysDescr=sysDescr, psFunctionIndex=psFunctionIndex, psDescr=psDescr, snmpTrapSrvCommunity=snmpTrapSrvCommunity, PYSNMP_MODULE_ID=advantechCommonMIB, psDeviceID=psDeviceID, advantech=advantech)
