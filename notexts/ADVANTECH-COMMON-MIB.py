...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvCommunity=snmpTrapSrvCommunity, psVendorID=psVendorID, sysBootTime=sysBootTime, psDisplayName=psDisplayName, psSubsysVendorID=psSubsysVendorID, psModulePorts=psModulePorts, snmpTrapSrvObj=snmpTrapSrvObj, psBaseAddress=psBaseAddress, psIndex=psIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psState=psState, atPciConfig=atPciConfig, advantech=advantech, snmpTrapVersion=snmpTrapVersion, sysDeviceName=sysDeviceName, sysDescr=sysDescr, sysImageVersion=sysImageVersion, psDeviceID=psDeviceID, psLength=psLength, snmpTrapSrvIndex=snmpTrapSrvIndex, psLocation=psLocation, advantechCommonMIB=advantechCommonMIB, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvTable=snmpTrapSrvTable, psBusIndex=psBusIndex, psFunctionIndex=psFunctionIndex, psClassCode=psClassCode, sysModuleID=sysModuleID, snmpTrapSrvEntry=snmpTrapSrvEntry, atMgmt=atMgmt, sysReleaseDate=sysReleaseDate, psDescr=psDescr, psSubsysDeviceID=psSubsysDeviceID, psDeviceIndex=psDeviceIndex, pciSlotEntry=pciSlotEntry, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvIP=snmpTrapSrvIP, psModuleType=psModuleType, sysFirstBootTime=sysFirstBootTime, sysBootCount=sysBootCount, pciConfigObj=pciConfigObj, snmpTrapSrvPort=snmpTrapSrvPort, psNumber=psNumber, atSystem=atSystem, psIRQ=psIRQ, psManufacturer=psManufacturer, pciSlotTable=pciSlotTable)
