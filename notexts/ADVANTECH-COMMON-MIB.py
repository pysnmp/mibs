...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvNumber=snmpTrapSrvNumber, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psLength=psLength, sysImageVersion=sysImageVersion, sysReleaseDate=sysReleaseDate, psDeviceID=psDeviceID, advantechCommonMIB=advantechCommonMIB, atMgmt=atMgmt, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapVersion=snmpTrapVersion, psLocation=psLocation, sysModuleID=sysModuleID, PYSNMP_MODULE_ID=advantechCommonMIB, psDescr=psDescr, psBaseAddress=psBaseAddress, psFunctionIndex=psFunctionIndex, snmpTrapSrvIndex=snmpTrapSrvIndex, psDisplayName=psDisplayName, psSubsysVendorID=psSubsysVendorID, psModulePorts=psModulePorts, psIndex=psIndex, sysBootCount=sysBootCount, psNumber=psNumber, psIRQ=psIRQ, sysBootTime=sysBootTime, pciSlotEntry=pciSlotEntry, psManufacturer=psManufacturer, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvEntry=snmpTrapSrvEntry, psState=psState, psModuleType=psModuleType, sysDescr=sysDescr, advantech=advantech, psVendorID=psVendorID, atPciConfig=atPciConfig, sysDeviceName=sysDeviceName, pciConfigObj=pciConfigObj, psDeviceIndex=psDeviceIndex, psBusIndex=psBusIndex, pciSlotTable=pciSlotTable, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvPort=snmpTrapSrvPort, atSystem=atSystem, psSubsysDeviceID=psSubsysDeviceID, psClassCode=psClassCode)
