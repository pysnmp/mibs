...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psLocation=psLocation, psDeviceID=psDeviceID, psNumber=psNumber, sysFirstBootTime=sysFirstBootTime, sysImageVersion=sysImageVersion, snmpTrapSrvIndex=snmpTrapSrvIndex, advantechCommonMIB=advantechCommonMIB, snmpTrapVersion=snmpTrapVersion, psModulePorts=psModulePorts, psClassCode=psClassCode, sysDeviceName=sysDeviceName, snmpTrapSrvEntry=snmpTrapSrvEntry, psModuleType=psModuleType, pciSlotTable=pciSlotTable, sysReleaseDate=sysReleaseDate, sysModuleID=sysModuleID, advantech=advantech, atSystem=atSystem, psFunctionIndex=psFunctionIndex, sysBootTime=sysBootTime, psDisplayName=psDisplayName, pciSlotEntry=pciSlotEntry, PYSNMP_MODULE_ID=advantechCommonMIB, atPciConfig=atPciConfig, psVendorID=psVendorID, atMgmt=atMgmt, sysBootCount=sysBootCount, snmpTrapSrvTable=snmpTrapSrvTable, psDeviceIndex=psDeviceIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psBusIndex=psBusIndex, psBaseAddress=psBaseAddress, snmpTrapSrvPort=snmpTrapSrvPort, psIndex=psIndex, psLength=psLength, sysDescr=sysDescr, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psManufacturer=psManufacturer, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvIP=snmpTrapSrvIP, psDescr=psDescr, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvObj=snmpTrapSrvObj, psIRQ=psIRQ, psState=psState, pciConfigObj=pciConfigObj, snmpTrapSrvNumber=snmpTrapSrvNumber)
