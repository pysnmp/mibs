...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysFirstBootTime=sysFirstBootTime, psDeviceIndex=psDeviceIndex, psDisplayName=psDisplayName, snmpTrapSrvTable=snmpTrapSrvTable, sysImageVersion=sysImageVersion, psNumber=psNumber, snmpTrapSrvPort=snmpTrapSrvPort, sysBootCount=sysBootCount, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvObj=snmpTrapSrvObj, psVendorID=psVendorID, psSubsysDeviceID=psSubsysDeviceID, psDescr=psDescr, psDeviceID=psDeviceID, advantechCommonMIB=advantechCommonMIB, sysDescr=sysDescr, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvIP=snmpTrapSrvIP, pciConfigObj=pciConfigObj, psState=psState, psModuleType=psModuleType, psBusIndex=psBusIndex, psIRQ=psIRQ, atMgmt=atMgmt, pciSlotEntry=pciSlotEntry, psManufacturer=psManufacturer, advantech=advantech, psLength=psLength, sysDeviceName=sysDeviceName, psClassCode=psClassCode, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psModulePorts=psModulePorts, psSubsysVendorID=psSubsysVendorID, sysModuleID=sysModuleID, atSystem=atSystem, snmpTrapVersion=snmpTrapVersion, sysBootTime=sysBootTime, psIndex=psIndex, sysReleaseDate=sysReleaseDate, atPciConfig=atPciConfig, psLocation=psLocation, pciSlotTable=pciSlotTable, psBaseAddress=psBaseAddress, psFunctionIndex=psFunctionIndex, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvNumber=snmpTrapSrvNumber)
