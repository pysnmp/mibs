...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysBootCount=sysBootCount, psIndex=psIndex, psDeviceID=psDeviceID, sysDescr=sysDescr, psLocation=psLocation, sysModuleID=sysModuleID, snmpTrapSrvNumber=snmpTrapSrvNumber, advantech=advantech, psDeviceIndex=psDeviceIndex, psModuleType=psModuleType, snmpTrapSrvObj=snmpTrapSrvObj, psClassCode=psClassCode, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psSubsysVendorID=psSubsysVendorID, atPciConfig=atPciConfig, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvIP=snmpTrapSrvIP, sysReleaseDate=sysReleaseDate, pciSlotTable=pciSlotTable, psFunctionIndex=psFunctionIndex, pciSlotEntry=pciSlotEntry, snmpTrapSrvPort=snmpTrapSrvPort, psDisplayName=psDisplayName, psState=psState, atMgmt=atMgmt, psLength=psLength, sysDeviceName=sysDeviceName, psIRQ=psIRQ, psBaseAddress=psBaseAddress, psBusIndex=psBusIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psVendorID=psVendorID, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvIndex=snmpTrapSrvIndex, pciConfigObj=pciConfigObj, psDescr=psDescr, psManufacturer=psManufacturer, snmpTrapSrvTable=snmpTrapSrvTable, sysBootTime=sysBootTime, sysFirstBootTime=sysFirstBootTime, psNumber=psNumber, atSystem=atSystem, psModulePorts=psModulePorts, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvEntry=snmpTrapSrvEntry, sysImageVersion=sysImageVersion, PYSNMP_MODULE_ID=advantechCommonMIB)
