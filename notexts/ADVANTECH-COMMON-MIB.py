...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", PYSNMP_MODULE_ID=advantechCommonMIB, psLocation=psLocation, pciSlotTable=pciSlotTable, atSystem=atSystem, psDescr=psDescr, sysImageVersion=sysImageVersion, snmpTrapSrvIP=snmpTrapSrvIP, psNumber=psNumber, psDeviceID=psDeviceID, advantech=advantech, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysReleaseDate=sysReleaseDate, pciSlotEntry=pciSlotEntry, snmpTrapSrvPort=snmpTrapSrvPort, psModulePorts=psModulePorts, pciConfigObj=pciConfigObj, sysBootCount=sysBootCount, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvIndex=snmpTrapSrvIndex, psBaseAddress=psBaseAddress, sysDeviceName=sysDeviceName, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvObj=snmpTrapSrvObj, psState=psState, sysModuleID=sysModuleID, psBusIndex=psBusIndex, psFunctionIndex=psFunctionIndex, advantechCommonMIB=advantechCommonMIB, atMgmt=atMgmt, psSubsysVendorID=psSubsysVendorID, sysDescr=sysDescr, psDeviceIndex=psDeviceIndex, psSubsysDeviceID=psSubsysDeviceID, psLength=psLength, atPciConfig=atPciConfig, sysBootTime=sysBootTime, psIRQ=psIRQ, psVendorID=psVendorID, psModuleType=psModuleType, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psClassCode=psClassCode, psDisplayName=psDisplayName, psManufacturer=psManufacturer, psIndex=psIndex, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvNumber=snmpTrapSrvNumber)
