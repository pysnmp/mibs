...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psLocation=psLocation, snmpTrapSrvPort=snmpTrapSrvPort, sysDescr=sysDescr, snmpTrapSrvNumber=snmpTrapSrvNumber, atPciConfig=atPciConfig, sysModuleID=sysModuleID, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvCommunity=snmpTrapSrvCommunity, PYSNMP_MODULE_ID=advantechCommonMIB, psBusIndex=psBusIndex, psVendorID=psVendorID, sysReleaseDate=sysReleaseDate, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psDisplayName=psDisplayName, snmpTrapSrvTable=snmpTrapSrvTable, psModuleType=psModuleType, psDeviceID=psDeviceID, pciSlotTable=pciSlotTable, psNumber=psNumber, pciSlotEntry=pciSlotEntry, psIRQ=psIRQ, psFunctionIndex=psFunctionIndex, psBaseAddress=psBaseAddress, psState=psState, psModulePorts=psModulePorts, snmpTrapVersion=snmpTrapVersion, psDeviceIndex=psDeviceIndex, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvIP=snmpTrapSrvIP, psManufacturer=psManufacturer, psLength=psLength, sysBootTime=sysBootTime, psClassCode=psClassCode, advantech=advantech, sysFirstBootTime=sysFirstBootTime, atMgmt=atMgmt, sysImageVersion=sysImageVersion, snmpTrapSrvIndex=snmpTrapSrvIndex, sysBootCount=sysBootCount, psDescr=psDescr, atSystem=atSystem, psIndex=psIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvObj=snmpTrapSrvObj, sysDeviceName=sysDeviceName, pciConfigObj=pciConfigObj)
