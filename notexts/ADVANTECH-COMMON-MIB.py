...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psVendorID=psVendorID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysModuleID=sysModuleID, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvIndex=snmpTrapSrvIndex, psIRQ=psIRQ, psLength=psLength, pciSlotTable=pciSlotTable, advantechCommonMIB=advantechCommonMIB, psDeviceIndex=psDeviceIndex, psClassCode=psClassCode, sysBootTime=sysBootTime, sysImageVersion=sysImageVersion, psDeviceID=psDeviceID, sysDescr=sysDescr, psFunctionIndex=psFunctionIndex, PYSNMP_MODULE_ID=advantechCommonMIB, psDisplayName=psDisplayName, psBusIndex=psBusIndex, sysReleaseDate=sysReleaseDate, atSystem=atSystem, snmpTrapSrvCommunity=snmpTrapSrvCommunity, atMgmt=atMgmt, psModuleType=psModuleType, psDescr=psDescr, pciSlotEntry=pciSlotEntry, snmpTrapSrvNumber=snmpTrapSrvNumber, psSubsysDeviceID=psSubsysDeviceID, sysBootCount=sysBootCount, psModulePorts=psModulePorts, psLocation=psLocation, snmpTrapSrvIP=snmpTrapSrvIP, pciConfigObj=pciConfigObj, atPciConfig=atPciConfig, snmpTrapSrvPort=snmpTrapSrvPort, psSubsysVendorID=psSubsysVendorID, psManufacturer=psManufacturer, psState=psState, snmpTrapSrvTable=snmpTrapSrvTable, sysFirstBootTime=sysFirstBootTime, psIndex=psIndex, psNumber=psNumber, snmpTrapSrvObj=snmpTrapSrvObj, advantech=advantech, sysDeviceName=sysDeviceName, psBaseAddress=psBaseAddress)
