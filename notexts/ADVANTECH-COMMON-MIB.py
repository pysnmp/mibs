...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysModuleID=sysModuleID, PYSNMP_MODULE_ID=advantechCommonMIB, psLocation=psLocation, snmpTrapSrvNumber=snmpTrapSrvNumber, psFunctionIndex=psFunctionIndex, psDisplayName=psDisplayName, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvTable=snmpTrapSrvTable, advantechCommonMIB=advantechCommonMIB, sysBootTime=sysBootTime, psDeviceID=psDeviceID, pciSlotTable=pciSlotTable, advantech=advantech, psDeviceIndex=psDeviceIndex, snmpTrapVersion=snmpTrapVersion, psBaseAddress=psBaseAddress, sysDeviceName=sysDeviceName, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysFirstBootTime=sysFirstBootTime, psState=psState, psLength=psLength, snmpTrapSrvPort=snmpTrapSrvPort, psDescr=psDescr, psSubsysDeviceID=psSubsysDeviceID, psClassCode=psClassCode, sysBootCount=sysBootCount, psIndex=psIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psManufacturer=psManufacturer, snmpTrapSrvObj=snmpTrapSrvObj, pciSlotEntry=pciSlotEntry, sysDescr=sysDescr, sysReleaseDate=sysReleaseDate, psModuleType=psModuleType, atSystem=atSystem, psBusIndex=psBusIndex, psIRQ=psIRQ, sysImageVersion=sysImageVersion, snmpTrapSrvIP=snmpTrapSrvIP, psModulePorts=psModulePorts, psSubsysVendorID=psSubsysVendorID, atPciConfig=atPciConfig, psNumber=psNumber, pciConfigObj=pciConfigObj, atMgmt=atMgmt, psVendorID=psVendorID)
