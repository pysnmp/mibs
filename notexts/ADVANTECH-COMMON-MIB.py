...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psDeviceIndex=psDeviceIndex, snmpTrapSrvObj=snmpTrapSrvObj, PYSNMP_MODULE_ID=advantechCommonMIB, psSubsysDeviceID=psSubsysDeviceID, psLength=psLength, sysReleaseDate=sysReleaseDate, atMgmt=atMgmt, snmpTrapSrvTable=snmpTrapSrvTable, psFunctionIndex=psFunctionIndex, sysModuleID=sysModuleID, psModuleType=psModuleType, psIRQ=psIRQ, psModulePorts=psModulePorts, psClassCode=psClassCode, psManufacturer=psManufacturer, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvIndex=snmpTrapSrvIndex, psIndex=psIndex, snmpTrapSrvIP=snmpTrapSrvIP, psDisplayName=psDisplayName, sysImageVersion=sysImageVersion, psBaseAddress=psBaseAddress, sysDescr=sysDescr, sysDeviceName=sysDeviceName, psVendorID=psVendorID, atPciConfig=atPciConfig, psDeviceID=psDeviceID, psNumber=psNumber, psBusIndex=psBusIndex, sysBootCount=sysBootCount, pciSlotTable=pciSlotTable, psDescr=psDescr, advantech=advantech, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvCommunity=snmpTrapSrvCommunity, atSystem=atSystem, pciConfigObj=pciConfigObj, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvEntry=snmpTrapSrvEntry, sysBootTime=sysBootTime, psSubsysVendorID=psSubsysVendorID, psLocation=psLocation, psState=psState, snmpTrapSrvNumber=snmpTrapSrvNumber, pciSlotEntry=pciSlotEntry)
