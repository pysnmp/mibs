...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysFirstBootTime=sysFirstBootTime, psClassCode=psClassCode, sysDescr=sysDescr, atMgmt=atMgmt, atPciConfig=atPciConfig, psDeviceIndex=psDeviceIndex, advantech=advantech, psSubsysVendorID=psSubsysVendorID, psFunctionIndex=psFunctionIndex, atSystem=atSystem, snmpTrapSrvIP=snmpTrapSrvIP, psVendorID=psVendorID, psModulePorts=psModulePorts, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, pciSlotTable=pciSlotTable, snmpTrapVersion=snmpTrapVersion, psDescr=psDescr, psIRQ=psIRQ, pciSlotEntry=pciSlotEntry, psLocation=psLocation, sysModuleID=sysModuleID, psManufacturer=psManufacturer, sysReleaseDate=sysReleaseDate, psDeviceID=psDeviceID, psNumber=psNumber, PYSNMP_MODULE_ID=advantechCommonMIB, psDisplayName=psDisplayName, sysBootTime=sysBootTime, snmpTrapSrvTable=snmpTrapSrvTable, psLength=psLength, psBaseAddress=psBaseAddress, psSubsysDeviceID=psSubsysDeviceID, sysDeviceName=sysDeviceName, psModuleType=psModuleType, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvEntry=snmpTrapSrvEntry, pciConfigObj=pciConfigObj, psIndex=psIndex, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysBootCount=sysBootCount, sysImageVersion=sysImageVersion, psState=psState, psBusIndex=psBusIndex)
