...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psBaseAddress=psBaseAddress, sysDescr=sysDescr, psSubsysVendorID=psSubsysVendorID, psDisplayName=psDisplayName, snmpTrapSrvTable=snmpTrapSrvTable, psFunctionIndex=psFunctionIndex, sysBootTime=sysBootTime, psNumber=psNumber, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvPort=snmpTrapSrvPort, PYSNMP_MODULE_ID=advantechCommonMIB, sysFirstBootTime=sysFirstBootTime, psIndex=psIndex, psManufacturer=psManufacturer, psSubsysDeviceID=psSubsysDeviceID, sysDeviceName=sysDeviceName, snmpTrapSrvEntry=snmpTrapSrvEntry, pciConfigObj=pciConfigObj, atSystem=atSystem, psIRQ=psIRQ, advantechCommonMIB=advantechCommonMIB, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psLength=psLength, psDescr=psDescr, psState=psState, snmpTrapSrvIndex=snmpTrapSrvIndex, psModuleType=psModuleType, psDeviceID=psDeviceID, sysModuleID=sysModuleID, sysReleaseDate=sysReleaseDate, atMgmt=atMgmt, psClassCode=psClassCode, pciSlotTable=pciSlotTable, advantech=advantech, psLocation=psLocation, atPciConfig=atPciConfig, sysBootCount=sysBootCount, snmpTrapSrvNumber=snmpTrapSrvNumber, psModulePorts=psModulePorts, psDeviceIndex=psDeviceIndex, psBusIndex=psBusIndex, psVendorID=psVendorID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, pciSlotEntry=pciSlotEntry, sysImageVersion=sysImageVersion)
