...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psSubsysVendorID=psSubsysVendorID, psManufacturer=psManufacturer, snmpTrapVersion=snmpTrapVersion, psModulePorts=psModulePorts, psDeviceIndex=psDeviceIndex, sysImageVersion=sysImageVersion, psVendorID=psVendorID, psLength=psLength, advantech=advantech, snmpTrapSrvObj=snmpTrapSrvObj, pciSlotTable=pciSlotTable, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvTable=snmpTrapSrvTable, psDisplayName=psDisplayName, psLocation=psLocation, snmpTrapSrvCommunity=snmpTrapSrvCommunity, advantechCommonMIB=advantechCommonMIB, sysFirstBootTime=sysFirstBootTime, pciConfigObj=pciConfigObj, psBusIndex=psBusIndex, psDescr=psDescr, snmpTrapSrvEntry=snmpTrapSrvEntry, sysBootCount=sysBootCount, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psClassCode=psClassCode, atSystem=atSystem, sysReleaseDate=sysReleaseDate, psBaseAddress=psBaseAddress, atMgmt=atMgmt, snmpTrapSrvNumber=snmpTrapSrvNumber, atPciConfig=atPciConfig, psState=psState, psNumber=psNumber, sysDeviceName=sysDeviceName, sysModuleID=sysModuleID, sysBootTime=sysBootTime, psFunctionIndex=psFunctionIndex, psDeviceID=psDeviceID, sysDescr=sysDescr, pciSlotEntry=pciSlotEntry, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvPort=snmpTrapSrvPort, psModuleType=psModuleType, psIndex=psIndex, psIRQ=psIRQ, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvIndex=snmpTrapSrvIndex)
