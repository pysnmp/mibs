...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psClassCode=psClassCode, pciSlotEntry=pciSlotEntry, psLength=psLength, snmpTrapSrvEntry=snmpTrapSrvEntry, atPciConfig=atPciConfig, psLocation=psLocation, psIndex=psIndex, atMgmt=atMgmt, snmpTrapVersion=snmpTrapVersion, psManufacturer=psManufacturer, psDeviceID=psDeviceID, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psIRQ=psIRQ, psModulePorts=psModulePorts, sysDescr=sysDescr, snmpTrapSrvTable=snmpTrapSrvTable, sysModuleID=sysModuleID, psSubsysVendorID=psSubsysVendorID, sysDeviceName=sysDeviceName, sysBootCount=sysBootCount, psBaseAddress=psBaseAddress, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvObj=snmpTrapSrvObj, advantechCommonMIB=advantechCommonMIB, psDeviceIndex=psDeviceIndex, psSubsysDeviceID=psSubsysDeviceID, sysImageVersion=sysImageVersion, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psFunctionIndex=psFunctionIndex, psDescr=psDescr, atSystem=atSystem, psVendorID=psVendorID, psNumber=psNumber, sysFirstBootTime=sysFirstBootTime, psBusIndex=psBusIndex, sysBootTime=sysBootTime, psModuleType=psModuleType, advantech=advantech, pciConfigObj=pciConfigObj, psDisplayName=psDisplayName, psState=psState, pciSlotTable=pciSlotTable, sysReleaseDate=sysReleaseDate, snmpTrapSrvIndex=snmpTrapSrvIndex, PYSNMP_MODULE_ID=advantechCommonMIB)
