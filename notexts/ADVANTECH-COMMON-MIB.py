...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapVersion=snmpTrapVersion, sysImageVersion=sysImageVersion, psDeviceIndex=psDeviceIndex, snmpTrapSrvTable=snmpTrapSrvTable, psIRQ=psIRQ, psVendorID=psVendorID, sysBootTime=sysBootTime, pciConfigObj=pciConfigObj, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psManufacturer=psManufacturer, psSubsysVendorID=psSubsysVendorID, pciSlotTable=pciSlotTable, psIndex=psIndex, psBaseAddress=psBaseAddress, psClassCode=psClassCode, sysModuleID=sysModuleID, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvPort=snmpTrapSrvPort, atMgmt=atMgmt, pciSlotEntry=pciSlotEntry, atPciConfig=atPciConfig, advantech=advantech, sysDescr=sysDescr, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psLength=psLength, psModuleType=psModuleType, advantechCommonMIB=advantechCommonMIB, psState=psState, sysDeviceName=sysDeviceName, psDisplayName=psDisplayName, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvIP=snmpTrapSrvIP, psBusIndex=psBusIndex, sysFirstBootTime=sysFirstBootTime, psDeviceID=psDeviceID, sysBootCount=sysBootCount, atSystem=atSystem, snmpTrapSrvEntry=snmpTrapSrvEntry, psNumber=psNumber, psFunctionIndex=psFunctionIndex, psModulePorts=psModulePorts, psDescr=psDescr, snmpTrapSrvNumber=snmpTrapSrvNumber, psLocation=psLocation, PYSNMP_MODULE_ID=advantechCommonMIB, psSubsysDeviceID=psSubsysDeviceID, sysReleaseDate=sysReleaseDate)
