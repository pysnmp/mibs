...
ObjectIdentity, Integer32, IpAddress, NotificationType, Unsigned32, Bits, iso, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, TimeTicks, Counter32, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Integer32", "IpAddress", "NotificationType", "Unsigned32", "Bits", "iso", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "TimeTicks", "Counter32", "Counter64", "Gauge32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvIP=snmpTrapSrvIP, psIRQ=psIRQ, sysFirstBootTime=sysFirstBootTime, psDeviceID=psDeviceID, psIndex=psIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psNumber=psNumber, pciConfigObj=pciConfigObj, pciSlotTable=pciSlotTable, atMgmt=atMgmt, psManufacturer=psManufacturer, psClassCode=psClassCode, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvTable=snmpTrapSrvTable, sysImageVersion=sysImageVersion, snmpTrapSrvIndex=snmpTrapSrvIndex, psBaseAddress=psBaseAddress, psDisplayName=psDisplayName, psModulePorts=psModulePorts, psVendorID=psVendorID, advantechCommonMIB=advantechCommonMIB, psBusIndex=psBusIndex, psLocation=psLocation, sysBootCount=sysBootCount, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvObj=snmpTrapSrvObj, sysBootTime=sysBootTime, atPciConfig=atPciConfig, advantech=advantech, sysDeviceName=sysDeviceName, psDescr=psDescr, snmpTrapSrvPort=snmpTrapSrvPort, psFunctionIndex=psFunctionIndex, sysDescr=sysDescr, atSystem=atSystem, pciSlotEntry=pciSlotEntry, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapVersion=snmpTrapVersion, psDeviceIndex=psDeviceIndex, psSubsysVendorID=psSubsysVendorID, psLength=psLength, sysModuleID=sysModuleID, psSubsysDeviceID=psSubsysDeviceID, psModuleType=psModuleType, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psState=psState, sysReleaseDate=sysReleaseDate)
