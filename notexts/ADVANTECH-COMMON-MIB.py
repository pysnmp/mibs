...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", advantech=advantech, sysBootCount=sysBootCount, psState=psState, atSystem=atSystem, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvIP=snmpTrapSrvIP, psSubsysVendorID=psSubsysVendorID, sysImageVersion=sysImageVersion, psModulePorts=psModulePorts, pciSlotTable=pciSlotTable, snmpTrapSrvTable=snmpTrapSrvTable, psClassCode=psClassCode, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvNumber=snmpTrapSrvNumber, psLocation=psLocation, psIRQ=psIRQ, advantechCommonMIB=advantechCommonMIB, sysBootTime=sysBootTime, sysDescr=sysDescr, psIndex=psIndex, psModuleType=psModuleType, sysModuleID=sysModuleID, pciConfigObj=pciConfigObj, psManufacturer=psManufacturer, sysDeviceName=sysDeviceName, snmpTrapSrvPort=snmpTrapSrvPort, psFunctionIndex=psFunctionIndex, psDescr=psDescr, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psBaseAddress=psBaseAddress, snmpTrapSrvIndex=snmpTrapSrvIndex, psDeviceID=psDeviceID, psLength=psLength, atPciConfig=atPciConfig, psBusIndex=psBusIndex, sysFirstBootTime=sysFirstBootTime, psDeviceIndex=psDeviceIndex, psDisplayName=psDisplayName, psSubsysDeviceID=psSubsysDeviceID, atMgmt=atMgmt, psNumber=psNumber, psVendorID=psVendorID, sysReleaseDate=sysReleaseDate, pciSlotEntry=pciSlotEntry, snmpTrapVersion=snmpTrapVersion)
