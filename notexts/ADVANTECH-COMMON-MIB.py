...
Integer32, Counter32, ModuleIdentity, IpAddress, iso, NotificationType, MibIdentifier, TimeTicks, Gauge32, enterprises, Unsigned32, Bits, Counter64, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "ModuleIdentity", "IpAddress", "iso", "NotificationType", "MibIdentifier", "TimeTicks", "Gauge32", "enterprises", "Unsigned32", "Bits", "Counter64", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psDisplayName=psDisplayName, PYSNMP_MODULE_ID=advantechCommonMIB, psDescr=psDescr, advantech=advantech, psLocation=psLocation, snmpTrapSrvIndex=snmpTrapSrvIndex, sysBootTime=sysBootTime, psVendorID=psVendorID, psFunctionIndex=psFunctionIndex, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvTable=snmpTrapSrvTable, psClassCode=psClassCode, sysDescr=sysDescr, pciSlotEntry=pciSlotEntry, psIRQ=psIRQ, sysBootCount=sysBootCount, psBaseAddress=psBaseAddress, psModuleType=psModuleType, pciConfigObj=pciConfigObj, psIndex=psIndex, psNumber=psNumber, psLength=psLength, sysModuleID=sysModuleID, snmpTrapVersion=snmpTrapVersion, psBusIndex=psBusIndex, sysFirstBootTime=sysFirstBootTime, advantechCommonMIB=advantechCommonMIB, psModulePorts=psModulePorts, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvNumber=snmpTrapSrvNumber, sysReleaseDate=sysReleaseDate, atSystem=atSystem, pciSlotTable=pciSlotTable, atPciConfig=atPciConfig, psManufacturer=psManufacturer, snmpTrapSrvPort=snmpTrapSrvPort, psSubsysVendorID=psSubsysVendorID, psState=psState, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psDeviceID=psDeviceID, psDeviceIndex=psDeviceIndex, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvEntry=snmpTrapSrvEntry, sysImageVersion=sysImageVersion, atMgmt=atMgmt, sysDeviceName=sysDeviceName, snmpTrapSrvIP=snmpTrapSrvIP)
