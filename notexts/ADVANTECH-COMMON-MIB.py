...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvObj=snmpTrapSrvObj, psIRQ=psIRQ, snmpTrapSrvTable=snmpTrapSrvTable, psBaseAddress=psBaseAddress, advantechCommonMIB=advantechCommonMIB, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvEntry=snmpTrapSrvEntry, sysBootCount=sysBootCount, psModulePorts=psModulePorts, psManufacturer=psManufacturer, sysDescr=sysDescr, atPciConfig=atPciConfig, psSubsysDeviceID=psSubsysDeviceID, psDeviceID=psDeviceID, psState=psState, psDescr=psDescr, psModuleType=psModuleType, psVendorID=psVendorID, sysBootTime=sysBootTime, sysImageVersion=sysImageVersion, snmpTrapSrvIP=snmpTrapSrvIP, psIndex=psIndex, advantech=advantech, psFunctionIndex=psFunctionIndex, psSubsysVendorID=psSubsysVendorID, psBusIndex=psBusIndex, psClassCode=psClassCode, snmpTrapSrvPort=snmpTrapSrvPort, pciConfigObj=pciConfigObj, atMgmt=atMgmt, atSystem=atSystem, pciSlotTable=pciSlotTable, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvIndex=snmpTrapSrvIndex, sysModuleID=sysModuleID, pciSlotEntry=pciSlotEntry, sysReleaseDate=sysReleaseDate, psNumber=psNumber, psDisplayName=psDisplayName, psLength=psLength, psLocation=psLocation, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvNumber=snmpTrapSrvNumber, sysDeviceName=sysDeviceName, snmpTrapVersion=snmpTrapVersion, psDeviceIndex=psDeviceIndex)
