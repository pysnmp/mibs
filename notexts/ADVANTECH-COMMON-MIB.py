...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapVersion=snmpTrapVersion, psDeviceIndex=psDeviceIndex, psNumber=psNumber, psDisplayName=psDisplayName, psDescr=psDescr, pciSlotEntry=pciSlotEntry, psLength=psLength, sysBootCount=sysBootCount, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, psModulePorts=psModulePorts, sysReleaseDate=sysReleaseDate, snmpTrapSrvCommunity=snmpTrapSrvCommunity, pciSlotTable=pciSlotTable, sysDescr=sysDescr, psLocation=psLocation, snmpTrapSrvIP=snmpTrapSrvIP, psIRQ=psIRQ, psState=psState, sysModuleID=sysModuleID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, atSystem=atSystem, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvObj=snmpTrapSrvObj, psVendorID=psVendorID, snmpTrapSrvTable=snmpTrapSrvTable, sysBootTime=sysBootTime, snmpTrapSrvNumber=snmpTrapSrvNumber, psManufacturer=psManufacturer, psModuleType=psModuleType, atMgmt=atMgmt, psDeviceID=psDeviceID, psFunctionIndex=psFunctionIndex, sysImageVersion=sysImageVersion, psSubsysDeviceID=psSubsysDeviceID, psBaseAddress=psBaseAddress, psIndex=psIndex, sysDeviceName=sysDeviceName, advantechCommonMIB=advantechCommonMIB, psClassCode=psClassCode, PYSNMP_MODULE_ID=advantechCommonMIB, atPciConfig=atPciConfig, snmpTrapSrvPort=snmpTrapSrvPort, psSubsysVendorID=psSubsysVendorID, advantech=advantech, pciConfigObj=pciConfigObj, psBusIndex=psBusIndex)
