...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psLocation=psLocation, sysBootTime=sysBootTime, psIndex=psIndex, advantech=advantech, advantechCommonMIB=advantechCommonMIB, psDisplayName=psDisplayName, pciSlotTable=pciSlotTable, psModuleType=psModuleType, psFunctionIndex=psFunctionIndex, psDeviceID=psDeviceID, psBusIndex=psBusIndex, atSystem=atSystem, psIRQ=psIRQ, sysDescr=sysDescr, snmpTrapSrvTable=snmpTrapSrvTable, sysBootCount=sysBootCount, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvIndex=snmpTrapSrvIndex, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvObj=snmpTrapSrvObj, psNumber=psNumber, psSubsysVendorID=psSubsysVendorID, psState=psState, sysModuleID=sysModuleID, psVendorID=psVendorID, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvEntry=snmpTrapSrvEntry, atMgmt=atMgmt, psClassCode=psClassCode, psBaseAddress=psBaseAddress, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvIP=snmpTrapSrvIP, psModulePorts=psModulePorts, pciSlotEntry=pciSlotEntry, psDescr=psDescr, psManufacturer=psManufacturer, sysReleaseDate=sysReleaseDate, sysImageVersion=sysImageVersion, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, pciConfigObj=pciConfigObj, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psLength=psLength, sysDeviceName=sysDeviceName, psDeviceIndex=psDeviceIndex, atPciConfig=atPciConfig, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvPort=snmpTrapSrvPort)
