...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psBusIndex=psBusIndex, psBaseAddress=psBaseAddress, psDisplayName=psDisplayName, psModuleType=psModuleType, advantech=advantech, psManufacturer=psManufacturer, sysModuleID=sysModuleID, psLocation=psLocation, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvTable=snmpTrapSrvTable, psDeviceID=psDeviceID, psSubsysDeviceID=psSubsysDeviceID, pciConfigObj=pciConfigObj, PYSNMP_MODULE_ID=advantechCommonMIB, sysBootTime=sysBootTime, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvIndex=snmpTrapSrvIndex, psNumber=psNumber, psState=psState, psModulePorts=psModulePorts, sysDeviceName=sysDeviceName, snmpTrapVersion=snmpTrapVersion, atMgmt=atMgmt, atSystem=atSystem, snmpTrapSrvCommunity=snmpTrapSrvCommunity, advantechCommonMIB=advantechCommonMIB, atPciConfig=atPciConfig, psFunctionIndex=psFunctionIndex, psDescr=psDescr, sysFirstBootTime=sysFirstBootTime, sysImageVersion=sysImageVersion, snmpTrapSrvNumber=snmpTrapSrvNumber, sysBootCount=sysBootCount, psIRQ=psIRQ, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psIndex=psIndex, psDeviceIndex=psDeviceIndex, sysReleaseDate=sysReleaseDate, snmpTrapSrvPort=snmpTrapSrvPort, pciSlotEntry=pciSlotEntry, psLength=psLength, sysDescr=sysDescr, snmpTrapSrvIP=snmpTrapSrvIP, psVendorID=psVendorID, psClassCode=psClassCode, snmpTrapSrvEntry=snmpTrapSrvEntry, pciSlotTable=pciSlotTable)
