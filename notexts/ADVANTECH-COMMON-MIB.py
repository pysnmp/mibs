...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysFirstBootTime=sysFirstBootTime, psIRQ=psIRQ, atMgmt=atMgmt, psLength=psLength, atSystem=atSystem, snmpTrapVersion=snmpTrapVersion, sysReleaseDate=sysReleaseDate, psClassCode=psClassCode, advantechCommonMIB=advantechCommonMIB, pciSlotTable=pciSlotTable, snmpTrapSrvPort=snmpTrapSrvPort, psLocation=psLocation, pciConfigObj=pciConfigObj, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvNumber=snmpTrapSrvNumber, sysBootCount=sysBootCount, psBusIndex=psBusIndex, psFunctionIndex=psFunctionIndex, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psModuleType=psModuleType, psDeviceIndex=psDeviceIndex, psDescr=psDescr, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvIP=snmpTrapSrvIP, psNumber=psNumber, pciSlotEntry=pciSlotEntry, psVendorID=psVendorID, snmpTrapSrvTable=snmpTrapSrvTable, advantech=advantech, sysModuleID=sysModuleID, psIndex=psIndex, snmpTrapSrvObj=snmpTrapSrvObj, sysDescr=sysDescr, atPciConfig=atPciConfig, sysImageVersion=sysImageVersion, psSubsysVendorID=psSubsysVendorID, sysDeviceName=sysDeviceName, psDeviceID=psDeviceID, snmpTrapSrvEntry=snmpTrapSrvEntry, psModulePorts=psModulePorts, psDisplayName=psDisplayName, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psState=psState, psBaseAddress=psBaseAddress, sysBootTime=sysBootTime, psManufacturer=psManufacturer)
