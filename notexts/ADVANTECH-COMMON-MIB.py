...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", atPciConfig=atPciConfig, psBaseAddress=psBaseAddress, psVendorID=psVendorID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psFunctionIndex=psFunctionIndex, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvNumber=snmpTrapSrvNumber, sysDescr=sysDescr, psDeviceID=psDeviceID, pciSlotTable=pciSlotTable, advantech=advantech, psModuleType=psModuleType, psIndex=psIndex, sysBootCount=sysBootCount, psNumber=psNumber, psDescr=psDescr, atSystem=atSystem, psLocation=psLocation, psManufacturer=psManufacturer, snmpTrapSrvTable=snmpTrapSrvTable, sysReleaseDate=sysReleaseDate, snmpTrapVersion=snmpTrapVersion, psState=psState, psBusIndex=psBusIndex, psDeviceIndex=psDeviceIndex, PYSNMP_MODULE_ID=advantechCommonMIB, sysImageVersion=sysImageVersion, snmpTrapSrvCommunity=snmpTrapSrvCommunity, pciConfigObj=pciConfigObj, psIRQ=psIRQ, psClassCode=psClassCode, psSubsysDeviceID=psSubsysDeviceID, pciSlotEntry=pciSlotEntry, snmpTrapSrvIndex=snmpTrapSrvIndex, psDisplayName=psDisplayName, psSubsysVendorID=psSubsysVendorID, psModulePorts=psModulePorts, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvObj=snmpTrapSrvObj, sysFirstBootTime=sysFirstBootTime, sysDeviceName=sysDeviceName, snmpTrapSrvEntry=snmpTrapSrvEntry, atMgmt=atMgmt, sysModuleID=sysModuleID, sysBootTime=sysBootTime, psLength=psLength, advantechCommonMIB=advantechCommonMIB)
