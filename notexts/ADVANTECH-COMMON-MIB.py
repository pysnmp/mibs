...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psVendorID=psVendorID, psNumber=psNumber, psIRQ=psIRQ, snmpTrapSrvObj=snmpTrapSrvObj, sysReleaseDate=sysReleaseDate, psBusIndex=psBusIndex, snmpTrapSrvIndex=snmpTrapSrvIndex, psLocation=psLocation, psState=psState, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psSubsysDeviceID=psSubsysDeviceID, psDescr=psDescr, psManufacturer=psManufacturer, psIndex=psIndex, pciConfigObj=pciConfigObj, advantech=advantech, sysDescr=sysDescr, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvTable=snmpTrapSrvTable, sysDeviceName=sysDeviceName, sysBootCount=sysBootCount, psClassCode=psClassCode, sysImageVersion=sysImageVersion, snmpTrapSrvIP=snmpTrapSrvIP, psModulePorts=psModulePorts, pciSlotTable=pciSlotTable, psFunctionIndex=psFunctionIndex, psDisplayName=psDisplayName, psDeviceIndex=psDeviceIndex, sysModuleID=sysModuleID, snmpTrapVersion=snmpTrapVersion, pciSlotEntry=pciSlotEntry, psDeviceID=psDeviceID, atSystem=atSystem, atPciConfig=atPciConfig, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psBaseAddress=psBaseAddress, psModuleType=psModuleType, PYSNMP_MODULE_ID=advantechCommonMIB, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvPort=snmpTrapSrvPort, advantechCommonMIB=advantechCommonMIB, psLength=psLength, sysFirstBootTime=sysFirstBootTime, atMgmt=atMgmt, snmpTrapSrvEntry=snmpTrapSrvEntry, sysBootTime=sysBootTime)
