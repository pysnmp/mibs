...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psState=psState, sysDeviceName=sysDeviceName, psLength=psLength, psIRQ=psIRQ, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysBootCount=sysBootCount, pciConfigObj=pciConfigObj, psLocation=psLocation, psBaseAddress=psBaseAddress, psDeviceIndex=psDeviceIndex, sysBootTime=sysBootTime, psDeviceID=psDeviceID, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvNumber=snmpTrapSrvNumber, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapVersion=snmpTrapVersion, psNumber=psNumber, psIndex=psIndex, psModuleType=psModuleType, psClassCode=psClassCode, psManufacturer=psManufacturer, pciSlotTable=pciSlotTable, psFunctionIndex=psFunctionIndex, snmpTrapSrvTable=snmpTrapSrvTable, atSystem=atSystem, advantechCommonMIB=advantechCommonMIB, atPciConfig=atPciConfig, sysDescr=sysDescr, snmpTrapSrvObj=snmpTrapSrvObj, psBusIndex=psBusIndex, psDescr=psDescr, psVendorID=psVendorID, advantech=advantech, psDisplayName=psDisplayName, sysReleaseDate=sysReleaseDate, snmpTrapSrvIP=snmpTrapSrvIP, PYSNMP_MODULE_ID=advantechCommonMIB, atMgmt=atMgmt, psSubsysVendorID=psSubsysVendorID, pciSlotEntry=pciSlotEntry, sysModuleID=sysModuleID, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysImageVersion=sysImageVersion, psModulePorts=psModulePorts)
