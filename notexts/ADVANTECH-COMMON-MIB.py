...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysModuleID=sysModuleID, psModuleType=psModuleType, PYSNMP_MODULE_ID=advantechCommonMIB, psManufacturer=psManufacturer, sysImageVersion=sysImageVersion, psVendorID=psVendorID, psBusIndex=psBusIndex, sysFirstBootTime=sysFirstBootTime, advantechCommonMIB=advantechCommonMIB, psIndex=psIndex, snmpTrapSrvTable=snmpTrapSrvTable, psLocation=psLocation, snmpTrapSrvIP=snmpTrapSrvIP, psDescr=psDescr, psSubsysDeviceID=psSubsysDeviceID, atSystem=atSystem, psLength=psLength, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvNumber=snmpTrapSrvNumber, advantech=advantech, psDeviceIndex=psDeviceIndex, sysBootTime=sysBootTime, pciSlotEntry=pciSlotEntry, psFunctionIndex=psFunctionIndex, psIRQ=psIRQ, pciConfigObj=pciConfigObj, sysDescr=sysDescr, snmpTrapSrvEntry=snmpTrapSrvEntry, psModulePorts=psModulePorts, snmpTrapVersion=snmpTrapVersion, psNumber=psNumber, psClassCode=psClassCode, psDisplayName=psDisplayName, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysReleaseDate=sysReleaseDate, atPciConfig=atPciConfig, psBaseAddress=psBaseAddress, psDeviceID=psDeviceID, sysDeviceName=sysDeviceName, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvIndex=snmpTrapSrvIndex, psState=psState, psSubsysVendorID=psSubsysVendorID, atMgmt=atMgmt, pciSlotTable=pciSlotTable, sysBootCount=sysBootCount)
