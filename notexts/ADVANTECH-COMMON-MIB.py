...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, atSystem=atSystem, psDescr=psDescr, snmpTrapSrvEntry=snmpTrapSrvEntry, atPciConfig=atPciConfig, psBusIndex=psBusIndex, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvObj=snmpTrapSrvObj, sysBootTime=sysBootTime, pciConfigObj=pciConfigObj, sysDescr=sysDescr, snmpTrapSrvNumber=snmpTrapSrvNumber, psVendorID=psVendorID, psLocation=psLocation, psNumber=psNumber, snmpTrapSrvTable=snmpTrapSrvTable, psClassCode=psClassCode, psDeviceIndex=psDeviceIndex, psState=psState, sysReleaseDate=sysReleaseDate, psLength=psLength, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysBootCount=sysBootCount, PYSNMP_MODULE_ID=advantechCommonMIB, pciSlotEntry=pciSlotEntry, snmpTrapSrvPort=snmpTrapSrvPort, advantech=advantech, psDisplayName=psDisplayName, atMgmt=atMgmt, psDeviceID=psDeviceID, psIRQ=psIRQ, sysDeviceName=sysDeviceName, pciSlotTable=pciSlotTable, psFunctionIndex=psFunctionIndex, psModuleType=psModuleType, sysImageVersion=sysImageVersion, snmpTrapVersion=snmpTrapVersion, psSubsysDeviceID=psSubsysDeviceID, psManufacturer=psManufacturer, psModulePorts=psModulePorts, sysFirstBootTime=sysFirstBootTime, sysModuleID=sysModuleID, psBaseAddress=psBaseAddress, snmpTrapSrvIndex=snmpTrapSrvIndex, psIndex=psIndex, psSubsysVendorID=psSubsysVendorID, advantechCommonMIB=advantechCommonMIB)
