...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysFirstBootTime=sysFirstBootTime, pciSlotEntry=pciSlotEntry, psVendorID=psVendorID, psDisplayName=psDisplayName, sysReleaseDate=sysReleaseDate, snmpTrapSrvIP=snmpTrapSrvIP, psLocation=psLocation, sysModuleID=sysModuleID, sysDeviceName=sysDeviceName, PYSNMP_MODULE_ID=advantechCommonMIB, psLength=psLength, sysBootTime=sysBootTime, atSystem=atSystem, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvPort=snmpTrapSrvPort, psClassCode=psClassCode, psNumber=psNumber, sysImageVersion=sysImageVersion, psManufacturer=psManufacturer, psSubsysDeviceID=psSubsysDeviceID, psDeviceID=psDeviceID, psIRQ=psIRQ, pciConfigObj=pciConfigObj, advantech=advantech, psDeviceIndex=psDeviceIndex, atPciConfig=atPciConfig, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvNumber=snmpTrapSrvNumber, sysBootCount=sysBootCount, psState=psState, atMgmt=atMgmt, psModulePorts=psModulePorts, snmpTrapSrvTable=snmpTrapSrvTable, psIndex=psIndex, psModuleType=psModuleType, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psFunctionIndex=psFunctionIndex, snmpTrapSrvIndex=snmpTrapSrvIndex, psBusIndex=psBusIndex, sysDescr=sysDescr, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psDescr=psDescr, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvEntry=snmpTrapSrvEntry, pciSlotTable=pciSlotTable, snmpTrapSrvObj=snmpTrapSrvObj, psBaseAddress=psBaseAddress)
