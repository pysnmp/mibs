...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", pciConfigObj=pciConfigObj, psDeviceID=psDeviceID, atSystem=atSystem, psModulePorts=psModulePorts, atPciConfig=atPciConfig, psIndex=psIndex, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvTable=snmpTrapSrvTable, atMgmt=atMgmt, pciSlotEntry=pciSlotEntry, psClassCode=psClassCode, snmpTrapSrvNumber=snmpTrapSrvNumber, sysImageVersion=sysImageVersion, sysFirstBootTime=sysFirstBootTime, psIRQ=psIRQ, psBusIndex=psBusIndex, psModuleType=psModuleType, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psFunctionIndex=psFunctionIndex, psSubsysDeviceID=psSubsysDeviceID, sysBootTime=sysBootTime, psDeviceIndex=psDeviceIndex, pciSlotTable=pciSlotTable, psDisplayName=psDisplayName, sysDescr=sysDescr, snmpTrapSrvIP=snmpTrapSrvIP, sysReleaseDate=sysReleaseDate, psSubsysVendorID=psSubsysVendorID, psVendorID=psVendorID, snmpTrapSrvCommunity=snmpTrapSrvCommunity, advantechCommonMIB=advantechCommonMIB, psState=psState, sysModuleID=sysModuleID, advantech=advantech, psManufacturer=psManufacturer, sysDeviceName=sysDeviceName, snmpTrapSrvEntry=snmpTrapSrvEntry, psNumber=psNumber, snmpTrapSrvPort=snmpTrapSrvPort, psLength=psLength, psDescr=psDescr, snmpTrapSrvIndex=snmpTrapSrvIndex, psLocation=psLocation, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapVersion=snmpTrapVersion, psBaseAddress=psBaseAddress, sysBootCount=sysBootCount)
