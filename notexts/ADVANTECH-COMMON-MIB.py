...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvTable=snmpTrapSrvTable, pciSlotEntry=pciSlotEntry, psDeviceID=psDeviceID, psIRQ=psIRQ, psVendorID=psVendorID, psModuleType=psModuleType, psManufacturer=psManufacturer, psIndex=psIndex, psModulePorts=psModulePorts, psDisplayName=psDisplayName, sysBootTime=sysBootTime, sysDescr=sysDescr, sysFirstBootTime=sysFirstBootTime, PYSNMP_MODULE_ID=advantechCommonMIB, psSubsysVendorID=psSubsysVendorID, snmpTrapVersion=snmpTrapVersion, psLength=psLength, pciSlotTable=pciSlotTable, sysModuleID=sysModuleID, snmpTrapSrvNumber=snmpTrapSrvNumber, psBusIndex=psBusIndex, atSystem=atSystem, snmpTrapSrvObj=snmpTrapSrvObj, psNumber=psNumber, psClassCode=psClassCode, psLocation=psLocation, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, atPciConfig=atPciConfig, sysImageVersion=sysImageVersion, psFunctionIndex=psFunctionIndex, advantechCommonMIB=advantechCommonMIB, sysBootCount=sysBootCount, atMgmt=atMgmt, psDescr=psDescr, snmpTrapSrvIndex=snmpTrapSrvIndex, psDeviceIndex=psDeviceIndex, sysDeviceName=sysDeviceName, snmpTrapSrvPort=snmpTrapSrvPort, advantech=advantech, snmpTrapSrvIP=snmpTrapSrvIP, psSubsysDeviceID=psSubsysDeviceID, psBaseAddress=psBaseAddress, psState=psState, sysReleaseDate=sysReleaseDate, pciConfigObj=pciConfigObj, snmpTrapSrvEntry=snmpTrapSrvEntry)
