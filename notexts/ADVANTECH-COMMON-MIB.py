...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapVersion=snmpTrapVersion, sysBootTime=sysBootTime, psIndex=psIndex, psSubsysVendorID=psSubsysVendorID, psState=psState, sysFirstBootTime=sysFirstBootTime, psDeviceID=psDeviceID, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psNumber=psNumber, sysDescr=sysDescr, PYSNMP_MODULE_ID=advantechCommonMIB, psDisplayName=psDisplayName, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvIndex=snmpTrapSrvIndex, sysDeviceName=sysDeviceName, atPciConfig=atPciConfig, snmpTrapSrvTable=snmpTrapSrvTable, psModuleType=psModuleType, sysImageVersion=sysImageVersion, psClassCode=psClassCode, psManufacturer=psManufacturer, psModulePorts=psModulePorts, sysModuleID=sysModuleID, pciSlotEntry=pciSlotEntry, psLength=psLength, sysBootCount=sysBootCount, psBaseAddress=psBaseAddress, psFunctionIndex=psFunctionIndex, psSubsysDeviceID=psSubsysDeviceID, atMgmt=atMgmt, psDeviceIndex=psDeviceIndex, advantech=advantech, psVendorID=psVendorID, snmpTrapSrvEntry=snmpTrapSrvEntry, sysReleaseDate=sysReleaseDate, pciSlotTable=pciSlotTable, psLocation=psLocation, atSystem=atSystem, snmpTrapSrvIP=snmpTrapSrvIP, psIRQ=psIRQ, psDescr=psDescr, advantechCommonMIB=advantechCommonMIB, psBusIndex=psBusIndex, pciConfigObj=pciConfigObj, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvObj=snmpTrapSrvObj)
