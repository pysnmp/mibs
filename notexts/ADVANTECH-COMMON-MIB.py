...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psModuleType=psModuleType, psFunctionIndex=psFunctionIndex, snmpTrapSrvTable=snmpTrapSrvTable, psSubsysVendorID=psSubsysVendorID, sysBootTime=sysBootTime, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psNumber=psNumber, psDescr=psDescr, psDeviceIndex=psDeviceIndex, advantech=advantech, psIRQ=psIRQ, sysReleaseDate=sysReleaseDate, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvObj=snmpTrapSrvObj, psModulePorts=psModulePorts, snmpTrapSrvEntry=snmpTrapSrvEntry, sysImageVersion=sysImageVersion, snmpTrapSrvPort=snmpTrapSrvPort, pciConfigObj=pciConfigObj, psLength=psLength, snmpTrapSrvIP=snmpTrapSrvIP, psDeviceID=psDeviceID, atMgmt=atMgmt, psDisplayName=psDisplayName, psVendorID=psVendorID, sysDescr=sysDescr, psSubsysDeviceID=psSubsysDeviceID, sysFirstBootTime=sysFirstBootTime, psLocation=psLocation, atPciConfig=atPciConfig, snmpTrapSrvIndex=snmpTrapSrvIndex, psManufacturer=psManufacturer, psBusIndex=psBusIndex, snmpTrapVersion=snmpTrapVersion, psBaseAddress=psBaseAddress, sysDeviceName=sysDeviceName, snmpTrapSrvNumber=snmpTrapSrvNumber, PYSNMP_MODULE_ID=advantechCommonMIB, psState=psState, psIndex=psIndex, psClassCode=psClassCode, sysBootCount=sysBootCount, atSystem=atSystem, pciSlotTable=pciSlotTable, pciSlotEntry=pciSlotEntry, sysModuleID=sysModuleID)
