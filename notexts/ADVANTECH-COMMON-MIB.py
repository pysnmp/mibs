...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psDisplayName=psDisplayName, psIRQ=psIRQ, psClassCode=psClassCode, sysBootCount=sysBootCount, psModulePorts=psModulePorts, psLocation=psLocation, psModuleType=psModuleType, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvEntry=snmpTrapSrvEntry, psBusIndex=psBusIndex, advantech=advantech, psSubsysDeviceID=psSubsysDeviceID, sysBootTime=sysBootTime, atMgmt=atMgmt, atPciConfig=atPciConfig, psState=psState, pciConfigObj=pciConfigObj, psManufacturer=psManufacturer, sysDescr=sysDescr, sysReleaseDate=sysReleaseDate, psFunctionIndex=psFunctionIndex, snmpTrapSrvObj=snmpTrapSrvObj, sysModuleID=sysModuleID, psVendorID=psVendorID, sysFirstBootTime=sysFirstBootTime, atSystem=atSystem, psDeviceID=psDeviceID, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvIP=snmpTrapSrvIP, sysImageVersion=sysImageVersion, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psLength=psLength, psSubsysVendorID=psSubsysVendorID, psDescr=psDescr, pciSlotEntry=pciSlotEntry, snmpTrapSrvTable=snmpTrapSrvTable, psDeviceIndex=psDeviceIndex, snmpTrapSrvNumber=snmpTrapSrvNumber, sysDeviceName=sysDeviceName, snmpTrapVersion=snmpTrapVersion, psNumber=psNumber, psIndex=psIndex, pciSlotTable=pciSlotTable, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psBaseAddress=psBaseAddress)
