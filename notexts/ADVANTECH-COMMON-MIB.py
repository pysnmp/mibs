...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psIndex=psIndex, sysDeviceName=sysDeviceName, psLocation=psLocation, psState=psState, psSubsysDeviceID=psSubsysDeviceID, sysBootTime=sysBootTime, snmpTrapSrvCommunity=snmpTrapSrvCommunity, pciSlotTable=pciSlotTable, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psClassCode=psClassCode, sysReleaseDate=sysReleaseDate, psFunctionIndex=psFunctionIndex, sysBootCount=sysBootCount, PYSNMP_MODULE_ID=advantechCommonMIB, psDescr=psDescr, atPciConfig=atPciConfig, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvNumber=snmpTrapSrvNumber, atMgmt=atMgmt, psDeviceIndex=psDeviceIndex, psVendorID=psVendorID, sysDescr=sysDescr, psDisplayName=psDisplayName, psModulePorts=psModulePorts, pciConfigObj=pciConfigObj, psBusIndex=psBusIndex, psLength=psLength, snmpTrapSrvTable=snmpTrapSrvTable, psManufacturer=psManufacturer, sysImageVersion=sysImageVersion, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvObj=snmpTrapSrvObj, sysFirstBootTime=sysFirstBootTime, psBaseAddress=psBaseAddress, atSystem=atSystem, snmpTrapSrvIP=snmpTrapSrvIP, sysModuleID=sysModuleID, psIRQ=psIRQ, psModuleType=psModuleType, psDeviceID=psDeviceID, advantech=advantech, psNumber=psNumber, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvPort=snmpTrapSrvPort, pciSlotEntry=pciSlotEntry)
