...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psModulePorts=psModulePorts, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvNumber=snmpTrapSrvNumber, psBaseAddress=psBaseAddress, psLength=psLength, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvTable=snmpTrapSrvTable, advantech=advantech, psClassCode=psClassCode, psNumber=psNumber, psFunctionIndex=psFunctionIndex, atMgmt=atMgmt, sysDeviceName=sysDeviceName, psIndex=psIndex, atPciConfig=atPciConfig, advantechCommonMIB=advantechCommonMIB, psSubsysDeviceID=psSubsysDeviceID, pciSlotTable=pciSlotTable, sysModuleID=sysModuleID, snmpTrapSrvIP=snmpTrapSrvIP, psModuleType=psModuleType, psIRQ=psIRQ, snmpTrapSrvEntry=snmpTrapSrvEntry, psManufacturer=psManufacturer, psDeviceIndex=psDeviceIndex, psVendorID=psVendorID, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psDisplayName=psDisplayName, psDescr=psDescr, pciConfigObj=pciConfigObj, sysBootCount=sysBootCount, sysFirstBootTime=sysFirstBootTime, psLocation=psLocation, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psSubsysVendorID=psSubsysVendorID, sysBootTime=sysBootTime, psBusIndex=psBusIndex, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvIndex=snmpTrapSrvIndex, pciSlotEntry=pciSlotEntry, psDeviceID=psDeviceID, psState=psState, PYSNMP_MODULE_ID=advantechCommonMIB, sysReleaseDate=sysReleaseDate, sysDescr=sysDescr, sysImageVersion=sysImageVersion, atSystem=atSystem)
