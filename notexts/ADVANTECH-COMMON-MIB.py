...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psIRQ=psIRQ, sysBootCount=sysBootCount, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapVersion=snmpTrapVersion, psBaseAddress=psBaseAddress, atMgmt=atMgmt, advantech=advantech, psNumber=psNumber, snmpTrapSrvPort=snmpTrapSrvPort, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvIndex=snmpTrapSrvIndex, pciSlotEntry=pciSlotEntry, psManufacturer=psManufacturer, pciSlotTable=pciSlotTable, pciConfigObj=pciConfigObj, sysImageVersion=sysImageVersion, psLocation=psLocation, psState=psState, psModulePorts=psModulePorts, snmpTrapSrvTable=snmpTrapSrvTable, psLength=psLength, atSystem=atSystem, sysModuleID=sysModuleID, snmpTrapSrvEntry=snmpTrapSrvEntry, psVendorID=psVendorID, psIndex=psIndex, psDescr=psDescr, sysDeviceName=sysDeviceName, psModuleType=psModuleType, sysFirstBootTime=sysFirstBootTime, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvIP=snmpTrapSrvIP, PYSNMP_MODULE_ID=advantechCommonMIB, psDisplayName=psDisplayName, psClassCode=psClassCode, psDeviceID=psDeviceID, psBusIndex=psBusIndex, sysBootTime=sysBootTime, atPciConfig=atPciConfig, sysDescr=sysDescr, snmpTrapSrvObj=snmpTrapSrvObj, psFunctionIndex=psFunctionIndex, psDeviceIndex=psDeviceIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvNumber=snmpTrapSrvNumber, sysReleaseDate=sysReleaseDate)
