...
TimeTicks, IpAddress, Integer32, Counter32, iso, Unsigned32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity, ObjectIdentity, Gauge32, enterprises, NotificationType, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "Integer32", "Counter32", "iso", "Unsigned32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "Gauge32", "enterprises", "NotificationType", "Bits")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvIndex=snmpTrapSrvIndex, psState=psState, sysBootTime=sysBootTime, atMgmt=atMgmt, snmpTrapSrvObj=snmpTrapSrvObj, atPciConfig=atPciConfig, pciSlotEntry=pciSlotEntry, psClassCode=psClassCode, snmpTrapVersion=snmpTrapVersion, psManufacturer=psManufacturer, snmpTrapSrvIP=snmpTrapSrvIP, sysDescr=sysDescr, psDeviceID=psDeviceID, snmpTrapSrvEntry=snmpTrapSrvEntry, psDescr=psDescr, psSubsysVendorID=psSubsysVendorID, sysModuleID=sysModuleID, PYSNMP_MODULE_ID=advantechCommonMIB, sysDeviceName=sysDeviceName, psDeviceIndex=psDeviceIndex, psFunctionIndex=psFunctionIndex, snmpTrapSrvPort=snmpTrapSrvPort, advantechCommonMIB=advantechCommonMIB, sysReleaseDate=sysReleaseDate, psIndex=psIndex, psBusIndex=psBusIndex, psIRQ=psIRQ, advantech=advantech, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psBaseAddress=psBaseAddress, sysImageVersion=sysImageVersion, psNumber=psNumber, sysBootCount=sysBootCount, psLocation=psLocation, psDisplayName=psDisplayName, psLength=psLength, psModuleType=psModuleType, psModulePorts=psModulePorts, snmpTrapSrvCommunity=snmpTrapSrvCommunity, pciSlotTable=pciSlotTable, atSystem=atSystem, pciConfigObj=pciConfigObj, psSubsysDeviceID=psSubsysDeviceID, psVendorID=psVendorID)
