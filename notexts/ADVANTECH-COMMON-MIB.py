...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvNumber=snmpTrapSrvNumber, psBusIndex=psBusIndex, psState=psState, psVendorID=psVendorID, snmpTrapSrvObj=snmpTrapSrvObj, advantech=advantech, PYSNMP_MODULE_ID=advantechCommonMIB, psBaseAddress=psBaseAddress, psDisplayName=psDisplayName, sysModuleID=sysModuleID, snmpTrapSrvEntry=snmpTrapSrvEntry, sysReleaseDate=sysReleaseDate, advantechCommonMIB=advantechCommonMIB, pciSlotEntry=pciSlotEntry, psFunctionIndex=psFunctionIndex, psDescr=psDescr, psLength=psLength, sysBootTime=sysBootTime, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psDeviceID=psDeviceID, psIRQ=psIRQ, psNumber=psNumber, psIndex=psIndex, sysBootCount=sysBootCount, pciSlotTable=pciSlotTable, sysDeviceName=sysDeviceName, psModuleType=psModuleType, atPciConfig=atPciConfig, psDeviceIndex=psDeviceIndex, psModulePorts=psModulePorts, psSubsysDeviceID=psSubsysDeviceID, psClassCode=psClassCode, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvIP=snmpTrapSrvIP, psManufacturer=psManufacturer, snmpTrapVersion=snmpTrapVersion, psSubsysVendorID=psSubsysVendorID, psLocation=psLocation, sysDescr=sysDescr, snmpTrapSrvPort=snmpTrapSrvPort, pciConfigObj=pciConfigObj, sysImageVersion=sysImageVersion, atMgmt=atMgmt, atSystem=atSystem)
