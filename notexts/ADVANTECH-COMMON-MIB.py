...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysFirstBootTime=sysFirstBootTime, psBaseAddress=psBaseAddress, psModulePorts=psModulePorts, snmpTrapVersion=snmpTrapVersion, psDeviceIndex=psDeviceIndex, psClassCode=psClassCode, sysDeviceName=sysDeviceName, snmpTrapSrvIndex=snmpTrapSrvIndex, psSubsysDeviceID=psSubsysDeviceID, pciSlotTable=pciSlotTable, psFunctionIndex=psFunctionIndex, snmpTrapSrvPort=snmpTrapSrvPort, psIndex=psIndex, psLength=psLength, psDeviceID=psDeviceID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, atSystem=atSystem, sysBootCount=sysBootCount, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psDisplayName=psDisplayName, psVendorID=psVendorID, psLocation=psLocation, snmpTrapSrvEntry=snmpTrapSrvEntry, sysDescr=sysDescr, snmpTrapSrvNumber=snmpTrapSrvNumber, psIRQ=psIRQ, psDescr=psDescr, psState=psState, psBusIndex=psBusIndex, atPciConfig=atPciConfig, snmpTrapSrvTable=snmpTrapSrvTable, pciSlotEntry=pciSlotEntry, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvObj=snmpTrapSrvObj, sysImageVersion=sysImageVersion, psNumber=psNumber, sysBootTime=sysBootTime, advantech=advantech, snmpTrapSrvIP=snmpTrapSrvIP, advantechCommonMIB=advantechCommonMIB, pciConfigObj=pciConfigObj, sysReleaseDate=sysReleaseDate, sysModuleID=sysModuleID, psModuleType=psModuleType, psManufacturer=psManufacturer, psSubsysVendorID=psSubsysVendorID, atMgmt=atMgmt)
