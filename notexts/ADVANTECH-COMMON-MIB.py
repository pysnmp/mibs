...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psModulePorts=psModulePorts, pciSlotEntry=pciSlotEntry, snmpTrapSrvNumber=snmpTrapSrvNumber, psState=psState, psNumber=psNumber, psModuleType=psModuleType, psDescr=psDescr, sysReleaseDate=sysReleaseDate, psFunctionIndex=psFunctionIndex, psDisplayName=psDisplayName, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvEntry=snmpTrapSrvEntry, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvIndex=snmpTrapSrvIndex, psIndex=psIndex, psDeviceIndex=psDeviceIndex, psLocation=psLocation, sysImageVersion=sysImageVersion, snmpTrapSrvIP=snmpTrapSrvIP, atMgmt=atMgmt, psLength=psLength, pciSlotTable=pciSlotTable, psSubsysDeviceID=psSubsysDeviceID, psClassCode=psClassCode, psIRQ=psIRQ, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, pciConfigObj=pciConfigObj, sysFirstBootTime=sysFirstBootTime, atSystem=atSystem, advantech=advantech, psBusIndex=psBusIndex, sysBootCount=sysBootCount, psManufacturer=psManufacturer, atPciConfig=atPciConfig, psBaseAddress=psBaseAddress, sysModuleID=sysModuleID, psVendorID=psVendorID, PYSNMP_MODULE_ID=advantechCommonMIB, sysDescr=sysDescr, sysBootTime=sysBootTime, snmpTrapVersion=snmpTrapVersion, psSubsysVendorID=psSubsysVendorID, psDeviceID=psDeviceID, sysDeviceName=sysDeviceName)
