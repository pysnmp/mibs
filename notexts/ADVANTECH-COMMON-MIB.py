...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psState=psState, snmpTrapSrvPort=snmpTrapSrvPort, sysReleaseDate=sysReleaseDate, psBusIndex=psBusIndex, psClassCode=psClassCode, sysBootCount=sysBootCount, sysDeviceName=sysDeviceName, sysDescr=sysDescr, psDeviceID=psDeviceID, psDisplayName=psDisplayName, snmpTrapSrvIndex=snmpTrapSrvIndex, sysModuleID=sysModuleID, psLocation=psLocation, psBaseAddress=psBaseAddress, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvTable=snmpTrapSrvTable, pciSlotTable=pciSlotTable, sysImageVersion=sysImageVersion, atSystem=atSystem, psDeviceIndex=psDeviceIndex, atMgmt=atMgmt, advantech=advantech, psIRQ=psIRQ, psSubsysDeviceID=psSubsysDeviceID, psLength=psLength, snmpTrapSrvIP=snmpTrapSrvIP, PYSNMP_MODULE_ID=advantechCommonMIB, psModulePorts=psModulePorts, psFunctionIndex=psFunctionIndex, pciSlotEntry=pciSlotEntry, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvObj=snmpTrapSrvObj, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapVersion=snmpTrapVersion, psModuleType=psModuleType, snmpTrapSrvEntry=snmpTrapSrvEntry, psIndex=psIndex, psNumber=psNumber, pciConfigObj=pciConfigObj, psDescr=psDescr, advantechCommonMIB=advantechCommonMIB, psVendorID=psVendorID, psManufacturer=psManufacturer, atPciConfig=atPciConfig, sysBootTime=sysBootTime)
