...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysBootCount=sysBootCount, psDeviceIndex=psDeviceIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, psFunctionIndex=psFunctionIndex, psIndex=psIndex, pciConfigObj=pciConfigObj, psBusIndex=psBusIndex, psModuleType=psModuleType, snmpTrapSrvNumber=snmpTrapSrvNumber, atPciConfig=atPciConfig, psVendorID=psVendorID, psIRQ=psIRQ, sysModuleID=sysModuleID, sysDeviceName=sysDeviceName, psLength=psLength, advantech=advantech, snmpTrapSrvTable=snmpTrapSrvTable, psDisplayName=psDisplayName, psModulePorts=psModulePorts, psSubsysVendorID=psSubsysVendorID, psState=psState, psDescr=psDescr, snmpTrapSrvIP=snmpTrapSrvIP, pciSlotTable=pciSlotTable, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psNumber=psNumber, advantechCommonMIB=advantechCommonMIB, sysImageVersion=sysImageVersion, sysDescr=sysDescr, atMgmt=atMgmt, snmpTrapSrvCommunity=snmpTrapSrvCommunity, pciSlotEntry=pciSlotEntry, sysReleaseDate=sysReleaseDate, sysFirstBootTime=sysFirstBootTime, psSubsysDeviceID=psSubsysDeviceID, psBaseAddress=psBaseAddress, atSystem=atSystem, sysBootTime=sysBootTime, snmpTrapVersion=snmpTrapVersion, psManufacturer=psManufacturer, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvObj=snmpTrapSrvObj, psDeviceID=psDeviceID, psLocation=psLocation, psClassCode=psClassCode, snmpTrapSrvPort=snmpTrapSrvPort, PYSNMP_MODULE_ID=advantechCommonMIB)
