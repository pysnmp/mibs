...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psBusIndex=psBusIndex, sysBootTime=sysBootTime, snmpTrapSrvEntry=snmpTrapSrvEntry, psDisplayName=psDisplayName, psDescr=psDescr, sysDeviceName=sysDeviceName, psState=psState, psFunctionIndex=psFunctionIndex, snmpTrapVersion=snmpTrapVersion, psNumber=psNumber, sysImageVersion=sysImageVersion, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psModuleType=psModuleType, atPciConfig=atPciConfig, pciSlotTable=pciSlotTable, psDeviceID=psDeviceID, snmpTrapSrvPort=snmpTrapSrvPort, psVendorID=psVendorID, pciSlotEntry=pciSlotEntry, psIndex=psIndex, sysModuleID=sysModuleID, psDeviceIndex=psDeviceIndex, psModulePorts=psModulePorts, sysBootCount=sysBootCount, psIRQ=psIRQ, atMgmt=atMgmt, advantech=advantech, sysFirstBootTime=sysFirstBootTime, psManufacturer=psManufacturer, snmpTrapSrvTable=snmpTrapSrvTable, psLocation=psLocation, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvIP=snmpTrapSrvIP, advantechCommonMIB=advantechCommonMIB, psLength=psLength, psClassCode=psClassCode, psSubsysVendorID=psSubsysVendorID, sysDescr=sysDescr, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psBaseAddress=psBaseAddress, psSubsysDeviceID=psSubsysDeviceID, sysReleaseDate=sysReleaseDate, atSystem=atSystem, pciConfigObj=pciConfigObj)
