...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", advantech=advantech, atSystem=atSystem, sysDeviceName=sysDeviceName, snmpTrapSrvNumber=snmpTrapSrvNumber, psSubsysDeviceID=psSubsysDeviceID, pciConfigObj=pciConfigObj, pciSlotTable=pciSlotTable, psLength=psLength, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvIndex=snmpTrapSrvIndex, sysImageVersion=sysImageVersion, snmpTrapSrvPort=snmpTrapSrvPort, atMgmt=atMgmt, pciSlotEntry=pciSlotEntry, psDeviceIndex=psDeviceIndex, psSubsysVendorID=psSubsysVendorID, psBaseAddress=psBaseAddress, psModuleType=psModuleType, sysModuleID=sysModuleID, sysDescr=sysDescr, psIndex=psIndex, advantechCommonMIB=advantechCommonMIB, psManufacturer=psManufacturer, psClassCode=psClassCode, sysBootTime=sysBootTime, psIRQ=psIRQ, sysReleaseDate=sysReleaseDate, psBusIndex=psBusIndex, psLocation=psLocation, atPciConfig=atPciConfig, sysBootCount=sysBootCount, psDescr=psDescr, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvEntry=snmpTrapSrvEntry, psNumber=psNumber, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psDisplayName=psDisplayName, psVendorID=psVendorID, snmpTrapVersion=snmpTrapVersion, psDeviceID=psDeviceID, psState=psState, snmpTrapSrvTable=snmpTrapSrvTable, psModulePorts=psModulePorts, psFunctionIndex=psFunctionIndex)
