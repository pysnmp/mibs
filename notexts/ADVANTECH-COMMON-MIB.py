...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psFunctionIndex=psFunctionIndex, psDescr=psDescr, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psClassCode=psClassCode, pciSlotEntry=pciSlotEntry, psVendorID=psVendorID, pciSlotTable=pciSlotTable, pciConfigObj=pciConfigObj, psNumber=psNumber, sysBootTime=sysBootTime, atPciConfig=atPciConfig, atSystem=atSystem, snmpTrapVersion=snmpTrapVersion, psLocation=psLocation, sysBootCount=sysBootCount, snmpTrapSrvPort=snmpTrapSrvPort, psBusIndex=psBusIndex, psBaseAddress=psBaseAddress, psSubsysDeviceID=psSubsysDeviceID, psModulePorts=psModulePorts, atMgmt=atMgmt, psSubsysVendorID=psSubsysVendorID, sysModuleID=sysModuleID, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvIP=snmpTrapSrvIP, sysDescr=sysDescr, advantech=advantech, psDisplayName=psDisplayName, psManufacturer=psManufacturer, snmpTrapSrvObj=snmpTrapSrvObj, sysDeviceName=sysDeviceName, psModuleType=psModuleType, psLength=psLength, advantechCommonMIB=advantechCommonMIB, psIRQ=psIRQ, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysFirstBootTime=sysFirstBootTime, sysReleaseDate=sysReleaseDate, psDeviceID=psDeviceID, psState=psState, snmpTrapSrvEntry=snmpTrapSrvEntry, sysImageVersion=sysImageVersion, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvNumber=snmpTrapSrvNumber, psDeviceIndex=psDeviceIndex, psIndex=psIndex)
