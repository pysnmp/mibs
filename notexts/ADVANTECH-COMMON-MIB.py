...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psIRQ=psIRQ, psLength=psLength, atSystem=atSystem, sysDescr=sysDescr, psVendorID=psVendorID, psManufacturer=psManufacturer, pciSlotTable=pciSlotTable, atMgmt=atMgmt, psClassCode=psClassCode, psBaseAddress=psBaseAddress, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvIP=snmpTrapSrvIP, pciConfigObj=pciConfigObj, psState=psState, psDescr=psDescr, psLocation=psLocation, sysBootTime=sysBootTime, advantech=advantech, psBusIndex=psBusIndex, snmpTrapSrvIndex=snmpTrapSrvIndex, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvObj=snmpTrapSrvObj, sysBootCount=sysBootCount, psIndex=psIndex, pciSlotEntry=pciSlotEntry, sysReleaseDate=sysReleaseDate, psModulePorts=psModulePorts, psDeviceIndex=psDeviceIndex, psModuleType=psModuleType, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysModuleID=sysModuleID, sysImageVersion=sysImageVersion, snmpTrapSrvNumber=snmpTrapSrvNumber, psDeviceID=psDeviceID, snmpTrapSrvPort=snmpTrapSrvPort, PYSNMP_MODULE_ID=advantechCommonMIB, psDisplayName=psDisplayName, sysFirstBootTime=sysFirstBootTime, psSubsysDeviceID=psSubsysDeviceID, psSubsysVendorID=psSubsysVendorID, atPciConfig=atPciConfig, psNumber=psNumber, sysDeviceName=sysDeviceName, snmpTrapSrvEntry=snmpTrapSrvEntry, psFunctionIndex=psFunctionIndex)
