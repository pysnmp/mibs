...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysDescr=sysDescr, sysBootTime=sysBootTime, psIRQ=psIRQ, psFunctionIndex=psFunctionIndex, psModulePorts=psModulePorts, snmpTrapSrvTable=snmpTrapSrvTable, sysImageVersion=sysImageVersion, atPciConfig=atPciConfig, psManufacturer=psManufacturer, atMgmt=atMgmt, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvNumber=snmpTrapSrvNumber, sysModuleID=sysModuleID, pciSlotTable=pciSlotTable, advantechCommonMIB=advantechCommonMIB, psBaseAddress=psBaseAddress, psNumber=psNumber, psDeviceID=psDeviceID, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvIndex=snmpTrapSrvIndex, advantech=advantech, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysDeviceName=sysDeviceName, psVendorID=psVendorID, snmpTrapSrvPort=snmpTrapSrvPort, pciSlotEntry=pciSlotEntry, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psSubsysDeviceID=psSubsysDeviceID, psClassCode=psClassCode, psDisplayName=psDisplayName, psModuleType=psModuleType, snmpTrapSrvEntry=snmpTrapSrvEntry, pciConfigObj=pciConfigObj, sysReleaseDate=sysReleaseDate, snmpTrapSrvIP=snmpTrapSrvIP, sysBootCount=sysBootCount, psLength=psLength, psState=psState, psLocation=psLocation, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvObj=snmpTrapSrvObj, PYSNMP_MODULE_ID=advantechCommonMIB, psDeviceIndex=psDeviceIndex, psBusIndex=psBusIndex, atSystem=atSystem, psDescr=psDescr, psIndex=psIndex)
