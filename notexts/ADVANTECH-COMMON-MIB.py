...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapVersion=snmpTrapVersion, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvNumber=snmpTrapSrvNumber, psDeviceID=psDeviceID, psState=psState, sysImageVersion=sysImageVersion, snmpTrapSrvObj=snmpTrapSrvObj, pciSlotEntry=pciSlotEntry, pciConfigObj=pciConfigObj, psModulePorts=psModulePorts, psManufacturer=psManufacturer, snmpTrapSrvTable=snmpTrapSrvTable, psDeviceIndex=psDeviceIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, PYSNMP_MODULE_ID=advantechCommonMIB, pciSlotTable=pciSlotTable, snmpTrapSrvIP=snmpTrapSrvIP, psFunctionIndex=psFunctionIndex, sysDescr=sysDescr, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, advantech=advantech, sysBootCount=sysBootCount, psSubsysDeviceID=psSubsysDeviceID, psClassCode=psClassCode, psLocation=psLocation, sysBootTime=sysBootTime, psLength=psLength, sysDeviceName=sysDeviceName, psDisplayName=psDisplayName, psIRQ=psIRQ, psBaseAddress=psBaseAddress, psVendorID=psVendorID, atPciConfig=atPciConfig, psDescr=psDescr, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvEntry=snmpTrapSrvEntry, psIndex=psIndex, psSubsysVendorID=psSubsysVendorID, psNumber=psNumber, psBusIndex=psBusIndex, sysModuleID=sysModuleID, atSystem=atSystem, sysReleaseDate=sysReleaseDate, sysFirstBootTime=sysFirstBootTime, psModuleType=psModuleType, atMgmt=atMgmt)
