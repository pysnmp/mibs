...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psModulePorts=psModulePorts, snmpTrapSrvEntry=snmpTrapSrvEntry, psManufacturer=psManufacturer, psFunctionIndex=psFunctionIndex, psDeviceID=psDeviceID, sysReleaseDate=sysReleaseDate, sysBootCount=sysBootCount, sysFirstBootTime=sysFirstBootTime, sysModuleID=sysModuleID, psSubsysVendorID=psSubsysVendorID, atMgmt=atMgmt, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapVersion=snmpTrapVersion, psModuleType=psModuleType, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, pciSlotTable=pciSlotTable, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvPort=snmpTrapSrvPort, pciSlotEntry=pciSlotEntry, psDescr=psDescr, advantech=advantech, sysDescr=sysDescr, psDeviceIndex=psDeviceIndex, psIndex=psIndex, psNumber=psNumber, psState=psState, psVendorID=psVendorID, psLocation=psLocation, snmpTrapSrvIndex=snmpTrapSrvIndex, sysBootTime=sysBootTime, psIRQ=psIRQ, psDisplayName=psDisplayName, snmpTrapSrvTable=snmpTrapSrvTable, advantechCommonMIB=advantechCommonMIB, sysImageVersion=sysImageVersion, atPciConfig=atPciConfig, pciConfigObj=pciConfigObj, psClassCode=psClassCode, snmpTrapSrvObj=snmpTrapSrvObj, psBaseAddress=psBaseAddress, snmpTrapSrvNumber=snmpTrapSrvNumber, psLength=psLength, atSystem=atSystem, psBusIndex=psBusIndex, sysDeviceName=sysDeviceName)
