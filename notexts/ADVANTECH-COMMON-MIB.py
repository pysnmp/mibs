...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvIP=snmpTrapSrvIP, psBaseAddress=psBaseAddress, psIndex=psIndex, sysDeviceName=sysDeviceName, PYSNMP_MODULE_ID=advantechCommonMIB, pciSlotEntry=pciSlotEntry, sysReleaseDate=sysReleaseDate, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psModulePorts=psModulePorts, pciSlotTable=pciSlotTable, psDeviceID=psDeviceID, atSystem=atSystem, psVendorID=psVendorID, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvPort=snmpTrapSrvPort, psManufacturer=psManufacturer, psClassCode=psClassCode, psDescr=psDescr, snmpTrapVersion=snmpTrapVersion, sysBootCount=sysBootCount, psModuleType=psModuleType, psIRQ=psIRQ, atMgmt=atMgmt, advantechCommonMIB=advantechCommonMIB, psFunctionIndex=psFunctionIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, pciConfigObj=pciConfigObj, psDisplayName=psDisplayName, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvObj=snmpTrapSrvObj, psState=psState, sysFirstBootTime=sysFirstBootTime, psSubsysVendorID=psSubsysVendorID, sysImageVersion=sysImageVersion, sysModuleID=sysModuleID, psBusIndex=psBusIndex, psDeviceIndex=psDeviceIndex, psLength=psLength, psNumber=psNumber, advantech=advantech, atPciConfig=atPciConfig, sysBootTime=sysBootTime, sysDescr=sysDescr, psLocation=psLocation)
