...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", advantechCommonMIB=advantechCommonMIB, advantech=advantech, snmpTrapSrvPort=snmpTrapSrvPort, sysFirstBootTime=sysFirstBootTime, atPciConfig=atPciConfig, psFunctionIndex=psFunctionIndex, psBaseAddress=psBaseAddress, psDescr=psDescr, psLocation=psLocation, snmpTrapSrvIP=snmpTrapSrvIP, psDeviceIndex=psDeviceIndex, pciSlotEntry=pciSlotEntry, sysBootCount=sysBootCount, psNumber=psNumber, atSystem=atSystem, pciConfigObj=pciConfigObj, pciSlotTable=pciSlotTable, sysImageVersion=sysImageVersion, psState=psState, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysDeviceName=sysDeviceName, psClassCode=psClassCode, snmpTrapSrvObj=snmpTrapSrvObj, sysReleaseDate=sysReleaseDate, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapVersion=snmpTrapVersion, sysDescr=sysDescr, psModulePorts=psModulePorts, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, psDeviceID=psDeviceID, psManufacturer=psManufacturer, sysBootTime=sysBootTime, psIRQ=psIRQ, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psDisplayName=psDisplayName, psSubsysVendorID=psSubsysVendorID, psVendorID=psVendorID, psSubsysDeviceID=psSubsysDeviceID, atMgmt=atMgmt, sysModuleID=sysModuleID, snmpTrapSrvTable=snmpTrapSrvTable, psIndex=psIndex, psModuleType=psModuleType, psBusIndex=psBusIndex, snmpTrapSrvNumber=snmpTrapSrvNumber, psLength=psLength)
