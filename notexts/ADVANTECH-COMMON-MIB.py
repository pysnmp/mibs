...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysBootTime=sysBootTime, sysModuleID=sysModuleID, pciSlotTable=pciSlotTable, psVendorID=psVendorID, atPciConfig=atPciConfig, psLength=psLength, psState=psState, psLocation=psLocation, psBaseAddress=psBaseAddress, psIRQ=psIRQ, advantech=advantech, sysDeviceName=sysDeviceName, pciSlotEntry=pciSlotEntry, snmpTrapSrvNumber=snmpTrapSrvNumber, sysDescr=sysDescr, psDeviceIndex=psDeviceIndex, atMgmt=atMgmt, psSubsysDeviceID=psSubsysDeviceID, sysBootCount=sysBootCount, pciConfigObj=pciConfigObj, psManufacturer=psManufacturer, psSubsysVendorID=psSubsysVendorID, psBusIndex=psBusIndex, psClassCode=psClassCode, sysImageVersion=sysImageVersion, psDeviceID=psDeviceID, psDisplayName=psDisplayName, snmpTrapSrvEntry=snmpTrapSrvEntry, psIndex=psIndex, sysReleaseDate=sysReleaseDate, advantechCommonMIB=advantechCommonMIB, snmpTrapVersion=snmpTrapVersion, psDescr=psDescr, psModuleType=psModuleType, psFunctionIndex=psFunctionIndex, atSystem=atSystem, snmpTrapSrvTable=snmpTrapSrvTable, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvObj=snmpTrapSrvObj, psNumber=psNumber, psModulePorts=psModulePorts, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, PYSNMP_MODULE_ID=advantechCommonMIB)
