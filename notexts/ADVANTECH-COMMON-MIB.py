...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", advantech=advantech, snmpTrapSrvObj=snmpTrapSrvObj, sysFirstBootTime=sysFirstBootTime, psDeviceIndex=psDeviceIndex, pciSlotEntry=pciSlotEntry, snmpTrapSrvPort=snmpTrapSrvPort, advantechCommonMIB=advantechCommonMIB, psFunctionIndex=psFunctionIndex, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvNumber=snmpTrapSrvNumber, psManufacturer=psManufacturer, atMgmt=atMgmt, psLocation=psLocation, pciSlotTable=pciSlotTable, psModulePorts=psModulePorts, sysModuleID=sysModuleID, snmpTrapVersion=snmpTrapVersion, psDisplayName=psDisplayName, snmpTrapSrvIP=snmpTrapSrvIP, psBaseAddress=psBaseAddress, sysImageVersion=sysImageVersion, snmpTrapSrvIndex=snmpTrapSrvIndex, psSubsysDeviceID=psSubsysDeviceID, psIndex=psIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, sysBootTime=sysBootTime, sysBootCount=sysBootCount, sysDescr=sysDescr, psState=psState, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psLength=psLength, psVendorID=psVendorID, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psDescr=psDescr, psIRQ=psIRQ, sysReleaseDate=sysReleaseDate, snmpTrapSrvTable=snmpTrapSrvTable, psModuleType=psModuleType, sysDeviceName=sysDeviceName, psNumber=psNumber, psClassCode=psClassCode, psDeviceID=psDeviceID, psBusIndex=psBusIndex, atSystem=atSystem, atPciConfig=atPciConfig, pciConfigObj=pciConfigObj, PYSNMP_MODULE_ID=advantechCommonMIB)
