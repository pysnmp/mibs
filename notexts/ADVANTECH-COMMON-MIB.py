...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvCommunity=snmpTrapSrvCommunity, psFunctionIndex=psFunctionIndex, sysModuleID=sysModuleID, snmpTrapSrvIndex=snmpTrapSrvIndex, psModuleType=psModuleType, pciConfigObj=pciConfigObj, psModulePorts=psModulePorts, psVendorID=psVendorID, sysDeviceName=sysDeviceName, atMgmt=atMgmt, snmpTrapSrvPort=snmpTrapSrvPort, psNumber=psNumber, sysImageVersion=sysImageVersion, psDescr=psDescr, psSubsysDeviceID=psSubsysDeviceID, psIndex=psIndex, psLocation=psLocation, sysDescr=sysDescr, psSubsysVendorID=psSubsysVendorID, sysFirstBootTime=sysFirstBootTime, psClassCode=psClassCode, psLength=psLength, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapVersion=snmpTrapVersion, sysReleaseDate=sysReleaseDate, psDisplayName=psDisplayName, psDeviceID=psDeviceID, psState=psState, sysBootTime=sysBootTime, snmpTrapSrvNumber=snmpTrapSrvNumber, psManufacturer=psManufacturer, pciSlotTable=pciSlotTable, snmpTrapSrvTable=snmpTrapSrvTable, psIRQ=psIRQ, snmpTrapSrvEntry=snmpTrapSrvEntry, psBusIndex=psBusIndex, psBaseAddress=psBaseAddress, sysBootCount=sysBootCount, atSystem=atSystem, atPciConfig=atPciConfig, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psDeviceIndex=psDeviceIndex, pciSlotEntry=pciSlotEntry, advantechCommonMIB=advantechCommonMIB, advantech=advantech, snmpTrapSrvObj=snmpTrapSrvObj)
