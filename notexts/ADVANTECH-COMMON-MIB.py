...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysBootCount=sysBootCount, psDisplayName=psDisplayName, PYSNMP_MODULE_ID=advantechCommonMIB, psDescr=psDescr, sysBootTime=sysBootTime, snmpTrapSrvEntry=snmpTrapSrvEntry, sysFirstBootTime=sysFirstBootTime, psSubsysDeviceID=psSubsysDeviceID, psNumber=psNumber, psFunctionIndex=psFunctionIndex, sysDeviceName=sysDeviceName, snmpTrapSrvNumber=snmpTrapSrvNumber, pciSlotEntry=pciSlotEntry, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psBusIndex=psBusIndex, psBaseAddress=psBaseAddress, snmpTrapSrvIndex=snmpTrapSrvIndex, psIRQ=psIRQ, psState=psState, snmpTrapSrvTable=snmpTrapSrvTable, atPciConfig=atPciConfig, psLocation=psLocation, pciSlotTable=pciSlotTable, sysReleaseDate=sysReleaseDate, atMgmt=atMgmt, psVendorID=psVendorID, psDeviceIndex=psDeviceIndex, psDeviceID=psDeviceID, sysImageVersion=sysImageVersion, psIndex=psIndex, snmpTrapSrvObj=snmpTrapSrvObj, psSubsysVendorID=psSubsysVendorID, sysDescr=sysDescr, psModulePorts=psModulePorts, pciConfigObj=pciConfigObj, psClassCode=psClassCode, advantechCommonMIB=advantechCommonMIB, psLength=psLength, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psManufacturer=psManufacturer, psModuleType=psModuleType, atSystem=atSystem, sysModuleID=sysModuleID, advantech=advantech, snmpTrapVersion=snmpTrapVersion)
