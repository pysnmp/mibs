...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psLength=psLength, sysFirstBootTime=sysFirstBootTime, pciConfigObj=pciConfigObj, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psNumber=psNumber, sysImageVersion=sysImageVersion, psDisplayName=psDisplayName, snmpTrapSrvTable=snmpTrapSrvTable, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvIndex=snmpTrapSrvIndex, psBaseAddress=psBaseAddress, pciSlotTable=pciSlotTable, psVendorID=psVendorID, atSystem=atSystem, PYSNMP_MODULE_ID=advantechCommonMIB, psBusIndex=psBusIndex, psDescr=psDescr, sysModuleID=sysModuleID, sysDescr=sysDescr, psIndex=psIndex, psModulePorts=psModulePorts, atPciConfig=atPciConfig, snmpTrapSrvPort=snmpTrapSrvPort, psState=psState, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysReleaseDate=sysReleaseDate, atMgmt=atMgmt, sysBootCount=sysBootCount, advantech=advantech, psLocation=psLocation, advantechCommonMIB=advantechCommonMIB, sysBootTime=sysBootTime, psFunctionIndex=psFunctionIndex, psDeviceID=psDeviceID, psClassCode=psClassCode, sysDeviceName=sysDeviceName, psModuleType=psModuleType, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvEntry=snmpTrapSrvEntry, pciSlotEntry=pciSlotEntry, snmpTrapVersion=snmpTrapVersion, psManufacturer=psManufacturer, psIRQ=psIRQ, snmpTrapSrvIP=snmpTrapSrvIP, psDeviceIndex=psDeviceIndex, snmpTrapSrvNumber=snmpTrapSrvNumber)
