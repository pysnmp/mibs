...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvObj=snmpTrapSrvObj, psDescr=psDescr, pciConfigObj=pciConfigObj, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvTable=snmpTrapSrvTable, psNumber=psNumber, psLength=psLength, sysBootCount=sysBootCount, psLocation=psLocation, psState=psState, advantechCommonMIB=advantechCommonMIB, advantech=advantech, snmpTrapSrvIndex=snmpTrapSrvIndex, psIndex=psIndex, psBaseAddress=psBaseAddress, psModuleType=psModuleType, sysBootTime=sysBootTime, pciSlotTable=pciSlotTable, atMgmt=atMgmt, sysDescr=sysDescr, atSystem=atSystem, snmpTrapVersion=snmpTrapVersion, psSubsysVendorID=psSubsysVendorID, psFunctionIndex=psFunctionIndex, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvPort=snmpTrapSrvPort, psClassCode=psClassCode, pciSlotEntry=pciSlotEntry, psIRQ=psIRQ, PYSNMP_MODULE_ID=advantechCommonMIB, psModulePorts=psModulePorts, psDeviceID=psDeviceID, psManufacturer=psManufacturer, psVendorID=psVendorID, psBusIndex=psBusIndex, sysReleaseDate=sysReleaseDate, psDisplayName=psDisplayName, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvEntry=snmpTrapSrvEntry, psDeviceIndex=psDeviceIndex, sysImageVersion=sysImageVersion, atPciConfig=atPciConfig, sysModuleID=sysModuleID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysDeviceName=sysDeviceName, psSubsysDeviceID=psSubsysDeviceID)
