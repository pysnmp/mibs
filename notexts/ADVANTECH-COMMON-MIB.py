...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", pciSlotEntry=pciSlotEntry, sysBootCount=sysBootCount, snmpTrapSrvNumber=snmpTrapSrvNumber, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvTable=snmpTrapSrvTable, psVendorID=psVendorID, PYSNMP_MODULE_ID=advantechCommonMIB, psClassCode=psClassCode, sysBootTime=sysBootTime, psLength=psLength, advantechCommonMIB=advantechCommonMIB, pciSlotTable=pciSlotTable, psBusIndex=psBusIndex, sysReleaseDate=sysReleaseDate, psBaseAddress=psBaseAddress, sysDescr=sysDescr, psNumber=psNumber, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvIndex=snmpTrapSrvIndex, psState=psState, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysImageVersion=sysImageVersion, psIndex=psIndex, sysDeviceName=sysDeviceName, advantech=advantech, snmpTrapSrvIP=snmpTrapSrvIP, psModuleType=psModuleType, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, atSystem=atSystem, snmpTrapSrvObj=snmpTrapSrvObj, psManufacturer=psManufacturer, psLocation=psLocation, snmpTrapVersion=snmpTrapVersion, pciConfigObj=pciConfigObj, snmpTrapSrvPort=snmpTrapSrvPort, sysFirstBootTime=sysFirstBootTime, psFunctionIndex=psFunctionIndex, atMgmt=atMgmt, psSubsysVendorID=psSubsysVendorID, psIRQ=psIRQ, sysModuleID=sysModuleID, psDeviceID=psDeviceID, psModulePorts=psModulePorts, psDisplayName=psDisplayName, psDescr=psDescr, psDeviceIndex=psDeviceIndex, atPciConfig=atPciConfig)
