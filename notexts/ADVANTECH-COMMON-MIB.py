...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysImageVersion=sysImageVersion, snmpTrapSrvNumber=snmpTrapSrvNumber, psModuleType=psModuleType, psBusIndex=psBusIndex, atMgmt=atMgmt, snmpTrapSrvPort=snmpTrapSrvPort, sysDeviceName=sysDeviceName, psDeviceID=psDeviceID, snmpTrapSrvIndex=snmpTrapSrvIndex, psLocation=psLocation, snmpTrapSrvEntry=snmpTrapSrvEntry, pciConfigObj=pciConfigObj, sysModuleID=sysModuleID, psFunctionIndex=psFunctionIndex, psIRQ=psIRQ, pciSlotEntry=pciSlotEntry, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvObj=snmpTrapSrvObj, PYSNMP_MODULE_ID=advantechCommonMIB, psSubsysVendorID=psSubsysVendorID, psLength=psLength, advantech=advantech, psDisplayName=psDisplayName, sysReleaseDate=sysReleaseDate, psManufacturer=psManufacturer, snmpTrapSrvTable=snmpTrapSrvTable, psVendorID=psVendorID, psState=psState, snmpTrapSrvIP=snmpTrapSrvIP, psDeviceIndex=psDeviceIndex, psClassCode=psClassCode, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psBaseAddress=psBaseAddress, snmpTrapVersion=snmpTrapVersion, psModulePorts=psModulePorts, psSubsysDeviceID=psSubsysDeviceID, atPciConfig=atPciConfig, sysBootCount=sysBootCount, pciSlotTable=pciSlotTable, psDescr=psDescr, sysBootTime=sysBootTime, psNumber=psNumber, psIndex=psIndex, atSystem=atSystem, sysFirstBootTime=sysFirstBootTime, sysDescr=sysDescr, advantechCommonMIB=advantechCommonMIB)
