...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvNumber=snmpTrapSrvNumber, psLength=psLength, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysDescr=sysDescr, atPciConfig=atPciConfig, sysDeviceName=sysDeviceName, psDisplayName=psDisplayName, psManufacturer=psManufacturer, atMgmt=atMgmt, psNumber=psNumber, psModuleType=psModuleType, psIRQ=psIRQ, psIndex=psIndex, snmpTrapSrvIndex=snmpTrapSrvIndex, sysBootCount=sysBootCount, psVendorID=psVendorID, atSystem=atSystem, pciSlotEntry=pciSlotEntry, psModulePorts=psModulePorts, psBaseAddress=psBaseAddress, advantech=advantech, psFunctionIndex=psFunctionIndex, psLocation=psLocation, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvIP=snmpTrapSrvIP, psBusIndex=psBusIndex, psClassCode=psClassCode, psDeviceIndex=psDeviceIndex, psState=psState, pciConfigObj=pciConfigObj, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvPort=snmpTrapSrvPort, advantechCommonMIB=advantechCommonMIB, sysReleaseDate=sysReleaseDate, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvTable=snmpTrapSrvTable, pciSlotTable=pciSlotTable, snmpTrapVersion=snmpTrapVersion, sysImageVersion=sysImageVersion, psDescr=psDescr, psSubsysDeviceID=psSubsysDeviceID, sysModuleID=sysModuleID, sysBootTime=sysBootTime, psDeviceID=psDeviceID, snmpTrapSrvEntry=snmpTrapSrvEntry)
