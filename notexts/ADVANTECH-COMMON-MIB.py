...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvObj=snmpTrapSrvObj, pciSlotEntry=pciSlotEntry, psNumber=psNumber, psDescr=psDescr, psDeviceID=psDeviceID, psBusIndex=psBusIndex, psBaseAddress=psBaseAddress, pciSlotTable=pciSlotTable, pciConfigObj=pciConfigObj, sysDeviceName=sysDeviceName, atMgmt=atMgmt, psDisplayName=psDisplayName, psIndex=psIndex, advantechCommonMIB=advantechCommonMIB, PYSNMP_MODULE_ID=advantechCommonMIB, atPciConfig=atPciConfig, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvPort=snmpTrapSrvPort, psLocation=psLocation, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapVersion=snmpTrapVersion, psVendorID=psVendorID, psClassCode=psClassCode, psIRQ=psIRQ, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysBootTime=sysBootTime, sysModuleID=sysModuleID, sysImageVersion=sysImageVersion, sysReleaseDate=sysReleaseDate, psDeviceIndex=psDeviceIndex, psSubsysVendorID=psSubsysVendorID, psSubsysDeviceID=psSubsysDeviceID, psModulePorts=psModulePorts, sysBootCount=sysBootCount, psModuleType=psModuleType, snmpTrapSrvNumber=snmpTrapSrvNumber, sysDescr=sysDescr, atSystem=atSystem, psLength=psLength, psState=psState, snmpTrapSrvIndex=snmpTrapSrvIndex, sysFirstBootTime=sysFirstBootTime, psFunctionIndex=psFunctionIndex, snmpTrapSrvIP=snmpTrapSrvIP, psManufacturer=psManufacturer, advantech=advantech)
