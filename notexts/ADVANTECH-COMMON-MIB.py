...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvNumber=snmpTrapSrvNumber, psVendorID=psVendorID, pciConfigObj=pciConfigObj, PYSNMP_MODULE_ID=advantechCommonMIB, pciSlotTable=pciSlotTable, pciSlotEntry=pciSlotEntry, snmpTrapSrvTable=snmpTrapSrvTable, sysBootTime=sysBootTime, psState=psState, psManufacturer=psManufacturer, atPciConfig=atPciConfig, psNumber=psNumber, psDisplayName=psDisplayName, psLength=psLength, psDescr=psDescr, psModuleType=psModuleType, sysModuleID=sysModuleID, sysBootCount=sysBootCount, psSubsysVendorID=psSubsysVendorID, sysReleaseDate=sysReleaseDate, snmpTrapSrvIndex=snmpTrapSrvIndex, psModulePorts=psModulePorts, psBusIndex=psBusIndex, sysDeviceName=sysDeviceName, advantech=advantech, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapVersion=snmpTrapVersion, psIRQ=psIRQ, psIndex=psIndex, atSystem=atSystem, snmpTrapSrvIP=snmpTrapSrvIP, sysImageVersion=sysImageVersion, advantechCommonMIB=advantechCommonMIB, sysDescr=sysDescr, snmpTrapSrvEntry=snmpTrapSrvEntry, psSubsysDeviceID=psSubsysDeviceID, psClassCode=psClassCode, psBaseAddress=psBaseAddress, psDeviceIndex=psDeviceIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvPort=snmpTrapSrvPort, psLocation=psLocation, psFunctionIndex=psFunctionIndex, psDeviceID=psDeviceID, atMgmt=atMgmt, sysFirstBootTime=sysFirstBootTime)
