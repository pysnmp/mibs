...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", atPciConfig=atPciConfig, sysBootCount=sysBootCount, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvPort=snmpTrapSrvPort, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvIP=snmpTrapSrvIP, psManufacturer=psManufacturer, psLocation=psLocation, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psSubsysDeviceID=psSubsysDeviceID, psIndex=psIndex, psBaseAddress=psBaseAddress, psState=psState, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvIndex=snmpTrapSrvIndex, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvEntry=snmpTrapSrvEntry, psClassCode=psClassCode, psLength=psLength, snmpTrapVersion=snmpTrapVersion, psDescr=psDescr, advantech=advantech, sysBootTime=sysBootTime, psNumber=psNumber, psFunctionIndex=psFunctionIndex, sysModuleID=sysModuleID, psModuleType=psModuleType, atSystem=atSystem, sysDescr=sysDescr, psDeviceIndex=psDeviceIndex, psIRQ=psIRQ, psDeviceID=psDeviceID, pciSlotTable=pciSlotTable, atMgmt=atMgmt, psBusIndex=psBusIndex, pciConfigObj=pciConfigObj, psModulePorts=psModulePorts, sysReleaseDate=sysReleaseDate, snmpTrapSrvNumber=snmpTrapSrvNumber, psSubsysVendorID=psSubsysVendorID, sysImageVersion=sysImageVersion, pciSlotEntry=pciSlotEntry, psDisplayName=psDisplayName, psVendorID=psVendorID, sysDeviceName=sysDeviceName, PYSNMP_MODULE_ID=advantechCommonMIB)
