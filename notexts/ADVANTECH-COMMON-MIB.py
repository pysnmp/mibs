...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysBootTime=sysBootTime, psModulePorts=psModulePorts, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvPort=snmpTrapSrvPort, psLocation=psLocation, psFunctionIndex=psFunctionIndex, sysModuleID=sysModuleID, sysDescr=sysDescr, snmpTrapVersion=snmpTrapVersion, pciConfigObj=pciConfigObj, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvEntry=snmpTrapSrvEntry, psManufacturer=psManufacturer, psDeviceID=psDeviceID, atPciConfig=atPciConfig, advantech=advantech, snmpTrapSrvIP=snmpTrapSrvIP, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysReleaseDate=sysReleaseDate, sysImageVersion=sysImageVersion, psSubsysVendorID=psSubsysVendorID, atMgmt=atMgmt, sysBootCount=sysBootCount, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psDeviceIndex=psDeviceIndex, psClassCode=psClassCode, pciSlotEntry=pciSlotEntry, psBusIndex=psBusIndex, snmpTrapSrvTable=snmpTrapSrvTable, psBaseAddress=psBaseAddress, snmpTrapSrvObj=snmpTrapSrvObj, psDisplayName=psDisplayName, psLength=psLength, psNumber=psNumber, psDescr=psDescr, sysDeviceName=sysDeviceName, psIndex=psIndex, psModuleType=psModuleType, pciSlotTable=pciSlotTable, psState=psState, advantechCommonMIB=advantechCommonMIB, PYSNMP_MODULE_ID=advantechCommonMIB, psIRQ=psIRQ, psVendorID=psVendorID, snmpTrapSrvIndex=snmpTrapSrvIndex, atSystem=atSystem)
