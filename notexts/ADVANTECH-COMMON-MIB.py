...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psDescr=psDescr, atSystem=atSystem, pciSlotTable=pciSlotTable, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvTable=snmpTrapSrvTable, psBusIndex=psBusIndex, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvPort=snmpTrapSrvPort, psClassCode=psClassCode, advantech=advantech, snmpTrapVersion=snmpTrapVersion, psFunctionIndex=psFunctionIndex, sysDeviceName=sysDeviceName, psDisplayName=psDisplayName, psSubsysDeviceID=psSubsysDeviceID, psManufacturer=psManufacturer, atPciConfig=atPciConfig, sysModuleID=sysModuleID, sysDescr=sysDescr, psNumber=psNumber, psLength=psLength, snmpTrapSrvObj=snmpTrapSrvObj, PYSNMP_MODULE_ID=advantechCommonMIB, psDeviceIndex=psDeviceIndex, psBaseAddress=psBaseAddress, advantechCommonMIB=advantechCommonMIB, psState=psState, snmpTrapSrvEntry=snmpTrapSrvEntry, psIRQ=psIRQ, psModulePorts=psModulePorts, pciSlotEntry=pciSlotEntry, psVendorID=psVendorID, psLocation=psLocation, psModuleType=psModuleType, sysImageVersion=sysImageVersion, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvNumber=snmpTrapSrvNumber, atMgmt=atMgmt, psIndex=psIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psDeviceID=psDeviceID, snmpTrapSrvIndex=snmpTrapSrvIndex, sysBootCount=sysBootCount, sysBootTime=sysBootTime, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysReleaseDate=sysReleaseDate, pciConfigObj=pciConfigObj)
