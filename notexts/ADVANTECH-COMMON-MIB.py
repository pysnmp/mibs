...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapVersion=snmpTrapVersion, psSubsysDeviceID=psSubsysDeviceID, advantech=advantech, sysDescr=sysDescr, psManufacturer=psManufacturer, psFunctionIndex=psFunctionIndex, psBaseAddress=psBaseAddress, pciSlotEntry=pciSlotEntry, psIndex=psIndex, psDeviceID=psDeviceID, pciConfigObj=pciConfigObj, atSystem=atSystem, psSubsysVendorID=psSubsysVendorID, sysDeviceName=sysDeviceName, psModulePorts=psModulePorts, psClassCode=psClassCode, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvNumber=snmpTrapSrvNumber, psModuleType=psModuleType, PYSNMP_MODULE_ID=advantechCommonMIB, sysImageVersion=sysImageVersion, psNumber=psNumber, psBusIndex=psBusIndex, snmpTrapSrvPort=snmpTrapSrvPort, atMgmt=atMgmt, pciSlotTable=pciSlotTable, sysReleaseDate=sysReleaseDate, sysFirstBootTime=sysFirstBootTime, psLocation=psLocation, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psIRQ=psIRQ, snmpTrapSrvEntry=snmpTrapSrvEntry, psDescr=psDescr, snmpTrapSrvIP=snmpTrapSrvIP, advantechCommonMIB=advantechCommonMIB, psState=psState, snmpTrapSrvTable=snmpTrapSrvTable, psDisplayName=psDisplayName, sysBootCount=sysBootCount, sysModuleID=sysModuleID, atPciConfig=atPciConfig, psDeviceIndex=psDeviceIndex, psVendorID=psVendorID, sysBootTime=sysBootTime, psLength=psLength)
