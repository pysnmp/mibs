...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psBaseAddress=psBaseAddress, pciConfigObj=pciConfigObj, PYSNMP_MODULE_ID=advantechCommonMIB, sysBootTime=sysBootTime, psClassCode=psClassCode, psState=psState, psModuleType=psModuleType, psManufacturer=psManufacturer, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvTable=snmpTrapSrvTable, psModulePorts=psModulePorts, psSubsysDeviceID=psSubsysDeviceID, sysModuleID=sysModuleID, advantech=advantech, snmpTrapSrvIndex=snmpTrapSrvIndex, psFunctionIndex=psFunctionIndex, sysReleaseDate=sysReleaseDate, psDescr=psDescr, snmpTrapSrvObj=snmpTrapSrvObj, atMgmt=atMgmt, psBusIndex=psBusIndex, psIRQ=psIRQ, pciSlotEntry=pciSlotEntry, snmpTrapSrvCommunity=snmpTrapSrvCommunity, atPciConfig=atPciConfig, advantechCommonMIB=advantechCommonMIB, psDeviceID=psDeviceID, psLength=psLength, sysDeviceName=sysDeviceName, snmpTrapSrvPort=snmpTrapSrvPort, sysBootCount=sysBootCount, psDeviceIndex=psDeviceIndex, sysDescr=sysDescr, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapVersion=snmpTrapVersion, psNumber=psNumber, psLocation=psLocation, pciSlotTable=pciSlotTable, psDisplayName=psDisplayName, psVendorID=psVendorID, psIndex=psIndex, atSystem=atSystem, psSubsysVendorID=psSubsysVendorID, sysImageVersion=sysImageVersion, snmpTrapSrvNumber=snmpTrapSrvNumber, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvEntry=snmpTrapSrvEntry)
