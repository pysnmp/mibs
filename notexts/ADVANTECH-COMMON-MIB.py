...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psIndex=psIndex, sysFirstBootTime=sysFirstBootTime, psDescr=psDescr, psManufacturer=psManufacturer, psModulePorts=psModulePorts, psSubsysVendorID=psSubsysVendorID, atMgmt=atMgmt, sysDescr=sysDescr, pciSlotEntry=pciSlotEntry, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvEntry=snmpTrapSrvEntry, atPciConfig=atPciConfig, psDisplayName=psDisplayName, psDeviceID=psDeviceID, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvIP=snmpTrapSrvIP, psLocation=psLocation, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psBusIndex=psBusIndex, sysDeviceName=sysDeviceName, sysBootCount=sysBootCount, psDeviceIndex=psDeviceIndex, sysModuleID=sysModuleID, psVendorID=psVendorID, advantechCommonMIB=advantechCommonMIB, sysBootTime=sysBootTime, psLength=psLength, psState=psState, atSystem=atSystem, snmpTrapVersion=snmpTrapVersion, psNumber=psNumber, sysReleaseDate=sysReleaseDate, psIRQ=psIRQ, sysImageVersion=sysImageVersion, pciConfigObj=pciConfigObj, psBaseAddress=psBaseAddress, psSubsysDeviceID=psSubsysDeviceID, psModuleType=psModuleType, pciSlotTable=pciSlotTable, psClassCode=psClassCode, advantech=advantech, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvNumber=snmpTrapSrvNumber, psFunctionIndex=psFunctionIndex)
