...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psLocation=psLocation, psVendorID=psVendorID, psState=psState, snmpTrapSrvNumber=snmpTrapSrvNumber, psLength=psLength, psFunctionIndex=psFunctionIndex, advantech=advantech, atPciConfig=atPciConfig, atSystem=atSystem, snmpTrapSrvPort=snmpTrapSrvPort, psDisplayName=psDisplayName, snmpTrapSrvIndex=snmpTrapSrvIndex, sysBootCount=sysBootCount, snmpTrapVersion=snmpTrapVersion, psIndex=psIndex, psIRQ=psIRQ, psNumber=psNumber, sysDeviceName=sysDeviceName, pciConfigObj=pciConfigObj, sysModuleID=sysModuleID, PYSNMP_MODULE_ID=advantechCommonMIB, sysReleaseDate=sysReleaseDate, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvObj=snmpTrapSrvObj, psClassCode=psClassCode, sysFirstBootTime=sysFirstBootTime, pciSlotTable=pciSlotTable, psManufacturer=psManufacturer, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psModuleType=psModuleType, psSubsysVendorID=psSubsysVendorID, sysImageVersion=sysImageVersion, psDeviceIndex=psDeviceIndex, psModulePorts=psModulePorts, psDeviceID=psDeviceID, psBaseAddress=psBaseAddress, psBusIndex=psBusIndex, atMgmt=atMgmt, pciSlotEntry=pciSlotEntry, snmpTrapSrvIP=snmpTrapSrvIP, psDescr=psDescr, psSubsysDeviceID=psSubsysDeviceID, sysBootTime=sysBootTime, snmpTrapSrvEntry=snmpTrapSrvEntry, sysDescr=sysDescr, snmpTrapSrvTable=snmpTrapSrvTable)
