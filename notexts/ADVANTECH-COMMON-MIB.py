...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvObj=snmpTrapSrvObj, psSubsysDeviceID=psSubsysDeviceID, psLocation=psLocation, psIRQ=psIRQ, psFunctionIndex=psFunctionIndex, sysBootCount=sysBootCount, psModuleType=psModuleType, psSubsysVendorID=psSubsysVendorID, psIndex=psIndex, sysModuleID=sysModuleID, psManufacturer=psManufacturer, advantechCommonMIB=advantechCommonMIB, psDisplayName=psDisplayName, advantech=advantech, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvPort=snmpTrapSrvPort, psClassCode=psClassCode, snmpTrapSrvIP=snmpTrapSrvIP, psDeviceID=psDeviceID, psDescr=psDescr, psBaseAddress=psBaseAddress, atPciConfig=atPciConfig, PYSNMP_MODULE_ID=advantechCommonMIB, pciSlotTable=pciSlotTable, psLength=psLength, psVendorID=psVendorID, snmpTrapSrvNumber=snmpTrapSrvNumber, psState=psState, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysReleaseDate=sysReleaseDate, sysDeviceName=sysDeviceName, snmpTrapSrvIndex=snmpTrapSrvIndex, sysDescr=sysDescr, pciConfigObj=pciConfigObj, psDeviceIndex=psDeviceIndex, psModulePorts=psModulePorts, atSystem=atSystem, atMgmt=atMgmt, sysImageVersion=sysImageVersion, psNumber=psNumber, sysFirstBootTime=sysFirstBootTime, pciSlotEntry=pciSlotEntry, psBusIndex=psBusIndex, sysBootTime=sysBootTime)
