...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psIRQ=psIRQ, atSystem=atSystem, sysReleaseDate=sysReleaseDate, sysModuleID=sysModuleID, pciConfigObj=pciConfigObj, sysBootTime=sysBootTime, sysDescr=sysDescr, psIndex=psIndex, psDeviceIndex=psDeviceIndex, psFunctionIndex=psFunctionIndex, advantech=advantech, snmpTrapSrvIndex=snmpTrapSrvIndex, psBusIndex=psBusIndex, psDescr=psDescr, pciSlotEntry=pciSlotEntry, psVendorID=psVendorID, psSubsysVendorID=psSubsysVendorID, psLocation=psLocation, pciSlotTable=pciSlotTable, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psBaseAddress=psBaseAddress, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapVersion=snmpTrapVersion, psLength=psLength, psState=psState, psModuleType=psModuleType, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psManufacturer=psManufacturer, sysImageVersion=sysImageVersion, sysFirstBootTime=sysFirstBootTime, psDeviceID=psDeviceID, psClassCode=psClassCode, sysDeviceName=sysDeviceName, snmpTrapSrvPort=snmpTrapSrvPort, sysBootCount=sysBootCount, psDisplayName=psDisplayName, atPciConfig=atPciConfig, snmpTrapSrvNumber=snmpTrapSrvNumber, psNumber=psNumber, PYSNMP_MODULE_ID=advantechCommonMIB, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvObj=snmpTrapSrvObj, psModulePorts=psModulePorts, snmpTrapSrvIP=snmpTrapSrvIP, atMgmt=atMgmt)
