...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysFirstBootTime=sysFirstBootTime, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psBaseAddress=psBaseAddress, psSubsysDeviceID=psSubsysDeviceID, sysModuleID=sysModuleID, psModuleType=psModuleType, psFunctionIndex=psFunctionIndex, psDescr=psDescr, psClassCode=psClassCode, snmpTrapSrvIndex=snmpTrapSrvIndex, sysDescr=sysDescr, PYSNMP_MODULE_ID=advantechCommonMIB, atPciConfig=atPciConfig, snmpTrapSrvNumber=snmpTrapSrvNumber, psBusIndex=psBusIndex, psLength=psLength, psManufacturer=psManufacturer, sysBootTime=sysBootTime, snmpTrapSrvObj=snmpTrapSrvObj, psNumber=psNumber, psIRQ=psIRQ, psModulePorts=psModulePorts, advantech=advantech, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysBootCount=sysBootCount, snmpTrapSrvEntry=snmpTrapSrvEntry, pciConfigObj=pciConfigObj, psDisplayName=psDisplayName, sysImageVersion=sysImageVersion, snmpTrapSrvTable=snmpTrapSrvTable, psDeviceID=psDeviceID, atMgmt=atMgmt, pciSlotTable=pciSlotTable, psState=psState, snmpTrapSrvIP=snmpTrapSrvIP, sysDeviceName=sysDeviceName, atSystem=atSystem, sysReleaseDate=sysReleaseDate, pciSlotEntry=pciSlotEntry, psIndex=psIndex, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapVersion=snmpTrapVersion, psSubsysVendorID=psSubsysVendorID, psDeviceIndex=psDeviceIndex, psVendorID=psVendorID, psLocation=psLocation, advantechCommonMIB=advantechCommonMIB)
