...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysDescr=sysDescr, psSubsysVendorID=psSubsysVendorID, psBusIndex=psBusIndex, psNumber=psNumber, pciSlotTable=pciSlotTable, atMgmt=atMgmt, sysImageVersion=sysImageVersion, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvNumber=snmpTrapSrvNumber, sysDeviceName=sysDeviceName, psIRQ=psIRQ, psLength=psLength, psDeviceID=psDeviceID, psIndex=psIndex, advantech=advantech, snmpTrapSrvIndex=snmpTrapSrvIndex, sysModuleID=sysModuleID, pciSlotEntry=pciSlotEntry, psLocation=psLocation, pciConfigObj=pciConfigObj, snmpTrapSrvPort=snmpTrapSrvPort, psClassCode=psClassCode, psFunctionIndex=psFunctionIndex, psVendorID=psVendorID, psBaseAddress=psBaseAddress, psDeviceIndex=psDeviceIndex, psState=psState, psModuleType=psModuleType, sysBootTime=sysBootTime, sysBootCount=sysBootCount, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysFirstBootTime=sysFirstBootTime, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psManufacturer=psManufacturer, snmpTrapSrvObj=snmpTrapSrvObj, PYSNMP_MODULE_ID=advantechCommonMIB, advantechCommonMIB=advantechCommonMIB, psModulePorts=psModulePorts, atSystem=atSystem, psDescr=psDescr, snmpTrapSrvTable=snmpTrapSrvTable, psDisplayName=psDisplayName, sysReleaseDate=sysReleaseDate, psSubsysDeviceID=psSubsysDeviceID, atPciConfig=atPciConfig)
