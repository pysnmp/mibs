...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", pciConfigObj=pciConfigObj, psDescr=psDescr, psBaseAddress=psBaseAddress, sysImageVersion=sysImageVersion, pciSlotEntry=pciSlotEntry, sysReleaseDate=sysReleaseDate, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psIndex=psIndex, sysFirstBootTime=sysFirstBootTime, psDisplayName=psDisplayName, advantechCommonMIB=advantechCommonMIB, psVendorID=psVendorID, sysBootTime=sysBootTime, psLocation=psLocation, psModuleType=psModuleType, atMgmt=atMgmt, psLength=psLength, advantech=advantech, snmpTrapSrvObj=snmpTrapSrvObj, sysModuleID=sysModuleID, sysDeviceName=sysDeviceName, psNumber=psNumber, psClassCode=psClassCode, psManufacturer=psManufacturer, snmpTrapSrvTable=snmpTrapSrvTable, psModulePorts=psModulePorts, atSystem=atSystem, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvIP=snmpTrapSrvIP, psState=psState, snmpTrapVersion=snmpTrapVersion, sysDescr=sysDescr, PYSNMP_MODULE_ID=advantechCommonMIB, sysBootCount=sysBootCount, snmpTrapSrvEntry=snmpTrapSrvEntry, atPciConfig=atPciConfig, psSubsysDeviceID=psSubsysDeviceID, pciSlotTable=pciSlotTable, snmpTrapSrvNumber=snmpTrapSrvNumber, psIRQ=psIRQ, psFunctionIndex=psFunctionIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psDeviceIndex=psDeviceIndex, snmpTrapSrvPort=snmpTrapSrvPort, psBusIndex=psBusIndex, psDeviceID=psDeviceID)
