...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", pciSlotEntry=pciSlotEntry, snmpTrapSrvPort=snmpTrapSrvPort, psClassCode=psClassCode, psDeviceID=psDeviceID, sysImageVersion=sysImageVersion, sysBootCount=sysBootCount, sysBootTime=sysBootTime, snmpTrapVersion=snmpTrapVersion, atMgmt=atMgmt, advantech=advantech, psFunctionIndex=psFunctionIndex, psBaseAddress=psBaseAddress, snmpTrapSrvIP=snmpTrapSrvIP, psDeviceIndex=psDeviceIndex, psSubsysDeviceID=psSubsysDeviceID, psIndex=psIndex, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvObj=snmpTrapSrvObj, sysFirstBootTime=sysFirstBootTime, psLocation=psLocation, pciSlotTable=pciSlotTable, psLength=psLength, psModuleType=psModuleType, sysModuleID=sysModuleID, snmpTrapSrvIndex=snmpTrapSrvIndex, psState=psState, atPciConfig=atPciConfig, snmpTrapSrvTable=snmpTrapSrvTable, psDescr=psDescr, psModulePorts=psModulePorts, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psIRQ=psIRQ, psNumber=psNumber, psManufacturer=psManufacturer, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psVendorID=psVendorID, snmpTrapSrvEntry=snmpTrapSrvEntry, atSystem=atSystem, sysDeviceName=sysDeviceName, pciConfigObj=pciConfigObj, advantechCommonMIB=advantechCommonMIB, sysReleaseDate=sysReleaseDate, psBusIndex=psBusIndex, psSubsysVendorID=psSubsysVendorID, PYSNMP_MODULE_ID=advantechCommonMIB, sysDescr=sysDescr, psDisplayName=psDisplayName)
