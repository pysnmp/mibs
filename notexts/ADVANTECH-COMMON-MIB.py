...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psIndex=psIndex, psNumber=psNumber, psVendorID=psVendorID, sysFirstBootTime=sysFirstBootTime, atMgmt=atMgmt, snmpTrapVersion=snmpTrapVersion, sysImageVersion=sysImageVersion, psSubsysDeviceID=psSubsysDeviceID, psModulePorts=psModulePorts, snmpTrapSrvPort=snmpTrapSrvPort, sysDescr=sysDescr, psLength=psLength, sysBootCount=sysBootCount, sysReleaseDate=sysReleaseDate, psIRQ=psIRQ, psDeviceIndex=psDeviceIndex, snmpTrapSrvObj=snmpTrapSrvObj, psBaseAddress=psBaseAddress, psManufacturer=psManufacturer, snmpTrapSrvIndex=snmpTrapSrvIndex, psBusIndex=psBusIndex, snmpTrapSrvTable=snmpTrapSrvTable, psDisplayName=psDisplayName, psModuleType=psModuleType, PYSNMP_MODULE_ID=advantechCommonMIB, psState=psState, psClassCode=psClassCode, advantech=advantech, snmpTrapSrvIP=snmpTrapSrvIP, sysModuleID=sysModuleID, snmpTrapSrvEntry=snmpTrapSrvEntry, psSubsysVendorID=psSubsysVendorID, psDeviceID=psDeviceID, psLocation=psLocation, psFunctionIndex=psFunctionIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, pciSlotTable=pciSlotTable, advantechCommonMIB=advantechCommonMIB, psDescr=psDescr, sysDeviceName=sysDeviceName, pciConfigObj=pciConfigObj, pciSlotEntry=pciSlotEntry, atSystem=atSystem, atPciConfig=atPciConfig, sysBootTime=sysBootTime)
