...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psBaseAddress=psBaseAddress, psState=psState, pciSlotEntry=pciSlotEntry, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvEntry=snmpTrapSrvEntry, atMgmt=atMgmt, snmpTrapVersion=snmpTrapVersion, psLength=psLength, sysBootCount=sysBootCount, sysBootTime=sysBootTime, pciConfigObj=pciConfigObj, psDeviceID=psDeviceID, psSubsysDeviceID=psSubsysDeviceID, psFunctionIndex=psFunctionIndex, psLocation=psLocation, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysDescr=sysDescr, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvObj=snmpTrapSrvObj, psNumber=psNumber, sysFirstBootTime=sysFirstBootTime, psVendorID=psVendorID, psBusIndex=psBusIndex, psDeviceIndex=psDeviceIndex, snmpTrapSrvIndex=snmpTrapSrvIndex, sysReleaseDate=sysReleaseDate, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvIP=snmpTrapSrvIP, pciSlotTable=pciSlotTable, psIRQ=psIRQ, advantech=advantech, psDisplayName=psDisplayName, psDescr=psDescr, sysImageVersion=sysImageVersion, sysDeviceName=sysDeviceName, psIndex=psIndex, sysModuleID=sysModuleID, advantechCommonMIB=advantechCommonMIB, psClassCode=psClassCode, atPciConfig=atPciConfig, psModulePorts=psModulePorts, PYSNMP_MODULE_ID=advantechCommonMIB, psManufacturer=psManufacturer, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psModuleType=psModuleType, atSystem=atSystem)
