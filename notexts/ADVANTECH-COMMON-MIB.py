...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvTable=snmpTrapSrvTable, atMgmt=atMgmt, psManufacturer=psManufacturer, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvObj=snmpTrapSrvObj, psLocation=psLocation, sysImageVersion=sysImageVersion, pciConfigObj=pciConfigObj, psDeviceIndex=psDeviceIndex, psVendorID=psVendorID, psLength=psLength, sysBootTime=sysBootTime, sysBootCount=sysBootCount, psBusIndex=psBusIndex, psModuleType=psModuleType, sysModuleID=sysModuleID, psSubsysDeviceID=psSubsysDeviceID, atPciConfig=atPciConfig, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysDeviceName=sysDeviceName, psBaseAddress=psBaseAddress, advantechCommonMIB=advantechCommonMIB, psNumber=psNumber, sysFirstBootTime=sysFirstBootTime, psDeviceID=psDeviceID, psIndex=psIndex, psSubsysVendorID=psSubsysVendorID, psModulePorts=psModulePorts, advantech=advantech, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvNumber=snmpTrapSrvNumber, pciSlotTable=pciSlotTable, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysReleaseDate=sysReleaseDate, psIRQ=psIRQ, psDisplayName=psDisplayName, psFunctionIndex=psFunctionIndex, psState=psState, snmpTrapSrvEntry=snmpTrapSrvEntry, atSystem=atSystem, sysDescr=sysDescr, psClassCode=psClassCode, psDescr=psDescr, snmpTrapSrvIndex=snmpTrapSrvIndex, pciSlotEntry=pciSlotEntry)
