...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psBusIndex=psBusIndex, psNumber=psNumber, atMgmt=atMgmt, sysReleaseDate=sysReleaseDate, snmpTrapSrvObj=snmpTrapSrvObj, psSubsysDeviceID=psSubsysDeviceID, sysImageVersion=sysImageVersion, pciSlotTable=pciSlotTable, atSystem=atSystem, psIndex=psIndex, psLength=psLength, sysDeviceName=sysDeviceName, pciSlotEntry=pciSlotEntry, snmpTrapSrvEntry=snmpTrapSrvEntry, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvIndex=snmpTrapSrvIndex, psModuleType=psModuleType, advantechCommonMIB=advantechCommonMIB, snmpTrapVersion=snmpTrapVersion, psModulePorts=psModulePorts, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvCommunity=snmpTrapSrvCommunity, pciConfigObj=pciConfigObj, psIRQ=psIRQ, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvIP=snmpTrapSrvIP, sysDescr=sysDescr, psDisplayName=psDisplayName, sysBootCount=sysBootCount, psManufacturer=psManufacturer, sysModuleID=sysModuleID, psDeviceIndex=psDeviceIndex, psBaseAddress=psBaseAddress, advantech=advantech, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvTable=snmpTrapSrvTable, atPciConfig=atPciConfig, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psDescr=psDescr, psClassCode=psClassCode, psLocation=psLocation, psVendorID=psVendorID, sysBootTime=sysBootTime, psDeviceID=psDeviceID, psFunctionIndex=psFunctionIndex, psState=psState, sysFirstBootTime=sysFirstBootTime)
