...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysFirstBootTime=sysFirstBootTime, psManufacturer=psManufacturer, atSystem=atSystem, atPciConfig=atPciConfig, advantech=advantech, sysModuleID=sysModuleID, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psSubsysVendorID=psSubsysVendorID, psLength=psLength, snmpTrapSrvObj=snmpTrapSrvObj, advantechCommonMIB=advantechCommonMIB, sysBootCount=sysBootCount, sysReleaseDate=sysReleaseDate, psVendorID=psVendorID, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvTable=snmpTrapSrvTable, psModuleType=psModuleType, sysImageVersion=sysImageVersion, PYSNMP_MODULE_ID=advantechCommonMIB, psFunctionIndex=psFunctionIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, pciSlotEntry=pciSlotEntry, atMgmt=atMgmt, psIndex=psIndex, psBaseAddress=psBaseAddress, sysBootTime=sysBootTime, psLocation=psLocation, sysDescr=sysDescr, psClassCode=psClassCode, psNumber=psNumber, psDeviceID=psDeviceID, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psBusIndex=psBusIndex, psDeviceIndex=psDeviceIndex, psSubsysDeviceID=psSubsysDeviceID, sysDeviceName=sysDeviceName, psIRQ=psIRQ, snmpTrapSrvIndex=snmpTrapSrvIndex, psModulePorts=psModulePorts, snmpTrapSrvPort=snmpTrapSrvPort, pciConfigObj=pciConfigObj, psState=psState, pciSlotTable=pciSlotTable, snmpTrapSrvNumber=snmpTrapSrvNumber, psDisplayName=psDisplayName, psDescr=psDescr)
