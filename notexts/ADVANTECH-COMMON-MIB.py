...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psIndex=psIndex, psLocation=psLocation, sysBootTime=sysBootTime, sysImageVersion=sysImageVersion, psSubsysVendorID=psSubsysVendorID, pciConfigObj=pciConfigObj, atMgmt=atMgmt, psDeviceID=psDeviceID, advantech=advantech, psBusIndex=psBusIndex, sysReleaseDate=sysReleaseDate, atPciConfig=atPciConfig, snmpTrapSrvEntry=snmpTrapSrvEntry, psNumber=psNumber, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psClassCode=psClassCode, snmpTrapSrvIndex=snmpTrapSrvIndex, psManufacturer=psManufacturer, psDescr=psDescr, psModulePorts=psModulePorts, atSystem=atSystem, psLength=psLength, advantechCommonMIB=advantechCommonMIB, psDisplayName=psDisplayName, psModuleType=psModuleType, PYSNMP_MODULE_ID=advantechCommonMIB, psIRQ=psIRQ, snmpTrapSrvObj=snmpTrapSrvObj, psDeviceIndex=psDeviceIndex, pciSlotEntry=pciSlotEntry, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvNumber=snmpTrapSrvNumber, psVendorID=psVendorID, snmpTrapSrvPort=snmpTrapSrvPort, pciSlotTable=pciSlotTable, psState=psState, snmpTrapSrvIP=snmpTrapSrvIP, sysModuleID=sysModuleID, sysDeviceName=sysDeviceName, sysFirstBootTime=sysFirstBootTime, sysBootCount=sysBootCount, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psFunctionIndex=psFunctionIndex, psBaseAddress=psBaseAddress, snmpTrapVersion=snmpTrapVersion, psSubsysDeviceID=psSubsysDeviceID, sysDescr=sysDescr)
