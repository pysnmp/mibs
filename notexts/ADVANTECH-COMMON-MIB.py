...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psVendorID=psVendorID, psDescr=psDescr, snmpTrapSrvIP=snmpTrapSrvIP, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysReleaseDate=sysReleaseDate, snmpTrapSrvIndex=snmpTrapSrvIndex, psState=psState, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapVersion=snmpTrapVersion, atMgmt=atMgmt, sysBootTime=sysBootTime, psDeviceIndex=psDeviceIndex, psModuleType=psModuleType, pciSlotEntry=pciSlotEntry, psBaseAddress=psBaseAddress, psFunctionIndex=psFunctionIndex, snmpTrapSrvNumber=snmpTrapSrvNumber, psLocation=psLocation, psLength=psLength, atSystem=atSystem, advantech=advantech, pciSlotTable=pciSlotTable, psDisplayName=psDisplayName, psIndex=psIndex, sysModuleID=sysModuleID, sysBootCount=sysBootCount, snmpTrapSrvEntry=snmpTrapSrvEntry, sysImageVersion=sysImageVersion, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvTable=snmpTrapSrvTable, PYSNMP_MODULE_ID=advantechCommonMIB, pciConfigObj=pciConfigObj, psIRQ=psIRQ, snmpTrapSrvObj=snmpTrapSrvObj, sysDeviceName=sysDeviceName, psClassCode=psClassCode, psModulePorts=psModulePorts, psManufacturer=psManufacturer, atPciConfig=atPciConfig, psDeviceID=psDeviceID, advantechCommonMIB=advantechCommonMIB, psBusIndex=psBusIndex, psNumber=psNumber, psSubsysDeviceID=psSubsysDeviceID, sysDescr=sysDescr)
