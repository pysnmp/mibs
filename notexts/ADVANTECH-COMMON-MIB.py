...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvPort=snmpTrapSrvPort, sysModuleID=sysModuleID, pciConfigObj=pciConfigObj, psBaseAddress=psBaseAddress, snmpTrapSrvObj=snmpTrapSrvObj, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvIndex=snmpTrapSrvIndex, sysDeviceName=sysDeviceName, psBusIndex=psBusIndex, psLocation=psLocation, psDisplayName=psDisplayName, sysBootCount=sysBootCount, psSubsysDeviceID=psSubsysDeviceID, advantech=advantech, psDescr=psDescr, psDeviceID=psDeviceID, atSystem=atSystem, atMgmt=atMgmt, PYSNMP_MODULE_ID=advantechCommonMIB, psDeviceIndex=psDeviceIndex, psState=psState, snmpTrapSrvIP=snmpTrapSrvIP, sysBootTime=sysBootTime, snmpTrapSrvNumber=snmpTrapSrvNumber, sysDescr=sysDescr, snmpTrapVersion=snmpTrapVersion, psLength=psLength, psNumber=psNumber, sysReleaseDate=sysReleaseDate, psVendorID=psVendorID, psIndex=psIndex, psManufacturer=psManufacturer, atPciConfig=atPciConfig, pciSlotEntry=pciSlotEntry, psClassCode=psClassCode, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psModuleType=psModuleType, sysImageVersion=sysImageVersion, snmpTrapSrvTable=snmpTrapSrvTable, advantechCommonMIB=advantechCommonMIB, pciSlotTable=pciSlotTable, psIRQ=psIRQ, psModulePorts=psModulePorts, psFunctionIndex=psFunctionIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, sysFirstBootTime=sysFirstBootTime)
