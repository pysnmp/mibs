...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvPort=snmpTrapSrvPort, psIndex=psIndex, snmpTrapSrvObj=snmpTrapSrvObj, atPciConfig=atPciConfig, psSubsysDeviceID=psSubsysDeviceID, psBusIndex=psBusIndex, psNumber=psNumber, psVendorID=psVendorID, sysBootTime=sysBootTime, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapVersion=snmpTrapVersion, sysDeviceName=sysDeviceName, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvEntry=snmpTrapSrvEntry, sysImageVersion=sysImageVersion, sysModuleID=sysModuleID, pciConfigObj=pciConfigObj, psBaseAddress=psBaseAddress, psState=psState, atMgmt=atMgmt, psClassCode=psClassCode, psDisplayName=psDisplayName, atSystem=atSystem, psModulePorts=psModulePorts, advantech=advantech, sysReleaseDate=sysReleaseDate, psDeviceIndex=psDeviceIndex, psLocation=psLocation, psDeviceID=psDeviceID, psSubsysVendorID=psSubsysVendorID, psDescr=psDescr, sysBootCount=sysBootCount, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvCommunity=snmpTrapSrvCommunity, PYSNMP_MODULE_ID=advantechCommonMIB, psIRQ=psIRQ, psModuleType=psModuleType, pciSlotEntry=pciSlotEntry, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvTable=snmpTrapSrvTable, psFunctionIndex=psFunctionIndex, snmpTrapSrvIndex=snmpTrapSrvIndex, sysDescr=sysDescr, advantechCommonMIB=advantechCommonMIB, psLength=psLength, pciSlotTable=pciSlotTable, psManufacturer=psManufacturer)
