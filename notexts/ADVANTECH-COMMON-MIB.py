...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysDescr=sysDescr, sysModuleID=sysModuleID, psNumber=psNumber, psBaseAddress=psBaseAddress, psDisplayName=psDisplayName, snmpTrapSrvNumber=snmpTrapSrvNumber, advantechCommonMIB=advantechCommonMIB, pciSlotTable=pciSlotTable, atSystem=atSystem, pciConfigObj=pciConfigObj, psManufacturer=psManufacturer, snmpTrapVersion=snmpTrapVersion, psDeviceID=psDeviceID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysImageVersion=sysImageVersion, sysBootTime=sysBootTime, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvIP=snmpTrapSrvIP, psFunctionIndex=psFunctionIndex, sysFirstBootTime=sysFirstBootTime, psSubsysVendorID=psSubsysVendorID, psLocation=psLocation, snmpTrapSrvIndex=snmpTrapSrvIndex, pciSlotEntry=pciSlotEntry, psModuleType=psModuleType, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psDescr=psDescr, psIndex=psIndex, psVendorID=psVendorID, advantech=advantech, snmpTrapSrvObj=snmpTrapSrvObj, sysBootCount=sysBootCount, PYSNMP_MODULE_ID=advantechCommonMIB, sysDeviceName=sysDeviceName, psClassCode=psClassCode, psBusIndex=psBusIndex, psIRQ=psIRQ, psLength=psLength, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvPort=snmpTrapSrvPort, sysReleaseDate=sysReleaseDate, atMgmt=atMgmt, psDeviceIndex=psDeviceIndex, atPciConfig=atPciConfig, snmpTrapSrvEntry=snmpTrapSrvEntry, psModulePorts=psModulePorts, psState=psState)
