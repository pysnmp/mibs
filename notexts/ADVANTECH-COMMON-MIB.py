...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysImageVersion=sysImageVersion, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysBootCount=sysBootCount, psFunctionIndex=psFunctionIndex, psManufacturer=psManufacturer, sysBootTime=sysBootTime, psDisplayName=psDisplayName, advantech=advantech, pciConfigObj=pciConfigObj, psBaseAddress=psBaseAddress, sysDescr=sysDescr, psClassCode=psClassCode, snmpTrapSrvPort=snmpTrapSrvPort, atSystem=atSystem, psLength=psLength, PYSNMP_MODULE_ID=advantechCommonMIB, atMgmt=atMgmt, psDescr=psDescr, psDeviceID=psDeviceID, psSubsysDeviceID=psSubsysDeviceID, sysDeviceName=sysDeviceName, sysFirstBootTime=sysFirstBootTime, pciSlotEntry=pciSlotEntry, snmpTrapSrvEntry=snmpTrapSrvEntry, psModulePorts=psModulePorts, psVendorID=psVendorID, snmpTrapVersion=snmpTrapVersion, psState=psState, snmpTrapSrvIP=snmpTrapSrvIP, psBusIndex=psBusIndex, sysReleaseDate=sysReleaseDate, snmpTrapSrvTable=snmpTrapSrvTable, pciSlotTable=pciSlotTable, psIRQ=psIRQ, snmpTrapSrvIndex=snmpTrapSrvIndex, psNumber=psNumber, snmpTrapSrvObj=snmpTrapSrvObj, atPciConfig=atPciConfig, psLocation=psLocation, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psDeviceIndex=psDeviceIndex, sysModuleID=sysModuleID, advantechCommonMIB=advantechCommonMIB, psIndex=psIndex, psModuleType=psModuleType)
