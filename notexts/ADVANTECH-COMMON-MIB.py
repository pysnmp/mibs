...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psManufacturer=psManufacturer, pciConfigObj=pciConfigObj, psIndex=psIndex, sysImageVersion=sysImageVersion, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvObj=snmpTrapSrvObj, psSubsysDeviceID=psSubsysDeviceID, psBusIndex=psBusIndex, psDescr=psDescr, psBaseAddress=psBaseAddress, snmpTrapSrvIndex=snmpTrapSrvIndex, sysBootCount=sysBootCount, snmpTrapSrvTable=snmpTrapSrvTable, sysDescr=sysDescr, advantech=advantech, psSubsysVendorID=psSubsysVendorID, psNumber=psNumber, psDeviceID=psDeviceID, sysDeviceName=sysDeviceName, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psIRQ=psIRQ, psDisplayName=psDisplayName, atMgmt=atMgmt, psVendorID=psVendorID, snmpTrapVersion=snmpTrapVersion, psLocation=psLocation, snmpTrapSrvIP=snmpTrapSrvIP, psLength=psLength, psModuleType=psModuleType, psDeviceIndex=psDeviceIndex, advantechCommonMIB=advantechCommonMIB, pciSlotEntry=pciSlotEntry, sysFirstBootTime=sysFirstBootTime, psState=psState, atPciConfig=atPciConfig, sysModuleID=sysModuleID, snmpTrapSrvPort=snmpTrapSrvPort, sysReleaseDate=sysReleaseDate, psClassCode=psClassCode, sysBootTime=sysBootTime, psFunctionIndex=psFunctionIndex, pciSlotTable=pciSlotTable, psModulePorts=psModulePorts, snmpTrapSrvEntry=snmpTrapSrvEntry, PYSNMP_MODULE_ID=advantechCommonMIB, atSystem=atSystem)
