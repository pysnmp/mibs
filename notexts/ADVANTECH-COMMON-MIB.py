...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapVersion=snmpTrapVersion, psNumber=psNumber, atSystem=atSystem, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psModulePorts=psModulePorts, pciSlotEntry=pciSlotEntry, psClassCode=psClassCode, atMgmt=atMgmt, psDeviceID=psDeviceID, snmpTrapSrvObj=snmpTrapSrvObj, sysBootTime=sysBootTime, sysDeviceName=sysDeviceName, psIRQ=psIRQ, psManufacturer=psManufacturer, sysImageVersion=sysImageVersion, snmpTrapSrvIndex=snmpTrapSrvIndex, psFunctionIndex=psFunctionIndex, psDeviceIndex=psDeviceIndex, psLocation=psLocation, PYSNMP_MODULE_ID=advantechCommonMIB, pciConfigObj=pciConfigObj, psDisplayName=psDisplayName, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysDescr=sysDescr, psLength=psLength, psVendorID=psVendorID, psState=psState, psDescr=psDescr, advantech=advantech, psIndex=psIndex, sysReleaseDate=sysReleaseDate, psModuleType=psModuleType, snmpTrapSrvEntry=snmpTrapSrvEntry, advantechCommonMIB=advantechCommonMIB, psSubsysDeviceID=psSubsysDeviceID, psSubsysVendorID=psSubsysVendorID, atPciConfig=atPciConfig, sysModuleID=sysModuleID, snmpTrapSrvPort=snmpTrapSrvPort, pciSlotTable=pciSlotTable, snmpTrapSrvTable=snmpTrapSrvTable, psBusIndex=psBusIndex, psBaseAddress=psBaseAddress, snmpTrapSrvNumber=snmpTrapSrvNumber, sysBootCount=sysBootCount)
