...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvPort=snmpTrapSrvPort, sysBootTime=sysBootTime, psSubsysVendorID=psSubsysVendorID, psDeviceID=psDeviceID, psFunctionIndex=psFunctionIndex, psManufacturer=psManufacturer, pciSlotTable=pciSlotTable, snmpTrapSrvEntry=snmpTrapSrvEntry, sysModuleID=sysModuleID, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, atPciConfig=atPciConfig, psIRQ=psIRQ, psBaseAddress=psBaseAddress, psDeviceIndex=psDeviceIndex, sysImageVersion=sysImageVersion, atSystem=atSystem, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psState=psState, snmpTrapSrvNumber=snmpTrapSrvNumber, pciConfigObj=pciConfigObj, psSubsysDeviceID=psSubsysDeviceID, advantechCommonMIB=advantechCommonMIB, sysReleaseDate=sysReleaseDate, psIndex=psIndex, advantech=advantech, psLocation=psLocation, sysDescr=sysDescr, psLength=psLength, sysDeviceName=sysDeviceName, psNumber=psNumber, psModulePorts=psModulePorts, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapVersion=snmpTrapVersion, psDescr=psDescr, psClassCode=psClassCode, psBusIndex=psBusIndex, atMgmt=atMgmt, PYSNMP_MODULE_ID=advantechCommonMIB, psModuleType=psModuleType, pciSlotEntry=pciSlotEntry, snmpTrapSrvObj=snmpTrapSrvObj, psDisplayName=psDisplayName, sysFirstBootTime=sysFirstBootTime, sysBootCount=sysBootCount, psVendorID=psVendorID)
