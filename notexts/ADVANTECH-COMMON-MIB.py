...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvIP=snmpTrapSrvIP, psDeviceID=psDeviceID, sysImageVersion=sysImageVersion, pciConfigObj=pciConfigObj, sysDeviceName=sysDeviceName, psIRQ=psIRQ, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, atMgmt=atMgmt, psDeviceIndex=psDeviceIndex, advantech=advantech, snmpTrapSrvTable=snmpTrapSrvTable, psState=psState, sysDescr=sysDescr, snmpTrapSrvPort=snmpTrapSrvPort, psSubsysDeviceID=psSubsysDeviceID, psManufacturer=psManufacturer, sysBootCount=sysBootCount, snmpTrapVersion=snmpTrapVersion, pciSlotEntry=pciSlotEntry, psLocation=psLocation, psFunctionIndex=psFunctionIndex, pciSlotTable=pciSlotTable, psIndex=psIndex, sysReleaseDate=sysReleaseDate, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psModuleType=psModuleType, sysBootTime=sysBootTime, sysModuleID=sysModuleID, atSystem=atSystem, psLength=psLength, psBaseAddress=psBaseAddress, snmpTrapSrvObj=snmpTrapSrvObj, psSubsysVendorID=psSubsysVendorID, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvIndex=snmpTrapSrvIndex, psDisplayName=psDisplayName, psDescr=psDescr, psClassCode=psClassCode, atPciConfig=atPciConfig, psBusIndex=psBusIndex, psModulePorts=psModulePorts, psNumber=psNumber, PYSNMP_MODULE_ID=advantechCommonMIB, psVendorID=psVendorID)
