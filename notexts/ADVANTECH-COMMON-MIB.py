...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psManufacturer=psManufacturer, sysDescr=sysDescr, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psFunctionIndex=psFunctionIndex, psDeviceIndex=psDeviceIndex, sysImageVersion=sysImageVersion, PYSNMP_MODULE_ID=advantechCommonMIB, psClassCode=psClassCode, psModulePorts=psModulePorts, snmpTrapSrvPort=snmpTrapSrvPort, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvIndex=snmpTrapSrvIndex, atMgmt=atMgmt, psDescr=psDescr, snmpTrapSrvCommunity=snmpTrapSrvCommunity, atSystem=atSystem, sysModuleID=sysModuleID, sysBootTime=sysBootTime, pciSlotTable=pciSlotTable, psModuleType=psModuleType, psNumber=psNumber, psState=psState, pciConfigObj=pciConfigObj, advantech=advantech, sysDeviceName=sysDeviceName, sysBootCount=sysBootCount, snmpTrapSrvIP=snmpTrapSrvIP, psIndex=psIndex, psLocation=psLocation, atPciConfig=atPciConfig, sysReleaseDate=sysReleaseDate, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvEntry=snmpTrapSrvEntry, psSubsysVendorID=psSubsysVendorID, psLength=psLength, pciSlotEntry=pciSlotEntry, psBaseAddress=psBaseAddress, psVendorID=psVendorID, advantechCommonMIB=advantechCommonMIB, snmpTrapVersion=snmpTrapVersion, psDisplayName=psDisplayName, psSubsysDeviceID=psSubsysDeviceID, psDeviceID=psDeviceID, snmpTrapSrvObj=snmpTrapSrvObj, psIRQ=psIRQ, psBusIndex=psBusIndex)
