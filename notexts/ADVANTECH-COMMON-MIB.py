...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysDeviceName=sysDeviceName, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psClassCode=psClassCode, psLocation=psLocation, psLength=psLength, sysDescr=sysDescr, sysBootCount=sysBootCount, snmpTrapSrvIndex=snmpTrapSrvIndex, psDescr=psDescr, sysReleaseDate=sysReleaseDate, psBusIndex=psBusIndex, psManufacturer=psManufacturer, psIRQ=psIRQ, snmpTrapSrvEntry=snmpTrapSrvEntry, psIndex=psIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvNumber=snmpTrapSrvNumber, atSystem=atSystem, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvIP=snmpTrapSrvIP, advantech=advantech, snmpTrapVersion=snmpTrapVersion, pciSlotTable=pciSlotTable, psFunctionIndex=psFunctionIndex, psDeviceID=psDeviceID, sysModuleID=sysModuleID, psNumber=psNumber, psVendorID=psVendorID, pciSlotEntry=pciSlotEntry, sysImageVersion=sysImageVersion, advantechCommonMIB=advantechCommonMIB, atMgmt=atMgmt, snmpTrapSrvObj=snmpTrapSrvObj, sysBootTime=sysBootTime, PYSNMP_MODULE_ID=advantechCommonMIB, psSubsysDeviceID=psSubsysDeviceID, psModulePorts=psModulePorts, psState=psState, psDisplayName=psDisplayName, pciConfigObj=pciConfigObj, psBaseAddress=psBaseAddress, snmpTrapSrvPort=snmpTrapSrvPort, atPciConfig=atPciConfig, psDeviceIndex=psDeviceIndex, psModuleType=psModuleType, snmpTrapSrvTable=snmpTrapSrvTable)
