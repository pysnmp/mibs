...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psModuleType=psModuleType, psDisplayName=psDisplayName, psLength=psLength, snmpTrapVersion=snmpTrapVersion, PYSNMP_MODULE_ID=advantechCommonMIB, pciSlotTable=pciSlotTable, psBaseAddress=psBaseAddress, snmpTrapSrvObj=snmpTrapSrvObj, psManufacturer=psManufacturer, psDescr=psDescr, sysBootTime=sysBootTime, advantechCommonMIB=advantechCommonMIB, advantech=advantech, psState=psState, pciSlotEntry=pciSlotEntry, snmpTrapSrvTable=snmpTrapSrvTable, atMgmt=atMgmt, psFunctionIndex=psFunctionIndex, atSystem=atSystem, psBusIndex=psBusIndex, psSubsysDeviceID=psSubsysDeviceID, psDeviceID=psDeviceID, psIRQ=psIRQ, psSubsysVendorID=psSubsysVendorID, psModulePorts=psModulePorts, pciConfigObj=pciConfigObj, psLocation=psLocation, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvPort=snmpTrapSrvPort, sysBootCount=sysBootCount, psDeviceIndex=psDeviceIndex, psNumber=psNumber, sysDescr=sysDescr, psVendorID=psVendorID, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysDeviceName=sysDeviceName, psIndex=psIndex, sysModuleID=sysModuleID, psClassCode=psClassCode, sysReleaseDate=sysReleaseDate, snmpTrapSrvNumber=snmpTrapSrvNumber, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysImageVersion=sysImageVersion, atPciConfig=atPciConfig)
