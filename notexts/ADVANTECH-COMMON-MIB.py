...
ModuleIdentity, iso, MibIdentifier, Counter64, Bits, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, ObjectIdentity, Integer32, IpAddress, Unsigned32, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "MibIdentifier", "Counter64", "Bits", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "ObjectIdentity", "Integer32", "IpAddress", "Unsigned32", "Counter32", "Gauge32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysDescr=sysDescr, sysFirstBootTime=sysFirstBootTime, psFunctionIndex=psFunctionIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psIndex=psIndex, atSystem=atSystem, sysDeviceName=sysDeviceName, sysBootTime=sysBootTime, psDeviceID=psDeviceID, sysBootCount=sysBootCount, snmpTrapVersion=snmpTrapVersion, psModuleType=psModuleType, atPciConfig=atPciConfig, psVendorID=psVendorID, advantech=advantech, pciSlotTable=pciSlotTable, psBaseAddress=psBaseAddress, psIRQ=psIRQ, sysReleaseDate=sysReleaseDate, snmpTrapSrvTable=snmpTrapSrvTable, psBusIndex=psBusIndex, sysImageVersion=sysImageVersion, psSubsysVendorID=psSubsysVendorID, pciConfigObj=pciConfigObj, psClassCode=psClassCode, psState=psState, pciSlotEntry=pciSlotEntry, sysModuleID=sysModuleID, atMgmt=atMgmt, snmpTrapSrvNumber=snmpTrapSrvNumber, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvIndex=snmpTrapSrvIndex, psManufacturer=psManufacturer, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvIP=snmpTrapSrvIP, psNumber=psNumber, psDescr=psDescr, psDisplayName=psDisplayName, psLocation=psLocation, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvObj=snmpTrapSrvObj, psDeviceIndex=psDeviceIndex, PYSNMP_MODULE_ID=advantechCommonMIB, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psLength=psLength, psModulePorts=psModulePorts)
