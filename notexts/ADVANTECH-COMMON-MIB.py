...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psIndex=psIndex, psFunctionIndex=psFunctionIndex, advantech=advantech, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysDeviceName=sysDeviceName, snmpTrapSrvIndex=snmpTrapSrvIndex, psBusIndex=psBusIndex, psState=psState, sysModuleID=sysModuleID, atSystem=atSystem, sysImageVersion=sysImageVersion, psClassCode=psClassCode, psDisplayName=psDisplayName, psBaseAddress=psBaseAddress, sysDescr=sysDescr, atPciConfig=atPciConfig, psModuleType=psModuleType, sysFirstBootTime=sysFirstBootTime, sysReleaseDate=sysReleaseDate, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psSubsysDeviceID=psSubsysDeviceID, psSubsysVendorID=psSubsysVendorID, pciConfigObj=pciConfigObj, psNumber=psNumber, snmpTrapSrvNumber=snmpTrapSrvNumber, sysBootCount=sysBootCount, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvIP=snmpTrapSrvIP, psDeviceID=psDeviceID, snmpTrapSrvEntry=snmpTrapSrvEntry, advantechCommonMIB=advantechCommonMIB, pciSlotTable=pciSlotTable, atMgmt=atMgmt, psIRQ=psIRQ, psLocation=psLocation, psDescr=psDescr, psManufacturer=psManufacturer, sysBootTime=sysBootTime, snmpTrapSrvObj=snmpTrapSrvObj, psModulePorts=psModulePorts, psVendorID=psVendorID, snmpTrapSrvTable=snmpTrapSrvTable, pciSlotEntry=pciSlotEntry, snmpTrapVersion=snmpTrapVersion, psDeviceIndex=psDeviceIndex, psLength=psLength)
