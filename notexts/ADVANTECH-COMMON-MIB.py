...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psNumber=psNumber, psLength=psLength, sysFirstBootTime=sysFirstBootTime, sysReleaseDate=sysReleaseDate, psIndex=psIndex, psState=psState, sysDescr=sysDescr, psDeviceIndex=psDeviceIndex, sysImageVersion=sysImageVersion, sysDeviceName=sysDeviceName, sysBootCount=sysBootCount, snmpTrapSrvObj=snmpTrapSrvObj, psDeviceID=psDeviceID, snmpTrapSrvIP=snmpTrapSrvIP, pciSlotTable=pciSlotTable, snmpTrapVersion=snmpTrapVersion, advantech=advantech, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psDescr=psDescr, pciSlotEntry=pciSlotEntry, sysModuleID=sysModuleID, psBaseAddress=psBaseAddress, atSystem=atSystem, pciConfigObj=pciConfigObj, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psManufacturer=psManufacturer, snmpTrapSrvTable=snmpTrapSrvTable, advantechCommonMIB=advantechCommonMIB, psBusIndex=psBusIndex, snmpTrapSrvIndex=snmpTrapSrvIndex, psModuleType=psModuleType, psVendorID=psVendorID, atPciConfig=atPciConfig, psClassCode=psClassCode, psIRQ=psIRQ, psDisplayName=psDisplayName, psSubsysDeviceID=psSubsysDeviceID, psFunctionIndex=psFunctionIndex, snmpTrapSrvNumber=snmpTrapSrvNumber, sysBootTime=sysBootTime, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvPort=snmpTrapSrvPort, psModulePorts=psModulePorts, atMgmt=atMgmt, psLocation=psLocation, psSubsysVendorID=psSubsysVendorID, PYSNMP_MODULE_ID=advantechCommonMIB)
