...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psIRQ=psIRQ, pciSlotTable=pciSlotTable, sysReleaseDate=sysReleaseDate, psSubsysDeviceID=psSubsysDeviceID, sysModuleID=sysModuleID, snmpTrapSrvObj=snmpTrapSrvObj, psBaseAddress=psBaseAddress, pciSlotEntry=pciSlotEntry, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, advantech=advantech, psDeviceIndex=psDeviceIndex, psDescr=psDescr, sysDescr=sysDescr, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvIP=snmpTrapSrvIP, PYSNMP_MODULE_ID=advantechCommonMIB, psSubsysVendorID=psSubsysVendorID, psBusIndex=psBusIndex, psFunctionIndex=psFunctionIndex, sysFirstBootTime=sysFirstBootTime, atSystem=atSystem, atMgmt=atMgmt, psClassCode=psClassCode, psLocation=psLocation, sysBootTime=sysBootTime, psState=psState, psModulePorts=psModulePorts, pciConfigObj=pciConfigObj, snmpTrapSrvIndex=snmpTrapSrvIndex, psDisplayName=psDisplayName, snmpTrapVersion=snmpTrapVersion, psManufacturer=psManufacturer, sysDeviceName=sysDeviceName, advantechCommonMIB=advantechCommonMIB, sysBootCount=sysBootCount, snmpTrapSrvEntry=snmpTrapSrvEntry, psVendorID=psVendorID, sysImageVersion=sysImageVersion, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psModuleType=psModuleType, snmpTrapSrvPort=snmpTrapSrvPort, psNumber=psNumber, psDeviceID=psDeviceID, atPciConfig=atPciConfig, psIndex=psIndex, psLength=psLength)
