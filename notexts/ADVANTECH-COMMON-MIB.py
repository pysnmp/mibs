...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psFunctionIndex=psFunctionIndex, snmpTrapVersion=snmpTrapVersion, psDisplayName=psDisplayName, snmpTrapSrvEntry=snmpTrapSrvEntry, sysReleaseDate=sysReleaseDate, sysBootCount=sysBootCount, pciSlotEntry=pciSlotEntry, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, pciSlotTable=pciSlotTable, psDeviceID=psDeviceID, psModuleType=psModuleType, sysFirstBootTime=sysFirstBootTime, psDeviceIndex=psDeviceIndex, advantechCommonMIB=advantechCommonMIB, psBaseAddress=psBaseAddress, psState=psState, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvTable=snmpTrapSrvTable, atMgmt=atMgmt, sysDeviceName=sysDeviceName, psModulePorts=psModulePorts, atPciConfig=atPciConfig, snmpTrapSrvCommunity=snmpTrapSrvCommunity, advantech=advantech, psIRQ=psIRQ, sysModuleID=sysModuleID, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvPort=snmpTrapSrvPort, psSubsysVendorID=psSubsysVendorID, psBusIndex=psBusIndex, psSubsysDeviceID=psSubsysDeviceID, sysImageVersion=sysImageVersion, psClassCode=psClassCode, sysDescr=sysDescr, psIndex=psIndex, psDescr=psDescr, psVendorID=psVendorID, psNumber=psNumber, sysBootTime=sysBootTime, pciConfigObj=pciConfigObj, psManufacturer=psManufacturer, atSystem=atSystem, snmpTrapSrvNumber=snmpTrapSrvNumber, psLength=psLength, snmpTrapSrvObj=snmpTrapSrvObj, psLocation=psLocation, snmpTrapSrvIP=snmpTrapSrvIP)
