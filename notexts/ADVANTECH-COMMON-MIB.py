...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psBusIndex=psBusIndex, pciSlotTable=pciSlotTable, psManufacturer=psManufacturer, atSystem=atSystem, sysDescr=sysDescr, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvObj=snmpTrapSrvObj, pciConfigObj=pciConfigObj, snmpTrapSrvTable=snmpTrapSrvTable, sysReleaseDate=sysReleaseDate, psIndex=psIndex, snmpTrapSrvPort=snmpTrapSrvPort, psVendorID=psVendorID, psBaseAddress=psBaseAddress, psDisplayName=psDisplayName, sysImageVersion=sysImageVersion, snmpTrapSrvNumber=snmpTrapSrvNumber, atPciConfig=atPciConfig, psState=psState, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvEntry=snmpTrapSrvEntry, psLocation=psLocation, snmpTrapSrvIndex=snmpTrapSrvIndex, sysBootCount=sysBootCount, sysFirstBootTime=sysFirstBootTime, psSubsysVendorID=psSubsysVendorID, psModuleType=psModuleType, sysBootTime=sysBootTime, snmpTrapSrvIP=snmpTrapSrvIP, pciSlotEntry=pciSlotEntry, psLength=psLength, atMgmt=atMgmt, advantech=advantech, psDeviceIndex=psDeviceIndex, sysDeviceName=sysDeviceName, psNumber=psNumber, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psModulePorts=psModulePorts, psClassCode=psClassCode, advantechCommonMIB=advantechCommonMIB, psIRQ=psIRQ, sysModuleID=sysModuleID, psDescr=psDescr, psFunctionIndex=psFunctionIndex, psDeviceID=psDeviceID, psSubsysDeviceID=psSubsysDeviceID)
