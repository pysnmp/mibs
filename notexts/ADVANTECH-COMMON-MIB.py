...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysBootCount=sysBootCount, psBusIndex=psBusIndex, snmpTrapSrvObj=snmpTrapSrvObj, pciSlotTable=pciSlotTable, psDisplayName=psDisplayName, psDescr=psDescr, snmpTrapSrvPort=snmpTrapSrvPort, psLocation=psLocation, sysImageVersion=sysImageVersion, snmpTrapSrvTable=snmpTrapSrvTable, atMgmt=atMgmt, sysDeviceName=sysDeviceName, pciSlotEntry=pciSlotEntry, psIndex=psIndex, psSubsysVendorID=psSubsysVendorID, pciConfigObj=pciConfigObj, snmpTrapSrvIP=snmpTrapSrvIP, psIRQ=psIRQ, sysReleaseDate=sysReleaseDate, advantech=advantech, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvIndex=snmpTrapSrvIndex, psState=psState, psVendorID=psVendorID, psSubsysDeviceID=psSubsysDeviceID, sysModuleID=sysModuleID, psClassCode=psClassCode, psModulePorts=psModulePorts, atSystem=atSystem, atPciConfig=atPciConfig, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvNumber=snmpTrapSrvNumber, sysDescr=sysDescr, psBaseAddress=psBaseAddress, psNumber=psNumber, psLength=psLength, psManufacturer=psManufacturer, sysBootTime=sysBootTime, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapVersion=snmpTrapVersion, psDeviceID=psDeviceID, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psModuleType=psModuleType, psFunctionIndex=psFunctionIndex, psDeviceIndex=psDeviceIndex, PYSNMP_MODULE_ID=advantechCommonMIB, sysFirstBootTime=sysFirstBootTime)
