...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psIndex=psIndex, pciSlotEntry=pciSlotEntry, sysFirstBootTime=sysFirstBootTime, psSubsysDeviceID=psSubsysDeviceID, sysDeviceName=sysDeviceName, sysModuleID=sysModuleID, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvPort=snmpTrapSrvPort, advantech=advantech, psModuleType=psModuleType, psDeviceID=psDeviceID, psIRQ=psIRQ, psState=psState, sysBootCount=sysBootCount, psBusIndex=psBusIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, atSystem=atSystem, psModulePorts=psModulePorts, psVendorID=psVendorID, sysReleaseDate=sysReleaseDate, psLocation=psLocation, psNumber=psNumber, atPciConfig=atPciConfig, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psDisplayName=psDisplayName, pciConfigObj=pciConfigObj, atMgmt=atMgmt, sysImageVersion=sysImageVersion, psBaseAddress=psBaseAddress, psSubsysVendorID=psSubsysVendorID, psClassCode=psClassCode, psFunctionIndex=psFunctionIndex, advantechCommonMIB=advantechCommonMIB, psDescr=psDescr, sysDescr=sysDescr, sysBootTime=sysBootTime, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapVersion=snmpTrapVersion, psManufacturer=psManufacturer, snmpTrapSrvIndex=snmpTrapSrvIndex, PYSNMP_MODULE_ID=advantechCommonMIB, pciSlotTable=pciSlotTable, psLength=psLength, psDeviceIndex=psDeviceIndex)
