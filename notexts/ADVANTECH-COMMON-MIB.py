...
Unsigned32, Gauge32, ObjectIdentity, Integer32, MibIdentifier, Bits, IpAddress, Counter32, Counter64, NotificationType, TimeTicks, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Gauge32", "ObjectIdentity", "Integer32", "MibIdentifier", "Bits", "IpAddress", "Counter32", "Counter64", "NotificationType", "TimeTicks", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "ModuleIdentity")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psFunctionIndex=psFunctionIndex, psIRQ=psIRQ, sysDeviceName=sysDeviceName, sysFirstBootTime=sysFirstBootTime, sysDescr=sysDescr, atSystem=atSystem, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psDescr=psDescr, psDeviceID=psDeviceID, advantech=advantech, psLocation=psLocation, psModuleType=psModuleType, advantechCommonMIB=advantechCommonMIB, psState=psState, pciSlotEntry=pciSlotEntry, PYSNMP_MODULE_ID=advantechCommonMIB, psSubsysDeviceID=psSubsysDeviceID, psClassCode=psClassCode, atMgmt=atMgmt, psLength=psLength, psModulePorts=psModulePorts, psDeviceIndex=psDeviceIndex, sysReleaseDate=sysReleaseDate, snmpTrapSrvNumber=snmpTrapSrvNumber, sysBootCount=sysBootCount, psBusIndex=psBusIndex, sysBootTime=sysBootTime, snmpTrapSrvEntry=snmpTrapSrvEntry, psIndex=psIndex, psBaseAddress=psBaseAddress, sysImageVersion=sysImageVersion, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapVersion=snmpTrapVersion, psVendorID=psVendorID, psManufacturer=psManufacturer, snmpTrapSrvIP=snmpTrapSrvIP, psDisplayName=psDisplayName, atPciConfig=atPciConfig, sysModuleID=sysModuleID, snmpTrapSrvPort=snmpTrapSrvPort, pciSlotTable=pciSlotTable, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psSubsysVendorID=psSubsysVendorID, pciConfigObj=pciConfigObj, snmpTrapSrvIndex=snmpTrapSrvIndex, psNumber=psNumber, snmpTrapSrvTable=snmpTrapSrvTable)
