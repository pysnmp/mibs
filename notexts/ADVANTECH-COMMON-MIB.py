...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psFunctionIndex=psFunctionIndex, psDescr=psDescr, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysReleaseDate=sysReleaseDate, pciSlotTable=pciSlotTable, psVendorID=psVendorID, PYSNMP_MODULE_ID=advantechCommonMIB, atSystem=atSystem, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvEntry=snmpTrapSrvEntry, psLength=psLength, psClassCode=psClassCode, snmpTrapSrvObj=snmpTrapSrvObj, psModulePorts=psModulePorts, atMgmt=atMgmt, sysDeviceName=sysDeviceName, psBusIndex=psBusIndex, psManufacturer=psManufacturer, psDeviceIndex=psDeviceIndex, pciSlotEntry=pciSlotEntry, advantech=advantech, sysBootCount=sysBootCount, snmpTrapSrvNumber=snmpTrapSrvNumber, psIndex=psIndex, psBaseAddress=psBaseAddress, sysBootTime=sysBootTime, snmpTrapSrvPort=snmpTrapSrvPort, advantechCommonMIB=advantechCommonMIB, psIRQ=psIRQ, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psDeviceID=psDeviceID, pciConfigObj=pciConfigObj, psLocation=psLocation, psNumber=psNumber, snmpTrapSrvTable=snmpTrapSrvTable, psState=psState, sysDescr=sysDescr, atPciConfig=atPciConfig, sysFirstBootTime=sysFirstBootTime, psDisplayName=psDisplayName, psModuleType=psModuleType, snmpTrapSrvIP=snmpTrapSrvIP, sysModuleID=sysModuleID, sysImageVersion=sysImageVersion)
