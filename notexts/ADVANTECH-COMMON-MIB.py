...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvIndex=snmpTrapSrvIndex, atSystem=atSystem, psVendorID=psVendorID, psDisplayName=psDisplayName, atMgmt=atMgmt, sysDescr=sysDescr, psManufacturer=psManufacturer, sysDeviceName=sysDeviceName, psState=psState, psModuleType=psModuleType, PYSNMP_MODULE_ID=advantechCommonMIB, psClassCode=psClassCode, advantechCommonMIB=advantechCommonMIB, advantech=advantech, psLocation=psLocation, atPciConfig=atPciConfig, psIndex=psIndex, sysReleaseDate=sysReleaseDate, psSubsysVendorID=psSubsysVendorID, psLength=psLength, snmpTrapVersion=snmpTrapVersion, psDeviceIndex=psDeviceIndex, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvTable=snmpTrapSrvTable, sysBootCount=sysBootCount, sysImageVersion=sysImageVersion, snmpTrapSrvIP=snmpTrapSrvIP, psBusIndex=psBusIndex, sysModuleID=sysModuleID, snmpTrapSrvNumber=snmpTrapSrvNumber, psFunctionIndex=psFunctionIndex, psDescr=psDescr, psSubsysDeviceID=psSubsysDeviceID, psBaseAddress=psBaseAddress, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psModulePorts=psModulePorts, sysFirstBootTime=sysFirstBootTime, psDeviceID=psDeviceID, pciConfigObj=pciConfigObj, psIRQ=psIRQ, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvCommunity=snmpTrapSrvCommunity, pciSlotTable=pciSlotTable, psNumber=psNumber, pciSlotEntry=pciSlotEntry, sysBootTime=sysBootTime, snmpTrapSrvEntry=snmpTrapSrvEntry)
