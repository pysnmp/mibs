...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psBusIndex=psBusIndex, atPciConfig=atPciConfig, psVendorID=psVendorID, pciSlotEntry=pciSlotEntry, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psClassCode=psClassCode, sysReleaseDate=sysReleaseDate, psState=psState, psDeviceID=psDeviceID, sysBootCount=sysBootCount, psModulePorts=psModulePorts, sysDeviceName=sysDeviceName, psSubsysDeviceID=psSubsysDeviceID, psNumber=psNumber, pciSlotTable=pciSlotTable, snmpTrapSrvNumber=snmpTrapSrvNumber, psLocation=psLocation, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psSubsysVendorID=psSubsysVendorID, psFunctionIndex=psFunctionIndex, advantechCommonMIB=advantechCommonMIB, sysDescr=sysDescr, atMgmt=atMgmt, advantech=advantech, sysImageVersion=sysImageVersion, snmpTrapSrvPort=snmpTrapSrvPort, psDisplayName=psDisplayName, psDeviceIndex=psDeviceIndex, sysModuleID=sysModuleID, snmpTrapSrvTable=snmpTrapSrvTable, psModuleType=psModuleType, snmpTrapVersion=snmpTrapVersion, psIndex=psIndex, pciConfigObj=pciConfigObj, psDescr=psDescr, psBaseAddress=psBaseAddress, psLength=psLength, snmpTrapSrvIndex=snmpTrapSrvIndex, psManufacturer=psManufacturer, atSystem=atSystem, sysFirstBootTime=sysFirstBootTime, sysBootTime=sysBootTime, snmpTrapSrvObj=snmpTrapSrvObj, psIRQ=psIRQ, snmpTrapSrvEntry=snmpTrapSrvEntry)
