...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysImageVersion=sysImageVersion, atMgmt=atMgmt, psFunctionIndex=psFunctionIndex, psLength=psLength, psManufacturer=psManufacturer, atPciConfig=atPciConfig, advantech=advantech, psIndex=psIndex, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvObj=snmpTrapSrvObj, pciSlotTable=pciSlotTable, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysDeviceName=sysDeviceName, sysBootCount=sysBootCount, psDescr=psDescr, psDeviceIndex=psDeviceIndex, psDeviceID=psDeviceID, snmpTrapSrvPort=snmpTrapSrvPort, psState=psState, psModulePorts=psModulePorts, sysDescr=sysDescr, psBaseAddress=psBaseAddress, sysModuleID=sysModuleID, snmpTrapSrvIndex=snmpTrapSrvIndex, psModuleType=psModuleType, pciConfigObj=pciConfigObj, snmpTrapSrvEntry=snmpTrapSrvEntry, psLocation=psLocation, psDisplayName=psDisplayName, snmpTrapSrvIP=snmpTrapSrvIP, psClassCode=psClassCode, psBusIndex=psBusIndex, psSubsysDeviceID=psSubsysDeviceID, atSystem=atSystem, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psVendorID=psVendorID, advantechCommonMIB=advantechCommonMIB, psSubsysVendorID=psSubsysVendorID, sysReleaseDate=sysReleaseDate, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvTable=snmpTrapSrvTable, sysBootTime=sysBootTime, psNumber=psNumber, psIRQ=psIRQ, pciSlotEntry=pciSlotEntry)
