...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psNumber=psNumber, psDescr=psDescr, psBusIndex=psBusIndex, sysBootTime=sysBootTime, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvIP=snmpTrapSrvIP, psLocation=psLocation, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvEntry=snmpTrapSrvEntry, psBaseAddress=psBaseAddress, sysDescr=sysDescr, psSubsysVendorID=psSubsysVendorID, sysFirstBootTime=sysFirstBootTime, psDisplayName=psDisplayName, pciConfigObj=pciConfigObj, PYSNMP_MODULE_ID=advantechCommonMIB, sysBootCount=sysBootCount, snmpTrapVersion=snmpTrapVersion, atPciConfig=atPciConfig, snmpTrapSrvPort=snmpTrapSrvPort, psSubsysDeviceID=psSubsysDeviceID, sysDeviceName=sysDeviceName, psFunctionIndex=psFunctionIndex, atMgmt=atMgmt, psIndex=psIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, advantech=advantech, pciSlotEntry=pciSlotEntry, psModuleType=psModuleType, psModulePorts=psModulePorts, psManufacturer=psManufacturer, pciSlotTable=pciSlotTable, psClassCode=psClassCode, snmpTrapSrvTable=snmpTrapSrvTable, psIRQ=psIRQ, sysImageVersion=sysImageVersion, atSystem=atSystem, psLength=psLength, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psVendorID=psVendorID, psDeviceID=psDeviceID, psState=psState, sysReleaseDate=sysReleaseDate, psDeviceIndex=psDeviceIndex, sysModuleID=sysModuleID)
