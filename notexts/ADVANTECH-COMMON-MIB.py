...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvCommunity=snmpTrapSrvCommunity, psBusIndex=psBusIndex, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvIndex=snmpTrapSrvIndex, psFunctionIndex=psFunctionIndex, snmpTrapVersion=snmpTrapVersion, psDisplayName=psDisplayName, atMgmt=atMgmt, sysFirstBootTime=sysFirstBootTime, pciSlotEntry=pciSlotEntry, psState=psState, psNumber=psNumber, sysDescr=sysDescr, snmpTrapSrvEntry=snmpTrapSrvEntry, psClassCode=psClassCode, atPciConfig=atPciConfig, sysImageVersion=sysImageVersion, atSystem=atSystem, snmpTrapSrvIP=snmpTrapSrvIP, sysModuleID=sysModuleID, psModulePorts=psModulePorts, pciSlotTable=pciSlotTable, psIndex=psIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psLength=psLength, psBaseAddress=psBaseAddress, sysBootTime=sysBootTime, snmpTrapSrvObj=snmpTrapSrvObj, sysDeviceName=sysDeviceName, pciConfigObj=pciConfigObj, psVendorID=psVendorID, sysReleaseDate=sysReleaseDate, psLocation=psLocation, advantechCommonMIB=advantechCommonMIB, psDeviceIndex=psDeviceIndex, psDescr=psDescr, psIRQ=psIRQ, snmpTrapSrvNumber=snmpTrapSrvNumber, psManufacturer=psManufacturer, snmpTrapSrvTable=snmpTrapSrvTable, advantech=advantech, snmpTrapSrvPort=snmpTrapSrvPort, PYSNMP_MODULE_ID=advantechCommonMIB, psDeviceID=psDeviceID, psModuleType=psModuleType, psSubsysVendorID=psSubsysVendorID, sysBootCount=sysBootCount)
