...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysDeviceName=sysDeviceName, PYSNMP_MODULE_ID=advantechCommonMIB, psClassCode=psClassCode, psBaseAddress=psBaseAddress, atPciConfig=atPciConfig, psDisplayName=psDisplayName, psDeviceID=psDeviceID, psIndex=psIndex, psModuleType=psModuleType, sysDescr=sysDescr, psState=psState, psModulePorts=psModulePorts, atSystem=atSystem, snmpTrapSrvEntry=snmpTrapSrvEntry, psBusIndex=psBusIndex, sysBootTime=sysBootTime, snmpTrapSrvObj=snmpTrapSrvObj, sysModuleID=sysModuleID, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvIndex=snmpTrapSrvIndex, sysReleaseDate=sysReleaseDate, psSubsysVendorID=psSubsysVendorID, psDeviceIndex=psDeviceIndex, psSubsysDeviceID=psSubsysDeviceID, pciConfigObj=pciConfigObj, psDescr=psDescr, snmpTrapVersion=snmpTrapVersion, psNumber=psNumber, sysBootCount=sysBootCount, psVendorID=psVendorID, snmpTrapSrvIP=snmpTrapSrvIP, psManufacturer=psManufacturer, advantechCommonMIB=advantechCommonMIB, atMgmt=atMgmt, sysFirstBootTime=sysFirstBootTime, psLength=psLength, psLocation=psLocation, sysImageVersion=sysImageVersion, pciSlotTable=pciSlotTable, psIRQ=psIRQ, snmpTrapSrvTable=snmpTrapSrvTable, pciSlotEntry=pciSlotEntry, snmpTrapSrvCommunity=snmpTrapSrvCommunity, advantech=advantech, psFunctionIndex=psFunctionIndex)
