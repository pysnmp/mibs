...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psIRQ=psIRQ, psDisplayName=psDisplayName, PYSNMP_MODULE_ID=advantechCommonMIB, sysDescr=sysDescr, pciConfigObj=pciConfigObj, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvCommunity=snmpTrapSrvCommunity, pciSlotEntry=pciSlotEntry, psBusIndex=psBusIndex, sysImageVersion=sysImageVersion, sysBootCount=sysBootCount, psDescr=psDescr, psVendorID=psVendorID, snmpTrapSrvNumber=snmpTrapSrvNumber, pciSlotTable=pciSlotTable, atPciConfig=atPciConfig, atSystem=atSystem, psSubsysDeviceID=psSubsysDeviceID, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvObj=snmpTrapSrvObj, psDeviceIndex=psDeviceIndex, snmpTrapVersion=snmpTrapVersion, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvEntry=snmpTrapSrvEntry, advantech=advantech, psBaseAddress=psBaseAddress, sysDeviceName=sysDeviceName, psManufacturer=psManufacturer, psLength=psLength, psIndex=psIndex, psFunctionIndex=psFunctionIndex, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psDeviceID=psDeviceID, psModulePorts=psModulePorts, snmpTrapSrvIP=snmpTrapSrvIP, psNumber=psNumber, sysModuleID=sysModuleID, sysBootTime=sysBootTime, psState=psState, psClassCode=psClassCode, psLocation=psLocation, sysReleaseDate=sysReleaseDate, atMgmt=atMgmt, psModuleType=psModuleType)
