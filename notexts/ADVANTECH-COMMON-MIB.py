...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psState=psState, pciConfigObj=pciConfigObj, snmpTrapSrvNumber=snmpTrapSrvNumber, psBaseAddress=psBaseAddress, sysBootTime=sysBootTime, pciSlotEntry=pciSlotEntry, sysModuleID=sysModuleID, sysBootCount=sysBootCount, psIRQ=psIRQ, psModulePorts=psModulePorts, sysDeviceName=sysDeviceName, atMgmt=atMgmt, snmpTrapSrvPort=snmpTrapSrvPort, psDescr=psDescr, atSystem=atSystem, snmpTrapSrvIndex=snmpTrapSrvIndex, psDisplayName=psDisplayName, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapVersion=snmpTrapVersion, psModuleType=psModuleType, psVendorID=psVendorID, psDeviceID=psDeviceID, pciSlotTable=pciSlotTable, psLength=psLength, psNumber=psNumber, psLocation=psLocation, snmpTrapSrvObj=snmpTrapSrvObj, psDeviceIndex=psDeviceIndex, atPciConfig=atPciConfig, sysImageVersion=sysImageVersion, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvEntry=snmpTrapSrvEntry, psIndex=psIndex, snmpTrapSrvTable=snmpTrapSrvTable, psManufacturer=psManufacturer, sysFirstBootTime=sysFirstBootTime, psFunctionIndex=psFunctionIndex, sysDescr=sysDescr, advantech=advantech, psClassCode=psClassCode, snmpTrapSrvIP=snmpTrapSrvIP, psBusIndex=psBusIndex, sysReleaseDate=sysReleaseDate, advantechCommonMIB=advantechCommonMIB, PYSNMP_MODULE_ID=advantechCommonMIB)
