...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, pciSlotTable=pciSlotTable, psDisplayName=psDisplayName, sysBootCount=sysBootCount, psManufacturer=psManufacturer, psState=psState, snmpTrapSrvNumber=snmpTrapSrvNumber, advantech=advantech, snmpTrapSrvIP=snmpTrapSrvIP, psModulePorts=psModulePorts, advantechCommonMIB=advantechCommonMIB, sysReleaseDate=sysReleaseDate, psModuleType=psModuleType, atPciConfig=atPciConfig, snmpTrapSrvTable=snmpTrapSrvTable, pciConfigObj=pciConfigObj, psClassCode=psClassCode, snmpTrapSrvCommunity=snmpTrapSrvCommunity, pciSlotEntry=pciSlotEntry, psSubsysDeviceID=psSubsysDeviceID, psBaseAddress=psBaseAddress, psBusIndex=psBusIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, sysImageVersion=sysImageVersion, sysBootTime=sysBootTime, atMgmt=atMgmt, snmpTrapSrvObj=snmpTrapSrvObj, sysDeviceName=sysDeviceName, psVendorID=psVendorID, psIndex=psIndex, psDescr=psDescr, atSystem=atSystem, psDeviceID=psDeviceID, psLength=psLength, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapVersion=snmpTrapVersion, psLocation=psLocation, sysModuleID=sysModuleID, psFunctionIndex=psFunctionIndex, psSubsysVendorID=psSubsysVendorID, psNumber=psNumber, sysDescr=sysDescr, snmpTrapSrvIndex=snmpTrapSrvIndex, psIRQ=psIRQ, psDeviceIndex=psDeviceIndex, sysFirstBootTime=sysFirstBootTime)
