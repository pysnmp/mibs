...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psFunctionIndex=psFunctionIndex, snmpTrapSrvIndex=snmpTrapSrvIndex, pciConfigObj=pciConfigObj, psClassCode=psClassCode, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvObj=snmpTrapSrvObj, sysDeviceName=sysDeviceName, psManufacturer=psManufacturer, snmpTrapSrvNumber=snmpTrapSrvNumber, psLocation=psLocation, sysReleaseDate=sysReleaseDate, snmpTrapSrvPort=snmpTrapSrvPort, sysFirstBootTime=sysFirstBootTime, sysImageVersion=sysImageVersion, psModuleType=psModuleType, snmpTrapSrvIP=snmpTrapSrvIP, atSystem=atSystem, advantech=advantech, psDeviceIndex=psDeviceIndex, pciSlotTable=pciSlotTable, pciSlotEntry=pciSlotEntry, psBusIndex=psBusIndex, PYSNMP_MODULE_ID=advantechCommonMIB, psNumber=psNumber, psModulePorts=psModulePorts, sysBootCount=sysBootCount, psIRQ=psIRQ, psSubsysVendorID=psSubsysVendorID, psState=psState, psDisplayName=psDisplayName, snmpTrapSrvTable=snmpTrapSrvTable, psDescr=psDescr, atPciConfig=atPciConfig, psDeviceID=psDeviceID, sysBootTime=sysBootTime, psIndex=psIndex, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psVendorID=psVendorID, sysModuleID=sysModuleID, atMgmt=atMgmt, psSubsysDeviceID=psSubsysDeviceID, sysDescr=sysDescr, psLength=psLength, psBaseAddress=psBaseAddress, snmpTrapSrvEntry=snmpTrapSrvEntry)
