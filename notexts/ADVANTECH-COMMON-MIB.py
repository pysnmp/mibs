...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psDeviceIndex=psDeviceIndex, snmpTrapSrvIP=snmpTrapSrvIP, advantech=advantech, advantechCommonMIB=advantechCommonMIB, pciSlotEntry=pciSlotEntry, psDeviceID=psDeviceID, sysFirstBootTime=sysFirstBootTime, pciConfigObj=pciConfigObj, snmpTrapVersion=snmpTrapVersion, psIndex=psIndex, psVendorID=psVendorID, psManufacturer=psManufacturer, psNumber=psNumber, pciSlotTable=pciSlotTable, psDescr=psDescr, psSubsysVendorID=psSubsysVendorID, sysDescr=sysDescr, psModulePorts=psModulePorts, atPciConfig=atPciConfig, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvEntry=snmpTrapSrvEntry, psDisplayName=psDisplayName, psLocation=psLocation, snmpTrapSrvNumber=snmpTrapSrvNumber, psState=psState, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysBootTime=sysBootTime, psModuleType=psModuleType, psLength=psLength, sysModuleID=sysModuleID, sysBootCount=sysBootCount, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvCommunity=snmpTrapSrvCommunity, atSystem=atSystem, sysDeviceName=sysDeviceName, snmpTrapSrvObj=snmpTrapSrvObj, psFunctionIndex=psFunctionIndex, atMgmt=atMgmt, psClassCode=psClassCode, snmpTrapSrvIndex=snmpTrapSrvIndex, psBaseAddress=psBaseAddress, sysReleaseDate=sysReleaseDate, psIRQ=psIRQ, psBusIndex=psBusIndex, sysImageVersion=sysImageVersion, PYSNMP_MODULE_ID=advantechCommonMIB, psSubsysDeviceID=psSubsysDeviceID)
