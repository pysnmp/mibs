...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", advantech=advantech, sysDescr=sysDescr, psBaseAddress=psBaseAddress, sysReleaseDate=sysReleaseDate, sysBootCount=sysBootCount, snmpTrapSrvIP=snmpTrapSrvIP, pciConfigObj=pciConfigObj, pciSlotEntry=pciSlotEntry, sysDeviceName=sysDeviceName, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psNumber=psNumber, psState=psState, snmpTrapSrvIndex=snmpTrapSrvIndex, psModuleType=psModuleType, psClassCode=psClassCode, psModulePorts=psModulePorts, snmpTrapSrvObj=snmpTrapSrvObj, pciSlotTable=pciSlotTable, psDeviceID=psDeviceID, psBusIndex=psBusIndex, psLength=psLength, snmpTrapSrvEntry=snmpTrapSrvEntry, psDisplayName=psDisplayName, psSubsysVendorID=psSubsysVendorID, atSystem=atSystem, snmpTrapSrvNumber=snmpTrapSrvNumber, psIndex=psIndex, PYSNMP_MODULE_ID=advantechCommonMIB, sysBootTime=sysBootTime, psSubsysDeviceID=psSubsysDeviceID, atMgmt=atMgmt, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psDescr=psDescr, psFunctionIndex=psFunctionIndex, sysImageVersion=sysImageVersion, snmpTrapSrvPort=snmpTrapSrvPort, psDeviceIndex=psDeviceIndex, psVendorID=psVendorID, psManufacturer=psManufacturer, advantechCommonMIB=advantechCommonMIB, atPciConfig=atPciConfig, sysModuleID=sysModuleID, snmpTrapSrvTable=snmpTrapSrvTable, psLocation=psLocation, sysFirstBootTime=sysFirstBootTime, psIRQ=psIRQ)
