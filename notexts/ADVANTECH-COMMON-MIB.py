...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvIP=snmpTrapSrvIP, psBaseAddress=psBaseAddress, psDisplayName=psDisplayName, psManufacturer=psManufacturer, psIndex=psIndex, psVendorID=psVendorID, pciSlotTable=pciSlotTable, sysReleaseDate=sysReleaseDate, sysModuleID=sysModuleID, sysFirstBootTime=sysFirstBootTime, psSubsysVendorID=psSubsysVendorID, sysImageVersion=sysImageVersion, psState=psState, snmpTrapSrvPort=snmpTrapSrvPort, psLength=psLength, sysBootTime=sysBootTime, psClassCode=psClassCode, psSubsysDeviceID=psSubsysDeviceID, PYSNMP_MODULE_ID=advantechCommonMIB, psLocation=psLocation, atMgmt=atMgmt, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapVersion=snmpTrapVersion, psDeviceID=psDeviceID, psBusIndex=psBusIndex, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvEntry=snmpTrapSrvEntry, psFunctionIndex=psFunctionIndex, psIRQ=psIRQ, advantech=advantech, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvTable=snmpTrapSrvTable, atSystem=atSystem, pciConfigObj=pciConfigObj, pciSlotEntry=pciSlotEntry, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psModuleType=psModuleType, psModulePorts=psModulePorts, psNumber=psNumber, psDeviceIndex=psDeviceIndex, sysDeviceName=sysDeviceName, psDescr=psDescr, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysBootCount=sysBootCount, sysDescr=sysDescr, atPciConfig=atPciConfig)
