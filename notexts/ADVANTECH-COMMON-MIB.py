...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, atMgmt=atMgmt, snmpTrapSrvPort=snmpTrapSrvPort, psDeviceID=psDeviceID, psFunctionIndex=psFunctionIndex, psSubsysDeviceID=psSubsysDeviceID, advantech=advantech, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvIndex=snmpTrapSrvIndex, sysDeviceName=sysDeviceName, sysFirstBootTime=sysFirstBootTime, psVendorID=psVendorID, psDeviceIndex=psDeviceIndex, psBusIndex=psBusIndex, pciSlotEntry=pciSlotEntry, psDisplayName=psDisplayName, snmpTrapSrvObj=snmpTrapSrvObj, pciSlotTable=pciSlotTable, psManufacturer=psManufacturer, snmpTrapSrvEntry=snmpTrapSrvEntry, sysDescr=sysDescr, psLength=psLength, psBaseAddress=psBaseAddress, pciConfigObj=pciConfigObj, atPciConfig=atPciConfig, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psNumber=psNumber, atSystem=atSystem, sysReleaseDate=sysReleaseDate, psIndex=psIndex, snmpTrapSrvNumber=snmpTrapSrvNumber, advantechCommonMIB=advantechCommonMIB, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvIP=snmpTrapSrvIP, psClassCode=psClassCode, psState=psState, PYSNMP_MODULE_ID=advantechCommonMIB, sysBootTime=sysBootTime, psLocation=psLocation, psDescr=psDescr, psIRQ=psIRQ, sysImageVersion=sysImageVersion, psModuleType=psModuleType, snmpTrapSrvTable=snmpTrapSrvTable, psModulePorts=psModulePorts, sysBootCount=sysBootCount, sysModuleID=sysModuleID)
