...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psLength=psLength, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, pciConfigObj=pciConfigObj, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psState=psState, pciSlotTable=pciSlotTable, psDeviceIndex=psDeviceIndex, psModuleType=psModuleType, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvObj=snmpTrapSrvObj, sysImageVersion=sysImageVersion, atSystem=atSystem, sysReleaseDate=sysReleaseDate, psLocation=psLocation, psIRQ=psIRQ, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvPort=snmpTrapSrvPort, psNumber=psNumber, psBusIndex=psBusIndex, psFunctionIndex=psFunctionIndex, snmpTrapSrvTable=snmpTrapSrvTable, psManufacturer=psManufacturer, sysModuleID=sysModuleID, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvNumber=snmpTrapSrvNumber, advantechCommonMIB=advantechCommonMIB, psVendorID=psVendorID, snmpTrapSrvIndex=snmpTrapSrvIndex, psBaseAddress=psBaseAddress, atPciConfig=atPciConfig, psDisplayName=psDisplayName, sysDescr=sysDescr, sysBootTime=sysBootTime, psDescr=psDescr, snmpTrapSrvEntry=snmpTrapSrvEntry, psDeviceID=psDeviceID, psIndex=psIndex, psSubsysVendorID=psSubsysVendorID, advantech=advantech, sysDeviceName=sysDeviceName, sysBootCount=sysBootCount, PYSNMP_MODULE_ID=advantechCommonMIB, psSubsysDeviceID=psSubsysDeviceID, atMgmt=atMgmt, psModulePorts=psModulePorts, pciSlotEntry=pciSlotEntry, psClassCode=psClassCode)
