...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psDescr=psDescr, snmpTrapSrvPort=snmpTrapSrvPort, psDeviceIndex=psDeviceIndex, psClassCode=psClassCode, psSubsysVendorID=psSubsysVendorID, sysModuleID=sysModuleID, snmpTrapVersion=snmpTrapVersion, sysBootTime=sysBootTime, atMgmt=atMgmt, psBaseAddress=psBaseAddress, pciSlotTable=pciSlotTable, psIRQ=psIRQ, snmpTrapSrvTable=snmpTrapSrvTable, sysDescr=sysDescr, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvIP=snmpTrapSrvIP, psFunctionIndex=psFunctionIndex, sysDeviceName=sysDeviceName, advantech=advantech, psNumber=psNumber, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psSubsysDeviceID=psSubsysDeviceID, psDisplayName=psDisplayName, psLocation=psLocation, sysBootCount=sysBootCount, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvEntry=snmpTrapSrvEntry, sysReleaseDate=sysReleaseDate, snmpTrapSrvIndex=snmpTrapSrvIndex, psDeviceID=psDeviceID, psIndex=psIndex, psLength=psLength, psModuleType=psModuleType, atSystem=atSystem, pciSlotEntry=pciSlotEntry, sysImageVersion=sysImageVersion, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psManufacturer=psManufacturer, advantechCommonMIB=advantechCommonMIB, psModulePorts=psModulePorts, psState=psState, pciConfigObj=pciConfigObj, psVendorID=psVendorID, atPciConfig=atPciConfig, snmpTrapSrvObj=snmpTrapSrvObj, psBusIndex=psBusIndex, sysFirstBootTime=sysFirstBootTime)
