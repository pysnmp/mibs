...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psFunctionIndex=psFunctionIndex, psModulePorts=psModulePorts, sysDescr=sysDescr, advantech=advantech, sysImageVersion=sysImageVersion, sysReleaseDate=sysReleaseDate, snmpTrapSrvIP=snmpTrapSrvIP, psLocation=psLocation, atPciConfig=atPciConfig, snmpTrapSrvObj=snmpTrapSrvObj, psBaseAddress=psBaseAddress, psDeviceIndex=psDeviceIndex, psLength=psLength, psModuleType=psModuleType, pciSlotTable=pciSlotTable, snmpTrapSrvPort=snmpTrapSrvPort, psIndex=psIndex, pciSlotEntry=pciSlotEntry, sysFirstBootTime=sysFirstBootTime, psIRQ=psIRQ, PYSNMP_MODULE_ID=advantechCommonMIB, psSubsysVendorID=psSubsysVendorID, pciConfigObj=pciConfigObj, snmpTrapSrvIndex=snmpTrapSrvIndex, sysDeviceName=sysDeviceName, sysBootTime=sysBootTime, psState=psState, advantechCommonMIB=advantechCommonMIB, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psManufacturer=psManufacturer, psClassCode=psClassCode, psBusIndex=psBusIndex, atSystem=atSystem, psVendorID=psVendorID, psDeviceID=psDeviceID, snmpTrapSrvNumber=snmpTrapSrvNumber, psNumber=psNumber, atMgmt=atMgmt, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psDisplayName=psDisplayName, sysModuleID=sysModuleID, psDescr=psDescr, sysBootCount=sysBootCount, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapVersion=snmpTrapVersion)
