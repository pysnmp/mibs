...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psBusIndex=psBusIndex, psLength=psLength, pciSlotTable=pciSlotTable, psSubsysVendorID=psSubsysVendorID, sysImageVersion=sysImageVersion, pciConfigObj=pciConfigObj, snmpTrapSrvEntry=snmpTrapSrvEntry, PYSNMP_MODULE_ID=advantechCommonMIB, atSystem=atSystem, sysBootTime=sysBootTime, psState=psState, sysDeviceName=sysDeviceName, sysReleaseDate=sysReleaseDate, advantechCommonMIB=advantechCommonMIB, psDeviceID=psDeviceID, atMgmt=atMgmt, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvTable=snmpTrapSrvTable, sysModuleID=sysModuleID, snmpTrapSrvNumber=snmpTrapSrvNumber, psClassCode=psClassCode, atPciConfig=atPciConfig, psFunctionIndex=psFunctionIndex, snmpTrapSrvObj=snmpTrapSrvObj, psLocation=psLocation, snmpTrapVersion=snmpTrapVersion, psIndex=psIndex, snmpTrapSrvPort=snmpTrapSrvPort, psVendorID=psVendorID, psBaseAddress=psBaseAddress, snmpTrapSrvIndex=snmpTrapSrvIndex, psManufacturer=psManufacturer, psDescr=psDescr, psModulePorts=psModulePorts, snmpTrapSrvIP=snmpTrapSrvIP, psNumber=psNumber, sysDescr=sysDescr, pciSlotEntry=pciSlotEntry, psDisplayName=psDisplayName, psModuleType=psModuleType, sysBootCount=sysBootCount, psIRQ=psIRQ, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysFirstBootTime=sysFirstBootTime, advantech=advantech, psDeviceIndex=psDeviceIndex)
