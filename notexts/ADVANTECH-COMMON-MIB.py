...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysImageVersion=sysImageVersion, pciConfigObj=pciConfigObj, atPciConfig=atPciConfig, psIRQ=psIRQ, psDisplayName=psDisplayName, sysModuleID=sysModuleID, psLocation=psLocation, psSubsysDeviceID=psSubsysDeviceID, sysFirstBootTime=sysFirstBootTime, sysDescr=sysDescr, snmpTrapSrvCommunity=snmpTrapSrvCommunity, pciSlotTable=pciSlotTable, psManufacturer=psManufacturer, psNumber=psNumber, psBaseAddress=psBaseAddress, pciSlotEntry=pciSlotEntry, psIndex=psIndex, psVendorID=psVendorID, sysDeviceName=sysDeviceName, psClassCode=psClassCode, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvPort=snmpTrapSrvPort, PYSNMP_MODULE_ID=advantechCommonMIB, advantech=advantech, sysBootCount=sysBootCount, psDeviceID=psDeviceID, psState=psState, snmpTrapVersion=snmpTrapVersion, atMgmt=atMgmt, psDeviceIndex=psDeviceIndex, advantechCommonMIB=advantechCommonMIB, psDescr=psDescr, sysBootTime=sysBootTime, sysReleaseDate=sysReleaseDate, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvIP=snmpTrapSrvIP, psSubsysVendorID=psSubsysVendorID, psModuleType=psModuleType, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psFunctionIndex=psFunctionIndex, psBusIndex=psBusIndex, atSystem=atSystem, psModulePorts=psModulePorts, snmpTrapSrvNumber=snmpTrapSrvNumber, psLength=psLength)
