...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", PYSNMP_MODULE_ID=advantechCommonMIB, psModuleType=psModuleType, snmpTrapSrvIP=snmpTrapSrvIP, atSystem=atSystem, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psVendorID=psVendorID, psDeviceID=psDeviceID, sysDescr=sysDescr, psDescr=psDescr, psSubsysVendorID=psSubsysVendorID, psLength=psLength, sysDeviceName=sysDeviceName, psIRQ=psIRQ, sysReleaseDate=sysReleaseDate, psNumber=psNumber, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvIndex=snmpTrapSrvIndex, sysFirstBootTime=sysFirstBootTime, atPciConfig=atPciConfig, snmpTrapSrvEntry=snmpTrapSrvEntry, pciConfigObj=pciConfigObj, pciSlotTable=pciSlotTable, snmpTrapSrvObj=snmpTrapSrvObj, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvPort=snmpTrapSrvPort, advantech=advantech, sysBootCount=sysBootCount, psClassCode=psClassCode, atMgmt=atMgmt, psModulePorts=psModulePorts, snmpTrapSrvNumber=snmpTrapSrvNumber, psSubsysDeviceID=psSubsysDeviceID, psLocation=psLocation, psBaseAddress=psBaseAddress, psIndex=psIndex, psManufacturer=psManufacturer, snmpTrapSrvTable=snmpTrapSrvTable, pciSlotEntry=pciSlotEntry, psState=psState, sysBootTime=sysBootTime, sysModuleID=sysModuleID, snmpTrapVersion=snmpTrapVersion, psDeviceIndex=psDeviceIndex, psDisplayName=psDisplayName, sysImageVersion=sysImageVersion, psFunctionIndex=psFunctionIndex, psBusIndex=psBusIndex)
