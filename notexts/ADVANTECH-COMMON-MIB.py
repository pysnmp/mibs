...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psFunctionIndex=psFunctionIndex, PYSNMP_MODULE_ID=advantechCommonMIB, psSubsysVendorID=psSubsysVendorID, psClassCode=psClassCode, psManufacturer=psManufacturer, psNumber=psNumber, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, pciConfigObj=pciConfigObj, psDisplayName=psDisplayName, snmpTrapSrvPort=snmpTrapSrvPort, psState=psState, psDeviceID=psDeviceID, sysFirstBootTime=sysFirstBootTime, sysDescr=sysDescr, atSystem=atSystem, psLocation=psLocation, psModuleType=psModuleType, psLength=psLength, sysReleaseDate=sysReleaseDate, snmpTrapSrvTable=snmpTrapSrvTable, sysImageVersion=sysImageVersion, psIndex=psIndex, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvEntry=snmpTrapSrvEntry, psModulePorts=psModulePorts, advantech=advantech, sysBootCount=sysBootCount, advantechCommonMIB=advantechCommonMIB, pciSlotEntry=pciSlotEntry, psBusIndex=psBusIndex, psBaseAddress=psBaseAddress, sysBootTime=sysBootTime, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psDescr=psDescr, snmpTrapVersion=snmpTrapVersion, sysModuleID=sysModuleID, sysDeviceName=sysDeviceName, pciSlotTable=pciSlotTable, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvIP=snmpTrapSrvIP, psIRQ=psIRQ, atMgmt=atMgmt, psDeviceIndex=psDeviceIndex, psVendorID=psVendorID, snmpTrapSrvNumber=snmpTrapSrvNumber, psSubsysDeviceID=psSubsysDeviceID, atPciConfig=atPciConfig)
