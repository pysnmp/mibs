...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psFunctionIndex=psFunctionIndex, psVendorID=psVendorID, psDescr=psDescr, sysDescr=sysDescr, atMgmt=atMgmt, pciSlotTable=pciSlotTable, psIRQ=psIRQ, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvPort=snmpTrapSrvPort, psBusIndex=psBusIndex, snmpTrapSrvIndex=snmpTrapSrvIndex, atSystem=atSystem, pciSlotEntry=pciSlotEntry, psBaseAddress=psBaseAddress, sysReleaseDate=sysReleaseDate, snmpTrapVersion=snmpTrapVersion, psManufacturer=psManufacturer, psModuleType=psModuleType, advantechCommonMIB=advantechCommonMIB, psDeviceID=psDeviceID, sysImageVersion=sysImageVersion, psSubsysVendorID=psSubsysVendorID, psState=psState, psSubsysDeviceID=psSubsysDeviceID, sysModuleID=sysModuleID, sysBootTime=sysBootTime, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, pciConfigObj=pciConfigObj, snmpTrapSrvTable=snmpTrapSrvTable, psDeviceIndex=psDeviceIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvObj=snmpTrapSrvObj, atPciConfig=atPciConfig, sysDeviceName=sysDeviceName, psLocation=psLocation, sysFirstBootTime=sysFirstBootTime, psModulePorts=psModulePorts, psNumber=psNumber, psLength=psLength, psClassCode=psClassCode, advantech=advantech, sysBootCount=sysBootCount, psIndex=psIndex, psDisplayName=psDisplayName, PYSNMP_MODULE_ID=advantechCommonMIB)
