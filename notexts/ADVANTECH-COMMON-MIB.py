...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysDescr=sysDescr, snmpTrapSrvObj=snmpTrapSrvObj, psDeviceIndex=psDeviceIndex, psModuleType=psModuleType, advantech=advantech, snmpTrapSrvEntry=snmpTrapSrvEntry, pciSlotEntry=pciSlotEntry, sysBootCount=sysBootCount, psState=psState, pciSlotTable=pciSlotTable, sysReleaseDate=sysReleaseDate, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvCommunity=snmpTrapSrvCommunity, advantechCommonMIB=advantechCommonMIB, psVendorID=psVendorID, snmpTrapSrvPort=snmpTrapSrvPort, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapVersion=snmpTrapVersion, psDisplayName=psDisplayName, atMgmt=atMgmt, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psLocation=psLocation, atPciConfig=atPciConfig, snmpTrapSrvNumber=snmpTrapSrvNumber, psDeviceID=psDeviceID, psLength=psLength, sysModuleID=sysModuleID, sysDeviceName=sysDeviceName, psClassCode=psClassCode, psNumber=psNumber, psModulePorts=psModulePorts, psDescr=psDescr, atSystem=atSystem, pciConfigObj=pciConfigObj, sysImageVersion=sysImageVersion, snmpTrapSrvTable=snmpTrapSrvTable, psBusIndex=psBusIndex, psBaseAddress=psBaseAddress, psIndex=psIndex, psIRQ=psIRQ, psFunctionIndex=psFunctionIndex, psSubsysDeviceID=psSubsysDeviceID, psManufacturer=psManufacturer, sysBootTime=sysBootTime)
