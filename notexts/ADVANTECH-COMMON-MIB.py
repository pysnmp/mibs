...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysModuleID=sysModuleID, psIRQ=psIRQ, psManufacturer=psManufacturer, pciSlotEntry=pciSlotEntry, advantech=advantech, psSubsysDeviceID=psSubsysDeviceID, PYSNMP_MODULE_ID=advantechCommonMIB, psFunctionIndex=psFunctionIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psLocation=psLocation, atSystem=atSystem, psDeviceID=psDeviceID, snmpTrapSrvPort=snmpTrapSrvPort, sysDescr=sysDescr, atMgmt=atMgmt, psDeviceIndex=psDeviceIndex, sysImageVersion=sysImageVersion, sysBootTime=sysBootTime, psModuleType=psModuleType, sysBootCount=sysBootCount, psModulePorts=psModulePorts, sysFirstBootTime=sysFirstBootTime, psClassCode=psClassCode, psVendorID=psVendorID, psIndex=psIndex, psBaseAddress=psBaseAddress, snmpTrapSrvTable=snmpTrapSrvTable, psState=psState, snmpTrapVersion=snmpTrapVersion, psBusIndex=psBusIndex, atPciConfig=atPciConfig, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvIP=snmpTrapSrvIP, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvEntry=snmpTrapSrvEntry, sysReleaseDate=sysReleaseDate, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysDeviceName=sysDeviceName, psSubsysVendorID=psSubsysVendorID, psLength=psLength, pciConfigObj=pciConfigObj, psDescr=psDescr, pciSlotTable=pciSlotTable, psNumber=psNumber, snmpTrapSrvObj=snmpTrapSrvObj, psDisplayName=psDisplayName)
