...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysBootTime=sysBootTime, psBusIndex=psBusIndex, atSystem=atSystem, sysModuleID=sysModuleID, sysDeviceName=sysDeviceName, atMgmt=atMgmt, PYSNMP_MODULE_ID=advantechCommonMIB, psModuleType=psModuleType, psFunctionIndex=psFunctionIndex, psDeviceID=psDeviceID, snmpTrapSrvTable=snmpTrapSrvTable, sysDescr=sysDescr, snmpTrapSrvNumber=snmpTrapSrvNumber, psVendorID=psVendorID, psIRQ=psIRQ, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, pciSlotTable=pciSlotTable, psIndex=psIndex, psBaseAddress=psBaseAddress, snmpTrapSrvIndex=snmpTrapSrvIndex, atPciConfig=atPciConfig, psNumber=psNumber, sysBootCount=sysBootCount, pciConfigObj=pciConfigObj, psDescr=psDescr, sysReleaseDate=sysReleaseDate, psSubsysDeviceID=psSubsysDeviceID, psState=psState, psLocation=psLocation, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysImageVersion=sysImageVersion, psDeviceIndex=psDeviceIndex, psClassCode=psClassCode, snmpTrapVersion=snmpTrapVersion, advantech=advantech, psSubsysVendorID=psSubsysVendorID, psManufacturer=psManufacturer, psLength=psLength, pciSlotEntry=pciSlotEntry, psDisplayName=psDisplayName, sysFirstBootTime=sysFirstBootTime, psModulePorts=psModulePorts, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvPort=snmpTrapSrvPort)
