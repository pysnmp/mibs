...
Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter64, Counter32, Unsigned32, iso, ModuleIdentity, MibIdentifier, NotificationType, TimeTicks, enterprises, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter64", "Counter32", "Unsigned32", "iso", "ModuleIdentity", "MibIdentifier", "NotificationType", "TimeTicks", "enterprises", "Bits", "Integer32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psDescr=psDescr, snmpTrapSrvTable=snmpTrapSrvTable, psFunctionIndex=psFunctionIndex, psBaseAddress=psBaseAddress, psDeviceIndex=psDeviceIndex, snmpTrapSrvPort=snmpTrapSrvPort, atSystem=atSystem, psLength=psLength, pciConfigObj=pciConfigObj, sysImageVersion=sysImageVersion, psIRQ=psIRQ, sysReleaseDate=sysReleaseDate, psIndex=psIndex, psModulePorts=psModulePorts, psNumber=psNumber, sysDescr=sysDescr, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvIP=snmpTrapSrvIP, sysBootCount=sysBootCount, psClassCode=psClassCode, pciSlotTable=pciSlotTable, advantech=advantech, psVendorID=psVendorID, atPciConfig=atPciConfig, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvObj=snmpTrapSrvObj, pciSlotEntry=pciSlotEntry, psBusIndex=psBusIndex, psSubsysDeviceID=psSubsysDeviceID, psLocation=psLocation, psModuleType=psModuleType, sysBootTime=sysBootTime, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psManufacturer=psManufacturer, atMgmt=atMgmt, psSubsysVendorID=psSubsysVendorID, sysModuleID=sysModuleID, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvEntry=snmpTrapSrvEntry, psDeviceID=psDeviceID, sysFirstBootTime=sysFirstBootTime, snmpTrapVersion=snmpTrapVersion, psDisplayName=psDisplayName, sysDeviceName=sysDeviceName, snmpTrapSrvNumber=snmpTrapSrvNumber, psState=psState)
