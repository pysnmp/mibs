...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvNumber=snmpTrapSrvNumber, psBaseAddress=psBaseAddress, psModulePorts=psModulePorts, psBusIndex=psBusIndex, snmpTrapSrvObj=snmpTrapSrvObj, psDescr=psDescr, sysBootTime=sysBootTime, snmpTrapSrvCommunity=snmpTrapSrvCommunity, atSystem=atSystem, pciSlotEntry=pciSlotEntry, psDeviceID=psDeviceID, psLocation=psLocation, psDisplayName=psDisplayName, PYSNMP_MODULE_ID=advantechCommonMIB, sysDeviceName=sysDeviceName, sysImageVersion=sysImageVersion, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvPort=snmpTrapSrvPort, psSubsysVendorID=psSubsysVendorID, psClassCode=psClassCode, snmpTrapSrvEntry=snmpTrapSrvEntry, sysDescr=sysDescr, psLength=psLength, psModuleType=psModuleType, psDeviceIndex=psDeviceIndex, psSubsysDeviceID=psSubsysDeviceID, atMgmt=atMgmt, snmpTrapSrvIndex=snmpTrapSrvIndex, advantechCommonMIB=advantechCommonMIB, advantech=advantech, psState=psState, pciSlotTable=pciSlotTable, psFunctionIndex=psFunctionIndex, atPciConfig=atPciConfig, sysReleaseDate=sysReleaseDate, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvTable=snmpTrapSrvTable, psIRQ=psIRQ, psVendorID=psVendorID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, pciConfigObj=pciConfigObj, snmpTrapVersion=snmpTrapVersion, psIndex=psIndex, psManufacturer=psManufacturer, sysModuleID=sysModuleID, sysBootCount=sysBootCount, psNumber=psNumber)
