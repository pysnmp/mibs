...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psIndex=psIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvObj=snmpTrapSrvObj, sysDescr=sysDescr, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapVersion=snmpTrapVersion, psDisplayName=psDisplayName, psModuleType=psModuleType, psClassCode=psClassCode, pciSlotTable=pciSlotTable, sysBootCount=sysBootCount, snmpTrapSrvIndex=snmpTrapSrvIndex, psDeviceIndex=psDeviceIndex, sysReleaseDate=sysReleaseDate, psVendorID=psVendorID, psIRQ=psIRQ, pciConfigObj=pciConfigObj, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysImageVersion=sysImageVersion, psNumber=psNumber, psLength=psLength, psSubsysDeviceID=psSubsysDeviceID, advantech=advantech, sysDeviceName=sysDeviceName, atMgmt=atMgmt, atSystem=atSystem, psModulePorts=psModulePorts, psLocation=psLocation, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvPort=snmpTrapSrvPort, psDeviceID=psDeviceID, snmpTrapSrvEntry=snmpTrapSrvEntry, sysBootTime=sysBootTime, pciSlotEntry=pciSlotEntry, advantechCommonMIB=advantechCommonMIB, atPciConfig=atPciConfig, psDescr=psDescr, sysModuleID=sysModuleID, psState=psState, psBaseAddress=psBaseAddress, psManufacturer=psManufacturer, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvIP=snmpTrapSrvIP, sysFirstBootTime=sysFirstBootTime, psFunctionIndex=psFunctionIndex, psBusIndex=psBusIndex)
