...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psManufacturer=psManufacturer, psState=psState, psIRQ=psIRQ, psFunctionIndex=psFunctionIndex, pciSlotTable=pciSlotTable, psDescr=psDescr, atSystem=atSystem, psNumber=psNumber, psIndex=psIndex, psVendorID=psVendorID, psModuleType=psModuleType, sysDeviceName=sysDeviceName, sysBootCount=sysBootCount, psDeviceID=psDeviceID, psSubsysDeviceID=psSubsysDeviceID, pciConfigObj=pciConfigObj, psLength=psLength, snmpTrapSrvNumber=snmpTrapSrvNumber, sysReleaseDate=sysReleaseDate, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvIP=snmpTrapSrvIP, psClassCode=psClassCode, atPciConfig=atPciConfig, psModulePorts=psModulePorts, sysBootTime=sysBootTime, psBusIndex=psBusIndex, atMgmt=atMgmt, advantech=advantech, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvIndex=snmpTrapSrvIndex, advantechCommonMIB=advantechCommonMIB, PYSNMP_MODULE_ID=advantechCommonMIB, psDisplayName=psDisplayName, snmpTrapSrvEntry=snmpTrapSrvEntry, psDeviceIndex=psDeviceIndex, sysDescr=sysDescr, psLocation=psLocation, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvPort=snmpTrapSrvPort, psBaseAddress=psBaseAddress, snmpTrapSrvTable=snmpTrapSrvTable, pciSlotEntry=pciSlotEntry, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysModuleID=sysModuleID, snmpTrapVersion=snmpTrapVersion, sysImageVersion=sysImageVersion, snmpTrapSrvObj=snmpTrapSrvObj)
