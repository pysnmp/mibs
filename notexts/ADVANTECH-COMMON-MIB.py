...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psDeviceIndex=psDeviceIndex, psIndex=psIndex, snmpTrapSrvNumber=snmpTrapSrvNumber, psModulePorts=psModulePorts, PYSNMP_MODULE_ID=advantechCommonMIB, psDisplayName=psDisplayName, atMgmt=atMgmt, psBusIndex=psBusIndex, psDescr=psDescr, snmpTrapSrvEntry=snmpTrapSrvEntry, pciSlotTable=pciSlotTable, psNumber=psNumber, psManufacturer=psManufacturer, atSystem=atSystem, sysImageVersion=sysImageVersion, psClassCode=psClassCode, sysDeviceName=sysDeviceName, psFunctionIndex=psFunctionIndex, sysModuleID=sysModuleID, psModuleType=psModuleType, psLength=psLength, advantechCommonMIB=advantechCommonMIB, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvPort=snmpTrapSrvPort, sysBootCount=sysBootCount, pciSlotEntry=pciSlotEntry, atPciConfig=atPciConfig, snmpTrapSrvCommunity=snmpTrapSrvCommunity, advantech=advantech, psState=psState, psDeviceID=psDeviceID, snmpTrapSrvObj=snmpTrapSrvObj, psBaseAddress=psBaseAddress, sysReleaseDate=sysReleaseDate, sysFirstBootTime=sysFirstBootTime, psVendorID=psVendorID, snmpTrapSrvIP=snmpTrapSrvIP, psLocation=psLocation, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvTable=snmpTrapSrvTable, pciConfigObj=pciConfigObj, psSubsysVendorID=psSubsysVendorID, psIRQ=psIRQ, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvIndex=snmpTrapSrvIndex, sysBootTime=sysBootTime, sysDescr=sysDescr)
