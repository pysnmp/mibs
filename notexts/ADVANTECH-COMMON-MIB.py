...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvTable=snmpTrapSrvTable, psSubsysVendorID=psSubsysVendorID, psBusIndex=psBusIndex, psLength=psLength, snmpTrapSrvEntry=snmpTrapSrvEntry, PYSNMP_MODULE_ID=advantechCommonMIB, atPciConfig=atPciConfig, sysImageVersion=sysImageVersion, sysFirstBootTime=sysFirstBootTime, pciSlotTable=pciSlotTable, sysDeviceName=sysDeviceName, sysBootCount=sysBootCount, pciConfigObj=pciConfigObj, psState=psState, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvIP=snmpTrapSrvIP, psModuleType=psModuleType, sysBootTime=sysBootTime, psDescr=psDescr, psDeviceID=psDeviceID, atMgmt=atMgmt, sysDescr=sysDescr, psSubsysDeviceID=psSubsysDeviceID, sysReleaseDate=sysReleaseDate, psNumber=psNumber, psLocation=psLocation, psBaseAddress=psBaseAddress, pciSlotEntry=pciSlotEntry, sysModuleID=sysModuleID, atSystem=atSystem, psDeviceIndex=psDeviceIndex, snmpTrapSrvObj=snmpTrapSrvObj, psIRQ=psIRQ, psIndex=psIndex, psClassCode=psClassCode, psDisplayName=psDisplayName, psFunctionIndex=psFunctionIndex, snmpTrapSrvPort=snmpTrapSrvPort, psModulePorts=psModulePorts, psVendorID=psVendorID, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapVersion=snmpTrapVersion, psManufacturer=psManufacturer, advantechCommonMIB=advantechCommonMIB, advantech=advantech)
