...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psModuleType=psModuleType, sysModuleID=sysModuleID, snmpTrapSrvObj=snmpTrapSrvObj, psClassCode=psClassCode, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysFirstBootTime=sysFirstBootTime, sysBootTime=sysBootTime, sysDescr=sysDescr, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvPort=snmpTrapSrvPort, psLocation=psLocation, psDescr=psDescr, PYSNMP_MODULE_ID=advantechCommonMIB, psNumber=psNumber, snmpTrapSrvIP=snmpTrapSrvIP, psSubsysVendorID=psSubsysVendorID, sysBootCount=sysBootCount, advantechCommonMIB=advantechCommonMIB, atMgmt=atMgmt, sysReleaseDate=sysReleaseDate, sysDeviceName=sysDeviceName, psManufacturer=psManufacturer, pciSlotTable=pciSlotTable, atSystem=atSystem, psIRQ=psIRQ, psBusIndex=psBusIndex, psIndex=psIndex, atPciConfig=atPciConfig, snmpTrapSrvTable=snmpTrapSrvTable, psVendorID=psVendorID, psDeviceIndex=psDeviceIndex, psLength=psLength, psBaseAddress=psBaseAddress, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapVersion=snmpTrapVersion, psModulePorts=psModulePorts, advantech=advantech, psFunctionIndex=psFunctionIndex, psDisplayName=psDisplayName, pciSlotEntry=pciSlotEntry, psState=psState, snmpTrapSrvNumber=snmpTrapSrvNumber, psDeviceID=psDeviceID, pciConfigObj=pciConfigObj, sysImageVersion=sysImageVersion)
