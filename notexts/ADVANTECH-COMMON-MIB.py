...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psState=psState, psVendorID=psVendorID, psModuleType=psModuleType, psDisplayName=psDisplayName, advantech=advantech, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvCommunity=snmpTrapSrvCommunity, atMgmt=atMgmt, psDescr=psDescr, psSubsysVendorID=psSubsysVendorID, sysDescr=sysDescr, pciConfigObj=pciConfigObj, atPciConfig=atPciConfig, atSystem=atSystem, sysReleaseDate=sysReleaseDate, psDeviceID=psDeviceID, psLocation=psLocation, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvTable=snmpTrapSrvTable, psIndex=psIndex, psFunctionIndex=psFunctionIndex, psManufacturer=psManufacturer, psLength=psLength, psIRQ=psIRQ, snmpTrapSrvNumber=snmpTrapSrvNumber, psModulePorts=psModulePorts, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvEntry=snmpTrapSrvEntry, sysImageVersion=sysImageVersion, snmpTrapSrvIP=snmpTrapSrvIP, psDeviceIndex=psDeviceIndex, psSubsysDeviceID=psSubsysDeviceID, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvPort=snmpTrapSrvPort, sysBootTime=sysBootTime, pciSlotEntry=pciSlotEntry, sysBootCount=sysBootCount, psNumber=psNumber, psClassCode=psClassCode, PYSNMP_MODULE_ID=advantechCommonMIB, psBaseAddress=psBaseAddress, snmpTrapSrvIndex=snmpTrapSrvIndex, sysModuleID=sysModuleID, sysDeviceName=sysDeviceName, snmpTrapSrvObj=snmpTrapSrvObj, psBusIndex=psBusIndex, pciSlotTable=pciSlotTable)
