...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psDescr=psDescr, psClassCode=psClassCode, psVendorID=psVendorID, PYSNMP_MODULE_ID=advantechCommonMIB, sysDescr=sysDescr, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psDisplayName=psDisplayName, psModuleType=psModuleType, psModulePorts=psModulePorts, snmpTrapSrvTable=snmpTrapSrvTable, psIndex=psIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, psIRQ=psIRQ, pciSlotEntry=pciSlotEntry, psLength=psLength, advantech=advantech, atMgmt=atMgmt, atSystem=atSystem, psBaseAddress=psBaseAddress, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvObj=snmpTrapSrvObj, sysModuleID=sysModuleID, sysDeviceName=sysDeviceName, psState=psState, sysBootCount=sysBootCount, psDeviceID=psDeviceID, sysBootTime=sysBootTime, psSubsysVendorID=psSubsysVendorID, advantechCommonMIB=advantechCommonMIB, pciSlotTable=pciSlotTable, snmpTrapSrvPort=snmpTrapSrvPort, psDeviceIndex=psDeviceIndex, psLocation=psLocation, pciConfigObj=pciConfigObj, sysImageVersion=sysImageVersion, sysFirstBootTime=sysFirstBootTime, sysReleaseDate=sysReleaseDate, psBusIndex=psBusIndex, psManufacturer=psManufacturer, snmpTrapSrvIndex=snmpTrapSrvIndex, atPciConfig=atPciConfig, snmpTrapSrvNumber=snmpTrapSrvNumber, psFunctionIndex=psFunctionIndex, snmpTrapVersion=snmpTrapVersion, psNumber=psNumber)
