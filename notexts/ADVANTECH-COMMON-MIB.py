...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", PYSNMP_MODULE_ID=advantechCommonMIB, sysFirstBootTime=sysFirstBootTime, psSubsysDeviceID=psSubsysDeviceID, psBaseAddress=psBaseAddress, psNumber=psNumber, atSystem=atSystem, sysDescr=sysDescr, psFunctionIndex=psFunctionIndex, sysReleaseDate=sysReleaseDate, pciSlotTable=pciSlotTable, psClassCode=psClassCode, advantech=advantech, psLocation=psLocation, snmpTrapSrvObj=snmpTrapSrvObj, pciConfigObj=pciConfigObj, psModulePorts=psModulePorts, psDeviceID=psDeviceID, snmpTrapSrvPort=snmpTrapSrvPort, sysBootTime=sysBootTime, psDisplayName=psDisplayName, snmpTrapSrvEntry=snmpTrapSrvEntry, psLength=psLength, psModuleType=psModuleType, sysDeviceName=sysDeviceName, sysImageVersion=sysImageVersion, atMgmt=atMgmt, pciSlotEntry=pciSlotEntry, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvNumber=snmpTrapSrvNumber, psIndex=psIndex, psState=psState, snmpTrapSrvIP=snmpTrapSrvIP, psIRQ=psIRQ, advantechCommonMIB=advantechCommonMIB, sysModuleID=sysModuleID, psDeviceIndex=psDeviceIndex, psVendorID=psVendorID, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psManufacturer=psManufacturer, psBusIndex=psBusIndex, sysBootCount=sysBootCount, atPciConfig=atPciConfig, snmpTrapSrvTable=snmpTrapSrvTable, psDescr=psDescr, snmpTrapSrvIndex=snmpTrapSrvIndex)
