...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvPort=snmpTrapSrvPort, sysBootTime=sysBootTime, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvIP=snmpTrapSrvIP, psDisplayName=psDisplayName, psIRQ=psIRQ, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapVersion=snmpTrapVersion, psNumber=psNumber, psModuleType=psModuleType, snmpTrapSrvEntry=snmpTrapSrvEntry, pciSlotEntry=pciSlotEntry, psDeviceIndex=psDeviceIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysBootCount=sysBootCount, psClassCode=psClassCode, sysReleaseDate=sysReleaseDate, psModulePorts=psModulePorts, sysModuleID=sysModuleID, psSubsysDeviceID=psSubsysDeviceID, atSystem=atSystem, psIndex=psIndex, psState=psState, sysDescr=sysDescr, psLength=psLength, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysImageVersion=sysImageVersion, advantech=advantech, atMgmt=atMgmt, psBaseAddress=psBaseAddress, advantechCommonMIB=advantechCommonMIB, psDescr=psDescr, PYSNMP_MODULE_ID=advantechCommonMIB, pciSlotTable=pciSlotTable, sysDeviceName=sysDeviceName, atPciConfig=atPciConfig, psFunctionIndex=psFunctionIndex, psManufacturer=psManufacturer, snmpTrapSrvTable=snmpTrapSrvTable, pciConfigObj=pciConfigObj, psBusIndex=psBusIndex, psLocation=psLocation, psSubsysVendorID=psSubsysVendorID, psDeviceID=psDeviceID, sysFirstBootTime=sysFirstBootTime, psVendorID=psVendorID)
