...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysModuleID=sysModuleID, psManufacturer=psManufacturer, psBusIndex=psBusIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psFunctionIndex=psFunctionIndex, pciSlotTable=pciSlotTable, psBaseAddress=psBaseAddress, psDisplayName=psDisplayName, psVendorID=psVendorID, psNumber=psNumber, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvNumber=snmpTrapSrvNumber, pciSlotEntry=pciSlotEntry, psDeviceID=psDeviceID, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvEntry=snmpTrapSrvEntry, sysBootCount=sysBootCount, pciConfigObj=pciConfigObj, psIRQ=psIRQ, sysImageVersion=sysImageVersion, psState=psState, atMgmt=atMgmt, psSubsysVendorID=psSubsysVendorID, psIndex=psIndex, atPciConfig=atPciConfig, snmpTrapVersion=snmpTrapVersion, psDescr=psDescr, sysReleaseDate=sysReleaseDate, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvIP=snmpTrapSrvIP, psModulePorts=psModulePorts, sysFirstBootTime=sysFirstBootTime, psDeviceIndex=psDeviceIndex, psLength=psLength, psClassCode=psClassCode, psModuleType=psModuleType, atSystem=atSystem, snmpTrapSrvPort=snmpTrapSrvPort, sysBootTime=sysBootTime, psLocation=psLocation, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvIndex=snmpTrapSrvIndex, sysDeviceName=sysDeviceName, PYSNMP_MODULE_ID=advantechCommonMIB, sysDescr=sysDescr, advantech=advantech)
