...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psBaseAddress=psBaseAddress, psManufacturer=psManufacturer, psBusIndex=psBusIndex, psVendorID=psVendorID, snmpTrapSrvNumber=snmpTrapSrvNumber, sysImageVersion=sysImageVersion, psClassCode=psClassCode, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvPort=snmpTrapSrvPort, pciSlotEntry=pciSlotEntry, psDeviceIndex=psDeviceIndex, psSubsysDeviceID=psSubsysDeviceID, sysModuleID=sysModuleID, snmpTrapSrvObj=snmpTrapSrvObj, psState=psState, sysDeviceName=sysDeviceName, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvIndex=snmpTrapSrvIndex, psModuleType=psModuleType, PYSNMP_MODULE_ID=advantechCommonMIB, sysBootTime=sysBootTime, psIRQ=psIRQ, psDeviceID=psDeviceID, psLength=psLength, psIndex=psIndex, sysFirstBootTime=sysFirstBootTime, psSubsysVendorID=psSubsysVendorID, atMgmt=atMgmt, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvTable=snmpTrapSrvTable, psNumber=psNumber, psFunctionIndex=psFunctionIndex, atSystem=atSystem, psDescr=psDescr, pciConfigObj=pciConfigObj, sysBootCount=sysBootCount, atPciConfig=atPciConfig, psLocation=psLocation, advantech=advantech, psDisplayName=psDisplayName, pciSlotTable=pciSlotTable, psModulePorts=psModulePorts, sysReleaseDate=sysReleaseDate, snmpTrapSrvIP=snmpTrapSrvIP, sysDescr=sysDescr)
