...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psSubsysDeviceID=psSubsysDeviceID, sysDescr=sysDescr, psDisplayName=psDisplayName, psDescr=psDescr, psModulePorts=psModulePorts, psManufacturer=psManufacturer, sysBootCount=sysBootCount, psSubsysVendorID=psSubsysVendorID, psDeviceIndex=psDeviceIndex, advantechCommonMIB=advantechCommonMIB, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psIndex=psIndex, psLength=psLength, pciSlotTable=pciSlotTable, psIRQ=psIRQ, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvTable=snmpTrapSrvTable, pciSlotEntry=pciSlotEntry, psModuleType=psModuleType, psVendorID=psVendorID, atMgmt=atMgmt, psClassCode=psClassCode, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psLocation=psLocation, sysDeviceName=sysDeviceName, sysImageVersion=sysImageVersion, snmpTrapSrvEntry=snmpTrapSrvEntry, psFunctionIndex=psFunctionIndex, psDeviceID=psDeviceID, psBaseAddress=psBaseAddress, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapVersion=snmpTrapVersion, pciConfigObj=pciConfigObj, psState=psState, sysModuleID=sysModuleID, psNumber=psNumber, sysBootTime=sysBootTime, snmpTrapSrvObj=snmpTrapSrvObj, psBusIndex=psBusIndex, advantech=advantech, atPciConfig=atPciConfig, atSystem=atSystem, sysReleaseDate=sysReleaseDate, snmpTrapSrvIP=snmpTrapSrvIP)
