...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ModuleIdentity, IpAddress, Gauge32, enterprises, ObjectIdentity, Counter32, iso, Bits, MibIdentifier, TimeTicks, Integer32, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ModuleIdentity", "IpAddress", "Gauge32", "enterprises", "ObjectIdentity", "Counter32", "iso", "Bits", "MibIdentifier", "TimeTicks", "Integer32", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysDeviceName=sysDeviceName, sysImageVersion=sysImageVersion, sysModuleID=sysModuleID, psFunctionIndex=psFunctionIndex, psNumber=psNumber, psLocation=psLocation, snmpTrapSrvEntry=snmpTrapSrvEntry, psModuleType=psModuleType, advantech=advantech, snmpTrapSrvNumber=snmpTrapSrvNumber, psModulePorts=psModulePorts, sysFirstBootTime=sysFirstBootTime, psDeviceID=psDeviceID, snmpTrapSrvObj=snmpTrapSrvObj, pciConfigObj=pciConfigObj, psIRQ=psIRQ, psDescr=psDescr, psManufacturer=psManufacturer, pciSlotTable=pciSlotTable, psDisplayName=psDisplayName, pciSlotEntry=pciSlotEntry, psSubsysDeviceID=psSubsysDeviceID, psLength=psLength, snmpTrapSrvPort=snmpTrapSrvPort, psClassCode=psClassCode, sysBootCount=sysBootCount, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvIP=snmpTrapSrvIP, sysReleaseDate=sysReleaseDate, psDeviceIndex=psDeviceIndex, psIndex=psIndex, snmpTrapVersion=snmpTrapVersion, atMgmt=atMgmt, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psVendorID=psVendorID, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvIndex=snmpTrapSrvIndex, sysBootTime=sysBootTime, atSystem=atSystem, atPciConfig=atPciConfig, snmpTrapSrvTable=snmpTrapSrvTable, sysDescr=sysDescr, psBusIndex=psBusIndex, psState=psState, advantechCommonMIB=advantechCommonMIB, psBaseAddress=psBaseAddress, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication)
