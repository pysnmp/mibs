...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psIndex=psIndex, psSubsysDeviceID=psSubsysDeviceID, psModulePorts=psModulePorts, psClassCode=psClassCode, pciSlotEntry=pciSlotEntry, advantech=advantech, sysDescr=sysDescr, psFunctionIndex=psFunctionIndex, psNumber=psNumber, psBaseAddress=psBaseAddress, psIRQ=psIRQ, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvPort=snmpTrapSrvPort, psDisplayName=psDisplayName, snmpTrapSrvTable=snmpTrapSrvTable, psVendorID=psVendorID, psSubsysVendorID=psSubsysVendorID, pciConfigObj=pciConfigObj, psLocation=psLocation, psLength=psLength, sysBootCount=sysBootCount, sysImageVersion=sysImageVersion, advantechCommonMIB=advantechCommonMIB, sysFirstBootTime=sysFirstBootTime, psDescr=psDescr, snmpTrapSrvIndex=snmpTrapSrvIndex, psDeviceID=psDeviceID, snmpTrapSrvIP=snmpTrapSrvIP, sysDeviceName=sysDeviceName, atMgmt=atMgmt, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psManufacturer=psManufacturer, snmpTrapSrvEntry=snmpTrapSrvEntry, atSystem=atSystem, sysBootTime=sysBootTime, pciSlotTable=pciSlotTable, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psState=psState, sysReleaseDate=sysReleaseDate, snmpTrapSrvObj=snmpTrapSrvObj, sysModuleID=sysModuleID, psModuleType=psModuleType, psBusIndex=psBusIndex, atPciConfig=atPciConfig, psDeviceIndex=psDeviceIndex)
