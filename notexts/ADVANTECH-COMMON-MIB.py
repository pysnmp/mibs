...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psClassCode=psClassCode, sysDeviceName=sysDeviceName, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvObj=snmpTrapSrvObj, psDescr=psDescr, psManufacturer=psManufacturer, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvTable=snmpTrapSrvTable, atSystem=atSystem, snmpTrapSrvEntry=snmpTrapSrvEntry, pciSlotTable=pciSlotTable, atPciConfig=atPciConfig, snmpTrapVersion=snmpTrapVersion, pciSlotEntry=pciSlotEntry, pciConfigObj=pciConfigObj, sysBootCount=sysBootCount, psDeviceID=psDeviceID, psLength=psLength, psModuleType=psModuleType, psVendorID=psVendorID, psBusIndex=psBusIndex, psIndex=psIndex, sysModuleID=sysModuleID, psDeviceIndex=psDeviceIndex, psIRQ=psIRQ, psState=psState, psFunctionIndex=psFunctionIndex, snmpTrapSrvIP=snmpTrapSrvIP, psBaseAddress=psBaseAddress, PYSNMP_MODULE_ID=advantechCommonMIB, psModulePorts=psModulePorts, psDisplayName=psDisplayName, psNumber=psNumber, atMgmt=atMgmt, sysDescr=sysDescr, sysBootTime=sysBootTime, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvPort=snmpTrapSrvPort, sysImageVersion=sysImageVersion, advantechCommonMIB=advantechCommonMIB, advantech=advantech, snmpTrapSrvNumber=snmpTrapSrvNumber, psLocation=psLocation, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psSubsysVendorID=psSubsysVendorID, sysReleaseDate=sysReleaseDate)
