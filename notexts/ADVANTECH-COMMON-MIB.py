...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvIP=snmpTrapSrvIP, sysDeviceName=sysDeviceName, snmpTrapSrvEntry=snmpTrapSrvEntry, psVendorID=psVendorID, psDeviceIndex=psDeviceIndex, sysImageVersion=sysImageVersion, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, pciSlotTable=pciSlotTable, sysBootCount=sysBootCount, snmpTrapSrvPort=snmpTrapSrvPort, psDescr=psDescr, PYSNMP_MODULE_ID=advantechCommonMIB, atMgmt=atMgmt, sysFirstBootTime=sysFirstBootTime, psState=psState, psBusIndex=psBusIndex, psSubsysDeviceID=psSubsysDeviceID, snmpTrapVersion=snmpTrapVersion, atPciConfig=atPciConfig, snmpTrapSrvObj=snmpTrapSrvObj, atSystem=atSystem, psFunctionIndex=psFunctionIndex, psDeviceID=psDeviceID, psSubsysVendorID=psSubsysVendorID, psNumber=psNumber, psModulePorts=psModulePorts, snmpTrapSrvTable=snmpTrapSrvTable, psManufacturer=psManufacturer, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psBaseAddress=psBaseAddress, psLength=psLength, advantech=advantech, snmpTrapSrvIndex=snmpTrapSrvIndex, psLocation=psLocation, psClassCode=psClassCode, psModuleType=psModuleType, advantechCommonMIB=advantechCommonMIB, psIRQ=psIRQ, sysModuleID=sysModuleID, pciSlotEntry=pciSlotEntry, sysReleaseDate=sysReleaseDate, pciConfigObj=pciConfigObj, sysBootTime=sysBootTime, sysDescr=sysDescr, psDisplayName=psDisplayName, psIndex=psIndex, snmpTrapSrvNumber=snmpTrapSrvNumber)
