...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", pciSlotEntry=pciSlotEntry, snmpTrapSrvObj=snmpTrapSrvObj, psIndex=psIndex, psState=psState, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvIndex=snmpTrapSrvIndex, sysBootTime=sysBootTime, snmpTrapSrvPort=snmpTrapSrvPort, psNumber=psNumber, psClassCode=psClassCode, psBaseAddress=psBaseAddress, psIRQ=psIRQ, snmpTrapSrvIP=snmpTrapSrvIP, sysReleaseDate=sysReleaseDate, psDeviceIndex=psDeviceIndex, psDeviceID=psDeviceID, PYSNMP_MODULE_ID=advantechCommonMIB, psModulePorts=psModulePorts, snmpTrapSrvEntry=snmpTrapSrvEntry, psManufacturer=psManufacturer, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvNumber=snmpTrapSrvNumber, pciConfigObj=pciConfigObj, psDisplayName=psDisplayName, psLength=psLength, psSubsysDeviceID=psSubsysDeviceID, sysFirstBootTime=sysFirstBootTime, snmpTrapVersion=snmpTrapVersion, psModuleType=psModuleType, atMgmt=atMgmt, sysDeviceName=sysDeviceName, psBusIndex=psBusIndex, atPciConfig=atPciConfig, advantech=advantech, sysModuleID=sysModuleID, advantechCommonMIB=advantechCommonMIB, sysDescr=sysDescr, pciSlotTable=pciSlotTable, sysBootCount=sysBootCount, atSystem=atSystem, sysImageVersion=sysImageVersion, psVendorID=psVendorID, psSubsysVendorID=psSubsysVendorID, psLocation=psLocation, psFunctionIndex=psFunctionIndex, psDescr=psDescr, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication)
