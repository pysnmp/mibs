...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psDescr=psDescr, psManufacturer=psManufacturer, snmpTrapSrvObj=snmpTrapSrvObj, sysBootCount=sysBootCount, snmpTrapSrvCommunity=snmpTrapSrvCommunity, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapVersion=snmpTrapVersion, psState=psState, psFunctionIndex=psFunctionIndex, sysImageVersion=sysImageVersion, pciConfigObj=pciConfigObj, snmpTrapSrvPort=snmpTrapSrvPort, atMgmt=atMgmt, sysReleaseDate=sysReleaseDate, snmpTrapSrvTable=snmpTrapSrvTable, psIRQ=psIRQ, psModuleType=psModuleType, psNumber=psNumber, atSystem=atSystem, psDisplayName=psDisplayName, psIndex=psIndex, advantech=advantech, pciSlotTable=pciSlotTable, psDeviceIndex=psDeviceIndex, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvNumber=snmpTrapSrvNumber, sysDeviceName=sysDeviceName, pciSlotEntry=pciSlotEntry, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvIndex=snmpTrapSrvIndex, psBusIndex=psBusIndex, psModulePorts=psModulePorts, psLength=psLength, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psSubsysVendorID=psSubsysVendorID, sysDescr=sysDescr, sysBootTime=sysBootTime, psDeviceID=psDeviceID, sysFirstBootTime=sysFirstBootTime, psBaseAddress=psBaseAddress, psClassCode=psClassCode, psLocation=psLocation, sysModuleID=sysModuleID, atPciConfig=atPciConfig, psVendorID=psVendorID)
