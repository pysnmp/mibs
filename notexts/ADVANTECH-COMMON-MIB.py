...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvTable=snmpTrapSrvTable, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvNumber=snmpTrapSrvNumber, psState=psState, psSubsysDeviceID=psSubsysDeviceID, snmpTrapVersion=snmpTrapVersion, psDisplayName=psDisplayName, sysReleaseDate=sysReleaseDate, sysDescr=sysDescr, pciSlotEntry=pciSlotEntry, sysBootCount=sysBootCount, sysImageVersion=sysImageVersion, psBaseAddress=psBaseAddress, advantech=advantech, atPciConfig=atPciConfig, psBusIndex=psBusIndex, psDeviceID=psDeviceID, atSystem=atSystem, psDeviceIndex=psDeviceIndex, psClassCode=psClassCode, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysFirstBootTime=sysFirstBootTime, psModuleType=psModuleType, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvIP=snmpTrapSrvIP, psIndex=psIndex, psNumber=psNumber, psLength=psLength, snmpTrapSrvIndex=snmpTrapSrvIndex, pciConfigObj=pciConfigObj, psIRQ=psIRQ, snmpTrapSrvPort=snmpTrapSrvPort, psManufacturer=psManufacturer, psModulePorts=psModulePorts, advantechCommonMIB=advantechCommonMIB, sysModuleID=sysModuleID, pciSlotTable=pciSlotTable, psFunctionIndex=psFunctionIndex, psVendorID=psVendorID, sysDeviceName=sysDeviceName, psSubsysVendorID=psSubsysVendorID, atMgmt=atMgmt, psLocation=psLocation, sysBootTime=sysBootTime, psDescr=psDescr)
