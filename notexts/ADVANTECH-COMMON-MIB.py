...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysDescr=sysDescr, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvTable=snmpTrapSrvTable, atSystem=atSystem, psIndex=psIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvEntry=snmpTrapSrvEntry, psState=psState, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psLocation=psLocation, snmpTrapVersion=snmpTrapVersion, sysReleaseDate=sysReleaseDate, advantech=advantech, atPciConfig=atPciConfig, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvPort=snmpTrapSrvPort, psModulePorts=psModulePorts, psDeviceIndex=psDeviceIndex, sysImageVersion=sysImageVersion, sysBootCount=sysBootCount, psModuleType=psModuleType, psSubsysVendorID=psSubsysVendorID, psBaseAddress=psBaseAddress, pciSlotTable=pciSlotTable, psIRQ=psIRQ, sysFirstBootTime=sysFirstBootTime, pciConfigObj=pciConfigObj, psBusIndex=psBusIndex, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvNumber=snmpTrapSrvNumber, sysDeviceName=sysDeviceName, PYSNMP_MODULE_ID=advantechCommonMIB, psNumber=psNumber, psFunctionIndex=psFunctionIndex, psDisplayName=psDisplayName, snmpTrapSrvIP=snmpTrapSrvIP, psClassCode=psClassCode, advantechCommonMIB=advantechCommonMIB, psVendorID=psVendorID, psLength=psLength, sysModuleID=sysModuleID, psDescr=psDescr, sysBootTime=sysBootTime, atMgmt=atMgmt, psManufacturer=psManufacturer, pciSlotEntry=pciSlotEntry, psDeviceID=psDeviceID)
