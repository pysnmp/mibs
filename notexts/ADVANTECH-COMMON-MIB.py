...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psFunctionIndex=psFunctionIndex, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvCommunity=snmpTrapSrvCommunity, pciSlotTable=pciSlotTable, sysModuleID=sysModuleID, psDeviceID=psDeviceID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, atMgmt=atMgmt, sysDeviceName=sysDeviceName, PYSNMP_MODULE_ID=advantechCommonMIB, psBusIndex=psBusIndex, psDisplayName=psDisplayName, advantech=advantech, psLength=psLength, psSubsysDeviceID=psSubsysDeviceID, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvIndex=snmpTrapSrvIndex, psClassCode=psClassCode, psBaseAddress=psBaseAddress, sysBootTime=sysBootTime, snmpTrapSrvObj=snmpTrapSrvObj, psDeviceIndex=psDeviceIndex, snmpTrapSrvPort=snmpTrapSrvPort, atSystem=atSystem, psDescr=psDescr, atPciConfig=atPciConfig, snmpTrapSrvIP=snmpTrapSrvIP, sysBootCount=sysBootCount, psVendorID=psVendorID, psIndex=psIndex, sysReleaseDate=sysReleaseDate, psManufacturer=psManufacturer, sysDescr=sysDescr, snmpTrapSrvEntry=snmpTrapSrvEntry, psNumber=psNumber, psSubsysVendorID=psSubsysVendorID, pciSlotEntry=pciSlotEntry, snmpTrapSrvNumber=snmpTrapSrvNumber, psModulePorts=psModulePorts, advantechCommonMIB=advantechCommonMIB, pciConfigObj=pciConfigObj, psLocation=psLocation, psIRQ=psIRQ, sysImageVersion=sysImageVersion, psState=psState, snmpTrapSrvTable=snmpTrapSrvTable, psModuleType=psModuleType)
