...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysModuleID=sysModuleID, sysImageVersion=sysImageVersion, psDeviceIndex=psDeviceIndex, psManufacturer=psManufacturer, sysFirstBootTime=sysFirstBootTime, psIndex=psIndex, psDeviceID=psDeviceID, snmpTrapSrvTable=snmpTrapSrvTable, psSubsysDeviceID=psSubsysDeviceID, pciSlotEntry=pciSlotEntry, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysDescr=sysDescr, psState=psState, PYSNMP_MODULE_ID=advantechCommonMIB, sysDeviceName=sysDeviceName, advantech=advantech, psFunctionIndex=psFunctionIndex, sysReleaseDate=sysReleaseDate, psModulePorts=psModulePorts, psVendorID=psVendorID, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvPort=snmpTrapSrvPort, atPciConfig=atPciConfig, psIRQ=psIRQ, pciConfigObj=pciConfigObj, pciSlotTable=pciSlotTable, psBaseAddress=psBaseAddress, snmpTrapSrvNumber=snmpTrapSrvNumber, atSystem=atSystem, sysBootCount=sysBootCount, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvIndex=snmpTrapSrvIndex, psDisplayName=psDisplayName, psClassCode=psClassCode, psLocation=psLocation, psLength=psLength, atMgmt=atMgmt, snmpTrapSrvIP=snmpTrapSrvIP, psNumber=psNumber, psDescr=psDescr, psBusIndex=psBusIndex, sysBootTime=sysBootTime, psModuleType=psModuleType, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapVersion=snmpTrapVersion, advantechCommonMIB=advantechCommonMIB)
