...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysImageVersion=sysImageVersion, psClassCode=psClassCode, snmpTrapSrvObj=snmpTrapSrvObj, psManufacturer=psManufacturer, snmpTrapSrvNumber=snmpTrapSrvNumber, pciConfigObj=pciConfigObj, snmpTrapSrvPort=snmpTrapSrvPort, psDisplayName=psDisplayName, sysModuleID=sysModuleID, atPciConfig=atPciConfig, psDeviceID=psDeviceID, sysReleaseDate=sysReleaseDate, sysBootTime=sysBootTime, psVendorID=psVendorID, sysBootCount=sysBootCount, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psDescr=psDescr, psFunctionIndex=psFunctionIndex, atMgmt=atMgmt, atSystem=atSystem, psModulePorts=psModulePorts, psIRQ=psIRQ, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvIP=snmpTrapSrvIP, psDeviceIndex=psDeviceIndex, pciSlotTable=pciSlotTable, psBaseAddress=psBaseAddress, sysDescr=sysDescr, psNumber=psNumber, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvTable=snmpTrapSrvTable, psIndex=psIndex, snmpTrapSrvIndex=snmpTrapSrvIndex, psModuleType=psModuleType, psBusIndex=psBusIndex, sysDeviceName=sysDeviceName, sysFirstBootTime=sysFirstBootTime, pciSlotEntry=pciSlotEntry, psSubsysDeviceID=psSubsysDeviceID, psLength=psLength, snmpTrapSrvEntry=snmpTrapSrvEntry, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psState=psState, psLocation=psLocation, advantech=advantech)
