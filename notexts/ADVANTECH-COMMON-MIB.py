...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", advantech=advantech, psVendorID=psVendorID, sysDescr=sysDescr, atMgmt=atMgmt, psManufacturer=psManufacturer, snmpTrapSrvNumber=snmpTrapSrvNumber, psNumber=psNumber, sysReleaseDate=sysReleaseDate, sysDeviceName=sysDeviceName, psDisplayName=psDisplayName, psLength=psLength, psState=psState, pciConfigObj=pciConfigObj, psBaseAddress=psBaseAddress, psModuleType=psModuleType, sysBootCount=sysBootCount, psBusIndex=psBusIndex, atSystem=atSystem, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvIndex=snmpTrapSrvIndex, psSubsysDeviceID=psSubsysDeviceID, psDeviceIndex=psDeviceIndex, pciSlotEntry=pciSlotEntry, psModulePorts=psModulePorts, snmpTrapVersion=snmpTrapVersion, psDeviceID=psDeviceID, psDescr=psDescr, psLocation=psLocation, snmpTrapSrvObj=snmpTrapSrvObj, atPciConfig=atPciConfig, snmpTrapSrvPort=snmpTrapSrvPort, psFunctionIndex=psFunctionIndex, pciSlotTable=pciSlotTable, psIndex=psIndex, psClassCode=psClassCode, sysImageVersion=sysImageVersion, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysModuleID=sysModuleID, psIRQ=psIRQ, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvEntry=snmpTrapSrvEntry, sysFirstBootTime=sysFirstBootTime, sysBootTime=sysBootTime, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvIP=snmpTrapSrvIP)
