...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysDeviceName=sysDeviceName, psDisplayName=psDisplayName, psManufacturer=psManufacturer, psState=psState, psDescr=psDescr, sysBootCount=sysBootCount, psNumber=psNumber, psBaseAddress=psBaseAddress, PYSNMP_MODULE_ID=advantechCommonMIB, psModuleType=psModuleType, psFunctionIndex=psFunctionIndex, psVendorID=psVendorID, sysDescr=sysDescr, psLength=psLength, psDeviceIndex=psDeviceIndex, psSubsysVendorID=psSubsysVendorID, psDeviceID=psDeviceID, pciConfigObj=pciConfigObj, psLocation=psLocation, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psClassCode=psClassCode, advantech=advantech, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvTable=snmpTrapSrvTable, psModulePorts=psModulePorts, atSystem=atSystem, atMgmt=atMgmt, sysImageVersion=sysImageVersion, snmpTrapSrvCommunity=snmpTrapSrvCommunity, atPciConfig=atPciConfig, psIRQ=psIRQ, advantechCommonMIB=advantechCommonMIB, sysFirstBootTime=sysFirstBootTime, pciSlotTable=pciSlotTable, pciSlotEntry=pciSlotEntry, psBusIndex=psBusIndex, psSubsysDeviceID=psSubsysDeviceID, psIndex=psIndex, snmpTrapSrvIP=snmpTrapSrvIP, sysModuleID=sysModuleID, sysReleaseDate=sysReleaseDate, sysBootTime=sysBootTime, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvPort=snmpTrapSrvPort)
