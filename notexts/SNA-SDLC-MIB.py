...
mibBuilder.exportSymbols("SNA-SDLC-MIB", sdlcPortAdminACTIVTO=sdlcPortAdminACTIVTO, sdlcPortAdminSlowPollTimer=sdlcPortAdminSlowPollTimer, sdlcPortStatsRemoteBusies=sdlcPortStatsRemoteBusies, sdlcLSStatsPollsOut=sdlcLSStatsPollsOut, sdlcLSAdminMAXDATASend=sdlcLSAdminMAXDATASend, sdlcLSStatsRetransmitsIn=sdlcLSStatsRetransmitsIn, PYSNMP_MODULE_ID=snaDLC, sdlcCorePortOperGroup=sdlcCorePortOperGroup, sdlcPrimaryCompliance=sdlcPrimaryCompliance, sdlcPortStatsPhysicalFailures=sdlcPortStatsPhysicalFailures, sdlcLSStatsDISCIn=sdlcLSStatsDISCIn, sdlcPortAdminTable=sdlcPortAdminTable, sdlcPortOperTable=sdlcPortOperTable, sdlcPortStatusChange=sdlcPortStatusChange, sdlcPortOperTopology=sdlcPortOperTopology, sdlcLSAdminRowStatus=sdlcLSAdminRowStatus, sdlcLSAdminName=sdlcLSAdminName, sdlcLSStatsDMIn=sdlcLSStatsDMIn, sdlcPortStatsEntry=sdlcPortStatsEntry, sdlcLSAdminRNRLIMIT=sdlcLSAdminRNRLIMIT, sdlcPortStatsRetransmitsIn=sdlcPortStatsRetransmitsIn, sdlcPortStatsProtocolErrs=sdlcPortStatsProtocolErrs, sdlcLSStatsFRMRsIn=sdlcLSStatsFRMRsIn, sdlcCoreLSStatsGroup=sdlcCoreLSStatsGroup, sdlcLSStatsDISCOut=sdlcLSStatsDISCOut, sdlcLSAdminXmitRcvCap=sdlcLSAdminXmitRcvCap, snaDLC=snaDLC, sdlcLSStatsPollRspsOut=sdlcLSStatsPollRspsOut, sdlcLSStatsREJsIn=sdlcLSStatsREJsIn, sdlcLSOperLastFailTime=sdlcLSOperLastFailTime, sdlcLSOperLastFailREPLYTOs=sdlcLSOperLastFailREPLYTOs, sdlcPrimaryMultipointGroup=sdlcPrimaryMultipointGroup, sdlcTraps=sdlcTraps, sdlcLSStatsPollsIn=sdlcLSStatsPollsIn, sdlcLSStatsLocalBusies=sdlcLSStatsLocalBusies, sdlcLSOperLastFailCtrlOut=sdlcLSOperLastFailCtrlOut, sdlcCoreLSOperGroup=sdlcCoreLSOperGroup, sdlcLSAdminMODULO=sdlcLSAdminMODULO, sdlcLSAdminMAXDATARcv=sdlcLSAdminMAXDATARcv, sdlc=sdlc, sdlcPortOperACTIVTO=sdlcPortOperACTIVTO, sdlcLSAdminSimRim=sdlcLSAdminSimRim, sdlcLSStatusChange=sdlcLSStatusChange, sdlcLSGroup=sdlcLSGroup, sdlcCoreGroups=sdlcCoreGroups, sdlcPortOperLastFailCause=sdlcPortOperLastFailCause, sdlcLSStatsSNRMIn=sdlcLSStatsSNRMIn, sdlcPortAdminISTATUS=sdlcPortAdminISTATUS, sdlcLSAdminISTATUS=sdlcLSAdminISTATUS, sdlcLSOperLastFailFRMRInfo=sdlcLSOperLastFailFRMRInfo, sdlcPortOperSlowPollTimer=sdlcPortOperSlowPollTimer, sdlcLSOperREPLYTO=sdlcLSOperREPLYTO, sdlcPortAdminRole=sdlcPortAdminRole, sdlcLSOperRole=sdlcLSOperRole, sdlcConformance=sdlcConformance, sdlcPortOperEntry=sdlcPortOperEntry, sdlcPortOperType=sdlcPortOperType, sdlcLSAdminMAXIN=sdlcLSAdminMAXIN, sdlcLSStatsRNRLIMITs=sdlcLSStatsRNRLIMITs, sdlcLSStatsActivityTOs=sdlcLSStatsActivityTOs, sdlcPortStatsPollRspsOut=sdlcPortStatsPollRspsOut, sdlcCoreCompliance=sdlcCoreCompliance, sdlcPortAdminPAUSE=sdlcPortAdminPAUSE, sdlcLSStatsTable=sdlcLSStatsTable, sdlcLSStatsDMOut=sdlcLSStatsDMOut, sdlcCompliances=sdlcCompliances, sdlcLSStatsREJsOut=sdlcLSStatsREJsOut, sdlcPortStatsPollsIn=sdlcPortStatsPollsIn, sdlcLSOperEntry=sdlcLSOperEntry, sdlcPortOperLastFailTime=sdlcPortOperLastFailTime, sdlcLSOperTable=sdlcLSOperTable, sdlcLSStatsPollRspsIn=sdlcLSStatsPollRspsIn, sdlcLSAdminREPLYTO=sdlcLSAdminREPLYTO, sdlcLSStatsXIDsIn=sdlcLSStatsXIDsIn, sdlcLSAdminRETRIESn=sdlcLSAdminRETRIESn, sdlcPortOperSlowPollMethod=sdlcPortOperSlowPollMethod, sdlcPortStatsRetriesExps=sdlcPortStatsRetriesExps, sdlcLSAdminDATMODE=sdlcLSAdminDATMODE, sdlcLSStatsSIMsOut=sdlcLSStatsSIMsOut, sdlcLSStatsRIMsIn=sdlcLSStatsRIMsIn, sdlcLSStatsOctetsOut=sdlcLSStatsOctetsOut, sdlcLSStatsIFramesOut=sdlcLSStatsIFramesOut, sdlcCorePortStatsGroup=sdlcCorePortStatsGroup, sdlcPortAdminSERVLIM=sdlcPortAdminSERVLIM, sdlcPortAdminType=sdlcPortAdminType, sdlcLSStatsEntry=sdlcLSStatsEntry, sdlcPortOperISTATUS=sdlcPortOperISTATUS, sdlcLSOperRETRIESt=sdlcLSOperRETRIESt, sdlcPortOperSERVLIM=sdlcPortOperSERVLIM, sdlcCorePortAdminGroup=sdlcCorePortAdminGroup, sdlcLSStatsSNRMOut=sdlcLSStatsSNRMOut, sdlcPortStatsInvalidAddresses=sdlcPortStatsInvalidAddresses, sdlcPortAdminTopology=sdlcPortAdminTopology, sdlcLSOperEcho=sdlcLSOperEcho, sdlcLSStatsOctetsIn=sdlcLSStatsOctetsIn, sdlcLSStatsRIMsOut=sdlcLSStatsRIMsOut, sdlcGroups=sdlcGroups, sdlcPortStatsRNRLIMITs=sdlcPortStatsRNRLIMITs, sdlcPrimaryGroups=sdlcPrimaryGroups, sdlcPortStatsIFramesIn=sdlcPortStatsIFramesIn, sdlcLSOperLastModifyTime=sdlcLSOperLastModifyTime, sdlcLSStatsTESTsOut=sdlcLSStatsTESTsOut, sdlcPortStatsTable=sdlcPortStatsTable, sdlcLSAdminEntry=sdlcLSAdminEntry, sdlcLSAdminRETRIESt=sdlcLSAdminRETRIESt, sdlcLSOperState=sdlcLSOperState, sdlcPortOperLastModifyTime=sdlcPortOperLastModifyTime, sdlcPortOperRole=sdlcPortOperRole, sdlcLSStatsUIFramesOut=sdlcLSStatsUIFramesOut, sdlcPortStatsIFramesOut=sdlcPortStatsIFramesOut, sdlcLSStatsRemoteBusies=sdlcLSStatsRemoteBusies, sdlcPrimaryMultipointCompliance=sdlcPrimaryMultipointCompliance, sdlcLSStatsRetriesExps=sdlcLSStatsRetriesExps, sdlcLSStatsXIDsOut=sdlcLSStatsXIDsOut, sdlcLSStatsUAOut=sdlcLSStatsUAOut, sdlcPortStatsRetransmitsOut=sdlcPortStatsRetransmitsOut, sdlcLSStatsUIFramesIn=sdlcLSStatsUIFramesIn, sdlcLSStatsUAIn=sdlcLSStatsUAIn, sdlcPortStatsDwarfFrames=sdlcPortStatsDwarfFrames, sdlcLSStatsRetransmitsOut=sdlcLSStatsRetransmitsOut, sdlcPortStatsActivityTOs=sdlcPortStatsActivityTOs, sdlcLSStatsIFramesIn=sdlcLSStatsIFramesIn, sdlcLSOperMAXOUT=sdlcLSOperMAXOUT, sdlcLSOperLastFailCause=sdlcLSOperLastFailCause, sdlcLSOperName=sdlcLSOperName, sdlcLSStatsBLUsOut=sdlcLSStatsBLUsOut, sdlcLSOperDATMODE=sdlcLSOperDATMODE, sdlcLSOperLastFailCtrlIn=sdlcLSOperLastFailCtrlIn, sdlcPortGroup=sdlcPortGroup, sdlcPortOperName=sdlcPortOperName, sdlcLSOperGPoll=sdlcLSOperGPoll, sdlcLSAdminTable=sdlcLSAdminTable, sdlcLSOperMAXDATASend=sdlcLSOperMAXDATASend, sdlcPortStatsLocalBusies=sdlcPortStatsLocalBusies, sdlcLSAdminState=sdlcLSAdminState, sdlcLSAdminRETRIESm=sdlcLSAdminRETRIESm, sdlcLSStatsFRMRsOut=sdlcLSStatsFRMRsOut, sdlcLSStatsTESTsIn=sdlcLSStatsTESTsIn, sdlcPortStatsPollsOut=sdlcPortStatsPollsOut, sdlcPortAdminName=sdlcPortAdminName, sdlcLSOperMODULO=sdlcLSOperMODULO, sdlcLSOperRETRIESm=sdlcLSOperRETRIESm, sdlcLSAdminGPoll=sdlcLSAdminGPoll, sdlcPortAdminEntry=sdlcPortAdminEntry, sdlcPortStatsOctetsOut=sdlcPortStatsOctetsOut, sdlcLSOperSimRim=sdlcLSOperSimRim, sdlcPortOperPAUSE=sdlcPortOperPAUSE, sdlcCoreLSAdminGroup=sdlcCoreLSAdminGroup, sdlcLSOperRETRIESn=sdlcLSOperRETRIESn, sdlcLSOperRNRLIMIT=sdlcLSOperRNRLIMIT, sdlcPortStatsPollRspsIn=sdlcPortStatsPollRspsIn, sdlcLSOperMAXIN=sdlcLSOperMAXIN, sdlcLSOperXmitRcvCap=sdlcLSOperXmitRcvCap, sdlcLSStatsBLUsIn=sdlcLSStatsBLUsIn, sdlcLSStatsProtocolErrs=sdlcLSStatsProtocolErrs, sdlcLSStatsSIMsIn=sdlcLSStatsSIMsIn, sdlcLSAddress=sdlcLSAddress, sdlcPrimaryGroup=sdlcPrimaryGroup, sdlcLSAdminMAXOUT=sdlcLSAdminMAXOUT, sdlcPortStatsOctetsIn=sdlcPortStatsOctetsIn)
