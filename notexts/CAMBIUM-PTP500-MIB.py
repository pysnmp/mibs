...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", configuration=configuration, bandwidthVariant=bandwidthVariant, licence=licence, transmitModulationMode=transmitModulationMode, userRole=userRole, tDDSynchronizationStatus=tDDSynchronizationStatus, ethernetFiberSupport=ethernetFiberSupport, sNTPSyncTrap=sNTPSyncTrap, ptpCompliance=ptpCompliance, telecomsLineCode=telecomsLineCode, installStatus=installStatus, vLANManagementVID=vLANManagementVID, systemClock=systemClock, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ptpGroups=ptpGroups, linkName=linkName, management=management, productName=productName, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptp500=ptp500, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitDataRate=transmitDataRate, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, eIRP=eIRP, userTableNumber=userTableNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, snmpControl=snmpControl, encryptionGroup=encryptionGroup, dfsPeaks=dfsPeaks, dataPortWirelessDownAlert=dataPortWirelessDownAlert, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNTPServerPortNumber=sNTPServerPortNumber, searchState=searchState, cambium=cambium, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, longitude=longitude, channelBandwidth=channelBandwidth, secondarySoftwareVersion=secondarySoftwareVersion, siteName=siteName, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, frequencyVariant=frequencyVariant, sNTPState=sNTPState, subnetMask=subnetMask, hTTPSPortNumber=hTTPSPortNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, telecomsLoopbackTrap=telecomsLoopbackTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, groupID=groupID, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapTable=sNMPTrapTable, userTableIndex=userTableIndex, syslogStateTrap=syslogStateTrap, sMTPEmailAlert=sMTPEmailAlert, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sMTPEnabledMessages=sMTPEnabledMessages, encryptionAlgorithm=encryptionAlgorithm, telecomsInterface=telecomsInterface, dfsTableNumber=dfsTableNumber, licenceGroup=licenceGroup, unitOutOfCalibration=unitOutOfCalibration, userName=userName, cableLoss=cableLoss, sNTPLastSync=sNTPLastSync, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ptp=ptp, pubStatsGroup=pubStatsGroup, sNMPTrapVersion=sNMPTrapVersion, dfsGroup=dfsGroup, range=range, transmitFreqMHz=transmitFreqMHz, encryption=encryption, licensedCapacity=licensedCapacity, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, timeZone=timeZone, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, telecomsCableLength=telecomsCableLength, sMTPServerIPAddress=sMTPServerIPAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, linkLoss=linkLoss, accessMethod=accessMethod, PYSNMP_MODULE_ID=cambium, smtpGroup=smtpGroup, hTTPPortNumber=hTTPPortNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, regionCodeTrap=regionCodeTrap, linkSymmetry=linkSymmetry, dataPortAutoMdix=dataPortAutoMdix, sNMPTrapPortNumber=sNMPTrapPortNumber, sntpGroup=sntpGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, targetMACAddress=targetMACAddress, receiveModulationModeDetail=receiveModulationModeDetail, sMTPServerPortNumber=sMTPServerPortNumber, bootVersion=bootVersion, versions=versions, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, telnetAccessEnabled=telnetAccessEnabled, hTTPSAccessEnabled=hTTPSAccessEnabled, aAAControl=aAAControl, vectorError=vectorError, transmitPower=transmitPower, sNTPPollInterval=sNTPPollInterval, daylightSaving=daylightSaving, hardwareVersion=hardwareVersion, tDDSynchronizationMode=tDDSynchronizationMode, dfsTableEntry=dfsTableEntry, byteErrorRatio=byteErrorRatio, snmpControlGroup=snmpControlGroup, configurationGroup=configurationGroup, userTableEntry=userTableEntry, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, vLANPriorityTable=vLANPriorityTable, useVLANForManagementInterfaces=useVLANForManagementInterfaces, pubStats=pubStats, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfs=dfs, syslogControl=syslogControl, sNTPSync=sNTPSync, sNMPEnabledTraps=sNMPEnabledTraps, antennaGain=antennaGain, receivePower=receivePower, dfsMeans=dfsMeans, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, receiveModulationMode=receiveModulationMode, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, regionCode=regionCode, sNTPServerIPAddress=sNTPServerIPAddress, alarmsGroup=alarmsGroup, ethernetGroup=ethernetGroup, telecomGroup=telecomGroup, productVariant=productVariant, capacityLicenseMismatch=capacityLicenseMismatch, supplementaryGroup=supplementaryGroup, phyControlGroup=phyControlGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, syslogControlGroup=syslogControlGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, phyStatus=phyStatus, ethernet=ethernet, maximumTransmitPower=maximumTransmitPower, phyControl=phyControl, syslogState=syslogState, versionsGroup=versionsGroup, transmitFreqKHz=transmitFreqKHz, dataPortDisabledWarning=dataPortDisabledWarning, masterSlaveMode=masterSlaveMode, remoteIPAddress=remoteIPAddress, installArmState=installArmState, channelChangeTrap=channelChangeTrap, installArmStateTrap=installArmStateTrap, transmitChannel=transmitChannel, systemReset=systemReset, sNMPCommunityString=sNMPCommunityString, notificationsGroup=notificationsGroup, wirelessLinkStatus=wirelessLinkStatus, dfsTableIndex=dfsTableIndex, installStatusTrap=installStatusTrap, supplementary=supplementary, latitude=latitude, linkModeOptimisation=linkModeOptimisation, vLANManagementPriority=vLANManagementPriority, ptmp=ptmp, receiveFreqMHz=receiveFreqMHz, userTable=userTable, telnetPortNumber=telnetPortNumber, vLANPriorityTableNumber=vLANPriorityTableNumber, gatewayIPAddress=gatewayIPAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsTable=dfsTable, vLANPriorityTableEntry=vLANPriorityTableEntry, alarms=alarms, iPAddress=iPAddress, incompatibleRegionCodes=incompatibleRegionCodes, syslogLocalWrappedTrap=syslogLocalWrappedTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sntp=sntp, receiveChannel=receiveChannel, userPassword=userPassword, constantPowerSpectralDensity=constantPowerSpectralDensity, receiveDataRate=receiveDataRate, phyStatusGroup=phyStatusGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, wirelessLinkAvailability=wirelessLinkAvailability, resetGroup=resetGroup, sNMPv3Enable=sNMPv3Enable, userEnabled=userEnabled, tDDControlGroup=tDDControlGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapIPAddress=sNMPTrapIPAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, hTTPAccessEnabled=hTTPAccessEnabled, tFTPServerPortNumber=tFTPServerPortNumber, telecomsChannelStatus=telecomsChannelStatus, telecomsChannelStatusTrap=telecomsChannelStatusTrap, softwareVersion=softwareVersion, sNMPPortNumber=sNMPPortNumber, aggregateDataRate=aggregateDataRate, ptpTraps=ptpTraps, reset=reset, tDDControl=tDDControl, signalStrengthRatio=signalStrengthRatio, syslogClient=syslogClient, receiveFreqKHz=receiveFreqKHz, telecomsLoopback=telecomsLoopback, aAAControlGroup=aAAControlGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, dataPortStatusTrap=dataPortStatusTrap, tFTPServerIPAddress=tFTPServerIPAddress, syslogClientTrap=syslogClientTrap, telecom=telecom, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortStatus=dataPortStatus, managementGroup=managementGroup, smtp=smtp, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, altitude=altitude)
