...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, notificationsGroup=notificationsGroup, sMTPServerPortNumber=sMTPServerPortNumber, dfs=dfs, alarmsGroup=alarmsGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, useVLANForManagementInterfaces=useVLANForManagementInterfaces, encryptionAlgorithm=encryptionAlgorithm, versions=versions, sNMPTrapIPAddress=sNMPTrapIPAddress, systemClock=systemClock, remoteMaximumTransmitPower=remoteMaximumTransmitPower, linkLoss=linkLoss, userTableIndex=userTableIndex, sMTPServerIPAddress=sMTPServerIPAddress, siteName=siteName, accessMethod=accessMethod, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, receiveDataRate=receiveDataRate, ptmp=ptmp, gatewayIPAddress=gatewayIPAddress, channelBandwidth=channelBandwidth, sNMPv3Enable=sNMPv3Enable, sNTPServerIPAddress=sNTPServerIPAddress, dfsTableEntry=dfsTableEntry, ptpCompliance=ptpCompliance, hTTPSPortNumber=hTTPSPortNumber, tDDControlGroup=tDDControlGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, receivePower=receivePower, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, wirelessLinkAvailability=wirelessLinkAvailability, telecomsCableLength=telecomsCableLength, ethernetGroup=ethernetGroup, byteErrorRatio=byteErrorRatio, syslogClient=syslogClient, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, syslogClientTrap=syslogClientTrap, maximumTransmitPower=maximumTransmitPower, regionCode=regionCode, masterSlaveMode=masterSlaveMode, snmpControl=snmpControl, hardwareVersion=hardwareVersion, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tDDControl=tDDControl, pubStats=pubStats, transmitChannel=transmitChannel, linkName=linkName, sMTPEnabledMessages=sMTPEnabledMessages, antennaGain=antennaGain, aAAControl=aAAControl, supplementaryGroup=supplementaryGroup, licence=licence, ethernetFiberSupport=ethernetFiberSupport, softwareVersion=softwareVersion, smtpGroup=smtpGroup, range=range, bandwidthVariant=bandwidthVariant, tDDSynchronizationAlarm=tDDSynchronizationAlarm, aggregateDataRate=aggregateDataRate, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNTPLastSync=sNTPLastSync, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, telecom=telecom, capacityLicenseMismatch=capacityLicenseMismatch, phyStatus=phyStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ptpGroups=ptpGroups, incompatibleMasterAndSlave=incompatibleMasterAndSlave, telecomsLoopbackTrap=telecomsLoopbackTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPTrapVersion=sNMPTrapVersion, transmitFreqMHz=transmitFreqMHz, sNMPTrapTable=sNMPTrapTable, reset=reset, PYSNMP_MODULE_ID=cambium, noWirelessChannelAvailable=noWirelessChannelAvailable, transmitDataRate=transmitDataRate, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, telecomsLoopback=telecomsLoopback, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, wirelessLinkStatus=wirelessLinkStatus, alarms=alarms, linkModeOptimisation=linkModeOptimisation, dataPortStatus=dataPortStatus, receiveModulationModeDetail=receiveModulationModeDetail, supplementary=supplementary, unitOutOfCalibration=unitOutOfCalibration, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPState=sNTPState, phyControl=phyControl, userEnabled=userEnabled, dataPortDisabledWarning=dataPortDisabledWarning, sMTPEmailAlert=sMTPEmailAlert, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, vectorError=vectorError, telecomGroup=telecomGroup, productName=productName, vLANPriorityTableIndex=vLANPriorityTableIndex, cambium=cambium, dfsTableNumber=dfsTableNumber, installArmStateTrap=installArmStateTrap, resetGroup=resetGroup, installStatusTrap=installStatusTrap, frequencyVariant=frequencyVariant, sntp=sntp, telnetPortNumber=telnetPortNumber, vLANPriorityTable=vLANPriorityTable, ptp500=ptp500, smtp=smtp, licensedCapacity=licensedCapacity, iPAddress=iPAddress, transmitPower=transmitPower, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, remoteIPAddress=remoteIPAddress, linkModeOptimizationMismatch=linkModeOptimizationMismatch, aAAControlGroup=aAAControlGroup, telecomsInterface=telecomsInterface, licenceGroup=licenceGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, sNTPSyncTrap=sNTPSyncTrap, management=management, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, snmpControlGroup=snmpControlGroup, regionCodeTrap=regionCodeTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortStatusTrap=dataPortStatusTrap, dfsTableIndex=dfsTableIndex, sNMPCommunityString=sNMPCommunityString, sNMPPortNumber=sNMPPortNumber, userName=userName, longitude=longitude, daylightSaving=daylightSaving, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, subnetMask=subnetMask, sntpGroup=sntpGroup, syslogControl=syslogControl, encryptionGroup=encryptionGroup, configuration=configuration, tDDSynchronizationMode=tDDSynchronizationMode, dataPortAutoNegotiation=dataPortAutoNegotiation, vLANPriorityQueueMapping=vLANPriorityQueueMapping, searchState=searchState, telecomsChannelStatus=telecomsChannelStatus, groupID=groupID, altitude=altitude, eIRP=eIRP, latitude=latitude, tFTPServerPortNumber=tFTPServerPortNumber, userTableEntry=userTableEntry, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dfsTable=dfsTable, sNMPTrapTableIndex=sNMPTrapTableIndex, tFTPServerIPAddress=tFTPServerIPAddress, targetMACAddress=targetMACAddress, timeZone=timeZone, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, phyStatusGroup=phyStatusGroup, vLANManagementVID=vLANManagementVID, vLANPriorityTableEntry=vLANPriorityTableEntry, userRole=userRole, telecomsLineCode=telecomsLineCode, receiveChannel=receiveChannel, receiveFreqMHz=receiveFreqMHz, bootVersion=bootVersion, ethernet=ethernet, installArmState=installArmState, ptp=ptp, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, secondarySoftwareVersion=secondarySoftwareVersion, dfsMeans=dfsMeans, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, incompatibleRegionCodes=incompatibleRegionCodes, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNTPServerPortNumber=sNTPServerPortNumber, sNTPPollInterval=sNTPPollInterval, dataPortAutoMdix=dataPortAutoMdix, ptpTrapPrefix=ptpTrapPrefix, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, syslogControlGroup=syslogControlGroup, receiveFreqKHz=receiveFreqKHz, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, userPassword=userPassword, dfsPeaks=dfsPeaks, telnetAccessEnabled=telnetAccessEnabled, dfsGroup=dfsGroup, transmitModulationMode=transmitModulationMode, userTableNumber=userTableNumber, configurationGroup=configurationGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPEnabledTraps=sNMPEnabledTraps, systemReset=systemReset, vLANManagementPriority=vLANManagementPriority, syslogStateTrap=syslogStateTrap, userTable=userTable, cableLoss=cableLoss, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, signalStrengthRatio=signalStrengthRatio, linkSymmetry=linkSymmetry, sNTPSync=sNTPSync, encryption=encryption, hTTPPortNumber=hTTPPortNumber, phyControlGroup=phyControlGroup, receiveModulationMode=receiveModulationMode, versionsGroup=versionsGroup, channelChangeTrap=channelChangeTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, ptpTraps=ptpTraps, installStatus=installStatus, managementGroup=managementGroup, pubStatsGroup=pubStatsGroup, transmitFreqKHz=transmitFreqKHz, productVariant=productVariant, hTTPAccessEnabled=hTTPAccessEnabled, syslogLocalWrappedTrap=syslogLocalWrappedTrap, syslogState=syslogState)
