...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", ptmp=ptmp, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sMTPServerIPAddress=sMTPServerIPAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, versions=versions, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, phyStatusGroup=phyStatusGroup, ethernetFiberSupport=ethernetFiberSupport, snmpControl=snmpControl, eIRP=eIRP, dfsTableEntry=dfsTableEntry, receiveFreqMHz=receiveFreqMHz, transmitFreqMHz=transmitFreqMHz, telnetPortNumber=telnetPortNumber, productVariant=productVariant, vectorError=vectorError, tFTPServerPortNumber=tFTPServerPortNumber, aAAControl=aAAControl, sNMPCommunityString=sNMPCommunityString, vLANManagementVID=vLANManagementVID, installStatus=installStatus, syslogClient=syslogClient, systemClock=systemClock, tDDSynchronizationMode=tDDSynchronizationMode, alarms=alarms, tDDControl=tDDControl, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dfsPeaks=dfsPeaks, transmitPower=transmitPower, tDDSynchronizationStatus=tDDSynchronizationStatus, syslogControlGroup=syslogControlGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, regionCodeTrap=regionCodeTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, siteName=siteName, byteErrorRatio=byteErrorRatio, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, linkName=linkName, transmitModulationMode=transmitModulationMode, range=range, aAAControlGroup=aAAControlGroup, hTTPPortNumber=hTTPPortNumber, encryptionGroup=encryptionGroup, receiveFreqKHz=receiveFreqKHz, smtp=smtp, ptpTraps=ptpTraps, sNMPTrapVersion=sNMPTrapVersion, sNTPSyncTrap=sNTPSyncTrap, telecomGroup=telecomGroup, licenceGroup=licenceGroup, bandwidthVariant=bandwidthVariant, supplementaryGroup=supplementaryGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapTable=sNMPTrapTable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, smtpGroup=smtpGroup, sntp=sntp, daylightSaving=daylightSaving, sNMPPortNumber=sNMPPortNumber, dfs=dfs, maximumTransmitPower=maximumTransmitPower, syslogClientTrap=syslogClientTrap, phyStatus=phyStatus, dfsGroup=dfsGroup, linkSymmetry=linkSymmetry, useVLANForManagementInterfaces=useVLANForManagementInterfaces, encryptionAlgorithm=encryptionAlgorithm, userRole=userRole, masterSlaveMode=masterSlaveMode, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, encryption=encryption, ptpCompliance=ptpCompliance, softwareVersion=softwareVersion, timeZone=timeZone, vLANPriorityTableEntry=vLANPriorityTableEntry, notificationsGroup=notificationsGroup, userTableEntry=userTableEntry, dataPortStatus=dataPortStatus, sNTPServerIPAddress=sNTPServerIPAddress, dataPortStatusTrap=dataPortStatusTrap, aggregateDataRate=aggregateDataRate, phyControlGroup=phyControlGroup, tDDControlGroup=tDDControlGroup, telecomsChannelStatusTrap=telecomsChannelStatusTrap, licensedCapacity=licensedCapacity, ethernetGroup=ethernetGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, wirelessLinkAvailability=wirelessLinkAvailability, telecom=telecom, sMTPServerPortNumber=sMTPServerPortNumber, linkLoss=linkLoss, capacityLicenseMismatch=capacityLicenseMismatch, vLANPriorityTableNumber=vLANPriorityTableNumber, transmitDataRate=transmitDataRate, telecomsLoopbackTrap=telecomsLoopbackTrap, secondarySoftwareVersion=secondarySoftwareVersion, telnetAccessEnabled=telnetAccessEnabled, frequencyVariant=frequencyVariant, reset=reset, syslogState=syslogState, sNTPState=sNTPState, sNMPv3Enable=sNMPv3Enable, sntpGroup=sntpGroup, resetGroup=resetGroup, installStatusTrap=installStatusTrap, vLANManagementPriority=vLANManagementPriority, channelChangeTrap=channelChangeTrap, cableLoss=cableLoss, iPAddress=iPAddress, userName=userName, ethernet=ethernet, userTableNumber=userTableNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telecomsInterface=telecomsInterface, systemReset=systemReset, syslogStateTrap=syslogStateTrap, ptpGroups=ptpGroups, licence=licence, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, accessMethod=accessMethod, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, latitude=latitude, dataPortAutoMdix=dataPortAutoMdix, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, syslogControl=syslogControl, sNTPPollInterval=sNTPPollInterval, sMTPEnabledMessages=sMTPEnabledMessages, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, userTable=userTable, transmitChannel=transmitChannel, management=management, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dfsTable=dfsTable, vLANPriorityTableIndex=vLANPriorityTableIndex, userPassword=userPassword, noWirelessChannelAvailable=noWirelessChannelAvailable, pubStatsGroup=pubStatsGroup, transmitFreqKHz=transmitFreqKHz, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, cambium=cambium, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPTrapIPAddress=sNMPTrapIPAddress, gatewayIPAddress=gatewayIPAddress, ptpTrapPrefix=ptpTrapPrefix, managementGroup=managementGroup, dfsTableNumber=dfsTableNumber, targetMACAddress=targetMACAddress, longitude=longitude, installArmState=installArmState, userTableIndex=userTableIndex, telecomsCableLength=telecomsCableLength, groupID=groupID, dataPortDisabledWarning=dataPortDisabledWarning, sNTPServerPortNumber=sNTPServerPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, unitOutOfCalibration=unitOutOfCalibration, receiveChannel=receiveChannel, bootVersion=bootVersion, vLANPriorityTable=vLANPriorityTable, searchState=searchState, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, hTTPSPortNumber=hTTPSPortNumber, installArmStateTrap=installArmStateTrap, phyControl=phyControl, dfsMeans=dfsMeans, incompatibleRegionCodes=incompatibleRegionCodes, sNMPEnabledTraps=sNMPEnabledTraps, channelBandwidth=channelBandwidth, regionCode=regionCode, telecomsChannelStatus=telecomsChannelStatus, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapPortNumber=sNMPTrapPortNumber, telecomsLoopback=telecomsLoopback, versionsGroup=versionsGroup, hardwareVersion=hardwareVersion, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, subnetMask=subnetMask, telecomsLineCode=telecomsLineCode, remoteIPAddress=remoteIPAddress, signalStrengthRatio=signalStrengthRatio, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNTPSync=sNTPSync, userEnabled=userEnabled, pubStats=pubStats, hTTPAccessEnabled=hTTPAccessEnabled, antennaGain=antennaGain, wirelessLinkStatus=wirelessLinkStatus, ptp500=ptp500, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, snmpControlGroup=snmpControlGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, supplementary=supplementary, receiveModulationModeDetail=receiveModulationModeDetail, configuration=configuration, sNMPTrapTableEntry=sNMPTrapTableEntry, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, receiveDataRate=receiveDataRate, productName=productName, receivePower=receivePower, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tFTPServerIPAddress=tFTPServerIPAddress, linkModeOptimisation=linkModeOptimisation, receiveModulationMode=receiveModulationMode, dfsTableIndex=dfsTableIndex, incompatibleMasterAndSlave=incompatibleMasterAndSlave, altitude=altitude, sNTPLastSync=sNTPLastSync, configurationGroup=configurationGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, alarmsGroup=alarmsGroup, ptp=ptp, PYSNMP_MODULE_ID=cambium)
