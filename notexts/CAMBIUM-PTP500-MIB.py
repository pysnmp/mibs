...
TimeTicks, Bits, Integer32, Counter32, NotificationType, ObjectIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Unsigned32, IpAddress, MibIdentifier, Counter64, ModuleIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Bits", "Integer32", "Counter32", "NotificationType", "ObjectIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Unsigned32", "IpAddress", "MibIdentifier", "Counter64", "ModuleIdentity", "iso")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", transmitFreqKHz=transmitFreqKHz, productVariant=productVariant, remoteMaximumTransmitPower=remoteMaximumTransmitPower, vLANPriorityTableIndex=vLANPriorityTableIndex, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ptpCompliance=ptpCompliance, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, searchState=searchState, userPassword=userPassword, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, hTTPSPortNumber=hTTPSPortNumber, installStatus=installStatus, wirelessLinkStatus=wirelessLinkStatus, sntp=sntp, telecom=telecom, hTTPSAccessEnabled=hTTPSAccessEnabled, management=management, userTableEntry=userTableEntry, gatewayIPAddress=gatewayIPAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, reset=reset, dfsMeans=dfsMeans, sMTPEnabledMessages=sMTPEnabledMessages, userEnabled=userEnabled, hardwareVersion=hardwareVersion, alarms=alarms, configuration=configuration, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPSync=sNTPSync, systemReset=systemReset, dfsTable=dfsTable, notificationsGroup=notificationsGroup, licenceGroup=licenceGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, receiveDataRate=receiveDataRate, telecomsLoopback=telecomsLoopback, configurationGroup=configurationGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, linkLoss=linkLoss, sNMPv3Enable=sNMPv3Enable, alarmsGroup=alarmsGroup, encryptionAlgorithm=encryptionAlgorithm, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, secondarySoftwareVersion=secondarySoftwareVersion, siteName=siteName, receivePower=receivePower, ptpGroups=ptpGroups, installStatusTrap=installStatusTrap, syslogStateTrap=syslogStateTrap, ptmp=ptmp, aAAControl=aAAControl, remoteIPAddress=remoteIPAddress, incompatibleRegionCodes=incompatibleRegionCodes, capacityLicenseMismatch=capacityLicenseMismatch, transmitDataRate=transmitDataRate, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ethernet=ethernet, transmitChannel=transmitChannel, PYSNMP_MODULE_ID=cambium, cambium=cambium, subnetMask=subnetMask, regionCode=regionCode, sntpGroup=sntpGroup, transmitPower=transmitPower, dfsPeaks=dfsPeaks, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tFTPServerPortNumber=tFTPServerPortNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, phyStatusGroup=phyStatusGroup, ethernetFiberSupport=ethernetFiberSupport, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPEnabledTraps=sNMPEnabledTraps, bootVersion=bootVersion, ptp500=ptp500, userRole=userRole, vLANPriorityTable=vLANPriorityTable, maximumTransmitPower=maximumTransmitPower, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, telecomsLoopbackTrap=telecomsLoopbackTrap, hTTPAccessEnabled=hTTPAccessEnabled, softwareVersion=softwareVersion, tDDSynchronizationMode=tDDSynchronizationMode, targetMACAddress=targetMACAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, constantPowerSpectralDensity=constantPowerSpectralDensity, daylightSaving=daylightSaving, longitude=longitude, receiveChannel=receiveChannel, supplementary=supplementary, userTable=userTable, iPAddress=iPAddress, snmpControlGroup=snmpControlGroup, sMTPEmailAlert=sMTPEmailAlert, receiveFreqMHz=receiveFreqMHz, channelChangeTrap=channelChangeTrap, pubStatsGroup=pubStatsGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, userTableIndex=userTableIndex, syslogState=syslogState, telnetAccessEnabled=telnetAccessEnabled, groupID=groupID, smtpGroup=smtpGroup, channelBandwidth=channelBandwidth, telecomsInterface=telecomsInterface, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, resetGroup=resetGroup, dfsGroup=dfsGroup, userName=userName, versions=versions, sNMPCommunityString=sNMPCommunityString, sNMPTrapVersion=sNMPTrapVersion, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, latitude=latitude, telecomGroup=telecomGroup, syslogClientTrap=syslogClientTrap, dataPortAutoMdix=dataPortAutoMdix, cableLoss=cableLoss, masterSlaveMode=masterSlaveMode, useVLANForManagementInterfaces=useVLANForManagementInterfaces, telecomsChannelStatus=telecomsChannelStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, hTTPPortNumber=hTTPPortNumber, transmitModulationMode=transmitModulationMode, wirelessLinkAvailability=wirelessLinkAvailability, licensedCapacity=licensedCapacity, tDDSynchronizationAlarm=tDDSynchronizationAlarm, licence=licence, vLANManagementVID=vLANManagementVID, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dfsTableIndex=dfsTableIndex, sNTPState=sNTPState, syslogClient=syslogClient, vLANPriorityQueueMapping=vLANPriorityQueueMapping, transmitFreqMHz=transmitFreqMHz, sNTPLastSync=sNTPLastSync, receiveModulationMode=receiveModulationMode, sMTPServerPortNumber=sMTPServerPortNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, supplementaryGroup=supplementaryGroup, sNTPServerIPAddress=sNTPServerIPAddress, snmpControl=snmpControl, dataPortStatus=dataPortStatus, dfsTableNumber=dfsTableNumber, userTableNumber=userTableNumber, syslogControl=syslogControl, bandwidthVariant=bandwidthVariant, receiveFreqKHz=receiveFreqKHz, frequencyVariant=frequencyVariant, range=range, unitOutOfCalibration=unitOutOfCalibration, eIRP=eIRP, systemClock=systemClock, versionsGroup=versionsGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tDDControlGroup=tDDControlGroup, productName=productName, phyControl=phyControl, installArmStateTrap=installArmStateTrap, altitude=altitude, aAAControlGroup=aAAControlGroup, phyControlGroup=phyControlGroup, linkName=linkName, accessMethod=accessMethod, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, smtp=smtp, regionCodeTrap=regionCodeTrap, receiveModulationModeDetail=receiveModulationModeDetail, sNTPServerPortNumber=sNTPServerPortNumber, ethernetGroup=ethernetGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, pubStats=pubStats, encryption=encryption, byteErrorRatio=byteErrorRatio, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNTPPollInterval=sNTPPollInterval, sNTPSyncTrap=sNTPSyncTrap, tDDControl=tDDControl, telecomsCableLength=telecomsCableLength, linkModeOptimisation=linkModeOptimisation, antennaGain=antennaGain, syslogControlGroup=syslogControlGroup, sMTPServerIPAddress=sMTPServerIPAddress, dfs=dfs, managementGroup=managementGroup, aggregateDataRate=aggregateDataRate, encryptionGroup=encryptionGroup, tFTPServerIPAddress=tFTPServerIPAddress, dataPortDisabledWarning=dataPortDisabledWarning, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, phyStatus=phyStatus, sNMPPortNumber=sNMPPortNumber, telnetPortNumber=telnetPortNumber, dataPortStatusTrap=dataPortStatusTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dfsTableEntry=dfsTableEntry, sNMPTrapTable=sNMPTrapTable, timeZone=timeZone, ptpTrapPrefix=ptpTrapPrefix, telecomsLineCode=telecomsLineCode, tDDSynchronizationStatus=tDDSynchronizationStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ptpTraps=ptpTraps, vectorError=vectorError, signalStrengthRatio=signalStrengthRatio, sNMPTrapPortNumber=sNMPTrapPortNumber, telecomsChannelStatusTrap=telecomsChannelStatusTrap, ptp=ptp, linkSymmetry=linkSymmetry, installArmState=installArmState, vLANPriorityTableNumber=vLANPriorityTableNumber, vLANManagementPriority=vLANManagementPriority)
