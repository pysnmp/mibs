...
# Produced by pysmi-1.1.3 at Tue Nov 30 02:57:53 2021
...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ObjectIdentity, TimeTicks, enterprises, IpAddress, Bits, ModuleIdentity, NotificationType, Integer32, iso, Counter32, MibIdentifier, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ObjectIdentity", "TimeTicks", "enterprises", "IpAddress", "Bits", "ModuleIdentity", "NotificationType", "Integer32", "iso", "Counter32", "MibIdentifier", "Unsigned32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", licence=licence, tFTPServerIPAddress=tFTPServerIPAddress, userRole=userRole, sMTPEmailAlert=sMTPEmailAlert, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, syslogClientTrap=syslogClientTrap, dfs=dfs, telecomGroup=telecomGroup, systemReset=systemReset, tDDControlGroup=tDDControlGroup, daylightSaving=daylightSaving, phyStatusGroup=phyStatusGroup, receiveDataRate=receiveDataRate, aAAControl=aAAControl, eIRP=eIRP, channelChangeTrap=channelChangeTrap, aggregateDataRate=aggregateDataRate, ptpCompliance=ptpCompliance, dfsTableIndex=dfsTableIndex, remoteMaximumTransmitPower=remoteMaximumTransmitPower, useVLANForManagementInterfaces=useVLANForManagementInterfaces, linkModeOptimizationMismatch=linkModeOptimizationMismatch, capacityLicenseMismatch=capacityLicenseMismatch, sNMPTrapTableIndex=sNMPTrapTableIndex, ptpTraps=ptpTraps, dataPortStatus=dataPortStatus, sNTPServerPortNumber=sNTPServerPortNumber, channelBandwidth=channelBandwidth, installStatusTrap=installStatusTrap, antennaGain=antennaGain, receiveFreqKHz=receiveFreqKHz, dataPortStatusTrap=dataPortStatusTrap, configurationGroup=configurationGroup, tDDControl=tDDControl, sntp=sntp, installStatus=installStatus, sNTPLastSync=sNTPLastSync, telnetAccessEnabled=telnetAccessEnabled, aAAControlGroup=aAAControlGroup, longitude=longitude, telecomsLoopbackTrap=telecomsLoopbackTrap, sNTPServerIPAddress=sNTPServerIPAddress, regionCodeTrap=regionCodeTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ptp500=ptp500, accessMethod=accessMethod, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, telecomsCableLength=telecomsCableLength, vLANPriorityQueueMapping=vLANPriorityQueueMapping, telnetPortNumber=telnetPortNumber, ethernet=ethernet, dataPortAutoMdix=dataPortAutoMdix, regionCode=regionCode, sNMPTrapTableNumber=sNMPTrapTableNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tDDSynchronizationAlarm=tDDSynchronizationAlarm, syslogControl=syslogControl, maximumTransmitPower=maximumTransmitPower, transmitFreqMHz=transmitFreqMHz, dfsGroup=dfsGroup, userName=userName, subnetMask=subnetMask, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, siteName=siteName, ptpGroups=ptpGroups, alarms=alarms, encryption=encryption, versions=versions, managementGroup=managementGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, telecomsInterface=telecomsInterface, ptmp=ptmp, linkSymmetry=linkSymmetry, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, linkLoss=linkLoss, receiveModulationModeDetail=receiveModulationModeDetail, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, userEnabled=userEnabled, sNMPTrapTable=sNMPTrapTable, telecom=telecom, syslogStateTrap=syslogStateTrap, pubStats=pubStats, vLANPriorityTableIndex=vLANPriorityTableIndex, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, productName=productName, sNTPPollInterval=sNTPPollInterval, bootVersion=bootVersion, userTableIndex=userTableIndex, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ethernetFiberSupport=ethernetFiberSupport, telecomsChannelStatusTrap=telecomsChannelStatusTrap, snmpControl=snmpControl, sNMPTrapVersion=sNMPTrapVersion, wirelessLinkAvailability=wirelessLinkAvailability, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dfsTableEntry=dfsTableEntry, versionsGroup=versionsGroup, hardwareVersion=hardwareVersion, snmpControlGroup=snmpControlGroup, productVariant=productVariant, installArmStateTrap=installArmStateTrap, userTable=userTable, constantPowerSpectralDensity=constantPowerSpectralDensity, vLANPriorityTableNumber=vLANPriorityTableNumber, searchState=searchState, sNMPCommunityString=sNMPCommunityString, licensedCapacity=licensedCapacity, tFTPServerPortNumber=tFTPServerPortNumber, pubStatsGroup=pubStatsGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dfsTableNumber=dfsTableNumber, userTableEntry=userTableEntry, sNMPv3Enable=sNMPv3Enable, receiveFreqMHz=receiveFreqMHz, notificationsGroup=notificationsGroup, management=management, remoteIPAddress=remoteIPAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, vLANPriorityTableEntry=vLANPriorityTableEntry, phyStatus=phyStatus, masterSlaveMode=masterSlaveMode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, gatewayIPAddress=gatewayIPAddress, dfsPeaks=dfsPeaks, sNTPState=sNTPState, configuration=configuration, incompatibleMasterAndSlave=incompatibleMasterAndSlave, vectorError=vectorError, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNMPPortNumber=sNMPPortNumber, systemClock=systemClock, timeZone=timeZone, syslogClient=syslogClient, hTTPSAccessEnabled=hTTPSAccessEnabled, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, iPAddress=iPAddress, altitude=altitude, transmitDataRate=transmitDataRate, transmitChannel=transmitChannel, unitOutOfCalibration=unitOutOfCalibration, hTTPSPortNumber=hTTPSPortNumber, phyControlGroup=phyControlGroup, dfsMeans=dfsMeans, ptpTrapPrefix=ptpTrapPrefix, vLANManagementVID=vLANManagementVID, telecomsLoopback=telecomsLoopback, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, syslogControlGroup=syslogControlGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, vLANPriorityTable=vLANPriorityTable, userTableNumber=userTableNumber, sntpGroup=sntpGroup, incompatibleRegionCodes=incompatibleRegionCodes, linkModeOptimisation=linkModeOptimisation, byteErrorRatio=byteErrorRatio, secondarySoftwareVersion=secondarySoftwareVersion, transmitFreqKHz=transmitFreqKHz, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tDDSynchronizationMode=tDDSynchronizationMode, installArmState=installArmState, encryptionAlgorithm=encryptionAlgorithm, licenceGroup=licenceGroup, telecomsLineCode=telecomsLineCode, softwareVersion=softwareVersion, alarmsGroup=alarmsGroup, smtpGroup=smtpGroup, transmitModulationMode=transmitModulationMode, targetMACAddress=targetMACAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortAutoNegotiation=dataPortAutoNegotiation, sNTPSync=sNTPSync, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, latitude=latitude, vLANManagementPriority=vLANManagementPriority, signalStrengthRatio=signalStrengthRatio, receivePower=receivePower, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, supplementary=supplementary, transmitPower=transmitPower, phyControl=phyControl, range=range, ethernetGroup=ethernetGroup, receiveChannel=receiveChannel, reset=reset, groupID=groupID, frequencyVariant=frequencyVariant, sMTPServerPortNumber=sMTPServerPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, syslogState=syslogState, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, supplementaryGroup=supplementaryGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, cableLoss=cableLoss, linkName=linkName, PYSNMP_MODULE_ID=cambium, sNMPTrapTableEntry=sNMPTrapTableEntry, hTTPPortNumber=hTTPPortNumber, receiveModulationMode=receiveModulationMode, smtp=smtp, bandwidthVariant=bandwidthVariant, dfsTable=dfsTable, telecomsChannelStatus=telecomsChannelStatus, dataPortDisabledWarning=dataPortDisabledWarning, cambium=cambium, sMTPEnabledMessages=sMTPEnabledMessages, sNTPSyncTrap=sNTPSyncTrap, ptp=ptp, noWirelessChannelAvailable=noWirelessChannelAvailable, hTTPAccessEnabled=hTTPAccessEnabled, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, wirelessLinkStatus=wirelessLinkStatus, encryptionGroup=encryptionGroup, userPassword=userPassword, resetGroup=resetGroup, sNMPEnabledTraps=sNMPEnabledTraps)
