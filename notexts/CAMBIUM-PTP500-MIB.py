...
enterprises, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity, NotificationType, IpAddress, Integer32, Unsigned32, Counter64, ModuleIdentity, Gauge32, MibIdentifier, Bits, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity", "NotificationType", "IpAddress", "Integer32", "Unsigned32", "Counter64", "ModuleIdentity", "Gauge32", "MibIdentifier", "Bits", "TimeTicks")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, receiveModulationModeDetail=receiveModulationModeDetail, telnetPortNumber=telnetPortNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPTrapTable=sNMPTrapTable, channelBandwidth=channelBandwidth, syslogLocalWrappedTrap=syslogLocalWrappedTrap, siteName=siteName, sNMPEnabledTraps=sNMPEnabledTraps, userTableNumber=userTableNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, userRole=userRole, dataPortAutoNegotiation=dataPortAutoNegotiation, regionCode=regionCode, syslogClient=syslogClient, ptp500=ptp500, configurationGroup=configurationGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, telecomsChannelStatus=telecomsChannelStatus, userEnabled=userEnabled, userName=userName, sNTPServerPortNumber=sNTPServerPortNumber, dataPortDisabledWarning=dataPortDisabledWarning, dfsMeans=dfsMeans, ethernet=ethernet, dfs=dfs, accessMethod=accessMethod, sMTPServerIPAddress=sMTPServerIPAddress, byteErrorRatio=byteErrorRatio, licenceGroup=licenceGroup, incompatibleRegionCodes=incompatibleRegionCodes, userTableIndex=userTableIndex, sNMPCommunityString=sNMPCommunityString, linkLoss=linkLoss, receiveFreqMHz=receiveFreqMHz, dataPortStatusTrap=dataPortStatusTrap, transmitChannel=transmitChannel, sNTPLastSync=sNTPLastSync, dataPortStatus=dataPortStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, hardwareVersion=hardwareVersion, wirelessLinkAvailability=wirelessLinkAvailability, vLANPriorityQueueMapping=vLANPriorityQueueMapping, telnetAccessEnabled=telnetAccessEnabled, bootVersion=bootVersion, tDDSynchronizationStatus=tDDSynchronizationStatus, configuration=configuration, sNTPServerIPAddress=sNTPServerIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, phyControlGroup=phyControlGroup, telecom=telecom, phyStatus=phyStatus, syslogStateTrap=syslogStateTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ptpTraps=ptpTraps, secondarySoftwareVersion=secondarySoftwareVersion, linkModeOptimisation=linkModeOptimisation, dfsGroup=dfsGroup, hTTPPortNumber=hTTPPortNumber, receiveChannel=receiveChannel, regionCodeTrap=regionCodeTrap, dfsTable=dfsTable, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, syslogControlGroup=syslogControlGroup, dfsPeaks=dfsPeaks, userTable=userTable, transmitFreqKHz=transmitFreqKHz, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sntp=sntp, remoteIPAddress=remoteIPAddress, tDDSynchronizationAlarm=tDDSynchronizationAlarm, telecomsLoopback=telecomsLoopback, sMTPServerPortNumber=sMTPServerPortNumber, softwareVersion=softwareVersion, subnetMask=subnetMask, encryptionAlgorithm=encryptionAlgorithm, sNMPTrapVersion=sNMPTrapVersion, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, transmitModulationMode=transmitModulationMode, linkName=linkName, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, versionsGroup=versionsGroup, resetGroup=resetGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, vLANManagementVID=vLANManagementVID, syslogState=syslogState, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, cambium=cambium, receiveDataRate=receiveDataRate, userPassword=userPassword, gatewayIPAddress=gatewayIPAddress, pubStats=pubStats, ptpCompliance=ptpCompliance, channelChangeTrap=channelChangeTrap, syslogClientTrap=syslogClientTrap, installArmState=installArmState, receiveModulationMode=receiveModulationMode, eIRP=eIRP, transmitDataRate=transmitDataRate, installStatusTrap=installStatusTrap, productVariant=productVariant, sNMPTrapTableNumber=sNMPTrapTableNumber, versions=versions, hTTPAccessEnabled=hTTPAccessEnabled, receivePower=receivePower, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, telecomsLineCode=telecomsLineCode, capacityLicenseMismatch=capacityLicenseMismatch, sNMPTrapTableIndex=sNMPTrapTableIndex, supplementary=supplementary, sMTPEnabledMessages=sMTPEnabledMessages, sMTPEmailAlert=sMTPEmailAlert, noWirelessChannelAvailable=noWirelessChannelAvailable, ptmp=ptmp, pubStatsGroup=pubStatsGroup, ethernetFiberSupport=ethernetFiberSupport, constantPowerSpectralDensity=constantPowerSpectralDensity, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ptp=ptp, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, management=management, smtpGroup=smtpGroup, sNTPPollInterval=sNTPPollInterval, dataPortConfigurationMismatch=dataPortConfigurationMismatch, installStatus=installStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, telecomsCableLength=telecomsCableLength, latitude=latitude, telecomGroup=telecomGroup, searchState=searchState, productName=productName, encryption=encryption, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, alarmsGroup=alarmsGroup, managementGroup=managementGroup, bandwidthVariant=bandwidthVariant, phyStatusGroup=phyStatusGroup, tFTPServerPortNumber=tFTPServerPortNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapPortNumber=sNMPTrapPortNumber, altitude=altitude, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, smtp=smtp, iPAddress=iPAddress, cableLoss=cableLoss, ptpTrapPrefix=ptpTrapPrefix, masterSlaveMode=masterSlaveMode, licensedCapacity=licensedCapacity, maximumTransmitPower=maximumTransmitPower, dfsTableEntry=dfsTableEntry, sNMPPortNumber=sNMPPortNumber, longitude=longitude, daylightSaving=daylightSaving, alarms=alarms, ethernetGroup=ethernetGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNTPSyncTrap=sNTPSyncTrap, unitOutOfCalibration=unitOutOfCalibration, vLANPriorityTableEntry=vLANPriorityTableEntry, incompatibleMasterAndSlave=incompatibleMasterAndSlave, vLANPriorityTableNumber=vLANPriorityTableNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, linkSymmetry=linkSymmetry, encryptionGroup=encryptionGroup, vLANPriorityTable=vLANPriorityTable, supplementaryGroup=supplementaryGroup, systemReset=systemReset, frequencyVariant=frequencyVariant, licence=licence, dfsTableNumber=dfsTableNumber, sNTPSync=sNTPSync, telecomsLoopbackTrap=telecomsLoopbackTrap, ptpGroups=ptpGroups, snmpControl=snmpControl, transmitPower=transmitPower, receiveFreqKHz=receiveFreqKHz, systemClock=systemClock, signalStrengthRatio=signalStrengthRatio, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsTableIndex=dfsTableIndex, vLANPriorityTableIndex=vLANPriorityTableIndex, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sntpGroup=sntpGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, range=range, notificationsGroup=notificationsGroup, tDDControlGroup=tDDControlGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, tDDControl=tDDControl, targetMACAddress=targetMACAddress, sNMPv3Enable=sNMPv3Enable, hTTPSAccessEnabled=hTTPSAccessEnabled, groupID=groupID, remoteMaximumTransmitPower=remoteMaximumTransmitPower, userTableEntry=userTableEntry, syslogControl=syslogControl, tFTPServerIPAddress=tFTPServerIPAddress, wirelessLinkStatus=wirelessLinkStatus, vLANManagementPriority=vLANManagementPriority, timeZone=timeZone, vectorError=vectorError, antennaGain=antennaGain, aAAControl=aAAControl, PYSNMP_MODULE_ID=cambium, installArmStateTrap=installArmStateTrap, hTTPSPortNumber=hTTPSPortNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, reset=reset, telecomsInterface=telecomsInterface, sNTPState=sNTPState, tDDSynchronizationMode=tDDSynchronizationMode, transmitFreqMHz=transmitFreqMHz, snmpControlGroup=snmpControlGroup, phyControl=phyControl, linkModeOptimizationMismatch=linkModeOptimizationMismatch, aAAControlGroup=aAAControlGroup, telecomsChannelStatusTrap=telecomsChannelStatusTrap, aggregateDataRate=aggregateDataRate, dataPortAutoMdix=dataPortAutoMdix)
