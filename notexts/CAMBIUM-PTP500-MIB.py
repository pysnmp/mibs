...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", latitude=latitude, dfsTable=dfsTable, configurationGroup=configurationGroup, eIRP=eIRP, dataPortStatusTrap=dataPortStatusTrap, altitude=altitude, dfsGroup=dfsGroup, ptpTrapPrefix=ptpTrapPrefix, bandwidthVariant=bandwidthVariant, syslogClientTrap=syslogClientTrap, userTableEntry=userTableEntry, accessMethod=accessMethod, tFTPServerIPAddress=tFTPServerIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, phyStatus=phyStatus, sMTPServerPortNumber=sMTPServerPortNumber, sNMPCommunityString=sNMPCommunityString, userName=userName, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, licenceGroup=licenceGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, vLANManagementPriority=vLANManagementPriority, pubStats=pubStats, userPassword=userPassword, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, installArmStateTrap=installArmStateTrap, ptp500=ptp500, encryptionGroup=encryptionGroup, configuration=configuration, secondarySoftwareVersion=secondarySoftwareVersion, hTTPAccessEnabled=hTTPAccessEnabled, phyStatusGroup=phyStatusGroup, tDDControlGroup=tDDControlGroup, versions=versions, frequencyVariant=frequencyVariant, telnetPortNumber=telnetPortNumber, resetGroup=resetGroup, transmitFreqKHz=transmitFreqKHz, signalStrengthRatio=signalStrengthRatio, incompatibleRegionCodes=incompatibleRegionCodes, bootVersion=bootVersion, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, smtpGroup=smtpGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, sMTPSourceEmailAddress=sMTPSourceEmailAddress, syslogStateTrap=syslogStateTrap, sMTPServerIPAddress=sMTPServerIPAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, searchState=searchState, sNMPPortNumber=sNMPPortNumber, sNTPPollInterval=sNTPPollInterval, receiveFreqMHz=receiveFreqMHz, supplementaryGroup=supplementaryGroup, softwareVersion=softwareVersion, ptpCompliance=ptpCompliance, licence=licence, dfsPeaks=dfsPeaks, ethernetGroup=ethernetGroup, sNTPServerPortNumber=sNTPServerPortNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, vLANPriorityTableNumber=vLANPriorityTableNumber, sNMPv3Enable=sNMPv3Enable, snmpControl=snmpControl, snmpControlGroup=snmpControlGroup, receiveModulationModeDetail=receiveModulationModeDetail, transmitFreqMHz=transmitFreqMHz, sNMPTrapIPAddress=sNMPTrapIPAddress, ethernet=ethernet, phyControl=phyControl, dfsTableIndex=dfsTableIndex, dataPortAutoMdix=dataPortAutoMdix, dfs=dfs, syslogControlGroup=syslogControlGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dfsTableEntry=dfsTableEntry, linkModeOptimisation=linkModeOptimisation, receiveDataRate=receiveDataRate, licensedCapacity=licensedCapacity, alarmsGroup=alarmsGroup, sNTPSync=sNTPSync, incompatibleMasterAndSlave=incompatibleMasterAndSlave, syslogState=syslogState, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, groupID=groupID, cableLoss=cableLoss, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, channelChangeTrap=channelChangeTrap, userTable=userTable, installStatusTrap=installStatusTrap, sNMPEnabledTraps=sNMPEnabledTraps, receivePower=receivePower, timeZone=timeZone, constantPowerSpectralDensity=constantPowerSpectralDensity, aAAControl=aAAControl, tDDSynchronizationMode=tDDSynchronizationMode, receiveFreqKHz=receiveFreqKHz, management=management, installStatus=installStatus, productName=productName, telecomsChannelStatus=telecomsChannelStatus, tFTPServerPortNumber=tFTPServerPortNumber, systemReset=systemReset, subnetMask=subnetMask, sNMPTrapTableNumber=sNMPTrapTableNumber, sntp=sntp, transmitPower=transmitPower, sNMPTrapVersion=sNMPTrapVersion, channelBandwidth=channelBandwidth, vLANPriorityTableEntry=vLANPriorityTableEntry, transmitModulationMode=transmitModulationMode, iPAddress=iPAddress, telecomsInterface=telecomsInterface, sMTPEnabledMessages=sMTPEnabledMessages, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, antennaGain=antennaGain, transmitChannel=transmitChannel, installArmState=installArmState, receiveModulationMode=receiveModulationMode, wirelessLinkStatus=wirelessLinkStatus, supplementary=supplementary, remoteIPAddress=remoteIPAddress, telecomsChannelStatusTrap=telecomsChannelStatusTrap, gatewayIPAddress=gatewayIPAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNTPServerIPAddress=sNTPServerIPAddress, smtp=smtp, ptmp=ptmp, dfsMeans=dfsMeans, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, userTableNumber=userTableNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, range=range, ethernetFiberSupport=ethernetFiberSupport, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ptpTraps=ptpTraps, telecomsCableLength=telecomsCableLength, versionsGroup=versionsGroup, telnetAccessEnabled=telnetAccessEnabled, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tDDSynchronizationAlarm=tDDSynchronizationAlarm, phyControlGroup=phyControlGroup, sNTPSyncTrap=sNTPSyncTrap, vectorError=vectorError, sntpGroup=sntpGroup, capacityLicenseMismatch=capacityLicenseMismatch, byteErrorRatio=byteErrorRatio, aggregateDataRate=aggregateDataRate, PYSNMP_MODULE_ID=cambium, ptp=ptp, maximumTransmitPower=maximumTransmitPower, unitOutOfCalibration=unitOutOfCalibration, encryptionAlgorithm=encryptionAlgorithm, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapTable=sNMPTrapTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, productVariant=productVariant, regionCode=regionCode, cambium=cambium, telecom=telecom, sNMPTrapTableIndex=sNMPTrapTableIndex, receiveChannel=receiveChannel, wirelessLinkAvailability=wirelessLinkAvailability, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, vLANPriorityTable=vLANPriorityTable, masterSlaveMode=masterSlaveMode, telecomGroup=telecomGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, userEnabled=userEnabled, hTTPPortNumber=hTTPPortNumber, vLANPriorityQueueMapping=vLANPriorityQueueMapping, dataPortConfigurationMismatch=dataPortConfigurationMismatch, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tDDControl=tDDControl, dfsTableNumber=dfsTableNumber, systemClock=systemClock, syslogClient=syslogClient, telecomsLineCode=telecomsLineCode, hTTPSPortNumber=hTTPSPortNumber, alarms=alarms, regionCodeTrap=regionCodeTrap, reset=reset, userTableIndex=userTableIndex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, linkLoss=linkLoss, linkSymmetry=linkSymmetry, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, daylightSaving=daylightSaving, transmitDataRate=transmitDataRate, aAAControlGroup=aAAControlGroup, siteName=siteName, hardwareVersion=hardwareVersion, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dataPortDisabledWarning=dataPortDisabledWarning, targetMACAddress=targetMACAddress, sNTPLastSync=sNTPLastSync, vLANPriorityTableIndex=vLANPriorityTableIndex, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ptpGroups=ptpGroups, telecomsLoopback=telecomsLoopback, telecomsLoopbackTrap=telecomsLoopbackTrap, sMTPEmailAlert=sMTPEmailAlert, notificationsGroup=notificationsGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, userRole=userRole, managementGroup=managementGroup, linkName=linkName, dataPortStatus=dataPortStatus, sNTPState=sNTPState, longitude=longitude, syslogControl=syslogControl, pubStatsGroup=pubStatsGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, vLANManagementVID=vLANManagementVID, encryption=encryption)
