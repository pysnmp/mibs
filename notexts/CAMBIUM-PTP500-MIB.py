...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", ptpTrapPrefix=ptpTrapPrefix, dataPortStatusTrap=dataPortStatusTrap, antennaGain=antennaGain, syslogLocalWrappedTrap=syslogLocalWrappedTrap, transmitFreqMHz=transmitFreqMHz, eIRP=eIRP, ethernet=ethernet, dfsTableEntry=dfsTableEntry, vectorError=vectorError, alarmsGroup=alarmsGroup, installStatus=installStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPLastSync=sNTPLastSync, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, subnetMask=subnetMask, vLANManagementVID=vLANManagementVID, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, remoteIPAddress=remoteIPAddress, ethernetGroup=ethernetGroup, aAAControl=aAAControl, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, encryptionGroup=encryptionGroup, dfsMeans=dfsMeans, installStatusTrap=installStatusTrap, sNTPSync=sNTPSync, transmitDataRate=transmitDataRate, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, latitude=latitude, groupID=groupID, linkSymmetry=linkSymmetry, bootVersion=bootVersion, gatewayIPAddress=gatewayIPAddress, hTTPAccessEnabled=hTTPAccessEnabled, telecomsLoopback=telecomsLoopback, sNMPCommunityString=sNMPCommunityString, userTableIndex=userTableIndex, iPAddress=iPAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sMTPEnabledMessages=sMTPEnabledMessages, masterSlaveMode=masterSlaveMode, dfsTableIndex=dfsTableIndex, encryption=encryption, sMTPEmailAlert=sMTPEmailAlert, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dfs=dfs, receiveFreqMHz=receiveFreqMHz, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, altitude=altitude, incompatibleRegionCodes=incompatibleRegionCodes, alarms=alarms, reset=reset, syslogClientTrap=syslogClientTrap, linkName=linkName, dataPortAutoNegotiation=dataPortAutoNegotiation, sMTPServerIPAddress=sMTPServerIPAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapVersion=sNMPTrapVersion, tFTPServerPortNumber=tFTPServerPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, timeZone=timeZone, linkModeOptimisation=linkModeOptimisation, transmitFreqKHz=transmitFreqKHz, telecomsLoopbackTrap=telecomsLoopbackTrap, hTTPPortNumber=hTTPPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortAutoMdix=dataPortAutoMdix, receiveFreqKHz=receiveFreqKHz, telnetAccessEnabled=telnetAccessEnabled, transmitPower=transmitPower, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, telecomsInterface=telecomsInterface, wirelessLinkStatus=wirelessLinkStatus, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, vLANManagementPriority=vLANManagementPriority, encryptionAlgorithm=encryptionAlgorithm, remoteMaximumTransmitPower=remoteMaximumTransmitPower, userPassword=userPassword, licensedCapacity=licensedCapacity, searchState=searchState, sNTPPollInterval=sNTPPollInterval, regionCode=regionCode, phyStatus=phyStatus, sNTPState=sNTPState, versions=versions, snmpControl=snmpControl, regionCodeTrap=regionCodeTrap, notificationsGroup=notificationsGroup, syslogControlGroup=syslogControlGroup, unitOutOfCalibration=unitOutOfCalibration, smtpGroup=smtpGroup, ptpTraps=ptpTraps, ptpGroups=ptpGroups, dfsTableNumber=dfsTableNumber, PYSNMP_MODULE_ID=cambium, installArmStateTrap=installArmStateTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, vLANPriorityTableNumber=vLANPriorityTableNumber, systemClock=systemClock, siteName=siteName, sntp=sntp, hardwareVersion=hardwareVersion, tDDSynchronizationAlarm=tDDSynchronizationAlarm, receiveModulationModeDetail=receiveModulationModeDetail, telecomsLineCode=telecomsLineCode, installArmState=installArmState, userTableEntry=userTableEntry, systemReset=systemReset, accessMethod=accessMethod, byteErrorRatio=byteErrorRatio, userEnabled=userEnabled, userRole=userRole, bandwidthVariant=bandwidthVariant, dfsGroup=dfsGroup, telecomsCableLength=telecomsCableLength, receiveModulationMode=receiveModulationMode, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tDDControlGroup=tDDControlGroup, hTTPSPortNumber=hTTPSPortNumber, dfsPeaks=dfsPeaks, sNTPServerIPAddress=sNTPServerIPAddress, licenceGroup=licenceGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, management=management, vLANPriorityTable=vLANPriorityTable, phyStatusGroup=phyStatusGroup, syslogStateTrap=syslogStateTrap, pubStats=pubStats, productVariant=productVariant, phyControl=phyControl, dfsTable=dfsTable, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, snmpControlGroup=snmpControlGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, constantPowerSpectralDensity=constantPowerSpectralDensity, sNTPServerPortNumber=sNTPServerPortNumber, supplementary=supplementary, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPTrapTable=sNMPTrapTable, vLANPriorityTableIndex=vLANPriorityTableIndex, targetMACAddress=targetMACAddress, receiveDataRate=receiveDataRate, smtp=smtp, range=range, licence=licence, receiveChannel=receiveChannel, channelBandwidth=channelBandwidth, longitude=longitude, dataPortStatus=dataPortStatus, signalStrengthRatio=signalStrengthRatio, pubStatsGroup=pubStatsGroup, linkLoss=linkLoss, dataPortDisabledWarning=dataPortDisabledWarning, tFTPServerIPAddress=tFTPServerIPAddress, ptp500=ptp500, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tDDSynchronizationMode=tDDSynchronizationMode, syslogControl=syslogControl, frequencyVariant=frequencyVariant, syslogClient=syslogClient, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, capacityLicenseMismatch=capacityLicenseMismatch, ptpCompliance=ptpCompliance, configuration=configuration, ethernetFiberSupport=ethernetFiberSupport, telecomsChannelStatus=telecomsChannelStatus, sNMPPortNumber=sNMPPortNumber, vLANPriorityTableEntry=vLANPriorityTableEntry, userTable=userTable, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, userTableNumber=userTableNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, ptmp=ptmp, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tDDControl=tDDControl, softwareVersion=softwareVersion, aAAControlGroup=aAAControlGroup, sntpGroup=sntpGroup, sNMPv3Enable=sNMPv3Enable, sNMPEnabledTraps=sNMPEnabledTraps, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, daylightSaving=daylightSaving, sNTPSyncTrap=sNTPSyncTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ptp=ptp, managementGroup=managementGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, phyControlGroup=phyControlGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, maximumTransmitPower=maximumTransmitPower, wirelessLinkAvailability=wirelessLinkAvailability, channelChangeTrap=channelChangeTrap, transmitChannel=transmitChannel, supplementaryGroup=supplementaryGroup, productName=productName, receivePower=receivePower, resetGroup=resetGroup, userName=userName, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortConfigurationMismatch=dataPortConfigurationMismatch, cableLoss=cableLoss, vLANPriorityQueueMapping=vLANPriorityQueueMapping, aggregateDataRate=aggregateDataRate, sNMPTrapIPAddress=sNMPTrapIPAddress, configurationGroup=configurationGroup, telecom=telecom, syslogState=syslogState, telnetPortNumber=telnetPortNumber, versionsGroup=versionsGroup, sMTPServerPortNumber=sMTPServerPortNumber, cambium=cambium, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, telecomGroup=telecomGroup, transmitModulationMode=transmitModulationMode)
