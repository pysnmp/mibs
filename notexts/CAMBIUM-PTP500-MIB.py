...
# Produced by pysmi-1.1.8 at Fri Jan  7 00:10:05 2022
...
Counter32, ObjectIdentity, IpAddress, MibIdentifier, Unsigned32, Integer32, TimeTicks, ModuleIdentity, Bits, enterprises, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ObjectIdentity", "IpAddress", "MibIdentifier", "Unsigned32", "Integer32", "TimeTicks", "ModuleIdentity", "Bits", "enterprises", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter64", "NotificationType")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", tDDControlGroup=tDDControlGroup, syslogClient=syslogClient, encryption=encryption, telecomsChannelStatus=telecomsChannelStatus, dataPortWirelessDownAlert=dataPortWirelessDownAlert, latitude=latitude, frequencyVariant=frequencyVariant, dfsTableIndex=dfsTableIndex, PYSNMP_MODULE_ID=cambium, dfs=dfs, vectorError=vectorError, userTableNumber=userTableNumber, hTTPPortNumber=hTTPPortNumber, installArmState=installArmState, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, regionCodeTrap=regionCodeTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, tDDSynchronizationMode=tDDSynchronizationMode, encryptionGroup=encryptionGroup, siteName=siteName, snmpControl=snmpControl, receivePower=receivePower, transmitModulationMode=transmitModulationMode, sNMPTrapPortNumber=sNMPTrapPortNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortDisabledWarning=dataPortDisabledWarning, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, tFTPServerPortNumber=tFTPServerPortNumber, signalStrengthRatio=signalStrengthRatio, longitude=longitude, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernetGroup=ethernetGroup, aAAControlGroup=aAAControlGroup, installArmStateTrap=installArmStateTrap, byteErrorRatio=byteErrorRatio, dataPortAutoMdix=dataPortAutoMdix, systemReset=systemReset, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, capacityLicenseMismatch=capacityLicenseMismatch, enabledDiagnosticAlarms=enabledDiagnosticAlarms, telnetPortNumber=telnetPortNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, wirelessLinkAvailability=wirelessLinkAvailability, aggregateDataRate=aggregateDataRate, managementGroup=managementGroup, telecomsInterface=telecomsInterface, remoteIPAddress=remoteIPAddress, dfsTable=dfsTable, sNTPSync=sNTPSync, telecomGroup=telecomGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, syslogControlGroup=syslogControlGroup, vLANManagementVID=vLANManagementVID, receiveDataRate=receiveDataRate, channelChangeTrap=channelChangeTrap, sNTPState=sNTPState, aAAControl=aAAControl, bootVersion=bootVersion, dataPortStatusTrap=dataPortStatusTrap, installStatusTrap=installStatusTrap, hTTPSPortNumber=hTTPSPortNumber, snmpControlGroup=snmpControlGroup, dfsMeans=dfsMeans, regionCode=regionCode, hTTPAccessEnabled=hTTPAccessEnabled, cambium=cambium, vLANPriorityTable=vLANPriorityTable, versions=versions, supplementary=supplementary, softwareVersion=softwareVersion, sNMPCommunityString=sNMPCommunityString, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, antennaGain=antennaGain, receiveModulationMode=receiveModulationMode, ptpTraps=ptpTraps, timeZone=timeZone, userTable=userTable, cableLoss=cableLoss, range=range, linkName=linkName, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPServerIPAddress=sNTPServerIPAddress, pubStatsGroup=pubStatsGroup, dfsPeaks=dfsPeaks, sMTPSourceEmailAddress=sMTPSourceEmailAddress, channelBandwidth=channelBandwidth, transmitChannel=transmitChannel, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, tDDControl=tDDControl, gatewayIPAddress=gatewayIPAddress, ethernetFiberSupport=ethernetFiberSupport, telecomsCableLength=telecomsCableLength, linkSymmetry=linkSymmetry, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPPollInterval=sNTPPollInterval, receiveFreqKHz=receiveFreqKHz, telecomsLoopback=telecomsLoopback, ptpGroups=ptpGroups, telecomsLoopbackTrap=telecomsLoopbackTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, groupID=groupID, dfsGroup=dfsGroup, targetMACAddress=targetMACAddress, encryptionAlgorithm=encryptionAlgorithm, configurationGroup=configurationGroup, dfsTableEntry=dfsTableEntry, noWirelessChannelAvailable=noWirelessChannelAvailable, userTableEntry=userTableEntry, userRole=userRole, telecom=telecom, productVariant=productVariant, sNMPTrapVersion=sNMPTrapVersion, sntp=sntp, sNMPTrapIPAddress=sNMPTrapIPAddress, ptpCompliance=ptpCompliance, licensedCapacity=licensedCapacity, phyStatus=phyStatus, transmitFreqMHz=transmitFreqMHz, licence=licence, alarms=alarms, sntpGroup=sntpGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ptp500=ptp500, hTTPSAccessEnabled=hTTPSAccessEnabled, dataPortConfigurationMismatch=dataPortConfigurationMismatch, userName=userName, alarmsGroup=alarmsGroup, phyStatusGroup=phyStatusGroup, supplementaryGroup=supplementaryGroup, searchState=searchState, installStatus=installStatus, eIRP=eIRP, syslogStateTrap=syslogStateTrap, sNMPTrapTable=sNMPTrapTable, useVLANForManagementInterfaces=useVLANForManagementInterfaces, accessMethod=accessMethod, telecomsChannelStatusTrap=telecomsChannelStatusTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, pubStats=pubStats, telecomsLineCode=telecomsLineCode, receiveChannel=receiveChannel, daylightSaving=daylightSaving, versionsGroup=versionsGroup, sMTPServerPortNumber=sMTPServerPortNumber, hardwareVersion=hardwareVersion, notificationsGroup=notificationsGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPv3Enable=sNMPv3Enable, syslogClientTrap=syslogClientTrap, incompatibleRegionCodes=incompatibleRegionCodes, systemClock=systemClock, sNTPLastSync=sNTPLastSync, smtpGroup=smtpGroup, iPAddress=iPAddress, resetGroup=resetGroup, syslogState=syslogState, reset=reset, linkLoss=linkLoss, wirelessLinkStatus=wirelessLinkStatus, vLANPriorityTableEntry=vLANPriorityTableEntry, unitOutOfCalibration=unitOutOfCalibration, licenceGroup=licenceGroup, secondarySoftwareVersion=secondarySoftwareVersion, sNTPServerPortNumber=sNTPServerPortNumber, transmitDataRate=transmitDataRate, masterSlaveMode=masterSlaveMode, userEnabled=userEnabled, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitFreqKHz=transmitFreqKHz, dfsTableNumber=dfsTableNumber, management=management, phyControlGroup=phyControlGroup, bandwidthVariant=bandwidthVariant, configuration=configuration, productName=productName, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, subnetMask=subnetMask, dataPortAutoNegotiation=dataPortAutoNegotiation, sMTPEmailAlert=sMTPEmailAlert, vLANPriorityTableNumber=vLANPriorityTableNumber, sNMPEnabledTraps=sNMPEnabledTraps, userPassword=userPassword, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tFTPServerIPAddress=tFTPServerIPAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPPortNumber=sNMPPortNumber, userTableIndex=userTableIndex, sNTPSyncTrap=sNTPSyncTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ethernet=ethernet, syslogControl=syslogControl, ptmp=ptmp, smtp=smtp, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, telnetAccessEnabled=telnetAccessEnabled, ptpTrapPrefix=ptpTrapPrefix, altitude=altitude, incompatibleMasterAndSlave=incompatibleMasterAndSlave, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sMTPEnabledMessages=sMTPEnabledMessages, maximumTransmitPower=maximumTransmitPower, receiveModulationModeDetail=receiveModulationModeDetail, receiveFreqMHz=receiveFreqMHz, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, phyControl=phyControl, vLANManagementPriority=vLANManagementPriority, ptp=ptp, dataPortStatus=dataPortStatus, transmitPower=transmitPower, linkModeOptimisation=linkModeOptimisation)
