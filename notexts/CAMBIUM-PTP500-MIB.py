...
# Produced by pysmi-1.1.3 at Tue Nov 30 02:59:28 2021
...
iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, enterprises, ObjectIdentity, Bits, ModuleIdentity, IpAddress, MibIdentifier, Integer32, Gauge32, Counter32, TimeTicks, NotificationType, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "enterprises", "ObjectIdentity", "Bits", "ModuleIdentity", "IpAddress", "MibIdentifier", "Integer32", "Gauge32", "Counter32", "TimeTicks", "NotificationType", "Counter64")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", aAAControl=aAAControl, systemClock=systemClock, installArmState=installArmState, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, vLANManagementVID=vLANManagementVID, telnetPortNumber=telnetPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dfsGroup=dfsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, tDDSynchronizationMode=tDDSynchronizationMode, vLANPriorityTableIndex=vLANPriorityTableIndex, incompatibleRegionCodes=incompatibleRegionCodes, receiveDataRate=receiveDataRate, sNMPTrapIPAddress=sNMPTrapIPAddress, tDDControl=tDDControl, sNTPSync=sNTPSync, dfsMeans=dfsMeans, vLANManagementPriority=vLANManagementPriority, hTTPAccessEnabled=hTTPAccessEnabled, groupID=groupID, range=range, alarms=alarms, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ethernet=ethernet, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, telecomsLoopback=telecomsLoopback, dfs=dfs, frequencyVariant=frequencyVariant, syslogControl=syslogControl, dataPortWirelessDownAlert=dataPortWirelessDownAlert, cambium=cambium, ptpTrapPrefix=ptpTrapPrefix, dfsPeaks=dfsPeaks, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, iPAddress=iPAddress, sMTPEnabledMessages=sMTPEnabledMessages, dataPortStatus=dataPortStatus, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, userTableNumber=userTableNumber, systemReset=systemReset, sNTPState=sNTPState, aggregateDataRate=aggregateDataRate, userTable=userTable, phyStatus=phyStatus, syslogClientTrap=syslogClientTrap, wirelessLinkStatus=wirelessLinkStatus, sNTPServerPortNumber=sNTPServerPortNumber, sMTPServerIPAddress=sMTPServerIPAddress, transmitModulationMode=transmitModulationMode, hTTPSAccessEnabled=hTTPSAccessEnabled, tDDSynchronizationAlarm=tDDSynchronizationAlarm, reset=reset, latitude=latitude, dfsTableIndex=dfsTableIndex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, userTableIndex=userTableIndex, ptpTraps=ptpTraps, sMTPServerPortNumber=sMTPServerPortNumber, vectorError=vectorError, maximumTransmitPower=maximumTransmitPower, siteName=siteName, dfsTableEntry=dfsTableEntry, enabledDiagnosticAlarms=enabledDiagnosticAlarms, linkName=linkName, dfsTableNumber=dfsTableNumber, masterSlaveMode=masterSlaveMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPEmailAlert=sMTPEmailAlert, tFTPServerIPAddress=tFTPServerIPAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, gatewayIPAddress=gatewayIPAddress, sNMPPortNumber=sNMPPortNumber, receiveFreqMHz=receiveFreqMHz, sNTPLastSync=sNTPLastSync, channelChangeTrap=channelChangeTrap, searchState=searchState, eIRP=eIRP, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, remoteIPAddress=remoteIPAddress, receiveModulationMode=receiveModulationMode, encryptionGroup=encryptionGroup, snmpControlGroup=snmpControlGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transmitFreqKHz=transmitFreqKHz, syslogControlGroup=syslogControlGroup, telnetAccessEnabled=telnetAccessEnabled, linkModeOptimisation=linkModeOptimisation, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, alarmsGroup=alarmsGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, regionCode=regionCode, smtp=smtp, transmitPower=transmitPower, linkSymmetry=linkSymmetry, telecomsInterface=telecomsInterface, telecomsLoopbackTrap=telecomsLoopbackTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, unitOutOfCalibration=unitOutOfCalibration, encryptionAlgorithm=encryptionAlgorithm, dataPortStatusTrap=dataPortStatusTrap, cableLoss=cableLoss, installStatusTrap=installStatusTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, ethernetGroup=ethernetGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, telecomsLineCode=telecomsLineCode, subnetMask=subnetMask, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tDDControlGroup=tDDControlGroup, transmitDataRate=transmitDataRate, ethernetFiberSupport=ethernetFiberSupport, phyStatusGroup=phyStatusGroup, ptpGroups=ptpGroups, userPassword=userPassword, licenceGroup=licenceGroup, aAAControlGroup=aAAControlGroup, management=management, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sntpGroup=sntpGroup, configuration=configuration, versionsGroup=versionsGroup, snmpControl=snmpControl, daylightSaving=daylightSaving, sNMPTrapVersion=sNMPTrapVersion, userTableEntry=userTableEntry, configurationGroup=configurationGroup, installStatus=installStatus, altitude=altitude, channelBandwidth=channelBandwidth, licence=licence, vLANPriorityTableEntry=vLANPriorityTableEntry, smtpGroup=smtpGroup, dataPortAutoMdix=dataPortAutoMdix, sNMPTrapPortNumber=sNMPTrapPortNumber, versions=versions, hTTPSPortNumber=hTTPSPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, syslogStateTrap=syslogStateTrap, capacityLicenseMismatch=capacityLicenseMismatch, telecom=telecom, hTTPPortNumber=hTTPPortNumber, licensedCapacity=licensedCapacity, PYSNMP_MODULE_ID=cambium, telecomsChannelStatus=telecomsChannelStatus, hardwareVersion=hardwareVersion, signalStrengthRatio=signalStrengthRatio, ptp500=ptp500, supplementaryGroup=supplementaryGroup, productName=productName, receiveModulationModeDetail=receiveModulationModeDetail, syslogClient=syslogClient, phyControl=phyControl, transmitFreqMHz=transmitFreqMHz, syslogState=syslogState, resetGroup=resetGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, secondarySoftwareVersion=secondarySoftwareVersion, transmitChannel=transmitChannel, sNMPTrapTableIndex=sNMPTrapTableIndex, accessMethod=accessMethod, notificationsGroup=notificationsGroup, dfsTable=dfsTable, wirelessLinkAvailability=wirelessLinkAvailability, sntp=sntp, timeZone=timeZone, constantPowerSpectralDensity=constantPowerSpectralDensity, receivePower=receivePower, phyControlGroup=phyControlGroup, receiveFreqKHz=receiveFreqKHz, installArmStateTrap=installArmStateTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, antennaGain=antennaGain, ptmp=ptmp, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, bandwidthVariant=bandwidthVariant, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, managementGroup=managementGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, vLANPriorityTable=vLANPriorityTable, sNMPCommunityString=sNMPCommunityString, byteErrorRatio=byteErrorRatio, dataPortDisabledWarning=dataPortDisabledWarning, receiveChannel=receiveChannel, productVariant=productVariant, vLANPriorityQueueMapping=vLANPriorityQueueMapping, linkLoss=linkLoss, sNTPSyncTrap=sNTPSyncTrap, supplementary=supplementary, targetMACAddress=targetMACAddress, userName=userName, linkModeOptimizationMismatch=linkModeOptimizationMismatch, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, longitude=longitude, pubStats=pubStats, encryption=encryption, ptpCompliance=ptpCompliance, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapTable=sNMPTrapTable, ptp=ptp, softwareVersion=softwareVersion, sNTPPollInterval=sNTPPollInterval, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, telecomGroup=telecomGroup, pubStatsGroup=pubStatsGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, regionCodeTrap=regionCodeTrap, bootVersion=bootVersion, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, userRole=userRole, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPServerIPAddress=sNTPServerIPAddress, telecomsCableLength=telecomsCableLength, userEnabled=userEnabled, sNMPv3Enable=sNMPv3Enable)
