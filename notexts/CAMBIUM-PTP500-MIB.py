...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", subnetMask=subnetMask, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, receiveChannel=receiveChannel, installStatusTrap=installStatusTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, userTableIndex=userTableIndex, receiveFreqMHz=receiveFreqMHz, targetMACAddress=targetMACAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, syslogClientTrap=syslogClientTrap, sntp=sntp, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, eIRP=eIRP, cambium=cambium, gatewayIPAddress=gatewayIPAddress, supplementaryGroup=supplementaryGroup, linkLoss=linkLoss, regionCodeTrap=regionCodeTrap, ptpGroups=ptpGroups, ptpCompliance=ptpCompliance, systemClock=systemClock, ptpTrapPrefix=ptpTrapPrefix, management=management, iPAddress=iPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dfsGroup=dfsGroup, installArmStateTrap=installArmStateTrap, tDDControl=tDDControl, constantPowerSpectralDensity=constantPowerSpectralDensity, versions=versions, timeZone=timeZone, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, resetGroup=resetGroup, receivePower=receivePower, regionCode=regionCode, systemReset=systemReset, capacityLicenseMismatch=capacityLicenseMismatch, pubStatsGroup=pubStatsGroup, syslogControlGroup=syslogControlGroup, byteErrorRatio=byteErrorRatio, searchState=searchState, managementGroup=managementGroup, alarms=alarms, PYSNMP_MODULE_ID=cambium, antennaGain=antennaGain, transmitDataRate=transmitDataRate, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNTPSyncTrap=sNTPSyncTrap, wirelessLinkStatus=wirelessLinkStatus, vectorError=vectorError, hTTPSAccessEnabled=hTTPSAccessEnabled, vLANPriorityTableNumber=vLANPriorityTableNumber, userTable=userTable, tDDControlGroup=tDDControlGroup, receiveDataRate=receiveDataRate, ptpTraps=ptpTraps, dataPortStatus=dataPortStatus, userPassword=userPassword, vLANPriorityTable=vLANPriorityTable, dfsTableEntry=dfsTableEntry, receiveModulationModeDetail=receiveModulationModeDetail, dfs=dfs, signalStrengthRatio=signalStrengthRatio, phyStatusGroup=phyStatusGroup, ptp=ptp, dfsTable=dfsTable, remoteIPAddress=remoteIPAddress, tFTPServerIPAddress=tFTPServerIPAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ptp500=ptp500, supplementary=supplementary, licenceGroup=licenceGroup, encryptionGroup=encryptionGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapIPAddress=sNMPTrapIPAddress, userName=userName, sNMPTrapPortNumber=sNMPTrapPortNumber, vLANPriorityTableEntry=vLANPriorityTableEntry, phyControlGroup=phyControlGroup, pubStats=pubStats, telecomsChannelStatus=telecomsChannelStatus, siteName=siteName, receiveModulationMode=receiveModulationMode, linkModeOptimizationMismatch=linkModeOptimizationMismatch, bootVersion=bootVersion, wirelessLinkAvailability=wirelessLinkAvailability, aggregateDataRate=aggregateDataRate, linkSymmetry=linkSymmetry, sMTPEmailAlert=sMTPEmailAlert, configurationGroup=configurationGroup, sMTPEnabledMessages=sMTPEnabledMessages, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPSync=sNTPSync, sNTPPollInterval=sNTPPollInterval, maximumTransmitPower=maximumTransmitPower, incompatibleMasterAndSlave=incompatibleMasterAndSlave, syslogState=syslogState, sntpGroup=sntpGroup, aAAControl=aAAControl, telecomsLineCode=telecomsLineCode, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, range=range, latitude=latitude, daylightSaving=daylightSaving, transmitFreqMHz=transmitFreqMHz, sNTPState=sNTPState, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, secondarySoftwareVersion=secondarySoftwareVersion, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, productName=productName, tDDSynchronizationAlarm=tDDSynchronizationAlarm, noWirelessChannelAvailable=noWirelessChannelAvailable, productVariant=productVariant, hTTPPortNumber=hTTPPortNumber, transmitChannel=transmitChannel, dfsTableIndex=dfsTableIndex, sNMPv3Enable=sNMPv3Enable, dataPortAutoMdix=dataPortAutoMdix, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, transmitFreqKHz=transmitFreqKHz, incompatibleRegionCodes=incompatibleRegionCodes, telnetAccessEnabled=telnetAccessEnabled, frequencyVariant=frequencyVariant, sNMPTrapTable=sNMPTrapTable, smtp=smtp, enabledDiagnosticAlarms=enabledDiagnosticAlarms, telecomsLoopback=telecomsLoopback, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tFTPServerPortNumber=tFTPServerPortNumber, hTTPSPortNumber=hTTPSPortNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, sMTPServerPortNumber=sMTPServerPortNumber, bandwidthVariant=bandwidthVariant, linkName=linkName, sNMPTrapVersion=sNMPTrapVersion, longitude=longitude, sNMPPortNumber=sNMPPortNumber, softwareVersion=softwareVersion, configuration=configuration, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, alarmsGroup=alarmsGroup, snmpControl=snmpControl, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortStatusTrap=dataPortStatusTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, aAAControlGroup=aAAControlGroup, sNTPLastSync=sNTPLastSync, telecom=telecom, encryption=encryption, installStatus=installStatus, groupID=groupID, smtpGroup=smtpGroup, reset=reset, vLANManagementVID=vLANManagementVID, syslogLocalWrappedTrap=syslogLocalWrappedTrap, cableLoss=cableLoss, dfsTableNumber=dfsTableNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, altitude=altitude, channelChangeTrap=channelChangeTrap, phyStatus=phyStatus, receiveFreqKHz=receiveFreqKHz, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPServerPortNumber=sNTPServerPortNumber, telnetPortNumber=telnetPortNumber, snmpControlGroup=snmpControlGroup, licence=licence, telecomGroup=telecomGroup, syslogControl=syslogControl, vLANManagementPriority=vLANManagementPriority, userEnabled=userEnabled, notificationsGroup=notificationsGroup, channelBandwidth=channelBandwidth, sNMPCommunityString=sNMPCommunityString, ethernetFiberSupport=ethernetFiberSupport, sMTPServerIPAddress=sMTPServerIPAddress, vLANPriorityTableIndex=vLANPriorityTableIndex, ethernetGroup=ethernetGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitPower=transmitPower, dataPortDisabledWarning=dataPortDisabledWarning, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, hardwareVersion=hardwareVersion, encryptionAlgorithm=encryptionAlgorithm, phyControl=phyControl, sNMPTrapTableIndex=sNMPTrapTableIndex, ethernet=ethernet, sNMPTrapTableEntry=sNMPTrapTableEntry, transmitModulationMode=transmitModulationMode, userTableNumber=userTableNumber, versionsGroup=versionsGroup, telecomsInterface=telecomsInterface, userTableEntry=userTableEntry, hTTPAccessEnabled=hTTPAccessEnabled, sNMPEnabledTraps=sNMPEnabledTraps, dfsPeaks=dfsPeaks, sNTPServerIPAddress=sNTPServerIPAddress, licensedCapacity=licensedCapacity, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, syslogClient=syslogClient, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, vLANPriorityQueueMapping=vLANPriorityQueueMapping, syslogStateTrap=syslogStateTrap, masterSlaveMode=masterSlaveMode, installArmState=installArmState, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, unitOutOfCalibration=unitOutOfCalibration, accessMethod=accessMethod, linkModeOptimisation=linkModeOptimisation, userRole=userRole, ptmp=ptmp, tDDSynchronizationMode=tDDSynchronizationMode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dfsMeans=dfsMeans, telecomsCableLength=telecomsCableLength, telecomsLoopbackTrap=telecomsLoopbackTrap)
