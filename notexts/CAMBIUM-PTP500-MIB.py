...
# Produced by pysmi-1.1.3 at Wed Dec  8 20:46:32 2021
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPCommunityString=sNMPCommunityString, hardwareVersion=hardwareVersion, installArmState=installArmState, altitude=altitude, ptp=ptp, managementGroup=managementGroup, dfsTableIndex=dfsTableIndex, constantPowerSpectralDensity=constantPowerSpectralDensity, telnetPortNumber=telnetPortNumber, productVariant=productVariant, hTTPPortNumber=hTTPPortNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNTPPollInterval=sNTPPollInterval, systemClock=systemClock, enabledDiagnosticAlarms=enabledDiagnosticAlarms, userTable=userTable, phyControlGroup=phyControlGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dfs=dfs, ptpTraps=ptpTraps, remoteIPAddress=remoteIPAddress, dfsTableEntry=dfsTableEntry, tDDSynchronizationMode=tDDSynchronizationMode, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, syslogClientTrap=syslogClientTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, transmitPower=transmitPower, pubStats=pubStats, unitOutOfCalibration=unitOutOfCalibration, cambium=cambium, pubStatsGroup=pubStatsGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dfsTableNumber=dfsTableNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, transmitFreqMHz=transmitFreqMHz, aAAControl=aAAControl, useVLANForManagementInterfaces=useVLANForManagementInterfaces, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, userTableNumber=userTableNumber, cableLoss=cableLoss, tDDSynchronizationAlarm=tDDSynchronizationAlarm, transmitFreqKHz=transmitFreqKHz, bootVersion=bootVersion, smtpGroup=smtpGroup, licence=licence, productName=productName, telecomsLoopbackTrap=telecomsLoopbackTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, configurationGroup=configurationGroup, telecomsCableLength=telecomsCableLength, sNTPSync=sNTPSync, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tFTPServerIPAddress=tFTPServerIPAddress, phyStatusGroup=phyStatusGroup, management=management, dataPortDisabledWarning=dataPortDisabledWarning, sNMPTrapTableEntry=sNMPTrapTableEntry, syslogControlGroup=syslogControlGroup, frequencyVariant=frequencyVariant, userRole=userRole, vectorError=vectorError, telecomsLoopback=telecomsLoopback, userPassword=userPassword, channelBandwidth=channelBandwidth, encryption=encryption, range=range, linkModeOptimizationMismatch=linkModeOptimizationMismatch, maximumTransmitPower=maximumTransmitPower, installStatus=installStatus, sNMPPortNumber=sNMPPortNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sMTPEmailAlert=sMTPEmailAlert, systemReset=systemReset, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, receiveFreqMHz=receiveFreqMHz, dataPortStatusTrap=dataPortStatusTrap, tDDControl=tDDControl, dfsMeans=dfsMeans, iPAddress=iPAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, telecomGroup=telecomGroup, dataPortStatus=dataPortStatus, linkModeOptimisation=linkModeOptimisation, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, secondarySoftwareVersion=secondarySoftwareVersion, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitDataRate=transmitDataRate, incompatibleMasterAndSlave=incompatibleMasterAndSlave, targetMACAddress=targetMACAddress, telecom=telecom, searchState=searchState, sNMPEnabledTraps=sNMPEnabledTraps, receiveModulationModeDetail=receiveModulationModeDetail, latitude=latitude, byteErrorRatio=byteErrorRatio, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, sNTPSyncTrap=sNTPSyncTrap, channelChangeTrap=channelChangeTrap, ptmp=ptmp, alarmsGroup=alarmsGroup, licensedCapacity=licensedCapacity, vLANPriorityQueueMapping=vLANPriorityQueueMapping, resetGroup=resetGroup, wirelessLinkStatus=wirelessLinkStatus, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, encryptionGroup=encryptionGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, masterSlaveMode=masterSlaveMode, vLANManagementPriority=vLANManagementPriority, smtp=smtp, sNTPState=sNTPState, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ptp500=ptp500, tDDControlGroup=tDDControlGroup, longitude=longitude, syslogStateTrap=syslogStateTrap, userTableIndex=userTableIndex, tFTPServerPortNumber=tFTPServerPortNumber, sNTPLastSync=sNTPLastSync, dfsPeaks=dfsPeaks, capacityLicenseMismatch=capacityLicenseMismatch, sntp=sntp, linkSymmetry=linkSymmetry, regionCodeTrap=regionCodeTrap, dfsGroup=dfsGroup, signalStrengthRatio=signalStrengthRatio, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPv3Enable=sNMPv3Enable, installArmStateTrap=installArmStateTrap, linkLoss=linkLoss, linkName=linkName, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapTableIndex=sNMPTrapTableIndex, softwareVersion=softwareVersion, ptpGroups=ptpGroups, dfsTable=dfsTable, vLANManagementVID=vLANManagementVID, installStatusTrap=installStatusTrap, receiveFreqKHz=receiveFreqKHz, ethernetFiberSupport=ethernetFiberSupport, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, vLANPriorityTableEntry=vLANPriorityTableEntry, telecomsChannelStatus=telecomsChannelStatus, antennaGain=antennaGain, licenceGroup=licenceGroup, regionCode=regionCode, hTTPSPortNumber=hTTPSPortNumber, vLANPriorityTableNumber=vLANPriorityTableNumber, alarms=alarms, notificationsGroup=notificationsGroup, transmitModulationMode=transmitModulationMode, sMTPServerIPAddress=sMTPServerIPAddress, subnetMask=subnetMask, sNMPTrapIPAddress=sNMPTrapIPAddress, transmitChannel=transmitChannel, aggregateDataRate=aggregateDataRate, telnetAccessEnabled=telnetAccessEnabled, receiveDataRate=receiveDataRate, bandwidthVariant=bandwidthVariant, sNTPServerIPAddress=sNTPServerIPAddress, eIRP=eIRP, versionsGroup=versionsGroup, phyControl=phyControl, sMTPServerPortNumber=sMTPServerPortNumber, versions=versions, snmpControlGroup=snmpControlGroup, daylightSaving=daylightSaving, sNTPServerPortNumber=sNTPServerPortNumber, receiveModulationMode=receiveModulationMode, hTTPAccessEnabled=hTTPAccessEnabled, ptpTrapPrefix=ptpTrapPrefix, sntpGroup=sntpGroup, timeZone=timeZone, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, syslogControl=syslogControl, wirelessLinkAvailability=wirelessLinkAvailability, userTableEntry=userTableEntry, sMTPEnabledMessages=sMTPEnabledMessages, sMTPSourceEmailAddress=sMTPSourceEmailAddress, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, phyStatus=phyStatus, ethernetGroup=ethernetGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ptpCompliance=ptpCompliance, receiveChannel=receiveChannel, siteName=siteName, sNMPTrapTable=sNMPTrapTable, aAAControlGroup=aAAControlGroup, configuration=configuration, groupID=groupID, telecomsLineCode=telecomsLineCode, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dataPortAutoMdix=dataPortAutoMdix, receivePower=receivePower, userEnabled=userEnabled, dataPortAutoNegotiation=dataPortAutoNegotiation, vLANPriorityTable=vLANPriorityTable, syslogClient=syslogClient, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, PYSNMP_MODULE_ID=cambium, userName=userName, supplementary=supplementary, supplementaryGroup=supplementaryGroup, syslogState=syslogState, incompatibleRegionCodes=incompatibleRegionCodes, remoteMaximumTransmitPower=remoteMaximumTransmitPower, telecomsInterface=telecomsInterface, encryptionAlgorithm=encryptionAlgorithm, reset=reset, ethernet=ethernet, accessMethod=accessMethod, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, snmpControl=snmpControl, gatewayIPAddress=gatewayIPAddress)
