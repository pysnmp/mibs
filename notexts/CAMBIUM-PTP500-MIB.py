...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", resetGroup=resetGroup, pubStats=pubStats, userTableEntry=userTableEntry, signalStrengthRatio=signalStrengthRatio, receiveFreqKHz=receiveFreqKHz, secondarySoftwareVersion=secondarySoftwareVersion, bootVersion=bootVersion, phyStatus=phyStatus, ptpCompliance=ptpCompliance, telecom=telecom, linkModeOptimisation=linkModeOptimisation, systemClock=systemClock, longitude=longitude, dataPortStatusTrap=dataPortStatusTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, range=range, receiveModulationMode=receiveModulationMode, ptpTrapPrefix=ptpTrapPrefix, managementGroup=managementGroup, vectorError=vectorError, latitude=latitude, wirelessLinkAvailability=wirelessLinkAvailability, supplementaryGroup=supplementaryGroup, regionCodeTrap=regionCodeTrap, frequencyVariant=frequencyVariant, sMTPEnabledMessages=sMTPEnabledMessages, installArmStateTrap=installArmStateTrap, transmitPower=transmitPower, syslogControlGroup=syslogControlGroup, masterSlaveMode=masterSlaveMode, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, telecomsLineCode=telecomsLineCode, dfs=dfs, dataPortConfigurationMismatch=dataPortConfigurationMismatch, cableLoss=cableLoss, telecomsInterface=telecomsInterface, userRole=userRole, linkSymmetry=linkSymmetry, snmpControlGroup=snmpControlGroup, dataPortDisabledWarning=dataPortDisabledWarning, systemReset=systemReset, sNTPState=sNTPState, sNMPTrapTable=sNMPTrapTable, transmitFreqKHz=transmitFreqKHz, userTable=userTable, transmitFreqMHz=transmitFreqMHz, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortStatus=dataPortStatus, phyControlGroup=phyControlGroup, sntpGroup=sntpGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, snmpControl=snmpControl, telnetPortNumber=telnetPortNumber, receiveModulationModeDetail=receiveModulationModeDetail, configuration=configuration, smtpGroup=smtpGroup, targetMACAddress=targetMACAddress, transmitDataRate=transmitDataRate, sMTPSourceEmailAddress=sMTPSourceEmailAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, byteErrorRatio=byteErrorRatio, antennaGain=antennaGain, phyControl=phyControl, alarmsGroup=alarmsGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsTableIndex=dfsTableIndex, iPAddress=iPAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, siteName=siteName, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapTableIndex=sNMPTrapTableIndex, pubStatsGroup=pubStatsGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, receiveDataRate=receiveDataRate, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, syslogClientTrap=syslogClientTrap, syslogStateTrap=syslogStateTrap, softwareVersion=softwareVersion, transmitChannel=transmitChannel, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, gatewayIPAddress=gatewayIPAddress, productVariant=productVariant, vLANPriorityTableNumber=vLANPriorityTableNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPCommunityString=sNMPCommunityString, PYSNMP_MODULE_ID=cambium, sMTPServerIPAddress=sMTPServerIPAddress, wirelessLinkStatus=wirelessLinkStatus, tFTPServerPortNumber=tFTPServerPortNumber, supplementary=supplementary, encryption=encryption, dfsTableEntry=dfsTableEntry, installArmState=installArmState, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dfsPeaks=dfsPeaks, telecomsChannelStatusTrap=telecomsChannelStatusTrap, unitOutOfCalibration=unitOutOfCalibration, vLANPriorityTableIndex=vLANPriorityTableIndex, aAAControl=aAAControl, dataPortAutoMdix=dataPortAutoMdix, ethernetGroup=ethernetGroup, alarms=alarms, sNTPSync=sNTPSync, installStatusTrap=installStatusTrap, ptpTraps=ptpTraps, smtp=smtp, syslogClient=syslogClient, sMTPServerPortNumber=sMTPServerPortNumber, hTTPSPortNumber=hTTPSPortNumber, tFTPServerIPAddress=tFTPServerIPAddress, ethernet=ethernet, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, aggregateDataRate=aggregateDataRate, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, receivePower=receivePower, transmitModulationMode=transmitModulationMode, dfsTable=dfsTable, vLANPriorityQueueMapping=vLANPriorityQueueMapping, telecomsCableLength=telecomsCableLength, userTableNumber=userTableNumber, linkName=linkName, receiveChannel=receiveChannel, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, regionCode=regionCode, phyStatusGroup=phyStatusGroup, licenceGroup=licenceGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, userEnabled=userEnabled, encryptionGroup=encryptionGroup, remoteIPAddress=remoteIPAddress, ptpGroups=ptpGroups, hardwareVersion=hardwareVersion, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, userTableIndex=userTableIndex, licensedCapacity=licensedCapacity, tDDControlGroup=tDDControlGroup, telecomsLoopback=telecomsLoopback, notificationsGroup=notificationsGroup, linkLoss=linkLoss, userPassword=userPassword, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPv3Enable=sNMPv3Enable, searchState=searchState, eIRP=eIRP, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, bandwidthVariant=bandwidthVariant, ptmp=ptmp, maximumTransmitPower=maximumTransmitPower, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, telecomsLoopbackTrap=telecomsLoopbackTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, altitude=altitude, dfsGroup=dfsGroup, ptp=ptp, hTTPSAccessEnabled=hTTPSAccessEnabled, userName=userName, reset=reset, incompatibleRegionCodes=incompatibleRegionCodes, sNTPServerIPAddress=sNTPServerIPAddress, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, channelBandwidth=channelBandwidth, vLANPriorityTable=vLANPriorityTable, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, productName=productName, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, vLANPriorityTableEntry=vLANPriorityTableEntry, sntp=sntp, groupID=groupID, sNMPPortNumber=sNMPPortNumber, hTTPPortNumber=hTTPPortNumber, telecomsChannelStatus=telecomsChannelStatus, timeZone=timeZone, sNTPPollInterval=sNTPPollInterval, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, licence=licence, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, cambium=cambium, sNTPServerPortNumber=sNTPServerPortNumber, sNTPLastSync=sNTPLastSync, daylightSaving=daylightSaving, channelChangeTrap=channelChangeTrap, encryptionAlgorithm=encryptionAlgorithm, ethernetFiberSupport=ethernetFiberSupport, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, installStatus=installStatus, tDDSynchronizationMode=tDDSynchronizationMode, dfsMeans=dfsMeans, hTTPAccessEnabled=hTTPAccessEnabled, configurationGroup=configurationGroup, subnetMask=subnetMask, management=management, capacityLicenseMismatch=capacityLicenseMismatch, syslogState=syslogState, ptp500=ptp500, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, receiveFreqMHz=receiveFreqMHz, vLANManagementPriority=vLANManagementPriority, sNMPEnabledTraps=sNMPEnabledTraps, tDDControl=tDDControl, telecomGroup=telecomGroup, sNTPSyncTrap=sNTPSyncTrap, sNMPTrapVersion=sNMPTrapVersion, versionsGroup=versionsGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, telnetAccessEnabled=telnetAccessEnabled, vLANManagementVID=vLANManagementVID, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogControl=syslogControl, sMTPEmailAlert=sMTPEmailAlert, dfsTableNumber=dfsTableNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, versions=versions, aAAControlGroup=aAAControlGroup, accessMethod=accessMethod)
