...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", transmitChannel=transmitChannel, alarmsGroup=alarmsGroup, receiveFreqMHz=receiveFreqMHz, ptp500=ptp500, syslogControl=syslogControl, encryption=encryption, vLANManagementPriority=vLANManagementPriority, tFTPServerPortNumber=tFTPServerPortNumber, ethernetGroup=ethernetGroup, sntp=sntp, telnetAccessEnabled=telnetAccessEnabled, searchState=searchState, sMTPEmailAlert=sMTPEmailAlert, channelChangeTrap=channelChangeTrap, resetGroup=resetGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, vLANPriorityTableEntry=vLANPriorityTableEntry, telecomGroup=telecomGroup, sNTPState=sNTPState, tDDControlGroup=tDDControlGroup, telecomsLoopback=telecomsLoopback, frequencyVariant=frequencyVariant, regionCodeTrap=regionCodeTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ptpGroups=ptpGroups, receiveChannel=receiveChannel, systemReset=systemReset, antennaGain=antennaGain, smtp=smtp, supplementary=supplementary, dfsGroup=dfsGroup, dfsTable=dfsTable, dataPortStatus=dataPortStatus, ptpTraps=ptpTraps, dataPortAutoMdix=dataPortAutoMdix, installArmState=installArmState, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, secondarySoftwareVersion=secondarySoftwareVersion, aggregateDataRate=aggregateDataRate, productName=productName, timeZone=timeZone, syslogClient=syslogClient, transmitFreqMHz=transmitFreqMHz, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPServerIPAddress=sNTPServerIPAddress, dfsTableEntry=dfsTableEntry, smtpGroup=smtpGroup, eIRP=eIRP, softwareVersion=softwareVersion, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, telecomsInterface=telecomsInterface, cableLoss=cableLoss, userTableEntry=userTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, iPAddress=iPAddress, vLANPriorityTable=vLANPriorityTable, ptpTrapPrefix=ptpTrapPrefix, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sntpGroup=sntpGroup, sNMPEnabledTraps=sNMPEnabledTraps, latitude=latitude, sNMPTrapTableEntry=sNMPTrapTableEntry, aAAControl=aAAControl, sNTPSyncTrap=sNTPSyncTrap, sNMPTrapTable=sNMPTrapTable, licensedCapacity=licensedCapacity, hTTPAccessEnabled=hTTPAccessEnabled, sNTPServerPortNumber=sNTPServerPortNumber, telecomsCableLength=telecomsCableLength, sMTPEnabledMessages=sMTPEnabledMessages, dataPortDisabledWarning=dataPortDisabledWarning, signalStrengthRatio=signalStrengthRatio, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, telecomsChannelStatus=telecomsChannelStatus, regionCode=regionCode, vLANManagementVID=vLANManagementVID, userRole=userRole, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, incompatibleRegionCodes=incompatibleRegionCodes, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, managementGroup=managementGroup, siteName=siteName, sMTPServerIPAddress=sMTPServerIPAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, bandwidthVariant=bandwidthVariant, syslogClientTrap=syslogClientTrap, tDDSynchronizationMode=tDDSynchronizationMode, vectorError=vectorError, encryptionGroup=encryptionGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortConfigurationMismatch=dataPortConfigurationMismatch, tDDSynchronizationAlarm=tDDSynchronizationAlarm, byteErrorRatio=byteErrorRatio, syslogLocalWrappedTrap=syslogLocalWrappedTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, transmitFreqKHz=transmitFreqKHz, vLANPriorityQueueMapping=vLANPriorityQueueMapping, targetMACAddress=targetMACAddress, supplementaryGroup=supplementaryGroup, installStatus=installStatus, pubStats=pubStats, userPassword=userPassword, dataPortStatusTrap=dataPortStatusTrap, alarms=alarms, telecomsChannelStatusTrap=telecomsChannelStatusTrap, installArmStateTrap=installArmStateTrap, channelBandwidth=channelBandwidth, userEnabled=userEnabled, ptpCompliance=ptpCompliance, aAAControlGroup=aAAControlGroup, receiveModulationMode=receiveModulationMode, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, userTableNumber=userTableNumber, syslogStateTrap=syslogStateTrap, groupID=groupID, installStatusTrap=installStatusTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPv3Enable=sNMPv3Enable, dfsTableIndex=dfsTableIndex, remoteMaximumTransmitPower=remoteMaximumTransmitPower, userName=userName, transmitModulationMode=transmitModulationMode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, phyStatus=phyStatus, licence=licence, phyControl=phyControl, reset=reset, cambium=cambium, linkLoss=linkLoss, telnetPortNumber=telnetPortNumber, sMTPServerPortNumber=sMTPServerPortNumber, sNMPCommunityString=sNMPCommunityString, transmitDataRate=transmitDataRate, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, masterSlaveMode=masterSlaveMode, receiveModulationModeDetail=receiveModulationModeDetail, productVariant=productVariant, userTableIndex=userTableIndex, snmpControlGroup=snmpControlGroup, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, hTTPSPortNumber=hTTPSPortNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPTrapTableIndex=sNMPTrapTableIndex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, userTable=userTable, dfsPeaks=dfsPeaks, telecomsLoopbackTrap=telecomsLoopbackTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, useVLANForManagementInterfaces=useVLANForManagementInterfaces, phyControlGroup=phyControlGroup, linkName=linkName, systemClock=systemClock, configurationGroup=configurationGroup, tFTPServerIPAddress=tFTPServerIPAddress, ethernet=ethernet, capacityLicenseMismatch=capacityLicenseMismatch, tDDControl=tDDControl, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, unitOutOfCalibration=unitOutOfCalibration, linkSymmetry=linkSymmetry, sNTPLastSync=sNTPLastSync, noWirelessChannelAvailable=noWirelessChannelAvailable, receiveFreqKHz=receiveFreqKHz, vLANPriorityTableIndex=vLANPriorityTableIndex, syslogState=syslogState, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, snmpControl=snmpControl, sNMPTrapTableNumber=sNMPTrapTableNumber, vLANPriorityTableNumber=vLANPriorityTableNumber, configuration=configuration, versionsGroup=versionsGroup, telecomsLineCode=telecomsLineCode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, gatewayIPAddress=gatewayIPAddress, receiveDataRate=receiveDataRate, daylightSaving=daylightSaving, syslogControlGroup=syslogControlGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dfsMeans=dfsMeans, receivePower=receivePower, sNMPPortNumber=sNMPPortNumber, sNTPSync=sNTPSync, range=range, licenceGroup=licenceGroup, sNMPTrapVersion=sNMPTrapVersion, encryptionAlgorithm=encryptionAlgorithm, ptmp=ptmp, pubStatsGroup=pubStatsGroup, telecom=telecom, management=management, hTTPSAccessEnabled=hTTPSAccessEnabled, maximumTransmitPower=maximumTransmitPower, transmitPower=transmitPower, sNTPPollInterval=sNTPPollInterval, versions=versions, wirelessLinkStatus=wirelessLinkStatus, dataPortAutoNegotiation=dataPortAutoNegotiation, dfsTableNumber=dfsTableNumber, altitude=altitude, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ethernetFiberSupport=ethernetFiberSupport, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, longitude=longitude, wirelessLinkAvailability=wirelessLinkAvailability, constantPowerSpectralDensity=constantPowerSpectralDensity, PYSNMP_MODULE_ID=cambium, subnetMask=subnetMask, hardwareVersion=hardwareVersion, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, accessMethod=accessMethod, phyStatusGroup=phyStatusGroup, hTTPPortNumber=hTTPPortNumber, bootVersion=bootVersion, notificationsGroup=notificationsGroup, linkModeOptimisation=linkModeOptimisation, ptp=ptp, remoteIPAddress=remoteIPAddress, dfs=dfs)
