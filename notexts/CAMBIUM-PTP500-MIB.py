...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", reset=reset, aggregateDataRate=aggregateDataRate, userTableIndex=userTableIndex, sMTPEnabledMessages=sMTPEnabledMessages, dfsTableEntry=dfsTableEntry, sntpGroup=sntpGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, resetGroup=resetGroup, telnetAccessEnabled=telnetAccessEnabled, encryptionAlgorithm=encryptionAlgorithm, telecomsCableLength=telecomsCableLength, ethernet=ethernet, configuration=configuration, sNMPTrapPortNumber=sNMPTrapPortNumber, wirelessLinkStatus=wirelessLinkStatus, dataPortConfigurationMismatch=dataPortConfigurationMismatch, licence=licence, remoteIPAddress=remoteIPAddress, aAAControl=aAAControl, sMTPServerPortNumber=sMTPServerPortNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, phyStatus=phyStatus, bandwidthVariant=bandwidthVariant, wirelessLinkAvailability=wirelessLinkAvailability, telnetPortNumber=telnetPortNumber, receiveFreqKHz=receiveFreqKHz, ptpTraps=ptpTraps, gatewayIPAddress=gatewayIPAddress, ptpTrapPrefix=ptpTrapPrefix, linkModeOptimisation=linkModeOptimisation, receiveModulationMode=receiveModulationMode, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPState=sNTPState, dfsTableIndex=dfsTableIndex, linkName=linkName, supplementary=supplementary, licenceGroup=licenceGroup, range=range, signalStrengthRatio=signalStrengthRatio, sNMPTrapTableNumber=sNMPTrapTableNumber, alarmsGroup=alarmsGroup, tDDControlGroup=tDDControlGroup, hTTPSPortNumber=hTTPSPortNumber, dfs=dfs, sNMPTrapIPAddress=sNMPTrapIPAddress, siteName=siteName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ethernetFiberSupport=ethernetFiberSupport, timeZone=timeZone, ptmp=ptmp, vLANManagementVID=vLANManagementVID, frequencyVariant=frequencyVariant, transmitFreqKHz=transmitFreqKHz, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNTPPollInterval=sNTPPollInterval, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNMPPortNumber=sNMPPortNumber, altitude=altitude, transmitModulationMode=transmitModulationMode, ptp=ptp, ptpGroups=ptpGroups, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, userTableEntry=userTableEntry, encryption=encryption, telecomsLineCode=telecomsLineCode, dataPortAutoMdix=dataPortAutoMdix, sNMPEnabledTraps=sNMPEnabledTraps, telecomsInterface=telecomsInterface, ethernetGroup=ethernetGroup, userRole=userRole, groupID=groupID, snmpControlGroup=snmpControlGroup, installStatusTrap=installStatusTrap, regionCode=regionCode, sNTPSyncTrap=sNTPSyncTrap, syslogControl=syslogControl, smtp=smtp, userTable=userTable, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dataPortStatus=dataPortStatus, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, eIRP=eIRP, snmpControl=snmpControl, sNMPCommunityString=sNMPCommunityString, dfsMeans=dfsMeans, capacityLicenseMismatch=capacityLicenseMismatch, userEnabled=userEnabled, sntp=sntp, syslogControlGroup=syslogControlGroup, receiveModulationModeDetail=receiveModulationModeDetail, daylightSaving=daylightSaving, systemReset=systemReset, channelChangeTrap=channelChangeTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, vLANPriorityTableIndex=vLANPriorityTableIndex, userPassword=userPassword, vLANPriorityTable=vLANPriorityTable, sNMPTrapVersion=sNMPTrapVersion, maximumTransmitPower=maximumTransmitPower, linkLoss=linkLoss, constantPowerSpectralDensity=constantPowerSpectralDensity, sMTPEmailAlert=sMTPEmailAlert, regionCodeTrap=regionCodeTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, vLANManagementPriority=vLANManagementPriority, telecomsLoopback=telecomsLoopback, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortDisabledWarning=dataPortDisabledWarning, receiveChannel=receiveChannel, vLANPriorityQueueMapping=vLANPriorityQueueMapping, productName=productName, ptp500=ptp500, unitOutOfCalibration=unitOutOfCalibration, dfsPeaks=dfsPeaks, sNTPLastSync=sNTPLastSync, accessMethod=accessMethod, tFTPServerPortNumber=tFTPServerPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, hTTPPortNumber=hTTPPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, subnetMask=subnetMask, channelBandwidth=channelBandwidth, phyStatusGroup=phyStatusGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, receivePower=receivePower, dfsGroup=dfsGroup, dfsTableNumber=dfsTableNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPSync=sNTPSync, sNMPTrapTable=sNMPTrapTable, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, transmitPower=transmitPower, notificationsGroup=notificationsGroup, telecomsChannelStatus=telecomsChannelStatus, transmitFreqMHz=transmitFreqMHz, incompatibleRegionCodes=incompatibleRegionCodes, telecomsLoopbackTrap=telecomsLoopbackTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, alarms=alarms, cableLoss=cableLoss, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, hTTPAccessEnabled=hTTPAccessEnabled, licensedCapacity=licensedCapacity, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, vLANPriorityTableNumber=vLANPriorityTableNumber, PYSNMP_MODULE_ID=cambium, tDDSynchronizationStatus=tDDSynchronizationStatus, versions=versions, telecomGroup=telecomGroup, bootVersion=bootVersion, sNTPServerIPAddress=sNTPServerIPAddress, hardwareVersion=hardwareVersion, pubStatsGroup=pubStatsGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, vectorError=vectorError, sNMPv3Enable=sNMPv3Enable, ptpCompliance=ptpCompliance, latitude=latitude, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, telecomsChannelStatusTrap=telecomsChannelStatusTrap, userTableNumber=userTableNumber, syslogState=syslogState, masterSlaveMode=masterSlaveMode, tFTPServerIPAddress=tFTPServerIPAddress, management=management, phyControl=phyControl, hTTPSAccessEnabled=hTTPSAccessEnabled, smtpGroup=smtpGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, versionsGroup=versionsGroup, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, linkSymmetry=linkSymmetry, tDDSynchronizationAlarm=tDDSynchronizationAlarm, longitude=longitude, syslogStateTrap=syslogStateTrap, aAAControlGroup=aAAControlGroup, searchState=searchState, sNTPServerPortNumber=sNTPServerPortNumber, tDDControl=tDDControl, dfsTable=dfsTable, systemClock=systemClock, softwareVersion=softwareVersion, vLANPriorityTableEntry=vLANPriorityTableEntry, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, encryptionGroup=encryptionGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sMTPServerIPAddress=sMTPServerIPAddress, productVariant=productVariant, installStatus=installStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, supplementaryGroup=supplementaryGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, secondarySoftwareVersion=secondarySoftwareVersion, transmitDataRate=transmitDataRate, telecom=telecom, cambium=cambium, tDDSynchronizationMode=tDDSynchronizationMode, installArmStateTrap=installArmStateTrap, configurationGroup=configurationGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, userName=userName, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, managementGroup=managementGroup, iPAddress=iPAddress, byteErrorRatio=byteErrorRatio, syslogClient=syslogClient, dataPortStatusTrap=dataPortStatusTrap, syslogClientTrap=syslogClientTrap, pubStats=pubStats, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, antennaGain=antennaGain, phyControlGroup=phyControlGroup, transmitChannel=transmitChannel, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, installArmState=installArmState, receiveFreqMHz=receiveFreqMHz, receiveDataRate=receiveDataRate, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, targetMACAddress=targetMACAddress)
