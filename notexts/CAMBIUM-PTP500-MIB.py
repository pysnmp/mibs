...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", management=management, phyStatus=phyStatus, sNTPServerIPAddress=sNTPServerIPAddress, vLANManagementPriority=vLANManagementPriority, ptp=ptp, vLANPriorityTableEntry=vLANPriorityTableEntry, dfsTable=dfsTable, sNMPPortNumber=sNMPPortNumber, receivePower=receivePower, snmpControl=snmpControl, sNMPTrapTableEntry=sNMPTrapTableEntry, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ptmp=ptmp, syslogState=syslogState, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, telecomsInterface=telecomsInterface, regionCode=regionCode, useVLANForManagementInterfaces=useVLANForManagementInterfaces, linkName=linkName, softwareVersion=softwareVersion, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, userTableNumber=userTableNumber, licenceGroup=licenceGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, telecom=telecom, userPassword=userPassword, sntp=sntp, transmitDataRate=transmitDataRate, productVariant=productVariant, hTTPAccessEnabled=hTTPAccessEnabled, userTableIndex=userTableIndex, PYSNMP_MODULE_ID=cambium, licensedCapacity=licensedCapacity, phyStatusGroup=phyStatusGroup, configuration=configuration, dataPortStatus=dataPortStatus, ethernetGroup=ethernetGroup, phyControl=phyControl, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, latitude=latitude, gatewayIPAddress=gatewayIPAddress, dfs=dfs, constantPowerSpectralDensity=constantPowerSpectralDensity, linkModeOptimisation=linkModeOptimisation, telecomsCableLength=telecomsCableLength, capacityLicenseMismatch=capacityLicenseMismatch, userRole=userRole, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, vectorError=vectorError, daylightSaving=daylightSaving, cambium=cambium, remoteMaximumTransmitPower=remoteMaximumTransmitPower, smtpGroup=smtpGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, systemReset=systemReset, dfsGroup=dfsGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dfsTableEntry=dfsTableEntry, transmitFreqKHz=transmitFreqKHz, hTTPSAccessEnabled=hTTPSAccessEnabled, reset=reset, dataPortAutoNegotiation=dataPortAutoNegotiation, groupID=groupID, telecomsLoopback=telecomsLoopback, encryptionAlgorithm=encryptionAlgorithm, vLANPriorityQueueMapping=vLANPriorityQueueMapping, telecomsChannelStatusTrap=telecomsChannelStatusTrap, siteName=siteName, configurationGroup=configurationGroup, cableLoss=cableLoss, dataPortConfigurationMismatch=dataPortConfigurationMismatch, installStatus=installStatus, notificationsGroup=notificationsGroup, transmitPower=transmitPower, regionCodeTrap=regionCodeTrap, supplementaryGroup=supplementaryGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, receiveFreqKHz=receiveFreqKHz, aAAControl=aAAControl, sNMPEnabledTraps=sNMPEnabledTraps, linkSymmetry=linkSymmetry, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, syslogControlGroup=syslogControlGroup, dataPortDisabledWarning=dataPortDisabledWarning, altitude=altitude, wirelessLinkAvailability=wirelessLinkAvailability, subnetMask=subnetMask, ptpTrapPrefix=ptpTrapPrefix, bandwidthVariant=bandwidthVariant, sNTPState=sNTPState, pubStatsGroup=pubStatsGroup, targetMACAddress=targetMACAddress, byteErrorRatio=byteErrorRatio, installStatusTrap=installStatusTrap, sNTPLastSync=sNTPLastSync, secondarySoftwareVersion=secondarySoftwareVersion, masterSlaveMode=masterSlaveMode, antennaGain=antennaGain, sMTPEmailAlert=sMTPEmailAlert, incompatibleMasterAndSlave=incompatibleMasterAndSlave, linkLoss=linkLoss, dfsMeans=dfsMeans, sNMPTrapTableNumber=sNMPTrapTableNumber, tDDControl=tDDControl, telecomGroup=telecomGroup, wirelessLinkStatus=wirelessLinkStatus, ptpTraps=ptpTraps, tDDControlGroup=tDDControlGroup, range=range, transmitFreqMHz=transmitFreqMHz, channelChangeTrap=channelChangeTrap, installArmStateTrap=installArmStateTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, licence=licence, userName=userName, syslogClientTrap=syslogClientTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, supplementary=supplementary, searchState=searchState, sNMPTrapPortNumber=sNMPTrapPortNumber, pubStats=pubStats, phyControlGroup=phyControlGroup, sNTPSyncTrap=sNTPSyncTrap, receiveDataRate=receiveDataRate, transmitModulationMode=transmitModulationMode, userEnabled=userEnabled, systemClock=systemClock, dataPortStatusTrap=dataPortStatusTrap, managementGroup=managementGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, receiveModulationModeDetail=receiveModulationModeDetail, dfsPeaks=dfsPeaks, accessMethod=accessMethod, receiveFreqMHz=receiveFreqMHz, unitOutOfCalibration=unitOutOfCalibration, sNTPPollInterval=sNTPPollInterval, transmitChannel=transmitChannel, snmpControlGroup=snmpControlGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, alarms=alarms, sMTPEnabledMessages=sMTPEnabledMessages, bootVersion=bootVersion, dataPortAutoMdix=dataPortAutoMdix, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sntpGroup=sntpGroup, aAAControlGroup=aAAControlGroup, ptpGroups=ptpGroups, syslogClient=syslogClient, telnetAccessEnabled=telnetAccessEnabled, sNMPTrapVersion=sNMPTrapVersion, sNTPSync=sNTPSync, frequencyVariant=frequencyVariant, enabledDiagnosticAlarms=enabledDiagnosticAlarms, vLANPriorityTable=vLANPriorityTable, encryptionGroup=encryptionGroup, telecomsChannelStatus=telecomsChannelStatus, receiveChannel=receiveChannel, vLANManagementVID=vLANManagementVID, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPServerPortNumber=sNTPServerPortNumber, hTTPSPortNumber=hTTPSPortNumber, tFTPServerPortNumber=tFTPServerPortNumber, iPAddress=iPAddress, productName=productName, receiveModulationMode=receiveModulationMode, tFTPServerIPAddress=tFTPServerIPAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ethernetFiberSupport=ethernetFiberSupport, sNMPTrapTableIndex=sNMPTrapTableIndex, userTableEntry=userTableEntry, tDDSynchronizationMode=tDDSynchronizationMode, signalStrengthRatio=signalStrengthRatio, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, syslogControl=syslogControl, alarmsGroup=alarmsGroup, sNMPv3Enable=sNMPv3Enable, userTable=userTable, dfsTableNumber=dfsTableNumber, ptpCompliance=ptpCompliance, smtp=smtp, installArmState=installArmState, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfsTableIndex=dfsTableIndex, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, longitude=longitude, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, encryption=encryption, ptp500=ptp500, versions=versions, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, telnetPortNumber=telnetPortNumber, syslogStateTrap=syslogStateTrap, remoteIPAddress=remoteIPAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPServerIPAddress=sMTPServerIPAddress, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, aggregateDataRate=aggregateDataRate, versionsGroup=versionsGroup, incompatibleRegionCodes=incompatibleRegionCodes, telecomsLoopbackTrap=telecomsLoopbackTrap, maximumTransmitPower=maximumTransmitPower, timeZone=timeZone, hardwareVersion=hardwareVersion, telecomsLineCode=telecomsLineCode, hTTPPortNumber=hTTPPortNumber, resetGroup=resetGroup, sMTPServerPortNumber=sMTPServerPortNumber, channelBandwidth=channelBandwidth, sNMPTrapTable=sNMPTrapTable, sNMPCommunityString=sNMPCommunityString, syslogLocalWrappedTrap=syslogLocalWrappedTrap, eIRP=eIRP, ethernet=ethernet)
