...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", siteName=siteName, syslogClient=syslogClient, telecomsChannelStatus=telecomsChannelStatus, syslogClientTrap=syslogClientTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dfsPeaks=dfsPeaks, userTableNumber=userTableNumber, cableLoss=cableLoss, telnetPortNumber=telnetPortNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitFreqKHz=transmitFreqKHz, regionCodeTrap=regionCodeTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, sNTPServerIPAddress=sNTPServerIPAddress, telecomsLoopbackTrap=telecomsLoopbackTrap, sMTPServerPortNumber=sMTPServerPortNumber, sntp=sntp, pubStats=pubStats, userRole=userRole, telnetAccessEnabled=telnetAccessEnabled, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sNMPTrapTableNumber=sNMPTrapTableNumber, sntpGroup=sntpGroup, versionsGroup=versionsGroup, encryptionAlgorithm=encryptionAlgorithm, syslogState=syslogState, timeZone=timeZone, snmpControlGroup=snmpControlGroup, incompatibleRegionCodes=incompatibleRegionCodes, productName=productName, ptpTrapPrefix=ptpTrapPrefix, receivePower=receivePower, userTable=userTable, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, transmitFreqMHz=transmitFreqMHz, installStatusTrap=installStatusTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, dfsGroup=dfsGroup, ptpCompliance=ptpCompliance, phyStatus=phyStatus, tDDControl=tDDControl, eIRP=eIRP, dfs=dfs, sNMPTrapTable=sNMPTrapTable, managementGroup=managementGroup, sNTPState=sNTPState, latitude=latitude, remoteIPAddress=remoteIPAddress, licensedCapacity=licensedCapacity, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, snmpControl=snmpControl, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, aAAControl=aAAControl, constantPowerSpectralDensity=constantPowerSpectralDensity, smtpGroup=smtpGroup, resetGroup=resetGroup, sMTPEnabledMessages=sMTPEnabledMessages, userTableIndex=userTableIndex, iPAddress=iPAddress, installStatus=installStatus, telecomGroup=telecomGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, daylightSaving=daylightSaving, management=management, productVariant=productVariant, frequencyVariant=frequencyVariant, dfsTable=dfsTable, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, linkName=linkName, reset=reset, sNMPTrapTableIndex=sNMPTrapTableIndex, userTableEntry=userTableEntry, ethernetFiberSupport=ethernetFiberSupport, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, phyControl=phyControl, receiveModulationMode=receiveModulationMode, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, wirelessLinkStatus=wirelessLinkStatus, dataPortStatus=dataPortStatus, telecomsChannelStatusTrap=telecomsChannelStatusTrap, cambium=cambium, vLANPriorityTable=vLANPriorityTable, dfsTableEntry=dfsTableEntry, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telecomsCableLength=telecomsCableLength, sNTPSyncTrap=sNTPSyncTrap, capacityLicenseMismatch=capacityLicenseMismatch, sNMPEnabledTraps=sNMPEnabledTraps, sNTPServerPortNumber=sNTPServerPortNumber, sMTPServerIPAddress=sMTPServerIPAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, vectorError=vectorError, encryptionGroup=encryptionGroup, dfsMeans=dfsMeans, transmitPower=transmitPower, alarms=alarms, hardwareVersion=hardwareVersion, signalStrengthRatio=signalStrengthRatio, dataPortAutoMdix=dataPortAutoMdix, ethernetGroup=ethernetGroup, syslogControlGroup=syslogControlGroup, configurationGroup=configurationGroup, phyStatusGroup=phyStatusGroup, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, syslogStateTrap=syslogStateTrap, gatewayIPAddress=gatewayIPAddress, ethernet=ethernet, regionCode=regionCode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tDDSynchronizationStatus=tDDSynchronizationStatus, pubStatsGroup=pubStatsGroup, configuration=configuration, dataPortConfigurationMismatch=dataPortConfigurationMismatch, range=range, dataPortDisabledWarning=dataPortDisabledWarning, secondarySoftwareVersion=secondarySoftwareVersion, subnetMask=subnetMask, altitude=altitude, sNTPLastSync=sNTPLastSync, vLANManagementPriority=vLANManagementPriority, telecom=telecom, encryption=encryption, ptmp=ptmp, vLANManagementVID=vLANManagementVID, targetMACAddress=targetMACAddress, aggregateDataRate=aggregateDataRate, notificationsGroup=notificationsGroup, groupID=groupID, vLANPriorityTableNumber=vLANPriorityTableNumber, installArmStateTrap=installArmStateTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, receiveFreqKHz=receiveFreqKHz, dataPortAutoNegotiation=dataPortAutoNegotiation, hTTPSPortNumber=hTTPSPortNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, licence=licence, linkLoss=linkLoss, sNMPTrapVersion=sNMPTrapVersion, linkSymmetry=linkSymmetry, sMTPEmailAlert=sMTPEmailAlert, sNMPPortNumber=sNMPPortNumber, wirelessLinkAvailability=wirelessLinkAvailability, ptpTraps=ptpTraps, sNMPv3Enable=sNMPv3Enable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, transmitDataRate=transmitDataRate, systemReset=systemReset, sNMPTrapPortNumber=sNMPTrapPortNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, installArmState=installArmState, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dataPortStatusTrap=dataPortStatusTrap, userPassword=userPassword, receiveModulationModeDetail=receiveModulationModeDetail, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, hTTPAccessEnabled=hTTPAccessEnabled, hTTPPortNumber=hTTPPortNumber, tDDControlGroup=tDDControlGroup, tFTPServerPortNumber=tFTPServerPortNumber, searchState=searchState, receiveFreqMHz=receiveFreqMHz, userName=userName, userEnabled=userEnabled, systemClock=systemClock, hTTPSAccessEnabled=hTTPSAccessEnabled, byteErrorRatio=byteErrorRatio, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, PYSNMP_MODULE_ID=cambium, channelChangeTrap=channelChangeTrap, telecomsInterface=telecomsInterface, noWirelessChannelAvailable=noWirelessChannelAvailable, telecomsLoopback=telecomsLoopback, alarmsGroup=alarmsGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, receiveDataRate=receiveDataRate, longitude=longitude, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNTPPollInterval=sNTPPollInterval, tFTPServerIPAddress=tFTPServerIPAddress, aAAControlGroup=aAAControlGroup, receiveChannel=receiveChannel, unitOutOfCalibration=unitOutOfCalibration, phyControlGroup=phyControlGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ptpGroups=ptpGroups, transmitChannel=transmitChannel, enabledDiagnosticAlarms=enabledDiagnosticAlarms, syslogControl=syslogControl, masterSlaveMode=masterSlaveMode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dfsTableNumber=dfsTableNumber, versions=versions, telecomsLineCode=telecomsLineCode, syslogLocalWrappedTrap=syslogLocalWrappedTrap, accessMethod=accessMethod, sNMPTrapTableEntry=sNMPTrapTableEntry, bandwidthVariant=bandwidthVariant, transmitModulationMode=transmitModulationMode, supplementaryGroup=supplementaryGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPCommunityString=sNMPCommunityString, incompatibleMasterAndSlave=incompatibleMasterAndSlave, licenceGroup=licenceGroup, smtp=smtp, softwareVersion=softwareVersion, dfsTableIndex=dfsTableIndex, linkModeOptimisation=linkModeOptimisation, ptp=ptp, ptp500=ptp500, antennaGain=antennaGain, bootVersion=bootVersion, maximumTransmitPower=maximumTransmitPower, sNTPSync=sNTPSync, channelBandwidth=channelBandwidth, tDDSynchronizationMode=tDDSynchronizationMode, supplementary=supplementary)
