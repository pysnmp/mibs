...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sNMPv3Enable=sNMPv3Enable, telecomsChannelStatus=telecomsChannelStatus, systemReset=systemReset, installStatusTrap=installStatusTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, remoteIPAddress=remoteIPAddress, sNMPPortNumber=sNMPPortNumber, targetMACAddress=targetMACAddress, installStatus=installStatus, byteErrorRatio=byteErrorRatio, telecom=telecom, dfsTableNumber=dfsTableNumber, transmitFreqMHz=transmitFreqMHz, aggregateDataRate=aggregateDataRate, smtp=smtp, sNMPTrapTableNumber=sNMPTrapTableNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, pubStatsGroup=pubStatsGroup, alarms=alarms, hardwareVersion=hardwareVersion, hTTPAccessEnabled=hTTPAccessEnabled, dataPortDisabledWarning=dataPortDisabledWarning, dataPortAutoNegotiation=dataPortAutoNegotiation, systemClock=systemClock, daylightSaving=daylightSaving, sntpGroup=sntpGroup, ptp=ptp, bandwidthVariant=bandwidthVariant, syslogClient=syslogClient, encryptionGroup=encryptionGroup, sNMPTrapVersion=sNMPTrapVersion, sNTPState=sNTPState, telnetPortNumber=telnetPortNumber, ptp500=ptp500, vLANManagementPriority=vLANManagementPriority, transmitFreqKHz=transmitFreqKHz, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ethernet=ethernet, receiveFreqKHz=receiveFreqKHz, linkName=linkName, userPassword=userPassword, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, productName=productName, notificationsGroup=notificationsGroup, receiveModulationModeDetail=receiveModulationModeDetail, telecomsCableLength=telecomsCableLength, management=management, masterSlaveMode=masterSlaveMode, userName=userName, licensedCapacity=licensedCapacity, vectorError=vectorError, alarmsGroup=alarmsGroup, syslogState=syslogState, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, linkSymmetry=linkSymmetry, vLANManagementVID=vLANManagementVID, sNTPLastSync=sNTPLastSync, userTableEntry=userTableEntry, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dfsTable=dfsTable, transmitPower=transmitPower, encryption=encryption, noWirelessChannelAvailable=noWirelessChannelAvailable, dfsTableEntry=dfsTableEntry, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortStatusTrap=dataPortStatusTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, softwareVersion=softwareVersion, sNMPTrapIPAddress=sNMPTrapIPAddress, cableLoss=cableLoss, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dataPortStatus=dataPortStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, configurationGroup=configurationGroup, telecomsInterface=telecomsInterface, receiveFreqMHz=receiveFreqMHz, vLANPriorityQueueMapping=vLANPriorityQueueMapping, dfsGroup=dfsGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, channelBandwidth=channelBandwidth, tFTPServerPortNumber=tFTPServerPortNumber, signalStrengthRatio=signalStrengthRatio, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, vLANPriorityTableEntry=vLANPriorityTableEntry, frequencyVariant=frequencyVariant, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, wirelessLinkStatus=wirelessLinkStatus, phyStatusGroup=phyStatusGroup, supplementaryGroup=supplementaryGroup, iPAddress=iPAddress, linkModeOptimisation=linkModeOptimisation, transmitModulationMode=transmitModulationMode, sNTPSync=sNTPSync, sNTPServerPortNumber=sNTPServerPortNumber, antennaGain=antennaGain, syslogStateTrap=syslogStateTrap, tDDSynchronizationMode=tDDSynchronizationMode, userTableIndex=userTableIndex, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, hTTPPortNumber=hTTPPortNumber, dfsMeans=dfsMeans, telecomsChannelStatusTrap=telecomsChannelStatusTrap, receiveDataRate=receiveDataRate, ptpTraps=ptpTraps, secondarySoftwareVersion=secondarySoftwareVersion, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, sMTPEnabledMessages=sMTPEnabledMessages, ptpGroups=ptpGroups, sNTPPollInterval=sNTPPollInterval, phyControl=phyControl, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, constantPowerSpectralDensity=constantPowerSpectralDensity, ptmp=ptmp, telecomsLineCode=telecomsLineCode, sNMPCommunityString=sNMPCommunityString, versions=versions, encryptionAlgorithm=encryptionAlgorithm, sntp=sntp, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, pubStats=pubStats, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ptpTrapPrefix=ptpTrapPrefix, resetGroup=resetGroup, telnetAccessEnabled=telnetAccessEnabled, vLANPriorityTableNumber=vLANPriorityTableNumber, telecomsLoopbackTrap=telecomsLoopbackTrap, searchState=searchState, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, transmitChannel=transmitChannel, tFTPServerIPAddress=tFTPServerIPAddress, sNTPServerIPAddress=sNTPServerIPAddress, maximumTransmitPower=maximumTransmitPower, incompatibleRegionCodes=incompatibleRegionCodes, phyControlGroup=phyControlGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, receivePower=receivePower, regionCodeTrap=regionCodeTrap, ethernetGroup=ethernetGroup, sMTPEmailAlert=sMTPEmailAlert, accessMethod=accessMethod, productVariant=productVariant, wirelessLinkAvailability=wirelessLinkAvailability, dfsPeaks=dfsPeaks, licence=licence, dataPortAutoMdix=dataPortAutoMdix, sMTPServerIPAddress=sMTPServerIPAddress, transmitDataRate=transmitDataRate, hTTPSAccessEnabled=hTTPSAccessEnabled, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, reset=reset, smtpGroup=smtpGroup, PYSNMP_MODULE_ID=cambium, snmpControl=snmpControl, altitude=altitude, range=range, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, cambium=cambium, sMTPServerPortNumber=sMTPServerPortNumber, longitude=longitude, configuration=configuration, syslogControlGroup=syslogControlGroup, userTable=userTable, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, userRole=userRole, groupID=groupID, telecomsLoopback=telecomsLoopback, tDDControl=tDDControl, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, timeZone=timeZone, phyStatus=phyStatus, latitude=latitude, unitOutOfCalibration=unitOutOfCalibration, bootVersion=bootVersion, supplementary=supplementary, telecomGroup=telecomGroup, eIRP=eIRP, aAAControlGroup=aAAControlGroup, syslogControl=syslogControl, installArmStateTrap=installArmStateTrap, aAAControl=aAAControl, useVLANForManagementInterfaces=useVLANForManagementInterfaces, remoteMaximumTransmitPower=remoteMaximumTransmitPower, managementGroup=managementGroup, userEnabled=userEnabled, linkLoss=linkLoss, sNMPTrapTable=sNMPTrapTable, dfsTableIndex=dfsTableIndex, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tDDSynchronizationStatus=tDDSynchronizationStatus, channelChangeTrap=channelChangeTrap, userTableNumber=userTableNumber, receiveModulationMode=receiveModulationMode, dfs=dfs, subnetMask=subnetMask, ptpCompliance=ptpCompliance, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receiveChannel=receiveChannel, licenceGroup=licenceGroup, tDDControlGroup=tDDControlGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, syslogClientTrap=syslogClientTrap, ethernetFiberSupport=ethernetFiberSupport, versionsGroup=versionsGroup, sNMPEnabledTraps=sNMPEnabledTraps, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, hTTPSPortNumber=hTTPSPortNumber, sNTPSyncTrap=sNTPSyncTrap, siteName=siteName, sNMPTrapPortNumber=sNMPTrapPortNumber, vLANPriorityTable=vLANPriorityTable, incompatibleMasterAndSlave=incompatibleMasterAndSlave, regionCode=regionCode, capacityLicenseMismatch=capacityLicenseMismatch, gatewayIPAddress=gatewayIPAddress, snmpControlGroup=snmpControlGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, installArmState=installArmState)
