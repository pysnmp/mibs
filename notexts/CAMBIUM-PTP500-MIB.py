...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sNMPEnabledTraps=sNMPEnabledTraps, dfsGroup=dfsGroup, ethernet=ethernet, telecomGroup=telecomGroup, userTableNumber=userTableNumber, syslogClientTrap=syslogClientTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapTableEntry=sNMPTrapTableEntry, timeZone=timeZone, regionCode=regionCode, userName=userName, ethernetGroup=ethernetGroup, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tDDControlGroup=tDDControlGroup, hTTPPortNumber=hTTPPortNumber, antennaGain=antennaGain, dfsTableEntry=dfsTableEntry, transmitFreqKHz=transmitFreqKHz, frequencyVariant=frequencyVariant, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, softwareVersion=softwareVersion, hTTPSPortNumber=hTTPSPortNumber, daylightSaving=daylightSaving, syslogStateTrap=syslogStateTrap, syslogClient=syslogClient, dfsMeans=dfsMeans, telecomsLineCode=telecomsLineCode, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, subnetMask=subnetMask, sNMPPortNumber=sNMPPortNumber, licenceGroup=licenceGroup, cableLoss=cableLoss, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, linkSymmetry=linkSymmetry, dfsTableNumber=dfsTableNumber, productVariant=productVariant, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNTPState=sNTPState, syslogState=syslogState, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortConfigurationMismatch=dataPortConfigurationMismatch, telecomsLoopbackTrap=telecomsLoopbackTrap, cambium=cambium, receiveModulationMode=receiveModulationMode, sNMPTrapVersion=sNMPTrapVersion, linkLoss=linkLoss, tDDSynchronizationMode=tDDSynchronizationMode, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, transmitFreqMHz=transmitFreqMHz, dataPortAutoMdix=dataPortAutoMdix, systemReset=systemReset, dfs=dfs, syslogControlGroup=syslogControlGroup, masterSlaveMode=masterSlaveMode, management=management, sNMPCommunityString=sNMPCommunityString, transmitDataRate=transmitDataRate, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, receiveDataRate=receiveDataRate, sntp=sntp, ptpGroups=ptpGroups, tFTPServerIPAddress=tFTPServerIPAddress, snmpControl=snmpControl, noWirelessChannelAvailable=noWirelessChannelAvailable, versionsGroup=versionsGroup, vLANManagementPriority=vLANManagementPriority, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, bandwidthVariant=bandwidthVariant, searchState=searchState, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, licence=licence, dataPortDisabledWarning=dataPortDisabledWarning, encryption=encryption, receiveFreqMHz=receiveFreqMHz, encryptionGroup=encryptionGroup, siteName=siteName, receivePower=receivePower, tDDSynchronizationAlarm=tDDSynchronizationAlarm, productName=productName, userTableIndex=userTableIndex, latitude=latitude, receiveChannel=receiveChannel, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tDDSynchronizationStatus=tDDSynchronizationStatus, userTableEntry=userTableEntry, signalStrengthRatio=signalStrengthRatio, sMTPServerIPAddress=sMTPServerIPAddress, dataPortStatusTrap=dataPortStatusTrap, tDDControl=tDDControl, regionCodeTrap=regionCodeTrap, gatewayIPAddress=gatewayIPAddress, longitude=longitude, vLANPriorityTableEntry=vLANPriorityTableEntry, accessMethod=accessMethod, maximumTransmitPower=maximumTransmitPower, channelBandwidth=channelBandwidth, vLANPriorityQueueMapping=vLANPriorityQueueMapping, supplementaryGroup=supplementaryGroup, transmitPower=transmitPower, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, notificationsGroup=notificationsGroup, alarms=alarms, dfsPeaks=dfsPeaks, sNTPSync=sNTPSync, sMTPEnabledMessages=sMTPEnabledMessages, telecomsLoopback=telecomsLoopback, tFTPServerPortNumber=tFTPServerPortNumber, ptp500=ptp500, sNMPTrapIPAddress=sNMPTrapIPAddress, userTable=userTable, aAAControl=aAAControl, eIRP=eIRP, linkName=linkName, versions=versions, transmitModulationMode=transmitModulationMode, sNTPServerIPAddress=sNTPServerIPAddress, range=range, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfsTable=dfsTable, ptpTraps=ptpTraps, sMTPServerPortNumber=sMTPServerPortNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsTableIndex=dfsTableIndex, syslogLocalWrappedTrap=syslogLocalWrappedTrap, pubStats=pubStats, channelChangeTrap=channelChangeTrap, telecomsInterface=telecomsInterface, vectorError=vectorError, transmitChannel=transmitChannel, bootVersion=bootVersion, dataPortStatus=dataPortStatus, wirelessLinkAvailability=wirelessLinkAvailability, dataPortWirelessDownAlert=dataPortWirelessDownAlert, constantPowerSpectralDensity=constantPowerSpectralDensity, hTTPAccessEnabled=hTTPAccessEnabled, smtpGroup=smtpGroup, vLANManagementVID=vLANManagementVID, installArmState=installArmState, altitude=altitude, resetGroup=resetGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, dataPortAutoNegotiation=dataPortAutoNegotiation, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, aAAControlGroup=aAAControlGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, sntpGroup=sntpGroup, PYSNMP_MODULE_ID=cambium, ptpTrapPrefix=ptpTrapPrefix, userPassword=userPassword, hardwareVersion=hardwareVersion, wirelessLinkStatus=wirelessLinkStatus, installArmStateTrap=installArmStateTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNMPTrapTable=sNMPTrapTable, phyControlGroup=phyControlGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, encryptionAlgorithm=encryptionAlgorithm, remoteIPAddress=remoteIPAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, sNTPLastSync=sNTPLastSync, phyStatusGroup=phyStatusGroup, sNTPPollInterval=sNTPPollInterval, ethernetFiberSupport=ethernetFiberSupport, incompatibleRegionCodes=incompatibleRegionCodes, configuration=configuration, sMTPEmailAlert=sMTPEmailAlert, useVLANForManagementInterfaces=useVLANForManagementInterfaces, pubStatsGroup=pubStatsGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, sMTPSourceEmailAddress=sMTPSourceEmailAddress, systemClock=systemClock, ptp=ptp, smtp=smtp, supplementary=supplementary, targetMACAddress=targetMACAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, incompatibleMasterAndSlave=incompatibleMasterAndSlave, installStatus=installStatus, byteErrorRatio=byteErrorRatio, userEnabled=userEnabled, phyStatus=phyStatus, telecomsChannelStatus=telecomsChannelStatus, sNMPv3Enable=sNMPv3Enable, reset=reset, vLANPriorityTable=vLANPriorityTable, installStatusTrap=installStatusTrap, sNTPSyncTrap=sNTPSyncTrap, capacityLicenseMismatch=capacityLicenseMismatch, sNTPServerPortNumber=sNTPServerPortNumber, aggregateDataRate=aggregateDataRate, secondarySoftwareVersion=secondarySoftwareVersion, snmpControlGroup=snmpControlGroup, telnetPortNumber=telnetPortNumber, groupID=groupID, unitOutOfCalibration=unitOutOfCalibration, telnetAccessEnabled=telnetAccessEnabled, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, iPAddress=iPAddress, ptpCompliance=ptpCompliance, telecomsCableLength=telecomsCableLength, licensedCapacity=licensedCapacity, managementGroup=managementGroup, ptmp=ptmp, syslogControl=syslogControl, linkModeOptimisation=linkModeOptimisation, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receiveFreqKHz=receiveFreqKHz, configurationGroup=configurationGroup, phyControl=phyControl, linkModeOptimizationMismatch=linkModeOptimizationMismatch, userRole=userRole, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, telecom=telecom, receiveModulationModeDetail=receiveModulationModeDetail, alarmsGroup=alarmsGroup)
