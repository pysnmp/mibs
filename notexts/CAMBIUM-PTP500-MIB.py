...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", aAAControl=aAAControl, hTTPSPortNumber=hTTPSPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, userName=userName, vLANPriorityTableIndex=vLANPriorityTableIndex, aAAControlGroup=aAAControlGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, phyControlGroup=phyControlGroup, dataPortDisabledWarning=dataPortDisabledWarning, smtpGroup=smtpGroup, signalStrengthRatio=signalStrengthRatio, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPEnabledTraps=sNMPEnabledTraps, softwareVersion=softwareVersion, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPSync=sNTPSync, remoteIPAddress=remoteIPAddress, linkModeOptimisation=linkModeOptimisation, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, capacityLicenseMismatch=capacityLicenseMismatch, receivePower=receivePower, regionCodeTrap=regionCodeTrap, receiveFreqKHz=receiveFreqKHz, userPassword=userPassword, phyStatusGroup=phyStatusGroup, bootVersion=bootVersion, tDDControl=tDDControl, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, daylightSaving=daylightSaving, telecom=telecom, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPServerPortNumber=sNTPServerPortNumber, ethernetFiberSupport=ethernetFiberSupport, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, constantPowerSpectralDensity=constantPowerSpectralDensity, telnetPortNumber=telnetPortNumber, dfsMeans=dfsMeans, sNMPCommunityString=sNMPCommunityString, encryptionAlgorithm=encryptionAlgorithm, userTableIndex=userTableIndex, dfsGroup=dfsGroup, alarmsGroup=alarmsGroup, receiveChannel=receiveChannel, snmpControlGroup=snmpControlGroup, userTableNumber=userTableNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, byteErrorRatio=byteErrorRatio, PYSNMP_MODULE_ID=cambium, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, alarms=alarms, vectorError=vectorError, dataPortConfigurationMismatch=dataPortConfigurationMismatch, syslogState=syslogState, licenceGroup=licenceGroup, encryption=encryption, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, linkName=linkName, ptpTrapPrefix=ptpTrapPrefix, remoteMaximumTransmitPower=remoteMaximumTransmitPower, eIRP=eIRP, unitOutOfCalibration=unitOutOfCalibration, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, vLANManagementPriority=vLANManagementPriority, antennaGain=antennaGain, hTTPAccessEnabled=hTTPAccessEnabled, systemClock=systemClock, configurationGroup=configurationGroup, masterSlaveMode=masterSlaveMode, transmitFreqKHz=transmitFreqKHz, syslogControlGroup=syslogControlGroup, versions=versions, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPLastSync=sNTPLastSync, installArmStateTrap=installArmStateTrap, linkSymmetry=linkSymmetry, channelBandwidth=channelBandwidth, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tDDControlGroup=tDDControlGroup, cambium=cambium, cableLoss=cableLoss, dfsTable=dfsTable, regionCode=regionCode, sNTPState=sNTPState, userTable=userTable, siteName=siteName, telecomsChannelStatus=telecomsChannelStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, installStatusTrap=installStatusTrap, sntpGroup=sntpGroup, targetMACAddress=targetMACAddress, sNTPSyncTrap=sNTPSyncTrap, transmitModulationMode=transmitModulationMode, sNTPServerIPAddress=sNTPServerIPAddress, dataPortStatus=dataPortStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, dfsPeaks=dfsPeaks, receiveModulationMode=receiveModulationMode, sNMPTrapVersion=sNMPTrapVersion, sNTPPollInterval=sNTPPollInterval, transmitFreqMHz=transmitFreqMHz, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, installStatus=installStatus, supplementaryGroup=supplementaryGroup, sNMPPortNumber=sNMPPortNumber, resetGroup=resetGroup, syslogStateTrap=syslogStateTrap, sMTPEnabledMessages=sMTPEnabledMessages, incompatibleMasterAndSlave=incompatibleMasterAndSlave, wirelessLinkStatus=wirelessLinkStatus, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, telecomGroup=telecomGroup, productName=productName, hTTPPortNumber=hTTPPortNumber, groupID=groupID, receiveFreqMHz=receiveFreqMHz, userEnabled=userEnabled, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dfsTableIndex=dfsTableIndex, transmitDataRate=transmitDataRate, timeZone=timeZone, configuration=configuration, smtp=smtp, installArmState=installArmState, licence=licence, phyStatus=phyStatus, telecomsLineCode=telecomsLineCode, transmitPower=transmitPower, searchState=searchState, ptpTraps=ptpTraps, vLANPriorityQueueMapping=vLANPriorityQueueMapping, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, systemReset=systemReset, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, aggregateDataRate=aggregateDataRate, snmpControl=snmpControl, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPTrapTable=sNMPTrapTable, sNMPv3Enable=sNMPv3Enable, tFTPServerIPAddress=tFTPServerIPAddress, dataPortStatusTrap=dataPortStatusTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, sMTPServerPortNumber=sMTPServerPortNumber, licensedCapacity=licensedCapacity, dataPortAutoMdix=dataPortAutoMdix, gatewayIPAddress=gatewayIPAddress, phyControl=phyControl, receiveDataRate=receiveDataRate, hTTPSAccessEnabled=hTTPSAccessEnabled, telnetAccessEnabled=telnetAccessEnabled, telecomsCableLength=telecomsCableLength, encryptionGroup=encryptionGroup, dfsTableNumber=dfsTableNumber, reset=reset, linkLoss=linkLoss, ethernet=ethernet, versionsGroup=versionsGroup, altitude=altitude, syslogClientTrap=syslogClientTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dfsTableEntry=dfsTableEntry, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, transmitChannel=transmitChannel, management=management, frequencyVariant=frequencyVariant, managementGroup=managementGroup, subnetMask=subnetMask, ptp=ptp, vLANPriorityTable=vLANPriorityTable, sMTPEmailAlert=sMTPEmailAlert, hardwareVersion=hardwareVersion, sntp=sntp, userTableEntry=userTableEntry, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, range=range, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, wirelessLinkAvailability=wirelessLinkAvailability, productVariant=productVariant, ptpGroups=ptpGroups, telecomsLoopbackTrap=telecomsLoopbackTrap, receiveModulationModeDetail=receiveModulationModeDetail, vLANPriorityTableNumber=vLANPriorityTableNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPTrapIPAddress=sNMPTrapIPAddress, telecomsLoopback=telecomsLoopback, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ethernetGroup=ethernetGroup, iPAddress=iPAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ptp500=ptp500, bandwidthVariant=bandwidthVariant, ptpCompliance=ptpCompliance, pubStatsGroup=pubStatsGroup, sMTPServerIPAddress=sMTPServerIPAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, latitude=latitude, longitude=longitude, dataPortAutoNegotiation=dataPortAutoNegotiation, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, accessMethod=accessMethod, maximumTransmitPower=maximumTransmitPower, incompatibleRegionCodes=incompatibleRegionCodes, telecomsInterface=telecomsInterface, syslogControl=syslogControl, pubStats=pubStats, secondarySoftwareVersion=secondarySoftwareVersion, userRole=userRole, vLANPriorityTableEntry=vLANPriorityTableEntry, channelChangeTrap=channelChangeTrap, tDDSynchronizationMode=tDDSynchronizationMode, dfs=dfs, notificationsGroup=notificationsGroup, syslogClient=syslogClient, ptmp=ptmp, vLANManagementVID=vLANManagementVID, supplementary=supplementary, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles)
