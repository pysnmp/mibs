...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", vectorError=vectorError, transmitDataRate=transmitDataRate, ptpCompliance=ptpCompliance, linkLoss=linkLoss, phyStatus=phyStatus, userName=userName, syslogLocalWrappedTrap=syslogLocalWrappedTrap, pubStats=pubStats, vLANPriorityTableEntry=vLANPriorityTableEntry, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, telecomsChannelStatus=telecomsChannelStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPTrapPortNumber=sNMPTrapPortNumber, bootVersion=bootVersion, dataPortAutoNegotiation=dataPortAutoNegotiation, hardwareVersion=hardwareVersion, productVariant=productVariant, sNMPTrapVersion=sNMPTrapVersion, phyControl=phyControl, ptpGroups=ptpGroups, sNMPTrapIPAddress=sNMPTrapIPAddress, versionsGroup=versionsGroup, smtpGroup=smtpGroup, telecomGroup=telecomGroup, vLANManagementVID=vLANManagementVID, vLANPriorityTable=vLANPriorityTable, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPTrapTableIndex=sNMPTrapTableIndex, telecomsCableLength=telecomsCableLength, antennaGain=antennaGain, userTableNumber=userTableNumber, dfsGroup=dfsGroup, phyControlGroup=phyControlGroup, userEnabled=userEnabled, encryptionAlgorithm=encryptionAlgorithm, tFTPServerIPAddress=tFTPServerIPAddress, aAAControl=aAAControl, syslogClientTrap=syslogClientTrap, sNTPState=sNTPState, licenceGroup=licenceGroup, linkSymmetry=linkSymmetry, smtp=smtp, masterSlaveMode=masterSlaveMode, linkName=linkName, channelChangeTrap=channelChangeTrap, regionCode=regionCode, userPassword=userPassword, receiveModulationMode=receiveModulationMode, telecomsLineCode=telecomsLineCode, sNTPPollInterval=sNTPPollInterval, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, constantPowerSpectralDensity=constantPowerSpectralDensity, installArmState=installArmState, resetGroup=resetGroup, supplementary=supplementary, wirelessLinkAvailability=wirelessLinkAvailability, ethernetFiberSupport=ethernetFiberSupport, dataPortStatusTrap=dataPortStatusTrap, channelBandwidth=channelBandwidth, reset=reset, PYSNMP_MODULE_ID=cambium, configuration=configuration, regionCodeTrap=regionCodeTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, wirelessLinkStatus=wirelessLinkStatus, dfsTable=dfsTable, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dataPortConfigurationMismatch=dataPortConfigurationMismatch, daylightSaving=daylightSaving, sMTPServerIPAddress=sMTPServerIPAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tDDControl=tDDControl, siteName=siteName, telnetPortNumber=telnetPortNumber, licensedCapacity=licensedCapacity, sNTPSyncTrap=sNTPSyncTrap, dataPortStatus=dataPortStatus, sNMPCommunityString=sNMPCommunityString, telecomsLoopback=telecomsLoopback, dfsTableNumber=dfsTableNumber, maximumTransmitPower=maximumTransmitPower, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, alarms=alarms, productName=productName, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, bandwidthVariant=bandwidthVariant, syslogClient=syslogClient, tDDControlGroup=tDDControlGroup, gatewayIPAddress=gatewayIPAddress, sNTPServerPortNumber=sNTPServerPortNumber, licence=licence, eIRP=eIRP, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, receiveDataRate=receiveDataRate, receivePower=receivePower, sNTPLastSync=sNTPLastSync, pubStatsGroup=pubStatsGroup, dfsTableIndex=dfsTableIndex, sntp=sntp, dfs=dfs, vLANPriorityTableNumber=vLANPriorityTableNumber, ptp=ptp, timeZone=timeZone, transmitFreqKHz=transmitFreqKHz, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, remoteIPAddress=remoteIPAddress, snmpControl=snmpControl, transmitModulationMode=transmitModulationMode, accessMethod=accessMethod, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ethernet=ethernet, cambium=cambium, transmitChannel=transmitChannel, hTTPSAccessEnabled=hTTPSAccessEnabled, ethernetGroup=ethernetGroup, userRole=userRole, receiveFreqKHz=receiveFreqKHz, installStatus=installStatus, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dfsTableEntry=dfsTableEntry, installArmStateTrap=installArmStateTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, telecomsInterface=telecomsInterface, snmpControlGroup=snmpControlGroup, frequencyVariant=frequencyVariant, transmitFreqMHz=transmitFreqMHz, ptpTrapPrefix=ptpTrapPrefix, sMTPServerPortNumber=sMTPServerPortNumber, receiveModulationModeDetail=receiveModulationModeDetail, sNTPServerIPAddress=sNTPServerIPAddress, iPAddress=iPAddress, versions=versions, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, encryptionGroup=encryptionGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, userTableIndex=userTableIndex, dfsPeaks=dfsPeaks, signalStrengthRatio=signalStrengthRatio, sMTPEnabledMessages=sMTPEnabledMessages, syslogState=syslogState, syslogStateTrap=syslogStateTrap, dataPortDisabledWarning=dataPortDisabledWarning, sMTPEmailAlert=sMTPEmailAlert, managementGroup=managementGroup, unitOutOfCalibration=unitOutOfCalibration, cableLoss=cableLoss, supplementaryGroup=supplementaryGroup, range=range, vLANPriorityQueueMapping=vLANPriorityQueueMapping, systemClock=systemClock, groupID=groupID, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tDDSynchronizationMode=tDDSynchronizationMode, transmitPower=transmitPower, telecomsChannelStatusTrap=telecomsChannelStatusTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPv3Enable=sNMPv3Enable, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPSync=sNTPSync, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ptmp=ptmp, subnetMask=subnetMask, incompatibleMasterAndSlave=incompatibleMasterAndSlave, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, alarmsGroup=alarmsGroup, userTable=userTable, vLANManagementPriority=vLANManagementPriority, telnetAccessEnabled=telnetAccessEnabled, noWirelessChannelAvailable=noWirelessChannelAvailable, hTTPSPortNumber=hTTPSPortNumber, receiveChannel=receiveChannel, userTableEntry=userTableEntry, incompatibleRegionCodes=incompatibleRegionCodes, dataPortWirelessDownAlert=dataPortWirelessDownAlert, vLANPriorityTableIndex=vLANPriorityTableIndex, ptp500=ptp500, sntpGroup=sntpGroup, sNMPPortNumber=sNMPPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, aggregateDataRate=aggregateDataRate, installStatusTrap=installStatusTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, longitude=longitude, telecom=telecom, sNMPTrapTable=sNMPTrapTable, capacityLicenseMismatch=capacityLicenseMismatch, notificationsGroup=notificationsGroup, hTTPAccessEnabled=hTTPAccessEnabled, hTTPPortNumber=hTTPPortNumber, syslogControl=syslogControl, sNMPEnabledTraps=sNMPEnabledTraps, configurationGroup=configurationGroup, latitude=latitude, ptpTraps=ptpTraps, tFTPServerPortNumber=tFTPServerPortNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, syslogControlGroup=syslogControlGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapTableNumber=sNMPTrapTableNumber, management=management, encryption=encryption, tDDSynchronizationStatus=tDDSynchronizationStatus, altitude=altitude, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfsMeans=dfsMeans, systemReset=systemReset, searchState=searchState, byteErrorRatio=byteErrorRatio, dataPortAutoMdix=dataPortAutoMdix, receiveFreqMHz=receiveFreqMHz, targetMACAddress=targetMACAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, softwareVersion=softwareVersion, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, aAAControlGroup=aAAControlGroup, linkModeOptimisation=linkModeOptimisation, phyStatusGroup=phyStatusGroup)
