...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", aggregateDataRate=aggregateDataRate, enabledDiagnosticAlarms=enabledDiagnosticAlarms, secondarySoftwareVersion=secondarySoftwareVersion, dataPortAutoNegotiation=dataPortAutoNegotiation, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, PYSNMP_MODULE_ID=cambium, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsTableIndex=dfsTableIndex, vLANManagementPriority=vLANManagementPriority, syslogState=syslogState, sNMPTrapTable=sNMPTrapTable, telnetPortNumber=telnetPortNumber, transmitModulationMode=transmitModulationMode, groupID=groupID, ptpCompliance=ptpCompliance, vLANPriorityTableEntry=vLANPriorityTableEntry, snmpControl=snmpControl, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, telecomsInterface=telecomsInterface, ethernetFiberSupport=ethernetFiberSupport, dataPortStatusTrap=dataPortStatusTrap, searchState=searchState, phyStatus=phyStatus, softwareVersion=softwareVersion, configuration=configuration, ptp=ptp, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ptpGroups=ptpGroups, aAAControlGroup=aAAControlGroup, sNTPServerPortNumber=sNTPServerPortNumber, syslogClient=syslogClient, pubStatsGroup=pubStatsGroup, hTTPAccessEnabled=hTTPAccessEnabled, sNMPEnabledTraps=sNMPEnabledTraps, targetMACAddress=targetMACAddress, reset=reset, notificationsGroup=notificationsGroup, channelBandwidth=channelBandwidth, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, alarmsGroup=alarmsGroup, sNMPCommunityString=sNMPCommunityString, linkModeOptimisation=linkModeOptimisation, dfsTableNumber=dfsTableNumber, productVariant=productVariant, resetGroup=resetGroup, incompatibleRegionCodes=incompatibleRegionCodes, systemReset=systemReset, sNTPSyncTrap=sNTPSyncTrap, ptmp=ptmp, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPTrapTableNumber=sNMPTrapTableNumber, signalStrengthRatio=signalStrengthRatio, telecomGroup=telecomGroup, userTableNumber=userTableNumber, cambium=cambium, vLANPriorityTableIndex=vLANPriorityTableIndex, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tDDSynchronizationStatus=tDDSynchronizationStatus, channelChangeTrap=channelChangeTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, management=management, installStatusTrap=installStatusTrap, bootVersion=bootVersion, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapTableIndex=sNMPTrapTableIndex, latitude=latitude, linkLoss=linkLoss, encryption=encryption, sNTPSync=sNTPSync, dfsPeaks=dfsPeaks, receiveDataRate=receiveDataRate, ptp500=ptp500, telecomsLoopbackTrap=telecomsLoopbackTrap, sntp=sntp, masterSlaveMode=masterSlaveMode, sMTPEmailAlert=sMTPEmailAlert, userName=userName, supplementary=supplementary, transmitChannel=transmitChannel, syslogStateTrap=syslogStateTrap, sNMPv3Enable=sNMPv3Enable, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, receiveFreqMHz=receiveFreqMHz, subnetMask=subnetMask, sMTPServerPortNumber=sMTPServerPortNumber, syslogControl=syslogControl, vLANPriorityTable=vLANPriorityTable, sNMPPortNumber=sNMPPortNumber, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, range=range, telecomsChannelStatus=telecomsChannelStatus, dfsTableEntry=dfsTableEntry, versionsGroup=versionsGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, daylightSaving=daylightSaving, managementGroup=managementGroup, telecomsCableLength=telecomsCableLength, sMTPServerIPAddress=sMTPServerIPAddress, wirelessLinkAvailability=wirelessLinkAvailability, encryptionGroup=encryptionGroup, longitude=longitude, alarms=alarms, cableLoss=cableLoss, gatewayIPAddress=gatewayIPAddress, tFTPServerIPAddress=tFTPServerIPAddress, sMTPEnabledMessages=sMTPEnabledMessages, linkName=linkName, hTTPPortNumber=hTTPPortNumber, userPassword=userPassword, constantPowerSpectralDensity=constantPowerSpectralDensity, receiveFreqKHz=receiveFreqKHz, systemClock=systemClock, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, telecomsLineCode=telecomsLineCode, transmitFreqMHz=transmitFreqMHz, encryptionAlgorithm=encryptionAlgorithm, transmitPower=transmitPower, snmpControlGroup=snmpControlGroup, userTable=userTable, capacityLicenseMismatch=capacityLicenseMismatch, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, configurationGroup=configurationGroup, receiveModulationMode=receiveModulationMode, receiveModulationModeDetail=receiveModulationModeDetail, altitude=altitude, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNTPLastSync=sNTPLastSync, linkSymmetry=linkSymmetry, receivePower=receivePower, timeZone=timeZone, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vectorError=vectorError, installArmStateTrap=installArmStateTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, iPAddress=iPAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, smtpGroup=smtpGroup, dataPortAutoMdix=dataPortAutoMdix, wirelessLinkStatus=wirelessLinkStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, licenceGroup=licenceGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, dfsGroup=dfsGroup, phyControl=phyControl, dfsMeans=dfsMeans, userRole=userRole, sNTPState=sNTPState, sNMPTrapVersion=sNMPTrapVersion, installArmState=installArmState, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, byteErrorRatio=byteErrorRatio, regionCodeTrap=regionCodeTrap, regionCode=regionCode, tDDControlGroup=tDDControlGroup, hardwareVersion=hardwareVersion, dfs=dfs, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, pubStats=pubStats, maximumTransmitPower=maximumTransmitPower, licence=licence, siteName=siteName, vLANManagementVID=vLANManagementVID, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, telecom=telecom, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ethernet=ethernet, userTableEntry=userTableEntry, vLANPriorityQueueMapping=vLANPriorityQueueMapping, bandwidthVariant=bandwidthVariant, unitOutOfCalibration=unitOutOfCalibration, userEnabled=userEnabled, dataPortStatus=dataPortStatus, ptpTraps=ptpTraps, productName=productName, dfsTable=dfsTable, dataPortDisabledWarning=dataPortDisabledWarning, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPPollInterval=sNTPPollInterval, antennaGain=antennaGain, telnetAccessEnabled=telnetAccessEnabled, accessMethod=accessMethod, ethernetGroup=ethernetGroup, smtp=smtp, licensedCapacity=licensedCapacity, transmitFreqKHz=transmitFreqKHz, telecomsChannelStatusTrap=telecomsChannelStatusTrap, receiveChannel=receiveChannel, phyControlGroup=phyControlGroup, syslogControlGroup=syslogControlGroup, userTableIndex=userTableIndex, sNTPServerIPAddress=sNTPServerIPAddress, tDDControl=tDDControl, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, hTTPSPortNumber=hTTPSPortNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, remoteIPAddress=remoteIPAddress, tDDSynchronizationMode=tDDSynchronizationMode, sntpGroup=sntpGroup, transmitDataRate=transmitDataRate, aAAControl=aAAControl, syslogClientTrap=syslogClientTrap, telecomsLoopback=telecomsLoopback, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, frequencyVariant=frequencyVariant, supplementaryGroup=supplementaryGroup, phyStatusGroup=phyStatusGroup, eIRP=eIRP, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, versions=versions, installStatus=installStatus, sNMPTrapPortNumber=sNMPTrapPortNumber)
