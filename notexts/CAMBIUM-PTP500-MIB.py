...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", dfsMeans=dfsMeans, tFTPServerPortNumber=tFTPServerPortNumber, managementGroup=managementGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, phyStatus=phyStatus, sMTPServerPortNumber=sMTPServerPortNumber, sNTPLastSync=sNTPLastSync, tDDSynchronizationAlarm=tDDSynchronizationAlarm, userTableNumber=userTableNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, installStatus=installStatus, smtp=smtp, configurationGroup=configurationGroup, linkName=linkName, secondarySoftwareVersion=secondarySoftwareVersion, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dfs=dfs, sNTPSyncTrap=sNTPSyncTrap, userTable=userTable, systemReset=systemReset, tFTPServerIPAddress=tFTPServerIPAddress, pubStats=pubStats, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, hardwareVersion=hardwareVersion, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, longitude=longitude, versionsGroup=versionsGroup, signalStrengthRatio=signalStrengthRatio, sMTPServerIPAddress=sMTPServerIPAddress, syslogClientTrap=syslogClientTrap, linkSymmetry=linkSymmetry, sNTPSync=sNTPSync, capacityLicenseMismatch=capacityLicenseMismatch, vLANPriorityQueueMapping=vLANPriorityQueueMapping, gatewayIPAddress=gatewayIPAddress, maximumTransmitPower=maximumTransmitPower, syslogControl=syslogControl, frequencyVariant=frequencyVariant, unitOutOfCalibration=unitOutOfCalibration, linkModeOptimizationMismatch=linkModeOptimizationMismatch, transmitDataRate=transmitDataRate, syslogClient=syslogClient, ethernetFiberSupport=ethernetFiberSupport, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitModulationMode=transmitModulationMode, snmpControl=snmpControl, hTTPSPortNumber=hTTPSPortNumber, transmitFreqMHz=transmitFreqMHz, userRole=userRole, telecomsInterface=telecomsInterface, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, vLANPriorityTable=vLANPriorityTable, antennaGain=antennaGain, subnetMask=subnetMask, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapVersion=sNMPTrapVersion, supplementaryGroup=supplementaryGroup, syslogState=syslogState, sNMPTrapIPAddress=sNMPTrapIPAddress, dfsTableNumber=dfsTableNumber, aggregateDataRate=aggregateDataRate, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, bandwidthVariant=bandwidthVariant, cableLoss=cableLoss, sNMPPortNumber=sNMPPortNumber, telnetAccessEnabled=telnetAccessEnabled, transmitChannel=transmitChannel, systemClock=systemClock, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, groupID=groupID, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, configuration=configuration, dfsTableEntry=dfsTableEntry, tDDSynchronizationMode=tDDSynchronizationMode, targetMACAddress=targetMACAddress, resetGroup=resetGroup, dfsTable=dfsTable, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortAutoMdix=dataPortAutoMdix, range=range, sMTPEnabledMessages=sMTPEnabledMessages, transmitPower=transmitPower, latitude=latitude, encryptionGroup=encryptionGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, encryption=encryption, dataPortDisabledWarning=dataPortDisabledWarning, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, vLANManagementPriority=vLANManagementPriority, sNMPv3Enable=sNMPv3Enable, sNMPTrapTableIndex=sNMPTrapTableIndex, telecomsLoopbackTrap=telecomsLoopbackTrap, alarmsGroup=alarmsGroup, userName=userName, vectorError=vectorError, vLANManagementVID=vLANManagementVID, ethernetGroup=ethernetGroup, softwareVersion=softwareVersion, siteName=siteName, linkLoss=linkLoss, sNMPTrapTableEntry=sNMPTrapTableEntry, userEnabled=userEnabled, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, incompatibleRegionCodes=incompatibleRegionCodes, daylightSaving=daylightSaving, dataPortConfigurationMismatch=dataPortConfigurationMismatch, pubStatsGroup=pubStatsGroup, receiveChannel=receiveChannel, ethernet=ethernet, linkModeOptimisation=linkModeOptimisation, remoteIPAddress=remoteIPAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, receiveFreqKHz=receiveFreqKHz, searchState=searchState, versions=versions, userTableEntry=userTableEntry, notificationsGroup=notificationsGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, wirelessLinkAvailability=wirelessLinkAvailability, tDDSynchronizationStatus=tDDSynchronizationStatus, vLANPriorityTableIndex=vLANPriorityTableIndex, sNMPTrapTableNumber=sNMPTrapTableNumber, alarms=alarms, hTTPAccessEnabled=hTTPAccessEnabled, receivePower=receivePower, sNMPTrapPortNumber=sNMPTrapPortNumber, channelChangeTrap=channelChangeTrap, syslogStateTrap=syslogStateTrap, snmpControlGroup=snmpControlGroup, phyControlGroup=phyControlGroup, ptpTrapPrefix=ptpTrapPrefix, masterSlaveMode=masterSlaveMode, receiveModulationMode=receiveModulationMode, reset=reset, installStatusTrap=installStatusTrap, telecomsChannelStatus=telecomsChannelStatus, ptpGroups=ptpGroups, dataPortStatusTrap=dataPortStatusTrap, encryptionAlgorithm=encryptionAlgorithm, sNTPServerPortNumber=sNTPServerPortNumber, receiveModulationModeDetail=receiveModulationModeDetail, phyStatusGroup=phyStatusGroup, wirelessLinkStatus=wirelessLinkStatus, sNTPState=sNTPState, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPServerIPAddress=sNTPServerIPAddress, tDDControl=tDDControl, sntp=sntp, ptp=ptp, bootVersion=bootVersion, sNMPCommunityString=sNMPCommunityString, altitude=altitude, licence=licence, sNTPPollInterval=sNTPPollInterval, syslogLocalWrappedTrap=syslogLocalWrappedTrap, regionCodeTrap=regionCodeTrap, aAAControl=aAAControl, accessMethod=accessMethod, channelBandwidth=channelBandwidth, smtpGroup=smtpGroup, ptmp=ptmp, iPAddress=iPAddress, userTableIndex=userTableIndex, sNMPEnabledTraps=sNMPEnabledTraps, userPassword=userPassword, telecomsChannelStatusTrap=telecomsChannelStatusTrap, byteErrorRatio=byteErrorRatio, supplementary=supplementary, vLANPriorityTableNumber=vLANPriorityTableNumber, syslogControlGroup=syslogControlGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, telecomGroup=telecomGroup, hTTPPortNumber=hTTPPortNumber, dfsGroup=dfsGroup, receiveDataRate=receiveDataRate, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, telecom=telecom, eIRP=eIRP, ptp500=ptp500, tDDControlGroup=tDDControlGroup, telnetPortNumber=telnetPortNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNMPTrapTable=sNMPTrapTable, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, management=management, productVariant=productVariant, regionCode=regionCode, telecomsLoopback=telecomsLoopback, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, licenceGroup=licenceGroup, cambium=cambium, sntpGroup=sntpGroup, dataPortStatus=dataPortStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, timeZone=timeZone, transmitFreqKHz=transmitFreqKHz, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, aAAControlGroup=aAAControlGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, receiveFreqMHz=receiveFreqMHz, licensedCapacity=licensedCapacity, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telecomsLineCode=telecomsLineCode, sMTPEmailAlert=sMTPEmailAlert, ptpTraps=ptpTraps, telecomsCableLength=telecomsCableLength, dfsTableIndex=dfsTableIndex, incompatibleMasterAndSlave=incompatibleMasterAndSlave, productName=productName, ptpCompliance=ptpCompliance, installArmStateTrap=installArmStateTrap, PYSNMP_MODULE_ID=cambium, dfsPeaks=dfsPeaks, installArmState=installArmState, vLANPriorityTableEntry=vLANPriorityTableEntry, phyControl=phyControl, useVLANForManagementInterfaces=useVLANForManagementInterfaces)
