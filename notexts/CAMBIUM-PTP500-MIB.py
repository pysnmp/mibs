...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkSymmetry=linkSymmetry, versions=versions, vLANPriorityTableNumber=vLANPriorityTableNumber, dfsTableIndex=dfsTableIndex, userTableEntry=userTableEntry, cambium=cambium, smtpGroup=smtpGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, vLANManagementVID=vLANManagementVID, telecomsLineCode=telecomsLineCode, telecomsLoopback=telecomsLoopback, receiveModulationMode=receiveModulationMode, snmpControlGroup=snmpControlGroup, bandwidthVariant=bandwidthVariant, remoteIPAddress=remoteIPAddress, altitude=altitude, bootVersion=bootVersion, tDDControl=tDDControl, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, phyControl=phyControl, productVariant=productVariant, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, daylightSaving=daylightSaving, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, eIRP=eIRP, dataPortDisabledWarning=dataPortDisabledWarning, syslogStateTrap=syslogStateTrap, ptp500=ptp500, cableLoss=cableLoss, groupID=groupID, encryptionGroup=encryptionGroup, receiveFreqKHz=receiveFreqKHz, syslogLocalWrappedTrap=syslogLocalWrappedTrap, subnetMask=subnetMask, sNMPTrapVersion=sNMPTrapVersion, sNTPSyncTrap=sNTPSyncTrap, telnetPortNumber=telnetPortNumber, channelChangeTrap=channelChangeTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, ptp=ptp, telecomsInterface=telecomsInterface, sNMPTrapPortNumber=sNMPTrapPortNumber, vLANPriorityTableEntry=vLANPriorityTableEntry, masterSlaveMode=masterSlaveMode, transmitFreqMHz=transmitFreqMHz, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dfsTableEntry=dfsTableEntry, dataPortAutoMdix=dataPortAutoMdix, licensedCapacity=licensedCapacity, managementGroup=managementGroup, incompatibleRegionCodes=incompatibleRegionCodes, softwareVersion=softwareVersion, gatewayIPAddress=gatewayIPAddress, phyStatusGroup=phyStatusGroup, ptpCompliance=ptpCompliance, tFTPServerPortNumber=tFTPServerPortNumber, supplementaryGroup=supplementaryGroup, capacityLicenseMismatch=capacityLicenseMismatch, transmitModulationMode=transmitModulationMode, alarms=alarms, sNTPPollInterval=sNTPPollInterval, sNMPv3Enable=sNMPv3Enable, regionCodeTrap=regionCodeTrap, range=range, vLANManagementPriority=vLANManagementPriority, sNTPServerIPAddress=sNTPServerIPAddress, phyControlGroup=phyControlGroup, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, vectorError=vectorError, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, receiveDataRate=receiveDataRate, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, supplementary=supplementary, transmitPower=transmitPower, phyStatus=phyStatus, sNTPState=sNTPState, ptmp=ptmp, sNMPCommunityString=sNMPCommunityString, dfs=dfs, sMTPEnabledMessages=sMTPEnabledMessages, maximumTransmitPower=maximumTransmitPower, sMTPServerIPAddress=sMTPServerIPAddress, regionCode=regionCode, versionsGroup=versionsGroup, userRole=userRole, dfsGroup=dfsGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, dataPortWirelessDownAlert=dataPortWirelessDownAlert, systemReset=systemReset, ethernet=ethernet, userName=userName, telecomsLoopbackTrap=telecomsLoopbackTrap, resetGroup=resetGroup, installStatusTrap=installStatusTrap, encryption=encryption, tDDControlGroup=tDDControlGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ptpTraps=ptpTraps, receiveChannel=receiveChannel, dfsTable=dfsTable, constantPowerSpectralDensity=constantPowerSpectralDensity, configuration=configuration, ptpGroups=ptpGroups, vLANPriorityTableIndex=vLANPriorityTableIndex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, longitude=longitude, antennaGain=antennaGain, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, receiveFreqMHz=receiveFreqMHz, dfsTableNumber=dfsTableNumber, sNTPSync=sNTPSync, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, linkName=linkName, ptpTrapPrefix=ptpTrapPrefix, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, linkModeOptimizationMismatch=linkModeOptimizationMismatch, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, reset=reset, dataPortAutoNegotiation=dataPortAutoNegotiation, userTableNumber=userTableNumber, aAAControlGroup=aAAControlGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogClientTrap=syslogClientTrap, userTable=userTable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNMPTrapTableIndex=sNMPTrapTableIndex, noWirelessChannelAvailable=noWirelessChannelAvailable, hTTPPortNumber=hTTPPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, receivePower=receivePower, siteName=siteName, sNMPTrapTableEntry=sNMPTrapTableEntry, hardwareVersion=hardwareVersion, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, userPassword=userPassword, sntpGroup=sntpGroup, frequencyVariant=frequencyVariant, receiveModulationModeDetail=receiveModulationModeDetail, dfsMeans=dfsMeans, productName=productName, sNMPTrapIPAddress=sNMPTrapIPAddress, timeZone=timeZone, dataPortStatusTrap=dataPortStatusTrap, syslogControlGroup=syslogControlGroup, syslogControl=syslogControl, linkModeOptimisation=linkModeOptimisation, sntp=sntp, tFTPServerIPAddress=tFTPServerIPAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfsPeaks=dfsPeaks, snmpControl=snmpControl, telecom=telecom, transmitChannel=transmitChannel, wirelessLinkAvailability=wirelessLinkAvailability, linkLoss=linkLoss, sNTPServerPortNumber=sNTPServerPortNumber, installStatus=installStatus, channelBandwidth=channelBandwidth, iPAddress=iPAddress, targetMACAddress=targetMACAddress, sNMPTrapTable=sNMPTrapTable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, hTTPSPortNumber=hTTPSPortNumber, encryptionAlgorithm=encryptionAlgorithm, syslogClient=syslogClient, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, notificationsGroup=notificationsGroup, telecomGroup=telecomGroup, PYSNMP_MODULE_ID=cambium, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNTPLastSync=sNTPLastSync, licence=licence, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tDDSynchronizationStatus=tDDSynchronizationStatus, dataPortConfigurationMismatch=dataPortConfigurationMismatch, management=management, installArmStateTrap=installArmStateTrap, aAAControl=aAAControl, vLANPriorityTable=vLANPriorityTable, userTableIndex=userTableIndex, systemClock=systemClock, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, syslogState=syslogState, sMTPServerPortNumber=sMTPServerPortNumber, pubStatsGroup=pubStatsGroup, telecomsCableLength=telecomsCableLength, dataPortStatus=dataPortStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, signalStrengthRatio=signalStrengthRatio, sMTPEmailAlert=sMTPEmailAlert, transmitDataRate=transmitDataRate, transmitFreqKHz=transmitFreqKHz, hTTPAccessEnabled=hTTPAccessEnabled, sNMPEnabledTraps=sNMPEnabledTraps, licenceGroup=licenceGroup, telecomsChannelStatus=telecomsChannelStatus, unitOutOfCalibration=unitOutOfCalibration, alarmsGroup=alarmsGroup, sNMPPortNumber=sNMPPortNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, vLANPriorityQueueMapping=vLANPriorityQueueMapping, ethernetFiberSupport=ethernetFiberSupport, wirelessLinkStatus=wirelessLinkStatus, configurationGroup=configurationGroup, byteErrorRatio=byteErrorRatio, latitude=latitude, telnetAccessEnabled=telnetAccessEnabled, pubStats=pubStats, aggregateDataRate=aggregateDataRate, smtp=smtp, searchState=searchState, installArmState=installArmState, userEnabled=userEnabled, tDDSynchronizationMode=tDDSynchronizationMode, accessMethod=accessMethod, ethernetGroup=ethernetGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap)
