...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, timeZone=timeZone, groupID=groupID, sNTPSyncTrap=sNTPSyncTrap, licensedCapacity=licensedCapacity, secondarySoftwareVersion=secondarySoftwareVersion, sNTPSync=sNTPSync, installArmState=installArmState, searchState=searchState, vLANPriorityTableNumber=vLANPriorityTableNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, hTTPAccessEnabled=hTTPAccessEnabled, longitude=longitude, supplementaryGroup=supplementaryGroup, sMTPEnabledMessages=sMTPEnabledMessages, linkModeOptimisation=linkModeOptimisation, userTableNumber=userTableNumber, aggregateDataRate=aggregateDataRate, dataPortAutoNegotiation=dataPortAutoNegotiation, sMTPEmailAlert=sMTPEmailAlert, ptp=ptp, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, transmitChannel=transmitChannel, sNMPTrapTable=sNMPTrapTable, vLANManagementVID=vLANManagementVID, dfsMeans=dfsMeans, sNTPState=sNTPState, siteName=siteName, sMTPServerIPAddress=sMTPServerIPAddress, range=range, remoteIPAddress=remoteIPAddress, gatewayIPAddress=gatewayIPAddress, alarms=alarms, reset=reset, installArmStateTrap=installArmStateTrap, tFTPServerIPAddress=tFTPServerIPAddress, tDDSynchronizationMode=tDDSynchronizationMode, noWirelessChannelAvailable=noWirelessChannelAvailable, sNTPPollInterval=sNTPPollInterval, userName=userName, phyControl=phyControl, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, telecomsInterface=telecomsInterface, tFTPServerPortNumber=tFTPServerPortNumber, cambium=cambium, telecomsChannelStatus=telecomsChannelStatus, dfsTableEntry=dfsTableEntry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sMTPServerPortNumber=sMTPServerPortNumber, unitOutOfCalibration=unitOutOfCalibration, sntp=sntp, vLANManagementPriority=vLANManagementPriority, telecomsCableLength=telecomsCableLength, telecom=telecom, userPassword=userPassword, bootVersion=bootVersion, daylightSaving=daylightSaving, ptpGroups=ptpGroups, receiveFreqMHz=receiveFreqMHz, telecomsLoopback=telecomsLoopback, wirelessLinkAvailability=wirelessLinkAvailability, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, smtpGroup=smtpGroup, encryption=encryption, snmpControlGroup=snmpControlGroup, telecomsLineCode=telecomsLineCode, sNTPServerIPAddress=sNTPServerIPAddress, vLANPriorityTableIndex=vLANPriorityTableIndex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, installStatus=installStatus, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, userTableIndex=userTableIndex, ptpTraps=ptpTraps, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfs=dfs, dataPortStatus=dataPortStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, vLANPriorityTable=vLANPriorityTable, syslogState=syslogState, licenceGroup=licenceGroup, regionCodeTrap=regionCodeTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, encryptionAlgorithm=encryptionAlgorithm, dfsPeaks=dfsPeaks, tDDSynchronizationStatus=tDDSynchronizationStatus, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, syslogStateTrap=syslogStateTrap, sNTPLastSync=sNTPLastSync, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, syslogClientTrap=syslogClientTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, channelChangeTrap=channelChangeTrap, ptpCompliance=ptpCompliance, ethernetGroup=ethernetGroup, aAAControl=aAAControl, bandwidthVariant=bandwidthVariant, productVariant=productVariant, receiveDataRate=receiveDataRate, sNMPTrapVersion=sNMPTrapVersion, dfsTableIndex=dfsTableIndex, accessMethod=accessMethod, sNMPTrapTableEntry=sNMPTrapTableEntry, aAAControlGroup=aAAControlGroup, pubStatsGroup=pubStatsGroup, dataPortDisabledWarning=dataPortDisabledWarning, telecomsChannelStatusTrap=telecomsChannelStatusTrap, systemReset=systemReset, regionCode=regionCode, byteErrorRatio=byteErrorRatio, encryptionGroup=encryptionGroup, phyStatus=phyStatus, pubStats=pubStats, signalStrengthRatio=signalStrengthRatio, linkModeOptimizationMismatch=linkModeOptimizationMismatch, systemClock=systemClock, configurationGroup=configurationGroup, notificationsGroup=notificationsGroup, sNMPv3Enable=sNMPv3Enable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPCommunityString=sNMPCommunityString, altitude=altitude, snmpControl=snmpControl, antennaGain=antennaGain, targetMACAddress=targetMACAddress, transmitPower=transmitPower, sNMPTrapPortNumber=sNMPTrapPortNumber, dfsTable=dfsTable, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, channelBandwidth=channelBandwidth, phyStatusGroup=phyStatusGroup, cableLoss=cableLoss, softwareVersion=softwareVersion, versions=versions, management=management, hTTPSAccessEnabled=hTTPSAccessEnabled, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, wirelessLinkStatus=wirelessLinkStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, linkSymmetry=linkSymmetry, frequencyVariant=frequencyVariant, transmitFreqMHz=transmitFreqMHz, incompatibleRegionCodes=incompatibleRegionCodes, sNMPPortNumber=sNMPPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapIPAddress=sNMPTrapIPAddress, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, transmitFreqKHz=transmitFreqKHz, dfsGroup=dfsGroup, smtp=smtp, tDDControl=tDDControl, receiveModulationMode=receiveModulationMode, latitude=latitude, PYSNMP_MODULE_ID=cambium, ethernet=ethernet, productName=productName, telnetPortNumber=telnetPortNumber, userTable=userTable, iPAddress=iPAddress, managementGroup=managementGroup, ptmp=ptmp, versionsGroup=versionsGroup, subnetMask=subnetMask, maximumTransmitPower=maximumTransmitPower, receiveFreqKHz=receiveFreqKHz, ptp500=ptp500, telecomGroup=telecomGroup, dataPortStatusTrap=dataPortStatusTrap, resetGroup=resetGroup, dfsTableNumber=dfsTableNumber, masterSlaveMode=masterSlaveMode, hTTPSPortNumber=hTTPSPortNumber, vectorError=vectorError, ethernetFiberSupport=ethernetFiberSupport, constantPowerSpectralDensity=constantPowerSpectralDensity, receiveChannel=receiveChannel, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sntpGroup=sntpGroup, receivePower=receivePower, vLANPriorityQueueMapping=vLANPriorityQueueMapping, telnetAccessEnabled=telnetAccessEnabled, sNTPServerPortNumber=sNTPServerPortNumber, dataPortAutoMdix=dataPortAutoMdix, configuration=configuration, remoteMaximumTransmitPower=remoteMaximumTransmitPower, supplementary=supplementary, linkName=linkName, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, linkLoss=linkLoss, alarmsGroup=alarmsGroup, tDDControlGroup=tDDControlGroup, syslogControlGroup=syslogControlGroup, syslogClient=syslogClient, licence=licence, userRole=userRole, useVLANForManagementInterfaces=useVLANForManagementInterfaces, userEnabled=userEnabled, syslogControl=syslogControl, userTableEntry=userTableEntry, installStatusTrap=installStatusTrap, transmitModulationMode=transmitModulationMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitDataRate=transmitDataRate, phyControlGroup=phyControlGroup, receiveModulationModeDetail=receiveModulationModeDetail, hardwareVersion=hardwareVersion, capacityLicenseMismatch=capacityLicenseMismatch, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, eIRP=eIRP, ptpTrapPrefix=ptpTrapPrefix, hTTPPortNumber=hTTPPortNumber)
