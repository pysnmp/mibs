...
# Produced by pysmi-1.1.8 at Fri Jan  7 00:57:40 2022
...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, iso, Counter64, Gauge32, ObjectIdentity, Bits, Unsigned32, MibIdentifier, IpAddress, Integer32, enterprises, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "iso", "Counter64", "Gauge32", "ObjectIdentity", "Bits", "Unsigned32", "MibIdentifier", "IpAddress", "Integer32", "enterprises", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sntp=sntp, telecom=telecom, constantPowerSpectralDensity=constantPowerSpectralDensity, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPCommunityString=sNMPCommunityString, vLANManagementPriority=vLANManagementPriority, secondarySoftwareVersion=secondarySoftwareVersion, wirelessLinkStatus=wirelessLinkStatus, cableLoss=cableLoss, bandwidthVariant=bandwidthVariant, vLANPriorityTableEntry=vLANPriorityTableEntry, receiveModulationModeDetail=receiveModulationModeDetail, longitude=longitude, userTableEntry=userTableEntry, dfsTableIndex=dfsTableIndex, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, PYSNMP_MODULE_ID=cambium, sNTPSync=sNTPSync, userPassword=userPassword, sNMPTrapTable=sNMPTrapTable, phyStatusGroup=phyStatusGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, licence=licence, syslogControlGroup=syslogControlGroup, alarmsGroup=alarmsGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, versionsGroup=versionsGroup, daylightSaving=daylightSaving, capacityLicenseMismatch=capacityLicenseMismatch, notificationsGroup=notificationsGroup, sNMPPortNumber=sNMPPortNumber, dfsMeans=dfsMeans, syslogState=syslogState, ptpTraps=ptpTraps, vLANPriorityTableNumber=vLANPriorityTableNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, ptp=ptp, sMTPServerPortNumber=sMTPServerPortNumber, pubStatsGroup=pubStatsGroup, wirelessLinkAvailability=wirelessLinkAvailability, syslogStateTrap=syslogStateTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, management=management, ptmp=ptmp, phyStatus=phyStatus, eIRP=eIRP, sNTPPollInterval=sNTPPollInterval, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dfsTableNumber=dfsTableNumber, sNMPEnabledTraps=sNMPEnabledTraps, antennaGain=antennaGain, sntpGroup=sntpGroup, pubStats=pubStats, linkModeOptimisation=linkModeOptimisation, telecomsLoopbackTrap=telecomsLoopbackTrap, snmpControl=snmpControl, tDDSynchronizationStatus=tDDSynchronizationStatus, bootVersion=bootVersion, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, linkLoss=linkLoss, userTable=userTable, telecomGroup=telecomGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, vLANPriorityQueueMapping=vLANPriorityQueueMapping, telecomsLineCode=telecomsLineCode, tFTPServerPortNumber=tFTPServerPortNumber, hTTPAccessEnabled=hTTPAccessEnabled, systemReset=systemReset, tFTPServerIPAddress=tFTPServerIPAddress, resetGroup=resetGroup, smtp=smtp, encryptionAlgorithm=encryptionAlgorithm, ptpTrapPrefix=ptpTrapPrefix, maximumTransmitPower=maximumTransmitPower, groupID=groupID, vectorError=vectorError, configuration=configuration, dataPortWirelessDownAlert=dataPortWirelessDownAlert, receivePower=receivePower, receiveModulationMode=receiveModulationMode, hTTPSAccessEnabled=hTTPSAccessEnabled, searchState=searchState, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, linkSymmetry=linkSymmetry, targetMACAddress=targetMACAddress, phyControl=phyControl, ethernetGroup=ethernetGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dataPortStatusTrap=dataPortStatusTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sMTPServerIPAddress=sMTPServerIPAddress, accessMethod=accessMethod, alarms=alarms, iPAddress=iPAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapPortNumber=sNMPTrapPortNumber, dfsPeaks=dfsPeaks, signalStrengthRatio=signalStrengthRatio, telnetAccessEnabled=telnetAccessEnabled, enabledDiagnosticAlarms=enabledDiagnosticAlarms, transmitPower=transmitPower, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, managementGroup=managementGroup, encryptionGroup=encryptionGroup, tDDControlGroup=tDDControlGroup, userEnabled=userEnabled, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, userTableIndex=userTableIndex, ptp500=ptp500, incompatibleRegionCodes=incompatibleRegionCodes, encryption=encryption, tDDSynchronizationMode=tDDSynchronizationMode, dataPortAutoMdix=dataPortAutoMdix, aggregateDataRate=aggregateDataRate, installArmState=installArmState, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, frequencyVariant=frequencyVariant, hTTPPortNumber=hTTPPortNumber, telecomsChannelStatus=telecomsChannelStatus, hardwareVersion=hardwareVersion, channelBandwidth=channelBandwidth, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNTPServerPortNumber=sNTPServerPortNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, unitOutOfCalibration=unitOutOfCalibration, masterSlaveMode=masterSlaveMode, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, byteErrorRatio=byteErrorRatio, installArmStateTrap=installArmStateTrap, dfs=dfs, linkName=linkName, softwareVersion=softwareVersion, dfsTableEntry=dfsTableEntry, transmitFreqMHz=transmitFreqMHz, sNMPTrapIPAddress=sNMPTrapIPAddress, supplementaryGroup=supplementaryGroup, sMTPEnabledMessages=sMTPEnabledMessages, userTableNumber=userTableNumber, telecomsInterface=telecomsInterface, transmitChannel=transmitChannel, sNMPTrapVersion=sNMPTrapVersion, licensedCapacity=licensedCapacity, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tDDControl=tDDControl, installStatusTrap=installStatusTrap, transmitModulationMode=transmitModulationMode, vLANManagementVID=vLANManagementVID, licenceGroup=licenceGroup, sMTPEmailAlert=sMTPEmailAlert, transmitFreqKHz=transmitFreqKHz, transmitDataRate=transmitDataRate, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, subnetMask=subnetMask, ptpCompliance=ptpCompliance, telnetPortNumber=telnetPortNumber, gatewayIPAddress=gatewayIPAddress, sNTPSyncTrap=sNTPSyncTrap, snmpControlGroup=snmpControlGroup, sNTPServerIPAddress=sNTPServerIPAddress, configurationGroup=configurationGroup, systemClock=systemClock, userRole=userRole, sNMPv3Enable=sNMPv3Enable, hTTPSPortNumber=hTTPSPortNumber, receiveDataRate=receiveDataRate, receiveFreqKHz=receiveFreqKHz, ethernet=ethernet, supplementary=supplementary, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, versions=versions, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, dataPortStatus=dataPortStatus, dfsTable=dfsTable, latitude=latitude, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortDisabledWarning=dataPortDisabledWarning, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dfsGroup=dfsGroup, reset=reset, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, productName=productName, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptpGroups=ptpGroups, regionCode=regionCode, channelChangeTrap=channelChangeTrap, smtpGroup=smtpGroup, timeZone=timeZone, syslogClientTrap=syslogClientTrap, aAAControlGroup=aAAControlGroup, syslogControl=syslogControl, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, vLANPriorityTable=vLANPriorityTable, altitude=altitude, cambium=cambium, installStatus=installStatus, ethernetFiberSupport=ethernetFiberSupport, sNTPState=sNTPState, telecomsLoopback=telecomsLoopback, syslogClient=syslogClient, receiveChannel=receiveChannel, phyControlGroup=phyControlGroup, siteName=siteName, productVariant=productVariant, regionCodeTrap=regionCodeTrap, receiveFreqMHz=receiveFreqMHz, remoteIPAddress=remoteIPAddress, sNTPLastSync=sNTPLastSync, userName=userName, aAAControl=aAAControl, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vLANPriorityTableIndex=vLANPriorityTableIndex, range=range, remoteMaximumTransmitPower=remoteMaximumTransmitPower, telecomsCableLength=telecomsCableLength, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus)
