...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, channelBandwidth=channelBandwidth, receiveModulationMode=receiveModulationMode, telecom=telecom, sNTPState=sNTPState, capacityLicenseMismatch=capacityLicenseMismatch, linkName=linkName, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, masterSlaveMode=masterSlaveMode, snmpControl=snmpControl, dataPortAutoNegotiation=dataPortAutoNegotiation, linkModeOptimisation=linkModeOptimisation, licence=licence, receiveDataRate=receiveDataRate, regionCodeTrap=regionCodeTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, antennaGain=antennaGain, telecomsLineCode=telecomsLineCode, sMTPServerPortNumber=sMTPServerPortNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, installStatus=installStatus, dfsPeaks=dfsPeaks, syslogState=syslogState, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, phyControlGroup=phyControlGroup, ptpTraps=ptpTraps, ptpCompliance=ptpCompliance, sNMPTrapTable=sNMPTrapTable, transmitChannel=transmitChannel, tDDControl=tDDControl, hardwareVersion=hardwareVersion, encryptionGroup=encryptionGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, ptpGroups=ptpGroups, sMTPEmailAlert=sMTPEmailAlert, userTable=userTable, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPTrapVersion=sNMPTrapVersion, secondarySoftwareVersion=secondarySoftwareVersion, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, frequencyVariant=frequencyVariant, transmitFreqMHz=transmitFreqMHz, sMTPSourceEmailAddress=sMTPSourceEmailAddress, hTTPAccessEnabled=hTTPAccessEnabled, userTableNumber=userTableNumber, userEnabled=userEnabled, receiveFreqMHz=receiveFreqMHz, receiveChannel=receiveChannel, sMTPEnabledMessages=sMTPEnabledMessages, byteErrorRatio=byteErrorRatio, sNMPTrapTableEntry=sNMPTrapTableEntry, vLANManagementPriority=vLANManagementPriority, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, telnetPortNumber=telnetPortNumber, userPassword=userPassword, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, cambium=cambium, maximumTransmitPower=maximumTransmitPower, vLANPriorityTable=vLANPriorityTable, userTableEntry=userTableEntry, telecomsLoopback=telecomsLoopback, transmitPower=transmitPower, timeZone=timeZone, systemReset=systemReset, receiveModulationModeDetail=receiveModulationModeDetail, phyControl=phyControl, configurationGroup=configurationGroup, subnetMask=subnetMask, wirelessLinkAvailability=wirelessLinkAvailability, unitOutOfCalibration=unitOutOfCalibration, bootVersion=bootVersion, sNTPSyncTrap=sNTPSyncTrap, ptpTrapPrefix=ptpTrapPrefix, supplementary=supplementary, iPAddress=iPAddress, reset=reset, hTTPPortNumber=hTTPPortNumber, sNTPServerIPAddress=sNTPServerIPAddress, snmpControlGroup=snmpControlGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, signalStrengthRatio=signalStrengthRatio, supplementaryGroup=supplementaryGroup, telecomsLoopbackTrap=telecomsLoopbackTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, transmitModulationMode=transmitModulationMode, encryption=encryption, dataPortStatus=dataPortStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tDDControlGroup=tDDControlGroup, ethernet=ethernet, searchState=searchState, versions=versions, receivePower=receivePower, sNMPTrapTableIndex=sNMPTrapTableIndex, syslogLocalWrappedTrap=syslogLocalWrappedTrap, latitude=latitude, installArmState=installArmState, sntp=sntp, dfsTableNumber=dfsTableNumber, range=range, linkLoss=linkLoss, userName=userName, sNMPTrapPortNumber=sNMPTrapPortNumber, telnetAccessEnabled=telnetAccessEnabled, regionCode=regionCode, sNMPEnabledTraps=sNMPEnabledTraps, dataPortAutoMdix=dataPortAutoMdix, altitude=altitude, installStatusTrap=installStatusTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, alarms=alarms, smtpGroup=smtpGroup, tDDSynchronizationMode=tDDSynchronizationMode, syslogControlGroup=syslogControlGroup, installArmStateTrap=installArmStateTrap, sNMPv3Enable=sNMPv3Enable, userTableIndex=userTableIndex, longitude=longitude, telecomsChannelStatus=telecomsChannelStatus, wirelessLinkStatus=wirelessLinkStatus, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tFTPServerIPAddress=tFTPServerIPAddress, dataPortDisabledWarning=dataPortDisabledWarning, tFTPServerPortNumber=tFTPServerPortNumber, incompatibleRegionCodes=incompatibleRegionCodes, receiveFreqKHz=receiveFreqKHz, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, productName=productName, ethernetFiberSupport=ethernetFiberSupport, linkSymmetry=linkSymmetry, productVariant=productVariant, alarmsGroup=alarmsGroup, hTTPSPortNumber=hTTPSPortNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, management=management, sntpGroup=sntpGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, syslogClient=syslogClient, transmitFreqKHz=transmitFreqKHz, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNMPTrapIPAddress=sNMPTrapIPAddress, pubStats=pubStats, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, licenceGroup=licenceGroup, targetMACAddress=targetMACAddress, notificationsGroup=notificationsGroup, userRole=userRole, telecomGroup=telecomGroup, eIRP=eIRP, licensedCapacity=licensedCapacity, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ptmp=ptmp, telecomsCableLength=telecomsCableLength, transmitDataRate=transmitDataRate, phyStatus=phyStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, gatewayIPAddress=gatewayIPAddress, ptp=ptp, ptp500=ptp500, sNTPPollInterval=sNTPPollInterval, syslogControl=syslogControl, ethernetGroup=ethernetGroup, vectorError=vectorError, sNTPLastSync=sNTPLastSync, syslogStateTrap=syslogStateTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, syslogClientTrap=syslogClientTrap, dfsMeans=dfsMeans, accessMethod=accessMethod, siteName=siteName, systemClock=systemClock, daylightSaving=daylightSaving, telecomsInterface=telecomsInterface, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortWirelessDownAlert=dataPortWirelessDownAlert, remoteIPAddress=remoteIPAddress, vLANPriorityTableIndex=vLANPriorityTableIndex, vLANPriorityTableNumber=vLANPriorityTableNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, softwareVersion=softwareVersion, vLANManagementVID=vLANManagementVID, dataPortStatusTrap=dataPortStatusTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPCommunityString=sNMPCommunityString, cableLoss=cableLoss, bandwidthVariant=bandwidthVariant, encryptionAlgorithm=encryptionAlgorithm, channelChangeTrap=channelChangeTrap, dfsTableEntry=dfsTableEntry, aggregateDataRate=aggregateDataRate, groupID=groupID, vLANPriorityQueueMapping=vLANPriorityQueueMapping, smtp=smtp, dfsTableIndex=dfsTableIndex, aAAControl=aAAControl, resetGroup=resetGroup, pubStatsGroup=pubStatsGroup, PYSNMP_MODULE_ID=cambium, sMTPServerIPAddress=sMTPServerIPAddress, dfs=dfs, managementGroup=managementGroup, telecomsChannelStatusTrap=telecomsChannelStatusTrap, versionsGroup=versionsGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, sNMPPortNumber=sNMPPortNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPServerPortNumber=sNTPServerPortNumber, sNTPSync=sNTPSync, dfsGroup=dfsGroup, dfsTable=dfsTable, tDDSynchronizationStatus=tDDSynchronizationStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, configuration=configuration, phyStatusGroup=phyStatusGroup, aAAControlGroup=aAAControlGroup)
