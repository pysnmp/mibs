...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", ptp500=ptp500, masterSlaveMode=masterSlaveMode, sMTPEmailAlert=sMTPEmailAlert, userName=userName, dataPortStatusTrap=dataPortStatusTrap, ptpGroups=ptpGroups, telecomsInterface=telecomsInterface, hTTPSPortNumber=hTTPSPortNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, iPAddress=iPAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, byteErrorRatio=byteErrorRatio, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, smtpGroup=smtpGroup, receiveModulationModeDetail=receiveModulationModeDetail, telecomsLineCode=telecomsLineCode, syslogState=syslogState, eIRP=eIRP, vLANPriorityTableEntry=vLANPriorityTableEntry, gatewayIPAddress=gatewayIPAddress, management=management, configurationGroup=configurationGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, signalStrengthRatio=signalStrengthRatio, wirelessLinkAvailability=wirelessLinkAvailability, receivePower=receivePower, ptmp=ptmp, telecomsChannelStatusTrap=telecomsChannelStatusTrap, transmitDataRate=transmitDataRate, installStatusTrap=installStatusTrap, syslogControlGroup=syslogControlGroup, telecomsLoopbackTrap=telecomsLoopbackTrap, cambium=cambium, encryptionAlgorithm=encryptionAlgorithm, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tFTPServerIPAddress=tFTPServerIPAddress, smtp=smtp, incompatibleRegionCodes=incompatibleRegionCodes, phyControl=phyControl, sNMPCommunityString=sNMPCommunityString, vectorError=vectorError, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sntpGroup=sntpGroup, resetGroup=resetGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, productVariant=productVariant, dfsMeans=dfsMeans, sNTPServerIPAddress=sNTPServerIPAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogClientTrap=syslogClientTrap, systemReset=systemReset, alarms=alarms, antennaGain=antennaGain, regionCodeTrap=regionCodeTrap, receiveFreqMHz=receiveFreqMHz, telecomsChannelStatus=telecomsChannelStatus, tDDSynchronizationStatus=tDDSynchronizationStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, receiveModulationMode=receiveModulationMode, cableLoss=cableLoss, sMTPServerIPAddress=sMTPServerIPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptpCompliance=ptpCompliance, dataPortAutoNegotiation=dataPortAutoNegotiation, licence=licence, pubStats=pubStats, receiveChannel=receiveChannel, transmitFreqKHz=transmitFreqKHz, dfsGroup=dfsGroup, linkName=linkName, sNMPTrapTableEntry=sNMPTrapTableEntry, syslogClient=syslogClient, phyControlGroup=phyControlGroup, telnetAccessEnabled=telnetAccessEnabled, sNTPLastSync=sNTPLastSync, transmitChannel=transmitChannel, dataPortStatus=dataPortStatus, userTableNumber=userTableNumber, userEnabled=userEnabled, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, telecomsCableLength=telecomsCableLength, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, notificationsGroup=notificationsGroup, supplementary=supplementary, sNMPTrapTableNumber=sNMPTrapTableNumber, subnetMask=subnetMask, unitOutOfCalibration=unitOutOfCalibration, dataPortDisabledWarning=dataPortDisabledWarning, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ethernet=ethernet, installStatus=installStatus, linkLoss=linkLoss, dataPortAutoMdix=dataPortAutoMdix, regionCode=regionCode, dfsTableIndex=dfsTableIndex, transmitModulationMode=transmitModulationMode, dfsTable=dfsTable, timeZone=timeZone, userTableIndex=userTableIndex, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, sMTPEnabledMessages=sMTPEnabledMessages, ptp=ptp, userRole=userRole, aAAControl=aAAControl, daylightSaving=daylightSaving, sNTPSyncTrap=sNTPSyncTrap, syslogControl=syslogControl, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, supplementaryGroup=supplementaryGroup, searchState=searchState, ptpTraps=ptpTraps, sntp=sntp, telecomGroup=telecomGroup, userPassword=userPassword, dfsTableEntry=dfsTableEntry, aggregateDataRate=aggregateDataRate, userTableEntry=userTableEntry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, vLANPriorityTable=vLANPriorityTable, tDDControlGroup=tDDControlGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vLANPriorityTableNumber=vLANPriorityTableNumber, encryption=encryption, installArmStateTrap=installArmStateTrap, secondarySoftwareVersion=secondarySoftwareVersion, snmpControl=snmpControl, sNMPTrapTable=sNMPTrapTable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, channelChangeTrap=channelChangeTrap, receiveDataRate=receiveDataRate, aAAControlGroup=aAAControlGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, PYSNMP_MODULE_ID=cambium, range=range, reset=reset, linkModeOptimizationMismatch=linkModeOptimizationMismatch, telecom=telecom, vLANPriorityTableIndex=vLANPriorityTableIndex, siteName=siteName, syslogStateTrap=syslogStateTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, phyStatus=phyStatus, hTTPAccessEnabled=hTTPAccessEnabled, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPPortNumber=sNMPPortNumber, dfsTableNumber=dfsTableNumber, licenceGroup=licenceGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, pubStatsGroup=pubStatsGroup, longitude=longitude, altitude=altitude, latitude=latitude, targetMACAddress=targetMACAddress, hTTPPortNumber=hTTPPortNumber, frequencyVariant=frequencyVariant, managementGroup=managementGroup, transmitFreqMHz=transmitFreqMHz, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPTrapVersion=sNMPTrapVersion, versions=versions, ethernetGroup=ethernetGroup, remoteIPAddress=remoteIPAddress, phyStatusGroup=phyStatusGroup, licensedCapacity=licensedCapacity, sNTPPollInterval=sNTPPollInterval, receiveFreqKHz=receiveFreqKHz, vLANManagementVID=vLANManagementVID, telecomsLoopback=telecomsLoopback, dataPortConfigurationMismatch=dataPortConfigurationMismatch, incompatibleMasterAndSlave=incompatibleMasterAndSlave, userTable=userTable, installArmState=installArmState, bootVersion=bootVersion, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, noWirelessChannelAvailable=noWirelessChannelAvailable, vLANManagementPriority=vLANManagementPriority, accessMethod=accessMethod, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, versionsGroup=versionsGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPServerPortNumber=tFTPServerPortNumber, wirelessLinkStatus=wirelessLinkStatus, hardwareVersion=hardwareVersion, tDDControl=tDDControl, dfsPeaks=dfsPeaks, sNMPv3Enable=sNMPv3Enable, configuration=configuration, sNTPState=sNTPState, softwareVersion=softwareVersion, systemClock=systemClock, vLANPriorityQueueMapping=vLANPriorityQueueMapping, hTTPSAccessEnabled=hTTPSAccessEnabled, capacityLicenseMismatch=capacityLicenseMismatch, sNMPTrapPortNumber=sNMPTrapPortNumber, bandwidthVariant=bandwidthVariant, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, groupID=groupID, telnetPortNumber=telnetPortNumber, alarmsGroup=alarmsGroup, sMTPServerPortNumber=sMTPServerPortNumber, dfs=dfs, linkSymmetry=linkSymmetry, snmpControlGroup=snmpControlGroup, ethernetFiberSupport=ethernetFiberSupport, channelBandwidth=channelBandwidth, transmitPower=transmitPower, sNTPServerPortNumber=sNTPServerPortNumber, tDDSynchronizationMode=tDDSynchronizationMode, productName=productName, maximumTransmitPower=maximumTransmitPower, linkModeOptimisation=linkModeOptimisation, encryptionGroup=encryptionGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ptpTrapPrefix=ptpTrapPrefix, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPEnabledTraps=sNMPEnabledTraps, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPSync=sNTPSync)
