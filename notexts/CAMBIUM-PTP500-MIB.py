...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", vLANPriorityTableEntry=vLANPriorityTableEntry, incompatibleRegionCodes=incompatibleRegionCodes, sNTPLastSync=sNTPLastSync, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, userEnabled=userEnabled, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, snmpControl=snmpControl, vLANManagementVID=vLANManagementVID, sNTPSync=sNTPSync, sntpGroup=sntpGroup, telnetPortNumber=telnetPortNumber, sNMPPortNumber=sNMPPortNumber, sNMPTrapVersion=sNMPTrapVersion, wirelessLinkStatus=wirelessLinkStatus, alarms=alarms, ptpCompliance=ptpCompliance, supplementaryGroup=supplementaryGroup, remoteIPAddress=remoteIPAddress, productName=productName, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortStatus=dataPortStatus, telecomsLoopback=telecomsLoopback, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, syslogStateTrap=syslogStateTrap, dfsMeans=dfsMeans, accessMethod=accessMethod, ptp=ptp, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, receiveModulationModeDetail=receiveModulationModeDetail, sNMPTrapTableIndex=sNMPTrapTableIndex, phyStatusGroup=phyStatusGroup, timeZone=timeZone, notificationsGroup=notificationsGroup, ethernetGroup=ethernetGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, eIRP=eIRP, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, receiveDataRate=receiveDataRate, smtpGroup=smtpGroup, ptp500=ptp500, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sNMPTrapTable=sNMPTrapTable, dfs=dfs, sMTPServerPortNumber=sMTPServerPortNumber, smtp=smtp, regionCode=regionCode, sNTPServerIPAddress=sNTPServerIPAddress, syslogClientTrap=syslogClientTrap, aAAControlGroup=aAAControlGroup, systemClock=systemClock, gatewayIPAddress=gatewayIPAddress, cambium=cambium, dataPortDisabledWarning=dataPortDisabledWarning, sNTPServerPortNumber=sNTPServerPortNumber, searchState=searchState, ethernetFiberSupport=ethernetFiberSupport, versionsGroup=versionsGroup, telnetAccessEnabled=telnetAccessEnabled, maximumTransmitPower=maximumTransmitPower, subnetMask=subnetMask, transmitFreqMHz=transmitFreqMHz, receiveFreqKHz=receiveFreqKHz, sNMPCommunityString=sNMPCommunityString, linkName=linkName, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, capacityLicenseMismatch=capacityLicenseMismatch, syslogLocalWrappedTrap=syslogLocalWrappedTrap, hTTPPortNumber=hTTPPortNumber, targetMACAddress=targetMACAddress, telecomGroup=telecomGroup, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, linkLoss=linkLoss, dataPortConfigurationMismatch=dataPortConfigurationMismatch, daylightSaving=daylightSaving, installArmState=installArmState, linkModeOptimizationMismatch=linkModeOptimizationMismatch, ptmp=ptmp, hTTPSPortNumber=hTTPSPortNumber, linkSymmetry=linkSymmetry, sNMPEnabledTraps=sNMPEnabledTraps, installStatusTrap=installStatusTrap, dfsTableNumber=dfsTableNumber, tDDControlGroup=tDDControlGroup, cableLoss=cableLoss, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telecom=telecom, sNTPState=sNTPState, receiveFreqMHz=receiveFreqMHz, reset=reset, telecomsCableLength=telecomsCableLength, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPEnabledMessages=sMTPEnabledMessages, syslogControlGroup=syslogControlGroup, antennaGain=antennaGain, secondarySoftwareVersion=secondarySoftwareVersion, licensedCapacity=licensedCapacity, sntp=sntp, byteErrorRatio=byteErrorRatio, transmitModulationMode=transmitModulationMode, transmitChannel=transmitChannel, userTableIndex=userTableIndex, encryptionGroup=encryptionGroup, PYSNMP_MODULE_ID=cambium, telecomsLoopbackTrap=telecomsLoopbackTrap, telecomsChannelStatus=telecomsChannelStatus, userName=userName, sNMPTrapTableNumber=sNMPTrapTableNumber, aAAControl=aAAControl, receivePower=receivePower, encryption=encryption, hardwareVersion=hardwareVersion, sMTPServerIPAddress=sMTPServerIPAddress, transmitDataRate=transmitDataRate, encryptionAlgorithm=encryptionAlgorithm, userPassword=userPassword, altitude=altitude, alarmsGroup=alarmsGroup, signalStrengthRatio=signalStrengthRatio, sNTPPollInterval=sNTPPollInterval, telecomsInterface=telecomsInterface, snmpControlGroup=snmpControlGroup, dfsGroup=dfsGroup, pubStatsGroup=pubStatsGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, vLANManagementPriority=vLANManagementPriority, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, transmitPower=transmitPower, ethernet=ethernet, versions=versions, sMTPEmailAlert=sMTPEmailAlert, tDDControl=tDDControl, hTTPSAccessEnabled=hTTPSAccessEnabled, bootVersion=bootVersion, vLANPriorityTable=vLANPriorityTable, frequencyVariant=frequencyVariant, resetGroup=resetGroup, telecomsLineCode=telecomsLineCode, softwareVersion=softwareVersion, dfsPeaks=dfsPeaks, dataPortStatusTrap=dataPortStatusTrap, phyStatus=phyStatus, syslogState=syslogState, wirelessLinkAvailability=wirelessLinkAvailability, ptpGroups=ptpGroups, configurationGroup=configurationGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, vectorError=vectorError, incompatibleMasterAndSlave=incompatibleMasterAndSlave, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ptpTraps=ptpTraps, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dfsTableEntry=dfsTableEntry, dfsTable=dfsTable, dataPortAutoMdix=dataPortAutoMdix, vLANPriorityTableIndex=vLANPriorityTableIndex, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, installStatus=installStatus, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, userRole=userRole, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, phyControl=phyControl, sNTPSyncTrap=sNTPSyncTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPServerIPAddress=tFTPServerIPAddress, unitOutOfCalibration=unitOutOfCalibration, range=range, pubStats=pubStats, syslogControl=syslogControl, remoteMaximumTransmitPower=remoteMaximumTransmitPower, managementGroup=managementGroup, siteName=siteName, hTTPAccessEnabled=hTTPAccessEnabled, longitude=longitude, masterSlaveMode=masterSlaveMode, tDDSynchronizationStatus=tDDSynchronizationStatus, receiveModulationMode=receiveModulationMode, tDDSynchronizationMode=tDDSynchronizationMode, vLANPriorityTableNumber=vLANPriorityTableNumber, licenceGroup=licenceGroup, iPAddress=iPAddress, regionCodeTrap=regionCodeTrap, dfsTableIndex=dfsTableIndex, productVariant=productVariant, configuration=configuration, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, supplementary=supplementary, tFTPServerPortNumber=tFTPServerPortNumber, channelChangeTrap=channelChangeTrap, userTableNumber=userTableNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, licence=licence, systemReset=systemReset, installArmStateTrap=installArmStateTrap, management=management, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userTable=userTable, telecomsChannelStatusTrap=telecomsChannelStatusTrap, latitude=latitude, userTableEntry=userTableEntry, receiveChannel=receiveChannel, ptpTrapPrefix=ptpTrapPrefix, phyControlGroup=phyControlGroup, groupID=groupID, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, bandwidthVariant=bandwidthVariant, linkModeOptimisation=linkModeOptimisation, transmitFreqKHz=transmitFreqKHz, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, aggregateDataRate=aggregateDataRate, channelBandwidth=channelBandwidth, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogClient=syslogClient, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPv3Enable=sNMPv3Enable, sNMPTrapIPAddress=sNMPTrapIPAddress)
