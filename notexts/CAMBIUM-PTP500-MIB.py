...
# Produced by pysmi-1.1.3 at Sun Nov 21 13:48:33 2021
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, Bits, ObjectIdentity, enterprises, Gauge32, Counter64, iso, Counter32, MibIdentifier, NotificationType, ModuleIdentity, IpAddress, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "Bits", "ObjectIdentity", "enterprises", "Gauge32", "Counter64", "iso", "Counter32", "MibIdentifier", "NotificationType", "ModuleIdentity", "IpAddress", "TimeTicks")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, groupID=groupID, enabledDiagnosticAlarms=enabledDiagnosticAlarms, linkModeOptimisation=linkModeOptimisation, accessMethod=accessMethod, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNTPServerPortNumber=sNTPServerPortNumber, tFTPServerPortNumber=tFTPServerPortNumber, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPPollInterval=sNTPPollInterval, hardwareVersion=hardwareVersion, licence=licence, longitude=longitude, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPTrapTableIndex=sNMPTrapTableIndex, systemClock=systemClock, targetMACAddress=targetMACAddress, userPassword=userPassword, sMTPEmailAlert=sMTPEmailAlert, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, systemReset=systemReset, sntp=sntp, sntpGroup=sntpGroup, syslogClientTrap=syslogClientTrap, sMTPEnabledMessages=sMTPEnabledMessages, syslogStateTrap=syslogStateTrap, ptpTraps=ptpTraps, vLANManagementPriority=vLANManagementPriority, sNTPSync=sNTPSync, tDDSynchronizationStatus=tDDSynchronizationStatus, smtpGroup=smtpGroup, phyControl=phyControl, transmitModulationMode=transmitModulationMode, telecomsLineCode=telecomsLineCode, productName=productName, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, licenceGroup=licenceGroup, userTableNumber=userTableNumber, ethernetGroup=ethernetGroup, dfsTable=dfsTable, incompatibleMasterAndSlave=incompatibleMasterAndSlave, configuration=configuration, wirelessLinkStatus=wirelessLinkStatus, subnetMask=subnetMask, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortAutoNegotiation=dataPortAutoNegotiation, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNMPTrapIPAddress=sNMPTrapIPAddress, receiveFreqMHz=receiveFreqMHz, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNTPState=sNTPState, dfsTableEntry=dfsTableEntry, encryptionGroup=encryptionGroup, aAAControl=aAAControl, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, unitOutOfCalibration=unitOutOfCalibration, useVLANForManagementInterfaces=useVLANForManagementInterfaces, altitude=altitude, dfsMeans=dfsMeans, ptmp=ptmp, productVariant=productVariant, versions=versions, gatewayIPAddress=gatewayIPAddress, bootVersion=bootVersion, sNMPEnabledTraps=sNMPEnabledTraps, masterSlaveMode=masterSlaveMode, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPPortNumber=sNMPPortNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortStatusTrap=dataPortStatusTrap, alarmsGroup=alarmsGroup, installArmStateTrap=installArmStateTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, latitude=latitude, sNTPLastSync=sNTPLastSync, telecom=telecom, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, telecomGroup=telecomGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, sNMPCommunityString=sNMPCommunityString, vLANPriorityTable=vLANPriorityTable, transmitChannel=transmitChannel, dataPortAutoMdix=dataPortAutoMdix, installStatus=installStatus, encryption=encryption, telnetAccessEnabled=telnetAccessEnabled, supplementaryGroup=supplementaryGroup, dfsTableNumber=dfsTableNumber, snmpControlGroup=snmpControlGroup, userTableIndex=userTableIndex, transmitPower=transmitPower, capacityLicenseMismatch=capacityLicenseMismatch, softwareVersion=softwareVersion, sNMPTrapTable=sNMPTrapTable, management=management, dfs=dfs, dataPortDisabledWarning=dataPortDisabledWarning, secondarySoftwareVersion=secondarySoftwareVersion, daylightSaving=daylightSaving, aggregateDataRate=aggregateDataRate, dfsTableIndex=dfsTableIndex, vectorError=vectorError, phyStatus=phyStatus, ethernet=ethernet, vLANPriorityTableIndex=vLANPriorityTableIndex, tDDControlGroup=tDDControlGroup, cableLoss=cableLoss, ptp=ptp, vLANPriorityTableNumber=vLANPriorityTableNumber, antennaGain=antennaGain, transmitDataRate=transmitDataRate, userTableEntry=userTableEntry, userName=userName, eIRP=eIRP, noWirelessChannelAvailable=noWirelessChannelAvailable, aAAControlGroup=aAAControlGroup, transmitFreqMHz=transmitFreqMHz, telecomsChannelStatusTrap=telecomsChannelStatusTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPTrapTableNumber=sNMPTrapTableNumber, configurationGroup=configurationGroup, telnetPortNumber=telnetPortNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPSyncTrap=sNTPSyncTrap, licensedCapacity=licensedCapacity, receiveFreqKHz=receiveFreqKHz, notificationsGroup=notificationsGroup, hTTPPortNumber=hTTPPortNumber, ethernetFiberSupport=ethernetFiberSupport, sMTPServerIPAddress=sMTPServerIPAddress, installStatusTrap=installStatusTrap, signalStrengthRatio=signalStrengthRatio, syslogClient=syslogClient, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, pubStatsGroup=pubStatsGroup, incompatibleRegionCodes=incompatibleRegionCodes, versionsGroup=versionsGroup, frequencyVariant=frequencyVariant, transmitFreqKHz=transmitFreqKHz, siteName=siteName, installArmState=installArmState, ptpCompliance=ptpCompliance, telecomsLoopbackTrap=telecomsLoopbackTrap, pubStats=pubStats, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, encryptionAlgorithm=encryptionAlgorithm, ptpTrapPrefix=ptpTrapPrefix, tDDSynchronizationMode=tDDSynchronizationMode, syslogControlGroup=syslogControlGroup, sNTPServerIPAddress=sNTPServerIPAddress, timeZone=timeZone, phyStatusGroup=phyStatusGroup, cambium=cambium, telecomsLoopback=telecomsLoopback, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, receiveModulationMode=receiveModulationMode, remoteIPAddress=remoteIPAddress, linkLoss=linkLoss, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, iPAddress=iPAddress, hTTPSPortNumber=hTTPSPortNumber, smtp=smtp, hTTPSAccessEnabled=hTTPSAccessEnabled, range=range, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortStatus=dataPortStatus, receiveChannel=receiveChannel, channelChangeTrap=channelChangeTrap, receiveModulationModeDetail=receiveModulationModeDetail, reset=reset, supplementary=supplementary, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, byteErrorRatio=byteErrorRatio, userTable=userTable, userEnabled=userEnabled, dataPortWirelessDownAlert=dataPortWirelessDownAlert, channelBandwidth=channelBandwidth, searchState=searchState, ptp500=ptp500, wirelessLinkAvailability=wirelessLinkAvailability, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, receiveDataRate=receiveDataRate, receivePower=receivePower, sNMPv3Enable=sNMPv3Enable, regionCodeTrap=regionCodeTrap, telecomsCableLength=telecomsCableLength, tDDSynchronizationAlarm=tDDSynchronizationAlarm, resetGroup=resetGroup, telecomsChannelStatus=telecomsChannelStatus, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, syslogControl=syslogControl, telecomsInterface=telecomsInterface, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dfsPeaks=dfsPeaks, linkName=linkName, tFTPServerIPAddress=tFTPServerIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, bandwidthVariant=bandwidthVariant, vLANPriorityQueueMapping=vLANPriorityQueueMapping, dfsGroup=dfsGroup, linkSymmetry=linkSymmetry, syslogState=syslogState, ptpGroups=ptpGroups, maximumTransmitPower=maximumTransmitPower, hTTPAccessEnabled=hTTPAccessEnabled, phyControlGroup=phyControlGroup, snmpControl=snmpControl, vLANPriorityTableEntry=vLANPriorityTableEntry, tDDControl=tDDControl, alarms=alarms, sMTPServerPortNumber=sMTPServerPortNumber, managementGroup=managementGroup, userRole=userRole, PYSNMP_MODULE_ID=cambium, vLANManagementVID=vLANManagementVID, regionCode=regionCode)
