...
# Produced by pysmi-1.1.3 at Sun Nov 28 20:36:01 2021
...
ModuleIdentity, NotificationType, Counter64, ObjectIdentity, MibIdentifier, Counter32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Integer32, Gauge32, TimeTicks, iso, IpAddress, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "NotificationType", "Counter64", "ObjectIdentity", "MibIdentifier", "Counter32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Integer32", "Gauge32", "TimeTicks", "iso", "IpAddress", "enterprises")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", receiveFreqMHz=receiveFreqMHz, dataPortAutoMdix=dataPortAutoMdix, range=range, versionsGroup=versionsGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, telecomsLoopback=telecomsLoopback, tDDControlGroup=tDDControlGroup, userTableEntry=userTableEntry, userEnabled=userEnabled, dfsTableIndex=dfsTableIndex, telecomsChannelStatus=telecomsChannelStatus, linkName=linkName, telecomsCableLength=telecomsCableLength, userTableIndex=userTableIndex, aAAControlGroup=aAAControlGroup, snmpControlGroup=snmpControlGroup, dataPortStatus=dataPortStatus, userPassword=userPassword, vLANManagementVID=vLANManagementVID, userTableNumber=userTableNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, signalStrengthRatio=signalStrengthRatio, tFTPServerPortNumber=tFTPServerPortNumber, sMTPServerPortNumber=sMTPServerPortNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, telecomsLoopbackTrap=telecomsLoopbackTrap, eIRP=eIRP, licence=licence, maximumTransmitPower=maximumTransmitPower, tDDControl=tDDControl, pubStats=pubStats, enabledDiagnosticAlarms=enabledDiagnosticAlarms, remoteIPAddress=remoteIPAddress, alarmsGroup=alarmsGroup, aggregateDataRate=aggregateDataRate, transmitModulationMode=transmitModulationMode, regionCode=regionCode, vectorError=vectorError, incompatibleRegionCodes=incompatibleRegionCodes, dataPortStatusTrap=dataPortStatusTrap, resetGroup=resetGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, receivePower=receivePower, vLANPriorityTableEntry=vLANPriorityTableEntry, dfs=dfs, dataPortWirelessDownAlert=dataPortWirelessDownAlert, vLANPriorityTableNumber=vLANPriorityTableNumber, transmitChannel=transmitChannel, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dfsTable=dfsTable, installStatus=installStatus, encryptionAlgorithm=encryptionAlgorithm, sNTPSyncTrap=sNTPSyncTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, hardwareVersion=hardwareVersion, systemClock=systemClock, channelChangeTrap=channelChangeTrap, antennaGain=antennaGain, tDDSynchronizationAlarm=tDDSynchronizationAlarm, alarms=alarms, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogControlGroup=syslogControlGroup, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, ptp=ptp, telecomsLineCode=telecomsLineCode, notificationsGroup=notificationsGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPEnabledTraps=sNMPEnabledTraps, userRole=userRole, smtpGroup=smtpGroup, transmitFreqKHz=transmitFreqKHz, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, installStatusTrap=installStatusTrap, bootVersion=bootVersion, wirelessLinkStatus=wirelessLinkStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, hTTPPortNumber=hTTPPortNumber, installArmStateTrap=installArmStateTrap, altitude=altitude, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userName=userName, aAAControl=aAAControl, phyControlGroup=phyControlGroup, sNTPPollInterval=sNTPPollInterval, wirelessLinkAvailability=wirelessLinkAvailability, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ptpTraps=ptpTraps, sMTPServerIPAddress=sMTPServerIPAddress, dfsTableEntry=dfsTableEntry, accessMethod=accessMethod, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortDisabledWarning=dataPortDisabledWarning, secondarySoftwareVersion=secondarySoftwareVersion, groupID=groupID, telecomsInterface=telecomsInterface, ptmp=ptmp, sMTPEnabledMessages=sMTPEnabledMessages, sMTPEmailAlert=sMTPEmailAlert, pubStatsGroup=pubStatsGroup, productName=productName, versions=versions, dfsTableNumber=dfsTableNumber, installArmState=installArmState, sNMPPortNumber=sNMPPortNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ptpCompliance=ptpCompliance, dfsPeaks=dfsPeaks, syslogClient=syslogClient, telecomGroup=telecomGroup, productVariant=productVariant, frequencyVariant=frequencyVariant, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, capacityLicenseMismatch=capacityLicenseMismatch, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNTPSync=sNTPSync, telnetPortNumber=telnetPortNumber, sNTPLastSync=sNTPLastSync, snmpControl=snmpControl, transmitPower=transmitPower, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, searchState=searchState, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, syslogStateTrap=syslogStateTrap, sntpGroup=sntpGroup, timeZone=timeZone, systemReset=systemReset, syslogClientTrap=syslogClientTrap, phyStatusGroup=phyStatusGroup, licenceGroup=licenceGroup, byteErrorRatio=byteErrorRatio, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, receiveChannel=receiveChannel, supplementary=supplementary, gatewayIPAddress=gatewayIPAddress, cambium=cambium, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, hTTPAccessEnabled=hTTPAccessEnabled, daylightSaving=daylightSaving, smtp=smtp, dfsGroup=dfsGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, unitOutOfCalibration=unitOutOfCalibration, regionCodeTrap=regionCodeTrap, vLANPriorityTable=vLANPriorityTable, targetMACAddress=targetMACAddress, sNTPServerIPAddress=sNTPServerIPAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNTPServerPortNumber=sNTPServerPortNumber, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, syslogControl=syslogControl, sNMPCommunityString=sNMPCommunityString, sNMPTrapTableNumber=sNMPTrapTableNumber, management=management, syslogLocalWrappedTrap=syslogLocalWrappedTrap, encryptionGroup=encryptionGroup, licensedCapacity=licensedCapacity, telecom=telecom, encryption=encryption, ethernet=ethernet, userTable=userTable, transmitFreqMHz=transmitFreqMHz, phyStatus=phyStatus, dataPortAutoNegotiation=dataPortAutoNegotiation, ptpGroups=ptpGroups, managementGroup=managementGroup, ethernetFiberSupport=ethernetFiberSupport, supplementaryGroup=supplementaryGroup, linkModeOptimisation=linkModeOptimisation, subnetMask=subnetMask, syslogState=syslogState, configuration=configuration, longitude=longitude, sNMPTrapVersion=sNMPTrapVersion, cableLoss=cableLoss, vLANManagementPriority=vLANManagementPriority, latitude=latitude, receiveModulationModeDetail=receiveModulationModeDetail, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, receiveFreqKHz=receiveFreqKHz, configurationGroup=configurationGroup, sNTPState=sNTPState, ethernetGroup=ethernetGroup, softwareVersion=softwareVersion, transmitDataRate=transmitDataRate, linkSymmetry=linkSymmetry, iPAddress=iPAddress, receiveDataRate=receiveDataRate, sntp=sntp, dataPortConfigurationMismatch=dataPortConfigurationMismatch, linkModeOptimizationMismatch=linkModeOptimizationMismatch, linkLoss=linkLoss, receiveModulationMode=receiveModulationMode, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPTrapTable=sNMPTrapTable, phyControl=phyControl, dfsMeans=dfsMeans, hTTPSPortNumber=hTTPSPortNumber, telnetAccessEnabled=telnetAccessEnabled, ptpTrapPrefix=ptpTrapPrefix, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tDDSynchronizationStatus=tDDSynchronizationStatus, ptp500=ptp500, channelBandwidth=channelBandwidth, tDDSynchronizationMode=tDDSynchronizationMode, siteName=siteName, sNMPv3Enable=sNMPv3Enable, bandwidthVariant=bandwidthVariant, PYSNMP_MODULE_ID=cambium, reset=reset, masterSlaveMode=masterSlaveMode, vLANPriorityQueueMapping=vLANPriorityQueueMapping)
