...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sntpGroup=sntpGroup, linkSymmetry=linkSymmetry, alarmsGroup=alarmsGroup, tDDControl=tDDControl, sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPServerIPAddress=tFTPServerIPAddress, encryptionGroup=encryptionGroup, supplementaryGroup=supplementaryGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, transmitChannel=transmitChannel, sNTPServerPortNumber=sNTPServerPortNumber, dataPortStatus=dataPortStatus, vLANPriorityTableNumber=vLANPriorityTableNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, ptpGroups=ptpGroups, linkName=linkName, receiveModulationMode=receiveModulationMode, receiveChannel=receiveChannel, gatewayIPAddress=gatewayIPAddress, dataPortStatusTrap=dataPortStatusTrap, bootVersion=bootVersion, cableLoss=cableLoss, productName=productName, configurationGroup=configurationGroup, ptp500=ptp500, userEnabled=userEnabled, vLANPriorityQueueMapping=vLANPriorityQueueMapping, userPassword=userPassword, hTTPSAccessEnabled=hTTPSAccessEnabled, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortDisabledWarning=dataPortDisabledWarning, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, systemReset=systemReset, userTableIndex=userTableIndex, managementGroup=managementGroup, smtpGroup=smtpGroup, receiveModulationModeDetail=receiveModulationModeDetail, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsMeans=dfsMeans, channelChangeTrap=channelChangeTrap, telecomsLineCode=telecomsLineCode, syslogClient=syslogClient, pubStatsGroup=pubStatsGroup, syslogState=syslogState, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortConfigurationMismatch=dataPortConfigurationMismatch, tDDSynchronizationStatus=tDDSynchronizationStatus, transmitDataRate=transmitDataRate, sNMPCommunityString=sNMPCommunityString, tDDControlGroup=tDDControlGroup, sNTPSync=sNTPSync, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, wirelessLinkStatus=wirelessLinkStatus, secondarySoftwareVersion=secondarySoftwareVersion, aggregateDataRate=aggregateDataRate, accessMethod=accessMethod, smtp=smtp, telecomsCableLength=telecomsCableLength, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, userRole=userRole, ptpTrapPrefix=ptpTrapPrefix, ptpTraps=ptpTraps, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, linkModeOptimisation=linkModeOptimisation, transmitPower=transmitPower, pubStats=pubStats, ptpCompliance=ptpCompliance, sNMPTrapTableNumber=sNMPTrapTableNumber, range=range, bandwidthVariant=bandwidthVariant, hTTPAccessEnabled=hTTPAccessEnabled, linkLoss=linkLoss, versionsGroup=versionsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, siteName=siteName, wirelessLinkAvailability=wirelessLinkAvailability, receiveDataRate=receiveDataRate, vLANPriorityTableIndex=vLANPriorityTableIndex, dfsTable=dfsTable, transmitFreqKHz=transmitFreqKHz, notificationsGroup=notificationsGroup, hTTPPortNumber=hTTPPortNumber, ptp=ptp, PYSNMP_MODULE_ID=cambium, searchState=searchState, userName=userName, transmitModulationMode=transmitModulationMode, encryptionAlgorithm=encryptionAlgorithm, sNMPTrapTable=sNMPTrapTable, ethernet=ethernet, phyStatusGroup=phyStatusGroup, eIRP=eIRP, tDDSynchronizationMode=tDDSynchronizationMode, telecomsChannelStatusTrap=telecomsChannelStatusTrap, syslogControl=syslogControl, vLANManagementVID=vLANManagementVID, transmitFreqMHz=transmitFreqMHz, configuration=configuration, groupID=groupID, reset=reset, remoteIPAddress=remoteIPAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, encryption=encryption, supplementary=supplementary, daylightSaving=daylightSaving, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapVersion=sNMPTrapVersion, hTTPSPortNumber=hTTPSPortNumber, sNTPLastSync=sNTPLastSync, tFTPServerPortNumber=tFTPServerPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, telnetAccessEnabled=telnetAccessEnabled, subnetMask=subnetMask, installStatus=installStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, userTable=userTable, dfs=dfs, receiveFreqMHz=receiveFreqMHz, frequencyVariant=frequencyVariant, ethernetFiberSupport=ethernetFiberSupport, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, phyControl=phyControl, cambium=cambium, longitude=longitude, syslogControlGroup=syslogControlGroup, regionCodeTrap=regionCodeTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNTPServerIPAddress=sNTPServerIPAddress, byteErrorRatio=byteErrorRatio, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, receiveFreqKHz=receiveFreqKHz, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, useVLANForManagementInterfaces=useVLANForManagementInterfaces, installArmState=installArmState, licensedCapacity=licensedCapacity, sMTPServerPortNumber=sMTPServerPortNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dfsPeaks=dfsPeaks, phyControlGroup=phyControlGroup, aAAControl=aAAControl, resetGroup=resetGroup, hardwareVersion=hardwareVersion, syslogStateTrap=syslogStateTrap, telecom=telecom, systemClock=systemClock, timeZone=timeZone, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, masterSlaveMode=masterSlaveMode, vLANPriorityTable=vLANPriorityTable, antennaGain=antennaGain, telecomsLoopbackTrap=telecomsLoopbackTrap, syslogClientTrap=syslogClientTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dfsTableEntry=dfsTableEntry, licence=licence, regionCode=regionCode, vectorError=vectorError, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, licenceGroup=licenceGroup, telecomsChannelStatus=telecomsChannelStatus, userTableNumber=userTableNumber, telecomsInterface=telecomsInterface, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNTPSyncTrap=sNTPSyncTrap, signalStrengthRatio=signalStrengthRatio, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, aAAControlGroup=aAAControlGroup, alarms=alarms, channelBandwidth=channelBandwidth, ethernetGroup=ethernetGroup, productVariant=productVariant, receivePower=receivePower, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPState=sNTPState, sNMPTrapTableEntry=sNMPTrapTableEntry, softwareVersion=softwareVersion, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, unitOutOfCalibration=unitOutOfCalibration, installStatusTrap=installStatusTrap, installArmStateTrap=installArmStateTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, snmpControlGroup=snmpControlGroup, dataPortAutoMdix=dataPortAutoMdix, management=management, vLANManagementPriority=vLANManagementPriority, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPv3Enable=sNMPv3Enable, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sMTPServerIPAddress=sMTPServerIPAddress, dfsGroup=dfsGroup, phyStatus=phyStatus, targetMACAddress=targetMACAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, capacityLicenseMismatch=capacityLicenseMismatch, telecomsLoopback=telecomsLoopback, telnetPortNumber=telnetPortNumber, sNTPPollInterval=sNTPPollInterval, iPAddress=iPAddress, vLANPriorityTableEntry=vLANPriorityTableEntry, dfsTableNumber=dfsTableNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, userTableEntry=userTableEntry, sNMPPortNumber=sNMPPortNumber, versions=versions, incompatibleRegionCodes=incompatibleRegionCodes, maximumTransmitPower=maximumTransmitPower, latitude=latitude, snmpControl=snmpControl, telecomGroup=telecomGroup, altitude=altitude, sntp=sntp, sMTPEmailAlert=sMTPEmailAlert, dfsTableIndex=dfsTableIndex, ptmp=ptmp)
