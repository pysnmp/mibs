...
Counter64, Unsigned32, Integer32, iso, Gauge32, ModuleIdentity, TimeTicks, NotificationType, Counter32, MibIdentifier, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Unsigned32", "Integer32", "iso", "Gauge32", "ModuleIdentity", "TimeTicks", "NotificationType", "Counter32", "MibIdentifier", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "enterprises")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", syslogStateTrap=syslogStateTrap, regionCodeTrap=regionCodeTrap, phyControlGroup=phyControlGroup, phyStatusGroup=phyStatusGroup, receiveModulationModeDetail=receiveModulationModeDetail, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, telecomGroup=telecomGroup, telnetPortNumber=telnetPortNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, smtp=smtp, wirelessLinkAvailability=wirelessLinkAvailability, regionCode=regionCode, syslogClient=syslogClient, vLANPriorityTableIndex=vLANPriorityTableIndex, capacityLicenseMismatch=capacityLicenseMismatch, sNTPServerPortNumber=sNTPServerPortNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, siteName=siteName, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, range=range, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tDDSynchronizationStatus=tDDSynchronizationStatus, ethernetGroup=ethernetGroup, telecomsLoopback=telecomsLoopback, transmitModulationMode=transmitModulationMode, vLANPriorityQueueMapping=vLANPriorityQueueMapping, masterSlaveMode=masterSlaveMode, sNTPState=sNTPState, userTableNumber=userTableNumber, ptpTraps=ptpTraps, wirelessLinkStatus=wirelessLinkStatus, eIRP=eIRP, installStatusTrap=installStatusTrap, userName=userName, sMTPServerIPAddress=sMTPServerIPAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ptp500=ptp500, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, targetMACAddress=targetMACAddress, ptmp=ptmp, bootVersion=bootVersion, cambium=cambium, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, vLANManagementPriority=vLANManagementPriority, vLANManagementVID=vLANManagementVID, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, versions=versions, aggregateDataRate=aggregateDataRate, syslogState=syslogState, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, resetGroup=resetGroup, gatewayIPAddress=gatewayIPAddress, ptpTrapPrefix=ptpTrapPrefix, dataPortStatusTrap=dataPortStatusTrap, installStatus=installStatus, sNMPEnabledTraps=sNMPEnabledTraps, encryptionGroup=encryptionGroup, dataPortAutoMdix=dataPortAutoMdix, snmpControl=snmpControl, alarms=alarms, antennaGain=antennaGain, receiveFreqMHz=receiveFreqMHz, dfsMeans=dfsMeans, syslogLocalWrappedTrap=syslogLocalWrappedTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, PYSNMP_MODULE_ID=cambium, maximumTransmitPower=maximumTransmitPower, telecomsChannelStatus=telecomsChannelStatus, hardwareVersion=hardwareVersion, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, vLANPriorityTable=vLANPriorityTable, productVariant=productVariant, snmpControlGroup=snmpControlGroup, remoteIPAddress=remoteIPAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, softwareVersion=softwareVersion, signalStrengthRatio=signalStrengthRatio, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsTableNumber=dfsTableNumber, ptpCompliance=ptpCompliance, telecomsLineCode=telecomsLineCode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, receivePower=receivePower, sNMPCommunityString=sNMPCommunityString, transmitPower=transmitPower, pubStatsGroup=pubStatsGroup, ptpGroups=ptpGroups, longitude=longitude, telecomsInterface=telecomsInterface, phyStatus=phyStatus, configurationGroup=configurationGroup, sMTPEmailAlert=sMTPEmailAlert, frequencyVariant=frequencyVariant, notificationsGroup=notificationsGroup, syslogClientTrap=syslogClientTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPPortNumber=sNMPPortNumber, licence=licence, userTableEntry=userTableEntry, systemReset=systemReset, dfsTable=dfsTable, vectorError=vectorError, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dataPortWirelessDownAlert=dataPortWirelessDownAlert, secondarySoftwareVersion=secondarySoftwareVersion, dfsGroup=dfsGroup, linkModeOptimisation=linkModeOptimisation, userRole=userRole, telecomsLoopbackTrap=telecomsLoopbackTrap, searchState=searchState, hTTPSPortNumber=hTTPSPortNumber, tDDControlGroup=tDDControlGroup, accessMethod=accessMethod, installArmState=installArmState, timeZone=timeZone, useVLANForManagementInterfaces=useVLANForManagementInterfaces, pubStats=pubStats, phyControl=phyControl, receiveDataRate=receiveDataRate, ethernet=ethernet, managementGroup=managementGroup, supplementaryGroup=supplementaryGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, unitOutOfCalibration=unitOutOfCalibration, altitude=altitude, sNTPSync=sNTPSync, userTableIndex=userTableIndex, licensedCapacity=licensedCapacity, channelChangeTrap=channelChangeTrap, dataPortStatus=dataPortStatus, receiveFreqKHz=receiveFreqKHz, tDDSynchronizationMode=tDDSynchronizationMode, telecom=telecom, encryptionAlgorithm=encryptionAlgorithm, supplementary=supplementary, sNMPTrapTableNumber=sNMPTrapTableNumber, systemClock=systemClock, transmitFreqKHz=transmitFreqKHz, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNMPTrapTable=sNMPTrapTable, iPAddress=iPAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, receiveChannel=receiveChannel, tFTPServerIPAddress=tFTPServerIPAddress, encryption=encryption, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, noWirelessChannelAvailable=noWirelessChannelAvailable, linkLoss=linkLoss, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, smtpGroup=smtpGroup, telecomsChannelStatusTrap=telecomsChannelStatusTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, aAAControlGroup=aAAControlGroup, sntp=sntp, sNMPTrapIPAddress=sNMPTrapIPAddress, telecomsCableLength=telecomsCableLength, management=management, hTTPPortNumber=hTTPPortNumber, vLANPriorityTableNumber=vLANPriorityTableNumber, licenceGroup=licenceGroup, sNMPv3Enable=sNMPv3Enable, linkSymmetry=linkSymmetry, incompatibleRegionCodes=incompatibleRegionCodes, daylightSaving=daylightSaving, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, bandwidthVariant=bandwidthVariant, constantPowerSpectralDensity=constantPowerSpectralDensity, dataPortDisabledWarning=dataPortDisabledWarning, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, versionsGroup=versionsGroup, sNTPLastSync=sNTPLastSync, syslogControl=syslogControl, channelBandwidth=channelBandwidth, transmitFreqMHz=transmitFreqMHz, transmitDataRate=transmitDataRate, sMTPEnabledMessages=sMTPEnabledMessages, sNTPServerIPAddress=sNTPServerIPAddress, installArmStateTrap=installArmStateTrap, sNTPPollInterval=sNTPPollInterval, tFTPServerPortNumber=tFTPServerPortNumber, dfsPeaks=dfsPeaks, hTTPAccessEnabled=hTTPAccessEnabled, userEnabled=userEnabled, dfsTableEntry=dfsTableEntry, transmitChannel=transmitChannel, productName=productName, sMTPServerPortNumber=sMTPServerPortNumber, cableLoss=cableLoss, groupID=groupID, userTable=userTable, tDDControl=tDDControl, subnetMask=subnetMask, dfsTableIndex=dfsTableIndex, ptp=ptp, reset=reset, alarmsGroup=alarmsGroup, ethernetFiberSupport=ethernetFiberSupport, receiveModulationMode=receiveModulationMode, vLANPriorityTableEntry=vLANPriorityTableEntry, sNMPTrapVersion=sNMPTrapVersion, byteErrorRatio=byteErrorRatio, userPassword=userPassword, latitude=latitude, sNTPSyncTrap=sNTPSyncTrap, dfs=dfs, aAAControl=aAAControl, linkName=linkName, configuration=configuration, telnetAccessEnabled=telnetAccessEnabled, sntpGroup=sntpGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, syslogControlGroup=syslogControlGroup)
