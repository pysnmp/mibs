...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", vLANPriorityTableIndex=vLANPriorityTableIndex, sntpGroup=sntpGroup, frequencyVariant=frequencyVariant, encryptionAlgorithm=encryptionAlgorithm, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, installStatusTrap=installStatusTrap, userPassword=userPassword, tDDSynchronizationStatus=tDDSynchronizationStatus, siteName=siteName, wirelessLinkStatus=wirelessLinkStatus, tFTPServerIPAddress=tFTPServerIPAddress, vectorError=vectorError, snmpControl=snmpControl, syslogControl=syslogControl, installStatus=installStatus, sNTPSyncTrap=sNTPSyncTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, timeZone=timeZone, linkLoss=linkLoss, sNMPv3Enable=sNMPv3Enable, userName=userName, userEnabled=userEnabled, sNTPState=sNTPState, pubStats=pubStats, phyStatusGroup=phyStatusGroup, syslogState=syslogState, cambium=cambium, telecomsLoopback=telecomsLoopback, sNMPTrapTableNumber=sNMPTrapTableNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, versions=versions, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, telecomsCableLength=telecomsCableLength, encryptionGroup=encryptionGroup, phyStatus=phyStatus, altitude=altitude, syslogClientTrap=syslogClientTrap, systemReset=systemReset, phyControl=phyControl, range=range, telecomsLoopbackTrap=telecomsLoopbackTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, remoteIPAddress=remoteIPAddress, sMTPServerPortNumber=sMTPServerPortNumber, iPAddress=iPAddress, dfsTable=dfsTable, incompatibleRegionCodes=incompatibleRegionCodes, accessMethod=accessMethod, subnetMask=subnetMask, reset=reset, userTableIndex=userTableIndex, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, linkModeOptimisation=linkModeOptimisation, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, channelBandwidth=channelBandwidth, syslogControlGroup=syslogControlGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPPollInterval=sNTPPollInterval, tDDSynchronizationMode=tDDSynchronizationMode, unitOutOfCalibration=unitOutOfCalibration, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, installArmStateTrap=installArmStateTrap, telecomsChannelStatus=telecomsChannelStatus, ethernetGroup=ethernetGroup, smtpGroup=smtpGroup, licenceGroup=licenceGroup, telecom=telecom, phyControlGroup=phyControlGroup, dfsTableNumber=dfsTableNumber, systemClock=systemClock, userTableNumber=userTableNumber, smtp=smtp, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, ptmp=ptmp, alarmsGroup=alarmsGroup, hTTPPortNumber=hTTPPortNumber, dfsTableEntry=dfsTableEntry, transmitFreqMHz=transmitFreqMHz, ptp=ptp, targetMACAddress=targetMACAddress, dataPortStatus=dataPortStatus, receiveChannel=receiveChannel, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPServerIPAddress=sNTPServerIPAddress, regionCode=regionCode, vLANPriorityTableEntry=vLANPriorityTableEntry, syslogClient=syslogClient, transmitModulationMode=transmitModulationMode, dataPortAutoMdix=dataPortAutoMdix, receiveFreqMHz=receiveFreqMHz, transmitDataRate=transmitDataRate, sntp=sntp, supplementaryGroup=supplementaryGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dfs=dfs, channelChangeTrap=channelChangeTrap, productVariant=productVariant, byteErrorRatio=byteErrorRatio, productName=productName, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapTable=sNMPTrapTable, telnetAccessEnabled=telnetAccessEnabled, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapVersion=sNMPTrapVersion, signalStrengthRatio=signalStrengthRatio, dfsGroup=dfsGroup, snmpControlGroup=snmpControlGroup, receiveModulationModeDetail=receiveModulationModeDetail, tDDControl=tDDControl, searchState=searchState, ethernet=ethernet, ethernetFiberSupport=ethernetFiberSupport, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfsMeans=dfsMeans, userTable=userTable, userRole=userRole, daylightSaving=daylightSaving, sNTPServerPortNumber=sNTPServerPortNumber, vLANManagementVID=vLANManagementVID, masterSlaveMode=masterSlaveMode, longitude=longitude, cableLoss=cableLoss, transmitFreqKHz=transmitFreqKHz, syslogLocalWrappedTrap=syslogLocalWrappedTrap, installArmState=installArmState, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNMPCommunityString=sNMPCommunityString, versionsGroup=versionsGroup, hTTPSPortNumber=hTTPSPortNumber, receiveModulationMode=receiveModulationMode, gatewayIPAddress=gatewayIPAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, PYSNMP_MODULE_ID=cambium, sNTPLastSync=sNTPLastSync, linkName=linkName, sMTPSourceEmailAddress=sMTPSourceEmailAddress, licensedCapacity=licensedCapacity, maximumTransmitPower=maximumTransmitPower, telecomGroup=telecomGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, receiveFreqKHz=receiveFreqKHz, regionCodeTrap=regionCodeTrap, tDDControlGroup=tDDControlGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, secondarySoftwareVersion=secondarySoftwareVersion, sNMPEnabledTraps=sNMPEnabledTraps, sNTPSync=sNTPSync, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, telecomsLineCode=telecomsLineCode, sNMPTrapTableEntry=sNMPTrapTableEntry, eIRP=eIRP, bandwidthVariant=bandwidthVariant, telnetPortNumber=telnetPortNumber, pubStatsGroup=pubStatsGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, management=management, constantPowerSpectralDensity=constantPowerSpectralDensity, transmitPower=transmitPower, ptpGroups=ptpGroups, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, notificationsGroup=notificationsGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, receiveDataRate=receiveDataRate, capacityLicenseMismatch=capacityLicenseMismatch, alarms=alarms, resetGroup=resetGroup, dataPortDisabledWarning=dataPortDisabledWarning, receivePower=receivePower, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, transmitChannel=transmitChannel, managementGroup=managementGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, vLANPriorityQueueMapping=vLANPriorityQueueMapping, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, licence=licence, tFTPServerPortNumber=tFTPServerPortNumber, supplementary=supplementary, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, configurationGroup=configurationGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPPortNumber=sNMPPortNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telecomsInterface=telecomsInterface, latitude=latitude, ptpTraps=ptpTraps, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, linkSymmetry=linkSymmetry, sNMPTrapTableIndex=sNMPTrapTableIndex, ptp500=ptp500, vLANPriorityTable=vLANPriorityTable, antennaGain=antennaGain, groupID=groupID, dfsPeaks=dfsPeaks, softwareVersion=softwareVersion, wirelessLinkAvailability=wirelessLinkAvailability, vLANManagementPriority=vLANManagementPriority, sNMPTrapPortNumber=sNMPTrapPortNumber, syslogStateTrap=syslogStateTrap, aAAControl=aAAControl, enabledDiagnosticAlarms=enabledDiagnosticAlarms, userTableEntry=userTableEntry, dfsTableIndex=dfsTableIndex, incompatibleMasterAndSlave=incompatibleMasterAndSlave, configuration=configuration, hTTPAccessEnabled=hTTPAccessEnabled, aAAControlGroup=aAAControlGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, encryption=encryption, hardwareVersion=hardwareVersion, bootVersion=bootVersion, dataPortStatusTrap=dataPortStatusTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ptpTrapPrefix=ptpTrapPrefix, ptpCompliance=ptpCompliance, sMTPEnabledMessages=sMTPEnabledMessages, aggregateDataRate=aggregateDataRate, dataPortAutoNegotiation=dataPortAutoNegotiation)
