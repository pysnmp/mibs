...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, smtp=smtp, transmitFreqKHz=transmitFreqKHz, licence=licence, linkName=linkName, sNTPServerIPAddress=sNTPServerIPAddress, versions=versions, transmitPower=transmitPower, phyStatus=phyStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapPortNumber=sNMPTrapPortNumber, telecomsInterface=telecomsInterface, byteErrorRatio=byteErrorRatio, vLANPriorityTable=vLANPriorityTable, productVariant=productVariant, systemClock=systemClock, productName=productName, receiveChannel=receiveChannel, notificationsGroup=notificationsGroup, accessMethod=accessMethod, resetGroup=resetGroup, longitude=longitude, remoteIPAddress=remoteIPAddress, sntp=sntp, userEnabled=userEnabled, linkModeOptimisation=linkModeOptimisation, vectorError=vectorError, altitude=altitude, dfsTableEntry=dfsTableEntry, sMTPEmailAlert=sMTPEmailAlert, constantPowerSpectralDensity=constantPowerSpectralDensity, tFTPServerPortNumber=tFTPServerPortNumber, receiveModulationModeDetail=receiveModulationModeDetail, syslogClient=syslogClient, alarmsGroup=alarmsGroup, managementGroup=managementGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, snmpControl=snmpControl, sNMPTrapIPAddress=sNMPTrapIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, latitude=latitude, installStatusTrap=installStatusTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, targetMACAddress=targetMACAddress, sNTPState=sNTPState, telecomsCableLength=telecomsCableLength, sNMPTrapTableEntry=sNMPTrapTableEntry, frequencyVariant=frequencyVariant, hTTPPortNumber=hTTPPortNumber, linkLoss=linkLoss, receiveDataRate=receiveDataRate, sntpGroup=sntpGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, syslogControlGroup=syslogControlGroup, dfsTableNumber=dfsTableNumber, licenceGroup=licenceGroup, telecomsLineCode=telecomsLineCode, hTTPSPortNumber=hTTPSPortNumber, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, linkSymmetry=linkSymmetry, ptp=ptp, incompatibleRegionCodes=incompatibleRegionCodes, licensedCapacity=licensedCapacity, ptpGroups=ptpGroups, noWirelessChannelAvailable=noWirelessChannelAvailable, versionsGroup=versionsGroup, sNMPv3Enable=sNMPv3Enable, sNMPTrapVersion=sNMPTrapVersion, installStatus=installStatus, cableLoss=cableLoss, hTTPAccessEnabled=hTTPAccessEnabled, ptpCompliance=ptpCompliance, PYSNMP_MODULE_ID=cambium, configurationGroup=configurationGroup, iPAddress=iPAddress, subnetMask=subnetMask, vLANManagementPriority=vLANManagementPriority, regionCodeTrap=regionCodeTrap, channelBandwidth=channelBandwidth, siteName=siteName, dataPortStatusTrap=dataPortStatusTrap, userTable=userTable, hTTPSAccessEnabled=hTTPSAccessEnabled, receivePower=receivePower, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, secondarySoftwareVersion=secondarySoftwareVersion, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNMPTrapTableIndex=sNMPTrapTableIndex, configuration=configuration, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tDDSynchronizationMode=tDDSynchronizationMode, userTableIndex=userTableIndex, telecomsChannelStatusTrap=telecomsChannelStatusTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, dataPortDisabledWarning=dataPortDisabledWarning, sNTPSync=sNTPSync, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ethernetFiberSupport=ethernetFiberSupport, receiveFreqKHz=receiveFreqKHz, unitOutOfCalibration=unitOutOfCalibration, dataPortAutoNegotiation=dataPortAutoNegotiation, vLANPriorityTableIndex=vLANPriorityTableIndex, syslogControl=syslogControl, softwareVersion=softwareVersion, sMTPServerPortNumber=sMTPServerPortNumber, aggregateDataRate=aggregateDataRate, sMTPServerIPAddress=sMTPServerIPAddress, sNMPCommunityString=sNMPCommunityString, supplementaryGroup=supplementaryGroup, syslogState=syslogState, cambium=cambium, tFTPServerIPAddress=tFTPServerIPAddress, pubStatsGroup=pubStatsGroup, daylightSaving=daylightSaving, range=range, tDDSynchronizationStatus=tDDSynchronizationStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, bootVersion=bootVersion, telecom=telecom, dfsPeaks=dfsPeaks, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, receiveFreqMHz=receiveFreqMHz, phyStatusGroup=phyStatusGroup, hardwareVersion=hardwareVersion, alarms=alarms, tDDControl=tDDControl, supplementary=supplementary, dataPortStatus=dataPortStatus, capacityLicenseMismatch=capacityLicenseMismatch, receiveModulationMode=receiveModulationMode, ptpTraps=ptpTraps, installArmState=installArmState, reset=reset, eIRP=eIRP, dfsMeans=dfsMeans, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, maximumTransmitPower=maximumTransmitPower, transmitDataRate=transmitDataRate, sNMPEnabledTraps=sNMPEnabledTraps, sNTPLastSync=sNTPLastSync, userPassword=userPassword, ethernet=ethernet, management=management, transmitFreqMHz=transmitFreqMHz, ptp500=ptp500, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telnetPortNumber=telnetPortNumber, searchState=searchState, syslogStateTrap=syslogStateTrap, timeZone=timeZone, installArmStateTrap=installArmStateTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, pubStats=pubStats, dfsTable=dfsTable, wirelessLinkAvailability=wirelessLinkAvailability, encryptionAlgorithm=encryptionAlgorithm, vLANPriorityQueueMapping=vLANPriorityQueueMapping, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, transmitModulationMode=transmitModulationMode, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPServerPortNumber=sNTPServerPortNumber, encryptionGroup=encryptionGroup, smtpGroup=smtpGroup, snmpControlGroup=snmpControlGroup, vLANManagementVID=vLANManagementVID, vLANPriorityTableEntry=vLANPriorityTableEntry, dfsTableIndex=dfsTableIndex, telecomsLoopbackTrap=telecomsLoopbackTrap, sNTPSyncTrap=sNTPSyncTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapTable=sNMPTrapTable, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ptmp=ptmp, encryption=encryption, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sMTPEnabledMessages=sMTPEnabledMessages, userName=userName, userTableEntry=userTableEntry, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, vLANPriorityTableNumber=vLANPriorityTableNumber, ptpTrapPrefix=ptpTrapPrefix, sNTPPollInterval=sNTPPollInterval, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, wirelessLinkStatus=wirelessLinkStatus, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dfs=dfs, dataPortAutoMdix=dataPortAutoMdix, telecomGroup=telecomGroup, gatewayIPAddress=gatewayIPAddress, phyControl=phyControl, aAAControl=aAAControl, userRole=userRole, antennaGain=antennaGain, phyControlGroup=phyControlGroup, masterSlaveMode=masterSlaveMode, syslogClientTrap=syslogClientTrap, sNMPPortNumber=sNMPPortNumber, regionCode=regionCode, systemReset=systemReset, signalStrengthRatio=signalStrengthRatio, tDDControlGroup=tDDControlGroup, transmitChannel=transmitChannel, bandwidthVariant=bandwidthVariant, telecomsLoopback=telecomsLoopback, telnetAccessEnabled=telnetAccessEnabled, dfsGroup=dfsGroup, groupID=groupID, userTableNumber=userTableNumber, aAAControlGroup=aAAControlGroup, channelChangeTrap=channelChangeTrap, telecomsChannelStatus=telecomsChannelStatus, ethernetGroup=ethernetGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, linkModeOptimizationMismatch=linkModeOptimizationMismatch)
