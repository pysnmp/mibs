...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", hardwareVersion=hardwareVersion, vLANPriorityTableNumber=vLANPriorityTableNumber, capacityLicenseMismatch=capacityLicenseMismatch, userTableNumber=userTableNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, reset=reset, installArmStateTrap=installArmStateTrap, telnetPortNumber=telnetPortNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPServerIPAddress=sNTPServerIPAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, dfs=dfs, transmitDataRate=transmitDataRate, versions=versions, dfsPeaks=dfsPeaks, ethernetGroup=ethernetGroup, remoteIPAddress=remoteIPAddress, wirelessLinkAvailability=wirelessLinkAvailability, masterSlaveMode=masterSlaveMode, sNMPTrapVersion=sNMPTrapVersion, ptpCompliance=ptpCompliance, tDDSynchronizationMode=tDDSynchronizationMode, systemReset=systemReset, telecomsLoopbackTrap=telecomsLoopbackTrap, linkSymmetry=linkSymmetry, telecomsLineCode=telecomsLineCode, bootVersion=bootVersion, sntp=sntp, transmitPower=transmitPower, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, userTable=userTable, timeZone=timeZone, ptmp=ptmp, cableLoss=cableLoss, regionCodeTrap=regionCodeTrap, receiveFreqMHz=receiveFreqMHz, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userTableIndex=userTableIndex, telecomsCableLength=telecomsCableLength, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dfsTableIndex=dfsTableIndex, sNTPState=sNTPState, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, installStatusTrap=installStatusTrap, phyStatus=phyStatus, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, syslogStateTrap=syslogStateTrap, licence=licence, pubStatsGroup=pubStatsGroup, PYSNMP_MODULE_ID=cambium, transmitModulationMode=transmitModulationMode, sNTPServerPortNumber=sNTPServerPortNumber, dfsMeans=dfsMeans, userRole=userRole, antennaGain=antennaGain, transmitChannel=transmitChannel, phyStatusGroup=phyStatusGroup, ptpGroups=ptpGroups, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, encryptionAlgorithm=encryptionAlgorithm, aAAControl=aAAControl, tFTPServerPortNumber=tFTPServerPortNumber, configurationGroup=configurationGroup, telnetAccessEnabled=telnetAccessEnabled, hTTPAccessEnabled=hTTPAccessEnabled, targetMACAddress=targetMACAddress, vectorError=vectorError, dataPortStatusTrap=dataPortStatusTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortStatus=dataPortStatus, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataPortConfigurationMismatch=dataPortConfigurationMismatch, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPv3Enable=sNMPv3Enable, dataPortAutoMdix=dataPortAutoMdix, receiveChannel=receiveChannel, daylightSaving=daylightSaving, vLANPriorityTableEntry=vLANPriorityTableEntry, sNTPSync=sNTPSync, bandwidthVariant=bandwidthVariant, vLANManagementVID=vLANManagementVID, syslogClient=syslogClient, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, subnetMask=subnetMask, productName=productName, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, syslogControl=syslogControl, maximumTransmitPower=maximumTransmitPower, userTableEntry=userTableEntry, smtp=smtp, snmpControlGroup=snmpControlGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, linkName=linkName, cambium=cambium, notificationsGroup=notificationsGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, frequencyVariant=frequencyVariant, channelBandwidth=channelBandwidth, supplementaryGroup=supplementaryGroup, encryptionGroup=encryptionGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, sMTPServerIPAddress=sMTPServerIPAddress, sntpGroup=sntpGroup, eIRP=eIRP, syslogControlGroup=syslogControlGroup, vLANPriorityTable=vLANPriorityTable, vLANManagementPriority=vLANManagementPriority, alarms=alarms, secondarySoftwareVersion=secondarySoftwareVersion, sNMPPortNumber=sNMPPortNumber, vLANPriorityQueueMapping=vLANPriorityQueueMapping, incompatibleRegionCodes=incompatibleRegionCodes, userPassword=userPassword, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortAutoNegotiation=dataPortAutoNegotiation, receiveDataRate=receiveDataRate, sMTPEmailAlert=sMTPEmailAlert, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, receiveFreqKHz=receiveFreqKHz, useVLANForManagementInterfaces=useVLANForManagementInterfaces, range=range, sNMPCommunityString=sNMPCommunityString, byteErrorRatio=byteErrorRatio, latitude=latitude, smtpGroup=smtpGroup, syslogClientTrap=syslogClientTrap, userEnabled=userEnabled, licenceGroup=licenceGroup, versionsGroup=versionsGroup, telecomsInterface=telecomsInterface, ptpTrapPrefix=ptpTrapPrefix, resetGroup=resetGroup, searchState=searchState, dfsTableEntry=dfsTableEntry, sNMPTrapTable=sNMPTrapTable, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogState=syslogState, ptpTraps=ptpTraps, sNTPPollInterval=sNTPPollInterval, pubStats=pubStats, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, installStatus=installStatus, tDDSynchronizationStatus=tDDSynchronizationStatus, telecomGroup=telecomGroup, telecomsChannelStatus=telecomsChannelStatus, transmitFreqKHz=transmitFreqKHz, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, receiveModulationModeDetail=receiveModulationModeDetail, incompatibleMasterAndSlave=incompatibleMasterAndSlave, supplementary=supplementary, groupID=groupID, managementGroup=managementGroup, installArmState=installArmState, sMTPServerPortNumber=sMTPServerPortNumber, productVariant=productVariant, tFTPServerIPAddress=tFTPServerIPAddress, systemClock=systemClock, sNTPSyncTrap=sNTPSyncTrap, dfsGroup=dfsGroup, gatewayIPAddress=gatewayIPAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, phyControlGroup=phyControlGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, licensedCapacity=licensedCapacity, constantPowerSpectralDensity=constantPowerSpectralDensity, siteName=siteName, transmitFreqMHz=transmitFreqMHz, tDDControlGroup=tDDControlGroup, ethernet=ethernet, linkModeOptimisation=linkModeOptimisation, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, channelChangeTrap=channelChangeTrap, configuration=configuration, encryption=encryption, ptp500=ptp500, linkLoss=linkLoss, phyControl=phyControl, sNMPTrapTableIndex=sNMPTrapTableIndex, unitOutOfCalibration=unitOutOfCalibration, hTTPPortNumber=hTTPPortNumber, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, signalStrengthRatio=signalStrengthRatio, aAAControlGroup=aAAControlGroup, userName=userName, alarmsGroup=alarmsGroup, telecomsChannelStatusTrap=telecomsChannelStatusTrap, hTTPSPortNumber=hTTPSPortNumber, softwareVersion=softwareVersion, telecom=telecom, management=management, dfsTable=dfsTable, snmpControl=snmpControl, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, longitude=longitude, altitude=altitude, dfsTableNumber=dfsTableNumber, aggregateDataRate=aggregateDataRate, telecomsLoopback=telecomsLoopback, accessMethod=accessMethod, sMTPEnabledMessages=sMTPEnabledMessages, regionCode=regionCode, wirelessLinkStatus=wirelessLinkStatus, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPLastSync=sNTPLastSync, iPAddress=iPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ethernetFiberSupport=ethernetFiberSupport, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapIPAddress=sNMPTrapIPAddress, receivePower=receivePower, ptp=ptp, receiveModulationMode=receiveModulationMode, dataPortDisabledWarning=dataPortDisabledWarning, tDDControl=tDDControl, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapPortNumber=sNMPTrapPortNumber)
