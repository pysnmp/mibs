...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", notificationsGroup=notificationsGroup, hTTPPortNumber=hTTPPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, receiveDataRate=receiveDataRate, transmitChannel=transmitChannel, telecomsLoopback=telecomsLoopback, range=range, linkLoss=linkLoss, dataPortAutoMdix=dataPortAutoMdix, hTTPSPortNumber=hTTPSPortNumber, systemReset=systemReset, linkName=linkName, groupID=groupID, installArmState=installArmState, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, encryptionGroup=encryptionGroup, dfsTableEntry=dfsTableEntry, telecomsInterface=telecomsInterface, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitDataRate=transmitDataRate, telecomsChannelStatusTrap=telecomsChannelStatusTrap, snmpControl=snmpControl, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sntpGroup=sntpGroup, masterSlaveMode=masterSlaveMode, licence=licence, telecomGroup=telecomGroup, phyControlGroup=phyControlGroup, licenceGroup=licenceGroup, tDDControlGroup=tDDControlGroup, aggregateDataRate=aggregateDataRate, ethernetGroup=ethernetGroup, ptpTrapPrefix=ptpTrapPrefix, gatewayIPAddress=gatewayIPAddress, vLANPriorityTableIndex=vLANPriorityTableIndex, cableLoss=cableLoss, ptpCompliance=ptpCompliance, supplementary=supplementary, capacityLicenseMismatch=capacityLicenseMismatch, dfsGroup=dfsGroup, receiveFreqMHz=receiveFreqMHz, hTTPSAccessEnabled=hTTPSAccessEnabled, transmitModulationMode=transmitModulationMode, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, versions=versions, configuration=configuration, sNTPSync=sNTPSync, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, channelChangeTrap=channelChangeTrap, bandwidthVariant=bandwidthVariant, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, ptpGroups=ptpGroups, PYSNMP_MODULE_ID=cambium, receiveFreqKHz=receiveFreqKHz, incompatibleMasterAndSlave=incompatibleMasterAndSlave, enabledDiagnosticAlarms=enabledDiagnosticAlarms, phyStatusGroup=phyStatusGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receivePower=receivePower, searchState=searchState, targetMACAddress=targetMACAddress, sNMPEnabledTraps=sNMPEnabledTraps, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNTPServerIPAddress=sNTPServerIPAddress, userTableNumber=userTableNumber, dfsTableIndex=dfsTableIndex, dfsMeans=dfsMeans, pubStats=pubStats, dfs=dfs, phyControl=phyControl, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, regionCode=regionCode, sNMPv3Enable=sNMPv3Enable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, reset=reset, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, secondarySoftwareVersion=secondarySoftwareVersion, syslogStateTrap=syslogStateTrap, sntp=sntp, alarms=alarms, linkModeOptimizationMismatch=linkModeOptimizationMismatch, snmpControlGroup=snmpControlGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, managementGroup=managementGroup, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, hTTPAccessEnabled=hTTPAccessEnabled, resetGroup=resetGroup, transmitFreqKHz=transmitFreqKHz, syslogClientTrap=syslogClientTrap, userTableIndex=userTableIndex, ethernet=ethernet, latitude=latitude, sMTPEnabledMessages=sMTPEnabledMessages, wirelessLinkAvailability=wirelessLinkAvailability, remoteMaximumTransmitPower=remoteMaximumTransmitPower, frequencyVariant=frequencyVariant, altitude=altitude, encryption=encryption, telecomsCableLength=telecomsCableLength, vectorError=vectorError, syslogClient=syslogClient, tFTPServerIPAddress=tFTPServerIPAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, siteName=siteName, subnetMask=subnetMask, syslogControlGroup=syslogControlGroup, aAAControl=aAAControl, receiveModulationModeDetail=receiveModulationModeDetail, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dfsPeaks=dfsPeaks, ethernetFiberSupport=ethernetFiberSupport, supplementaryGroup=supplementaryGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, receiveModulationMode=receiveModulationMode, management=management, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNTPLastSync=sNTPLastSync, telnetAccessEnabled=telnetAccessEnabled, configurationGroup=configurationGroup, longitude=longitude, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPState=sNTPState, noWirelessChannelAvailable=noWirelessChannelAvailable, telnetPortNumber=telnetPortNumber, installArmStateTrap=installArmStateTrap, accessMethod=accessMethod, telecomsChannelStatus=telecomsChannelStatus, licensedCapacity=licensedCapacity, constantPowerSpectralDensity=constantPowerSpectralDensity, productName=productName, cambium=cambium, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNTPServerPortNumber=sNTPServerPortNumber, userRole=userRole, userTableEntry=userTableEntry, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPPortNumber=sNMPPortNumber, wirelessLinkStatus=wirelessLinkStatus, sNTPSyncTrap=sNTPSyncTrap, smtpGroup=smtpGroup, dataPortDisabledWarning=dataPortDisabledWarning, regionCodeTrap=regionCodeTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, dfsTableNumber=dfsTableNumber, timeZone=timeZone, tDDControl=tDDControl, tDDSynchronizationStatus=tDDSynchronizationStatus, bootVersion=bootVersion, sNMPTrapTableIndex=sNMPTrapTableIndex, vLANPriorityTable=vLANPriorityTable, maximumTransmitPower=maximumTransmitPower, telecomsLoopbackTrap=telecomsLoopbackTrap, installStatusTrap=installStatusTrap, userTable=userTable, smtp=smtp, versionsGroup=versionsGroup, linkModeOptimisation=linkModeOptimisation, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapVersion=sNMPTrapVersion, systemClock=systemClock, tDDSynchronizationMode=tDDSynchronizationMode, alarmsGroup=alarmsGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, transmitFreqMHz=transmitFreqMHz, dataPortStatusTrap=dataPortStatusTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ptmp=ptmp, dfsTable=dfsTable, antennaGain=antennaGain, userPassword=userPassword, iPAddress=iPAddress, daylightSaving=daylightSaving, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, aAAControlGroup=aAAControlGroup, tFTPServerPortNumber=tFTPServerPortNumber, ptp=ptp, signalStrengthRatio=signalStrengthRatio, hardwareVersion=hardwareVersion, vLANManagementVID=vLANManagementVID, unitOutOfCalibration=unitOutOfCalibration, syslogState=syslogState, dataPortStatus=dataPortStatus, pubStatsGroup=pubStatsGroup, byteErrorRatio=byteErrorRatio, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, encryptionAlgorithm=encryptionAlgorithm, productVariant=productVariant, installStatus=installStatus, userName=userName, sNTPPollInterval=sNTPPollInterval, userEnabled=userEnabled, channelBandwidth=channelBandwidth, eIRP=eIRP, telecom=telecom, ptp500=ptp500, sMTPServerPortNumber=sMTPServerPortNumber, transmitPower=transmitPower, sNMPCommunityString=sNMPCommunityString, dataPortWirelessDownAlert=dataPortWirelessDownAlert, receiveChannel=receiveChannel, sMTPServerIPAddress=sMTPServerIPAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, linkSymmetry=linkSymmetry, softwareVersion=softwareVersion, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPTrapTable=sNMPTrapTable, vLANManagementPriority=vLANManagementPriority, syslogControl=syslogControl, ptpTraps=ptpTraps, telecomsLineCode=telecomsLineCode, tDDSynchronizationAlarm=tDDSynchronizationAlarm, incompatibleRegionCodes=incompatibleRegionCodes, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapTableEntry=sNMPTrapTableEntry, remoteIPAddress=remoteIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, phyStatus=phyStatus)
