...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", ptmp=ptmp, syslogControl=syslogControl, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, regionCode=regionCode, capacityLicenseMismatch=capacityLicenseMismatch, sNMPTrapTableNumber=sNMPTrapTableNumber, searchState=searchState, transmitModulationMode=transmitModulationMode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, linkName=linkName, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, gatewayIPAddress=gatewayIPAddress, resetGroup=resetGroup, sNTPState=sNTPState, signalStrengthRatio=signalStrengthRatio, frequencyVariant=frequencyVariant, snmpControl=snmpControl, phyStatus=phyStatus, supplementary=supplementary, vLANPriorityTableEntry=vLANPriorityTableEntry, sNTPSync=sNTPSync, sNTPServerPortNumber=sNTPServerPortNumber, maximumTransmitPower=maximumTransmitPower, vLANPriorityQueueMapping=vLANPriorityQueueMapping, receiveDataRate=receiveDataRate, sntpGroup=sntpGroup, byteErrorRatio=byteErrorRatio, sNTPPollInterval=sNTPPollInterval, encryptionAlgorithm=encryptionAlgorithm, versionsGroup=versionsGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, userTableIndex=userTableIndex, noWirelessChannelAvailable=noWirelessChannelAvailable, sNTPServerIPAddress=sNTPServerIPAddress, dfsMeans=dfsMeans, versions=versions, sNMPv3Enable=sNMPv3Enable, dfsGroup=dfsGroup, remoteIPAddress=remoteIPAddress, receivePower=receivePower, incompatibleMasterAndSlave=incompatibleMasterAndSlave, installStatus=installStatus, smtpGroup=smtpGroup, dfsTableEntry=dfsTableEntry, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, accessMethod=accessMethod, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sntp=sntp, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, alarms=alarms, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPServerIPAddress=tFTPServerIPAddress, regionCodeTrap=regionCodeTrap, transmitChannel=transmitChannel, productVariant=productVariant, dataPortDisabledWarning=dataPortDisabledWarning, dfsTableIndex=dfsTableIndex, siteName=siteName, ptpCompliance=ptpCompliance, encryptionGroup=encryptionGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, PYSNMP_MODULE_ID=cambium, telecomsLoopback=telecomsLoopback, sMTPServerPortNumber=sMTPServerPortNumber, telnetAccessEnabled=telnetAccessEnabled, dataPortWirelessDownAlert=dataPortWirelessDownAlert, aAAControlGroup=aAAControlGroup, latitude=latitude, antennaGain=antennaGain, cableLoss=cableLoss, tFTPServerPortNumber=tFTPServerPortNumber, dataPortAutoMdix=dataPortAutoMdix, userEnabled=userEnabled, syslogStateTrap=syslogStateTrap, ptpTrapPrefix=ptpTrapPrefix, channelBandwidth=channelBandwidth, dfsTable=dfsTable, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, systemClock=systemClock, userRole=userRole, receiveFreqKHz=receiveFreqKHz, alarmsGroup=alarmsGroup, reset=reset, systemReset=systemReset, constantPowerSpectralDensity=constantPowerSpectralDensity, bootVersion=bootVersion, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userTableNumber=userTableNumber, aAAControl=aAAControl, sNMPCommunityString=sNMPCommunityString, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dfsTableNumber=dfsTableNumber, groupID=groupID, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, smtp=smtp, vLANManagementPriority=vLANManagementPriority, managementGroup=managementGroup, pubStats=pubStats, telecomGroup=telecomGroup, sNMPPortNumber=sNMPPortNumber, hardwareVersion=hardwareVersion, configuration=configuration, phyControlGroup=phyControlGroup, syslogControlGroup=syslogControlGroup, vectorError=vectorError, sNMPTrapVersion=sNMPTrapVersion, aggregateDataRate=aggregateDataRate, syslogState=syslogState, vLANPriorityTable=vLANPriorityTable, vLANManagementVID=vLANManagementVID, masterSlaveMode=masterSlaveMode, receiveChannel=receiveChannel, iPAddress=iPAddress, syslogClientTrap=syslogClientTrap, altitude=altitude, tDDControl=tDDControl, eIRP=eIRP, dataPortStatusTrap=dataPortStatusTrap, sNTPSyncTrap=sNTPSyncTrap, hTTPAccessEnabled=hTTPAccessEnabled, management=management, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ptpTraps=ptpTraps, linkModeOptimizationMismatch=linkModeOptimizationMismatch, transmitDataRate=transmitDataRate, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPTrapTable=sNMPTrapTable, hTTPPortNumber=hTTPPortNumber, transmitFreqMHz=transmitFreqMHz, configurationGroup=configurationGroup, sNMPEnabledTraps=sNMPEnabledTraps, sMTPEnabledMessages=sMTPEnabledMessages, receiveModulationModeDetail=receiveModulationModeDetail, userTableEntry=userTableEntry, ptp=ptp, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sMTPEmailAlert=sMTPEmailAlert, installArmState=installArmState, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPLastSync=sNTPLastSync, sNMPTrapPortNumber=sNMPTrapPortNumber, userName=userName, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, tDDControlGroup=tDDControlGroup, syslogClient=syslogClient, installStatusTrap=installStatusTrap, ptp500=ptp500, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, telecomsLineCode=telecomsLineCode, licence=licence, dfsPeaks=dfsPeaks, userTable=userTable, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ethernetFiberSupport=ethernetFiberSupport, bandwidthVariant=bandwidthVariant, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, transmitFreqKHz=transmitFreqKHz, phyControl=phyControl, telecomsCableLength=telecomsCableLength, notificationsGroup=notificationsGroup, pubStatsGroup=pubStatsGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dataPortStatus=dataPortStatus, phyStatusGroup=phyStatusGroup, supplementaryGroup=supplementaryGroup, tDDSynchronizationMode=tDDSynchronizationMode, snmpControlGroup=snmpControlGroup, telecomsChannelStatus=telecomsChannelStatus, licensedCapacity=licensedCapacity, linkSymmetry=linkSymmetry, transmitPower=transmitPower, linkLoss=linkLoss, secondarySoftwareVersion=secondarySoftwareVersion, linkModeOptimisation=linkModeOptimisation, softwareVersion=softwareVersion, range=range, installArmStateTrap=installArmStateTrap, licenceGroup=licenceGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, telecomsInterface=telecomsInterface, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, targetMACAddress=targetMACAddress, sMTPServerIPAddress=sMTPServerIPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, productName=productName, sNMPTrapTableIndex=sNMPTrapTableIndex, unitOutOfCalibration=unitOutOfCalibration, telecom=telecom, receiveFreqMHz=receiveFreqMHz, daylightSaving=daylightSaving, longitude=longitude, sNMPTrapIPAddress=sNMPTrapIPAddress, telecomsLoopbackTrap=telecomsLoopbackTrap, incompatibleRegionCodes=incompatibleRegionCodes, ethernet=ethernet, encryption=encryption, dfs=dfs, vLANPriorityTableIndex=vLANPriorityTableIndex, subnetMask=subnetMask, timeZone=timeZone, ethernetGroup=ethernetGroup, receiveModulationMode=receiveModulationMode, userPassword=userPassword, cambium=cambium, wirelessLinkAvailability=wirelessLinkAvailability, dataPortAutoNegotiation=dataPortAutoNegotiation, wirelessLinkStatus=wirelessLinkStatus, channelChangeTrap=channelChangeTrap, telnetPortNumber=telnetPortNumber, ptpGroups=ptpGroups, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, hTTPSPortNumber=hTTPSPortNumber)
