...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", vectorError=vectorError, latitude=latitude, constantPowerSpectralDensity=constantPowerSpectralDensity, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, vLANPriorityTableIndex=vLANPriorityTableIndex, transmitFreqKHz=transmitFreqKHz, sNMPTrapTableNumber=sNMPTrapTableNumber, sMTPServerPortNumber=sMTPServerPortNumber, sNTPLastSync=sNTPLastSync, searchState=searchState, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNMPTrapPortNumber=sNMPTrapPortNumber, capacityLicenseMismatch=capacityLicenseMismatch, tDDControlGroup=tDDControlGroup, ethernetGroup=ethernetGroup, ptpTraps=ptpTraps, linkSymmetry=linkSymmetry, smtpGroup=smtpGroup, sMTPEnabledMessages=sMTPEnabledMessages, syslogControlGroup=syslogControlGroup, wirelessLinkStatus=wirelessLinkStatus, tDDControl=tDDControl, transmitChannel=transmitChannel, transmitModulationMode=transmitModulationMode, syslogStateTrap=syslogStateTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortStatusTrap=dataPortStatusTrap, sNMPEnabledTraps=sNMPEnabledTraps, productName=productName, ptpTrapPrefix=ptpTrapPrefix, transmitPower=transmitPower, sNTPState=sNTPState, reset=reset, sNMPTrapTableEntry=sNMPTrapTableEntry, hTTPSPortNumber=hTTPSPortNumber, installStatus=installStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, systemClock=systemClock, linkName=linkName, groupID=groupID, dataPortStatus=dataPortStatus, vLANManagementVID=vLANManagementVID, siteName=siteName, cambium=cambium, versions=versions, snmpControl=snmpControl, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, supplementaryGroup=supplementaryGroup, sntpGroup=sntpGroup, secondarySoftwareVersion=secondarySoftwareVersion, ptpCompliance=ptpCompliance, managementGroup=managementGroup, signalStrengthRatio=signalStrengthRatio, licenceGroup=licenceGroup, bootVersion=bootVersion, telecomsChannelStatus=telecomsChannelStatus, dfsMeans=dfsMeans, vLANPriorityTable=vLANPriorityTable, installArmStateTrap=installArmStateTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, versionsGroup=versionsGroup, userTableEntry=userTableEntry, hTTPAccessEnabled=hTTPAccessEnabled, sNMPTrapTable=sNMPTrapTable, antennaGain=antennaGain, management=management, telecomsCableLength=telecomsCableLength, licensedCapacity=licensedCapacity, configuration=configuration, encryption=encryption, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, unitOutOfCalibration=unitOutOfCalibration, wirelessLinkAvailability=wirelessLinkAvailability, dfsGroup=dfsGroup, pubStatsGroup=pubStatsGroup, regionCode=regionCode, installArmState=installArmState, telecomsChannelStatusTrap=telecomsChannelStatusTrap, syslogClient=syslogClient, PYSNMP_MODULE_ID=cambium, snmpControlGroup=snmpControlGroup, longitude=longitude, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, phyControlGroup=phyControlGroup, userPassword=userPassword, alarms=alarms, telecomGroup=telecomGroup, daylightSaving=daylightSaving, receivePower=receivePower, accessMethod=accessMethod, hardwareVersion=hardwareVersion, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPv3Enable=sNMPv3Enable, dfs=dfs, sntp=sntp, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, subnetMask=subnetMask, receiveModulationMode=receiveModulationMode, sNMPTrapIPAddress=sNMPTrapIPAddress, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortAutoMdix=dataPortAutoMdix, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, notificationsGroup=notificationsGroup, phyControl=phyControl, dfsTable=dfsTable, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPPortNumber=sNMPPortNumber, tFTPServerIPAddress=tFTPServerIPAddress, receiveModulationModeDetail=receiveModulationModeDetail, altitude=altitude, maximumTransmitPower=maximumTransmitPower, dataPortConfigurationMismatch=dataPortConfigurationMismatch, hTTPPortNumber=hTTPPortNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPTrapVersion=sNMPTrapVersion, sNTPServerPortNumber=sNTPServerPortNumber, iPAddress=iPAddress, vLANPriorityTableNumber=vLANPriorityTableNumber, targetMACAddress=targetMACAddress, userTableIndex=userTableIndex, userRole=userRole, frequencyVariant=frequencyVariant, timeZone=timeZone, dataPortWirelessDownAlert=dataPortWirelessDownAlert, vLANManagementPriority=vLANManagementPriority, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, channelBandwidth=channelBandwidth, configurationGroup=configurationGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, aAAControl=aAAControl, installStatusTrap=installStatusTrap, ptpGroups=ptpGroups, sNMPCommunityString=sNMPCommunityString, syslogState=syslogState, tDDSynchronizationMode=tDDSynchronizationMode, telecom=telecom, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, regionCodeTrap=regionCodeTrap, ptmp=ptmp, alarmsGroup=alarmsGroup, telnetAccessEnabled=telnetAccessEnabled, softwareVersion=softwareVersion, userName=userName, linkModeOptimisation=linkModeOptimisation, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ptp500=ptp500, sMTPEmailAlert=sMTPEmailAlert, remoteIPAddress=remoteIPAddress, telecomsLineCode=telecomsLineCode, tDDSynchronizationAlarm=tDDSynchronizationAlarm, gatewayIPAddress=gatewayIPAddress, sNTPServerIPAddress=sNTPServerIPAddress, dataPortDisabledWarning=dataPortDisabledWarning, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, cableLoss=cableLoss, receiveChannel=receiveChannel, userTable=userTable, incompatibleMasterAndSlave=incompatibleMasterAndSlave, vLANPriorityQueueMapping=vLANPriorityQueueMapping, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, pubStats=pubStats, phyStatus=phyStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, receiveDataRate=receiveDataRate, masterSlaveMode=masterSlaveMode, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, transmitDataRate=transmitDataRate, dfsTableEntry=dfsTableEntry, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dfsTableNumber=dfsTableNumber, productVariant=productVariant, licence=licence, ethernetFiberSupport=ethernetFiberSupport, bandwidthVariant=bandwidthVariant, tFTPServerPortNumber=tFTPServerPortNumber, incompatibleRegionCodes=incompatibleRegionCodes, encryptionAlgorithm=encryptionAlgorithm, linkLoss=linkLoss, sNTPSyncTrap=sNTPSyncTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, receiveFreqKHz=receiveFreqKHz, syslogClientTrap=syslogClientTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, userEnabled=userEnabled, transmitFreqMHz=transmitFreqMHz, telecomsInterface=telecomsInterface, sNTPPollInterval=sNTPPollInterval, eIRP=eIRP, telnetPortNumber=telnetPortNumber, smtp=smtp, encryptionGroup=encryptionGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, range=range, phyStatusGroup=phyStatusGroup, byteErrorRatio=byteErrorRatio, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernet=ethernet, aAAControlGroup=aAAControlGroup, syslogControl=syslogControl, sMTPServerIPAddress=sMTPServerIPAddress, dfsTableIndex=dfsTableIndex, telecomsLoopback=telecomsLoopback, userTableNumber=userTableNumber, sNTPSync=sNTPSync, channelChangeTrap=channelChangeTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, resetGroup=resetGroup, supplementary=supplementary, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, systemReset=systemReset, receiveFreqMHz=receiveFreqMHz, ptp=ptp, dfsPeaks=dfsPeaks, aggregateDataRate=aggregateDataRate, vLANPriorityTableEntry=vLANPriorityTableEntry)
