...
# Produced by pysmi-1.1.3 at Sun Nov 28 16:32:56 2021
...
ModuleIdentity, IpAddress, ObjectIdentity, Bits, Counter64, Integer32, MibIdentifier, NotificationType, enterprises, iso, Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "IpAddress", "ObjectIdentity", "Bits", "Counter64", "Integer32", "MibIdentifier", "NotificationType", "enterprises", "iso", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", telecomsLineCode=telecomsLineCode, tDDSynchronizationMode=tDDSynchronizationMode, alarmsGroup=alarmsGroup, sNMPTrapVersion=sNMPTrapVersion, ptpTrapPrefix=ptpTrapPrefix, configurationGroup=configurationGroup, dfsMeans=dfsMeans, aAAControlGroup=aAAControlGroup, maximumTransmitPower=maximumTransmitPower, linkName=linkName, sMTPEmailAlert=sMTPEmailAlert, sntpGroup=sntpGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, supplementaryGroup=supplementaryGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsTableNumber=dfsTableNumber, versionsGroup=versionsGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, capacityLicenseMismatch=capacityLicenseMismatch, sNTPServerIPAddress=sNTPServerIPAddress, transmitDataRate=transmitDataRate, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, snmpControl=snmpControl, transmitChannel=transmitChannel, productName=productName, enabledDiagnosticAlarms=enabledDiagnosticAlarms, hardwareVersion=hardwareVersion, bootVersion=bootVersion, hTTPPortNumber=hTTPPortNumber, telecomGroup=telecomGroup, resetGroup=resetGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, telecomsChannelStatus=telecomsChannelStatus, bandwidthVariant=bandwidthVariant, hTTPSPortNumber=hTTPSPortNumber, installStatusTrap=installStatusTrap, ethernetFiberSupport=ethernetFiberSupport, hTTPSAccessEnabled=hTTPSAccessEnabled, searchState=searchState, sMTPEnabledMessages=sMTPEnabledMessages, masterSlaveMode=masterSlaveMode, phyControl=phyControl, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, syslogState=syslogState, transmitFreqKHz=transmitFreqKHz, vLANManagementVID=vLANManagementVID, sNMPEnabledTraps=sNMPEnabledTraps, sNTPSyncTrap=sNTPSyncTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPState=sNTPState, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, management=management, ptpGroups=ptpGroups, dfsGroup=dfsGroup, vLANManagementPriority=vLANManagementPriority, ptmp=ptmp, telecomsCableLength=telecomsCableLength, tDDControlGroup=tDDControlGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, softwareVersion=softwareVersion, dfsPeaks=dfsPeaks, telecomsInterface=telecomsInterface, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, PYSNMP_MODULE_ID=cambium, secondarySoftwareVersion=secondarySoftwareVersion, daylightSaving=daylightSaving, channelBandwidth=channelBandwidth, wirelessLinkStatus=wirelessLinkStatus, managementGroup=managementGroup, telecomsChannelStatusTrap=telecomsChannelStatusTrap, range=range, syslogControl=syslogControl, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, linkModeOptimisation=linkModeOptimisation, userPassword=userPassword, sntp=sntp, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, encryption=encryption, iPAddress=iPAddress, tFTPServerPortNumber=tFTPServerPortNumber, alarms=alarms, userTableIndex=userTableIndex, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, linkSymmetry=linkSymmetry, sNTPServerPortNumber=sNTPServerPortNumber, telecom=telecom, antennaGain=antennaGain, ptpTraps=ptpTraps, transmitModulationMode=transmitModulationMode, subnetMask=subnetMask, userRole=userRole, userEnabled=userEnabled, smtpGroup=smtpGroup, linkLoss=linkLoss, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPSync=sNTPSync, ptp500=ptp500, telnetAccessEnabled=telnetAccessEnabled, timeZone=timeZone, ptp=ptp, sNTPPollInterval=sNTPPollInterval, syslogClientTrap=syslogClientTrap, transmitPower=transmitPower, remoteIPAddress=remoteIPAddress, sMTPServerPortNumber=sMTPServerPortNumber, sNTPLastSync=sNTPLastSync, configuration=configuration, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, pubStatsGroup=pubStatsGroup, longitude=longitude, licence=licence, licensedCapacity=licensedCapacity, syslogControlGroup=syslogControlGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, siteName=siteName, groupID=groupID, telnetPortNumber=telnetPortNumber, snmpControlGroup=snmpControlGroup, dfsTableEntry=dfsTableEntry, receiveFreqKHz=receiveFreqKHz, sNMPTrapIPAddress=sNMPTrapIPAddress, receiveModulationMode=receiveModulationMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, unitOutOfCalibration=unitOutOfCalibration, phyStatusGroup=phyStatusGroup, tDDControl=tDDControl, sNMPTrapTableIndex=sNMPTrapTableIndex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPPortNumber=sNMPPortNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, vLANPriorityTableIndex=vLANPriorityTableIndex, vectorError=vectorError, sNMPv3Enable=sNMPv3Enable, incompatibleRegionCodes=incompatibleRegionCodes, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPTrapTable=sNMPTrapTable, remoteMaximumTransmitPower=remoteMaximumTransmitPower, receiveChannel=receiveChannel, aAAControl=aAAControl, sNMPCommunityString=sNMPCommunityString, sNMPTrapTableNumber=sNMPTrapTableNumber, receiveModulationModeDetail=receiveModulationModeDetail, dfs=dfs, reset=reset, supplementary=supplementary, userTable=userTable, installArmState=installArmState, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sMTPServerIPAddress=sMTPServerIPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, vLANPriorityTableEntry=vLANPriorityTableEntry, aggregateDataRate=aggregateDataRate, receiveDataRate=receiveDataRate, userTableNumber=userTableNumber, dataPortDisabledWarning=dataPortDisabledWarning, ethernetGroup=ethernetGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, pubStats=pubStats, installStatus=installStatus, dataPortStatus=dataPortStatus, notificationsGroup=notificationsGroup, installArmStateTrap=installArmStateTrap, telecomsLoopback=telecomsLoopback, receivePower=receivePower, dataPortWirelessDownAlert=dataPortWirelessDownAlert, cableLoss=cableLoss, productVariant=productVariant, ptpCompliance=ptpCompliance, dataPortStatusTrap=dataPortStatusTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, cambium=cambium, transmitFreqMHz=transmitFreqMHz, altitude=altitude, dataPortAutoMdix=dataPortAutoMdix, systemClock=systemClock, byteErrorRatio=byteErrorRatio, phyStatus=phyStatus, hTTPAccessEnabled=hTTPAccessEnabled, receiveFreqMHz=receiveFreqMHz, vLANPriorityTable=vLANPriorityTable, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsTableIndex=dfsTableIndex, phyControlGroup=phyControlGroup, wirelessLinkAvailability=wirelessLinkAvailability, accessMethod=accessMethod, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, syslogClient=syslogClient, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, smtp=smtp, ethernet=ethernet, gatewayIPAddress=gatewayIPAddress, userName=userName, licenceGroup=licenceGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, eIRP=eIRP, channelChangeTrap=channelChangeTrap, systemReset=systemReset, regionCodeTrap=regionCodeTrap, latitude=latitude, telecomsLoopbackTrap=telecomsLoopbackTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, userTableEntry=userTableEntry, signalStrengthRatio=signalStrengthRatio, syslogStateTrap=syslogStateTrap, versions=versions, dfsTable=dfsTable, frequencyVariant=frequencyVariant, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tDDSynchronizationStatus=tDDSynchronizationStatus, encryptionAlgorithm=encryptionAlgorithm, encryptionGroup=encryptionGroup, regionCode=regionCode, tFTPServerIPAddress=tFTPServerIPAddress, targetMACAddress=targetMACAddress)
