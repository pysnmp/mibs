...
# Produced by pysmi-1.1.8 at Tue Jan 11 21:10:50 2022
...
Counter32, MibIdentifier, enterprises, Bits, TimeTicks, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, ModuleIdentity, Gauge32, NotificationType, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "enterprises", "Bits", "TimeTicks", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "ModuleIdentity", "Gauge32", "NotificationType", "iso", "Integer32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", encryption=encryption, remoteIPAddress=remoteIPAddress, hTTPPortNumber=hTTPPortNumber, userTableEntry=userTableEntry, phyStatus=phyStatus, cambium=cambium, sNMPTrapTableNumber=sNMPTrapTableNumber, syslogClient=syslogClient, userTable=userTable, telecomsCableLength=telecomsCableLength, incompatibleMasterAndSlave=incompatibleMasterAndSlave, targetMACAddress=targetMACAddress, ethernetFiberSupport=ethernetFiberSupport, receiveChannel=receiveChannel, aAAControl=aAAControl, PYSNMP_MODULE_ID=cambium, telecomsChannelStatus=telecomsChannelStatus, antennaGain=antennaGain, dataPortAutoMdix=dataPortAutoMdix, transmitFreqKHz=transmitFreqKHz, bandwidthVariant=bandwidthVariant, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ethernetGroup=ethernetGroup, telnetAccessEnabled=telnetAccessEnabled, signalStrengthRatio=signalStrengthRatio, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sMTPEnabledMessages=sMTPEnabledMessages, tDDSynchronizationMode=tDDSynchronizationMode, vLANPriorityTable=vLANPriorityTable, supplementary=supplementary, userRole=userRole, alarms=alarms, userEnabled=userEnabled, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, byteErrorRatio=byteErrorRatio, siteName=siteName, phyStatusGroup=phyStatusGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sMTPServerPortNumber=sMTPServerPortNumber, reset=reset, telecomsInterface=telecomsInterface, remoteMaximumTransmitPower=remoteMaximumTransmitPower, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, dfsTable=dfsTable, masterSlaveMode=masterSlaveMode, aggregateDataRate=aggregateDataRate, installStatusTrap=installStatusTrap, ptp=ptp, dataPortStatus=dataPortStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, range=range, tFTPServerPortNumber=tFTPServerPortNumber, sntp=sntp, telecomsChannelStatusTrap=telecomsChannelStatusTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapIPAddress=sNMPTrapIPAddress, snmpControl=snmpControl, cableLoss=cableLoss, notificationsGroup=notificationsGroup, hTTPAccessEnabled=hTTPAccessEnabled, altitude=altitude, telecomsLoopbackTrap=telecomsLoopbackTrap, dataPortStatusTrap=dataPortStatusTrap, telecomGroup=telecomGroup, linkLoss=linkLoss, sNMPv3Enable=sNMPv3Enable, transmitFreqMHz=transmitFreqMHz, tDDControlGroup=tDDControlGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, transmitDataRate=transmitDataRate, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ptpTraps=ptpTraps, subnetMask=subnetMask, snmpControlGroup=snmpControlGroup, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, tDDControl=tDDControl, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortAutoNegotiation=dataPortAutoNegotiation, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ptpCompliance=ptpCompliance, sNMPTrapTable=sNMPTrapTable, sMTPEmailAlert=sMTPEmailAlert, unitOutOfCalibration=unitOutOfCalibration, encryptionAlgorithm=encryptionAlgorithm, userName=userName, maximumTransmitPower=maximumTransmitPower, userPassword=userPassword, installArmState=installArmState, receiveModulationMode=receiveModulationMode, ptmp=ptmp, dataPortWirelessDownAlert=dataPortWirelessDownAlert, regionCode=regionCode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, encryptionGroup=encryptionGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, configurationGroup=configurationGroup, productVariant=productVariant, hTTPSPortNumber=hTTPSPortNumber, syslogControlGroup=syslogControlGroup, sNTPLastSync=sNTPLastSync, management=management, smtpGroup=smtpGroup, dfsTableEntry=dfsTableEntry, linkModeOptimizationMismatch=linkModeOptimizationMismatch, hTTPSAccessEnabled=hTTPSAccessEnabled, vectorError=vectorError, phyControl=phyControl, channelChangeTrap=channelChangeTrap, sNMPPortNumber=sNMPPortNumber, ptp500=ptp500, latitude=latitude, wirelessLinkStatus=wirelessLinkStatus, channelBandwidth=channelBandwidth, systemClock=systemClock, longitude=longitude, syslogControl=syslogControl, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, incompatibleRegionCodes=incompatibleRegionCodes, sMTPServerIPAddress=sMTPServerIPAddress, licence=licence, telecomsLoopback=telecomsLoopback, managementGroup=managementGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapPortNumber=sNMPTrapPortNumber, dfsMeans=dfsMeans, receiveFreqKHz=receiveFreqKHz, licenceGroup=licenceGroup, sntpGroup=sntpGroup, dfsTableNumber=dfsTableNumber, telnetPortNumber=telnetPortNumber, telecom=telecom, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, sNMPTrapVersion=sNMPTrapVersion, useVLANForManagementInterfaces=useVLANForManagementInterfaces, vLANManagementPriority=vLANManagementPriority, alarmsGroup=alarmsGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, telecomsLineCode=telecomsLineCode, vLANPriorityTableNumber=vLANPriorityTableNumber, pubStats=pubStats, iPAddress=iPAddress, groupID=groupID, capacityLicenseMismatch=capacityLicenseMismatch, sNTPSync=sNTPSync, ethernet=ethernet, timeZone=timeZone, versions=versions, licensedCapacity=licensedCapacity, userTableIndex=userTableIndex, accessMethod=accessMethod, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ptpGroups=ptpGroups, receiveDataRate=receiveDataRate, syslogState=syslogState, dfs=dfs, linkSymmetry=linkSymmetry, installArmStateTrap=installArmStateTrap, transmitModulationMode=transmitModulationMode, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, systemReset=systemReset, phyControlGroup=phyControlGroup, sNTPPollInterval=sNTPPollInterval, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPServerIPAddress=sNTPServerIPAddress, aAAControlGroup=aAAControlGroup, smtp=smtp, pubStatsGroup=pubStatsGroup, linkName=linkName, constantPowerSpectralDensity=constantPowerSpectralDensity, sNTPState=sNTPState, installStatus=installStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPEnabledTraps=sNMPEnabledTraps, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ptpTrapPrefix=ptpTrapPrefix, searchState=searchState, syslogStateTrap=syslogStateTrap, receivePower=receivePower, sNMPCommunityString=sNMPCommunityString, wirelessLinkAvailability=wirelessLinkAvailability, sNMPTrapTableIndex=sNMPTrapTableIndex, vLANManagementVID=vLANManagementVID, supplementaryGroup=supplementaryGroup, daylightSaving=daylightSaving, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfsGroup=dfsGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, receiveFreqMHz=receiveFreqMHz, regionCodeTrap=regionCodeTrap, transmitPower=transmitPower, userTableNumber=userTableNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, receiveModulationModeDetail=receiveModulationModeDetail, gatewayIPAddress=gatewayIPAddress, dfsPeaks=dfsPeaks, tFTPServerIPAddress=tFTPServerIPAddress, productName=productName, syslogClientTrap=syslogClientTrap, vLANPriorityQueueMapping=vLANPriorityQueueMapping, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNTPSyncTrap=sNTPSyncTrap, transmitChannel=transmitChannel, bootVersion=bootVersion, sNTPServerPortNumber=sNTPServerPortNumber, configuration=configuration, eIRP=eIRP, hardwareVersion=hardwareVersion, linkModeOptimisation=linkModeOptimisation, resetGroup=resetGroup, versionsGroup=versionsGroup, softwareVersion=softwareVersion, frequencyVariant=frequencyVariant, secondarySoftwareVersion=secondarySoftwareVersion, dfsTableIndex=dfsTableIndex, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortDisabledWarning=dataPortDisabledWarning)
