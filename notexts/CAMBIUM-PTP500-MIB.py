...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", vLANPriorityTableEntry=vLANPriorityTableEntry, sNTPLastSync=sNTPLastSync, userTableIndex=userTableIndex, telnetAccessEnabled=telnetAccessEnabled, ethernetFiberSupport=ethernetFiberSupport, telecomGroup=telecomGroup, snmpControlGroup=snmpControlGroup, sNMPv3Enable=sNMPv3Enable, installStatus=installStatus, licenceGroup=licenceGroup, management=management, aAAControlGroup=aAAControlGroup, telecomsInterface=telecomsInterface, sNMPTrapIPAddress=sNMPTrapIPAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, linkModeOptimisation=linkModeOptimisation, telecomsChannelStatusTrap=telecomsChannelStatusTrap, tFTPServerPortNumber=tFTPServerPortNumber, userTableEntry=userTableEntry, sNMPCommunityString=sNMPCommunityString, sNTPServerIPAddress=sNTPServerIPAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sMTPServerIPAddress=sMTPServerIPAddress, telecomsChannelStatus=telecomsChannelStatus, antennaGain=antennaGain, subnetMask=subnetMask, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, telecom=telecom, systemReset=systemReset, frequencyVariant=frequencyVariant, pubStatsGroup=pubStatsGroup, linkName=linkName, telnetPortNumber=telnetPortNumber, ptpTrapPrefix=ptpTrapPrefix, ptp=ptp, vLANPriorityQueueMapping=vLANPriorityQueueMapping, systemClock=systemClock, aggregateDataRate=aggregateDataRate, syslogStateTrap=syslogStateTrap, softwareVersion=softwareVersion, siteName=siteName, productVariant=productVariant, receivePower=receivePower, userTableNumber=userTableNumber, tDDSynchronizationMode=tDDSynchronizationMode, hTTPSPortNumber=hTTPSPortNumber, daylightSaving=daylightSaving, ptp500=ptp500, receiveModulationModeDetail=receiveModulationModeDetail, tDDControlGroup=tDDControlGroup, ptpTraps=ptpTraps, vLANManagementVID=vLANManagementVID, alarmsGroup=alarmsGroup, supplementary=supplementary, hTTPAccessEnabled=hTTPAccessEnabled, hardwareVersion=hardwareVersion, regionCodeTrap=regionCodeTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, installArmStateTrap=installArmStateTrap, receiveFreqMHz=receiveFreqMHz, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortDisabledWarning=dataPortDisabledWarning, sNTPServerPortNumber=sNTPServerPortNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfsTableNumber=dfsTableNumber, vLANPriorityTableNumber=vLANPriorityTableNumber, groupID=groupID, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, resetGroup=resetGroup, licensedCapacity=licensedCapacity, sNMPTrapTableEntry=sNMPTrapTableEntry, cableLoss=cableLoss, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, channelBandwidth=channelBandwidth, sNMPTrapTable=sNMPTrapTable, altitude=altitude, incompatibleRegionCodes=incompatibleRegionCodes, wirelessLinkStatus=wirelessLinkStatus, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPState=sNTPState, pubStats=pubStats, bootVersion=bootVersion, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, linkSymmetry=linkSymmetry, searchState=searchState, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, secondarySoftwareVersion=secondarySoftwareVersion, byteErrorRatio=byteErrorRatio, supplementaryGroup=supplementaryGroup, managementGroup=managementGroup, aAAControl=aAAControl, iPAddress=iPAddress, dataPortStatus=dataPortStatus, ptpGroups=ptpGroups, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, encryptionGroup=encryptionGroup, telecomsLineCode=telecomsLineCode, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNTPPollInterval=sNTPPollInterval, installArmState=installArmState, tDDSynchronizationAlarm=tDDSynchronizationAlarm, snmpControl=snmpControl, sMTPEnabledMessages=sMTPEnabledMessages, phyStatusGroup=phyStatusGroup, timeZone=timeZone, hTTPSAccessEnabled=hTTPSAccessEnabled, latitude=latitude, sNTPSync=sNTPSync, encryption=encryption, tDDControl=tDDControl, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, channelChangeTrap=channelChangeTrap, transmitModulationMode=transmitModulationMode, capacityLicenseMismatch=capacityLicenseMismatch, versionsGroup=versionsGroup, configurationGroup=configurationGroup, dataPortStatusTrap=dataPortStatusTrap, userEnabled=userEnabled, syslogControlGroup=syslogControlGroup, longitude=longitude, transmitFreqMHz=transmitFreqMHz, reset=reset, syslogClientTrap=syslogClientTrap, unitOutOfCalibration=unitOutOfCalibration, sNMPEnabledTraps=sNMPEnabledTraps, sNTPSyncTrap=sNTPSyncTrap, vLANPriorityTable=vLANPriorityTable, receiveFreqKHz=receiveFreqKHz, transmitChannel=transmitChannel, sNMPTrapTableIndex=sNMPTrapTableIndex, remoteIPAddress=remoteIPAddress, wirelessLinkAvailability=wirelessLinkAvailability, dfsMeans=dfsMeans, syslogControl=syslogControl, receiveDataRate=receiveDataRate, syslogState=syslogState, userTable=userTable, linkLoss=linkLoss, sntpGroup=sntpGroup, accessMethod=accessMethod, telecomsLoopback=telecomsLoopback, configuration=configuration, dfsTableIndex=dfsTableIndex, noWirelessChannelAvailable=noWirelessChannelAvailable, vectorError=vectorError, bandwidthVariant=bandwidthVariant, range=range, smtp=smtp, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sMTPServerPortNumber=sMTPServerPortNumber, telecomsCableLength=telecomsCableLength, vLANManagementPriority=vLANManagementPriority, hTTPPortNumber=hTTPPortNumber, smtpGroup=smtpGroup, dataPortAutoMdix=dataPortAutoMdix, sNMPTrapPortNumber=sNMPTrapPortNumber, targetMACAddress=targetMACAddress, dfs=dfs, maximumTransmitPower=maximumTransmitPower, sNMPTrapTableNumber=sNMPTrapTableNumber, userName=userName, receiveModulationMode=receiveModulationMode, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sntp=sntp, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ptmp=ptmp, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dfsGroup=dfsGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, transmitPower=transmitPower, ethernet=ethernet, phyStatus=phyStatus, dfsPeaks=dfsPeaks, versions=versions, tFTPServerIPAddress=tFTPServerIPAddress, sNMPPortNumber=sNMPPortNumber, productName=productName, enabledDiagnosticAlarms=enabledDiagnosticAlarms, encryptionAlgorithm=encryptionAlgorithm, notificationsGroup=notificationsGroup, userPassword=userPassword, sMTPEmailAlert=sMTPEmailAlert, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dfsTable=dfsTable, cambium=cambium, constantPowerSpectralDensity=constantPowerSpectralDensity, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, signalStrengthRatio=signalStrengthRatio, userRole=userRole, receiveChannel=receiveChannel, regionCode=regionCode, PYSNMP_MODULE_ID=cambium, ptpCompliance=ptpCompliance, alarms=alarms, phyControlGroup=phyControlGroup, eIRP=eIRP, ethernetGroup=ethernetGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, tDDSynchronizationStatus=tDDSynchronizationStatus, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, transmitFreqKHz=transmitFreqKHz, installStatusTrap=installStatusTrap, licence=licence, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, transmitDataRate=transmitDataRate, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, syslogClient=syslogClient, dfsTableEntry=dfsTableEntry, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapVersion=sNMPTrapVersion, masterSlaveMode=masterSlaveMode, phyControl=phyControl, gatewayIPAddress=gatewayIPAddress)
