...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", iPAddress=iPAddress, dfsMeans=dfsMeans, installStatus=installStatus, receiveModulationModeDetail=receiveModulationModeDetail, sntp=sntp, dataPortAutoMdix=dataPortAutoMdix, encryptionGroup=encryptionGroup, supplementary=supplementary, dataPortStatusTrap=dataPortStatusTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, vLANManagementVID=vLANManagementVID, sNTPPollInterval=sNTPPollInterval, ptp=ptp, ethernet=ethernet, smtp=smtp, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, aAAControl=aAAControl, ptpGroups=ptpGroups, dfsTable=dfsTable, transmitFreqKHz=transmitFreqKHz, dataPortDisabledWarning=dataPortDisabledWarning, reset=reset, vLANPriorityQueueMapping=vLANPriorityQueueMapping, phyControl=phyControl, capacityLicenseMismatch=capacityLicenseMismatch, encryptionAlgorithm=encryptionAlgorithm, linkName=linkName, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, installArmStateTrap=installArmStateTrap, telecomsChannelStatus=telecomsChannelStatus, linkModeOptimisation=linkModeOptimisation, linkLoss=linkLoss, unitOutOfCalibration=unitOutOfCalibration, cableLoss=cableLoss, receiveDataRate=receiveDataRate, configuration=configuration, notificationsGroup=notificationsGroup, ethernetFiberSupport=ethernetFiberSupport, regionCodeTrap=regionCodeTrap, productName=productName, ptpTraps=ptpTraps, telecomsCableLength=telecomsCableLength, telecomGroup=telecomGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, transmitFreqMHz=transmitFreqMHz, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, receiveFreqMHz=receiveFreqMHz, management=management, sNMPTrapTable=sNMPTrapTable, productVariant=productVariant, signalStrengthRatio=signalStrengthRatio, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPPortNumber=sNMPPortNumber, ptmp=ptmp, tDDControlGroup=tDDControlGroup, masterSlaveMode=masterSlaveMode, licence=licence, smtpGroup=smtpGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, syslogControl=syslogControl, syslogState=syslogState, syslogControlGroup=syslogControlGroup, snmpControlGroup=snmpControlGroup, resetGroup=resetGroup, installStatusTrap=installStatusTrap, userTableIndex=userTableIndex, phyControlGroup=phyControlGroup, dfsTableIndex=dfsTableIndex, accessMethod=accessMethod, linkSymmetry=linkSymmetry, sNMPv3Enable=sNMPv3Enable, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tFTPServerIPAddress=tFTPServerIPAddress, userEnabled=userEnabled, softwareVersion=softwareVersion, sNTPServerIPAddress=sNTPServerIPAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, telecomsLineCode=telecomsLineCode, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, supplementaryGroup=supplementaryGroup, dfsTableEntry=dfsTableEntry, sNTPState=sNTPState, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sMTPServerPortNumber=sMTPServerPortNumber, userRole=userRole, userPassword=userPassword, sNMPTrapVersion=sNMPTrapVersion, sntpGroup=sntpGroup, snmpControl=snmpControl, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, systemClock=systemClock, aggregateDataRate=aggregateDataRate, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, timeZone=timeZone, aAAControlGroup=aAAControlGroup, sNTPServerPortNumber=sNTPServerPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, telecomsLoopbackTrap=telecomsLoopbackTrap, secondarySoftwareVersion=secondarySoftwareVersion, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, installArmState=installArmState, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dataPortConfigurationMismatch=dataPortConfigurationMismatch, bootVersion=bootVersion, licenceGroup=licenceGroup, sMTPServerIPAddress=sMTPServerIPAddress, receiveFreqKHz=receiveFreqKHz, PYSNMP_MODULE_ID=cambium, remoteIPAddress=remoteIPAddress, vLANPriorityTableNumber=vLANPriorityTableNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, telecomsLoopback=telecomsLoopback, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, daylightSaving=daylightSaving, longitude=longitude, syslogClientTrap=syslogClientTrap, encryption=encryption, phyStatus=phyStatus, transmitChannel=transmitChannel, linkModeOptimizationMismatch=linkModeOptimizationMismatch, userName=userName, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ethernetGroup=ethernetGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dfsPeaks=dfsPeaks, antennaGain=antennaGain, versions=versions, transmitPower=transmitPower, sMTPEnabledMessages=sMTPEnabledMessages, sNTPSync=sNTPSync, transmitDataRate=transmitDataRate, hTTPPortNumber=hTTPPortNumber, ptp500=ptp500, hTTPAccessEnabled=hTTPAccessEnabled, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, pubStats=pubStats, eIRP=eIRP, sNMPCommunityString=sNMPCommunityString, dfsGroup=dfsGroup, telecom=telecom, byteErrorRatio=byteErrorRatio, vectorError=vectorError, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPEmailAlert=sMTPEmailAlert, wirelessLinkAvailability=wirelessLinkAvailability, constantPowerSpectralDensity=constantPowerSpectralDensity, userTableEntry=userTableEntry, searchState=searchState, sNTPLastSync=sNTPLastSync, channelChangeTrap=channelChangeTrap, siteName=siteName, syslogLocalWrappedTrap=syslogLocalWrappedTrap, phyStatusGroup=phyStatusGroup, telecomsChannelStatusTrap=telecomsChannelStatusTrap, licensedCapacity=licensedCapacity, vLANPriorityTable=vLANPriorityTable, sNTPSyncTrap=sNTPSyncTrap, wirelessLinkStatus=wirelessLinkStatus, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, systemReset=systemReset, tDDControl=tDDControl, channelBandwidth=channelBandwidth, versionsGroup=versionsGroup, managementGroup=managementGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPEnabledTraps=sNMPEnabledTraps, dataPortStatus=dataPortStatus, altitude=altitude, dfs=dfs, useVLANForManagementInterfaces=useVLANForManagementInterfaces, groupID=groupID, vLANPriorityTableIndex=vLANPriorityTableIndex, hTTPSPortNumber=hTTPSPortNumber, receiveChannel=receiveChannel, userTable=userTable, transmitModulationMode=transmitModulationMode, targetMACAddress=targetMACAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ptpTrapPrefix=ptpTrapPrefix, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, telnetPortNumber=telnetPortNumber, bandwidthVariant=bandwidthVariant, alarmsGroup=alarmsGroup, userTableNumber=userTableNumber, receivePower=receivePower, subnetMask=subnetMask, range=range, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, gatewayIPAddress=gatewayIPAddress, telnetAccessEnabled=telnetAccessEnabled, hardwareVersion=hardwareVersion, regionCode=regionCode, vLANManagementPriority=vLANManagementPriority, tDDSynchronizationAlarm=tDDSynchronizationAlarm, syslogStateTrap=syslogStateTrap, incompatibleRegionCodes=incompatibleRegionCodes, tFTPServerPortNumber=tFTPServerPortNumber, alarms=alarms, receiveModulationMode=receiveModulationMode, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, configurationGroup=configurationGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dfsTableNumber=dfsTableNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, maximumTransmitPower=maximumTransmitPower, incompatibleMasterAndSlave=incompatibleMasterAndSlave, frequencyVariant=frequencyVariant, tDDSynchronizationMode=tDDSynchronizationMode, latitude=latitude, sNMPTrapTableEntry=sNMPTrapTableEntry, cambium=cambium, telecomsInterface=telecomsInterface, pubStatsGroup=pubStatsGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ptpCompliance=ptpCompliance, syslogClient=syslogClient)
