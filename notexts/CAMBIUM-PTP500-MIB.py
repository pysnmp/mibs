...
# Produced by pysmi-1.1.3 at Wed Dec  8 21:23:47 2021
...
Counter32, enterprises, ModuleIdentity, Unsigned32, ObjectIdentity, iso, NotificationType, MibIdentifier, Integer32, Bits, Counter64, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "enterprises", "ModuleIdentity", "Unsigned32", "ObjectIdentity", "iso", "NotificationType", "MibIdentifier", "Integer32", "Bits", "Counter64", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", ptpGroups=ptpGroups, vectorError=vectorError, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, unitOutOfCalibration=unitOutOfCalibration, searchState=searchState, capacityLicenseMismatch=capacityLicenseMismatch, sNMPCommunityString=sNMPCommunityString, receiveDataRate=receiveDataRate, smtp=smtp, supplementaryGroup=supplementaryGroup, linkName=linkName, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, vLANPriorityQueueMapping=vLANPriorityQueueMapping, aggregateDataRate=aggregateDataRate, telecomsLoopback=telecomsLoopback, secondarySoftwareVersion=secondarySoftwareVersion, encryption=encryption, alarmsGroup=alarmsGroup, transmitFreqMHz=transmitFreqMHz, systemClock=systemClock, installArmStateTrap=installArmStateTrap, sNTPLastSync=sNTPLastSync, notificationsGroup=notificationsGroup, sNMPTrapTable=sNMPTrapTable, sNMPEnabledTraps=sNMPEnabledTraps, installStatusTrap=installStatusTrap, telecomsChannelStatus=telecomsChannelStatus, licence=licence, receiveModulationMode=receiveModulationMode, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ptpTraps=ptpTraps, constantPowerSpectralDensity=constantPowerSpectralDensity, userTable=userTable, userTableIndex=userTableIndex, siteName=siteName, management=management, phyControl=phyControl, syslogClient=syslogClient, regionCode=regionCode, transmitModulationMode=transmitModulationMode, sMTPServerIPAddress=sMTPServerIPAddress, sNTPServerIPAddress=sNTPServerIPAddress, userTableNumber=userTableNumber, dataPortConfigurationMismatch=dataPortConfigurationMismatch, alarms=alarms, ptpCompliance=ptpCompliance, phyStatus=phyStatus, licenceGroup=licenceGroup, dfsPeaks=dfsPeaks, vLANPriorityTableIndex=vLANPriorityTableIndex, telecomsInterface=telecomsInterface, receiveFreqMHz=receiveFreqMHz, configurationGroup=configurationGroup, telecom=telecom, dfsTableEntry=dfsTableEntry, ptp=ptp, smtpGroup=smtpGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, maximumTransmitPower=maximumTransmitPower, aAAControlGroup=aAAControlGroup, linkSymmetry=linkSymmetry, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, longitude=longitude, linkLoss=linkLoss, sNMPv3Enable=sNMPv3Enable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tDDControl=tDDControl, phyStatusGroup=phyStatusGroup, pubStatsGroup=pubStatsGroup, syslogClientTrap=syslogClientTrap, dataPortDisabledWarning=dataPortDisabledWarning, useVLANForManagementInterfaces=useVLANForManagementInterfaces, snmpControl=snmpControl, dfsTableIndex=dfsTableIndex, remoteIPAddress=remoteIPAddress, incompatibleRegionCodes=incompatibleRegionCodes, managementGroup=managementGroup, telecomsCableLength=telecomsCableLength, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sMTPServerPortNumber=sMTPServerPortNumber, systemReset=systemReset, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, userEnabled=userEnabled, snmpControlGroup=snmpControlGroup, aAAControl=aAAControl, sNTPSyncTrap=sNTPSyncTrap, latitude=latitude, receiveModulationModeDetail=receiveModulationModeDetail, dfsMeans=dfsMeans, subnetMask=subnetMask, transmitChannel=transmitChannel, ptpTrapPrefix=ptpTrapPrefix, tDDControlGroup=tDDControlGroup, dfsTableNumber=dfsTableNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ethernetGroup=ethernetGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, userTableEntry=userTableEntry, productVariant=productVariant, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNTPServerPortNumber=sNTPServerPortNumber, tDDSynchronizationMode=tDDSynchronizationMode, syslogState=syslogState, bootVersion=bootVersion, phyControlGroup=phyControlGroup, dataPortStatusTrap=dataPortStatusTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, hardwareVersion=hardwareVersion, vLANManagementPriority=vLANManagementPriority, eIRP=eIRP, dfs=dfs, channelBandwidth=channelBandwidth, dataPortStatus=dataPortStatus, telecomsLoopbackTrap=telecomsLoopbackTrap, supplementary=supplementary, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, transmitPower=transmitPower, sNMPTrapTableIndex=sNMPTrapTableIndex, licensedCapacity=licensedCapacity, accessMethod=accessMethod, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, softwareVersion=softwareVersion, hTTPSAccessEnabled=hTTPSAccessEnabled, PYSNMP_MODULE_ID=cambium, userName=userName, groupID=groupID, userRole=userRole, linkModeOptimisation=linkModeOptimisation, syslogStateTrap=syslogStateTrap, telecomGroup=telecomGroup, ethernet=ethernet, receiveFreqKHz=receiveFreqKHz, hTTPAccessEnabled=hTTPAccessEnabled, vLANPriorityTableEntry=vLANPriorityTableEntry, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, altitude=altitude, channelChangeTrap=channelChangeTrap, userPassword=userPassword, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, receivePower=receivePower, sMTPEmailAlert=sMTPEmailAlert, transmitFreqKHz=transmitFreqKHz, pubStats=pubStats, sNTPSync=sNTPSync, byteErrorRatio=byteErrorRatio, dataPortAutoMdix=dataPortAutoMdix, signalStrengthRatio=signalStrengthRatio, encryptionAlgorithm=encryptionAlgorithm, telecomsChannelStatusTrap=telecomsChannelStatusTrap, ptmp=ptmp, syslogLocalWrappedTrap=syslogLocalWrappedTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, antennaGain=antennaGain, encryptionGroup=encryptionGroup, transmitDataRate=transmitDataRate, telecomsLineCode=telecomsLineCode, targetMACAddress=targetMACAddress, wirelessLinkAvailability=wirelessLinkAvailability, vLANManagementVID=vLANManagementVID, configuration=configuration, dfsTable=dfsTable, syslogControlGroup=syslogControlGroup, vLANPriorityTable=vLANPriorityTable, tFTPServerPortNumber=tFTPServerPortNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, bandwidthVariant=bandwidthVariant, sntpGroup=sntpGroup, telnetPortNumber=telnetPortNumber, sNMPPortNumber=sNMPPortNumber, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, masterSlaveMode=masterSlaveMode, regionCodeTrap=regionCodeTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, installStatus=installStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNMPTrapTableEntry=sNMPTrapTableEntry, versions=versions, sNTPState=sNTPState, timeZone=timeZone, telnetAccessEnabled=telnetAccessEnabled, cambium=cambium, installArmState=installArmState, sntp=sntp, ethernetFiberSupport=ethernetFiberSupport, wirelessLinkStatus=wirelessLinkStatus, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, syslogControl=syslogControl, sNMPTrapTableNumber=sNMPTrapTableNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, frequencyVariant=frequencyVariant, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, range=range, sNTPPollInterval=sNTPPollInterval, gatewayIPAddress=gatewayIPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, resetGroup=resetGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dfsGroup=dfsGroup, receiveChannel=receiveChannel, hTTPSPortNumber=hTTPSPortNumber, daylightSaving=daylightSaving, versionsGroup=versionsGroup, hTTPPortNumber=hTTPPortNumber, cableLoss=cableLoss, ptp500=ptp500, reset=reset, tFTPServerIPAddress=tFTPServerIPAddress, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapIPAddress=sNMPTrapIPAddress, productName=productName, iPAddress=iPAddress)
