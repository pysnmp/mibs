...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", hardwareVersion=hardwareVersion, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, cableLoss=cableLoss, alarms=alarms, managementGroup=managementGroup, receiveChannel=receiveChannel, tDDSynchronizationMode=tDDSynchronizationMode, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, licence=licence, systemClock=systemClock, telnetPortNumber=telnetPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, dfs=dfs, iPAddress=iPAddress, sMTPEmailAlert=sMTPEmailAlert, ptpTrapPrefix=ptpTrapPrefix, dataPortStatus=dataPortStatus, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, wirelessLinkAvailability=wirelessLinkAvailability, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPEnabledTraps=sNMPEnabledTraps, tFTPServerPortNumber=tFTPServerPortNumber, phyStatus=phyStatus, sNMPPortNumber=sNMPPortNumber, phyControlGroup=phyControlGroup, linkName=linkName, userTableIndex=userTableIndex, userEnabled=userEnabled, phyStatusGroup=phyStatusGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, telecomGroup=telecomGroup, hTTPAccessEnabled=hTTPAccessEnabled, systemReset=systemReset, sNMPCommunityString=sNMPCommunityString, remoteMaximumTransmitPower=remoteMaximumTransmitPower, productName=productName, smtpGroup=smtpGroup, receiveModulationModeDetail=receiveModulationModeDetail, userName=userName, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, eIRP=eIRP, bandwidthVariant=bandwidthVariant, linkSymmetry=linkSymmetry, installArmStateTrap=installArmStateTrap, installStatusTrap=installStatusTrap, telecomsLoopback=telecomsLoopback, snmpControlGroup=snmpControlGroup, linkLoss=linkLoss, dfsMeans=dfsMeans, dfsTableIndex=dfsTableIndex, productVariant=productVariant, supplementary=supplementary, receiveFreqMHz=receiveFreqMHz, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, encryptionGroup=encryptionGroup, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, frequencyVariant=frequencyVariant, transmitModulationMode=transmitModulationMode, antennaGain=antennaGain, configurationGroup=configurationGroup, accessMethod=accessMethod, ethernetGroup=ethernetGroup, wirelessLinkStatus=wirelessLinkStatus, constantPowerSpectralDensity=constantPowerSpectralDensity, useVLANForManagementInterfaces=useVLANForManagementInterfaces, vLANManagementPriority=vLANManagementPriority, sMTPSourceEmailAddress=sMTPSourceEmailAddress, unitOutOfCalibration=unitOutOfCalibration, ptpCompliance=ptpCompliance, vLANManagementVID=vLANManagementVID, sNTPState=sNTPState, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapVersion=sNMPTrapVersion, userRole=userRole, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, telecomsCableLength=telecomsCableLength, management=management, versionsGroup=versionsGroup, licenceGroup=licenceGroup, notificationsGroup=notificationsGroup, ptpGroups=ptpGroups, signalStrengthRatio=signalStrengthRatio, sMTPServerPortNumber=sMTPServerPortNumber, receiveModulationMode=receiveModulationMode, vLANPriorityTable=vLANPriorityTable, telecomsLineCode=telecomsLineCode, dfsPeaks=dfsPeaks, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, telecom=telecom, targetMACAddress=targetMACAddress, remoteIPAddress=remoteIPAddress, receivePower=receivePower, noWirelessChannelAvailable=noWirelessChannelAvailable, range=range, aAAControl=aAAControl, hTTPSAccessEnabled=hTTPSAccessEnabled, pubStatsGroup=pubStatsGroup, timeZone=timeZone, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, searchState=searchState, telecomsChannelStatusTrap=telecomsChannelStatusTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, enabledDiagnosticAlarms=enabledDiagnosticAlarms, supplementaryGroup=supplementaryGroup, daylightSaving=daylightSaving, sNTPServerIPAddress=sNTPServerIPAddress, alarmsGroup=alarmsGroup, receiveDataRate=receiveDataRate, channelBandwidth=channelBandwidth, ethernet=ethernet, tDDSynchronizationStatus=tDDSynchronizationStatus, hTTPSPortNumber=hTTPSPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, channelChangeTrap=channelChangeTrap, dataPortStatusTrap=dataPortStatusTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortWirelessDownAlert=dataPortWirelessDownAlert, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, syslogControlGroup=syslogControlGroup, byteErrorRatio=byteErrorRatio, userTable=userTable, syslogState=syslogState, sNTPSync=sNTPSync, dfsTableNumber=dfsTableNumber, vLANPriorityQueueMapping=vLANPriorityQueueMapping, capacityLicenseMismatch=capacityLicenseMismatch, ptpTraps=ptpTraps, gatewayIPAddress=gatewayIPAddress, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, altitude=altitude, receiveFreqKHz=receiveFreqKHz, transmitChannel=transmitChannel, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsTableEntry=dfsTableEntry, installArmState=installArmState, hTTPPortNumber=hTTPPortNumber, sNTPServerPortNumber=sNTPServerPortNumber, vLANPriorityTableIndex=vLANPriorityTableIndex, telecomsChannelStatus=telecomsChannelStatus, sNMPv3Enable=sNMPv3Enable, sntpGroup=sntpGroup, vectorError=vectorError, sMTPEnabledMessages=sMTPEnabledMessages, transmitFreqKHz=transmitFreqKHz, pubStats=pubStats, encryptionAlgorithm=encryptionAlgorithm, vLANPriorityTableEntry=vLANPriorityTableEntry, licensedCapacity=licensedCapacity, resetGroup=resetGroup, aAAControlGroup=aAAControlGroup, dfsTable=dfsTable, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, cambium=cambium, sNMPTrapTableEntry=sNMPTrapTableEntry, ethernetFiberSupport=ethernetFiberSupport, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPTrapTableIndex=sNMPTrapTableIndex, telecomsInterface=telecomsInterface, ptmp=ptmp, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dfsGroup=dfsGroup, siteName=siteName, syslogControl=syslogControl, smtp=smtp, userPassword=userPassword, bootVersion=bootVersion, transmitFreqMHz=transmitFreqMHz, reset=reset, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNTPPollInterval=sNTPPollInterval, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, encryption=encryption, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, snmpControl=snmpControl, userTableEntry=userTableEntry, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, transmitPower=transmitPower, syslogClient=syslogClient, sntp=sntp, syslogStateTrap=syslogStateTrap, syslogClientTrap=syslogClientTrap, regionCodeTrap=regionCodeTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ptp500=ptp500, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tDDControl=tDDControl, sNMPTrapTable=sNMPTrapTable, dataPortAutoMdix=dataPortAutoMdix, longitude=longitude, latitude=latitude, dataPortDisabledWarning=dataPortDisabledWarning, sNTPSyncTrap=sNTPSyncTrap, transmitDataRate=transmitDataRate, tDDControlGroup=tDDControlGroup, userTableNumber=userTableNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, telecomsLoopbackTrap=telecomsLoopbackTrap, maximumTransmitPower=maximumTransmitPower, regionCode=regionCode, linkModeOptimisation=linkModeOptimisation, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, installStatus=installStatus, sNTPLastSync=sNTPLastSync, groupID=groupID, ptp=ptp, PYSNMP_MODULE_ID=cambium, incompatibleRegionCodes=incompatibleRegionCodes, aggregateDataRate=aggregateDataRate, tFTPServerIPAddress=tFTPServerIPAddress, telnetAccessEnabled=telnetAccessEnabled, phyControl=phyControl, softwareVersion=softwareVersion, configuration=configuration, masterSlaveMode=masterSlaveMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, subnetMask=subnetMask, versions=versions)
