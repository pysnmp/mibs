...
# Produced by pysmi-1.1.3 at Mon Nov 22 19:56:35 2021
...
ObjectIdentity, MibIdentifier, Bits, IpAddress, iso, Unsigned32, Gauge32, Integer32, Counter64, enterprises, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ModuleIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "Bits", "IpAddress", "iso", "Unsigned32", "Gauge32", "Integer32", "Counter64", "enterprises", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ModuleIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", pubStatsGroup=pubStatsGroup, dfsTableNumber=dfsTableNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dfs=dfs, receiveModulationModeDetail=receiveModulationModeDetail, telnetPortNumber=telnetPortNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, telecom=telecom, sNMPTrapIPAddress=sNMPTrapIPAddress, ptpCompliance=ptpCompliance, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, hardwareVersion=hardwareVersion, masterSlaveMode=masterSlaveMode, frequencyVariant=frequencyVariant, vLANPriorityQueueMapping=vLANPriorityQueueMapping, telecomsLoopbackTrap=telecomsLoopbackTrap, vLANManagementPriority=vLANManagementPriority, management=management, dfsTableIndex=dfsTableIndex, range=range, channelChangeTrap=channelChangeTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPv3Enable=sNMPv3Enable, siteName=siteName, antennaGain=antennaGain, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, linkModeOptimisation=linkModeOptimisation, encryptionGroup=encryptionGroup, phyControlGroup=phyControlGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, linkModeOptimizationMismatch=linkModeOptimizationMismatch, regionCodeTrap=regionCodeTrap, sntp=sntp, dfsGroup=dfsGroup, eIRP=eIRP, transmitChannel=transmitChannel, alarmsGroup=alarmsGroup, phyStatus=phyStatus, dfsMeans=dfsMeans, installArmStateTrap=installArmStateTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, signalStrengthRatio=signalStrengthRatio, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, supplementary=supplementary, tDDControlGroup=tDDControlGroup, receiveFreqMHz=receiveFreqMHz, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, pubStats=pubStats, syslogControlGroup=syslogControlGroup, searchState=searchState, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, systemClock=systemClock, configurationGroup=configurationGroup, ptp=ptp, wirelessLinkAvailability=wirelessLinkAvailability, sMTPEnabledMessages=sMTPEnabledMessages, syslogLocalWrappedTrap=syslogLocalWrappedTrap, softwareVersion=softwareVersion, encryptionAlgorithm=encryptionAlgorithm, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, managementGroup=managementGroup, phyControl=phyControl, bandwidthVariant=bandwidthVariant, cambium=cambium, constantPowerSpectralDensity=constantPowerSpectralDensity, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, transmitPower=transmitPower, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, smtp=smtp, dfsPeaks=dfsPeaks, maximumTransmitPower=maximumTransmitPower, userTableNumber=userTableNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, longitude=longitude, sNMPTrapTable=sNMPTrapTable, installStatus=installStatus, userEnabled=userEnabled, capacityLicenseMismatch=capacityLicenseMismatch, dataPortStatusTrap=dataPortStatusTrap, ptmp=ptmp, vLANManagementVID=vLANManagementVID, regionCode=regionCode, aAAControl=aAAControl, transmitModulationMode=transmitModulationMode, byteErrorRatio=byteErrorRatio, phyStatusGroup=phyStatusGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, installArmState=installArmState, transmitDataRate=transmitDataRate, latitude=latitude, licensedCapacity=licensedCapacity, aAAControlGroup=aAAControlGroup, sMTPEmailAlert=sMTPEmailAlert, userRole=userRole, userTableIndex=userTableIndex, secondarySoftwareVersion=secondarySoftwareVersion, linkName=linkName, sMTPServerIPAddress=sMTPServerIPAddress, dataPortDisabledWarning=dataPortDisabledWarning, linkLoss=linkLoss, sMTPServerPortNumber=sMTPServerPortNumber, telecomsLoopback=telecomsLoopback, productName=productName, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, snmpControl=snmpControl, ethernetGroup=ethernetGroup, sNTPSync=sNTPSync, snmpControlGroup=snmpControlGroup, userPassword=userPassword, configuration=configuration, aggregateDataRate=aggregateDataRate, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, smtpGroup=smtpGroup, sNTPServerPortNumber=sNTPServerPortNumber, telecomGroup=telecomGroup, systemReset=systemReset, resetGroup=resetGroup, ptp500=ptp500, linkSymmetry=linkSymmetry, receiveChannel=receiveChannel, accessMethod=accessMethod, dataPortConfigurationMismatch=dataPortConfigurationMismatch, telecomsLineCode=telecomsLineCode, wirelessLinkStatus=wirelessLinkStatus, productVariant=productVariant, licence=licence, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, installStatusTrap=installStatusTrap, versions=versions, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortAutoMdix=dataPortAutoMdix, hTTPAccessEnabled=hTTPAccessEnabled, dfsTable=dfsTable, iPAddress=iPAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, remoteMaximumTransmitPower=remoteMaximumTransmitPower, bootVersion=bootVersion, sNMPTrapVersion=sNMPTrapVersion, receiveDataRate=receiveDataRate, sNMPPortNumber=sNMPPortNumber, tFTPServerIPAddress=tFTPServerIPAddress, cableLoss=cableLoss, remoteIPAddress=remoteIPAddress, vLANPriorityTableEntry=vLANPriorityTableEntry, subnetMask=subnetMask, sNMPEnabledTraps=sNMPEnabledTraps, userTable=userTable, dataPortStatus=dataPortStatus, transmitFreqMHz=transmitFreqMHz, altitude=altitude, ptpTraps=ptpTraps, telnetAccessEnabled=telnetAccessEnabled, ethernet=ethernet, vLANPriorityTableNumber=vLANPriorityTableNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNTPLastSync=sNTPLastSync, incompatibleRegionCodes=incompatibleRegionCodes, versionsGroup=versionsGroup, targetMACAddress=targetMACAddress, telecomsCableLength=telecomsCableLength, sNTPState=sNTPState, vLANPriorityTableIndex=vLANPriorityTableIndex, receivePower=receivePower, gatewayIPAddress=gatewayIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tDDSynchronizationMode=tDDSynchronizationMode, incompatibleMasterAndSlave=incompatibleMasterAndSlave, vectorError=vectorError, sNTPSyncTrap=sNTPSyncTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, alarms=alarms, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, encryption=encryption, telecomsInterface=telecomsInterface, receiveFreqKHz=receiveFreqKHz, syslogState=syslogState, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNTPPollInterval=sNTPPollInterval, daylightSaving=daylightSaving, channelBandwidth=channelBandwidth, sNTPServerIPAddress=sNTPServerIPAddress, ptpGroups=ptpGroups, tFTPServerPortNumber=tFTPServerPortNumber, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, ptpTrapPrefix=ptpTrapPrefix, unitOutOfCalibration=unitOutOfCalibration, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, syslogClientTrap=syslogClientTrap, groupID=groupID, hTTPSAccessEnabled=hTTPSAccessEnabled, syslogControl=syslogControl, hTTPSPortNumber=hTTPSPortNumber, syslogClient=syslogClient, tDDControl=tDDControl, ethernetFiberSupport=ethernetFiberSupport, userTableEntry=userTableEntry, receiveModulationMode=receiveModulationMode, enabledDiagnosticAlarms=enabledDiagnosticAlarms, telecomsChannelStatus=telecomsChannelStatus, PYSNMP_MODULE_ID=cambium, timeZone=timeZone, reset=reset, userName=userName, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNMPCommunityString=sNMPCommunityString, licenceGroup=licenceGroup, dfsTableEntry=dfsTableEntry, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, syslogStateTrap=syslogStateTrap, sntpGroup=sntpGroup, vLANPriorityTable=vLANPriorityTable, hTTPPortNumber=hTTPPortNumber, notificationsGroup=notificationsGroup, supplementaryGroup=supplementaryGroup, transmitFreqKHz=transmitFreqKHz)
