...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sNMPv3Enable=sNMPv3Enable, capacityLicenseMismatch=capacityLicenseMismatch, syslogState=syslogState, dfsTableEntry=dfsTableEntry, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, maximumTransmitPower=maximumTransmitPower, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, longitude=longitude, vLANPriorityTableIndex=vLANPriorityTableIndex, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, managementGroup=managementGroup, targetMACAddress=targetMACAddress, userTableIndex=userTableIndex, dataPortStatusTrap=dataPortStatusTrap, ptpGroups=ptpGroups, sNTPSyncTrap=sNTPSyncTrap, alarmsGroup=alarmsGroup, syslogStateTrap=syslogStateTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, productName=productName, vectorError=vectorError, receiveModulationMode=receiveModulationMode, dfsTableIndex=dfsTableIndex, hTTPPortNumber=hTTPPortNumber, transmitPower=transmitPower, telecomsLoopback=telecomsLoopback, telecomsChannelStatus=telecomsChannelStatus, sNTPPollInterval=sNTPPollInterval, remoteMaximumTransmitPower=remoteMaximumTransmitPower, useVLANForManagementInterfaces=useVLANForManagementInterfaces, installStatusTrap=installStatusTrap, aggregateDataRate=aggregateDataRate, dataPortDisabledWarning=dataPortDisabledWarning, linkModeOptimisation=linkModeOptimisation, syslogClientTrap=syslogClientTrap, licensedCapacity=licensedCapacity, vLANPriorityQueueMapping=vLANPriorityQueueMapping, phyControlGroup=phyControlGroup, dfsTable=dfsTable, userTable=userTable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, phyStatusGroup=phyStatusGroup, incompatibleRegionCodes=incompatibleRegionCodes, userName=userName, ptp500=ptp500, range=range, phyStatus=phyStatus, syslogClient=syslogClient, timeZone=timeZone, userTableEntry=userTableEntry, dataPortAutoNegotiation=dataPortAutoNegotiation, supplementaryGroup=supplementaryGroup, telecomsCableLength=telecomsCableLength, alarms=alarms, sNMPCommunityString=sNMPCommunityString, pubStatsGroup=pubStatsGroup, transmitModulationMode=transmitModulationMode, sntpGroup=sntpGroup, transmitChannel=transmitChannel, latitude=latitude, management=management, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, versions=versions, installStatus=installStatus, syslogControl=syslogControl, tDDControlGroup=tDDControlGroup, remoteIPAddress=remoteIPAddress, telecomsLoopbackTrap=telecomsLoopbackTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, wirelessLinkAvailability=wirelessLinkAvailability, encryptionGroup=encryptionGroup, sntp=sntp, bandwidthVariant=bandwidthVariant, channelBandwidth=channelBandwidth, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tDDControl=tDDControl, sNMPTrapPortNumber=sNMPTrapPortNumber, vLANPriorityTableEntry=vLANPriorityTableEntry, receivePower=receivePower, searchState=searchState, hardwareVersion=hardwareVersion, aAAControl=aAAControl, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapTableEntry=sNMPTrapTableEntry, resetGroup=resetGroup, tDDSynchronizationMode=tDDSynchronizationMode, sNMPEnabledTraps=sNMPEnabledTraps, encryption=encryption, unitOutOfCalibration=unitOutOfCalibration, regionCodeTrap=regionCodeTrap, licenceGroup=licenceGroup, ethernetFiberSupport=ethernetFiberSupport, tDDSynchronizationStatus=tDDSynchronizationStatus, softwareVersion=softwareVersion, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sMTPServerPortNumber=sMTPServerPortNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, licence=licence, transmitFreqKHz=transmitFreqKHz, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortStatus=dataPortStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortAutoMdix=dataPortAutoMdix, hTTPSPortNumber=hTTPSPortNumber, ptpTrapPrefix=ptpTrapPrefix, receiveFreqMHz=receiveFreqMHz, ptp=ptp, pubStats=pubStats, sNMPTrapVersion=sNMPTrapVersion, altitude=altitude, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, vLANPriorityTableNumber=vLANPriorityTableNumber, sNTPSync=sNTPSync, sNTPServerIPAddress=sNTPServerIPAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ethernetGroup=ethernetGroup, byteErrorRatio=byteErrorRatio, configurationGroup=configurationGroup, sMTPEmailAlert=sMTPEmailAlert, userPassword=userPassword, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, linkName=linkName, telecomGroup=telecomGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapTableIndex=sNMPTrapTableIndex, telecomsInterface=telecomsInterface, eIRP=eIRP, sNTPState=sNTPState, supplementary=supplementary, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sMTPServerIPAddress=sMTPServerIPAddress, dfsGroup=dfsGroup, secondarySoftwareVersion=secondarySoftwareVersion, notificationsGroup=notificationsGroup, linkLoss=linkLoss, enabledDiagnosticAlarms=enabledDiagnosticAlarms, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, PYSNMP_MODULE_ID=cambium, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, telnetPortNumber=telnetPortNumber, dfsTableNumber=dfsTableNumber, dfsPeaks=dfsPeaks, phyControl=phyControl, daylightSaving=daylightSaving, smtp=smtp, productVariant=productVariant, dfs=dfs, receiveModulationModeDetail=receiveModulationModeDetail, vLANManagementVID=vLANManagementVID, userEnabled=userEnabled, regionCode=regionCode, vLANManagementPriority=vLANManagementPriority, antennaGain=antennaGain, ethernet=ethernet, snmpControlGroup=snmpControlGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, linkModeOptimizationMismatch=linkModeOptimizationMismatch, systemReset=systemReset, encryptionAlgorithm=encryptionAlgorithm, systemClock=systemClock, sNMPTrapTable=sNMPTrapTable, signalStrengthRatio=signalStrengthRatio, tFTPServerIPAddress=tFTPServerIPAddress, linkSymmetry=linkSymmetry, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPLastSync=sNTPLastSync, dfsMeans=dfsMeans, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, receiveDataRate=receiveDataRate, reset=reset, groupID=groupID, vLANPriorityTable=vLANPriorityTable, smtpGroup=smtpGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, noWirelessChannelAvailable=noWirelessChannelAvailable, telecom=telecom, snmpControl=snmpControl, siteName=siteName, versionsGroup=versionsGroup, receiveChannel=receiveChannel, configuration=configuration, subnetMask=subnetMask, telnetAccessEnabled=telnetAccessEnabled, sNTPServerPortNumber=sNTPServerPortNumber, wirelessLinkStatus=wirelessLinkStatus, userRole=userRole, transmitFreqMHz=transmitFreqMHz, ptpTraps=ptpTraps, ptmp=ptmp, telecomsLineCode=telecomsLineCode, installArmState=installArmState, hTTPAccessEnabled=hTTPAccessEnabled, telecomsChannelStatusTrap=telecomsChannelStatusTrap, tFTPServerPortNumber=tFTPServerPortNumber, userTableNumber=userTableNumber, masterSlaveMode=masterSlaveMode, transmitDataRate=transmitDataRate, bootVersion=bootVersion, cambium=cambium, aAAControlGroup=aAAControlGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, channelChangeTrap=channelChangeTrap, cableLoss=cableLoss, receiveFreqKHz=receiveFreqKHz, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, frequencyVariant=frequencyVariant, iPAddress=iPAddress, gatewayIPAddress=gatewayIPAddress, installArmStateTrap=installArmStateTrap, sNMPPortNumber=sNMPPortNumber, syslogControlGroup=syslogControlGroup, accessMethod=accessMethod, ptpCompliance=ptpCompliance)
