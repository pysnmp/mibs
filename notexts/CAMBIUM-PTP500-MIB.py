...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", longitude=longitude, eIRP=eIRP, telecomsLoopbackTrap=telecomsLoopbackTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, phyControlGroup=phyControlGroup, tDDControlGroup=tDDControlGroup, installStatus=installStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, hTTPSAccessEnabled=hTTPSAccessEnabled, bandwidthVariant=bandwidthVariant, transmitPower=transmitPower, tFTPServerPortNumber=tFTPServerPortNumber, cableLoss=cableLoss, byteErrorRatio=byteErrorRatio, receiveFreqKHz=receiveFreqKHz, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, telecomGroup=telecomGroup, linkLoss=linkLoss, userTableEntry=userTableEntry, sMTPEmailAlert=sMTPEmailAlert, sNTPServerIPAddress=sNTPServerIPAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, softwareVersion=softwareVersion, ptpTraps=ptpTraps, phyStatus=phyStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, targetMACAddress=targetMACAddress, sMTPEnabledMessages=sMTPEnabledMessages, alarmsGroup=alarmsGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, phyControl=phyControl, transmitFreqMHz=transmitFreqMHz, linkModeOptimisation=linkModeOptimisation, systemClock=systemClock, userEnabled=userEnabled, encryptionGroup=encryptionGroup, dfsTableNumber=dfsTableNumber, vLANManagementVID=vLANManagementVID, productName=productName, ethernet=ethernet, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, userName=userName, useVLANForManagementInterfaces=useVLANForManagementInterfaces, userTable=userTable, userRole=userRole, vLANPriorityQueueMapping=vLANPriorityQueueMapping, licence=licence, tFTPServerIPAddress=tFTPServerIPAddress, aAAControlGroup=aAAControlGroup, syslogControlGroup=syslogControlGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, licenceGroup=licenceGroup, dfsTableIndex=dfsTableIndex, ptp500=ptp500, versionsGroup=versionsGroup, telecomsLineCode=telecomsLineCode, gatewayIPAddress=gatewayIPAddress, subnetMask=subnetMask, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfsGroup=dfsGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, licensedCapacity=licensedCapacity, frequencyVariant=frequencyVariant, transmitFreqKHz=transmitFreqKHz, searchState=searchState, tDDSynchronizationAlarm=tDDSynchronizationAlarm, reset=reset, hTTPSPortNumber=hTTPSPortNumber, dataPortDisabledWarning=dataPortDisabledWarning, ptpGroups=ptpGroups, siteName=siteName, tDDSynchronizationStatus=tDDSynchronizationStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, telecomsCableLength=telecomsCableLength, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, telecom=telecom, smtp=smtp, vectorError=vectorError, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, antennaGain=antennaGain, vLANPriorityTable=vLANPriorityTable, wirelessLinkStatus=wirelessLinkStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNTPLastSync=sNTPLastSync, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, vLANPriorityTableIndex=vLANPriorityTableIndex, secondarySoftwareVersion=secondarySoftwareVersion, transmitModulationMode=transmitModulationMode, syslogClientTrap=syslogClientTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPTrapTableEntry=sNMPTrapTableEntry, accessMethod=accessMethod, dataPortAutoMdix=dataPortAutoMdix, dataPortAutoNegotiation=dataPortAutoNegotiation, sNTPPollInterval=sNTPPollInterval, aggregateDataRate=aggregateDataRate, installArmStateTrap=installArmStateTrap, sNMPTrapTable=sNMPTrapTable, daylightSaving=daylightSaving, altitude=altitude, configurationGroup=configurationGroup, encryptionAlgorithm=encryptionAlgorithm, ptpTrapPrefix=ptpTrapPrefix, syslogLocalWrappedTrap=syslogLocalWrappedTrap, syslogState=syslogState, sNMPTrapIPAddress=sNMPTrapIPAddress, receiveChannel=receiveChannel, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sntpGroup=sntpGroup, hardwareVersion=hardwareVersion, snmpControl=snmpControl, sNMPEnabledTraps=sNMPEnabledTraps, signalStrengthRatio=signalStrengthRatio, sMTPSourceEmailAddress=sMTPSourceEmailAddress, linkName=linkName, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, range=range, sNMPTrapVersion=sNMPTrapVersion, cambium=cambium, sntp=sntp, smtpGroup=smtpGroup, linkSymmetry=linkSymmetry, sNMPPortNumber=sNMPPortNumber, syslogControl=syslogControl, noWirelessChannelAvailable=noWirelessChannelAvailable, notificationsGroup=notificationsGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, masterSlaveMode=masterSlaveMode, receivePower=receivePower, latitude=latitude, alarms=alarms, maximumTransmitPower=maximumTransmitPower, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, userPassword=userPassword, pubStats=pubStats, sNTPSyncTrap=sNTPSyncTrap, telecomsInterface=telecomsInterface, timeZone=timeZone, sNMPTrapTableIndex=sNMPTrapTableIndex, regionCode=regionCode, hTTPAccessEnabled=hTTPAccessEnabled, regionCodeTrap=regionCodeTrap, snmpControlGroup=snmpControlGroup, transmitDataRate=transmitDataRate, userTableIndex=userTableIndex, telecomsLoopback=telecomsLoopback, syslogStateTrap=syslogStateTrap, remoteIPAddress=remoteIPAddress, receiveDataRate=receiveDataRate, ptp=ptp, wirelessLinkAvailability=wirelessLinkAvailability, dfsMeans=dfsMeans, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ptpCompliance=ptpCompliance, encryption=encryption, capacityLicenseMismatch=capacityLicenseMismatch, sNTPSync=sNTPSync, iPAddress=iPAddress, installStatusTrap=installStatusTrap, supplementaryGroup=supplementaryGroup, receiveFreqMHz=receiveFreqMHz, sNMPCommunityString=sNMPCommunityString, bootVersion=bootVersion, userTableNumber=userTableNumber, PYSNMP_MODULE_ID=cambium, telecomsChannelStatus=telecomsChannelStatus, tDDSynchronizationMode=tDDSynchronizationMode, vLANPriorityTableNumber=vLANPriorityTableNumber, telecomsChannelStatusTrap=telecomsChannelStatusTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, incompatibleRegionCodes=incompatibleRegionCodes, versions=versions, aAAControl=aAAControl, dataPortStatus=dataPortStatus, dfs=dfs, dataPortStatusTrap=dataPortStatusTrap, receiveModulationModeDetail=receiveModulationModeDetail, groupID=groupID, sMTPServerIPAddress=sMTPServerIPAddress, channelChangeTrap=channelChangeTrap, installArmState=installArmState, dfsPeaks=dfsPeaks, supplementary=supplementary, productVariant=productVariant, systemReset=systemReset, ethernetFiberSupport=ethernetFiberSupport, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, transmitChannel=transmitChannel, tDDControl=tDDControl, hTTPPortNumber=hTTPPortNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, resetGroup=resetGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPServerPortNumber=sNTPServerPortNumber, pubStatsGroup=pubStatsGroup, phyStatusGroup=phyStatusGroup, ethernetGroup=ethernetGroup, vLANManagementPriority=vLANManagementPriority, sNMPv3Enable=sNMPv3Enable, telnetPortNumber=telnetPortNumber, unitOutOfCalibration=unitOutOfCalibration, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, receiveModulationMode=receiveModulationMode, syslogClient=syslogClient, management=management, managementGroup=managementGroup, telnetAccessEnabled=telnetAccessEnabled, sNTPState=sNTPState, dfsTable=dfsTable, configuration=configuration, channelBandwidth=channelBandwidth, dfsTableEntry=dfsTableEntry, ptmp=ptmp)
