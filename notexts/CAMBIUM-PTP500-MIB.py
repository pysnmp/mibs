...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", telecomGroup=telecomGroup, dfsTableNumber=dfsTableNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, linkSymmetry=linkSymmetry, ptpTraps=ptpTraps, sntp=sntp, secondarySoftwareVersion=secondarySoftwareVersion, systemClock=systemClock, receiveModulationMode=receiveModulationMode, productName=productName, receiveFreqMHz=receiveFreqMHz, gatewayIPAddress=gatewayIPAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPCommunityString=sNMPCommunityString, encryption=encryption, sNMPPortNumber=sNMPPortNumber, alarmsGroup=alarmsGroup, phyStatus=phyStatus, channelBandwidth=channelBandwidth, vLANPriorityTableNumber=vLANPriorityTableNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, transmitDataRate=transmitDataRate, transmitFreqKHz=transmitFreqKHz, vLANPriorityTableIndex=vLANPriorityTableIndex, sNMPEnabledTraps=sNMPEnabledTraps, systemReset=systemReset, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ptpTrapPrefix=ptpTrapPrefix, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNTPState=sNTPState, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPLastSync=sNTPLastSync, byteErrorRatio=byteErrorRatio, altitude=altitude, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPPollInterval=sNTPPollInterval, licenceGroup=licenceGroup, telecomsInterface=telecomsInterface, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, configuration=configuration, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, aggregateDataRate=aggregateDataRate, dataPortStatus=dataPortStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, searchState=searchState, aAAControlGroup=aAAControlGroup, antennaGain=antennaGain, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, userTableEntry=userTableEntry, receiveModulationModeDetail=receiveModulationModeDetail, range=range, telecomsChannelStatus=telecomsChannelStatus, channelChangeTrap=channelChangeTrap, phyStatusGroup=phyStatusGroup, wirelessLinkAvailability=wirelessLinkAvailability, sNTPSync=sNTPSync, dataPortDisabledWarning=dataPortDisabledWarning, dataPortAutoMdix=dataPortAutoMdix, versions=versions, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, bootVersion=bootVersion, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, phyControl=phyControl, managementGroup=managementGroup, syslogState=syslogState, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tFTPServerIPAddress=tFTPServerIPAddress, sMTPEmailAlert=sMTPEmailAlert, dfsGroup=dfsGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, siteName=siteName, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dataPortConfigurationMismatch=dataPortConfigurationMismatch, syslogClient=syslogClient, regionCodeTrap=regionCodeTrap, sntpGroup=sntpGroup, userPassword=userPassword, ethernetGroup=ethernetGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, supplementary=supplementary, dfsPeaks=dfsPeaks, maximumTransmitPower=maximumTransmitPower, iPAddress=iPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, cambium=cambium, linkLoss=linkLoss, syslogControl=syslogControl, transmitFreqMHz=transmitFreqMHz, tDDControl=tDDControl, licence=licence, receiveChannel=receiveChannel, linkName=linkName, management=management, vLANPriorityTable=vLANPriorityTable, tDDSynchronizationMode=tDDSynchronizationMode, useVLANForManagementInterfaces=useVLANForManagementInterfaces, incompatibleRegionCodes=incompatibleRegionCodes, hTTPAccessEnabled=hTTPAccessEnabled, remoteIPAddress=remoteIPAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortAutoNegotiation=dataPortAutoNegotiation, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, userName=userName, eIRP=eIRP, daylightSaving=daylightSaving, accessMethod=accessMethod, frequencyVariant=frequencyVariant, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, hTTPPortNumber=hTTPPortNumber, sNTPSyncTrap=sNTPSyncTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, ptp500=ptp500, sNMPTrapVersion=sNMPTrapVersion, userEnabled=userEnabled, telecom=telecom, syslogControlGroup=syslogControlGroup, notificationsGroup=notificationsGroup, encryptionAlgorithm=encryptionAlgorithm, sNMPTrapTableEntry=sNMPTrapTableEntry, vectorError=vectorError, syslogStateTrap=syslogStateTrap, ptmp=ptmp, transmitPower=transmitPower, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, pubStats=pubStats, ethernetFiberSupport=ethernetFiberSupport, signalStrengthRatio=signalStrengthRatio, transmitChannel=transmitChannel, telecomsChannelStatusTrap=telecomsChannelStatusTrap, snmpControl=snmpControl, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, syslogClientTrap=syslogClientTrap, masterSlaveMode=masterSlaveMode, userRole=userRole, alarms=alarms, transmitModulationMode=transmitModulationMode, snmpControlGroup=snmpControlGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, installArmStateTrap=installArmStateTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataPortStatusTrap=dataPortStatusTrap, longitude=longitude, receiveDataRate=receiveDataRate, tDDSynchronizationStatus=tDDSynchronizationStatus, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, userTableNumber=userTableNumber, telnetAccessEnabled=telnetAccessEnabled, ptp=ptp, sMTPServerIPAddress=sMTPServerIPAddress, receivePower=receivePower, softwareVersion=softwareVersion, hardwareVersion=hardwareVersion, encryptionGroup=encryptionGroup, sMTPEnabledMessages=sMTPEnabledMessages, productVariant=productVariant, dfsTableEntry=dfsTableEntry, sMTPServerPortNumber=sMTPServerPortNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ptpCompliance=ptpCompliance, aAAControl=aAAControl, sNMPTrapTable=sNMPTrapTable, installStatus=installStatus, capacityLicenseMismatch=capacityLicenseMismatch, sNTPServerIPAddress=sNTPServerIPAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, versionsGroup=versionsGroup, userTable=userTable, telecomsLoopback=telecomsLoopback, hTTPSPortNumber=hTTPSPortNumber, regionCode=regionCode, installArmState=installArmState, licensedCapacity=licensedCapacity, phyControlGroup=phyControlGroup, telecomsLineCode=telecomsLineCode, latitude=latitude, PYSNMP_MODULE_ID=cambium, timeZone=timeZone, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tFTPServerPortNumber=tFTPServerPortNumber, dfsTable=dfsTable, dfsMeans=dfsMeans, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, targetMACAddress=targetMACAddress, groupID=groupID, dfsTableIndex=dfsTableIndex, constantPowerSpectralDensity=constantPowerSpectralDensity, installStatusTrap=installStatusTrap, subnetMask=subnetMask, smtp=smtp, dfs=dfs, cableLoss=cableLoss, ethernet=ethernet, tDDControlGroup=tDDControlGroup, telecomsCableLength=telecomsCableLength, reset=reset, telecomsLoopbackTrap=telecomsLoopbackTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, supplementaryGroup=supplementaryGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, bandwidthVariant=bandwidthVariant, sNMPTrapPortNumber=sNMPTrapPortNumber, ptpGroups=ptpGroups, smtpGroup=smtpGroup, wirelessLinkStatus=wirelessLinkStatus, configurationGroup=configurationGroup, receiveFreqKHz=receiveFreqKHz, telnetPortNumber=telnetPortNumber, unitOutOfCalibration=unitOutOfCalibration, pubStatsGroup=pubStatsGroup, userTableIndex=userTableIndex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, vLANManagementPriority=vLANManagementPriority, sNTPServerPortNumber=sNTPServerPortNumber, vLANManagementVID=vLANManagementVID, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, vLANPriorityQueueMapping=vLANPriorityQueueMapping, linkModeOptimisation=linkModeOptimisation, resetGroup=resetGroup, sNMPv3Enable=sNMPv3Enable)
