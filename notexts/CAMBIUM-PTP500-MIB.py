...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, frequencyVariant=frequencyVariant, telecomsLoopback=telecomsLoopback, telnetPortNumber=telnetPortNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, tFTPServerIPAddress=tFTPServerIPAddress, dataPortAutoMdix=dataPortAutoMdix, antennaGain=antennaGain, receiveModulationModeDetail=receiveModulationModeDetail, dataPortStatus=dataPortStatus, signalStrengthRatio=signalStrengthRatio, tDDSynchronizationMode=tDDSynchronizationMode, installStatus=installStatus, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, supplementaryGroup=supplementaryGroup, cambium=cambium, licenceGroup=licenceGroup, searchState=searchState, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, vLANManagementVID=vLANManagementVID, vLANPriorityTableNumber=vLANPriorityTableNumber, encryptionAlgorithm=encryptionAlgorithm, vLANPriorityTableIndex=vLANPriorityTableIndex, telnetAccessEnabled=telnetAccessEnabled, dfsTableIndex=dfsTableIndex, targetMACAddress=targetMACAddress, syslogClientTrap=syslogClientTrap, linkLoss=linkLoss, ethernet=ethernet, productName=productName, transmitFreqMHz=transmitFreqMHz, phyStatus=phyStatus, telecomsChannelStatus=telecomsChannelStatus, dfs=dfs, ptpCompliance=ptpCompliance, enabledDiagnosticAlarms=enabledDiagnosticAlarms, range=range, sNMPTrapVersion=sNMPTrapVersion, sNMPv3Enable=sNMPv3Enable, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortConfigurationMismatch=dataPortConfigurationMismatch, resetGroup=resetGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNMPTrapTable=sNMPTrapTable, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortDisabledWarning=dataPortDisabledWarning, groupID=groupID, timeZone=timeZone, transmitChannel=transmitChannel, ptp500=ptp500, configurationGroup=configurationGroup, accessMethod=accessMethod, dfsMeans=dfsMeans, tFTPServerPortNumber=tFTPServerPortNumber, sntpGroup=sntpGroup, userName=userName, sNTPSyncTrap=sNTPSyncTrap, longitude=longitude, dfsGroup=dfsGroup, alarms=alarms, byteErrorRatio=byteErrorRatio, maximumTransmitPower=maximumTransmitPower, altitude=altitude, ptpGroups=ptpGroups, vLANManagementPriority=vLANManagementPriority, tDDControl=tDDControl, aAAControl=aAAControl, sNTPPollInterval=sNTPPollInterval, cableLoss=cableLoss, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, aggregateDataRate=aggregateDataRate, incompatibleRegionCodes=incompatibleRegionCodes, syslogState=syslogState, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, secondarySoftwareVersion=secondarySoftwareVersion, wirelessLinkAvailability=wirelessLinkAvailability, userEnabled=userEnabled, sMTPServerPortNumber=sMTPServerPortNumber, capacityLicenseMismatch=capacityLicenseMismatch, notificationsGroup=notificationsGroup, daylightSaving=daylightSaving, receiveChannel=receiveChannel, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, channelChangeTrap=channelChangeTrap, gatewayIPAddress=gatewayIPAddress, eIRP=eIRP, management=management, telecomGroup=telecomGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, siteName=siteName, telecomsCableLength=telecomsCableLength, PYSNMP_MODULE_ID=cambium, ptpTrapPrefix=ptpTrapPrefix, licence=licence, supplementary=supplementary, sNMPPortNumber=sNMPPortNumber, telecomsLoopbackTrap=telecomsLoopbackTrap, vLANPriorityQueueMapping=vLANPriorityQueueMapping, licensedCapacity=licensedCapacity, tDDControlGroup=tDDControlGroup, telecomsInterface=telecomsInterface, hTTPPortNumber=hTTPPortNumber, dfsTableEntry=dfsTableEntry, hTTPSAccessEnabled=hTTPSAccessEnabled, linkName=linkName, transmitDataRate=transmitDataRate, vLANPriorityTableEntry=vLANPriorityTableEntry, userTableEntry=userTableEntry, sNMPCommunityString=sNMPCommunityString, userPassword=userPassword, hTTPAccessEnabled=hTTPAccessEnabled, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNTPServerPortNumber=sNTPServerPortNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, installStatusTrap=installStatusTrap, receiveFreqMHz=receiveFreqMHz, dfsTableNumber=dfsTableNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, syslogStateTrap=syslogStateTrap, sNTPSync=sNTPSync, encryption=encryption, userTable=userTable, receiveModulationMode=receiveModulationMode, dataPortStatusTrap=dataPortStatusTrap, sntp=sntp, syslogClient=syslogClient, smtpGroup=smtpGroup, softwareVersion=softwareVersion, receiveDataRate=receiveDataRate, phyControl=phyControl, sMTPServerIPAddress=sMTPServerIPAddress, encryptionGroup=encryptionGroup, snmpControl=snmpControl, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, linkSymmetry=linkSymmetry, constantPowerSpectralDensity=constantPowerSpectralDensity, transmitFreqKHz=transmitFreqKHz, syslogLocalWrappedTrap=syslogLocalWrappedTrap, pubStatsGroup=pubStatsGroup, syslogControlGroup=syslogControlGroup, dfsPeaks=dfsPeaks, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, versionsGroup=versionsGroup, remoteIPAddress=remoteIPAddress, ptpTraps=ptpTraps, sNMPTrapIPAddress=sNMPTrapIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, ptmp=ptmp, ethernetGroup=ethernetGroup, hTTPSPortNumber=hTTPSPortNumber, phyControlGroup=phyControlGroup, receivePower=receivePower, userTableIndex=userTableIndex, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sMTPEnabledMessages=sMTPEnabledMessages, ptp=ptp, pubStats=pubStats, hardwareVersion=hardwareVersion, latitude=latitude, regionCode=regionCode, linkModeOptimisation=linkModeOptimisation, userRole=userRole, smtp=smtp, managementGroup=managementGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPServerIPAddress=sNTPServerIPAddress, masterSlaveMode=masterSlaveMode, userTableNumber=userTableNumber, vectorError=vectorError, transmitModulationMode=transmitModulationMode, transmitPower=transmitPower, alarmsGroup=alarmsGroup, installArmState=installArmState, sNTPLastSync=sNTPLastSync, sNTPState=sNTPState, ethernetFiberSupport=ethernetFiberSupport, sMTPEmailAlert=sMTPEmailAlert, bootVersion=bootVersion, unitOutOfCalibration=unitOutOfCalibration, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPTrapTableIndex=sNMPTrapTableIndex, channelBandwidth=channelBandwidth, telecom=telecom, telecomsLineCode=telecomsLineCode, regionCodeTrap=regionCodeTrap, versions=versions, dfsTable=dfsTable, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, syslogControl=syslogControl, sNMPTrapTableNumber=sNMPTrapTableNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, systemReset=systemReset, configuration=configuration, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, systemClock=systemClock, iPAddress=iPAddress, productVariant=productVariant, aAAControlGroup=aAAControlGroup, bandwidthVariant=bandwidthVariant, wirelessLinkStatus=wirelessLinkStatus, subnetMask=subnetMask, vLANPriorityTable=vLANPriorityTable, reset=reset, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, phyStatusGroup=phyStatusGroup, receiveFreqKHz=receiveFreqKHz, snmpControlGroup=snmpControlGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPEnabledTraps=sNMPEnabledTraps, installArmStateTrap=installArmStateTrap, sNMPTrapPortNumber=sNMPTrapPortNumber)
