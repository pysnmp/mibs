...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPEnabledTraps=sNMPEnabledTraps, bootVersion=bootVersion, userTable=userTable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, phyStatus=phyStatus, userTableIndex=userTableIndex, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, syslogControl=syslogControl, maximumTransmitPower=maximumTransmitPower, sntpGroup=sntpGroup, receiveDataRate=receiveDataRate, iPAddress=iPAddress, sNTPSync=sNTPSync, ptp=ptp, telnetAccessEnabled=telnetAccessEnabled, sNMPTrapTableEntry=sNMPTrapTableEntry, telecomsCableLength=telecomsCableLength, smtpGroup=smtpGroup, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapTableIndex=sNMPTrapTableIndex, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tDDControlGroup=tDDControlGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, vLANManagementVID=vLANManagementVID, receiveFreqKHz=receiveFreqKHz, dataPortDisabledWarning=dataPortDisabledWarning, vLANPriorityTableNumber=vLANPriorityTableNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNMPPortNumber=sNMPPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, syslogState=syslogState, telecomsLineCode=telecomsLineCode, hTTPAccessEnabled=hTTPAccessEnabled, supplementaryGroup=supplementaryGroup, ethernetGroup=ethernetGroup, smtp=smtp, telecomsLoopback=telecomsLoopback, receivePower=receivePower, alarms=alarms, hTTPSPortNumber=hTTPSPortNumber, incompatibleRegionCodes=incompatibleRegionCodes, syslogControlGroup=syslogControlGroup, sNMPTrapVersion=sNMPTrapVersion, dataPortConfigurationMismatch=dataPortConfigurationMismatch, receiveFreqMHz=receiveFreqMHz, siteName=siteName, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, regionCode=regionCode, targetMACAddress=targetMACAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, licensedCapacity=licensedCapacity, ptpTraps=ptpTraps, searchState=searchState, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, syslogClientTrap=syslogClientTrap, wirelessLinkAvailability=wirelessLinkAvailability, userPassword=userPassword, dfsMeans=dfsMeans, installStatus=installStatus, managementGroup=managementGroup, frequencyVariant=frequencyVariant, supplementary=supplementary, vLANPriorityTable=vLANPriorityTable, productVariant=productVariant, receiveChannel=receiveChannel, sMTPEmailAlert=sMTPEmailAlert, userTableNumber=userTableNumber, eIRP=eIRP, encryption=encryption, sMTPServerPortNumber=sMTPServerPortNumber, sNTPServerPortNumber=sNTPServerPortNumber, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, aggregateDataRate=aggregateDataRate, dfsTableIndex=dfsTableIndex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, unitOutOfCalibration=unitOutOfCalibration, ethernetFiberSupport=ethernetFiberSupport, PYSNMP_MODULE_ID=cambium, encryptionAlgorithm=encryptionAlgorithm, linkLoss=linkLoss, tDDControl=tDDControl, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, userTableEntry=userTableEntry, signalStrengthRatio=signalStrengthRatio, sNMPv3Enable=sNMPv3Enable, dfsTableEntry=dfsTableEntry, systemClock=systemClock, dfsGroup=dfsGroup, dataPortAutoMdix=dataPortAutoMdix, transmitFreqKHz=transmitFreqKHz, byteErrorRatio=byteErrorRatio, dfsPeaks=dfsPeaks, dataPortStatus=dataPortStatus, receiveModulationModeDetail=receiveModulationModeDetail, vectorError=vectorError, sMTPServerIPAddress=sMTPServerIPAddress, ptmp=ptmp, configuration=configuration, sNMPTrapTable=sNMPTrapTable, sNTPState=sNTPState, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, linkModeOptimisation=linkModeOptimisation, management=management, vLANPriorityTableIndex=vLANPriorityTableIndex, ethernet=ethernet, pubStatsGroup=pubStatsGroup, transmitDataRate=transmitDataRate, versionsGroup=versionsGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, cambium=cambium, transmitFreqMHz=transmitFreqMHz, noWirelessChannelAvailable=noWirelessChannelAvailable, dfsTableNumber=dfsTableNumber, sNTPSyncTrap=sNTPSyncTrap, longitude=longitude, cableLoss=cableLoss, secondarySoftwareVersion=secondarySoftwareVersion, telecomsChannelStatusTrap=telecomsChannelStatusTrap, reset=reset, softwareVersion=softwareVersion, tDDSynchronizationMode=tDDSynchronizationMode, regionCodeTrap=regionCodeTrap, phyControl=phyControl, versions=versions, configurationGroup=configurationGroup, dataPortStatusTrap=dataPortStatusTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, sntp=sntp, syslogClient=syslogClient, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userName=userName, linkSymmetry=linkSymmetry, resetGroup=resetGroup, aAAControlGroup=aAAControlGroup, licenceGroup=licenceGroup, encryptionGroup=encryptionGroup, aAAControl=aAAControl, bandwidthVariant=bandwidthVariant, sNTPServerIPAddress=sNTPServerIPAddress, capacityLicenseMismatch=capacityLicenseMismatch, hTTPSAccessEnabled=hTTPSAccessEnabled, receiveModulationMode=receiveModulationMode, telecomGroup=telecomGroup, phyControlGroup=phyControlGroup, sNTPLastSync=sNTPLastSync, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, hardwareVersion=hardwareVersion, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, pubStats=pubStats, dataPortAutoNegotiation=dataPortAutoNegotiation, dfsTable=dfsTable, syslogStateTrap=syslogStateTrap, installStatusTrap=installStatusTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ptp500=ptp500, timeZone=timeZone, remoteMaximumTransmitPower=remoteMaximumTransmitPower, channelBandwidth=channelBandwidth, sNTPPollInterval=sNTPPollInterval, hTTPPortNumber=hTTPPortNumber, systemReset=systemReset, altitude=altitude, phyStatusGroup=phyStatusGroup, userEnabled=userEnabled, channelChangeTrap=channelChangeTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, antennaGain=antennaGain, constantPowerSpectralDensity=constantPowerSpectralDensity, subnetMask=subnetMask, vLANPriorityQueueMapping=vLANPriorityQueueMapping, installArmStateTrap=installArmStateTrap, accessMethod=accessMethod, transmitPower=transmitPower, installArmState=installArmState, remoteIPAddress=remoteIPAddress, vLANManagementPriority=vLANManagementPriority, transmitChannel=transmitChannel, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sMTPSourceEmailAddress=sMTPSourceEmailAddress, masterSlaveMode=masterSlaveMode, dataPortWirelessDownAlert=dataPortWirelessDownAlert, notificationsGroup=notificationsGroup, range=range, productName=productName, gatewayIPAddress=gatewayIPAddress, ptpCompliance=ptpCompliance, telecomsLoopbackTrap=telecomsLoopbackTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, wirelessLinkStatus=wirelessLinkStatus, transmitModulationMode=transmitModulationMode, sNMPCommunityString=sNMPCommunityString, daylightSaving=daylightSaving, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ptpTrapPrefix=ptpTrapPrefix, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tFTPServerPortNumber=tFTPServerPortNumber, telecom=telecom, snmpControlGroup=snmpControlGroup, groupID=groupID, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPServerIPAddress=tFTPServerIPAddress, userRole=userRole, linkName=linkName, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, telecomsInterface=telecomsInterface, dfs=dfs, licence=licence, telnetPortNumber=telnetPortNumber, snmpControl=snmpControl, ptpGroups=ptpGroups, telecomsChannelStatus=telecomsChannelStatus, alarmsGroup=alarmsGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, latitude=latitude)
