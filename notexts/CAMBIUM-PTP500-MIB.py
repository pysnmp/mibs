...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", configurationGroup=configurationGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dataPortDisabledWarning=dataPortDisabledWarning, telnetAccessEnabled=telnetAccessEnabled, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, receiveModulationMode=receiveModulationMode, sNTPState=sNTPState, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, telecomsChannelStatus=telecomsChannelStatus, installStatusTrap=installStatusTrap, subnetMask=subnetMask, management=management, encryptionAlgorithm=encryptionAlgorithm, siteName=siteName, dfsGroup=dfsGroup, sNMPv3Enable=sNMPv3Enable, sNMPEnabledTraps=sNMPEnabledTraps, telecomsInterface=telecomsInterface, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ethernetFiberSupport=ethernetFiberSupport, installArmStateTrap=installArmStateTrap, phyStatus=phyStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, cableLoss=cableLoss, wirelessLinkStatus=wirelessLinkStatus, sNMPPortNumber=sNMPPortNumber, channelChangeTrap=channelChangeTrap, ptp=ptp, encryptionGroup=encryptionGroup, userTable=userTable, syslogClient=syslogClient, telecomsLoopback=telecomsLoopback, constantPowerSpectralDensity=constantPowerSpectralDensity, sntp=sntp, incompatibleRegionCodes=incompatibleRegionCodes, sMTPServerIPAddress=sMTPServerIPAddress, snmpControl=snmpControl, vLANManagementPriority=vLANManagementPriority, latitude=latitude, linkSymmetry=linkSymmetry, telnetPortNumber=telnetPortNumber, sNTPLastSync=sNTPLastSync, licensedCapacity=licensedCapacity, ptmp=ptmp, vLANManagementVID=vLANManagementVID, versionsGroup=versionsGroup, userTableEntry=userTableEntry, bootVersion=bootVersion, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, gatewayIPAddress=gatewayIPAddress, capacityLicenseMismatch=capacityLicenseMismatch, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tDDSynchronizationAlarm=tDDSynchronizationAlarm, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sMTPEmailAlert=sMTPEmailAlert, vLANPriorityTableEntry=vLANPriorityTableEntry, receivePower=receivePower, dfsPeaks=dfsPeaks, pubStatsGroup=pubStatsGroup, userEnabled=userEnabled, hardwareVersion=hardwareVersion, PYSNMP_MODULE_ID=cambium, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, regionCode=regionCode, syslogStateTrap=syslogStateTrap, userTableIndex=userTableIndex, sNTPPollInterval=sNTPPollInterval, systemReset=systemReset, smtp=smtp, sNMPTrapTable=sNMPTrapTable, dfsTableNumber=dfsTableNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, licenceGroup=licenceGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, signalStrengthRatio=signalStrengthRatio, vLANPriorityTable=vLANPriorityTable, hTTPPortNumber=hTTPPortNumber, userRole=userRole, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortAutoMdix=dataPortAutoMdix, altitude=altitude, channelBandwidth=channelBandwidth, transmitFreqMHz=transmitFreqMHz, sNMPTrapPortNumber=sNMPTrapPortNumber, aAAControl=aAAControl, ethernet=ethernet, dfsTableIndex=dfsTableIndex, telecomsLineCode=telecomsLineCode, ptpCompliance=ptpCompliance, managementGroup=managementGroup, daylightSaving=daylightSaving, sNMPCommunityString=sNMPCommunityString, linkName=linkName, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dataPortStatus=dataPortStatus, userPassword=userPassword, phyControlGroup=phyControlGroup, maximumTransmitPower=maximumTransmitPower, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ptpGroups=ptpGroups, transmitModulationMode=transmitModulationMode, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, transmitChannel=transmitChannel, unitOutOfCalibration=unitOutOfCalibration, regionCodeTrap=regionCodeTrap, dfsMeans=dfsMeans, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, telecomsCableLength=telecomsCableLength, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, configuration=configuration, bandwidthVariant=bandwidthVariant, useVLANForManagementInterfaces=useVLANForManagementInterfaces, telecomsLoopbackTrap=telecomsLoopbackTrap, antennaGain=antennaGain, userName=userName, tDDControl=tDDControl, pubStats=pubStats, telecomGroup=telecomGroup, smtpGroup=smtpGroup, remoteIPAddress=remoteIPAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, syslogClientTrap=syslogClientTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, sNTPServerIPAddress=sNTPServerIPAddress, telecomsChannelStatusTrap=telecomsChannelStatusTrap, syslogState=syslogState, sNMPTrapVersion=sNMPTrapVersion, ptp500=ptp500, cambium=cambium, dataPortConfigurationMismatch=dataPortConfigurationMismatch, receiveModulationModeDetail=receiveModulationModeDetail, vLANPriorityTableNumber=vLANPriorityTableNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, dfsTableEntry=dfsTableEntry, hTTPSPortNumber=hTTPSPortNumber, snmpControlGroup=snmpControlGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, aAAControlGroup=aAAControlGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, transmitDataRate=transmitDataRate, tFTPServerPortNumber=tFTPServerPortNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, range=range, incompatibleMasterAndSlave=incompatibleMasterAndSlave, longitude=longitude, syslogControl=syslogControl, eIRP=eIRP, productVariant=productVariant, ptpTrapPrefix=ptpTrapPrefix, accessMethod=accessMethod, phyControl=phyControl, tDDControlGroup=tDDControlGroup, sNTPSync=sNTPSync, vLANPriorityTableIndex=vLANPriorityTableIndex, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, timeZone=timeZone, sNTPServerPortNumber=sNTPServerPortNumber, byteErrorRatio=byteErrorRatio, transmitFreqKHz=transmitFreqKHz, sNTPSyncTrap=sNTPSyncTrap, encryption=encryption, tDDSynchronizationMode=tDDSynchronizationMode, telecom=telecom, alarmsGroup=alarmsGroup, versions=versions, alarms=alarms, secondarySoftwareVersion=secondarySoftwareVersion, iPAddress=iPAddress, notificationsGroup=notificationsGroup, phyStatusGroup=phyStatusGroup, installArmState=installArmState, dfsTable=dfsTable, ptpTraps=ptpTraps, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, wirelessLinkAvailability=wirelessLinkAvailability, hTTPAccessEnabled=hTTPAccessEnabled, sMTPEnabledMessages=sMTPEnabledMessages, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ethernetGroup=ethernetGroup, searchState=searchState, aggregateDataRate=aggregateDataRate, sNMPTrapTableIndex=sNMPTrapTableIndex, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, transmitPower=transmitPower, receiveFreqMHz=receiveFreqMHz, resetGroup=resetGroup, dataPortStatusTrap=dataPortStatusTrap, supplementary=supplementary, linkModeOptimisation=linkModeOptimisation, hTTPSAccessEnabled=hTTPSAccessEnabled, productName=productName, vectorError=vectorError, licence=licence, sMTPServerPortNumber=sMTPServerPortNumber, sntpGroup=sntpGroup, syslogControlGroup=syslogControlGroup, supplementaryGroup=supplementaryGroup, linkLoss=linkLoss, receiveFreqKHz=receiveFreqKHz, reset=reset, targetMACAddress=targetMACAddress, masterSlaveMode=masterSlaveMode, dfs=dfs, frequencyVariant=frequencyVariant, groupID=groupID, userTableNumber=userTableNumber, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, receiveDataRate=receiveDataRate, systemClock=systemClock, installStatus=installStatus, softwareVersion=softwareVersion, receiveChannel=receiveChannel)
