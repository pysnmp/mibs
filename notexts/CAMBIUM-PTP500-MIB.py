...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", iPAddress=iPAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, channelBandwidth=channelBandwidth, subnetMask=subnetMask, pubStats=pubStats, useVLANForManagementInterfaces=useVLANForManagementInterfaces, enabledDiagnosticAlarms=enabledDiagnosticAlarms, userEnabled=userEnabled, sMTPServerIPAddress=sMTPServerIPAddress, sNTPLastSync=sNTPLastSync, frequencyVariant=frequencyVariant, dataPortDisabledWarning=dataPortDisabledWarning, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPState=sNTPState, installStatusTrap=installStatusTrap, unitOutOfCalibration=unitOutOfCalibration, smtp=smtp, antennaGain=antennaGain, telnetPortNumber=telnetPortNumber, userTableNumber=userTableNumber, altitude=altitude, userTableEntry=userTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, remoteMaximumTransmitPower=remoteMaximumTransmitPower, receiveModulationMode=receiveModulationMode, sMTPEnabledMessages=sMTPEnabledMessages, notificationsGroup=notificationsGroup, encryptionGroup=encryptionGroup, sNTPServerPortNumber=sNTPServerPortNumber, resetGroup=resetGroup, aggregateDataRate=aggregateDataRate, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, installStatus=installStatus, managementGroup=managementGroup, aAAControlGroup=aAAControlGroup, dataPortStatusTrap=dataPortStatusTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tDDControl=tDDControl, sNMPTrapTable=sNMPTrapTable, timeZone=timeZone, ptpTrapPrefix=ptpTrapPrefix, smtpGroup=smtpGroup, hTTPAccessEnabled=hTTPAccessEnabled, syslogControl=syslogControl, systemReset=systemReset, productVariant=productVariant, sNMPv3Enable=sNMPv3Enable, searchState=searchState, sNMPTrapVersion=sNMPTrapVersion, management=management, configurationGroup=configurationGroup, linkSymmetry=linkSymmetry, transmitDataRate=transmitDataRate, userPassword=userPassword, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, vLANManagementPriority=vLANManagementPriority, telecomsLoopback=telecomsLoopback, linkName=linkName, ptmp=ptmp, accessMethod=accessMethod, alarms=alarms, hTTPSPortNumber=hTTPSPortNumber, gatewayIPAddress=gatewayIPAddress, cableLoss=cableLoss, telecomsLoopbackTrap=telecomsLoopbackTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, configuration=configuration, userRole=userRole, dataPortAutoMdix=dataPortAutoMdix, sNTPSync=sNTPSync, receiveFreqKHz=receiveFreqKHz, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, channelChangeTrap=channelChangeTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, supplementary=supplementary, telecomGroup=telecomGroup, signalStrengthRatio=signalStrengthRatio, dfsTableIndex=dfsTableIndex, sNMPTrapIPAddress=sNMPTrapIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, remoteIPAddress=remoteIPAddress, transmitFreqMHz=transmitFreqMHz, receivePower=receivePower, sNMPTrapPortNumber=sNMPTrapPortNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, longitude=longitude, tDDSynchronizationStatus=tDDSynchronizationStatus, syslogStateTrap=syslogStateTrap, wirelessLinkStatus=wirelessLinkStatus, targetMACAddress=targetMACAddress, tFTPServerPortNumber=tFTPServerPortNumber, transmitPower=transmitPower, snmpControl=snmpControl, range=range, vLANPriorityTableEntry=vLANPriorityTableEntry, tDDControlGroup=tDDControlGroup, systemClock=systemClock, hardwareVersion=hardwareVersion, pubStatsGroup=pubStatsGroup, encryptionAlgorithm=encryptionAlgorithm, siteName=siteName, dfsTableEntry=dfsTableEntry, byteErrorRatio=byteErrorRatio, sNTPSyncTrap=sNTPSyncTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, maximumTransmitPower=maximumTransmitPower, ptp500=ptp500, alarmsGroup=alarmsGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, telecomsInterface=telecomsInterface, bandwidthVariant=bandwidthVariant, tDDSynchronizationMode=tDDSynchronizationMode, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sMTPEmailAlert=sMTPEmailAlert, daylightSaving=daylightSaving, snmpControlGroup=snmpControlGroup, licence=licence, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogLocalWrappedTrap=syslogLocalWrappedTrap, userName=userName, ptpTraps=ptpTraps, telecomsLineCode=telecomsLineCode, transmitChannel=transmitChannel, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfs=dfs, licenceGroup=licenceGroup, incompatibleRegionCodes=incompatibleRegionCodes, noWirelessChannelAvailable=noWirelessChannelAvailable, vLANManagementVID=vLANManagementVID, tFTPServerIPAddress=tFTPServerIPAddress, userTable=userTable, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, regionCodeTrap=regionCodeTrap, wirelessLinkAvailability=wirelessLinkAvailability, phyControl=phyControl, versionsGroup=versionsGroup, regionCode=regionCode, dfsPeaks=dfsPeaks, groupID=groupID, receiveChannel=receiveChannel, vLANPriorityTableIndex=vLANPriorityTableIndex, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, transmitModulationMode=transmitModulationMode, hTTPPortNumber=hTTPPortNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, ptpGroups=ptpGroups, reset=reset, receiveModulationModeDetail=receiveModulationModeDetail, syslogClientTrap=syslogClientTrap, dfsTable=dfsTable, phyControlGroup=phyControlGroup, sntp=sntp, aAAControl=aAAControl, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, phyStatusGroup=phyStatusGroup, linkModeOptimisation=linkModeOptimisation, linkLoss=linkLoss, secondarySoftwareVersion=secondarySoftwareVersion, latitude=latitude, syslogState=syslogState, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, phyStatus=phyStatus, receiveDataRate=receiveDataRate, sNTPServerIPAddress=sNTPServerIPAddress, PYSNMP_MODULE_ID=cambium, vLANPriorityTable=vLANPriorityTable, versions=versions, ethernetGroup=ethernetGroup, telnetAccessEnabled=telnetAccessEnabled, ptp=ptp, sNMPEnabledTraps=sNMPEnabledTraps, sNTPPollInterval=sNTPPollInterval, sNMPPortNumber=sNMPPortNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, dfsTableNumber=dfsTableNumber, telecomsChannelStatus=telecomsChannelStatus, bootVersion=bootVersion, userTableIndex=userTableIndex, installArmState=installArmState, softwareVersion=softwareVersion, receiveFreqMHz=receiveFreqMHz, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, ethernetFiberSupport=ethernetFiberSupport, licensedCapacity=licensedCapacity, sNMPCommunityString=sNMPCommunityString, syslogClient=syslogClient, telecom=telecom, syslogControlGroup=syslogControlGroup, sMTPServerPortNumber=sMTPServerPortNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tDDSynchronizationAlarm=tDDSynchronizationAlarm, productName=productName, supplementaryGroup=supplementaryGroup, capacityLicenseMismatch=capacityLicenseMismatch, vectorError=vectorError, ptpCompliance=ptpCompliance, masterSlaveMode=masterSlaveMode, eIRP=eIRP, dataPortConfigurationMismatch=dataPortConfigurationMismatch, transmitFreqKHz=transmitFreqKHz, sMTPSourceEmailAddress=sMTPSourceEmailAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortStatus=dataPortStatus, encryption=encryption, dfsMeans=dfsMeans, ethernet=ethernet, dfsGroup=dfsGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, installArmStateTrap=installArmStateTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sntpGroup=sntpGroup, cambium=cambium, telecomsCableLength=telecomsCableLength)
