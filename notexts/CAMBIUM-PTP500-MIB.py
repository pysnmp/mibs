...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", telecomsInterface=telecomsInterface, installArmState=installArmState, licensedCapacity=licensedCapacity, sNMPv3Enable=sNMPv3Enable, wirelessLinkStatus=wirelessLinkStatus, alarms=alarms, resetGroup=resetGroup, antennaGain=antennaGain, masterSlaveMode=masterSlaveMode, searchState=searchState, daylightSaving=daylightSaving, eIRP=eIRP, sNMPTrapPortNumber=sNMPTrapPortNumber, targetMACAddress=targetMACAddress, snmpControlGroup=snmpControlGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, smtpGroup=smtpGroup, ptpTrapPrefix=ptpTrapPrefix, iPAddress=iPAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, userName=userName, vLANPriorityTable=vLANPriorityTable, incompatibleRegionCodes=incompatibleRegionCodes, encryptionGroup=encryptionGroup, receiveDataRate=receiveDataRate, gatewayIPAddress=gatewayIPAddress, systemReset=systemReset, hardwareVersion=hardwareVersion, enabledDiagnosticAlarms=enabledDiagnosticAlarms, telecomsLoopbackTrap=telecomsLoopbackTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dfsGroup=dfsGroup, ethernetFiberSupport=ethernetFiberSupport, dataPortStatusTrap=dataPortStatusTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, productName=productName, remoteIPAddress=remoteIPAddress, telnetAccessEnabled=telnetAccessEnabled, range=range, smtp=smtp, regionCodeTrap=regionCodeTrap, ptmp=ptmp, versionsGroup=versionsGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, userTableNumber=userTableNumber, secondarySoftwareVersion=secondarySoftwareVersion, userEnabled=userEnabled, sNTPSyncTrap=sNTPSyncTrap, tFTPServerPortNumber=tFTPServerPortNumber, reset=reset, tDDSynchronizationAlarm=tDDSynchronizationAlarm, frequencyVariant=frequencyVariant, sMTPEnabledMessages=sMTPEnabledMessages, hTTPSPortNumber=hTTPSPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsPeaks=dfsPeaks, telecomsChannelStatus=telecomsChannelStatus, vLANManagementPriority=vLANManagementPriority, sNTPState=sNTPState, regionCode=regionCode, aAAControlGroup=aAAControlGroup, syslogClientTrap=syslogClientTrap, linkName=linkName, tDDSynchronizationMode=tDDSynchronizationMode, sntpGroup=sntpGroup, sNTPServerPortNumber=sNTPServerPortNumber, sNTPPollInterval=sNTPPollInterval, configurationGroup=configurationGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, licenceGroup=licenceGroup, phyStatusGroup=phyStatusGroup, productVariant=productVariant, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, capacityLicenseMismatch=capacityLicenseMismatch, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, ptpCompliance=ptpCompliance, longitude=longitude, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, encryptionAlgorithm=encryptionAlgorithm, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, syslogState=syslogState, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, bandwidthVariant=bandwidthVariant, wirelessLinkAvailability=wirelessLinkAvailability, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, cambium=cambium, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, snmpControl=snmpControl, supplementary=supplementary, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, telecomsLoopback=telecomsLoopback, transmitFreqMHz=transmitFreqMHz, dfsTableIndex=dfsTableIndex, unitOutOfCalibration=unitOutOfCalibration, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, management=management, installStatusTrap=installStatusTrap, installArmStateTrap=installArmStateTrap, signalStrengthRatio=signalStrengthRatio, dfs=dfs, telecomGroup=telecomGroup, sMTPServerPortNumber=sMTPServerPortNumber, siteName=siteName, vLANManagementVID=vLANManagementVID, systemClock=systemClock, tDDControl=tDDControl, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPEnabledTraps=sNMPEnabledTraps, receiveModulationMode=receiveModulationMode, userPassword=userPassword, installStatus=installStatus, sNMPTrapVersion=sNMPTrapVersion, ethernetGroup=ethernetGroup, transmitPower=transmitPower, aggregateDataRate=aggregateDataRate, channelBandwidth=channelBandwidth, userTable=userTable, hTTPAccessEnabled=hTTPAccessEnabled, transmitChannel=transmitChannel, altitude=altitude, telecom=telecom, licence=licence, sNMPTrapTableNumber=sNMPTrapTableNumber, cableLoss=cableLoss, dataPortAutoNegotiation=dataPortAutoNegotiation, softwareVersion=softwareVersion, bootVersion=bootVersion, dataPortConfigurationMismatch=dataPortConfigurationMismatch, vLANPriorityTableIndex=vLANPriorityTableIndex, versions=versions, vLANPriorityTableEntry=vLANPriorityTableEntry, alarmsGroup=alarmsGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tFTPServerIPAddress=tFTPServerIPAddress, encryption=encryption, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, hTTPPortNumber=hTTPPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sntp=sntp, ptp500=ptp500, userTableEntry=userTableEntry, pubStatsGroup=pubStatsGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, ethernet=ethernet, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNTPServerIPAddress=sNTPServerIPAddress, phyControl=phyControl, phyControlGroup=phyControlGroup, dfsTable=dfsTable, pubStats=pubStats, incompatibleMasterAndSlave=incompatibleMasterAndSlave, byteErrorRatio=byteErrorRatio, timeZone=timeZone, telecomsChannelStatusTrap=telecomsChannelStatusTrap, receiveFreqMHz=receiveFreqMHz, receiveFreqKHz=receiveFreqKHz, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, aAAControl=aAAControl, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, maximumTransmitPower=maximumTransmitPower, telecomsLineCode=telecomsLineCode, sNTPSync=sNTPSync, sNMPTrapTableEntry=sNMPTrapTableEntry, dfsMeans=dfsMeans, vLANPriorityTableNumber=vLANPriorityTableNumber, managementGroup=managementGroup, ptp=ptp, syslogControl=syslogControl, sNMPTrapIPAddress=sNMPTrapIPAddress, userTableIndex=userTableIndex, syslogClient=syslogClient, groupID=groupID, useVLANForManagementInterfaces=useVLANForManagementInterfaces, receiveChannel=receiveChannel, PYSNMP_MODULE_ID=cambium, supplementaryGroup=supplementaryGroup, linkModeOptimisation=linkModeOptimisation, dataPortAutoMdix=dataPortAutoMdix, dfsTableEntry=dfsTableEntry, telnetPortNumber=telnetPortNumber, dfsTableNumber=dfsTableNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, syslogStateTrap=syslogStateTrap, dataPortStatus=dataPortStatus, syslogControlGroup=syslogControlGroup, sNTPLastSync=sNTPLastSync, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPEmailAlert=sMTPEmailAlert, ptpGroups=ptpGroups, notificationsGroup=notificationsGroup, subnetMask=subnetMask, accessMethod=accessMethod, telecomsCableLength=telecomsCableLength, sNMPPortNumber=sNMPPortNumber, receiveModulationModeDetail=receiveModulationModeDetail, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, linkModeOptimizationMismatch=linkModeOptimizationMismatch, transmitFreqKHz=transmitFreqKHz, sMTPServerIPAddress=sMTPServerIPAddress, receivePower=receivePower, sNMPCommunityString=sNMPCommunityString, latitude=latitude, sNMPTrapTable=sNMPTrapTable, linkLoss=linkLoss, vectorError=vectorError, dataPortDisabledWarning=dataPortDisabledWarning, ptpTraps=ptpTraps, transmitModulationMode=transmitModulationMode, transmitDataRate=transmitDataRate, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, constantPowerSpectralDensity=constantPowerSpectralDensity, tDDControlGroup=tDDControlGroup, channelChangeTrap=channelChangeTrap, userRole=userRole, phyStatus=phyStatus, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, configuration=configuration, linkSymmetry=linkSymmetry)
