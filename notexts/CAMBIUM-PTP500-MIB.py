...
NotificationType, Integer32, Gauge32, MibIdentifier, Bits, ModuleIdentity, iso, Counter32, Counter64, Unsigned32, TimeTicks, IpAddress, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "Gauge32", "MibIdentifier", "Bits", "ModuleIdentity", "iso", "Counter32", "Counter64", "Unsigned32", "TimeTicks", "IpAddress", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", pubStatsGroup=pubStatsGroup, userEnabled=userEnabled, tDDSynchronizationStatus=tDDSynchronizationStatus, licenceGroup=licenceGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, ptpCompliance=ptpCompliance, transmitModulationMode=transmitModulationMode, reset=reset, dataPortStatusTrap=dataPortStatusTrap, encryptionGroup=encryptionGroup, vectorError=vectorError, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, hTTPAccessEnabled=hTTPAccessEnabled, telecom=telecom, vLANManagementVID=vLANManagementVID, sMTPServerPortNumber=sMTPServerPortNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, alarms=alarms, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortDisabledWarning=dataPortDisabledWarning, userName=userName, productName=productName, sMTPEmailAlert=sMTPEmailAlert, siteName=siteName, sNMPTrapTable=sNMPTrapTable, remoteMaximumTransmitPower=remoteMaximumTransmitPower, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ptmp=ptmp, vLANPriorityTableEntry=vLANPriorityTableEntry, receiveModulationModeDetail=receiveModulationModeDetail, vLANManagementPriority=vLANManagementPriority, hardwareVersion=hardwareVersion, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, linkModeOptimisation=linkModeOptimisation, telecomsLoopback=telecomsLoopback, syslogControlGroup=syslogControlGroup, remoteIPAddress=remoteIPAddress, tFTPServerPortNumber=tFTPServerPortNumber, ptp500=ptp500, transmitDataRate=transmitDataRate, telecomGroup=telecomGroup, pubStats=pubStats, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptp=ptp, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, supplementaryGroup=supplementaryGroup, syslogStateTrap=syslogStateTrap, sNMPEnabledTraps=sNMPEnabledTraps, telnetPortNumber=telnetPortNumber, aggregateDataRate=aggregateDataRate, transmitChannel=transmitChannel, secondarySoftwareVersion=secondarySoftwareVersion, ethernetFiberSupport=ethernetFiberSupport, hTTPSAccessEnabled=hTTPSAccessEnabled, encryption=encryption, sNTPSync=sNTPSync, syslogClient=syslogClient, encryptionAlgorithm=encryptionAlgorithm, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, smtp=smtp, smtpGroup=smtpGroup, linkName=linkName, daylightSaving=daylightSaving, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, alarmsGroup=alarmsGroup, capacityLicenseMismatch=capacityLicenseMismatch, syslogState=syslogState, aAAControlGroup=aAAControlGroup, configuration=configuration, receiveModulationMode=receiveModulationMode, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, resetGroup=resetGroup, syslogControl=syslogControl, receiveChannel=receiveChannel, groupID=groupID, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dfsTableNumber=dfsTableNumber, bandwidthVariant=bandwidthVariant, syslogClientTrap=syslogClientTrap, hTTPSPortNumber=hTTPSPortNumber, dfsTableIndex=dfsTableIndex, installStatusTrap=installStatusTrap, ptpTraps=ptpTraps, sNTPLastSync=sNTPLastSync, dataPortAutoMdix=dataPortAutoMdix, tDDControl=tDDControl, dataPortConfigurationMismatch=dataPortConfigurationMismatch, userTableIndex=userTableIndex, sNTPServerIPAddress=sNTPServerIPAddress, snmpControl=snmpControl, userRole=userRole, regionCodeTrap=regionCodeTrap, sntpGroup=sntpGroup, phyControl=phyControl, vLANPriorityTableIndex=vLANPriorityTableIndex, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPServerPortNumber=sNTPServerPortNumber, management=management, versions=versions, userTable=userTable, licence=licence, dfs=dfs, sMTPEnabledMessages=sMTPEnabledMessages, telecomsChannelStatusTrap=telecomsChannelStatusTrap, range=range, telecomsLoopbackTrap=telecomsLoopbackTrap, tFTPServerIPAddress=tFTPServerIPAddress, receiveFreqMHz=receiveFreqMHz, tDDSynchronizationAlarm=tDDSynchronizationAlarm, softwareVersion=softwareVersion, ethernetGroup=ethernetGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPState=sNTPState, licensedCapacity=licensedCapacity, dfsTableEntry=dfsTableEntry, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, supplementary=supplementary, systemReset=systemReset, altitude=altitude, longitude=longitude, telecomsInterface=telecomsInterface, dfsTable=dfsTable, installArmState=installArmState, linkSymmetry=linkSymmetry, iPAddress=iPAddress, installStatus=installStatus, managementGroup=managementGroup, transmitFreqMHz=transmitFreqMHz, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, userPassword=userPassword, useVLANForManagementInterfaces=useVLANForManagementInterfaces, noWirelessChannelAvailable=noWirelessChannelAvailable, unitOutOfCalibration=unitOutOfCalibration, tDDSynchronizationMode=tDDSynchronizationMode, eIRP=eIRP, dataPortStatus=dataPortStatus, timeZone=timeZone, dataPortWirelessDownAlert=dataPortWirelessDownAlert, configurationGroup=configurationGroup, ptpGroups=ptpGroups, linkModeOptimizationMismatch=linkModeOptimizationMismatch, snmpControlGroup=snmpControlGroup, dfsGroup=dfsGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, signalStrengthRatio=signalStrengthRatio, systemClock=systemClock, vLANPriorityTable=vLANPriorityTable, channelChangeTrap=channelChangeTrap, channelBandwidth=channelBandwidth, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPPollInterval=sNTPPollInterval, PYSNMP_MODULE_ID=cambium, versionsGroup=versionsGroup, gatewayIPAddress=gatewayIPAddress, telecomsLineCode=telecomsLineCode, targetMACAddress=targetMACAddress, sNMPCommunityString=sNMPCommunityString, sNMPTrapVersion=sNMPTrapVersion, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, userTableNumber=userTableNumber, frequencyVariant=frequencyVariant, productVariant=productVariant, dfsPeaks=dfsPeaks, vLANPriorityTableNumber=vLANPriorityTableNumber, receiveFreqKHz=receiveFreqKHz, sNMPv3Enable=sNMPv3Enable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ethernet=ethernet, sntp=sntp, linkLoss=linkLoss, bootVersion=bootVersion, notificationsGroup=notificationsGroup, phyControlGroup=phyControlGroup, sNTPSyncTrap=sNTPSyncTrap, antennaGain=antennaGain, regionCode=regionCode, wirelessLinkStatus=wirelessLinkStatus, latitude=latitude, tDDControlGroup=tDDControlGroup, phyStatus=phyStatus, ptpTrapPrefix=ptpTrapPrefix, telecomsChannelStatus=telecomsChannelStatus, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, maximumTransmitPower=maximumTransmitPower, searchState=searchState, dataPortAutoNegotiation=dataPortAutoNegotiation, enabledDiagnosticAlarms=enabledDiagnosticAlarms, receivePower=receivePower, sMTPServerIPAddress=sMTPServerIPAddress, incompatibleRegionCodes=incompatibleRegionCodes, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, receiveDataRate=receiveDataRate, transmitFreqKHz=transmitFreqKHz, hTTPPortNumber=hTTPPortNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, wirelessLinkAvailability=wirelessLinkAvailability, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, transmitPower=transmitPower, subnetMask=subnetMask, vLANPriorityQueueMapping=vLANPriorityQueueMapping, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, telecomsCableLength=telecomsCableLength, telnetAccessEnabled=telnetAccessEnabled, aAAControl=aAAControl, userTableEntry=userTableEntry, dfsMeans=dfsMeans, sNMPPortNumber=sNMPPortNumber, masterSlaveMode=masterSlaveMode, sNMPTrapPortNumber=sNMPTrapPortNumber, phyStatusGroup=phyStatusGroup, accessMethod=accessMethod, byteErrorRatio=byteErrorRatio, installArmStateTrap=installArmStateTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, cambium=cambium, sNMPTrapTableIndex=sNMPTrapTableIndex, cableLoss=cableLoss, incompatibleMasterAndSlave=incompatibleMasterAndSlave)
