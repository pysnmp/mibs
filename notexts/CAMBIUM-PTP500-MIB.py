...
# Produced by pysmi-1.1.8 at Thu Jan  6 20:04:33 2022
...
Integer32, Counter32, TimeTicks, ObjectIdentity, Counter64, Unsigned32, ModuleIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, Bits, iso, Gauge32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "TimeTicks", "ObjectIdentity", "Counter64", "Unsigned32", "ModuleIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "Bits", "iso", "Gauge32", "enterprises")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", vectorError=vectorError, sntp=sntp, sNTPSyncTrap=sNTPSyncTrap, searchState=searchState, sMTPServerPortNumber=sMTPServerPortNumber, range=range, configurationGroup=configurationGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, antennaGain=antennaGain, alarmsGroup=alarmsGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, telecomsCableLength=telecomsCableLength, vLANPriorityTableEntry=vLANPriorityTableEntry, receiveChannel=receiveChannel, iPAddress=iPAddress, supplementaryGroup=supplementaryGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, remoteIPAddress=remoteIPAddress, altitude=altitude, sNTPLastSync=sNTPLastSync, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, systemReset=systemReset, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, telecomsInterface=telecomsInterface, transmitDataRate=transmitDataRate, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, syslogStateTrap=syslogStateTrap, syslogControl=syslogControl, telecomsLoopback=telecomsLoopback, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortAutoNegotiation=dataPortAutoNegotiation, syslogControlGroup=syslogControlGroup, licensedCapacity=licensedCapacity, hTTPSPortNumber=hTTPSPortNumber, sNTPServerIPAddress=sNTPServerIPAddress, cableLoss=cableLoss, receiveModulationModeDetail=receiveModulationModeDetail, ethernetGroup=ethernetGroup, installArmStateTrap=installArmStateTrap, subnetMask=subnetMask, productVariant=productVariant, phyStatusGroup=phyStatusGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, sNTPState=sNTPState, vLANManagementPriority=vLANManagementPriority, ptp=ptp, vLANManagementVID=vLANManagementVID, linkLoss=linkLoss, siteName=siteName, aAAControl=aAAControl, sNTPPollInterval=sNTPPollInterval, systemClock=systemClock, notificationsGroup=notificationsGroup, regionCodeTrap=regionCodeTrap, syslogClientTrap=syslogClientTrap, linkName=linkName, wirelessLinkStatus=wirelessLinkStatus, ptmp=ptmp, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogClient=syslogClient, versionsGroup=versionsGroup, telecomsChannelStatus=telecomsChannelStatus, snmpControlGroup=snmpControlGroup, smtp=smtp, receiveDataRate=receiveDataRate, userRole=userRole, transmitChannel=transmitChannel, incompatibleRegionCodes=incompatibleRegionCodes, userTableNumber=userTableNumber, ptpTrapPrefix=ptpTrapPrefix, receivePower=receivePower, sNMPCommunityString=sNMPCommunityString, sMTPEnabledMessages=sMTPEnabledMessages, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNMPTrapVersion=sNMPTrapVersion, hTTPPortNumber=hTTPPortNumber, phyControl=phyControl, bootVersion=bootVersion, dfs=dfs, tDDSynchronizationMode=tDDSynchronizationMode, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, receiveFreqMHz=receiveFreqMHz, sMTPServerIPAddress=sMTPServerIPAddress, capacityLicenseMismatch=capacityLicenseMismatch, sNMPTrapTable=sNMPTrapTable, daylightSaving=daylightSaving, dfsTable=dfsTable, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, byteErrorRatio=byteErrorRatio, productName=productName, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sntpGroup=sntpGroup, sNTPServerPortNumber=sNTPServerPortNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, userPassword=userPassword, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, transmitModulationMode=transmitModulationMode, vLANPriorityTableIndex=vLANPriorityTableIndex, linkModeOptimisation=linkModeOptimisation, ethernet=ethernet, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortStatus=dataPortStatus, transmitFreqMHz=transmitFreqMHz, encryptionAlgorithm=encryptionAlgorithm, userTableEntry=userTableEntry, syslogState=syslogState, accessMethod=accessMethod, tFTPServerPortNumber=tFTPServerPortNumber, telecomsLoopbackTrap=telecomsLoopbackTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dfsGroup=dfsGroup, transmitFreqKHz=transmitFreqKHz, wirelessLinkAvailability=wirelessLinkAvailability, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, secondarySoftwareVersion=secondarySoftwareVersion, frequencyVariant=frequencyVariant, linkSymmetry=linkSymmetry, masterSlaveMode=masterSlaveMode, softwareVersion=softwareVersion, tDDSynchronizationStatus=tDDSynchronizationStatus, telecomGroup=telecomGroup, receiveFreqKHz=receiveFreqKHz, latitude=latitude, targetMACAddress=targetMACAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dfsTableEntry=dfsTableEntry, userTable=userTable, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dataPortAutoMdix=dataPortAutoMdix, longitude=longitude, enabledDiagnosticAlarms=enabledDiagnosticAlarms, gatewayIPAddress=gatewayIPAddress, managementGroup=managementGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, tDDControl=tDDControl, aggregateDataRate=aggregateDataRate, hardwareVersion=hardwareVersion, hTTPSAccessEnabled=hTTPSAccessEnabled, ptp500=ptp500, userTableIndex=userTableIndex, encryption=encryption, useVLANForManagementInterfaces=useVLANForManagementInterfaces, smtpGroup=smtpGroup, signalStrengthRatio=signalStrengthRatio, dfsMeans=dfsMeans, eIRP=eIRP, snmpControl=snmpControl, installArmState=installArmState, PYSNMP_MODULE_ID=cambium, telnetAccessEnabled=telnetAccessEnabled, cambium=cambium, ethernetFiberSupport=ethernetFiberSupport, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPSync=sNTPSync, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, phyControlGroup=phyControlGroup, aAAControlGroup=aAAControlGroup, sNMPv3Enable=sNMPv3Enable, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPTrapTableIndex=sNMPTrapTableIndex, receiveModulationMode=receiveModulationMode, timeZone=timeZone, telecomsLineCode=telecomsLineCode, pubStats=pubStats, dfsTableNumber=dfsTableNumber, vLANPriorityTable=vLANPriorityTable, regionCode=regionCode, dfsTableIndex=dfsTableIndex, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dataPortDisabledWarning=dataPortDisabledWarning, telnetPortNumber=telnetPortNumber, userName=userName, syslogLocalWrappedTrap=syslogLocalWrappedTrap, bandwidthVariant=bandwidthVariant, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, pubStatsGroup=pubStatsGroup, ptpTraps=ptpTraps, configuration=configuration, hTTPAccessEnabled=hTTPAccessEnabled, sNMPTrapTableNumber=sNMPTrapTableNumber, userEnabled=userEnabled, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, resetGroup=resetGroup, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortStatusTrap=dataPortStatusTrap, groupID=groupID, transmitPower=transmitPower, channelBandwidth=channelBandwidth, telecomsChannelStatusTrap=telecomsChannelStatusTrap, licenceGroup=licenceGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, telecom=telecom, sNMPPortNumber=sNMPPortNumber, ptpCompliance=ptpCompliance, dfsPeaks=dfsPeaks, maximumTransmitPower=maximumTransmitPower, installStatus=installStatus, installStatusTrap=installStatusTrap, unitOutOfCalibration=unitOutOfCalibration, tFTPServerIPAddress=tFTPServerIPAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, supplementary=supplementary, encryptionGroup=encryptionGroup, licence=licence, vLANPriorityTableNumber=vLANPriorityTableNumber, sMTPEmailAlert=sMTPEmailAlert, remoteMaximumTransmitPower=remoteMaximumTransmitPower, channelChangeTrap=channelChangeTrap, tDDControlGroup=tDDControlGroup, ptpGroups=ptpGroups, reset=reset, alarms=alarms, versions=versions, management=management, phyStatus=phyStatus)
