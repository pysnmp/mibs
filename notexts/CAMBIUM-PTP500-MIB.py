...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", receiveDataRate=receiveDataRate, vLANPriorityTableIndex=vLANPriorityTableIndex, sMTPServerPortNumber=sMTPServerPortNumber, vLANPriorityTableNumber=vLANPriorityTableNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, receiveModulationMode=receiveModulationMode, licenceGroup=licenceGroup, sMTPEmailAlert=sMTPEmailAlert, ethernetGroup=ethernetGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPv3Enable=sNMPv3Enable, dfsPeaks=dfsPeaks, phyControl=phyControl, noWirelessChannelAvailable=noWirelessChannelAvailable, licensedCapacity=licensedCapacity, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapTableEntry=sNMPTrapTableEntry, groupID=groupID, management=management, telecomsLineCode=telecomsLineCode, dfsMeans=dfsMeans, receiveFreqMHz=receiveFreqMHz, cambium=cambium, remoteMaximumTransmitPower=remoteMaximumTransmitPower, aAAControlGroup=aAAControlGroup, gatewayIPAddress=gatewayIPAddress, cableLoss=cableLoss, bootVersion=bootVersion, hTTPSPortNumber=hTTPSPortNumber, transmitDataRate=transmitDataRate, ptp500=ptp500, softwareVersion=softwareVersion, syslogStateTrap=syslogStateTrap, userTableEntry=userTableEntry, unitOutOfCalibration=unitOutOfCalibration, sNTPSync=sNTPSync, incompatibleRegionCodes=incompatibleRegionCodes, sNMPTrapTable=sNMPTrapTable, sNMPTrapTableNumber=sNMPTrapTableNumber, masterSlaveMode=masterSlaveMode, productName=productName, hTTPPortNumber=hTTPPortNumber, sNTPPollInterval=sNTPPollInterval, ethernetFiberSupport=ethernetFiberSupport, wirelessLinkStatus=wirelessLinkStatus, accessMethod=accessMethod, dataPortStatus=dataPortStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, vectorError=vectorError, tDDSynchronizationAlarm=tDDSynchronizationAlarm, configuration=configuration, transmitFreqMHz=transmitFreqMHz, installArmStateTrap=installArmStateTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, incompatibleMasterAndSlave=incompatibleMasterAndSlave, supplementaryGroup=supplementaryGroup, subnetMask=subnetMask, telecomsLoopbackTrap=telecomsLoopbackTrap, ethernet=ethernet, smtp=smtp, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tFTPServerIPAddress=tFTPServerIPAddress, systemReset=systemReset, ptpCompliance=ptpCompliance, linkSymmetry=linkSymmetry, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ptpGroups=ptpGroups, vLANPriorityQueueMapping=vLANPriorityQueueMapping, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, receivePower=receivePower, dfsTable=dfsTable, userTableNumber=userTableNumber, sNTPLastSync=sNTPLastSync, vLANManagementVID=vLANManagementVID, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, linkLoss=linkLoss, syslogState=syslogState, vLANPriorityTable=vLANPriorityTable, installArmState=installArmState, range=range, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, syslogControl=syslogControl, syslogControlGroup=syslogControlGroup, ptpTrapPrefix=ptpTrapPrefix, aggregateDataRate=aggregateDataRate, eIRP=eIRP, productVariant=productVariant, ptmp=ptmp, smtpGroup=smtpGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, telecomGroup=telecomGroup, channelBandwidth=channelBandwidth, installStatusTrap=installStatusTrap, userPassword=userPassword, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, regionCode=regionCode, dfs=dfs, bandwidthVariant=bandwidthVariant, daylightSaving=daylightSaving, remoteIPAddress=remoteIPAddress, supplementary=supplementary, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, alarms=alarms, userTable=userTable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, frequencyVariant=frequencyVariant, transmitFreqKHz=transmitFreqKHz, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, channelChangeTrap=channelChangeTrap, ptp=ptp, vLANManagementPriority=vLANManagementPriority, targetMACAddress=targetMACAddress, receiveModulationModeDetail=receiveModulationModeDetail, telecomsInterface=telecomsInterface, timeZone=timeZone, searchState=searchState, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, antennaGain=antennaGain, wirelessLinkAvailability=wirelessLinkAvailability, hTTPSAccessEnabled=hTTPSAccessEnabled, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, secondarySoftwareVersion=secondarySoftwareVersion, aAAControl=aAAControl, tFTPServerPortNumber=tFTPServerPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, licence=licence, sMTPServerIPAddress=sMTPServerIPAddress, sNMPEnabledTraps=sNMPEnabledTraps, longitude=longitude, reset=reset, managementGroup=managementGroup, pubStats=pubStats, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapVersion=sNMPTrapVersion, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, vLANPriorityTableEntry=vLANPriorityTableEntry, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, versions=versions, configurationGroup=configurationGroup, iPAddress=iPAddress, sNTPSyncTrap=sNTPSyncTrap, notificationsGroup=notificationsGroup, maximumTransmitPower=maximumTransmitPower, sntp=sntp, syslogClientTrap=syslogClientTrap, sNMPCommunityString=sNMPCommunityString, hTTPAccessEnabled=hTTPAccessEnabled, transmitChannel=transmitChannel, sMTPEnabledMessages=sMTPEnabledMessages, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, userEnabled=userEnabled, sntpGroup=sntpGroup, telnetPortNumber=telnetPortNumber, dataPortDisabledWarning=dataPortDisabledWarning, sNTPServerPortNumber=sNTPServerPortNumber, userName=userName, dataPortStatusTrap=dataPortStatusTrap, snmpControlGroup=snmpControlGroup, tDDControl=tDDControl, signalStrengthRatio=signalStrengthRatio, phyControlGroup=phyControlGroup, transmitPower=transmitPower, dfsGroup=dfsGroup, sNTPServerIPAddress=sNTPServerIPAddress, tDDControlGroup=tDDControlGroup, telecom=telecom, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, systemClock=systemClock, telecomsLoopback=telecomsLoopback, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, PYSNMP_MODULE_ID=cambium, dataPortWirelessDownAlert=dataPortWirelessDownAlert, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, userRole=userRole, syslogClient=syslogClient, receiveChannel=receiveChannel, snmpControl=snmpControl, resetGroup=resetGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, hardwareVersion=hardwareVersion, sNTPState=sNTPState, dataPortAutoMdix=dataPortAutoMdix, versionsGroup=versionsGroup, dfsTableEntry=dfsTableEntry, pubStatsGroup=pubStatsGroup, phyStatusGroup=phyStatusGroup, phyStatus=phyStatus, alarmsGroup=alarmsGroup, sNMPPortNumber=sNMPPortNumber, altitude=altitude, linkName=linkName, telnetAccessEnabled=telnetAccessEnabled, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dfsTableIndex=dfsTableIndex, encryptionGroup=encryptionGroup, userTableIndex=userTableIndex, ptpTraps=ptpTraps, dfsTableNumber=dfsTableNumber, encryption=encryption, siteName=siteName, linkModeOptimisation=linkModeOptimisation, receiveFreqKHz=receiveFreqKHz, regionCodeTrap=regionCodeTrap, tDDSynchronizationMode=tDDSynchronizationMode, telecomsChannelStatus=telecomsChannelStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, transmitModulationMode=transmitModulationMode, telecomsCableLength=telecomsCableLength, installStatus=installStatus, byteErrorRatio=byteErrorRatio, latitude=latitude, encryptionAlgorithm=encryptionAlgorithm, capacityLicenseMismatch=capacityLicenseMismatch)
