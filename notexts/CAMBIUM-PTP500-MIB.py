...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", telecomGroup=telecomGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, hTTPSPortNumber=hTTPSPortNumber, dfsPeaks=dfsPeaks, antennaGain=antennaGain, transmitChannel=transmitChannel, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, receivePower=receivePower, userTableNumber=userTableNumber, vLANPriorityTable=vLANPriorityTable, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, resetGroup=resetGroup, receiveDataRate=receiveDataRate, userName=userName, installStatusTrap=installStatusTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, syslogState=syslogState, configurationGroup=configurationGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, vLANPriorityTableNumber=vLANPriorityTableNumber, dfsTableEntry=dfsTableEntry, dataPortStatus=dataPortStatus, installArmState=installArmState, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, snmpControlGroup=snmpControlGroup, unitOutOfCalibration=unitOutOfCalibration, latitude=latitude, dataPortDisabledWarning=dataPortDisabledWarning, sNMPv3Enable=sNMPv3Enable, regionCode=regionCode, tFTPServerIPAddress=tFTPServerIPAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, telecomsInterface=telecomsInterface, phyStatusGroup=phyStatusGroup, cambium=cambium, dfsTableNumber=dfsTableNumber, groupID=groupID, sNTPServerPortNumber=sNTPServerPortNumber, tDDSynchronizationMode=tDDSynchronizationMode, sNMPTrapTable=sNMPTrapTable, telecomsLoopbackTrap=telecomsLoopbackTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, receiveFreqMHz=receiveFreqMHz, ptmp=ptmp, telnetAccessEnabled=telnetAccessEnabled, byteErrorRatio=byteErrorRatio, linkModeOptimisation=linkModeOptimisation, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortStatusTrap=dataPortStatusTrap, syslogClientTrap=syslogClientTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, frequencyVariant=frequencyVariant, vectorError=vectorError, softwareVersion=softwareVersion, timeZone=timeZone, installStatus=installStatus, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, pubStatsGroup=pubStatsGroup, configuration=configuration, smtp=smtp, sNMPTrapTableEntry=sNMPTrapTableEntry, licenceGroup=licenceGroup, vLANManagementPriority=vLANManagementPriority, ethernetGroup=ethernetGroup, daylightSaving=daylightSaving, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dfsTableIndex=dfsTableIndex, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, licensedCapacity=licensedCapacity, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPEnabledTraps=sNMPEnabledTraps, syslogControl=syslogControl, userTableEntry=userTableEntry, ptp=ptp, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, bandwidthVariant=bandwidthVariant, accessMethod=accessMethod, productName=productName, management=management, incompatibleRegionCodes=incompatibleRegionCodes, telnetPortNumber=telnetPortNumber, telecomsLineCode=telecomsLineCode, hardwareVersion=hardwareVersion, sNTPServerIPAddress=sNTPServerIPAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, pubStats=pubStats, tDDControlGroup=tDDControlGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, PYSNMP_MODULE_ID=cambium, sNTPState=sNTPState, transmitFreqKHz=transmitFreqKHz, sntpGroup=sntpGroup, subnetMask=subnetMask, tDDControl=tDDControl, phyControlGroup=phyControlGroup, maximumTransmitPower=maximumTransmitPower, aAAControl=aAAControl, sNMPTrapVersion=sNMPTrapVersion, sMTPSourceEmailAddress=sMTPSourceEmailAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, hTTPSAccessEnabled=hTTPSAccessEnabled, encryptionGroup=encryptionGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, dfsTable=dfsTable, sNMPCommunityString=sNMPCommunityString, channelChangeTrap=channelChangeTrap, alarmsGroup=alarmsGroup, sNTPPollInterval=sNTPPollInterval, siteName=siteName, encryptionAlgorithm=encryptionAlgorithm, userTableIndex=userTableIndex, reset=reset, versions=versions, userRole=userRole, longitude=longitude, transmitPower=transmitPower, installArmStateTrap=installArmStateTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, snmpControl=snmpControl, eIRP=eIRP, receiveModulationModeDetail=receiveModulationModeDetail, ptpCompliance=ptpCompliance, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ptpTrapPrefix=ptpTrapPrefix, linkModeOptimizationMismatch=linkModeOptimizationMismatch, ptpGroups=ptpGroups, telecomsChannelStatusTrap=telecomsChannelStatusTrap, encryption=encryption, userTable=userTable, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sMTPEnabledMessages=sMTPEnabledMessages, smtpGroup=smtpGroup, phyStatus=phyStatus, ptpTraps=ptpTraps, managementGroup=managementGroup, aAAControlGroup=aAAControlGroup, tFTPServerPortNumber=tFTPServerPortNumber, userEnabled=userEnabled, ptp500=ptp500, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sMTPEmailAlert=sMTPEmailAlert, secondarySoftwareVersion=secondarySoftwareVersion, receiveFreqKHz=receiveFreqKHz, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPPortNumber=sNMPPortNumber, gatewayIPAddress=gatewayIPAddress, bootVersion=bootVersion, enabledDiagnosticAlarms=enabledDiagnosticAlarms, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, aggregateDataRate=aggregateDataRate, masterSlaveMode=masterSlaveMode, channelBandwidth=channelBandwidth, telecomsChannelStatus=telecomsChannelStatus, capacityLicenseMismatch=capacityLicenseMismatch, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, targetMACAddress=targetMACAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, receiveModulationMode=receiveModulationMode, sNTPLastSync=sNTPLastSync, ethernet=ethernet, range=range, transmitFreqMHz=transmitFreqMHz, cableLoss=cableLoss, transmitDataRate=transmitDataRate, syslogClient=syslogClient, dfsMeans=dfsMeans, productVariant=productVariant, systemClock=systemClock, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkName=linkName, receiveChannel=receiveChannel, telecomsLoopback=telecomsLoopback, sNTPSyncTrap=sNTPSyncTrap, sNTPSync=sNTPSync, hTTPAccessEnabled=hTTPAccessEnabled, versionsGroup=versionsGroup, supplementary=supplementary, linkSymmetry=linkSymmetry, wirelessLinkAvailability=wirelessLinkAvailability, syslogStateTrap=syslogStateTrap, dfs=dfs, hTTPPortNumber=hTTPPortNumber, iPAddress=iPAddress, ethernetFiberSupport=ethernetFiberSupport, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, regionCodeTrap=regionCodeTrap, telecom=telecom, searchState=searchState, systemReset=systemReset, sntp=sntp, linkLoss=linkLoss, tDDSynchronizationStatus=tDDSynchronizationStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, userPassword=userPassword, remoteIPAddress=remoteIPAddress, sMTPServerIPAddress=sMTPServerIPAddress, syslogControlGroup=syslogControlGroup, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, wirelessLinkStatus=wirelessLinkStatus, dataPortAutoNegotiation=dataPortAutoNegotiation, tDDSynchronizationAlarm=tDDSynchronizationAlarm, phyControl=phyControl, telecomsCableLength=telecomsCableLength, vLANPriorityTableEntry=vLANPriorityTableEntry, dataPortAutoMdix=dataPortAutoMdix, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dfsGroup=dfsGroup, transmitModulationMode=transmitModulationMode, supplementaryGroup=supplementaryGroup, licence=licence, sNMPTrapTableIndex=sNMPTrapTableIndex, alarms=alarms, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, notificationsGroup=notificationsGroup, vLANManagementVID=vLANManagementVID, signalStrengthRatio=signalStrengthRatio, altitude=altitude)
