...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", PYSNMP_MODULE_ID=cambium, range=range, syslogStateTrap=syslogStateTrap, syslogState=syslogState, ethernetFiberSupport=ethernetFiberSupport, aAAControl=aAAControl, reset=reset, latitude=latitude, phyStatusGroup=phyStatusGroup, receiveChannel=receiveChannel, userPassword=userPassword, incompatibleRegionCodes=incompatibleRegionCodes, ethernetGroup=ethernetGroup, licensedCapacity=licensedCapacity, wirelessLinkStatus=wirelessLinkStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, versions=versions, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ptpTrapPrefix=ptpTrapPrefix, phyControl=phyControl, receiveModulationModeDetail=receiveModulationModeDetail, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, cableLoss=cableLoss, hTTPPortNumber=hTTPPortNumber, smtpGroup=smtpGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, installStatus=installStatus, sNTPLastSync=sNTPLastSync, secondarySoftwareVersion=secondarySoftwareVersion, telecom=telecom, dfsGroup=dfsGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, installStatusTrap=installStatusTrap, telecomsCableLength=telecomsCableLength, transmitChannel=transmitChannel, telecomsLoopback=telecomsLoopback, groupID=groupID, systemClock=systemClock, encryptionGroup=encryptionGroup, maximumTransmitPower=maximumTransmitPower, syslogClient=syslogClient, hTTPAccessEnabled=hTTPAccessEnabled, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, bootVersion=bootVersion, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsTableNumber=dfsTableNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, aggregateDataRate=aggregateDataRate, snmpControlGroup=snmpControlGroup, ptmp=ptmp, vLANPriorityTableEntry=vLANPriorityTableEntry, sNMPTrapTable=sNMPTrapTable, telnetPortNumber=telnetPortNumber, ptp500=ptp500, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPSyncTrap=sNTPSyncTrap, userEnabled=userEnabled, syslogClientTrap=syslogClientTrap, managementGroup=managementGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, telecomsChannelStatus=telecomsChannelStatus, channelBandwidth=channelBandwidth, userTable=userTable, snmpControl=snmpControl, dfs=dfs, iPAddress=iPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, notificationsGroup=notificationsGroup, dfsMeans=dfsMeans, transmitFreqKHz=transmitFreqKHz, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPEnabledTraps=sNMPEnabledTraps, enabledDiagnosticAlarms=enabledDiagnosticAlarms, receiveFreqMHz=receiveFreqMHz, cambium=cambium, capacityLicenseMismatch=capacityLicenseMismatch, tDDControlGroup=tDDControlGroup, telnetAccessEnabled=telnetAccessEnabled, eIRP=eIRP, daylightSaving=daylightSaving, pubStats=pubStats, telecomsInterface=telecomsInterface, tDDSynchronizationAlarm=tDDSynchronizationAlarm, userTableIndex=userTableIndex, sntpGroup=sntpGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, regionCode=regionCode, frequencyVariant=frequencyVariant, hardwareVersion=hardwareVersion, dfsTable=dfsTable, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPState=sNTPState, phyControlGroup=phyControlGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, timeZone=timeZone, sMTPEmailAlert=sMTPEmailAlert, sNTPServerIPAddress=sNTPServerIPAddress, transmitModulationMode=transmitModulationMode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, constantPowerSpectralDensity=constantPowerSpectralDensity, syslogControl=syslogControl, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dataPortAutoNegotiation=dataPortAutoNegotiation, installArmState=installArmState, vLANPriorityTable=vLANPriorityTable, sNMPTrapVersion=sNMPTrapVersion, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, resetGroup=resetGroup, userTableNumber=userTableNumber, productVariant=productVariant, versionsGroup=versionsGroup, installArmStateTrap=installArmStateTrap, sNTPSync=sNTPSync, sMTPServerIPAddress=sMTPServerIPAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, antennaGain=antennaGain, sMTPServerPortNumber=sMTPServerPortNumber, sNTPPollInterval=sNTPPollInterval, remoteIPAddress=remoteIPAddress, byteErrorRatio=byteErrorRatio, wirelessLinkAvailability=wirelessLinkAvailability, accessMethod=accessMethod, tDDControl=tDDControl, sNMPTrapPortNumber=sNMPTrapPortNumber, siteName=siteName, dataPortAutoMdix=dataPortAutoMdix, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, encryption=encryption, systemReset=systemReset, supplementary=supplementary, syslogControlGroup=syslogControlGroup, vLANManagementVID=vLANManagementVID, gatewayIPAddress=gatewayIPAddress, sMTPEnabledMessages=sMTPEnabledMessages, masterSlaveMode=masterSlaveMode, alarmsGroup=alarmsGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortDisabledWarning=dataPortDisabledWarning, receiveDataRate=receiveDataRate, linkName=linkName, telecomsLineCode=telecomsLineCode, linkLoss=linkLoss, supplementaryGroup=supplementaryGroup, phyStatus=phyStatus, ethernet=ethernet, vLANPriorityQueueMapping=vLANPriorityQueueMapping, bandwidthVariant=bandwidthVariant, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPCommunityString=sNMPCommunityString, sNTPServerPortNumber=sNTPServerPortNumber, sNMPPortNumber=sNMPPortNumber, transmitFreqMHz=transmitFreqMHz, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, dfsTableIndex=dfsTableIndex, sMTPSourceEmailAddress=sMTPSourceEmailAddress, channelChangeTrap=channelChangeTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, receiveFreqKHz=receiveFreqKHz, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ptpCompliance=ptpCompliance, productName=productName, ptp=ptp, userName=userName, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, management=management, ptpTraps=ptpTraps, ptpGroups=ptpGroups, licence=licence, syslogLocalWrappedTrap=syslogLocalWrappedTrap, signalStrengthRatio=signalStrengthRatio, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, hTTPSAccessEnabled=hTTPSAccessEnabled, dfsPeaks=dfsPeaks, subnetMask=subnetMask, unitOutOfCalibration=unitOutOfCalibration, softwareVersion=softwareVersion, targetMACAddress=targetMACAddress, tFTPServerIPAddress=tFTPServerIPAddress, transmitDataRate=transmitDataRate, transmitPower=transmitPower, aAAControlGroup=aAAControlGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, configurationGroup=configurationGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sntp=sntp, longitude=longitude, vLANPriorityTableIndex=vLANPriorityTableIndex, dataPortWirelessDownAlert=dataPortWirelessDownAlert, licenceGroup=licenceGroup, userTableEntry=userTableEntry, telecomGroup=telecomGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsTableEntry=dfsTableEntry, smtp=smtp, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortStatusTrap=dataPortStatusTrap, linkSymmetry=linkSymmetry, receivePower=receivePower, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, hTTPSPortNumber=hTTPSPortNumber, vLANManagementPriority=vLANManagementPriority, vectorError=vectorError, linkModeOptimisation=linkModeOptimisation, encryptionAlgorithm=encryptionAlgorithm, tFTPServerPortNumber=tFTPServerPortNumber, sNMPv3Enable=sNMPv3Enable, altitude=altitude, regionCodeTrap=regionCodeTrap, dataPortStatus=dataPortStatus, receiveModulationMode=receiveModulationMode, tDDSynchronizationMode=tDDSynchronizationMode, telecomsChannelStatusTrap=telecomsChannelStatusTrap, configuration=configuration, alarms=alarms, userRole=userRole, pubStatsGroup=pubStatsGroup, searchState=searchState)
