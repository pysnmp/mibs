...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ptp=ptp, syslogControlGroup=syslogControlGroup, groupID=groupID, systemClock=systemClock, userPassword=userPassword, vectorError=vectorError, installArmState=installArmState, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, channelBandwidth=channelBandwidth, transmitDataRate=transmitDataRate, searchState=searchState, regionCode=regionCode, receivePower=receivePower, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapTableEntry=sNMPTrapTableEntry, ethernet=ethernet, pubStatsGroup=pubStatsGroup, userEnabled=userEnabled, regionCodeTrap=regionCodeTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telecomsChannelStatus=telecomsChannelStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNTPLastSync=sNTPLastSync, transmitFreqMHz=transmitFreqMHz, supplementary=supplementary, telecom=telecom, snmpControl=snmpControl, vLANPriorityTableIndex=vLANPriorityTableIndex, sNTPServerIPAddress=sNTPServerIPAddress, linkSymmetry=linkSymmetry, sNMPEnabledTraps=sNMPEnabledTraps, configuration=configuration, productVariant=productVariant, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tDDControl=tDDControl, aAAControl=aAAControl, incompatibleMasterAndSlave=incompatibleMasterAndSlave, altitude=altitude, phyStatusGroup=phyStatusGroup, incompatibleRegionCodes=incompatibleRegionCodes, frequencyVariant=frequencyVariant, ptpCompliance=ptpCompliance, syslogStateTrap=syslogStateTrap, gatewayIPAddress=gatewayIPAddress, eIRP=eIRP, sNTPServerPortNumber=sNTPServerPortNumber, sNTPSync=sNTPSync, linkName=linkName, wirelessLinkStatus=wirelessLinkStatus, snmpControlGroup=snmpControlGroup, bandwidthVariant=bandwidthVariant, signalStrengthRatio=signalStrengthRatio, dfsPeaks=dfsPeaks, vLANManagementVID=vLANManagementVID, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ptpTraps=ptpTraps, dfsTableEntry=dfsTableEntry, telecomsInterface=telecomsInterface, userTableIndex=userTableIndex, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, productName=productName, phyControlGroup=phyControlGroup, phyStatus=phyStatus, sNMPCommunityString=sNMPCommunityString, siteName=siteName, antennaGain=antennaGain, hTTPAccessEnabled=hTTPAccessEnabled, sNMPTrapPortNumber=sNMPTrapPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, userRole=userRole, installArmStateTrap=installArmStateTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, smtpGroup=smtpGroup, userTableNumber=userTableNumber, dfsMeans=dfsMeans, receiveModulationMode=receiveModulationMode, sNMPTrapTableNumber=sNMPTrapTableNumber, telecomsLoopbackTrap=telecomsLoopbackTrap, maximumTransmitPower=maximumTransmitPower, vLANManagementPriority=vLANManagementPriority, smtp=smtp, managementGroup=managementGroup, telecomsCableLength=telecomsCableLength, accessMethod=accessMethod, ethernetGroup=ethernetGroup, range=range, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPPollInterval=sNTPPollInterval, telecomsLineCode=telecomsLineCode, receiveChannel=receiveChannel, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, hTTPSPortNumber=hTTPSPortNumber, installStatusTrap=installStatusTrap, licensedCapacity=licensedCapacity, dataPortStatusTrap=dataPortStatusTrap, sntp=sntp, iPAddress=iPAddress, ptmp=ptmp, vLANPriorityQueueMapping=vLANPriorityQueueMapping, telecomsLoopback=telecomsLoopback, sNMPv3Enable=sNMPv3Enable, sNTPState=sNTPState, receiveModulationModeDetail=receiveModulationModeDetail, linkModeOptimizationMismatch=linkModeOptimizationMismatch, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, reset=reset, versions=versions, telecomGroup=telecomGroup, sNMPTrapTable=sNMPTrapTable, daylightSaving=daylightSaving, channelChangeTrap=channelChangeTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, syslogClientTrap=syslogClientTrap, licence=licence, licenceGroup=licenceGroup, remoteIPAddress=remoteIPAddress, sntpGroup=sntpGroup, pubStats=pubStats, supplementaryGroup=supplementaryGroup, syslogState=syslogState, PYSNMP_MODULE_ID=cambium, aAAControlGroup=aAAControlGroup, dfsTable=dfsTable, dataPortDisabledWarning=dataPortDisabledWarning, linkLoss=linkLoss, encryptionAlgorithm=encryptionAlgorithm, dataPortStatus=dataPortStatus, transmitFreqKHz=transmitFreqKHz, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, phyControl=phyControl, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, hTTPSAccessEnabled=hTTPSAccessEnabled, tFTPServerPortNumber=tFTPServerPortNumber, telecomsChannelStatusTrap=telecomsChannelStatusTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, receiveFreqMHz=receiveFreqMHz, sNMPPortNumber=sNMPPortNumber, sNTPSyncTrap=sNTPSyncTrap, syslogControl=syslogControl, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ptpTrapPrefix=ptpTrapPrefix, encryption=encryption, vLANPriorityTableNumber=vLANPriorityTableNumber, transmitPower=transmitPower, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, cambium=cambium, telnetPortNumber=telnetPortNumber, alarmsGroup=alarmsGroup, hardwareVersion=hardwareVersion, userTable=userTable, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, vLANPriorityTable=vLANPriorityTable, softwareVersion=softwareVersion, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, management=management, configurationGroup=configurationGroup, tFTPServerIPAddress=tFTPServerIPAddress, userName=userName, telnetAccessEnabled=telnetAccessEnabled, ptp500=ptp500, alarms=alarms, tDDControlGroup=tDDControlGroup, installStatus=installStatus, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dfsTableNumber=dfsTableNumber, cableLoss=cableLoss, bootVersion=bootVersion, timeZone=timeZone, enabledDiagnosticAlarms=enabledDiagnosticAlarms, unitOutOfCalibration=unitOutOfCalibration, sMTPEmailAlert=sMTPEmailAlert, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dfs=dfs, targetMACAddress=targetMACAddress, dfsGroup=dfsGroup, tDDSynchronizationMode=tDDSynchronizationMode, dataPortAutoMdix=dataPortAutoMdix, dfsTableIndex=dfsTableIndex, masterSlaveMode=masterSlaveMode, transmitChannel=transmitChannel, latitude=latitude, sMTPSourceEmailAddress=sMTPSourceEmailAddress, linkModeOptimisation=linkModeOptimisation, capacityLicenseMismatch=capacityLicenseMismatch, resetGroup=resetGroup, userTableEntry=userTableEntry, syslogClient=syslogClient, subnetMask=subnetMask, sMTPEnabledMessages=sMTPEnabledMessages, systemReset=systemReset, receiveDataRate=receiveDataRate, encryptionGroup=encryptionGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, hTTPPortNumber=hTTPPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, sMTPServerPortNumber=sMTPServerPortNumber, versionsGroup=versionsGroup, sMTPServerIPAddress=sMTPServerIPAddress, byteErrorRatio=byteErrorRatio, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, wirelessLinkAvailability=wirelessLinkAvailability, ptpGroups=ptpGroups, receiveFreqKHz=receiveFreqKHz, longitude=longitude, ethernetFiberSupport=ethernetFiberSupport, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitModulationMode=transmitModulationMode, notificationsGroup=notificationsGroup, aggregateDataRate=aggregateDataRate)
