...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", subnetMask=subnetMask, hardwareVersion=hardwareVersion, dataPortConfigurationMismatch=dataPortConfigurationMismatch, ptmp=ptmp, sNTPSyncTrap=sNTPSyncTrap, installArmStateTrap=installArmStateTrap, installStatusTrap=installStatusTrap, sNMPTrapTable=sNMPTrapTable, versionsGroup=versionsGroup, receiveFreqKHz=receiveFreqKHz, hTTPPortNumber=hTTPPortNumber, dfsMeans=dfsMeans, syslogControlGroup=syslogControlGroup, receivePower=receivePower, remoteMaximumTransmitPower=remoteMaximumTransmitPower, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, bandwidthVariant=bandwidthVariant, syslogControl=syslogControl, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, licensedCapacity=licensedCapacity, linkName=linkName, supplementary=supplementary, searchState=searchState, receiveModulationModeDetail=receiveModulationModeDetail, telecomsLoopbackTrap=telecomsLoopbackTrap, cableLoss=cableLoss, sMTPEmailAlert=sMTPEmailAlert, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernetGroup=ethernetGroup, supplementaryGroup=supplementaryGroup, maximumTransmitPower=maximumTransmitPower, syslogClientTrap=syslogClientTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, syslogState=syslogState, reset=reset, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, masterSlaveMode=masterSlaveMode, vLANPriorityQueueMapping=vLANPriorityQueueMapping, receiveFreqMHz=receiveFreqMHz, userTable=userTable, useVLANForManagementInterfaces=useVLANForManagementInterfaces, bootVersion=bootVersion, aggregateDataRate=aggregateDataRate, channelChangeTrap=channelChangeTrap, ptpCompliance=ptpCompliance, vectorError=vectorError, tFTPServerIPAddress=tFTPServerIPAddress, antennaGain=antennaGain, snmpControl=snmpControl, userTableEntry=userTableEntry, sNMPTrapTableNumber=sNMPTrapTableNumber, smtp=smtp, vLANPriorityTableEntry=vLANPriorityTableEntry, telecomsInterface=telecomsInterface, telnetAccessEnabled=telnetAccessEnabled, transmitPower=transmitPower, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, unitOutOfCalibration=unitOutOfCalibration, sntpGroup=sntpGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, phyControl=phyControl, ethernetFiberSupport=ethernetFiberSupport, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortStatusTrap=dataPortStatusTrap, sMTPServerIPAddress=sMTPServerIPAddress, userEnabled=userEnabled, constantPowerSpectralDensity=constantPowerSpectralDensity, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, aAAControl=aAAControl, dataPortAutoMdix=dataPortAutoMdix, systemClock=systemClock, transmitDataRate=transmitDataRate, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dataPortDisabledWarning=dataPortDisabledWarning, sNTPState=sNTPState, hTTPAccessEnabled=hTTPAccessEnabled, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, pubStats=pubStats, sNMPTrapVersion=sNMPTrapVersion, telecomGroup=telecomGroup, gatewayIPAddress=gatewayIPAddress, transmitModulationMode=transmitModulationMode, accessMethod=accessMethod, dfsTable=dfsTable, regionCodeTrap=regionCodeTrap, iPAddress=iPAddress, licenceGroup=licenceGroup, versions=versions, sNMPEnabledTraps=sNMPEnabledTraps, telecom=telecom, alarmsGroup=alarmsGroup, vLANManagementPriority=vLANManagementPriority, PYSNMP_MODULE_ID=cambium, noWirelessChannelAvailable=noWirelessChannelAvailable, userPassword=userPassword, installStatus=installStatus, userRole=userRole, linkSymmetry=linkSymmetry, tDDControl=tDDControl, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, incompatibleRegionCodes=incompatibleRegionCodes, sNMPPortNumber=sNMPPortNumber, hTTPSPortNumber=hTTPSPortNumber, productVariant=productVariant, pubStatsGroup=pubStatsGroup, tDDControlGroup=tDDControlGroup, dfsPeaks=dfsPeaks, snmpControlGroup=snmpControlGroup, eIRP=eIRP, telecomsLineCode=telecomsLineCode, linkModeOptimizationMismatch=linkModeOptimizationMismatch, configurationGroup=configurationGroup, dfsTableEntry=dfsTableEntry, telecomsChannelStatusTrap=telecomsChannelStatusTrap, linkModeOptimisation=linkModeOptimisation, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptpGroups=ptpGroups, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, targetMACAddress=targetMACAddress, telecomsChannelStatus=telecomsChannelStatus, ethernet=ethernet, userTableNumber=userTableNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, installArmState=installArmState, syslogStateTrap=syslogStateTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, softwareVersion=softwareVersion, sNTPPollInterval=sNTPPollInterval, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, remoteIPAddress=remoteIPAddress, userName=userName, licence=licence, vLANPriorityTableNumber=vLANPriorityTableNumber, receiveModulationMode=receiveModulationMode, dataPortWirelessDownAlert=dataPortWirelessDownAlert, altitude=altitude, hTTPSAccessEnabled=hTTPSAccessEnabled, ptpTraps=ptpTraps, aAAControlGroup=aAAControlGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, phyStatusGroup=phyStatusGroup, groupID=groupID, telecomsCableLength=telecomsCableLength, encryption=encryption, linkLoss=linkLoss, systemReset=systemReset, telnetPortNumber=telnetPortNumber, transmitChannel=transmitChannel, dataPortAutoNegotiation=dataPortAutoNegotiation, receiveDataRate=receiveDataRate, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortStatus=dataPortStatus, telecomsLoopback=telecomsLoopback, dfsTableNumber=dfsTableNumber, sNMPCommunityString=sNMPCommunityString, receiveChannel=receiveChannel, sMTPSourceEmailAddress=sMTPSourceEmailAddress, phyControlGroup=phyControlGroup, vLANPriorityTable=vLANPriorityTable, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, signalStrengthRatio=signalStrengthRatio, managementGroup=managementGroup, cambium=cambium, tDDSynchronizationStatus=tDDSynchronizationStatus, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, regionCode=regionCode, wirelessLinkStatus=wirelessLinkStatus, tFTPServerPortNumber=tFTPServerPortNumber, wirelessLinkAvailability=wirelessLinkAvailability, frequencyVariant=frequencyVariant, daylightSaving=daylightSaving, ptp=ptp, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPSync=sNTPSync, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogClient=syslogClient, ptp500=ptp500, alarms=alarms, dfs=dfs, sNMPv3Enable=sNMPv3Enable, timeZone=timeZone, encryptionAlgorithm=encryptionAlgorithm, notificationsGroup=notificationsGroup, byteErrorRatio=byteErrorRatio, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, secondarySoftwareVersion=secondarySoftwareVersion, sntp=sntp, longitude=longitude, dfsTableIndex=dfsTableIndex, vLANManagementVID=vLANManagementVID, management=management, configuration=configuration, resetGroup=resetGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, tDDSynchronizationMode=tDDSynchronizationMode, transmitFreqKHz=transmitFreqKHz, sNTPLastSync=sNTPLastSync, userTableIndex=userTableIndex, encryptionGroup=encryptionGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, range=range, sNTPServerIPAddress=sNTPServerIPAddress, ptpTrapPrefix=ptpTrapPrefix, channelBandwidth=channelBandwidth, siteName=siteName, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, transmitFreqMHz=transmitFreqMHz, dfsGroup=dfsGroup, capacityLicenseMismatch=capacityLicenseMismatch, sNTPServerPortNumber=sNTPServerPortNumber, phyStatus=phyStatus, sMTPEnabledMessages=sMTPEnabledMessages, productName=productName, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, latitude=latitude, smtpGroup=smtpGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tDDSynchronizationAlarm=tDDSynchronizationAlarm)
