...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", softwareVersion=softwareVersion, syslogClientTrap=syslogClientTrap, targetMACAddress=targetMACAddress, syslogControl=syslogControl, notificationsGroup=notificationsGroup, installStatusTrap=installStatusTrap, syslogStateTrap=syslogStateTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfsGroup=dfsGroup, groupID=groupID, sNMPPortNumber=sNMPPortNumber, phyControl=phyControl, userTable=userTable, aAAControl=aAAControl, receivePower=receivePower, receiveChannel=receiveChannel, syslogControlGroup=syslogControlGroup, telecomsLineCode=telecomsLineCode, iPAddress=iPAddress, transmitChannel=transmitChannel, userPassword=userPassword, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, encryptionGroup=encryptionGroup, resetGroup=resetGroup, searchState=searchState, incompatibleRegionCodes=incompatibleRegionCodes, transmitModulationMode=transmitModulationMode, systemClock=systemClock, wirelessLinkStatus=wirelessLinkStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, vLANPriorityQueueMapping=vLANPriorityQueueMapping, hardwareVersion=hardwareVersion, longitude=longitude, telecomsCableLength=telecomsCableLength, telecomGroup=telecomGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, snmpControl=snmpControl, smtp=smtp, masterSlaveMode=masterSlaveMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, channelBandwidth=channelBandwidth, dfsMeans=dfsMeans, pubStats=pubStats, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNTPServerPortNumber=sNTPServerPortNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dataPortStatus=dataPortStatus, systemReset=systemReset, constantPowerSpectralDensity=constantPowerSpectralDensity, syslogClient=syslogClient, hTTPAccessEnabled=hTTPAccessEnabled, linkLoss=linkLoss, installArmState=installArmState, pubStatsGroup=pubStatsGroup, ptp500=ptp500, sNMPTrapTableIndex=sNMPTrapTableIndex, linkName=linkName, sntp=sntp, aggregateDataRate=aggregateDataRate, sNMPTrapTableNumber=sNMPTrapTableNumber, ptpGroups=ptpGroups, accessMethod=accessMethod, channelChangeTrap=channelChangeTrap, range=range, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapVersion=sNMPTrapVersion, receiveDataRate=receiveDataRate, encryption=encryption, vLANPriorityTableNumber=vLANPriorityTableNumber, encryptionAlgorithm=encryptionAlgorithm, hTTPPortNumber=hTTPPortNumber, vectorError=vectorError, tFTPServerIPAddress=tFTPServerIPAddress, sNTPLastSync=sNTPLastSync, frequencyVariant=frequencyVariant, telecom=telecom, antennaGain=antennaGain, sNTPSync=sNTPSync, tDDSynchronizationMode=tDDSynchronizationMode, sNTPSyncTrap=sNTPSyncTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortAutoMdix=dataPortAutoMdix, aAAControlGroup=aAAControlGroup, receiveFreqMHz=receiveFreqMHz, tDDControlGroup=tDDControlGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, installArmStateTrap=installArmStateTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, receiveModulationModeDetail=receiveModulationModeDetail, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ptpTrapPrefix=ptpTrapPrefix, dfsPeaks=dfsPeaks, dataPortDisabledWarning=dataPortDisabledWarning, telnetAccessEnabled=telnetAccessEnabled, telecomsChannelStatus=telecomsChannelStatus, daylightSaving=daylightSaving, sNMPCommunityString=sNMPCommunityString, dfsTableNumber=dfsTableNumber, licensedCapacity=licensedCapacity, snmpControlGroup=snmpControlGroup, licence=licence, dfsTableEntry=dfsTableEntry, bandwidthVariant=bandwidthVariant, sNMPEnabledTraps=sNMPEnabledTraps, sNMPv3Enable=sNMPv3Enable, installStatus=installStatus, siteName=siteName, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ptpCompliance=ptpCompliance, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, timeZone=timeZone, dfs=dfs, versions=versions, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, managementGroup=managementGroup, ethernetFiberSupport=ethernetFiberSupport, eIRP=eIRP, ethernet=ethernet, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, management=management, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, supplementaryGroup=supplementaryGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, userEnabled=userEnabled, bootVersion=bootVersion, dfsTableIndex=dfsTableIndex, transmitPower=transmitPower, altitude=altitude, sMTPEnabledMessages=sMTPEnabledMessages, dataPortStatusTrap=dataPortStatusTrap, subnetMask=subnetMask, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, signalStrengthRatio=signalStrengthRatio, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dfsTable=dfsTable, vLANPriorityTableEntry=vLANPriorityTableEntry, syslogState=syslogState, alarms=alarms, userTableIndex=userTableIndex, hTTPSAccessEnabled=hTTPSAccessEnabled, vLANManagementVID=vLANManagementVID, gatewayIPAddress=gatewayIPAddress, configuration=configuration, ethernetGroup=ethernetGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPState=sNTPState, smtpGroup=smtpGroup, ptpTraps=ptpTraps, licenceGroup=licenceGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, capacityLicenseMismatch=capacityLicenseMismatch, sNTPPollInterval=sNTPPollInterval, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, productVariant=productVariant, ptp=ptp, ptmp=ptmp, remoteIPAddress=remoteIPAddress, telecomsChannelStatusTrap=telecomsChannelStatusTrap, telnetPortNumber=telnetPortNumber, alarmsGroup=alarmsGroup, versionsGroup=versionsGroup, vLANManagementPriority=vLANManagementPriority, secondarySoftwareVersion=secondarySoftwareVersion, userTableEntry=userTableEntry, transmitFreqKHz=transmitFreqKHz, vLANPriorityTable=vLANPriorityTable, telecomsInterface=telecomsInterface, userRole=userRole, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, cambium=cambium, reset=reset, maximumTransmitPower=maximumTransmitPower, sMTPServerPortNumber=sMTPServerPortNumber, phyControlGroup=phyControlGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, productName=productName, linkSymmetry=linkSymmetry, linkModeOptimisation=linkModeOptimisation, receiveFreqKHz=receiveFreqKHz, telecomsLoopbackTrap=telecomsLoopbackTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, vLANPriorityTableIndex=vLANPriorityTableIndex, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tDDSynchronizationAlarm=tDDSynchronizationAlarm, telecomsLoopback=telecomsLoopback, wirelessLinkAvailability=wirelessLinkAvailability, latitude=latitude, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tFTPServerPortNumber=tFTPServerPortNumber, transmitFreqMHz=transmitFreqMHz, hTTPSPortNumber=hTTPSPortNumber, regionCodeTrap=regionCodeTrap, unitOutOfCalibration=unitOutOfCalibration, cableLoss=cableLoss, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, configurationGroup=configurationGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, phyStatus=phyStatus, sntpGroup=sntpGroup, transmitDataRate=transmitDataRate, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, regionCode=regionCode, receiveModulationMode=receiveModulationMode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, userName=userName, PYSNMP_MODULE_ID=cambium, tDDControl=tDDControl, supplementary=supplementary, sNTPServerIPAddress=sNTPServerIPAddress, sNMPTrapTable=sNMPTrapTable, phyStatusGroup=phyStatusGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, userTableNumber=userTableNumber, byteErrorRatio=byteErrorRatio)
