...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sNMPCommunityString=sNMPCommunityString, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsTableNumber=dfsTableNumber, PYSNMP_MODULE_ID=cambium, sNMPTrapTableEntry=sNMPTrapTableEntry, transmitFreqKHz=transmitFreqKHz, transmitModulationMode=transmitModulationMode, ptp=ptp, versions=versions, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, smtpGroup=smtpGroup, supplementaryGroup=supplementaryGroup, receiveFreqMHz=receiveFreqMHz, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPSync=sNTPSync, sNTPServerPortNumber=sNTPServerPortNumber, systemReset=systemReset, userPassword=userPassword, wirelessLinkAvailability=wirelessLinkAvailability, altitude=altitude, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dfsTableIndex=dfsTableIndex, encryptionGroup=encryptionGroup, licence=licence, hTTPSAccessEnabled=hTTPSAccessEnabled, telnetAccessEnabled=telnetAccessEnabled, vLANPriorityQueueMapping=vLANPriorityQueueMapping, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tDDControlGroup=tDDControlGroup, hTTPAccessEnabled=hTTPAccessEnabled, ptpGroups=ptpGroups, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, accessMethod=accessMethod, telecom=telecom, byteErrorRatio=byteErrorRatio, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, syslogClient=syslogClient, hTTPSPortNumber=hTTPSPortNumber, eIRP=eIRP, sNMPTrapPortNumber=sNMPTrapPortNumber, telecomGroup=telecomGroup, sntp=sntp, subnetMask=subnetMask, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, regionCodeTrap=regionCodeTrap, vectorError=vectorError, range=range, searchState=searchState, userTableNumber=userTableNumber, configuration=configuration, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, snmpControl=snmpControl, syslogState=syslogState, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNTPState=sNTPState, telecomsLoopbackTrap=telecomsLoopbackTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortAutoMdix=dataPortAutoMdix, ptpTrapPrefix=ptpTrapPrefix, installStatusTrap=installStatusTrap, groupID=groupID, sNMPTrapIPAddress=sNMPTrapIPAddress, channelBandwidth=channelBandwidth, resetGroup=resetGroup, timeZone=timeZone, transmitDataRate=transmitDataRate, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsGroup=dfsGroup, dataPortDisabledWarning=dataPortDisabledWarning, tDDControl=tDDControl, vLANPriorityTableEntry=vLANPriorityTableEntry, aAAControlGroup=aAAControlGroup, ethernet=ethernet, constantPowerSpectralDensity=constantPowerSpectralDensity, hTTPPortNumber=hTTPPortNumber, installStatus=installStatus, phyStatusGroup=phyStatusGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transmitPower=transmitPower, wirelessLinkStatus=wirelessLinkStatus, gatewayIPAddress=gatewayIPAddress, tDDSynchronizationMode=tDDSynchronizationMode, dataPortConfigurationMismatch=dataPortConfigurationMismatch, configurationGroup=configurationGroup, secondarySoftwareVersion=secondarySoftwareVersion, dfs=dfs, dataPortStatusTrap=dataPortStatusTrap, sNTPSyncTrap=sNTPSyncTrap, telecomsChannelStatus=telecomsChannelStatus, dfsTable=dfsTable, productName=productName, receiveDataRate=receiveDataRate, vLANPriorityTableIndex=vLANPriorityTableIndex, transmitFreqMHz=transmitFreqMHz, tDDSynchronizationAlarm=tDDSynchronizationAlarm, productVariant=productVariant, ptmp=ptmp, remoteIPAddress=remoteIPAddress, frequencyVariant=frequencyVariant, regionCode=regionCode, daylightSaving=daylightSaving, softwareVersion=softwareVersion, linkSymmetry=linkSymmetry, userEnabled=userEnabled, encryption=encryption, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, systemClock=systemClock, maximumTransmitPower=maximumTransmitPower, sntpGroup=sntpGroup, aAAControl=aAAControl, telecomsCableLength=telecomsCableLength, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPEnabledTraps=sNMPEnabledTraps, managementGroup=managementGroup, channelChangeTrap=channelChangeTrap, receiveChannel=receiveChannel, linkName=linkName, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, aggregateDataRate=aggregateDataRate, phyStatus=phyStatus, userRole=userRole, phyControl=phyControl, telecomsLineCode=telecomsLineCode, linkModeOptimizationMismatch=linkModeOptimizationMismatch, linkLoss=linkLoss, iPAddress=iPAddress, userTableIndex=userTableIndex, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, longitude=longitude, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPServerIPAddress=sMTPServerIPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, syslogControlGroup=syslogControlGroup, dfsPeaks=dfsPeaks, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ptp500=ptp500, alarmsGroup=alarmsGroup, receiveFreqKHz=receiveFreqKHz, incompatibleRegionCodes=incompatibleRegionCodes, sMTPServerPortNumber=sMTPServerPortNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, telecomsLoopback=telecomsLoopback, siteName=siteName, versionsGroup=versionsGroup, sNMPTrapTable=sNMPTrapTable, notificationsGroup=notificationsGroup, userTableEntry=userTableEntry, linkModeOptimisation=linkModeOptimisation, receiveModulationModeDetail=receiveModulationModeDetail, phyControlGroup=phyControlGroup, snmpControlGroup=snmpControlGroup, sNMPv3Enable=sNMPv3Enable, alarms=alarms, tFTPServerIPAddress=tFTPServerIPAddress, smtp=smtp, vLANPriorityTableNumber=vLANPriorityTableNumber, ethernetFiberSupport=ethernetFiberSupport, targetMACAddress=targetMACAddress, signalStrengthRatio=signalStrengthRatio, management=management, receivePower=receivePower, cambium=cambium, tDDSynchronizationStatus=tDDSynchronizationStatus, ethernetGroup=ethernetGroup, capacityLicenseMismatch=capacityLicenseMismatch, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsMeans=dfsMeans, licensedCapacity=licensedCapacity, installArmStateTrap=installArmStateTrap, vLANManagementVID=vLANManagementVID, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapVersion=sNMPTrapVersion, incompatibleMasterAndSlave=incompatibleMasterAndSlave, hardwareVersion=hardwareVersion, telecomsInterface=telecomsInterface, installArmState=installArmState, syslogClientTrap=syslogClientTrap, tFTPServerPortNumber=tFTPServerPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, syslogControl=syslogControl, receiveModulationMode=receiveModulationMode, ptpCompliance=ptpCompliance, sNMPTrapTableNumber=sNMPTrapTableNumber, encryptionAlgorithm=encryptionAlgorithm, syslogStateTrap=syslogStateTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, reset=reset, vLANPriorityTable=vLANPriorityTable, userName=userName, transmitChannel=transmitChannel, pubStats=pubStats, cableLoss=cableLoss, sNTPServerIPAddress=sNTPServerIPAddress, antennaGain=antennaGain, masterSlaveMode=masterSlaveMode, userTable=userTable, unitOutOfCalibration=unitOutOfCalibration, bandwidthVariant=bandwidthVariant, dataPortStatus=dataPortStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPEmailAlert=sMTPEmailAlert, sNTPPollInterval=sNTPPollInterval, useVLANForManagementInterfaces=useVLANForManagementInterfaces, supplementary=supplementary, sNMPPortNumber=sNMPPortNumber, bootVersion=bootVersion, sNTPLastSync=sNTPLastSync, licenceGroup=licenceGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, pubStatsGroup=pubStatsGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfsTableEntry=dfsTableEntry, latitude=latitude, vLANManagementPriority=vLANManagementPriority, telnetPortNumber=telnetPortNumber, ptpTraps=ptpTraps)
