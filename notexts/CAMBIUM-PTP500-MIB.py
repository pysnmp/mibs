...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", dfsTableIndex=dfsTableIndex, linkModeOptimisation=linkModeOptimisation, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapTable=sNMPTrapTable, supplementary=supplementary, snmpControl=snmpControl, userEnabled=userEnabled, receiveDataRate=receiveDataRate, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, encryption=encryption, sNMPTrapPortNumber=sNMPTrapPortNumber, vLANManagementVID=vLANManagementVID, licenceGroup=licenceGroup, daylightSaving=daylightSaving, sNTPSyncTrap=sNTPSyncTrap, sNTPSync=sNTPSync, phyControlGroup=phyControlGroup, telecomGroup=telecomGroup, range=range, supplementaryGroup=supplementaryGroup, wirelessLinkAvailability=wirelessLinkAvailability, snmpControlGroup=snmpControlGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, vectorError=vectorError, sMTPEmailAlert=sMTPEmailAlert, productName=productName, byteErrorRatio=byteErrorRatio, tDDSynchronizationStatus=tDDSynchronizationStatus, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, systemReset=systemReset, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, wirelessLinkStatus=wirelessLinkStatus, channelChangeTrap=channelChangeTrap, sNMPEnabledTraps=sNMPEnabledTraps, dataPortStatusTrap=dataPortStatusTrap, transmitPower=transmitPower, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfsPeaks=dfsPeaks, receiveChannel=receiveChannel, remoteIPAddress=remoteIPAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, transmitDataRate=transmitDataRate, bandwidthVariant=bandwidthVariant, ethernet=ethernet, configurationGroup=configurationGroup, alarmsGroup=alarmsGroup, dataPortStatus=dataPortStatus, productVariant=productVariant, installStatus=installStatus, capacityLicenseMismatch=capacityLicenseMismatch, dataPortAutoNegotiation=dataPortAutoNegotiation, hTTPSAccessEnabled=hTTPSAccessEnabled, accessMethod=accessMethod, ptpGroups=ptpGroups, managementGroup=managementGroup, ptpTraps=ptpTraps, userTableEntry=userTableEntry, encryptionAlgorithm=encryptionAlgorithm, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, telecomsChannelStatus=telecomsChannelStatus, secondarySoftwareVersion=secondarySoftwareVersion, configuration=configuration, syslogClient=syslogClient, longitude=longitude, syslogClientTrap=syslogClientTrap, userTable=userTable, telnetPortNumber=telnetPortNumber, subnetMask=subnetMask, sntp=sntp, hTTPAccessEnabled=hTTPAccessEnabled, timeZone=timeZone, altitude=altitude, telecomsLineCode=telecomsLineCode, transmitModulationMode=transmitModulationMode, siteName=siteName, gatewayIPAddress=gatewayIPAddress, receiveFreqKHz=receiveFreqKHz, cableLoss=cableLoss, tDDSynchronizationMode=tDDSynchronizationMode, signalStrengthRatio=signalStrengthRatio, syslogLocalWrappedTrap=syslogLocalWrappedTrap, transmitChannel=transmitChannel, receiveModulationMode=receiveModulationMode, searchState=searchState, telecomsCableLength=telecomsCableLength, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsMeans=dfsMeans, phyStatus=phyStatus, syslogState=syslogState, management=management, smtp=smtp, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, masterSlaveMode=masterSlaveMode, tDDControl=tDDControl, linkName=linkName, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dfsTable=dfsTable, userName=userName, licensedCapacity=licensedCapacity, telnetAccessEnabled=telnetAccessEnabled, telecomsLoopbackTrap=telecomsLoopbackTrap, receiveFreqMHz=receiveFreqMHz, dataPortAutoMdix=dataPortAutoMdix, versions=versions, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsTableEntry=dfsTableEntry, latitude=latitude, vLANPriorityTableEntry=vLANPriorityTableEntry, telecomsLoopback=telecomsLoopback, tDDControlGroup=tDDControlGroup, installArmStateTrap=installArmStateTrap, pubStats=pubStats, incompatibleRegionCodes=incompatibleRegionCodes, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPPollInterval=sNTPPollInterval, dfsGroup=dfsGroup, phyStatusGroup=phyStatusGroup, hTTPPortNumber=hTTPPortNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, hardwareVersion=hardwareVersion, sNTPState=sNTPState, linkSymmetry=linkSymmetry, dataPortConfigurationMismatch=dataPortConfigurationMismatch, reset=reset, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, systemClock=systemClock, vLANPriorityTable=vLANPriorityTable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ethernetFiberSupport=ethernetFiberSupport, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, transmitFreqMHz=transmitFreqMHz, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, softwareVersion=softwareVersion, notificationsGroup=notificationsGroup, telecom=telecom, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sMTPEnabledMessages=sMTPEnabledMessages, installArmState=installArmState, dataPortWirelessDownAlert=dataPortWirelessDownAlert, userTableNumber=userTableNumber, installStatusTrap=installStatusTrap, phyControl=phyControl, ethernetGroup=ethernetGroup, userPassword=userPassword, unitOutOfCalibration=unitOutOfCalibration, syslogStateTrap=syslogStateTrap, licence=licence, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, cambium=cambium, sNMPTrapIPAddress=sNMPTrapIPAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, linkLoss=linkLoss, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsTableNumber=dfsTableNumber, iPAddress=iPAddress, receiveModulationModeDetail=receiveModulationModeDetail, smtpGroup=smtpGroup, sNMPv3Enable=sNMPv3Enable, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, eIRP=eIRP, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, vLANPriorityQueueMapping=vLANPriorityQueueMapping, vLANManagementPriority=vLANManagementPriority, sNMPPortNumber=sNMPPortNumber, channelBandwidth=channelBandwidth, regionCode=regionCode, ptp500=ptp500, telecomsInterface=telecomsInterface, tFTPServerPortNumber=tFTPServerPortNumber, transmitFreqKHz=transmitFreqKHz, sNMPCommunityString=sNMPCommunityString, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, frequencyVariant=frequencyVariant, bootVersion=bootVersion, hTTPSPortNumber=hTTPSPortNumber, syslogControlGroup=syslogControlGroup, sMTPServerPortNumber=sMTPServerPortNumber, ptp=ptp, vLANPriorityTableNumber=vLANPriorityTableNumber, sNMPTrapVersion=sNMPTrapVersion, maximumTransmitPower=maximumTransmitPower, encryptionGroup=encryptionGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, aAAControl=aAAControl, dataPortDisabledWarning=dataPortDisabledWarning, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNTPServerIPAddress=sNTPServerIPAddress, syslogControl=syslogControl, vLANPriorityTableIndex=vLANPriorityTableIndex, ptmp=ptmp, versionsGroup=versionsGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sntpGroup=sntpGroup, ptpCompliance=ptpCompliance, targetMACAddress=targetMACAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, userTableIndex=userTableIndex, pubStatsGroup=pubStatsGroup, dfs=dfs, sNTPLastSync=sNTPLastSync, receivePower=receivePower, tFTPServerIPAddress=tFTPServerIPAddress, PYSNMP_MODULE_ID=cambium, aggregateDataRate=aggregateDataRate, antennaGain=antennaGain, sNTPServerPortNumber=sNTPServerPortNumber, sMTPServerIPAddress=sMTPServerIPAddress, userRole=userRole, regionCodeTrap=regionCodeTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, alarms=alarms, tDDSynchronizationAlarm=tDDSynchronizationAlarm, aAAControlGroup=aAAControlGroup, groupID=groupID, resetGroup=resetGroup)
