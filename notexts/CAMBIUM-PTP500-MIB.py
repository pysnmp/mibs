...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", syslogControl=syslogControl, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, noWirelessChannelAvailable=noWirelessChannelAvailable, supplementaryGroup=supplementaryGroup, daylightSaving=daylightSaving, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, userEnabled=userEnabled, dfsTableIndex=dfsTableIndex, telecomsLoopback=telecomsLoopback, transmitPower=transmitPower, incompatibleRegionCodes=incompatibleRegionCodes, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, hTTPSPortNumber=hTTPSPortNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ethernetFiberSupport=ethernetFiberSupport, tFTPServerIPAddress=tFTPServerIPAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, vLANPriorityQueueMapping=vLANPriorityQueueMapping, groupID=groupID, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, longitude=longitude, versionsGroup=versionsGroup, timeZone=timeZone, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, masterSlaveMode=masterSlaveMode, linkSymmetry=linkSymmetry, vLANPriorityTable=vLANPriorityTable, userName=userName, telecomGroup=telecomGroup, capacityLicenseMismatch=capacityLicenseMismatch, maximumTransmitPower=maximumTransmitPower, snmpControlGroup=snmpControlGroup, subnetMask=subnetMask, sNMPTrapPortNumber=sNMPTrapPortNumber, sntp=sntp, sMTPServerIPAddress=sMTPServerIPAddress, dfsPeaks=dfsPeaks, ptp=ptp, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPPortNumber=sNMPPortNumber, userTableIndex=userTableIndex, sMTPEmailAlert=sMTPEmailAlert, tDDSynchronizationMode=tDDSynchronizationMode, systemReset=systemReset, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, vLANPriorityTableNumber=vLANPriorityTableNumber, licensedCapacity=licensedCapacity, linkModeOptimizationMismatch=linkModeOptimizationMismatch, remoteIPAddress=remoteIPAddress, vLANPriorityTableIndex=vLANPriorityTableIndex, userPassword=userPassword, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPEnabledTraps=sNMPEnabledTraps, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortDisabledWarning=dataPortDisabledWarning, receiveChannel=receiveChannel, dfsTableEntry=dfsTableEntry, sNMPv3Enable=sNMPv3Enable, targetMACAddress=targetMACAddress, syslogControlGroup=syslogControlGroup, licence=licence, eIRP=eIRP, constantPowerSpectralDensity=constantPowerSpectralDensity, regionCodeTrap=regionCodeTrap, linkLoss=linkLoss, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, telnetAccessEnabled=telnetAccessEnabled, accessMethod=accessMethod, vectorError=vectorError, reset=reset, vLANManagementPriority=vLANManagementPriority, transmitDataRate=transmitDataRate, dataPortAutoMdix=dataPortAutoMdix, ethernet=ethernet, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sMTPEnabledMessages=sMTPEnabledMessages, regionCode=regionCode, transmitModulationMode=transmitModulationMode, receiveModulationModeDetail=receiveModulationModeDetail, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telecomsCableLength=telecomsCableLength, wirelessLinkAvailability=wirelessLinkAvailability, sNMPCommunityString=sNMPCommunityString, resetGroup=resetGroup, channelChangeTrap=channelChangeTrap, antennaGain=antennaGain, unitOutOfCalibration=unitOutOfCalibration, syslogStateTrap=syslogStateTrap, phyStatus=phyStatus, siteName=siteName, cableLoss=cableLoss, telecomsChannelStatus=telecomsChannelStatus, linkModeOptimisation=linkModeOptimisation, linkName=linkName, aAAControl=aAAControl, pubStats=pubStats, dfsGroup=dfsGroup, ethernetGroup=ethernetGroup, configurationGroup=configurationGroup, installStatus=installStatus, phyControlGroup=phyControlGroup, telecomsLoopbackTrap=telecomsLoopbackTrap, latitude=latitude, hTTPPortNumber=hTTPPortNumber, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, vLANManagementVID=vLANManagementVID, sMTPSourceEmailAddress=sMTPSourceEmailAddress, byteErrorRatio=byteErrorRatio, supplementary=supplementary, dfsTable=dfsTable, smtpGroup=smtpGroup, sNTPLastSync=sNTPLastSync, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, versions=versions, encryption=encryption, telecomsInterface=telecomsInterface, ptpTrapPrefix=ptpTrapPrefix, configuration=configuration, receiveFreqKHz=receiveFreqKHz, managementGroup=managementGroup, telecomsLineCode=telecomsLineCode, alarmsGroup=alarmsGroup, tDDControl=tDDControl, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, PYSNMP_MODULE_ID=cambium, sNMPTrapVersion=sNMPTrapVersion, dataPortStatus=dataPortStatus, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, bootVersion=bootVersion, syslogLocalWrappedTrap=syslogLocalWrappedTrap, channelBandwidth=channelBandwidth, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, syslogClient=syslogClient, productVariant=productVariant, iPAddress=iPAddress, telecom=telecom, aggregateDataRate=aggregateDataRate, ptpGroups=ptpGroups, userRole=userRole, sNMPTrapTable=sNMPTrapTable, sNMPTrapTableNumber=sNMPTrapTableNumber, syslogState=syslogState, userTable=userTable, sNTPSync=sNTPSync, dataPortStatusTrap=dataPortStatusTrap, phyStatusGroup=phyStatusGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, transmitChannel=transmitChannel, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, phyControl=phyControl, aAAControlGroup=aAAControlGroup, receiveModulationMode=receiveModulationMode, userTableNumber=userTableNumber, notificationsGroup=notificationsGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, ptmp=ptmp, sNTPServerPortNumber=sNTPServerPortNumber, tFTPServerPortNumber=tFTPServerPortNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, gatewayIPAddress=gatewayIPAddress, signalStrengthRatio=signalStrengthRatio, secondarySoftwareVersion=secondarySoftwareVersion, sNTPSyncTrap=sNTPSyncTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPServerIPAddress=sNTPServerIPAddress, pubStatsGroup=pubStatsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, hTTPAccessEnabled=hTTPAccessEnabled, dfs=dfs, encryptionGroup=encryptionGroup, ptpTraps=ptpTraps, syslogClientTrap=syslogClientTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, installArmStateTrap=installArmStateTrap, sNTPPollInterval=sNTPPollInterval, transmitFreqMHz=transmitFreqMHz, hardwareVersion=hardwareVersion, receiveDataRate=receiveDataRate, wirelessLinkStatus=wirelessLinkStatus, alarms=alarms, smtp=smtp, tDDControlGroup=tDDControlGroup, management=management, receiveFreqMHz=receiveFreqMHz, bandwidthVariant=bandwidthVariant, remoteMaximumTransmitPower=remoteMaximumTransmitPower, receivePower=receivePower, snmpControl=snmpControl, cambium=cambium, tDDSynchronizationAlarm=tDDSynchronizationAlarm, systemClock=systemClock, userTableEntry=userTableEntry, telnetPortNumber=telnetPortNumber, sMTPServerPortNumber=sMTPServerPortNumber, installArmState=installArmState, ptpCompliance=ptpCompliance, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsTableNumber=dfsTableNumber, frequencyVariant=frequencyVariant, dfsMeans=dfsMeans, searchState=searchState, encryptionAlgorithm=encryptionAlgorithm, installStatusTrap=installStatusTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPState=sNTPState, sNMPTrapTableIndex=sNMPTrapTableIndex, productName=productName, licenceGroup=licenceGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sntpGroup=sntpGroup, transmitFreqKHz=transmitFreqKHz, altitude=altitude, range=range, softwareVersion=softwareVersion, ptp500=ptp500)
