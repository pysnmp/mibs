...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", linkLoss=linkLoss, smtp=smtp, searchState=searchState, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sMTPServerPortNumber=sMTPServerPortNumber, sNMPCommunityString=sNMPCommunityString, byteErrorRatio=byteErrorRatio, ptpGroups=ptpGroups, sntpGroup=sntpGroup, userPassword=userPassword, altitude=altitude, receiveModulationModeDetail=receiveModulationModeDetail, licensedCapacity=licensedCapacity, ethernetFiberSupport=ethernetFiberSupport, channelBandwidth=channelBandwidth, transmitFreqKHz=transmitFreqKHz, dataPortDisabledWarning=dataPortDisabledWarning, sNMPEnabledTraps=sNMPEnabledTraps, bandwidthVariant=bandwidthVariant, vLANManagementVID=vLANManagementVID, sNMPPortNumber=sNMPPortNumber, notificationsGroup=notificationsGroup, systemClock=systemClock, sMTPServerIPAddress=sMTPServerIPAddress, configurationGroup=configurationGroup, installArmStateTrap=installArmStateTrap, sNTPPollInterval=sNTPPollInterval, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapIPAddress=sNMPTrapIPAddress, hardwareVersion=hardwareVersion, receivePower=receivePower, gatewayIPAddress=gatewayIPAddress, sNTPLastSync=sNTPLastSync, systemReset=systemReset, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, snmpControl=snmpControl, tFTPServerPortNumber=tFTPServerPortNumber, vectorError=vectorError, siteName=siteName, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, iPAddress=iPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, range=range, sNMPv3Enable=sNMPv3Enable, receiveDataRate=receiveDataRate, sNMPTrapPortNumber=sNMPTrapPortNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tDDControlGroup=tDDControlGroup, dfsMeans=dfsMeans, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, aggregateDataRate=aggregateDataRate, softwareVersion=softwareVersion, syslogLocalWrappedTrap=syslogLocalWrappedTrap, installStatusTrap=installStatusTrap, ethernet=ethernet, tDDControl=tDDControl, remoteMaximumTransmitPower=remoteMaximumTransmitPower, frequencyVariant=frequencyVariant, encryption=encryption, management=management, linkModeOptimizationMismatch=linkModeOptimizationMismatch, managementGroup=managementGroup, ptpTraps=ptpTraps, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, hTTPSPortNumber=hTTPSPortNumber, sNMPTrapTable=sNMPTrapTable, sNTPSyncTrap=sNTPSyncTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tFTPServerIPAddress=tFTPServerIPAddress, syslogClientTrap=syslogClientTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, telecomsLineCode=telecomsLineCode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, licence=licence, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, antennaGain=antennaGain, pubStatsGroup=pubStatsGroup, groupID=groupID, transmitPower=transmitPower, wirelessLinkStatus=wirelessLinkStatus, installArmState=installArmState, incompatibleRegionCodes=incompatibleRegionCodes, userName=userName, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, userTableEntry=userTableEntry, constantPowerSpectralDensity=constantPowerSpectralDensity, vLANPriorityTableEntry=vLANPriorityTableEntry, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ptp=ptp, sNTPSync=sNTPSync, bootVersion=bootVersion, userEnabled=userEnabled, configuration=configuration, tDDSynchronizationStatus=tDDSynchronizationStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, syslogStateTrap=syslogStateTrap, phyControl=phyControl, PYSNMP_MODULE_ID=cambium, vLANPriorityTableIndex=vLANPriorityTableIndex, wirelessLinkAvailability=wirelessLinkAvailability, receiveFreqMHz=receiveFreqMHz, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, remoteIPAddress=remoteIPAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, reset=reset, enabledDiagnosticAlarms=enabledDiagnosticAlarms, transmitDataRate=transmitDataRate, masterSlaveMode=masterSlaveMode, userTable=userTable, encryptionAlgorithm=encryptionAlgorithm, transmitChannel=transmitChannel, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, linkSymmetry=linkSymmetry, phyStatusGroup=phyStatusGroup, licenceGroup=licenceGroup, dfsPeaks=dfsPeaks, sMTPEmailAlert=sMTPEmailAlert, dfsTableIndex=dfsTableIndex, vLANPriorityQueueMapping=vLANPriorityQueueMapping, capacityLicenseMismatch=capacityLicenseMismatch, sNMPTrapVersion=sNMPTrapVersion, sNTPState=sNTPState, supplementaryGroup=supplementaryGroup, daylightSaving=daylightSaving, dfs=dfs, vLANPriorityTable=vLANPriorityTable, signalStrengthRatio=signalStrengthRatio, secondarySoftwareVersion=secondarySoftwareVersion, syslogClient=syslogClient, ethernetGroup=ethernetGroup, regionCodeTrap=regionCodeTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, productVariant=productVariant, dfsTableEntry=dfsTableEntry, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsTableNumber=dfsTableNumber, hTTPAccessEnabled=hTTPAccessEnabled, versions=versions, maximumTransmitPower=maximumTransmitPower, versionsGroup=versionsGroup, userRole=userRole, cambium=cambium, receiveModulationMode=receiveModulationMode, telecomsCableLength=telecomsCableLength, telnetPortNumber=telnetPortNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, telecomsChannelStatus=telecomsChannelStatus, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, dfsGroup=dfsGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, pubStats=pubStats, dfsTable=dfsTable, telecom=telecom, transmitModulationMode=transmitModulationMode, alarms=alarms, sMTPEnabledMessages=sMTPEnabledMessages, receiveFreqKHz=receiveFreqKHz, latitude=latitude, tDDSynchronizationMode=tDDSynchronizationMode, ptmp=ptmp, aAAControl=aAAControl, hTTPPortNumber=hTTPPortNumber, channelChangeTrap=channelChangeTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, syslogControlGroup=syslogControlGroup, ptpTrapPrefix=ptpTrapPrefix, telecomGroup=telecomGroup, receiveChannel=receiveChannel, unitOutOfCalibration=unitOutOfCalibration, sNTPServerPortNumber=sNTPServerPortNumber, syslogState=syslogState, linkName=linkName, dataPortStatusTrap=dataPortStatusTrap, accessMethod=accessMethod, dataPortStatus=dataPortStatus, sntp=sntp, linkModeOptimisation=linkModeOptimisation, sNTPServerIPAddress=sNTPServerIPAddress, resetGroup=resetGroup, subnetMask=subnetMask, installStatus=installStatus, syslogControl=syslogControl, ptpCompliance=ptpCompliance, longitude=longitude, telecomsInterface=telecomsInterface, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, userTableIndex=userTableIndex, timeZone=timeZone, telnetAccessEnabled=telnetAccessEnabled, transmitFreqMHz=transmitFreqMHz, targetMACAddress=targetMACAddress, incompatibleMasterAndSlave=incompatibleMasterAndSlave, phyStatus=phyStatus, alarmsGroup=alarmsGroup, eIRP=eIRP, telecomsLoopback=telecomsLoopback, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortAutoMdix=dataPortAutoMdix, snmpControlGroup=snmpControlGroup, smtpGroup=smtpGroup, cableLoss=cableLoss, productName=productName, vLANManagementPriority=vLANManagementPriority, supplementary=supplementary, vLANPriorityTableNumber=vLANPriorityTableNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, phyControlGroup=phyControlGroup, encryptionGroup=encryptionGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, userTableNumber=userTableNumber, regionCode=regionCode, sNMPTrapTableEntry=sNMPTrapTableEntry, aAAControlGroup=aAAControlGroup, ptp500=ptp500)
