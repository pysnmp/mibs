...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", vLANPriorityTableIndex=vLANPriorityTableIndex, smtp=smtp, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tDDSynchronizationAlarm=tDDSynchronizationAlarm, linkSymmetry=linkSymmetry, sNMPCommunityString=sNMPCommunityString, encryptionGroup=encryptionGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, pubStats=pubStats, sNMPTrapTable=sNMPTrapTable, sMTPServerIPAddress=sMTPServerIPAddress, alarms=alarms, longitude=longitude, syslogStateTrap=syslogStateTrap, aAAControl=aAAControl, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, supplementaryGroup=supplementaryGroup, sNTPPollInterval=sNTPPollInterval, tFTPServerIPAddress=tFTPServerIPAddress, dataPortStatus=dataPortStatus, linkLoss=linkLoss, noWirelessChannelAvailable=noWirelessChannelAvailable, userTableIndex=userTableIndex, hTTPSAccessEnabled=hTTPSAccessEnabled, masterSlaveMode=masterSlaveMode, remoteIPAddress=remoteIPAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, receiveChannel=receiveChannel, syslogControl=syslogControl, iPAddress=iPAddress, supplementary=supplementary, regionCodeTrap=regionCodeTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, pubStatsGroup=pubStatsGroup, sMTPEnabledMessages=sMTPEnabledMessages, userRole=userRole, accessMethod=accessMethod, configurationGroup=configurationGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, linkName=linkName, useVLANForManagementInterfaces=useVLANForManagementInterfaces, regionCode=regionCode, transmitModulationMode=transmitModulationMode, sNTPSyncTrap=sNTPSyncTrap, versionsGroup=versionsGroup, ptmp=ptmp, ethernet=ethernet, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPv3Enable=sNMPv3Enable, receivePower=receivePower, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ethernetFiberSupport=ethernetFiberSupport, unitOutOfCalibration=unitOutOfCalibration, syslogState=syslogState, bandwidthVariant=bandwidthVariant, phyStatusGroup=phyStatusGroup, sNTPSync=sNTPSync, sNMPTrapTableEntry=sNMPTrapTableEntry, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, syslogControlGroup=syslogControlGroup, syslogClient=syslogClient, targetMACAddress=targetMACAddress, installStatus=installStatus, telecomGroup=telecomGroup, signalStrengthRatio=signalStrengthRatio, range=range, timeZone=timeZone, dfsTableNumber=dfsTableNumber, receiveFreqMHz=receiveFreqMHz, sNMPPortNumber=sNMPPortNumber, hTTPAccessEnabled=hTTPAccessEnabled, sMTPEmailAlert=sMTPEmailAlert, sMTPServerPortNumber=sMTPServerPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, userEnabled=userEnabled, dataPortAutoMdix=dataPortAutoMdix, PYSNMP_MODULE_ID=cambium, dfsTableIndex=dfsTableIndex, snmpControl=snmpControl, tFTPServerPortNumber=tFTPServerPortNumber, ptp500=ptp500, dfsTable=dfsTable, syslogClientTrap=syslogClientTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sMTPSourceEmailAddress=sMTPSourceEmailAddress, vLANPriorityTableEntry=vLANPriorityTableEntry, productName=productName, eIRP=eIRP, userName=userName, dataPortStatusTrap=dataPortStatusTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, phyControl=phyControl, sNMPTrapIPAddress=sNMPTrapIPAddress, licensedCapacity=licensedCapacity, daylightSaving=daylightSaving, ptpCompliance=ptpCompliance, softwareVersion=softwareVersion, configuration=configuration, vLANManagementPriority=vLANManagementPriority, transmitDataRate=transmitDataRate, telecom=telecom, userTableEntry=userTableEntry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitPower=transmitPower, management=management, sntpGroup=sntpGroup, ptp=ptp, sNMPTrapPortNumber=sNMPTrapPortNumber, aAAControlGroup=aAAControlGroup, productVariant=productVariant, telecomsLoopbackTrap=telecomsLoopbackTrap, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsGroup=dfsGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, receiveDataRate=receiveDataRate, snmpControlGroup=snmpControlGroup, ptpGroups=ptpGroups, userTable=userTable, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, versions=versions, siteName=siteName, telecomsInterface=telecomsInterface, tDDSynchronizationMode=tDDSynchronizationMode, ptpTraps=ptpTraps, hardwareVersion=hardwareVersion, sNTPState=sNTPState, installArmState=installArmState, tDDControl=tDDControl, sNTPServerIPAddress=sNTPServerIPAddress, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, groupID=groupID, receiveModulationMode=receiveModulationMode, dfs=dfs, receiveModulationModeDetail=receiveModulationModeDetail, syslogLocalWrappedTrap=syslogLocalWrappedTrap, latitude=latitude, telnetAccessEnabled=telnetAccessEnabled, transmitChannel=transmitChannel, cambium=cambium, secondarySoftwareVersion=secondarySoftwareVersion, channelChangeTrap=channelChangeTrap, byteErrorRatio=byteErrorRatio, linkModeOptimisation=linkModeOptimisation, userPassword=userPassword, receiveFreqKHz=receiveFreqKHz, dataPortAutoNegotiation=dataPortAutoNegotiation, smtpGroup=smtpGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, transmitFreqMHz=transmitFreqMHz, linkModeOptimizationMismatch=linkModeOptimizationMismatch, systemClock=systemClock, telecomsChannelStatusTrap=telecomsChannelStatusTrap, reset=reset, telecomsChannelStatus=telecomsChannelStatus, dataPortDisabledWarning=dataPortDisabledWarning, frequencyVariant=frequencyVariant, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, hTTPSPortNumber=hTTPSPortNumber, userTableNumber=userTableNumber, altitude=altitude, encryption=encryption, tDDControlGroup=tDDControlGroup, vLANPriorityTable=vLANPriorityTable, transmitFreqKHz=transmitFreqKHz, alarmsGroup=alarmsGroup, licenceGroup=licenceGroup, telecomsCableLength=telecomsCableLength, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, phyStatus=phyStatus, searchState=searchState, gatewayIPAddress=gatewayIPAddress, sNTPLastSync=sNTPLastSync, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, aggregateDataRate=aggregateDataRate, maximumTransmitPower=maximumTransmitPower, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, licence=licence, dfsTableEntry=dfsTableEntry, hTTPPortNumber=hTTPPortNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortWirelessDownAlert=dataPortWirelessDownAlert, vectorError=vectorError, vLANManagementVID=vLANManagementVID, sNMPTrapTableNumber=sNMPTrapTableNumber, ethernetGroup=ethernetGroup, wirelessLinkAvailability=wirelessLinkAvailability, cableLoss=cableLoss, incompatibleRegionCodes=incompatibleRegionCodes, telecomsLoopback=telecomsLoopback, constantPowerSpectralDensity=constantPowerSpectralDensity, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, systemReset=systemReset, resetGroup=resetGroup, sNTPServerPortNumber=sNTPServerPortNumber, bootVersion=bootVersion, enabledDiagnosticAlarms=enabledDiagnosticAlarms, capacityLicenseMismatch=capacityLicenseMismatch, subnetMask=subnetMask, dfsPeaks=dfsPeaks, dfsMeans=dfsMeans, wirelessLinkStatus=wirelessLinkStatus, encryptionAlgorithm=encryptionAlgorithm, installStatusTrap=installStatusTrap, telnetPortNumber=telnetPortNumber, telecomsLineCode=telecomsLineCode, installArmStateTrap=installArmStateTrap, managementGroup=managementGroup, ptpTrapPrefix=ptpTrapPrefix, phyControlGroup=phyControlGroup, antennaGain=antennaGain, incompatibleMasterAndSlave=incompatibleMasterAndSlave, channelBandwidth=channelBandwidth, notificationsGroup=notificationsGroup, sntp=sntp)
