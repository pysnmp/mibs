...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, linkLoss=linkLoss, sNMPTrapTableEntry=sNMPTrapTableEntry, subnetMask=subnetMask, ptpCompliance=ptpCompliance, supplementaryGroup=supplementaryGroup, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, installArmState=installArmState, dataPortConfigurationMismatch=dataPortConfigurationMismatch, ptp500=ptp500, tDDSynchronizationStatus=tDDSynchronizationStatus, dataPortStatusTrap=dataPortStatusTrap, signalStrengthRatio=signalStrengthRatio, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, telecom=telecom, receivePower=receivePower, ptpTrapPrefix=ptpTrapPrefix, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sMTPEmailAlert=sMTPEmailAlert, telecomsCableLength=telecomsCableLength, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, vLANPriorityQueueMapping=vLANPriorityQueueMapping, unitOutOfCalibration=unitOutOfCalibration, receiveModulationModeDetail=receiveModulationModeDetail, dfsTableEntry=dfsTableEntry, regionCode=regionCode, sNMPEnabledTraps=sNMPEnabledTraps, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, transmitFreqMHz=transmitFreqMHz, supplementary=supplementary, sNMPTrapIPAddress=sNMPTrapIPAddress, channelBandwidth=channelBandwidth, sNTPServerIPAddress=sNTPServerIPAddress, userPassword=userPassword, tDDControl=tDDControl, softwareVersion=softwareVersion, telecomsLoopbackTrap=telecomsLoopbackTrap, cambium=cambium, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, phyControlGroup=phyControlGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, daylightSaving=daylightSaving, tFTPServerIPAddress=tFTPServerIPAddress, antennaGain=antennaGain, cableLoss=cableLoss, byteErrorRatio=byteErrorRatio, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, telecomGroup=telecomGroup, encryption=encryption, gatewayIPAddress=gatewayIPAddress, telecomsLoopback=telecomsLoopback, sNMPv3Enable=sNMPv3Enable, installStatus=installStatus, productName=productName, dfsMeans=dfsMeans, accessMethod=accessMethod, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, transmitPower=transmitPower, aAAControl=aAAControl, licenceGroup=licenceGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, resetGroup=resetGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPPollInterval=sNTPPollInterval, receiveChannel=receiveChannel, linkModeOptimizationMismatch=linkModeOptimizationMismatch, telecomsInterface=telecomsInterface, dfs=dfs, dfsPeaks=dfsPeaks, productVariant=productVariant, aAAControlGroup=aAAControlGroup, vLANManagementVID=vLANManagementVID, remoteMaximumTransmitPower=remoteMaximumTransmitPower, capacityLicenseMismatch=capacityLicenseMismatch, enabledDiagnosticAlarms=enabledDiagnosticAlarms, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, iPAddress=iPAddress, sNMPTrapVersion=sNMPTrapVersion, management=management, configuration=configuration, telecomsChannelStatus=telecomsChannelStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, phyStatusGroup=phyStatusGroup, versions=versions, configurationGroup=configurationGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, regionCodeTrap=regionCodeTrap, dataPortDisabledWarning=dataPortDisabledWarning, bootVersion=bootVersion, vLANPriorityTable=vLANPriorityTable, transmitFreqKHz=transmitFreqKHz, versionsGroup=versionsGroup, receiveFreqKHz=receiveFreqKHz, userTableEntry=userTableEntry, systemClock=systemClock, longitude=longitude, userEnabled=userEnabled, userTable=userTable, sNMPTrapPortNumber=sNMPTrapPortNumber, userRole=userRole, ptmp=ptmp, userTableIndex=userTableIndex, userTableNumber=userTableNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tDDControlGroup=tDDControlGroup, dfsTable=dfsTable, sNTPLastSync=sNTPLastSync, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, syslogClientTrap=syslogClientTrap, licensedCapacity=licensedCapacity, transmitModulationMode=transmitModulationMode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, snmpControl=snmpControl, constantPowerSpectralDensity=constantPowerSpectralDensity, alarms=alarms, sNTPSync=sNTPSync, frequencyVariant=frequencyVariant, telnetAccessEnabled=telnetAccessEnabled, syslogClient=syslogClient, latitude=latitude, linkName=linkName, transmitChannel=transmitChannel, sNTPSyncTrap=sNTPSyncTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, remoteIPAddress=remoteIPAddress, secondarySoftwareVersion=secondarySoftwareVersion, ptp=ptp, receiveDataRate=receiveDataRate, syslogControl=syslogControl, altitude=altitude, searchState=searchState, sNMPTrapTable=sNMPTrapTable, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, smtpGroup=smtpGroup, linkSymmetry=linkSymmetry, noWirelessChannelAvailable=noWirelessChannelAvailable, transmitDataRate=transmitDataRate, receiveFreqMHz=receiveFreqMHz, sNTPState=sNTPState, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, aggregateDataRate=aggregateDataRate, incompatibleRegionCodes=incompatibleRegionCodes, snmpControlGroup=snmpControlGroup, userName=userName, ethernet=ethernet, pubStatsGroup=pubStatsGroup, wirelessLinkAvailability=wirelessLinkAvailability, sNMPCommunityString=sNMPCommunityString, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, hTTPSAccessEnabled=hTTPSAccessEnabled, tDDSynchronizationMode=tDDSynchronizationMode, dfsTableNumber=dfsTableNumber, phyStatus=phyStatus, pubStats=pubStats, sntp=sntp, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, linkModeOptimisation=linkModeOptimisation, installStatusTrap=installStatusTrap, syslogState=syslogState, ptpGroups=ptpGroups, sntpGroup=sntpGroup, dfsTableIndex=dfsTableIndex, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, masterSlaveMode=masterSlaveMode, alarmsGroup=alarmsGroup, managementGroup=managementGroup, sMTPServerIPAddress=sMTPServerIPAddress, hTTPPortNumber=hTTPPortNumber, licence=licence, encryptionGroup=encryptionGroup, maximumTransmitPower=maximumTransmitPower, smtp=smtp, phyControl=phyControl, vLANPriorityTableIndex=vLANPriorityTableIndex, receiveModulationMode=receiveModulationMode, hardwareVersion=hardwareVersion, tFTPServerPortNumber=tFTPServerPortNumber, ethernetFiberSupport=ethernetFiberSupport, targetMACAddress=targetMACAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, telecomsLineCode=telecomsLineCode, siteName=siteName, timeZone=timeZone, dataPortStatus=dataPortStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, hTTPAccessEnabled=hTTPAccessEnabled, sMTPServerPortNumber=sMTPServerPortNumber, dfsGroup=dfsGroup, syslogControlGroup=syslogControlGroup, sNMPPortNumber=sNMPPortNumber, notificationsGroup=notificationsGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, range=range, sMTPSourceEmailAddress=sMTPSourceEmailAddress, systemReset=systemReset, hTTPSPortNumber=hTTPSPortNumber, bandwidthVariant=bandwidthVariant, syslogStateTrap=syslogStateTrap, installArmStateTrap=installArmStateTrap, groupID=groupID, ethernetGroup=ethernetGroup, eIRP=eIRP, telnetPortNumber=telnetPortNumber, vLANManagementPriority=vLANManagementPriority, sNTPServerPortNumber=sNTPServerPortNumber, encryptionAlgorithm=encryptionAlgorithm, ptpTraps=ptpTraps, vLANPriorityTableEntry=vLANPriorityTableEntry, PYSNMP_MODULE_ID=cambium, dataPortAutoMdix=dataPortAutoMdix, channelChangeTrap=channelChangeTrap, reset=reset, sMTPEnabledMessages=sMTPEnabledMessages, vectorError=vectorError, wirelessLinkStatus=wirelessLinkStatus)
