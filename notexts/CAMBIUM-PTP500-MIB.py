...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", syslogControl=syslogControl, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPv3Enable=sNMPv3Enable, systemClock=systemClock, receiveModulationModeDetail=receiveModulationModeDetail, telecomsInterface=telecomsInterface, sNMPEnabledTraps=sNMPEnabledTraps, wirelessLinkAvailability=wirelessLinkAvailability, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ptmp=ptmp, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dataPortWirelessDownAlert=dataPortWirelessDownAlert, userName=userName, pubStatsGroup=pubStatsGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, receiveDataRate=receiveDataRate, snmpControlGroup=snmpControlGroup, resetGroup=resetGroup, telnetPortNumber=telnetPortNumber, timeZone=timeZone, syslogClientTrap=syslogClientTrap, telecomGroup=telecomGroup, sNTPPollInterval=sNTPPollInterval, tFTPServerIPAddress=tFTPServerIPAddress, groupID=groupID, longitude=longitude, receiveModulationMode=receiveModulationMode, cambium=cambium, telecomsChannelStatus=telecomsChannelStatus, sNTPServerPortNumber=sNTPServerPortNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPPortNumber=sNMPPortNumber, tDDControl=tDDControl, userTableEntry=userTableEntry, vLANPriorityTable=vLANPriorityTable, siteName=siteName, dataPortStatus=dataPortStatus, channelBandwidth=channelBandwidth, dataPortAutoNegotiation=dataPortAutoNegotiation, searchState=searchState, accessMethod=accessMethod, sNMPTrapPortNumber=sNMPTrapPortNumber, notificationsGroup=notificationsGroup, userRole=userRole, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPSync=sNTPSync, supplementaryGroup=supplementaryGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dfsGroup=dfsGroup, remoteIPAddress=remoteIPAddress, sNMPCommunityString=sNMPCommunityString, byteErrorRatio=byteErrorRatio, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, sMTPServerPortNumber=sMTPServerPortNumber, hTTPSPortNumber=hTTPSPortNumber, aggregateDataRate=aggregateDataRate, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, hTTPAccessEnabled=hTTPAccessEnabled, vLANPriorityQueueMapping=vLANPriorityQueueMapping, vLANPriorityTableNumber=vLANPriorityTableNumber, transmitChannel=transmitChannel, linkModeOptimisation=linkModeOptimisation, vLANPriorityTableIndex=vLANPriorityTableIndex, cableLoss=cableLoss, iPAddress=iPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, wirelessLinkStatus=wirelessLinkStatus, syslogClient=syslogClient, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, daylightSaving=daylightSaving, alarmsGroup=alarmsGroup, hTTPPortNumber=hTTPPortNumber, ptp=ptp, smtpGroup=smtpGroup, dfs=dfs, userTable=userTable, dfsMeans=dfsMeans, eIRP=eIRP, softwareVersion=softwareVersion, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, frequencyVariant=frequencyVariant, vLANPriorityTableEntry=vLANPriorityTableEntry, channelChangeTrap=channelChangeTrap, dataPortStatusTrap=dataPortStatusTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, transmitPower=transmitPower, telecomsLineCode=telecomsLineCode, sMTPServerIPAddress=sMTPServerIPAddress, vLANManagementPriority=vLANManagementPriority, syslogControlGroup=syslogControlGroup, receiveFreqKHz=receiveFreqKHz, installStatus=installStatus, encryption=encryption, reset=reset, remoteMaximumTransmitPower=remoteMaximumTransmitPower, productVariant=productVariant, vectorError=vectorError, useVLANForManagementInterfaces=useVLANForManagementInterfaces, regionCode=regionCode, ptp500=ptp500, gatewayIPAddress=gatewayIPAddress, ethernet=ethernet, licence=licence, aAAControl=aAAControl, ptpCompliance=ptpCompliance, sNMPTrapTableEntry=sNMPTrapTableEntry, unitOutOfCalibration=unitOutOfCalibration, incompatibleMasterAndSlave=incompatibleMasterAndSlave, incompatibleRegionCodes=incompatibleRegionCodes, dataPortAutoMdix=dataPortAutoMdix, sNMPTrapIPAddress=sNMPTrapIPAddress, telecomsLoopbackTrap=telecomsLoopbackTrap, secondarySoftwareVersion=secondarySoftwareVersion, maximumTransmitPower=maximumTransmitPower, managementGroup=managementGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, phyStatusGroup=phyStatusGroup, sNTPServerIPAddress=sNTPServerIPAddress, capacityLicenseMismatch=capacityLicenseMismatch, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNTPState=sNTPState, tDDControlGroup=tDDControlGroup, ptpGroups=ptpGroups, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptpTrapPrefix=ptpTrapPrefix, sntp=sntp, bandwidthVariant=bandwidthVariant, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, regionCodeTrap=regionCodeTrap, transmitModulationMode=transmitModulationMode, transmitFreqKHz=transmitFreqKHz, transmitDataRate=transmitDataRate, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, range=range, sMTPEmailAlert=sMTPEmailAlert, ethernetFiberSupport=ethernetFiberSupport, phyStatus=phyStatus, dfsTableIndex=dfsTableIndex, targetMACAddress=targetMACAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPEnabledMessages=sMTPEnabledMessages, hardwareVersion=hardwareVersion, productName=productName, phyControlGroup=phyControlGroup, encryptionAlgorithm=encryptionAlgorithm, noWirelessChannelAvailable=noWirelessChannelAvailable, tDDSynchronizationMode=tDDSynchronizationMode, telnetAccessEnabled=telnetAccessEnabled, syslogLocalWrappedTrap=syslogLocalWrappedTrap, systemReset=systemReset, versions=versions, userPassword=userPassword, userTableNumber=userTableNumber, telecom=telecom, pubStats=pubStats, altitude=altitude, syslogStateTrap=syslogStateTrap, sNMPTrapTable=sNMPTrapTable, ptpTraps=ptpTraps, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tFTPServerPortNumber=tFTPServerPortNumber, installStatusTrap=installStatusTrap, sntpGroup=sntpGroup, alarms=alarms, antennaGain=antennaGain, telecomsLoopback=telecomsLoopback, sNMPTrapVersion=sNMPTrapVersion, transmitFreqMHz=transmitFreqMHz, encryptionGroup=encryptionGroup, subnetMask=subnetMask, receiveFreqMHz=receiveFreqMHz, latitude=latitude, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receiveChannel=receiveChannel, syslogState=syslogState, sNTPSyncTrap=sNTPSyncTrap, versionsGroup=versionsGroup, masterSlaveMode=masterSlaveMode, dataPortDisabledWarning=dataPortDisabledWarning, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, installArmStateTrap=installArmStateTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dfsTable=dfsTable, linkSymmetry=linkSymmetry, snmpControl=snmpControl, management=management, installArmState=installArmState, hTTPSAccessEnabled=hTTPSAccessEnabled, licenceGroup=licenceGroup, linkName=linkName, linkLoss=linkLoss, dfsTableEntry=dfsTableEntry, licensedCapacity=licensedCapacity, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, configuration=configuration, userEnabled=userEnabled, telecomsCableLength=telecomsCableLength, phyControl=phyControl, aAAControlGroup=aAAControlGroup, vLANManagementVID=vLANManagementVID, userTableIndex=userTableIndex, PYSNMP_MODULE_ID=cambium, bootVersion=bootVersion, dfsPeaks=dfsPeaks, constantPowerSpectralDensity=constantPowerSpectralDensity, sNTPLastSync=sNTPLastSync, ethernetGroup=ethernetGroup, receivePower=receivePower, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, signalStrengthRatio=signalStrengthRatio, supplementary=supplementary, dfsTableNumber=dfsTableNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, smtp=smtp, configurationGroup=configurationGroup)
