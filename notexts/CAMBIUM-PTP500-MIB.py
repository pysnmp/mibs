...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, incompatibleRegionCodes=incompatibleRegionCodes, supplementary=supplementary, latitude=latitude, vLANPriorityTableEntry=vLANPriorityTableEntry, licensedCapacity=licensedCapacity, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, encryption=encryption, pubStats=pubStats, receiveFreqMHz=receiveFreqMHz, signalStrengthRatio=signalStrengthRatio, gatewayIPAddress=gatewayIPAddress, groupID=groupID, capacityLicenseMismatch=capacityLicenseMismatch, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, managementGroup=managementGroup, maximumTransmitPower=maximumTransmitPower, configuration=configuration, vLANPriorityQueueMapping=vLANPriorityQueueMapping, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, installArmState=installArmState, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapTableNumber=sNMPTrapTableNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, linkSymmetry=linkSymmetry, cambium=cambium, telecomsInterface=telecomsInterface, systemReset=systemReset, ptmp=ptmp, productName=productName, snmpControlGroup=snmpControlGroup, altitude=altitude, sNMPTrapVersion=sNMPTrapVersion, enabledDiagnosticAlarms=enabledDiagnosticAlarms, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPState=sNTPState, bootVersion=bootVersion, sNTPServerIPAddress=sNTPServerIPAddress, transmitDataRate=transmitDataRate, dataPortAutoMdix=dataPortAutoMdix, tDDSynchronizationAlarm=tDDSynchronizationAlarm, phyStatusGroup=phyStatusGroup, linkModeOptimisation=linkModeOptimisation, telecomsChannelStatus=telecomsChannelStatus, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, hardwareVersion=hardwareVersion, linkLoss=linkLoss, systemClock=systemClock, sntpGroup=sntpGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dfs=dfs, wirelessLinkAvailability=wirelessLinkAvailability, accessMethod=accessMethod, vectorError=vectorError, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, subnetMask=subnetMask, frequencyVariant=frequencyVariant, receivePower=receivePower, wirelessLinkStatus=wirelessLinkStatus, hTTPPortNumber=hTTPPortNumber, syslogClient=syslogClient, licenceGroup=licenceGroup, syslogStateTrap=syslogStateTrap, installStatus=installStatus, userName=userName, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ptp=ptp, antennaGain=antennaGain, installStatusTrap=installStatusTrap, dfsMeans=dfsMeans, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, versionsGroup=versionsGroup, userTableIndex=userTableIndex, resetGroup=resetGroup, userTableEntry=userTableEntry, tDDControl=tDDControl, masterSlaveMode=masterSlaveMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, transmitFreqMHz=transmitFreqMHz, tFTPServerPortNumber=tFTPServerPortNumber, hTTPSPortNumber=hTTPSPortNumber, sNMPCommunityString=sNMPCommunityString, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPLastSync=sNTPLastSync, phyControlGroup=phyControlGroup, aAAControl=aAAControl, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, secondarySoftwareVersion=secondarySoftwareVersion, alarms=alarms, remoteMaximumTransmitPower=remoteMaximumTransmitPower, softwareVersion=softwareVersion, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortDisabledWarning=dataPortDisabledWarning, receiveDataRate=receiveDataRate, regionCodeTrap=regionCodeTrap, siteName=siteName, transmitChannel=transmitChannel, vLANPriorityTableIndex=vLANPriorityTableIndex, range=range, sntp=sntp, receiveChannel=receiveChannel, receiveModulationMode=receiveModulationMode, vLANPriorityTable=vLANPriorityTable, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPServerPortNumber=sNTPServerPortNumber, smtp=smtp, longitude=longitude, telnetPortNumber=telnetPortNumber, vLANManagementVID=vLANManagementVID, sMTPServerPortNumber=sMTPServerPortNumber, telecomsLoopbackTrap=telecomsLoopbackTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNMPPortNumber=sNMPPortNumber, ptpCompliance=ptpCompliance, dfsTableNumber=dfsTableNumber, targetMACAddress=targetMACAddress, alarmsGroup=alarmsGroup, snmpControl=snmpControl, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dfsPeaks=dfsPeaks, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tDDSynchronizationMode=tDDSynchronizationMode, vLANManagementPriority=vLANManagementPriority, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, management=management, dfsGroup=dfsGroup, aAAControlGroup=aAAControlGroup, receiveFreqKHz=receiveFreqKHz, searchState=searchState, constantPowerSpectralDensity=constantPowerSpectralDensity, sNMPEnabledTraps=sNMPEnabledTraps, versions=versions, syslogControl=syslogControl, transmitPower=transmitPower, sNMPTrapTableIndex=sNMPTrapTableIndex, sMTPEnabledMessages=sMTPEnabledMessages, dataPortStatusTrap=dataPortStatusTrap, configurationGroup=configurationGroup, dfsTableEntry=dfsTableEntry, syslogState=syslogState, bandwidthVariant=bandwidthVariant, smtpGroup=smtpGroup, ptpTrapPrefix=ptpTrapPrefix, phyStatus=phyStatus, ptpTraps=ptpTraps, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPv3Enable=sNMPv3Enable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, cableLoss=cableLoss, productVariant=productVariant, dataPortAutoNegotiation=dataPortAutoNegotiation, aggregateDataRate=aggregateDataRate, receiveModulationModeDetail=receiveModulationModeDetail, tFTPServerIPAddress=tFTPServerIPAddress, syslogClientTrap=syslogClientTrap, channelBandwidth=channelBandwidth, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, remoteIPAddress=remoteIPAddress, dfsTableIndex=dfsTableIndex, iPAddress=iPAddress, linkName=linkName, channelChangeTrap=channelChangeTrap, transmitModulationMode=transmitModulationMode, sMTPServerIPAddress=sMTPServerIPAddress, tDDControlGroup=tDDControlGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, transmitFreqKHz=transmitFreqKHz, ethernetFiberSupport=ethernetFiberSupport, sNMPTrapTableEntry=sNMPTrapTableEntry, vLANPriorityTableNumber=vLANPriorityTableNumber, userEnabled=userEnabled, daylightSaving=daylightSaving, phyControl=phyControl, telecomsCableLength=telecomsCableLength, encryptionAlgorithm=encryptionAlgorithm, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, userTable=userTable, hTTPAccessEnabled=hTTPAccessEnabled, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapPortNumber=sNMPTrapPortNumber, PYSNMP_MODULE_ID=cambium, ptp500=ptp500, dfsTable=dfsTable, sNMPTrapTable=sNMPTrapTable, dataPortStatus=dataPortStatus, byteErrorRatio=byteErrorRatio, notificationsGroup=notificationsGroup, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, telecom=telecom, sMTPSourceEmailAddress=sMTPSourceEmailAddress, telecomsLoopback=telecomsLoopback, sNTPSync=sNTPSync, ethernet=ethernet, telecomsChannelStatusTrap=telecomsChannelStatusTrap, supplementaryGroup=supplementaryGroup, sNTPSyncTrap=sNTPSyncTrap, regionCode=regionCode, reset=reset, hTTPSAccessEnabled=hTTPSAccessEnabled, syslogControlGroup=syslogControlGroup, telecomGroup=telecomGroup, ethernetGroup=ethernetGroup, telnetAccessEnabled=telnetAccessEnabled, timeZone=timeZone, userRole=userRole, pubStatsGroup=pubStatsGroup, userPassword=userPassword, ptpGroups=ptpGroups, encryptionGroup=encryptionGroup, userTableNumber=userTableNumber, installArmStateTrap=installArmStateTrap, unitOutOfCalibration=unitOutOfCalibration, sNTPPollInterval=sNTPPollInterval, licence=licence, telecomsLineCode=telecomsLineCode, eIRP=eIRP, syslogLocalWrappedTrap=syslogLocalWrappedTrap)
