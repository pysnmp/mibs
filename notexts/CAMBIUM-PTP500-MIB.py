...
# Produced by pysmi-1.1.3 at Sat Nov 20 21:25:58 2021
...
Gauge32, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, NotificationType, Bits, TimeTicks, enterprises, Counter64, Counter32, ObjectIdentity, Unsigned32, MibIdentifier, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "NotificationType", "Bits", "TimeTicks", "enterprises", "Counter64", "Counter32", "ObjectIdentity", "Unsigned32", "MibIdentifier", "Integer32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", ptp500=ptp500, productName=productName, bandwidthVariant=bandwidthVariant, userPassword=userPassword, versions=versions, signalStrengthRatio=signalStrengthRatio, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, installArmStateTrap=installArmStateTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, vectorError=vectorError, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, sMTPServerIPAddress=sMTPServerIPAddress, vLANPriorityTableEntry=vLANPriorityTableEntry, ptpTraps=ptpTraps, vLANPriorityTableNumber=vLANPriorityTableNumber, timeZone=timeZone, aggregateDataRate=aggregateDataRate, installStatus=installStatus, dfsGroup=dfsGroup, sNMPTrapTable=sNMPTrapTable, sMTPServerPortNumber=sMTPServerPortNumber, dataPortAutoMdix=dataPortAutoMdix, sNTPServerPortNumber=sNTPServerPortNumber, remoteIPAddress=remoteIPAddress, transmitFreqMHz=transmitFreqMHz, transmitChannel=transmitChannel, wirelessLinkStatus=wirelessLinkStatus, telnetPortNumber=telnetPortNumber, targetMACAddress=targetMACAddress, sMTPEmailAlert=sMTPEmailAlert, groupID=groupID, ptpGroups=ptpGroups, receivePower=receivePower, notificationsGroup=notificationsGroup, searchState=searchState, linkName=linkName, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, receiveDataRate=receiveDataRate, wirelessLinkAvailability=wirelessLinkAvailability, vLANPriorityQueueMapping=vLANPriorityQueueMapping, eIRP=eIRP, regionCodeTrap=regionCodeTrap, encryption=encryption, unitOutOfCalibration=unitOutOfCalibration, configurationGroup=configurationGroup, tDDSynchronizationMode=tDDSynchronizationMode, dataPortStatusTrap=dataPortStatusTrap, userTableNumber=userTableNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, byteErrorRatio=byteErrorRatio, cambium=cambium, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, pubStatsGroup=pubStatsGroup, channelChangeTrap=channelChangeTrap, sNTPSyncTrap=sNTPSyncTrap, resetGroup=resetGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPServerIPAddress=sNTPServerIPAddress, licensedCapacity=licensedCapacity, snmpControlGroup=snmpControlGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, systemReset=systemReset, siteName=siteName, ethernetGroup=ethernetGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, telecomGroup=telecomGroup, sNMPv3Enable=sNMPv3Enable, syslogState=syslogState, systemClock=systemClock, sNTPPollInterval=sNTPPollInterval, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, bootVersion=bootVersion, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, alarmsGroup=alarmsGroup, syslogControl=syslogControl, dataPortConfigurationMismatch=dataPortConfigurationMismatch, softwareVersion=softwareVersion, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsTableIndex=dfsTableIndex, telecomsLineCode=telecomsLineCode, sntp=sntp, antennaGain=antennaGain, telecomsInterface=telecomsInterface, phyControl=phyControl, frequencyVariant=frequencyVariant, syslogStateTrap=syslogStateTrap, sNMPPortNumber=sNMPPortNumber, ptp=ptp, channelBandwidth=channelBandwidth, encryptionGroup=encryptionGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, iPAddress=iPAddress, licence=licence, ethernetFiberSupport=ethernetFiberSupport, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapVersion=sNMPTrapVersion, alarms=alarms, aAAControlGroup=aAAControlGroup, dataPortDisabledWarning=dataPortDisabledWarning, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, hTTPPortNumber=hTTPPortNumber, configuration=configuration, ptpTrapPrefix=ptpTrapPrefix, management=management, ptpCompliance=ptpCompliance, snmpControl=snmpControl, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, supplementaryGroup=supplementaryGroup, dfsPeaks=dfsPeaks, gatewayIPAddress=gatewayIPAddress, ethernet=ethernet, phyStatusGroup=phyStatusGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, userEnabled=userEnabled, encryptionAlgorithm=encryptionAlgorithm, incompatibleRegionCodes=incompatibleRegionCodes, userTableEntry=userTableEntry, linkModeOptimizationMismatch=linkModeOptimizationMismatch, linkLoss=linkLoss, aAAControl=aAAControl, latitude=latitude, installArmState=installArmState, pubStats=pubStats, receiveFreqMHz=receiveFreqMHz, telecom=telecom, transmitDataRate=transmitDataRate, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sntpGroup=sntpGroup, cableLoss=cableLoss, telecomsLoopback=telecomsLoopback, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, userName=userName, regionCode=regionCode, productVariant=productVariant, sNMPTrapTableIndex=sNMPTrapTableIndex, accessMethod=accessMethod, vLANManagementVID=vLANManagementVID, telnetAccessEnabled=telnetAccessEnabled, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNTPLastSync=sNTPLastSync, hTTPSPortNumber=hTTPSPortNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, licenceGroup=licenceGroup, smtpGroup=smtpGroup, hardwareVersion=hardwareVersion, subnetMask=subnetMask, receiveModulationMode=receiveModulationMode, PYSNMP_MODULE_ID=cambium, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, vLANPriorityTable=vLANPriorityTable, versionsGroup=versionsGroup, capacityLicenseMismatch=capacityLicenseMismatch, userTableIndex=userTableIndex, longitude=longitude, altitude=altitude, dfs=dfs, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, smtp=smtp, receiveChannel=receiveChannel, transmitFreqKHz=transmitFreqKHz, transmitPower=transmitPower, syslogClient=syslogClient, reset=reset, telecomsChannelStatus=telecomsChannelStatus, supplementary=supplementary, maximumTransmitPower=maximumTransmitPower, sNMPCommunityString=sNMPCommunityString, syslogControlGroup=syslogControlGroup, telecomsChannelStatusTrap=telecomsChannelStatusTrap, range=range, hTTPAccessEnabled=hTTPAccessEnabled, dfsTableNumber=dfsTableNumber, linkSymmetry=linkSymmetry, phyStatus=phyStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, transmitModulationMode=transmitModulationMode, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dfsMeans=dfsMeans, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, linkModeOptimisation=linkModeOptimisation, noWirelessChannelAvailable=noWirelessChannelAvailable, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sMTPEnabledMessages=sMTPEnabledMessages, sNMPEnabledTraps=sNMPEnabledTraps, telecomsCableLength=telecomsCableLength, masterSlaveMode=masterSlaveMode, telecomsLoopbackTrap=telecomsLoopbackTrap, dfsTable=dfsTable, dataPortStatus=dataPortStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfsTableEntry=dfsTableEntry, managementGroup=managementGroup, phyControlGroup=phyControlGroup, tDDControl=tDDControl, tDDControlGroup=tDDControlGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sMTPSourceEmailAddress=sMTPSourceEmailAddress, receiveModulationModeDetail=receiveModulationModeDetail, enabledDiagnosticAlarms=enabledDiagnosticAlarms, hTTPSAccessEnabled=hTTPSAccessEnabled, vLANManagementPriority=vLANManagementPriority, userRole=userRole, tFTPServerIPAddress=tFTPServerIPAddress, installStatusTrap=installStatusTrap, ptmp=ptmp, userTable=userTable, sNMPTrapTableNumber=sNMPTrapTableNumber, daylightSaving=daylightSaving, syslogClientTrap=syslogClientTrap, sNTPState=sNTPState, secondarySoftwareVersion=secondarySoftwareVersion, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPSync=sNTPSync, receiveFreqKHz=receiveFreqKHz)
