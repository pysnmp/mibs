...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, eIRP=eIRP, sNMPTrapTableIndex=sNMPTrapTableIndex, vLANPriorityTableNumber=vLANPriorityTableNumber, byteErrorRatio=byteErrorRatio, dfs=dfs, sNMPv3Enable=sNMPv3Enable, dataPortAutoMdix=dataPortAutoMdix, sntpGroup=sntpGroup, cableLoss=cableLoss, linkLoss=linkLoss, syslogStateTrap=syslogStateTrap, telecomsCableLength=telecomsCableLength, userTableEntry=userTableEntry, dataPortDisabledWarning=dataPortDisabledWarning, sMTPServerIPAddress=sMTPServerIPAddress, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tDDSynchronizationStatus=tDDSynchronizationStatus, wirelessLinkStatus=wirelessLinkStatus, remoteIPAddress=remoteIPAddress, regionCode=regionCode, sNMPTrapIPAddress=sNMPTrapIPAddress, altitude=altitude, sNMPTrapTableEntry=sNMPTrapTableEntry, licenceGroup=licenceGroup, siteName=siteName, transmitFreqKHz=transmitFreqKHz, sNTPSync=sNTPSync, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, capacityLicenseMismatch=capacityLicenseMismatch, iPAddress=iPAddress, userEnabled=userEnabled, configuration=configuration, productName=productName, PYSNMP_MODULE_ID=cambium, pubStats=pubStats, sMTPEnabledMessages=sMTPEnabledMessages, sNTPServerPortNumber=sNTPServerPortNumber, sMTPServerPortNumber=sMTPServerPortNumber, encryptionGroup=encryptionGroup, vLANManagementVID=vLANManagementVID, management=management, syslogControlGroup=syslogControlGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, hTTPSPortNumber=hTTPSPortNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, supplementary=supplementary, userTableNumber=userTableNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, dataPortConfigurationMismatch=dataPortConfigurationMismatch, incompatibleRegionCodes=incompatibleRegionCodes, syslogControl=syslogControl, alarms=alarms, versionsGroup=versionsGroup, dfsGroup=dfsGroup, ptpGroups=ptpGroups, ethernetGroup=ethernetGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, searchState=searchState, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ptpTrapPrefix=ptpTrapPrefix, antennaGain=antennaGain, installStatus=installStatus, reset=reset, subnetMask=subnetMask, syslogClient=syslogClient, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, telnetPortNumber=telnetPortNumber, vLANManagementPriority=vLANManagementPriority, telecomGroup=telecomGroup, transmitModulationMode=transmitModulationMode, vLANPriorityTableEntry=vLANPriorityTableEntry, timeZone=timeZone, masterSlaveMode=masterSlaveMode, hTTPAccessEnabled=hTTPAccessEnabled, maximumTransmitPower=maximumTransmitPower, alarmsGroup=alarmsGroup, smtp=smtp, linkModeOptimisation=linkModeOptimisation, receiveChannel=receiveChannel, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNMPPortNumber=sNMPPortNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsTableIndex=dfsTableIndex, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPEnabledTraps=sNMPEnabledTraps, range=range, aggregateDataRate=aggregateDataRate, aAAControlGroup=aAAControlGroup, bandwidthVariant=bandwidthVariant, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, userTable=userTable, ptpCompliance=ptpCompliance, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, transmitPower=transmitPower, userTableIndex=userTableIndex, hardwareVersion=hardwareVersion, licence=licence, sNMPTrapVersion=sNMPTrapVersion, vLANPriorityTableIndex=vLANPriorityTableIndex, tDDControlGroup=tDDControlGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, syslogState=syslogState, supplementaryGroup=supplementaryGroup, sntp=sntp, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, frequencyVariant=frequencyVariant, wirelessLinkAvailability=wirelessLinkAvailability, aAAControl=aAAControl, snmpControlGroup=snmpControlGroup, dfsPeaks=dfsPeaks, telecomsLoopback=telecomsLoopback, versions=versions, unitOutOfCalibration=unitOutOfCalibration, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNTPServerIPAddress=sNTPServerIPAddress, dfsTable=dfsTable, installArmStateTrap=installArmStateTrap, configurationGroup=configurationGroup, dataPortStatus=dataPortStatus, ptmp=ptmp, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ethernet=ethernet, hTTPPortNumber=hTTPPortNumber, telecomsLoopbackTrap=telecomsLoopbackTrap, systemClock=systemClock, sNTPState=sNTPState, channelBandwidth=channelBandwidth, sNMPCommunityString=sNMPCommunityString, tFTPServerPortNumber=tFTPServerPortNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, ethernetFiberSupport=ethernetFiberSupport, transmitFreqMHz=transmitFreqMHz, cambium=cambium, phyControlGroup=phyControlGroup, ptp=ptp, transmitChannel=transmitChannel, latitude=latitude, sNMPTrapTableNumber=sNMPTrapTableNumber, telecomsChannelStatusTrap=telecomsChannelStatusTrap, vectorError=vectorError, groupID=groupID, notificationsGroup=notificationsGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, noWirelessChannelAvailable=noWirelessChannelAvailable, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tDDSynchronizationMode=tDDSynchronizationMode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, targetMACAddress=targetMACAddress, receiveModulationMode=receiveModulationMode, productVariant=productVariant, regionCodeTrap=regionCodeTrap, receivePower=receivePower, userRole=userRole, sNTPSyncTrap=sNTPSyncTrap, encryption=encryption, pubStatsGroup=pubStatsGroup, sNMPTrapTable=sNMPTrapTable, linkSymmetry=linkSymmetry, receiveFreqMHz=receiveFreqMHz, snmpControl=snmpControl, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, installArmState=installArmState, accessMethod=accessMethod, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, encryptionAlgorithm=encryptionAlgorithm, syslogClientTrap=syslogClientTrap, phyStatus=phyStatus, dfsMeans=dfsMeans, vLANPriorityTable=vLANPriorityTable, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, telecomsChannelStatus=telecomsChannelStatus, dfsTableNumber=dfsTableNumber, transmitDataRate=transmitDataRate, longitude=longitude, daylightSaving=daylightSaving, licensedCapacity=licensedCapacity, telecom=telecom, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, softwareVersion=softwareVersion, receiveModulationModeDetail=receiveModulationModeDetail, constantPowerSpectralDensity=constantPowerSpectralDensity, secondarySoftwareVersion=secondarySoftwareVersion, signalStrengthRatio=signalStrengthRatio, installStatusTrap=installStatusTrap, ptp500=ptp500, tDDControl=tDDControl, telecomsLineCode=telecomsLineCode, systemReset=systemReset, channelChangeTrap=channelChangeTrap, phyControl=phyControl, telnetAccessEnabled=telnetAccessEnabled, userName=userName, userPassword=userPassword, tFTPServerIPAddress=tFTPServerIPAddress, sNTPLastSync=sNTPLastSync, dfsTableEntry=dfsTableEntry, gatewayIPAddress=gatewayIPAddress, ptpTraps=ptpTraps, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, receiveFreqKHz=receiveFreqKHz, receiveDataRate=receiveDataRate, dataPortStatusTrap=dataPortStatusTrap, sMTPEmailAlert=sMTPEmailAlert, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, phyStatusGroup=phyStatusGroup, smtpGroup=smtpGroup, managementGroup=managementGroup, resetGroup=resetGroup, linkName=linkName, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telecomsInterface=telecomsInterface, bootVersion=bootVersion, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPPollInterval=sNTPPollInterval, remoteMaximumTransmitPower=remoteMaximumTransmitPower)
