...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", hardwareVersion=hardwareVersion, ethernet=ethernet, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, antennaGain=antennaGain, ptpTraps=ptpTraps, cambium=cambium, cableLoss=cableLoss, sMTPEmailAlert=sMTPEmailAlert, wirelessLinkAvailability=wirelessLinkAvailability, encryptionAlgorithm=encryptionAlgorithm, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPServerPortNumber=sNTPServerPortNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNTPLastSync=sNTPLastSync, signalStrengthRatio=signalStrengthRatio, smtpGroup=smtpGroup, alarms=alarms, encryption=encryption, resetGroup=resetGroup, sNMPv3Enable=sNMPv3Enable, installStatus=installStatus, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, maximumTransmitPower=maximumTransmitPower, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, telnetAccessEnabled=telnetAccessEnabled, dataPortConfigurationMismatch=dataPortConfigurationMismatch, configurationGroup=configurationGroup, dfsGroup=dfsGroup, regionCodeTrap=regionCodeTrap, telecomsChannelStatus=telecomsChannelStatus, eIRP=eIRP, dataPortAutoMdix=dataPortAutoMdix, searchState=searchState, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, latitude=latitude, byteErrorRatio=byteErrorRatio, remoteIPAddress=remoteIPAddress, masterSlaveMode=masterSlaveMode, sNMPCommunityString=sNMPCommunityString, ptpGroups=ptpGroups, versionsGroup=versionsGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, supplementaryGroup=supplementaryGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPSyncTrap=sNTPSyncTrap, installArmStateTrap=installArmStateTrap, sntp=sntp, sntpGroup=sntpGroup, receiveFreqKHz=receiveFreqKHz, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, phyControl=phyControl, groupID=groupID, telecomsLoopbackTrap=telecomsLoopbackTrap, incompatibleRegionCodes=incompatibleRegionCodes, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, systemReset=systemReset, sNTPServerIPAddress=sNTPServerIPAddress, altitude=altitude, phyControlGroup=phyControlGroup, ethernetGroup=ethernetGroup, phyStatus=phyStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, noWirelessChannelAvailable=noWirelessChannelAvailable, vectorError=vectorError, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, userTableEntry=userTableEntry, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, receivePower=receivePower, hTTPAccessEnabled=hTTPAccessEnabled, dataPortStatus=dataPortStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, PYSNMP_MODULE_ID=cambium, syslogControlGroup=syslogControlGroup, vLANPriorityTable=vLANPriorityTable, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, supplementary=supplementary, channelBandwidth=channelBandwidth, userTable=userTable, sNMPTrapTable=sNMPTrapTable, productVariant=productVariant, linkLoss=linkLoss, aAAControlGroup=aAAControlGroup, telecom=telecom, softwareVersion=softwareVersion, syslogControl=syslogControl, phyStatusGroup=phyStatusGroup, telecomsCableLength=telecomsCableLength, hTTPPortNumber=hTTPPortNumber, syslogState=syslogState, licensedCapacity=licensedCapacity, sNMPEnabledTraps=sNMPEnabledTraps, telnetPortNumber=telnetPortNumber, versions=versions, telecomGroup=telecomGroup, management=management, targetMACAddress=targetMACAddress, range=range, userPassword=userPassword, tFTPServerIPAddress=tFTPServerIPAddress, hTTPSPortNumber=hTTPSPortNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, linkModeOptimisation=linkModeOptimisation, tDDSynchronizationStatus=tDDSynchronizationStatus, vLANPriorityTableIndex=vLANPriorityTableIndex, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, regionCode=regionCode, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, siteName=siteName, pubStats=pubStats, unitOutOfCalibration=unitOutOfCalibration, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dfsTable=dfsTable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, transmitDataRate=transmitDataRate, configuration=configuration, bandwidthVariant=bandwidthVariant, snmpControl=snmpControl, linkModeOptimizationMismatch=linkModeOptimizationMismatch, daylightSaving=daylightSaving, dataPortStatusTrap=dataPortStatusTrap, systemClock=systemClock, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitFreqKHz=transmitFreqKHz, sNMPPortNumber=sNMPPortNumber, tDDControlGroup=tDDControlGroup, dfsTableEntry=dfsTableEntry, ptmp=ptmp, transmitPower=transmitPower, longitude=longitude, telecomsInterface=telecomsInterface, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tDDControl=tDDControl, telecomsLoopback=telecomsLoopback, dataPortAutoNegotiation=dataPortAutoNegotiation, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, installArmState=installArmState, transmitChannel=transmitChannel, userRole=userRole, encryptionGroup=encryptionGroup, managementGroup=managementGroup, userTableIndex=userTableIndex, dataPortDisabledWarning=dataPortDisabledWarning, capacityLicenseMismatch=capacityLicenseMismatch, productName=productName, sMTPServerPortNumber=sMTPServerPortNumber, transmitModulationMode=transmitModulationMode, constantPowerSpectralDensity=constantPowerSpectralDensity, hTTPSAccessEnabled=hTTPSAccessEnabled, wirelessLinkStatus=wirelessLinkStatus, ptpCompliance=ptpCompliance, receiveFreqMHz=receiveFreqMHz, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, licence=licence, alarmsGroup=alarmsGroup, channelChangeTrap=channelChangeTrap, ptpTrapPrefix=ptpTrapPrefix, receiveModulationModeDetail=receiveModulationModeDetail, linkSymmetry=linkSymmetry, sNMPTrapVersion=sNMPTrapVersion, ptp=ptp, tDDSynchronizationMode=tDDSynchronizationMode, syslogStateTrap=syslogStateTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, enabledDiagnosticAlarms=enabledDiagnosticAlarms, transmitFreqMHz=transmitFreqMHz, secondarySoftwareVersion=secondarySoftwareVersion, installStatusTrap=installStatusTrap, ptp500=ptp500, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telecomsLineCode=telecomsLineCode, receiveModulationMode=receiveModulationMode, syslogClientTrap=syslogClientTrap, tFTPServerPortNumber=tFTPServerPortNumber, sMTPServerIPAddress=sMTPServerIPAddress, subnetMask=subnetMask, frequencyVariant=frequencyVariant, accessMethod=accessMethod, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dfs=dfs, bootVersion=bootVersion, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dfsPeaks=dfsPeaks, notificationsGroup=notificationsGroup, userName=userName, linkName=linkName, receiveChannel=receiveChannel, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, aggregateDataRate=aggregateDataRate, dfsTableNumber=dfsTableNumber, sNTPState=sNTPState, sNTPPollInterval=sNTPPollInterval, snmpControlGroup=snmpControlGroup, pubStatsGroup=pubStatsGroup, vLANManagementPriority=vLANManagementPriority, gatewayIPAddress=gatewayIPAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, aAAControl=aAAControl, sNTPSync=sNTPSync, timeZone=timeZone, receiveDataRate=receiveDataRate, syslogClient=syslogClient, smtp=smtp, dfsMeans=dfsMeans, vLANPriorityTableNumber=vLANPriorityTableNumber, vLANPriorityQueueMapping=vLANPriorityQueueMapping, dfsTableIndex=dfsTableIndex, licenceGroup=licenceGroup, userTableNumber=userTableNumber, userEnabled=userEnabled, ethernetFiberSupport=ethernetFiberSupport, iPAddress=iPAddress, vLANManagementVID=vLANManagementVID, sMTPEnabledMessages=sMTPEnabledMessages, reset=reset)
