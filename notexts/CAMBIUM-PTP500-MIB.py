...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sNMPTrapTableEntry=sNMPTrapTableEntry, telecomsLineCode=telecomsLineCode, targetMACAddress=targetMACAddress, licensedCapacity=licensedCapacity, useVLANForManagementInterfaces=useVLANForManagementInterfaces, incompatibleRegionCodes=incompatibleRegionCodes, userTable=userTable, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, wirelessLinkStatus=wirelessLinkStatus, sNTPPollInterval=sNTPPollInterval, hardwareVersion=hardwareVersion, versionsGroup=versionsGroup, groupID=groupID, sNTPServerIPAddress=sNTPServerIPAddress, telecomsChannelStatusTrap=telecomsChannelStatusTrap, encryptionGroup=encryptionGroup, aAAControl=aAAControl, supplementaryGroup=supplementaryGroup, antennaGain=antennaGain, sNTPServerPortNumber=sNTPServerPortNumber, encryptionAlgorithm=encryptionAlgorithm, ptmp=ptmp, cambium=cambium, vectorError=vectorError, tDDControlGroup=tDDControlGroup, telnetPortNumber=telnetPortNumber, dfsMeans=dfsMeans, iPAddress=iPAddress, telecomsInterface=telecomsInterface, wirelessLinkAvailability=wirelessLinkAvailability, transmitDataRate=transmitDataRate, licenceGroup=licenceGroup, capacityLicenseMismatch=capacityLicenseMismatch, sNMPTrapIPAddress=sNMPTrapIPAddress, receivePower=receivePower, aggregateDataRate=aggregateDataRate, transmitModulationMode=transmitModulationMode, configuration=configuration, alarmsGroup=alarmsGroup, ptpTrapPrefix=ptpTrapPrefix, telecomsChannelStatus=telecomsChannelStatus, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, userRole=userRole, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tDDSynchronizationMode=tDDSynchronizationMode, installArmState=installArmState, snmpControl=snmpControl, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dfs=dfs, transmitPower=transmitPower, secondarySoftwareVersion=secondarySoftwareVersion, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, tDDControl=tDDControl, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkLoss=linkLoss, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, transmitChannel=transmitChannel, userName=userName, resetGroup=resetGroup, channelChangeTrap=channelChangeTrap, ethernet=ethernet, syslogClient=syslogClient, timeZone=timeZone, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPLastSync=sNTPLastSync, byteErrorRatio=byteErrorRatio, eIRP=eIRP, hTTPSPortNumber=hTTPSPortNumber, receiveFreqKHz=receiveFreqKHz, masterSlaveMode=masterSlaveMode, telecomsLoopback=telecomsLoopback, licence=licence, dfsGroup=dfsGroup, regionCode=regionCode, dataPortConfigurationMismatch=dataPortConfigurationMismatch, reset=reset, dfsTableIndex=dfsTableIndex, vLANManagementPriority=vLANManagementPriority, userPassword=userPassword, telecomGroup=telecomGroup, aAAControlGroup=aAAControlGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, hTTPAccessEnabled=hTTPAccessEnabled, sNMPEnabledTraps=sNMPEnabledTraps, management=management, gatewayIPAddress=gatewayIPAddress, telecom=telecom, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapPortNumber=sNMPTrapPortNumber, dfsTableEntry=dfsTableEntry, dfsPeaks=dfsPeaks, remoteIPAddress=remoteIPAddress, productName=productName, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, maximumTransmitPower=maximumTransmitPower, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, syslogControlGroup=syslogControlGroup, syslogStateTrap=syslogStateTrap, linkModeOptimisation=linkModeOptimisation, syslogState=syslogState, sNMPv3Enable=sNMPv3Enable, pubStats=pubStats, bandwidthVariant=bandwidthVariant, vLANPriorityTableEntry=vLANPriorityTableEntry, sMTPEnabledMessages=sMTPEnabledMessages, range=range, frequencyVariant=frequencyVariant, systemClock=systemClock, userEnabled=userEnabled, dataPortDisabledWarning=dataPortDisabledWarning, installArmStateTrap=installArmStateTrap, sMTPServerIPAddress=sMTPServerIPAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ptpGroups=ptpGroups, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, bootVersion=bootVersion, userTableEntry=userTableEntry, tFTPServerPortNumber=tFTPServerPortNumber, ptp=ptp, accessMethod=accessMethod, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receiveChannel=receiveChannel, cableLoss=cableLoss, ptpTraps=ptpTraps, linkSymmetry=linkSymmetry, sNTPSyncTrap=sNTPSyncTrap, regionCodeTrap=regionCodeTrap, supplementary=supplementary, smtp=smtp, subnetMask=subnetMask, telecomsCableLength=telecomsCableLength, ethernetGroup=ethernetGroup, managementGroup=managementGroup, siteName=siteName, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, softwareVersion=softwareVersion, phyStatusGroup=phyStatusGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNMPPortNumber=sNMPPortNumber, sNMPCommunityString=sNMPCommunityString, linkName=linkName, sMTPServerPortNumber=sMTPServerPortNumber, vLANPriorityQueueMapping=vLANPriorityQueueMapping, altitude=altitude, remoteMaximumTransmitPower=remoteMaximumTransmitPower, vLANPriorityTableNumber=vLANPriorityTableNumber, dataPortStatusTrap=dataPortStatusTrap, hTTPPortNumber=hTTPPortNumber, longitude=longitude, productVariant=productVariant, telecomsLoopbackTrap=telecomsLoopbackTrap, dfsTableNumber=dfsTableNumber, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, encryption=encryption, telnetAccessEnabled=telnetAccessEnabled, sNTPState=sNTPState, sNMPTrapVersion=sNMPTrapVersion, channelBandwidth=channelBandwidth, daylightSaving=daylightSaving, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNTPSync=sNTPSync, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortAutoNegotiation=dataPortAutoNegotiation, tDDSynchronizationStatus=tDDSynchronizationStatus, smtpGroup=smtpGroup, userTableNumber=userTableNumber, vLANPriorityTable=vLANPriorityTable, ptpCompliance=ptpCompliance, snmpControlGroup=snmpControlGroup, pubStatsGroup=pubStatsGroup, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, installStatusTrap=installStatusTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, vLANPriorityTableIndex=vLANPriorityTableIndex, phyControl=phyControl, notificationsGroup=notificationsGroup, systemReset=systemReset, signalStrengthRatio=signalStrengthRatio, latitude=latitude, dfsTable=dfsTable, PYSNMP_MODULE_ID=cambium, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, receiveModulationModeDetail=receiveModulationModeDetail, ethernetFiberSupport=ethernetFiberSupport, hTTPSAccessEnabled=hTTPSAccessEnabled, syslogLocalWrappedTrap=syslogLocalWrappedTrap, vLANManagementVID=vLANManagementVID, dataPortWirelessDownAlert=dataPortWirelessDownAlert, syslogControl=syslogControl, dataPortStatus=dataPortStatus, alarms=alarms, incompatibleMasterAndSlave=incompatibleMasterAndSlave, unitOutOfCalibration=unitOutOfCalibration, receiveDataRate=receiveDataRate, versions=versions, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, tFTPServerIPAddress=tFTPServerIPAddress, sntp=sntp, searchState=searchState, sntpGroup=sntpGroup, syslogClientTrap=syslogClientTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, transmitFreqMHz=transmitFreqMHz, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPTrapTable=sNMPTrapTable, dataPortAutoMdix=dataPortAutoMdix, userTableIndex=userTableIndex, configurationGroup=configurationGroup, phyStatus=phyStatus, receiveModulationMode=receiveModulationMode, phyControlGroup=phyControlGroup, ptp500=ptp500, receiveFreqMHz=receiveFreqMHz, installStatus=installStatus, constantPowerSpectralDensity=constantPowerSpectralDensity, transmitFreqKHz=transmitFreqKHz)
