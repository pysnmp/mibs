...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", alarmsGroup=alarmsGroup, longitude=longitude, enabledDiagnosticAlarms=enabledDiagnosticAlarms, constantPowerSpectralDensity=constantPowerSpectralDensity, userTable=userTable, userPassword=userPassword, softwareVersion=softwareVersion, masterSlaveMode=masterSlaveMode, tDDControlGroup=tDDControlGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, encryptionAlgorithm=encryptionAlgorithm, configuration=configuration, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, regionCode=regionCode, sNMPTrapPortNumber=sNMPTrapPortNumber, vLANManagementPriority=vLANManagementPriority, dataPortDisabledWarning=dataPortDisabledWarning, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, licensedCapacity=licensedCapacity, receiveModulationMode=receiveModulationMode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, management=management, ethernet=ethernet, targetMACAddress=targetMACAddress, telecomsChannelStatusTrap=telecomsChannelStatusTrap, smtpGroup=smtpGroup, dfsMeans=dfsMeans, syslogControlGroup=syslogControlGroup, phyControlGroup=phyControlGroup, receiveFreqMHz=receiveFreqMHz, telecomsInterface=telecomsInterface, encryptionGroup=encryptionGroup, telecomsLineCode=telecomsLineCode, tFTPServerPortNumber=tFTPServerPortNumber, installArmStateTrap=installArmStateTrap, resetGroup=resetGroup, telecomGroup=telecomGroup, telecomsLoopback=telecomsLoopback, dfsTableIndex=dfsTableIndex, sMTPEmailAlert=sMTPEmailAlert, gatewayIPAddress=gatewayIPAddress, sNTPState=sNTPState, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, hTTPAccessEnabled=hTTPAccessEnabled, iPAddress=iPAddress, incompatibleRegionCodes=incompatibleRegionCodes, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, installStatusTrap=installStatusTrap, systemClock=systemClock, syslogControl=syslogControl, transmitChannel=transmitChannel, sntp=sntp, sNTPLastSync=sNTPLastSync, linkLoss=linkLoss, syslogState=syslogState, range=range, telnetPortNumber=telnetPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, vLANPriorityTableEntry=vLANPriorityTableEntry, tDDControl=tDDControl, sNMPTrapTableEntry=sNMPTrapTableEntry, wirelessLinkAvailability=wirelessLinkAvailability, userRole=userRole, hTTPSPortNumber=hTTPSPortNumber, snmpControlGroup=snmpControlGroup, sMTPServerPortNumber=sMTPServerPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, hTTPPortNumber=hTTPPortNumber, linkModeOptimisation=linkModeOptimisation, ptpCompliance=ptpCompliance, snmpControl=snmpControl, sNTPServerPortNumber=sNTPServerPortNumber, regionCodeTrap=regionCodeTrap, versionsGroup=versionsGroup, syslogStateTrap=syslogStateTrap, cambium=cambium, linkSymmetry=linkSymmetry, aggregateDataRate=aggregateDataRate, ptpGroups=ptpGroups, licenceGroup=licenceGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, userTableEntry=userTableEntry, phyStatus=phyStatus, searchState=searchState, incompatibleMasterAndSlave=incompatibleMasterAndSlave, configurationGroup=configurationGroup, dfsGroup=dfsGroup, telecom=telecom, ethernetGroup=ethernetGroup, notificationsGroup=notificationsGroup, ethernetFiberSupport=ethernetFiberSupport, linkModeOptimizationMismatch=linkModeOptimizationMismatch, hTTPSAccessEnabled=hTTPSAccessEnabled, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, channelBandwidth=channelBandwidth, eIRP=eIRP, alarms=alarms, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortWirelessDownAlert=dataPortWirelessDownAlert, installArmState=installArmState, groupID=groupID, receiveModulationModeDetail=receiveModulationModeDetail, encryption=encryption, ptp500=ptp500, sNMPv3Enable=sNMPv3Enable, ptp=ptp, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, maximumTransmitPower=maximumTransmitPower, accessMethod=accessMethod, productVariant=productVariant, sNTPServerIPAddress=sNTPServerIPAddress, secondarySoftwareVersion=secondarySoftwareVersion, dfsTableNumber=dfsTableNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptmp=ptmp, dataPortConfigurationMismatch=dataPortConfigurationMismatch, wirelessLinkStatus=wirelessLinkStatus, systemReset=systemReset, tFTPServerIPAddress=tFTPServerIPAddress, supplementaryGroup=supplementaryGroup, managementGroup=managementGroup, subnetMask=subnetMask, useVLANForManagementInterfaces=useVLANForManagementInterfaces, userEnabled=userEnabled, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, transmitDataRate=transmitDataRate, transmitFreqKHz=transmitFreqKHz, receiveDataRate=receiveDataRate, PYSNMP_MODULE_ID=cambium, reset=reset, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, tDDSynchronizationMode=tDDSynchronizationMode, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, vLANManagementVID=vLANManagementVID, transmitPower=transmitPower, vLANPriorityQueueMapping=vLANPriorityQueueMapping, latitude=latitude, timeZone=timeZone, phyControl=phyControl, productName=productName, siteName=siteName, transmitModulationMode=transmitModulationMode, dataPortAutoMdix=dataPortAutoMdix, sNMPTrapIPAddress=sNMPTrapIPAddress, byteErrorRatio=byteErrorRatio, bandwidthVariant=bandwidthVariant, sNMPTrapTableNumber=sNMPTrapTableNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, aAAControl=aAAControl, altitude=altitude, daylightSaving=daylightSaving, telecomsLoopbackTrap=telecomsLoopbackTrap, smtp=smtp, frequencyVariant=frequencyVariant, dfsTableEntry=dfsTableEntry, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, receiveChannel=receiveChannel, capacityLicenseMismatch=capacityLicenseMismatch, channelChangeTrap=channelChangeTrap, dataPortStatusTrap=dataPortStatusTrap, sMTPServerIPAddress=sMTPServerIPAddress, aAAControlGroup=aAAControlGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPEnabledTraps=sNMPEnabledTraps, pubStatsGroup=pubStatsGroup, versions=versions, sNTPSync=sNTPSync, pubStats=pubStats, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sntpGroup=sntpGroup, dataPortStatus=dataPortStatus, installStatus=installStatus, transmitFreqMHz=transmitFreqMHz, ptpTrapPrefix=ptpTrapPrefix, receiveFreqKHz=receiveFreqKHz, sNMPTrapTable=sNMPTrapTable, dfs=dfs, receivePower=receivePower, ptpTraps=ptpTraps, sNTPPollInterval=sNTPPollInterval, licence=licence, userName=userName, sNMPCommunityString=sNMPCommunityString, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, hardwareVersion=hardwareVersion, dfsTable=dfsTable, tDDSynchronizationAlarm=tDDSynchronizationAlarm, userTableIndex=userTableIndex, antennaGain=antennaGain, phyStatusGroup=phyStatusGroup, vLANPriorityTable=vLANPriorityTable, remoteIPAddress=remoteIPAddress, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, syslogClient=syslogClient, telecomsChannelStatus=telecomsChannelStatus, tDDSynchronizationStatus=tDDSynchronizationStatus, userTableNumber=userTableNumber, syslogClientTrap=syslogClientTrap, vectorError=vectorError, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, telnetAccessEnabled=telnetAccessEnabled, bootVersion=bootVersion, sNTPSyncTrap=sNTPSyncTrap, unitOutOfCalibration=unitOutOfCalibration, linkName=linkName, telecomsCableLength=telecomsCableLength, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, supplementary=supplementary, signalStrengthRatio=signalStrengthRatio, sNMPPortNumber=sNMPPortNumber, cableLoss=cableLoss, sNMPTrapVersion=sNMPTrapVersion, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, dfsPeaks=dfsPeaks, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex)
