...
# Produced by pysmi-1.1.8 at Fri Jan  7 16:54:37 2022
...
Unsigned32, IpAddress, MibIdentifier, Counter32, TimeTicks, ModuleIdentity, enterprises, iso, Bits, Counter64, NotificationType, ObjectIdentity, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "MibIdentifier", "Counter32", "TimeTicks", "ModuleIdentity", "enterprises", "iso", "Bits", "Counter64", "NotificationType", "ObjectIdentity", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", secondarySoftwareVersion=secondarySoftwareVersion, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPEnabledTraps=sNMPEnabledTraps, transmitFreqKHz=transmitFreqKHz, syslogControlGroup=syslogControlGroup, tDDControlGroup=tDDControlGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPv3Enable=sNMPv3Enable, userTableNumber=userTableNumber, sMTPEnabledMessages=sMTPEnabledMessages, regionCodeTrap=regionCodeTrap, tDDControl=tDDControl, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, encryptionGroup=encryptionGroup, phyStatus=phyStatus, targetMACAddress=targetMACAddress, sNTPServerPortNumber=sNTPServerPortNumber, altitude=altitude, accessMethod=accessMethod, byteErrorRatio=byteErrorRatio, maximumTransmitPower=maximumTransmitPower, ptpGroups=ptpGroups, sNMPTrapTable=sNMPTrapTable, incompatibleMasterAndSlave=incompatibleMasterAndSlave, hTTPSAccessEnabled=hTTPSAccessEnabled, vLANPriorityTableIndex=vLANPriorityTableIndex, telecomsLineCode=telecomsLineCode, hTTPSPortNumber=hTTPSPortNumber, ptmp=ptmp, searchState=searchState, sNMPTrapIPAddress=sNMPTrapIPAddress, systemClock=systemClock, syslogStateTrap=syslogStateTrap, dfsPeaks=dfsPeaks, dataPortAutoNegotiation=dataPortAutoNegotiation, noWirelessChannelAvailable=noWirelessChannelAvailable, PYSNMP_MODULE_ID=cambium, vLANPriorityTable=vLANPriorityTable, userEnabled=userEnabled, installArmState=installArmState, receiveModulationModeDetail=receiveModulationModeDetail, subnetMask=subnetMask, transmitChannel=transmitChannel, linkName=linkName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPPortNumber=sNMPPortNumber, sNTPSync=sNTPSync, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ethernetFiberSupport=ethernetFiberSupport, sNMPTrapVersion=sNMPTrapVersion, smtpGroup=smtpGroup, smtp=smtp, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNTPServerIPAddress=sNTPServerIPAddress, installStatusTrap=installStatusTrap, sNMPCommunityString=sNMPCommunityString, transmitDataRate=transmitDataRate, encryptionAlgorithm=encryptionAlgorithm, pubStatsGroup=pubStatsGroup, telecomsLoopback=telecomsLoopback, systemReset=systemReset, ptp500=ptp500, sMTPEmailAlert=sMTPEmailAlert, telecom=telecom, pubStats=pubStats, snmpControlGroup=snmpControlGroup, notificationsGroup=notificationsGroup, linkSymmetry=linkSymmetry, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortAutoMdix=dataPortAutoMdix, dfsTableIndex=dfsTableIndex, telecomsChannelStatusTrap=telecomsChannelStatusTrap, softwareVersion=softwareVersion, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, configuration=configuration, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ptpCompliance=ptpCompliance, sMTPServerIPAddress=sMTPServerIPAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, syslogClient=syslogClient, bootVersion=bootVersion, userName=userName, masterSlaveMode=masterSlaveMode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ethernet=ethernet, unitOutOfCalibration=unitOutOfCalibration, resetGroup=resetGroup, sNTPLastSync=sNTPLastSync, hardwareVersion=hardwareVersion, regionCode=regionCode, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, sMTPSourceEmailAddress=sMTPSourceEmailAddress, wirelessLinkStatus=wirelessLinkStatus, versions=versions, telnetPortNumber=telnetPortNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, versionsGroup=versionsGroup, gatewayIPAddress=gatewayIPAddress, receiveChannel=receiveChannel, licence=licence, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, receiveFreqKHz=receiveFreqKHz, linkModeOptimisation=linkModeOptimisation, supplementaryGroup=supplementaryGroup, phyStatusGroup=phyStatusGroup, hTTPPortNumber=hTTPPortNumber, dataPortConfigurationMismatch=dataPortConfigurationMismatch, groupID=groupID, userTableIndex=userTableIndex, frequencyVariant=frequencyVariant, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPTrapTableIndex=sNMPTrapTableIndex, aAAControlGroup=aAAControlGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, range=range, management=management, sNTPPollInterval=sNTPPollInterval, vLANPriorityTableEntry=vLANPriorityTableEntry, tDDSynchronizationMode=tDDSynchronizationMode, sNTPSyncTrap=sNTPSyncTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, installArmStateTrap=installArmStateTrap, dataPortStatus=dataPortStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, licenceGroup=licenceGroup, ptp=ptp, sNMPTrapPortNumber=sNMPTrapPortNumber, sMTPServerPortNumber=sMTPServerPortNumber, aggregateDataRate=aggregateDataRate, telecomsCableLength=telecomsCableLength, vLANManagementVID=vLANManagementVID, alarms=alarms, ptpTraps=ptpTraps, syslogControl=syslogControl, incompatibleRegionCodes=incompatibleRegionCodes, capacityLicenseMismatch=capacityLicenseMismatch, reset=reset, vLANPriorityQueueMapping=vLANPriorityQueueMapping, receiveDataRate=receiveDataRate, timeZone=timeZone, telnetAccessEnabled=telnetAccessEnabled, signalStrengthRatio=signalStrengthRatio, productName=productName, managementGroup=managementGroup, syslogClientTrap=syslogClientTrap, sntpGroup=sntpGroup, transmitPower=transmitPower, wirelessLinkAvailability=wirelessLinkAvailability, channelChangeTrap=channelChangeTrap, cableLoss=cableLoss, telecomsChannelStatus=telecomsChannelStatus, vLANManagementPriority=vLANManagementPriority, receivePower=receivePower, vectorError=vectorError, dataPortDisabledWarning=dataPortDisabledWarning, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dfsTableNumber=dfsTableNumber, channelBandwidth=channelBandwidth, telecomsLoopbackTrap=telecomsLoopbackTrap, ptpTrapPrefix=ptpTrapPrefix, remoteIPAddress=remoteIPAddress, dfs=dfs, licensedCapacity=licensedCapacity, userPassword=userPassword, syslogState=syslogState, dataPortStatusTrap=dataPortStatusTrap, cambium=cambium, sntp=sntp, phyControl=phyControl, dfsMeans=dfsMeans, encryption=encryption, configurationGroup=configurationGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, receiveFreqMHz=receiveFreqMHz, hTTPAccessEnabled=hTTPAccessEnabled, longitude=longitude, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, userRole=userRole, userTable=userTable, daylightSaving=daylightSaving, dataPortWirelessDownAlert=dataPortWirelessDownAlert, latitude=latitude, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, telecomsInterface=telecomsInterface, vLANPriorityTableNumber=vLANPriorityTableNumber, aAAControl=aAAControl, receiveModulationMode=receiveModulationMode, bandwidthVariant=bandwidthVariant, tFTPServerPortNumber=tFTPServerPortNumber, dfsTable=dfsTable, sNTPState=sNTPState, sNMPTrapTableNumber=sNMPTrapTableNumber, iPAddress=iPAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dfsGroup=dfsGroup, siteName=siteName, transmitModulationMode=transmitModulationMode, transmitFreqMHz=transmitFreqMHz, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ethernetGroup=ethernetGroup, productVariant=productVariant, userTableEntry=userTableEntry, snmpControl=snmpControl, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, telecomGroup=telecomGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, antennaGain=antennaGain, phyControlGroup=phyControlGroup, alarmsGroup=alarmsGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, linkLoss=linkLoss, dfsTableEntry=dfsTableEntry, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, installStatus=installStatus, tFTPServerIPAddress=tFTPServerIPAddress, eIRP=eIRP, supplementary=supplementary)
