...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", dataPortWirelessDownAlert=dataPortWirelessDownAlert, dfsTableNumber=dfsTableNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, bootVersion=bootVersion, supplementary=supplementary, userPassword=userPassword, telecomGroup=telecomGroup, syslogControlGroup=syslogControlGroup, management=management, phyControl=phyControl, hTTPSAccessEnabled=hTTPSAccessEnabled, installArmState=installArmState, vLANManagementPriority=vLANManagementPriority, antennaGain=antennaGain, userTableIndex=userTableIndex, sMTPServerPortNumber=sMTPServerPortNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, aggregateDataRate=aggregateDataRate, userTableNumber=userTableNumber, sntpGroup=sntpGroup, transmitChannel=transmitChannel, ethernet=ethernet, supplementaryGroup=supplementaryGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, productVariant=productVariant, range=range, phyStatusGroup=phyStatusGroup, snmpControlGroup=snmpControlGroup, incompatibleRegionCodes=incompatibleRegionCodes, telecom=telecom, productName=productName, transmitFreqMHz=transmitFreqMHz, useVLANForManagementInterfaces=useVLANForManagementInterfaces, userTable=userTable, dataPortAutoNegotiation=dataPortAutoNegotiation, syslogLocalWrappedTrap=syslogLocalWrappedTrap, longitude=longitude, dataPortStatus=dataPortStatus, ptp=ptp, byteErrorRatio=byteErrorRatio, frequencyVariant=frequencyVariant, ethernetGroup=ethernetGroup, configurationGroup=configurationGroup, reset=reset, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPv3Enable=sNMPv3Enable, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPPortNumber=sNMPPortNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, telecomsLineCode=telecomsLineCode, noWirelessChannelAvailable=noWirelessChannelAvailable, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfsTableEntry=dfsTableEntry, receiveFreqKHz=receiveFreqKHz, groupID=groupID, dfsGroup=dfsGroup, capacityLicenseMismatch=capacityLicenseMismatch, versionsGroup=versionsGroup, dfsTableIndex=dfsTableIndex, syslogControl=syslogControl, ptpTraps=ptpTraps, aAAControl=aAAControl, installStatusTrap=installStatusTrap, pubStatsGroup=pubStatsGroup, tDDSynchronizationMode=tDDSynchronizationMode, hardwareVersion=hardwareVersion, masterSlaveMode=masterSlaveMode, syslogClientTrap=syslogClientTrap, telnetPortNumber=telnetPortNumber, latitude=latitude, snmpControl=snmpControl, regionCode=regionCode, linkModeOptimisation=linkModeOptimisation, sNMPTrapPortNumber=sNMPTrapPortNumber, sntp=sntp, softwareVersion=softwareVersion, dataPortStatusTrap=dataPortStatusTrap, sNMPEnabledTraps=sNMPEnabledTraps, alarmsGroup=alarmsGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ptmp=ptmp, receiveFreqMHz=receiveFreqMHz, encryption=encryption, sNTPServerIPAddress=sNTPServerIPAddress, sMTPEmailAlert=sMTPEmailAlert, systemReset=systemReset, vLANPriorityTable=vLANPriorityTable, receivePower=receivePower, transmitModulationMode=transmitModulationMode, resetGroup=resetGroup, telecomsCableLength=telecomsCableLength, sNTPState=sNTPState, encryptionAlgorithm=encryptionAlgorithm, sNTPLastSync=sNTPLastSync, siteName=siteName, syslogStateTrap=syslogStateTrap, channelChangeTrap=channelChangeTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, receiveModulationModeDetail=receiveModulationModeDetail, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, phyControlGroup=phyControlGroup, timeZone=timeZone, vLANPriorityTableEntry=vLANPriorityTableEntry, receiveDataRate=receiveDataRate, signalStrengthRatio=signalStrengthRatio, tDDControlGroup=tDDControlGroup, telnetAccessEnabled=telnetAccessEnabled, constantPowerSpectralDensity=constantPowerSpectralDensity, transmitPower=transmitPower, ptpTrapPrefix=ptpTrapPrefix, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, notificationsGroup=notificationsGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, telecomsLoopback=telecomsLoopback, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPTrapVersion=sNMPTrapVersion, smtp=smtp, sNTPPollInterval=sNTPPollInterval, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, gatewayIPAddress=gatewayIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, wirelessLinkAvailability=wirelessLinkAvailability, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dfsTable=dfsTable, cambium=cambium, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, userEnabled=userEnabled, ethernetFiberSupport=ethernetFiberSupport, bandwidthVariant=bandwidthVariant, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, hTTPPortNumber=hTTPPortNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, PYSNMP_MODULE_ID=cambium, dfs=dfs, cableLoss=cableLoss, iPAddress=iPAddress, licence=licence, remoteIPAddress=remoteIPAddress, telecomsChannelStatus=telecomsChannelStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, vLANPriorityQueueMapping=vLANPriorityQueueMapping, dataPortDisabledWarning=dataPortDisabledWarning, daylightSaving=daylightSaving, syslogClient=syslogClient, regionCodeTrap=regionCodeTrap, dataPortAutoMdix=dataPortAutoMdix, vLANPriorityTableNumber=vLANPriorityTableNumber, userTableEntry=userTableEntry, accessMethod=accessMethod, telecomsInterface=telecomsInterface, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, aAAControlGroup=aAAControlGroup, unitOutOfCalibration=unitOutOfCalibration, transmitFreqKHz=transmitFreqKHz, systemClock=systemClock, linkName=linkName, hTTPAccessEnabled=hTTPAccessEnabled, linkSymmetry=linkSymmetry, secondarySoftwareVersion=secondarySoftwareVersion, maximumTransmitPower=maximumTransmitPower, telecomsChannelStatusTrap=telecomsChannelStatusTrap, linkLoss=linkLoss, alarms=alarms, ptpGroups=ptpGroups, tFTPServerIPAddress=tFTPServerIPAddress, searchState=searchState, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, receiveChannel=receiveChannel, channelBandwidth=channelBandwidth, licensedCapacity=licensedCapacity, vectorError=vectorError, userName=userName, vLANManagementVID=vLANManagementVID, tDDControl=tDDControl, encryptionGroup=encryptionGroup, installArmStateTrap=installArmStateTrap, dfsPeaks=dfsPeaks, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNTPSyncTrap=sNTPSyncTrap, tFTPServerPortNumber=tFTPServerPortNumber, managementGroup=managementGroup, receiveModulationMode=receiveModulationMode, eIRP=eIRP, wirelessLinkStatus=wirelessLinkStatus, sNTPSync=sNTPSync, userRole=userRole, ptp500=ptp500, altitude=altitude, targetMACAddress=targetMACAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, licenceGroup=licenceGroup, subnetMask=subnetMask, vLANPriorityTableIndex=vLANPriorityTableIndex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, transmitDataRate=transmitDataRate, configuration=configuration, pubStats=pubStats, dfsMeans=dfsMeans, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sMTPServerIPAddress=sMTPServerIPAddress, sNMPCommunityString=sNMPCommunityString, sNMPTrapTableEntry=sNMPTrapTableEntry, installStatus=installStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, telecomsLoopbackTrap=telecomsLoopbackTrap, smtpGroup=smtpGroup, phyStatus=phyStatus, versions=versions, sMTPEnabledMessages=sMTPEnabledMessages, hTTPSPortNumber=hTTPSPortNumber, sNTPServerPortNumber=sNTPServerPortNumber, ptpCompliance=ptpCompliance, syslogState=syslogState, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapTable=sNMPTrapTable)
