...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPPollInterval=sNTPPollInterval, dfsGroup=dfsGroup, dataPortStatusTrap=dataPortStatusTrap, resetGroup=resetGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, capacityLicenseMismatch=capacityLicenseMismatch, dfsTableNumber=dfsTableNumber, dataPortDisabledWarning=dataPortDisabledWarning, ethernetFiberSupport=ethernetFiberSupport, sntpGroup=sntpGroup, snmpControl=snmpControl, pubStats=pubStats, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, installArmState=installArmState, softwareVersion=softwareVersion, telecomsChannelStatusTrap=telecomsChannelStatusTrap, configurationGroup=configurationGroup, daylightSaving=daylightSaving, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNTPSync=sNTPSync, telnetPortNumber=telnetPortNumber, supplementary=supplementary, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, receiveFreqMHz=receiveFreqMHz, sNTPState=sNTPState, noWirelessChannelAvailable=noWirelessChannelAvailable, ethernet=ethernet, phyControlGroup=phyControlGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, userTable=userTable, groupID=groupID, regionCode=regionCode, searchState=searchState, transmitFreqMHz=transmitFreqMHz, installArmStateTrap=installArmStateTrap, userTableNumber=userTableNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortAutoMdix=dataPortAutoMdix, syslogClient=syslogClient, versionsGroup=versionsGroup, notificationsGroup=notificationsGroup, receiveModulationMode=receiveModulationMode, ptp=ptp, installStatus=installStatus, secondarySoftwareVersion=secondarySoftwareVersion, userRole=userRole, unitOutOfCalibration=unitOutOfCalibration, phyStatus=phyStatus, ptpTrapPrefix=ptpTrapPrefix, sMTPServerIPAddress=sMTPServerIPAddress, sNMPv3Enable=sNMPv3Enable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tFTPServerIPAddress=tFTPServerIPAddress, sntp=sntp, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsTable=dfsTable, ptpCompliance=ptpCompliance, reset=reset, dfsTableIndex=dfsTableIndex, tDDSynchronizationAlarm=tDDSynchronizationAlarm, syslogControlGroup=syslogControlGroup, wirelessLinkStatus=wirelessLinkStatus, linkModeOptimizationMismatch=linkModeOptimizationMismatch, systemClock=systemClock, telecomsLoopback=telecomsLoopback, sNTPLastSync=sNTPLastSync, pubStatsGroup=pubStatsGroup, managementGroup=managementGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, userPassword=userPassword, telecomsInterface=telecomsInterface, tDDSynchronizationMode=tDDSynchronizationMode, incompatibleMasterAndSlave=incompatibleMasterAndSlave, transmitDataRate=transmitDataRate, sNTPSyncTrap=sNTPSyncTrap, telnetAccessEnabled=telnetAccessEnabled, receiveModulationModeDetail=receiveModulationModeDetail, phyControl=phyControl, sNMPEnabledTraps=sNMPEnabledTraps, hTTPPortNumber=hTTPPortNumber, sMTPServerPortNumber=sMTPServerPortNumber, sNMPPortNumber=sNMPPortNumber, telecom=telecom, alarms=alarms, aAAControlGroup=aAAControlGroup, linkModeOptimisation=linkModeOptimisation, dataPortStatus=dataPortStatus, bootVersion=bootVersion, licensedCapacity=licensedCapacity, sNTPServerPortNumber=sNTPServerPortNumber, dfsMeans=dfsMeans, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, maximumTransmitPower=maximumTransmitPower, ptp500=ptp500, dataPortAutoNegotiation=dataPortAutoNegotiation, vLANManagementPriority=vLANManagementPriority, encryption=encryption, supplementaryGroup=supplementaryGroup, latitude=latitude, regionCodeTrap=regionCodeTrap, vectorError=vectorError, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ethernetGroup=ethernetGroup, masterSlaveMode=masterSlaveMode, incompatibleRegionCodes=incompatibleRegionCodes, ptmp=ptmp, dfs=dfs, userEnabled=userEnabled, tDDControlGroup=tDDControlGroup, cableLoss=cableLoss, vLANPriorityTableIndex=vLANPriorityTableIndex, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, licenceGroup=licenceGroup, transmitPower=transmitPower, versions=versions, altitude=altitude, systemReset=systemReset, sNTPServerIPAddress=sNTPServerIPAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapIPAddress=sNMPTrapIPAddress, management=management, constantPowerSpectralDensity=constantPowerSpectralDensity, siteName=siteName, tFTPServerPortNumber=tFTPServerPortNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tDDControl=tDDControl, linkLoss=linkLoss, eIRP=eIRP, userName=userName, receiveDataRate=receiveDataRate, encryptionAlgorithm=encryptionAlgorithm, frequencyVariant=frequencyVariant, longitude=longitude, aggregateDataRate=aggregateDataRate, syslogState=syslogState, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, productVariant=productVariant, hTTPAccessEnabled=hTTPAccessEnabled, transmitModulationMode=transmitModulationMode, PYSNMP_MODULE_ID=cambium, productName=productName, hardwareVersion=hardwareVersion, wirelessLinkAvailability=wirelessLinkAvailability, receivePower=receivePower, sNMPCommunityString=sNMPCommunityString, range=range, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sMTPEmailAlert=sMTPEmailAlert, telecomGroup=telecomGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, transmitFreqKHz=transmitFreqKHz, transmitChannel=transmitChannel, syslogStateTrap=syslogStateTrap, encryptionGroup=encryptionGroup, aAAControl=aAAControl, antennaGain=antennaGain, vLANPriorityTable=vLANPriorityTable, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, snmpControlGroup=snmpControlGroup, phyStatusGroup=phyStatusGroup, ptpTraps=ptpTraps, sMTPEnabledMessages=sMTPEnabledMessages, vLANPriorityQueueMapping=vLANPriorityQueueMapping, timeZone=timeZone, telecomsCableLength=telecomsCableLength, receiveChannel=receiveChannel, accessMethod=accessMethod, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sMTPSourceEmailAddress=sMTPSourceEmailAddress, signalStrengthRatio=signalStrengthRatio, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, alarmsGroup=alarmsGroup, iPAddress=iPAddress, ptpGroups=ptpGroups, telecomsChannelStatus=telecomsChannelStatus, telecomsLineCode=telecomsLineCode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, byteErrorRatio=byteErrorRatio, bandwidthVariant=bandwidthVariant, sNMPTrapVersion=sNMPTrapVersion, smtp=smtp, syslogControl=syslogControl, channelBandwidth=channelBandwidth, hTTPSPortNumber=hTTPSPortNumber, sNMPTrapTable=sNMPTrapTable, installStatusTrap=installStatusTrap, smtpGroup=smtpGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, receiveFreqKHz=receiveFreqKHz, linkSymmetry=linkSymmetry, vLANPriorityTableNumber=vLANPriorityTableNumber, userTableIndex=userTableIndex, telecomsLoopbackTrap=telecomsLoopbackTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, syslogClientTrap=syslogClientTrap, configuration=configuration, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dfsTableEntry=dfsTableEntry, licence=licence, linkName=linkName, channelChangeTrap=channelChangeTrap, targetMACAddress=targetMACAddress, vLANManagementVID=vLANManagementVID, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, cambium=cambium, dfsPeaks=dfsPeaks, gatewayIPAddress=gatewayIPAddress, remoteIPAddress=remoteIPAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, subnetMask=subnetMask, userTableEntry=userTableEntry, sNMPTrapTableNumber=sNMPTrapTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus)
