...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", pubStats=pubStats, constantPowerSpectralDensity=constantPowerSpectralDensity, syslogState=syslogState, ptmp=ptmp, userPassword=userPassword, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, systemClock=systemClock, pubStatsGroup=pubStatsGroup, secondarySoftwareVersion=secondarySoftwareVersion, eIRP=eIRP, tFTPServerPortNumber=tFTPServerPortNumber, transmitModulationMode=transmitModulationMode, dfs=dfs, PYSNMP_MODULE_ID=cambium, dfsTableNumber=dfsTableNumber, smtp=smtp, transmitDataRate=transmitDataRate, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNTPServerPortNumber=sNTPServerPortNumber, vLANManagementPriority=vLANManagementPriority, telecomsLoopback=telecomsLoopback, dataPortStatus=dataPortStatus, ethernet=ethernet, dfsTableIndex=dfsTableIndex, capacityLicenseMismatch=capacityLicenseMismatch, sNMPTrapTableNumber=sNMPTrapTableNumber, sntpGroup=sntpGroup, sNTPSyncTrap=sNTPSyncTrap, sNTPPollInterval=sNTPPollInterval, dfsGroup=dfsGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, maximumTransmitPower=maximumTransmitPower, hTTPAccessEnabled=hTTPAccessEnabled, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, smtpGroup=smtpGroup, ethernetFiberSupport=ethernetFiberSupport, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ethernetGroup=ethernetGroup, licensedCapacity=licensedCapacity, alarms=alarms, installStatus=installStatus, signalStrengthRatio=signalStrengthRatio, vectorError=vectorError, syslogLocalWrappedTrap=syslogLocalWrappedTrap, linkModeOptimisation=linkModeOptimisation, ptpTraps=ptpTraps, phyStatusGroup=phyStatusGroup, remoteIPAddress=remoteIPAddress, channelBandwidth=channelBandwidth, tDDSynchronizationAlarm=tDDSynchronizationAlarm, userName=userName, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, snmpControl=snmpControl, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, cambium=cambium, tDDSynchronizationMode=tDDSynchronizationMode, dataPortWirelessDownAlert=dataPortWirelessDownAlert, masterSlaveMode=masterSlaveMode, incompatibleRegionCodes=incompatibleRegionCodes, hardwareVersion=hardwareVersion, telecomsChannelStatus=telecomsChannelStatus, phyControlGroup=phyControlGroup, frequencyVariant=frequencyVariant, supplementary=supplementary, licence=licence, vLANPriorityTableNumber=vLANPriorityTableNumber, sNTPSync=sNTPSync, sNMPv3Enable=sNMPv3Enable, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPEnabledTraps=sNMPEnabledTraps, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortStatusTrap=dataPortStatusTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, managementGroup=managementGroup, regionCodeTrap=regionCodeTrap, siteName=siteName, dataPortAutoMdix=dataPortAutoMdix, aggregateDataRate=aggregateDataRate, productVariant=productVariant, configurationGroup=configurationGroup, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, encryptionGroup=encryptionGroup, management=management, receivePower=receivePower, vLANPriorityTable=vLANPriorityTable, telecomsCableLength=telecomsCableLength, aAAControlGroup=aAAControlGroup, userEnabled=userEnabled, sMTPEnabledMessages=sMTPEnabledMessages, dfsTable=dfsTable, sNMPPortNumber=sNMPPortNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, latitude=latitude, telecomsLoopbackTrap=telecomsLoopbackTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, iPAddress=iPAddress, range=range, alarmsGroup=alarmsGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, ptpGroups=ptpGroups, transmitPower=transmitPower, wirelessLinkAvailability=wirelessLinkAvailability, receiveFreqKHz=receiveFreqKHz, ptp=ptp, gatewayIPAddress=gatewayIPAddress, sMTPServerPortNumber=sMTPServerPortNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dfsTableEntry=dfsTableEntry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, telecomsInterface=telecomsInterface, sNTPServerIPAddress=sNTPServerIPAddress, subnetMask=subnetMask, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dfsPeaks=dfsPeaks, sNMPCommunityString=sNMPCommunityString, supplementaryGroup=supplementaryGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, altitude=altitude, vLANManagementVID=vLANManagementVID, installStatusTrap=installStatusTrap, tDDControl=tDDControl, sNMPTrapTable=sNMPTrapTable, daylightSaving=daylightSaving, transmitFreqKHz=transmitFreqKHz, syslogControl=syslogControl, linkSymmetry=linkSymmetry, cableLoss=cableLoss, longitude=longitude, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogClientTrap=syslogClientTrap, encryption=encryption, dataPortDisabledWarning=dataPortDisabledWarning, receiveModulationModeDetail=receiveModulationModeDetail, telecomsLineCode=telecomsLineCode, phyStatus=phyStatus, sNMPTrapVersion=sNMPTrapVersion, receiveChannel=receiveChannel, sNTPState=sNTPState, userTableIndex=userTableIndex, userRole=userRole, sNMPTrapTableEntry=sNMPTrapTableEntry, antennaGain=antennaGain, snmpControlGroup=snmpControlGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, softwareVersion=softwareVersion, tDDSynchronizationStatus=tDDSynchronizationStatus, ptpCompliance=ptpCompliance, ptp500=ptp500, hTTPPortNumber=hTTPPortNumber, receiveDataRate=receiveDataRate, transmitFreqMHz=transmitFreqMHz, licenceGroup=licenceGroup, wirelessLinkStatus=wirelessLinkStatus, groupID=groupID, searchState=searchState, versionsGroup=versionsGroup, notificationsGroup=notificationsGroup, phyControl=phyControl, sMTPEmailAlert=sMTPEmailAlert, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, linkLoss=linkLoss, resetGroup=resetGroup, receiveFreqMHz=receiveFreqMHz, vLANPriorityTableEntry=vLANPriorityTableEntry, linkName=linkName, timeZone=timeZone, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, syslogControlGroup=syslogControlGroup, systemReset=systemReset, userTable=userTable, transmitChannel=transmitChannel, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, vLANPriorityQueueMapping=vLANPriorityQueueMapping, accessMethod=accessMethod, bootVersion=bootVersion, encryptionAlgorithm=encryptionAlgorithm, channelChangeTrap=channelChangeTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, ptpTrapPrefix=ptpTrapPrefix, productName=productName, syslogStateTrap=syslogStateTrap, dfsMeans=dfsMeans, useVLANForManagementInterfaces=useVLANForManagementInterfaces, unitOutOfCalibration=unitOutOfCalibration, userTableEntry=userTableEntry, installArmState=installArmState, receiveModulationMode=receiveModulationMode, aAAControl=aAAControl, noWirelessChannelAvailable=noWirelessChannelAvailable, tDDControlGroup=tDDControlGroup, versions=versions, telecomsChannelStatusTrap=telecomsChannelStatusTrap, tFTPServerIPAddress=tFTPServerIPAddress, configuration=configuration, telecom=telecom, regionCode=regionCode, bandwidthVariant=bandwidthVariant, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, syslogClient=syslogClient, targetMACAddress=targetMACAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, userTableNumber=userTableNumber, reset=reset, telnetAccessEnabled=telnetAccessEnabled, sNMPTrapPortNumber=sNMPTrapPortNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telnetPortNumber=telnetPortNumber, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sntp=sntp, dataPortAutoNegotiation=dataPortAutoNegotiation, installArmStateTrap=installArmStateTrap, telecomGroup=telecomGroup, byteErrorRatio=byteErrorRatio, hTTPSPortNumber=hTTPSPortNumber, sMTPServerIPAddress=sMTPServerIPAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPLastSync=sNTPLastSync)
