...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", daylightSaving=daylightSaving, transmitFreqKHz=transmitFreqKHz, phyStatus=phyStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, capacityLicenseMismatch=capacityLicenseMismatch, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sNTPSyncTrap=sNTPSyncTrap, licenceGroup=licenceGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, alarmsGroup=alarmsGroup, syslogClientTrap=syslogClientTrap, phyControl=phyControl, ptp=ptp, receivePower=receivePower, dfsTableEntry=dfsTableEntry, maximumTransmitPower=maximumTransmitPower, enabledDiagnosticAlarms=enabledDiagnosticAlarms, supplementary=supplementary, sMTPSourceEmailAddress=sMTPSourceEmailAddress, searchState=searchState, sNTPSync=sNTPSync, cambium=cambium, dfsTableIndex=dfsTableIndex, remoteIPAddress=remoteIPAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, longitude=longitude, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNTPPollInterval=sNTPPollInterval, sNMPEnabledTraps=sNMPEnabledTraps, ptp500=ptp500, dfsMeans=dfsMeans, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, wirelessLinkAvailability=wirelessLinkAvailability, phyStatusGroup=phyStatusGroup, ethernetGroup=ethernetGroup, sntpGroup=sntpGroup, phyControlGroup=phyControlGroup, syslogControlGroup=syslogControlGroup, syslogClient=syslogClient, dfsGroup=dfsGroup, tFTPServerPortNumber=tFTPServerPortNumber, channelBandwidth=channelBandwidth, dataPortWirelessDownAlert=dataPortWirelessDownAlert, vLANPriorityTableIndex=vLANPriorityTableIndex, telnetPortNumber=telnetPortNumber, groupID=groupID, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, configurationGroup=configurationGroup, telecomsInterface=telecomsInterface, siteName=siteName, linkName=linkName, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dfs=dfs, userTableIndex=userTableIndex, receiveFreqMHz=receiveFreqMHz, sNMPv3Enable=sNMPv3Enable, incompatibleRegionCodes=incompatibleRegionCodes, reset=reset, PYSNMP_MODULE_ID=cambium, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortAutoNegotiation=dataPortAutoNegotiation, unitOutOfCalibration=unitOutOfCalibration, sNTPState=sNTPState, installStatusTrap=installStatusTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNMPCommunityString=sNMPCommunityString, vLANManagementVID=vLANManagementVID, aggregateDataRate=aggregateDataRate, gatewayIPAddress=gatewayIPAddress, receiveFreqKHz=receiveFreqKHz, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ptmp=ptmp, vLANManagementPriority=vLANManagementPriority, sNTPLastSync=sNTPLastSync, hTTPPortNumber=hTTPPortNumber, installArmState=installArmState, userTable=userTable, resetGroup=resetGroup, userTableEntry=userTableEntry, dataPortAutoMdix=dataPortAutoMdix, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, transmitPower=transmitPower, telecomsLoopbackTrap=telecomsLoopbackTrap, management=management, pubStatsGroup=pubStatsGroup, dfsTableNumber=dfsTableNumber, hardwareVersion=hardwareVersion, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, installArmStateTrap=installArmStateTrap, aAAControl=aAAControl, vectorError=vectorError, bootVersion=bootVersion, supplementaryGroup=supplementaryGroup, snmpControlGroup=snmpControlGroup, wirelessLinkStatus=wirelessLinkStatus, signalStrengthRatio=signalStrengthRatio, syslogStateTrap=syslogStateTrap, ptpCompliance=ptpCompliance, latitude=latitude, softwareVersion=softwareVersion, sNMPTrapTableEntry=sNMPTrapTableEntry, productVariant=productVariant, vLANPriorityTableNumber=vLANPriorityTableNumber, iPAddress=iPAddress, sNMPTrapTable=sNMPTrapTable, hTTPAccessEnabled=hTTPAccessEnabled, ptpTrapPrefix=ptpTrapPrefix, telecomGroup=telecomGroup, eIRP=eIRP, configuration=configuration, sMTPEnabledMessages=sMTPEnabledMessages, userEnabled=userEnabled, tDDControl=tDDControl, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, timeZone=timeZone, sntp=sntp, userRole=userRole, snmpControl=snmpControl, targetMACAddress=targetMACAddress, hTTPSPortNumber=hTTPSPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, smtpGroup=smtpGroup, receiveChannel=receiveChannel, ptpTraps=ptpTraps, receiveModulationMode=receiveModulationMode, tDDControlGroup=tDDControlGroup, encryptionGroup=encryptionGroup, alarms=alarms, dfsTable=dfsTable, systemReset=systemReset, installStatus=installStatus, tDDSynchronizationStatus=tDDSynchronizationStatus, userName=userName, telecomsCableLength=telecomsCableLength, syslogState=syslogState, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptpGroups=ptpGroups, bandwidthVariant=bandwidthVariant, sMTPServerPortNumber=sMTPServerPortNumber, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, userTableNumber=userTableNumber, telecom=telecom, range=range, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPPortNumber=sNMPPortNumber, sNMPTrapVersion=sNMPTrapVersion, cableLoss=cableLoss, syslogControl=syslogControl, sNTPServerIPAddress=sNTPServerIPAddress, transmitModulationMode=transmitModulationMode, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, versions=versions, pubStats=pubStats, sMTPEmailAlert=sMTPEmailAlert, linkModeOptimizationMismatch=linkModeOptimizationMismatch, telecomsLoopback=telecomsLoopback, frequencyVariant=frequencyVariant, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dataPortDisabledWarning=dataPortDisabledWarning, hTTPSAccessEnabled=hTTPSAccessEnabled, channelChangeTrap=channelChangeTrap, aAAControlGroup=aAAControlGroup, transmitFreqMHz=transmitFreqMHz, telecomsLineCode=telecomsLineCode, vLANPriorityTable=vLANPriorityTable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, licensedCapacity=licensedCapacity, sNMPTrapPortNumber=sNMPTrapPortNumber, telecomsChannelStatus=telecomsChannelStatus, antennaGain=antennaGain, ethernetFiberSupport=ethernetFiberSupport, licence=licence, vLANPriorityTableEntry=vLANPriorityTableEntry, dfsPeaks=dfsPeaks, sMTPServerIPAddress=sMTPServerIPAddress, dataPortStatus=dataPortStatus, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, encryptionAlgorithm=encryptionAlgorithm, tDDSynchronizationMode=tDDSynchronizationMode, managementGroup=managementGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, receiveDataRate=receiveDataRate, smtp=smtp, linkLoss=linkLoss, sNTPServerPortNumber=sNTPServerPortNumber, linkSymmetry=linkSymmetry, masterSlaveMode=masterSlaveMode, encryption=encryption, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkModeOptimisation=linkModeOptimisation, systemClock=systemClock, receiveModulationModeDetail=receiveModulationModeDetail, telnetAccessEnabled=telnetAccessEnabled, altitude=altitude, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, regionCode=regionCode, transmitDataRate=transmitDataRate, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, transmitChannel=transmitChannel, sNMPTrapTableIndex=sNMPTrapTableIndex, versionsGroup=versionsGroup, dataPortStatusTrap=dataPortStatusTrap, regionCodeTrap=regionCodeTrap, notificationsGroup=notificationsGroup, userPassword=userPassword, productName=productName, byteErrorRatio=byteErrorRatio, subnetMask=subnetMask, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, accessMethod=accessMethod, ethernet=ethernet, tFTPServerIPAddress=tFTPServerIPAddress)
