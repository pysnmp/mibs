...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", syslogClientTrap=syslogClientTrap, siteName=siteName, bandwidthVariant=bandwidthVariant, installStatusTrap=installStatusTrap, ethernet=ethernet, sNMPTrapIPAddress=sNMPTrapIPAddress, latitude=latitude, hTTPSAccessEnabled=hTTPSAccessEnabled, dataPortDisabledWarning=dataPortDisabledWarning, vLANPriorityTableEntry=vLANPriorityTableEntry, vLANManagementVID=vLANManagementVID, telecomGroup=telecomGroup, phyControl=phyControl, userTableNumber=userTableNumber, management=management, linkModeOptimizationMismatch=linkModeOptimizationMismatch, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, masterSlaveMode=masterSlaveMode, alarms=alarms, vLANPriorityTableNumber=vLANPriorityTableNumber, telnetAccessEnabled=telnetAccessEnabled, syslogControlGroup=syslogControlGroup, hTTPPortNumber=hTTPPortNumber, transmitDataRate=transmitDataRate, dfsTable=dfsTable, syslogLocalWrappedTrap=syslogLocalWrappedTrap, channelBandwidth=channelBandwidth, managementGroup=managementGroup, dfsTableNumber=dfsTableNumber, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapVersion=sNMPTrapVersion, hardwareVersion=hardwareVersion, sNMPCommunityString=sNMPCommunityString, dfsTableIndex=dfsTableIndex, sNTPSyncTrap=sNTPSyncTrap, signalStrengthRatio=signalStrengthRatio, enabledDiagnosticAlarms=enabledDiagnosticAlarms, vectorError=vectorError, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNTPLastSync=sNTPLastSync, smtpGroup=smtpGroup, accessMethod=accessMethod, resetGroup=resetGroup, incompatibleRegionCodes=incompatibleRegionCodes, constantPowerSpectralDensity=constantPowerSpectralDensity, PYSNMP_MODULE_ID=cambium, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, unitOutOfCalibration=unitOutOfCalibration, dataPortStatus=dataPortStatus, regionCodeTrap=regionCodeTrap, cableLoss=cableLoss, transmitFreqKHz=transmitFreqKHz, supplementaryGroup=supplementaryGroup, snmpControlGroup=snmpControlGroup, snmpControl=snmpControl, ptpTraps=ptpTraps, sNMPTrapPortNumber=sNMPTrapPortNumber, eIRP=eIRP, linkName=linkName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, receiveDataRate=receiveDataRate, capacityLicenseMismatch=capacityLicenseMismatch, syslogControl=syslogControl, configurationGroup=configurationGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telnetPortNumber=telnetPortNumber, bootVersion=bootVersion, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dfsGroup=dfsGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, linkModeOptimisation=linkModeOptimisation, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, versions=versions, receiveChannel=receiveChannel, ptp=ptp, ptpTrapPrefix=ptpTrapPrefix, licence=licence, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, wirelessLinkAvailability=wirelessLinkAvailability, transmitFreqMHz=transmitFreqMHz, sNMPTrapTableNumber=sNMPTrapTableNumber, phyStatusGroup=phyStatusGroup, encryptionGroup=encryptionGroup, sNTPSync=sNTPSync, userTable=userTable, sntp=sntp, versionsGroup=versionsGroup, phyControlGroup=phyControlGroup, supplementary=supplementary, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, telecomsLineCode=telecomsLineCode, telecomsLoopback=telecomsLoopback, receiveModulationMode=receiveModulationMode, frequencyVariant=frequencyVariant, sMTPServerIPAddress=sMTPServerIPAddress, reset=reset, vLANPriorityQueueMapping=vLANPriorityQueueMapping, ethernetFiberSupport=ethernetFiberSupport, sNTPPollInterval=sNTPPollInterval, gatewayIPAddress=gatewayIPAddress, alarmsGroup=alarmsGroup, linkLoss=linkLoss, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, wirelessLinkStatus=wirelessLinkStatus, tDDSynchronizationMode=tDDSynchronizationMode, sntpGroup=sntpGroup, iPAddress=iPAddress, sNMPEnabledTraps=sNMPEnabledTraps, ptp500=ptp500, channelChangeTrap=channelChangeTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, phyStatus=phyStatus, installStatus=installStatus, encryptionAlgorithm=encryptionAlgorithm, userEnabled=userEnabled, sNMPv3Enable=sNMPv3Enable, dfsPeaks=dfsPeaks, productVariant=productVariant, transmitChannel=transmitChannel, notificationsGroup=notificationsGroup, softwareVersion=softwareVersion, userTableIndex=userTableIndex, useVLANForManagementInterfaces=useVLANForManagementInterfaces, daylightSaving=daylightSaving, vLANManagementPriority=vLANManagementPriority, userTableEntry=userTableEntry, sMTPSourceEmailAddress=sMTPSourceEmailAddress, hTTPSPortNumber=hTTPSPortNumber, receiveFreqKHz=receiveFreqKHz, timeZone=timeZone, dataPortStatusTrap=dataPortStatusTrap, transmitModulationMode=transmitModulationMode, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNTPServerPortNumber=sNTPServerPortNumber, systemReset=systemReset, syslogState=syslogState, ethernetGroup=ethernetGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vLANPriorityTable=vLANPriorityTable, ptpCompliance=ptpCompliance, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, aggregateDataRate=aggregateDataRate, sNMPTrapTableEntry=sNMPTrapTableEntry, receiveModulationModeDetail=receiveModulationModeDetail, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortAutoMdix=dataPortAutoMdix, encryption=encryption, aAAControlGroup=aAAControlGroup, productName=productName, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tDDControlGroup=tDDControlGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapTable=sNMPTrapTable, tDDSynchronizationAlarm=tDDSynchronizationAlarm, longitude=longitude, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogStateTrap=syslogStateTrap, licenceGroup=licenceGroup, aAAControl=aAAControl, incompatibleMasterAndSlave=incompatibleMasterAndSlave, linkSymmetry=linkSymmetry, sMTPEmailAlert=sMTPEmailAlert, installArmState=installArmState, tFTPServerIPAddress=tFTPServerIPAddress, pubStatsGroup=pubStatsGroup, subnetMask=subnetMask, ptpGroups=ptpGroups, groupID=groupID, hTTPAccessEnabled=hTTPAccessEnabled, userPassword=userPassword, tFTPServerPortNumber=tFTPServerPortNumber, dfsMeans=dfsMeans, targetMACAddress=targetMACAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortAutoNegotiation=dataPortAutoNegotiation, telecomsLoopbackTrap=telecomsLoopbackTrap, searchState=searchState, regionCode=regionCode, remoteIPAddress=remoteIPAddress, vLANPriorityTableIndex=vLANPriorityTableIndex, installArmStateTrap=installArmStateTrap, sMTPServerPortNumber=sMTPServerPortNumber, licensedCapacity=licensedCapacity, byteErrorRatio=byteErrorRatio, telecomsChannelStatus=telecomsChannelStatus, cambium=cambium, telecomsCableLength=telecomsCableLength, dfs=dfs, receivePower=receivePower, systemClock=systemClock, ptmp=ptmp, tDDControl=tDDControl, syslogClient=syslogClient, telecom=telecom, sNTPServerIPAddress=sNTPServerIPAddress, secondarySoftwareVersion=secondarySoftwareVersion, range=range, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, maximumTransmitPower=maximumTransmitPower, sNTPState=sNTPState, altitude=altitude, userName=userName, pubStats=pubStats, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPPortNumber=sNMPPortNumber, configuration=configuration, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, antennaGain=antennaGain, transmitPower=transmitPower, userRole=userRole, telecomsInterface=telecomsInterface, receiveFreqMHz=receiveFreqMHz, smtp=smtp, dfsTableEntry=dfsTableEntry)
