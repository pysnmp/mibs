...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", secondarySoftwareVersion=secondarySoftwareVersion, versions=versions, supplementaryGroup=supplementaryGroup, receiveFreqMHz=receiveFreqMHz, transmitChannel=transmitChannel, dfsTableEntry=dfsTableEntry, userTableNumber=userTableNumber, frequencyVariant=frequencyVariant, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ptpTrapPrefix=ptpTrapPrefix, wirelessLinkStatus=wirelessLinkStatus, receiveFreqKHz=receiveFreqKHz, linkName=linkName, bandwidthVariant=bandwidthVariant, maximumTransmitPower=maximumTransmitPower, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPPollInterval=sNTPPollInterval, aAAControl=aAAControl, softwareVersion=softwareVersion, vLANPriorityTableIndex=vLANPriorityTableIndex, vLANPriorityTableEntry=vLANPriorityTableEntry, receiveChannel=receiveChannel, telecom=telecom, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, accessMethod=accessMethod, licensedCapacity=licensedCapacity, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, transmitFreqMHz=transmitFreqMHz, vLANPriorityTable=vLANPriorityTable, bootVersion=bootVersion, receiveModulationModeDetail=receiveModulationModeDetail, sNMPTrapTableIndex=sNMPTrapTableIndex, receiveDataRate=receiveDataRate, dfsTableIndex=dfsTableIndex, transmitDataRate=transmitDataRate, dfs=dfs, signalStrengthRatio=signalStrengthRatio, eIRP=eIRP, sNTPLastSync=sNTPLastSync, tFTPServerPortNumber=tFTPServerPortNumber, userRole=userRole, dataPortAutoNegotiation=dataPortAutoNegotiation, encryptionAlgorithm=encryptionAlgorithm, systemReset=systemReset, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sMTPEmailAlert=sMTPEmailAlert, encryptionGroup=encryptionGroup, sNTPServerIPAddress=sNTPServerIPAddress, userTableIndex=userTableIndex, productVariant=productVariant, cambium=cambium, ethernet=ethernet, longitude=longitude, altitude=altitude, syslogClient=syslogClient, sNTPState=sNTPState, gatewayIPAddress=gatewayIPAddress, sNTPServerPortNumber=sNTPServerPortNumber, sMTPServerPortNumber=sMTPServerPortNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, transmitModulationMode=transmitModulationMode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, antennaGain=antennaGain, hardwareVersion=hardwareVersion, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, transmitFreqKHz=transmitFreqKHz, receiveModulationMode=receiveModulationMode, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, hTTPSPortNumber=hTTPSPortNumber, aggregateDataRate=aggregateDataRate, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tDDSynchronizationMode=tDDSynchronizationMode, telecomsChannelStatusTrap=telecomsChannelStatusTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, ethernetFiberSupport=ethernetFiberSupport, hTTPSAccessEnabled=hTTPSAccessEnabled, licence=licence, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, incompatibleRegionCodes=incompatibleRegionCodes, tDDSynchronizationStatus=tDDSynchronizationStatus, linkModeOptimisation=linkModeOptimisation, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortDisabledWarning=dataPortDisabledWarning, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, installArmState=installArmState, syslogControlGroup=syslogControlGroup, systemClock=systemClock, latitude=latitude, pubStatsGroup=pubStatsGroup, telecomGroup=telecomGroup, targetMACAddress=targetMACAddress, ethernetGroup=ethernetGroup, productName=productName, sMTPEnabledMessages=sMTPEnabledMessages, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, telecomsInterface=telecomsInterface, ptpGroups=ptpGroups, telecomsLoopback=telecomsLoopback, versionsGroup=versionsGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, wirelessLinkAvailability=wirelessLinkAvailability, subnetMask=subnetMask, encryption=encryption, tDDControlGroup=tDDControlGroup, sntpGroup=sntpGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ptmp=ptmp, alarmsGroup=alarmsGroup, byteErrorRatio=byteErrorRatio, userTable=userTable, incompatibleMasterAndSlave=incompatibleMasterAndSlave, configuration=configuration, userTableEntry=userTableEntry, tDDControl=tDDControl, userEnabled=userEnabled, dfsGroup=dfsGroup, resetGroup=resetGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, smtp=smtp, installArmStateTrap=installArmStateTrap, transmitPower=transmitPower, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapTable=sNMPTrapTable, aAAControlGroup=aAAControlGroup, managementGroup=managementGroup, smtpGroup=smtpGroup, telecomsChannelStatus=telecomsChannelStatus, licenceGroup=licenceGroup, cableLoss=cableLoss, phyStatus=phyStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dfsPeaks=dfsPeaks, telecomsLoopbackTrap=telecomsLoopbackTrap, dfsTable=dfsTable, sNMPTrapIPAddress=sNMPTrapIPAddress, dfsTableNumber=dfsTableNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, range=range, installStatusTrap=installStatusTrap, ptp=ptp, sNTPSync=sNTPSync, sNMPEnabledTraps=sNMPEnabledTraps, channelChangeTrap=channelChangeTrap, telnetPortNumber=telnetPortNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, management=management, vLANPriorityTableNumber=vLANPriorityTableNumber, channelBandwidth=channelBandwidth, pubStats=pubStats, sMTPServerIPAddress=sMTPServerIPAddress, sNTPSyncTrap=sNTPSyncTrap, dfsMeans=dfsMeans, vLANManagementPriority=vLANManagementPriority, telecomsCableLength=telecomsCableLength, syslogClientTrap=syslogClientTrap, snmpControlGroup=snmpControlGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, unitOutOfCalibration=unitOutOfCalibration, hTTPAccessEnabled=hTTPAccessEnabled, configurationGroup=configurationGroup, remoteIPAddress=remoteIPAddress, sntp=sntp, phyControlGroup=phyControlGroup, siteName=siteName, alarms=alarms, reset=reset, daylightSaving=daylightSaving, masterSlaveMode=masterSlaveMode, phyControl=phyControl, sNMPPortNumber=sNMPPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapTableEntry=sNMPTrapTableEntry, PYSNMP_MODULE_ID=cambium, sNMPv3Enable=sNMPv3Enable, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortConfigurationMismatch=dataPortConfigurationMismatch, userPassword=userPassword, groupID=groupID, vectorError=vectorError, sNMPCommunityString=sNMPCommunityString, linkSymmetry=linkSymmetry, syslogState=syslogState, notificationsGroup=notificationsGroup, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dataPortStatusTrap=dataPortStatusTrap, vLANManagementVID=vLANManagementVID, iPAddress=iPAddress, sNMPTrapVersion=sNMPTrapVersion, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkLoss=linkLoss, syslogControl=syslogControl, regionCodeTrap=regionCodeTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ptpCompliance=ptpCompliance, supplementary=supplementary, searchState=searchState, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortAutoMdix=dataPortAutoMdix, snmpControl=snmpControl, ptpTraps=ptpTraps, telnetAccessEnabled=telnetAccessEnabled, phyStatusGroup=phyStatusGroup, timeZone=timeZone, regionCode=regionCode, capacityLicenseMismatch=capacityLicenseMismatch, dataPortStatus=dataPortStatus, hTTPPortNumber=hTTPPortNumber, receivePower=receivePower, syslogStateTrap=syslogStateTrap, telecomsLineCode=telecomsLineCode, installStatus=installStatus, ptp500=ptp500, userName=userName)
