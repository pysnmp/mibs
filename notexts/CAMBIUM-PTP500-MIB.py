...
# Produced by pysmi-1.1.3 at Tue Dec  7 17:23:50 2021
...
Gauge32, Integer32, Counter32, NotificationType, Counter64, ModuleIdentity, iso, MibIdentifier, Unsigned32, IpAddress, Bits, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Integer32", "Counter32", "NotificationType", "Counter64", "ModuleIdentity", "iso", "MibIdentifier", "Unsigned32", "IpAddress", "Bits", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", transmitFreqMHz=transmitFreqMHz, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, cableLoss=cableLoss, subnetMask=subnetMask, syslogStateTrap=syslogStateTrap, transmitChannel=transmitChannel, ptmp=ptmp, aAAControl=aAAControl, phyStatus=phyStatus, management=management, installArmStateTrap=installArmStateTrap, syslogControlGroup=syslogControlGroup, userTableEntry=userTableEntry, dataPortAutoNegotiation=dataPortAutoNegotiation, hardwareVersion=hardwareVersion, dataPortDisabledWarning=dataPortDisabledWarning, linkLoss=linkLoss, ptpTrapPrefix=ptpTrapPrefix, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, versions=versions, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dfsTableNumber=dfsTableNumber, remoteIPAddress=remoteIPAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, telecomGroup=telecomGroup, encryptionGroup=encryptionGroup, vLANPriorityTable=vLANPriorityTable, regionCodeTrap=regionCodeTrap, vLANManagementVID=vLANManagementVID, sMTPServerPortNumber=sMTPServerPortNumber, sNTPState=sNTPState, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, telecom=telecom, hTTPSPortNumber=hTTPSPortNumber, receivePower=receivePower, phyStatusGroup=phyStatusGroup, sNTPServerPortNumber=sNTPServerPortNumber, systemClock=systemClock, telecomsLineCode=telecomsLineCode, telecomsChannelStatusTrap=telecomsChannelStatusTrap, secondarySoftwareVersion=secondarySoftwareVersion, ethernetFiberSupport=ethernetFiberSupport, pubStats=pubStats, sntpGroup=sntpGroup, supplementaryGroup=supplementaryGroup, installStatusTrap=installStatusTrap, channelChangeTrap=channelChangeTrap, receiveChannel=receiveChannel, dfsTableIndex=dfsTableIndex, ptp=ptp, constantPowerSpectralDensity=constantPowerSpectralDensity, softwareVersion=softwareVersion, vLANPriorityTableIndex=vLANPriorityTableIndex, ptpCompliance=ptpCompliance, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telnetPortNumber=telnetPortNumber, regionCode=regionCode, incompatibleMasterAndSlave=incompatibleMasterAndSlave, wirelessLinkAvailability=wirelessLinkAvailability, telecomsLoopbackTrap=telecomsLoopbackTrap, range=range, sMTPEmailAlert=sMTPEmailAlert, syslogClientTrap=syslogClientTrap, supplementary=supplementary, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, userTable=userTable, telecomsLoopback=telecomsLoopback, resetGroup=resetGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, ptp500=ptp500, sNMPTrapTableNumber=sNMPTrapTableNumber, dfsTable=dfsTable, capacityLicenseMismatch=capacityLicenseMismatch, receiveModulationMode=receiveModulationMode, tDDControlGroup=tDDControlGroup, wirelessLinkStatus=wirelessLinkStatus, receiveModulationModeDetail=receiveModulationModeDetail, transmitModulationMode=transmitModulationMode, tDDSynchronizationMode=tDDSynchronizationMode, pubStatsGroup=pubStatsGroup, tFTPServerPortNumber=tFTPServerPortNumber, bandwidthVariant=bandwidthVariant, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, vectorError=vectorError, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, userEnabled=userEnabled, sMTPServerIPAddress=sMTPServerIPAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPTrapVersion=sNMPTrapVersion, altitude=altitude, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, phyControl=phyControl, linkSymmetry=linkSymmetry, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, signalStrengthRatio=signalStrengthRatio, sNTPServerIPAddress=sNTPServerIPAddress, transmitPower=transmitPower, useVLANForManagementInterfaces=useVLANForManagementInterfaces, phyControlGroup=phyControlGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, gatewayIPAddress=gatewayIPAddress, targetMACAddress=targetMACAddress, sNTPPollInterval=sNTPPollInterval, syslogState=syslogState, channelBandwidth=channelBandwidth, sNMPEnabledTraps=sNMPEnabledTraps, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, smtpGroup=smtpGroup, dataPortStatusTrap=dataPortStatusTrap, PYSNMP_MODULE_ID=cambium, byteErrorRatio=byteErrorRatio, telecomsChannelStatus=telecomsChannelStatus, userName=userName, transmitDataRate=transmitDataRate, ethernet=ethernet, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, antennaGain=antennaGain, timeZone=timeZone, frequencyVariant=frequencyVariant, hTTPPortNumber=hTTPPortNumber, receiveFreqKHz=receiveFreqKHz, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ptpTraps=ptpTraps, tFTPServerIPAddress=tFTPServerIPAddress, userRole=userRole, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, productVariant=productVariant, sNMPTrapIPAddress=sNMPTrapIPAddress, configurationGroup=configurationGroup, ptpGroups=ptpGroups, licenceGroup=licenceGroup, dfsGroup=dfsGroup, tDDControl=tDDControl, dataPortConfigurationMismatch=dataPortConfigurationMismatch, transmitFreqKHz=transmitFreqKHz, receiveDataRate=receiveDataRate, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPv3Enable=sNMPv3Enable, hTTPAccessEnabled=hTTPAccessEnabled, cambium=cambium, sntp=sntp, iPAddress=iPAddress, receiveFreqMHz=receiveFreqMHz, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dfs=dfs, snmpControl=snmpControl, telnetAccessEnabled=telnetAccessEnabled, dfsPeaks=dfsPeaks, aggregateDataRate=aggregateDataRate, vLANPriorityQueueMapping=vLANPriorityQueueMapping, userTableIndex=userTableIndex, vLANPriorityTableNumber=vLANPriorityTableNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, groupID=groupID, incompatibleRegionCodes=incompatibleRegionCodes, systemReset=systemReset, linkModeOptimisation=linkModeOptimisation, linkName=linkName, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPCommunityString=sNMPCommunityString, configuration=configuration, licensedCapacity=licensedCapacity, sNMPTrapTable=sNMPTrapTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPPortNumber=sNMPPortNumber, userPassword=userPassword, snmpControlGroup=snmpControlGroup, ethernetGroup=ethernetGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapTableIndex=sNMPTrapTableIndex, encryptionAlgorithm=encryptionAlgorithm, userTableNumber=userTableNumber, dataPortAutoMdix=dataPortAutoMdix, unitOutOfCalibration=unitOutOfCalibration, remoteMaximumTransmitPower=remoteMaximumTransmitPower, latitude=latitude, sNTPSyncTrap=sNTPSyncTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, reset=reset, longitude=longitude, sNTPSync=sNTPSync, licence=licence, alarms=alarms, installStatus=installStatus, bootVersion=bootVersion, masterSlaveMode=masterSlaveMode, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dfsMeans=dfsMeans, sNTPLastSync=sNTPLastSync, aAAControlGroup=aAAControlGroup, productName=productName, sMTPEnabledMessages=sMTPEnabledMessages, maximumTransmitPower=maximumTransmitPower, smtp=smtp, encryption=encryption, installArmState=installArmState, alarmsGroup=alarmsGroup, eIRP=eIRP, linkModeOptimizationMismatch=linkModeOptimizationMismatch, syslogClient=syslogClient, managementGroup=managementGroup, daylightSaving=daylightSaving, syslogControl=syslogControl, accessMethod=accessMethod, dataPortStatus=dataPortStatus, versionsGroup=versionsGroup, telecomsCableLength=telecomsCableLength, notificationsGroup=notificationsGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, telecomsInterface=telecomsInterface, vLANManagementPriority=vLANManagementPriority, siteName=siteName, searchState=searchState, dfsTableEntry=dfsTableEntry, sNMPTrapTableEntry=sNMPTrapTableEntry)
