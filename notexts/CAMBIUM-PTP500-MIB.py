...
# Produced by pysmi-1.1.3 at Sun Nov 28 20:17:49 2021
...
iso, Bits, TimeTicks, MibIdentifier, ModuleIdentity, Counter32, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Integer32, IpAddress, enterprises, Counter64, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "TimeTicks", "MibIdentifier", "ModuleIdentity", "Counter32", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Integer32", "IpAddress", "enterprises", "Counter64", "ObjectIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", snmpControlGroup=snmpControlGroup, encryptionGroup=encryptionGroup, sNMPEnabledTraps=sNMPEnabledTraps, tDDControl=tDDControl, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, unitOutOfCalibration=unitOutOfCalibration, installArmState=installArmState, dfsGroup=dfsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, userEnabled=userEnabled, sNMPTrapTableEntry=sNMPTrapTableEntry, linkSymmetry=linkSymmetry, syslogControlGroup=syslogControlGroup, channelChangeTrap=channelChangeTrap, sNTPSyncTrap=sNTPSyncTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, linkLoss=linkLoss, vLANPriorityTableNumber=vLANPriorityTableNumber, telecomsLineCode=telecomsLineCode, systemReset=systemReset, remoteIPAddress=remoteIPAddress, incompatibleRegionCodes=incompatibleRegionCodes, masterSlaveMode=masterSlaveMode, regionCode=regionCode, sNMPTrapTableIndex=sNMPTrapTableIndex, hTTPSPortNumber=hTTPSPortNumber, dfsTableNumber=dfsTableNumber, aAAControlGroup=aAAControlGroup, sNTPState=sNTPState, smtpGroup=smtpGroup, tFTPServerPortNumber=tFTPServerPortNumber, range=range, channelBandwidth=channelBandwidth, dfsTable=dfsTable, accessMethod=accessMethod, ptp=ptp, aggregateDataRate=aggregateDataRate, receivePower=receivePower, transmitModulationMode=transmitModulationMode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, secondarySoftwareVersion=secondarySoftwareVersion, telnetPortNumber=telnetPortNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, vLANPriorityTable=vLANPriorityTable, receiveFreqKHz=receiveFreqKHz, PYSNMP_MODULE_ID=cambium, notificationsGroup=notificationsGroup, iPAddress=iPAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, productVariant=productVariant, installStatus=installStatus, transmitFreqKHz=transmitFreqKHz, ethernetFiberSupport=ethernetFiberSupport, telnetAccessEnabled=telnetAccessEnabled, snmpControl=snmpControl, transmitPower=transmitPower, longitude=longitude, dataPortStatus=dataPortStatus, softwareVersion=softwareVersion, remoteMaximumTransmitPower=remoteMaximumTransmitPower, installArmStateTrap=installArmStateTrap, alarms=alarms, signalStrengthRatio=signalStrengthRatio, vLANManagementPriority=vLANManagementPriority, regionCodeTrap=regionCodeTrap, gatewayIPAddress=gatewayIPAddress, groupID=groupID, vectorError=vectorError, vLANPriorityTableIndex=vLANPriorityTableIndex, receiveModulationMode=receiveModulationMode, transmitFreqMHz=transmitFreqMHz, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, antennaGain=antennaGain, altitude=altitude, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPServerIPAddress=sNTPServerIPAddress, userPassword=userPassword, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, phyStatusGroup=phyStatusGroup, sNMPTrapTable=sNMPTrapTable, subnetMask=subnetMask, userTableNumber=userTableNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, ptpGroups=ptpGroups, pubStats=pubStats, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPPortNumber=sNMPPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, management=management, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, linkModeOptimisation=linkModeOptimisation, receiveFreqMHz=receiveFreqMHz, byteErrorRatio=byteErrorRatio, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNTPLastSync=sNTPLastSync, telecomsLoopbackTrap=telecomsLoopbackTrap, tDDControlGroup=tDDControlGroup, phyStatus=phyStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, vLANManagementVID=vLANManagementVID, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, receiveChannel=receiveChannel, userRole=userRole, systemClock=systemClock, timeZone=timeZone, wirelessLinkAvailability=wirelessLinkAvailability, dfsTableEntry=dfsTableEntry, managementGroup=managementGroup, telecomsChannelStatus=telecomsChannelStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, smtp=smtp, ptpTrapPrefix=ptpTrapPrefix, sntpGroup=sntpGroup, tDDSynchronizationMode=tDDSynchronizationMode, dfsMeans=dfsMeans, tFTPServerIPAddress=tFTPServerIPAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, enabledDiagnosticAlarms=enabledDiagnosticAlarms, bandwidthVariant=bandwidthVariant, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, userName=userName, siteName=siteName, noWirelessChannelAvailable=noWirelessChannelAvailable, syslogControl=syslogControl, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dfs=dfs, versions=versions, ptpCompliance=ptpCompliance, sNTPSync=sNTPSync, daylightSaving=daylightSaving, phyControlGroup=phyControlGroup, sNMPCommunityString=sNMPCommunityString, targetMACAddress=targetMACAddress, telecomsCableLength=telecomsCableLength, sNTPPollInterval=sNTPPollInterval, encryptionAlgorithm=encryptionAlgorithm, transmitDataRate=transmitDataRate, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, telecom=telecom, supplementaryGroup=supplementaryGroup, wirelessLinkStatus=wirelessLinkStatus, syslogState=syslogState, bootVersion=bootVersion, ethernet=ethernet, ptmp=ptmp, supplementary=supplementary, vLANPriorityQueueMapping=vLANPriorityQueueMapping, productName=productName, tDDSynchronizationStatus=tDDSynchronizationStatus, versionsGroup=versionsGroup, installStatusTrap=installStatusTrap, alarmsGroup=alarmsGroup, sMTPEnabledMessages=sMTPEnabledMessages, ptp500=ptp500, userTable=userTable, sMTPServerIPAddress=sMTPServerIPAddress, dataPortStatusTrap=dataPortStatusTrap, dfsTableIndex=dfsTableIndex, userTableEntry=userTableEntry, dataPortConfigurationMismatch=dataPortConfigurationMismatch, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, licenceGroup=licenceGroup, dataPortAutoMdix=dataPortAutoMdix, ptpTraps=ptpTraps, configuration=configuration, reset=reset, dataPortDisabledWarning=dataPortDisabledWarning, frequencyVariant=frequencyVariant, encryption=encryption, telecomGroup=telecomGroup, capacityLicenseMismatch=capacityLicenseMismatch, syslogClient=syslogClient, sNTPServerPortNumber=sNTPServerPortNumber, linkName=linkName, receiveModulationModeDetail=receiveModulationModeDetail, licence=licence, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ethernetGroup=ethernetGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, userTableIndex=userTableIndex, hTTPPortNumber=hTTPPortNumber, configurationGroup=configurationGroup, sNMPTrapVersion=sNMPTrapVersion, maximumTransmitPower=maximumTransmitPower, sNMPv3Enable=sNMPv3Enable, latitude=latitude, syslogStateTrap=syslogStateTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, eIRP=eIRP, sntp=sntp, cableLoss=cableLoss, hardwareVersion=hardwareVersion, phyControl=phyControl, resetGroup=resetGroup, sMTPServerPortNumber=sMTPServerPortNumber, telecomsLoopback=telecomsLoopback, cambium=cambium, syslogClientTrap=syslogClientTrap, aAAControl=aAAControl, dfsPeaks=dfsPeaks, vLANPriorityTableEntry=vLANPriorityTableEntry, receiveDataRate=receiveDataRate, dataPortWirelessDownAlert=dataPortWirelessDownAlert, pubStatsGroup=pubStatsGroup, telecomsInterface=telecomsInterface, sMTPEmailAlert=sMTPEmailAlert, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, searchState=searchState, transmitChannel=transmitChannel, hTTPAccessEnabled=hTTPAccessEnabled, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, licensedCapacity=licensedCapacity)
