...
# Produced by pysmi-1.1.0 at Fri Nov 19 15:15:29 2021
...
TimeTicks, Unsigned32, Integer32, IpAddress, ObjectIdentity, Counter64, Gauge32, MibIdentifier, enterprises, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, iso, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "Integer32", "IpAddress", "ObjectIdentity", "Counter64", "Gauge32", "MibIdentifier", "enterprises", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "iso", "Counter32", "NotificationType")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", smtp=smtp, frequencyVariant=frequencyVariant, sNMPCommunityString=sNMPCommunityString, dataPortDisabledWarning=dataPortDisabledWarning, userEnabled=userEnabled, searchState=searchState, installArmStateTrap=installArmStateTrap, receiveChannel=receiveChannel, sNTPServerPortNumber=sNTPServerPortNumber, reset=reset, cableLoss=cableLoss, telecomsChannelStatus=telecomsChannelStatus, PYSNMP_MODULE_ID=cambium, wirelessLinkAvailability=wirelessLinkAvailability, receivePower=receivePower, dfsTableEntry=dfsTableEntry, dataPortAutoNegotiation=dataPortAutoNegotiation, regionCodeTrap=regionCodeTrap, ptpTraps=ptpTraps, regionCode=regionCode, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, maximumTransmitPower=maximumTransmitPower, dfsTable=dfsTable, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, vLANPriorityTableEntry=vLANPriorityTableEntry, ethernetFiberSupport=ethernetFiberSupport, capacityLicenseMismatch=capacityLicenseMismatch, byteErrorRatio=byteErrorRatio, encryptionGroup=encryptionGroup, versionsGroup=versionsGroup, smtpGroup=smtpGroup, subnetMask=subnetMask, tFTPServerPortNumber=tFTPServerPortNumber, transmitDataRate=transmitDataRate, userTableIndex=userTableIndex, sNMPTrapTable=sNMPTrapTable, ptpGroups=ptpGroups, alarms=alarms, snmpControl=snmpControl, sNTPPollInterval=sNTPPollInterval, iPAddress=iPAddress, tDDControlGroup=tDDControlGroup, snmpControlGroup=snmpControlGroup, linkName=linkName, managementGroup=managementGroup, tDDControl=tDDControl, userTableEntry=userTableEntry, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, signalStrengthRatio=signalStrengthRatio, userTableNumber=userTableNumber, aAAControl=aAAControl, supplementaryGroup=supplementaryGroup, versions=versions, siteName=siteName, dfsMeans=dfsMeans, telecomsLoopbackTrap=telecomsLoopbackTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dataPortStatus=dataPortStatus, masterSlaveMode=masterSlaveMode, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, altitude=altitude, sNMPTrapVersion=sNMPTrapVersion, sNTPState=sNTPState, sntpGroup=sntpGroup, channelBandwidth=channelBandwidth, sNTPServerIPAddress=sNTPServerIPAddress, notificationsGroup=notificationsGroup, syslogControl=syslogControl, transmitFreqKHz=transmitFreqKHz, dataPortAutoMdix=dataPortAutoMdix, aggregateDataRate=aggregateDataRate, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, latitude=latitude, dfsTableIndex=dfsTableIndex, sNMPTrapPortNumber=sNMPTrapPortNumber, telecomsChannelStatusTrap=telecomsChannelStatusTrap, ptmp=ptmp, longitude=longitude, pubStats=pubStats, softwareVersion=softwareVersion, phyControl=phyControl, hTTPPortNumber=hTTPPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ptpCompliance=ptpCompliance, sNMPTrapTableNumber=sNMPTrapTableNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, incompatibleRegionCodes=incompatibleRegionCodes, installArmState=installArmState, hTTPSPortNumber=hTTPSPortNumber, alarmsGroup=alarmsGroup, dfsPeaks=dfsPeaks, dataPortStatusTrap=dataPortStatusTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tFTPServerIPAddress=tFTPServerIPAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, linkModeOptimisation=linkModeOptimisation, syslogState=syslogState, tDDSynchronizationMode=tDDSynchronizationMode, pubStatsGroup=pubStatsGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPTrapTableEntry=sNMPTrapTableEntry, sMTPEmailAlert=sMTPEmailAlert, systemClock=systemClock, configuration=configuration, management=management, vLANPriorityTable=vLANPriorityTable, eIRP=eIRP, daylightSaving=daylightSaving, encryption=encryption, accessMethod=accessMethod, supplementary=supplementary, receiveModulationModeDetail=receiveModulationModeDetail, ptpTrapPrefix=ptpTrapPrefix, productName=productName, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ethernet=ethernet, linkLoss=linkLoss, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, installStatus=installStatus, telnetAccessEnabled=telnetAccessEnabled, productVariant=productVariant, licensedCapacity=licensedCapacity, wirelessLinkStatus=wirelessLinkStatus, transmitModulationMode=transmitModulationMode, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, telecomsLoopback=telecomsLoopback, sNMPPortNumber=sNMPPortNumber, dfsGroup=dfsGroup, range=range, transmitChannel=transmitChannel, constantPowerSpectralDensity=constantPowerSpectralDensity, vLANPriorityTableIndex=vLANPriorityTableIndex, telecomsCableLength=telecomsCableLength, tDDSynchronizationStatus=tDDSynchronizationStatus, encryptionAlgorithm=encryptionAlgorithm, linkSymmetry=linkSymmetry, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, receiveFreqKHz=receiveFreqKHz, sNMPv3Enable=sNMPv3Enable, sNTPLastSync=sNTPLastSync, vLANPriorityTableNumber=vLANPriorityTableNumber, syslogControlGroup=syslogControlGroup, channelChangeTrap=channelChangeTrap, antennaGain=antennaGain, ptp500=ptp500, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, phyStatusGroup=phyStatusGroup, bootVersion=bootVersion, transmitPower=transmitPower, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, resetGroup=resetGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, cambium=cambium, dfsTableNumber=dfsTableNumber, configurationGroup=configurationGroup, vectorError=vectorError, userPassword=userPassword, targetMACAddress=targetMACAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dfs=dfs, phyControlGroup=phyControlGroup, licence=licence, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, userName=userName, sNMPEnabledTraps=sNMPEnabledTraps, telecomGroup=telecomGroup, remoteIPAddress=remoteIPAddress, telecomsInterface=telecomsInterface, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, hTTPAccessEnabled=hTTPAccessEnabled, syslogClientTrap=syslogClientTrap, transmitFreqMHz=transmitFreqMHz, sMTPServerIPAddress=sMTPServerIPAddress, telnetPortNumber=telnetPortNumber, timeZone=timeZone, sNTPSync=sNTPSync, dataPortWirelessDownAlert=dataPortWirelessDownAlert, installStatusTrap=installStatusTrap, systemReset=systemReset, syslogStateTrap=syslogStateTrap, userTable=userTable, bandwidthVariant=bandwidthVariant, sntp=sntp, ethernetGroup=ethernetGroup, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, vLANPriorityQueueMapping=vLANPriorityQueueMapping, receiveDataRate=receiveDataRate, syslogClient=syslogClient, licenceGroup=licenceGroup, ptp=ptp, secondarySoftwareVersion=secondarySoftwareVersion, syslogLocalWrappedTrap=syslogLocalWrappedTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, telecomsLineCode=telecomsLineCode, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, phyStatus=phyStatus, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNTPSyncTrap=sNTPSyncTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, receiveFreqMHz=receiveFreqMHz, enabledDiagnosticAlarms=enabledDiagnosticAlarms, groupID=groupID, hardwareVersion=hardwareVersion, gatewayIPAddress=gatewayIPAddress, vLANManagementPriority=vLANManagementPriority, unitOutOfCalibration=unitOutOfCalibration, aAAControlGroup=aAAControlGroup, userRole=userRole, receiveModulationMode=receiveModulationMode, telecom=telecom, sNMPTrapTableIndex=sNMPTrapTableIndex, vLANManagementVID=vLANManagementVID)
