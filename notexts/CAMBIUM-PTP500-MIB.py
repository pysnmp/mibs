...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", bandwidthVariant=bandwidthVariant, telnetAccessEnabled=telnetAccessEnabled, wirelessLinkStatus=wirelessLinkStatus, daylightSaving=daylightSaving, aggregateDataRate=aggregateDataRate, vLANPriorityTableIndex=vLANPriorityTableIndex, telecomsLineCode=telecomsLineCode, ptpTrapPrefix=ptpTrapPrefix, supplementary=supplementary, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortConfigurationMismatch=dataPortConfigurationMismatch, transmitDataRate=transmitDataRate, reset=reset, dataPortStatus=dataPortStatus, ptp=ptp, sNTPPollInterval=sNTPPollInterval, tDDControl=tDDControl, capacityLicenseMismatch=capacityLicenseMismatch, receiveDataRate=receiveDataRate, versionsGroup=versionsGroup, installArmState=installArmState, receiveModulationMode=receiveModulationMode, unitOutOfCalibration=unitOutOfCalibration, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, gatewayIPAddress=gatewayIPAddress, channelChangeTrap=channelChangeTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, sMTPServerPortNumber=sMTPServerPortNumber, systemClock=systemClock, ptpTraps=ptpTraps, ethernetGroup=ethernetGroup, groupID=groupID, aAAControl=aAAControl, dataPortAutoMdix=dataPortAutoMdix, licenceGroup=licenceGroup, tDDSynchronizationMode=tDDSynchronizationMode, systemReset=systemReset, phyControl=phyControl, incompatibleRegionCodes=incompatibleRegionCodes, management=management, masterSlaveMode=masterSlaveMode, sNMPCommunityString=sNMPCommunityString, antennaGain=antennaGain, telecomsChannelStatus=telecomsChannelStatus, installStatus=installStatus, telecomsCableLength=telecomsCableLength, tFTPServerPortNumber=tFTPServerPortNumber, syslogClient=syslogClient, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, installStatusTrap=installStatusTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, cambium=cambium, range=range, telecomGroup=telecomGroup, snmpControlGroup=snmpControlGroup, ethernet=ethernet, pubStatsGroup=pubStatsGroup, PYSNMP_MODULE_ID=cambium, longitude=longitude, signalStrengthRatio=signalStrengthRatio, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfsPeaks=dfsPeaks, sNMPTrapTableEntry=sNMPTrapTableEntry, dfsGroup=dfsGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, receiveFreqKHz=receiveFreqKHz, productName=productName, dataPortDisabledWarning=dataPortDisabledWarning, receiveChannel=receiveChannel, hardwareVersion=hardwareVersion, vectorError=vectorError, sntpGroup=sntpGroup, vLANManagementPriority=vLANManagementPriority, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, subnetMask=subnetMask, userTable=userTable, syslogClientTrap=syslogClientTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, channelBandwidth=channelBandwidth, dataPortAutoNegotiation=dataPortAutoNegotiation, siteName=siteName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userTableIndex=userTableIndex, dataPortWirelessDownAlert=dataPortWirelessDownAlert, noWirelessChannelAvailable=noWirelessChannelAvailable, supplementaryGroup=supplementaryGroup, telecomsInterface=telecomsInterface, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, phyStatus=phyStatus, sNTPServerIPAddress=sNTPServerIPAddress, transmitChannel=transmitChannel, altitude=altitude, encryptionAlgorithm=encryptionAlgorithm, ptp500=ptp500, sNMPTrapVersion=sNMPTrapVersion, userName=userName, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, alarmsGroup=alarmsGroup, cableLoss=cableLoss, tFTPServerIPAddress=tFTPServerIPAddress, tDDControlGroup=tDDControlGroup, ethernetFiberSupport=ethernetFiberSupport, syslogLocalWrappedTrap=syslogLocalWrappedTrap, eIRP=eIRP, licensedCapacity=licensedCapacity, linkLoss=linkLoss, snmpControl=snmpControl, timeZone=timeZone, accessMethod=accessMethod, hTTPAccessEnabled=hTTPAccessEnabled, sNMPTrapTableIndex=sNMPTrapTableIndex, telecom=telecom, encryption=encryption, dfsTableNumber=dfsTableNumber, transmitFreqKHz=transmitFreqKHz, sNTPLastSync=sNTPLastSync, userPassword=userPassword, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dfsTableEntry=dfsTableEntry, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, receiveModulationModeDetail=receiveModulationModeDetail, telecomsLoopbackTrap=telecomsLoopbackTrap, dataPortStatusTrap=dataPortStatusTrap, ptpCompliance=ptpCompliance, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, alarms=alarms, sNMPTrapTable=sNMPTrapTable, targetMACAddress=targetMACAddress, maximumTransmitPower=maximumTransmitPower, searchState=searchState, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, phyControlGroup=phyControlGroup, sNTPSync=sNTPSync, sNTPServerPortNumber=sNTPServerPortNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, userRole=userRole, softwareVersion=softwareVersion, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, bootVersion=bootVersion, dfsMeans=dfsMeans, ptpGroups=ptpGroups, receiveFreqMHz=receiveFreqMHz, receivePower=receivePower, frequencyVariant=frequencyVariant, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPSyncTrap=sNTPSyncTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, linkName=linkName, secondarySoftwareVersion=secondarySoftwareVersion, sNMPPortNumber=sNMPPortNumber, syslogControl=syslogControl, userEnabled=userEnabled, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, latitude=latitude, notificationsGroup=notificationsGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, vLANPriorityTable=vLANPriorityTable, hTTPSPortNumber=hTTPSPortNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, transmitPower=transmitPower, dfsTable=dfsTable, versions=versions, telecomsLoopback=telecomsLoopback, configuration=configuration, linkModeOptimisation=linkModeOptimisation, userTableNumber=userTableNumber, syslogControlGroup=syslogControlGroup, encryptionGroup=encryptionGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, iPAddress=iPAddress, pubStats=pubStats, sMTPSourceEmailAddress=sMTPSourceEmailAddress, installArmStateTrap=installArmStateTrap, sNTPState=sNTPState, dfsTableIndex=dfsTableIndex, sntp=sntp, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, wirelessLinkAvailability=wirelessLinkAvailability, smtpGroup=smtpGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, byteErrorRatio=byteErrorRatio, sNMPv3Enable=sNMPv3Enable, useVLANForManagementInterfaces=useVLANForManagementInterfaces, resetGroup=resetGroup, productVariant=productVariant, managementGroup=managementGroup, syslogStateTrap=syslogStateTrap, linkSymmetry=linkSymmetry, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, smtp=smtp, sNMPTrapPortNumber=sNMPTrapPortNumber, aAAControlGroup=aAAControlGroup, regionCode=regionCode, sNMPEnabledTraps=sNMPEnabledTraps, syslogState=syslogState, sMTPEmailAlert=sMTPEmailAlert, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, telnetPortNumber=telnetPortNumber, userTableEntry=userTableEntry, transmitModulationMode=transmitModulationMode, vLANManagementVID=vLANManagementVID, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dfs=dfs, transmitFreqMHz=transmitFreqMHz, remoteIPAddress=remoteIPAddress, regionCodeTrap=regionCodeTrap, hTTPPortNumber=hTTPPortNumber, phyStatusGroup=phyStatusGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sMTPEnabledMessages=sMTPEnabledMessages, configurationGroup=configurationGroup, ptmp=ptmp, licence=licence, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, vLANPriorityTableEntry=vLANPriorityTableEntry, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch)
