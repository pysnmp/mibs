...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", transmitModulationMode=transmitModulationMode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPServerPortNumber=sMTPServerPortNumber, userTableNumber=userTableNumber, sNTPPollInterval=sNTPPollInterval, sMTPServerIPAddress=sMTPServerIPAddress, managementGroup=managementGroup, remoteIPAddress=remoteIPAddress, accessMethod=accessMethod, subnetMask=subnetMask, installStatus=installStatus, sNMPCommunityString=sNMPCommunityString, receiveDataRate=receiveDataRate, smtpGroup=smtpGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, antennaGain=antennaGain, ptp=ptp, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sMTPEmailAlert=sMTPEmailAlert, masterSlaveMode=masterSlaveMode, phyStatus=phyStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, bootVersion=bootVersion, transmitDataRate=transmitDataRate, sMTPEnabledMessages=sMTPEnabledMessages, userTableEntry=userTableEntry, pubStatsGroup=pubStatsGroup, sNMPTrapVersion=sNMPTrapVersion, smtp=smtp, syslogStateTrap=syslogStateTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, hTTPPortNumber=hTTPPortNumber, receiveFreqKHz=receiveFreqKHz, telecomsChannelStatusTrap=telecomsChannelStatusTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, userRole=userRole, iPAddress=iPAddress, alarmsGroup=alarmsGroup, ptpGroups=ptpGroups, licence=licence, ethernetFiberSupport=ethernetFiberSupport, sNMPv3Enable=sNMPv3Enable, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPLastSync=sNTPLastSync, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, productName=productName, notificationsGroup=notificationsGroup, dataPortDisabledWarning=dataPortDisabledWarning, sNMPTrapPortNumber=sNMPTrapPortNumber, phyStatusGroup=phyStatusGroup, incompatibleRegionCodes=incompatibleRegionCodes, telecomsChannelStatus=telecomsChannelStatus, sNTPState=sNTPState, tDDControl=tDDControl, userName=userName, daylightSaving=daylightSaving, installStatusTrap=installStatusTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, userTableIndex=userTableIndex, transmitPower=transmitPower, capacityLicenseMismatch=capacityLicenseMismatch, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ptpTraps=ptpTraps, sntpGroup=sntpGroup, systemClock=systemClock, versions=versions, longitude=longitude, frequencyVariant=frequencyVariant, cableLoss=cableLoss, hTTPSAccessEnabled=hTTPSAccessEnabled, wirelessLinkStatus=wirelessLinkStatus, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, signalStrengthRatio=signalStrengthRatio, receivePower=receivePower, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, aAAControlGroup=aAAControlGroup, productVariant=productVariant, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ptpCompliance=ptpCompliance, phyControl=phyControl, sNMPTrapTable=sNMPTrapTable, tFTPServerPortNumber=tFTPServerPortNumber, receiveFreqMHz=receiveFreqMHz, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, snmpControl=snmpControl, dfsTableNumber=dfsTableNumber, configurationGroup=configurationGroup, maximumTransmitPower=maximumTransmitPower, tFTPServerIPAddress=tFTPServerIPAddress, receiveChannel=receiveChannel, supplementaryGroup=supplementaryGroup, alarms=alarms, range=range, sNMPEnabledTraps=sNMPEnabledTraps, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, cambium=cambium, syslogControlGroup=syslogControlGroup, groupID=groupID, telnetPortNumber=telnetPortNumber, sntp=sntp, channelChangeTrap=channelChangeTrap, snmpControlGroup=snmpControlGroup, linkName=linkName, regionCodeTrap=regionCodeTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, PYSNMP_MODULE_ID=cambium, dfsGroup=dfsGroup, versionsGroup=versionsGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, hTTPSPortNumber=hTTPSPortNumber, syslogClient=syslogClient, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPSync=sNTPSync, userEnabled=userEnabled, telnetAccessEnabled=telnetAccessEnabled, latitude=latitude, dataPortWirelessDownAlert=dataPortWirelessDownAlert, phyControlGroup=phyControlGroup, reset=reset, ptmp=ptmp, vLANPriorityTableNumber=vLANPriorityTableNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, licensedCapacity=licensedCapacity, telecomsLoopback=telecomsLoopback, regionCode=regionCode, hTTPAccessEnabled=hTTPAccessEnabled, secondarySoftwareVersion=secondarySoftwareVersion, telecomsLineCode=telecomsLineCode, linkModeOptimisation=linkModeOptimisation, timeZone=timeZone, dfsPeaks=dfsPeaks, resetGroup=resetGroup, ethernetGroup=ethernetGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, ptp500=ptp500, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, telecomGroup=telecomGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dfsTableIndex=dfsTableIndex, aAAControl=aAAControl, dfsTableEntry=dfsTableEntry, altitude=altitude, tDDSynchronizationMode=tDDSynchronizationMode, gatewayIPAddress=gatewayIPAddress, receiveModulationMode=receiveModulationMode, supplementary=supplementary, bandwidthVariant=bandwidthVariant, systemReset=systemReset, userPassword=userPassword, transmitFreqKHz=transmitFreqKHz, softwareVersion=softwareVersion, sNMPPortNumber=sNMPPortNumber, vectorError=vectorError, enabledDiagnosticAlarms=enabledDiagnosticAlarms, hardwareVersion=hardwareVersion, syslogLocalWrappedTrap=syslogLocalWrappedTrap, aggregateDataRate=aggregateDataRate, dataPortStatus=dataPortStatus, eIRP=eIRP, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, syslogState=syslogState, pubStats=pubStats, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telecom=telecom, configuration=configuration, encryptionAlgorithm=encryptionAlgorithm, telecomsCableLength=telecomsCableLength, channelBandwidth=channelBandwidth, telecomsInterface=telecomsInterface, dfsTable=dfsTable, transmitChannel=transmitChannel, transmitFreqMHz=transmitFreqMHz, incompatibleMasterAndSlave=incompatibleMasterAndSlave, syslogControl=syslogControl, encryptionGroup=encryptionGroup, sNTPSyncTrap=sNTPSyncTrap, encryption=encryption, targetMACAddress=targetMACAddress, userTable=userTable, installArmState=installArmState, vLANPriorityTable=vLANPriorityTable, ethernet=ethernet, vLANManagementVID=vLANManagementVID, tDDSynchronizationAlarm=tDDSynchronizationAlarm, unitOutOfCalibration=unitOutOfCalibration, management=management, syslogClientTrap=syslogClientTrap, dataPortAutoMdix=dataPortAutoMdix, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPServerIPAddress=sNTPServerIPAddress, siteName=siteName, noWirelessChannelAvailable=noWirelessChannelAvailable, linkSymmetry=linkSymmetry, tDDSynchronizationStatus=tDDSynchronizationStatus, installArmStateTrap=installArmStateTrap, sNTPServerPortNumber=sNTPServerPortNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, receiveModulationModeDetail=receiveModulationModeDetail, tDDControlGroup=tDDControlGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, vLANPriorityTableIndex=vLANPriorityTableIndex, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortStatusTrap=dataPortStatusTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, vLANManagementPriority=vLANManagementPriority, dfsMeans=dfsMeans, ptpTrapPrefix=ptpTrapPrefix, dfs=dfs, licenceGroup=licenceGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, byteErrorRatio=byteErrorRatio, wirelessLinkAvailability=wirelessLinkAvailability, linkLoss=linkLoss, searchState=searchState)
