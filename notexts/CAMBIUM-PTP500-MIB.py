...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", dataPortAutoMdix=dataPortAutoMdix, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNTPSync=sNTPSync, dataPortDisabledWarning=dataPortDisabledWarning, reset=reset, userTable=userTable, maximumTransmitPower=maximumTransmitPower, snmpControl=snmpControl, hTTPSAccessEnabled=hTTPSAccessEnabled, pubStatsGroup=pubStatsGroup, sntpGroup=sntpGroup, bandwidthVariant=bandwidthVariant, dfsTableEntry=dfsTableEntry, sMTPServerPortNumber=sMTPServerPortNumber, configurationGroup=configurationGroup, dfsTableIndex=dfsTableIndex, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, channelBandwidth=channelBandwidth, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortWirelessDownAlert=dataPortWirelessDownAlert, receiveModulationModeDetail=receiveModulationModeDetail, transmitFreqMHz=transmitFreqMHz, vLANPriorityTableEntry=vLANPriorityTableEntry, phyStatusGroup=phyStatusGroup, encryptionAlgorithm=encryptionAlgorithm, syslogStateTrap=syslogStateTrap, supplementaryGroup=supplementaryGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, userPassword=userPassword, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, signalStrengthRatio=signalStrengthRatio, linkLoss=linkLoss, installStatus=installStatus, capacityLicenseMismatch=capacityLicenseMismatch, latitude=latitude, tDDSynchronizationMode=tDDSynchronizationMode, tDDControlGroup=tDDControlGroup, telecomsLoopback=telecomsLoopback, smtp=smtp, useVLANForManagementInterfaces=useVLANForManagementInterfaces, userTableNumber=userTableNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, PYSNMP_MODULE_ID=cambium, licence=licence, aAAControl=aAAControl, ethernetFiberSupport=ethernetFiberSupport, receiveFreqMHz=receiveFreqMHz, phyControlGroup=phyControlGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapVersion=sNMPTrapVersion, alarms=alarms, management=management, ptpTraps=ptpTraps, telnetAccessEnabled=telnetAccessEnabled, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, installArmState=installArmState, supplementary=supplementary, dfsPeaks=dfsPeaks, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ptpTrapPrefix=ptpTrapPrefix, vLANPriorityQueueMapping=vLANPriorityQueueMapping, userTableEntry=userTableEntry, sMTPServerIPAddress=sMTPServerIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfsMeans=dfsMeans, licensedCapacity=licensedCapacity, transmitFreqKHz=transmitFreqKHz, sNMPPortNumber=sNMPPortNumber, systemReset=systemReset, receiveModulationMode=receiveModulationMode, installStatusTrap=installStatusTrap, vectorError=vectorError, ptpCompliance=ptpCompliance, snmpControlGroup=snmpControlGroup, vLANManagementVID=vLANManagementVID, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPEmailAlert=sMTPEmailAlert, transmitModulationMode=transmitModulationMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, daylightSaving=daylightSaving, sNMPTrapTable=sNMPTrapTable, vLANPriorityTableNumber=vLANPriorityTableNumber, receiveDataRate=receiveDataRate, ptpGroups=ptpGroups, sNTPServerIPAddress=sNTPServerIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, cableLoss=cableLoss, telecomGroup=telecomGroup, tFTPServerPortNumber=tFTPServerPortNumber, accessMethod=accessMethod, transmitChannel=transmitChannel, dataPortConfigurationMismatch=dataPortConfigurationMismatch, resetGroup=resetGroup, subnetMask=subnetMask, searchState=searchState, sNMPEnabledTraps=sNMPEnabledTraps, aggregateDataRate=aggregateDataRate, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, hTTPAccessEnabled=hTTPAccessEnabled, incompatibleRegionCodes=incompatibleRegionCodes, licenceGroup=licenceGroup, dfsTable=dfsTable, byteErrorRatio=byteErrorRatio, ptp=ptp, linkModeOptimisation=linkModeOptimisation, versions=versions, userEnabled=userEnabled, regionCodeTrap=regionCodeTrap, sNTPSyncTrap=sNTPSyncTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, vLANManagementPriority=vLANManagementPriority, sMTPEnabledMessages=sMTPEnabledMessages, softwareVersion=softwareVersion, userRole=userRole, productName=productName, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, managementGroup=managementGroup, hTTPPortNumber=hTTPPortNumber, vLANPriorityTableIndex=vLANPriorityTableIndex, enabledDiagnosticAlarms=enabledDiagnosticAlarms, wirelessLinkStatus=wirelessLinkStatus, encryption=encryption, systemClock=systemClock, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, longitude=longitude, bootVersion=bootVersion, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, phyControl=phyControl, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, syslogClientTrap=syslogClientTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tFTPServerIPAddress=tFTPServerIPAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, telecomsChannelStatus=telecomsChannelStatus, dfs=dfs, tDDControl=tDDControl, dataPortStatusTrap=dataPortStatusTrap, antennaGain=antennaGain, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNMPv3Enable=sNMPv3Enable, userTableIndex=userTableIndex, timeZone=timeZone, sNMPCommunityString=sNMPCommunityString, ptmp=ptmp, phyStatus=phyStatus, telecomsLoopbackTrap=telecomsLoopbackTrap, ptp500=ptp500, sNTPState=sNTPState, masterSlaveMode=masterSlaveMode, constantPowerSpectralDensity=constantPowerSpectralDensity, versionsGroup=versionsGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, telecom=telecom, remoteIPAddress=remoteIPAddress, ethernetGroup=ethernetGroup, encryptionGroup=encryptionGroup, linkName=linkName, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, syslogClient=syslogClient, smtpGroup=smtpGroup, iPAddress=iPAddress, hTTPSPortNumber=hTTPSPortNumber, receiveFreqKHz=receiveFreqKHz, receiveChannel=receiveChannel, hardwareVersion=hardwareVersion, telecomsCableLength=telecomsCableLength, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPLastSync=sNTPLastSync, sntp=sntp, wirelessLinkAvailability=wirelessLinkAvailability, userName=userName, range=range, dataPortAutoNegotiation=dataPortAutoNegotiation, installArmStateTrap=installArmStateTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, alarmsGroup=alarmsGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, notificationsGroup=notificationsGroup, telecomsInterface=telecomsInterface, telnetPortNumber=telnetPortNumber, dataPortStatus=dataPortStatus, transmitDataRate=transmitDataRate, dfsGroup=dfsGroup, groupID=groupID, dfsTableNumber=dfsTableNumber, frequencyVariant=frequencyVariant, secondarySoftwareVersion=secondarySoftwareVersion, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, gatewayIPAddress=gatewayIPAddress, syslogState=syslogState, linkSymmetry=linkSymmetry, regionCode=regionCode, syslogControlGroup=syslogControlGroup, channelChangeTrap=channelChangeTrap, ethernet=ethernet, altitude=altitude, sNMPTrapTableIndex=sNMPTrapTableIndex, targetMACAddress=targetMACAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, aAAControlGroup=aAAControlGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, eIRP=eIRP, siteName=siteName, telecomsLineCode=telecomsLineCode, syslogControl=syslogControl, productVariant=productVariant, pubStats=pubStats, receivePower=receivePower, sNTPPollInterval=sNTPPollInterval, configuration=configuration, transmitPower=transmitPower, sNTPServerPortNumber=sNTPServerPortNumber, telecomsChannelStatusTrap=telecomsChannelStatusTrap, cambium=cambium, unitOutOfCalibration=unitOutOfCalibration, vLANPriorityTable=vLANPriorityTable)
