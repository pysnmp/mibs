...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", aggregateDataRate=aggregateDataRate, sNMPEnabledTraps=sNMPEnabledTraps, configurationGroup=configurationGroup, systemClock=systemClock, gatewayIPAddress=gatewayIPAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, linkName=linkName, vLANManagementPriority=vLANManagementPriority, aAAControlGroup=aAAControlGroup, channelChangeTrap=channelChangeTrap, latitude=latitude, telecomsInterface=telecomsInterface, dfsTableNumber=dfsTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, ptmp=ptmp, dataPortAutoNegotiation=dataPortAutoNegotiation, phyControl=phyControl, licence=licence, unitOutOfCalibration=unitOutOfCalibration, linkSymmetry=linkSymmetry, syslogLocalWrappedTrap=syslogLocalWrappedTrap, versions=versions, licensedCapacity=licensedCapacity, transmitFreqMHz=transmitFreqMHz, userEnabled=userEnabled, telnetAccessEnabled=telnetAccessEnabled, userTableNumber=userTableNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, wirelessLinkAvailability=wirelessLinkAvailability, tDDControlGroup=tDDControlGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, incompatibleRegionCodes=incompatibleRegionCodes, telecomsChannelStatusTrap=telecomsChannelStatusTrap, bandwidthVariant=bandwidthVariant, transmitModulationMode=transmitModulationMode, sNMPTrapTable=sNMPTrapTable, tDDSynchronizationStatus=tDDSynchronizationStatus, capacityLicenseMismatch=capacityLicenseMismatch, telecomsLineCode=telecomsLineCode, telecomsLoopback=telecomsLoopback, groupID=groupID, sMTPServerIPAddress=sMTPServerIPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, PYSNMP_MODULE_ID=cambium, ptpTrapPrefix=ptpTrapPrefix, telecom=telecom, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, supplementary=supplementary, accessMethod=accessMethod, byteErrorRatio=byteErrorRatio, productVariant=productVariant, transmitPower=transmitPower, syslogClient=syslogClient, ethernet=ethernet, softwareVersion=softwareVersion, ptp=ptp, tDDControl=tDDControl, dfs=dfs, hTTPSPortNumber=hTTPSPortNumber, ethernetFiberSupport=ethernetFiberSupport, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dfsPeaks=dfsPeaks, sMTPServerPortNumber=sMTPServerPortNumber, sNMPCommunityString=sNMPCommunityString, syslogStateTrap=syslogStateTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tDDSynchronizationAlarm=tDDSynchronizationAlarm, hTTPAccessEnabled=hTTPAccessEnabled, snmpControlGroup=snmpControlGroup, dataPortAutoMdix=dataPortAutoMdix, installArmStateTrap=installArmStateTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, pubStats=pubStats, smtp=smtp, resetGroup=resetGroup, siteName=siteName, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, sMTPEmailAlert=sMTPEmailAlert, receiveModulationModeDetail=receiveModulationModeDetail, userRole=userRole, versionsGroup=versionsGroup, antennaGain=antennaGain, installArmState=installArmState, hardwareVersion=hardwareVersion, sNMPTrapIPAddress=sNMPTrapIPAddress, range=range, telecomsChannelStatus=telecomsChannelStatus, receiveChannel=receiveChannel, cableLoss=cableLoss, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, smtpGroup=smtpGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, alarmsGroup=alarmsGroup, licenceGroup=licenceGroup, notificationsGroup=notificationsGroup, transmitChannel=transmitChannel, sNTPState=sNTPState, userPassword=userPassword, ethernetGroup=ethernetGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, targetMACAddress=targetMACAddress, frequencyVariant=frequencyVariant, vLANManagementVID=vLANManagementVID, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapVersion=sNMPTrapVersion, sNTPServerPortNumber=sNTPServerPortNumber, installStatusTrap=installStatusTrap, telecomGroup=telecomGroup, telnetPortNumber=telnetPortNumber, dataPortStatusTrap=dataPortStatusTrap, cambium=cambium, sNMPTrapTableIndex=sNMPTrapTableIndex, alarms=alarms, regionCode=regionCode, maximumTransmitPower=maximumTransmitPower, ptp500=ptp500, receivePower=receivePower, syslogClientTrap=syslogClientTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, encryptionAlgorithm=encryptionAlgorithm, encryption=encryption, sNTPSync=sNTPSync, altitude=altitude, iPAddress=iPAddress, sntp=sntp, pubStatsGroup=pubStatsGroup, vectorError=vectorError, eIRP=eIRP, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, snmpControl=snmpControl, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dfsMeans=dfsMeans, userName=userName, receiveFreqKHz=receiveFreqKHz, dfsTableEntry=dfsTableEntry, systemReset=systemReset, transmitFreqKHz=transmitFreqKHz, phyStatus=phyStatus, syslogState=syslogState, receiveFreqMHz=receiveFreqMHz, phyControlGroup=phyControlGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ptpTraps=ptpTraps, management=management, syslogControl=syslogControl, transmitDataRate=transmitDataRate, dfsGroup=dfsGroup, timeZone=timeZone, vLANPriorityQueueMapping=vLANPriorityQueueMapping, tDDSynchronizationMode=tDDSynchronizationMode, dataPortDisabledWarning=dataPortDisabledWarning, ptpGroups=ptpGroups, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dfsTable=dfsTable, linkModeOptimizationMismatch=linkModeOptimizationMismatch, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sMTPEnabledMessages=sMTPEnabledMessages, longitude=longitude, channelBandwidth=channelBandwidth, dataPortWirelessDownAlert=dataPortWirelessDownAlert, encryptionGroup=encryptionGroup, sNTPLastSync=sNTPLastSync, bootVersion=bootVersion, linkModeOptimisation=linkModeOptimisation, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, reset=reset, receiveDataRate=receiveDataRate, telecomsCableLength=telecomsCableLength, enabledDiagnosticAlarms=enabledDiagnosticAlarms, managementGroup=managementGroup, daylightSaving=daylightSaving, sntpGroup=sntpGroup, aAAControl=aAAControl, installStatus=installStatus, ptpCompliance=ptpCompliance, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogControlGroup=syslogControlGroup, supplementaryGroup=supplementaryGroup, dataPortStatus=dataPortStatus, configuration=configuration, remoteIPAddress=remoteIPAddress, userTableEntry=userTableEntry, hTTPPortNumber=hTTPPortNumber, productName=productName, dataPortConfigurationMismatch=dataPortConfigurationMismatch, secondarySoftwareVersion=secondarySoftwareVersion, sNTPSyncTrap=sNTPSyncTrap, dfsTableIndex=dfsTableIndex, vLANPriorityTableIndex=vLANPriorityTableIndex, signalStrengthRatio=signalStrengthRatio, phyStatusGroup=phyStatusGroup, subnetMask=subnetMask, telecomsLoopbackTrap=telecomsLoopbackTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, regionCodeTrap=regionCodeTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPPollInterval=sNTPPollInterval, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tFTPServerPortNumber=tFTPServerPortNumber, linkLoss=linkLoss, userTable=userTable, userTableIndex=userTableIndex, searchState=searchState, masterSlaveMode=masterSlaveMode, sNMPv3Enable=sNMPv3Enable, receiveModulationMode=receiveModulationMode, vLANPriorityTable=vLANPriorityTable, wirelessLinkStatus=wirelessLinkStatus, sNMPPortNumber=sNMPPortNumber, sNTPServerIPAddress=sNTPServerIPAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap)
