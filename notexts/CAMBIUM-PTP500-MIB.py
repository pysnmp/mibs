...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, telecomsLoopbackTrap=telecomsLoopbackTrap, tDDSynchronizationMode=tDDSynchronizationMode, dfsTable=dfsTable, vectorError=vectorError, notificationsGroup=notificationsGroup, supplementary=supplementary, targetMACAddress=targetMACAddress, cableLoss=cableLoss, telecomsLineCode=telecomsLineCode, dfsTableNumber=dfsTableNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPCommunityString=sNMPCommunityString, dfsGroup=dfsGroup, sntpGroup=sntpGroup, sMTPEmailAlert=sMTPEmailAlert, systemClock=systemClock, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, hTTPSPortNumber=hTTPSPortNumber, sNMPTrapVersion=sNMPTrapVersion, byteErrorRatio=byteErrorRatio, encryption=encryption, antennaGain=antennaGain, systemReset=systemReset, userName=userName, range=range, syslogClient=syslogClient, management=management, vLANPriorityTableEntry=vLANPriorityTableEntry, transmitPower=transmitPower, incompatibleRegionCodes=incompatibleRegionCodes, telecom=telecom, telecomsInterface=telecomsInterface, linkModeOptimisation=linkModeOptimisation, receiveFreqMHz=receiveFreqMHz, syslogStateTrap=syslogStateTrap, ptpCompliance=ptpCompliance, sNMPTrapIPAddress=sNMPTrapIPAddress, ptpTrapPrefix=ptpTrapPrefix, snmpControlGroup=snmpControlGroup, ethernetGroup=ethernetGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPPortNumber=sNMPPortNumber, dfsTableEntry=dfsTableEntry, encryptionAlgorithm=encryptionAlgorithm, telnetAccessEnabled=telnetAccessEnabled, smtp=smtp, tFTPServerIPAddress=tFTPServerIPAddress, ptpGroups=ptpGroups, tDDControlGroup=tDDControlGroup, tFTPServerPortNumber=tFTPServerPortNumber, iPAddress=iPAddress, phyControl=phyControl, linkLoss=linkLoss, transmitChannel=transmitChannel, userTableIndex=userTableIndex, masterSlaveMode=masterSlaveMode, siteName=siteName, tDDControl=tDDControl, bootVersion=bootVersion, aggregateDataRate=aggregateDataRate, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNTPServerPortNumber=sNTPServerPortNumber, encryptionGroup=encryptionGroup, managementGroup=managementGroup, receiveFreqKHz=receiveFreqKHz, hardwareVersion=hardwareVersion, resetGroup=resetGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dfsPeaks=dfsPeaks, transmitFreqMHz=transmitFreqMHz, syslogClientTrap=syslogClientTrap, searchState=searchState, dataPortAutoMdix=dataPortAutoMdix, sNMPv3Enable=sNMPv3Enable, secondarySoftwareVersion=secondarySoftwareVersion, wirelessLinkStatus=wirelessLinkStatus, phyStatusGroup=phyStatusGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, vLANManagementVID=vLANManagementVID, syslogControl=syslogControl, frequencyVariant=frequencyVariant, latitude=latitude, alarmsGroup=alarmsGroup, sntp=sntp, userTableNumber=userTableNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, accessMethod=accessMethod, ethernetFiberSupport=ethernetFiberSupport, signalStrengthRatio=signalStrengthRatio, constantPowerSpectralDensity=constantPowerSpectralDensity, sNTPServerIPAddress=sNTPServerIPAddress, sNMPTrapTable=sNMPTrapTable, productVariant=productVariant, vLANPriorityTableNumber=vLANPriorityTableNumber, sNTPSyncTrap=sNTPSyncTrap, snmpControl=snmpControl, configuration=configuration, installArmState=installArmState, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, linkSymmetry=linkSymmetry, supplementaryGroup=supplementaryGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, phyControlGroup=phyControlGroup, dfs=dfs, telecomsLoopback=telecomsLoopback, dataPortWirelessDownAlert=dataPortWirelessDownAlert, productName=productName, transmitModulationMode=transmitModulationMode, versions=versions, enabledDiagnosticAlarms=enabledDiagnosticAlarms, linkName=linkName, maximumTransmitPower=maximumTransmitPower, dfsTableIndex=dfsTableIndex, noWirelessChannelAvailable=noWirelessChannelAvailable, unitOutOfCalibration=unitOutOfCalibration, sNTPPollInterval=sNTPPollInterval, syslogState=syslogState, gatewayIPAddress=gatewayIPAddress, channelChangeTrap=channelChangeTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, PYSNMP_MODULE_ID=cambium, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNTPState=sNTPState, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernet=ethernet, installStatus=installStatus, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dataPortDisabledWarning=dataPortDisabledWarning, capacityLicenseMismatch=capacityLicenseMismatch, sNMPTrapTableIndex=sNMPTrapTableIndex, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPLastSync=sNTPLastSync, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPEnabledTraps=sNMPEnabledTraps, telecomsChannelStatus=telecomsChannelStatus, sMTPServerPortNumber=sMTPServerPortNumber, licensedCapacity=licensedCapacity, ptp500=ptp500, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, hTTPAccessEnabled=hTTPAccessEnabled, ptpTraps=ptpTraps, receiveModulationModeDetail=receiveModulationModeDetail, telnetPortNumber=telnetPortNumber, bandwidthVariant=bandwidthVariant, vLANPriorityQueueMapping=vLANPriorityQueueMapping, aAAControlGroup=aAAControlGroup, sNTPSync=sNTPSync, syslogControlGroup=syslogControlGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, cambium=cambium, eIRP=eIRP, versionsGroup=versionsGroup, groupID=groupID, userTableEntry=userTableEntry, userRole=userRole, timeZone=timeZone, hTTPPortNumber=hTTPPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, channelBandwidth=channelBandwidth, telecomsCableLength=telecomsCableLength, dataPortStatus=dataPortStatus, smtpGroup=smtpGroup, phyStatus=phyStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, receiveModulationMode=receiveModulationMode, alarms=alarms, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, linkModeOptimizationMismatch=linkModeOptimizationMismatch, transmitDataRate=transmitDataRate, daylightSaving=daylightSaving, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, pubStatsGroup=pubStatsGroup, ptmp=ptmp, softwareVersion=softwareVersion, reset=reset, aAAControl=aAAControl, dfsMeans=dfsMeans, installArmStateTrap=installArmStateTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, regionCodeTrap=regionCodeTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, ptp=ptp, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, wirelessLinkAvailability=wirelessLinkAvailability, licenceGroup=licenceGroup, receiveChannel=receiveChannel, transmitFreqKHz=transmitFreqKHz, vLANPriorityTable=vLANPriorityTable, remoteIPAddress=remoteIPAddress, userTable=userTable, sMTPServerIPAddress=sMTPServerIPAddress, longitude=longitude, installStatusTrap=installStatusTrap, altitude=altitude, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, subnetMask=subnetMask, configurationGroup=configurationGroup, userEnabled=userEnabled, vLANManagementPriority=vLANManagementPriority, pubStats=pubStats, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPEnabledMessages=sMTPEnabledMessages, regionCode=regionCode, telecomGroup=telecomGroup, dataPortStatusTrap=dataPortStatusTrap, receiveDataRate=receiveDataRate, licence=licence, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, userPassword=userPassword, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapPortNumber=sNMPTrapPortNumber, receivePower=receivePower)
