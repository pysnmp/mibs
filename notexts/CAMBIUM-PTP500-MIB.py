...
TimeTicks, Integer32, ModuleIdentity, iso, enterprises, Bits, Counter32, MibIdentifier, Counter64, IpAddress, Unsigned32, Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Integer32", "ModuleIdentity", "iso", "enterprises", "Bits", "Counter32", "MibIdentifier", "Counter64", "IpAddress", "Unsigned32", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", tDDSynchronizationStatus=tDDSynchronizationStatus, aAAControlGroup=aAAControlGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, hTTPPortNumber=hTTPPortNumber, dfsGroup=dfsGroup, softwareVersion=softwareVersion, systemReset=systemReset, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, hTTPSAccessEnabled=hTTPSAccessEnabled, eIRP=eIRP, ptpTrapPrefix=ptpTrapPrefix, aggregateDataRate=aggregateDataRate, ptp500=ptp500, transmitFreqKHz=transmitFreqKHz, sNMPEnabledTraps=sNMPEnabledTraps, installStatusTrap=installStatusTrap, dataPortStatus=dataPortStatus, smtp=smtp, userTableNumber=userTableNumber, targetMACAddress=targetMACAddress, licence=licence, masterSlaveMode=masterSlaveMode, installArmStateTrap=installArmStateTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, gatewayIPAddress=gatewayIPAddress, alarms=alarms, systemClock=systemClock, userTableEntry=userTableEntry, cableLoss=cableLoss, dfsTableNumber=dfsTableNumber, iPAddress=iPAddress, versions=versions, licensedCapacity=licensedCapacity, constantPowerSpectralDensity=constantPowerSpectralDensity, versionsGroup=versionsGroup, sMTPServerIPAddress=sMTPServerIPAddress, dfsPeaks=dfsPeaks, hTTPAccessEnabled=hTTPAccessEnabled, transmitPower=transmitPower, managementGroup=managementGroup, vLANManagementPriority=vLANManagementPriority, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, wirelessLinkAvailability=wirelessLinkAvailability, regionCodeTrap=regionCodeTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNTPServerIPAddress=sNTPServerIPAddress, timeZone=timeZone, noWirelessChannelAvailable=noWirelessChannelAvailable, supplementaryGroup=supplementaryGroup, management=management, installArmState=installArmState, ptmp=ptmp, userEnabled=userEnabled, linkModeOptimisation=linkModeOptimisation, receivePower=receivePower, vLANPriorityQueueMapping=vLANPriorityQueueMapping, telnetAccessEnabled=telnetAccessEnabled, transmitFreqMHz=transmitFreqMHz, linkLoss=linkLoss, receiveModulationModeDetail=receiveModulationModeDetail, sNTPState=sNTPState, channelChangeTrap=channelChangeTrap, syslogClient=syslogClient, userTable=userTable, receiveFreqKHz=receiveFreqKHz, encryptionAlgorithm=encryptionAlgorithm, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNTPSync=sNTPSync, regionCode=regionCode, resetGroup=resetGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dfsTableEntry=dfsTableEntry, encryptionGroup=encryptionGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, ptp=ptp, siteName=siteName, telecomsLoopback=telecomsLoopback, transmitModulationMode=transmitModulationMode, dataPortDisabledWarning=dataPortDisabledWarning, ptpTraps=ptpTraps, userPassword=userPassword, configuration=configuration, syslogClientTrap=syslogClientTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, receiveDataRate=receiveDataRate, groupID=groupID, receiveModulationMode=receiveModulationMode, userName=userName, enabledDiagnosticAlarms=enabledDiagnosticAlarms, channelBandwidth=channelBandwidth, sMTPServerPortNumber=sMTPServerPortNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, snmpControl=snmpControl, vLANPriorityTableNumber=vLANPriorityTableNumber, pubStats=pubStats, pubStatsGroup=pubStatsGroup, linkName=linkName, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPTrapVersion=sNMPTrapVersion, tFTPServerIPAddress=tFTPServerIPAddress, PYSNMP_MODULE_ID=cambium, telecomsInterface=telecomsInterface, maximumTransmitPower=maximumTransmitPower, userRole=userRole, dfsMeans=dfsMeans, dataPortAutoMdix=dataPortAutoMdix, telecomsLoopbackTrap=telecomsLoopbackTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sntpGroup=sntpGroup, incompatibleRegionCodes=incompatibleRegionCodes, antennaGain=antennaGain, byteErrorRatio=byteErrorRatio, userTableIndex=userTableIndex, sNMPPortNumber=sNMPPortNumber, alarmsGroup=alarmsGroup, receiveFreqMHz=receiveFreqMHz, sMTPEnabledMessages=sMTPEnabledMessages, tFTPServerPortNumber=tFTPServerPortNumber, licenceGroup=licenceGroup, receiveChannel=receiveChannel, sNMPv3Enable=sNMPv3Enable, range=range, snmpControlGroup=snmpControlGroup, searchState=searchState, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, linkSymmetry=linkSymmetry, tDDControlGroup=tDDControlGroup, unitOutOfCalibration=unitOutOfCalibration, daylightSaving=daylightSaving, telecomsChannelStatus=telecomsChannelStatus, syslogStateTrap=syslogStateTrap, configurationGroup=configurationGroup, frequencyVariant=frequencyVariant, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, telecomGroup=telecomGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ptpGroups=ptpGroups, telecomsCableLength=telecomsCableLength, accessMethod=accessMethod, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, notificationsGroup=notificationsGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, phyControlGroup=phyControlGroup, tDDControl=tDDControl, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPCommunityString=sNMPCommunityString, sntp=sntp, transmitDataRate=transmitDataRate, aAAControl=aAAControl, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNTPSyncTrap=sNTPSyncTrap, dfs=dfs, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dfsTableIndex=dfsTableIndex, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, supplementary=supplementary, sNTPLastSync=sNTPLastSync, tDDSynchronizationMode=tDDSynchronizationMode, subnetMask=subnetMask, vectorError=vectorError, sNTPPollInterval=sNTPPollInterval, sNTPServerPortNumber=sNTPServerPortNumber, dataPortStatusTrap=dataPortStatusTrap, ethernet=ethernet, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, telnetPortNumber=telnetPortNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, remoteIPAddress=remoteIPAddress, capacityLicenseMismatch=capacityLicenseMismatch, phyStatus=phyStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, encryption=encryption, ethernetFiberSupport=ethernetFiberSupport, productVariant=productVariant, phyControl=phyControl, ptpCompliance=ptpCompliance, hTTPSPortNumber=hTTPSPortNumber, latitude=latitude, longitude=longitude, signalStrengthRatio=signalStrengthRatio, syslogControlGroup=syslogControlGroup, installStatus=installStatus, altitude=altitude, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sMTPEmailAlert=sMTPEmailAlert, dfsTable=dfsTable, vLANPriorityTableEntry=vLANPriorityTableEntry, wirelessLinkStatus=wirelessLinkStatus, dataPortAutoNegotiation=dataPortAutoNegotiation, sMTPSourceEmailAddress=sMTPSourceEmailAddress, smtpGroup=smtpGroup, vLANManagementVID=vLANManagementVID, syslogControl=syslogControl, secondarySoftwareVersion=secondarySoftwareVersion, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, telecom=telecom, sNMPTrapTable=sNMPTrapTable, bandwidthVariant=bandwidthVariant, transmitChannel=transmitChannel, hardwareVersion=hardwareVersion, telecomsLineCode=telecomsLineCode, bootVersion=bootVersion, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, reset=reset, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapIPAddress=sNMPTrapIPAddress, vLANPriorityTable=vLANPriorityTable, ethernetGroup=ethernetGroup, phyStatusGroup=phyStatusGroup, cambium=cambium, productName=productName, syslogState=syslogState)
