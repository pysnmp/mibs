...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", encryption=encryption, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, phyStatus=phyStatus, bandwidthVariant=bandwidthVariant, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ptp=ptp, remoteIPAddress=remoteIPAddress, linkModeOptimisation=linkModeOptimisation, daylightSaving=daylightSaving, dataPortAutoNegotiation=dataPortAutoNegotiation, telecomsLoopback=telecomsLoopback, telnetPortNumber=telnetPortNumber, range=range, hTTPAccessEnabled=hTTPAccessEnabled, receiveDataRate=receiveDataRate, telecomGroup=telecomGroup, sNTPPollInterval=sNTPPollInterval, userRole=userRole, timeZone=timeZone, latitude=latitude, userName=userName, dfsGroup=dfsGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, hardwareVersion=hardwareVersion, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sMTPServerPortNumber=sMTPServerPortNumber, sNTPSyncTrap=sNTPSyncTrap, sNMPCommunityString=sNMPCommunityString, dataPortDisabledWarning=dataPortDisabledWarning, telecomsChannelStatus=telecomsChannelStatus, dataPortConfigurationMismatch=dataPortConfigurationMismatch, regionCodeTrap=regionCodeTrap, alarmsGroup=alarmsGroup, cambium=cambium, dfsTableIndex=dfsTableIndex, gatewayIPAddress=gatewayIPAddress, secondarySoftwareVersion=secondarySoftwareVersion, vLANPriorityTable=vLANPriorityTable, syslogStateTrap=syslogStateTrap, receiveModulationModeDetail=receiveModulationModeDetail, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, transmitPower=transmitPower, resetGroup=resetGroup, installStatus=installStatus, ptmp=ptmp, regionCode=regionCode, ptpTraps=ptpTraps, dfsTableEntry=dfsTableEntry, sNMPv3Enable=sNMPv3Enable, telecom=telecom, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, telecomsInterface=telecomsInterface, snmpControl=snmpControl, snmpControlGroup=snmpControlGroup, userTableEntry=userTableEntry, tFTPServerPortNumber=tFTPServerPortNumber, transmitFreqMHz=transmitFreqMHz, constantPowerSpectralDensity=constantPowerSpectralDensity, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sMTPSourceEmailAddress=sMTPSourceEmailAddress, syslogClient=syslogClient, systemReset=systemReset, telecomsChannelStatusTrap=telecomsChannelStatusTrap, telecomsCableLength=telecomsCableLength, sNTPServerPortNumber=sNTPServerPortNumber, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, receiveChannel=receiveChannel, vLANPriorityQueueMapping=vLANPriorityQueueMapping, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, productVariant=productVariant, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, pubStatsGroup=pubStatsGroup, antennaGain=antennaGain, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, alarms=alarms, aAAControl=aAAControl, licenceGroup=licenceGroup, receiveFreqMHz=receiveFreqMHz, sNTPSync=sNTPSync, hTTPSPortNumber=hTTPSPortNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, userEnabled=userEnabled, iPAddress=iPAddress, sntpGroup=sntpGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, syslogClientTrap=syslogClientTrap, hTTPPortNumber=hTTPPortNumber, userTableNumber=userTableNumber, phyStatusGroup=phyStatusGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, telecomsLineCode=telecomsLineCode, aggregateDataRate=aggregateDataRate, longitude=longitude, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapIPAddress=sNMPTrapIPAddress, vLANPriorityTableNumber=vLANPriorityTableNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ethernetGroup=ethernetGroup, dataPortAutoMdix=dataPortAutoMdix, searchState=searchState, incompatibleMasterAndSlave=incompatibleMasterAndSlave, licence=licence, ptpTrapPrefix=ptpTrapPrefix, maximumTransmitPower=maximumTransmitPower, PYSNMP_MODULE_ID=cambium, linkSymmetry=linkSymmetry, sNMPTrapTableEntry=sNMPTrapTableEntry, tDDSynchronizationMode=tDDSynchronizationMode, userTableIndex=userTableIndex, subnetMask=subnetMask, linkName=linkName, telnetAccessEnabled=telnetAccessEnabled, ptp500=ptp500, installArmState=installArmState, softwareVersion=softwareVersion, versions=versions, versionsGroup=versionsGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, management=management, eIRP=eIRP, cableLoss=cableLoss, wirelessLinkAvailability=wirelessLinkAvailability, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, signalStrengthRatio=signalStrengthRatio, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, ethernet=ethernet, ptpCompliance=ptpCompliance, productName=productName, tFTPServerIPAddress=tFTPServerIPAddress, encryptionGroup=encryptionGroup, receiveModulationMode=receiveModulationMode, supplementary=supplementary, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPTrapPortNumber=sNMPTrapPortNumber, userPassword=userPassword, vLANManagementPriority=vLANManagementPriority, hTTPSAccessEnabled=hTTPSAccessEnabled, dfsMeans=dfsMeans, sMTPEnabledMessages=sMTPEnabledMessages, capacityLicenseMismatch=capacityLicenseMismatch, syslogControlGroup=syslogControlGroup, configuration=configuration, configurationGroup=configurationGroup, dfsTable=dfsTable, dfs=dfs, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, installArmStateTrap=installArmStateTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, groupID=groupID, systemClock=systemClock, vLANManagementVID=vLANManagementVID, vLANPriorityTableIndex=vLANPriorityTableIndex, tDDControl=tDDControl, transmitDataRate=transmitDataRate, altitude=altitude, pubStats=pubStats, sNTPState=sNTPState, telecomsLoopbackTrap=telecomsLoopbackTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, vLANPriorityTableEntry=vLANPriorityTableEntry, phyControl=phyControl, managementGroup=managementGroup, licensedCapacity=licensedCapacity, sntp=sntp, transmitModulationMode=transmitModulationMode, sNTPServerIPAddress=sNTPServerIPAddress, ptpGroups=ptpGroups, targetMACAddress=targetMACAddress, bootVersion=bootVersion, phyControlGroup=phyControlGroup, encryptionAlgorithm=encryptionAlgorithm, syslogLocalWrappedTrap=syslogLocalWrappedTrap, wirelessLinkStatus=wirelessLinkStatus, dataPortStatus=dataPortStatus, userTable=userTable, transmitChannel=transmitChannel, unitOutOfCalibration=unitOutOfCalibration, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPTrapTable=sNMPTrapTable, dfsTableNumber=dfsTableNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNTPLastSync=sNTPLastSync, byteErrorRatio=byteErrorRatio, receivePower=receivePower, supplementaryGroup=supplementaryGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, smtpGroup=smtpGroup, dataPortStatusTrap=dataPortStatusTrap, ethernetFiberSupport=ethernetFiberSupport, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogState=syslogState, sMTPServerIPAddress=sMTPServerIPAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPPortNumber=sNMPPortNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, reset=reset, sNMPEnabledTraps=sNMPEnabledTraps, siteName=siteName, smtp=smtp, sNMPTrapVersion=sNMPTrapVersion, channelChangeTrap=channelChangeTrap, frequencyVariant=frequencyVariant, notificationsGroup=notificationsGroup, installStatusTrap=installStatusTrap, tDDControlGroup=tDDControlGroup, aAAControlGroup=aAAControlGroup, transmitFreqKHz=transmitFreqKHz, syslogControl=syslogControl, noWirelessChannelAvailable=noWirelessChannelAvailable, incompatibleRegionCodes=incompatibleRegionCodes, dfsPeaks=dfsPeaks, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, channelBandwidth=channelBandwidth, linkLoss=linkLoss, masterSlaveMode=masterSlaveMode, accessMethod=accessMethod, receiveFreqKHz=receiveFreqKHz, vectorError=vectorError)
