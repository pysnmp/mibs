...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", masterSlaveMode=masterSlaveMode, dataPortStatus=dataPortStatus, linkModeOptimisation=linkModeOptimisation, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPState=sNTPState, sNTPServerPortNumber=sNTPServerPortNumber, tDDControl=tDDControl, userTableIndex=userTableIndex, ptpTrapPrefix=ptpTrapPrefix, PYSNMP_MODULE_ID=cambium, sMTPServerIPAddress=sMTPServerIPAddress, dataPortStatusTrap=dataPortStatusTrap, byteErrorRatio=byteErrorRatio, vLANPriorityQueueMapping=vLANPriorityQueueMapping, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telecomsLineCode=telecomsLineCode, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, capacityLicenseMismatch=capacityLicenseMismatch, linkLoss=linkLoss, sNTPSync=sNTPSync, telecomsInterface=telecomsInterface, dfsTable=dfsTable, iPAddress=iPAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, softwareVersion=softwareVersion, managementGroup=managementGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, wirelessLinkAvailability=wirelessLinkAvailability, accessMethod=accessMethod, subnetMask=subnetMask, hTTPPortNumber=hTTPPortNumber, sntp=sntp, dataPortConfigurationMismatch=dataPortConfigurationMismatch, gatewayIPAddress=gatewayIPAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, searchState=searchState, latitude=latitude, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, eIRP=eIRP, syslogState=syslogState, userTableEntry=userTableEntry, dataPortDisabledWarning=dataPortDisabledWarning, sNTPLastSync=sNTPLastSync, maximumTransmitPower=maximumTransmitPower, tDDSynchronizationStatus=tDDSynchronizationStatus, phyControl=phyControl, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, siteName=siteName, userPassword=userPassword, remoteMaximumTransmitPower=remoteMaximumTransmitPower, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, telecomsLoopbackTrap=telecomsLoopbackTrap, tFTPServerIPAddress=tFTPServerIPAddress, licenceGroup=licenceGroup, ptp=ptp, hardwareVersion=hardwareVersion, receiveModulationMode=receiveModulationMode, sntpGroup=sntpGroup, telecomsLoopback=telecomsLoopback, sMTPSourceEmailAddress=sMTPSourceEmailAddress, installStatusTrap=installStatusTrap, dfsTableNumber=dfsTableNumber, targetMACAddress=targetMACAddress, groupID=groupID, pubStats=pubStats, sNMPTrapTableIndex=sNMPTrapTableIndex, ethernetGroup=ethernetGroup, antennaGain=antennaGain, sNMPEnabledTraps=sNMPEnabledTraps, telecomsChannelStatusTrap=telecomsChannelStatusTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, syslogControl=syslogControl, telecomsChannelStatus=telecomsChannelStatus, aggregateDataRate=aggregateDataRate, sMTPEmailAlert=sMTPEmailAlert, transmitModulationMode=transmitModulationMode, snmpControlGroup=snmpControlGroup, smtp=smtp, hTTPSAccessEnabled=hTTPSAccessEnabled, receiveModulationModeDetail=receiveModulationModeDetail, userRole=userRole, configuration=configuration, productName=productName, vLANManagementVID=vLANManagementVID, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, supplementary=supplementary, channelChangeTrap=channelChangeTrap, syslogControlGroup=syslogControlGroup, systemReset=systemReset, useVLANForManagementInterfaces=useVLANForManagementInterfaces, telecomsCableLength=telecomsCableLength, receiveChannel=receiveChannel, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, telecom=telecom, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, licence=licence, linkName=linkName, productVariant=productVariant, telnetAccessEnabled=telnetAccessEnabled, vectorError=vectorError, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, timeZone=timeZone, vLANPriorityTable=vLANPriorityTable, hTTPSPortNumber=hTTPSPortNumber, receivePower=receivePower, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, transmitPower=transmitPower, signalStrengthRatio=signalStrengthRatio, bandwidthVariant=bandwidthVariant, phyStatusGroup=phyStatusGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, installArmState=installArmState, phyControlGroup=phyControlGroup, tDDControlGroup=tDDControlGroup, userName=userName, userTableNumber=userTableNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, userTable=userTable, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, phyStatus=phyStatus, ptpCompliance=ptpCompliance, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sMTPEnabledMessages=sMTPEnabledMessages, ptmp=ptmp, sNTPPollInterval=sNTPPollInterval, aAAControl=aAAControl, transmitDataRate=transmitDataRate, licensedCapacity=licensedCapacity, longitude=longitude, ptpTraps=ptpTraps, transmitChannel=transmitChannel, incompatibleRegionCodes=incompatibleRegionCodes, installArmStateTrap=installArmStateTrap, ptp500=ptp500, regionCode=regionCode, vLANManagementPriority=vLANManagementPriority, encryption=encryption, alarmsGroup=alarmsGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, channelBandwidth=channelBandwidth, vLANPriorityTableEntry=vLANPriorityTableEntry, sNMPTrapVersion=sNMPTrapVersion, telnetPortNumber=telnetPortNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsGroup=dfsGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, secondarySoftwareVersion=secondarySoftwareVersion, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPTrapTable=sNMPTrapTable, sNMPTrapTableEntry=sNMPTrapTableEntry, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, cableLoss=cableLoss, tFTPServerPortNumber=tFTPServerPortNumber, wirelessLinkStatus=wirelessLinkStatus, notificationsGroup=notificationsGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dfsTableIndex=dfsTableIndex, userEnabled=userEnabled, bootVersion=bootVersion, sNMPPortNumber=sNMPPortNumber, vLANPriorityTableIndex=vLANPriorityTableIndex, ethernetFiberSupport=ethernetFiberSupport, installStatus=installStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, daylightSaving=daylightSaving, transmitFreqKHz=transmitFreqKHz, syslogClientTrap=syslogClientTrap, resetGroup=resetGroup, sNMPv3Enable=sNMPv3Enable, enabledDiagnosticAlarms=enabledDiagnosticAlarms, syslogClient=syslogClient, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, frequencyVariant=frequencyVariant, systemClock=systemClock, receiveFreqKHz=receiveFreqKHz, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, snmpControl=snmpControl, vLANPriorityTableNumber=vLANPriorityTableNumber, sNMPCommunityString=sNMPCommunityString, sNTPSyncTrap=sNTPSyncTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, syslogStateTrap=syslogStateTrap, dfsPeaks=dfsPeaks, receiveFreqMHz=receiveFreqMHz, regionCodeTrap=regionCodeTrap, management=management, sMTPServerPortNumber=sMTPServerPortNumber, dfsTableEntry=dfsTableEntry, dfsMeans=dfsMeans, alarms=alarms, incompatibleMasterAndSlave=incompatibleMasterAndSlave, linkSymmetry=linkSymmetry, sNTPServerIPAddress=sNTPServerIPAddress, range=range, smtpGroup=smtpGroup, altitude=altitude, ethernet=ethernet, remoteIPAddress=remoteIPAddress, pubStatsGroup=pubStatsGroup, unitOutOfCalibration=unitOutOfCalibration, reset=reset, versionsGroup=versionsGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dataPortAutoMdix=dataPortAutoMdix, dfs=dfs, noWirelessChannelAvailable=noWirelessChannelAvailable, hTTPAccessEnabled=hTTPAccessEnabled, telecomGroup=telecomGroup, encryptionAlgorithm=encryptionAlgorithm, cambium=cambium, tDDSynchronizationMode=tDDSynchronizationMode, aAAControlGroup=aAAControlGroup, versions=versions, transmitFreqMHz=transmitFreqMHz, ptpGroups=ptpGroups, supplementaryGroup=supplementaryGroup, configurationGroup=configurationGroup, receiveDataRate=receiveDataRate, encryptionGroup=encryptionGroup)
