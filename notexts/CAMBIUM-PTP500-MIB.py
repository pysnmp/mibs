...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPTrapTable=sNMPTrapTable, hTTPPortNumber=hTTPPortNumber, notificationsGroup=notificationsGroup, snmpControl=snmpControl, productName=productName, gatewayIPAddress=gatewayIPAddress, capacityLicenseMismatch=capacityLicenseMismatch, configuration=configuration, syslogStateTrap=syslogStateTrap, timeZone=timeZone, ptp=ptp, targetMACAddress=targetMACAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, userName=userName, sMTPServerPortNumber=sMTPServerPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, regionCode=regionCode, cambium=cambium, linkModeOptimizationMismatch=linkModeOptimizationMismatch, telnetAccessEnabled=telnetAccessEnabled, vLANPriorityTableIndex=vLANPriorityTableIndex, sNTPLastSync=sNTPLastSync, searchState=searchState, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sMTPEmailAlert=sMTPEmailAlert, sNMPPortNumber=sNMPPortNumber, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sntpGroup=sntpGroup, accessMethod=accessMethod, groupID=groupID, dataPortAutoNegotiation=dataPortAutoNegotiation, longitude=longitude, installStatusTrap=installStatusTrap, userTable=userTable, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dfsMeans=dfsMeans, sNTPSyncTrap=sNTPSyncTrap, hardwareVersion=hardwareVersion, softwareVersion=softwareVersion, latitude=latitude, aAAControlGroup=aAAControlGroup, sNMPEnabledTraps=sNMPEnabledTraps, vectorError=vectorError, ptp500=ptp500, receiveChannel=receiveChannel, receiveModulationMode=receiveModulationMode, alarmsGroup=alarmsGroup, hTTPAccessEnabled=hTTPAccessEnabled, smtpGroup=smtpGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, installStatus=installStatus, siteName=siteName, enabledDiagnosticAlarms=enabledDiagnosticAlarms, daylightSaving=daylightSaving, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, signalStrengthRatio=signalStrengthRatio, sNMPTrapIPAddress=sNMPTrapIPAddress, sntp=sntp, tFTPServerPortNumber=tFTPServerPortNumber, ptpCompliance=ptpCompliance, transmitFreqMHz=transmitFreqMHz, encryption=encryption, userTableIndex=userTableIndex, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ethernetGroup=ethernetGroup, frequencyVariant=frequencyVariant, systemReset=systemReset, versionsGroup=versionsGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, userEnabled=userEnabled, syslogClient=syslogClient, aggregateDataRate=aggregateDataRate, dfsTableNumber=dfsTableNumber, management=management, transmitChannel=transmitChannel, telecomsInterface=telecomsInterface, supplementaryGroup=supplementaryGroup, installArmState=installArmState, userRole=userRole, vLANPriorityTable=vLANPriorityTable, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dfsTableEntry=dfsTableEntry, sNMPCommunityString=sNMPCommunityString, linkModeOptimisation=linkModeOptimisation, dfsTable=dfsTable, syslogState=syslogState, constantPowerSpectralDensity=constantPowerSpectralDensity, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, receiveFreqKHz=receiveFreqKHz, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telecomsChannelStatusTrap=telecomsChannelStatusTrap, managementGroup=managementGroup, channelBandwidth=channelBandwidth, licence=licence, reset=reset, phyStatusGroup=phyStatusGroup, userTableEntry=userTableEntry, subnetMask=subnetMask, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapVersion=sNMPTrapVersion, telnetPortNumber=telnetPortNumber, tDDControl=tDDControl, dataPortConfigurationMismatch=dataPortConfigurationMismatch, PYSNMP_MODULE_ID=cambium, syslogClientTrap=syslogClientTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPPollInterval=sNTPPollInterval, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, antennaGain=antennaGain, receiveDataRate=receiveDataRate, phyStatus=phyStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ethernetFiberSupport=ethernetFiberSupport, userPassword=userPassword, vLANManagementPriority=vLANManagementPriority, transmitPower=transmitPower, versions=versions, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPSync=sNTPSync, ptpGroups=ptpGroups, syslogControlGroup=syslogControlGroup, pubStatsGroup=pubStatsGroup, byteErrorRatio=byteErrorRatio, vLANPriorityTableNumber=vLANPriorityTableNumber, telecom=telecom, eIRP=eIRP, wirelessLinkStatus=wirelessLinkStatus, linkName=linkName, resetGroup=resetGroup, dataPortAutoMdix=dataPortAutoMdix, phyControlGroup=phyControlGroup, telecomsLineCode=telecomsLineCode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tDDSynchronizationMode=tDDSynchronizationMode, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, remoteIPAddress=remoteIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkSymmetry=linkSymmetry, licensedCapacity=licensedCapacity, dfs=dfs, tDDControlGroup=tDDControlGroup, telecomsChannelStatus=telecomsChannelStatus, alarms=alarms, sNMPTrapTableNumber=sNMPTrapTableNumber, receiveFreqMHz=receiveFreqMHz, transmitDataRate=transmitDataRate, unitOutOfCalibration=unitOutOfCalibration, installArmStateTrap=installArmStateTrap, vLANManagementVID=vLANManagementVID, transmitModulationMode=transmitModulationMode, dataPortStatusTrap=dataPortStatusTrap, supplementary=supplementary, ptmp=ptmp, phyControl=phyControl, maximumTransmitPower=maximumTransmitPower, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, smtp=smtp, encryptionGroup=encryptionGroup, hTTPSPortNumber=hTTPSPortNumber, dataPortDisabledWarning=dataPortDisabledWarning, sMTPServerIPAddress=sMTPServerIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, range=range, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPState=sNTPState, sNMPv3Enable=sNMPv3Enable, aAAControl=aAAControl, masterSlaveMode=masterSlaveMode, dfsTableIndex=dfsTableIndex, incompatibleMasterAndSlave=incompatibleMasterAndSlave, configurationGroup=configurationGroup, channelChangeTrap=channelChangeTrap, ptpTraps=ptpTraps, sNTPServerPortNumber=sNTPServerPortNumber, tFTPServerIPAddress=tFTPServerIPAddress, telecomsCableLength=telecomsCableLength, tDDSynchronizationStatus=tDDSynchronizationStatus, snmpControlGroup=snmpControlGroup, secondarySoftwareVersion=secondarySoftwareVersion, vLANPriorityQueueMapping=vLANPriorityQueueMapping, wirelessLinkAvailability=wirelessLinkAvailability, bootVersion=bootVersion, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, transmitFreqKHz=transmitFreqKHz, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dataPortStatus=dataPortStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, telecomGroup=telecomGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, sNMPTrapPortNumber=sNMPTrapPortNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, syslogControl=syslogControl, dfsGroup=dfsGroup, userTableNumber=userTableNumber, pubStats=pubStats, sNTPServerIPAddress=sNTPServerIPAddress, licenceGroup=licenceGroup, iPAddress=iPAddress, linkLoss=linkLoss, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, altitude=altitude, ethernet=ethernet, telecomsLoopback=telecomsLoopback, systemClock=systemClock, ptpTrapPrefix=ptpTrapPrefix, receiveModulationModeDetail=receiveModulationModeDetail, dfsPeaks=dfsPeaks, bandwidthVariant=bandwidthVariant, regionCodeTrap=regionCodeTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, productVariant=productVariant, receivePower=receivePower, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, encryptionAlgorithm=encryptionAlgorithm, incompatibleRegionCodes=incompatibleRegionCodes, cableLoss=cableLoss)
