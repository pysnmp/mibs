...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", vLANPriorityQueueMapping=vLANPriorityQueueMapping, channelChangeTrap=channelChangeTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, notificationsGroup=notificationsGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, receiveModulationModeDetail=receiveModulationModeDetail, userPassword=userPassword, sNTPSync=sNTPSync, telecomsInterface=telecomsInterface, encryptionGroup=encryptionGroup, targetMACAddress=targetMACAddress, receiveChannel=receiveChannel, bootVersion=bootVersion, sNTPServerPortNumber=sNTPServerPortNumber, telnetPortNumber=telnetPortNumber, dfs=dfs, cableLoss=cableLoss, dataPortAutoMdix=dataPortAutoMdix, timeZone=timeZone, PYSNMP_MODULE_ID=cambium, dfsTableEntry=dfsTableEntry, sNMPCommunityString=sNMPCommunityString, incompatibleRegionCodes=incompatibleRegionCodes, longitude=longitude, maximumTransmitPower=maximumTransmitPower, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, antennaGain=antennaGain, secondarySoftwareVersion=secondarySoftwareVersion, latitude=latitude, installStatusTrap=installStatusTrap, subnetMask=subnetMask, userName=userName, installArmState=installArmState, dataPortStatus=dataPortStatus, dfsTableIndex=dfsTableIndex, versions=versions, userTableEntry=userTableEntry, syslogLocalWrappedTrap=syslogLocalWrappedTrap, userTableIndex=userTableIndex, sNTPLastSync=sNTPLastSync, transmitDataRate=transmitDataRate, vLANPriorityTableNumber=vLANPriorityTableNumber, softwareVersion=softwareVersion, hTTPPortNumber=hTTPPortNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, licensedCapacity=licensedCapacity, telecomsLineCode=telecomsLineCode, ptp500=ptp500, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, reset=reset, telecomsChannelStatusTrap=telecomsChannelStatusTrap, resetGroup=resetGroup, configuration=configuration, transmitFreqKHz=transmitFreqKHz, configurationGroup=configurationGroup, systemClock=systemClock, vLANPriorityTable=vLANPriorityTable, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPPollInterval=sNTPPollInterval, managementGroup=managementGroup, sntpGroup=sntpGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, installArmStateTrap=installArmStateTrap, wirelessLinkStatus=wirelessLinkStatus, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, hTTPAccessEnabled=hTTPAccessEnabled, telecomsChannelStatus=telecomsChannelStatus, ethernetGroup=ethernetGroup, telnetAccessEnabled=telnetAccessEnabled, pubStatsGroup=pubStatsGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPTrapIPAddress=sNMPTrapIPAddress, encryptionAlgorithm=encryptionAlgorithm, supplementaryGroup=supplementaryGroup, dataPortDisabledWarning=dataPortDisabledWarning, tDDControlGroup=tDDControlGroup, vLANManagementPriority=vLANManagementPriority, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sMTPEmailAlert=sMTPEmailAlert, regionCodeTrap=regionCodeTrap, frequencyVariant=frequencyVariant, transmitChannel=transmitChannel, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, gatewayIPAddress=gatewayIPAddress, range=range, syslogStateTrap=syslogStateTrap, receiveModulationMode=receiveModulationMode, dataPortStatusTrap=dataPortStatusTrap, cambium=cambium, vLANPriorityTableEntry=vLANPriorityTableEntry, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, aAAControl=aAAControl, daylightSaving=daylightSaving, productVariant=productVariant, management=management, linkLoss=linkLoss, supplementary=supplementary, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, telecomGroup=telecomGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, hTTPSPortNumber=hTTPSPortNumber, syslogControl=syslogControl, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, receiveFreqMHz=receiveFreqMHz, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, iPAddress=iPAddress, productName=productName, ptpCompliance=ptpCompliance, ethernet=ethernet, syslogState=syslogState, encryption=encryption, aAAControlGroup=aAAControlGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, telecom=telecom, masterSlaveMode=masterSlaveMode, vLANManagementVID=vLANManagementVID, ptp=ptp, sntp=sntp, syslogClientTrap=syslogClientTrap, ptpTrapPrefix=ptpTrapPrefix, siteName=siteName, altitude=altitude, noWirelessChannelAvailable=noWirelessChannelAvailable, capacityLicenseMismatch=capacityLicenseMismatch, phyStatus=phyStatus, telecomsLoopback=telecomsLoopback, channelBandwidth=channelBandwidth, sNMPTrapVersion=sNMPTrapVersion, licence=licence, installStatus=installStatus, tDDSynchronizationMode=tDDSynchronizationMode, sNMPEnabledTraps=sNMPEnabledTraps, dfsPeaks=dfsPeaks, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, groupID=groupID, userEnabled=userEnabled, dfsTableNumber=dfsTableNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, eIRP=eIRP, linkSymmetry=linkSymmetry, receivePower=receivePower, sNTPState=sNTPState, transmitModulationMode=transmitModulationMode, transmitFreqMHz=transmitFreqMHz, snmpControl=snmpControl, aggregateDataRate=aggregateDataRate, dataPortConfigurationMismatch=dataPortConfigurationMismatch, syslogClient=syslogClient, transmitPower=transmitPower, pubStats=pubStats, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, alarms=alarms, smtp=smtp, smtpGroup=smtpGroup, bandwidthVariant=bandwidthVariant, snmpControlGroup=snmpControlGroup, ptpGroups=ptpGroups, accessMethod=accessMethod, sNMPv3Enable=sNMPv3Enable, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, hardwareVersion=hardwareVersion, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNTPServerIPAddress=sNTPServerIPAddress, byteErrorRatio=byteErrorRatio, telecomsLoopbackTrap=telecomsLoopbackTrap, receiveDataRate=receiveDataRate, syslogControlGroup=syslogControlGroup, systemReset=systemReset, sNMPTrapTable=sNMPTrapTable, userTable=userTable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPServerPortNumber=tFTPServerPortNumber, sNTPSyncTrap=sNTPSyncTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tDDControl=tDDControl, vectorError=vectorError, versionsGroup=versionsGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, phyControl=phyControl, alarmsGroup=alarmsGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, sMTPServerPortNumber=sMTPServerPortNumber, userTableNumber=userTableNumber, vLANPriorityTableIndex=vLANPriorityTableIndex, sMTPEnabledMessages=sMTPEnabledMessages, licenceGroup=licenceGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, phyControlGroup=phyControlGroup, linkName=linkName, signalStrengthRatio=signalStrengthRatio, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, wirelessLinkAvailability=wirelessLinkAvailability, searchState=searchState, dfsGroup=dfsGroup, sNMPPortNumber=sNMPPortNumber, ethernetFiberSupport=ethernetFiberSupport, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptpTraps=ptpTraps, receiveFreqKHz=receiveFreqKHz, dfsTable=dfsTable, ptmp=ptmp, phyStatusGroup=phyStatusGroup, telecomsCableLength=telecomsCableLength, userRole=userRole, unitOutOfCalibration=unitOutOfCalibration, regionCode=regionCode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, linkModeOptimisation=linkModeOptimisation, remoteIPAddress=remoteIPAddress, dfsMeans=dfsMeans, useVLANForManagementInterfaces=useVLANForManagementInterfaces)
