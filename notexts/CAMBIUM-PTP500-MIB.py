...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", supplementaryGroup=supplementaryGroup, syslogStateTrap=syslogStateTrap, transmitFreqMHz=transmitFreqMHz, syslogState=syslogState, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNMPTrapVersion=sNMPTrapVersion, dataPortStatus=dataPortStatus, eIRP=eIRP, telecomsChannelStatus=telecomsChannelStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, licenceGroup=licenceGroup, vLANManagementVID=vLANManagementVID, dfsTableIndex=dfsTableIndex, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, syslogClient=syslogClient, supplementary=supplementary, vLANPriorityTableIndex=vLANPriorityTableIndex, transmitDataRate=transmitDataRate, sNMPTrapTable=sNMPTrapTable, bootVersion=bootVersion, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, telecomsLineCode=telecomsLineCode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, syslogControl=syslogControl, tFTPServerIPAddress=tFTPServerIPAddress, smtp=smtp, userTableIndex=userTableIndex, sNTPServerIPAddress=sNTPServerIPAddress, licence=licence, ptp500=ptp500, wirelessLinkAvailability=wirelessLinkAvailability, tDDSynchronizationMode=tDDSynchronizationMode, ethernet=ethernet, alarmsGroup=alarmsGroup, hardwareVersion=hardwareVersion, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, channelBandwidth=channelBandwidth, sntp=sntp, encryption=encryption, configurationGroup=configurationGroup, encryptionAlgorithm=encryptionAlgorithm, sNMPEnabledTraps=sNMPEnabledTraps, dfsTable=dfsTable, transmitFreqKHz=transmitFreqKHz, aAAControlGroup=aAAControlGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, pubStatsGroup=pubStatsGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, telecomsLoopback=telecomsLoopback, telecomsInterface=telecomsInterface, groupID=groupID, sNTPSync=sNTPSync, ptpTraps=ptpTraps, userRole=userRole, syslogControlGroup=syslogControlGroup, ptmp=ptmp, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, linkLoss=linkLoss, antennaGain=antennaGain, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, unitOutOfCalibration=unitOutOfCalibration, aggregateDataRate=aggregateDataRate, receiveFreqKHz=receiveFreqKHz, phyControl=phyControl, aAAControl=aAAControl, receiveFreqMHz=receiveFreqMHz, sNMPTrapPortNumber=sNMPTrapPortNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, userEnabled=userEnabled, vLANPriorityTable=vLANPriorityTable, systemClock=systemClock, sNTPSyncTrap=sNTPSyncTrap, dfsTableEntry=dfsTableEntry, iPAddress=iPAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, latitude=latitude, management=management, telnetAccessEnabled=telnetAccessEnabled, ptp=ptp, sNMPTrapTableNumber=sNMPTrapTableNumber, altitude=altitude, smtpGroup=smtpGroup, bandwidthVariant=bandwidthVariant, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, hTTPSPortNumber=hTTPSPortNumber, tDDControl=tDDControl, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPCommunityString=sNMPCommunityString, gatewayIPAddress=gatewayIPAddress, managementGroup=managementGroup, sMTPEnabledMessages=sMTPEnabledMessages, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortStatusTrap=dataPortStatusTrap, phyStatus=phyStatus, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, snmpControl=snmpControl, dataPortAutoMdix=dataPortAutoMdix, sNMPTrapIPAddress=sNMPTrapIPAddress, telecomsChannelStatusTrap=telecomsChannelStatusTrap, timeZone=timeZone, constantPowerSpectralDensity=constantPowerSpectralDensity, userTableEntry=userTableEntry, tDDControlGroup=tDDControlGroup, siteName=siteName, productName=productName, reset=reset, dfs=dfs, sNMPTrapTableEntry=sNMPTrapTableEntry, productVariant=productVariant, dataPortConfigurationMismatch=dataPortConfigurationMismatch, linkModeOptimizationMismatch=linkModeOptimizationMismatch, wirelessLinkStatus=wirelessLinkStatus, telecomGroup=telecomGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, telecomsLoopbackTrap=telecomsLoopbackTrap, dfsGroup=dfsGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, frequencyVariant=frequencyVariant, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, regionCodeTrap=regionCodeTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, snmpControlGroup=snmpControlGroup, telecom=telecom, vLANManagementPriority=vLANManagementPriority, maximumTransmitPower=maximumTransmitPower, sNTPPollInterval=sNTPPollInterval, sNMPv3Enable=sNMPv3Enable, receiveModulationModeDetail=receiveModulationModeDetail, systemReset=systemReset, cableLoss=cableLoss, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dfsMeans=dfsMeans, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, encryptionGroup=encryptionGroup, hTTPPortNumber=hTTPPortNumber, sNTPServerPortNumber=sNTPServerPortNumber, channelChangeTrap=channelChangeTrap, ptpGroups=ptpGroups, ethernetGroup=ethernetGroup, range=range, sNTPState=sNTPState, installStatusTrap=installStatusTrap, receivePower=receivePower, subnetMask=subnetMask, dataPortAutoNegotiation=dataPortAutoNegotiation, notificationsGroup=notificationsGroup, masterSlaveMode=masterSlaveMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPServerIPAddress=sMTPServerIPAddress, installArmState=installArmState, daylightSaving=daylightSaving, byteErrorRatio=byteErrorRatio, cambium=cambium, PYSNMP_MODULE_ID=cambium, incompatibleRegionCodes=incompatibleRegionCodes, installArmStateTrap=installArmStateTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, capacityLicenseMismatch=capacityLicenseMismatch, sNMPPortNumber=sNMPPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, phyStatusGroup=phyStatusGroup, linkName=linkName, sMTPSourceEmailAddress=sMTPSourceEmailAddress, searchState=searchState, linkSymmetry=linkSymmetry, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sMTPServerPortNumber=sMTPServerPortNumber, linkModeOptimisation=linkModeOptimisation, sNTPLastSync=sNTPLastSync, sMTPEmailAlert=sMTPEmailAlert, resetGroup=resetGroup, licensedCapacity=licensedCapacity, tFTPServerPortNumber=tFTPServerPortNumber, receiveChannel=receiveChannel, dfsPeaks=dfsPeaks, userPassword=userPassword, versions=versions, vLANPriorityQueueMapping=vLANPriorityQueueMapping, telecomsCableLength=telecomsCableLength, userTable=userTable, configuration=configuration, alarms=alarms, softwareVersion=softwareVersion, userTableNumber=userTableNumber, longitude=longitude, vectorError=vectorError, targetMACAddress=targetMACAddress, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, regionCode=regionCode, sNMPTrapTableIndex=sNMPTrapTableIndex, telnetPortNumber=telnetPortNumber, transmitModulationMode=transmitModulationMode, dfsTableNumber=dfsTableNumber, installStatus=installStatus, signalStrengthRatio=signalStrengthRatio, incompatibleMasterAndSlave=incompatibleMasterAndSlave, versionsGroup=versionsGroup, sntpGroup=sntpGroup, transmitPower=transmitPower, accessMethod=accessMethod, receiveModulationMode=receiveModulationMode, syslogClientTrap=syslogClientTrap, ethernetFiberSupport=ethernetFiberSupport, userName=userName, ptpTrapPrefix=ptpTrapPrefix, transmitChannel=transmitChannel, pubStats=pubStats, phyControlGroup=phyControlGroup, hTTPAccessEnabled=hTTPAccessEnabled, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ptpCompliance=ptpCompliance, vLANPriorityTableEntry=vLANPriorityTableEntry, dataPortDisabledWarning=dataPortDisabledWarning, remoteIPAddress=remoteIPAddress, receiveDataRate=receiveDataRate)
