...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", userPassword=userPassword, maximumTransmitPower=maximumTransmitPower, sNMPTrapVersion=sNMPTrapVersion, signalStrengthRatio=signalStrengthRatio, dataPortAutoNegotiation=dataPortAutoNegotiation, receiveModulationModeDetail=receiveModulationModeDetail, telnetPortNumber=telnetPortNumber, telecomsCableLength=telecomsCableLength, installStatusTrap=installStatusTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, systemReset=systemReset, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogStateTrap=syslogStateTrap, sMTPEmailAlert=sMTPEmailAlert, installStatus=installStatus, sNMPEnabledTraps=sNMPEnabledTraps, receiveDataRate=receiveDataRate, incompatibleRegionCodes=incompatibleRegionCodes, range=range, linkSymmetry=linkSymmetry, dfsMeans=dfsMeans, sNTPSyncTrap=sNTPSyncTrap, installArmStateTrap=installArmStateTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, vLANManagementPriority=vLANManagementPriority, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernetGroup=ethernetGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, smtpGroup=smtpGroup, iPAddress=iPAddress, management=management, aAAControl=aAAControl, userEnabled=userEnabled, wirelessLinkStatus=wirelessLinkStatus, syslogClient=syslogClient, phyStatus=phyStatus, notificationsGroup=notificationsGroup, sMTPEnabledMessages=sMTPEnabledMessages, softwareVersion=softwareVersion, encryptionGroup=encryptionGroup, PYSNMP_MODULE_ID=cambium, vLANPriorityQueueMapping=vLANPriorityQueueMapping, versionsGroup=versionsGroup, versions=versions, vLANPriorityTableNumber=vLANPriorityTableNumber, ethernetFiberSupport=ethernetFiberSupport, smtp=smtp, sNTPLastSync=sNTPLastSync, syslogControl=syslogControl, eIRP=eIRP, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPServerIPAddress=tFTPServerIPAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPServerPortNumber=tFTPServerPortNumber, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, accessMethod=accessMethod, telecomsLoopback=telecomsLoopback, hTTPPortNumber=hTTPPortNumber, sNTPState=sNTPState, phyControl=phyControl, tDDControlGroup=tDDControlGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, alarmsGroup=alarmsGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, pubStats=pubStats, transmitPower=transmitPower, sNTPSync=sNTPSync, telecomsLineCode=telecomsLineCode, sMTPServerIPAddress=sMTPServerIPAddress, regionCodeTrap=regionCodeTrap, licenceGroup=licenceGroup, sNTPServerPortNumber=sNTPServerPortNumber, transmitModulationMode=transmitModulationMode, telnetAccessEnabled=telnetAccessEnabled, vectorError=vectorError, dataPortWirelessDownAlert=dataPortWirelessDownAlert, targetMACAddress=targetMACAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, hTTPAccessEnabled=hTTPAccessEnabled, searchState=searchState, aggregateDataRate=aggregateDataRate, syslogState=syslogState, configuration=configuration, resetGroup=resetGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, sNMPCommunityString=sNMPCommunityString, dataPortStatusTrap=dataPortStatusTrap, userTableNumber=userTableNumber, alarms=alarms, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptp=ptp, ptp500=ptp500, ptpTrapPrefix=ptpTrapPrefix, sntpGroup=sntpGroup, capacityLicenseMismatch=capacityLicenseMismatch, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsTableEntry=dfsTableEntry, dfsTableIndex=dfsTableIndex, linkModeOptimisation=linkModeOptimisation, telecomsChannelStatusTrap=telecomsChannelStatusTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, supplementary=supplementary, syslogClientTrap=syslogClientTrap, tDDControl=tDDControl, remoteIPAddress=remoteIPAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, hardwareVersion=hardwareVersion, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPServerIPAddress=sNTPServerIPAddress, latitude=latitude, syslogLocalWrappedTrap=syslogLocalWrappedTrap, phyControlGroup=phyControlGroup, telecom=telecom, dataPortAutoMdix=dataPortAutoMdix, linkLoss=linkLoss, sNTPPollInterval=sNTPPollInterval, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, installArmState=installArmState, sNMPTrapTableIndex=sNMPTrapTableIndex, receivePower=receivePower, channelChangeTrap=channelChangeTrap, antennaGain=antennaGain, remoteMaximumTransmitPower=remoteMaximumTransmitPower, supplementaryGroup=supplementaryGroup, linkName=linkName, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, vLANManagementVID=vLANManagementVID, hTTPSPortNumber=hTTPSPortNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, sMTPServerPortNumber=sMTPServerPortNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dfsTable=dfsTable, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, userTable=userTable, productName=productName, phyStatusGroup=phyStatusGroup, daylightSaving=daylightSaving, receiveChannel=receiveChannel, ethernet=ethernet, telecomsLoopbackTrap=telecomsLoopbackTrap, userTableIndex=userTableIndex, altitude=altitude, sNMPTrapTable=sNMPTrapTable, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortDisabledWarning=dataPortDisabledWarning, dataPortConfigurationMismatch=dataPortConfigurationMismatch, wirelessLinkAvailability=wirelessLinkAvailability, sntp=sntp, userName=userName, reset=reset, snmpControl=snmpControl, snmpControlGroup=snmpControlGroup, aAAControlGroup=aAAControlGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, managementGroup=managementGroup, encryption=encryption, tDDSynchronizationMode=tDDSynchronizationMode, telecomGroup=telecomGroup, telecomsChannelStatus=telecomsChannelStatus, receiveFreqMHz=receiveFreqMHz, sNMPTrapTableNumber=sNMPTrapTableNumber, configurationGroup=configurationGroup, vLANPriorityTable=vLANPriorityTable, ptpCompliance=ptpCompliance, dfsPeaks=dfsPeaks, ptmp=ptmp, licence=licence, transmitChannel=transmitChannel, transmitFreqMHz=transmitFreqMHz, productVariant=productVariant, siteName=siteName, frequencyVariant=frequencyVariant, transmitFreqKHz=transmitFreqKHz, unitOutOfCalibration=unitOutOfCalibration, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, vLANPriorityTableIndex=vLANPriorityTableIndex, userRole=userRole, cambium=cambium, sNMPTrapIPAddress=sNMPTrapIPAddress, dfs=dfs, transmitDataRate=transmitDataRate, encryptionAlgorithm=encryptionAlgorithm, syslogControlGroup=syslogControlGroup, subnetMask=subnetMask, channelBandwidth=channelBandwidth, systemClock=systemClock, pubStatsGroup=pubStatsGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, regionCode=regionCode, ptpGroups=ptpGroups, sNMPPortNumber=sNMPPortNumber, ptpTraps=ptpTraps, sNMPv3Enable=sNMPv3Enable, cableLoss=cableLoss, longitude=longitude, receiveModulationMode=receiveModulationMode, masterSlaveMode=masterSlaveMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, licensedCapacity=licensedCapacity, hTTPSAccessEnabled=hTTPSAccessEnabled, receiveFreqKHz=receiveFreqKHz, telecomsInterface=telecomsInterface, bandwidthVariant=bandwidthVariant, dataPortStatus=dataPortStatus, bootVersion=bootVersion, gatewayIPAddress=gatewayIPAddress, dfsGroup=dfsGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfsTableNumber=dfsTableNumber, secondarySoftwareVersion=secondarySoftwareVersion, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, groupID=groupID, timeZone=timeZone, byteErrorRatio=byteErrorRatio, userTableEntry=userTableEntry)
