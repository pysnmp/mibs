...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", licence=licence, configuration=configuration, userRole=userRole, latitude=latitude, accessMethod=accessMethod, vLANPriorityTable=vLANPriorityTable, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, phyControl=phyControl, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ptpTraps=ptpTraps, receivePower=receivePower, aAAControlGroup=aAAControlGroup, installArmState=installArmState, tDDControl=tDDControl, licenceGroup=licenceGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, groupID=groupID, PYSNMP_MODULE_ID=cambium, supplementary=supplementary, constantPowerSpectralDensity=constantPowerSpectralDensity, userTable=userTable, syslogControlGroup=syslogControlGroup, productName=productName, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tDDControlGroup=tDDControlGroup, daylightSaving=daylightSaving, gatewayIPAddress=gatewayIPAddress, dataPortStatusTrap=dataPortStatusTrap, productVariant=productVariant, sNTPPollInterval=sNTPPollInterval, sNTPSyncTrap=sNTPSyncTrap, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sNTPState=sNTPState, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, syslogClientTrap=syslogClientTrap, licensedCapacity=licensedCapacity, telecomGroup=telecomGroup, dfs=dfs, sMTPEmailAlert=sMTPEmailAlert, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, linkLoss=linkLoss, syslogControl=syslogControl, transmitFreqKHz=transmitFreqKHz, hardwareVersion=hardwareVersion, bootVersion=bootVersion, sNMPEnabledTraps=sNMPEnabledTraps, wirelessLinkAvailability=wirelessLinkAvailability, userTableEntry=userTableEntry, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptmp=ptmp, ptp=ptp, transmitFreqMHz=transmitFreqMHz, longitude=longitude, telnetAccessEnabled=telnetAccessEnabled, encryption=encryption, tFTPServerIPAddress=tFTPServerIPAddress, userEnabled=userEnabled, secondarySoftwareVersion=secondarySoftwareVersion, userPassword=userPassword, versionsGroup=versionsGroup, userName=userName, telecom=telecom, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, telecomsLoopbackTrap=telecomsLoopbackTrap, notificationsGroup=notificationsGroup, ethernetGroup=ethernetGroup, antennaGain=antennaGain, range=range, iPAddress=iPAddress, transmitModulationMode=transmitModulationMode, tDDSynchronizationAlarm=tDDSynchronizationAlarm, timeZone=timeZone, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, managementGroup=managementGroup, encryptionGroup=encryptionGroup, aAAControl=aAAControl, receiveFreqMHz=receiveFreqMHz, dfsTableEntry=dfsTableEntry, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, smtp=smtp, sMTPEnabledMessages=sMTPEnabledMessages, linkModeOptimizationMismatch=linkModeOptimizationMismatch, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPv3Enable=sNMPv3Enable, vLANManagementVID=vLANManagementVID, ptpGroups=ptpGroups, regionCode=regionCode, telecomsCableLength=telecomsCableLength, sNTPLastSync=sNTPLastSync, syslogStateTrap=syslogStateTrap, cableLoss=cableLoss, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, vLANManagementPriority=vLANManagementPriority, dataPortAutoMdix=dataPortAutoMdix, hTTPPortNumber=hTTPPortNumber, aggregateDataRate=aggregateDataRate, resetGroup=resetGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, maximumTransmitPower=maximumTransmitPower, altitude=altitude, ethernetFiberSupport=ethernetFiberSupport, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortWirelessDownAlert=dataPortWirelessDownAlert, systemReset=systemReset, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, alarms=alarms, linkName=linkName, phyStatus=phyStatus, linkModeOptimisation=linkModeOptimisation, signalStrengthRatio=signalStrengthRatio, sNMPTrapIPAddress=sNMPTrapIPAddress, snmpControl=snmpControl, dfsTable=dfsTable, userTableIndex=userTableIndex, dataPortAutoNegotiation=dataPortAutoNegotiation, telecomsLineCode=telecomsLineCode, sNMPTrapPortNumber=sNMPTrapPortNumber, receiveModulationModeDetail=receiveModulationModeDetail, ethernet=ethernet, systemClock=systemClock, eIRP=eIRP, sNMPTrapTable=sNMPTrapTable, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, pubStatsGroup=pubStatsGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, encryptionAlgorithm=encryptionAlgorithm, phyStatusGroup=phyStatusGroup, vectorError=vectorError, installStatusTrap=installStatusTrap, pubStats=pubStats, syslogClient=syslogClient, hTTPSAccessEnabled=hTTPSAccessEnabled, syslogLocalWrappedTrap=syslogLocalWrappedTrap, linkSymmetry=linkSymmetry, channelBandwidth=channelBandwidth, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, hTTPAccessEnabled=hTTPAccessEnabled, userTableNumber=userTableNumber, vLANPriorityTableNumber=vLANPriorityTableNumber, hTTPSPortNumber=hTTPSPortNumber, smtpGroup=smtpGroup, receiveChannel=receiveChannel, searchState=searchState, targetMACAddress=targetMACAddress, sNTPServerPortNumber=sNTPServerPortNumber, configurationGroup=configurationGroup, dfsGroup=dfsGroup, sMTPServerPortNumber=sMTPServerPortNumber, dfsMeans=dfsMeans, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortStatus=dataPortStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapVersion=sNMPTrapVersion, wirelessLinkStatus=wirelessLinkStatus, ptpCompliance=ptpCompliance, receiveFreqKHz=receiveFreqKHz, softwareVersion=softwareVersion, channelChangeTrap=channelChangeTrap, sMTPServerIPAddress=sMTPServerIPAddress, snmpControlGroup=snmpControlGroup, dfsTableNumber=dfsTableNumber, dfsPeaks=dfsPeaks, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, installStatus=installStatus, phyControlGroup=phyControlGroup, tFTPServerPortNumber=tFTPServerPortNumber, unitOutOfCalibration=unitOutOfCalibration, vLANPriorityTableIndex=vLANPriorityTableIndex, sNTPSync=sNTPSync, reset=reset, masterSlaveMode=masterSlaveMode, transmitDataRate=transmitDataRate, subnetMask=subnetMask, tDDSynchronizationStatus=tDDSynchronizationStatus, bandwidthVariant=bandwidthVariant, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, remoteIPAddress=remoteIPAddress, telecomsLoopback=telecomsLoopback, receiveModulationMode=receiveModulationMode, ptp500=ptp500, transmitChannel=transmitChannel, incompatibleRegionCodes=incompatibleRegionCodes, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, receiveDataRate=receiveDataRate, byteErrorRatio=byteErrorRatio, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, syslogState=syslogState, telnetPortNumber=telnetPortNumber, sNMPCommunityString=sNMPCommunityString, telecomsInterface=telecomsInterface, supplementaryGroup=supplementaryGroup, tDDSynchronizationMode=tDDSynchronizationMode, cambium=cambium, sntp=sntp, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, telecomsChannelStatus=telecomsChannelStatus, frequencyVariant=frequencyVariant, sNTPServerIPAddress=sNTPServerIPAddress, management=management, capacityLicenseMismatch=capacityLicenseMismatch, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, ptpTrapPrefix=ptpTrapPrefix, sntpGroup=sntpGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, siteName=siteName, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitPower=transmitPower, sNMPPortNumber=sNMPPortNumber, dfsTableIndex=dfsTableIndex, installArmStateTrap=installArmStateTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dataPortDisabledWarning=dataPortDisabledWarning, alarmsGroup=alarmsGroup, regionCodeTrap=regionCodeTrap, versions=versions, sNMPTrapTableIndex=sNMPTrapTableIndex, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, vLANPriorityTableEntry=vLANPriorityTableEntry)
