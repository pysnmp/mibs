...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, installArmStateTrap=installArmStateTrap, telecomGroup=telecomGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, dfsTableEntry=dfsTableEntry, syslogClient=syslogClient, siteName=siteName, ptpCompliance=ptpCompliance, ethernetFiberSupport=ethernetFiberSupport, receivePower=receivePower, enabledDiagnosticAlarms=enabledDiagnosticAlarms, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, phyControlGroup=phyControlGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, configurationGroup=configurationGroup, masterSlaveMode=masterSlaveMode, telecomsLineCode=telecomsLineCode, installStatus=installStatus, wirelessLinkAvailability=wirelessLinkAvailability, accessMethod=accessMethod, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptp500=ptp500, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, userEnabled=userEnabled, ptmp=ptmp, ptpTrapPrefix=ptpTrapPrefix, dataPortStatusTrap=dataPortStatusTrap, ptp=ptp, userTableEntry=userTableEntry, targetMACAddress=targetMACAddress, syslogStateTrap=syslogStateTrap, sNTPState=sNTPState, vLANPriorityQueueMapping=vLANPriorityQueueMapping, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, hTTPSAccessEnabled=hTTPSAccessEnabled, transmitModulationMode=transmitModulationMode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, subnetMask=subnetMask, telecomsCableLength=telecomsCableLength, installStatusTrap=installStatusTrap, transmitPower=transmitPower, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, wirelessLinkStatus=wirelessLinkStatus, sNTPSyncTrap=sNTPSyncTrap, systemClock=systemClock, channelChangeTrap=channelChangeTrap, cambium=cambium, productVariant=productVariant, hardwareVersion=hardwareVersion, phyControl=phyControl, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, transmitFreqMHz=transmitFreqMHz, capacityLicenseMismatch=capacityLicenseMismatch, gatewayIPAddress=gatewayIPAddress, installArmState=installArmState, sntpGroup=sntpGroup, iPAddress=iPAddress, telnetAccessEnabled=telnetAccessEnabled, range=range, pubStatsGroup=pubStatsGroup, sNMPEnabledTraps=sNMPEnabledTraps, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNMPTrapVersion=sNMPTrapVersion, sMTPServerIPAddress=sMTPServerIPAddress, telnetPortNumber=telnetPortNumber, syslogControl=syslogControl, vectorError=vectorError, receiveChannel=receiveChannel, sNMPPortNumber=sNMPPortNumber, telecom=telecom, versionsGroup=versionsGroup, receiveModulationMode=receiveModulationMode, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, softwareVersion=softwareVersion, userPassword=userPassword, aAAControlGroup=aAAControlGroup, phyStatus=phyStatus, bandwidthVariant=bandwidthVariant, versions=versions, supplementaryGroup=supplementaryGroup, ptpGroups=ptpGroups, tDDSynchronizationStatus=tDDSynchronizationStatus, dfsPeaks=dfsPeaks, cableLoss=cableLoss, transmitFreqKHz=transmitFreqKHz, telecomsInterface=telecomsInterface, sNMPTrapTableIndex=sNMPTrapTableIndex, secondarySoftwareVersion=secondarySoftwareVersion, licence=licence, encryptionAlgorithm=encryptionAlgorithm, transmitChannel=transmitChannel, receiveModulationModeDetail=receiveModulationModeDetail, aAAControl=aAAControl, sMTPServerPortNumber=sMTPServerPortNumber, vLANPriorityTableNumber=vLANPriorityTableNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitDataRate=transmitDataRate, syslogClientTrap=syslogClientTrap, sNMPCommunityString=sNMPCommunityString, groupID=groupID, telecomsLoopback=telecomsLoopback, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPSync=sNTPSync, latitude=latitude, telecomsChannelStatusTrap=telecomsChannelStatusTrap, vLANManagementVID=vLANManagementVID, systemReset=systemReset, hTTPSPortNumber=hTTPSPortNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPServerPortNumber=sNTPServerPortNumber, bootVersion=bootVersion, ethernetGroup=ethernetGroup, reset=reset, tFTPServerPortNumber=tFTPServerPortNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, frequencyVariant=frequencyVariant, receiveFreqMHz=receiveFreqMHz, sNMPTrapPortNumber=sNMPTrapPortNumber, linkName=linkName, tDDControl=tDDControl, supplementary=supplementary, ptpTraps=ptpTraps, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortStatus=dataPortStatus, sntp=sntp, sNMPTrapTable=sNMPTrapTable, dfsTableNumber=dfsTableNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, sNMPv3Enable=sNMPv3Enable, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tFTPServerIPAddress=tFTPServerIPAddress, remoteIPAddress=remoteIPAddress, sNTPLastSync=sNTPLastSync, hTTPAccessEnabled=hTTPAccessEnabled, tDDSynchronizationAlarm=tDDSynchronizationAlarm, unitOutOfCalibration=unitOutOfCalibration, pubStats=pubStats, dfsGroup=dfsGroup, hTTPPortNumber=hTTPPortNumber, daylightSaving=daylightSaving, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapIPAddress=sNMPTrapIPAddress, snmpControl=snmpControl, configuration=configuration, phyStatusGroup=phyStatusGroup, alarmsGroup=alarmsGroup, licensedCapacity=licensedCapacity, telecomsLoopbackTrap=telecomsLoopbackTrap, linkSymmetry=linkSymmetry, incompatibleRegionCodes=incompatibleRegionCodes, snmpControlGroup=snmpControlGroup, regionCodeTrap=regionCodeTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, regionCode=regionCode, userRole=userRole, userName=userName, timeZone=timeZone, ethernet=ethernet, maximumTransmitPower=maximumTransmitPower, alarms=alarms, vLANPriorityTableIndex=vLANPriorityTableIndex, antennaGain=antennaGain, dfsMeans=dfsMeans, encryption=encryption, longitude=longitude, dfsTable=dfsTable, sNTPServerIPAddress=sNTPServerIPAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, eIRP=eIRP, encryptionGroup=encryptionGroup, tDDControlGroup=tDDControlGroup, productName=productName, byteErrorRatio=byteErrorRatio, altitude=altitude, telecomsChannelStatus=telecomsChannelStatus, receiveDataRate=receiveDataRate, notificationsGroup=notificationsGroup, dataPortAutoMdix=dataPortAutoMdix, smtp=smtp, smtpGroup=smtpGroup, tDDSynchronizationMode=tDDSynchronizationMode, sMTPEmailAlert=sMTPEmailAlert, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, searchState=searchState, userTableNumber=userTableNumber, dfs=dfs, licenceGroup=licenceGroup, vLANManagementPriority=vLANManagementPriority, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, userTable=userTable, syslogControlGroup=syslogControlGroup, sNTPPollInterval=sNTPPollInterval, linkModeOptimisation=linkModeOptimisation, syslogState=syslogState, vLANPriorityTable=vLANPriorityTable, resetGroup=resetGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, aggregateDataRate=aggregateDataRate, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, receiveFreqKHz=receiveFreqKHz, signalStrengthRatio=signalStrengthRatio, dataPortDisabledWarning=dataPortDisabledWarning, managementGroup=managementGroup, linkLoss=linkLoss, dfsTableIndex=dfsTableIndex, channelBandwidth=channelBandwidth, management=management, PYSNMP_MODULE_ID=cambium, userTableIndex=userTableIndex, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles)
