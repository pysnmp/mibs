...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, aAAControl=aAAControl, telecom=telecom, installStatus=installStatus, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, userTableNumber=userTableNumber, userName=userName, productVariant=productVariant, sNTPState=sNTPState, tFTPServerIPAddress=tFTPServerIPAddress, hTTPSPortNumber=hTTPSPortNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sMTPServerIPAddress=sMTPServerIPAddress, ptpGroups=ptpGroups, hTTPSAccessEnabled=hTTPSAccessEnabled, dfsTableNumber=dfsTableNumber, userTableIndex=userTableIndex, wirelessLinkStatus=wirelessLinkStatus, remoteIPAddress=remoteIPAddress, supplementary=supplementary, dataPortStatus=dataPortStatus, vLANManagementVID=vLANManagementVID, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, daylightSaving=daylightSaving, configurationGroup=configurationGroup, telecomsInterface=telecomsInterface, dfsPeaks=dfsPeaks, linkModeOptimizationMismatch=linkModeOptimizationMismatch, vLANPriorityTableEntry=vLANPriorityTableEntry, transmitFreqMHz=transmitFreqMHz, managementGroup=managementGroup, groupID=groupID, dfsTableEntry=dfsTableEntry, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsTable=dfsTable, dfsGroup=dfsGroup, gatewayIPAddress=gatewayIPAddress, timeZone=timeZone, systemClock=systemClock, linkSymmetry=linkSymmetry, tDDSynchronizationMode=tDDSynchronizationMode, telecomsChannelStatusTrap=telecomsChannelStatusTrap, regionCodeTrap=regionCodeTrap, vLANPriorityQueueMapping=vLANPriorityQueueMapping, PYSNMP_MODULE_ID=cambium, ptpTrapPrefix=ptpTrapPrefix, subnetMask=subnetMask, signalStrengthRatio=signalStrengthRatio, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, cambium=cambium, sNTPLastSync=sNTPLastSync, telecomsLineCode=telecomsLineCode, transmitFreqKHz=transmitFreqKHz, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, wirelessLinkAvailability=wirelessLinkAvailability, targetMACAddress=targetMACAddress, ethernet=ethernet, encryption=encryption, snmpControl=snmpControl, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, bootVersion=bootVersion, dfsMeans=dfsMeans, configuration=configuration, vLANPriorityTable=vLANPriorityTable, tFTPServerPortNumber=tFTPServerPortNumber, sNTPServerIPAddress=sNTPServerIPAddress, dataPortStatusTrap=dataPortStatusTrap, linkModeOptimisation=linkModeOptimisation, vLANPriorityTableIndex=vLANPriorityTableIndex, receiveModulationModeDetail=receiveModulationModeDetail, syslogControl=syslogControl, smtpGroup=smtpGroup, vLANManagementPriority=vLANManagementPriority, dataPortDisabledWarning=dataPortDisabledWarning, telecomsLoopbackTrap=telecomsLoopbackTrap, supplementaryGroup=supplementaryGroup, ptp=ptp, installArmStateTrap=installArmStateTrap, telecomGroup=telecomGroup, frequencyVariant=frequencyVariant, sNMPv3Enable=sNMPv3Enable, sNTPServerPortNumber=sNTPServerPortNumber, hTTPAccessEnabled=hTTPAccessEnabled, sNMPTrapTable=sNMPTrapTable, incompatibleMasterAndSlave=incompatibleMasterAndSlave, iPAddress=iPAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, secondarySoftwareVersion=secondarySoftwareVersion, telnetAccessEnabled=telnetAccessEnabled, latitude=latitude, pubStats=pubStats, antennaGain=antennaGain, capacityLicenseMismatch=capacityLicenseMismatch, sntp=sntp, byteErrorRatio=byteErrorRatio, sNMPTrapTableIndex=sNMPTrapTableIndex, licenceGroup=licenceGroup, maximumTransmitPower=maximumTransmitPower, ptpTraps=ptpTraps, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sMTPEnabledMessages=sMTPEnabledMessages, sntpGroup=sntpGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ethernetFiberSupport=ethernetFiberSupport, altitude=altitude, eIRP=eIRP, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPCommunityString=sNMPCommunityString, installArmState=installArmState, aggregateDataRate=aggregateDataRate, longitude=longitude, reset=reset, phyStatusGroup=phyStatusGroup, hardwareVersion=hardwareVersion, syslogClient=syslogClient, masterSlaveMode=masterSlaveMode, syslogClientTrap=syslogClientTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, range=range, bandwidthVariant=bandwidthVariant, aAAControlGroup=aAAControlGroup, sNTPSync=sNTPSync, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, smtp=smtp, receiveChannel=receiveChannel, systemReset=systemReset, licensedCapacity=licensedCapacity, transmitModulationMode=transmitModulationMode, tDDSynchronizationAlarm=tDDSynchronizationAlarm, management=management, incompatibleRegionCodes=incompatibleRegionCodes, accessMethod=accessMethod, telnetPortNumber=telnetPortNumber, receiveFreqKHz=receiveFreqKHz, ptmp=ptmp, receiveModulationMode=receiveModulationMode, transmitChannel=transmitChannel, tDDSynchronizationStatus=tDDSynchronizationStatus, unitOutOfCalibration=unitOutOfCalibration, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPPortNumber=sNMPPortNumber, phyStatus=phyStatus, syslogState=syslogState, vectorError=vectorError, pubStatsGroup=pubStatsGroup, tDDControlGroup=tDDControlGroup, receiveDataRate=receiveDataRate, tDDControl=tDDControl, sMTPEmailAlert=sMTPEmailAlert, versions=versions, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, installStatusTrap=installStatusTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, linkName=linkName, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernetGroup=ethernetGroup, sNMPEnabledTraps=sNMPEnabledTraps, snmpControlGroup=snmpControlGroup, dfsTableIndex=dfsTableIndex, syslogLocalWrappedTrap=syslogLocalWrappedTrap, softwareVersion=softwareVersion, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ptp500=ptp500, regionCode=regionCode, constantPowerSpectralDensity=constantPowerSpectralDensity, ptpCompliance=ptpCompliance, receivePower=receivePower, sNMPTrapIPAddress=sNMPTrapIPAddress, resetGroup=resetGroup, hTTPPortNumber=hTTPPortNumber, receiveFreqMHz=receiveFreqMHz, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNTPSyncTrap=sNTPSyncTrap, phyControl=phyControl, searchState=searchState, phyControlGroup=phyControlGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortAutoMdix=dataPortAutoMdix, sMTPServerPortNumber=sMTPServerPortNumber, dfs=dfs, cableLoss=cableLoss, telecomsCableLength=telecomsCableLength, versionsGroup=versionsGroup, userTable=userTable, telecomsLoopback=telecomsLoopback, alarmsGroup=alarmsGroup, transmitDataRate=transmitDataRate, userTableEntry=userTableEntry, vLANPriorityTableNumber=vLANPriorityTableNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, userEnabled=userEnabled, channelChangeTrap=channelChangeTrap, transmitPower=transmitPower, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, userPassword=userPassword, siteName=siteName, userRole=userRole, encryptionAlgorithm=encryptionAlgorithm, syslogControlGroup=syslogControlGroup, encryptionGroup=encryptionGroup, notificationsGroup=notificationsGroup, channelBandwidth=channelBandwidth, telecomsChannelStatus=telecomsChannelStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, linkLoss=linkLoss, sNTPPollInterval=sNTPPollInterval, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapVersion=sNMPTrapVersion, syslogStateTrap=syslogStateTrap, alarms=alarms, productName=productName, licence=licence)
