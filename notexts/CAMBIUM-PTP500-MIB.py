...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, channelChangeTrap=channelChangeTrap, dfsPeaks=dfsPeaks, dataPortAutoNegotiation=dataPortAutoNegotiation, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, licence=licence, secondarySoftwareVersion=secondarySoftwareVersion, systemReset=systemReset, dfsTable=dfsTable, signalStrengthRatio=signalStrengthRatio, siteName=siteName, telecom=telecom, ptmp=ptmp, alarms=alarms, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, productVariant=productVariant, latitude=latitude, transmitFreqMHz=transmitFreqMHz, transmitDataRate=transmitDataRate, PYSNMP_MODULE_ID=cambium, telecomsChannelStatusTrap=telecomsChannelStatusTrap, hTTPPortNumber=hTTPPortNumber, sMTPEmailAlert=sMTPEmailAlert, telecomsLineCode=telecomsLineCode, alarmsGroup=alarmsGroup, receiveModulationModeDetail=receiveModulationModeDetail, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, pubStatsGroup=pubStatsGroup, antennaGain=antennaGain, vLANManagementVID=vLANManagementVID, installStatus=installStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, receiveChannel=receiveChannel, frequencyVariant=frequencyVariant, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dataPortAutoMdix=dataPortAutoMdix, targetMACAddress=targetMACAddress, telecomGroup=telecomGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, channelBandwidth=channelBandwidth, resetGroup=resetGroup, sNMPTrapTable=sNMPTrapTable, userTable=userTable, telnetPortNumber=telnetPortNumber, userEnabled=userEnabled, masterSlaveMode=masterSlaveMode, ethernetFiberSupport=ethernetFiberSupport, phyStatusGroup=phyStatusGroup, dataPortDisabledWarning=dataPortDisabledWarning, installStatusTrap=installStatusTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, management=management, vLANPriorityQueueMapping=vLANPriorityQueueMapping, ethernet=ethernet, userName=userName, syslogClientTrap=syslogClientTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tFTPServerPortNumber=tFTPServerPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tFTPServerIPAddress=tFTPServerIPAddress, gatewayIPAddress=gatewayIPAddress, telecomsLoopback=telecomsLoopback, tDDControlGroup=tDDControlGroup, snmpControl=snmpControl, subnetMask=subnetMask, softwareVersion=softwareVersion, tDDSynchronizationMode=tDDSynchronizationMode, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, hardwareVersion=hardwareVersion, smtp=smtp, sntpGroup=sntpGroup, regionCode=regionCode, linkModeOptimisation=linkModeOptimisation, remoteIPAddress=remoteIPAddress, transmitModulationMode=transmitModulationMode, capacityLicenseMismatch=capacityLicenseMismatch, productName=productName, sMTPServerIPAddress=sMTPServerIPAddress, sNTPState=sNTPState, dfsTableIndex=dfsTableIndex, receiveDataRate=receiveDataRate, dfs=dfs, managementGroup=managementGroup, dfsTableNumber=dfsTableNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataPortConfigurationMismatch=dataPortConfigurationMismatch, vLANManagementPriority=vLANManagementPriority, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapIPAddress=sNMPTrapIPAddress, transmitChannel=transmitChannel, syslogControlGroup=syslogControlGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, vLANPriorityTableIndex=vLANPriorityTableIndex, sntp=sntp, notificationsGroup=notificationsGroup, groupID=groupID, daylightSaving=daylightSaving, ptpTraps=ptpTraps, licensedCapacity=licensedCapacity, sMTPServerPortNumber=sMTPServerPortNumber, ptp=ptp, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, receiveFreqMHz=receiveFreqMHz, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, encryptionGroup=encryptionGroup, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, longitude=longitude, syslogStateTrap=syslogStateTrap, sNMPTrapVersion=sNMPTrapVersion, dataPortStatusTrap=dataPortStatusTrap, ptp500=ptp500, transmitFreqKHz=transmitFreqKHz, userRole=userRole, sNMPPortNumber=sNMPPortNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, hTTPAccessEnabled=hTTPAccessEnabled, sNMPTrapTableEntry=sNMPTrapTableEntry, installArmState=installArmState, sNMPCommunityString=sNMPCommunityString, linkSymmetry=linkSymmetry, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, unitOutOfCalibration=unitOutOfCalibration, encryptionAlgorithm=encryptionAlgorithm, sNTPServerPortNumber=sNTPServerPortNumber, altitude=altitude, dfsMeans=dfsMeans, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernetGroup=ethernetGroup, aAAControl=aAAControl, supplementary=supplementary, noWirelessChannelAvailable=noWirelessChannelAvailable, sNTPLastSync=sNTPLastSync, sMTPSourceEmailAddress=sMTPSourceEmailAddress, phyControlGroup=phyControlGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, syslogClient=syslogClient, vectorError=vectorError, wirelessLinkAvailability=wirelessLinkAvailability, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, byteErrorRatio=byteErrorRatio, linkLoss=linkLoss, userPassword=userPassword, phyControl=phyControl, userTableEntry=userTableEntry, telecomsInterface=telecomsInterface, ptpTrapPrefix=ptpTrapPrefix, syslogControl=syslogControl, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, bandwidthVariant=bandwidthVariant, supplementaryGroup=supplementaryGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, telecomsCableLength=telecomsCableLength, licenceGroup=licenceGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, vLANPriorityTable=vLANPriorityTable, dfsGroup=dfsGroup, userTableIndex=userTableIndex, tDDControl=tDDControl, reset=reset, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, constantPowerSpectralDensity=constantPowerSpectralDensity, maximumTransmitPower=maximumTransmitPower, aggregateDataRate=aggregateDataRate, smtpGroup=smtpGroup, configuration=configuration, receiveModulationMode=receiveModulationMode, dataPortStatus=dataPortStatus, vLANPriorityTableEntry=vLANPriorityTableEntry, receiveFreqKHz=receiveFreqKHz, aAAControlGroup=aAAControlGroup, cableLoss=cableLoss, cambium=cambium, sNTPSync=sNTPSync, syslogState=syslogState, range=range, installArmStateTrap=installArmStateTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ptpCompliance=ptpCompliance, wirelessLinkStatus=wirelessLinkStatus, telecomsLoopbackTrap=telecomsLoopbackTrap, iPAddress=iPAddress, phyStatus=phyStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, eIRP=eIRP, versionsGroup=versionsGroup, accessMethod=accessMethod, sNTPPollInterval=sNTPPollInterval, systemClock=systemClock, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, searchState=searchState, timeZone=timeZone, sNMPEnabledTraps=sNMPEnabledTraps, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dfsTableEntry=dfsTableEntry, bootVersion=bootVersion, regionCodeTrap=regionCodeTrap, sNMPv3Enable=sNMPv3Enable, sNTPServerIPAddress=sNTPServerIPAddress, telecomsChannelStatus=telecomsChannelStatus, snmpControlGroup=snmpControlGroup, ptpGroups=ptpGroups, linkName=linkName, telnetAccessEnabled=telnetAccessEnabled, sMTPEnabledMessages=sMTPEnabledMessages, versions=versions, pubStats=pubStats, receivePower=receivePower, encryption=encryption, userTableNumber=userTableNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, hTTPSPortNumber=hTTPSPortNumber, sNTPSyncTrap=sNTPSyncTrap, transmitPower=transmitPower, linkModeOptimizationMismatch=linkModeOptimizationMismatch, configurationGroup=configurationGroup, incompatibleRegionCodes=incompatibleRegionCodes)
