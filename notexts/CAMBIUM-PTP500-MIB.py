...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", linkLoss=linkLoss, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogStateTrap=syslogStateTrap, gatewayIPAddress=gatewayIPAddress, sMTPServerIPAddress=sMTPServerIPAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tDDSynchronizationMode=tDDSynchronizationMode, sNMPEnabledTraps=sNMPEnabledTraps, versions=versions, syslogState=syslogState, phyControlGroup=phyControlGroup, syslogClientTrap=syslogClientTrap, sNTPSync=sNTPSync, telecomsLoopbackTrap=telecomsLoopbackTrap, phyStatusGroup=phyStatusGroup, groupID=groupID, telecomsLineCode=telecomsLineCode, dfsTableEntry=dfsTableEntry, systemReset=systemReset, sNTPLastSync=sNTPLastSync, dataPortStatusTrap=dataPortStatusTrap, dfsTableIndex=dfsTableIndex, managementGroup=managementGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, smtp=smtp, channelBandwidth=channelBandwidth, telecom=telecom, linkModeOptimizationMismatch=linkModeOptimizationMismatch, userTableIndex=userTableIndex, dfs=dfs, dataPortDisabledWarning=dataPortDisabledWarning, userName=userName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, searchState=searchState, resetGroup=resetGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPTrapVersion=sNMPTrapVersion, dataPortConfigurationMismatch=dataPortConfigurationMismatch, pubStats=pubStats, linkSymmetry=linkSymmetry, enabledDiagnosticAlarms=enabledDiagnosticAlarms, configuration=configuration, transmitChannel=transmitChannel, eIRP=eIRP, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tDDControlGroup=tDDControlGroup, alarmsGroup=alarmsGroup, syslogClient=syslogClient, useVLANForManagementInterfaces=useVLANForManagementInterfaces, incompatibleRegionCodes=incompatibleRegionCodes, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, antennaGain=antennaGain, telnetPortNumber=telnetPortNumber, transmitFreqMHz=transmitFreqMHz, tDDSynchronizationAlarm=tDDSynchronizationAlarm, remoteIPAddress=remoteIPAddress, productVariant=productVariant, ptpTrapPrefix=ptpTrapPrefix, smtpGroup=smtpGroup, wirelessLinkStatus=wirelessLinkStatus, dfsGroup=dfsGroup, receiveDataRate=receiveDataRate, ethernet=ethernet, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, hTTPPortNumber=hTTPPortNumber, reset=reset, encryption=encryption, sNTPState=sNTPState, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, maximumTransmitPower=maximumTransmitPower, syslogControlGroup=syslogControlGroup, alarms=alarms, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernetFiberSupport=ethernetFiberSupport, userTableNumber=userTableNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, ptp500=ptp500, daylightSaving=daylightSaving, installStatusTrap=installStatusTrap, accessMethod=accessMethod, dataPortStatus=dataPortStatus, secondarySoftwareVersion=secondarySoftwareVersion, vLANPriorityTableIndex=vLANPriorityTableIndex, linkName=linkName, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNTPServerIPAddress=sNTPServerIPAddress, sNMPTrapTable=sNMPTrapTable, timeZone=timeZone, telecomsCableLength=telecomsCableLength, receivePower=receivePower, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, capacityLicenseMismatch=capacityLicenseMismatch, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dfsPeaks=dfsPeaks, installArmState=installArmState, dataPortAutoMdix=dataPortAutoMdix, phyStatus=phyStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPEnabledMessages=sMTPEnabledMessages, encryptionGroup=encryptionGroup, vectorError=vectorError, supplementary=supplementary, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPPortNumber=sNMPPortNumber, range=range, sNTPPollInterval=sNTPPollInterval, ethernetGroup=ethernetGroup, tFTPServerIPAddress=tFTPServerIPAddress, ptp=ptp, cableLoss=cableLoss, sNMPTrapIPAddress=sNMPTrapIPAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, frequencyVariant=frequencyVariant, ptmp=ptmp, telecomsLoopback=telecomsLoopback, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, productName=productName, linkModeOptimisation=linkModeOptimisation, sntpGroup=sntpGroup, receiveModulationMode=receiveModulationMode, transmitModulationMode=transmitModulationMode, vLANPriorityTableEntry=vLANPriorityTableEntry, longitude=longitude, vLANPriorityTableNumber=vLANPriorityTableNumber, installStatus=installStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, hTTPSAccessEnabled=hTTPSAccessEnabled, telecomGroup=telecomGroup, snmpControl=snmpControl, dataPortWirelessDownAlert=dataPortWirelessDownAlert, PYSNMP_MODULE_ID=cambium, targetMACAddress=targetMACAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tFTPServerPortNumber=tFTPServerPortNumber, unitOutOfCalibration=unitOutOfCalibration, versionsGroup=versionsGroup, vLANManagementVID=vLANManagementVID, sMTPEmailAlert=sMTPEmailAlert, siteName=siteName, transmitPower=transmitPower, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, snmpControlGroup=snmpControlGroup, signalStrengthRatio=signalStrengthRatio, sMTPServerPortNumber=sMTPServerPortNumber, bandwidthVariant=bandwidthVariant, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNTPSyncTrap=sNTPSyncTrap, encryptionAlgorithm=encryptionAlgorithm, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, transmitFreqKHz=transmitFreqKHz, sNTPServerPortNumber=sNTPServerPortNumber, iPAddress=iPAddress, byteErrorRatio=byteErrorRatio, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsMeans=dfsMeans, subnetMask=subnetMask, dataPortAutoNegotiation=dataPortAutoNegotiation, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, systemClock=systemClock, userRole=userRole, vLANManagementPriority=vLANManagementPriority, aAAControlGroup=aAAControlGroup, transmitDataRate=transmitDataRate, sNMPTrapTableIndex=sNMPTrapTableIndex, management=management, syslogLocalWrappedTrap=syslogLocalWrappedTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dfsTableNumber=dfsTableNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, installArmStateTrap=installArmStateTrap, altitude=altitude, aggregateDataRate=aggregateDataRate, hTTPSPortNumber=hTTPSPortNumber, receiveChannel=receiveChannel, licensedCapacity=licensedCapacity, tDDSynchronizationStatus=tDDSynchronizationStatus, telnetAccessEnabled=telnetAccessEnabled, softwareVersion=softwareVersion, licence=licence, channelChangeTrap=channelChangeTrap, tDDControl=tDDControl, aAAControl=aAAControl, sNMPCommunityString=sNMPCommunityString, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, userEnabled=userEnabled, vLANPriorityQueueMapping=vLANPriorityQueueMapping, syslogControl=syslogControl, supplementaryGroup=supplementaryGroup, telecomsInterface=telecomsInterface, sNMPTrapTableEntry=sNMPTrapTableEntry, userTable=userTable, sNMPv3Enable=sNMPv3Enable, vLANPriorityTable=vLANPriorityTable, regionCodeTrap=regionCodeTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, receiveFreqKHz=receiveFreqKHz, phyControl=phyControl, dfsTable=dfsTable, cambium=cambium, ptpGroups=ptpGroups, masterSlaveMode=masterSlaveMode, receiveFreqMHz=receiveFreqMHz, userPassword=userPassword, sntp=sntp, wirelessLinkAvailability=wirelessLinkAvailability, userTableEntry=userTableEntry, latitude=latitude, configurationGroup=configurationGroup, pubStatsGroup=pubStatsGroup, receiveModulationModeDetail=receiveModulationModeDetail, ptpTraps=ptpTraps, telecomsChannelStatus=telecomsChannelStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, licenceGroup=licenceGroup, hTTPAccessEnabled=hTTPAccessEnabled, notificationsGroup=notificationsGroup, hardwareVersion=hardwareVersion, bootVersion=bootVersion, regionCode=regionCode, ptpCompliance=ptpCompliance)
