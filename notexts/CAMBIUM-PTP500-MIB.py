...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", reset=reset, frequencyVariant=frequencyVariant, resetGroup=resetGroup, gatewayIPAddress=gatewayIPAddress, installArmState=installArmState, ptpTraps=ptpTraps, timeZone=timeZone, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, telnetPortNumber=telnetPortNumber, vLANPriorityTableNumber=vLANPriorityTableNumber, cambium=cambium, hTTPSPortNumber=hTTPSPortNumber, signalStrengthRatio=signalStrengthRatio, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPTrapPortNumber=sNMPTrapPortNumber, sntpGroup=sntpGroup, dfsMeans=dfsMeans, unitOutOfCalibration=unitOutOfCalibration, linkModeOptimisation=linkModeOptimisation, aggregateDataRate=aggregateDataRate, sNMPTrapTable=sNMPTrapTable, range=range, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, altitude=altitude, userEnabled=userEnabled, telecomsChannelStatusTrap=telecomsChannelStatusTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, supplementaryGroup=supplementaryGroup, regionCode=regionCode, sNMPTrapTableEntry=sNMPTrapTableEntry, ptpTrapPrefix=ptpTrapPrefix, linkName=linkName, linkSymmetry=linkSymmetry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, bandwidthVariant=bandwidthVariant, iPAddress=iPAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPPollInterval=sNTPPollInterval, channelChangeTrap=channelChangeTrap, dfsTable=dfsTable, dataPortConfigurationMismatch=dataPortConfigurationMismatch, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, telecom=telecom, sMTPServerIPAddress=sMTPServerIPAddress, telecomsChannelStatus=telecomsChannelStatus, wirelessLinkStatus=wirelessLinkStatus, dataPortStatusTrap=dataPortStatusTrap, sMTPEnabledMessages=sMTPEnabledMessages, configurationGroup=configurationGroup, installStatus=installStatus, telecomsLoopback=telecomsLoopback, sNTPServerPortNumber=sNTPServerPortNumber, versionsGroup=versionsGroup, dfsTableNumber=dfsTableNumber, incompatibleRegionCodes=incompatibleRegionCodes, syslogControl=syslogControl, vLANPriorityTable=vLANPriorityTable, channelBandwidth=channelBandwidth, vLANManagementVID=vLANManagementVID, telecomsLineCode=telecomsLineCode, licensedCapacity=licensedCapacity, productVariant=productVariant, transmitFreqKHz=transmitFreqKHz, syslogClientTrap=syslogClientTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, pubStats=pubStats, phyStatus=phyStatus, snmpControl=snmpControl, sNMPCommunityString=sNMPCommunityString, telecomsInterface=telecomsInterface, bootVersion=bootVersion, dfsTableIndex=dfsTableIndex, linkLoss=linkLoss, syslogClient=syslogClient, sNMPPortNumber=sNMPPortNumber, sntp=sntp, managementGroup=managementGroup, encryptionGroup=encryptionGroup, syslogControlGroup=syslogControlGroup, userTableIndex=userTableIndex, vLANManagementPriority=vLANManagementPriority, ptpGroups=ptpGroups, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ethernet=ethernet, maximumTransmitPower=maximumTransmitPower, installStatusTrap=installStatusTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, latitude=latitude, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dataPortAutoMdix=dataPortAutoMdix, cableLoss=cableLoss, masterSlaveMode=masterSlaveMode, systemReset=systemReset, transmitChannel=transmitChannel, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tFTPServerIPAddress=tFTPServerIPAddress, ethernetFiberSupport=ethernetFiberSupport, groupID=groupID, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dfs=dfs, sNMPTrapVersion=sNMPTrapVersion, receiveDataRate=receiveDataRate, tDDControlGroup=tDDControlGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, supplementary=supplementary, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, versions=versions, productName=productName, dfsTableEntry=dfsTableEntry, sNMPEnabledTraps=sNMPEnabledTraps, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, enabledDiagnosticAlarms=enabledDiagnosticAlarms, systemClock=systemClock, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, subnetMask=subnetMask, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNTPSync=sNTPSync, telecomGroup=telecomGroup, userRole=userRole, pubStatsGroup=pubStatsGroup, hardwareVersion=hardwareVersion, userTable=userTable, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, alarms=alarms, receiveModulationMode=receiveModulationMode, receiveFreqMHz=receiveFreqMHz, targetMACAddress=targetMACAddress, vLANPriorityTableEntry=vLANPriorityTableEntry, capacityLicenseMismatch=capacityLicenseMismatch, sMTPServerPortNumber=sMTPServerPortNumber, vectorError=vectorError, telecomsLoopbackTrap=telecomsLoopbackTrap, hTTPAccessEnabled=hTTPAccessEnabled, secondarySoftwareVersion=secondarySoftwareVersion, receivePower=receivePower, transmitModulationMode=transmitModulationMode, regionCodeTrap=regionCodeTrap, tDDControl=tDDControl, phyControlGroup=phyControlGroup, smtpGroup=smtpGroup, ptmp=ptmp, phyStatusGroup=phyStatusGroup, dfsGroup=dfsGroup, aAAControlGroup=aAAControlGroup, daylightSaving=daylightSaving, sNTPState=sNTPState, sNTPSyncTrap=sNTPSyncTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, ptp=ptp, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, syslogState=syslogState, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, smtp=smtp, syslogStateTrap=syslogStateTrap, telecomsCableLength=telecomsCableLength, ethernetGroup=ethernetGroup, sNTPLastSync=sNTPLastSync, telnetAccessEnabled=telnetAccessEnabled, softwareVersion=softwareVersion, dfsPeaks=dfsPeaks, sNMPv3Enable=sNMPv3Enable, licenceGroup=licenceGroup, ptp500=ptp500, remoteIPAddress=remoteIPAddress, siteName=siteName, sNTPServerIPAddress=sNTPServerIPAddress, userName=userName, sMTPSourceEmailAddress=sMTPSourceEmailAddress, transmitFreqMHz=transmitFreqMHz, tDDSynchronizationMode=tDDSynchronizationMode, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, management=management, antennaGain=antennaGain, PYSNMP_MODULE_ID=cambium, userPassword=userPassword, userTableEntry=userTableEntry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, eIRP=eIRP, searchState=searchState, encryption=encryption, sNMPTrapTableIndex=sNMPTrapTableIndex, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sMTPEmailAlert=sMTPEmailAlert, tFTPServerPortNumber=tFTPServerPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, notificationsGroup=notificationsGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, aAAControl=aAAControl, configuration=configuration, dataPortStatus=dataPortStatus, hTTPPortNumber=hTTPPortNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, transmitPower=transmitPower, wirelessLinkAvailability=wirelessLinkAvailability, transmitDataRate=transmitDataRate, userTableNumber=userTableNumber, alarmsGroup=alarmsGroup, ptpCompliance=ptpCompliance, byteErrorRatio=byteErrorRatio, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, accessMethod=accessMethod, longitude=longitude, installArmStateTrap=installArmStateTrap, licence=licence, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, phyControl=phyControl, snmpControlGroup=snmpControlGroup, receiveModulationModeDetail=receiveModulationModeDetail, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortDisabledWarning=dataPortDisabledWarning, encryptionAlgorithm=encryptionAlgorithm, receiveChannel=receiveChannel, receiveFreqKHz=receiveFreqKHz)
