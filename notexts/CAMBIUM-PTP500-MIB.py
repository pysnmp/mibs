...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", receivePower=receivePower, ptpCompliance=ptpCompliance, transmitFreqMHz=transmitFreqMHz, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, resetGroup=resetGroup, pubStatsGroup=pubStatsGroup, productVariant=productVariant, remoteMaximumTransmitPower=remoteMaximumTransmitPower, snmpControlGroup=snmpControlGroup, PYSNMP_MODULE_ID=cambium, sNTPSyncTrap=sNTPSyncTrap, ptpTrapPrefix=ptpTrapPrefix, cableLoss=cableLoss, dataPortStatusTrap=dataPortStatusTrap, sNTPSync=sNTPSync, dfs=dfs, syslogClientTrap=syslogClientTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, supplementary=supplementary, sMTPEmailAlert=sMTPEmailAlert, dataPortAutoMdix=dataPortAutoMdix, versions=versions, vLANPriorityQueueMapping=vLANPriorityQueueMapping, signalStrengthRatio=signalStrengthRatio, aggregateDataRate=aggregateDataRate, sNMPPortNumber=sNMPPortNumber, installStatusTrap=installStatusTrap, hTTPSPortNumber=hTTPSPortNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, accessMethod=accessMethod, userTableIndex=userTableIndex, smtp=smtp, secondarySoftwareVersion=secondarySoftwareVersion, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, receiveChannel=receiveChannel, dfsPeaks=dfsPeaks, regionCode=regionCode, hTTPPortNumber=hTTPPortNumber, ethernetGroup=ethernetGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, systemClock=systemClock, receiveFreqKHz=receiveFreqKHz, subnetMask=subnetMask, receiveModulationModeDetail=receiveModulationModeDetail, altitude=altitude, frequencyVariant=frequencyVariant, telecom=telecom, regionCodeTrap=regionCodeTrap, channelChangeTrap=channelChangeTrap, telnetAccessEnabled=telnetAccessEnabled, cambium=cambium, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptp500=ptp500, vLANManagementPriority=vLANManagementPriority, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, versionsGroup=versionsGroup, sNTPPollInterval=sNTPPollInterval, supplementaryGroup=supplementaryGroup, installStatus=installStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPTrapTableNumber=sNMPTrapTableNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, gatewayIPAddress=gatewayIPAddress, configurationGroup=configurationGroup, latitude=latitude, siteName=siteName, iPAddress=iPAddress, encryption=encryption, bandwidthVariant=bandwidthVariant, wirelessLinkStatus=wirelessLinkStatus, searchState=searchState, telecomsLoopback=telecomsLoopback, ethernetFiberSupport=ethernetFiberSupport, vLANPriorityTableIndex=vLANPriorityTableIndex, sNTPLastSync=sNTPLastSync, enabledDiagnosticAlarms=enabledDiagnosticAlarms, channelBandwidth=channelBandwidth, ptp=ptp, userEnabled=userEnabled, daylightSaving=daylightSaving, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, telecomsLoopbackTrap=telecomsLoopbackTrap, antennaGain=antennaGain, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPCommunityString=sNMPCommunityString, unitOutOfCalibration=unitOutOfCalibration, transmitDataRate=transmitDataRate, syslogStateTrap=syslogStateTrap, alarmsGroup=alarmsGroup, productName=productName, sMTPEnabledMessages=sMTPEnabledMessages, encryptionGroup=encryptionGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPState=sNTPState, noWirelessChannelAvailable=noWirelessChannelAvailable, syslogState=syslogState, licenceGroup=licenceGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, timeZone=timeZone, linkSymmetry=linkSymmetry, sNMPv3Enable=sNMPv3Enable, userTable=userTable, vLANPriorityTableNumber=vLANPriorityTableNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dataPortDisabledWarning=dataPortDisabledWarning, vLANPriorityTable=vLANPriorityTable, ptpGroups=ptpGroups, telecomsLineCode=telecomsLineCode, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, installArmState=installArmState, dataPortAutoNegotiation=dataPortAutoNegotiation, licensedCapacity=licensedCapacity, sNMPTrapVersion=sNMPTrapVersion, tFTPServerIPAddress=tFTPServerIPAddress, linkName=linkName, telecomsCableLength=telecomsCableLength, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, syslogControl=syslogControl, ptmp=ptmp, userPassword=userPassword, sMTPSourceEmailAddress=sMTPSourceEmailAddress, linkModeOptimisation=linkModeOptimisation, incompatibleRegionCodes=incompatibleRegionCodes, licence=licence, dfsTableIndex=dfsTableIndex, dfsGroup=dfsGroup, transmitChannel=transmitChannel, tDDSynchronizationMode=tDDSynchronizationMode, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNTPServerPortNumber=sNTPServerPortNumber, wirelessLinkAvailability=wirelessLinkAvailability, eIRP=eIRP, sMTPServerPortNumber=sMTPServerPortNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sntpGroup=sntpGroup, longitude=longitude, sNMPTrapTableIndex=sNMPTrapTableIndex, vLANManagementVID=vLANManagementVID, hardwareVersion=hardwareVersion, range=range, softwareVersion=softwareVersion, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, userRole=userRole, receiveDataRate=receiveDataRate, telecomsChannelStatusTrap=telecomsChannelStatusTrap, telecomsInterface=telecomsInterface, dfsMeans=dfsMeans, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, constantPowerSpectralDensity=constantPowerSpectralDensity, installArmStateTrap=installArmStateTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, alarms=alarms, reset=reset, tDDControl=tDDControl, sNMPTrapTableEntry=sNMPTrapTableEntry, encryptionAlgorithm=encryptionAlgorithm, userTableNumber=userTableNumber, sMTPServerIPAddress=sMTPServerIPAddress, hTTPAccessEnabled=hTTPAccessEnabled, systemReset=systemReset, syslogClient=syslogClient, tFTPServerPortNumber=tFTPServerPortNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPEnabledTraps=sNMPEnabledTraps, phyStatusGroup=phyStatusGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapTable=sNMPTrapTable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, transmitPower=transmitPower, phyControlGroup=phyControlGroup, dfsTableNumber=dfsTableNumber, receiveModulationMode=receiveModulationMode, snmpControl=snmpControl, ptpTraps=ptpTraps, sNTPServerIPAddress=sNTPServerIPAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, pubStats=pubStats, maximumTransmitPower=maximumTransmitPower, tDDControlGroup=tDDControlGroup, capacityLicenseMismatch=capacityLicenseMismatch, managementGroup=managementGroup, targetMACAddress=targetMACAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernet=ethernet, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, transmitModulationMode=transmitModulationMode, bootVersion=bootVersion, notificationsGroup=notificationsGroup, byteErrorRatio=byteErrorRatio, telecomsChannelStatus=telecomsChannelStatus, remoteIPAddress=remoteIPAddress, vLANPriorityTableEntry=vLANPriorityTableEntry, masterSlaveMode=masterSlaveMode, dataPortStatus=dataPortStatus, userTableEntry=userTableEntry, linkLoss=linkLoss, userName=userName, dfsTable=dfsTable, vectorError=vectorError, sntp=sntp, phyStatus=phyStatus, dataPortConfigurationMismatch=dataPortConfigurationMismatch, transmitFreqKHz=transmitFreqKHz, smtpGroup=smtpGroup, telnetPortNumber=telnetPortNumber, telecomGroup=telecomGroup, receiveFreqMHz=receiveFreqMHz, configuration=configuration, phyControl=phyControl, management=management, aAAControlGroup=aAAControlGroup, dfsTableEntry=dfsTableEntry, aAAControl=aAAControl, groupID=groupID, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, syslogControlGroup=syslogControlGroup)
