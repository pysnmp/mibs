...
iso, ObjectIdentity, IpAddress, Bits, Counter64, MibIdentifier, NotificationType, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Gauge32, enterprises, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "IpAddress", "Bits", "Counter64", "MibIdentifier", "NotificationType", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Gauge32", "enterprises", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", vLANPriorityTableEntry=vLANPriorityTableEntry, vLANPriorityTable=vLANPriorityTable, sNMPv3Enable=sNMPv3Enable, ptpTrapPrefix=ptpTrapPrefix, remoteMaximumTransmitPower=remoteMaximumTransmitPower, telecomsChannelStatus=telecomsChannelStatus, installStatus=installStatus, dfsTableEntry=dfsTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tDDSynchronizationMode=tDDSynchronizationMode, bandwidthVariant=bandwidthVariant, alarmsGroup=alarmsGroup, dataPortStatusTrap=dataPortStatusTrap, sNTPServerPortNumber=sNTPServerPortNumber, vLANManagementVID=vLANManagementVID, vLANManagementPriority=vLANManagementPriority, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, telecomsCableLength=telecomsCableLength, incompatibleMasterAndSlave=incompatibleMasterAndSlave, telecomsChannelStatusTrap=telecomsChannelStatusTrap, snmpControl=snmpControl, dfsGroup=dfsGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, systemClock=systemClock, installArmStateTrap=installArmStateTrap, hTTPSPortNumber=hTTPSPortNumber, pubStats=pubStats, searchState=searchState, dfs=dfs, syslogControl=syslogControl, secondarySoftwareVersion=secondarySoftwareVersion, sMTPEnabledMessages=sMTPEnabledMessages, smtpGroup=smtpGroup, systemReset=systemReset, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, licence=licence, syslogClient=syslogClient, installArmState=installArmState, wirelessLinkStatus=wirelessLinkStatus, sNTPSync=sNTPSync, altitude=altitude, cambium=cambium, dataPortDisabledWarning=dataPortDisabledWarning, tFTPServerPortNumber=tFTPServerPortNumber, licenceGroup=licenceGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNTPLastSync=sNTPLastSync, receiveModulationMode=receiveModulationMode, aAAControl=aAAControl, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, aggregateDataRate=aggregateDataRate, byteErrorRatio=byteErrorRatio, dataPortAutoNegotiation=dataPortAutoNegotiation, snmpControlGroup=snmpControlGroup, aAAControlGroup=aAAControlGroup, latitude=latitude, useVLANForManagementInterfaces=useVLANForManagementInterfaces, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, productName=productName, vectorError=vectorError, sNMPTrapTable=sNMPTrapTable, telecomsLoopbackTrap=telecomsLoopbackTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, userTableNumber=userTableNumber, dataPortStatus=dataPortStatus, sNTPState=sNTPState, sntp=sntp, timeZone=timeZone, sNMPCommunityString=sNMPCommunityString, regionCodeTrap=regionCodeTrap, incompatibleRegionCodes=incompatibleRegionCodes, maximumTransmitPower=maximumTransmitPower, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ptmp=ptmp, sMTPServerPortNumber=sMTPServerPortNumber, userTableIndex=userTableIndex, configurationGroup=configurationGroup, managementGroup=managementGroup, syslogState=syslogState, versionsGroup=versionsGroup, userName=userName, supplementary=supplementary, userPassword=userPassword, ptp500=ptp500, eIRP=eIRP, telecomsLineCode=telecomsLineCode, supplementaryGroup=supplementaryGroup, dfsMeans=dfsMeans, wirelessLinkAvailability=wirelessLinkAvailability, targetMACAddress=targetMACAddress, dfsTableNumber=dfsTableNumber, telecomGroup=telecomGroup, tDDControlGroup=tDDControlGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsTableIndex=dfsTableIndex, receivePower=receivePower, dataPortConfigurationMismatch=dataPortConfigurationMismatch, transmitPower=transmitPower, transmitChannel=transmitChannel, tFTPServerIPAddress=tFTPServerIPAddress, telecom=telecom, transmitModulationMode=transmitModulationMode, hardwareVersion=hardwareVersion, range=range, softwareVersion=softwareVersion, dataPortWirelessDownAlert=dataPortWirelessDownAlert, linkModeOptimizationMismatch=linkModeOptimizationMismatch, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, signalStrengthRatio=signalStrengthRatio, sMTPEmailAlert=sMTPEmailAlert, ethernetFiberSupport=ethernetFiberSupport, vLANPriorityTableNumber=vLANPriorityTableNumber, bootVersion=bootVersion, sNTPPollInterval=sNTPPollInterval, productVariant=productVariant, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, channelChangeTrap=channelChangeTrap, sNTPSyncTrap=sNTPSyncTrap, dataPortAutoMdix=dataPortAutoMdix, sNMPPortNumber=sNMPPortNumber, alarms=alarms, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapTableIndex=sNMPTrapTableIndex, tDDControl=tDDControl, vLANPriorityTableIndex=vLANPriorityTableIndex, siteName=siteName, ptpCompliance=ptpCompliance, phyControlGroup=phyControlGroup, ptp=ptp, ptpTraps=ptpTraps, dfsTable=dfsTable, antennaGain=antennaGain, regionCode=regionCode, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, telecomsLoopback=telecomsLoopback, linkSymmetry=linkSymmetry, transmitFreqKHz=transmitFreqKHz, userRole=userRole, configuration=configuration, userEnabled=userEnabled, syslogClientTrap=syslogClientTrap, ptpGroups=ptpGroups, sNTPServerIPAddress=sNTPServerIPAddress, sMTPServerIPAddress=sMTPServerIPAddress, versions=versions, pubStatsGroup=pubStatsGroup, capacityLicenseMismatch=capacityLicenseMismatch, userTableEntry=userTableEntry, encryptionAlgorithm=encryptionAlgorithm, userTable=userTable, vLANPriorityQueueMapping=vLANPriorityQueueMapping, receiveFreqKHz=receiveFreqKHz, dfsPeaks=dfsPeaks, sntpGroup=sntpGroup, transmitDataRate=transmitDataRate, phyStatusGroup=phyStatusGroup, installStatusTrap=installStatusTrap, syslogStateTrap=syslogStateTrap, receiveChannel=receiveChannel, iPAddress=iPAddress, cableLoss=cableLoss, linkModeOptimisation=linkModeOptimisation, accessMethod=accessMethod, masterSlaveMode=masterSlaveMode, reset=reset, linkName=linkName, linkLoss=linkLoss, gatewayIPAddress=gatewayIPAddress, encryptionGroup=encryptionGroup, receiveFreqMHz=receiveFreqMHz, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ethernet=ethernet, longitude=longitude, encryption=encryption, telecomsInterface=telecomsInterface, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, management=management, sNMPEnabledTraps=sNMPEnabledTraps, daylightSaving=daylightSaving, sNMPTrapTableEntry=sNMPTrapTableEntry, remoteIPAddress=remoteIPAddress, phyControl=phyControl, noWirelessChannelAvailable=noWirelessChannelAvailable, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, licensedCapacity=licensedCapacity, PYSNMP_MODULE_ID=cambium, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, hTTPAccessEnabled=hTTPAccessEnabled, sNMPTrapTableNumber=sNMPTrapTableNumber, receiveModulationModeDetail=receiveModulationModeDetail, frequencyVariant=frequencyVariant, channelBandwidth=channelBandwidth, phyStatus=phyStatus, smtp=smtp, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, hTTPPortNumber=hTTPPortNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, telnetPortNumber=telnetPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, subnetMask=subnetMask, notificationsGroup=notificationsGroup, ethernetGroup=ethernetGroup, telnetAccessEnabled=telnetAccessEnabled, groupID=groupID, receiveDataRate=receiveDataRate, tDDSynchronizationStatus=tDDSynchronizationStatus, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, unitOutOfCalibration=unitOutOfCalibration, resetGroup=resetGroup, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, transmitFreqMHz=transmitFreqMHz, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, syslogControlGroup=syslogControlGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress)
