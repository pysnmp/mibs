...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sNMPTrapVersion=sNMPTrapVersion, userTableNumber=userTableNumber, gatewayIPAddress=gatewayIPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, licensedCapacity=licensedCapacity, snmpControlGroup=snmpControlGroup, bootVersion=bootVersion, sNMPTrapTableNumber=sNMPTrapTableNumber, tDDControl=tDDControl, constantPowerSpectralDensity=constantPowerSpectralDensity, dataPortAutoMdix=dataPortAutoMdix, sNTPSyncTrap=sNTPSyncTrap, hardwareVersion=hardwareVersion, accessMethod=accessMethod, sNMPTrapIPAddress=sNMPTrapIPAddress, reset=reset, telecomsCableLength=telecomsCableLength, userEnabled=userEnabled, telecomsInterface=telecomsInterface, wirelessLinkStatus=wirelessLinkStatus, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, bandwidthVariant=bandwidthVariant, altitude=altitude, dfsPeaks=dfsPeaks, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPState=sNTPState, vLANPriorityTableEntry=vLANPriorityTableEntry, licenceGroup=licenceGroup, syslogClientTrap=syslogClientTrap, encryptionAlgorithm=encryptionAlgorithm, regionCode=regionCode, useVLANForManagementInterfaces=useVLANForManagementInterfaces, supplementaryGroup=supplementaryGroup, tFTPServerIPAddress=tFTPServerIPAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, vLANPriorityTableNumber=vLANPriorityTableNumber, telnetAccessEnabled=telnetAccessEnabled, userName=userName, systemClock=systemClock, subnetMask=subnetMask, receivePower=receivePower, dfsTableNumber=dfsTableNumber, sNTPLastSync=sNTPLastSync, ptpTraps=ptpTraps, dataPortStatusTrap=dataPortStatusTrap, dfs=dfs, sMTPEnabledMessages=sMTPEnabledMessages, telecomsChannelStatus=telecomsChannelStatus, configurationGroup=configurationGroup, sMTPEmailAlert=sMTPEmailAlert, remoteIPAddress=remoteIPAddress, tFTPServerPortNumber=tFTPServerPortNumber, dfsGroup=dfsGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, transmitFreqMHz=transmitFreqMHz, cambium=cambium, tDDSynchronizationStatus=tDDSynchronizationStatus, sntp=sntp, vLANPriorityQueueMapping=vLANPriorityQueueMapping, receiveModulationMode=receiveModulationMode, userPassword=userPassword, telecomsLoopback=telecomsLoopback, iPAddress=iPAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, frequencyVariant=frequencyVariant, transmitModulationMode=transmitModulationMode, aAAControl=aAAControl, management=management, installArmState=installArmState, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dfsMeans=dfsMeans, transmitChannel=transmitChannel, regionCodeTrap=regionCodeTrap, dfsTable=dfsTable, sNMPCommunityString=sNMPCommunityString, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, maximumTransmitPower=maximumTransmitPower, daylightSaving=daylightSaving, antennaGain=antennaGain, installStatusTrap=installStatusTrap, byteErrorRatio=byteErrorRatio, sNTPPollInterval=sNTPPollInterval, PYSNMP_MODULE_ID=cambium, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPServerIPAddress=sNTPServerIPAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, snmpControl=snmpControl, sNMPTrapTable=sNMPTrapTable, telecomsLineCode=telecomsLineCode, vLANPriorityTable=vLANPriorityTable, hTTPSAccessEnabled=hTTPSAccessEnabled, noWirelessChannelAvailable=noWirelessChannelAvailable, vLANPriorityTableIndex=vLANPriorityTableIndex, syslogStateTrap=syslogStateTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, latitude=latitude, telecomsLoopbackTrap=telecomsLoopbackTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, linkModeOptimizationMismatch=linkModeOptimizationMismatch, targetMACAddress=targetMACAddress, signalStrengthRatio=signalStrengthRatio, tDDSynchronizationMode=tDDSynchronizationMode, configuration=configuration, vectorError=vectorError, receiveChannel=receiveChannel, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, userTableIndex=userTableIndex, pubStatsGroup=pubStatsGroup, phyControl=phyControl, eIRP=eIRP, sNMPv3Enable=sNMPv3Enable, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, telnetPortNumber=telnetPortNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, installArmStateTrap=installArmStateTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, productName=productName, notificationsGroup=notificationsGroup, phyStatusGroup=phyStatusGroup, linkName=linkName, linkLoss=linkLoss, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, range=range, supplementary=supplementary, syslogControlGroup=syslogControlGroup, sNTPServerPortNumber=sNTPServerPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, receiveDataRate=receiveDataRate, timeZone=timeZone, linkSymmetry=linkSymmetry, alarms=alarms, ptmp=ptmp, searchState=searchState, longitude=longitude, syslogControl=syslogControl, channelBandwidth=channelBandwidth, aggregateDataRate=aggregateDataRate, encryptionGroup=encryptionGroup, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, dfsTableEntry=dfsTableEntry, masterSlaveMode=masterSlaveMode, unitOutOfCalibration=unitOutOfCalibration, receiveModulationModeDetail=receiveModulationModeDetail, ethernetGroup=ethernetGroup, softwareVersion=softwareVersion, cableLoss=cableLoss, channelChangeTrap=channelChangeTrap, siteName=siteName, ethernetFiberSupport=ethernetFiberSupport, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, managementGroup=managementGroup, wirelessLinkAvailability=wirelessLinkAvailability, receiveFreqKHz=receiveFreqKHz, ethernet=ethernet, smtp=smtp, telecomGroup=telecomGroup, userTableEntry=userTableEntry, transmitDataRate=transmitDataRate, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, hTTPAccessEnabled=hTTPAccessEnabled, receiveFreqMHz=receiveFreqMHz, aAAControlGroup=aAAControlGroup, smtpGroup=smtpGroup, installStatus=installStatus, dataPortConfigurationMismatch=dataPortConfigurationMismatch, syslogState=syslogState, syslogLocalWrappedTrap=syslogLocalWrappedTrap, versions=versions, linkModeOptimisation=linkModeOptimisation, alarmsGroup=alarmsGroup, ptpCompliance=ptpCompliance, vLANManagementVID=vLANManagementVID, incompatibleRegionCodes=incompatibleRegionCodes, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPEnabledTraps=sNMPEnabledTraps, dataPortDisabledWarning=dataPortDisabledWarning, phyControlGroup=phyControlGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sntpGroup=sntpGroup, capacityLicenseMismatch=capacityLicenseMismatch, groupID=groupID, userTable=userTable, transmitFreqKHz=transmitFreqKHz, dfsTableIndex=dfsTableIndex, licence=licence, hTTPPortNumber=hTTPPortNumber, telecom=telecom, ptp500=ptp500, dataPortAutoNegotiation=dataPortAutoNegotiation, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, productVariant=productVariant, pubStats=pubStats, transmitPower=transmitPower, systemReset=systemReset, ptpTrapPrefix=ptpTrapPrefix, vLANManagementPriority=vLANManagementPriority, hTTPSPortNumber=hTTPSPortNumber, resetGroup=resetGroup, ptp=ptp, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPPortNumber=sNMPPortNumber, ptpGroups=ptpGroups, tDDControlGroup=tDDControlGroup, versionsGroup=versionsGroup, sNTPSync=sNTPSync, sMTPServerIPAddress=sMTPServerIPAddress, phyStatus=phyStatus, encryption=encryption, syslogClient=syslogClient, userRole=userRole, dataPortStatus=dataPortStatus)
