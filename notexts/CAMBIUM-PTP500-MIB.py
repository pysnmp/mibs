...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sMTPServerIPAddress=sMTPServerIPAddress, syslogClient=syslogClient, aggregateDataRate=aggregateDataRate, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, phyControlGroup=phyControlGroup, ethernetFiberSupport=ethernetFiberSupport, signalStrengthRatio=signalStrengthRatio, tDDSynchronizationStatus=tDDSynchronizationStatus, dataPortStatusTrap=dataPortStatusTrap, telecomsLineCode=telecomsLineCode, latitude=latitude, ptpTraps=ptpTraps, smtp=smtp, telecomsChannelStatus=telecomsChannelStatus, pubStats=pubStats, syslogControl=syslogControl, dfsTable=dfsTable, linkModeOptimisation=linkModeOptimisation, linkLoss=linkLoss, sNTPServerPortNumber=sNTPServerPortNumber, subnetMask=subnetMask, secondarySoftwareVersion=secondarySoftwareVersion, dfsMeans=dfsMeans, hTTPAccessEnabled=hTTPAccessEnabled, ptp=ptp, ptpCompliance=ptpCompliance, sntpGroup=sntpGroup, encryptionAlgorithm=encryptionAlgorithm, eIRP=eIRP, installArmStateTrap=installArmStateTrap, vectorError=vectorError, ptmp=ptmp, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPTrapTableNumber=sNMPTrapTableNumber, bootVersion=bootVersion, unitOutOfCalibration=unitOutOfCalibration, dataPortAutoNegotiation=dataPortAutoNegotiation, ptpTrapPrefix=ptpTrapPrefix, searchState=searchState, sNMPCommunityString=sNMPCommunityString, userTable=userTable, vLANPriorityTableEntry=vLANPriorityTableEntry, altitude=altitude, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, daylightSaving=daylightSaving, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, maximumTransmitPower=maximumTransmitPower, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, incompatibleRegionCodes=incompatibleRegionCodes, hTTPSAccessEnabled=hTTPSAccessEnabled, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, capacityLicenseMismatch=capacityLicenseMismatch, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, wirelessLinkAvailability=wirelessLinkAvailability, sMTPEmailAlert=sMTPEmailAlert, bandwidthVariant=bandwidthVariant, configuration=configuration, vLANManagementPriority=vLANManagementPriority, cableLoss=cableLoss, alarmsGroup=alarmsGroup, smtpGroup=smtpGroup, transmitChannel=transmitChannel, tDDControl=tDDControl, receiveFreqKHz=receiveFreqKHz, wirelessLinkStatus=wirelessLinkStatus, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, cambium=cambium, telecomGroup=telecomGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, productName=productName, receiveDataRate=receiveDataRate, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapVersion=sNMPTrapVersion, pubStatsGroup=pubStatsGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPSyncTrap=sNTPSyncTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, syslogClientTrap=syslogClientTrap, transmitFreqKHz=transmitFreqKHz, dataPortWirelessDownAlert=dataPortWirelessDownAlert, installStatusTrap=installStatusTrap, encryption=encryption, sNTPSync=sNTPSync, sMTPEnabledMessages=sMTPEnabledMessages, targetMACAddress=targetMACAddress, ptp500=ptp500, useVLANForManagementInterfaces=useVLANForManagementInterfaces, aAAControl=aAAControl, userTableEntry=userTableEntry, telecomsInterface=telecomsInterface, sNMPEnabledTraps=sNMPEnabledTraps, dataPortStatus=dataPortStatus, tDDControlGroup=tDDControlGroup, management=management, channelBandwidth=channelBandwidth, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, syslogStateTrap=syslogStateTrap, linkName=linkName, telnetPortNumber=telnetPortNumber, tDDSynchronizationMode=tDDSynchronizationMode, sNMPTrapTable=sNMPTrapTable, hardwareVersion=hardwareVersion, vLANPriorityTableIndex=vLANPriorityTableIndex, licence=licence, telecomsLoopback=telecomsLoopback, softwareVersion=softwareVersion, transmitDataRate=transmitDataRate, syslogLocalWrappedTrap=syslogLocalWrappedTrap, userName=userName, transmitFreqMHz=transmitFreqMHz, hTTPSPortNumber=hTTPSPortNumber, sNMPPortNumber=sNMPPortNumber, transmitModulationMode=transmitModulationMode, tDDSynchronizationAlarm=tDDSynchronizationAlarm, licensedCapacity=licensedCapacity, dataPortDisabledWarning=dataPortDisabledWarning, alarms=alarms, phyStatusGroup=phyStatusGroup, regionCodeTrap=regionCodeTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, longitude=longitude, receiveChannel=receiveChannel, vLANPriorityTable=vLANPriorityTable, installArmState=installArmState, dfsGroup=dfsGroup, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, resetGroup=resetGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, aAAControlGroup=aAAControlGroup, sNTPServerIPAddress=sNTPServerIPAddress, remoteIPAddress=remoteIPAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, enabledDiagnosticAlarms=enabledDiagnosticAlarms, configurationGroup=configurationGroup, receiveModulationModeDetail=receiveModulationModeDetail, ethernetGroup=ethernetGroup, phyControl=phyControl, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, antennaGain=antennaGain, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, snmpControl=snmpControl, PYSNMP_MODULE_ID=cambium, byteErrorRatio=byteErrorRatio, constantPowerSpectralDensity=constantPowerSpectralDensity, vLANManagementVID=vLANManagementVID, telecomsCableLength=telecomsCableLength, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, linkSymmetry=linkSymmetry, userRole=userRole, telnetAccessEnabled=telnetAccessEnabled, phyStatus=phyStatus, dfsTableEntry=dfsTableEntry, sNTPLastSync=sNTPLastSync, sNMPTrapTableEntry=sNMPTrapTableEntry, transmitPower=transmitPower, systemClock=systemClock, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNMPv3Enable=sNMPv3Enable, accessMethod=accessMethod, userTableIndex=userTableIndex, userEnabled=userEnabled, userPassword=userPassword, syslogControlGroup=syslogControlGroup, ethernet=ethernet, ptpGroups=ptpGroups, siteName=siteName, dfsPeaks=dfsPeaks, groupID=groupID, sNTPState=sNTPState, gatewayIPAddress=gatewayIPAddress, sntp=sntp, timeZone=timeZone, syslogState=syslogState, masterSlaveMode=masterSlaveMode, systemReset=systemReset, sMTPServerPortNumber=sMTPServerPortNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, managementGroup=managementGroup, channelChangeTrap=channelChangeTrap, snmpControlGroup=snmpControlGroup, iPAddress=iPAddress, tFTPServerPortNumber=tFTPServerPortNumber, licenceGroup=licenceGroup, dataPortAutoMdix=dataPortAutoMdix, receiveFreqMHz=receiveFreqMHz, hTTPPortNumber=hTTPPortNumber, range=range, receivePower=receivePower, sNMPTrapPortNumber=sNMPTrapPortNumber, versionsGroup=versionsGroup, installStatus=installStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dfs=dfs, receiveModulationMode=receiveModulationMode, supplementary=supplementary, supplementaryGroup=supplementaryGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, dfsTableNumber=dfsTableNumber, versions=versions, telecomsLoopbackTrap=telecomsLoopbackTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, telecom=telecom, notificationsGroup=notificationsGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, reset=reset, frequencyVariant=frequencyVariant, sNTPPollInterval=sNTPPollInterval, dfsTableIndex=dfsTableIndex, encryptionGroup=encryptionGroup, userTableNumber=userTableNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, productVariant=productVariant, incompatibleMasterAndSlave=incompatibleMasterAndSlave, regionCode=regionCode)
