...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", secondarySoftwareVersion=secondarySoftwareVersion, regionCodeTrap=regionCodeTrap, tFTPServerPortNumber=tFTPServerPortNumber, vLANManagementPriority=vLANManagementPriority, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapTableEntry=sNMPTrapTableEntry, dfs=dfs, supplementaryGroup=supplementaryGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, longitude=longitude, vLANPriorityTable=vLANPriorityTable, capacityLicenseMismatch=capacityLicenseMismatch, sntp=sntp, sMTPEmailAlert=sMTPEmailAlert, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sMTPServerPortNumber=sMTPServerPortNumber, phyControlGroup=phyControlGroup, installArmState=installArmState, antennaGain=antennaGain, dataPortConfigurationMismatch=dataPortConfigurationMismatch, transmitPower=transmitPower, encryptionAlgorithm=encryptionAlgorithm, noWirelessChannelAvailable=noWirelessChannelAvailable, dfsTable=dfsTable, altitude=altitude, userTableIndex=userTableIndex, sNMPTrapIPAddress=sNMPTrapIPAddress, regionCode=regionCode, bootVersion=bootVersion, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, ptp500=ptp500, sNTPSync=sNTPSync, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, latitude=latitude, licence=licence, phyControl=phyControl, sNTPSyncTrap=sNTPSyncTrap, wirelessLinkStatus=wirelessLinkStatus, notificationsGroup=notificationsGroup, ethernetFiberSupport=ethernetFiberSupport, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, vectorError=vectorError, installArmStateTrap=installArmStateTrap, installStatus=installStatus, signalStrengthRatio=signalStrengthRatio, enabledDiagnosticAlarms=enabledDiagnosticAlarms, configuration=configuration, sNMPTrapVersion=sNMPTrapVersion, syslogControlGroup=syslogControlGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, vLANPriorityTableNumber=vLANPriorityTableNumber, sNTPServerPortNumber=sNTPServerPortNumber, pubStatsGroup=pubStatsGroup, ptmp=ptmp, bandwidthVariant=bandwidthVariant, phyStatusGroup=phyStatusGroup, dfsTableNumber=dfsTableNumber, ptpGroups=ptpGroups, maximumTransmitPower=maximumTransmitPower, receivePower=receivePower, receiveChannel=receiveChannel, resetGroup=resetGroup, licensedCapacity=licensedCapacity, supplementary=supplementary, sNTPServerIPAddress=sNTPServerIPAddress, alarmsGroup=alarmsGroup, licenceGroup=licenceGroup, accessMethod=accessMethod, receiveModulationMode=receiveModulationMode, telecom=telecom, groupID=groupID, userEnabled=userEnabled, useVLANForManagementInterfaces=useVLANForManagementInterfaces, incompatibleMasterAndSlave=incompatibleMasterAndSlave, gatewayIPAddress=gatewayIPAddress, tDDControlGroup=tDDControlGroup, cableLoss=cableLoss, vLANManagementVID=vLANManagementVID, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, userPassword=userPassword, timeZone=timeZone, daylightSaving=daylightSaving, telecomsCableLength=telecomsCableLength, productVariant=productVariant, aggregateDataRate=aggregateDataRate, subnetMask=subnetMask, userName=userName, incompatibleRegionCodes=incompatibleRegionCodes, userTable=userTable, syslogClient=syslogClient, telecomsLoopbackTrap=telecomsLoopbackTrap, linkName=linkName, telecomsLoopback=telecomsLoopback, masterSlaveMode=masterSlaveMode, dfsGroup=dfsGroup, encryption=encryption, targetMACAddress=targetMACAddress, receiveFreqMHz=receiveFreqMHz, eIRP=eIRP, ptpTrapPrefix=ptpTrapPrefix, vLANPriorityTableIndex=vLANPriorityTableIndex, sNMPTrapPortNumber=sNMPTrapPortNumber, dfsMeans=dfsMeans, sMTPEnabledMessages=sMTPEnabledMessages, hTTPAccessEnabled=hTTPAccessEnabled, userTableEntry=userTableEntry, systemClock=systemClock, telecomsChannelStatusTrap=telecomsChannelStatusTrap, versions=versions, management=management, ethernetGroup=ethernetGroup, sNTPState=sNTPState, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, linkLoss=linkLoss, dataPortStatusTrap=dataPortStatusTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, channelChangeTrap=channelChangeTrap, sNTPPollInterval=sNTPPollInterval, softwareVersion=softwareVersion, dfsTableEntry=dfsTableEntry, sNMPTrapTable=sNMPTrapTable, dfsPeaks=dfsPeaks, dataPortWirelessDownAlert=dataPortWirelessDownAlert, syslogControl=syslogControl, syslogClientTrap=syslogClientTrap, frequencyVariant=frequencyVariant, telecomGroup=telecomGroup, linkModeOptimisation=linkModeOptimisation, snmpControlGroup=snmpControlGroup, ptpTraps=ptpTraps, dataPortAutoNegotiation=dataPortAutoNegotiation, transmitModulationMode=transmitModulationMode, vLANPriorityQueueMapping=vLANPriorityQueueMapping, dataPortStatus=dataPortStatus, byteErrorRatio=byteErrorRatio, sntpGroup=sntpGroup, smtpGroup=smtpGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPEnabledTraps=sNMPEnabledTraps, sNTPLastSync=sNTPLastSync, systemReset=systemReset, siteName=siteName, phyStatus=phyStatus, dataPortDisabledWarning=dataPortDisabledWarning, ptp=ptp, sNMPTrapTableIndex=sNMPTrapTableIndex, hardwareVersion=hardwareVersion, syslogState=syslogState, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPv3Enable=sNMPv3Enable, hTTPSAccessEnabled=hTTPSAccessEnabled, pubStats=pubStats, sMTPServerIPAddress=sMTPServerIPAddress, userTableNumber=userTableNumber, syslogStateTrap=syslogStateTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, hTTPPortNumber=hTTPPortNumber, range=range, telecomsChannelStatus=telecomsChannelStatus, searchState=searchState, wirelessLinkAvailability=wirelessLinkAvailability, reset=reset, alarms=alarms, tDDSynchronizationAlarm=tDDSynchronizationAlarm, userRole=userRole, managementGroup=managementGroup, transmitFreqMHz=transmitFreqMHz, PYSNMP_MODULE_ID=cambium, transmitDataRate=transmitDataRate, tDDControl=tDDControl, receiveFreqKHz=receiveFreqKHz, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, dataPortAutoMdix=dataPortAutoMdix, dfsTableIndex=dfsTableIndex, hTTPSPortNumber=hTTPSPortNumber, transmitFreqKHz=transmitFreqKHz, tDDSynchronizationStatus=tDDSynchronizationStatus, aAAControlGroup=aAAControlGroup, cambium=cambium, sNMPCommunityString=sNMPCommunityString, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, constantPowerSpectralDensity=constantPowerSpectralDensity, telnetAccessEnabled=telnetAccessEnabled, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, smtp=smtp, productName=productName, vLANPriorityTableEntry=vLANPriorityTableEntry, telnetPortNumber=telnetPortNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, iPAddress=iPAddress, versionsGroup=versionsGroup, transmitChannel=transmitChannel, telecomsLineCode=telecomsLineCode, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, unitOutOfCalibration=unitOutOfCalibration, ethernet=ethernet, ptpCompliance=ptpCompliance, encryptionGroup=encryptionGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, remoteMaximumTransmitPower=remoteMaximumTransmitPower, remoteIPAddress=remoteIPAddress, snmpControl=snmpControl, tDDSynchronizationMode=tDDSynchronizationMode, configurationGroup=configurationGroup, sNMPPortNumber=sNMPPortNumber, receiveDataRate=receiveDataRate, installStatusTrap=installStatusTrap, receiveModulationModeDetail=receiveModulationModeDetail, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, aAAControl=aAAControl, telecomsInterface=telecomsInterface, linkSymmetry=linkSymmetry, tFTPServerIPAddress=tFTPServerIPAddress, channelBandwidth=channelBandwidth, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText)
