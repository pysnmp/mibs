...
Counter64, Gauge32, TimeTicks, Bits, ObjectIdentity, Integer32, Unsigned32, MibIdentifier, iso, NotificationType, IpAddress, Counter32, enterprises, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Gauge32", "TimeTicks", "Bits", "ObjectIdentity", "Integer32", "Unsigned32", "MibIdentifier", "iso", "NotificationType", "IpAddress", "Counter32", "enterprises", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sNMPTrapTable=sNMPTrapTable, subnetMask=subnetMask, dfsTableNumber=dfsTableNumber, vLANManagementPriority=vLANManagementPriority, systemReset=systemReset, sntpGroup=sntpGroup, aAAControl=aAAControl, supplementaryGroup=supplementaryGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPSync=sNTPSync, vLANManagementVID=vLANManagementVID, transmitDataRate=transmitDataRate, dfs=dfs, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, receivePower=receivePower, receiveModulationMode=receiveModulationMode, userTableNumber=userTableNumber, hardwareVersion=hardwareVersion, receiveFreqKHz=receiveFreqKHz, transmitModulationMode=transmitModulationMode, sMTPEmailAlert=sMTPEmailAlert, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapTableNumber=sNMPTrapTableNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sMTPSourceEmailAddress=sMTPSourceEmailAddress, receiveModulationModeDetail=receiveModulationModeDetail, userName=userName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, hTTPPortNumber=hTTPPortNumber, transmitFreqMHz=transmitFreqMHz, sNMPTrapTableIndex=sNMPTrapTableIndex, reset=reset, groupID=groupID, regionCode=regionCode, userEnabled=userEnabled, tDDSynchronizationMode=tDDSynchronizationMode, installArmStateTrap=installArmStateTrap, phyControlGroup=phyControlGroup, userTable=userTable, licence=licence, linkModeOptimisation=linkModeOptimisation, gatewayIPAddress=gatewayIPAddress, range=range, sntp=sntp, accessMethod=accessMethod, productVariant=productVariant, sMTPServerIPAddress=sMTPServerIPAddress, eIRP=eIRP, remoteIPAddress=remoteIPAddress, versions=versions, versionsGroup=versionsGroup, ptmp=ptmp, snmpControlGroup=snmpControlGroup, telnetAccessEnabled=telnetAccessEnabled, tDDSynchronizationStatus=tDDSynchronizationStatus, bootVersion=bootVersion, ptp500=ptp500, sNTPLastSync=sNTPLastSync, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, alarmsGroup=alarmsGroup, userRole=userRole, syslogStateTrap=syslogStateTrap, siteName=siteName, remoteMaximumTransmitPower=remoteMaximumTransmitPower, syslogControl=syslogControl, dfsPeaks=dfsPeaks, constantPowerSpectralDensity=constantPowerSpectralDensity, incompatibleRegionCodes=incompatibleRegionCodes, telecomsCableLength=telecomsCableLength, softwareVersion=softwareVersion, sNMPTrapIPAddress=sNMPTrapIPAddress, byteErrorRatio=byteErrorRatio, vLANPriorityTableNumber=vLANPriorityTableNumber, channelChangeTrap=channelChangeTrap, tDDControlGroup=tDDControlGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, telecom=telecom, ptpTraps=ptpTraps, managementGroup=managementGroup, telecomsChannelStatus=telecomsChannelStatus, sNMPv3Enable=sNMPv3Enable, supplementary=supplementary, transmitFreqKHz=transmitFreqKHz, smtpGroup=smtpGroup, phyStatus=phyStatus, sNTPPollInterval=sNTPPollInterval, sNMPTrapPortNumber=sNMPTrapPortNumber, cableLoss=cableLoss, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, signalStrengthRatio=signalStrengthRatio, dataPortDisabledWarning=dataPortDisabledWarning, dfsTableEntry=dfsTableEntry, dfsTableIndex=dfsTableIndex, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNTPServerIPAddress=sNTPServerIPAddress, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, linkLoss=linkLoss, phyControl=phyControl, ptpCompliance=ptpCompliance, pubStats=pubStats, hTTPSAccessEnabled=hTTPSAccessEnabled, ethernet=ethernet, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sMTPEnabledMessages=sMTPEnabledMessages, snmpControl=snmpControl, telecomGroup=telecomGroup, ethernetFiberSupport=ethernetFiberSupport, dataPortWirelessDownAlert=dataPortWirelessDownAlert, searchState=searchState, encryption=encryption, receiveFreqMHz=receiveFreqMHz, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, transmitChannel=transmitChannel, noWirelessChannelAvailable=noWirelessChannelAvailable, hTTPAccessEnabled=hTTPAccessEnabled, notificationsGroup=notificationsGroup, iPAddress=iPAddress, channelBandwidth=channelBandwidth, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPPortNumber=sNMPPortNumber, ptp=ptp, dataPortAutoMdix=dataPortAutoMdix, sNTPState=sNTPState, licensedCapacity=licensedCapacity, antennaGain=antennaGain, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, latitude=latitude, frequencyVariant=frequencyVariant, tFTPServerPortNumber=tFTPServerPortNumber, aAAControlGroup=aAAControlGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, vLANPriorityQueueMapping=vLANPriorityQueueMapping, ethernetGroup=ethernetGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, phyStatusGroup=phyStatusGroup, timeZone=timeZone, installStatus=installStatus, sMTPServerPortNumber=sMTPServerPortNumber, dfsMeans=dfsMeans, regionCodeTrap=regionCodeTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, linkName=linkName, alarms=alarms, secondarySoftwareVersion=secondarySoftwareVersion, sNTPSyncTrap=sNTPSyncTrap, syslogClient=syslogClient, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, bandwidthVariant=bandwidthVariant, telecomsLoopbackTrap=telecomsLoopbackTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, telecomsLoopback=telecomsLoopback, tDDControl=tDDControl, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, capacityLicenseMismatch=capacityLicenseMismatch, userTableIndex=userTableIndex, tDDSynchronizationAlarm=tDDSynchronizationAlarm, syslogState=syslogState, altitude=altitude, syslogClientTrap=syslogClientTrap, userTableEntry=userTableEntry, resetGroup=resetGroup, encryptionGroup=encryptionGroup, productName=productName, installArmState=installArmState, installStatusTrap=installStatusTrap, dfsTable=dfsTable, dataPortStatusTrap=dataPortStatusTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, pubStatsGroup=pubStatsGroup, hTTPSPortNumber=hTTPSPortNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, receiveChannel=receiveChannel, incompatibleMasterAndSlave=incompatibleMasterAndSlave, encryptionAlgorithm=encryptionAlgorithm, licenceGroup=licenceGroup, telecomsInterface=telecomsInterface, vLANPriorityTable=vLANPriorityTable, linkSymmetry=linkSymmetry, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, targetMACAddress=targetMACAddress, dataPortStatus=dataPortStatus, maximumTransmitPower=maximumTransmitPower, telecomsChannelStatusTrap=telecomsChannelStatusTrap, wirelessLinkStatus=wirelessLinkStatus, wirelessLinkAvailability=wirelessLinkAvailability, configurationGroup=configurationGroup, receiveDataRate=receiveDataRate, vectorError=vectorError, longitude=longitude, ptpGroups=ptpGroups, smtp=smtp, masterSlaveMode=masterSlaveMode, configuration=configuration, telecomsLineCode=telecomsLineCode, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNMPTrapVersion=sNMPTrapVersion, daylightSaving=daylightSaving, syslogLocalWrappedTrap=syslogLocalWrappedTrap, userPassword=userPassword, transmitPower=transmitPower, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfsGroup=dfsGroup, PYSNMP_MODULE_ID=cambium, tFTPServerIPAddress=tFTPServerIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, unitOutOfCalibration=unitOutOfCalibration, telnetPortNumber=telnetPortNumber, systemClock=systemClock, aggregateDataRate=aggregateDataRate, vLANPriorityTableIndex=vLANPriorityTableIndex, syslogControlGroup=syslogControlGroup, sNMPEnabledTraps=sNMPEnabledTraps, sNTPServerPortNumber=sNTPServerPortNumber, cambium=cambium, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPCommunityString=sNMPCommunityString, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, management=management)
