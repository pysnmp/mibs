...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ObjectIdentity, Bits, IpAddress, Unsigned32, Counter32, Gauge32, enterprises, Integer32, Counter64, TimeTicks, iso, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ObjectIdentity", "Bits", "IpAddress", "Unsigned32", "Counter32", "Gauge32", "enterprises", "Integer32", "Counter64", "TimeTicks", "iso", "MibIdentifier")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", dfsTableIndex=dfsTableIndex, syslogControl=syslogControl, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, telecomsLineCode=telecomsLineCode, alarms=alarms, linkName=linkName, systemReset=systemReset, tFTPServerIPAddress=tFTPServerIPAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, hardwareVersion=hardwareVersion, telecomsChannelStatusTrap=telecomsChannelStatusTrap, tDDSynchronizationMode=tDDSynchronizationMode, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, productName=productName, latitude=latitude, userEnabled=userEnabled, tDDControl=tDDControl, dfsMeans=dfsMeans, transmitChannel=transmitChannel, sNTPServerIPAddress=sNTPServerIPAddress, licensedCapacity=licensedCapacity, licence=licence, managementGroup=managementGroup, userTable=userTable, signalStrengthRatio=signalStrengthRatio, alarmsGroup=alarmsGroup, sNTPPollInterval=sNTPPollInterval, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, vLANManagementVID=vLANManagementVID, sNMPTrapPortNumber=sNMPTrapPortNumber, range=range, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, capacityLicenseMismatch=capacityLicenseMismatch, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, regionCode=regionCode, telecomGroup=telecomGroup, versionsGroup=versionsGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPServerPortNumber=sNTPServerPortNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, linkLoss=linkLoss, syslogStateTrap=syslogStateTrap, dfs=dfs, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ptpGroups=ptpGroups, ptp500=ptp500, sNMPEnabledTraps=sNMPEnabledTraps, dataPortWirelessDownAlert=dataPortWirelessDownAlert, encryptionGroup=encryptionGroup, receiveFreqMHz=receiveFreqMHz, encryptionAlgorithm=encryptionAlgorithm, configurationGroup=configurationGroup, sNTPLastSync=sNTPLastSync, dataPortStatusTrap=dataPortStatusTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, management=management, ptpTrapPrefix=ptpTrapPrefix, encryption=encryption, remoteIPAddress=remoteIPAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, smtp=smtp, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sMTPServerPortNumber=sMTPServerPortNumber, ethernet=ethernet, installArmState=installArmState, linkModeOptimizationMismatch=linkModeOptimizationMismatch, ptp=ptp, telecomsInterface=telecomsInterface, noWirelessChannelAvailable=noWirelessChannelAvailable, installArmStateTrap=installArmStateTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, telecomsLoopback=telecomsLoopback, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, installStatusTrap=installStatusTrap, dataPortAutoMdix=dataPortAutoMdix, tDDControlGroup=tDDControlGroup, syslogControlGroup=syslogControlGroup, phyControl=phyControl, dfsTableEntry=dfsTableEntry, iPAddress=iPAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, hTTPPortNumber=hTTPPortNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPPortNumber=sNMPPortNumber, wirelessLinkStatus=wirelessLinkStatus, sNMPCommunityString=sNMPCommunityString, supplementaryGroup=supplementaryGroup, softwareVersion=softwareVersion, dfsTableNumber=dfsTableNumber, sNMPTrapVersion=sNMPTrapVersion, sMTPEmailAlert=sMTPEmailAlert, ptpTraps=ptpTraps, hTTPAccessEnabled=hTTPAccessEnabled, transmitDataRate=transmitDataRate, bandwidthVariant=bandwidthVariant, altitude=altitude, transmitFreqMHz=transmitFreqMHz, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortStatus=dataPortStatus, syslogClientTrap=syslogClientTrap, cableLoss=cableLoss, sNMPTrapTableEntry=sNMPTrapTableEntry, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, installStatus=installStatus, vLANManagementPriority=vLANManagementPriority, tFTPServerPortNumber=tFTPServerPortNumber, receivePower=receivePower, vLANPriorityQueueMapping=vLANPriorityQueueMapping, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPSync=sNTPSync, dfsGroup=dfsGroup, transmitPower=transmitPower, systemClock=systemClock, targetMACAddress=targetMACAddress, syslogState=syslogState, frequencyVariant=frequencyVariant, aAAControl=aAAControl, supplementary=supplementary, telecom=telecom, aggregateDataRate=aggregateDataRate, notificationsGroup=notificationsGroup, vLANPriorityTable=vLANPriorityTable, sMTPServerIPAddress=sMTPServerIPAddress, ptmp=ptmp, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, telnetAccessEnabled=telnetAccessEnabled, unitOutOfCalibration=unitOutOfCalibration, gatewayIPAddress=gatewayIPAddress, userName=userName, byteErrorRatio=byteErrorRatio, telnetPortNumber=telnetPortNumber, receiveChannel=receiveChannel, sMTPSourceEmailAddress=sMTPSourceEmailAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sntp=sntp, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, userTableNumber=userTableNumber, receiveDataRate=receiveDataRate, pubStats=pubStats, hTTPSPortNumber=hTTPSPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortConfigurationMismatch=dataPortConfigurationMismatch, bootVersion=bootVersion, daylightSaving=daylightSaving, longitude=longitude, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, configuration=configuration, groupID=groupID, secondarySoftwareVersion=secondarySoftwareVersion, ptpCompliance=ptpCompliance, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, incompatibleRegionCodes=incompatibleRegionCodes, licenceGroup=licenceGroup, subnetMask=subnetMask, sNMPTrapTable=sNMPTrapTable, receiveModulationMode=receiveModulationMode, snmpControlGroup=snmpControlGroup, aAAControlGroup=aAAControlGroup, receiveFreqKHz=receiveFreqKHz, linkModeOptimisation=linkModeOptimisation, phyStatusGroup=phyStatusGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, sntpGroup=sntpGroup, masterSlaveMode=masterSlaveMode, productVariant=productVariant, cambium=cambium, maximumTransmitPower=maximumTransmitPower, wirelessLinkAvailability=wirelessLinkAvailability, dfsPeaks=dfsPeaks, searchState=searchState, smtpGroup=smtpGroup, siteName=siteName, pubStatsGroup=pubStatsGroup, ethernetFiberSupport=ethernetFiberSupport, dataPortAutoNegotiation=dataPortAutoNegotiation, sMTPEnabledMessages=sMTPEnabledMessages, sNTPSyncTrap=sNTPSyncTrap, channelBandwidth=channelBandwidth, receiveModulationModeDetail=receiveModulationModeDetail, eIRP=eIRP, vectorError=vectorError, userRole=userRole, syslogClient=syslogClient, userPassword=userPassword, tDDSynchronizationAlarm=tDDSynchronizationAlarm, versions=versions, linkSymmetry=linkSymmetry, phyStatus=phyStatus, ethernetGroup=ethernetGroup, timeZone=timeZone, telecomsCableLength=telecomsCableLength, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, vLANPriorityTableIndex=vLANPriorityTableIndex, antennaGain=antennaGain, regionCodeTrap=regionCodeTrap, resetGroup=resetGroup, channelChangeTrap=channelChangeTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, dfsTable=dfsTable, transmitFreqKHz=transmitFreqKHz, remoteMaximumTransmitPower=remoteMaximumTransmitPower, PYSNMP_MODULE_ID=cambium, dataPortDisabledWarning=dataPortDisabledWarning, sNMPv3Enable=sNMPv3Enable, vLANPriorityTableEntry=vLANPriorityTableEntry, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, snmpControl=snmpControl, userTableIndex=userTableIndex, reset=reset, accessMethod=accessMethod, sNTPState=sNTPState, userTableEntry=userTableEntry, telecomsChannelStatus=telecomsChannelStatus, phyControlGroup=phyControlGroup, transmitModulationMode=transmitModulationMode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement)
