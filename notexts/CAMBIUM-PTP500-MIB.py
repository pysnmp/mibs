...
# Produced by pysmi-1.1.3 at Sun Nov 28 17:06:24 2021
...
Bits, Integer32, MibIdentifier, Gauge32, ModuleIdentity, Unsigned32, Counter32, ObjectIdentity, IpAddress, enterprises, Counter64, TimeTicks, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Integer32", "MibIdentifier", "Gauge32", "ModuleIdentity", "Unsigned32", "Counter32", "ObjectIdentity", "IpAddress", "enterprises", "Counter64", "TimeTicks", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", subnetMask=subnetMask, installArmStateTrap=installArmStateTrap, telecomGroup=telecomGroup, bootVersion=bootVersion, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dataPortAutoMdix=dataPortAutoMdix, licenceGroup=licenceGroup, transmitModulationMode=transmitModulationMode, hTTPAccessEnabled=hTTPAccessEnabled, management=management, sNMPCommunityString=sNMPCommunityString, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, maximumTransmitPower=maximumTransmitPower, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, syslogLocalWrappedTrap=syslogLocalWrappedTrap, daylightSaving=daylightSaving, telnetPortNumber=telnetPortNumber, snmpControl=snmpControl, dfsMeans=dfsMeans, dataPortWirelessDownAlert=dataPortWirelessDownAlert, vLANManagementPriority=vLANManagementPriority, vLANPriorityTableNumber=vLANPriorityTableNumber, sMTPEmailAlert=sMTPEmailAlert, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, userTableEntry=userTableEntry, notificationsGroup=notificationsGroup, vLANPriorityTable=vLANPriorityTable, ptp500=ptp500, telecomsInterface=telecomsInterface, frequencyVariant=frequencyVariant, sNTPServerIPAddress=sNTPServerIPAddress, sNTPSyncTrap=sNTPSyncTrap, PYSNMP_MODULE_ID=cambium, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, phyStatus=phyStatus, sNTPPollInterval=sNTPPollInterval, aAAControl=aAAControl, phyStatusGroup=phyStatusGroup, licence=licence, linkModeOptimisation=linkModeOptimisation, hTTPSPortNumber=hTTPSPortNumber, aAAControlGroup=aAAControlGroup, receiveModulationMode=receiveModulationMode, sntpGroup=sntpGroup, sNTPSync=sNTPSync, channelBandwidth=channelBandwidth, userTableIndex=userTableIndex, pubStatsGroup=pubStatsGroup, linkSymmetry=linkSymmetry, siteName=siteName, sNMPTrapTableEntry=sNMPTrapTableEntry, syslogClientTrap=syslogClientTrap, receiveFreqKHz=receiveFreqKHz, unitOutOfCalibration=unitOutOfCalibration, sNMPEnabledTraps=sNMPEnabledTraps, productVariant=productVariant, smtpGroup=smtpGroup, syslogControlGroup=syslogControlGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, vLANPriorityTableEntry=vLANPriorityTableEntry, noWirelessChannelAvailable=noWirelessChannelAvailable, installStatus=installStatus, wirelessLinkStatus=wirelessLinkStatus, sNMPv3Enable=sNMPv3Enable, iPAddress=iPAddress, alarms=alarms, supplementary=supplementary, telnetAccessEnabled=telnetAccessEnabled, transmitFreqKHz=transmitFreqKHz, syslogControl=syslogControl, configuration=configuration, ptpGroups=ptpGroups, telecom=telecom, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, longitude=longitude, linkName=linkName, dataPortAutoNegotiation=dataPortAutoNegotiation, phyControl=phyControl, resetGroup=resetGroup, userPassword=userPassword, dataPortStatusTrap=dataPortStatusTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, receiveModulationModeDetail=receiveModulationModeDetail, sNTPServerPortNumber=sNTPServerPortNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ptmp=ptmp, sMTPSourceEmailAddress=sMTPSourceEmailAddress, antennaGain=antennaGain, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sntp=sntp, tDDControlGroup=tDDControlGroup, encryptionGroup=encryptionGroup, dfsTableNumber=dfsTableNumber, phyControlGroup=phyControlGroup, dfsTableIndex=dfsTableIndex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dfsGroup=dfsGroup, masterSlaveMode=masterSlaveMode, tDDSynchronizationAlarm=tDDSynchronizationAlarm, capacityLicenseMismatch=capacityLicenseMismatch, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, remoteMaximumTransmitPower=remoteMaximumTransmitPower, receiveChannel=receiveChannel, timeZone=timeZone, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, channelChangeTrap=channelChangeTrap, syslogState=syslogState, telecomsCableLength=telecomsCableLength, alarmsGroup=alarmsGroup, linkLoss=linkLoss, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dfsPeaks=dfsPeaks, dataPortStatus=dataPortStatus, transmitPower=transmitPower, sNTPState=sNTPState, aggregateDataRate=aggregateDataRate, byteErrorRatio=byteErrorRatio, sMTPServerIPAddress=sMTPServerIPAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, userName=userName, vLANPriorityQueueMapping=vLANPriorityQueueMapping, tDDSynchronizationMode=tDDSynchronizationMode, telecomsChannelStatus=telecomsChannelStatus, softwareVersion=softwareVersion, hTTPPortNumber=hTTPPortNumber, vectorError=vectorError, dfs=dfs, installArmState=installArmState, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, ptpTrapPrefix=ptpTrapPrefix, syslogClient=syslogClient, userEnabled=userEnabled, reset=reset, userTableNumber=userTableNumber, supplementaryGroup=supplementaryGroup, gatewayIPAddress=gatewayIPAddress, wirelessLinkAvailability=wirelessLinkAvailability, systemClock=systemClock, tFTPServerIPAddress=tFTPServerIPAddress, latitude=latitude, regionCodeTrap=regionCodeTrap, sNMPTrapTable=sNMPTrapTable, ptp=ptp, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ethernetFiberSupport=ethernetFiberSupport, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, signalStrengthRatio=signalStrengthRatio, tFTPServerPortNumber=tFTPServerPortNumber, licensedCapacity=licensedCapacity, telecomsLineCode=telecomsLineCode, ptpTraps=ptpTraps, sMTPServerPortNumber=sMTPServerPortNumber, eIRP=eIRP, sNTPLastSync=sNTPLastSync, encryptionAlgorithm=encryptionAlgorithm, vLANPriorityTableIndex=vLANPriorityTableIndex, encryption=encryption, cableLoss=cableLoss, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, range=range, managementGroup=managementGroup, bandwidthVariant=bandwidthVariant, smtp=smtp, targetMACAddress=targetMACAddress, installStatusTrap=installStatusTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, versions=versions, tDDSynchronizationStatus=tDDSynchronizationStatus, dfsTable=dfsTable, accessMethod=accessMethod, receiveFreqMHz=receiveFreqMHz, sMTPEnabledMessages=sMTPEnabledMessages, snmpControlGroup=snmpControlGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, transmitDataRate=transmitDataRate, systemReset=systemReset, searchState=searchState, secondarySoftwareVersion=secondarySoftwareVersion, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dataPortDisabledWarning=dataPortDisabledWarning, groupID=groupID, pubStats=pubStats, transmitFreqMHz=transmitFreqMHz, hardwareVersion=hardwareVersion, altitude=altitude, dataPortConfigurationMismatch=dataPortConfigurationMismatch, syslogStateTrap=syslogStateTrap, telecomsLoopback=telecomsLoopback, ethernet=ethernet, versionsGroup=versionsGroup, regionCode=regionCode, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ethernetGroup=ethernetGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, vLANManagementVID=vLANManagementVID, cambium=cambium, transmitChannel=transmitChannel, dfsTableEntry=dfsTableEntry, incompatibleRegionCodes=incompatibleRegionCodes, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNMPPortNumber=sNMPPortNumber, userRole=userRole, ptpCompliance=ptpCompliance, productName=productName, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, receivePower=receivePower, receiveDataRate=receiveDataRate, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, userTable=userTable, configurationGroup=configurationGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, remoteIPAddress=remoteIPAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tDDControl=tDDControl, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPTrapVersion=sNMPTrapVersion)
