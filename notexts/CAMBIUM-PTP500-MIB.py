...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", maximumTransmitPower=maximumTransmitPower, dfsTableIndex=dfsTableIndex, eIRP=eIRP, iPAddress=iPAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, tDDSynchronizationAlarm=tDDSynchronizationAlarm, regionCodeTrap=regionCodeTrap, linkLoss=linkLoss, aggregateDataRate=aggregateDataRate, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, installStatus=installStatus, dfsMeans=dfsMeans, sMTPEnabledMessages=sMTPEnabledMessages, hTTPPortNumber=hTTPPortNumber, telecomsCableLength=telecomsCableLength, ptmp=ptmp, ptpTrapPrefix=ptpTrapPrefix, sMTPEmailAlert=sMTPEmailAlert, wirelessLinkAvailability=wirelessLinkAvailability, hTTPAccessEnabled=hTTPAccessEnabled, systemClock=systemClock, telecomsChannelStatusTrap=telecomsChannelStatusTrap, wirelessLinkStatus=wirelessLinkStatus, vLANPriorityTableIndex=vLANPriorityTableIndex, alarms=alarms, notificationsGroup=notificationsGroup, vLANPriorityTable=vLANPriorityTable, aAAControlGroup=aAAControlGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, accessMethod=accessMethod, sNMPTrapIPAddress=sNMPTrapIPAddress, ptpCompliance=ptpCompliance, pubStatsGroup=pubStatsGroup, syslogClientTrap=syslogClientTrap, productName=productName, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, encryptionGroup=encryptionGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, versionsGroup=versionsGroup, dataPortStatus=dataPortStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, productVariant=productVariant, userTableIndex=userTableIndex, telecomsLineCode=telecomsLineCode, encryption=encryption, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapTableIndex=sNMPTrapTableIndex, syslogStateTrap=syslogStateTrap, sNMPv3Enable=sNMPv3Enable, masterSlaveMode=masterSlaveMode, subnetMask=subnetMask, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, installArmStateTrap=installArmStateTrap, licensedCapacity=licensedCapacity, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPServerIPAddress=sNTPServerIPAddress, remoteIPAddress=remoteIPAddress, telecomsLoopback=telecomsLoopback, altitude=altitude, unitOutOfCalibration=unitOutOfCalibration, hTTPSAccessEnabled=hTTPSAccessEnabled, constantPowerSpectralDensity=constantPowerSpectralDensity, frequencyVariant=frequencyVariant, syslogClient=syslogClient, sNMPPortNumber=sNMPPortNumber, longitude=longitude, dfsGroup=dfsGroup, telecomsLoopbackTrap=telecomsLoopbackTrap, range=range, vLANPriorityQueueMapping=vLANPriorityQueueMapping, receiveFreqMHz=receiveFreqMHz, dataPortDisabledWarning=dataPortDisabledWarning, signalStrengthRatio=signalStrengthRatio, syslogControlGroup=syslogControlGroup, byteErrorRatio=byteErrorRatio, gatewayIPAddress=gatewayIPAddress, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, smtpGroup=smtpGroup, userTableNumber=userTableNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, targetMACAddress=targetMACAddress, supplementary=supplementary, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ptpTraps=ptpTraps, dfsTableNumber=dfsTableNumber, vectorError=vectorError, capacityLicenseMismatch=capacityLicenseMismatch, sMTPSourceEmailAddress=sMTPSourceEmailAddress, groupID=groupID, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, softwareVersion=softwareVersion, sNTPPollInterval=sNTPPollInterval, ptp500=ptp500, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, secondarySoftwareVersion=secondarySoftwareVersion, tFTPServerPortNumber=tFTPServerPortNumber, vLANManagementPriority=vLANManagementPriority, vLANPriorityTableNumber=vLANPriorityTableNumber, regionCode=regionCode, transmitFreqKHz=transmitFreqKHz, syslogState=syslogState, transmitChannel=transmitChannel, smtp=smtp, cambium=cambium, sNTPServerPortNumber=sNTPServerPortNumber, sNTPLastSync=sNTPLastSync, transmitModulationMode=transmitModulationMode, sMTPServerIPAddress=sMTPServerIPAddress, vLANManagementVID=vLANManagementVID, phyControl=phyControl, telecomsInterface=telecomsInterface, snmpControlGroup=snmpControlGroup, configurationGroup=configurationGroup, sNTPSyncTrap=sNTPSyncTrap, ethernet=ethernet, telecom=telecom, sNMPTrapTable=sNMPTrapTable, telnetAccessEnabled=telnetAccessEnabled, linkSymmetry=linkSymmetry, dfsTable=dfsTable, phyControlGroup=phyControlGroup, installStatusTrap=installStatusTrap, userPassword=userPassword, receiveDataRate=receiveDataRate, searchState=searchState, PYSNMP_MODULE_ID=cambium, channelChangeTrap=channelChangeTrap, licence=licence, incompatibleMasterAndSlave=incompatibleMasterAndSlave, remoteMaximumTransmitPower=remoteMaximumTransmitPower, receiveModulationMode=receiveModulationMode, dfsTableEntry=dfsTableEntry, userTable=userTable, tDDControlGroup=tDDControlGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, licenceGroup=licenceGroup, receiveFreqKHz=receiveFreqKHz, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sntpGroup=sntpGroup, channelBandwidth=channelBandwidth, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ethernetFiberSupport=ethernetFiberSupport, noWirelessChannelAvailable=noWirelessChannelAvailable, managementGroup=managementGroup, systemReset=systemReset, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, installArmState=installArmState, receiveChannel=receiveChannel, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapPortNumber=sNMPTrapPortNumber, versions=versions, dfs=dfs, ptpGroups=ptpGroups, hTTPSPortNumber=hTTPSPortNumber, ethernetGroup=ethernetGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, hardwareVersion=hardwareVersion, transmitPower=transmitPower, phyStatus=phyStatus, tDDSynchronizationMode=tDDSynchronizationMode, receivePower=receivePower, syslogControl=syslogControl, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, linkModeOptimisation=linkModeOptimisation, sNTPState=sNTPState, receiveModulationModeDetail=receiveModulationModeDetail, bandwidthVariant=bandwidthVariant, telecomGroup=telecomGroup, dataPortStatusTrap=dataPortStatusTrap, transmitFreqMHz=transmitFreqMHz, daylightSaving=daylightSaving, reset=reset, phyStatusGroup=phyStatusGroup, telecomsChannelStatus=telecomsChannelStatus, tFTPServerIPAddress=tFTPServerIPAddress, incompatibleRegionCodes=incompatibleRegionCodes, sNMPEnabledTraps=sNMPEnabledTraps, transmitDataRate=transmitDataRate, sNMPTrapVersion=sNMPTrapVersion, latitude=latitude, userName=userName, sntp=sntp, pubStats=pubStats, telnetPortNumber=telnetPortNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, timeZone=timeZone, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, encryptionAlgorithm=encryptionAlgorithm, sMTPServerPortNumber=sMTPServerPortNumber, configuration=configuration, linkName=linkName, management=management, resetGroup=resetGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, bootVersion=bootVersion, userRole=userRole, userEnabled=userEnabled, dfsPeaks=dfsPeaks, alarmsGroup=alarmsGroup, siteName=siteName, tDDControl=tDDControl, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, dataPortAutoMdix=dataPortAutoMdix, ptp=ptp, cableLoss=cableLoss, supplementaryGroup=supplementaryGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNTPSync=sNTPSync, aAAControl=aAAControl, snmpControl=snmpControl, userTableEntry=userTableEntry, antennaGain=antennaGain, sNMPCommunityString=sNMPCommunityString)
