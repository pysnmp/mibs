...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", hTTPAccessEnabled=hTTPAccessEnabled, supplementary=supplementary, ptpGroups=ptpGroups, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPTrapPortNumber=sNMPTrapPortNumber, sntp=sntp, byteErrorRatio=byteErrorRatio, syslogState=syslogState, phyControl=phyControl, encryptionAlgorithm=encryptionAlgorithm, dataPortStatusTrap=dataPortStatusTrap, sNMPTrapVersion=sNMPTrapVersion, sNMPPortNumber=sNMPPortNumber, altitude=altitude, PYSNMP_MODULE_ID=cambium, tDDSynchronizationStatus=tDDSynchronizationStatus, userName=userName, softwareVersion=softwareVersion, telecomGroup=telecomGroup, timeZone=timeZone, sMTPSourceEmailAddress=sMTPSourceEmailAddress, phyStatus=phyStatus, ethernetGroup=ethernetGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, managementGroup=managementGroup, regionCodeTrap=regionCodeTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ptpCompliance=ptpCompliance, sntpGroup=sntpGroup, reset=reset, receiveDataRate=receiveDataRate, userTableEntry=userTableEntry, enabledDiagnosticAlarms=enabledDiagnosticAlarms, vectorError=vectorError, sNTPSync=sNTPSync, receivePower=receivePower, hardwareVersion=hardwareVersion, vLANPriorityTableNumber=vLANPriorityTableNumber, bandwidthVariant=bandwidthVariant, telecomsInterface=telecomsInterface, aggregateDataRate=aggregateDataRate, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, phyStatusGroup=phyStatusGroup, transmitChannel=transmitChannel, noWirelessChannelAvailable=noWirelessChannelAvailable, userTableIndex=userTableIndex, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, installArmState=installArmState, sNMPEnabledTraps=sNMPEnabledTraps, latitude=latitude, notificationsGroup=notificationsGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, receiveFreqKHz=receiveFreqKHz, versions=versions, dfsTableIndex=dfsTableIndex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPServerIPAddress=sNTPServerIPAddress, tDDSynchronizationAlarm=tDDSynchronizationAlarm, unitOutOfCalibration=unitOutOfCalibration, telecomsCableLength=telecomsCableLength, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, transmitPower=transmitPower, phyControlGroup=phyControlGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, incompatibleRegionCodes=incompatibleRegionCodes, systemClock=systemClock, sNTPPollInterval=sNTPPollInterval, systemReset=systemReset, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, constantPowerSpectralDensity=constantPowerSpectralDensity, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tFTPServerPortNumber=tFTPServerPortNumber, supplementaryGroup=supplementaryGroup, syslogStateTrap=syslogStateTrap, sNMPTrapTable=sNMPTrapTable, telecomsLineCode=telecomsLineCode, syslogClient=syslogClient, smtp=smtp, hTTPPortNumber=hTTPPortNumber, capacityLicenseMismatch=capacityLicenseMismatch, linkLoss=linkLoss, bootVersion=bootVersion, transmitFreqKHz=transmitFreqKHz, productName=productName, transmitModulationMode=transmitModulationMode, pubStats=pubStats, frequencyVariant=frequencyVariant, dataPortDisabledWarning=dataPortDisabledWarning, vLANPriorityTable=vLANPriorityTable, eIRP=eIRP, wirelessLinkStatus=wirelessLinkStatus, ptpTraps=ptpTraps, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, siteName=siteName, sNMPv3Enable=sNMPv3Enable, linkSymmetry=linkSymmetry, masterSlaveMode=masterSlaveMode, tDDSynchronizationMode=tDDSynchronizationMode, userEnabled=userEnabled, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sMTPEmailAlert=sMTPEmailAlert, channelChangeTrap=channelChangeTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, ptp500=ptp500, hTTPSPortNumber=hTTPSPortNumber, receiveModulationMode=receiveModulationMode, configuration=configuration, aAAControlGroup=aAAControlGroup, longitude=longitude, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNMPCommunityString=sNMPCommunityString, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sMTPServerIPAddress=sMTPServerIPAddress, antennaGain=antennaGain, secondarySoftwareVersion=secondarySoftwareVersion, tDDControl=tDDControl, wirelessLinkAvailability=wirelessLinkAvailability, ethernet=ethernet, snmpControl=snmpControl, groupID=groupID, vLANManagementPriority=vLANManagementPriority, subnetMask=subnetMask, incompatibleMasterAndSlave=incompatibleMasterAndSlave, licensedCapacity=licensedCapacity, sNMPTrapTableEntry=sNMPTrapTableEntry, ptp=ptp, transmitDataRate=transmitDataRate, telecomsChannelStatus=telecomsChannelStatus, cableLoss=cableLoss, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, receiveFreqMHz=receiveFreqMHz, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNTPLastSync=sNTPLastSync, range=range, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, syslogControlGroup=syslogControlGroup, pubStatsGroup=pubStatsGroup, encryptionGroup=encryptionGroup, iPAddress=iPAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, telecom=telecom, syslogLocalWrappedTrap=syslogLocalWrappedTrap, channelBandwidth=channelBandwidth, telecomsLoopback=telecomsLoopback, installStatus=installStatus, vLANManagementVID=vLANManagementVID, userRole=userRole, alarms=alarms, dfsTableNumber=dfsTableNumber, userPassword=userPassword, sNMPTrapTableIndex=sNMPTrapTableIndex, licenceGroup=licenceGroup, dfsMeans=dfsMeans, sMTPEnabledMessages=sMTPEnabledMessages, licence=licence, configurationGroup=configurationGroup, telnetPortNumber=telnetPortNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, aAAControl=aAAControl, dfsTable=dfsTable, dfsTableEntry=dfsTableEntry, dfsPeaks=dfsPeaks, signalStrengthRatio=signalStrengthRatio, searchState=searchState, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, smtpGroup=smtpGroup, sNTPState=sNTPState, syslogClientTrap=syslogClientTrap, linkModeOptimisation=linkModeOptimisation, dfsGroup=dfsGroup, gatewayIPAddress=gatewayIPAddress, versionsGroup=versionsGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, encryption=encryption, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPSyncTrap=sNTPSyncTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, installStatusTrap=installStatusTrap, tFTPServerIPAddress=tFTPServerIPAddress, resetGroup=resetGroup, installArmStateTrap=installArmStateTrap, userTable=userTable, receiveChannel=receiveChannel, productVariant=productVariant, ptpTrapPrefix=ptpTrapPrefix, maximumTransmitPower=maximumTransmitPower, telecomsLoopbackTrap=telecomsLoopbackTrap, cambium=cambium, management=management, sMTPServerPortNumber=sMTPServerPortNumber, remoteIPAddress=remoteIPAddress, dfs=dfs, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, tDDControlGroup=tDDControlGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, targetMACAddress=targetMACAddress, alarmsGroup=alarmsGroup, ptmp=ptmp, dataPortAutoMdix=dataPortAutoMdix, accessMethod=accessMethod, ethernetFiberSupport=ethernetFiberSupport, daylightSaving=daylightSaving, sNTPServerPortNumber=sNTPServerPortNumber, receiveModulationModeDetail=receiveModulationModeDetail, snmpControlGroup=snmpControlGroup, syslogControl=syslogControl, dataPortStatus=dataPortStatus, telnetAccessEnabled=telnetAccessEnabled, transmitFreqMHz=transmitFreqMHz, regionCode=regionCode, userTableNumber=userTableNumber, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sNMPTrapTableNumber=sNMPTrapTableNumber, linkName=linkName, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement)
