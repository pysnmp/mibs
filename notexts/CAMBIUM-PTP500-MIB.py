...
# Produced by pysmi-1.1.8 at Thu Jan 13 23:38:04 2022
...
TimeTicks, enterprises, Counter32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity, Counter64, Gauge32, NotificationType, IpAddress, Bits, ObjectIdentity, Unsigned32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "enterprises", "Counter32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity", "Counter64", "Gauge32", "NotificationType", "IpAddress", "Bits", "ObjectIdentity", "Unsigned32", "iso")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", syslogClient=syslogClient, receiveModulationMode=receiveModulationMode, receivePower=receivePower, enabledDiagnosticAlarms=enabledDiagnosticAlarms, linkSymmetry=linkSymmetry, userRole=userRole, channelBandwidth=channelBandwidth, siteName=siteName, sNMPTrapTableNumber=sNMPTrapTableNumber, tDDSynchronizationMode=tDDSynchronizationMode, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, frequencyVariant=frequencyVariant, transmitModulationMode=transmitModulationMode, altitude=altitude, softwareVersion=softwareVersion, maximumTransmitPower=maximumTransmitPower, managementGroup=managementGroup, sMTPEmailAlert=sMTPEmailAlert, ptpGroups=ptpGroups, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptpTrapPrefix=ptpTrapPrefix, phyControlGroup=phyControlGroup, sNMPv3Enable=sNMPv3Enable, vectorError=vectorError, timeZone=timeZone, userPassword=userPassword, remoteIPAddress=remoteIPAddress, secondarySoftwareVersion=secondarySoftwareVersion, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, sNTPState=sNTPState, ptp500=ptp500, installStatus=installStatus, userTableIndex=userTableIndex, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapTable=sNMPTrapTable, telecomsLoopbackTrap=telecomsLoopbackTrap, encryption=encryption, encryptionGroup=encryptionGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, aggregateDataRate=aggregateDataRate, versionsGroup=versionsGroup, versions=versions, sNTPPollInterval=sNTPPollInterval, alarmsGroup=alarmsGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sMTPServerPortNumber=sMTPServerPortNumber, latitude=latitude, snmpControl=snmpControl, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPSync=sNTPSync, vLANPriorityTable=vLANPriorityTable, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, PYSNMP_MODULE_ID=cambium, productName=productName, unitOutOfCalibration=unitOutOfCalibration, incompatibleRegionCodes=incompatibleRegionCodes, tDDSynchronizationStatus=tDDSynchronizationStatus, licenceGroup=licenceGroup, dfsGroup=dfsGroup, daylightSaving=daylightSaving, supplementaryGroup=supplementaryGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, management=management, searchState=searchState, dfs=dfs, dataPortDisabledWarning=dataPortDisabledWarning, masterSlaveMode=masterSlaveMode, vLANManagementVID=vLANManagementVID, syslogClientTrap=syslogClientTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, pubStatsGroup=pubStatsGroup, notificationsGroup=notificationsGroup, installStatusTrap=installStatusTrap, telecomGroup=telecomGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, capacityLicenseMismatch=capacityLicenseMismatch, userTableNumber=userTableNumber, smtpGroup=smtpGroup, sNTPServerIPAddress=sNTPServerIPAddress, sNTPLastSync=sNTPLastSync, transmitChannel=transmitChannel, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, hTTPAccessEnabled=hTTPAccessEnabled, dfsTableIndex=dfsTableIndex, subnetMask=subnetMask, hardwareVersion=hardwareVersion, phyStatus=phyStatus, ethernetFiberSupport=ethernetFiberSupport, tFTPServerPortNumber=tFTPServerPortNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, phyStatusGroup=phyStatusGroup, receiveDataRate=receiveDataRate, iPAddress=iPAddress, installArmState=installArmState, transmitPower=transmitPower, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPTrapTableEntry=sNMPTrapTableEntry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, systemReset=systemReset, snmpControlGroup=snmpControlGroup, vLANManagementPriority=vLANManagementPriority, tFTPServerIPAddress=tFTPServerIPAddress, wirelessLinkAvailability=wirelessLinkAvailability, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, ptpTraps=ptpTraps, signalStrengthRatio=signalStrengthRatio, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, gatewayIPAddress=gatewayIPAddress, hTTPSPortNumber=hTTPSPortNumber, cableLoss=cableLoss, smtp=smtp, receiveChannel=receiveChannel, wirelessLinkStatus=wirelessLinkStatus, syslogControlGroup=syslogControlGroup, sNMPEnabledTraps=sNMPEnabledTraps, transmitFreqKHz=transmitFreqKHz, configurationGroup=configurationGroup, receiveModulationModeDetail=receiveModulationModeDetail, ptp=ptp, sMTPSourceEmailAddress=sMTPSourceEmailAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, encryptionAlgorithm=encryptionAlgorithm, linkLoss=linkLoss, hTTPSAccessEnabled=hTTPSAccessEnabled, telnetPortNumber=telnetPortNumber, dataPortStatusTrap=dataPortStatusTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, installArmStateTrap=installArmStateTrap, sntp=sntp, sntpGroup=sntpGroup, syslogStateTrap=syslogStateTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, linkName=linkName, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, telecomsCableLength=telecomsCableLength, groupID=groupID, linkModeOptimisation=linkModeOptimisation, pubStats=pubStats, dfsPeaks=dfsPeaks, tDDControl=tDDControl, licensedCapacity=licensedCapacity, telecomsLineCode=telecomsLineCode, sNMPTrapIPAddress=sNMPTrapIPAddress, aAAControl=aAAControl, dataPortAutoMdix=dataPortAutoMdix, userName=userName, systemClock=systemClock, telecomsChannelStatusTrap=telecomsChannelStatusTrap, antennaGain=antennaGain, alarms=alarms, hTTPPortNumber=hTTPPortNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, licence=licence, telecomsChannelStatus=telecomsChannelStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, channelChangeTrap=channelChangeTrap, regionCodeTrap=regionCodeTrap, receiveFreqMHz=receiveFreqMHz, syslogControl=syslogControl, dfsTableNumber=dfsTableNumber, dfsMeans=dfsMeans, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dfsTable=dfsTable, aAAControlGroup=aAAControlGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, range=range, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, regionCode=regionCode, dataPortStatus=dataPortStatus, transmitFreqMHz=transmitFreqMHz, accessMethod=accessMethod, sNMPPortNumber=sNMPPortNumber, resetGroup=resetGroup, supplementary=supplementary, ptmp=ptmp, ptpCompliance=ptpCompliance, telnetAccessEnabled=telnetAccessEnabled, tDDSynchronizationAlarm=tDDSynchronizationAlarm, transmitDataRate=transmitDataRate, tDDControlGroup=tDDControlGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ethernetGroup=ethernetGroup, byteErrorRatio=byteErrorRatio, sNMPCommunityString=sNMPCommunityString, longitude=longitude, userTable=userTable, syslogState=syslogState, targetMACAddress=targetMACAddress, userTableEntry=userTableEntry, productVariant=productVariant, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNTPSyncTrap=sNTPSyncTrap, userEnabled=userEnabled, bootVersion=bootVersion, reset=reset, telecomsLoopback=telecomsLoopback, receiveFreqKHz=receiveFreqKHz, configuration=configuration, phyControl=phyControl, dfsTableEntry=dfsTableEntry, sNMPTrapVersion=sNMPTrapVersion, eIRP=eIRP, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ethernet=ethernet, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPServerIPAddress=sMTPServerIPAddress, cambium=cambium, telecom=telecom, sNTPServerPortNumber=sNTPServerPortNumber, telecomsInterface=telecomsInterface, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, bandwidthVariant=bandwidthVariant)
