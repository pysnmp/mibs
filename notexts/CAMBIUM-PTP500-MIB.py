...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", hTTPSPortNumber=hTTPSPortNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfsPeaks=dfsPeaks, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, transmitModulationMode=transmitModulationMode, encryptionGroup=encryptionGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, transmitFreqMHz=transmitFreqMHz, notificationsGroup=notificationsGroup, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, unitOutOfCalibration=unitOutOfCalibration, latitude=latitude, ethernet=ethernet, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, transmitChannel=transmitChannel, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, receiveModulationModeDetail=receiveModulationModeDetail, telecomGroup=telecomGroup, linkSymmetry=linkSymmetry, range=range, dataPortAutoNegotiation=dataPortAutoNegotiation, timeZone=timeZone, accessMethod=accessMethod, dataPortStatusTrap=dataPortStatusTrap, dataPortAutoMdix=dataPortAutoMdix, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, phyStatus=phyStatus, sNTPSync=sNTPSync, productVariant=productVariant, tFTPServerPortNumber=tFTPServerPortNumber, transmitDataRate=transmitDataRate, tFTPServerIPAddress=tFTPServerIPAddress, syslogClientTrap=syslogClientTrap, smtpGroup=smtpGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, vLANManagementVID=vLANManagementVID, sNMPv3Enable=sNMPv3Enable, installStatus=installStatus, altitude=altitude, userTableEntry=userTableEntry, telnetAccessEnabled=telnetAccessEnabled, dfs=dfs, snmpControlGroup=snmpControlGroup, dfsGroup=dfsGroup, receiveFreqKHz=receiveFreqKHz, searchState=searchState, tDDControl=tDDControl, configurationGroup=configurationGroup, aAAControlGroup=aAAControlGroup, bandwidthVariant=bandwidthVariant, syslogClient=syslogClient, transmitPower=transmitPower, syslogLocalWrappedTrap=syslogLocalWrappedTrap, supplementaryGroup=supplementaryGroup, userTableNumber=userTableNumber, transmitFreqKHz=transmitFreqKHz, licence=licence, installArmState=installArmState, dataPortDisabledWarning=dataPortDisabledWarning, sNTPServerPortNumber=sNTPServerPortNumber, receiveDataRate=receiveDataRate, userPassword=userPassword, installArmStateTrap=installArmStateTrap, wirelessLinkStatus=wirelessLinkStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, eIRP=eIRP, encryptionAlgorithm=encryptionAlgorithm, sNMPCommunityString=sNMPCommunityString, dfsTableIndex=dfsTableIndex, aggregateDataRate=aggregateDataRate, dfsMeans=dfsMeans, alarms=alarms, sNTPLastSync=sNTPLastSync, iPAddress=iPAddress, incompatibleMasterAndSlave=incompatibleMasterAndSlave, vectorError=vectorError, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, syslogControlGroup=syslogControlGroup, cambium=cambium, phyStatusGroup=phyStatusGroup, userEnabled=userEnabled, resetGroup=resetGroup, receivePower=receivePower, hTTPAccessEnabled=hTTPAccessEnabled, telecomsLoopback=telecomsLoopback, ptp=ptp, ethernetGroup=ethernetGroup, secondarySoftwareVersion=secondarySoftwareVersion, remoteIPAddress=remoteIPAddress, alarmsGroup=alarmsGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, channelChangeTrap=channelChangeTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPServerIPAddress=sNTPServerIPAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, syslogState=syslogState, dfsTableEntry=dfsTableEntry, tDDSynchronizationMode=tDDSynchronizationMode, regionCodeTrap=regionCodeTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, encryption=encryption, ptpTraps=ptpTraps, PYSNMP_MODULE_ID=cambium, subnetMask=subnetMask, sNMPTrapTable=sNMPTrapTable, ptpCompliance=ptpCompliance, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, channelBandwidth=channelBandwidth, receiveModulationMode=receiveModulationMode, versionsGroup=versionsGroup, sNMPPortNumber=sNMPPortNumber, vLANManagementPriority=vLANManagementPriority, hTTPPortNumber=hTTPPortNumber, sMTPServerIPAddress=sMTPServerIPAddress, capacityLicenseMismatch=capacityLicenseMismatch, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPEnabledTraps=sNMPEnabledTraps, receiveFreqMHz=receiveFreqMHz, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, management=management, phyControl=phyControl, systemReset=systemReset, maximumTransmitPower=maximumTransmitPower, dfsTable=dfsTable, pubStatsGroup=pubStatsGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sntpGroup=sntpGroup, versions=versions, constantPowerSpectralDensity=constantPowerSpectralDensity, receiveChannel=receiveChannel, enabledDiagnosticAlarms=enabledDiagnosticAlarms, bootVersion=bootVersion, ptpTrapPrefix=ptpTrapPrefix, groupID=groupID, telecomsChannelStatus=telecomsChannelStatus, userTableIndex=userTableIndex, sNMPTrapVersion=sNMPTrapVersion, userName=userName, telnetPortNumber=telnetPortNumber, signalStrengthRatio=signalStrengthRatio, aAAControl=aAAControl, daylightSaving=daylightSaving, sntp=sntp, vLANPriorityTableNumber=vLANPriorityTableNumber, phyControlGroup=phyControlGroup, regionCode=regionCode, incompatibleRegionCodes=incompatibleRegionCodes, longitude=longitude, linkModeOptimisation=linkModeOptimisation, vLANPriorityTableIndex=vLANPriorityTableIndex, targetMACAddress=targetMACAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, reset=reset, ethernetFiberSupport=ethernetFiberSupport, sMTPEnabledMessages=sMTPEnabledMessages, syslogControl=syslogControl, telecomsLineCode=telecomsLineCode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, gatewayIPAddress=gatewayIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, installStatusTrap=installStatusTrap, antennaGain=antennaGain, sNTPPollInterval=sNTPPollInterval, linkName=linkName, telecomsChannelStatusTrap=telecomsChannelStatusTrap, frequencyVariant=frequencyVariant, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, licensedCapacity=licensedCapacity, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dfsTableNumber=dfsTableNumber, vLANPriorityTable=vLANPriorityTable, pubStats=pubStats, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, cableLoss=cableLoss, configuration=configuration, sMTPEmailAlert=sMTPEmailAlert, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, smtp=smtp, ptpGroups=ptpGroups, hTTPSAccessEnabled=hTTPSAccessEnabled, snmpControl=snmpControl, telecomsInterface=telecomsInterface, tDDSynchronizationStatus=tDDSynchronizationStatus, ptmp=ptmp, syslogStateTrap=syslogStateTrap, systemClock=systemClock, byteErrorRatio=byteErrorRatio, telecomsLoopbackTrap=telecomsLoopbackTrap, userRole=userRole, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, linkLoss=linkLoss, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sNTPState=sNTPState, wirelessLinkAvailability=wirelessLinkAvailability, dataPortConfigurationMismatch=dataPortConfigurationMismatch, masterSlaveMode=masterSlaveMode, telecomsCableLength=telecomsCableLength, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tDDControlGroup=tDDControlGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, productName=productName, userTable=userTable, managementGroup=managementGroup, hardwareVersion=hardwareVersion, licenceGroup=licenceGroup, dataPortStatus=dataPortStatus, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, ptp500=ptp500, sMTPServerPortNumber=sMTPServerPortNumber, telecom=telecom, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPSyncTrap=sNTPSyncTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, softwareVersion=softwareVersion, supplementary=supplementary, siteName=siteName)
