...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", signalStrengthRatio=signalStrengthRatio, dfsTableNumber=dfsTableNumber, ptpTrapPrefix=ptpTrapPrefix, unitOutOfCalibration=unitOutOfCalibration, ethernetGroup=ethernetGroup, dfsMeans=dfsMeans, licenceGroup=licenceGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, receiveModulationModeDetail=receiveModulationModeDetail, byteErrorRatio=byteErrorRatio, snmpControl=snmpControl, latitude=latitude, sNMPTrapIPAddress=sNMPTrapIPAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogClientTrap=syslogClientTrap, sNTPSync=sNTPSync, channelChangeTrap=channelChangeTrap, alarms=alarms, aAAControl=aAAControl, smtpGroup=smtpGroup, sNTPLastSync=sNTPLastSync, syslogLocalWrappedTrap=syslogLocalWrappedTrap, productVariant=productVariant, receivePower=receivePower, siteName=siteName, regionCode=regionCode, transmitModulationMode=transmitModulationMode, installStatus=installStatus, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, userTableIndex=userTableIndex, antennaGain=antennaGain, ptpGroups=ptpGroups, receiveChannel=receiveChannel, dataPortConfigurationMismatch=dataPortConfigurationMismatch, vLANPriorityTable=vLANPriorityTable, tDDSynchronizationMode=tDDSynchronizationMode, sNMPTrapTableEntry=sNMPTrapTableEntry, aggregateDataRate=aggregateDataRate, linkLoss=linkLoss, syslogControlGroup=syslogControlGroup, dfsTable=dfsTable, dataPortStatus=dataPortStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tDDSynchronizationStatus=tDDSynchronizationStatus, secondarySoftwareVersion=secondarySoftwareVersion, sNTPSyncTrap=sNTPSyncTrap, managementGroup=managementGroup, ptpTraps=ptpTraps, receiveFreqMHz=receiveFreqMHz, searchState=searchState, sNTPServerIPAddress=sNTPServerIPAddress, wirelessLinkStatus=wirelessLinkStatus, resetGroup=resetGroup, encryptionGroup=encryptionGroup, sNTPState=sNTPState, regionCodeTrap=regionCodeTrap, ptmp=ptmp, telecomsLoopback=telecomsLoopback, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, remoteIPAddress=remoteIPAddress, configuration=configuration, notificationsGroup=notificationsGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNMPTrapTable=sNMPTrapTable, sntp=sntp, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, vLANPriorityTableEntry=vLANPriorityTableEntry, vLANPriorityQueueMapping=vLANPriorityQueueMapping, remoteMaximumTransmitPower=remoteMaximumTransmitPower, telnetPortNumber=telnetPortNumber, transmitPower=transmitPower, ptpCompliance=ptpCompliance, tDDControl=tDDControl, dataPortAutoNegotiation=dataPortAutoNegotiation, constantPowerSpectralDensity=constantPowerSpectralDensity, sNMPPortNumber=sNMPPortNumber, sMTPServerPortNumber=sMTPServerPortNumber, userTable=userTable, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, linkSymmetry=linkSymmetry, syslogStateTrap=syslogStateTrap, hTTPAccessEnabled=hTTPAccessEnabled, linkName=linkName, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, smtp=smtp, transmitFreqKHz=transmitFreqKHz, softwareVersion=softwareVersion, systemReset=systemReset, hTTPSPortNumber=hTTPSPortNumber, transmitChannel=transmitChannel, accessMethod=accessMethod, telecomsInterface=telecomsInterface, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, receiveModulationMode=receiveModulationMode, hTTPSAccessEnabled=hTTPSAccessEnabled, maximumTransmitPower=maximumTransmitPower, syslogClient=syslogClient, phyControlGroup=phyControlGroup, channelBandwidth=channelBandwidth, hTTPPortNumber=hTTPPortNumber, alarmsGroup=alarmsGroup, snmpControlGroup=snmpControlGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ethernet=ethernet, tFTPServerIPAddress=tFTPServerIPAddress, versionsGroup=versionsGroup, userPassword=userPassword, reset=reset, syslogControl=syslogControl, encryption=encryption, sMTPServerIPAddress=sMTPServerIPAddress, userTableNumber=userTableNumber, altitude=altitude, telecomsLoopbackTrap=telecomsLoopbackTrap, encryptionAlgorithm=encryptionAlgorithm, versions=versions, installArmState=installArmState, sNMPTrapVersion=sNMPTrapVersion, targetMACAddress=targetMACAddress, transmitFreqMHz=transmitFreqMHz, userName=userName, bandwidthVariant=bandwidthVariant, ptp=ptp, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, linkModeOptimizationMismatch=linkModeOptimizationMismatch, transmitDataRate=transmitDataRate, telecomsChannelStatus=telecomsChannelStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, vLANManagementVID=vLANManagementVID, dfsTableEntry=dfsTableEntry, management=management, hardwareVersion=hardwareVersion, sNMPCommunityString=sNMPCommunityString, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, licence=licence, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dfsGroup=dfsGroup, syslogState=syslogState, gatewayIPAddress=gatewayIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPv3Enable=sNMPv3Enable, range=range, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, telecomsCableLength=telecomsCableLength, installStatusTrap=installStatusTrap, masterSlaveMode=masterSlaveMode, dataPortDisabledWarning=dataPortDisabledWarning, longitude=longitude, vectorError=vectorError, bootVersion=bootVersion, sNTPPollInterval=sNTPPollInterval, supplementaryGroup=supplementaryGroup, systemClock=systemClock, installArmStateTrap=installArmStateTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, pubStats=pubStats, PYSNMP_MODULE_ID=cambium, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, pubStatsGroup=pubStatsGroup, dataPortAutoMdix=dataPortAutoMdix, dfsTableIndex=dfsTableIndex, sNTPServerPortNumber=sNTPServerPortNumber, sMTPEmailAlert=sMTPEmailAlert, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, telecomGroup=telecomGroup, frequencyVariant=frequencyVariant, vLANPriorityTableNumber=vLANPriorityTableNumber, receiveDataRate=receiveDataRate, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dfs=dfs, productName=productName, userTableEntry=userTableEntry, receiveFreqKHz=receiveFreqKHz, sMTPEnabledMessages=sMTPEnabledMessages, userEnabled=userEnabled, phyControl=phyControl, tDDControlGroup=tDDControlGroup, ptp500=ptp500, linkModeOptimisation=linkModeOptimisation, sMTPSourceEmailAddress=sMTPSourceEmailAddress, phyStatusGroup=phyStatusGroup, eIRP=eIRP, subnetMask=subnetMask, dataPortStatusTrap=dataPortStatusTrap, configurationGroup=configurationGroup, tFTPServerPortNumber=tFTPServerPortNumber, telnetAccessEnabled=telnetAccessEnabled, timeZone=timeZone, vLANManagementPriority=vLANManagementPriority, groupID=groupID, incompatibleMasterAndSlave=incompatibleMasterAndSlave, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, telecom=telecom, wirelessLinkAvailability=wirelessLinkAvailability, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, daylightSaving=daylightSaving, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, supplementary=supplementary, vLANPriorityTableIndex=vLANPriorityTableIndex, phyStatus=phyStatus, telecomsLineCode=telecomsLineCode, iPAddress=iPAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, cambium=cambium, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPEnabledTraps=sNMPEnabledTraps, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, aAAControlGroup=aAAControlGroup, capacityLicenseMismatch=capacityLicenseMismatch, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sntpGroup=sntpGroup, dfsPeaks=dfsPeaks, cableLoss=cableLoss, licensedCapacity=licensedCapacity, incompatibleRegionCodes=incompatibleRegionCodes, userRole=userRole, ethernetFiberSupport=ethernetFiberSupport)
