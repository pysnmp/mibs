...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", syslogClientTrap=syslogClientTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, phyStatus=phyStatus, telecomsChannelStatusTrap=telecomsChannelStatusTrap, latitude=latitude, dfsGroup=dfsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, licensedCapacity=licensedCapacity, notificationsGroup=notificationsGroup, bandwidthVariant=bandwidthVariant, userEnabled=userEnabled, snmpControlGroup=snmpControlGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, aggregateDataRate=aggregateDataRate, unitOutOfCalibration=unitOutOfCalibration, softwareVersion=softwareVersion, supplementaryGroup=supplementaryGroup, telnetPortNumber=telnetPortNumber, installArmState=installArmState, cambium=cambium, dataPortStatusTrap=dataPortStatusTrap, transmitPower=transmitPower, installArmStateTrap=installArmStateTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, encryptionAlgorithm=encryptionAlgorithm, sNMPTrapPortNumber=sNMPTrapPortNumber, configurationGroup=configurationGroup, pubStats=pubStats, groupID=groupID, ptp500=ptp500, wirelessLinkAvailability=wirelessLinkAvailability, linkModeOptimizationMismatch=linkModeOptimizationMismatch, receiveModulationMode=receiveModulationMode, signalStrengthRatio=signalStrengthRatio, sNMPCommunityString=sNMPCommunityString, sNMPTrapVersion=sNMPTrapVersion, smtp=smtp, sNMPTrapTable=sNMPTrapTable, eIRP=eIRP, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ptpTraps=ptpTraps, userTableEntry=userTableEntry, vLANPriorityTableIndex=vLANPriorityTableIndex, vectorError=vectorError, transmitDataRate=transmitDataRate, sNTPServerIPAddress=sNTPServerIPAddress, sNTPServerPortNumber=sNTPServerPortNumber, dataPortAutoMdix=dataPortAutoMdix, frequencyVariant=frequencyVariant, receiveFreqKHz=receiveFreqKHz, sNMPTrapTableIndex=sNMPTrapTableIndex, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, syslogState=syslogState, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPv3Enable=sNMPv3Enable, snmpControl=snmpControl, installStatus=installStatus, syslogControlGroup=syslogControlGroup, transmitFreqKHz=transmitFreqKHz, masterSlaveMode=masterSlaveMode, telecomsCableLength=telecomsCableLength, transmitModulationMode=transmitModulationMode, dfsMeans=dfsMeans, sMTPServerPortNumber=sMTPServerPortNumber, channelBandwidth=channelBandwidth, bootVersion=bootVersion, userTableIndex=userTableIndex, phyControl=phyControl, constantPowerSpectralDensity=constantPowerSpectralDensity, systemClock=systemClock, dfsTable=dfsTable, telecom=telecom, alarmsGroup=alarmsGroup, telecomsLoopback=telecomsLoopback, secondarySoftwareVersion=secondarySoftwareVersion, tDDSynchronizationAlarm=tDDSynchronizationAlarm, longitude=longitude, dfs=dfs, phyControlGroup=phyControlGroup, aAAControlGroup=aAAControlGroup, configuration=configuration, hTTPPortNumber=hTTPPortNumber, ptpTrapPrefix=ptpTrapPrefix, tDDControl=tDDControl, aAAControl=aAAControl, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, reset=reset, ptpCompliance=ptpCompliance, daylightSaving=daylightSaving, licenceGroup=licenceGroup, productVariant=productVariant, searchState=searchState, vLANManagementPriority=vLANManagementPriority, accessMethod=accessMethod, smtpGroup=smtpGroup, iPAddress=iPAddress, linkModeOptimisation=linkModeOptimisation, hTTPSAccessEnabled=hTTPSAccessEnabled, receiveDataRate=receiveDataRate, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPPollInterval=sNTPPollInterval, remoteMaximumTransmitPower=remoteMaximumTransmitPower, resetGroup=resetGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, maximumTransmitPower=maximumTransmitPower, ptp=ptp, hTTPAccessEnabled=hTTPAccessEnabled, versionsGroup=versionsGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, supplementary=supplementary, encryption=encryption, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ethernetGroup=ethernetGroup, syslogControl=syslogControl, encryptionGroup=encryptionGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, ptpGroups=ptpGroups, receiveModulationModeDetail=receiveModulationModeDetail, range=range, sNTPState=sNTPState, incompatibleRegionCodes=incompatibleRegionCodes, managementGroup=managementGroup, dataPortStatus=dataPortStatus, productName=productName, vLANPriorityTableNumber=vLANPriorityTableNumber, tDDControlGroup=tDDControlGroup, tFTPServerIPAddress=tFTPServerIPAddress, sntp=sntp, vLANPriorityTableEntry=vLANPriorityTableEntry, tDDSynchronizationMode=tDDSynchronizationMode, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dfsTableNumber=dfsTableNumber, siteName=siteName, dfsTableIndex=dfsTableIndex, phyStatusGroup=phyStatusGroup, userPassword=userPassword, PYSNMP_MODULE_ID=cambium, sNTPSyncTrap=sNTPSyncTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, regionCodeTrap=regionCodeTrap, management=management, subnetMask=subnetMask, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ethernet=ethernet, telecomsChannelStatus=telecomsChannelStatus, sntpGroup=sntpGroup, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, linkName=linkName, syslogStateTrap=syslogStateTrap, timeZone=timeZone, vLANManagementVID=vLANManagementVID, antennaGain=antennaGain, systemReset=systemReset, userTable=userTable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, altitude=altitude, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dfsPeaks=dfsPeaks, alarms=alarms, syslogClient=syslogClient, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNMPPortNumber=sNMPPortNumber, sNTPSync=sNTPSync, linkSymmetry=linkSymmetry, wirelessLinkStatus=wirelessLinkStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, telecomsInterface=telecomsInterface, sMTPEmailAlert=sMTPEmailAlert, sNMPEnabledTraps=sNMPEnabledTraps, telnetAccessEnabled=telnetAccessEnabled, targetMACAddress=targetMACAddress, pubStatsGroup=pubStatsGroup, gatewayIPAddress=gatewayIPAddress, receivePower=receivePower, receiveChannel=receiveChannel, ptmp=ptmp, dataPortDisabledWarning=dataPortDisabledWarning, receiveFreqMHz=receiveFreqMHz, dfsTableEntry=dfsTableEntry, telecomGroup=telecomGroup, sMTPEnabledMessages=sMTPEnabledMessages, licence=licence, sMTPServerIPAddress=sMTPServerIPAddress, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, vLANPriorityQueueMapping=vLANPriorityQueueMapping, telecomsLineCode=telecomsLineCode, byteErrorRatio=byteErrorRatio, ethernetFiberSupport=ethernetFiberSupport, remoteIPAddress=remoteIPAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tFTPServerPortNumber=tFTPServerPortNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, userTableNumber=userTableNumber, sNTPLastSync=sNTPLastSync, linkLoss=linkLoss, hardwareVersion=hardwareVersion, userName=userName, vLANPriorityTable=vLANPriorityTable, syslogLocalWrappedTrap=syslogLocalWrappedTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, regionCode=regionCode, useVLANForManagementInterfaces=useVLANForManagementInterfaces, userRole=userRole, versions=versions, hTTPSPortNumber=hTTPSPortNumber, transmitFreqMHz=transmitFreqMHz, channelChangeTrap=channelChangeTrap, installStatusTrap=installStatusTrap, capacityLicenseMismatch=capacityLicenseMismatch, cableLoss=cableLoss, transmitChannel=transmitChannel)
