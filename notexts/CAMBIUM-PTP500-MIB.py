...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sNTPSyncTrap=sNTPSyncTrap, userRole=userRole, aAAControlGroup=aAAControlGroup, ptpGroups=ptpGroups, syslogClient=syslogClient, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dfsTableEntry=dfsTableEntry, smtpGroup=smtpGroup, ptmp=ptmp, channelBandwidth=channelBandwidth, hTTPSPortNumber=hTTPSPortNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPServerIPAddress=sNTPServerIPAddress, secondarySoftwareVersion=secondarySoftwareVersion, channelChangeTrap=channelChangeTrap, dataPortStatusTrap=dataPortStatusTrap, snmpControl=snmpControl, unitOutOfCalibration=unitOutOfCalibration, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, receiveModulationMode=receiveModulationMode, dataPortConfigurationMismatch=dataPortConfigurationMismatch, linkModeOptimisation=linkModeOptimisation, telecomsInterface=telecomsInterface, systemReset=systemReset, tDDControl=tDDControl, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, linkSymmetry=linkSymmetry, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, bootVersion=bootVersion, dataPortAutoMdix=dataPortAutoMdix, ethernet=ethernet, sMTPEnabledMessages=sMTPEnabledMessages, aggregateDataRate=aggregateDataRate, productName=productName, sNMPCommunityString=sNMPCommunityString, telecom=telecom, syslogControlGroup=syslogControlGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, telecomsLoopbackTrap=telecomsLoopbackTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tFTPServerIPAddress=tFTPServerIPAddress, dataPortDisabledWarning=dataPortDisabledWarning, receiveModulationModeDetail=receiveModulationModeDetail, installArmStateTrap=installArmStateTrap, vLANManagementPriority=vLANManagementPriority, userTableEntry=userTableEntry, hardwareVersion=hardwareVersion, sNMPTrapTableIndex=sNMPTrapTableIndex, hTTPAccessEnabled=hTTPAccessEnabled, iPAddress=iPAddress, management=management, transmitFreqKHz=transmitFreqKHz, smtp=smtp, userPassword=userPassword, sntpGroup=sntpGroup, pubStats=pubStats, vLANPriorityQueueMapping=vLANPriorityQueueMapping, configurationGroup=configurationGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, incompatibleRegionCodes=incompatibleRegionCodes, latitude=latitude, tDDSynchronizationStatus=tDDSynchronizationStatus, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortWirelessDownAlert=dataPortWirelessDownAlert, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, licensedCapacity=licensedCapacity, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, telnetPortNumber=telnetPortNumber, receiveFreqMHz=receiveFreqMHz, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, hTTPPortNumber=hTTPPortNumber, ethernetGroup=ethernetGroup, vLANPriorityTable=vLANPriorityTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, syslogState=syslogState, phyStatusGroup=phyStatusGroup, timeZone=timeZone, ptp=ptp, snmpControlGroup=snmpControlGroup, installStatus=installStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortStatus=dataPortStatus, transmitDataRate=transmitDataRate, userEnabled=userEnabled, regionCode=regionCode, vectorError=vectorError, sntp=sntp, versionsGroup=versionsGroup, syslogClientTrap=syslogClientTrap, altitude=altitude, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tFTPServerPortNumber=tFTPServerPortNumber, userName=userName, ptpCompliance=ptpCompliance, telecomsLoopback=telecomsLoopback, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPLastSync=sNTPLastSync, aAAControl=aAAControl, telecomsCableLength=telecomsCableLength, installStatusTrap=installStatusTrap, regionCodeTrap=regionCodeTrap, userTableIndex=userTableIndex, telecomsLineCode=telecomsLineCode, configuration=configuration, siteName=siteName, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, softwareVersion=softwareVersion, tDDSynchronizationMode=tDDSynchronizationMode, managementGroup=managementGroup, phyStatus=phyStatus, accessMethod=accessMethod, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ethernetFiberSupport=ethernetFiberSupport, encryptionGroup=encryptionGroup, notificationsGroup=notificationsGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, telecomsChannelStatusTrap=telecomsChannelStatusTrap, searchState=searchState, receiveDataRate=receiveDataRate, sMTPServerIPAddress=sMTPServerIPAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, syslogStateTrap=syslogStateTrap, supplementaryGroup=supplementaryGroup, transmitFreqMHz=transmitFreqMHz, licenceGroup=licenceGroup, dfsMeans=dfsMeans, antennaGain=antennaGain, dfs=dfs, sNMPTrapTableEntry=sNMPTrapTableEntry, reset=reset, dfsPeaks=dfsPeaks, userTableNumber=userTableNumber, transmitChannel=transmitChannel, wirelessLinkStatus=wirelessLinkStatus, dfsTableNumber=dfsTableNumber, telnetAccessEnabled=telnetAccessEnabled, sNMPTrapVersion=sNMPTrapVersion, alarmsGroup=alarmsGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tDDControlGroup=tDDControlGroup, encryptionAlgorithm=encryptionAlgorithm, vLANPriorityTableIndex=vLANPriorityTableIndex, sNMPTrapIPAddress=sNMPTrapIPAddress, pubStatsGroup=pubStatsGroup, phyControl=phyControl, installArmState=installArmState, useVLANForManagementInterfaces=useVLANForManagementInterfaces, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, syslogControl=syslogControl, daylightSaving=daylightSaving, versions=versions, wirelessLinkAvailability=wirelessLinkAvailability, frequencyVariant=frequencyVariant, longitude=longitude, range=range, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ptpTrapPrefix=ptpTrapPrefix, targetMACAddress=targetMACAddress, dfsTable=dfsTable, ptpTraps=ptpTraps, dfsTableIndex=dfsTableIndex, remoteIPAddress=remoteIPAddress, receivePower=receivePower, vLANManagementVID=vLANManagementVID, dfsGroup=dfsGroup, linkLoss=linkLoss, productVariant=productVariant, dataPortAutoNegotiation=dataPortAutoNegotiation, transmitPower=transmitPower, linkName=linkName, enabledDiagnosticAlarms=enabledDiagnosticAlarms, eIRP=eIRP, cambium=cambium, alarms=alarms, sMTPServerPortNumber=sMTPServerPortNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, byteErrorRatio=byteErrorRatio, resetGroup=resetGroup, licence=licence, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPTrapTable=sNMPTrapTable, encryption=encryption, subnetMask=subnetMask, sNMPEnabledTraps=sNMPEnabledTraps, telecomGroup=telecomGroup, telecomsChannelStatus=telecomsChannelStatus, capacityLicenseMismatch=capacityLicenseMismatch, maximumTransmitPower=maximumTransmitPower, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, userTable=userTable, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPPollInterval=sNTPPollInterval, sMTPEmailAlert=sMTPEmailAlert, sMTPSourceEmailAddress=sMTPSourceEmailAddress, systemClock=systemClock, remoteMaximumTransmitPower=remoteMaximumTransmitPower, cableLoss=cableLoss, sNTPSync=sNTPSync, sNMPPortNumber=sNMPPortNumber, groupID=groupID, masterSlaveMode=masterSlaveMode, sNTPState=sNTPState, receiveChannel=receiveChannel, PYSNMP_MODULE_ID=cambium, sNMPv3Enable=sNMPv3Enable, syslogLocalWrappedTrap=syslogLocalWrappedTrap, gatewayIPAddress=gatewayIPAddress, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, receiveFreqKHz=receiveFreqKHz, phyControlGroup=phyControlGroup, sNTPServerPortNumber=sNTPServerPortNumber, ptp500=ptp500, bandwidthVariant=bandwidthVariant, vLANPriorityTableEntry=vLANPriorityTableEntry, signalStrengthRatio=signalStrengthRatio, supplementary=supplementary, transmitModulationMode=transmitModulationMode)
