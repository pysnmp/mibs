...
IpAddress, Counter32, Unsigned32, NotificationType, Gauge32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Integer32, MibIdentifier, TimeTicks, enterprises, Counter64, ModuleIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter32", "Unsigned32", "NotificationType", "Gauge32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Integer32", "MibIdentifier", "TimeTicks", "enterprises", "Counter64", "ModuleIdentity", "Bits")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", snmpControl=snmpControl, ptp=ptp, groupID=groupID, userTableNumber=userTableNumber, aggregateDataRate=aggregateDataRate, productName=productName, dfsTable=dfsTable, installArmState=installArmState, remoteMaximumTransmitPower=remoteMaximumTransmitPower, vLANManagementVID=vLANManagementVID, wirelessLinkAvailability=wirelessLinkAvailability, secondarySoftwareVersion=secondarySoftwareVersion, receiveModulationModeDetail=receiveModulationModeDetail, receiveFreqKHz=receiveFreqKHz, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPTrapVersion=sNMPTrapVersion, telecomsChannelStatusTrap=telecomsChannelStatusTrap, pubStatsGroup=pubStatsGroup, telecomsInterface=telecomsInterface, sMTPSourceEmailAddress=sMTPSourceEmailAddress, installArmStateTrap=installArmStateTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, channelBandwidth=channelBandwidth, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, vectorError=vectorError, PYSNMP_MODULE_ID=cambium, eIRP=eIRP, sNTPSync=sNTPSync, masterSlaveMode=masterSlaveMode, aAAControl=aAAControl, installStatus=installStatus, dataPortStatusTrap=dataPortStatusTrap, dfsPeaks=dfsPeaks, receiveChannel=receiveChannel, transmitPower=transmitPower, versions=versions, vLANPriorityQueueMapping=vLANPriorityQueueMapping, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapTableIndex=sNMPTrapTableIndex, ptpGroups=ptpGroups, sMTPServerIPAddress=sMTPServerIPAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, productVariant=productVariant, userRole=userRole, configuration=configuration, hTTPAccessEnabled=hTTPAccessEnabled, licenceGroup=licenceGroup, siteName=siteName, gatewayIPAddress=gatewayIPAddress, sNTPLastSync=sNTPLastSync, daylightSaving=daylightSaving, iPAddress=iPAddress, ptpTraps=ptpTraps, sNMPTrapTable=sNMPTrapTable, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, vLANManagementPriority=vLANManagementPriority, ptmp=ptmp, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, hTTPSPortNumber=hTTPSPortNumber, unitOutOfCalibration=unitOutOfCalibration, transmitModulationMode=transmitModulationMode, sNMPPortNumber=sNMPPortNumber, vLANPriorityTableNumber=vLANPriorityTableNumber, sNTPState=sNTPState, wirelessLinkStatus=wirelessLinkStatus, phyControlGroup=phyControlGroup, userTableEntry=userTableEntry, userEnabled=userEnabled, dfsGroup=dfsGroup, dfsTableIndex=dfsTableIndex, alarms=alarms, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, versionsGroup=versionsGroup, targetMACAddress=targetMACAddress, vLANPriorityTableIndex=vLANPriorityTableIndex, snmpControlGroup=snmpControlGroup, hardwareVersion=hardwareVersion, telecomGroup=telecomGroup, ptp500=ptp500, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sMTPEnabledMessages=sMTPEnabledMessages, linkModeOptimisation=linkModeOptimisation, linkModeOptimizationMismatch=linkModeOptimizationMismatch, transmitDataRate=transmitDataRate, management=management, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortDisabledWarning=dataPortDisabledWarning, bandwidthVariant=bandwidthVariant, sNTPPollInterval=sNTPPollInterval, syslogClient=syslogClient, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptpCompliance=ptpCompliance, vLANPriorityTable=vLANPriorityTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, transmitFreqMHz=transmitFreqMHz, pubStats=pubStats, antennaGain=antennaGain, sNMPv3Enable=sNMPv3Enable, licence=licence, incompatibleRegionCodes=incompatibleRegionCodes, encryptionAlgorithm=encryptionAlgorithm, dfsMeans=dfsMeans, maximumTransmitPower=maximumTransmitPower, range=range, alarmsGroup=alarmsGroup, linkSymmetry=linkSymmetry, dataPortAutoMdix=dataPortAutoMdix, incompatibleMasterAndSlave=incompatibleMasterAndSlave, regionCode=regionCode, timeZone=timeZone, sNMPTrapIPAddress=sNMPTrapIPAddress, userTable=userTable, receiveFreqMHz=receiveFreqMHz, constantPowerSpectralDensity=constantPowerSpectralDensity, licensedCapacity=licensedCapacity, noWirelessChannelAvailable=noWirelessChannelAvailable, sntp=sntp, remoteIPAddress=remoteIPAddress, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPTrapPortNumber=sNMPTrapPortNumber, smtp=smtp, accessMethod=accessMethod, capacityLicenseMismatch=capacityLicenseMismatch, sNMPTrapTableEntry=sNMPTrapTableEntry, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPSyncTrap=sNTPSyncTrap, telecomsLineCode=telecomsLineCode, tDDControl=tDDControl, byteErrorRatio=byteErrorRatio, telecomsLoopback=telecomsLoopback, channelChangeTrap=channelChangeTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dfs=dfs, cambium=cambium, phyControl=phyControl, tDDSynchronizationStatus=tDDSynchronizationStatus, latitude=latitude, longitude=longitude, systemReset=systemReset, syslogState=syslogState, ethernetGroup=ethernetGroup, telecom=telecom, reset=reset, dataPortStatus=dataPortStatus, sNMPEnabledTraps=sNMPEnabledTraps, dfsTableNumber=dfsTableNumber, linkLoss=linkLoss, sMTPServerPortNumber=sMTPServerPortNumber, hTTPPortNumber=hTTPPortNumber, telecomsCableLength=telecomsCableLength, telnetPortNumber=telnetPortNumber, dfsTableEntry=dfsTableEntry, frequencyVariant=frequencyVariant, installStatusTrap=installStatusTrap, ethernet=ethernet, smtpGroup=smtpGroup, encryption=encryption, userPassword=userPassword, encryptionGroup=encryptionGroup, softwareVersion=softwareVersion, userTableIndex=userTableIndex, syslogClientTrap=syslogClientTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tFTPServerPortNumber=tFTPServerPortNumber, subnetMask=subnetMask, sntpGroup=sntpGroup, resetGroup=resetGroup, transmitChannel=transmitChannel, hTTPSAccessEnabled=hTTPSAccessEnabled, regionCodeTrap=regionCodeTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, managementGroup=managementGroup, syslogControl=syslogControl, notificationsGroup=notificationsGroup, supplementary=supplementary, supplementaryGroup=supplementaryGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, altitude=altitude, linkName=linkName, phyStatusGroup=phyStatusGroup, sNTPServerIPAddress=sNTPServerIPAddress, signalStrengthRatio=signalStrengthRatio, telecomsLoopbackTrap=telecomsLoopbackTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, telecomsChannelStatus=telecomsChannelStatus, receiveDataRate=receiveDataRate, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, receiveModulationMode=receiveModulationMode, telnetAccessEnabled=telnetAccessEnabled, ethernetFiberSupport=ethernetFiberSupport, tFTPServerIPAddress=tFTPServerIPAddress, tDDSynchronizationMode=tDDSynchronizationMode, tDDControlGroup=tDDControlGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sMTPEmailAlert=sMTPEmailAlert, configurationGroup=configurationGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, systemClock=systemClock, transmitFreqKHz=transmitFreqKHz, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPServerPortNumber=sNTPServerPortNumber, ptpTrapPrefix=ptpTrapPrefix, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, phyStatus=phyStatus, searchState=searchState, cableLoss=cableLoss, aAAControlGroup=aAAControlGroup, bootVersion=bootVersion, syslogControlGroup=syslogControlGroup, userName=userName, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPCommunityString=sNMPCommunityString, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, syslogStateTrap=syslogStateTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, receivePower=receivePower)
