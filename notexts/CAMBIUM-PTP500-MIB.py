...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sMTPEmailAlert=sMTPEmailAlert, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, vLANPriorityTableNumber=vLANPriorityTableNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPSync=sNTPSync, linkLoss=linkLoss, dfsTableEntry=dfsTableEntry, hardwareVersion=hardwareVersion, tDDSynchronizationAlarm=tDDSynchronizationAlarm, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, telecomsInterface=telecomsInterface, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transmitFreqMHz=transmitFreqMHz, sNTPLastSync=sNTPLastSync, resetGroup=resetGroup, alarms=alarms, notificationsGroup=notificationsGroup, ptpCompliance=ptpCompliance, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, receiveChannel=receiveChannel, ptpTraps=ptpTraps, phyControl=phyControl, management=management, frequencyVariant=frequencyVariant, syslogClient=syslogClient, dfs=dfs, hTTPSAccessEnabled=hTTPSAccessEnabled, supplementaryGroup=supplementaryGroup, linkSymmetry=linkSymmetry, userPassword=userPassword, telecomsChannelStatusTrap=telecomsChannelStatusTrap, productName=productName, range=range, receiveDataRate=receiveDataRate, accessMethod=accessMethod, vLANManagementPriority=vLANManagementPriority, encryptionAlgorithm=encryptionAlgorithm, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, installArmStateTrap=installArmStateTrap, maximumTransmitPower=maximumTransmitPower, syslogLocalWrappedTrap=syslogLocalWrappedTrap, linkName=linkName, licensedCapacity=licensedCapacity, userEnabled=userEnabled, supplementary=supplementary, longitude=longitude, telecomsLoopback=telecomsLoopback, sMTPServerPortNumber=sMTPServerPortNumber, cableLoss=cableLoss, antennaGain=antennaGain, phyStatusGroup=phyStatusGroup, channelChangeTrap=channelChangeTrap, tDDSynchronizationMode=tDDSynchronizationMode, wirelessLinkStatus=wirelessLinkStatus, cambium=cambium, versions=versions, regionCodeTrap=regionCodeTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, latitude=latitude, softwareVersion=softwareVersion, gatewayIPAddress=gatewayIPAddress, licenceGroup=licenceGroup, remoteIPAddress=remoteIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, systemReset=systemReset, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapVersion=sNMPTrapVersion, hTTPAccessEnabled=hTTPAccessEnabled, capacityLicenseMismatch=capacityLicenseMismatch, configuration=configuration, tFTPServerIPAddress=tFTPServerIPAddress, productVariant=productVariant, dfsTableIndex=dfsTableIndex, transmitModulationMode=transmitModulationMode, noWirelessChannelAvailable=noWirelessChannelAvailable, receiveModulationMode=receiveModulationMode, dataPortDisabledWarning=dataPortDisabledWarning, altitude=altitude, snmpControlGroup=snmpControlGroup, secondarySoftwareVersion=secondarySoftwareVersion, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sMTPEnabledMessages=sMTPEnabledMessages, syslogState=syslogState, phyStatus=phyStatus, ptpGroups=ptpGroups, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ethernet=ethernet, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, signalStrengthRatio=signalStrengthRatio, telecomsLineCode=telecomsLineCode, telecom=telecom, licence=licence, transmitPower=transmitPower, aAAControl=aAAControl, userTable=userTable, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ethernetGroup=ethernetGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dfsPeaks=dfsPeaks, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, timeZone=timeZone, dataPortStatusTrap=dataPortStatusTrap, hTTPSPortNumber=hTTPSPortNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, bootVersion=bootVersion, tDDControl=tDDControl, vLANPriorityQueueMapping=vLANPriorityQueueMapping, pubStats=pubStats, incompatibleMasterAndSlave=incompatibleMasterAndSlave, versionsGroup=versionsGroup, managementGroup=managementGroup, ptpTrapPrefix=ptpTrapPrefix, dfsTable=dfsTable, hTTPPortNumber=hTTPPortNumber, vLANPriorityTableEntry=vLANPriorityTableEntry, dataPortConfigurationMismatch=dataPortConfigurationMismatch, userRole=userRole, sNMPTrapTableEntry=sNMPTrapTableEntry, incompatibleRegionCodes=incompatibleRegionCodes, receiveModulationModeDetail=receiveModulationModeDetail, constantPowerSpectralDensity=constantPowerSpectralDensity, tFTPServerPortNumber=tFTPServerPortNumber, telnetAccessEnabled=telnetAccessEnabled, aggregateDataRate=aggregateDataRate, dfsMeans=dfsMeans, masterSlaveMode=masterSlaveMode, sNTPState=sNTPState, userTableEntry=userTableEntry, smtpGroup=smtpGroup, sNMPTrapTable=sNMPTrapTable, systemClock=systemClock, installStatus=installStatus, pubStatsGroup=pubStatsGroup, groupID=groupID, dataPortStatus=dataPortStatus, PYSNMP_MODULE_ID=cambium, vLANManagementVID=vLANManagementVID, syslogControl=syslogControl, receiveFreqKHz=receiveFreqKHz, telecomGroup=telecomGroup, userTableIndex=userTableIndex, subnetMask=subnetMask, configurationGroup=configurationGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPPortNumber=sNMPPortNumber, ptmp=ptmp, telecomsChannelStatus=telecomsChannelStatus, eIRP=eIRP, ptp500=ptp500, sMTPServerIPAddress=sMTPServerIPAddress, sNMPEnabledTraps=sNMPEnabledTraps, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sntpGroup=sntpGroup, sNTPServerPortNumber=sNTPServerPortNumber, snmpControl=snmpControl, dataPortAutoMdix=dataPortAutoMdix, telecomsCableLength=telecomsCableLength, dfsTableNumber=dfsTableNumber, daylightSaving=daylightSaving, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPTrapTableNumber=sNMPTrapTableNumber, sntp=sntp, sNMPv3Enable=sNMPv3Enable, byteErrorRatio=byteErrorRatio, transmitDataRate=transmitDataRate, encryptionGroup=encryptionGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, telnetPortNumber=telnetPortNumber, telecomsLoopbackTrap=telecomsLoopbackTrap, regionCode=regionCode, bandwidthVariant=bandwidthVariant, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, installArmState=installArmState, reset=reset, sNMPTrapTableIndex=sNMPTrapTableIndex, channelBandwidth=channelBandwidth, vLANPriorityTableIndex=vLANPriorityTableIndex, receivePower=receivePower, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, siteName=siteName, wirelessLinkAvailability=wirelessLinkAvailability, sNTPServerIPAddress=sNTPServerIPAddress, aAAControlGroup=aAAControlGroup, transmitFreqKHz=transmitFreqKHz, vLANPriorityTable=vLANPriorityTable, searchState=searchState, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, receiveFreqMHz=receiveFreqMHz, transmitChannel=transmitChannel, userTableNumber=userTableNumber, encryption=encryption, sNTPPollInterval=sNTPPollInterval, targetMACAddress=targetMACAddress, userName=userName, tDDControlGroup=tDDControlGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ptp=ptp, dfsGroup=dfsGroup, alarmsGroup=alarmsGroup, phyControlGroup=phyControlGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, ethernetFiberSupport=ethernetFiberSupport, sNMPTrapPortNumber=sNMPTrapPortNumber, syslogClientTrap=syslogClientTrap, unitOutOfCalibration=unitOutOfCalibration, sNMPCommunityString=sNMPCommunityString, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, syslogStateTrap=syslogStateTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, smtp=smtp, syslogControlGroup=syslogControlGroup, vectorError=vectorError, installStatusTrap=installStatusTrap, linkModeOptimisation=linkModeOptimisation, sNTPSyncTrap=sNTPSyncTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, iPAddress=iPAddress)
