...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tDDSynchronizationMode=tDDSynchronizationMode, dataPortStatus=dataPortStatus, altitude=altitude, userTableEntry=userTableEntry, linkModeOptimisation=linkModeOptimisation, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, ptp500=ptp500, sNTPServerIPAddress=sNTPServerIPAddress, managementGroup=managementGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, smtp=smtp, configurationGroup=configurationGroup, syslogClientTrap=syslogClientTrap, alarms=alarms, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ethernet=ethernet, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNTPState=sNTPState, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, pubStatsGroup=pubStatsGroup, sNMPEnabledTraps=sNMPEnabledTraps, vLANManagementVID=vLANManagementVID, systemClock=systemClock, cambium=cambium, syslogLocalWrappedTrap=syslogLocalWrappedTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPServerPortNumber=tFTPServerPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, userTableNumber=userTableNumber, telecomsLoopback=telecomsLoopback, licenceGroup=licenceGroup, targetMACAddress=targetMACAddress, pubStats=pubStats, phyStatus=phyStatus, telecomsLineCode=telecomsLineCode, transmitFreqMHz=transmitFreqMHz, sNMPTrapTableNumber=sNMPTrapTableNumber, masterSlaveMode=masterSlaveMode, ptpCompliance=ptpCompliance, sNTPServerPortNumber=sNTPServerPortNumber, dfsGroup=dfsGroup, userName=userName, sNMPTrapTable=sNMPTrapTable, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ethernetGroup=ethernetGroup, syslogStateTrap=syslogStateTrap, sMTPEnabledMessages=sMTPEnabledMessages, tDDControlGroup=tDDControlGroup, cableLoss=cableLoss, supplementaryGroup=supplementaryGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, ptp=ptp, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, vLANPriorityTableEntry=vLANPriorityTableEntry, transmitChannel=transmitChannel, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ptpGroups=ptpGroups, sntp=sntp, dfsTable=dfsTable, dataPortAutoMdix=dataPortAutoMdix, sNMPTrapPortNumber=sNMPTrapPortNumber, telecomsChannelStatus=telecomsChannelStatus, receiveFreqMHz=receiveFreqMHz, dfsTableIndex=dfsTableIndex, aggregateDataRate=aggregateDataRate, dfs=dfs, telecomsLoopbackTrap=telecomsLoopbackTrap, phyControlGroup=phyControlGroup, channelBandwidth=channelBandwidth, range=range, sNTPSyncTrap=sNTPSyncTrap, linkSymmetry=linkSymmetry, installStatusTrap=installStatusTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, transmitModulationMode=transmitModulationMode, snmpControlGroup=snmpControlGroup, hTTPSPortNumber=hTTPSPortNumber, transmitDataRate=transmitDataRate, sNMPPortNumber=sNMPPortNumber, sntpGroup=sntpGroup, userRole=userRole, signalStrengthRatio=signalStrengthRatio, siteName=siteName, softwareVersion=softwareVersion, remoteMaximumTransmitPower=remoteMaximumTransmitPower, telecomGroup=telecomGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, searchState=searchState, dataPortDisabledWarning=dataPortDisabledWarning, wirelessLinkStatus=wirelessLinkStatus, dataPortStatusTrap=dataPortStatusTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, snmpControl=snmpControl, wirelessLinkAvailability=wirelessLinkAvailability, noWirelessChannelAvailable=noWirelessChannelAvailable, sNTPPollInterval=sNTPPollInterval, ethernetFiberSupport=ethernetFiberSupport, sNMPv3Enable=sNMPv3Enable, telnetAccessEnabled=telnetAccessEnabled, sMTPServerIPAddress=sMTPServerIPAddress, regionCode=regionCode, receiveDataRate=receiveDataRate, vectorError=vectorError, userTableIndex=userTableIndex, receiveChannel=receiveChannel, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, phyStatusGroup=phyStatusGroup, dfsTableEntry=dfsTableEntry, smtpGroup=smtpGroup, ptmp=ptmp, dfsTableNumber=dfsTableNumber, transmitFreqKHz=transmitFreqKHz, iPAddress=iPAddress, sNMPCommunityString=sNMPCommunityString, enabledDiagnosticAlarms=enabledDiagnosticAlarms, accessMethod=accessMethod, gatewayIPAddress=gatewayIPAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, sMTPServerPortNumber=sMTPServerPortNumber, latitude=latitude, dataPortWirelessDownAlert=dataPortWirelessDownAlert, unitOutOfCalibration=unitOutOfCalibration, vLANPriorityTable=vLANPriorityTable, encryptionGroup=encryptionGroup, reset=reset, vLANPriorityTableNumber=vLANPriorityTableNumber, sNTPSync=sNTPSync, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, sNMPTrapTableEntry=sNMPTrapTableEntry, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, licence=licence, receiveModulationModeDetail=receiveModulationModeDetail, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, incompatibleRegionCodes=incompatibleRegionCodes, daylightSaving=daylightSaving, tDDControl=tDDControl, linkModeOptimizationMismatch=linkModeOptimizationMismatch, syslogControlGroup=syslogControlGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPTrapVersion=sNMPTrapVersion, userPassword=userPassword, channelChangeTrap=channelChangeTrap, tFTPServerIPAddress=tFTPServerIPAddress, linkName=linkName, notificationsGroup=notificationsGroup, productVariant=productVariant, installArmState=installArmState, aAAControlGroup=aAAControlGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, telecomsInterface=telecomsInterface, syslogClient=syslogClient, supplementary=supplementary, dfsPeaks=dfsPeaks, syslogControl=syslogControl, timeZone=timeZone, vLANManagementPriority=vLANManagementPriority, tDDSynchronizationStatus=tDDSynchronizationStatus, longitude=longitude, regionCodeTrap=regionCodeTrap, licensedCapacity=licensedCapacity, hTTPAccessEnabled=hTTPAccessEnabled, telnetPortNumber=telnetPortNumber, receiveFreqKHz=receiveFreqKHz, phyControl=phyControl, remoteIPAddress=remoteIPAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, syslogState=syslogState, alarmsGroup=alarmsGroup, groupID=groupID, installStatus=installStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sMTPEmailAlert=sMTPEmailAlert, antennaGain=antennaGain, transmitPower=transmitPower, userTable=userTable, receiveModulationMode=receiveModulationMode, telecom=telecom, secondarySoftwareVersion=secondarySoftwareVersion, versionsGroup=versionsGroup, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, ptpTrapPrefix=ptpTrapPrefix, hTTPPortNumber=hTTPPortNumber, installArmStateTrap=installArmStateTrap, encryption=encryption, ptpTraps=ptpTraps, capacityLicenseMismatch=capacityLicenseMismatch, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, bootVersion=bootVersion, configuration=configuration, aAAControl=aAAControl, productName=productName, hardwareVersion=hardwareVersion, frequencyVariant=frequencyVariant, encryptionAlgorithm=encryptionAlgorithm, resetGroup=resetGroup, telecomsCableLength=telecomsCableLength, management=management, PYSNMP_MODULE_ID=cambium, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, bandwidthVariant=bandwidthVariant, linkLoss=linkLoss, byteErrorRatio=byteErrorRatio, systemReset=systemReset, subnetMask=subnetMask, maximumTransmitPower=maximumTransmitPower, receivePower=receivePower, sNTPLastSync=sNTPLastSync, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userEnabled=userEnabled, eIRP=eIRP, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, versions=versions, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsMeans=dfsMeans)
