...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", userRole=userRole, channelBandwidth=channelBandwidth, encryption=encryption, unitOutOfCalibration=unitOutOfCalibration, receiveFreqMHz=receiveFreqMHz, transmitChannel=transmitChannel, secondarySoftwareVersion=secondarySoftwareVersion, telnetPortNumber=telnetPortNumber, tDDSynchronizationMode=tDDSynchronizationMode, hardwareVersion=hardwareVersion, ethernet=ethernet, noWirelessChannelAvailable=noWirelessChannelAvailable, sNTPSyncTrap=sNTPSyncTrap, dfsPeaks=dfsPeaks, userTableIndex=userTableIndex, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortWirelessDownAlert=dataPortWirelessDownAlert, linkName=linkName, searchState=searchState, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, configuration=configuration, supplementaryGroup=supplementaryGroup, daylightSaving=daylightSaving, vLANManagementPriority=vLANManagementPriority, telecomsLoopback=telecomsLoopback, licence=licence, syslogControlGroup=syslogControlGroup, aAAControl=aAAControl, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, range=range, signalStrengthRatio=signalStrengthRatio, sNMPTrapVersion=sNMPTrapVersion, PYSNMP_MODULE_ID=cambium, reset=reset, syslogControl=syslogControl, wirelessLinkStatus=wirelessLinkStatus, userName=userName, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, wirelessLinkAvailability=wirelessLinkAvailability, dfsTable=dfsTable, dataPortAutoNegotiation=dataPortAutoNegotiation, linkSymmetry=linkSymmetry, softwareVersion=softwareVersion, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, cambium=cambium, versions=versions, iPAddress=iPAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sntp=sntp, dataPortAutoMdix=dataPortAutoMdix, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, receiveModulationMode=receiveModulationMode, snmpControl=snmpControl, antennaGain=antennaGain, alarms=alarms, licenceGroup=licenceGroup, tFTPServerPortNumber=tFTPServerPortNumber, sNMPCommunityString=sNMPCommunityString, remoteIPAddress=remoteIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPEnabledTraps=sNMPEnabledTraps, sNTPPollInterval=sNTPPollInterval, longitude=longitude, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, transmitDataRate=transmitDataRate, ptp=ptp, subnetMask=subnetMask, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, ethernetGroup=ethernetGroup, siteName=siteName, userTable=userTable, resetGroup=resetGroup, smtp=smtp, sMTPEmailAlert=sMTPEmailAlert, latitude=latitude, userPassword=userPassword, pubStats=pubStats, sNMPTrapTableEntry=sNMPTrapTableEntry, eIRP=eIRP, transmitFreqMHz=transmitFreqMHz, sNMPPortNumber=sNMPPortNumber, ethernetFiberSupport=ethernetFiberSupport, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogStateTrap=syslogStateTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, encryptionAlgorithm=encryptionAlgorithm, installStatusTrap=installStatusTrap, altitude=altitude, ptpCompliance=ptpCompliance, telecomsLineCode=telecomsLineCode, groupID=groupID, incompatibleRegionCodes=incompatibleRegionCodes, smtpGroup=smtpGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dfsMeans=dfsMeans, hTTPAccessEnabled=hTTPAccessEnabled, telecomsCableLength=telecomsCableLength, receivePower=receivePower, receiveChannel=receiveChannel, managementGroup=managementGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, vLANPriorityTable=vLANPriorityTable, installArmState=installArmState, hTTPSAccessEnabled=hTTPSAccessEnabled, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPServerPortNumber=sNTPServerPortNumber, transmitFreqKHz=transmitFreqKHz, linkLoss=linkLoss, versionsGroup=versionsGroup, installStatus=installStatus, licensedCapacity=licensedCapacity, ptp500=ptp500, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, phyControl=phyControl, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tDDControlGroup=tDDControlGroup, masterSlaveMode=masterSlaveMode, telecomsChannelStatusTrap=telecomsChannelStatusTrap, userEnabled=userEnabled, frequencyVariant=frequencyVariant, tDDControl=tDDControl, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, telecomsChannelStatus=telecomsChannelStatus, tDDSynchronizationStatus=tDDSynchronizationStatus, receiveDataRate=receiveDataRate, hTTPPortNumber=hTTPPortNumber, systemClock=systemClock, dataPortStatusTrap=dataPortStatusTrap, channelChangeTrap=channelChangeTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, telecomsInterface=telecomsInterface, sNTPLastSync=sNTPLastSync, management=management, dfsTableNumber=dfsTableNumber, alarmsGroup=alarmsGroup, accessMethod=accessMethod, vLANManagementVID=vLANManagementVID, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receiveFreqKHz=receiveFreqKHz, productVariant=productVariant, sNMPv3Enable=sNMPv3Enable, sMTPServerPortNumber=sMTPServerPortNumber, vLANPriorityTableNumber=vLANPriorityTableNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dfs=dfs, vLANPriorityTableEntry=vLANPriorityTableEntry, sNTPServerIPAddress=sNTPServerIPAddress, targetMACAddress=targetMACAddress, vectorError=vectorError, bootVersion=bootVersion, linkModeOptimisation=linkModeOptimisation, installArmStateTrap=installArmStateTrap, sntpGroup=sntpGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, systemReset=systemReset, userTableEntry=userTableEntry, sNMPTrapTable=sNMPTrapTable, sMTPServerIPAddress=sMTPServerIPAddress, encryptionGroup=encryptionGroup, ptmp=ptmp, productName=productName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, phyControlGroup=phyControlGroup, ptpGroups=ptpGroups, dfsGroup=dfsGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, vLANPriorityTableIndex=vLANPriorityTableIndex, sNTPSync=sNTPSync, supplementary=supplementary, incompatibleMasterAndSlave=incompatibleMasterAndSlave, remoteMaximumTransmitPower=remoteMaximumTransmitPower, bandwidthVariant=bandwidthVariant, syslogClient=syslogClient, sNTPState=sNTPState, timeZone=timeZone, telnetAccessEnabled=telnetAccessEnabled, snmpControlGroup=snmpControlGroup, ptpTrapPrefix=ptpTrapPrefix, aggregateDataRate=aggregateDataRate, receiveModulationModeDetail=receiveModulationModeDetail, telecomGroup=telecomGroup, ptpTraps=ptpTraps, configurationGroup=configurationGroup, dataPortStatus=dataPortStatus, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dfsTableIndex=dfsTableIndex, userTableNumber=userTableNumber, syslogState=syslogState, dfsTableEntry=dfsTableEntry, transmitModulationMode=transmitModulationMode, phyStatus=phyStatus, capacityLicenseMismatch=capacityLicenseMismatch, hTTPSPortNumber=hTTPSPortNumber, regionCode=regionCode, aAAControlGroup=aAAControlGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, transmitPower=transmitPower, byteErrorRatio=byteErrorRatio, telecomsLoopbackTrap=telecomsLoopbackTrap, maximumTransmitPower=maximumTransmitPower, notificationsGroup=notificationsGroup, telecom=telecom, phyStatusGroup=phyStatusGroup, gatewayIPAddress=gatewayIPAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortDisabledWarning=dataPortDisabledWarning, sMTPEnabledMessages=sMTPEnabledMessages, regionCodeTrap=regionCodeTrap, syslogClientTrap=syslogClientTrap, tFTPServerIPAddress=tFTPServerIPAddress, cableLoss=cableLoss, pubStatsGroup=pubStatsGroup)
