...
# Produced by pysmi-1.1.8 at Thu Jan 13 22:45:54 2022
...
Counter64, ModuleIdentity, enterprises, NotificationType, Gauge32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, IpAddress, ObjectIdentity, Integer32, Bits, TimeTicks, Counter32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ModuleIdentity", "enterprises", "NotificationType", "Gauge32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "IpAddress", "ObjectIdentity", "Integer32", "Bits", "TimeTicks", "Counter32", "iso")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", receiveModulationModeDetail=receiveModulationModeDetail, masterSlaveMode=masterSlaveMode, vLANManagementPriority=vLANManagementPriority, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, installStatus=installStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, syslogClientTrap=syslogClientTrap, telecomsChannelStatus=telecomsChannelStatus, installStatusTrap=installStatusTrap, maximumTransmitPower=maximumTransmitPower, ptp=ptp, linkLoss=linkLoss, aggregateDataRate=aggregateDataRate, userTableNumber=userTableNumber, dfsTableIndex=dfsTableIndex, phyStatusGroup=phyStatusGroup, bandwidthVariant=bandwidthVariant, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, byteErrorRatio=byteErrorRatio, userTableEntry=userTableEntry, receivePower=receivePower, constantPowerSpectralDensity=constantPowerSpectralDensity, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPState=sNTPState, tDDControl=tDDControl, targetMACAddress=targetMACAddress, siteName=siteName, encryption=encryption, transmitModulationMode=transmitModulationMode, cableLoss=cableLoss, range=range, dfsTable=dfsTable, receiveChannel=receiveChannel, ptpGroups=ptpGroups, dataPortConfigurationMismatch=dataPortConfigurationMismatch, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, cambium=cambium, syslogClient=syslogClient, userTable=userTable, sMTPEnabledMessages=sMTPEnabledMessages, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, managementGroup=managementGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitPower=transmitPower, sMTPSourceEmailAddress=sMTPSourceEmailAddress, vLANPriorityTable=vLANPriorityTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNTPPollInterval=sNTPPollInterval, frequencyVariant=frequencyVariant, tDDSynchronizationMode=tDDSynchronizationMode, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, syslogControlGroup=syslogControlGroup, unitOutOfCalibration=unitOutOfCalibration, configurationGroup=configurationGroup, dataPortStatus=dataPortStatus, dfsTableEntry=dfsTableEntry, ptpTrapPrefix=ptpTrapPrefix, ethernetFiberSupport=ethernetFiberSupport, alarms=alarms, hTTPSAccessEnabled=hTTPSAccessEnabled, systemClock=systemClock, userEnabled=userEnabled, aAAControlGroup=aAAControlGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, sNTPSyncTrap=sNTPSyncTrap, telecomsLoopback=telecomsLoopback, linkModeOptimisation=linkModeOptimisation, dataPortAutoMdix=dataPortAutoMdix, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dfsTableNumber=dfsTableNumber, dfsPeaks=dfsPeaks, PYSNMP_MODULE_ID=cambium, latitude=latitude, searchState=searchState, notificationsGroup=notificationsGroup, sMTPServerPortNumber=sMTPServerPortNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPServerIPAddress=sNTPServerIPAddress, configuration=configuration, dfs=dfs, enabledDiagnosticAlarms=enabledDiagnosticAlarms, hardwareVersion=hardwareVersion, sNMPPortNumber=sNMPPortNumber, snmpControl=snmpControl, telecomsChannelStatusTrap=telecomsChannelStatusTrap, vLANManagementVID=vLANManagementVID, ethernetGroup=ethernetGroup, syslogControl=syslogControl, vLANPriorityQueueMapping=vLANPriorityQueueMapping, receiveModulationMode=receiveModulationMode, tDDControlGroup=tDDControlGroup, incompatibleRegionCodes=incompatibleRegionCodes, noWirelessChannelAvailable=noWirelessChannelAvailable, ethernet=ethernet, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPServerPortNumber=sNTPServerPortNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, installArmStateTrap=installArmStateTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, secondarySoftwareVersion=secondarySoftwareVersion, antennaGain=antennaGain, vectorError=vectorError, sMTPEmailAlert=sMTPEmailAlert, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tFTPServerIPAddress=tFTPServerIPAddress, versionsGroup=versionsGroup, gatewayIPAddress=gatewayIPAddress, productName=productName, userTableIndex=userTableIndex, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, capacityLicenseMismatch=capacityLicenseMismatch, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, phyControl=phyControl, iPAddress=iPAddress, smtp=smtp, syslogState=syslogState, alarmsGroup=alarmsGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, groupID=groupID, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, receiveDataRate=receiveDataRate, phyControlGroup=phyControlGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, hTTPPortNumber=hTTPPortNumber, licenceGroup=licenceGroup, encryptionAlgorithm=encryptionAlgorithm, sNTPLastSync=sNTPLastSync, telnetPortNumber=telnetPortNumber, transmitChannel=transmitChannel, sNMPEnabledTraps=sNMPEnabledTraps, telecom=telecom, aAAControl=aAAControl, ptpTraps=ptpTraps, accessMethod=accessMethod, wirelessLinkStatus=wirelessLinkStatus, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPCommunityString=sNMPCommunityString, vLANPriorityTableEntry=vLANPriorityTableEntry, supplementaryGroup=supplementaryGroup, linkName=linkName, eIRP=eIRP, productVariant=productVariant, remoteIPAddress=remoteIPAddress, smtpGroup=smtpGroup, management=management, dataPortDisabledWarning=dataPortDisabledWarning, ptmp=ptmp, reset=reset, telecomsCableLength=telecomsCableLength, pubStatsGroup=pubStatsGroup, dataPortStatusTrap=dataPortStatusTrap, syslogStateTrap=syslogStateTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, receiveFreqKHz=receiveFreqKHz, transmitFreqMHz=transmitFreqMHz, ptp500=ptp500, softwareVersion=softwareVersion, userPassword=userPassword, vLANPriorityTableNumber=vLANPriorityTableNumber, hTTPSPortNumber=hTTPSPortNumber, regionCodeTrap=regionCodeTrap, wirelessLinkAvailability=wirelessLinkAvailability, encryptionGroup=encryptionGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dfsGroup=dfsGroup, transmitDataRate=transmitDataRate, tFTPServerPortNumber=tFTPServerPortNumber, sMTPServerIPAddress=sMTPServerIPAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, licensedCapacity=licensedCapacity, hTTPAccessEnabled=hTTPAccessEnabled, sNMPTrapTableNumber=sNMPTrapTableNumber, ptpCompliance=ptpCompliance, receiveFreqMHz=receiveFreqMHz, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPv3Enable=sNMPv3Enable, snmpControlGroup=snmpControlGroup, supplementary=supplementary, versions=versions, userRole=userRole, telecomsInterface=telecomsInterface, telnetAccessEnabled=telnetAccessEnabled, timeZone=timeZone, telecomsLoopbackTrap=telecomsLoopbackTrap, systemReset=systemReset, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortWirelessDownAlert=dataPortWirelessDownAlert, transmitFreqKHz=transmitFreqKHz, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, channelBandwidth=channelBandwidth, subnetMask=subnetMask, regionCode=regionCode, linkModeOptimizationMismatch=linkModeOptimizationMismatch, telecomsLineCode=telecomsLineCode, pubStats=pubStats, bootVersion=bootVersion, sntpGroup=sntpGroup, signalStrengthRatio=signalStrengthRatio, sNMPTrapVersion=sNMPTrapVersion, sntp=sntp, altitude=altitude, licence=licence, installArmState=installArmState, userName=userName, tDDSynchronizationStatus=tDDSynchronizationStatus, resetGroup=resetGroup, linkSymmetry=linkSymmetry, channelChangeTrap=channelChangeTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, sNTPSync=sNTPSync, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, daylightSaving=daylightSaving, phyStatus=phyStatus, telecomGroup=telecomGroup, longitude=longitude, sNMPTrapTable=sNMPTrapTable, dfsMeans=dfsMeans)
