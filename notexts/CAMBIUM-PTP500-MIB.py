...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", reset=reset, secondarySoftwareVersion=secondarySoftwareVersion, installStatusTrap=installStatusTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, userPassword=userPassword, sNTPLastSync=sNTPLastSync, syslogLocalWrappedTrap=syslogLocalWrappedTrap, telecomGroup=telecomGroup, dataPortAutoMdix=dataPortAutoMdix, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, groupID=groupID, sNTPServerPortNumber=sNTPServerPortNumber, sMTPServerIPAddress=sMTPServerIPAddress, syslogControlGroup=syslogControlGroup, notificationsGroup=notificationsGroup, installArmState=installArmState, hTTPSPortNumber=hTTPSPortNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, hardwareVersion=hardwareVersion, phyStatusGroup=phyStatusGroup, bootVersion=bootVersion, targetMACAddress=targetMACAddress, ptpTraps=ptpTraps, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, byteErrorRatio=byteErrorRatio, telecomsCableLength=telecomsCableLength, cableLoss=cableLoss, antennaGain=antennaGain, constantPowerSpectralDensity=constantPowerSpectralDensity, remoteMaximumTransmitPower=remoteMaximumTransmitPower, wirelessLinkStatus=wirelessLinkStatus, userTableNumber=userTableNumber, phyStatus=phyStatus, userRole=userRole, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPEnabledTraps=sNMPEnabledTraps, installStatus=installStatus, sNMPPortNumber=sNMPPortNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tFTPServerPortNumber=tFTPServerPortNumber, licensedCapacity=licensedCapacity, signalStrengthRatio=signalStrengthRatio, configurationGroup=configurationGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, subnetMask=subnetMask, userEnabled=userEnabled, hTTPPortNumber=hTTPPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, userTableIndex=userTableIndex, productName=productName, productVariant=productVariant, dataPortConfigurationMismatch=dataPortConfigurationMismatch, tDDControl=tDDControl, dfs=dfs, tDDControlGroup=tDDControlGroup, sMTPEmailAlert=sMTPEmailAlert, sMTPServerPortNumber=sMTPServerPortNumber, bandwidthVariant=bandwidthVariant, receiveChannel=receiveChannel, telecomsLineCode=telecomsLineCode, systemReset=systemReset, telecomsChannelStatus=telecomsChannelStatus, sNMPTrapTable=sNMPTrapTable, sNMPCommunityString=sNMPCommunityString, accessMethod=accessMethod, syslogControl=syslogControl, aggregateDataRate=aggregateDataRate, licence=licence, vLANManagementPriority=vLANManagementPriority, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPServerIPAddress=sNTPServerIPAddress, dataPortStatusTrap=dataPortStatusTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPPollInterval=sNTPPollInterval, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, searchState=searchState, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, longitude=longitude, linkModeOptimisation=linkModeOptimisation, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, transmitDataRate=transmitDataRate, versionsGroup=versionsGroup, phyControlGroup=phyControlGroup, ptpGroups=ptpGroups, sNMPTrapTableEntry=sNMPTrapTableEntry, channelBandwidth=channelBandwidth, vectorError=vectorError, maximumTransmitPower=maximumTransmitPower, dfsTableNumber=dfsTableNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, telecomsLoopback=telecomsLoopback, sNTPSync=sNTPSync, syslogClient=syslogClient, regionCode=regionCode, latitude=latitude, PYSNMP_MODULE_ID=cambium, ethernet=ethernet, sMTPEnabledMessages=sMTPEnabledMessages, telnetPortNumber=telnetPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, remoteIPAddress=remoteIPAddress, tDDSynchronizationMode=tDDSynchronizationMode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, encryption=encryption, userName=userName, telecomsChannelStatusTrap=telecomsChannelStatusTrap, smtp=smtp, siteName=siteName, ethernetGroup=ethernetGroup, transmitPower=transmitPower, softwareVersion=softwareVersion, aAAControlGroup=aAAControlGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ptp=ptp, tDDSynchronizationStatus=tDDSynchronizationStatus, regionCodeTrap=regionCodeTrap, alarmsGroup=alarmsGroup, dfsTable=dfsTable, ptpCompliance=ptpCompliance, dfsGroup=dfsGroup, syslogClientTrap=syslogClientTrap, incompatibleRegionCodes=incompatibleRegionCodes, cambium=cambium, telecom=telecom, supplementary=supplementary, daylightSaving=daylightSaving, dfsTableEntry=dfsTableEntry, tFTPServerIPAddress=tFTPServerIPAddress, vLANPriorityTableNumber=vLANPriorityTableNumber, sNMPTrapVersion=sNMPTrapVersion, aAAControl=aAAControl, snmpControlGroup=snmpControlGroup, gatewayIPAddress=gatewayIPAddress, sNTPState=sNTPState, resetGroup=resetGroup, receiveModulationModeDetail=receiveModulationModeDetail, vLANPriorityTableIndex=vLANPriorityTableIndex, telecomsInterface=telecomsInterface, channelChangeTrap=channelChangeTrap, pubStats=pubStats, ptmp=ptmp, range=range, pubStatsGroup=pubStatsGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, encryptionAlgorithm=encryptionAlgorithm, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, phyControl=phyControl, vLANManagementVID=vLANManagementVID, sNMPv3Enable=sNMPv3Enable, transmitFreqMHz=transmitFreqMHz, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, linkLoss=linkLoss, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, smtpGroup=smtpGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, receiveDataRate=receiveDataRate, supplementaryGroup=supplementaryGroup, vLANPriorityTable=vLANPriorityTable, iPAddress=iPAddress, altitude=altitude, dfsPeaks=dfsPeaks, configuration=configuration, capacityLicenseMismatch=capacityLicenseMismatch, ptp500=ptp500, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, receivePower=receivePower, receiveFreqKHz=receiveFreqKHz, telecomsLoopbackTrap=telecomsLoopbackTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, ptpTrapPrefix=ptpTrapPrefix, transmitModulationMode=transmitModulationMode, timeZone=timeZone, hTTPAccessEnabled=hTTPAccessEnabled, versions=versions, installArmStateTrap=installArmStateTrap, receiveFreqMHz=receiveFreqMHz, management=management, hTTPSAccessEnabled=hTTPSAccessEnabled, vLANPriorityQueueMapping=vLANPriorityQueueMapping, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sntp=sntp, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dataPortDisabledWarning=dataPortDisabledWarning, vLANPriorityTableEntry=vLANPriorityTableEntry, sntpGroup=sntpGroup, alarms=alarms, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tDDSynchronizationAlarm=tDDSynchronizationAlarm, snmpControl=snmpControl, linkName=linkName, frequencyVariant=frequencyVariant, eIRP=eIRP, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, transmitFreqKHz=transmitFreqKHz, dfsTableIndex=dfsTableIndex, systemClock=systemClock, userTableEntry=userTableEntry, sNTPSyncTrap=sNTPSyncTrap, encryptionGroup=encryptionGroup, dataPortStatus=dataPortStatus, masterSlaveMode=masterSlaveMode, ethernetFiberSupport=ethernetFiberSupport, licenceGroup=licenceGroup, receiveModulationMode=receiveModulationMode, linkSymmetry=linkSymmetry, managementGroup=managementGroup, telnetAccessEnabled=telnetAccessEnabled, syslogStateTrap=syslogStateTrap, wirelessLinkAvailability=wirelessLinkAvailability, sNMPTrapPortNumber=sNMPTrapPortNumber, transmitChannel=transmitChannel, unitOutOfCalibration=unitOutOfCalibration, userTable=userTable, syslogState=syslogState, dfsMeans=dfsMeans)
