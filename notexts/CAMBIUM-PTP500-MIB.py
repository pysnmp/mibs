...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", pubStatsGroup=pubStatsGroup, receiveChannel=receiveChannel, supplementary=supplementary, ptp=ptp, telecom=telecom, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPServerIPAddress=sNTPServerIPAddress, reset=reset, remoteMaximumTransmitPower=remoteMaximumTransmitPower, wirelessLinkAvailability=wirelessLinkAvailability, configuration=configuration, noWirelessChannelAvailable=noWirelessChannelAvailable, ptmp=ptmp, telecomsLineCode=telecomsLineCode, ptpCompliance=ptpCompliance, productName=productName, targetMACAddress=targetMACAddress, transmitFreqMHz=transmitFreqMHz, dfs=dfs, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, capacityLicenseMismatch=capacityLicenseMismatch, sNMPTrapPortNumber=sNMPTrapPortNumber, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNMPv3Enable=sNMPv3Enable, searchState=searchState, supplementaryGroup=supplementaryGroup, telecomsLoopback=telecomsLoopback, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, dfsTableNumber=dfsTableNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, linkModeOptimisation=linkModeOptimisation, tDDControl=tDDControl, sNTPSync=sNTPSync, sNMPTrapTableEntry=sNMPTrapTableEntry, ethernetGroup=ethernetGroup, accessMethod=accessMethod, receiveModulationModeDetail=receiveModulationModeDetail, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, cableLoss=cableLoss, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sntp=sntp, timeZone=timeZone, vectorError=vectorError, linkLoss=linkLoss, sNMPCommunityString=sNMPCommunityString, telnetAccessEnabled=telnetAccessEnabled, signalStrengthRatio=signalStrengthRatio, userTableIndex=userTableIndex, subnetMask=subnetMask, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, telecomsCableLength=telecomsCableLength, latitude=latitude, linkName=linkName, dataPortWirelessDownAlert=dataPortWirelessDownAlert, productVariant=productVariant, licence=licence, receiveFreqKHz=receiveFreqKHz, vLANPriorityQueueMapping=vLANPriorityQueueMapping, ptpGroups=ptpGroups, transmitFreqKHz=transmitFreqKHz, bandwidthVariant=bandwidthVariant, phyControl=phyControl, hardwareVersion=hardwareVersion, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, frequencyVariant=frequencyVariant, receiveModulationMode=receiveModulationMode, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, syslogControl=syslogControl, channelChangeTrap=channelChangeTrap, dfsTable=dfsTable, userEnabled=userEnabled, pubStats=pubStats, ethernet=ethernet, vLANPriorityTableEntry=vLANPriorityTableEntry, dataPortStatus=dataPortStatus, syslogClient=syslogClient, daylightSaving=daylightSaving, userTable=userTable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, snmpControlGroup=snmpControlGroup, syslogState=syslogState, linkSymmetry=linkSymmetry, eIRP=eIRP, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, hTTPSPortNumber=hTTPSPortNumber, transmitPower=transmitPower, managementGroup=managementGroup, groupID=groupID, vLANPriorityTableNumber=vLANPriorityTableNumber, masterSlaveMode=masterSlaveMode, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tFTPServerPortNumber=tFTPServerPortNumber, byteErrorRatio=byteErrorRatio, syslogStateTrap=syslogStateTrap, tFTPServerIPAddress=tFTPServerIPAddress, receivePower=receivePower, sNTPServerPortNumber=sNTPServerPortNumber, dataPortAutoMdix=dataPortAutoMdix, smtp=smtp, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dfsMeans=dfsMeans, telecomGroup=telecomGroup, sntpGroup=sntpGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, telecomsInterface=telecomsInterface, dfsTableEntry=dfsTableEntry, regionCode=regionCode, telecomsLoopbackTrap=telecomsLoopbackTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sMTPEmailAlert=sMTPEmailAlert, installStatusTrap=installStatusTrap, versionsGroup=versionsGroup, incompatibleRegionCodes=incompatibleRegionCodes, channelBandwidth=channelBandwidth, phyStatus=phyStatus, sNMPTrapVersion=sNMPTrapVersion, enabledDiagnosticAlarms=enabledDiagnosticAlarms, telecomsChannelStatusTrap=telecomsChannelStatusTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, receiveDataRate=receiveDataRate, sNTPPollInterval=sNTPPollInterval, remoteIPAddress=remoteIPAddress, longitude=longitude, licenceGroup=licenceGroup, alarms=alarms, maximumTransmitPower=maximumTransmitPower, licensedCapacity=licensedCapacity, cambium=cambium, sNMPTrapTable=sNMPTrapTable, hTTPSAccessEnabled=hTTPSAccessEnabled, sMTPServerIPAddress=sMTPServerIPAddress, snmpControl=snmpControl, dataPortConfigurationMismatch=dataPortConfigurationMismatch, versions=versions, sNMPEnabledTraps=sNMPEnabledTraps, smtpGroup=smtpGroup, softwareVersion=softwareVersion, hTTPPortNumber=hTTPPortNumber, wirelessLinkStatus=wirelessLinkStatus, bootVersion=bootVersion, dataPortStatusTrap=dataPortStatusTrap, ethernetFiberSupport=ethernetFiberSupport, dataPortAutoNegotiation=dataPortAutoNegotiation, aggregateDataRate=aggregateDataRate, systemReset=systemReset, aAAControl=aAAControl, encryptionAlgorithm=encryptionAlgorithm, PYSNMP_MODULE_ID=cambium, alarmsGroup=alarmsGroup, vLANManagementVID=vLANManagementVID, systemClock=systemClock, sNMPTrapIPAddress=sNMPTrapIPAddress, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNTPSyncTrap=sNTPSyncTrap, vLANManagementPriority=vLANManagementPriority, vLANPriorityTableIndex=vLANPriorityTableIndex, sNMPTrapTableIndex=sNMPTrapTableIndex, secondarySoftwareVersion=secondarySoftwareVersion, ptpTraps=ptpTraps, encryption=encryption, dfsPeaks=dfsPeaks, phyStatusGroup=phyStatusGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, regionCodeTrap=regionCodeTrap, vLANPriorityTable=vLANPriorityTable, iPAddress=iPAddress, tDDSynchronizationAlarm=tDDSynchronizationAlarm, encryptionGroup=encryptionGroup, sMTPEnabledMessages=sMTPEnabledMessages, configurationGroup=configurationGroup, siteName=siteName, sNMPPortNumber=sNMPPortNumber, tDDControlGroup=tDDControlGroup, syslogClientTrap=syslogClientTrap, ptpTrapPrefix=ptpTrapPrefix, dfsGroup=dfsGroup, dataPortDisabledWarning=dataPortDisabledWarning, sMTPSourceEmailAddress=sMTPSourceEmailAddress, hTTPAccessEnabled=hTTPAccessEnabled, antennaGain=antennaGain, tDDSynchronizationMode=tDDSynchronizationMode, userTableEntry=userTableEntry, resetGroup=resetGroup, userRole=userRole, userPassword=userPassword, gatewayIPAddress=gatewayIPAddress, sNTPState=sNTPState, dfsTableIndex=dfsTableIndex, ptp500=ptp500, range=range, sNTPLastSync=sNTPLastSync, userTableNumber=userTableNumber, installArmStateTrap=installArmStateTrap, phyControlGroup=phyControlGroup, aAAControlGroup=aAAControlGroup, receiveFreqMHz=receiveFreqMHz, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, telnetPortNumber=telnetPortNumber, notificationsGroup=notificationsGroup, unitOutOfCalibration=unitOutOfCalibration, installStatus=installStatus, transmitChannel=transmitChannel, installArmState=installArmState, altitude=altitude, sNMPTrapTableNumber=sNMPTrapTableNumber, telecomsChannelStatus=telecomsChannelStatus, transmitModulationMode=transmitModulationMode, userName=userName, transmitDataRate=transmitDataRate, syslogControlGroup=syslogControlGroup, sMTPServerPortNumber=sMTPServerPortNumber, management=management)
