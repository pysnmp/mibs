...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", dfsPeaks=dfsPeaks, dataPortDisabledWarning=dataPortDisabledWarning, productName=productName, unitOutOfCalibration=unitOutOfCalibration, vLANPriorityTable=vLANPriorityTable, receiveFreqMHz=receiveFreqMHz, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPSyncTrap=sNTPSyncTrap, signalStrengthRatio=signalStrengthRatio, licenceGroup=licenceGroup, PYSNMP_MODULE_ID=cambium, management=management, dfsTableIndex=dfsTableIndex, linkModeOptimisation=linkModeOptimisation, snmpControl=snmpControl, wirelessLinkAvailability=wirelessLinkAvailability, constantPowerSpectralDensity=constantPowerSpectralDensity, alarmsGroup=alarmsGroup, targetMACAddress=targetMACAddress, productVariant=productVariant, telecomsLoopbackTrap=telecomsLoopbackTrap, masterSlaveMode=masterSlaveMode, ptpTrapPrefix=ptpTrapPrefix, installStatusTrap=installStatusTrap, userTableIndex=userTableIndex, userTable=userTable, sMTPServerIPAddress=sMTPServerIPAddress, channelBandwidth=channelBandwidth, pubStats=pubStats, cableLoss=cableLoss, transmitFreqKHz=transmitFreqKHz, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, secondarySoftwareVersion=secondarySoftwareVersion, ethernetGroup=ethernetGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, altitude=altitude, vLANPriorityTableNumber=vLANPriorityTableNumber, receiveModulationMode=receiveModulationMode, vLANPriorityTableIndex=vLANPriorityTableIndex, syslogLocalWrappedTrap=syslogLocalWrappedTrap, cambium=cambium, sMTPEnabledMessages=sMTPEnabledMessages, versions=versions, ethernetFiberSupport=ethernetFiberSupport, syslogClientTrap=syslogClientTrap, linkSymmetry=linkSymmetry, transmitChannel=transmitChannel, sNTPLastSync=sNTPLastSync, sNMPTrapTableNumber=sNMPTrapTableNumber, userTableNumber=userTableNumber, eIRP=eIRP, sNTPSync=sNTPSync, pubStatsGroup=pubStatsGroup, transmitModulationMode=transmitModulationMode, sNTPServerPortNumber=sNTPServerPortNumber, ptpTraps=ptpTraps, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, telecomGroup=telecomGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, sNTPServerIPAddress=sNTPServerIPAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, configurationGroup=configurationGroup, installStatus=installStatus, receiveDataRate=receiveDataRate, resetGroup=resetGroup, phyControlGroup=phyControlGroup, telecom=telecom, configuration=configuration, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dataPortStatusTrap=dataPortStatusTrap, sntpGroup=sntpGroup, tDDSynchronizationMode=tDDSynchronizationMode, dataPortStatus=dataPortStatus, installArmStateTrap=installArmStateTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, incompatibleRegionCodes=incompatibleRegionCodes, hTTPPortNumber=hTTPPortNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, noWirelessChannelAvailable=noWirelessChannelAvailable, encryptionAlgorithm=encryptionAlgorithm, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, range=range, userEnabled=userEnabled, antennaGain=antennaGain, wirelessLinkStatus=wirelessLinkStatus, vLANManagementPriority=vLANManagementPriority, ptmp=ptmp, tDDControlGroup=tDDControlGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, phyStatusGroup=phyStatusGroup, telecomsLineCode=telecomsLineCode, sNTPState=sNTPState, sntp=sntp, userRole=userRole, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, groupID=groupID, vLANManagementVID=vLANManagementVID, remoteIPAddress=remoteIPAddress, sNMPTrapTable=sNMPTrapTable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, gatewayIPAddress=gatewayIPAddress, maximumTransmitPower=maximumTransmitPower, encryptionGroup=encryptionGroup, aAAControl=aAAControl, regionCode=regionCode, tFTPServerPortNumber=tFTPServerPortNumber, reset=reset, receiveChannel=receiveChannel, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, userPassword=userPassword, phyStatus=phyStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, hTTPAccessEnabled=hTTPAccessEnabled, byteErrorRatio=byteErrorRatio, licence=licence, snmpControlGroup=snmpControlGroup, channelChangeTrap=channelChangeTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, dfsGroup=dfsGroup, capacityLicenseMismatch=capacityLicenseMismatch, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, frequencyVariant=frequencyVariant, aAAControlGroup=aAAControlGroup, userName=userName, accessMethod=accessMethod, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tDDControl=tDDControl, telecomsInterface=telecomsInterface, linkModeOptimizationMismatch=linkModeOptimizationMismatch, receiveModulationModeDetail=receiveModulationModeDetail, ptpCompliance=ptpCompliance, transmitFreqMHz=transmitFreqMHz, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPPortNumber=sNMPPortNumber, ptp500=ptp500, dfsTableNumber=dfsTableNumber, dfsMeans=dfsMeans, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ptp=ptp, receiveFreqKHz=receiveFreqKHz, syslogControl=syslogControl, supplementary=supplementary, sNMPTrapVersion=sNMPTrapVersion, daylightSaving=daylightSaving, sNMPv3Enable=sNMPv3Enable, systemClock=systemClock, userTableEntry=userTableEntry, alarms=alarms, sNTPPollInterval=sNTPPollInterval, telecomsCableLength=telecomsCableLength, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPCommunityString=sNMPCommunityString, receivePower=receivePower, managementGroup=managementGroup, timeZone=timeZone, latitude=latitude, sNMPEnabledTraps=sNMPEnabledTraps, incompatibleMasterAndSlave=incompatibleMasterAndSlave, siteName=siteName, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sMTPServerPortNumber=sMTPServerPortNumber, subnetMask=subnetMask, useVLANForManagementInterfaces=useVLANForManagementInterfaces, encryption=encryption, hTTPSPortNumber=hTTPSPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, longitude=longitude, phyControl=phyControl, hardwareVersion=hardwareVersion, telecomsChannelStatusTrap=telecomsChannelStatusTrap, bandwidthVariant=bandwidthVariant, syslogControlGroup=syslogControlGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortAutoMdix=dataPortAutoMdix, telecomsChannelStatus=telecomsChannelStatus, ethernet=ethernet, tFTPServerIPAddress=tFTPServerIPAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfs=dfs, dfsTableEntry=dfsTableEntry, supplementaryGroup=supplementaryGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitDataRate=transmitDataRate, syslogState=syslogState, versionsGroup=versionsGroup, sMTPEmailAlert=sMTPEmailAlert, notificationsGroup=notificationsGroup, aggregateDataRate=aggregateDataRate, syslogClient=syslogClient, ptpGroups=ptpGroups, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, linkLoss=linkLoss, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, linkName=linkName, telnetAccessEnabled=telnetAccessEnabled, vLANPriorityQueueMapping=vLANPriorityQueueMapping, vLANPriorityTableEntry=vLANPriorityTableEntry, transmitPower=transmitPower, smtp=smtp, searchState=searchState, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, telecomsLoopback=telecomsLoopback, telnetPortNumber=telnetPortNumber, licensedCapacity=licensedCapacity, regionCodeTrap=regionCodeTrap, softwareVersion=softwareVersion, systemReset=systemReset, bootVersion=bootVersion, smtpGroup=smtpGroup, installArmState=installArmState, vectorError=vectorError, iPAddress=iPAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, syslogStateTrap=syslogStateTrap, dfsTable=dfsTable)
