...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", ptpTraps=ptpTraps, resetGroup=resetGroup, telecomsCableLength=telecomsCableLength, ptpCompliance=ptpCompliance, dfsTableEntry=dfsTableEntry, vLANManagementPriority=vLANManagementPriority, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPSync=sNTPSync, versions=versions, vLANPriorityTableNumber=vLANPriorityTableNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, hardwareVersion=hardwareVersion, latitude=latitude, maximumTransmitPower=maximumTransmitPower, incompatibleRegionCodes=incompatibleRegionCodes, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, longitude=longitude, sNMPEnabledTraps=sNMPEnabledTraps, versionsGroup=versionsGroup, cableLoss=cableLoss, transmitPower=transmitPower, vectorError=vectorError, userPassword=userPassword, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, ptpTrapPrefix=ptpTrapPrefix, ptp500=ptp500, daylightSaving=daylightSaving, byteErrorRatio=byteErrorRatio, sMTPServerIPAddress=sMTPServerIPAddress, linkName=linkName, dataPortDisabledWarning=dataPortDisabledWarning, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, userTableEntry=userTableEntry, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sntp=sntp, linkModeOptimizationMismatch=linkModeOptimizationMismatch, ethernet=ethernet, snmpControl=snmpControl, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPTrapPortNumber=sNMPTrapPortNumber, eIRP=eIRP, sNMPTrapTableNumber=sNMPTrapTableNumber, telecomGroup=telecomGroup, ethernetFiberSupport=ethernetFiberSupport, licensedCapacity=licensedCapacity, bootVersion=bootVersion, receiveModulationModeDetail=receiveModulationModeDetail, supplementary=supplementary, receiveFreqKHz=receiveFreqKHz, regionCode=regionCode, productVariant=productVariant, alarmsGroup=alarmsGroup, signalStrengthRatio=signalStrengthRatio, wirelessLinkAvailability=wirelessLinkAvailability, channelChangeTrap=channelChangeTrap, tDDControl=tDDControl, channelBandwidth=channelBandwidth, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPv3Enable=sNMPv3Enable, telecom=telecom, sMTPServerPortNumber=sMTPServerPortNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, vLANPriorityTable=vLANPriorityTable, cambium=cambium, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortWirelessDownAlert=dataPortWirelessDownAlert, phyControl=phyControl, syslogClient=syslogClient, receiveChannel=receiveChannel, siteName=siteName, groupID=groupID, PYSNMP_MODULE_ID=cambium, supplementaryGroup=supplementaryGroup, reset=reset, gatewayIPAddress=gatewayIPAddress, aAAControl=aAAControl, sNMPTrapTable=sNMPTrapTable, configurationGroup=configurationGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, vLANPriorityTableEntry=vLANPriorityTableEntry, smtp=smtp, dfsPeaks=dfsPeaks, hTTPAccessEnabled=hTTPAccessEnabled, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, telecomsChannelStatus=telecomsChannelStatus, transmitModulationMode=transmitModulationMode, pubStats=pubStats, sNTPState=sNTPState, installStatusTrap=installStatusTrap, dfsTable=dfsTable, dataPortAutoMdix=dataPortAutoMdix, dfsTableNumber=dfsTableNumber, dataPortStatusTrap=dataPortStatusTrap, alarms=alarms, receiveModulationMode=receiveModulationMode, receiveDataRate=receiveDataRate, linkModeOptimisation=linkModeOptimisation, subnetMask=subnetMask, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sntpGroup=sntpGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, iPAddress=iPAddress, dfsMeans=dfsMeans, sMTPEnabledMessages=sMTPEnabledMessages, encryption=encryption, telecomsLoopback=telecomsLoopback, sNMPTrapTableIndex=sNMPTrapTableIndex, licence=licence, licenceGroup=licenceGroup, sMTPEmailAlert=sMTPEmailAlert, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, aAAControlGroup=aAAControlGroup, telnetPortNumber=telnetPortNumber, bandwidthVariant=bandwidthVariant, targetMACAddress=targetMACAddress, snmpControlGroup=snmpControlGroup, notificationsGroup=notificationsGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapVersion=sNMPTrapVersion, telecomsChannelStatusTrap=telecomsChannelStatusTrap, userRole=userRole, systemClock=systemClock, linkSymmetry=linkSymmetry, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapIPAddress=sNMPTrapIPAddress, userTableNumber=userTableNumber, linkLoss=linkLoss, transmitDataRate=transmitDataRate, telnetAccessEnabled=telnetAccessEnabled, sNMPPortNumber=sNMPPortNumber, dataPortStatus=dataPortStatus, range=range, installStatus=installStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, frequencyVariant=frequencyVariant, tFTPServerIPAddress=tFTPServerIPAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsGroup=dfsGroup, encryptionGroup=encryptionGroup, encryptionAlgorithm=encryptionAlgorithm, syslogControl=syslogControl, sNTPServerPortNumber=sNTPServerPortNumber, sNTPPollInterval=sNTPPollInterval, userTableIndex=userTableIndex, telecomsLineCode=telecomsLineCode, sNTPServerIPAddress=sNTPServerIPAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, accessMethod=accessMethod, constantPowerSpectralDensity=constantPowerSpectralDensity, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitFreqMHz=transmitFreqMHz, phyStatus=phyStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, pubStatsGroup=pubStatsGroup, receivePower=receivePower, unitOutOfCalibration=unitOutOfCalibration, regionCodeTrap=regionCodeTrap, configuration=configuration, smtpGroup=smtpGroup, userTable=userTable, dfsTableIndex=dfsTableIndex, remoteIPAddress=remoteIPAddress, sNTPLastSync=sNTPLastSync, altitude=altitude, capacityLicenseMismatch=capacityLicenseMismatch, tDDSynchronizationMode=tDDSynchronizationMode, hTTPSPortNumber=hTTPSPortNumber, phyControlGroup=phyControlGroup, syslogState=syslogState, userEnabled=userEnabled, aggregateDataRate=aggregateDataRate, tDDSynchronizationStatus=tDDSynchronizationStatus, telecomsInterface=telecomsInterface, tDDControlGroup=tDDControlGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ptmp=ptmp, softwareVersion=softwareVersion, dfs=dfs, wirelessLinkStatus=wirelessLinkStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, productName=productName, management=management, installArmStateTrap=installArmStateTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, masterSlaveMode=masterSlaveMode, vLANManagementVID=vLANManagementVID, syslogStateTrap=syslogStateTrap, ethernetGroup=ethernetGroup, managementGroup=managementGroup, antennaGain=antennaGain, hTTPPortNumber=hTTPPortNumber, tFTPServerPortNumber=tFTPServerPortNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ptpGroups=ptpGroups, sNMPCommunityString=sNMPCommunityString, receiveFreqMHz=receiveFreqMHz, syslogControlGroup=syslogControlGroup, ptp=ptp, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, phyStatusGroup=phyStatusGroup, searchState=searchState, syslogLocalWrappedTrap=syslogLocalWrappedTrap, systemReset=systemReset, secondarySoftwareVersion=secondarySoftwareVersion, userName=userName, timeZone=timeZone, vLANPriorityTableIndex=vLANPriorityTableIndex, transmitChannel=transmitChannel, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNTPSyncTrap=sNTPSyncTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, installArmState=installArmState, transmitFreqKHz=transmitFreqKHz, syslogClientTrap=syslogClientTrap)
