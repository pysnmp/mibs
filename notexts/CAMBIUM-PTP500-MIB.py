...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sNTPLastSync=sNTPLastSync, dfsTableEntry=dfsTableEntry, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, syslogState=syslogState, bandwidthVariant=bandwidthVariant, regionCodeTrap=regionCodeTrap, vectorError=vectorError, sNMPCommunityString=sNMPCommunityString, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, syslogClientTrap=syslogClientTrap, sNMPTrapTable=sNMPTrapTable, vLANPriorityTable=vLANPriorityTable, constantPowerSpectralDensity=constantPowerSpectralDensity, receiveFreqKHz=receiveFreqKHz, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, channelChangeTrap=channelChangeTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPEnabledTraps=sNMPEnabledTraps, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, telnetAccessEnabled=telnetAccessEnabled, sNMPPortNumber=sNMPPortNumber, tDDControlGroup=tDDControlGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, receiveChannel=receiveChannel, aggregateDataRate=aggregateDataRate, userName=userName, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tDDSynchronizationStatus=tDDSynchronizationStatus, configuration=configuration, userTableEntry=userTableEntry, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, latitude=latitude, tFTPServerIPAddress=tFTPServerIPAddress, targetMACAddress=targetMACAddress, masterSlaveMode=masterSlaveMode, dfs=dfs, configurationGroup=configurationGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, management=management, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, phyControl=phyControl, signalStrengthRatio=signalStrengthRatio, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ptpGroups=ptpGroups, noWirelessChannelAvailable=noWirelessChannelAvailable, installArmStateTrap=installArmStateTrap, supplementary=supplementary, installArmState=installArmState, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfsTable=dfsTable, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfsPeaks=dfsPeaks, linkSymmetry=linkSymmetry, userTableNumber=userTableNumber, iPAddress=iPAddress, userPassword=userPassword, userEnabled=userEnabled, userTableIndex=userTableIndex, hTTPSPortNumber=hTTPSPortNumber, phyStatus=phyStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, phyControlGroup=phyControlGroup, sNMPTrapVersion=sNMPTrapVersion, sNTPSync=sNTPSync, wirelessLinkAvailability=wirelessLinkAvailability, longitude=longitude, unitOutOfCalibration=unitOutOfCalibration, PYSNMP_MODULE_ID=cambium, channelBandwidth=channelBandwidth, installStatus=installStatus, regionCode=regionCode, ethernet=ethernet, telnetPortNumber=telnetPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, capacityLicenseMismatch=capacityLicenseMismatch, dfsMeans=dfsMeans, syslogClient=syslogClient, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, alarmsGroup=alarmsGroup, sNMPv3Enable=sNMPv3Enable, notificationsGroup=notificationsGroup, receiveModulationMode=receiveModulationMode, resetGroup=resetGroup, incompatibleRegionCodes=incompatibleRegionCodes, vLANPriorityTableEntry=vLANPriorityTableEntry, pubStats=pubStats, userTable=userTable, byteErrorRatio=byteErrorRatio, encryption=encryption, sMTPServerIPAddress=sMTPServerIPAddress, maximumTransmitPower=maximumTransmitPower, transmitPower=transmitPower, dfsGroup=dfsGroup, telecomGroup=telecomGroup, linkName=linkName, sntp=sntp, sNMPTrapTableEntry=sNMPTrapTableEntry, telecomsLineCode=telecomsLineCode, bootVersion=bootVersion, cableLoss=cableLoss, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, linkLoss=linkLoss, telecomsChannelStatusTrap=telecomsChannelStatusTrap, aAAControlGroup=aAAControlGroup, telecomsCableLength=telecomsCableLength, sNTPSyncTrap=sNTPSyncTrap, licenceGroup=licenceGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, telecomsInterface=telecomsInterface, telecomsLoopbackTrap=telecomsLoopbackTrap, userRole=userRole, ptp=ptp, hTTPPortNumber=hTTPPortNumber, sNTPPollInterval=sNTPPollInterval, productVariant=productVariant, groupID=groupID, useVLANForManagementInterfaces=useVLANForManagementInterfaces, daylightSaving=daylightSaving, softwareVersion=softwareVersion, eIRP=eIRP, vLANManagementPriority=vLANManagementPriority, sNTPServerIPAddress=sNTPServerIPAddress, frequencyVariant=frequencyVariant, systemClock=systemClock, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, altitude=altitude, ptmp=ptmp, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, range=range, siteName=siteName, syslogControlGroup=syslogControlGroup, receiveModulationModeDetail=receiveModulationModeDetail, subnetMask=subnetMask, secondarySoftwareVersion=secondarySoftwareVersion, receivePower=receivePower, hTTPAccessEnabled=hTTPAccessEnabled, ptpCompliance=ptpCompliance, dataPortConfigurationMismatch=dataPortConfigurationMismatch, alarms=alarms, dataPortStatus=dataPortStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, licensedCapacity=licensedCapacity, sMTPServerPortNumber=sMTPServerPortNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, transmitModulationMode=transmitModulationMode, sNMPTrapIPAddress=sNMPTrapIPAddress, managementGroup=managementGroup, telecomsChannelStatus=telecomsChannelStatus, transmitChannel=transmitChannel, telecom=telecom, ptpTraps=ptpTraps, receiveDataRate=receiveDataRate, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, syslogControl=syslogControl, ethernetGroup=ethernetGroup, productName=productName, dataPortWirelessDownAlert=dataPortWirelessDownAlert, encryptionGroup=encryptionGroup, versions=versions, vLANManagementVID=vLANManagementVID, receiveFreqMHz=receiveFreqMHz, hardwareVersion=hardwareVersion, accessMethod=accessMethod, snmpControlGroup=snmpControlGroup, sNTPState=sNTPState, sntpGroup=sntpGroup, pubStatsGroup=pubStatsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, snmpControl=snmpControl, ethernetFiberSupport=ethernetFiberSupport, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, transmitDataRate=transmitDataRate, vLANPriorityQueueMapping=vLANPriorityQueueMapping, remoteIPAddress=remoteIPAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, installStatusTrap=installStatusTrap, supplementaryGroup=supplementaryGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsTableNumber=dfsTableNumber, ptp500=ptp500, phyStatusGroup=phyStatusGroup, aAAControl=aAAControl, searchState=searchState, encryptionAlgorithm=encryptionAlgorithm, dataPortAutoMdix=dataPortAutoMdix, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sMTPEnabledMessages=sMTPEnabledMessages, syslogStateTrap=syslogStateTrap, sNTPServerPortNumber=sNTPServerPortNumber, dataPortStatusTrap=dataPortStatusTrap, dataPortDisabledWarning=dataPortDisabledWarning, wirelessLinkStatus=wirelessLinkStatus, tDDSynchronizationMode=tDDSynchronizationMode, reset=reset, timeZone=timeZone, sMTPEmailAlert=sMTPEmailAlert, antennaGain=antennaGain, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, systemReset=systemReset, ptpTrapPrefix=ptpTrapPrefix, telecomsLoopback=telecomsLoopback, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dfsTableIndex=dfsTableIndex, versionsGroup=versionsGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, cambium=cambium, gatewayIPAddress=gatewayIPAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, smtpGroup=smtpGroup, smtp=smtp, licence=licence, transmitFreqMHz=transmitFreqMHz, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, linkModeOptimisation=linkModeOptimisation, tFTPServerPortNumber=tFTPServerPortNumber, tDDControl=tDDControl, transmitFreqKHz=transmitFreqKHz)
