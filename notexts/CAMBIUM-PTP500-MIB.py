...
# Produced by pysmi-1.1.3 at Wed Dec  8 19:05:39 2021
...
ModuleIdentity, IpAddress, Unsigned32, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter32, Counter64, Gauge32, Integer32, Bits, ObjectIdentity, enterprises, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "IpAddress", "Unsigned32", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter32", "Counter64", "Gauge32", "Integer32", "Bits", "ObjectIdentity", "enterprises", "TimeTicks")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", alarms=alarms, subnetMask=subnetMask, receivePower=receivePower, eIRP=eIRP, sNMPTrapTableIndex=sNMPTrapTableIndex, groupID=groupID, telecomsCableLength=telecomsCableLength, transmitPower=transmitPower, hTTPPortNumber=hTTPPortNumber, syslogState=syslogState, range=range, ethernetGroup=ethernetGroup, receiveFreqKHz=receiveFreqKHz, sNTPPollInterval=sNTPPollInterval, snmpControl=snmpControl, userRole=userRole, searchState=searchState, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, installStatus=installStatus, ptp500=ptp500, notificationsGroup=notificationsGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tDDSynchronizationAlarm=tDDSynchronizationAlarm, vectorError=vectorError, sNTPSync=sNTPSync, latitude=latitude, licenceGroup=licenceGroup, transmitDataRate=transmitDataRate, sNMPTrapTableNumber=sNMPTrapTableNumber, hardwareVersion=hardwareVersion, userEnabled=userEnabled, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, longitude=longitude, supplementaryGroup=supplementaryGroup, frequencyVariant=frequencyVariant, phyStatus=phyStatus, telecomsLoopbackTrap=telecomsLoopbackTrap, vLANPriorityQueueMapping=vLANPriorityQueueMapping, altitude=altitude, vLANPriorityTableEntry=vLANPriorityTableEntry, dataPortConfigurationMismatch=dataPortConfigurationMismatch, tFTPServerIPAddress=tFTPServerIPAddress, phyControlGroup=phyControlGroup, vLANPriorityTable=vLANPriorityTable, userTable=userTable, installStatusTrap=installStatusTrap, receiveChannel=receiveChannel, PYSNMP_MODULE_ID=cambium, telecomsInterface=telecomsInterface, encryptionGroup=encryptionGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, telecomsLoopback=telecomsLoopback, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, versions=versions, sMTPServerIPAddress=sMTPServerIPAddress, dataPortDisabledWarning=dataPortDisabledWarning, configuration=configuration, sNMPCommunityString=sNMPCommunityString, sMTPServerPortNumber=sMTPServerPortNumber, ptpTraps=ptpTraps, softwareVersion=softwareVersion, receiveModulationModeDetail=receiveModulationModeDetail, targetMACAddress=targetMACAddress, telecom=telecom, phyStatusGroup=phyStatusGroup, wirelessLinkAvailability=wirelessLinkAvailability, tDDSynchronizationStatus=tDDSynchronizationStatus, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortWirelessDownAlert=dataPortWirelessDownAlert, accessMethod=accessMethod, secondarySoftwareVersion=secondarySoftwareVersion, hTTPSAccessEnabled=hTTPSAccessEnabled, aggregateDataRate=aggregateDataRate, receiveModulationMode=receiveModulationMode, transmitFreqMHz=transmitFreqMHz, receiveFreqMHz=receiveFreqMHz, sMTPSourceEmailAddress=sMTPSourceEmailAddress, cableLoss=cableLoss, configurationGroup=configurationGroup, dataPortStatusTrap=dataPortStatusTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, smtpGroup=smtpGroup, userTableEntry=userTableEntry, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPServerIPAddress=sNTPServerIPAddress, encryption=encryption, telnetPortNumber=telnetPortNumber, capacityLicenseMismatch=capacityLicenseMismatch, syslogLocalWrappedTrap=syslogLocalWrappedTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, resetGroup=resetGroup, userTableNumber=userTableNumber, dfsTableNumber=dfsTableNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, linkModeOptimisation=linkModeOptimisation, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapPortNumber=sNMPTrapPortNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, installArmStateTrap=installArmStateTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, signalStrengthRatio=signalStrengthRatio, telnetAccessEnabled=telnetAccessEnabled, productVariant=productVariant, transmitFreqKHz=transmitFreqKHz, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, hTTPAccessEnabled=hTTPAccessEnabled, hTTPSPortNumber=hTTPSPortNumber, vLANPriorityTableIndex=vLANPriorityTableIndex, siteName=siteName, tDDControlGroup=tDDControlGroup, encryptionAlgorithm=encryptionAlgorithm, cambium=cambium, telecomGroup=telecomGroup, masterSlaveMode=masterSlaveMode, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPEnabledTraps=sNMPEnabledTraps, ptp=ptp, dfsTable=dfsTable, sNTPLastSync=sNTPLastSync, byteErrorRatio=byteErrorRatio, sNTPState=sNTPState, sNTPServerPortNumber=sNTPServerPortNumber, dfsTableIndex=dfsTableIndex, versionsGroup=versionsGroup, aAAControl=aAAControl, regionCode=regionCode, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, linkName=linkName, sNMPv3Enable=sNMPv3Enable, ptpGroups=ptpGroups, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, timeZone=timeZone, wirelessLinkStatus=wirelessLinkStatus, tFTPServerPortNumber=tFTPServerPortNumber, antennaGain=antennaGain, telecomsChannelStatus=telecomsChannelStatus, systemClock=systemClock, systemReset=systemReset, userPassword=userPassword, incompatibleRegionCodes=incompatibleRegionCodes, ethernet=ethernet, smtp=smtp, ptpTrapPrefix=ptpTrapPrefix, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tDDControl=tDDControl, dfsMeans=dfsMeans, dfsGroup=dfsGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, installArmState=installArmState, transmitModulationMode=transmitModulationMode, noWirelessChannelAvailable=noWirelessChannelAvailable, sNTPSyncTrap=sNTPSyncTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, pubStats=pubStats, sNMPTrapVersion=sNMPTrapVersion, syslogClient=syslogClient, dataPortStatus=dataPortStatus, sntpGroup=sntpGroup, ptpCompliance=ptpCompliance, sNMPTrapIPAddress=sNMPTrapIPAddress, syslogClientTrap=syslogClientTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sMTPEmailAlert=sMTPEmailAlert, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dfsTableEntry=dfsTableEntry, supplementary=supplementary, sNMPPortNumber=sNMPPortNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, licence=licence, ethernetFiberSupport=ethernetFiberSupport, linkSymmetry=linkSymmetry, sNMPTrapTable=sNMPTrapTable, channelChangeTrap=channelChangeTrap, syslogControlGroup=syslogControlGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsPeaks=dfsPeaks, receiveDataRate=receiveDataRate, transmitChannel=transmitChannel, sntp=sntp, ptmp=ptmp, syslogControl=syslogControl, tDDSynchronizationMode=tDDSynchronizationMode, sMTPEnabledMessages=sMTPEnabledMessages, userTableIndex=userTableIndex, dfs=dfs, bandwidthVariant=bandwidthVariant, aAAControlGroup=aAAControlGroup, gatewayIPAddress=gatewayIPAddress, productName=productName, linkLoss=linkLoss, telecomsLineCode=telecomsLineCode, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, unitOutOfCalibration=unitOutOfCalibration, managementGroup=managementGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, remoteIPAddress=remoteIPAddress, alarmsGroup=alarmsGroup, syslogStateTrap=syslogStateTrap, channelBandwidth=channelBandwidth, daylightSaving=daylightSaving, phyControl=phyControl, pubStatsGroup=pubStatsGroup, iPAddress=iPAddress, maximumTransmitPower=maximumTransmitPower, licensedCapacity=licensedCapacity, reset=reset, sNMPTrapTableEntry=sNMPTrapTableEntry, linkModeOptimizationMismatch=linkModeOptimizationMismatch, vLANManagementVID=vLANManagementVID, regionCodeTrap=regionCodeTrap, snmpControlGroup=snmpControlGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortAutoMdix=dataPortAutoMdix, vLANManagementPriority=vLANManagementPriority, bootVersion=bootVersion, management=management, telecomsChannelStatusTrap=telecomsChannelStatusTrap, userName=userName)
