...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", vLANPriorityTableEntry=vLANPriorityTableEntry, encryptionGroup=encryptionGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, gatewayIPAddress=gatewayIPAddress, bandwidthVariant=bandwidthVariant, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogControl=syslogControl, receiveFreqMHz=receiveFreqMHz, searchState=searchState, systemReset=systemReset, telecomsChannelStatus=telecomsChannelStatus, dfsTableNumber=dfsTableNumber, dfsTableIndex=dfsTableIndex, incompatibleMasterAndSlave=incompatibleMasterAndSlave, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, userEnabled=userEnabled, tFTPServerIPAddress=tFTPServerIPAddress, sNTPServerIPAddress=sNTPServerIPAddress, transmitModulationMode=transmitModulationMode, telnetAccessEnabled=telnetAccessEnabled, vLANManagementPriority=vLANManagementPriority, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptpGroups=ptpGroups, vLANManagementVID=vLANManagementVID, sNTPLastSync=sNTPLastSync, pubStats=pubStats, installArmState=installArmState, cableLoss=cableLoss, telecom=telecom, licence=licence, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, transmitFreqKHz=transmitFreqKHz, vLANPriorityTable=vLANPriorityTable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, supplementary=supplementary, ptpTrapPrefix=ptpTrapPrefix, userTableIndex=userTableIndex, hTTPSAccessEnabled=hTTPSAccessEnabled, PYSNMP_MODULE_ID=cambium, telecomsChannelStatusTrap=telecomsChannelStatusTrap, aAAControl=aAAControl, dfsPeaks=dfsPeaks, receiveChannel=receiveChannel, dataPortDisabledWarning=dataPortDisabledWarning, maximumTransmitPower=maximumTransmitPower, sNMPPortNumber=sNMPPortNumber, channelBandwidth=channelBandwidth, notificationsGroup=notificationsGroup, sNMPTrapTable=sNMPTrapTable, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptpCompliance=ptpCompliance, vLANPriorityTableIndex=vLANPriorityTableIndex, receiveModulationModeDetail=receiveModulationModeDetail, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, softwareVersion=softwareVersion, remoteMaximumTransmitPower=remoteMaximumTransmitPower, installStatus=installStatus, configurationGroup=configurationGroup, encryptionAlgorithm=encryptionAlgorithm, longitude=longitude, syslogState=syslogState, hTTPPortNumber=hTTPPortNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPTrapVersion=sNMPTrapVersion, supplementaryGroup=supplementaryGroup, sNTPServerPortNumber=sNTPServerPortNumber, groupID=groupID, sMTPEmailAlert=sMTPEmailAlert, tDDControl=tDDControl, dfs=dfs, phyControl=phyControl, snmpControl=snmpControl, dfsTableEntry=dfsTableEntry, dfsMeans=dfsMeans, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, userPassword=userPassword, syslogClient=syslogClient, ethernet=ethernet, userTableEntry=userTableEntry, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, frequencyVariant=frequencyVariant, pubStatsGroup=pubStatsGroup, vectorError=vectorError, installArmStateTrap=installArmStateTrap, ethernetFiberSupport=ethernetFiberSupport, dataPortWirelessDownAlert=dataPortWirelessDownAlert, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, telecomsInterface=telecomsInterface, telnetPortNumber=telnetPortNumber, transmitChannel=transmitChannel, wirelessLinkStatus=wirelessLinkStatus, sMTPEnabledMessages=sMTPEnabledMessages, systemClock=systemClock, sNMPEnabledTraps=sNMPEnabledTraps, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, sNTPSyncTrap=sNTPSyncTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, phyControlGroup=phyControlGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, encryption=encryption, cambium=cambium, linkModeOptimisation=linkModeOptimisation, receivePower=receivePower, sNMPTrapPortNumber=sNMPTrapPortNumber, linkName=linkName, sNMPTrapTableIndex=sNMPTrapTableIndex, eIRP=eIRP, dfsGroup=dfsGroup, userTable=userTable, regionCode=regionCode, regionCodeTrap=regionCodeTrap, receiveFreqKHz=receiveFreqKHz, noWirelessChannelAvailable=noWirelessChannelAvailable, reset=reset, channelChangeTrap=channelChangeTrap, dataPortStatus=dataPortStatus, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, telecomsLoopback=telecomsLoopback, dataPortConfigurationMismatch=dataPortConfigurationMismatch, siteName=siteName, wirelessLinkAvailability=wirelessLinkAvailability, alarmsGroup=alarmsGroup, transmitFreqMHz=transmitFreqMHz, aAAControlGroup=aAAControlGroup, hTTPAccessEnabled=hTTPAccessEnabled, alarms=alarms, tDDControlGroup=tDDControlGroup, sNTPPollInterval=sNTPPollInterval, phyStatus=phyStatus, sNTPState=sNTPState, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNTPSync=sNTPSync, syslogClientTrap=syslogClientTrap, range=range, sNMPCommunityString=sNMPCommunityString, productName=productName, transmitDataRate=transmitDataRate, installStatusTrap=installStatusTrap, ptpTraps=ptpTraps, dfsTable=dfsTable, userTableNumber=userTableNumber, sNMPv3Enable=sNMPv3Enable, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sntpGroup=sntpGroup, incompatibleRegionCodes=incompatibleRegionCodes, bootVersion=bootVersion, sNMPTrapIPAddress=sNMPTrapIPAddress, timeZone=timeZone, ethernetGroup=ethernetGroup, telecomGroup=telecomGroup, smtpGroup=smtpGroup, phyStatusGroup=phyStatusGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, userRole=userRole, versions=versions, useVLANForManagementInterfaces=useVLANForManagementInterfaces, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, userName=userName, ptp=ptp, linkSymmetry=linkSymmetry, telecomsLineCode=telecomsLineCode, accessMethod=accessMethod, productVariant=productVariant, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, hTTPSPortNumber=hTTPSPortNumber, hardwareVersion=hardwareVersion, latitude=latitude, altitude=altitude, targetMACAddress=targetMACAddress, licensedCapacity=licensedCapacity, sMTPServerPortNumber=sMTPServerPortNumber, sntp=sntp, receiveDataRate=receiveDataRate, remoteIPAddress=remoteIPAddress, snmpControlGroup=snmpControlGroup, syslogControlGroup=syslogControlGroup, aggregateDataRate=aggregateDataRate, ptmp=ptmp, ptp500=ptp500, tFTPServerPortNumber=tFTPServerPortNumber, resetGroup=resetGroup, secondarySoftwareVersion=secondarySoftwareVersion, linkLoss=linkLoss, dataPortStatusTrap=dataPortStatusTrap, signalStrengthRatio=signalStrengthRatio, receiveModulationMode=receiveModulationMode, managementGroup=managementGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, management=management, vLANPriorityQueueMapping=vLANPriorityQueueMapping, unitOutOfCalibration=unitOutOfCalibration, licenceGroup=licenceGroup, smtp=smtp, subnetMask=subnetMask, sMTPServerIPAddress=sMTPServerIPAddress, capacityLicenseMismatch=capacityLicenseMismatch, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, transmitPower=transmitPower, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, configuration=configuration, tDDSynchronizationAlarm=tDDSynchronizationAlarm, telecomsLoopbackTrap=telecomsLoopbackTrap, iPAddress=iPAddress, byteErrorRatio=byteErrorRatio, versionsGroup=versionsGroup, tDDSynchronizationMode=tDDSynchronizationMode, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortAutoMdix=dataPortAutoMdix, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, antennaGain=antennaGain, syslogStateTrap=syslogStateTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, daylightSaving=daylightSaving, masterSlaveMode=masterSlaveMode, telecomsCableLength=telecomsCableLength)
