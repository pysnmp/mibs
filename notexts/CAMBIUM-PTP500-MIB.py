...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", installArmState=installArmState, receiveModulationModeDetail=receiveModulationModeDetail, transmitFreqKHz=transmitFreqKHz, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dfs=dfs, sNTPState=sNTPState, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, masterSlaveMode=masterSlaveMode, telecom=telecom, channelBandwidth=channelBandwidth, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, receiveModulationMode=receiveModulationMode, noWirelessChannelAvailable=noWirelessChannelAvailable, receiveFreqMHz=receiveFreqMHz, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, aggregateDataRate=aggregateDataRate, dataPortConfigurationMismatch=dataPortConfigurationMismatch, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, encryptionGroup=encryptionGroup, softwareVersion=softwareVersion, ptpCompliance=ptpCompliance, versionsGroup=versionsGroup, sNTPServerIPAddress=sNTPServerIPAddress, wirelessLinkAvailability=wirelessLinkAvailability, configuration=configuration, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, eIRP=eIRP, productVariant=productVariant, ethernet=ethernet, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, maximumTransmitPower=maximumTransmitPower, transmitChannel=transmitChannel, antennaGain=antennaGain, userRole=userRole, installStatus=installStatus, hTTPAccessEnabled=hTTPAccessEnabled, transmitModulationMode=transmitModulationMode, linkModeOptimizationMismatch=linkModeOptimizationMismatch, incompatibleMasterAndSlave=incompatibleMasterAndSlave, byteErrorRatio=byteErrorRatio, userName=userName, vLANManagementVID=vLANManagementVID, sNMPv3Enable=sNMPv3Enable, userPassword=userPassword, licenceGroup=licenceGroup, tDDControlGroup=tDDControlGroup, dfsTable=dfsTable, aAAControlGroup=aAAControlGroup, daylightSaving=daylightSaving, userEnabled=userEnabled, sNMPTrapTableEntry=sNMPTrapTableEntry, vLANPriorityQueueMapping=vLANPriorityQueueMapping, linkName=linkName, receivePower=receivePower, syslogClientTrap=syslogClientTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ptpTrapPrefix=ptpTrapPrefix, unitOutOfCalibration=unitOutOfCalibration, targetMACAddress=targetMACAddress, regionCodeTrap=regionCodeTrap, smtp=smtp, hTTPSPortNumber=hTTPSPortNumber, hardwareVersion=hardwareVersion, transmitDataRate=transmitDataRate, sNMPTrapTable=sNMPTrapTable, receiveChannel=receiveChannel, sNMPEnabledTraps=sNMPEnabledTraps, notificationsGroup=notificationsGroup, telecomsChannelStatusTrap=telecomsChannelStatusTrap, syslogState=syslogState, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNTPLastSync=sNTPLastSync, ethernetGroup=ethernetGroup, sNMPPortNumber=sNMPPortNumber, dataPortStatusTrap=dataPortStatusTrap, linkLoss=linkLoss, subnetMask=subnetMask, syslogControl=syslogControl, incompatibleRegionCodes=incompatibleRegionCodes, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sMTPServerPortNumber=sMTPServerPortNumber, telecomGroup=telecomGroup, ptp500=ptp500, capacityLicenseMismatch=capacityLicenseMismatch, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapVersion=sNMPTrapVersion, accessMethod=accessMethod, linkModeOptimisation=linkModeOptimisation, hTTPPortNumber=hTTPPortNumber, resetGroup=resetGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tFTPServerPortNumber=tFTPServerPortNumber, management=management, versions=versions, latitude=latitude, frequencyVariant=frequencyVariant, dataPortAutoNegotiation=dataPortAutoNegotiation, channelChangeTrap=channelChangeTrap, encryption=encryption, vLANPriorityTableIndex=vLANPriorityTableIndex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPEmailAlert=sMTPEmailAlert, dfsTableNumber=dfsTableNumber, userTableEntry=userTableEntry, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, bandwidthVariant=bandwidthVariant, bootVersion=bootVersion, sNMPTrapTableNumber=sNMPTrapTableNumber, encryptionAlgorithm=encryptionAlgorithm, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, installStatusTrap=installStatusTrap, PYSNMP_MODULE_ID=cambium, hTTPSAccessEnabled=hTTPSAccessEnabled, secondarySoftwareVersion=secondarySoftwareVersion, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, aAAControl=aAAControl, linkSymmetry=linkSymmetry, cambium=cambium, receiveFreqKHz=receiveFreqKHz, licence=licence, transmitPower=transmitPower, productName=productName, ptpGroups=ptpGroups, phyStatusGroup=phyStatusGroup, smtpGroup=smtpGroup, cableLoss=cableLoss, tDDSynchronizationMode=tDDSynchronizationMode, searchState=searchState, telnetPortNumber=telnetPortNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tDDControl=tDDControl, sNMPTrapPortNumber=sNMPTrapPortNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, pubStatsGroup=pubStatsGroup, licensedCapacity=licensedCapacity, receiveDataRate=receiveDataRate, gatewayIPAddress=gatewayIPAddress, dataPortStatus=dataPortStatus, alarmsGroup=alarmsGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, phyStatus=phyStatus, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, systemClock=systemClock, dfsGroup=dfsGroup, userTable=userTable, sNMPCommunityString=sNMPCommunityString, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, iPAddress=iPAddress, vLANPriorityTable=vLANPriorityTable, tFTPServerIPAddress=tFTPServerIPAddress, syslogClient=syslogClient, sNTPPollInterval=sNTPPollInterval, sMTPSourceEmailAddress=sMTPSourceEmailAddress, syslogControlGroup=syslogControlGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, sMTPEnabledMessages=sMTPEnabledMessages, supplementary=supplementary, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, syslogStateTrap=syslogStateTrap, telecomsChannelStatus=telecomsChannelStatus, range=range, tDDSynchronizationStatus=tDDSynchronizationStatus, userTableIndex=userTableIndex, sNTPServerPortNumber=sNTPServerPortNumber, transmitFreqMHz=transmitFreqMHz, telecomsLineCode=telecomsLineCode, longitude=longitude, sNTPSyncTrap=sNTPSyncTrap, alarms=alarms, phyControl=phyControl, phyControlGroup=phyControlGroup, siteName=siteName, constantPowerSpectralDensity=constantPowerSpectralDensity, timeZone=timeZone, dataPortDisabledWarning=dataPortDisabledWarning, sntp=sntp, ptmp=ptmp, installArmStateTrap=installArmStateTrap, supplementaryGroup=supplementaryGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sntpGroup=sntpGroup, telecomsLoopbackTrap=telecomsLoopbackTrap, ptpTraps=ptpTraps, vLANManagementPriority=vLANManagementPriority, signalStrengthRatio=signalStrengthRatio, ethernetFiberSupport=ethernetFiberSupport, telecomsLoopback=telecomsLoopback, userTableNumber=userTableNumber, telecomsInterface=telecomsInterface, remoteIPAddress=remoteIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, groupID=groupID, wirelessLinkStatus=wirelessLinkStatus, snmpControlGroup=snmpControlGroup, configurationGroup=configurationGroup, dfsMeans=dfsMeans, regionCode=regionCode, telecomsCableLength=telecomsCableLength, sNTPSync=sNTPSync, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, vectorError=vectorError, ptp=ptp, managementGroup=managementGroup, dataPortAutoMdix=dataPortAutoMdix, systemReset=systemReset, reset=reset, vLANPriorityTableNumber=vLANPriorityTableNumber, dfsTableIndex=dfsTableIndex, dfsTableEntry=dfsTableEntry, telnetAccessEnabled=telnetAccessEnabled, altitude=altitude, dfsPeaks=dfsPeaks, snmpControl=snmpControl, pubStats=pubStats, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement)
