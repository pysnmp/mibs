...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", transmitDataRate=transmitDataRate, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, telecomsLineCode=telecomsLineCode, sntpGroup=sntpGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tFTPServerIPAddress=tFTPServerIPAddress, phyStatus=phyStatus, dataPortDisabledWarning=dataPortDisabledWarning, dataPortWirelessDownAlert=dataPortWirelessDownAlert, receiveModulationModeDetail=receiveModulationModeDetail, sNMPTrapTableNumber=sNMPTrapTableNumber, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, installStatus=installStatus, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, vectorError=vectorError, telnetAccessEnabled=telnetAccessEnabled, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, vLANPriorityTableEntry=vLANPriorityTableEntry, transmitFreqMHz=transmitFreqMHz, management=management, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dfsTable=dfsTable, userName=userName, gatewayIPAddress=gatewayIPAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, aggregateDataRate=aggregateDataRate, userRole=userRole, telnetPortNumber=telnetPortNumber, receiveFreqMHz=receiveFreqMHz, ptpTraps=ptpTraps, regionCode=regionCode, sMTPServerIPAddress=sMTPServerIPAddress, iPAddress=iPAddress, hardwareVersion=hardwareVersion, systemReset=systemReset, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, vLANPriorityTableNumber=vLANPriorityTableNumber, configurationGroup=configurationGroup, ethernetFiberSupport=ethernetFiberSupport, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vLANPriorityTableIndex=vLANPriorityTableIndex, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tFTPServerPortNumber=tFTPServerPortNumber, receivePower=receivePower, sNMPPortNumber=sNMPPortNumber, wirelessLinkStatus=wirelessLinkStatus, licenceGroup=licenceGroup, linkModeOptimisation=linkModeOptimisation, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapPortNumber=sNMPTrapPortNumber, dfsTableEntry=dfsTableEntry, phyControlGroup=phyControlGroup, ptpGroups=ptpGroups, sNTPSync=sNTPSync, antennaGain=antennaGain, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortStatusTrap=dataPortStatusTrap, smtp=smtp, byteErrorRatio=byteErrorRatio, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNTPServerIPAddress=sNTPServerIPAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, range=range, ptp=ptp, timeZone=timeZone, configuration=configuration, productName=productName, receiveModulationMode=receiveModulationMode, sNTPLastSync=sNTPLastSync, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, vLANManagementVID=vLANManagementVID, signalStrengthRatio=signalStrengthRatio, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortConfigurationMismatch=dataPortConfigurationMismatch, encryptionAlgorithm=encryptionAlgorithm, aAAControl=aAAControl, noWirelessChannelAvailable=noWirelessChannelAvailable, maximumTransmitPower=maximumTransmitPower, versions=versions, userTableIndex=userTableIndex, dfsTableIndex=dfsTableIndex, syslogState=syslogState, installStatusTrap=installStatusTrap, sNMPEnabledTraps=sNMPEnabledTraps, dfsTableNumber=dfsTableNumber, snmpControlGroup=snmpControlGroup, syslogControl=syslogControl, siteName=siteName, alarms=alarms, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNMPTrapIPAddress=sNMPTrapIPAddress, transmitModulationMode=transmitModulationMode, masterSlaveMode=masterSlaveMode, wirelessLinkAvailability=wirelessLinkAvailability, ptmp=ptmp, receiveDataRate=receiveDataRate, telecomsLoopback=telecomsLoopback, longitude=longitude, sNMPTrapTableIndex=sNMPTrapTableIndex, linkLoss=linkLoss, incompatibleMasterAndSlave=incompatibleMasterAndSlave, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, notificationsGroup=notificationsGroup, resetGroup=resetGroup, installArmState=installArmState, unitOutOfCalibration=unitOutOfCalibration, latitude=latitude, frequencyVariant=frequencyVariant, daylightSaving=daylightSaving, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, pubStatsGroup=pubStatsGroup, searchState=searchState, softwareVersion=softwareVersion, ptp500=ptp500, hTTPSAccessEnabled=hTTPSAccessEnabled, vLANPriorityQueueMapping=vLANPriorityQueueMapping, dataPortAutoMdix=dataPortAutoMdix, sMTPServerPortNumber=sMTPServerPortNumber, hTTPSPortNumber=hTTPSPortNumber, dfs=dfs, aAAControlGroup=aAAControlGroup, dfsMeans=dfsMeans, phyControl=phyControl, systemClock=systemClock, telecomsChannelStatusTrap=telecomsChannelStatusTrap, channelChangeTrap=channelChangeTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, syslogControlGroup=syslogControlGroup, regionCodeTrap=regionCodeTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapTable=sNMPTrapTable, telecomsCableLength=telecomsCableLength, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, channelBandwidth=channelBandwidth, tDDSynchronizationAlarm=tDDSynchronizationAlarm, receiveFreqKHz=receiveFreqKHz, dfsGroup=dfsGroup, hTTPAccessEnabled=hTTPAccessEnabled, receiveChannel=receiveChannel, syslogStateTrap=syslogStateTrap, targetMACAddress=targetMACAddress, telecomsInterface=telecomsInterface, capacityLicenseMismatch=capacityLicenseMismatch, phyStatusGroup=phyStatusGroup, eIRP=eIRP, cambium=cambium, dfsPeaks=dfsPeaks, snmpControl=snmpControl, dataPortStatus=dataPortStatus, productVariant=productVariant, bandwidthVariant=bandwidthVariant, ethernetGroup=ethernetGroup, userTableEntry=userTableEntry, encryption=encryption, sNTPServerPortNumber=sNTPServerPortNumber, tDDControl=tDDControl, telecomsLoopbackTrap=telecomsLoopbackTrap, syslogClientTrap=syslogClientTrap, sNMPTrapVersion=sNMPTrapVersion, licensedCapacity=licensedCapacity, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sntp=sntp, transmitPower=transmitPower, telecomGroup=telecomGroup, supplementaryGroup=supplementaryGroup, encryptionGroup=encryptionGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, alarmsGroup=alarmsGroup, userEnabled=userEnabled, linkModeOptimizationMismatch=linkModeOptimizationMismatch, ethernet=ethernet, tDDControlGroup=tDDControlGroup, pubStats=pubStats, vLANPriorityTable=vLANPriorityTable, bootVersion=bootVersion, ptpTrapPrefix=ptpTrapPrefix, transmitChannel=transmitChannel, sMTPEmailAlert=sMTPEmailAlert, installArmStateTrap=installArmStateTrap, linkName=linkName, remoteIPAddress=remoteIPAddress, PYSNMP_MODULE_ID=cambium, incompatibleRegionCodes=incompatibleRegionCodes, telecom=telecom, supplementary=supplementary, managementGroup=managementGroup, vLANManagementPriority=vLANManagementPriority, sNTPState=sNTPState, reset=reset, sNMPTrapTableEntry=sNMPTrapTableEntry, altitude=altitude, sNMPCommunityString=sNMPCommunityString, sNMPv3Enable=sNMPv3Enable, syslogClient=syslogClient, licence=licence, linkSymmetry=linkSymmetry, sNTPPollInterval=sNTPPollInterval, smtpGroup=smtpGroup, versionsGroup=versionsGroup, userPassword=userPassword, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ptpCompliance=ptpCompliance, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, telecomsChannelStatus=telecomsChannelStatus, userTableNumber=userTableNumber, secondarySoftwareVersion=secondarySoftwareVersion, sNTPSyncTrap=sNTPSyncTrap, accessMethod=accessMethod, tDDSynchronizationMode=tDDSynchronizationMode, groupID=groupID, transmitFreqKHz=transmitFreqKHz, subnetMask=subnetMask, hTTPPortNumber=hTTPPortNumber, cableLoss=cableLoss, userTable=userTable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText)
