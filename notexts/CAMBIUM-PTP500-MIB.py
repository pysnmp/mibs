...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", receiveModulationMode=receiveModulationMode, supplementary=supplementary, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, capacityLicenseMismatch=capacityLicenseMismatch, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tDDControl=tDDControl, tDDSynchronizationAlarm=tDDSynchronizationAlarm, channelBandwidth=channelBandwidth, sNMPTrapTableIndex=sNMPTrapTableIndex, receiveDataRate=receiveDataRate, ptmp=ptmp, sMTPSourceEmailAddress=sMTPSourceEmailAddress, configuration=configuration, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, syslogStateTrap=syslogStateTrap, versionsGroup=versionsGroup, notificationsGroup=notificationsGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, iPAddress=iPAddress, dataPortStatusTrap=dataPortStatusTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, management=management, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNTPServerPortNumber=sNTPServerPortNumber, userName=userName, linkLoss=linkLoss, remoteMaximumTransmitPower=remoteMaximumTransmitPower, telecomsCableLength=telecomsCableLength, telecomsLoopback=telecomsLoopback, receiveModulationModeDetail=receiveModulationModeDetail, telecomsChannelStatus=telecomsChannelStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, telecomsLineCode=telecomsLineCode, bandwidthVariant=bandwidthVariant, userTable=userTable, dfsTableNumber=dfsTableNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, encryptionAlgorithm=encryptionAlgorithm, dataPortAutoNegotiation=dataPortAutoNegotiation, regionCodeTrap=regionCodeTrap, remoteIPAddress=remoteIPAddress, vLANPriorityTableNumber=vLANPriorityTableNumber, frequencyVariant=frequencyVariant, snmpControl=snmpControl, phyStatus=phyStatus, incompatibleRegionCodes=incompatibleRegionCodes, hardwareVersion=hardwareVersion, telnetAccessEnabled=telnetAccessEnabled, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dfsTableIndex=dfsTableIndex, vLANPriorityQueueMapping=vLANPriorityQueueMapping, secondarySoftwareVersion=secondarySoftwareVersion, sNTPPollInterval=sNTPPollInterval, installStatusTrap=installStatusTrap, ptpCompliance=ptpCompliance, userTableNumber=userTableNumber, transmitFreqKHz=transmitFreqKHz, latitude=latitude, userTableEntry=userTableEntry, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, configurationGroup=configurationGroup, sNMPPortNumber=sNMPPortNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPCommunityString=sNMPCommunityString, smtpGroup=smtpGroup, hTTPPortNumber=hTTPPortNumber, receivePower=receivePower, ethernetGroup=ethernetGroup, dataPortAutoMdix=dataPortAutoMdix, dataPortConfigurationMismatch=dataPortConfigurationMismatch, productName=productName, linkModeOptimizationMismatch=linkModeOptimizationMismatch, installArmStateTrap=installArmStateTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, linkModeOptimisation=linkModeOptimisation, tFTPServerPortNumber=tFTPServerPortNumber, byteErrorRatio=byteErrorRatio, linkSymmetry=linkSymmetry, phyStatusGroup=phyStatusGroup, userRole=userRole, regionCode=regionCode, sNTPSyncTrap=sNTPSyncTrap, sNMPEnabledTraps=sNMPEnabledTraps, aAAControl=aAAControl, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, hTTPSPortNumber=hTTPSPortNumber, ptp500=ptp500, telecom=telecom, gatewayIPAddress=gatewayIPAddress, transmitPower=transmitPower, ptpTraps=ptpTraps, sNMPTrapTableEntry=sNMPTrapTableEntry, receiveChannel=receiveChannel, daylightSaving=daylightSaving, dataPortWirelessDownAlert=dataPortWirelessDownAlert, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, transmitDataRate=transmitDataRate, productVariant=productVariant, encryption=encryption, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, alarmsGroup=alarmsGroup, PYSNMP_MODULE_ID=cambium, transmitModulationMode=transmitModulationMode, versions=versions, syslogLocalWrappedTrap=syslogLocalWrappedTrap, vectorError=vectorError, noWirelessChannelAvailable=noWirelessChannelAvailable, alarms=alarms, cambium=cambium, telecomsInterface=telecomsInterface, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, timeZone=timeZone, userTableIndex=userTableIndex, targetMACAddress=targetMACAddress, syslogState=syslogState, searchState=searchState, altitude=altitude, sMTPEnabledMessages=sMTPEnabledMessages, vLANPriorityTable=vLANPriorityTable, wirelessLinkAvailability=wirelessLinkAvailability, linkName=linkName, constantPowerSpectralDensity=constantPowerSpectralDensity, ptpGroups=ptpGroups, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, installStatus=installStatus, dfsGroup=dfsGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, aggregateDataRate=aggregateDataRate, sntp=sntp, masterSlaveMode=masterSlaveMode, transmitFreqMHz=transmitFreqMHz, sNTPServerIPAddress=sNTPServerIPAddress, phyControl=phyControl, smtp=smtp, sNMPTrapVersion=sNMPTrapVersion, dfsTableEntry=dfsTableEntry, encryptionGroup=encryptionGroup, installArmState=installArmState, groupID=groupID, antennaGain=antennaGain, ethernet=ethernet, vLANManagementVID=vLANManagementVID, vLANPriorityTableEntry=vLANPriorityTableEntry, tDDSynchronizationMode=tDDSynchronizationMode, vLANManagementPriority=vLANManagementPriority, ptpTrapPrefix=ptpTrapPrefix, tDDControlGroup=tDDControlGroup, sMTPServerIPAddress=sMTPServerIPAddress, telnetPortNumber=telnetPortNumber, receiveFreqMHz=receiveFreqMHz, syslogControl=syslogControl, sNTPSync=sNTPSync, reset=reset, resetGroup=resetGroup, systemClock=systemClock, syslogClient=syslogClient, siteName=siteName, dfsTable=dfsTable, snmpControlGroup=snmpControlGroup, hTTPAccessEnabled=hTTPAccessEnabled, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, subnetMask=subnetMask, ethernetFiberSupport=ethernetFiberSupport, syslogControlGroup=syslogControlGroup, sNMPv3Enable=sNMPv3Enable, dataPortDisabledWarning=dataPortDisabledWarning, bootVersion=bootVersion, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, signalStrengthRatio=signalStrengthRatio, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, licenceGroup=licenceGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, syslogClientTrap=syslogClientTrap, managementGroup=managementGroup, dfs=dfs, incompatibleMasterAndSlave=incompatibleMasterAndSlave, licensedCapacity=licensedCapacity, userPassword=userPassword, sNTPState=sNTPState, sNTPLastSync=sNTPLastSync, dfsMeans=dfsMeans, dfsPeaks=dfsPeaks, eIRP=eIRP, tFTPServerIPAddress=tFTPServerIPAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortStatus=dataPortStatus, transmitChannel=transmitChannel, accessMethod=accessMethod, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ptp=ptp, supplementaryGroup=supplementaryGroup, receiveFreqKHz=receiveFreqKHz, telecomsLoopbackTrap=telecomsLoopbackTrap, cableLoss=cableLoss, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, aAAControlGroup=aAAControlGroup, sntpGroup=sntpGroup, licence=licence, softwareVersion=softwareVersion, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapPortNumber=sNMPTrapPortNumber, wirelessLinkStatus=wirelessLinkStatus, userEnabled=userEnabled, telecomsChannelStatusTrap=telecomsChannelStatusTrap, systemReset=systemReset, pubStats=pubStats, sNMPTrapTable=sNMPTrapTable, unitOutOfCalibration=unitOutOfCalibration, telecomGroup=telecomGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, useVLANForManagementInterfaces=useVLANForManagementInterfaces, range=range, pubStatsGroup=pubStatsGroup, longitude=longitude, channelChangeTrap=channelChangeTrap, phyControlGroup=phyControlGroup, maximumTransmitPower=maximumTransmitPower, sMTPServerPortNumber=sMTPServerPortNumber)
