...
# Produced by pysmi-1.1.3 at Thu Dec  9 15:30:08 2021
...
NotificationType, Gauge32, Counter32, MibIdentifier, Counter64, iso, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, enterprises, ObjectIdentity, Integer32, Bits, IpAddress, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "Counter32", "MibIdentifier", "Counter64", "iso", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "enterprises", "ObjectIdentity", "Integer32", "Bits", "IpAddress", "TimeTicks")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", telecomsLoopback=telecomsLoopback, alarms=alarms, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sMTPEmailAlert=sMTPEmailAlert, timeZone=timeZone, snmpControl=snmpControl, transmitChannel=transmitChannel, syslogStateTrap=syslogStateTrap, encryption=encryption, transmitDataRate=transmitDataRate, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, altitude=altitude, hTTPSAccessEnabled=hTTPSAccessEnabled, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, configuration=configuration, subnetMask=subnetMask, productVariant=productVariant, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPLastSync=sNTPLastSync, incompatibleMasterAndSlave=incompatibleMasterAndSlave, receiveModulationModeDetail=receiveModulationModeDetail, channelChangeTrap=channelChangeTrap, bootVersion=bootVersion, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dfsGroup=dfsGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, daylightSaving=daylightSaving, userPassword=userPassword, capacityLicenseMismatch=capacityLicenseMismatch, linkLoss=linkLoss, gatewayIPAddress=gatewayIPAddress, regionCode=regionCode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, bandwidthVariant=bandwidthVariant, installStatusTrap=installStatusTrap, unitOutOfCalibration=unitOutOfCalibration, iPAddress=iPAddress, dataPortStatusTrap=dataPortStatusTrap, userTableEntry=userTableEntry, constantPowerSpectralDensity=constantPowerSpectralDensity, accessMethod=accessMethod, pubStatsGroup=pubStatsGroup, channelBandwidth=channelBandwidth, PYSNMP_MODULE_ID=cambium, ptpGroups=ptpGroups, sntpGroup=sntpGroup, targetMACAddress=targetMACAddress, vLANManagementPriority=vLANManagementPriority, remoteMaximumTransmitPower=remoteMaximumTransmitPower, syslogControlGroup=syslogControlGroup, dataPortAutoMdix=dataPortAutoMdix, dfsTable=dfsTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, telecomsCableLength=telecomsCableLength, frequencyVariant=frequencyVariant, sNMPTrapTable=sNMPTrapTable, eIRP=eIRP, wirelessLinkStatus=wirelessLinkStatus, dataPortDisabledWarning=dataPortDisabledWarning, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, management=management, smtp=smtp, userEnabled=userEnabled, telecomGroup=telecomGroup, encryptionAlgorithm=encryptionAlgorithm, alarmsGroup=alarmsGroup, phyStatusGroup=phyStatusGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dfsMeans=dfsMeans, phyControlGroup=phyControlGroup, reset=reset, aAAControlGroup=aAAControlGroup, transmitPower=transmitPower, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, managementGroup=managementGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dfsTableNumber=dfsTableNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ptpCompliance=ptpCompliance, incompatibleRegionCodes=incompatibleRegionCodes, antennaGain=antennaGain, ethernetFiberSupport=ethernetFiberSupport, tDDSynchronizationMode=tDDSynchronizationMode, licensedCapacity=licensedCapacity, receiveDataRate=receiveDataRate, ptpTrapPrefix=ptpTrapPrefix, telecomsLineCode=telecomsLineCode, vLANManagementVID=vLANManagementVID, sNMPTrapIPAddress=sNMPTrapIPAddress, notificationsGroup=notificationsGroup, masterSlaveMode=masterSlaveMode, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPEnabledTraps=sNMPEnabledTraps, dfsTableEntry=dfsTableEntry, supplementary=supplementary, userName=userName, ethernet=ethernet, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNTPSync=sNTPSync, linkName=linkName, sNMPCommunityString=sNMPCommunityString, aAAControl=aAAControl, installArmState=installArmState, telecomsLoopbackTrap=telecomsLoopbackTrap, configurationGroup=configurationGroup, receivePower=receivePower, tFTPServerPortNumber=tFTPServerPortNumber, byteErrorRatio=byteErrorRatio, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, phyStatus=phyStatus, telecomsChannelStatus=telecomsChannelStatus, groupID=groupID, tFTPServerIPAddress=tFTPServerIPAddress, sNTPPollInterval=sNTPPollInterval, sNMPTrapTableEntry=sNMPTrapTableEntry, installArmStateTrap=installArmStateTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, receiveChannel=receiveChannel, ptmp=ptmp, sntp=sntp, dfsTableIndex=dfsTableIndex, sNTPServerIPAddress=sNTPServerIPAddress, ethernetGroup=ethernetGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, systemClock=systemClock, secondarySoftwareVersion=secondarySoftwareVersion, enabledDiagnosticAlarms=enabledDiagnosticAlarms, linkModeOptimisation=linkModeOptimisation, telecom=telecom, phyControl=phyControl, softwareVersion=softwareVersion, transmitFreqKHz=transmitFreqKHz, ptp=ptp, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapTableNumber=sNMPTrapTableNumber, longitude=longitude, resetGroup=resetGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, vLANPriorityTable=vLANPriorityTable, dataPortConfigurationMismatch=dataPortConfigurationMismatch, vLANPriorityQueueMapping=vLANPriorityQueueMapping, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, cambium=cambium, sNTPState=sNTPState, tDDControlGroup=tDDControlGroup, tDDControl=tDDControl, linkModeOptimizationMismatch=linkModeOptimizationMismatch, ptpTraps=ptpTraps, receiveModulationMode=receiveModulationMode, regionCodeTrap=regionCodeTrap, searchState=searchState, versionsGroup=versionsGroup, latitude=latitude, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, telnetAccessEnabled=telnetAccessEnabled, hTTPAccessEnabled=hTTPAccessEnabled, cableLoss=cableLoss, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, aggregateDataRate=aggregateDataRate, syslogClientTrap=syslogClientTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sMTPServerPortNumber=sMTPServerPortNumber, signalStrengthRatio=signalStrengthRatio, sNMPTrapTableIndex=sNMPTrapTableIndex, hardwareVersion=hardwareVersion, sNTPSyncTrap=sNTPSyncTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, remoteIPAddress=remoteIPAddress, maximumTransmitPower=maximumTransmitPower, sNMPTrapVersion=sNMPTrapVersion, supplementaryGroup=supplementaryGroup, installStatus=installStatus, transmitFreqMHz=transmitFreqMHz, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, telnetPortNumber=telnetPortNumber, siteName=siteName, hTTPPortNumber=hTTPPortNumber, sMTPServerIPAddress=sMTPServerIPAddress, receiveFreqMHz=receiveFreqMHz, transmitModulationMode=transmitModulationMode, receiveFreqKHz=receiveFreqKHz, dfsPeaks=dfsPeaks, telecomsInterface=telecomsInterface, hTTPSPortNumber=hTTPSPortNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, vectorError=vectorError, dataPortStatus=dataPortStatus, syslogClient=syslogClient, range=range, ptp500=ptp500, licence=licence, smtpGroup=smtpGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPEnabledMessages=sMTPEnabledMessages, sNMPPortNumber=sNMPPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, syslogState=syslogState, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, wirelessLinkAvailability=wirelessLinkAvailability, syslogControl=syslogControl, pubStats=pubStats, systemReset=systemReset, userTableIndex=userTableIndex, productName=productName, vLANPriorityTableNumber=vLANPriorityTableNumber, linkSymmetry=linkSymmetry, userRole=userRole, userTable=userTable, sNMPv3Enable=sNMPv3Enable, dfs=dfs, userTableNumber=userTableNumber, snmpControlGroup=snmpControlGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, sNTPServerPortNumber=sNTPServerPortNumber, encryptionGroup=encryptionGroup, licenceGroup=licenceGroup, versions=versions)
