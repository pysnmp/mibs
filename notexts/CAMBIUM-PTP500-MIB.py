...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", bandwidthVariant=bandwidthVariant, licence=licence, regionCode=regionCode, linkModeOptimizationMismatch=linkModeOptimizationMismatch, smtp=smtp, vLANPriorityQueueMapping=vLANPriorityQueueMapping, transmitPower=transmitPower, ptpCompliance=ptpCompliance, iPAddress=iPAddress, userRole=userRole, ptp500=ptp500, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dfsGroup=dfsGroup, antennaGain=antennaGain, telecomsInterface=telecomsInterface, vectorError=vectorError, sNTPLastSync=sNTPLastSync, installArmStateTrap=installArmStateTrap, groupID=groupID, syslogClient=syslogClient, telecomsLoopbackTrap=telecomsLoopbackTrap, ptpTrapPrefix=ptpTrapPrefix, ethernetGroup=ethernetGroup, sntpGroup=sntpGroup, syslogClientTrap=syslogClientTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, phyStatusGroup=phyStatusGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, accessMethod=accessMethod, userTable=userTable, subnetMask=subnetMask, installStatus=installStatus, configuration=configuration, reset=reset, sNMPTrapTableNumber=sNMPTrapTableNumber, productName=productName, syslogState=syslogState, tDDSynchronizationAlarm=tDDSynchronizationAlarm, syslogControlGroup=syslogControlGroup, userName=userName, licenceGroup=licenceGroup, dataPortAutoMdix=dataPortAutoMdix, sNMPTrapTableEntry=sNMPTrapTableEntry, alarmsGroup=alarmsGroup, receiveModulationMode=receiveModulationMode, range=range, syslogLocalWrappedTrap=syslogLocalWrappedTrap, pubStatsGroup=pubStatsGroup, dataPortDisabledWarning=dataPortDisabledWarning, phyStatus=phyStatus, sNTPState=sNTPState, sNTPServerPortNumber=sNTPServerPortNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, managementGroup=managementGroup, remoteIPAddress=remoteIPAddress, channelChangeTrap=channelChangeTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPv3Enable=sNMPv3Enable, snmpControlGroup=snmpControlGroup, installArmState=installArmState, softwareVersion=softwareVersion, dfsMeans=dfsMeans, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, telecomGroup=telecomGroup, eIRP=eIRP, receiveDataRate=receiveDataRate, linkModeOptimisation=linkModeOptimisation, PYSNMP_MODULE_ID=cambium, siteName=siteName, userTableNumber=userTableNumber, aAAControl=aAAControl, tDDSynchronizationStatus=tDDSynchronizationStatus, telnetPortNumber=telnetPortNumber, vLANManagementVID=vLANManagementVID, sNMPCommunityString=sNMPCommunityString, hTTPSPortNumber=hTTPSPortNumber, ptp=ptp, noWirelessChannelAvailable=noWirelessChannelAvailable, timeZone=timeZone, sNMPTrapPortNumber=sNMPTrapPortNumber, versionsGroup=versionsGroup, aggregateDataRate=aggregateDataRate, tDDSynchronizationMode=tDDSynchronizationMode, channelBandwidth=channelBandwidth, supplementaryGroup=supplementaryGroup, syslogControl=syslogControl, dfs=dfs, receiveChannel=receiveChannel, incompatibleRegionCodes=incompatibleRegionCodes, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, aAAControlGroup=aAAControlGroup, maximumTransmitPower=maximumTransmitPower, alarms=alarms, snmpControl=snmpControl, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortWirelessDownAlert=dataPortWirelessDownAlert, byteErrorRatio=byteErrorRatio, sNMPTrapVersion=sNMPTrapVersion, masterSlaveMode=masterSlaveMode, ptmp=ptmp, searchState=searchState, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sMTPEnabledMessages=sMTPEnabledMessages, dataPortStatusTrap=dataPortStatusTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, receiveFreqMHz=receiveFreqMHz, capacityLicenseMismatch=capacityLicenseMismatch, sNMPEnabledTraps=sNMPEnabledTraps, hTTPSAccessEnabled=hTTPSAccessEnabled, receiveFreqKHz=receiveFreqKHz, sNTPSyncTrap=sNTPSyncTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, userTableIndex=userTableIndex, dataPortAutoNegotiation=dataPortAutoNegotiation, userPassword=userPassword, dataPortStatus=dataPortStatus, vLANPriorityTableNumber=vLANPriorityTableNumber, systemClock=systemClock, licensedCapacity=licensedCapacity, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, telecom=telecom, dfsTable=dfsTable, vLANPriorityTable=vLANPriorityTable, ptpTraps=ptpTraps, phyControl=phyControl, sNMPPortNumber=sNMPPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, sMTPServerIPAddress=sMTPServerIPAddress, sNTPPollInterval=sNTPPollInterval, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapTable=sNMPTrapTable, cambium=cambium, vLANManagementPriority=vLANManagementPriority, tFTPServerIPAddress=tFTPServerIPAddress, wirelessLinkAvailability=wirelessLinkAvailability, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, daylightSaving=daylightSaving, resetGroup=resetGroup, dfsPeaks=dfsPeaks, targetMACAddress=targetMACAddress, bootVersion=bootVersion, telecomsLineCode=telecomsLineCode, enabledDiagnosticAlarms=enabledDiagnosticAlarms, linkLoss=linkLoss, sNTPServerIPAddress=sNTPServerIPAddress, unitOutOfCalibration=unitOutOfCalibration, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, productVariant=productVariant, smtpGroup=smtpGroup, telecomsCableLength=telecomsCableLength, telnetAccessEnabled=telnetAccessEnabled, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, userEnabled=userEnabled, constantPowerSpectralDensity=constantPowerSpectralDensity, hTTPPortNumber=hTTPPortNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, encryptionGroup=encryptionGroup, gatewayIPAddress=gatewayIPAddress, wirelessLinkStatus=wirelessLinkStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ethernetFiberSupport=ethernetFiberSupport, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPTrapIPAddress=sNMPTrapIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, transmitModulationMode=transmitModulationMode, tDDControl=tDDControl, signalStrengthRatio=signalStrengthRatio, regionCodeTrap=regionCodeTrap, dfsTableEntry=dfsTableEntry, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, encryptionAlgorithm=encryptionAlgorithm, pubStats=pubStats, tDDControlGroup=tDDControlGroup, telecomsChannelStatus=telecomsChannelStatus, cableLoss=cableLoss, systemReset=systemReset, sMTPEmailAlert=sMTPEmailAlert, syslogStateTrap=syslogStateTrap, notificationsGroup=notificationsGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, linkName=linkName, userTableEntry=userTableEntry, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, transmitFreqKHz=transmitFreqKHz, useVLANForManagementInterfaces=useVLANForManagementInterfaces, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dfsTableIndex=dfsTableIndex, frequencyVariant=frequencyVariant, linkSymmetry=linkSymmetry, sntp=sntp, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, configurationGroup=configurationGroup, latitude=latitude, longitude=longitude, ethernet=ethernet, tFTPServerPortNumber=tFTPServerPortNumber, phyControlGroup=phyControlGroup, supplementary=supplementary, sNTPSync=sNTPSync, installStatusTrap=installStatusTrap, ptpGroups=ptpGroups, receivePower=receivePower, secondarySoftwareVersion=secondarySoftwareVersion, hardwareVersion=hardwareVersion, telecomsLoopback=telecomsLoopback, sMTPServerPortNumber=sMTPServerPortNumber, dfsTableNumber=dfsTableNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, transmitFreqMHz=transmitFreqMHz, versions=versions, transmitDataRate=transmitDataRate, receiveModulationModeDetail=receiveModulationModeDetail, hTTPAccessEnabled=hTTPAccessEnabled, transmitChannel=transmitChannel, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, management=management, encryption=encryption, altitude=altitude)
