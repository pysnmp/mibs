...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sntpGroup=sntpGroup, signalStrengthRatio=signalStrengthRatio, receiveFreqKHz=receiveFreqKHz, latitude=latitude, managementGroup=managementGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, productName=productName, ptpCompliance=ptpCompliance, telnetAccessEnabled=telnetAccessEnabled, searchState=searchState, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapTableIndex=sNMPTrapTableIndex, aAAControlGroup=aAAControlGroup, aggregateDataRate=aggregateDataRate, resetGroup=resetGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapPortNumber=sNMPTrapPortNumber, dfsPeaks=dfsPeaks, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sntp=sntp, systemClock=systemClock, enabledDiagnosticAlarms=enabledDiagnosticAlarms, byteErrorRatio=byteErrorRatio, sMTPSourceEmailAddress=sMTPSourceEmailAddress, userTableIndex=userTableIndex, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, cambium=cambium, wirelessLinkAvailability=wirelessLinkAvailability, hTTPPortNumber=hTTPPortNumber, syslogControl=syslogControl, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, ethernetFiberSupport=ethernetFiberSupport, smtp=smtp, hardwareVersion=hardwareVersion, vLANPriorityTable=vLANPriorityTable, sNTPSync=sNTPSync, sNMPPortNumber=sNMPPortNumber, tDDControl=tDDControl, installArmState=installArmState, receiveChannel=receiveChannel, snmpControl=snmpControl, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ptp500=ptp500, transmitChannel=transmitChannel, telecomsInterface=telecomsInterface, ethernetGroup=ethernetGroup, sNTPLastSync=sNTPLastSync, dataPortDisabledWarning=dataPortDisabledWarning, userName=userName, linkLoss=linkLoss, userTableEntry=userTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, transmitFreqKHz=transmitFreqKHz, telecomsCableLength=telecomsCableLength, encryptionGroup=encryptionGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, PYSNMP_MODULE_ID=cambium, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, vectorError=vectorError, alarmsGroup=alarmsGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, tDDSynchronizationMode=tDDSynchronizationMode, telecom=telecom, installStatusTrap=installStatusTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, iPAddress=iPAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, syslogLocalWrappedTrap=syslogLocalWrappedTrap, receiveDataRate=receiveDataRate, transmitDataRate=transmitDataRate, userTableNumber=userTableNumber, masterSlaveMode=masterSlaveMode, constantPowerSpectralDensity=constantPowerSpectralDensity, management=management, vLANManagementVID=vLANManagementVID, encryptionAlgorithm=encryptionAlgorithm, antennaGain=antennaGain, userTable=userTable, supplementaryGroup=supplementaryGroup, productVariant=productVariant, cableLoss=cableLoss, receivePower=receivePower, linkModeOptimizationMismatch=linkModeOptimizationMismatch, incompatibleRegionCodes=incompatibleRegionCodes, pubStats=pubStats, licence=licence, phyControl=phyControl, sMTPServerIPAddress=sMTPServerIPAddress, remoteIPAddress=remoteIPAddress, telnetPortNumber=telnetPortNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, alarms=alarms, reset=reset, phyStatusGroup=phyStatusGroup, telecomGroup=telecomGroup, telecomsChannelStatus=telecomsChannelStatus, range=range, installStatus=installStatus, syslogStateTrap=syslogStateTrap, supplementary=supplementary, syslogClient=syslogClient, hTTPAccessEnabled=hTTPAccessEnabled, dfsTableEntry=dfsTableEntry, timeZone=timeZone, vLANPriorityQueueMapping=vLANPriorityQueueMapping, syslogState=syslogState, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ptpTrapPrefix=ptpTrapPrefix, hTTPSAccessEnabled=hTTPSAccessEnabled, softwareVersion=softwareVersion, vLANManagementPriority=vLANManagementPriority, dfsGroup=dfsGroup, ptp=ptp, vLANPriorityTableEntry=vLANPriorityTableEntry, ptpTraps=ptpTraps, regionCodeTrap=regionCodeTrap, subnetMask=subnetMask, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, transmitModulationMode=transmitModulationMode, receiveModulationModeDetail=receiveModulationModeDetail, ptpGroups=ptpGroups, systemReset=systemReset, phyStatus=phyStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, licenceGroup=licenceGroup, sNTPServerPortNumber=sNTPServerPortNumber, configurationGroup=configurationGroup, sNMPEnabledTraps=sNMPEnabledTraps, dfsMeans=dfsMeans, linkModeOptimisation=linkModeOptimisation, dfsTable=dfsTable, snmpControlGroup=snmpControlGroup, channelBandwidth=channelBandwidth, sNMPTrapTable=sNMPTrapTable, targetMACAddress=targetMACAddress, telecomsLineCode=telecomsLineCode, userRole=userRole, tDDSynchronizationAlarm=tDDSynchronizationAlarm, siteName=siteName, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dfsTableIndex=dfsTableIndex, transmitFreqMHz=transmitFreqMHz, accessMethod=accessMethod, longitude=longitude, telecomsChannelStatusTrap=telecomsChannelStatusTrap, channelChangeTrap=channelChangeTrap, sNMPCommunityString=sNMPCommunityString, tFTPServerIPAddress=tFTPServerIPAddress, capacityLicenseMismatch=capacityLicenseMismatch, phyControlGroup=phyControlGroup, aAAControl=aAAControl, telecomsLoopbackTrap=telecomsLoopbackTrap, userEnabled=userEnabled, dataPortWirelessDownAlert=dataPortWirelessDownAlert, linkName=linkName, pubStatsGroup=pubStatsGroup, tFTPServerPortNumber=tFTPServerPortNumber, licensedCapacity=licensedCapacity, installArmStateTrap=installArmStateTrap, telecomsLoopback=telecomsLoopback, tDDControlGroup=tDDControlGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, configuration=configuration, receiveModulationMode=receiveModulationMode, versionsGroup=versionsGroup, frequencyVariant=frequencyVariant, dataPortStatus=dataPortStatus, sNMPTrapVersion=sNMPTrapVersion, bandwidthVariant=bandwidthVariant, maximumTransmitPower=maximumTransmitPower, dataPortAutoMdix=dataPortAutoMdix, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, linkSymmetry=linkSymmetry, sNTPState=sNTPState, wirelessLinkStatus=wirelessLinkStatus, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, versions=versions, sNTPServerIPAddress=sNTPServerIPAddress, ethernet=ethernet, sNTPPollInterval=sNTPPollInterval, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapTableEntry=sNMPTrapTableEntry, sMTPServerPortNumber=sMTPServerPortNumber, transmitPower=transmitPower, userPassword=userPassword, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, bootVersion=bootVersion, notificationsGroup=notificationsGroup, unitOutOfCalibration=unitOutOfCalibration, smtpGroup=smtpGroup, encryption=encryption, ptmp=ptmp, regionCode=regionCode, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dataPortStatusTrap=dataPortStatusTrap, groupID=groupID, syslogClientTrap=syslogClientTrap, daylightSaving=daylightSaving, sMTPEnabledMessages=sMTPEnabledMessages, dfsTableNumber=dfsTableNumber, altitude=altitude, dfs=dfs, gatewayIPAddress=gatewayIPAddress, secondarySoftwareVersion=secondarySoftwareVersion, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPv3Enable=sNMPv3Enable, hTTPSPortNumber=hTTPSPortNumber, syslogControlGroup=syslogControlGroup, receiveFreqMHz=receiveFreqMHz, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, eIRP=eIRP, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNTPSyncTrap=sNTPSyncTrap)
