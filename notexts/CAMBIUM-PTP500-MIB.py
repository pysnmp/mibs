...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sNMPv3Enable=sNMPv3Enable, supplementary=supplementary, licenceGroup=licenceGroup, subnetMask=subnetMask, sNMPEnabledTraps=sNMPEnabledTraps, syslogClientTrap=syslogClientTrap, telnetAccessEnabled=telnetAccessEnabled, sNMPPortNumber=sNMPPortNumber, cambium=cambium, sMTPServerIPAddress=sMTPServerIPAddress, dfsTableEntry=dfsTableEntry, phyStatus=phyStatus, receiveChannel=receiveChannel, masterSlaveMode=masterSlaveMode, antennaGain=antennaGain, installStatus=installStatus, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortDisabledWarning=dataPortDisabledWarning, ptp500=ptp500, vectorError=vectorError, phyStatusGroup=phyStatusGroup, byteErrorRatio=byteErrorRatio, ptpCompliance=ptpCompliance, aAAControl=aAAControl, telecom=telecom, remoteMaximumTransmitPower=remoteMaximumTransmitPower, linkModeOptimisation=linkModeOptimisation, userTableNumber=userTableNumber, management=management, telecomsCableLength=telecomsCableLength, syslogClient=syslogClient, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPSyncTrap=sNTPSyncTrap, resetGroup=resetGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, installArmState=installArmState, hardwareVersion=hardwareVersion, bootVersion=bootVersion, vLANPriorityTableNumber=vLANPriorityTableNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, pubStats=pubStats, vLANPriorityTableEntry=vLANPriorityTableEntry, userTableIndex=userTableIndex, telecomGroup=telecomGroup, versions=versions, licensedCapacity=licensedCapacity, hTTPPortNumber=hTTPPortNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, userEnabled=userEnabled, aggregateDataRate=aggregateDataRate, userPassword=userPassword, syslogLocalWrappedTrap=syslogLocalWrappedTrap, accessMethod=accessMethod, dfsTable=dfsTable, transmitFreqKHz=transmitFreqKHz, targetMACAddress=targetMACAddress, maximumTransmitPower=maximumTransmitPower, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, receiveDataRate=receiveDataRate, sNTPServerIPAddress=sNTPServerIPAddress, snmpControl=snmpControl, ptmp=ptmp, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ptpTraps=ptpTraps, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptpGroups=ptpGroups, sNTPLastSync=sNTPLastSync, encryption=encryption, notificationsGroup=notificationsGroup, sNMPCommunityString=sNMPCommunityString, syslogControlGroup=syslogControlGroup, receiveFreqMHz=receiveFreqMHz, incompatibleRegionCodes=incompatibleRegionCodes, linkName=linkName, systemClock=systemClock, syslogControl=syslogControl, sNMPTrapTableNumber=sNMPTrapTableNumber, sMTPServerPortNumber=sMTPServerPortNumber, productName=productName, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dfsGroup=dfsGroup, configuration=configuration, reset=reset, sNMPTrapPortNumber=sNMPTrapPortNumber, receivePower=receivePower, managementGroup=managementGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, sntpGroup=sntpGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, sntp=sntp, userTable=userTable, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortStatus=dataPortStatus, sNTPSync=sNTPSync, systemReset=systemReset, alarmsGroup=alarmsGroup, vLANManagementPriority=vLANManagementPriority, groupID=groupID, sNMPTrapIPAddress=sNMPTrapIPAddress, smtpGroup=smtpGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tDDControl=tDDControl, wirelessLinkAvailability=wirelessLinkAvailability, bandwidthVariant=bandwidthVariant, PYSNMP_MODULE_ID=cambium, encryptionGroup=encryptionGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tDDSynchronizationMode=tDDSynchronizationMode, secondarySoftwareVersion=secondarySoftwareVersion, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, cableLoss=cableLoss, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, siteName=siteName, linkModeOptimizationMismatch=linkModeOptimizationMismatch, syslogState=syslogState, vLANPriorityQueueMapping=vLANPriorityQueueMapping, encryptionAlgorithm=encryptionAlgorithm, channelChangeTrap=channelChangeTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, receiveModulationMode=receiveModulationMode, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dfs=dfs, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, latitude=latitude, capacityLicenseMismatch=capacityLicenseMismatch, userRole=userRole, telnetPortNumber=telnetPortNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dfsTableNumber=dfsTableNumber, channelBandwidth=channelBandwidth, remoteIPAddress=remoteIPAddress, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapVersion=sNMPTrapVersion, transmitFreqMHz=transmitFreqMHz, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPState=sNTPState, sNMPTrapTableIndex=sNMPTrapTableIndex, useVLANForManagementInterfaces=useVLANForManagementInterfaces, phyControl=phyControl, telecomsChannelStatus=telecomsChannelStatus, telecomsLoopback=telecomsLoopback, installStatusTrap=installStatusTrap, softwareVersion=softwareVersion, userTableEntry=userTableEntry, searchState=searchState, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, transmitDataRate=transmitDataRate, dfsMeans=dfsMeans, vLANManagementVID=vLANManagementVID, sNTPServerPortNumber=sNTPServerPortNumber, receiveModulationModeDetail=receiveModulationModeDetail, hTTPAccessEnabled=hTTPAccessEnabled, timeZone=timeZone, ethernet=ethernet, licence=licence, dfsTableIndex=dfsTableIndex, ethernetFiberSupport=ethernetFiberSupport, sMTPSourceEmailAddress=sMTPSourceEmailAddress, range=range, regionCode=regionCode, unitOutOfCalibration=unitOutOfCalibration, telecomsLineCode=telecomsLineCode, configurationGroup=configurationGroup, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapTable=sNMPTrapTable, wirelessLinkStatus=wirelessLinkStatus, dataPortStatusTrap=dataPortStatusTrap, alarms=alarms, sNTPPollInterval=sNTPPollInterval, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, transmitChannel=transmitChannel, dataPortConfigurationMismatch=dataPortConfigurationMismatch, versionsGroup=versionsGroup, longitude=longitude, snmpControlGroup=snmpControlGroup, daylightSaving=daylightSaving, incompatibleMasterAndSlave=incompatibleMasterAndSlave, vLANPriorityTable=vLANPriorityTable, linkLoss=linkLoss, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, linkSymmetry=linkSymmetry, tDDControlGroup=tDDControlGroup, receiveFreqKHz=receiveFreqKHz, hTTPSPortNumber=hTTPSPortNumber, smtp=smtp, pubStatsGroup=pubStatsGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, transmitModulationMode=transmitModulationMode, altitude=altitude, supplementaryGroup=supplementaryGroup, regionCodeTrap=regionCodeTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, frequencyVariant=frequencyVariant, dataPortAutoMdix=dataPortAutoMdix, telecomsInterface=telecomsInterface, userName=userName, dfsPeaks=dfsPeaks, phyControlGroup=phyControlGroup, aAAControlGroup=aAAControlGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, syslogStateTrap=syslogStateTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, transmitPower=transmitPower, ethernetGroup=ethernetGroup, tFTPServerPortNumber=tFTPServerPortNumber, installArmStateTrap=installArmStateTrap, ptp=ptp, tFTPServerIPAddress=tFTPServerIPAddress, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sMTPEnabledMessages=sMTPEnabledMessages, gatewayIPAddress=gatewayIPAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, productVariant=productVariant, signalStrengthRatio=signalStrengthRatio, eIRP=eIRP, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, iPAddress=iPAddress)
