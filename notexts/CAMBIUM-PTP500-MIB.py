...
TimeTicks, Counter32, MibIdentifier, Unsigned32, Counter64, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Integer32, NotificationType, ObjectIdentity, enterprises, Gauge32, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "MibIdentifier", "Unsigned32", "Counter64", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Integer32", "NotificationType", "ObjectIdentity", "enterprises", "Gauge32", "IpAddress", "ModuleIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", telecomsCableLength=telecomsCableLength, receiveFreqKHz=receiveFreqKHz, phyControl=phyControl, aAAControl=aAAControl, remoteIPAddress=remoteIPAddress, productName=productName, tDDSynchronizationAlarm=tDDSynchronizationAlarm, vectorError=vectorError, sNMPTrapTableIndex=sNMPTrapTableIndex, channelChangeTrap=channelChangeTrap, sntpGroup=sntpGroup, subnetMask=subnetMask, sNMPTrapVersion=sNMPTrapVersion, ptp500=ptp500, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, cambium=cambium, tFTPServerIPAddress=tFTPServerIPAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, linkModeOptimisation=linkModeOptimisation, groupID=groupID, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPv3Enable=sNMPv3Enable, PYSNMP_MODULE_ID=cambium, bandwidthVariant=bandwidthVariant, dfsTable=dfsTable, unitOutOfCalibration=unitOutOfCalibration, tDDSynchronizationStatus=tDDSynchronizationStatus, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, licensedCapacity=licensedCapacity, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sMTPEmailAlert=sMTPEmailAlert, dataPortAutoMdix=dataPortAutoMdix, systemClock=systemClock, alarms=alarms, vLANPriorityTable=vLANPriorityTable, maximumTransmitPower=maximumTransmitPower, linkModeOptimizationMismatch=linkModeOptimizationMismatch, vLANManagementVID=vLANManagementVID, incompatibleRegionCodes=incompatibleRegionCodes, userTableIndex=userTableIndex, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ethernet=ethernet, sMTPServerIPAddress=sMTPServerIPAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, wirelessLinkAvailability=wirelessLinkAvailability, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPPortNumber=sNMPPortNumber, telecom=telecom, eIRP=eIRP, ptpGroups=ptpGroups, telnetAccessEnabled=telnetAccessEnabled, transmitPower=transmitPower, telecomsLoopback=telecomsLoopback, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, userTableEntry=userTableEntry, dfsGroup=dfsGroup, sNMPEnabledTraps=sNMPEnabledTraps, sNTPSync=sNTPSync, alarmsGroup=alarmsGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sntp=sntp, installArmStateTrap=installArmStateTrap, licence=licence, licenceGroup=licenceGroup, regionCode=regionCode, hTTPSPortNumber=hTTPSPortNumber, sNTPLastSync=sNTPLastSync, userRole=userRole, altitude=altitude, notificationsGroup=notificationsGroup, dataPortStatus=dataPortStatus, dfsTableNumber=dfsTableNumber, daylightSaving=daylightSaving, sNMPTrapTableNumber=sNMPTrapTableNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, transmitFreqMHz=transmitFreqMHz, receiveModulationModeDetail=receiveModulationModeDetail, tDDSynchronizationMode=tDDSynchronizationMode, linkLoss=linkLoss, vLANManagementPriority=vLANManagementPriority, regionCodeTrap=regionCodeTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsMeans=dfsMeans, snmpControlGroup=snmpControlGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPPollInterval=sNTPPollInterval, byteErrorRatio=byteErrorRatio, transmitChannel=transmitChannel, vLANPriorityTableEntry=vLANPriorityTableEntry, hTTPPortNumber=hTTPPortNumber, linkName=linkName, sNTPState=sNTPState, userPassword=userPassword, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, receivePower=receivePower, sNMPTrapPortNumber=sNMPTrapPortNumber, configuration=configuration, accessMethod=accessMethod, vLANPriorityTableIndex=vLANPriorityTableIndex, dataPortWirelessDownAlert=dataPortWirelessDownAlert, syslogClient=syslogClient, telecomsInterface=telecomsInterface, dataPortStatusTrap=dataPortStatusTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, syslogControlGroup=syslogControlGroup, userTable=userTable, targetMACAddress=targetMACAddress, syslogControl=syslogControl, vLANPriorityQueueMapping=vLANPriorityQueueMapping, ptmp=ptmp, ptpTrapPrefix=ptpTrapPrefix, pubStats=pubStats, vLANPriorityTableNumber=vLANPriorityTableNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, reset=reset, hTTPAccessEnabled=hTTPAccessEnabled, telnetPortNumber=telnetPortNumber, pubStatsGroup=pubStatsGroup, managementGroup=managementGroup, signalStrengthRatio=signalStrengthRatio, sMTPEnabledMessages=sMTPEnabledMessages, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, phyControlGroup=phyControlGroup, secondarySoftwareVersion=secondarySoftwareVersion, versionsGroup=versionsGroup, management=management, phyStatus=phyStatus, dfsTableEntry=dfsTableEntry, installArmState=installArmState, sNMPTrapTable=sNMPTrapTable, searchState=searchState, userName=userName, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, receiveModulationMode=receiveModulationMode, sMTPServerPortNumber=sMTPServerPortNumber, sNTPSyncTrap=sNTPSyncTrap, resetGroup=resetGroup, timeZone=timeZone, dfsTableIndex=dfsTableIndex, ethernetFiberSupport=ethernetFiberSupport, range=range, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tFTPServerPortNumber=tFTPServerPortNumber, installStatus=installStatus, sNTPServerIPAddress=sNTPServerIPAddress, cableLoss=cableLoss, ptpCompliance=ptpCompliance, telecomsLoopbackTrap=telecomsLoopbackTrap, supplementary=supplementary, receiveFreqMHz=receiveFreqMHz, dfsPeaks=dfsPeaks, hardwareVersion=hardwareVersion, receiveChannel=receiveChannel, channelBandwidth=channelBandwidth, phyStatusGroup=phyStatusGroup, frequencyVariant=frequencyVariant, sNMPCommunityString=sNMPCommunityString, noWirelessChannelAvailable=noWirelessChannelAvailable, ethernetGroup=ethernetGroup, sNTPServerPortNumber=sNTPServerPortNumber, smtpGroup=smtpGroup, telecomsChannelStatusTrap=telecomsChannelStatusTrap, telecomGroup=telecomGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, telecomsLineCode=telecomsLineCode, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, configurationGroup=configurationGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, transmitDataRate=transmitDataRate, encryptionAlgorithm=encryptionAlgorithm, ptpTraps=ptpTraps, dataPortDisabledWarning=dataPortDisabledWarning, syslogState=syslogState, longitude=longitude, bootVersion=bootVersion, versions=versions, encryption=encryption, tDDControl=tDDControl, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, telecomsChannelStatus=telecomsChannelStatus, snmpControl=snmpControl, aAAControlGroup=aAAControlGroup, transmitFreqKHz=transmitFreqKHz, installStatusTrap=installStatusTrap, aggregateDataRate=aggregateDataRate, latitude=latitude, supplementaryGroup=supplementaryGroup, siteName=siteName, linkSymmetry=linkSymmetry, smtp=smtp, syslogStateTrap=syslogStateTrap, encryptionGroup=encryptionGroup, transmitModulationMode=transmitModulationMode, masterSlaveMode=masterSlaveMode, capacityLicenseMismatch=capacityLicenseMismatch, wirelessLinkStatus=wirelessLinkStatus, syslogClientTrap=syslogClientTrap, softwareVersion=softwareVersion, userEnabled=userEnabled, gatewayIPAddress=gatewayIPAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, iPAddress=iPAddress, tDDControlGroup=tDDControlGroup, antennaGain=antennaGain, productVariant=productVariant, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, systemReset=systemReset, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptp=ptp, sNMPTrapIPAddress=sNMPTrapIPAddress, receiveDataRate=receiveDataRate, dfs=dfs, userTableNumber=userTableNumber)
