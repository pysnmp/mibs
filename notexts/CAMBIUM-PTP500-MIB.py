...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", snmpControl=snmpControl, supplementary=supplementary, linkLoss=linkLoss, configurationGroup=configurationGroup, tDDControlGroup=tDDControlGroup, searchState=searchState, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, alarms=alarms, ptpTraps=ptpTraps, vLANManagementVID=vLANManagementVID, signalStrengthRatio=signalStrengthRatio, dfsTableIndex=dfsTableIndex, targetMACAddress=targetMACAddress, frequencyVariant=frequencyVariant, installArmState=installArmState, syslogControl=syslogControl, pubStats=pubStats, iPAddress=iPAddress, managementGroup=managementGroup, dfsMeans=dfsMeans, syslogClientTrap=syslogClientTrap, ethernetGroup=ethernetGroup, telecomsInterface=telecomsInterface, productVariant=productVariant, ptp=ptp, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, longitude=longitude, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, systemClock=systemClock, aAAControl=aAAControl, encryptionAlgorithm=encryptionAlgorithm, sNTPServerIPAddress=sNTPServerIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, tDDControl=tDDControl, vLANPriorityQueueMapping=vLANPriorityQueueMapping, phyControl=phyControl, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataPortDisabledWarning=dataPortDisabledWarning, vLANPriorityTable=vLANPriorityTable, receiveFreqMHz=receiveFreqMHz, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, pubStatsGroup=pubStatsGroup, telecomsLoopback=telecomsLoopback, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, remoteMaximumTransmitPower=remoteMaximumTransmitPower, range=range, receiveModulationMode=receiveModulationMode, sNMPTrapTableIndex=sNMPTrapTableIndex, channelBandwidth=channelBandwidth, transmitFreqMHz=transmitFreqMHz, notificationsGroup=notificationsGroup, telecomsChannelStatusTrap=telecomsChannelStatusTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tFTPServerIPAddress=tFTPServerIPAddress, vLANPriorityTableIndex=vLANPriorityTableIndex, linkSymmetry=linkSymmetry, receiveModulationModeDetail=receiveModulationModeDetail, sNTPPollInterval=sNTPPollInterval, sntpGroup=sntpGroup, dfsTableEntry=dfsTableEntry, hTTPSPortNumber=hTTPSPortNumber, receiveChannel=receiveChannel, sntp=sntp, telnetPortNumber=telnetPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, tFTPServerPortNumber=tFTPServerPortNumber, receiveFreqKHz=receiveFreqKHz, masterSlaveMode=masterSlaveMode, sNMPTrapTableEntry=sNMPTrapTableEntry, vLANManagementPriority=vLANManagementPriority, dataPortAutoMdix=dataPortAutoMdix, installStatus=installStatus, sNMPv3Enable=sNMPv3Enable, sNTPState=sNTPState, userTable=userTable, licensedCapacity=licensedCapacity, transmitChannel=transmitChannel, telnetAccessEnabled=telnetAccessEnabled, eIRP=eIRP, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, reset=reset, antennaGain=antennaGain, sNMPPortNumber=sNMPPortNumber, phyStatus=phyStatus, installStatusTrap=installStatusTrap, resetGroup=resetGroup, latitude=latitude, licenceGroup=licenceGroup, versionsGroup=versionsGroup, ptpTrapPrefix=ptpTrapPrefix, supplementaryGroup=supplementaryGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, daylightSaving=daylightSaving, regionCodeTrap=regionCodeTrap, dfsGroup=dfsGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, aggregateDataRate=aggregateDataRate, cableLoss=cableLoss, phyStatusGroup=phyStatusGroup, userTableEntry=userTableEntry, ptp500=ptp500, transmitModulationMode=transmitModulationMode, syslogControlGroup=syslogControlGroup, dfsPeaks=dfsPeaks, useVLANForManagementInterfaces=useVLANForManagementInterfaces, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, transmitPower=transmitPower, timeZone=timeZone, bootVersion=bootVersion, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, userRole=userRole, telecomsLoopbackTrap=telecomsLoopbackTrap, secondarySoftwareVersion=secondarySoftwareVersion, userTableIndex=userTableIndex, cambium=cambium, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, hardwareVersion=hardwareVersion, receiveDataRate=receiveDataRate, syslogStateTrap=syslogStateTrap, linkName=linkName, constantPowerSpectralDensity=constantPowerSpectralDensity, channelChangeTrap=channelChangeTrap, telecomsCableLength=telecomsCableLength, ethernetFiberSupport=ethernetFiberSupport, userTableNumber=userTableNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, wirelessLinkStatus=wirelessLinkStatus, alarmsGroup=alarmsGroup, hTTPPortNumber=hTTPPortNumber, sMTPServerPortNumber=sMTPServerPortNumber, smtp=smtp, tDDSynchronizationStatus=tDDSynchronizationStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, sNTPSyncTrap=sNTPSyncTrap, accessMethod=accessMethod, encryptionGroup=encryptionGroup, regionCode=regionCode, dfsTableNumber=dfsTableNumber, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, softwareVersion=softwareVersion, ptpGroups=ptpGroups, vectorError=vectorError, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapPortNumber=sNMPTrapPortNumber, management=management, snmpControlGroup=snmpControlGroup, systemReset=systemReset, phyControlGroup=phyControlGroup, versions=versions, ptpCompliance=ptpCompliance, productName=productName, subnetMask=subnetMask, enabledDiagnosticAlarms=enabledDiagnosticAlarms, remoteIPAddress=remoteIPAddress, sNTPServerPortNumber=sNTPServerPortNumber, telecomsChannelStatus=telecomsChannelStatus, transmitDataRate=transmitDataRate, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tDDSynchronizationMode=tDDSynchronizationMode, unitOutOfCalibration=unitOutOfCalibration, sNMPEnabledTraps=sNMPEnabledTraps, vLANPriorityTableNumber=vLANPriorityTableNumber, capacityLicenseMismatch=capacityLicenseMismatch, dfs=dfs, sNMPTrapVersion=sNMPTrapVersion, userName=userName, ptmp=ptmp, smtpGroup=smtpGroup, dataPortStatusTrap=dataPortStatusTrap, telecomsLineCode=telecomsLineCode, incompatibleRegionCodes=incompatibleRegionCodes, hTTPAccessEnabled=hTTPAccessEnabled, sNMPCommunityString=sNMPCommunityString, PYSNMP_MODULE_ID=cambium, gatewayIPAddress=gatewayIPAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, receivePower=receivePower, sNTPSync=sNTPSync, userEnabled=userEnabled, sNMPTrapIPAddress=sNMPTrapIPAddress, configuration=configuration, bandwidthVariant=bandwidthVariant, syslogState=syslogState, telecom=telecom, linkModeOptimizationMismatch=linkModeOptimizationMismatch, byteErrorRatio=byteErrorRatio, licence=licence, telecomGroup=telecomGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, linkModeOptimisation=linkModeOptimisation, maximumTransmitPower=maximumTransmitPower, dataPortAutoNegotiation=dataPortAutoNegotiation, transmitFreqKHz=transmitFreqKHz, sNMPTrapTable=sNMPTrapTable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, siteName=siteName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNTPLastSync=sNTPLastSync, encryption=encryption, userPassword=userPassword, dataPortStatus=dataPortStatus, ethernet=ethernet, hTTPSAccessEnabled=hTTPSAccessEnabled, aAAControlGroup=aAAControlGroup, groupID=groupID, sMTPServerIPAddress=sMTPServerIPAddress, wirelessLinkAvailability=wirelessLinkAvailability, altitude=altitude, dataPortConfigurationMismatch=dataPortConfigurationMismatch, installArmStateTrap=installArmStateTrap, sMTPEmailAlert=sMTPEmailAlert, syslogClient=syslogClient, dfsTable=dfsTable)
