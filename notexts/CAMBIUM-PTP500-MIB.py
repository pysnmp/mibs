...
# Produced by pysmi-1.1.8 at Thu Jan  6 19:20:31 2022
...
iso, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, MibIdentifier, NotificationType, Counter32, Gauge32, ModuleIdentity, enterprises, Unsigned32, TimeTicks, IpAddress, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "MibIdentifier", "NotificationType", "Counter32", "Gauge32", "ModuleIdentity", "enterprises", "Unsigned32", "TimeTicks", "IpAddress", "ObjectIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, resetGroup=resetGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, ptpCompliance=ptpCompliance, telnetAccessEnabled=telnetAccessEnabled, capacityLicenseMismatch=capacityLicenseMismatch, searchState=searchState, dfs=dfs, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, userName=userName, receiveChannel=receiveChannel, vectorError=vectorError, encryptionGroup=encryptionGroup, alarms=alarms, tDDSynchronizationMode=tDDSynchronizationMode, maximumTransmitPower=maximumTransmitPower, hTTPSPortNumber=hTTPSPortNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, hTTPAccessEnabled=hTTPAccessEnabled, hardwareVersion=hardwareVersion, sNMPTrapPortNumber=sNMPTrapPortNumber, syslogClientTrap=syslogClientTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, dataPortStatusTrap=dataPortStatusTrap, frequencyVariant=frequencyVariant, tFTPServerPortNumber=tFTPServerPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, configuration=configuration, sNMPTrapIPAddress=sNMPTrapIPAddress, channelBandwidth=channelBandwidth, notificationsGroup=notificationsGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, transmitFreqKHz=transmitFreqKHz, regionCode=regionCode, sNMPTrapTable=sNMPTrapTable, remoteMaximumTransmitPower=remoteMaximumTransmitPower, installArmState=installArmState, configurationGroup=configurationGroup, gatewayIPAddress=gatewayIPAddress, encryptionAlgorithm=encryptionAlgorithm, snmpControlGroup=snmpControlGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, wirelessLinkAvailability=wirelessLinkAvailability, sMTPEmailAlert=sMTPEmailAlert, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, systemClock=systemClock, hTTPPortNumber=hTTPPortNumber, transmitPower=transmitPower, channelChangeTrap=channelChangeTrap, sNMPPortNumber=sNMPPortNumber, installStatusTrap=installStatusTrap, targetMACAddress=targetMACAddress, dfsPeaks=dfsPeaks, pubStatsGroup=pubStatsGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, receiveModulationModeDetail=receiveModulationModeDetail, PYSNMP_MODULE_ID=cambium, ethernetGroup=ethernetGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, telecomsLoopback=telecomsLoopback, sMTPServerIPAddress=sMTPServerIPAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, syslogStateTrap=syslogStateTrap, sMTPEnabledMessages=sMTPEnabledMessages, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, aAAControl=aAAControl, byteErrorRatio=byteErrorRatio, userRole=userRole, siteName=siteName, bootVersion=bootVersion, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, licence=licence, cambium=cambium, telecomsChannelStatusTrap=telecomsChannelStatusTrap, systemReset=systemReset, vLANManagementPriority=vLANManagementPriority, userPassword=userPassword, sMTPSourceEmailAddress=sMTPSourceEmailAddress, longitude=longitude, dfsTableEntry=dfsTableEntry, dataPortStatus=dataPortStatus, tDDControl=tDDControl, telecomsChannelStatus=telecomsChannelStatus, userEnabled=userEnabled, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, telecom=telecom, ethernetFiberSupport=ethernetFiberSupport, tDDSynchronizationStatus=tDDSynchronizationStatus, licensedCapacity=licensedCapacity, transmitChannel=transmitChannel, telecomsLoopbackTrap=telecomsLoopbackTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, aggregateDataRate=aggregateDataRate, smtpGroup=smtpGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, unitOutOfCalibration=unitOutOfCalibration, productName=productName, syslogState=syslogState, aAAControlGroup=aAAControlGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, transmitDataRate=transmitDataRate, bandwidthVariant=bandwidthVariant, accessMethod=accessMethod, masterSlaveMode=masterSlaveMode, syslogClient=syslogClient, ptpTrapPrefix=ptpTrapPrefix, linkName=linkName, ptpGroups=ptpGroups, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, reset=reset, dataPortDisabledWarning=dataPortDisabledWarning, versions=versions, sNTPServerPortNumber=sNTPServerPortNumber, dataPortAutoMdix=dataPortAutoMdix, phyStatus=phyStatus, sntp=sntp, dfsGroup=dfsGroup, subnetMask=subnetMask, secondarySoftwareVersion=secondarySoftwareVersion, installArmStateTrap=installArmStateTrap, syslogControl=syslogControl, versionsGroup=versionsGroup, ptp=ptp, antennaGain=antennaGain, iPAddress=iPAddress, userTableIndex=userTableIndex, altitude=altitude, licenceGroup=licenceGroup, sNTPSync=sNTPSync, timeZone=timeZone, management=management, ptpTraps=ptpTraps, syslogControlGroup=syslogControlGroup, eIRP=eIRP, constantPowerSpectralDensity=constantPowerSpectralDensity, dfsTableIndex=dfsTableIndex, sNTPServerIPAddress=sNTPServerIPAddress, linkSymmetry=linkSymmetry, ethernet=ethernet, receiveModulationMode=receiveModulationMode, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, managementGroup=managementGroup, telecomsCableLength=telecomsCableLength, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dfsTable=dfsTable, sNMPv3Enable=sNMPv3Enable, smtp=smtp, tDDControlGroup=tDDControlGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, ptmp=ptmp, vLANPriorityQueueMapping=vLANPriorityQueueMapping, dfsTableNumber=dfsTableNumber, tFTPServerIPAddress=tFTPServerIPAddress, incompatibleMasterAndSlave=incompatibleMasterAndSlave, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dfsMeans=dfsMeans, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ptp500=ptp500, phyControlGroup=phyControlGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPServerPortNumber=sMTPServerPortNumber, phyControl=phyControl, sNMPCommunityString=sNMPCommunityString, noWirelessChannelAvailable=noWirelessChannelAvailable, receiveFreqKHz=receiveFreqKHz, sNMPTrapVersion=sNMPTrapVersion, sNTPLastSync=sNTPLastSync, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNTPSyncTrap=sNTPSyncTrap, receiveDataRate=receiveDataRate, supplementaryGroup=supplementaryGroup, incompatibleRegionCodes=incompatibleRegionCodes, vLANPriorityTableIndex=vLANPriorityTableIndex, softwareVersion=softwareVersion, telecomGroup=telecomGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, userTableEntry=userTableEntry, encryption=encryption, sNMPEnabledTraps=sNMPEnabledTraps, sNTPPollInterval=sNTPPollInterval, supplementary=supplementary, transmitModulationMode=transmitModulationMode, latitude=latitude, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, wirelessLinkStatus=wirelessLinkStatus, daylightSaving=daylightSaving, sntpGroup=sntpGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, phyStatusGroup=phyStatusGroup, installStatus=installStatus, linkModeOptimisation=linkModeOptimisation, snmpControl=snmpControl, userTableNumber=userTableNumber, userTable=userTable, range=range, alarmsGroup=alarmsGroup, groupID=groupID, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, receiveFreqMHz=receiveFreqMHz, productVariant=productVariant, receivePower=receivePower, vLANManagementVID=vLANManagementVID, regionCodeTrap=regionCodeTrap, sNTPState=sNTPState, dataPortAutoNegotiation=dataPortAutoNegotiation, pubStats=pubStats, cableLoss=cableLoss, linkLoss=linkLoss, telecomsInterface=telecomsInterface, transmitFreqMHz=transmitFreqMHz, remoteIPAddress=remoteIPAddress, signalStrengthRatio=signalStrengthRatio, telnetPortNumber=telnetPortNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, telecomsLineCode=telecomsLineCode, vLANPriorityTable=vLANPriorityTable)
