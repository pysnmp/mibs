...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", telnetAccessEnabled=telnetAccessEnabled, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPv3Enable=sNMPv3Enable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPState=sNTPState, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, transmitModulationMode=transmitModulationMode, sNMPEnabledTraps=sNMPEnabledTraps, management=management, sNTPServerIPAddress=sNTPServerIPAddress, secondarySoftwareVersion=secondarySoftwareVersion, sNTPSync=sNTPSync, enabledDiagnosticAlarms=enabledDiagnosticAlarms, userName=userName, hardwareVersion=hardwareVersion, iPAddress=iPAddress, linkSymmetry=linkSymmetry, useVLANForManagementInterfaces=useVLANForManagementInterfaces, unitOutOfCalibration=unitOutOfCalibration, telnetPortNumber=telnetPortNumber, linkModeOptimisation=linkModeOptimisation, sMTPServerPortNumber=sMTPServerPortNumber, supplementary=supplementary, latitude=latitude, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, phyControl=phyControl, telecomsInterface=telecomsInterface, dataPortStatus=dataPortStatus, sNTPServerPortNumber=sNTPServerPortNumber, systemReset=systemReset, linkModeOptimizationMismatch=linkModeOptimizationMismatch, snmpControl=snmpControl, dfsPeaks=dfsPeaks, incompatibleRegionCodes=incompatibleRegionCodes, PYSNMP_MODULE_ID=cambium, ethernet=ethernet, hTTPSAccessEnabled=hTTPSAccessEnabled, timeZone=timeZone, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, capacityLicenseMismatch=capacityLicenseMismatch, siteName=siteName, eIRP=eIRP, bandwidthVariant=bandwidthVariant, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortStatusTrap=dataPortStatusTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, receiveChannel=receiveChannel, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, regionCodeTrap=regionCodeTrap, phyStatus=phyStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, installStatusTrap=installStatusTrap, groupID=groupID, versionsGroup=versionsGroup, snmpControlGroup=snmpControlGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, searchState=searchState, vLANPriorityTableNumber=vLANPriorityTableNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, telecomsLoopback=telecomsLoopback, linkName=linkName, dataPortDisabledWarning=dataPortDisabledWarning, aggregateDataRate=aggregateDataRate, wirelessLinkAvailability=wirelessLinkAvailability, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, wirelessLinkStatus=wirelessLinkStatus, ptpGroups=ptpGroups, ptpTrapPrefix=ptpTrapPrefix, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, longitude=longitude, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, vLANManagementVID=vLANManagementVID, installArmState=installArmState, userRole=userRole, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, managementGroup=managementGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, vLANManagementPriority=vLANManagementPriority, productName=productName, syslogControl=syslogControl, transmitFreqMHz=transmitFreqMHz, dfsTable=dfsTable, alarmsGroup=alarmsGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, telecomsChannelStatusTrap=telecomsChannelStatusTrap, licence=licence, supplementaryGroup=supplementaryGroup, cableLoss=cableLoss, configurationGroup=configurationGroup, licenceGroup=licenceGroup, smtpGroup=smtpGroup, tFTPServerPortNumber=tFTPServerPortNumber, sMTPEmailAlert=sMTPEmailAlert, receiveModulationMode=receiveModulationMode, dataPortWirelessDownAlert=dataPortWirelessDownAlert, receivePower=receivePower, tFTPServerIPAddress=tFTPServerIPAddress, sMTPEnabledMessages=sMTPEnabledMessages, vLANPriorityTableEntry=vLANPriorityTableEntry, userEnabled=userEnabled, pubStats=pubStats, gatewayIPAddress=gatewayIPAddress, userTableEntry=userTableEntry, sNMPTrapTableIndex=sNMPTrapTableIndex, receiveFreqMHz=receiveFreqMHz, altitude=altitude, aAAControlGroup=aAAControlGroup, tDDSynchronizationMode=tDDSynchronizationMode, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, encryptionAlgorithm=encryptionAlgorithm, accessMethod=accessMethod, remoteMaximumTransmitPower=remoteMaximumTransmitPower, encryption=encryption, userTable=userTable, telecomsCableLength=telecomsCableLength, daylightSaving=daylightSaving, tDDSynchronizationStatus=tDDSynchronizationStatus, softwareVersion=softwareVersion, dfsTableEntry=dfsTableEntry, subnetMask=subnetMask, vLANPriorityQueueMapping=vLANPriorityQueueMapping, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, bootVersion=bootVersion, remoteIPAddress=remoteIPAddress, notificationsGroup=notificationsGroup, vectorError=vectorError, tDDControlGroup=tDDControlGroup, syslogState=syslogState, syslogControlGroup=syslogControlGroup, aAAControl=aAAControl, userTableNumber=userTableNumber, productVariant=productVariant, encryptionGroup=encryptionGroup, sNTPSyncTrap=sNTPSyncTrap, reset=reset, transmitDataRate=transmitDataRate, hTTPSPortNumber=hTTPSPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, telecomsLineCode=telecomsLineCode, versions=versions, sNMPCommunityString=sNMPCommunityString, systemClock=systemClock, syslogClientTrap=syslogClientTrap, telecomGroup=telecomGroup, ptp500=ptp500, ptpCompliance=ptpCompliance, hTTPPortNumber=hTTPPortNumber, vLANPriorityTable=vLANPriorityTable, receiveDataRate=receiveDataRate, byteErrorRatio=byteErrorRatio, configuration=configuration, vLANPriorityTableIndex=vLANPriorityTableIndex, antennaGain=antennaGain, sntp=sntp, linkLoss=linkLoss, sMTPServerIPAddress=sMTPServerIPAddress, installStatus=installStatus, range=range, sNMPTrapVersion=sNMPTrapVersion, ptp=ptp, dfsMeans=dfsMeans, userTableIndex=userTableIndex, receiveModulationModeDetail=receiveModulationModeDetail, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, signalStrengthRatio=signalStrengthRatio, dfsGroup=dfsGroup, tDDControl=tDDControl, userPassword=userPassword, phyControlGroup=phyControlGroup, transmitChannel=transmitChannel, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, maximumTransmitPower=maximumTransmitPower, sntpGroup=sntpGroup, dfsTableIndex=dfsTableIndex, resetGroup=resetGroup, dfs=dfs, masterSlaveMode=masterSlaveMode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ethernetGroup=ethernetGroup, sNMPPortNumber=sNMPPortNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, syslogClient=syslogClient, cambium=cambium, smtp=smtp, installArmStateTrap=installArmStateTrap, phyStatusGroup=phyStatusGroup, ptmp=ptmp, sNTPPollInterval=sNTPPollInterval, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, transmitFreqKHz=transmitFreqKHz, licensedCapacity=licensedCapacity, hTTPAccessEnabled=hTTPAccessEnabled, telecomsChannelStatus=telecomsChannelStatus, dataPortAutoMdix=dataPortAutoMdix, sMTPSourceEmailAddress=sMTPSourceEmailAddress, channelBandwidth=channelBandwidth, alarms=alarms, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, telecom=telecom, transmitPower=transmitPower, regionCode=regionCode, channelChangeTrap=channelChangeTrap, ethernetFiberSupport=ethernetFiberSupport, sNTPLastSync=sNTPLastSync, syslogStateTrap=syslogStateTrap, receiveFreqKHz=receiveFreqKHz, sNMPTrapTable=sNMPTrapTable, frequencyVariant=frequencyVariant, noWirelessChannelAvailable=noWirelessChannelAvailable, targetMACAddress=targetMACAddress, pubStatsGroup=pubStatsGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPTrapTableNumber=sNMPTrapTableNumber, dfsTableNumber=dfsTableNumber, ptpTraps=ptpTraps)
