...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sNMPTrapTable=sNMPTrapTable, telnetAccessEnabled=telnetAccessEnabled, dfsTableNumber=dfsTableNumber, vLANManagementVID=vLANManagementVID, sNTPState=sNTPState, userTableIndex=userTableIndex, versions=versions, frequencyVariant=frequencyVariant, dfsPeaks=dfsPeaks, telecomsInterface=telecomsInterface, timeZone=timeZone, alarms=alarms, userTableEntry=userTableEntry, iPAddress=iPAddress, dataPortStatus=dataPortStatus, sNTPPollInterval=sNTPPollInterval, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sMTPEnabledMessages=sMTPEnabledMessages, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, ptp500=ptp500, searchState=searchState, latitude=latitude, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNTPLastSync=sNTPLastSync, sMTPSourceEmailAddress=sMTPSourceEmailAddress, receiveFreqKHz=receiveFreqKHz, tDDSynchronizationStatus=tDDSynchronizationStatus, phyStatusGroup=phyStatusGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dataPortStatusTrap=dataPortStatusTrap, transmitPower=transmitPower, userTableNumber=userTableNumber, dfs=dfs, vLANPriorityTable=vLANPriorityTable, sNMPCommunityString=sNMPCommunityString, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, capacityLicenseMismatch=capacityLicenseMismatch, pubStats=pubStats, supplementary=supplementary, phyControlGroup=phyControlGroup, systemReset=systemReset, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPServerPortNumber=tFTPServerPortNumber, syslogState=syslogState, sNMPTrapTableIndex=sNMPTrapTableIndex, userPassword=userPassword, wirelessLinkStatus=wirelessLinkStatus, gatewayIPAddress=gatewayIPAddress, telecomsChannelStatus=telecomsChannelStatus, installStatusTrap=installStatusTrap, unitOutOfCalibration=unitOutOfCalibration, channelChangeTrap=channelChangeTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, smtpGroup=smtpGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, installArmState=installArmState, userEnabled=userEnabled, licensedCapacity=licensedCapacity, sMTPServerPortNumber=sMTPServerPortNumber, sNTPServerPortNumber=sNTPServerPortNumber, productVariant=productVariant, telecomsLoopback=telecomsLoopback, receiveDataRate=receiveDataRate, syslogStateTrap=syslogStateTrap, ethernetGroup=ethernetGroup, bandwidthVariant=bandwidthVariant, sNMPTrapVersion=sNMPTrapVersion, syslogClient=syslogClient, versionsGroup=versionsGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, antennaGain=antennaGain, eIRP=eIRP, tDDControl=tDDControl, transmitDataRate=transmitDataRate, transmitFreqKHz=transmitFreqKHz, dataPortWirelessDownAlert=dataPortWirelessDownAlert, hTTPSPortNumber=hTTPSPortNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, userName=userName, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, daylightSaving=daylightSaving, sNTPServerIPAddress=sNTPServerIPAddress, ptmp=ptmp, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sMTPEmailAlert=sMTPEmailAlert, telecom=telecom, masterSlaveMode=masterSlaveMode, wirelessLinkAvailability=wirelessLinkAvailability, transmitFreqMHz=transmitFreqMHz, telecomsLineCode=telecomsLineCode, snmpControlGroup=snmpControlGroup, telecomsCableLength=telecomsCableLength, sNTPSyncTrap=sNTPSyncTrap, dfsTableEntry=dfsTableEntry, alarmsGroup=alarmsGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, receiveChannel=receiveChannel, supplementaryGroup=supplementaryGroup, configuration=configuration, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsTable=dfsTable, syslogControlGroup=syslogControlGroup, linkModeOptimisation=linkModeOptimisation, secondarySoftwareVersion=secondarySoftwareVersion, telecomsLoopbackTrap=telecomsLoopbackTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, constantPowerSpectralDensity=constantPowerSpectralDensity, altitude=altitude, pubStatsGroup=pubStatsGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, cambium=cambium, vLANPriorityTableEntry=vLANPriorityTableEntry, receiveFreqMHz=receiveFreqMHz, sntp=sntp, longitude=longitude, sNTPSync=sNTPSync, sntpGroup=sntpGroup, aggregateDataRate=aggregateDataRate, linkLoss=linkLoss, remoteIPAddress=remoteIPAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, management=management, syslogControl=syslogControl, aAAControlGroup=aAAControlGroup, tDDSynchronizationMode=tDDSynchronizationMode, ethernet=ethernet, ptpTrapPrefix=ptpTrapPrefix, targetMACAddress=targetMACAddress, groupID=groupID, installArmStateTrap=installArmStateTrap, licence=licence, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, reset=reset, systemClock=systemClock, encryption=encryption, regionCode=regionCode, dataPortConfigurationMismatch=dataPortConfigurationMismatch, linkSymmetry=linkSymmetry, licenceGroup=licenceGroup, telnetPortNumber=telnetPortNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, remoteMaximumTransmitPower=remoteMaximumTransmitPower, installStatus=installStatus, PYSNMP_MODULE_ID=cambium, snmpControl=snmpControl, incompatibleRegionCodes=incompatibleRegionCodes, transmitModulationMode=transmitModulationMode, subnetMask=subnetMask, hardwareVersion=hardwareVersion, configurationGroup=configurationGroup, aAAControl=aAAControl, regionCodeTrap=regionCodeTrap, sNMPPortNumber=sNMPPortNumber, signalStrengthRatio=signalStrengthRatio, incompatibleMasterAndSlave=incompatibleMasterAndSlave, cableLoss=cableLoss, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, vLANManagementPriority=vLANManagementPriority, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, phyStatus=phyStatus, transmitChannel=transmitChannel, userTable=userTable, sNMPTrapTableEntry=sNMPTrapTableEntry, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, softwareVersion=softwareVersion, hTTPAccessEnabled=hTTPAccessEnabled, ptpTraps=ptpTraps, byteErrorRatio=byteErrorRatio, sNMPEnabledTraps=sNMPEnabledTraps, vLANPriorityQueueMapping=vLANPriorityQueueMapping, hTTPPortNumber=hTTPPortNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, maximumTransmitPower=maximumTransmitPower, ptpCompliance=ptpCompliance, productName=productName, phyControl=phyControl, channelBandwidth=channelBandwidth, receiveModulationMode=receiveModulationMode, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, tFTPServerIPAddress=tFTPServerIPAddress, userRole=userRole, ethernetFiberSupport=ethernetFiberSupport, syslogClientTrap=syslogClientTrap, dfsMeans=dfsMeans, dfsGroup=dfsGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, linkName=linkName, notificationsGroup=notificationsGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapIPAddress=sNMPTrapIPAddress, bootVersion=bootVersion, dfsTableIndex=dfsTableIndex, sNMPv3Enable=sNMPv3Enable, ptpGroups=ptpGroups, receivePower=receivePower, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, resetGroup=resetGroup, dataPortDisabledWarning=dataPortDisabledWarning, managementGroup=managementGroup, receiveModulationModeDetail=receiveModulationModeDetail, encryptionAlgorithm=encryptionAlgorithm, ptp=ptp, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, vectorError=vectorError, smtp=smtp, sMTPServerIPAddress=sMTPServerIPAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, accessMethod=accessMethod, encryptionGroup=encryptionGroup, tDDControlGroup=tDDControlGroup, dataPortAutoMdix=dataPortAutoMdix, siteName=siteName, telecomGroup=telecomGroup, range=range)
