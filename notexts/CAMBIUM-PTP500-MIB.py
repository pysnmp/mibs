...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", iPAddress=iPAddress, bootVersion=bootVersion, ptp500=ptp500, aggregateDataRate=aggregateDataRate, dataPortAutoNegotiation=dataPortAutoNegotiation, installStatus=installStatus, transmitFreqKHz=transmitFreqKHz, searchState=searchState, hTTPSPortNumber=hTTPSPortNumber, tDDControl=tDDControl, sMTPServerIPAddress=sMTPServerIPAddress, ptmp=ptmp, licenceGroup=licenceGroup, targetMACAddress=targetMACAddress, receivePower=receivePower, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, receiveFreqKHz=receiveFreqKHz, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, userRole=userRole, regionCode=regionCode, gatewayIPAddress=gatewayIPAddress, ethernet=ethernet, sMTPEmailAlert=sMTPEmailAlert, syslogControlGroup=syslogControlGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sntpGroup=sntpGroup, syslogControl=syslogControl, receiveModulationMode=receiveModulationMode, dfsTableEntry=dfsTableEntry, telecomsCableLength=telecomsCableLength, hTTPAccessEnabled=hTTPAccessEnabled, tDDSynchronizationStatus=tDDSynchronizationStatus, groupID=groupID, phyControlGroup=phyControlGroup, dfsMeans=dfsMeans, dataPortDisabledWarning=dataPortDisabledWarning, channelChangeTrap=channelChangeTrap, supplementary=supplementary, ptpCompliance=ptpCompliance, resetGroup=resetGroup, ethernetGroup=ethernetGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, transmitModulationMode=transmitModulationMode, dataPortAutoMdix=dataPortAutoMdix, syslogLocalWrappedTrap=syslogLocalWrappedTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, phyControl=phyControl, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, notificationsGroup=notificationsGroup, smtpGroup=smtpGroup, systemClock=systemClock, userPassword=userPassword, subnetMask=subnetMask, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, supplementaryGroup=supplementaryGroup, softwareVersion=softwareVersion, vLANPriorityTable=vLANPriorityTable, syslogClientTrap=syslogClientTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, receiveDataRate=receiveDataRate, range=range, userTable=userTable, sNMPTrapTable=sNMPTrapTable, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, remoteMaximumTransmitPower=remoteMaximumTransmitPower, systemReset=systemReset, capacityLicenseMismatch=capacityLicenseMismatch, sNMPCommunityString=sNMPCommunityString, cambium=cambium, hTTPSAccessEnabled=hTTPSAccessEnabled, receiveModulationModeDetail=receiveModulationModeDetail, tDDControlGroup=tDDControlGroup, telnetPortNumber=telnetPortNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, dataPortStatus=dataPortStatus, dfsGroup=dfsGroup, sNTPSyncTrap=sNTPSyncTrap, vLANPriorityQueueMapping=vLANPriorityQueueMapping, pubStats=pubStats, syslogClient=syslogClient, linkSymmetry=linkSymmetry, telecomsLoopbackTrap=telecomsLoopbackTrap, incompatibleRegionCodes=incompatibleRegionCodes, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPEnabledTraps=sNMPEnabledTraps, smtp=smtp, encryption=encryption, snmpControlGroup=snmpControlGroup, ptpGroups=ptpGroups, sNMPv3Enable=sNMPv3Enable, hTTPPortNumber=hTTPPortNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, vectorError=vectorError, reset=reset, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, transmitDataRate=transmitDataRate, encryptionGroup=encryptionGroup, sNTPState=sNTPState, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, telecomsChannelStatus=telecomsChannelStatus, sMTPEnabledMessages=sMTPEnabledMessages, byteErrorRatio=byteErrorRatio, sNMPTrapPortNumber=sNMPTrapPortNumber, phyStatus=phyStatus, telecomsLineCode=telecomsLineCode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, licence=licence, timeZone=timeZone, userEnabled=userEnabled, sNTPPollInterval=sNTPPollInterval, ptpTrapPrefix=ptpTrapPrefix, aAAControlGroup=aAAControlGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, transmitChannel=transmitChannel, pubStatsGroup=pubStatsGroup, hardwareVersion=hardwareVersion, snmpControl=snmpControl, telecomGroup=telecomGroup, bandwidthVariant=bandwidthVariant, managementGroup=managementGroup, syslogStateTrap=syslogStateTrap, configurationGroup=configurationGroup, userName=userName, linkModeOptimisation=linkModeOptimisation, sMTPSourceEmailAddress=sMTPSourceEmailAddress, userTableEntry=userTableEntry, installStatusTrap=installStatusTrap, cableLoss=cableLoss, sNTPServerPortNumber=sNTPServerPortNumber, tFTPServerPortNumber=tFTPServerPortNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, maximumTransmitPower=maximumTransmitPower, sNTPSync=sNTPSync, regionCodeTrap=regionCodeTrap, telecomsInterface=telecomsInterface, dfsTableIndex=dfsTableIndex, receiveFreqMHz=receiveFreqMHz, sntp=sntp, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, remoteIPAddress=remoteIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, altitude=altitude, secondarySoftwareVersion=secondarySoftwareVersion, alarmsGroup=alarmsGroup, signalStrengthRatio=signalStrengthRatio, receiveChannel=receiveChannel, latitude=latitude, dfsTable=dfsTable, antennaGain=antennaGain, unitOutOfCalibration=unitOutOfCalibration, transmitFreqMHz=transmitFreqMHz, alarms=alarms, telnetAccessEnabled=telnetAccessEnabled, frequencyVariant=frequencyVariant, transmitPower=transmitPower, noWirelessChannelAvailable=noWirelessChannelAvailable, productName=productName, userTableIndex=userTableIndex, vLANPriorityTableNumber=vLANPriorityTableNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, management=management, versions=versions, configuration=configuration, dataPortStatusTrap=dataPortStatusTrap, channelBandwidth=channelBandwidth, userTableNumber=userTableNumber, siteName=siteName, linkLoss=linkLoss, telecomsChannelStatusTrap=telecomsChannelStatusTrap, installArmStateTrap=installArmStateTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPTrapTableIndex=sNMPTrapTableIndex, sMTPServerPortNumber=sMTPServerPortNumber, daylightSaving=daylightSaving, syslogState=syslogState, vLANManagementPriority=vLANManagementPriority, telecom=telecom, tDDSynchronizationMode=tDDSynchronizationMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNTPServerIPAddress=sNTPServerIPAddress, aAAControl=aAAControl, masterSlaveMode=masterSlaveMode, PYSNMP_MODULE_ID=cambium, dataPortWirelessDownAlert=dataPortWirelessDownAlert, accessMethod=accessMethod, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, phyStatusGroup=phyStatusGroup, linkName=linkName, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ethernetFiberSupport=ethernetFiberSupport, productVariant=productVariant, installArmState=installArmState, licensedCapacity=licensedCapacity, sNMPTrapTableNumber=sNMPTrapTableNumber, tFTPServerIPAddress=tFTPServerIPAddress, sNMPPortNumber=sNMPPortNumber, sNTPLastSync=sNTPLastSync, longitude=longitude, dfs=dfs, sNMPTrapTableEntry=sNMPTrapTableEntry, ptpTraps=ptpTraps, ptp=ptp, wirelessLinkAvailability=wirelessLinkAvailability, vLANManagementVID=vLANManagementVID, sNMPTrapVersion=sNMPTrapVersion, wirelessLinkStatus=wirelessLinkStatus, encryptionAlgorithm=encryptionAlgorithm, telecomsLoopback=telecomsLoopback, dfsPeaks=dfsPeaks, eIRP=eIRP, dfsTableNumber=dfsTableNumber, versionsGroup=versionsGroup)
