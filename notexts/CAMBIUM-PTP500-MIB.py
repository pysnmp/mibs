...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", dataPortDisabledWarning=dataPortDisabledWarning, unitOutOfCalibration=unitOutOfCalibration, remoteMaximumTransmitPower=remoteMaximumTransmitPower, receivePower=receivePower, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, dfsPeaks=dfsPeaks, supplementary=supplementary, phyControl=phyControl, receiveModulationMode=receiveModulationMode, userEnabled=userEnabled, wirelessLinkAvailability=wirelessLinkAvailability, sNTPServerIPAddress=sNTPServerIPAddress, capacityLicenseMismatch=capacityLicenseMismatch, dfsTable=dfsTable, daylightSaving=daylightSaving, secondarySoftwareVersion=secondarySoftwareVersion, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, eIRP=eIRP, syslogState=syslogState, tDDSynchronizationStatus=tDDSynchronizationStatus, hardwareVersion=hardwareVersion, installStatusTrap=installStatusTrap, encryptionGroup=encryptionGroup, tFTPServerIPAddress=tFTPServerIPAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, vectorError=vectorError, transmitFreqKHz=transmitFreqKHz, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, syslogClient=syslogClient, gatewayIPAddress=gatewayIPAddress, hTTPSPortNumber=hTTPSPortNumber, vLANPriorityQueueMapping=vLANPriorityQueueMapping, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPPortNumber=sNMPPortNumber, encryptionAlgorithm=encryptionAlgorithm, syslogStateTrap=syslogStateTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, regionCodeTrap=regionCodeTrap, telecomGroup=telecomGroup, telecomsLoopbackTrap=telecomsLoopbackTrap, hTTPAccessEnabled=hTTPAccessEnabled, reset=reset, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, transmitPower=transmitPower, sNMPTrapTable=sNMPTrapTable, altitude=altitude, systemClock=systemClock, aAAControl=aAAControl, licence=licence, bandwidthVariant=bandwidthVariant, telecomsChannelStatus=telecomsChannelStatus, ptmp=ptmp, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, incompatibleRegionCodes=incompatibleRegionCodes, dfs=dfs, telecomsLineCode=telecomsLineCode, versionsGroup=versionsGroup, pubStatsGroup=pubStatsGroup, snmpControl=snmpControl, userName=userName, linkName=linkName, sNMPv3Enable=sNMPv3Enable, telnetAccessEnabled=telnetAccessEnabled, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, range=range, enabledDiagnosticAlarms=enabledDiagnosticAlarms, pubStats=pubStats, phyControlGroup=phyControlGroup, wirelessLinkStatus=wirelessLinkStatus, userTableNumber=userTableNumber, aAAControlGroup=aAAControlGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dfsMeans=dfsMeans, syslogControl=syslogControl, searchState=searchState, sNMPEnabledTraps=sNMPEnabledTraps, ptpTraps=ptpTraps, sNTPSync=sNTPSync, sMTPEmailAlert=sMTPEmailAlert, versions=versions, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dfsTableNumber=dfsTableNumber, signalStrengthRatio=signalStrengthRatio, sMTPServerPortNumber=sMTPServerPortNumber, dfsTableEntry=dfsTableEntry, licensedCapacity=licensedCapacity, hTTPSAccessEnabled=hTTPSAccessEnabled, installArmStateTrap=installArmStateTrap, transmitChannel=transmitChannel, sNTPState=sNTPState, dataPortStatus=dataPortStatus, dataPortAutoMdix=dataPortAutoMdix, smtpGroup=smtpGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, phyStatus=phyStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, userTableEntry=userTableEntry, transmitModulationMode=transmitModulationMode, bootVersion=bootVersion, telnetPortNumber=telnetPortNumber, syslogClientTrap=syslogClientTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, alarms=alarms, encryption=encryption, userPassword=userPassword, receiveFreqMHz=receiveFreqMHz, cambium=cambium, transmitDataRate=transmitDataRate, latitude=latitude, sNTPServerPortNumber=sNTPServerPortNumber, productVariant=productVariant, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPPollInterval=sNTPPollInterval, sMTPServerIPAddress=sMTPServerIPAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, alarmsGroup=alarmsGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, systemReset=systemReset, incompatibleMasterAndSlave=incompatibleMasterAndSlave, phyStatusGroup=phyStatusGroup, receiveDataRate=receiveDataRate, sNMPCommunityString=sNMPCommunityString, linkSymmetry=linkSymmetry, sNTPSyncTrap=sNTPSyncTrap, sntp=sntp, masterSlaveMode=masterSlaveMode, telecomsCableLength=telecomsCableLength, regionCode=regionCode, userRole=userRole, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, transmitFreqMHz=transmitFreqMHz, sNMPTrapTableEntry=sNMPTrapTableEntry, vLANPriorityTableNumber=vLANPriorityTableNumber, vLANPriorityTable=vLANPriorityTable, longitude=longitude, resetGroup=resetGroup, siteName=siteName, cableLoss=cableLoss, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNMPTrapVersion=sNMPTrapVersion, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, receiveFreqKHz=receiveFreqKHz, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, linkModeOptimisation=linkModeOptimisation, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, installStatus=installStatus, targetMACAddress=targetMACAddress, softwareVersion=softwareVersion, ptpGroups=ptpGroups, vLANPriorityTableIndex=vLANPriorityTableIndex, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, telecomsInterface=telecomsInterface, channelChangeTrap=channelChangeTrap, ethernet=ethernet, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ptpCompliance=ptpCompliance, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tDDControlGroup=tDDControlGroup, ptp500=ptp500, ptpTrapPrefix=ptpTrapPrefix, dataPortStatusTrap=dataPortStatusTrap, timeZone=timeZone, dataPortConfigurationMismatch=dataPortConfigurationMismatch, receiveModulationModeDetail=receiveModulationModeDetail, iPAddress=iPAddress, receiveChannel=receiveChannel, userTableIndex=userTableIndex, ethernetFiberSupport=ethernetFiberSupport, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkLoss=linkLoss, dataPortAutoNegotiation=dataPortAutoNegotiation, productName=productName, ethernetGroup=ethernetGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, subnetMask=subnetMask, ptp=ptp, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, PYSNMP_MODULE_ID=cambium, licenceGroup=licenceGroup, notificationsGroup=notificationsGroup, tDDSynchronizationMode=tDDSynchronizationMode, frequencyVariant=frequencyVariant, smtp=smtp, vLANManagementPriority=vLANManagementPriority, groupID=groupID, byteErrorRatio=byteErrorRatio, managementGroup=managementGroup, syslogControlGroup=syslogControlGroup, dfsTableIndex=dfsTableIndex, remoteIPAddress=remoteIPAddress, vLANManagementVID=vLANManagementVID, accessMethod=accessMethod, configurationGroup=configurationGroup, hTTPPortNumber=hTTPPortNumber, supplementaryGroup=supplementaryGroup, tFTPServerPortNumber=tFTPServerPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, userTable=userTable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, telecomsChannelStatusTrap=telecomsChannelStatusTrap, maximumTransmitPower=maximumTransmitPower, management=management, sntpGroup=sntpGroup, dfsGroup=dfsGroup, channelBandwidth=channelBandwidth, tDDSynchronizationAlarm=tDDSynchronizationAlarm, snmpControlGroup=snmpControlGroup, aggregateDataRate=aggregateDataRate, telecomsLoopback=telecomsLoopback, configuration=configuration, antennaGain=antennaGain, telecom=telecom, tDDControl=tDDControl, installArmState=installArmState, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPLastSync=sNTPLastSync)
