...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", userTable=userTable, linkLoss=linkLoss, syslogLocalWrappedTrap=syslogLocalWrappedTrap, antennaGain=antennaGain, subnetMask=subnetMask, tFTPServerPortNumber=tFTPServerPortNumber, snmpControl=snmpControl, telecomsChannelStatus=telecomsChannelStatus, receivePower=receivePower, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telecomGroup=telecomGroup, bandwidthVariant=bandwidthVariant, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, pubStats=pubStats, dataPortConfigurationMismatch=dataPortConfigurationMismatch, hTTPAccessEnabled=hTTPAccessEnabled, sNMPTrapTable=sNMPTrapTable, useVLANForManagementInterfaces=useVLANForManagementInterfaces, telecomsLoopback=telecomsLoopback, channelBandwidth=channelBandwidth, incompatibleMasterAndSlave=incompatibleMasterAndSlave, iPAddress=iPAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, userEnabled=userEnabled, encryptionGroup=encryptionGroup, masterSlaveMode=masterSlaveMode, hTTPPortNumber=hTTPPortNumber, sNTPServerPortNumber=sNTPServerPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, telecom=telecom, transmitDataRate=transmitDataRate, constantPowerSpectralDensity=constantPowerSpectralDensity, userTableEntry=userTableEntry, sMTPSourceEmailAddress=sMTPSourceEmailAddress, byteErrorRatio=byteErrorRatio, vLANPriorityTableNumber=vLANPriorityTableNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPCommunityString=sNMPCommunityString, sNMPv3Enable=sNMPv3Enable, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsPeaks=dfsPeaks, productName=productName, ptp=ptp, range=range, sNMPTrapTableIndex=sNMPTrapTableIndex, phyControl=phyControl, hTTPSAccessEnabled=hTTPSAccessEnabled, targetMACAddress=targetMACAddress, receiveFreqMHz=receiveFreqMHz, unitOutOfCalibration=unitOutOfCalibration, ethernetGroup=ethernetGroup, dfsTableNumber=dfsTableNumber, PYSNMP_MODULE_ID=cambium, tDDControl=tDDControl, wirelessLinkAvailability=wirelessLinkAvailability, telecomsInterface=telecomsInterface, management=management, dataPortDisabledWarning=dataPortDisabledWarning, sMTPServerPortNumber=sMTPServerPortNumber, telnetAccessEnabled=telnetAccessEnabled, versions=versions, sNMPTrapPortNumber=sNMPTrapPortNumber, latitude=latitude, softwareVersion=softwareVersion, ptpTraps=ptpTraps, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNTPSyncTrap=sNTPSyncTrap, syslogStateTrap=syslogStateTrap, altitude=altitude, phyControlGroup=phyControlGroup, accessMethod=accessMethod, syslogControl=syslogControl, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dfsTable=dfsTable, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sNTPPollInterval=sNTPPollInterval, ethernetFiberSupport=ethernetFiberSupport, sNMPTrapIPAddress=sNMPTrapIPAddress, configuration=configuration, searchState=searchState, sNMPPortNumber=sNMPPortNumber, syslogState=syslogState, installArmStateTrap=installArmStateTrap, ptpGroups=ptpGroups, userRole=userRole, daylightSaving=daylightSaving, siteName=siteName, vectorError=vectorError, eIRP=eIRP, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sntp=sntp, versionsGroup=versionsGroup, pubStatsGroup=pubStatsGroup, systemClock=systemClock, userTableNumber=userTableNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, supplementary=supplementary, ptpTrapPrefix=ptpTrapPrefix, notificationsGroup=notificationsGroup, transmitModulationMode=transmitModulationMode, licence=licence, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPSync=sNTPSync, installArmState=installArmState, vLANManagementPriority=vLANManagementPriority, aAAControl=aAAControl, ptp500=ptp500, dfs=dfs, installStatus=installStatus, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, regionCode=regionCode, transmitFreqKHz=transmitFreqKHz, sMTPServerIPAddress=sMTPServerIPAddress, sNTPState=sNTPState, vLANPriorityTable=vLANPriorityTable, frequencyVariant=frequencyVariant, timeZone=timeZone, bootVersion=bootVersion, encryptionAlgorithm=encryptionAlgorithm, userTableIndex=userTableIndex, incompatibleRegionCodes=incompatibleRegionCodes, remoteIPAddress=remoteIPAddress, installStatusTrap=installStatusTrap, tDDSynchronizationMode=tDDSynchronizationMode, vLANManagementVID=vLANManagementVID, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPServerIPAddress=sNTPServerIPAddress, dfsTableEntry=dfsTableEntry, telecomsCableLength=telecomsCableLength, sNMPTrapVersion=sNMPTrapVersion, dfsTableIndex=dfsTableIndex, smtpGroup=smtpGroup, telecomsChannelStatusTrap=telecomsChannelStatusTrap, secondarySoftwareVersion=secondarySoftwareVersion, phyStatus=phyStatus, licensedCapacity=licensedCapacity, tFTPServerIPAddress=tFTPServerIPAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, alarmsGroup=alarmsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, vLANPriorityTableIndex=vLANPriorityTableIndex, linkName=linkName, telecomsLoopbackTrap=telecomsLoopbackTrap, telecomsLineCode=telecomsLineCode, signalStrengthRatio=signalStrengthRatio, receiveModulationMode=receiveModulationMode, userPassword=userPassword, gatewayIPAddress=gatewayIPAddress, syslogClientTrap=syslogClientTrap, transmitFreqMHz=transmitFreqMHz, maximumTransmitPower=maximumTransmitPower, sNMPTrapTableNumber=sNMPTrapTableNumber, aggregateDataRate=aggregateDataRate, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, productVariant=productVariant, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, wirelessLinkStatus=wirelessLinkStatus, receiveDataRate=receiveDataRate, groupID=groupID, syslogControlGroup=syslogControlGroup, sntpGroup=sntpGroup, linkModeOptimisation=linkModeOptimisation, ptmp=ptmp, longitude=longitude, ptpCompliance=ptpCompliance, regionCodeTrap=regionCodeTrap, receiveChannel=receiveChannel, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, telnetPortNumber=telnetPortNumber, hardwareVersion=hardwareVersion, dfsMeans=dfsMeans, smtp=smtp, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortStatus=dataPortStatus, receiveFreqKHz=receiveFreqKHz, cambium=cambium, managementGroup=managementGroup, aAAControlGroup=aAAControlGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, cableLoss=cableLoss, hTTPSPortNumber=hTTPSPortNumber, sNTPLastSync=sNTPLastSync, syslogClient=syslogClient, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, phyStatusGroup=phyStatusGroup, licenceGroup=licenceGroup, userName=userName, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, configurationGroup=configurationGroup, transmitPower=transmitPower, dataPortStatusTrap=dataPortStatusTrap, ethernet=ethernet, snmpControlGroup=snmpControlGroup, resetGroup=resetGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPEnabledTraps=sNMPEnabledTraps, receiveModulationModeDetail=receiveModulationModeDetail, channelChangeTrap=channelChangeTrap, dataPortAutoMdix=dataPortAutoMdix, tDDControlGroup=tDDControlGroup, supplementaryGroup=supplementaryGroup, systemReset=systemReset, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, linkModeOptimizationMismatch=linkModeOptimizationMismatch, reset=reset, capacityLicenseMismatch=capacityLicenseMismatch, transmitChannel=transmitChannel, sMTPEmailAlert=sMTPEmailAlert, linkSymmetry=linkSymmetry, alarms=alarms, sMTPEnabledMessages=sMTPEnabledMessages, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dfsGroup=dfsGroup, encryption=encryption, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex)
