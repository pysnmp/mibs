...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", telecomsLoopback=telecomsLoopback, maximumTransmitPower=maximumTransmitPower, sNMPPortNumber=sNMPPortNumber, wirelessLinkStatus=wirelessLinkStatus, systemClock=systemClock, linkSymmetry=linkSymmetry, snmpControlGroup=snmpControlGroup, supplementaryGroup=supplementaryGroup, transmitFreqMHz=transmitFreqMHz, versionsGroup=versionsGroup, sNMPv3Enable=sNMPv3Enable, transmitChannel=transmitChannel, managementGroup=managementGroup, sMTPServerPortNumber=sMTPServerPortNumber, aggregateDataRate=aggregateDataRate, notificationsGroup=notificationsGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, transmitModulationMode=transmitModulationMode, systemReset=systemReset, encryptionAlgorithm=encryptionAlgorithm, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sMTPEnabledMessages=sMTPEnabledMessages, tDDSynchronizationStatus=tDDSynchronizationStatus, phyControl=phyControl, dfs=dfs, dataPortWirelessDownAlert=dataPortWirelessDownAlert, encryptionGroup=encryptionGroup, sNTPServerPortNumber=sNTPServerPortNumber, bootVersion=bootVersion, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapVersion=sNMPTrapVersion, masterSlaveMode=masterSlaveMode, vLANPriorityTableIndex=vLANPriorityTableIndex, subnetMask=subnetMask, sntpGroup=sntpGroup, dataPortDisabledWarning=dataPortDisabledWarning, sNTPPollInterval=sNTPPollInterval, timeZone=timeZone, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, receiveFreqMHz=receiveFreqMHz, ptp=ptp, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, alarmsGroup=alarmsGroup, dfsTable=dfsTable, alarms=alarms, transmitFreqKHz=transmitFreqKHz, telecomsLoopbackTrap=telecomsLoopbackTrap, userName=userName, unitOutOfCalibration=unitOutOfCalibration, vLANManagementPriority=vLANManagementPriority, sNMPTrapTableNumber=sNMPTrapTableNumber, telecomsCableLength=telecomsCableLength, sNMPEnabledTraps=sNMPEnabledTraps, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, productVariant=productVariant, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, linkModeOptimizationMismatch=linkModeOptimizationMismatch, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ptmp=ptmp, licence=licence, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, vLANPriorityTableEntry=vLANPriorityTableEntry, frequencyVariant=frequencyVariant, bandwidthVariant=bandwidthVariant, receiveDataRate=receiveDataRate, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, phyControlGroup=phyControlGroup, searchState=searchState, vLANPriorityTableNumber=vLANPriorityTableNumber, accessMethod=accessMethod, eIRP=eIRP, vectorError=vectorError, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ethernetGroup=ethernetGroup, dataPortStatus=dataPortStatus, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, linkLoss=linkLoss, latitude=latitude, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, configuration=configuration, ethernet=ethernet, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, hTTPPortNumber=hTTPPortNumber, incompatibleRegionCodes=incompatibleRegionCodes, sNTPServerIPAddress=sNTPServerIPAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, ethernetFiberSupport=ethernetFiberSupport, installStatus=installStatus, tFTPServerIPAddress=tFTPServerIPAddress, channelChangeTrap=channelChangeTrap, sNTPLastSync=sNTPLastSync, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPSyncTrap=sNTPSyncTrap, telecomGroup=telecomGroup, reset=reset, resetGroup=resetGroup, siteName=siteName, dfsGroup=dfsGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, configurationGroup=configurationGroup, phyStatus=phyStatus, syslogClient=syslogClient, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, receivePower=receivePower, tFTPServerPortNumber=tFTPServerPortNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, userPassword=userPassword, productName=productName, dfsTableNumber=dfsTableNumber, targetMACAddress=targetMACAddress, syslogStateTrap=syslogStateTrap, receiveChannel=receiveChannel, hTTPSAccessEnabled=hTTPSAccessEnabled, wirelessLinkAvailability=wirelessLinkAvailability, userRole=userRole, vLANPriorityTable=vLANPriorityTable, smtp=smtp, regionCode=regionCode, sNMPTrapIPAddress=sNMPTrapIPAddress, installStatusTrap=installStatusTrap, userTable=userTable, receiveModulationMode=receiveModulationMode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, transmitDataRate=transmitDataRate, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ptpGroups=ptpGroups, sNTPState=sNTPState, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, cableLoss=cableLoss, aAAControlGroup=aAAControlGroup, vLANManagementVID=vLANManagementVID, linkModeOptimisation=linkModeOptimisation, installArmState=installArmState, capacityLicenseMismatch=capacityLicenseMismatch, telecomsChannelStatusTrap=telecomsChannelStatusTrap, userTableEntry=userTableEntry, regionCodeTrap=regionCodeTrap, licensedCapacity=licensedCapacity, dfsTableIndex=dfsTableIndex, groupID=groupID, dataPortStatusTrap=dataPortStatusTrap, pubStatsGroup=pubStatsGroup, licenceGroup=licenceGroup, iPAddress=iPAddress, telnetAccessEnabled=telnetAccessEnabled, gatewayIPAddress=gatewayIPAddress, ptpTraps=ptpTraps, versions=versions, userTableNumber=userTableNumber, longitude=longitude, ptpCompliance=ptpCompliance, dfsPeaks=dfsPeaks, syslogControlGroup=syslogControlGroup, channelBandwidth=channelBandwidth, daylightSaving=daylightSaving, telecomsChannelStatus=telecomsChannelStatus, transmitPower=transmitPower, sMTPSourceEmailAddress=sMTPSourceEmailAddress, remoteIPAddress=remoteIPAddress, tDDSynchronizationAlarm=tDDSynchronizationAlarm, smtpGroup=smtpGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, range=range, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, receiveModulationModeDetail=receiveModulationModeDetail, sntp=sntp, antennaGain=antennaGain, management=management, signalStrengthRatio=signalStrengthRatio, softwareVersion=softwareVersion, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, userTableIndex=userTableIndex, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ptp500=ptp500, ptpTrapPrefix=ptpTrapPrefix, snmpControl=snmpControl, aAAControl=aAAControl, cambium=cambium, noWirelessChannelAvailable=noWirelessChannelAvailable, linkName=linkName, PYSNMP_MODULE_ID=cambium, receiveFreqKHz=receiveFreqKHz, sNMPTrapTable=sNMPTrapTable, sNMPCommunityString=sNMPCommunityString, phyStatusGroup=phyStatusGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, telecomsLineCode=telecomsLineCode, sMTPEmailAlert=sMTPEmailAlert, encryption=encryption, dataPortAutoMdix=dataPortAutoMdix, installArmStateTrap=installArmStateTrap, syslogClientTrap=syslogClientTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sMTPServerIPAddress=sMTPServerIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dfsTableEntry=dfsTableEntry, pubStats=pubStats, syslogState=syslogState, syslogControl=syslogControl, telnetPortNumber=telnetPortNumber, sNTPSync=sNTPSync, telecom=telecom, hTTPAccessEnabled=hTTPAccessEnabled, byteErrorRatio=byteErrorRatio, userEnabled=userEnabled, supplementary=supplementary, altitude=altitude, telecomsInterface=telecomsInterface, hTTPSPortNumber=hTTPSPortNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, secondarySoftwareVersion=secondarySoftwareVersion, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tDDSynchronizationMode=tDDSynchronizationMode, tDDControl=tDDControl, tDDControlGroup=tDDControlGroup, hardwareVersion=hardwareVersion, dfsMeans=dfsMeans)
