...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sNTPServerPortNumber=sNTPServerPortNumber, cambium=cambium, userTable=userTable, telnetPortNumber=telnetPortNumber, ptpTrapPrefix=ptpTrapPrefix, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sMTPEmailAlert=sMTPEmailAlert, vLANPriorityTableNumber=vLANPriorityTableNumber, pubStatsGroup=pubStatsGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPTrapTableIndex=sNMPTrapTableIndex, phyStatusGroup=phyStatusGroup, vLANManagementVID=vLANManagementVID, receiveFreqKHz=receiveFreqKHz, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, daylightSaving=daylightSaving, dataPortDisabledWarning=dataPortDisabledWarning, linkName=linkName, bandwidthVariant=bandwidthVariant, regionCodeTrap=regionCodeTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, hardwareVersion=hardwareVersion, vLANPriorityQueueMapping=vLANPriorityQueueMapping, ptmp=ptmp, transmitDataRate=transmitDataRate, smtpGroup=smtpGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sMTPEnabledMessages=sMTPEnabledMessages, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPPortNumber=sNMPPortNumber, telecomsLoopbackTrap=telecomsLoopbackTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, telnetAccessEnabled=telnetAccessEnabled, ptpGroups=ptpGroups, tDDControlGroup=tDDControlGroup, transmitFreqMHz=transmitFreqMHz, installArmStateTrap=installArmStateTrap, notificationsGroup=notificationsGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ptp=ptp, dfs=dfs, supplementaryGroup=supplementaryGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, pubStats=pubStats, userTableIndex=userTableIndex, userTableNumber=userTableNumber, receiveFreqMHz=receiveFreqMHz, sNTPLastSync=sNTPLastSync, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, encryptionGroup=encryptionGroup, hTTPPortNumber=hTTPPortNumber, syslogStateTrap=syslogStateTrap, telecomsCableLength=telecomsCableLength, vectorError=vectorError, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, transmitFreqKHz=transmitFreqKHz, receiveModulationMode=receiveModulationMode, dataPortAutoMdix=dataPortAutoMdix, transmitChannel=transmitChannel, maximumTransmitPower=maximumTransmitPower, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, receiveModulationModeDetail=receiveModulationModeDetail, syslogControl=syslogControl, targetMACAddress=targetMACAddress, ptpCompliance=ptpCompliance, sNTPServerIPAddress=sNTPServerIPAddress, snmpControl=snmpControl, enabledDiagnosticAlarms=enabledDiagnosticAlarms, cableLoss=cableLoss, bootVersion=bootVersion, phyControl=phyControl, useVLANForManagementInterfaces=useVLANForManagementInterfaces, antennaGain=antennaGain, tDDSynchronizationAlarm=tDDSynchronizationAlarm, alarms=alarms, syslogClient=syslogClient, latitude=latitude, frequencyVariant=frequencyVariant, telecom=telecom, constantPowerSpectralDensity=constantPowerSpectralDensity, dataPortStatusTrap=dataPortStatusTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNTPPollInterval=sNTPPollInterval, telecomsLineCode=telecomsLineCode, PYSNMP_MODULE_ID=cambium, unitOutOfCalibration=unitOutOfCalibration, transmitModulationMode=transmitModulationMode, aAAControlGroup=aAAControlGroup, range=range, userTableEntry=userTableEntry, receiveDataRate=receiveDataRate, sNTPSync=sNTPSync, altitude=altitude, dfsTableIndex=dfsTableIndex, hTTPSPortNumber=hTTPSPortNumber, licence=licence, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, iPAddress=iPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, linkModeOptimizationMismatch=linkModeOptimizationMismatch, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, installArmState=installArmState, sNMPTrapTable=sNMPTrapTable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, telecomsChannelStatus=telecomsChannelStatus, userRole=userRole, versionsGroup=versionsGroup, management=management, incompatibleRegionCodes=incompatibleRegionCodes, wirelessLinkStatus=wirelessLinkStatus, telecomsLoopback=telecomsLoopback, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, phyStatus=phyStatus, sMTPServerPortNumber=sMTPServerPortNumber, userEnabled=userEnabled, masterSlaveMode=masterSlaveMode, linkModeOptimisation=linkModeOptimisation, dfsGroup=dfsGroup, linkLoss=linkLoss, sNMPv3Enable=sNMPv3Enable, systemReset=systemReset, dfsPeaks=dfsPeaks, regionCode=regionCode, vLANPriorityTable=vLANPriorityTable, noWirelessChannelAvailable=noWirelessChannelAvailable, softwareVersion=softwareVersion, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortStatus=dataPortStatus, eIRP=eIRP, installStatus=installStatus, secondarySoftwareVersion=secondarySoftwareVersion, channelChangeTrap=channelChangeTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sntp=sntp, syslogClientTrap=syslogClientTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, syslogLocalWrappedTrap=syslogLocalWrappedTrap, alarmsGroup=alarmsGroup, dfsTable=dfsTable, licensedCapacity=licensedCapacity, channelBandwidth=channelBandwidth, timeZone=timeZone, longitude=longitude, ethernetGroup=ethernetGroup, receivePower=receivePower, syslogControlGroup=syslogControlGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sMTPServerIPAddress=sMTPServerIPAddress, gatewayIPAddress=gatewayIPAddress, productVariant=productVariant, sNMPTrapVersion=sNMPTrapVersion, vLANManagementPriority=vLANManagementPriority, aggregateDataRate=aggregateDataRate, searchState=searchState, phyControlGroup=phyControlGroup, dfsMeans=dfsMeans, telecomsChannelStatusTrap=telecomsChannelStatusTrap, managementGroup=managementGroup, transmitPower=transmitPower, tDDSynchronizationMode=tDDSynchronizationMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dfsTableEntry=dfsTableEntry, hTTPSAccessEnabled=hTTPSAccessEnabled, wirelessLinkAvailability=wirelessLinkAvailability, smtp=smtp, byteErrorRatio=byteErrorRatio, userName=userName, telecomsInterface=telecomsInterface, telecomGroup=telecomGroup, configuration=configuration, sNMPTrapTableEntry=sNMPTrapTableEntry, resetGroup=resetGroup, sNTPSyncTrap=sNTPSyncTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, encryption=encryption, licenceGroup=licenceGroup, encryptionAlgorithm=encryptionAlgorithm, supplementary=supplementary, sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPServerPortNumber=tFTPServerPortNumber, ethernetFiberSupport=ethernetFiberSupport, groupID=groupID, dataPortAutoNegotiation=dataPortAutoNegotiation, installStatusTrap=installStatusTrap, dfsTableNumber=dfsTableNumber, aAAControl=aAAControl, sNMPEnabledTraps=sNMPEnabledTraps, remoteMaximumTransmitPower=remoteMaximumTransmitPower, hTTPAccessEnabled=hTTPAccessEnabled, syslogState=syslogState, remoteIPAddress=remoteIPAddress, vLANPriorityTableEntry=vLANPriorityTableEntry, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, receiveChannel=receiveChannel, systemClock=systemClock, productName=productName, sntpGroup=sntpGroup, ethernet=ethernet, linkSymmetry=linkSymmetry, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, capacityLicenseMismatch=capacityLicenseMismatch, siteName=siteName, signalStrengthRatio=signalStrengthRatio, sNTPState=sNTPState, configurationGroup=configurationGroup, tFTPServerIPAddress=tFTPServerIPAddress, ptp500=ptp500, sNMPTrapPortNumber=sNMPTrapPortNumber, tDDControl=tDDControl, accessMethod=accessMethod, subnetMask=subnetMask, reset=reset, snmpControlGroup=snmpControlGroup, ptpTraps=ptpTraps, userPassword=userPassword, versions=versions, sNMPCommunityString=sNMPCommunityString)
