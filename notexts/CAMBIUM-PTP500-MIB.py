...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", vLANPriorityTableNumber=vLANPriorityTableNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, linkName=linkName, hTTPSAccessEnabled=hTTPSAccessEnabled, maximumTransmitPower=maximumTransmitPower, sNTPPollInterval=sNTPPollInterval, dataPortConfigurationMismatch=dataPortConfigurationMismatch, linkLoss=linkLoss, userTable=userTable, tDDSynchronizationStatus=tDDSynchronizationStatus, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPEnabledTraps=sNMPEnabledTraps, aggregateDataRate=aggregateDataRate, sNMPTrapTableNumber=sNMPTrapTableNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, syslogClient=syslogClient, sntpGroup=sntpGroup, telecomsCableLength=telecomsCableLength, transmitDataRate=transmitDataRate, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPEmailAlert=sMTPEmailAlert, receiveFreqMHz=receiveFreqMHz, sNTPState=sNTPState, sNTPServerIPAddress=sNTPServerIPAddress, syslogControl=syslogControl, vLANPriorityQueueMapping=vLANPriorityQueueMapping, installStatus=installStatus, vLANPriorityTableIndex=vLANPriorityTableIndex, capacityLicenseMismatch=capacityLicenseMismatch, incompatibleMasterAndSlave=incompatibleMasterAndSlave, supplementaryGroup=supplementaryGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, userEnabled=userEnabled, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, vectorError=vectorError, telnetAccessEnabled=telnetAccessEnabled, supplementary=supplementary, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, siteName=siteName, userTableNumber=userTableNumber, cambium=cambium, snmpControl=snmpControl, dfsTableIndex=dfsTableIndex, remoteIPAddress=remoteIPAddress, transmitChannel=transmitChannel, sNTPServerPortNumber=sNTPServerPortNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, receiveChannel=receiveChannel, enabledDiagnosticAlarms=enabledDiagnosticAlarms, secondarySoftwareVersion=secondarySoftwareVersion, resetGroup=resetGroup, phyControlGroup=phyControlGroup, dfsTable=dfsTable, latitude=latitude, channelBandwidth=channelBandwidth, sNTPSync=sNTPSync, linkSymmetry=linkSymmetry, tDDControlGroup=tDDControlGroup, dataPortStatusTrap=dataPortStatusTrap, productVariant=productVariant, telecomsInterface=telecomsInterface, incompatibleRegionCodes=incompatibleRegionCodes, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPv3Enable=sNMPv3Enable, sntp=sntp, unitOutOfCalibration=unitOutOfCalibration, aAAControl=aAAControl, vLANManagementPriority=vLANManagementPriority, receiveDataRate=receiveDataRate, licenceGroup=licenceGroup, longitude=longitude, telnetPortNumber=telnetPortNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, systemReset=systemReset, sNMPCommunityString=sNMPCommunityString, hTTPPortNumber=hTTPPortNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, phyStatus=phyStatus, ethernetGroup=ethernetGroup, tFTPServerIPAddress=tFTPServerIPAddress, PYSNMP_MODULE_ID=cambium, wirelessLinkAvailability=wirelessLinkAvailability, tDDSynchronizationMode=tDDSynchronizationMode, smtpGroup=smtpGroup, sNMPTrapVersion=sNMPTrapVersion, noWirelessChannelAvailable=noWirelessChannelAvailable, installArmState=installArmState, sNMPTrapPortNumber=sNMPTrapPortNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, regionCode=regionCode, configurationGroup=configurationGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, productName=productName, searchState=searchState, eIRP=eIRP, vLANManagementVID=vLANManagementVID, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapIPAddress=sNMPTrapIPAddress, gatewayIPAddress=gatewayIPAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, targetMACAddress=targetMACAddress, installStatusTrap=installStatusTrap, syslogClientTrap=syslogClientTrap, ptmp=ptmp, ptpTraps=ptpTraps, telecomsLineCode=telecomsLineCode, telecomsLoopbackTrap=telecomsLoopbackTrap, configuration=configuration, dfsPeaks=dfsPeaks, licensedCapacity=licensedCapacity, pubStats=pubStats, ptp500=ptp500, hTTPAccessEnabled=hTTPAccessEnabled, receiveModulationModeDetail=receiveModulationModeDetail, transmitPower=transmitPower, versionsGroup=versionsGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ptpGroups=ptpGroups, ethernet=ethernet, bandwidthVariant=bandwidthVariant, telecomsLoopback=telecomsLoopback, systemClock=systemClock, softwareVersion=softwareVersion, bootVersion=bootVersion, subnetMask=subnetMask, telecomsChannelStatusTrap=telecomsChannelStatusTrap, groupID=groupID, range=range, daylightSaving=daylightSaving, versions=versions, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, signalStrengthRatio=signalStrengthRatio, reset=reset, userPassword=userPassword, encryptionGroup=encryptionGroup, encryption=encryption, hTTPSPortNumber=hTTPSPortNumber, sNTPSyncTrap=sNTPSyncTrap, sMTPServerIPAddress=sMTPServerIPAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, pubStatsGroup=pubStatsGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, iPAddress=iPAddress, receiveModulationMode=receiveModulationMode, alarmsGroup=alarmsGroup, sNTPLastSync=sNTPLastSync, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, antennaGain=antennaGain, dfsTableNumber=dfsTableNumber, frequencyVariant=frequencyVariant, ptpTrapPrefix=ptpTrapPrefix, regionCodeTrap=regionCodeTrap, vLANPriorityTable=vLANPriorityTable, telecomsChannelStatus=telecomsChannelStatus, installArmStateTrap=installArmStateTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, wirelessLinkStatus=wirelessLinkStatus, hardwareVersion=hardwareVersion, tFTPServerPortNumber=tFTPServerPortNumber, dataPortStatus=dataPortStatus, sMTPEnabledMessages=sMTPEnabledMessages, ptpCompliance=ptpCompliance, sNMPTrapTable=sNMPTrapTable, alarms=alarms, dataPortAutoMdix=dataPortAutoMdix, sNMPTrapTableIndex=sNMPTrapTableIndex, phyStatusGroup=phyStatusGroup, smtp=smtp, userTableEntry=userTableEntry, dfsTableEntry=dfsTableEntry, licence=licence, userName=userName, transmitFreqKHz=transmitFreqKHz, ethernetFiberSupport=ethernetFiberSupport, remoteMaximumTransmitPower=remoteMaximumTransmitPower, telecomGroup=telecomGroup, ptp=ptp, management=management, transmitModulationMode=transmitModulationMode, sNMPPortNumber=sNMPPortNumber, byteErrorRatio=byteErrorRatio, cableLoss=cableLoss, userRole=userRole, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tDDControl=tDDControl, dfs=dfs, sMTPServerPortNumber=sMTPServerPortNumber, dataPortDisabledWarning=dataPortDisabledWarning, syslogControlGroup=syslogControlGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, accessMethod=accessMethod, snmpControlGroup=snmpControlGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, encryptionAlgorithm=encryptionAlgorithm, telecom=telecom, dfsGroup=dfsGroup, receivePower=receivePower, phyControl=phyControl, timeZone=timeZone, notificationsGroup=notificationsGroup, transmitFreqMHz=transmitFreqMHz, altitude=altitude, masterSlaveMode=masterSlaveMode, linkModeOptimisation=linkModeOptimisation, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, receiveFreqKHz=receiveFreqKHz, sNMPTrapTableEntry=sNMPTrapTableEntry, aAAControlGroup=aAAControlGroup, userTableIndex=userTableIndex, syslogStateTrap=syslogStateTrap, dfsMeans=dfsMeans, managementGroup=managementGroup, syslogState=syslogState, channelChangeTrap=channelChangeTrap)
