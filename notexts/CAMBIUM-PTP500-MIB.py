...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", useVLANForManagementInterfaces=useVLANForManagementInterfaces, alarms=alarms, remoteIPAddress=remoteIPAddress, tDDControlGroup=tDDControlGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, incompatibleRegionCodes=incompatibleRegionCodes, siteName=siteName, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapPortNumber=sNMPTrapPortNumber, dfsTable=dfsTable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, syslogClientTrap=syslogClientTrap, searchState=searchState, sNTPSync=sNTPSync, ptp=ptp, linkName=linkName, receiveChannel=receiveChannel, receiveDataRate=receiveDataRate, userName=userName, versions=versions, snmpControlGroup=snmpControlGroup, transmitModulationMode=transmitModulationMode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tFTPServerIPAddress=tFTPServerIPAddress, userTable=userTable, notificationsGroup=notificationsGroup, versionsGroup=versionsGroup, bandwidthVariant=bandwidthVariant, hTTPPortNumber=hTTPPortNumber, subnetMask=subnetMask, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sntp=sntp, installArmState=installArmState, dfsGroup=dfsGroup, pubStatsGroup=pubStatsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, phyControl=phyControl, sNMPTrapTableNumber=sNMPTrapTableNumber, syslogControl=syslogControl, hTTPSAccessEnabled=hTTPSAccessEnabled, receiveFreqKHz=receiveFreqKHz, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, receiveFreqMHz=receiveFreqMHz, receiveModulationMode=receiveModulationMode, aggregateDataRate=aggregateDataRate, aAAControlGroup=aAAControlGroup, regionCodeTrap=regionCodeTrap, antennaGain=antennaGain, daylightSaving=daylightSaving, licensedCapacity=licensedCapacity, phyStatusGroup=phyStatusGroup, targetMACAddress=targetMACAddress, syslogClient=syslogClient, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPTrapTable=sNMPTrapTable, range=range, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, installArmStateTrap=installArmStateTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, systemClock=systemClock, management=management, dfsMeans=dfsMeans, syslogControlGroup=syslogControlGroup, dataPortStatus=dataPortStatus, transmitChannel=transmitChannel, ethernet=ethernet, aAAControl=aAAControl, productName=productName, dataPortConfigurationMismatch=dataPortConfigurationMismatch, bootVersion=bootVersion, ptpCompliance=ptpCompliance, encryption=encryption, sMTPEmailAlert=sMTPEmailAlert, ptmp=ptmp, telecomsLineCode=telecomsLineCode, sNTPLastSync=sNTPLastSync, hardwareVersion=hardwareVersion, supplementaryGroup=supplementaryGroup, dfsPeaks=dfsPeaks, telecomsChannelStatus=telecomsChannelStatus, userEnabled=userEnabled, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, vLANPriorityTable=vLANPriorityTable, tFTPServerPortNumber=tFTPServerPortNumber, smtp=smtp, longitude=longitude, channelBandwidth=channelBandwidth, telecomsLoopback=telecomsLoopback, eIRP=eIRP, vectorError=vectorError, ptp500=ptp500, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, remoteMaximumTransmitPower=remoteMaximumTransmitPower, installStatus=installStatus, transmitPower=transmitPower, byteErrorRatio=byteErrorRatio, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, userPassword=userPassword, userRole=userRole, transmitFreqMHz=transmitFreqMHz, ethernetGroup=ethernetGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, configurationGroup=configurationGroup, hTTPAccessEnabled=hTTPAccessEnabled, vLANPriorityQueueMapping=vLANPriorityQueueMapping, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ethernetFiberSupport=ethernetFiberSupport, transmitDataRate=transmitDataRate, ptpGroups=ptpGroups, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPCommunityString=sNMPCommunityString, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ptpTraps=ptpTraps, PYSNMP_MODULE_ID=cambium, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tDDSynchronizationMode=tDDSynchronizationMode, cambium=cambium, managementGroup=managementGroup, hTTPSPortNumber=hTTPSPortNumber, frequencyVariant=frequencyVariant, linkSymmetry=linkSymmetry, vLANPriorityTableIndex=vLANPriorityTableIndex, transmitFreqKHz=transmitFreqKHz, sNMPTrapTableIndex=sNMPTrapTableIndex, encryptionGroup=encryptionGroup, altitude=altitude, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapVersion=sNMPTrapVersion, dataPortStatusTrap=dataPortStatusTrap, timeZone=timeZone, tDDSynchronizationAlarm=tDDSynchronizationAlarm, snmpControl=snmpControl, linkLoss=linkLoss, sMTPSourceEmailAddress=sMTPSourceEmailAddress, userTableEntry=userTableEntry, sNTPState=sNTPState, sNTPServerPortNumber=sNTPServerPortNumber, telecomsInterface=telecomsInterface, sMTPServerPortNumber=sMTPServerPortNumber, softwareVersion=softwareVersion, secondarySoftwareVersion=secondarySoftwareVersion, userTableIndex=userTableIndex, latitude=latitude, systemReset=systemReset, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, resetGroup=resetGroup, sNTPServerIPAddress=sNTPServerIPAddress, wirelessLinkStatus=wirelessLinkStatus, capacityLicenseMismatch=capacityLicenseMismatch, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dfs=dfs, dfsTableIndex=dfsTableIndex, dataPortAutoMdix=dataPortAutoMdix, masterSlaveMode=masterSlaveMode, sNTPPollInterval=sNTPPollInterval, dfsTableEntry=dfsTableEntry, syslogStateTrap=syslogStateTrap, encryptionAlgorithm=encryptionAlgorithm, reset=reset, sMTPEnabledMessages=sMTPEnabledMessages, licence=licence, gatewayIPAddress=gatewayIPAddress, vLANPriorityTableEntry=vLANPriorityTableEntry, phyControlGroup=phyControlGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vLANManagementPriority=vLANManagementPriority, sNMPTrapTableEntry=sNMPTrapTableEntry, wirelessLinkAvailability=wirelessLinkAvailability, receivePower=receivePower, licenceGroup=licenceGroup, installStatusTrap=installStatusTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNTPSyncTrap=sNTPSyncTrap, linkModeOptimisation=linkModeOptimisation, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, telnetAccessEnabled=telnetAccessEnabled, sNMPTrapIPAddress=sNMPTrapIPAddress, regionCode=regionCode, sntpGroup=sntpGroup, dataPortDisabledWarning=dataPortDisabledWarning, sMTPServerIPAddress=sMTPServerIPAddress, receiveModulationModeDetail=receiveModulationModeDetail, channelChangeTrap=channelChangeTrap, tDDControl=tDDControl, alarmsGroup=alarmsGroup, dfsTableNumber=dfsTableNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, groupID=groupID, smtpGroup=smtpGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, sNMPPortNumber=sNMPPortNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, telecomsCableLength=telecomsCableLength, supplementary=supplementary, configuration=configuration, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPv3Enable=sNMPv3Enable, telecom=telecom, telnetPortNumber=telnetPortNumber, signalStrengthRatio=signalStrengthRatio, syslogState=syslogState, vLANManagementVID=vLANManagementVID, pubStats=pubStats, phyStatus=phyStatus, unitOutOfCalibration=unitOutOfCalibration, productVariant=productVariant, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, enabledDiagnosticAlarms=enabledDiagnosticAlarms, userTableNumber=userTableNumber, iPAddress=iPAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPEnabledTraps=sNMPEnabledTraps, cableLoss=cableLoss, telecomGroup=telecomGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, maximumTransmitPower=maximumTransmitPower, accessMethod=accessMethod)
