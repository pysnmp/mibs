...
ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, Unsigned32, ModuleIdentity, Bits, Counter64, enterprises, Counter32, MibIdentifier, Integer32, NotificationType, iso, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "Unsigned32", "ModuleIdentity", "Bits", "Counter64", "enterprises", "Counter32", "MibIdentifier", "Integer32", "NotificationType", "iso", "IpAddress")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, phyControlGroup=phyControlGroup, productVariant=productVariant, sntpGroup=sntpGroup, aAAControlGroup=aAAControlGroup, transmitPower=transmitPower, groupID=groupID, ptp=ptp, versions=versions, syslogStateTrap=syslogStateTrap, softwareVersion=softwareVersion, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, telecomsCableLength=telecomsCableLength, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, channelChangeTrap=channelChangeTrap, userEnabled=userEnabled, dfsTableIndex=dfsTableIndex, dfsMeans=dfsMeans, linkSymmetry=linkSymmetry, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNMPTrapVersion=sNMPTrapVersion, vLANPriorityTableEntry=vLANPriorityTableEntry, licensedCapacity=licensedCapacity, hTTPPortNumber=hTTPPortNumber, configurationGroup=configurationGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, telecomsChannelStatusTrap=telecomsChannelStatusTrap, ethernetGroup=ethernetGroup, gatewayIPAddress=gatewayIPAddress, vectorError=vectorError, bandwidthVariant=bandwidthVariant, transmitDataRate=transmitDataRate, regionCodeTrap=regionCodeTrap, ptp500=ptp500, ptpCompliance=ptpCompliance, receiveModulationModeDetail=receiveModulationModeDetail, phyStatus=phyStatus, dataPortStatus=dataPortStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, syslogClientTrap=syslogClientTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, systemClock=systemClock, telnetAccessEnabled=telnetAccessEnabled, antennaGain=antennaGain, dfsTableEntry=dfsTableEntry, wirelessLinkStatus=wirelessLinkStatus, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, altitude=altitude, versionsGroup=versionsGroup, telecomsChannelStatus=telecomsChannelStatus, eIRP=eIRP, wirelessLinkAvailability=wirelessLinkAvailability, receiveChannel=receiveChannel, sNMPPortNumber=sNMPPortNumber, userName=userName, dataPortWirelessDownAlert=dataPortWirelessDownAlert, targetMACAddress=targetMACAddress, PYSNMP_MODULE_ID=cambium, sNTPLastSync=sNTPLastSync, linkModeOptimisation=linkModeOptimisation, alarms=alarms, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tDDControlGroup=tDDControlGroup, managementGroup=managementGroup, telecomsLoopback=telecomsLoopback, pubStats=pubStats, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dfsPeaks=dfsPeaks, sNMPTrapTableEntry=sNMPTrapTableEntry, receiveModulationMode=receiveModulationMode, hardwareVersion=hardwareVersion, snmpControlGroup=snmpControlGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapPortNumber=sNMPTrapPortNumber, phyControl=phyControl, ptmp=ptmp, licenceGroup=licenceGroup, userTableEntry=userTableEntry, alarmsGroup=alarmsGroup, management=management, sNTPPollInterval=sNTPPollInterval, sNTPState=sNTPState, bootVersion=bootVersion, sMTPEnabledMessages=sMTPEnabledMessages, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, supplementary=supplementary, sMTPSourceEmailAddress=sMTPSourceEmailAddress, maximumTransmitPower=maximumTransmitPower, vLANManagementVID=vLANManagementVID, encryptionAlgorithm=encryptionAlgorithm, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, installArmStateTrap=installArmStateTrap, smtpGroup=smtpGroup, dataPortDisabledWarning=dataPortDisabledWarning, encryption=encryption, pubStatsGroup=pubStatsGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, searchState=searchState, timeZone=timeZone, tDDSynchronizationMode=tDDSynchronizationMode, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telecomGroup=telecomGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, hTTPSAccessEnabled=hTTPSAccessEnabled, ptpTrapPrefix=ptpTrapPrefix, aggregateDataRate=aggregateDataRate, sNMPv3Enable=sNMPv3Enable, hTTPSPortNumber=hTTPSPortNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, syslogLocalWrappedTrap=syslogLocalWrappedTrap, syslogControlGroup=syslogControlGroup, receivePower=receivePower, sNMPTrapIPAddress=sNMPTrapIPAddress, remoteIPAddress=remoteIPAddress, vLANManagementPriority=vLANManagementPriority, transmitChannel=transmitChannel, dfsTable=dfsTable, sNTPServerPortNumber=sNTPServerPortNumber, vLANPriorityTableNumber=vLANPriorityTableNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, supplementaryGroup=supplementaryGroup, sMTPEmailAlert=sMTPEmailAlert, iPAddress=iPAddress, transmitModulationMode=transmitModulationMode, channelBandwidth=channelBandwidth, useVLANForManagementInterfaces=useVLANForManagementInterfaces, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tFTPServerIPAddress=tFTPServerIPAddress, secondarySoftwareVersion=secondarySoftwareVersion, ethernetFiberSupport=ethernetFiberSupport, snmpControl=snmpControl, productName=productName, sNMPTrapTableIndex=sNMPTrapTableIndex, cambium=cambium, userPassword=userPassword, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPTrapTable=sNMPTrapTable, accessMethod=accessMethod, tDDSynchronizationAlarm=tDDSynchronizationAlarm, capacityLicenseMismatch=capacityLicenseMismatch, sMTPServerPortNumber=sMTPServerPortNumber, sNTPSync=sNTPSync, subnetMask=subnetMask, longitude=longitude, sNTPSyncTrap=sNTPSyncTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, configuration=configuration, regionCode=regionCode, transmitFreqMHz=transmitFreqMHz, aAAControl=aAAControl, cableLoss=cableLoss, vLANPriorityTable=vLANPriorityTable, installStatusTrap=installStatusTrap, phyStatusGroup=phyStatusGroup, receiveDataRate=receiveDataRate, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, transmitFreqKHz=transmitFreqKHz, byteErrorRatio=byteErrorRatio, telecom=telecom, telecomsInterface=telecomsInterface, sNTPServerIPAddress=sNTPServerIPAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, userTableIndex=userTableIndex, notificationsGroup=notificationsGroup, userTable=userTable, reset=reset, constantPowerSpectralDensity=constantPowerSpectralDensity, frequencyVariant=frequencyVariant, sNMPCommunityString=sNMPCommunityString, sMTPServerIPAddress=sMTPServerIPAddress, syslogControl=syslogControl, masterSlaveMode=masterSlaveMode, linkName=linkName, dfsTableNumber=dfsTableNumber, dataPortStatusTrap=dataPortStatusTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, syslogClient=syslogClient, range=range, latitude=latitude, resetGroup=resetGroup, incompatibleRegionCodes=incompatibleRegionCodes, licence=licence, noWirelessChannelAvailable=noWirelessChannelAvailable, syslogState=syslogState, linkLoss=linkLoss, encryptionGroup=encryptionGroup, userTableNumber=userTableNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, vLANPriorityTableIndex=vLANPriorityTableIndex, dataPortAutoMdix=dataPortAutoMdix, installStatus=installStatus, installArmState=installArmState, siteName=siteName, dfs=dfs, sntp=sntp, tFTPServerPortNumber=tFTPServerPortNumber, receiveFreqMHz=receiveFreqMHz, unitOutOfCalibration=unitOutOfCalibration, dataPortConfigurationMismatch=dataPortConfigurationMismatch, systemReset=systemReset, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNMPEnabledTraps=sNMPEnabledTraps, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, receiveFreqKHz=receiveFreqKHz, telecomsLineCode=telecomsLineCode, tDDControl=tDDControl, hTTPAccessEnabled=hTTPAccessEnabled, ptpGroups=ptpGroups, dfsGroup=dfsGroup, ptpTraps=ptpTraps, daylightSaving=daylightSaving, userRole=userRole, smtp=smtp, vLANPriorityQueueMapping=vLANPriorityQueueMapping, ethernet=ethernet, signalStrengthRatio=signalStrengthRatio, telnetPortNumber=telnetPortNumber)
