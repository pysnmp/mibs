...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sNTPServerIPAddress=sNTPServerIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, systemClock=systemClock, supplementaryGroup=supplementaryGroup, subnetMask=subnetMask, tFTPServerPortNumber=tFTPServerPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, ethernetGroup=ethernetGroup, notificationsGroup=notificationsGroup, linkModeOptimisation=linkModeOptimisation, ptpCompliance=ptpCompliance, byteErrorRatio=byteErrorRatio, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vLANPriorityTableNumber=vLANPriorityTableNumber, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tDDControl=tDDControl, channelChangeTrap=channelChangeTrap, sntpGroup=sntpGroup, userTableEntry=userTableEntry, cableLoss=cableLoss, syslogLocalWrappedTrap=syslogLocalWrappedTrap, phyStatus=phyStatus, snmpControlGroup=snmpControlGroup, groupID=groupID, transmitPower=transmitPower, longitude=longitude, sNMPTrapTableNumber=sNMPTrapTableNumber, receiveModulationModeDetail=receiveModulationModeDetail, dataPortAutoMdix=dataPortAutoMdix, linkName=linkName, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, installArmState=installArmState, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, vLANPriorityTable=vLANPriorityTable, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPLastSync=sNTPLastSync, managementGroup=managementGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortDisabledWarning=dataPortDisabledWarning, sMTPEmailAlert=sMTPEmailAlert, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, frequencyVariant=frequencyVariant, encryptionAlgorithm=encryptionAlgorithm, linkSymmetry=linkSymmetry, sNTPPollInterval=sNTPPollInterval, sNMPCommunityString=sNMPCommunityString, ptpGroups=ptpGroups, transmitChannel=transmitChannel, syslogClient=syslogClient, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsGroup=dfsGroup, wirelessLinkStatus=wirelessLinkStatus, pubStats=pubStats, eIRP=eIRP, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dfsTable=dfsTable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, receiveFreqKHz=receiveFreqKHz, encryption=encryption, masterSlaveMode=masterSlaveMode, phyStatusGroup=phyStatusGroup, syslogStateTrap=syslogStateTrap, sNTPState=sNTPState, PYSNMP_MODULE_ID=cambium, cambium=cambium, phyControl=phyControl, alarmsGroup=alarmsGroup, incompatibleRegionCodes=incompatibleRegionCodes, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, receiveFreqMHz=receiveFreqMHz, telecomsChannelStatusTrap=telecomsChannelStatusTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, licence=licence, targetMACAddress=targetMACAddress, receiveModulationMode=receiveModulationMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tDDControlGroup=tDDControlGroup, channelBandwidth=channelBandwidth, sNMPTrapTable=sNMPTrapTable, sMTPServerIPAddress=sMTPServerIPAddress, ptmp=ptmp, hTTPAccessEnabled=hTTPAccessEnabled, altitude=altitude, userEnabled=userEnabled, latitude=latitude, sntp=sntp, syslogControl=syslogControl, remoteIPAddress=remoteIPAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, pubStatsGroup=pubStatsGroup, configurationGroup=configurationGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, aggregateDataRate=aggregateDataRate, telnetAccessEnabled=telnetAccessEnabled, transmitFreqMHz=transmitFreqMHz, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, productName=productName, telecomsLoopback=telecomsLoopback, regionCode=regionCode, ptp500=ptp500, ethernetFiberSupport=ethernetFiberSupport, syslogControlGroup=syslogControlGroup, hTTPPortNumber=hTTPPortNumber, vectorError=vectorError, sNTPSync=sNTPSync, vLANManagementVID=vLANManagementVID, versions=versions, sNMPPortNumber=sNMPPortNumber, resetGroup=resetGroup, installStatusTrap=installStatusTrap, tDDSynchronizationMode=tDDSynchronizationMode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfsTableIndex=dfsTableIndex, telecom=telecom, constantPowerSpectralDensity=constantPowerSpectralDensity, smtp=smtp, ptp=ptp, vLANPriorityTableEntry=vLANPriorityTableEntry, maximumTransmitPower=maximumTransmitPower, siteName=siteName, dataPortStatus=dataPortStatus, searchState=searchState, timeZone=timeZone, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, secondarySoftwareVersion=secondarySoftwareVersion, telecomsLoopbackTrap=telecomsLoopbackTrap, userTableIndex=userTableIndex, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, installStatus=installStatus, daylightSaving=daylightSaving, sNMPTrapVersion=sNMPTrapVersion, hTTPSAccessEnabled=hTTPSAccessEnabled, dfsTableNumber=dfsTableNumber, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dfsMeans=dfsMeans, bandwidthVariant=bandwidthVariant, syslogClientTrap=syslogClientTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, userPassword=userPassword, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, hTTPSPortNumber=hTTPSPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, userName=userName, snmpControl=snmpControl, versionsGroup=versionsGroup, range=range, regionCodeTrap=regionCodeTrap, iPAddress=iPAddress, incompatibleMasterAndSlave=incompatibleMasterAndSlave, receiveChannel=receiveChannel, tFTPServerIPAddress=tFTPServerIPAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, transmitFreqKHz=transmitFreqKHz, userTableNumber=userTableNumber, dfs=dfs, telecomsInterface=telecomsInterface, dfsTableEntry=dfsTableEntry, bootVersion=bootVersion, accessMethod=accessMethod, ptpTrapPrefix=ptpTrapPrefix, transmitModulationMode=transmitModulationMode, transmitDataRate=transmitDataRate, tDDSynchronizationStatus=tDDSynchronizationStatus, sMTPServerPortNumber=sMTPServerPortNumber, receiveDataRate=receiveDataRate, gatewayIPAddress=gatewayIPAddress, aAAControlGroup=aAAControlGroup, telecomGroup=telecomGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, capacityLicenseMismatch=capacityLicenseMismatch, sNTPSyncTrap=sNTPSyncTrap, unitOutOfCalibration=unitOutOfCalibration, management=management, dataPortAutoNegotiation=dataPortAutoNegotiation, telecomsCableLength=telecomsCableLength, wirelessLinkAvailability=wirelessLinkAvailability, dfsPeaks=dfsPeaks, tDDSynchronizationAlarm=tDDSynchronizationAlarm, enabledDiagnosticAlarms=enabledDiagnosticAlarms, productVariant=productVariant, ethernet=ethernet, installArmStateTrap=installArmStateTrap, ptpTraps=ptpTraps, phyControlGroup=phyControlGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, encryptionGroup=encryptionGroup, licenceGroup=licenceGroup, antennaGain=antennaGain, sNTPServerPortNumber=sNTPServerPortNumber, supplementary=supplementary, licensedCapacity=licensedCapacity, telecomsChannelStatus=telecomsChannelStatus, vLANManagementPriority=vLANManagementPriority, aAAControl=aAAControl, smtpGroup=smtpGroup, receivePower=receivePower, systemReset=systemReset, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, sNMPv3Enable=sNMPv3Enable, telnetPortNumber=telnetPortNumber, softwareVersion=softwareVersion, signalStrengthRatio=signalStrengthRatio, hardwareVersion=hardwareVersion, syslogState=syslogState, userTable=userTable, telecomsLineCode=telecomsLineCode, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, vLANPriorityQueueMapping=vLANPriorityQueueMapping, userRole=userRole, configuration=configuration, dataPortStatusTrap=dataPortStatusTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, reset=reset, linkLoss=linkLoss, alarms=alarms, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText)
