...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", ptpGroups=ptpGroups, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, installStatus=installStatus, dfsTableNumber=dfsTableNumber, encryptionGroup=encryptionGroup, capacityLicenseMismatch=capacityLicenseMismatch, PYSNMP_MODULE_ID=cambium, reset=reset, userName=userName, useVLANForManagementInterfaces=useVLANForManagementInterfaces, managementGroup=managementGroup, sNTPPollInterval=sNTPPollInterval, telecomsLoopback=telecomsLoopback, phyStatus=phyStatus, tDDControl=tDDControl, telecomsLineCode=telecomsLineCode, receiveDataRate=receiveDataRate, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, ptp=ptp, tFTPServerIPAddress=tFTPServerIPAddress, timeZone=timeZone, ethernetGroup=ethernetGroup, userTableNumber=userTableNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, systemClock=systemClock, telecomGroup=telecomGroup, hardwareVersion=hardwareVersion, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNMPTrapIPAddress=sNMPTrapIPAddress, telecomsCableLength=telecomsCableLength, syslogState=syslogState, aAAControlGroup=aAAControlGroup, phyStatusGroup=phyStatusGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, linkLoss=linkLoss, aggregateDataRate=aggregateDataRate, sNTPSync=sNTPSync, softwareVersion=softwareVersion, cambium=cambium, iPAddress=iPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, regionCodeTrap=regionCodeTrap, ethernetFiberSupport=ethernetFiberSupport, masterSlaveMode=masterSlaveMode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, signalStrengthRatio=signalStrengthRatio, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, phyControlGroup=phyControlGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, groupID=groupID, licence=licence, linkModeOptimisation=linkModeOptimisation, telecomsInterface=telecomsInterface, sNTPServerPortNumber=sNTPServerPortNumber, dfsGroup=dfsGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, configuration=configuration, eIRP=eIRP, sNMPTrapTableNumber=sNMPTrapTableNumber, snmpControl=snmpControl, productName=productName, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNTPServerIPAddress=sNTPServerIPAddress, telecom=telecom, sNMPTrapTable=sNMPTrapTable, dataPortStatus=dataPortStatus, vLANPriorityQueueMapping=vLANPriorityQueueMapping, supplementary=supplementary, subnetMask=subnetMask, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dfs=dfs, searchState=searchState, bootVersion=bootVersion, sNTPLastSync=sNTPLastSync, transmitDataRate=transmitDataRate, tDDSynchronizationMode=tDDSynchronizationMode, range=range, wirelessLinkAvailability=wirelessLinkAvailability, pubStats=pubStats, maximumTransmitPower=maximumTransmitPower, byteErrorRatio=byteErrorRatio, supplementaryGroup=supplementaryGroup, resetGroup=resetGroup, telecomsChannelStatus=telecomsChannelStatus, sNTPState=sNTPState, userTableEntry=userTableEntry, notificationsGroup=notificationsGroup, receiveModulationMode=receiveModulationMode, sNMPTrapPortNumber=sNMPTrapPortNumber, syslogClientTrap=syslogClientTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ptmp=ptmp, sNMPTrapVersion=sNMPTrapVersion, dataPortAutoMdix=dataPortAutoMdix, versions=versions, telnetAccessEnabled=telnetAccessEnabled, gatewayIPAddress=gatewayIPAddress, snmpControlGroup=snmpControlGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, dfsTableEntry=dfsTableEntry, sMTPServerPortNumber=sMTPServerPortNumber, transmitModulationMode=transmitModulationMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPEnabledTraps=sNMPEnabledTraps, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receiveModulationModeDetail=receiveModulationModeDetail, sMTPEnabledMessages=sMTPEnabledMessages, sNMPCommunityString=sNMPCommunityString, tDDControlGroup=tDDControlGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sntp=sntp, installArmStateTrap=installArmStateTrap, management=management, installArmState=installArmState, linkSymmetry=linkSymmetry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, linkModeOptimizationMismatch=linkModeOptimizationMismatch, syslogControlGroup=syslogControlGroup, longitude=longitude, installStatusTrap=installStatusTrap, alarms=alarms, channelBandwidth=channelBandwidth, phyControl=phyControl, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, frequencyVariant=frequencyVariant, tFTPServerPortNumber=tFTPServerPortNumber, versionsGroup=versionsGroup, vLANPriorityTable=vLANPriorityTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPEmailAlert=sMTPEmailAlert, latitude=latitude, userTable=userTable, vLANPriorityTableIndex=vLANPriorityTableIndex, dfsPeaks=dfsPeaks, accessMethod=accessMethod, bandwidthVariant=bandwidthVariant, channelChangeTrap=channelChangeTrap, ptp500=ptp500, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptpCompliance=ptpCompliance, sNTPSyncTrap=sNTPSyncTrap, alarmsGroup=alarmsGroup, licenceGroup=licenceGroup, syslogStateTrap=syslogStateTrap, sNMPv3Enable=sNMPv3Enable, unitOutOfCalibration=unitOutOfCalibration, daylightSaving=daylightSaving, dfsMeans=dfsMeans, productVariant=productVariant, receivePower=receivePower, sNMPPortNumber=sNMPPortNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, encryption=encryption, remoteIPAddress=remoteIPAddress, vectorError=vectorError, tDDSynchronizationStatus=tDDSynchronizationStatus, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, smtpGroup=smtpGroup, userRole=userRole, hTTPAccessEnabled=hTTPAccessEnabled, siteName=siteName, syslogControl=syslogControl, dfsTableIndex=dfsTableIndex, smtp=smtp, incompatibleRegionCodes=incompatibleRegionCodes, ethernet=ethernet, hTTPSPortNumber=hTTPSPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, userTableIndex=userTableIndex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, aAAControl=aAAControl, transmitChannel=transmitChannel, altitude=altitude, syslogClient=syslogClient, licensedCapacity=licensedCapacity, ptpTrapPrefix=ptpTrapPrefix, receiveFreqKHz=receiveFreqKHz, systemReset=systemReset, userEnabled=userEnabled, userPassword=userPassword, receiveChannel=receiveChannel, targetMACAddress=targetMACAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, configurationGroup=configurationGroup, regionCode=regionCode, ptpTraps=ptpTraps, sNMPTrapTableEntry=sNMPTrapTableEntry, vLANManagementVID=vLANManagementVID, dfsTable=dfsTable, wirelessLinkStatus=wirelessLinkStatus, transmitFreqKHz=transmitFreqKHz, encryptionAlgorithm=encryptionAlgorithm, cableLoss=cableLoss, transmitPower=transmitPower, dataPortStatusTrap=dataPortStatusTrap, dataPortDisabledWarning=dataPortDisabledWarning, transmitFreqMHz=transmitFreqMHz, antennaGain=antennaGain, hTTPSAccessEnabled=hTTPSAccessEnabled, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPServerIPAddress=sMTPServerIPAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, linkName=linkName, vLANPriorityTableEntry=vLANPriorityTableEntry, pubStatsGroup=pubStatsGroup, vLANManagementPriority=vLANManagementPriority, telnetPortNumber=telnetPortNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, hTTPPortNumber=hTTPPortNumber, receiveFreqMHz=receiveFreqMHz, sNMPTrapTableIndex=sNMPTrapTableIndex, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sntpGroup=sntpGroup)
