...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", systemReset=systemReset, ethernetGroup=ethernetGroup, ethernetFiberSupport=ethernetFiberSupport, sNMPPortNumber=sNMPPortNumber, ptpGroups=ptpGroups, phyControlGroup=phyControlGroup, tDDControlGroup=tDDControlGroup, tFTPServerIPAddress=tFTPServerIPAddress, vLANManagementVID=vLANManagementVID, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPServerPortNumber=sNTPServerPortNumber, gatewayIPAddress=gatewayIPAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, frequencyVariant=frequencyVariant, syslogStateTrap=syslogStateTrap, bandwidthVariant=bandwidthVariant, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, versionsGroup=versionsGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPSync=sNTPSync, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortDisabledWarning=dataPortDisabledWarning, resetGroup=resetGroup, configuration=configuration, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortStatus=dataPortStatus, remoteIPAddress=remoteIPAddress, telecomsCableLength=telecomsCableLength, userName=userName, groupID=groupID, telecomsChannelStatusTrap=telecomsChannelStatusTrap, syslogControl=syslogControl, vLANManagementPriority=vLANManagementPriority, telecom=telecom, telecomsInterface=telecomsInterface, linkModeOptimisation=linkModeOptimisation, smtp=smtp, snmpControl=snmpControl, sNMPv3Enable=sNMPv3Enable, syslogState=syslogState, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, aAAControlGroup=aAAControlGroup, versions=versions, productName=productName, incompatibleRegionCodes=incompatibleRegionCodes, linkName=linkName, timeZone=timeZone, regionCode=regionCode, PYSNMP_MODULE_ID=cambium, encryptionAlgorithm=encryptionAlgorithm, reset=reset, dataPortStatusTrap=dataPortStatusTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, licensedCapacity=licensedCapacity, telecomGroup=telecomGroup, smtpGroup=smtpGroup, supplementary=supplementary, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, userPassword=userPassword, syslogClient=syslogClient, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ptpTraps=ptpTraps, transmitPower=transmitPower, syslogControlGroup=syslogControlGroup, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, telecomsChannelStatus=telecomsChannelStatus, transmitModulationMode=transmitModulationMode, antennaGain=antennaGain, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, eIRP=eIRP, receiveDataRate=receiveDataRate, installStatusTrap=installStatusTrap, ptp=ptp, cambium=cambium, userTable=userTable, maximumTransmitPower=maximumTransmitPower, receiveFreqKHz=receiveFreqKHz, capacityLicenseMismatch=capacityLicenseMismatch, sNTPState=sNTPState, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dfs=dfs, dfsTable=dfsTable, channelBandwidth=channelBandwidth, syslogClientTrap=syslogClientTrap, targetMACAddress=targetMACAddress, alarms=alarms, telecomsLoopback=telecomsLoopback, hTTPAccessEnabled=hTTPAccessEnabled, dfsGroup=dfsGroup, accessMethod=accessMethod, secondarySoftwareVersion=secondarySoftwareVersion, sntpGroup=sntpGroup, pubStatsGroup=pubStatsGroup, dfsMeans=dfsMeans, tDDSynchronizationAlarm=tDDSynchronizationAlarm, phyStatusGroup=phyStatusGroup, aggregateDataRate=aggregateDataRate, encryption=encryption, enabledDiagnosticAlarms=enabledDiagnosticAlarms, userTableNumber=userTableNumber, ethernet=ethernet, licenceGroup=licenceGroup, dfsTableEntry=dfsTableEntry, sNTPPollInterval=sNTPPollInterval, userTableIndex=userTableIndex, receiveFreqMHz=receiveFreqMHz, vectorError=vectorError, userTableEntry=userTableEntry, receiveModulationMode=receiveModulationMode, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, transmitChannel=transmitChannel, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sMTPServerIPAddress=sMTPServerIPAddress, productVariant=productVariant, installStatus=installStatus, transmitFreqMHz=transmitFreqMHz, managementGroup=managementGroup, hardwareVersion=hardwareVersion, vLANPriorityTableNumber=vLANPriorityTableNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPSyncTrap=sNTPSyncTrap, notificationsGroup=notificationsGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, alarmsGroup=alarmsGroup, vLANPriorityTable=vLANPriorityTable, dfsTableNumber=dfsTableNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPTrapTable=sNMPTrapTable, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNMPCommunityString=sNMPCommunityString, telecomsLoopbackTrap=telecomsLoopbackTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, altitude=altitude, subnetMask=subnetMask, supplementaryGroup=supplementaryGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, cableLoss=cableLoss, range=range, sMTPServerPortNumber=sMTPServerPortNumber, siteName=siteName, vLANPriorityTableIndex=vLANPriorityTableIndex, aAAControl=aAAControl, phyControl=phyControl, masterSlaveMode=masterSlaveMode, linkSymmetry=linkSymmetry, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ptpTrapPrefix=ptpTrapPrefix, sMTPEnabledMessages=sMTPEnabledMessages, tFTPServerPortNumber=tFTPServerPortNumber, softwareVersion=softwareVersion, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dfsPeaks=dfsPeaks, wirelessLinkStatus=wirelessLinkStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, latitude=latitude, searchState=searchState, userEnabled=userEnabled, noWirelessChannelAvailable=noWirelessChannelAvailable, licence=licence, remoteMaximumTransmitPower=remoteMaximumTransmitPower, signalStrengthRatio=signalStrengthRatio, hTTPSPortNumber=hTTPSPortNumber, receivePower=receivePower, telnetPortNumber=telnetPortNumber, sNTPLastSync=sNTPLastSync, management=management, pubStats=pubStats, configurationGroup=configurationGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, receiveModulationModeDetail=receiveModulationModeDetail, regionCodeTrap=regionCodeTrap, dataPortAutoMdix=dataPortAutoMdix, vLANPriorityQueueMapping=vLANPriorityQueueMapping, unitOutOfCalibration=unitOutOfCalibration, iPAddress=iPAddress, installArmStateTrap=installArmStateTrap, tDDSynchronizationMode=tDDSynchronizationMode, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, linkLoss=linkLoss, sNTPServerIPAddress=sNTPServerIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, channelChangeTrap=channelChangeTrap, sNMPTrapVersion=sNMPTrapVersion, wirelessLinkAvailability=wirelessLinkAvailability, useVLANForManagementInterfaces=useVLANForManagementInterfaces, vLANPriorityTableEntry=vLANPriorityTableEntry, bootVersion=bootVersion, ptp500=ptp500, sNMPEnabledTraps=sNMPEnabledTraps, telecomsLineCode=telecomsLineCode, longitude=longitude, ptmp=ptmp, phyStatus=phyStatus, daylightSaving=daylightSaving, receiveChannel=receiveChannel, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, transmitFreqKHz=transmitFreqKHz, sntp=sntp, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, encryptionGroup=encryptionGroup, installArmState=installArmState, telnetAccessEnabled=telnetAccessEnabled, sMTPEmailAlert=sMTPEmailAlert, hTTPPortNumber=hTTPPortNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, snmpControlGroup=snmpControlGroup, dfsTableIndex=dfsTableIndex, tDDControl=tDDControl, constantPowerSpectralDensity=constantPowerSpectralDensity, incompatibleMasterAndSlave=incompatibleMasterAndSlave, systemClock=systemClock, sNMPTrapPortNumber=sNMPTrapPortNumber, byteErrorRatio=byteErrorRatio, userRole=userRole, transmitDataRate=transmitDataRate, ptpCompliance=ptpCompliance)
