...
# Produced by pysmi-1.1.8 at Fri Jan  7 17:35:40 2022
...
Integer32, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, enterprises, Bits, NotificationType, Counter64, IpAddress, TimeTicks, MibIdentifier, ObjectIdentity, Counter32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "enterprises", "Bits", "NotificationType", "Counter64", "IpAddress", "TimeTicks", "MibIdentifier", "ObjectIdentity", "Counter32", "Unsigned32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", dataPortStatus=dataPortStatus, bootVersion=bootVersion, vLANPriorityTableNumber=vLANPriorityTableNumber, alarmsGroup=alarmsGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, installArmStateTrap=installArmStateTrap, hTTPPortNumber=hTTPPortNumber, cableLoss=cableLoss, dataPortAutoNegotiation=dataPortAutoNegotiation, pubStats=pubStats, managementGroup=managementGroup, phyControlGroup=phyControlGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ptpCompliance=ptpCompliance, supplementary=supplementary, tDDControl=tDDControl, installArmState=installArmState, ptp=ptp, vLANPriorityTableIndex=vLANPriorityTableIndex, userPassword=userPassword, sNTPServerIPAddress=sNTPServerIPAddress, telecomsLineCode=telecomsLineCode, dataPortConfigurationMismatch=dataPortConfigurationMismatch, ethernet=ethernet, sMTPEmailAlert=sMTPEmailAlert, userTable=userTable, dfsTableNumber=dfsTableNumber, sNMPv3Enable=sNMPv3Enable, vLANManagementPriority=vLANManagementPriority, transmitPower=transmitPower, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, softwareVersion=softwareVersion, receiveFreqKHz=receiveFreqKHz, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, receiveFreqMHz=receiveFreqMHz, hTTPSAccessEnabled=hTTPSAccessEnabled, encryptionAlgorithm=encryptionAlgorithm, subnetMask=subnetMask, syslogStateTrap=syslogStateTrap, phyStatusGroup=phyStatusGroup, dfs=dfs, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfsMeans=dfsMeans, notificationsGroup=notificationsGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, wirelessLinkAvailability=wirelessLinkAvailability, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, syslogState=syslogState, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dfsTableEntry=dfsTableEntry, productVariant=productVariant, installStatusTrap=installStatusTrap, telnetPortNumber=telnetPortNumber, userName=userName, PYSNMP_MODULE_ID=cambium, smtp=smtp, snmpControl=snmpControl, telecomsLoopbackTrap=telecomsLoopbackTrap, smtpGroup=smtpGroup, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, regionCode=regionCode, sMTPServerIPAddress=sMTPServerIPAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPTrapVersion=sNMPTrapVersion, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, noWirelessChannelAvailable=noWirelessChannelAvailable, signalStrengthRatio=signalStrengthRatio, userTableEntry=userTableEntry, tDDSynchronizationAlarm=tDDSynchronizationAlarm, aggregateDataRate=aggregateDataRate, unitOutOfCalibration=unitOutOfCalibration, transmitFreqKHz=transmitFreqKHz, ptpGroups=ptpGroups, sntp=sntp, gatewayIPAddress=gatewayIPAddress, remoteIPAddress=remoteIPAddress, syslogClient=syslogClient, dataPortDisabledWarning=dataPortDisabledWarning, transmitDataRate=transmitDataRate, sMTPServerPortNumber=sMTPServerPortNumber, latitude=latitude, alarms=alarms, useVLANForManagementInterfaces=useVLANForManagementInterfaces, receiveDataRate=receiveDataRate, sntpGroup=sntpGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, userEnabled=userEnabled, sNTPSync=sNTPSync, daylightSaving=daylightSaving, sNMPTrapTableNumber=sNMPTrapTableNumber, vLANManagementVID=vLANManagementVID, tFTPServerIPAddress=tFTPServerIPAddress, ethernetFiberSupport=ethernetFiberSupport, telecomsInterface=telecomsInterface, telecomsChannelStatus=telecomsChannelStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, syslogControlGroup=syslogControlGroup, telecom=telecom, configurationGroup=configurationGroup, transmitChannel=transmitChannel, capacityLicenseMismatch=capacityLicenseMismatch, sNMPCommunityString=sNMPCommunityString, receiveModulationModeDetail=receiveModulationModeDetail, ptpTrapPrefix=ptpTrapPrefix, dfsTableIndex=dfsTableIndex, timeZone=timeZone, telecomGroup=telecomGroup, syslogControl=syslogControl, tFTPServerPortNumber=tFTPServerPortNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, phyControl=phyControl, linkSymmetry=linkSymmetry, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, encryption=encryption, productName=productName, aAAControl=aAAControl, dfsGroup=dfsGroup, userTableNumber=userTableNumber, byteErrorRatio=byteErrorRatio, channelBandwidth=channelBandwidth, sNMPTrapTable=sNMPTrapTable, vLANPriorityQueueMapping=vLANPriorityQueueMapping, versions=versions, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, receivePower=receivePower, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, cambium=cambium, aAAControlGroup=aAAControlGroup, dfsPeaks=dfsPeaks, linkName=linkName, vectorError=vectorError, longitude=longitude, sNMPEnabledTraps=sNMPEnabledTraps, sNTPPollInterval=sNTPPollInterval, linkModeOptimisation=linkModeOptimisation, masterSlaveMode=masterSlaveMode, channelChangeTrap=channelChangeTrap, range=range, linkLoss=linkLoss, phyStatus=phyStatus, targetMACAddress=targetMACAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, altitude=altitude, maximumTransmitPower=maximumTransmitPower, eIRP=eIRP, userTableIndex=userTableIndex, incompatibleRegionCodes=incompatibleRegionCodes, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPServerPortNumber=sNTPServerPortNumber, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ptp500=ptp500, snmpControlGroup=snmpControlGroup, ptmp=ptmp, sNTPLastSync=sNTPLastSync, dataPortStatusTrap=dataPortStatusTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, supplementaryGroup=supplementaryGroup, vLANPriorityTable=vLANPriorityTable, iPAddress=iPAddress, installStatus=installStatus, receiveModulationMode=receiveModulationMode, systemClock=systemClock, telecomsCableLength=telecomsCableLength, sMTPEnabledMessages=sMTPEnabledMessages, transmitFreqMHz=transmitFreqMHz, syslogClientTrap=syslogClientTrap, bandwidthVariant=bandwidthVariant, sNTPState=sNTPState, sNMPTrapTableEntry=sNMPTrapTableEntry, receiveChannel=receiveChannel, hTTPSPortNumber=hTTPSPortNumber, telecomsLoopback=telecomsLoopback, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tDDControlGroup=tDDControlGroup, searchState=searchState, dataPortAutoMdix=dataPortAutoMdix, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ptpTraps=ptpTraps, versionsGroup=versionsGroup, sNTPSyncTrap=sNTPSyncTrap, configuration=configuration, syslogLocalWrappedTrap=syslogLocalWrappedTrap, licenceGroup=licenceGroup, sNMPPortNumber=sNMPPortNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, telnetAccessEnabled=telnetAccessEnabled, frequencyVariant=frequencyVariant, sNMPTrapTableIndex=sNMPTrapTableIndex, encryptionGroup=encryptionGroup, userRole=userRole, groupID=groupID, hardwareVersion=hardwareVersion, pubStatsGroup=pubStatsGroup, tDDSynchronizationMode=tDDSynchronizationMode, ethernetGroup=ethernetGroup, secondarySoftwareVersion=secondarySoftwareVersion, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, licensedCapacity=licensedCapacity, regionCodeTrap=regionCodeTrap, transmitModulationMode=transmitModulationMode, wirelessLinkStatus=wirelessLinkStatus, accessMethod=accessMethod, reset=reset, resetGroup=resetGroup, hTTPAccessEnabled=hTTPAccessEnabled, siteName=siteName, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, systemReset=systemReset, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, management=management, antennaGain=antennaGain, dfsTable=dfsTable, licence=licence, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex)
