...
# Produced by pysmi-1.1.3 at Wed Dec  8 17:45:20 2021
...
MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, NotificationType, TimeTicks, Counter64, Gauge32, Integer32, Unsigned32, Bits, MibIdentifier, ModuleIdentity, IpAddress, iso, enterprises, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "NotificationType", "TimeTicks", "Counter64", "Gauge32", "Integer32", "Unsigned32", "Bits", "MibIdentifier", "ModuleIdentity", "IpAddress", "iso", "enterprises", "Counter32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", telecomsChannelStatus=telecomsChannelStatus, sNMPv3Enable=sNMPv3Enable, wirelessLinkStatus=wirelessLinkStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, telnetPortNumber=telnetPortNumber, aAAControl=aAAControl, targetMACAddress=targetMACAddress, telecomsChannelStatusTrap=telecomsChannelStatusTrap, bandwidthVariant=bandwidthVariant, sNMPPortNumber=sNMPPortNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, linkName=linkName, installStatusTrap=installStatusTrap, linkSymmetry=linkSymmetry, altitude=altitude, tDDControlGroup=tDDControlGroup, vLANPriorityTable=vLANPriorityTable, accessMethod=accessMethod, dfsTableNumber=dfsTableNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, wirelessLinkAvailability=wirelessLinkAvailability, sntp=sntp, supplementaryGroup=supplementaryGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPServerPortNumber=sNTPServerPortNumber, softwareVersion=softwareVersion, dataPortStatusTrap=dataPortStatusTrap, dataPortAutoMdix=dataPortAutoMdix, vectorError=vectorError, dfsTableEntry=dfsTableEntry, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, telecomsLoopbackTrap=telecomsLoopbackTrap, tFTPServerPortNumber=tFTPServerPortNumber, latitude=latitude, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, systemClock=systemClock, userName=userName, tDDSynchronizationStatus=tDDSynchronizationStatus, telecomGroup=telecomGroup, ethernetFiberSupport=ethernetFiberSupport, userTable=userTable, transmitChannel=transmitChannel, management=management, sNTPSync=sNTPSync, linkModeOptimisation=linkModeOptimisation, notificationsGroup=notificationsGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, tFTPServerIPAddress=tFTPServerIPAddress, transmitModulationMode=transmitModulationMode, receivePower=receivePower, transmitFreqKHz=transmitFreqKHz, noWirelessChannelAvailable=noWirelessChannelAvailable, productName=productName, reset=reset, encryptionGroup=encryptionGroup, cambium=cambium, productVariant=productVariant, versions=versions, sNMPEnabledTraps=sNMPEnabledTraps, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, transmitDataRate=transmitDataRate, ptmp=ptmp, userEnabled=userEnabled, regionCodeTrap=regionCodeTrap, byteErrorRatio=byteErrorRatio, transmitPower=transmitPower, bootVersion=bootVersion, subnetMask=subnetMask, sMTPEmailAlert=sMTPEmailAlert, transmitFreqMHz=transmitFreqMHz, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, receiveFreqMHz=receiveFreqMHz, signalStrengthRatio=signalStrengthRatio, channelBandwidth=channelBandwidth, receiveModulationModeDetail=receiveModulationModeDetail, telnetAccessEnabled=telnetAccessEnabled, sntpGroup=sntpGroup, sNTPState=sNTPState, telecomsLoopback=telecomsLoopback, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, telecomsInterface=telecomsInterface, sNMPTrapTableIndex=sNMPTrapTableIndex, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, hardwareVersion=hardwareVersion, useVLANForManagementInterfaces=useVLANForManagementInterfaces, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogClientTrap=syslogClientTrap, dfs=dfs, phyStatus=phyStatus, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, vLANManagementPriority=vLANManagementPriority, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortDisabledWarning=dataPortDisabledWarning, linkLoss=linkLoss, sNTPServerIPAddress=sNTPServerIPAddress, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, vLANPriorityTableEntry=vLANPriorityTableEntry, telecomsLineCode=telecomsLineCode, cableLoss=cableLoss, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, groupID=groupID, hTTPAccessEnabled=hTTPAccessEnabled, pubStats=pubStats, syslogLocalWrappedTrap=syslogLocalWrappedTrap, maximumTransmitPower=maximumTransmitPower, userRole=userRole, PYSNMP_MODULE_ID=cambium, managementGroup=managementGroup, installStatus=installStatus, sMTPServerPortNumber=sMTPServerPortNumber, installArmState=installArmState, licenceGroup=licenceGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, secondarySoftwareVersion=secondarySoftwareVersion, encryptionAlgorithm=encryptionAlgorithm, tDDSynchronizationMode=tDDSynchronizationMode, syslogState=syslogState, phyControlGroup=phyControlGroup, alarmsGroup=alarmsGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, timeZone=timeZone, installArmStateTrap=installArmStateTrap, sNMPCommunityString=sNMPCommunityString, snmpControl=snmpControl, antennaGain=antennaGain, phyControl=phyControl, gatewayIPAddress=gatewayIPAddress, syslogStateTrap=syslogStateTrap, ptpTrapPrefix=ptpTrapPrefix, ptpGroups=ptpGroups, frequencyVariant=frequencyVariant, remoteMaximumTransmitPower=remoteMaximumTransmitPower, remoteIPAddress=remoteIPAddress, dfsGroup=dfsGroup, sNMPTrapVersion=sNMPTrapVersion, receiveDataRate=receiveDataRate, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, userTableNumber=userTableNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, ptp=ptp, configuration=configuration, range=range, aggregateDataRate=aggregateDataRate, masterSlaveMode=masterSlaveMode, sNMPTrapPortNumber=sNMPTrapPortNumber, supplementary=supplementary, snmpControlGroup=snmpControlGroup, alarms=alarms, tDDControl=tDDControl, vLANManagementVID=vLANManagementVID, sNTPLastSync=sNTPLastSync, userPassword=userPassword, receiveModulationMode=receiveModulationMode, capacityLicenseMismatch=capacityLicenseMismatch, resetGroup=resetGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptp500=ptp500, hTTPSAccessEnabled=hTTPSAccessEnabled, dfsMeans=dfsMeans, sNMPTrapTable=sNMPTrapTable, dfsTableIndex=dfsTableIndex, sMTPEnabledMessages=sMTPEnabledMessages, ptpCompliance=ptpCompliance, vLANPriorityTableNumber=vLANPriorityTableNumber, longitude=longitude, siteName=siteName, dataPortStatus=dataPortStatus, sNTPSyncTrap=sNTPSyncTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, encryption=encryption, smtp=smtp, iPAddress=iPAddress, channelChangeTrap=channelChangeTrap, syslogControl=syslogControl, constantPowerSpectralDensity=constantPowerSpectralDensity, telecomsCableLength=telecomsCableLength, dfsPeaks=dfsPeaks, tDDSynchronizationAlarm=tDDSynchronizationAlarm, unitOutOfCalibration=unitOutOfCalibration, regionCode=regionCode, sMTPServerIPAddress=sMTPServerIPAddress, syslogControlGroup=syslogControlGroup, pubStatsGroup=pubStatsGroup, systemReset=systemReset, sNMPTrapTableEntry=sNMPTrapTableEntry, syslogClient=syslogClient, eIRP=eIRP, dataPortConfigurationMismatch=dataPortConfigurationMismatch, configurationGroup=configurationGroup, telecom=telecom, incompatibleRegionCodes=incompatibleRegionCodes, userTableIndex=userTableIndex, receiveFreqKHz=receiveFreqKHz, ptpTraps=ptpTraps, licence=licence, sNMPTrapIPAddress=sNMPTrapIPAddress, versionsGroup=versionsGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, ethernetGroup=ethernetGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, receiveChannel=receiveChannel, daylightSaving=daylightSaving, hTTPSPortNumber=hTTPSPortNumber, licensedCapacity=licensedCapacity, searchState=searchState, sNTPPollInterval=sNTPPollInterval, linkModeOptimizationMismatch=linkModeOptimizationMismatch, ethernet=ethernet, hTTPPortNumber=hTTPPortNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, aAAControlGroup=aAAControlGroup, userTableEntry=userTableEntry, dfsTable=dfsTable, smtpGroup=smtpGroup, phyStatusGroup=phyStatusGroup)
