...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, channelChangeTrap=channelChangeTrap, configuration=configuration, dfsTableNumber=dfsTableNumber, unitOutOfCalibration=unitOutOfCalibration, userRole=userRole, sntp=sntp, ptpTraps=ptpTraps, telecomsCableLength=telecomsCableLength, ptp=ptp, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, phyStatus=phyStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, hardwareVersion=hardwareVersion, notificationsGroup=notificationsGroup, sNMPTrapVersion=sNMPTrapVersion, telnetPortNumber=telnetPortNumber, tDDControl=tDDControl, vLANPriorityTableNumber=vLANPriorityTableNumber, dfsTable=dfsTable, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, telecomsLoopbackTrap=telecomsLoopbackTrap, tFTPServerIPAddress=tFTPServerIPAddress, telnetAccessEnabled=telnetAccessEnabled, supplementaryGroup=supplementaryGroup, telecomsInterface=telecomsInterface, receiveChannel=receiveChannel, vLANPriorityTable=vLANPriorityTable, masterSlaveMode=masterSlaveMode, dataPortStatusTrap=dataPortStatusTrap, telecomGroup=telecomGroup, dataPortAutoMdix=dataPortAutoMdix, userTableEntry=userTableEntry, versions=versions, antennaGain=antennaGain, licensedCapacity=licensedCapacity, capacityLicenseMismatch=capacityLicenseMismatch, gatewayIPAddress=gatewayIPAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, bootVersion=bootVersion, encryption=encryption, noWirelessChannelAvailable=noWirelessChannelAvailable, accessMethod=accessMethod, sNMPTrapTableIndex=sNMPTrapTableIndex, installStatus=installStatus, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dataPortStatus=dataPortStatus, transmitFreqMHz=transmitFreqMHz, secondarySoftwareVersion=secondarySoftwareVersion, productVariant=productVariant, receiveFreqMHz=receiveFreqMHz, syslogClient=syslogClient, pubStats=pubStats, sNTPSyncTrap=sNTPSyncTrap, cambium=cambium, linkModeOptimisation=linkModeOptimisation, sNMPEnabledTraps=sNMPEnabledTraps, transmitDataRate=transmitDataRate, syslogControl=syslogControl, remoteIPAddress=remoteIPAddress, wirelessLinkStatus=wirelessLinkStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkName=linkName, dfsGroup=dfsGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, management=management, userPassword=userPassword, hTTPSAccessEnabled=hTTPSAccessEnabled, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sMTPSourceEmailAddress=sMTPSourceEmailAddress, frequencyVariant=frequencyVariant, tDDSynchronizationAlarm=tDDSynchronizationAlarm, enabledDiagnosticAlarms=enabledDiagnosticAlarms, telecom=telecom, installStatusTrap=installStatusTrap, alarmsGroup=alarmsGroup, transmitModulationMode=transmitModulationMode, syslogClientTrap=syslogClientTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNTPServerIPAddress=sNTPServerIPAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, aggregateDataRate=aggregateDataRate, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ethernetGroup=ethernetGroup, cableLoss=cableLoss, altitude=altitude, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, syslogState=syslogState, snmpControl=snmpControl, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, snmpControlGroup=snmpControlGroup, linkLoss=linkLoss, searchState=searchState, linkModeOptimizationMismatch=linkModeOptimizationMismatch, installArmState=installArmState, sntpGroup=sntpGroup, tFTPServerPortNumber=tFTPServerPortNumber, dataPortDisabledWarning=dataPortDisabledWarning, sNTPState=sNTPState, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptpCompliance=ptpCompliance, hTTPAccessEnabled=hTTPAccessEnabled, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPServerPortNumber=sNTPServerPortNumber, sNMPTrapTable=sNMPTrapTable, syslogControlGroup=syslogControlGroup, resetGroup=resetGroup, sMTPEmailAlert=sMTPEmailAlert, sNMPv3Enable=sNMPv3Enable, systemReset=systemReset, receivePower=receivePower, channelBandwidth=channelBandwidth, ptpTrapPrefix=ptpTrapPrefix, tDDControlGroup=tDDControlGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dfs=dfs, userEnabled=userEnabled, sNMPCommunityString=sNMPCommunityString, licenceGroup=licenceGroup, bandwidthVariant=bandwidthVariant, incompatibleRegionCodes=incompatibleRegionCodes, sNTPLastSync=sNTPLastSync, aAAControl=aAAControl, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, vLANManagementPriority=vLANManagementPriority, ptmp=ptmp, dataPortAutoNegotiation=dataPortAutoNegotiation, vLANManagementVID=vLANManagementVID, syslogStateTrap=syslogStateTrap, vectorError=vectorError, installArmStateTrap=installArmStateTrap, smtpGroup=smtpGroup, telecomsLineCode=telecomsLineCode, hTTPSPortNumber=hTTPSPortNumber, receiveDataRate=receiveDataRate, versionsGroup=versionsGroup, reset=reset, userTable=userTable, telecomsLoopback=telecomsLoopback, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, systemClock=systemClock, aAAControlGroup=aAAControlGroup, alarms=alarms, sNTPPollInterval=sNTPPollInterval, regionCodeTrap=regionCodeTrap, tDDSynchronizationMode=tDDSynchronizationMode, regionCode=regionCode, ethernet=ethernet, siteName=siteName, iPAddress=iPAddress, range=range, signalStrengthRatio=signalStrengthRatio, receiveFreqKHz=receiveFreqKHz, dataPortConfigurationMismatch=dataPortConfigurationMismatch, encryptionAlgorithm=encryptionAlgorithm, userName=userName, maximumTransmitPower=maximumTransmitPower, supplementary=supplementary, licence=licence, transmitPower=transmitPower, useVLANForManagementInterfaces=useVLANForManagementInterfaces, vLANPriorityQueueMapping=vLANPriorityQueueMapping, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ethernetFiberSupport=ethernetFiberSupport, managementGroup=managementGroup, subnetMask=subnetMask, configurationGroup=configurationGroup, transmitChannel=transmitChannel, targetMACAddress=targetMACAddress, telecomsChannelStatusTrap=telecomsChannelStatusTrap, telecomsChannelStatus=telecomsChannelStatus, receiveModulationMode=receiveModulationMode, sNMPPortNumber=sNMPPortNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPSync=sNTPSync, wirelessLinkAvailability=wirelessLinkAvailability, phyStatusGroup=phyStatusGroup, longitude=longitude, phyControl=phyControl, sNMPTrapIPAddress=sNMPTrapIPAddress, dfsTableEntry=dfsTableEntry, dfsMeans=dfsMeans, pubStatsGroup=pubStatsGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, eIRP=eIRP, timeZone=timeZone, ptp500=ptp500, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, userTableIndex=userTableIndex, PYSNMP_MODULE_ID=cambium, dfsTableIndex=dfsTableIndex, byteErrorRatio=byteErrorRatio, dfsPeaks=dfsPeaks, sMTPServerIPAddress=sMTPServerIPAddress, vLANPriorityTableIndex=vLANPriorityTableIndex, smtp=smtp, userTableNumber=userTableNumber, phyControlGroup=phyControlGroup, ptpGroups=ptpGroups, receiveModulationModeDetail=receiveModulationModeDetail, productName=productName, softwareVersion=softwareVersion, sMTPServerPortNumber=sMTPServerPortNumber, hTTPPortNumber=hTTPPortNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, latitude=latitude, encryptionGroup=encryptionGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, groupID=groupID, dataPortWirelessDownAlert=dataPortWirelessDownAlert, linkSymmetry=linkSymmetry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitFreqKHz=transmitFreqKHz, sMTPEnabledMessages=sMTPEnabledMessages, daylightSaving=daylightSaving, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade)
