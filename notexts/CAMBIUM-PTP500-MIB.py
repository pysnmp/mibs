...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", linkName=linkName, installArmStateTrap=installArmStateTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, telecomsInterface=telecomsInterface, incompatibleMasterAndSlave=incompatibleMasterAndSlave, bootVersion=bootVersion, dfsTableNumber=dfsTableNumber, dfsMeans=dfsMeans, byteErrorRatio=byteErrorRatio, sNMPTrapTableEntry=sNMPTrapTableEntry, hTTPAccessEnabled=hTTPAccessEnabled, remoteMaximumTransmitPower=remoteMaximumTransmitPower, encryptionAlgorithm=encryptionAlgorithm, alarmsGroup=alarmsGroup, pubStatsGroup=pubStatsGroup, timeZone=timeZone, supplementary=supplementary, ptp500=ptp500, phyStatusGroup=phyStatusGroup, aAAControlGroup=aAAControlGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPTrapIPAddress=sNMPTrapIPAddress, systemReset=systemReset, sMTPSourceEmailAddress=sMTPSourceEmailAddress, supplementaryGroup=supplementaryGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, telnetPortNumber=telnetPortNumber, ptmp=ptmp, versions=versions, tDDControl=tDDControl, transmitPower=transmitPower, vectorError=vectorError, vLANManagementPriority=vLANManagementPriority, sNMPTrapTable=sNMPTrapTable, capacityLicenseMismatch=capacityLicenseMismatch, managementGroup=managementGroup, sntp=sntp, subnetMask=subnetMask, snmpControl=snmpControl, ptpGroups=ptpGroups, ethernetGroup=ethernetGroup, groupID=groupID, longitude=longitude, receivePower=receivePower, useVLANForManagementInterfaces=useVLANForManagementInterfaces, syslogClientTrap=syslogClientTrap, licence=licence, notificationsGroup=notificationsGroup, productVariant=productVariant, siteName=siteName, sNTPServerPortNumber=sNTPServerPortNumber, userRole=userRole, syslogLocalWrappedTrap=syslogLocalWrappedTrap, installStatusTrap=installStatusTrap, iPAddress=iPAddress, dataPortStatusTrap=dataPortStatusTrap, smtpGroup=smtpGroup, ptpCompliance=ptpCompliance, receiveFreqKHz=receiveFreqKHz, reset=reset, ethernetFiberSupport=ethernetFiberSupport, telnetAccessEnabled=telnetAccessEnabled, sNMPTrapPortNumber=sNMPTrapPortNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortStatus=dataPortStatus, tDDSynchronizationMode=tDDSynchronizationMode, daylightSaving=daylightSaving, wirelessLinkAvailability=wirelessLinkAvailability, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, PYSNMP_MODULE_ID=cambium, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, resetGroup=resetGroup, userName=userName, eIRP=eIRP, encryptionGroup=encryptionGroup, signalStrengthRatio=signalStrengthRatio, linkSymmetry=linkSymmetry, syslogStateTrap=syslogStateTrap, telecom=telecom, sNMPv3Enable=sNMPv3Enable, ptpTrapPrefix=ptpTrapPrefix, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, alarms=alarms, receiveFreqMHz=receiveFreqMHz, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dfsTable=dfsTable, hTTPSAccessEnabled=hTTPSAccessEnabled, masterSlaveMode=masterSlaveMode, regionCode=regionCode, hardwareVersion=hardwareVersion, unitOutOfCalibration=unitOutOfCalibration, dfsTableEntry=dfsTableEntry, syslogControlGroup=syslogControlGroup, frequencyVariant=frequencyVariant, dfs=dfs, sntpGroup=sntpGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, hTTPSPortNumber=hTTPSPortNumber, snmpControlGroup=snmpControlGroup, ptpTraps=ptpTraps, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, secondarySoftwareVersion=secondarySoftwareVersion, phyControl=phyControl, smtp=smtp, management=management, vLANPriorityTable=vLANPriorityTable, syslogControl=syslogControl, sNMPTrapVersion=sNMPTrapVersion, targetMACAddress=targetMACAddress, receiveModulationModeDetail=receiveModulationModeDetail, dfsGroup=dfsGroup, dataPortAutoMdix=dataPortAutoMdix, linkLoss=linkLoss, transmitDataRate=transmitDataRate, vLANPriorityTableIndex=vLANPriorityTableIndex, tDDControlGroup=tDDControlGroup, userTable=userTable, phyStatus=phyStatus, dfsPeaks=dfsPeaks, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, receiveChannel=receiveChannel, maximumTransmitPower=maximumTransmitPower, remoteIPAddress=remoteIPAddress, sMTPEnabledMessages=sMTPEnabledMessages, userPassword=userPassword, searchState=searchState, sMTPServerPortNumber=sMTPServerPortNumber, sNTPLastSync=sNTPLastSync, sNTPSync=sNTPSync, vLANPriorityQueueMapping=vLANPriorityQueueMapping, receiveDataRate=receiveDataRate, hTTPPortNumber=hTTPPortNumber, systemClock=systemClock, configurationGroup=configurationGroup, sNMPPortNumber=sNMPPortNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, cambium=cambium, transmitFreqMHz=transmitFreqMHz, telecomsChannelStatus=telecomsChannelStatus, dfsTableIndex=dfsTableIndex, antennaGain=antennaGain, sNTPState=sNTPState, latitude=latitude, tDDSynchronizationAlarm=tDDSynchronizationAlarm, linkModeOptimisation=linkModeOptimisation, productName=productName, telecomsLoopbackTrap=telecomsLoopbackTrap, accessMethod=accessMethod, sNTPServerIPAddress=sNTPServerIPAddress, incompatibleRegionCodes=incompatibleRegionCodes, dataPortDisabledWarning=dataPortDisabledWarning, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telecomGroup=telecomGroup, transmitFreqKHz=transmitFreqKHz, cableLoss=cableLoss, licenceGroup=licenceGroup, configuration=configuration, noWirelessChannelAvailable=noWirelessChannelAvailable, aAAControl=aAAControl, ethernet=ethernet, wirelessLinkStatus=wirelessLinkStatus, syslogClient=syslogClient, encryption=encryption, tDDSynchronizationStatus=tDDSynchronizationStatus, altitude=altitude, regionCodeTrap=regionCodeTrap, userTableNumber=userTableNumber, telecomsLoopback=telecomsLoopback, transmitChannel=transmitChannel, userTableEntry=userTableEntry, softwareVersion=softwareVersion, phyControlGroup=phyControlGroup, versionsGroup=versionsGroup, sMTPServerIPAddress=sMTPServerIPAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, installArmState=installArmState, telecomsLineCode=telecomsLineCode, channelBandwidth=channelBandwidth, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNMPCommunityString=sNMPCommunityString, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, receiveModulationMode=receiveModulationMode, vLANPriorityTableEntry=vLANPriorityTableEntry, licensedCapacity=licensedCapacity, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNTPSyncTrap=sNTPSyncTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, transmitModulationMode=transmitModulationMode, sNMPTrapTableIndex=sNMPTrapTableIndex, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tFTPServerPortNumber=tFTPServerPortNumber, gatewayIPAddress=gatewayIPAddress, userEnabled=userEnabled, telecomsCableLength=telecomsCableLength, linkModeOptimizationMismatch=linkModeOptimizationMismatch, range=range, bandwidthVariant=bandwidthVariant, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, vLANPriorityTableNumber=vLANPriorityTableNumber, channelChangeTrap=channelChangeTrap, syslogState=syslogState, sNTPPollInterval=sNTPPollInterval, sMTPEmailAlert=sMTPEmailAlert, userTableIndex=userTableIndex, installStatus=installStatus, pubStats=pubStats, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, aggregateDataRate=aggregateDataRate, vLANManagementVID=vLANManagementVID, sNMPEnabledTraps=sNMPEnabledTraps, tFTPServerIPAddress=tFTPServerIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ptp=ptp, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement)
