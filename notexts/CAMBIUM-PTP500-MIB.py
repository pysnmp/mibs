...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", aggregateDataRate=aggregateDataRate, remoteIPAddress=remoteIPAddress, vLANPriorityTableEntry=vLANPriorityTableEntry, sNMPv3Enable=sNMPv3Enable, sNMPTrapTableIndex=sNMPTrapTableIndex, smtpGroup=smtpGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, wirelessLinkStatus=wirelessLinkStatus, ethernetGroup=ethernetGroup, sNMPTrapTable=sNMPTrapTable, syslogControlGroup=syslogControlGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, ptmp=ptmp, tDDSynchronizationMode=tDDSynchronizationMode, dfs=dfs, wirelessLinkAvailability=wirelessLinkAvailability, longitude=longitude, telecomsLoopbackTrap=telecomsLoopbackTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, reset=reset, sntp=sntp, configuration=configuration, dfsGroup=dfsGroup, channelBandwidth=channelBandwidth, vLANManagementVID=vLANManagementVID, ethernetFiberSupport=ethernetFiberSupport, remoteMaximumTransmitPower=remoteMaximumTransmitPower, secondarySoftwareVersion=secondarySoftwareVersion, dataPortAutoNegotiation=dataPortAutoNegotiation, sNTPPollInterval=sNTPPollInterval, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, telecomsInterface=telecomsInterface, userRole=userRole, userTableIndex=userTableIndex, constantPowerSpectralDensity=constantPowerSpectralDensity, dataPortStatus=dataPortStatus, userEnabled=userEnabled, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, iPAddress=iPAddress, dataPortStatusTrap=dataPortStatusTrap, eIRP=eIRP, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, transmitChannel=transmitChannel, vLANManagementPriority=vLANManagementPriority, ptpGroups=ptpGroups, ptpTraps=ptpTraps, sNMPPortNumber=sNMPPortNumber, subnetMask=subnetMask, linkSymmetry=linkSymmetry, tDDControl=tDDControl, sNTPServerIPAddress=sNTPServerIPAddress, phyStatusGroup=phyStatusGroup, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, alarms=alarms, daylightSaving=daylightSaving, dfsTableIndex=dfsTableIndex, vectorError=vectorError, supplementary=supplementary, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, softwareVersion=softwareVersion, sMTPEmailAlert=sMTPEmailAlert, systemClock=systemClock, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, signalStrengthRatio=signalStrengthRatio, tDDSynchronizationAlarm=tDDSynchronizationAlarm, vLANPriorityTable=vLANPriorityTable, sNTPLastSync=sNTPLastSync, userTable=userTable, hardwareVersion=hardwareVersion, hTTPSAccessEnabled=hTTPSAccessEnabled, incompatibleRegionCodes=incompatibleRegionCodes, syslogControl=syslogControl, ptp=ptp, productVariant=productVariant, sNMPTrapVersion=sNMPTrapVersion, masterSlaveMode=masterSlaveMode, dataPortAutoMdix=dataPortAutoMdix, management=management, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, hTTPAccessEnabled=hTTPAccessEnabled, tFTPServerIPAddress=tFTPServerIPAddress, transmitPower=transmitPower, range=range, userName=userName, ptpTrapPrefix=ptpTrapPrefix, syslogClientTrap=syslogClientTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, versions=versions, sNTPSyncTrap=sNTPSyncTrap, siteName=siteName, syslogStateTrap=syslogStateTrap, maximumTransmitPower=maximumTransmitPower, ptpCompliance=ptpCompliance, linkLoss=linkLoss, configurationGroup=configurationGroup, ethernet=ethernet, userTableNumber=userTableNumber, licenceGroup=licenceGroup, encryptionGroup=encryptionGroup, receiveDataRate=receiveDataRate, snmpControl=snmpControl, phyControl=phyControl, telecomsLoopback=telecomsLoopback, phyStatus=phyStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ptp500=ptp500, sNMPTrapTableNumber=sNMPTrapTableNumber, searchState=searchState, unitOutOfCalibration=unitOutOfCalibration, syslogState=syslogState, aAAControlGroup=aAAControlGroup, telecomsChannelStatus=telecomsChannelStatus, sntpGroup=sntpGroup, sNTPState=sNTPState, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, frequencyVariant=frequencyVariant, hTTPSPortNumber=hTTPSPortNumber, sNMPCommunityString=sNMPCommunityString, PYSNMP_MODULE_ID=cambium, telnetAccessEnabled=telnetAccessEnabled, receiveChannel=receiveChannel, transmitFreqKHz=transmitFreqKHz, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sMTPServerIPAddress=sMTPServerIPAddress, dfsTable=dfsTable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, licensedCapacity=licensedCapacity, sMTPEnabledMessages=sMTPEnabledMessages, enabledDiagnosticAlarms=enabledDiagnosticAlarms, channelChangeTrap=channelChangeTrap, sMTPServerPortNumber=sMTPServerPortNumber, versionsGroup=versionsGroup, productName=productName, installStatusTrap=installStatusTrap, capacityLicenseMismatch=capacityLicenseMismatch, targetMACAddress=targetMACAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, licence=licence, bandwidthVariant=bandwidthVariant, installArmState=installArmState, regionCodeTrap=regionCodeTrap, regionCode=regionCode, byteErrorRatio=byteErrorRatio, sNMPTrapPortNumber=sNMPTrapPortNumber, telecomsCableLength=telecomsCableLength, snmpControlGroup=snmpControlGroup, receiveModulationMode=receiveModulationMode, dataPortDisabledWarning=dataPortDisabledWarning, aAAControl=aAAControl, sNTPServerPortNumber=sNTPServerPortNumber, phyControlGroup=phyControlGroup, dfsMeans=dfsMeans, bootVersion=bootVersion, encryptionAlgorithm=encryptionAlgorithm, noWirelessChannelAvailable=noWirelessChannelAvailable, transmitDataRate=transmitDataRate, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, smtp=smtp, dfsTableEntry=dfsTableEntry, receivePower=receivePower, dfsTableNumber=dfsTableNumber, pubStats=pubStats, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, vLANPriorityTableIndex=vLANPriorityTableIndex, userTableEntry=userTableEntry, syslogClient=syslogClient, linkModeOptimizationMismatch=linkModeOptimizationMismatch, timeZone=timeZone, cambium=cambium, vLANPriorityQueueMapping=vLANPriorityQueueMapping, cableLoss=cableLoss, userPassword=userPassword, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, systemReset=systemReset, syslogLocalWrappedTrap=syslogLocalWrappedTrap, resetGroup=resetGroup, installArmStateTrap=installArmStateTrap, telecom=telecom, linkModeOptimisation=linkModeOptimisation, vLANPriorityTableNumber=vLANPriorityTableNumber, telnetPortNumber=telnetPortNumber, latitude=latitude, alarmsGroup=alarmsGroup, transmitModulationMode=transmitModulationMode, supplementaryGroup=supplementaryGroup, tDDControlGroup=tDDControlGroup, antennaGain=antennaGain, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPEnabledTraps=sNMPEnabledTraps, receiveModulationModeDetail=receiveModulationModeDetail, notificationsGroup=notificationsGroup, telecomsLineCode=telecomsLineCode, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, encryption=encryption, managementGroup=managementGroup, linkName=linkName, groupID=groupID, tFTPServerPortNumber=tFTPServerPortNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transmitFreqMHz=transmitFreqMHz, pubStatsGroup=pubStatsGroup, receiveFreqMHz=receiveFreqMHz, sNTPSync=sNTPSync, receiveFreqKHz=receiveFreqKHz, accessMethod=accessMethod, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, altitude=altitude, telecomGroup=telecomGroup, installStatus=installStatus, gatewayIPAddress=gatewayIPAddress, hTTPPortNumber=hTTPPortNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dfsPeaks=dfsPeaks)
