...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", linkModeOptimizationMismatch=linkModeOptimizationMismatch, encryptionGroup=encryptionGroup, longitude=longitude, telecomGroup=telecomGroup, subnetMask=subnetMask, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkLoss=linkLoss, sNTPSync=sNTPSync, bootVersion=bootVersion, dfsGroup=dfsGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, productName=productName, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, frequencyVariant=frequencyVariant, ptmp=ptmp, sntpGroup=sntpGroup, tDDSynchronizationMode=tDDSynchronizationMode, dataPortStatus=dataPortStatus, tFTPServerPortNumber=tFTPServerPortNumber, sMTPServerPortNumber=sMTPServerPortNumber, sntp=sntp, receiveModulationModeDetail=receiveModulationModeDetail, vLANManagementPriority=vLANManagementPriority, siteName=siteName, vLANManagementVID=vLANManagementVID, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapTableIndex=sNMPTrapTableIndex, capacityLicenseMismatch=capacityLicenseMismatch, ptp=ptp, receiveFreqKHz=receiveFreqKHz, syslogClientTrap=syslogClientTrap, sNMPTrapVersion=sNMPTrapVersion, incompatibleMasterAndSlave=incompatibleMasterAndSlave, remoteMaximumTransmitPower=remoteMaximumTransmitPower, syslogState=syslogState, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, secondarySoftwareVersion=secondarySoftwareVersion, sNMPCommunityString=sNMPCommunityString, installArmState=installArmState, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dfsTableNumber=dfsTableNumber, softwareVersion=softwareVersion, configuration=configuration, smtp=smtp, licence=licence, transmitChannel=transmitChannel, tDDSynchronizationStatus=tDDSynchronizationStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, versions=versions, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, cableLoss=cableLoss, iPAddress=iPAddress, syslogStateTrap=syslogStateTrap, versionsGroup=versionsGroup, receiveChannel=receiveChannel, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, eIRP=eIRP, hTTPSPortNumber=hTTPSPortNumber, encryptionAlgorithm=encryptionAlgorithm, ptpGroups=ptpGroups, dataPortStatusTrap=dataPortStatusTrap, aggregateDataRate=aggregateDataRate, sNMPTrapTableEntry=sNMPTrapTableEntry, telnetPortNumber=telnetPortNumber, dfsPeaks=dfsPeaks, dfs=dfs, searchState=searchState, telecomsLoopbackTrap=telecomsLoopbackTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, telecomsChannelStatus=telecomsChannelStatus, targetMACAddress=targetMACAddress, groupID=groupID, supplementaryGroup=supplementaryGroup, regionCodeTrap=regionCodeTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, alarmsGroup=alarmsGroup, sNTPState=sNTPState, timeZone=timeZone, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, unitOutOfCalibration=unitOutOfCalibration, signalStrengthRatio=signalStrengthRatio, userTableNumber=userTableNumber, telecom=telecom, dfsTableEntry=dfsTableEntry, sNTPPollInterval=sNTPPollInterval, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptpTraps=ptpTraps, reset=reset, ethernet=ethernet, hTTPSAccessEnabled=hTTPSAccessEnabled, management=management, sMTPServerIPAddress=sMTPServerIPAddress, installStatusTrap=installStatusTrap, ptpTrapPrefix=ptpTrapPrefix, syslogControl=syslogControl, sNMPTrapPortNumber=sNMPTrapPortNumber, accessMethod=accessMethod, antennaGain=antennaGain, vectorError=vectorError, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, licensedCapacity=licensedCapacity, phyControlGroup=phyControlGroup, bandwidthVariant=bandwidthVariant, vLANPriorityTableIndex=vLANPriorityTableIndex, dataPortWirelessDownAlert=dataPortWirelessDownAlert, regionCode=regionCode, tDDSynchronizationAlarm=tDDSynchronizationAlarm, vLANPriorityTable=vLANPriorityTable, sMTPEnabledMessages=sMTPEnabledMessages, linkSymmetry=linkSymmetry, sMTPEmailAlert=sMTPEmailAlert, daylightSaving=daylightSaving, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tDDControlGroup=tDDControlGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, systemReset=systemReset, range=range, systemClock=systemClock, transmitDataRate=transmitDataRate, vLANPriorityTableNumber=vLANPriorityTableNumber, cambium=cambium, telecomsLineCode=telecomsLineCode, sNMPPortNumber=sNMPPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, phyStatus=phyStatus, dfsTableIndex=dfsTableIndex, phyControl=phyControl, dfsTable=dfsTable, ptp500=ptp500, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, channelBandwidth=channelBandwidth, dfsMeans=dfsMeans, telecomsInterface=telecomsInterface, snmpControl=snmpControl, licenceGroup=licenceGroup, ptpCompliance=ptpCompliance, sNMPTrapTable=sNMPTrapTable, smtpGroup=smtpGroup, syslogControlGroup=syslogControlGroup, transmitFreqKHz=transmitFreqKHz, dataPortDisabledWarning=dataPortDisabledWarning, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, userRole=userRole, sNTPSyncTrap=sNTPSyncTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, wirelessLinkStatus=wirelessLinkStatus, telecomsLoopback=telecomsLoopback, snmpControlGroup=snmpControlGroup, installStatus=installStatus, hTTPPortNumber=hTTPPortNumber, installArmStateTrap=installArmStateTrap, resetGroup=resetGroup, receiveFreqMHz=receiveFreqMHz, transmitFreqMHz=transmitFreqMHz, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitPower=transmitPower, hardwareVersion=hardwareVersion, pubStats=pubStats, vLANPriorityQueueMapping=vLANPriorityQueueMapping, channelChangeTrap=channelChangeTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, userTable=userTable, alarms=alarms, configurationGroup=configurationGroup, pubStatsGroup=pubStatsGroup, dataPortAutoMdix=dataPortAutoMdix, supplementary=supplementary, productVariant=productVariant, transmitModulationMode=transmitModulationMode, sNTPServerIPAddress=sNTPServerIPAddress, receivePower=receivePower, sNTPServerPortNumber=sNTPServerPortNumber, sNMPv3Enable=sNMPv3Enable, userPassword=userPassword, managementGroup=managementGroup, altitude=altitude, incompatibleRegionCodes=incompatibleRegionCodes, gatewayIPAddress=gatewayIPAddress, masterSlaveMode=masterSlaveMode, encryption=encryption, ethernetGroup=ethernetGroup, userName=userName, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, linkModeOptimisation=linkModeOptimisation, PYSNMP_MODULE_ID=cambium, receiveDataRate=receiveDataRate, telnetAccessEnabled=telnetAccessEnabled, byteErrorRatio=byteErrorRatio, userTableEntry=userTableEntry, sNTPLastSync=sNTPLastSync, latitude=latitude, notificationsGroup=notificationsGroup, tDDControl=tDDControl, linkName=linkName, receiveModulationMode=receiveModulationMode, vLANPriorityTableEntry=vLANPriorityTableEntry, wirelessLinkAvailability=wirelessLinkAvailability, aAAControl=aAAControl, telecomsCableLength=telecomsCableLength, syslogClient=syslogClient, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, aAAControlGroup=aAAControlGroup, maximumTransmitPower=maximumTransmitPower, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, hTTPAccessEnabled=hTTPAccessEnabled, userTableIndex=userTableIndex, remoteIPAddress=remoteIPAddress, userEnabled=userEnabled, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, telecomsChannelStatusTrap=telecomsChannelStatusTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ethernetFiberSupport=ethernetFiberSupport, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPServerIPAddress=tFTPServerIPAddress, phyStatusGroup=phyStatusGroup)
