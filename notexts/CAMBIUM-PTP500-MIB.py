...
iso, MibIdentifier, Counter32, Integer32, IpAddress, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ModuleIdentity, TimeTicks, Gauge32, Unsigned32, ObjectIdentity, Counter64, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "Counter32", "Integer32", "IpAddress", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ModuleIdentity", "TimeTicks", "Gauge32", "Unsigned32", "ObjectIdentity", "Counter64", "Bits")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", range=range, antennaGain=antennaGain, telecom=telecom, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, vLANPriorityTableNumber=vLANPriorityTableNumber, unitOutOfCalibration=unitOutOfCalibration, dataPortAutoNegotiation=dataPortAutoNegotiation, vLANPriorityQueueMapping=vLANPriorityQueueMapping, cableLoss=cableLoss, signalStrengthRatio=signalStrengthRatio, userTable=userTable, userRole=userRole, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptpCompliance=ptpCompliance, smtpGroup=smtpGroup, phyStatus=phyStatus, versionsGroup=versionsGroup, management=management, receiveModulationModeDetail=receiveModulationModeDetail, aAAControlGroup=aAAControlGroup, transmitPower=transmitPower, altitude=altitude, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, bootVersion=bootVersion, sNMPTrapTableEntry=sNMPTrapTableEntry, siteName=siteName, sNTPServerPortNumber=sNTPServerPortNumber, vectorError=vectorError, telecomsCableLength=telecomsCableLength, searchState=searchState, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, syslogControl=syslogControl, sMTPEnabledMessages=sMTPEnabledMessages, sNTPLastSync=sNTPLastSync, encryption=encryption, regionCodeTrap=regionCodeTrap, ptmp=ptmp, hTTPAccessEnabled=hTTPAccessEnabled, iPAddress=iPAddress, configuration=configuration, sNMPCommunityString=sNMPCommunityString, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, reset=reset, snmpControl=snmpControl, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPServerIPAddress=sNTPServerIPAddress, vLANManagementVID=vLANManagementVID, ptpGroups=ptpGroups, longitude=longitude, installStatus=installStatus, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, telecomsLoopbackTrap=telecomsLoopbackTrap, eIRP=eIRP, sMTPServerIPAddress=sMTPServerIPAddress, systemReset=systemReset, syslogClient=syslogClient, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPPollInterval=sNTPPollInterval, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, aggregateDataRate=aggregateDataRate, remoteIPAddress=remoteIPAddress, userName=userName, alarms=alarms, ethernetFiberSupport=ethernetFiberSupport, linkModeOptimisation=linkModeOptimisation, receivePower=receivePower, transmitFreqKHz=transmitFreqKHz, transmitDataRate=transmitDataRate, supplementaryGroup=supplementaryGroup, ethernet=ethernet, aAAControl=aAAControl, vLANPriorityTableEntry=vLANPriorityTableEntry, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPv3Enable=sNMPv3Enable, receiveModulationMode=receiveModulationMode, receiveChannel=receiveChannel, syslogLocalWrappedTrap=syslogLocalWrappedTrap, resetGroup=resetGroup, managementGroup=managementGroup, syslogClientTrap=syslogClientTrap, telecomsLoopback=telecomsLoopback, phyControlGroup=phyControlGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sntp=sntp, productVariant=productVariant, telnetPortNumber=telnetPortNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, linkLoss=linkLoss, receiveFreqKHz=receiveFreqKHz, installArmStateTrap=installArmStateTrap, sMTPServerPortNumber=sMTPServerPortNumber, maximumTransmitPower=maximumTransmitPower, groupID=groupID, noWirelessChannelAvailable=noWirelessChannelAvailable, encryptionAlgorithm=encryptionAlgorithm, snmpControlGroup=snmpControlGroup, ptp500=ptp500, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, channelBandwidth=channelBandwidth, pubStats=pubStats, dfsMeans=dfsMeans, incompatibleRegionCodes=incompatibleRegionCodes, versions=versions, telnetAccessEnabled=telnetAccessEnabled, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, phyControl=phyControl, sNTPSync=sNTPSync, targetMACAddress=targetMACAddress, configurationGroup=configurationGroup, licence=licence, transmitModulationMode=transmitModulationMode, regionCode=regionCode, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, linkSymmetry=linkSymmetry, sntpGroup=sntpGroup, tDDControlGroup=tDDControlGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, tDDSynchronizationStatus=tDDSynchronizationStatus, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, gatewayIPAddress=gatewayIPAddress, dfsGroup=dfsGroup, productName=productName, softwareVersion=softwareVersion, telecomsLineCode=telecomsLineCode, licenceGroup=licenceGroup, transmitFreqMHz=transmitFreqMHz, encryptionGroup=encryptionGroup, bandwidthVariant=bandwidthVariant, sNTPState=sNTPState, dataPortAutoMdix=dataPortAutoMdix, notificationsGroup=notificationsGroup, ptpTrapPrefix=ptpTrapPrefix, userTableEntry=userTableEntry, frequencyVariant=frequencyVariant, sNMPTrapTable=sNMPTrapTable, wirelessLinkAvailability=wirelessLinkAvailability, telecomsChannelStatus=telecomsChannelStatus, systemClock=systemClock, ptp=ptp, syslogControlGroup=syslogControlGroup, accessMethod=accessMethod, sMTPSourceEmailAddress=sMTPSourceEmailAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, userTableIndex=userTableIndex, phyStatusGroup=phyStatusGroup, vLANManagementPriority=vLANManagementPriority, supplementary=supplementary, receiveDataRate=receiveDataRate, remoteMaximumTransmitPower=remoteMaximumTransmitPower, vLANPriorityTable=vLANPriorityTable, cambium=cambium, installArmState=installArmState, syslogStateTrap=syslogStateTrap, dfsPeaks=dfsPeaks, latitude=latitude, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, PYSNMP_MODULE_ID=cambium, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapTableNumber=sNMPTrapTableNumber, masterSlaveMode=masterSlaveMode, userPassword=userPassword, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sMTPEmailAlert=sMTPEmailAlert, telecomsInterface=telecomsInterface, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, telecomGroup=telecomGroup, timeZone=timeZone, alarmsGroup=alarmsGroup, dataPortDisabledWarning=dataPortDisabledWarning, ethernetGroup=ethernetGroup, capacityLicenseMismatch=capacityLicenseMismatch, dfs=dfs, subnetMask=subnetMask, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, channelChangeTrap=channelChangeTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, syslogState=syslogState, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, linkName=linkName, dataPortWirelessDownAlert=dataPortWirelessDownAlert, constantPowerSpectralDensity=constantPowerSpectralDensity, dfsTableIndex=dfsTableIndex, smtp=smtp, pubStatsGroup=pubStatsGroup, byteErrorRatio=byteErrorRatio, userTableNumber=userTableNumber, tDDControl=tDDControl, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, secondarySoftwareVersion=secondarySoftwareVersion, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tDDSynchronizationMode=tDDSynchronizationMode, dfsTableEntry=dfsTableEntry, tFTPServerIPAddress=tFTPServerIPAddress, licensedCapacity=licensedCapacity, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receiveFreqMHz=receiveFreqMHz, enabledDiagnosticAlarms=enabledDiagnosticAlarms, hTTPPortNumber=hTTPPortNumber, daylightSaving=daylightSaving, dataPortConfigurationMismatch=dataPortConfigurationMismatch, userEnabled=userEnabled, hardwareVersion=hardwareVersion, dataPortStatus=dataPortStatus, dataPortStatusTrap=dataPortStatusTrap, sNTPSyncTrap=sNTPSyncTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNMPPortNumber=sNMPPortNumber, ptpTraps=ptpTraps, wirelessLinkStatus=wirelessLinkStatus, transmitChannel=transmitChannel, dfsTable=dfsTable, dfsTableNumber=dfsTableNumber, installStatusTrap=installStatusTrap, hTTPSPortNumber=hTTPSPortNumber)
