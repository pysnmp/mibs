...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", encryptionGroup=encryptionGroup, dfsMeans=dfsMeans, tFTPServerPortNumber=tFTPServerPortNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, siteName=siteName, versionsGroup=versionsGroup, productName=productName, alarms=alarms, sMTPEmailAlert=sMTPEmailAlert, sNTPLastSync=sNTPLastSync, telecomsLineCode=telecomsLineCode, transmitDataRate=transmitDataRate, telecomGroup=telecomGroup, secondarySoftwareVersion=secondarySoftwareVersion, syslogStateTrap=syslogStateTrap, userTable=userTable, range=range, hardwareVersion=hardwareVersion, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, wirelessLinkStatus=wirelessLinkStatus, receiveModulationMode=receiveModulationMode, gatewayIPAddress=gatewayIPAddress, installArmStateTrap=installArmStateTrap, dfsTableIndex=dfsTableIndex, softwareVersion=softwareVersion, channelChangeTrap=channelChangeTrap, phyStatusGroup=phyStatusGroup, sMTPServerPortNumber=sMTPServerPortNumber, dataPortDisabledWarning=dataPortDisabledWarning, vLANPriorityTable=vLANPriorityTable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, iPAddress=iPAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telecomsLoopbackTrap=telecomsLoopbackTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, remoteIPAddress=remoteIPAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, sMTPEnabledMessages=sMTPEnabledMessages, syslogClientTrap=syslogClientTrap, sMTPServerIPAddress=sMTPServerIPAddress, unitOutOfCalibration=unitOutOfCalibration, sNMPEnabledTraps=sNMPEnabledTraps, phyStatus=phyStatus, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ptpTraps=ptpTraps, ethernet=ethernet, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, hTTPSPortNumber=hTTPSPortNumber, dfsTableNumber=dfsTableNumber, versions=versions, ptpCompliance=ptpCompliance, hTTPSAccessEnabled=hTTPSAccessEnabled, management=management, encryption=encryption, subnetMask=subnetMask, snmpControlGroup=snmpControlGroup, telnetAccessEnabled=telnetAccessEnabled, PYSNMP_MODULE_ID=cambium, sNMPPortNumber=sNMPPortNumber, userPassword=userPassword, cambium=cambium, masterSlaveMode=masterSlaveMode, linkName=linkName, userTableIndex=userTableIndex, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, configurationGroup=configurationGroup, regionCode=regionCode, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, telecom=telecom, accessMethod=accessMethod, sNMPTrapTableNumber=sNMPTrapTableNumber, maximumTransmitPower=maximumTransmitPower, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, transmitFreqMHz=transmitFreqMHz, licenceGroup=licenceGroup, ptp500=ptp500, channelBandwidth=channelBandwidth, sNTPSyncTrap=sNTPSyncTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tDDControl=tDDControl, longitude=longitude, constantPowerSpectralDensity=constantPowerSpectralDensity, configuration=configuration, noWirelessChannelAvailable=noWirelessChannelAvailable, ptmp=ptmp, aAAControl=aAAControl, licence=licence, linkModeOptimizationMismatch=linkModeOptimizationMismatch, aggregateDataRate=aggregateDataRate, useVLANForManagementInterfaces=useVLANForManagementInterfaces, userName=userName, syslogState=syslogState, tDDSynchronizationMode=tDDSynchronizationMode, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dataPortStatus=dataPortStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dfs=dfs, userEnabled=userEnabled, receiveFreqKHz=receiveFreqKHz, vLANPriorityQueueMapping=vLANPriorityQueueMapping, productVariant=productVariant, ethernetGroup=ethernetGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, vLANPriorityTableIndex=vLANPriorityTableIndex, sntp=sntp, syslogClient=syslogClient, telecomsInterface=telecomsInterface, installArmState=installArmState, remoteMaximumTransmitPower=remoteMaximumTransmitPower, vectorError=vectorError, sNTPPollInterval=sNTPPollInterval, managementGroup=managementGroup, frequencyVariant=frequencyVariant, dfsTableEntry=dfsTableEntry, receiveFreqMHz=receiveFreqMHz, phyControl=phyControl, pubStats=pubStats, tDDControlGroup=tDDControlGroup, eIRP=eIRP, linkModeOptimisation=linkModeOptimisation, sNMPCommunityString=sNMPCommunityString, cableLoss=cableLoss, hTTPAccessEnabled=hTTPAccessEnabled, capacityLicenseMismatch=capacityLicenseMismatch, supplementaryGroup=supplementaryGroup, vLANManagementVID=vLANManagementVID, telecomsLoopback=telecomsLoopback, hTTPPortNumber=hTTPPortNumber, incompatibleRegionCodes=incompatibleRegionCodes, tDDSynchronizationStatus=tDDSynchronizationStatus, userRole=userRole, receivePower=receivePower, telecomsChannelStatusTrap=telecomsChannelStatusTrap, linkSymmetry=linkSymmetry, targetMACAddress=targetMACAddress, snmpControl=snmpControl, transmitFreqKHz=transmitFreqKHz, transmitModulationMode=transmitModulationMode, dataPortConfigurationMismatch=dataPortConfigurationMismatch, receiveDataRate=receiveDataRate, alarmsGroup=alarmsGroup, phyControlGroup=phyControlGroup, userTableEntry=userTableEntry, sNMPTrapPortNumber=sNMPTrapPortNumber, systemClock=systemClock, groupID=groupID, telecomsCableLength=telecomsCableLength, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, antennaGain=antennaGain, smtp=smtp, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, installStatus=installStatus, sNMPTrapVersion=sNMPTrapVersion, sNTPServerIPAddress=sNTPServerIPAddress, smtpGroup=smtpGroup, dfsPeaks=dfsPeaks, transmitChannel=transmitChannel, timeZone=timeZone, tFTPServerIPAddress=tFTPServerIPAddress, daylightSaving=daylightSaving, sNTPServerPortNumber=sNTPServerPortNumber, latitude=latitude, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dataPortAutoMdix=dataPortAutoMdix, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ptpTrapPrefix=ptpTrapPrefix, systemReset=systemReset, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dfsTable=dfsTable, receiveModulationModeDetail=receiveModulationModeDetail, searchState=searchState, incompatibleMasterAndSlave=incompatibleMasterAndSlave, telnetPortNumber=telnetPortNumber, notificationsGroup=notificationsGroup, bandwidthVariant=bandwidthVariant, sNMPTrapIPAddress=sNMPTrapIPAddress, dfsGroup=dfsGroup, pubStatsGroup=pubStatsGroup, resetGroup=resetGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNMPTrapTable=sNMPTrapTable, linkLoss=linkLoss, vLANManagementPriority=vLANManagementPriority, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, wirelessLinkAvailability=wirelessLinkAvailability, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transmitPower=transmitPower, receiveChannel=receiveChannel, dataPortAutoNegotiation=dataPortAutoNegotiation, ethernetFiberSupport=ethernetFiberSupport, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, ptpGroups=ptpGroups, ptp=ptp, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, sNTPState=sNTPState, sNTPSync=sNTPSync, aAAControlGroup=aAAControlGroup, byteErrorRatio=byteErrorRatio, licensedCapacity=licensedCapacity, sntpGroup=sntpGroup, dataPortStatusTrap=dataPortStatusTrap, syslogControl=syslogControl, supplementary=supplementary, tDDSynchronizationAlarm=tDDSynchronizationAlarm, altitude=altitude, signalStrengthRatio=signalStrengthRatio, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, reset=reset, bootVersion=bootVersion, encryptionAlgorithm=encryptionAlgorithm, syslogControlGroup=syslogControlGroup, sNMPv3Enable=sNMPv3Enable, userTableNumber=userTableNumber, telecomsChannelStatus=telecomsChannelStatus, regionCodeTrap=regionCodeTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, installStatusTrap=installStatusTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress)
