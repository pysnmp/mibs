...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPServerPortNumber=sNTPServerPortNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, range=range, phyControl=phyControl, linkName=linkName, receiveDataRate=receiveDataRate, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, accessMethod=accessMethod, ptpTraps=ptpTraps, gatewayIPAddress=gatewayIPAddress, telnetAccessEnabled=telnetAccessEnabled, ptmp=ptmp, dataPortAutoNegotiation=dataPortAutoNegotiation, wirelessLinkStatus=wirelessLinkStatus, dfsTableEntry=dfsTableEntry, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telecom=telecom, alarmsGroup=alarmsGroup, groupID=groupID, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPSyncTrap=sNTPSyncTrap, PYSNMP_MODULE_ID=cambium, encryptionGroup=encryptionGroup, ptpCompliance=ptpCompliance, supplementaryGroup=supplementaryGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptpTrapPrefix=ptpTrapPrefix, transmitFreqMHz=transmitFreqMHz, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, regionCodeTrap=regionCodeTrap, alarms=alarms, channelChangeTrap=channelChangeTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, sMTPServerIPAddress=sMTPServerIPAddress, ethernetGroup=ethernetGroup, vLANManagementVID=vLANManagementVID, incompatibleMasterAndSlave=incompatibleMasterAndSlave, userTableEntry=userTableEntry, sNTPPollInterval=sNTPPollInterval, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, receivePower=receivePower, sNMPTrapTable=sNMPTrapTable, useVLANForManagementInterfaces=useVLANForManagementInterfaces, receiveChannel=receiveChannel, transmitChannel=transmitChannel, transmitDataRate=transmitDataRate, sNMPTrapTableIndex=sNMPTrapTableIndex, hardwareVersion=hardwareVersion, dataPortWirelessDownAlert=dataPortWirelessDownAlert, regionCode=regionCode, syslogClient=syslogClient, tFTPServerIPAddress=tFTPServerIPAddress, hTTPAccessEnabled=hTTPAccessEnabled, syslogControlGroup=syslogControlGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tDDSynchronizationAlarm=tDDSynchronizationAlarm, remoteIPAddress=remoteIPAddress, productVariant=productVariant, aggregateDataRate=aggregateDataRate, telecomsLoopbackTrap=telecomsLoopbackTrap, dataPortStatus=dataPortStatus, managementGroup=managementGroup, resetGroup=resetGroup, searchState=searchState, vLANPriorityTableEntry=vLANPriorityTableEntry, phyStatusGroup=phyStatusGroup, softwareVersion=softwareVersion, sntpGroup=sntpGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNMPPortNumber=sNMPPortNumber, dfsTableNumber=dfsTableNumber, userEnabled=userEnabled, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, licenceGroup=licenceGroup, telecomsChannelStatusTrap=telecomsChannelStatusTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ethernet=ethernet, sNMPEnabledTraps=sNMPEnabledTraps, transmitPower=transmitPower, syslogState=syslogState, sMTPEnabledMessages=sMTPEnabledMessages, versions=versions, syslogControl=syslogControl, userPassword=userPassword, hTTPSAccessEnabled=hTTPSAccessEnabled, ptp500=ptp500, supplementary=supplementary, sNTPSync=sNTPSync, ptpGroups=ptpGroups, ptp=ptp, sNMPv3Enable=sNMPv3Enable, ethernetFiberSupport=ethernetFiberSupport, vectorError=vectorError, pubStatsGroup=pubStatsGroup, reset=reset, systemReset=systemReset, aAAControl=aAAControl, bootVersion=bootVersion, transmitFreqKHz=transmitFreqKHz, licensedCapacity=licensedCapacity, receiveModulationModeDetail=receiveModulationModeDetail, wirelessLinkAvailability=wirelessLinkAvailability, configuration=configuration, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, userTable=userTable, snmpControlGroup=snmpControlGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortAutoMdix=dataPortAutoMdix, userTableIndex=userTableIndex, masterSlaveMode=masterSlaveMode, management=management, receiveFreqKHz=receiveFreqKHz, dataPortDisabledWarning=dataPortDisabledWarning, vLANPriorityTable=vLANPriorityTable, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPTrapIPAddress=sNMPTrapIPAddress, telnetPortNumber=telnetPortNumber, vLANPriorityQueueMapping=vLANPriorityQueueMapping, notificationsGroup=notificationsGroup, snmpControl=snmpControl, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dfsMeans=dfsMeans, bandwidthVariant=bandwidthVariant, syslogStateTrap=syslogStateTrap, versionsGroup=versionsGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, receiveModulationMode=receiveModulationMode, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, iPAddress=iPAddress, syslogClientTrap=syslogClientTrap, maximumTransmitPower=maximumTransmitPower, telecomGroup=telecomGroup, pubStats=pubStats, installArmState=installArmState, systemClock=systemClock, installStatusTrap=installStatusTrap, dfs=dfs, productName=productName, dfsTable=dfsTable, subnetMask=subnetMask, sntp=sntp, unitOutOfCalibration=unitOutOfCalibration, telecomsLoopback=telecomsLoopback, signalStrengthRatio=signalStrengthRatio, sNMPTrapVersion=sNMPTrapVersion, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, frequencyVariant=frequencyVariant, longitude=longitude, sMTPServerPortNumber=sMTPServerPortNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, linkModeOptimizationMismatch=linkModeOptimizationMismatch, hTTPPortNumber=hTTPPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, incompatibleRegionCodes=incompatibleRegionCodes, daylightSaving=daylightSaving, sMTPEmailAlert=sMTPEmailAlert, sNTPLastSync=sNTPLastSync, receiveFreqMHz=receiveFreqMHz, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, latitude=latitude, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, smtpGroup=smtpGroup, telecomsChannelStatus=telecomsChannelStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, vLANPriorityTableIndex=vLANPriorityTableIndex, hTTPSPortNumber=hTTPSPortNumber, targetMACAddress=targetMACAddress, channelBandwidth=channelBandwidth, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPCommunityString=sNMPCommunityString, licence=licence, configurationGroup=configurationGroup, timeZone=timeZone, tDDControl=tDDControl, antennaGain=antennaGain, altitude=altitude, tDDControlGroup=tDDControlGroup, linkModeOptimisation=linkModeOptimisation, telecomsLineCode=telecomsLineCode, transmitModulationMode=transmitModulationMode, eIRP=eIRP, tDDSynchronizationMode=tDDSynchronizationMode, encryption=encryption, phyControlGroup=phyControlGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNTPServerIPAddress=sNTPServerIPAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortStatusTrap=dataPortStatusTrap, installStatus=installStatus, dfsPeaks=dfsPeaks, capacityLicenseMismatch=capacityLicenseMismatch, dfsTableIndex=dfsTableIndex, userRole=userRole, cableLoss=cableLoss, vLANManagementPriority=vLANManagementPriority, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, siteName=siteName, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, linkSymmetry=linkSymmetry, syslogLocalWrappedTrap=syslogLocalWrappedTrap, secondarySoftwareVersion=secondarySoftwareVersion, cambium=cambium, byteErrorRatio=byteErrorRatio, userTableNumber=userTableNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, encryptionAlgorithm=encryptionAlgorithm, sNMPTrapTableEntry=sNMPTrapTableEntry, aAAControlGroup=aAAControlGroup, telecomsInterface=telecomsInterface, linkLoss=linkLoss, userName=userName, sNTPState=sNTPState, tFTPServerPortNumber=tFTPServerPortNumber, phyStatus=phyStatus, telecomsCableLength=telecomsCableLength, sMTPSourceEmailAddress=sMTPSourceEmailAddress, installArmStateTrap=installArmStateTrap, smtp=smtp, dfsGroup=dfsGroup)
