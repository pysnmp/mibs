...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", dataPortAutoNegotiation=dataPortAutoNegotiation, aAAControlGroup=aAAControlGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, signalStrengthRatio=signalStrengthRatio, phyStatusGroup=phyStatusGroup, configurationGroup=configurationGroup, transmitFreqMHz=transmitFreqMHz, sNMPCommunityString=sNMPCommunityString, alarms=alarms, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, receiveModulationMode=receiveModulationMode, syslogControl=syslogControl, frequencyVariant=frequencyVariant, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dfsGroup=dfsGroup, telecomsLineCode=telecomsLineCode, ethernetFiberSupport=ethernetFiberSupport, receiveChannel=receiveChannel, sNMPTrapPortNumber=sNMPTrapPortNumber, masterSlaveMode=masterSlaveMode, dfsTable=dfsTable, syslogState=syslogState, smtpGroup=smtpGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receiveFreqMHz=receiveFreqMHz, sNMPTrapTableIndex=sNMPTrapTableIndex, userTableEntry=userTableEntry, versions=versions, systemClock=systemClock, daylightSaving=daylightSaving, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, iPAddress=iPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, vLANPriorityTable=vLANPriorityTable, byteErrorRatio=byteErrorRatio, enabledDiagnosticAlarms=enabledDiagnosticAlarms, incompatibleRegionCodes=incompatibleRegionCodes, sNMPTrapTableEntry=sNMPTrapTableEntry, vectorError=vectorError, syslogLocalWrappedTrap=syslogLocalWrappedTrap, timeZone=timeZone, constantPowerSpectralDensity=constantPowerSpectralDensity, vLANManagementPriority=vLANManagementPriority, syslogControlGroup=syslogControlGroup, regionCode=regionCode, unitOutOfCalibration=unitOutOfCalibration, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, linkModeOptimisation=linkModeOptimisation, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, ptpTraps=ptpTraps, productVariant=productVariant, linkSymmetry=linkSymmetry, telecomsChannelStatusTrap=telecomsChannelStatusTrap, antennaGain=antennaGain, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, alarmsGroup=alarmsGroup, sNTPSync=sNTPSync, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortWirelessDownAlert=dataPortWirelessDownAlert, linkModeOptimizationMismatch=linkModeOptimizationMismatch, latitude=latitude, dataPortConfigurationMismatch=dataPortConfigurationMismatch, hTTPSPortNumber=hTTPSPortNumber, PYSNMP_MODULE_ID=cambium, userTableIndex=userTableIndex, longitude=longitude, installStatusTrap=installStatusTrap, notificationsGroup=notificationsGroup, transmitPower=transmitPower, incompatibleMasterAndSlave=incompatibleMasterAndSlave, telecomsChannelStatus=telecomsChannelStatus, groupID=groupID, productName=productName, telecomGroup=telecomGroup, cambium=cambium, ptpGroups=ptpGroups, tDDSynchronizationStatus=tDDSynchronizationStatus, capacityLicenseMismatch=capacityLicenseMismatch, pubStats=pubStats, cableLoss=cableLoss, secondarySoftwareVersion=secondarySoftwareVersion, syslogStateTrap=syslogStateTrap, sNTPState=sNTPState, dfsTableEntry=dfsTableEntry, encryptionGroup=encryptionGroup, linkLoss=linkLoss, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ptmp=ptmp, tFTPServerPortNumber=tFTPServerPortNumber, licenceGroup=licenceGroup, maximumTransmitPower=maximumTransmitPower, wirelessLinkStatus=wirelessLinkStatus, userEnabled=userEnabled, sNMPTrapIPAddress=sNMPTrapIPAddress, snmpControl=snmpControl, sntp=sntp, remoteIPAddress=remoteIPAddress, syslogClient=syslogClient, installStatus=installStatus, configuration=configuration, managementGroup=managementGroup, sNTPPollInterval=sNTPPollInterval, bootVersion=bootVersion, dfsPeaks=dfsPeaks, receiveFreqKHz=receiveFreqKHz, sMTPEnabledMessages=sMTPEnabledMessages, dfsTableNumber=dfsTableNumber, eIRP=eIRP, sNTPServerPortNumber=sNTPServerPortNumber, vLANPriorityTableNumber=vLANPriorityTableNumber, telecom=telecom, softwareVersion=softwareVersion, vLANPriorityTableEntry=vLANPriorityTableEntry, transmitDataRate=transmitDataRate, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tDDSynchronizationMode=tDDSynchronizationMode, sNMPTrapTable=sNMPTrapTable, vLANPriorityTableIndex=vLANPriorityTableIndex, tDDControl=tDDControl, sNMPTrapVersion=sNMPTrapVersion, resetGroup=resetGroup, gatewayIPAddress=gatewayIPAddress, installArmState=installArmState, transmitChannel=transmitChannel, syslogClientTrap=syslogClientTrap, supplementary=supplementary, ptp=ptp, licensedCapacity=licensedCapacity, transmitFreqKHz=transmitFreqKHz, wirelessLinkAvailability=wirelessLinkAvailability, sntpGroup=sntpGroup, dfsMeans=dfsMeans, sMTPServerIPAddress=sMTPServerIPAddress, userPassword=userPassword, transmitModulationMode=transmitModulationMode, sMTPServerPortNumber=sMTPServerPortNumber, aAAControl=aAAControl, tDDControlGroup=tDDControlGroup, dataPortDisabledWarning=dataPortDisabledWarning, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dfsTableIndex=dfsTableIndex, siteName=siteName, tFTPServerIPAddress=tFTPServerIPAddress, telecomsCableLength=telecomsCableLength, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, range=range, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, channelBandwidth=channelBandwidth, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, pubStatsGroup=pubStatsGroup, telnetAccessEnabled=telnetAccessEnabled, userTable=userTable, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, receivePower=receivePower, management=management, hTTPAccessEnabled=hTTPAccessEnabled, searchState=searchState, sNTPServerIPAddress=sNTPServerIPAddress, systemReset=systemReset, encryptionAlgorithm=encryptionAlgorithm, telnetPortNumber=telnetPortNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, channelChangeTrap=channelChangeTrap, accessMethod=accessMethod, hTTPSAccessEnabled=hTTPSAccessEnabled, supplementaryGroup=supplementaryGroup, licence=licence, reset=reset, sMTPEmailAlert=sMTPEmailAlert, regionCodeTrap=regionCodeTrap, telecomsLoopback=telecomsLoopback, receiveModulationModeDetail=receiveModulationModeDetail, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, smtp=smtp, bandwidthVariant=bandwidthVariant, phyControlGroup=phyControlGroup, phyStatus=phyStatus, ptpCompliance=ptpCompliance, sNMPEnabledTraps=sNMPEnabledTraps, telecomsLoopbackTrap=telecomsLoopbackTrap, installArmStateTrap=installArmStateTrap, sNTPSyncTrap=sNTPSyncTrap, phyControl=phyControl, hTTPPortNumber=hTTPPortNumber, sNTPLastSync=sNTPLastSync, ptp500=ptp500, vLANManagementVID=vLANManagementVID, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, encryption=encryption, dataPortStatus=dataPortStatus, snmpControlGroup=snmpControlGroup, receiveDataRate=receiveDataRate, userName=userName, sMTPSourceEmailAddress=sMTPSourceEmailAddress, vLANPriorityQueueMapping=vLANPriorityQueueMapping, dataPortAutoMdix=dataPortAutoMdix, userRole=userRole, ethernetGroup=ethernetGroup, sNMPv3Enable=sNMPv3Enable, versionsGroup=versionsGroup, dfs=dfs, ethernet=ethernet, userTableNumber=userTableNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, targetMACAddress=targetMACAddress, ptpTrapPrefix=ptpTrapPrefix, sNMPPortNumber=sNMPPortNumber, dataPortStatusTrap=dataPortStatusTrap, linkName=linkName, sNMPTrapTableNumber=sNMPTrapTableNumber, subnetMask=subnetMask, hardwareVersion=hardwareVersion, telecomsInterface=telecomsInterface, aggregateDataRate=aggregateDataRate, altitude=altitude, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex)
