...
# Produced by pysmi-1.1.3 at Sun Nov 28 14:22:34 2021
...
IpAddress, Counter64, MibIdentifier, enterprises, Gauge32, Unsigned32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, Bits, ModuleIdentity, TimeTicks, ObjectIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter64", "MibIdentifier", "enterprises", "Gauge32", "Unsigned32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "Bits", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "NotificationType")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", management=management, dfsPeaks=dfsPeaks, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNMPv3Enable=sNMPv3Enable, byteErrorRatio=byteErrorRatio, sNMPTrapTableIndex=sNMPTrapTableIndex, subnetMask=subnetMask, enabledDiagnosticAlarms=enabledDiagnosticAlarms, userTableEntry=userTableEntry, transmitFreqKHz=transmitFreqKHz, sNTPSync=sNTPSync, longitude=longitude, sNMPTrapTable=sNMPTrapTable, sNTPLastSync=sNTPLastSync, regionCodeTrap=regionCodeTrap, unitOutOfCalibration=unitOutOfCalibration, supplementary=supplementary, dfs=dfs, channelBandwidth=channelBandwidth, antennaGain=antennaGain, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, remoteIPAddress=remoteIPAddress, hTTPSPortNumber=hTTPSPortNumber, dfsTableNumber=dfsTableNumber, installStatusTrap=installStatusTrap, incompatibleRegionCodes=incompatibleRegionCodes, daylightSaving=daylightSaving, hardwareVersion=hardwareVersion, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPEnabledTraps=sNMPEnabledTraps, configuration=configuration, linkModeOptimisation=linkModeOptimisation, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, installArmStateTrap=installArmStateTrap, ptpCompliance=ptpCompliance, linkSymmetry=linkSymmetry, hTTPAccessEnabled=hTTPAccessEnabled, encryption=encryption, sNTPSyncTrap=sNTPSyncTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, snmpControlGroup=snmpControlGroup, transmitChannel=transmitChannel, dfsGroup=dfsGroup, hTTPPortNumber=hTTPPortNumber, telecomsLineCode=telecomsLineCode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ptpGroups=ptpGroups, aAAControlGroup=aAAControlGroup, signalStrengthRatio=signalStrengthRatio, receiveModulationModeDetail=receiveModulationModeDetail, userName=userName, dataPortStatus=dataPortStatus, reset=reset, versionsGroup=versionsGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, syslogStateTrap=syslogStateTrap, maximumTransmitPower=maximumTransmitPower, sNMPTrapVersion=sNMPTrapVersion, linkLoss=linkLoss, latitude=latitude, ptmp=ptmp, sNMPCommunityString=sNMPCommunityString, tDDSynchronizationStatus=tDDSynchronizationStatus, userTableIndex=userTableIndex, userRole=userRole, cambium=cambium, sMTPEmailAlert=sMTPEmailAlert, dataPortStatusTrap=dataPortStatusTrap, sNTPServerPortNumber=sNTPServerPortNumber, accessMethod=accessMethod, sNTPState=sNTPState, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, wirelessLinkAvailability=wirelessLinkAvailability, gatewayIPAddress=gatewayIPAddress, receiveDataRate=receiveDataRate, productVariant=productVariant, versions=versions, remoteMaximumTransmitPower=remoteMaximumTransmitPower, licenceGroup=licenceGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, telecomsCableLength=telecomsCableLength, vLANManagementVID=vLANManagementVID, sNMPTrapTableNumber=sNMPTrapTableNumber, systemReset=systemReset, supplementaryGroup=supplementaryGroup, sMTPServerIPAddress=sMTPServerIPAddress, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, licence=licence, userTableNumber=userTableNumber, masterSlaveMode=masterSlaveMode, receiveModulationMode=receiveModulationMode, userPassword=userPassword, phyStatus=phyStatus, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, syslogControlGroup=syslogControlGroup, telecomsLoopback=telecomsLoopback, searchState=searchState, dataPortAutoNegotiation=dataPortAutoNegotiation, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, targetMACAddress=targetMACAddress, transmitFreqMHz=transmitFreqMHz, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, encryptionAlgorithm=encryptionAlgorithm, telnetAccessEnabled=telnetAccessEnabled, dfsTableEntry=dfsTableEntry, secondarySoftwareVersion=secondarySoftwareVersion, vLANPriorityTable=vLANPriorityTable, sntp=sntp, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortAutoMdix=dataPortAutoMdix, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, licensedCapacity=licensedCapacity, regionCode=regionCode, linkModeOptimizationMismatch=linkModeOptimizationMismatch, vLANPriorityTableEntry=vLANPriorityTableEntry, receivePower=receivePower, transmitModulationMode=transmitModulationMode, sNTPPollInterval=sNTPPollInterval, alarms=alarms, frequencyVariant=frequencyVariant, capacityLicenseMismatch=capacityLicenseMismatch, hTTPSAccessEnabled=hTTPSAccessEnabled, configurationGroup=configurationGroup, vLANManagementPriority=vLANManagementPriority, telecomsChannelStatusTrap=telecomsChannelStatusTrap, eIRP=eIRP, sNMPTrapIPAddress=sNMPTrapIPAddress, dfsMeans=dfsMeans, ptp=ptp, installArmState=installArmState, iPAddress=iPAddress, productName=productName, userEnabled=userEnabled, dataPortWirelessDownAlert=dataPortWirelessDownAlert, pubStats=pubStats, dataPortDisabledWarning=dataPortDisabledWarning, smtpGroup=smtpGroup, telecom=telecom, aggregateDataRate=aggregateDataRate, syslogLocalWrappedTrap=syslogLocalWrappedTrap, syslogClientTrap=syslogClientTrap, ethernet=ethernet, vLANPriorityQueueMapping=vLANPriorityQueueMapping, vectorError=vectorError, tFTPServerPortNumber=tFTPServerPortNumber, receiveFreqKHz=receiveFreqKHz, tDDSynchronizationAlarm=tDDSynchronizationAlarm, bandwidthVariant=bandwidthVariant, wirelessLinkStatus=wirelessLinkStatus, tFTPServerIPAddress=tFTPServerIPAddress, smtp=smtp, pubStatsGroup=pubStatsGroup, telnetPortNumber=telnetPortNumber, notificationsGroup=notificationsGroup, ptp500=ptp500, softwareVersion=softwareVersion, installStatus=installStatus, tDDSynchronizationMode=tDDSynchronizationMode, sNTPServerIPAddress=sNTPServerIPAddress, telecomsInterface=telecomsInterface, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, userTable=userTable, tDDControl=tDDControl, aAAControl=aAAControl, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, bootVersion=bootVersion, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, systemClock=systemClock, alarmsGroup=alarmsGroup, syslogClient=syslogClient, siteName=siteName, channelChangeTrap=channelChangeTrap, sMTPServerPortNumber=sMTPServerPortNumber, telecomsChannelStatus=telecomsChannelStatus, encryptionGroup=encryptionGroup, phyControlGroup=phyControlGroup, ethernetFiberSupport=ethernetFiberSupport, managementGroup=managementGroup, snmpControl=snmpControl, telecomGroup=telecomGroup, receiveFreqMHz=receiveFreqMHz, altitude=altitude, dfsTable=dfsTable, dataPortConfigurationMismatch=dataPortConfigurationMismatch, vLANPriorityTableNumber=vLANPriorityTableNumber, range=range, transmitPower=transmitPower, sntpGroup=sntpGroup, receiveChannel=receiveChannel, ptpTraps=ptpTraps, phyControl=phyControl, syslogControl=syslogControl, resetGroup=resetGroup, groupID=groupID, tDDControlGroup=tDDControlGroup, PYSNMP_MODULE_ID=cambium, constantPowerSpectralDensity=constantPowerSpectralDensity, syslogState=syslogState, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, timeZone=timeZone, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, cableLoss=cableLoss, linkName=linkName, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ptpTrapPrefix=ptpTrapPrefix, sMTPEnabledMessages=sMTPEnabledMessages, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, phyStatusGroup=phyStatusGroup, ethernetGroup=ethernetGroup, sNMPPortNumber=sNMPPortNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPTrapTableEntry=sNMPTrapTableEntry, dfsTableIndex=dfsTableIndex, transmitDataRate=transmitDataRate)
