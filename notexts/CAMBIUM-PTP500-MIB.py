...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", linkName=linkName, ptp=ptp, eIRP=eIRP, receiveChannel=receiveChannel, hTTPAccessEnabled=hTTPAccessEnabled, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sntp=sntp, versions=versions, dfsTableIndex=dfsTableIndex, tDDSynchronizationMode=tDDSynchronizationMode, cableLoss=cableLoss, capacityLicenseMismatch=capacityLicenseMismatch, noWirelessChannelAvailable=noWirelessChannelAvailable, dfsTableEntry=dfsTableEntry, groupID=groupID, receiveFreqMHz=receiveFreqMHz, searchState=searchState, configurationGroup=configurationGroup, sNTPPollInterval=sNTPPollInterval, telecomsLoopbackTrap=telecomsLoopbackTrap, sNMPv3Enable=sNMPv3Enable, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsTable=dfsTable, sNMPTrapTableNumber=sNMPTrapTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, altitude=altitude, smtp=smtp, dfsMeans=dfsMeans, transmitModulationMode=transmitModulationMode, sNTPState=sNTPState, telecomGroup=telecomGroup, ptpTrapPrefix=ptpTrapPrefix, incompatibleRegionCodes=incompatibleRegionCodes, transmitDataRate=transmitDataRate, tDDSynchronizationStatus=tDDSynchronizationStatus, supplementary=supplementary, hTTPPortNumber=hTTPPortNumber, cambium=cambium, ptmp=ptmp, masterSlaveMode=masterSlaveMode, ethernet=ethernet, transmitFreqMHz=transmitFreqMHz, sNMPTrapPortNumber=sNMPTrapPortNumber, receiveModulationModeDetail=receiveModulationModeDetail, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sMTPServerPortNumber=sMTPServerPortNumber, transmitFreqKHz=transmitFreqKHz, sNTPLastSync=sNTPLastSync, snmpControlGroup=snmpControlGroup, syslogClientTrap=syslogClientTrap, ethernetGroup=ethernetGroup, userRole=userRole, signalStrengthRatio=signalStrengthRatio, userEnabled=userEnabled, vLANPriorityTableIndex=vLANPriorityTableIndex, syslogControl=syslogControl, telecomsLineCode=telecomsLineCode, tDDControl=tDDControl, remoteIPAddress=remoteIPAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, telecomsChannelStatus=telecomsChannelStatus, notificationsGroup=notificationsGroup, sNMPCommunityString=sNMPCommunityString, wirelessLinkAvailability=wirelessLinkAvailability, siteName=siteName, userPassword=userPassword, sMTPEnabledMessages=sMTPEnabledMessages, installArmStateTrap=installArmStateTrap, phyControl=phyControl, pubStatsGroup=pubStatsGroup, regionCode=regionCode, telecomsInterface=telecomsInterface, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, linkLoss=linkLoss, dataPortStatusTrap=dataPortStatusTrap, userTableEntry=userTableEntry, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapTable=sNMPTrapTable, installStatusTrap=installStatusTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, bandwidthVariant=bandwidthVariant, receiveDataRate=receiveDataRate, sNTPSync=sNTPSync, telecomsChannelStatusTrap=telecomsChannelStatusTrap, targetMACAddress=targetMACAddress, syslogControlGroup=syslogControlGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, unitOutOfCalibration=unitOutOfCalibration, latitude=latitude, receivePower=receivePower, ptp500=ptp500, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dataPortAutoMdix=dataPortAutoMdix, frequencyVariant=frequencyVariant, encryptionGroup=encryptionGroup, tFTPServerIPAddress=tFTPServerIPAddress, syslogState=syslogState, pubStats=pubStats, sntpGroup=sntpGroup, ptpGroups=ptpGroups, dfs=dfs, vLANManagementPriority=vLANManagementPriority, licensedCapacity=licensedCapacity, installArmState=installArmState, dataPortConfigurationMismatch=dataPortConfigurationMismatch, reset=reset, resetGroup=resetGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, wirelessLinkStatus=wirelessLinkStatus, licence=licence, sMTPServerIPAddress=sMTPServerIPAddress, sNMPPortNumber=sNMPPortNumber, bootVersion=bootVersion, telecom=telecom, ethernetFiberSupport=ethernetFiberSupport, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, PYSNMP_MODULE_ID=cambium, vLANPriorityTableEntry=vLANPriorityTableEntry, hTTPSPortNumber=hTTPSPortNumber, management=management, syslogStateTrap=syslogStateTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, alarms=alarms, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, supplementaryGroup=supplementaryGroup, linkSymmetry=linkSymmetry, hardwareVersion=hardwareVersion, userName=userName, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, aggregateDataRate=aggregateDataRate, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, phyControlGroup=phyControlGroup, smtpGroup=smtpGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, systemClock=systemClock, syslogClient=syslogClient, subnetMask=subnetMask, tDDControlGroup=tDDControlGroup, receiveFreqKHz=receiveFreqKHz, installStatus=installStatus, dataPortStatus=dataPortStatus, longitude=longitude, dfsGroup=dfsGroup, telecomsLoopback=telecomsLoopback, vLANPriorityQueueMapping=vLANPriorityQueueMapping, receiveModulationMode=receiveModulationMode, tFTPServerPortNumber=tFTPServerPortNumber, sNTPSyncTrap=sNTPSyncTrap, vectorError=vectorError, configuration=configuration, ptpTraps=ptpTraps, productName=productName, channelBandwidth=channelBandwidth, sNTPServerIPAddress=sNTPServerIPAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNMPTrapVersion=sNMPTrapVersion, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPEnabledTraps=sNMPEnabledTraps, encryption=encryption, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, timeZone=timeZone, softwareVersion=softwareVersion, userTable=userTable, telnetPortNumber=telnetPortNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, channelChangeTrap=channelChangeTrap, iPAddress=iPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, vLANManagementVID=vLANManagementVID, versionsGroup=versionsGroup, licenceGroup=licenceGroup, telecomsCableLength=telecomsCableLength, dfsPeaks=dfsPeaks, alarmsGroup=alarmsGroup, ptpCompliance=ptpCompliance, syslogLocalWrappedTrap=syslogLocalWrappedTrap, maximumTransmitPower=maximumTransmitPower, phyStatusGroup=phyStatusGroup, dfsTableNumber=dfsTableNumber, gatewayIPAddress=gatewayIPAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, antennaGain=antennaGain, userTableNumber=userTableNumber, systemReset=systemReset, sNMPTrapTableIndex=sNMPTrapTableIndex, snmpControl=snmpControl, telnetAccessEnabled=telnetAccessEnabled, transmitPower=transmitPower, aAAControl=aAAControl, hTTPSAccessEnabled=hTTPSAccessEnabled, aAAControlGroup=aAAControlGroup, vLANPriorityTable=vLANPriorityTable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, userTableIndex=userTableIndex, dataPortAutoNegotiation=dataPortAutoNegotiation, daylightSaving=daylightSaving, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, encryptionAlgorithm=encryptionAlgorithm, accessMethod=accessMethod, dataPortDisabledWarning=dataPortDisabledWarning, sNTPServerPortNumber=sNTPServerPortNumber, regionCodeTrap=regionCodeTrap, transmitChannel=transmitChannel, secondarySoftwareVersion=secondarySoftwareVersion, byteErrorRatio=byteErrorRatio, managementGroup=managementGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sMTPEmailAlert=sMTPEmailAlert, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, linkModeOptimisation=linkModeOptimisation, incompatibleMasterAndSlave=incompatibleMasterAndSlave, phyStatus=phyStatus, range=range, productVariant=productVariant, linkModeOptimizationMismatch=linkModeOptimizationMismatch)
