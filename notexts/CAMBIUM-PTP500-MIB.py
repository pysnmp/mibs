...
# Produced by pysmi-1.1.8 at Fri Jan  7 15:56:24 2022
...
NotificationType, IpAddress, iso, TimeTicks, Gauge32, ObjectIdentity, Bits, MibIdentifier, Counter32, Unsigned32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "iso", "TimeTicks", "Gauge32", "ObjectIdentity", "Bits", "MibIdentifier", "Counter32", "Unsigned32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, phyControl=phyControl, installStatusTrap=installStatusTrap, smtpGroup=smtpGroup, ptmp=ptmp, unitOutOfCalibration=unitOutOfCalibration, phyStatusGroup=phyStatusGroup, telecom=telecom, supplementary=supplementary, encryptionGroup=encryptionGroup, linkName=linkName, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, linkModeOptimisation=linkModeOptimisation, sNMPPortNumber=sNMPPortNumber, latitude=latitude, supplementaryGroup=supplementaryGroup, iPAddress=iPAddress, regionCodeTrap=regionCodeTrap, eIRP=eIRP, licensedCapacity=licensedCapacity, syslogStateTrap=syslogStateTrap, masterSlaveMode=masterSlaveMode, signalStrengthRatio=signalStrengthRatio, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNMPTrapIPAddress=sNMPTrapIPAddress, remoteIPAddress=remoteIPAddress, hTTPPortNumber=hTTPPortNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, linkModeOptimizationMismatch=linkModeOptimizationMismatch, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ptpGroups=ptpGroups, transmitModulationMode=transmitModulationMode, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, transmitPower=transmitPower, dfsGroup=dfsGroup, receiveModulationMode=receiveModulationMode, ethernet=ethernet, hTTPSPortNumber=hTTPSPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, phyStatus=phyStatus, licenceGroup=licenceGroup, channelChangeTrap=channelChangeTrap, ethernetGroup=ethernetGroup, hTTPAccessEnabled=hTTPAccessEnabled, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortStatusTrap=dataPortStatusTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, targetMACAddress=targetMACAddress, receiveModulationModeDetail=receiveModulationModeDetail, tDDSynchronizationStatus=tDDSynchronizationStatus, dataPortDisabledWarning=dataPortDisabledWarning, sNTPPollInterval=sNTPPollInterval, userName=userName, vLANPriorityTableEntry=vLANPriorityTableEntry, tFTPServerIPAddress=tFTPServerIPAddress, productName=productName, userEnabled=userEnabled, dfsPeaks=dfsPeaks, dataPortAutoMdix=dataPortAutoMdix, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapTableIndex=sNMPTrapTableIndex, telecomsChannelStatusTrap=telecomsChannelStatusTrap, managementGroup=managementGroup, linkSymmetry=linkSymmetry, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNTPServerIPAddress=sNTPServerIPAddress, vLANManagementVID=vLANManagementVID, constantPowerSpectralDensity=constantPowerSpectralDensity, tDDSynchronizationMode=tDDSynchronizationMode, transmitFreqKHz=transmitFreqKHz, groupID=groupID, sNMPTrapTableNumber=sNMPTrapTableNumber, telnetAccessEnabled=telnetAccessEnabled, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, byteErrorRatio=byteErrorRatio, longitude=longitude, installArmState=installArmState, userTable=userTable, bootVersion=bootVersion, dfsTable=dfsTable, ptpTraps=ptpTraps, maximumTransmitPower=maximumTransmitPower, tDDControl=tDDControl, syslogLocalWrappedTrap=syslogLocalWrappedTrap, management=management, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, wirelessLinkAvailability=wirelessLinkAvailability, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, accessMethod=accessMethod, smtp=smtp, dfsTableIndex=dfsTableIndex, sMTPSourceEmailAddress=sMTPSourceEmailAddress, bandwidthVariant=bandwidthVariant, capacityLicenseMismatch=capacityLicenseMismatch, notificationsGroup=notificationsGroup, syslogClientTrap=syslogClientTrap, wirelessLinkStatus=wirelessLinkStatus, incompatibleRegionCodes=incompatibleRegionCodes, receiveChannel=receiveChannel, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dfsTableNumber=dfsTableNumber, softwareVersion=softwareVersion, tFTPServerPortNumber=tFTPServerPortNumber, sNTPLastSync=sNTPLastSync, ptpTrapPrefix=ptpTrapPrefix, transmitFreqMHz=transmitFreqMHz, encryptionAlgorithm=encryptionAlgorithm, vectorError=vectorError, installArmStateTrap=installArmStateTrap, gatewayIPAddress=gatewayIPAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, receiveDataRate=receiveDataRate, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, resetGroup=resetGroup, snmpControl=snmpControl, vLANPriorityQueueMapping=vLANPriorityQueueMapping, telecomsInterface=telecomsInterface, reset=reset, sntpGroup=sntpGroup, transmitDataRate=transmitDataRate, regionCode=regionCode, sNMPEnabledTraps=sNMPEnabledTraps, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, telecomsLoopbackTrap=telecomsLoopbackTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, systemReset=systemReset, antennaGain=antennaGain, sNMPTrapTable=sNMPTrapTable, receiveFreqKHz=receiveFreqKHz, installStatus=installStatus, phyControlGroup=phyControlGroup, configuration=configuration, userTableNumber=userTableNumber, transmitChannel=transmitChannel, sMTPEmailAlert=sMTPEmailAlert, dfs=dfs, syslogControl=syslogControl, alarmsGroup=alarmsGroup, sNMPv3Enable=sNMPv3Enable, aAAControlGroup=aAAControlGroup, alarms=alarms, pubStats=pubStats, telecomsCableLength=telecomsCableLength, systemClock=systemClock, userPassword=userPassword, subnetMask=subnetMask, ptp500=ptp500, cableLoss=cableLoss, telecomsChannelStatus=telecomsChannelStatus, cambium=cambium, timeZone=timeZone, telnetPortNumber=telnetPortNumber, sMTPServerPortNumber=sMTPServerPortNumber, ptpCompliance=ptpCompliance, vLANManagementPriority=vLANManagementPriority, encryption=encryption, telecomsLineCode=telecomsLineCode, versionsGroup=versionsGroup, userTableIndex=userTableIndex, syslogClient=syslogClient, altitude=altitude, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapTableEntry=sNMPTrapTableEntry, secondarySoftwareVersion=secondarySoftwareVersion, syslogControlGroup=syslogControlGroup, dfsMeans=dfsMeans, siteName=siteName, sMTPServerIPAddress=sMTPServerIPAddress, vLANPriorityTable=vLANPriorityTable, receivePower=receivePower, dataPortConfigurationMismatch=dataPortConfigurationMismatch, snmpControlGroup=snmpControlGroup, ptp=ptp, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, userTableEntry=userTableEntry, sNTPServerPortNumber=sNTPServerPortNumber, sNMPCommunityString=sNMPCommunityString, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, searchState=searchState, configurationGroup=configurationGroup, channelBandwidth=channelBandwidth, frequencyVariant=frequencyVariant, sNTPState=sNTPState, PYSNMP_MODULE_ID=cambium, tDDControlGroup=tDDControlGroup, telecomsLoopback=telecomsLoopback, receiveFreqMHz=receiveFreqMHz, licence=licence, aggregateDataRate=aggregateDataRate, sntp=sntp, versions=versions, hTTPSAccessEnabled=hTTPSAccessEnabled, range=range, sNTPSync=sNTPSync, daylightSaving=daylightSaving, userRole=userRole, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPEnabledMessages=sMTPEnabledMessages, dfsTableEntry=dfsTableEntry, vLANPriorityTableNumber=vLANPriorityTableNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, linkLoss=linkLoss, aAAControl=aAAControl, incompatibleMasterAndSlave=incompatibleMasterAndSlave, syslogState=syslogState, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, hardwareVersion=hardwareVersion, pubStatsGroup=pubStatsGroup, telecomGroup=telecomGroup, ethernetFiberSupport=ethernetFiberSupport, dataPortStatus=dataPortStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, vLANPriorityTableIndex=vLANPriorityTableIndex, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, productVariant=productVariant, sNTPSyncTrap=sNTPSyncTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortAutoNegotiation=dataPortAutoNegotiation, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNMPTrapVersion=sNMPTrapVersion)
