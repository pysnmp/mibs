...
# Produced by pysmi-1.1.3 at Sat Nov 20 16:49:31 2021
...
MibIdentifier, Counter64, Bits, TimeTicks, Integer32, NotificationType, Unsigned32, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Gauge32, enterprises, Counter32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter64", "Bits", "TimeTicks", "Integer32", "NotificationType", "Unsigned32", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Gauge32", "enterprises", "Counter32", "ObjectIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", byteErrorRatio=byteErrorRatio, searchState=searchState, altitude=altitude, sNMPTrapTable=sNMPTrapTable, vLANPriorityTableNumber=vLANPriorityTableNumber, smtp=smtp, productVariant=productVariant, tDDControl=tDDControl, licence=licence, licensedCapacity=licensedCapacity, versions=versions, sNMPTrapTableIndex=sNMPTrapTableIndex, bootVersion=bootVersion, incompatibleMasterAndSlave=incompatibleMasterAndSlave, maximumTransmitPower=maximumTransmitPower, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, telecomsChannelStatusTrap=telecomsChannelStatusTrap, wirelessLinkAvailability=wirelessLinkAvailability, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ptp=ptp, bandwidthVariant=bandwidthVariant, dataPortStatusTrap=dataPortStatusTrap, dfsPeaks=dfsPeaks, vLANPriorityTable=vLANPriorityTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, receiveModulationModeDetail=receiveModulationModeDetail, noWirelessChannelAvailable=noWirelessChannelAvailable, systemReset=systemReset, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogClientTrap=syslogClientTrap, sMTPServerPortNumber=sMTPServerPortNumber, syslogClient=syslogClient, regionCode=regionCode, dfsGroup=dfsGroup, transmitPower=transmitPower, siteName=siteName, installArmState=installArmState, syslogControl=syslogControl, tDDSynchronizationMode=tDDSynchronizationMode, masterSlaveMode=masterSlaveMode, sNMPv3Enable=sNMPv3Enable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, systemClock=systemClock, linkName=linkName, hTTPAccessEnabled=hTTPAccessEnabled, dfs=dfs, tDDSynchronizationStatus=tDDSynchronizationStatus, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, accessMethod=accessMethod, sNMPPortNumber=sNMPPortNumber, userTableNumber=userTableNumber, receiveFreqMHz=receiveFreqMHz, timeZone=timeZone, linkSymmetry=linkSymmetry, smtpGroup=smtpGroup, wirelessLinkStatus=wirelessLinkStatus, dfsTableEntry=dfsTableEntry, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, configurationGroup=configurationGroup, syslogState=syslogState, ethernetGroup=ethernetGroup, telecomsInterface=telecomsInterface, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfsMeans=dfsMeans, pubStats=pubStats, telnetAccessEnabled=telnetAccessEnabled, receiveFreqKHz=receiveFreqKHz, userTable=userTable, ptp500=ptp500, managementGroup=managementGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, versionsGroup=versionsGroup, notificationsGroup=notificationsGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, softwareVersion=softwareVersion, ptpTrapPrefix=ptpTrapPrefix, ptpCompliance=ptpCompliance, dataPortConfigurationMismatch=dataPortConfigurationMismatch, vLANManagementPriority=vLANManagementPriority, userEnabled=userEnabled, incompatibleRegionCodes=incompatibleRegionCodes, vLANPriorityTableIndex=vLANPriorityTableIndex, vectorError=vectorError, encryptionGroup=encryptionGroup, aAAControlGroup=aAAControlGroup, daylightSaving=daylightSaving, targetMACAddress=targetMACAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, gatewayIPAddress=gatewayIPAddress, sntpGroup=sntpGroup, sNMPTrapVersion=sNMPTrapVersion, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, regionCodeTrap=regionCodeTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, installStatus=installStatus, ptpGroups=ptpGroups, antennaGain=antennaGain, userTableIndex=userTableIndex, dataPortDisabledWarning=dataPortDisabledWarning, tDDControlGroup=tDDControlGroup, sMTPEmailAlert=sMTPEmailAlert, receiveChannel=receiveChannel, installArmStateTrap=installArmStateTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, latitude=latitude, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsTableNumber=dfsTableNumber, aggregateDataRate=aggregateDataRate, longitude=longitude, pubStatsGroup=pubStatsGroup, subnetMask=subnetMask, groupID=groupID, telnetPortNumber=telnetPortNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPState=sNTPState, hardwareVersion=hardwareVersion, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tFTPServerIPAddress=tFTPServerIPAddress, reset=reset, telecomGroup=telecomGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, capacityLicenseMismatch=capacityLicenseMismatch, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, vLANManagementVID=vLANManagementVID, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPServerIPAddress=sNTPServerIPAddress, encryption=encryption, signalStrengthRatio=signalStrengthRatio, userTableEntry=userTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, PYSNMP_MODULE_ID=cambium, cambium=cambium, transmitFreqKHz=transmitFreqKHz, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPServerPortNumber=sNTPServerPortNumber, linkLoss=linkLoss, hTTPPortNumber=hTTPPortNumber, sntp=sntp, telecomsChannelStatus=telecomsChannelStatus, userPassword=userPassword, dfsTable=dfsTable, phyStatusGroup=phyStatusGroup, dataPortStatus=dataPortStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, linkModeOptimizationMismatch=linkModeOptimizationMismatch, channelBandwidth=channelBandwidth, alarms=alarms, sNMPEnabledTraps=sNMPEnabledTraps, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, resetGroup=resetGroup, receiveDataRate=receiveDataRate, eIRP=eIRP, syslogControlGroup=syslogControlGroup, transmitModulationMode=transmitModulationMode, sNTPSync=sNTPSync, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPLastSync=sNTPLastSync, installStatusTrap=installStatusTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, userName=userName, sNTPSyncTrap=sNTPSyncTrap, management=management, configuration=configuration, phyControl=phyControl, ptpTraps=ptpTraps, sNMPTrapTableNumber=sNMPTrapTableNumber, remoteIPAddress=remoteIPAddress, secondarySoftwareVersion=secondarySoftwareVersion, userRole=userRole, ptmp=ptmp, iPAddress=iPAddress, snmpControl=snmpControl, telecomsLineCode=telecomsLineCode, ethernetFiberSupport=ethernetFiberSupport, linkModeOptimisation=linkModeOptimisation, supplementary=supplementary, transmitDataRate=transmitDataRate, telecomsCableLength=telecomsCableLength, hTTPSPortNumber=hTTPSPortNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, unitOutOfCalibration=unitOutOfCalibration, cableLoss=cableLoss, hTTPSAccessEnabled=hTTPSAccessEnabled, tFTPServerPortNumber=tFTPServerPortNumber, sNTPPollInterval=sNTPPollInterval, phyControlGroup=phyControlGroup, sMTPEnabledMessages=sMTPEnabledMessages, telecom=telecom, aAAControl=aAAControl, snmpControlGroup=snmpControlGroup, telecomsLoopback=telecomsLoopback, frequencyVariant=frequencyVariant, constantPowerSpectralDensity=constantPowerSpectralDensity, dataPortAutoMdix=dataPortAutoMdix, vLANPriorityTableEntry=vLANPriorityTableEntry, alarmsGroup=alarmsGroup, supplementaryGroup=supplementaryGroup, productName=productName, phyStatus=phyStatus, dfsTableIndex=dfsTableIndex, vLANPriorityQueueMapping=vLANPriorityQueueMapping, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, licenceGroup=licenceGroup, ethernet=ethernet, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, encryptionAlgorithm=encryptionAlgorithm, syslogStateTrap=syslogStateTrap, sNMPCommunityString=sNMPCommunityString, sNMPTrapTableEntry=sNMPTrapTableEntry, telecomsLoopbackTrap=telecomsLoopbackTrap, channelChangeTrap=channelChangeTrap, range=range, receiveModulationMode=receiveModulationMode, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, transmitFreqMHz=transmitFreqMHz, transmitChannel=transmitChannel, receivePower=receivePower)
