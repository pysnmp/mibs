...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", pubStatsGroup=pubStatsGroup, phyStatus=phyStatus, masterSlaveMode=masterSlaveMode, sNMPPortNumber=sNMPPortNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, vLANPriorityTableEntry=vLANPriorityTableEntry, ptpTraps=ptpTraps, capacityLicenseMismatch=capacityLicenseMismatch, byteErrorRatio=byteErrorRatio, subnetMask=subnetMask, linkLoss=linkLoss, transmitModulationMode=transmitModulationMode, syslogClientTrap=syslogClientTrap, versionsGroup=versionsGroup, sNTPPollInterval=sNTPPollInterval, sMTPEnabledMessages=sMTPEnabledMessages, linkModeOptimisation=linkModeOptimisation, searchState=searchState, dataPortStatusTrap=dataPortStatusTrap, telecom=telecom, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPServerIPAddress=sNTPServerIPAddress, cableLoss=cableLoss, ethernetGroup=ethernetGroup, antennaGain=antennaGain, timeZone=timeZone, range=range, vLANPriorityTableIndex=vLANPriorityTableIndex, installStatus=installStatus, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tDDSynchronizationAlarm=tDDSynchronizationAlarm, signalStrengthRatio=signalStrengthRatio, sNTPState=sNTPState, hTTPPortNumber=hTTPPortNumber, siteName=siteName, constantPowerSpectralDensity=constantPowerSpectralDensity, supplementaryGroup=supplementaryGroup, reset=reset, softwareVersion=softwareVersion, secondarySoftwareVersion=secondarySoftwareVersion, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPTrapIPAddress=sNMPTrapIPAddress, ptpGroups=ptpGroups, frequencyVariant=frequencyVariant, linkSymmetry=linkSymmetry, telecomsChannelStatus=telecomsChannelStatus, transmitPower=transmitPower, sNTPServerPortNumber=sNTPServerPortNumber, bootVersion=bootVersion, dfs=dfs, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, installArmStateTrap=installArmStateTrap, eIRP=eIRP, gatewayIPAddress=gatewayIPAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, management=management, incompatibleMasterAndSlave=incompatibleMasterAndSlave, telecomsLoopbackTrap=telecomsLoopbackTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tDDControlGroup=tDDControlGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, productVariant=productVariant, snmpControl=snmpControl, syslogControl=syslogControl, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, userPassword=userPassword, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tDDSynchronizationMode=tDDSynchronizationMode, targetMACAddress=targetMACAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, latitude=latitude, ethernet=ethernet, userRole=userRole, syslogStateTrap=syslogStateTrap, ptmp=ptmp, transmitDataRate=transmitDataRate, systemClock=systemClock, productName=productName, ptpTrapPrefix=ptpTrapPrefix, channelBandwidth=channelBandwidth, phyStatusGroup=phyStatusGroup, phyControl=phyControl, remoteMaximumTransmitPower=remoteMaximumTransmitPower, vLANManagementPriority=vLANManagementPriority, transmitFreqKHz=transmitFreqKHz, dataPortAutoMdix=dataPortAutoMdix, telnetPortNumber=telnetPortNumber, telecomsChannelStatusTrap=telecomsChannelStatusTrap, licenceGroup=licenceGroup, telecomGroup=telecomGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitFreqMHz=transmitFreqMHz, sNMPv3Enable=sNMPv3Enable, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapVersion=sNMPTrapVersion, dfsMeans=dfsMeans, dfsPeaks=dfsPeaks, unitOutOfCalibration=unitOutOfCalibration, aAAControl=aAAControl, daylightSaving=daylightSaving, vLANManagementVID=vLANManagementVID, licensedCapacity=licensedCapacity, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPTrapTable=sNMPTrapTable, smtp=smtp, vLANPriorityTableNumber=vLANPriorityTableNumber, userTableIndex=userTableIndex, sMTPServerPortNumber=sMTPServerPortNumber, channelChangeTrap=channelChangeTrap, PYSNMP_MODULE_ID=cambium, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, aggregateDataRate=aggregateDataRate, sntp=sntp, accessMethod=accessMethod, notificationsGroup=notificationsGroup, vectorError=vectorError, userTableEntry=userTableEntry, transmitChannel=transmitChannel, longitude=longitude, dfsGroup=dfsGroup, ptp=ptp, dataPortDisabledWarning=dataPortDisabledWarning, wirelessLinkStatus=wirelessLinkStatus, userName=userName, sNMPCommunityString=sNMPCommunityString, installArmState=installArmState, telnetAccessEnabled=telnetAccessEnabled, userEnabled=userEnabled, userTable=userTable, encryptionAlgorithm=encryptionAlgorithm, regionCode=regionCode, sNMPEnabledTraps=sNMPEnabledTraps, remoteIPAddress=remoteIPAddress, dataPortStatus=dataPortStatus, receiveChannel=receiveChannel, receiveDataRate=receiveDataRate, syslogControlGroup=syslogControlGroup, sNTPSync=sNTPSync, sntpGroup=sntpGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, encryption=encryption, hTTPAccessEnabled=hTTPAccessEnabled, maximumTransmitPower=maximumTransmitPower, regionCodeTrap=regionCodeTrap, pubStats=pubStats, aAAControlGroup=aAAControlGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, groupID=groupID, telecomsInterface=telecomsInterface, snmpControlGroup=snmpControlGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, incompatibleRegionCodes=incompatibleRegionCodes, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dfsTableIndex=dfsTableIndex, alarms=alarms, configuration=configuration, receiveFreqMHz=receiveFreqMHz, tDDSynchronizationStatus=tDDSynchronizationStatus, receivePower=receivePower, bandwidthVariant=bandwidthVariant, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, resetGroup=resetGroup, sMTPServerIPAddress=sMTPServerIPAddress, userTableNumber=userTableNumber, vLANPriorityQueueMapping=vLANPriorityQueueMapping, tFTPServerIPAddress=tFTPServerIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, configurationGroup=configurationGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, systemReset=systemReset, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, telecomsLoopback=telecomsLoopback, hTTPSPortNumber=hTTPSPortNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, cambium=cambium, sMTPEmailAlert=sMTPEmailAlert, wirelessLinkAvailability=wirelessLinkAvailability, sNMPTrapPortNumber=sNMPTrapPortNumber, hardwareVersion=hardwareVersion, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, telecomsCableLength=telecomsCableLength, dfsTable=dfsTable, telecomsLineCode=telecomsLineCode, linkName=linkName, tFTPServerPortNumber=tFTPServerPortNumber, receiveFreqKHz=receiveFreqKHz, iPAddress=iPAddress, receiveModulationMode=receiveModulationMode, dataPortAutoNegotiation=dataPortAutoNegotiation, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, alarmsGroup=alarmsGroup, syslogState=syslogState, versions=versions, phyControlGroup=phyControlGroup, ethernetFiberSupport=ethernetFiberSupport, ptp500=ptp500, tDDControl=tDDControl, encryptionGroup=encryptionGroup, dfsTableNumber=dfsTableNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, receiveModulationModeDetail=receiveModulationModeDetail, managementGroup=managementGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ptpCompliance=ptpCompliance, installStatusTrap=installStatusTrap, sNTPSyncTrap=sNTPSyncTrap, dfsTableEntry=dfsTableEntry, hTTPSAccessEnabled=hTTPSAccessEnabled, vLANPriorityTable=vLANPriorityTable, licence=licence, supplementary=supplementary, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPLastSync=sNTPLastSync, syslogClient=syslogClient, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, altitude=altitude, smtpGroup=smtpGroup)
