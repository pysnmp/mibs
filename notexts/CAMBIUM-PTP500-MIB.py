...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", constantPowerSpectralDensity=constantPowerSpectralDensity, targetMACAddress=targetMACAddress, sntp=sntp, telecom=telecom, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, tFTPServerIPAddress=tFTPServerIPAddress, capacityLicenseMismatch=capacityLicenseMismatch, management=management, linkModeOptimizationMismatch=linkModeOptimizationMismatch, vectorError=vectorError, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNTPSync=sNTPSync, masterSlaveMode=masterSlaveMode, userTableEntry=userTableEntry, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNTPServerIPAddress=sNTPServerIPAddress, sNMPv3Enable=sNMPv3Enable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, notificationsGroup=notificationsGroup, dfsTable=dfsTable, tDDSynchronizationMode=tDDSynchronizationMode, telecomsLoopbackTrap=telecomsLoopbackTrap, gatewayIPAddress=gatewayIPAddress, vLANPriorityTableNumber=vLANPriorityTableNumber, vLANPriorityTableIndex=vLANPriorityTableIndex, encryptionAlgorithm=encryptionAlgorithm, remoteIPAddress=remoteIPAddress, regionCodeTrap=regionCodeTrap, userEnabled=userEnabled, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dfs=dfs, telecomGroup=telecomGroup, linkModeOptimisation=linkModeOptimisation, transmitPower=transmitPower, incompatibleRegionCodes=incompatibleRegionCodes, channelChangeTrap=channelChangeTrap, userName=userName, ptpGroups=ptpGroups, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, syslogControlGroup=syslogControlGroup, aggregateDataRate=aggregateDataRate, linkName=linkName, dataPortConfigurationMismatch=dataPortConfigurationMismatch, siteName=siteName, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, telecomsCableLength=telecomsCableLength, eIRP=eIRP, transmitChannel=transmitChannel, managementGroup=managementGroup, cableLoss=cableLoss, receiveFreqKHz=receiveFreqKHz, versions=versions, receiveFreqMHz=receiveFreqMHz, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, ptpTrapPrefix=ptpTrapPrefix, subnetMask=subnetMask, vLANPriorityTable=vLANPriorityTable, sNTPServerPortNumber=sNTPServerPortNumber, transmitDataRate=transmitDataRate, licensedCapacity=licensedCapacity, resetGroup=resetGroup, telecomsLoopback=telecomsLoopback, tDDSynchronizationAlarm=tDDSynchronizationAlarm, snmpControl=snmpControl, antennaGain=antennaGain, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dataPortStatus=dataPortStatus, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNTPLastSync=sNTPLastSync, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, snmpControlGroup=snmpControlGroup, altitude=altitude, longitude=longitude, tDDControlGroup=tDDControlGroup, alarms=alarms, encryptionGroup=encryptionGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, accessMethod=accessMethod, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPCommunityString=sNMPCommunityString, telecomsInterface=telecomsInterface, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, byteErrorRatio=byteErrorRatio, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNMPPortNumber=sNMPPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, ptmp=ptmp, phyStatusGroup=phyStatusGroup, dfsPeaks=dfsPeaks, bootVersion=bootVersion, hardwareVersion=hardwareVersion, licence=licence, dataPortAutoMdix=dataPortAutoMdix, dfsMeans=dfsMeans, ptp=ptp, userTableNumber=userTableNumber, ethernetGroup=ethernetGroup, maximumTransmitPower=maximumTransmitPower, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, iPAddress=iPAddress, telnetPortNumber=telnetPortNumber, transmitFreqMHz=transmitFreqMHz, sNTPPollInterval=sNTPPollInterval, aAAControlGroup=aAAControlGroup, sMTPEmailAlert=sMTPEmailAlert, groupID=groupID, transmitFreqKHz=transmitFreqKHz, receiveModulationModeDetail=receiveModulationModeDetail, alarmsGroup=alarmsGroup, syslogStateTrap=syslogStateTrap, sMTPServerIPAddress=sMTPServerIPAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, versionsGroup=versionsGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapTable=sNMPTrapTable, signalStrengthRatio=signalStrengthRatio, ethernet=ethernet, sntpGroup=sntpGroup, PYSNMP_MODULE_ID=cambium, systemReset=systemReset, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, supplementaryGroup=supplementaryGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, hTTPPortNumber=hTTPPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortStatusTrap=dataPortStatusTrap, configuration=configuration, bandwidthVariant=bandwidthVariant, tFTPServerPortNumber=tFTPServerPortNumber, syslogClient=syslogClient, dfsTableIndex=dfsTableIndex, tDDControl=tDDControl, syslogControl=syslogControl, sNMPTrapVersion=sNMPTrapVersion, phyControl=phyControl, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, telnetAccessEnabled=telnetAccessEnabled, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, supplementary=supplementary, vLANManagementVID=vLANManagementVID, phyControlGroup=phyControlGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, pubStats=pubStats, smtpGroup=smtpGroup, latitude=latitude, ptp500=ptp500, configurationGroup=configurationGroup, cambium=cambium, tDDSynchronizationStatus=tDDSynchronizationStatus, dataPortDisabledWarning=dataPortDisabledWarning, hTTPAccessEnabled=hTTPAccessEnabled, smtp=smtp, linkSymmetry=linkSymmetry, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, unitOutOfCalibration=unitOutOfCalibration, telecomsChannelStatus=telecomsChannelStatus, sMTPServerPortNumber=sMTPServerPortNumber, telecomsLineCode=telecomsLineCode, sMTPEnabledMessages=sMTPEnabledMessages, userPassword=userPassword, sNMPTrapIPAddress=sNMPTrapIPAddress, productName=productName, channelBandwidth=channelBandwidth, frequencyVariant=frequencyVariant, encryption=encryption, useVLANForManagementInterfaces=useVLANForManagementInterfaces, softwareVersion=softwareVersion, daylightSaving=daylightSaving, dfsTableEntry=dfsTableEntry, receivePower=receivePower, aAAControl=aAAControl, dataPortAutoNegotiation=dataPortAutoNegotiation, ptpCompliance=ptpCompliance, userRole=userRole, productVariant=productVariant, sNTPSyncTrap=sNTPSyncTrap, ethernetFiberSupport=ethernetFiberSupport, sNMPTrapPortNumber=sNMPTrapPortNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, hTTPSPortNumber=hTTPSPortNumber, ptpTraps=ptpTraps, syslogState=syslogState, sNTPState=sNTPState, wirelessLinkStatus=wirelessLinkStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, licenceGroup=licenceGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, installStatusTrap=installStatusTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, userTable=userTable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dfsGroup=dfsGroup, systemClock=systemClock, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, installArmState=installArmState, searchState=searchState, pubStatsGroup=pubStatsGroup, vLANManagementPriority=vLANManagementPriority, sNMPTrapTableNumber=sNMPTrapTableNumber, reset=reset, linkLoss=linkLoss, timeZone=timeZone, userTableIndex=userTableIndex, regionCode=regionCode, receiveChannel=receiveChannel, phyStatus=phyStatus, transmitModulationMode=transmitModulationMode, installStatus=installStatus, dfsTableNumber=dfsTableNumber, receiveModulationMode=receiveModulationMode, wirelessLinkAvailability=wirelessLinkAvailability, installArmStateTrap=installArmStateTrap, syslogClientTrap=syslogClientTrap, receiveDataRate=receiveDataRate, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, range=range)
