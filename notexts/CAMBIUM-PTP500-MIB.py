...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", receiveModulationMode=receiveModulationMode, sNTPSync=sNTPSync, sNMPCommunityString=sNMPCommunityString, subnetMask=subnetMask, receivePower=receivePower, notificationsGroup=notificationsGroup, tDDSynchronizationMode=tDDSynchronizationMode, constantPowerSpectralDensity=constantPowerSpectralDensity, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, licence=licence, bootVersion=bootVersion, telecomsCableLength=telecomsCableLength, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, linkLoss=linkLoss, dfsPeaks=dfsPeaks, PYSNMP_MODULE_ID=cambium, alarms=alarms, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, antennaGain=antennaGain, cambium=cambium, versions=versions, telecomsInterface=telecomsInterface, transmitPower=transmitPower, versionsGroup=versionsGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptp=ptp, syslogControl=syslogControl, vLANPriorityTableEntry=vLANPriorityTableEntry, syslogClient=syslogClient, dataPortAutoNegotiation=dataPortAutoNegotiation, ethernetFiberSupport=ethernetFiberSupport, timeZone=timeZone, userRole=userRole, sNMPTrapPortNumber=sNMPTrapPortNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, encryption=encryption, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sMTPSourceEmailAddress=sMTPSourceEmailAddress, supplementaryGroup=supplementaryGroup, sNTPServerPortNumber=sNTPServerPortNumber, syslogState=syslogState, userName=userName, configuration=configuration, telecomsLineCode=telecomsLineCode, tDDSynchronizationAlarm=tDDSynchronizationAlarm, telecomsLoopbackTrap=telecomsLoopbackTrap, aAAControlGroup=aAAControlGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, cableLoss=cableLoss, telecomGroup=telecomGroup, sNMPTrapTable=sNMPTrapTable, softwareVersion=softwareVersion, telnetPortNumber=telnetPortNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sMTPEmailAlert=sMTPEmailAlert, licenceGroup=licenceGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, hTTPAccessEnabled=hTTPAccessEnabled, sNTPServerIPAddress=sNTPServerIPAddress, userTableEntry=userTableEntry, vLANPriorityTable=vLANPriorityTable, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernetGroup=ethernetGroup, tDDControlGroup=tDDControlGroup, targetMACAddress=targetMACAddress, management=management, userTable=userTable, sntp=sntp, ptpTrapPrefix=ptpTrapPrefix, encryptionGroup=encryptionGroup, productName=productName, regionCode=regionCode, sNMPTrapIPAddress=sNMPTrapIPAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, unitOutOfCalibration=unitOutOfCalibration, accessMethod=accessMethod, installStatus=installStatus, ptpGroups=ptpGroups, capacityLicenseMismatch=capacityLicenseMismatch, incompatibleMasterAndSlave=incompatibleMasterAndSlave, regionCodeTrap=regionCodeTrap, hardwareVersion=hardwareVersion, remoteIPAddress=remoteIPAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, latitude=latitude, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, snmpControl=snmpControl, sNMPPortNumber=sNMPPortNumber, dfsGroup=dfsGroup, linkSymmetry=linkSymmetry, channelChangeTrap=channelChangeTrap, ptp500=ptp500, syslogStateTrap=syslogStateTrap, transmitFreqKHz=transmitFreqKHz, hTTPSAccessEnabled=hTTPSAccessEnabled, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, userPassword=userPassword, receiveDataRate=receiveDataRate, snmpControlGroup=snmpControlGroup, phyControlGroup=phyControlGroup, reset=reset, ethernet=ethernet, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, aAAControl=aAAControl, dfsTableEntry=dfsTableEntry, sntpGroup=sntpGroup, dataPortAutoMdix=dataPortAutoMdix, maximumTransmitPower=maximumTransmitPower, eIRP=eIRP, vLANManagementVID=vLANManagementVID, receiveFreqMHz=receiveFreqMHz, pubStatsGroup=pubStatsGroup, sNTPState=sNTPState, sNTPPollInterval=sNTPPollInterval, daylightSaving=daylightSaving, noWirelessChannelAvailable=noWirelessChannelAvailable, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfs=dfs, vectorError=vectorError, managementGroup=managementGroup, installStatusTrap=installStatusTrap, receiveChannel=receiveChannel, vLANPriorityQueueMapping=vLANPriorityQueueMapping, alarmsGroup=alarmsGroup, configurationGroup=configurationGroup, signalStrengthRatio=signalStrengthRatio, linkModeOptimisation=linkModeOptimisation, sMTPEnabledMessages=sMTPEnabledMessages, aggregateDataRate=aggregateDataRate, userTableNumber=userTableNumber, installArmStateTrap=installArmStateTrap, bandwidthVariant=bandwidthVariant, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, systemClock=systemClock, userEnabled=userEnabled, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, smtpGroup=smtpGroup, receiveFreqKHz=receiveFreqKHz, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, hTTPSPortNumber=hTTPSPortNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, vLANPriorityTableNumber=vLANPriorityTableNumber, linkName=linkName, syslogClientTrap=syslogClientTrap, ptpCompliance=ptpCompliance, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNMPTrapVersion=sNMPTrapVersion, ptmp=ptmp, transmitFreqMHz=transmitFreqMHz, receiveModulationModeDetail=receiveModulationModeDetail, transmitModulationMode=transmitModulationMode, iPAddress=iPAddress, telnetAccessEnabled=telnetAccessEnabled, hTTPPortNumber=hTTPPortNumber, systemReset=systemReset, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, channelBandwidth=channelBandwidth, telecomsLoopback=telecomsLoopback, sNTPSyncTrap=sNTPSyncTrap, longitude=longitude, tFTPServerPortNumber=tFTPServerPortNumber, dataPortStatusTrap=dataPortStatusTrap, dataPortStatus=dataPortStatus, installArmState=installArmState, altitude=altitude, searchState=searchState, transmitChannel=transmitChannel, telecomsChannelStatusTrap=telecomsChannelStatusTrap, productVariant=productVariant, sNMPEnabledTraps=sNMPEnabledTraps, userTableIndex=userTableIndex, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPLastSync=sNTPLastSync, secondarySoftwareVersion=secondarySoftwareVersion, incompatibleRegionCodes=incompatibleRegionCodes, ptpTraps=ptpTraps, tFTPServerIPAddress=tFTPServerIPAddress, dfsTable=dfsTable, wirelessLinkStatus=wirelessLinkStatus, dfsTableIndex=dfsTableIndex, phyControl=phyControl, telecom=telecom, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dfsTableNumber=dfsTableNumber, byteErrorRatio=byteErrorRatio, encryptionAlgorithm=encryptionAlgorithm, dfsMeans=dfsMeans, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, groupID=groupID, vLANPriorityTableIndex=vLANPriorityTableIndex, telecomsChannelStatus=telecomsChannelStatus, sMTPServerIPAddress=sMTPServerIPAddress, vLANManagementPriority=vLANManagementPriority, wirelessLinkAvailability=wirelessLinkAvailability, siteName=siteName, frequencyVariant=frequencyVariant, phyStatus=phyStatus, licensedCapacity=licensedCapacity, syslogControlGroup=syslogControlGroup, dataPortDisabledWarning=dataPortDisabledWarning, sNMPTrapTableIndex=sNMPTrapTableIndex, tDDControl=tDDControl, supplementary=supplementary, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, gatewayIPAddress=gatewayIPAddress, transmitDataRate=transmitDataRate, sNMPTrapTableEntry=sNMPTrapTableEntry, pubStats=pubStats, sNMPv3Enable=sNMPv3Enable, range=range, smtp=smtp, phyStatusGroup=phyStatusGroup, sMTPServerPortNumber=sMTPServerPortNumber, masterSlaveMode=masterSlaveMode, resetGroup=resetGroup)
