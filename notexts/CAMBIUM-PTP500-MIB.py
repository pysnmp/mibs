...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", installStatus=installStatus, phyControl=phyControl, syslogState=syslogState, frequencyVariant=frequencyVariant, bootVersion=bootVersion, phyControlGroup=phyControlGroup, dfsTableIndex=dfsTableIndex, dfsGroup=dfsGroup, transmitModulationMode=transmitModulationMode, sNMPPortNumber=sNMPPortNumber, sMTPServerIPAddress=sMTPServerIPAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ethernetGroup=ethernetGroup, syslogControlGroup=syslogControlGroup, syslogStateTrap=syslogStateTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, receiveChannel=receiveChannel, remoteMaximumTransmitPower=remoteMaximumTransmitPower, licence=licence, encryption=encryption, versionsGroup=versionsGroup, masterSlaveMode=masterSlaveMode, hTTPAccessEnabled=hTTPAccessEnabled, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, receiveModulationMode=receiveModulationMode, transmitFreqMHz=transmitFreqMHz, noWirelessChannelAvailable=noWirelessChannelAvailable, vLANPriorityTable=vLANPriorityTable, daylightSaving=daylightSaving, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, groupID=groupID, telecomGroup=telecomGroup, longitude=longitude, incompatibleRegionCodes=incompatibleRegionCodes, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, smtpGroup=smtpGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, sntp=sntp, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transmitChannel=transmitChannel, accessMethod=accessMethod, userEnabled=userEnabled, vLANManagementVID=vLANManagementVID, telnetAccessEnabled=telnetAccessEnabled, hTTPSAccessEnabled=hTTPSAccessEnabled, sntpGroup=sntpGroup, sMTPServerPortNumber=sMTPServerPortNumber, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, pubStatsGroup=pubStatsGroup, telecomsChannelStatus=telecomsChannelStatus, dataPortDisabledWarning=dataPortDisabledWarning, aggregateDataRate=aggregateDataRate, altitude=altitude, alarms=alarms, linkSymmetry=linkSymmetry, sNMPTrapVersion=sNMPTrapVersion, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, telecomsChannelStatusTrap=telecomsChannelStatusTrap, configurationGroup=configurationGroup, systemClock=systemClock, linkModeOptimisation=linkModeOptimisation, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapPortNumber=sNMPTrapPortNumber, syslogClient=syslogClient, telnetPortNumber=telnetPortNumber, dfsMeans=dfsMeans, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, management=management, channelBandwidth=channelBandwidth, installStatusTrap=installStatusTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPServerPortNumber=tFTPServerPortNumber, ptp=ptp, supplementaryGroup=supplementaryGroup, cableLoss=cableLoss, productName=productName, sNTPSync=sNTPSync, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPSyncTrap=sNTPSyncTrap, smtp=smtp, range=range, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, supplementary=supplementary, aAAControlGroup=aAAControlGroup, cambium=cambium, ethernet=ethernet, hardwareVersion=hardwareVersion, telecomsLoopbackTrap=telecomsLoopbackTrap, alarmsGroup=alarmsGroup, receiveModulationModeDetail=receiveModulationModeDetail, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, receiveDataRate=receiveDataRate, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, managementGroup=managementGroup, licensedCapacity=licensedCapacity, tFTPServerIPAddress=tFTPServerIPAddress, receiveFreqMHz=receiveFreqMHz, dfsTable=dfsTable, telecomsLineCode=telecomsLineCode, receivePower=receivePower, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, snmpControl=snmpControl, dataPortWirelessDownAlert=dataPortWirelessDownAlert, transmitDataRate=transmitDataRate, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPServerIPAddress=sNTPServerIPAddress, maximumTransmitPower=maximumTransmitPower, sNTPServerPortNumber=sNTPServerPortNumber, channelChangeTrap=channelChangeTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, transmitPower=transmitPower, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tDDControl=tDDControl, userRole=userRole, latitude=latitude, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dfs=dfs, telecom=telecom, reset=reset, sNTPState=sNTPState, wirelessLinkAvailability=wirelessLinkAvailability, systemReset=systemReset, sMTPEnabledMessages=sMTPEnabledMessages, licenceGroup=licenceGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, userTable=userTable, tDDSynchronizationStatus=tDDSynchronizationStatus, syslogControl=syslogControl, targetMACAddress=targetMACAddress, productVariant=productVariant, siteName=siteName, hTTPSPortNumber=hTTPSPortNumber, tDDControlGroup=tDDControlGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ptpTraps=ptpTraps, userTableNumber=userTableNumber, resetGroup=resetGroup, subnetMask=subnetMask, wirelessLinkStatus=wirelessLinkStatus, vLANPriorityTableIndex=vLANPriorityTableIndex, PYSNMP_MODULE_ID=cambium, aAAControl=aAAControl, antennaGain=antennaGain, transmitFreqKHz=transmitFreqKHz, vLANPriorityTableEntry=vLANPriorityTableEntry, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, secondarySoftwareVersion=secondarySoftwareVersion, dataPortAutoMdix=dataPortAutoMdix, snmpControlGroup=snmpControlGroup, softwareVersion=softwareVersion, eIRP=eIRP, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, pubStats=pubStats, encryptionGroup=encryptionGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, byteErrorRatio=byteErrorRatio, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, useVLANForManagementInterfaces=useVLANForManagementInterfaces, receiveFreqKHz=receiveFreqKHz, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, regionCodeTrap=regionCodeTrap, installArmStateTrap=installArmStateTrap, unitOutOfCalibration=unitOutOfCalibration, hTTPPortNumber=hTTPPortNumber, vLANManagementPriority=vLANManagementPriority, dataPortStatus=dataPortStatus, searchState=searchState, dataPortStatusTrap=dataPortStatusTrap, sNTPLastSync=sNTPLastSync, installArmState=installArmState, userTableEntry=userTableEntry, ptpTrapPrefix=ptpTrapPrefix, sNMPv3Enable=sNMPv3Enable, constantPowerSpectralDensity=constantPowerSpectralDensity, telecomsInterface=telecomsInterface, ptpCompliance=ptpCompliance, vectorError=vectorError, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, configuration=configuration, dfsTableNumber=dfsTableNumber, signalStrengthRatio=signalStrengthRatio, incompatibleMasterAndSlave=incompatibleMasterAndSlave, gatewayIPAddress=gatewayIPAddress, ptpGroups=ptpGroups, sNMPCommunityString=sNMPCommunityString, remoteIPAddress=remoteIPAddress, phyStatus=phyStatus, sNTPPollInterval=sNTPPollInterval, encryptionAlgorithm=encryptionAlgorithm, sNMPTrapTable=sNMPTrapTable, dfsPeaks=dfsPeaks, linkName=linkName, telecomsLoopback=telecomsLoopback, regionCode=regionCode, syslogLocalWrappedTrap=syslogLocalWrappedTrap, linkLoss=linkLoss, capacityLicenseMismatch=capacityLicenseMismatch, ptmp=ptmp, vLANPriorityQueueMapping=vLANPriorityQueueMapping, userName=userName, bandwidthVariant=bandwidthVariant, dataPortConfigurationMismatch=dataPortConfigurationMismatch, timeZone=timeZone, userPassword=userPassword, dataPortAutoNegotiation=dataPortAutoNegotiation, phyStatusGroup=phyStatusGroup, userTableIndex=userTableIndex, syslogClientTrap=syslogClientTrap, ethernetFiberSupport=ethernetFiberSupport, iPAddress=iPAddress, notificationsGroup=notificationsGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptp500=ptp500, telecomsCableLength=telecomsCableLength, versions=versions, tDDSynchronizationMode=tDDSynchronizationMode, dfsTableEntry=dfsTableEntry)
