...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", telecomsInterface=telecomsInterface, resetGroup=resetGroup, timeZone=timeZone, receiveModulationMode=receiveModulationMode, encryption=encryption, signalStrengthRatio=signalStrengthRatio, tFTPServerPortNumber=tFTPServerPortNumber, hTTPSPortNumber=hTTPSPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, telnetPortNumber=telnetPortNumber, aAAControlGroup=aAAControlGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, transmitFreqMHz=transmitFreqMHz, vLANPriorityTableNumber=vLANPriorityTableNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, managementGroup=managementGroup, dfsPeaks=dfsPeaks, eIRP=eIRP, smtpGroup=smtpGroup, telecomsLoopbackTrap=telecomsLoopbackTrap, dfsTableNumber=dfsTableNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, phyStatusGroup=phyStatusGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, maximumTransmitPower=maximumTransmitPower, noWirelessChannelAvailable=noWirelessChannelAvailable, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sMTPEmailAlert=sMTPEmailAlert, ethernetFiberSupport=ethernetFiberSupport, tFTPServerIPAddress=tFTPServerIPAddress, tDDSynchronizationMode=tDDSynchronizationMode, searchState=searchState, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, telecomsLineCode=telecomsLineCode, vLANManagementVID=vLANManagementVID, ptmp=ptmp, smtp=smtp, sMTPServerIPAddress=sMTPServerIPAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, userTableIndex=userTableIndex, regionCodeTrap=regionCodeTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortAutoMdix=dataPortAutoMdix, installArmStateTrap=installArmStateTrap, aAAControl=aAAControl, subnetMask=subnetMask, encryptionGroup=encryptionGroup, sNMPCommunityString=sNMPCommunityString, telecomsCableLength=telecomsCableLength, userPassword=userPassword, sNMPTrapVersion=sNMPTrapVersion, sNTPPollInterval=sNTPPollInterval, vLANPriorityTable=vLANPriorityTable, snmpControl=snmpControl, alarmsGroup=alarmsGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dfsTableEntry=dfsTableEntry, productName=productName, dfsTableIndex=dfsTableIndex, syslogStateTrap=syslogStateTrap, receiveDataRate=receiveDataRate, hardwareVersion=hardwareVersion, gatewayIPAddress=gatewayIPAddress, receiveFreqMHz=receiveFreqMHz, transmitChannel=transmitChannel, dataPortAutoNegotiation=dataPortAutoNegotiation, sNTPServerPortNumber=sNTPServerPortNumber, sMTPServerPortNumber=sMTPServerPortNumber, latitude=latitude, installStatusTrap=installStatusTrap, ethernet=ethernet, userEnabled=userEnabled, userTableEntry=userTableEntry, syslogClient=syslogClient, byteErrorRatio=byteErrorRatio, snmpControlGroup=snmpControlGroup, telecomGroup=telecomGroup, telecomsChannelStatus=telecomsChannelStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, daylightSaving=daylightSaving, tDDControlGroup=tDDControlGroup, dfsMeans=dfsMeans, transmitFreqKHz=transmitFreqKHz, configurationGroup=configurationGroup, versionsGroup=versionsGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, linkName=linkName, installStatus=installStatus, transmitPower=transmitPower, vLANManagementPriority=vLANManagementPriority, productVariant=productVariant, licenceGroup=licenceGroup, licence=licence, sNMPPortNumber=sNMPPortNumber, sNMPv3Enable=sNMPv3Enable, softwareVersion=softwareVersion, bootVersion=bootVersion, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, receiveChannel=receiveChannel, iPAddress=iPAddress, capacityLicenseMismatch=capacityLicenseMismatch, antennaGain=antennaGain, receivePower=receivePower, userTableNumber=userTableNumber, cableLoss=cableLoss, linkModeOptimisation=linkModeOptimisation, vLANPriorityQueueMapping=vLANPriorityQueueMapping, incompatibleMasterAndSlave=incompatibleMasterAndSlave, constantPowerSpectralDensity=constantPowerSpectralDensity, incompatibleRegionCodes=incompatibleRegionCodes, ptpTrapPrefix=ptpTrapPrefix, tDDControl=tDDControl, sMTPEnabledMessages=sMTPEnabledMessages, sntpGroup=sntpGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, sNMPTrapTableIndex=sNMPTrapTableIndex, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogControl=syslogControl, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, phyControlGroup=phyControlGroup, sNTPSync=sNTPSync, systemClock=systemClock, management=management, sNTPLastSync=sNTPLastSync, siteName=siteName, altitude=altitude, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ptp500=ptp500, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, alarms=alarms, PYSNMP_MODULE_ID=cambium, ptpGroups=ptpGroups, regionCode=regionCode, masterSlaveMode=masterSlaveMode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, cambium=cambium, channelBandwidth=channelBandwidth, hTTPAccessEnabled=hTTPAccessEnabled, hTTPSAccessEnabled=hTTPSAccessEnabled, wirelessLinkAvailability=wirelessLinkAvailability, receiveFreqKHz=receiveFreqKHz, transmitDataRate=transmitDataRate, sNMPEnabledTraps=sNMPEnabledTraps, syslogControlGroup=syslogControlGroup, phyStatus=phyStatus, hTTPPortNumber=hTTPPortNumber, wirelessLinkStatus=wirelessLinkStatus, dfsGroup=dfsGroup, ptpCompliance=ptpCompliance, notificationsGroup=notificationsGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dataPortStatusTrap=dataPortStatusTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, pubStatsGroup=pubStatsGroup, linkLoss=linkLoss, configuration=configuration, installArmState=installArmState, dataPortConfigurationMismatch=dataPortConfigurationMismatch, ethernetGroup=ethernetGroup, supplementary=supplementary, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, unitOutOfCalibration=unitOutOfCalibration, encryptionAlgorithm=encryptionAlgorithm, sNTPSyncTrap=sNTPSyncTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, telecom=telecom, tDDSynchronizationStatus=tDDSynchronizationStatus, systemReset=systemReset, sNMPTrapPortNumber=sNMPTrapPortNumber, syslogState=syslogState, pubStats=pubStats, targetMACAddress=targetMACAddress, bandwidthVariant=bandwidthVariant, dataPortDisabledWarning=dataPortDisabledWarning, syslogClientTrap=syslogClientTrap, supplementaryGroup=supplementaryGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, userTable=userTable, remoteIPAddress=remoteIPAddress, range=range, channelChangeTrap=channelChangeTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, vLANPriorityTableEntry=vLANPriorityTableEntry, enabledDiagnosticAlarms=enabledDiagnosticAlarms, receiveModulationModeDetail=receiveModulationModeDetail, userRole=userRole, ptpTraps=ptpTraps, frequencyVariant=frequencyVariant, dataPortStatus=dataPortStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, licensedCapacity=licensedCapacity, telnetAccessEnabled=telnetAccessEnabled, sNTPState=sNTPState, accessMethod=accessMethod, vectorError=vectorError, sNMPTrapTable=sNMPTrapTable, userName=userName, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, aggregateDataRate=aggregateDataRate, sntp=sntp, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dfsTable=dfsTable, dfs=dfs, phyControl=phyControl, telecomsLoopback=telecomsLoopback, longitude=longitude, ptp=ptp, linkSymmetry=linkSymmetry, transmitModulationMode=transmitModulationMode, reset=reset, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, groupID=groupID, versions=versions, sNTPServerIPAddress=sNTPServerIPAddress)
