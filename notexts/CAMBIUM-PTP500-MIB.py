...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", encryptionGroup=encryptionGroup, channelChangeTrap=channelChangeTrap, ptp500=ptp500, transmitModulationMode=transmitModulationMode, channelBandwidth=channelBandwidth, smtpGroup=smtpGroup, dfsMeans=dfsMeans, tFTPServerPortNumber=tFTPServerPortNumber, telecom=telecom, bootVersion=bootVersion, vLANPriorityTableNumber=vLANPriorityTableNumber, siteName=siteName, bandwidthVariant=bandwidthVariant, sNMPCommunityString=sNMPCommunityString, ptpTrapPrefix=ptpTrapPrefix, userTableNumber=userTableNumber, phyStatusGroup=phyStatusGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dataPortStatus=dataPortStatus, syslogStateTrap=syslogStateTrap, receivePower=receivePower, receiveFreqKHz=receiveFreqKHz, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ptmp=ptmp, installArmStateTrap=installArmStateTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, versions=versions, phyControlGroup=phyControlGroup, userName=userName, receiveChannel=receiveChannel, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, licence=licence, productVariant=productVariant, encryptionAlgorithm=encryptionAlgorithm, ptp=ptp, sMTPEnabledMessages=sMTPEnabledMessages, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, vLANManagementVID=vLANManagementVID, licenceGroup=licenceGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, receiveModulationMode=receiveModulationMode, range=range, reset=reset, sntpGroup=sntpGroup, vLANManagementPriority=vLANManagementPriority, sMTPSourceEmailAddress=sMTPSourceEmailAddress, softwareVersion=softwareVersion, ethernet=ethernet, vectorError=vectorError, dataPortStatusTrap=dataPortStatusTrap, capacityLicenseMismatch=capacityLicenseMismatch, targetMACAddress=targetMACAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ethernetFiberSupport=ethernetFiberSupport, userEnabled=userEnabled, userPassword=userPassword, cableLoss=cableLoss, sMTPServerPortNumber=sMTPServerPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, syslogClient=syslogClient, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitDataRate=transmitDataRate, PYSNMP_MODULE_ID=cambium, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNTPSyncTrap=sNTPSyncTrap, dfsTableIndex=dfsTableIndex, installStatusTrap=installStatusTrap, hTTPSPortNumber=hTTPSPortNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, vLANPriorityQueueMapping=vLANPriorityQueueMapping, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, hTTPPortNumber=hTTPPortNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, secondarySoftwareVersion=secondarySoftwareVersion, dfsTableEntry=dfsTableEntry, encryption=encryption, ptpTraps=ptpTraps, sNTPSync=sNTPSync, sMTPEmailAlert=sMTPEmailAlert, dfsTableNumber=dfsTableNumber, transmitPower=transmitPower, transmitFreqMHz=transmitFreqMHz, receiveFreqMHz=receiveFreqMHz, incompatibleRegionCodes=incompatibleRegionCodes, sNTPServerIPAddress=sNTPServerIPAddress, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, managementGroup=managementGroup, telecomsLoopbackTrap=telecomsLoopbackTrap, sMTPServerIPAddress=sMTPServerIPAddress, telnetAccessEnabled=telnetAccessEnabled, telecomsLineCode=telecomsLineCode, telnetPortNumber=telnetPortNumber, notificationsGroup=notificationsGroup, telecomsChannelStatus=telecomsChannelStatus, receiveDataRate=receiveDataRate, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ptpCompliance=ptpCompliance, transmitChannel=transmitChannel, alarms=alarms, maximumTransmitPower=maximumTransmitPower, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, searchState=searchState, hTTPAccessEnabled=hTTPAccessEnabled, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sntp=sntp, telecomsLoopback=telecomsLoopback, ethernetGroup=ethernetGroup, accessMethod=accessMethod, aAAControlGroup=aAAControlGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, alarmsGroup=alarmsGroup, productName=productName, groupID=groupID, dataPortAutoNegotiation=dataPortAutoNegotiation, transmitFreqKHz=transmitFreqKHz, sNTPState=sNTPState, sNTPServerPortNumber=sNTPServerPortNumber, subnetMask=subnetMask, userTableEntry=userTableEntry, management=management, phyControl=phyControl, supplementaryGroup=supplementaryGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPTrapTableIndex=sNMPTrapTableIndex, daylightSaving=daylightSaving, resetGroup=resetGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, systemClock=systemClock, installArmState=installArmState, sNTPPollInterval=sNTPPollInterval, versionsGroup=versionsGroup, configurationGroup=configurationGroup, antennaGain=antennaGain, frequencyVariant=frequencyVariant, systemReset=systemReset, wirelessLinkStatus=wirelessLinkStatus, receiveModulationModeDetail=receiveModulationModeDetail, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortAutoMdix=dataPortAutoMdix, byteErrorRatio=byteErrorRatio, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dfs=dfs, iPAddress=iPAddress, gatewayIPAddress=gatewayIPAddress, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapVersion=sNMPTrapVersion, constantPowerSpectralDensity=constantPowerSpectralDensity, altitude=altitude, tDDSynchronizationMode=tDDSynchronizationMode, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, licensedCapacity=licensedCapacity, userTable=userTable, dfsPeaks=dfsPeaks, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, linkModeOptimizationMismatch=linkModeOptimizationMismatch, syslogClientTrap=syslogClientTrap, installStatus=installStatus, tDDControl=tDDControl, aAAControl=aAAControl, cambium=cambium, remoteIPAddress=remoteIPAddress, tDDControlGroup=tDDControlGroup, userTableIndex=userTableIndex, configuration=configuration, telecomsInterface=telecomsInterface, signalStrengthRatio=signalStrengthRatio, pubStats=pubStats, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNMPTrapTable=sNMPTrapTable, linkName=linkName, linkModeOptimisation=linkModeOptimisation, smtp=smtp, syslogControl=syslogControl, syslogControlGroup=syslogControlGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortDisabledWarning=dataPortDisabledWarning, enabledDiagnosticAlarms=enabledDiagnosticAlarms, syslogState=syslogState, latitude=latitude, vLANPriorityTable=vLANPriorityTable, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapPortNumber=sNMPTrapPortNumber, unitOutOfCalibration=unitOutOfCalibration, vLANPriorityTableEntry=vLANPriorityTableEntry, telecomsCableLength=telecomsCableLength, supplementary=supplementary, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, linkSymmetry=linkSymmetry, snmpControl=snmpControl, userRole=userRole, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNMPPortNumber=sNMPPortNumber, eIRP=eIRP, ptpGroups=ptpGroups, masterSlaveMode=masterSlaveMode, pubStatsGroup=pubStatsGroup, sNTPLastSync=sNTPLastSync, sNMPv3Enable=sNMPv3Enable, vLANPriorityTableIndex=vLANPriorityTableIndex, sNMPTrapTableEntry=sNMPTrapTableEntry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfsGroup=dfsGroup, timeZone=timeZone, linkLoss=linkLoss, regionCode=regionCode, regionCodeTrap=regionCodeTrap, dfsTable=dfsTable, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, longitude=longitude, phyStatus=phyStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, snmpControlGroup=snmpControlGroup, hardwareVersion=hardwareVersion, aggregateDataRate=aggregateDataRate, telecomGroup=telecomGroup, wirelessLinkAvailability=wirelessLinkAvailability)
