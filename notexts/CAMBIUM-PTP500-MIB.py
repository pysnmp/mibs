...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", regionCodeTrap=regionCodeTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, incompatibleRegionCodes=incompatibleRegionCodes, frequencyVariant=frequencyVariant, sNMPPortNumber=sNMPPortNumber, telecomsLineCode=telecomsLineCode, incompatibleMasterAndSlave=incompatibleMasterAndSlave, receiveChannel=receiveChannel, vLANPriorityQueueMapping=vLANPriorityQueueMapping, targetMACAddress=targetMACAddress, telnetPortNumber=telnetPortNumber, userRole=userRole, ethernetFiberSupport=ethernetFiberSupport, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPv3Enable=sNMPv3Enable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, hardwareVersion=hardwareVersion, linkSymmetry=linkSymmetry, installStatus=installStatus, sMTPEnabledMessages=sMTPEnabledMessages, sNTPSyncTrap=sNTPSyncTrap, remoteIPAddress=remoteIPAddress, tDDSynchronizationMode=tDDSynchronizationMode, latitude=latitude, vLANManagementPriority=vLANManagementPriority, telecomsLoopbackTrap=telecomsLoopbackTrap, dfsTableIndex=dfsTableIndex, licensedCapacity=licensedCapacity, dfsPeaks=dfsPeaks, ptp500=ptp500, sNMPEnabledTraps=sNMPEnabledTraps, sNTPServerPortNumber=sNTPServerPortNumber, tDDControlGroup=tDDControlGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, phyControlGroup=phyControlGroup, signalStrengthRatio=signalStrengthRatio, dfs=dfs, linkModeOptimisation=linkModeOptimisation, dfsTable=dfsTable, accessMethod=accessMethod, reset=reset, aggregateDataRate=aggregateDataRate, remoteMaximumTransmitPower=remoteMaximumTransmitPower, PYSNMP_MODULE_ID=cambium, regionCode=regionCode, sNTPLastSync=sNTPLastSync, snmpControlGroup=snmpControlGroup, siteName=siteName, aAAControl=aAAControl, wirelessLinkStatus=wirelessLinkStatus, phyStatus=phyStatus, sNMPTrapTable=sNMPTrapTable, iPAddress=iPAddress, masterSlaveMode=masterSlaveMode, ptpGroups=ptpGroups, transmitPower=transmitPower, phyStatusGroup=phyStatusGroup, notificationsGroup=notificationsGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, syslogControl=syslogControl, ptmp=ptmp, useVLANForManagementInterfaces=useVLANForManagementInterfaces, channelBandwidth=channelBandwidth, management=management, dataPortAutoMdix=dataPortAutoMdix, versionsGroup=versionsGroup, cableLoss=cableLoss, configuration=configuration, supplementaryGroup=supplementaryGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, enabledDiagnosticAlarms=enabledDiagnosticAlarms, userTable=userTable, unitOutOfCalibration=unitOutOfCalibration, receiveFreqMHz=receiveFreqMHz, versions=versions, smtp=smtp, subnetMask=subnetMask, aAAControlGroup=aAAControlGroup, receivePower=receivePower, dataPortStatusTrap=dataPortStatusTrap, resetGroup=resetGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, tFTPServerPortNumber=tFTPServerPortNumber, antennaGain=antennaGain, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernet=ethernet, telecom=telecom, range=range, userTableIndex=userTableIndex, ethernetGroup=ethernetGroup, pubStats=pubStats, telecomsLoopback=telecomsLoopback, receiveDataRate=receiveDataRate, userName=userName, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, installArmStateTrap=installArmStateTrap, dfsGroup=dfsGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, supplementary=supplementary, hTTPPortNumber=hTTPPortNumber, managementGroup=managementGroup, userTableEntry=userTableEntry, sNTPState=sNTPState, bandwidthVariant=bandwidthVariant, linkLoss=linkLoss, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, receiveModulationMode=receiveModulationMode, syslogState=syslogState, transmitChannel=transmitChannel, transmitModulationMode=transmitModulationMode, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNTPSync=sNTPSync, byteErrorRatio=byteErrorRatio, wirelessLinkAvailability=wirelessLinkAvailability, syslogClientTrap=syslogClientTrap, encryption=encryption, systemReset=systemReset, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, userPassword=userPassword, syslogControlGroup=syslogControlGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, searchState=searchState, linkModeOptimizationMismatch=linkModeOptimizationMismatch, transmitFreqMHz=transmitFreqMHz, gatewayIPAddress=gatewayIPAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, alarmsGroup=alarmsGroup, hTTPAccessEnabled=hTTPAccessEnabled, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dfsMeans=dfsMeans, syslogStateTrap=syslogStateTrap, cambium=cambium, transmitFreqKHz=transmitFreqKHz, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, vLANPriorityTable=vLANPriorityTable, tDDControl=tDDControl, pubStatsGroup=pubStatsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, tDDSynchronizationAlarm=tDDSynchronizationAlarm, bootVersion=bootVersion, groupID=groupID, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPServerIPAddress=sNTPServerIPAddress, snmpControl=snmpControl, userEnabled=userEnabled, sMTPServerPortNumber=sMTPServerPortNumber, hTTPSPortNumber=hTTPSPortNumber, dfsTableNumber=dfsTableNumber, userTableNumber=userTableNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, ptpTraps=ptpTraps, tFTPServerIPAddress=tFTPServerIPAddress, sntp=sntp, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, systemClock=systemClock, smtpGroup=smtpGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, telecomGroup=telecomGroup, productVariant=productVariant, timeZone=timeZone, syslogLocalWrappedTrap=syslogLocalWrappedTrap, telecomsCableLength=telecomsCableLength, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, linkName=linkName, dataPortStatus=dataPortStatus, sntpGroup=sntpGroup, syslogClient=syslogClient, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, longitude=longitude, sMTPServerIPAddress=sMTPServerIPAddress, sNTPPollInterval=sNTPPollInterval, daylightSaving=daylightSaving, ptpCompliance=ptpCompliance, telecomsInterface=telecomsInterface, sNMPTrapTableNumber=sNMPTrapTableNumber, licenceGroup=licenceGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, channelChangeTrap=channelChangeTrap, sNMPCommunityString=sNMPCommunityString, eIRP=eIRP, licence=licence, receiveModulationModeDetail=receiveModulationModeDetail, installStatusTrap=installStatusTrap, maximumTransmitPower=maximumTransmitPower, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, softwareVersion=softwareVersion, altitude=altitude, vLANManagementVID=vLANManagementVID, encryptionGroup=encryptionGroup, productName=productName, secondarySoftwareVersion=secondarySoftwareVersion, transmitDataRate=transmitDataRate, receiveFreqKHz=receiveFreqKHz, configurationGroup=configurationGroup, ptp=ptp, alarms=alarms, constantPowerSpectralDensity=constantPowerSpectralDensity, installArmState=installArmState, telnetAccessEnabled=telnetAccessEnabled, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, encryptionAlgorithm=encryptionAlgorithm, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dfsTableEntry=dfsTableEntry, ptpTrapPrefix=ptpTrapPrefix, vectorError=vectorError, sNMPTrapVersion=sNMPTrapVersion, hTTPSAccessEnabled=hTTPSAccessEnabled, phyControl=phyControl, telecomsChannelStatus=telecomsChannelStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortDisabledWarning=dataPortDisabledWarning, capacityLicenseMismatch=capacityLicenseMismatch, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sMTPEmailAlert=sMTPEmailAlert, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning)
