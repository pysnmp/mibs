...
# Produced by pysmi-1.1.0 at Fri Nov 19 14:49:33 2021
...
Bits, enterprises, TimeTicks, NotificationType, ObjectIdentity, MibIdentifier, IpAddress, Counter64, iso, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32, Integer32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "enterprises", "TimeTicks", "NotificationType", "ObjectIdentity", "MibIdentifier", "IpAddress", "Counter64", "iso", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32", "Integer32", "Unsigned32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", enabledDiagnosticAlarms=enabledDiagnosticAlarms, receiveDataRate=receiveDataRate, hTTPSPortNumber=hTTPSPortNumber, versionsGroup=versionsGroup, sMTPServerIPAddress=sMTPServerIPAddress, licence=licence, sNTPSync=sNTPSync, sNTPState=sNTPState, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPLastSync=sNTPLastSync, sNMPEnabledTraps=sNMPEnabledTraps, receivePower=receivePower, snmpControlGroup=snmpControlGroup, dfsPeaks=dfsPeaks, accessMethod=accessMethod, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, versions=versions, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, vectorError=vectorError, wirelessLinkAvailability=wirelessLinkAvailability, pubStatsGroup=pubStatsGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, vLANPriorityTable=vLANPriorityTable, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, bandwidthVariant=bandwidthVariant, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogStateTrap=syslogStateTrap, masterSlaveMode=masterSlaveMode, systemClock=systemClock, tFTPServerIPAddress=tFTPServerIPAddress, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ethernetFiberSupport=ethernetFiberSupport, alarmsGroup=alarmsGroup, altitude=altitude, ptpTrapPrefix=ptpTrapPrefix, encryptionGroup=encryptionGroup, telecomGroup=telecomGroup, telecomsChannelStatus=telecomsChannelStatus, telnetAccessEnabled=telnetAccessEnabled, productVariant=productVariant, phyControl=phyControl, telecomsInterface=telecomsInterface, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNTPServerIPAddress=sNTPServerIPAddress, channelBandwidth=channelBandwidth, syslogClient=syslogClient, telecomsChannelStatusTrap=telecomsChannelStatusTrap, hTTPPortNumber=hTTPPortNumber, receiveModulationModeDetail=receiveModulationModeDetail, managementGroup=managementGroup, installStatusTrap=installStatusTrap, transmitPower=transmitPower, antennaGain=antennaGain, dfsMeans=dfsMeans, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dfsTableNumber=dfsTableNumber, linkName=linkName, channelChangeTrap=channelChangeTrap, userTable=userTable, sNMPTrapPortNumber=sNMPTrapPortNumber, transmitModulationMode=transmitModulationMode, dataPortAutoMdix=dataPortAutoMdix, userName=userName, sNMPTrapTable=sNMPTrapTable, sNMPv3Enable=sNMPv3Enable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, licenceGroup=licenceGroup, bootVersion=bootVersion, reset=reset, dfsTableIndex=dfsTableIndex, cambium=cambium, vLANPriorityQueueMapping=vLANPriorityQueueMapping, telecomsLineCode=telecomsLineCode, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkModeOptimisation=linkModeOptimisation, phyControlGroup=phyControlGroup, syslogClientTrap=syslogClientTrap, longitude=longitude, tDDSynchronizationAlarm=tDDSynchronizationAlarm, vLANPriorityTableEntry=vLANPriorityTableEntry, frequencyVariant=frequencyVariant, range=range, systemReset=systemReset, capacityLicenseMismatch=capacityLicenseMismatch, configuration=configuration, sMTPSourceEmailAddress=sMTPSourceEmailAddress, management=management, tDDSynchronizationMode=tDDSynchronizationMode, ptp=ptp, linkSymmetry=linkSymmetry, dataPortDisabledWarning=dataPortDisabledWarning, phyStatusGroup=phyStatusGroup, sNTPSyncTrap=sNTPSyncTrap, transmitFreqMHz=transmitFreqMHz, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, gatewayIPAddress=gatewayIPAddress, telecom=telecom, telecomsCableLength=telecomsCableLength, tFTPServerPortNumber=tFTPServerPortNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, timeZone=timeZone, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfs=dfs, remoteIPAddress=remoteIPAddress, ptpTraps=ptpTraps, vLANManagementPriority=vLANManagementPriority, ptp500=ptp500, supplementary=supplementary, hTTPSAccessEnabled=hTTPSAccessEnabled, noWirelessChannelAvailable=noWirelessChannelAvailable, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPTrapVersion=sNMPTrapVersion, userRole=userRole, telecomsLoopbackTrap=telecomsLoopbackTrap, installArmStateTrap=installArmStateTrap, groupID=groupID, smtp=smtp, userTableEntry=userTableEntry, siteName=siteName, searchState=searchState, sNMPTrapIPAddress=sNMPTrapIPAddress, wirelessLinkStatus=wirelessLinkStatus, cableLoss=cableLoss, sNMPTrapTableEntry=sNMPTrapTableEntry, telnetPortNumber=telnetPortNumber, dataPortStatus=dataPortStatus, notificationsGroup=notificationsGroup, vLANManagementVID=vLANManagementVID, receiveFreqKHz=receiveFreqKHz, pubStats=pubStats, maximumTransmitPower=maximumTransmitPower, sNMPTrapTableIndex=sNMPTrapTableIndex, secondarySoftwareVersion=secondarySoftwareVersion, aggregateDataRate=aggregateDataRate, tDDControlGroup=tDDControlGroup, softwareVersion=softwareVersion, byteErrorRatio=byteErrorRatio, sNTPServerPortNumber=sNTPServerPortNumber, sntpGroup=sntpGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, iPAddress=iPAddress, linkLoss=linkLoss, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, configurationGroup=configurationGroup, smtpGroup=smtpGroup, transmitFreqKHz=transmitFreqKHz, unitOutOfCalibration=unitOutOfCalibration, syslogState=syslogState, encryptionAlgorithm=encryptionAlgorithm, sMTPEnabledMessages=sMTPEnabledMessages, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dfsTable=dfsTable, transmitChannel=transmitChannel, latitude=latitude, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sntp=sntp, aAAControl=aAAControl, hardwareVersion=hardwareVersion, sNMPPortNumber=sNMPPortNumber, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, signalStrengthRatio=signalStrengthRatio, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPCommunityString=sNMPCommunityString, dataPortAutoNegotiation=dataPortAutoNegotiation, subnetMask=subnetMask, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, encryption=encryption, dataPortStatusTrap=dataPortStatusTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, ptpGroups=ptpGroups, daylightSaving=daylightSaving, incompatibleRegionCodes=incompatibleRegionCodes, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, productName=productName, installArmState=installArmState, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, ptmp=ptmp, regionCode=regionCode, dfsTableEntry=dfsTableEntry, vLANPriorityTableNumber=vLANPriorityTableNumber, licensedCapacity=licensedCapacity, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, receiveFreqMHz=receiveFreqMHz, userTableIndex=userTableIndex, targetMACAddress=targetMACAddress, dfsGroup=dfsGroup, receiveModulationMode=receiveModulationMode, userEnabled=userEnabled, syslogControlGroup=syslogControlGroup, sNTPPollInterval=sNTPPollInterval, userPassword=userPassword, phyStatus=phyStatus, telecomsLoopback=telecomsLoopback, eIRP=eIRP, hTTPAccessEnabled=hTTPAccessEnabled, regionCodeTrap=regionCodeTrap, alarms=alarms, sMTPServerPortNumber=sMTPServerPortNumber, installStatus=installStatus, snmpControl=snmpControl, receiveChannel=receiveChannel, ethernet=ethernet, PYSNMP_MODULE_ID=cambium, sMTPEmailAlert=sMTPEmailAlert, aAAControlGroup=aAAControlGroup, tDDControl=tDDControl, supplementaryGroup=supplementaryGroup, transmitDataRate=transmitDataRate, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, userTableNumber=userTableNumber, syslogControl=syslogControl, resetGroup=resetGroup, ptpCompliance=ptpCompliance, ethernetGroup=ethernetGroup)
