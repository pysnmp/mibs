...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", hardwareVersion=hardwareVersion, tDDSynchronizationMode=tDDSynchronizationMode, configurationGroup=configurationGroup, wirelessLinkStatus=wirelessLinkStatus, sNMPPortNumber=sNMPPortNumber, hTTPSPortNumber=hTTPSPortNumber, bandwidthVariant=bandwidthVariant, telnetPortNumber=telnetPortNumber, syslogControlGroup=syslogControlGroup, masterSlaveMode=masterSlaveMode, sNTPServerPortNumber=sNTPServerPortNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPCommunityString=sNMPCommunityString, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPTrapIPAddress=sNMPTrapIPAddress, siteName=siteName, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, phyControl=phyControl, groupID=groupID, cambium=cambium, channelBandwidth=channelBandwidth, constantPowerSpectralDensity=constantPowerSpectralDensity, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, syslogControl=syslogControl, configuration=configuration, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, versionsGroup=versionsGroup, dataPortStatusTrap=dataPortStatusTrap, snmpControl=snmpControl, receiveFreqKHz=receiveFreqKHz, systemReset=systemReset, aggregateDataRate=aggregateDataRate, ptpTraps=ptpTraps, altitude=altitude, installArmStateTrap=installArmStateTrap, phyStatusGroup=phyStatusGroup, receiveChannel=receiveChannel, aAAControl=aAAControl, ethernetGroup=ethernetGroup, aAAControlGroup=aAAControlGroup, transmitModulationMode=transmitModulationMode, syslogState=syslogState, systemClock=systemClock, phyStatus=phyStatus, sMTPServerPortNumber=sMTPServerPortNumber, syslogStateTrap=syslogStateTrap, smtpGroup=smtpGroup, sNTPState=sNTPState, licenceGroup=licenceGroup, sNTPSyncTrap=sNTPSyncTrap, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, receiveFreqMHz=receiveFreqMHz, receivePower=receivePower, tDDSynchronizationAlarm=tDDSynchronizationAlarm, transmitDataRate=transmitDataRate, vLANPriorityTableIndex=vLANPriorityTableIndex, syslogClient=syslogClient, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, ethernet=ethernet, sMTPEmailAlert=sMTPEmailAlert, ptp=ptp, sNTPPollInterval=sNTPPollInterval, alarms=alarms, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, secondarySoftwareVersion=secondarySoftwareVersion, longitude=longitude, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, reset=reset, encryptionAlgorithm=encryptionAlgorithm, enabledDiagnosticAlarms=enabledDiagnosticAlarms, installStatusTrap=installStatusTrap, searchState=searchState, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, versions=versions, range=range, byteErrorRatio=byteErrorRatio, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitFreqKHz=transmitFreqKHz, userName=userName, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortConfigurationMismatch=dataPortConfigurationMismatch, vLANPriorityTable=vLANPriorityTable, telecomsInterface=telecomsInterface, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortAutoMdix=dataPortAutoMdix, PYSNMP_MODULE_ID=cambium, productVariant=productVariant, regionCode=regionCode, sNMPv3Enable=sNMPv3Enable, sNTPSync=sNTPSync, dfsPeaks=dfsPeaks, antennaGain=antennaGain, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNMPTrapPortNumber=sNMPTrapPortNumber, telecomsLoopback=telecomsLoopback, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tDDControl=tDDControl, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsGroup=dfsGroup, telecomGroup=telecomGroup, tDDControlGroup=tDDControlGroup, incompatibleRegionCodes=incompatibleRegionCodes, phyControlGroup=phyControlGroup, telecom=telecom, telecomsChannelStatus=telecomsChannelStatus, managementGroup=managementGroup, telecomsLineCode=telecomsLineCode, sNTPLastSync=sNTPLastSync, channelChangeTrap=channelChangeTrap, wirelessLinkAvailability=wirelessLinkAvailability, notificationsGroup=notificationsGroup, snmpControlGroup=snmpControlGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, resetGroup=resetGroup, vLANManagementVID=vLANManagementVID, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sMTPEnabledMessages=sMTPEnabledMessages, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ethernetFiberSupport=ethernetFiberSupport, transmitPower=transmitPower, remoteIPAddress=remoteIPAddress, ptp500=ptp500, eIRP=eIRP, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapTable=sNMPTrapTable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, frequencyVariant=frequencyVariant, ptpCompliance=ptpCompliance, targetMACAddress=targetMACAddress, userTable=userTable, cableLoss=cableLoss, vLANPriorityQueueMapping=vLANPriorityQueueMapping, receiveModulationMode=receiveModulationMode, ptpGroups=ptpGroups, maximumTransmitPower=maximumTransmitPower, telnetAccessEnabled=telnetAccessEnabled, vLANManagementPriority=vLANManagementPriority, receiveModulationModeDetail=receiveModulationModeDetail, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, daylightSaving=daylightSaving, dataPortDisabledWarning=dataPortDisabledWarning, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, supplementaryGroup=supplementaryGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, licence=licence, ptmp=ptmp, dfsTableIndex=dfsTableIndex, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, hTTPPortNumber=hTTPPortNumber, pubStats=pubStats, sNMPTrapVersion=sNMPTrapVersion, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dfs=dfs, userEnabled=userEnabled, userPassword=userPassword, smtp=smtp, linkName=linkName, timeZone=timeZone, syslogClientTrap=syslogClientTrap, userRole=userRole, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sntp=sntp, licensedCapacity=licensedCapacity, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, signalStrengthRatio=signalStrengthRatio, dfsTable=dfsTable, installStatus=installStatus, pubStatsGroup=pubStatsGroup, linkLoss=linkLoss, dfsTableNumber=dfsTableNumber, sntpGroup=sntpGroup, sNMPEnabledTraps=sNMPEnabledTraps, unitOutOfCalibration=unitOutOfCalibration, encryption=encryption, productName=productName, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, subnetMask=subnetMask, vectorError=vectorError, regionCodeTrap=regionCodeTrap, capacityLicenseMismatch=capacityLicenseMismatch, linkSymmetry=linkSymmetry, telecomsCableLength=telecomsCableLength, dfsMeans=dfsMeans, userTableEntry=userTableEntry, vLANPriorityTableNumber=vLANPriorityTableNumber, alarmsGroup=alarmsGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, linkModeOptimisation=linkModeOptimisation, iPAddress=iPAddress, sMTPServerIPAddress=sMTPServerIPAddress, userTableNumber=userTableNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPServerIPAddress=sNTPServerIPAddress, hTTPAccessEnabled=hTTPAccessEnabled, softwareVersion=softwareVersion, encryptionGroup=encryptionGroup, bootVersion=bootVersion, accessMethod=accessMethod, transmitFreqMHz=transmitFreqMHz, management=management, ptpTrapPrefix=ptpTrapPrefix, remoteMaximumTransmitPower=remoteMaximumTransmitPower, gatewayIPAddress=gatewayIPAddress, dataPortStatus=dataPortStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortWirelessDownAlert=dataPortWirelessDownAlert, receiveDataRate=receiveDataRate, latitude=latitude, userTableIndex=userTableIndex, transmitChannel=transmitChannel, dfsTableEntry=dfsTableEntry, installArmState=installArmState, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, supplementary=supplementary)
