...
Counter64, NotificationType, ObjectIdentity, TimeTicks, Unsigned32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, MibIdentifier, IpAddress, enterprises, Integer32, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "ObjectIdentity", "TimeTicks", "Unsigned32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "MibIdentifier", "IpAddress", "enterprises", "Integer32", "Gauge32", "iso")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", alarmsGroup=alarmsGroup, tDDControlGroup=tDDControlGroup, versions=versions, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortAutoMdix=dataPortAutoMdix, secondarySoftwareVersion=secondarySoftwareVersion, vectorError=vectorError, wirelessLinkAvailability=wirelessLinkAvailability, smtpGroup=smtpGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tDDSynchronizationAlarm=tDDSynchronizationAlarm, userEnabled=userEnabled, pubStatsGroup=pubStatsGroup, longitude=longitude, ptmp=ptmp, receivePower=receivePower, incompatibleRegionCodes=incompatibleRegionCodes, pubStats=pubStats, enabledDiagnosticAlarms=enabledDiagnosticAlarms, telecomsChannelStatusTrap=telecomsChannelStatusTrap, snmpControlGroup=snmpControlGroup, ptpTrapPrefix=ptpTrapPrefix, configurationGroup=configurationGroup, phyControl=phyControl, licenceGroup=licenceGroup, linkName=linkName, sNTPServerIPAddress=sNTPServerIPAddress, systemClock=systemClock, sNMPTrapTable=sNMPTrapTable, installStatus=installStatus, dfsGroup=dfsGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, masterSlaveMode=masterSlaveMode, dfsTableEntry=dfsTableEntry, transmitModulationMode=transmitModulationMode, noWirelessChannelAvailable=noWirelessChannelAvailable, notificationsGroup=notificationsGroup, ethernetFiberSupport=ethernetFiberSupport, timeZone=timeZone, ptpTraps=ptpTraps, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, syslogControlGroup=syslogControlGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, telecomGroup=telecomGroup, sNTPState=sNTPState, dfsTableNumber=dfsTableNumber, smtp=smtp, linkSymmetry=linkSymmetry, snmpControl=snmpControl, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dfsPeaks=dfsPeaks, sNMPPortNumber=sNMPPortNumber, frequencyVariant=frequencyVariant, ptp500=ptp500, tDDSynchronizationMode=tDDSynchronizationMode, remoteIPAddress=remoteIPAddress, tFTPServerPortNumber=tFTPServerPortNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, receiveFreqKHz=receiveFreqKHz, systemReset=systemReset, syslogStateTrap=syslogStateTrap, dfsTableIndex=dfsTableIndex, vLANPriorityTable=vLANPriorityTable, vLANPriorityTableNumber=vLANPriorityTableNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, signalStrengthRatio=signalStrengthRatio, syslogControl=syslogControl, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, searchState=searchState, channelChangeTrap=channelChangeTrap, telecomsCableLength=telecomsCableLength, aAAControlGroup=aAAControlGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, managementGroup=managementGroup, iPAddress=iPAddress, installStatusTrap=installStatusTrap, installArmState=installArmState, userTableEntry=userTableEntry, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dataPortDisabledWarning=dataPortDisabledWarning, cableLoss=cableLoss, transmitFreqMHz=transmitFreqMHz, sNMPTrapVersion=sNMPTrapVersion, productVariant=productVariant, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, aAAControl=aAAControl, installArmStateTrap=installArmStateTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, management=management, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telecomsLoopback=telecomsLoopback, versionsGroup=versionsGroup, dataPortStatusTrap=dataPortStatusTrap, vLANPriorityQueueMapping=vLANPriorityQueueMapping, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, transmitFreqKHz=transmitFreqKHz, sNMPTrapTableIndex=sNMPTrapTableIndex, bootVersion=bootVersion, groupID=groupID, telecomsInterface=telecomsInterface, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPCommunityString=sNMPCommunityString, ptpGroups=ptpGroups, eIRP=eIRP, productName=productName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPServerPortNumber=sMTPServerPortNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, phyStatus=phyStatus, phyControlGroup=phyControlGroup, unitOutOfCalibration=unitOutOfCalibration, sMTPServerIPAddress=sMTPServerIPAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dfs=dfs, transmitChannel=transmitChannel, licence=licence, wirelessLinkStatus=wirelessLinkStatus, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, subnetMask=subnetMask, vLANManagementPriority=vLANManagementPriority, syslogClient=syslogClient, hardwareVersion=hardwareVersion, userTable=userTable, userName=userName, tFTPServerIPAddress=tFTPServerIPAddress, receiveModulationMode=receiveModulationMode, telecomsLoopbackTrap=telecomsLoopbackTrap, sNTPSyncTrap=sNTPSyncTrap, reset=reset, alarms=alarms, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPTrapTableNumber=sNMPTrapTableNumber, vLANPriorityTableIndex=vLANPriorityTableIndex, userRole=userRole, PYSNMP_MODULE_ID=cambium, sntpGroup=sntpGroup, channelBandwidth=channelBandwidth, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, linkModeOptimisation=linkModeOptimisation, telecomsChannelStatus=telecomsChannelStatus, ptpCompliance=ptpCompliance, syslogState=syslogState, altitude=altitude, maximumTransmitPower=maximumTransmitPower, siteName=siteName, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsTable=dfsTable, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, aggregateDataRate=aggregateDataRate, dataPortAutoNegotiation=dataPortAutoNegotiation, transmitPower=transmitPower, receiveModulationModeDetail=receiveModulationModeDetail, linkLoss=linkLoss, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, receiveChannel=receiveChannel, dfsMeans=dfsMeans, sntp=sntp, hTTPPortNumber=hTTPPortNumber, userTableNumber=userTableNumber, licensedCapacity=licensedCapacity, sNMPv3Enable=sNMPv3Enable, sNMPTrapPortNumber=sNMPTrapPortNumber, phyStatusGroup=phyStatusGroup, cambium=cambium, ptp=ptp, userTableIndex=userTableIndex, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPEnabledTraps=sNMPEnabledTraps, regionCodeTrap=regionCodeTrap, encryptionAlgorithm=encryptionAlgorithm, useVLANForManagementInterfaces=useVLANForManagementInterfaces, encryptionGroup=encryptionGroup, sNTPPollInterval=sNTPPollInterval, supplementary=supplementary, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, regionCode=regionCode, linkModeOptimizationMismatch=linkModeOptimizationMismatch, softwareVersion=softwareVersion, gatewayIPAddress=gatewayIPAddress, dataPortStatus=dataPortStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, vLANManagementVID=vLANManagementVID, hTTPSPortNumber=hTTPSPortNumber, capacityLicenseMismatch=capacityLicenseMismatch, telecomsLineCode=telecomsLineCode, sNTPSync=sNTPSync, targetMACAddress=targetMACAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, ethernetGroup=ethernetGroup, bandwidthVariant=bandwidthVariant, syslogClientTrap=syslogClientTrap, accessMethod=accessMethod, sNMPTrapIPAddress=sNMPTrapIPAddress, userPassword=userPassword, encryption=encryption, latitude=latitude, supplementaryGroup=supplementaryGroup, byteErrorRatio=byteErrorRatio, receiveFreqMHz=receiveFreqMHz, sMTPEnabledMessages=sMTPEnabledMessages, configuration=configuration, sMTPEmailAlert=sMTPEmailAlert, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, hTTPAccessEnabled=hTTPAccessEnabled, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tDDControl=tDDControl, transmitDataRate=transmitDataRate, receiveDataRate=receiveDataRate, ethernet=ethernet, telnetPortNumber=telnetPortNumber, sNTPServerPortNumber=sNTPServerPortNumber, sNTPLastSync=sNTPLastSync, telnetAccessEnabled=telnetAccessEnabled, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telecom=telecom, resetGroup=resetGroup, daylightSaving=daylightSaving, range=range, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, antennaGain=antennaGain)
