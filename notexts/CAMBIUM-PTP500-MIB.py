...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sNMPTrapVersion=sNMPTrapVersion, masterSlaveMode=masterSlaveMode, telecomsLineCode=telecomsLineCode, sMTPServerPortNumber=sMTPServerPortNumber, receiveDataRate=receiveDataRate, linkLoss=linkLoss, versionsGroup=versionsGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptp500=ptp500, hTTPSPortNumber=hTTPSPortNumber, dataPortStatus=dataPortStatus, userRole=userRole, dfsTableNumber=dfsTableNumber, iPAddress=iPAddress, productVariant=productVariant, hTTPPortNumber=hTTPPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPv3Enable=sNMPv3Enable, enabledDiagnosticAlarms=enabledDiagnosticAlarms, smtpGroup=smtpGroup, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ptpCompliance=ptpCompliance, managementGroup=managementGroup, receiveFreqMHz=receiveFreqMHz, vLANManagementPriority=vLANManagementPriority, telecomsLoopback=telecomsLoopback, tDDSynchronizationStatus=tDDSynchronizationStatus, gatewayIPAddress=gatewayIPAddress, sNTPServerIPAddress=sNTPServerIPAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, vLANPriorityTableIndex=vLANPriorityTableIndex, softwareVersion=softwareVersion, phyControl=phyControl, bootVersion=bootVersion, wirelessLinkStatus=wirelessLinkStatus, syslogControlGroup=syslogControlGroup, userName=userName, sMTPServerIPAddress=sMTPServerIPAddress, secondarySoftwareVersion=secondarySoftwareVersion, sNMPTrapTableEntry=sNMPTrapTableEntry, transmitChannel=transmitChannel, aggregateDataRate=aggregateDataRate, remoteIPAddress=remoteIPAddress, telecomGroup=telecomGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, telecomsLoopbackTrap=telecomsLoopbackTrap, tDDControlGroup=tDDControlGroup, maximumTransmitPower=maximumTransmitPower, tFTPServerIPAddress=tFTPServerIPAddress, userPassword=userPassword, dfsPeaks=dfsPeaks, userTableEntry=userTableEntry, transmitFreqMHz=transmitFreqMHz, cableLoss=cableLoss, sNMPPortNumber=sNMPPortNumber, userTableNumber=userTableNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sntpGroup=sntpGroup, sntp=sntp, dfsTable=dfsTable, encryptionAlgorithm=encryptionAlgorithm, telecomsChannelStatusTrap=telecomsChannelStatusTrap, snmpControlGroup=snmpControlGroup, phyStatusGroup=phyStatusGroup, hardwareVersion=hardwareVersion, telecomsCableLength=telecomsCableLength, licenceGroup=licenceGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ptp=ptp, signalStrengthRatio=signalStrengthRatio, channelBandwidth=channelBandwidth, sMTPSourceEmailAddress=sMTPSourceEmailAddress, receiveModulationModeDetail=receiveModulationModeDetail, receiveChannel=receiveChannel, sNMPTrapIPAddress=sNMPTrapIPAddress, eIRP=eIRP, range=range, installStatusTrap=installStatusTrap, linkName=linkName, incompatibleRegionCodes=incompatibleRegionCodes, dataPortConfigurationMismatch=dataPortConfigurationMismatch, aAAControl=aAAControl, frequencyVariant=frequencyVariant, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, useVLANForManagementInterfaces=useVLANForManagementInterfaces, userTable=userTable, remoteMaximumTransmitPower=remoteMaximumTransmitPower, constantPowerSpectralDensity=constantPowerSpectralDensity, transmitPower=transmitPower, channelChangeTrap=channelChangeTrap, versions=versions, userEnabled=userEnabled, vLANPriorityTableNumber=vLANPriorityTableNumber, ptmp=ptmp, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, phyControlGroup=phyControlGroup, receivePower=receivePower, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, pubStats=pubStats, dataPortAutoNegotiation=dataPortAutoNegotiation, pubStatsGroup=pubStatsGroup, byteErrorRatio=byteErrorRatio, dataPortStatusTrap=dataPortStatusTrap, productName=productName, tDDSynchronizationMode=tDDSynchronizationMode, dataPortDisabledWarning=dataPortDisabledWarning, noWirelessChannelAvailable=noWirelessChannelAvailable, supplementaryGroup=supplementaryGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, installStatus=installStatus, sNMPTrapTable=sNMPTrapTable, ethernet=ethernet, telecomsChannelStatus=telecomsChannelStatus, regionCodeTrap=regionCodeTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfsTableIndex=dfsTableIndex, dfsMeans=dfsMeans, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, encryptionGroup=encryptionGroup, vLANPriorityTable=vLANPriorityTable, linkSymmetry=linkSymmetry, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, userTableIndex=userTableIndex, sNMPEnabledTraps=sNMPEnabledTraps, siteName=siteName, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPServerPortNumber=sNTPServerPortNumber, bandwidthVariant=bandwidthVariant, vLANPriorityQueueMapping=vLANPriorityQueueMapping, dfs=dfs, transmitModulationMode=transmitModulationMode, sNTPSync=sNTPSync, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, syslogStateTrap=syslogStateTrap, snmpControl=snmpControl, altitude=altitude, configurationGroup=configurationGroup, ethernetFiberSupport=ethernetFiberSupport, ethernetGroup=ethernetGroup, subnetMask=subnetMask, phyStatus=phyStatus, aAAControlGroup=aAAControlGroup, transmitFreqKHz=transmitFreqKHz, hTTPAccessEnabled=hTTPAccessEnabled, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, systemReset=systemReset, tDDControl=tDDControl, vLANManagementVID=vLANManagementVID, encryption=encryption, supplementary=supplementary, alarmsGroup=alarmsGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, syslogLocalWrappedTrap=syslogLocalWrappedTrap, cambium=cambium, sNMPTrapPortNumber=sNMPTrapPortNumber, accessMethod=accessMethod, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, notificationsGroup=notificationsGroup, telnetAccessEnabled=telnetAccessEnabled, dataPortAutoMdix=dataPortAutoMdix, longitude=longitude, systemClock=systemClock, telnetPortNumber=telnetPortNumber, wirelessLinkAvailability=wirelessLinkAvailability, timeZone=timeZone, sNTPLastSync=sNTPLastSync, sNTPSyncTrap=sNTPSyncTrap, syslogState=syslogState, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, syslogControl=syslogControl, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, PYSNMP_MODULE_ID=cambium, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogClient=syslogClient, unitOutOfCalibration=unitOutOfCalibration, smtp=smtp, reset=reset, sMTPEnabledMessages=sMTPEnabledMessages, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, searchState=searchState, transmitDataRate=transmitDataRate, management=management, ptpTrapPrefix=ptpTrapPrefix, telecomsInterface=telecomsInterface, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, targetMACAddress=targetMACAddress, groupID=groupID, regionCode=regionCode, sNMPCommunityString=sNMPCommunityString, configuration=configuration, capacityLicenseMismatch=capacityLicenseMismatch, alarms=alarms, resetGroup=resetGroup, sNTPPollInterval=sNTPPollInterval, latitude=latitude, vectorError=vectorError, syslogClientTrap=syslogClientTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, dfsTableEntry=dfsTableEntry, dfsGroup=dfsGroup, installArmStateTrap=installArmStateTrap, licence=licence, linkModeOptimisation=linkModeOptimisation, telecom=telecom, installArmState=installArmState, receiveModulationMode=receiveModulationMode, sMTPEmailAlert=sMTPEmailAlert, antennaGain=antennaGain, licensedCapacity=licensedCapacity, tFTPServerPortNumber=tFTPServerPortNumber, daylightSaving=daylightSaving, receiveFreqKHz=receiveFreqKHz, sNTPState=sNTPState, ptpGroups=ptpGroups, ptpTraps=ptpTraps, hTTPSAccessEnabled=hTTPSAccessEnabled)
