...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", vLANPriorityTable=vLANPriorityTable, syslogState=syslogState, ptp=ptp, sNMPEnabledTraps=sNMPEnabledTraps, encryption=encryption, ethernet=ethernet, sNMPTrapVersion=sNMPTrapVersion, maximumTransmitPower=maximumTransmitPower, sNMPTrapTableNumber=sNMPTrapTableNumber, telecomsLoopback=telecomsLoopback, cableLoss=cableLoss, syslogStateTrap=syslogStateTrap, tDDSynchronizationMode=tDDSynchronizationMode, linkModeOptimisation=linkModeOptimisation, sNMPv3Enable=sNMPv3Enable, secondarySoftwareVersion=secondarySoftwareVersion, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, groupID=groupID, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, systemClock=systemClock, tDDSynchronizationStatus=tDDSynchronizationStatus, telecomsLoopbackTrap=telecomsLoopbackTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, phyStatusGroup=phyStatusGroup, receiveFreqMHz=receiveFreqMHz, sMTPServerIPAddress=sMTPServerIPAddress, supplementaryGroup=supplementaryGroup, dfs=dfs, vLANManagementVID=vLANManagementVID, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tDDControl=tDDControl, telecomGroup=telecomGroup, syslogControl=syslogControl, userRole=userRole, pubStatsGroup=pubStatsGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPCommunityString=sNMPCommunityString, sNTPSync=sNTPSync, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, systemReset=systemReset, telecomsCableLength=telecomsCableLength, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ptpTrapPrefix=ptpTrapPrefix, vLANPriorityTableNumber=vLANPriorityTableNumber, PYSNMP_MODULE_ID=cambium, installArmState=installArmState, telecom=telecom, transmitChannel=transmitChannel, dataPortDisabledWarning=dataPortDisabledWarning, dataPortAutoMdix=dataPortAutoMdix, hardwareVersion=hardwareVersion, bootVersion=bootVersion, receiveDataRate=receiveDataRate, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, reset=reset, dfsTable=dfsTable, dataPortConfigurationMismatch=dataPortConfigurationMismatch, syslogClient=syslogClient, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, vLANManagementPriority=vLANManagementPriority, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, smtp=smtp, receivePower=receivePower, sMTPEnabledMessages=sMTPEnabledMessages, noWirelessChannelAvailable=noWirelessChannelAvailable, telnetAccessEnabled=telnetAccessEnabled, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, aAAControlGroup=aAAControlGroup, sMTPEmailAlert=sMTPEmailAlert, linkName=linkName, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, userTable=userTable, phyStatus=phyStatus, receiveModulationMode=receiveModulationMode, sNMPPortNumber=sNMPPortNumber, installStatusTrap=installStatusTrap, encryptionAlgorithm=encryptionAlgorithm, dataPortWirelessDownAlert=dataPortWirelessDownAlert, userName=userName, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ptpGroups=ptpGroups, antennaGain=antennaGain, userTableIndex=userTableIndex, hTTPPortNumber=hTTPPortNumber, configuration=configuration, eIRP=eIRP, productVariant=productVariant, licensedCapacity=licensedCapacity, notificationsGroup=notificationsGroup, transmitModulationMode=transmitModulationMode, longitude=longitude, transmitPower=transmitPower, sNTPServerIPAddress=sNTPServerIPAddress, gatewayIPAddress=gatewayIPAddress, sNTPState=sNTPState, unitOutOfCalibration=unitOutOfCalibration, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, telecomsLineCode=telecomsLineCode, syslogControlGroup=syslogControlGroup, targetMACAddress=targetMACAddress, tFTPServerIPAddress=tFTPServerIPAddress, regionCode=regionCode, dfsTableEntry=dfsTableEntry, dataPortStatus=dataPortStatus, smtpGroup=smtpGroup, frequencyVariant=frequencyVariant, userTableNumber=userTableNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernetGroup=ethernetGroup, latitude=latitude, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, siteName=siteName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, installStatus=installStatus, vLANPriorityTableIndex=vLANPriorityTableIndex, sNMPTrapIPAddress=sNMPTrapIPAddress, sntp=sntp, configurationGroup=configurationGroup, snmpControlGroup=snmpControlGroup, subnetMask=subnetMask, tDDControlGroup=tDDControlGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, hTTPSAccessEnabled=hTTPSAccessEnabled, searchState=searchState, sNTPPollInterval=sNTPPollInterval, tFTPServerPortNumber=tFTPServerPortNumber, hTTPSPortNumber=hTTPSPortNumber, softwareVersion=softwareVersion, wirelessLinkStatus=wirelessLinkStatus, channelBandwidth=channelBandwidth, regionCodeTrap=regionCodeTrap, telecomsInterface=telecomsInterface, altitude=altitude, dataPortStatusTrap=dataPortStatusTrap, capacityLicenseMismatch=capacityLicenseMismatch, userEnabled=userEnabled, sNMPTrapTableEntry=sNMPTrapTableEntry, bandwidthVariant=bandwidthVariant, tDDSynchronizationAlarm=tDDSynchronizationAlarm, resetGroup=resetGroup, sNMPTrapTable=sNMPTrapTable, masterSlaveMode=masterSlaveMode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptpCompliance=ptpCompliance, sMTPServerPortNumber=sMTPServerPortNumber, alarmsGroup=alarmsGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfsTableIndex=dfsTableIndex, snmpControl=snmpControl, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPLastSync=sNTPLastSync, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, receiveFreqKHz=receiveFreqKHz, sNTPSyncTrap=sNTPSyncTrap, ptp500=ptp500, iPAddress=iPAddress, linkSymmetry=linkSymmetry, phyControl=phyControl, aAAControl=aAAControl, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, linkLoss=linkLoss, versions=versions, ptpTraps=ptpTraps, vLANPriorityTableEntry=vLANPriorityTableEntry, sNTPServerPortNumber=sNTPServerPortNumber, cambium=cambium, remoteIPAddress=remoteIPAddress, licence=licence, managementGroup=managementGroup, dfsMeans=dfsMeans, vLANPriorityQueueMapping=vLANPriorityQueueMapping, range=range, supplementary=supplementary, phyControlGroup=phyControlGroup, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, encryptionGroup=encryptionGroup, dfsTableNumber=dfsTableNumber, management=management, incompatibleRegionCodes=incompatibleRegionCodes, installArmStateTrap=installArmStateTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, channelChangeTrap=channelChangeTrap, transmitFreqMHz=transmitFreqMHz, telnetPortNumber=telnetPortNumber, syslogClientTrap=syslogClientTrap, sntpGroup=sntpGroup, dfsGroup=dfsGroup, signalStrengthRatio=signalStrengthRatio, transmitDataRate=transmitDataRate, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, receiveChannel=receiveChannel, ptmp=ptmp, licenceGroup=licenceGroup, wirelessLinkAvailability=wirelessLinkAvailability, userPassword=userPassword, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, alarms=alarms, useVLANForManagementInterfaces=useVLANForManagementInterfaces, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dfsPeaks=dfsPeaks, userTableEntry=userTableEntry, dataPortAutoNegotiation=dataPortAutoNegotiation, timeZone=timeZone, hTTPAccessEnabled=hTTPAccessEnabled, telecomsChannelStatus=telecomsChannelStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, productName=productName, pubStats=pubStats, daylightSaving=daylightSaving, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, versionsGroup=versionsGroup, aggregateDataRate=aggregateDataRate, ethernetFiberSupport=ethernetFiberSupport, accessMethod=accessMethod, receiveModulationModeDetail=receiveModulationModeDetail, vectorError=vectorError, transmitFreqKHz=transmitFreqKHz, byteErrorRatio=byteErrorRatio)
