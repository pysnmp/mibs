...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", linkModeOptimisation=linkModeOptimisation, tDDSynchronizationAlarm=tDDSynchronizationAlarm, hTTPPortNumber=hTTPPortNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, syslogControl=syslogControl, secondarySoftwareVersion=secondarySoftwareVersion, cambium=cambium, tDDControl=tDDControl, configurationGroup=configurationGroup, regionCode=regionCode, frequencyVariant=frequencyVariant, masterSlaveMode=masterSlaveMode, capacityLicenseMismatch=capacityLicenseMismatch, maximumTransmitPower=maximumTransmitPower, telecomsLineCode=telecomsLineCode, aggregateDataRate=aggregateDataRate, sNMPTrapIPAddress=sNMPTrapIPAddress, userPassword=userPassword, ptpCompliance=ptpCompliance, systemClock=systemClock, userRole=userRole, telnetPortNumber=telnetPortNumber, receiveFreqKHz=receiveFreqKHz, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, telecom=telecom, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPEnabledTraps=sNMPEnabledTraps, timeZone=timeZone, hardwareVersion=hardwareVersion, phyControl=phyControl, noWirelessChannelAvailable=noWirelessChannelAvailable, accessMethod=accessMethod, sNTPLastSync=sNTPLastSync, management=management, versions=versions, licenceGroup=licenceGroup, encryptionGroup=encryptionGroup, sNMPTrapTable=sNMPTrapTable, reset=reset, linkName=linkName, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sntpGroup=sntpGroup, sNTPState=sNTPState, groupID=groupID, hTTPSPortNumber=hTTPSPortNumber, receiveChannel=receiveChannel, sMTPServerIPAddress=sMTPServerIPAddress, subnetMask=subnetMask, transmitModulationMode=transmitModulationMode, linkSymmetry=linkSymmetry, bootVersion=bootVersion, sNMPv3Enable=sNMPv3Enable, vectorError=vectorError, installArmStateTrap=installArmStateTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, remoteMaximumTransmitPower=remoteMaximumTransmitPower, range=range, telecomsCableLength=telecomsCableLength, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNMPTrapVersion=sNMPTrapVersion, resetGroup=resetGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, tDDSynchronizationMode=tDDSynchronizationMode, incompatibleRegionCodes=incompatibleRegionCodes, telecomsLoopback=telecomsLoopback, remoteIPAddress=remoteIPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, regionCodeTrap=regionCodeTrap, installStatusTrap=installStatusTrap, snmpControl=snmpControl, versionsGroup=versionsGroup, PYSNMP_MODULE_ID=cambium, linkLoss=linkLoss, vLANPriorityTableNumber=vLANPriorityTableNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPPollInterval=sNTPPollInterval, telecomsLoopbackTrap=telecomsLoopbackTrap, ptmp=ptmp, ethernetFiberSupport=ethernetFiberSupport, dataPortDisabledWarning=dataPortDisabledWarning, ptpTrapPrefix=ptpTrapPrefix, phyControlGroup=phyControlGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ptpTraps=ptpTraps, dfs=dfs, linkModeOptimizationMismatch=linkModeOptimizationMismatch, userTableNumber=userTableNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, searchState=searchState, receiveModulationMode=receiveModulationMode, unitOutOfCalibration=unitOutOfCalibration, userTableEntry=userTableEntry, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, phyStatusGroup=phyStatusGroup, ptpGroups=ptpGroups, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, softwareVersion=softwareVersion, phyStatus=phyStatus, channelBandwidth=channelBandwidth, dfsMeans=dfsMeans, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ptp500=ptp500, encryption=encryption, dataPortAutoNegotiation=dataPortAutoNegotiation, sMTPEmailAlert=sMTPEmailAlert, dataPortStatusTrap=dataPortStatusTrap, bandwidthVariant=bandwidthVariant, sNMPTrapTableIndex=sNMPTrapTableIndex, ethernet=ethernet, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vLANPriorityTable=vLANPriorityTable, wirelessLinkStatus=wirelessLinkStatus, sMTPServerPortNumber=sMTPServerPortNumber, dfsTableEntry=dfsTableEntry, userName=userName, ethernetGroup=ethernetGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, userTableIndex=userTableIndex, latitude=latitude, productName=productName, telnetAccessEnabled=telnetAccessEnabled, dfsTableNumber=dfsTableNumber, siteName=siteName, telecomsChannelStatus=telecomsChannelStatus, vLANPriorityTableEntry=vLANPriorityTableEntry, dfsPeaks=dfsPeaks, userTable=userTable, aAAControlGroup=aAAControlGroup, syslogState=syslogState, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPSync=sNTPSync, smtp=smtp, encryptionAlgorithm=encryptionAlgorithm, supplementary=supplementary, syslogClient=syslogClient, targetMACAddress=targetMACAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, receiveModulationModeDetail=receiveModulationModeDetail, tFTPServerPortNumber=tFTPServerPortNumber, tDDControlGroup=tDDControlGroup, dfsTable=dfsTable, receiveFreqMHz=receiveFreqMHz, pubStats=pubStats, transmitFreqKHz=transmitFreqKHz, sNMPTrapPortNumber=sNMPTrapPortNumber, dfsTableIndex=dfsTableIndex, installArmState=installArmState, aAAControl=aAAControl, snmpControlGroup=snmpControlGroup, userEnabled=userEnabled, daylightSaving=daylightSaving, byteErrorRatio=byteErrorRatio, vLANManagementVID=vLANManagementVID, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sntp=sntp, alarms=alarms, dataPortStatus=dataPortStatus, dataPortWirelessDownAlert=dataPortWirelessDownAlert, vLANPriorityTableIndex=vLANPriorityTableIndex, vLANPriorityQueueMapping=vLANPriorityQueueMapping, longitude=longitude, sNTPServerIPAddress=sNTPServerIPAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, antennaGain=antennaGain, productVariant=productVariant, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, installStatus=installStatus, sMTPEnabledMessages=sMTPEnabledMessages, hTTPAccessEnabled=hTTPAccessEnabled, syslogStateTrap=syslogStateTrap, smtpGroup=smtpGroup, vLANManagementPriority=vLANManagementPriority, enabledDiagnosticAlarms=enabledDiagnosticAlarms, channelChangeTrap=channelChangeTrap, dataPortAutoMdix=dataPortAutoMdix, configuration=configuration, notificationsGroup=notificationsGroup, gatewayIPAddress=gatewayIPAddress, sNMPCommunityString=sNMPCommunityString, telecomsChannelStatusTrap=telecomsChannelStatusTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, receivePower=receivePower, telecomsInterface=telecomsInterface, alarmsGroup=alarmsGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, telecomGroup=telecomGroup, syslogClientTrap=syslogClientTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, licence=licence, dfsGroup=dfsGroup, signalStrengthRatio=signalStrengthRatio, iPAddress=iPAddress, pubStatsGroup=pubStatsGroup, transmitPower=transmitPower, constantPowerSpectralDensity=constantPowerSpectralDensity, hTTPSAccessEnabled=hTTPSAccessEnabled, managementGroup=managementGroup, licensedCapacity=licensedCapacity, supplementaryGroup=supplementaryGroup, wirelessLinkAvailability=wirelessLinkAvailability, sNTPSyncTrap=sNTPSyncTrap, sNTPServerPortNumber=sNTPServerPortNumber, ptp=ptp, sNMPPortNumber=sNMPPortNumber, altitude=altitude, sNMPTrapTableEntry=sNMPTrapTableEntry, transmitFreqMHz=transmitFreqMHz, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tFTPServerIPAddress=tFTPServerIPAddress, eIRP=eIRP, receiveDataRate=receiveDataRate, systemReset=systemReset, transmitDataRate=transmitDataRate, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, transmitChannel=transmitChannel, syslogControlGroup=syslogControlGroup, cableLoss=cableLoss)
