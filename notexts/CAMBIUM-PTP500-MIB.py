...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", installArmState=installArmState, encryptionAlgorithm=encryptionAlgorithm, dataPortDisabledWarning=dataPortDisabledWarning, cambium=cambium, range=range, transmitFreqKHz=transmitFreqKHz, ptp=ptp, remoteIPAddress=remoteIPAddress, ptpGroups=ptpGroups, syslogState=syslogState, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dfsTableEntry=dfsTableEntry, daylightSaving=daylightSaving, receiveFreqMHz=receiveFreqMHz, tDDControl=tDDControl, vLANPriorityQueueMapping=vLANPriorityQueueMapping, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, productName=productName, telecom=telecom, wirelessLinkStatus=wirelessLinkStatus, aggregateDataRate=aggregateDataRate, sNMPTrapVersion=sNMPTrapVersion, tDDSynchronizationAlarm=tDDSynchronizationAlarm, telecomsInterface=telecomsInterface, searchState=searchState, userTableNumber=userTableNumber, smtpGroup=smtpGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, ethernetGroup=ethernetGroup, userEnabled=userEnabled, receivePower=receivePower, dfsGroup=dfsGroup, pubStats=pubStats, dataPortWirelessDownAlert=dataPortWirelessDownAlert, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPServerIPAddress=sNTPServerIPAddress, syslogStateTrap=syslogStateTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, dfsTableIndex=dfsTableIndex, remoteMaximumTransmitPower=remoteMaximumTransmitPower, iPAddress=iPAddress, transmitChannel=transmitChannel, telecomGroup=telecomGroup, channelBandwidth=channelBandwidth, productVariant=productVariant, tDDSynchronizationMode=tDDSynchronizationMode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, licenceGroup=licenceGroup, byteErrorRatio=byteErrorRatio, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, versions=versions, dataPortConfigurationMismatch=dataPortConfigurationMismatch, regionCode=regionCode, sNTPPollInterval=sNTPPollInterval, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, notificationsGroup=notificationsGroup, linkLoss=linkLoss, dfsMeans=dfsMeans, receiveDataRate=receiveDataRate, reset=reset, bandwidthVariant=bandwidthVariant, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, encryptionGroup=encryptionGroup, cableLoss=cableLoss, snmpControl=snmpControl, sNMPv3Enable=sNMPv3Enable, userTable=userTable, phyControlGroup=phyControlGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, wirelessLinkAvailability=wirelessLinkAvailability, frequencyVariant=frequencyVariant, groupID=groupID, syslogClientTrap=syslogClientTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, supplementaryGroup=supplementaryGroup, encryption=encryption, sNMPTrapTable=sNMPTrapTable, dataPortStatusTrap=dataPortStatusTrap, transmitDataRate=transmitDataRate, userTableIndex=userTableIndex, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dataPortAutoMdix=dataPortAutoMdix, secondarySoftwareVersion=secondarySoftwareVersion, noWirelessChannelAvailable=noWirelessChannelAvailable, systemClock=systemClock, userTableEntry=userTableEntry, ptp500=ptp500, syslogControl=syslogControl, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPServerPortNumber=sNTPServerPortNumber, dfs=dfs, accessMethod=accessMethod, ethernetFiberSupport=ethernetFiberSupport, phyStatusGroup=phyStatusGroup, receiveModulationMode=receiveModulationMode, supplementary=supplementary, installStatusTrap=installStatusTrap, vLANManagementPriority=vLANManagementPriority, installArmStateTrap=installArmStateTrap, targetMACAddress=targetMACAddress, altitude=altitude, siteName=siteName, dataPortStatus=dataPortStatus, resetGroup=resetGroup, sNTPLastSync=sNTPLastSync, telecomsLoopbackTrap=telecomsLoopbackTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, telecomsLineCode=telecomsLineCode, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, softwareVersion=softwareVersion, versionsGroup=versionsGroup, userPassword=userPassword, phyStatus=phyStatus, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, ethernet=ethernet, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sMTPSourceEmailAddress=sMTPSourceEmailAddress, syslogClient=syslogClient, hTTPSPortNumber=hTTPSPortNumber, sNTPState=sNTPState, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, subnetMask=subnetMask, tFTPServerPortNumber=tFTPServerPortNumber, telnetAccessEnabled=telnetAccessEnabled, licensedCapacity=licensedCapacity, ptmp=ptmp, receiveFreqKHz=receiveFreqKHz, telecomsCableLength=telecomsCableLength, aAAControlGroup=aAAControlGroup, transmitModulationMode=transmitModulationMode, hardwareVersion=hardwareVersion, vLANManagementVID=vLANManagementVID, pubStatsGroup=pubStatsGroup, timeZone=timeZone, telecomsLoopback=telecomsLoopback, snmpControlGroup=snmpControlGroup, receiveChannel=receiveChannel, sNTPSync=sNTPSync, hTTPAccessEnabled=hTTPAccessEnabled, userRole=userRole, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, channelChangeTrap=channelChangeTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, userName=userName, ptpTrapPrefix=ptpTrapPrefix, sMTPServerPortNumber=sMTPServerPortNumber, alarmsGroup=alarmsGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, vLANPriorityTableEntry=vLANPriorityTableEntry, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, receiveModulationModeDetail=receiveModulationModeDetail, transmitFreqMHz=transmitFreqMHz, PYSNMP_MODULE_ID=cambium, sNTPSyncTrap=sNTPSyncTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPPortNumber=sNMPPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, hTTPPortNumber=hTTPPortNumber, sMTPServerIPAddress=sMTPServerIPAddress, telecomsChannelStatus=telecomsChannelStatus, configurationGroup=configurationGroup, latitude=latitude, sMTPEnabledMessages=sMTPEnabledMessages, longitude=longitude, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, management=management, regionCodeTrap=regionCodeTrap, capacityLicenseMismatch=capacityLicenseMismatch, phyControl=phyControl, configuration=configuration, unitOutOfCalibration=unitOutOfCalibration, sMTPEmailAlert=sMTPEmailAlert, signalStrengthRatio=signalStrengthRatio, vLANPriorityTable=vLANPriorityTable, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, incompatibleRegionCodes=incompatibleRegionCodes, sNMPTrapPortNumber=sNMPTrapPortNumber, maximumTransmitPower=maximumTransmitPower, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, managementGroup=managementGroup, linkName=linkName, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, bootVersion=bootVersion, linkSymmetry=linkSymmetry, masterSlaveMode=masterSlaveMode, sNMPCommunityString=sNMPCommunityString, licence=licence, ptpCompliance=ptpCompliance, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, eIRP=eIRP, gatewayIPAddress=gatewayIPAddress, dfsTable=dfsTable, vLANPriorityTableNumber=vLANPriorityTableNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, tDDControlGroup=tDDControlGroup, linkModeOptimisation=linkModeOptimisation, dfsPeaks=dfsPeaks, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sntpGroup=sntpGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sntp=sntp, transmitPower=transmitPower, alarms=alarms, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, vectorError=vectorError, aAAControl=aAAControl, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dfsTableNumber=dfsTableNumber, smtp=smtp, telnetPortNumber=telnetPortNumber, ptpTraps=ptpTraps, systemReset=systemReset, installStatus=installStatus, constantPowerSpectralDensity=constantPowerSpectralDensity, antennaGain=antennaGain, syslogControlGroup=syslogControlGroup)
