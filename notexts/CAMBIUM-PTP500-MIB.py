...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", dfsMeans=dfsMeans, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPv3Enable=sNMPv3Enable, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ptmp=ptmp, sNMPTrapTableEntry=sNMPTrapTableEntry, telecomsChannelStatusTrap=telecomsChannelStatusTrap, installArmStateTrap=installArmStateTrap, ethernet=ethernet, sMTPEnabledMessages=sMTPEnabledMessages, userPassword=userPassword, systemReset=systemReset, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dfsPeaks=dfsPeaks, ptpTrapPrefix=ptpTrapPrefix, managementGroup=managementGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, installStatus=installStatus, sNMPTrapTable=sNMPTrapTable, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, antennaGain=antennaGain, syslogControl=syslogControl, dataPortAutoMdix=dataPortAutoMdix, productName=productName, sntp=sntp, receiveChannel=receiveChannel, linkModeOptimisation=linkModeOptimisation, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, aggregateDataRate=aggregateDataRate, ptpTraps=ptpTraps, sMTPEmailAlert=sMTPEmailAlert, aAAControlGroup=aAAControlGroup, transmitChannel=transmitChannel, telecomsCableLength=telecomsCableLength, dataPortConfigurationMismatch=dataPortConfigurationMismatch, transmitDataRate=transmitDataRate, smtpGroup=smtpGroup, frequencyVariant=frequencyVariant, userName=userName, latitude=latitude, telecomsInterface=telecomsInterface, sNTPPollInterval=sNTPPollInterval, productVariant=productVariant, iPAddress=iPAddress, licence=licence, ptp500=ptp500, tDDControlGroup=tDDControlGroup, transmitFreqKHz=transmitFreqKHz, snmpControlGroup=snmpControlGroup, linkLoss=linkLoss, linkName=linkName, configuration=configuration, constantPowerSpectralDensity=constantPowerSpectralDensity, byteErrorRatio=byteErrorRatio, receiveModulationMode=receiveModulationMode, installArmState=installArmState, receiveModulationModeDetail=receiveModulationModeDetail, telecomsChannelStatus=telecomsChannelStatus, systemClock=systemClock, regionCode=regionCode, sMTPServerIPAddress=sMTPServerIPAddress, tDDSynchronizationMode=tDDSynchronizationMode, accessMethod=accessMethod, vLANPriorityTableIndex=vLANPriorityTableIndex, dfsTable=dfsTable, dataPortStatusTrap=dataPortStatusTrap, telecomsLoopback=telecomsLoopback, sNTPServerIPAddress=sNTPServerIPAddress, dfsTableIndex=dfsTableIndex, sNTPLastSync=sNTPLastSync, receiveFreqKHz=receiveFreqKHz, notificationsGroup=notificationsGroup, licenceGroup=licenceGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, telnetAccessEnabled=telnetAccessEnabled, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, searchState=searchState, installStatusTrap=installStatusTrap, supplementary=supplementary, dataPortAutoNegotiation=dataPortAutoNegotiation, channelBandwidth=channelBandwidth, telnetPortNumber=telnetPortNumber, incompatibleRegionCodes=incompatibleRegionCodes, sNMPCommunityString=sNMPCommunityString, phyStatusGroup=phyStatusGroup, sntpGroup=sntpGroup, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapPortNumber=sNMPTrapPortNumber, channelChangeTrap=channelChangeTrap, syslogStateTrap=syslogStateTrap, resetGroup=resetGroup, ptpCompliance=ptpCompliance, syslogClient=syslogClient, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsTableNumber=dfsTableNumber, daylightSaving=daylightSaving, userEnabled=userEnabled, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, licensedCapacity=licensedCapacity, softwareVersion=softwareVersion, smtp=smtp, sNMPPortNumber=sNMPPortNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, alarmsGroup=alarmsGroup, pubStats=pubStats, sMTPSourceEmailAddress=sMTPSourceEmailAddress, longitude=longitude, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, vLANPriorityTable=vLANPriorityTable, encryptionAlgorithm=encryptionAlgorithm, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tFTPServerPortNumber=tFTPServerPortNumber, sNTPState=sNTPState, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, cambium=cambium, versionsGroup=versionsGroup, encryptionGroup=encryptionGroup, tFTPServerIPAddress=tFTPServerIPAddress, linkSymmetry=linkSymmetry, secondarySoftwareVersion=secondarySoftwareVersion, groupID=groupID, ethernetFiberSupport=ethernetFiberSupport, userTableNumber=userTableNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, versions=versions, ptpGroups=ptpGroups, phyControlGroup=phyControlGroup, sNTPSyncTrap=sNTPSyncTrap, range=range, altitude=altitude, userTableEntry=userTableEntry, transmitModulationMode=transmitModulationMode, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, targetMACAddress=targetMACAddress, sMTPServerPortNumber=sMTPServerPortNumber, receiveFreqMHz=receiveFreqMHz, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sNTPServerPortNumber=sNTPServerPortNumber, telecomGroup=telecomGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, maximumTransmitPower=maximumTransmitPower, receivePower=receivePower, sNMPTrapVersion=sNMPTrapVersion, receiveDataRate=receiveDataRate, wirelessLinkStatus=wirelessLinkStatus, userRole=userRole, telecom=telecom, ptp=ptp, syslogControlGroup=syslogControlGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, alarms=alarms, hTTPAccessEnabled=hTTPAccessEnabled, syslogLocalWrappedTrap=syslogLocalWrappedTrap, aAAControl=aAAControl, vLANPriorityTableEntry=vLANPriorityTableEntry, cableLoss=cableLoss, siteName=siteName, wirelessLinkAvailability=wirelessLinkAvailability, useVLANForManagementInterfaces=useVLANForManagementInterfaces, snmpControl=snmpControl, telecomsLineCode=telecomsLineCode, bandwidthVariant=bandwidthVariant, pubStatsGroup=pubStatsGroup, unitOutOfCalibration=unitOutOfCalibration, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPTrapIPAddress=sNMPTrapIPAddress, regionCodeTrap=regionCodeTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dfs=dfs, vectorError=vectorError, syslogClientTrap=syslogClientTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortStatus=dataPortStatus, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfsGroup=dfsGroup, reset=reset, capacityLicenseMismatch=capacityLicenseMismatch, dataPortDisabledWarning=dataPortDisabledWarning, transmitPower=transmitPower, ethernetGroup=ethernetGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, vLANManagementPriority=vLANManagementPriority, gatewayIPAddress=gatewayIPAddress, tDDControl=tDDControl, hTTPSAccessEnabled=hTTPSAccessEnabled, masterSlaveMode=masterSlaveMode, hardwareVersion=hardwareVersion, transmitFreqMHz=transmitFreqMHz, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, remoteIPAddress=remoteIPAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, signalStrengthRatio=signalStrengthRatio, hTTPPortNumber=hTTPPortNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, phyStatus=phyStatus, vLANManagementVID=vLANManagementVID, PYSNMP_MODULE_ID=cambium, supplementaryGroup=supplementaryGroup, hTTPSPortNumber=hTTPSPortNumber, userTable=userTable, phyControl=phyControl, sNMPTrapTableNumber=sNMPTrapTableNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dfsTableEntry=dfsTableEntry, subnetMask=subnetMask, eIRP=eIRP, timeZone=timeZone, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, syslogState=syslogState, telecomsLoopbackTrap=telecomsLoopbackTrap, bootVersion=bootVersion, userTableIndex=userTableIndex, configurationGroup=configurationGroup, sNTPSync=sNTPSync, management=management, encryption=encryption)
