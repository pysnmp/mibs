...
# Produced by pysmi-1.1.8 at Fri Jan  7 15:55:16 2022
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", remoteMaximumTransmitPower=remoteMaximumTransmitPower, telecomGroup=telecomGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, receiveFreqMHz=receiveFreqMHz, hTTPSPortNumber=hTTPSPortNumber, snmpControl=snmpControl, sNMPTrapTableEntry=sNMPTrapTableEntry, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ptpGroups=ptpGroups, dfsTableEntry=dfsTableEntry, dataPortAutoMdix=dataPortAutoMdix, pubStatsGroup=pubStatsGroup, ptpTrapPrefix=ptpTrapPrefix, sNTPSyncTrap=sNTPSyncTrap, syslogClientTrap=syslogClientTrap, syslogControl=syslogControl, vLANPriorityTableEntry=vLANPriorityTableEntry, dfsPeaks=dfsPeaks, ethernetFiberSupport=ethernetFiberSupport, timeZone=timeZone, hTTPPortNumber=hTTPPortNumber, syslogState=syslogState, installArmState=installArmState, hTTPSAccessEnabled=hTTPSAccessEnabled, PYSNMP_MODULE_ID=cambium, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, encryptionGroup=encryptionGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, ptpCompliance=ptpCompliance, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, licenceGroup=licenceGroup, userTableIndex=userTableIndex, encryptionAlgorithm=encryptionAlgorithm, altitude=altitude, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sMTPEmailAlert=sMTPEmailAlert, telecomsChannelStatusTrap=telecomsChannelStatusTrap, transmitFreqKHz=transmitFreqKHz, phyControlGroup=phyControlGroup, transmitFreqMHz=transmitFreqMHz, vLANPriorityTableNumber=vLANPriorityTableNumber, smtp=smtp, systemReset=systemReset, sNMPEnabledTraps=sNMPEnabledTraps, searchState=searchState, vLANManagementPriority=vLANManagementPriority, cambium=cambium, pubStats=pubStats, dfsMeans=dfsMeans, sMTPServerIPAddress=sMTPServerIPAddress, siteName=siteName, hardwareVersion=hardwareVersion, dfs=dfs, aggregateDataRate=aggregateDataRate, userEnabled=userEnabled, receiveFreqKHz=receiveFreqKHz, latitude=latitude, syslogStateTrap=syslogStateTrap, linkName=linkName, regionCodeTrap=regionCodeTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, dfsGroup=dfsGroup, receiveDataRate=receiveDataRate, transmitChannel=transmitChannel, iPAddress=iPAddress, sNTPSync=sNTPSync, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, telecomsInterface=telecomsInterface, bandwidthVariant=bandwidthVariant, systemClock=systemClock, bootVersion=bootVersion, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPServerPortNumber=sNTPServerPortNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, byteErrorRatio=byteErrorRatio, tFTPServerPortNumber=tFTPServerPortNumber, configuration=configuration, range=range, hTTPAccessEnabled=hTTPAccessEnabled, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapVersion=sNMPTrapVersion, installStatus=installStatus, alarms=alarms, syslogControlGroup=syslogControlGroup, receiveChannel=receiveChannel, capacityLicenseMismatch=capacityLicenseMismatch, ptpTraps=ptpTraps, userName=userName, incompatibleMasterAndSlave=incompatibleMasterAndSlave, subnetMask=subnetMask, telecomsCableLength=telecomsCableLength, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, transmitPower=transmitPower, supplementary=supplementary, installStatusTrap=installStatusTrap, configurationGroup=configurationGroup, sNMPv3Enable=sNMPv3Enable, management=management, phyControl=phyControl, sMTPServerPortNumber=sMTPServerPortNumber, signalStrengthRatio=signalStrengthRatio, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, supplementaryGroup=supplementaryGroup, sNMPTrapTable=sNMPTrapTable, vLANPriorityTable=vLANPriorityTable, vLANPriorityQueueMapping=vLANPriorityQueueMapping, receiveModulationMode=receiveModulationMode, versionsGroup=versionsGroup, dataPortDisabledWarning=dataPortDisabledWarning, maximumTransmitPower=maximumTransmitPower, sNTPLastSync=sNTPLastSync, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, reset=reset, managementGroup=managementGroup, aAAControlGroup=aAAControlGroup, transmitDataRate=transmitDataRate, wirelessLinkAvailability=wirelessLinkAvailability, sMTPEnabledMessages=sMTPEnabledMessages, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, gatewayIPAddress=gatewayIPAddress, softwareVersion=softwareVersion, dfsTableIndex=dfsTableIndex, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, channelChangeTrap=channelChangeTrap, userTableNumber=userTableNumber, remoteIPAddress=remoteIPAddress, sNTPState=sNTPState, groupID=groupID, userPassword=userPassword, ethernetGroup=ethernetGroup, ptp=ptp, notificationsGroup=notificationsGroup, dfsTableNumber=dfsTableNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, targetMACAddress=targetMACAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPCommunityString=sNMPCommunityString, sntpGroup=sntpGroup, vectorError=vectorError, ethernet=ethernet, dfsTable=dfsTable, tDDControlGroup=tDDControlGroup, sNTPPollInterval=sNTPPollInterval, receiveModulationModeDetail=receiveModulationModeDetail, transmitModulationMode=transmitModulationMode, aAAControl=aAAControl, noWirelessChannelAvailable=noWirelessChannelAvailable, telnetPortNumber=telnetPortNumber, dataPortStatusTrap=dataPortStatusTrap, frequencyVariant=frequencyVariant, sMTPSourceEmailAddress=sMTPSourceEmailAddress, channelBandwidth=channelBandwidth, licensedCapacity=licensedCapacity, ptp500=ptp500, userTableEntry=userTableEntry, linkModeOptimisation=linkModeOptimisation, snmpControlGroup=snmpControlGroup, sNTPServerIPAddress=sNTPServerIPAddress, productName=productName, userRole=userRole, alarmsGroup=alarmsGroup, linkSymmetry=linkSymmetry, telecom=telecom, daylightSaving=daylightSaving, longitude=longitude, sNMPTrapTableNumber=sNMPTrapTableNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, syslogClient=syslogClient, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptmp=ptmp, antennaGain=antennaGain, tFTPServerIPAddress=tFTPServerIPAddress, wirelessLinkStatus=wirelessLinkStatus, installArmStateTrap=installArmStateTrap, linkLoss=linkLoss, telnetAccessEnabled=telnetAccessEnabled, unitOutOfCalibration=unitOutOfCalibration, sNMPPortNumber=sNMPPortNumber, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, tDDSynchronizationMode=tDDSynchronizationMode, telecomsChannelStatus=telecomsChannelStatus, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, phyStatusGroup=phyStatusGroup, smtpGroup=smtpGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, masterSlaveMode=masterSlaveMode, telecomsLineCode=telecomsLineCode, productVariant=productVariant, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortStatus=dataPortStatus, sntp=sntp, eIRP=eIRP, encryption=encryption, receivePower=receivePower, incompatibleRegionCodes=incompatibleRegionCodes, userTable=userTable, versions=versions, secondarySoftwareVersion=secondarySoftwareVersion, phyStatus=phyStatus, licence=licence, dataPortConfigurationMismatch=dataPortConfigurationMismatch, telecomsLoopbackTrap=telecomsLoopbackTrap, telecomsLoopback=telecomsLoopback, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tDDControl=tDDControl, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, resetGroup=resetGroup, accessMethod=accessMethod, regionCode=regionCode, linkModeOptimizationMismatch=linkModeOptimizationMismatch, vLANManagementVID=vLANManagementVID, vLANPriorityTableIndex=vLANPriorityTableIndex, cableLoss=cableLoss)
