...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Integer32, ObjectIdentity, ModuleIdentity, IpAddress, Bits, MibIdentifier, NotificationType, Counter64, Gauge32, TimeTicks, Unsigned32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Integer32", "ObjectIdentity", "ModuleIdentity", "IpAddress", "Bits", "MibIdentifier", "NotificationType", "Counter64", "Gauge32", "TimeTicks", "Unsigned32", "enterprises")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", aAAControlGroup=aAAControlGroup, groupID=groupID, telecomsChannelStatus=telecomsChannelStatus, snmpControlGroup=snmpControlGroup, sNMPv3Enable=sNMPv3Enable, ptpCompliance=ptpCompliance, remoteIPAddress=remoteIPAddress, telecomsCableLength=telecomsCableLength, userEnabled=userEnabled, userTableNumber=userTableNumber, sNTPSyncTrap=sNTPSyncTrap, encryption=encryption, latitude=latitude, altitude=altitude, masterSlaveMode=masterSlaveMode, sMTPEnabledMessages=sMTPEnabledMessages, softwareVersion=softwareVersion, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapTableEntry=sNMPTrapTableEntry, aggregateDataRate=aggregateDataRate, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, ethernetGroup=ethernetGroup, vLANManagementVID=vLANManagementVID, transmitModulationMode=transmitModulationMode, dfsTableNumber=dfsTableNumber, alarms=alarms, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, wirelessLinkStatus=wirelessLinkStatus, encryptionAlgorithm=encryptionAlgorithm, userTableIndex=userTableIndex, receiveModulationMode=receiveModulationMode, transmitFreqMHz=transmitFreqMHz, longitude=longitude, alarmsGroup=alarmsGroup, vLANPriorityTable=vLANPriorityTable, linkModeOptimizationMismatch=linkModeOptimizationMismatch, noWirelessChannelAvailable=noWirelessChannelAvailable, dfs=dfs, sNMPTrapIPAddress=sNMPTrapIPAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, frequencyVariant=frequencyVariant, dataPortAutoMdix=dataPortAutoMdix, syslogControlGroup=syslogControlGroup, userName=userName, sNTPState=sNTPState, phyControl=phyControl, ptmp=ptmp, installStatusTrap=installStatusTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, tDDSynchronizationMode=tDDSynchronizationMode, sntpGroup=sntpGroup, transmitPower=transmitPower, telecomsChannelStatusTrap=telecomsChannelStatusTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapTableNumber=sNMPTrapTableNumber, dfsTableEntry=dfsTableEntry, targetMACAddress=targetMACAddress, tDDSynchronizationAlarm=tDDSynchronizationAlarm, pubStatsGroup=pubStatsGroup, accessMethod=accessMethod, sMTPServerIPAddress=sMTPServerIPAddress, searchState=searchState, sMTPEmailAlert=sMTPEmailAlert, telecomsLoopback=telecomsLoopback, ptpTrapPrefix=ptpTrapPrefix, receiveDataRate=receiveDataRate, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, configuration=configuration, telecomsLoopbackTrap=telecomsLoopbackTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, userRole=userRole, sNTPServerIPAddress=sNTPServerIPAddress, notificationsGroup=notificationsGroup, range=range, transmitChannel=transmitChannel, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, resetGroup=resetGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, telecom=telecom, licenceGroup=licenceGroup, supplementaryGroup=supplementaryGroup, telecomsLineCode=telecomsLineCode, tDDSynchronizationStatus=tDDSynchronizationStatus, incompatibleRegionCodes=incompatibleRegionCodes, pubStats=pubStats, syslogClientTrap=syslogClientTrap, unitOutOfCalibration=unitOutOfCalibration, sMTPSourceEmailAddress=sMTPSourceEmailAddress, aAAControl=aAAControl, syslogStateTrap=syslogStateTrap, channelBandwidth=channelBandwidth, cambium=cambium, hardwareVersion=hardwareVersion, receiveFreqMHz=receiveFreqMHz, PYSNMP_MODULE_ID=cambium, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ptp=ptp, dataPortStatus=dataPortStatus, linkModeOptimisation=linkModeOptimisation, sNMPEnabledTraps=sNMPEnabledTraps, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, vLANManagementPriority=vLANManagementPriority, ethernetFiberSupport=ethernetFiberSupport, hTTPPortNumber=hTTPPortNumber, ethernet=ethernet, telnetAccessEnabled=telnetAccessEnabled, receiveChannel=receiveChannel, encryptionGroup=encryptionGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, wirelessLinkAvailability=wirelessLinkAvailability, reset=reset, ptp500=ptp500, linkLoss=linkLoss, snmpControl=snmpControl, telecomGroup=telecomGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, productVariant=productVariant, phyStatus=phyStatus, smtpGroup=smtpGroup, dfsTableIndex=dfsTableIndex, installStatus=installStatus, telecomsInterface=telecomsInterface, remoteMaximumTransmitPower=remoteMaximumTransmitPower, telnetPortNumber=telnetPortNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dfsPeaks=dfsPeaks, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, licence=licence, management=management, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, maximumTransmitPower=maximumTransmitPower, phyControlGroup=phyControlGroup, installArmState=installArmState, enabledDiagnosticAlarms=enabledDiagnosticAlarms, receiveFreqKHz=receiveFreqKHz, subnetMask=subnetMask, vectorError=vectorError, sNTPServerPortNumber=sNTPServerPortNumber, tFTPServerIPAddress=tFTPServerIPAddress, configurationGroup=configurationGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, smtp=smtp, channelChangeTrap=channelChangeTrap, phyStatusGroup=phyStatusGroup, versions=versions, sntp=sntp, useVLANForManagementInterfaces=useVLANForManagementInterfaces, bootVersion=bootVersion, incompatibleMasterAndSlave=incompatibleMasterAndSlave, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortDisabledWarning=dataPortDisabledWarning, siteName=siteName, systemReset=systemReset, sNMPTrapTable=sNMPTrapTable, signalStrengthRatio=signalStrengthRatio, sMTPServerPortNumber=sMTPServerPortNumber, byteErrorRatio=byteErrorRatio, receiveModulationModeDetail=receiveModulationModeDetail, installArmStateTrap=installArmStateTrap, hTTPSPortNumber=hTTPSPortNumber, eIRP=eIRP, syslogState=syslogState, transmitFreqKHz=transmitFreqKHz, licensedCapacity=licensedCapacity, timeZone=timeZone, syslogControl=syslogControl, bandwidthVariant=bandwidthVariant, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, tDDControl=tDDControl, iPAddress=iPAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, dfsMeans=dfsMeans, vLANPriorityTableNumber=vLANPriorityTableNumber, userPassword=userPassword, constantPowerSpectralDensity=constantPowerSpectralDensity, antennaGain=antennaGain, transmitDataRate=transmitDataRate, tDDControlGroup=tDDControlGroup, userTable=userTable, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, userTableEntry=userTableEntry, vLANPriorityTableIndex=vLANPriorityTableIndex, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, hTTPAccessEnabled=hTTPAccessEnabled, systemClock=systemClock, cableLoss=cableLoss, vLANPriorityQueueMapping=vLANPriorityQueueMapping, secondarySoftwareVersion=secondarySoftwareVersion, linkSymmetry=linkSymmetry, linkName=linkName, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPCommunityString=sNMPCommunityString, sNMPTrapVersion=sNMPTrapVersion, tFTPServerPortNumber=tFTPServerPortNumber, supplementary=supplementary, sNTPSync=sNTPSync, daylightSaving=daylightSaving, syslogClient=syslogClient, regionCodeTrap=regionCodeTrap, dataPortStatusTrap=dataPortStatusTrap, regionCode=regionCode, productName=productName, sNTPPollInterval=sNTPPollInterval, versionsGroup=versionsGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPLastSync=sNTPLastSync, dfsTable=dfsTable, managementGroup=managementGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, sNMPPortNumber=sNMPPortNumber, receivePower=receivePower, ptpGroups=ptpGroups, dfsGroup=dfsGroup, gatewayIPAddress=gatewayIPAddress, capacityLicenseMismatch=capacityLicenseMismatch, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptpTraps=ptpTraps)
