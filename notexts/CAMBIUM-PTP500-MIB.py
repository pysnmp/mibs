...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", userName=userName, telnetPortNumber=telnetPortNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, telecomsLineCode=telecomsLineCode, supplementaryGroup=supplementaryGroup, byteErrorRatio=byteErrorRatio, remoteMaximumTransmitPower=remoteMaximumTransmitPower, cableLoss=cableLoss, ethernet=ethernet, receiveFreqKHz=receiveFreqKHz, syslogClient=syslogClient, smtpGroup=smtpGroup, hTTPPortNumber=hTTPPortNumber, phyStatusGroup=phyStatusGroup, linkLoss=linkLoss, signalStrengthRatio=signalStrengthRatio, systemClock=systemClock, systemReset=systemReset, iPAddress=iPAddress, vLANManagementPriority=vLANManagementPriority, syslogStateTrap=syslogStateTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dfs=dfs, ptpTraps=ptpTraps, dataPortAutoNegotiation=dataPortAutoNegotiation, tDDSynchronizationMode=tDDSynchronizationMode, userTableIndex=userTableIndex, antennaGain=antennaGain, sNTPLastSync=sNTPLastSync, transmitFreqMHz=transmitFreqMHz, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, wirelessLinkStatus=wirelessLinkStatus, ptpCompliance=ptpCompliance, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ptmp=ptmp, licence=licence, sNMPTrapTable=sNMPTrapTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, hTTPSPortNumber=hTTPSPortNumber, transmitModulationMode=transmitModulationMode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, remoteIPAddress=remoteIPAddress, range=range, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapTableNumber=sNMPTrapTableNumber, wirelessLinkAvailability=wirelessLinkAvailability, dataPortStatusTrap=dataPortStatusTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, userEnabled=userEnabled, licenceGroup=licenceGroup, sNMPCommunityString=sNMPCommunityString, syslogControlGroup=syslogControlGroup, bandwidthVariant=bandwidthVariant, productName=productName, sNTPServerPortNumber=sNTPServerPortNumber, aAAControlGroup=aAAControlGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, channelBandwidth=channelBandwidth, dataPortConfigurationMismatch=dataPortConfigurationMismatch, transmitPower=transmitPower, configuration=configuration, PYSNMP_MODULE_ID=cambium, installStatusTrap=installStatusTrap, sNMPEnabledTraps=sNMPEnabledTraps, constantPowerSpectralDensity=constantPowerSpectralDensity, targetMACAddress=targetMACAddress, notificationsGroup=notificationsGroup, hardwareVersion=hardwareVersion, telecomsChannelStatus=telecomsChannelStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tFTPServerPortNumber=tFTPServerPortNumber, installArmState=installArmState, groupID=groupID, management=management, dataPortStatus=dataPortStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, regionCode=regionCode, dfsTableIndex=dfsTableIndex, sNTPState=sNTPState, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, snmpControlGroup=snmpControlGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, alarmsGroup=alarmsGroup, userTableNumber=userTableNumber, ptp500=ptp500, phyControl=phyControl, capacityLicenseMismatch=capacityLicenseMismatch, telecom=telecom, timeZone=timeZone, ethernetGroup=ethernetGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPServerIPAddress=sNTPServerIPAddress, dfsTableEntry=dfsTableEntry, vLANPriorityQueueMapping=vLANPriorityQueueMapping, userTableEntry=userTableEntry, syslogLocalWrappedTrap=syslogLocalWrappedTrap, accessMethod=accessMethod, unitOutOfCalibration=unitOutOfCalibration, vLANPriorityTableIndex=vLANPriorityTableIndex, receiveChannel=receiveChannel, receiveDataRate=receiveDataRate, sNMPPortNumber=sNMPPortNumber, telnetAccessEnabled=telnetAccessEnabled, vLANPriorityTableNumber=vLANPriorityTableNumber, vectorError=vectorError, latitude=latitude, encryption=encryption, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPSync=sNTPSync, incompatibleRegionCodes=incompatibleRegionCodes, tDDSynchronizationStatus=tDDSynchronizationStatus, tDDControl=tDDControl, reset=reset, sNMPTrapIPAddress=sNMPTrapIPAddress, versionsGroup=versionsGroup, dfsPeaks=dfsPeaks, searchState=searchState, transmitDataRate=transmitDataRate, longitude=longitude, productVariant=productVariant, siteName=siteName, hTTPAccessEnabled=hTTPAccessEnabled, snmpControl=snmpControl, ethernetFiberSupport=ethernetFiberSupport, phyStatus=phyStatus, pubStats=pubStats, vLANPriorityTable=vLANPriorityTable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, telecomsInterface=telecomsInterface, syslogState=syslogState, userRole=userRole, aggregateDataRate=aggregateDataRate, sNMPTrapVersion=sNMPTrapVersion, syslogClientTrap=syslogClientTrap, transmitFreqKHz=transmitFreqKHz, dataPortAutoMdix=dataPortAutoMdix, vLANManagementVID=vLANManagementVID, frequencyVariant=frequencyVariant, aAAControl=aAAControl, dataPortWirelessDownAlert=dataPortWirelessDownAlert, pubStatsGroup=pubStatsGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPSyncTrap=sNTPSyncTrap, telecomsLoopback=telecomsLoopback, sMTPEmailAlert=sMTPEmailAlert, dfsGroup=dfsGroup, regionCodeTrap=regionCodeTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, linkSymmetry=linkSymmetry, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, linkModeOptimisation=linkModeOptimisation, dataPortDisabledWarning=dataPortDisabledWarning, receiveModulationModeDetail=receiveModulationModeDetail, versions=versions, encryptionAlgorithm=encryptionAlgorithm, subnetMask=subnetMask, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, installArmStateTrap=installArmStateTrap, receiveModulationMode=receiveModulationMode, secondarySoftwareVersion=secondarySoftwareVersion, ptp=ptp, masterSlaveMode=masterSlaveMode, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sntp=sntp, sMTPEnabledMessages=sMTPEnabledMessages, tFTPServerIPAddress=tFTPServerIPAddress, bootVersion=bootVersion, dfsMeans=dfsMeans, transmitChannel=transmitChannel, vLANPriorityTableEntry=vLANPriorityTableEntry, telecomsLoopbackTrap=telecomsLoopbackTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, cambium=cambium, linkModeOptimizationMismatch=linkModeOptimizationMismatch, channelChangeTrap=channelChangeTrap, resetGroup=resetGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, alarms=alarms, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, syslogControl=syslogControl, telecomGroup=telecomGroup, smtp=smtp, dfsTable=dfsTable, sNMPv3Enable=sNMPv3Enable, receivePower=receivePower, sMTPServerIPAddress=sMTPServerIPAddress, softwareVersion=softwareVersion, eIRP=eIRP, managementGroup=managementGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, configurationGroup=configurationGroup, userTable=userTable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, telecomsCableLength=telecomsCableLength, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, supplementary=supplementary, userPassword=userPassword, encryptionGroup=encryptionGroup, installStatus=installStatus, telecomsChannelStatusTrap=telecomsChannelStatusTrap, receiveFreqMHz=receiveFreqMHz, sMTPServerPortNumber=sMTPServerPortNumber, maximumTransmitPower=maximumTransmitPower, daylightSaving=daylightSaving, altitude=altitude, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sntpGroup=sntpGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, licensedCapacity=licensedCapacity, ptpGroups=ptpGroups, gatewayIPAddress=gatewayIPAddress, sNTPPollInterval=sNTPPollInterval, linkName=linkName, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, phyControlGroup=phyControlGroup, dfsTableNumber=dfsTableNumber, tDDControlGroup=tDDControlGroup, hTTPSAccessEnabled=hTTPSAccessEnabled)
