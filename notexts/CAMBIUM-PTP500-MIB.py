...
# Produced by pysmi-1.1.3 at Wed Dec  1 14:50:52 2021
...
Integer32, Bits, ObjectIdentity, IpAddress, ModuleIdentity, Counter64, MibIdentifier, Unsigned32, Counter32, enterprises, iso, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "ObjectIdentity", "IpAddress", "ModuleIdentity", "Counter64", "MibIdentifier", "Unsigned32", "Counter32", "enterprises", "iso", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sMTPEmailAlert=sMTPEmailAlert, syslogState=syslogState, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, bootVersion=bootVersion, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, vLANPriorityQueueMapping=vLANPriorityQueueMapping, telecomsLoopbackTrap=telecomsLoopbackTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ethernetFiberSupport=ethernetFiberSupport, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortStatusTrap=dataPortStatusTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, incompatibleMasterAndSlave=incompatibleMasterAndSlave, aggregateDataRate=aggregateDataRate, latitude=latitude, PYSNMP_MODULE_ID=cambium, dfsMeans=dfsMeans, syslogControl=syslogControl, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ptp=ptp, ptpGroups=ptpGroups, sNMPTrapIPAddress=sNMPTrapIPAddress, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, alarms=alarms, licence=licence, sNMPTrapPortNumber=sNMPTrapPortNumber, sntp=sntp, telecomsCableLength=telecomsCableLength, syslogStateTrap=syslogStateTrap, dfsGroup=dfsGroup, sNMPTrapTable=sNMPTrapTable, sNMPPortNumber=sNMPPortNumber, dfsPeaks=dfsPeaks, capacityLicenseMismatch=capacityLicenseMismatch, phyStatus=phyStatus, unitOutOfCalibration=unitOutOfCalibration, receiveModulationModeDetail=receiveModulationModeDetail, sMTPServerIPAddress=sMTPServerIPAddress, userTableIndex=userTableIndex, hTTPSPortNumber=hTTPSPortNumber, sMTPServerPortNumber=sMTPServerPortNumber, softwareVersion=softwareVersion, installStatusTrap=installStatusTrap, incompatibleRegionCodes=incompatibleRegionCodes, alarmsGroup=alarmsGroup, userName=userName, altitude=altitude, gatewayIPAddress=gatewayIPAddress, sNTPSync=sNTPSync, sNMPv3Enable=sNMPv3Enable, dfsTable=dfsTable, smtpGroup=smtpGroup, productName=productName, receiveFreqKHz=receiveFreqKHz, vLANManagementPriority=vLANManagementPriority, telecom=telecom, groupID=groupID, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortAutoMdix=dataPortAutoMdix, vLANPriorityTableIndex=vLANPriorityTableIndex, snmpControlGroup=snmpControlGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, daylightSaving=daylightSaving, transmitModulationMode=transmitModulationMode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, aAAControl=aAAControl, channelBandwidth=channelBandwidth, linkSymmetry=linkSymmetry, transmitPower=transmitPower, dfsTableNumber=dfsTableNumber, siteName=siteName, phyControlGroup=phyControlGroup, transmitChannel=transmitChannel, masterSlaveMode=masterSlaveMode, phyControl=phyControl, sMTPEnabledMessages=sMTPEnabledMessages, transmitFreqMHz=transmitFreqMHz, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, telecomGroup=telecomGroup, linkName=linkName, ethernet=ethernet, subnetMask=subnetMask, vLANPriorityTableNumber=vLANPriorityTableNumber, ptpCompliance=ptpCompliance, linkLoss=linkLoss, wirelessLinkStatus=wirelessLinkStatus, reset=reset, regionCode=regionCode, sntpGroup=sntpGroup, cableLoss=cableLoss, supplementaryGroup=supplementaryGroup, ptpTrapPrefix=ptpTrapPrefix, remoteIPAddress=remoteIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, installArmState=installArmState, userTableEntry=userTableEntry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, linkModeOptimizationMismatch=linkModeOptimizationMismatch, encryptionGroup=encryptionGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, systemReset=systemReset, tDDControlGroup=tDDControlGroup, telecomsChannelStatus=telecomsChannelStatus, aAAControlGroup=aAAControlGroup, licensedCapacity=licensedCapacity, resetGroup=resetGroup, sNTPLastSync=sNTPLastSync, installArmStateTrap=installArmStateTrap, iPAddress=iPAddress, syslogControlGroup=syslogControlGroup, tDDSynchronizationMode=tDDSynchronizationMode, ethernetGroup=ethernetGroup, receiveChannel=receiveChannel, supplementary=supplementary, versions=versions, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortConfigurationMismatch=dataPortConfigurationMismatch, telnetPortNumber=telnetPortNumber, eIRP=eIRP, telnetAccessEnabled=telnetAccessEnabled, wirelessLinkAvailability=wirelessLinkAvailability, userEnabled=userEnabled, phyStatusGroup=phyStatusGroup, regionCodeTrap=regionCodeTrap, sNTPServerPortNumber=sNTPServerPortNumber, hTTPPortNumber=hTTPPortNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, systemClock=systemClock, configuration=configuration, encryption=encryption, vLANPriorityTable=vLANPriorityTable, tFTPServerIPAddress=tFTPServerIPAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, managementGroup=managementGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, accessMethod=accessMethod, searchState=searchState, syslogClientTrap=syslogClientTrap, smtp=smtp, maximumTransmitPower=maximumTransmitPower, channelChangeTrap=channelChangeTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, telecomsLineCode=telecomsLineCode, telecomsChannelStatusTrap=telecomsChannelStatusTrap, productVariant=productVariant, sNMPEnabledTraps=sNMPEnabledTraps, targetMACAddress=targetMACAddress, linkModeOptimisation=linkModeOptimisation, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, snmpControl=snmpControl, tDDControl=tDDControl, sNMPTrapTableEntry=sNMPTrapTableEntry, receivePower=receivePower, transmitDataRate=transmitDataRate, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ptp500=ptp500, pubStatsGroup=pubStatsGroup, dataPortStatus=dataPortStatus, secondarySoftwareVersion=secondarySoftwareVersion, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dfsTableEntry=dfsTableEntry, hTTPAccessEnabled=hTTPAccessEnabled, cambium=cambium, telecomsLoopback=telecomsLoopback, sNTPSyncTrap=sNTPSyncTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNTPState=sNTPState, ptpTraps=ptpTraps, management=management, byteErrorRatio=byteErrorRatio, sNTPServerIPAddress=sNTPServerIPAddress, notificationsGroup=notificationsGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dfs=dfs, tFTPServerPortNumber=tFTPServerPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, useVLANForManagementInterfaces=useVLANForManagementInterfaces, telecomsInterface=telecomsInterface, sNMPTrapVersion=sNMPTrapVersion, syslogClient=syslogClient, tDDSynchronizationStatus=tDDSynchronizationStatus, pubStats=pubStats, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, longitude=longitude, frequencyVariant=frequencyVariant, sNTPPollInterval=sNTPPollInterval, timeZone=timeZone, range=range, installStatus=installStatus, receiveModulationMode=receiveModulationMode, encryptionAlgorithm=encryptionAlgorithm, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, versionsGroup=versionsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataPortDisabledWarning=dataPortDisabledWarning, vLANManagementVID=vLANManagementVID, bandwidthVariant=bandwidthVariant, sNMPCommunityString=sNMPCommunityString, userPassword=userPassword, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, userRole=userRole, receiveFreqMHz=receiveFreqMHz, hardwareVersion=hardwareVersion, sMTPSourceEmailAddress=sMTPSourceEmailAddress, licenceGroup=licenceGroup, signalStrengthRatio=signalStrengthRatio, constantPowerSpectralDensity=constantPowerSpectralDensity, receiveDataRate=receiveDataRate, vectorError=vectorError, dfsTableIndex=dfsTableIndex, ptmp=ptmp, antennaGain=antennaGain, transmitFreqKHz=transmitFreqKHz, userTable=userTable, configurationGroup=configurationGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, userTableNumber=userTableNumber)
