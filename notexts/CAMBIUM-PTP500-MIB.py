...
IpAddress, ObjectIdentity, enterprises, Bits, TimeTicks, MibIdentifier, ModuleIdentity, Counter32, Counter64, iso, Unsigned32, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ObjectIdentity", "enterprises", "Bits", "TimeTicks", "MibIdentifier", "ModuleIdentity", "Counter32", "Counter64", "iso", "Unsigned32", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sNTPSync=sNTPSync, longitude=longitude, sNMPv3Enable=sNMPv3Enable, secondarySoftwareVersion=secondarySoftwareVersion, ptp=ptp, ethernetGroup=ethernetGroup, sNTPPollInterval=sNTPPollInterval, tDDSynchronizationMode=tDDSynchronizationMode, telecomsCableLength=telecomsCableLength, frequencyVariant=frequencyVariant, unitOutOfCalibration=unitOutOfCalibration, vLANManagementPriority=vLANManagementPriority, telecom=telecom, management=management, sNMPTrapTable=sNMPTrapTable, tFTPServerIPAddress=tFTPServerIPAddress, dataPortStatusTrap=dataPortStatusTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfsTableEntry=dfsTableEntry, vLANPriorityTable=vLANPriorityTable, transmitChannel=transmitChannel, dataPortAutoNegotiation=dataPortAutoNegotiation, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, transmitFreqMHz=transmitFreqMHz, dataPortDisabledWarning=dataPortDisabledWarning, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, bootVersion=bootVersion, userPassword=userPassword, syslogStateTrap=syslogStateTrap, maximumTransmitPower=maximumTransmitPower, ptpTrapPrefix=ptpTrapPrefix, sNTPLastSync=sNTPLastSync, phyControlGroup=phyControlGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, wirelessLinkStatus=wirelessLinkStatus, receiveModulationModeDetail=receiveModulationModeDetail, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, transmitDataRate=transmitDataRate, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dataPortAutoMdix=dataPortAutoMdix, licensedCapacity=licensedCapacity, dfsTableIndex=dfsTableIndex, telecomsLineCode=telecomsLineCode, sMTPEnabledMessages=sMTPEnabledMessages, supplementaryGroup=supplementaryGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, versions=versions, snmpControlGroup=snmpControlGroup, aAAControlGroup=aAAControlGroup, vLANManagementVID=vLANManagementVID, installArmState=installArmState, aAAControl=aAAControl, installArmStateTrap=installArmStateTrap, siteName=siteName, installStatus=installStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, linkSymmetry=linkSymmetry, telecomsInterface=telecomsInterface, alarms=alarms, vLANPriorityTableIndex=vLANPriorityTableIndex, pubStats=pubStats, systemClock=systemClock, notificationsGroup=notificationsGroup, linkLoss=linkLoss, linkName=linkName, sNMPCommunityString=sNMPCommunityString, encryption=encryption, receiveChannel=receiveChannel, dfsGroup=dfsGroup, sNMPTrapVersion=sNMPTrapVersion, tDDControlGroup=tDDControlGroup, sNMPEnabledTraps=sNMPEnabledTraps, wirelessLinkAvailability=wirelessLinkAvailability, resetGroup=resetGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNTPServerIPAddress=sNTPServerIPAddress, dfsMeans=dfsMeans, hardwareVersion=hardwareVersion, dataPortStatus=dataPortStatus, sMTPEmailAlert=sMTPEmailAlert, aggregateDataRate=aggregateDataRate, vLANPriorityTableEntry=vLANPriorityTableEntry, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, PYSNMP_MODULE_ID=cambium, iPAddress=iPAddress, sNMPPortNumber=sNMPPortNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, smtpGroup=smtpGroup, receiveDataRate=receiveDataRate, sMTPServerPortNumber=sMTPServerPortNumber, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, telecomsLoopback=telecomsLoopback, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, masterSlaveMode=masterSlaveMode, telecomGroup=telecomGroup, pubStatsGroup=pubStatsGroup, bandwidthVariant=bandwidthVariant, vLANPriorityQueueMapping=vLANPriorityQueueMapping, userName=userName, installStatusTrap=installStatusTrap, searchState=searchState, sNTPServerPortNumber=sNTPServerPortNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, smtp=smtp, phyStatusGroup=phyStatusGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dfs=dfs, phyStatus=phyStatus, supplementary=supplementary, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, managementGroup=managementGroup, encryptionGroup=encryptionGroup, hTTPPortNumber=hTTPPortNumber, range=range, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, userRole=userRole, receivePower=receivePower, tFTPServerPortNumber=tFTPServerPortNumber, receiveFreqKHz=receiveFreqKHz, ethernet=ethernet, gatewayIPAddress=gatewayIPAddress, telecomsChannelStatusTrap=telecomsChannelStatusTrap, channelBandwidth=channelBandwidth, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ptpTraps=ptpTraps, licenceGroup=licenceGroup, cambium=cambium, sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, hTTPAccessEnabled=hTTPAccessEnabled, sNMPTrapTableNumber=sNMPTrapTableNumber, telecomsLoopbackTrap=telecomsLoopbackTrap, ptpGroups=ptpGroups, userTable=userTable, alarmsGroup=alarmsGroup, tDDControl=tDDControl, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, productVariant=productVariant, transmitFreqKHz=transmitFreqKHz, configuration=configuration, dfsPeaks=dfsPeaks, sNTPState=sNTPState, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, syslogState=syslogState, eIRP=eIRP, subnetMask=subnetMask, ethernetFiberSupport=ethernetFiberSupport, dfsTable=dfsTable, accessMethod=accessMethod, receiveFreqMHz=receiveFreqMHz, configurationGroup=configurationGroup, syslogClientTrap=syslogClientTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, transmitModulationMode=transmitModulationMode, daylightSaving=daylightSaving, timeZone=timeZone, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sMTPServerIPAddress=sMTPServerIPAddress, receiveModulationMode=receiveModulationMode, licence=licence, sntp=sntp, dataPortWirelessDownAlert=dataPortWirelessDownAlert, userEnabled=userEnabled, vectorError=vectorError, altitude=altitude, targetMACAddress=targetMACAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, snmpControl=snmpControl, channelChangeTrap=channelChangeTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, regionCode=regionCode, ptpCompliance=ptpCompliance, syslogClient=syslogClient, userTableNumber=userTableNumber, dataPortConfigurationMismatch=dataPortConfigurationMismatch, incompatibleRegionCodes=incompatibleRegionCodes, transmitPower=transmitPower, sntpGroup=sntpGroup, antennaGain=antennaGain, phyControl=phyControl, byteErrorRatio=byteErrorRatio, noWirelessChannelAvailable=noWirelessChannelAvailable, softwareVersion=softwareVersion, ptmp=ptmp, signalStrengthRatio=signalStrengthRatio, constantPowerSpectralDensity=constantPowerSpectralDensity, productName=productName, useVLANForManagementInterfaces=useVLANForManagementInterfaces, encryptionAlgorithm=encryptionAlgorithm, telnetAccessEnabled=telnetAccessEnabled, sNMPTrapTableEntry=sNMPTrapTableEntry, syslogControl=syslogControl, userTableEntry=userTableEntry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, syslogControlGroup=syslogControlGroup, cableLoss=cableLoss, reset=reset, hTTPSAccessEnabled=hTTPSAccessEnabled, enabledDiagnosticAlarms=enabledDiagnosticAlarms, systemReset=systemReset, ptp500=ptp500, latitude=latitude, sNTPSyncTrap=sNTPSyncTrap, remoteIPAddress=remoteIPAddress, hTTPSPortNumber=hTTPSPortNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, versionsGroup=versionsGroup, groupID=groupID, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, telnetPortNumber=telnetPortNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, capacityLicenseMismatch=capacityLicenseMismatch, telecomsChannelStatus=telecomsChannelStatus, userTableIndex=userTableIndex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfsTableNumber=dfsTableNumber, regionCodeTrap=regionCodeTrap, linkModeOptimisation=linkModeOptimisation)
