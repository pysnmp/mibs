...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", userName=userName, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, linkName=linkName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tDDControlGroup=tDDControlGroup, unitOutOfCalibration=unitOutOfCalibration, dfs=dfs, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ethernet=ethernet, syslogControlGroup=syslogControlGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, constantPowerSpectralDensity=constantPowerSpectralDensity, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, bandwidthVariant=bandwidthVariant, hardwareVersion=hardwareVersion, alarms=alarms, sntpGroup=sntpGroup, timeZone=timeZone, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, longitude=longitude, installArmStateTrap=installArmStateTrap, productName=productName, transmitModulationMode=transmitModulationMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, receiveModulationModeDetail=receiveModulationModeDetail, subnetMask=subnetMask, telecomsLoopbackTrap=telecomsLoopbackTrap, ethernetGroup=ethernetGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, installStatusTrap=installStatusTrap, ptpGroups=ptpGroups, antennaGain=antennaGain, telecomsChannelStatus=telecomsChannelStatus, sMTPEnabledMessages=sMTPEnabledMessages, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, receivePower=receivePower, signalStrengthRatio=signalStrengthRatio, vLANPriorityTable=vLANPriorityTable, syslogControl=syslogControl, transmitFreqKHz=transmitFreqKHz, bootVersion=bootVersion, cableLoss=cableLoss, sMTPServerPortNumber=sMTPServerPortNumber, aggregateDataRate=aggregateDataRate, syslogClient=syslogClient, sMTPEmailAlert=sMTPEmailAlert, sNTPLastSync=sNTPLastSync, syslogStateTrap=syslogStateTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, reset=reset, sMTPSourceEmailAddress=sMTPSourceEmailAddress, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, userTableNumber=userTableNumber, eIRP=eIRP, transmitFreqMHz=transmitFreqMHz, alarmsGroup=alarmsGroup, wirelessLinkAvailability=wirelessLinkAvailability, altitude=altitude, linkLoss=linkLoss, productVariant=productVariant, sNMPv3Enable=sNMPv3Enable, snmpControl=snmpControl, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, receiveFreqMHz=receiveFreqMHz, targetMACAddress=targetMACAddress, maximumTransmitPower=maximumTransmitPower, userEnabled=userEnabled, groupID=groupID, range=range, sNTPPollInterval=sNTPPollInterval, phyStatusGroup=phyStatusGroup, managementGroup=managementGroup, incompatibleRegionCodes=incompatibleRegionCodes, phyControl=phyControl, capacityLicenseMismatch=capacityLicenseMismatch, userTable=userTable, receiveModulationMode=receiveModulationMode, pubStats=pubStats, sNTPSyncTrap=sNTPSyncTrap, tDDControl=tDDControl, syslogClientTrap=syslogClientTrap, installArmState=installArmState, linkModeOptimizationMismatch=linkModeOptimizationMismatch, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, linkSymmetry=linkSymmetry, sntp=sntp, licensedCapacity=licensedCapacity, masterSlaveMode=masterSlaveMode, accessMethod=accessMethod, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, phyStatus=phyStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, iPAddress=iPAddress, userTableEntry=userTableEntry, versions=versions, sNMPTrapVersion=sNMPTrapVersion, incompatibleMasterAndSlave=incompatibleMasterAndSlave, configuration=configuration, telecomsLoopback=telecomsLoopback, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, configurationGroup=configurationGroup, tDDSynchronizationMode=tDDSynchronizationMode, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, telecomsLineCode=telecomsLineCode, byteErrorRatio=byteErrorRatio, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dataPortStatusTrap=dataPortStatusTrap, hTTPPortNumber=hTTPPortNumber, vLANPriorityTableNumber=vLANPriorityTableNumber, telecomsCableLength=telecomsCableLength, hTTPSPortNumber=hTTPSPortNumber, sNMPPortNumber=sNMPPortNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, smtpGroup=smtpGroup, vLANManagementVID=vLANManagementVID, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortDisabledWarning=dataPortDisabledWarning, sNTPState=sNTPState, sNTPServerIPAddress=sNTPServerIPAddress, pubStatsGroup=pubStatsGroup, telnetAccessEnabled=telnetAccessEnabled, licenceGroup=licenceGroup, tFTPServerIPAddress=tFTPServerIPAddress, sNMPEnabledTraps=sNMPEnabledTraps, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, vLANPriorityTableEntry=vLANPriorityTableEntry, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telnetPortNumber=telnetPortNumber, dfsTableNumber=dfsTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, supplementary=supplementary, encryption=encryption, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, encryptionGroup=encryptionGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, daylightSaving=daylightSaving, dataPortAutoNegotiation=dataPortAutoNegotiation, ptmp=ptmp, noWirelessChannelAvailable=noWirelessChannelAvailable, resetGroup=resetGroup, remoteIPAddress=remoteIPAddress, sNMPCommunityString=sNMPCommunityString, ethernetFiberSupport=ethernetFiberSupport, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, regionCode=regionCode, smtp=smtp, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dfsTable=dfsTable, frequencyVariant=frequencyVariant, dfsTableEntry=dfsTableEntry, useVLANForManagementInterfaces=useVLANForManagementInterfaces, syslogState=syslogState, enabledDiagnosticAlarms=enabledDiagnosticAlarms, encryptionAlgorithm=encryptionAlgorithm, ptp=ptp, gatewayIPAddress=gatewayIPAddress, secondarySoftwareVersion=secondarySoftwareVersion, userPassword=userPassword, licence=licence, ptpTraps=ptpTraps, notificationsGroup=notificationsGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPSync=sNTPSync, installStatus=installStatus, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, softwareVersion=softwareVersion, channelBandwidth=channelBandwidth, sNMPTrapTable=sNMPTrapTable, dataPortAutoMdix=dataPortAutoMdix, dfsTableIndex=dfsTableIndex, transmitChannel=transmitChannel, management=management, vectorError=vectorError, sNMPTrapTableIndex=sNMPTrapTableIndex, systemClock=systemClock, latitude=latitude, tFTPServerPortNumber=tFTPServerPortNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, cambium=cambium, wirelessLinkStatus=wirelessLinkStatus, ptpTrapPrefix=ptpTrapPrefix, channelChangeTrap=channelChangeTrap, ptpCompliance=ptpCompliance, userTableIndex=userTableIndex, systemReset=systemReset, telecomGroup=telecomGroup, linkModeOptimisation=linkModeOptimisation, receiveChannel=receiveChannel, ptp500=ptp500, aAAControl=aAAControl, supplementaryGroup=supplementaryGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, vLANManagementPriority=vLANManagementPriority, receiveDataRate=receiveDataRate, dfsGroup=dfsGroup, searchState=searchState, snmpControlGroup=snmpControlGroup, transmitDataRate=transmitDataRate, dfsPeaks=dfsPeaks, aAAControlGroup=aAAControlGroup, sMTPServerIPAddress=sMTPServerIPAddress, PYSNMP_MODULE_ID=cambium, sNMPTrapTableEntry=sNMPTrapTableEntry, receiveFreqKHz=receiveFreqKHz, dfsMeans=dfsMeans, regionCodeTrap=regionCodeTrap, versionsGroup=versionsGroup, hTTPAccessEnabled=hTTPAccessEnabled, telecom=telecom, transmitPower=transmitPower, siteName=siteName, phyControlGroup=phyControlGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, telecomsInterface=telecomsInterface, sNTPServerPortNumber=sNTPServerPortNumber, dataPortStatus=dataPortStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, userRole=userRole)
