...
# Produced by pysmi-1.1.0 at Tue Nov 16 11:43:13 2021
...
TimeTicks, Integer32, enterprises, NotificationType, Counter32, Gauge32, Counter64, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, ObjectIdentity, Unsigned32, MibIdentifier, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Integer32", "enterprises", "NotificationType", "Counter32", "Gauge32", "Counter64", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "ObjectIdentity", "Unsigned32", "MibIdentifier", "Bits")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", telecom=telecom, systemReset=systemReset, vLANPriorityTableNumber=vLANPriorityTableNumber, remoteIPAddress=remoteIPAddress, ptmp=ptmp, hardwareVersion=hardwareVersion, configurationGroup=configurationGroup, telnetAccessEnabled=telnetAccessEnabled, userTableIndex=userTableIndex, licenceGroup=licenceGroup, telecomsInterface=telecomsInterface, sNTPServerPortNumber=sNTPServerPortNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, vLANManagementVID=vLANManagementVID, receiveDataRate=receiveDataRate, management=management, dfsPeaks=dfsPeaks, userRole=userRole, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, vLANPriorityTable=vLANPriorityTable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transmitDataRate=transmitDataRate, latitude=latitude, sNTPSyncTrap=sNTPSyncTrap, smtp=smtp, sMTPServerIPAddress=sMTPServerIPAddress, userPassword=userPassword, phyControl=phyControl, hTTPSAccessEnabled=hTTPSAccessEnabled, ptpTraps=ptpTraps, syslogControlGroup=syslogControlGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, vLANPriorityQueueMapping=vLANPriorityQueueMapping, userName=userName, longitude=longitude, ptp=ptp, incompatibleMasterAndSlave=incompatibleMasterAndSlave, pubStats=pubStats, dfsTableNumber=dfsTableNumber, transmitModulationMode=transmitModulationMode, phyStatusGroup=phyStatusGroup, productVariant=productVariant, transmitFreqMHz=transmitFreqMHz, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, userTableEntry=userTableEntry, dfsGroup=dfsGroup, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNMPTrapPortNumber=sNMPTrapPortNumber, daylightSaving=daylightSaving, receiveModulationModeDetail=receiveModulationModeDetail, telecomGroup=telecomGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, linkName=linkName, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNTPState=sNTPState, dfsMeans=dfsMeans, systemClock=systemClock, versionsGroup=versionsGroup, bootVersion=bootVersion, userEnabled=userEnabled, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dfsTableEntry=dfsTableEntry, dataPortStatusTrap=dataPortStatusTrap, tFTPServerIPAddress=tFTPServerIPAddress, encryptionAlgorithm=encryptionAlgorithm, smtpGroup=smtpGroup, snmpControlGroup=snmpControlGroup, sNTPLastSync=sNTPLastSync, syslogStateTrap=syslogStateTrap, eIRP=eIRP, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, syslogState=syslogState, installArmStateTrap=installArmStateTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, iPAddress=iPAddress, capacityLicenseMismatch=capacityLicenseMismatch, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ptpGroups=ptpGroups, dataPortConfigurationMismatch=dataPortConfigurationMismatch, ptpCompliance=ptpCompliance, sNMPTrapTableNumber=sNMPTrapTableNumber, byteErrorRatio=byteErrorRatio, hTTPSPortNumber=hTTPSPortNumber, softwareVersion=softwareVersion, telecomsLineCode=telecomsLineCode, supplementary=supplementary, range=range, ethernet=ethernet, receiveChannel=receiveChannel, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, supplementaryGroup=supplementaryGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, telecomsCableLength=telecomsCableLength, vectorError=vectorError, dataPortAutoNegotiation=dataPortAutoNegotiation, sMTPServerPortNumber=sMTPServerPortNumber, tFTPServerPortNumber=tFTPServerPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, managementGroup=managementGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, receiveModulationMode=receiveModulationMode, transmitPower=transmitPower, sMTPEnabledMessages=sMTPEnabledMessages, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, installArmState=installArmState, transmitFreqKHz=transmitFreqKHz, syslogClientTrap=syslogClientTrap, timeZone=timeZone, antennaGain=antennaGain, accessMethod=accessMethod, sntp=sntp, encryption=encryption, syslogControl=syslogControl, channelBandwidth=channelBandwidth, frequencyVariant=frequencyVariant, hTTPAccessEnabled=hTTPAccessEnabled, signalStrengthRatio=signalStrengthRatio, regionCodeTrap=regionCodeTrap, cambium=cambium, siteName=siteName, wirelessLinkStatus=wirelessLinkStatus, gatewayIPAddress=gatewayIPAddress, sNMPCommunityString=sNMPCommunityString, secondarySoftwareVersion=secondarySoftwareVersion, tDDSynchronizationMode=tDDSynchronizationMode, PYSNMP_MODULE_ID=cambium, ethernetGroup=ethernetGroup, dfs=dfs, resetGroup=resetGroup, encryptionGroup=encryptionGroup, pubStatsGroup=pubStatsGroup, sNMPPortNumber=sNMPPortNumber, licence=licence, dataPortAutoMdix=dataPortAutoMdix, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sMTPEmailAlert=sMTPEmailAlert, phyControlGroup=phyControlGroup, receivePower=receivePower, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortDisabledWarning=dataPortDisabledWarning, configuration=configuration, transmitChannel=transmitChannel, syslogClient=syslogClient, ptp500=ptp500, sNMPTrapIPAddress=sNMPTrapIPAddress, ptpTrapPrefix=ptpTrapPrefix, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPSync=sNTPSync, wirelessLinkAvailability=wirelessLinkAvailability, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, notificationsGroup=notificationsGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sntpGroup=sntpGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, aggregateDataRate=aggregateDataRate, linkModeOptimisation=linkModeOptimisation, telecomsChannelStatus=telecomsChannelStatus, masterSlaveMode=masterSlaveMode, aAAControlGroup=aAAControlGroup, snmpControl=snmpControl, userTableNumber=userTableNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, telecomsLoopbackTrap=telecomsLoopbackTrap, productName=productName, receiveFreqKHz=receiveFreqKHz, incompatibleRegionCodes=incompatibleRegionCodes, tDDSynchronizationAlarm=tDDSynchronizationAlarm, enabledDiagnosticAlarms=enabledDiagnosticAlarms, installStatusTrap=installStatusTrap, sNMPEnabledTraps=sNMPEnabledTraps, sNMPv3Enable=sNMPv3Enable, targetMACAddress=targetMACAddress, sNMPTrapTable=sNMPTrapTable, reset=reset, regionCode=regionCode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPPollInterval=sNTPPollInterval, aAAControl=aAAControl, maximumTransmitPower=maximumTransmitPower, alarms=alarms, syslogLocalWrappedTrap=syslogLocalWrappedTrap, vLANManagementPriority=vLANManagementPriority, unitOutOfCalibration=unitOutOfCalibration, cableLoss=cableLoss, versions=versions, dataPortStatus=dataPortStatus, telnetPortNumber=telnetPortNumber, linkSymmetry=linkSymmetry, linkLoss=linkLoss, alarmsGroup=alarmsGroup, dfsTableIndex=dfsTableIndex, ethernetFiberSupport=ethernetFiberSupport, sNMPTrapVersion=sNMPTrapVersion, phyStatus=phyStatus, userTable=userTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, bandwidthVariant=bandwidthVariant, licensedCapacity=licensedCapacity, tDDControlGroup=tDDControlGroup, telecomsLoopback=telecomsLoopback, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, groupID=groupID, dfsTable=dfsTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, altitude=altitude, tDDControl=tDDControl, sNTPServerIPAddress=sNTPServerIPAddress, channelChangeTrap=channelChangeTrap, installStatus=installStatus, hTTPPortNumber=hTTPPortNumber, subnetMask=subnetMask, vLANPriorityTableEntry=vLANPriorityTableEntry, receiveFreqMHz=receiveFreqMHz, searchState=searchState)
