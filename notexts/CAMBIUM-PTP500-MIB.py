...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, userEnabled=userEnabled, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telecomGroup=telecomGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ethernet=ethernet, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, userTableNumber=userTableNumber, latitude=latitude, transmitFreqKHz=transmitFreqKHz, productName=productName, telnetPortNumber=telnetPortNumber, sNTPPollInterval=sNTPPollInterval, sNMPTrapTableEntry=sNMPTrapTableEntry, installStatus=installStatus, syslogControlGroup=syslogControlGroup, sMTPEmailAlert=sMTPEmailAlert, receiveFreqMHz=receiveFreqMHz, transmitChannel=transmitChannel, sntpGroup=sntpGroup, encryption=encryption, tDDSynchronizationMode=tDDSynchronizationMode, dfsGroup=dfsGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, telecomsInterface=telecomsInterface, systemClock=systemClock, userTableIndex=userTableIndex, dfsTableIndex=dfsTableIndex, phyControl=phyControl, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, phyControlGroup=phyControlGroup, ptpTrapPrefix=ptpTrapPrefix, frequencyVariant=frequencyVariant, sNTPServerIPAddress=sNTPServerIPAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, linkSymmetry=linkSymmetry, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ptmp=ptmp, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, userName=userName, hTTPAccessEnabled=hTTPAccessEnabled, smtpGroup=smtpGroup, managementGroup=managementGroup, signalStrengthRatio=signalStrengthRatio, hardwareVersion=hardwareVersion, sNMPTrapPortNumber=sNMPTrapPortNumber, licence=licence, tDDSynchronizationStatus=tDDSynchronizationStatus, ethernetGroup=ethernetGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPTrapVersion=sNMPTrapVersion, installArmStateTrap=installArmStateTrap, reset=reset, supplementary=supplementary, cambium=cambium, PYSNMP_MODULE_ID=cambium, resetGroup=resetGroup, tFTPServerPortNumber=tFTPServerPortNumber, receiveModulationModeDetail=receiveModulationModeDetail, systemReset=systemReset, receiveChannel=receiveChannel, regionCodeTrap=regionCodeTrap, snmpControlGroup=snmpControlGroup, eIRP=eIRP, dataPortStatus=dataPortStatus, pubStatsGroup=pubStatsGroup, capacityLicenseMismatch=capacityLicenseMismatch, aggregateDataRate=aggregateDataRate, transmitModulationMode=transmitModulationMode, installStatusTrap=installStatusTrap, sNTPSync=sNTPSync, siteName=siteName, installArmState=installArmState, masterSlaveMode=masterSlaveMode, dataPortDisabledWarning=dataPortDisabledWarning, cableLoss=cableLoss, transmitDataRate=transmitDataRate, receiveDataRate=receiveDataRate, notificationsGroup=notificationsGroup, telecomsChannelStatusTrap=telecomsChannelStatusTrap, ptpTraps=ptpTraps, configuration=configuration, ptp500=ptp500, dfsTable=dfsTable, maximumTransmitPower=maximumTransmitPower, productVariant=productVariant, ethernetFiberSupport=ethernetFiberSupport, vectorError=vectorError, sMTPServerIPAddress=sMTPServerIPAddress, sNMPCommunityString=sNMPCommunityString, antennaGain=antennaGain, daylightSaving=daylightSaving, licenceGroup=licenceGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, softwareVersion=softwareVersion, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, telecomsChannelStatus=telecomsChannelStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, telecomsLoopback=telecomsLoopback, regionCode=regionCode, vLANManagementVID=vLANManagementVID, telecomsCableLength=telecomsCableLength, dataPortConfigurationMismatch=dataPortConfigurationMismatch, timeZone=timeZone, byteErrorRatio=byteErrorRatio, remoteIPAddress=remoteIPAddress, receivePower=receivePower, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, syslogControl=syslogControl, wirelessLinkStatus=wirelessLinkStatus, sNTPState=sNTPState, wirelessLinkAvailability=wirelessLinkAvailability, alarmsGroup=alarmsGroup, licensedCapacity=licensedCapacity, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, syslogStateTrap=syslogStateTrap, syslogState=syslogState, hTTPPortNumber=hTTPPortNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, ptpCompliance=ptpCompliance, vLANPriorityTable=vLANPriorityTable, smtp=smtp, groupID=groupID, tDDControl=tDDControl, vLANPriorityTableIndex=vLANPriorityTableIndex, dfs=dfs, gatewayIPAddress=gatewayIPAddress, sNMPTrapTable=sNMPTrapTable, versionsGroup=versionsGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, linkModeOptimisation=linkModeOptimisation, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, vLANPriorityQueueMapping=vLANPriorityQueueMapping, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPSyncTrap=sNTPSyncTrap, transmitFreqMHz=transmitFreqMHz, aAAControl=aAAControl, accessMethod=accessMethod, userPassword=userPassword, userTableEntry=userTableEntry, sNMPPortNumber=sNMPPortNumber, channelBandwidth=channelBandwidth, dfsTableNumber=dfsTableNumber, receiveModulationMode=receiveModulationMode, phyStatus=phyStatus, sntp=sntp, syslogClientTrap=syslogClientTrap, ptp=ptp, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNTPServerPortNumber=sNTPServerPortNumber, management=management, tDDControlGroup=tDDControlGroup, phyStatusGroup=phyStatusGroup, encryptionAlgorithm=encryptionAlgorithm, dfsPeaks=dfsPeaks, sNMPTrapTableNumber=sNMPTrapTableNumber, configurationGroup=configurationGroup, alarms=alarms, snmpControl=snmpControl, supplementaryGroup=supplementaryGroup, targetMACAddress=targetMACAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, telecom=telecom, constantPowerSpectralDensity=constantPowerSpectralDensity, sNTPLastSync=sNTPLastSync, range=range, transmitPower=transmitPower, syslogClient=syslogClient, linkLoss=linkLoss, altitude=altitude, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tFTPServerIPAddress=tFTPServerIPAddress, dataPortAutoMdix=dataPortAutoMdix, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, searchState=searchState, telecomsLoopbackTrap=telecomsLoopbackTrap, vLANManagementPriority=vLANManagementPriority, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortStatusTrap=dataPortStatusTrap, secondarySoftwareVersion=secondarySoftwareVersion, aAAControlGroup=aAAControlGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, encryptionGroup=encryptionGroup, incompatibleRegionCodes=incompatibleRegionCodes, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ptpGroups=ptpGroups, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, bandwidthVariant=bandwidthVariant, userRole=userRole, linkName=linkName, unitOutOfCalibration=unitOutOfCalibration, dfsTableEntry=dfsTableEntry, longitude=longitude, receiveFreqKHz=receiveFreqKHz, pubStats=pubStats, versions=versions, hTTPSPortNumber=hTTPSPortNumber, sMTPServerPortNumber=sMTPServerPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, subnetMask=subnetMask, sMTPEnabledMessages=sMTPEnabledMessages, dataPortAutoNegotiation=dataPortAutoNegotiation, userTable=userTable, hTTPSAccessEnabled=hTTPSAccessEnabled, channelChangeTrap=channelChangeTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, bootVersion=bootVersion, iPAddress=iPAddress, sNMPv3Enable=sNMPv3Enable, sNMPEnabledTraps=sNMPEnabledTraps, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, telnetAccessEnabled=telnetAccessEnabled, telecomsLineCode=telecomsLineCode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, dfsMeans=dfsMeans)
