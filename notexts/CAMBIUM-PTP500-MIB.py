...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", licenceGroup=licenceGroup, dfsTable=dfsTable, phyStatusGroup=phyStatusGroup, linkName=linkName, hTTPPortNumber=hTTPPortNumber, range=range, channelChangeTrap=channelChangeTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, antennaGain=antennaGain, userTableIndex=userTableIndex, sNMPv3Enable=sNMPv3Enable, telecomsLoopback=telecomsLoopback, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortDisabledWarning=dataPortDisabledWarning, alarms=alarms, wirelessLinkAvailability=wirelessLinkAvailability, dataPortWirelessDownAlert=dataPortWirelessDownAlert, aAAControl=aAAControl, hTTPSPortNumber=hTTPSPortNumber, licensedCapacity=licensedCapacity, sNMPCommunityString=sNMPCommunityString, smtpGroup=smtpGroup, frequencyVariant=frequencyVariant, hTTPAccessEnabled=hTTPAccessEnabled, timeZone=timeZone, phyStatus=phyStatus, productVariant=productVariant, sNTPPollInterval=sNTPPollInterval, dataPortConfigurationMismatch=dataPortConfigurationMismatch, management=management, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, eIRP=eIRP, sNMPTrapTableIndex=sNMPTrapTableIndex, channelBandwidth=channelBandwidth, smtp=smtp, bandwidthVariant=bandwidthVariant, dfs=dfs, syslogControl=syslogControl, sMTPEmailAlert=sMTPEmailAlert, syslogStateTrap=syslogStateTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, ptpTrapPrefix=ptpTrapPrefix, dfsGroup=dfsGroup, ethernet=ethernet, productName=productName, ptmp=ptmp, sNTPSync=sNTPSync, telecomsInterface=telecomsInterface, secondarySoftwareVersion=secondarySoftwareVersion, userName=userName, capacityLicenseMismatch=capacityLicenseMismatch, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, PYSNMP_MODULE_ID=cambium, alarmsGroup=alarmsGroup, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, userTable=userTable, userTableEntry=userTableEntry, linkModeOptimisation=linkModeOptimisation, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, syslogClientTrap=syslogClientTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, receiveFreqKHz=receiveFreqKHz, dfsTableEntry=dfsTableEntry, vLANPriorityTableNumber=vLANPriorityTableNumber, telecomsChannelStatusTrap=telecomsChannelStatusTrap, accessMethod=accessMethod, receiveModulationModeDetail=receiveModulationModeDetail, installStatusTrap=installStatusTrap, userTableNumber=userTableNumber, sNTPSyncTrap=sNTPSyncTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, wirelessLinkStatus=wirelessLinkStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, maximumTransmitPower=maximumTransmitPower, searchState=searchState, ptpGroups=ptpGroups, telecomsLoopbackTrap=telecomsLoopbackTrap, sntpGroup=sntpGroup, transmitModulationMode=transmitModulationMode, resetGroup=resetGroup, vLANPriorityTable=vLANPriorityTable, telnetAccessEnabled=telnetAccessEnabled, regionCode=regionCode, masterSlaveMode=masterSlaveMode, remoteIPAddress=remoteIPAddress, incompatibleRegionCodes=incompatibleRegionCodes, sNMPPortNumber=sNMPPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, encryptionAlgorithm=encryptionAlgorithm, tDDSynchronizationMode=tDDSynchronizationMode, syslogLocalWrappedTrap=syslogLocalWrappedTrap, transmitDataRate=transmitDataRate, sNMPTrapVersion=sNMPTrapVersion, iPAddress=iPAddress, gatewayIPAddress=gatewayIPAddress, userPassword=userPassword, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsPeaks=dfsPeaks, constantPowerSpectralDensity=constantPowerSpectralDensity, dfsTableIndex=dfsTableIndex, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPServerIPAddress=sNTPServerIPAddress, pubStats=pubStats, phyControlGroup=phyControlGroup, tDDControl=tDDControl, hardwareVersion=hardwareVersion, signalStrengthRatio=signalStrengthRatio, phyControl=phyControl, tDDSynchronizationAlarm=tDDSynchronizationAlarm, vLANManagementPriority=vLANManagementPriority, versions=versions, longitude=longitude, tDDControlGroup=tDDControlGroup, dfsTableNumber=dfsTableNumber, installArmState=installArmState, telnetPortNumber=telnetPortNumber, dataPortStatus=dataPortStatus, latitude=latitude, sNMPTrapTable=sNMPTrapTable, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, licence=licence, softwareVersion=softwareVersion, ptp500=ptp500, sMTPServerPortNumber=sMTPServerPortNumber, siteName=siteName, dataPortAutoMdix=dataPortAutoMdix, vectorError=vectorError, transmitFreqKHz=transmitFreqKHz, ethernetGroup=ethernetGroup, sNTPServerPortNumber=sNTPServerPortNumber, telecomGroup=telecomGroup, daylightSaving=daylightSaving, encryptionGroup=encryptionGroup, snmpControlGroup=snmpControlGroup, tFTPServerPortNumber=tFTPServerPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, transmitFreqMHz=transmitFreqMHz, tFTPServerIPAddress=tFTPServerIPAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, linkSymmetry=linkSymmetry, managementGroup=managementGroup, aAAControlGroup=aAAControlGroup, supplementary=supplementary, reset=reset, telecomsLineCode=telecomsLineCode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, systemReset=systemReset, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, ethernetFiberSupport=ethernetFiberSupport, transmitPower=transmitPower, cableLoss=cableLoss, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, configurationGroup=configurationGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, targetMACAddress=targetMACAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, transmitChannel=transmitChannel, userEnabled=userEnabled, vLANManagementVID=vLANManagementVID, subnetMask=subnetMask, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, linkModeOptimizationMismatch=linkModeOptimizationMismatch, configuration=configuration, systemClock=systemClock, telecomsChannelStatus=telecomsChannelStatus, syslogClient=syslogClient, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogState=syslogState, altitude=altitude, sNTPLastSync=sNTPLastSync, snmpControl=snmpControl, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, telecom=telecom, telecomsCableLength=telecomsCableLength, sntp=sntp, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, pubStatsGroup=pubStatsGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, userRole=userRole, vLANPriorityTableEntry=vLANPriorityTableEntry, cambium=cambium, sMTPEnabledMessages=sMTPEnabledMessages, tDDSynchronizationStatus=tDDSynchronizationStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, encryption=encryption, dfsMeans=dfsMeans, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dataPortStatusTrap=dataPortStatusTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, receiveModulationMode=receiveModulationMode, ptpCompliance=ptpCompliance, syslogControlGroup=syslogControlGroup, bootVersion=bootVersion, regionCodeTrap=regionCodeTrap, receiveChannel=receiveChannel, supplementaryGroup=supplementaryGroup, ptp=ptp, receivePower=receivePower, notificationsGroup=notificationsGroup, ptpTraps=ptpTraps, dataPortAutoNegotiation=dataPortAutoNegotiation, receiveFreqMHz=receiveFreqMHz, sNTPState=sNTPState, installArmStateTrap=installArmStateTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, byteErrorRatio=byteErrorRatio, sNMPEnabledTraps=sNMPEnabledTraps, vLANPriorityQueueMapping=vLANPriorityQueueMapping, aggregateDataRate=aggregateDataRate, groupID=groupID, versionsGroup=versionsGroup, sMTPServerIPAddress=sMTPServerIPAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, receiveDataRate=receiveDataRate, linkLoss=linkLoss, installStatus=installStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, unitOutOfCalibration=unitOutOfCalibration)
