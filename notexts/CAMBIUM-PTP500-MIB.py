...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", userRole=userRole, syslogState=syslogState, ptp=ptp, telecomsChannelStatus=telecomsChannelStatus, channelBandwidth=channelBandwidth, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dfsTableIndex=dfsTableIndex, alarmsGroup=alarmsGroup, altitude=altitude, sNTPLastSync=sNTPLastSync, vLANPriorityTableNumber=vLANPriorityTableNumber, aAAControlGroup=aAAControlGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, telecomsLoopback=telecomsLoopback, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPServerIPAddress=sNTPServerIPAddress, configuration=configuration, userTableIndex=userTableIndex, groupID=groupID, accessMethod=accessMethod, alarms=alarms, userPassword=userPassword, sNTPServerPortNumber=sNTPServerPortNumber, transmitDataRate=transmitDataRate, maximumTransmitPower=maximumTransmitPower, regionCodeTrap=regionCodeTrap, reset=reset, installStatusTrap=installStatusTrap, antennaGain=antennaGain, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tFTPServerIPAddress=tFTPServerIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, aggregateDataRate=aggregateDataRate, installArmStateTrap=installArmStateTrap, phyStatus=phyStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, vLANPriorityQueueMapping=vLANPriorityQueueMapping, regionCode=regionCode, daylightSaving=daylightSaving, softwareVersion=softwareVersion, sNTPState=sNTPState, userTable=userTable, signalStrengthRatio=signalStrengthRatio, latitude=latitude, vLANManagementVID=vLANManagementVID, dfs=dfs, sNMPPortNumber=sNMPPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ptpCompliance=ptpCompliance, sNMPTrapTable=sNMPTrapTable, subnetMask=subnetMask, vLANManagementPriority=vLANManagementPriority, sMTPEmailAlert=sMTPEmailAlert, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, capacityLicenseMismatch=capacityLicenseMismatch, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, vLANPriorityTableEntry=vLANPriorityTableEntry, telnetAccessEnabled=telnetAccessEnabled, tFTPServerPortNumber=tFTPServerPortNumber, supplementaryGroup=supplementaryGroup, secondarySoftwareVersion=secondarySoftwareVersion, snmpControl=snmpControl, range=range, telecomGroup=telecomGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sntpGroup=sntpGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, pubStats=pubStats, syslogControlGroup=syslogControlGroup, dfsTableEntry=dfsTableEntry, searchState=searchState, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dataPortStatus=dataPortStatus, wirelessLinkAvailability=wirelessLinkAvailability, telecom=telecom, licenceGroup=licenceGroup, transmitChannel=transmitChannel, transmitFreqMHz=transmitFreqMHz, dfsGroup=dfsGroup, ptpTraps=ptpTraps, installStatus=installStatus, bootVersion=bootVersion, syslogClient=syslogClient, PYSNMP_MODULE_ID=cambium, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ethernet=ethernet, notificationsGroup=notificationsGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, linkName=linkName, encryptionAlgorithm=encryptionAlgorithm, ethernetGroup=ethernetGroup, dfsTableNumber=dfsTableNumber, pubStatsGroup=pubStatsGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, telecomsInterface=telecomsInterface, constantPowerSpectralDensity=constantPowerSpectralDensity, dataPortStatusTrap=dataPortStatusTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkLoss=linkLoss, tDDSynchronizationAlarm=tDDSynchronizationAlarm, incompatibleMasterAndSlave=incompatibleMasterAndSlave, cableLoss=cableLoss, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, transmitPower=transmitPower, licensedCapacity=licensedCapacity, syslogClientTrap=syslogClientTrap, licence=licence, syslogControl=syslogControl, userTableNumber=userTableNumber, userTableEntry=userTableEntry, byteErrorRatio=byteErrorRatio, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, transmitFreqKHz=transmitFreqKHz, channelChangeTrap=channelChangeTrap, installArmState=installArmState, iPAddress=iPAddress, telecomsChannelStatusTrap=telecomsChannelStatusTrap, systemClock=systemClock, encryptionGroup=encryptionGroup, smtp=smtp, unitOutOfCalibration=unitOutOfCalibration, dfsPeaks=dfsPeaks, ptpGroups=ptpGroups, dataPortDisabledWarning=dataPortDisabledWarning, sMTPEnabledMessages=sMTPEnabledMessages, productVariant=productVariant, smtpGroup=smtpGroup, targetMACAddress=targetMACAddress, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dfsTable=dfsTable, gatewayIPAddress=gatewayIPAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, supplementary=supplementary, receivePower=receivePower, frequencyVariant=frequencyVariant, ptmp=ptmp, userEnabled=userEnabled, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, telnetPortNumber=telnetPortNumber, vectorError=vectorError, sNMPTrapTableNumber=sNMPTrapTableNumber, timeZone=timeZone, sntp=sntp, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNTPSyncTrap=sNTPSyncTrap, bandwidthVariant=bandwidthVariant, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, userName=userName, sNMPv3Enable=sNMPv3Enable, management=management, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortAutoMdix=dataPortAutoMdix, managementGroup=managementGroup, tDDControl=tDDControl, syslogStateTrap=syslogStateTrap, ptpTrapPrefix=ptpTrapPrefix, tDDControlGroup=tDDControlGroup, versionsGroup=versionsGroup, productName=productName, telecomsLineCode=telecomsLineCode, cambium=cambium, receiveModulationMode=receiveModulationMode, longitude=longitude, hTTPSPortNumber=hTTPSPortNumber, telecomsLoopbackTrap=telecomsLoopbackTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, versions=versions, snmpControlGroup=snmpControlGroup, phyControlGroup=phyControlGroup, phyStatusGroup=phyStatusGroup, dfsMeans=dfsMeans, sNMPCommunityString=sNMPCommunityString, tDDSynchronizationMode=tDDSynchronizationMode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, remoteIPAddress=remoteIPAddress, configurationGroup=configurationGroup, ethernetFiberSupport=ethernetFiberSupport, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, receiveFreqKHz=receiveFreqKHz, sNMPTrapVersion=sNMPTrapVersion, sNMPEnabledTraps=sNMPEnabledTraps, telecomsCableLength=telecomsCableLength, receiveModulationModeDetail=receiveModulationModeDetail, receiveDataRate=receiveDataRate, eIRP=eIRP, masterSlaveMode=masterSlaveMode, linkModeOptimisation=linkModeOptimisation, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, phyControl=phyControl, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, resetGroup=resetGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortWirelessDownAlert=dataPortWirelessDownAlert, receiveFreqMHz=receiveFreqMHz, vLANPriorityTable=vLANPriorityTable, transmitModulationMode=transmitModulationMode, receiveChannel=receiveChannel, linkSymmetry=linkSymmetry, sMTPServerPortNumber=sMTPServerPortNumber, hTTPPortNumber=hTTPPortNumber, siteName=siteName, sNTPSync=sNTPSync, hardwareVersion=hardwareVersion, wirelessLinkStatus=wirelessLinkStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, hTTPAccessEnabled=hTTPAccessEnabled, systemReset=systemReset, sMTPServerIPAddress=sMTPServerIPAddress, incompatibleRegionCodes=incompatibleRegionCodes, dataPortAutoNegotiation=dataPortAutoNegotiation, aAAControl=aAAControl, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPPollInterval=sNTPPollInterval, encryption=encryption, ptp500=ptp500)
