...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", encryptionAlgorithm=encryptionAlgorithm, dfsTableEntry=dfsTableEntry, tDDSynchronizationStatus=tDDSynchronizationStatus, sMTPEmailAlert=sMTPEmailAlert, dfsGroup=dfsGroup, sNMPEnabledTraps=sNMPEnabledTraps, dfsTable=dfsTable, userTable=userTable, licenceGroup=licenceGroup, cableLoss=cableLoss, ethernetFiberSupport=ethernetFiberSupport, userPassword=userPassword, snmpControl=snmpControl, dfsMeans=dfsMeans, vLANPriorityTable=vLANPriorityTable, sNTPServerIPAddress=sNTPServerIPAddress, encryption=encryption, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, phyControlGroup=phyControlGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, sNMPv3Enable=sNMPv3Enable, bootVersion=bootVersion, PYSNMP_MODULE_ID=cambium, aAAControlGroup=aAAControlGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, receiveFreqKHz=receiveFreqKHz, telnetAccessEnabled=telnetAccessEnabled, pubStatsGroup=pubStatsGroup, supplementary=supplementary, dfsTableNumber=dfsTableNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, receiveDataRate=receiveDataRate, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ptpTraps=ptpTraps, pubStats=pubStats, configurationGroup=configurationGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, installStatus=installStatus, phyControl=phyControl, accessMethod=accessMethod, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, latitude=latitude, management=management, iPAddress=iPAddress, telecom=telecom, subnetMask=subnetMask, vLANPriorityQueueMapping=vLANPriorityQueueMapping, receivePower=receivePower, telecomsChannelStatusTrap=telecomsChannelStatusTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, vLANManagementVID=vLANManagementVID, incompatibleRegionCodes=incompatibleRegionCodes, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPServerPortNumber=tFTPServerPortNumber, range=range, sNMPCommunityString=sNMPCommunityString, telecomsLoopback=telecomsLoopback, groupID=groupID, softwareVersion=softwareVersion, tFTPServerIPAddress=tFTPServerIPAddress, transmitDataRate=transmitDataRate, dataPortConfigurationMismatch=dataPortConfigurationMismatch, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, configuration=configuration, ethernet=ethernet, timeZone=timeZone, systemReset=systemReset, alarmsGroup=alarmsGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, cambium=cambium, transmitFreqKHz=transmitFreqKHz, alarms=alarms, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, receiveModulationModeDetail=receiveModulationModeDetail, sNMPTrapTableEntry=sNMPTrapTableEntry, vLANPriorityTableIndex=vLANPriorityTableIndex, wirelessLinkStatus=wirelessLinkStatus, antennaGain=antennaGain, telecomsLineCode=telecomsLineCode, userEnabled=userEnabled, regionCodeTrap=regionCodeTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, userName=userName, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, syslogState=syslogState, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, linkModeOptimisation=linkModeOptimisation, sNTPState=sNTPState, syslogLocalWrappedTrap=syslogLocalWrappedTrap, wirelessLinkAvailability=wirelessLinkAvailability, hTTPSPortNumber=hTTPSPortNumber, sNTPSyncTrap=sNTPSyncTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, supplementaryGroup=supplementaryGroup, encryptionGroup=encryptionGroup, phyStatusGroup=phyStatusGroup, telecomsCableLength=telecomsCableLength, aggregateDataRate=aggregateDataRate, userRole=userRole, regionCode=regionCode, longitude=longitude, sNTPPollInterval=sNTPPollInterval, managementGroup=managementGroup, systemClock=systemClock, receiveChannel=receiveChannel, secondarySoftwareVersion=secondarySoftwareVersion, masterSlaveMode=masterSlaveMode, ptmp=ptmp, enabledDiagnosticAlarms=enabledDiagnosticAlarms, productName=productName, unitOutOfCalibration=unitOutOfCalibration, sNMPTrapTable=sNMPTrapTable, linkLoss=linkLoss, sNMPTrapIPAddress=sNMPTrapIPAddress, remoteIPAddress=remoteIPAddress, vectorError=vectorError, gatewayIPAddress=gatewayIPAddress, dfsTableIndex=dfsTableIndex, syslogStateTrap=syslogStateTrap, byteErrorRatio=byteErrorRatio, telecomsChannelStatus=telecomsChannelStatus, installArmStateTrap=installArmStateTrap, productVariant=productVariant, resetGroup=resetGroup, sntp=sntp, targetMACAddress=targetMACAddress, dataPortStatusTrap=dataPortStatusTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, installStatusTrap=installStatusTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, licence=licence, ptpCompliance=ptpCompliance, eIRP=eIRP, syslogControl=syslogControl, tDDControlGroup=tDDControlGroup, bandwidthVariant=bandwidthVariant, sNTPSync=sNTPSync, hTTPPortNumber=hTTPPortNumber, transmitPower=transmitPower, searchState=searchState, noWirelessChannelAvailable=noWirelessChannelAvailable, channelChangeTrap=channelChangeTrap, smtpGroup=smtpGroup, syslogClient=syslogClient, reset=reset, tDDSynchronizationAlarm=tDDSynchronizationAlarm, hTTPAccessEnabled=hTTPAccessEnabled, licensedCapacity=licensedCapacity, capacityLicenseMismatch=capacityLicenseMismatch, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sntpGroup=sntpGroup, dataPortStatus=dataPortStatus, dfs=dfs, vLANManagementPriority=vLANManagementPriority, telecomGroup=telecomGroup, versionsGroup=versionsGroup, ptpTrapPrefix=ptpTrapPrefix, dataPortDisabledWarning=dataPortDisabledWarning, sMTPEnabledMessages=sMTPEnabledMessages, sMTPSourceEmailAddress=sMTPSourceEmailAddress, versions=versions, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogClientTrap=syslogClientTrap, aAAControl=aAAControl, telnetPortNumber=telnetPortNumber, linkName=linkName, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dataPortAutoMdix=dataPortAutoMdix, syslogControlGroup=syslogControlGroup, ptpGroups=ptpGroups, dataPortWirelessDownAlert=dataPortWirelessDownAlert, smtp=smtp, receiveFreqMHz=receiveFreqMHz, altitude=altitude, receiveModulationMode=receiveModulationMode, vLANPriorityTableNumber=vLANPriorityTableNumber, ptp500=ptp500, sNMPPortNumber=sNMPPortNumber, snmpControlGroup=snmpControlGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, userTableNumber=userTableNumber, transmitFreqMHz=transmitFreqMHz, signalStrengthRatio=signalStrengthRatio, channelBandwidth=channelBandwidth, sMTPServerIPAddress=sMTPServerIPAddress, telecomsInterface=telecomsInterface, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, phyStatus=phyStatus, tDDControl=tDDControl, tDDSynchronizationMode=tDDSynchronizationMode, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, hardwareVersion=hardwareVersion, frequencyVariant=frequencyVariant, userTableEntry=userTableEntry, sNTPServerPortNumber=sNTPServerPortNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, userTableIndex=userTableIndex, dfsPeaks=dfsPeaks, siteName=siteName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkSymmetry=linkSymmetry, sNMPTrapVersion=sNMPTrapVersion, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, daylightSaving=daylightSaving, transmitChannel=transmitChannel, sMTPServerPortNumber=sMTPServerPortNumber, notificationsGroup=notificationsGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, maximumTransmitPower=maximumTransmitPower, transmitModulationMode=transmitModulationMode, sNTPLastSync=sNTPLastSync, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ethernetGroup=ethernetGroup, ptp=ptp, installArmState=installArmState, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapTableIndex=sNMPTrapTableIndex)
