...
# Produced by pysmi-1.1.3 at Wed Dec  1 17:00:26 2021
...
Bits, Counter64, ObjectIdentity, Unsigned32, MibIdentifier, enterprises, TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter32, ModuleIdentity, Integer32, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "ObjectIdentity", "Unsigned32", "MibIdentifier", "enterprises", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter32", "ModuleIdentity", "Integer32", "IpAddress", "NotificationType")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sntpGroup=sntpGroup, groupID=groupID, phyStatusGroup=phyStatusGroup, systemReset=systemReset, telecomsLoopbackTrap=telecomsLoopbackTrap, installArmState=installArmState, ptp500=ptp500, dfsTable=dfsTable, userTableNumber=userTableNumber, tFTPServerPortNumber=tFTPServerPortNumber, management=management, linkModeOptimizationMismatch=linkModeOptimizationMismatch, userEnabled=userEnabled, remoteMaximumTransmitPower=remoteMaximumTransmitPower, latitude=latitude, vLANPriorityQueueMapping=vLANPriorityQueueMapping, userPassword=userPassword, ethernet=ethernet, sNTPState=sNTPState, sNTPLastSync=sNTPLastSync, encryptionGroup=encryptionGroup, vLANManagementPriority=vLANManagementPriority, PYSNMP_MODULE_ID=cambium, licensedCapacity=licensedCapacity, smtpGroup=smtpGroup, receiveFreqMHz=receiveFreqMHz, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, productName=productName, systemClock=systemClock, receiveModulationMode=receiveModulationMode, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNMPCommunityString=sNMPCommunityString, tFTPServerIPAddress=tFTPServerIPAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receiveChannel=receiveChannel, tDDSynchronizationAlarm=tDDSynchronizationAlarm, noWirelessChannelAvailable=noWirelessChannelAvailable, phyControlGroup=phyControlGroup, siteName=siteName, productVariant=productVariant, linkLoss=linkLoss, sNMPTrapTableNumber=sNMPTrapTableNumber, encryption=encryption, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, vLANPriorityTable=vLANPriorityTable, smtp=smtp, pubStats=pubStats, linkModeOptimisation=linkModeOptimisation, linkName=linkName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapTable=sNMPTrapTable, ethernetFiberSupport=ethernetFiberSupport, transmitPower=transmitPower, byteErrorRatio=byteErrorRatio, licenceGroup=licenceGroup, eIRP=eIRP, dfs=dfs, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, telecomsLineCode=telecomsLineCode, telnetAccessEnabled=telnetAccessEnabled, versions=versions, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPTrapVersion=sNMPTrapVersion, tDDControl=tDDControl, transmitFreqKHz=transmitFreqKHz, ptpGroups=ptpGroups, accessMethod=accessMethod, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortStatusTrap=dataPortStatusTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ptp=ptp, dataPortStatus=dataPortStatus, versionsGroup=versionsGroup, receivePower=receivePower, snmpControl=snmpControl, vectorError=vectorError, sNTPServerPortNumber=sNTPServerPortNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, snmpControlGroup=snmpControlGroup, dfsTableNumber=dfsTableNumber, telecomGroup=telecomGroup, supplementary=supplementary, userTableEntry=userTableEntry, userTableIndex=userTableIndex, remoteIPAddress=remoteIPAddress, sNMPv3Enable=sNMPv3Enable, vLANPriorityTableIndex=vLANPriorityTableIndex, reset=reset, telecomsLoopback=telecomsLoopback, dfsTableIndex=dfsTableIndex, range=range, transmitModulationMode=transmitModulationMode, receiveFreqKHz=receiveFreqKHz, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPPortNumber=sNMPPortNumber, daylightSaving=daylightSaving, secondarySoftwareVersion=secondarySoftwareVersion, channelBandwidth=channelBandwidth, hTTPSPortNumber=hTTPSPortNumber, phyStatus=phyStatus, dataPortDisabledWarning=dataPortDisabledWarning, tDDSynchronizationStatus=tDDSynchronizationStatus, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, iPAddress=iPAddress, encryptionAlgorithm=encryptionAlgorithm, dfsPeaks=dfsPeaks, telnetPortNumber=telnetPortNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, wirelessLinkAvailability=wirelessLinkAvailability, vLANPriorityTableEntry=vLANPriorityTableEntry, masterSlaveMode=masterSlaveMode, transmitChannel=transmitChannel, syslogClientTrap=syslogClientTrap, sMTPEnabledMessages=sMTPEnabledMessages, capacityLicenseMismatch=capacityLicenseMismatch, sNMPTrapTableIndex=sNMPTrapTableIndex, signalStrengthRatio=signalStrengthRatio, configurationGroup=configurationGroup, softwareVersion=softwareVersion, telecom=telecom, linkSymmetry=linkSymmetry, timeZone=timeZone, hardwareVersion=hardwareVersion, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, managementGroup=managementGroup, tDDSynchronizationMode=tDDSynchronizationMode, installStatus=installStatus, resetGroup=resetGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, regionCode=regionCode, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, syslogState=syslogState, sMTPEmailAlert=sMTPEmailAlert, syslogClient=syslogClient, telecomsInterface=telecomsInterface, userTable=userTable, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogControlGroup=syslogControlGroup, aAAControl=aAAControl, ethernetGroup=ethernetGroup, regionCodeTrap=regionCodeTrap, tDDControlGroup=tDDControlGroup, sNTPPollInterval=sNTPPollInterval, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ptmp=ptmp, subnetMask=subnetMask, dfsMeans=dfsMeans, enabledDiagnosticAlarms=enabledDiagnosticAlarms, searchState=searchState, phyControl=phyControl, aAAControlGroup=aAAControlGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, unitOutOfCalibration=unitOutOfCalibration, transmitDataRate=transmitDataRate, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, userName=userName, maximumTransmitPower=maximumTransmitPower, hTTPAccessEnabled=hTTPAccessEnabled, longitude=longitude, cambium=cambium, sMTPSourceEmailAddress=sMTPSourceEmailAddress, bandwidthVariant=bandwidthVariant, sNMPEnabledTraps=sNMPEnabledTraps, sMTPServerIPAddress=sMTPServerIPAddress, telecomsCableLength=telecomsCableLength, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ptpTraps=ptpTraps, vLANPriorityTableNumber=vLANPriorityTableNumber, alarms=alarms, hTTPSAccessEnabled=hTTPSAccessEnabled, sntp=sntp, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, alarmsGroup=alarmsGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, aggregateDataRate=aggregateDataRate, dataPortAutoNegotiation=dataPortAutoNegotiation, sNTPSyncTrap=sNTPSyncTrap, configuration=configuration, cableLoss=cableLoss, receiveModulationModeDetail=receiveModulationModeDetail, syslogStateTrap=syslogStateTrap, dfsTableEntry=dfsTableEntry, antennaGain=antennaGain, telecomsChannelStatus=telecomsChannelStatus, hTTPPortNumber=hTTPPortNumber, altitude=altitude, syslogControl=syslogControl, sNTPSync=sNTPSync, supplementaryGroup=supplementaryGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sMTPServerPortNumber=sMTPServerPortNumber, ptpCompliance=ptpCompliance, transmitFreqMHz=transmitFreqMHz, receiveDataRate=receiveDataRate, notificationsGroup=notificationsGroup, frequencyVariant=frequencyVariant, userRole=userRole, dataPortAutoMdix=dataPortAutoMdix, licence=licence, installArmStateTrap=installArmStateTrap, dfsGroup=dfsGroup, telecomsChannelStatusTrap=telecomsChannelStatusTrap, bootVersion=bootVersion, vLANManagementVID=vLANManagementVID, sNTPServerIPAddress=sNTPServerIPAddress, channelChangeTrap=channelChangeTrap, installStatusTrap=installStatusTrap, pubStatsGroup=pubStatsGroup, targetMACAddress=targetMACAddress, gatewayIPAddress=gatewayIPAddress, ptpTrapPrefix=ptpTrapPrefix, wirelessLinkStatus=wirelessLinkStatus, incompatibleRegionCodes=incompatibleRegionCodes, sNMPTrapPortNumber=sNMPTrapPortNumber)
