...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", altitude=altitude, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, supplementaryGroup=supplementaryGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, installArmState=installArmState, encryptionGroup=encryptionGroup, signalStrengthRatio=signalStrengthRatio, remoteIPAddress=remoteIPAddress, ptpGroups=ptpGroups, versionsGroup=versionsGroup, hTTPPortNumber=hTTPPortNumber, reset=reset, secondarySoftwareVersion=secondarySoftwareVersion, groupID=groupID, encryption=encryption, installArmStateTrap=installArmStateTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, resetGroup=resetGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, tDDSynchronizationStatus=tDDSynchronizationStatus, transmitPower=transmitPower, linkName=linkName, aAAControlGroup=aAAControlGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, receiveChannel=receiveChannel, sMTPServerIPAddress=sMTPServerIPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, cableLoss=cableLoss, ptpCompliance=ptpCompliance, transmitFreqMHz=transmitFreqMHz, masterSlaveMode=masterSlaveMode, syslogControlGroup=syslogControlGroup, configuration=configuration, ptpTraps=ptpTraps, timeZone=timeZone, sNTPPollInterval=sNTPPollInterval, longitude=longitude, searchState=searchState, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, syslogClient=syslogClient, userEnabled=userEnabled, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, vLANManagementPriority=vLANManagementPriority, alarms=alarms, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dfs=dfs, transmitModulationMode=transmitModulationMode, daylightSaving=daylightSaving, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ethernetGroup=ethernetGroup, snmpControlGroup=snmpControlGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, dataPortDisabledWarning=dataPortDisabledWarning, telecomsChannelStatusTrap=telecomsChannelStatusTrap, targetMACAddress=targetMACAddress, dataPortStatus=dataPortStatus, vLANManagementVID=vLANManagementVID, sNMPTrapTableIndex=sNMPTrapTableIndex, userPassword=userPassword, sNMPTrapPortNumber=sNMPTrapPortNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfsGroup=dfsGroup, aggregateDataRate=aggregateDataRate, cambium=cambium, dataPortAutoNegotiation=dataPortAutoNegotiation, phyStatusGroup=phyStatusGroup, licence=licence, sNMPTrapTable=sNMPTrapTable, maximumTransmitPower=maximumTransmitPower, userTableNumber=userTableNumber, channelChangeTrap=channelChangeTrap, linkSymmetry=linkSymmetry, versions=versions, sNMPTrapVersion=sNMPTrapVersion, hardwareVersion=hardwareVersion, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, phyStatus=phyStatus, regionCodeTrap=regionCodeTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ethernet=ethernet, linkModeOptimizationMismatch=linkModeOptimizationMismatch, licensedCapacity=licensedCapacity, bootVersion=bootVersion, telecomsCableLength=telecomsCableLength, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPCommunityString=sNMPCommunityString, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, supplementary=supplementary, softwareVersion=softwareVersion, sNMPv3Enable=sNMPv3Enable, tFTPServerIPAddress=tFTPServerIPAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dfsTableEntry=dfsTableEntry, sNTPState=sNTPState, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPEnabledTraps=sNMPEnabledTraps, receivePower=receivePower, syslogState=syslogState, dfsTableNumber=dfsTableNumber, linkModeOptimisation=linkModeOptimisation, smtpGroup=smtpGroup, tDDControl=tDDControl, ptmp=ptmp, systemClock=systemClock, configurationGroup=configurationGroup, sntpGroup=sntpGroup, accessMethod=accessMethod, enabledDiagnosticAlarms=enabledDiagnosticAlarms, telecomGroup=telecomGroup, linkLoss=linkLoss, sNMPPortNumber=sNMPPortNumber, pubStatsGroup=pubStatsGroup, management=management, ptpTrapPrefix=ptpTrapPrefix, subnetMask=subnetMask, receiveModulationModeDetail=receiveModulationModeDetail, sNTPSync=sNTPSync, eIRP=eIRP, userTableIndex=userTableIndex, managementGroup=managementGroup, PYSNMP_MODULE_ID=cambium, sntp=sntp, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPLastSync=sNTPLastSync, systemReset=systemReset, dfsTable=dfsTable, userTable=userTable, ptp500=ptp500, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortStatusTrap=dataPortStatusTrap, installStatus=installStatus, telnetAccessEnabled=telnetAccessEnabled, dfsTableIndex=dfsTableIndex, alarmsGroup=alarmsGroup, productVariant=productVariant, incompatibleRegionCodes=incompatibleRegionCodes, syslogStateTrap=syslogStateTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, transmitChannel=transmitChannel, hTTPAccessEnabled=hTTPAccessEnabled, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, syslogControl=syslogControl, noWirelessChannelAvailable=noWirelessChannelAvailable, telnetPortNumber=telnetPortNumber, byteErrorRatio=byteErrorRatio, sNTPServerPortNumber=sNTPServerPortNumber, telecomsLoopback=telecomsLoopback, telecomsLineCode=telecomsLineCode, telecomsInterface=telecomsInterface, productName=productName, range=range, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, siteName=siteName, telecomsChannelStatus=telecomsChannelStatus, hTTPSPortNumber=hTTPSPortNumber, pubStats=pubStats, transmitDataRate=transmitDataRate, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, unitOutOfCalibration=unitOutOfCalibration, dataPortAutoMdix=dataPortAutoMdix, gatewayIPAddress=gatewayIPAddress, userTableEntry=userTableEntry, smtp=smtp, sNMPTrapTableNumber=sNMPTrapTableNumber, snmpControl=snmpControl, encryptionAlgorithm=encryptionAlgorithm, licenceGroup=licenceGroup, receiveModulationMode=receiveModulationMode, tDDSynchronizationMode=tDDSynchronizationMode, aAAControl=aAAControl, notificationsGroup=notificationsGroup, telecom=telecom, capacityLicenseMismatch=capacityLicenseMismatch, sNTPSyncTrap=sNTPSyncTrap, vLANPriorityQueueMapping=vLANPriorityQueueMapping, antennaGain=antennaGain, ptp=ptp, dfsMeans=dfsMeans, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, vLANPriorityTableNumber=vLANPriorityTableNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, transmitFreqKHz=transmitFreqKHz, sMTPServerPortNumber=sMTPServerPortNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, vectorError=vectorError, phyControl=phyControl, incompatibleMasterAndSlave=incompatibleMasterAndSlave, syslogClientTrap=syslogClientTrap, tFTPServerPortNumber=tFTPServerPortNumber, receiveDataRate=receiveDataRate, wirelessLinkStatus=wirelessLinkStatus, phyControlGroup=phyControlGroup, regionCode=regionCode, sNTPServerIPAddress=sNTPServerIPAddress, wirelessLinkAvailability=wirelessLinkAvailability, userName=userName, latitude=latitude, sMTPEnabledMessages=sMTPEnabledMessages, channelBandwidth=channelBandwidth, receiveFreqMHz=receiveFreqMHz, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, installStatusTrap=installStatusTrap, tDDControlGroup=tDDControlGroup, telecomsLoopbackTrap=telecomsLoopbackTrap, sMTPEmailAlert=sMTPEmailAlert, vLANPriorityTable=vLANPriorityTable, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ethernetFiberSupport=ethernetFiberSupport, receiveFreqKHz=receiveFreqKHz, dfsPeaks=dfsPeaks, frequencyVariant=frequencyVariant, userRole=userRole, bandwidthVariant=bandwidthVariant, sNMPTrapTableEntry=sNMPTrapTableEntry, iPAddress=iPAddress)
