...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sNMPTrapTable=sNMPTrapTable, receiveChannel=receiveChannel, dataPortStatusTrap=dataPortStatusTrap, systemClock=systemClock, sNTPPollInterval=sNTPPollInterval, sNMPTrapPortNumber=sNMPTrapPortNumber, receiveModulationMode=receiveModulationMode, PYSNMP_MODULE_ID=cambium, sNTPLastSync=sNTPLastSync, timeZone=timeZone, useVLANForManagementInterfaces=useVLANForManagementInterfaces, targetMACAddress=targetMACAddress, installStatus=installStatus, resetGroup=resetGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, tDDSynchronizationMode=tDDSynchronizationMode, syslogLocalWrappedTrap=syslogLocalWrappedTrap, installStatusTrap=installStatusTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, phyControl=phyControl, enabledDiagnosticAlarms=enabledDiagnosticAlarms, notificationsGroup=notificationsGroup, supplementary=supplementary, telecom=telecom, subnetMask=subnetMask, telecomsChannelStatus=telecomsChannelStatus, hTTPSPortNumber=hTTPSPortNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, longitude=longitude, dfsPeaks=dfsPeaks, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dfsTableNumber=dfsTableNumber, linkLoss=linkLoss, linkModeOptimizationMismatch=linkModeOptimizationMismatch, frequencyVariant=frequencyVariant, hTTPSAccessEnabled=hTTPSAccessEnabled, linkModeOptimisation=linkModeOptimisation, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, signalStrengthRatio=signalStrengthRatio, userPassword=userPassword, incompatibleRegionCodes=incompatibleRegionCodes, antennaGain=antennaGain, dfsTableEntry=dfsTableEntry, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, syslogClient=syslogClient, userTableNumber=userTableNumber, sNMPEnabledTraps=sNMPEnabledTraps, cableLoss=cableLoss, userTableEntry=userTableEntry, dataPortDisabledWarning=dataPortDisabledWarning, transmitModulationMode=transmitModulationMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, transmitChannel=transmitChannel, sMTPEnabledMessages=sMTPEnabledMessages, receivePower=receivePower, syslogStateTrap=syslogStateTrap, encryptionGroup=encryptionGroup, configurationGroup=configurationGroup, channelBandwidth=channelBandwidth, vectorError=vectorError, sNMPPortNumber=sNMPPortNumber, userRole=userRole, dfs=dfs, licenceGroup=licenceGroup, ethernetGroup=ethernetGroup, encryptionAlgorithm=encryptionAlgorithm, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, wirelessLinkAvailability=wirelessLinkAvailability, iPAddress=iPAddress, telecomsChannelStatusTrap=telecomsChannelStatusTrap, cambium=cambium, dataPortStatus=dataPortStatus, sNTPSyncTrap=sNTPSyncTrap, vLANManagementPriority=vLANManagementPriority, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, gatewayIPAddress=gatewayIPAddress, aAAControlGroup=aAAControlGroup, dfsMeans=dfsMeans, pubStats=pubStats, hardwareVersion=hardwareVersion, sNTPServerIPAddress=sNTPServerIPAddress, sntp=sntp, telecomGroup=telecomGroup, supplementaryGroup=supplementaryGroup, bootVersion=bootVersion, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNTPServerPortNumber=sNTPServerPortNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapIPAddress=sNMPTrapIPAddress, smtpGroup=smtpGroup, ptp=ptp, byteErrorRatio=byteErrorRatio, pubStatsGroup=pubStatsGroup, sNTPState=sNTPState, userEnabled=userEnabled, dataPortAutoMdix=dataPortAutoMdix, ethernetFiberSupport=ethernetFiberSupport, telecomsCableLength=telecomsCableLength, hTTPAccessEnabled=hTTPAccessEnabled, tDDControlGroup=tDDControlGroup, syslogClientTrap=syslogClientTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, masterSlaveMode=masterSlaveMode, telecomsInterface=telecomsInterface, dataPortWirelessDownAlert=dataPortWirelessDownAlert, unitOutOfCalibration=unitOutOfCalibration, vLANPriorityTable=vLANPriorityTable, linkSymmetry=linkSymmetry, searchState=searchState, dataPortConfigurationMismatch=dataPortConfigurationMismatch, vLANPriorityTableIndex=vLANPriorityTableIndex, userTable=userTable, alarms=alarms, receiveModulationModeDetail=receiveModulationModeDetail, transmitFreqKHz=transmitFreqKHz, versionsGroup=versionsGroup, siteName=siteName, tFTPServerPortNumber=tFTPServerPortNumber, snmpControlGroup=snmpControlGroup, altitude=altitude, ptp500=ptp500, daylightSaving=daylightSaving, hTTPPortNumber=hTTPPortNumber, regionCodeTrap=regionCodeTrap, transmitFreqMHz=transmitFreqMHz, sntpGroup=sntpGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, installArmStateTrap=installArmStateTrap, phyControlGroup=phyControlGroup, sMTPEmailAlert=sMTPEmailAlert, telecomsLoopbackTrap=telecomsLoopbackTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, groupID=groupID, telnetAccessEnabled=telnetAccessEnabled, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, secondarySoftwareVersion=secondarySoftwareVersion, accessMethod=accessMethod, syslogState=syslogState, sNMPTrapTableEntry=sNMPTrapTableEntry, tDDSynchronizationAlarm=tDDSynchronizationAlarm, licence=licence, phyStatus=phyStatus, receiveDataRate=receiveDataRate, eIRP=eIRP, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, systemReset=systemReset, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, installArmState=installArmState, userName=userName, productName=productName, ptpCompliance=ptpCompliance, dfsGroup=dfsGroup, ptpGroups=ptpGroups, alarmsGroup=alarmsGroup, maximumTransmitPower=maximumTransmitPower, remoteIPAddress=remoteIPAddress, management=management, sNTPSync=sNTPSync, vLANPriorityTableNumber=vLANPriorityTableNumber, smtp=smtp, sMTPServerPortNumber=sMTPServerPortNumber, regionCode=regionCode, aAAControl=aAAControl, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, receiveFreqKHz=receiveFreqKHz, syslogControl=syslogControl, userTableIndex=userTableIndex, wirelessLinkStatus=wirelessLinkStatus, telecomsLineCode=telecomsLineCode, reset=reset, encryption=encryption, versions=versions, licensedCapacity=licensedCapacity, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, telnetPortNumber=telnetPortNumber, productVariant=productVariant, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNMPCommunityString=sNMPCommunityString, vLANManagementVID=vLANManagementVID, range=range, dataPortAutoNegotiation=dataPortAutoNegotiation, ethernet=ethernet, aggregateDataRate=aggregateDataRate, capacityLicenseMismatch=capacityLicenseMismatch, linkName=linkName, receiveFreqMHz=receiveFreqMHz, sNMPTrapTableIndex=sNMPTrapTableIndex, transmitPower=transmitPower, phyStatusGroup=phyStatusGroup, ptpTrapPrefix=ptpTrapPrefix, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, latitude=latitude, managementGroup=managementGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vLANPriorityQueueMapping=vLANPriorityQueueMapping, channelChangeTrap=channelChangeTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfsTable=dfsTable, syslogControlGroup=syslogControlGroup, bandwidthVariant=bandwidthVariant, snmpControl=snmpControl, ptpTraps=ptpTraps, transmitDataRate=transmitDataRate, softwareVersion=softwareVersion, sMTPServerIPAddress=sMTPServerIPAddress, dfsTableIndex=dfsTableIndex, sNMPv3Enable=sNMPv3Enable, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, tFTPServerIPAddress=tFTPServerIPAddress, telecomsLoopback=telecomsLoopback, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapVersion=sNMPTrapVersion, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, configuration=configuration, ptmp=ptmp, tDDControl=tDDControl, vLANPriorityTableEntry=vLANPriorityTableEntry)
