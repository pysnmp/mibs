...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", userTableIndex=userTableIndex, phyControl=phyControl, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPServerIPAddress=sNTPServerIPAddress, telecomsLoopback=telecomsLoopback, sMTPServerPortNumber=sMTPServerPortNumber, licence=licence, versions=versions, accessMethod=accessMethod, dataPortAutoMdix=dataPortAutoMdix, tFTPServerPortNumber=tFTPServerPortNumber, bootVersion=bootVersion, notificationsGroup=notificationsGroup, dfs=dfs, timeZone=timeZone, transmitFreqKHz=transmitFreqKHz, enabledDiagnosticAlarms=enabledDiagnosticAlarms, userName=userName, hTTPSPortNumber=hTTPSPortNumber, syslogControl=syslogControl, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPEnabledTraps=sNMPEnabledTraps, aggregateDataRate=aggregateDataRate, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tFTPServerIPAddress=tFTPServerIPAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, regionCode=regionCode, reset=reset, sNMPTrapVersion=sNMPTrapVersion, syslogClientTrap=syslogClientTrap, userTableNumber=userTableNumber, phyStatus=phyStatus, tDDControl=tDDControl, dataPortStatus=dataPortStatus, telecomsCableLength=telecomsCableLength, receiveFreqKHz=receiveFreqKHz, syslogState=syslogState, telecomsInterface=telecomsInterface, wirelessLinkAvailability=wirelessLinkAvailability, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, installArmStateTrap=installArmStateTrap, unitOutOfCalibration=unitOutOfCalibration, subnetMask=subnetMask, hTTPSAccessEnabled=hTTPSAccessEnabled, transmitDataRate=transmitDataRate, telecomsChannelStatusTrap=telecomsChannelStatusTrap, linkName=linkName, phyControlGroup=phyControlGroup, eIRP=eIRP, sNTPServerPortNumber=sNTPServerPortNumber, ethernet=ethernet, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, iPAddress=iPAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tDDControlGroup=tDDControlGroup, linkLoss=linkLoss, sNMPTrapTable=sNMPTrapTable, encryption=encryption, incompatibleMasterAndSlave=incompatibleMasterAndSlave, gatewayIPAddress=gatewayIPAddress, ethernetFiberSupport=ethernetFiberSupport, daylightSaving=daylightSaving, telnetPortNumber=telnetPortNumber, ptpTraps=ptpTraps, phyStatusGroup=phyStatusGroup, sntp=sntp, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telecom=telecom, transmitModulationMode=transmitModulationMode, signalStrengthRatio=signalStrengthRatio, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapTableNumber=sNMPTrapTableNumber, remoteIPAddress=remoteIPAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tDDSynchronizationMode=tDDSynchronizationMode, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, managementGroup=managementGroup, incompatibleRegionCodes=incompatibleRegionCodes, sNTPPollInterval=sNTPPollInterval, systemReset=systemReset, smtp=smtp, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitFreqMHz=transmitFreqMHz, sNMPTrapTableIndex=sNMPTrapTableIndex, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, installStatus=installStatus, vLANPriorityTable=vLANPriorityTable, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, versionsGroup=versionsGroup, ethernetGroup=ethernetGroup, dfsTable=dfsTable, masterSlaveMode=masterSlaveMode, sNMPTrapPortNumber=sNMPTrapPortNumber, longitude=longitude, sNTPLastSync=sNTPLastSync, vLANPriorityQueueMapping=vLANPriorityQueueMapping, vectorError=vectorError, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, vLANPriorityTableNumber=vLANPriorityTableNumber, latitude=latitude, vLANPriorityTableIndex=vLANPriorityTableIndex, frequencyVariant=frequencyVariant, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dataPortDisabledWarning=dataPortDisabledWarning, antennaGain=antennaGain, aAAControl=aAAControl, dfsPeaks=dfsPeaks, vLANManagementVID=vLANManagementVID, groupID=groupID, sNMPv3Enable=sNMPv3Enable, licensedCapacity=licensedCapacity, linkModeOptimisation=linkModeOptimisation, receiveModulationMode=receiveModulationMode, configuration=configuration, ptpCompliance=ptpCompliance, configurationGroup=configurationGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, siteName=siteName, regionCodeTrap=regionCodeTrap, dataPortStatusTrap=dataPortStatusTrap, sMTPEnabledMessages=sMTPEnabledMessages, wirelessLinkStatus=wirelessLinkStatus, channelChangeTrap=channelChangeTrap, ptp500=ptp500, sMTPServerIPAddress=sMTPServerIPAddress, supplementaryGroup=supplementaryGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, targetMACAddress=targetMACAddress, receiveDataRate=receiveDataRate, pubStats=pubStats, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfsTableIndex=dfsTableIndex, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, smtpGroup=smtpGroup, cambium=cambium, sNTPSyncTrap=sNTPSyncTrap, dfsGroup=dfsGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, productName=productName, altitude=altitude, PYSNMP_MODULE_ID=cambium, snmpControl=snmpControl, sNMPTrapTableEntry=sNMPTrapTableEntry, management=management, installArmState=installArmState, systemClock=systemClock, receivePower=receivePower, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dfsMeans=dfsMeans, transmitChannel=transmitChannel, dfsTableNumber=dfsTableNumber, encryptionAlgorithm=encryptionAlgorithm, ptp=ptp, userTableEntry=userTableEntry, capacityLicenseMismatch=capacityLicenseMismatch, sNMPPortNumber=sNMPPortNumber, hTTPPortNumber=hTTPPortNumber, alarms=alarms, productVariant=productVariant, syslogControlGroup=syslogControlGroup, maximumTransmitPower=maximumTransmitPower, receiveModulationModeDetail=receiveModulationModeDetail, ptpTrapPrefix=ptpTrapPrefix, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dfsTableEntry=dfsTableEntry, installStatusTrap=installStatusTrap, userRole=userRole, supplementary=supplementary, dataPortAutoNegotiation=dataPortAutoNegotiation, secondarySoftwareVersion=secondarySoftwareVersion, receiveChannel=receiveChannel, userPassword=userPassword, constantPowerSpectralDensity=constantPowerSpectralDensity, vLANManagementPriority=vLANManagementPriority, receiveFreqMHz=receiveFreqMHz, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, licenceGroup=licenceGroup, range=range, telecomsChannelStatus=telecomsChannelStatus, resetGroup=resetGroup, softwareVersion=softwareVersion, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNTPSync=sNTPSync, alarmsGroup=alarmsGroup, channelBandwidth=channelBandwidth, linkSymmetry=linkSymmetry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, hTTPAccessEnabled=hTTPAccessEnabled, syslogStateTrap=syslogStateTrap, telecomGroup=telecomGroup, sNMPCommunityString=sNMPCommunityString, encryptionGroup=encryptionGroup, sMTPEmailAlert=sMTPEmailAlert, bandwidthVariant=bandwidthVariant, byteErrorRatio=byteErrorRatio, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, searchState=searchState, transmitPower=transmitPower, sntpGroup=sntpGroup, ptpGroups=ptpGroups, noWirelessChannelAvailable=noWirelessChannelAvailable, ptmp=ptmp, linkModeOptimizationMismatch=linkModeOptimizationMismatch, pubStatsGroup=pubStatsGroup, hardwareVersion=hardwareVersion, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, cableLoss=cableLoss, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, aAAControlGroup=aAAControlGroup, telecomsLoopbackTrap=telecomsLoopbackTrap, snmpControlGroup=snmpControlGroup, syslogClient=syslogClient, sNTPState=sNTPState, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, userEnabled=userEnabled, userTable=userTable, telnetAccessEnabled=telnetAccessEnabled, telecomsLineCode=telecomsLineCode, tDDSynchronizationAlarm=tDDSynchronizationAlarm)
