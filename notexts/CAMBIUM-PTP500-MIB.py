...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sNTPServerIPAddress=sNTPServerIPAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, hardwareVersion=hardwareVersion, receiveModulationModeDetail=receiveModulationModeDetail, tDDControlGroup=tDDControlGroup, dataPortStatus=dataPortStatus, phyStatusGroup=phyStatusGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ethernetFiberSupport=ethernetFiberSupport, hTTPPortNumber=hTTPPortNumber, channelBandwidth=channelBandwidth, sNTPLastSync=sNTPLastSync, incompatibleMasterAndSlave=incompatibleMasterAndSlave, remoteMaximumTransmitPower=remoteMaximumTransmitPower, installStatusTrap=installStatusTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, secondarySoftwareVersion=secondarySoftwareVersion, vLANPriorityTableNumber=vLANPriorityTableNumber, licenceGroup=licenceGroup, installArmState=installArmState, aAAControl=aAAControl, gatewayIPAddress=gatewayIPAddress, vLANPriorityTableIndex=vLANPriorityTableIndex, vLANManagementPriority=vLANManagementPriority, dfsTableEntry=dfsTableEntry, dfs=dfs, userPassword=userPassword, ptpTraps=ptpTraps, userEnabled=userEnabled, linkLoss=linkLoss, sNMPTrapIPAddress=sNMPTrapIPAddress, telecomsCableLength=telecomsCableLength, searchState=searchState, sNMPTrapPortNumber=sNMPTrapPortNumber, telecomsInterface=telecomsInterface, productVariant=productVariant, receiveChannel=receiveChannel, linkModeOptimizationMismatch=linkModeOptimizationMismatch, resetGroup=resetGroup, sNTPSyncTrap=sNTPSyncTrap, syslogState=syslogState, ethernet=ethernet, sNMPTrapTable=sNMPTrapTable, systemClock=systemClock, cambium=cambium, bandwidthVariant=bandwidthVariant, dfsMeans=dfsMeans, ptp=ptp, dataPortAutoMdix=dataPortAutoMdix, incompatibleRegionCodes=incompatibleRegionCodes, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sMTPServerPortNumber=sMTPServerPortNumber, longitude=longitude, encryptionAlgorithm=encryptionAlgorithm, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortWirelessDownAlert=dataPortWirelessDownAlert, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, remoteIPAddress=remoteIPAddress, dfsTableNumber=dfsTableNumber, pubStatsGroup=pubStatsGroup, siteName=siteName, linkName=linkName, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, linkModeOptimisation=linkModeOptimisation, systemReset=systemReset, configuration=configuration, eIRP=eIRP, dataPortDisabledWarning=dataPortDisabledWarning, unitOutOfCalibration=unitOutOfCalibration, maximumTransmitPower=maximumTransmitPower, tFTPServerIPAddress=tFTPServerIPAddress, telecomGroup=telecomGroup, linkSymmetry=linkSymmetry, vectorError=vectorError, tDDSynchronizationStatus=tDDSynchronizationStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, userTable=userTable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, telecomsLoopbackTrap=telecomsLoopbackTrap, userTableIndex=userTableIndex, sntp=sntp, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNMPEnabledTraps=sNMPEnabledTraps, sNTPState=sNTPState, versions=versions, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, phyControl=phyControl, sMTPEnabledMessages=sMTPEnabledMessages, transmitDataRate=transmitDataRate, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, antennaGain=antennaGain, receiveFreqMHz=receiveFreqMHz, telecomsChannelStatus=telecomsChannelStatus, receiveFreqKHz=receiveFreqKHz, ptp500=ptp500, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptpCompliance=ptpCompliance, sntpGroup=sntpGroup, altitude=altitude, configurationGroup=configurationGroup, ptpTrapPrefix=ptpTrapPrefix, smtpGroup=smtpGroup, telnetAccessEnabled=telnetAccessEnabled, sMTPEmailAlert=sMTPEmailAlert, notificationsGroup=notificationsGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, reset=reset, sNMPTrapVersion=sNMPTrapVersion, smtp=smtp, transmitFreqMHz=transmitFreqMHz, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, managementGroup=managementGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, supplementary=supplementary, syslogControlGroup=syslogControlGroup, dfsPeaks=dfsPeaks, licence=licence, alarms=alarms, licensedCapacity=licensedCapacity, pubStats=pubStats, vLANPriorityTableEntry=vLANPriorityTableEntry, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receivePower=receivePower, vLANPriorityQueueMapping=vLANPriorityQueueMapping, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortStatusTrap=dataPortStatusTrap, sNTPServerPortNumber=sNTPServerPortNumber, supplementaryGroup=supplementaryGroup, phyControlGroup=phyControlGroup, regionCode=regionCode, alarmsGroup=alarmsGroup, targetMACAddress=targetMACAddress, sNTPSync=sNTPSync, softwareVersion=softwareVersion, wirelessLinkStatus=wirelessLinkStatus, telecomsLoopback=telecomsLoopback, sMTPServerIPAddress=sMTPServerIPAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, transmitChannel=transmitChannel, snmpControl=snmpControl, sNMPv3Enable=sNMPv3Enable, sNMPTrapTableIndex=sNMPTrapTableIndex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, syslogClientTrap=syslogClientTrap, bootVersion=bootVersion, dfsTable=dfsTable, syslogClient=syslogClient, hTTPAccessEnabled=hTTPAccessEnabled, phyStatus=phyStatus, telnetPortNumber=telnetPortNumber, ptpGroups=ptpGroups, noWirelessChannelAvailable=noWirelessChannelAvailable, tDDControl=tDDControl, vLANPriorityTable=vLANPriorityTable, telecom=telecom, snmpControlGroup=snmpControlGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, encryption=encryption, vLANManagementVID=vLANManagementVID, PYSNMP_MODULE_ID=cambium, channelChangeTrap=channelChangeTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, masterSlaveMode=masterSlaveMode, capacityLicenseMismatch=capacityLicenseMismatch, receiveModulationMode=receiveModulationMode, range=range, groupID=groupID, aggregateDataRate=aggregateDataRate, sNMPTrapTableNumber=sNMPTrapTableNumber, syslogStateTrap=syslogStateTrap, timeZone=timeZone, installArmStateTrap=installArmStateTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, iPAddress=iPAddress, byteErrorRatio=byteErrorRatio, cableLoss=cableLoss, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, management=management, frequencyVariant=frequencyVariant, userTableEntry=userTableEntry, userRole=userRole, accessMethod=accessMethod, signalStrengthRatio=signalStrengthRatio, transmitModulationMode=transmitModulationMode, dfsGroup=dfsGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, productName=productName, versionsGroup=versionsGroup, syslogControl=syslogControl, ptmp=ptmp, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPPortNumber=sNMPPortNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, receiveDataRate=receiveDataRate, sNMPCommunityString=sNMPCommunityString, wirelessLinkAvailability=wirelessLinkAvailability, dataPortConfigurationMismatch=dataPortConfigurationMismatch, transmitPower=transmitPower, daylightSaving=daylightSaving, aAAControlGroup=aAAControlGroup, dfsTableIndex=dfsTableIndex, installStatus=installStatus, tFTPServerPortNumber=tFTPServerPortNumber, userTableNumber=userTableNumber, transmitFreqKHz=transmitFreqKHz, tDDSynchronizationMode=tDDSynchronizationMode, encryptionGroup=encryptionGroup, ethernetGroup=ethernetGroup, latitude=latitude, userName=userName, sNTPPollInterval=sNTPPollInterval, regionCodeTrap=regionCodeTrap, hTTPSPortNumber=hTTPSPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, telecomsLineCode=telecomsLineCode, subnetMask=subnetMask)
