...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", snmpControlGroup=snmpControlGroup, incompatibleRegionCodes=incompatibleRegionCodes, eIRP=eIRP, vLANPriorityQueueMapping=vLANPriorityQueueMapping, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, systemClock=systemClock, ptmp=ptmp, linkName=linkName, phyControl=phyControl, productVariant=productVariant, dataPortStatus=dataPortStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNTPServerPortNumber=sNTPServerPortNumber, telnetAccessEnabled=telnetAccessEnabled, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, channelBandwidth=channelBandwidth, installStatus=installStatus, sNMPTrapTable=sNMPTrapTable, constantPowerSpectralDensity=constantPowerSpectralDensity, ptp=ptp, alarmsGroup=alarmsGroup, maximumTransmitPower=maximumTransmitPower, smtp=smtp, tDDControlGroup=tDDControlGroup, syslogStateTrap=syslogStateTrap, transmitPower=transmitPower, versionsGroup=versionsGroup, telecom=telecom, vLANManagementVID=vLANManagementVID, timeZone=timeZone, dataPortAutoNegotiation=dataPortAutoNegotiation, telecomsLoopbackTrap=telecomsLoopbackTrap, capacityLicenseMismatch=capacityLicenseMismatch, tDDSynchronizationMode=tDDSynchronizationMode, userEnabled=userEnabled, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsMeans=dfsMeans, userPassword=userPassword, smtpGroup=smtpGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, vLANPriorityTableIndex=vLANPriorityTableIndex, configuration=configuration, transmitFreqMHz=transmitFreqMHz, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, syslogControlGroup=syslogControlGroup, sMTPEmailAlert=sMTPEmailAlert, sNTPPollInterval=sNTPPollInterval, ptp500=ptp500, dfsTable=dfsTable, regionCode=regionCode, sNMPTrapTableIndex=sNMPTrapTableIndex, wirelessLinkAvailability=wirelessLinkAvailability, tDDControl=tDDControl, bootVersion=bootVersion, alarms=alarms, syslogControl=syslogControl, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, hTTPSPortNumber=hTTPSPortNumber, range=range, licenceGroup=licenceGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, syslogClientTrap=syslogClientTrap, sNMPPortNumber=sNMPPortNumber, hTTPAccessEnabled=hTTPAccessEnabled, tFTPServerIPAddress=tFTPServerIPAddress, transmitChannel=transmitChannel, ptpCompliance=ptpCompliance, receiveDataRate=receiveDataRate, receiveChannel=receiveChannel, PYSNMP_MODULE_ID=cambium, incompatibleMasterAndSlave=incompatibleMasterAndSlave, encryptionGroup=encryptionGroup, supplementary=supplementary, frequencyVariant=frequencyVariant, ethernet=ethernet, licence=licence, sNMPTrapPortNumber=sNMPTrapPortNumber, phyStatus=phyStatus, dfsTableEntry=dfsTableEntry, installArmState=installArmState, tDDSynchronizationStatus=tDDSynchronizationStatus, vLANPriorityTableEntry=vLANPriorityTableEntry, ptpGroups=ptpGroups, ethernetGroup=ethernetGroup, dfsTableNumber=dfsTableNumber, linkModeOptimisation=linkModeOptimisation, vLANPriorityTableNumber=vLANPriorityTableNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, longitude=longitude, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, userTableNumber=userTableNumber, userTableIndex=userTableIndex, dfsTableIndex=dfsTableIndex, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, versions=versions, searchState=searchState, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, gatewayIPAddress=gatewayIPAddress, receiveModulationModeDetail=receiveModulationModeDetail, siteName=siteName, aggregateDataRate=aggregateDataRate, telecomsChannelStatus=telecomsChannelStatus, userTable=userTable, masterSlaveMode=masterSlaveMode, cableLoss=cableLoss, dfs=dfs, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortStatusTrap=dataPortStatusTrap, transmitDataRate=transmitDataRate, encryptionAlgorithm=encryptionAlgorithm, remoteMaximumTransmitPower=remoteMaximumTransmitPower, userRole=userRole, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, receiveModulationMode=receiveModulationMode, aAAControl=aAAControl, syslogClient=syslogClient, unitOutOfCalibration=unitOutOfCalibration, altitude=altitude, subnetMask=subnetMask, dataPortDisabledWarning=dataPortDisabledWarning, installArmStateTrap=installArmStateTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, telecomsLineCode=telecomsLineCode, daylightSaving=daylightSaving, hardwareVersion=hardwareVersion, receivePower=receivePower, configurationGroup=configurationGroup, accessMethod=accessMethod, channelChangeTrap=channelChangeTrap, managementGroup=managementGroup, receiveFreqMHz=receiveFreqMHz, hTTPSAccessEnabled=hTTPSAccessEnabled, systemReset=systemReset, sNMPTrapVersion=sNMPTrapVersion, phyStatusGroup=phyStatusGroup, sNTPSyncTrap=sNTPSyncTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, encryption=encryption, phyControlGroup=phyControlGroup, wirelessLinkStatus=wirelessLinkStatus, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNTPSync=sNTPSync, signalStrengthRatio=signalStrengthRatio, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, management=management, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, licensedCapacity=licensedCapacity, sNTPLastSync=sNTPLastSync, dataPortWirelessDownAlert=dataPortWirelessDownAlert, resetGroup=resetGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, hTTPPortNumber=hTTPPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, vectorError=vectorError, telecomsCableLength=telecomsCableLength, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ethernetFiberSupport=ethernetFiberSupport, pubStatsGroup=pubStatsGroup, reset=reset, cambium=cambium, snmpControl=snmpControl, linkSymmetry=linkSymmetry, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortAutoMdix=dataPortAutoMdix, antennaGain=antennaGain, productName=productName, sNTPState=sNTPState, latitude=latitude, regionCodeTrap=regionCodeTrap, targetMACAddress=targetMACAddress, pubStats=pubStats, ptpTraps=ptpTraps, sNMPv3Enable=sNMPv3Enable, sntp=sntp, supplementaryGroup=supplementaryGroup, iPAddress=iPAddress, installStatusTrap=installStatusTrap, transmitModulationMode=transmitModulationMode, syslogState=syslogState, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, bandwidthVariant=bandwidthVariant, telecomsLoopback=telecomsLoopback, sMTPServerPortNumber=sMTPServerPortNumber, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sntpGroup=sntpGroup, telnetPortNumber=telnetPortNumber, groupID=groupID, sNMPEnabledTraps=sNMPEnabledTraps, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, vLANPriorityTable=vLANPriorityTable, sNTPServerIPAddress=sNTPServerIPAddress, linkLoss=linkLoss, aAAControlGroup=aAAControlGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sMTPServerIPAddress=sMTPServerIPAddress, softwareVersion=softwareVersion, vLANManagementPriority=vLANManagementPriority, notificationsGroup=notificationsGroup, remoteIPAddress=remoteIPAddress, receiveFreqKHz=receiveFreqKHz, telecomGroup=telecomGroup, telecomsInterface=telecomsInterface, userTableEntry=userTableEntry, dfsGroup=dfsGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, userName=userName, ptpTrapPrefix=ptpTrapPrefix, noWirelessChannelAvailable=noWirelessChannelAvailable, secondarySoftwareVersion=secondarySoftwareVersion, sNMPTrapIPAddress=sNMPTrapIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dfsPeaks=dfsPeaks, byteErrorRatio=byteErrorRatio, transmitFreqKHz=transmitFreqKHz, sNMPCommunityString=sNMPCommunityString)
