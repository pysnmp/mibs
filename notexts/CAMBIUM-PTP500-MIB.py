...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", hTTPAccessEnabled=hTTPAccessEnabled, sNTPSyncTrap=sNTPSyncTrap, tDDSynchronizationMode=tDDSynchronizationMode, ptp=ptp, snmpControl=snmpControl, systemClock=systemClock, dfsTableNumber=dfsTableNumber, tFTPServerIPAddress=tFTPServerIPAddress, vLANPriorityTable=vLANPriorityTable, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPTrapPortNumber=sNMPTrapPortNumber, dfsTableIndex=dfsTableIndex, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tDDSynchronizationStatus=tDDSynchronizationStatus, systemReset=systemReset, installArmState=installArmState, ethernetFiberSupport=ethernetFiberSupport, wirelessLinkAvailability=wirelessLinkAvailability, versionsGroup=versionsGroup, ptpGroups=ptpGroups, cableLoss=cableLoss, transmitDataRate=transmitDataRate, userTableIndex=userTableIndex, sNMPTrapTableIndex=sNMPTrapTableIndex, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, hTTPSPortNumber=hTTPSPortNumber, notificationsGroup=notificationsGroup, installArmStateTrap=installArmStateTrap, receiveFreqKHz=receiveFreqKHz, resetGroup=resetGroup, iPAddress=iPAddress, sNTPServerIPAddress=sNTPServerIPAddress, telecomsLoopbackTrap=telecomsLoopbackTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, noWirelessChannelAvailable=noWirelessChannelAvailable, transmitChannel=transmitChannel, encryption=encryption, dataPortWirelessDownAlert=dataPortWirelessDownAlert, alarms=alarms, dataPortAutoNegotiation=dataPortAutoNegotiation, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, versions=versions, searchState=searchState, linkSymmetry=linkSymmetry, sNTPServerPortNumber=sNTPServerPortNumber, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, snmpControlGroup=snmpControlGroup, gatewayIPAddress=gatewayIPAddress, ptpTrapPrefix=ptpTrapPrefix, masterSlaveMode=masterSlaveMode, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPEnabledTraps=sNMPEnabledTraps, dfsMeans=dfsMeans, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, cambium=cambium, transmitPower=transmitPower, syslogStateTrap=syslogStateTrap, syslogControl=syslogControl, managementGroup=managementGroup, sNTPState=sNTPState, vLANPriorityTableEntry=vLANPriorityTableEntry, licence=licence, sMTPEnabledMessages=sMTPEnabledMessages, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, vectorError=vectorError, sMTPServerPortNumber=sMTPServerPortNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, reset=reset, smtp=smtp, tFTPServerPortNumber=tFTPServerPortNumber, telnetAccessEnabled=telnetAccessEnabled, siteName=siteName, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, frequencyVariant=frequencyVariant, supplementaryGroup=supplementaryGroup, dfsTable=dfsTable, remoteMaximumTransmitPower=remoteMaximumTransmitPower, encryptionAlgorithm=encryptionAlgorithm, regionCode=regionCode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dfsPeaks=dfsPeaks, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, phyStatusGroup=phyStatusGroup, sNTPPollInterval=sNTPPollInterval, transmitFreqKHz=transmitFreqKHz, sNMPTrapTableNumber=sNMPTrapTableNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ptpCompliance=ptpCompliance, licenceGroup=licenceGroup, installStatus=installStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, vLANManagementPriority=vLANManagementPriority, vLANPriorityTableNumber=vLANPriorityTableNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, timeZone=timeZone, syslogClientTrap=syslogClientTrap, ptp500=ptp500, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPLastSync=sNTPLastSync, sNMPTrapTable=sNMPTrapTable, range=range, sntpGroup=sntpGroup, sNMPv3Enable=sNMPv3Enable, latitude=latitude, linkModeOptimisation=linkModeOptimisation, accessMethod=accessMethod, dataPortAutoMdix=dataPortAutoMdix, signalStrengthRatio=signalStrengthRatio, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortStatusTrap=dataPortStatusTrap, sMTPEmailAlert=sMTPEmailAlert, aAAControlGroup=aAAControlGroup, antennaGain=antennaGain, sNMPTrapIPAddress=sNMPTrapIPAddress, vLANPriorityQueueMapping=vLANPriorityQueueMapping, hardwareVersion=hardwareVersion, bandwidthVariant=bandwidthVariant, telecom=telecom, linkLoss=linkLoss, encryptionGroup=encryptionGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, longitude=longitude, unitOutOfCalibration=unitOutOfCalibration, bootVersion=bootVersion, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, aggregateDataRate=aggregateDataRate, syslogControlGroup=syslogControlGroup, syslogClient=syslogClient, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPSync=sNTPSync, channelChangeTrap=channelChangeTrap, remoteIPAddress=remoteIPAddress, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, pubStatsGroup=pubStatsGroup, receivePower=receivePower, telecomsInterface=telecomsInterface, telnetPortNumber=telnetPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPCommunityString=sNMPCommunityString, PYSNMP_MODULE_ID=cambium, ethernet=ethernet, userTableNumber=userTableNumber, telecomsLineCode=telecomsLineCode, transmitModulationMode=transmitModulationMode, dfsTableEntry=dfsTableEntry, softwareVersion=softwareVersion, receiveModulationModeDetail=receiveModulationModeDetail, userName=userName, regionCodeTrap=regionCodeTrap, userTable=userTable, ptmp=ptmp, alarmsGroup=alarmsGroup, telecomsCableLength=telecomsCableLength, sNMPPortNumber=sNMPPortNumber, linkName=linkName, phyControl=phyControl, eIRP=eIRP, telecomsLoopback=telecomsLoopback, receiveModulationMode=receiveModulationMode, telecomGroup=telecomGroup, byteErrorRatio=byteErrorRatio, userTableEntry=userTableEntry, incompatibleRegionCodes=incompatibleRegionCodes, secondarySoftwareVersion=secondarySoftwareVersion, productName=productName, sNMPTrapVersion=sNMPTrapVersion, receiveDataRate=receiveDataRate, subnetMask=subnetMask, telecomsChannelStatus=telecomsChannelStatus, targetMACAddress=targetMACAddress, altitude=altitude, management=management, dfs=dfs, dfsGroup=dfsGroup, maximumTransmitPower=maximumTransmitPower, telecomsChannelStatusTrap=telecomsChannelStatusTrap, syslogState=syslogState, ethernetGroup=ethernetGroup, smtpGroup=smtpGroup, hTTPPortNumber=hTTPPortNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, receiveFreqMHz=receiveFreqMHz, tDDControl=tDDControl, userEnabled=userEnabled, supplementary=supplementary, pubStats=pubStats, phyControlGroup=phyControlGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, wirelessLinkStatus=wirelessLinkStatus, sMTPServerIPAddress=sMTPServerIPAddress, productVariant=productVariant, linkModeOptimizationMismatch=linkModeOptimizationMismatch, transmitFreqMHz=transmitFreqMHz, installStatusTrap=installStatusTrap, groupID=groupID, capacityLicenseMismatch=capacityLicenseMismatch, phyStatus=phyStatus, userPassword=userPassword, hTTPSAccessEnabled=hTTPSAccessEnabled, daylightSaving=daylightSaving, licensedCapacity=licensedCapacity, receiveChannel=receiveChannel, ptpTraps=ptpTraps, configurationGroup=configurationGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortStatus=dataPortStatus, configuration=configuration, vLANManagementVID=vLANManagementVID, channelBandwidth=channelBandwidth, incompatibleMasterAndSlave=incompatibleMasterAndSlave, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sntp=sntp, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tDDControlGroup=tDDControlGroup, aAAControl=aAAControl, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortDisabledWarning=dataPortDisabledWarning, userRole=userRole, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex)
