...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", licensedCapacity=licensedCapacity, snmpControlGroup=snmpControlGroup, encryption=encryption, receiveFreqKHz=receiveFreqKHz, incompatibleMasterAndSlave=incompatibleMasterAndSlave, transmitFreqKHz=transmitFreqKHz, tFTPServerPortNumber=tFTPServerPortNumber, accessMethod=accessMethod, phyStatus=phyStatus, receiveModulationMode=receiveModulationMode, installStatus=installStatus, installStatusTrap=installStatusTrap, ethernet=ethernet, tDDSynchronizationStatus=tDDSynchronizationStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapTable=sNMPTrapTable, syslogClientTrap=syslogClientTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPSync=sNTPSync, vLANManagementVID=vLANManagementVID, pubStats=pubStats, sMTPEmailAlert=sMTPEmailAlert, ptpTrapPrefix=ptpTrapPrefix, sNTPPollInterval=sNTPPollInterval, wirelessLinkAvailability=wirelessLinkAvailability, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, regionCode=regionCode, eIRP=eIRP, linkName=linkName, sNMPTrapTableEntry=sNMPTrapTableEntry, linkModeOptimisation=linkModeOptimisation, sNTPSyncTrap=sNTPSyncTrap, antennaGain=antennaGain, syslogLocalWrappedTrap=syslogLocalWrappedTrap, smtpGroup=smtpGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, linkLoss=linkLoss, sntp=sntp, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPEnabledTraps=sNMPEnabledTraps, dfs=dfs, sNMPTrapTableNumber=sNMPTrapTableNumber, wirelessLinkStatus=wirelessLinkStatus, installArmState=installArmState, gatewayIPAddress=gatewayIPAddress, syslogClient=syslogClient, range=range, targetMACAddress=targetMACAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, notificationsGroup=notificationsGroup, userRole=userRole, telecomsChannelStatus=telecomsChannelStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, telecomsLoopbackTrap=telecomsLoopbackTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, productName=productName, installArmStateTrap=installArmStateTrap, groupID=groupID, telecomsCableLength=telecomsCableLength, sNTPServerIPAddress=sNTPServerIPAddress, versions=versions, dfsGroup=dfsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, vLANPriorityQueueMapping=vLANPriorityQueueMapping, hardwareVersion=hardwareVersion, sMTPServerIPAddress=sMTPServerIPAddress, aggregateDataRate=aggregateDataRate, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, telnetAccessEnabled=telnetAccessEnabled, ptpTraps=ptpTraps, latitude=latitude, dataPortConfigurationMismatch=dataPortConfigurationMismatch, syslogControlGroup=syslogControlGroup, frequencyVariant=frequencyVariant, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, phyStatusGroup=phyStatusGroup, ptpCompliance=ptpCompliance, sNMPPortNumber=sNMPPortNumber, dataPortAutoMdix=dataPortAutoMdix, telecomsLineCode=telecomsLineCode, sNMPCommunityString=sNMPCommunityString, sNMPTrapPortNumber=sNMPTrapPortNumber, snmpControl=snmpControl, sNTPServerPortNumber=sNTPServerPortNumber, telecomsInterface=telecomsInterface, transmitModulationMode=transmitModulationMode, ptp500=ptp500, tFTPServerIPAddress=tFTPServerIPAddress, syslogControl=syslogControl, timeZone=timeZone, userTableEntry=userTableEntry, sMTPServerPortNumber=sMTPServerPortNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tDDControlGroup=tDDControlGroup, transmitFreqMHz=transmitFreqMHz, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, hTTPSPortNumber=hTTPSPortNumber, userPassword=userPassword, telecomGroup=telecomGroup, encryptionGroup=encryptionGroup, sMTPEnabledMessages=sMTPEnabledMessages, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dfsTableEntry=dfsTableEntry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, pubStatsGroup=pubStatsGroup, vectorError=vectorError, syslogStateTrap=syslogStateTrap, bandwidthVariant=bandwidthVariant, iPAddress=iPAddress, configuration=configuration, channelBandwidth=channelBandwidth, alarms=alarms, transmitDataRate=transmitDataRate, systemReset=systemReset, dfsPeaks=dfsPeaks, regionCodeTrap=regionCodeTrap, dfsTableNumber=dfsTableNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sntpGroup=sntpGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tDDSynchronizationMode=tDDSynchronizationMode, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, vLANManagementPriority=vLANManagementPriority, configurationGroup=configurationGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, cableLoss=cableLoss, softwareVersion=softwareVersion, noWirelessChannelAvailable=noWirelessChannelAvailable, searchState=searchState, smtp=smtp, vLANPriorityTable=vLANPriorityTable, sNMPv3Enable=sNMPv3Enable, ptpGroups=ptpGroups, dfsTable=dfsTable, supplementary=supplementary, linkSymmetry=linkSymmetry, dfsTableIndex=dfsTableIndex, hTTPAccessEnabled=hTTPAccessEnabled, ptp=ptp, licence=licence, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, resetGroup=resetGroup, receiveFreqMHz=receiveFreqMHz, systemClock=systemClock, tDDControl=tDDControl, receiveModulationModeDetail=receiveModulationModeDetail, daylightSaving=daylightSaving, reset=reset, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, management=management, subnetMask=subnetMask, telecomsLoopback=telecomsLoopback, PYSNMP_MODULE_ID=cambium, cambium=cambium, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, userEnabled=userEnabled, receivePower=receivePower, managementGroup=managementGroup, bootVersion=bootVersion, signalStrengthRatio=signalStrengthRatio, linkModeOptimizationMismatch=linkModeOptimizationMismatch, phyControl=phyControl, vLANPriorityTableIndex=vLANPriorityTableIndex, aAAControl=aAAControl, ethernetFiberSupport=ethernetFiberSupport, remoteMaximumTransmitPower=remoteMaximumTransmitPower, userTableNumber=userTableNumber, receiveChannel=receiveChannel, hTTPPortNumber=hTTPPortNumber, transmitPower=transmitPower, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPLastSync=sNTPLastSync, constantPowerSpectralDensity=constantPowerSpectralDensity, encryptionAlgorithm=encryptionAlgorithm, incompatibleRegionCodes=incompatibleRegionCodes, versionsGroup=versionsGroup, transmitChannel=transmitChannel, longitude=longitude, licenceGroup=licenceGroup, siteName=siteName, byteErrorRatio=byteErrorRatio, telecom=telecom, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, userName=userName, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, userTableIndex=userTableIndex, remoteIPAddress=remoteIPAddress, maximumTransmitPower=maximumTransmitPower, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapVersion=sNMPTrapVersion, receiveDataRate=receiveDataRate, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ptmp=ptmp, secondarySoftwareVersion=secondarySoftwareVersion, channelChangeTrap=channelChangeTrap, dfsMeans=dfsMeans, dataPortDisabledWarning=dataPortDisabledWarning, unitOutOfCalibration=unitOutOfCalibration, dataPortStatusTrap=dataPortStatusTrap, sNTPState=sNTPState, alarmsGroup=alarmsGroup, productVariant=productVariant, capacityLicenseMismatch=capacityLicenseMismatch, telnetPortNumber=telnetPortNumber, syslogState=syslogState, ethernetGroup=ethernetGroup, phyControlGroup=phyControlGroup, supplementaryGroup=supplementaryGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, aAAControlGroup=aAAControlGroup, masterSlaveMode=masterSlaveMode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortStatus=dataPortStatus, userTable=userTable, altitude=altitude, telecomsChannelStatusTrap=telecomsChannelStatusTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap)
