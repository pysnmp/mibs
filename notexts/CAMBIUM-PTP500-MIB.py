...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", userRole=userRole, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, vLANPriorityQueueMapping=vLANPriorityQueueMapping, alarmsGroup=alarmsGroup, channelBandwidth=channelBandwidth, vectorError=vectorError, sMTPEmailAlert=sMTPEmailAlert, sNTPState=sNTPState, snmpControlGroup=snmpControlGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortConfigurationMismatch=dataPortConfigurationMismatch, regionCodeTrap=regionCodeTrap, wirelessLinkAvailability=wirelessLinkAvailability, systemReset=systemReset, configurationGroup=configurationGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, userTableNumber=userTableNumber, productVariant=productVariant, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dfsMeans=dfsMeans, receivePower=receivePower, ptp=ptp, tFTPServerPortNumber=tFTPServerPortNumber, userTableIndex=userTableIndex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptmp=ptmp, sNTPServerIPAddress=sNTPServerIPAddress, linkModeOptimisation=linkModeOptimisation, linkName=linkName, userName=userName, installStatusTrap=installStatusTrap, sntp=sntp, installArmState=installArmState, ethernet=ethernet, transmitFreqKHz=transmitFreqKHz, notificationsGroup=notificationsGroup, sNTPSync=sNTPSync, vLANManagementPriority=vLANManagementPriority, sNTPSyncTrap=sNTPSyncTrap, bandwidthVariant=bandwidthVariant, versionsGroup=versionsGroup, userEnabled=userEnabled, syslogClient=syslogClient, hTTPSPortNumber=hTTPSPortNumber, sNTPPollInterval=sNTPPollInterval, supplementaryGroup=supplementaryGroup, transmitPower=transmitPower, signalStrengthRatio=signalStrengthRatio, aAAControl=aAAControl, telecom=telecom, dfsGroup=dfsGroup, masterSlaveMode=masterSlaveMode, snmpControl=snmpControl, dfsTableIndex=dfsTableIndex, eIRP=eIRP, encryptionAlgorithm=encryptionAlgorithm, syslogLocalWrappedTrap=syslogLocalWrappedTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, unitOutOfCalibration=unitOutOfCalibration, dataPortStatus=dataPortStatus, receiveFreqMHz=receiveFreqMHz, sntpGroup=sntpGroup, syslogClientTrap=syslogClientTrap, encryption=encryption, vLANManagementVID=vLANManagementVID, sNMPv3Enable=sNMPv3Enable, hardwareVersion=hardwareVersion, transmitDataRate=transmitDataRate, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, pubStats=pubStats, aAAControlGroup=aAAControlGroup, secondarySoftwareVersion=secondarySoftwareVersion, antennaGain=antennaGain, targetMACAddress=targetMACAddress, syslogControlGroup=syslogControlGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPCommunityString=sNMPCommunityString, linkModeOptimizationMismatch=linkModeOptimizationMismatch, remoteIPAddress=remoteIPAddress, daylightSaving=daylightSaving, telecomsChannelStatusTrap=telecomsChannelStatusTrap, groupID=groupID, licence=licence, ptpGroups=ptpGroups, licenceGroup=licenceGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, configuration=configuration, noWirelessChannelAvailable=noWirelessChannelAvailable, transmitModulationMode=transmitModulationMode, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, capacityLicenseMismatch=capacityLicenseMismatch, dfsTableNumber=dfsTableNumber, vLANPriorityTableIndex=vLANPriorityTableIndex, latitude=latitude, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, gatewayIPAddress=gatewayIPAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, sMTPSourceEmailAddress=sMTPSourceEmailAddress, accessMethod=accessMethod, telecomsLineCode=telecomsLineCode, ethernetFiberSupport=ethernetFiberSupport, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, linkLoss=linkLoss, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, iPAddress=iPAddress, cambium=cambium, regionCode=regionCode, userTable=userTable, wirelessLinkStatus=wirelessLinkStatus, sMTPEnabledMessages=sMTPEnabledMessages, linkSymmetry=linkSymmetry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, receiveFreqKHz=receiveFreqKHz, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sMTPServerPortNumber=sMTPServerPortNumber, tFTPServerIPAddress=tFTPServerIPAddress, siteName=siteName, constantPowerSpectralDensity=constantPowerSpectralDensity, dataPortAutoMdix=dataPortAutoMdix, phyControl=phyControl, receiveDataRate=receiveDataRate, licensedCapacity=licensedCapacity, useVLANForManagementInterfaces=useVLANForManagementInterfaces, frequencyVariant=frequencyVariant, cableLoss=cableLoss, ptpCompliance=ptpCompliance, dfsTableEntry=dfsTableEntry, telecomsLoopbackTrap=telecomsLoopbackTrap, telecomGroup=telecomGroup, pubStatsGroup=pubStatsGroup, sNMPTrapTable=sNMPTrapTable, syslogState=syslogState, ptpTrapPrefix=ptpTrapPrefix, longitude=longitude, smtp=smtp, ethernetGroup=ethernetGroup, sNTPLastSync=sNTPLastSync, supplementary=supplementary, userPassword=userPassword, dataPortStatusTrap=dataPortStatusTrap, hTTPPortNumber=hTTPPortNumber, installStatus=installStatus, telecomsCableLength=telecomsCableLength, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, alarms=alarms, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, installArmStateTrap=installArmStateTrap, versions=versions, PYSNMP_MODULE_ID=cambium, sNMPTrapVersion=sNMPTrapVersion, tDDControlGroup=tDDControlGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, ptp500=ptp500, receiveModulationModeDetail=receiveModulationModeDetail, management=management, managementGroup=managementGroup, byteErrorRatio=byteErrorRatio, dfs=dfs, transmitChannel=transmitChannel, encryptionGroup=encryptionGroup, timeZone=timeZone, incompatibleRegionCodes=incompatibleRegionCodes, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dataPortDisabledWarning=dataPortDisabledWarning, dfsTable=dfsTable, enabledDiagnosticAlarms=enabledDiagnosticAlarms, phyStatus=phyStatus, sNMPEnabledTraps=sNMPEnabledTraps, telnetPortNumber=telnetPortNumber, ptpTraps=ptpTraps, telecomsLoopback=telecomsLoopback, phyStatusGroup=phyStatusGroup, syslogControl=syslogControl, tDDSynchronizationMode=tDDSynchronizationMode, altitude=altitude, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, hTTPAccessEnabled=hTTPAccessEnabled, maximumTransmitPower=maximumTransmitPower, sNMPTrapIPAddress=sNMPTrapIPAddress, softwareVersion=softwareVersion, dataPortWirelessDownAlert=dataPortWirelessDownAlert, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, bootVersion=bootVersion, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userTableEntry=userTableEntry, resetGroup=resetGroup, sNTPServerPortNumber=sNTPServerPortNumber, subnetMask=subnetMask, telnetAccessEnabled=telnetAccessEnabled, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, vLANPriorityTable=vLANPriorityTable, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, systemClock=systemClock, dfsPeaks=dfsPeaks, range=range, syslogStateTrap=syslogStateTrap, smtpGroup=smtpGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, transmitFreqMHz=transmitFreqMHz, receiveModulationMode=receiveModulationMode, channelChangeTrap=channelChangeTrap, productName=productName, sNMPTrapTableIndex=sNMPTrapTableIndex, tDDControl=tDDControl, phyControlGroup=phyControlGroup, telecomsInterface=telecomsInterface, telecomsChannelStatus=telecomsChannelStatus, searchState=searchState, aggregateDataRate=aggregateDataRate, sMTPServerIPAddress=sMTPServerIPAddress, reset=reset, sNMPPortNumber=sNMPPortNumber, vLANPriorityTableEntry=vLANPriorityTableEntry, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, receiveChannel=receiveChannel)
