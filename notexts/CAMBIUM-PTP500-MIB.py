...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", telnetAccessEnabled=telnetAccessEnabled, vLANPriorityTableEntry=vLANPriorityTableEntry, sMTPServerIPAddress=sMTPServerIPAddress, ethernetGroup=ethernetGroup, dfsTable=dfsTable, capacityLicenseMismatch=capacityLicenseMismatch, systemClock=systemClock, altitude=altitude, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ptpCompliance=ptpCompliance, versionsGroup=versionsGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, userTable=userTable, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, userRole=userRole, targetMACAddress=targetMACAddress, userEnabled=userEnabled, phyStatusGroup=phyStatusGroup, syslogStateTrap=syslogStateTrap, phyControlGroup=phyControlGroup, receiveChannel=receiveChannel, receiveModulationMode=receiveModulationMode, sNTPPollInterval=sNTPPollInterval, ethernet=ethernet, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfs=dfs, sMTPEnabledMessages=sMTPEnabledMessages, enabledDiagnosticAlarms=enabledDiagnosticAlarms, searchState=searchState, daylightSaving=daylightSaving, antennaGain=antennaGain, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, syslogLocalWrappedTrap=syslogLocalWrappedTrap, wirelessLinkStatus=wirelessLinkStatus, cableLoss=cableLoss, hTTPAccessEnabled=hTTPAccessEnabled, telecomsLineCode=telecomsLineCode, accessMethod=accessMethod, telecomsCableLength=telecomsCableLength, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, userPassword=userPassword, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapPortNumber=sNMPTrapPortNumber, range=range, dfsPeaks=dfsPeaks, eIRP=eIRP, dataPortAutoNegotiation=dataPortAutoNegotiation, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, linkSymmetry=linkSymmetry, receiveFreqMHz=receiveFreqMHz, sNTPState=sNTPState, userTableNumber=userTableNumber, vLANPriorityTableIndex=vLANPriorityTableIndex, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, receiveDataRate=receiveDataRate, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, transmitPower=transmitPower, tDDSynchronizationMode=tDDSynchronizationMode, hTTPPortNumber=hTTPPortNumber, alarms=alarms, supplementaryGroup=supplementaryGroup, bootVersion=bootVersion, dfsTableIndex=dfsTableIndex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, productVariant=productVariant, receivePower=receivePower, sNTPSyncTrap=sNTPSyncTrap, configurationGroup=configurationGroup, vLANManagementPriority=vLANManagementPriority, sNMPTrapIPAddress=sNMPTrapIPAddress, linkName=linkName, installStatus=installStatus, licenceGroup=licenceGroup, incompatibleRegionCodes=incompatibleRegionCodes, telecomsChannelStatusTrap=telecomsChannelStatusTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tFTPServerPortNumber=tFTPServerPortNumber, vLANPriorityTable=vLANPriorityTable, dataPortStatus=dataPortStatus, dataPortDisabledWarning=dataPortDisabledWarning, dfsTableEntry=dfsTableEntry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, channelChangeTrap=channelChangeTrap, telecomGroup=telecomGroup, cambium=cambium, sNMPv3Enable=sNMPv3Enable, userTableEntry=userTableEntry, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, secondarySoftwareVersion=secondarySoftwareVersion, installStatusTrap=installStatusTrap, bandwidthVariant=bandwidthVariant, aAAControl=aAAControl, linkLoss=linkLoss, syslogState=syslogState, dfsTableNumber=dfsTableNumber, regionCodeTrap=regionCodeTrap, ptpTrapPrefix=ptpTrapPrefix, telecomsInterface=telecomsInterface, sNMPEnabledTraps=sNMPEnabledTraps, reset=reset, wirelessLinkAvailability=wirelessLinkAvailability, telnetPortNumber=telnetPortNumber, encryptionGroup=encryptionGroup, syslogClient=syslogClient, vectorError=vectorError, ptmp=ptmp, syslogControl=syslogControl, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, receiveFreqKHz=receiveFreqKHz, snmpControl=snmpControl, management=management, telecomsLoopback=telecomsLoopback, installArmStateTrap=installArmStateTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, productName=productName, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, hardwareVersion=hardwareVersion, dataPortAutoMdix=dataPortAutoMdix, transmitModulationMode=transmitModulationMode, latitude=latitude, alarmsGroup=alarmsGroup, configuration=configuration, sNTPLastSync=sNTPLastSync, sNMPTrapTable=sNMPTrapTable, aggregateDataRate=aggregateDataRate, tDDControlGroup=tDDControlGroup, timeZone=timeZone, licence=licence, remoteIPAddress=remoteIPAddress, vLANPriorityQueueMapping=vLANPriorityQueueMapping, ptpGroups=ptpGroups, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, iPAddress=iPAddress, versions=versions, supplementary=supplementary, longitude=longitude, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ethernetFiberSupport=ethernetFiberSupport, pubStats=pubStats, ptp=ptp, userTableIndex=userTableIndex, signalStrengthRatio=signalStrengthRatio, dfsGroup=dfsGroup, transmitFreqMHz=transmitFreqMHz, vLANManagementVID=vLANManagementVID, pubStatsGroup=pubStatsGroup, transmitDataRate=transmitDataRate, phyControl=phyControl, subnetMask=subnetMask, phyStatus=phyStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPSourceEmailAddress=sMTPSourceEmailAddress, smtp=smtp, telecomsChannelStatus=telecomsChannelStatus, licensedCapacity=licensedCapacity, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, userName=userName, aAAControlGroup=aAAControlGroup, installArmState=installArmState, snmpControlGroup=snmpControlGroup, gatewayIPAddress=gatewayIPAddress, notificationsGroup=notificationsGroup, tDDControl=tDDControl, constantPowerSpectralDensity=constantPowerSpectralDensity, systemReset=systemReset, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPServerPortNumber=sNTPServerPortNumber, groupID=groupID, channelBandwidth=channelBandwidth, masterSlaveMode=masterSlaveMode, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPCommunityString=sNMPCommunityString, sntp=sntp, sNMPTrapVersion=sNMPTrapVersion, ptpTraps=ptpTraps, regionCode=regionCode, ptp500=ptp500, maximumTransmitPower=maximumTransmitPower, telecom=telecom, hTTPSPortNumber=hTTPSPortNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortStatusTrap=dataPortStatusTrap, sNTPServerIPAddress=sNTPServerIPAddress, encryption=encryption, managementGroup=managementGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, transmitFreqKHz=transmitFreqKHz, sNTPSync=sNTPSync, siteName=siteName, syslogControlGroup=syslogControlGroup, byteErrorRatio=byteErrorRatio, smtpGroup=smtpGroup, softwareVersion=softwareVersion, tFTPServerIPAddress=tFTPServerIPAddress, unitOutOfCalibration=unitOutOfCalibration, hTTPSAccessEnabled=hTTPSAccessEnabled, encryptionAlgorithm=encryptionAlgorithm, dfsMeans=dfsMeans, sntpGroup=sntpGroup, transmitChannel=transmitChannel, receiveModulationModeDetail=receiveModulationModeDetail, sNMPPortNumber=sNMPPortNumber, telecomsLoopbackTrap=telecomsLoopbackTrap, syslogClientTrap=syslogClientTrap, resetGroup=resetGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, linkModeOptimisation=linkModeOptimisation, frequencyVariant=frequencyVariant, PYSNMP_MODULE_ID=cambium)
