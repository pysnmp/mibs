...
# Produced by pysmi-1.1.3 at Thu Dec  9 14:54:45 2021
...
Gauge32, Integer32, Bits, enterprises, TimeTicks, Counter64, NotificationType, MibIdentifier, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity, Unsigned32, ModuleIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Integer32", "Bits", "enterprises", "TimeTicks", "Counter64", "NotificationType", "MibIdentifier", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "IpAddress")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", notificationsGroup=notificationsGroup, sNMPTrapVersion=sNMPTrapVersion, bandwidthVariant=bandwidthVariant, installStatusTrap=installStatusTrap, hTTPAccessEnabled=hTTPAccessEnabled, sntp=sntp, longitude=longitude, vLANManagementPriority=vLANManagementPriority, installStatus=installStatus, maximumTransmitPower=maximumTransmitPower, userName=userName, aggregateDataRate=aggregateDataRate, dfsTableEntry=dfsTableEntry, installArmState=installArmState, productName=productName, reset=reset, vLANPriorityTable=vLANPriorityTable, linkModeOptimisation=linkModeOptimisation, sNMPCommunityString=sNMPCommunityString, userEnabled=userEnabled, vLANPriorityTableEntry=vLANPriorityTableEntry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, encryption=encryption, regionCode=regionCode, ptpCompliance=ptpCompliance, alarms=alarms, targetMACAddress=targetMACAddress, pubStatsGroup=pubStatsGroup, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, licence=licence, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, telnetAccessEnabled=telnetAccessEnabled, alarmsGroup=alarmsGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, telecomsLineCode=telecomsLineCode, userTableIndex=userTableIndex, hTTPPortNumber=hTTPPortNumber, sNMPPortNumber=sNMPPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitModulationMode=transmitModulationMode, sNMPEnabledTraps=sNMPEnabledTraps, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortWirelessDownAlert=dataPortWirelessDownAlert, channelChangeTrap=channelChangeTrap, receiveModulationModeDetail=receiveModulationModeDetail, receiveModulationMode=receiveModulationMode, gatewayIPAddress=gatewayIPAddress, cableLoss=cableLoss, sNMPTrapPortNumber=sNMPTrapPortNumber, remoteIPAddress=remoteIPAddress, syslogClientTrap=syslogClientTrap, supplementaryGroup=supplementaryGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, syslogState=syslogState, syslogControlGroup=syslogControlGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, receiveFreqMHz=receiveFreqMHz, syslogControl=syslogControl, softwareVersion=softwareVersion, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, transmitFreqKHz=transmitFreqKHz, altitude=altitude, sMTPEmailAlert=sMTPEmailAlert, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, managementGroup=managementGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, dfs=dfs, vectorError=vectorError, tFTPServerIPAddress=tFTPServerIPAddress, encryptionAlgorithm=encryptionAlgorithm, linkLoss=linkLoss, receiveFreqKHz=receiveFreqKHz, dfsPeaks=dfsPeaks, ethernetGroup=ethernetGroup, snmpControlGroup=snmpControlGroup, dfsTable=dfsTable, ethernetFiberSupport=ethernetFiberSupport, dataPortAutoMdix=dataPortAutoMdix, incompatibleRegionCodes=incompatibleRegionCodes, sNTPServerPortNumber=sNTPServerPortNumber, latitude=latitude, pubStats=pubStats, sNMPTrapTableEntry=sNMPTrapTableEntry, linkModeOptimizationMismatch=linkModeOptimizationMismatch, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, range=range, wirelessLinkStatus=wirelessLinkStatus, aAAControl=aAAControl, siteName=siteName, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNTPServerIPAddress=sNTPServerIPAddress, vLANPriorityTableNumber=vLANPriorityTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dfsGroup=dfsGroup, regionCodeTrap=regionCodeTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, phyStatus=phyStatus, timeZone=timeZone, hTTPSPortNumber=hTTPSPortNumber, configuration=configuration, systemClock=systemClock, enabledDiagnosticAlarms=enabledDiagnosticAlarms, useVLANForManagementInterfaces=useVLANForManagementInterfaces, transmitPower=transmitPower, management=management, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, daylightSaving=daylightSaving, tDDControlGroup=tDDControlGroup, licenceGroup=licenceGroup, groupID=groupID, cambium=cambium, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, configurationGroup=configurationGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, userPassword=userPassword, telnetPortNumber=telnetPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, tDDSynchronizationMode=tDDSynchronizationMode, installArmStateTrap=installArmStateTrap, aAAControlGroup=aAAControlGroup, ptpTrapPrefix=ptpTrapPrefix, linkSymmetry=linkSymmetry, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, userTableNumber=userTableNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sMTPEnabledMessages=sMTPEnabledMessages, smtpGroup=smtpGroup, transmitFreqMHz=transmitFreqMHz, sNTPLastSync=sNTPLastSync, telecomsLoopbackTrap=telecomsLoopbackTrap, resetGroup=resetGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, signalStrengthRatio=signalStrengthRatio, incompatibleMasterAndSlave=incompatibleMasterAndSlave, supplementary=supplementary, phyControlGroup=phyControlGroup, smtp=smtp, sNMPTrapTable=sNMPTrapTable, telecomsLoopback=telecomsLoopback, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsTableNumber=dfsTableNumber, bootVersion=bootVersion, antennaGain=antennaGain, ptp=ptp, ptpGroups=ptpGroups, telecom=telecom, versionsGroup=versionsGroup, accessMethod=accessMethod, secondarySoftwareVersion=secondarySoftwareVersion, sNMPv3Enable=sNMPv3Enable, dfsMeans=dfsMeans, tFTPServerPortNumber=tFTPServerPortNumber, sMTPServerPortNumber=sMTPServerPortNumber, sNTPState=sNTPState, telecomsInterface=telecomsInterface, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, searchState=searchState, sNMPTrapIPAddress=sNMPTrapIPAddress, sntpGroup=sntpGroup, channelBandwidth=channelBandwidth, userRole=userRole, phyControl=phyControl, userTableEntry=userTableEntry, PYSNMP_MODULE_ID=cambium, receivePower=receivePower, sNTPSync=sNTPSync, unitOutOfCalibration=unitOutOfCalibration, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dataPortStatus=dataPortStatus, syslogStateTrap=syslogStateTrap, telecomGroup=telecomGroup, transmitDataRate=transmitDataRate, tDDControl=tDDControl, iPAddress=iPAddress, receiveDataRate=receiveDataRate, dataPortStatusTrap=dataPortStatusTrap, masterSlaveMode=masterSlaveMode, sNTPSyncTrap=sNTPSyncTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tDDSynchronizationStatus=tDDSynchronizationStatus, eIRP=eIRP, dataPortDisabledWarning=dataPortDisabledWarning, versions=versions, ptmp=ptmp, productVariant=productVariant, sMTPServerIPAddress=sMTPServerIPAddress, wirelessLinkAvailability=wirelessLinkAvailability, receiveChannel=receiveChannel, snmpControl=snmpControl, vLANManagementVID=vLANManagementVID, userTable=userTable, dfsTableIndex=dfsTableIndex, transmitChannel=transmitChannel, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, systemReset=systemReset, encryptionGroup=encryptionGroup, licensedCapacity=licensedCapacity, sNTPPollInterval=sNTPPollInterval, syslogLocalWrappedTrap=syslogLocalWrappedTrap, subnetMask=subnetMask, ptpTraps=ptpTraps, frequencyVariant=frequencyVariant, phyStatusGroup=phyStatusGroup, telecomsChannelStatus=telecomsChannelStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, ptp500=ptp500, linkName=linkName, syslogClient=syslogClient, ethernet=ethernet, vLANPriorityTableIndex=vLANPriorityTableIndex, telecomsChannelStatusTrap=telecomsChannelStatusTrap, capacityLicenseMismatch=capacityLicenseMismatch, hardwareVersion=hardwareVersion, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, byteErrorRatio=byteErrorRatio, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, telecomsCableLength=telecomsCableLength)
