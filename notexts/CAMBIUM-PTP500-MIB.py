...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", versions=versions, sntp=sntp, masterSlaveMode=masterSlaveMode, sNMPEnabledTraps=sNMPEnabledTraps, syslogState=syslogState, tDDSynchronizationStatus=tDDSynchronizationStatus, syslogClientTrap=syslogClientTrap, telecomGroup=telecomGroup, versionsGroup=versionsGroup, channelChangeTrap=channelChangeTrap, subnetMask=subnetMask, capacityLicenseMismatch=capacityLicenseMismatch, aAAControlGroup=aAAControlGroup, transmitChannel=transmitChannel, transmitPower=transmitPower, maximumTransmitPower=maximumTransmitPower, telecomsCableLength=telecomsCableLength, unitOutOfCalibration=unitOutOfCalibration, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, groupID=groupID, vLANPriorityQueueMapping=vLANPriorityQueueMapping, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dataPortStatus=dataPortStatus, aggregateDataRate=aggregateDataRate, sNTPSyncTrap=sNTPSyncTrap, bootVersion=bootVersion, hTTPSAccessEnabled=hTTPSAccessEnabled, installArmState=installArmState, encryptionGroup=encryptionGroup, licensedCapacity=licensedCapacity, useVLANForManagementInterfaces=useVLANForManagementInterfaces, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, userRole=userRole, userPassword=userPassword, vLANPriorityTableNumber=vLANPriorityTableNumber, tFTPServerIPAddress=tFTPServerIPAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, secondarySoftwareVersion=secondarySoftwareVersion, receiveModulationModeDetail=receiveModulationModeDetail, gatewayIPAddress=gatewayIPAddress, longitude=longitude, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, userName=userName, receiveDataRate=receiveDataRate, managementGroup=managementGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, smtpGroup=smtpGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, receiveFreqMHz=receiveFreqMHz, reset=reset, sMTPServerPortNumber=sMTPServerPortNumber, dfsGroup=dfsGroup, incompatibleRegionCodes=incompatibleRegionCodes, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, accessMethod=accessMethod, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, resetGroup=resetGroup, hTTPAccessEnabled=hTTPAccessEnabled, installStatusTrap=installStatusTrap, sNTPState=sNTPState, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ethernet=ethernet, dfsTableEntry=dfsTableEntry, notificationsGroup=notificationsGroup, userEnabled=userEnabled, dataPortDisabledWarning=dataPortDisabledWarning, PYSNMP_MODULE_ID=cambium, supplementary=supplementary, phyControl=phyControl, linkName=linkName, frequencyVariant=frequencyVariant, softwareVersion=softwareVersion, management=management, ptpCompliance=ptpCompliance, userTableEntry=userTableEntry, systemClock=systemClock, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNTPServerPortNumber=sNTPServerPortNumber, userTableNumber=userTableNumber, transmitFreqKHz=transmitFreqKHz, regionCodeTrap=regionCodeTrap, altitude=altitude, tFTPServerPortNumber=tFTPServerPortNumber, systemReset=systemReset, sMTPSourceEmailAddress=sMTPSourceEmailAddress, telecomsInterface=telecomsInterface, vLANPriorityTable=vLANPriorityTable, productVariant=productVariant, productName=productName, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortConfigurationMismatch=dataPortConfigurationMismatch, syslogStateTrap=syslogStateTrap, cableLoss=cableLoss, regionCode=regionCode, sNMPTrapVersion=sNMPTrapVersion, ptpTrapPrefix=ptpTrapPrefix, vLANManagementVID=vLANManagementVID, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, noWirelessChannelAvailable=noWirelessChannelAvailable, incompatibleMasterAndSlave=incompatibleMasterAndSlave, phyStatusGroup=phyStatusGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dfsPeaks=dfsPeaks, pubStats=pubStats, encryptionAlgorithm=encryptionAlgorithm, alarms=alarms, iPAddress=iPAddress, range=range, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, receiveFreqKHz=receiveFreqKHz, receiveChannel=receiveChannel, searchState=searchState, antennaGain=antennaGain, syslogControl=syslogControl, channelBandwidth=channelBandwidth, dfsTableNumber=dfsTableNumber, bandwidthVariant=bandwidthVariant, transmitModulationMode=transmitModulationMode, alarmsGroup=alarmsGroup, receiveModulationMode=receiveModulationMode, hTTPSPortNumber=hTTPSPortNumber, siteName=siteName, dfsMeans=dfsMeans, sNTPPollInterval=sNTPPollInterval, wirelessLinkStatus=wirelessLinkStatus, remoteIPAddress=remoteIPAddress, sntpGroup=sntpGroup, smtp=smtp, sNMPCommunityString=sNMPCommunityString, sNMPTrapTableNumber=sNMPTrapTableNumber, telecomsLoopbackTrap=telecomsLoopbackTrap, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapPortNumber=sNMPTrapPortNumber, installArmStateTrap=installArmStateTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, installStatus=installStatus, dfsTable=dfsTable, syslogClient=syslogClient, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, linkSymmetry=linkSymmetry, ptpGroups=ptpGroups, ptmp=ptmp, signalStrengthRatio=signalStrengthRatio, hTTPPortNumber=hTTPPortNumber, tDDControl=tDDControl, vectorError=vectorError, sNTPSync=sNTPSync, vLANManagementPriority=vLANManagementPriority, linkModeOptimisation=linkModeOptimisation, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapIPAddress=sNMPTrapIPAddress, transmitDataRate=transmitDataRate, licence=licence, tDDControlGroup=tDDControlGroup, sMTPServerIPAddress=sMTPServerIPAddress, tDDSynchronizationMode=tDDSynchronizationMode, userTableIndex=userTableIndex, tDDSynchronizationAlarm=tDDSynchronizationAlarm, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, sNMPTrapTable=sNMPTrapTable, dfs=dfs, ptp500=ptp500, telnetPortNumber=telnetPortNumber, daylightSaving=daylightSaving, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ethernetGroup=ethernetGroup, sNTPServerIPAddress=sNTPServerIPAddress, receivePower=receivePower, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, transmitFreqMHz=transmitFreqMHz, encryption=encryption, timeZone=timeZone, supplementaryGroup=supplementaryGroup, aAAControl=aAAControl, licenceGroup=licenceGroup, telecom=telecom, telecomsChannelStatus=telecomsChannelStatus, ptpTraps=ptpTraps, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, cambium=cambium, sNMPv3Enable=sNMPv3Enable, sNTPLastSync=sNTPLastSync, linkLoss=linkLoss, targetMACAddress=targetMACAddress, sNMPPortNumber=sNMPPortNumber, phyControlGroup=phyControlGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, syslogControlGroup=syslogControlGroup, ethernetFiberSupport=ethernetFiberSupport, telnetAccessEnabled=telnetAccessEnabled, wirelessLinkAvailability=wirelessLinkAvailability, telecomsChannelStatusTrap=telecomsChannelStatusTrap, byteErrorRatio=byteErrorRatio, dataPortStatusTrap=dataPortStatusTrap, configuration=configuration, dataPortAutoMdix=dataPortAutoMdix, snmpControl=snmpControl, latitude=latitude, userTable=userTable, dfsTableIndex=dfsTableIndex, telecomsLoopback=telecomsLoopback, hardwareVersion=hardwareVersion, snmpControlGroup=snmpControlGroup, configurationGroup=configurationGroup, ptp=ptp, eIRP=eIRP, remoteMaximumTransmitPower=remoteMaximumTransmitPower, pubStatsGroup=pubStatsGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, dataPortAutoNegotiation=dataPortAutoNegotiation, telecomsLineCode=telecomsLineCode, phyStatus=phyStatus)
