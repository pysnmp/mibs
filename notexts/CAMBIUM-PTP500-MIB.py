...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", maximumTransmitPower=maximumTransmitPower, sNTPState=sNTPState, receiveModulationModeDetail=receiveModulationModeDetail, ptpTrapPrefix=ptpTrapPrefix, aggregateDataRate=aggregateDataRate, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, productVariant=productVariant, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, installArmStateTrap=installArmStateTrap, ptpGroups=ptpGroups, vLANPriorityQueueMapping=vLANPriorityQueueMapping, vLANPriorityTableEntry=vLANPriorityTableEntry, hTTPPortNumber=hTTPPortNumber, transmitFreqKHz=transmitFreqKHz, sntp=sntp, sntpGroup=sntpGroup, configuration=configuration, dataPortConfigurationMismatch=dataPortConfigurationMismatch, targetMACAddress=targetMACAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataPortStatusTrap=dataPortStatusTrap, dfsGroup=dfsGroup, groupID=groupID, receiveFreqKHz=receiveFreqKHz, tFTPServerIPAddress=tFTPServerIPAddress, telecomsCableLength=telecomsCableLength, bandwidthVariant=bandwidthVariant, signalStrengthRatio=signalStrengthRatio, transmitDataRate=transmitDataRate, vLANPriorityTable=vLANPriorityTable, masterSlaveMode=masterSlaveMode, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, telnetPortNumber=telnetPortNumber, userTableNumber=userTableNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPLastSync=sNTPLastSync, ethernetFiberSupport=ethernetFiberSupport, cableLoss=cableLoss, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tDDControlGroup=tDDControlGroup, daylightSaving=daylightSaving, managementGroup=managementGroup, hTTPAccessEnabled=hTTPAccessEnabled, sNMPTrapTable=sNMPTrapTable, supplementary=supplementary, timeZone=timeZone, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, installStatus=installStatus, latitude=latitude, siteName=siteName, constantPowerSpectralDensity=constantPowerSpectralDensity, remoteIPAddress=remoteIPAddress, sNMPv3Enable=sNMPv3Enable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ptp=ptp, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, receiveModulationMode=receiveModulationMode, receiveDataRate=receiveDataRate, unitOutOfCalibration=unitOutOfCalibration, range=range, sNMPPortNumber=sNMPPortNumber, telnetAccessEnabled=telnetAccessEnabled, tDDSynchronizationMode=tDDSynchronizationMode, userTableIndex=userTableIndex, encryption=encryption, syslogControlGroup=syslogControlGroup, regionCode=regionCode, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortAutoMdix=dataPortAutoMdix, dfs=dfs, dfsMeans=dfsMeans, wirelessLinkAvailability=wirelessLinkAvailability, telecomsLoopbackTrap=telecomsLoopbackTrap, vectorError=vectorError, systemReset=systemReset, syslogClient=syslogClient, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, phyControl=phyControl, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, licensedCapacity=licensedCapacity, snmpControlGroup=snmpControlGroup, hardwareVersion=hardwareVersion, reset=reset, sNMPTrapTableEntry=sNMPTrapTableEntry, vLANManagementVID=vLANManagementVID, licenceGroup=licenceGroup, longitude=longitude, phyControlGroup=phyControlGroup, aAAControl=aAAControl, iPAddress=iPAddress, receiveChannel=receiveChannel, snmpControl=snmpControl, linkName=linkName, dataPortDisabledWarning=dataPortDisabledWarning, sMTPEnabledMessages=sMTPEnabledMessages, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPEmailAlert=sMTPEmailAlert, telecomsInterface=telecomsInterface, byteErrorRatio=byteErrorRatio, sNMPTrapPortNumber=sNMPTrapPortNumber, syslogState=syslogState, telecomsChannelStatusTrap=telecomsChannelStatusTrap, transmitModulationMode=transmitModulationMode, transmitChannel=transmitChannel, syslogLocalWrappedTrap=syslogLocalWrappedTrap, receiveFreqMHz=receiveFreqMHz, syslogControl=syslogControl, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, telecomsLoopback=telecomsLoopback, receivePower=receivePower, telecomGroup=telecomGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, versions=versions, linkModeOptimisation=linkModeOptimisation, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, antennaGain=antennaGain, vLANManagementPriority=vLANManagementPriority, tDDSynchronizationAlarm=tDDSynchronizationAlarm, encryptionAlgorithm=encryptionAlgorithm, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ethernet=ethernet, sNTPSync=sNTPSync, vLANPriorityTableNumber=vLANPriorityTableNumber, dataPortStatus=dataPortStatus, gatewayIPAddress=gatewayIPAddress, installStatusTrap=installStatusTrap, dfsTableIndex=dfsTableIndex, installArmState=installArmState, productName=productName, sMTPServerIPAddress=sMTPServerIPAddress, dfsPeaks=dfsPeaks, sMTPServerPortNumber=sMTPServerPortNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, transmitFreqMHz=transmitFreqMHz, aAAControlGroup=aAAControlGroup, secondarySoftwareVersion=secondarySoftwareVersion, management=management, frequencyVariant=frequencyVariant, hTTPSPortNumber=hTTPSPortNumber, userName=userName, userTableEntry=userTableEntry, systemClock=systemClock, telecomsChannelStatus=telecomsChannelStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, alarms=alarms, phyStatusGroup=phyStatusGroup, cambium=cambium, dfsTable=dfsTable, smtpGroup=smtpGroup, subnetMask=subnetMask, versionsGroup=versionsGroup, sNTPServerPortNumber=sNTPServerPortNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, notificationsGroup=notificationsGroup, phyStatus=phyStatus, pubStatsGroup=pubStatsGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, smtp=smtp, sNTPServerIPAddress=sNTPServerIPAddress, linkLoss=linkLoss, userEnabled=userEnabled, channelBandwidth=channelBandwidth, configurationGroup=configurationGroup, ptpCompliance=ptpCompliance, eIRP=eIRP, wirelessLinkStatus=wirelessLinkStatus, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, syslogStateTrap=syslogStateTrap, ptpTraps=ptpTraps, ethernetGroup=ethernetGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, encryptionGroup=encryptionGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, ptmp=ptmp, searchState=searchState, tFTPServerPortNumber=tFTPServerPortNumber, sNMPCommunityString=sNMPCommunityString, syslogClientTrap=syslogClientTrap, telecom=telecom, dataPortAutoNegotiation=dataPortAutoNegotiation, PYSNMP_MODULE_ID=cambium, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, capacityLicenseMismatch=capacityLicenseMismatch, userTable=userTable, tDDSynchronizationStatus=tDDSynchronizationStatus, incompatibleRegionCodes=incompatibleRegionCodes, ptp500=ptp500, dfsTableNumber=dfsTableNumber, accessMethod=accessMethod, sNMPEnabledTraps=sNMPEnabledTraps, sNTPPollInterval=sNTPPollInterval, sNTPSyncTrap=sNTPSyncTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, resetGroup=resetGroup, userRole=userRole, softwareVersion=softwareVersion, altitude=altitude, pubStats=pubStats, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tDDControl=tDDControl, regionCodeTrap=regionCodeTrap, sNMPTrapVersion=sNMPTrapVersion, licence=licence, userPassword=userPassword, channelChangeTrap=channelChangeTrap, linkSymmetry=linkSymmetry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfsTableEntry=dfsTableEntry, useVLANForManagementInterfaces=useVLANForManagementInterfaces, bootVersion=bootVersion, telecomsLineCode=telecomsLineCode, supplementaryGroup=supplementaryGroup, transmitPower=transmitPower, alarmsGroup=alarmsGroup)
