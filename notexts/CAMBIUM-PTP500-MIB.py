...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", vLANManagementVID=vLANManagementVID, ptpTraps=ptpTraps, sMTPServerPortNumber=sMTPServerPortNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortAutoNegotiation=dataPortAutoNegotiation, vectorError=vectorError, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, frequencyVariant=frequencyVariant, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, hTTPPortNumber=hTTPPortNumber, telecomsLineCode=telecomsLineCode, dfsTableNumber=dfsTableNumber, vLANPriorityTable=vLANPriorityTable, dataPortAutoMdix=dataPortAutoMdix, daylightSaving=daylightSaving, regionCodeTrap=regionCodeTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, regionCode=regionCode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, aAAControlGroup=aAAControlGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, channelChangeTrap=channelChangeTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, vLANPriorityTableEntry=vLANPriorityTableEntry, signalStrengthRatio=signalStrengthRatio, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, ptpCompliance=ptpCompliance, resetGroup=resetGroup, transmitDataRate=transmitDataRate, userRole=userRole, dataPortStatusTrap=dataPortStatusTrap, dataPortStatus=dataPortStatus, timeZone=timeZone, antennaGain=antennaGain, receiveFreqKHz=receiveFreqKHz, userTableNumber=userTableNumber, ptpTrapPrefix=ptpTrapPrefix, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, configurationGroup=configurationGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dfsTable=dfsTable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, receiveModulationModeDetail=receiveModulationModeDetail, productVariant=productVariant, productName=productName, receiveModulationMode=receiveModulationMode, telecomsLoopbackTrap=telecomsLoopbackTrap, dfs=dfs, receivePower=receivePower, latitude=latitude, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNMPTrapVersion=sNMPTrapVersion, dfsTableIndex=dfsTableIndex, cableLoss=cableLoss, sNMPv3Enable=sNMPv3Enable, tDDControlGroup=tDDControlGroup, aggregateDataRate=aggregateDataRate, userName=userName, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, receiveFreqMHz=receiveFreqMHz, sNTPSyncTrap=sNTPSyncTrap, sntp=sntp, telecomsCableLength=telecomsCableLength, supplementaryGroup=supplementaryGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPSync=sNTPSync, syslogClient=syslogClient, transmitModulationMode=transmitModulationMode, sNTPPollInterval=sNTPPollInterval, encryption=encryption, syslogControlGroup=syslogControlGroup, linkName=linkName, dataPortDisabledWarning=dataPortDisabledWarning, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, smtp=smtp, syslogControl=syslogControl, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, pubStatsGroup=pubStatsGroup, licensedCapacity=licensedCapacity, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tDDControl=tDDControl, receiveChannel=receiveChannel, ethernet=ethernet, channelBandwidth=channelBandwidth, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfsGroup=dfsGroup, longitude=longitude, wirelessLinkStatus=wirelessLinkStatus, unitOutOfCalibration=unitOutOfCalibration, sNTPServerPortNumber=sNTPServerPortNumber, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sMTPEmailAlert=sMTPEmailAlert, installArmState=installArmState, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, searchState=searchState, ptmp=ptmp, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, eIRP=eIRP, transmitFreqKHz=transmitFreqKHz, phyControl=phyControl, userTableEntry=userTableEntry, masterSlaveMode=masterSlaveMode, sNMPTrapTableIndex=sNMPTrapTableIndex, smtpGroup=smtpGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, userTableIndex=userTableIndex, vLANManagementPriority=vLANManagementPriority, sNMPCommunityString=sNMPCommunityString, targetMACAddress=targetMACAddress, userTable=userTable, transmitChannel=transmitChannel, phyStatus=phyStatus, secondarySoftwareVersion=secondarySoftwareVersion, managementGroup=managementGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, installStatus=installStatus, snmpControlGroup=snmpControlGroup, subnetMask=subnetMask, encryptionAlgorithm=encryptionAlgorithm, gatewayIPAddress=gatewayIPAddress, sntpGroup=sntpGroup, remoteIPAddress=remoteIPAddress, groupID=groupID, telecomsLoopback=telecomsLoopback, ethernetFiberSupport=ethernetFiberSupport, installArmStateTrap=installArmStateTrap, ethernetGroup=ethernetGroup, sNMPTrapTable=sNMPTrapTable, telecom=telecom, hTTPSAccessEnabled=hTTPSAccessEnabled, remoteMaximumTransmitPower=remoteMaximumTransmitPower, pubStats=pubStats, capacityLicenseMismatch=capacityLicenseMismatch, PYSNMP_MODULE_ID=cambium, telecomGroup=telecomGroup, versions=versions, transmitPower=transmitPower, phyControlGroup=phyControlGroup, systemReset=systemReset, ptp500=ptp500, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPPortNumber=sNMPPortNumber, sMTPServerIPAddress=sMTPServerIPAddress, telnetAccessEnabled=telnetAccessEnabled, sNMPEnabledTraps=sNMPEnabledTraps, sNTPServerIPAddress=sNTPServerIPAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, syslogState=syslogState, sMTPEnabledMessages=sMTPEnabledMessages, altitude=altitude, syslogClientTrap=syslogClientTrap, installStatusTrap=installStatusTrap, userPassword=userPassword, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsMeans=dfsMeans, hardwareVersion=hardwareVersion, linkSymmetry=linkSymmetry, alarmsGroup=alarmsGroup, encryptionGroup=encryptionGroup, iPAddress=iPAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, hTTPSPortNumber=hTTPSPortNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, supplementary=supplementary, systemClock=systemClock, dfsTableEntry=dfsTableEntry, accessMethod=accessMethod, vLANPriorityQueueMapping=vLANPriorityQueueMapping, maximumTransmitPower=maximumTransmitPower, linkLoss=linkLoss, telecomsInterface=telecomsInterface, incompatibleRegionCodes=incompatibleRegionCodes, bandwidthVariant=bandwidthVariant, phyStatusGroup=phyStatusGroup, receiveDataRate=receiveDataRate, telnetPortNumber=telnetPortNumber, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, siteName=siteName, ptpGroups=ptpGroups, sMTPSourceEmailAddress=sMTPSourceEmailAddress, linkModeOptimisation=linkModeOptimisation, tDDSynchronizationMode=tDDSynchronizationMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, snmpControl=snmpControl, reset=reset, sNTPLastSync=sNTPLastSync, configuration=configuration, tDDSynchronizationAlarm=tDDSynchronizationAlarm, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, hTTPAccessEnabled=hTTPAccessEnabled, management=management, ptp=ptp, tFTPServerIPAddress=tFTPServerIPAddress, range=range, sNTPState=sNTPState, sNMPTrapTableEntry=sNMPTrapTableEntry, userEnabled=userEnabled, licenceGroup=licenceGroup, wirelessLinkAvailability=wirelessLinkAvailability, alarms=alarms, aAAControl=aAAControl, notificationsGroup=notificationsGroup, tFTPServerPortNumber=tFTPServerPortNumber, bootVersion=bootVersion, softwareVersion=softwareVersion, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, transmitFreqMHz=transmitFreqMHz, versionsGroup=versionsGroup, licence=licence, syslogStateTrap=syslogStateTrap, byteErrorRatio=byteErrorRatio, dataPortConfigurationMismatch=dataPortConfigurationMismatch, telecomsChannelStatus=telecomsChannelStatus, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapTableNumber=sNMPTrapTableNumber, dfsPeaks=dfsPeaks, cambium=cambium)
