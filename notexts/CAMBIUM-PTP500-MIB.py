...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", dfs=dfs, remoteMaximumTransmitPower=remoteMaximumTransmitPower, receiveFreqKHz=receiveFreqKHz, dfsPeaks=dfsPeaks, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tDDSynchronizationStatus=tDDSynchronizationStatus, aggregateDataRate=aggregateDataRate, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, hTTPSAccessEnabled=hTTPSAccessEnabled, transmitModulationMode=transmitModulationMode, hardwareVersion=hardwareVersion, ptpCompliance=ptpCompliance, reset=reset, ptpGroups=ptpGroups, dfsMeans=dfsMeans, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, telecomsLineCode=telecomsLineCode, sMTPServerIPAddress=sMTPServerIPAddress, tFTPServerPortNumber=tFTPServerPortNumber, wirelessLinkStatus=wirelessLinkStatus, pubStatsGroup=pubStatsGroup, syslogStateTrap=syslogStateTrap, smtpGroup=smtpGroup, vLANPriorityTable=vLANPriorityTable, telnetAccessEnabled=telnetAccessEnabled, telecom=telecom, sMTPEnabledMessages=sMTPEnabledMessages, longitude=longitude, userTableEntry=userTableEntry, receiveModulationModeDetail=receiveModulationModeDetail, sNTPSyncTrap=sNTPSyncTrap, cableLoss=cableLoss, receiveDataRate=receiveDataRate, tDDSynchronizationAlarm=tDDSynchronizationAlarm, maximumTransmitPower=maximumTransmitPower, sNMPPortNumber=sNMPPortNumber, installArmState=installArmState, receivePower=receivePower, receiveChannel=receiveChannel, wirelessLinkAvailability=wirelessLinkAvailability, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapVersion=sNMPTrapVersion, syslogControl=syslogControl, productVariant=productVariant, frequencyVariant=frequencyVariant, userRole=userRole, sNMPEnabledTraps=sNMPEnabledTraps, userPassword=userPassword, sNTPServerPortNumber=sNTPServerPortNumber, vectorError=vectorError, licence=licence, remoteIPAddress=remoteIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernetFiberSupport=ethernetFiberSupport, siteName=siteName, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, byteErrorRatio=byteErrorRatio, userTableIndex=userTableIndex, vLANPriorityTableIndex=vLANPriorityTableIndex, dfsGroup=dfsGroup, cambium=cambium, dfsTableEntry=dfsTableEntry, telecomsLoopbackTrap=telecomsLoopbackTrap, tFTPServerIPAddress=tFTPServerIPAddress, receiveModulationMode=receiveModulationMode, resetGroup=resetGroup, transmitFreqKHz=transmitFreqKHz, userName=userName, channelChangeTrap=channelChangeTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, licenceGroup=licenceGroup, sNTPState=sNTPState, tDDControlGroup=tDDControlGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, aAAControl=aAAControl, ptp=ptp, alarmsGroup=alarmsGroup, hTTPSPortNumber=hTTPSPortNumber, installStatus=installStatus, configuration=configuration, linkLoss=linkLoss, sNTPServerIPAddress=sNTPServerIPAddress, hTTPPortNumber=hTTPPortNumber, bandwidthVariant=bandwidthVariant, incompatibleMasterAndSlave=incompatibleMasterAndSlave, PYSNMP_MODULE_ID=cambium, ptpTrapPrefix=ptpTrapPrefix, dataPortStatus=dataPortStatus, linkModeOptimizationMismatch=linkModeOptimizationMismatch, groupID=groupID, installArmStateTrap=installArmStateTrap, aAAControlGroup=aAAControlGroup, userTableNumber=userTableNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, phyStatus=phyStatus, capacityLicenseMismatch=capacityLicenseMismatch, regionCodeTrap=regionCodeTrap, accessMethod=accessMethod, phyControlGroup=phyControlGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, phyControl=phyControl, ethernet=ethernet, incompatibleRegionCodes=incompatibleRegionCodes, receiveFreqMHz=receiveFreqMHz, dataPortStatusTrap=dataPortStatusTrap, dfsTableNumber=dfsTableNumber, productName=productName, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, versionsGroup=versionsGroup, userTable=userTable, channelBandwidth=channelBandwidth, ptpTraps=ptpTraps, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, timeZone=timeZone, antennaGain=antennaGain, sntpGroup=sntpGroup, encryptionAlgorithm=encryptionAlgorithm, daylightSaving=daylightSaving, configurationGroup=configurationGroup, telecomsLoopback=telecomsLoopback, sMTPServerPortNumber=sMTPServerPortNumber, masterSlaveMode=masterSlaveMode, range=range, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, supplementaryGroup=supplementaryGroup, sNTPLastSync=sNTPLastSync, telecomsChannelStatus=telecomsChannelStatus, snmpControlGroup=snmpControlGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPPollInterval=sNTPPollInterval, userEnabled=userEnabled, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, linkModeOptimisation=linkModeOptimisation, alarms=alarms, pubStats=pubStats, sNMPTrapIPAddress=sNMPTrapIPAddress, syslogControlGroup=syslogControlGroup, searchState=searchState, sNTPSync=sNTPSync, softwareVersion=softwareVersion, syslogState=syslogState, tDDSynchronizationMode=tDDSynchronizationMode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, gatewayIPAddress=gatewayIPAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tDDControl=tDDControl, vLANManagementPriority=vLANManagementPriority, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortDisabledWarning=dataPortDisabledWarning, targetMACAddress=targetMACAddress, hTTPAccessEnabled=hTTPAccessEnabled, sNMPv3Enable=sNMPv3Enable, transmitChannel=transmitChannel, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, subnetMask=subnetMask, bootVersion=bootVersion, phyStatusGroup=phyStatusGroup, telecomGroup=telecomGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, transmitPower=transmitPower, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapTable=sNMPTrapTable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, altitude=altitude, ethernetGroup=ethernetGroup, linkName=linkName, transmitFreqMHz=transmitFreqMHz, supplementary=supplementary, versions=versions, sntp=sntp, notificationsGroup=notificationsGroup, dfsTableIndex=dfsTableIndex, licensedCapacity=licensedCapacity, smtp=smtp, dataPortAutoMdix=dataPortAutoMdix, linkSymmetry=linkSymmetry, transmitDataRate=transmitDataRate, encryptionGroup=encryptionGroup, sNMPCommunityString=sNMPCommunityString, management=management, secondarySoftwareVersion=secondarySoftwareVersion, snmpControl=snmpControl, vLANPriorityTableNumber=vLANPriorityTableNumber, vLANPriorityQueueMapping=vLANPriorityQueueMapping, managementGroup=managementGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, regionCode=regionCode, iPAddress=iPAddress, vLANManagementVID=vLANManagementVID, syslogClient=syslogClient, syslogClientTrap=syslogClientTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ptp500=ptp500, latitude=latitude, telecomsChannelStatusTrap=telecomsChannelStatusTrap, telecomsInterface=telecomsInterface, sNMPTrapTableIndex=sNMPTrapTableIndex, sMTPEmailAlert=sMTPEmailAlert, encryption=encryption, telecomsCableLength=telecomsCableLength, systemClock=systemClock, ptmp=ptmp, telnetPortNumber=telnetPortNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, eIRP=eIRP, installStatusTrap=installStatusTrap, dfsTable=dfsTable, systemReset=systemReset, signalStrengthRatio=signalStrengthRatio, dataPortWirelessDownAlert=dataPortWirelessDownAlert, unitOutOfCalibration=unitOutOfCalibration)
