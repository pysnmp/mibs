...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", channelBandwidth=channelBandwidth, dfsTable=dfsTable, capacityLicenseMismatch=capacityLicenseMismatch, ptp=ptp, transmitPower=transmitPower, hTTPPortNumber=hTTPPortNumber, longitude=longitude, vLANPriorityQueueMapping=vLANPriorityQueueMapping, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tFTPServerIPAddress=tFTPServerIPAddress, ethernetFiberSupport=ethernetFiberSupport, telecomsInterface=telecomsInterface, sNTPServerIPAddress=sNTPServerIPAddress, systemReset=systemReset, snmpControl=snmpControl, userTableEntry=userTableEntry, ptp500=ptp500, latitude=latitude, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, productName=productName, dfsTableIndex=dfsTableIndex, targetMACAddress=targetMACAddress, eIRP=eIRP, telecomsLineCode=telecomsLineCode, enabledDiagnosticAlarms=enabledDiagnosticAlarms, transmitModulationMode=transmitModulationMode, management=management, dfsTableEntry=dfsTableEntry, ptpTrapPrefix=ptpTrapPrefix, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, PYSNMP_MODULE_ID=cambium, encryptionAlgorithm=encryptionAlgorithm, vLANPriorityTableIndex=vLANPriorityTableIndex, sNMPPortNumber=sNMPPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, telecomGroup=telecomGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, antennaGain=antennaGain, userTableNumber=userTableNumber, cableLoss=cableLoss, daylightSaving=daylightSaving, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, ptpCompliance=ptpCompliance, configuration=configuration, siteName=siteName, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, syslogStateTrap=syslogStateTrap, sntp=sntp, phyStatus=phyStatus, syslogState=syslogState, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, subnetMask=subnetMask, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, userTableIndex=userTableIndex, ptmp=ptmp, userEnabled=userEnabled, sNMPTrapTableEntry=sNMPTrapTableEntry, vLANManagementVID=vLANManagementVID, phyControlGroup=phyControlGroup, resetGroup=resetGroup, telecomsLoopback=telecomsLoopback, accessMethod=accessMethod, timeZone=timeZone, supplementaryGroup=supplementaryGroup, installArmState=installArmState, notificationsGroup=notificationsGroup, masterSlaveMode=masterSlaveMode, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tDDSynchronizationStatus=tDDSynchronizationStatus, constantPowerSpectralDensity=constantPowerSpectralDensity, cambium=cambium, dfsPeaks=dfsPeaks, receiveModulationMode=receiveModulationMode, aAAControlGroup=aAAControlGroup, reset=reset, tDDControlGroup=tDDControlGroup, linkName=linkName, vectorError=vectorError, hTTPSAccessEnabled=hTTPSAccessEnabled, telecomsChannelStatusTrap=telecomsChannelStatusTrap, smtp=smtp, vLANPriorityTableEntry=vLANPriorityTableEntry, sNTPServerPortNumber=sNTPServerPortNumber, dfsMeans=dfsMeans, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPLastSync=sNTPLastSync, aggregateDataRate=aggregateDataRate, hTTPSPortNumber=hTTPSPortNumber, linkSymmetry=linkSymmetry, alarmsGroup=alarmsGroup, ethernetGroup=ethernetGroup, receiveChannel=receiveChannel, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPSyncTrap=sNTPSyncTrap, sMTPServerPortNumber=sMTPServerPortNumber, telecomsCableLength=telecomsCableLength, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, snmpControlGroup=snmpControlGroup, regionCode=regionCode, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, incompatibleRegionCodes=incompatibleRegionCodes, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, linkModeOptimisation=linkModeOptimisation, wirelessLinkAvailability=wirelessLinkAvailability, dataPortStatusTrap=dataPortStatusTrap, aAAControl=aAAControl, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptpGroups=ptpGroups, dataPortDisabledWarning=dataPortDisabledWarning, installStatusTrap=installStatusTrap, smtpGroup=smtpGroup, userTable=userTable, vLANManagementPriority=vLANManagementPriority, productVariant=productVariant, sNMPEnabledTraps=sNMPEnabledTraps, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, syslogClientTrap=syslogClientTrap, telnetAccessEnabled=telnetAccessEnabled, phyStatusGroup=phyStatusGroup, searchState=searchState, syslogControlGroup=syslogControlGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPTrapIPAddress=sNMPTrapIPAddress, encryptionGroup=encryptionGroup, linkLoss=linkLoss, sNMPTrapVersion=sNMPTrapVersion, telecomsLoopbackTrap=telecomsLoopbackTrap, sntpGroup=sntpGroup, vLANPriorityTable=vLANPriorityTable, frequencyVariant=frequencyVariant, hTTPAccessEnabled=hTTPAccessEnabled, unitOutOfCalibration=unitOutOfCalibration, receivePower=receivePower, installStatus=installStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, userRole=userRole, telecomsChannelStatus=telecomsChannelStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPSync=sNTPSync, signalStrengthRatio=signalStrengthRatio, managementGroup=managementGroup, sNMPTrapTable=sNMPTrapTable, bootVersion=bootVersion, telecom=telecom, vLANPriorityTableNumber=vLANPriorityTableNumber, sMTPServerIPAddress=sMTPServerIPAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, versionsGroup=versionsGroup, sNMPCommunityString=sNMPCommunityString, softwareVersion=softwareVersion, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPv3Enable=sNMPv3Enable, maximumTransmitPower=maximumTransmitPower, phyControl=phyControl, range=range, dfs=dfs, secondarySoftwareVersion=secondarySoftwareVersion, tDDControl=tDDControl, dfsGroup=dfsGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tDDSynchronizationMode=tDDSynchronizationMode, receiveFreqKHz=receiveFreqKHz, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, regionCodeTrap=regionCodeTrap, userName=userName, gatewayIPAddress=gatewayIPAddress, supplementary=supplementary, systemClock=systemClock, sNMPTrapPortNumber=sNMPTrapPortNumber, transmitFreqKHz=transmitFreqKHz, alarms=alarms, syslogClient=syslogClient, syslogControl=syslogControl, remoteIPAddress=remoteIPAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, configurationGroup=configurationGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, licence=licence, hardwareVersion=hardwareVersion, installArmStateTrap=installArmStateTrap, bandwidthVariant=bandwidthVariant, sNTPState=sNTPState, altitude=altitude, byteErrorRatio=byteErrorRatio, iPAddress=iPAddress, transmitFreqMHz=transmitFreqMHz, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ptpTraps=ptpTraps, dfsTableNumber=dfsTableNumber, dataPortAutoMdix=dataPortAutoMdix, encryption=encryption, groupID=groupID, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNTPPollInterval=sNTPPollInterval, licenceGroup=licenceGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, transmitChannel=transmitChannel, telnetPortNumber=telnetPortNumber, licensedCapacity=licensedCapacity, receiveModulationModeDetail=receiveModulationModeDetail, userPassword=userPassword, receiveDataRate=receiveDataRate, ethernet=ethernet, transmitDataRate=transmitDataRate, dataPortStatus=dataPortStatus, tFTPServerPortNumber=tFTPServerPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, noWirelessChannelAvailable=noWirelessChannelAvailable, pubStatsGroup=pubStatsGroup, receiveFreqMHz=receiveFreqMHz, useVLANForManagementInterfaces=useVLANForManagementInterfaces, pubStats=pubStats, wirelessLinkStatus=wirelessLinkStatus, dataPortAutoNegotiation=dataPortAutoNegotiation, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, channelChangeTrap=channelChangeTrap, sMTPEmailAlert=sMTPEmailAlert, versions=versions)
