...
TimeTicks, ModuleIdentity, ObjectIdentity, MibIdentifier, enterprises, NotificationType, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter64, Gauge32, Counter32, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "enterprises", "NotificationType", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter64", "Gauge32", "Counter32", "IpAddress", "Integer32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", configuration=configuration, userTableEntry=userTableEntry, sNMPTrapIPAddress=sNMPTrapIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, userEnabled=userEnabled, telecomsCableLength=telecomsCableLength, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, noWirelessChannelAvailable=noWirelessChannelAvailable, ptpCompliance=ptpCompliance, useVLANForManagementInterfaces=useVLANForManagementInterfaces, phyStatus=phyStatus, maximumTransmitPower=maximumTransmitPower, supplementary=supplementary, telecomsChannelStatus=telecomsChannelStatus, sNTPServerIPAddress=sNTPServerIPAddress, bootVersion=bootVersion, syslogControl=syslogControl, ethernetGroup=ethernetGroup, vectorError=vectorError, sNMPTrapTable=sNMPTrapTable, channelBandwidth=channelBandwidth, sMTPServerPortNumber=sMTPServerPortNumber, ptpTrapPrefix=ptpTrapPrefix, userPassword=userPassword, latitude=latitude, ptp500=ptp500, dfsMeans=dfsMeans, linkLoss=linkLoss, unitOutOfCalibration=unitOutOfCalibration, systemClock=systemClock, vLANManagementPriority=vLANManagementPriority, vLANPriorityQueueMapping=vLANPriorityQueueMapping, linkModeOptimisation=linkModeOptimisation, wirelessLinkStatus=wirelessLinkStatus, telecom=telecom, timeZone=timeZone, userRole=userRole, resetGroup=resetGroup, sMTPEmailAlert=sMTPEmailAlert, versionsGroup=versionsGroup, bandwidthVariant=bandwidthVariant, sNTPSync=sNTPSync, incompatibleMasterAndSlave=incompatibleMasterAndSlave, telnetAccessEnabled=telnetAccessEnabled, management=management, subnetMask=subnetMask, constantPowerSpectralDensity=constantPowerSpectralDensity, aggregateDataRate=aggregateDataRate, licenceGroup=licenceGroup, dataPortStatusTrap=dataPortStatusTrap, hardwareVersion=hardwareVersion, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPServerPortNumber=sNTPServerPortNumber, telecomsLoopbackTrap=telecomsLoopbackTrap, remoteIPAddress=remoteIPAddress, telecomGroup=telecomGroup, eIRP=eIRP, sNMPTrapVersion=sNMPTrapVersion, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, managementGroup=managementGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, installArmStateTrap=installArmStateTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, softwareVersion=softwareVersion, licence=licence, secondarySoftwareVersion=secondarySoftwareVersion, receivePower=receivePower, aAAControlGroup=aAAControlGroup, byteErrorRatio=byteErrorRatio, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tDDSynchronizationMode=tDDSynchronizationMode, installStatus=installStatus, groupID=groupID, transmitFreqMHz=transmitFreqMHz, syslogClientTrap=syslogClientTrap, transmitChannel=transmitChannel, iPAddress=iPAddress, smtp=smtp, productName=productName, telecomsInterface=telecomsInterface, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, phyStatusGroup=phyStatusGroup, sNTPSyncTrap=sNTPSyncTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, range=range, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, regionCodeTrap=regionCodeTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, vLANManagementVID=vLANManagementVID, hTTPAccessEnabled=hTTPAccessEnabled, channelChangeTrap=channelChangeTrap, antennaGain=antennaGain, linkName=linkName, syslogClient=syslogClient, transmitFreqKHz=transmitFreqKHz, syslogLocalWrappedTrap=syslogLocalWrappedTrap, alarmsGroup=alarmsGroup, receiveModulationMode=receiveModulationMode, tDDSynchronizationAlarm=tDDSynchronizationAlarm, vLANPriorityTable=vLANPriorityTable, syslogState=syslogState, syslogControlGroup=syslogControlGroup, tFTPServerIPAddress=tFTPServerIPAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, linkSymmetry=linkSymmetry, configurationGroup=configurationGroup, dfsTableIndex=dfsTableIndex, versions=versions, reset=reset, vLANPriorityTableEntry=vLANPriorityTableEntry, pubStatsGroup=pubStatsGroup, dataPortStatus=dataPortStatus, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, snmpControl=snmpControl, systemReset=systemReset, phyControlGroup=phyControlGroup, dfsTable=dfsTable, syslogStateTrap=syslogStateTrap, sNMPPortNumber=sNMPPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, dfsTableEntry=dfsTableEntry, accessMethod=accessMethod, sNMPCommunityString=sNMPCommunityString, signalStrengthRatio=signalStrengthRatio, userTableNumber=userTableNumber, notificationsGroup=notificationsGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, telecomsChannelStatusTrap=telecomsChannelStatusTrap, smtpGroup=smtpGroup, encryptionGroup=encryptionGroup, PYSNMP_MODULE_ID=cambium, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPEnabledTraps=sNMPEnabledTraps, tFTPServerPortNumber=tFTPServerPortNumber, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, masterSlaveMode=masterSlaveMode, cambium=cambium, dfsTableNumber=dfsTableNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNTPPollInterval=sNTPPollInterval, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, tDDControl=tDDControl, targetMACAddress=targetMACAddress, tDDControlGroup=tDDControlGroup, transmitDataRate=transmitDataRate, telecomsLineCode=telecomsLineCode, altitude=altitude, encryption=encryption, tDDSynchronizationStatus=tDDSynchronizationStatus, siteName=siteName, receiveModulationModeDetail=receiveModulationModeDetail, ptmp=ptmp, encryptionAlgorithm=encryptionAlgorithm, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sntpGroup=sntpGroup, wirelessLinkAvailability=wirelessLinkAvailability, sntp=sntp, ptp=ptp, transmitPower=transmitPower, incompatibleRegionCodes=incompatibleRegionCodes, userName=userName, dataPortWirelessDownAlert=dataPortWirelessDownAlert, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sMTPServerIPAddress=sMTPServerIPAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, capacityLicenseMismatch=capacityLicenseMismatch, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, receiveDataRate=receiveDataRate, ptpTraps=ptpTraps, hTTPSAccessEnabled=hTTPSAccessEnabled, installStatusTrap=installStatusTrap, phyControl=phyControl, snmpControlGroup=snmpControlGroup, sNTPState=sNTPState, regionCode=regionCode, dfsPeaks=dfsPeaks, telecomsLoopback=telecomsLoopback, userTableIndex=userTableIndex, daylightSaving=daylightSaving, searchState=searchState, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortDisabledWarning=dataPortDisabledWarning, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dataPortAutoMdix=dataPortAutoMdix, longitude=longitude, installArmState=installArmState, licensedCapacity=licensedCapacity, ptpGroups=ptpGroups, hTTPSPortNumber=hTTPSPortNumber, transmitModulationMode=transmitModulationMode, userTable=userTable, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, frequencyVariant=frequencyVariant, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, pubStats=pubStats, receiveFreqKHz=receiveFreqKHz, sNMPv3Enable=sNMPv3Enable, gatewayIPAddress=gatewayIPAddress, hTTPPortNumber=hTTPPortNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, cableLoss=cableLoss, dfsGroup=dfsGroup, ethernet=ethernet, supplementaryGroup=supplementaryGroup, ethernetFiberSupport=ethernetFiberSupport, sMTPSourceEmailAddress=sMTPSourceEmailAddress, productVariant=productVariant, dfs=dfs, receiveChannel=receiveChannel, receiveFreqMHz=receiveFreqMHz, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, telnetPortNumber=telnetPortNumber, alarms=alarms, sNTPLastSync=sNTPLastSync, aAAControl=aAAControl)
