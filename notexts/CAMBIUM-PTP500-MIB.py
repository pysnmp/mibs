...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", telecom=telecom, range=range, ethernet=ethernet, groupID=groupID, ptp500=ptp500, ptpTrapPrefix=ptpTrapPrefix, ptpCompliance=ptpCompliance, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, timeZone=timeZone, bandwidthVariant=bandwidthVariant, phyStatus=phyStatus, installArmState=installArmState, telnetPortNumber=telnetPortNumber, PYSNMP_MODULE_ID=cambium, encryptionGroup=encryptionGroup, dataPortDisabledWarning=dataPortDisabledWarning, sMTPServerPortNumber=sMTPServerPortNumber, sNTPState=sNTPState, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sMTPEnabledMessages=sMTPEnabledMessages, transmitDataRate=transmitDataRate, sNMPv3Enable=sNMPv3Enable, capacityLicenseMismatch=capacityLicenseMismatch, tDDSynchronizationStatus=tDDSynchronizationStatus, bootVersion=bootVersion, productVariant=productVariant, wirelessLinkAvailability=wirelessLinkAvailability, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPSyncTrap=sNTPSyncTrap, receiveModulationModeDetail=receiveModulationModeDetail, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ptpTraps=ptpTraps, linkSymmetry=linkSymmetry, vectorError=vectorError, smtpGroup=smtpGroup, eIRP=eIRP, encryptionAlgorithm=encryptionAlgorithm, userTable=userTable, accessMethod=accessMethod, hTTPSAccessEnabled=hTTPSAccessEnabled, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, versions=versions, configurationGroup=configurationGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, phyControl=phyControl, vLANPriorityTableEntry=vLANPriorityTableEntry, aAAControl=aAAControl, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, phyStatusGroup=phyStatusGroup, sNTPSync=sNTPSync, remoteMaximumTransmitPower=remoteMaximumTransmitPower, syslogControl=syslogControl, receiveDataRate=receiveDataRate, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, userEnabled=userEnabled, telecomsLoopback=telecomsLoopback, frequencyVariant=frequencyVariant, installStatusTrap=installStatusTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ethernetGroup=ethernetGroup, dfsTableEntry=dfsTableEntry, sNMPEnabledTraps=sNMPEnabledTraps, incompatibleRegionCodes=incompatibleRegionCodes, incompatibleMasterAndSlave=incompatibleMasterAndSlave, phyControlGroup=phyControlGroup, sNMPPortNumber=sNMPPortNumber, configuration=configuration, transmitFreqKHz=transmitFreqKHz, aggregateDataRate=aggregateDataRate, userTableNumber=userTableNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, receivePower=receivePower, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dfsMeans=dfsMeans, ptpGroups=ptpGroups, transmitPower=transmitPower, transmitFreqMHz=transmitFreqMHz, dfsTable=dfsTable, telecomsChannelStatusTrap=telecomsChannelStatusTrap, versionsGroup=versionsGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, byteErrorRatio=byteErrorRatio, userTableEntry=userTableEntry, dataPortAutoMdix=dataPortAutoMdix, sMTPServerIPAddress=sMTPServerIPAddress, syslogControlGroup=syslogControlGroup, subnetMask=subnetMask, receiveFreqMHz=receiveFreqMHz, cambium=cambium, managementGroup=managementGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, aAAControlGroup=aAAControlGroup, licence=licence, supplementaryGroup=supplementaryGroup, telecomGroup=telecomGroup, hTTPAccessEnabled=hTTPAccessEnabled, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, unitOutOfCalibration=unitOutOfCalibration, linkModeOptimizationMismatch=linkModeOptimizationMismatch, telecomsLineCode=telecomsLineCode, smtp=smtp, snmpControl=snmpControl, snmpControlGroup=snmpControlGroup, cableLoss=cableLoss, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, targetMACAddress=targetMACAddress, wirelessLinkStatus=wirelessLinkStatus, signalStrengthRatio=signalStrengthRatio, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, licensedCapacity=licensedCapacity, ptmp=ptmp, supplementary=supplementary, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPCommunityString=sNMPCommunityString, dfsTableNumber=dfsTableNumber, reset=reset, tDDSynchronizationMode=tDDSynchronizationMode, sNMPTrapTable=sNMPTrapTable, sNMPTrapTableNumber=sNMPTrapTableNumber, channelBandwidth=channelBandwidth, dataPortStatusTrap=dataPortStatusTrap, transmitChannel=transmitChannel, secondarySoftwareVersion=secondarySoftwareVersion, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNMPTrapVersion=sNMPTrapVersion, sNTPServerPortNumber=sNTPServerPortNumber, productName=productName, sMTPEmailAlert=sMTPEmailAlert, dfsPeaks=dfsPeaks, notificationsGroup=notificationsGroup, hardwareVersion=hardwareVersion, telecomsLoopbackTrap=telecomsLoopbackTrap, telecomsInterface=telecomsInterface, latitude=latitude, licenceGroup=licenceGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tFTPServerIPAddress=tFTPServerIPAddress, sNTPServerIPAddress=sNTPServerIPAddress, altitude=altitude, telnetAccessEnabled=telnetAccessEnabled, syslogClient=syslogClient, pubStats=pubStats, ethernetFiberSupport=ethernetFiberSupport, linkModeOptimisation=linkModeOptimisation, tDDControl=tDDControl, receiveFreqKHz=receiveFreqKHz, dfsGroup=dfsGroup, pubStatsGroup=pubStatsGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, dfs=dfs, masterSlaveMode=masterSlaveMode, sntpGroup=sntpGroup, syslogClientTrap=syslogClientTrap, resetGroup=resetGroup, alarmsGroup=alarmsGroup, hTTPPortNumber=hTTPPortNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, longitude=longitude, searchState=searchState, tFTPServerPortNumber=tFTPServerPortNumber, sntp=sntp, encryption=encryption, siteName=siteName, syslogState=syslogState, systemReset=systemReset, channelChangeTrap=channelChangeTrap, telecomsCableLength=telecomsCableLength, userPassword=userPassword, vLANManagementPriority=vLANManagementPriority, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userName=userName, sNTPLastSync=sNTPLastSync, dataPortStatus=dataPortStatus, installArmStateTrap=installArmStateTrap, softwareVersion=softwareVersion, management=management, sNMPTrapTableEntry=sNMPTrapTableEntry, vLANManagementVID=vLANManagementVID, enabledDiagnosticAlarms=enabledDiagnosticAlarms, linkLoss=linkLoss, vLANPriorityQueueMapping=vLANPriorityQueueMapping, regionCodeTrap=regionCodeTrap, regionCode=regionCode, maximumTransmitPower=maximumTransmitPower, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, iPAddress=iPAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, userRole=userRole, vLANPriorityTable=vLANPriorityTable, userTableIndex=userTableIndex, tDDControlGroup=tDDControlGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, antennaGain=antennaGain, dfsTableIndex=dfsTableIndex, transmitModulationMode=transmitModulationMode, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, ptp=ptp, installStatus=installStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPPollInterval=sNTPPollInterval, systemClock=systemClock, daylightSaving=daylightSaving, hTTPSPortNumber=hTTPSPortNumber, linkName=linkName, receiveModulationMode=receiveModulationMode, vLANPriorityTableIndex=vLANPriorityTableIndex, receiveChannel=receiveChannel, alarms=alarms, remoteIPAddress=remoteIPAddress, telecomsChannelStatus=telecomsChannelStatus, gatewayIPAddress=gatewayIPAddress, syslogStateTrap=syslogStateTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap)
