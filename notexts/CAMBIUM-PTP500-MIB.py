...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPTrapPortNumber=sNMPTrapPortNumber, userEnabled=userEnabled, transmitPower=transmitPower, ptp=ptp, telecomsLoopback=telecomsLoopback, receiveFreqKHz=receiveFreqKHz, sNTPState=sNTPState, systemClock=systemClock, telecomsLoopbackTrap=telecomsLoopbackTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, dfsTableEntry=dfsTableEntry, useVLANForManagementInterfaces=useVLANForManagementInterfaces, searchState=searchState, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPPortNumber=sNMPPortNumber, PYSNMP_MODULE_ID=cambium, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, installStatusTrap=installStatusTrap, userPassword=userPassword, aAAControl=aAAControl, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ptp500=ptp500, sMTPServerIPAddress=sMTPServerIPAddress, cableLoss=cableLoss, reset=reset, ptpGroups=ptpGroups, regionCodeTrap=regionCodeTrap, phyStatus=phyStatus, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sMTPEmailAlert=sMTPEmailAlert, userTableEntry=userTableEntry, pubStatsGroup=pubStatsGroup, timeZone=timeZone, subnetMask=subnetMask, linkModeOptimisation=linkModeOptimisation, syslogClientTrap=syslogClientTrap, versions=versions, incompatibleRegionCodes=incompatibleRegionCodes, softwareVersion=softwareVersion, receiveFreqMHz=receiveFreqMHz, syslogClient=syslogClient, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, wirelessLinkStatus=wirelessLinkStatus, ethernet=ethernet, alarms=alarms, sNMPCommunityString=sNMPCommunityString, resetGroup=resetGroup, transmitDataRate=transmitDataRate, aggregateDataRate=aggregateDataRate, management=management, longitude=longitude, capacityLicenseMismatch=capacityLicenseMismatch, telecomsCableLength=telecomsCableLength, syslogState=syslogState, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPTrapVersion=sNMPTrapVersion, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPLastSync=sNTPLastSync, transmitModulationMode=transmitModulationMode, notificationsGroup=notificationsGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, installStatus=installStatus, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, tFTPServerPortNumber=tFTPServerPortNumber, productName=productName, ethernetGroup=ethernetGroup, receiveModulationModeDetail=receiveModulationModeDetail, dataPortStatusTrap=dataPortStatusTrap, telecomGroup=telecomGroup, transmitChannel=transmitChannel, tFTPServerIPAddress=tFTPServerIPAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPv3Enable=sNMPv3Enable, sMTPServerPortNumber=sMTPServerPortNumber, userName=userName, userTableIndex=userTableIndex, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, installArmState=installArmState, sNTPSyncTrap=sNTPSyncTrap, syslogStateTrap=syslogStateTrap, licence=licence, receiveChannel=receiveChannel, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, iPAddress=iPAddress, licensedCapacity=licensedCapacity, pubStats=pubStats, ptpCompliance=ptpCompliance, telnetAccessEnabled=telnetAccessEnabled, masterSlaveMode=masterSlaveMode, systemReset=systemReset, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sMTPEnabledMessages=sMTPEnabledMessages, installArmStateTrap=installArmStateTrap, syslogControlGroup=syslogControlGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, sntpGroup=sntpGroup, dfsTableIndex=dfsTableIndex, sNTPSync=sNTPSync, dfsTableNumber=dfsTableNumber, transmitFreqKHz=transmitFreqKHz, configuration=configuration, encryptionGroup=encryptionGroup, frequencyVariant=frequencyVariant, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, latitude=latitude, sNTPServerPortNumber=sNTPServerPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, sNMPTrapIPAddress=sNMPTrapIPAddress, eIRP=eIRP, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, unitOutOfCalibration=unitOutOfCalibration, dfs=dfs, vLANPriorityTableEntry=vLANPriorityTableEntry, sNMPTrapTableEntry=sNMPTrapTableEntry, channelBandwidth=channelBandwidth, vLANManagementPriority=vLANManagementPriority, bandwidthVariant=bandwidthVariant, dataPortAutoNegotiation=dataPortAutoNegotiation, ptpTrapPrefix=ptpTrapPrefix, dataPortAutoMdix=dataPortAutoMdix, sntp=sntp, telecomsInterface=telecomsInterface, remoteMaximumTransmitPower=remoteMaximumTransmitPower, phyControl=phyControl, snmpControlGroup=snmpControlGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, gatewayIPAddress=gatewayIPAddress, dfsTable=dfsTable, regionCode=regionCode, telecomsChannelStatus=telecomsChannelStatus, linkName=linkName, phyControlGroup=phyControlGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPEnabledTraps=sNMPEnabledTraps, linkModeOptimizationMismatch=linkModeOptimizationMismatch, linkLoss=linkLoss, tDDSynchronizationMode=tDDSynchronizationMode, vLANPriorityQueueMapping=vLANPriorityQueueMapping, syslogControl=syslogControl, telecomsLineCode=telecomsLineCode, dfsPeaks=dfsPeaks, sNMPTrapTable=sNMPTrapTable, channelChangeTrap=channelChangeTrap, userTable=userTable, hTTPPortNumber=hTTPPortNumber, userRole=userRole, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ptmp=ptmp, managementGroup=managementGroup, sNTPServerIPAddress=sNTPServerIPAddress, signalStrengthRatio=signalStrengthRatio, targetMACAddress=targetMACAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, bootVersion=bootVersion, dataPortStatus=dataPortStatus, phyStatusGroup=phyStatusGroup, smtpGroup=smtpGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, userTableNumber=userTableNumber, transmitFreqMHz=transmitFreqMHz, cambium=cambium, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tDDControl=tDDControl, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, snmpControl=snmpControl, vLANPriorityTable=vLANPriorityTable, linkSymmetry=linkSymmetry, antennaGain=antennaGain, tDDControlGroup=tDDControlGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, altitude=altitude, telnetPortNumber=telnetPortNumber, receiveModulationMode=receiveModulationMode, wirelessLinkAvailability=wirelessLinkAvailability, alarmsGroup=alarmsGroup, siteName=siteName, constantPowerSpectralDensity=constantPowerSpectralDensity, hTTPAccessEnabled=hTTPAccessEnabled, byteErrorRatio=byteErrorRatio, smtp=smtp, accessMethod=accessMethod, dataPortDisabledWarning=dataPortDisabledWarning, telecom=telecom, vLANManagementVID=vLANManagementVID, aAAControlGroup=aAAControlGroup, versionsGroup=versionsGroup, encryptionAlgorithm=encryptionAlgorithm, ptpTraps=ptpTraps, receivePower=receivePower, dfsMeans=dfsMeans, productVariant=productVariant, range=range, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, configurationGroup=configurationGroup, maximumTransmitPower=maximumTransmitPower, remoteIPAddress=remoteIPAddress, groupID=groupID, vLANPriorityTableIndex=vLANPriorityTableIndex, hTTPSPortNumber=hTTPSPortNumber, telecomsChannelStatusTrap=telecomsChannelStatusTrap, hardwareVersion=hardwareVersion, licenceGroup=licenceGroup, supplementary=supplementary, receiveDataRate=receiveDataRate, ethernetFiberSupport=ethernetFiberSupport, vectorError=vectorError, daylightSaving=daylightSaving, supplementaryGroup=supplementaryGroup, dfsGroup=dfsGroup, sNTPPollInterval=sNTPPollInterval, encryption=encryption)
