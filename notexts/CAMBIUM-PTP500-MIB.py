...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", phyStatus=phyStatus, licenceGroup=licenceGroup, maximumTransmitPower=maximumTransmitPower, groupID=groupID, tDDControl=tDDControl, tDDControlGroup=tDDControlGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, vLANPriorityTableIndex=vLANPriorityTableIndex, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, daylightSaving=daylightSaving, range=range, telecomsChannelStatus=telecomsChannelStatus, siteName=siteName, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, receiveChannel=receiveChannel, receiveFreqKHz=receiveFreqKHz, dfsTable=dfsTable, receivePower=receivePower, transmitFreqKHz=transmitFreqKHz, cambium=cambium, versionsGroup=versionsGroup, telecom=telecom, resetGroup=resetGroup, aAAControl=aAAControl, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNMPTrapTable=sNMPTrapTable, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPPollInterval=sNTPPollInterval, sNTPState=sNTPState, syslogState=syslogState, incompatibleRegionCodes=incompatibleRegionCodes, dataPortAutoMdix=dataPortAutoMdix, noWirelessChannelAvailable=noWirelessChannelAvailable, userPassword=userPassword, phyControl=phyControl, sNTPSync=sNTPSync, vLANManagementVID=vLANManagementVID, encryption=encryption, sNTPServerPortNumber=sNTPServerPortNumber, dfs=dfs, sntpGroup=sntpGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, linkName=linkName, altitude=altitude, phyStatusGroup=phyStatusGroup, snmpControlGroup=snmpControlGroup, sNTPLastSync=sNTPLastSync, constantPowerSpectralDensity=constantPowerSpectralDensity, userTableIndex=userTableIndex, sMTPServerIPAddress=sMTPServerIPAddress, smtpGroup=smtpGroup, receiveFreqMHz=receiveFreqMHz, hardwareVersion=hardwareVersion, telnetAccessEnabled=telnetAccessEnabled, telecomsInterface=telecomsInterface, sNMPCommunityString=sNMPCommunityString, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, syslogClientTrap=syslogClientTrap, telecomsCableLength=telecomsCableLength, alarms=alarms, dataPortConfigurationMismatch=dataPortConfigurationMismatch, hTTPSPortNumber=hTTPSPortNumber, channelBandwidth=channelBandwidth, userRole=userRole, linkModeOptimisation=linkModeOptimisation, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, linkLoss=linkLoss, systemClock=systemClock, ptmp=ptmp, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsTableIndex=dfsTableIndex, regionCode=regionCode, cableLoss=cableLoss, tFTPServerPortNumber=tFTPServerPortNumber, management=management, telnetPortNumber=telnetPortNumber, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, eIRP=eIRP, ethernetFiberSupport=ethernetFiberSupport, hTTPPortNumber=hTTPPortNumber, transmitModulationMode=transmitModulationMode, userTableNumber=userTableNumber, productName=productName, linkSymmetry=linkSymmetry, wirelessLinkAvailability=wirelessLinkAvailability, incompatibleMasterAndSlave=incompatibleMasterAndSlave, useVLANForManagementInterfaces=useVLANForManagementInterfaces, snmpControl=snmpControl, notificationsGroup=notificationsGroup, softwareVersion=softwareVersion, telecomsLineCode=telecomsLineCode, bootVersion=bootVersion, ptpGroups=ptpGroups, aggregateDataRate=aggregateDataRate, userEnabled=userEnabled, dataPortStatusTrap=dataPortStatusTrap, PYSNMP_MODULE_ID=cambium, encryptionAlgorithm=encryptionAlgorithm, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ptpTrapPrefix=ptpTrapPrefix, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, configurationGroup=configurationGroup, byteErrorRatio=byteErrorRatio, sNMPv3Enable=sNMPv3Enable, installArmStateTrap=installArmStateTrap, transmitFreqMHz=transmitFreqMHz, sMTPEmailAlert=sMTPEmailAlert, installArmState=installArmState, sNMPPortNumber=sNMPPortNumber, subnetMask=subnetMask, syslogStateTrap=syslogStateTrap, dfsTableNumber=dfsTableNumber, dfsPeaks=dfsPeaks, antennaGain=antennaGain, dataPortWirelessDownAlert=dataPortWirelessDownAlert, pubStatsGroup=pubStatsGroup, userTable=userTable, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, licence=licence, hTTPAccessEnabled=hTTPAccessEnabled, timeZone=timeZone, wirelessLinkStatus=wirelessLinkStatus, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, vectorError=vectorError, vLANManagementPriority=vLANManagementPriority, pubStats=pubStats, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, frequencyVariant=frequencyVariant, syslogLocalWrappedTrap=syslogLocalWrappedTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, accessMethod=accessMethod, tDDSynchronizationStatus=tDDSynchronizationStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, secondarySoftwareVersion=secondarySoftwareVersion, regionCodeTrap=regionCodeTrap, telecomsLoopback=telecomsLoopback, systemReset=systemReset, userName=userName, receiveModulationModeDetail=receiveModulationModeDetail, productVariant=productVariant, sNMPTrapTableEntry=sNMPTrapTableEntry, userTableEntry=userTableEntry, sNTPSyncTrap=sNTPSyncTrap, dataPortStatus=dataPortStatus, signalStrengthRatio=signalStrengthRatio, transmitDataRate=transmitDataRate, targetMACAddress=targetMACAddress, syslogClient=syslogClient, telecomsLoopbackTrap=telecomsLoopbackTrap, receiveDataRate=receiveDataRate, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, searchState=searchState, ptp500=ptp500, gatewayIPAddress=gatewayIPAddress, transmitPower=transmitPower, telecomGroup=telecomGroup, configuration=configuration, dataPortDisabledWarning=dataPortDisabledWarning, syslogControl=syslogControl, supplementary=supplementary, iPAddress=iPAddress, dfsTableEntry=dfsTableEntry, ethernet=ethernet, longitude=longitude, supplementaryGroup=supplementaryGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, dfsGroup=dfsGroup, bandwidthVariant=bandwidthVariant, ptp=ptp, sMTPServerPortNumber=sMTPServerPortNumber, capacityLicenseMismatch=capacityLicenseMismatch, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, reset=reset, phyControlGroup=phyControlGroup, managementGroup=managementGroup, ethernetGroup=ethernetGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, receiveModulationMode=receiveModulationMode, alarmsGroup=alarmsGroup, aAAControlGroup=aAAControlGroup, sntp=sntp, vLANPriorityTable=vLANPriorityTable, encryptionGroup=encryptionGroup, unitOutOfCalibration=unitOutOfCalibration, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sMTPEnabledMessages=sMTPEnabledMessages, tFTPServerIPAddress=tFTPServerIPAddress, versions=versions, masterSlaveMode=masterSlaveMode, transmitChannel=transmitChannel, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNTPServerIPAddress=sNTPServerIPAddress, tDDSynchronizationMode=tDDSynchronizationMode, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPEnabledTraps=sNMPEnabledTraps, installStatus=installStatus, channelChangeTrap=channelChangeTrap, remoteIPAddress=remoteIPAddress, vLANPriorityTableNumber=vLANPriorityTableNumber, syslogControlGroup=syslogControlGroup, dfsMeans=dfsMeans, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, licensedCapacity=licensedCapacity, installStatusTrap=installStatusTrap, ptpCompliance=ptpCompliance, ptpTraps=ptpTraps, tDDSynchronizationAlarm=tDDSynchronizationAlarm, smtp=smtp, latitude=latitude, sNMPTrapVersion=sNMPTrapVersion)
