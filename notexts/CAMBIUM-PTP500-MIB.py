...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", vLANPriorityQueueMapping=vLANPriorityQueueMapping, reset=reset, managementGroup=managementGroup, PYSNMP_MODULE_ID=cambium, dataPortStatus=dataPortStatus, telnetAccessEnabled=telnetAccessEnabled, userPassword=userPassword, ethernet=ethernet, installArmStateTrap=installArmStateTrap, receiveFreqMHz=receiveFreqMHz, sNTPState=sNTPState, transmitDataRate=transmitDataRate, alarms=alarms, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sntpGroup=sntpGroup, sNMPPortNumber=sNMPPortNumber, receiveDataRate=receiveDataRate, dfsTableNumber=dfsTableNumber, capacityLicenseMismatch=capacityLicenseMismatch, telecomGroup=telecomGroup, linkName=linkName, targetMACAddress=targetMACAddress, ethernetGroup=ethernetGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, accessMethod=accessMethod, telecomsChannelStatusTrap=telecomsChannelStatusTrap, snmpControlGroup=snmpControlGroup, linkModeOptimisation=linkModeOptimisation, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, productVariant=productVariant, encryption=encryption, vLANPriorityTableIndex=vLANPriorityTableIndex, sNTPSyncTrap=sNTPSyncTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, management=management, configurationGroup=configurationGroup, vLANManagementPriority=vLANManagementPriority, receiveModulationMode=receiveModulationMode, telecomsInterface=telecomsInterface, transmitPower=transmitPower, userName=userName, regionCodeTrap=regionCodeTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, incompatibleMasterAndSlave=incompatibleMasterAndSlave, smtpGroup=smtpGroup, ptpTrapPrefix=ptpTrapPrefix, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, aggregateDataRate=aggregateDataRate, dfsTable=dfsTable, sMTPServerIPAddress=sMTPServerIPAddress, eIRP=eIRP, notificationsGroup=notificationsGroup, searchState=searchState, transmitChannel=transmitChannel, linkSymmetry=linkSymmetry, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPServerPortNumber=tFTPServerPortNumber, versions=versions, sNTPLastSync=sNTPLastSync, masterSlaveMode=masterSlaveMode, versionsGroup=versionsGroup, timeZone=timeZone, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, pubStatsGroup=pubStatsGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, snmpControl=snmpControl, tFTPServerIPAddress=tFTPServerIPAddress, aAAControl=aAAControl, ptpGroups=ptpGroups, longitude=longitude, maximumTransmitPower=maximumTransmitPower, hTTPPortNumber=hTTPPortNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, installStatusTrap=installStatusTrap, productName=productName, systemReset=systemReset, transmitFreqKHz=transmitFreqKHz, dfsMeans=dfsMeans, receiveChannel=receiveChannel, incompatibleRegionCodes=incompatibleRegionCodes, unitOutOfCalibration=unitOutOfCalibration, resetGroup=resetGroup, encryptionAlgorithm=encryptionAlgorithm, channelBandwidth=channelBandwidth, licence=licence, ptpTraps=ptpTraps, ethernetFiberSupport=ethernetFiberSupport, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapTableIndex=sNMPTrapTableIndex, encryptionGroup=encryptionGroup, installStatus=installStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, userTableEntry=userTableEntry, dataPortDisabledWarning=dataPortDisabledWarning, range=range, sMTPServerPortNumber=sMTPServerPortNumber, siteName=siteName, bandwidthVariant=bandwidthVariant, wirelessLinkStatus=wirelessLinkStatus, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, phyStatus=phyStatus, sNTPSync=sNTPSync, softwareVersion=softwareVersion, sNTPPollInterval=sNTPPollInterval, altitude=altitude, phyControlGroup=phyControlGroup, channelChangeTrap=channelChangeTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, frequencyVariant=frequencyVariant, transmitModulationMode=transmitModulationMode, pubStats=pubStats, subnetMask=subnetMask, telecom=telecom, dfsTableEntry=dfsTableEntry, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, bootVersion=bootVersion, iPAddress=iPAddress, transmitFreqMHz=transmitFreqMHz, telecomsChannelStatus=telecomsChannelStatus, dfsTableIndex=dfsTableIndex, dfs=dfs, dfsPeaks=dfsPeaks, gatewayIPAddress=gatewayIPAddress, remoteIPAddress=remoteIPAddress, sMTPEnabledMessages=sMTPEnabledMessages, userRole=userRole, licensedCapacity=licensedCapacity, sNTPServerPortNumber=sNTPServerPortNumber, supplementary=supplementary, secondarySoftwareVersion=secondarySoftwareVersion, alarmsGroup=alarmsGroup, userTableIndex=userTableIndex, telnetPortNumber=telnetPortNumber, latitude=latitude, ptp500=ptp500, vectorError=vectorError, cableLoss=cableLoss, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sntp=sntp, hTTPAccessEnabled=hTTPAccessEnabled, groupID=groupID, syslogClient=syslogClient, hTTPSAccessEnabled=hTTPSAccessEnabled, tDDSynchronizationMode=tDDSynchronizationMode, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, userTableNumber=userTableNumber, syslogControlGroup=syslogControlGroup, signalStrengthRatio=signalStrengthRatio, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, vLANPriorityTableNumber=vLANPriorityTableNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, syslogStateTrap=syslogStateTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, syslogClientTrap=syslogClientTrap, ptmp=ptmp, receiveModulationModeDetail=receiveModulationModeDetail, tDDSynchronizationAlarm=tDDSynchronizationAlarm, smtp=smtp, supplementaryGroup=supplementaryGroup, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPServerIPAddress=sNTPServerIPAddress, userEnabled=userEnabled, remoteMaximumTransmitPower=remoteMaximumTransmitPower, receivePower=receivePower, hardwareVersion=hardwareVersion, sNMPCommunityString=sNMPCommunityString, receiveFreqKHz=receiveFreqKHz, sNMPv3Enable=sNMPv3Enable, daylightSaving=daylightSaving, dfsGroup=dfsGroup, ptpCompliance=ptpCompliance, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, antennaGain=antennaGain, syslogControl=syslogControl, wirelessLinkAvailability=wirelessLinkAvailability, tDDSynchronizationStatus=tDDSynchronizationStatus, licenceGroup=licenceGroup, phyControl=phyControl, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, systemClock=systemClock, hTTPSPortNumber=hTTPSPortNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, telecomsCableLength=telecomsCableLength, syslogState=syslogState, configuration=configuration, userTable=userTable, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sMTPEmailAlert=sMTPEmailAlert, aAAControlGroup=aAAControlGroup, telecomsLineCode=telecomsLineCode, installArmState=installArmState, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ptp=ptp, vLANPriorityTable=vLANPriorityTable, tDDControl=tDDControl, tDDControlGroup=tDDControlGroup, sNMPTrapTable=sNMPTrapTable, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, telecomsLoopback=telecomsLoopback, linkLoss=linkLoss, byteErrorRatio=byteErrorRatio, vLANManagementVID=vLANManagementVID, dataPortStatusTrap=dataPortStatusTrap, dataPortAutoMdix=dataPortAutoMdix, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, cambium=cambium, regionCode=regionCode, sNMPTrapVersion=sNMPTrapVersion, phyStatusGroup=phyStatusGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade)
