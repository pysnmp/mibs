...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", ethernet=ethernet, notificationsGroup=notificationsGroup, vLANPriorityTable=vLANPriorityTable, eIRP=eIRP, receivePower=receivePower, PYSNMP_MODULE_ID=cambium, vLANPriorityQueueMapping=vLANPriorityQueueMapping, enabledDiagnosticAlarms=enabledDiagnosticAlarms, byteErrorRatio=byteErrorRatio, sNMPv3Enable=sNMPv3Enable, aggregateDataRate=aggregateDataRate, encryptionGroup=encryptionGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, licensedCapacity=licensedCapacity, systemReset=systemReset, sNTPServerIPAddress=sNTPServerIPAddress, phyControlGroup=phyControlGroup, sNTPLastSync=sNTPLastSync, targetMACAddress=targetMACAddress, receiveChannel=receiveChannel, unitOutOfCalibration=unitOutOfCalibration, linkModeOptimisation=linkModeOptimisation, systemClock=systemClock, range=range, sNMPTrapIPAddress=sNMPTrapIPAddress, dfs=dfs, ptpCompliance=ptpCompliance, antennaGain=antennaGain, dataPortDisabledWarning=dataPortDisabledWarning, transmitModulationMode=transmitModulationMode, snmpControl=snmpControl, resetGroup=resetGroup, tFTPServerIPAddress=tFTPServerIPAddress, telnetAccessEnabled=telnetAccessEnabled, linkModeOptimizationMismatch=linkModeOptimizationMismatch, transmitChannel=transmitChannel, ptpTraps=ptpTraps, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, phyStatus=phyStatus, installArmStateTrap=installArmStateTrap, telecomGroup=telecomGroup, userName=userName, tDDControl=tDDControl, ptpGroups=ptpGroups, configuration=configuration, aAAControlGroup=aAAControlGroup, vLANManagementVID=vLANManagementVID, sMTPEmailAlert=sMTPEmailAlert, snmpControlGroup=snmpControlGroup, sNTPSyncTrap=sNTPSyncTrap, syslogStateTrap=syslogStateTrap, wirelessLinkAvailability=wirelessLinkAvailability, dataPortConfigurationMismatch=dataPortConfigurationMismatch, timeZone=timeZone, productVariant=productVariant, dfsTableNumber=dfsTableNumber, maximumTransmitPower=maximumTransmitPower, versions=versions, telnetPortNumber=telnetPortNumber, installStatus=installStatus, receiveFreqKHz=receiveFreqKHz, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tDDControlGroup=tDDControlGroup, groupID=groupID, reset=reset, ptpTrapPrefix=ptpTrapPrefix, alarmsGroup=alarmsGroup, productName=productName, hardwareVersion=hardwareVersion, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, telecomsLineCode=telecomsLineCode, cambium=cambium, installArmState=installArmState, syslogControl=syslogControl, iPAddress=iPAddress, vLANPriorityTableNumber=vLANPriorityTableNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, sNMPCommunityString=sNMPCommunityString, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPTrapVersion=sNMPTrapVersion, ptp=ptp, vLANPriorityTableEntry=vLANPriorityTableEntry, gatewayIPAddress=gatewayIPAddress, linkLoss=linkLoss, transmitFreqMHz=transmitFreqMHz, signalStrengthRatio=signalStrengthRatio, siteName=siteName, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfsTableEntry=dfsTableEntry, supplementaryGroup=supplementaryGroup, ptmp=ptmp, phyControl=phyControl, receiveModulationMode=receiveModulationMode, dfsGroup=dfsGroup, remoteIPAddress=remoteIPAddress, receiveModulationModeDetail=receiveModulationModeDetail, sNMPTrapPortNumber=sNMPTrapPortNumber, userTableIndex=userTableIndex, versionsGroup=versionsGroup, userTableEntry=userTableEntry, latitude=latitude, telecomsInterface=telecomsInterface, licence=licence, channelChangeTrap=channelChangeTrap, daylightSaving=daylightSaving, syslogState=syslogState, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPTrapTable=sNMPTrapTable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNTPState=sNTPState, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, alarms=alarms, transmitFreqKHz=transmitFreqKHz, encryption=encryption, sntp=sntp, pubStats=pubStats, telecomsChannelStatus=telecomsChannelStatus, userTableNumber=userTableNumber, sMTPServerPortNumber=sMTPServerPortNumber, telecom=telecom, masterSlaveMode=masterSlaveMode, dataPortWirelessDownAlert=dataPortWirelessDownAlert, management=management, softwareVersion=softwareVersion, tDDSynchronizationMode=tDDSynchronizationMode, phyStatusGroup=phyStatusGroup, regionCode=regionCode, regionCodeTrap=regionCodeTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, userTable=userTable, channelBandwidth=channelBandwidth, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, supplementary=supplementary, subnetMask=subnetMask, longitude=longitude, smtpGroup=smtpGroup, userEnabled=userEnabled, altitude=altitude, tFTPServerPortNumber=tFTPServerPortNumber, aAAControl=aAAControl, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, dataPortStatusTrap=dataPortStatusTrap, dfsTableIndex=dfsTableIndex, hTTPAccessEnabled=hTTPAccessEnabled, licenceGroup=licenceGroup, sMTPEnabledMessages=sMTPEnabledMessages, sNMPEnabledTraps=sNMPEnabledTraps, ethernetGroup=ethernetGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNMPPortNumber=sNMPPortNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsMeans=dfsMeans, sMTPServerIPAddress=sMTPServerIPAddress, telecomsChannelStatusTrap=telecomsChannelStatusTrap, bootVersion=bootVersion, sNMPTrapTableEntry=sNMPTrapTableEntry, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ethernetFiberSupport=ethernetFiberSupport, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, vectorError=vectorError, useVLANForManagementInterfaces=useVLANForManagementInterfaces, syslogLocalWrappedTrap=syslogLocalWrappedTrap, configurationGroup=configurationGroup, smtp=smtp, telecomsLoopback=telecomsLoopback, transmitPower=transmitPower, linkSymmetry=linkSymmetry, installStatusTrap=installStatusTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, receiveDataRate=receiveDataRate, hTTPPortNumber=hTTPPortNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortAutoMdix=dataPortAutoMdix, incompatibleRegionCodes=incompatibleRegionCodes, secondarySoftwareVersion=secondarySoftwareVersion, dfsPeaks=dfsPeaks, dataPortStatus=dataPortStatus, dfsTable=dfsTable, bandwidthVariant=bandwidthVariant, sNTPPollInterval=sNTPPollInterval, wirelessLinkStatus=wirelessLinkStatus, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogClientTrap=syslogClientTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, encryptionAlgorithm=encryptionAlgorithm, vLANManagementPriority=vLANManagementPriority, managementGroup=managementGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, transmitDataRate=transmitDataRate, linkName=linkName, receiveFreqMHz=receiveFreqMHz, sNTPServerPortNumber=sNTPServerPortNumber, userRole=userRole, userPassword=userPassword, vLANPriorityTableIndex=vLANPriorityTableIndex, capacityLicenseMismatch=capacityLicenseMismatch, searchState=searchState, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, telecomsCableLength=telecomsCableLength, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, accessMethod=accessMethod, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortAutoNegotiation=dataPortAutoNegotiation, sntpGroup=sntpGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, pubStatsGroup=pubStatsGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapTableIndex=sNMPTrapTableIndex, cableLoss=cableLoss, syslogClient=syslogClient, sNTPSync=sNTPSync, syslogControlGroup=syslogControlGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sMTPSourceEmailAddress=sMTPSourceEmailAddress, hTTPSPortNumber=hTTPSPortNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, frequencyVariant=frequencyVariant, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ptp500=ptp500)
