...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sntp=sntp, vLANPriorityTableNumber=vLANPriorityTableNumber, linkLoss=linkLoss, searchState=searchState, telecomsLoopback=telecomsLoopback, capacityLicenseMismatch=capacityLicenseMismatch, syslogClientTrap=syslogClientTrap, bandwidthVariant=bandwidthVariant, syslogControlGroup=syslogControlGroup, siteName=siteName, aAAControl=aAAControl, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dfsMeans=dfsMeans, userEnabled=userEnabled, syslogClient=syslogClient, syslogControl=syslogControl, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptpCompliance=ptpCompliance, antennaGain=antennaGain, management=management, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, encryptionGroup=encryptionGroup, subnetMask=subnetMask, vLANPriorityQueueMapping=vLANPriorityQueueMapping, tDDSynchronizationAlarm=tDDSynchronizationAlarm, eIRP=eIRP, secondarySoftwareVersion=secondarySoftwareVersion, ethernetFiberSupport=ethernetFiberSupport, phyControl=phyControl, sNMPCommunityString=sNMPCommunityString, ethernetGroup=ethernetGroup, sNTPPollInterval=sNTPPollInterval, managementGroup=managementGroup, configuration=configuration, hTTPSAccessEnabled=hTTPSAccessEnabled, dfsTableNumber=dfsTableNumber, dataPortConfigurationMismatch=dataPortConfigurationMismatch, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, signalStrengthRatio=signalStrengthRatio, constantPowerSpectralDensity=constantPowerSpectralDensity, sMTPEnabledMessages=sMTPEnabledMessages, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, incompatibleRegionCodes=incompatibleRegionCodes, unitOutOfCalibration=unitOutOfCalibration, maximumTransmitPower=maximumTransmitPower, bootVersion=bootVersion, linkSymmetry=linkSymmetry, latitude=latitude, softwareVersion=softwareVersion, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sMTPEmailAlert=sMTPEmailAlert, sNTPServerPortNumber=sNTPServerPortNumber, hTTPPortNumber=hTTPPortNumber, sNTPSync=sNTPSync, ptpTraps=ptpTraps, installArmStateTrap=installArmStateTrap, resetGroup=resetGroup, supplementaryGroup=supplementaryGroup, wirelessLinkStatus=wirelessLinkStatus, reset=reset, cableLoss=cableLoss, wirelessLinkAvailability=wirelessLinkAvailability, range=range, frequencyVariant=frequencyVariant, tDDSynchronizationStatus=tDDSynchronizationStatus, supplementary=supplementary, licenceGroup=licenceGroup, ethernet=ethernet, smtpGroup=smtpGroup, remoteIPAddress=remoteIPAddress, regionCode=regionCode, versionsGroup=versionsGroup, hTTPAccessEnabled=hTTPAccessEnabled, transmitPower=transmitPower, noWirelessChannelAvailable=noWirelessChannelAvailable, encryptionAlgorithm=encryptionAlgorithm, dataPortStatusTrap=dataPortStatusTrap, snmpControlGroup=snmpControlGroup, smtp=smtp, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPLastSync=sNTPLastSync, phyStatus=phyStatus, encryption=encryption, installStatus=installStatus, notificationsGroup=notificationsGroup, groupID=groupID, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dfs=dfs, sNMPEnabledTraps=sNMPEnabledTraps, receiveModulationModeDetail=receiveModulationModeDetail, vLANManagementVID=vLANManagementVID, aAAControlGroup=aAAControlGroup, aggregateDataRate=aggregateDataRate, tDDControl=tDDControl, accessMethod=accessMethod, phyStatusGroup=phyStatusGroup, vectorError=vectorError, systemReset=systemReset, licensedCapacity=licensedCapacity, syslogState=syslogState, telecomsInterface=telecomsInterface, sNMPTrapTable=sNMPTrapTable, userTableNumber=userTableNumber, sNTPSyncTrap=sNTPSyncTrap, sNMPv3Enable=sNMPv3Enable, snmpControl=snmpControl, sNTPServerIPAddress=sNTPServerIPAddress, ptpTrapPrefix=ptpTrapPrefix, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitDataRate=transmitDataRate, transmitModulationMode=transmitModulationMode, linkModeOptimisation=linkModeOptimisation, gatewayIPAddress=gatewayIPAddress, pubStats=pubStats, receiveChannel=receiveChannel, userName=userName, userTableIndex=userTableIndex, receiveDataRate=receiveDataRate, tDDSynchronizationMode=tDDSynchronizationMode, dfsTableIndex=dfsTableIndex, channelBandwidth=channelBandwidth, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, systemClock=systemClock, userPassword=userPassword, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, byteErrorRatio=byteErrorRatio, vLANPriorityTable=vLANPriorityTable, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, productVariant=productVariant, sNTPState=sNTPState, receiveModulationMode=receiveModulationMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, telecomsLoopbackTrap=telecomsLoopbackTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, telecom=telecom, telecomsCableLength=telecomsCableLength, telnetPortNumber=telnetPortNumber, dataPortStatus=dataPortStatus, telnetAccessEnabled=telnetAccessEnabled, dfsPeaks=dfsPeaks, phyControlGroup=phyControlGroup, tFTPServerPortNumber=tFTPServerPortNumber, vLANManagementPriority=vLANManagementPriority, userRole=userRole, telecomsChannelStatusTrap=telecomsChannelStatusTrap, ptp=ptp, productName=productName, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptp500=ptp500, userTableEntry=userTableEntry, sMTPServerPortNumber=sMTPServerPortNumber, versions=versions, linkName=linkName, dfsGroup=dfsGroup, receivePower=receivePower, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, timeZone=timeZone, hardwareVersion=hardwareVersion, altitude=altitude, channelChangeTrap=channelChangeTrap, ptmp=ptmp, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPPortNumber=sNMPPortNumber, regionCodeTrap=regionCodeTrap, dfsTableEntry=dfsTableEntry, iPAddress=iPAddress, vLANPriorityTableEntry=vLANPriorityTableEntry, configurationGroup=configurationGroup, alarmsGroup=alarmsGroup, userTable=userTable, transmitFreqKHz=transmitFreqKHz, alarms=alarms, targetMACAddress=targetMACAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, telecomsLineCode=telecomsLineCode, tFTPServerIPAddress=tFTPServerIPAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dataPortDisabledWarning=dataPortDisabledWarning, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, vLANPriorityTableIndex=vLANPriorityTableIndex, sMTPServerIPAddress=sMTPServerIPAddress, receiveFreqMHz=receiveFreqMHz, syslogStateTrap=syslogStateTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, transmitChannel=transmitChannel, sNMPTrapTableEntry=sNMPTrapTableEntry, cambium=cambium, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, longitude=longitude, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, transmitFreqMHz=transmitFreqMHz, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, masterSlaveMode=masterSlaveMode, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tDDControlGroup=tDDControlGroup, receiveFreqKHz=receiveFreqKHz, dataPortAutoMdix=dataPortAutoMdix, telecomGroup=telecomGroup, PYSNMP_MODULE_ID=cambium, hTTPSPortNumber=hTTPSPortNumber, licence=licence, dataPortWirelessDownAlert=dataPortWirelessDownAlert, pubStatsGroup=pubStatsGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ptpGroups=ptpGroups, dfsTable=dfsTable, installArmState=installArmState, daylightSaving=daylightSaving, installStatusTrap=installStatusTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sntpGroup=sntpGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, telecomsChannelStatus=telecomsChannelStatus)
