...
# Produced by pysmi-1.1.3 at Wed Dec  8 20:12:08 2021
...
ObjectIdentity, Gauge32, IpAddress, Bits, Integer32, Counter64, MibIdentifier, TimeTicks, Counter32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ModuleIdentity, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Gauge32", "IpAddress", "Bits", "Integer32", "Counter64", "MibIdentifier", "TimeTicks", "Counter32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ModuleIdentity", "NotificationType", "iso")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", telecom=telecom, regionCodeTrap=regionCodeTrap, tDDControlGroup=tDDControlGroup, systemReset=systemReset, cambium=cambium, hTTPSPortNumber=hTTPSPortNumber, subnetMask=subnetMask, dataPortAutoMdix=dataPortAutoMdix, sNTPServerPortNumber=sNTPServerPortNumber, alarms=alarms, sMTPServerPortNumber=sMTPServerPortNumber, ptmp=ptmp, remoteIPAddress=remoteIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ptpGroups=ptpGroups, ethernetFiberSupport=ethernetFiberSupport, remoteMaximumTransmitPower=remoteMaximumTransmitPower, channelChangeTrap=channelChangeTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, longitude=longitude, dfsTableNumber=dfsTableNumber, linkSymmetry=linkSymmetry, sNTPPollInterval=sNTPPollInterval, licensedCapacity=licensedCapacity, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, licenceGroup=licenceGroup, transmitChannel=transmitChannel, licence=licence, aggregateDataRate=aggregateDataRate, enabledDiagnosticAlarms=enabledDiagnosticAlarms, useVLANForManagementInterfaces=useVLANForManagementInterfaces, telecomsChannelStatusTrap=telecomsChannelStatusTrap, managementGroup=managementGroup, dfsTableEntry=dfsTableEntry, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, vLANManagementPriority=vLANManagementPriority, capacityLicenseMismatch=capacityLicenseMismatch, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, telecomsLoopback=telecomsLoopback, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, eIRP=eIRP, ptpTrapPrefix=ptpTrapPrefix, vLANPriorityTableIndex=vLANPriorityTableIndex, dataPortStatus=dataPortStatus, softwareVersion=softwareVersion, linkName=linkName, sNTPServerIPAddress=sNTPServerIPAddress, sNMPPortNumber=sNMPPortNumber, dfs=dfs, linkModeOptimizationMismatch=linkModeOptimizationMismatch, frequencyVariant=frequencyVariant, phyControl=phyControl, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, sMTPEnabledMessages=sMTPEnabledMessages, sntp=sntp, vLANPriorityQueueMapping=vLANPriorityQueueMapping, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userTableNumber=userTableNumber, accessMethod=accessMethod, ptp=ptp, sNTPState=sNTPState, receivePower=receivePower, telecomsChannelStatus=telecomsChannelStatus, constantPowerSpectralDensity=constantPowerSpectralDensity, supplementaryGroup=supplementaryGroup, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, encryption=encryption, sNMPTrapPortNumber=sNMPTrapPortNumber, phyControlGroup=phyControlGroup, hTTPAccessEnabled=hTTPAccessEnabled, ptpCompliance=ptpCompliance, aAAControlGroup=aAAControlGroup, phyStatus=phyStatus, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, cableLoss=cableLoss, dataPortDisabledWarning=dataPortDisabledWarning, sNMPCommunityString=sNMPCommunityString, secondarySoftwareVersion=secondarySoftwareVersion, telecomsInterface=telecomsInterface, productName=productName, signalStrengthRatio=signalStrengthRatio, userRole=userRole, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, phyStatusGroup=phyStatusGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, userEnabled=userEnabled, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, smtp=smtp, vLANPriorityTableNumber=vLANPriorityTableNumber, sNMPTrapTable=sNMPTrapTable, dataPortConfigurationMismatch=dataPortConfigurationMismatch, encryptionAlgorithm=encryptionAlgorithm, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, smtpGroup=smtpGroup, versions=versions, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, noWirelessChannelAvailable=noWirelessChannelAvailable, unitOutOfCalibration=unitOutOfCalibration, antennaGain=antennaGain, ptpTraps=ptpTraps, incompatibleRegionCodes=incompatibleRegionCodes, groupID=groupID, sNMPTrapTableEntry=sNMPTrapTableEntry, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tDDSynchronizationMode=tDDSynchronizationMode, syslogControl=syslogControl, userTableIndex=userTableIndex, syslogState=syslogState, transmitPower=transmitPower, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, userTableEntry=userTableEntry, reset=reset, masterSlaveMode=masterSlaveMode, telecomsCableLength=telecomsCableLength, siteName=siteName, tFTPServerIPAddress=tFTPServerIPAddress, range=range, tDDSynchronizationStatus=tDDSynchronizationStatus, installStatusTrap=installStatusTrap, hardwareVersion=hardwareVersion, transmitDataRate=transmitDataRate, transmitFreqMHz=transmitFreqMHz, telecomGroup=telecomGroup, daylightSaving=daylightSaving, dataPortWirelessDownAlert=dataPortWirelessDownAlert, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dfsGroup=dfsGroup, channelBandwidth=channelBandwidth, encryptionGroup=encryptionGroup, maximumTransmitPower=maximumTransmitPower, sMTPEmailAlert=sMTPEmailAlert, targetMACAddress=targetMACAddress, vLANManagementVID=vLANManagementVID, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, receiveDataRate=receiveDataRate, receiveModulationModeDetail=receiveModulationModeDetail, byteErrorRatio=byteErrorRatio, gatewayIPAddress=gatewayIPAddress, ethernet=ethernet, latitude=latitude, vectorError=vectorError, sNTPLastSync=sNTPLastSync, aAAControl=aAAControl, userTable=userTable, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, transmitFreqKHz=transmitFreqKHz, snmpControl=snmpControl, alarmsGroup=alarmsGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, iPAddress=iPAddress, linkLoss=linkLoss, wirelessLinkStatus=wirelessLinkStatus, snmpControlGroup=snmpControlGroup, altitude=altitude, pubStatsGroup=pubStatsGroup, hTTPPortNumber=hTTPPortNumber, tDDControl=tDDControl, userName=userName, supplementary=supplementary, dfsTableIndex=dfsTableIndex, receiveModulationMode=receiveModulationMode, configurationGroup=configurationGroup, ethernetGroup=ethernetGroup, userPassword=userPassword, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, receiveFreqMHz=receiveFreqMHz, resetGroup=resetGroup, sNTPSyncTrap=sNTPSyncTrap, configuration=configuration, dataPortStatusTrap=dataPortStatusTrap, telecomsLineCode=telecomsLineCode, sntpGroup=sntpGroup, versionsGroup=versionsGroup, notificationsGroup=notificationsGroup, management=management, syslogControlGroup=syslogControlGroup, receiveFreqKHz=receiveFreqKHz, sNMPEnabledTraps=sNMPEnabledTraps, tFTPServerPortNumber=tFTPServerPortNumber, wirelessLinkAvailability=wirelessLinkAvailability, sNMPv3Enable=sNMPv3Enable, installArmStateTrap=installArmStateTrap, transmitModulationMode=transmitModulationMode, pubStats=pubStats, PYSNMP_MODULE_ID=cambium, dfsTable=dfsTable, syslogStateTrap=syslogStateTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, regionCode=regionCode, dataPortAutoNegotiation=dataPortAutoNegotiation, systemClock=systemClock, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapVersion=sNMPTrapVersion, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, vLANPriorityTable=vLANPriorityTable, bootVersion=bootVersion, dfsMeans=dfsMeans, dfsPeaks=dfsPeaks, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, telnetPortNumber=telnetPortNumber, bandwidthVariant=bandwidthVariant, syslogClientTrap=syslogClientTrap, installArmState=installArmState, syslogClient=syslogClient, vLANPriorityTableEntry=vLANPriorityTableEntry, sNTPSync=sNTPSync, telnetAccessEnabled=telnetAccessEnabled, ptp500=ptp500, receiveChannel=receiveChannel, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, productVariant=productVariant, timeZone=timeZone, installStatus=installStatus, linkModeOptimisation=linkModeOptimisation, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, searchState=searchState)
