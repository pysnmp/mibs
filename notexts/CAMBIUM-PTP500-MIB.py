...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", constantPowerSpectralDensity=constantPowerSpectralDensity, ptpCompliance=ptpCompliance, dfs=dfs, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, alarmsGroup=alarmsGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, pubStats=pubStats, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, wirelessLinkStatus=wirelessLinkStatus, transmitFreqMHz=transmitFreqMHz, telnetAccessEnabled=telnetAccessEnabled, ethernetFiberSupport=ethernetFiberSupport, systemReset=systemReset, alarms=alarms, ptpTrapPrefix=ptpTrapPrefix, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, linkName=linkName, sMTPEnabledMessages=sMTPEnabledMessages, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, wirelessLinkAvailability=wirelessLinkAvailability, vLANManagementVID=vLANManagementVID, dfsTableNumber=dfsTableNumber, eIRP=eIRP, dataPortStatus=dataPortStatus, transmitModulationMode=transmitModulationMode, syslogControlGroup=syslogControlGroup, ptp=ptp, dfsTable=dfsTable, syslogState=syslogState, licensedCapacity=licensedCapacity, transmitChannel=transmitChannel, sMTPServerIPAddress=sMTPServerIPAddress, tDDControlGroup=tDDControlGroup, sNMPTrapTable=sNMPTrapTable, reset=reset, smtp=smtp, cableLoss=cableLoss, subnetMask=subnetMask, vLANPriorityTableIndex=vLANPriorityTableIndex, bandwidthVariant=bandwidthVariant, hTTPSPortNumber=hTTPSPortNumber, sNTPSyncTrap=sNTPSyncTrap, vLANPriorityQueueMapping=vLANPriorityQueueMapping, telecomsCableLength=telecomsCableLength, transmitFreqKHz=transmitFreqKHz, supplementary=supplementary, enabledDiagnosticAlarms=enabledDiagnosticAlarms, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, frequencyVariant=frequencyVariant, siteName=siteName, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapPortNumber=sNMPTrapPortNumber, signalStrengthRatio=signalStrengthRatio, userEnabled=userEnabled, telecomsChannelStatusTrap=telecomsChannelStatusTrap, configurationGroup=configurationGroup, productName=productName, snmpControl=snmpControl, syslogClient=syslogClient, ethernetGroup=ethernetGroup, userRole=userRole, installStatusTrap=installStatusTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, userName=userName, telecomsInterface=telecomsInterface, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ptp500=ptp500, range=range, sNMPPortNumber=sNMPPortNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, installArmState=installArmState, dfsTableIndex=dfsTableIndex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNTPState=sNTPState, phyControl=phyControl, userTableEntry=userTableEntry, receivePower=receivePower, transmitPower=transmitPower, regionCode=regionCode, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsTableEntry=dfsTableEntry, transmitDataRate=transmitDataRate, receiveDataRate=receiveDataRate, versions=versions, targetMACAddress=targetMACAddress, sNTPSync=sNTPSync, dataPortDisabledWarning=dataPortDisabledWarning, antennaGain=antennaGain, receiveChannel=receiveChannel, hTTPPortNumber=hTTPPortNumber, sntpGroup=sntpGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, masterSlaveMode=masterSlaveMode, linkModeOptimisation=linkModeOptimisation, systemClock=systemClock, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ethernet=ethernet, supplementaryGroup=supplementaryGroup, installStatus=installStatus, bootVersion=bootVersion, licenceGroup=licenceGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, telecom=telecom, aAAControl=aAAControl, ptpTraps=ptpTraps, dfsMeans=dfsMeans, dataPortAutoMdix=dataPortAutoMdix, telecomsLoopback=telecomsLoopback, sMTPServerPortNumber=sMTPServerPortNumber, sNTPPollInterval=sNTPPollInterval, encryptionAlgorithm=encryptionAlgorithm, encryptionGroup=encryptionGroup, dfsPeaks=dfsPeaks, maximumTransmitPower=maximumTransmitPower, accessMethod=accessMethod, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, latitude=latitude, installArmStateTrap=installArmStateTrap, receiveFreqMHz=receiveFreqMHz, dataPortConfigurationMismatch=dataPortConfigurationMismatch, linkLoss=linkLoss, sNTPServerIPAddress=sNTPServerIPAddress, tDDSynchronizationMode=tDDSynchronizationMode, syslogClientTrap=syslogClientTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, managementGroup=managementGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPEnabledTraps=sNMPEnabledTraps, licence=licence, hTTPSAccessEnabled=hTTPSAccessEnabled, hardwareVersion=hardwareVersion, dataPortStatusTrap=dataPortStatusTrap, groupID=groupID, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPServerPortNumber=tFTPServerPortNumber, receiveModulationMode=receiveModulationMode, telecomsLineCode=telecomsLineCode, unitOutOfCalibration=unitOutOfCalibration, sNMPv3Enable=sNMPv3Enable, userTable=userTable, dfsGroup=dfsGroup, hTTPAccessEnabled=hTTPAccessEnabled, productVariant=productVariant, userTableNumber=userTableNumber, phyControlGroup=phyControlGroup, vectorError=vectorError, sMTPEmailAlert=sMTPEmailAlert, sNTPLastSync=sNTPLastSync, telecomsLoopbackTrap=telecomsLoopbackTrap, daylightSaving=daylightSaving, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, gatewayIPAddress=gatewayIPAddress, userPassword=userPassword, telnetPortNumber=telnetPortNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, aAAControlGroup=aAAControlGroup, configuration=configuration, ptmp=ptmp, sntp=sntp, aggregateDataRate=aggregateDataRate, management=management, phyStatusGroup=phyStatusGroup, byteErrorRatio=byteErrorRatio, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, searchState=searchState, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, remoteIPAddress=remoteIPAddress, sNMPTrapVersion=sNMPTrapVersion, vLANPriorityTableNumber=vLANPriorityTableNumber, receiveModulationModeDetail=receiveModulationModeDetail, softwareVersion=softwareVersion, regionCodeTrap=regionCodeTrap, pubStatsGroup=pubStatsGroup, linkSymmetry=linkSymmetry, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tDDControl=tDDControl, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, syslogStateTrap=syslogStateTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, telecomsChannelStatus=telecomsChannelStatus, timeZone=timeZone, smtpGroup=smtpGroup, capacityLicenseMismatch=capacityLicenseMismatch, sNMPCommunityString=sNMPCommunityString, receiveFreqKHz=receiveFreqKHz, sNMPTrapTableNumber=sNMPTrapTableNumber, channelChangeTrap=channelChangeTrap, vLANPriorityTable=vLANPriorityTable, noWirelessChannelAvailable=noWirelessChannelAvailable, altitude=altitude, snmpControlGroup=snmpControlGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ptpGroups=ptpGroups, telecomGroup=telecomGroup, phyStatus=phyStatus, notificationsGroup=notificationsGroup, longitude=longitude, cambium=cambium, userTableIndex=userTableIndex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, incompatibleRegionCodes=incompatibleRegionCodes, secondarySoftwareVersion=secondarySoftwareVersion, versionsGroup=versionsGroup, channelBandwidth=channelBandwidth, PYSNMP_MODULE_ID=cambium, resetGroup=resetGroup, tFTPServerIPAddress=tFTPServerIPAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, iPAddress=iPAddress, sNTPServerPortNumber=sNTPServerPortNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, encryption=encryption, vLANManagementPriority=vLANManagementPriority, syslogControl=syslogControl)
