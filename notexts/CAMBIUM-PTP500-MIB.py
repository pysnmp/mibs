...
NotificationType, ObjectIdentity, Bits, TimeTicks, iso, IpAddress, Counter32, Unsigned32, MibIdentifier, enterprises, Integer32, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "Bits", "TimeTicks", "iso", "IpAddress", "Counter32", "Unsigned32", "MibIdentifier", "enterprises", "Integer32", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", userTable=userTable, resetGroup=resetGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, daylightSaving=daylightSaving, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dfsTableIndex=dfsTableIndex, accessMethod=accessMethod, sMTPEnabledMessages=sMTPEnabledMessages, userTableEntry=userTableEntry, sMTPServerPortNumber=sMTPServerPortNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, antennaGain=antennaGain, telecomsChannelStatusTrap=telecomsChannelStatusTrap, softwareVersion=softwareVersion, useVLANForManagementInterfaces=useVLANForManagementInterfaces, telnetPortNumber=telnetPortNumber, userPassword=userPassword, installArmStateTrap=installArmStateTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, telecom=telecom, encryption=encryption, vLANPriorityTableNumber=vLANPriorityTableNumber, tDDSynchronizationMode=tDDSynchronizationMode, sNTPSync=sNTPSync, userTableNumber=userTableNumber, linkModeOptimisation=linkModeOptimisation, sNMPTrapTable=sNMPTrapTable, linkSymmetry=linkSymmetry, gatewayIPAddress=gatewayIPAddress, smtp=smtp, sNTPServerIPAddress=sNTPServerIPAddress, systemReset=systemReset, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, aAAControl=aAAControl, regionCode=regionCode, latitude=latitude, vLANManagementVID=vLANManagementVID, supplementary=supplementary, phyControlGroup=phyControlGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, aAAControlGroup=aAAControlGroup, wirelessLinkAvailability=wirelessLinkAvailability, ptpTrapPrefix=ptpTrapPrefix, userEnabled=userEnabled, vLANPriorityTableEntry=vLANPriorityTableEntry, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, receiveModulationMode=receiveModulationMode, smtpGroup=smtpGroup, tFTPServerIPAddress=tFTPServerIPAddress, syslogState=syslogState, receiveFreqKHz=receiveFreqKHz, sntp=sntp, targetMACAddress=targetMACAddress, licence=licence, ethernetFiberSupport=ethernetFiberSupport, dataPortAutoNegotiation=dataPortAutoNegotiation, telecomsCableLength=telecomsCableLength, ethernetGroup=ethernetGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, telecomsInterface=telecomsInterface, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sntpGroup=sntpGroup, syslogClientTrap=syslogClientTrap, systemClock=systemClock, iPAddress=iPAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, alarmsGroup=alarmsGroup, alarms=alarms, sNMPPortNumber=sNMPPortNumber, tDDControl=tDDControl, hTTPSAccessEnabled=hTTPSAccessEnabled, enabledDiagnosticAlarms=enabledDiagnosticAlarms, reset=reset, configuration=configuration, dataPortConfigurationMismatch=dataPortConfigurationMismatch, transmitFreqMHz=transmitFreqMHz, encryptionGroup=encryptionGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, linkModeOptimizationMismatch=linkModeOptimizationMismatch, syslogControlGroup=syslogControlGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receiveChannel=receiveChannel, dfsGroup=dfsGroup, syslogStateTrap=syslogStateTrap, syslogControl=syslogControl, installArmState=installArmState, telecomsLineCode=telecomsLineCode, dataPortWirelessDownAlert=dataPortWirelessDownAlert, maximumTransmitPower=maximumTransmitPower, sNMPTrapIPAddress=sNMPTrapIPAddress, telecomGroup=telecomGroup, snmpControl=snmpControl, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dfsPeaks=dfsPeaks, sMTPEmailAlert=sMTPEmailAlert, cambium=cambium, sMTPServerIPAddress=sMTPServerIPAddress, supplementaryGroup=supplementaryGroup, productName=productName, notificationsGroup=notificationsGroup, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, phyStatusGroup=phyStatusGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, altitude=altitude, vectorError=vectorError, telecomsLoopbackTrap=telecomsLoopbackTrap, pubStatsGroup=pubStatsGroup, sNTPServerPortNumber=sNTPServerPortNumber, ptpCompliance=ptpCompliance, frequencyVariant=frequencyVariant, sNMPTrapVersion=sNMPTrapVersion, ptpGroups=ptpGroups, transmitChannel=transmitChannel, telecomsLoopback=telecomsLoopback, channelBandwidth=channelBandwidth, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, hTTPPortNumber=hTTPPortNumber, bootVersion=bootVersion, userName=userName, versionsGroup=versionsGroup, masterSlaveMode=masterSlaveMode, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, managementGroup=managementGroup, dfsTableNumber=dfsTableNumber, userTableIndex=userTableIndex, installStatusTrap=installStatusTrap, range=range, sNMPEnabledTraps=sNMPEnabledTraps, dataPortStatus=dataPortStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, groupID=groupID, vLANPriorityTableIndex=vLANPriorityTableIndex, bandwidthVariant=bandwidthVariant, transmitFreqKHz=transmitFreqKHz, capacityLicenseMismatch=capacityLicenseMismatch, hTTPSPortNumber=hTTPSPortNumber, remoteIPAddress=remoteIPAddress, incompatibleRegionCodes=incompatibleRegionCodes, sMTPSourceEmailAddress=sMTPSourceEmailAddress, signalStrengthRatio=signalStrengthRatio, syslogClient=syslogClient, sNTPSyncTrap=sNTPSyncTrap, receiveFreqMHz=receiveFreqMHz, cableLoss=cableLoss, receiveDataRate=receiveDataRate, vLANManagementPriority=vLANManagementPriority, linkName=linkName, timeZone=timeZone, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ethernet=ethernet, sNTPState=sNTPState, tDDControlGroup=tDDControlGroup, receivePower=receivePower, incompatibleMasterAndSlave=incompatibleMasterAndSlave, encryptionAlgorithm=encryptionAlgorithm, configurationGroup=configurationGroup, licenceGroup=licenceGroup, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, phyStatus=phyStatus, sNTPLastSync=sNTPLastSync, sNMPCommunityString=sNMPCommunityString, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitDataRate=transmitDataRate, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, pubStats=pubStats, telnetAccessEnabled=telnetAccessEnabled, dataPortDisabledWarning=dataPortDisabledWarning, secondarySoftwareVersion=secondarySoftwareVersion, vLANPriorityTable=vLANPriorityTable, licensedCapacity=licensedCapacity, dfsMeans=dfsMeans, sNTPPollInterval=sNTPPollInterval, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, unitOutOfCalibration=unitOutOfCalibration, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, management=management, dfs=dfs, tDDSynchronizationStatus=tDDSynchronizationStatus, dfsTable=dfsTable, dataPortStatusTrap=dataPortStatusTrap, dataPortAutoMdix=dataPortAutoMdix, eIRP=eIRP, searchState=searchState, PYSNMP_MODULE_ID=cambium, transmitPower=transmitPower, regionCodeTrap=regionCodeTrap, dfsTableEntry=dfsTableEntry, sNMPv3Enable=sNMPv3Enable, siteName=siteName, ptpTraps=ptpTraps, aggregateDataRate=aggregateDataRate, versions=versions, transmitModulationMode=transmitModulationMode, longitude=longitude, subnetMask=subnetMask, phyControl=phyControl, channelChangeTrap=channelChangeTrap, wirelessLinkStatus=wirelessLinkStatus, snmpControlGroup=snmpControlGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, productVariant=productVariant, telecomsChannelStatus=telecomsChannelStatus, installStatus=installStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, linkLoss=linkLoss, hardwareVersion=hardwareVersion, receiveModulationModeDetail=receiveModulationModeDetail, byteErrorRatio=byteErrorRatio, userRole=userRole, ptp500=ptp500, ptmp=ptmp, ptp=ptp, hTTPAccessEnabled=hTTPAccessEnabled, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex)
