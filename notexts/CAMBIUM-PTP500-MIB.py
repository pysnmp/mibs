...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", snmpControl=snmpControl, sMTPServerPortNumber=sMTPServerPortNumber, pubStatsGroup=pubStatsGroup, softwareVersion=softwareVersion, sntpGroup=sntpGroup, productName=productName, subnetMask=subnetMask, notificationsGroup=notificationsGroup, syslogStateTrap=syslogStateTrap, transmitModulationMode=transmitModulationMode, groupID=groupID, range=range, licence=licence, sNTPServerIPAddress=sNTPServerIPAddress, vLANManagementVID=vLANManagementVID, telecomsLoopback=telecomsLoopback, searchState=searchState, telecomsInterface=telecomsInterface, telecomGroup=telecomGroup, telecomsCableLength=telecomsCableLength, frequencyVariant=frequencyVariant, userName=userName, userTable=userTable, ethernetFiberSupport=ethernetFiberSupport, ptmp=ptmp, hTTPPortNumber=hTTPPortNumber, userTableIndex=userTableIndex, receiveModulationMode=receiveModulationMode, systemReset=systemReset, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dfs=dfs, licenceGroup=licenceGroup, smtpGroup=smtpGroup, sNTPLastSync=sNTPLastSync, ptpTrapPrefix=ptpTrapPrefix, gatewayIPAddress=gatewayIPAddress, transmitFreqMHz=transmitFreqMHz, linkModeOptimizationMismatch=linkModeOptimizationMismatch, linkModeOptimisation=linkModeOptimisation, telnetPortNumber=telnetPortNumber, licensedCapacity=licensedCapacity, linkName=linkName, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, resetGroup=resetGroup, dfsTable=dfsTable, sNTPSyncTrap=sNTPSyncTrap, installArmStateTrap=installArmStateTrap, pubStats=pubStats, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, encryption=encryption, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitChannel=transmitChannel, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, wirelessLinkAvailability=wirelessLinkAvailability, unitOutOfCalibration=unitOutOfCalibration, transmitPower=transmitPower, syslogLocalWrappedTrap=syslogLocalWrappedTrap, alarms=alarms, vLANPriorityTableNumber=vLANPriorityTableNumber, systemClock=systemClock, sNMPCommunityString=sNMPCommunityString, sNMPTrapIPAddress=sNMPTrapIPAddress, syslogControl=syslogControl, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, byteErrorRatio=byteErrorRatio, useVLANForManagementInterfaces=useVLANForManagementInterfaces, telecomsChannelStatus=telecomsChannelStatus, PYSNMP_MODULE_ID=cambium, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dfsTableNumber=dfsTableNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, phyStatusGroup=phyStatusGroup, dataPortAutoMdix=dataPortAutoMdix, tFTPServerPortNumber=tFTPServerPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, supplementaryGroup=supplementaryGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, incompatibleRegionCodes=incompatibleRegionCodes, aggregateDataRate=aggregateDataRate, sNMPTrapTable=sNMPTrapTable, telecomsLoopbackTrap=telecomsLoopbackTrap, dfsMeans=dfsMeans, linkSymmetry=linkSymmetry, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, smtp=smtp, versionsGroup=versionsGroup, userTableNumber=userTableNumber, ethernetGroup=ethernetGroup, versions=versions, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNMPEnabledTraps=sNMPEnabledTraps, remoteIPAddress=remoteIPAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ethernet=ethernet, reset=reset, constantPowerSpectralDensity=constantPowerSpectralDensity, productVariant=productVariant, userTableEntry=userTableEntry, tDDControlGroup=tDDControlGroup, dfsPeaks=dfsPeaks, siteName=siteName, receiveFreqKHz=receiveFreqKHz, syslogState=syslogState, sNTPState=sNTPState, vectorError=vectorError, sMTPEnabledMessages=sMTPEnabledMessages, accessMethod=accessMethod, hardwareVersion=hardwareVersion, configuration=configuration, sNMPv3Enable=sNMPv3Enable, tDDSynchronizationAlarm=tDDSynchronizationAlarm, channelBandwidth=channelBandwidth, installArmState=installArmState, transmitFreqKHz=transmitFreqKHz, sMTPServerIPAddress=sMTPServerIPAddress, latitude=latitude, userRole=userRole, antennaGain=antennaGain, targetMACAddress=targetMACAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, wirelessLinkStatus=wirelessLinkStatus, aAAControlGroup=aAAControlGroup, bootVersion=bootVersion, vLANPriorityTable=vLANPriorityTable, configurationGroup=configurationGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tDDSynchronizationMode=tDDSynchronizationMode, installStatus=installStatus, receiveModulationModeDetail=receiveModulationModeDetail, regionCode=regionCode, capacityLicenseMismatch=capacityLicenseMismatch, userPassword=userPassword, telecomsLineCode=telecomsLineCode, receiveChannel=receiveChannel, ptpTraps=ptpTraps, vLANPriorityTableEntry=vLANPriorityTableEntry, iPAddress=iPAddress, cambium=cambium, dfsGroup=dfsGroup, phyControl=phyControl, tDDControl=tDDControl, syslogClient=syslogClient, installStatusTrap=installStatusTrap, supplementary=supplementary, hTTPSAccessEnabled=hTTPSAccessEnabled, encryptionGroup=encryptionGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, userEnabled=userEnabled, sMTPEmailAlert=sMTPEmailAlert, transmitDataRate=transmitDataRate, ptp500=ptp500, vLANPriorityQueueMapping=vLANPriorityQueueMapping, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, masterSlaveMode=masterSlaveMode, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, timeZone=timeZone, telecom=telecom, secondarySoftwareVersion=secondarySoftwareVersion, eIRP=eIRP, linkLoss=linkLoss, altitude=altitude, encryptionAlgorithm=encryptionAlgorithm, dfsTableEntry=dfsTableEntry, maximumTransmitPower=maximumTransmitPower, aAAControl=aAAControl, receivePower=receivePower, receiveFreqMHz=receiveFreqMHz, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogClientTrap=syslogClientTrap, telnetAccessEnabled=telnetAccessEnabled, sNTPSync=sNTPSync, ptpGroups=ptpGroups, bandwidthVariant=bandwidthVariant, regionCodeTrap=regionCodeTrap, managementGroup=managementGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, snmpControlGroup=snmpControlGroup, ptp=ptp, sNTPServerPortNumber=sNTPServerPortNumber, dataPortStatusTrap=dataPortStatusTrap, receiveDataRate=receiveDataRate, channelChangeTrap=channelChangeTrap, tFTPServerIPAddress=tFTPServerIPAddress, phyControlGroup=phyControlGroup, daylightSaving=daylightSaving, sNTPPollInterval=sNTPPollInterval, alarmsGroup=alarmsGroup, signalStrengthRatio=signalStrengthRatio, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, phyStatus=phyStatus, hTTPAccessEnabled=hTTPAccessEnabled, sNMPTrapVersion=sNMPTrapVersion, dfsTableIndex=dfsTableIndex, sNMPPortNumber=sNMPPortNumber, hTTPSPortNumber=hTTPSPortNumber, cableLoss=cableLoss, vLANPriorityTableIndex=vLANPriorityTableIndex, longitude=longitude, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, management=management, sntp=sntp, sNMPTrapPortNumber=sNMPTrapPortNumber, telecomsChannelStatusTrap=telecomsChannelStatusTrap, syslogControlGroup=syslogControlGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortDisabledWarning=dataPortDisabledWarning, dataPortStatus=dataPortStatus, vLANManagementPriority=vLANManagementPriority, ptpCompliance=ptpCompliance, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPTrapTableIndex=sNMPTrapTableIndex)
