...
# Produced by pysmi-1.1.8 at Tue Jan 11 21:13:11 2022
...
MibIdentifier, Counter64, enterprises, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Unsigned32, ModuleIdentity, TimeTicks, Bits, Gauge32, IpAddress, iso, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter64", "enterprises", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Unsigned32", "ModuleIdentity", "TimeTicks", "Bits", "Gauge32", "IpAddress", "iso", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", phyStatus=phyStatus, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, systemReset=systemReset, hTTPAccessEnabled=hTTPAccessEnabled, linkName=linkName, smtpGroup=smtpGroup, userTable=userTable, phyStatusGroup=phyStatusGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, telecomsLineCode=telecomsLineCode, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, transmitModulationMode=transmitModulationMode, syslogState=syslogState, bootVersion=bootVersion, wirelessLinkStatus=wirelessLinkStatus, range=range, telecomsInterface=telecomsInterface, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, iPAddress=iPAddress, vLANPriorityTableIndex=vLANPriorityTableIndex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, wirelessLinkAvailability=wirelessLinkAvailability, hTTPPortNumber=hTTPPortNumber, installArmStateTrap=installArmStateTrap, sNTPServerPortNumber=sNTPServerPortNumber, userEnabled=userEnabled, aAAControl=aAAControl, supplementaryGroup=supplementaryGroup, dataPortAutoMdix=dataPortAutoMdix, tFTPServerPortNumber=tFTPServerPortNumber, aAAControlGroup=aAAControlGroup, dfsTableEntry=dfsTableEntry, eIRP=eIRP, versionsGroup=versionsGroup, cableLoss=cableLoss, linkSymmetry=linkSymmetry, sNTPSync=sNTPSync, sNTPLastSync=sNTPLastSync, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, hardwareVersion=hardwareVersion, sNTPSyncTrap=sNTPSyncTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, alarms=alarms, regionCodeTrap=regionCodeTrap, receiveFreqKHz=receiveFreqKHz, signalStrengthRatio=signalStrengthRatio, dataPortStatusTrap=dataPortStatusTrap, ptpCompliance=ptpCompliance, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, cambium=cambium, installArmState=installArmState, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, userRole=userRole, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, capacityLicenseMismatch=capacityLicenseMismatch, receiveModulationModeDetail=receiveModulationModeDetail, userPassword=userPassword, dfsTableIndex=dfsTableIndex, ptpTraps=ptpTraps, versions=versions, sNTPState=sNTPState, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tDDControl=tDDControl, hTTPSAccessEnabled=hTTPSAccessEnabled, userName=userName, accessMethod=accessMethod, siteName=siteName, resetGroup=resetGroup, receivePower=receivePower, telecom=telecom, sNMPPortNumber=sNMPPortNumber, remoteIPAddress=remoteIPAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, syslogClient=syslogClient, licenceGroup=licenceGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPEnabledMessages=sMTPEnabledMessages, longitude=longitude, productVariant=productVariant, dfsPeaks=dfsPeaks, sNMPTrapVersion=sNMPTrapVersion, supplementary=supplementary, sntpGroup=sntpGroup, dfsTableNumber=dfsTableNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, syslogControl=syslogControl, sNMPTrapTableEntry=sNMPTrapTableEntry, linkModeOptimizationMismatch=linkModeOptimizationMismatch, maximumTransmitPower=maximumTransmitPower, phyControlGroup=phyControlGroup, dataPortStatus=dataPortStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, pubStatsGroup=pubStatsGroup, installStatus=installStatus, vLANManagementPriority=vLANManagementPriority, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPTrapPortNumber=sNMPTrapPortNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tDDSynchronizationMode=tDDSynchronizationMode, userTableNumber=userTableNumber, syslogStateTrap=syslogStateTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dfsGroup=dfsGroup, telecomsCableLength=telecomsCableLength, sNTPServerIPAddress=sNTPServerIPAddress, pubStats=pubStats, groupID=groupID, vLANManagementVID=vLANManagementVID, sMTPServerPortNumber=sMTPServerPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, latitude=latitude, dataPortDisabledWarning=dataPortDisabledWarning, management=management, ptmp=ptmp, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPTrapTableNumber=sNMPTrapTableNumber, ethernet=ethernet, receiveChannel=receiveChannel, telnetPortNumber=telnetPortNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, userTableIndex=userTableIndex, transmitFreqKHz=transmitFreqKHz, vLANPriorityTableNumber=vLANPriorityTableNumber, dfsMeans=dfsMeans, ethernetGroup=ethernetGroup, receiveModulationMode=receiveModulationMode, tDDControlGroup=tDDControlGroup, notificationsGroup=notificationsGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, licensedCapacity=licensedCapacity, syslogClientTrap=syslogClientTrap, sMTPServerIPAddress=sMTPServerIPAddress, gatewayIPAddress=gatewayIPAddress, telnetAccessEnabled=telnetAccessEnabled, dfs=dfs, sntp=sntp, timeZone=timeZone, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, receiveFreqMHz=receiveFreqMHz, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, channelChangeTrap=channelChangeTrap, targetMACAddress=targetMACAddress, daylightSaving=daylightSaving, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, encryption=encryption, antennaGain=antennaGain, telecomsChannelStatus=telecomsChannelStatus, telecomGroup=telecomGroup, regionCode=regionCode, ethernetFiberSupport=ethernetFiberSupport, sMTPEmailAlert=sMTPEmailAlert, channelBandwidth=channelBandwidth, byteErrorRatio=byteErrorRatio, productName=productName, linkModeOptimisation=linkModeOptimisation, vLANPriorityTable=vLANPriorityTable, sNMPTrapIPAddress=sNMPTrapIPAddress, managementGroup=managementGroup, userTableEntry=userTableEntry, PYSNMP_MODULE_ID=cambium, bandwidthVariant=bandwidthVariant, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNMPv3Enable=sNMPv3Enable, syslogControlGroup=syslogControlGroup, configuration=configuration, transmitFreqMHz=transmitFreqMHz, subnetMask=subnetMask, smtp=smtp, systemClock=systemClock, dfsTable=dfsTable, alarmsGroup=alarmsGroup, snmpControlGroup=snmpControlGroup, aggregateDataRate=aggregateDataRate, telecomsChannelStatusTrap=telecomsChannelStatusTrap, linkLoss=linkLoss, phyControl=phyControl, constantPowerSpectralDensity=constantPowerSpectralDensity, sNMPCommunityString=sNMPCommunityString, tFTPServerIPAddress=tFTPServerIPAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, hTTPSPortNumber=hTTPSPortNumber, sNMPTrapTable=sNMPTrapTable, transmitPower=transmitPower, searchState=searchState, unitOutOfCalibration=unitOutOfCalibration, sNTPPollInterval=sNTPPollInterval, transmitDataRate=transmitDataRate, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptp=ptp, secondarySoftwareVersion=secondarySoftwareVersion, reset=reset, masterSlaveMode=masterSlaveMode, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, vectorError=vectorError, frequencyVariant=frequencyVariant, installStatusTrap=installStatusTrap, encryptionGroup=encryptionGroup, transmitChannel=transmitChannel, receiveDataRate=receiveDataRate, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ptpTrapPrefix=ptpTrapPrefix, encryptionAlgorithm=encryptionAlgorithm, ptp500=ptp500, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, snmpControl=snmpControl, vLANPriorityQueueMapping=vLANPriorityQueueMapping, licence=licence, telecomsLoopback=telecomsLoopback, incompatibleRegionCodes=incompatibleRegionCodes, configurationGroup=configurationGroup, softwareVersion=softwareVersion, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortConfigurationMismatch=dataPortConfigurationMismatch, ptpGroups=ptpGroups, altitude=altitude)
