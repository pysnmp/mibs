...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", hTTPSAccessEnabled=hTTPSAccessEnabled, telecomsLoopback=telecomsLoopback, transmitDataRate=transmitDataRate, installStatusTrap=installStatusTrap, hTTPSPortNumber=hTTPSPortNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, aAAControl=aAAControl, management=management, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, noWirelessChannelAvailable=noWirelessChannelAvailable, ptpGroups=ptpGroups, eIRP=eIRP, sNTPSync=sNTPSync, alarmsGroup=alarmsGroup, sNMPCommunityString=sNMPCommunityString, dataPortStatus=dataPortStatus, configurationGroup=configurationGroup, snmpControlGroup=snmpControlGroup, ethernet=ethernet, sNMPPortNumber=sNMPPortNumber, sntp=sntp, sntpGroup=sntpGroup, dfsTableEntry=dfsTableEntry, linkName=linkName, siteName=siteName, linkLoss=linkLoss, phyStatus=phyStatus, vLANManagementPriority=vLANManagementPriority, dfsGroup=dfsGroup, byteErrorRatio=byteErrorRatio, sNMPEnabledTraps=sNMPEnabledTraps, ethernetFiberSupport=ethernetFiberSupport, remoteIPAddress=remoteIPAddress, sNTPServerPortNumber=sNTPServerPortNumber, telecomsLoopbackTrap=telecomsLoopbackTrap, reset=reset, ethernetGroup=ethernetGroup, frequencyVariant=frequencyVariant, smtpGroup=smtpGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapVersion=sNMPTrapVersion, secondarySoftwareVersion=secondarySoftwareVersion, capacityLicenseMismatch=capacityLicenseMismatch, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, cableLoss=cableLoss, sNMPTrapPortNumber=sNMPTrapPortNumber, hTTPAccessEnabled=hTTPAccessEnabled, encryptionAlgorithm=encryptionAlgorithm, vectorError=vectorError, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, versions=versions, transmitPower=transmitPower, targetMACAddress=targetMACAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tFTPServerPortNumber=tFTPServerPortNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, searchState=searchState, constantPowerSpectralDensity=constantPowerSpectralDensity, hTTPPortNumber=hTTPPortNumber, dfs=dfs, softwareVersion=softwareVersion, receiveChannel=receiveChannel, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, linkSymmetry=linkSymmetry, longitude=longitude, userPassword=userPassword, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, transmitFreqKHz=transmitFreqKHz, pubStats=pubStats, wirelessLinkStatus=wirelessLinkStatus, telecomsChannelStatusTrap=telecomsChannelStatusTrap, productName=productName, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNTPServerIPAddress=sNTPServerIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, channelChangeTrap=channelChangeTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, aAAControlGroup=aAAControlGroup, versionsGroup=versionsGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, accessMethod=accessMethod, smtp=smtp, licensedCapacity=licensedCapacity, productVariant=productVariant, receiveFreqKHz=receiveFreqKHz, sMTPEmailAlert=sMTPEmailAlert, receiveModulationModeDetail=receiveModulationModeDetail, dataPortStatusTrap=dataPortStatusTrap, systemClock=systemClock, cambium=cambium, sNMPTrapTableIndex=sNMPTrapTableIndex, userName=userName, userRole=userRole, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, channelBandwidth=channelBandwidth, userTableNumber=userTableNumber, userTableEntry=userTableEntry, encryptionGroup=encryptionGroup, maximumTransmitPower=maximumTransmitPower, tDDSynchronizationStatus=tDDSynchronizationStatus, managementGroup=managementGroup, ptpTraps=ptpTraps, iPAddress=iPAddress, groupID=groupID, dfsMeans=dfsMeans, vLANPriorityTableNumber=vLANPriorityTableNumber, dataPortConfigurationMismatch=dataPortConfigurationMismatch, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sMTPEnabledMessages=sMTPEnabledMessages, wirelessLinkAvailability=wirelessLinkAvailability, licence=licence, sMTPServerPortNumber=sMTPServerPortNumber, bootVersion=bootVersion, transmitFreqMHz=transmitFreqMHz, userEnabled=userEnabled, gatewayIPAddress=gatewayIPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, telnetPortNumber=telnetPortNumber, telnetAccessEnabled=telnetAccessEnabled, userTableIndex=userTableIndex, tDDControlGroup=tDDControlGroup, ptpCompliance=ptpCompliance, linkModeOptimizationMismatch=linkModeOptimizationMismatch, resetGroup=resetGroup, dfsTableIndex=dfsTableIndex, telecomGroup=telecomGroup, systemReset=systemReset, dataPortAutoMdix=dataPortAutoMdix, encryption=encryption, licenceGroup=licenceGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, signalStrengthRatio=signalStrengthRatio, pubStatsGroup=pubStatsGroup, masterSlaveMode=masterSlaveMode, telecomsInterface=telecomsInterface, installStatus=installStatus, supplementary=supplementary, telecomsChannelStatus=telecomsChannelStatus, tFTPServerIPAddress=tFTPServerIPAddress, supplementaryGroup=supplementaryGroup, syslogState=syslogState, dataPortDisabledWarning=dataPortDisabledWarning, receiveDataRate=receiveDataRate, vLANPriorityTable=vLANPriorityTable, receiveModulationMode=receiveModulationMode, telecom=telecom, ptmp=ptmp, incompatibleRegionCodes=incompatibleRegionCodes, sNMPTrapTable=sNMPTrapTable, phyControlGroup=phyControlGroup, dfsTableNumber=dfsTableNumber, sMTPServerIPAddress=sMTPServerIPAddress, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNTPLastSync=sNTPLastSync, dfsPeaks=dfsPeaks, installArmStateTrap=installArmStateTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, timeZone=timeZone, phyControl=phyControl, PYSNMP_MODULE_ID=cambium, altitude=altitude, bandwidthVariant=bandwidthVariant, syslogControl=syslogControl, sNMPv3Enable=sNMPv3Enable, snmpControl=snmpControl, installArmState=installArmState, tDDSynchronizationMode=tDDSynchronizationMode, aggregateDataRate=aggregateDataRate, syslogStateTrap=syslogStateTrap, ptp500=ptp500, telecomsLineCode=telecomsLineCode, linkModeOptimisation=linkModeOptimisation, sNMPTrapTableNumber=sNMPTrapTableNumber, ptpTrapPrefix=ptpTrapPrefix, transmitChannel=transmitChannel, sNTPSyncTrap=sNTPSyncTrap, transmitModulationMode=transmitModulationMode, tDDControl=tDDControl, subnetMask=subnetMask, receivePower=receivePower, sNTPState=sNTPState, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dfsTable=dfsTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, configuration=configuration, vLANPriorityTableIndex=vLANPriorityTableIndex, receiveFreqMHz=receiveFreqMHz, tDDSynchronizationAlarm=tDDSynchronizationAlarm, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, antennaGain=antennaGain, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, notificationsGroup=notificationsGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, ptp=ptp, sNMPTrapTableEntry=sNMPTrapTableEntry, latitude=latitude, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, syslogClientTrap=syslogClientTrap, phyStatusGroup=phyStatusGroup, hardwareVersion=hardwareVersion, range=range, daylightSaving=daylightSaving, telecomsCableLength=telecomsCableLength, alarms=alarms, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapIPAddress=sNMPTrapIPAddress, vLANManagementVID=vLANManagementVID, syslogClient=syslogClient, syslogControlGroup=syslogControlGroup, unitOutOfCalibration=unitOutOfCalibration, regionCodeTrap=regionCodeTrap, userTable=userTable, sNTPPollInterval=sNTPPollInterval, regionCode=regionCode, useVLANForManagementInterfaces=useVLANForManagementInterfaces)
