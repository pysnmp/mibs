...
enterprises, Gauge32, NotificationType, TimeTicks, Integer32, Counter32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, iso, ModuleIdentity, ObjectIdentity, Counter64, Unsigned32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Gauge32", "NotificationType", "TimeTicks", "Integer32", "Counter32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "iso", "ModuleIdentity", "ObjectIdentity", "Counter64", "Unsigned32", "IpAddress")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", searchState=searchState, telecomsInterface=telecomsInterface, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, linkSymmetry=linkSymmetry, byteErrorRatio=byteErrorRatio, altitude=altitude, ptp500=ptp500, telecomsLineCode=telecomsLineCode, latitude=latitude, syslogControlGroup=syslogControlGroup, receiveDataRate=receiveDataRate, sNMPEnabledTraps=sNMPEnabledTraps, remoteIPAddress=remoteIPAddress, receiveModulationModeDetail=receiveModulationModeDetail, pubStatsGroup=pubStatsGroup, unitOutOfCalibration=unitOutOfCalibration, licence=licence, licensedCapacity=licensedCapacity, syslogStateTrap=syslogStateTrap, tDDControlGroup=tDDControlGroup, vLANPriorityTable=vLANPriorityTable, iPAddress=iPAddress, tDDSynchronizationMode=tDDSynchronizationMode, secondarySoftwareVersion=secondarySoftwareVersion, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPPollInterval=sNTPPollInterval, capacityLicenseMismatch=capacityLicenseMismatch, sNTPSyncTrap=sNTPSyncTrap, linkLoss=linkLoss, sNTPLastSync=sNTPLastSync, siteName=siteName, pubStats=pubStats, aAAControl=aAAControl, aAAControlGroup=aAAControlGroup, snmpControl=snmpControl, transmitChannel=transmitChannel, sNTPSync=sNTPSync, phyStatus=phyStatus, versionsGroup=versionsGroup, antennaGain=antennaGain, telecom=telecom, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, regionCode=regionCode, hTTPPortNumber=hTTPPortNumber, daylightSaving=daylightSaving, userTableIndex=userTableIndex, configuration=configuration, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, systemReset=systemReset, telecomsLoopbackTrap=telecomsLoopbackTrap, userTableNumber=userTableNumber, alarmsGroup=alarmsGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, smtpGroup=smtpGroup, installStatusTrap=installStatusTrap, vLANManagementVID=vLANManagementVID, frequencyVariant=frequencyVariant, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, hTTPAccessEnabled=hTTPAccessEnabled, dataPortAutoNegotiation=dataPortAutoNegotiation, accessMethod=accessMethod, snmpControlGroup=snmpControlGroup, sNMPTrapVersion=sNMPTrapVersion, groupID=groupID, range=range, gatewayIPAddress=gatewayIPAddress, userEnabled=userEnabled, configurationGroup=configurationGroup, encryptionAlgorithm=encryptionAlgorithm, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPServerIPAddress=sMTPServerIPAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, dfs=dfs, syslogControl=syslogControl, resetGroup=resetGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sMTPEmailAlert=sMTPEmailAlert, sntpGroup=sntpGroup, syslogClient=syslogClient, userRole=userRole, useVLANForManagementInterfaces=useVLANForManagementInterfaces, licenceGroup=licenceGroup, userTableEntry=userTableEntry, userName=userName, sNMPPortNumber=sNMPPortNumber, linkName=linkName, installStatus=installStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, installArmState=installArmState, dfsTableEntry=dfsTableEntry, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapTableIndex=sNMPTrapTableIndex, telnetPortNumber=telnetPortNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, telnetAccessEnabled=telnetAccessEnabled, ethernet=ethernet, dfsTableIndex=dfsTableIndex, ptpCompliance=ptpCompliance, ptpGroups=ptpGroups, telecomsChannelStatusTrap=telecomsChannelStatusTrap, receiveModulationMode=receiveModulationMode, receivePower=receivePower, dataPortDisabledWarning=dataPortDisabledWarning, vLANManagementPriority=vLANManagementPriority, reset=reset, ptp=ptp, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dfsTable=dfsTable, channelBandwidth=channelBandwidth, transmitFreqKHz=transmitFreqKHz, ptpTrapPrefix=ptpTrapPrefix, telecomGroup=telecomGroup, dfsPeaks=dfsPeaks, telecomsLoopback=telecomsLoopback, dataPortWirelessDownAlert=dataPortWirelessDownAlert, vLANPriorityTableNumber=vLANPriorityTableNumber, incompatibleRegionCodes=incompatibleRegionCodes, sMTPServerPortNumber=sMTPServerPortNumber, sntp=sntp, vLANPriorityTableEntry=vLANPriorityTableEntry, productVariant=productVariant, sNMPv3Enable=sNMPv3Enable, linkModeOptimizationMismatch=linkModeOptimizationMismatch, phyControlGroup=phyControlGroup, dfsTableNumber=dfsTableNumber, ethernetGroup=ethernetGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tDDControl=tDDControl, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, management=management, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sNMPTrapTableNumber=sNMPTrapTableNumber, syslogClientTrap=syslogClientTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, receiveFreqMHz=receiveFreqMHz, dfsGroup=dfsGroup, longitude=longitude, userPassword=userPassword, installArmStateTrap=installArmStateTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ptpTraps=ptpTraps, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, timeZone=timeZone, telecomsChannelStatus=telecomsChannelStatus, dataPortAutoMdix=dataPortAutoMdix, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, targetMACAddress=targetMACAddress, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ethernetFiberSupport=ethernetFiberSupport, sMTPEnabledMessages=sMTPEnabledMessages, sNMPCommunityString=sNMPCommunityString, sNTPServerPortNumber=sNTPServerPortNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, transmitModulationMode=transmitModulationMode, transmitFreqMHz=transmitFreqMHz, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, aggregateDataRate=aggregateDataRate, systemClock=systemClock, sNMPTrapTable=sNMPTrapTable, bootVersion=bootVersion, signalStrengthRatio=signalStrengthRatio, noWirelessChannelAvailable=noWirelessChannelAvailable, transmitDataRate=transmitDataRate, subnetMask=subnetMask, tFTPServerIPAddress=tFTPServerIPAddress, dfsMeans=dfsMeans, receiveFreqKHz=receiveFreqKHz, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dataPortStatus=dataPortStatus, cableLoss=cableLoss, hardwareVersion=hardwareVersion, telecomsCableLength=telecomsCableLength, dataPortConfigurationMismatch=dataPortConfigurationMismatch, alarms=alarms, encryption=encryption, supplementaryGroup=supplementaryGroup, regionCodeTrap=regionCodeTrap, masterSlaveMode=masterSlaveMode, eIRP=eIRP, wirelessLinkStatus=wirelessLinkStatus, productName=productName, managementGroup=managementGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPState=sNTPState, phyStatusGroup=phyStatusGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, PYSNMP_MODULE_ID=cambium, phyControl=phyControl, hTTPSPortNumber=hTTPSPortNumber, linkModeOptimisation=linkModeOptimisation, syslogLocalWrappedTrap=syslogLocalWrappedTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, vectorError=vectorError, ptmp=ptmp, cambium=cambium, maximumTransmitPower=maximumTransmitPower, versions=versions, sNTPServerIPAddress=sNTPServerIPAddress, syslogState=syslogState, dataPortStatusTrap=dataPortStatusTrap, softwareVersion=softwareVersion, smtp=smtp, supplementary=supplementary, bandwidthVariant=bandwidthVariant, vLANPriorityTableIndex=vLANPriorityTableIndex, receiveChannel=receiveChannel, notificationsGroup=notificationsGroup, encryptionGroup=encryptionGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, userTable=userTable, channelChangeTrap=channelChangeTrap, tFTPServerPortNumber=tFTPServerPortNumber, wirelessLinkAvailability=wirelessLinkAvailability, transmitPower=transmitPower, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade)
