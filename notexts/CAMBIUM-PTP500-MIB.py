...
# Produced by pysmi-1.1.3 at Tue Nov 30 02:25:51 2021
...
TimeTicks, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, Counter64, Unsigned32, MibIdentifier, NotificationType, Gauge32, ObjectIdentity, IpAddress, ModuleIdentity, enterprises, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "Counter64", "Unsigned32", "MibIdentifier", "NotificationType", "Gauge32", "ObjectIdentity", "IpAddress", "ModuleIdentity", "enterprises", "Bits")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", tDDControl=tDDControl, versionsGroup=versionsGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, hTTPSAccessEnabled=hTTPSAccessEnabled, telecomsChannelStatusTrap=telecomsChannelStatusTrap, snmpControlGroup=snmpControlGroup, siteName=siteName, telecomsInterface=telecomsInterface, receiveChannel=receiveChannel, telecomsLineCode=telecomsLineCode, sNMPTrapIPAddress=sNMPTrapIPAddress, ptmp=ptmp, supplementary=supplementary, linkLoss=linkLoss, gatewayIPAddress=gatewayIPAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, altitude=altitude, antennaGain=antennaGain, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, dfsTableEntry=dfsTableEntry, ptp500=ptp500, installArmState=installArmState, transmitFreqKHz=transmitFreqKHz, dfsMeans=dfsMeans, signalStrengthRatio=signalStrengthRatio, userName=userName, ethernetGroup=ethernetGroup, alarmsGroup=alarmsGroup, userEnabled=userEnabled, frequencyVariant=frequencyVariant, linkName=linkName, encryptionAlgorithm=encryptionAlgorithm, transmitDataRate=transmitDataRate, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sMTPServerPortNumber=sMTPServerPortNumber, alarms=alarms, bandwidthVariant=bandwidthVariant, licence=licence, telecom=telecom, dataPortAutoMdix=dataPortAutoMdix, tDDSynchronizationStatus=tDDSynchronizationStatus, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, wirelessLinkStatus=wirelessLinkStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, syslogClient=syslogClient, notificationsGroup=notificationsGroup, capacityLicenseMismatch=capacityLicenseMismatch, telecomsChannelStatus=telecomsChannelStatus, sntp=sntp, ethernetFiberSupport=ethernetFiberSupport, userTableNumber=userTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, subnetMask=subnetMask, secondarySoftwareVersion=secondarySoftwareVersion, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, versions=versions, supplementaryGroup=supplementaryGroup, receiveFreqMHz=receiveFreqMHz, encryptionGroup=encryptionGroup, sNMPTrapVersion=sNMPTrapVersion, telecomsLoopbackTrap=telecomsLoopbackTrap, ptp=ptp, phyStatusGroup=phyStatusGroup, sntpGroup=sntpGroup, dataPortStatus=dataPortStatus, resetGroup=resetGroup, telecomGroup=telecomGroup, ptpTrapPrefix=ptpTrapPrefix, hTTPPortNumber=hTTPPortNumber, channelChangeTrap=channelChangeTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, telnetAccessEnabled=telnetAccessEnabled, transmitPower=transmitPower, sNMPPortNumber=sNMPPortNumber, sNMPv3Enable=sNMPv3Enable, sNTPPollInterval=sNTPPollInterval, smtp=smtp, constantPowerSpectralDensity=constantPowerSpectralDensity, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, iPAddress=iPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, vLANPriorityTable=vLANPriorityTable, userPassword=userPassword, dfs=dfs, phyControl=phyControl, sNTPServerPortNumber=sNTPServerPortNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, ptpGroups=ptpGroups, sMTPServerIPAddress=sMTPServerIPAddress, reset=reset, aggregateDataRate=aggregateDataRate, timeZone=timeZone, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dfsGroup=dfsGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, syslogClientTrap=syslogClientTrap, sNTPLastSync=sNTPLastSync, masterSlaveMode=masterSlaveMode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, bootVersion=bootVersion, sMTPEmailAlert=sMTPEmailAlert, ethernet=ethernet, smtpGroup=smtpGroup, cambium=cambium, regionCode=regionCode, accessMethod=accessMethod, sNMPTrapTableEntry=sNMPTrapTableEntry, aAAControlGroup=aAAControlGroup, remoteIPAddress=remoteIPAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, licenceGroup=licenceGroup, managementGroup=managementGroup, productVariant=productVariant, syslogControl=syslogControl, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, userTable=userTable, dfsPeaks=dfsPeaks, pubStats=pubStats, searchState=searchState, licensedCapacity=licensedCapacity, maximumTransmitPower=maximumTransmitPower, syslogControlGroup=syslogControlGroup, productName=productName, hTTPAccessEnabled=hTTPAccessEnabled, userTableEntry=userTableEntry, sNMPTrapTableIndex=sNMPTrapTableIndex, byteErrorRatio=byteErrorRatio, syslogStateTrap=syslogStateTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, telnetPortNumber=telnetPortNumber, unitOutOfCalibration=unitOutOfCalibration, management=management, range=range, cableLoss=cableLoss, tDDSynchronizationMode=tDDSynchronizationMode, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tFTPServerPortNumber=tFTPServerPortNumber, vLANPriorityTableNumber=vLANPriorityTableNumber, aAAControl=aAAControl, dataPortDisabledWarning=dataPortDisabledWarning, vLANManagementVID=vLANManagementVID, dataPortWirelessDownAlert=dataPortWirelessDownAlert, vectorError=vectorError, dfsTable=dfsTable, userTableIndex=userTableIndex, phyControlGroup=phyControlGroup, sMTPEnabledMessages=sMTPEnabledMessages, vLANPriorityQueueMapping=vLANPriorityQueueMapping, daylightSaving=daylightSaving, latitude=latitude, dataPortConfigurationMismatch=dataPortConfigurationMismatch, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, telecomsCableLength=telecomsCableLength, receiveFreqKHz=receiveFreqKHz, snmpControl=snmpControl, hTTPSPortNumber=hTTPSPortNumber, configurationGroup=configurationGroup, dataPortStatusTrap=dataPortStatusTrap, installStatusTrap=installStatusTrap, groupID=groupID, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, systemClock=systemClock, wirelessLinkAvailability=wirelessLinkAvailability, vLANPriorityTableIndex=vLANPriorityTableIndex, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, PYSNMP_MODULE_ID=cambium, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, installStatus=installStatus, linkModeOptimisation=linkModeOptimisation, receivePower=receivePower, tFTPServerIPAddress=tFTPServerIPAddress, configuration=configuration, receiveModulationMode=receiveModulationMode, hardwareVersion=hardwareVersion, useVLANForManagementInterfaces=useVLANForManagementInterfaces, syslogState=syslogState, ptpTraps=ptpTraps, vLANPriorityTableEntry=vLANPriorityTableEntry, dfsTableNumber=dfsTableNumber, tDDControlGroup=tDDControlGroup, transmitChannel=transmitChannel, sNTPServerIPAddress=sNTPServerIPAddress, systemReset=systemReset, targetMACAddress=targetMACAddress, sNTPState=sNTPState, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, regionCodeTrap=regionCodeTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, vLANManagementPriority=vLANManagementPriority, receiveModulationModeDetail=receiveModulationModeDetail, sNMPCommunityString=sNMPCommunityString, eIRP=eIRP, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, installArmStateTrap=installArmStateTrap, longitude=longitude, receiveDataRate=receiveDataRate, linkSymmetry=linkSymmetry, sNMPEnabledTraps=sNMPEnabledTraps, telecomsLoopback=telecomsLoopback, noWirelessChannelAvailable=noWirelessChannelAvailable, encryption=encryption, ptpCompliance=ptpCompliance, channelBandwidth=channelBandwidth, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPTrapTable=sNMPTrapTable, sNTPSyncTrap=sNTPSyncTrap, incompatibleRegionCodes=incompatibleRegionCodes, softwareVersion=softwareVersion, sNMPTrapTableNumber=sNMPTrapTableNumber, userRole=userRole, pubStatsGroup=pubStatsGroup, transmitFreqMHz=transmitFreqMHz, sNTPSync=sNTPSync, phyStatus=phyStatus, transmitModulationMode=transmitModulationMode, dfsTableIndex=dfsTableIndex)
