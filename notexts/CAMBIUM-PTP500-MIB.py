...
# Produced by pysmi-1.1.3 at Wed Dec  8 18:20:52 2021
...
NotificationType, ModuleIdentity, Counter32, IpAddress, iso, Bits, TimeTicks, ObjectIdentity, Unsigned32, MibIdentifier, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Gauge32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "Counter32", "IpAddress", "iso", "Bits", "TimeTicks", "ObjectIdentity", "Unsigned32", "MibIdentifier", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Gauge32", "enterprises")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", productVariant=productVariant, telecomsLoopback=telecomsLoopback, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, encryptionAlgorithm=encryptionAlgorithm, frequencyVariant=frequencyVariant, pubStats=pubStats, sNTPState=sNTPState, versions=versions, latitude=latitude, sNMPv3Enable=sNMPv3Enable, receivePower=receivePower, hardwareVersion=hardwareVersion, licensedCapacity=licensedCapacity, searchState=searchState, incompatibleRegionCodes=incompatibleRegionCodes, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, syslogStateTrap=syslogStateTrap, dataPortAutoMdix=dataPortAutoMdix, transmitFreqMHz=transmitFreqMHz, dataPortStatusTrap=dataPortStatusTrap, dfsPeaks=dfsPeaks, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, licence=licence, userEnabled=userEnabled, telnetPortNumber=telnetPortNumber, hTTPPortNumber=hTTPPortNumber, management=management, sNMPTrapIPAddress=sNMPTrapIPAddress, userRole=userRole, phyControlGroup=phyControlGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPTrapTableNumber=sNMPTrapTableNumber, installStatus=installStatus, telecomGroup=telecomGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, telecomsChannelStatus=telecomsChannelStatus, tDDSynchronizationMode=tDDSynchronizationMode, vLANPriorityTableIndex=vLANPriorityTableIndex, sNMPTrapTable=sNMPTrapTable, transmitFreqKHz=transmitFreqKHz, sNMPCommunityString=sNMPCommunityString, syslogControl=syslogControl, ethernetFiberSupport=ethernetFiberSupport, encryptionGroup=encryptionGroup, notificationsGroup=notificationsGroup, ethernet=ethernet, vLANManagementVID=vLANManagementVID, phyStatus=phyStatus, transmitModulationMode=transmitModulationMode, daylightSaving=daylightSaving, transmitChannel=transmitChannel, aggregateDataRate=aggregateDataRate, dfsMeans=dfsMeans, aAAControlGroup=aAAControlGroup, cambium=cambium, ptpTrapPrefix=ptpTrapPrefix, siteName=siteName, telecomsLineCode=telecomsLineCode, linkLoss=linkLoss, altitude=altitude, telecomsChannelStatusTrap=telecomsChannelStatusTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPLastSync=sNTPLastSync, sMTPEnabledMessages=sMTPEnabledMessages, antennaGain=antennaGain, sNMPTrapVersion=sNMPTrapVersion, dataPortConfigurationMismatch=dataPortConfigurationMismatch, smtpGroup=smtpGroup, regionCode=regionCode, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ptpTraps=ptpTraps, sNMPTrapTableEntry=sNMPTrapTableEntry, ptmp=ptmp, snmpControlGroup=snmpControlGroup, receiveChannel=receiveChannel, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, eIRP=eIRP, bandwidthVariant=bandwidthVariant, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, dfsTableEntry=dfsTableEntry, syslogClientTrap=syslogClientTrap, linkSymmetry=linkSymmetry, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, hTTPSAccessEnabled=hTTPSAccessEnabled, dataPortDisabledWarning=dataPortDisabledWarning, reset=reset, userTableNumber=userTableNumber, resetGroup=resetGroup, smtp=smtp, tDDControl=tDDControl, iPAddress=iPAddress, dfs=dfs, maximumTransmitPower=maximumTransmitPower, timeZone=timeZone, versionsGroup=versionsGroup, wirelessLinkAvailability=wirelessLinkAvailability, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNTPSync=sNTPSync, aAAControl=aAAControl, dfsGroup=dfsGroup, ethernetGroup=ethernetGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, masterSlaveMode=masterSlaveMode, secondarySoftwareVersion=secondarySoftwareVersion, tDDControlGroup=tDDControlGroup, userTable=userTable, noWirelessChannelAvailable=noWirelessChannelAvailable, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, installArmState=installArmState, incompatibleMasterAndSlave=incompatibleMasterAndSlave, licenceGroup=licenceGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, accessMethod=accessMethod, unitOutOfCalibration=unitOutOfCalibration, wirelessLinkStatus=wirelessLinkStatus, sNTPServerIPAddress=sNTPServerIPAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, phyControl=phyControl, sNTPPollInterval=sNTPPollInterval, installStatusTrap=installStatusTrap, channelBandwidth=channelBandwidth, userPassword=userPassword, vLANPriorityTableEntry=vLANPriorityTableEntry, sNTPServerPortNumber=sNTPServerPortNumber, telecomsLoopbackTrap=telecomsLoopbackTrap, range=range, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dataPortStatus=dataPortStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, softwareVersion=softwareVersion, remoteIPAddress=remoteIPAddress, regionCodeTrap=regionCodeTrap, bootVersion=bootVersion, configuration=configuration, PYSNMP_MODULE_ID=cambium, sntpGroup=sntpGroup, alarms=alarms, groupID=groupID, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, receiveFreqKHz=receiveFreqKHz, sMTPServerIPAddress=sMTPServerIPAddress, installArmStateTrap=installArmStateTrap, telecomsInterface=telecomsInterface, byteErrorRatio=byteErrorRatio, dataPortAutoNegotiation=dataPortAutoNegotiation, telecom=telecom, transmitPower=transmitPower, supplementaryGroup=supplementaryGroup, syslogClient=syslogClient, receiveModulationMode=receiveModulationMode, sNTPSyncTrap=sNTPSyncTrap, channelChangeTrap=channelChangeTrap, gatewayIPAddress=gatewayIPAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPEnabledTraps=sNMPEnabledTraps, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dfsTable=dfsTable, managementGroup=managementGroup, receiveFreqMHz=receiveFreqMHz, vectorError=vectorError, transmitDataRate=transmitDataRate, phyStatusGroup=phyStatusGroup, userTableEntry=userTableEntry, linkName=linkName, syslogState=syslogState, userName=userName, productName=productName, supplementary=supplementary, configurationGroup=configurationGroup, vLANManagementPriority=vLANManagementPriority, pubStatsGroup=pubStatsGroup, signalStrengthRatio=signalStrengthRatio, systemReset=systemReset, vLANPriorityQueueMapping=vLANPriorityQueueMapping, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, linkModeOptimisation=linkModeOptimisation, tFTPServerIPAddress=tFTPServerIPAddress, receiveModulationModeDetail=receiveModulationModeDetail, alarmsGroup=alarmsGroup, sMTPEmailAlert=sMTPEmailAlert, longitude=longitude, hTTPSPortNumber=hTTPSPortNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, capacityLicenseMismatch=capacityLicenseMismatch, sNMPPortNumber=sNMPPortNumber, ptpCompliance=ptpCompliance, cableLoss=cableLoss, encryption=encryption, dfsTableIndex=dfsTableIndex, ptpGroups=ptpGroups, telnetAccessEnabled=telnetAccessEnabled, subnetMask=subnetMask, dfsTableNumber=dfsTableNumber, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, targetMACAddress=targetMACAddress, hTTPAccessEnabled=hTTPAccessEnabled, ptp500=ptp500, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sntp=sntp, telecomsCableLength=telecomsCableLength, sMTPServerPortNumber=sMTPServerPortNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, receiveDataRate=receiveDataRate, tFTPServerPortNumber=tFTPServerPortNumber, syslogControlGroup=syslogControlGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, systemClock=systemClock, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, vLANPriorityTable=vLANPriorityTable, constantPowerSpectralDensity=constantPowerSpectralDensity, userTableIndex=userTableIndex, snmpControl=snmpControl, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ptp=ptp, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement)
