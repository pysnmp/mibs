...
# Produced by pysmi-1.1.3 at Wed Dec  8 18:56:13 2021
...
iso, Integer32, ObjectIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Bits, Counter64, TimeTicks, Counter32, Gauge32, MibIdentifier, Unsigned32, enterprises, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "ObjectIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Bits", "Counter64", "TimeTicks", "Counter32", "Gauge32", "MibIdentifier", "Unsigned32", "enterprises", "IpAddress")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", syslogClientTrap=syslogClientTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, cambium=cambium, telnetAccessEnabled=telnetAccessEnabled, ethernetFiberSupport=ethernetFiberSupport, frequencyVariant=frequencyVariant, linkModeOptimizationMismatch=linkModeOptimizationMismatch, userTableEntry=userTableEntry, dataPortAutoMdix=dataPortAutoMdix, installStatusTrap=installStatusTrap, telecomsInterface=telecomsInterface, vLANPriorityTable=vLANPriorityTable, linkSymmetry=linkSymmetry, regionCode=regionCode, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sMTPSourceEmailAddress=sMTPSourceEmailAddress, subnetMask=subnetMask, receiveDataRate=receiveDataRate, hTTPSAccessEnabled=hTTPSAccessEnabled, transmitFreqKHz=transmitFreqKHz, secondarySoftwareVersion=secondarySoftwareVersion, receiveModulationModeDetail=receiveModulationModeDetail, versionsGroup=versionsGroup, channelChangeTrap=channelChangeTrap, configuration=configuration, eIRP=eIRP, PYSNMP_MODULE_ID=cambium, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, regionCodeTrap=regionCodeTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, byteErrorRatio=byteErrorRatio, telnetPortNumber=telnetPortNumber, ptp=ptp, versions=versions, incompatibleRegionCodes=incompatibleRegionCodes, reset=reset, sMTPEnabledMessages=sMTPEnabledMessages, supplementary=supplementary, longitude=longitude, cableLoss=cableLoss, hTTPAccessEnabled=hTTPAccessEnabled, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPLastSync=sNTPLastSync, aAAControl=aAAControl, ptpGroups=ptpGroups, noWirelessChannelAvailable=noWirelessChannelAvailable, timeZone=timeZone, ethernet=ethernet, accessMethod=accessMethod, licence=licence, dfsGroup=dfsGroup, alarms=alarms, smtpGroup=smtpGroup, sntpGroup=sntpGroup, systemClock=systemClock, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapVersion=sNMPTrapVersion, aAAControlGroup=aAAControlGroup, sNMPPortNumber=sNMPPortNumber, userEnabled=userEnabled, transmitChannel=transmitChannel, transmitFreqMHz=transmitFreqMHz, incompatibleMasterAndSlave=incompatibleMasterAndSlave, capacityLicenseMismatch=capacityLicenseMismatch, productVariant=productVariant, licenceGroup=licenceGroup, userPassword=userPassword, altitude=altitude, vectorError=vectorError, phyStatus=phyStatus, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, pubStats=pubStats, ethernetGroup=ethernetGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, encryptionAlgorithm=encryptionAlgorithm, management=management, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, sMTPServerIPAddress=sMTPServerIPAddress, aggregateDataRate=aggregateDataRate, alarmsGroup=alarmsGroup, configurationGroup=configurationGroup, sNTPSync=sNTPSync, telecomsLineCode=telecomsLineCode, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, softwareVersion=softwareVersion, receiveFreqKHz=receiveFreqKHz, hardwareVersion=hardwareVersion, sNMPv3Enable=sNMPv3Enable, linkName=linkName, sNTPServerPortNumber=sNTPServerPortNumber, iPAddress=iPAddress, sNMPEnabledTraps=sNMPEnabledTraps, productName=productName, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, userTableIndex=userTableIndex, vLANPriorityTableIndex=vLANPriorityTableIndex, sNTPPollInterval=sNTPPollInterval, tDDControl=tDDControl, receiveFreqMHz=receiveFreqMHz, receiveModulationMode=receiveModulationMode, sNTPState=sNTPState, ptpTrapPrefix=ptpTrapPrefix, sMTPServerPortNumber=sMTPServerPortNumber, tFTPServerPortNumber=tFTPServerPortNumber, licensedCapacity=licensedCapacity, telecomsCableLength=telecomsCableLength, installArmState=installArmState, phyControl=phyControl, remoteMaximumTransmitPower=remoteMaximumTransmitPower, userRole=userRole, tDDSynchronizationMode=tDDSynchronizationMode, syslogControl=syslogControl, dataPortDisabledWarning=dataPortDisabledWarning, latitude=latitude, useVLANForManagementInterfaces=useVLANForManagementInterfaces, remoteIPAddress=remoteIPAddress, systemReset=systemReset, transmitDataRate=transmitDataRate, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, linkModeOptimisation=linkModeOptimisation, syslogClient=syslogClient, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPCommunityString=sNMPCommunityString, hTTPPortNumber=hTTPPortNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, pubStatsGroup=pubStatsGroup, notificationsGroup=notificationsGroup, telecomsLoopback=telecomsLoopback, telecom=telecom, phyStatusGroup=phyStatusGroup, dataPortStatusTrap=dataPortStatusTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, sNMPTrapIPAddress=sNMPTrapIPAddress, ptmp=ptmp, daylightSaving=daylightSaving, targetMACAddress=targetMACAddress, dfsTableEntry=dfsTableEntry, transmitPower=transmitPower, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, wirelessLinkStatus=wirelessLinkStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tDDControlGroup=tDDControlGroup, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sMTPEmailAlert=sMTPEmailAlert, dfsTableNumber=dfsTableNumber, bootVersion=bootVersion, dfsTableIndex=dfsTableIndex, telecomGroup=telecomGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dfsPeaks=dfsPeaks, syslogState=syslogState, sNTPSyncTrap=sNTPSyncTrap, vLANManagementPriority=vLANManagementPriority, searchState=searchState, unitOutOfCalibration=unitOutOfCalibration, linkLoss=linkLoss, groupID=groupID, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, resetGroup=resetGroup, vLANManagementVID=vLANManagementVID, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, signalStrengthRatio=signalStrengthRatio, ptp500=ptp500, antennaGain=antennaGain, userName=userName, dataPortStatus=dataPortStatus, ptpTraps=ptpTraps, range=range, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, installStatus=installStatus, smtp=smtp, sntp=sntp, telecomsChannelStatus=telecomsChannelStatus, ptpCompliance=ptpCompliance, hTTPSPortNumber=hTTPSPortNumber, siteName=siteName, masterSlaveMode=masterSlaveMode, receiveChannel=receiveChannel, sNTPServerIPAddress=sNTPServerIPAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, wirelessLinkAvailability=wirelessLinkAvailability, receivePower=receivePower, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, userTableNumber=userTableNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, snmpControl=snmpControl, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, transmitModulationMode=transmitModulationMode, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, sNMPTrapTableNumber=sNMPTrapTableNumber, telecomsLoopbackTrap=telecomsLoopbackTrap, userTable=userTable, phyControlGroup=phyControlGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, encryption=encryption, supplementaryGroup=supplementaryGroup, managementGroup=managementGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, installArmStateTrap=installArmStateTrap, dfsTable=dfsTable, maximumTransmitPower=maximumTransmitPower, sNMPTrapTableIndex=sNMPTrapTableIndex, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPTrapTable=sNMPTrapTable, bandwidthVariant=bandwidthVariant, syslogControlGroup=syslogControlGroup, syslogStateTrap=syslogStateTrap, encryptionGroup=encryptionGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, dfsMeans=dfsMeans, channelBandwidth=channelBandwidth, gatewayIPAddress=gatewayIPAddress, snmpControlGroup=snmpControlGroup, dfs=dfs)
