...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, telnetAccessEnabled=telnetAccessEnabled, vectorError=vectorError, bandwidthVariant=bandwidthVariant, antennaGain=antennaGain, cableLoss=cableLoss, transmitPower=transmitPower, remoteIPAddress=remoteIPAddress, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ethernetFiberSupport=ethernetFiberSupport, syslogClient=syslogClient, dfsMeans=dfsMeans, managementGroup=managementGroup, telecomsLineCode=telecomsLineCode, constantPowerSpectralDensity=constantPowerSpectralDensity, sNTPLastSync=sNTPLastSync, range=range, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, subnetMask=subnetMask, ptpTrapPrefix=ptpTrapPrefix, ptp500=ptp500, groupID=groupID, sMTPEmailAlert=sMTPEmailAlert, wirelessLinkStatus=wirelessLinkStatus, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, receiveFreqKHz=receiveFreqKHz, userName=userName, ethernetGroup=ethernetGroup, telecom=telecom, productName=productName, installStatus=installStatus, ptpTraps=ptpTraps, secondarySoftwareVersion=secondarySoftwareVersion, userTable=userTable, supplementaryGroup=supplementaryGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, receiveDataRate=receiveDataRate, management=management, receiveModulationMode=receiveModulationMode, aAAControlGroup=aAAControlGroup, daylightSaving=daylightSaving, signalStrengthRatio=signalStrengthRatio, linkModeOptimisation=linkModeOptimisation, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPServerIPAddress=tFTPServerIPAddress, sNTPSync=sNTPSync, supplementary=supplementary, aAAControl=aAAControl, tDDSynchronizationStatus=tDDSynchronizationStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapIPAddress=sNMPTrapIPAddress, telecomsCableLength=telecomsCableLength, userEnabled=userEnabled, dfs=dfs, sNTPServerIPAddress=sNTPServerIPAddress, bootVersion=bootVersion, alarmsGroup=alarmsGroup, vLANPriorityTable=vLANPriorityTable, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ptp=ptp, installStatusTrap=installStatusTrap, receiveChannel=receiveChannel, dataPortAutoNegotiation=dataPortAutoNegotiation, smtpGroup=smtpGroup, pubStats=pubStats, telecomGroup=telecomGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, hTTPAccessEnabled=hTTPAccessEnabled, userTableIndex=userTableIndex, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, versionsGroup=versionsGroup, telecomsChannelStatusTrap=telecomsChannelStatusTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, encryption=encryption, sMTPSourceEmailAddress=sMTPSourceEmailAddress, vLANPriorityTableEntry=vLANPriorityTableEntry, transmitModulationMode=transmitModulationMode, ptpGroups=ptpGroups, syslogControlGroup=syslogControlGroup, softwareVersion=softwareVersion, regionCodeTrap=regionCodeTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, syslogStateTrap=syslogStateTrap, notificationsGroup=notificationsGroup, hTTPSPortNumber=hTTPSPortNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, userPassword=userPassword, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dataPortAutoMdix=dataPortAutoMdix, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, encryptionAlgorithm=encryptionAlgorithm, regionCode=regionCode, receiveFreqMHz=receiveFreqMHz, enabledDiagnosticAlarms=enabledDiagnosticAlarms, byteErrorRatio=byteErrorRatio, hTTPPortNumber=hTTPPortNumber, aggregateDataRate=aggregateDataRate, sntpGroup=sntpGroup, dfsTableIndex=dfsTableIndex, capacityLicenseMismatch=capacityLicenseMismatch, smtp=smtp, productVariant=productVariant, sNMPEnabledTraps=sNMPEnabledTraps, telecomsInterface=telecomsInterface, receiveModulationModeDetail=receiveModulationModeDetail, syslogControl=syslogControl, ptpCompliance=ptpCompliance, snmpControlGroup=snmpControlGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, licence=licence, dataPortWirelessDownAlert=dataPortWirelessDownAlert, timeZone=timeZone, syslogState=syslogState, incompatibleRegionCodes=incompatibleRegionCodes, sMTPServerPortNumber=sMTPServerPortNumber, wirelessLinkAvailability=wirelessLinkAvailability, transmitFreqKHz=transmitFreqKHz, phyStatus=phyStatus, targetMACAddress=targetMACAddress, linkName=linkName, userTableEntry=userTableEntry, dfsTable=dfsTable, telecomsChannelStatus=telecomsChannelStatus, cambium=cambium, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tDDControl=tDDControl, tDDSynchronizationAlarm=tDDSynchronizationAlarm, configurationGroup=configurationGroup, dfsTableNumber=dfsTableNumber, resetGroup=resetGroup, telecomsLoopbackTrap=telecomsLoopbackTrap, maximumTransmitPower=maximumTransmitPower, frequencyVariant=frequencyVariant, linkModeOptimizationMismatch=linkModeOptimizationMismatch, userRole=userRole, installArmState=installArmState, transmitFreqMHz=transmitFreqMHz, unitOutOfCalibration=unitOutOfCalibration, sNTPServerPortNumber=sNTPServerPortNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, transmitChannel=transmitChannel, altitude=altitude, sNMPTrapTable=sNMPTrapTable, tFTPServerPortNumber=tFTPServerPortNumber, gatewayIPAddress=gatewayIPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, receivePower=receivePower, tDDSynchronizationMode=tDDSynchronizationMode, linkSymmetry=linkSymmetry, dfsGroup=dfsGroup, ethernet=ethernet, dataPortStatusTrap=dataPortStatusTrap, snmpControl=snmpControl, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dfsTableEntry=dfsTableEntry, userTableNumber=userTableNumber, telecomsLoopback=telecomsLoopback, alarms=alarms, vLANManagementVID=vLANManagementVID, transmitDataRate=transmitDataRate, vLANPriorityTableIndex=vLANPriorityTableIndex, iPAddress=iPAddress, latitude=latitude, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortStatus=dataPortStatus, phyStatusGroup=phyStatusGroup, encryptionGroup=encryptionGroup, sNMPPortNumber=sNMPPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, pubStatsGroup=pubStatsGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, systemClock=systemClock, sNTPSyncTrap=sNTPSyncTrap, syslogClientTrap=syslogClientTrap, searchState=searchState, sNMPv3Enable=sNMPv3Enable, tDDControlGroup=tDDControlGroup, sNTPState=sNTPState, dataPortConfigurationMismatch=dataPortConfigurationMismatch, channelBandwidth=channelBandwidth, versions=versions, vLANPriorityQueueMapping=vLANPriorityQueueMapping, telnetPortNumber=telnetPortNumber, linkLoss=linkLoss, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, systemReset=systemReset, vLANManagementPriority=vLANManagementPriority, dfsPeaks=dfsPeaks, longitude=longitude, channelChangeTrap=channelChangeTrap, eIRP=eIRP, dataPortDisabledWarning=dataPortDisabledWarning, accessMethod=accessMethod, sntp=sntp, ptmp=ptmp, reset=reset, sNTPPollInterval=sNTPPollInterval, installArmStateTrap=installArmStateTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, hardwareVersion=hardwareVersion, phyControlGroup=phyControlGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPCommunityString=sNMPCommunityString, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, phyControl=phyControl, licensedCapacity=licensedCapacity, sMTPServerIPAddress=sMTPServerIPAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, PYSNMP_MODULE_ID=cambium, siteName=siteName, masterSlaveMode=masterSlaveMode, configuration=configuration, licenceGroup=licenceGroup)
