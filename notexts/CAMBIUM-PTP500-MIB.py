...
# Produced by pysmi-1.1.3 at Wed Dec  1 16:27:57 2021
...
iso, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Integer32, ModuleIdentity, ObjectIdentity, MibIdentifier, Counter64, Unsigned32, TimeTicks, IpAddress, Bits, Counter32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Integer32", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "Counter64", "Unsigned32", "TimeTicks", "IpAddress", "Bits", "Counter32", "enterprises")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, aggregateDataRate=aggregateDataRate, channelChangeTrap=channelChangeTrap, managementGroup=managementGroup, hTTPPortNumber=hTTPPortNumber, vLANPriorityQueueMapping=vLANPriorityQueueMapping, telecomsLineCode=telecomsLineCode, syslogState=syslogState, pubStats=pubStats, ptpCompliance=ptpCompliance, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPPollInterval=sNTPPollInterval, userPassword=userPassword, dfs=dfs, licence=licence, tFTPServerPortNumber=tFTPServerPortNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, vLANManagementVID=vLANManagementVID, wirelessLinkStatus=wirelessLinkStatus, tDDControl=tDDControl, unitOutOfCalibration=unitOutOfCalibration, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPTrapTableEntry=sNMPTrapTableEntry, syslogControl=syslogControl, vectorError=vectorError, dfsMeans=dfsMeans, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, range=range, remoteMaximumTransmitPower=remoteMaximumTransmitPower, altitude=altitude, telecomsCableLength=telecomsCableLength, vLANPriorityTableEntry=vLANPriorityTableEntry, userTable=userTable, constantPowerSpectralDensity=constantPowerSpectralDensity, transmitChannel=transmitChannel, maximumTransmitPower=maximumTransmitPower, ethernet=ethernet, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPCommunityString=sNMPCommunityString, syslogClientTrap=syslogClientTrap, vLANManagementPriority=vLANManagementPriority, installArmStateTrap=installArmStateTrap, ptmp=ptmp, notificationsGroup=notificationsGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, subnetMask=subnetMask, configuration=configuration, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, transmitPower=transmitPower, sNMPTrapTable=sNMPTrapTable, tFTPServerIPAddress=tFTPServerIPAddress, installStatusTrap=installStatusTrap, alarmsGroup=alarmsGroup, installStatus=installStatus, encryptionAlgorithm=encryptionAlgorithm, sNMPTrapPortNumber=sNMPTrapPortNumber, licenceGroup=licenceGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPServerIPAddress=sNTPServerIPAddress, sNMPPortNumber=sNMPPortNumber, bootVersion=bootVersion, incompatibleRegionCodes=incompatibleRegionCodes, signalStrengthRatio=signalStrengthRatio, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, wirelessLinkAvailability=wirelessLinkAvailability, encryptionGroup=encryptionGroup, dataPortStatus=dataPortStatus, hardwareVersion=hardwareVersion, dfsGroup=dfsGroup, searchState=searchState, reset=reset, noWirelessChannelAvailable=noWirelessChannelAvailable, channelBandwidth=channelBandwidth, ethernetFiberSupport=ethernetFiberSupport, installArmState=installArmState, telecomsInterface=telecomsInterface, syslogControlGroup=syslogControlGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transmitFreqMHz=transmitFreqMHz, telecomsChannelStatus=telecomsChannelStatus, management=management, encryption=encryption, aAAControl=aAAControl, telnetPortNumber=telnetPortNumber, smtp=smtp, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, licensedCapacity=licensedCapacity, daylightSaving=daylightSaving, supplementary=supplementary, sNMPTrapVersion=sNMPTrapVersion, userName=userName, ptpTraps=ptpTraps, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, antennaGain=antennaGain, phyStatus=phyStatus, vLANPriorityTable=vLANPriorityTable, dataPortStatusTrap=dataPortStatusTrap, transmitDataRate=transmitDataRate, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, receivePower=receivePower, phyControlGroup=phyControlGroup, sNTPSyncTrap=sNTPSyncTrap, telecom=telecom, frequencyVariant=frequencyVariant, bandwidthVariant=bandwidthVariant, dataPortWirelessDownAlert=dataPortWirelessDownAlert, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPv3Enable=sNMPv3Enable, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, pubStatsGroup=pubStatsGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, linkSymmetry=linkSymmetry, userRole=userRole, dataPortAutoMdix=dataPortAutoMdix, linkModeOptimisation=linkModeOptimisation, receiveModulationMode=receiveModulationMode, systemClock=systemClock, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, phyControl=phyControl, linkLoss=linkLoss, softwareVersion=softwareVersion, timeZone=timeZone, snmpControl=snmpControl, configurationGroup=configurationGroup, telnetAccessEnabled=telnetAccessEnabled, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, phyStatusGroup=phyStatusGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ptpGroups=ptpGroups, dfsTableIndex=dfsTableIndex, ptp500=ptp500, productName=productName, ptp=ptp, ethernetGroup=ethernetGroup, remoteIPAddress=remoteIPAddress, latitude=latitude, sNTPServerPortNumber=sNTPServerPortNumber, ptpTrapPrefix=ptpTrapPrefix, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, accessMethod=accessMethod, snmpControlGroup=snmpControlGroup, resetGroup=resetGroup, dfsPeaks=dfsPeaks, sNMPTrapTableIndex=sNMPTrapTableIndex, receiveDataRate=receiveDataRate, userTableNumber=userTableNumber, sNTPSync=sNTPSync, alarms=alarms, sntpGroup=sntpGroup, hTTPSPortNumber=hTTPSPortNumber, receiveFreqKHz=receiveFreqKHz, sMTPEnabledMessages=sMTPEnabledMessages, regionCodeTrap=regionCodeTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, secondarySoftwareVersion=secondarySoftwareVersion, regionCode=regionCode, dfsTable=dfsTable, tDDSynchronizationMode=tDDSynchronizationMode, cableLoss=cableLoss, byteErrorRatio=byteErrorRatio, eIRP=eIRP, gatewayIPAddress=gatewayIPAddress, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sMTPEmailAlert=sMTPEmailAlert, longitude=longitude, cambium=cambium, siteName=siteName, sMTPServerIPAddress=sMTPServerIPAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, masterSlaveMode=masterSlaveMode, capacityLicenseMismatch=capacityLicenseMismatch, versions=versions, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPEnabledTraps=sNMPEnabledTraps, supplementaryGroup=supplementaryGroup, telecomsLoopbackTrap=telecomsLoopbackTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, targetMACAddress=targetMACAddress, telecomsLoopback=telecomsLoopback, userEnabled=userEnabled, hTTPSAccessEnabled=hTTPSAccessEnabled, versionsGroup=versionsGroup, smtpGroup=smtpGroup, syslogStateTrap=syslogStateTrap, dfsTableEntry=dfsTableEntry, userTableEntry=userTableEntry, dataPortDisabledWarning=dataPortDisabledWarning, dataPortAutoNegotiation=dataPortAutoNegotiation, receiveChannel=receiveChannel, productVariant=productVariant, userTableIndex=userTableIndex, receiveFreqMHz=receiveFreqMHz, transmitFreqKHz=transmitFreqKHz, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, aAAControlGroup=aAAControlGroup, receiveModulationModeDetail=receiveModulationModeDetail, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, systemReset=systemReset, sntp=sntp, transmitModulationMode=transmitModulationMode, telecomsChannelStatusTrap=telecomsChannelStatusTrap, groupID=groupID, sNTPLastSync=sNTPLastSync, dfsTableNumber=dfsTableNumber, PYSNMP_MODULE_ID=cambium, telecomGroup=telecomGroup, tDDControlGroup=tDDControlGroup, linkName=linkName, sNTPState=sNTPState, iPAddress=iPAddress, syslogClient=syslogClient, hTTPAccessEnabled=hTTPAccessEnabled)
