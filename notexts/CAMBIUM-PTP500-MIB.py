...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", siteName=siteName, receiveModulationMode=receiveModulationMode, sNTPSync=sNTPSync, telecom=telecom, constantPowerSpectralDensity=constantPowerSpectralDensity, configurationGroup=configurationGroup, sMTPServerIPAddress=sMTPServerIPAddress, hTTPPortNumber=hTTPPortNumber, ptpTrapPrefix=ptpTrapPrefix, dataPortAutoNegotiation=dataPortAutoNegotiation, userRole=userRole, dataPortAutoMdix=dataPortAutoMdix, aAAControl=aAAControl, linkModeOptimizationMismatch=linkModeOptimizationMismatch, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, range=range, transmitModulationMode=transmitModulationMode, snmpControl=snmpControl, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, productVariant=productVariant, receiveModulationModeDetail=receiveModulationModeDetail, syslogState=syslogState, sMTPEnabledMessages=sMTPEnabledMessages, regionCodeTrap=regionCodeTrap, pubStatsGroup=pubStatsGroup, telnetPortNumber=telnetPortNumber, vectorError=vectorError, sNMPTrapIPAddress=sNMPTrapIPAddress, unitOutOfCalibration=unitOutOfCalibration, userTable=userTable, frequencyVariant=frequencyVariant, wirelessLinkAvailability=wirelessLinkAvailability, userName=userName, sNMPTrapTableNumber=sNMPTrapTableNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, tDDSynchronizationMode=tDDSynchronizationMode, phyStatus=phyStatus, alarms=alarms, telecomsInterface=telecomsInterface, sNMPTrapPortNumber=sNMPTrapPortNumber, sntp=sntp, dataPortConfigurationMismatch=dataPortConfigurationMismatch, syslogStateTrap=syslogStateTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, managementGroup=managementGroup, supplementaryGroup=supplementaryGroup, masterSlaveMode=masterSlaveMode, ethernetFiberSupport=ethernetFiberSupport, hTTPAccessEnabled=hTTPAccessEnabled, incompatibleMasterAndSlave=incompatibleMasterAndSlave, telecomsLineCode=telecomsLineCode, snmpControlGroup=snmpControlGroup, sNMPTrapVersion=sNMPTrapVersion, telnetAccessEnabled=telnetAccessEnabled, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, PYSNMP_MODULE_ID=cambium, ptp500=ptp500, configuration=configuration, useVLANForManagementInterfaces=useVLANForManagementInterfaces, remoteIPAddress=remoteIPAddress, dfsTableIndex=dfsTableIndex, tFTPServerIPAddress=tFTPServerIPAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNTPState=sNTPState, pubStats=pubStats, dfsGroup=dfsGroup, encryption=encryption, bootVersion=bootVersion, eIRP=eIRP, signalStrengthRatio=signalStrengthRatio, targetMACAddress=targetMACAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, vLANManagementPriority=vLANManagementPriority, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, linkModeOptimisation=linkModeOptimisation, searchState=searchState, reset=reset, userTableNumber=userTableNumber, installArmStateTrap=installArmStateTrap, receiveChannel=receiveChannel, encryptionGroup=encryptionGroup, sNMPCommunityString=sNMPCommunityString, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, syslogClient=syslogClient, versionsGroup=versionsGroup, ptpCompliance=ptpCompliance, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, antennaGain=antennaGain, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, userPassword=userPassword, ethernet=ethernet, gatewayIPAddress=gatewayIPAddress, sNMPv3Enable=sNMPv3Enable, encryptionAlgorithm=encryptionAlgorithm, syslogClientTrap=syslogClientTrap, resetGroup=resetGroup, sMTPServerPortNumber=sMTPServerPortNumber, incompatibleRegionCodes=incompatibleRegionCodes, ptmp=ptmp, iPAddress=iPAddress, phyControlGroup=phyControlGroup, alarmsGroup=alarmsGroup, secondarySoftwareVersion=secondarySoftwareVersion, notificationsGroup=notificationsGroup, transmitFreqMHz=transmitFreqMHz, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, transmitPower=transmitPower, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ptpTraps=ptpTraps, sNMPTrapTable=sNMPTrapTable, cambium=cambium, sNTPLastSync=sNTPLastSync, telecomsLoopbackTrap=telecomsLoopbackTrap, vLANManagementVID=vLANManagementVID, sMTPSourceEmailAddress=sMTPSourceEmailAddress, syslogControlGroup=syslogControlGroup, telecomsCableLength=telecomsCableLength, bandwidthVariant=bandwidthVariant, hardwareVersion=hardwareVersion, installArmState=installArmState, receiveDataRate=receiveDataRate, timeZone=timeZone, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, telecomGroup=telecomGroup, softwareVersion=softwareVersion, licenceGroup=licenceGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, receiveFreqKHz=receiveFreqKHz, installStatusTrap=installStatusTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, groupID=groupID, vLANPriorityTableEntry=vLANPriorityTableEntry, hTTPSPortNumber=hTTPSPortNumber, vLANPriorityQueueMapping=vLANPriorityQueueMapping, licensedCapacity=licensedCapacity, linkSymmetry=linkSymmetry, sNTPPollInterval=sNTPPollInterval, ptp=ptp, sntpGroup=sntpGroup, smtp=smtp, syslogControl=syslogControl, telecomsChannelStatus=telecomsChannelStatus, telecomsChannelStatusTrap=telecomsChannelStatusTrap, phyControl=phyControl, latitude=latitude, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tDDControlGroup=tDDControlGroup, dfsTableNumber=dfsTableNumber, phyStatusGroup=phyStatusGroup, productName=productName, userTableEntry=userTableEntry, tDDControl=tDDControl, channelBandwidth=channelBandwidth, sNTPServerPortNumber=sNTPServerPortNumber, installStatus=installStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dfsTableEntry=dfsTableEntry, enabledDiagnosticAlarms=enabledDiagnosticAlarms, systemClock=systemClock, supplementary=supplementary, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tFTPServerPortNumber=tFTPServerPortNumber, linkLoss=linkLoss, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPEnabledTraps=sNMPEnabledTraps, sNTPSyncTrap=sNTPSyncTrap, cableLoss=cableLoss, dataPortStatus=dataPortStatus, vLANPriorityTableIndex=vLANPriorityTableIndex, daylightSaving=daylightSaving, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, receivePower=receivePower, userEnabled=userEnabled, dfsMeans=dfsMeans, ethernetGroup=ethernetGroup, aggregateDataRate=aggregateDataRate, sNMPTrapTableIndex=sNMPTrapTableIndex, byteErrorRatio=byteErrorRatio, transmitDataRate=transmitDataRate, altitude=altitude, dfsPeaks=dfsPeaks, channelChangeTrap=channelChangeTrap, transmitChannel=transmitChannel, tDDSynchronizationAlarm=tDDSynchronizationAlarm, accessMethod=accessMethod, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, versions=versions, sNTPServerIPAddress=sNTPServerIPAddress, userTableIndex=userTableIndex, systemReset=systemReset, longitude=longitude, ptpGroups=ptpGroups, vLANPriorityTableNumber=vLANPriorityTableNumber, maximumTransmitPower=maximumTransmitPower, capacityLicenseMismatch=capacityLicenseMismatch, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, regionCode=regionCode, licence=licence, sNMPPortNumber=sNMPPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dfs=dfs, aAAControlGroup=aAAControlGroup, telecomsLoopback=telecomsLoopback, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sMTPEmailAlert=sMTPEmailAlert, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, linkName=linkName, wirelessLinkStatus=wirelessLinkStatus, subnetMask=subnetMask, dfsTable=dfsTable, smtpGroup=smtpGroup, dataPortDisabledWarning=dataPortDisabledWarning, management=management, transmitFreqKHz=transmitFreqKHz, vLANPriorityTable=vLANPriorityTable, receiveFreqMHz=receiveFreqMHz, dataPortStatusTrap=dataPortStatusTrap)
