...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", maximumTransmitPower=maximumTransmitPower, sNTPServerPortNumber=sNTPServerPortNumber, ethernet=ethernet, syslogState=syslogState, antennaGain=antennaGain, licence=licence, smtp=smtp, dfsTableIndex=dfsTableIndex, encryption=encryption, sNMPTrapIPAddress=sNMPTrapIPAddress, accessMethod=accessMethod, telecomsChannelStatusTrap=telecomsChannelStatusTrap, telecomsChannelStatus=telecomsChannelStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tDDSynchronizationMode=tDDSynchronizationMode, alarms=alarms, supplementary=supplementary, dataPortConfigurationMismatch=dataPortConfigurationMismatch, syslogClientTrap=syslogClientTrap, versions=versions, dfsMeans=dfsMeans, dataPortAutoMdix=dataPortAutoMdix, aAAControl=aAAControl, sNMPTrapVersion=sNMPTrapVersion, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPTrapTableNumber=sNMPTrapTableNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, vectorError=vectorError, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, transmitFreqMHz=transmitFreqMHz, incompatibleMasterAndSlave=incompatibleMasterAndSlave, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sMTPSourceEmailAddress=sMTPSourceEmailAddress, longitude=longitude, installArmState=installArmState, supplementaryGroup=supplementaryGroup, vLANManagementVID=vLANManagementVID, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, hTTPAccessEnabled=hTTPAccessEnabled, noWirelessChannelAvailable=noWirelessChannelAvailable, vLANPriorityQueueMapping=vLANPriorityQueueMapping, dataPortAutoNegotiation=dataPortAutoNegotiation, sntpGroup=sntpGroup, linkModeOptimisation=linkModeOptimisation, dfsTable=dfsTable, userPassword=userPassword, gatewayIPAddress=gatewayIPAddress, cambium=cambium, altitude=altitude, receiveFreqKHz=receiveFreqKHz, sNTPPollInterval=sNTPPollInterval, transmitChannel=transmitChannel, wirelessLinkStatus=wirelessLinkStatus, sNMPTrapTable=sNMPTrapTable, systemReset=systemReset, vLANPriorityTable=vLANPriorityTable, productName=productName, aggregateDataRate=aggregateDataRate, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, licensedCapacity=licensedCapacity, byteErrorRatio=byteErrorRatio, softwareVersion=softwareVersion, telecomsLineCode=telecomsLineCode, sNTPSync=sNTPSync, configuration=configuration, management=management, sMTPServerPortNumber=sMTPServerPortNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, systemClock=systemClock, dfsTableEntry=dfsTableEntry, PYSNMP_MODULE_ID=cambium, telecom=telecom, telecomsLoopbackTrap=telecomsLoopbackTrap, telnetAccessEnabled=telnetAccessEnabled, syslogControl=syslogControl, targetMACAddress=targetMACAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, userTable=userTable, ptpGroups=ptpGroups, dataPortWirelessDownAlert=dataPortWirelessDownAlert, phyControlGroup=phyControlGroup, pubStats=pubStats, transmitPower=transmitPower, linkSymmetry=linkSymmetry, tDDControlGroup=tDDControlGroup, syslogStateTrap=syslogStateTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPServerIPAddress=sNTPServerIPAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, masterSlaveMode=masterSlaveMode, telecomGroup=telecomGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sMTPEnabledMessages=sMTPEnabledMessages, searchState=searchState, managementGroup=managementGroup, tFTPServerIPAddress=tFTPServerIPAddress, transmitFreqKHz=transmitFreqKHz, ptp=ptp, remoteIPAddress=remoteIPAddress, encryptionAlgorithm=encryptionAlgorithm, userRole=userRole, telecomsLoopback=telecomsLoopback, dfsTableNumber=dfsTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ptp500=ptp500, syslogLocalWrappedTrap=syslogLocalWrappedTrap, subnetMask=subnetMask, linkName=linkName, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, channelChangeTrap=channelChangeTrap, hardwareVersion=hardwareVersion, secondarySoftwareVersion=secondarySoftwareVersion, receivePower=receivePower, licenceGroup=licenceGroup, regionCode=regionCode, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPServerIPAddress=sMTPServerIPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPv3Enable=sNMPv3Enable, userTableIndex=userTableIndex, sNMPTrapTableEntry=sNMPTrapTableEntry, dfsPeaks=dfsPeaks, vLANPriorityTableNumber=vLANPriorityTableNumber, groupID=groupID, sMTPEmailAlert=sMTPEmailAlert, unitOutOfCalibration=unitOutOfCalibration, tFTPServerPortNumber=tFTPServerPortNumber, ptpCompliance=ptpCompliance, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, installStatusTrap=installStatusTrap, sNTPSyncTrap=sNTPSyncTrap, phyStatusGroup=phyStatusGroup, timeZone=timeZone, userName=userName, installArmStateTrap=installArmStateTrap, userTableNumber=userTableNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, userEnabled=userEnabled, regionCodeTrap=regionCodeTrap, iPAddress=iPAddress, sntp=sntp, frequencyVariant=frequencyVariant, transmitModulationMode=transmitModulationMode, receiveModulationMode=receiveModulationMode, range=range, eIRP=eIRP, syslogClient=syslogClient, cableLoss=cableLoss, vLANPriorityTableIndex=vLANPriorityTableIndex, bandwidthVariant=bandwidthVariant, capacityLicenseMismatch=capacityLicenseMismatch, sNMPEnabledTraps=sNMPEnabledTraps, ethernetFiberSupport=ethernetFiberSupport, wirelessLinkAvailability=wirelessLinkAvailability, syslogControlGroup=syslogControlGroup, snmpControlGroup=snmpControlGroup, configurationGroup=configurationGroup, tDDControl=tDDControl, sNTPLastSync=sNTPLastSync, dataPortStatusTrap=dataPortStatusTrap, channelBandwidth=channelBandwidth, encryptionGroup=encryptionGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, transmitDataRate=transmitDataRate, receiveFreqMHz=receiveFreqMHz, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, productVariant=productVariant, snmpControl=snmpControl, smtpGroup=smtpGroup, latitude=latitude, sNMPPortNumber=sNMPPortNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPState=sNTPState, ptmp=ptmp, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, vLANPriorityTableEntry=vLANPriorityTableEntry, dataPortStatus=dataPortStatus, alarmsGroup=alarmsGroup, telecomsInterface=telecomsInterface, daylightSaving=daylightSaving, notificationsGroup=notificationsGroup, pubStatsGroup=pubStatsGroup, ptpTrapPrefix=ptpTrapPrefix, hTTPPortNumber=hTTPPortNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, receiveModulationModeDetail=receiveModulationModeDetail, installStatus=installStatus, aAAControlGroup=aAAControlGroup, signalStrengthRatio=signalStrengthRatio, sNMPTrapPortNumber=sNMPTrapPortNumber, linkLoss=linkLoss, constantPowerSpectralDensity=constantPowerSpectralDensity, receiveDataRate=receiveDataRate, dfsGroup=dfsGroup, userTableEntry=userTableEntry, resetGroup=resetGroup, receiveChannel=receiveChannel, phyControl=phyControl, ptpTraps=ptpTraps, dfs=dfs, telecomsCableLength=telecomsCableLength, telnetPortNumber=telnetPortNumber, incompatibleRegionCodes=incompatibleRegionCodes, bootVersion=bootVersion, versionsGroup=versionsGroup, dataPortDisabledWarning=dataPortDisabledWarning, ethernetGroup=ethernetGroup, sNMPCommunityString=sNMPCommunityString, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vLANManagementPriority=vLANManagementPriority, phyStatus=phyStatus, reset=reset, hTTPSPortNumber=hTTPSPortNumber, siteName=siteName)
