...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ethernetGroup=ethernetGroup, alarmsGroup=alarmsGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, vLANPriorityQueueMapping=vLANPriorityQueueMapping, bootVersion=bootVersion, sMTPEmailAlert=sMTPEmailAlert, encryptionGroup=encryptionGroup, searchState=searchState, sNTPState=sNTPState, iPAddress=iPAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, encryption=encryption, userTableEntry=userTableEntry, hTTPSPortNumber=hTTPSPortNumber, userRole=userRole, telecom=telecom, encryptionAlgorithm=encryptionAlgorithm, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, linkModeOptimizationMismatch=linkModeOptimizationMismatch, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sMTPServerIPAddress=sMTPServerIPAddress, managementGroup=managementGroup, telecomGroup=telecomGroup, hTTPAccessEnabled=hTTPAccessEnabled, receivePower=receivePower, transmitChannel=transmitChannel, syslogStateTrap=syslogStateTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, userPassword=userPassword, supplementaryGroup=supplementaryGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ptp=ptp, vLANPriorityTableEntry=vLANPriorityTableEntry, sNMPPortNumber=sNMPPortNumber, syslogControl=syslogControl, transmitFreqMHz=transmitFreqMHz, ethernet=ethernet, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPEnabledTraps=sNMPEnabledTraps, snmpControl=snmpControl, userTableIndex=userTableIndex, dataPortStatus=dataPortStatus, remoteIPAddress=remoteIPAddress, sMTPServerPortNumber=sMTPServerPortNumber, incompatibleRegionCodes=incompatibleRegionCodes, sNMPTrapTableEntry=sNMPTrapTableEntry, telecomsLoopbackTrap=telecomsLoopbackTrap, installArmStateTrap=installArmStateTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, maximumTransmitPower=maximumTransmitPower, alarms=alarms, siteName=siteName, configurationGroup=configurationGroup, syslogClient=syslogClient, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sntp=sntp, cambium=cambium, telecomsLoopback=telecomsLoopback, cableLoss=cableLoss, versions=versions, byteErrorRatio=byteErrorRatio, ptpCompliance=ptpCompliance, groupID=groupID, tDDControl=tDDControl, sNTPPollInterval=sNTPPollInterval, dfsTableEntry=dfsTableEntry, telecomsCableLength=telecomsCableLength, installArmState=installArmState, receiveModulationMode=receiveModulationMode, vLANPriorityTable=vLANPriorityTable, phyControlGroup=phyControlGroup, hTTPPortNumber=hTTPPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapTable=sNMPTrapTable, dfsTable=dfsTable, productName=productName, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, transmitDataRate=transmitDataRate, telecomsLineCode=telecomsLineCode, snmpControlGroup=snmpControlGroup, signalStrengthRatio=signalStrengthRatio, eIRP=eIRP, constantPowerSpectralDensity=constantPowerSpectralDensity, dfsTableNumber=dfsTableNumber, daylightSaving=daylightSaving, useVLANForManagementInterfaces=useVLANForManagementInterfaces, receiveDataRate=receiveDataRate, sNTPSyncTrap=sNTPSyncTrap, vectorError=vectorError, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, tFTPServerIPAddress=tFTPServerIPAddress, dfsPeaks=dfsPeaks, ptpTraps=ptpTraps, dataPortDisabledWarning=dataPortDisabledWarning, channelChangeTrap=channelChangeTrap, targetMACAddress=targetMACAddress, ethernetFiberSupport=ethernetFiberSupport, smtpGroup=smtpGroup, dfsTableIndex=dfsTableIndex, sNMPTrapTableNumber=sNMPTrapTableNumber, softwareVersion=softwareVersion, receiveModulationModeDetail=receiveModulationModeDetail, altitude=altitude, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, phyStatus=phyStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPLastSync=sNTPLastSync, vLANManagementVID=vLANManagementVID, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortAutoMdix=dataPortAutoMdix, range=range, linkName=linkName, sNMPv3Enable=sNMPv3Enable, sNTPServerIPAddress=sNTPServerIPAddress, hardwareVersion=hardwareVersion, systemReset=systemReset, versionsGroup=versionsGroup, dfsMeans=dfsMeans, sNTPSync=sNTPSync, syslogState=syslogState, telecomsInterface=telecomsInterface, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, transmitFreqKHz=transmitFreqKHz, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, reset=reset, phyControl=phyControl, pubStatsGroup=pubStatsGroup, longitude=longitude, channelBandwidth=channelBandwidth, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, wirelessLinkAvailability=wirelessLinkAvailability, syslogClientTrap=syslogClientTrap, receiveFreqMHz=receiveFreqMHz, bandwidthVariant=bandwidthVariant, dataPortStatusTrap=dataPortStatusTrap, aAAControlGroup=aAAControlGroup, installStatus=installStatus, productVariant=productVariant, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, syslogControlGroup=syslogControlGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPCommunityString=sNMPCommunityString, masterSlaveMode=masterSlaveMode, tDDControlGroup=tDDControlGroup, aggregateDataRate=aggregateDataRate, gatewayIPAddress=gatewayIPAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, phyStatusGroup=phyStatusGroup, telecomsChannelStatus=telecomsChannelStatus, dataPortWirelessDownAlert=dataPortWirelessDownAlert, enabledDiagnosticAlarms=enabledDiagnosticAlarms, regionCodeTrap=regionCodeTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, receiveChannel=receiveChannel, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, vLANManagementPriority=vLANManagementPriority, licence=licence, installStatusTrap=installStatusTrap, licenceGroup=licenceGroup, wirelessLinkStatus=wirelessLinkStatus, ptpTrapPrefix=ptpTrapPrefix, sNTPServerPortNumber=sNTPServerPortNumber, configuration=configuration, pubStats=pubStats, dfsGroup=dfsGroup, ptmp=ptmp, userTableNumber=userTableNumber, userName=userName, telnetPortNumber=telnetPortNumber, dfs=dfs, aAAControl=aAAControl, management=management, ptp500=ptp500, accessMethod=accessMethod, licensedCapacity=licensedCapacity, antennaGain=antennaGain, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, notificationsGroup=notificationsGroup, ptpGroups=ptpGroups, subnetMask=subnetMask, linkModeOptimisation=linkModeOptimisation, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, linkLoss=linkLoss, unitOutOfCalibration=unitOutOfCalibration, transmitPower=transmitPower, sntpGroup=sntpGroup, transmitModulationMode=transmitModulationMode, userTable=userTable, smtp=smtp, tFTPServerPortNumber=tFTPServerPortNumber, userEnabled=userEnabled, supplementary=supplementary, vLANPriorityTableNumber=vLANPriorityTableNumber, frequencyVariant=frequencyVariant, sNMPTrapVersion=sNMPTrapVersion, telnetAccessEnabled=telnetAccessEnabled, systemClock=systemClock, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tDDSynchronizationStatus=tDDSynchronizationStatus, dataPortAutoNegotiation=dataPortAutoNegotiation, regionCode=regionCode, resetGroup=resetGroup, sMTPEnabledMessages=sMTPEnabledMessages, linkSymmetry=linkSymmetry, timeZone=timeZone, capacityLicenseMismatch=capacityLicenseMismatch, PYSNMP_MODULE_ID=cambium, receiveFreqKHz=receiveFreqKHz, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tDDSynchronizationMode=tDDSynchronizationMode, latitude=latitude)
