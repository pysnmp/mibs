...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", telecomsInterface=telecomsInterface, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dfsPeaks=dfsPeaks, notificationsGroup=notificationsGroup, phyControl=phyControl, dataPortAutoNegotiation=dataPortAutoNegotiation, telecomsCableLength=telecomsCableLength, sNMPv3Enable=sNMPv3Enable, receiveFreqMHz=receiveFreqMHz, searchState=searchState, sMTPEnabledMessages=sMTPEnabledMessages, frequencyVariant=frequencyVariant, transmitChannel=transmitChannel, userPassword=userPassword, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, snmpControl=snmpControl, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, telecomsChannelStatus=telecomsChannelStatus, linkSymmetry=linkSymmetry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNTPSyncTrap=sNTPSyncTrap, transmitModulationMode=transmitModulationMode, syslogLocalWrappedTrap=syslogLocalWrappedTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, gatewayIPAddress=gatewayIPAddress, userTableNumber=userTableNumber, installArmState=installArmState, telecomsLoopback=telecomsLoopback, tDDControl=tDDControl, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, receiveModulationModeDetail=receiveModulationModeDetail, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, systemClock=systemClock, dfsTableIndex=dfsTableIndex, licence=licence, syslogControlGroup=syslogControlGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, wirelessLinkStatus=wirelessLinkStatus, productVariant=productVariant, channelBandwidth=channelBandwidth, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ptpCompliance=ptpCompliance, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortAutoMdix=dataPortAutoMdix, sNMPTrapTableEntry=sNMPTrapTableEntry, cableLoss=cableLoss, tDDSynchronizationStatus=tDDSynchronizationStatus, aAAControlGroup=aAAControlGroup, telecomGroup=telecomGroup, eIRP=eIRP, versionsGroup=versionsGroup, userName=userName, capacityLicenseMismatch=capacityLicenseMismatch, vLANManagementVID=vLANManagementVID, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, byteErrorRatio=byteErrorRatio, telnetPortNumber=telnetPortNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, sMTPEmailAlert=sMTPEmailAlert, dataPortConfigurationMismatch=dataPortConfigurationMismatch, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, longitude=longitude, sMTPServerPortNumber=sMTPServerPortNumber, pubStats=pubStats, cambium=cambium, dataPortStatusTrap=dataPortStatusTrap, alarmsGroup=alarmsGroup, reset=reset, masterSlaveMode=masterSlaveMode, supplementary=supplementary, snmpControlGroup=snmpControlGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sMTPSourceEmailAddress=sMTPSourceEmailAddress, syslogState=syslogState, altitude=altitude, accessMethod=accessMethod, sNMPTrapVersion=sNMPTrapVersion, ethernetFiberSupport=ethernetFiberSupport, hTTPPortNumber=hTTPPortNumber, daylightSaving=daylightSaving, siteName=siteName, phyStatusGroup=phyStatusGroup, linkName=linkName, transmitFreqKHz=transmitFreqKHz, installArmStateTrap=installArmStateTrap, systemReset=systemReset, sNTPServerIPAddress=sNTPServerIPAddress, transmitFreqMHz=transmitFreqMHz, secondarySoftwareVersion=secondarySoftwareVersion, telnetAccessEnabled=telnetAccessEnabled, userRole=userRole, linkModeOptimisation=linkModeOptimisation, receivePower=receivePower, channelChangeTrap=channelChangeTrap, encryptionAlgorithm=encryptionAlgorithm, dataPortStatus=dataPortStatus, regionCode=regionCode, phyStatus=phyStatus, installStatus=installStatus, productName=productName, transmitPower=transmitPower, tDDSynchronizationAlarm=tDDSynchronizationAlarm, managementGroup=managementGroup, latitude=latitude, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, hTTPAccessEnabled=hTTPAccessEnabled, ptp500=ptp500, dfsMeans=dfsMeans, syslogStateTrap=syslogStateTrap, ptpTrapPrefix=ptpTrapPrefix, tFTPServerPortNumber=tFTPServerPortNumber, resetGroup=resetGroup, maximumTransmitPower=maximumTransmitPower, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, configurationGroup=configurationGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, linkModeOptimizationMismatch=linkModeOptimizationMismatch, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, smtpGroup=smtpGroup, sNMPPortNumber=sNMPPortNumber, phyControlGroup=phyControlGroup, range=range, vLANPriorityTable=vLANPriorityTable, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, antennaGain=antennaGain, userTableEntry=userTableEntry, userTableIndex=userTableIndex, sNTPLastSync=sNTPLastSync, vLANPriorityTableIndex=vLANPriorityTableIndex, vLANManagementPriority=vLANManagementPriority, remoteIPAddress=remoteIPAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, vectorError=vectorError, hTTPSPortNumber=hTTPSPortNumber, alarms=alarms, syslogControl=syslogControl, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, syslogClient=syslogClient, dfsTableEntry=dfsTableEntry, sntpGroup=sntpGroup, receiveModulationMode=receiveModulationMode, sNTPPollInterval=sNTPPollInterval, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, incompatibleRegionCodes=incompatibleRegionCodes, iPAddress=iPAddress, sNMPTrapTable=sNMPTrapTable, softwareVersion=softwareVersion, transmitDataRate=transmitDataRate, vLANPriorityTableEntry=vLANPriorityTableEntry, aAAControl=aAAControl, unitOutOfCalibration=unitOutOfCalibration, bootVersion=bootVersion, aggregateDataRate=aggregateDataRate, telecomsChannelStatusTrap=telecomsChannelStatusTrap, receiveFreqKHz=receiveFreqKHz, supplementaryGroup=supplementaryGroup, sNTPState=sNTPState, noWirelessChannelAvailable=noWirelessChannelAvailable, telecom=telecom, receiveDataRate=receiveDataRate, sNMPEnabledTraps=sNMPEnabledTraps, ptp=ptp, timeZone=timeZone, installStatusTrap=installStatusTrap, telecomsLineCode=telecomsLineCode, syslogClientTrap=syslogClientTrap, sNTPSync=sNTPSync, ethernetGroup=ethernetGroup, signalStrengthRatio=signalStrengthRatio, encryption=encryption, receiveChannel=receiveChannel, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, bandwidthVariant=bandwidthVariant, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ptpGroups=ptpGroups, userTable=userTable, sNMPCommunityString=sNMPCommunityString, tDDControlGroup=tDDControlGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPServerIPAddress=sMTPServerIPAddress, targetMACAddress=targetMACAddress, sntp=sntp, regionCodeTrap=regionCodeTrap, userEnabled=userEnabled, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ethernet=ethernet, tDDSynchronizationMode=tDDSynchronizationMode, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dfsTable=dfsTable, subnetMask=subnetMask, configuration=configuration, PYSNMP_MODULE_ID=cambium, dfsGroup=dfsGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, constantPowerSpectralDensity=constantPowerSpectralDensity, dfsTableNumber=dfsTableNumber, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, hardwareVersion=hardwareVersion, licensedCapacity=licensedCapacity, wirelessLinkAvailability=wirelessLinkAvailability, pubStatsGroup=pubStatsGroup, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, management=management, linkLoss=linkLoss, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortDisabledWarning=dataPortDisabledWarning, versions=versions, ptmp=ptmp, sNTPServerPortNumber=sNTPServerPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, dfs=dfs, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, smtp=smtp, encryptionGroup=encryptionGroup, licenceGroup=licenceGroup, groupID=groupID, ptpTraps=ptpTraps)
