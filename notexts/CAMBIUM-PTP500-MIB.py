...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPLastSync=sNTPLastSync, snmpControl=snmpControl, userTableEntry=userTableEntry, ptp=ptp, encryption=encryption, altitude=altitude, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ptpCompliance=ptpCompliance, smtpGroup=smtpGroup, vLANPriorityTable=vLANPriorityTable, dfsTableNumber=dfsTableNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, gatewayIPAddress=gatewayIPAddress, dfs=dfs, syslogClient=syslogClient, receiveDataRate=receiveDataRate, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNMPTrapVersion=sNMPTrapVersion, vectorError=vectorError, vLANManagementPriority=vLANManagementPriority, ptpTraps=ptpTraps, reset=reset, sNMPv3Enable=sNMPv3Enable, PYSNMP_MODULE_ID=cambium, receivePower=receivePower, dfsMeans=dfsMeans, userRole=userRole, installArmStateTrap=installArmStateTrap, dataPortAutoMdix=dataPortAutoMdix, linkLoss=linkLoss, sMTPEmailAlert=sMTPEmailAlert, userTableNumber=userTableNumber, receiveFreqKHz=receiveFreqKHz, syslogControl=syslogControl, dataPortStatusTrap=dataPortStatusTrap, productVariant=productVariant, userEnabled=userEnabled, aAAControlGroup=aAAControlGroup, phyControl=phyControl, sNTPServerPortNumber=sNTPServerPortNumber, daylightSaving=daylightSaving, channelBandwidth=channelBandwidth, sNMPTrapTableEntry=sNMPTrapTableEntry, receiveChannel=receiveChannel, snmpControlGroup=snmpControlGroup, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sntp=sntp, vLANPriorityQueueMapping=vLANPriorityQueueMapping, telecomsLoopback=telecomsLoopback, transmitFreqMHz=transmitFreqMHz, userPassword=userPassword, sNMPTrapTableIndex=sNMPTrapTableIndex, alarms=alarms, ptp500=ptp500, linkModeOptimizationMismatch=linkModeOptimizationMismatch, frequencyVariant=frequencyVariant, transmitPower=transmitPower, management=management, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, masterSlaveMode=masterSlaveMode, latitude=latitude, dfsPeaks=dfsPeaks, softwareVersion=softwareVersion, telecomsInterface=telecomsInterface, sNMPEnabledTraps=sNMPEnabledTraps, systemReset=systemReset, ptmp=ptmp, vLANManagementVID=vLANManagementVID, sntpGroup=sntpGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ethernet=ethernet, linkSymmetry=linkSymmetry, aggregateDataRate=aggregateDataRate, transmitDataRate=transmitDataRate, sNTPSync=sNTPSync, configurationGroup=configurationGroup, siteName=siteName, remoteIPAddress=remoteIPAddress, wirelessLinkStatus=wirelessLinkStatus, telecomsLoopbackTrap=telecomsLoopbackTrap, sMTPServerPortNumber=sMTPServerPortNumber, ethernetGroup=ethernetGroup, installStatusTrap=installStatusTrap, tDDControlGroup=tDDControlGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, cambium=cambium, dataPortStatus=dataPortStatus, pubStats=pubStats, vLANPriorityTableEntry=vLANPriorityTableEntry, hTTPPortNumber=hTTPPortNumber, supplementary=supplementary, linkModeOptimisation=linkModeOptimisation, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapTable=sNMPTrapTable, sNMPCommunityString=sNMPCommunityString, signalStrengthRatio=signalStrengthRatio, pubStatsGroup=pubStatsGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, systemClock=systemClock, bootVersion=bootVersion, syslogClientTrap=syslogClientTrap, cableLoss=cableLoss, notificationsGroup=notificationsGroup, licensedCapacity=licensedCapacity, wirelessLinkAvailability=wirelessLinkAvailability, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, iPAddress=iPAddress, telnetAccessEnabled=telnetAccessEnabled, timeZone=timeZone, ptpGroups=ptpGroups, syslogControlGroup=syslogControlGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, phyControlGroup=phyControlGroup, bandwidthVariant=bandwidthVariant, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, aAAControl=aAAControl, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, encryptionAlgorithm=encryptionAlgorithm, transmitFreqKHz=transmitFreqKHz, configuration=configuration, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ethernetFiberSupport=ethernetFiberSupport, antennaGain=antennaGain, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, installStatus=installStatus, licence=licence, hTTPAccessEnabled=hTTPAccessEnabled, receiveModulationMode=receiveModulationMode, secondarySoftwareVersion=secondarySoftwareVersion, transmitModulationMode=transmitModulationMode, range=range, installArmState=installArmState, tDDControl=tDDControl, resetGroup=resetGroup, syslogState=syslogState, licenceGroup=licenceGroup, userTable=userTable, hTTPSPortNumber=hTTPSPortNumber, telecomsChannelStatus=telecomsChannelStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPServerIPAddress=sNTPServerIPAddress, hardwareVersion=hardwareVersion, sNTPSyncTrap=sNTPSyncTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortDisabledWarning=dataPortDisabledWarning, dfsTableEntry=dfsTableEntry, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tDDSynchronizationMode=tDDSynchronizationMode, versions=versions, encryptionGroup=encryptionGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, telecomsLineCode=telecomsLineCode, alarmsGroup=alarmsGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dfsTableIndex=dfsTableIndex, eIRP=eIRP, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tFTPServerPortNumber=tFTPServerPortNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, transmitChannel=transmitChannel, sNTPPollInterval=sNTPPollInterval, dfsGroup=dfsGroup, managementGroup=managementGroup, receiveFreqMHz=receiveFreqMHz, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telecom=telecom, dataPortWirelessDownAlert=dataPortWirelessDownAlert, maximumTransmitPower=maximumTransmitPower, sNMPTrapTableNumber=sNMPTrapTableNumber, receiveModulationModeDetail=receiveModulationModeDetail, versionsGroup=versionsGroup, targetMACAddress=targetMACAddress, telnetPortNumber=telnetPortNumber, linkName=linkName, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, byteErrorRatio=byteErrorRatio, vLANPriorityTableIndex=vLANPriorityTableIndex, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsTable=dfsTable, accessMethod=accessMethod, supplementaryGroup=supplementaryGroup, incompatibleRegionCodes=incompatibleRegionCodes, capacityLicenseMismatch=capacityLicenseMismatch, regionCodeTrap=regionCodeTrap, telecomGroup=telecomGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, unitOutOfCalibration=unitOutOfCalibration, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, userName=userName, dataPortAutoNegotiation=dataPortAutoNegotiation, productName=productName, smtp=smtp, subnetMask=subnetMask, phyStatus=phyStatus, telecomsCableLength=telecomsCableLength, regionCode=regionCode, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPEnabledMessages=sMTPEnabledMessages, vLANPriorityTableNumber=vLANPriorityTableNumber, sNTPState=sNTPState, longitude=longitude, searchState=searchState, sNMPPortNumber=sNMPPortNumber, sMTPServerIPAddress=sMTPServerIPAddress, phyStatusGroup=phyStatusGroup, tFTPServerIPAddress=tFTPServerIPAddress, syslogStateTrap=syslogStateTrap, channelChangeTrap=channelChangeTrap, groupID=groupID, userTableIndex=userTableIndex)
