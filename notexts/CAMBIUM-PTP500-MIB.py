...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", wirelessLinkAvailability=wirelessLinkAvailability, reset=reset, syslogControl=syslogControl, vLANPriorityQueueMapping=vLANPriorityQueueMapping, tFTPServerIPAddress=tFTPServerIPAddress, hTTPSPortNumber=hTTPSPortNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, hardwareVersion=hardwareVersion, encryptionGroup=encryptionGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPLastSync=sNTPLastSync, telnetAccessEnabled=telnetAccessEnabled, subnetMask=subnetMask, tDDControlGroup=tDDControlGroup, receiveFreqMHz=receiveFreqMHz, ptp500=ptp500, altitude=altitude, siteName=siteName, systemReset=systemReset, userPassword=userPassword, supplementaryGroup=supplementaryGroup, searchState=searchState, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPPollInterval=sNTPPollInterval, channelBandwidth=channelBandwidth, bootVersion=bootVersion, tDDSynchronizationMode=tDDSynchronizationMode, managementGroup=managementGroup, licence=licence, sNMPTrapVersion=sNMPTrapVersion, dfsTable=dfsTable, phyControlGroup=phyControlGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, capacityLicenseMismatch=capacityLicenseMismatch, telecom=telecom, dfsTableNumber=dfsTableNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, range=range, vectorError=vectorError, syslogStateTrap=syslogStateTrap, telecomGroup=telecomGroup, regionCodeTrap=regionCodeTrap, dfs=dfs, transmitChannel=transmitChannel, bandwidthVariant=bandwidthVariant, remoteMaximumTransmitPower=remoteMaximumTransmitPower, daylightSaving=daylightSaving, userEnabled=userEnabled, alarmsGroup=alarmsGroup, userName=userName, dataPortConfigurationMismatch=dataPortConfigurationMismatch, userTable=userTable, dfsTableIndex=dfsTableIndex, aAAControlGroup=aAAControlGroup, aggregateDataRate=aggregateDataRate, masterSlaveMode=masterSlaveMode, linkLoss=linkLoss, receiveChannel=receiveChannel, dataPortStatus=dataPortStatus, receiveModulationModeDetail=receiveModulationModeDetail, frequencyVariant=frequencyVariant, telecomsLineCode=telecomsLineCode, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, pubStats=pubStats, accessMethod=accessMethod, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, sNMPPortNumber=sNMPPortNumber, iPAddress=iPAddress, softwareVersion=softwareVersion, sMTPEnabledMessages=sMTPEnabledMessages, vLANPriorityTable=vLANPriorityTable, transmitPower=transmitPower, aAAControl=aAAControl, sMTPServerPortNumber=sMTPServerPortNumber, userTableNumber=userTableNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sntp=sntp, sMTPSourceEmailAddress=sMTPSourceEmailAddress, systemClock=systemClock, userRole=userRole, signalStrengthRatio=signalStrengthRatio, regionCode=regionCode, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sMTPServerIPAddress=sMTPServerIPAddress, syslogState=syslogState, ptpGroups=ptpGroups, groupID=groupID, smtpGroup=smtpGroup, installStatus=installStatus, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, notificationsGroup=notificationsGroup, configurationGroup=configurationGroup, hTTPAccessEnabled=hTTPAccessEnabled, sNMPv3Enable=sNMPv3Enable, configuration=configuration, cableLoss=cableLoss, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernet=ethernet, smtp=smtp, vLANManagementPriority=vLANManagementPriority, sNMPTrapIPAddress=sNMPTrapIPAddress, telnetPortNumber=telnetPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, byteErrorRatio=byteErrorRatio, tDDSynchronizationStatus=tDDSynchronizationStatus, installStatusTrap=installStatusTrap, productVariant=productVariant, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortStatusTrap=dataPortStatusTrap, phyStatus=phyStatus, syslogControlGroup=syslogControlGroup, sMTPEmailAlert=sMTPEmailAlert, telecomsChannelStatus=telecomsChannelStatus, ptp=ptp, telecomsCableLength=telecomsCableLength, vLANPriorityTableEntry=vLANPriorityTableEntry, versions=versions, versionsGroup=versionsGroup, resetGroup=resetGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, installArmStateTrap=installArmStateTrap, transmitFreqMHz=transmitFreqMHz, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, targetMACAddress=targetMACAddress, ethernetFiberSupport=ethernetFiberSupport, licenceGroup=licenceGroup, dfsMeans=dfsMeans, dataPortAutoMdix=dataPortAutoMdix, telecomsChannelStatusTrap=telecomsChannelStatusTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, secondarySoftwareVersion=secondarySoftwareVersion, receiveDataRate=receiveDataRate, alarms=alarms, PYSNMP_MODULE_ID=cambium, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, syslogClientTrap=syslogClientTrap, ethernetGroup=ethernetGroup, sntpGroup=sntpGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, receivePower=receivePower, snmpControl=snmpControl, tDDControl=tDDControl, ptpTraps=ptpTraps, maximumTransmitPower=maximumTransmitPower, vLANPriorityTableIndex=vLANPriorityTableIndex, hTTPSAccessEnabled=hTTPSAccessEnabled, snmpControlGroup=snmpControlGroup, timeZone=timeZone, phyStatusGroup=phyStatusGroup, encryptionAlgorithm=encryptionAlgorithm, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, receiveModulationMode=receiveModulationMode, dfsTableEntry=dfsTableEntry, phyControl=phyControl, telecomsInterface=telecomsInterface, hTTPPortNumber=hTTPPortNumber, gatewayIPAddress=gatewayIPAddress, linkModeOptimisation=linkModeOptimisation, wirelessLinkStatus=wirelessLinkStatus, userTableEntry=userTableEntry, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPState=sNTPState, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, vLANPriorityTableNumber=vLANPriorityTableNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, transmitFreqKHz=transmitFreqKHz, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, encryption=encryption, licensedCapacity=licensedCapacity, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNTPSync=sNTPSync, antennaGain=antennaGain, sNTPServerPortNumber=sNTPServerPortNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, telecomsLoopback=telecomsLoopback, telecomsLoopbackTrap=telecomsLoopbackTrap, eIRP=eIRP, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptpCompliance=ptpCompliance, sNTPSyncTrap=sNTPSyncTrap, transmitDataRate=transmitDataRate, vLANManagementVID=vLANManagementVID, dfsGroup=dfsGroup, supplementary=supplementary, dfsPeaks=dfsPeaks, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ptpTrapPrefix=ptpTrapPrefix, sNMPEnabledTraps=sNMPEnabledTraps, channelChangeTrap=channelChangeTrap, syslogClient=syslogClient, userTableIndex=userTableIndex, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, receiveFreqKHz=receiveFreqKHz, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dataPortDisabledWarning=dataPortDisabledWarning, ptmp=ptmp, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPCommunityString=sNMPCommunityString, linkSymmetry=linkSymmetry, sNMPTrapTable=sNMPTrapTable, incompatibleRegionCodes=incompatibleRegionCodes, remoteIPAddress=remoteIPAddress, transmitModulationMode=transmitModulationMode, cambium=cambium, management=management, useVLANForManagementInterfaces=useVLANForManagementInterfaces, installArmState=installArmState, latitude=latitude, linkName=linkName, pubStatsGroup=pubStatsGroup, productName=productName, sNTPServerIPAddress=sNTPServerIPAddress, longitude=longitude, unitOutOfCalibration=unitOutOfCalibration)
