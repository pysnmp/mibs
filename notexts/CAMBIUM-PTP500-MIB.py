...
Gauge32, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, MibIdentifier, enterprises, Counter32, iso, NotificationType, Counter64, Unsigned32, TimeTicks, Integer32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "MibIdentifier", "enterprises", "Counter32", "iso", "NotificationType", "Counter64", "Unsigned32", "TimeTicks", "Integer32", "ObjectIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", reset=reset, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, searchState=searchState, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, telecomGroup=telecomGroup, transmitFreqKHz=transmitFreqKHz, wirelessLinkStatus=wirelessLinkStatus, ptp500=ptp500, maximumTransmitPower=maximumTransmitPower, remoteIPAddress=remoteIPAddress, vLANPriorityQueueMapping=vLANPriorityQueueMapping, telecomsChannelStatus=telecomsChannelStatus, receiveModulationMode=receiveModulationMode, timeZone=timeZone, tDDSynchronizationMode=tDDSynchronizationMode, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNMPTrapTableNumber=sNMPTrapTableNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dfsGroup=dfsGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, channelChangeTrap=channelChangeTrap, secondarySoftwareVersion=secondarySoftwareVersion, licence=licence, configurationGroup=configurationGroup, phyControl=phyControl, telecomsCableLength=telecomsCableLength, dfsTableNumber=dfsTableNumber, receivePower=receivePower, ptpTraps=ptpTraps, phyStatusGroup=phyStatusGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, vLANPriorityTable=vLANPriorityTable, resetGroup=resetGroup, hTTPPortNumber=hTTPPortNumber, ptmp=ptmp, encryptionAlgorithm=encryptionAlgorithm, targetMACAddress=targetMACAddress, notificationsGroup=notificationsGroup, frequencyVariant=frequencyVariant, masterSlaveMode=masterSlaveMode, bandwidthVariant=bandwidthVariant, incompatibleRegionCodes=incompatibleRegionCodes, userRole=userRole, vLANManagementPriority=vLANManagementPriority, sMTPEmailAlert=sMTPEmailAlert, dfsPeaks=dfsPeaks, ptpCompliance=ptpCompliance, telecomsInterface=telecomsInterface, siteName=siteName, telecomsChannelStatusTrap=telecomsChannelStatusTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfs=dfs, smtp=smtp, sNTPSync=sNTPSync, sNMPTrapPortNumber=sNMPTrapPortNumber, tDDControl=tDDControl, dfsTable=dfsTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, syslogControl=syslogControl, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ethernetGroup=ethernetGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, iPAddress=iPAddress, PYSNMP_MODULE_ID=cambium, telecomsLoopback=telecomsLoopback, userTableNumber=userTableNumber, telecomsLoopbackTrap=telecomsLoopbackTrap, phyStatus=phyStatus, ethernetFiberSupport=ethernetFiberSupport, constantPowerSpectralDensity=constantPowerSpectralDensity, regionCodeTrap=regionCodeTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, vectorError=vectorError, dataPortConfigurationMismatch=dataPortConfigurationMismatch, hardwareVersion=hardwareVersion, pubStatsGroup=pubStatsGroup, userPassword=userPassword, gatewayIPAddress=gatewayIPAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, linkModeOptimisation=linkModeOptimisation, eIRP=eIRP, linkModeOptimizationMismatch=linkModeOptimizationMismatch, softwareVersion=softwareVersion, linkLoss=linkLoss, sntp=sntp, receiveFreqMHz=receiveFreqMHz, regionCode=regionCode, userName=userName, syslogControlGroup=syslogControlGroup, licenceGroup=licenceGroup, transmitDataRate=transmitDataRate, productVariant=productVariant, sNTPLastSync=sNTPLastSync, cableLoss=cableLoss, dataPortAutoMdix=dataPortAutoMdix, dataPortStatus=dataPortStatus, management=management, subnetMask=subnetMask, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tFTPServerIPAddress=tFTPServerIPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, aAAControlGroup=aAAControlGroup, dataPortDisabledWarning=dataPortDisabledWarning, hTTPAccessEnabled=hTTPAccessEnabled, telnetAccessEnabled=telnetAccessEnabled, versions=versions, managementGroup=managementGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPPollInterval=sNTPPollInterval, sMTPServerIPAddress=sMTPServerIPAddress, sNMPEnabledTraps=sNMPEnabledTraps, versionsGroup=versionsGroup, groupID=groupID, alarmsGroup=alarmsGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, altitude=altitude, tFTPServerPortNumber=tFTPServerPortNumber, syslogClient=syslogClient, receiveChannel=receiveChannel, systemClock=systemClock, aggregateDataRate=aggregateDataRate, syslogState=syslogState, telecom=telecom, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, pubStats=pubStats, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dfsTableEntry=dfsTableEntry, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, userTableEntry=userTableEntry, dataPortWirelessDownAlert=dataPortWirelessDownAlert, vLANPriorityTableIndex=vLANPriorityTableIndex, userEnabled=userEnabled, channelBandwidth=channelBandwidth, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tDDSynchronizationAlarm=tDDSynchronizationAlarm, encryption=encryption, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sMTPEnabledMessages=sMTPEnabledMessages, sNMPPortNumber=sNMPPortNumber, bootVersion=bootVersion, longitude=longitude, configuration=configuration, linkName=linkName, sntpGroup=sntpGroup, phyControlGroup=phyControlGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ptp=ptp, licensedCapacity=licensedCapacity, byteErrorRatio=byteErrorRatio, snmpControl=snmpControl, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPv3Enable=sNMPv3Enable, receiveFreqKHz=receiveFreqKHz, receiveDataRate=receiveDataRate, sNTPState=sNTPState, ethernet=ethernet, snmpControlGroup=snmpControlGroup, installStatusTrap=installStatusTrap, syslogClientTrap=syslogClientTrap, receiveModulationModeDetail=receiveModulationModeDetail, telnetPortNumber=telnetPortNumber, systemReset=systemReset, ptpTrapPrefix=ptpTrapPrefix, transmitChannel=transmitChannel, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, unitOutOfCalibration=unitOutOfCalibration, daylightSaving=daylightSaving, latitude=latitude, transmitFreqMHz=transmitFreqMHz, supplementaryGroup=supplementaryGroup, sMTPServerPortNumber=sMTPServerPortNumber, installArmStateTrap=installArmStateTrap, smtpGroup=smtpGroup, alarms=alarms, dfsTableIndex=dfsTableIndex, sNTPServerPortNumber=sNTPServerPortNumber, sNMPTrapTable=sNMPTrapTable, transmitPower=transmitPower, transmitModulationMode=transmitModulationMode, vLANPriorityTableNumber=vLANPriorityTableNumber, userTable=userTable, installStatus=installStatus, vLANPriorityTableEntry=vLANPriorityTableEntry, range=range, ptpGroups=ptpGroups, hTTPSAccessEnabled=hTTPSAccessEnabled, wirelessLinkAvailability=wirelessLinkAvailability, signalStrengthRatio=signalStrengthRatio, dataPortStatusTrap=dataPortStatusTrap, syslogStateTrap=syslogStateTrap, supplementary=supplementary, sNMPTrapVersion=sNMPTrapVersion, cambium=cambium, accessMethod=accessMethod, installArmState=installArmState, tDDSynchronizationStatus=tDDSynchronizationStatus, antennaGain=antennaGain, aAAControl=aAAControl, encryptionGroup=encryptionGroup, dfsMeans=dfsMeans, userTableIndex=userTableIndex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkSymmetry=linkSymmetry, telecomsLineCode=telecomsLineCode, capacityLicenseMismatch=capacityLicenseMismatch, syslogLocalWrappedTrap=syslogLocalWrappedTrap, productName=productName, hTTPSPortNumber=hTTPSPortNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPSyncTrap=sNTPSyncTrap, vLANManagementVID=vLANManagementVID, sNMPCommunityString=sNMPCommunityString, sNTPServerIPAddress=sNTPServerIPAddress, tDDControlGroup=tDDControlGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap)
