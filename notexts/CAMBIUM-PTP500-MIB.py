...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", dfsTable=dfsTable, regionCodeTrap=regionCodeTrap, receiveModulationModeDetail=receiveModulationModeDetail, snmpControlGroup=snmpControlGroup, transmitFreqMHz=transmitFreqMHz, sNTPLastSync=sNTPLastSync, syslogStateTrap=syslogStateTrap, dfs=dfs, supplementaryGroup=supplementaryGroup, secondarySoftwareVersion=secondarySoftwareVersion, sntpGroup=sntpGroup, targetMACAddress=targetMACAddress, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPSync=sNTPSync, vLANManagementPriority=vLANManagementPriority, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, siteName=siteName, tFTPServerPortNumber=tFTPServerPortNumber, byteErrorRatio=byteErrorRatio, managementGroup=managementGroup, dataPortAutoMdix=dataPortAutoMdix, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, vectorError=vectorError, receiveModulationMode=receiveModulationMode, encryption=encryption, timeZone=timeZone, bootVersion=bootVersion, encryptionAlgorithm=encryptionAlgorithm, incompatibleMasterAndSlave=incompatibleMasterAndSlave, phyControl=phyControl, telecomsLineCode=telecomsLineCode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, reset=reset, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tFTPServerIPAddress=tFTPServerIPAddress, smtpGroup=smtpGroup, syslogClientTrap=syslogClientTrap, syslogControlGroup=syslogControlGroup, groupID=groupID, subnetMask=subnetMask, notificationsGroup=notificationsGroup, telecomsCableLength=telecomsCableLength, eIRP=eIRP, cableLoss=cableLoss, altitude=altitude, productVariant=productVariant, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNTPSyncTrap=sNTPSyncTrap, phyStatus=phyStatus, sNTPPollInterval=sNTPPollInterval, sNTPServerPortNumber=sNTPServerPortNumber, syslogState=syslogState, sMTPEmailAlert=sMTPEmailAlert, latitude=latitude, sNMPEnabledTraps=sNMPEnabledTraps, userTableEntry=userTableEntry, vLANPriorityTableNumber=vLANPriorityTableNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, management=management, sNMPCommunityString=sNMPCommunityString, telecomGroup=telecomGroup, installStatusTrap=installStatusTrap, sntp=sntp, ptpTrapPrefix=ptpTrapPrefix, dfsPeaks=dfsPeaks, transmitPower=transmitPower, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, userTable=userTable, noWirelessChannelAvailable=noWirelessChannelAvailable, ptpCompliance=ptpCompliance, sNMPTrapIPAddress=sNMPTrapIPAddress, versions=versions, wirelessLinkStatus=wirelessLinkStatus, vLANPriorityQueueMapping=vLANPriorityQueueMapping, receiveFreqKHz=receiveFreqKHz, regionCode=regionCode, sNMPPortNumber=sNMPPortNumber, ptpTraps=ptpTraps, licenceGroup=licenceGroup, snmpControl=snmpControl, configurationGroup=configurationGroup, dfsTableIndex=dfsTableIndex, hTTPSPortNumber=hTTPSPortNumber, dataPortDisabledWarning=dataPortDisabledWarning, sMTPServerPortNumber=sMTPServerPortNumber, sNTPState=sNTPState, ptp500=ptp500, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tDDControl=tDDControl, linkLoss=linkLoss, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, telnetPortNumber=telnetPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPv3Enable=sNMPv3Enable, telecom=telecom, channelChangeTrap=channelChangeTrap, telecomsLoopback=telecomsLoopback, dataPortAutoNegotiation=dataPortAutoNegotiation, phyControlGroup=phyControlGroup, tDDControlGroup=tDDControlGroup, transmitChannel=transmitChannel, sNMPTrapTableIndex=sNMPTrapTableIndex, telecomsChannelStatus=telecomsChannelStatus, systemClock=systemClock, remoteIPAddress=remoteIPAddress, transmitDataRate=transmitDataRate, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, searchState=searchState, userRole=userRole, ptp=ptp, sMTPEnabledMessages=sMTPEnabledMessages, hTTPPortNumber=hTTPPortNumber, receiveFreqMHz=receiveFreqMHz, alarmsGroup=alarmsGroup, receivePower=receivePower, antennaGain=antennaGain, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, encryptionGroup=encryptionGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, supplementary=supplementary, sNMPTrapVersion=sNMPTrapVersion, dataPortConfigurationMismatch=dataPortConfigurationMismatch, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, alarms=alarms, userTableIndex=userTableIndex, iPAddress=iPAddress, PYSNMP_MODULE_ID=cambium, hTTPAccessEnabled=hTTPAccessEnabled, syslogControl=syslogControl, capacityLicenseMismatch=capacityLicenseMismatch, softwareVersion=softwareVersion, licence=licence, pubStatsGroup=pubStatsGroup, linkName=linkName, bandwidthVariant=bandwidthVariant, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, configuration=configuration, resetGroup=resetGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, phyStatusGroup=phyStatusGroup, telnetAccessEnabled=telnetAccessEnabled, accessMethod=accessMethod, dfsMeans=dfsMeans, useVLANForManagementInterfaces=useVLANForManagementInterfaces, signalStrengthRatio=signalStrengthRatio, systemReset=systemReset, aggregateDataRate=aggregateDataRate, pubStats=pubStats, ethernetFiberSupport=ethernetFiberSupport, masterSlaveMode=masterSlaveMode, userTableNumber=userTableNumber, aAAControl=aAAControl, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, telecomsLoopbackTrap=telecomsLoopbackTrap, dfsTableEntry=dfsTableEntry, receiveDataRate=receiveDataRate, transmitModulationMode=transmitModulationMode, sNTPServerIPAddress=sNTPServerIPAddress, smtp=smtp, channelBandwidth=channelBandwidth, telecomsInterface=telecomsInterface, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, userPassword=userPassword, constantPowerSpectralDensity=constantPowerSpectralDensity, linkModeOptimisation=linkModeOptimisation, sNMPTrapTableEntry=sNMPTrapTableEntry, transmitFreqKHz=transmitFreqKHz, ptpGroups=ptpGroups, aAAControlGroup=aAAControlGroup, hardwareVersion=hardwareVersion, sMTPServerIPAddress=sMTPServerIPAddress, versionsGroup=versionsGroup, linkSymmetry=linkSymmetry, range=range, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, userEnabled=userEnabled, wirelessLinkAvailability=wirelessLinkAvailability, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortStatus=dataPortStatus, telecomsChannelStatusTrap=telecomsChannelStatusTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, syslogClient=syslogClient, tDDSynchronizationStatus=tDDSynchronizationStatus, ethernet=ethernet, installArmStateTrap=installArmStateTrap, dfsTableNumber=dfsTableNumber, gatewayIPAddress=gatewayIPAddress, frequencyVariant=frequencyVariant, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, maximumTransmitPower=maximumTransmitPower, vLANManagementVID=vLANManagementVID, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, vLANPriorityTableIndex=vLANPriorityTableIndex, vLANPriorityTable=vLANPriorityTable, incompatibleRegionCodes=incompatibleRegionCodes, ptmp=ptmp, cambium=cambium, installStatus=installStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, unitOutOfCalibration=unitOutOfCalibration, receiveChannel=receiveChannel, dataPortStatusTrap=dataPortStatusTrap, dfsGroup=dfsGroup, sNMPTrapTable=sNMPTrapTable, productName=productName, licensedCapacity=licensedCapacity, longitude=longitude, userName=userName, tDDSynchronizationMode=tDDSynchronizationMode, ethernetGroup=ethernetGroup, installArmState=installArmState, daylightSaving=daylightSaving)
