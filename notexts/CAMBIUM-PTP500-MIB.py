...
# Produced by pysmi-1.1.3 at Sun Nov 28 21:13:30 2021
...
TimeTicks, Counter32, Integer32, Unsigned32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, ObjectIdentity, MibIdentifier, Bits, NotificationType, Gauge32, enterprises, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "Integer32", "Unsigned32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "ObjectIdentity", "MibIdentifier", "Bits", "NotificationType", "Gauge32", "enterprises", "IpAddress")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", pubStats=pubStats, encryption=encryption, bootVersion=bootVersion, syslogClientTrap=syslogClientTrap, longitude=longitude, accessMethod=accessMethod, receivePower=receivePower, sNTPSyncTrap=sNTPSyncTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, noWirelessChannelAvailable=noWirelessChannelAvailable, ptpTraps=ptpTraps, softwareVersion=softwareVersion, cambium=cambium, targetMACAddress=targetMACAddress, ptp=ptp, sNTPLastSync=sNTPLastSync, managementGroup=managementGroup, sntpGroup=sntpGroup, receiveChannel=receiveChannel, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ptp500=ptp500, telecomGroup=telecomGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, vLANPriorityTable=vLANPriorityTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, useVLANForManagementInterfaces=useVLANForManagementInterfaces, antennaGain=antennaGain, bandwidthVariant=bandwidthVariant, constantPowerSpectralDensity=constantPowerSpectralDensity, receiveFreqKHz=receiveFreqKHz, phyControlGroup=phyControlGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, versionsGroup=versionsGroup, aggregateDataRate=aggregateDataRate, transmitPower=transmitPower, sMTPEnabledMessages=sMTPEnabledMessages, dataPortAutoMdix=dataPortAutoMdix, frequencyVariant=frequencyVariant, transmitModulationMode=transmitModulationMode, userTableIndex=userTableIndex, userPassword=userPassword, sMTPServerIPAddress=sMTPServerIPAddress, phyControl=phyControl, aAAControl=aAAControl, ethernet=ethernet, dfsTableEntry=dfsTableEntry, systemClock=systemClock, dfsTable=dfsTable, groupID=groupID, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, syslogControlGroup=syslogControlGroup, sNTPState=sNTPState, masterSlaveMode=masterSlaveMode, alarmsGroup=alarmsGroup, tDDControlGroup=tDDControlGroup, sNTPPollInterval=sNTPPollInterval, vLANPriorityTableIndex=vLANPriorityTableIndex, syslogLocalWrappedTrap=syslogLocalWrappedTrap, receiveFreqMHz=receiveFreqMHz, sMTPEmailAlert=sMTPEmailAlert, eIRP=eIRP, tFTPServerPortNumber=tFTPServerPortNumber, dataPortStatusTrap=dataPortStatusTrap, sNTPServerIPAddress=sNTPServerIPAddress, licenceGroup=licenceGroup, dfsMeans=dfsMeans, hTTPAccessEnabled=hTTPAccessEnabled, sNMPTrapVersion=sNMPTrapVersion, wirelessLinkAvailability=wirelessLinkAvailability, tDDSynchronizationStatus=tDDSynchronizationStatus, installStatus=installStatus, productVariant=productVariant, sntp=sntp, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, telnetAccessEnabled=telnetAccessEnabled, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPCommunityString=sNMPCommunityString, phyStatusGroup=phyStatusGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, syslogClient=syslogClient, vLANPriorityQueueMapping=vLANPriorityQueueMapping, telecomsCableLength=telecomsCableLength, range=range, secondarySoftwareVersion=secondarySoftwareVersion, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, smtpGroup=smtpGroup, resetGroup=resetGroup, notificationsGroup=notificationsGroup, telnetPortNumber=telnetPortNumber, unitOutOfCalibration=unitOutOfCalibration, transmitFreqKHz=transmitFreqKHz, dfs=dfs, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, vLANManagementVID=vLANManagementVID, telecomsInterface=telecomsInterface, regionCode=regionCode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, licence=licence, sNMPPortNumber=sNMPPortNumber, siteName=siteName, telecom=telecom, hTTPSAccessEnabled=hTTPSAccessEnabled, capacityLicenseMismatch=capacityLicenseMismatch, supplementary=supplementary, installStatusTrap=installStatusTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, pubStatsGroup=pubStatsGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, iPAddress=iPAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ptpGroups=ptpGroups, userTable=userTable, syslogState=syslogState, snmpControl=snmpControl, cableLoss=cableLoss, sNTPServerPortNumber=sNTPServerPortNumber, altitude=altitude, channelChangeTrap=channelChangeTrap, telecomsLoopback=telecomsLoopback, telecomsChannelStatus=telecomsChannelStatus, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, transmitFreqMHz=transmitFreqMHz, receiveDataRate=receiveDataRate, syslogStateTrap=syslogStateTrap, alarms=alarms, aAAControlGroup=aAAControlGroup, ptpTrapPrefix=ptpTrapPrefix, ptmp=ptmp, hardwareVersion=hardwareVersion, ethernetGroup=ethernetGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, timeZone=timeZone, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPv3Enable=sNMPv3Enable, supplementaryGroup=supplementaryGroup, versions=versions, sMTPServerPortNumber=sMTPServerPortNumber, searchState=searchState, dfsTableIndex=dfsTableIndex, telecomsLoopbackTrap=telecomsLoopbackTrap, sNMPTrapTable=sNMPTrapTable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, syslogControl=syslogControl, dfsTableNumber=dfsTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfsGroup=dfsGroup, maximumTransmitPower=maximumTransmitPower, systemReset=systemReset, telecomsChannelStatusTrap=telecomsChannelStatusTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, receiveModulationMode=receiveModulationMode, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, reset=reset, incompatibleRegionCodes=incompatibleRegionCodes, tDDControl=tDDControl, userTableEntry=userTableEntry, dataPortDisabledWarning=dataPortDisabledWarning, userEnabled=userEnabled, installArmState=installArmState, sNTPSync=sNTPSync, smtp=smtp, sNMPTrapTableEntry=sNMPTrapTableEntry, linkName=linkName, configurationGroup=configurationGroup, vLANManagementPriority=vLANManagementPriority, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, linkModeOptimisation=linkModeOptimisation, latitude=latitude, sNMPTrapTableNumber=sNMPTrapTableNumber, regionCodeTrap=regionCodeTrap, gatewayIPAddress=gatewayIPAddress, snmpControlGroup=snmpControlGroup, configuration=configuration, wirelessLinkStatus=wirelessLinkStatus, userRole=userRole, management=management, hTTPSPortNumber=hTTPSPortNumber, linkLoss=linkLoss, productName=productName, dataPortStatus=dataPortStatus, signalStrengthRatio=signalStrengthRatio, linkModeOptimizationMismatch=linkModeOptimizationMismatch, byteErrorRatio=byteErrorRatio, vLANPriorityTableEntry=vLANPriorityTableEntry, tDDSynchronizationMode=tDDSynchronizationMode, PYSNMP_MODULE_ID=cambium, tDDSynchronizationAlarm=tDDSynchronizationAlarm, remoteIPAddress=remoteIPAddress, encryptionGroup=encryptionGroup, dfsPeaks=dfsPeaks, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ptpCompliance=ptpCompliance, vLANPriorityTableNumber=vLANPriorityTableNumber, sNMPEnabledTraps=sNMPEnabledTraps, transmitDataRate=transmitDataRate, userTableNumber=userTableNumber, ethernetFiberSupport=ethernetFiberSupport, tFTPServerIPAddress=tFTPServerIPAddress, userName=userName, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, channelBandwidth=channelBandwidth, transmitChannel=transmitChannel, incompatibleMasterAndSlave=incompatibleMasterAndSlave, encryptionAlgorithm=encryptionAlgorithm, phyStatus=phyStatus, vectorError=vectorError, installArmStateTrap=installArmStateTrap, hTTPPortNumber=hTTPPortNumber, telecomsLineCode=telecomsLineCode, daylightSaving=daylightSaving, linkSymmetry=linkSymmetry, licensedCapacity=licensedCapacity, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, receiveModulationModeDetail=receiveModulationModeDetail, subnetMask=subnetMask)
