...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", tFTPServerPortNumber=tFTPServerPortNumber, phyControlGroup=phyControlGroup, vectorError=vectorError, telecomGroup=telecomGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, cambium=cambium, sNMPTrapTable=sNMPTrapTable, userName=userName, dfsMeans=dfsMeans, sNMPTrapIPAddress=sNMPTrapIPAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, cableLoss=cableLoss, wirelessLinkAvailability=wirelessLinkAvailability, longitude=longitude, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, productVariant=productVariant, receivePower=receivePower, daylightSaving=daylightSaving, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfs=dfs, management=management, targetMACAddress=targetMACAddress, vLANManagementPriority=vLANManagementPriority, wirelessLinkStatus=wirelessLinkStatus, remoteIPAddress=remoteIPAddress, userTableIndex=userTableIndex, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, managementGroup=managementGroup, telecomsInterface=telecomsInterface, linkLoss=linkLoss, configurationGroup=configurationGroup, ptpTrapPrefix=ptpTrapPrefix, unitOutOfCalibration=unitOutOfCalibration, byteErrorRatio=byteErrorRatio, userRole=userRole, ptpCompliance=ptpCompliance, pubStats=pubStats, dfsTableNumber=dfsTableNumber, vLANPriorityTableIndex=vLANPriorityTableIndex, tDDSynchronizationMode=tDDSynchronizationMode, snmpControl=snmpControl, antennaGain=antennaGain, receiveModulationModeDetail=receiveModulationModeDetail, telecomsCableLength=telecomsCableLength, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sMTPEnabledMessages=sMTPEnabledMessages, dataPortStatus=dataPortStatus, syslogClient=syslogClient, tDDControlGroup=tDDControlGroup, maximumTransmitPower=maximumTransmitPower, userTableNumber=userTableNumber, licensedCapacity=licensedCapacity, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sMTPServerIPAddress=sMTPServerIPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, userPassword=userPassword, alarmsGroup=alarmsGroup, dfsGroup=dfsGroup, linkName=linkName, productName=productName, hardwareVersion=hardwareVersion, bandwidthVariant=bandwidthVariant, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, aggregateDataRate=aggregateDataRate, installArmStateTrap=installArmStateTrap, hTTPSPortNumber=hTTPSPortNumber, channelChangeTrap=channelChangeTrap, supplementaryGroup=supplementaryGroup, reset=reset, versions=versions, ethernet=ethernet, searchState=searchState, receiveModulationMode=receiveModulationMode, regionCodeTrap=regionCodeTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telnetPortNumber=telnetPortNumber, sNTPServerIPAddress=sNTPServerIPAddress, sntpGroup=sntpGroup, dfsTable=dfsTable, vLANPriorityQueueMapping=vLANPriorityQueueMapping, tDDSynchronizationStatus=tDDSynchronizationStatus, capacityLicenseMismatch=capacityLicenseMismatch, hTTPSAccessEnabled=hTTPSAccessEnabled, transmitChannel=transmitChannel, systemClock=systemClock, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, smtp=smtp, hTTPAccessEnabled=hTTPAccessEnabled, linkSymmetry=linkSymmetry, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPTrapPortNumber=sNMPTrapPortNumber, telecomsChannelStatusTrap=telecomsChannelStatusTrap, masterSlaveMode=masterSlaveMode, supplementary=supplementary, receiveFreqKHz=receiveFreqKHz, pubStatsGroup=pubStatsGroup, alarms=alarms, userTableEntry=userTableEntry, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, userTable=userTable, range=range, syslogState=syslogState, sMTPServerPortNumber=sMTPServerPortNumber, licenceGroup=licenceGroup, encryption=encryption, receiveChannel=receiveChannel, accessMethod=accessMethod, resetGroup=resetGroup, sNTPServerPortNumber=sNTPServerPortNumber, latitude=latitude, sNTPSyncTrap=sNTPSyncTrap, hTTPPortNumber=hTTPPortNumber, syslogStateTrap=syslogStateTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, installStatus=installStatus, sntp=sntp, tDDControl=tDDControl, aAAControl=aAAControl, installArmState=installArmState, tFTPServerIPAddress=tFTPServerIPAddress, systemReset=systemReset, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, vLANPriorityTableEntry=vLANPriorityTableEntry, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNMPTrapVersion=sNMPTrapVersion, ptp500=ptp500, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPCommunityString=sNMPCommunityString, siteName=siteName, eIRP=eIRP, PYSNMP_MODULE_ID=cambium, signalStrengthRatio=signalStrengthRatio, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, installStatusTrap=installStatusTrap, bootVersion=bootVersion, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, telecomsChannelStatus=telecomsChannelStatus, gatewayIPAddress=gatewayIPAddress, configuration=configuration, encryptionAlgorithm=encryptionAlgorithm, syslogControlGroup=syslogControlGroup, altitude=altitude, telnetAccessEnabled=telnetAccessEnabled, transmitFreqMHz=transmitFreqMHz, iPAddress=iPAddress, dataPortStatusTrap=dataPortStatusTrap, snmpControlGroup=snmpControlGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, aAAControlGroup=aAAControlGroup, dfsTableEntry=dfsTableEntry, incompatibleRegionCodes=incompatibleRegionCodes, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, vLANManagementVID=vLANManagementVID, syslogControl=syslogControl, receiveFreqMHz=receiveFreqMHz, telecomsLoopbackTrap=telecomsLoopbackTrap, dataPortAutoMdix=dataPortAutoMdix, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPSync=sNTPSync, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, linkModeOptimisation=linkModeOptimisation, ethernetGroup=ethernetGroup, timeZone=timeZone, transmitDataRate=transmitDataRate, dfsPeaks=dfsPeaks, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, versionsGroup=versionsGroup, syslogClientTrap=syslogClientTrap, channelBandwidth=channelBandwidth, transmitPower=transmitPower, dataPortDisabledWarning=dataPortDisabledWarning, phyControl=phyControl, subnetMask=subnetMask, vLANPriorityTableNumber=vLANPriorityTableNumber, telecomsLoopback=telecomsLoopback, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, phyStatusGroup=phyStatusGroup, ethernetFiberSupport=ethernetFiberSupport, notificationsGroup=notificationsGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, telecom=telecom, dfsTableIndex=dfsTableIndex, telecomsLineCode=telecomsLineCode, transmitFreqKHz=transmitFreqKHz, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, regionCode=regionCode, ptpTraps=ptpTraps, ptmp=ptmp, encryptionGroup=encryptionGroup, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, ptpGroups=ptpGroups, sNTPLastSync=sNTPLastSync, sMTPEmailAlert=sMTPEmailAlert, sNMPEnabledTraps=sNMPEnabledTraps, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPState=sNTPState, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, licence=licence, sNMPTrapTableNumber=sNMPTrapTableNumber, frequencyVariant=frequencyVariant, sNMPPortNumber=sNMPPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, receiveDataRate=receiveDataRate, ptp=ptp, vLANPriorityTable=vLANPriorityTable, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPv3Enable=sNMPv3Enable, softwareVersion=softwareVersion, userEnabled=userEnabled, sNTPPollInterval=sNTPPollInterval, transmitModulationMode=transmitModulationMode, phyStatus=phyStatus, smtpGroup=smtpGroup, groupID=groupID, sNMPTrapTableIndex=sNMPTrapTableIndex, noWirelessChannelAvailable=noWirelessChannelAvailable, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles)
