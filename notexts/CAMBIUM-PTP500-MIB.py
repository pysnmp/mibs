...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", subnetMask=subnetMask, constantPowerSpectralDensity=constantPowerSpectralDensity, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPServerPortNumber=sNTPServerPortNumber, sNTPPollInterval=sNTPPollInterval, configurationGroup=configurationGroup, dfs=dfs, userTableIndex=userTableIndex, phyStatus=phyStatus, encryptionGroup=encryptionGroup, ethernetFiberSupport=ethernetFiberSupport, byteErrorRatio=byteErrorRatio, phyControlGroup=phyControlGroup, dfsTable=dfsTable, sNMPTrapVersion=sNMPTrapVersion, licenceGroup=licenceGroup, transmitModulationMode=transmitModulationMode, vLANPriorityQueueMapping=vLANPriorityQueueMapping, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNMPCommunityString=sNMPCommunityString, incompatibleRegionCodes=incompatibleRegionCodes, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, telecomsLoopback=telecomsLoopback, userTableEntry=userTableEntry, sMTPServerPortNumber=sMTPServerPortNumber, linkLoss=linkLoss, latitude=latitude, ethernet=ethernet, snmpControlGroup=snmpControlGroup, syslogClient=syslogClient, tFTPServerPortNumber=tFTPServerPortNumber, PYSNMP_MODULE_ID=cambium, productName=productName, remoteIPAddress=remoteIPAddress, receivePower=receivePower, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dfsTableNumber=dfsTableNumber, telecomsLineCode=telecomsLineCode, sNMPTrapTableEntry=sNMPTrapTableEntry, linkModeOptimisation=linkModeOptimisation, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telnetAccessEnabled=telnetAccessEnabled, bandwidthVariant=bandwidthVariant, userEnabled=userEnabled, syslogState=syslogState, daylightSaving=daylightSaving, receiveDataRate=receiveDataRate, productVariant=productVariant, userTable=userTable, transmitFreqKHz=transmitFreqKHz, accessMethod=accessMethod, masterSlaveMode=masterSlaveMode, pubStats=pubStats, telecomGroup=telecomGroup, dataPortStatus=dataPortStatus, gatewayIPAddress=gatewayIPAddress, licensedCapacity=licensedCapacity, telecomsLoopbackTrap=telecomsLoopbackTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNTPState=sNTPState, vectorError=vectorError, siteName=siteName, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, hTTPSPortNumber=hTTPSPortNumber, licence=licence, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, telecomsInterface=telecomsInterface, transmitChannel=transmitChannel, receiveModulationModeDetail=receiveModulationModeDetail, transmitFreqMHz=transmitFreqMHz, tDDControl=tDDControl, sNTPLastSync=sNTPLastSync, userRole=userRole, versions=versions, dataPortWirelessDownAlert=dataPortWirelessDownAlert, vLANPriorityTable=vLANPriorityTable, phyStatusGroup=phyStatusGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, resetGroup=resetGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, supplementaryGroup=supplementaryGroup, capacityLicenseMismatch=capacityLicenseMismatch, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ethernetGroup=ethernetGroup, telecomsChannelStatusTrap=telecomsChannelStatusTrap, targetMACAddress=targetMACAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPv3Enable=sNMPv3Enable, userPassword=userPassword, tDDControlGroup=tDDControlGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapTable=sNMPTrapTable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPEnabledTraps=sNMPEnabledTraps, dataPortDisabledWarning=dataPortDisabledWarning, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPServerIPAddress=sNTPServerIPAddress, dataPortStatusTrap=dataPortStatusTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, vLANManagementVID=vLANManagementVID, hardwareVersion=hardwareVersion, sNMPPortNumber=sNMPPortNumber, range=range, receiveFreqMHz=receiveFreqMHz, tDDSynchronizationMode=tDDSynchronizationMode, alarmsGroup=alarmsGroup, userName=userName, dfsMeans=dfsMeans, encryptionAlgorithm=encryptionAlgorithm, telnetPortNumber=telnetPortNumber, unitOutOfCalibration=unitOutOfCalibration, dataPortAutoMdix=dataPortAutoMdix, sntpGroup=sntpGroup, signalStrengthRatio=signalStrengthRatio, sNMPTrapTableNumber=sNMPTrapTableNumber, management=management, encryption=encryption, managementGroup=managementGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, softwareVersion=softwareVersion, installStatusTrap=installStatusTrap, linkSymmetry=linkSymmetry, iPAddress=iPAddress, userTableNumber=userTableNumber, vLANPriorityTableEntry=vLANPriorityTableEntry, pubStatsGroup=pubStatsGroup, snmpControl=snmpControl, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, phyControl=phyControl, searchState=searchState, secondarySoftwareVersion=secondarySoftwareVersion, regionCodeTrap=regionCodeTrap, telecom=telecom, aAAControlGroup=aAAControlGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, receiveFreqKHz=receiveFreqKHz, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ptpGroups=ptpGroups, timeZone=timeZone, receiveModulationMode=receiveModulationMode, ptp500=ptp500, wirelessLinkAvailability=wirelessLinkAvailability, dfsGroup=dfsGroup, systemClock=systemClock, installArmState=installArmState, syslogControlGroup=syslogControlGroup, supplementary=supplementary, tFTPServerIPAddress=tFTPServerIPAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dfsPeaks=dfsPeaks, versionsGroup=versionsGroup, frequencyVariant=frequencyVariant, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, hTTPSAccessEnabled=hTTPSAccessEnabled, aAAControl=aAAControl, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapPortNumber=sNMPTrapPortNumber, syslogControl=syslogControl, maximumTransmitPower=maximumTransmitPower, ptmp=ptmp, useVLANForManagementInterfaces=useVLANForManagementInterfaces, wirelessLinkStatus=wirelessLinkStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, linkName=linkName, telecomsCableLength=telecomsCableLength, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, hTTPPortNumber=hTTPPortNumber, transmitPower=transmitPower, transmitDataRate=transmitDataRate, syslogClientTrap=syslogClientTrap, ptp=ptp, hTTPAccessEnabled=hTTPAccessEnabled, notificationsGroup=notificationsGroup, systemReset=systemReset, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPSync=sNTPSync, smtp=smtp, channelChangeTrap=channelChangeTrap, sntp=sntp, antennaGain=antennaGain, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ptpTraps=ptpTraps, regionCode=regionCode, eIRP=eIRP, telecomsChannelStatus=telecomsChannelStatus, dataPortAutoNegotiation=dataPortAutoNegotiation, receiveChannel=receiveChannel, bootVersion=bootVersion, configuration=configuration, sMTPEnabledMessages=sMTPEnabledMessages, smtpGroup=smtpGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dfsTableEntry=dfsTableEntry, vLANPriorityTableNumber=vLANPriorityTableNumber, syslogStateTrap=syslogStateTrap, groupID=groupID, aggregateDataRate=aggregateDataRate, dfsTableIndex=dfsTableIndex, channelBandwidth=channelBandwidth, altitude=altitude, sNTPSyncTrap=sNTPSyncTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, longitude=longitude, alarms=alarms, installArmStateTrap=installArmStateTrap, reset=reset, cambium=cambium, sMTPServerIPAddress=sMTPServerIPAddress, vLANPriorityTableIndex=vLANPriorityTableIndex, ptpCompliance=ptpCompliance, installStatus=installStatus, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sMTPEmailAlert=sMTPEmailAlert, ptpTrapPrefix=ptpTrapPrefix, cableLoss=cableLoss, sNMPTrapIPAddress=sNMPTrapIPAddress, vLANManagementPriority=vLANManagementPriority)
