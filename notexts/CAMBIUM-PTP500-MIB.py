...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", tFTPServerPortNumber=tFTPServerPortNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, signalStrengthRatio=signalStrengthRatio, userTableIndex=userTableIndex, tDDControlGroup=tDDControlGroup, dfsGroup=dfsGroup, dfsTable=dfsTable, sNMPCommunityString=sNMPCommunityString, licence=licence, management=management, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, groupID=groupID, versions=versions, antennaGain=antennaGain, PYSNMP_MODULE_ID=cambium, telecomsInterface=telecomsInterface, transmitChannel=transmitChannel, noWirelessChannelAvailable=noWirelessChannelAvailable, aAAControlGroup=aAAControlGroup, telecomGroup=telecomGroup, targetMACAddress=targetMACAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, phyStatus=phyStatus, searchState=searchState, tDDSynchronizationStatus=tDDSynchronizationStatus, telecomsCableLength=telecomsCableLength, licenceGroup=licenceGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ptmp=ptmp, vLANPriorityTable=vLANPriorityTable, regionCode=regionCode, altitude=altitude, phyControl=phyControl, dfsPeaks=dfsPeaks, gatewayIPAddress=gatewayIPAddress, sNTPServerPortNumber=sNTPServerPortNumber, vLANPriorityTableIndex=vLANPriorityTableIndex, frequencyVariant=frequencyVariant, dfsTableIndex=dfsTableIndex, ptpTraps=ptpTraps, installArmState=installArmState, transmitFreqKHz=transmitFreqKHz, userName=userName, ptpCompliance=ptpCompliance, hTTPSPortNumber=hTTPSPortNumber, softwareVersion=softwareVersion, aAAControl=aAAControl, tDDControl=tDDControl, sNMPPortNumber=sNMPPortNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, capacityLicenseMismatch=capacityLicenseMismatch, channelChangeTrap=channelChangeTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, telecomsChannelStatus=telecomsChannelStatus, ptpTrapPrefix=ptpTrapPrefix, cambium=cambium, userTable=userTable, byteErrorRatio=byteErrorRatio, incompatibleRegionCodes=incompatibleRegionCodes, alarmsGroup=alarmsGroup, configuration=configuration, sNMPTrapTableEntry=sNMPTrapTableEntry, receiveModulationMode=receiveModulationMode, ethernet=ethernet, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, iPAddress=iPAddress, vLANManagementPriority=vLANManagementPriority, maximumTransmitPower=maximumTransmitPower, unitOutOfCalibration=unitOutOfCalibration, ethernetFiberSupport=ethernetFiberSupport, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, encryptionAlgorithm=encryptionAlgorithm, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, telnetAccessEnabled=telnetAccessEnabled, sMTPSourceEmailAddress=sMTPSourceEmailAddress, phyStatusGroup=phyStatusGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, notificationsGroup=notificationsGroup, vectorError=vectorError, supplementary=supplementary, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, wirelessLinkStatus=wirelessLinkStatus, hTTPPortNumber=hTTPPortNumber, sntpGroup=sntpGroup, sNTPPollInterval=sNTPPollInterval, sNTPServerIPAddress=sNTPServerIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, telecomsChannelStatusTrap=telecomsChannelStatusTrap, pubStats=pubStats, cableLoss=cableLoss, installStatusTrap=installStatusTrap, subnetMask=subnetMask, sNMPEnabledTraps=sNMPEnabledTraps, secondarySoftwareVersion=secondarySoftwareVersion, eIRP=eIRP, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPTrapVersion=sNMPTrapVersion, syslogControlGroup=syslogControlGroup, encryptionGroup=encryptionGroup, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, receiveFreqKHz=receiveFreqKHz, remoteMaximumTransmitPower=remoteMaximumTransmitPower, phyControlGroup=phyControlGroup, range=range, vLANManagementVID=vLANManagementVID, dfs=dfs, ethernetGroup=ethernetGroup, syslogClientTrap=syslogClientTrap, sMTPEmailAlert=sMTPEmailAlert, tDDSynchronizationAlarm=tDDSynchronizationAlarm, telnetPortNumber=telnetPortNumber, transmitFreqMHz=transmitFreqMHz, latitude=latitude, wirelessLinkAvailability=wirelessLinkAvailability, userTableEntry=userTableEntry, productVariant=productVariant, receiveChannel=receiveChannel, dfsTableNumber=dfsTableNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dataPortAutoNegotiation=dataPortAutoNegotiation, installArmStateTrap=installArmStateTrap, receivePower=receivePower, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortDisabledWarning=dataPortDisabledWarning, bandwidthVariant=bandwidthVariant, regionCodeTrap=regionCodeTrap, licensedCapacity=licensedCapacity, useVLANForManagementInterfaces=useVLANForManagementInterfaces, transmitModulationMode=transmitModulationMode, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, encryption=encryption, vLANPriorityTableNumber=vLANPriorityTableNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, transmitPower=transmitPower, productName=productName, reset=reset, daylightSaving=daylightSaving, sNMPTrapPortNumber=sNMPTrapPortNumber, resetGroup=resetGroup, telecom=telecom, syslogLocalWrappedTrap=syslogLocalWrappedTrap, linkModeOptimisation=linkModeOptimisation, snmpControl=snmpControl, hTTPAccessEnabled=hTTPAccessEnabled, enabledDiagnosticAlarms=enabledDiagnosticAlarms, systemClock=systemClock, hardwareVersion=hardwareVersion, vLANPriorityTableEntry=vLANPriorityTableEntry, receiveModulationModeDetail=receiveModulationModeDetail, supplementaryGroup=supplementaryGroup, channelBandwidth=channelBandwidth, incompatibleMasterAndSlave=incompatibleMasterAndSlave, userRole=userRole, masterSlaveMode=masterSlaveMode, tDDSynchronizationMode=tDDSynchronizationMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sMTPServerPortNumber=sMTPServerPortNumber, ptp=ptp, remoteIPAddress=remoteIPAddress, sNTPLastSync=sNTPLastSync, linkName=linkName, userTableNumber=userTableNumber, aggregateDataRate=aggregateDataRate, dataPortStatus=dataPortStatus, syslogControl=syslogControl, dataPortStatusTrap=dataPortStatusTrap, sNTPSyncTrap=sNTPSyncTrap, syslogStateTrap=syslogStateTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, versionsGroup=versionsGroup, sMTPEnabledMessages=sMTPEnabledMessages, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNTPSync=sNTPSync, syslogClient=syslogClient, receiveFreqMHz=receiveFreqMHz, bootVersion=bootVersion, receiveDataRate=receiveDataRate, siteName=siteName, telecomsLoopback=telecomsLoopback, constantPowerSpectralDensity=constantPowerSpectralDensity, systemReset=systemReset, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, linkSymmetry=linkSymmetry, sntp=sntp, tFTPServerIPAddress=tFTPServerIPAddress, telecomsLoopbackTrap=telecomsLoopbackTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, longitude=longitude, sNTPState=sNTPState, sNMPTrapTable=sNMPTrapTable, dataPortAutoMdix=dataPortAutoMdix, snmpControlGroup=snmpControlGroup, transmitDataRate=transmitDataRate, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPv3Enable=sNMPv3Enable, accessMethod=accessMethod, installStatus=installStatus, userEnabled=userEnabled, hTTPSAccessEnabled=hTTPSAccessEnabled, linkLoss=linkLoss, dfsMeans=dfsMeans, sNMPTrapTableIndex=sNMPTrapTableIndex, timeZone=timeZone, managementGroup=managementGroup, ptp500=ptp500, smtpGroup=smtpGroup, userPassword=userPassword, syslogState=syslogState, alarms=alarms, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, vLANPriorityQueueMapping=vLANPriorityQueueMapping, telecomsLineCode=telecomsLineCode, sMTPServerIPAddress=sMTPServerIPAddress, dfsTableEntry=dfsTableEntry, pubStatsGroup=pubStatsGroup, configurationGroup=configurationGroup, ptpGroups=ptpGroups, smtp=smtp)
