...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", signalStrengthRatio=signalStrengthRatio, range=range, byteErrorRatio=byteErrorRatio, sNMPTrapVersion=sNMPTrapVersion, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, installStatusTrap=installStatusTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, productVariant=productVariant, telecom=telecom, transmitDataRate=transmitDataRate, longitude=longitude, ptp500=ptp500, alarmsGroup=alarmsGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, smtp=smtp, dfsTable=dfsTable, ethernetFiberSupport=ethernetFiberSupport, userName=userName, supplementaryGroup=supplementaryGroup, bootVersion=bootVersion, versionsGroup=versionsGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, sntpGroup=sntpGroup, ethernetGroup=ethernetGroup, telecomsInterface=telecomsInterface, tFTPServerIPAddress=tFTPServerIPAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ptpGroups=ptpGroups, userTableNumber=userTableNumber, regionCodeTrap=regionCodeTrap, sNTPState=sNTPState, dfsPeaks=dfsPeaks, hTTPPortNumber=hTTPPortNumber, altitude=altitude, syslogLocalWrappedTrap=syslogLocalWrappedTrap, subnetMask=subnetMask, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, resetGroup=resetGroup, productName=productName, vLANManagementPriority=vLANManagementPriority, managementGroup=managementGroup, userTableEntry=userTableEntry, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dataPortStatus=dataPortStatus, receiveFreqMHz=receiveFreqMHz, softwareVersion=softwareVersion, vLANPriorityTableNumber=vLANPriorityTableNumber, sNTPServerPortNumber=sNTPServerPortNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, pubStatsGroup=pubStatsGroup, antennaGain=antennaGain, telnetAccessEnabled=telnetAccessEnabled, receiveModulationMode=receiveModulationMode, sMTPEmailAlert=sMTPEmailAlert, tDDControlGroup=tDDControlGroup, licensedCapacity=licensedCapacity, vLANManagementVID=vLANManagementVID, ethernet=ethernet, cableLoss=cableLoss, maximumTransmitPower=maximumTransmitPower, sNMPEnabledTraps=sNMPEnabledTraps, enabledDiagnosticAlarms=enabledDiagnosticAlarms, telnetPortNumber=telnetPortNumber, syslogClient=syslogClient, telecomsLoopbackTrap=telecomsLoopbackTrap, alarms=alarms, dfsGroup=dfsGroup, management=management, notificationsGroup=notificationsGroup, dfsTableIndex=dfsTableIndex, installArmState=installArmState, licenceGroup=licenceGroup, sNMPCommunityString=sNMPCommunityString, phyControl=phyControl, latitude=latitude, remoteIPAddress=remoteIPAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, transmitFreqKHz=transmitFreqKHz, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dataPortDisabledWarning=dataPortDisabledWarning, bandwidthVariant=bandwidthVariant, wirelessLinkAvailability=wirelessLinkAvailability, configuration=configuration, transmitModulationMode=transmitModulationMode, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dfsMeans=dfsMeans, licence=licence, linkName=linkName, channelChangeTrap=channelChangeTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, daylightSaving=daylightSaving, dataPortAutoMdix=dataPortAutoMdix, frequencyVariant=frequencyVariant, phyControlGroup=phyControlGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, cambium=cambium, iPAddress=iPAddress, sNTPServerIPAddress=sNTPServerIPAddress, ptmp=ptmp, dataPortWirelessDownAlert=dataPortWirelessDownAlert, syslogControl=syslogControl, receiveModulationModeDetail=receiveModulationModeDetail, remoteMaximumTransmitPower=remoteMaximumTransmitPower, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, userPassword=userPassword, PYSNMP_MODULE_ID=cambium, encryptionAlgorithm=encryptionAlgorithm, dfs=dfs, syslogState=syslogState, encryptionGroup=encryptionGroup, ptpTraps=ptpTraps, reset=reset, telecomsLineCode=telecomsLineCode, eIRP=eIRP, hTTPAccessEnabled=hTTPAccessEnabled, transmitFreqMHz=transmitFreqMHz, transmitChannel=transmitChannel, secondarySoftwareVersion=secondarySoftwareVersion, masterSlaveMode=masterSlaveMode, hTTPSAccessEnabled=hTTPSAccessEnabled, userRole=userRole, sMTPSourceEmailAddress=sMTPSourceEmailAddress, syslogControlGroup=syslogControlGroup, systemReset=systemReset, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, encryption=encryption, snmpControl=snmpControl, sNTPPollInterval=sNTPPollInterval, aAAControlGroup=aAAControlGroup, sMTPEnabledMessages=sMTPEnabledMessages, gatewayIPAddress=gatewayIPAddress, dfsTableEntry=dfsTableEntry, telecomsLoopback=telecomsLoopback, receivePower=receivePower, aAAControl=aAAControl, userTableIndex=userTableIndex, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptpTrapPrefix=ptpTrapPrefix, syslogClientTrap=syslogClientTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, userEnabled=userEnabled, phyStatusGroup=phyStatusGroup, configurationGroup=configurationGroup, sNTPSyncTrap=sNTPSyncTrap, installArmStateTrap=installArmStateTrap, tFTPServerPortNumber=tFTPServerPortNumber, sNMPPortNumber=sNMPPortNumber, snmpControlGroup=snmpControlGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, installStatus=installStatus, dfsTableNumber=dfsTableNumber, dataPortStatusTrap=dataPortStatusTrap, targetMACAddress=targetMACAddress, ptpCompliance=ptpCompliance, searchState=searchState, receiveDataRate=receiveDataRate, unitOutOfCalibration=unitOutOfCalibration, vectorError=vectorError, aggregateDataRate=aggregateDataRate, sNMPTrapTableIndex=sNMPTrapTableIndex, pubStats=pubStats, regionCode=regionCode, sNMPTrapTable=sNMPTrapTable, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, transmitPower=transmitPower, linkLoss=linkLoss, sMTPServerPortNumber=sMTPServerPortNumber, userTable=userTable, linkSymmetry=linkSymmetry, phyStatus=phyStatus, dataPortAutoNegotiation=dataPortAutoNegotiation, capacityLicenseMismatch=capacityLicenseMismatch, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPTrapPortNumber=sNMPTrapPortNumber, vLANPriorityTableIndex=vLANPriorityTableIndex, tDDSynchronizationMode=tDDSynchronizationMode, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, telecomsCableLength=telecomsCableLength, receiveChannel=receiveChannel, accessMethod=accessMethod, systemClock=systemClock, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, versions=versions, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, telecomGroup=telecomGroup, smtpGroup=smtpGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, telecomsChannelStatus=telecomsChannelStatus, receiveFreqKHz=receiveFreqKHz, linkModeOptimisation=linkModeOptimisation, channelBandwidth=channelBandwidth, sNMPv3Enable=sNMPv3Enable, vLANPriorityTable=vLANPriorityTable, supplementary=supplementary, hTTPSPortNumber=hTTPSPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPLastSync=sNTPLastSync, wirelessLinkStatus=wirelessLinkStatus, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, syslogStateTrap=syslogStateTrap, sNTPSync=sNTPSync, hardwareVersion=hardwareVersion, incompatibleRegionCodes=incompatibleRegionCodes, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptp=ptp, tDDControl=tDDControl, siteName=siteName, timeZone=timeZone, sntp=sntp, groupID=groupID)
