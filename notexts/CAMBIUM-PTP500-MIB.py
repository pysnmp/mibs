...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", altitude=altitude, dfsMeans=dfsMeans, transmitModulationMode=transmitModulationMode, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, telnetPortNumber=telnetPortNumber, supplementaryGroup=supplementaryGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, ethernetFiberSupport=ethernetFiberSupport, timeZone=timeZone, dataPortStatusTrap=dataPortStatusTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, vectorError=vectorError, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, hTTPPortNumber=hTTPPortNumber, linkLoss=linkLoss, range=range, receiveChannel=receiveChannel, sNTPLastSync=sNTPLastSync, wirelessLinkAvailability=wirelessLinkAvailability, sNTPServerPortNumber=sNTPServerPortNumber, sntpGroup=sntpGroup, longitude=longitude, sMTPSourceEmailAddress=sMTPSourceEmailAddress, versions=versions, sNMPTrapPortNumber=sNMPTrapPortNumber, vLANPriorityTableIndex=vLANPriorityTableIndex, telecomsInterface=telecomsInterface, ptp=ptp, tDDControl=tDDControl, syslogControl=syslogControl, syslogClientTrap=syslogClientTrap, smtpGroup=smtpGroup, remoteIPAddress=remoteIPAddress, tFTPServerPortNumber=tFTPServerPortNumber, ptp500=ptp500, channelBandwidth=channelBandwidth, productName=productName, sNMPTrapTable=sNMPTrapTable, sMTPServerPortNumber=sMTPServerPortNumber, ptpCompliance=ptpCompliance, sNTPState=sNTPState, resetGroup=resetGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, telecomsChannelStatusTrap=telecomsChannelStatusTrap, userTable=userTable, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, systemReset=systemReset, bandwidthVariant=bandwidthVariant, receiveDataRate=receiveDataRate, vLANPriorityTable=vLANPriorityTable, receiveFreqMHz=receiveFreqMHz, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, linkName=linkName, sNMPTrapTableNumber=sNMPTrapTableNumber, phyStatusGroup=phyStatusGroup, productVariant=productVariant, transmitFreqKHz=transmitFreqKHz, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, receiveModulationModeDetail=receiveModulationModeDetail, searchState=searchState, sMTPServerIPAddress=sMTPServerIPAddress, snmpControlGroup=snmpControlGroup, sNMPTrapVersion=sNMPTrapVersion, noWirelessChannelAvailable=noWirelessChannelAvailable, snmpControl=snmpControl, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dfsTable=dfsTable, groupID=groupID, incompatibleRegionCodes=incompatibleRegionCodes, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, maximumTransmitPower=maximumTransmitPower, installStatusTrap=installStatusTrap, userTableEntry=userTableEntry, targetMACAddress=targetMACAddress, receiveModulationMode=receiveModulationMode, transmitPower=transmitPower, vLANPriorityQueueMapping=vLANPriorityQueueMapping, syslogState=syslogState, telnetAccessEnabled=telnetAccessEnabled, smtp=smtp, linkModeOptimisation=linkModeOptimisation, dfsGroup=dfsGroup, frequencyVariant=frequencyVariant, PYSNMP_MODULE_ID=cambium, eIRP=eIRP, channelChangeTrap=channelChangeTrap, regionCode=regionCode, telecomsLineCode=telecomsLineCode, configurationGroup=configurationGroup, unitOutOfCalibration=unitOutOfCalibration, installStatus=installStatus, receivePower=receivePower, bootVersion=bootVersion, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, hTTPSPortNumber=hTTPSPortNumber, dataPortAutoMdix=dataPortAutoMdix, constantPowerSpectralDensity=constantPowerSpectralDensity, cambium=cambium, notificationsGroup=notificationsGroup, antennaGain=antennaGain, alarmsGroup=alarmsGroup, systemClock=systemClock, telecomsCableLength=telecomsCableLength, gatewayIPAddress=gatewayIPAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, licence=licence, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dfsTableIndex=dfsTableIndex, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPSyncTrap=sNTPSyncTrap, receiveFreqKHz=receiveFreqKHz, configuration=configuration, syslogControlGroup=syslogControlGroup, management=management, softwareVersion=softwareVersion, installArmState=installArmState, tFTPServerIPAddress=tFTPServerIPAddress, licenceGroup=licenceGroup, iPAddress=iPAddress, vLANPriorityTableNumber=vLANPriorityTableNumber, aAAControl=aAAControl, pubStats=pubStats, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, cableLoss=cableLoss, telecomsLoopbackTrap=telecomsLoopbackTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPCommunityString=sNMPCommunityString, wirelessLinkStatus=wirelessLinkStatus, dataPortWirelessDownAlert=dataPortWirelessDownAlert, hardwareVersion=hardwareVersion, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, accessMethod=accessMethod, siteName=siteName, sNTPPollInterval=sNTPPollInterval, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortConfigurationMismatch=dataPortConfigurationMismatch, userPassword=userPassword, versionsGroup=versionsGroup, transmitChannel=transmitChannel, dataPortDisabledWarning=dataPortDisabledWarning, vLANManagementPriority=vLANManagementPriority, phyStatus=phyStatus, sNTPServerIPAddress=sNTPServerIPAddress, subnetMask=subnetMask, tDDSynchronizationMode=tDDSynchronizationMode, reset=reset, phyControlGroup=phyControlGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, userName=userName, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tDDControlGroup=tDDControlGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, ethernet=ethernet, managementGroup=managementGroup, encryptionAlgorithm=encryptionAlgorithm, userTableIndex=userTableIndex, sMTPEnabledMessages=sMTPEnabledMessages, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, aggregateDataRate=aggregateDataRate, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, alarms=alarms, enabledDiagnosticAlarms=enabledDiagnosticAlarms, syslogLocalWrappedTrap=syslogLocalWrappedTrap, telecom=telecom, telecomGroup=telecomGroup, byteErrorRatio=byteErrorRatio, userRole=userRole, transmitFreqMHz=transmitFreqMHz, dfs=dfs, sNMPEnabledTraps=sNMPEnabledTraps, userTableNumber=userTableNumber, licensedCapacity=licensedCapacity, pubStatsGroup=pubStatsGroup, capacityLicenseMismatch=capacityLicenseMismatch, secondarySoftwareVersion=secondarySoftwareVersion, masterSlaveMode=masterSlaveMode, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, syslogClient=syslogClient, incompatibleMasterAndSlave=incompatibleMasterAndSlave, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, phyControl=phyControl, sntp=sntp, sMTPEmailAlert=sMTPEmailAlert, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, telecomsLoopback=telecomsLoopback, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortAutoNegotiation=dataPortAutoNegotiation, ptpTraps=ptpTraps, dfsTableEntry=dfsTableEntry, dataPortStatus=dataPortStatus, sNMPv3Enable=sNMPv3Enable, encryption=encryption, signalStrengthRatio=signalStrengthRatio, regionCodeTrap=regionCodeTrap, supplementary=supplementary, vLANManagementVID=vLANManagementVID, aAAControlGroup=aAAControlGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPSync=sNTPSync, dfsPeaks=dfsPeaks, installArmStateTrap=installArmStateTrap, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapIPAddress=sNMPTrapIPAddress, linkSymmetry=linkSymmetry, encryptionGroup=encryptionGroup, ethernetGroup=ethernetGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, ptmp=ptmp, hTTPAccessEnabled=hTTPAccessEnabled, syslogStateTrap=syslogStateTrap, ptpGroups=ptpGroups, dfsTableNumber=dfsTableNumber, userEnabled=userEnabled, telecomsChannelStatus=telecomsChannelStatus, daylightSaving=daylightSaving, sNMPTrapTableIndex=sNMPTrapTableIndex, latitude=latitude, sNMPPortNumber=sNMPPortNumber, transmitDataRate=transmitDataRate)
