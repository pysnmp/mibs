...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", frequencyVariant=frequencyVariant, sntp=sntp, phyControlGroup=phyControlGroup, telecomsLoopbackTrap=telecomsLoopbackTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPServerPortNumber=sNTPServerPortNumber, telecomsChannelStatusTrap=telecomsChannelStatusTrap, ethernet=ethernet, telecomGroup=telecomGroup, licence=licence, ptp=ptp, vLANPriorityTable=vLANPriorityTable, dfsTableIndex=dfsTableIndex, configuration=configuration, eIRP=eIRP, productName=productName, linkLoss=linkLoss, constantPowerSpectralDensity=constantPowerSpectralDensity, installStatusTrap=installStatusTrap, tDDSynchronizationMode=tDDSynchronizationMode, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, systemReset=systemReset, telecomsLoopback=telecomsLoopback, tDDSynchronizationStatus=tDDSynchronizationStatus, management=management, managementGroup=managementGroup, syslogState=syslogState, ptpTraps=ptpTraps, linkName=linkName, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ptpCompliance=ptpCompliance, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, telecomsCableLength=telecomsCableLength, versions=versions, iPAddress=iPAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, vLANPriorityTableIndex=vLANPriorityTableIndex, transmitPower=transmitPower, aAAControl=aAAControl, dfsTableEntry=dfsTableEntry, cambium=cambium, dataPortAutoMdix=dataPortAutoMdix, receiveModulationMode=receiveModulationMode, unitOutOfCalibration=unitOutOfCalibration, remoteMaximumTransmitPower=remoteMaximumTransmitPower, subnetMask=subnetMask, dfsTableNumber=dfsTableNumber, remoteIPAddress=remoteIPAddress, daylightSaving=daylightSaving, maximumTransmitPower=maximumTransmitPower, sMTPServerPortNumber=sMTPServerPortNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, versionsGroup=versionsGroup, altitude=altitude, syslogLocalWrappedTrap=syslogLocalWrappedTrap, userName=userName, sNMPTrapTableNumber=sNMPTrapTableNumber, telecomsChannelStatus=telecomsChannelStatus, sMTPServerIPAddress=sMTPServerIPAddress, snmpControlGroup=snmpControlGroup, receiveFreqKHz=receiveFreqKHz, ptmp=ptmp, sNTPSync=sNTPSync, signalStrengthRatio=signalStrengthRatio, hTTPPortNumber=hTTPPortNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, supplementaryGroup=supplementaryGroup, groupID=groupID, encryptionAlgorithm=encryptionAlgorithm, capacityLicenseMismatch=capacityLicenseMismatch, licenceGroup=licenceGroup, smtp=smtp, sntpGroup=sntpGroup, supplementary=supplementary, syslogClientTrap=syslogClientTrap, siteName=siteName, productVariant=productVariant, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPState=sNTPState, receiveChannel=receiveChannel, dfsMeans=dfsMeans, vLANManagementPriority=vLANManagementPriority, telnetPortNumber=telnetPortNumber, notificationsGroup=notificationsGroup, sNMPEnabledTraps=sNMPEnabledTraps, secondarySoftwareVersion=secondarySoftwareVersion, syslogControl=syslogControl, cableLoss=cableLoss, wirelessLinkStatus=wirelessLinkStatus, userTable=userTable, channelBandwidth=channelBandwidth, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, alarmsGroup=alarmsGroup, resetGroup=resetGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, receiveDataRate=receiveDataRate, ptpTrapPrefix=ptpTrapPrefix, receivePower=receivePower, vLANPriorityQueueMapping=vLANPriorityQueueMapping, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, telecom=telecom, dfsGroup=dfsGroup, syslogControlGroup=syslogControlGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, installStatus=installStatus, telnetAccessEnabled=telnetAccessEnabled, userRole=userRole, noWirelessChannelAvailable=noWirelessChannelAvailable, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, aAAControlGroup=aAAControlGroup, phyControl=phyControl, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, userTableEntry=userTableEntry, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, alarms=alarms, sNMPTrapIPAddress=sNMPTrapIPAddress, telecomsLineCode=telecomsLineCode, tDDControl=tDDControl, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPServerPortNumber=tFTPServerPortNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNTPServerIPAddress=sNTPServerIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receiveFreqMHz=receiveFreqMHz, channelChangeTrap=channelChangeTrap, wirelessLinkAvailability=wirelessLinkAvailability, antennaGain=antennaGain, PYSNMP_MODULE_ID=cambium, hTTPSPortNumber=hTTPSPortNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNTPLastSync=sNTPLastSync, receiveModulationModeDetail=receiveModulationModeDetail, sNMPTrapPortNumber=sNMPTrapPortNumber, userTableNumber=userTableNumber, timeZone=timeZone, userEnabled=userEnabled, sNMPTrapVersion=sNMPTrapVersion, pubStats=pubStats, telecomsInterface=telecomsInterface, linkSymmetry=linkSymmetry, sMTPEnabledMessages=sMTPEnabledMessages, encryptionGroup=encryptionGroup, sMTPEmailAlert=sMTPEmailAlert, dataPortStatusTrap=dataPortStatusTrap, ptp500=ptp500, sNTPSyncTrap=sNTPSyncTrap, syslogStateTrap=syslogStateTrap, regionCodeTrap=regionCodeTrap, sNMPv3Enable=sNMPv3Enable, transmitModulationMode=transmitModulationMode, dfsTable=dfsTable, dataPortConfigurationMismatch=dataPortConfigurationMismatch, enabledDiagnosticAlarms=enabledDiagnosticAlarms, accessMethod=accessMethod, targetMACAddress=targetMACAddress, range=range, byteErrorRatio=byteErrorRatio, installArmState=installArmState, transmitDataRate=transmitDataRate, transmitChannel=transmitChannel, bootVersion=bootVersion, masterSlaveMode=masterSlaveMode, configurationGroup=configurationGroup, searchState=searchState, regionCode=regionCode, pubStatsGroup=pubStatsGroup, ptpGroups=ptpGroups, vectorError=vectorError, sNMPTrapTable=sNMPTrapTable, incompatibleRegionCodes=incompatibleRegionCodes, softwareVersion=softwareVersion, ethernetFiberSupport=ethernetFiberSupport, linkModeOptimisation=linkModeOptimisation, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, userTableIndex=userTableIndex, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortDisabledWarning=dataPortDisabledWarning, phyStatus=phyStatus, vLANPriorityTableEntry=vLANPriorityTableEntry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, phyStatusGroup=phyStatusGroup, syslogClient=syslogClient, dfsPeaks=dfsPeaks, sNMPPortNumber=sNMPPortNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, vLANManagementVID=vLANManagementVID, systemClock=systemClock, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sMTPSourceEmailAddress=sMTPSourceEmailAddress, bandwidthVariant=bandwidthVariant, installArmStateTrap=installArmStateTrap, licensedCapacity=licensedCapacity, sNTPPollInterval=sNTPPollInterval, longitude=longitude, userPassword=userPassword, incompatibleMasterAndSlave=incompatibleMasterAndSlave, latitude=latitude, encryption=encryption, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, reset=reset, tDDSynchronizationAlarm=tDDSynchronizationAlarm, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, aggregateDataRate=aggregateDataRate, smtpGroup=smtpGroup, tDDControlGroup=tDDControlGroup, ethernetGroup=ethernetGroup, dfs=dfs, transmitFreqMHz=transmitFreqMHz, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, transmitFreqKHz=transmitFreqKHz, hTTPAccessEnabled=hTTPAccessEnabled, hTTPSAccessEnabled=hTTPSAccessEnabled, dataPortStatus=dataPortStatus, sNMPCommunityString=sNMPCommunityString, hardwareVersion=hardwareVersion, snmpControl=snmpControl, gatewayIPAddress=gatewayIPAddress)
