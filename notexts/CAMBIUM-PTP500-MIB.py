...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", telecom=telecom, bandwidthVariant=bandwidthVariant, sNTPState=sNTPState, smtp=smtp, enabledDiagnosticAlarms=enabledDiagnosticAlarms, bootVersion=bootVersion, systemClock=systemClock, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, phyControlGroup=phyControlGroup, supplementary=supplementary, installStatusTrap=installStatusTrap, sntpGroup=sntpGroup, sNMPEnabledTraps=sNMPEnabledTraps, receiveDataRate=receiveDataRate, notificationsGroup=notificationsGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, syslogControlGroup=syslogControlGroup, userRole=userRole, ptp500=ptp500, vLANManagementPriority=vLANManagementPriority, timeZone=timeZone, dfsTableEntry=dfsTableEntry, ptp=ptp, tDDControlGroup=tDDControlGroup, dfsMeans=dfsMeans, sNMPCommunityString=sNMPCommunityString, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapTableNumber=sNMPTrapTableNumber, productName=productName, altitude=altitude, range=range, hardwareVersion=hardwareVersion, vLANPriorityTable=vLANPriorityTable, hTTPAccessEnabled=hTTPAccessEnabled, tFTPServerIPAddress=tFTPServerIPAddress, installArmState=installArmState, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapIPAddress=sNMPTrapIPAddress, aAAControlGroup=aAAControlGroup, signalStrengthRatio=signalStrengthRatio, ethernet=ethernet, productVariant=productVariant, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, latitude=latitude, installArmStateTrap=installArmStateTrap, versions=versions, ptpGroups=ptpGroups, userTableIndex=userTableIndex, syslogClient=syslogClient, tDDSynchronizationMode=tDDSynchronizationMode, dataPortAutoMdix=dataPortAutoMdix, sNTPSyncTrap=sNTPSyncTrap, versionsGroup=versionsGroup, encryptionGroup=encryptionGroup, configurationGroup=configurationGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPServerIPAddress=sMTPServerIPAddress, linkModeOptimizationMismatch=linkModeOptimizationMismatch, pubStatsGroup=pubStatsGroup, sNTPSync=sNTPSync, daylightSaving=daylightSaving, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortStatusTrap=dataPortStatusTrap, wirelessLinkAvailability=wirelessLinkAvailability, channelBandwidth=channelBandwidth, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPServerPortNumber=sNTPServerPortNumber, groupID=groupID, pubStats=pubStats, hTTPSAccessEnabled=hTTPSAccessEnabled, vLANPriorityTableEntry=vLANPriorityTableEntry, management=management, phyControl=phyControl, ptpTraps=ptpTraps, userName=userName, managementGroup=managementGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, PYSNMP_MODULE_ID=cambium, syslogControl=syslogControl, dfsTableIndex=dfsTableIndex, syslogLocalWrappedTrap=syslogLocalWrappedTrap, masterSlaveMode=masterSlaveMode, encryption=encryption, resetGroup=resetGroup, channelChangeTrap=channelChangeTrap, targetMACAddress=targetMACAddress, vLANManagementVID=vLANManagementVID, iPAddress=iPAddress, transmitPower=transmitPower, phyStatusGroup=phyStatusGroup, cableLoss=cableLoss, sNMPTrapVersion=sNMPTrapVersion, aAAControl=aAAControl, telecomsLoopback=telecomsLoopback, tFTPServerPortNumber=tFTPServerPortNumber, reset=reset, softwareVersion=softwareVersion, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, syslogState=syslogState, telecomGroup=telecomGroup, encryptionAlgorithm=encryptionAlgorithm, gatewayIPAddress=gatewayIPAddress, subnetMask=subnetMask, userTable=userTable, telnetAccessEnabled=telnetAccessEnabled, incompatibleRegionCodes=incompatibleRegionCodes, licenceGroup=licenceGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsGroup=dfsGroup, receiveFreqMHz=receiveFreqMHz, regionCodeTrap=regionCodeTrap, receivePower=receivePower, sMTPServerPortNumber=sMTPServerPortNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, telecomsInterface=telecomsInterface, ptmp=ptmp, wirelessLinkStatus=wirelessLinkStatus, licensedCapacity=licensedCapacity, linkLoss=linkLoss, ptpTrapPrefix=ptpTrapPrefix, linkModeOptimisation=linkModeOptimisation, byteErrorRatio=byteErrorRatio, installStatus=installStatus, linkSymmetry=linkSymmetry, sNTPServerIPAddress=sNTPServerIPAddress, dfsPeaks=dfsPeaks, sNMPTrapPortNumber=sNMPTrapPortNumber, ptpCompliance=ptpCompliance, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, transmitFreqKHz=transmitFreqKHz, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, transmitFreqMHz=transmitFreqMHz, telnetPortNumber=telnetPortNumber, aggregateDataRate=aggregateDataRate, telecomsChannelStatus=telecomsChannelStatus, dataPortDisabledWarning=dataPortDisabledWarning, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPPollInterval=sNTPPollInterval, secondarySoftwareVersion=secondarySoftwareVersion, sNMPPortNumber=sNMPPortNumber, userPassword=userPassword, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, transmitModulationMode=transmitModulationMode, maximumTransmitPower=maximumTransmitPower, receiveModulationMode=receiveModulationMode, telecomsLineCode=telecomsLineCode, syslogStateTrap=syslogStateTrap, telecomsCableLength=telecomsCableLength, dfs=dfs, linkName=linkName, hTTPPortNumber=hTTPPortNumber, ethernetFiberSupport=ethernetFiberSupport, licence=licence, sNMPTrapTable=sNMPTrapTable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, accessMethod=accessMethod, vLANPriorityQueueMapping=vLANPriorityQueueMapping, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, remoteIPAddress=remoteIPAddress, ethernetGroup=ethernetGroup, snmpControl=snmpControl, regionCode=regionCode, sntp=sntp, searchState=searchState, transmitDataRate=transmitDataRate, alarms=alarms, dfsTable=dfsTable, noWirelessChannelAvailable=noWirelessChannelAvailable, cambium=cambium, dfsTableNumber=dfsTableNumber, transmitChannel=transmitChannel, sMTPEmailAlert=sMTPEmailAlert, dataPortAutoNegotiation=dataPortAutoNegotiation, unitOutOfCalibration=unitOutOfCalibration, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sMTPEnabledMessages=sMTPEnabledMessages, alarmsGroup=alarmsGroup, systemReset=systemReset, sNTPLastSync=sNTPLastSync, telecomsChannelStatusTrap=telecomsChannelStatusTrap, userEnabled=userEnabled, snmpControlGroup=snmpControlGroup, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, smtpGroup=smtpGroup, telecomsLoopbackTrap=telecomsLoopbackTrap, tDDControl=tDDControl, receiveFreqKHz=receiveFreqKHz, configuration=configuration, userTableEntry=userTableEntry, antennaGain=antennaGain, siteName=siteName, vLANPriorityTableNumber=vLANPriorityTableNumber, sNMPv3Enable=sNMPv3Enable, receiveChannel=receiveChannel, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, syslogClientTrap=syslogClientTrap, userTableNumber=userTableNumber, phyStatus=phyStatus, hTTPSPortNumber=hTTPSPortNumber, frequencyVariant=frequencyVariant, receiveModulationModeDetail=receiveModulationModeDetail, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dataPortStatus=dataPortStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, longitude=longitude, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vectorError=vectorError, constantPowerSpectralDensity=constantPowerSpectralDensity, eIRP=eIRP, supplementaryGroup=supplementaryGroup, capacityLicenseMismatch=capacityLicenseMismatch, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap)
