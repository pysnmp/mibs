...
# Produced by pysmi-1.1.0 at Mon Nov 15 20:11:14 2021
...
Counter64, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ObjectIdentity, Counter32, Integer32, iso, ModuleIdentity, NotificationType, enterprises, Unsigned32, IpAddress, MibIdentifier, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ObjectIdentity", "Counter32", "Integer32", "iso", "ModuleIdentity", "NotificationType", "enterprises", "Unsigned32", "IpAddress", "MibIdentifier", "TimeTicks")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", resetGroup=resetGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, versionsGroup=versionsGroup, dataPortAutoMdix=dataPortAutoMdix, transmitChannel=transmitChannel, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, targetMACAddress=targetMACAddress, vectorError=vectorError, receiveChannel=receiveChannel, sMTPServerPortNumber=sMTPServerPortNumber, telecomsChannelStatusTrap=telecomsChannelStatusTrap, wirelessLinkAvailability=wirelessLinkAvailability, dataPortDisabledWarning=dataPortDisabledWarning, telecomsLoopbackTrap=telecomsLoopbackTrap, receiveFreqMHz=receiveFreqMHz, antennaGain=antennaGain, eIRP=eIRP, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, systemReset=systemReset, dfsGroup=dfsGroup, maximumTransmitPower=maximumTransmitPower, sntp=sntp, systemClock=systemClock, hTTPPortNumber=hTTPPortNumber, gatewayIPAddress=gatewayIPAddress, tDDControl=tDDControl, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, alarms=alarms, telnetAccessEnabled=telnetAccessEnabled, incompatibleRegionCodes=incompatibleRegionCodes, syslogClientTrap=syslogClientTrap, linkName=linkName, tDDSynchronizationStatus=tDDSynchronizationStatus, linkLoss=linkLoss, constantPowerSpectralDensity=constantPowerSpectralDensity, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, PYSNMP_MODULE_ID=cambium, tFTPServerPortNumber=tFTPServerPortNumber, encryptionGroup=encryptionGroup, signalStrengthRatio=signalStrengthRatio, pubStats=pubStats, tDDSynchronizationAlarm=tDDSynchronizationAlarm, masterSlaveMode=masterSlaveMode, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPEnabledTraps=sNMPEnabledTraps, dataPortStatusTrap=dataPortStatusTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPCommunityString=sNMPCommunityString, phyControlGroup=phyControlGroup, transmitDataRate=transmitDataRate, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, telecomGroup=telecomGroup, hardwareVersion=hardwareVersion, management=management, sNMPv3Enable=sNMPv3Enable, dfsTableNumber=dfsTableNumber, siteName=siteName, ptp500=ptp500, sNMPTrapTable=sNMPTrapTable, frequencyVariant=frequencyVariant, remoteMaximumTransmitPower=remoteMaximumTransmitPower, useVLANForManagementInterfaces=useVLANForManagementInterfaces, receiveFreqKHz=receiveFreqKHz, sNTPLastSync=sNTPLastSync, vLANPriorityTableIndex=vLANPriorityTableIndex, vLANManagementVID=vLANManagementVID, telecomsLineCode=telecomsLineCode, bandwidthVariant=bandwidthVariant, licensedCapacity=licensedCapacity, dfs=dfs, notificationsGroup=notificationsGroup, ethernetFiberSupport=ethernetFiberSupport, range=range, aAAControlGroup=aAAControlGroup, transmitFreqMHz=transmitFreqMHz, linkModeOptimizationMismatch=linkModeOptimizationMismatch, enabledDiagnosticAlarms=enabledDiagnosticAlarms, latitude=latitude, ethernetGroup=ethernetGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, syslogControl=syslogControl, receiveDataRate=receiveDataRate, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, softwareVersion=softwareVersion, sNTPPollInterval=sNTPPollInterval, smtpGroup=smtpGroup, groupID=groupID, vLANPriorityTableEntry=vLANPriorityTableEntry, installArmStateTrap=installArmStateTrap, receiveModulationModeDetail=receiveModulationModeDetail, longitude=longitude, regionCode=regionCode, phyStatus=phyStatus, accessMethod=accessMethod, tDDControlGroup=tDDControlGroup, vLANManagementPriority=vLANManagementPriority, channelBandwidth=channelBandwidth, userTable=userTable, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dfsPeaks=dfsPeaks, syslogStateTrap=syslogStateTrap, telnetPortNumber=telnetPortNumber, bootVersion=bootVersion, dfsTableEntry=dfsTableEntry, licence=licence, dfsTableIndex=dfsTableIndex, ptp=ptp, ptpTrapPrefix=ptpTrapPrefix, sMTPSourceEmailAddress=sMTPSourceEmailAddress, regionCodeTrap=regionCodeTrap, ptpCompliance=ptpCompliance, unitOutOfCalibration=unitOutOfCalibration, altitude=altitude, iPAddress=iPAddress, configurationGroup=configurationGroup, sNTPServerIPAddress=sNTPServerIPAddress, sNTPState=sNTPState, installStatus=installStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, alarmsGroup=alarmsGroup, linkSymmetry=linkSymmetry, sNMPTrapPortNumber=sNMPTrapPortNumber, byteErrorRatio=byteErrorRatio, telecom=telecom, pubStatsGroup=pubStatsGroup, capacityLicenseMismatch=capacityLicenseMismatch, sNTPSyncTrap=sNTPSyncTrap, aggregateDataRate=aggregateDataRate, dfsMeans=dfsMeans, receiveModulationMode=receiveModulationMode, encryptionAlgorithm=encryptionAlgorithm, userPassword=userPassword, userEnabled=userEnabled, telecomsCableLength=telecomsCableLength, configuration=configuration, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, hTTPAccessEnabled=hTTPAccessEnabled, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, vLANPriorityTable=vLANPriorityTable, aAAControl=aAAControl, hTTPSAccessEnabled=hTTPSAccessEnabled, sMTPEmailAlert=sMTPEmailAlert, ptmp=ptmp, userRole=userRole, noWirelessChannelAvailable=noWirelessChannelAvailable, hTTPSPortNumber=hTTPSPortNumber, ptpGroups=ptpGroups, managementGroup=managementGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sNMPTrapIPAddress=sNMPTrapIPAddress, supplementaryGroup=supplementaryGroup, licenceGroup=licenceGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, telecomsLoopback=telecomsLoopback, phyControl=phyControl, secondarySoftwareVersion=secondarySoftwareVersion, sNMPTrapTableNumber=sNMPTrapTableNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, installArmState=installArmState, sNMPPortNumber=sNMPPortNumber, smtp=smtp, sNMPTrapTableEntry=sNMPTrapTableEntry, syslogControlGroup=syslogControlGroup, userTableNumber=userTableNumber, tFTPServerIPAddress=tFTPServerIPAddress, channelChangeTrap=channelChangeTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, syslogState=syslogState, snmpControl=snmpControl, userTableIndex=userTableIndex, cableLoss=cableLoss, installStatusTrap=installStatusTrap, sNTPServerPortNumber=sNTPServerPortNumber, userName=userName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, versions=versions, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, subnetMask=subnetMask, supplementary=supplementary, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, timeZone=timeZone, sNTPSync=sNTPSync, remoteIPAddress=remoteIPAddress, cambium=cambium, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sntpGroup=sntpGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telecomsInterface=telecomsInterface, productName=productName, transmitPower=transmitPower, transmitFreqKHz=transmitFreqKHz, daylightSaving=daylightSaving, productVariant=productVariant, ptpTraps=ptpTraps, snmpControlGroup=snmpControlGroup, ethernet=ethernet, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortStatus=dataPortStatus, dfsTable=dfsTable, wirelessLinkStatus=wirelessLinkStatus, encryption=encryption, searchState=searchState, sMTPEnabledMessages=sMTPEnabledMessages, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, transmitModulationMode=transmitModulationMode, linkModeOptimisation=linkModeOptimisation, sNMPTrapVersion=sNMPTrapVersion, tDDSynchronizationMode=tDDSynchronizationMode, syslogClient=syslogClient, telecomsChannelStatus=telecomsChannelStatus, receivePower=receivePower, sMTPServerIPAddress=sMTPServerIPAddress, userTableEntry=userTableEntry, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, phyStatusGroup=phyStatusGroup, reset=reset)
