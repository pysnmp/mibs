...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", encryptionGroup=encryptionGroup, installStatus=installStatus, sNTPSyncTrap=sNTPSyncTrap, syslogClient=syslogClient, managementGroup=managementGroup, incompatibleRegionCodes=incompatibleRegionCodes, aAAControl=aAAControl, unitOutOfCalibration=unitOutOfCalibration, receiveModulationModeDetail=receiveModulationModeDetail, resetGroup=resetGroup, eIRP=eIRP, wirelessLinkAvailability=wirelessLinkAvailability, targetMACAddress=targetMACAddress, snmpControl=snmpControl, enabledDiagnosticAlarms=enabledDiagnosticAlarms, receiveFreqMHz=receiveFreqMHz, receiveDataRate=receiveDataRate, userTableIndex=userTableIndex, secondarySoftwareVersion=secondarySoftwareVersion, tFTPServerIPAddress=tFTPServerIPAddress, channelBandwidth=channelBandwidth, constantPowerSpectralDensity=constantPowerSpectralDensity, linkModeOptimizationMismatch=linkModeOptimizationMismatch, vLANPriorityTableNumber=vLANPriorityTableNumber, receivePower=receivePower, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataPortStatus=dataPortStatus, longitude=longitude, dfsPeaks=dfsPeaks, vLANPriorityTableEntry=vLANPriorityTableEntry, sntpGroup=sntpGroup, receiveChannel=receiveChannel, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataPortStatusTrap=dataPortStatusTrap, transmitFreqMHz=transmitFreqMHz, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapTableIndex=sNMPTrapTableIndex, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dfsTableEntry=dfsTableEntry, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, snmpControlGroup=snmpControlGroup, versions=versions, remoteIPAddress=remoteIPAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPPortNumber=sNMPPortNumber, vLANManagementVID=vLANManagementVID, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ptpTraps=ptpTraps, sNMPTrapVersion=sNMPTrapVersion, regionCode=regionCode, systemClock=systemClock, ptpCompliance=ptpCompliance, ptp500=ptp500, smtp=smtp, daylightSaving=daylightSaving, phyStatusGroup=phyStatusGroup, dfsTableNumber=dfsTableNumber, licenceGroup=licenceGroup, cableLoss=cableLoss, PYSNMP_MODULE_ID=cambium, sNTPServerIPAddress=sNTPServerIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, syslogControl=syslogControl, telecomsLoopback=telecomsLoopback, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPTrapPortNumber=sNMPTrapPortNumber, receiveModulationMode=receiveModulationMode, hTTPSAccessEnabled=hTTPSAccessEnabled, receiveFreqKHz=receiveFreqKHz, telecomsLoopbackTrap=telecomsLoopbackTrap, ethernetGroup=ethernetGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, telecomGroup=telecomGroup, encryption=encryption, ptmp=ptmp, installArmState=installArmState, altitude=altitude, byteErrorRatio=byteErrorRatio, userEnabled=userEnabled, supplementaryGroup=supplementaryGroup, sNMPTrapTable=sNMPTrapTable, hardwareVersion=hardwareVersion, smtpGroup=smtpGroup, tDDControlGroup=tDDControlGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, pubStatsGroup=pubStatsGroup, sNMPEnabledTraps=sNMPEnabledTraps, vLANPriorityTableIndex=vLANPriorityTableIndex, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, iPAddress=iPAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, softwareVersion=softwareVersion, userPassword=userPassword, licensedCapacity=licensedCapacity, dataPortAutoMdix=dataPortAutoMdix, transmitDataRate=transmitDataRate, transmitFreqKHz=transmitFreqKHz, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ptpTrapPrefix=ptpTrapPrefix, userTableNumber=userTableNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, syslogClientTrap=syslogClientTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, telecomsCableLength=telecomsCableLength, maximumTransmitPower=maximumTransmitPower, sntp=sntp, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tFTPServerPortNumber=tFTPServerPortNumber, sNTPPollInterval=sNTPPollInterval, encryptionAlgorithm=encryptionAlgorithm, sNTPLastSync=sNTPLastSync, dfsGroup=dfsGroup, vLANPriorityTable=vLANPriorityTable, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, linkSymmetry=linkSymmetry, telnetPortNumber=telnetPortNumber, supplementary=supplementary, sMTPServerIPAddress=sMTPServerIPAddress, installArmStateTrap=installArmStateTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, transmitChannel=transmitChannel, tDDSynchronizationAlarm=tDDSynchronizationAlarm, alarms=alarms, sNTPServerPortNumber=sNTPServerPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dfsTableIndex=dfsTableIndex, sNMPTrapTableEntry=sNMPTrapTableEntry, tDDSynchronizationMode=tDDSynchronizationMode, sNMPv3Enable=sNMPv3Enable, vectorError=vectorError, cambium=cambium, userTableEntry=userTableEntry, vLANManagementPriority=vLANManagementPriority, sNMPCommunityString=sNMPCommunityString, installStatusTrap=installStatusTrap, tDDControl=tDDControl, ethernetFiberSupport=ethernetFiberSupport, configuration=configuration, gatewayIPAddress=gatewayIPAddress, searchState=searchState, syslogLocalWrappedTrap=syslogLocalWrappedTrap, bootVersion=bootVersion, telecom=telecom, configurationGroup=configurationGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, dataPortAutoNegotiation=dataPortAutoNegotiation, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, licence=licence, timeZone=timeZone, telecomsChannelStatus=telecomsChannelStatus, aAAControlGroup=aAAControlGroup, syslogState=syslogState, dataPortDisabledWarning=dataPortDisabledWarning, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, systemReset=systemReset, latitude=latitude, subnetMask=subnetMask, ptpGroups=ptpGroups, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sMTPServerPortNumber=sMTPServerPortNumber, wirelessLinkStatus=wirelessLinkStatus, phyStatus=phyStatus, sMTPEmailAlert=sMTPEmailAlert, ethernet=ethernet, regionCodeTrap=regionCodeTrap, ptp=ptp, telecomsChannelStatusTrap=telecomsChannelStatusTrap, antennaGain=antennaGain, telnetAccessEnabled=telnetAccessEnabled, hTTPSPortNumber=hTTPSPortNumber, linkLoss=linkLoss, phyControl=phyControl, userRole=userRole, hTTPPortNumber=hTTPPortNumber, telecomsLineCode=telecomsLineCode, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, channelChangeTrap=channelChangeTrap, linkName=linkName, hTTPAccessEnabled=hTTPAccessEnabled, productName=productName, management=management, signalStrengthRatio=signalStrengthRatio, dfsTable=dfsTable, transmitPower=transmitPower, sNTPState=sNTPState, dfs=dfs, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, userTable=userTable, bandwidthVariant=bandwidthVariant, linkModeOptimisation=linkModeOptimisation, range=range, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, notificationsGroup=notificationsGroup, groupID=groupID, productVariant=productVariant, siteName=siteName, accessMethod=accessMethod, userName=userName, syslogControlGroup=syslogControlGroup, pubStats=pubStats, syslogStateTrap=syslogStateTrap, aggregateDataRate=aggregateDataRate, reset=reset, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, masterSlaveMode=masterSlaveMode, telecomsInterface=telecomsInterface, transmitModulationMode=transmitModulationMode, capacityLicenseMismatch=capacityLicenseMismatch, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, alarmsGroup=alarmsGroup, frequencyVariant=frequencyVariant, sNTPSync=sNTPSync, phyControlGroup=phyControlGroup, versionsGroup=versionsGroup, dfsMeans=dfsMeans, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap)
