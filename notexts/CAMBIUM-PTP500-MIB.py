...
# Produced by pysmi-1.1.3 at Sun Nov 21 00:36:20 2021
...
iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, NotificationType, MibIdentifier, Unsigned32, IpAddress, TimeTicks, enterprises, ObjectIdentity, ModuleIdentity, Gauge32, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "NotificationType", "MibIdentifier", "Unsigned32", "IpAddress", "TimeTicks", "enterprises", "ObjectIdentity", "ModuleIdentity", "Gauge32", "Bits", "Integer32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sMTPEmailAlert=sMTPEmailAlert, linkSymmetry=linkSymmetry, receivePower=receivePower, snmpControl=snmpControl, smtpGroup=smtpGroup, sNMPTrapTable=sNMPTrapTable, sNMPTrapVersion=sNMPTrapVersion, encryption=encryption, cableLoss=cableLoss, wirelessLinkStatus=wirelessLinkStatus, telecomsChannelStatusTrap=telecomsChannelStatusTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, hTTPAccessEnabled=hTTPAccessEnabled, sNTPSync=sNTPSync, tDDSynchronizationMode=tDDSynchronizationMode, unitOutOfCalibration=unitOutOfCalibration, pubStats=pubStats, managementGroup=managementGroup, tDDControlGroup=tDDControlGroup, ptpGroups=ptpGroups, userTableNumber=userTableNumber, hardwareVersion=hardwareVersion, dfsTableEntry=dfsTableEntry, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, aAAControl=aAAControl, vLANManagementPriority=vLANManagementPriority, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ethernetGroup=ethernetGroup, receiveFreqKHz=receiveFreqKHz, wirelessLinkAvailability=wirelessLinkAvailability, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortDisabledWarning=dataPortDisabledWarning, byteErrorRatio=byteErrorRatio, transmitDataRate=transmitDataRate, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dfsPeaks=dfsPeaks, ptpTraps=ptpTraps, sNTPSyncTrap=sNTPSyncTrap, systemClock=systemClock, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, syslogStateTrap=syslogStateTrap, vLANPriorityTable=vLANPriorityTable, sMTPEnabledMessages=sMTPEnabledMessages, vLANPriorityTableIndex=vLANPriorityTableIndex, telecomGroup=telecomGroup, range=range, regionCode=regionCode, tDDControl=tDDControl, dfsTableNumber=dfsTableNumber, notificationsGroup=notificationsGroup, syslogClientTrap=syslogClientTrap, licensedCapacity=licensedCapacity, dataPortAutoNegotiation=dataPortAutoNegotiation, signalStrengthRatio=signalStrengthRatio, sntpGroup=sntpGroup, dfsTable=dfsTable, phyControlGroup=phyControlGroup, telecom=telecom, syslogControl=syslogControl, linkLoss=linkLoss, ethernetFiberSupport=ethernetFiberSupport, tDDSynchronizationAlarm=tDDSynchronizationAlarm, altitude=altitude, licence=licence, dataPortAutoMdix=dataPortAutoMdix, vLANPriorityQueueMapping=vLANPriorityQueueMapping, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, bootVersion=bootVersion, supplementary=supplementary, sMTPServerPortNumber=sMTPServerPortNumber, ethernet=ethernet, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, transmitFreqMHz=transmitFreqMHz, userTable=userTable, configuration=configuration, sNMPCommunityString=sNMPCommunityString, telecomsChannelStatus=telecomsChannelStatus, secondarySoftwareVersion=secondarySoftwareVersion, pubStatsGroup=pubStatsGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, accessMethod=accessMethod, management=management, receiveModulationMode=receiveModulationMode, configurationGroup=configurationGroup, versionsGroup=versionsGroup, snmpControlGroup=snmpControlGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, vLANManagementVID=vLANManagementVID, transmitPower=transmitPower, incompatibleRegionCodes=incompatibleRegionCodes, transmitModulationMode=transmitModulationMode, alarms=alarms, sNTPState=sNTPState, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, syslogClient=syslogClient, softwareVersion=softwareVersion, dfsGroup=dfsGroup, masterSlaveMode=masterSlaveMode, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPServerIPAddress=sNTPServerIPAddress, iPAddress=iPAddress, phyStatusGroup=phyStatusGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, userName=userName, incompatibleMasterAndSlave=incompatibleMasterAndSlave, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, phyControl=phyControl, targetMACAddress=targetMACAddress, dfsMeans=dfsMeans, channelBandwidth=channelBandwidth, latitude=latitude, tDDSynchronizationStatus=tDDSynchronizationStatus, maximumTransmitPower=maximumTransmitPower, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, productVariant=productVariant, productName=productName, tFTPServerPortNumber=tFTPServerPortNumber, sNTPPollInterval=sNTPPollInterval, userEnabled=userEnabled, smtp=smtp, sNMPEnabledTraps=sNMPEnabledTraps, cambium=cambium, sNMPTrapTableEntry=sNMPTrapTableEntry, userTableEntry=userTableEntry, ptp500=ptp500, PYSNMP_MODULE_ID=cambium, telecomsInterface=telecomsInterface, subnetMask=subnetMask, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, installStatus=installStatus, receiveModulationModeDetail=receiveModulationModeDetail, installArmStateTrap=installArmStateTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, encryptionGroup=encryptionGroup, versions=versions, hTTPSAccessEnabled=hTTPSAccessEnabled, telecomsLoopback=telecomsLoopback, dfsTableIndex=dfsTableIndex, capacityLicenseMismatch=capacityLicenseMismatch, dataPortStatusTrap=dataPortStatusTrap, receiveChannel=receiveChannel, aggregateDataRate=aggregateDataRate, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, daylightSaving=daylightSaving, telnetAccessEnabled=telnetAccessEnabled, hTTPSPortNumber=hTTPSPortNumber, telecomsLineCode=telecomsLineCode, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, groupID=groupID, sNMPPortNumber=sNMPPortNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dfs=dfs, gatewayIPAddress=gatewayIPAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, channelChangeTrap=channelChangeTrap, receiveFreqMHz=receiveFreqMHz, dataPortStatus=dataPortStatus, siteName=siteName, transmitChannel=transmitChannel, syslogControlGroup=syslogControlGroup, transmitFreqKHz=transmitFreqKHz, linkModeOptimizationMismatch=linkModeOptimizationMismatch, alarmsGroup=alarmsGroup, reset=reset, vLANPriorityTableEntry=vLANPriorityTableEntry, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telecomsCableLength=telecomsCableLength, hTTPPortNumber=hTTPPortNumber, telecomsLoopbackTrap=telecomsLoopbackTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapIPAddress=sNMPTrapIPAddress, regionCodeTrap=regionCodeTrap, licenceGroup=licenceGroup, sNTPLastSync=sNTPLastSync, remoteIPAddress=remoteIPAddress, searchState=searchState, aAAControlGroup=aAAControlGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, supplementaryGroup=supplementaryGroup, syslogState=syslogState, syslogLocalWrappedTrap=syslogLocalWrappedTrap, bandwidthVariant=bandwidthVariant, userTableIndex=userTableIndex, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNMPv3Enable=sNMPv3Enable, tFTPServerIPAddress=tFTPServerIPAddress, systemReset=systemReset, telnetPortNumber=telnetPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPServerPortNumber=sNTPServerPortNumber, installStatusTrap=installStatusTrap, ptmp=ptmp, linkModeOptimisation=linkModeOptimisation, eIRP=eIRP, phyStatus=phyStatus, antennaGain=antennaGain, resetGroup=resetGroup, sMTPServerIPAddress=sMTPServerIPAddress, sntp=sntp, frequencyVariant=frequencyVariant, sMTPSourceEmailAddress=sMTPSourceEmailAddress, linkName=linkName, ptpCompliance=ptpCompliance, userRole=userRole, userPassword=userPassword, ptp=ptp, installArmState=installArmState, timeZone=timeZone, encryptionAlgorithm=encryptionAlgorithm, longitude=longitude, receiveDataRate=receiveDataRate, vectorError=vectorError, ptpTrapPrefix=ptpTrapPrefix)
