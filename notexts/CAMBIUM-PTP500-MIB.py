...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", userPassword=userPassword, sNMPTrapTable=sNMPTrapTable, userName=userName, receiveChannel=receiveChannel, sNMPTrapVersion=sNMPTrapVersion, telecomsChannelStatusTrap=telecomsChannelStatusTrap, ptpCompliance=ptpCompliance, supplementaryGroup=supplementaryGroup, systemReset=systemReset, regionCode=regionCode, vLANManagementVID=vLANManagementVID, telecomsInterface=telecomsInterface, managementGroup=managementGroup, userTableIndex=userTableIndex, vLANPriorityTable=vLANPriorityTable, wirelessLinkAvailability=wirelessLinkAvailability, regionCodeTrap=regionCodeTrap, configuration=configuration, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tFTPServerIPAddress=tFTPServerIPAddress, installStatus=installStatus, incompatibleRegionCodes=incompatibleRegionCodes, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, systemClock=systemClock, telnetAccessEnabled=telnetAccessEnabled, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, maximumTransmitPower=maximumTransmitPower, byteErrorRatio=byteErrorRatio, groupID=groupID, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, receiveModulationMode=receiveModulationMode, sNTPSyncTrap=sNTPSyncTrap, phyControl=phyControl, tDDControlGroup=tDDControlGroup, supplementary=supplementary, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, siteName=siteName, telecomsLineCode=telecomsLineCode, telecom=telecom, antennaGain=antennaGain, transmitFreqKHz=transmitFreqKHz, hardwareVersion=hardwareVersion, vectorError=vectorError, hTTPPortNumber=hTTPPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, installArmStateTrap=installArmStateTrap, dfsTableEntry=dfsTableEntry, syslogLocalWrappedTrap=syslogLocalWrappedTrap, management=management, linkModeOptimizationMismatch=linkModeOptimizationMismatch, telecomsLoopback=telecomsLoopback, subnetMask=subnetMask, sNMPPortNumber=sNMPPortNumber, syslogStateTrap=syslogStateTrap, phyControlGroup=phyControlGroup, sNMPCommunityString=sNMPCommunityString, userTableNumber=userTableNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, userTable=userTable, dfsMeans=dfsMeans, versionsGroup=versionsGroup, transmitFreqMHz=transmitFreqMHz, dataPortConfigurationMismatch=dataPortConfigurationMismatch, syslogState=syslogState, licenceGroup=licenceGroup, sMTPEnabledMessages=sMTPEnabledMessages, productVariant=productVariant, channelChangeTrap=channelChangeTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, encryption=encryption, sNMPv3Enable=sNMPv3Enable, transmitChannel=transmitChannel, longitude=longitude, configurationGroup=configurationGroup, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, aAAControlGroup=aAAControlGroup, notificationsGroup=notificationsGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, installStatusTrap=installStatusTrap, iPAddress=iPAddress, sNTPServerPortNumber=sNTPServerPortNumber, syslogControlGroup=syslogControlGroup, pubStatsGroup=pubStatsGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, aAAControl=aAAControl, telecomsCableLength=telecomsCableLength, vLANPriorityTableIndex=vLANPriorityTableIndex, dfsTableNumber=dfsTableNumber, transmitPower=transmitPower, dataPortDisabledWarning=dataPortDisabledWarning, ptmp=ptmp, sNMPEnabledTraps=sNMPEnabledTraps, hTTPSPortNumber=hTTPSPortNumber, syslogClientTrap=syslogClientTrap, sntp=sntp, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, vLANManagementPriority=vLANManagementPriority, cambium=cambium, sNTPSync=sNTPSync, telecomGroup=telecomGroup, dfsTableIndex=dfsTableIndex, secondarySoftwareVersion=secondarySoftwareVersion, smtp=smtp, bandwidthVariant=bandwidthVariant, sNMPTrapTableEntry=sNMPTrapTableEntry, snmpControlGroup=snmpControlGroup, sNTPServerIPAddress=sNTPServerIPAddress, sNTPPollInterval=sNTPPollInterval, unitOutOfCalibration=unitOutOfCalibration, dfsGroup=dfsGroup, tFTPServerPortNumber=tFTPServerPortNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, receiveFreqMHz=receiveFreqMHz, userRole=userRole, sMTPEmailAlert=sMTPEmailAlert, accessMethod=accessMethod, reset=reset, dataPortAutoMdix=dataPortAutoMdix, constantPowerSpectralDensity=constantPowerSpectralDensity, bootVersion=bootVersion, encryptionAlgorithm=encryptionAlgorithm, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, linkSymmetry=linkSymmetry, dfsPeaks=dfsPeaks, tDDSynchronizationStatus=tDDSynchronizationStatus, hTTPAccessEnabled=hTTPAccessEnabled, userEnabled=userEnabled, dfs=dfs, tDDControl=tDDControl, vLANPriorityQueueMapping=vLANPriorityQueueMapping, installArmState=installArmState, syslogControl=syslogControl, tDDSynchronizationMode=tDDSynchronizationMode, ptp=ptp, sNTPLastSync=sNTPLastSync, cableLoss=cableLoss, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ethernetFiberSupport=ethernetFiberSupport, sntpGroup=sntpGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, linkName=linkName, noWirelessChannelAvailable=noWirelessChannelAvailable, alarmsGroup=alarmsGroup, productName=productName, PYSNMP_MODULE_ID=cambium, ptp500=ptp500, sNMPTrapTableNumber=sNMPTrapTableNumber, receiveDataRate=receiveDataRate, sNMPTrapIPAddress=sNMPTrapIPAddress, snmpControl=snmpControl, phyStatusGroup=phyStatusGroup, range=range, dataPortAutoNegotiation=dataPortAutoNegotiation, ethernetGroup=ethernetGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dataPortStatusTrap=dataPortStatusTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ethernet=ethernet, userTableEntry=userTableEntry, alarms=alarms, capacityLicenseMismatch=capacityLicenseMismatch, channelBandwidth=channelBandwidth, targetMACAddress=targetMACAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, receiveModulationModeDetail=receiveModulationModeDetail, ptpTraps=ptpTraps, ptpGroups=ptpGroups, telecomsChannelStatus=telecomsChannelStatus, vLANPriorityTableNumber=vLANPriorityTableNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, altitude=altitude, frequencyVariant=frequencyVariant, telecomsLoopbackTrap=telecomsLoopbackTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, encryptionGroup=encryptionGroup, receivePower=receivePower, telnetPortNumber=telnetPortNumber, transmitModulationMode=transmitModulationMode, enabledDiagnosticAlarms=enabledDiagnosticAlarms, smtpGroup=smtpGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPTrapPortNumber=sNMPTrapPortNumber, softwareVersion=softwareVersion, versions=versions, dataPortStatus=dataPortStatus, sMTPServerIPAddress=sMTPServerIPAddress, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, masterSlaveMode=masterSlaveMode, gatewayIPAddress=gatewayIPAddress, linkModeOptimisation=linkModeOptimisation, sNTPState=sNTPState, wirelessLinkStatus=wirelessLinkStatus, syslogClient=syslogClient, remoteIPAddress=remoteIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, vLANPriorityTableEntry=vLANPriorityTableEntry, transmitDataRate=transmitDataRate, sMTPServerPortNumber=sMTPServerPortNumber, linkLoss=linkLoss, hTTPSAccessEnabled=hTTPSAccessEnabled, latitude=latitude, timeZone=timeZone, ptpTrapPrefix=ptpTrapPrefix, phyStatus=phyStatus, pubStats=pubStats, dfsTable=dfsTable, receiveFreqKHz=receiveFreqKHz, searchState=searchState, eIRP=eIRP, sNMPTrapTableIndex=sNMPTrapTableIndex, daylightSaving=daylightSaving, licensedCapacity=licensedCapacity, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, licence=licence, aggregateDataRate=aggregateDataRate, signalStrengthRatio=signalStrengthRatio, resetGroup=resetGroup)
