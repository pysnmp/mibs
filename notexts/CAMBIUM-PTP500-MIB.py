...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", reset=reset, cableLoss=cableLoss, vectorError=vectorError, productVariant=productVariant, userTableNumber=userTableNumber, telecomGroup=telecomGroup, latitude=latitude, telecomsLoopbackTrap=telecomsLoopbackTrap, accessMethod=accessMethod, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPTrapVersion=sNMPTrapVersion, syslogClient=syslogClient, userTableEntry=userTableEntry, byteErrorRatio=byteErrorRatio, versionsGroup=versionsGroup, telnetAccessEnabled=telnetAccessEnabled, PYSNMP_MODULE_ID=cambium, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dfsTable=dfsTable, encryptionGroup=encryptionGroup, telnetPortNumber=telnetPortNumber, receivePower=receivePower, installStatusTrap=installStatusTrap, bandwidthVariant=bandwidthVariant, wirelessLinkStatus=wirelessLinkStatus, wirelessLinkAvailability=wirelessLinkAvailability, vLANPriorityQueueMapping=vLANPriorityQueueMapping, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPTrapIPAddress=sNMPTrapIPAddress, transmitModulationMode=transmitModulationMode, tFTPServerIPAddress=tFTPServerIPAddress, softwareVersion=softwareVersion, searchState=searchState, sNMPEnabledTraps=sNMPEnabledTraps, installStatus=installStatus, daylightSaving=daylightSaving, receiveFreqKHz=receiveFreqKHz, dataPortDisabledWarning=dataPortDisabledWarning, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNTPLastSync=sNTPLastSync, cambium=cambium, management=management, ptpGroups=ptpGroups, smtp=smtp, installArmState=installArmState, unitOutOfCalibration=unitOutOfCalibration, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPState=sNTPState, encryptionAlgorithm=encryptionAlgorithm, regionCodeTrap=regionCodeTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sMTPSourceEmailAddress=sMTPSourceEmailAddress, aAAControl=aAAControl, dataPortAutoMdix=dataPortAutoMdix, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, telecom=telecom, vLANPriorityTableIndex=vLANPriorityTableIndex, pubStatsGroup=pubStatsGroup, snmpControl=snmpControl, incompatibleRegionCodes=incompatibleRegionCodes, sMTPEnabledMessages=sMTPEnabledMessages, ethernet=ethernet, sMTPEmailAlert=sMTPEmailAlert, telecomsInterface=telecomsInterface, configuration=configuration, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, userName=userName, sNMPTrapTable=sNMPTrapTable, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ptpCompliance=ptpCompliance, licence=licence, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, syslogClientTrap=syslogClientTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortStatus=dataPortStatus, iPAddress=iPAddress, syslogControl=syslogControl, channelChangeTrap=channelChangeTrap, sNMPCommunityString=sNMPCommunityString, constantPowerSpectralDensity=constantPowerSpectralDensity, telecomsLineCode=telecomsLineCode, tDDSynchronizationAlarm=tDDSynchronizationAlarm, maximumTransmitPower=maximumTransmitPower, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dfsTableEntry=dfsTableEntry, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sntpGroup=sntpGroup, sNTPSyncTrap=sNTPSyncTrap, receiveModulationMode=receiveModulationMode, bootVersion=bootVersion, managementGroup=managementGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, vLANPriorityTableNumber=vLANPriorityTableNumber, ptpTraps=ptpTraps, snmpControlGroup=snmpControlGroup, telecomsCableLength=telecomsCableLength, incompatibleMasterAndSlave=incompatibleMasterAndSlave, configurationGroup=configurationGroup, altitude=altitude, sNTPSync=sNTPSync, supplementaryGroup=supplementaryGroup, hTTPSPortNumber=hTTPSPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, gatewayIPAddress=gatewayIPAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, secondarySoftwareVersion=secondarySoftwareVersion, linkModeOptimisation=linkModeOptimisation, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPServerIPAddress=sMTPServerIPAddress, vLANPriorityTable=vLANPriorityTable, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, systemReset=systemReset, dfsMeans=dfsMeans, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, targetMACAddress=targetMACAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, userRole=userRole, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, telecomsChannelStatus=telecomsChannelStatus, receiveChannel=receiveChannel, alarmsGroup=alarmsGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNMPPortNumber=sNMPPortNumber, phyStatus=phyStatus, productName=productName, channelBandwidth=channelBandwidth, frequencyVariant=frequencyVariant, sNMPTrapTableIndex=sNMPTrapTableIndex, remoteIPAddress=remoteIPAddress, linkName=linkName, phyControl=phyControl, sNTPPollInterval=sNTPPollInterval, hardwareVersion=hardwareVersion, tFTPServerPortNumber=tFTPServerPortNumber, licenceGroup=licenceGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, transmitPower=transmitPower, hTTPPortNumber=hTTPPortNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, linkSymmetry=linkSymmetry, receiveModulationModeDetail=receiveModulationModeDetail, syslogControlGroup=syslogControlGroup, tDDControl=tDDControl, smtpGroup=smtpGroup, ptmp=ptmp, supplementary=supplementary, masterSlaveMode=masterSlaveMode, eIRP=eIRP, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortAutoNegotiation=dataPortAutoNegotiation, sMTPServerPortNumber=sMTPServerPortNumber, receiveFreqMHz=receiveFreqMHz, syslogStateTrap=syslogStateTrap, userTable=userTable, vLANManagementVID=vLANManagementVID, capacityLicenseMismatch=capacityLicenseMismatch, tDDSynchronizationMode=tDDSynchronizationMode, versions=versions, dfsGroup=dfsGroup, dfsPeaks=dfsPeaks, aAAControlGroup=aAAControlGroup, groupID=groupID, signalStrengthRatio=signalStrengthRatio, subnetMask=subnetMask, userEnabled=userEnabled, licensedCapacity=licensedCapacity, transmitChannel=transmitChannel, linkLoss=linkLoss, encryption=encryption, transmitFreqKHz=transmitFreqKHz, resetGroup=resetGroup, ptpTrapPrefix=ptpTrapPrefix, dfsTableIndex=dfsTableIndex, notificationsGroup=notificationsGroup, vLANManagementPriority=vLANManagementPriority, ethernetGroup=ethernetGroup, receiveDataRate=receiveDataRate, sntp=sntp, userTableIndex=userTableIndex, transmitDataRate=transmitDataRate, tDDControlGroup=tDDControlGroup, alarms=alarms, tDDSynchronizationStatus=tDDSynchronizationStatus, pubStats=pubStats, phyStatusGroup=phyStatusGroup, sNMPv3Enable=sNMPv3Enable, sNTPServerPortNumber=sNTPServerPortNumber, transmitFreqMHz=transmitFreqMHz, dfs=dfs, antennaGain=antennaGain, sNTPServerIPAddress=sNTPServerIPAddress, phyControlGroup=phyControlGroup, ethernetFiberSupport=ethernetFiberSupport, aggregateDataRate=aggregateDataRate, sNMPTrapTableEntry=sNMPTrapTableEntry, installArmStateTrap=installArmStateTrap, ptp=ptp, hTTPAccessEnabled=hTTPAccessEnabled, range=range, userPassword=userPassword, telecomsLoopback=telecomsLoopback, syslogState=syslogState, systemClock=systemClock, timeZone=timeZone, telecomsChannelStatusTrap=telecomsChannelStatusTrap, ptp500=ptp500, vLANPriorityTableEntry=vLANPriorityTableEntry, dfsTableNumber=dfsTableNumber, regionCode=regionCode, siteName=siteName, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortStatusTrap=dataPortStatusTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, longitude=longitude)
