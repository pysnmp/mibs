...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", hTTPAccessEnabled=hTTPAccessEnabled, sNTPState=sNTPState, phyControl=phyControl, transmitPower=transmitPower, hTTPSPortNumber=hTTPSPortNumber, cambium=cambium, telecomsLineCode=telecomsLineCode, telnetPortNumber=telnetPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapPortNumber=sNMPTrapPortNumber, timeZone=timeZone, vLANPriorityTable=vLANPriorityTable, syslogLocalWrappedTrap=syslogLocalWrappedTrap, softwareVersion=softwareVersion, dfsPeaks=dfsPeaks, dfsMeans=dfsMeans, vLANPriorityTableEntry=vLANPriorityTableEntry, incompatibleRegionCodes=incompatibleRegionCodes, secondarySoftwareVersion=secondarySoftwareVersion, userEnabled=userEnabled, sNTPPollInterval=sNTPPollInterval, telecomsChannelStatus=telecomsChannelStatus, receiveChannel=receiveChannel, wirelessLinkAvailability=wirelessLinkAvailability, pubStatsGroup=pubStatsGroup, groupID=groupID, tDDControl=tDDControl, transmitDataRate=transmitDataRate, encryptionAlgorithm=encryptionAlgorithm, transmitChannel=transmitChannel, linkName=linkName, systemClock=systemClock, sNMPTrapTableNumber=sNMPTrapTableNumber, aAAControlGroup=aAAControlGroup, vectorError=vectorError, ptp=ptp, receiveDataRate=receiveDataRate, vLANManagementVID=vLANManagementVID, receiveModulationMode=receiveModulationMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, versionsGroup=versionsGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, linkModeOptimisation=linkModeOptimisation, alarms=alarms, vLANPriorityTableNumber=vLANPriorityTableNumber, sntpGroup=sntpGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogState=syslogState, productVariant=productVariant, supplementaryGroup=supplementaryGroup, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, subnetMask=subnetMask, dfs=dfs, dfsTable=dfsTable, sNTPSync=sNTPSync, channelBandwidth=channelBandwidth, transmitFreqMHz=transmitFreqMHz, antennaGain=antennaGain, regionCode=regionCode, dataPortWirelessDownAlert=dataPortWirelessDownAlert, transmitFreqKHz=transmitFreqKHz, sNMPTrapVersion=sNMPTrapVersion, dataPortConfigurationMismatch=dataPortConfigurationMismatch, userTableNumber=userTableNumber, licensedCapacity=licensedCapacity, altitude=altitude, gatewayIPAddress=gatewayIPAddress, managementGroup=managementGroup, dataPortStatusTrap=dataPortStatusTrap, encryption=encryption, resetGroup=resetGroup, dataPortStatus=dataPortStatus, userTable=userTable, sNMPEnabledTraps=sNMPEnabledTraps, receiveFreqMHz=receiveFreqMHz, productName=productName, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, syslogClientTrap=syslogClientTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, remoteIPAddress=remoteIPAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, telecom=telecom, syslogControl=syslogControl, snmpControlGroup=snmpControlGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, masterSlaveMode=masterSlaveMode, snmpControl=snmpControl, bootVersion=bootVersion, telnetAccessEnabled=telnetAccessEnabled, receiveModulationModeDetail=receiveModulationModeDetail, reset=reset, licenceGroup=licenceGroup, eIRP=eIRP, telecomsInterface=telecomsInterface, telecomsLoopbackTrap=telecomsLoopbackTrap, sMTPEmailAlert=sMTPEmailAlert, hTTPSAccessEnabled=hTTPSAccessEnabled, cableLoss=cableLoss, wirelessLinkStatus=wirelessLinkStatus, syslogClient=syslogClient, userRole=userRole, installStatusTrap=installStatusTrap, aAAControl=aAAControl, linkSymmetry=linkSymmetry, configuration=configuration, constantPowerSpectralDensity=constantPowerSpectralDensity, systemReset=systemReset, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, targetMACAddress=targetMACAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ptp500=ptp500, phyStatus=phyStatus, vLANManagementPriority=vLANManagementPriority, tDDSynchronizationStatus=tDDSynchronizationStatus, pubStats=pubStats, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tFTPServerPortNumber=tFTPServerPortNumber, ptmp=ptmp, sNTPServerIPAddress=sNTPServerIPAddress, ethernet=ethernet, sntp=sntp, userTableIndex=userTableIndex, unitOutOfCalibration=unitOutOfCalibration, sMTPEnabledMessages=sMTPEnabledMessages, transmitModulationMode=transmitModulationMode, dataPortAutoMdix=dataPortAutoMdix, dfsTableEntry=dfsTableEntry, dfsTableIndex=dfsTableIndex, searchState=searchState, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, smtpGroup=smtpGroup, PYSNMP_MODULE_ID=cambium, noWirelessChannelAvailable=noWirelessChannelAvailable, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, siteName=siteName, linkLoss=linkLoss, userPassword=userPassword, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, smtp=smtp, alarmsGroup=alarmsGroup, syslogControlGroup=syslogControlGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, userTableEntry=userTableEntry, ethernetFiberSupport=ethernetFiberSupport, sNMPPortNumber=sNMPPortNumber, ptpTrapPrefix=ptpTrapPrefix, byteErrorRatio=byteErrorRatio, syslogStateTrap=syslogStateTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, userName=userName, tDDControlGroup=tDDControlGroup, installArmStateTrap=installArmStateTrap, dfsGroup=dfsGroup, installStatus=installStatus, longitude=longitude, receivePower=receivePower, ptpGroups=ptpGroups, tDDSynchronizationAlarm=tDDSynchronizationAlarm, bandwidthVariant=bandwidthVariant, frequencyVariant=frequencyVariant, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, signalStrengthRatio=signalStrengthRatio, configurationGroup=configurationGroup, hTTPPortNumber=hTTPPortNumber, sNMPv3Enable=sNMPv3Enable, notificationsGroup=notificationsGroup, accessMethod=accessMethod, installArmState=installArmState, sNTPServerPortNumber=sNTPServerPortNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sMTPServerPortNumber=sMTPServerPortNumber, ethernetGroup=ethernetGroup, range=range, latitude=latitude, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sMTPSourceEmailAddress=sMTPSourceEmailAddress, regionCodeTrap=regionCodeTrap, maximumTransmitPower=maximumTransmitPower, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tDDSynchronizationMode=tDDSynchronizationMode, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, daylightSaving=daylightSaving, hardwareVersion=hardwareVersion, iPAddress=iPAddress, licence=licence, dataPortDisabledWarning=dataPortDisabledWarning, enabledDiagnosticAlarms=enabledDiagnosticAlarms, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPCommunityString=sNMPCommunityString, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, management=management, encryptionGroup=encryptionGroup, sNMPTrapTable=sNMPTrapTable, telecomGroup=telecomGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, phyStatusGroup=phyStatusGroup, sMTPServerIPAddress=sMTPServerIPAddress, incompatibleMasterAndSlave=incompatibleMasterAndSlave, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, telecomsLoopback=telecomsLoopback, phyControlGroup=phyControlGroup, sNTPLastSync=sNTPLastSync, versions=versions, telecomsCableLength=telecomsCableLength, receiveFreqKHz=receiveFreqKHz, supplementary=supplementary, channelChangeTrap=channelChangeTrap, ptpTraps=ptpTraps, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, capacityLicenseMismatch=capacityLicenseMismatch, ptpCompliance=ptpCompliance, sNTPSyncTrap=sNTPSyncTrap, dfsTableNumber=dfsTableNumber, aggregateDataRate=aggregateDataRate)
