...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", latitude=latitude, tDDControlGroup=tDDControlGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, snmpControl=snmpControl, phyStatusGroup=phyStatusGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPState=sNTPState, hardwareVersion=hardwareVersion, longitude=longitude, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userTable=userTable, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, remoteIPAddress=remoteIPAddress, receiveFreqKHz=receiveFreqKHz, ptpCompliance=ptpCompliance, ethernetGroup=ethernetGroup, accessMethod=accessMethod, aAAControlGroup=aAAControlGroup, incompatibleRegionCodes=incompatibleRegionCodes, dfsTableEntry=dfsTableEntry, eIRP=eIRP, vLANPriorityTable=vLANPriorityTable, linkModeOptimisation=linkModeOptimisation, sNMPTrapTableEntry=sNMPTrapTableEntry, encryptionGroup=encryptionGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dfsPeaks=dfsPeaks, transmitFreqKHz=transmitFreqKHz, wirelessLinkAvailability=wirelessLinkAvailability, alarmsGroup=alarmsGroup, syslogClientTrap=syslogClientTrap, dataPortDisabledWarning=dataPortDisabledWarning, receiveDataRate=receiveDataRate, telecomsLoopback=telecomsLoopback, resetGroup=resetGroup, syslogClient=syslogClient, pubStatsGroup=pubStatsGroup, daylightSaving=daylightSaving, channelBandwidth=channelBandwidth, vLANPriorityTableNumber=vLANPriorityTableNumber, transmitModulationMode=transmitModulationMode, userTableNumber=userTableNumber, timeZone=timeZone, alarms=alarms, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, syslogControlGroup=syslogControlGroup, dfsTableNumber=dfsTableNumber, configuration=configuration, tFTPServerIPAddress=tFTPServerIPAddress, sntp=sntp, telecomGroup=telecomGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, phyControlGroup=phyControlGroup, installArmState=installArmState, dfsTable=dfsTable, vLANManagementVID=vLANManagementVID, vLANPriorityQueueMapping=vLANPriorityQueueMapping, groupID=groupID, syslogStateTrap=syslogStateTrap, ptp500=ptp500, installArmStateTrap=installArmStateTrap, receivePower=receivePower, notificationsGroup=notificationsGroup, bootVersion=bootVersion, targetMACAddress=targetMACAddress, management=management, unitOutOfCalibration=unitOutOfCalibration, ptpTraps=ptpTraps, licenceGroup=licenceGroup, frequencyVariant=frequencyVariant, receiveModulationMode=receiveModulationMode, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, systemClock=systemClock, sNTPSync=sNTPSync, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, hTTPSPortNumber=hTTPSPortNumber, vLANPriorityTableEntry=vLANPriorityTableEntry, transmitChannel=transmitChannel, snmpControlGroup=snmpControlGroup, sNMPTrapTable=sNMPTrapTable, encryptionAlgorithm=encryptionAlgorithm, receiveFreqMHz=receiveFreqMHz, versions=versions, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, signalStrengthRatio=signalStrengthRatio, telecom=telecom, ptpTrapPrefix=ptpTrapPrefix, linkLoss=linkLoss, softwareVersion=softwareVersion, installStatus=installStatus, userPassword=userPassword, productName=productName, sNMPCommunityString=sNMPCommunityString, sNMPEnabledTraps=sNMPEnabledTraps, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, supplementaryGroup=supplementaryGroup, antennaGain=antennaGain, sntpGroup=sntpGroup, vectorError=vectorError, linkSymmetry=linkSymmetry, ptp=ptp, userTableIndex=userTableIndex, regionCode=regionCode, dataPortConfigurationMismatch=dataPortConfigurationMismatch, hTTPAccessEnabled=hTTPAccessEnabled, telecomsLoopbackTrap=telecomsLoopbackTrap, iPAddress=iPAddress, telnetAccessEnabled=telnetAccessEnabled, searchState=searchState, aggregateDataRate=aggregateDataRate, telecomsChannelStatus=telecomsChannelStatus, productVariant=productVariant, syslogControl=syslogControl, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, smtp=smtp, userName=userName, dataPortAutoNegotiation=dataPortAutoNegotiation, reset=reset, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, configurationGroup=configurationGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, masterSlaveMode=masterSlaveMode, phyStatus=phyStatus, transmitPower=transmitPower, telecomsCableLength=telecomsCableLength, aAAControl=aAAControl, subnetMask=subnetMask, gatewayIPAddress=gatewayIPAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, transmitDataRate=transmitDataRate, hTTPSAccessEnabled=hTTPSAccessEnabled, managementGroup=managementGroup, installStatusTrap=installStatusTrap, sNMPv3Enable=sNMPv3Enable, telnetPortNumber=telnetPortNumber, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, receiveModulationModeDetail=receiveModulationModeDetail, transmitFreqMHz=transmitFreqMHz, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ethernetFiberSupport=ethernetFiberSupport, linkName=linkName, cambium=cambium, ethernet=ethernet, capacityLicenseMismatch=capacityLicenseMismatch, enabledDiagnosticAlarms=enabledDiagnosticAlarms, range=range, noWirelessChannelAvailable=noWirelessChannelAvailable, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ptpGroups=ptpGroups, smtpGroup=smtpGroup, encryption=encryption, tDDControl=tDDControl, cableLoss=cableLoss, sNTPServerIPAddress=sNTPServerIPAddress, dataPortAutoMdix=dataPortAutoMdix, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, receiveChannel=receiveChannel, hTTPPortNumber=hTTPPortNumber, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, licence=licence, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPPollInterval=sNTPPollInterval, dataPortStatusTrap=dataPortStatusTrap, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, userEnabled=userEnabled, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sMTPServerIPAddress=sMTPServerIPAddress, userTableEntry=userTableEntry, sNTPLastSync=sNTPLastSync, versionsGroup=versionsGroup, secondarySoftwareVersion=secondarySoftwareVersion, byteErrorRatio=byteErrorRatio, maximumTransmitPower=maximumTransmitPower, wirelessLinkStatus=wirelessLinkStatus, ptmp=ptmp, sNTPServerPortNumber=sNTPServerPortNumber, regionCodeTrap=regionCodeTrap, siteName=siteName, dfsGroup=dfsGroup, sNMPTrapVersion=sNMPTrapVersion, tDDSynchronizationStatus=tDDSynchronizationStatus, supplementary=supplementary, syslogState=syslogState, dfs=dfs, licensedCapacity=licensedCapacity, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortStatus=dataPortStatus, altitude=altitude, bandwidthVariant=bandwidthVariant, channelChangeTrap=channelChangeTrap, vLANManagementPriority=vLANManagementPriority, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tDDSynchronizationMode=tDDSynchronizationMode, PYSNMP_MODULE_ID=cambium, userRole=userRole, systemReset=systemReset, phyControl=phyControl, sMTPEmailAlert=sMTPEmailAlert, sNTPSyncTrap=sNTPSyncTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPPortNumber=sNMPPortNumber, telecomsLineCode=telecomsLineCode, telecomsInterface=telecomsInterface, pubStats=pubStats, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dfsTableIndex=dfsTableIndex, tFTPServerPortNumber=tFTPServerPortNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dfsMeans=dfsMeans, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles)
