...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", versionsGroup=versionsGroup, licensedCapacity=licensedCapacity, sNTPServerIPAddress=sNTPServerIPAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, pubStatsGroup=pubStatsGroup, transmitFreqKHz=transmitFreqKHz, tDDControl=tDDControl, dfs=dfs, pubStats=pubStats, configurationGroup=configurationGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, reset=reset, userTableEntry=userTableEntry, dataPortConfigurationMismatch=dataPortConfigurationMismatch, encryptionAlgorithm=encryptionAlgorithm, PYSNMP_MODULE_ID=cambium, cableLoss=cableLoss, phyStatusGroup=phyStatusGroup, ptp=ptp, subnetMask=subnetMask, linkModeOptimisation=linkModeOptimisation, userTableIndex=userTableIndex, telecomGroup=telecomGroup, sNMPCommunityString=sNMPCommunityString, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPServerIPAddress=tFTPServerIPAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, daylightSaving=daylightSaving, sNMPTrapTableEntry=sNMPTrapTableEntry, resetGroup=resetGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, installArmStateTrap=installArmStateTrap, systemReset=systemReset, aggregateDataRate=aggregateDataRate, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, unitOutOfCalibration=unitOutOfCalibration, useVLANForManagementInterfaces=useVLANForManagementInterfaces, gatewayIPAddress=gatewayIPAddress, vLANPriorityTableNumber=vLANPriorityTableNumber, ethernetFiberSupport=ethernetFiberSupport, receiveDataRate=receiveDataRate, sNMPTrapTable=sNMPTrapTable, syslogState=syslogState, encryption=encryption, sNMPTrapPortNumber=sNMPTrapPortNumber, smtpGroup=smtpGroup, configuration=configuration, range=range, sNMPv3Enable=sNMPv3Enable, dataPortDisabledWarning=dataPortDisabledWarning, secondarySoftwareVersion=secondarySoftwareVersion, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogControl=syslogControl, aAAControl=aAAControl, productVariant=productVariant, tFTPServerPortNumber=tFTPServerPortNumber, maximumTransmitPower=maximumTransmitPower, linkLoss=linkLoss, transmitChannel=transmitChannel, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, telnetAccessEnabled=telnetAccessEnabled, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapVersion=sNMPTrapVersion, syslogStateTrap=syslogStateTrap, hTTPSPortNumber=hTTPSPortNumber, syslogControlGroup=syslogControlGroup, ptpCompliance=ptpCompliance, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, phyStatus=phyStatus, bandwidthVariant=bandwidthVariant, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPEnabledTraps=sNMPEnabledTraps, telecomsChannelStatus=telecomsChannelStatus, phyControl=phyControl, sNMPTrapIPAddress=sNMPTrapIPAddress, regionCodeTrap=regionCodeTrap, aAAControlGroup=aAAControlGroup, dfsTable=dfsTable, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, transmitModulationMode=transmitModulationMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, transmitDataRate=transmitDataRate, frequencyVariant=frequencyVariant, linkSymmetry=linkSymmetry, dfsGroup=dfsGroup, installArmState=installArmState, syslogClient=syslogClient, targetMACAddress=targetMACAddress, accessMethod=accessMethod, vLANPriorityTableIndex=vLANPriorityTableIndex, softwareVersion=softwareVersion, dfsTableIndex=dfsTableIndex, sNTPSyncTrap=sNTPSyncTrap, byteErrorRatio=byteErrorRatio, sNTPSync=sNTPSync, iPAddress=iPAddress, notificationsGroup=notificationsGroup, installStatusTrap=installStatusTrap, timeZone=timeZone, capacityLicenseMismatch=capacityLicenseMismatch, channelChangeTrap=channelChangeTrap, supplementaryGroup=supplementaryGroup, receivePower=receivePower, userEnabled=userEnabled, masterSlaveMode=masterSlaveMode, sMTPEnabledMessages=sMTPEnabledMessages, receiveFreqMHz=receiveFreqMHz, altitude=altitude, userPassword=userPassword, telecom=telecom, snmpControlGroup=snmpControlGroup, telecomsLoopbackTrap=telecomsLoopbackTrap, ptpTraps=ptpTraps, userTableNumber=userTableNumber, vLANPriorityTableEntry=vLANPriorityTableEntry, telnetPortNumber=telnetPortNumber, linkName=linkName, sNMPPortNumber=sNMPPortNumber, management=management, wirelessLinkAvailability=wirelessLinkAvailability, remoteIPAddress=remoteIPAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, userTable=userTable, vectorError=vectorError, tDDSynchronizationAlarm=tDDSynchronizationAlarm, hardwareVersion=hardwareVersion, remoteMaximumTransmitPower=remoteMaximumTransmitPower, smtp=smtp, constantPowerSpectralDensity=constantPowerSpectralDensity, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telecomsLoopback=telecomsLoopback, hTTPPortNumber=hTTPPortNumber, productName=productName, telecomsChannelStatusTrap=telecomsChannelStatusTrap, channelBandwidth=channelBandwidth, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapTableNumber=sNMPTrapTableNumber, incompatibleRegionCodes=incompatibleRegionCodes, sntp=sntp, sntpGroup=sntpGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, alarms=alarms, dfsMeans=dfsMeans, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, eIRP=eIRP, sNTPLastSync=sNTPLastSync, systemClock=systemClock, sMTPEmailAlert=sMTPEmailAlert, alarmsGroup=alarmsGroup, dfsPeaks=dfsPeaks, incompatibleMasterAndSlave=incompatibleMasterAndSlave, transmitPower=transmitPower, vLANPriorityTable=vLANPriorityTable, snmpControl=snmpControl, licence=licence, installStatus=installStatus, dataPortStatusTrap=dataPortStatusTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tDDSynchronizationMode=tDDSynchronizationMode, syslogLocalWrappedTrap=syslogLocalWrappedTrap, telecomsLineCode=telecomsLineCode, sNTPPollInterval=sNTPPollInterval, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, versions=versions, wirelessLinkStatus=wirelessLinkStatus, regionCode=regionCode, sNTPState=sNTPState, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ptp500=ptp500, signalStrengthRatio=signalStrengthRatio, telecomsCableLength=telecomsCableLength, sMTPServerIPAddress=sMTPServerIPAddress, ethernetGroup=ethernetGroup, transmitFreqMHz=transmitFreqMHz, tDDControlGroup=tDDControlGroup, dataPortStatus=dataPortStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, bootVersion=bootVersion, userName=userName, receiveChannel=receiveChannel, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sNTPServerPortNumber=sNTPServerPortNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortAutoMdix=dataPortAutoMdix, licenceGroup=licenceGroup, antennaGain=antennaGain, syslogClientTrap=syslogClientTrap, groupID=groupID, dfsTableNumber=dfsTableNumber, ptmp=ptmp, dfsTableEntry=dfsTableEntry, phyControlGroup=phyControlGroup, searchState=searchState, managementGroup=managementGroup, latitude=latitude, receiveModulationMode=receiveModulationMode, hTTPAccessEnabled=hTTPAccessEnabled, ptpTrapPrefix=ptpTrapPrefix, longitude=longitude, receiveModulationModeDetail=receiveModulationModeDetail, ptpGroups=ptpGroups, encryptionGroup=encryptionGroup, cambium=cambium, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, vLANManagementPriority=vLANManagementPriority, userRole=userRole, siteName=siteName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, vLANManagementVID=vLANManagementVID, telecomsInterface=telecomsInterface, ethernet=ethernet, receiveFreqKHz=receiveFreqKHz, sMTPServerPortNumber=sMTPServerPortNumber, supplementary=supplementary, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles)
