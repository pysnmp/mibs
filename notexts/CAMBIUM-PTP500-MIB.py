...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", ethernet=ethernet, linkLoss=linkLoss, syslogStateTrap=syslogStateTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, sNMPTrapVersion=sNMPTrapVersion, channelBandwidth=channelBandwidth, telecomsChannelStatus=telecomsChannelStatus, userTableIndex=userTableIndex, longitude=longitude, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dataPortAutoNegotiation=dataPortAutoNegotiation, hTTPAccessEnabled=hTTPAccessEnabled, userTableNumber=userTableNumber, vectorError=vectorError, sMTPEmailAlert=sMTPEmailAlert, sNTPPollInterval=sNTPPollInterval, receiveDataRate=receiveDataRate, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, frequencyVariant=frequencyVariant, alarmsGroup=alarmsGroup, telecomsLoopback=telecomsLoopback, hTTPSAccessEnabled=hTTPSAccessEnabled, signalStrengthRatio=signalStrengthRatio, syslogClientTrap=syslogClientTrap, ptpTraps=ptpTraps, telecom=telecom, gatewayIPAddress=gatewayIPAddress, vLANPriorityTableEntry=vLANPriorityTableEntry, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, altitude=altitude, ptp=ptp, dfsTableNumber=dfsTableNumber, dfsTableIndex=dfsTableIndex, linkSymmetry=linkSymmetry, dataPortDisabledWarning=dataPortDisabledWarning, noWirelessChannelAvailable=noWirelessChannelAvailable, regionCodeTrap=regionCodeTrap, telnetAccessEnabled=telnetAccessEnabled, eIRP=eIRP, sNMPv3Enable=sNMPv3Enable, capacityLicenseMismatch=capacityLicenseMismatch, syslogLocalWrappedTrap=syslogLocalWrappedTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, tFTPServerPortNumber=tFTPServerPortNumber, telecomsLineCode=telecomsLineCode, dfsTable=dfsTable, sNTPLastSync=sNTPLastSync, snmpControl=snmpControl, searchState=searchState, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, systemReset=systemReset, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPTrapTableIndex=sNMPTrapTableIndex, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNTPServerPortNumber=sNTPServerPortNumber, syslogControlGroup=syslogControlGroup, aggregateDataRate=aggregateDataRate, maximumTransmitPower=maximumTransmitPower, installStatusTrap=installStatusTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ptpGroups=ptpGroups, installArmState=installArmState, receivePower=receivePower, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, byteErrorRatio=byteErrorRatio, hTTPSPortNumber=hTTPSPortNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, management=management, userTable=userTable, tDDSynchronizationMode=tDDSynchronizationMode, userRole=userRole, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, transmitPower=transmitPower, vLANPriorityTable=vLANPriorityTable, tDDControlGroup=tDDControlGroup, smtp=smtp, alarms=alarms, wirelessLinkAvailability=wirelessLinkAvailability, regionCode=regionCode, ptp500=ptp500, dataPortAutoMdix=dataPortAutoMdix, userName=userName, sNTPServerIPAddress=sNTPServerIPAddress, phyControl=phyControl, licensedCapacity=licensedCapacity, syslogState=syslogState, telecomsLoopbackTrap=telecomsLoopbackTrap, bandwidthVariant=bandwidthVariant, tDDControl=tDDControl, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, telnetPortNumber=telnetPortNumber, userTableEntry=userTableEntry, masterSlaveMode=masterSlaveMode, receiveFreqKHz=receiveFreqKHz, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, PYSNMP_MODULE_ID=cambium, dfsMeans=dfsMeans, licence=licence, configurationGroup=configurationGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, productName=productName, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receiveChannel=receiveChannel, transmitFreqKHz=transmitFreqKHz, encryption=encryption, bootVersion=bootVersion, versions=versions, remoteIPAddress=remoteIPAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, timeZone=timeZone, vLANManagementPriority=vLANManagementPriority, range=range, receiveFreqMHz=receiveFreqMHz, installArmStateTrap=installArmStateTrap, systemClock=systemClock, dfsTableEntry=dfsTableEntry, supplementary=supplementary, dfs=dfs, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, notificationsGroup=notificationsGroup, targetMACAddress=targetMACAddress, ethernetFiberSupport=ethernetFiberSupport, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, userPassword=userPassword, phyControlGroup=phyControlGroup, vLANManagementVID=vLANManagementVID, linkModeOptimisation=linkModeOptimisation, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, incompatibleRegionCodes=incompatibleRegionCodes, sNTPSync=sNTPSync, dfsGroup=dfsGroup, telecomGroup=telecomGroup, groupID=groupID, iPAddress=iPAddress, softwareVersion=softwareVersion, managementGroup=managementGroup, subnetMask=subnetMask, accessMethod=accessMethod, snmpControlGroup=snmpControlGroup, sntpGroup=sntpGroup, unitOutOfCalibration=unitOutOfCalibration, incompatibleMasterAndSlave=incompatibleMasterAndSlave, hTTPPortNumber=hTTPPortNumber, sNTPSyncTrap=sNTPSyncTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, configuration=configuration, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, aAAControlGroup=aAAControlGroup, ethernetGroup=ethernetGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, phyStatus=phyStatus, encryptionAlgorithm=encryptionAlgorithm, siteName=siteName, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, syslogControl=syslogControl, sMTPEnabledMessages=sMTPEnabledMessages, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, transmitModulationMode=transmitModulationMode, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sNTPState=sNTPState, vLANPriorityTableNumber=vLANPriorityTableNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, sMTPServerPortNumber=sMTPServerPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, supplementaryGroup=supplementaryGroup, daylightSaving=daylightSaving, pubStatsGroup=pubStatsGroup, sntp=sntp, aAAControl=aAAControl, userEnabled=userEnabled, ptpCompliance=ptpCompliance, encryptionGroup=encryptionGroup, receiveModulationMode=receiveModulationMode, sNMPPortNumber=sNMPPortNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, linkName=linkName, sNMPCommunityString=sNMPCommunityString, antennaGain=antennaGain, pubStats=pubStats, latitude=latitude, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tDDSynchronizationStatus=tDDSynchronizationStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sMTPServerIPAddress=sMTPServerIPAddress, transmitDataRate=transmitDataRate, syslogClient=syslogClient, cableLoss=cableLoss, dataPortStatus=dataPortStatus, ptpTrapPrefix=ptpTrapPrefix, versionsGroup=versionsGroup, phyStatusGroup=phyStatusGroup, reset=reset, smtpGroup=smtpGroup, tFTPServerIPAddress=tFTPServerIPAddress, resetGroup=resetGroup, transmitChannel=transmitChannel, productVariant=productVariant, transmitFreqMHz=transmitFreqMHz, secondarySoftwareVersion=secondarySoftwareVersion, receiveModulationModeDetail=receiveModulationModeDetail, licenceGroup=licenceGroup, channelChangeTrap=channelChangeTrap, sNMPTrapTable=sNMPTrapTable, dfsPeaks=dfsPeaks, ptmp=ptmp, vLANPriorityTableIndex=vLANPriorityTableIndex, enabledDiagnosticAlarms=enabledDiagnosticAlarms, telecomsCableLength=telecomsCableLength, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortConfigurationMismatch=dataPortConfigurationMismatch, installStatus=installStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, hardwareVersion=hardwareVersion, wirelessLinkStatus=wirelessLinkStatus, telecomsInterface=telecomsInterface, dataPortStatusTrap=dataPortStatusTrap, cambium=cambium, sNMPEnabledTraps=sNMPEnabledTraps, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress)
