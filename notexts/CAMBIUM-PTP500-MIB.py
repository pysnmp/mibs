...
# Produced by pysmi-1.1.3 at Tue Nov 30 13:47:20 2021
...
MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, Integer32, TimeTicks, ObjectIdentity, iso, Bits, IpAddress, enterprises, ModuleIdentity, Gauge32, Counter32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "Integer32", "TimeTicks", "ObjectIdentity", "iso", "Bits", "IpAddress", "enterprises", "ModuleIdentity", "Gauge32", "Counter32", "Unsigned32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", receiveFreqKHz=receiveFreqKHz, linkLoss=linkLoss, softwareVersion=softwareVersion, notificationsGroup=notificationsGroup, transmitFreqKHz=transmitFreqKHz, tDDSynchronizationStatus=tDDSynchronizationStatus, syslogControl=syslogControl, licenceGroup=licenceGroup, snmpControl=snmpControl, receivePower=receivePower, sNMPTrapPortNumber=sNMPTrapPortNumber, sntpGroup=sntpGroup, supplementary=supplementary, dfsGroup=dfsGroup, receiveModulationModeDetail=receiveModulationModeDetail, configurationGroup=configurationGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, frequencyVariant=frequencyVariant, siteName=siteName, dataPortAutoNegotiation=dataPortAutoNegotiation, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, regionCodeTrap=regionCodeTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, telecomsLineCode=telecomsLineCode, userPassword=userPassword, telecomsChannelStatusTrap=telecomsChannelStatusTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNTPLastSync=sNTPLastSync, configuration=configuration, dataPortStatusTrap=dataPortStatusTrap, aAAControlGroup=aAAControlGroup, receiveChannel=receiveChannel, incompatibleRegionCodes=incompatibleRegionCodes, bootVersion=bootVersion, linkModeOptimisation=linkModeOptimisation, pubStats=pubStats, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tDDSynchronizationMode=tDDSynchronizationMode, telecomsInterface=telecomsInterface, managementGroup=managementGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, syslogStateTrap=syslogStateTrap, latitude=latitude, phyControl=phyControl, vectorError=vectorError, reset=reset, sNMPTrapTable=sNMPTrapTable, useVLANForManagementInterfaces=useVLANForManagementInterfaces, encryption=encryption, capacityLicenseMismatch=capacityLicenseMismatch, vLANPriorityTableIndex=vLANPriorityTableIndex, regionCode=regionCode, licence=licence, telnetPortNumber=telnetPortNumber, sntp=sntp, dataPortStatus=dataPortStatus, dataPortDisabledWarning=dataPortDisabledWarning, encryptionAlgorithm=encryptionAlgorithm, userRole=userRole, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dataPortAutoMdix=dataPortAutoMdix, ptpGroups=ptpGroups, searchState=searchState, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, channelBandwidth=channelBandwidth, cambium=cambium, dfsTableIndex=dfsTableIndex, PYSNMP_MODULE_ID=cambium, tFTPServerPortNumber=tFTPServerPortNumber, systemClock=systemClock, sNMPTrapTableNumber=sNMPTrapTableNumber, sMTPEnabledMessages=sMTPEnabledMessages, userTableNumber=userTableNumber, channelChangeTrap=channelChangeTrap, hTTPAccessEnabled=hTTPAccessEnabled, gatewayIPAddress=gatewayIPAddress, sNTPServerIPAddress=sNTPServerIPAddress, altitude=altitude, management=management, linkName=linkName, sNMPPortNumber=sNMPPortNumber, sMTPEmailAlert=sMTPEmailAlert, incompatibleMasterAndSlave=incompatibleMasterAndSlave, vLANManagementVID=vLANManagementVID, dfsMeans=dfsMeans, receiveDataRate=receiveDataRate, range=range, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sMTPServerPortNumber=sMTPServerPortNumber, versions=versions, vLANPriorityTableNumber=vLANPriorityTableNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transmitFreqMHz=transmitFreqMHz, sNTPPollInterval=sNTPPollInterval, secondarySoftwareVersion=secondarySoftwareVersion, ptpTrapPrefix=ptpTrapPrefix, telecomsLoopback=telecomsLoopback, antennaGain=antennaGain, aAAControl=aAAControl, aggregateDataRate=aggregateDataRate, accessMethod=accessMethod, masterSlaveMode=masterSlaveMode, iPAddress=iPAddress, vLANPriorityQueueMapping=vLANPriorityQueueMapping, ethernet=ethernet, phyStatus=phyStatus, sMTPServerIPAddress=sMTPServerIPAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, hTTPSPortNumber=hTTPSPortNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, resetGroup=resetGroup, userTableEntry=userTableEntry, syslogClientTrap=syslogClientTrap, installArmStateTrap=installArmStateTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ptp500=ptp500, transmitDataRate=transmitDataRate, encryptionGroup=encryptionGroup, unitOutOfCalibration=unitOutOfCalibration, smtpGroup=smtpGroup, telecom=telecom, phyStatusGroup=phyStatusGroup, productVariant=productVariant, supplementaryGroup=supplementaryGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, maximumTransmitPower=maximumTransmitPower, installStatus=installStatus, userTableIndex=userTableIndex, userName=userName, phyControlGroup=phyControlGroup, timeZone=timeZone, wirelessLinkAvailability=wirelessLinkAvailability, subnetMask=subnetMask, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPCommunityString=sNMPCommunityString, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNTPSyncTrap=sNTPSyncTrap, targetMACAddress=targetMACAddress, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dfsTableEntry=dfsTableEntry, ptpTraps=ptpTraps, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, longitude=longitude, receiveModulationMode=receiveModulationMode, bandwidthVariant=bandwidthVariant, tFTPServerIPAddress=tFTPServerIPAddress, userTable=userTable, ptp=ptp, tDDControlGroup=tDDControlGroup, ethernetFiberSupport=ethernetFiberSupport, alarmsGroup=alarmsGroup, syslogState=syslogState, alarms=alarms, dfsPeaks=dfsPeaks, daylightSaving=daylightSaving, transmitChannel=transmitChannel, tDDSynchronizationAlarm=tDDSynchronizationAlarm, syslogClient=syslogClient, installArmState=installArmState, sMTPSourceEmailAddress=sMTPSourceEmailAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, vLANManagementPriority=vLANManagementPriority, userEnabled=userEnabled, versionsGroup=versionsGroup, installStatusTrap=installStatusTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, systemReset=systemReset, telecomsCableLength=telecomsCableLength, syslogControlGroup=syslogControlGroup, pubStatsGroup=pubStatsGroup, hTTPPortNumber=hTTPPortNumber, remoteIPAddress=remoteIPAddress, cableLoss=cableLoss, transmitPower=transmitPower, sNMPTrapVersion=sNMPTrapVersion, dfsTable=dfsTable, ptpCompliance=ptpCompliance, sNMPv3Enable=sNMPv3Enable, sNTPSync=sNTPSync, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, linkModeOptimizationMismatch=linkModeOptimizationMismatch, telecomsChannelStatus=telecomsChannelStatus, telecomsLoopbackTrap=telecomsLoopbackTrap, transmitModulationMode=transmitModulationMode, dfsTableNumber=dfsTableNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, smtp=smtp, hTTPSAccessEnabled=hTTPSAccessEnabled, licensedCapacity=licensedCapacity, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, receiveFreqMHz=receiveFreqMHz, telnetAccessEnabled=telnetAccessEnabled, dfs=dfs, linkSymmetry=linkSymmetry, tDDControl=tDDControl, eIRP=eIRP, hardwareVersion=hardwareVersion, ethernetGroup=ethernetGroup, byteErrorRatio=byteErrorRatio, telecomGroup=telecomGroup, wirelessLinkStatus=wirelessLinkStatus, snmpControlGroup=snmpControlGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, sNTPState=sNTPState, syslogLocalWrappedTrap=syslogLocalWrappedTrap, vLANPriorityTable=vLANPriorityTable, ptmp=ptmp, productName=productName, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, signalStrengthRatio=signalStrengthRatio, sNTPServerPortNumber=sNTPServerPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, remoteMaximumTransmitPower=remoteMaximumTransmitPower, groupID=groupID)
