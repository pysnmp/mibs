...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", channelChangeTrap=channelChangeTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, groupID=groupID, telnetAccessEnabled=telnetAccessEnabled, sNTPServerIPAddress=sNTPServerIPAddress, PYSNMP_MODULE_ID=cambium, dataPortStatusTrap=dataPortStatusTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, versions=versions, regionCodeTrap=regionCodeTrap, iPAddress=iPAddress, secondarySoftwareVersion=secondarySoftwareVersion, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, aAAControlGroup=aAAControlGroup, remoteIPAddress=remoteIPAddress, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, linkSymmetry=linkSymmetry, pubStats=pubStats, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNTPServerPortNumber=sNTPServerPortNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, telecomsChannelStatus=telecomsChannelStatus, transmitDataRate=transmitDataRate, licenceGroup=licenceGroup, receiveFreqKHz=receiveFreqKHz, ethernet=ethernet, receiveDataRate=receiveDataRate, linkModeOptimisation=linkModeOptimisation, dfsTable=dfsTable, constantPowerSpectralDensity=constantPowerSpectralDensity, dataPortDisabledWarning=dataPortDisabledWarning, ptp500=ptp500, userTableNumber=userTableNumber, sNMPTrapVersion=sNMPTrapVersion, incompatibleRegionCodes=incompatibleRegionCodes, userEnabled=userEnabled, phyStatusGroup=phyStatusGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, capacityLicenseMismatch=capacityLicenseMismatch, transmitChannel=transmitChannel, hTTPAccessEnabled=hTTPAccessEnabled, vLANManagementVID=vLANManagementVID, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, userTableEntry=userTableEntry, sNMPCommunityString=sNMPCommunityString, telecomsLineCode=telecomsLineCode, tDDSynchronizationStatus=tDDSynchronizationStatus, licensedCapacity=licensedCapacity, ptpTraps=ptpTraps, snmpControlGroup=snmpControlGroup, productName=productName, dataPortAutoMdix=dataPortAutoMdix, alarms=alarms, sNMPTrapIPAddress=sNMPTrapIPAddress, receiveModulationModeDetail=receiveModulationModeDetail, timeZone=timeZone, tDDSynchronizationAlarm=tDDSynchronizationAlarm, phyControl=phyControl, smtpGroup=smtpGroup, telecomsLoopback=telecomsLoopback, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, daylightSaving=daylightSaving, longitude=longitude, signalStrengthRatio=signalStrengthRatio, gatewayIPAddress=gatewayIPAddress, linkName=linkName, siteName=siteName, ethernetFiberSupport=ethernetFiberSupport, userTableIndex=userTableIndex, pubStatsGroup=pubStatsGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, range=range, notificationsGroup=notificationsGroup, tDDSynchronizationMode=tDDSynchronizationMode, tDDControl=tDDControl, hardwareVersion=hardwareVersion, sNMPTrapTableEntry=sNMPTrapTableEntry, hTTPSPortNumber=hTTPSPortNumber, ptp=ptp, sNMPTrapTableNumber=sNMPTrapTableNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, linkLoss=linkLoss, remoteMaximumTransmitPower=remoteMaximumTransmitPower, installArmStateTrap=installArmStateTrap, transmitFreqKHz=transmitFreqKHz, maximumTransmitPower=maximumTransmitPower, sMTPServerIPAddress=sMTPServerIPAddress, sNTPSync=sNTPSync, vLANPriorityTableNumber=vLANPriorityTableNumber, systemClock=systemClock, dfsTableEntry=dfsTableEntry, phyControlGroup=phyControlGroup, resetGroup=resetGroup, altitude=altitude, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dfsPeaks=dfsPeaks, sMTPEnabledMessages=sMTPEnabledMessages, vLANPriorityTableEntry=vLANPriorityTableEntry, dfsTableIndex=dfsTableIndex, management=management, frequencyVariant=frequencyVariant, targetMACAddress=targetMACAddress, installArmState=installArmState, receiveModulationMode=receiveModulationMode, unitOutOfCalibration=unitOutOfCalibration, alarmsGroup=alarmsGroup, encryption=encryption, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, syslogControl=syslogControl, vLANPriorityTableIndex=vLANPriorityTableIndex, ethernetGroup=ethernetGroup, reset=reset, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, configurationGroup=configurationGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, userPassword=userPassword, installStatusTrap=installStatusTrap, sNTPPollInterval=sNTPPollInterval, syslogStateTrap=syslogStateTrap, sNTPState=sNTPState, masterSlaveMode=masterSlaveMode, hTTPSAccessEnabled=hTTPSAccessEnabled, supplementaryGroup=supplementaryGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, transmitModulationMode=transmitModulationMode, aggregateDataRate=aggregateDataRate, searchState=searchState, vLANPriorityTable=vLANPriorityTable, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsGroup=dfsGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, sntp=sntp, sntpGroup=sntpGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, licence=licence, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, versionsGroup=versionsGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, transmitFreqMHz=transmitFreqMHz, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, receiveChannel=receiveChannel, phyStatus=phyStatus, vLANManagementPriority=vLANManagementPriority, enabledDiagnosticAlarms=enabledDiagnosticAlarms, byteErrorRatio=byteErrorRatio, cambium=cambium, bandwidthVariant=bandwidthVariant, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, aAAControl=aAAControl, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptpTrapPrefix=ptpTrapPrefix, sNMPv3Enable=sNMPv3Enable, telecom=telecom, regionCode=regionCode, telecomsInterface=telecomsInterface, productVariant=productVariant, tFTPServerIPAddress=tFTPServerIPAddress, telecomGroup=telecomGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sMTPEmailAlert=sMTPEmailAlert, tDDControlGroup=tDDControlGroup, antennaGain=antennaGain, sNMPPortNumber=sNMPPortNumber, ptmp=ptmp, encryptionAlgorithm=encryptionAlgorithm, tFTPServerPortNumber=tFTPServerPortNumber, sMTPServerPortNumber=sMTPServerPortNumber, systemReset=systemReset, accessMethod=accessMethod, userName=userName, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, bootVersion=bootVersion, ptpGroups=ptpGroups, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, telecomsCableLength=telecomsCableLength, receivePower=receivePower, userRole=userRole, subnetMask=subnetMask, installStatus=installStatus, syslogClientTrap=syslogClientTrap, telnetPortNumber=telnetPortNumber, ptpCompliance=ptpCompliance, supplementary=supplementary, channelBandwidth=channelBandwidth, dfsMeans=dfsMeans, hTTPPortNumber=hTTPPortNumber, receiveFreqMHz=receiveFreqMHz, vectorError=vectorError, sMTPSourceEmailAddress=sMTPSourceEmailAddress, wirelessLinkStatus=wirelessLinkStatus, syslogState=syslogState, snmpControl=snmpControl, smtp=smtp, configuration=configuration, dataPortStatus=dataPortStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, transmitPower=transmitPower, eIRP=eIRP, cableLoss=cableLoss, userTable=userTable, syslogControlGroup=syslogControlGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortConfigurationMismatch=dataPortConfigurationMismatch, syslogClient=syslogClient, latitude=latitude, sNMPEnabledTraps=sNMPEnabledTraps, sNTPSyncTrap=sNTPSyncTrap, sNTPLastSync=sNTPLastSync, softwareVersion=softwareVersion, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfsTableNumber=dfsTableNumber, encryptionGroup=encryptionGroup, sNMPTrapTable=sNMPTrapTable, wirelessLinkAvailability=wirelessLinkAvailability, useVLANForManagementInterfaces=useVLANForManagementInterfaces, managementGroup=managementGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dfs=dfs)
