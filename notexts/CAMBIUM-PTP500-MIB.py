...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", altitude=altitude, hTTPAccessEnabled=hTTPAccessEnabled, ptmp=ptmp, telecomsInterface=telecomsInterface, sNMPTrapTable=sNMPTrapTable, secondarySoftwareVersion=secondarySoftwareVersion, gatewayIPAddress=gatewayIPAddress, phyControl=phyControl, transmitModulationMode=transmitModulationMode, maximumTransmitPower=maximumTransmitPower, accessMethod=accessMethod, linkLoss=linkLoss, licensedCapacity=licensedCapacity, sMTPServerPortNumber=sMTPServerPortNumber, bootVersion=bootVersion, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNTPLastSync=sNTPLastSync, encryption=encryption, telecomsLoopbackTrap=telecomsLoopbackTrap, telecomsLoopback=telecomsLoopback, dataPortStatus=dataPortStatus, vLANPriorityTableIndex=vLANPriorityTableIndex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, aAAControl=aAAControl, frequencyVariant=frequencyVariant, incompatibleMasterAndSlave=incompatibleMasterAndSlave, encryptionGroup=encryptionGroup, daylightSaving=daylightSaving, supplementaryGroup=supplementaryGroup, hTTPSPortNumber=hTTPSPortNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, phyStatusGroup=phyStatusGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, iPAddress=iPAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, installStatusTrap=installStatusTrap, encryptionAlgorithm=encryptionAlgorithm, dataPortDisabledWarning=dataPortDisabledWarning, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, longitude=longitude, transmitFreqKHz=transmitFreqKHz, versionsGroup=versionsGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, noWirelessChannelAvailable=noWirelessChannelAvailable, unitOutOfCalibration=unitOutOfCalibration, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, productName=productName, remoteMaximumTransmitPower=remoteMaximumTransmitPower, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, management=management, installArmStateTrap=installArmStateTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, sNMPCommunityString=sNMPCommunityString, tFTPServerPortNumber=tFTPServerPortNumber, installStatus=installStatus, syslogStateTrap=syslogStateTrap, receiveChannel=receiveChannel, aggregateDataRate=aggregateDataRate, linkName=linkName, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, incompatibleRegionCodes=incompatibleRegionCodes, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, hardwareVersion=hardwareVersion, pubStats=pubStats, tFTPServerIPAddress=tFTPServerIPAddress, dfsTableIndex=dfsTableIndex, subnetMask=subnetMask, byteErrorRatio=byteErrorRatio, pubStatsGroup=pubStatsGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, snmpControlGroup=snmpControlGroup, alarms=alarms, syslogClient=syslogClient, phyControlGroup=phyControlGroup, phyStatus=phyStatus, userEnabled=userEnabled, useVLANForManagementInterfaces=useVLANForManagementInterfaces, PYSNMP_MODULE_ID=cambium, syslogClientTrap=syslogClientTrap, vLANPriorityTable=vLANPriorityTable, userTableEntry=userTableEntry, targetMACAddress=targetMACAddress, sMTPServerIPAddress=sMTPServerIPAddress, dfsMeans=dfsMeans, sNMPTrapTableIndex=sNMPTrapTableIndex, vectorError=vectorError, dfsGroup=dfsGroup, channelBandwidth=channelBandwidth, dfs=dfs, productVariant=productVariant, telecomsChannelStatus=telecomsChannelStatus, sNMPEnabledTraps=sNMPEnabledTraps, transmitChannel=transmitChannel, receiveModulationModeDetail=receiveModulationModeDetail, masterSlaveMode=masterSlaveMode, smtp=smtp, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, systemClock=systemClock, antennaGain=antennaGain, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, channelChangeTrap=channelChangeTrap, telecomGroup=telecomGroup, aAAControlGroup=aAAControlGroup, sMTPEmailAlert=sMTPEmailAlert, receivePower=receivePower, notificationsGroup=notificationsGroup, tDDControlGroup=tDDControlGroup, dfsTableEntry=dfsTableEntry, vLANManagementPriority=vLANManagementPriority, sNTPState=sNTPState, latitude=latitude, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, userTable=userTable, licenceGroup=licenceGroup, receiveFreqMHz=receiveFreqMHz, tDDSynchronizationMode=tDDSynchronizationMode, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ethernetGroup=ethernetGroup, softwareVersion=softwareVersion, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, linkModeOptimisation=linkModeOptimisation, sNMPPortNumber=sNMPPortNumber, bandwidthVariant=bandwidthVariant, hTTPSAccessEnabled=hTTPSAccessEnabled, userTableIndex=userTableIndex, userTableNumber=userTableNumber, sNMPv3Enable=sNMPv3Enable, configurationGroup=configurationGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPEnabledMessages=sMTPEnabledMessages, sNTPSyncTrap=sNTPSyncTrap, supplementary=supplementary, linkSymmetry=linkSymmetry, ptpTrapPrefix=ptpTrapPrefix, transmitFreqMHz=transmitFreqMHz, ptp500=ptp500, siteName=siteName, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, regionCode=regionCode, tDDSynchronizationStatus=tDDSynchronizationStatus, userPassword=userPassword, sNTPSync=sNTPSync, dataPortStatusTrap=dataPortStatusTrap, sNTPPollInterval=sNTPPollInterval, reset=reset, remoteIPAddress=remoteIPAddress, regionCodeTrap=regionCodeTrap, dfsTableNumber=dfsTableNumber, ptpTraps=ptpTraps, cambium=cambium, smtpGroup=smtpGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, resetGroup=resetGroup, sntpGroup=sntpGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, systemReset=systemReset, telecom=telecom, alarmsGroup=alarmsGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receiveModulationMode=receiveModulationMode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, sntp=sntp, installArmState=installArmState, sNMPTrapTableEntry=sNMPTrapTableEntry, receiveDataRate=receiveDataRate, dfsPeaks=dfsPeaks, snmpControl=snmpControl, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, licence=licence, dfsTable=dfsTable, tDDControl=tDDControl, sNTPServerIPAddress=sNTPServerIPAddress, cableLoss=cableLoss, sNMPTrapTableNumber=sNMPTrapTableNumber, eIRP=eIRP, sNMPTrapVersion=sNMPTrapVersion, transmitDataRate=transmitDataRate, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, groupID=groupID, transmitPower=transmitPower, dataPortAutoNegotiation=dataPortAutoNegotiation, vLANPriorityQueueMapping=vLANPriorityQueueMapping, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dataPortAutoMdix=dataPortAutoMdix, syslogControlGroup=syslogControlGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, sNTPServerPortNumber=sNTPServerPortNumber, telecomsCableLength=telecomsCableLength, capacityLicenseMismatch=capacityLicenseMismatch, ptp=ptp, syslogState=syslogState, signalStrengthRatio=signalStrengthRatio, wirelessLinkStatus=wirelessLinkStatus, searchState=searchState, receiveFreqKHz=receiveFreqKHz, versions=versions, syslogControl=syslogControl, telecomsChannelStatusTrap=telecomsChannelStatusTrap, userRole=userRole, telnetAccessEnabled=telnetAccessEnabled, hTTPPortNumber=hTTPPortNumber, wirelessLinkAvailability=wirelessLinkAvailability, ethernetFiberSupport=ethernetFiberSupport, telecomsLineCode=telecomsLineCode, managementGroup=managementGroup, range=range, configuration=configuration, ptpGroups=ptpGroups, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telnetPortNumber=telnetPortNumber, userName=userName, vLANPriorityTableNumber=vLANPriorityTableNumber, timeZone=timeZone, ethernet=ethernet, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ptpCompliance=ptpCompliance, vLANManagementVID=vLANManagementVID)
