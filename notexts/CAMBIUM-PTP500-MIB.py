...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", vLANPriorityTableIndex=vLANPriorityTableIndex, dataPortAutoMdix=dataPortAutoMdix, channelBandwidth=channelBandwidth, encryption=encryption, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, installArmStateTrap=installArmStateTrap, management=management, syslogClientTrap=syslogClientTrap, hTTPPortNumber=hTTPPortNumber, antennaGain=antennaGain, capacityLicenseMismatch=capacityLicenseMismatch, aggregateDataRate=aggregateDataRate, receivePower=receivePower, versionsGroup=versionsGroup, installArmState=installArmState, receiveChannel=receiveChannel, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, userEnabled=userEnabled, bootVersion=bootVersion, telecomsChannelStatus=telecomsChannelStatus, sNMPTrapTable=sNMPTrapTable, searchState=searchState, productName=productName, ptp=ptp, alarms=alarms, sMTPEnabledMessages=sMTPEnabledMessages, wirelessLinkAvailability=wirelessLinkAvailability, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, hTTPAccessEnabled=hTTPAccessEnabled, range=range, sNMPCommunityString=sNMPCommunityString, ptp500=ptp500, ptmp=ptmp, userTable=userTable, maximumTransmitPower=maximumTransmitPower, linkName=linkName, channelChangeTrap=channelChangeTrap, gatewayIPAddress=gatewayIPAddress, userRole=userRole, smtp=smtp, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, telecom=telecom, syslogControl=syslogControl, tDDControlGroup=tDDControlGroup, snmpControl=snmpControl, tDDControl=tDDControl, telecomGroup=telecomGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, wirelessLinkStatus=wirelessLinkStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, pubStatsGroup=pubStatsGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPTrapIPAddress=sNMPTrapIPAddress, aAAControlGroup=aAAControlGroup, vLANPriorityTable=vLANPriorityTable, telecomsLineCode=telecomsLineCode, accessMethod=accessMethod, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPPortNumber=sNMPPortNumber, sNMPTrapVersion=sNMPTrapVersion, phyControlGroup=phyControlGroup, vLANManagementVID=vLANManagementVID, userPassword=userPassword, sntp=sntp, targetMACAddress=targetMACAddress, smtpGroup=smtpGroup, timeZone=timeZone, transmitChannel=transmitChannel, telecomsLoopback=telecomsLoopback, userTableIndex=userTableIndex, vLANPriorityTableEntry=vLANPriorityTableEntry, supplementaryGroup=supplementaryGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, cambium=cambium, dataPortWirelessDownAlert=dataPortWirelessDownAlert, phyStatus=phyStatus, tFTPServerPortNumber=tFTPServerPortNumber, regionCode=regionCode, dfsTableIndex=dfsTableIndex, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, receiveModulationMode=receiveModulationMode, enabledDiagnosticAlarms=enabledDiagnosticAlarms, syslogClient=syslogClient, snmpControlGroup=snmpControlGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, frequencyVariant=frequencyVariant, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ptpTrapPrefix=ptpTrapPrefix, sNTPSync=sNTPSync, vectorError=vectorError, dfsGroup=dfsGroup, managementGroup=managementGroup, transmitPower=transmitPower, dfsTable=dfsTable, receiveDataRate=receiveDataRate, linkSymmetry=linkSymmetry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, licence=licence, alarmsGroup=alarmsGroup, linkModeOptimisation=linkModeOptimisation, systemReset=systemReset, latitude=latitude, masterSlaveMode=masterSlaveMode, ptpCompliance=ptpCompliance, hTTPSPortNumber=hTTPSPortNumber, syslogStateTrap=syslogStateTrap, dataPortDisabledWarning=dataPortDisabledWarning, telecomsInterface=telecomsInterface, incompatibleRegionCodes=incompatibleRegionCodes, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, linkLoss=linkLoss, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPServerPortNumber=sNTPServerPortNumber, encryptionAlgorithm=encryptionAlgorithm, ethernetGroup=ethernetGroup, dfsTableNumber=dfsTableNumber, notificationsGroup=notificationsGroup, versions=versions, receiveFreqMHz=receiveFreqMHz, PYSNMP_MODULE_ID=cambium, ethernet=ethernet, telnetAccessEnabled=telnetAccessEnabled, transmitModulationMode=transmitModulationMode, cableLoss=cableLoss, vLANPriorityTableNumber=vLANPriorityTableNumber, dataPortStatusTrap=dataPortStatusTrap, encryptionGroup=encryptionGroup, sNMPv3Enable=sNMPv3Enable, sMTPServerIPAddress=sMTPServerIPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, aAAControl=aAAControl, sntpGroup=sntpGroup, tFTPServerIPAddress=tFTPServerIPAddress, dataPortStatus=dataPortStatus, configuration=configuration, receiveFreqKHz=receiveFreqKHz, siteName=siteName, userName=userName, sNTPSyncTrap=sNTPSyncTrap, supplementary=supplementary, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNTPLastSync=sNTPLastSync, telecomsCableLength=telecomsCableLength, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, installStatusTrap=installStatusTrap, iPAddress=iPAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, noWirelessChannelAvailable=noWirelessChannelAvailable, signalStrengthRatio=signalStrengthRatio, telecomsLoopbackTrap=telecomsLoopbackTrap, transmitFreqKHz=transmitFreqKHz, hardwareVersion=hardwareVersion, installStatus=installStatus, altitude=altitude, tDDSynchronizationMode=tDDSynchronizationMode, vLANPriorityQueueMapping=vLANPriorityQueueMapping, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, eIRP=eIRP, receiveModulationModeDetail=receiveModulationModeDetail, resetGroup=resetGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPPollInterval=sNTPPollInterval, byteErrorRatio=byteErrorRatio, sMTPServerPortNumber=sMTPServerPortNumber, telecomsChannelStatusTrap=telecomsChannelStatusTrap, vLANManagementPriority=vLANManagementPriority, sNMPTrapTableNumber=sNMPTrapTableNumber, syslogState=syslogState, syslogControlGroup=syslogControlGroup, ethernetFiberSupport=ethernetFiberSupport, transmitDataRate=transmitDataRate, syslogLocalWrappedTrap=syslogLocalWrappedTrap, secondarySoftwareVersion=secondarySoftwareVersion, dfsPeaks=dfsPeaks, userTableEntry=userTableEntry, reset=reset, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, telnetPortNumber=telnetPortNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapPortNumber=sNMPTrapPortNumber, unitOutOfCalibration=unitOutOfCalibration, daylightSaving=daylightSaving, bandwidthVariant=bandwidthVariant, productVariant=productVariant, constantPowerSpectralDensity=constantPowerSpectralDensity, linkModeOptimizationMismatch=linkModeOptimizationMismatch, userTableNumber=userTableNumber, dfsMeans=dfsMeans, dfsTableEntry=dfsTableEntry, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, remoteIPAddress=remoteIPAddress, subnetMask=subnetMask, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, configurationGroup=configurationGroup, ptpTraps=ptpTraps, groupID=groupID, sMTPEmailAlert=sMTPEmailAlert, systemClock=systemClock, regionCodeTrap=regionCodeTrap, longitude=longitude, phyStatusGroup=phyStatusGroup, phyControl=phyControl, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, pubStats=pubStats, transmitFreqMHz=transmitFreqMHz, sNTPState=sNTPState, ptpGroups=ptpGroups, softwareVersion=softwareVersion, licenceGroup=licenceGroup, sNTPServerIPAddress=sNTPServerIPAddress, licensedCapacity=licensedCapacity, sNMPTrapTableIndex=sNMPTrapTableIndex, dfs=dfs)
