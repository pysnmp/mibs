...
iso, ObjectIdentity, enterprises, Counter32, IpAddress, TimeTicks, Bits, Gauge32, ModuleIdentity, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter64, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "enterprises", "Counter32", "IpAddress", "TimeTicks", "Bits", "Gauge32", "ModuleIdentity", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter64", "Unsigned32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sNTPSync=sNTPSync, hTTPSAccessEnabled=hTTPSAccessEnabled, ethernetFiberSupport=ethernetFiberSupport, tFTPServerPortNumber=tFTPServerPortNumber, alarms=alarms, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPEnabledTraps=sNMPEnabledTraps, channelChangeTrap=channelChangeTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, vLANManagementVID=vLANManagementVID, licence=licence, sNMPPortNumber=sNMPPortNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogStateTrap=syslogStateTrap, secondarySoftwareVersion=secondarySoftwareVersion, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapTableEntry=sNMPTrapTableEntry, wirelessLinkAvailability=wirelessLinkAvailability, telnetPortNumber=telnetPortNumber, dfsPeaks=dfsPeaks, hTTPAccessEnabled=hTTPAccessEnabled, groupID=groupID, encryption=encryption, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ptp500=ptp500, receivePower=receivePower, sNTPLastSync=sNTPLastSync, hTTPSPortNumber=hTTPSPortNumber, dfs=dfs, range=range, sNMPTrapTableNumber=sNMPTrapTableNumber, aAAControl=aAAControl, vLANPriorityTableNumber=vLANPriorityTableNumber, pubStats=pubStats, systemReset=systemReset, syslogControl=syslogControl, productName=productName, transmitModulationMode=transmitModulationMode, daylightSaving=daylightSaving, bootVersion=bootVersion, softwareVersion=softwareVersion, regionCodeTrap=regionCodeTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, sntpGroup=sntpGroup, syslogState=syslogState, frequencyVariant=frequencyVariant, tDDSynchronizationMode=tDDSynchronizationMode, receiveModulationMode=receiveModulationMode, dataPortConfigurationMismatch=dataPortConfigurationMismatch, altitude=altitude, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortStatus=dataPortStatus, licenceGroup=licenceGroup, userTable=userTable, ethernet=ethernet, userPassword=userPassword, phyControl=phyControl, dfsTableIndex=dfsTableIndex, smtpGroup=smtpGroup, phyStatusGroup=phyStatusGroup, sNTPServerPortNumber=sNTPServerPortNumber, supplementary=supplementary, sNTPPollInterval=sNTPPollInterval, receiveDataRate=receiveDataRate, installArmStateTrap=installArmStateTrap, resetGroup=resetGroup, versions=versions, sMTPEmailAlert=sMTPEmailAlert, dataPortStatusTrap=dataPortStatusTrap, bandwidthVariant=bandwidthVariant, transmitDataRate=transmitDataRate, searchState=searchState, sNTPState=sNTPState, phyStatus=phyStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortDisabledWarning=dataPortDisabledWarning, sNMPTrapTableIndex=sNMPTrapTableIndex, syslogClientTrap=syslogClientTrap, phyControlGroup=phyControlGroup, eIRP=eIRP, gatewayIPAddress=gatewayIPAddress, installArmState=installArmState, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ptpTraps=ptpTraps, sMTPEnabledMessages=sMTPEnabledMessages, dfsTableEntry=dfsTableEntry, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, unitOutOfCalibration=unitOutOfCalibration, remoteIPAddress=remoteIPAddress, ptmp=ptmp, linkModeOptimizationMismatch=linkModeOptimizationMismatch, cambium=cambium, sNMPTrapPortNumber=sNMPTrapPortNumber, userEnabled=userEnabled, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, pubStatsGroup=pubStatsGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, encryptionAlgorithm=encryptionAlgorithm, telnetAccessEnabled=telnetAccessEnabled, ptpCompliance=ptpCompliance, channelBandwidth=channelBandwidth, latitude=latitude, siteName=siteName, incompatibleMasterAndSlave=incompatibleMasterAndSlave, iPAddress=iPAddress, telecomsLoopbackTrap=telecomsLoopbackTrap, vectorError=vectorError, linkLoss=linkLoss, transmitPower=transmitPower, productVariant=productVariant, telecom=telecom, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, transmitChannel=transmitChannel, sNTPSyncTrap=sNTPSyncTrap, antennaGain=antennaGain, vLANPriorityTableEntry=vLANPriorityTableEntry, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, masterSlaveMode=masterSlaveMode, dfsTableNumber=dfsTableNumber, telecomsLoopback=telecomsLoopback, tDDSynchronizationStatus=tDDSynchronizationStatus, userName=userName, aggregateDataRate=aggregateDataRate, regionCode=regionCode, sNTPServerIPAddress=sNTPServerIPAddress, telecomsCableLength=telecomsCableLength, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, PYSNMP_MODULE_ID=cambium, linkModeOptimisation=linkModeOptimisation, timeZone=timeZone, userTableEntry=userTableEntry, subnetMask=subnetMask, useVLANForManagementInterfaces=useVLANForManagementInterfaces, telecomGroup=telecomGroup, ethernetGroup=ethernetGroup, accessMethod=accessMethod, syslogClient=syslogClient, vLANPriorityTable=vLANPriorityTable, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tDDControl=tDDControl, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ptpGroups=ptpGroups, receiveFreqMHz=receiveFreqMHz, longitude=longitude, telecomsChannelStatusTrap=telecomsChannelStatusTrap, management=management, userTableNumber=userTableNumber, receiveFreqKHz=receiveFreqKHz, snmpControl=snmpControl, telecomsChannelStatus=telecomsChannelStatus, configuration=configuration, vLANPriorityQueueMapping=vLANPriorityQueueMapping, capacityLicenseMismatch=capacityLicenseMismatch, systemClock=systemClock, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ptpTrapPrefix=ptpTrapPrefix, incompatibleRegionCodes=incompatibleRegionCodes, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tFTPServerIPAddress=tFTPServerIPAddress, configurationGroup=configurationGroup, snmpControlGroup=snmpControlGroup, installStatusTrap=installStatusTrap, linkName=linkName, alarmsGroup=alarmsGroup, telecomsLineCode=telecomsLineCode, dfsMeans=dfsMeans, sNMPTrapTable=sNMPTrapTable, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, cableLoss=cableLoss, licensedCapacity=licensedCapacity, wirelessLinkStatus=wirelessLinkStatus, dfsGroup=dfsGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, telecomsInterface=telecomsInterface, sMTPServerIPAddress=sMTPServerIPAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, userTableIndex=userTableIndex, ptp=ptp, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, receiveModulationModeDetail=receiveModulationModeDetail, smtp=smtp, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tDDControlGroup=tDDControlGroup, aAAControlGroup=aAAControlGroup, targetMACAddress=targetMACAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, supplementaryGroup=supplementaryGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, linkSymmetry=linkSymmetry, receiveChannel=receiveChannel, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, hTTPPortNumber=hTTPPortNumber, sNMPCommunityString=sNMPCommunityString, syslogControlGroup=syslogControlGroup, dataPortAutoMdix=dataPortAutoMdix, enabledDiagnosticAlarms=enabledDiagnosticAlarms, managementGroup=managementGroup, signalStrengthRatio=signalStrengthRatio, transmitFreqMHz=transmitFreqMHz, sNMPv3Enable=sNMPv3Enable, noWirelessChannelAvailable=noWirelessChannelAvailable, hardwareVersion=hardwareVersion, transmitFreqKHz=transmitFreqKHz, notificationsGroup=notificationsGroup, byteErrorRatio=byteErrorRatio, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, maximumTransmitPower=maximumTransmitPower, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dfsTable=dfsTable, installStatus=installStatus, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, userRole=userRole, vLANManagementPriority=vLANManagementPriority, sntp=sntp, sMTPServerPortNumber=sMTPServerPortNumber, versionsGroup=versionsGroup, reset=reset, encryptionGroup=encryptionGroup)
