...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", receiveModulationModeDetail=receiveModulationModeDetail, telecomsChannelStatusTrap=telecomsChannelStatusTrap, aAAControl=aAAControl, tFTPServerPortNumber=tFTPServerPortNumber, bootVersion=bootVersion, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPPollInterval=sNTPPollInterval, linkSymmetry=linkSymmetry, regionCode=regionCode, longitude=longitude, encryptionAlgorithm=encryptionAlgorithm, ptp=ptp, noWirelessChannelAvailable=noWirelessChannelAvailable, telecomsLoopback=telecomsLoopback, hTTPSPortNumber=hTTPSPortNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, configurationGroup=configurationGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, receiveDataRate=receiveDataRate, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNTPServerIPAddress=sNTPServerIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, telnetPortNumber=telnetPortNumber, versions=versions, transmitDataRate=transmitDataRate, latitude=latitude, altitude=altitude, dataPortStatus=dataPortStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, syslogClientTrap=syslogClientTrap, smtpGroup=smtpGroup, configuration=configuration, supplementary=supplementary, PYSNMP_MODULE_ID=cambium, phyStatusGroup=phyStatusGroup, capacityLicenseMismatch=capacityLicenseMismatch, sNMPTrapTable=sNMPTrapTable, maximumTransmitPower=maximumTransmitPower, resetGroup=resetGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, dfsTableIndex=dfsTableIndex, productName=productName, sntpGroup=sntpGroup, receiveFreqKHz=receiveFreqKHz, incompatibleRegionCodes=incompatibleRegionCodes, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, alarms=alarms, syslogControlGroup=syslogControlGroup, linkLoss=linkLoss, cambium=cambium, telecomsInterface=telecomsInterface, tDDControlGroup=tDDControlGroup, notificationsGroup=notificationsGroup, receiveFreqMHz=receiveFreqMHz, timeZone=timeZone, ethernet=ethernet, tDDControl=tDDControl, ptpTraps=ptpTraps, management=management, gatewayIPAddress=gatewayIPAddress, dataPortDisabledWarning=dataPortDisabledWarning, sNTPState=sNTPState, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, vLANPriorityTable=vLANPriorityTable, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ptp500=ptp500, ethernetFiberSupport=ethernetFiberSupport, dfsTableNumber=dfsTableNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, telecom=telecom, dataPortWirelessDownAlert=dataPortWirelessDownAlert, supplementaryGroup=supplementaryGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, vLANManagementVID=vLANManagementVID, hTTPSAccessEnabled=hTTPSAccessEnabled, managementGroup=managementGroup, smtp=smtp, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortStatusTrap=dataPortStatusTrap, ethernetGroup=ethernetGroup, softwareVersion=softwareVersion, snmpControlGroup=snmpControlGroup, sNTPSync=sNTPSync, remoteMaximumTransmitPower=remoteMaximumTransmitPower, searchState=searchState, constantPowerSpectralDensity=constantPowerSpectralDensity, reset=reset, alarmsGroup=alarmsGroup, telecomGroup=telecomGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, hardwareVersion=hardwareVersion, sNMPv3Enable=sNMPv3Enable, wirelessLinkAvailability=wirelessLinkAvailability, secondarySoftwareVersion=secondarySoftwareVersion, masterSlaveMode=masterSlaveMode, tFTPServerIPAddress=tFTPServerIPAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, iPAddress=iPAddress, dfs=dfs, pubStatsGroup=pubStatsGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, installArmStateTrap=installArmStateTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, transmitModulationMode=transmitModulationMode, sNMPPortNumber=sNMPPortNumber, phyControlGroup=phyControlGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, userTableNumber=userTableNumber, range=range, cableLoss=cableLoss, bandwidthVariant=bandwidthVariant, unitOutOfCalibration=unitOutOfCalibration, userRole=userRole, telnetAccessEnabled=telnetAccessEnabled, ptpGroups=ptpGroups, telecomsCableLength=telecomsCableLength, userTableIndex=userTableIndex, dfsPeaks=dfsPeaks, telecomsChannelStatus=telecomsChannelStatus, versionsGroup=versionsGroup, phyStatus=phyStatus, dfsTableEntry=dfsTableEntry, vectorError=vectorError, vLANPriorityTableNumber=vLANPriorityTableNumber, sNTPLastSync=sNTPLastSync, systemReset=systemReset, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dfsTable=dfsTable, sMTPServerIPAddress=sMTPServerIPAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, encryptionGroup=encryptionGroup, accessMethod=accessMethod, transmitPower=transmitPower, receiveChannel=receiveChannel, wirelessLinkStatus=wirelessLinkStatus, siteName=siteName, linkName=linkName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, hTTPPortNumber=hTTPPortNumber, sNTPServerPortNumber=sNTPServerPortNumber, userEnabled=userEnabled, licenceGroup=licenceGroup, frequencyVariant=frequencyVariant, syslogStateTrap=syslogStateTrap, hTTPAccessEnabled=hTTPAccessEnabled, productVariant=productVariant, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, systemClock=systemClock, syslogControl=syslogControl, dataPortAutoNegotiation=dataPortAutoNegotiation, userName=userName, vLANManagementPriority=vLANManagementPriority, installArmState=installArmState, sMTPEmailAlert=sMTPEmailAlert, transmitFreqKHz=transmitFreqKHz, signalStrengthRatio=signalStrengthRatio, sNMPEnabledTraps=sNMPEnabledTraps, transmitFreqMHz=transmitFreqMHz, sMTPServerPortNumber=sMTPServerPortNumber, remoteIPAddress=remoteIPAddress, installStatusTrap=installStatusTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, pubStats=pubStats, userPassword=userPassword, telecomsLoopbackTrap=telecomsLoopbackTrap, licence=licence, syslogClient=syslogClient, sMTPEnabledMessages=sMTPEnabledMessages, sNMPCommunityString=sNMPCommunityString, sNMPTrapVersion=sNMPTrapVersion, byteErrorRatio=byteErrorRatio, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapIPAddress=sNMPTrapIPAddress, aAAControlGroup=aAAControlGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, licensedCapacity=licensedCapacity, tDDSynchronizationMode=tDDSynchronizationMode, userTable=userTable, antennaGain=antennaGain, receiveModulationMode=receiveModulationMode, dataPortAutoMdix=dataPortAutoMdix, telecomsLineCode=telecomsLineCode, aggregateDataRate=aggregateDataRate, encryption=encryption, snmpControl=snmpControl, targetMACAddress=targetMACAddress, eIRP=eIRP, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ptpCompliance=ptpCompliance, channelChangeTrap=channelChangeTrap, sntp=sntp, vLANPriorityQueueMapping=vLANPriorityQueueMapping, ptpTrapPrefix=ptpTrapPrefix, transmitChannel=transmitChannel, sNMPTrapTableEntry=sNMPTrapTableEntry, channelBandwidth=channelBandwidth, installStatus=installStatus, linkModeOptimisation=linkModeOptimisation, dfsMeans=dfsMeans, subnetMask=subnetMask, phyControl=phyControl, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNMPTrapPortNumber=sNMPTrapPortNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ptmp=ptmp, syslogState=syslogState, dfsGroup=dfsGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPSyncTrap=sNTPSyncTrap, groupID=groupID, regionCodeTrap=regionCodeTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, daylightSaving=daylightSaving, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, userTableEntry=userTableEntry, receivePower=receivePower)
