...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sNMPEnabledTraps=sNMPEnabledTraps, receiveFreqMHz=receiveFreqMHz, vLANPriorityTable=vLANPriorityTable, eIRP=eIRP, sNMPTrapTableNumber=sNMPTrapTableNumber, signalStrengthRatio=signalStrengthRatio, sNMPTrapIPAddress=sNMPTrapIPAddress, ptpTrapPrefix=ptpTrapPrefix, syslogStateTrap=syslogStateTrap, dfsTableNumber=dfsTableNumber, sNTPServerIPAddress=sNTPServerIPAddress, syslogState=syslogState, sNMPTrapVersion=sNMPTrapVersion, installStatus=installStatus, linkSymmetry=linkSymmetry, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, notificationsGroup=notificationsGroup, byteErrorRatio=byteErrorRatio, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, telecomsLoopback=telecomsLoopback, transmitModulationMode=transmitModulationMode, smtp=smtp, transmitFreqKHz=transmitFreqKHz, sNTPSync=sNTPSync, receiveModulationModeDetail=receiveModulationModeDetail, receivePower=receivePower, receiveChannel=receiveChannel, ethernetGroup=ethernetGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, hTTPAccessEnabled=hTTPAccessEnabled, userPassword=userPassword, masterSlaveMode=masterSlaveMode, latitude=latitude, dataPortStatusTrap=dataPortStatusTrap, tFTPServerIPAddress=tFTPServerIPAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, licenceGroup=licenceGroup, pubStatsGroup=pubStatsGroup, tDDSynchronizationMode=tDDSynchronizationMode, sNTPLastSync=sNTPLastSync, targetMACAddress=targetMACAddress, linkName=linkName, sMTPEmailAlert=sMTPEmailAlert, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, aAAControl=aAAControl, groupID=groupID, hTTPSPortNumber=hTTPSPortNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, altitude=altitude, dfsTableIndex=dfsTableIndex, remoteIPAddress=remoteIPAddress, ptmp=ptmp, vLANPriorityTableIndex=vLANPriorityTableIndex, receiveFreqKHz=receiveFreqKHz, phyControl=phyControl, hTTPPortNumber=hTTPPortNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkLoss=linkLoss, managementGroup=managementGroup, dataPortDisabledWarning=dataPortDisabledWarning, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, userName=userName, userRole=userRole, sMTPSourceEmailAddress=sMTPSourceEmailAddress, configurationGroup=configurationGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, cambium=cambium, installArmState=installArmState, telecomsLoopbackTrap=telecomsLoopbackTrap, telecom=telecom, longitude=longitude, incompatibleRegionCodes=incompatibleRegionCodes, alarmsGroup=alarmsGroup, transmitFreqMHz=transmitFreqMHz, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortAutoNegotiation=dataPortAutoNegotiation, dfsGroup=dfsGroup, telecomGroup=telecomGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vLANPriorityTableEntry=vLANPriorityTableEntry, licence=licence, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, gatewayIPAddress=gatewayIPAddress, ptp=ptp, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, reset=reset, versionsGroup=versionsGroup, accessMethod=accessMethod, wirelessLinkAvailability=wirelessLinkAvailability, phyControlGroup=phyControlGroup, resetGroup=resetGroup, sNMPCommunityString=sNMPCommunityString, installStatusTrap=installStatusTrap, dataPortAutoMdix=dataPortAutoMdix, dataPortConfigurationMismatch=dataPortConfigurationMismatch, range=range, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, versions=versions, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPv3Enable=sNMPv3Enable, syslogControlGroup=syslogControlGroup, wirelessLinkStatus=wirelessLinkStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, encryption=encryption, sNMPTrapTableEntry=sNMPTrapTableEntry, snmpControlGroup=snmpControlGroup, configuration=configuration, regionCodeTrap=regionCodeTrap, userTableEntry=userTableEntry, syslogClientTrap=syslogClientTrap, PYSNMP_MODULE_ID=cambium, iPAddress=iPAddress, encryptionGroup=encryptionGroup, supplementary=supplementary, licensedCapacity=licensedCapacity, aAAControlGroup=aAAControlGroup, dfsTableEntry=dfsTableEntry, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, daylightSaving=daylightSaving, receiveModulationMode=receiveModulationMode, telnetPortNumber=telnetPortNumber, sNTPPollInterval=sNTPPollInterval, bandwidthVariant=bandwidthVariant, alarms=alarms, cableLoss=cableLoss, productName=productName, sNTPServerPortNumber=sNTPServerPortNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, timeZone=timeZone, receiveDataRate=receiveDataRate, transmitChannel=transmitChannel, capacityLicenseMismatch=capacityLicenseMismatch, sNMPPortNumber=sNMPPortNumber, phyStatus=phyStatus, transmitPower=transmitPower, incompatibleMasterAndSlave=incompatibleMasterAndSlave, systemReset=systemReset, channelBandwidth=channelBandwidth, channelChangeTrap=channelChangeTrap, sMTPEnabledMessages=sMTPEnabledMessages, unitOutOfCalibration=unitOutOfCalibration, installArmStateTrap=installArmStateTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, smtpGroup=smtpGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, sntpGroup=sntpGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, transmitDataRate=transmitDataRate, aggregateDataRate=aggregateDataRate, maximumTransmitPower=maximumTransmitPower, encryptionAlgorithm=encryptionAlgorithm, ptp500=ptp500, ptpTraps=ptpTraps, searchState=searchState, telecomsChannelStatus=telecomsChannelStatus, siteName=siteName, snmpControl=snmpControl, linkModeOptimisation=linkModeOptimisation, vectorError=vectorError, sMTPServerIPAddress=sMTPServerIPAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, vLANManagementVID=vLANManagementVID, productVariant=productVariant, userTableNumber=userTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, management=management, userTableIndex=userTableIndex, ptpCompliance=ptpCompliance, frequencyVariant=frequencyVariant, ptpGroups=ptpGroups, sNMPTrapTable=sNMPTrapTable, vLANPriorityQueueMapping=vLANPriorityQueueMapping, telnetAccessEnabled=telnetAccessEnabled, subnetMask=subnetMask, vLANPriorityTableNumber=vLANPriorityTableNumber, ethernet=ethernet, tDDControlGroup=tDDControlGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tDDControl=tDDControl, telecomsInterface=telecomsInterface, phyStatusGroup=phyStatusGroup, dfsTable=dfsTable, sMTPServerPortNumber=sMTPServerPortNumber, ethernetFiberSupport=ethernetFiberSupport, softwareVersion=softwareVersion, dataPortStatus=dataPortStatus, hardwareVersion=hardwareVersion, sNTPSyncTrap=sNTPSyncTrap, syslogControl=syslogControl, userTable=userTable, dfsMeans=dfsMeans, useVLANForManagementInterfaces=useVLANForManagementInterfaces, regionCode=regionCode, pubStats=pubStats, hTTPSAccessEnabled=hTTPSAccessEnabled, telecomsChannelStatusTrap=telecomsChannelStatusTrap, bootVersion=bootVersion, sNMPTrapTableIndex=sNMPTrapTableIndex, dfs=dfs, vLANManagementPriority=vLANManagementPriority, userEnabled=userEnabled, sntp=sntp, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, systemClock=systemClock, tFTPServerPortNumber=tFTPServerPortNumber, telecomsCableLength=telecomsCableLength, telecomsLineCode=telecomsLineCode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dfsPeaks=dfsPeaks, supplementaryGroup=supplementaryGroup, syslogClient=syslogClient, secondarySoftwareVersion=secondarySoftwareVersion, sNTPState=sNTPState, antennaGain=antennaGain)
