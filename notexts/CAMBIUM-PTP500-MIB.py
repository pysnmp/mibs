...
# Produced by pysmi-1.1.3 at Tue Dec  7 17:26:59 2021
...
enterprises, Counter64, IpAddress, Counter32, MibIdentifier, Integer32, NotificationType, ModuleIdentity, iso, ObjectIdentity, Bits, Unsigned32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter64", "IpAddress", "Counter32", "MibIdentifier", "Integer32", "NotificationType", "ModuleIdentity", "iso", "ObjectIdentity", "Bits", "Unsigned32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", timeZone=timeZone, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, eIRP=eIRP, dataPortConfigurationMismatch=dataPortConfigurationMismatch, userName=userName, telecomGroup=telecomGroup, transmitDataRate=transmitDataRate, phyStatusGroup=phyStatusGroup, transmitModulationMode=transmitModulationMode, ptmp=ptmp, signalStrengthRatio=signalStrengthRatio, dfs=dfs, managementGroup=managementGroup, dataPortAutoMdix=dataPortAutoMdix, sNMPTrapTable=sNMPTrapTable, ethernetGroup=ethernetGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, dfsPeaks=dfsPeaks, vLANPriorityTableEntry=vLANPriorityTableEntry, sNMPCommunityString=sNMPCommunityString, ethernet=ethernet, wirelessLinkAvailability=wirelessLinkAvailability, sNMPTrapIPAddress=sNMPTrapIPAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ptpCompliance=ptpCompliance, PYSNMP_MODULE_ID=cambium, ptpTraps=ptpTraps, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsMeans=dfsMeans, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dataPortStatus=dataPortStatus, byteErrorRatio=byteErrorRatio, sNMPTrapTableNumber=sNMPTrapTableNumber, bootVersion=bootVersion, productName=productName, telecomsCableLength=telecomsCableLength, receiveFreqKHz=receiveFreqKHz, syslogState=syslogState, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, telnetAccessEnabled=telnetAccessEnabled, syslogLocalWrappedTrap=syslogLocalWrappedTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, hTTPSAccessEnabled=hTTPSAccessEnabled, productVariant=productVariant, alarmsGroup=alarmsGroup, smtpGroup=smtpGroup, userPassword=userPassword, regionCode=regionCode, antennaGain=antennaGain, userRole=userRole, versionsGroup=versionsGroup, tDDSynchronizationMode=tDDSynchronizationMode, targetMACAddress=targetMACAddress, aggregateDataRate=aggregateDataRate, ptpGroups=ptpGroups, userTableIndex=userTableIndex, secondarySoftwareVersion=secondarySoftwareVersion, sNMPTrapVersion=sNMPTrapVersion, supplementary=supplementary, phyControl=phyControl, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, vLANManagementPriority=vLANManagementPriority, vLANPriorityQueueMapping=vLANPriorityQueueMapping, pubStatsGroup=pubStatsGroup, resetGroup=resetGroup, licence=licence, licensedCapacity=licensedCapacity, range=range, dataPortDisabledWarning=dataPortDisabledWarning, wirelessLinkStatus=wirelessLinkStatus, vLANManagementVID=vLANManagementVID, syslogClient=syslogClient, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, installArmState=installArmState, hardwareVersion=hardwareVersion, pubStats=pubStats, reset=reset, vLANPriorityTableNumber=vLANPriorityTableNumber, telecom=telecom, phyStatus=phyStatus, ptp500=ptp500, systemReset=systemReset, userEnabled=userEnabled, management=management, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, transmitPower=transmitPower, hTTPAccessEnabled=hTTPAccessEnabled, channelChangeTrap=channelChangeTrap, userTableEntry=userTableEntry, supplementaryGroup=supplementaryGroup, userTableNumber=userTableNumber, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, sntpGroup=sntpGroup, dfsTableNumber=dfsTableNumber, channelBandwidth=channelBandwidth, tFTPServerIPAddress=tFTPServerIPAddress, sNMPv3Enable=sNMPv3Enable, sNTPServerIPAddress=sNTPServerIPAddress, softwareVersion=softwareVersion, encryption=encryption, remoteIPAddress=remoteIPAddress, longitude=longitude, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, frequencyVariant=frequencyVariant, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, licenceGroup=licenceGroup, capacityLicenseMismatch=capacityLicenseMismatch, tDDSynchronizationStatus=tDDSynchronizationStatus, userTable=userTable, sNTPSyncTrap=sNTPSyncTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tDDControlGroup=tDDControlGroup, telecomsLoopbackTrap=telecomsLoopbackTrap, alarms=alarms, subnetMask=subnetMask, vLANPriorityTable=vLANPriorityTable, sNTPSync=sNTPSync, sNMPPortNumber=sNMPPortNumber, cambium=cambium, sMTPEmailAlert=sMTPEmailAlert, sntp=sntp, iPAddress=iPAddress, systemClock=systemClock, phyControlGroup=phyControlGroup, installStatus=installStatus, sNTPPollInterval=sNTPPollInterval, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, unitOutOfCalibration=unitOutOfCalibration, incompatibleRegionCodes=incompatibleRegionCodes, telecomsInterface=telecomsInterface, ptp=ptp, telecomsLineCode=telecomsLineCode, altitude=altitude, masterSlaveMode=masterSlaveMode, sNTPServerPortNumber=sNTPServerPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, sMTPServerPortNumber=sMTPServerPortNumber, encryptionGroup=encryptionGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, searchState=searchState, accessMethod=accessMethod, dataPortAutoNegotiation=dataPortAutoNegotiation, siteName=siteName, notificationsGroup=notificationsGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, noWirelessChannelAvailable=noWirelessChannelAvailable, hTTPSPortNumber=hTTPSPortNumber, receiveFreqMHz=receiveFreqMHz, telecomsChannelStatus=telecomsChannelStatus, aAAControlGroup=aAAControlGroup, latitude=latitude, dataPortStatusTrap=dataPortStatusTrap, sNTPLastSync=sNTPLastSync, ptpTrapPrefix=ptpTrapPrefix, daylightSaving=daylightSaving, versions=versions, gatewayIPAddress=gatewayIPAddress, installStatusTrap=installStatusTrap, sMTPEnabledMessages=sMTPEnabledMessages, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, transmitChannel=transmitChannel, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfsTable=dfsTable, telecomsChannelStatusTrap=telecomsChannelStatusTrap, configuration=configuration, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, syslogControlGroup=syslogControlGroup, aAAControl=aAAControl, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ethernetFiberSupport=ethernetFiberSupport, receiveChannel=receiveChannel, receiveModulationModeDetail=receiveModulationModeDetail, linkName=linkName, dfsGroup=dfsGroup, tFTPServerPortNumber=tFTPServerPortNumber, linkLoss=linkLoss, syslogClientTrap=syslogClientTrap, hTTPPortNumber=hTTPPortNumber, receiveDataRate=receiveDataRate, maximumTransmitPower=maximumTransmitPower, linkModeOptimisation=linkModeOptimisation, syslogStateTrap=syslogStateTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, linkSymmetry=linkSymmetry, transmitFreqMHz=transmitFreqMHz, bandwidthVariant=bandwidthVariant, snmpControlGroup=snmpControlGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, cableLoss=cableLoss, dfsTableIndex=dfsTableIndex, installArmStateTrap=installArmStateTrap, syslogControl=syslogControl, configurationGroup=configurationGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPState=sNTPState, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, transmitFreqKHz=transmitFreqKHz, vectorError=vectorError, receiveModulationMode=receiveModulationMode, tDDControl=tDDControl, smtp=smtp, telnetPortNumber=telnetPortNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, remoteMaximumTransmitPower=remoteMaximumTransmitPower, snmpControl=snmpControl, dfsTableEntry=dfsTableEntry, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, receivePower=receivePower, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, encryptionAlgorithm=encryptionAlgorithm, regionCodeTrap=regionCodeTrap, telecomsLoopback=telecomsLoopback, groupID=groupID)
