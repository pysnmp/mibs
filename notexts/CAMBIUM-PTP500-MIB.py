...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", ethernetFiberSupport=ethernetFiberSupport, phyStatusGroup=phyStatusGroup, telecomsLoopback=telecomsLoopback, dfsTableIndex=dfsTableIndex, hTTPSAccessEnabled=hTTPSAccessEnabled, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, userTableEntry=userTableEntry, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, regionCodeTrap=regionCodeTrap, dfsPeaks=dfsPeaks, linkName=linkName, wirelessLinkAvailability=wirelessLinkAvailability, telecomsLineCode=telecomsLineCode, transmitFreqMHz=transmitFreqMHz, sMTPSourceEmailAddress=sMTPSourceEmailAddress, longitude=longitude, searchState=searchState, userEnabled=userEnabled, dfsTableNumber=dfsTableNumber, sMTPServerIPAddress=sMTPServerIPAddress, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ethernetGroup=ethernetGroup, licence=licence, sNMPTrapIPAddress=sNMPTrapIPAddress, ptp500=ptp500, PYSNMP_MODULE_ID=cambium, notificationsGroup=notificationsGroup, unitOutOfCalibration=unitOutOfCalibration, dataPortDisabledWarning=dataPortDisabledWarning, useVLANForManagementInterfaces=useVLANForManagementInterfaces, masterSlaveMode=masterSlaveMode, channelChangeTrap=channelChangeTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, linkModeOptimisation=linkModeOptimisation, telecom=telecom, configurationGroup=configurationGroup, remoteIPAddress=remoteIPAddress, aAAControl=aAAControl, hTTPPortNumber=hTTPPortNumber, hardwareVersion=hardwareVersion, maximumTransmitPower=maximumTransmitPower, channelBandwidth=channelBandwidth, eIRP=eIRP, linkSymmetry=linkSymmetry, ptpGroups=ptpGroups, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tFTPServerIPAddress=tFTPServerIPAddress, sNMPv3Enable=sNMPv3Enable, incompatibleRegionCodes=incompatibleRegionCodes, receiveFreqMHz=receiveFreqMHz, accessMethod=accessMethod, vLANPriorityTable=vLANPriorityTable, dfsMeans=dfsMeans, sNMPTrapTableNumber=sNMPTrapTableNumber, installStatusTrap=installStatusTrap, sMTPEmailAlert=sMTPEmailAlert, dataPortWirelessDownAlert=dataPortWirelessDownAlert, hTTPSPortNumber=hTTPSPortNumber, groupID=groupID, secondarySoftwareVersion=secondarySoftwareVersion, encryptionAlgorithm=encryptionAlgorithm, receiveModulationModeDetail=receiveModulationModeDetail, receiveChannel=receiveChannel, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPPollInterval=sNTPPollInterval, receiveDataRate=receiveDataRate, latitude=latitude, userTable=userTable, sNMPTrapTableIndex=sNMPTrapTableIndex, telnetPortNumber=telnetPortNumber, alarms=alarms, telecomsLoopbackTrap=telecomsLoopbackTrap, receivePower=receivePower, sNTPLastSync=sNTPLastSync, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPServerIPAddress=sNTPServerIPAddress, cambium=cambium, timeZone=timeZone, transmitDataRate=transmitDataRate, transmitPower=transmitPower, cableLoss=cableLoss, phyControl=phyControl, dataPortAutoMdix=dataPortAutoMdix, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, pubStatsGroup=pubStatsGroup, encryption=encryption, siteName=siteName, snmpControlGroup=snmpControlGroup, bandwidthVariant=bandwidthVariant, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPSync=sNTPSync, systemClock=systemClock, wirelessLinkStatus=wirelessLinkStatus, sNMPEnabledTraps=sNMPEnabledTraps, sNTPServerPortNumber=sNTPServerPortNumber, syslogClient=syslogClient, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, range=range, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, licensedCapacity=licensedCapacity, userName=userName, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sMTPEnabledMessages=sMTPEnabledMessages, tDDControl=tDDControl, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ethernet=ethernet, vLANPriorityTableEntry=vLANPriorityTableEntry, telecomsChannelStatus=telecomsChannelStatus, subnetMask=subnetMask, installArmStateTrap=installArmStateTrap, resetGroup=resetGroup, vectorError=vectorError, sNMPPortNumber=sNMPPortNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dfsTableEntry=dfsTableEntry, dataPortAutoNegotiation=dataPortAutoNegotiation, transmitModulationMode=transmitModulationMode, configuration=configuration, encryptionGroup=encryptionGroup, transmitFreqKHz=transmitFreqKHz, versions=versions, ptmp=ptmp, sNMPTrapPortNumber=sNMPTrapPortNumber, iPAddress=iPAddress, userTableNumber=userTableNumber, syslogState=syslogState, sNMPTrapTableEntry=sNMPTrapTableEntry, telecomsChannelStatusTrap=telecomsChannelStatusTrap, syslogControl=syslogControl, alarmsGroup=alarmsGroup, receiveModulationMode=receiveModulationMode, vLANPriorityTableNumber=vLANPriorityTableNumber, syslogStateTrap=syslogStateTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, smtp=smtp, dataPortStatusTrap=dataPortStatusTrap, dataPortStatus=dataPortStatus, constantPowerSpectralDensity=constantPowerSpectralDensity, gatewayIPAddress=gatewayIPAddress, frequencyVariant=frequencyVariant, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tFTPServerPortNumber=tFTPServerPortNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, installArmState=installArmState, licenceGroup=licenceGroup, sNMPTrapVersion=sNMPTrapVersion, antennaGain=antennaGain, regionCode=regionCode, snmpControl=snmpControl, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, byteErrorRatio=byteErrorRatio, vLANManagementVID=vLANManagementVID, phyStatus=phyStatus, syslogControlGroup=syslogControlGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, altitude=altitude, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, transmitChannel=transmitChannel, telecomsCableLength=telecomsCableLength, sNMPCommunityString=sNMPCommunityString, ptp=ptp, managementGroup=managementGroup, dfs=dfs, installStatus=installStatus, tDDSynchronizationMode=tDDSynchronizationMode, tDDSynchronizationStatus=tDDSynchronizationStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, daylightSaving=daylightSaving, userRole=userRole, smtpGroup=smtpGroup, sntpGroup=sntpGroup, aAAControlGroup=aAAControlGroup, capacityLicenseMismatch=capacityLicenseMismatch, vLANPriorityTableIndex=vLANPriorityTableIndex, sNTPSyncTrap=sNTPSyncTrap, phyControlGroup=phyControlGroup, hTTPAccessEnabled=hTTPAccessEnabled, sNTPState=sNTPState, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, softwareVersion=softwareVersion, aggregateDataRate=aggregateDataRate, sntp=sntp, telecomGroup=telecomGroup, telecomsInterface=telecomsInterface, telnetAccessEnabled=telnetAccessEnabled, userTableIndex=userTableIndex, bootVersion=bootVersion, reset=reset, ptpTraps=ptpTraps, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ptpTrapPrefix=ptpTrapPrefix, versionsGroup=versionsGroup, productName=productName, ptpCompliance=ptpCompliance, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, userPassword=userPassword, remoteMaximumTransmitPower=remoteMaximumTransmitPower, systemReset=systemReset, productVariant=productVariant, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapTable=sNMPTrapTable, vLANManagementPriority=vLANManagementPriority, dfsGroup=dfsGroup, supplementary=supplementary, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, pubStats=pubStats, tDDControlGroup=tDDControlGroup, management=management, targetMACAddress=targetMACAddress, receiveFreqKHz=receiveFreqKHz, signalStrengthRatio=signalStrengthRatio, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, syslogClientTrap=syslogClientTrap, linkLoss=linkLoss, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, supplementaryGroup=supplementaryGroup, dfsTable=dfsTable)
