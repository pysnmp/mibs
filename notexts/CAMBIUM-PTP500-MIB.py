...
Unsigned32, TimeTicks, Counter32, NotificationType, MibIdentifier, ModuleIdentity, iso, Bits, Counter64, enterprises, Gauge32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "TimeTicks", "Counter32", "NotificationType", "MibIdentifier", "ModuleIdentity", "iso", "Bits", "Counter64", "enterprises", "Gauge32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ObjectIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", receiveDataRate=receiveDataRate, aggregateDataRate=aggregateDataRate, sNMPTrapPortNumber=sNMPTrapPortNumber, installStatus=installStatus, telecomsChannelStatusTrap=telecomsChannelStatusTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, licensedCapacity=licensedCapacity, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, telecomsCableLength=telecomsCableLength, userTableIndex=userTableIndex, receiveChannel=receiveChannel, gatewayIPAddress=gatewayIPAddress, unitOutOfCalibration=unitOutOfCalibration, tDDControl=tDDControl, configurationGroup=configurationGroup, versionsGroup=versionsGroup, pubStatsGroup=pubStatsGroup, telecomsLoopback=telecomsLoopback, phyControl=phyControl, dfsTableIndex=dfsTableIndex, cableLoss=cableLoss, remoteMaximumTransmitPower=remoteMaximumTransmitPower, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tFTPServerIPAddress=tFTPServerIPAddress, vLANPriorityTableNumber=vLANPriorityTableNumber, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, ethernetGroup=ethernetGroup, siteName=siteName, sntpGroup=sntpGroup, syslogControlGroup=syslogControlGroup, dataPortStatusTrap=dataPortStatusTrap, accessMethod=accessMethod, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, antennaGain=antennaGain, tDDSynchronizationAlarm=tDDSynchronizationAlarm, channelChangeTrap=channelChangeTrap, phyStatusGroup=phyStatusGroup, dfsGroup=dfsGroup, signalStrengthRatio=signalStrengthRatio, telnetPortNumber=telnetPortNumber, resetGroup=resetGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, phyStatus=phyStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortStatus=dataPortStatus, snmpControl=snmpControl, ethernet=ethernet, linkLoss=linkLoss, range=range, subnetMask=subnetMask, licenceGroup=licenceGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, vLANManagementVID=vLANManagementVID, syslogClient=syslogClient, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNTPSync=sNTPSync, sMTPEnabledMessages=sMTPEnabledMessages, regionCode=regionCode, enabledDiagnosticAlarms=enabledDiagnosticAlarms, receiveFreqKHz=receiveFreqKHz, transmitFreqKHz=transmitFreqKHz, sMTPServerIPAddress=sMTPServerIPAddress, PYSNMP_MODULE_ID=cambium, masterSlaveMode=masterSlaveMode, alarms=alarms, sNMPTrapTableEntry=sNMPTrapTableEntry, wirelessLinkStatus=wirelessLinkStatus, receivePower=receivePower, sMTPSourceEmailAddress=sMTPSourceEmailAddress, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPServerIPAddress=sNTPServerIPAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, channelBandwidth=channelBandwidth, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sMTPServerPortNumber=sMTPServerPortNumber, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPTrapTableNumber=sNMPTrapTableNumber, userTableNumber=userTableNumber, dataPortDisabledWarning=dataPortDisabledWarning, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, installArmStateTrap=installArmStateTrap, sNTPLastSync=sNTPLastSync, receiveFreqMHz=receiveFreqMHz, ptpCompliance=ptpCompliance, sNMPTrapTableIndex=sNMPTrapTableIndex, groupID=groupID, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, vLANManagementPriority=vLANManagementPriority, transmitPower=transmitPower, hTTPSPortNumber=hTTPSPortNumber, wirelessLinkAvailability=wirelessLinkAvailability, bandwidthVariant=bandwidthVariant, ptmp=ptmp, ptp=ptp, telnetAccessEnabled=telnetAccessEnabled, capacityLicenseMismatch=capacityLicenseMismatch, encryptionAlgorithm=encryptionAlgorithm, altitude=altitude, pubStats=pubStats, tDDSynchronizationMode=tDDSynchronizationMode, dfs=dfs, dfsTableEntry=dfsTableEntry, tDDSynchronizationStatus=tDDSynchronizationStatus, timeZone=timeZone, hTTPSAccessEnabled=hTTPSAccessEnabled, aAAControl=aAAControl, vLANPriorityTableIndex=vLANPriorityTableIndex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPPortNumber=sNMPPortNumber, bootVersion=bootVersion, latitude=latitude, userPassword=userPassword, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, transmitChannel=transmitChannel, syslogClientTrap=syslogClientTrap, vLANPriorityQueueMapping=vLANPriorityQueueMapping, regionCodeTrap=regionCodeTrap, eIRP=eIRP, systemReset=systemReset, sNMPCommunityString=sNMPCommunityString, encryptionGroup=encryptionGroup, sNTPPollInterval=sNTPPollInterval, hardwareVersion=hardwareVersion, vLANPriorityTable=vLANPriorityTable, sNMPTrapVersion=sNMPTrapVersion, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, installArmState=installArmState, vLANPriorityTableEntry=vLANPriorityTableEntry, configuration=configuration, telecomsLineCode=telecomsLineCode, sNMPEnabledTraps=sNMPEnabledTraps, daylightSaving=daylightSaving, supplementaryGroup=supplementaryGroup, installStatusTrap=installStatusTrap, ptp500=ptp500, smtpGroup=smtpGroup, notificationsGroup=notificationsGroup, management=management, userTable=userTable, useVLANForManagementInterfaces=useVLANForManagementInterfaces, searchState=searchState, reset=reset, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapIPAddress=sNMPTrapIPAddress, syslogStateTrap=syslogStateTrap, dfsTable=dfsTable, linkSymmetry=linkSymmetry, ptpTrapPrefix=ptpTrapPrefix, sNTPSyncTrap=sNTPSyncTrap, telecomsInterface=telecomsInterface, dfsMeans=dfsMeans, byteErrorRatio=byteErrorRatio, vectorError=vectorError, managementGroup=managementGroup, sNTPState=sNTPState, supplementary=supplementary, receiveModulationMode=receiveModulationMode, cambium=cambium, ethernetFiberSupport=ethernetFiberSupport, receiveModulationModeDetail=receiveModulationModeDetail, userEnabled=userEnabled, ptpGroups=ptpGroups, dataPortAutoMdix=dataPortAutoMdix, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, smtp=smtp, targetMACAddress=targetMACAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, constantPowerSpectralDensity=constantPowerSpectralDensity, hTTPAccessEnabled=hTTPAccessEnabled, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, transmitDataRate=transmitDataRate, telecomsLoopbackTrap=telecomsLoopbackTrap, transmitFreqMHz=transmitFreqMHz, sNMPv3Enable=sNMPv3Enable, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dfsPeaks=dfsPeaks, sNTPServerPortNumber=sNTPServerPortNumber, systemClock=systemClock, encryption=encryption, versions=versions, iPAddress=iPAddress, sNMPTrapTable=sNMPTrapTable, productName=productName, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPServerPortNumber=tFTPServerPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, syslogState=syslogState, licence=licence, ptpTraps=ptpTraps, tDDControlGroup=tDDControlGroup, sntp=sntp, secondarySoftwareVersion=secondarySoftwareVersion, userName=userName, frequencyVariant=frequencyVariant, telecomsChannelStatus=telecomsChannelStatus, softwareVersion=softwareVersion, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkName=linkName, productVariant=productVariant, incompatibleRegionCodes=incompatibleRegionCodes, dataPortAutoNegotiation=dataPortAutoNegotiation, telecom=telecom, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, aAAControlGroup=aAAControlGroup, phyControlGroup=phyControlGroup, hTTPPortNumber=hTTPPortNumber, telecomGroup=telecomGroup, longitude=longitude, linkModeOptimisation=linkModeOptimisation, sMTPEmailAlert=sMTPEmailAlert, snmpControlGroup=snmpControlGroup, maximumTransmitPower=maximumTransmitPower, dfsTableNumber=dfsTableNumber, syslogControl=syslogControl, userRole=userRole, transmitModulationMode=transmitModulationMode, userTableEntry=userTableEntry, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, remoteIPAddress=remoteIPAddress, alarmsGroup=alarmsGroup)
