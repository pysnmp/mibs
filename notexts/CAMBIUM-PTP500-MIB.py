...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", cableLoss=cableLoss, hTTPPortNumber=hTTPPortNumber, bandwidthVariant=bandwidthVariant, phyStatusGroup=phyStatusGroup, supplementary=supplementary, sNTPState=sNTPState, syslogState=syslogState, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, transmitFreqMHz=transmitFreqMHz, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dfs=dfs, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, telnetAccessEnabled=telnetAccessEnabled, userTable=userTable, ptpCompliance=ptpCompliance, installArmState=installArmState, tFTPServerPortNumber=tFTPServerPortNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, transmitDataRate=transmitDataRate, vLANPriorityTable=vLANPriorityTable, regionCode=regionCode, ptpGroups=ptpGroups, sNMPTrapIPAddress=sNMPTrapIPAddress, userTableIndex=userTableIndex, licenceGroup=licenceGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, groupID=groupID, dataPortAutoNegotiation=dataPortAutoNegotiation, searchState=searchState, systemClock=systemClock, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ptp=ptp, userRole=userRole, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, encryptionGroup=encryptionGroup, iPAddress=iPAddress, telecomGroup=telecomGroup, reset=reset, linkSymmetry=linkSymmetry, sNTPServerIPAddress=sNTPServerIPAddress, incompatibleRegionCodes=incompatibleRegionCodes, dfsMeans=dfsMeans, sNMPv3Enable=sNMPv3Enable, syslogClientTrap=syslogClientTrap, sNTPLastSync=sNTPLastSync, sMTPServerPortNumber=sMTPServerPortNumber, sNMPPortNumber=sNMPPortNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNTPPollInterval=sNTPPollInterval, eIRP=eIRP, ptp500=ptp500, hardwareVersion=hardwareVersion, userName=userName, licensedCapacity=licensedCapacity, resetGroup=resetGroup, hTTPSPortNumber=hTTPSPortNumber, ptmp=ptmp, notificationsGroup=notificationsGroup, transmitPower=transmitPower, dataPortStatusTrap=dataPortStatusTrap, syslogControl=syslogControl, masterSlaveMode=masterSlaveMode, maximumTransmitPower=maximumTransmitPower, linkModeOptimisation=linkModeOptimisation, sNMPTrapTable=sNMPTrapTable, remoteIPAddress=remoteIPAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, secondarySoftwareVersion=secondarySoftwareVersion, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, userPassword=userPassword, smtp=smtp, receivePower=receivePower, encryptionAlgorithm=encryptionAlgorithm, ethernetGroup=ethernetGroup, telecomsChannelStatus=telecomsChannelStatus, configuration=configuration, supplementaryGroup=supplementaryGroup, ptpTrapPrefix=ptpTrapPrefix, PYSNMP_MODULE_ID=cambium, dfsPeaks=dfsPeaks, timeZone=timeZone, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, userEnabled=userEnabled, dataPortDisabledWarning=dataPortDisabledWarning, tDDSynchronizationMode=tDDSynchronizationMode, dataPortConfigurationMismatch=dataPortConfigurationMismatch, receiveChannel=receiveChannel, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, phyControl=phyControl, bootVersion=bootVersion, transmitChannel=transmitChannel, sNMPCommunityString=sNMPCommunityString, ethernetFiberSupport=ethernetFiberSupport, antennaGain=antennaGain, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, subnetMask=subnetMask, sNMPTrapTableIndex=sNMPTrapTableIndex, transmitFreqKHz=transmitFreqKHz, configurationGroup=configurationGroup, channelBandwidth=channelBandwidth, wirelessLinkStatus=wirelessLinkStatus, signalStrengthRatio=signalStrengthRatio, constantPowerSpectralDensity=constantPowerSpectralDensity, transmitModulationMode=transmitModulationMode, userTableNumber=userTableNumber, telecomsInterface=telecomsInterface, dataPortStatus=dataPortStatus, latitude=latitude, dfsGroup=dfsGroup, softwareVersion=softwareVersion, sNMPTrapVersion=sNMPTrapVersion, installStatusTrap=installStatusTrap, ethernet=ethernet, snmpControl=snmpControl, byteErrorRatio=byteErrorRatio, aggregateDataRate=aggregateDataRate, phyStatus=phyStatus, targetMACAddress=targetMACAddress, pubStatsGroup=pubStatsGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, unitOutOfCalibration=unitOutOfCalibration, installArmStateTrap=installArmStateTrap, sNTPSyncTrap=sNTPSyncTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, dfsTableIndex=dfsTableIndex, syslogStateTrap=syslogStateTrap, linkLoss=linkLoss, management=management, telecomsLoopback=telecomsLoopback, syslogClient=syslogClient, sMTPSourceEmailAddress=sMTPSourceEmailAddress, managementGroup=managementGroup, linkName=linkName, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, vLANPriorityTableIndex=vLANPriorityTableIndex, sMTPServerIPAddress=sMTPServerIPAddress, alarms=alarms, telecomsChannelStatusTrap=telecomsChannelStatusTrap, telnetPortNumber=telnetPortNumber, userTableEntry=userTableEntry, useVLANForManagementInterfaces=useVLANForManagementInterfaces, alarmsGroup=alarmsGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, aAAControl=aAAControl, aAAControlGroup=aAAControlGroup, syslogControlGroup=syslogControlGroup, vLANManagementPriority=vLANManagementPriority, productName=productName, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, receiveModulationMode=receiveModulationMode, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sMTPEnabledMessages=sMTPEnabledMessages, receiveModulationModeDetail=receiveModulationModeDetail, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPTrapTableNumber=sNMPTrapTableNumber, receiveDataRate=receiveDataRate, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dfsTable=dfsTable, versions=versions, phyControlGroup=phyControlGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tDDControl=tDDControl, tFTPServerIPAddress=tFTPServerIPAddress, gatewayIPAddress=gatewayIPAddress, vLANManagementVID=vLANManagementVID, smtpGroup=smtpGroup, sntpGroup=sntpGroup, regionCodeTrap=regionCodeTrap, licence=licence, tDDControlGroup=tDDControlGroup, range=range, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, capacityLicenseMismatch=capacityLicenseMismatch, channelChangeTrap=channelChangeTrap, receiveFreqKHz=receiveFreqKHz, sNTPSync=sNTPSync, wirelessLinkAvailability=wirelessLinkAvailability, snmpControlGroup=snmpControlGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sMTPEmailAlert=sMTPEmailAlert, receiveFreqMHz=receiveFreqMHz, daylightSaving=daylightSaving, longitude=longitude, altitude=altitude, hTTPAccessEnabled=hTTPAccessEnabled, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, frequencyVariant=frequencyVariant, encryption=encryption, telecomsCableLength=telecomsCableLength, sntp=sntp, sNTPServerPortNumber=sNTPServerPortNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, productVariant=productVariant, tDDSynchronizationStatus=tDDSynchronizationStatus, systemReset=systemReset, pubStats=pubStats, telecomsLineCode=telecomsLineCode, dfsTableEntry=dfsTableEntry, vectorError=vectorError, accessMethod=accessMethod, versionsGroup=versionsGroup, ptpTraps=ptpTraps, siteName=siteName, telecom=telecom, dataPortAutoMdix=dataPortAutoMdix, installStatus=installStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPEnabledTraps=sNMPEnabledTraps, telecomsLoopbackTrap=telecomsLoopbackTrap, dfsTableNumber=dfsTableNumber, cambium=cambium)
