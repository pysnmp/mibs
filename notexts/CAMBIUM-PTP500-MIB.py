...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sNTPServerPortNumber=sNTPServerPortNumber, timeZone=timeZone, aggregateDataRate=aggregateDataRate, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, transmitModulationMode=transmitModulationMode, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapIPAddress=sNMPTrapIPAddress, incompatibleMasterAndSlave=incompatibleMasterAndSlave, syslogLocalWrappedTrap=syslogLocalWrappedTrap, telecomsCableLength=telecomsCableLength, encryptionGroup=encryptionGroup, dfsPeaks=dfsPeaks, installArmState=installArmState, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNMPTrapTableIndex=sNMPTrapTableIndex, wirelessLinkStatus=wirelessLinkStatus, syslogClient=syslogClient, latitude=latitude, telecomsChannelStatusTrap=telecomsChannelStatusTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortDisabledWarning=dataPortDisabledWarning, snmpControlGroup=snmpControlGroup, snmpControl=snmpControl, regionCode=regionCode, frequencyVariant=frequencyVariant, altitude=altitude, systemReset=systemReset, pubStatsGroup=pubStatsGroup, ethernetGroup=ethernetGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, telnetPortNumber=telnetPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, configuration=configuration, sNTPPollInterval=sNTPPollInterval, sNTPSync=sNTPSync, dataPortWirelessDownAlert=dataPortWirelessDownAlert, systemClock=systemClock, dfsTableIndex=dfsTableIndex, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, phyStatusGroup=phyStatusGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, smtpGroup=smtpGroup, sNTPSyncTrap=sNTPSyncTrap, vLANManagementVID=vLANManagementVID, dfsTableEntry=dfsTableEntry, supplementary=supplementary, dataPortAutoMdix=dataPortAutoMdix, signalStrengthRatio=signalStrengthRatio, enabledDiagnosticAlarms=enabledDiagnosticAlarms, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, telecomsLoopback=telecomsLoopback, iPAddress=iPAddress, masterSlaveMode=masterSlaveMode, sNMPTrapTable=sNMPTrapTable, linkLoss=linkLoss, receiveDataRate=receiveDataRate, transmitFreqMHz=transmitFreqMHz, tDDSynchronizationStatus=tDDSynchronizationStatus, regionCodeTrap=regionCodeTrap, longitude=longitude, channelChangeTrap=channelChangeTrap, ptp=ptp, sNMPPortNumber=sNMPPortNumber, sntpGroup=sntpGroup, antennaGain=antennaGain, secondarySoftwareVersion=secondarySoftwareVersion, phyControl=phyControl, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, useVLANForManagementInterfaces=useVLANForManagementInterfaces, productName=productName, transmitPower=transmitPower, sNTPState=sNTPState, configurationGroup=configurationGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, reset=reset, syslogControl=syslogControl, userTableEntry=userTableEntry, hTTPSPortNumber=hTTPSPortNumber, ptpGroups=ptpGroups, userEnabled=userEnabled, byteErrorRatio=byteErrorRatio, linkName=linkName, vLANPriorityTableNumber=vLANPriorityTableNumber, tDDControl=tDDControl, sNMPCommunityString=sNMPCommunityString, telecom=telecom, supplementaryGroup=supplementaryGroup, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receiveModulationMode=receiveModulationMode, bootVersion=bootVersion, remoteIPAddress=remoteIPAddress, userName=userName, smtp=smtp, licensedCapacity=licensedCapacity, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dfsGroup=dfsGroup, dataPortStatus=dataPortStatus, dataPortAutoNegotiation=dataPortAutoNegotiation, syslogState=syslogState, licence=licence, receivePower=receivePower, notificationsGroup=notificationsGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, userPassword=userPassword, receiveFreqKHz=receiveFreqKHz, userTable=userTable, channelBandwidth=channelBandwidth, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, management=management, searchState=searchState, dfs=dfs, syslogClientTrap=syslogClientTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, eIRP=eIRP, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sMTPServerPortNumber=sMTPServerPortNumber, transmitFreqKHz=transmitFreqKHz, cableLoss=cableLoss, telecomsLineCode=telecomsLineCode, wirelessLinkAvailability=wirelessLinkAvailability, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dfsTableNumber=dfsTableNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, receiveChannel=receiveChannel, bandwidthVariant=bandwidthVariant, installArmStateTrap=installArmStateTrap, syslogStateTrap=syslogStateTrap, installStatus=installStatus, telecomsLoopbackTrap=telecomsLoopbackTrap, encryptionAlgorithm=encryptionAlgorithm, sNMPTrapTableNumber=sNMPTrapTableNumber, vLANPriorityTableEntry=vLANPriorityTableEntry, gatewayIPAddress=gatewayIPAddress, dfsMeans=dfsMeans, resetGroup=resetGroup, capacityLicenseMismatch=capacityLicenseMismatch, phyControlGroup=phyControlGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPTrapPortNumber=sNMPTrapPortNumber, userTableIndex=userTableIndex, encryption=encryption, vLANPriorityQueueMapping=vLANPriorityQueueMapping, maximumTransmitPower=maximumTransmitPower, ethernetFiberSupport=ethernetFiberSupport, hardwareVersion=hardwareVersion, userTableNumber=userTableNumber, dataPortStatusTrap=dataPortStatusTrap, targetMACAddress=targetMACAddress, userRole=userRole, sNMPTrapVersion=sNMPTrapVersion, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, sNMPv3Enable=sNMPv3Enable, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, telecomsChannelStatus=telecomsChannelStatus, accessMethod=accessMethod, hTTPPortNumber=hTTPPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, transmitChannel=transmitChannel, tDDControlGroup=tDDControlGroup, softwareVersion=softwareVersion, telecomGroup=telecomGroup, aAAControl=aAAControl, versionsGroup=versionsGroup, syslogControlGroup=syslogControlGroup, sNTPLastSync=sNTPLastSync, tDDSynchronizationMode=tDDSynchronizationMode, unitOutOfCalibration=unitOutOfCalibration, vLANPriorityTable=vLANPriorityTable, groupID=groupID, sMTPServerIPAddress=sMTPServerIPAddress, receiveFreqMHz=receiveFreqMHz, receiveModulationModeDetail=receiveModulationModeDetail, sntp=sntp, installStatusTrap=installStatusTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, range=range, ptpTraps=ptpTraps, constantPowerSpectralDensity=constantPowerSpectralDensity, ptpTrapPrefix=ptpTrapPrefix, vectorError=vectorError, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, subnetMask=subnetMask, dfsTable=dfsTable, managementGroup=managementGroup, productVariant=productVariant, cambium=cambium, pubStats=pubStats, transmitDataRate=transmitDataRate, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, tFTPServerPortNumber=tFTPServerPortNumber, licenceGroup=licenceGroup, siteName=siteName, sNMPEnabledTraps=sNMPEnabledTraps, sNTPServerIPAddress=sNTPServerIPAddress, versions=versions, remoteMaximumTransmitPower=remoteMaximumTransmitPower, alarms=alarms, telnetAccessEnabled=telnetAccessEnabled, daylightSaving=daylightSaving, hTTPSAccessEnabled=hTTPSAccessEnabled, vLANManagementPriority=vLANManagementPriority, aAAControlGroup=aAAControlGroup, ptpCompliance=ptpCompliance, tFTPServerIPAddress=tFTPServerIPAddress, incompatibleRegionCodes=incompatibleRegionCodes, alarmsGroup=alarmsGroup, PYSNMP_MODULE_ID=cambium, telecomsInterface=telecomsInterface, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ptp500=ptp500, ptmp=ptmp, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkSymmetry=linkSymmetry, linkModeOptimisation=linkModeOptimisation, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, hTTPAccessEnabled=hTTPAccessEnabled, ethernet=ethernet, phyStatus=phyStatus)
