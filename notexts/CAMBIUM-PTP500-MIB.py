...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", hTTPAccessEnabled=hTTPAccessEnabled, transmitModulationMode=transmitModulationMode, receiveFreqKHz=receiveFreqKHz, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, receiveDataRate=receiveDataRate, vLANManagementPriority=vLANManagementPriority, installStatus=installStatus, licence=licence, incompatibleRegionCodes=incompatibleRegionCodes, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ethernetFiberSupport=ethernetFiberSupport, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, encryption=encryption, encryptionGroup=encryptionGroup, tDDControlGroup=tDDControlGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, telecomsLoopback=telecomsLoopback, smtp=smtp, sntp=sntp, telecomsChannelStatusTrap=telecomsChannelStatusTrap, licenceGroup=licenceGroup, dfsPeaks=dfsPeaks, installStatusTrap=installStatusTrap, systemReset=systemReset, useVLANForManagementInterfaces=useVLANForManagementInterfaces, userTableEntry=userTableEntry, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, longitude=longitude, phyControlGroup=phyControlGroup, daylightSaving=daylightSaving, ptpTrapPrefix=ptpTrapPrefix, tFTPServerIPAddress=tFTPServerIPAddress, supplementary=supplementary, dataPortStatus=dataPortStatus, sNTPServerIPAddress=sNTPServerIPAddress, sNTPSync=sNTPSync, configuration=configuration, management=management, ptp500=ptp500, aggregateDataRate=aggregateDataRate, masterSlaveMode=masterSlaveMode, transmitFreqMHz=transmitFreqMHz, telecomsCableLength=telecomsCableLength, sNTPLastSync=sNTPLastSync, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ptp=ptp, secondarySoftwareVersion=secondarySoftwareVersion, altitude=altitude, signalStrengthRatio=signalStrengthRatio, versionsGroup=versionsGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, bootVersion=bootVersion, vLANManagementVID=vLANManagementVID, frequencyVariant=frequencyVariant, wirelessLinkStatus=wirelessLinkStatus, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, PYSNMP_MODULE_ID=cambium, sNMPTrapVersion=sNMPTrapVersion, userRole=userRole, alarmsGroup=alarmsGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, productName=productName, sMTPServerIPAddress=sMTPServerIPAddress, channelBandwidth=channelBandwidth, receiveModulationMode=receiveModulationMode, smtpGroup=smtpGroup, snmpControl=snmpControl, systemClock=systemClock, regionCode=regionCode, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, aAAControl=aAAControl, supplementaryGroup=supplementaryGroup, ptmp=ptmp, syslogControl=syslogControl, telecomGroup=telecomGroup, transmitDataRate=transmitDataRate, dataPortWirelessDownAlert=dataPortWirelessDownAlert, incompatibleMasterAndSlave=incompatibleMasterAndSlave, installArmState=installArmState, unitOutOfCalibration=unitOutOfCalibration, remoteIPAddress=remoteIPAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, vectorError=vectorError, linkSymmetry=linkSymmetry, phyStatus=phyStatus, vLANPriorityTableIndex=vLANPriorityTableIndex, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, receivePower=receivePower, dfs=dfs, phyStatusGroup=phyStatusGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, licensedCapacity=licensedCapacity, sNMPTrapTableNumber=sNMPTrapTableNumber, latitude=latitude, sNMPTrapPortNumber=sNMPTrapPortNumber, byteErrorRatio=byteErrorRatio, eIRP=eIRP, hTTPPortNumber=hTTPPortNumber, sNTPSyncTrap=sNTPSyncTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, transmitPower=transmitPower, managementGroup=managementGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPEnabledTraps=sNMPEnabledTraps, antennaGain=antennaGain, sNMPTrapTable=sNMPTrapTable, groupID=groupID, dataPortDisabledWarning=dataPortDisabledWarning, sNTPState=sNTPState, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dfsTableEntry=dfsTableEntry, sntpGroup=sntpGroup, telnetAccessEnabled=telnetAccessEnabled, telecomsChannelStatus=telecomsChannelStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPEmailAlert=sMTPEmailAlert, timeZone=timeZone, transmitChannel=transmitChannel, reset=reset, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ptpTraps=ptpTraps, configurationGroup=configurationGroup, telecom=telecom, encryptionAlgorithm=encryptionAlgorithm, tDDSynchronizationMode=tDDSynchronizationMode, dfsTableIndex=dfsTableIndex, receiveChannel=receiveChannel, ethernet=ethernet, tFTPServerPortNumber=tFTPServerPortNumber, alarms=alarms, hTTPSPortNumber=hTTPSPortNumber, softwareVersion=softwareVersion, subnetMask=subnetMask, sMTPServerPortNumber=sMTPServerPortNumber, dfsMeans=dfsMeans, gatewayIPAddress=gatewayIPAddress, pubStatsGroup=pubStatsGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, userName=userName, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, snmpControlGroup=snmpControlGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, userTableNumber=userTableNumber, userPassword=userPassword, phyControl=phyControl, linkModeOptimisation=linkModeOptimisation, wirelessLinkAvailability=wirelessLinkAvailability, productVariant=productVariant, ethernetGroup=ethernetGroup, hardwareVersion=hardwareVersion, syslogControlGroup=syslogControlGroup, linkLoss=linkLoss, ptpCompliance=ptpCompliance, iPAddress=iPAddress, capacityLicenseMismatch=capacityLicenseMismatch, receiveModulationModeDetail=receiveModulationModeDetail, transmitFreqKHz=transmitFreqKHz, channelChangeTrap=channelChangeTrap, accessMethod=accessMethod, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPPollInterval=sNTPPollInterval, maximumTransmitPower=maximumTransmitPower, resetGroup=resetGroup, sMTPEnabledMessages=sMTPEnabledMessages, dfsTableNumber=dfsTableNumber, sNMPPortNumber=sNMPPortNumber, syslogStateTrap=syslogStateTrap, dfsTable=dfsTable, dataPortAutoMdix=dataPortAutoMdix, sNMPTrapIPAddress=sNMPTrapIPAddress, installArmStateTrap=installArmStateTrap, versions=versions, dfsGroup=dfsGroup, dataPortStatusTrap=dataPortStatusTrap, tDDControl=tDDControl, linkModeOptimizationMismatch=linkModeOptimizationMismatch, bandwidthVariant=bandwidthVariant, searchState=searchState, cableLoss=cableLoss, siteName=siteName, syslogClient=syslogClient, enabledDiagnosticAlarms=enabledDiagnosticAlarms, pubStats=pubStats, sNMPTrapTableEntry=sNMPTrapTableEntry, ptpGroups=ptpGroups, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, linkName=linkName, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPCommunityString=sNMPCommunityString, syslogClientTrap=syslogClientTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, hTTPSAccessEnabled=hTTPSAccessEnabled, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tDDSynchronizationStatus=tDDSynchronizationStatus, userTableIndex=userTableIndex, vLANPriorityTableEntry=vLANPriorityTableEntry, vLANPriorityTable=vLANPriorityTable, sNTPServerPortNumber=sNTPServerPortNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, syslogState=syslogState, regionCodeTrap=regionCodeTrap, notificationsGroup=notificationsGroup, telecomsInterface=telecomsInterface, range=range, userTable=userTable, telecomsLineCode=telecomsLineCode, syslogLocalWrappedTrap=syslogLocalWrappedTrap, vLANPriorityQueueMapping=vLANPriorityQueueMapping, telnetPortNumber=telnetPortNumber, userEnabled=userEnabled, targetMACAddress=targetMACAddress, cambium=cambium, receiveFreqMHz=receiveFreqMHz, constantPowerSpectralDensity=constantPowerSpectralDensity, aAAControlGroup=aAAControlGroup, sNMPv3Enable=sNMPv3Enable)
