...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", tDDSynchronizationAlarm=tDDSynchronizationAlarm, userEnabled=userEnabled, linkSymmetry=linkSymmetry, tFTPServerPortNumber=tFTPServerPortNumber, syslogClient=syslogClient, remoteMaximumTransmitPower=remoteMaximumTransmitPower, systemReset=systemReset, userTableIndex=userTableIndex, aggregateDataRate=aggregateDataRate, sMTPSourceEmailAddress=sMTPSourceEmailAddress, telecomsLoopbackTrap=telecomsLoopbackTrap, gatewayIPAddress=gatewayIPAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, syslogControl=syslogControl, bandwidthVariant=bandwidthVariant, dataPortDisabledWarning=dataPortDisabledWarning, dataPortAutoNegotiation=dataPortAutoNegotiation, phyStatus=phyStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ethernetGroup=ethernetGroup, installStatus=installStatus, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, transmitDataRate=transmitDataRate, telecomsInterface=telecomsInterface, receiveModulationMode=receiveModulationMode, alarms=alarms, management=management, productVariant=productVariant, smtpGroup=smtpGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ptpGroups=ptpGroups, snmpControlGroup=snmpControlGroup, range=range, incompatibleMasterAndSlave=incompatibleMasterAndSlave, incompatibleRegionCodes=incompatibleRegionCodes, userRole=userRole, userPassword=userPassword, sNTPPollInterval=sNTPPollInterval, dataPortStatusTrap=dataPortStatusTrap, dfsTable=dfsTable, longitude=longitude, licensedCapacity=licensedCapacity, sMTPEnabledMessages=sMTPEnabledMessages, telecomsChannelStatusTrap=telecomsChannelStatusTrap, installArmStateTrap=installArmStateTrap, receiveChannel=receiveChannel, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNMPEnabledTraps=sNMPEnabledTraps, alarmsGroup=alarmsGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ptpCompliance=ptpCompliance, timeZone=timeZone, resetGroup=resetGroup, remoteIPAddress=remoteIPAddress, receiveModulationModeDetail=receiveModulationModeDetail, dfs=dfs, signalStrengthRatio=signalStrengthRatio, tDDSynchronizationMode=tDDSynchronizationMode, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, ethernetFiberSupport=ethernetFiberSupport, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sMTPServerIPAddress=sMTPServerIPAddress, eIRP=eIRP, ptp500=ptp500, accessMethod=accessMethod, productName=productName, wirelessLinkStatus=wirelessLinkStatus, PYSNMP_MODULE_ID=cambium, telecomsLoopback=telecomsLoopback, sNMPv3Enable=sNMPv3Enable, pubStatsGroup=pubStatsGroup, capacityLicenseMismatch=capacityLicenseMismatch, latitude=latitude, sNMPCommunityString=sNMPCommunityString, syslogControlGroup=syslogControlGroup, vLANManagementVID=vLANManagementVID, configuration=configuration, telnetPortNumber=telnetPortNumber, ethernet=ethernet, antennaGain=antennaGain, vLANPriorityQueueMapping=vLANPriorityQueueMapping, vLANPriorityTableIndex=vLANPriorityTableIndex, hTTPSPortNumber=hTTPSPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, phyControl=phyControl, transmitChannel=transmitChannel, dfsTableEntry=dfsTableEntry, sNMPTrapVersion=sNMPTrapVersion, installStatusTrap=installStatusTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, hTTPPortNumber=hTTPPortNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, versionsGroup=versionsGroup, userName=userName, phyStatusGroup=phyStatusGroup, receiveDataRate=receiveDataRate, systemClock=systemClock, ptp=ptp, ptpTraps=ptpTraps, tFTPServerIPAddress=tFTPServerIPAddress, dataPortAutoMdix=dataPortAutoMdix, telecom=telecom, tDDControlGroup=tDDControlGroup, notificationsGroup=notificationsGroup, receiveFreqKHz=receiveFreqKHz, dfsTableNumber=dfsTableNumber, ptpTrapPrefix=ptpTrapPrefix, linkModeOptimisation=linkModeOptimisation, hTTPAccessEnabled=hTTPAccessEnabled, supplementaryGroup=supplementaryGroup, snmpControl=snmpControl, unitOutOfCalibration=unitOutOfCalibration, vLANPriorityTable=vLANPriorityTable, sNMPTrapTable=sNMPTrapTable, telecomsCableLength=telecomsCableLength, aAAControl=aAAControl, noWirelessChannelAvailable=noWirelessChannelAvailable, transmitModulationMode=transmitModulationMode, sNTPState=sNTPState, hardwareVersion=hardwareVersion, telecomGroup=telecomGroup, syslogState=syslogState, bootVersion=bootVersion, sNTPServerIPAddress=sNTPServerIPAddress, dataPortStatus=dataPortStatus, iPAddress=iPAddress, masterSlaveMode=masterSlaveMode, targetMACAddress=targetMACAddress, receiveFreqMHz=receiveFreqMHz, transmitFreqKHz=transmitFreqKHz, tDDSynchronizationStatus=tDDSynchronizationStatus, licence=licence, linkLoss=linkLoss, groupID=groupID, sNTPSync=sNTPSync, vectorError=vectorError, sMTPServerPortNumber=sMTPServerPortNumber, altitude=altitude, transmitFreqMHz=transmitFreqMHz, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, phyControlGroup=phyControlGroup, aAAControlGroup=aAAControlGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, searchState=searchState, sntpGroup=sntpGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPPortNumber=sNMPPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, telecomsChannelStatus=telecomsChannelStatus, userTableEntry=userTableEntry, siteName=siteName, encryptionAlgorithm=encryptionAlgorithm, sNMPTrapTableEntry=sNMPTrapTableEntry, hTTPSAccessEnabled=hTTPSAccessEnabled, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, userTable=userTable, reset=reset, ptmp=ptmp, dfsGroup=dfsGroup, sNTPServerPortNumber=sNTPServerPortNumber, dfsMeans=dfsMeans, smtp=smtp, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dfsPeaks=dfsPeaks, supplementary=supplementary, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPLastSync=sNTPLastSync, syslogStateTrap=syslogStateTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, linkName=linkName, regionCodeTrap=regionCodeTrap, sntp=sntp, sNMPTrapIPAddress=sNMPTrapIPAddress, vLANPriorityTableEntry=vLANPriorityTableEntry, maximumTransmitPower=maximumTransmitPower, byteErrorRatio=byteErrorRatio, frequencyVariant=frequencyVariant, installArmState=installArmState, constantPowerSpectralDensity=constantPowerSpectralDensity, receivePower=receivePower, cableLoss=cableLoss, sNMPTrapTableIndex=sNMPTrapTableIndex, cambium=cambium, managementGroup=managementGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tDDControl=tDDControl, userTableNumber=userTableNumber, licenceGroup=licenceGroup, dfsTableIndex=dfsTableIndex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, syslogClientTrap=syslogClientTrap, pubStats=pubStats, encryptionGroup=encryptionGroup, sMTPEmailAlert=sMTPEmailAlert, channelBandwidth=channelBandwidth, versions=versions, regionCode=regionCode, telecomsLineCode=telecomsLineCode, telnetAccessEnabled=telnetAccessEnabled, linkModeOptimizationMismatch=linkModeOptimizationMismatch, wirelessLinkAvailability=wirelessLinkAvailability, sNTPSyncTrap=sNTPSyncTrap, encryption=encryption, sNMPTrapPortNumber=sNMPTrapPortNumber, daylightSaving=daylightSaving, subnetMask=subnetMask, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, configurationGroup=configurationGroup, vLANManagementPriority=vLANManagementPriority, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, softwareVersion=softwareVersion, dataPortConfigurationMismatch=dataPortConfigurationMismatch, channelChangeTrap=channelChangeTrap, transmitPower=transmitPower, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap)
