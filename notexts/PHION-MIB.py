...
ObjectIdentity, NotificationType, Gauge32, iso, TimeTicks, IpAddress, Counter64, Bits, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity, Unsigned32, Integer32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "Gauge32", "iso", "TimeTicks", "IpAddress", "Counter64", "Bits", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity", "Unsigned32", "Integer32", "enterprises")
...
mibBuilder.exportSymbols("PHION-MIB", serverServices=serverServices, fwCompliances=fwCompliances, partitionUsedSpacePercent=partitionUsedSpacePercent, ripGroup=ripGroup, class3Total=class3Total, vpnName=vpnName, packetThroughput64=packetThroughput64, boxServicesEntry=boxServicesEntry, bgpNeighborsEntry=bgpNeighborsEntry, dataThroughput=dataThroughput, eventID=eventID, hwSensorType=hwSensorType, phionHotfixes=phionHotfixes, class1Pakets=class1Pakets, packetThroughput=packetThroughput, ripNeighborsEntry=ripNeighborsEntry, phionRelease=phionRelease, trafficShapeEntry=trafficShapeEntry, PYSNMP_MODULE_ID=phion, vpnTunnelsEntry=vpnTunnelsEntry, ospfNeighborId=ospfNeighborId, partitionName=partitionName, RaidEventSeverity=RaidEventSeverity, bgpNeighbors=bgpNeighbors, dataThroughput64=dataThroughput64, serviceGroups=serviceGroups, fwGroups=fwGroups, partitionFreeSpace=partitionFreeSpace, eventRepresentation=eventRepresentation, raidEventTime=raidEventTime, serverServicesEntry=serverServicesEntry, diskSpace=diskSpace, raidEventsEntry=raidEventsEntry, hwSensors=hwSensors, fwCompliance=fwCompliance, eventIDDescription=eventIDDescription, diskspaceGroup=diskspaceGroup, phionHotfixesEntry=phionHotfixesEntry, hwSensorValue=hwSensorValue, fwStatsEntry=fwStatsEntry, connectorName=connectorName, bgpNeighborState=bgpNeighborState, ospfNeighbors=ospfNeighbors, ospfNeighborsEntry=ospfNeighborsEntry, boxServices=boxServices, class1Total=class1Total, class1Drop=class1Drop, hotfixName=hotfixName, raidGroup=raidGroup, sessions=sessions, raidEventIndex=raidEventIndex, eventAlarmTime=eventAlarmTime, ospfNeighborInterface=ospfNeighborInterface, class2Pakets=class2Pakets, eventGroup=eventGroup, partitionUsedSpace=partitionUsedSpace, fwStats=fwStats, hotfixInstallTime=hotfixInstallTime, boxGroup=boxGroup, raidEventText=raidEventText, class2Total=class2Total, eventType=eventType, bgpNeighborAddress=bgpNeighborAddress, noDelayTotal=noDelayTotal, netGroups=netGroups, vpnusersGroup=vpnusersGroup, SensorType=SensorType, trafficShape=trafficShape, eventTrap=eventTrap, noDelayDrop=noDelayDrop, eventSeverity=eventSeverity, hwSensorName=hwSensorName, VpnStates=VpnStates, trafficshapeGroup=trafficshapeGroup, vpnState=vpnState, firewallSessions64=firewallSessions64, class2Drop=class2Drop, serverServiceName=serverServiceName, raidEvents=raidEvents, bgpGroup=bgpGroup, firewallSessions=firewallSessions, raidEventSev=raidEventSev, firmwareGroups=firmwareGroups, eventLayerDescription=eventLayerDescription, eventClassification=eventClassification, serverServiceState=serverServiceState, fwstatsGroup=fwstatsGroup, boxServiceName=boxServiceName, ServiceState=ServiceState, vpnGroup=vpnGroup, boxServiceState=boxServiceState, ospfNeighborAddress=ospfNeighborAddress, hwSensorsEntry=hwSensorsEntry, noDelayPakets=noDelayPakets, hwGroups=hwGroups, partitionMaxSpace=partitionMaxSpace, ospfGroup=ospfGroup, event=event, serverGroup=serverGroup, vpnUsers=vpnUsers, releaseGroup=releaseGroup, notificationGroup=notificationGroup, ripNeighborAddress=ripNeighborAddress, rate=rate, ospfNeighborStatus=ospfNeighborStatus, eventGroups=eventGroups, class3Pakets=class3Pakets, class3Drop=class3Drop, firewall=firewall, hwGroup=hwGroup, vpnTunnels=vpnTunnels, hotfixGroup=hotfixGroup, phion=phion, ripNeighbors=ripNeighbors, ripNeighborState=ripNeighborState, diskSpaceEntry=diskSpaceEntry)
