...
MibIdentifier, ObjectIdentity, IpAddress, TimeTicks, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32, NotificationType, Counter64, Counter32, ModuleIdentity, enterprises, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ObjectIdentity", "IpAddress", "TimeTicks", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32", "NotificationType", "Counter64", "Counter32", "ModuleIdentity", "enterprises", "iso", "Integer32")
...
mibBuilder.exportSymbols("PHION-MIB", event=event, serverServicesEntry=serverServicesEntry, bgpNeighbors=bgpNeighbors, hwSensorType=hwSensorType, trafficShape=trafficShape, ospfNeighborInterface=ospfNeighborInterface, SensorType=SensorType, hwGroup=hwGroup, fwCompliance=fwCompliance, partitionUsedSpace=partitionUsedSpace, ospfNeighbors=ospfNeighbors, partitionName=partitionName, eventClassification=eventClassification, hwSensorValue=hwSensorValue, netGroups=netGroups, noDelayPakets=noDelayPakets, vpnName=vpnName, ripNeighborAddress=ripNeighborAddress, raidEventTime=raidEventTime, vpnTunnelsEntry=vpnTunnelsEntry, class1Pakets=class1Pakets, phion=phion, trafficshapeGroup=trafficshapeGroup, rate=rate, firmwareGroups=firmwareGroups, hwSensors=hwSensors, serverServiceName=serverServiceName, class1Drop=class1Drop, class2Drop=class2Drop, ripGroup=ripGroup, ospfNeighborsEntry=ospfNeighborsEntry, ripNeighbors=ripNeighbors, dataThroughput64=dataThroughput64, ripNeighborsEntry=ripNeighborsEntry, packetThroughput=packetThroughput, raidEventSev=raidEventSev, fwCompliances=fwCompliances, ospfNeighborAddress=ospfNeighborAddress, phionHotfixesEntry=phionHotfixesEntry, vpnGroup=vpnGroup, raidGroup=raidGroup, eventRepresentation=eventRepresentation, hotfixInstallTime=hotfixInstallTime, noDelayTotal=noDelayTotal, serviceGroups=serviceGroups, dataThroughput=dataThroughput, RaidEventSeverity=RaidEventSeverity, vpnUsers=vpnUsers, ospfNeighborStatus=ospfNeighborStatus, serverServices=serverServices, fwstatsGroup=fwstatsGroup, eventTrap=eventTrap, ospfGroup=ospfGroup, eventGroups=eventGroups, class3Drop=class3Drop, class1Total=class1Total, class3Total=class3Total, notificationGroup=notificationGroup, vpnTunnels=vpnTunnels, eventID=eventID, diskspaceGroup=diskspaceGroup, bgpGroup=bgpGroup, vpnusersGroup=vpnusersGroup, vpnState=vpnState, boxServicesEntry=boxServicesEntry, firewall=firewall, ServiceState=ServiceState, eventType=eventType, diskSpace=diskSpace, eventLayerDescription=eventLayerDescription, bgpNeighborState=bgpNeighborState, releaseGroup=releaseGroup, serverGroup=serverGroup, class3Pakets=class3Pakets, partitionFreeSpace=partitionFreeSpace, hotfixGroup=hotfixGroup, diskSpaceEntry=diskSpaceEntry, eventAlarmTime=eventAlarmTime, hwSensorName=hwSensorName, PYSNMP_MODULE_ID=phion, eventSeverity=eventSeverity, boxServices=boxServices, connectorName=connectorName, raidEventIndex=raidEventIndex, ripNeighborState=ripNeighborState, ospfNeighborId=ospfNeighborId, partitionMaxSpace=partitionMaxSpace, phionRelease=phionRelease, hwSensorsEntry=hwSensorsEntry, VpnStates=VpnStates, fwGroups=fwGroups, fwStatsEntry=fwStatsEntry, partitionUsedSpacePercent=partitionUsedSpacePercent, sessions=sessions, boxServiceState=boxServiceState, boxGroup=boxGroup, serverServiceState=serverServiceState, eventIDDescription=eventIDDescription, firewallSessions64=firewallSessions64, hwGroups=hwGroups, packetThroughput64=packetThroughput64, trafficShapeEntry=trafficShapeEntry, hotfixName=hotfixName, eventGroup=eventGroup, raidEvents=raidEvents, boxServiceName=boxServiceName, phionHotfixes=phionHotfixes, noDelayDrop=noDelayDrop, raidEventsEntry=raidEventsEntry, bgpNeighborsEntry=bgpNeighborsEntry, bgpNeighborAddress=bgpNeighborAddress, firewallSessions=firewallSessions, class2Pakets=class2Pakets, class2Total=class2Total, fwStats=fwStats, raidEventText=raidEventText)
