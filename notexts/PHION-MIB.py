...
iso, enterprises, Gauge32, ObjectIdentity, NotificationType, Counter64, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits, Counter32, Unsigned32, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "enterprises", "Gauge32", "ObjectIdentity", "NotificationType", "Counter64", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits", "Counter32", "Unsigned32", "ModuleIdentity", "Integer32")
...
mibBuilder.exportSymbols("PHION-MIB", connectorName=connectorName, boxServicesEntry=boxServicesEntry, boxServiceName=boxServiceName, RaidEventSeverity=RaidEventSeverity, boxServices=boxServices, rate=rate, firewall=firewall, class2Drop=class2Drop, fwStats=fwStats, netGroups=netGroups, releaseGroup=releaseGroup, noDelayPakets=noDelayPakets, phionHotfixes=phionHotfixes, hwGroups=hwGroups, eventIDDescription=eventIDDescription, eventTrap=eventTrap, fwCompliance=fwCompliance, vpnName=vpnName, raidEventText=raidEventText, SensorType=SensorType, partitionMaxSpace=partitionMaxSpace, hwGroup=hwGroup, raidEventIndex=raidEventIndex, PYSNMP_MODULE_ID=phion, sessions=sessions, boxGroup=boxGroup, class1Drop=class1Drop, dataThroughput64=dataThroughput64, ripNeighborAddress=ripNeighborAddress, eventGroup=eventGroup, hwSensorName=hwSensorName, vpnTunnels=vpnTunnels, hwSensorValue=hwSensorValue, class2Pakets=class2Pakets, phionRelease=phionRelease, eventID=eventID, hwSensors=hwSensors, partitionFreeSpace=partitionFreeSpace, hotfixGroup=hotfixGroup, firmwareGroups=firmwareGroups, ospfNeighborStatus=ospfNeighborStatus, partitionUsedSpacePercent=partitionUsedSpacePercent, eventAlarmTime=eventAlarmTime, dataThroughput=dataThroughput, raidEventSev=raidEventSev, trafficShapeEntry=trafficShapeEntry, serverGroup=serverGroup, bgpNeighborsEntry=bgpNeighborsEntry, noDelayDrop=noDelayDrop, hotfixInstallTime=hotfixInstallTime, serverServiceName=serverServiceName, trafficshapeGroup=trafficshapeGroup, bgpNeighborAddress=bgpNeighborAddress, packetThroughput64=packetThroughput64, vpnusersGroup=vpnusersGroup, eventSeverity=eventSeverity, ospfGroup=ospfGroup, ospfNeighborId=ospfNeighborId, eventLayerDescription=eventLayerDescription, vpnState=vpnState, class3Drop=class3Drop, trafficShape=trafficShape, ospfNeighborAddress=ospfNeighborAddress, eventType=eventType, bgpNeighbors=bgpNeighbors, class1Pakets=class1Pakets, diskSpaceEntry=diskSpaceEntry, vpnTunnelsEntry=vpnTunnelsEntry, eventRepresentation=eventRepresentation, serverServices=serverServices, raidGroup=raidGroup, serverServicesEntry=serverServicesEntry, VpnStates=VpnStates, diskSpace=diskSpace, eventGroups=eventGroups, ospfNeighborsEntry=ospfNeighborsEntry, fwstatsGroup=fwstatsGroup, fwGroups=fwGroups, hotfixName=hotfixName, class2Total=class2Total, raidEventTime=raidEventTime, notificationGroup=notificationGroup, raidEvents=raidEvents, boxServiceState=boxServiceState, serviceGroups=serviceGroups, ospfNeighbors=ospfNeighbors, raidEventsEntry=raidEventsEntry, partitionUsedSpace=partitionUsedSpace, class1Total=class1Total, firewallSessions64=firewallSessions64, packetThroughput=packetThroughput, noDelayTotal=noDelayTotal, bgpNeighborState=bgpNeighborState, ripNeighborsEntry=ripNeighborsEntry, serverServiceState=serverServiceState, fwStatsEntry=fwStatsEntry, partitionName=partitionName, vpnUsers=vpnUsers, firewallSessions=firewallSessions, hwSensorsEntry=hwSensorsEntry, vpnGroup=vpnGroup, ripNeighbors=ripNeighbors, ServiceState=ServiceState, diskspaceGroup=diskspaceGroup, class3Pakets=class3Pakets, eventClassification=eventClassification, ripNeighborState=ripNeighborState, ripGroup=ripGroup, ospfNeighborInterface=ospfNeighborInterface, event=event, fwCompliances=fwCompliances, hwSensorType=hwSensorType, class3Total=class3Total, bgpGroup=bgpGroup, phionHotfixesEntry=phionHotfixesEntry, phion=phion)
