...
ModuleIdentity, Integer32, IpAddress, MibIdentifier, Counter32, iso, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Unsigned32, NotificationType, Counter64, TimeTicks, Bits, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "IpAddress", "MibIdentifier", "Counter32", "iso", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Unsigned32", "NotificationType", "Counter64", "TimeTicks", "Bits", "ObjectIdentity")
...
mibBuilder.exportSymbols("PHION-MIB", trafficShapeEntry=trafficShapeEntry, serverServiceState=serverServiceState, ripNeighbors=ripNeighbors, ospfNeighborAddress=ospfNeighborAddress, ospfGroup=ospfGroup, trafficshapeGroup=trafficshapeGroup, SensorType=SensorType, netGroups=netGroups, partitionUsedSpace=partitionUsedSpace, partitionName=partitionName, hwGroups=hwGroups, eventSeverity=eventSeverity, dataThroughput64=dataThroughput64, phionHotfixesEntry=phionHotfixesEntry, firmwareGroups=firmwareGroups, bgpNeighborsEntry=bgpNeighborsEntry, hwGroup=hwGroup, eventGroups=eventGroups, eventClassification=eventClassification, dataThroughput=dataThroughput, ripGroup=ripGroup, hotfixInstallTime=hotfixInstallTime, bgpGroup=bgpGroup, raidEventTime=raidEventTime, ripNeighborState=ripNeighborState, boxGroup=boxGroup, packetThroughput=packetThroughput, noDelayPakets=noDelayPakets, fwStats=fwStats, serverServicesEntry=serverServicesEntry, ospfNeighborsEntry=ospfNeighborsEntry, hwSensorValue=hwSensorValue, diskSpaceEntry=diskSpaceEntry, class3Total=class3Total, eventRepresentation=eventRepresentation, eventType=eventType, PYSNMP_MODULE_ID=phion, fwGroups=fwGroups, ripNeighborsEntry=ripNeighborsEntry, hotfixGroup=hotfixGroup, vpnUsers=vpnUsers, ospfNeighborId=ospfNeighborId, vpnTunnels=vpnTunnels, class3Drop=class3Drop, eventGroup=eventGroup, raidEventIndex=raidEventIndex, ripNeighborAddress=ripNeighborAddress, ServiceState=ServiceState, phion=phion, firewall=firewall, hwSensorName=hwSensorName, ospfNeighborStatus=ospfNeighborStatus, serverGroup=serverGroup, vpnName=vpnName, eventTrap=eventTrap, boxServices=boxServices, noDelayTotal=noDelayTotal, partitionMaxSpace=partitionMaxSpace, class1Pakets=class1Pakets, firewallSessions64=firewallSessions64, eventID=eventID, class2Pakets=class2Pakets, eventAlarmTime=eventAlarmTime, vpnTunnelsEntry=vpnTunnelsEntry, raidGroup=raidGroup, serviceGroups=serviceGroups, ospfNeighborInterface=ospfNeighborInterface, raidEventsEntry=raidEventsEntry, class1Drop=class1Drop, vpnState=vpnState, class2Total=class2Total, class2Drop=class2Drop, phionRelease=phionRelease, diskSpace=diskSpace, fwCompliance=fwCompliance, firewallSessions=firewallSessions, eventIDDescription=eventIDDescription, noDelayDrop=noDelayDrop, hwSensorType=hwSensorType, RaidEventSeverity=RaidEventSeverity, event=event, bgpNeighborAddress=bgpNeighborAddress, raidEventText=raidEventText, fwStatsEntry=fwStatsEntry, hwSensorsEntry=hwSensorsEntry, class3Pakets=class3Pakets, packetThroughput64=packetThroughput64, hwSensors=hwSensors, sessions=sessions, phionHotfixes=phionHotfixes, eventLayerDescription=eventLayerDescription, class1Total=class1Total, vpnusersGroup=vpnusersGroup, VpnStates=VpnStates, releaseGroup=releaseGroup, hotfixName=hotfixName, bgpNeighborState=bgpNeighborState, diskspaceGroup=diskspaceGroup, notificationGroup=notificationGroup, ospfNeighbors=ospfNeighbors, boxServiceName=boxServiceName, boxServicesEntry=boxServicesEntry, vpnGroup=vpnGroup, serverServiceName=serverServiceName, serverServices=serverServices, raidEvents=raidEvents, partitionFreeSpace=partitionFreeSpace, fwstatsGroup=fwstatsGroup, boxServiceState=boxServiceState, partitionUsedSpacePercent=partitionUsedSpacePercent, trafficShape=trafficShape, fwCompliances=fwCompliances, bgpNeighbors=bgpNeighbors, connectorName=connectorName, raidEventSev=raidEventSev, rate=rate)
