...
iso, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Unsigned32, IpAddress, ModuleIdentity, Counter32, Gauge32, TimeTicks, enterprises, NotificationType, Counter64, MibIdentifier, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Unsigned32", "IpAddress", "ModuleIdentity", "Counter32", "Gauge32", "TimeTicks", "enterprises", "NotificationType", "Counter64", "MibIdentifier", "ObjectIdentity")
...
mibBuilder.exportSymbols("PHION-MIB", hwGroup=hwGroup, releaseGroup=releaseGroup, firmwareGroups=firmwareGroups, ripGroup=ripGroup, noDelayDrop=noDelayDrop, class3Total=class3Total, hwGroups=hwGroups, noDelayTotal=noDelayTotal, noDelayPakets=noDelayPakets, eventGroups=eventGroups, ripNeighborsEntry=ripNeighborsEntry, fwStats=fwStats, bgpNeighborAddress=bgpNeighborAddress, phionRelease=phionRelease, serverServiceState=serverServiceState, serverServices=serverServices, ospfNeighborAddress=ospfNeighborAddress, hwSensorName=hwSensorName, bgpNeighborsEntry=bgpNeighborsEntry, hotfixName=hotfixName, class3Drop=class3Drop, eventType=eventType, fwGroups=fwGroups, vpnTunnelsEntry=vpnTunnelsEntry, ripNeighbors=ripNeighbors, boxServiceState=boxServiceState, class1Drop=class1Drop, ospfNeighbors=ospfNeighbors, ripNeighborState=ripNeighborState, boxServiceName=boxServiceName, firewallSessions64=firewallSessions64, connectorName=connectorName, class2Drop=class2Drop, rate=rate, notificationGroup=notificationGroup, boxServicesEntry=boxServicesEntry, fwstatsGroup=fwstatsGroup, netGroups=netGroups, eventLayerDescription=eventLayerDescription, PYSNMP_MODULE_ID=phion, vpnTunnels=vpnTunnels, diskSpace=diskSpace, phionHotfixesEntry=phionHotfixesEntry, diskSpaceEntry=diskSpaceEntry, hwSensors=hwSensors, vpnState=vpnState, partitionFreeSpace=partitionFreeSpace, raidEventTime=raidEventTime, hotfixGroup=hotfixGroup, dataThroughput64=dataThroughput64, trafficShape=trafficShape, bgpNeighbors=bgpNeighbors, vpnName=vpnName, firewall=firewall, phion=phion, class3Pakets=class3Pakets, vpnGroup=vpnGroup, RaidEventSeverity=RaidEventSeverity, phionHotfixes=phionHotfixes, class1Pakets=class1Pakets, hwSensorValue=hwSensorValue, eventAlarmTime=eventAlarmTime, sessions=sessions, hwSensorType=hwSensorType, class2Total=class2Total, fwCompliance=fwCompliance, boxGroup=boxGroup, partitionMaxSpace=partitionMaxSpace, raidEventIndex=raidEventIndex, VpnStates=VpnStates, eventIDDescription=eventIDDescription, ospfNeighborStatus=ospfNeighborStatus, ospfNeighborId=ospfNeighborId, class2Pakets=class2Pakets, ripNeighborAddress=ripNeighborAddress, eventTrap=eventTrap, ServiceState=ServiceState, diskspaceGroup=diskspaceGroup, partitionName=partitionName, raidEventSev=raidEventSev, hwSensorsEntry=hwSensorsEntry, SensorType=SensorType, hotfixInstallTime=hotfixInstallTime, fwCompliances=fwCompliances, class1Total=class1Total, packetThroughput64=packetThroughput64, firewallSessions=firewallSessions, packetThroughput=packetThroughput, fwStatsEntry=fwStatsEntry, serviceGroups=serviceGroups, eventSeverity=eventSeverity, boxServices=boxServices, vpnusersGroup=vpnusersGroup, bgpGroup=bgpGroup, eventGroup=eventGroup, event=event, ospfNeighborInterface=ospfNeighborInterface, dataThroughput=dataThroughput, trafficShapeEntry=trafficShapeEntry, raidEventsEntry=raidEventsEntry, vpnUsers=vpnUsers, partitionUsedSpace=partitionUsedSpace, eventID=eventID, serverGroup=serverGroup, eventClassification=eventClassification, bgpNeighborState=bgpNeighborState, partitionUsedSpacePercent=partitionUsedSpacePercent, serverServicesEntry=serverServicesEntry, ospfNeighborsEntry=ospfNeighborsEntry, raidGroup=raidGroup, raidEventText=raidEventText, raidEvents=raidEvents, eventRepresentation=eventRepresentation, trafficshapeGroup=trafficshapeGroup, ospfGroup=ospfGroup, serverServiceName=serverServiceName)
