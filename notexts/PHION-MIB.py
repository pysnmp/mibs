...
NotificationType, TimeTicks, Counter32, Bits, enterprises, Gauge32, ModuleIdentity, Integer32, iso, IpAddress, Unsigned32, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "Counter32", "Bits", "enterprises", "Gauge32", "ModuleIdentity", "Integer32", "iso", "IpAddress", "Unsigned32", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("PHION-MIB", PYSNMP_MODULE_ID=phion, class3Total=class3Total, hwSensorType=hwSensorType, firewallSessions64=firewallSessions64, bgpNeighborAddress=bgpNeighborAddress, dataThroughput64=dataThroughput64, class1Pakets=class1Pakets, class2Drop=class2Drop, trafficShape=trafficShape, fwCompliances=fwCompliances, trafficShapeEntry=trafficShapeEntry, eventTrap=eventTrap, hotfixGroup=hotfixGroup, eventClassification=eventClassification, class2Pakets=class2Pakets, serverServicesEntry=serverServicesEntry, bgpGroup=bgpGroup, packetThroughput=packetThroughput, hwGroup=hwGroup, sessions=sessions, vpnUsers=vpnUsers, raidEventText=raidEventText, fwCompliance=fwCompliance, vpnusersGroup=vpnusersGroup, diskSpace=diskSpace, event=event, eventGroup=eventGroup, rate=rate, releaseGroup=releaseGroup, notificationGroup=notificationGroup, phionHotfixesEntry=phionHotfixesEntry, hwSensors=hwSensors, trafficshapeGroup=trafficshapeGroup, vpnTunnels=vpnTunnels, RaidEventSeverity=RaidEventSeverity, phion=phion, firmwareGroups=firmwareGroups, boxServices=boxServices, raidEventTime=raidEventTime, class3Pakets=class3Pakets, class2Total=class2Total, vpnTunnelsEntry=vpnTunnelsEntry, fwGroups=fwGroups, serverServiceState=serverServiceState, diskspaceGroup=diskspaceGroup, SensorType=SensorType, serverServices=serverServices, raidEventIndex=raidEventIndex, boxGroup=boxGroup, ospfGroup=ospfGroup, ripNeighborsEntry=ripNeighborsEntry, bgpNeighborState=bgpNeighborState, boxServiceState=boxServiceState, raidEvents=raidEvents, VpnStates=VpnStates, partitionMaxSpace=partitionMaxSpace, packetThroughput64=packetThroughput64, ospfNeighborAddress=ospfNeighborAddress, serverServiceName=serverServiceName, hwSensorValue=hwSensorValue, fwStatsEntry=fwStatsEntry, vpnGroup=vpnGroup, eventLayerDescription=eventLayerDescription, ospfNeighbors=ospfNeighbors, eventGroups=eventGroups, eventID=eventID, ServiceState=ServiceState, dataThroughput=dataThroughput, boxServiceName=boxServiceName, hotfixInstallTime=hotfixInstallTime, ospfNeighborId=ospfNeighborId, noDelayDrop=noDelayDrop, connectorName=connectorName, ospfNeighborsEntry=ospfNeighborsEntry, ospfNeighborStatus=ospfNeighborStatus, eventAlarmTime=eventAlarmTime, vpnName=vpnName, class1Drop=class1Drop, serviceGroups=serviceGroups, fwstatsGroup=fwstatsGroup, phionHotfixes=phionHotfixes, partitionUsedSpacePercent=partitionUsedSpacePercent, hotfixName=hotfixName, raidEventsEntry=raidEventsEntry, serverGroup=serverGroup, netGroups=netGroups, fwStats=fwStats, ripNeighbors=ripNeighbors, firewallSessions=firewallSessions, ripNeighborAddress=ripNeighborAddress, eventIDDescription=eventIDDescription, hwSensorsEntry=hwSensorsEntry, raidEventSev=raidEventSev, boxServicesEntry=boxServicesEntry, diskSpaceEntry=diskSpaceEntry, raidGroup=raidGroup, ripGroup=ripGroup, bgpNeighbors=bgpNeighbors, partitionFreeSpace=partitionFreeSpace, noDelayPakets=noDelayPakets, ripNeighborState=ripNeighborState, class1Total=class1Total, eventType=eventType, phionRelease=phionRelease, hwSensorName=hwSensorName, firewall=firewall, class3Drop=class3Drop, ospfNeighborInterface=ospfNeighborInterface, hwGroups=hwGroups, vpnState=vpnState, bgpNeighborsEntry=bgpNeighborsEntry, partitionName=partitionName, noDelayTotal=noDelayTotal, eventSeverity=eventSeverity, eventRepresentation=eventRepresentation, partitionUsedSpace=partitionUsedSpace)
