...
Counter32, ObjectIdentity, Bits, Counter64, IpAddress, iso, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32, Unsigned32, enterprises, ModuleIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ObjectIdentity", "Bits", "Counter64", "IpAddress", "iso", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32", "Unsigned32", "enterprises", "ModuleIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("PHION-MIB", vpnName=vpnName, phionHotfixes=phionHotfixes, ospfNeighborStatus=ospfNeighborStatus, vpnTunnelsEntry=vpnTunnelsEntry, eventClassification=eventClassification, ServiceState=ServiceState, trafficShapeEntry=trafficShapeEntry, rate=rate, partitionName=partitionName, diskSpace=diskSpace, ospfNeighborAddress=ospfNeighborAddress, eventTrap=eventTrap, trafficShape=trafficShape, partitionUsedSpace=partitionUsedSpace, boxServiceName=boxServiceName, class1Drop=class1Drop, hwSensors=hwSensors, phion=phion, fwStats=fwStats, ospfGroup=ospfGroup, eventRepresentation=eventRepresentation, ripNeighborsEntry=ripNeighborsEntry, hwGroup=hwGroup, raidEvents=raidEvents, ripNeighborState=ripNeighborState, class1Total=class1Total, hwGroups=hwGroups, bgpNeighborsEntry=bgpNeighborsEntry, phionHotfixesEntry=phionHotfixesEntry, ripGroup=ripGroup, eventID=eventID, raidEventIndex=raidEventIndex, partitionFreeSpace=partitionFreeSpace, releaseGroup=releaseGroup, notificationGroup=notificationGroup, boxGroup=boxGroup, hotfixInstallTime=hotfixInstallTime, diskSpaceEntry=diskSpaceEntry, vpnusersGroup=vpnusersGroup, serverServices=serverServices, vpnTunnels=vpnTunnels, phionRelease=phionRelease, raidGroup=raidGroup, partitionMaxSpace=partitionMaxSpace, fwCompliances=fwCompliances, firewallSessions=firewallSessions, eventGroup=eventGroup, serverGroup=serverGroup, class3Drop=class3Drop, firewall=firewall, raidEventSev=raidEventSev, partitionUsedSpacePercent=partitionUsedSpacePercent, trafficshapeGroup=trafficshapeGroup, ospfNeighborInterface=ospfNeighborInterface, diskspaceGroup=diskspaceGroup, netGroups=netGroups, bgpNeighborAddress=bgpNeighborAddress, eventAlarmTime=eventAlarmTime, serviceGroups=serviceGroups, raidEventTime=raidEventTime, hwSensorValue=hwSensorValue, packetThroughput=packetThroughput, eventSeverity=eventSeverity, RaidEventSeverity=RaidEventSeverity, dataThroughput=dataThroughput, class2Total=class2Total, serverServicesEntry=serverServicesEntry, ripNeighbors=ripNeighbors, class3Pakets=class3Pakets, ospfNeighbors=ospfNeighbors, eventType=eventType, vpnUsers=vpnUsers, fwCompliance=fwCompliance, hotfixGroup=hotfixGroup, boxServices=boxServices, ospfNeighborId=ospfNeighborId, SensorType=SensorType, ripNeighborAddress=ripNeighborAddress, serverServiceName=serverServiceName, serverServiceState=serverServiceState, event=event, dataThroughput64=dataThroughput64, noDelayPakets=noDelayPakets, raidEventsEntry=raidEventsEntry, eventGroups=eventGroups, packetThroughput64=packetThroughput64, eventIDDescription=eventIDDescription, hwSensorsEntry=hwSensorsEntry, firmwareGroups=firmwareGroups, noDelayTotal=noDelayTotal, class2Pakets=class2Pakets, class1Pakets=class1Pakets, bgpNeighbors=bgpNeighbors, raidEventText=raidEventText, vpnGroup=vpnGroup, bgpNeighborState=bgpNeighborState, boxServiceState=boxServiceState, eventLayerDescription=eventLayerDescription, firewallSessions64=firewallSessions64, fwStatsEntry=fwStatsEntry, fwstatsGroup=fwstatsGroup, sessions=sessions, class3Total=class3Total, hwSensorName=hwSensorName, ospfNeighborsEntry=ospfNeighborsEntry, noDelayDrop=noDelayDrop, boxServicesEntry=boxServicesEntry, hwSensorType=hwSensorType, fwGroups=fwGroups, hotfixName=hotfixName, bgpGroup=bgpGroup, vpnState=vpnState, connectorName=connectorName, class2Drop=class2Drop, PYSNMP_MODULE_ID=phion, VpnStates=VpnStates)
