...
enterprises, Integer32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, NotificationType, IpAddress, Bits, Gauge32, ObjectIdentity, Counter64, iso, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Integer32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "NotificationType", "IpAddress", "Bits", "Gauge32", "ObjectIdentity", "Counter64", "iso", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("PHION-MIB", boxGroup=boxGroup, class2Pakets=class2Pakets, ospfNeighborId=ospfNeighborId, event=event, releaseGroup=releaseGroup, partitionUsedSpace=partitionUsedSpace, eventAlarmTime=eventAlarmTime, fwGroups=fwGroups, firewall=firewall, class3Total=class3Total, hotfixName=hotfixName, raidGroup=raidGroup, diskSpace=diskSpace, boxServices=boxServices, raidEventIndex=raidEventIndex, RaidEventSeverity=RaidEventSeverity, ripNeighborState=ripNeighborState, ripNeighborsEntry=ripNeighborsEntry, serverServicesEntry=serverServicesEntry, bgpNeighbors=bgpNeighbors, partitionUsedSpacePercent=partitionUsedSpacePercent, raidEventTime=raidEventTime, class3Pakets=class3Pakets, firewallSessions=firewallSessions, eventRepresentation=eventRepresentation, eventGroup=eventGroup, fwstatsGroup=fwstatsGroup, trafficShapeEntry=trafficShapeEntry, class1Drop=class1Drop, serverServices=serverServices, hwGroup=hwGroup, bgpNeighborAddress=bgpNeighborAddress, phionHotfixes=phionHotfixes, raidEvents=raidEvents, dataThroughput64=dataThroughput64, vpnTunnels=vpnTunnels, sessions=sessions, class2Drop=class2Drop, SensorType=SensorType, fwStatsEntry=fwStatsEntry, raidEventText=raidEventText, vpnUsers=vpnUsers, connectorName=connectorName, dataThroughput=dataThroughput, trafficShape=trafficShape, vpnName=vpnName, ripNeighborAddress=ripNeighborAddress, bgpNeighborState=bgpNeighborState, notificationGroup=notificationGroup, firmwareGroups=firmwareGroups, firewallSessions64=firewallSessions64, vpnTunnelsEntry=vpnTunnelsEntry, packetThroughput64=packetThroughput64, eventClassification=eventClassification, ospfGroup=ospfGroup, class2Total=class2Total, diskSpaceEntry=diskSpaceEntry, VpnStates=VpnStates, trafficshapeGroup=trafficshapeGroup, hwSensorsEntry=hwSensorsEntry, class1Pakets=class1Pakets, class3Drop=class3Drop, fwStats=fwStats, eventGroups=eventGroups, class1Total=class1Total, PYSNMP_MODULE_ID=phion, serverServiceName=serverServiceName, hwSensors=hwSensors, serverServiceState=serverServiceState, hwSensorName=hwSensorName, eventLayerDescription=eventLayerDescription, noDelayTotal=noDelayTotal, eventSeverity=eventSeverity, vpnGroup=vpnGroup, netGroups=netGroups, boxServiceState=boxServiceState, raidEventsEntry=raidEventsEntry, boxServicesEntry=boxServicesEntry, ServiceState=ServiceState, hotfixInstallTime=hotfixInstallTime, ospfNeighborInterface=ospfNeighborInterface, ospfNeighborAddress=ospfNeighborAddress, eventTrap=eventTrap, ospfNeighborStatus=ospfNeighborStatus, eventIDDescription=eventIDDescription, fwCompliance=fwCompliance, diskspaceGroup=diskspaceGroup, ospfNeighbors=ospfNeighbors, partitionName=partitionName, hwSensorValue=hwSensorValue, hotfixGroup=hotfixGroup, phion=phion, ripNeighbors=ripNeighbors, vpnState=vpnState, ospfNeighborsEntry=ospfNeighborsEntry, phionRelease=phionRelease, serverGroup=serverGroup, hwGroups=hwGroups, raidEventSev=raidEventSev, bgpNeighborsEntry=bgpNeighborsEntry, vpnusersGroup=vpnusersGroup, partitionFreeSpace=partitionFreeSpace, rate=rate, bgpGroup=bgpGroup, hwSensorType=hwSensorType, eventType=eventType, phionHotfixesEntry=phionHotfixesEntry, serviceGroups=serviceGroups, partitionMaxSpace=partitionMaxSpace, packetThroughput=packetThroughput, noDelayDrop=noDelayDrop, fwCompliances=fwCompliances, noDelayPakets=noDelayPakets, boxServiceName=boxServiceName, ripGroup=ripGroup, eventID=eventID)
