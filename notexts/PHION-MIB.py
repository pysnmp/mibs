...
Gauge32, ObjectIdentity, MibIdentifier, NotificationType, enterprises, TimeTicks, Counter64, iso, Unsigned32, Integer32, Bits, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "MibIdentifier", "NotificationType", "enterprises", "TimeTicks", "Counter64", "iso", "Unsigned32", "Integer32", "Bits", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress")
...
mibBuilder.exportSymbols("PHION-MIB", partitionUsedSpacePercent=partitionUsedSpacePercent, bgpNeighbors=bgpNeighbors, eventType=eventType, raidEventIndex=raidEventIndex, dataThroughput64=dataThroughput64, class3Drop=class3Drop, class2Total=class2Total, serviceGroups=serviceGroups, boxServiceName=boxServiceName, raidEventsEntry=raidEventsEntry, packetThroughput64=packetThroughput64, serverServicesEntry=serverServicesEntry, releaseGroup=releaseGroup, trafficShape=trafficShape, ripNeighborsEntry=ripNeighborsEntry, ripNeighbors=ripNeighbors, class1Total=class1Total, partitionUsedSpace=partitionUsedSpace, hwGroup=hwGroup, boxServicesEntry=boxServicesEntry, phion=phion, noDelayPakets=noDelayPakets, ripNeighborState=ripNeighborState, trafficshapeGroup=trafficshapeGroup, class1Drop=class1Drop, eventLayerDescription=eventLayerDescription, packetThroughput=packetThroughput, class2Pakets=class2Pakets, raidEventSev=raidEventSev, hwSensorType=hwSensorType, vpnUsers=vpnUsers, connectorName=connectorName, raidEventText=raidEventText, hwSensors=hwSensors, ospfNeighborInterface=ospfNeighborInterface, firewallSessions=firewallSessions, ospfGroup=ospfGroup, eventID=eventID, noDelayDrop=noDelayDrop, trafficShapeEntry=trafficShapeEntry, vpnTunnels=vpnTunnels, ripGroup=ripGroup, vpnTunnelsEntry=vpnTunnelsEntry, ServiceState=ServiceState, RaidEventSeverity=RaidEventSeverity, ospfNeighborAddress=ospfNeighborAddress, partitionFreeSpace=partitionFreeSpace, raidGroup=raidGroup, SensorType=SensorType, fwStatsEntry=fwStatsEntry, raidEvents=raidEvents, PYSNMP_MODULE_ID=phion, hwSensorValue=hwSensorValue, event=event, class2Drop=class2Drop, fwStats=fwStats, eventClassification=eventClassification, diskspaceGroup=diskspaceGroup, eventGroup=eventGroup, sessions=sessions, hotfixName=hotfixName, serverServiceState=serverServiceState, vpnusersGroup=vpnusersGroup, firewall=firewall, diskSpaceEntry=diskSpaceEntry, class1Pakets=class1Pakets, diskSpace=diskSpace, fwCompliance=fwCompliance, bgpNeighborAddress=bgpNeighborAddress, hwSensorName=hwSensorName, phionHotfixes=phionHotfixes, partitionName=partitionName, eventIDDescription=eventIDDescription, partitionMaxSpace=partitionMaxSpace, firmwareGroups=firmwareGroups, hwGroups=hwGroups, phionRelease=phionRelease, vpnState=vpnState, boxServiceState=boxServiceState, ospfNeighborStatus=ospfNeighborStatus, dataThroughput=dataThroughput, firewallSessions64=firewallSessions64, serverGroup=serverGroup, rate=rate, raidEventTime=raidEventTime, boxServices=boxServices, hotfixGroup=hotfixGroup, ospfNeighbors=ospfNeighbors, class3Pakets=class3Pakets, class3Total=class3Total, fwCompliances=fwCompliances, bgpNeighborState=bgpNeighborState, eventRepresentation=eventRepresentation, netGroups=netGroups, serverServices=serverServices, notificationGroup=notificationGroup, eventSeverity=eventSeverity, noDelayTotal=noDelayTotal, ospfNeighborId=ospfNeighborId, ripNeighborAddress=ripNeighborAddress, boxGroup=boxGroup, bgpNeighborsEntry=bgpNeighborsEntry, eventTrap=eventTrap, bgpGroup=bgpGroup, ospfNeighborsEntry=ospfNeighborsEntry, vpnGroup=vpnGroup, VpnStates=VpnStates, phionHotfixesEntry=phionHotfixesEntry, fwstatsGroup=fwstatsGroup, fwGroups=fwGroups, serverServiceName=serverServiceName, eventGroups=eventGroups, eventAlarmTime=eventAlarmTime, hwSensorsEntry=hwSensorsEntry, hotfixInstallTime=hotfixInstallTime, vpnName=vpnName)
