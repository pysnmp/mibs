...
Counter32, Unsigned32, IpAddress, ModuleIdentity, enterprises, Gauge32, iso, ObjectIdentity, TimeTicks, Bits, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter64, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Unsigned32", "IpAddress", "ModuleIdentity", "enterprises", "Gauge32", "iso", "ObjectIdentity", "TimeTicks", "Bits", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter64", "MibIdentifier")
...
mibBuilder.exportSymbols("PHION-MIB", fwGroups=fwGroups, phionHotfixes=phionHotfixes, hwGroup=hwGroup, raidEventTime=raidEventTime, class3Pakets=class3Pakets, boxServicesEntry=boxServicesEntry, bgpNeighborsEntry=bgpNeighborsEntry, fwstatsGroup=fwstatsGroup, vpnusersGroup=vpnusersGroup, class1Total=class1Total, hwSensors=hwSensors, fwCompliances=fwCompliances, notificationGroup=notificationGroup, bgpNeighbors=bgpNeighbors, firewall=firewall, eventTrap=eventTrap, partitionUsedSpacePercent=partitionUsedSpacePercent, ripNeighbors=ripNeighbors, vpnName=vpnName, ripNeighborAddress=ripNeighborAddress, bgpNeighborAddress=bgpNeighborAddress, fwStats=fwStats, boxServiceName=boxServiceName, eventType=eventType, hwSensorType=hwSensorType, dataThroughput64=dataThroughput64, ripNeighborState=ripNeighborState, partitionName=partitionName, noDelayPakets=noDelayPakets, eventID=eventID, eventGroup=eventGroup, ServiceState=ServiceState, releaseGroup=releaseGroup, noDelayDrop=noDelayDrop, diskSpaceEntry=diskSpaceEntry, raidEventIndex=raidEventIndex, packetThroughput64=packetThroughput64, SensorType=SensorType, hwSensorName=hwSensorName, class1Pakets=class1Pakets, ospfNeighborStatus=ospfNeighborStatus, connectorName=connectorName, dataThroughput=dataThroughput, RaidEventSeverity=RaidEventSeverity, class2Pakets=class2Pakets, ripNeighborsEntry=ripNeighborsEntry, netGroups=netGroups, fwStatsEntry=fwStatsEntry, eventGroups=eventGroups, ripGroup=ripGroup, sessions=sessions, raidEventSev=raidEventSev, ospfNeighborAddress=ospfNeighborAddress, class1Drop=class1Drop, firewallSessions64=firewallSessions64, vpnTunnels=vpnTunnels, boxServices=boxServices, serviceGroups=serviceGroups, hotfixGroup=hotfixGroup, noDelayTotal=noDelayTotal, vpnTunnelsEntry=vpnTunnelsEntry, ospfNeighborsEntry=ospfNeighborsEntry, ospfNeighborInterface=ospfNeighborInterface, eventAlarmTime=eventAlarmTime, class3Drop=class3Drop, phionRelease=phionRelease, trafficShapeEntry=trafficShapeEntry, eventLayerDescription=eventLayerDescription, partitionMaxSpace=partitionMaxSpace, serverServices=serverServices, partitionFreeSpace=partitionFreeSpace, bgpGroup=bgpGroup, boxServiceState=boxServiceState, raidGroup=raidGroup, hotfixName=hotfixName, trafficshapeGroup=trafficshapeGroup, serverServiceName=serverServiceName, raidEventText=raidEventText, vpnState=vpnState, hwGroups=hwGroups, class3Total=class3Total, vpnUsers=vpnUsers, rate=rate, VpnStates=VpnStates, diskSpace=diskSpace, class2Drop=class2Drop, diskspaceGroup=diskspaceGroup, phionHotfixesEntry=phionHotfixesEntry, eventIDDescription=eventIDDescription, serverGroup=serverGroup, PYSNMP_MODULE_ID=phion, partitionUsedSpace=partitionUsedSpace, raidEvents=raidEvents, bgpNeighborState=bgpNeighborState, raidEventsEntry=raidEventsEntry, ospfNeighborId=ospfNeighborId, hotfixInstallTime=hotfixInstallTime, vpnGroup=vpnGroup, packetThroughput=packetThroughput, phion=phion, fwCompliance=fwCompliance, serverServiceState=serverServiceState, boxGroup=boxGroup, eventSeverity=eventSeverity, hwSensorValue=hwSensorValue, event=event, ospfNeighbors=ospfNeighbors, firmwareGroups=firmwareGroups, hwSensorsEntry=hwSensorsEntry, ospfGroup=ospfGroup, trafficShape=trafficShape, eventRepresentation=eventRepresentation, eventClassification=eventClassification, firewallSessions=firewallSessions, serverServicesEntry=serverServicesEntry, class2Total=class2Total)
