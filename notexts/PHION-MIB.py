...
enterprises, IpAddress, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter64, Bits, NotificationType, Gauge32, Integer32, ObjectIdentity, MibIdentifier, iso, Counter32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "IpAddress", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter64", "Bits", "NotificationType", "Gauge32", "Integer32", "ObjectIdentity", "MibIdentifier", "iso", "Counter32", "TimeTicks")
...
mibBuilder.exportSymbols("PHION-MIB", hwSensorsEntry=hwSensorsEntry, partitionMaxSpace=partitionMaxSpace, vpnTunnels=vpnTunnels, hotfixGroup=hotfixGroup, bgpNeighborAddress=bgpNeighborAddress, diskSpace=diskSpace, firewallSessions=firewallSessions, hotfixName=hotfixName, class1Total=class1Total, releaseGroup=releaseGroup, vpnUsers=vpnUsers, eventSeverity=eventSeverity, bgpNeighborState=bgpNeighborState, bgpGroup=bgpGroup, partitionName=partitionName, raidEventText=raidEventText, class1Drop=class1Drop, eventIDDescription=eventIDDescription, raidEventsEntry=raidEventsEntry, phion=phion, vpnState=vpnState, eventTrap=eventTrap, hwSensorType=hwSensorType, ripGroup=ripGroup, boxServicesEntry=boxServicesEntry, hwSensorValue=hwSensorValue, serverServicesEntry=serverServicesEntry, partitionFreeSpace=partitionFreeSpace, ServiceState=ServiceState, RaidEventSeverity=RaidEventSeverity, serverServiceName=serverServiceName, hwGroups=hwGroups, ospfNeighborAddress=ospfNeighborAddress, boxGroup=boxGroup, hotfixInstallTime=hotfixInstallTime, raidEventSev=raidEventSev, diskspaceGroup=diskspaceGroup, hwSensors=hwSensors, ospfGroup=ospfGroup, phionRelease=phionRelease, ripNeighbors=ripNeighbors, dataThroughput=dataThroughput, ospfNeighbors=ospfNeighbors, firmwareGroups=firmwareGroups, ospfNeighborInterface=ospfNeighborInterface, fwStats=fwStats, serverServices=serverServices, boxServiceName=boxServiceName, firewall=firewall, rate=rate, noDelayPakets=noDelayPakets, raidEvents=raidEvents, phionHotfixes=phionHotfixes, partitionUsedSpace=partitionUsedSpace, fwCompliance=fwCompliance, noDelayTotal=noDelayTotal, PYSNMP_MODULE_ID=phion, serviceGroups=serviceGroups, VpnStates=VpnStates, raidEventIndex=raidEventIndex, class3Pakets=class3Pakets, netGroups=netGroups, partitionUsedSpacePercent=partitionUsedSpacePercent, serverGroup=serverGroup, packetThroughput64=packetThroughput64, SensorType=SensorType, bgpNeighborsEntry=bgpNeighborsEntry, boxServiceState=boxServiceState, hwSensorName=hwSensorName, serverServiceState=serverServiceState, phionHotfixesEntry=phionHotfixesEntry, ospfNeighborId=ospfNeighborId, bgpNeighbors=bgpNeighbors, raidEventTime=raidEventTime, firewallSessions64=firewallSessions64, eventAlarmTime=eventAlarmTime, eventType=eventType, sessions=sessions, class3Total=class3Total, eventRepresentation=eventRepresentation, trafficShapeEntry=trafficShapeEntry, event=event, noDelayDrop=noDelayDrop, vpnTunnelsEntry=vpnTunnelsEntry, trafficshapeGroup=trafficshapeGroup, packetThroughput=packetThroughput, ospfNeighborsEntry=ospfNeighborsEntry, fwCompliances=fwCompliances, eventLayerDescription=eventLayerDescription, eventClassification=eventClassification, trafficShape=trafficShape, ripNeighborsEntry=ripNeighborsEntry, raidGroup=raidGroup, diskSpaceEntry=diskSpaceEntry, vpnName=vpnName, class3Drop=class3Drop, class2Drop=class2Drop, ripNeighborAddress=ripNeighborAddress, connectorName=connectorName, boxServices=boxServices, class1Pakets=class1Pakets, ripNeighborState=ripNeighborState, fwGroups=fwGroups, vpnusersGroup=vpnusersGroup, eventGroups=eventGroups, vpnGroup=vpnGroup, class2Total=class2Total, hwGroup=hwGroup, eventGroup=eventGroup, eventID=eventID, fwstatsGroup=fwstatsGroup, notificationGroup=notificationGroup, fwStatsEntry=fwStatsEntry, dataThroughput64=dataThroughput64, class2Pakets=class2Pakets, ospfNeighborStatus=ospfNeighborStatus)
