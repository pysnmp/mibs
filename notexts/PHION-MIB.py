...
ModuleIdentity, iso, ObjectIdentity, Bits, enterprises, MibIdentifier, Integer32, TimeTicks, Gauge32, Counter32, Unsigned32, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "ObjectIdentity", "Bits", "enterprises", "MibIdentifier", "Integer32", "TimeTicks", "Gauge32", "Counter32", "Unsigned32", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("PHION-MIB", ospfNeighborInterface=ospfNeighborInterface, hotfixGroup=hotfixGroup, noDelayTotal=noDelayTotal, noDelayDrop=noDelayDrop, dataThroughput=dataThroughput, raidEventTime=raidEventTime, raidEventSev=raidEventSev, serverServiceName=serverServiceName, releaseGroup=releaseGroup, ospfNeighborAddress=ospfNeighborAddress, ospfNeighborId=ospfNeighborId, connectorName=connectorName, diskspaceGroup=diskspaceGroup, hwGroup=hwGroup, raidGroup=raidGroup, class1Total=class1Total, raidEventText=raidEventText, vpnTunnels=vpnTunnels, vpnUsers=vpnUsers, firewallSessions64=firewallSessions64, class2Drop=class2Drop, diskSpace=diskSpace, ripNeighborState=ripNeighborState, firewallSessions=firewallSessions, ServiceState=ServiceState, notificationGroup=notificationGroup, ospfNeighborStatus=ospfNeighborStatus, class3Drop=class3Drop, boxServices=boxServices, serverServices=serverServices, vpnGroup=vpnGroup, sessions=sessions, eventRepresentation=eventRepresentation, phionHotfixesEntry=phionHotfixesEntry, fwStats=fwStats, boxServicesEntry=boxServicesEntry, noDelayPakets=noDelayPakets, partitionUsedSpacePercent=partitionUsedSpacePercent, vpnName=vpnName, hwSensorValue=hwSensorValue, partitionUsedSpace=partitionUsedSpace, class2Pakets=class2Pakets, diskSpaceEntry=diskSpaceEntry, VpnStates=VpnStates, boxGroup=boxGroup, rate=rate, hotfixInstallTime=hotfixInstallTime, bgpNeighborsEntry=bgpNeighborsEntry, class1Drop=class1Drop, serverGroup=serverGroup, SensorType=SensorType, vpnState=vpnState, eventGroup=eventGroup, eventSeverity=eventSeverity, PYSNMP_MODULE_ID=phion, serverServicesEntry=serverServicesEntry, trafficShape=trafficShape, bgpNeighborAddress=bgpNeighborAddress, partitionMaxSpace=partitionMaxSpace, bgpNeighborState=bgpNeighborState, phionHotfixes=phionHotfixes, ripNeighborAddress=ripNeighborAddress, eventIDDescription=eventIDDescription, boxServiceState=boxServiceState, netGroups=netGroups, ospfGroup=ospfGroup, vpnTunnelsEntry=vpnTunnelsEntry, eventID=eventID, firewall=firewall, class3Total=class3Total, eventLayerDescription=eventLayerDescription, eventType=eventType, fwCompliances=fwCompliances, event=event, boxServiceName=boxServiceName, raidEvents=raidEvents, vpnusersGroup=vpnusersGroup, ripNeighborsEntry=ripNeighborsEntry, class1Pakets=class1Pakets, fwstatsGroup=fwstatsGroup, hwSensors=hwSensors, packetThroughput=packetThroughput, ripGroup=ripGroup, firmwareGroups=firmwareGroups, raidEventIndex=raidEventIndex, eventTrap=eventTrap, hwGroups=hwGroups, class2Total=class2Total, bgpNeighbors=bgpNeighbors, fwCompliance=fwCompliance, partitionName=partitionName, hwSensorName=hwSensorName, hwSensorsEntry=hwSensorsEntry, phion=phion, phionRelease=phionRelease, bgpGroup=bgpGroup, partitionFreeSpace=partitionFreeSpace, hotfixName=hotfixName, serverServiceState=serverServiceState, serviceGroups=serviceGroups, ospfNeighborsEntry=ospfNeighborsEntry, eventClassification=eventClassification, raidEventsEntry=raidEventsEntry, hwSensorType=hwSensorType, RaidEventSeverity=RaidEventSeverity, class3Pakets=class3Pakets, fwStatsEntry=fwStatsEntry, eventGroups=eventGroups, fwGroups=fwGroups, ospfNeighbors=ospfNeighbors, dataThroughput64=dataThroughput64, trafficshapeGroup=trafficshapeGroup, eventAlarmTime=eventAlarmTime, trafficShapeEntry=trafficShapeEntry, packetThroughput64=packetThroughput64, ripNeighbors=ripNeighbors)
