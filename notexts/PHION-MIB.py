...
ModuleIdentity, iso, ObjectIdentity, Gauge32, MibIdentifier, NotificationType, enterprises, Integer32, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, TimeTicks, Counter64, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "ObjectIdentity", "Gauge32", "MibIdentifier", "NotificationType", "enterprises", "Integer32", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "TimeTicks", "Counter64", "Bits")
...
mibBuilder.exportSymbols("PHION-MIB", hwGroups=hwGroups, partitionUsedSpace=partitionUsedSpace, ServiceState=ServiceState, ripNeighborsEntry=ripNeighborsEntry, vpnusersGroup=vpnusersGroup, eventGroups=eventGroups, serverServiceState=serverServiceState, class3Pakets=class3Pakets, fwCompliance=fwCompliance, raidEventIndex=raidEventIndex, boxServiceState=boxServiceState, phion=phion, packetThroughput64=packetThroughput64, hwSensorValue=hwSensorValue, noDelayDrop=noDelayDrop, class3Drop=class3Drop, class1Total=class1Total, partitionUsedSpacePercent=partitionUsedSpacePercent, class1Pakets=class1Pakets, bgpNeighborState=bgpNeighborState, trafficShapeEntry=trafficShapeEntry, ospfNeighborsEntry=ospfNeighborsEntry, boxServicesEntry=boxServicesEntry, eventClassification=eventClassification, hwSensors=hwSensors, eventRepresentation=eventRepresentation, firewallSessions=firewallSessions, vpnUsers=vpnUsers, raidEventsEntry=raidEventsEntry, raidEventSev=raidEventSev, hotfixName=hotfixName, eventTrap=eventTrap, dataThroughput=dataThroughput, raidEvents=raidEvents, ospfNeighborStatus=ospfNeighborStatus, hwSensorsEntry=hwSensorsEntry, hwSensorName=hwSensorName, ospfNeighborId=ospfNeighborId, boxGroup=boxGroup, serverServices=serverServices, eventType=eventType, ospfNeighborAddress=ospfNeighborAddress, class2Drop=class2Drop, firewall=firewall, vpnState=vpnState, partitionFreeSpace=partitionFreeSpace, trafficShape=trafficShape, vpnGroup=vpnGroup, bgpNeighbors=bgpNeighbors, VpnStates=VpnStates, diskspaceGroup=diskspaceGroup, eventGroup=eventGroup, noDelayTotal=noDelayTotal, class2Pakets=class2Pakets, event=event, ripNeighborAddress=ripNeighborAddress, sessions=sessions, dataThroughput64=dataThroughput64, ospfNeighbors=ospfNeighbors, hotfixGroup=hotfixGroup, fwStatsEntry=fwStatsEntry, boxServices=boxServices, bgpNeighborsEntry=bgpNeighborsEntry, fwstatsGroup=fwstatsGroup, ripGroup=ripGroup, class1Drop=class1Drop, partitionMaxSpace=partitionMaxSpace, class3Total=class3Total, firmwareGroups=firmwareGroups, serviceGroups=serviceGroups, releaseGroup=releaseGroup, ospfNeighborInterface=ospfNeighborInterface, phionRelease=phionRelease, netGroups=netGroups, boxServiceName=boxServiceName, serverGroup=serverGroup, diskSpaceEntry=diskSpaceEntry, notificationGroup=notificationGroup, packetThroughput=packetThroughput, phionHotfixes=phionHotfixes, rate=rate, class2Total=class2Total, fwStats=fwStats, vpnTunnelsEntry=vpnTunnelsEntry, eventID=eventID, raidEventText=raidEventText, serverServiceName=serverServiceName, raidEventTime=raidEventTime, connectorName=connectorName, eventSeverity=eventSeverity, trafficshapeGroup=trafficshapeGroup, eventLayerDescription=eventLayerDescription, hwGroup=hwGroup, noDelayPakets=noDelayPakets, eventAlarmTime=eventAlarmTime, raidGroup=raidGroup, RaidEventSeverity=RaidEventSeverity, serverServicesEntry=serverServicesEntry, firewallSessions64=firewallSessions64, SensorType=SensorType, hotfixInstallTime=hotfixInstallTime, bgpNeighborAddress=bgpNeighborAddress, phionHotfixesEntry=phionHotfixesEntry, fwCompliances=fwCompliances, vpnName=vpnName, PYSNMP_MODULE_ID=phion, hwSensorType=hwSensorType, vpnTunnels=vpnTunnels, ripNeighbors=ripNeighbors, ripNeighborState=ripNeighborState, diskSpace=diskSpace, eventIDDescription=eventIDDescription, fwGroups=fwGroups, bgpGroup=bgpGroup, partitionName=partitionName, ospfGroup=ospfGroup)
