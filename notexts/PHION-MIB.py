...
enterprises, TimeTicks, ObjectIdentity, Counter32, IpAddress, Bits, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, Unsigned32, iso, ModuleIdentity, MibIdentifier, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "TimeTicks", "ObjectIdentity", "Counter32", "IpAddress", "Bits", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "Unsigned32", "iso", "ModuleIdentity", "MibIdentifier", "Counter64")
...
mibBuilder.exportSymbols("PHION-MIB", class2Pakets=class2Pakets, ospfNeighborAddress=ospfNeighborAddress, partitionUsedSpace=partitionUsedSpace, hotfixGroup=hotfixGroup, vpnTunnelsEntry=vpnTunnelsEntry, event=event, class1Total=class1Total, fwCompliances=fwCompliances, noDelayDrop=noDelayDrop, serverServiceState=serverServiceState, diskSpace=diskSpace, ospfNeighborInterface=ospfNeighborInterface, ripNeighborsEntry=ripNeighborsEntry, vpnName=vpnName, noDelayTotal=noDelayTotal, eventIDDescription=eventIDDescription, eventLayerDescription=eventLayerDescription, vpnUsers=vpnUsers, firmwareGroups=firmwareGroups, ospfGroup=ospfGroup, class3Total=class3Total, serverServiceName=serverServiceName, raidEventsEntry=raidEventsEntry, diskspaceGroup=diskspaceGroup, eventID=eventID, packetThroughput=packetThroughput, vpnusersGroup=vpnusersGroup, ospfNeighbors=ospfNeighbors, notificationGroup=notificationGroup, bgpNeighborsEntry=bgpNeighborsEntry, ripNeighbors=ripNeighbors, raidEventIndex=raidEventIndex, raidEventSev=raidEventSev, ospfNeighborStatus=ospfNeighborStatus, bgpNeighborAddress=bgpNeighborAddress, serviceGroups=serviceGroups, eventGroups=eventGroups, sessions=sessions, serverServicesEntry=serverServicesEntry, vpnState=vpnState, boxServices=boxServices, ospfNeighborsEntry=ospfNeighborsEntry, boxServiceState=boxServiceState, class2Total=class2Total, phionHotfixes=phionHotfixes, phion=phion, eventSeverity=eventSeverity, raidEvents=raidEvents, partitionName=partitionName, VpnStates=VpnStates, hwSensorValue=hwSensorValue, hwSensorsEntry=hwSensorsEntry, class3Drop=class3Drop, noDelayPakets=noDelayPakets, trafficShapeEntry=trafficShapeEntry, phionHotfixesEntry=phionHotfixesEntry, eventType=eventType, fwCompliance=fwCompliance, hwSensorType=hwSensorType, hwSensors=hwSensors, boxGroup=boxGroup, fwGroups=fwGroups, hwGroups=hwGroups, serverGroup=serverGroup, partitionFreeSpace=partitionFreeSpace, ripNeighborAddress=ripNeighborAddress, SensorType=SensorType, class1Drop=class1Drop, serverServices=serverServices, eventAlarmTime=eventAlarmTime, trafficshapeGroup=trafficshapeGroup, bgpGroup=bgpGroup, fwStats=fwStats, ripGroup=ripGroup, vpnTunnels=vpnTunnels, boxServiceName=boxServiceName, class1Pakets=class1Pakets, eventClassification=eventClassification, ospfNeighborId=ospfNeighborId, partitionMaxSpace=partitionMaxSpace, ripNeighborState=ripNeighborState, boxServicesEntry=boxServicesEntry, releaseGroup=releaseGroup, fwStatsEntry=fwStatsEntry, class2Drop=class2Drop, firewall=firewall, hotfixInstallTime=hotfixInstallTime, hotfixName=hotfixName, eventRepresentation=eventRepresentation, netGroups=netGroups, firewallSessions=firewallSessions, eventGroup=eventGroup, rate=rate, dataThroughput=dataThroughput, hwGroup=hwGroup, PYSNMP_MODULE_ID=phion, dataThroughput64=dataThroughput64, raidEventText=raidEventText, RaidEventSeverity=RaidEventSeverity, bgpNeighborState=bgpNeighborState, ServiceState=ServiceState, eventTrap=eventTrap, vpnGroup=vpnGroup, firewallSessions64=firewallSessions64, hwSensorName=hwSensorName, connectorName=connectorName, partitionUsedSpacePercent=partitionUsedSpacePercent, diskSpaceEntry=diskSpaceEntry, raidGroup=raidGroup, bgpNeighbors=bgpNeighbors, packetThroughput64=packetThroughput64, trafficShape=trafficShape, fwstatsGroup=fwstatsGroup, class3Pakets=class3Pakets, phionRelease=phionRelease, raidEventTime=raidEventTime)
