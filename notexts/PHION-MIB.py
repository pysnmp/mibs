...
enterprises, Bits, NotificationType, TimeTicks, ObjectIdentity, Unsigned32, MibIdentifier, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, Gauge32, Counter32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Bits", "NotificationType", "TimeTicks", "ObjectIdentity", "Unsigned32", "MibIdentifier", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "Gauge32", "Counter32", "Integer32")
...
mibBuilder.exportSymbols("PHION-MIB", trafficShapeEntry=trafficShapeEntry, packetThroughput64=packetThroughput64, ripGroup=ripGroup, class3Total=class3Total, ospfNeighborsEntry=ospfNeighborsEntry, boxGroup=boxGroup, firmwareGroups=firmwareGroups, sessions=sessions, PYSNMP_MODULE_ID=phion, trafficShape=trafficShape, ServiceState=ServiceState, firewall=firewall, ospfNeighborId=ospfNeighborId, fwStats=fwStats, fwstatsGroup=fwstatsGroup, packetThroughput=packetThroughput, ospfGroup=ospfGroup, hotfixName=hotfixName, bgpNeighborsEntry=bgpNeighborsEntry, bgpNeighbors=bgpNeighbors, partitionName=partitionName, fwStatsEntry=fwStatsEntry, partitionUsedSpacePercent=partitionUsedSpacePercent, partitionFreeSpace=partitionFreeSpace, RaidEventSeverity=RaidEventSeverity, class1Drop=class1Drop, eventGroups=eventGroups, firewallSessions=firewallSessions, hwSensorType=hwSensorType, VpnStates=VpnStates, raidEvents=raidEvents, hwSensorName=hwSensorName, hwGroups=hwGroups, eventIDDescription=eventIDDescription, noDelayPakets=noDelayPakets, ripNeighborState=ripNeighborState, notificationGroup=notificationGroup, vpnName=vpnName, noDelayDrop=noDelayDrop, eventGroup=eventGroup, fwCompliances=fwCompliances, bgpNeighborAddress=bgpNeighborAddress, raidGroup=raidGroup, raidEventText=raidEventText, diskSpace=diskSpace, vpnusersGroup=vpnusersGroup, eventLayerDescription=eventLayerDescription, bgpNeighborState=bgpNeighborState, boxServicesEntry=boxServicesEntry, serverServices=serverServices, raidEventSev=raidEventSev, releaseGroup=releaseGroup, serverServiceState=serverServiceState, raidEventTime=raidEventTime, eventSeverity=eventSeverity, eventTrap=eventTrap, eventType=eventType, dataThroughput64=dataThroughput64, serverGroup=serverGroup, event=event, eventClassification=eventClassification, boxServices=boxServices, serviceGroups=serviceGroups, fwCompliance=fwCompliance, hwSensors=hwSensors, class3Pakets=class3Pakets, hwSensorValue=hwSensorValue, ripNeighborsEntry=ripNeighborsEntry, class2Total=class2Total, netGroups=netGroups, raidEventIndex=raidEventIndex, eventRepresentation=eventRepresentation, bgpGroup=bgpGroup, dataThroughput=dataThroughput, rate=rate, vpnState=vpnState, ripNeighborAddress=ripNeighborAddress, firewallSessions64=firewallSessions64, vpnTunnelsEntry=vpnTunnelsEntry, vpnGroup=vpnGroup, phion=phion, ripNeighbors=ripNeighbors, serverServiceName=serverServiceName, ospfNeighborAddress=ospfNeighborAddress, hwGroup=hwGroup, trafficshapeGroup=trafficshapeGroup, eventID=eventID, SensorType=SensorType, eventAlarmTime=eventAlarmTime, phionHotfixesEntry=phionHotfixesEntry, ospfNeighborInterface=ospfNeighborInterface, hotfixGroup=hotfixGroup, class1Pakets=class1Pakets, serverServicesEntry=serverServicesEntry, hotfixInstallTime=hotfixInstallTime, vpnTunnels=vpnTunnels, fwGroups=fwGroups, phionHotfixes=phionHotfixes, phionRelease=phionRelease, partitionMaxSpace=partitionMaxSpace, diskspaceGroup=diskspaceGroup, diskSpaceEntry=diskSpaceEntry, hwSensorsEntry=hwSensorsEntry, class2Drop=class2Drop, boxServiceName=boxServiceName, vpnUsers=vpnUsers, partitionUsedSpace=partitionUsedSpace, boxServiceState=boxServiceState, raidEventsEntry=raidEventsEntry, class3Drop=class3Drop, ospfNeighbors=ospfNeighbors, class1Total=class1Total, connectorName=connectorName, noDelayTotal=noDelayTotal, class2Pakets=class2Pakets, ospfNeighborStatus=ospfNeighborStatus)
