...
Bits, ModuleIdentity, MibIdentifier, TimeTicks, enterprises, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter32, Gauge32, Integer32, Counter64, NotificationType, IpAddress, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "MibIdentifier", "TimeTicks", "enterprises", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter32", "Gauge32", "Integer32", "Counter64", "NotificationType", "IpAddress", "Unsigned32")
...
mibBuilder.exportSymbols("PHION-MIB", class2Total=class2Total, fwCompliance=fwCompliance, eventTrap=eventTrap, sessions=sessions, hwSensorValue=hwSensorValue, noDelayTotal=noDelayTotal, raidEventsEntry=raidEventsEntry, packetThroughput=packetThroughput, eventType=eventType, bgpNeighborsEntry=bgpNeighborsEntry, bgpGroup=bgpGroup, vpnTunnelsEntry=vpnTunnelsEntry, SensorType=SensorType, noDelayDrop=noDelayDrop, trafficShape=trafficShape, serverServiceName=serverServiceName, boxServiceState=boxServiceState, eventGroup=eventGroup, class1Pakets=class1Pakets, packetThroughput64=packetThroughput64, hwSensorsEntry=hwSensorsEntry, raidEventTime=raidEventTime, eventLayerDescription=eventLayerDescription, raidEventSev=raidEventSev, diskSpace=diskSpace, boxServiceName=boxServiceName, ospfNeighborId=ospfNeighborId, ripNeighborAddress=ripNeighborAddress, eventSeverity=eventSeverity, eventRepresentation=eventRepresentation, ripGroup=ripGroup, rate=rate, bgpNeighbors=bgpNeighbors, serverServiceState=serverServiceState, releaseGroup=releaseGroup, class1Total=class1Total, vpnTunnels=vpnTunnels, serverServicesEntry=serverServicesEntry, phionHotfixesEntry=phionHotfixesEntry, firmwareGroups=firmwareGroups, class2Drop=class2Drop, raidGroup=raidGroup, partitionUsedSpacePercent=partitionUsedSpacePercent, bgpNeighborState=bgpNeighborState, ServiceState=ServiceState, trafficShapeEntry=trafficShapeEntry, phionHotfixes=phionHotfixes, trafficshapeGroup=trafficshapeGroup, fwCompliances=fwCompliances, phionRelease=phionRelease, dataThroughput64=dataThroughput64, eventAlarmTime=eventAlarmTime, phion=phion, eventID=eventID, ospfGroup=ospfGroup, hwSensorType=hwSensorType, partitionFreeSpace=partitionFreeSpace, hotfixGroup=hotfixGroup, ospfNeighborInterface=ospfNeighborInterface, bgpNeighborAddress=bgpNeighborAddress, event=event, firewallSessions=firewallSessions, raidEventText=raidEventText, notificationGroup=notificationGroup, connectorName=connectorName, RaidEventSeverity=RaidEventSeverity, boxServices=boxServices, raidEvents=raidEvents, ospfNeighborsEntry=ospfNeighborsEntry, VpnStates=VpnStates, serverGroup=serverGroup, ripNeighborsEntry=ripNeighborsEntry, firewall=firewall, vpnGroup=vpnGroup, ripNeighborState=ripNeighborState, fwstatsGroup=fwstatsGroup, class3Drop=class3Drop, eventIDDescription=eventIDDescription, serviceGroups=serviceGroups, fwGroups=fwGroups, diskspaceGroup=diskspaceGroup, PYSNMP_MODULE_ID=phion, class1Drop=class1Drop, ospfNeighborAddress=ospfNeighborAddress, hwSensorName=hwSensorName, hwSensors=hwSensors, dataThroughput=dataThroughput, ripNeighbors=ripNeighbors, eventGroups=eventGroups, partitionName=partitionName, boxServicesEntry=boxServicesEntry, partitionMaxSpace=partitionMaxSpace, vpnState=vpnState, ospfNeighbors=ospfNeighbors, eventClassification=eventClassification, class3Pakets=class3Pakets, fwStats=fwStats, class3Total=class3Total, firewallSessions64=firewallSessions64, vpnusersGroup=vpnusersGroup, hotfixName=hotfixName, partitionUsedSpace=partitionUsedSpace, diskSpaceEntry=diskSpaceEntry, noDelayPakets=noDelayPakets, hwGroups=hwGroups, hwGroup=hwGroup, vpnUsers=vpnUsers, class2Pakets=class2Pakets, fwStatsEntry=fwStatsEntry, netGroups=netGroups, hotfixInstallTime=hotfixInstallTime, serverServices=serverServices, boxGroup=boxGroup, raidEventIndex=raidEventIndex, ospfNeighborStatus=ospfNeighborStatus, vpnName=vpnName)
