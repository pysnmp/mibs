...
NotificationType, Integer32, Gauge32, Counter32, enterprises, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Bits, ObjectIdentity, Unsigned32, Counter64, MibIdentifier, iso, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "Gauge32", "Counter32", "enterprises", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Bits", "ObjectIdentity", "Unsigned32", "Counter64", "MibIdentifier", "iso", "TimeTicks")
...
mibBuilder.exportSymbols("PHION-MIB", RaidEventSeverity=RaidEventSeverity, ripNeighborsEntry=ripNeighborsEntry, vpnState=vpnState, boxServiceState=boxServiceState, SensorType=SensorType, ospfNeighborId=ospfNeighborId, vpnGroup=vpnGroup, partitionUsedSpace=partitionUsedSpace, fwStatsEntry=fwStatsEntry, diskSpace=diskSpace, partitionMaxSpace=partitionMaxSpace, bgpGroup=bgpGroup, firewallSessions=firewallSessions, vpnusersGroup=vpnusersGroup, phion=phion, class1Pakets=class1Pakets, ripGroup=ripGroup, packetThroughput64=packetThroughput64, vpnTunnels=vpnTunnels, trafficShape=trafficShape, phionHotfixes=phionHotfixes, diskSpaceEntry=diskSpaceEntry, fwCompliance=fwCompliance, dataThroughput64=dataThroughput64, serverGroup=serverGroup, boxGroup=boxGroup, boxServicesEntry=boxServicesEntry, vpnUsers=vpnUsers, class2Pakets=class2Pakets, ospfNeighborAddress=ospfNeighborAddress, ospfNeighborStatus=ospfNeighborStatus, eventIDDescription=eventIDDescription, noDelayTotal=noDelayTotal, eventGroups=eventGroups, raidEventText=raidEventText, serviceGroups=serviceGroups, phionHotfixesEntry=phionHotfixesEntry, eventSeverity=eventSeverity, ripNeighbors=ripNeighbors, bgpNeighbors=bgpNeighbors, partitionFreeSpace=partitionFreeSpace, class1Total=class1Total, ospfNeighbors=ospfNeighbors, notificationGroup=notificationGroup, noDelayPakets=noDelayPakets, dataThroughput=dataThroughput, vpnName=vpnName, connectorName=connectorName, hotfixGroup=hotfixGroup, eventAlarmTime=eventAlarmTime, bgpNeighborsEntry=bgpNeighborsEntry, ospfGroup=ospfGroup, hwSensors=hwSensors, partitionName=partitionName, class1Drop=class1Drop, serverServicesEntry=serverServicesEntry, fwCompliances=fwCompliances, raidGroup=raidGroup, event=event, raidEventSev=raidEventSev, PYSNMP_MODULE_ID=phion, packetThroughput=packetThroughput, fwGroups=fwGroups, bgpNeighborState=bgpNeighborState, boxServiceName=boxServiceName, hwSensorValue=hwSensorValue, class3Total=class3Total, eventType=eventType, ospfNeighborsEntry=ospfNeighborsEntry, eventLayerDescription=eventLayerDescription, eventID=eventID, ripNeighborState=ripNeighborState, firewall=firewall, rate=rate, fwstatsGroup=fwstatsGroup, hwSensorType=hwSensorType, eventGroup=eventGroup, trafficshapeGroup=trafficshapeGroup, hwSensorName=hwSensorName, raidEventTime=raidEventTime, hotfixInstallTime=hotfixInstallTime, ripNeighborAddress=ripNeighborAddress, ospfNeighborInterface=ospfNeighborInterface, VpnStates=VpnStates, hwSensorsEntry=hwSensorsEntry, hotfixName=hotfixName, fwStats=fwStats, bgpNeighborAddress=bgpNeighborAddress, eventClassification=eventClassification, noDelayDrop=noDelayDrop, raidEventIndex=raidEventIndex, raidEvents=raidEvents, trafficShapeEntry=trafficShapeEntry, class3Drop=class3Drop, phionRelease=phionRelease, hwGroup=hwGroup, class2Drop=class2Drop, ServiceState=ServiceState, eventRepresentation=eventRepresentation, hwGroups=hwGroups, netGroups=netGroups, serverServiceName=serverServiceName, releaseGroup=releaseGroup, partitionUsedSpacePercent=partitionUsedSpacePercent, class2Total=class2Total, vpnTunnelsEntry=vpnTunnelsEntry, eventTrap=eventTrap, class3Pakets=class3Pakets, serverServiceState=serverServiceState, boxServices=boxServices, firmwareGroups=firmwareGroups, serverServices=serverServices, firewallSessions64=firewallSessions64, diskspaceGroup=diskspaceGroup, sessions=sessions, raidEventsEntry=raidEventsEntry)
