...
ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, iso, Counter64, Counter32, NotificationType, ModuleIdentity, enterprises, MibIdentifier, Bits, Integer32, IpAddress, TimeTicks, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "iso", "Counter64", "Counter32", "NotificationType", "ModuleIdentity", "enterprises", "MibIdentifier", "Bits", "Integer32", "IpAddress", "TimeTicks", "Unsigned32")
...
mibBuilder.exportSymbols("PHION-MIB", eventGroups=eventGroups, serverServicesEntry=serverServicesEntry, eventAlarmTime=eventAlarmTime, partitionUsedSpacePercent=partitionUsedSpacePercent, trafficShape=trafficShape, raidEvents=raidEvents, phionHotfixes=phionHotfixes, class2Drop=class2Drop, boxServiceState=boxServiceState, vpnusersGroup=vpnusersGroup, trafficShapeEntry=trafficShapeEntry, fwCompliances=fwCompliances, diskSpaceEntry=diskSpaceEntry, ripNeighborsEntry=ripNeighborsEntry, firewallSessions=firewallSessions, firewall=firewall, eventSeverity=eventSeverity, partitionMaxSpace=partitionMaxSpace, boxServices=boxServices, fwCompliance=fwCompliance, event=event, raidEventText=raidEventText, ospfNeighbors=ospfNeighbors, eventID=eventID, class1Drop=class1Drop, dataThroughput64=dataThroughput64, packetThroughput=packetThroughput, eventLayerDescription=eventLayerDescription, bgpNeighborAddress=bgpNeighborAddress, hotfixInstallTime=hotfixInstallTime, raidEventsEntry=raidEventsEntry, bgpNeighborState=bgpNeighborState, raidGroup=raidGroup, serverServiceState=serverServiceState, phionHotfixesEntry=phionHotfixesEntry, connectorName=connectorName, firewallSessions64=firewallSessions64, rate=rate, raidEventTime=raidEventTime, vpnName=vpnName, serviceGroups=serviceGroups, vpnTunnels=vpnTunnels, partitionFreeSpace=partitionFreeSpace, class1Pakets=class1Pakets, hwSensorType=hwSensorType, ripNeighborAddress=ripNeighborAddress, ospfNeighborId=ospfNeighborId, boxServicesEntry=boxServicesEntry, hwGroup=hwGroup, ServiceState=ServiceState, sessions=sessions, partitionName=partitionName, hwSensorValue=hwSensorValue, boxServiceName=boxServiceName, PYSNMP_MODULE_ID=phion, ospfGroup=ospfGroup, fwGroups=fwGroups, hwSensors=hwSensors, eventRepresentation=eventRepresentation, noDelayTotal=noDelayTotal, hwSensorName=hwSensorName, class3Drop=class3Drop, eventIDDescription=eventIDDescription, raidEventIndex=raidEventIndex, noDelayPakets=noDelayPakets, eventTrap=eventTrap, phionRelease=phionRelease, netGroups=netGroups, bgpNeighborsEntry=bgpNeighborsEntry, trafficshapeGroup=trafficshapeGroup, SensorType=SensorType, notificationGroup=notificationGroup, ripNeighbors=ripNeighbors, ospfNeighborInterface=ospfNeighborInterface, ripNeighborState=ripNeighborState, eventType=eventType, packetThroughput64=packetThroughput64, hwGroups=hwGroups, ospfNeighborStatus=ospfNeighborStatus, dataThroughput=dataThroughput, eventGroup=eventGroup, class2Total=class2Total, bgpNeighbors=bgpNeighbors, fwStats=fwStats, ospfNeighborAddress=ospfNeighborAddress, vpnTunnelsEntry=vpnTunnelsEntry, serverGroup=serverGroup, vpnState=vpnState, class1Total=class1Total, class2Pakets=class2Pakets, fwStatsEntry=fwStatsEntry, diskspaceGroup=diskspaceGroup, VpnStates=VpnStates, noDelayDrop=noDelayDrop, ripGroup=ripGroup, fwstatsGroup=fwstatsGroup, vpnUsers=vpnUsers, boxGroup=boxGroup, hwSensorsEntry=hwSensorsEntry, phion=phion, class3Pakets=class3Pakets, eventClassification=eventClassification, partitionUsedSpace=partitionUsedSpace, RaidEventSeverity=RaidEventSeverity, hotfixName=hotfixName, releaseGroup=releaseGroup, ospfNeighborsEntry=ospfNeighborsEntry, serverServiceName=serverServiceName, bgpGroup=bgpGroup, vpnGroup=vpnGroup, diskSpace=diskSpace, raidEventSev=raidEventSev, class3Total=class3Total, hotfixGroup=hotfixGroup, serverServices=serverServices, firmwareGroups=firmwareGroups)
