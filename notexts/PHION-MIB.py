...
Counter32, Counter64, enterprises, Gauge32, ObjectIdentity, Integer32, MibIdentifier, IpAddress, ModuleIdentity, Bits, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "enterprises", "Gauge32", "ObjectIdentity", "Integer32", "MibIdentifier", "IpAddress", "ModuleIdentity", "Bits", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "iso")
...
mibBuilder.exportSymbols("PHION-MIB", partitionUsedSpace=partitionUsedSpace, RaidEventSeverity=RaidEventSeverity, bgpNeighbors=bgpNeighbors, boxServicesEntry=boxServicesEntry, vpnName=vpnName, boxGroup=boxGroup, partitionName=partitionName, bgpGroup=bgpGroup, raidEventTime=raidEventTime, VpnStates=VpnStates, hwSensorType=hwSensorType, phionHotfixes=phionHotfixes, class3Total=class3Total, fwStats=fwStats, class2Pakets=class2Pakets, eventAlarmTime=eventAlarmTime, boxServiceState=boxServiceState, notificationGroup=notificationGroup, packetThroughput=packetThroughput, ospfNeighborId=ospfNeighborId, ripNeighborAddress=ripNeighborAddress, vpnTunnels=vpnTunnels, PYSNMP_MODULE_ID=phion, vpnState=vpnState, trafficShape=trafficShape, noDelayTotal=noDelayTotal, hotfixInstallTime=hotfixInstallTime, rate=rate, hotfixName=hotfixName, hwSensorsEntry=hwSensorsEntry, dataThroughput64=dataThroughput64, SensorType=SensorType, hwGroups=hwGroups, hotfixGroup=hotfixGroup, trafficShapeEntry=trafficShapeEntry, eventClassification=eventClassification, noDelayDrop=noDelayDrop, ospfNeighborAddress=ospfNeighborAddress, ospfNeighborStatus=ospfNeighborStatus, phionRelease=phionRelease, eventTrap=eventTrap, event=event, dataThroughput=dataThroughput, ripGroup=ripGroup, bgpNeighborState=bgpNeighborState, firewall=firewall, class2Total=class2Total, class2Drop=class2Drop, eventSeverity=eventSeverity, connectorName=connectorName, hwSensors=hwSensors, raidEventsEntry=raidEventsEntry, bgpNeighborAddress=bgpNeighborAddress, serverServices=serverServices, ripNeighborState=ripNeighborState, eventType=eventType, class1Drop=class1Drop, fwGroups=fwGroups, diskSpaceEntry=diskSpaceEntry, firewallSessions=firewallSessions, vpnusersGroup=vpnusersGroup, trafficshapeGroup=trafficshapeGroup, partitionMaxSpace=partitionMaxSpace, boxServices=boxServices, raidEventSev=raidEventSev, serviceGroups=serviceGroups, firewallSessions64=firewallSessions64, firmwareGroups=firmwareGroups, eventGroup=eventGroup, serverServiceState=serverServiceState, serverGroup=serverGroup, netGroups=netGroups, phionHotfixesEntry=phionHotfixesEntry, hwGroup=hwGroup, vpnUsers=vpnUsers, sessions=sessions, vpnGroup=vpnGroup, releaseGroup=releaseGroup, class3Pakets=class3Pakets, class1Total=class1Total, hwSensorName=hwSensorName, diskSpace=diskSpace, packetThroughput64=packetThroughput64, fwCompliance=fwCompliance, ospfNeighborsEntry=ospfNeighborsEntry, class3Drop=class3Drop, eventIDDescription=eventIDDescription, serverServicesEntry=serverServicesEntry, class1Pakets=class1Pakets, raidEventText=raidEventText, hwSensorValue=hwSensorValue, ripNeighbors=ripNeighbors, noDelayPakets=noDelayPakets, raidGroup=raidGroup, phion=phion, fwstatsGroup=fwstatsGroup, ospfGroup=ospfGroup, ripNeighborsEntry=ripNeighborsEntry, raidEventIndex=raidEventIndex, eventGroups=eventGroups, fwStatsEntry=fwStatsEntry, serverServiceName=serverServiceName, ServiceState=ServiceState, eventID=eventID, raidEvents=raidEvents, eventLayerDescription=eventLayerDescription, ospfNeighbors=ospfNeighbors, bgpNeighborsEntry=bgpNeighborsEntry, partitionUsedSpacePercent=partitionUsedSpacePercent, diskspaceGroup=diskspaceGroup, eventRepresentation=eventRepresentation, partitionFreeSpace=partitionFreeSpace, ospfNeighborInterface=ospfNeighborInterface, fwCompliances=fwCompliances, vpnTunnelsEntry=vpnTunnelsEntry, boxServiceName=boxServiceName)
