...
MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, enterprises, Unsigned32, NotificationType, ModuleIdentity, TimeTicks, Bits, ObjectIdentity, Integer32, Gauge32, iso, Counter64, Counter32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "enterprises", "Unsigned32", "NotificationType", "ModuleIdentity", "TimeTicks", "Bits", "ObjectIdentity", "Integer32", "Gauge32", "iso", "Counter64", "Counter32", "IpAddress")
...
mibBuilder.exportSymbols("PHION-MIB", ospfNeighborInterface=ospfNeighborInterface, ospfGroup=ospfGroup, boxGroup=boxGroup, connectorName=connectorName, serverServices=serverServices, vpnName=vpnName, class1Total=class1Total, trafficShape=trafficShape, fwStats=fwStats, eventRepresentation=eventRepresentation, hwSensorName=hwSensorName, phion=phion, ospfNeighborAddress=ospfNeighborAddress, PYSNMP_MODULE_ID=phion, SensorType=SensorType, vpnState=vpnState, bgpNeighbors=bgpNeighbors, noDelayTotal=noDelayTotal, event=event, hwSensorValue=hwSensorValue, fwStatsEntry=fwStatsEntry, bgpNeighborsEntry=bgpNeighborsEntry, dataThroughput=dataThroughput, ServiceState=ServiceState, bgpGroup=bgpGroup, diskSpace=diskSpace, boxServiceName=boxServiceName, hwSensorsEntry=hwSensorsEntry, eventGroup=eventGroup, trafficshapeGroup=trafficshapeGroup, packetThroughput64=packetThroughput64, firmwareGroups=firmwareGroups, class3Pakets=class3Pakets, eventIDDescription=eventIDDescription, bgpNeighborState=bgpNeighborState, class1Pakets=class1Pakets, boxServiceState=boxServiceState, vpnTunnels=vpnTunnels, raidEventSev=raidEventSev, class2Pakets=class2Pakets, class3Total=class3Total, eventGroups=eventGroups, rate=rate, eventID=eventID, serverServicesEntry=serverServicesEntry, noDelayPakets=noDelayPakets, eventLayerDescription=eventLayerDescription, class1Drop=class1Drop, boxServices=boxServices, ripNeighbors=ripNeighbors, netGroups=netGroups, vpnGroup=vpnGroup, vpnTunnelsEntry=vpnTunnelsEntry, fwGroups=fwGroups, ripGroup=ripGroup, trafficShapeEntry=trafficShapeEntry, fwCompliance=fwCompliance, diskSpaceEntry=diskSpaceEntry, firewallSessions=firewallSessions, vpnUsers=vpnUsers, phionHotfixesEntry=phionHotfixesEntry, class2Total=class2Total, ospfNeighborId=ospfNeighborId, VpnStates=VpnStates, hotfixName=hotfixName, partitionUsedSpace=partitionUsedSpace, fwCompliances=fwCompliances, ospfNeighborsEntry=ospfNeighborsEntry, dataThroughput64=dataThroughput64, hotfixGroup=hotfixGroup, eventTrap=eventTrap, partitionFreeSpace=partitionFreeSpace, diskspaceGroup=diskspaceGroup, serverServiceName=serverServiceName, serverGroup=serverGroup, class3Drop=class3Drop, partitionName=partitionName, serverServiceState=serverServiceState, eventAlarmTime=eventAlarmTime, hotfixInstallTime=hotfixInstallTime, raidEventIndex=raidEventIndex, bgpNeighborAddress=bgpNeighborAddress, noDelayDrop=noDelayDrop, raidEventText=raidEventText, firewallSessions64=firewallSessions64, hwSensorType=hwSensorType, hwGroups=hwGroups, raidGroup=raidGroup, ripNeighborAddress=ripNeighborAddress, raidEventsEntry=raidEventsEntry, RaidEventSeverity=RaidEventSeverity, hwGroup=hwGroup, ripNeighborState=ripNeighborState, vpnusersGroup=vpnusersGroup, eventClassification=eventClassification, releaseGroup=releaseGroup, sessions=sessions, partitionUsedSpacePercent=partitionUsedSpacePercent, phionRelease=phionRelease, raidEventTime=raidEventTime, hwSensors=hwSensors, partitionMaxSpace=partitionMaxSpace, class2Drop=class2Drop, raidEvents=raidEvents, serviceGroups=serviceGroups, phionHotfixes=phionHotfixes, eventSeverity=eventSeverity, firewall=firewall, boxServicesEntry=boxServicesEntry, ospfNeighbors=ospfNeighbors, ripNeighborsEntry=ripNeighborsEntry, ospfNeighborStatus=ospfNeighborStatus, fwstatsGroup=fwstatsGroup, notificationGroup=notificationGroup, eventType=eventType, packetThroughput=packetThroughput)
