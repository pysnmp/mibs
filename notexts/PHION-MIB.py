...
NotificationType, IpAddress, enterprises, Counter64, iso, Counter32, Bits, Gauge32, MibIdentifier, TimeTicks, ObjectIdentity, ModuleIdentity, Unsigned32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "enterprises", "Counter64", "iso", "Counter32", "Bits", "Gauge32", "MibIdentifier", "TimeTicks", "ObjectIdentity", "ModuleIdentity", "Unsigned32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("PHION-MIB", ServiceState=ServiceState, class1Drop=class1Drop, rate=rate, fwCompliances=fwCompliances, VpnStates=VpnStates, phionHotfixes=phionHotfixes, hotfixName=hotfixName, fwGroups=fwGroups, hwSensorName=hwSensorName, firewallSessions=firewallSessions, event=event, bgpNeighborsEntry=bgpNeighborsEntry, ripNeighbors=ripNeighbors, noDelayDrop=noDelayDrop, class2Total=class2Total, notificationGroup=notificationGroup, boxServicesEntry=boxServicesEntry, eventIDDescription=eventIDDescription, ospfNeighbors=ospfNeighbors, netGroups=netGroups, vpnName=vpnName, fwstatsGroup=fwstatsGroup, class2Pakets=class2Pakets, ospfNeighborInterface=ospfNeighborInterface, bgpNeighborState=bgpNeighborState, diskspaceGroup=diskspaceGroup, noDelayPakets=noDelayPakets, eventGroup=eventGroup, trafficShape=trafficShape, noDelayTotal=noDelayTotal, bgpGroup=bgpGroup, vpnGroup=vpnGroup, bgpNeighborAddress=bgpNeighborAddress, boxServiceState=boxServiceState, sessions=sessions, boxServiceName=boxServiceName, class3Drop=class3Drop, eventAlarmTime=eventAlarmTime, raidEventsEntry=raidEventsEntry, eventGroups=eventGroups, partitionFreeSpace=partitionFreeSpace, packetThroughput=packetThroughput, raidEvents=raidEvents, hwSensorType=hwSensorType, ospfNeighborStatus=ospfNeighborStatus, vpnTunnels=vpnTunnels, raidEventText=raidEventText, hotfixInstallTime=hotfixInstallTime, phion=phion, ripGroup=ripGroup, serverServices=serverServices, eventTrap=eventTrap, fwStats=fwStats, class2Drop=class2Drop, RaidEventSeverity=RaidEventSeverity, hwSensorsEntry=hwSensorsEntry, eventID=eventID, hwSensors=hwSensors, fwStatsEntry=fwStatsEntry, hwSensorValue=hwSensorValue, partitionUsedSpacePercent=partitionUsedSpacePercent, ospfGroup=ospfGroup, vpnusersGroup=vpnusersGroup, serverServicesEntry=serverServicesEntry, eventType=eventType, ripNeighborsEntry=ripNeighborsEntry, diskSpace=diskSpace, firmwareGroups=firmwareGroups, serverGroup=serverGroup, raidGroup=raidGroup, partitionMaxSpace=partitionMaxSpace, raidEventIndex=raidEventIndex, boxGroup=boxGroup, trafficshapeGroup=trafficshapeGroup, class1Pakets=class1Pakets, fwCompliance=fwCompliance, phionHotfixesEntry=phionHotfixesEntry, hotfixGroup=hotfixGroup, hwGroups=hwGroups, ospfNeighborId=ospfNeighborId, vpnTunnelsEntry=vpnTunnelsEntry, eventLayerDescription=eventLayerDescription, trafficShapeEntry=trafficShapeEntry, eventRepresentation=eventRepresentation, raidEventSev=raidEventSev, eventClassification=eventClassification, class3Total=class3Total, serverServiceState=serverServiceState, packetThroughput64=packetThroughput64, releaseGroup=releaseGroup, class1Total=class1Total, eventSeverity=eventSeverity, serviceGroups=serviceGroups, PYSNMP_MODULE_ID=phion, ripNeighborAddress=ripNeighborAddress, ospfNeighborsEntry=ospfNeighborsEntry, phionRelease=phionRelease, SensorType=SensorType, partitionName=partitionName, hwGroup=hwGroup, class3Pakets=class3Pakets, dataThroughput64=dataThroughput64, raidEventTime=raidEventTime, bgpNeighbors=bgpNeighbors, partitionUsedSpace=partitionUsedSpace, dataThroughput=dataThroughput, firewallSessions64=firewallSessions64, vpnUsers=vpnUsers, firewall=firewall, ospfNeighborAddress=ospfNeighborAddress, vpnState=vpnState, serverServiceName=serverServiceName, ripNeighborState=ripNeighborState, boxServices=boxServices, connectorName=connectorName, diskSpaceEntry=diskSpaceEntry)
