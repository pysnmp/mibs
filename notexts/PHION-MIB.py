...
ModuleIdentity, Integer32, Bits, enterprises, Counter32, TimeTicks, NotificationType, Gauge32, ObjectIdentity, IpAddress, Counter64, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "Bits", "enterprises", "Counter32", "TimeTicks", "NotificationType", "Gauge32", "ObjectIdentity", "IpAddress", "Counter64", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32")
...
mibBuilder.exportSymbols("PHION-MIB", vpnTunnelsEntry=vpnTunnelsEntry, diskspaceGroup=diskspaceGroup, hotfixGroup=hotfixGroup, boxGroup=boxGroup, ripNeighbors=ripNeighbors, RaidEventSeverity=RaidEventSeverity, serverServiceName=serverServiceName, diskSpace=diskSpace, bgpGroup=bgpGroup, fwStats=fwStats, eventRepresentation=eventRepresentation, fwGroups=fwGroups, eventID=eventID, eventLayerDescription=eventLayerDescription, eventGroups=eventGroups, ripGroup=ripGroup, partitionUsedSpacePercent=partitionUsedSpacePercent, class2Total=class2Total, serverGroup=serverGroup, hwSensorType=hwSensorType, noDelayDrop=noDelayDrop, firewall=firewall, serverServicesEntry=serverServicesEntry, vpnusersGroup=vpnusersGroup, phionHotfixesEntry=phionHotfixesEntry, eventType=eventType, trafficshapeGroup=trafficshapeGroup, bgpNeighbors=bgpNeighbors, bgpNeighborAddress=bgpNeighborAddress, dataThroughput64=dataThroughput64, boxServices=boxServices, ospfNeighborStatus=ospfNeighborStatus, trafficShape=trafficShape, ospfNeighborInterface=ospfNeighborInterface, partitionFreeSpace=partitionFreeSpace, vpnGroup=vpnGroup, VpnStates=VpnStates, eventIDDescription=eventIDDescription, raidEventText=raidEventText, class2Drop=class2Drop, ospfGroup=ospfGroup, vpnState=vpnState, notificationGroup=notificationGroup, hwGroups=hwGroups, phionHotfixes=phionHotfixes, class2Pakets=class2Pakets, packetThroughput64=packetThroughput64, eventGroup=eventGroup, fwStatsEntry=fwStatsEntry, hwGroup=hwGroup, noDelayTotal=noDelayTotal, class3Drop=class3Drop, eventTrap=eventTrap, PYSNMP_MODULE_ID=phion, phionRelease=phionRelease, raidEventTime=raidEventTime, trafficShapeEntry=trafficShapeEntry, hwSensorsEntry=hwSensorsEntry, hwSensorValue=hwSensorValue, hotfixInstallTime=hotfixInstallTime, raidEventsEntry=raidEventsEntry, SensorType=SensorType, hwSensors=hwSensors, fwstatsGroup=fwstatsGroup, boxServicesEntry=boxServicesEntry, releaseGroup=releaseGroup, raidEventSev=raidEventSev, connectorName=connectorName, sessions=sessions, eventSeverity=eventSeverity, eventClassification=eventClassification, hwSensorName=hwSensorName, rate=rate, ServiceState=ServiceState, ripNeighborAddress=ripNeighborAddress, dataThroughput=dataThroughput, vpnName=vpnName, hotfixName=hotfixName, firewallSessions64=firewallSessions64, fwCompliance=fwCompliance, ospfNeighborsEntry=ospfNeighborsEntry, serverServiceState=serverServiceState, raidEventIndex=raidEventIndex, boxServiceName=boxServiceName, ospfNeighbors=ospfNeighbors, packetThroughput=packetThroughput, boxServiceState=boxServiceState, partitionName=partitionName, partitionUsedSpace=partitionUsedSpace, firewallSessions=firewallSessions, noDelayPakets=noDelayPakets, vpnUsers=vpnUsers, class3Pakets=class3Pakets, bgpNeighborsEntry=bgpNeighborsEntry, ripNeighborState=ripNeighborState, firmwareGroups=firmwareGroups, phion=phion, diskSpaceEntry=diskSpaceEntry, vpnTunnels=vpnTunnels, serverServices=serverServices, netGroups=netGroups, raidEvents=raidEvents, eventAlarmTime=eventAlarmTime, class3Total=class3Total, ospfNeighborAddress=ospfNeighborAddress, class1Pakets=class1Pakets, ripNeighborsEntry=ripNeighborsEntry, partitionMaxSpace=partitionMaxSpace, fwCompliances=fwCompliances, bgpNeighborState=bgpNeighborState, class1Drop=class1Drop, serviceGroups=serviceGroups, class1Total=class1Total, ospfNeighborId=ospfNeighborId, event=event, raidGroup=raidGroup)
