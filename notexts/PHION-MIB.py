...
enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, iso, ObjectIdentity, Counter32, ModuleIdentity, Counter64, NotificationType, Integer32, MibIdentifier, Bits, IpAddress, TimeTicks, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "iso", "ObjectIdentity", "Counter32", "ModuleIdentity", "Counter64", "NotificationType", "Integer32", "MibIdentifier", "Bits", "IpAddress", "TimeTicks", "Unsigned32")
...
mibBuilder.exportSymbols("PHION-MIB", connectorName=connectorName, class3Drop=class3Drop, boxServicesEntry=boxServicesEntry, fwCompliance=fwCompliance, ripGroup=ripGroup, serverGroup=serverGroup, eventGroups=eventGroups, class3Pakets=class3Pakets, firewallSessions64=firewallSessions64, partitionName=partitionName, serverServicesEntry=serverServicesEntry, serverServices=serverServices, raidEventIndex=raidEventIndex, eventLayerDescription=eventLayerDescription, diskspaceGroup=diskspaceGroup, netGroups=netGroups, bgpNeighborState=bgpNeighborState, dataThroughput=dataThroughput, partitionUsedSpace=partitionUsedSpace, fwCompliances=fwCompliances, diskSpaceEntry=diskSpaceEntry, fwStats=fwStats, ospfNeighborsEntry=ospfNeighborsEntry, raidEventText=raidEventText, eventClassification=eventClassification, vpnGroup=vpnGroup, ospfNeighbors=ospfNeighbors, hwGroups=hwGroups, hotfixGroup=hotfixGroup, ServiceState=ServiceState, VpnStates=VpnStates, serverServiceState=serverServiceState, vpnState=vpnState, hotfixName=hotfixName, ospfNeighborStatus=ospfNeighborStatus, ripNeighborAddress=ripNeighborAddress, trafficShape=trafficShape, noDelayPakets=noDelayPakets, class2Total=class2Total, hotfixInstallTime=hotfixInstallTime, partitionFreeSpace=partitionFreeSpace, ospfGroup=ospfGroup, serviceGroups=serviceGroups, raidEventsEntry=raidEventsEntry, raidEventSev=raidEventSev, boxServices=boxServices, vpnUsers=vpnUsers, ospfNeighborInterface=ospfNeighborInterface, hwSensorValue=hwSensorValue, phion=phion, firmwareGroups=firmwareGroups, packetThroughput=packetThroughput, trafficShapeEntry=trafficShapeEntry, vpnTunnelsEntry=vpnTunnelsEntry, fwGroups=fwGroups, class3Total=class3Total, class1Total=class1Total, firewall=firewall, hwSensors=hwSensors, hwSensorName=hwSensorName, vpnusersGroup=vpnusersGroup, ripNeighborState=ripNeighborState, event=event, trafficshapeGroup=trafficshapeGroup, vpnName=vpnName, eventTrap=eventTrap, noDelayTotal=noDelayTotal, sessions=sessions, raidEventTime=raidEventTime, partitionUsedSpacePercent=partitionUsedSpacePercent, eventRepresentation=eventRepresentation, packetThroughput64=packetThroughput64, boxServiceName=boxServiceName, bgpGroup=bgpGroup, phionHotfixesEntry=phionHotfixesEntry, class2Drop=class2Drop, class2Pakets=class2Pakets, hwSensorsEntry=hwSensorsEntry, rate=rate, phionHotfixes=phionHotfixes, bgpNeighbors=bgpNeighbors, PYSNMP_MODULE_ID=phion, eventID=eventID, vpnTunnels=vpnTunnels, ospfNeighborId=ospfNeighborId, class1Pakets=class1Pakets, ripNeighborsEntry=ripNeighborsEntry, ospfNeighborAddress=ospfNeighborAddress, SensorType=SensorType, eventGroup=eventGroup, RaidEventSeverity=RaidEventSeverity, ripNeighbors=ripNeighbors, boxServiceState=boxServiceState, releaseGroup=releaseGroup, hwGroup=hwGroup, raidGroup=raidGroup, phionRelease=phionRelease, fwStatsEntry=fwStatsEntry, boxGroup=boxGroup, notificationGroup=notificationGroup, firewallSessions=firewallSessions, dataThroughput64=dataThroughput64, diskSpace=diskSpace, eventType=eventType, hwSensorType=hwSensorType, eventIDDescription=eventIDDescription, class1Drop=class1Drop, bgpNeighborAddress=bgpNeighborAddress, eventSeverity=eventSeverity, noDelayDrop=noDelayDrop, bgpNeighborsEntry=bgpNeighborsEntry, raidEvents=raidEvents, eventAlarmTime=eventAlarmTime, partitionMaxSpace=partitionMaxSpace, serverServiceName=serverServiceName, fwstatsGroup=fwstatsGroup)
