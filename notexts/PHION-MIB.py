...
TimeTicks, Gauge32, MibIdentifier, enterprises, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, Unsigned32, ModuleIdentity, iso, ObjectIdentity, NotificationType, Integer32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Gauge32", "MibIdentifier", "enterprises", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "Unsigned32", "ModuleIdentity", "iso", "ObjectIdentity", "NotificationType", "Integer32", "IpAddress")
...
mibBuilder.exportSymbols("PHION-MIB", raidEventSev=raidEventSev, class2Drop=class2Drop, diskspaceGroup=diskspaceGroup, raidEventTime=raidEventTime, firewallSessions64=firewallSessions64, partitionUsedSpace=partitionUsedSpace, noDelayTotal=noDelayTotal, hotfixGroup=hotfixGroup, ripNeighborsEntry=ripNeighborsEntry, eventAlarmTime=eventAlarmTime, eventGroups=eventGroups, netGroups=netGroups, eventIDDescription=eventIDDescription, vpnGroup=vpnGroup, class3Pakets=class3Pakets, SensorType=SensorType, vpnusersGroup=vpnusersGroup, boxGroup=boxGroup, serverServices=serverServices, ripNeighborAddress=ripNeighborAddress, dataThroughput=dataThroughput, partitionName=partitionName, noDelayDrop=noDelayDrop, class1Total=class1Total, fwCompliances=fwCompliances, fwGroups=fwGroups, partitionUsedSpacePercent=partitionUsedSpacePercent, rate=rate, boxServicesEntry=boxServicesEntry, class3Total=class3Total, vpnTunnelsEntry=vpnTunnelsEntry, class2Pakets=class2Pakets, serverServiceName=serverServiceName, class1Pakets=class1Pakets, eventSeverity=eventSeverity, hwSensorType=hwSensorType, raidEventText=raidEventText, connectorName=connectorName, fwCompliance=fwCompliance, raidEventIndex=raidEventIndex, boxServiceState=boxServiceState, releaseGroup=releaseGroup, phion=phion, ospfGroup=ospfGroup, eventType=eventType, ospfNeighborId=ospfNeighborId, hotfixName=hotfixName, eventLayerDescription=eventLayerDescription, ospfNeighborStatus=ospfNeighborStatus, serverGroup=serverGroup, bgpGroup=bgpGroup, partitionMaxSpace=partitionMaxSpace, ospfNeighborAddress=ospfNeighborAddress, event=event, VpnStates=VpnStates, bgpNeighborsEntry=bgpNeighborsEntry, sessions=sessions, notificationGroup=notificationGroup, eventRepresentation=eventRepresentation, serverServicesEntry=serverServicesEntry, trafficShapeEntry=trafficShapeEntry, phionHotfixesEntry=phionHotfixesEntry, packetThroughput64=packetThroughput64, firewallSessions=firewallSessions, eventGroup=eventGroup, phionHotfixes=phionHotfixes, trafficShape=trafficShape, trafficshapeGroup=trafficshapeGroup, hwSensorsEntry=hwSensorsEntry, dataThroughput64=dataThroughput64, ripNeighbors=ripNeighbors, fwstatsGroup=fwstatsGroup, hwGroups=hwGroups, hwSensors=hwSensors, fwStatsEntry=fwStatsEntry, raidEventsEntry=raidEventsEntry, vpnTunnels=vpnTunnels, fwStats=fwStats, eventID=eventID, hotfixInstallTime=hotfixInstallTime, serviceGroups=serviceGroups, class1Drop=class1Drop, eventClassification=eventClassification, partitionFreeSpace=partitionFreeSpace, raidEvents=raidEvents, ripGroup=ripGroup, noDelayPakets=noDelayPakets, diskSpaceEntry=diskSpaceEntry, vpnState=vpnState, ospfNeighborsEntry=ospfNeighborsEntry, class2Total=class2Total, vpnName=vpnName, ServiceState=ServiceState, vpnUsers=vpnUsers, serverServiceState=serverServiceState, hwSensorValue=hwSensorValue, bgpNeighborAddress=bgpNeighborAddress, bgpNeighborState=bgpNeighborState, RaidEventSeverity=RaidEventSeverity, ospfNeighbors=ospfNeighbors, diskSpace=diskSpace, firewall=firewall, eventTrap=eventTrap, PYSNMP_MODULE_ID=phion, ripNeighborState=ripNeighborState, class3Drop=class3Drop, packetThroughput=packetThroughput, hwSensorName=hwSensorName, boxServices=boxServices, firmwareGroups=firmwareGroups, raidGroup=raidGroup, boxServiceName=boxServiceName, phionRelease=phionRelease, ospfNeighborInterface=ospfNeighborInterface, hwGroup=hwGroup, bgpNeighbors=bgpNeighbors)
