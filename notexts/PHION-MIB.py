...
Bits, NotificationType, iso, Counter32, Gauge32, Counter64, IpAddress, MibIdentifier, ObjectIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Unsigned32, Integer32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "iso", "Counter32", "Gauge32", "Counter64", "IpAddress", "MibIdentifier", "ObjectIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Unsigned32", "Integer32", "enterprises")
...
mibBuilder.exportSymbols("PHION-MIB", eventRepresentation=eventRepresentation, event=event, vpnState=vpnState, fwstatsGroup=fwstatsGroup, phionHotfixesEntry=phionHotfixesEntry, vpnName=vpnName, diskSpace=diskSpace, raidEventSev=raidEventSev, bgpNeighbors=bgpNeighbors, ospfNeighborId=ospfNeighborId, partitionUsedSpacePercent=partitionUsedSpacePercent, bgpNeighborAddress=bgpNeighborAddress, ripNeighborAddress=ripNeighborAddress, partitionUsedSpace=partitionUsedSpace, eventTrap=eventTrap, netGroups=netGroups, ospfNeighborInterface=ospfNeighborInterface, diskspaceGroup=diskspaceGroup, raidGroup=raidGroup, trafficShapeEntry=trafficShapeEntry, boxServices=boxServices, partitionMaxSpace=partitionMaxSpace, hotfixGroup=hotfixGroup, fwCompliances=fwCompliances, boxGroup=boxGroup, ospfNeighbors=ospfNeighbors, serverServicesEntry=serverServicesEntry, hotfixInstallTime=hotfixInstallTime, connectorName=connectorName, firewallSessions=firewallSessions, bgpGroup=bgpGroup, raidEventIndex=raidEventIndex, fwStats=fwStats, serverServices=serverServices, firewallSessions64=firewallSessions64, eventGroup=eventGroup, class1Pakets=class1Pakets, raidEvents=raidEvents, hwSensors=hwSensors, boxServicesEntry=boxServicesEntry, eventType=eventType, eventGroups=eventGroups, eventIDDescription=eventIDDescription, serverServiceName=serverServiceName, eventSeverity=eventSeverity, noDelayDrop=noDelayDrop, ospfNeighborsEntry=ospfNeighborsEntry, class3Total=class3Total, eventAlarmTime=eventAlarmTime, class2Pakets=class2Pakets, class1Drop=class1Drop, hwSensorValue=hwSensorValue, serverServiceState=serverServiceState, boxServiceName=boxServiceName, vpnTunnels=vpnTunnels, bgpNeighborsEntry=bgpNeighborsEntry, vpnGroup=vpnGroup, SensorType=SensorType, eventClassification=eventClassification, diskSpaceEntry=diskSpaceEntry, partitionName=partitionName, ospfGroup=ospfGroup, class2Drop=class2Drop, vpnUsers=vpnUsers, rate=rate, hwGroups=hwGroups, eventID=eventID, trafficshapeGroup=trafficshapeGroup, dataThroughput64=dataThroughput64, packetThroughput=packetThroughput, serviceGroups=serviceGroups, raidEventsEntry=raidEventsEntry, fwCompliance=fwCompliance, hwGroup=hwGroup, ospfNeighborStatus=ospfNeighborStatus, trafficShape=trafficShape, phion=phion, sessions=sessions, ospfNeighborAddress=ospfNeighborAddress, ripGroup=ripGroup, raidEventTime=raidEventTime, vpnTunnelsEntry=vpnTunnelsEntry, fwStatsEntry=fwStatsEntry, hotfixName=hotfixName, RaidEventSeverity=RaidEventSeverity, class2Total=class2Total, class3Drop=class3Drop, class1Total=class1Total, hwSensorType=hwSensorType, hwSensorsEntry=hwSensorsEntry, ripNeighborsEntry=ripNeighborsEntry, phionHotfixes=phionHotfixes, ripNeighborState=ripNeighborState, packetThroughput64=packetThroughput64, releaseGroup=releaseGroup, ripNeighbors=ripNeighbors, noDelayPakets=noDelayPakets, fwGroups=fwGroups, dataThroughput=dataThroughput, eventLayerDescription=eventLayerDescription, class3Pakets=class3Pakets, partitionFreeSpace=partitionFreeSpace, boxServiceState=boxServiceState, PYSNMP_MODULE_ID=phion, hwSensorName=hwSensorName, serverGroup=serverGroup, firewall=firewall, notificationGroup=notificationGroup, VpnStates=VpnStates, ServiceState=ServiceState, bgpNeighborState=bgpNeighborState, phionRelease=phionRelease, firmwareGroups=firmwareGroups, noDelayTotal=noDelayTotal, vpnusersGroup=vpnusersGroup, raidEventText=raidEventText)
