...
Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Gauge32, MibIdentifier, enterprises, TimeTicks, NotificationType, Counter64, Bits, Counter32, ObjectIdentity, Unsigned32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Gauge32", "MibIdentifier", "enterprises", "TimeTicks", "NotificationType", "Counter64", "Bits", "Counter32", "ObjectIdentity", "Unsigned32", "IpAddress")
...
mibBuilder.exportSymbols("PHION-MIB", noDelayDrop=noDelayDrop, diskSpaceEntry=diskSpaceEntry, phionHotfixesEntry=phionHotfixesEntry, firewallSessions64=firewallSessions64, raidEventsEntry=raidEventsEntry, phionRelease=phionRelease, notificationGroup=notificationGroup, SensorType=SensorType, serverServicesEntry=serverServicesEntry, netGroups=netGroups, vpnGroup=vpnGroup, eventGroup=eventGroup, boxServices=boxServices, firewall=firewall, eventTrap=eventTrap, sessions=sessions, raidEventSev=raidEventSev, hwSensorValue=hwSensorValue, phionHotfixes=phionHotfixes, packetThroughput64=packetThroughput64, VpnStates=VpnStates, diskspaceGroup=diskspaceGroup, hwGroups=hwGroups, ospfNeighborId=ospfNeighborId, class1Pakets=class1Pakets, class2Total=class2Total, class3Drop=class3Drop, vpnTunnelsEntry=vpnTunnelsEntry, diskSpace=diskSpace, ospfGroup=ospfGroup, dataThroughput64=dataThroughput64, class2Drop=class2Drop, bgpGroup=bgpGroup, ripGroup=ripGroup, fwCompliances=fwCompliances, ripNeighbors=ripNeighbors, vpnUsers=vpnUsers, ripNeighborState=ripNeighborState, ospfNeighborInterface=ospfNeighborInterface, raidEventTime=raidEventTime, trafficShape=trafficShape, eventAlarmTime=eventAlarmTime, fwStats=fwStats, firmwareGroups=firmwareGroups, releaseGroup=releaseGroup, serverServiceName=serverServiceName, fwstatsGroup=fwstatsGroup, ospfNeighborStatus=ospfNeighborStatus, bgpNeighborAddress=bgpNeighborAddress, PYSNMP_MODULE_ID=phion, partitionName=partitionName, partitionMaxSpace=partitionMaxSpace, fwStatsEntry=fwStatsEntry, eventClassification=eventClassification, ospfNeighborAddress=ospfNeighborAddress, hotfixName=hotfixName, RaidEventSeverity=RaidEventSeverity, hotfixGroup=hotfixGroup, bgpNeighborsEntry=bgpNeighborsEntry, ripNeighborsEntry=ripNeighborsEntry, hwSensorType=hwSensorType, ripNeighborAddress=ripNeighborAddress, trafficShapeEntry=trafficShapeEntry, eventIDDescription=eventIDDescription, partitionFreeSpace=partitionFreeSpace, phion=phion, serviceGroups=serviceGroups, serverServices=serverServices, fwCompliance=fwCompliance, serverGroup=serverGroup, class1Drop=class1Drop, firewallSessions=firewallSessions, raidGroup=raidGroup, ospfNeighbors=ospfNeighbors, hwSensorName=hwSensorName, packetThroughput=packetThroughput, event=event, ServiceState=ServiceState, trafficshapeGroup=trafficshapeGroup, class2Pakets=class2Pakets, partitionUsedSpacePercent=partitionUsedSpacePercent, fwGroups=fwGroups, partitionUsedSpace=partitionUsedSpace, boxServiceName=boxServiceName, vpnusersGroup=vpnusersGroup, eventLayerDescription=eventLayerDescription, raidEventIndex=raidEventIndex, vpnTunnels=vpnTunnels, serverServiceState=serverServiceState, dataThroughput=dataThroughput, eventType=eventType, hwSensors=hwSensors, hotfixInstallTime=hotfixInstallTime, bgpNeighbors=bgpNeighbors, eventID=eventID, class1Total=class1Total, rate=rate, raidEvents=raidEvents, vpnState=vpnState, noDelayTotal=noDelayTotal, eventRepresentation=eventRepresentation, class3Pakets=class3Pakets, noDelayPakets=noDelayPakets, hwGroup=hwGroup, eventGroups=eventGroups, boxGroup=boxGroup, connectorName=connectorName, class3Total=class3Total, hwSensorsEntry=hwSensorsEntry, ospfNeighborsEntry=ospfNeighborsEntry, vpnName=vpnName, boxServicesEntry=boxServicesEntry, eventSeverity=eventSeverity, bgpNeighborState=bgpNeighborState, raidEventText=raidEventText, boxServiceState=boxServiceState)
