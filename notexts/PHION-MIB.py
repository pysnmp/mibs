...
MibIdentifier, Bits, Counter32, ObjectIdentity, Unsigned32, NotificationType, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, iso, Gauge32, ModuleIdentity, Counter64, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Bits", "Counter32", "ObjectIdentity", "Unsigned32", "NotificationType", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "iso", "Gauge32", "ModuleIdentity", "Counter64", "IpAddress", "Integer32")
...
mibBuilder.exportSymbols("PHION-MIB", partitionName=partitionName, ospfNeighborAddress=ospfNeighborAddress, fwCompliances=fwCompliances, fwstatsGroup=fwstatsGroup, class2Pakets=class2Pakets, rate=rate, packetThroughput64=packetThroughput64, eventRepresentation=eventRepresentation, serverServiceName=serverServiceName, phionHotfixesEntry=phionHotfixesEntry, ospfNeighbors=ospfNeighbors, class3Pakets=class3Pakets, noDelayDrop=noDelayDrop, eventClassification=eventClassification, hwSensorName=hwSensorName, SensorType=SensorType, eventLayerDescription=eventLayerDescription, hwSensorValue=hwSensorValue, eventGroups=eventGroups, PYSNMP_MODULE_ID=phion, boxServices=boxServices, class1Total=class1Total, eventID=eventID, event=event, hotfixName=hotfixName, partitionUsedSpace=partitionUsedSpace, phion=phion, ripGroup=ripGroup, bgpNeighborAddress=bgpNeighborAddress, eventTrap=eventTrap, ripNeighborAddress=ripNeighborAddress, eventType=eventType, noDelayPakets=noDelayPakets, trafficShapeEntry=trafficShapeEntry, hwSensorType=hwSensorType, netGroups=netGroups, eventIDDescription=eventIDDescription, ripNeighbors=ripNeighbors, class2Drop=class2Drop, ospfNeighborId=ospfNeighborId, diskSpaceEntry=diskSpaceEntry, class3Total=class3Total, class2Total=class2Total, ospfGroup=ospfGroup, diskspaceGroup=diskspaceGroup, fwStats=fwStats, firmwareGroups=firmwareGroups, partitionMaxSpace=partitionMaxSpace, class1Pakets=class1Pakets, raidEventsEntry=raidEventsEntry, class1Drop=class1Drop, boxServiceState=boxServiceState, hwGroups=hwGroups, class3Drop=class3Drop, VpnStates=VpnStates, trafficshapeGroup=trafficshapeGroup, raidEvents=raidEvents, serverServiceState=serverServiceState, fwCompliance=fwCompliance, hotfixInstallTime=hotfixInstallTime, raidEventTime=raidEventTime, phionRelease=phionRelease, hwGroup=hwGroup, noDelayTotal=noDelayTotal, dataThroughput64=dataThroughput64, eventSeverity=eventSeverity, serverServicesEntry=serverServicesEntry, raidEventSev=raidEventSev, vpnName=vpnName, vpnGroup=vpnGroup, vpnUsers=vpnUsers, partitionFreeSpace=partitionFreeSpace, ospfNeighborInterface=ospfNeighborInterface, eventGroup=eventGroup, ServiceState=ServiceState, sessions=sessions, ripNeighborState=ripNeighborState, connectorName=connectorName, releaseGroup=releaseGroup, vpnusersGroup=vpnusersGroup, raidEventText=raidEventText, hwSensors=hwSensors, fwStatsEntry=fwStatsEntry, vpnTunnelsEntry=vpnTunnelsEntry, packetThroughput=packetThroughput, firewall=firewall, dataThroughput=dataThroughput, fwGroups=fwGroups, bgpNeighbors=bgpNeighbors, notificationGroup=notificationGroup, boxServicesEntry=boxServicesEntry, hotfixGroup=hotfixGroup, vpnTunnels=vpnTunnels, bgpGroup=bgpGroup, firewallSessions64=firewallSessions64, partitionUsedSpacePercent=partitionUsedSpacePercent, raidGroup=raidGroup, ospfNeighborStatus=ospfNeighborStatus, serverServices=serverServices, serviceGroups=serviceGroups, ospfNeighborsEntry=ospfNeighborsEntry, serverGroup=serverGroup, diskSpace=diskSpace, eventAlarmTime=eventAlarmTime, firewallSessions=firewallSessions, trafficShape=trafficShape, boxServiceName=boxServiceName, RaidEventSeverity=RaidEventSeverity, boxGroup=boxGroup, ripNeighborsEntry=ripNeighborsEntry, vpnState=vpnState, phionHotfixes=phionHotfixes, hwSensorsEntry=hwSensorsEntry, bgpNeighborState=bgpNeighborState, bgpNeighborsEntry=bgpNeighborsEntry, raidEventIndex=raidEventIndex)
