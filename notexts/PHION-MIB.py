...
ObjectIdentity, IpAddress, MibIdentifier, NotificationType, Bits, Unsigned32, Gauge32, enterprises, Integer32, Counter64, iso, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "MibIdentifier", "NotificationType", "Bits", "Unsigned32", "Gauge32", "enterprises", "Integer32", "Counter64", "iso", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity")
...
mibBuilder.exportSymbols("PHION-MIB", PYSNMP_MODULE_ID=phion, eventClassification=eventClassification, class2Pakets=class2Pakets, serverServiceName=serverServiceName, ripGroup=ripGroup, partitionMaxSpace=partitionMaxSpace, ripNeighborsEntry=ripNeighborsEntry, fwCompliance=fwCompliance, fwGroups=fwGroups, phionHotfixes=phionHotfixes, ripNeighborState=ripNeighborState, boxServiceState=boxServiceState, class1Total=class1Total, partitionName=partitionName, partitionUsedSpacePercent=partitionUsedSpacePercent, packetThroughput=packetThroughput, trafficShape=trafficShape, boxGroup=boxGroup, hwGroup=hwGroup, eventSeverity=eventSeverity, ripNeighbors=ripNeighbors, trafficshapeGroup=trafficshapeGroup, sessions=sessions, SensorType=SensorType, serviceGroups=serviceGroups, notificationGroup=notificationGroup, raidEventsEntry=raidEventsEntry, noDelayDrop=noDelayDrop, partitionFreeSpace=partitionFreeSpace, trafficShapeEntry=trafficShapeEntry, hwGroups=hwGroups, raidGroup=raidGroup, ripNeighborAddress=ripNeighborAddress, diskSpace=diskSpace, eventAlarmTime=eventAlarmTime, serverServiceState=serverServiceState, ospfGroup=ospfGroup, ospfNeighborAddress=ospfNeighborAddress, hwSensorName=hwSensorName, serverServices=serverServices, partitionUsedSpace=partitionUsedSpace, bgpGroup=bgpGroup, vpnGroup=vpnGroup, class2Total=class2Total, eventRepresentation=eventRepresentation, raidEventText=raidEventText, dataThroughput64=dataThroughput64, noDelayPakets=noDelayPakets, eventLayerDescription=eventLayerDescription, class3Pakets=class3Pakets, vpnusersGroup=vpnusersGroup, eventTrap=eventTrap, dataThroughput=dataThroughput, boxServiceName=boxServiceName, phionRelease=phionRelease, phion=phion, boxServicesEntry=boxServicesEntry, raidEvents=raidEvents, eventIDDescription=eventIDDescription, firmwareGroups=firmwareGroups, hwSensorType=hwSensorType, hotfixGroup=hotfixGroup, diskspaceGroup=diskspaceGroup, boxServices=boxServices, ospfNeighborStatus=ospfNeighborStatus, class3Total=class3Total, serverServicesEntry=serverServicesEntry, class3Drop=class3Drop, eventGroup=eventGroup, releaseGroup=releaseGroup, phionHotfixesEntry=phionHotfixesEntry, eventGroups=eventGroups, diskSpaceEntry=diskSpaceEntry, fwStats=fwStats, firewallSessions64=firewallSessions64, fwstatsGroup=fwstatsGroup, vpnTunnelsEntry=vpnTunnelsEntry, ospfNeighborId=ospfNeighborId, eventID=eventID, class1Pakets=class1Pakets, vpnState=vpnState, netGroups=netGroups, bgpNeighborState=bgpNeighborState, firewallSessions=firewallSessions, vpnName=vpnName, connectorName=connectorName, rate=rate, hwSensorsEntry=hwSensorsEntry, VpnStates=VpnStates, serverGroup=serverGroup, ospfNeighborsEntry=ospfNeighborsEntry, vpnUsers=vpnUsers, raidEventIndex=raidEventIndex, ServiceState=ServiceState, hotfixInstallTime=hotfixInstallTime, RaidEventSeverity=RaidEventSeverity, raidEventTime=raidEventTime, ospfNeighborInterface=ospfNeighborInterface, noDelayTotal=noDelayTotal, raidEventSev=raidEventSev, hotfixName=hotfixName, bgpNeighbors=bgpNeighbors, fwStatsEntry=fwStatsEntry, eventType=eventType, bgpNeighborAddress=bgpNeighborAddress, class2Drop=class2Drop, fwCompliances=fwCompliances, event=event, vpnTunnels=vpnTunnels, firewall=firewall, class1Drop=class1Drop, hwSensors=hwSensors, hwSensorValue=hwSensorValue, ospfNeighbors=ospfNeighbors, packetThroughput64=packetThroughput64, bgpNeighborsEntry=bgpNeighborsEntry)
