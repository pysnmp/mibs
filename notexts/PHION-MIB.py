...
mibBuilder.exportSymbols("PHION-MIB", raidGroup=raidGroup, bgpNeighborsEntry=bgpNeighborsEntry, trafficShape=trafficShape, noDelayTotal=noDelayTotal, ospfNeighbors=ospfNeighbors, hwSensorValue=hwSensorValue, serverServiceName=serverServiceName, raidEventTime=raidEventTime, eventIDDescription=eventIDDescription, class2Drop=class2Drop, class1Drop=class1Drop, dataThroughput64=dataThroughput64, boxServiceState=boxServiceState, ospfNeighborAddress=ospfNeighborAddress, eventClassification=eventClassification, boxServiceName=boxServiceName, ospfNeighborId=ospfNeighborId, hwGroups=hwGroups, partitionFreeSpace=partitionFreeSpace, eventLayerDescription=eventLayerDescription, netGroups=netGroups, PYSNMP_MODULE_ID=phion, phionHotfixesEntry=phionHotfixesEntry, packetThroughput64=packetThroughput64, partitionUsedSpacePercent=partitionUsedSpacePercent, boxServices=boxServices, rate=rate, ServiceState=ServiceState, raidEventText=raidEventText, fwCompliance=fwCompliance, phionRelease=phionRelease, eventGroups=eventGroups, trafficShapeEntry=trafficShapeEntry, serverServicesEntry=serverServicesEntry, ospfNeighborsEntry=ospfNeighborsEntry, serverServices=serverServices, ripGroup=ripGroup, eventGroup=eventGroup, hwGroup=hwGroup, sessions=sessions, fwGroups=fwGroups, class2Total=class2Total, serverGroup=serverGroup, partitionMaxSpace=partitionMaxSpace, class3Total=class3Total, vpnName=vpnName, trafficshapeGroup=trafficshapeGroup, event=event, class1Total=class1Total, vpnGroup=vpnGroup, boxServicesEntry=boxServicesEntry, partitionName=partitionName, ospfNeighborStatus=ospfNeighborStatus, ripNeighborsEntry=ripNeighborsEntry, fwStats=fwStats, class2Pakets=class2Pakets, raidEventsEntry=raidEventsEntry, connectorName=connectorName, class3Drop=class3Drop, raidEventSev=raidEventSev, boxGroup=boxGroup, phionHotfixes=phionHotfixes, eventTrap=eventTrap, firewallSessions=firewallSessions, fwCompliances=fwCompliances, hwSensorType=hwSensorType, class1Pakets=class1Pakets, bgpNeighbors=bgpNeighbors, vpnTunnels=vpnTunnels, vpnUsers=vpnUsers, eventAlarmTime=eventAlarmTime, dataThroughput=dataThroughput, raidEventIndex=raidEventIndex, hwSensors=hwSensors, bgpGroup=bgpGroup, fwStatsEntry=fwStatsEntry, noDelayDrop=noDelayDrop, eventSeverity=eventSeverity, hotfixName=hotfixName, firewall=firewall, releaseGroup=releaseGroup, serviceGroups=serviceGroups, hotfixInstallTime=hotfixInstallTime, raidEvents=raidEvents, notificationGroup=notificationGroup, vpnState=vpnState, ripNeighbors=ripNeighbors, noDelayPakets=noDelayPakets, partitionUsedSpace=partitionUsedSpace, vpnTunnelsEntry=vpnTunnelsEntry, VpnStates=VpnStates, serverServiceState=serverServiceState, class3Pakets=class3Pakets, ospfNeighborInterface=ospfNeighborInterface, diskspaceGroup=diskspaceGroup, hotfixGroup=hotfixGroup, eventID=eventID, eventType=eventType, phion=phion, hwSensorName=hwSensorName, firewallSessions64=firewallSessions64, hwSensorsEntry=hwSensorsEntry, ospfGroup=ospfGroup, diskSpace=diskSpace, SensorType=SensorType, diskSpaceEntry=diskSpaceEntry, eventRepresentation=eventRepresentation, ripNeighborAddress=ripNeighborAddress, ripNeighborState=ripNeighborState, packetThroughput=packetThroughput, bgpNeighborAddress=bgpNeighborAddress, vpnusersGroup=vpnusersGroup, RaidEventSeverity=RaidEventSeverity, fwstatsGroup=fwstatsGroup, bgpNeighborState=bgpNeighborState, firmwareGroups=firmwareGroups)
