...
Gauge32, ObjectIdentity, Counter32, ModuleIdentity, Counter64, Bits, MibIdentifier, NotificationType, iso, enterprises, IpAddress, TimeTicks, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "Counter32", "ModuleIdentity", "Counter64", "Bits", "MibIdentifier", "NotificationType", "iso", "enterprises", "IpAddress", "TimeTicks", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32")
...
mibBuilder.exportSymbols("PHION-MIB", hotfixInstallTime=hotfixInstallTime, firmwareGroups=firmwareGroups, diskSpace=diskSpace, hotfixGroup=hotfixGroup, fwStatsEntry=fwStatsEntry, fwGroups=fwGroups, vpnTunnels=vpnTunnels, boxGroup=boxGroup, serverServicesEntry=serverServicesEntry, eventTrap=eventTrap, packetThroughput=packetThroughput, ripNeighborsEntry=ripNeighborsEntry, connectorName=connectorName, eventLayerDescription=eventLayerDescription, raidEventIndex=raidEventIndex, eventRepresentation=eventRepresentation, packetThroughput64=packetThroughput64, diskSpaceEntry=diskSpaceEntry, bgpGroup=bgpGroup, hwSensors=hwSensors, class3Pakets=class3Pakets, class3Total=class3Total, phion=phion, PYSNMP_MODULE_ID=phion, boxServicesEntry=boxServicesEntry, trafficShapeEntry=trafficShapeEntry, firewallSessions=firewallSessions, raidEventSev=raidEventSev, eventID=eventID, partitionUsedSpace=partitionUsedSpace, bgpNeighborState=bgpNeighborState, ospfGroup=ospfGroup, phionRelease=phionRelease, diskspaceGroup=diskspaceGroup, partitionName=partitionName, vpnName=vpnName, sessions=sessions, vpnGroup=vpnGroup, class3Drop=class3Drop, phionHotfixes=phionHotfixes, bgpNeighborAddress=bgpNeighborAddress, noDelayDrop=noDelayDrop, SensorType=SensorType, serverServices=serverServices, raidEvents=raidEvents, noDelayPakets=noDelayPakets, class1Total=class1Total, ospfNeighborId=ospfNeighborId, ripNeighbors=ripNeighbors, fwStats=fwStats, raidGroup=raidGroup, boxServiceState=boxServiceState, notificationGroup=notificationGroup, class1Pakets=class1Pakets, raidEventText=raidEventText, fwCompliance=fwCompliance, trafficShape=trafficShape, eventGroup=eventGroup, ripGroup=ripGroup, dataThroughput=dataThroughput, ospfNeighbors=ospfNeighbors, eventGroups=eventGroups, serviceGroups=serviceGroups, event=event, eventAlarmTime=eventAlarmTime, eventClassification=eventClassification, bgpNeighborsEntry=bgpNeighborsEntry, ServiceState=ServiceState, releaseGroup=releaseGroup, ripNeighborAddress=ripNeighborAddress, partitionFreeSpace=partitionFreeSpace, firewallSessions64=firewallSessions64, fwCompliances=fwCompliances, firewall=firewall, vpnUsers=vpnUsers, partitionMaxSpace=partitionMaxSpace, serverServiceState=serverServiceState, serverServiceName=serverServiceName, hwSensorsEntry=hwSensorsEntry, vpnusersGroup=vpnusersGroup, raidEventsEntry=raidEventsEntry, netGroups=netGroups, hotfixName=hotfixName, class2Pakets=class2Pakets, vpnTunnelsEntry=vpnTunnelsEntry, hwGroups=hwGroups, hwSensorName=hwSensorName, dataThroughput64=dataThroughput64, bgpNeighbors=bgpNeighbors, class1Drop=class1Drop, VpnStates=VpnStates, ospfNeighborInterface=ospfNeighborInterface, vpnState=vpnState, phionHotfixesEntry=phionHotfixesEntry, rate=rate, class2Total=class2Total, RaidEventSeverity=RaidEventSeverity, hwGroup=hwGroup, raidEventTime=raidEventTime, trafficshapeGroup=trafficshapeGroup, ospfNeighborAddress=ospfNeighborAddress, eventSeverity=eventSeverity, ospfNeighborStatus=ospfNeighborStatus, ospfNeighborsEntry=ospfNeighborsEntry, partitionUsedSpacePercent=partitionUsedSpacePercent, fwstatsGroup=fwstatsGroup, boxServices=boxServices, hwSensorType=hwSensorType, serverGroup=serverGroup, hwSensorValue=hwSensorValue, ripNeighborState=ripNeighborState, class2Drop=class2Drop, eventType=eventType, boxServiceName=boxServiceName, noDelayTotal=noDelayTotal, eventIDDescription=eventIDDescription)
