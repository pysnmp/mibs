...
Counter32, enterprises, IpAddress, Counter64, TimeTicks, ModuleIdentity, ObjectIdentity, Unsigned32, Bits, NotificationType, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "enterprises", "IpAddress", "Counter64", "TimeTicks", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "Bits", "NotificationType", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier")
...
mibBuilder.exportSymbols("PHION-MIB", bgpGroup=bgpGroup, packetThroughput=packetThroughput, partitionMaxSpace=partitionMaxSpace, vpnGroup=vpnGroup, eventSeverity=eventSeverity, serverServiceState=serverServiceState, class2Pakets=class2Pakets, hwSensors=hwSensors, boxServiceState=boxServiceState, raidEventsEntry=raidEventsEntry, firmwareGroups=firmwareGroups, bgpNeighborsEntry=bgpNeighborsEntry, fwCompliances=fwCompliances, ospfNeighborStatus=ospfNeighborStatus, bgpNeighborState=bgpNeighborState, firewallSessions64=firewallSessions64, class1Pakets=class1Pakets, ServiceState=ServiceState, phionRelease=phionRelease, hwGroups=hwGroups, class1Drop=class1Drop, sessions=sessions, class3Drop=class3Drop, vpnUsers=vpnUsers, vpnTunnelsEntry=vpnTunnelsEntry, hwSensorsEntry=hwSensorsEntry, hwGroup=hwGroup, hotfixName=hotfixName, notificationGroup=notificationGroup, dataThroughput64=dataThroughput64, raidEventTime=raidEventTime, ripNeighborState=ripNeighborState, ospfNeighborInterface=ospfNeighborInterface, vpnusersGroup=vpnusersGroup, event=event, boxServices=boxServices, connectorName=connectorName, eventAlarmTime=eventAlarmTime, ospfNeighborsEntry=ospfNeighborsEntry, eventTrap=eventTrap, bgpNeighborAddress=bgpNeighborAddress, hotfixInstallTime=hotfixInstallTime, ospfNeighborAddress=ospfNeighborAddress, class2Total=class2Total, ospfGroup=ospfGroup, eventRepresentation=eventRepresentation, RaidEventSeverity=RaidEventSeverity, rate=rate, partitionFreeSpace=partitionFreeSpace, hwSensorName=hwSensorName, boxGroup=boxGroup, class2Drop=class2Drop, ripNeighborAddress=ripNeighborAddress, phionHotfixes=phionHotfixes, eventClassification=eventClassification, diskspaceGroup=diskspaceGroup, hotfixGroup=hotfixGroup, packetThroughput64=packetThroughput64, eventLayerDescription=eventLayerDescription, firewall=firewall, fwCompliance=fwCompliance, eventGroup=eventGroup, class3Pakets=class3Pakets, partitionUsedSpace=partitionUsedSpace, partitionName=partitionName, ripNeighbors=ripNeighbors, raidGroup=raidGroup, trafficShape=trafficShape, noDelayTotal=noDelayTotal, eventType=eventType, hwSensorType=hwSensorType, eventIDDescription=eventIDDescription, class1Total=class1Total, vpnState=vpnState, eventID=eventID, ripGroup=ripGroup, fwStats=fwStats, diskSpace=diskSpace, fwStatsEntry=fwStatsEntry, raidEventIndex=raidEventIndex, phion=phion, serverServiceName=serverServiceName, trafficShapeEntry=trafficShapeEntry, raidEventText=raidEventText, releaseGroup=releaseGroup, raidEvents=raidEvents, serverGroup=serverGroup, serviceGroups=serviceGroups, ospfNeighborId=ospfNeighborId, ospfNeighbors=ospfNeighbors, VpnStates=VpnStates, noDelayDrop=noDelayDrop, bgpNeighbors=bgpNeighbors, serverServicesEntry=serverServicesEntry, trafficshapeGroup=trafficshapeGroup, partitionUsedSpacePercent=partitionUsedSpacePercent, firewallSessions=firewallSessions, noDelayPakets=noDelayPakets, ripNeighborsEntry=ripNeighborsEntry, serverServices=serverServices, class3Total=class3Total, diskSpaceEntry=diskSpaceEntry, dataThroughput=dataThroughput, raidEventSev=raidEventSev, netGroups=netGroups, boxServiceName=boxServiceName, vpnTunnels=vpnTunnels, fwstatsGroup=fwstatsGroup, boxServicesEntry=boxServicesEntry, vpnName=vpnName, eventGroups=eventGroups, fwGroups=fwGroups, phionHotfixesEntry=phionHotfixesEntry, SensorType=SensorType, hwSensorValue=hwSensorValue, PYSNMP_MODULE_ID=phion)
