...
NotificationType, enterprises, TimeTicks, Counter32, ObjectIdentity, IpAddress, MibIdentifier, Counter64, Unsigned32, iso, Integer32, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "enterprises", "TimeTicks", "Counter32", "ObjectIdentity", "IpAddress", "MibIdentifier", "Counter64", "Unsigned32", "iso", "Integer32", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("PHION-MIB", sessions=sessions, phionRelease=phionRelease, diskSpace=diskSpace, eventGroups=eventGroups, class2Pakets=class2Pakets, firewallSessions=firewallSessions, notificationGroup=notificationGroup, ServiceState=ServiceState, boxServiceName=boxServiceName, raidEventsEntry=raidEventsEntry, serverServices=serverServices, ospfNeighborAddress=ospfNeighborAddress, class3Pakets=class3Pakets, event=event, bgpNeighborsEntry=bgpNeighborsEntry, ripNeighborsEntry=ripNeighborsEntry, vpnState=vpnState, VpnStates=VpnStates, vpnName=vpnName, fwGroups=fwGroups, partitionUsedSpace=partitionUsedSpace, netGroups=netGroups, packetThroughput=packetThroughput, ripNeighbors=ripNeighbors, firewall=firewall, dataThroughput=dataThroughput, hwSensors=hwSensors, noDelayTotal=noDelayTotal, eventGroup=eventGroup, vpnGroup=vpnGroup, fwCompliance=fwCompliance, hotfixName=hotfixName, hotfixGroup=hotfixGroup, raidEventTime=raidEventTime, eventSeverity=eventSeverity, trafficShapeEntry=trafficShapeEntry, ripGroup=ripGroup, vpnUsers=vpnUsers, boxServicesEntry=boxServicesEntry, fwstatsGroup=fwstatsGroup, phionHotfixesEntry=phionHotfixesEntry, diskSpaceEntry=diskSpaceEntry, serverGroup=serverGroup, partitionUsedSpacePercent=partitionUsedSpacePercent, fwCompliances=fwCompliances, partitionName=partitionName, class2Total=class2Total, serviceGroups=serviceGroups, raidEvents=raidEvents, trafficshapeGroup=trafficshapeGroup, ripNeighborAddress=ripNeighborAddress, eventID=eventID, class3Drop=class3Drop, class1Pakets=class1Pakets, eventAlarmTime=eventAlarmTime, hwGroups=hwGroups, noDelayPakets=noDelayPakets, eventTrap=eventTrap, raidEventSev=raidEventSev, ripNeighborState=ripNeighborState, hwSensorValue=hwSensorValue, dataThroughput64=dataThroughput64, ospfNeighborInterface=ospfNeighborInterface, ospfNeighbors=ospfNeighbors, ospfNeighborsEntry=ospfNeighborsEntry, bgpNeighborAddress=bgpNeighborAddress, noDelayDrop=noDelayDrop, vpnTunnelsEntry=vpnTunnelsEntry, vpnTunnels=vpnTunnels, boxServiceState=boxServiceState, bgpNeighborState=bgpNeighborState, hwGroup=hwGroup, diskspaceGroup=diskspaceGroup, ospfNeighborStatus=ospfNeighborStatus, phion=phion, fwStatsEntry=fwStatsEntry, serverServicesEntry=serverServicesEntry, rate=rate, PYSNMP_MODULE_ID=phion, hwSensorName=hwSensorName, serverServiceState=serverServiceState, raidGroup=raidGroup, firewallSessions64=firewallSessions64, vpnusersGroup=vpnusersGroup, class3Total=class3Total, packetThroughput64=packetThroughput64, connectorName=connectorName, RaidEventSeverity=RaidEventSeverity, fwStats=fwStats, SensorType=SensorType, trafficShape=trafficShape, class1Drop=class1Drop, eventType=eventType, eventRepresentation=eventRepresentation, bgpGroup=bgpGroup, hwSensorsEntry=hwSensorsEntry, ospfGroup=ospfGroup, phionHotfixes=phionHotfixes, eventIDDescription=eventIDDescription, partitionMaxSpace=partitionMaxSpace, class1Total=class1Total, hwSensorType=hwSensorType, firmwareGroups=firmwareGroups, boxGroup=boxGroup, raidEventIndex=raidEventIndex, partitionFreeSpace=partitionFreeSpace, eventLayerDescription=eventLayerDescription, class2Drop=class2Drop, bgpNeighbors=bgpNeighbors, eventClassification=eventClassification, boxServices=boxServices, serverServiceName=serverServiceName, releaseGroup=releaseGroup, raidEventText=raidEventText, ospfNeighborId=ospfNeighborId, hotfixInstallTime=hotfixInstallTime)
