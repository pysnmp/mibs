...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ModuleIdentity, NotificationType, Gauge32, MibIdentifier, Counter64, Counter32, IpAddress, enterprises, Unsigned32, iso, TimeTicks, Integer32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ModuleIdentity", "NotificationType", "Gauge32", "MibIdentifier", "Counter64", "Counter32", "IpAddress", "enterprises", "Unsigned32", "iso", "TimeTicks", "Integer32", "ObjectIdentity")
...
mibBuilder.exportSymbols("PHION-MIB", eventLayerDescription=eventLayerDescription, firmwareGroups=firmwareGroups, vpnTunnelsEntry=vpnTunnelsEntry, trafficShape=trafficShape, class3Drop=class3Drop, hotfixGroup=hotfixGroup, fwGroups=fwGroups, ospfGroup=ospfGroup, firewallSessions64=firewallSessions64, class3Total=class3Total, eventRepresentation=eventRepresentation, noDelayPakets=noDelayPakets, ospfNeighborAddress=ospfNeighborAddress, ServiceState=ServiceState, boxGroup=boxGroup, firewallSessions=firewallSessions, vpnState=vpnState, fwStats=fwStats, partitionMaxSpace=partitionMaxSpace, boxServices=boxServices, vpnName=vpnName, class3Pakets=class3Pakets, bgpNeighborsEntry=bgpNeighborsEntry, partitionName=partitionName, hwSensorName=hwSensorName, ospfNeighborsEntry=ospfNeighborsEntry, raidEvents=raidEvents, ospfNeighborInterface=ospfNeighborInterface, boxServicesEntry=boxServicesEntry, bgpNeighbors=bgpNeighbors, boxServiceName=boxServiceName, eventClassification=eventClassification, hwGroups=hwGroups, trafficshapeGroup=trafficshapeGroup, packetThroughput=packetThroughput, noDelayDrop=noDelayDrop, VpnStates=VpnStates, hwSensorsEntry=hwSensorsEntry, eventGroups=eventGroups, partitionFreeSpace=partitionFreeSpace, eventGroup=eventGroup, noDelayTotal=noDelayTotal, phionRelease=phionRelease, raidEventIndex=raidEventIndex, rate=rate, fwCompliances=fwCompliances, hotfixInstallTime=hotfixInstallTime, diskspaceGroup=diskspaceGroup, serverGroup=serverGroup, eventType=eventType, class1Drop=class1Drop, connectorName=connectorName, sessions=sessions, hwSensorValue=hwSensorValue, firewall=firewall, trafficShapeEntry=trafficShapeEntry, ospfNeighborStatus=ospfNeighborStatus, diskSpaceEntry=diskSpaceEntry, notificationGroup=notificationGroup, vpnusersGroup=vpnusersGroup, eventTrap=eventTrap, ospfNeighbors=ospfNeighbors, eventID=eventID, class1Total=class1Total, ripGroup=ripGroup, ripNeighbors=ripNeighbors, fwCompliance=fwCompliance, fwstatsGroup=fwstatsGroup, serverServiceState=serverServiceState, ripNeighborState=ripNeighborState, raidEventText=raidEventText, phionHotfixes=phionHotfixes, bgpNeighborAddress=bgpNeighborAddress, partitionUsedSpace=partitionUsedSpace, RaidEventSeverity=RaidEventSeverity, ripNeighborAddress=ripNeighborAddress, dataThroughput=dataThroughput, eventIDDescription=eventIDDescription, hotfixName=hotfixName, class1Pakets=class1Pakets, serviceGroups=serviceGroups, hwGroup=hwGroup, class2Total=class2Total, raidEventSev=raidEventSev, partitionUsedSpacePercent=partitionUsedSpacePercent, ripNeighborsEntry=ripNeighborsEntry, packetThroughput64=packetThroughput64, bgpNeighborState=bgpNeighborState, raidEventsEntry=raidEventsEntry, vpnTunnels=vpnTunnels, phionHotfixesEntry=phionHotfixesEntry, raidEventTime=raidEventTime, SensorType=SensorType, hwSensorType=hwSensorType, vpnGroup=vpnGroup, raidGroup=raidGroup, serverServicesEntry=serverServicesEntry, fwStatsEntry=fwStatsEntry, bgpGroup=bgpGroup, diskSpace=diskSpace, netGroups=netGroups, phion=phion, eventSeverity=eventSeverity, class2Pakets=class2Pakets, serverServices=serverServices, PYSNMP_MODULE_ID=phion, releaseGroup=releaseGroup, boxServiceState=boxServiceState, ospfNeighborId=ospfNeighborId, class2Drop=class2Drop, eventAlarmTime=eventAlarmTime, serverServiceName=serverServiceName, hwSensors=hwSensors, vpnUsers=vpnUsers, dataThroughput64=dataThroughput64, event=event)
