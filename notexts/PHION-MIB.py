...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, Bits, enterprises, iso, Counter32, Unsigned32, IpAddress, MibIdentifier, NotificationType, Integer32, ModuleIdentity, Counter64, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "Bits", "enterprises", "iso", "Counter32", "Unsigned32", "IpAddress", "MibIdentifier", "NotificationType", "Integer32", "ModuleIdentity", "Counter64", "ObjectIdentity")
...
mibBuilder.exportSymbols("PHION-MIB", eventLayerDescription=eventLayerDescription, trafficShape=trafficShape, bgpGroup=bgpGroup, ripNeighborsEntry=ripNeighborsEntry, diskspaceGroup=diskspaceGroup, ospfNeighborAddress=ospfNeighborAddress, boxServiceState=boxServiceState, ripNeighborState=ripNeighborState, packetThroughput=packetThroughput, ripGroup=ripGroup, netGroups=netGroups, eventClassification=eventClassification, eventIDDescription=eventIDDescription, eventGroup=eventGroup, firewall=firewall, eventID=eventID, class2Total=class2Total, hwSensorType=hwSensorType, class2Pakets=class2Pakets, noDelayPakets=noDelayPakets, class2Drop=class2Drop, hwSensorValue=hwSensorValue, serverServicesEntry=serverServicesEntry, noDelayTotal=noDelayTotal, ospfNeighborInterface=ospfNeighborInterface, trafficShapeEntry=trafficShapeEntry, eventGroups=eventGroups, serverGroup=serverGroup, hwSensorsEntry=hwSensorsEntry, rate=rate, RaidEventSeverity=RaidEventSeverity, fwCompliance=fwCompliance, raidEventIndex=raidEventIndex, raidEventText=raidEventText, serverServices=serverServices, partitionName=partitionName, SensorType=SensorType, ServiceState=ServiceState, ripNeighbors=ripNeighbors, event=event, VpnStates=VpnStates, hwGroup=hwGroup, serverServiceName=serverServiceName, vpnState=vpnState, hwGroups=hwGroups, ospfNeighbors=ospfNeighbors, fwStats=fwStats, eventRepresentation=eventRepresentation, class1Pakets=class1Pakets, firmwareGroups=firmwareGroups, dataThroughput64=dataThroughput64, vpnGroup=vpnGroup, raidGroup=raidGroup, vpnusersGroup=vpnusersGroup, class3Pakets=class3Pakets, partitionMaxSpace=partitionMaxSpace, partitionUsedSpace=partitionUsedSpace, boxServices=boxServices, class3Drop=class3Drop, bgpNeighbors=bgpNeighbors, vpnTunnels=vpnTunnels, ospfGroup=ospfGroup, serverServiceState=serverServiceState, PYSNMP_MODULE_ID=phion, hotfixGroup=hotfixGroup, vpnName=vpnName, partitionUsedSpacePercent=partitionUsedSpacePercent, eventSeverity=eventSeverity, bgpNeighborState=bgpNeighborState, noDelayDrop=noDelayDrop, hwSensorName=hwSensorName, vpnTunnelsEntry=vpnTunnelsEntry, connectorName=connectorName, phionHotfixes=phionHotfixes, ospfNeighborsEntry=ospfNeighborsEntry, partitionFreeSpace=partitionFreeSpace, dataThroughput=dataThroughput, class3Total=class3Total, bgpNeighborsEntry=bgpNeighborsEntry, packetThroughput64=packetThroughput64, boxServicesEntry=boxServicesEntry, firewallSessions=firewallSessions, phion=phion, ospfNeighborStatus=ospfNeighborStatus, phionRelease=phionRelease, bgpNeighborAddress=bgpNeighborAddress, hotfixInstallTime=hotfixInstallTime, fwStatsEntry=fwStatsEntry, boxGroup=boxGroup, hotfixName=hotfixName, sessions=sessions, fwGroups=fwGroups, hwSensors=hwSensors, diskSpaceEntry=diskSpaceEntry, serviceGroups=serviceGroups, class1Total=class1Total, eventAlarmTime=eventAlarmTime, phionHotfixesEntry=phionHotfixesEntry, class1Drop=class1Drop, releaseGroup=releaseGroup, raidEvents=raidEvents, ripNeighborAddress=ripNeighborAddress, trafficshapeGroup=trafficshapeGroup, boxServiceName=boxServiceName, ospfNeighborId=ospfNeighborId, firewallSessions64=firewallSessions64, eventTrap=eventTrap, fwstatsGroup=fwstatsGroup, diskSpace=diskSpace, vpnUsers=vpnUsers, notificationGroup=notificationGroup, raidEventSev=raidEventSev, raidEventTime=raidEventTime, eventType=eventType, fwCompliances=fwCompliances, raidEventsEntry=raidEventsEntry)
