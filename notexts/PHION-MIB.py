...
MibIdentifier, NotificationType, ModuleIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32, iso, Unsigned32, TimeTicks, Counter32, ObjectIdentity, IpAddress, Counter64, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "ModuleIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32", "iso", "Unsigned32", "TimeTicks", "Counter32", "ObjectIdentity", "IpAddress", "Counter64", "enterprises")
...
mibBuilder.exportSymbols("PHION-MIB", eventIDDescription=eventIDDescription, boxServiceState=boxServiceState, serverServicesEntry=serverServicesEntry, noDelayPakets=noDelayPakets, ospfNeighborId=ospfNeighborId, fwstatsGroup=fwstatsGroup, serverServiceName=serverServiceName, vpnState=vpnState, bgpNeighborAddress=bgpNeighborAddress, raidEventTime=raidEventTime, phionRelease=phionRelease, bgpNeighbors=bgpNeighbors, serverServices=serverServices, firmwareGroups=firmwareGroups, hwSensorType=hwSensorType, raidEventsEntry=raidEventsEntry, eventID=eventID, trafficshapeGroup=trafficshapeGroup, hwSensorName=hwSensorName, SensorType=SensorType, hwSensorValue=hwSensorValue, ospfNeighborStatus=ospfNeighborStatus, hwGroups=hwGroups, ripGroup=ripGroup, dataThroughput=dataThroughput, hotfixGroup=hotfixGroup, ServiceState=ServiceState, eventAlarmTime=eventAlarmTime, VpnStates=VpnStates, bgpNeighborState=bgpNeighborState, phion=phion, fwStats=fwStats, ospfNeighborInterface=ospfNeighborInterface, hotfixName=hotfixName, vpnGroup=vpnGroup, trafficShapeEntry=trafficShapeEntry, phionHotfixes=phionHotfixes, firewall=firewall, boxServiceName=boxServiceName, class2Drop=class2Drop, ripNeighbors=ripNeighbors, raidGroup=raidGroup, class1Drop=class1Drop, ospfNeighborsEntry=ospfNeighborsEntry, partitionUsedSpace=partitionUsedSpace, eventTrap=eventTrap, boxGroup=boxGroup, class1Total=class1Total, eventGroup=eventGroup, partitionUsedSpacePercent=partitionUsedSpacePercent, class3Total=class3Total, vpnUsers=vpnUsers, serverGroup=serverGroup, partitionMaxSpace=partitionMaxSpace, phionHotfixesEntry=phionHotfixesEntry, packetThroughput=packetThroughput, partitionName=partitionName, PYSNMP_MODULE_ID=phion, diskSpaceEntry=diskSpaceEntry, eventRepresentation=eventRepresentation, bgpGroup=bgpGroup, ospfGroup=ospfGroup, eventClassification=eventClassification, raidEventText=raidEventText, vpnTunnelsEntry=vpnTunnelsEntry, boxServices=boxServices, fwStatsEntry=fwStatsEntry, hwGroup=hwGroup, event=event, releaseGroup=releaseGroup, vpnName=vpnName, serviceGroups=serviceGroups, partitionFreeSpace=partitionFreeSpace, fwGroups=fwGroups, eventGroups=eventGroups, hwSensors=hwSensors, eventLayerDescription=eventLayerDescription, vpnTunnels=vpnTunnels, class3Pakets=class3Pakets, ospfNeighbors=ospfNeighbors, rate=rate, raidEventIndex=raidEventIndex, firewallSessions64=firewallSessions64, hwSensorsEntry=hwSensorsEntry, noDelayDrop=noDelayDrop, diskspaceGroup=diskspaceGroup, bgpNeighborsEntry=bgpNeighborsEntry, ospfNeighborAddress=ospfNeighborAddress, sessions=sessions, eventType=eventType, RaidEventSeverity=RaidEventSeverity, vpnusersGroup=vpnusersGroup, boxServicesEntry=boxServicesEntry, netGroups=netGroups, packetThroughput64=packetThroughput64, hotfixInstallTime=hotfixInstallTime, class2Pakets=class2Pakets, dataThroughput64=dataThroughput64, class3Drop=class3Drop, fwCompliances=fwCompliances, diskSpace=diskSpace, noDelayTotal=noDelayTotal, ripNeighborsEntry=ripNeighborsEntry, ripNeighborAddress=ripNeighborAddress, raidEventSev=raidEventSev, eventSeverity=eventSeverity, raidEvents=raidEvents, fwCompliance=fwCompliance, class1Pakets=class1Pakets, serverServiceState=serverServiceState, class2Total=class2Total, trafficShape=trafficShape, ripNeighborState=ripNeighborState, connectorName=connectorName, firewallSessions=firewallSessions, notificationGroup=notificationGroup)
