...
mibBuilder.exportSymbols("PHION-MIB", fwGroups=fwGroups, serverServiceName=serverServiceName, ripNeighborState=ripNeighborState, hotfixInstallTime=hotfixInstallTime, ServiceState=ServiceState, trafficshapeGroup=trafficshapeGroup, hwGroups=hwGroups, rate=rate, partitionMaxSpace=partitionMaxSpace, hwSensorValue=hwSensorValue, raidEvents=raidEvents, packetThroughput64=packetThroughput64, boxGroup=boxGroup, hotfixGroup=hotfixGroup, ripNeighborsEntry=ripNeighborsEntry, class3Total=class3Total, bgpNeighborsEntry=bgpNeighborsEntry, vpnusersGroup=vpnusersGroup, trafficShapeEntry=trafficShapeEntry, serviceGroups=serviceGroups, class3Pakets=class3Pakets, diskspaceGroup=diskspaceGroup, noDelayPakets=noDelayPakets, eventTrap=eventTrap, netGroups=netGroups, vpnState=vpnState, eventClassification=eventClassification, notificationGroup=notificationGroup, ospfNeighborStatus=ospfNeighborStatus, hwSensors=hwSensors, trafficShape=trafficShape, bgpNeighborAddress=bgpNeighborAddress, partitionName=partitionName, ospfNeighborInterface=ospfNeighborInterface, vpnUsers=vpnUsers, hwGroup=hwGroup, bgpNeighborState=bgpNeighborState, raidEventIndex=raidEventIndex, raidEventSev=raidEventSev, fwstatsGroup=fwstatsGroup, hwSensorType=hwSensorType, raidGroup=raidGroup, class1Total=class1Total, fwStats=fwStats, class1Drop=class1Drop, dataThroughput=dataThroughput, class1Pakets=class1Pakets, vpnGroup=vpnGroup, eventAlarmTime=eventAlarmTime, ospfNeighborsEntry=ospfNeighborsEntry, class2Total=class2Total, sessions=sessions, partitionUsedSpace=partitionUsedSpace, phionHotfixesEntry=phionHotfixesEntry, ripGroup=ripGroup, noDelayTotal=noDelayTotal, connectorName=connectorName, diskSpaceEntry=diskSpaceEntry, fwCompliances=fwCompliances, boxServices=boxServices, releaseGroup=releaseGroup, serverServicesEntry=serverServicesEntry, class3Drop=class3Drop, ripNeighborAddress=ripNeighborAddress, eventLayerDescription=eventLayerDescription, eventGroup=eventGroup, firewall=firewall, ospfNeighbors=ospfNeighbors, firewallSessions=firewallSessions, vpnName=vpnName, bgpGroup=bgpGroup, serverServices=serverServices, raidEventText=raidEventText, phion=phion, diskSpace=diskSpace, firmwareGroups=firmwareGroups, noDelayDrop=noDelayDrop, eventIDDescription=eventIDDescription, hwSensorName=hwSensorName, bgpNeighbors=bgpNeighbors, event=event, class2Pakets=class2Pakets, fwCompliance=fwCompliance, fwStatsEntry=fwStatsEntry, ospfGroup=ospfGroup, phionHotfixes=phionHotfixes, SensorType=SensorType, hotfixName=hotfixName, ripNeighbors=ripNeighbors, hwSensorsEntry=hwSensorsEntry, ospfNeighborId=ospfNeighborId, partitionFreeSpace=partitionFreeSpace, VpnStates=VpnStates, eventType=eventType, raidEventTime=raidEventTime, eventRepresentation=eventRepresentation, PYSNMP_MODULE_ID=phion, eventID=eventID, serverGroup=serverGroup, eventGroups=eventGroups, boxServiceName=boxServiceName, partitionUsedSpacePercent=partitionUsedSpacePercent, boxServiceState=boxServiceState, ospfNeighborAddress=ospfNeighborAddress, serverServiceState=serverServiceState, phionRelease=phionRelease, dataThroughput64=dataThroughput64, class2Drop=class2Drop, eventSeverity=eventSeverity, RaidEventSeverity=RaidEventSeverity, raidEventsEntry=raidEventsEntry, packetThroughput=packetThroughput, vpnTunnels=vpnTunnels, boxServicesEntry=boxServicesEntry, firewallSessions64=firewallSessions64, vpnTunnelsEntry=vpnTunnelsEntry)
