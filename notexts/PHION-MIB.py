...
mibBuilder.exportSymbols("PHION-MIB", class1Drop=class1Drop, serverGroup=serverGroup, bgpNeighborAddress=bgpNeighborAddress, class2Drop=class2Drop, boxServiceName=boxServiceName, firewallSessions64=firewallSessions64, netGroups=netGroups, partitionUsedSpace=partitionUsedSpace, eventRepresentation=eventRepresentation, hwGroup=hwGroup, ripGroup=ripGroup, eventAlarmTime=eventAlarmTime, raidEventText=raidEventText, class3Total=class3Total, trafficShape=trafficShape, boxServicesEntry=boxServicesEntry, fwCompliance=fwCompliance, class3Pakets=class3Pakets, partitionName=partitionName, raidEventIndex=raidEventIndex, class1Total=class1Total, hotfixName=hotfixName, packetThroughput=packetThroughput, event=event, firmwareGroups=firmwareGroups, SensorType=SensorType, boxGroup=boxGroup, rate=rate, class2Total=class2Total, hwGroups=hwGroups, class3Drop=class3Drop, noDelayDrop=noDelayDrop, eventClassification=eventClassification, serverServiceState=serverServiceState, phion=phion, dataThroughput64=dataThroughput64, vpnGroup=vpnGroup, raidEventSev=raidEventSev, eventSeverity=eventSeverity, ripNeighbors=ripNeighbors, diskSpace=diskSpace, hwSensors=hwSensors, eventGroup=eventGroup, fwStatsEntry=fwStatsEntry, fwGroups=fwGroups, hwSensorName=hwSensorName, hotfixInstallTime=hotfixInstallTime, bgpGroup=bgpGroup, phionHotfixes=phionHotfixes, hwSensorType=hwSensorType, fwCompliances=fwCompliances, partitionMaxSpace=partitionMaxSpace, RaidEventSeverity=RaidEventSeverity, ripNeighborsEntry=ripNeighborsEntry, hwSensorsEntry=hwSensorsEntry, vpnTunnelsEntry=vpnTunnelsEntry, ospfNeighborAddress=ospfNeighborAddress, firewallSessions=firewallSessions, bgpNeighborState=bgpNeighborState, serviceGroups=serviceGroups, eventType=eventType, packetThroughput64=packetThroughput64, connectorName=connectorName, PYSNMP_MODULE_ID=phion, class2Pakets=class2Pakets, vpnState=vpnState, eventID=eventID, sessions=sessions, boxServiceState=boxServiceState, raidGroup=raidGroup, fwStats=fwStats, class1Pakets=class1Pakets, firewall=firewall, raidEventsEntry=raidEventsEntry, ospfNeighborInterface=ospfNeighborInterface, ripNeighborState=ripNeighborState, ospfNeighborStatus=ospfNeighborStatus, notificationGroup=notificationGroup, raidEventTime=raidEventTime, phionHotfixesEntry=phionHotfixesEntry, eventIDDescription=eventIDDescription, phionRelease=phionRelease, bgpNeighborsEntry=bgpNeighborsEntry, dataThroughput=dataThroughput, ospfGroup=ospfGroup, diskspaceGroup=diskspaceGroup, VpnStates=VpnStates, vpnName=vpnName, noDelayPakets=noDelayPakets, bgpNeighbors=bgpNeighbors, raidEvents=raidEvents, ServiceState=ServiceState, serverServiceName=serverServiceName, ripNeighborAddress=ripNeighborAddress, diskSpaceEntry=diskSpaceEntry, vpnusersGroup=vpnusersGroup, noDelayTotal=noDelayTotal, eventLayerDescription=eventLayerDescription, ospfNeighborId=ospfNeighborId, eventGroups=eventGroups, trafficShapeEntry=trafficShapeEntry, boxServices=boxServices, ospfNeighborsEntry=ospfNeighborsEntry, ospfNeighbors=ospfNeighbors, serverServices=serverServices, hotfixGroup=hotfixGroup, partitionUsedSpacePercent=partitionUsedSpacePercent, partitionFreeSpace=partitionFreeSpace, vpnTunnels=vpnTunnels, fwstatsGroup=fwstatsGroup, releaseGroup=releaseGroup, vpnUsers=vpnUsers, eventTrap=eventTrap, serverServicesEntry=serverServicesEntry, hwSensorValue=hwSensorValue, trafficshapeGroup=trafficshapeGroup)
