...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, MibIdentifier, ModuleIdentity, Counter64, NotificationType, enterprises, iso, Integer32, TimeTicks, Gauge32, ObjectIdentity, Bits, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "MibIdentifier", "ModuleIdentity", "Counter64", "NotificationType", "enterprises", "iso", "Integer32", "TimeTicks", "Gauge32", "ObjectIdentity", "Bits", "Unsigned32")
...
mibBuilder.exportSymbols("PHION-MIB", trafficShapeEntry=trafficShapeEntry, packetThroughput=packetThroughput, eventGroups=eventGroups, serverServices=serverServices, class2Total=class2Total, fwGroups=fwGroups, hwSensors=hwSensors, phionRelease=phionRelease, ripGroup=ripGroup, partitionUsedSpace=partitionUsedSpace, diskSpaceEntry=diskSpaceEntry, hwSensorType=hwSensorType, ospfGroup=ospfGroup, fwStatsEntry=fwStatsEntry, serviceGroups=serviceGroups, ripNeighborsEntry=ripNeighborsEntry, notificationGroup=notificationGroup, dataThroughput64=dataThroughput64, vpnGroup=vpnGroup, eventAlarmTime=eventAlarmTime, class1Pakets=class1Pakets, eventTrap=eventTrap, serverServiceState=serverServiceState, trafficshapeGroup=trafficshapeGroup, hwSensorValue=hwSensorValue, bgpNeighbors=bgpNeighbors, eventClassification=eventClassification, fwCompliances=fwCompliances, firmwareGroups=firmwareGroups, raidEventText=raidEventText, firewallSessions=firewallSessions, vpnTunnels=vpnTunnels, serverServiceName=serverServiceName, bgpNeighborsEntry=bgpNeighborsEntry, serverServicesEntry=serverServicesEntry, ospfNeighbors=ospfNeighbors, hwSensorsEntry=hwSensorsEntry, SensorType=SensorType, eventRepresentation=eventRepresentation, phionHotfixesEntry=phionHotfixesEntry, hotfixName=hotfixName, noDelayTotal=noDelayTotal, class3Pakets=class3Pakets, ospfNeighborAddress=ospfNeighborAddress, raidEventSev=raidEventSev, dataThroughput=dataThroughput, partitionUsedSpacePercent=partitionUsedSpacePercent, ospfNeighborsEntry=ospfNeighborsEntry, boxServiceName=boxServiceName, firewallSessions64=firewallSessions64, hotfixGroup=hotfixGroup, packetThroughput64=packetThroughput64, RaidEventSeverity=RaidEventSeverity, eventID=eventID, hwGroup=hwGroup, eventLayerDescription=eventLayerDescription, phion=phion, raidEventIndex=raidEventIndex, ospfNeighborId=ospfNeighborId, eventGroup=eventGroup, serverGroup=serverGroup, PYSNMP_MODULE_ID=phion, ripNeighborAddress=ripNeighborAddress, class1Total=class1Total, noDelayDrop=noDelayDrop, vpnTunnelsEntry=vpnTunnelsEntry, bgpNeighborState=bgpNeighborState, ospfNeighborInterface=ospfNeighborInterface, partitionMaxSpace=partitionMaxSpace, eventIDDescription=eventIDDescription, VpnStates=VpnStates, raidEventsEntry=raidEventsEntry, phionHotfixes=phionHotfixes, fwStats=fwStats, netGroups=netGroups, rate=rate, boxGroup=boxGroup, firewall=firewall, raidEvents=raidEvents, fwCompliance=fwCompliance, hwSensorName=hwSensorName, eventSeverity=eventSeverity, vpnusersGroup=vpnusersGroup, partitionFreeSpace=partitionFreeSpace, vpnUsers=vpnUsers, diskspaceGroup=diskspaceGroup, ripNeighborState=ripNeighborState, class2Drop=class2Drop, vpnName=vpnName, class3Total=class3Total, raidGroup=raidGroup, raidEventTime=raidEventTime, sessions=sessions, connectorName=connectorName, eventType=eventType, ripNeighbors=ripNeighbors, bgpNeighborAddress=bgpNeighborAddress, vpnState=vpnState, hwGroups=hwGroups, bgpGroup=bgpGroup, hotfixInstallTime=hotfixInstallTime, fwstatsGroup=fwstatsGroup, diskSpace=diskSpace, releaseGroup=releaseGroup, boxServiceState=boxServiceState, boxServicesEntry=boxServicesEntry, ospfNeighborStatus=ospfNeighborStatus, noDelayPakets=noDelayPakets, class2Pakets=class2Pakets, class3Drop=class3Drop, class1Drop=class1Drop, event=event, ServiceState=ServiceState, boxServices=boxServices, partitionName=partitionName, trafficShape=trafficShape)
