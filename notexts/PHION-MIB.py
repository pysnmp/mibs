...
mibBuilder.exportSymbols("PHION-MIB", rate=rate, partitionFreeSpace=partitionFreeSpace, raidEventTime=raidEventTime, boxServiceState=boxServiceState, hwSensorValue=hwSensorValue, serverServiceName=serverServiceName, hotfixInstallTime=hotfixInstallTime, bgpNeighbors=bgpNeighbors, packetThroughput=packetThroughput, ripNeighborAddress=ripNeighborAddress, hwGroups=hwGroups, boxServiceName=boxServiceName, serverServiceState=serverServiceState, class1Total=class1Total, packetThroughput64=packetThroughput64, raidEventText=raidEventText, firewallSessions64=firewallSessions64, class1Pakets=class1Pakets, eventGroup=eventGroup, ospfNeighbors=ospfNeighbors, eventID=eventID, class3Drop=class3Drop, hwSensorType=hwSensorType, vpnUsers=vpnUsers, SensorType=SensorType, connectorName=connectorName, fwStatsEntry=fwStatsEntry, bgpNeighborState=bgpNeighborState, phionHotfixesEntry=phionHotfixesEntry, eventType=eventType, vpnState=vpnState, ripNeighborsEntry=ripNeighborsEntry, raidEventSev=raidEventSev, netGroups=netGroups, vpnusersGroup=vpnusersGroup, trafficshapeGroup=trafficshapeGroup, class2Pakets=class2Pakets, vpnTunnelsEntry=vpnTunnelsEntry, raidGroup=raidGroup, ospfGroup=ospfGroup, firewallSessions=firewallSessions, hotfixName=hotfixName, ServiceState=ServiceState, diskspaceGroup=diskspaceGroup, ospfNeighborId=ospfNeighborId, class2Drop=class2Drop, serviceGroups=serviceGroups, ospfNeighborAddress=ospfNeighborAddress, fwCompliance=fwCompliance, eventTrap=eventTrap, trafficShapeEntry=trafficShapeEntry, noDelayDrop=noDelayDrop, diskSpaceEntry=diskSpaceEntry, dataThroughput=dataThroughput, hwSensors=hwSensors, firewall=firewall, phionRelease=phionRelease, firmwareGroups=firmwareGroups, partitionUsedSpace=partitionUsedSpace, VpnStates=VpnStates, class3Pakets=class3Pakets, boxServicesEntry=boxServicesEntry, raidEvents=raidEvents, sessions=sessions, fwstatsGroup=fwstatsGroup, fwGroups=fwGroups, vpnTunnels=vpnTunnels, boxGroup=boxGroup, hotfixGroup=hotfixGroup, ospfNeighborInterface=ospfNeighborInterface, eventRepresentation=eventRepresentation, ospfNeighborsEntry=ospfNeighborsEntry, eventGroups=eventGroups, notificationGroup=notificationGroup, ripNeighborState=ripNeighborState, raidEventIndex=raidEventIndex, noDelayPakets=noDelayPakets, partitionUsedSpacePercent=partitionUsedSpacePercent, hwSensorsEntry=hwSensorsEntry, class1Drop=class1Drop, ripGroup=ripGroup, class2Total=class2Total, diskSpace=diskSpace, serverServicesEntry=serverServicesEntry, bgpNeighborsEntry=bgpNeighborsEntry, RaidEventSeverity=RaidEventSeverity, PYSNMP_MODULE_ID=phion, eventClassification=eventClassification, eventSeverity=eventSeverity, noDelayTotal=noDelayTotal, hwGroup=hwGroup, partitionMaxSpace=partitionMaxSpace, releaseGroup=releaseGroup, phionHotfixes=phionHotfixes, raidEventsEntry=raidEventsEntry, fwCompliances=fwCompliances, bgpNeighborAddress=bgpNeighborAddress, class3Total=class3Total, trafficShape=trafficShape, ripNeighbors=ripNeighbors, event=event, vpnGroup=vpnGroup, vpnName=vpnName, dataThroughput64=dataThroughput64, eventAlarmTime=eventAlarmTime, serverGroup=serverGroup, phion=phion, fwStats=fwStats, eventLayerDescription=eventLayerDescription, ospfNeighborStatus=ospfNeighborStatus, bgpGroup=bgpGroup, serverServices=serverServices, hwSensorName=hwSensorName, partitionName=partitionName, boxServices=boxServices, eventIDDescription=eventIDDescription)
