...
MibIdentifier, Counter64, Bits, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, NotificationType, iso, TimeTicks, enterprises, Counter32, Gauge32, IpAddress, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter64", "Bits", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "NotificationType", "iso", "TimeTicks", "enterprises", "Counter32", "Gauge32", "IpAddress", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("PHION-MIB", boxServiceName=boxServiceName, eventTrap=eventTrap, ospfGroup=ospfGroup, fwStats=fwStats, hwSensorName=hwSensorName, bgpNeighborState=bgpNeighborState, class2Pakets=class2Pakets, dataThroughput=dataThroughput, noDelayTotal=noDelayTotal, ripNeighborsEntry=ripNeighborsEntry, fwCompliances=fwCompliances, eventAlarmTime=eventAlarmTime, hwSensorsEntry=hwSensorsEntry, trafficShape=trafficShape, raidEvents=raidEvents, notificationGroup=notificationGroup, vpnUsers=vpnUsers, serverGroup=serverGroup, hotfixInstallTime=hotfixInstallTime, boxServices=boxServices, phionHotfixesEntry=phionHotfixesEntry, ospfNeighborsEntry=ospfNeighborsEntry, partitionUsedSpacePercent=partitionUsedSpacePercent, diskspaceGroup=diskspaceGroup, class2Drop=class2Drop, class1Total=class1Total, bgpNeighborsEntry=bgpNeighborsEntry, raidEventTime=raidEventTime, class3Total=class3Total, diskSpaceEntry=diskSpaceEntry, eventRepresentation=eventRepresentation, hwGroups=hwGroups, fwCompliance=fwCompliance, firewall=firewall, ospfNeighbors=ospfNeighbors, ospfNeighborAddress=ospfNeighborAddress, packetThroughput64=packetThroughput64, vpnusersGroup=vpnusersGroup, vpnTunnelsEntry=vpnTunnelsEntry, class2Total=class2Total, raidGroup=raidGroup, packetThroughput=packetThroughput, eventLayerDescription=eventLayerDescription, boxGroup=boxGroup, hwGroup=hwGroup, class3Drop=class3Drop, firewallSessions64=firewallSessions64, ospfNeighborInterface=ospfNeighborInterface, trafficshapeGroup=trafficshapeGroup, eventGroups=eventGroups, event=event, hwSensorType=hwSensorType, ripNeighborState=ripNeighborState, eventClassification=eventClassification, connectorName=connectorName, rate=rate, ripNeighbors=ripNeighbors, SensorType=SensorType, firmwareGroups=firmwareGroups, class3Pakets=class3Pakets, hwSensors=hwSensors, serverServiceState=serverServiceState, phionRelease=phionRelease, firewallSessions=firewallSessions, class1Drop=class1Drop, partitionMaxSpace=partitionMaxSpace, phionHotfixes=phionHotfixes, boxServicesEntry=boxServicesEntry, hotfixName=hotfixName, netGroups=netGroups, partitionFreeSpace=partitionFreeSpace, ServiceState=ServiceState, serverServicesEntry=serverServicesEntry, serverServices=serverServices, raidEventsEntry=raidEventsEntry, eventSeverity=eventSeverity, bgpGroup=bgpGroup, noDelayDrop=noDelayDrop, eventIDDescription=eventIDDescription, hwSensorValue=hwSensorValue, eventID=eventID, phion=phion, vpnState=vpnState, serviceGroups=serviceGroups, PYSNMP_MODULE_ID=phion, serverServiceName=serverServiceName, noDelayPakets=noDelayPakets, fwStatsEntry=fwStatsEntry, diskSpace=diskSpace, class1Pakets=class1Pakets, raidEventText=raidEventText, fwstatsGroup=fwstatsGroup, RaidEventSeverity=RaidEventSeverity, ripGroup=ripGroup, ripNeighborAddress=ripNeighborAddress, partitionUsedSpace=partitionUsedSpace, sessions=sessions, eventType=eventType, ospfNeighborStatus=ospfNeighborStatus, vpnGroup=vpnGroup, raidEventIndex=raidEventIndex, partitionName=partitionName, VpnStates=VpnStates, hotfixGroup=hotfixGroup, fwGroups=fwGroups, raidEventSev=raidEventSev, releaseGroup=releaseGroup, boxServiceState=boxServiceState, trafficShapeEntry=trafficShapeEntry, ospfNeighborId=ospfNeighborId, vpnTunnels=vpnTunnels, bgpNeighbors=bgpNeighbors, vpnName=vpnName, dataThroughput64=dataThroughput64, bgpNeighborAddress=bgpNeighborAddress, eventGroup=eventGroup)
