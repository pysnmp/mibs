...
MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Bits, TimeTicks, IpAddress, ObjectIdentity, enterprises, Counter32, ModuleIdentity, Counter64, Integer32, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Bits", "TimeTicks", "IpAddress", "ObjectIdentity", "enterprises", "Counter32", "ModuleIdentity", "Counter64", "Integer32", "Gauge32", "iso")
...
mibBuilder.exportSymbols("PHION-MIB", vpnName=vpnName, eventClassification=eventClassification, ripNeighborsEntry=ripNeighborsEntry, hwSensors=hwSensors, class3Drop=class3Drop, serverServices=serverServices, eventGroups=eventGroups, PYSNMP_MODULE_ID=phion, eventLayerDescription=eventLayerDescription, hwSensorName=hwSensorName, class2Total=class2Total, packetThroughput=packetThroughput, class3Total=class3Total, ripNeighbors=ripNeighbors, vpnGroup=vpnGroup, class3Pakets=class3Pakets, raidEvents=raidEvents, partitionMaxSpace=partitionMaxSpace, fwGroups=fwGroups, phionHotfixes=phionHotfixes, raidEventsEntry=raidEventsEntry, diskSpace=diskSpace, raidEventText=raidEventText, diskSpaceEntry=diskSpaceEntry, eventIDDescription=eventIDDescription, diskspaceGroup=diskspaceGroup, partitionUsedSpace=partitionUsedSpace, vpnTunnels=vpnTunnels, sessions=sessions, ospfNeighborsEntry=ospfNeighborsEntry, bgpNeighborState=bgpNeighborState, boxServicesEntry=boxServicesEntry, VpnStates=VpnStates, boxServiceState=boxServiceState, partitionFreeSpace=partitionFreeSpace, notificationGroup=notificationGroup, hwSensorType=hwSensorType, ospfNeighborInterface=ospfNeighborInterface, hwGroups=hwGroups, ospfNeighborId=ospfNeighborId, trafficShape=trafficShape, eventRepresentation=eventRepresentation, phion=phion, noDelayTotal=noDelayTotal, SensorType=SensorType, firewall=firewall, ripGroup=ripGroup, firewallSessions=firewallSessions, ripNeighborAddress=ripNeighborAddress, phionRelease=phionRelease, vpnUsers=vpnUsers, class2Drop=class2Drop, boxGroup=boxGroup, serverGroup=serverGroup, fwstatsGroup=fwstatsGroup, vpnusersGroup=vpnusersGroup, boxServices=boxServices, RaidEventSeverity=RaidEventSeverity, raidEventTime=raidEventTime, eventAlarmTime=eventAlarmTime, firmwareGroups=firmwareGroups, eventID=eventID, ospfNeighbors=ospfNeighbors, serverServicesEntry=serverServicesEntry, dataThroughput=dataThroughput, eventGroup=eventGroup, fwStatsEntry=fwStatsEntry, eventSeverity=eventSeverity, vpnState=vpnState, ospfGroup=ospfGroup, bgpNeighborsEntry=bgpNeighborsEntry, hotfixGroup=hotfixGroup, ospfNeighborAddress=ospfNeighborAddress, partitionUsedSpacePercent=partitionUsedSpacePercent, trafficShapeEntry=trafficShapeEntry, serverServiceState=serverServiceState, dataThroughput64=dataThroughput64, hwSensorsEntry=hwSensorsEntry, class1Total=class1Total, vpnTunnelsEntry=vpnTunnelsEntry, noDelayDrop=noDelayDrop, trafficshapeGroup=trafficshapeGroup, fwCompliances=fwCompliances, serverServiceName=serverServiceName, ripNeighborState=ripNeighborState, event=event, hwSensorValue=hwSensorValue, noDelayPakets=noDelayPakets, rate=rate, raidEventIndex=raidEventIndex, netGroups=netGroups, fwStats=fwStats, bgpGroup=bgpGroup, boxServiceName=boxServiceName, eventTrap=eventTrap, firewallSessions64=firewallSessions64, hotfixInstallTime=hotfixInstallTime, partitionName=partitionName, eventType=eventType, class1Drop=class1Drop, serviceGroups=serviceGroups, ServiceState=ServiceState, class1Pakets=class1Pakets, class2Pakets=class2Pakets, hwGroup=hwGroup, fwCompliance=fwCompliance, raidEventSev=raidEventSev, bgpNeighbors=bgpNeighbors, releaseGroup=releaseGroup, bgpNeighborAddress=bgpNeighborAddress, ospfNeighborStatus=ospfNeighborStatus, raidGroup=raidGroup, packetThroughput64=packetThroughput64, connectorName=connectorName, hotfixName=hotfixName, phionHotfixesEntry=phionHotfixesEntry)
