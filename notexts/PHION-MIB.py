...
ObjectIdentity, Counter32, ModuleIdentity, NotificationType, Gauge32, TimeTicks, IpAddress, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Unsigned32, Counter64, Integer32, Bits, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter32", "ModuleIdentity", "NotificationType", "Gauge32", "TimeTicks", "IpAddress", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Unsigned32", "Counter64", "Integer32", "Bits", "MibIdentifier")
...
mibBuilder.exportSymbols("PHION-MIB", phionRelease=phionRelease, hwSensorsEntry=hwSensorsEntry, diskSpace=diskSpace, partitionUsedSpace=partitionUsedSpace, hwSensorValue=hwSensorValue, raidEventIndex=raidEventIndex, class3Total=class3Total, class3Pakets=class3Pakets, firmwareGroups=firmwareGroups, raidEventText=raidEventText, eventClassification=eventClassification, boxServices=boxServices, eventLayerDescription=eventLayerDescription, raidEventTime=raidEventTime, hwGroup=hwGroup, dataThroughput64=dataThroughput64, eventGroups=eventGroups, hwSensorType=hwSensorType, class2Pakets=class2Pakets, ripNeighborState=ripNeighborState, event=event, hotfixInstallTime=hotfixInstallTime, eventGroup=eventGroup, fwStatsEntry=fwStatsEntry, vpnGroup=vpnGroup, serviceGroups=serviceGroups, serverGroup=serverGroup, hotfixName=hotfixName, partitionName=partitionName, rate=rate, boxServicesEntry=boxServicesEntry, noDelayTotal=noDelayTotal, hwGroups=hwGroups, class1Total=class1Total, eventType=eventType, phionHotfixesEntry=phionHotfixesEntry, raidEventSev=raidEventSev, vpnName=vpnName, dataThroughput=dataThroughput, class1Pakets=class1Pakets, ospfGroup=ospfGroup, bgpNeighborsEntry=bgpNeighborsEntry, hwSensors=hwSensors, hwSensorName=hwSensorName, ospfNeighborId=ospfNeighborId, PYSNMP_MODULE_ID=phion, eventID=eventID, eventIDDescription=eventIDDescription, fwStats=fwStats, eventSeverity=eventSeverity, eventTrap=eventTrap, hotfixGroup=hotfixGroup, ospfNeighborsEntry=ospfNeighborsEntry, class2Drop=class2Drop, trafficShapeEntry=trafficShapeEntry, netGroups=netGroups, firewall=firewall, class1Drop=class1Drop, packetThroughput64=packetThroughput64, VpnStates=VpnStates, serverServiceName=serverServiceName, bgpNeighborAddress=bgpNeighborAddress, bgpNeighborState=bgpNeighborState, packetThroughput=packetThroughput, partitionUsedSpacePercent=partitionUsedSpacePercent, class3Drop=class3Drop, eventAlarmTime=eventAlarmTime, fwCompliance=fwCompliance, raidEvents=raidEvents, vpnUsers=vpnUsers, serverServices=serverServices, boxServiceName=boxServiceName, trafficshapeGroup=trafficshapeGroup, serverServicesEntry=serverServicesEntry, diskspaceGroup=diskspaceGroup, vpnusersGroup=vpnusersGroup, noDelayPakets=noDelayPakets, fwstatsGroup=fwstatsGroup, boxServiceState=boxServiceState, ospfNeighbors=ospfNeighbors, vpnTunnelsEntry=vpnTunnelsEntry, trafficShape=trafficShape, firewallSessions64=firewallSessions64, fwCompliances=fwCompliances, releaseGroup=releaseGroup, class2Total=class2Total, ServiceState=ServiceState, firewallSessions=firewallSessions, phion=phion, ripNeighborsEntry=ripNeighborsEntry, ospfNeighborStatus=ospfNeighborStatus, eventRepresentation=eventRepresentation, fwGroups=fwGroups, sessions=sessions, ospfNeighborInterface=ospfNeighborInterface, bgpNeighbors=bgpNeighbors, ripGroup=ripGroup, connectorName=connectorName, partitionFreeSpace=partitionFreeSpace, serverServiceState=serverServiceState, raidGroup=raidGroup, SensorType=SensorType, partitionMaxSpace=partitionMaxSpace, ripNeighbors=ripNeighbors, noDelayDrop=noDelayDrop, phionHotfixes=phionHotfixes, raidEventsEntry=raidEventsEntry, ripNeighborAddress=ripNeighborAddress, vpnTunnels=vpnTunnels, boxGroup=boxGroup, RaidEventSeverity=RaidEventSeverity, notificationGroup=notificationGroup, bgpGroup=bgpGroup, ospfNeighborAddress=ospfNeighborAddress, vpnState=vpnState, diskSpaceEntry=diskSpaceEntry)
