...
enterprises, IpAddress, Gauge32, iso, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, TimeTicks, Bits, ModuleIdentity, Counter32, Unsigned32, ObjectIdentity, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "IpAddress", "Gauge32", "iso", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "TimeTicks", "Bits", "ModuleIdentity", "Counter32", "Unsigned32", "ObjectIdentity", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("PHION-MIB", hotfixInstallTime=hotfixInstallTime, raidEventTime=raidEventTime, eventType=eventType, eventTrap=eventTrap, phionHotfixes=phionHotfixes, firewallSessions64=firewallSessions64, bgpNeighbors=bgpNeighbors, hwSensorsEntry=hwSensorsEntry, ospfNeighborAddress=ospfNeighborAddress, sessions=sessions, serviceGroups=serviceGroups, class3Drop=class3Drop, bgpNeighborsEntry=bgpNeighborsEntry, ripNeighborState=ripNeighborState, ospfNeighborId=ospfNeighborId, class1Total=class1Total, fwCompliance=fwCompliance, bgpNeighborState=bgpNeighborState, SensorType=SensorType, firewallSessions=firewallSessions, vpnName=vpnName, raidEventsEntry=raidEventsEntry, PYSNMP_MODULE_ID=phion, hwGroup=hwGroup, bgpGroup=bgpGroup, serverServiceState=serverServiceState, ospfGroup=ospfGroup, boxServicesEntry=boxServicesEntry, packetThroughput64=packetThroughput64, fwStats=fwStats, ospfNeighborsEntry=ospfNeighborsEntry, ospfNeighborInterface=ospfNeighborInterface, fwGroups=fwGroups, class1Drop=class1Drop, class3Pakets=class3Pakets, RaidEventSeverity=RaidEventSeverity, partitionFreeSpace=partitionFreeSpace, diskSpaceEntry=diskSpaceEntry, eventGroups=eventGroups, boxServiceState=boxServiceState, raidGroup=raidGroup, partitionName=partitionName, raidEventIndex=raidEventIndex, netGroups=netGroups, bgpNeighborAddress=bgpNeighborAddress, eventClassification=eventClassification, hwSensorValue=hwSensorValue, noDelayDrop=noDelayDrop, ospfNeighborStatus=ospfNeighborStatus, eventAlarmTime=eventAlarmTime, ospfNeighbors=ospfNeighbors, hwSensorName=hwSensorName, ripNeighbors=ripNeighbors, eventLayerDescription=eventLayerDescription, boxGroup=boxGroup, ServiceState=ServiceState, class1Pakets=class1Pakets, vpnTunnels=vpnTunnels, hotfixName=hotfixName, trafficShapeEntry=trafficShapeEntry, eventIDDescription=eventIDDescription, ripNeighborsEntry=ripNeighborsEntry, raidEventText=raidEventText, ripGroup=ripGroup, partitionUsedSpace=partitionUsedSpace, connectorName=connectorName, noDelayTotal=noDelayTotal, serverGroup=serverGroup, eventID=eventID, rate=rate, fwCompliances=fwCompliances, diskSpace=diskSpace, eventRepresentation=eventRepresentation, eventSeverity=eventSeverity, diskspaceGroup=diskspaceGroup, phionHotfixesEntry=phionHotfixesEntry, hotfixGroup=hotfixGroup, vpnusersGroup=vpnusersGroup, boxServiceName=boxServiceName, phionRelease=phionRelease, vpnGroup=vpnGroup, partitionUsedSpacePercent=partitionUsedSpacePercent, trafficshapeGroup=trafficshapeGroup, VpnStates=VpnStates, serverServiceName=serverServiceName, hwSensors=hwSensors, noDelayPakets=noDelayPakets, dataThroughput=dataThroughput, hwSensorType=hwSensorType, ripNeighborAddress=ripNeighborAddress, releaseGroup=releaseGroup, packetThroughput=packetThroughput, vpnUsers=vpnUsers, raidEventSev=raidEventSev, raidEvents=raidEvents, hwGroups=hwGroups, partitionMaxSpace=partitionMaxSpace, serverServicesEntry=serverServicesEntry, fwstatsGroup=fwstatsGroup, boxServices=boxServices, eventGroup=eventGroup, notificationGroup=notificationGroup, serverServices=serverServices, firmwareGroups=firmwareGroups, class2Pakets=class2Pakets, vpnTunnelsEntry=vpnTunnelsEntry, trafficShape=trafficShape, phion=phion, fwStatsEntry=fwStatsEntry, vpnState=vpnState, class3Total=class3Total, firewall=firewall, class2Drop=class2Drop, dataThroughput64=dataThroughput64, class2Total=class2Total, event=event)
