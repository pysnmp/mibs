...
Bits, enterprises, TimeTicks, NotificationType, ModuleIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, IpAddress, Gauge32, MibIdentifier, Unsigned32, Counter32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "enterprises", "TimeTicks", "NotificationType", "ModuleIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "IpAddress", "Gauge32", "MibIdentifier", "Unsigned32", "Counter32", "ObjectIdentity")
...
mibBuilder.exportSymbols("PHION-MIB", boxServiceName=boxServiceName, event=event, serviceGroups=serviceGroups, raidEventsEntry=raidEventsEntry, fwCompliance=fwCompliance, phionRelease=phionRelease, noDelayDrop=noDelayDrop, boxServicesEntry=boxServicesEntry, phion=phion, fwCompliances=fwCompliances, raidEvents=raidEvents, class3Total=class3Total, firewallSessions=firewallSessions, raidGroup=raidGroup, raidEventTime=raidEventTime, vpnusersGroup=vpnusersGroup, partitionFreeSpace=partitionFreeSpace, partitionUsedSpace=partitionUsedSpace, packetThroughput64=packetThroughput64, dataThroughput64=dataThroughput64, notificationGroup=notificationGroup, ospfNeighbors=ospfNeighbors, partitionName=partitionName, raidEventIndex=raidEventIndex, firewallSessions64=firewallSessions64, vpnTunnels=vpnTunnels, eventSeverity=eventSeverity, noDelayTotal=noDelayTotal, boxGroup=boxGroup, hwSensorsEntry=hwSensorsEntry, hotfixGroup=hotfixGroup, partitionMaxSpace=partitionMaxSpace, vpnTunnelsEntry=vpnTunnelsEntry, bgpNeighborsEntry=bgpNeighborsEntry, vpnState=vpnState, netGroups=netGroups, serverGroup=serverGroup, serverServiceState=serverServiceState, vpnUsers=vpnUsers, vpnName=vpnName, eventTrap=eventTrap, eventAlarmTime=eventAlarmTime, eventRepresentation=eventRepresentation, trafficShape=trafficShape, SensorType=SensorType, releaseGroup=releaseGroup, hwGroups=hwGroups, dataThroughput=dataThroughput, hwSensors=hwSensors, class2Drop=class2Drop, partitionUsedSpacePercent=partitionUsedSpacePercent, hotfixName=hotfixName, phionHotfixesEntry=phionHotfixesEntry, bgpNeighborState=bgpNeighborState, eventType=eventType, serverServices=serverServices, firewall=firewall, hwSensorType=hwSensorType, ServiceState=ServiceState, fwGroups=fwGroups, ospfNeighborsEntry=ospfNeighborsEntry, sessions=sessions, phionHotfixes=phionHotfixes, class3Pakets=class3Pakets, serverServiceName=serverServiceName, diskspaceGroup=diskspaceGroup, serverServicesEntry=serverServicesEntry, class2Pakets=class2Pakets, ospfNeighborAddress=ospfNeighborAddress, fwStats=fwStats, diskSpace=diskSpace, raidEventSev=raidEventSev, class1Drop=class1Drop, hwGroup=hwGroup, hwSensorName=hwSensorName, class1Total=class1Total, boxServiceState=boxServiceState, firmwareGroups=firmwareGroups, ripNeighbors=ripNeighbors, ripNeighborsEntry=ripNeighborsEntry, VpnStates=VpnStates, ospfNeighborStatus=ospfNeighborStatus, eventID=eventID, ripNeighborState=ripNeighborState, PYSNMP_MODULE_ID=phion, eventClassification=eventClassification, trafficshapeGroup=trafficshapeGroup, eventGroups=eventGroups, connectorName=connectorName, ripGroup=ripGroup, RaidEventSeverity=RaidEventSeverity, bgpNeighbors=bgpNeighbors, noDelayPakets=noDelayPakets, ospfNeighborInterface=ospfNeighborInterface, trafficShapeEntry=trafficShapeEntry, fwstatsGroup=fwstatsGroup, hwSensorValue=hwSensorValue, eventGroup=eventGroup, boxServices=boxServices, class2Total=class2Total, vpnGroup=vpnGroup, class1Pakets=class1Pakets, packetThroughput=packetThroughput, diskSpaceEntry=diskSpaceEntry, bgpGroup=bgpGroup, eventLayerDescription=eventLayerDescription, raidEventText=raidEventText, rate=rate, bgpNeighborAddress=bgpNeighborAddress, class3Drop=class3Drop, eventIDDescription=eventIDDescription, hotfixInstallTime=hotfixInstallTime, ripNeighborAddress=ripNeighborAddress, ospfGroup=ospfGroup, ospfNeighborId=ospfNeighborId, fwStatsEntry=fwStatsEntry)
