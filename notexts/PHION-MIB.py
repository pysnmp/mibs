...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress, MibIdentifier, ObjectIdentity, iso, Counter64, Integer32, NotificationType, Counter32, enterprises, Gauge32, TimeTicks, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress", "MibIdentifier", "ObjectIdentity", "iso", "Counter64", "Integer32", "NotificationType", "Counter32", "enterprises", "Gauge32", "TimeTicks", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("PHION-MIB", releaseGroup=releaseGroup, ospfNeighborStatus=ospfNeighborStatus, vpnTunnels=vpnTunnels, serverServicesEntry=serverServicesEntry, ospfNeighborAddress=ospfNeighborAddress, phionRelease=phionRelease, VpnStates=VpnStates, hotfixInstallTime=hotfixInstallTime, ospfNeighbors=ospfNeighbors, diskSpaceEntry=diskSpaceEntry, vpnName=vpnName, class2Pakets=class2Pakets, hotfixName=hotfixName, dataThroughput=dataThroughput, fwGroups=fwGroups, ospfNeighborInterface=ospfNeighborInterface, eventType=eventType, partitionUsedSpacePercent=partitionUsedSpacePercent, class3Drop=class3Drop, firmwareGroups=firmwareGroups, hwSensorType=hwSensorType, diskSpace=diskSpace, partitionUsedSpace=partitionUsedSpace, phion=phion, vpnState=vpnState, eventAlarmTime=eventAlarmTime, PYSNMP_MODULE_ID=phion, dataThroughput64=dataThroughput64, bgpNeighborsEntry=bgpNeighborsEntry, partitionMaxSpace=partitionMaxSpace, firewallSessions=firewallSessions, ripGroup=ripGroup, eventClassification=eventClassification, class3Pakets=class3Pakets, raidGroup=raidGroup, connectorName=connectorName, sessions=sessions, serverServices=serverServices, eventSeverity=eventSeverity, fwstatsGroup=fwstatsGroup, hwSensorsEntry=hwSensorsEntry, raidEventText=raidEventText, noDelayPakets=noDelayPakets, rate=rate, fwCompliances=fwCompliances, eventRepresentation=eventRepresentation, raidEventSev=raidEventSev, vpnGroup=vpnGroup, ripNeighborsEntry=ripNeighborsEntry, hotfixGroup=hotfixGroup, partitionName=partitionName, ospfNeighborsEntry=ospfNeighborsEntry, hwGroups=hwGroups, netGroups=netGroups, partitionFreeSpace=partitionFreeSpace, firewall=firewall, hwSensors=hwSensors, ripNeighborAddress=ripNeighborAddress, bgpGroup=bgpGroup, class3Total=class3Total, trafficshapeGroup=trafficshapeGroup, hwSensorValue=hwSensorValue, bgpNeighborAddress=bgpNeighborAddress, ServiceState=ServiceState, eventGroup=eventGroup, raidEvents=raidEvents, raidEventsEntry=raidEventsEntry, raidEventIndex=raidEventIndex, noDelayDrop=noDelayDrop, phionHotfixesEntry=phionHotfixesEntry, class1Drop=class1Drop, class2Total=class2Total, serverServiceState=serverServiceState, vpnUsers=vpnUsers, packetThroughput=packetThroughput, fwStats=fwStats, packetThroughput64=packetThroughput64, boxServices=boxServices, class1Total=class1Total, raidEventTime=raidEventTime, serverGroup=serverGroup, boxGroup=boxGroup, ripNeighborState=ripNeighborState, fwCompliance=fwCompliance, ospfGroup=ospfGroup, boxServiceName=boxServiceName, class1Pakets=class1Pakets, serverServiceName=serverServiceName, bgpNeighborState=bgpNeighborState, vpnTunnelsEntry=vpnTunnelsEntry, phionHotfixes=phionHotfixes, vpnusersGroup=vpnusersGroup, notificationGroup=notificationGroup, boxServicesEntry=boxServicesEntry, eventIDDescription=eventIDDescription, RaidEventSeverity=RaidEventSeverity, eventGroups=eventGroups, firewallSessions64=firewallSessions64, class2Drop=class2Drop, diskspaceGroup=diskspaceGroup, eventID=eventID, hwSensorName=hwSensorName, bgpNeighbors=bgpNeighbors, hwGroup=hwGroup, eventLayerDescription=eventLayerDescription, boxServiceState=boxServiceState, trafficShapeEntry=trafficShapeEntry, ospfNeighborId=ospfNeighborId, SensorType=SensorType, trafficShape=trafficShape, noDelayTotal=noDelayTotal, ripNeighbors=ripNeighbors, fwStatsEntry=fwStatsEntry, serviceGroups=serviceGroups, eventTrap=eventTrap, event=event)
