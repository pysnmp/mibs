...
mibBuilder.exportSymbols("PHION-MIB", PYSNMP_MODULE_ID=phion, vpnState=vpnState, ripNeighborsEntry=ripNeighborsEntry, VpnStates=VpnStates, partitionUsedSpacePercent=partitionUsedSpacePercent, noDelayPakets=noDelayPakets, fwCompliance=fwCompliance, diskspaceGroup=diskspaceGroup, serverGroup=serverGroup, eventID=eventID, releaseGroup=releaseGroup, ripGroup=ripGroup, bgpNeighborState=bgpNeighborState, eventType=eventType, fwstatsGroup=fwstatsGroup, eventGroup=eventGroup, hwSensorValue=hwSensorValue, eventRepresentation=eventRepresentation, ospfNeighborStatus=ospfNeighborStatus, ripNeighborAddress=ripNeighborAddress, class1Total=class1Total, diskSpaceEntry=diskSpaceEntry, ServiceState=ServiceState, raidEventsEntry=raidEventsEntry, fwStats=fwStats, rate=rate, ospfNeighbors=ospfNeighbors, boxServiceName=boxServiceName, netGroups=netGroups, fwCompliances=fwCompliances, raidGroup=raidGroup, eventLayerDescription=eventLayerDescription, hwSensors=hwSensors, partitionName=partitionName, class3Pakets=class3Pakets, eventClassification=eventClassification, eventSeverity=eventSeverity, boxGroup=boxGroup, boxServices=boxServices, partitionMaxSpace=partitionMaxSpace, boxServiceState=boxServiceState, partitionFreeSpace=partitionFreeSpace, eventIDDescription=eventIDDescription, vpnusersGroup=vpnusersGroup, phionRelease=phionRelease, vpnTunnelsEntry=vpnTunnelsEntry, firewallSessions=firewallSessions, ripNeighborState=ripNeighborState, packetThroughput64=packetThroughput64, serverServiceState=serverServiceState, bgpNeighborsEntry=bgpNeighborsEntry, boxServicesEntry=boxServicesEntry, vpnGroup=vpnGroup, raidEvents=raidEvents, dataThroughput=dataThroughput, hwGroup=hwGroup, ospfGroup=ospfGroup, hotfixGroup=hotfixGroup, ospfNeighborAddress=ospfNeighborAddress, phionHotfixes=phionHotfixes, sessions=sessions, notificationGroup=notificationGroup, event=event, serviceGroups=serviceGroups, hwSensorsEntry=hwSensorsEntry, packetThroughput=packetThroughput, ripNeighbors=ripNeighbors, class2Total=class2Total, phion=phion, SensorType=SensorType, class3Drop=class3Drop, hwSensorType=hwSensorType, ospfNeighborId=ospfNeighborId, raidEventText=raidEventText, noDelayDrop=noDelayDrop, class3Total=class3Total, raidEventIndex=raidEventIndex, vpnUsers=vpnUsers, ospfNeighborsEntry=ospfNeighborsEntry, fwStatsEntry=fwStatsEntry, eventGroups=eventGroups, hotfixName=hotfixName, class2Drop=class2Drop, eventTrap=eventTrap, firewall=firewall, bgpNeighbors=bgpNeighbors, raidEventTime=raidEventTime, RaidEventSeverity=RaidEventSeverity, phionHotfixesEntry=phionHotfixesEntry, noDelayTotal=noDelayTotal, partitionUsedSpace=partitionUsedSpace, class2Pakets=class2Pakets, raidEventSev=raidEventSev, serverServices=serverServices, vpnTunnels=vpnTunnels, dataThroughput64=dataThroughput64, bgpNeighborAddress=bgpNeighborAddress, vpnName=vpnName, diskSpace=diskSpace, firewallSessions64=firewallSessions64, eventAlarmTime=eventAlarmTime, firmwareGroups=firmwareGroups, bgpGroup=bgpGroup, trafficShape=trafficShape, connectorName=connectorName, trafficshapeGroup=trafficshapeGroup, hwSensorName=hwSensorName, class1Pakets=class1Pakets, serverServicesEntry=serverServicesEntry, serverServiceName=serverServiceName, trafficShapeEntry=trafficShapeEntry, hotfixInstallTime=hotfixInstallTime, fwGroups=fwGroups, ospfNeighborInterface=ospfNeighborInterface, hwGroups=hwGroups, class1Drop=class1Drop)
