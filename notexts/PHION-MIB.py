...
TimeTicks, MibIdentifier, Counter64, ModuleIdentity, Integer32, Bits, enterprises, iso, ObjectIdentity, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibIdentifier", "Counter64", "ModuleIdentity", "Integer32", "Bits", "enterprises", "iso", "ObjectIdentity", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("PHION-MIB", fwGroups=fwGroups, class1Pakets=class1Pakets, eventGroup=eventGroup, class3Drop=class3Drop, serviceGroups=serviceGroups, raidEventsEntry=raidEventsEntry, ripGroup=ripGroup, serverServiceState=serverServiceState, boxServices=boxServices, partitionUsedSpace=partitionUsedSpace, SensorType=SensorType, dataThroughput64=dataThroughput64, ServiceState=ServiceState, raidEventText=raidEventText, eventLayerDescription=eventLayerDescription, partitionName=partitionName, ripNeighborAddress=ripNeighborAddress, bgpNeighborsEntry=bgpNeighborsEntry, phionHotfixesEntry=phionHotfixesEntry, diskSpace=diskSpace, netGroups=netGroups, eventID=eventID, vpnusersGroup=vpnusersGroup, vpnTunnels=vpnTunnels, packetThroughput=packetThroughput, fwStats=fwStats, phionHotfixes=phionHotfixes, RaidEventSeverity=RaidEventSeverity, trafficShape=trafficShape, eventAlarmTime=eventAlarmTime, hwSensorValue=hwSensorValue, firewallSessions=firewallSessions, trafficShapeEntry=trafficShapeEntry, boxServicesEntry=boxServicesEntry, rate=rate, hwSensors=hwSensors, diskSpaceEntry=diskSpaceEntry, eventIDDescription=eventIDDescription, partitionUsedSpacePercent=partitionUsedSpacePercent, serverServiceName=serverServiceName, serverGroup=serverGroup, hotfixName=hotfixName, vpnUsers=vpnUsers, class3Total=class3Total, eventRepresentation=eventRepresentation, releaseGroup=releaseGroup, hotfixGroup=hotfixGroup, connectorName=connectorName, hotfixInstallTime=hotfixInstallTime, packetThroughput64=packetThroughput64, noDelayPakets=noDelayPakets, eventType=eventType, eventClassification=eventClassification, bgpNeighbors=bgpNeighbors, raidGroup=raidGroup, ospfNeighborInterface=ospfNeighborInterface, trafficshapeGroup=trafficshapeGroup, ospfNeighborId=ospfNeighborId, ospfNeighborAddress=ospfNeighborAddress, dataThroughput=dataThroughput, vpnState=vpnState, eventGroups=eventGroups, raidEvents=raidEvents, fwstatsGroup=fwstatsGroup, noDelayTotal=noDelayTotal, noDelayDrop=noDelayDrop, event=event, firmwareGroups=firmwareGroups, boxServiceName=boxServiceName, partitionMaxSpace=partitionMaxSpace, class2Drop=class2Drop, bgpNeighborAddress=bgpNeighborAddress, ripNeighbors=ripNeighbors, boxServiceState=boxServiceState, firewallSessions64=firewallSessions64, ripNeighborState=ripNeighborState, serverServicesEntry=serverServicesEntry, hwGroup=hwGroup, phionRelease=phionRelease, hwSensorName=hwSensorName, hwGroups=hwGroups, phion=phion, class1Total=class1Total, PYSNMP_MODULE_ID=phion, notificationGroup=notificationGroup, hwSensorsEntry=hwSensorsEntry, ospfNeighborsEntry=ospfNeighborsEntry, vpnGroup=vpnGroup, boxGroup=boxGroup, fwStatsEntry=fwStatsEntry, ripNeighborsEntry=ripNeighborsEntry, vpnName=vpnName, bgpGroup=bgpGroup, eventSeverity=eventSeverity, VpnStates=VpnStates, eventTrap=eventTrap, class2Total=class2Total, raidEventTime=raidEventTime, bgpNeighborState=bgpNeighborState, ospfNeighbors=ospfNeighbors, sessions=sessions, vpnTunnelsEntry=vpnTunnelsEntry, ospfNeighborStatus=ospfNeighborStatus, hwSensorType=hwSensorType, class2Pakets=class2Pakets, raidEventSev=raidEventSev, fwCompliances=fwCompliances, firewall=firewall, fwCompliance=fwCompliance, class1Drop=class1Drop, class3Pakets=class3Pakets, partitionFreeSpace=partitionFreeSpace, ospfGroup=ospfGroup, serverServices=serverServices, diskspaceGroup=diskspaceGroup, raidEventIndex=raidEventIndex)
