...
mibBuilder.exportSymbols("PHION-MIB", eventType=eventType, class3Total=class3Total, bgpNeighbors=bgpNeighbors, rate=rate, ripNeighborsEntry=ripNeighborsEntry, ospfNeighbors=ospfNeighbors, dataThroughput=dataThroughput, phionHotfixes=phionHotfixes, releaseGroup=releaseGroup, class1Pakets=class1Pakets, firewall=firewall, eventIDDescription=eventIDDescription, eventRepresentation=eventRepresentation, class3Pakets=class3Pakets, class3Drop=class3Drop, partitionFreeSpace=partitionFreeSpace, eventGroup=eventGroup, RaidEventSeverity=RaidEventSeverity, ospfNeighborId=ospfNeighborId, packetThroughput=packetThroughput, PYSNMP_MODULE_ID=phion, notificationGroup=notificationGroup, trafficShape=trafficShape, noDelayPakets=noDelayPakets, packetThroughput64=packetThroughput64, boxGroup=boxGroup, raidEventSev=raidEventSev, fwCompliance=fwCompliance, dataThroughput64=dataThroughput64, fwCompliances=fwCompliances, serverGroup=serverGroup, vpnState=vpnState, boxServicesEntry=boxServicesEntry, ospfNeighborStatus=ospfNeighborStatus, vpnTunnelsEntry=vpnTunnelsEntry, eventClassification=eventClassification, fwStats=fwStats, class1Drop=class1Drop, bgpNeighborsEntry=bgpNeighborsEntry, fwStatsEntry=fwStatsEntry, ripNeighborAddress=ripNeighborAddress, eventAlarmTime=eventAlarmTime, ospfNeighborsEntry=ospfNeighborsEntry, hwSensorValue=hwSensorValue, class2Pakets=class2Pakets, partitionUsedSpacePercent=partitionUsedSpacePercent, class1Total=class1Total, vpnGroup=vpnGroup, trafficshapeGroup=trafficshapeGroup, netGroups=netGroups, ripGroup=ripGroup, hwSensorType=hwSensorType, hwSensorsEntry=hwSensorsEntry, SensorType=SensorType, ServiceState=ServiceState, hwSensors=hwSensors, event=event, fwGroups=fwGroups, phion=phion, serverServiceName=serverServiceName, eventTrap=eventTrap, eventLayerDescription=eventLayerDescription, diskSpace=diskSpace, ospfNeighborAddress=ospfNeighborAddress, raidEvents=raidEvents, trafficShapeEntry=trafficShapeEntry, diskSpaceEntry=diskSpaceEntry, bgpNeighborState=bgpNeighborState, partitionMaxSpace=partitionMaxSpace, boxServices=boxServices, eventGroups=eventGroups, phionRelease=phionRelease, connectorName=connectorName, boxServiceState=boxServiceState, hotfixGroup=hotfixGroup, ripNeighborState=ripNeighborState, raidEventText=raidEventText, serviceGroups=serviceGroups, class2Drop=class2Drop, partitionUsedSpace=partitionUsedSpace, raidEventIndex=raidEventIndex, hotfixInstallTime=hotfixInstallTime, serverServices=serverServices, vpnusersGroup=vpnusersGroup, noDelayDrop=noDelayDrop, serverServiceState=serverServiceState, fwstatsGroup=fwstatsGroup, hwGroups=hwGroups, hwGroup=hwGroup, raidGroup=raidGroup, bgpGroup=bgpGroup, noDelayTotal=noDelayTotal, vpnName=vpnName, ospfNeighborInterface=ospfNeighborInterface, ripNeighbors=ripNeighbors, eventID=eventID, partitionName=partitionName, hotfixName=hotfixName, class2Total=class2Total, phionHotfixesEntry=phionHotfixesEntry, sessions=sessions, diskspaceGroup=diskspaceGroup, ospfGroup=ospfGroup, raidEventTime=raidEventTime, boxServiceName=boxServiceName, eventSeverity=eventSeverity, bgpNeighborAddress=bgpNeighborAddress, raidEventsEntry=raidEventsEntry, VpnStates=VpnStates, firmwareGroups=firmwareGroups, firewallSessions64=firewallSessions64, serverServicesEntry=serverServicesEntry, vpnUsers=vpnUsers, firewallSessions=firewallSessions, vpnTunnels=vpnTunnels, hwSensorName=hwSensorName)
