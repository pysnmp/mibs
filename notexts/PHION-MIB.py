...
Counter32, ModuleIdentity, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, MibIdentifier, Bits, Unsigned32, enterprises, Integer32, TimeTicks, ObjectIdentity, IpAddress, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "MibIdentifier", "Bits", "Unsigned32", "enterprises", "Integer32", "TimeTicks", "ObjectIdentity", "IpAddress", "Counter64")
...
mibBuilder.exportSymbols("PHION-MIB", eventID=eventID, dataThroughput=dataThroughput, eventTrap=eventTrap, ospfNeighborStatus=ospfNeighborStatus, noDelayPakets=noDelayPakets, ServiceState=ServiceState, eventRepresentation=eventRepresentation, fwGroups=fwGroups, raidEventIndex=raidEventIndex, bgpNeighborsEntry=bgpNeighborsEntry, hwGroup=hwGroup, partitionMaxSpace=partitionMaxSpace, class2Total=class2Total, class1Pakets=class1Pakets, eventSeverity=eventSeverity, class2Pakets=class2Pakets, bgpNeighborAddress=bgpNeighborAddress, SensorType=SensorType, vpnTunnelsEntry=vpnTunnelsEntry, raidEventsEntry=raidEventsEntry, serverServiceState=serverServiceState, hotfixName=hotfixName, fwstatsGroup=fwstatsGroup, ripNeighborState=ripNeighborState, connectorName=connectorName, ospfGroup=ospfGroup, hwSensorValue=hwSensorValue, dataThroughput64=dataThroughput64, raidEventTime=raidEventTime, boxServicesEntry=boxServicesEntry, sessions=sessions, noDelayTotal=noDelayTotal, eventClassification=eventClassification, vpnState=vpnState, eventAlarmTime=eventAlarmTime, class3Total=class3Total, hwSensorType=hwSensorType, partitionUsedSpace=partitionUsedSpace, ospfNeighborInterface=ospfNeighborInterface, firewall=firewall, releaseGroup=releaseGroup, phionHotfixes=phionHotfixes, vpnGroup=vpnGroup, firewallSessions64=firewallSessions64, firewallSessions=firewallSessions, class1Total=class1Total, serviceGroups=serviceGroups, firmwareGroups=firmwareGroups, raidGroup=raidGroup, serverGroup=serverGroup, VpnStates=VpnStates, eventGroup=eventGroup, notificationGroup=notificationGroup, boxGroup=boxGroup, partitionName=partitionName, diskSpaceEntry=diskSpaceEntry, eventIDDescription=eventIDDescription, ripGroup=ripGroup, partitionUsedSpacePercent=partitionUsedSpacePercent, raidEvents=raidEvents, serverServicesEntry=serverServicesEntry, fwCompliances=fwCompliances, hotfixInstallTime=hotfixInstallTime, trafficshapeGroup=trafficshapeGroup, diskSpace=diskSpace, hwSensorName=hwSensorName, diskspaceGroup=diskspaceGroup, class1Drop=class1Drop, phionHotfixesEntry=phionHotfixesEntry, ospfNeighborAddress=ospfNeighborAddress, ripNeighbors=ripNeighbors, ripNeighborAddress=ripNeighborAddress, phionRelease=phionRelease, hwGroups=hwGroups, class2Drop=class2Drop, bgpGroup=bgpGroup, fwStats=fwStats, RaidEventSeverity=RaidEventSeverity, boxServices=boxServices, hwSensors=hwSensors, vpnTunnels=vpnTunnels, bgpNeighborState=bgpNeighborState, ospfNeighborsEntry=ospfNeighborsEntry, bgpNeighbors=bgpNeighbors, hotfixGroup=hotfixGroup, PYSNMP_MODULE_ID=phion, hwSensorsEntry=hwSensorsEntry, packetThroughput=packetThroughput, eventType=eventType, raidEventText=raidEventText, fwCompliance=fwCompliance, trafficShape=trafficShape, eventLayerDescription=eventLayerDescription, partitionFreeSpace=partitionFreeSpace, serverServiceName=serverServiceName, phion=phion, vpnusersGroup=vpnusersGroup, ospfNeighbors=ospfNeighbors, ospfNeighborId=ospfNeighborId, fwStatsEntry=fwStatsEntry, boxServiceName=boxServiceName, class3Drop=class3Drop, boxServiceState=boxServiceState, raidEventSev=raidEventSev, packetThroughput64=packetThroughput64, serverServices=serverServices, event=event, ripNeighborsEntry=ripNeighborsEntry, vpnName=vpnName, rate=rate, vpnUsers=vpnUsers, noDelayDrop=noDelayDrop, class3Pakets=class3Pakets, eventGroups=eventGroups, trafficShapeEntry=trafficShapeEntry, netGroups=netGroups)
