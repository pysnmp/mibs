...
Integer32, iso, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress, Counter32, ModuleIdentity, NotificationType, Gauge32, Counter64, MibIdentifier, ObjectIdentity, TimeTicks, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress", "Counter32", "ModuleIdentity", "NotificationType", "Gauge32", "Counter64", "MibIdentifier", "ObjectIdentity", "TimeTicks", "enterprises")
...
mibBuilder.exportSymbols("PHION-MIB", firmwareGroups=firmwareGroups, raidEventsEntry=raidEventsEntry, fwCompliance=fwCompliance, eventGroup=eventGroup, hotfixName=hotfixName, raidEventText=raidEventText, diskspaceGroup=diskspaceGroup, firewall=firewall, firewallSessions64=firewallSessions64, phionRelease=phionRelease, noDelayDrop=noDelayDrop, releaseGroup=releaseGroup, class2Pakets=class2Pakets, vpnUsers=vpnUsers, VpnStates=VpnStates, vpnGroup=vpnGroup, boxServicesEntry=boxServicesEntry, serviceGroups=serviceGroups, hotfixGroup=hotfixGroup, raidEventTime=raidEventTime, trafficshapeGroup=trafficshapeGroup, raidEvents=raidEvents, hwSensorName=hwSensorName, bgpNeighborState=bgpNeighborState, hwSensors=hwSensors, trafficShape=trafficShape, partitionName=partitionName, ospfNeighborAddress=ospfNeighborAddress, vpnState=vpnState, ospfNeighborId=ospfNeighborId, sessions=sessions, eventRepresentation=eventRepresentation, class3Total=class3Total, eventIDDescription=eventIDDescription, eventType=eventType, fwstatsGroup=fwstatsGroup, hwSensorsEntry=hwSensorsEntry, packetThroughput=packetThroughput, ospfNeighbors=ospfNeighbors, firewallSessions=firewallSessions, fwGroups=fwGroups, ospfNeighborsEntry=ospfNeighborsEntry, RaidEventSeverity=RaidEventSeverity, class3Pakets=class3Pakets, bgpNeighborAddress=bgpNeighborAddress, bgpNeighbors=bgpNeighbors, noDelayPakets=noDelayPakets, class2Total=class2Total, diskSpace=diskSpace, ServiceState=ServiceState, vpnusersGroup=vpnusersGroup, bgpGroup=bgpGroup, partitionUsedSpacePercent=partitionUsedSpacePercent, boxServiceState=boxServiceState, phion=phion, class1Total=class1Total, hwSensorValue=hwSensorValue, eventSeverity=eventSeverity, boxServices=boxServices, raidEventIndex=raidEventIndex, hwSensorType=hwSensorType, eventTrap=eventTrap, partitionFreeSpace=partitionFreeSpace, serverServiceState=serverServiceState, trafficShapeEntry=trafficShapeEntry, eventGroups=eventGroups, noDelayTotal=noDelayTotal, ripNeighborsEntry=ripNeighborsEntry, class1Pakets=class1Pakets, ospfNeighborInterface=ospfNeighborInterface, fwStatsEntry=fwStatsEntry, vpnName=vpnName, connectorName=connectorName, SensorType=SensorType, fwStats=fwStats, hotfixInstallTime=hotfixInstallTime, vpnTunnelsEntry=vpnTunnelsEntry, ripGroup=ripGroup, phionHotfixesEntry=phionHotfixesEntry, vpnTunnels=vpnTunnels, raidGroup=raidGroup, phionHotfixes=phionHotfixes, partitionMaxSpace=partitionMaxSpace, event=event, class3Drop=class3Drop, partitionUsedSpace=partitionUsedSpace, dataThroughput64=dataThroughput64, eventClassification=eventClassification, ospfNeighborStatus=ospfNeighborStatus, ripNeighbors=ripNeighbors, bgpNeighborsEntry=bgpNeighborsEntry, serverServiceName=serverServiceName, eventAlarmTime=eventAlarmTime, raidEventSev=raidEventSev, eventID=eventID, PYSNMP_MODULE_ID=phion, netGroups=netGroups, serverServicesEntry=serverServicesEntry, serverGroup=serverGroup, rate=rate, boxGroup=boxGroup, class2Drop=class2Drop, diskSpaceEntry=diskSpaceEntry, ripNeighborAddress=ripNeighborAddress, hwGroups=hwGroups, packetThroughput64=packetThroughput64, dataThroughput=dataThroughput, notificationGroup=notificationGroup, boxServiceName=boxServiceName, hwGroup=hwGroup, class1Drop=class1Drop, fwCompliances=fwCompliances, serverServices=serverServices, eventLayerDescription=eventLayerDescription, ripNeighborState=ripNeighborState, ospfGroup=ospfGroup)
