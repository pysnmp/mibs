...
ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, iso, Gauge32, Unsigned32, MibIdentifier, Bits, ObjectIdentity, IpAddress, NotificationType, Counter32, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "iso", "Gauge32", "Unsigned32", "MibIdentifier", "Bits", "ObjectIdentity", "IpAddress", "NotificationType", "Counter32", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("PHION-MIB", phionHotfixesEntry=phionHotfixesEntry, packetThroughput64=packetThroughput64, raidEventText=raidEventText, packetThroughput=packetThroughput, bgpNeighborAddress=bgpNeighborAddress, event=event, firmwareGroups=firmwareGroups, serverGroup=serverGroup, raidEventIndex=raidEventIndex, VpnStates=VpnStates, eventID=eventID, boxGroup=boxGroup, hwGroup=hwGroup, fwCompliances=fwCompliances, serverServicesEntry=serverServicesEntry, phion=phion, diskspaceGroup=diskspaceGroup, bgpNeighborState=bgpNeighborState, class1Drop=class1Drop, boxServiceState=boxServiceState, fwStats=fwStats, vpnTunnels=vpnTunnels, ospfNeighbors=ospfNeighbors, ripNeighborAddress=ripNeighborAddress, trafficShapeEntry=trafficShapeEntry, firewall=firewall, firewallSessions64=firewallSessions64, eventAlarmTime=eventAlarmTime, class1Pakets=class1Pakets, hwSensorValue=hwSensorValue, dataThroughput64=dataThroughput64, hotfixInstallTime=hotfixInstallTime, ripNeighborsEntry=ripNeighborsEntry, fwCompliance=fwCompliance, class2Pakets=class2Pakets, trafficshapeGroup=trafficshapeGroup, vpnTunnelsEntry=vpnTunnelsEntry, ripNeighborState=ripNeighborState, eventTrap=eventTrap, vpnusersGroup=vpnusersGroup, partitionUsedSpacePercent=partitionUsedSpacePercent, eventGroups=eventGroups, raidEventsEntry=raidEventsEntry, SensorType=SensorType, ripNeighbors=ripNeighbors, PYSNMP_MODULE_ID=phion, hotfixGroup=hotfixGroup, class3Pakets=class3Pakets, vpnGroup=vpnGroup, ospfNeighborInterface=ospfNeighborInterface, diskSpace=diskSpace, raidEventTime=raidEventTime, sessions=sessions, hwSensorName=hwSensorName, hotfixName=hotfixName, trafficShape=trafficShape, eventLayerDescription=eventLayerDescription, ripGroup=ripGroup, bgpNeighborsEntry=bgpNeighborsEntry, releaseGroup=releaseGroup, netGroups=netGroups, bgpGroup=bgpGroup, rate=rate, vpnUsers=vpnUsers, boxServiceName=boxServiceName, noDelayPakets=noDelayPakets, hwSensorsEntry=hwSensorsEntry, fwStatsEntry=fwStatsEntry, raidEvents=raidEvents, hwGroups=hwGroups, ServiceState=ServiceState, firewallSessions=firewallSessions, class3Drop=class3Drop, hwSensors=hwSensors, serverServiceName=serverServiceName, ospfGroup=ospfGroup, class1Total=class1Total, vpnName=vpnName, serviceGroups=serviceGroups, eventRepresentation=eventRepresentation, diskSpaceEntry=diskSpaceEntry, notificationGroup=notificationGroup, dataThroughput=dataThroughput, class2Total=class2Total, class2Drop=class2Drop, boxServicesEntry=boxServicesEntry, fwGroups=fwGroups, bgpNeighbors=bgpNeighbors, noDelayTotal=noDelayTotal, ospfNeighborAddress=ospfNeighborAddress, hwSensorType=hwSensorType, ospfNeighborId=ospfNeighborId, eventGroup=eventGroup, serverServices=serverServices, RaidEventSeverity=RaidEventSeverity, ospfNeighborsEntry=ospfNeighborsEntry, raidGroup=raidGroup, partitionFreeSpace=partitionFreeSpace, partitionMaxSpace=partitionMaxSpace, partitionUsedSpace=partitionUsedSpace, vpnState=vpnState, serverServiceState=serverServiceState, partitionName=partitionName, ospfNeighborStatus=ospfNeighborStatus, fwstatsGroup=fwstatsGroup, noDelayDrop=noDelayDrop, class3Total=class3Total, eventClassification=eventClassification, eventType=eventType, eventSeverity=eventSeverity, boxServices=boxServices, phionRelease=phionRelease, connectorName=connectorName, eventIDDescription=eventIDDescription, phionHotfixes=phionHotfixes, raidEventSev=raidEventSev)
