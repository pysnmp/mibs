...
MibIdentifier, iso, Gauge32, NotificationType, enterprises, ObjectIdentity, Counter64, TimeTicks, ModuleIdentity, Bits, IpAddress, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "iso", "Gauge32", "NotificationType", "enterprises", "ObjectIdentity", "Counter64", "TimeTicks", "ModuleIdentity", "Bits", "IpAddress", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Integer32")
...
mibBuilder.exportSymbols("PHION-MIB", sessions=sessions, notificationGroup=notificationGroup, eventGroups=eventGroups, vpnTunnelsEntry=vpnTunnelsEntry, hwGroups=hwGroups, ospfNeighbors=ospfNeighbors, ripNeighborState=ripNeighborState, class1Total=class1Total, eventType=eventType, ospfNeighborsEntry=ospfNeighborsEntry, ospfGroup=ospfGroup, packetThroughput=packetThroughput, vpnGroup=vpnGroup, eventID=eventID, serverServicesEntry=serverServicesEntry, trafficShapeEntry=trafficShapeEntry, class3Total=class3Total, firewall=firewall, raidEventSev=raidEventSev, diskspaceGroup=diskspaceGroup, ripNeighbors=ripNeighbors, ripGroup=ripGroup, raidEventsEntry=raidEventsEntry, hwGroup=hwGroup, raidEvents=raidEvents, eventTrap=eventTrap, ospfNeighborInterface=ospfNeighborInterface, trafficshapeGroup=trafficshapeGroup, fwCompliances=fwCompliances, vpnState=vpnState, firewallSessions=firewallSessions, RaidEventSeverity=RaidEventSeverity, boxServiceState=boxServiceState, raidEventText=raidEventText, bgpNeighborState=bgpNeighborState, class2Total=class2Total, noDelayDrop=noDelayDrop, diskSpace=diskSpace, phion=phion, noDelayTotal=noDelayTotal, SensorType=SensorType, netGroups=netGroups, hwSensorType=hwSensorType, ripNeighborsEntry=ripNeighborsEntry, ospfNeighborId=ospfNeighborId, eventRepresentation=eventRepresentation, hwSensorName=hwSensorName, vpnUsers=vpnUsers, class3Pakets=class3Pakets, fwCompliance=fwCompliance, serverGroup=serverGroup, eventClassification=eventClassification, vpnusersGroup=vpnusersGroup, eventSeverity=eventSeverity, connectorName=connectorName, vpnTunnels=vpnTunnels, vpnName=vpnName, serverServiceState=serverServiceState, bgpNeighborAddress=bgpNeighborAddress, class3Drop=class3Drop, phionHotfixesEntry=phionHotfixesEntry, fwstatsGroup=fwstatsGroup, bgpNeighborsEntry=bgpNeighborsEntry, releaseGroup=releaseGroup, class2Pakets=class2Pakets, phionRelease=phionRelease, class2Drop=class2Drop, hotfixInstallTime=hotfixInstallTime, class1Drop=class1Drop, eventAlarmTime=eventAlarmTime, class1Pakets=class1Pakets, packetThroughput64=packetThroughput64, hwSensors=hwSensors, PYSNMP_MODULE_ID=phion, trafficShape=trafficShape, noDelayPakets=noDelayPakets, firewallSessions64=firewallSessions64, event=event, raidEventTime=raidEventTime, bgpGroup=bgpGroup, dataThroughput=dataThroughput, dataThroughput64=dataThroughput64, ospfNeighborAddress=ospfNeighborAddress, eventLayerDescription=eventLayerDescription, boxServices=boxServices, hotfixGroup=hotfixGroup, boxServiceName=boxServiceName, serverServices=serverServices, ServiceState=ServiceState, bgpNeighbors=bgpNeighbors, firmwareGroups=firmwareGroups, partitionMaxSpace=partitionMaxSpace, raidGroup=raidGroup, raidEventIndex=raidEventIndex, VpnStates=VpnStates, fwStats=fwStats, serverServiceName=serverServiceName, ospfNeighborStatus=ospfNeighborStatus, fwGroups=fwGroups, hotfixName=hotfixName, serviceGroups=serviceGroups, boxGroup=boxGroup, boxServicesEntry=boxServicesEntry, rate=rate, partitionName=partitionName, eventIDDescription=eventIDDescription, eventGroup=eventGroup, partitionUsedSpacePercent=partitionUsedSpacePercent, hwSensorsEntry=hwSensorsEntry, hwSensorValue=hwSensorValue, fwStatsEntry=fwStatsEntry, phionHotfixes=phionHotfixes, diskSpaceEntry=diskSpaceEntry, ripNeighborAddress=ripNeighborAddress, partitionUsedSpace=partitionUsedSpace, partitionFreeSpace=partitionFreeSpace)
