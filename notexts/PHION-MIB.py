...
Gauge32, NotificationType, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity, Unsigned32, Counter32, MibIdentifier, enterprises, Integer32, Counter64, TimeTicks, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity", "Unsigned32", "Counter32", "MibIdentifier", "enterprises", "Integer32", "Counter64", "TimeTicks", "IpAddress", "ModuleIdentity")
...
mibBuilder.exportSymbols("PHION-MIB", class1Pakets=class1Pakets, SensorType=SensorType, ripNeighbors=ripNeighbors, netGroups=netGroups, raidEventTime=raidEventTime, trafficshapeGroup=trafficshapeGroup, class3Drop=class3Drop, ospfNeighborInterface=ospfNeighborInterface, fwstatsGroup=fwstatsGroup, class2Drop=class2Drop, diskSpace=diskSpace, partitionFreeSpace=partitionFreeSpace, phion=phion, ospfNeighborAddress=ospfNeighborAddress, ospfGroup=ospfGroup, serverServices=serverServices, hwSensorName=hwSensorName, fwCompliances=fwCompliances, eventGroup=eventGroup, raidEvents=raidEvents, RaidEventSeverity=RaidEventSeverity, raidEventText=raidEventText, ospfNeighbors=ospfNeighbors, hwGroups=hwGroups, class1Total=class1Total, sessions=sessions, noDelayPakets=noDelayPakets, eventGroups=eventGroups, eventType=eventType, boxServiceName=boxServiceName, eventIDDescription=eventIDDescription, raidEventIndex=raidEventIndex, bgpGroup=bgpGroup, hwSensorsEntry=hwSensorsEntry, VpnStates=VpnStates, bgpNeighbors=bgpNeighbors, serverGroup=serverGroup, eventLayerDescription=eventLayerDescription, hotfixInstallTime=hotfixInstallTime, serverServiceState=serverServiceState, ripGroup=ripGroup, fwGroups=fwGroups, PYSNMP_MODULE_ID=phion, hotfixGroup=hotfixGroup, ripNeighborAddress=ripNeighborAddress, vpnTunnelsEntry=vpnTunnelsEntry, vpnState=vpnState, vpnTunnels=vpnTunnels, ripNeighborsEntry=ripNeighborsEntry, ospfNeighborStatus=ospfNeighborStatus, event=event, partitionName=partitionName, fwStats=fwStats, partitionUsedSpace=partitionUsedSpace, phionHotfixesEntry=phionHotfixesEntry, class3Total=class3Total, packetThroughput=packetThroughput, vpnGroup=vpnGroup, fwStatsEntry=fwStatsEntry, packetThroughput64=packetThroughput64, boxServiceState=boxServiceState, eventRepresentation=eventRepresentation, class2Total=class2Total, serverServiceName=serverServiceName, ripNeighborState=ripNeighborState, eventClassification=eventClassification, firewallSessions64=firewallSessions64, dataThroughput64=dataThroughput64, boxGroup=boxGroup, connectorName=connectorName, raidGroup=raidGroup, serverServicesEntry=serverServicesEntry, hwSensors=hwSensors, phionHotfixes=phionHotfixes, bgpNeighborAddress=bgpNeighborAddress, bgpNeighborState=bgpNeighborState, phionRelease=phionRelease, firmwareGroups=firmwareGroups, hwGroup=hwGroup, bgpNeighborsEntry=bgpNeighborsEntry, boxServices=boxServices, eventTrap=eventTrap, dataThroughput=dataThroughput, eventID=eventID, partitionUsedSpacePercent=partitionUsedSpacePercent, releaseGroup=releaseGroup, diskSpaceEntry=diskSpaceEntry, firewallSessions=firewallSessions, trafficShapeEntry=trafficShapeEntry, fwCompliance=fwCompliance, boxServicesEntry=boxServicesEntry, eventSeverity=eventSeverity, eventAlarmTime=eventAlarmTime, ServiceState=ServiceState, ospfNeighborId=ospfNeighborId, vpnName=vpnName, diskspaceGroup=diskspaceGroup, vpnusersGroup=vpnusersGroup, serviceGroups=serviceGroups, firewall=firewall, rate=rate, hwSensorType=hwSensorType, notificationGroup=notificationGroup, ospfNeighborsEntry=ospfNeighborsEntry, class2Pakets=class2Pakets, trafficShape=trafficShape, noDelayTotal=noDelayTotal, vpnUsers=vpnUsers, partitionMaxSpace=partitionMaxSpace, noDelayDrop=noDelayDrop, hwSensorValue=hwSensorValue, class3Pakets=class3Pakets, raidEventSev=raidEventSev, class1Drop=class1Drop, hotfixName=hotfixName, raidEventsEntry=raidEventsEntry)
