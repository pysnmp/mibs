...
Bits, ModuleIdentity, Unsigned32, TimeTicks, Integer32, Counter64, enterprises, Gauge32, NotificationType, Counter32, IpAddress, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "Unsigned32", "TimeTicks", "Integer32", "Counter64", "enterprises", "Gauge32", "NotificationType", "Counter32", "IpAddress", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity")
...
mibBuilder.exportSymbols("PHION-MIB", hwSensorValue=hwSensorValue, raidEventIndex=raidEventIndex, serverGroup=serverGroup, RaidEventSeverity=RaidEventSeverity, phionRelease=phionRelease, ripNeighborState=ripNeighborState, ripNeighborAddress=ripNeighborAddress, bgpNeighborState=bgpNeighborState, vpnTunnelsEntry=vpnTunnelsEntry, firmwareGroups=firmwareGroups, hwSensors=hwSensors, phionHotfixes=phionHotfixes, releaseGroup=releaseGroup, ServiceState=ServiceState, firewall=firewall, raidGroup=raidGroup, netGroups=netGroups, serverServiceState=serverServiceState, fwCompliances=fwCompliances, bgpGroup=bgpGroup, connectorName=connectorName, trafficShape=trafficShape, partitionMaxSpace=partitionMaxSpace, fwGroups=fwGroups, class3Drop=class3Drop, eventType=eventType, diskSpaceEntry=diskSpaceEntry, raidEventText=raidEventText, fwCompliance=fwCompliance, fwStatsEntry=fwStatsEntry, eventIDDescription=eventIDDescription, packetThroughput64=packetThroughput64, hwGroups=hwGroups, hwSensorName=hwSensorName, ospfGroup=ospfGroup, phionHotfixesEntry=phionHotfixesEntry, class2Drop=class2Drop, SensorType=SensorType, boxServiceState=boxServiceState, raidEventTime=raidEventTime, eventTrap=eventTrap, rate=rate, class2Pakets=class2Pakets, notificationGroup=notificationGroup, partitionName=partitionName, vpnUsers=vpnUsers, serverServices=serverServices, raidEventsEntry=raidEventsEntry, ripGroup=ripGroup, diskSpace=diskSpace, vpnusersGroup=vpnusersGroup, eventClassification=eventClassification, bgpNeighborAddress=bgpNeighborAddress, eventID=eventID, packetThroughput=packetThroughput, noDelayPakets=noDelayPakets, dataThroughput64=dataThroughput64, boxServicesEntry=boxServicesEntry, bgpNeighborsEntry=bgpNeighborsEntry, noDelayTotal=noDelayTotal, class1Drop=class1Drop, phion=phion, ospfNeighborAddress=ospfNeighborAddress, ospfNeighborInterface=ospfNeighborInterface, trafficshapeGroup=trafficshapeGroup, ospfNeighbors=ospfNeighbors, hwSensorsEntry=hwSensorsEntry, vpnName=vpnName, bgpNeighbors=bgpNeighbors, noDelayDrop=noDelayDrop, class3Total=class3Total, partitionUsedSpacePercent=partitionUsedSpacePercent, fwstatsGroup=fwstatsGroup, vpnState=vpnState, vpnGroup=vpnGroup, diskspaceGroup=diskspaceGroup, hotfixGroup=hotfixGroup, hwGroup=hwGroup, partitionUsedSpace=partitionUsedSpace, serviceGroups=serviceGroups, hotfixName=hotfixName, trafficShapeEntry=trafficShapeEntry, sessions=sessions, ospfNeighborsEntry=ospfNeighborsEntry, boxServiceName=boxServiceName, ospfNeighborId=ospfNeighborId, class2Total=class2Total, event=event, partitionFreeSpace=partitionFreeSpace, eventSeverity=eventSeverity, class1Total=class1Total, eventRepresentation=eventRepresentation, class3Pakets=class3Pakets, eventAlarmTime=eventAlarmTime, class1Pakets=class1Pakets, eventGroups=eventGroups, ospfNeighborStatus=ospfNeighborStatus, VpnStates=VpnStates, dataThroughput=dataThroughput, vpnTunnels=vpnTunnels, hwSensorType=hwSensorType, hotfixInstallTime=hotfixInstallTime, ripNeighbors=ripNeighbors, PYSNMP_MODULE_ID=phion, boxServices=boxServices, firewallSessions64=firewallSessions64, raidEvents=raidEvents, eventLayerDescription=eventLayerDescription, eventGroup=eventGroup, serverServiceName=serverServiceName, ripNeighborsEntry=ripNeighborsEntry, fwStats=fwStats, serverServicesEntry=serverServicesEntry, boxGroup=boxGroup, firewallSessions=firewallSessions, raidEventSev=raidEventSev)
