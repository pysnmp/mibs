...
ModuleIdentity, MibIdentifier, Unsigned32, TimeTicks, iso, Counter64, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32, enterprises, NotificationType, IpAddress, Counter32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibIdentifier", "Unsigned32", "TimeTicks", "iso", "Counter64", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32", "enterprises", "NotificationType", "IpAddress", "Counter32", "ObjectIdentity")
...
mibBuilder.exportSymbols("PHION-MIB", partitionUsedSpacePercent=partitionUsedSpacePercent, hwSensorName=hwSensorName, vpnUsers=vpnUsers, diskSpace=diskSpace, class3Total=class3Total, class2Total=class2Total, raidEventIndex=raidEventIndex, ospfNeighborStatus=ospfNeighborStatus, phionHotfixesEntry=phionHotfixesEntry, partitionMaxSpace=partitionMaxSpace, serverGroup=serverGroup, diskspaceGroup=diskspaceGroup, ripNeighbors=ripNeighbors, class3Drop=class3Drop, fwGroups=fwGroups, boxServiceName=boxServiceName, bgpNeighborsEntry=bgpNeighborsEntry, rate=rate, partitionFreeSpace=partitionFreeSpace, eventGroups=eventGroups, RaidEventSeverity=RaidEventSeverity, SensorType=SensorType, releaseGroup=releaseGroup, dataThroughput64=dataThroughput64, fwstatsGroup=fwstatsGroup, notificationGroup=notificationGroup, hwGroups=hwGroups, packetThroughput=packetThroughput, partitionName=partitionName, ServiceState=ServiceState, PYSNMP_MODULE_ID=phion, fwStatsEntry=fwStatsEntry, raidEventSev=raidEventSev, fwCompliance=fwCompliance, hwSensorValue=hwSensorValue, event=event, firewallSessions=firewallSessions, netGroups=netGroups, ospfGroup=ospfGroup, boxServiceState=boxServiceState, eventID=eventID, raidEventText=raidEventText, diskSpaceEntry=diskSpaceEntry, partitionUsedSpace=partitionUsedSpace, vpnGroup=vpnGroup, ospfNeighborId=ospfNeighborId, eventGroup=eventGroup, serverServiceName=serverServiceName, noDelayPakets=noDelayPakets, hwGroup=hwGroup, trafficShape=trafficShape, bgpNeighborAddress=bgpNeighborAddress, eventClassification=eventClassification, phionHotfixes=phionHotfixes, noDelayTotal=noDelayTotal, eventTrap=eventTrap, ospfNeighborAddress=ospfNeighborAddress, serverServiceState=serverServiceState, dataThroughput=dataThroughput, ripNeighborState=ripNeighborState, phionRelease=phionRelease, trafficShapeEntry=trafficShapeEntry, vpnState=vpnState, class2Drop=class2Drop, hwSensorType=hwSensorType, eventType=eventType, packetThroughput64=packetThroughput64, bgpGroup=bgpGroup, class1Total=class1Total, boxServices=boxServices, bgpNeighbors=bgpNeighbors, raidEventsEntry=raidEventsEntry, eventRepresentation=eventRepresentation, vpnTunnels=vpnTunnels, firewallSessions64=firewallSessions64, phion=phion, raidEvents=raidEvents, bgpNeighborState=bgpNeighborState, hwSensorsEntry=hwSensorsEntry, vpnName=vpnName, VpnStates=VpnStates, serviceGroups=serviceGroups, ripNeighborsEntry=ripNeighborsEntry, vpnusersGroup=vpnusersGroup, fwStats=fwStats, class2Pakets=class2Pakets, boxServicesEntry=boxServicesEntry, eventAlarmTime=eventAlarmTime, trafficshapeGroup=trafficshapeGroup, raidGroup=raidGroup, eventIDDescription=eventIDDescription, serverServicesEntry=serverServicesEntry, eventLayerDescription=eventLayerDescription, firewall=firewall, fwCompliances=fwCompliances, class3Pakets=class3Pakets, hotfixGroup=hotfixGroup, ospfNeighborsEntry=ospfNeighborsEntry, raidEventTime=raidEventTime, firmwareGroups=firmwareGroups, hotfixInstallTime=hotfixInstallTime, class1Drop=class1Drop, sessions=sessions, noDelayDrop=noDelayDrop, vpnTunnelsEntry=vpnTunnelsEntry, ospfNeighbors=ospfNeighbors, ripGroup=ripGroup, boxGroup=boxGroup, hwSensors=hwSensors, ospfNeighborInterface=ospfNeighborInterface, eventSeverity=eventSeverity, hotfixName=hotfixName, connectorName=connectorName, serverServices=serverServices, class1Pakets=class1Pakets, ripNeighborAddress=ripNeighborAddress)
