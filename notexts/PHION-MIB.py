...
mibBuilder.exportSymbols("PHION-MIB", eventID=eventID, ripNeighborAddress=ripNeighborAddress, firewallSessions=firewallSessions, eventType=eventType, hwGroup=hwGroup, eventSeverity=eventSeverity, class2Pakets=class2Pakets, ServiceState=ServiceState, ripNeighbors=ripNeighbors, hwSensorValue=hwSensorValue, vpnTunnelsEntry=vpnTunnelsEntry, fwStatsEntry=fwStatsEntry, partitionName=partitionName, class1Drop=class1Drop, phionHotfixes=phionHotfixes, serverServiceName=serverServiceName, ospfNeighborId=ospfNeighborId, boxGroup=boxGroup, serverServicesEntry=serverServicesEntry, class3Total=class3Total, fwGroups=fwGroups, bgpNeighborAddress=bgpNeighborAddress, eventLayerDescription=eventLayerDescription, raidEventIndex=raidEventIndex, bgpNeighborsEntry=bgpNeighborsEntry, hwSensorType=hwSensorType, ospfNeighborAddress=ospfNeighborAddress, hwSensorsEntry=hwSensorsEntry, vpnusersGroup=vpnusersGroup, partitionUsedSpacePercent=partitionUsedSpacePercent, vpnState=vpnState, vpnUsers=vpnUsers, diskSpace=diskSpace, trafficShapeEntry=trafficShapeEntry, SensorType=SensorType, serviceGroups=serviceGroups, trafficShape=trafficShape, phionRelease=phionRelease, ospfGroup=ospfGroup, connectorName=connectorName, diskSpaceEntry=diskSpaceEntry, ospfNeighborInterface=ospfNeighborInterface, raidEvents=raidEvents, class3Drop=class3Drop, serverGroup=serverGroup, trafficshapeGroup=trafficshapeGroup, ripNeighborsEntry=ripNeighborsEntry, hwSensorName=hwSensorName, serverServiceState=serverServiceState, fwCompliance=fwCompliance, VpnStates=VpnStates, notificationGroup=notificationGroup, boxServiceName=boxServiceName, boxServicesEntry=boxServicesEntry, event=event, ripGroup=ripGroup, vpnGroup=vpnGroup, boxServices=boxServices, hotfixGroup=hotfixGroup, class1Pakets=class1Pakets, noDelayPakets=noDelayPakets, hwGroups=hwGroups, fwstatsGroup=fwstatsGroup, sessions=sessions, eventClassification=eventClassification, fwCompliances=fwCompliances, eventGroup=eventGroup, bgpGroup=bgpGroup, hotfixInstallTime=hotfixInstallTime, hotfixName=hotfixName, firmwareGroups=firmwareGroups, phionHotfixesEntry=phionHotfixesEntry, ospfNeighborsEntry=ospfNeighborsEntry, RaidEventSeverity=RaidEventSeverity, firewallSessions64=firewallSessions64, vpnTunnels=vpnTunnels, bgpNeighbors=bgpNeighbors, ospfNeighborStatus=ospfNeighborStatus, releaseGroup=releaseGroup, class2Drop=class2Drop, dataThroughput64=dataThroughput64, serverServices=serverServices, hwSensors=hwSensors, raidGroup=raidGroup, partitionMaxSpace=partitionMaxSpace, rate=rate, raidEventText=raidEventText, phion=phion, packetThroughput=packetThroughput, netGroups=netGroups, PYSNMP_MODULE_ID=phion, eventGroups=eventGroups, noDelayDrop=noDelayDrop, boxServiceState=boxServiceState, bgpNeighborState=bgpNeighborState, raidEventsEntry=raidEventsEntry, dataThroughput=dataThroughput, eventTrap=eventTrap, class1Total=class1Total, eventRepresentation=eventRepresentation, class3Pakets=class3Pakets, eventIDDescription=eventIDDescription, ospfNeighbors=ospfNeighbors, eventAlarmTime=eventAlarmTime, firewall=firewall, raidEventTime=raidEventTime, ripNeighborState=ripNeighborState, partitionUsedSpace=partitionUsedSpace, packetThroughput64=packetThroughput64, diskspaceGroup=diskspaceGroup, partitionFreeSpace=partitionFreeSpace, fwStats=fwStats, class2Total=class2Total, raidEventSev=raidEventSev, vpnName=vpnName, noDelayTotal=noDelayTotal)
