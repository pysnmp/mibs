...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Unsigned32, iso, Integer32, Bits, ModuleIdentity, TimeTicks, Counter64, Counter32, ObjectIdentity, NotificationType, MibIdentifier, enterprises, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Unsigned32", "iso", "Integer32", "Bits", "ModuleIdentity", "TimeTicks", "Counter64", "Counter32", "ObjectIdentity", "NotificationType", "MibIdentifier", "enterprises", "Gauge32")
...
mibBuilder.exportSymbols("PHION-MIB", hwGroups=hwGroups, class1Drop=class1Drop, releaseGroup=releaseGroup, vpnUsers=vpnUsers, hotfixInstallTime=hotfixInstallTime, class1Pakets=class1Pakets, serverGroup=serverGroup, ospfNeighbors=ospfNeighbors, boxServicesEntry=boxServicesEntry, ripNeighborAddress=ripNeighborAddress, firewallSessions64=firewallSessions64, ospfGroup=ospfGroup, trafficShape=trafficShape, netGroups=netGroups, dataThroughput=dataThroughput, class3Pakets=class3Pakets, rate=rate, eventGroup=eventGroup, ospfNeighborId=ospfNeighborId, eventRepresentation=eventRepresentation, phionRelease=phionRelease, raidEvents=raidEvents, class2Drop=class2Drop, serverServicesEntry=serverServicesEntry, hwSensorsEntry=hwSensorsEntry, PYSNMP_MODULE_ID=phion, firewall=firewall, eventSeverity=eventSeverity, class2Pakets=class2Pakets, bgpNeighborAddress=bgpNeighborAddress, boxServiceName=boxServiceName, SensorType=SensorType, vpnState=vpnState, bgpNeighbors=bgpNeighbors, ospfNeighborAddress=ospfNeighborAddress, partitionFreeSpace=partitionFreeSpace, ripNeighborsEntry=ripNeighborsEntry, bgpNeighborState=bgpNeighborState, hwSensors=hwSensors, ripNeighborState=ripNeighborState, vpnTunnelsEntry=vpnTunnelsEntry, eventGroups=eventGroups, boxServiceState=boxServiceState, firmwareGroups=firmwareGroups, class3Total=class3Total, raidEventIndex=raidEventIndex, hwSensorValue=hwSensorValue, class3Drop=class3Drop, serverServiceName=serverServiceName, hwGroup=hwGroup, fwCompliances=fwCompliances, hwSensorType=hwSensorType, ServiceState=ServiceState, VpnStates=VpnStates, class1Total=class1Total, bgpGroup=bgpGroup, noDelayPakets=noDelayPakets, packetThroughput64=packetThroughput64, fwStats=fwStats, ripNeighbors=ripNeighbors, serverServices=serverServices, raidEventTime=raidEventTime, eventID=eventID, fwstatsGroup=fwstatsGroup, RaidEventSeverity=RaidEventSeverity, raidEventText=raidEventText, noDelayTotal=noDelayTotal, eventAlarmTime=eventAlarmTime, trafficshapeGroup=trafficshapeGroup, boxGroup=boxGroup, phionHotfixes=phionHotfixes, partitionMaxSpace=partitionMaxSpace, hotfixName=hotfixName, notificationGroup=notificationGroup, ospfNeighborsEntry=ospfNeighborsEntry, phion=phion, eventLayerDescription=eventLayerDescription, packetThroughput=packetThroughput, raidGroup=raidGroup, raidEventSev=raidEventSev, ospfNeighborInterface=ospfNeighborInterface, class2Total=class2Total, fwGroups=fwGroups, serverServiceState=serverServiceState, fwStatsEntry=fwStatsEntry, firewallSessions=firewallSessions, trafficShapeEntry=trafficShapeEntry, vpnusersGroup=vpnusersGroup, vpnName=vpnName, eventIDDescription=eventIDDescription, eventClassification=eventClassification, serviceGroups=serviceGroups, vpnGroup=vpnGroup, eventTrap=eventTrap, diskSpace=diskSpace, ospfNeighborStatus=ospfNeighborStatus, sessions=sessions, noDelayDrop=noDelayDrop, boxServices=boxServices, diskSpaceEntry=diskSpaceEntry, phionHotfixesEntry=phionHotfixesEntry, diskspaceGroup=diskspaceGroup, connectorName=connectorName, ripGroup=ripGroup, fwCompliance=fwCompliance, hotfixGroup=hotfixGroup, partitionUsedSpacePercent=partitionUsedSpacePercent, partitionName=partitionName, hwSensorName=hwSensorName, dataThroughput64=dataThroughput64, raidEventsEntry=raidEventsEntry, event=event, eventType=eventType, vpnTunnels=vpnTunnels, partitionUsedSpace=partitionUsedSpace, bgpNeighborsEntry=bgpNeighborsEntry)
