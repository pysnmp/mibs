...
ModuleIdentity, MibIdentifier, NotificationType, Integer32, Unsigned32, Counter64, Gauge32, Bits, ObjectIdentity, IpAddress, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, iso, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibIdentifier", "NotificationType", "Integer32", "Unsigned32", "Counter64", "Gauge32", "Bits", "ObjectIdentity", "IpAddress", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "iso", "TimeTicks")
...
mibBuilder.exportSymbols("PHION-MIB", boxServiceState=boxServiceState, diskSpace=diskSpace, diskspaceGroup=diskspaceGroup, ospfNeighborInterface=ospfNeighborInterface, ospfGroup=ospfGroup, ripGroup=ripGroup, hwGroup=hwGroup, trafficShape=trafficShape, boxServices=boxServices, serverServiceState=serverServiceState, RaidEventSeverity=RaidEventSeverity, serverGroup=serverGroup, phionRelease=phionRelease, ServiceState=ServiceState, raidEventIndex=raidEventIndex, fwStatsEntry=fwStatsEntry, fwCompliances=fwCompliances, partitionMaxSpace=partitionMaxSpace, vpnState=vpnState, eventGroups=eventGroups, raidEventTime=raidEventTime, dataThroughput=dataThroughput, hwGroups=hwGroups, diskSpaceEntry=diskSpaceEntry, vpnusersGroup=vpnusersGroup, eventAlarmTime=eventAlarmTime, rate=rate, releaseGroup=releaseGroup, raidGroup=raidGroup, class1Drop=class1Drop, VpnStates=VpnStates, serverServiceName=serverServiceName, boxServiceName=boxServiceName, eventLayerDescription=eventLayerDescription, serverServicesEntry=serverServicesEntry, trafficshapeGroup=trafficshapeGroup, event=event, boxGroup=boxGroup, hwSensorsEntry=hwSensorsEntry, bgpNeighborAddress=bgpNeighborAddress, packetThroughput=packetThroughput, fwGroups=fwGroups, bgpNeighborState=bgpNeighborState, bgpNeighborsEntry=bgpNeighborsEntry, ripNeighborAddress=ripNeighborAddress, eventSeverity=eventSeverity, class3Pakets=class3Pakets, phion=phion, raidEventsEntry=raidEventsEntry, class2Total=class2Total, eventType=eventType, vpnName=vpnName, netGroups=netGroups, sessions=sessions, partitionUsedSpacePercent=partitionUsedSpacePercent, bgpGroup=bgpGroup, vpnGroup=vpnGroup, class1Pakets=class1Pakets, noDelayPakets=noDelayPakets, vpnTunnelsEntry=vpnTunnelsEntry, notificationGroup=notificationGroup, fwCompliance=fwCompliance, eventTrap=eventTrap, packetThroughput64=packetThroughput64, fwstatsGroup=fwstatsGroup, dataThroughput64=dataThroughput64, hotfixGroup=hotfixGroup, hwSensorValue=hwSensorValue, ospfNeighborAddress=ospfNeighborAddress, hwSensors=hwSensors, partitionUsedSpace=partitionUsedSpace, eventRepresentation=eventRepresentation, ospfNeighborsEntry=ospfNeighborsEntry, class2Pakets=class2Pakets, class3Drop=class3Drop, noDelayTotal=noDelayTotal, connectorName=connectorName, eventID=eventID, serviceGroups=serviceGroups, ospfNeighbors=ospfNeighbors, eventIDDescription=eventIDDescription, ripNeighborsEntry=ripNeighborsEntry, ripNeighborState=ripNeighborState, eventClassification=eventClassification, phionHotfixes=phionHotfixes, firewall=firewall, hwSensorType=hwSensorType, raidEventText=raidEventText, class3Total=class3Total, eventGroup=eventGroup, noDelayDrop=noDelayDrop, vpnTunnels=vpnTunnels, phionHotfixesEntry=phionHotfixesEntry, firewallSessions64=firewallSessions64, hotfixInstallTime=hotfixInstallTime, vpnUsers=vpnUsers, partitionName=partitionName, ripNeighbors=ripNeighbors, hotfixName=hotfixName, fwStats=fwStats, ospfNeighborId=ospfNeighborId, partitionFreeSpace=partitionFreeSpace, raidEvents=raidEvents, bgpNeighbors=bgpNeighbors, raidEventSev=raidEventSev, firmwareGroups=firmwareGroups, class1Total=class1Total, ospfNeighborStatus=ospfNeighborStatus, boxServicesEntry=boxServicesEntry, trafficShapeEntry=trafficShapeEntry, serverServices=serverServices, hwSensorName=hwSensorName, class2Drop=class2Drop, firewallSessions=firewallSessions, PYSNMP_MODULE_ID=phion, SensorType=SensorType)
