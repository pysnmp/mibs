...
NotificationType, Counter32, Counter64, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, enterprises, ObjectIdentity, MibIdentifier, IpAddress, Integer32, Unsigned32, TimeTicks, ModuleIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "Counter64", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "enterprises", "ObjectIdentity", "MibIdentifier", "IpAddress", "Integer32", "Unsigned32", "TimeTicks", "ModuleIdentity", "iso")
...
mibBuilder.exportSymbols("PHION-MIB", serverServicesEntry=serverServicesEntry, RaidEventSeverity=RaidEventSeverity, hwSensorType=hwSensorType, eventRepresentation=eventRepresentation, hotfixInstallTime=hotfixInstallTime, class2Drop=class2Drop, raidEvents=raidEvents, partitionMaxSpace=partitionMaxSpace, diskspaceGroup=diskspaceGroup, ospfGroup=ospfGroup, ripNeighbors=ripNeighbors, hwGroups=hwGroups, ripNeighborState=ripNeighborState, SensorType=SensorType, partitionUsedSpace=partitionUsedSpace, vpnTunnelsEntry=vpnTunnelsEntry, fwCompliance=fwCompliance, vpnState=vpnState, boxServiceState=boxServiceState, bgpNeighbors=bgpNeighbors, eventLayerDescription=eventLayerDescription, bgpNeighborsEntry=bgpNeighborsEntry, fwStats=fwStats, boxServicesEntry=boxServicesEntry, bgpNeighborState=bgpNeighborState, class3Total=class3Total, noDelayDrop=noDelayDrop, diskSpace=diskSpace, netGroups=netGroups, releaseGroup=releaseGroup, hotfixGroup=hotfixGroup, notificationGroup=notificationGroup, dataThroughput64=dataThroughput64, raidEventSev=raidEventSev, diskSpaceEntry=diskSpaceEntry, partitionName=partitionName, ospfNeighborId=ospfNeighborId, rate=rate, eventID=eventID, eventType=eventType, hwSensorValue=hwSensorValue, raidEventIndex=raidEventIndex, event=event, bgpNeighborAddress=bgpNeighborAddress, raidEventTime=raidEventTime, phionHotfixes=phionHotfixes, eventAlarmTime=eventAlarmTime, class3Drop=class3Drop, ospfNeighborsEntry=ospfNeighborsEntry, fwStatsEntry=fwStatsEntry, phion=phion, class2Pakets=class2Pakets, firewall=firewall, bgpGroup=bgpGroup, ripGroup=ripGroup, class1Drop=class1Drop, partitionFreeSpace=partitionFreeSpace, ripNeighborAddress=ripNeighborAddress, eventTrap=eventTrap, class2Total=class2Total, hwSensorName=hwSensorName, eventGroup=eventGroup, ospfNeighborAddress=ospfNeighborAddress, hwSensorsEntry=hwSensorsEntry, trafficshapeGroup=trafficshapeGroup, serverServiceName=serverServiceName, class1Pakets=class1Pakets, partitionUsedSpacePercent=partitionUsedSpacePercent, serverGroup=serverGroup, boxServices=boxServices, connectorName=connectorName, noDelayTotal=noDelayTotal, hwGroup=hwGroup, eventGroups=eventGroups, ospfNeighbors=ospfNeighbors, serverServiceState=serverServiceState, class3Pakets=class3Pakets, raidGroup=raidGroup, eventIDDescription=eventIDDescription, serviceGroups=serviceGroups, ospfNeighborInterface=ospfNeighborInterface, firewallSessions64=firewallSessions64, phionRelease=phionRelease, trafficShapeEntry=trafficShapeEntry, noDelayPakets=noDelayPakets, vpnName=vpnName, VpnStates=VpnStates, hwSensors=hwSensors, eventSeverity=eventSeverity, vpnGroup=vpnGroup, fwstatsGroup=fwstatsGroup, sessions=sessions, fwCompliances=fwCompliances, packetThroughput64=packetThroughput64, PYSNMP_MODULE_ID=phion, raidEventsEntry=raidEventsEntry, fwGroups=fwGroups, packetThroughput=packetThroughput, eventClassification=eventClassification, firmwareGroups=firmwareGroups, vpnUsers=vpnUsers, boxGroup=boxGroup, dataThroughput=dataThroughput, ospfNeighborStatus=ospfNeighborStatus, ServiceState=ServiceState, serverServices=serverServices, firewallSessions=firewallSessions, boxServiceName=boxServiceName, vpnTunnels=vpnTunnels, vpnusersGroup=vpnusersGroup, trafficShape=trafficShape, phionHotfixesEntry=phionHotfixesEntry, class1Total=class1Total, raidEventText=raidEventText, hotfixName=hotfixName, ripNeighborsEntry=ripNeighborsEntry)
