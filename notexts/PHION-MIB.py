...
Counter32, TimeTicks, Counter64, iso, MibIdentifier, Integer32, Bits, Gauge32, NotificationType, ObjectIdentity, Unsigned32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "TimeTicks", "Counter64", "iso", "MibIdentifier", "Integer32", "Bits", "Gauge32", "NotificationType", "ObjectIdentity", "Unsigned32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ModuleIdentity")
...
mibBuilder.exportSymbols("PHION-MIB", eventID=eventID, hwGroup=hwGroup, class3Pakets=class3Pakets, class3Drop=class3Drop, ServiceState=ServiceState, eventGroup=eventGroup, eventGroups=eventGroups, partitionFreeSpace=partitionFreeSpace, ospfNeighborsEntry=ospfNeighborsEntry, trafficShape=trafficShape, bgpNeighborState=bgpNeighborState, diskSpaceEntry=diskSpaceEntry, serverServiceName=serverServiceName, ospfNeighbors=ospfNeighbors, eventIDDescription=eventIDDescription, raidEventText=raidEventText, hotfixInstallTime=hotfixInstallTime, eventType=eventType, phionRelease=phionRelease, boxServiceState=boxServiceState, rate=rate, diskspaceGroup=diskspaceGroup, eventClassification=eventClassification, sessions=sessions, connectorName=connectorName, hwSensorsEntry=hwSensorsEntry, vpnusersGroup=vpnusersGroup, phionHotfixes=phionHotfixes, eventSeverity=eventSeverity, partitionUsedSpacePercent=partitionUsedSpacePercent, serverServicesEntry=serverServicesEntry, trafficshapeGroup=trafficshapeGroup, phion=phion, boxServicesEntry=boxServicesEntry, hwGroups=hwGroups, fwCompliance=fwCompliance, hotfixName=hotfixName, serverServices=serverServices, PYSNMP_MODULE_ID=phion, fwStatsEntry=fwStatsEntry, vpnName=vpnName, vpnTunnels=vpnTunnels, packetThroughput=packetThroughput, class2Total=class2Total, raidEvents=raidEvents, phionHotfixesEntry=phionHotfixesEntry, SensorType=SensorType, eventAlarmTime=eventAlarmTime, bgpNeighborAddress=bgpNeighborAddress, ripNeighborState=ripNeighborState, ospfNeighborId=ospfNeighborId, eventTrap=eventTrap, raidGroup=raidGroup, VpnStates=VpnStates, class2Drop=class2Drop, fwCompliances=fwCompliances, vpnGroup=vpnGroup, RaidEventSeverity=RaidEventSeverity, class1Total=class1Total, ospfGroup=ospfGroup, diskSpace=diskSpace, dataThroughput64=dataThroughput64, dataThroughput=dataThroughput, netGroups=netGroups, ripNeighbors=ripNeighbors, noDelayDrop=noDelayDrop, ripNeighborsEntry=ripNeighborsEntry, raidEventSev=raidEventSev, firewall=firewall, bgpNeighborsEntry=bgpNeighborsEntry, firewallSessions64=firewallSessions64, firewallSessions=firewallSessions, releaseGroup=releaseGroup, ripNeighborAddress=ripNeighborAddress, serverGroup=serverGroup, ospfNeighborInterface=ospfNeighborInterface, vpnTunnelsEntry=vpnTunnelsEntry, vpnState=vpnState, class3Total=class3Total, boxServices=boxServices, bgpNeighbors=bgpNeighbors, class1Drop=class1Drop, partitionName=partitionName, class1Pakets=class1Pakets, event=event, raidEventTime=raidEventTime, serviceGroups=serviceGroups, packetThroughput64=packetThroughput64, bgpGroup=bgpGroup, vpnUsers=vpnUsers, raidEventIndex=raidEventIndex, notificationGroup=notificationGroup, raidEventsEntry=raidEventsEntry, eventRepresentation=eventRepresentation, partitionMaxSpace=partitionMaxSpace, trafficShapeEntry=trafficShapeEntry, hwSensorType=hwSensorType, fwStats=fwStats, firmwareGroups=firmwareGroups, boxGroup=boxGroup, class2Pakets=class2Pakets, fwGroups=fwGroups, ospfNeighborAddress=ospfNeighborAddress, ripGroup=ripGroup, hwSensorName=hwSensorName, ospfNeighborStatus=ospfNeighborStatus, hotfixGroup=hotfixGroup, hwSensorValue=hwSensorValue, hwSensors=hwSensors, noDelayTotal=noDelayTotal, fwstatsGroup=fwstatsGroup, boxServiceName=boxServiceName, eventLayerDescription=eventLayerDescription, serverServiceState=serverServiceState, partitionUsedSpace=partitionUsedSpace, noDelayPakets=noDelayPakets)
