...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType, Gauge32, Bits, MibIdentifier, IpAddress, enterprises, Counter32, Unsigned32, Integer32, Counter64, ObjectIdentity, ModuleIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType", "Gauge32", "Bits", "MibIdentifier", "IpAddress", "enterprises", "Counter32", "Unsigned32", "Integer32", "Counter64", "ObjectIdentity", "ModuleIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("PHION-MIB", hotfixName=hotfixName, serviceGroups=serviceGroups, vpnTunnels=vpnTunnels, ospfNeighborStatus=ospfNeighborStatus, ospfNeighbors=ospfNeighbors, partitionUsedSpace=partitionUsedSpace, partitionFreeSpace=partitionFreeSpace, hotfixInstallTime=hotfixInstallTime, class1Total=class1Total, class1Drop=class1Drop, eventRepresentation=eventRepresentation, boxServiceState=boxServiceState, raidEventTime=raidEventTime, fwstatsGroup=fwstatsGroup, fwCompliance=fwCompliance, serverServiceState=serverServiceState, dataThroughput=dataThroughput, raidEventsEntry=raidEventsEntry, bgpNeighborAddress=bgpNeighborAddress, bgpNeighborState=bgpNeighborState, fwCompliances=fwCompliances, firewallSessions64=firewallSessions64, raidEventSev=raidEventSev, netGroups=netGroups, raidEventText=raidEventText, phionHotfixes=phionHotfixes, RaidEventSeverity=RaidEventSeverity, ripNeighbors=ripNeighbors, eventAlarmTime=eventAlarmTime, vpnGroup=vpnGroup, eventType=eventType, boxGroup=boxGroup, noDelayPakets=noDelayPakets, hwSensorName=hwSensorName, hwGroup=hwGroup, firmwareGroups=firmwareGroups, phionRelease=phionRelease, serverServiceName=serverServiceName, raidEventIndex=raidEventIndex, class3Pakets=class3Pakets, eventID=eventID, raidEvents=raidEvents, partitionName=partitionName, boxServicesEntry=boxServicesEntry, diskspaceGroup=diskspaceGroup, trafficShapeEntry=trafficShapeEntry, SensorType=SensorType, dataThroughput64=dataThroughput64, packetThroughput=packetThroughput, class1Pakets=class1Pakets, ospfNeighborInterface=ospfNeighborInterface, diskSpace=diskSpace, ospfNeighborAddress=ospfNeighborAddress, ripNeighborsEntry=ripNeighborsEntry, noDelayDrop=noDelayDrop, firewall=firewall, hotfixGroup=hotfixGroup, eventClassification=eventClassification, vpnTunnelsEntry=vpnTunnelsEntry, vpnUsers=vpnUsers, bgpNeighbors=bgpNeighbors, phionHotfixesEntry=phionHotfixesEntry, serverServices=serverServices, ospfNeighborId=ospfNeighborId, class2Total=class2Total, hwSensors=hwSensors, boxServices=boxServices, eventLayerDescription=eventLayerDescription, partitionUsedSpacePercent=partitionUsedSpacePercent, class3Total=class3Total, hwSensorsEntry=hwSensorsEntry, notificationGroup=notificationGroup, ripNeighborState=ripNeighborState, packetThroughput64=packetThroughput64, vpnusersGroup=vpnusersGroup, eventSeverity=eventSeverity, vpnState=vpnState, vpnName=vpnName, serverGroup=serverGroup, raidGroup=raidGroup, ospfGroup=ospfGroup, firewallSessions=firewallSessions, diskSpaceEntry=diskSpaceEntry, eventIDDescription=eventIDDescription, fwStats=fwStats, VpnStates=VpnStates, boxServiceName=boxServiceName, eventGroups=eventGroups, class2Pakets=class2Pakets, PYSNMP_MODULE_ID=phion, hwGroups=hwGroups, sessions=sessions, ospfNeighborsEntry=ospfNeighborsEntry, rate=rate, noDelayTotal=noDelayTotal, bgpGroup=bgpGroup, hwSensorType=hwSensorType, ServiceState=ServiceState, releaseGroup=releaseGroup, fwStatsEntry=fwStatsEntry, serverServicesEntry=serverServicesEntry, class2Drop=class2Drop, event=event, class3Drop=class3Drop, trafficshapeGroup=trafficshapeGroup, trafficShape=trafficShape, bgpNeighborsEntry=bgpNeighborsEntry, hwSensorValue=hwSensorValue, phion=phion, connectorName=connectorName, partitionMaxSpace=partitionMaxSpace, eventGroup=eventGroup, ripGroup=ripGroup, fwGroups=fwGroups, ripNeighborAddress=ripNeighborAddress, eventTrap=eventTrap)
