...
iso, IpAddress, MibIdentifier, enterprises, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ModuleIdentity, Counter64, Bits, Unsigned32, Counter32, TimeTicks, Gauge32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "MibIdentifier", "enterprises", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ModuleIdentity", "Counter64", "Bits", "Unsigned32", "Counter32", "TimeTicks", "Gauge32", "Integer32")
...
mibBuilder.exportSymbols("PHION-MIB", vpnUsers=vpnUsers, eventID=eventID, phionRelease=phionRelease, ripNeighborState=ripNeighborState, ospfNeighborId=ospfNeighborId, ospfNeighborsEntry=ospfNeighborsEntry, hotfixGroup=hotfixGroup, ripGroup=ripGroup, releaseGroup=releaseGroup, phionHotfixes=phionHotfixes, VpnStates=VpnStates, raidEventText=raidEventText, connectorName=connectorName, eventGroups=eventGroups, ospfNeighborAddress=ospfNeighborAddress, ripNeighborsEntry=ripNeighborsEntry, vpnState=vpnState, noDelayTotal=noDelayTotal, trafficShapeEntry=trafficShapeEntry, vpnTunnelsEntry=vpnTunnelsEntry, ospfGroup=ospfGroup, class2Pakets=class2Pakets, hwGroup=hwGroup, sessions=sessions, class1Total=class1Total, bgpNeighborState=bgpNeighborState, class3Pakets=class3Pakets, raidEventSev=raidEventSev, serverServiceName=serverServiceName, raidEventIndex=raidEventIndex, eventRepresentation=eventRepresentation, event=event, class2Total=class2Total, packetThroughput=packetThroughput, ServiceState=ServiceState, fwCompliance=fwCompliance, SensorType=SensorType, bgpNeighborAddress=bgpNeighborAddress, firewall=firewall, packetThroughput64=packetThroughput64, eventAlarmTime=eventAlarmTime, vpnusersGroup=vpnusersGroup, raidGroup=raidGroup, partitionMaxSpace=partitionMaxSpace, netGroups=netGroups, notificationGroup=notificationGroup, hwGroups=hwGroups, rate=rate, ospfNeighborStatus=ospfNeighborStatus, boxGroup=boxGroup, firewallSessions64=firewallSessions64, serverServiceState=serverServiceState, hwSensors=hwSensors, dataThroughput=dataThroughput, boxServiceName=boxServiceName, boxServiceState=boxServiceState, bgpNeighborsEntry=bgpNeighborsEntry, fwstatsGroup=fwstatsGroup, serverServices=serverServices, raidEvents=raidEvents, noDelayPakets=noDelayPakets, dataThroughput64=dataThroughput64, RaidEventSeverity=RaidEventSeverity, fwCompliances=fwCompliances, hwSensorsEntry=hwSensorsEntry, fwGroups=fwGroups, phion=phion, eventGroup=eventGroup, partitionName=partitionName, ospfNeighbors=ospfNeighbors, class3Drop=class3Drop, eventLayerDescription=eventLayerDescription, hwSensorValue=hwSensorValue, boxServices=boxServices, raidEventTime=raidEventTime, class2Drop=class2Drop, hotfixInstallTime=hotfixInstallTime, eventType=eventType, phionHotfixesEntry=phionHotfixesEntry, partitionFreeSpace=partitionFreeSpace, fwStatsEntry=fwStatsEntry, bgpNeighbors=bgpNeighbors, vpnName=vpnName, bgpGroup=bgpGroup, partitionUsedSpace=partitionUsedSpace, fwStats=fwStats, firewallSessions=firewallSessions, hwSensorName=hwSensorName, serverGroup=serverGroup, vpnGroup=vpnGroup, ripNeighborAddress=ripNeighborAddress, eventIDDescription=eventIDDescription, serverServicesEntry=serverServicesEntry, class1Pakets=class1Pakets, diskSpace=diskSpace, serviceGroups=serviceGroups, class3Total=class3Total, eventSeverity=eventSeverity, firmwareGroups=firmwareGroups, trafficShape=trafficShape, diskspaceGroup=diskspaceGroup, class1Drop=class1Drop, eventClassification=eventClassification, boxServicesEntry=boxServicesEntry, hwSensorType=hwSensorType, raidEventsEntry=raidEventsEntry, trafficshapeGroup=trafficshapeGroup, partitionUsedSpacePercent=partitionUsedSpacePercent, PYSNMP_MODULE_ID=phion, noDelayDrop=noDelayDrop, diskSpaceEntry=diskSpaceEntry, vpnTunnels=vpnTunnels, ospfNeighborInterface=ospfNeighborInterface, eventTrap=eventTrap, hotfixName=hotfixName, ripNeighbors=ripNeighbors)
