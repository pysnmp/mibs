...
mibBuilder.exportSymbols("PHION-MIB", fwstatsGroup=fwstatsGroup, noDelayPakets=noDelayPakets, vpnUsers=vpnUsers, class2Pakets=class2Pakets, ospfNeighborId=ospfNeighborId, serverServicesEntry=serverServicesEntry, partitionUsedSpace=partitionUsedSpace, RaidEventSeverity=RaidEventSeverity, firewallSessions=firewallSessions, vpnusersGroup=vpnusersGroup, firewallSessions64=firewallSessions64, ospfNeighborAddress=ospfNeighborAddress, hwSensors=hwSensors, boxServiceName=boxServiceName, hwGroup=hwGroup, eventIDDescription=eventIDDescription, hwSensorValue=hwSensorValue, hwSensorName=hwSensorName, ospfNeighborStatus=ospfNeighborStatus, fwGroups=fwGroups, vpnName=vpnName, dataThroughput64=dataThroughput64, eventAlarmTime=eventAlarmTime, ospfNeighborInterface=ospfNeighborInterface, partitionMaxSpace=partitionMaxSpace, class2Total=class2Total, bgpNeighborAddress=bgpNeighborAddress, noDelayDrop=noDelayDrop, eventID=eventID, hotfixInstallTime=hotfixInstallTime, raidEventSev=raidEventSev, trafficShape=trafficShape, raidEventTime=raidEventTime, diskSpaceEntry=diskSpaceEntry, phionRelease=phionRelease, fwStatsEntry=fwStatsEntry, ServiceState=ServiceState, serverGroup=serverGroup, partitionUsedSpacePercent=partitionUsedSpacePercent, class1Pakets=class1Pakets, vpnState=vpnState, diskSpace=diskSpace, packetThroughput=packetThroughput, serverServiceName=serverServiceName, raidEventIndex=raidEventIndex, trafficshapeGroup=trafficshapeGroup, trafficShapeEntry=trafficShapeEntry, eventSeverity=eventSeverity, releaseGroup=releaseGroup, diskspaceGroup=diskspaceGroup, bgpNeighbors=bgpNeighbors, eventType=eventType, noDelayTotal=noDelayTotal, firewall=firewall, ospfNeighborsEntry=ospfNeighborsEntry, ripNeighborAddress=ripNeighborAddress, VpnStates=VpnStates, serverServices=serverServices, phionHotfixes=phionHotfixes, serverServiceState=serverServiceState, ripNeighborsEntry=ripNeighborsEntry, packetThroughput64=packetThroughput64, ripNeighbors=ripNeighbors, dataThroughput=dataThroughput, eventRepresentation=eventRepresentation, PYSNMP_MODULE_ID=phion, serviceGroups=serviceGroups, class3Drop=class3Drop, fwCompliances=fwCompliances, class3Pakets=class3Pakets, firmwareGroups=firmwareGroups, vpnGroup=vpnGroup, eventClassification=eventClassification, fwStats=fwStats, class1Drop=class1Drop, notificationGroup=notificationGroup, bgpGroup=bgpGroup, vpnTunnels=vpnTunnels, bgpNeighborState=bgpNeighborState, eventGroup=eventGroup, class1Total=class1Total, SensorType=SensorType, raidEventsEntry=raidEventsEntry, class3Total=class3Total, ripGroup=ripGroup, boxServiceState=boxServiceState, hotfixGroup=hotfixGroup, phionHotfixesEntry=phionHotfixesEntry, raidEventText=raidEventText, event=event, ripNeighborState=ripNeighborState, raidEvents=raidEvents, hwGroups=hwGroups, rate=rate, ospfNeighbors=ospfNeighbors, fwCompliance=fwCompliance, netGroups=netGroups, hwSensorType=hwSensorType, phion=phion, eventGroups=eventGroups, eventTrap=eventTrap, ospfGroup=ospfGroup, partitionFreeSpace=partitionFreeSpace, partitionName=partitionName, bgpNeighborsEntry=bgpNeighborsEntry, sessions=sessions, boxServices=boxServices, vpnTunnelsEntry=vpnTunnelsEntry, class2Drop=class2Drop, boxGroup=boxGroup, boxServicesEntry=boxServicesEntry, hotfixName=hotfixName, hwSensorsEntry=hwSensorsEntry, raidGroup=raidGroup, eventLayerDescription=eventLayerDescription, connectorName=connectorName)
