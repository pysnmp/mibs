...
mibBuilder.exportSymbols("PHION-MIB", class3Drop=class3Drop, partitionFreeSpace=partitionFreeSpace, partitionUsedSpace=partitionUsedSpace, phionHotfixesEntry=phionHotfixesEntry, phionRelease=phionRelease, event=event, hwGroup=hwGroup, noDelayTotal=noDelayTotal, partitionName=partitionName, eventRepresentation=eventRepresentation, ospfNeighborAddress=ospfNeighborAddress, sessions=sessions, class1Drop=class1Drop, class2Total=class2Total, trafficShapeEntry=trafficShapeEntry, PYSNMP_MODULE_ID=phion, ospfNeighborInterface=ospfNeighborInterface, phion=phion, dataThroughput64=dataThroughput64, vpnState=vpnState, eventIDDescription=eventIDDescription, SensorType=SensorType, serverServiceState=serverServiceState, raidGroup=raidGroup, hotfixName=hotfixName, hwSensorType=hwSensorType, vpnUsers=vpnUsers, partitionMaxSpace=partitionMaxSpace, eventClassification=eventClassification, fwStatsEntry=fwStatsEntry, hwSensorName=hwSensorName, noDelayDrop=noDelayDrop, notificationGroup=notificationGroup, raidEventsEntry=raidEventsEntry, class3Pakets=class3Pakets, hotfixGroup=hotfixGroup, partitionUsedSpacePercent=partitionUsedSpacePercent, class2Drop=class2Drop, eventSeverity=eventSeverity, bgpNeighborsEntry=bgpNeighborsEntry, ripNeighborState=ripNeighborState, netGroups=netGroups, vpnTunnelsEntry=vpnTunnelsEntry, firmwareGroups=firmwareGroups, hwGroups=hwGroups, bgpNeighbors=bgpNeighbors, raidEventTime=raidEventTime, boxServicesEntry=boxServicesEntry, hotfixInstallTime=hotfixInstallTime, boxServiceState=boxServiceState, dataThroughput=dataThroughput, vpnTunnels=vpnTunnels, packetThroughput=packetThroughput, bgpNeighborAddress=bgpNeighborAddress, raidEvents=raidEvents, firewallSessions=firewallSessions, bgpGroup=bgpGroup, noDelayPakets=noDelayPakets, eventGroups=eventGroups, ospfGroup=ospfGroup, class1Pakets=class1Pakets, hwSensorsEntry=hwSensorsEntry, eventID=eventID, packetThroughput64=packetThroughput64, eventLayerDescription=eventLayerDescription, ripGroup=ripGroup, phionHotfixes=phionHotfixes, serverServices=serverServices, ServiceState=ServiceState, fwCompliance=fwCompliance, serverServiceName=serverServiceName, diskspaceGroup=diskspaceGroup, boxServices=boxServices, ospfNeighborStatus=ospfNeighborStatus, class1Total=class1Total, eventTrap=eventTrap, ripNeighbors=ripNeighbors, trafficshapeGroup=trafficshapeGroup, vpnGroup=vpnGroup, rate=rate, vpnusersGroup=vpnusersGroup, hwSensors=hwSensors, RaidEventSeverity=RaidEventSeverity, VpnStates=VpnStates, releaseGroup=releaseGroup, fwStats=fwStats, fwCompliances=fwCompliances, connectorName=connectorName, hwSensorValue=hwSensorValue, fwstatsGroup=fwstatsGroup, raidEventIndex=raidEventIndex, diskSpace=diskSpace, boxServiceName=boxServiceName, serviceGroups=serviceGroups, trafficShape=trafficShape, firewallSessions64=firewallSessions64, boxGroup=boxGroup, eventType=eventType, diskSpaceEntry=diskSpaceEntry, firewall=firewall, eventAlarmTime=eventAlarmTime, serverGroup=serverGroup, ospfNeighborId=ospfNeighborId, ripNeighborsEntry=ripNeighborsEntry, eventGroup=eventGroup, bgpNeighborState=bgpNeighborState, ospfNeighborsEntry=ospfNeighborsEntry, ripNeighborAddress=ripNeighborAddress, class2Pakets=class2Pakets, fwGroups=fwGroups, raidEventSev=raidEventSev, class3Total=class3Total, serverServicesEntry=serverServicesEntry, ospfNeighbors=ospfNeighbors, raidEventText=raidEventText, vpnName=vpnName)
