...
ObjectIdentity, iso, TimeTicks, IpAddress, Bits, Unsigned32, Counter32, Gauge32, NotificationType, Counter64, MibIdentifier, Integer32, enterprises, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "iso", "TimeTicks", "IpAddress", "Bits", "Unsigned32", "Counter32", "Gauge32", "NotificationType", "Counter64", "MibIdentifier", "Integer32", "enterprises", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("PHION-MIB", class3Drop=class3Drop, PYSNMP_MODULE_ID=phion, rate=rate, bgpNeighborsEntry=bgpNeighborsEntry, fwStatsEntry=fwStatsEntry, firewall=firewall, eventType=eventType, raidEventsEntry=raidEventsEntry, fwstatsGroup=fwstatsGroup, diskSpace=diskSpace, vpnTunnels=vpnTunnels, ospfNeighborInterface=ospfNeighborInterface, noDelayTotal=noDelayTotal, serviceGroups=serviceGroups, eventTrap=eventTrap, ospfNeighborId=ospfNeighborId, ripNeighbors=ripNeighbors, connectorName=connectorName, fwCompliances=fwCompliances, serverGroup=serverGroup, diskspaceGroup=diskspaceGroup, vpnUsers=vpnUsers, partitionUsedSpacePercent=partitionUsedSpacePercent, raidGroup=raidGroup, class3Total=class3Total, eventAlarmTime=eventAlarmTime, firewallSessions64=firewallSessions64, ripNeighborState=ripNeighborState, serverServicesEntry=serverServicesEntry, hwSensorName=hwSensorName, serverServiceState=serverServiceState, dataThroughput=dataThroughput, ripGroup=ripGroup, serverServices=serverServices, ripNeighborAddress=ripNeighborAddress, fwCompliance=fwCompliance, noDelayPakets=noDelayPakets, diskSpaceEntry=diskSpaceEntry, packetThroughput64=packetThroughput64, phionHotfixesEntry=phionHotfixesEntry, vpnTunnelsEntry=vpnTunnelsEntry, notificationGroup=notificationGroup, eventID=eventID, boxServiceState=boxServiceState, boxServices=boxServices, ospfGroup=ospfGroup, trafficshapeGroup=trafficshapeGroup, raidEvents=raidEvents, hotfixName=hotfixName, partitionName=partitionName, phionRelease=phionRelease, hotfixInstallTime=hotfixInstallTime, eventRepresentation=eventRepresentation, partitionFreeSpace=partitionFreeSpace, hotfixGroup=hotfixGroup, bgpGroup=bgpGroup, trafficShape=trafficShape, eventGroup=eventGroup, eventLayerDescription=eventLayerDescription, raidEventIndex=raidEventIndex, boxServiceName=boxServiceName, phionHotfixes=phionHotfixes, class1Total=class1Total, boxGroup=boxGroup, vpnName=vpnName, ospfNeighbors=ospfNeighbors, eventClassification=eventClassification, eventGroups=eventGroups, firewallSessions=firewallSessions, class1Pakets=class1Pakets, class2Total=class2Total, fwStats=fwStats, eventSeverity=eventSeverity, class2Drop=class2Drop, boxServicesEntry=boxServicesEntry, SensorType=SensorType, bgpNeighborState=bgpNeighborState, dataThroughput64=dataThroughput64, netGroups=netGroups, ospfNeighborAddress=ospfNeighborAddress, eventIDDescription=eventIDDescription, hwSensorValue=hwSensorValue, noDelayDrop=noDelayDrop, ServiceState=ServiceState, firmwareGroups=firmwareGroups, hwGroup=hwGroup, partitionUsedSpace=partitionUsedSpace, bgpNeighbors=bgpNeighbors, packetThroughput=packetThroughput, phion=phion, hwSensorType=hwSensorType, bgpNeighborAddress=bgpNeighborAddress, hwSensorsEntry=hwSensorsEntry, sessions=sessions, ripNeighborsEntry=ripNeighborsEntry, releaseGroup=releaseGroup, raidEventText=raidEventText, raidEventSev=raidEventSev, ospfNeighborsEntry=ospfNeighborsEntry, VpnStates=VpnStates, class2Pakets=class2Pakets, raidEventTime=raidEventTime, hwSensors=hwSensors, vpnusersGroup=vpnusersGroup, partitionMaxSpace=partitionMaxSpace, serverServiceName=serverServiceName, trafficShapeEntry=trafficShapeEntry, vpnState=vpnState, fwGroups=fwGroups, ospfNeighborStatus=ospfNeighborStatus, event=event, vpnGroup=vpnGroup, class1Drop=class1Drop, hwGroups=hwGroups, class3Pakets=class3Pakets, RaidEventSeverity=RaidEventSeverity)
