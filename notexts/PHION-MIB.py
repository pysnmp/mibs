...
mibBuilder.exportSymbols("PHION-MIB", partitionMaxSpace=partitionMaxSpace, fwStats=fwStats, trafficShapeEntry=trafficShapeEntry, serverServiceState=serverServiceState, noDelayPakets=noDelayPakets, eventClassification=eventClassification, vpnTunnelsEntry=vpnTunnelsEntry, hwGroup=hwGroup, eventTrap=eventTrap, eventID=eventID, ripNeighborAddress=ripNeighborAddress, ripGroup=ripGroup, rate=rate, serviceGroups=serviceGroups, phionHotfixes=phionHotfixes, sessions=sessions, raidGroup=raidGroup, packetThroughput=packetThroughput, PYSNMP_MODULE_ID=phion, serverServices=serverServices, firewallSessions64=firewallSessions64, connectorName=connectorName, fwCompliance=fwCompliance, ospfGroup=ospfGroup, boxServiceState=boxServiceState, partitionUsedSpace=partitionUsedSpace, eventType=eventType, phionRelease=phionRelease, releaseGroup=releaseGroup, firmwareGroups=firmwareGroups, ospfNeighborInterface=ospfNeighborInterface, trafficshapeGroup=trafficshapeGroup, raidEventSev=raidEventSev, vpnName=vpnName, class3Total=class3Total, phionHotfixesEntry=phionHotfixesEntry, hwGroups=hwGroups, hotfixName=hotfixName, partitionName=partitionName, fwGroups=fwGroups, vpnState=vpnState, class3Pakets=class3Pakets, bgpGroup=bgpGroup, RaidEventSeverity=RaidEventSeverity, ripNeighborsEntry=ripNeighborsEntry, partitionUsedSpacePercent=partitionUsedSpacePercent, VpnStates=VpnStates, dataThroughput=dataThroughput, ospfNeighborAddress=ospfNeighborAddress, hwSensorName=hwSensorName, eventAlarmTime=eventAlarmTime, noDelayDrop=noDelayDrop, firewallSessions=firewallSessions, eventGroup=eventGroup, packetThroughput64=packetThroughput64, class2Drop=class2Drop, serverGroup=serverGroup, boxServicesEntry=boxServicesEntry, eventIDDescription=eventIDDescription, hwSensorValue=hwSensorValue, bgpNeighbors=bgpNeighbors, raidEventText=raidEventText, class1Total=class1Total, serverServicesEntry=serverServicesEntry, raidEventIndex=raidEventIndex, vpnGroup=vpnGroup, ospfNeighbors=ospfNeighbors, boxGroup=boxGroup, dataThroughput64=dataThroughput64, firewall=firewall, netGroups=netGroups, serverServiceName=serverServiceName, fwCompliances=fwCompliances, diskSpace=diskSpace, class3Drop=class3Drop, boxServices=boxServices, raidEventTime=raidEventTime, phion=phion, eventRepresentation=eventRepresentation, bgpNeighborAddress=bgpNeighborAddress, fwStatsEntry=fwStatsEntry, hwSensorsEntry=hwSensorsEntry, fwstatsGroup=fwstatsGroup, class2Total=class2Total, notificationGroup=notificationGroup, ServiceState=ServiceState, hotfixGroup=hotfixGroup, bgpNeighborsEntry=bgpNeighborsEntry, vpnusersGroup=vpnusersGroup, raidEventsEntry=raidEventsEntry, diskspaceGroup=diskspaceGroup, trafficShape=trafficShape, partitionFreeSpace=partitionFreeSpace, SensorType=SensorType, hwSensorType=hwSensorType, ospfNeighborsEntry=ospfNeighborsEntry, event=event, eventGroups=eventGroups, bgpNeighborState=bgpNeighborState, class2Pakets=class2Pakets, ripNeighborState=ripNeighborState, ripNeighbors=ripNeighbors, noDelayTotal=noDelayTotal, vpnTunnels=vpnTunnels, diskSpaceEntry=diskSpaceEntry, hwSensors=hwSensors, ospfNeighborId=ospfNeighborId, ospfNeighborStatus=ospfNeighborStatus, hotfixInstallTime=hotfixInstallTime, class1Pakets=class1Pakets, boxServiceName=boxServiceName, vpnUsers=vpnUsers, class1Drop=class1Drop, eventSeverity=eventSeverity, eventLayerDescription=eventLayerDescription, raidEvents=raidEvents)
