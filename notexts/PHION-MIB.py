...
iso, NotificationType, ObjectIdentity, Counter32, Gauge32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, Integer32, IpAddress, TimeTicks, MibIdentifier, ModuleIdentity, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "ObjectIdentity", "Counter32", "Gauge32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "Integer32", "IpAddress", "TimeTicks", "MibIdentifier", "ModuleIdentity", "enterprises")
...
mibBuilder.exportSymbols("PHION-MIB", boxServiceState=boxServiceState, eventIDDescription=eventIDDescription, hwSensorValue=hwSensorValue, partitionUsedSpacePercent=partitionUsedSpacePercent, vpnName=vpnName, ripNeighborState=ripNeighborState, noDelayPakets=noDelayPakets, class2Drop=class2Drop, bgpNeighbors=bgpNeighbors, class2Pakets=class2Pakets, hotfixName=hotfixName, ospfNeighborInterface=ospfNeighborInterface, fwCompliances=fwCompliances, PYSNMP_MODULE_ID=phion, SensorType=SensorType, serverServices=serverServices, ripNeighborAddress=ripNeighborAddress, hwGroups=hwGroups, fwCompliance=fwCompliance, fwStats=fwStats, packetThroughput=packetThroughput, diskSpaceEntry=diskSpaceEntry, RaidEventSeverity=RaidEventSeverity, dataThroughput64=dataThroughput64, ripNeighbors=ripNeighbors, hwSensors=hwSensors, bgpNeighborsEntry=bgpNeighborsEntry, trafficshapeGroup=trafficshapeGroup, dataThroughput=dataThroughput, noDelayTotal=noDelayTotal, hotfixGroup=hotfixGroup, ospfNeighborId=ospfNeighborId, hwGroup=hwGroup, eventTrap=eventTrap, noDelayDrop=noDelayDrop, notificationGroup=notificationGroup, class1Pakets=class1Pakets, class1Total=class1Total, partitionFreeSpace=partitionFreeSpace, raidEventIndex=raidEventIndex, hwSensorType=hwSensorType, ripGroup=ripGroup, partitionUsedSpace=partitionUsedSpace, hwSensorName=hwSensorName, serverServiceName=serverServiceName, class2Total=class2Total, ospfNeighborStatus=ospfNeighborStatus, vpnUsers=vpnUsers, firewallSessions=firewallSessions, eventClassification=eventClassification, ospfNeighbors=ospfNeighbors, firewall=firewall, class1Drop=class1Drop, fwstatsGroup=fwstatsGroup, eventRepresentation=eventRepresentation, phionHotfixesEntry=phionHotfixesEntry, vpnState=vpnState, vpnGroup=vpnGroup, phion=phion, bgpGroup=bgpGroup, rate=rate, ServiceState=ServiceState, eventSeverity=eventSeverity, serverServiceState=serverServiceState, eventGroups=eventGroups, fwGroups=fwGroups, ospfGroup=ospfGroup, class3Drop=class3Drop, firewallSessions64=firewallSessions64, phionRelease=phionRelease, fwStatsEntry=fwStatsEntry, sessions=sessions, bgpNeighborAddress=bgpNeighborAddress, packetThroughput64=packetThroughput64, boxServiceName=boxServiceName, event=event, raidEventsEntry=raidEventsEntry, boxServicesEntry=boxServicesEntry, ripNeighborsEntry=ripNeighborsEntry, class3Total=class3Total, eventID=eventID, raidEventSev=raidEventSev, trafficShape=trafficShape, diskSpace=diskSpace, vpnusersGroup=vpnusersGroup, trafficShapeEntry=trafficShapeEntry, serverGroup=serverGroup, raidEventTime=raidEventTime, ospfNeighborAddress=ospfNeighborAddress, firmwareGroups=firmwareGroups, ospfNeighborsEntry=ospfNeighborsEntry, serverServicesEntry=serverServicesEntry, VpnStates=VpnStates, boxGroup=boxGroup, raidGroup=raidGroup, hotfixInstallTime=hotfixInstallTime, eventAlarmTime=eventAlarmTime, diskspaceGroup=diskspaceGroup, vpnTunnelsEntry=vpnTunnelsEntry, eventLayerDescription=eventLayerDescription, raidEventText=raidEventText, hwSensorsEntry=hwSensorsEntry, releaseGroup=releaseGroup, vpnTunnels=vpnTunnels, class3Pakets=class3Pakets, raidEvents=raidEvents, connectorName=connectorName, serviceGroups=serviceGroups, phionHotfixes=phionHotfixes, eventType=eventType, bgpNeighborState=bgpNeighborState, partitionName=partitionName, eventGroup=eventGroup, partitionMaxSpace=partitionMaxSpace, netGroups=netGroups, boxServices=boxServices)
