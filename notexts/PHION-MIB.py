...
ModuleIdentity, Unsigned32, IpAddress, TimeTicks, Counter32, MibIdentifier, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Gauge32, Bits, Counter64, Integer32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "IpAddress", "TimeTicks", "Counter32", "MibIdentifier", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Gauge32", "Bits", "Counter64", "Integer32", "enterprises")
...
mibBuilder.exportSymbols("PHION-MIB", eventLayerDescription=eventLayerDescription, hwSensorValue=hwSensorValue, class3Total=class3Total, phion=phion, bgpNeighborAddress=bgpNeighborAddress, eventID=eventID, noDelayTotal=noDelayTotal, ospfNeighborStatus=ospfNeighborStatus, hotfixGroup=hotfixGroup, eventTrap=eventTrap, phionRelease=phionRelease, boxServicesEntry=boxServicesEntry, eventSeverity=eventSeverity, eventClassification=eventClassification, boxServiceState=boxServiceState, raidEventIndex=raidEventIndex, bgpNeighbors=bgpNeighbors, raidEvents=raidEvents, diskspaceGroup=diskspaceGroup, partitionName=partitionName, partitionUsedSpace=partitionUsedSpace, fwCompliance=fwCompliance, fwCompliances=fwCompliances, hwSensorsEntry=hwSensorsEntry, vpnTunnels=vpnTunnels, vpnUsers=vpnUsers, raidGroup=raidGroup, ospfNeighborAddress=ospfNeighborAddress, packetThroughput=packetThroughput, class1Drop=class1Drop, notificationGroup=notificationGroup, boxGroup=boxGroup, boxServices=boxServices, hwGroups=hwGroups, ripNeighborAddress=ripNeighborAddress, releaseGroup=releaseGroup, ripNeighbors=ripNeighbors, vpnusersGroup=vpnusersGroup, serverServicesEntry=serverServicesEntry, VpnStates=VpnStates, class2Drop=class2Drop, dataThroughput64=dataThroughput64, serviceGroups=serviceGroups, phionHotfixesEntry=phionHotfixesEntry, ospfGroup=ospfGroup, partitionUsedSpacePercent=partitionUsedSpacePercent, ospfNeighborId=ospfNeighborId, fwStatsEntry=fwStatsEntry, rate=rate, fwStats=fwStats, RaidEventSeverity=RaidEventSeverity, ripNeighborState=ripNeighborState, phionHotfixes=phionHotfixes, raidEventText=raidEventText, sessions=sessions, boxServiceName=boxServiceName, class2Pakets=class2Pakets, SensorType=SensorType, vpnTunnelsEntry=vpnTunnelsEntry, raidEventsEntry=raidEventsEntry, ospfNeighborsEntry=ospfNeighborsEntry, bgpNeighborState=bgpNeighborState, serverGroup=serverGroup, trafficshapeGroup=trafficshapeGroup, noDelayPakets=noDelayPakets, fwGroups=fwGroups, vpnName=vpnName, serverServiceState=serverServiceState, class1Pakets=class1Pakets, class1Total=class1Total, event=event, bgpNeighborsEntry=bgpNeighborsEntry, serverServiceName=serverServiceName, firewall=firewall, ospfNeighborInterface=ospfNeighborInterface, dataThroughput=dataThroughput, packetThroughput64=packetThroughput64, partitionMaxSpace=partitionMaxSpace, firewallSessions64=firewallSessions64, ripGroup=ripGroup, netGroups=netGroups, partitionFreeSpace=partitionFreeSpace, eventType=eventType, hwSensorName=hwSensorName, raidEventTime=raidEventTime, PYSNMP_MODULE_ID=phion, class2Total=class2Total, eventRepresentation=eventRepresentation, serverServices=serverServices, vpnGroup=vpnGroup, eventAlarmTime=eventAlarmTime, hotfixName=hotfixName, firmwareGroups=firmwareGroups, trafficShapeEntry=trafficShapeEntry, trafficShape=trafficShape, hwSensorType=hwSensorType, eventIDDescription=eventIDDescription, firewallSessions=firewallSessions, class3Pakets=class3Pakets, fwstatsGroup=fwstatsGroup, diskSpace=diskSpace, eventGroup=eventGroup, raidEventSev=raidEventSev, noDelayDrop=noDelayDrop, ospfNeighbors=ospfNeighbors, diskSpaceEntry=diskSpaceEntry, ServiceState=ServiceState, eventGroups=eventGroups, hwGroup=hwGroup, connectorName=connectorName, bgpGroup=bgpGroup, vpnState=vpnState, hotfixInstallTime=hotfixInstallTime, ripNeighborsEntry=ripNeighborsEntry, hwSensors=hwSensors, class3Drop=class3Drop)
