...
NotificationType, Counter64, MibIdentifier, ModuleIdentity, Integer32, Counter32, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, IpAddress, TimeTicks, Bits, ObjectIdentity, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "MibIdentifier", "ModuleIdentity", "Integer32", "Counter32", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "IpAddress", "TimeTicks", "Bits", "ObjectIdentity", "enterprises")
...
mibBuilder.exportSymbols("PHION-MIB", vpnusersGroup=vpnusersGroup, eventAlarmTime=eventAlarmTime, fwCompliances=fwCompliances, bgpNeighborsEntry=bgpNeighborsEntry, hwSensorName=hwSensorName, sessions=sessions, noDelayTotal=noDelayTotal, class2Total=class2Total, fwstatsGroup=fwstatsGroup, vpnGroup=vpnGroup, partitionFreeSpace=partitionFreeSpace, connectorName=connectorName, phionRelease=phionRelease, raidEventsEntry=raidEventsEntry, ospfNeighbors=ospfNeighbors, eventClassification=eventClassification, hwGroup=hwGroup, dataThroughput=dataThroughput, event=event, packetThroughput=packetThroughput, boxServiceState=boxServiceState, eventIDDescription=eventIDDescription, VpnStates=VpnStates, bgpNeighborAddress=bgpNeighborAddress, trafficShape=trafficShape, partitionName=partitionName, raidGroup=raidGroup, class1Total=class1Total, diskSpaceEntry=diskSpaceEntry, phion=phion, firewall=firewall, SensorType=SensorType, partitionUsedSpace=partitionUsedSpace, ospfNeighborId=ospfNeighborId, class3Drop=class3Drop, phionHotfixesEntry=phionHotfixesEntry, vpnState=vpnState, class2Pakets=class2Pakets, ripNeighborAddress=ripNeighborAddress, eventGroups=eventGroups, packetThroughput64=packetThroughput64, firewallSessions=firewallSessions, fwStatsEntry=fwStatsEntry, eventLayerDescription=eventLayerDescription, eventSeverity=eventSeverity, ripNeighbors=ripNeighbors, partitionMaxSpace=partitionMaxSpace, ospfNeighborStatus=ospfNeighborStatus, serverServices=serverServices, fwCompliance=fwCompliance, eventGroup=eventGroup, fwGroups=fwGroups, firewallSessions64=firewallSessions64, class2Drop=class2Drop, bgpNeighborState=bgpNeighborState, eventRepresentation=eventRepresentation, class1Pakets=class1Pakets, releaseGroup=releaseGroup, firmwareGroups=firmwareGroups, fwStats=fwStats, serverServicesEntry=serverServicesEntry, diskspaceGroup=diskspaceGroup, vpnTunnelsEntry=vpnTunnelsEntry, boxServices=boxServices, vpnName=vpnName, hwSensors=hwSensors, eventType=eventType, serverServiceState=serverServiceState, trafficShapeEntry=trafficShapeEntry, trafficshapeGroup=trafficshapeGroup, RaidEventSeverity=RaidEventSeverity, hwGroups=hwGroups, boxServicesEntry=boxServicesEntry, raidEventTime=raidEventTime, class1Drop=class1Drop, noDelayPakets=noDelayPakets, serverGroup=serverGroup, ripNeighborsEntry=ripNeighborsEntry, boxServiceName=boxServiceName, raidEventText=raidEventText, ospfNeighborAddress=ospfNeighborAddress, raidEventSev=raidEventSev, class3Total=class3Total, raidEventIndex=raidEventIndex, boxGroup=boxGroup, noDelayDrop=noDelayDrop, rate=rate, hwSensorType=hwSensorType, ospfNeighborInterface=ospfNeighborInterface, vpnUsers=vpnUsers, serviceGroups=serviceGroups, hotfixName=hotfixName, dataThroughput64=dataThroughput64, ripGroup=ripGroup, serverServiceName=serverServiceName, partitionUsedSpacePercent=partitionUsedSpacePercent, hwSensorValue=hwSensorValue, ServiceState=ServiceState, ospfGroup=ospfGroup, bgpGroup=bgpGroup, vpnTunnels=vpnTunnels, bgpNeighbors=bgpNeighbors, PYSNMP_MODULE_ID=phion, diskSpace=diskSpace, hotfixGroup=hotfixGroup, hotfixInstallTime=hotfixInstallTime, notificationGroup=notificationGroup, ospfNeighborsEntry=ospfNeighborsEntry, raidEvents=raidEvents, class3Pakets=class3Pakets, phionHotfixes=phionHotfixes, hwSensorsEntry=hwSensorsEntry, eventID=eventID, eventTrap=eventTrap, netGroups=netGroups, ripNeighborState=ripNeighborState)
