...
MibIdentifier, Counter64, enterprises, ObjectIdentity, Integer32, Gauge32, TimeTicks, IpAddress, Unsigned32, ModuleIdentity, iso, Bits, Counter32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter64", "enterprises", "ObjectIdentity", "Integer32", "Gauge32", "TimeTicks", "IpAddress", "Unsigned32", "ModuleIdentity", "iso", "Bits", "Counter32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("PHION-MIB", phionRelease=phionRelease, hwSensors=hwSensors, ospfNeighborsEntry=ospfNeighborsEntry, noDelayPakets=noDelayPakets, firewallSessions64=firewallSessions64, ripGroup=ripGroup, fwstatsGroup=fwstatsGroup, hwSensorsEntry=hwSensorsEntry, ripNeighbors=ripNeighbors, hotfixInstallTime=hotfixInstallTime, raidEvents=raidEvents, class1Pakets=class1Pakets, vpnState=vpnState, partitionUsedSpacePercent=partitionUsedSpacePercent, class3Pakets=class3Pakets, noDelayDrop=noDelayDrop, serverServiceState=serverServiceState, fwStats=fwStats, boxServicesEntry=boxServicesEntry, partitionFreeSpace=partitionFreeSpace, raidEventText=raidEventText, boxServiceState=boxServiceState, connectorName=connectorName, raidEventTime=raidEventTime, class1Total=class1Total, boxServiceName=boxServiceName, hwSensorType=hwSensorType, bgpNeighborState=bgpNeighborState, bgpNeighborsEntry=bgpNeighborsEntry, ospfNeighborInterface=ospfNeighborInterface, bgpGroup=bgpGroup, serverServices=serverServices, notificationGroup=notificationGroup, class3Total=class3Total, partitionUsedSpace=partitionUsedSpace, firewall=firewall, event=event, phion=phion, packetThroughput64=packetThroughput64, vpnName=vpnName, trafficShape=trafficShape, fwStatsEntry=fwStatsEntry, hwSensorValue=hwSensorValue, class2Total=class2Total, boxGroup=boxGroup, boxServices=boxServices, raidEventSev=raidEventSev, firmwareGroups=firmwareGroups, eventIDDescription=eventIDDescription, raidGroup=raidGroup, VpnStates=VpnStates, serverGroup=serverGroup, trafficShapeEntry=trafficShapeEntry, serviceGroups=serviceGroups, serverServicesEntry=serverServicesEntry, ServiceState=ServiceState, hotfixName=hotfixName, eventClassification=eventClassification, ospfNeighborId=ospfNeighborId, bgpNeighbors=bgpNeighbors, ospfNeighborAddress=ospfNeighborAddress, packetThroughput=packetThroughput, serverServiceName=serverServiceName, noDelayTotal=noDelayTotal, diskSpaceEntry=diskSpaceEntry, rate=rate, sessions=sessions, eventSeverity=eventSeverity, vpnGroup=vpnGroup, firewallSessions=firewallSessions, eventTrap=eventTrap, ripNeighborState=ripNeighborState, eventAlarmTime=eventAlarmTime, diskspaceGroup=diskspaceGroup, hwGroup=hwGroup, hwGroups=hwGroups, dataThroughput=dataThroughput, ospfNeighbors=ospfNeighbors, trafficshapeGroup=trafficshapeGroup, eventType=eventType, phionHotfixesEntry=phionHotfixesEntry, eventGroups=eventGroups, fwGroups=fwGroups, diskSpace=diskSpace, vpnusersGroup=vpnusersGroup, raidEventsEntry=raidEventsEntry, raidEventIndex=raidEventIndex, dataThroughput64=dataThroughput64, class3Drop=class3Drop, hotfixGroup=hotfixGroup, partitionName=partitionName, class2Pakets=class2Pakets, ospfGroup=ospfGroup, eventRepresentation=eventRepresentation, fwCompliances=fwCompliances, vpnUsers=vpnUsers, eventGroup=eventGroup, hwSensorName=hwSensorName, bgpNeighborAddress=bgpNeighborAddress, eventLayerDescription=eventLayerDescription, ospfNeighborStatus=ospfNeighborStatus, phionHotfixes=phionHotfixes, partitionMaxSpace=partitionMaxSpace, class1Drop=class1Drop, releaseGroup=releaseGroup, SensorType=SensorType, eventID=eventID, RaidEventSeverity=RaidEventSeverity, vpnTunnels=vpnTunnels, vpnTunnelsEntry=vpnTunnelsEntry, netGroups=netGroups, ripNeighborAddress=ripNeighborAddress, ripNeighborsEntry=ripNeighborsEntry, class2Drop=class2Drop, PYSNMP_MODULE_ID=phion, fwCompliance=fwCompliance)
