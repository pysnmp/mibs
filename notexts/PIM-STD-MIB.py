...
# ASN.1 source file:///home/runner/work/mibs/mibs/output/asn1/PIM-STD-MIB
...
iso, Bits, Unsigned32, Counter64, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, mib_2, ModuleIdentity, Integer32, Gauge32, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "Unsigned32", "Counter64", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "mib-2", "ModuleIdentity", "Integer32", "Gauge32", "TimeTicks", "Counter32")
...
pimStarGPimMode = MibTableColumn((1, 3, 6, 1, 2, 1, 157, 1, 4, 1, 4), PimMode()).setMaxAccess("readonly")
...
pimSGPimMode = MibTableColumn((1, 3, 6, 1, 2, 1, 157, 1, 6, 1, 5), PimMode()).setMaxAccess("readonly")
if mibBuilder.loadTexts: pimSGPimMode.setStatus('current')
pimSGUpstreamJoinState = MibTableColumn((1, 3, 6, 1, 2, 1, 157, 1, 6, 1, 6), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(0, 1, 2))).clone(namedValues=NamedValues(("notApplicable", 0), ("notJoined", 1), ("joined", 2)))).setMaxAccess("readonly")
...
pimSGUpstreamPruneState = MibTableColumn((1, 3, 6, 1, 2, 1, 157, 1, 6, 1, 23), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(0, 1, 2, 3))).clone(namedValues=NamedValues(("notApplicable", 0), ("forwarding", 1), ("ackpending", 2), ("pruned", 3)))).setMaxAccess("readonly")
...
pimSGOriginatorState = MibTableColumn((1, 3, 6, 1, 2, 1, 157, 1, 6, 1, 25), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(0, 1, 2))).clone(namedValues=NamedValues(("notApplicable", 0), ("notOriginator", 1), ("originator", 2)))).setMaxAccess("readonly")
...
pimSGIJoinPruneState = MibTableColumn((1, 3, 6, 1, 2, 1, 157, 1, 7, 1, 4), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4))).clone(namedValues=NamedValues(("noInfo", 1), ("join", 2), ("prunePending", 3), ("pruned", 4)))).setMaxAccess("readonly")
...
pimStaticRPPimMode = MibTableColumn((1, 3, 6, 1, 2, 1, 157, 1, 11, 1, 5), PimMode().clone('asm')).setMaxAccess("readcreate")
...
mibBuilder.exportSymbols("PIM-STD-MIB", pimSGRPFRouteMetric=pimSGRPFRouteMetric, pimSGRPFRouteMetricPref=pimSGRPFRouteMetricPref, pimStarGIAssertState=pimStarGIAssertState, pimNbrSecAddressTable=pimNbrSecAddressTable, pimInterfaceElectionNotificationPeriod=pimInterfaceElectionNotificationPeriod, pimBidirDFElectionWinnerAddressType=pimBidirDFElectionWinnerAddressType, pimGroupMappingOrigin=pimGroupMappingOrigin, pimInterfaceJoinPruneInterval=pimInterfaceJoinPruneInterval, pimSmGroup=pimSmGroup, pimMIBComplianceSsm=pimMIBComplianceSsm, pimSGTable=pimSGTable, pimStarGRPFRouteAddress=pimStarGRPFRouteAddress, PimMode=PimMode, pimStarGRPFRouteMetricPref=pimStarGRPFRouteMetricPref, pimSGIJoinExpiryTimer=pimSGIJoinExpiryTimer, pimNeighborTable=pimNeighborTable, pimStarGITable=pimStarGITable, pimSGRptTable=pimSGRptTable, pimInterfacePruneLimitInterval=pimInterfacePruneLimitInterval, pimInvalidJoinPruneMsgsRcvd=pimInvalidJoinPruneMsgsRcvd, pimBidirDFElectionTable=pimBidirDFElectionTable, pimStarGIAssertTimer=pimStarGIAssertTimer, pimBidirDFElectionRPAddress=pimBidirDFElectionRPAddress, pimStarGRPFNextHop=pimStarGRPFNextHop, pimStarGIIfIndex=pimStarGIIfIndex, pimBidirDFElectionStateTimer=pimBidirDFElectionStateTimer, pimStarGGrpAddress=pimStarGGrpAddress, pimNeighborLoss=pimNeighborLoss, pimStarGUpstreamNeighbor=pimStarGUpstreamNeighbor, pimStarGUpstreamJoinState=pimStarGUpstreamJoinState, pimStarGUpstreamJoinTimer=pimStarGUpstreamJoinTimer, pimNeighborDRPriority=pimNeighborDRPriority, pimStarGEntry=pimStarGEntry, pimGroupMappingPimMode=pimGroupMappingPimMode, pimInvalidRegisterAddressType=pimInvalidRegisterAddressType, pimBidirDFElectionWinnerMetric=pimBidirDFElectionWinnerMetric, pimDeviceStorageGroup=pimDeviceStorageGroup, pimStaticRPGrpAddress=pimStaticRPGrpAddress, pimInterfaceDRPriority=pimInterfaceDRPriority, pimSGIAssertWinnerMetricPref=pimSGIAssertWinnerMetricPref, pimSGIAssertWinnerMetric=pimSGIAssertWinnerMetric, pimGroupMappingRPAddressType=pimGroupMappingRPAddressType, pimKeepalivePeriod=pimKeepalivePeriod, pimSGUpstreamJoinState=pimSGUpstreamJoinState, pimSGEntries=pimSGEntries, pimSGRPFRouteAddress=pimSGRPFRouteAddress, pimNeighborAddressType=pimNeighborAddressType, pimRPMappingNotificationPeriod=pimRPMappingNotificationPeriod, pimBidirGroup=pimBidirGroup, pimInterfacePropagationDelay=pimInterfacePropagationDelay, pimNeighborAddress=pimNeighborAddress, pimStarGRPAddressType=pimStarGRPAddressType, pimStarGIAssertWinnerAddress=pimStarGIAssertWinnerAddress, pimStarGIAssertWinnerMetric=pimStarGIAssertWinnerMetric, pimSGRptIPruneExpiryTimer=pimSGRptIPruneExpiryTimer, pimMIBComplianceAsm=pimMIBComplianceAsm, pimStaticRPTable=pimStaticRPTable, pimInvalidJoinPruneNotificationPeriod=pimInvalidJoinPruneNotificationPeriod, pimSGRptIPrunePendingTimer=pimSGRptIPrunePendingTimer, pimAnycastRPSetAddressType=pimAnycastRPSetAddressType, pimInterfaceBidirCapable=pimInterfaceBidirCapable, pimInterfaceAddressType=pimInterfaceAddressType, pimInterfaceDFElectionRobustness=pimInterfaceDFElectionRobustness, pimStarGRPIsLocal=pimStarGRPIsLocal, pimNetMgmtNotificationObjects=pimNetMgmtNotificationObjects, pimGroupMappingGrpPrefixLength=pimGroupMappingGrpPrefixLength, pimAnycastRPSetLocalRouter=pimAnycastRPSetLocalRouter, pimSGRptUpstreamPruneState=pimSGRptUpstreamPruneState, pimInvalidRegisterGroup=pimInvalidRegisterGroup, pimNbrSecAddressEntry=pimNbrSecAddressEntry, pimStarGUpstreamNeighborType=pimStarGUpstreamNeighborType, pimSGUpstreamNeighbor=pimSGUpstreamNeighbor, pimNeighborExpiryTime=pimNeighborExpiryTime, pimStarGIAssertWinnerAddressType=pimStarGIAssertWinnerAddressType, pimGroupMappingAddressType=pimGroupMappingAddressType, pimStarGAddressType=pimStarGAddressType, pimMIBComplianceDm=pimMIBComplianceDm, pimAnycastRPSetRowStatus=pimAnycastRPSetRowStatus, pimStarGIEntry=pimStarGIEntry, pimAnycastRPSetEntry=pimAnycastRPSetEntry, pimInvalidRegisterOrigin=pimInvalidRegisterOrigin, pimSGIEntry=pimSGIEntry, pimNeighborSRCapable=pimNeighborSRCapable, pimStarGPimMode=pimStarGPimMode, pimRPMappingChange=pimRPMappingChange, pimStarGRPFRoutePrefixLength=pimStarGRPFRoutePrefixLength, pimGroupMappingGrpAddress=pimGroupMappingGrpAddress, pimInterfaceAddress=pimInterfaceAddress, pimNeighborPropagationDelay=pimNeighborPropagationDelay, pimInAsserts=pimInAsserts, pimInterfaceLanDelayEnabled=pimInterfaceLanDelayEnabled, pimSGIUpTime=pimSGIUpTime, pimInterfaceStubInterface=pimInterfaceStubInterface, pimNeighborOverrideInterval=pimNeighborOverrideInterval, pimSGSourceActiveTimer=pimSGSourceActiveTimer, pimStarGRPAddress=pimStarGRPAddress, pimStaticRPGrpPrefixLength=pimStaticRPGrpPrefixLength, pimSGRptIEntry=pimSGRptIEntry, pimStarGEntries=pimStarGEntries, pimNotificationGroup=pimNotificationGroup, pimSGRPFNextHop=pimSGRPFNextHop, pimNeighborLanPruneDelayPresent=pimNeighborLanPruneDelayPresent, pimSGSrcAddress=pimSGSrcAddress, pimSGPimMode=pimSGPimMode, pimInterfaceElection=pimInterfaceElection, pimMIBComplianceBidir=pimMIBComplianceBidir, pimSGRptUpTime=pimSGRptUpTime, pimInterfaceHelloInterval=pimInterfaceHelloInterval, pimInvalidJoinPrune=pimInvalidJoinPrune, pimStdMIB=pimStdMIB, pim=pim, pimSGRptIUpTime=pimSGRptIUpTime, pimMIBCompliances=pimMIBCompliances, pimRouterStatisticsGroup=pimRouterStatisticsGroup, pimStarGIJoinPruneState=pimStarGIJoinPruneState, pimSGRPFNextHopType=pimSGRPFNextHopType, pimRefreshInterval=pimRefreshInterval, pimBidirDFElectionAddressType=pimBidirDFElectionAddressType, pimStarGUpTime=pimStarGUpTime, pimSGRptIIfIndex=pimSGRptIIfIndex, pimAnycastRPSetTable=pimAnycastRPSetTable, pimAnycastRPSetRouterAddress=pimAnycastRPSetRouterAddress, pimNbrSecAddressType=pimNbrSecAddressType, pimInvalidRegisterMsgsRcvd=pimInvalidRegisterMsgsRcvd, pimSGUpstreamPruneLimitTimer=pimSGUpstreamPruneLimitTimer, pimInterfaceElectionWinCount=pimInterfaceElectionWinCount, pimSGRptEntry=pimSGRptEntry, pimSGRptILocalMembership=pimSGRptILocalMembership, pimBidirDFElectionState=pimBidirDFElectionState, pimRPConfigGroup=pimRPConfigGroup, pimNeighborBidirCapable=pimNeighborBidirCapable, pimSGRptSrcAddress=pimSGRptSrcAddress, pimSGIIfIndex=pimSGIIfIndex, pimStaticRPStorageType=pimStaticRPStorageType, pimBidirDFElectionEntry=pimBidirDFElectionEntry, pimNeighborDRPriorityPresent=pimNeighborDRPriorityPresent, pimNbrSecAddressPrimary=pimNbrSecAddressPrimary, pimInterfaceIPVersion=pimInterfaceIPVersion, pimStarGRPFRouteMetric=pimStarGRPFRouteMetric, pimSGIPrunePendingTimer=pimSGIPrunePendingTimer, pimSGRPFIfIndex=pimSGRPFIfIndex, pimInterfaceTable=pimInterfaceTable, pimStarGRPFIfIndex=pimStarGRPFIfIndex, pimStaticRPRPAddress=pimStaticRPRPAddress, pimInvalidRegisterNotificationPeriod=pimInvalidRegisterNotificationPeriod, pimInterfaceDomainBorder=pimInterfaceDomainBorder, pimStarGIPrunePendingTimer=pimStarGIPrunePendingTimer, pimMIBConformance=pimMIBConformance, pimTopologyGroup=pimTopologyGroup, pimStarGIUpTime=pimStarGIUpTime, pimSGRPRegisterPMBRAddressType=pimSGRPRegisterPMBRAddressType, pimNeighborEntry=pimNeighborEntry, pimSGDRRegisterState=pimSGDRRegisterState, pimLastAssertGroupAddressType=pimLastAssertGroupAddressType, pimInterfaceEffectPropagDelay=pimInterfaceEffectPropagDelay, pimInterfaceStatus=pimInterfaceStatus, pimInvalidJoinPruneRp=pimInvalidJoinPruneRp, pimInvalidRegister=pimInvalidRegister, pimMIBGroups=pimMIBGroups, pimLastAssertInterface=pimLastAssertInterface, pimSGIJoinPruneState=pimSGIJoinPruneState, pimInterfaceSuppressionEnabled=pimInterfaceSuppressionEnabled, pimSGILocalMembership=pimSGILocalMembership, pimGroupMappingEntry=pimGroupMappingEntry, pimStaticRPEntry=pimStaticRPEntry, pimBidirDFElectionWinnerMetricPref=pimBidirDFElectionWinnerMetricPref, pimAnycastRpGroup=pimAnycastRpGroup, pimSGIAssertState=pimSGIAssertState, pimTuningParametersGroup=pimTuningParametersGroup, pimSGRPFRoutePrefixLength=pimSGRPFRoutePrefixLength, pimInterfaceEffectOverrideIvl=pimInterfaceEffectOverrideIvl, pimSGOriginatorState=pimSGOriginatorState, pimNeighborLossCount=pimNeighborLossCount, pimStaticRPRowStatus=pimStaticRPRowStatus, pimNeighborGenerationIDValue=pimNeighborGenerationIDValue, pimDiagnosticsGroup=pimDiagnosticsGroup, pimLastAssertGroupAddress=pimLastAssertGroupAddress, pimAnycastRPSetStorageType=pimAnycastRPSetStorageType, pimStaticRPPrecedenceGroup=pimStaticRPPrecedenceGroup, pimSGIAssertTimer=pimSGIAssertTimer, pimRPMappingChangeCount=pimRPMappingChangeCount, pimDeviceConfigStorageType=pimDeviceConfigStorageType, pimInterfaceDR=pimInterfaceDR, pimAnycastRPSetAnycastAddress=pimAnycastRPSetAnycastAddress, pimSGUpstreamPruneState=pimSGUpstreamPruneState, PimGroupMappingOriginType=PimGroupMappingOriginType, pimInterfaceDRPriorityEnabled=pimInterfaceDRPriorityEnabled, pimNeighborTBit=pimNeighborTBit, pimSGRptITable=pimSGRptITable, pimSGUpTime=pimSGUpTime, pimOutAsserts=pimOutAsserts, pimStarGTable=pimStarGTable, pimSsmGroup=pimSsmGroup, pimBidirDFElectionWinnerAddress=pimBidirDFElectionWinnerAddress, pimSGStateRefreshTimer=pimSGStateRefreshTimer, pimSGRptIEntries=pimSGRptIEntries, pimInvalidJoinPruneGroup=pimInvalidJoinPruneGroup, pimSGITable=pimSGITable, pimInterfaceSRPriorityEnabled=pimInterfaceSRPriorityEnabled, pimSGRptUpstreamOverrideTimer=pimSGRptUpstreamOverrideTimer, pimInterfaceIfIndex=pimInterfaceIfIndex, pimSGRptEntries=pimSGRptEntries, pimSGRPRegisterPMBRAddress=pimSGRPRegisterPMBRAddress, pimRegisterSuppressionTime=pimRegisterSuppressionTime, pimInvalidJoinPruneAddressType=pimInvalidJoinPruneAddressType, pimInterfaceOverrideInterval=pimInterfaceOverrideInterval, pimLastAssertSourceAddressType=pimLastAssertSourceAddressType, pimNotifications=pimNotifications, PYSNMP_MODULE_ID=pimStdMIB, pimStarGILocalMembership=pimStarGILocalMembership, pimStarGIAssertWinnerMetricPref=pimStarGIAssertWinnerMetricPref, pimSGKeepaliveTimer=pimSGKeepaliveTimer, pimSGRptIJoinPruneState=pimSGRptIJoinPruneState, pimSGEntry=pimSGEntry, pimGroupMappingTable=pimGroupMappingTable, pimSGDRRegisterStopTimer=pimSGDRRegisterStopTimer, pimBidirDFElectionIfIndex=pimBidirDFElectionIfIndex, pimInterfaceGenerationIDValue=pimInterfaceGenerationIDValue, pimSGIEntries=pimSGIEntries, pimInvalidJoinPruneOrigin=pimInvalidJoinPruneOrigin, pimInterfaceTrigHelloInterval=pimInterfaceTrigHelloInterval, pimNbrSecAddressIfIndex=pimNbrSecAddressIfIndex, pimDmGroup=pimDmGroup, pimStaticRPPrecedence=pimStaticRPPrecedence, pimNetMgmtNotificationGroup=pimNetMgmtNotificationGroup, pimLastAssertSourceAddress=pimLastAssertSourceAddress, pimStarGRPFRouteProtocol=pimStarGRPFRouteProtocol, pimSGGrpAddress=pimSGGrpAddress, pimInterfaceStorageType=pimInterfaceStorageType, pimStarGIJoinExpiryTimer=pimStarGIJoinExpiryTimer, pimInvalidRegisterRp=pimInvalidRegisterRp, pimSGSPTBit=pimSGSPTBit, pimStaticRPAddressType=pimStaticRPAddressType, pimBidirDFElectionWinnerUpTime=pimBidirDFElectionWinnerUpTime, pimSGRPFRouteProtocol=pimSGRPFRouteProtocol, pimNeighborUpTime=pimNeighborUpTime, pimInterfaceJoinPruneHoldtime=pimInterfaceJoinPruneHoldtime, pimSGAddressType=pimSGAddressType, pimStaticRPOverrideDynamic=pimStaticRPOverrideDynamic, pimInterfaceEntry=pimInterfaceEntry, pimNeighborLossNotificationPeriod=pimNeighborLossNotificationPeriod, pimNeighborGenerationIDPresent=pimNeighborGenerationIDPresent, pimSGIAssertWinnerAddress=pimSGIAssertWinnerAddress, pimGroupMappingRPAddress=pimGroupMappingRPAddress, pimStarGIEntries=pimStarGIEntries, pimNeighborIfIndex=pimNeighborIfIndex, pimInterfaceGraftRetryInterval=pimInterfaceGraftRetryInterval, pimSGUpstreamJoinTimer=pimSGUpstreamJoinTimer, pimNbrSecAddress=pimNbrSecAddress, pimStarGPimModeOrigin=pimStarGPimModeOrigin, pimStaticRPPimMode=pimStaticRPPimMode, pimGroupMappingPrecedence=pimGroupMappingPrecedence, pimInterfaceHelloHoldtime=pimInterfaceHelloHoldtime, pimSGIAssertWinnerAddressType=pimSGIAssertWinnerAddressType)
mibBuilder.exportSymbols("PIM-STD-MIB", pimStarGRPFNextHopType=pimStarGRPFNextHopType)
