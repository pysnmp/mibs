...
mibBuilder.exportSymbols("STE-MIB", SensorSN=SensorSN, sensValue=sensValue, sensIndex=sensIndex, UnitType=UnitType, IOName=IOName, sensID=sensID, PositiveInteger=PositiveInteger, SensorName=SensorName, InputAlarmState=InputAlarmState, inpIndex=inpIndex, sensState=sensState, hwgroup=hwgroup, infoAddressMAC=infoAddressMAC, sensSN=sensSN, SensorState=SensorState, info=info, inpTable=inpTable, SensorID=SensorID, inpAlarmState=inpAlarmState, SensorValue=SensorValue, x390=x390, inpValue=inpValue, ste=ste, sensString=sensString, sensTable=sensTable, inpEntry=inpEntry, sensUnit=sensUnit, inpName=inpName, sensEntry=sensEntry, sensName=sensName, SensorString=SensorString, OnOff=OnOff)
