...
mibBuilder.exportSymbols("STE-MIB", sensTable=sensTable, sensValue=sensValue, OnOff=OnOff, sensState=sensState, sensID=sensID, sensString=sensString, sensName=sensName, sensIndex=sensIndex, sensEntry=sensEntry, SensorState=SensorState, inpIndex=inpIndex, inpEntry=inpEntry, SensorString=SensorString, PositiveInteger=PositiveInteger, infoAddressMAC=infoAddressMAC, inpTable=inpTable, SensorName=SensorName, sensUnit=sensUnit, inpValue=inpValue, SensorID=SensorID, sensSN=sensSN, hwgroup=hwgroup, IOName=IOName, ste=ste, InputAlarmState=InputAlarmState, x390=x390, SensorSN=SensorSN, info=info, inpAlarmState=inpAlarmState, UnitType=UnitType, inpName=inpName, SensorValue=SensorValue)
