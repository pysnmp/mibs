...
mibBuilder.exportSymbols("STE-MIB", SensorName=SensorName, inpName=inpName, sensValue=sensValue, sensSN=sensSN, PositiveInteger=PositiveInteger, SensorValue=SensorValue, sensState=sensState, inpEntry=inpEntry, ste=ste, SensorState=SensorState, hwgroup=hwgroup, info=info, sensID=sensID, sensName=sensName, UnitType=UnitType, sensEntry=sensEntry, IOName=IOName, inpValue=inpValue, SensorSN=SensorSN, InputAlarmState=InputAlarmState, OnOff=OnOff, infoAddressMAC=infoAddressMAC, x390=x390, sensUnit=sensUnit, SensorID=SensorID, inpTable=inpTable, sensTable=sensTable, SensorString=SensorString, inpIndex=inpIndex, inpAlarmState=inpAlarmState, sensIndex=sensIndex, sensString=sensString)
