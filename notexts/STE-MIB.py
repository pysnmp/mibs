...
mibBuilder.exportSymbols("STE-MIB", sensValue=sensValue, sensID=sensID, PositiveInteger=PositiveInteger, SensorState=SensorState, SensorString=SensorString, hwgroup=hwgroup, infoAddressMAC=infoAddressMAC, inpEntry=inpEntry, IOName=IOName, sensTable=sensTable, UnitType=UnitType, inpIndex=inpIndex, inpValue=inpValue, InputAlarmState=InputAlarmState, SensorID=SensorID, SensorName=SensorName, sensIndex=sensIndex, inpAlarmState=inpAlarmState, inpName=inpName, info=info, sensName=sensName, SensorSN=SensorSN, sensState=sensState, OnOff=OnOff, sensEntry=sensEntry, x390=x390, ste=ste, sensSN=sensSN, sensString=sensString, SensorValue=SensorValue, inpTable=inpTable, sensUnit=sensUnit)
