...
mibBuilder.exportSymbols("STE-MIB", sensIndex=sensIndex, inpTable=inpTable, SensorSN=SensorSN, sensName=sensName, x390=x390, inpName=inpName, sensValue=sensValue, sensString=sensString, inpIndex=inpIndex, hwgroup=hwgroup, inpValue=inpValue, sensEntry=sensEntry, sensSN=sensSN, SensorID=SensorID, PositiveInteger=PositiveInteger, inpEntry=inpEntry, SensorValue=SensorValue, UnitType=UnitType, IOName=IOName, OnOff=OnOff, InputAlarmState=InputAlarmState, SensorName=SensorName, SensorString=SensorString, ste=ste, info=info, sensUnit=sensUnit, sensID=sensID, inpAlarmState=inpAlarmState, sensTable=sensTable, SensorState=SensorState, sensState=sensState, infoAddressMAC=infoAddressMAC)
