...
mibBuilder.exportSymbols("STE-MIB", sensIndex=sensIndex, inpIndex=inpIndex, UnitType=UnitType, PositiveInteger=PositiveInteger, inpTable=inpTable, sensUnit=sensUnit, SensorString=SensorString, inpName=inpName, sensValue=sensValue, infoAddressMAC=infoAddressMAC, sensName=sensName, SensorSN=SensorSN, sensTable=sensTable, IOName=IOName, x390=x390, SensorState=SensorState, sensEntry=sensEntry, sensID=sensID, InputAlarmState=InputAlarmState, hwgroup=hwgroup, ste=ste, sensState=sensState, inpEntry=inpEntry, SensorValue=SensorValue, SensorName=SensorName, sensString=sensString, sensSN=sensSN, inpAlarmState=inpAlarmState, SensorID=SensorID, info=info, inpValue=inpValue, OnOff=OnOff)
