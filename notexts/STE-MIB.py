...
mibBuilder.exportSymbols("STE-MIB", UnitType=UnitType, inpAlarmState=inpAlarmState, SensorID=SensorID, sensValue=sensValue, sensName=sensName, inpName=inpName, sensTable=sensTable, inpValue=inpValue, info=info, SensorValue=SensorValue, SensorState=SensorState, inpEntry=inpEntry, SensorSN=SensorSN, sensUnit=sensUnit, SensorName=SensorName, inpTable=inpTable, SensorString=SensorString, sensIndex=sensIndex, hwgroup=hwgroup, OnOff=OnOff, sensString=sensString, x390=x390, sensEntry=sensEntry, sensSN=sensSN, InputAlarmState=InputAlarmState, sensState=sensState, IOName=IOName, infoAddressMAC=infoAddressMAC, ste=ste, inpIndex=inpIndex, PositiveInteger=PositiveInteger, sensID=sensID)
