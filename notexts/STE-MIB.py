...
mibBuilder.exportSymbols("STE-MIB", inpValue=inpValue, sensID=sensID, sensSN=sensSN, hwgroup=hwgroup, sensIndex=sensIndex, inpEntry=inpEntry, inpIndex=inpIndex, inpAlarmState=inpAlarmState, sensValue=sensValue, SensorState=SensorState, x390=x390, sensTable=sensTable, PositiveInteger=PositiveInteger, IOName=IOName, infoAddressMAC=infoAddressMAC, SensorName=SensorName, SensorSN=SensorSN, sensEntry=sensEntry, sensName=sensName, ste=ste, SensorValue=SensorValue, sensState=sensState, sensString=sensString, SensorString=SensorString, InputAlarmState=InputAlarmState, info=info, UnitType=UnitType, sensUnit=sensUnit, OnOff=OnOff, inpName=inpName, SensorID=SensorID, inpTable=inpTable)
