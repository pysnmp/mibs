...
mibBuilder.exportSymbols("STE-MIB", sensName=sensName, inpAlarmState=inpAlarmState, inpIndex=inpIndex, IOName=IOName, inpEntry=inpEntry, SensorString=SensorString, sensUnit=sensUnit, sensString=sensString, sensTable=sensTable, inpTable=inpTable, ste=ste, x390=x390, SensorSN=SensorSN, OnOff=OnOff, sensEntry=sensEntry, UnitType=UnitType, InputAlarmState=InputAlarmState, sensID=sensID, SensorValue=SensorValue, SensorID=SensorID, SensorName=SensorName, inpValue=inpValue, PositiveInteger=PositiveInteger, sensState=sensState, inpName=inpName, infoAddressMAC=infoAddressMAC, SensorState=SensorState, sensIndex=sensIndex, sensValue=sensValue, sensSN=sensSN, hwgroup=hwgroup, info=info)
