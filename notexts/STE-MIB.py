...
mibBuilder.exportSymbols("STE-MIB", IOName=IOName, SensorName=SensorName, sensValue=sensValue, sensID=sensID, UnitType=UnitType, sensTable=sensTable, OnOff=OnOff, sensString=sensString, sensUnit=sensUnit, InputAlarmState=InputAlarmState, SensorSN=SensorSN, PositiveInteger=PositiveInteger, sensIndex=sensIndex, inpIndex=inpIndex, infoAddressMAC=infoAddressMAC, inpValue=inpValue, hwgroup=hwgroup, SensorValue=SensorValue, SensorState=SensorState, SensorString=SensorString, info=info, sensEntry=sensEntry, sensSN=sensSN, inpName=inpName, inpTable=inpTable, ste=ste, inpAlarmState=inpAlarmState, x390=x390, sensName=sensName, sensState=sensState, inpEntry=inpEntry, SensorID=SensorID)
