...
mibBuilder.exportSymbols("STE-MIB", sensState=sensState, SensorName=SensorName, SensorValue=SensorValue, UnitType=UnitType, sensTable=sensTable, inpEntry=inpEntry, SensorState=SensorState, sensName=sensName, sensEntry=sensEntry, x390=x390, sensString=sensString, PositiveInteger=PositiveInteger, inpAlarmState=inpAlarmState, inpIndex=inpIndex, inpValue=inpValue, infoAddressMAC=infoAddressMAC, inpTable=inpTable, inpName=inpName, sensValue=sensValue, sensSN=sensSN, sensUnit=sensUnit, sensIndex=sensIndex, hwgroup=hwgroup, ste=ste, OnOff=OnOff, sensID=sensID, info=info, SensorString=SensorString, SensorSN=SensorSN, SensorID=SensorID, InputAlarmState=InputAlarmState, IOName=IOName)
