...
mibBuilder.exportSymbols("STE-MIB", inpTable=inpTable, SensorString=SensorString, sensID=sensID, UnitType=UnitType, ste=ste, sensTable=sensTable, SensorID=SensorID, SensorSN=SensorSN, inpIndex=inpIndex, info=info, inpName=inpName, inpValue=inpValue, sensValue=sensValue, inpEntry=inpEntry, PositiveInteger=PositiveInteger, infoAddressMAC=infoAddressMAC, sensName=sensName, SensorState=SensorState, sensUnit=sensUnit, sensEntry=sensEntry, SensorValue=SensorValue, x390=x390, InputAlarmState=InputAlarmState, sensString=sensString, hwgroup=hwgroup, sensState=sensState, IOName=IOName, sensSN=sensSN, SensorName=SensorName, OnOff=OnOff, sensIndex=sensIndex, inpAlarmState=inpAlarmState)
