...
mibBuilder.exportSymbols("STE-MIB", sensName=sensName, IOName=IOName, PositiveInteger=PositiveInteger, info=info, SensorString=SensorString, x390=x390, InputAlarmState=InputAlarmState, hwgroup=hwgroup, sensIndex=sensIndex, sensSN=sensSN, sensEntry=sensEntry, SensorID=SensorID, sensID=sensID, SensorState=SensorState, inpIndex=inpIndex, sensValue=sensValue, SensorName=SensorName, sensState=sensState, SensorSN=SensorSN, infoAddressMAC=infoAddressMAC, SensorValue=SensorValue, sensUnit=sensUnit, inpTable=inpTable, sensString=sensString, UnitType=UnitType, inpAlarmState=inpAlarmState, ste=ste, sensTable=sensTable, inpName=inpName, inpEntry=inpEntry, inpValue=inpValue, OnOff=OnOff)
