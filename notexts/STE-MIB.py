...
mibBuilder.exportSymbols("STE-MIB", inpName=inpName, sensID=sensID, SensorID=SensorID, PositiveInteger=PositiveInteger, sensIndex=sensIndex, sensState=sensState, SensorName=SensorName, SensorSN=SensorSN, infoAddressMAC=infoAddressMAC, inpTable=inpTable, inpEntry=inpEntry, sensUnit=sensUnit, info=info, sensEntry=sensEntry, sensString=sensString, IOName=IOName, hwgroup=hwgroup, SensorState=SensorState, inpIndex=inpIndex, InputAlarmState=InputAlarmState, sensTable=sensTable, SensorValue=SensorValue, UnitType=UnitType, OnOff=OnOff, SensorString=SensorString, sensValue=sensValue, inpValue=inpValue, x390=x390, sensName=sensName, inpAlarmState=inpAlarmState, ste=ste, sensSN=sensSN)
