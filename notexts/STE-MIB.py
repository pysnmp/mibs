...
mibBuilder.exportSymbols("STE-MIB", sensName=sensName, SensorSN=SensorSN, infoAddressMAC=infoAddressMAC, InputAlarmState=InputAlarmState, inpAlarmState=inpAlarmState, inpIndex=inpIndex, sensTable=sensTable, inpValue=inpValue, SensorValue=SensorValue, sensState=sensState, inpName=inpName, info=info, hwgroup=hwgroup, x390=x390, SensorID=SensorID, SensorString=SensorString, PositiveInteger=PositiveInteger, sensIndex=sensIndex, ste=ste, SensorState=SensorState, inpTable=inpTable, sensSN=sensSN, sensString=sensString, sensValue=sensValue, SensorName=SensorName, UnitType=UnitType, sensID=sensID, OnOff=OnOff, IOName=IOName, inpEntry=inpEntry, sensUnit=sensUnit, sensEntry=sensEntry)
