...
mibBuilder.exportSymbols("STE-MIB", sensID=sensID, sensSN=sensSN, inpName=inpName, inpIndex=inpIndex, SensorSN=SensorSN, sensName=sensName, info=info, sensState=sensState, SensorName=SensorName, IOName=IOName, inpValue=inpValue, InputAlarmState=InputAlarmState, sensEntry=sensEntry, infoAddressMAC=infoAddressMAC, inpEntry=inpEntry, sensIndex=sensIndex, SensorString=SensorString, UnitType=UnitType, SensorID=SensorID, hwgroup=hwgroup, x390=x390, sensTable=sensTable, PositiveInteger=PositiveInteger, sensString=sensString, SensorValue=SensorValue, sensValue=sensValue, ste=ste, SensorState=SensorState, inpTable=inpTable, sensUnit=sensUnit, inpAlarmState=inpAlarmState, OnOff=OnOff)
