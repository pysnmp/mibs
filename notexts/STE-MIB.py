...
mibBuilder.exportSymbols("STE-MIB", sensIndex=sensIndex, sensID=sensID, sensState=sensState, inpAlarmState=inpAlarmState, infoAddressMAC=infoAddressMAC, sensEntry=sensEntry, inpName=inpName, SensorState=SensorState, IOName=IOName, inpTable=inpTable, InputAlarmState=InputAlarmState, inpValue=inpValue, sensValue=sensValue, SensorString=SensorString, SensorID=SensorID, sensTable=sensTable, sensString=sensString, PositiveInteger=PositiveInteger, hwgroup=hwgroup, SensorValue=SensorValue, sensName=sensName, sensUnit=sensUnit, UnitType=UnitType, SensorName=SensorName, info=info, inpEntry=inpEntry, inpIndex=inpIndex, ste=ste, SensorSN=SensorSN, sensSN=sensSN, x390=x390, OnOff=OnOff)
