...
mibBuilder.exportSymbols("STE2-MIB", UnitType=UnitType, IOName=IOName, sensValue=sensValue, SensorState=SensorState, sensSN=sensSN, info=info, SensorString=SensorString, hwgroup=hwgroup, SensorValue=SensorValue, inpEntry=inpEntry, sensEntry=sensEntry, SensorID=SensorID, inpAlarmState=inpAlarmState, inpValue=inpValue, inpIndex=inpIndex, PositiveInteger=PositiveInteger, sensState=sensState, sensID=sensID, SensorName=SensorName, sensIndex=sensIndex, sensTable=sensTable, sensName=sensName, sensString=sensString, SensorSN=SensorSN, infoAddressMAC=infoAddressMAC, OnOff=OnOff, InputAlarmState=InputAlarmState, inpName=inpName, sensUnit=sensUnit, ste2=ste2, inpTable=inpTable, x390=x390)
