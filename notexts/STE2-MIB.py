...
mibBuilder.exportSymbols("STE2-MIB", sensValue=sensValue, sensString=sensString, inpValue=inpValue, inpIndex=inpIndex, ste2=ste2, InputAlarmState=InputAlarmState, inpAlarmState=inpAlarmState, SensorName=SensorName, IOName=IOName, inpName=inpName, sensState=sensState, hwgroup=hwgroup, inpEntry=inpEntry, inpTable=inpTable, sensName=sensName, SensorID=SensorID, UnitType=UnitType, SensorSN=SensorSN, sensID=sensID, SensorValue=SensorValue, x390=x390, sensSN=sensSN, SensorState=SensorState, PositiveInteger=PositiveInteger, SensorString=SensorString, info=info, OnOff=OnOff, sensTable=sensTable, sensIndex=sensIndex, sensEntry=sensEntry, sensUnit=sensUnit, infoAddressMAC=infoAddressMAC)
