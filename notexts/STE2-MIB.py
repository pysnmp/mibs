...
mibBuilder.exportSymbols("STE2-MIB", sensIndex=sensIndex, inpName=inpName, PositiveInteger=PositiveInteger, inpValue=inpValue, infoAddressMAC=infoAddressMAC, ste2=ste2, sensString=sensString, SensorName=SensorName, OnOff=OnOff, inpTable=inpTable, inpEntry=inpEntry, inpIndex=inpIndex, SensorID=SensorID, sensSN=sensSN, sensID=sensID, sensValue=sensValue, sensTable=sensTable, sensEntry=sensEntry, IOName=IOName, sensState=sensState, SensorState=SensorState, SensorValue=SensorValue, sensName=sensName, SensorSN=SensorSN, hwgroup=hwgroup, info=info, inpAlarmState=inpAlarmState, SensorString=SensorString, sensUnit=sensUnit, UnitType=UnitType, x390=x390, InputAlarmState=InputAlarmState)
