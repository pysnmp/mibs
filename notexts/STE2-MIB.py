...
mibBuilder.exportSymbols("STE2-MIB", infoAddressMAC=infoAddressMAC, inpIndex=inpIndex, inpValue=inpValue, sensID=sensID, sensTable=sensTable, sensUnit=sensUnit, OnOff=OnOff, sensState=sensState, sensName=sensName, inpEntry=inpEntry, PositiveInteger=PositiveInteger, hwgroup=hwgroup, x390=x390, UnitType=UnitType, SensorState=SensorState, InputAlarmState=InputAlarmState, SensorString=SensorString, SensorValue=SensorValue, SensorName=SensorName, SensorSN=SensorSN, sensEntry=sensEntry, sensValue=sensValue, sensIndex=sensIndex, sensString=sensString, inpTable=inpTable, sensSN=sensSN, inpAlarmState=inpAlarmState, SensorID=SensorID, IOName=IOName, ste2=ste2, info=info, inpName=inpName)
