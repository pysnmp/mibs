...
mibBuilder.exportSymbols("STE2-MIB", SensorState=SensorState, inpValue=inpValue, x390=x390, PositiveInteger=PositiveInteger, InputAlarmState=InputAlarmState, hwgroup=hwgroup, sensIndex=sensIndex, SensorID=SensorID, sensEntry=sensEntry, inpName=inpName, inpAlarmState=inpAlarmState, sensSN=sensSN, sensID=sensID, OnOff=OnOff, SensorValue=SensorValue, inpTable=inpTable, sensName=sensName, UnitType=UnitType, sensState=sensState, sensUnit=sensUnit, SensorName=SensorName, sensValue=sensValue, sensTable=sensTable, sensString=sensString, IOName=IOName, inpIndex=inpIndex, SensorString=SensorString, ste2=ste2, inpEntry=inpEntry, info=info, infoAddressMAC=infoAddressMAC, SensorSN=SensorSN)
