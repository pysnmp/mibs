...
mibBuilder.exportSymbols("STE2-MIB", sensString=sensString, sensSN=sensSN, infoAddressMAC=infoAddressMAC, sensUnit=sensUnit, SensorName=SensorName, PositiveInteger=PositiveInteger, hwgroup=hwgroup, info=info, inpAlarmState=inpAlarmState, OnOff=OnOff, UnitType=UnitType, SensorString=SensorString, inpEntry=inpEntry, SensorValue=SensorValue, x390=x390, sensState=sensState, InputAlarmState=InputAlarmState, SensorState=SensorState, sensTable=sensTable, sensEntry=sensEntry, sensName=sensName, sensID=sensID, sensValue=sensValue, SensorSN=SensorSN, inpName=inpName, IOName=IOName, ste2=ste2, SensorID=SensorID, inpIndex=inpIndex, sensIndex=sensIndex, inpValue=inpValue, inpTable=inpTable)
