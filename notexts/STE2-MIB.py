...
mibBuilder.exportSymbols("STE2-MIB", UnitType=UnitType, inpName=inpName, SensorValue=SensorValue, sensString=sensString, sensUnit=sensUnit, SensorSN=SensorSN, sensSN=sensSN, SensorState=SensorState, sensState=sensState, PositiveInteger=PositiveInteger, SensorName=SensorName, inpAlarmState=inpAlarmState, hwgroup=hwgroup, sensValue=sensValue, x390=x390, IOName=IOName, InputAlarmState=InputAlarmState, info=info, inpEntry=inpEntry, sensTable=sensTable, ste2=ste2, OnOff=OnOff, SensorID=SensorID, sensID=sensID, inpIndex=inpIndex, inpValue=inpValue, infoAddressMAC=infoAddressMAC, sensEntry=sensEntry, sensIndex=sensIndex, sensName=sensName, inpTable=inpTable, SensorString=SensorString)
