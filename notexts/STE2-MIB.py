...
mibBuilder.exportSymbols("STE2-MIB", sensUnit=sensUnit, OnOff=OnOff, SensorState=SensorState, SensorSN=SensorSN, sensEntry=sensEntry, PositiveInteger=PositiveInteger, inpTable=inpTable, sensID=sensID, infoAddressMAC=infoAddressMAC, inpAlarmState=inpAlarmState, sensTable=sensTable, sensString=sensString, sensIndex=sensIndex, SensorID=SensorID, SensorString=SensorString, sensState=sensState, hwgroup=hwgroup, sensSN=sensSN, InputAlarmState=InputAlarmState, UnitType=UnitType, IOName=IOName, ste2=ste2, sensValue=sensValue, inpIndex=inpIndex, info=info, inpValue=inpValue, x390=x390, SensorName=SensorName, inpEntry=inpEntry, sensName=sensName, inpName=inpName, SensorValue=SensorValue)
