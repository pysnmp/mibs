...
mibBuilder.exportSymbols("STE2-MIB", sensIndex=sensIndex, sensTable=sensTable, sensString=sensString, inpEntry=inpEntry, inpTable=inpTable, SensorString=SensorString, sensUnit=sensUnit, IOName=IOName, InputAlarmState=InputAlarmState, SensorSN=SensorSN, PositiveInteger=PositiveInteger, ste2=ste2, sensEntry=sensEntry, hwgroup=hwgroup, UnitType=UnitType, inpValue=inpValue, inpName=inpName, SensorValue=SensorValue, SensorState=SensorState, sensValue=sensValue, sensName=sensName, sensSN=sensSN, SensorName=SensorName, sensID=sensID, SensorID=SensorID, OnOff=OnOff, inpAlarmState=inpAlarmState, info=info, sensState=sensState, x390=x390, infoAddressMAC=infoAddressMAC, inpIndex=inpIndex)
