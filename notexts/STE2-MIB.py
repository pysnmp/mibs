...
mibBuilder.exportSymbols("STE2-MIB", SensorState=SensorState, SensorValue=SensorValue, sensUnit=sensUnit, inpEntry=inpEntry, sensName=sensName, SensorSN=SensorSN, sensValue=sensValue, sensEntry=sensEntry, info=info, sensID=sensID, inpAlarmState=inpAlarmState, UnitType=UnitType, IOName=IOName, infoAddressMAC=infoAddressMAC, inpValue=inpValue, x390=x390, sensString=sensString, sensIndex=sensIndex, PositiveInteger=PositiveInteger, SensorName=SensorName, sensTable=sensTable, SensorID=SensorID, OnOff=OnOff, hwgroup=hwgroup, sensState=sensState, InputAlarmState=InputAlarmState, sensSN=sensSN, inpName=inpName, ste2=ste2, SensorString=SensorString, inpTable=inpTable, inpIndex=inpIndex)
