...
mibBuilder.exportSymbols("STE2-MIB", sensString=sensString, inpTable=inpTable, SensorString=SensorString, OnOff=OnOff, sensID=sensID, inpValue=inpValue, inpAlarmState=inpAlarmState, ste2=ste2, SensorID=SensorID, infoAddressMAC=infoAddressMAC, x390=x390, inpEntry=inpEntry, SensorSN=SensorSN, InputAlarmState=InputAlarmState, PositiveInteger=PositiveInteger, sensIndex=sensIndex, IOName=IOName, sensEntry=sensEntry, sensTable=sensTable, info=info, inpIndex=inpIndex, sensState=sensState, UnitType=UnitType, hwgroup=hwgroup, inpName=inpName, SensorState=SensorState, SensorName=SensorName, sensSN=sensSN, SensorValue=SensorValue, sensUnit=sensUnit, sensValue=sensValue, sensName=sensName)
