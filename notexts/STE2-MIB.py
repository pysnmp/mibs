...
mibBuilder.exportSymbols("STE2-MIB", IOName=IOName, sensUnit=sensUnit, sensString=sensString, inpValue=inpValue, sensTable=sensTable, SensorString=SensorString, UnitType=UnitType, info=info, SensorState=SensorState, x390=x390, inpName=inpName, PositiveInteger=PositiveInteger, sensIndex=sensIndex, SensorValue=SensorValue, sensValue=sensValue, sensEntry=sensEntry, InputAlarmState=InputAlarmState, sensName=sensName, infoAddressMAC=infoAddressMAC, inpIndex=inpIndex, SensorID=SensorID, SensorSN=SensorSN, inpAlarmState=inpAlarmState, hwgroup=hwgroup, sensID=sensID, sensSN=sensSN, inpTable=inpTable, SensorName=SensorName, OnOff=OnOff, inpEntry=inpEntry, ste2=ste2, sensState=sensState)
