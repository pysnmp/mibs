...
mibBuilder.exportSymbols("STE2-MIB", inpIndex=inpIndex, sensUnit=sensUnit, sensString=sensString, SensorSN=SensorSN, SensorValue=SensorValue, SensorName=SensorName, inpTable=inpTable, SensorString=SensorString, OnOff=OnOff, inpValue=inpValue, ste2=ste2, x390=x390, inpAlarmState=inpAlarmState, IOName=IOName, sensState=sensState, inpName=inpName, UnitType=UnitType, SensorState=SensorState, InputAlarmState=InputAlarmState, sensValue=sensValue, sensTable=sensTable, sensName=sensName, SensorID=SensorID, PositiveInteger=PositiveInteger, inpEntry=inpEntry, info=info, sensEntry=sensEntry, sensSN=sensSN, sensID=sensID, hwgroup=hwgroup, infoAddressMAC=infoAddressMAC, sensIndex=sensIndex)
