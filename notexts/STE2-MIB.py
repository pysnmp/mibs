...
mibBuilder.exportSymbols("STE2-MIB", inpIndex=inpIndex, x390=x390, inpValue=inpValue, sensUnit=sensUnit, UnitType=UnitType, IOName=IOName, sensSN=sensSN, PositiveInteger=PositiveInteger, sensState=sensState, inpName=inpName, InputAlarmState=InputAlarmState, sensEntry=sensEntry, sensString=sensString, sensID=sensID, OnOff=OnOff, info=info, SensorState=SensorState, sensValue=sensValue, sensName=sensName, SensorString=SensorString, SensorValue=SensorValue, sensTable=sensTable, hwgroup=hwgroup, sensIndex=sensIndex, inpAlarmState=inpAlarmState, infoAddressMAC=infoAddressMAC, inpEntry=inpEntry, SensorID=SensorID, inpTable=inpTable, SensorName=SensorName, ste2=ste2, SensorSN=SensorSN)
