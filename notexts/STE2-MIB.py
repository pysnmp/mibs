...
mibBuilder.exportSymbols("STE2-MIB", sensState=sensState, IOName=IOName, sensUnit=sensUnit, ste2=ste2, PositiveInteger=PositiveInteger, SensorString=SensorString, sensIndex=sensIndex, sensEntry=sensEntry, inpIndex=inpIndex, inpAlarmState=inpAlarmState, SensorSN=SensorSN, inpEntry=inpEntry, sensString=sensString, SensorID=SensorID, sensValue=sensValue, info=info, sensTable=sensTable, SensorValue=SensorValue, inpTable=inpTable, inpName=inpName, hwgroup=hwgroup, inpValue=inpValue, SensorName=SensorName, OnOff=OnOff, SensorState=SensorState, InputAlarmState=InputAlarmState, infoAddressMAC=infoAddressMAC, UnitType=UnitType, sensSN=sensSN, sensName=sensName, x390=x390, sensID=sensID)
