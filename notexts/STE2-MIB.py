...
mibBuilder.exportSymbols("STE2-MIB", sensString=sensString, x390=x390, inpName=inpName, inpAlarmState=inpAlarmState, SensorState=SensorState, inpEntry=inpEntry, sensState=sensState, sensID=sensID, OnOff=OnOff, UnitType=UnitType, SensorSN=SensorSN, infoAddressMAC=infoAddressMAC, sensName=sensName, sensTable=sensTable, PositiveInteger=PositiveInteger, inpTable=inpTable, SensorName=SensorName, inpIndex=inpIndex, hwgroup=hwgroup, sensUnit=sensUnit, IOName=IOName, sensSN=sensSN, ste2=ste2, SensorString=SensorString, sensEntry=sensEntry, sensIndex=sensIndex, SensorID=SensorID, info=info, inpValue=inpValue, SensorValue=SensorValue, InputAlarmState=InputAlarmState, sensValue=sensValue)
