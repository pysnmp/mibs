...
mibBuilder.exportSymbols("STE2-MIB", sensEntry=sensEntry, PositiveInteger=PositiveInteger, InputAlarmState=InputAlarmState, info=info, sensValue=sensValue, sensID=sensID, SensorSN=SensorSN, x390=x390, inpEntry=inpEntry, inpIndex=inpIndex, inpValue=inpValue, hwgroup=hwgroup, UnitType=UnitType, SensorName=SensorName, sensState=sensState, SensorString=SensorString, SensorState=SensorState, sensString=sensString, OnOff=OnOff, SensorValue=SensorValue, inpName=inpName, inpAlarmState=inpAlarmState, sensSN=sensSN, SensorID=SensorID, infoAddressMAC=infoAddressMAC, sensName=sensName, IOName=IOName, sensIndex=sensIndex, inpTable=inpTable, ste2=ste2, sensTable=sensTable, sensUnit=sensUnit)
