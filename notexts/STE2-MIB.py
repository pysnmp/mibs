...
mibBuilder.exportSymbols("STE2-MIB", SensorValue=SensorValue, inpEntry=inpEntry, sensEntry=sensEntry, SensorID=SensorID, InputAlarmState=InputAlarmState, PositiveInteger=PositiveInteger, sensString=sensString, x390=x390, SensorName=SensorName, inpAlarmState=inpAlarmState, ste2=ste2, OnOff=OnOff, inpIndex=inpIndex, UnitType=UnitType, SensorString=SensorString, hwgroup=hwgroup, sensValue=sensValue, sensSN=sensSN, sensState=sensState, info=info, inpName=inpName, SensorState=SensorState, sensName=sensName, sensUnit=sensUnit, IOName=IOName, sensID=sensID, sensTable=sensTable, inpTable=inpTable, inpValue=inpValue, infoAddressMAC=infoAddressMAC, SensorSN=SensorSN, sensIndex=sensIndex)
