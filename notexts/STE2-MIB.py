...
mibBuilder.exportSymbols("STE2-MIB", UnitType=UnitType, sensValue=sensValue, InputAlarmState=InputAlarmState, sensState=sensState, sensName=sensName, info=info, sensID=sensID, infoAddressMAC=infoAddressMAC, sensEntry=sensEntry, sensIndex=sensIndex, PositiveInteger=PositiveInteger, inpAlarmState=inpAlarmState, SensorState=SensorState, inpEntry=inpEntry, SensorName=SensorName, inpIndex=inpIndex, SensorSN=SensorSN, sensUnit=sensUnit, x390=x390, sensSN=sensSN, SensorValue=SensorValue, OnOff=OnOff, SensorString=SensorString, inpName=inpName, hwgroup=hwgroup, sensString=sensString, IOName=IOName, sensTable=sensTable, ste2=ste2, SensorID=SensorID, inpValue=inpValue, inpTable=inpTable)
