...
mibBuilder.exportSymbols("STE2-MIB", SensorValue=SensorValue, SensorName=SensorName, sensValue=sensValue, sensEntry=sensEntry, SensorID=SensorID, inpValue=inpValue, inpTable=inpTable, ste2=ste2, sensUnit=sensUnit, PositiveInteger=PositiveInteger, IOName=IOName, SensorState=SensorState, OnOff=OnOff, sensSN=sensSN, UnitType=UnitType, inpEntry=inpEntry, sensTable=sensTable, InputAlarmState=InputAlarmState, inpName=inpName, inpAlarmState=inpAlarmState, sensIndex=sensIndex, inpIndex=inpIndex, sensID=sensID, SensorSN=SensorSN, SensorString=SensorString, sensState=sensState, info=info, hwgroup=hwgroup, sensName=sensName, sensString=sensString, infoAddressMAC=infoAddressMAC, x390=x390)
