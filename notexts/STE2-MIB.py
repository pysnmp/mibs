...
mibBuilder.exportSymbols("STE2-MIB", sensEntry=sensEntry, InputAlarmState=InputAlarmState, inpIndex=inpIndex, inpEntry=inpEntry, SensorState=SensorState, info=info, sensState=sensState, sensValue=sensValue, sensUnit=sensUnit, x390=x390, sensID=sensID, IOName=IOName, inpAlarmState=inpAlarmState, SensorValue=SensorValue, sensSN=sensSN, inpTable=inpTable, PositiveInteger=PositiveInteger, SensorSN=SensorSN, ste2=ste2, SensorID=SensorID, infoAddressMAC=infoAddressMAC, UnitType=UnitType, SensorName=SensorName, sensIndex=sensIndex, inpValue=inpValue, sensString=sensString, OnOff=OnOff, sensName=sensName, SensorString=SensorString, sensTable=sensTable, inpName=inpName, hwgroup=hwgroup)
