...
mibBuilder.exportSymbols("STE2-MIB", x390=x390, sensState=sensState, sensIndex=sensIndex, PositiveInteger=PositiveInteger, inpEntry=inpEntry, sensID=sensID, InputAlarmState=InputAlarmState, inpIndex=inpIndex, sensSN=sensSN, SensorName=SensorName, inpName=inpName, sensTable=sensTable, sensUnit=sensUnit, IOName=IOName, SensorState=SensorState, sensValue=sensValue, info=info, OnOff=OnOff, inpAlarmState=inpAlarmState, ste2=ste2, sensEntry=sensEntry, infoAddressMAC=infoAddressMAC, hwgroup=hwgroup, inpValue=inpValue, sensName=sensName, SensorSN=SensorSN, SensorID=SensorID, UnitType=UnitType, SensorValue=SensorValue, sensString=sensString, SensorString=SensorString, inpTable=inpTable)
