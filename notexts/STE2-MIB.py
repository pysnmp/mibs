...
mibBuilder.exportSymbols("STE2-MIB", sensID=sensID, UnitType=UnitType, SensorValue=SensorValue, sensName=sensName, inpTable=inpTable, hwgroup=hwgroup, sensValue=sensValue, inpAlarmState=inpAlarmState, PositiveInteger=PositiveInteger, InputAlarmState=InputAlarmState, inpEntry=inpEntry, SensorID=SensorID, sensState=sensState, SensorName=SensorName, SensorState=SensorState, sensEntry=sensEntry, infoAddressMAC=infoAddressMAC, sensTable=sensTable, sensIndex=sensIndex, inpName=inpName, IOName=IOName, SensorString=SensorString, info=info, inpIndex=inpIndex, sensString=sensString, inpValue=inpValue, sensSN=sensSN, ste2=ste2, OnOff=OnOff, sensUnit=sensUnit, SensorSN=SensorSN, x390=x390)
