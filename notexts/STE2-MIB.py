...
mibBuilder.exportSymbols("STE2-MIB", sensID=sensID, sensIndex=sensIndex, inpValue=inpValue, sensName=sensName, sensState=sensState, SensorID=SensorID, sensUnit=sensUnit, IOName=IOName, info=info, sensSN=sensSN, InputAlarmState=InputAlarmState, infoAddressMAC=infoAddressMAC, PositiveInteger=PositiveInteger, SensorName=SensorName, SensorValue=SensorValue, SensorString=SensorString, hwgroup=hwgroup, sensTable=sensTable, sensEntry=sensEntry, UnitType=UnitType, inpIndex=inpIndex, x390=x390, sensString=sensString, inpAlarmState=inpAlarmState, inpEntry=inpEntry, sensValue=sensValue, SensorSN=SensorSN, inpTable=inpTable, ste2=ste2, OnOff=OnOff, inpName=inpName, SensorState=SensorState)
