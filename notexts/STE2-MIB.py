...
mibBuilder.exportSymbols("STE2-MIB", sensTable=sensTable, SensorName=SensorName, OnOff=OnOff, sensID=sensID, SensorValue=SensorValue, SensorSN=SensorSN, x390=x390, ste2=ste2, inpIndex=inpIndex, sensName=sensName, sensState=sensState, info=info, sensEntry=sensEntry, sensSN=sensSN, infoAddressMAC=infoAddressMAC, sensUnit=sensUnit, SensorState=SensorState, SensorString=SensorString, inpAlarmState=inpAlarmState, hwgroup=hwgroup, sensString=sensString, inpName=inpName, SensorID=SensorID, sensValue=sensValue, inpEntry=inpEntry, IOName=IOName, sensIndex=sensIndex, InputAlarmState=InputAlarmState, UnitType=UnitType, inpValue=inpValue, PositiveInteger=PositiveInteger, inpTable=inpTable)
