...
mibBuilder.exportSymbols("STE2-MIB", infoAddressMAC=infoAddressMAC, UnitType=UnitType, SensorValue=SensorValue, info=info, PositiveInteger=PositiveInteger, SensorName=SensorName, sensState=sensState, SensorString=SensorString, ste2=ste2, sensSN=sensSN, sensValue=sensValue, SensorID=SensorID, hwgroup=hwgroup, inpIndex=inpIndex, x390=x390, inpTable=inpTable, sensID=sensID, sensEntry=sensEntry, sensString=sensString, sensName=sensName, IOName=IOName, InputAlarmState=InputAlarmState, SensorSN=SensorSN, inpName=inpName, sensUnit=sensUnit, OnOff=OnOff, inpAlarmState=inpAlarmState, SensorState=SensorState, sensTable=sensTable, sensIndex=sensIndex, inpEntry=inpEntry, inpValue=inpValue)
