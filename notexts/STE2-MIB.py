...
mibBuilder.exportSymbols("STE2-MIB", sensState=sensState, inpEntry=inpEntry, SensorName=SensorName, inpTable=inpTable, sensTable=sensTable, sensIndex=sensIndex, sensValue=sensValue, x390=x390, info=info, sensID=sensID, sensUnit=sensUnit, sensEntry=sensEntry, infoAddressMAC=infoAddressMAC, inpAlarmState=inpAlarmState, inpIndex=inpIndex, IOName=IOName, SensorValue=SensorValue, hwgroup=hwgroup, SensorState=SensorState, SensorID=SensorID, sensName=sensName, inpName=inpName, ste2=ste2, inpValue=inpValue, PositiveInteger=PositiveInteger, sensSN=sensSN, InputAlarmState=InputAlarmState, UnitType=UnitType, OnOff=OnOff, SensorSN=SensorSN, sensString=sensString, SensorString=SensorString)
