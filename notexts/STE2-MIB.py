...
mibBuilder.exportSymbols("STE2-MIB", sensIndex=sensIndex, UnitType=UnitType, inpName=inpName, sensEntry=sensEntry, infoAddressMAC=infoAddressMAC, sensID=sensID, inpValue=inpValue, SensorID=SensorID, sensUnit=sensUnit, OnOff=OnOff, IOName=IOName, SensorString=SensorString, SensorState=SensorState, x390=x390, sensString=sensString, PositiveInteger=PositiveInteger, hwgroup=hwgroup, InputAlarmState=InputAlarmState, SensorSN=SensorSN, inpIndex=inpIndex, ste2=ste2, info=info, sensSN=sensSN, sensTable=sensTable, sensName=sensName, inpTable=inpTable, SensorValue=SensorValue, inpEntry=inpEntry, sensValue=sensValue, inpAlarmState=inpAlarmState, sensState=sensState, SensorName=SensorName)
