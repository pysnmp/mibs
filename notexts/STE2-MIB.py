...
mibBuilder.exportSymbols("STE2-MIB", sensValue=sensValue, OnOff=OnOff, SensorString=SensorString, inpName=inpName, SensorSN=SensorSN, UnitType=UnitType, sensString=sensString, infoAddressMAC=infoAddressMAC, inpTable=inpTable, SensorState=SensorState, sensSN=sensSN, sensUnit=sensUnit, PositiveInteger=PositiveInteger, sensState=sensState, inpIndex=inpIndex, SensorValue=SensorValue, inpValue=inpValue, sensID=sensID, sensIndex=sensIndex, SensorName=SensorName, sensTable=sensTable, InputAlarmState=InputAlarmState, SensorID=SensorID, info=info, sensEntry=sensEntry, x390=x390, IOName=IOName, hwgroup=hwgroup, ste2=ste2, inpEntry=inpEntry, inpAlarmState=inpAlarmState, sensName=sensName)
