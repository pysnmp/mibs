...
mibBuilder.exportSymbols("STE2-MIB", SensorValue=SensorValue, SensorString=SensorString, sensID=sensID, SensorName=SensorName, x390=x390, SensorID=SensorID, inpEntry=inpEntry, PositiveInteger=PositiveInteger, InputAlarmState=InputAlarmState, IOName=IOName, sensString=sensString, info=info, sensState=sensState, infoAddressMAC=infoAddressMAC, inpName=inpName, sensValue=sensValue, sensSN=sensSN, SensorSN=SensorSN, sensName=sensName, sensEntry=sensEntry, OnOff=OnOff, sensUnit=sensUnit, sensIndex=sensIndex, UnitType=UnitType, sensTable=sensTable, hwgroup=hwgroup, inpTable=inpTable, ste2=ste2, SensorState=SensorState, inpIndex=inpIndex, inpValue=inpValue, inpAlarmState=inpAlarmState)
