...
mibBuilder.exportSymbols("STE2-MIB", SensorValue=SensorValue, hwgroup=hwgroup, SensorSN=SensorSN, inpTable=inpTable, inpEntry=inpEntry, sensTable=sensTable, sensSN=sensSN, SensorName=SensorName, info=info, inpName=inpName, sensName=sensName, infoAddressMAC=infoAddressMAC, SensorState=SensorState, IOName=IOName, sensIndex=sensIndex, inpAlarmState=inpAlarmState, x390=x390, SensorID=SensorID, PositiveInteger=PositiveInteger, sensValue=sensValue, InputAlarmState=InputAlarmState, sensState=sensState, sensID=sensID, OnOff=OnOff, sensString=sensString, sensUnit=sensUnit, SensorString=SensorString, ste2=ste2, inpIndex=inpIndex, inpValue=inpValue, UnitType=UnitType, sensEntry=sensEntry)
