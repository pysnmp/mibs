...
mibBuilder.exportSymbols("STE2-MIB", sensSN=sensSN, ste2=ste2, infoAddressMAC=infoAddressMAC, SensorString=SensorString, inpTable=inpTable, inpName=inpName, SensorName=SensorName, sensString=sensString, SensorSN=SensorSN, sensValue=sensValue, x390=x390, SensorValue=SensorValue, sensUnit=sensUnit, hwgroup=hwgroup, PositiveInteger=PositiveInteger, SensorState=SensorState, sensEntry=sensEntry, inpIndex=inpIndex, inpEntry=inpEntry, sensID=sensID, SensorID=SensorID, IOName=IOName, OnOff=OnOff, inpAlarmState=inpAlarmState, UnitType=UnitType, inpValue=inpValue, sensState=sensState, InputAlarmState=InputAlarmState, info=info, sensIndex=sensIndex, sensTable=sensTable, sensName=sensName)
