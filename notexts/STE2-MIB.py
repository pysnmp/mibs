...
mibBuilder.exportSymbols("STE2-MIB", sensValue=sensValue, SensorString=SensorString, inpValue=inpValue, inpIndex=inpIndex, sensUnit=sensUnit, inpEntry=inpEntry, sensIndex=sensIndex, x390=x390, SensorName=SensorName, IOName=IOName, OnOff=OnOff, sensName=sensName, InputAlarmState=InputAlarmState, inpName=inpName, sensString=sensString, sensState=sensState, sensID=sensID, infoAddressMAC=infoAddressMAC, sensEntry=sensEntry, info=info, UnitType=UnitType, hwgroup=hwgroup, SensorValue=SensorValue, sensTable=sensTable, SensorSN=SensorSN, SensorID=SensorID, SensorState=SensorState, PositiveInteger=PositiveInteger, ste2=ste2, inpTable=inpTable, sensSN=sensSN, inpAlarmState=inpAlarmState)
