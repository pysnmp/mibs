...
mibBuilder.exportSymbols("STE2-MIB", infoAddressMAC=infoAddressMAC, inpName=inpName, UnitType=UnitType, inpIndex=inpIndex, OnOff=OnOff, ste2=ste2, sensIndex=sensIndex, SensorString=SensorString, sensID=sensID, SensorValue=SensorValue, x390=x390, sensString=sensString, SensorState=SensorState, info=info, inpAlarmState=inpAlarmState, sensSN=sensSN, IOName=IOName, sensUnit=sensUnit, PositiveInteger=PositiveInteger, sensValue=sensValue, inpEntry=inpEntry, SensorName=SensorName, hwgroup=hwgroup, inpValue=inpValue, inpTable=inpTable, SensorID=SensorID, sensEntry=sensEntry, sensState=sensState, sensTable=sensTable, InputAlarmState=InputAlarmState, SensorSN=SensorSN, sensName=sensName)
