...
mibBuilder.exportSymbols("STE2-MIB", SensorSN=SensorSN, inpValue=inpValue, PositiveInteger=PositiveInteger, SensorValue=SensorValue, sensSN=sensSN, sensState=sensState, sensValue=sensValue, ste2=ste2, sensIndex=sensIndex, x390=x390, inpAlarmState=inpAlarmState, inpIndex=inpIndex, info=info, OnOff=OnOff, InputAlarmState=InputAlarmState, inpEntry=inpEntry, SensorName=SensorName, SensorString=SensorString, SensorID=SensorID, sensUnit=sensUnit, SensorState=SensorState, sensTable=sensTable, hwgroup=hwgroup, sensString=sensString, sensID=sensID, UnitType=UnitType, sensName=sensName, sensEntry=sensEntry, IOName=IOName, infoAddressMAC=infoAddressMAC, inpName=inpName, inpTable=inpTable)
