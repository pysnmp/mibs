...
mibBuilder.exportSymbols("STE2-MIB", SensorState=SensorState, sensEntry=sensEntry, inpTable=inpTable, inpEntry=inpEntry, sensIndex=sensIndex, sensUnit=sensUnit, inpIndex=inpIndex, info=info, PositiveInteger=PositiveInteger, SensorSN=SensorSN, inpAlarmState=inpAlarmState, IOName=IOName, inpName=inpName, hwgroup=hwgroup, x390=x390, InputAlarmState=InputAlarmState, SensorValue=SensorValue, sensTable=sensTable, UnitType=UnitType, sensState=sensState, SensorString=SensorString, sensID=sensID, SensorName=SensorName, OnOff=OnOff, SensorID=SensorID, inpValue=inpValue, sensValue=sensValue, sensSN=sensSN, sensString=sensString, sensName=sensName, infoAddressMAC=infoAddressMAC, ste2=ste2)
