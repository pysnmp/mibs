...
mibBuilder.exportSymbols("STE2-MIB", sensIndex=sensIndex, SensorState=SensorState, inpName=inpName, ste2=ste2, sensValue=sensValue, SensorID=SensorID, infoAddressMAC=infoAddressMAC, OnOff=OnOff, inpAlarmState=inpAlarmState, sensEntry=sensEntry, inpEntry=inpEntry, SensorName=SensorName, sensUnit=sensUnit, x390=x390, inpIndex=inpIndex, info=info, SensorString=SensorString, inpTable=inpTable, sensTable=sensTable, sensSN=sensSN, PositiveInteger=PositiveInteger, inpValue=inpValue, sensName=sensName, hwgroup=hwgroup, UnitType=UnitType, sensState=sensState, sensID=sensID, IOName=IOName, SensorSN=SensorSN, sensString=sensString, InputAlarmState=InputAlarmState, SensorValue=SensorValue)
