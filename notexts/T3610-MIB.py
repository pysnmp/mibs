...
# Produced by pysmi-1.1.10 at Thu Oct 26 13:01:55 2023
...
Bits, MibIdentifier, ObjectIdentity, Unsigned32, NotificationType, Integer32, NotificationType, Counter32, enterprises, Counter64, TimeTicks, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibIdentifier", "ObjectIdentity", "Unsigned32", "NotificationType", "Integer32", "NotificationType", "Counter32", "enterprises", "Counter64", "TimeTicks", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso")
...
mibBuilder.exportSymbols("T3610-MIB", trapHumLowAlarm=trapHumLowAlarm, values=values, humInt=humInt, pysmi_global=pysmi_global, trapSOAPErrFile=trapSOAPErrFile, compValInt=compValInt, histCompVal=histCompVal, trapHumError=trapHumError, compValHystInt=compValHystInt, traps=traps, tempAlarm=tempAlarm, compValAlarmInt=compValAlarmInt, compValDelayInt=compValDelayInt, trapTempClrAlarm=trapTempClrAlarm, histHum=histHum, trapSOAPErrDNS=trapSOAPErrDNS, trapCompValHighAlarm=trapCompValHighAlarm, serialNumber=serialNumber, tempMin=tempMin, humAlarmInt=humAlarmInt, tempHighInt=tempHighInt, humDelayInt=humDelayInt, trapEmailErrDNS=trapEmailErrDNS, compVal=compVal, tempUnit=tempUnit, trapHumHighAlarm=trapHumHighAlarm, humAlarm=humAlarm, tempLowInt=tempLowInt, tempDelayInt=tempDelayInt, sensorName=sensorName, historyEntry=historyEntry, histTemp=histTemp, trapTempLowAlarm=trapTempLowAlarm, trapCompValClrAlarm=trapCompValClrAlarm, trapEmailErrSome=trapEmailErrSome, trapTempHighAlarm=trapTempHighAlarm, trapHumClrAlarm=trapHumClrAlarm, tables=tables, settings=settings, deviceType=deviceType, t3610=t3610, trapSOAPErrDelivery=trapSOAPErrDelivery, historyTable=historyTable, trapCompValError=trapCompValError, humMax=humMax, valuesInt=valuesInt, humLowInt=humLowInt, tempInt=tempInt, compValHighInt=compValHighInt, DisplayString=DisplayString, comet=comet, temp=temp, humHystInt=humHystInt, humUnit=humUnit, compValAlarm=compValAlarm, compValUnit=compValUnit, trapTest=trapTest, messageString=messageString, compValMin=compValMin, products=products, trapEmailErrLogin=trapEmailErrLogin, humMin=humMin, tempHystInt=tempHystInt, trapEmailErrSocket=trapEmailErrSocket, trapCompValLowAlarm=trapCompValLowAlarm, trapTempError=trapTempError, compValMax=compValMax, compValLowInt=compValLowInt, hum=hum, humHighInt=humHighInt, trapNTPError=trapNTPError, trapSOAPErrSocket=trapSOAPErrSocket, trapEmailErrAuth=trapEmailErrAuth, tempAlarmInt=tempAlarmInt, tempMax=tempMax)
