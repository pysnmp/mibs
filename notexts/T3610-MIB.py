...
iso, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, Counter64, IpAddress, Integer32, NotificationType, ObjectIdentity, MibIdentifier, Gauge32, NotificationType, enterprises, Counter32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "Counter64", "IpAddress", "Integer32", "NotificationType", "ObjectIdentity", "MibIdentifier", "Gauge32", "NotificationType", "enterprises", "Counter32", "ModuleIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", tempInt=tempInt, trapTempError=trapTempError, compValAlarm=compValAlarm, tempLowInt=tempLowInt, compValUnit=compValUnit, compValMax=compValMax, humInt=humInt, valuesInt=valuesInt, tempDelayInt=tempDelayInt, trapTempHighAlarm=trapTempHighAlarm, trapCompValError=trapCompValError, tempMax=tempMax, tempAlarm=tempAlarm, trapTempLowAlarm=trapTempLowAlarm, trapSOAPErrSocket=trapSOAPErrSocket, trapHumLowAlarm=trapHumLowAlarm, humHighInt=humHighInt, products=products, traps=traps, messageString=messageString, trapEmailErrSome=trapEmailErrSome, pysmi_global=pysmi_global, trapSOAPErrDNS=trapSOAPErrDNS, trapSOAPErrDelivery=trapSOAPErrDelivery, trapHumHighAlarm=trapHumHighAlarm, trapCompValClrAlarm=trapCompValClrAlarm, trapEmailErrSocket=trapEmailErrSocket, DisplayString=DisplayString, compValAlarmInt=compValAlarmInt, settings=settings, histHum=histHum, trapHumClrAlarm=trapHumClrAlarm, trapSOAPErrFile=trapSOAPErrFile, compValLowInt=compValLowInt, compValHighInt=compValHighInt, humAlarmInt=humAlarmInt, tables=tables, temp=temp, serialNumber=serialNumber, values=values, histTemp=histTemp, humLowInt=humLowInt, humHystInt=humHystInt, tempHystInt=tempHystInt, t3610=t3610, tempMin=tempMin, humMin=humMin, compValInt=compValInt, trapEmailErrAuth=trapEmailErrAuth, historyTable=historyTable, compVal=compVal, trapTempClrAlarm=trapTempClrAlarm, hum=hum, humDelayInt=humDelayInt, tempAlarmInt=tempAlarmInt, humUnit=humUnit, compValDelayInt=compValDelayInt, trapNTPError=trapNTPError, sensorName=sensorName, comet=comet, humMax=humMax, trapHumError=trapHumError, humAlarm=humAlarm, tempHighInt=tempHighInt, historyEntry=historyEntry, histCompVal=histCompVal, trapTest=trapTest, trapCompValHighAlarm=trapCompValHighAlarm, trapCompValLowAlarm=trapCompValLowAlarm, compValHystInt=compValHystInt, tempUnit=tempUnit, trapEmailErrLogin=trapEmailErrLogin, deviceType=deviceType, compValMin=compValMin, trapEmailErrDNS=trapEmailErrDNS)
