...
# Produced by pysmi-1.1.8 at Wed Feb  2 17:53:59 2022
...
IpAddress, ObjectIdentity, MibIdentifier, Integer32, Bits, Counter64, iso, TimeTicks, Gauge32, NotificationType, NotificationType, Unsigned32, enterprises, Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ObjectIdentity", "MibIdentifier", "Integer32", "Bits", "Counter64", "iso", "TimeTicks", "Gauge32", "NotificationType", "NotificationType", "Unsigned32", "enterprises", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("T3610-MIB", compValLowInt=compValLowInt, trapEmailErrSocket=trapEmailErrSocket, tempLowInt=tempLowInt, messageString=messageString, trapSOAPErrSocket=trapSOAPErrSocket, tables=tables, tempAlarm=tempAlarm, trapTempError=trapTempError, compValMax=compValMax, temp=temp, humMin=humMin, trapSOAPErrDelivery=trapSOAPErrDelivery, t3610=t3610, DisplayString=DisplayString, humHighInt=humHighInt, sensorName=sensorName, valuesInt=valuesInt, compVal=compVal, deviceType=deviceType, tempMin=tempMin, trapSOAPErrDNS=trapSOAPErrDNS, trapHumClrAlarm=trapHumClrAlarm, trapCompValError=trapCompValError, tempInt=tempInt, compValAlarmInt=compValAlarmInt, trapTest=trapTest, compValMin=compValMin, comet=comet, settings=settings, humDelayInt=humDelayInt, histTemp=histTemp, trapHumHighAlarm=trapHumHighAlarm, trapTempLowAlarm=trapTempLowAlarm, trapHumLowAlarm=trapHumLowAlarm, tempHystInt=tempHystInt, serialNumber=serialNumber, humAlarm=humAlarm, trapEmailErrLogin=trapEmailErrLogin, histHum=histHum, compValHighInt=compValHighInt, trapTempHighAlarm=trapTempHighAlarm, traps=traps, humInt=humInt, compValDelayInt=compValDelayInt, humUnit=humUnit, histCompVal=histCompVal, tempMax=tempMax, trapEmailErrSome=trapEmailErrSome, historyTable=historyTable, trapHumError=trapHumError, pysmi_global=pysmi_global, compValHystInt=compValHystInt, trapSOAPErrFile=trapSOAPErrFile, compValAlarm=compValAlarm, trapCompValLowAlarm=trapCompValLowAlarm, compValUnit=compValUnit, compValInt=compValInt, products=products, trapTempClrAlarm=trapTempClrAlarm, tempHighInt=tempHighInt, tempDelayInt=tempDelayInt, trapEmailErrAuth=trapEmailErrAuth, historyEntry=historyEntry, trapNTPError=trapNTPError, humAlarmInt=humAlarmInt, tempAlarmInt=tempAlarmInt, trapCompValHighAlarm=trapCompValHighAlarm, hum=hum, humHystInt=humHystInt, trapCompValClrAlarm=trapCompValClrAlarm, humLowInt=humLowInt, trapEmailErrDNS=trapEmailErrDNS, humMax=humMax, tempUnit=tempUnit, values=values)
