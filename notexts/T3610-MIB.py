...
# Produced by pysmi-1.1.8 at Fri Jul  8 08:51:18 2022
...
Gauge32, NotificationType, ModuleIdentity, enterprises, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, iso, Counter64, IpAddress, MibIdentifier, ObjectIdentity, TimeTicks, Unsigned32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "ModuleIdentity", "enterprises", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "iso", "Counter64", "IpAddress", "MibIdentifier", "ObjectIdentity", "TimeTicks", "Unsigned32", "Integer32")
...
mibBuilder.exportSymbols("T3610-MIB", t3610=t3610, histTemp=histTemp, tempAlarmInt=tempAlarmInt, compValAlarmInt=compValAlarmInt, tempLowInt=tempLowInt, trapEmailErrAuth=trapEmailErrAuth, temp=temp, sensorName=sensorName, trapEmailErrLogin=trapEmailErrLogin, trapCompValHighAlarm=trapCompValHighAlarm, messageString=messageString, trapEmailErrSocket=trapEmailErrSocket, traps=traps, humInt=humInt, hum=hum, humMax=humMax, histCompVal=histCompVal, historyEntry=historyEntry, compVal=compVal, trapSOAPErrSocket=trapSOAPErrSocket, humUnit=humUnit, trapCompValLowAlarm=trapCompValLowAlarm, humHighInt=humHighInt, compValDelayInt=compValDelayInt, compValMin=compValMin, tempHighInt=tempHighInt, DisplayString=DisplayString, trapHumHighAlarm=trapHumHighAlarm, humMin=humMin, compValInt=compValInt, trapHumClrAlarm=trapHumClrAlarm, valuesInt=valuesInt, values=values, histHum=histHum, trapEmailErrDNS=trapEmailErrDNS, trapCompValError=trapCompValError, trapTest=trapTest, settings=settings, historyTable=historyTable, tempInt=tempInt, trapHumLowAlarm=trapHumLowAlarm, tables=tables, trapSOAPErrDelivery=trapSOAPErrDelivery, tempMax=tempMax, compValMax=compValMax, humAlarmInt=humAlarmInt, tempDelayInt=tempDelayInt, compValHystInt=compValHystInt, trapSOAPErrFile=trapSOAPErrFile, compValUnit=compValUnit, humHystInt=humHystInt, trapNTPError=trapNTPError, trapTempHighAlarm=trapTempHighAlarm, humDelayInt=humDelayInt, tempHystInt=tempHystInt, humLowInt=humLowInt, trapHumError=trapHumError, pysmi_global=pysmi_global, tempMin=tempMin, trapTempLowAlarm=trapTempLowAlarm, compValAlarm=compValAlarm, trapCompValClrAlarm=trapCompValClrAlarm, trapTempClrAlarm=trapTempClrAlarm, products=products, serialNumber=serialNumber, trapSOAPErrDNS=trapSOAPErrDNS, humAlarm=humAlarm, tempAlarm=tempAlarm, deviceType=deviceType, compValLowInt=compValLowInt, compValHighInt=compValHighInt, tempUnit=tempUnit, trapEmailErrSome=trapEmailErrSome, comet=comet, trapTempError=trapTempError)
