...
# Produced by pysmi-1.1.3 at Sun Nov 28 17:22:13 2021
...
NotificationType, Integer32, TimeTicks, Counter64, MibIdentifier, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, iso, ModuleIdentity, ObjectIdentity, Bits, NotificationType, IpAddress, Counter32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "TimeTicks", "Counter64", "MibIdentifier", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "iso", "ModuleIdentity", "ObjectIdentity", "Bits", "NotificationType", "IpAddress", "Counter32", "enterprises")
...
mibBuilder.exportSymbols("T3610-MIB", t3610=t3610, trapHumLowAlarm=trapHumLowAlarm, histHum=histHum, histCompVal=histCompVal, humInt=humInt, historyEntry=historyEntry, trapSOAPErrSocket=trapSOAPErrSocket, trapSOAPErrFile=trapSOAPErrFile, humUnit=humUnit, tempHighInt=tempHighInt, trapCompValHighAlarm=trapCompValHighAlarm, tempAlarm=tempAlarm, temp=temp, trapTempError=trapTempError, products=products, settings=settings, compValMax=compValMax, trapHumClrAlarm=trapHumClrAlarm, humAlarm=humAlarm, serialNumber=serialNumber, trapTempClrAlarm=trapTempClrAlarm, tempDelayInt=tempDelayInt, compValHystInt=compValHystInt, historyTable=historyTable, hum=hum, compValAlarmInt=compValAlarmInt, trapCompValClrAlarm=trapCompValClrAlarm, compValDelayInt=compValDelayInt, compVal=compVal, comet=comet, tempLowInt=tempLowInt, humHighInt=humHighInt, values=values, compValMin=compValMin, tempInt=tempInt, tempAlarmInt=tempAlarmInt, valuesInt=valuesInt, humDelayInt=humDelayInt, trapSOAPErrDelivery=trapSOAPErrDelivery, compValInt=compValInt, trapEmailErrAuth=trapEmailErrAuth, trapHumError=trapHumError, DisplayString=DisplayString, compValLowInt=compValLowInt, deviceType=deviceType, sensorName=sensorName, trapEmailErrDNS=trapEmailErrDNS, humMax=humMax, trapSOAPErrDNS=trapSOAPErrDNS, pysmi_global=pysmi_global, trapHumHighAlarm=trapHumHighAlarm, tempUnit=tempUnit, messageString=messageString, trapTest=trapTest, trapEmailErrSome=trapEmailErrSome, tempMin=tempMin, compValHighInt=compValHighInt, trapEmailErrLogin=trapEmailErrLogin, trapCompValLowAlarm=trapCompValLowAlarm, tables=tables, histTemp=histTemp, traps=traps, trapEmailErrSocket=trapEmailErrSocket, humHystInt=humHystInt, trapTempHighAlarm=trapTempHighAlarm, compValUnit=compValUnit, trapNTPError=trapNTPError, tempMax=tempMax, humLowInt=humLowInt, trapCompValError=trapCompValError, humMin=humMin, humAlarmInt=humAlarmInt, trapTempLowAlarm=trapTempLowAlarm, compValAlarm=compValAlarm, tempHystInt=tempHystInt)
