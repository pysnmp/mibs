...
# Produced by pysmi-1.1.3 at Mon Nov 22 12:39:56 2021
...
Counter32, NotificationType, ObjectIdentity, Bits, IpAddress, Counter64, ModuleIdentity, Integer32, TimeTicks, MibIdentifier, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, enterprises, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "ObjectIdentity", "Bits", "IpAddress", "Counter64", "ModuleIdentity", "Integer32", "TimeTicks", "MibIdentifier", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "enterprises", "iso")
...
mibBuilder.exportSymbols("T3610-MIB", sensorName=sensorName, tempAlarm=tempAlarm, compValLowInt=compValLowInt, trapNTPError=trapNTPError, trapTempHighAlarm=trapTempHighAlarm, trapCompValLowAlarm=trapCompValLowAlarm, DisplayString=DisplayString, tempAlarmInt=tempAlarmInt, trapHumHighAlarm=trapHumHighAlarm, trapTempLowAlarm=trapTempLowAlarm, humLowInt=humLowInt, compValInt=compValInt, compValAlarm=compValAlarm, trapCompValError=trapCompValError, compValMax=compValMax, historyTable=historyTable, tempMin=tempMin, histTemp=histTemp, temp=temp, values=values, tempUnit=tempUnit, humAlarm=humAlarm, humHystInt=humHystInt, messageString=messageString, trapEmailErrAuth=trapEmailErrAuth, tempHystInt=tempHystInt, products=products, traps=traps, t3610=t3610, serialNumber=serialNumber, pysmi_global=pysmi_global, tables=tables, trapHumLowAlarm=trapHumLowAlarm, tempInt=tempInt, trapEmailErrSome=trapEmailErrSome, trapTempError=trapTempError, humDelayInt=humDelayInt, trapEmailErrLogin=trapEmailErrLogin, histHum=histHum, humHighInt=humHighInt, trapSOAPErrSocket=trapSOAPErrSocket, humMax=humMax, tempLowInt=tempLowInt, trapHumClrAlarm=trapHumClrAlarm, valuesInt=valuesInt, compValAlarmInt=compValAlarmInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapHumError=trapHumError, trapSOAPErrDNS=trapSOAPErrDNS, compValUnit=compValUnit, tempHighInt=tempHighInt, trapEmailErrSocket=trapEmailErrSocket, trapCompValClrAlarm=trapCompValClrAlarm, historyEntry=historyEntry, humUnit=humUnit, compVal=compVal, humMin=humMin, trapCompValHighAlarm=trapCompValHighAlarm, compValHighInt=compValHighInt, trapTempClrAlarm=trapTempClrAlarm, hum=hum, histCompVal=histCompVal, comet=comet, compValMin=compValMin, trapSOAPErrFile=trapSOAPErrFile, tempMax=tempMax, humInt=humInt, humAlarmInt=humAlarmInt, trapEmailErrDNS=trapEmailErrDNS, tempDelayInt=tempDelayInt, compValDelayInt=compValDelayInt, trapTest=trapTest, settings=settings, compValHystInt=compValHystInt, deviceType=deviceType)
