...
# Produced by pysmi-1.1.11 at Tue Dec  5 08:32:20 2023
...
Gauge32, ObjectIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Integer32, iso, MibIdentifier, Counter64, IpAddress, NotificationType, ModuleIdentity, TimeTicks, NotificationType, enterprises, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Integer32", "iso", "MibIdentifier", "Counter64", "IpAddress", "NotificationType", "ModuleIdentity", "TimeTicks", "NotificationType", "enterprises", "Counter32")
...
mibBuilder.exportSymbols("T3610-MIB", humHystInt=humHystInt, values=values, compVal=compVal, trapSOAPErrFile=trapSOAPErrFile, trapCompValLowAlarm=trapCompValLowAlarm, tempHystInt=tempHystInt, hum=hum, humMax=humMax, tempDelayInt=tempDelayInt, humAlarm=humAlarm, trapNTPError=trapNTPError, humAlarmInt=humAlarmInt, trapEmailErrAuth=trapEmailErrAuth, trapTempClrAlarm=trapTempClrAlarm, trapTempHighAlarm=trapTempHighAlarm, trapEmailErrSocket=trapEmailErrSocket, t3610=t3610, tempUnit=tempUnit, humMin=humMin, tempLowInt=tempLowInt, serialNumber=serialNumber, humLowInt=humLowInt, comet=comet, tempMin=tempMin, tempHighInt=tempHighInt, histHum=histHum, compValAlarmInt=compValAlarmInt, compValInt=compValInt, humUnit=humUnit, humHighInt=humHighInt, compValHighInt=compValHighInt, histTemp=histTemp, trapSOAPErrDNS=trapSOAPErrDNS, trapTempLowAlarm=trapTempLowAlarm, trapHumLowAlarm=trapHumLowAlarm, trapHumError=trapHumError, tempInt=tempInt, compValDelayInt=compValDelayInt, histCompVal=histCompVal, humInt=humInt, trapHumHighAlarm=trapHumHighAlarm, tables=tables, trapCompValError=trapCompValError, products=products, tempAlarmInt=tempAlarmInt, trapEmailErrDNS=trapEmailErrDNS, valuesInt=valuesInt, pysmi_global=pysmi_global, compValMax=compValMax, sensorName=sensorName, trapEmailErrSome=trapEmailErrSome, compValMin=compValMin, historyTable=historyTable, compValUnit=compValUnit, deviceType=deviceType, trapSOAPErrDelivery=trapSOAPErrDelivery, trapCompValHighAlarm=trapCompValHighAlarm, trapCompValClrAlarm=trapCompValClrAlarm, tempAlarm=tempAlarm, DisplayString=DisplayString, compValLowInt=compValLowInt, temp=temp, humDelayInt=humDelayInt, historyEntry=historyEntry, trapHumClrAlarm=trapHumClrAlarm, trapTempError=trapTempError, tempMax=tempMax, trapSOAPErrSocket=trapSOAPErrSocket, settings=settings, traps=traps, trapEmailErrLogin=trapEmailErrLogin, trapTest=trapTest, compValHystInt=compValHystInt, compValAlarm=compValAlarm, messageString=messageString)
