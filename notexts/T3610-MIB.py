...
# Produced by pysmi-1.1.10 at Thu Apr  4 02:55:24 2024
...
Integer32, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, enterprises, TimeTicks, NotificationType, Gauge32, MibIdentifier, ModuleIdentity, iso, Bits, ObjectIdentity, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "enterprises", "TimeTicks", "NotificationType", "Gauge32", "MibIdentifier", "ModuleIdentity", "iso", "Bits", "ObjectIdentity", "Counter64", "Counter32")
...
mibBuilder.exportSymbols("T3610-MIB", trapTempClrAlarm=trapTempClrAlarm, compValAlarm=compValAlarm, humUnit=humUnit, messageString=messageString, humHighInt=humHighInt, trapEmailErrSocket=trapEmailErrSocket, compValDelayInt=compValDelayInt, trapEmailErrDNS=trapEmailErrDNS, humInt=humInt, t3610=t3610, DisplayString=DisplayString, humLowInt=humLowInt, deviceType=deviceType, temp=temp, hum=hum, tempDelayInt=tempDelayInt, historyEntry=historyEntry, trapNTPError=trapNTPError, trapTempLowAlarm=trapTempLowAlarm, historyTable=historyTable, compValMin=compValMin, trapSOAPErrDelivery=trapSOAPErrDelivery, tempInt=tempInt, tempAlarmInt=tempAlarmInt, products=products, humDelayInt=humDelayInt, compValHystInt=compValHystInt, tempHystInt=tempHystInt, histHum=histHum, tempHighInt=tempHighInt, tempUnit=tempUnit, valuesInt=valuesInt, pysmi_global=pysmi_global, trapCompValHighAlarm=trapCompValHighAlarm, trapSOAPErrFile=trapSOAPErrFile, serialNumber=serialNumber, trapSOAPErrDNS=trapSOAPErrDNS, tempAlarm=tempAlarm, comet=comet, values=values, humMax=humMax, trapEmailErrAuth=trapEmailErrAuth, humHystInt=humHystInt, trapHumLowAlarm=trapHumLowAlarm, traps=traps, compValMax=compValMax, humMin=humMin, histTemp=histTemp, trapEmailErrSome=trapEmailErrSome, tempMin=tempMin, trapSOAPErrSocket=trapSOAPErrSocket, trapHumError=trapHumError, compValInt=compValInt, trapTempError=trapTempError, trapCompValError=trapCompValError, tables=tables, sensorName=sensorName, histCompVal=histCompVal, compValHighInt=compValHighInt, settings=settings, compValLowInt=compValLowInt, trapHumClrAlarm=trapHumClrAlarm, trapCompValClrAlarm=trapCompValClrAlarm, trapHumHighAlarm=trapHumHighAlarm, trapTempHighAlarm=trapTempHighAlarm, compVal=compVal, humAlarm=humAlarm, tempLowInt=tempLowInt, compValUnit=compValUnit, trapTest=trapTest, trapEmailErrLogin=trapEmailErrLogin, trapCompValLowAlarm=trapCompValLowAlarm, tempMax=tempMax, compValAlarmInt=compValAlarmInt, humAlarmInt=humAlarmInt)
