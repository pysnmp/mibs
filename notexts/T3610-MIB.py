...
# Produced by pysmi-1.1.8 at Mon Jan 17 19:42:45 2022
...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, MibIdentifier, iso, Unsigned32, ObjectIdentity, TimeTicks, Gauge32, IpAddress, ModuleIdentity, enterprises, Integer32, Counter32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "MibIdentifier", "iso", "Unsigned32", "ObjectIdentity", "TimeTicks", "Gauge32", "IpAddress", "ModuleIdentity", "enterprises", "Integer32", "Counter32", "Counter64")
...
mibBuilder.exportSymbols("T3610-MIB", compValAlarm=compValAlarm, trapNTPError=trapNTPError, trapEmailErrSocket=trapEmailErrSocket, trapCompValError=trapCompValError, DisplayString=DisplayString, trapCompValLowAlarm=trapCompValLowAlarm, trapSOAPErrFile=trapSOAPErrFile, compValMin=compValMin, humAlarm=humAlarm, tempMin=tempMin, temp=temp, pysmi_global=pysmi_global, trapTempClrAlarm=trapTempClrAlarm, trapHumClrAlarm=trapHumClrAlarm, trapCompValClrAlarm=trapCompValClrAlarm, tempUnit=tempUnit, histTemp=histTemp, trapEmailErrSome=trapEmailErrSome, compValMax=compValMax, trapTest=trapTest, compVal=compVal, trapCompValHighAlarm=trapCompValHighAlarm, humMin=humMin, hum=hum, sensorName=sensorName, traps=traps, humInt=humInt, tempAlarmInt=tempAlarmInt, humAlarmInt=humAlarmInt, tables=tables, compValInt=compValInt, historyEntry=historyEntry, trapHumHighAlarm=trapHumHighAlarm, trapTempHighAlarm=trapTempHighAlarm, serialNumber=serialNumber, histHum=histHum, tempLowInt=tempLowInt, historyTable=historyTable, humLowInt=humLowInt, values=values, tempMax=tempMax, comet=comet, tempHighInt=tempHighInt, compValUnit=compValUnit, tempDelayInt=tempDelayInt, trapEmailErrDNS=trapEmailErrDNS, valuesInt=valuesInt, compValHystInt=compValHystInt, trapTempError=trapTempError, compValDelayInt=compValDelayInt, products=products, humHystInt=humHystInt, trapEmailErrAuth=trapEmailErrAuth, humHighInt=humHighInt, histCompVal=histCompVal, trapSOAPErrDNS=trapSOAPErrDNS, trapHumError=trapHumError, tempAlarm=tempAlarm, compValAlarmInt=compValAlarmInt, t3610=t3610, tempHystInt=tempHystInt, settings=settings, humMax=humMax, compValLowInt=compValLowInt, compValHighInt=compValHighInt, trapHumLowAlarm=trapHumLowAlarm, humUnit=humUnit, messageString=messageString, trapSOAPErrSocket=trapSOAPErrSocket, deviceType=deviceType, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTempLowAlarm=trapTempLowAlarm, trapEmailErrLogin=trapEmailErrLogin, humDelayInt=humDelayInt, tempInt=tempInt)
