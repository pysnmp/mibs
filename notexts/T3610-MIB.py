...
# Produced by pysmi-1.1.8 at Fri Feb 11 19:36:51 2022
...
iso, Bits, Integer32, NotificationType, Gauge32, ModuleIdentity, MibIdentifier, IpAddress, Counter32, TimeTicks, ObjectIdentity, NotificationType, Counter64, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "Integer32", "NotificationType", "Gauge32", "ModuleIdentity", "MibIdentifier", "IpAddress", "Counter32", "TimeTicks", "ObjectIdentity", "NotificationType", "Counter64", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises")
...
mibBuilder.exportSymbols("T3610-MIB", humMax=humMax, humInt=humInt, serialNumber=serialNumber, tempAlarmInt=tempAlarmInt, tables=tables, tempHighInt=tempHighInt, messageString=messageString, pysmi_global=pysmi_global, compValInt=compValInt, trapCompValError=trapCompValError, compValAlarmInt=compValAlarmInt, trapEmailErrDNS=trapEmailErrDNS, trapTempError=trapTempError, tempHystInt=tempHystInt, settings=settings, deviceType=deviceType, values=values, tempLowInt=tempLowInt, compValLowInt=compValLowInt, compValHystInt=compValHystInt, trapEmailErrLogin=trapEmailErrLogin, trapHumHighAlarm=trapHumHighAlarm, sensorName=sensorName, tempDelayInt=tempDelayInt, humMin=humMin, historyTable=historyTable, histCompVal=histCompVal, products=products, trapSOAPErrFile=trapSOAPErrFile, trapEmailErrAuth=trapEmailErrAuth, humHystInt=humHystInt, trapEmailErrSome=trapEmailErrSome, humAlarmInt=humAlarmInt, trapCompValClrAlarm=trapCompValClrAlarm, hum=hum, trapTempClrAlarm=trapTempClrAlarm, compValMin=compValMin, trapSOAPErrDelivery=trapSOAPErrDelivery, tempAlarm=tempAlarm, trapHumLowAlarm=trapHumLowAlarm, traps=traps, tempMax=tempMax, historyEntry=historyEntry, trapNTPError=trapNTPError, compValUnit=compValUnit, humLowInt=humLowInt, tempUnit=tempUnit, trapTest=trapTest, humAlarm=humAlarm, compValDelayInt=compValDelayInt, compValMax=compValMax, comet=comet, trapSOAPErrSocket=trapSOAPErrSocket, temp=temp, histHum=histHum, humUnit=humUnit, trapEmailErrSocket=trapEmailErrSocket, compValHighInt=compValHighInt, trapTempLowAlarm=trapTempLowAlarm, humDelayInt=humDelayInt, humHighInt=humHighInt, trapTempHighAlarm=trapTempHighAlarm, trapHumError=trapHumError, trapSOAPErrDNS=trapSOAPErrDNS, trapHumClrAlarm=trapHumClrAlarm, tempMin=tempMin, trapCompValLowAlarm=trapCompValLowAlarm, histTemp=histTemp, valuesInt=valuesInt, trapCompValHighAlarm=trapCompValHighAlarm, tempInt=tempInt, compValAlarm=compValAlarm, t3610=t3610, compVal=compVal, DisplayString=DisplayString)
