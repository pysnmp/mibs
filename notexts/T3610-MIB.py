...
# Produced by pysmi-1.1.8 at Sun Jan 16 00:56:04 2022
...
enterprises, NotificationType, TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType, Unsigned32, Bits, IpAddress, MibIdentifier, ObjectIdentity, Counter64, Integer32, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "NotificationType", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType", "Unsigned32", "Bits", "IpAddress", "MibIdentifier", "ObjectIdentity", "Counter64", "Integer32", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("T3610-MIB", humHystInt=humHystInt, compValAlarmInt=compValAlarmInt, trapHumError=trapHumError, humMax=humMax, trapSOAPErrFile=trapSOAPErrFile, humAlarmInt=humAlarmInt, traps=traps, tempHighInt=tempHighInt, historyTable=historyTable, compValDelayInt=compValDelayInt, messageString=messageString, histCompVal=histCompVal, trapEmailErrDNS=trapEmailErrDNS, trapTempLowAlarm=trapTempLowAlarm, pysmi_global=pysmi_global, products=products, compValUnit=compValUnit, serialNumber=serialNumber, tempDelayInt=tempDelayInt, tempUnit=tempUnit, compValInt=compValInt, trapTempHighAlarm=trapTempHighAlarm, values=values, trapSOAPErrDNS=trapSOAPErrDNS, trapHumHighAlarm=trapHumHighAlarm, compValAlarm=compValAlarm, hum=hum, humAlarm=humAlarm, humMin=humMin, compValMin=compValMin, compValHystInt=compValHystInt, trapEmailErrLogin=trapEmailErrLogin, trapCompValLowAlarm=trapCompValLowAlarm, trapCompValClrAlarm=trapCompValClrAlarm, humLowInt=humLowInt, trapTest=trapTest, humHighInt=humHighInt, tempLowInt=tempLowInt, t3610=t3610, deviceType=deviceType, trapNTPError=trapNTPError, compValHighInt=compValHighInt, tables=tables, tempMin=tempMin, trapEmailErrAuth=trapEmailErrAuth, historyEntry=historyEntry, trapHumClrAlarm=trapHumClrAlarm, humInt=humInt, tempAlarmInt=tempAlarmInt, compValLowInt=compValLowInt, trapSOAPErrDelivery=trapSOAPErrDelivery, temp=temp, trapCompValError=trapCompValError, tempHystInt=tempHystInt, trapHumLowAlarm=trapHumLowAlarm, trapCompValHighAlarm=trapCompValHighAlarm, humDelayInt=humDelayInt, tempMax=tempMax, compValMax=compValMax, trapTempError=trapTempError, humUnit=humUnit, tempInt=tempInt, histHum=histHum, settings=settings, trapEmailErrSocket=trapEmailErrSocket, trapTempClrAlarm=trapTempClrAlarm, comet=comet, trapEmailErrSome=trapEmailErrSome, sensorName=sensorName, DisplayString=DisplayString, compVal=compVal, tempAlarm=tempAlarm, trapSOAPErrSocket=trapSOAPErrSocket, valuesInt=valuesInt, histTemp=histTemp)
