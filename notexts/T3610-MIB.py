...
# Produced by pysmi-1.1.8 at Tue Aug  9 16:05:07 2022
...
NotificationType, Counter64, NotificationType, enterprises, MibIdentifier, Bits, iso, Counter32, TimeTicks, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity, Integer32, IpAddress, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "NotificationType", "enterprises", "MibIdentifier", "Bits", "iso", "Counter32", "TimeTicks", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity", "Integer32", "IpAddress", "ObjectIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", compValAlarmInt=compValAlarmInt, tables=tables, hum=hum, compVal=compVal, trapEmailErrAuth=trapEmailErrAuth, tempMax=tempMax, trapEmailErrSome=trapEmailErrSome, compValInt=compValInt, trapHumError=trapHumError, humLowInt=humLowInt, tempLowInt=tempLowInt, trapHumClrAlarm=trapHumClrAlarm, temp=temp, trapTempError=trapTempError, compValUnit=compValUnit, compValMin=compValMin, trapHumLowAlarm=trapHumLowAlarm, valuesInt=valuesInt, humDelayInt=humDelayInt, compValHystInt=compValHystInt, histTemp=histTemp, humAlarmInt=humAlarmInt, DisplayString=DisplayString, trapTest=trapTest, tempUnit=tempUnit, trapCompValHighAlarm=trapCompValHighAlarm, t3610=t3610, products=products, trapNTPError=trapNTPError, sensorName=sensorName, historyEntry=historyEntry, humUnit=humUnit, trapSOAPErrDNS=trapSOAPErrDNS, tempMin=tempMin, trapEmailErrSocket=trapEmailErrSocket, messageString=messageString, trapTempClrAlarm=trapTempClrAlarm, trapCompValError=trapCompValError, tempHighInt=tempHighInt, trapEmailErrDNS=trapEmailErrDNS, trapSOAPErrFile=trapSOAPErrFile, trapTempLowAlarm=trapTempLowAlarm, compValAlarm=compValAlarm, trapCompValLowAlarm=trapCompValLowAlarm, humAlarm=humAlarm, compValLowInt=compValLowInt, trapHumHighAlarm=trapHumHighAlarm, compValHighInt=compValHighInt, histHum=histHum, tempDelayInt=tempDelayInt, humInt=humInt, trapSOAPErrDelivery=trapSOAPErrDelivery, pysmi_global=pysmi_global, humHighInt=humHighInt, humMin=humMin, traps=traps, serialNumber=serialNumber, compValDelayInt=compValDelayInt, humHystInt=humHystInt, historyTable=historyTable, humMax=humMax, trapEmailErrLogin=trapEmailErrLogin, values=values, tempAlarmInt=tempAlarmInt, comet=comet, trapCompValClrAlarm=trapCompValClrAlarm, histCompVal=histCompVal, tempAlarm=tempAlarm, tempInt=tempInt, settings=settings, trapSOAPErrSocket=trapSOAPErrSocket, trapTempHighAlarm=trapTempHighAlarm, tempHystInt=tempHystInt, compValMax=compValMax, deviceType=deviceType)
