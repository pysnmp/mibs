...
# Produced by pysmi-1.1.8 at Thu Sep  7 14:10:39 2023
...
NotificationType, MibIdentifier, ObjectIdentity, Bits, Counter32, NotificationType, iso, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ModuleIdentity, enterprises, TimeTicks, IpAddress, Gauge32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "ObjectIdentity", "Bits", "Counter32", "NotificationType", "iso", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ModuleIdentity", "enterprises", "TimeTicks", "IpAddress", "Gauge32", "Integer32")
...
mibBuilder.exportSymbols("T3610-MIB", hum=hum, tempHystInt=tempHystInt, trapTempLowAlarm=trapTempLowAlarm, humMin=humMin, compValHighInt=compValHighInt, humAlarm=humAlarm, compValMin=compValMin, tempMin=tempMin, deviceType=deviceType, historyTable=historyTable, historyEntry=historyEntry, trapSOAPErrSocket=trapSOAPErrSocket, trapEmailErrSocket=trapEmailErrSocket, trapTempClrAlarm=trapTempClrAlarm, pysmi_global=pysmi_global, tempUnit=tempUnit, sensorName=sensorName, compValInt=compValInt, humDelayInt=humDelayInt, trapSOAPErrFile=trapSOAPErrFile, trapCompValError=trapCompValError, trapHumLowAlarm=trapHumLowAlarm, trapCompValClrAlarm=trapCompValClrAlarm, serialNumber=serialNumber, t3610=t3610, compValMax=compValMax, histHum=histHum, compValUnit=compValUnit, histTemp=histTemp, tempHighInt=tempHighInt, trapTempHighAlarm=trapTempHighAlarm, settings=settings, trapEmailErrLogin=trapEmailErrLogin, trapHumHighAlarm=trapHumHighAlarm, trapCompValHighAlarm=trapCompValHighAlarm, humUnit=humUnit, tables=tables, comet=comet, humLowInt=humLowInt, DisplayString=DisplayString, humHighInt=humHighInt, tempAlarmInt=tempAlarmInt, tempDelayInt=tempDelayInt, trapNTPError=trapNTPError, trapHumClrAlarm=trapHumClrAlarm, humInt=humInt, compValHystInt=compValHystInt, tempAlarm=tempAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, tempLowInt=tempLowInt, histCompVal=histCompVal, temp=temp, humMax=humMax, tempInt=tempInt, humHystInt=humHystInt, trapSOAPErrDNS=trapSOAPErrDNS, messageString=messageString, humAlarmInt=humAlarmInt, compValAlarmInt=compValAlarmInt, products=products, trapEmailErrSome=trapEmailErrSome, traps=traps, values=values, valuesInt=valuesInt, compValLowInt=compValLowInt, compValDelayInt=compValDelayInt, trapCompValLowAlarm=trapCompValLowAlarm, trapTempError=trapTempError, trapTest=trapTest, trapEmailErrAuth=trapEmailErrAuth, trapHumError=trapHumError, compVal=compVal, tempMax=tempMax, trapEmailErrDNS=trapEmailErrDNS, compValAlarm=compValAlarm)
