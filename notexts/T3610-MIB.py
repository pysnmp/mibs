...
# Produced by pysmi-1.1.10 at Fri Oct 27 06:58:46 2023
...
NotificationType, IpAddress, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, MibIdentifier, NotificationType, iso, Bits, Counter64, ObjectIdentity, Gauge32, Integer32, enterprises, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "MibIdentifier", "NotificationType", "iso", "Bits", "Counter64", "ObjectIdentity", "Gauge32", "Integer32", "enterprises", "ModuleIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", tempHystInt=tempHystInt, humAlarmInt=humAlarmInt, tempDelayInt=tempDelayInt, trapSOAPErrDNS=trapSOAPErrDNS, compValHystInt=compValHystInt, products=products, humHystInt=humHystInt, tempAlarmInt=tempAlarmInt, humInt=humInt, historyEntry=historyEntry, compValMin=compValMin, trapEmailErrLogin=trapEmailErrLogin, tempHighInt=tempHighInt, trapCompValClrAlarm=trapCompValClrAlarm, histHum=histHum, trapTempClrAlarm=trapTempClrAlarm, tempMax=tempMax, trapHumClrAlarm=trapHumClrAlarm, compValDelayInt=compValDelayInt, deviceType=deviceType, tempAlarm=tempAlarm, comet=comet, humLowInt=humLowInt, historyTable=historyTable, compVal=compVal, DisplayString=DisplayString, trapHumLowAlarm=trapHumLowAlarm, humMax=humMax, trapTempHighAlarm=trapTempHighAlarm, values=values, histCompVal=histCompVal, compValHighInt=compValHighInt, tempUnit=tempUnit, trapTempError=trapTempError, valuesInt=valuesInt, sensorName=sensorName, trapNTPError=trapNTPError, hum=hum, compValAlarmInt=compValAlarmInt, trapCompValHighAlarm=trapCompValHighAlarm, trapSOAPErrFile=trapSOAPErrFile, temp=temp, trapEmailErrDNS=trapEmailErrDNS, messageString=messageString, settings=settings, compValMax=compValMax, humHighInt=humHighInt, trapTest=trapTest, trapSOAPErrDelivery=trapSOAPErrDelivery, tables=tables, compValAlarm=compValAlarm, compValUnit=compValUnit, trapCompValLowAlarm=trapCompValLowAlarm, trapEmailErrSome=trapEmailErrSome, trapHumHighAlarm=trapHumHighAlarm, humAlarm=humAlarm, trapEmailErrAuth=trapEmailErrAuth, trapEmailErrSocket=trapEmailErrSocket, t3610=t3610, humUnit=humUnit, serialNumber=serialNumber, tempMin=tempMin, trapSOAPErrSocket=trapSOAPErrSocket, pysmi_global=pysmi_global, tempLowInt=tempLowInt, traps=traps, histTemp=histTemp, humMin=humMin, trapTempLowAlarm=trapTempLowAlarm, compValInt=compValInt, humDelayInt=humDelayInt, trapCompValError=trapCompValError, tempInt=tempInt, trapHumError=trapHumError, compValLowInt=compValLowInt)
