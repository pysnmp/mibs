...
Integer32, NotificationType, TimeTicks, ModuleIdentity, enterprises, Unsigned32, Gauge32, Bits, ObjectIdentity, Counter64, Counter32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "TimeTicks", "ModuleIdentity", "enterprises", "Unsigned32", "Gauge32", "Bits", "ObjectIdentity", "Counter64", "Counter32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "IpAddress", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", compValLowInt=compValLowInt, histTemp=histTemp, trapCompValLowAlarm=trapCompValLowAlarm, deviceType=deviceType, humMin=humMin, compValUnit=compValUnit, tempMin=tempMin, sensorName=sensorName, trapSOAPErrSocket=trapSOAPErrSocket, humHighInt=humHighInt, trapTempLowAlarm=trapTempLowAlarm, trapCompValError=trapCompValError, tempInt=tempInt, compValAlarmInt=compValAlarmInt, trapTest=trapTest, trapEmailErrSome=trapEmailErrSome, humLowInt=humLowInt, historyEntry=historyEntry, comet=comet, pysmi_global=pysmi_global, trapHumHighAlarm=trapHumHighAlarm, trapTempError=trapTempError, tempUnit=tempUnit, trapEmailErrAuth=trapEmailErrAuth, traps=traps, compVal=compVal, compValHystInt=compValHystInt, tempHystInt=tempHystInt, settings=settings, humInt=humInt, tempDelayInt=tempDelayInt, tempLowInt=tempLowInt, temp=temp, tempHighInt=tempHighInt, trapNTPError=trapNTPError, trapHumLowAlarm=trapHumLowAlarm, compValAlarm=compValAlarm, humMax=humMax, trapSOAPErrFile=trapSOAPErrFile, compValMin=compValMin, tempAlarm=tempAlarm, histCompVal=histCompVal, humAlarmInt=humAlarmInt, products=products, trapSOAPErrDelivery=trapSOAPErrDelivery, humHystInt=humHystInt, trapTempHighAlarm=trapTempHighAlarm, trapSOAPErrDNS=trapSOAPErrDNS, serialNumber=serialNumber, compValHighInt=compValHighInt, hum=hum, historyTable=historyTable, histHum=histHum, valuesInt=valuesInt, tempMax=tempMax, t3610=t3610, humUnit=humUnit, tempAlarmInt=tempAlarmInt, humAlarm=humAlarm, humDelayInt=humDelayInt, messageString=messageString, tables=tables, trapEmailErrLogin=trapEmailErrLogin, trapEmailErrSocket=trapEmailErrSocket, DisplayString=DisplayString, trapHumClrAlarm=trapHumClrAlarm, compValInt=compValInt, trapCompValClrAlarm=trapCompValClrAlarm, compValDelayInt=compValDelayInt, trapEmailErrDNS=trapEmailErrDNS, values=values, trapTempClrAlarm=trapTempClrAlarm, compValMax=compValMax, trapCompValHighAlarm=trapCompValHighAlarm, trapHumError=trapHumError)
