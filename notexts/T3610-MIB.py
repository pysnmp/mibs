...
# Produced by pysmi-1.1.10 at Fri Oct 27 06:58:05 2023
...
Gauge32, Unsigned32, Bits, MibIdentifier, Counter32, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Integer32, NotificationType, IpAddress, TimeTicks, Counter64, ObjectIdentity, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Unsigned32", "Bits", "MibIdentifier", "Counter32", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Integer32", "NotificationType", "IpAddress", "TimeTicks", "Counter64", "ObjectIdentity", "enterprises")
...
mibBuilder.exportSymbols("T3610-MIB", humAlarm=humAlarm, trapEmailErrSome=trapEmailErrSome, tempDelayInt=tempDelayInt, trapTempClrAlarm=trapTempClrAlarm, compValUnit=compValUnit, trapTempLowAlarm=trapTempLowAlarm, trapCompValClrAlarm=trapCompValClrAlarm, historyEntry=historyEntry, trapHumHighAlarm=trapHumHighAlarm, trapEmailErrDNS=trapEmailErrDNS, traps=traps, tempInt=tempInt, tempLowInt=tempLowInt, humLowInt=humLowInt, t3610=t3610, humUnit=humUnit, tempMin=tempMin, trapCompValError=trapCompValError, humMax=humMax, compValAlarm=compValAlarm, compValDelayInt=compValDelayInt, humMin=humMin, humHystInt=humHystInt, trapSOAPErrFile=trapSOAPErrFile, tempAlarmInt=tempAlarmInt, trapHumClrAlarm=trapHumClrAlarm, hum=hum, valuesInt=valuesInt, tempHighInt=tempHighInt, compValHystInt=compValHystInt, settings=settings, trapSOAPErrDNS=trapSOAPErrDNS, serialNumber=serialNumber, histCompVal=histCompVal, trapEmailErrSocket=trapEmailErrSocket, histTemp=histTemp, tempHystInt=tempHystInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapCompValHighAlarm=trapCompValHighAlarm, compValMax=compValMax, tables=tables, trapTempHighAlarm=trapTempHighAlarm, products=products, trapNTPError=trapNTPError, temp=temp, deviceType=deviceType, trapEmailErrLogin=trapEmailErrLogin, compValMin=compValMin, comet=comet, compValHighInt=compValHighInt, values=values, humInt=humInt, compValInt=compValInt, humDelayInt=humDelayInt, sensorName=sensorName, trapTest=trapTest, DisplayString=DisplayString, humHighInt=humHighInt, compValLowInt=compValLowInt, tempAlarm=tempAlarm, messageString=messageString, historyTable=historyTable, histHum=histHum, trapHumLowAlarm=trapHumLowAlarm, trapCompValLowAlarm=trapCompValLowAlarm, compVal=compVal, compValAlarmInt=compValAlarmInt, trapSOAPErrSocket=trapSOAPErrSocket, tempUnit=tempUnit, tempMax=tempMax, trapHumError=trapHumError, trapTempError=trapTempError, trapEmailErrAuth=trapEmailErrAuth, pysmi_global=pysmi_global, humAlarmInt=humAlarmInt)
