...
NotificationType, MibIdentifier, Bits, IpAddress, Counter64, iso, Integer32, ModuleIdentity, TimeTicks, ObjectIdentity, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, enterprises, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "Bits", "IpAddress", "Counter64", "iso", "Integer32", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "enterprises", "Counter32")
...
mibBuilder.exportSymbols("T3610-MIB", trapHumError=trapHumError, hum=hum, tempAlarm=tempAlarm, compValLowInt=compValLowInt, humHystInt=humHystInt, trapHumLowAlarm=trapHumLowAlarm, t3610=t3610, humUnit=humUnit, messageString=messageString, products=products, histTemp=histTemp, trapCompValError=trapCompValError, serialNumber=serialNumber, compValHighInt=compValHighInt, tempInt=tempInt, trapSOAPErrSocket=trapSOAPErrSocket, historyEntry=historyEntry, valuesInt=valuesInt, tempHighInt=tempHighInt, compValMax=compValMax, trapHumHighAlarm=trapHumHighAlarm, values=values, compVal=compVal, compValDelayInt=compValDelayInt, trapTempClrAlarm=trapTempClrAlarm, trapTest=trapTest, humDelayInt=humDelayInt, comet=comet, compValAlarm=compValAlarm, compValInt=compValInt, trapEmailErrLogin=trapEmailErrLogin, trapHumClrAlarm=trapHumClrAlarm, trapCompValHighAlarm=trapCompValHighAlarm, humAlarm=humAlarm, DisplayString=DisplayString, tempAlarmInt=tempAlarmInt, compValAlarmInt=compValAlarmInt, tables=tables, tempMax=tempMax, trapSOAPErrFile=trapSOAPErrFile, trapTempLowAlarm=trapTempLowAlarm, compValUnit=compValUnit, pysmi_global=pysmi_global, trapEmailErrAuth=trapEmailErrAuth, settings=settings, humAlarmInt=humAlarmInt, trapSOAPErrDNS=trapSOAPErrDNS, sensorName=sensorName, humMin=humMin, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTempHighAlarm=trapTempHighAlarm, trapEmailErrSocket=trapEmailErrSocket, historyTable=historyTable, tempUnit=tempUnit, tempMin=tempMin, trapCompValLowAlarm=trapCompValLowAlarm, trapNTPError=trapNTPError, compValHystInt=compValHystInt, compValMin=compValMin, histCompVal=histCompVal, humLowInt=humLowInt, traps=traps, temp=temp, humHighInt=humHighInt, tempDelayInt=tempDelayInt, trapEmailErrSome=trapEmailErrSome, deviceType=deviceType, trapTempError=trapTempError, tempHystInt=tempHystInt, histHum=histHum, humInt=humInt, trapEmailErrDNS=trapEmailErrDNS, trapCompValClrAlarm=trapCompValClrAlarm, tempLowInt=tempLowInt, humMax=humMax)
