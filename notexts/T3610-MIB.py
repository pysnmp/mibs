...
# Produced by pysmi-1.1.10 at Thu Apr  4 03:04:36 2024
...
TimeTicks, enterprises, Integer32, NotificationType, iso, NotificationType, Bits, Gauge32, MibIdentifier, Unsigned32, IpAddress, Counter32, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "enterprises", "Integer32", "NotificationType", "iso", "NotificationType", "Bits", "Gauge32", "MibIdentifier", "Unsigned32", "IpAddress", "Counter32", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("T3610-MIB", tempHystInt=tempHystInt, trapEmailErrAuth=trapEmailErrAuth, historyTable=historyTable, comet=comet, historyEntry=historyEntry, trapNTPError=trapNTPError, compValAlarmInt=compValAlarmInt, products=products, trapSOAPErrSocket=trapSOAPErrSocket, humUnit=humUnit, trapEmailErrSocket=trapEmailErrSocket, tempHighInt=tempHighInt, trapHumHighAlarm=trapHumHighAlarm, trapTest=trapTest, trapSOAPErrFile=trapSOAPErrFile, trapCompValHighAlarm=trapCompValHighAlarm, trapEmailErrSome=trapEmailErrSome, humMax=humMax, tempAlarmInt=tempAlarmInt, compValMax=compValMax, tempInt=tempInt, histCompVal=histCompVal, deviceType=deviceType, humHighInt=humHighInt, compValLowInt=compValLowInt, trapTempHighAlarm=trapTempHighAlarm, t3610=t3610, DisplayString=DisplayString, compValHystInt=compValHystInt, histHum=histHum, trapEmailErrDNS=trapEmailErrDNS, trapCompValLowAlarm=trapCompValLowAlarm, humHystInt=humHystInt, trapTempLowAlarm=trapTempLowAlarm, compValDelayInt=compValDelayInt, trapHumError=trapHumError, tempDelayInt=tempDelayInt, hum=hum, trapSOAPErrDNS=trapSOAPErrDNS, pysmi_global=pysmi_global, traps=traps, compValMin=compValMin, humAlarmInt=humAlarmInt, humInt=humInt, trapTempClrAlarm=trapTempClrAlarm, serialNumber=serialNumber, humAlarm=humAlarm, temp=temp, values=values, compValInt=compValInt, histTemp=histTemp, compValHighInt=compValHighInt, messageString=messageString, trapCompValClrAlarm=trapCompValClrAlarm, compValAlarm=compValAlarm, tempLowInt=tempLowInt, trapTempError=trapTempError, compValUnit=compValUnit, tempMax=tempMax, humDelayInt=humDelayInt, humMin=humMin, trapHumClrAlarm=trapHumClrAlarm, tempAlarm=tempAlarm, sensorName=sensorName, humLowInt=humLowInt, tempMin=tempMin, trapEmailErrLogin=trapEmailErrLogin, valuesInt=valuesInt, tables=tables, tempUnit=tempUnit, compVal=compVal, trapSOAPErrDelivery=trapSOAPErrDelivery, trapCompValError=trapCompValError, settings=settings, trapHumLowAlarm=trapHumLowAlarm)
