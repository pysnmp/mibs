...
# Produced by pysmi-1.1.11 at Wed Dec  6 02:59:08 2023
...
iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32, Counter64, Bits, MibIdentifier, Unsigned32, NotificationType, enterprises, ObjectIdentity, TimeTicks, ModuleIdentity, Integer32, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32", "Counter64", "Bits", "MibIdentifier", "Unsigned32", "NotificationType", "enterprises", "ObjectIdentity", "TimeTicks", "ModuleIdentity", "Integer32", "NotificationType", "IpAddress")
...
mibBuilder.exportSymbols("T3610-MIB", traps=traps, values=values, trapCompValLowAlarm=trapCompValLowAlarm, tempInt=tempInt, temp=temp, humInt=humInt, tempLowInt=tempLowInt, tempAlarmInt=tempAlarmInt, humAlarm=humAlarm, compValHighInt=compValHighInt, tempHystInt=tempHystInt, trapCompValError=trapCompValError, settings=settings, compValMin=compValMin, compValAlarm=compValAlarm, compValLowInt=compValLowInt, trapTempError=trapTempError, histCompVal=histCompVal, trapSOAPErrDNS=trapSOAPErrDNS, trapEmailErrSocket=trapEmailErrSocket, trapCompValClrAlarm=trapCompValClrAlarm, trapNTPError=trapNTPError, messageString=messageString, histHum=histHum, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrFile=trapSOAPErrFile, trapSOAPErrSocket=trapSOAPErrSocket, tempMax=tempMax, trapCompValHighAlarm=trapCompValHighAlarm, compVal=compVal, humHystInt=humHystInt, trapEmailErrDNS=trapEmailErrDNS, histTemp=histTemp, humMin=humMin, humHighInt=humHighInt, tempMin=tempMin, trapHumError=trapHumError, tables=tables, trapHumClrAlarm=trapHumClrAlarm, humMax=humMax, tempDelayInt=tempDelayInt, products=products, trapSOAPErrDelivery=trapSOAPErrDelivery, valuesInt=valuesInt, compValMax=compValMax, humDelayInt=humDelayInt, tempAlarm=tempAlarm, compValDelayInt=compValDelayInt, historyTable=historyTable, serialNumber=serialNumber, comet=comet, humLowInt=humLowInt, tempHighInt=tempHighInt, t3610=t3610, historyEntry=historyEntry, trapHumHighAlarm=trapHumHighAlarm, trapTempHighAlarm=trapTempHighAlarm, compValHystInt=compValHystInt, compValInt=compValInt, trapEmailErrSome=trapEmailErrSome, compValAlarmInt=compValAlarmInt, humAlarmInt=humAlarmInt, humUnit=humUnit, compValUnit=compValUnit, sensorName=sensorName, trapTempLowAlarm=trapTempLowAlarm, pysmi_global=pysmi_global, trapTempClrAlarm=trapTempClrAlarm, hum=hum, tempUnit=tempUnit, trapEmailErrLogin=trapEmailErrLogin, DisplayString=DisplayString, deviceType=deviceType, trapHumLowAlarm=trapHumLowAlarm, trapTest=trapTest)
