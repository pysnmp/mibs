...
# Produced by pysmi-1.1.8 at Thu Jan 27 21:05:53 2022
...
Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, NotificationType, ModuleIdentity, Unsigned32, MibIdentifier, Counter32, enterprises, Bits, IpAddress, ObjectIdentity, iso, NotificationType, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "NotificationType", "ModuleIdentity", "Unsigned32", "MibIdentifier", "Counter32", "enterprises", "Bits", "IpAddress", "ObjectIdentity", "iso", "NotificationType", "Counter64")
...
mibBuilder.exportSymbols("T3610-MIB", compValHystInt=compValHystInt, humInt=humInt, trapTempLowAlarm=trapTempLowAlarm, trapTest=trapTest, trapHumHighAlarm=trapHumHighAlarm, serialNumber=serialNumber, tempDelayInt=tempDelayInt, compValAlarmInt=compValAlarmInt, tempHystInt=tempHystInt, compValInt=compValInt, tempAlarmInt=tempAlarmInt, humAlarmInt=humAlarmInt, compVal=compVal, comet=comet, trapCompValLowAlarm=trapCompValLowAlarm, trapTempError=trapTempError, trapHumError=trapHumError, histCompVal=histCompVal, tempLowInt=tempLowInt, tempUnit=tempUnit, compValUnit=compValUnit, trapTempHighAlarm=trapTempHighAlarm, tempMin=tempMin, trapHumClrAlarm=trapHumClrAlarm, trapHumLowAlarm=trapHumLowAlarm, trapEmailErrAuth=trapEmailErrAuth, humHighInt=humHighInt, trapSOAPErrDNS=trapSOAPErrDNS, trapSOAPErrSocket=trapSOAPErrSocket, humLowInt=humLowInt, messageString=messageString, histHum=histHum, humAlarm=humAlarm, trapTempClrAlarm=trapTempClrAlarm, trapEmailErrLogin=trapEmailErrLogin, settings=settings, values=values, trapSOAPErrFile=trapSOAPErrFile, humDelayInt=humDelayInt, humMin=humMin, sensorName=sensorName, trapNTPError=trapNTPError, traps=traps, tables=tables, compValMin=compValMin, compValDelayInt=compValDelayInt, pysmi_global=pysmi_global, historyEntry=historyEntry, valuesInt=valuesInt, trapSOAPErrDelivery=trapSOAPErrDelivery, humUnit=humUnit, tempHighInt=tempHighInt, compValHighInt=compValHighInt, trapCompValHighAlarm=trapCompValHighAlarm, hum=hum, compValLowInt=compValLowInt, tempMax=tempMax, trapCompValClrAlarm=trapCompValClrAlarm, trapCompValError=trapCompValError, DisplayString=DisplayString, trapEmailErrSome=trapEmailErrSome, t3610=t3610, tempInt=tempInt, deviceType=deviceType, tempAlarm=tempAlarm, humMax=humMax, trapEmailErrDNS=trapEmailErrDNS, histTemp=histTemp, temp=temp, products=products, trapEmailErrSocket=trapEmailErrSocket, humHystInt=humHystInt, compValMax=compValMax, compValAlarm=compValAlarm, historyTable=historyTable)
