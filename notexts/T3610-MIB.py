...
# Produced by pysmi-1.1.8 at Fri Jan 13 13:50:28 2023
...
TimeTicks, Counter32, enterprises, ModuleIdentity, IpAddress, Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, iso, Counter64, NotificationType, MibIdentifier, Bits, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "enterprises", "ModuleIdentity", "IpAddress", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "iso", "Counter64", "NotificationType", "MibIdentifier", "Bits", "ObjectIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", trapCompValClrAlarm=trapCompValClrAlarm, humUnit=humUnit, sensorName=sensorName, deviceType=deviceType, compValLowInt=compValLowInt, histCompVal=histCompVal, compValDelayInt=compValDelayInt, historyTable=historyTable, humAlarmInt=humAlarmInt, compValAlarmInt=compValAlarmInt, compVal=compVal, tempUnit=tempUnit, tempHighInt=tempHighInt, humLowInt=humLowInt, messageString=messageString, trapCompValError=trapCompValError, tempMax=tempMax, trapSOAPErrSocket=trapSOAPErrSocket, trapTempHighAlarm=trapTempHighAlarm, tempLowInt=tempLowInt, trapHumHighAlarm=trapHumHighAlarm, pysmi_global=pysmi_global, DisplayString=DisplayString, trapCompValHighAlarm=trapCompValHighAlarm, temp=temp, compValMax=compValMax, historyEntry=historyEntry, tempMin=tempMin, trapTempLowAlarm=trapTempLowAlarm, compValHystInt=compValHystInt, histHum=histHum, compValUnit=compValUnit, tempAlarmInt=tempAlarmInt, humMax=humMax, tempAlarm=tempAlarm, hum=hum, trapSOAPErrDelivery=trapSOAPErrDelivery, humDelayInt=humDelayInt, trapCompValLowAlarm=trapCompValLowAlarm, trapTempClrAlarm=trapTempClrAlarm, trapHumClrAlarm=trapHumClrAlarm, humAlarm=humAlarm, trapTest=trapTest, traps=traps, compValAlarm=compValAlarm, tempDelayInt=tempDelayInt, compValHighInt=compValHighInt, trapHumError=trapHumError, valuesInt=valuesInt, products=products, trapSOAPErrFile=trapSOAPErrFile, trapEmailErrSocket=trapEmailErrSocket, trapTempError=trapTempError, trapEmailErrLogin=trapEmailErrLogin, comet=comet, humHystInt=humHystInt, t3610=t3610, trapNTPError=trapNTPError, tempInt=tempInt, trapSOAPErrDNS=trapSOAPErrDNS, compValMin=compValMin, humInt=humInt, histTemp=histTemp, serialNumber=serialNumber, tables=tables, trapEmailErrAuth=trapEmailErrAuth, humMin=humMin, compValInt=compValInt, settings=settings, trapEmailErrSome=trapEmailErrSome, trapHumLowAlarm=trapHumLowAlarm, values=values, trapEmailErrDNS=trapEmailErrDNS, humHighInt=humHighInt, tempHystInt=tempHystInt)
