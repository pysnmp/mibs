...
# Produced by pysmi-1.1.12 at Fri Nov 22 15:08:14 2024
...
enterprises, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Integer32, Gauge32, Counter32, iso, IpAddress, NotificationType, ObjectIdentity, MibIdentifier, Bits, TimeTicks, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Integer32", "Gauge32", "Counter32", "iso", "IpAddress", "NotificationType", "ObjectIdentity", "MibIdentifier", "Bits", "TimeTicks", "Counter64", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", trapSOAPErrDelivery=trapSOAPErrDelivery, deviceType=deviceType, compValMin=compValMin, trapSOAPErrDNS=trapSOAPErrDNS, values=values, humLowInt=humLowInt, histCompVal=histCompVal, tempAlarm=tempAlarm, compValAlarm=compValAlarm, trapEmailErrDNS=trapEmailErrDNS, humHystInt=humHystInt, trapTempLowAlarm=trapTempLowAlarm, humDelayInt=humDelayInt, messageString=messageString, humMin=humMin, temp=temp, trapCompValError=trapCompValError, historyEntry=historyEntry, tempDelayInt=tempDelayInt, trapNTPError=trapNTPError, humHighInt=humHighInt, trapTempClrAlarm=trapTempClrAlarm, tables=tables, DisplayString=DisplayString, humInt=humInt, trapTempHighAlarm=trapTempHighAlarm, pysmi_global=pysmi_global, trapCompValClrAlarm=trapCompValClrAlarm, humMax=humMax, trapCompValLowAlarm=trapCompValLowAlarm, tempMin=tempMin, serialNumber=serialNumber, humAlarmInt=humAlarmInt, humUnit=humUnit, tempLowInt=tempLowInt, traps=traps, products=products, compValInt=compValInt, sensorName=sensorName, compValHighInt=compValHighInt, comet=comet, trapCompValHighAlarm=trapCompValHighAlarm, hum=hum, tempHystInt=tempHystInt, historyTable=historyTable, tempUnit=tempUnit, t3610=t3610, compVal=compVal, compValDelayInt=compValDelayInt, trapHumClrAlarm=trapHumClrAlarm, compValAlarmInt=compValAlarmInt, trapHumLowAlarm=trapHumLowAlarm, trapHumError=trapHumError, trapEmailErrLogin=trapEmailErrLogin, valuesInt=valuesInt, tempMax=tempMax, compValHystInt=compValHystInt, humAlarm=humAlarm, trapTest=trapTest, trapSOAPErrFile=trapSOAPErrFile, tempHighInt=tempHighInt, trapSOAPErrSocket=trapSOAPErrSocket, trapEmailErrSome=trapEmailErrSome, tempAlarmInt=tempAlarmInt, trapHumHighAlarm=trapHumHighAlarm, settings=settings, trapTempError=trapTempError, compValLowInt=compValLowInt, histHum=histHum, tempInt=tempInt, compValMax=compValMax, compValUnit=compValUnit, trapEmailErrAuth=trapEmailErrAuth, histTemp=histTemp, trapEmailErrSocket=trapEmailErrSocket)
