...
# Produced by pysmi-1.1.8 at Fri Jan  7 01:01:52 2022
...
iso, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter64, Gauge32, NotificationType, Bits, IpAddress, ModuleIdentity, NotificationType, Unsigned32, ObjectIdentity, enterprises, Integer32, Counter32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter64", "Gauge32", "NotificationType", "Bits", "IpAddress", "ModuleIdentity", "NotificationType", "Unsigned32", "ObjectIdentity", "enterprises", "Integer32", "Counter32", "TimeTicks")
...
mibBuilder.exportSymbols("T3610-MIB", compValMax=compValMax, products=products, compValHystInt=compValHystInt, tempAlarmInt=tempAlarmInt, trapHumClrAlarm=trapHumClrAlarm, trapEmailErrAuth=trapEmailErrAuth, trapTest=trapTest, serialNumber=serialNumber, trapHumLowAlarm=trapHumLowAlarm, trapTempError=trapTempError, pysmi_global=pysmi_global, humInt=humInt, humAlarm=humAlarm, trapCompValLowAlarm=trapCompValLowAlarm, trapCompValClrAlarm=trapCompValClrAlarm, tempDelayInt=tempDelayInt, compValDelayInt=compValDelayInt, humDelayInt=humDelayInt, histHum=histHum, valuesInt=valuesInt, trapTempLowAlarm=trapTempLowAlarm, compValMin=compValMin, messageString=messageString, tempAlarm=tempAlarm, trapCompValHighAlarm=trapCompValHighAlarm, tempHystInt=tempHystInt, trapHumHighAlarm=trapHumHighAlarm, compValHighInt=compValHighInt, historyTable=historyTable, trapCompValError=trapCompValError, compValAlarmInt=compValAlarmInt, historyEntry=historyEntry, trapTempHighAlarm=trapTempHighAlarm, histTemp=histTemp, tempUnit=tempUnit, hum=hum, tempLowInt=tempLowInt, humHystInt=humHystInt, trapHumError=trapHumError, humMin=humMin, tempMax=tempMax, tempHighInt=tempHighInt, trapEmailErrDNS=trapEmailErrDNS, humAlarmInt=humAlarmInt, compValAlarm=compValAlarm, trapTempClrAlarm=trapTempClrAlarm, comet=comet, trapEmailErrLogin=trapEmailErrLogin, tables=tables, humUnit=humUnit, DisplayString=DisplayString, trapEmailErrSome=trapEmailErrSome, tempMin=tempMin, values=values, humLowInt=humLowInt, temp=temp, humMax=humMax, sensorName=sensorName, tempInt=tempInt, compValLowInt=compValLowInt, humHighInt=humHighInt, compValUnit=compValUnit, histCompVal=histCompVal, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrDNS=trapSOAPErrDNS, trapSOAPErrDelivery=trapSOAPErrDelivery, trapNTPError=trapNTPError, t3610=t3610, deviceType=deviceType, compValInt=compValInt, compVal=compVal, trapSOAPErrFile=trapSOAPErrFile, trapSOAPErrSocket=trapSOAPErrSocket, traps=traps, settings=settings)
