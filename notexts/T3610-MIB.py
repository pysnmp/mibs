...
# Produced by pysmi-1.1.8 at Thu Sep 15 09:36:20 2022
...
iso, Integer32, MibIdentifier, Counter64, NotificationType, Gauge32, Counter32, IpAddress, enterprises, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, ObjectIdentity, NotificationType, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "MibIdentifier", "Counter64", "NotificationType", "Gauge32", "Counter32", "IpAddress", "enterprises", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "ObjectIdentity", "NotificationType", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", messageString=messageString, historyEntry=historyEntry, trapTempError=trapTempError, trapEmailErrDNS=trapEmailErrDNS, serialNumber=serialNumber, compValLowInt=compValLowInt, compValAlarm=compValAlarm, tempMax=tempMax, hum=hum, trapNTPError=trapNTPError, humMin=humMin, histCompVal=histCompVal, humHystInt=humHystInt, compVal=compVal, tempAlarmInt=tempAlarmInt, trapSOAPErrDelivery=trapSOAPErrDelivery, products=products, humAlarmInt=humAlarmInt, compValInt=compValInt, trapTempHighAlarm=trapTempHighAlarm, trapHumHighAlarm=trapHumHighAlarm, trapTempClrAlarm=trapTempClrAlarm, trapEmailErrSocket=trapEmailErrSocket, DisplayString=DisplayString, trapTest=trapTest, humAlarm=humAlarm, trapCompValError=trapCompValError, comet=comet, humDelayInt=humDelayInt, tempAlarm=tempAlarm, traps=traps, t3610=t3610, compValHighInt=compValHighInt, deviceType=deviceType, temp=temp, histHum=histHum, compValHystInt=compValHystInt, humMax=humMax, histTemp=histTemp, humInt=humInt, trapEmailErrAuth=trapEmailErrAuth, tempHighInt=tempHighInt, humUnit=humUnit, tempUnit=tempUnit, trapHumLowAlarm=trapHumLowAlarm, compValMax=compValMax, trapSOAPErrDNS=trapSOAPErrDNS, trapEmailErrSome=trapEmailErrSome, trapEmailErrLogin=trapEmailErrLogin, historyTable=historyTable, trapCompValHighAlarm=trapCompValHighAlarm, tempHystInt=tempHystInt, trapCompValLowAlarm=trapCompValLowAlarm, trapHumClrAlarm=trapHumClrAlarm, tables=tables, pysmi_global=pysmi_global, compValDelayInt=compValDelayInt, settings=settings, humLowInt=humLowInt, compValAlarmInt=compValAlarmInt, sensorName=sensorName, tempMin=tempMin, humHighInt=humHighInt, trapTempLowAlarm=trapTempLowAlarm, tempLowInt=tempLowInt, trapSOAPErrFile=trapSOAPErrFile, trapSOAPErrSocket=trapSOAPErrSocket, values=values, tempDelayInt=tempDelayInt, valuesInt=valuesInt, compValMin=compValMin, trapCompValClrAlarm=trapCompValClrAlarm, trapHumError=trapHumError, compValUnit=compValUnit, tempInt=tempInt)
