...
# Produced by pysmi-1.1.8 at Sat Jan 15 17:12:10 2022
...
Counter32, Unsigned32, MibIdentifier, ObjectIdentity, enterprises, ModuleIdentity, iso, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32, Counter64, NotificationType, Gauge32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Unsigned32", "MibIdentifier", "ObjectIdentity", "enterprises", "ModuleIdentity", "iso", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32", "Counter64", "NotificationType", "Gauge32", "TimeTicks")
...
mibBuilder.exportSymbols("T3610-MIB", trapTempClrAlarm=trapTempClrAlarm, trapHumLowAlarm=trapHumLowAlarm, serialNumber=serialNumber, trapSOAPErrDNS=trapSOAPErrDNS, trapEmailErrAuth=trapEmailErrAuth, trapTempLowAlarm=trapTempLowAlarm, tempLowInt=tempLowInt, trapEmailErrDNS=trapEmailErrDNS, pysmi_global=pysmi_global, DisplayString=DisplayString, trapHumError=trapHumError, histTemp=histTemp, historyTable=historyTable, compValLowInt=compValLowInt, trapHumClrAlarm=trapHumClrAlarm, humHighInt=humHighInt, histHum=histHum, hum=hum, tempUnit=tempUnit, compValDelayInt=compValDelayInt, trapNTPError=trapNTPError, tempMin=tempMin, humLowInt=humLowInt, humMin=humMin, messageString=messageString, compValHystInt=compValHystInt, compValAlarm=compValAlarm, humMax=humMax, tempAlarmInt=tempAlarmInt, histCompVal=histCompVal, trapSOAPErrSocket=trapSOAPErrSocket, trapTempError=trapTempError, settings=settings, tempInt=tempInt, trapSOAPErrFile=trapSOAPErrFile, compVal=compVal, compValAlarmInt=compValAlarmInt, trapCompValError=trapCompValError, products=products, tempHystInt=tempHystInt, trapEmailErrSome=trapEmailErrSome, comet=comet, trapTest=trapTest, trapHumHighAlarm=trapHumHighAlarm, trapCompValLowAlarm=trapCompValLowAlarm, traps=traps, compValUnit=compValUnit, deviceType=deviceType, sensorName=sensorName, humInt=humInt, trapEmailErrLogin=trapEmailErrLogin, compValMin=compValMin, compValMax=compValMax, values=values, humHystInt=humHystInt, trapCompValClrAlarm=trapCompValClrAlarm, compValHighInt=compValHighInt, compValInt=compValInt, trapCompValHighAlarm=trapCompValHighAlarm, tempHighInt=tempHighInt, tempDelayInt=tempDelayInt, trapTempHighAlarm=trapTempHighAlarm, t3610=t3610, valuesInt=valuesInt, historyEntry=historyEntry, trapEmailErrSocket=trapEmailErrSocket, tempAlarm=tempAlarm, humUnit=humUnit, humAlarmInt=humAlarmInt, trapSOAPErrDelivery=trapSOAPErrDelivery, tables=tables, temp=temp, tempMax=tempMax, humDelayInt=humDelayInt, humAlarm=humAlarm)
