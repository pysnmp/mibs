...
# Produced by pysmi-1.1.8 at Thu Oct 12 08:13:15 2023
...
NotificationType, iso, ObjectIdentity, Unsigned32, Bits, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ModuleIdentity, Gauge32, Counter64, IpAddress, MibIdentifier, Integer32, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "ObjectIdentity", "Unsigned32", "Bits", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ModuleIdentity", "Gauge32", "Counter64", "IpAddress", "MibIdentifier", "Integer32", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("T3610-MIB", humDelayInt=humDelayInt, values=values, humAlarm=humAlarm, humMax=humMax, traps=traps, DisplayString=DisplayString, humUnit=humUnit, trapEmailErrSome=trapEmailErrSome, humHighInt=humHighInt, tempAlarmInt=tempAlarmInt, tempMax=tempMax, sensorName=sensorName, comet=comet, t3610=t3610, compValAlarmInt=compValAlarmInt, compValMax=compValMax, trapCompValHighAlarm=trapCompValHighAlarm, trapEmailErrDNS=trapEmailErrDNS, pysmi_global=pysmi_global, compValInt=compValInt, tempMin=tempMin, messageString=messageString, trapNTPError=trapNTPError, trapEmailErrLogin=trapEmailErrLogin, trapHumError=trapHumError, compValUnit=compValUnit, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrSocket=trapSOAPErrSocket, humInt=humInt, tempInt=tempInt, compValHighInt=compValHighInt, histTemp=histTemp, compValMin=compValMin, humAlarmInt=humAlarmInt, products=products, compValDelayInt=compValDelayInt, humHystInt=humHystInt, trapHumClrAlarm=trapHumClrAlarm, serialNumber=serialNumber, histHum=histHum, trapTempLowAlarm=trapTempLowAlarm, deviceType=deviceType, trapTempError=trapTempError, trapCompValLowAlarm=trapCompValLowAlarm, historyTable=historyTable, trapSOAPErrDelivery=trapSOAPErrDelivery, trapCompValError=trapCompValError, humLowInt=humLowInt, settings=settings, tempHystInt=tempHystInt, tempLowInt=tempLowInt, trapEmailErrSocket=trapEmailErrSocket, trapHumHighAlarm=trapHumHighAlarm, tempAlarm=tempAlarm, trapHumLowAlarm=trapHumLowAlarm, humMin=humMin, historyEntry=historyEntry, compValAlarm=compValAlarm, trapTest=trapTest, compValHystInt=compValHystInt, trapSOAPErrDNS=trapSOAPErrDNS, tables=tables, compVal=compVal, trapTempHighAlarm=trapTempHighAlarm, trapCompValClrAlarm=trapCompValClrAlarm, histCompVal=histCompVal, trapSOAPErrFile=trapSOAPErrFile, temp=temp, tempHighInt=tempHighInt, tempDelayInt=tempDelayInt, compValLowInt=compValLowInt, tempUnit=tempUnit, hum=hum, trapTempClrAlarm=trapTempClrAlarm, valuesInt=valuesInt)
