...
# Produced by pysmi-1.1.12 at Tue May 28 12:04:14 2024
...
NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, MibIdentifier, NotificationType, Unsigned32, TimeTicks, Bits, enterprises, iso, Counter32, Gauge32, ObjectIdentity, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "MibIdentifier", "NotificationType", "Unsigned32", "TimeTicks", "Bits", "enterprises", "iso", "Counter32", "Gauge32", "ObjectIdentity", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("T3610-MIB", trapEmailErrSome=trapEmailErrSome, trapHumClrAlarm=trapHumClrAlarm, trapCompValHighAlarm=trapCompValHighAlarm, compValHystInt=compValHystInt, tempHighInt=tempHighInt, trapNTPError=trapNTPError, humDelayInt=humDelayInt, compValMin=compValMin, compValDelayInt=compValDelayInt, tempMin=tempMin, deviceType=deviceType, trapSOAPErrFile=trapSOAPErrFile, valuesInt=valuesInt, histCompVal=histCompVal, humInt=humInt, humHystInt=humHystInt, historyEntry=historyEntry, humUnit=humUnit, compValUnit=compValUnit, compValInt=compValInt, trapEmailErrDNS=trapEmailErrDNS, trapHumHighAlarm=trapHumHighAlarm, compValHighInt=compValHighInt, pysmi_global=pysmi_global, products=products, t3610=t3610, tempUnit=tempUnit, histHum=histHum, trapSOAPErrDNS=trapSOAPErrDNS, tables=tables, settings=settings, trapTempHighAlarm=trapTempHighAlarm, messageString=messageString, trapCompValClrAlarm=trapCompValClrAlarm, compValLowInt=compValLowInt, trapHumLowAlarm=trapHumLowAlarm, temp=temp, trapEmailErrAuth=trapEmailErrAuth, traps=traps, compValMax=compValMax, trapSOAPErrSocket=trapSOAPErrSocket, tempLowInt=tempLowInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTempLowAlarm=trapTempLowAlarm, histTemp=histTemp, trapHumError=trapHumError, humAlarmInt=humAlarmInt, humHighInt=humHighInt, humAlarm=humAlarm, tempHystInt=tempHystInt, trapTest=trapTest, trapEmailErrSocket=trapEmailErrSocket, sensorName=sensorName, tempInt=tempInt, humLowInt=humLowInt, values=values, historyTable=historyTable, humMin=humMin, hum=hum, tempMax=tempMax, compValAlarmInt=compValAlarmInt, humMax=humMax, trapCompValError=trapCompValError, trapTempError=trapTempError, trapCompValLowAlarm=trapCompValLowAlarm, trapTempClrAlarm=trapTempClrAlarm, trapEmailErrLogin=trapEmailErrLogin, compVal=compVal, comet=comet, tempAlarm=tempAlarm, serialNumber=serialNumber, DisplayString=DisplayString, tempDelayInt=tempDelayInt, compValAlarm=compValAlarm, tempAlarmInt=tempAlarmInt)
