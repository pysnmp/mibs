...
# Produced by pysmi-1.1.12 at Tue Jun  4 12:15:36 2024
...
TimeTicks, iso, Bits, enterprises, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, Counter64, NotificationType, ObjectIdentity, Unsigned32, IpAddress, MibIdentifier, NotificationType, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "iso", "Bits", "enterprises", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "Counter64", "NotificationType", "ObjectIdentity", "Unsigned32", "IpAddress", "MibIdentifier", "NotificationType", "Gauge32")
...
mibBuilder.exportSymbols("T3610-MIB", trapSOAPErrSocket=trapSOAPErrSocket, compValAlarm=compValAlarm, humInt=humInt, tempMin=tempMin, settings=settings, tempInt=tempInt, historyTable=historyTable, trapSOAPErrDNS=trapSOAPErrDNS, tempHighInt=tempHighInt, DisplayString=DisplayString, humUnit=humUnit, compValInt=compValInt, trapNTPError=trapNTPError, trapTempError=trapTempError, tables=tables, tempAlarm=tempAlarm, tempUnit=tempUnit, trapCompValClrAlarm=trapCompValClrAlarm, histCompVal=histCompVal, humAlarm=humAlarm, tempDelayInt=tempDelayInt, trapEmailErrSome=trapEmailErrSome, t3610=t3610, compValMax=compValMax, tempLowInt=tempLowInt, tempHystInt=tempHystInt, histHum=histHum, trapTempClrAlarm=trapTempClrAlarm, trapHumError=trapHumError, trapEmailErrAuth=trapEmailErrAuth, trapEmailErrDNS=trapEmailErrDNS, trapCompValHighAlarm=trapCompValHighAlarm, tempAlarmInt=tempAlarmInt, serialNumber=serialNumber, humHystInt=humHystInt, compValDelayInt=compValDelayInt, trapHumClrAlarm=trapHumClrAlarm, compValLowInt=compValLowInt, trapCompValError=trapCompValError, compValMin=compValMin, sensorName=sensorName, trapSOAPErrDelivery=trapSOAPErrDelivery, humHighInt=humHighInt, histTemp=histTemp, trapCompValLowAlarm=trapCompValLowAlarm, trapEmailErrSocket=trapEmailErrSocket, compValUnit=compValUnit, deviceType=deviceType, historyEntry=historyEntry, products=products, humLowInt=humLowInt, trapEmailErrLogin=trapEmailErrLogin, traps=traps, compValAlarmInt=compValAlarmInt, comet=comet, trapHumHighAlarm=trapHumHighAlarm, hum=hum, trapTempLowAlarm=trapTempLowAlarm, messageString=messageString, trapTest=trapTest, values=values, temp=temp, humMax=humMax, trapTempHighAlarm=trapTempHighAlarm, humAlarmInt=humAlarmInt, trapSOAPErrFile=trapSOAPErrFile, pysmi_global=pysmi_global, valuesInt=valuesInt, compValHystInt=compValHystInt, humDelayInt=humDelayInt, humMin=humMin, compVal=compVal, compValHighInt=compValHighInt, tempMax=tempMax, trapHumLowAlarm=trapHumLowAlarm)
