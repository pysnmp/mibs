...
Gauge32, enterprises, Counter32, Integer32, Counter64, iso, ModuleIdentity, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, TimeTicks, Bits, NotificationType, NotificationType, Unsigned32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "enterprises", "Counter32", "Integer32", "Counter64", "iso", "ModuleIdentity", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "TimeTicks", "Bits", "NotificationType", "NotificationType", "Unsigned32", "MibIdentifier")
...
mibBuilder.exportSymbols("T3610-MIB", trapEmailErrAuth=trapEmailErrAuth, humLowInt=humLowInt, trapSOAPErrDNS=trapSOAPErrDNS, compValMin=compValMin, trapCompValClrAlarm=trapCompValClrAlarm, historyEntry=historyEntry, histCompVal=histCompVal, trapNTPError=trapNTPError, pysmi_global=pysmi_global, trapTempLowAlarm=trapTempLowAlarm, humMin=humMin, serialNumber=serialNumber, compValHystInt=compValHystInt, trapHumClrAlarm=trapHumClrAlarm, hum=hum, sensorName=sensorName, compVal=compVal, tempLowInt=tempLowInt, humUnit=humUnit, histHum=histHum, trapSOAPErrFile=trapSOAPErrFile, trapTempHighAlarm=trapTempHighAlarm, tempAlarm=tempAlarm, compValLowInt=compValLowInt, trapTempError=trapTempError, products=products, comet=comet, tempHystInt=tempHystInt, tempAlarmInt=tempAlarmInt, temp=temp, humAlarm=humAlarm, trapEmailErrSome=trapEmailErrSome, histTemp=histTemp, values=values, humDelayInt=humDelayInt, valuesInt=valuesInt, humHystInt=humHystInt, compValDelayInt=compValDelayInt, trapTempClrAlarm=trapTempClrAlarm, humAlarmInt=humAlarmInt, trapCompValHighAlarm=trapCompValHighAlarm, trapCompValError=trapCompValError, tempInt=tempInt, trapSOAPErrSocket=trapSOAPErrSocket, trapEmailErrSocket=trapEmailErrSocket, compValHighInt=compValHighInt, t3610=t3610, trapCompValLowAlarm=trapCompValLowAlarm, settings=settings, tempMin=tempMin, compValUnit=compValUnit, traps=traps, tables=tables, humHighInt=humHighInt, tempHighInt=tempHighInt, humInt=humInt, trapHumError=trapHumError, messageString=messageString, trapTest=trapTest, tempMax=tempMax, trapEmailErrLogin=trapEmailErrLogin, trapHumLowAlarm=trapHumLowAlarm, compValAlarm=compValAlarm, tempUnit=tempUnit, compValAlarmInt=compValAlarmInt, historyTable=historyTable, compValMax=compValMax, trapSOAPErrDelivery=trapSOAPErrDelivery, tempDelayInt=tempDelayInt, compValInt=compValInt, trapEmailErrDNS=trapEmailErrDNS, humMax=humMax, trapHumHighAlarm=trapHumHighAlarm, DisplayString=DisplayString, deviceType=deviceType)
