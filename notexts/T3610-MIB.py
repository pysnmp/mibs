...
# Produced by pysmi-1.1.8 at Thu Apr 27 12:07:33 2023
...
Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Integer32, Gauge32, NotificationType, Counter32, ObjectIdentity, enterprises, Counter64, IpAddress, iso, MibIdentifier, ModuleIdentity, Unsigned32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Integer32", "Gauge32", "NotificationType", "Counter32", "ObjectIdentity", "enterprises", "Counter64", "IpAddress", "iso", "MibIdentifier", "ModuleIdentity", "Unsigned32", "TimeTicks")
...
mibBuilder.exportSymbols("T3610-MIB", DisplayString=DisplayString, humMax=humMax, pysmi_global=pysmi_global, trapEmailErrSocket=trapEmailErrSocket, histCompVal=histCompVal, trapEmailErrDNS=trapEmailErrDNS, trapHumError=trapHumError, humLowInt=humLowInt, trapHumLowAlarm=trapHumLowAlarm, compValAlarm=compValAlarm, tempInt=tempInt, tempAlarm=tempAlarm, tempAlarmInt=tempAlarmInt, humHighInt=humHighInt, historyTable=historyTable, tempMin=tempMin, trapSOAPErrDNS=trapSOAPErrDNS, sensorName=sensorName, trapCompValLowAlarm=trapCompValLowAlarm, t3610=t3610, tempUnit=tempUnit, compValInt=compValInt, trapTempClrAlarm=trapTempClrAlarm, compValHystInt=compValHystInt, trapTest=trapTest, trapHumClrAlarm=trapHumClrAlarm, temp=temp, settings=settings, hum=hum, trapEmailErrSome=trapEmailErrSome, trapTempLowAlarm=trapTempLowAlarm, comet=comet, trapSOAPErrDelivery=trapSOAPErrDelivery, humDelayInt=humDelayInt, humHystInt=humHystInt, trapCompValClrAlarm=trapCompValClrAlarm, trapCompValHighAlarm=trapCompValHighAlarm, humAlarmInt=humAlarmInt, values=values, tempMax=tempMax, valuesInt=valuesInt, histTemp=histTemp, trapHumHighAlarm=trapHumHighAlarm, trapSOAPErrFile=trapSOAPErrFile, tempLowInt=tempLowInt, compValHighInt=compValHighInt, humMin=humMin, products=products, traps=traps, compValLowInt=compValLowInt, tempHystInt=tempHystInt, trapEmailErrLogin=trapEmailErrLogin, serialNumber=serialNumber, trapEmailErrAuth=trapEmailErrAuth, deviceType=deviceType, humInt=humInt, messageString=messageString, histHum=histHum, trapTempHighAlarm=trapTempHighAlarm, trapTempError=trapTempError, trapNTPError=trapNTPError, humUnit=humUnit, tables=tables, tempDelayInt=tempDelayInt, trapSOAPErrSocket=trapSOAPErrSocket, compValAlarmInt=compValAlarmInt, compVal=compVal, compValDelayInt=compValDelayInt, humAlarm=humAlarm, historyEntry=historyEntry, compValUnit=compValUnit, tempHighInt=tempHighInt, compValMin=compValMin, compValMax=compValMax, trapCompValError=trapCompValError)
