...
# Produced by pysmi-1.1.3 at Tue Dec  7 13:49:20 2021
...
ModuleIdentity, iso, TimeTicks, ObjectIdentity, Counter32, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Gauge32, NotificationType, Bits, Unsigned32, Integer32, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "TimeTicks", "ObjectIdentity", "Counter32", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Gauge32", "NotificationType", "Bits", "Unsigned32", "Integer32", "Counter64", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", comet=comet, compValHystInt=compValHystInt, trapSOAPErrFile=trapSOAPErrFile, humMax=humMax, compValAlarm=compValAlarm, compValUnit=compValUnit, tempInt=tempInt, humAlarm=humAlarm, humDelayInt=humDelayInt, trapEmailErrLogin=trapEmailErrLogin, trapEmailErrAuth=trapEmailErrAuth, trapTempClrAlarm=trapTempClrAlarm, products=products, tempLowInt=tempLowInt, historyEntry=historyEntry, compValLowInt=compValLowInt, humHighInt=humHighInt, sensorName=sensorName, tempMin=tempMin, hum=hum, trapTest=trapTest, histTemp=histTemp, trapHumClrAlarm=trapHumClrAlarm, trapCompValClrAlarm=trapCompValClrAlarm, trapTempError=trapTempError, tempAlarm=tempAlarm, trapSOAPErrDNS=trapSOAPErrDNS, trapCompValHighAlarm=trapCompValHighAlarm, compValDelayInt=compValDelayInt, histHum=histHum, trapHumHighAlarm=trapHumHighAlarm, trapTempLowAlarm=trapTempLowAlarm, tempHighInt=tempHighInt, temp=temp, deviceType=deviceType, trapSOAPErrDelivery=trapSOAPErrDelivery, valuesInt=valuesInt, values=values, tempHystInt=tempHystInt, tempMax=tempMax, compValMin=compValMin, compValHighInt=compValHighInt, tempAlarmInt=tempAlarmInt, trapNTPError=trapNTPError, traps=traps, compValInt=compValInt, pysmi_global=pysmi_global, humHystInt=humHystInt, messageString=messageString, histCompVal=histCompVal, trapCompValLowAlarm=trapCompValLowAlarm, tables=tables, trapHumError=trapHumError, trapEmailErrDNS=trapEmailErrDNS, t3610=t3610, serialNumber=serialNumber, trapEmailErrSome=trapEmailErrSome, trapTempHighAlarm=trapTempHighAlarm, trapCompValError=trapCompValError, historyTable=historyTable, humInt=humInt, trapSOAPErrSocket=trapSOAPErrSocket, DisplayString=DisplayString, humMin=humMin, humLowInt=humLowInt, compValAlarmInt=compValAlarmInt, compVal=compVal, tempUnit=tempUnit, trapHumLowAlarm=trapHumLowAlarm, compValMax=compValMax, humUnit=humUnit, humAlarmInt=humAlarmInt, trapEmailErrSocket=trapEmailErrSocket, tempDelayInt=tempDelayInt, settings=settings)
