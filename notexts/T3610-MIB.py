...
# Produced by pysmi-1.1.8 at Thu Apr 27 10:31:50 2023
...
enterprises, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, MibIdentifier, Unsigned32, ModuleIdentity, Integer32, TimeTicks, Counter64, NotificationType, NotificationType, Gauge32, Bits, IpAddress, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "MibIdentifier", "Unsigned32", "ModuleIdentity", "Integer32", "TimeTicks", "Counter64", "NotificationType", "NotificationType", "Gauge32", "Bits", "IpAddress", "Counter32")
...
mibBuilder.exportSymbols("T3610-MIB", histCompVal=histCompVal, humLowInt=humLowInt, humHighInt=humHighInt, compValHighInt=compValHighInt, compValHystInt=compValHystInt, trapTempError=trapTempError, trapEmailErrSome=trapEmailErrSome, compValDelayInt=compValDelayInt, histHum=histHum, trapCompValLowAlarm=trapCompValLowAlarm, products=products, trapEmailErrDNS=trapEmailErrDNS, historyTable=historyTable, sensorName=sensorName, compValUnit=compValUnit, trapHumClrAlarm=trapHumClrAlarm, compValLowInt=compValLowInt, tempInt=tempInt, messageString=messageString, trapCompValError=trapCompValError, settings=settings, humMin=humMin, compValAlarmInt=compValAlarmInt, trapTempHighAlarm=trapTempHighAlarm, compValAlarm=compValAlarm, tempHystInt=tempHystInt, trapHumHighAlarm=trapHumHighAlarm, trapHumLowAlarm=trapHumLowAlarm, compValInt=compValInt, trapTempClrAlarm=trapTempClrAlarm, humMax=humMax, histTemp=histTemp, values=values, trapTempLowAlarm=trapTempLowAlarm, valuesInt=valuesInt, tempUnit=tempUnit, tempAlarmInt=tempAlarmInt, compVal=compVal, traps=traps, tempLowInt=tempLowInt, humDelayInt=humDelayInt, trapEmailErrLogin=trapEmailErrLogin, historyEntry=historyEntry, tempMin=tempMin, trapEmailErrAuth=trapEmailErrAuth, tempDelayInt=tempDelayInt, humHystInt=humHystInt, tempHighInt=tempHighInt, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrDelivery=trapSOAPErrDelivery, DisplayString=DisplayString, compValMax=compValMax, tempMax=tempMax, trapCompValClrAlarm=trapCompValClrAlarm, trapNTPError=trapNTPError, trapSOAPErrSocket=trapSOAPErrSocket, t3610=t3610, deviceType=deviceType, temp=temp, hum=hum, humUnit=humUnit, serialNumber=serialNumber, pysmi_global=pysmi_global, tables=tables, trapHumError=trapHumError, tempAlarm=tempAlarm, humInt=humInt, trapSOAPErrDNS=trapSOAPErrDNS, trapSOAPErrFile=trapSOAPErrFile, trapCompValHighAlarm=trapCompValHighAlarm, compValMin=compValMin, trapTest=trapTest, humAlarmInt=humAlarmInt, humAlarm=humAlarm, comet=comet)
