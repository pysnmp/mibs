...
# Produced by pysmi-1.1.8 at Wed Oct 11 11:22:12 2023
...
Counter64, ObjectIdentity, Bits, enterprises, iso, NotificationType, TimeTicks, NotificationType, Integer32, MibIdentifier, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ModuleIdentity, Counter32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ObjectIdentity", "Bits", "enterprises", "iso", "NotificationType", "TimeTicks", "NotificationType", "Integer32", "MibIdentifier", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ModuleIdentity", "Counter32", "Unsigned32")
...
mibBuilder.exportSymbols("T3610-MIB", humInt=humInt, traps=traps, humLowInt=humLowInt, trapCompValLowAlarm=trapCompValLowAlarm, tempMin=tempMin, histHum=histHum, compValLowInt=compValLowInt, compValDelayInt=compValDelayInt, settings=settings, historyEntry=historyEntry, histCompVal=histCompVal, trapTest=trapTest, humMax=humMax, hum=hum, compValHystInt=compValHystInt, compValUnit=compValUnit, tempUnit=tempUnit, pysmi_global=pysmi_global, compValInt=compValInt, compValAlarmInt=compValAlarmInt, compValHighInt=compValHighInt, trapEmailErrSocket=trapEmailErrSocket, trapEmailErrDNS=trapEmailErrDNS, trapTempLowAlarm=trapTempLowAlarm, tables=tables, histTemp=histTemp, trapTempError=trapTempError, trapSOAPErrDelivery=trapSOAPErrDelivery, compValMax=compValMax, tempDelayInt=tempDelayInt, temp=temp, humHystInt=humHystInt, tempMax=tempMax, serialNumber=serialNumber, tempHighInt=tempHighInt, trapCompValHighAlarm=trapCompValHighAlarm, compVal=compVal, comet=comet, tempHystInt=tempHystInt, trapNTPError=trapNTPError, humAlarmInt=humAlarmInt, deviceType=deviceType, valuesInt=valuesInt, trapHumError=trapHumError, tempInt=tempInt, trapCompValError=trapCompValError, trapHumClrAlarm=trapHumClrAlarm, trapSOAPErrSocket=trapSOAPErrSocket, trapSOAPErrFile=trapSOAPErrFile, historyTable=historyTable, values=values, trapHumLowAlarm=trapHumLowAlarm, trapEmailErrSome=trapEmailErrSome, messageString=messageString, humHighInt=humHighInt, trapTempHighAlarm=trapTempHighAlarm, products=products, sensorName=sensorName, humAlarm=humAlarm, trapTempClrAlarm=trapTempClrAlarm, DisplayString=DisplayString, trapCompValClrAlarm=trapCompValClrAlarm, humMin=humMin, trapEmailErrLogin=trapEmailErrLogin, compValAlarm=compValAlarm, trapHumHighAlarm=trapHumHighAlarm, trapEmailErrAuth=trapEmailErrAuth, compValMin=compValMin, tempLowInt=tempLowInt, humUnit=humUnit, trapSOAPErrDNS=trapSOAPErrDNS, tempAlarmInt=tempAlarmInt, humDelayInt=humDelayInt, t3610=t3610, tempAlarm=tempAlarm)
