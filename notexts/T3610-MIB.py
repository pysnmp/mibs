...
MibIdentifier, NotificationType, ModuleIdentity, enterprises, Counter32, IpAddress, TimeTicks, NotificationType, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Gauge32, iso, Unsigned32, ObjectIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "ModuleIdentity", "enterprises", "Counter32", "IpAddress", "TimeTicks", "NotificationType", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Gauge32", "iso", "Unsigned32", "ObjectIdentity", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", humMax=humMax, compValDelayInt=compValDelayInt, trapEmailErrLogin=trapEmailErrLogin, humUnit=humUnit, trapEmailErrAuth=trapEmailErrAuth, humAlarm=humAlarm, deviceType=deviceType, humInt=humInt, tempHighInt=tempHighInt, trapEmailErrSocket=trapEmailErrSocket, compValInt=compValInt, trapCompValError=trapCompValError, compValLowInt=compValLowInt, histTemp=histTemp, tempInt=tempInt, trapTest=trapTest, pysmi_global=pysmi_global, trapTempError=trapTempError, tempMax=tempMax, serialNumber=serialNumber, trapTempHighAlarm=trapTempHighAlarm, tempMin=tempMin, trapNTPError=trapNTPError, humMin=humMin, humAlarmInt=humAlarmInt, trapTempClrAlarm=trapTempClrAlarm, humHystInt=humHystInt, tempHystInt=tempHystInt, trapCompValHighAlarm=trapCompValHighAlarm, compValUnit=compValUnit, compValMin=compValMin, compValAlarm=compValAlarm, compValAlarmInt=compValAlarmInt, humHighInt=humHighInt, messageString=messageString, trapEmailErrDNS=trapEmailErrDNS, trapHumLowAlarm=trapHumLowAlarm, DisplayString=DisplayString, valuesInt=valuesInt, settings=settings, histCompVal=histCompVal, products=products, humDelayInt=humDelayInt, compValHighInt=compValHighInt, trapSOAPErrFile=trapSOAPErrFile, trapHumClrAlarm=trapHumClrAlarm, historyTable=historyTable, t3610=t3610, tables=tables, trapSOAPErrSocket=trapSOAPErrSocket, trapEmailErrSome=trapEmailErrSome, tempUnit=tempUnit, trapCompValLowAlarm=trapCompValLowAlarm, histHum=histHum, comet=comet, compVal=compVal, tempDelayInt=tempDelayInt, trapSOAPErrDNS=trapSOAPErrDNS, trapHumHighAlarm=trapHumHighAlarm, compValHystInt=compValHystInt, tempAlarm=tempAlarm, hum=hum, values=values, trapCompValClrAlarm=trapCompValClrAlarm, tempLowInt=tempLowInt, compValMax=compValMax, tempAlarmInt=tempAlarmInt, humLowInt=humLowInt, sensorName=sensorName, historyEntry=historyEntry, traps=traps, trapSOAPErrDelivery=trapSOAPErrDelivery, trapHumError=trapHumError, trapTempLowAlarm=trapTempLowAlarm, temp=temp)
