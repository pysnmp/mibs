...
# Produced by pysmi-1.1.11 at Tue Dec  5 02:26:57 2023
...
IpAddress, NotificationType, Gauge32, ObjectIdentity, iso, enterprises, Integer32, Counter32, Unsigned32, MibIdentifier, ModuleIdentity, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "NotificationType", "Gauge32", "ObjectIdentity", "iso", "enterprises", "Integer32", "Counter32", "Unsigned32", "MibIdentifier", "ModuleIdentity", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "TimeTicks")
...
mibBuilder.exportSymbols("T3610-MIB", trapEmailErrDNS=trapEmailErrDNS, trapTempClrAlarm=trapTempClrAlarm, trapTempLowAlarm=trapTempLowAlarm, humInt=humInt, humAlarm=humAlarm, valuesInt=valuesInt, humMax=humMax, humHighInt=humHighInt, trapHumClrAlarm=trapHumClrAlarm, products=products, compValDelayInt=compValDelayInt, tempHystInt=tempHystInt, compValLowInt=compValLowInt, historyTable=historyTable, tempLowInt=tempLowInt, hum=hum, compValAlarm=compValAlarm, settings=settings, compValHighInt=compValHighInt, compValMax=compValMax, historyEntry=historyEntry, trapEmailErrLogin=trapEmailErrLogin, trapCompValHighAlarm=trapCompValHighAlarm, trapHumLowAlarm=trapHumLowAlarm, humLowInt=humLowInt, trapSOAPErrDNS=trapSOAPErrDNS, temp=temp, compValAlarmInt=compValAlarmInt, pysmi_global=pysmi_global, compVal=compVal, trapCompValClrAlarm=trapCompValClrAlarm, tempAlarm=tempAlarm, deviceType=deviceType, humDelayInt=humDelayInt, t3610=t3610, comet=comet, serialNumber=serialNumber, tempInt=tempInt, compValHystInt=compValHystInt, trapNTPError=trapNTPError, trapCompValLowAlarm=trapCompValLowAlarm, trapTempHighAlarm=trapTempHighAlarm, histCompVal=histCompVal, tempUnit=tempUnit, humAlarmInt=humAlarmInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapHumHighAlarm=trapHumHighAlarm, humUnit=humUnit, messageString=messageString, values=values, trapSOAPErrSocket=trapSOAPErrSocket, traps=traps, DisplayString=DisplayString, tempAlarmInt=tempAlarmInt, histTemp=histTemp, trapEmailErrAuth=trapEmailErrAuth, compValInt=compValInt, trapSOAPErrFile=trapSOAPErrFile, sensorName=sensorName, trapCompValError=trapCompValError, compValUnit=compValUnit, compValMin=compValMin, tempMax=tempMax, trapEmailErrSome=trapEmailErrSome, histHum=histHum, tempHighInt=tempHighInt, trapEmailErrSocket=trapEmailErrSocket, tempDelayInt=tempDelayInt, trapTest=trapTest, tempMin=tempMin, trapHumError=trapHumError, humMin=humMin, humHystInt=humHystInt, trapTempError=trapTempError, tables=tables)
