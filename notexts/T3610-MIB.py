...
# Produced by pysmi-1.1.3 at Thu Dec  9 14:30:40 2021
...
Integer32, IpAddress, enterprises, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Gauge32, ObjectIdentity, Unsigned32, MibIdentifier, TimeTicks, Bits, Counter64, Counter32, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "enterprises", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Gauge32", "ObjectIdentity", "Unsigned32", "MibIdentifier", "TimeTicks", "Bits", "Counter64", "Counter32", "NotificationType", "iso")
...
mibBuilder.exportSymbols("T3610-MIB", compValHighInt=compValHighInt, trapTempClrAlarm=trapTempClrAlarm, histCompVal=histCompVal, trapHumHighAlarm=trapHumHighAlarm, historyEntry=historyEntry, tempHystInt=tempHystInt, comet=comet, traps=traps, humHystInt=humHystInt, humHighInt=humHighInt, trapCompValLowAlarm=trapCompValLowAlarm, tempAlarm=tempAlarm, tempInt=tempInt, tempUnit=tempUnit, humInt=humInt, values=values, trapEmailErrLogin=trapEmailErrLogin, deviceType=deviceType, trapTempError=trapTempError, messageString=messageString, trapTempLowAlarm=trapTempLowAlarm, products=products, humMax=humMax, trapCompValError=trapCompValError, compValMin=compValMin, trapSOAPErrDNS=trapSOAPErrDNS, trapHumLowAlarm=trapHumLowAlarm, tables=tables, tempDelayInt=tempDelayInt, trapEmailErrSocket=trapEmailErrSocket, compValMax=compValMax, compValInt=compValInt, humDelayInt=humDelayInt, compValDelayInt=compValDelayInt, compValHystInt=compValHystInt, humAlarmInt=humAlarmInt, historyTable=historyTable, tempAlarmInt=tempAlarmInt, trapTest=trapTest, humUnit=humUnit, trapHumClrAlarm=trapHumClrAlarm, settings=settings, humAlarm=humAlarm, humMin=humMin, temp=temp, compValAlarm=compValAlarm, histTemp=histTemp, compValLowInt=compValLowInt, histHum=histHum, valuesInt=valuesInt, trapSOAPErrFile=trapSOAPErrFile, trapEmailErrSome=trapEmailErrSome, serialNumber=serialNumber, trapCompValClrAlarm=trapCompValClrAlarm, trapNTPError=trapNTPError, hum=hum, trapHumError=trapHumError, humLowInt=humLowInt, compValAlarmInt=compValAlarmInt, pysmi_global=pysmi_global, trapEmailErrAuth=trapEmailErrAuth, sensorName=sensorName, trapSOAPErrDelivery=trapSOAPErrDelivery, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValHighAlarm=trapCompValHighAlarm, DisplayString=DisplayString, tempMin=tempMin, compVal=compVal, t3610=t3610, compValUnit=compValUnit, tempHighInt=tempHighInt, trapEmailErrDNS=trapEmailErrDNS, trapTempHighAlarm=trapTempHighAlarm, tempLowInt=tempLowInt, tempMax=tempMax)
