...
# Produced by pysmi-1.1.8 at Wed Sep  6 13:27:46 2023
...
Gauge32, enterprises, Counter64, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, Unsigned32, IpAddress, MibIdentifier, NotificationType, iso, ModuleIdentity, Counter32, ObjectIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "enterprises", "Counter64", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "Unsigned32", "IpAddress", "MibIdentifier", "NotificationType", "iso", "ModuleIdentity", "Counter32", "ObjectIdentity", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", compVal=compVal, messageString=messageString, humAlarmInt=humAlarmInt, compValAlarmInt=compValAlarmInt, trapCompValError=trapCompValError, humMax=humMax, compValUnit=compValUnit, humLowInt=humLowInt, trapHumError=trapHumError, humHighInt=humHighInt, trapNTPError=trapNTPError, trapEmailErrSome=trapEmailErrSome, trapTempLowAlarm=trapTempLowAlarm, humHystInt=humHystInt, t3610=t3610, comet=comet, trapTempHighAlarm=trapTempHighAlarm, compValHystInt=compValHystInt, sensorName=sensorName, serialNumber=serialNumber, trapCompValClrAlarm=trapCompValClrAlarm, hum=hum, valuesInt=valuesInt, historyEntry=historyEntry, tempAlarm=tempAlarm, tempDelayInt=tempDelayInt, compValHighInt=compValHighInt, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValLowAlarm=trapCompValLowAlarm, pysmi_global=pysmi_global, trapSOAPErrFile=trapSOAPErrFile, trapHumHighAlarm=trapHumHighAlarm, tempMin=tempMin, tempHighInt=tempHighInt, products=products, tempMax=tempMax, deviceType=deviceType, tempInt=tempInt, tempLowInt=tempLowInt, compValDelayInt=compValDelayInt, humUnit=humUnit, tempHystInt=tempHystInt, traps=traps, trapEmailErrSocket=trapEmailErrSocket, trapEmailErrDNS=trapEmailErrDNS, humAlarm=humAlarm, compValMax=compValMax, humDelayInt=humDelayInt, trapHumClrAlarm=trapHumClrAlarm, compValMin=compValMin, compValInt=compValInt, histTemp=histTemp, trapTempError=trapTempError, historyTable=historyTable, humMin=humMin, tempUnit=tempUnit, trapSOAPErrDNS=trapSOAPErrDNS, trapEmailErrLogin=trapEmailErrLogin, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTempClrAlarm=trapTempClrAlarm, values=values, trapHumLowAlarm=trapHumLowAlarm, settings=settings, trapTest=trapTest, compValLowInt=compValLowInt, tables=tables, temp=temp, trapEmailErrAuth=trapEmailErrAuth, tempAlarmInt=tempAlarmInt, compValAlarm=compValAlarm, humInt=humInt, trapCompValHighAlarm=trapCompValHighAlarm, DisplayString=DisplayString, histHum=histHum, histCompVal=histCompVal)
