...
# Produced by pysmi-1.1.12 at Mon Jun  3 11:53:52 2024
...
iso, enterprises, NotificationType, ObjectIdentity, Integer32, TimeTicks, Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, ModuleIdentity, IpAddress, NotificationType, MibIdentifier, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "enterprises", "NotificationType", "ObjectIdentity", "Integer32", "TimeTicks", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "ModuleIdentity", "IpAddress", "NotificationType", "MibIdentifier", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", trapEmailErrDNS=trapEmailErrDNS, settings=settings, humAlarm=humAlarm, trapNTPError=trapNTPError, messageString=messageString, trapHumHighAlarm=trapHumHighAlarm, tempHighInt=tempHighInt, humHighInt=humHighInt, compValAlarmInt=compValAlarmInt, tempDelayInt=tempDelayInt, historyTable=historyTable, trapHumClrAlarm=trapHumClrAlarm, sensorName=sensorName, DisplayString=DisplayString, tempMin=tempMin, tempAlarmInt=tempAlarmInt, tempLowInt=tempLowInt, histTemp=histTemp, trapEmailErrSome=trapEmailErrSome, compVal=compVal, trapCompValHighAlarm=trapCompValHighAlarm, trapTempHighAlarm=trapTempHighAlarm, trapCompValClrAlarm=trapCompValClrAlarm, humDelayInt=humDelayInt, trapEmailErrAuth=trapEmailErrAuth, serialNumber=serialNumber, tables=tables, historyEntry=historyEntry, trapSOAPErrSocket=trapSOAPErrSocket, values=values, t3610=t3610, pysmi_global=pysmi_global, compValDelayInt=compValDelayInt, compValMin=compValMin, tempHystInt=tempHystInt, humUnit=humUnit, humLowInt=humLowInt, compValInt=compValInt, histHum=histHum, trapTempClrAlarm=trapTempClrAlarm, products=products, trapEmailErrLogin=trapEmailErrLogin, humAlarmInt=humAlarmInt, tempInt=tempInt, humInt=humInt, trapCompValLowAlarm=trapCompValLowAlarm, tempUnit=tempUnit, trapCompValError=trapCompValError, trapSOAPErrDNS=trapSOAPErrDNS, valuesInt=valuesInt, temp=temp, hum=hum, trapHumError=trapHumError, humMin=humMin, humMax=humMax, tempAlarm=tempAlarm, compValHighInt=compValHighInt, trapEmailErrSocket=trapEmailErrSocket, traps=traps, trapTempLowAlarm=trapTempLowAlarm, compValUnit=compValUnit, histCompVal=histCompVal, trapSOAPErrFile=trapSOAPErrFile, trapTempError=trapTempError, comet=comet, deviceType=deviceType, humHystInt=humHystInt, tempMax=tempMax, trapHumLowAlarm=trapHumLowAlarm, compValLowInt=compValLowInt, trapTest=trapTest, compValMax=compValMax, trapSOAPErrDelivery=trapSOAPErrDelivery, compValHystInt=compValHystInt, compValAlarm=compValAlarm)
