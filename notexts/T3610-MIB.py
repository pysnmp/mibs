...
# Produced by pysmi-1.1.3 at Wed Dec  8 17:58:01 2021
...
NotificationType, Integer32, Unsigned32, IpAddress, iso, ObjectIdentity, Bits, Counter32, MibIdentifier, NotificationType, ModuleIdentity, TimeTicks, Counter64, enterprises, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "Unsigned32", "IpAddress", "iso", "ObjectIdentity", "Bits", "Counter32", "MibIdentifier", "NotificationType", "ModuleIdentity", "TimeTicks", "Counter64", "enterprises", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("T3610-MIB", hum=hum, t3610=t3610, settings=settings, humMax=humMax, tempInt=tempInt, values=values, compValMin=compValMin, tempHighInt=tempHighInt, humInt=humInt, compValDelayInt=compValDelayInt, trapCompValError=trapCompValError, humLowInt=humLowInt, deviceType=deviceType, tempLowInt=tempLowInt, humHighInt=humHighInt, trapHumHighAlarm=trapHumHighAlarm, trapEmailErrSocket=trapEmailErrSocket, trapTempError=trapTempError, trapTempClrAlarm=trapTempClrAlarm, trapHumLowAlarm=trapHumLowAlarm, trapEmailErrLogin=trapEmailErrLogin, traps=traps, compValUnit=compValUnit, humMin=humMin, historyEntry=historyEntry, trapTempLowAlarm=trapTempLowAlarm, compValMax=compValMax, messageString=messageString, trapEmailErrAuth=trapEmailErrAuth, products=products, humAlarmInt=humAlarmInt, humUnit=humUnit, compValAlarmInt=compValAlarmInt, histTemp=histTemp, pysmi_global=pysmi_global, tempMax=tempMax, valuesInt=valuesInt, tempMin=tempMin, histHum=histHum, tempAlarm=tempAlarm, trapCompValClrAlarm=trapCompValClrAlarm, trapSOAPErrDNS=trapSOAPErrDNS, trapHumClrAlarm=trapHumClrAlarm, humAlarm=humAlarm, DisplayString=DisplayString, histCompVal=histCompVal, trapHumError=trapHumError, sensorName=sensorName, serialNumber=serialNumber, tempHystInt=tempHystInt, trapNTPError=trapNTPError, trapEmailErrSome=trapEmailErrSome, trapTempHighAlarm=trapTempHighAlarm, compValInt=compValInt, compValLowInt=compValLowInt, trapEmailErrDNS=trapEmailErrDNS, tempDelayInt=tempDelayInt, tempAlarmInt=tempAlarmInt, trapSOAPErrFile=trapSOAPErrFile, trapSOAPErrSocket=trapSOAPErrSocket, comet=comet, tables=tables, humDelayInt=humDelayInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTest=trapTest, compValHighInt=compValHighInt, historyTable=historyTable, trapCompValLowAlarm=trapCompValLowAlarm, trapCompValHighAlarm=trapCompValHighAlarm, compValAlarm=compValAlarm, tempUnit=tempUnit, humHystInt=humHystInt, temp=temp, compVal=compVal, compValHystInt=compValHystInt)
