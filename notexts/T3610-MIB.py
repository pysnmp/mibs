...
# Produced by pysmi-1.1.12 at Tue Jun  4 13:00:46 2024
...
enterprises, Integer32, IpAddress, Counter64, TimeTicks, ModuleIdentity, Bits, Gauge32, iso, Unsigned32, NotificationType, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ObjectIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Integer32", "IpAddress", "Counter64", "TimeTicks", "ModuleIdentity", "Bits", "Gauge32", "iso", "Unsigned32", "NotificationType", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ObjectIdentity", "Counter32")
...
mibBuilder.exportSymbols("T3610-MIB", compValInt=compValInt, tempDelayInt=tempDelayInt, trapCompValLowAlarm=trapCompValLowAlarm, tempUnit=tempUnit, trapHumLowAlarm=trapHumLowAlarm, pysmi_global=pysmi_global, compValHystInt=compValHystInt, tempMax=tempMax, humDelayInt=humDelayInt, trapNTPError=trapNTPError, histHum=histHum, trapCompValClrAlarm=trapCompValClrAlarm, settings=settings, t3610=t3610, trapEmailErrAuth=trapEmailErrAuth, serialNumber=serialNumber, histTemp=histTemp, trapSOAPErrSocket=trapSOAPErrSocket, trapTempLowAlarm=trapTempLowAlarm, historyTable=historyTable, humUnit=humUnit, humAlarm=humAlarm, valuesInt=valuesInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTempHighAlarm=trapTempHighAlarm, trapSOAPErrDNS=trapSOAPErrDNS, temp=temp, tempAlarmInt=tempAlarmInt, humAlarmInt=humAlarmInt, tempHighInt=tempHighInt, humHighInt=humHighInt, trapTest=trapTest, tempMin=tempMin, comet=comet, humInt=humInt, humHystInt=humHystInt, compValUnit=compValUnit, trapSOAPErrFile=trapSOAPErrFile, histCompVal=histCompVal, trapTempClrAlarm=trapTempClrAlarm, tempAlarm=tempAlarm, hum=hum, traps=traps, humLowInt=humLowInt, DisplayString=DisplayString, compValDelayInt=compValDelayInt, trapCompValError=trapCompValError, values=values, humMin=humMin, compValLowInt=compValLowInt, trapEmailErrLogin=trapEmailErrLogin, humMax=humMax, tempInt=tempInt, trapEmailErrSocket=trapEmailErrSocket, compValMax=compValMax, tempLowInt=tempLowInt, tables=tables, messageString=messageString, compValAlarm=compValAlarm, tempHystInt=tempHystInt, trapEmailErrSome=trapEmailErrSome, trapHumHighAlarm=trapHumHighAlarm, trapCompValHighAlarm=trapCompValHighAlarm, trapHumClrAlarm=trapHumClrAlarm, deviceType=deviceType, trapTempError=trapTempError, historyEntry=historyEntry, sensorName=sensorName, compValHighInt=compValHighInt, compValAlarmInt=compValAlarmInt, trapEmailErrDNS=trapEmailErrDNS, trapHumError=trapHumError, compVal=compVal, products=products, compValMin=compValMin)
