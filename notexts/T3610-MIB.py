...
# Produced by pysmi-1.1.8 at Thu Sep  7 13:54:03 2023
...
Bits, TimeTicks, Counter32, enterprises, NotificationType, Integer32, NotificationType, Counter64, IpAddress, iso, Unsigned32, ModuleIdentity, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "TimeTicks", "Counter32", "enterprises", "NotificationType", "Integer32", "NotificationType", "Counter64", "IpAddress", "iso", "Unsigned32", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32")
...
mibBuilder.exportSymbols("T3610-MIB", trapHumClrAlarm=trapHumClrAlarm, compValHystInt=compValHystInt, humAlarm=humAlarm, values=values, tempDelayInt=tempDelayInt, trapTempHighAlarm=trapTempHighAlarm, compValLowInt=compValLowInt, histCompVal=histCompVal, humInt=humInt, tempLowInt=tempLowInt, trapSOAPErrSocket=trapSOAPErrSocket, trapEmailErrSome=trapEmailErrSome, trapTempClrAlarm=trapTempClrAlarm, trapSOAPErrDNS=trapSOAPErrDNS, trapSOAPErrDelivery=trapSOAPErrDelivery, humUnit=humUnit, compValInt=compValInt, tempAlarmInt=tempAlarmInt, sensorName=sensorName, compValDelayInt=compValDelayInt, humMin=humMin, humAlarmInt=humAlarmInt, compValUnit=compValUnit, trapNTPError=trapNTPError, pysmi_global=pysmi_global, trapCompValHighAlarm=trapCompValHighAlarm, trapEmailErrAuth=trapEmailErrAuth, messageString=messageString, DisplayString=DisplayString, compValAlarm=compValAlarm, trapCompValError=trapCompValError, tables=tables, tempUnit=tempUnit, humHighInt=humHighInt, trapSOAPErrFile=trapSOAPErrFile, hum=hum, compVal=compVal, settings=settings, tempInt=tempInt, traps=traps, humLowInt=humLowInt, products=products, compValHighInt=compValHighInt, histHum=histHum, compValAlarmInt=compValAlarmInt, compValMin=compValMin, trapCompValClrAlarm=trapCompValClrAlarm, historyEntry=historyEntry, trapHumHighAlarm=trapHumHighAlarm, humDelayInt=humDelayInt, historyTable=historyTable, trapEmailErrSocket=trapEmailErrSocket, trapTempError=trapTempError, valuesInt=valuesInt, trapEmailErrDNS=trapEmailErrDNS, temp=temp, tempHighInt=tempHighInt, trapTempLowAlarm=trapTempLowAlarm, trapCompValLowAlarm=trapCompValLowAlarm, trapHumError=trapHumError, compValMax=compValMax, deviceType=deviceType, humMax=humMax, tempMax=tempMax, humHystInt=humHystInt, trapHumLowAlarm=trapHumLowAlarm, histTemp=histTemp, tempAlarm=tempAlarm, tempHystInt=tempHystInt, t3610=t3610, serialNumber=serialNumber, trapEmailErrLogin=trapEmailErrLogin, trapTest=trapTest, comet=comet, tempMin=tempMin)
