...
# Produced by pysmi-1.1.8 at Thu Sep  7 14:21:05 2023
...
Unsigned32, Bits, MibIdentifier, TimeTicks, Gauge32, IpAddress, Counter64, Integer32, enterprises, ObjectIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Bits", "MibIdentifier", "TimeTicks", "Gauge32", "IpAddress", "Counter64", "Integer32", "enterprises", "ObjectIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("T3610-MIB", tempUnit=tempUnit, compValUnit=compValUnit, trapEmailErrLogin=trapEmailErrLogin, values=values, trapEmailErrSome=trapEmailErrSome, compValAlarm=compValAlarm, hum=hum, tempMax=tempMax, trapTempHighAlarm=trapTempHighAlarm, sensorName=sensorName, compValLowInt=compValLowInt, trapHumLowAlarm=trapHumLowAlarm, humDelayInt=humDelayInt, trapTest=trapTest, tempInt=tempInt, traps=traps, humInt=humInt, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValError=trapCompValError, histTemp=histTemp, trapEmailErrAuth=trapEmailErrAuth, temp=temp, messageString=messageString, compVal=compVal, trapEmailErrSocket=trapEmailErrSocket, trapCompValLowAlarm=trapCompValLowAlarm, humUnit=humUnit, trapNTPError=trapNTPError, humMin=humMin, historyEntry=historyEntry, trapSOAPErrFile=trapSOAPErrFile, trapTempClrAlarm=trapTempClrAlarm, trapEmailErrDNS=trapEmailErrDNS, trapSOAPErrDNS=trapSOAPErrDNS, trapTempError=trapTempError, trapCompValHighAlarm=trapCompValHighAlarm, humAlarmInt=humAlarmInt, pysmi_global=pysmi_global, humHighInt=humHighInt, compValHighInt=compValHighInt, tempLowInt=tempLowInt, compValDelayInt=compValDelayInt, comet=comet, DisplayString=DisplayString, compValHystInt=compValHystInt, humLowInt=humLowInt, tempDelayInt=tempDelayInt, trapHumError=trapHumError, compValMax=compValMax, trapCompValClrAlarm=trapCompValClrAlarm, historyTable=historyTable, histHum=histHum, humHystInt=humHystInt, deviceType=deviceType, histCompVal=histCompVal, valuesInt=valuesInt, trapTempLowAlarm=trapTempLowAlarm, tempAlarmInt=tempAlarmInt, tables=tables, t3610=t3610, tempAlarm=tempAlarm, compValAlarmInt=compValAlarmInt, humMax=humMax, tempHystInt=tempHystInt, compValInt=compValInt, products=products, compValMin=compValMin, trapHumHighAlarm=trapHumHighAlarm, humAlarm=humAlarm, tempMin=tempMin, trapSOAPErrDelivery=trapSOAPErrDelivery, serialNumber=serialNumber, settings=settings, trapHumClrAlarm=trapHumClrAlarm, tempHighInt=tempHighInt)
