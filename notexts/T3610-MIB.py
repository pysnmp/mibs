...
# Produced by pysmi-1.1.8 at Fri Jul  8 08:18:41 2022
...
Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress, MibIdentifier, Unsigned32, Counter64, Gauge32, NotificationType, enterprises, iso, Integer32, ObjectIdentity, TimeTicks, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress", "MibIdentifier", "Unsigned32", "Counter64", "Gauge32", "NotificationType", "enterprises", "iso", "Integer32", "ObjectIdentity", "TimeTicks", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", compValAlarm=compValAlarm, deviceType=deviceType, DisplayString=DisplayString, tempDelayInt=tempDelayInt, trapHumLowAlarm=trapHumLowAlarm, humMin=humMin, histHum=histHum, humInt=humInt, trapTest=trapTest, tempLowInt=tempLowInt, compValLowInt=compValLowInt, compValMin=compValMin, humHighInt=humHighInt, comet=comet, historyTable=historyTable, trapSOAPErrFile=trapSOAPErrFile, trapTempLowAlarm=trapTempLowAlarm, histCompVal=histCompVal, pysmi_global=pysmi_global, temp=temp, values=values, valuesInt=valuesInt, tempAlarm=tempAlarm, tempInt=tempInt, humAlarmInt=humAlarmInt, trapEmailErrLogin=trapEmailErrLogin, compValHystInt=compValHystInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapEmailErrAuth=trapEmailErrAuth, trapCompValClrAlarm=trapCompValClrAlarm, trapHumHighAlarm=trapHumHighAlarm, trapHumClrAlarm=trapHumClrAlarm, humHystInt=humHystInt, compValInt=compValInt, compVal=compVal, compValMax=compValMax, sensorName=sensorName, trapEmailErrDNS=trapEmailErrDNS, humMax=humMax, trapTempClrAlarm=trapTempClrAlarm, trapHumError=trapHumError, humDelayInt=humDelayInt, hum=hum, trapTempError=trapTempError, trapEmailErrSome=trapEmailErrSome, histTemp=histTemp, trapEmailErrSocket=trapEmailErrSocket, trapCompValLowAlarm=trapCompValLowAlarm, traps=traps, t3610=t3610, products=products, trapSOAPErrDNS=trapSOAPErrDNS, compValUnit=compValUnit, trapSOAPErrSocket=trapSOAPErrSocket, humUnit=humUnit, trapCompValHighAlarm=trapCompValHighAlarm, trapTempHighAlarm=trapTempHighAlarm, settings=settings, tempAlarmInt=tempAlarmInt, humAlarm=humAlarm, tempMin=tempMin, compValDelayInt=compValDelayInt, tempHystInt=tempHystInt, compValAlarmInt=compValAlarmInt, tempHighInt=tempHighInt, trapNTPError=trapNTPError, tables=tables, tempMax=tempMax, humLowInt=humLowInt, compValHighInt=compValHighInt, serialNumber=serialNumber, messageString=messageString, trapCompValError=trapCompValError, historyEntry=historyEntry, tempUnit=tempUnit)
