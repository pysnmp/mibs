...
# Produced by pysmi-1.1.8 at Sat Jan 15 19:33:27 2022
...
TimeTicks, Bits, NotificationType, NotificationType, Integer32, iso, ModuleIdentity, IpAddress, MibIdentifier, Counter64, Counter32, ObjectIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Bits", "NotificationType", "NotificationType", "Integer32", "iso", "ModuleIdentity", "IpAddress", "MibIdentifier", "Counter64", "Counter32", "ObjectIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Gauge32")
...
mibBuilder.exportSymbols("T3610-MIB", trapEmailErrAuth=trapEmailErrAuth, humAlarm=humAlarm, trapHumError=trapHumError, deviceType=deviceType, settings=settings, tempAlarm=tempAlarm, valuesInt=valuesInt, trapCompValError=trapCompValError, values=values, tempDelayInt=tempDelayInt, trapHumLowAlarm=trapHumLowAlarm, trapEmailErrDNS=trapEmailErrDNS, tempLowInt=tempLowInt, trapEmailErrSome=trapEmailErrSome, humLowInt=humLowInt, humMax=humMax, trapHumHighAlarm=trapHumHighAlarm, temp=temp, traps=traps, compVal=compVal, trapCompValHighAlarm=trapCompValHighAlarm, humMin=humMin, tables=tables, humInt=humInt, tempMax=tempMax, humDelayInt=humDelayInt, trapNTPError=trapNTPError, trapEmailErrLogin=trapEmailErrLogin, trapSOAPErrFile=trapSOAPErrFile, historyEntry=historyEntry, DisplayString=DisplayString, trapTempLowAlarm=trapTempLowAlarm, humUnit=humUnit, trapSOAPErrDNS=trapSOAPErrDNS, tempHighInt=tempHighInt, compValAlarmInt=compValAlarmInt, comet=comet, serialNumber=serialNumber, historyTable=historyTable, pysmi_global=pysmi_global, tempMin=tempMin, t3610=t3610, products=products, compValAlarm=compValAlarm, histCompVal=histCompVal, trapHumClrAlarm=trapHumClrAlarm, hum=hum, trapTempError=trapTempError, compValInt=compValInt, tempHystInt=tempHystInt, trapSOAPErrSocket=trapSOAPErrSocket, humHystInt=humHystInt, trapSOAPErrDelivery=trapSOAPErrDelivery, compValDelayInt=compValDelayInt, tempInt=tempInt, compValHighInt=compValHighInt, histTemp=histTemp, tempAlarmInt=tempAlarmInt, trapCompValLowAlarm=trapCompValLowAlarm, compValLowInt=compValLowInt, compValMax=compValMax, humHighInt=humHighInt, tempUnit=tempUnit, compValMin=compValMin, messageString=messageString, trapTempHighAlarm=trapTempHighAlarm, trapTest=trapTest, compValUnit=compValUnit, humAlarmInt=humAlarmInt, sensorName=sensorName, histHum=histHum, trapCompValClrAlarm=trapCompValClrAlarm, trapTempClrAlarm=trapTempClrAlarm, trapEmailErrSocket=trapEmailErrSocket, compValHystInt=compValHystInt)
