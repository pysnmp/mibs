...
# Produced by pysmi-1.1.12 at Tue Jun  4 13:49:29 2024
...
Bits, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter64, NotificationType, ObjectIdentity, IpAddress, MibIdentifier, Counter32, Unsigned32, NotificationType, Integer32, ModuleIdentity, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter64", "NotificationType", "ObjectIdentity", "IpAddress", "MibIdentifier", "Counter32", "Unsigned32", "NotificationType", "Integer32", "ModuleIdentity", "iso", "Gauge32")
...
mibBuilder.exportSymbols("T3610-MIB", trapSOAPErrFile=trapSOAPErrFile, trapSOAPErrSocket=trapSOAPErrSocket, tempLowInt=tempLowInt, humHighInt=humHighInt, tempAlarm=tempAlarm, historyTable=historyTable, trapEmailErrAuth=trapEmailErrAuth, DisplayString=DisplayString, histCompVal=histCompVal, trapNTPError=trapNTPError, trapTempHighAlarm=trapTempHighAlarm, trapHumHighAlarm=trapHumHighAlarm, tempUnit=tempUnit, trapCompValClrAlarm=trapCompValClrAlarm, valuesInt=valuesInt, sensorName=sensorName, serialNumber=serialNumber, historyEntry=historyEntry, trapEmailErrDNS=trapEmailErrDNS, compValDelayInt=compValDelayInt, humMin=humMin, compValAlarmInt=compValAlarmInt, trapEmailErrLogin=trapEmailErrLogin, trapTempClrAlarm=trapTempClrAlarm, trapCompValError=trapCompValError, trapSOAPErrDelivery=trapSOAPErrDelivery, trapHumClrAlarm=trapHumClrAlarm, humUnit=humUnit, settings=settings, humInt=humInt, compValMin=compValMin, tempDelayInt=tempDelayInt, trapTest=trapTest, humAlarmInt=humAlarmInt, humLowInt=humLowInt, trapHumLowAlarm=trapHumLowAlarm, trapTempError=trapTempError, tempHighInt=tempHighInt, products=products, trapHumError=trapHumError, hum=hum, compValAlarm=compValAlarm, temp=temp, tempMax=tempMax, humDelayInt=humDelayInt, tempMin=tempMin, compValHystInt=compValHystInt, trapEmailErrSome=trapEmailErrSome, compValUnit=compValUnit, humHystInt=humHystInt, trapSOAPErrDNS=trapSOAPErrDNS, tempHystInt=tempHystInt, trapTempLowAlarm=trapTempLowAlarm, tempAlarmInt=tempAlarmInt, tempInt=tempInt, compValInt=compValInt, trapCompValLowAlarm=trapCompValLowAlarm, traps=traps, tables=tables, compVal=compVal, compValLowInt=compValLowInt, histTemp=histTemp, histHum=histHum, messageString=messageString, compValHighInt=compValHighInt, comet=comet, trapEmailErrSocket=trapEmailErrSocket, trapCompValHighAlarm=trapCompValHighAlarm, humAlarm=humAlarm, humMax=humMax, pysmi_global=pysmi_global, deviceType=deviceType, compValMax=compValMax, values=values, t3610=t3610)
