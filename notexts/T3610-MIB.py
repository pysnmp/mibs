...
# Produced by pysmi-1.1.8 at Thu Jan  5 09:53:41 2023
...
TimeTicks, NotificationType, enterprises, Unsigned32, Integer32, ObjectIdentity, Counter32, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, IpAddress, MibIdentifier, Counter64, ModuleIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "enterprises", "Unsigned32", "Integer32", "ObjectIdentity", "Counter32", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "IpAddress", "MibIdentifier", "Counter64", "ModuleIdentity", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", settings=settings, trapEmailErrSome=trapEmailErrSome, trapEmailErrLogin=trapEmailErrLogin, trapSOAPErrDelivery=trapSOAPErrDelivery, humHystInt=humHystInt, compValAlarmInt=compValAlarmInt, tempInt=tempInt, trapHumLowAlarm=trapHumLowAlarm, temp=temp, histTemp=histTemp, DisplayString=DisplayString, humDelayInt=humDelayInt, valuesInt=valuesInt, historyEntry=historyEntry, humAlarm=humAlarm, trapTest=trapTest, deviceType=deviceType, trapEmailErrDNS=trapEmailErrDNS, tempDelayInt=tempDelayInt, compValDelayInt=compValDelayInt, tempHystInt=tempHystInt, t3610=t3610, trapHumClrAlarm=trapHumClrAlarm, trapCompValHighAlarm=trapCompValHighAlarm, compValMax=compValMax, humLowInt=humLowInt, trapTempError=trapTempError, trapTempLowAlarm=trapTempLowAlarm, humUnit=humUnit, trapNTPError=trapNTPError, compValAlarm=compValAlarm, comet=comet, compValMin=compValMin, humAlarmInt=humAlarmInt, tempMax=tempMax, compValInt=compValInt, compValLowInt=compValLowInt, trapHumHighAlarm=trapHumHighAlarm, pysmi_global=pysmi_global, humInt=humInt, trapEmailErrSocket=trapEmailErrSocket, trapTempHighAlarm=trapTempHighAlarm, traps=traps, values=values, tempUnit=tempUnit, humHighInt=humHighInt, tables=tables, historyTable=historyTable, serialNumber=serialNumber, trapSOAPErrSocket=trapSOAPErrSocket, trapSOAPErrFile=trapSOAPErrFile, trapCompValClrAlarm=trapCompValClrAlarm, trapEmailErrAuth=trapEmailErrAuth, trapCompValLowAlarm=trapCompValLowAlarm, compVal=compVal, hum=hum, histHum=histHum, tempHighInt=tempHighInt, humMax=humMax, compValUnit=compValUnit, tempMin=tempMin, histCompVal=histCompVal, trapSOAPErrDNS=trapSOAPErrDNS, trapTempClrAlarm=trapTempClrAlarm, tempLowInt=tempLowInt, tempAlarmInt=tempAlarmInt, trapCompValError=trapCompValError, compValHighInt=compValHighInt, trapHumError=trapHumError, humMin=humMin, products=products, messageString=messageString, tempAlarm=tempAlarm, compValHystInt=compValHystInt, sensorName=sensorName)
