...
# Produced by pysmi-1.1.8 at Tue Sep 12 13:29:33 2023
...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ModuleIdentity, ObjectIdentity, NotificationType, IpAddress, TimeTicks, MibIdentifier, enterprises, iso, Unsigned32, Counter64, Gauge32, Integer32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ModuleIdentity", "ObjectIdentity", "NotificationType", "IpAddress", "TimeTicks", "MibIdentifier", "enterprises", "iso", "Unsigned32", "Counter64", "Gauge32", "Integer32", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", trapHumHighAlarm=trapHumHighAlarm, compValAlarm=compValAlarm, tempMin=tempMin, values=values, trapCompValHighAlarm=trapCompValHighAlarm, pysmi_global=pysmi_global, humMin=humMin, humAlarmInt=humAlarmInt, trapEmailErrLogin=trapEmailErrLogin, DisplayString=DisplayString, trapCompValClrAlarm=trapCompValClrAlarm, tempUnit=tempUnit, t3610=t3610, humUnit=humUnit, compValDelayInt=compValDelayInt, histHum=histHum, trapHumError=trapHumError, trapCompValLowAlarm=trapCompValLowAlarm, valuesInt=valuesInt, compValUnit=compValUnit, trapTempClrAlarm=trapTempClrAlarm, trapHumClrAlarm=trapHumClrAlarm, compValHystInt=compValHystInt, humAlarm=humAlarm, tempAlarmInt=tempAlarmInt, humHystInt=humHystInt, historyEntry=historyEntry, humHighInt=humHighInt, trapEmailErrDNS=trapEmailErrDNS, trapTempError=trapTempError, deviceType=deviceType, trapTest=trapTest, trapSOAPErrFile=trapSOAPErrFile, compValAlarmInt=compValAlarmInt, tempLowInt=tempLowInt, histCompVal=histCompVal, tempHighInt=tempHighInt, trapSOAPErrDNS=trapSOAPErrDNS, temp=temp, traps=traps, settings=settings, tables=tables, trapTempLowAlarm=trapTempLowAlarm, tempHystInt=tempHystInt, tempMax=tempMax, trapEmailErrSome=trapEmailErrSome, humMax=humMax, histTemp=histTemp, historyTable=historyTable, compVal=compVal, products=products, humInt=humInt, compValMin=compValMin, humLowInt=humLowInt, trapEmailErrAuth=trapEmailErrAuth, serialNumber=serialNumber, sensorName=sensorName, hum=hum, compValHighInt=compValHighInt, trapNTPError=trapNTPError, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrDelivery=trapSOAPErrDelivery, tempDelayInt=tempDelayInt, trapSOAPErrSocket=trapSOAPErrSocket, tempAlarm=tempAlarm, messageString=messageString, humDelayInt=humDelayInt, compValLowInt=compValLowInt, trapHumLowAlarm=trapHumLowAlarm, tempInt=tempInt, trapTempHighAlarm=trapTempHighAlarm, compValMax=compValMax, trapCompValError=trapCompValError, compValInt=compValInt, comet=comet)
