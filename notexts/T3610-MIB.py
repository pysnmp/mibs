...
# Produced by pysmi-1.1.3 at Sun Nov 28 14:38:52 2021
...
NotificationType, Gauge32, enterprises, IpAddress, MibIdentifier, Bits, NotificationType, TimeTicks, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, ModuleIdentity, Counter32, Counter64, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "enterprises", "IpAddress", "MibIdentifier", "Bits", "NotificationType", "TimeTicks", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "ModuleIdentity", "Counter32", "Counter64", "ObjectIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", compValAlarm=compValAlarm, humMax=humMax, humMin=humMin, tempHighInt=tempHighInt, tempHystInt=tempHystInt, compValHighInt=compValHighInt, trapSOAPErrFile=trapSOAPErrFile, temp=temp, serialNumber=serialNumber, trapHumError=trapHumError, historyEntry=historyEntry, trapTempError=trapTempError, tempAlarm=tempAlarm, t3610=t3610, trapEmailErrAuth=trapEmailErrAuth, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrDNS=trapSOAPErrDNS, tempAlarmInt=tempAlarmInt, trapTest=trapTest, trapEmailErrLogin=trapEmailErrLogin, trapTempHighAlarm=trapTempHighAlarm, tempLowInt=tempLowInt, histHum=histHum, hum=hum, compValMin=compValMin, compValLowInt=compValLowInt, histCompVal=histCompVal, trapSOAPErrDelivery=trapSOAPErrDelivery, valuesInt=valuesInt, compValInt=compValInt, humHighInt=humHighInt, tables=tables, trapEmailErrSome=trapEmailErrSome, comet=comet, DisplayString=DisplayString, humHystInt=humHystInt, trapHumHighAlarm=trapHumHighAlarm, historyTable=historyTable, trapEmailErrDNS=trapEmailErrDNS, compValMax=compValMax, trapSOAPErrSocket=trapSOAPErrSocket, trapHumClrAlarm=trapHumClrAlarm, tempMin=tempMin, tempInt=tempInt, trapNTPError=trapNTPError, trapTempClrAlarm=trapTempClrAlarm, humInt=humInt, trapHumLowAlarm=trapHumLowAlarm, settings=settings, compValUnit=compValUnit, messageString=messageString, sensorName=sensorName, trapCompValClrAlarm=trapCompValClrAlarm, humAlarmInt=humAlarmInt, deviceType=deviceType, tempUnit=tempUnit, trapCompValError=trapCompValError, trapCompValLowAlarm=trapCompValLowAlarm, humUnit=humUnit, values=values, tempDelayInt=tempDelayInt, humAlarm=humAlarm, humDelayInt=humDelayInt, tempMax=tempMax, compValDelayInt=compValDelayInt, trapCompValHighAlarm=trapCompValHighAlarm, trapTempLowAlarm=trapTempLowAlarm, humLowInt=humLowInt, pysmi_global=pysmi_global, histTemp=histTemp, compValHystInt=compValHystInt, compVal=compVal, products=products, compValAlarmInt=compValAlarmInt, traps=traps)
