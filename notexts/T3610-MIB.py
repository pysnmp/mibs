...
# Produced by pysmi-1.1.8 at Thu Sep  7 13:21:48 2023
...
Unsigned32, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress, MibIdentifier, Integer32, Counter64, enterprises, NotificationType, Gauge32, TimeTicks, ObjectIdentity, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress", "MibIdentifier", "Integer32", "Counter64", "enterprises", "NotificationType", "Gauge32", "TimeTicks", "ObjectIdentity", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("T3610-MIB", trapHumHighAlarm=trapHumHighAlarm, tempMax=tempMax, trapCompValLowAlarm=trapCompValLowAlarm, pysmi_global=pysmi_global, valuesInt=valuesInt, compValHystInt=compValHystInt, compValMax=compValMax, tempHighInt=tempHighInt, histHum=histHum, compValAlarmInt=compValAlarmInt, tables=tables, hum=hum, t3610=t3610, compValLowInt=compValLowInt, trapSOAPErrFile=trapSOAPErrFile, compValDelayInt=compValDelayInt, humHighInt=humHighInt, humLowInt=humLowInt, trapEmailErrSome=trapEmailErrSome, trapSOAPErrDelivery=trapSOAPErrDelivery, tempAlarm=tempAlarm, trapTempError=trapTempError, humHystInt=humHystInt, trapNTPError=trapNTPError, DisplayString=DisplayString, humMin=humMin, histTemp=histTemp, tempAlarmInt=tempAlarmInt, historyEntry=historyEntry, trapCompValHighAlarm=trapCompValHighAlarm, tempUnit=tempUnit, compValUnit=compValUnit, tempLowInt=tempLowInt, compVal=compVal, humInt=humInt, compValAlarm=compValAlarm, values=values, compValInt=compValInt, trapEmailErrAuth=trapEmailErrAuth, trapTempClrAlarm=trapTempClrAlarm, tempDelayInt=tempDelayInt, trapTest=trapTest, humAlarm=humAlarm, compValMin=compValMin, tempMin=tempMin, comet=comet, trapSOAPErrDNS=trapSOAPErrDNS, trapTempLowAlarm=trapTempLowAlarm, trapCompValClrAlarm=trapCompValClrAlarm, serialNumber=serialNumber, products=products, humMax=humMax, trapSOAPErrSocket=trapSOAPErrSocket, humAlarmInt=humAlarmInt, histCompVal=histCompVal, sensorName=sensorName, trapHumClrAlarm=trapHumClrAlarm, temp=temp, compValHighInt=compValHighInt, trapHumError=trapHumError, trapCompValError=trapCompValError, tempInt=tempInt, humUnit=humUnit, trapTempHighAlarm=trapTempHighAlarm, trapEmailErrLogin=trapEmailErrLogin, traps=traps, trapEmailErrSocket=trapEmailErrSocket, tempHystInt=tempHystInt, deviceType=deviceType, historyTable=historyTable, trapHumLowAlarm=trapHumLowAlarm, humDelayInt=humDelayInt, trapEmailErrDNS=trapEmailErrDNS, settings=settings, messageString=messageString)
