...
# Produced by pysmi-1.1.12 at Mon Jun  3 03:01:24 2024
...
MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32, Gauge32, NotificationType, ObjectIdentity, Bits, enterprises, NotificationType, Counter64, IpAddress, TimeTicks, ModuleIdentity, iso, Counter32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32", "Gauge32", "NotificationType", "ObjectIdentity", "Bits", "enterprises", "NotificationType", "Counter64", "IpAddress", "TimeTicks", "ModuleIdentity", "iso", "Counter32", "Unsigned32")
...
mibBuilder.exportSymbols("T3610-MIB", tempDelayInt=tempDelayInt, trapTempError=trapTempError, compValMin=compValMin, tempAlarm=tempAlarm, tempMin=tempMin, compValInt=compValInt, humAlarmInt=humAlarmInt, hum=hum, tempAlarmInt=tempAlarmInt, sensorName=sensorName, trapSOAPErrDNS=trapSOAPErrDNS, pysmi_global=pysmi_global, trapTempLowAlarm=trapTempLowAlarm, traps=traps, humHighInt=humHighInt, tempHighInt=tempHighInt, humInt=humInt, compValHystInt=compValHystInt, trapEmailErrDNS=trapEmailErrDNS, products=products, tempInt=tempInt, compValAlarmInt=compValAlarmInt, compValLowInt=compValLowInt, humDelayInt=humDelayInt, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValClrAlarm=trapCompValClrAlarm, tempMax=tempMax, humMin=humMin, trapCompValLowAlarm=trapCompValLowAlarm, trapHumError=trapHumError, compValDelayInt=compValDelayInt, trapHumLowAlarm=trapHumLowAlarm, comet=comet, trapEmailErrSome=trapEmailErrSome, compValMax=compValMax, humMax=humMax, trapEmailErrLogin=trapEmailErrLogin, trapEmailErrAuth=trapEmailErrAuth, settings=settings, humAlarm=humAlarm, compValAlarm=compValAlarm, messageString=messageString, serialNumber=serialNumber, deviceType=deviceType, humLowInt=humLowInt, tempHystInt=tempHystInt, trapSOAPErrFile=trapSOAPErrFile, humUnit=humUnit, trapSOAPErrDelivery=trapSOAPErrDelivery, trapEmailErrSocket=trapEmailErrSocket, trapHumHighAlarm=trapHumHighAlarm, trapHumClrAlarm=trapHumClrAlarm, histHum=histHum, historyEntry=historyEntry, trapNTPError=trapNTPError, trapCompValError=trapCompValError, compValHighInt=compValHighInt, t3610=t3610, humHystInt=humHystInt, historyTable=historyTable, valuesInt=valuesInt, values=values, compVal=compVal, tempUnit=tempUnit, DisplayString=DisplayString, trapTempHighAlarm=trapTempHighAlarm, trapCompValHighAlarm=trapCompValHighAlarm, histCompVal=histCompVal, trapTest=trapTest, trapTempClrAlarm=trapTempClrAlarm, tables=tables, histTemp=histTemp, temp=temp, compValUnit=compValUnit, tempLowInt=tempLowInt)
