...
Bits, ModuleIdentity, NotificationType, TimeTicks, ObjectIdentity, MibIdentifier, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, IpAddress, iso, Integer32, Gauge32, enterprises, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "NotificationType", "TimeTicks", "ObjectIdentity", "MibIdentifier", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "IpAddress", "iso", "Integer32", "Gauge32", "enterprises", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", histHum=histHum, trapNTPError=trapNTPError, tables=tables, compValHighInt=compValHighInt, humLowInt=humLowInt, messageString=messageString, tempHighInt=tempHighInt, humAlarmInt=humAlarmInt, comet=comet, temp=temp, humHighInt=humHighInt, t3610=t3610, compValDelayInt=compValDelayInt, tempMin=tempMin, tempUnit=tempUnit, humAlarm=humAlarm, trapEmailErrLogin=trapEmailErrLogin, trapCompValError=trapCompValError, trapCompValLowAlarm=trapCompValLowAlarm, tempAlarmInt=tempAlarmInt, histCompVal=histCompVal, humMin=humMin, sensorName=sensorName, trapEmailErrAuth=trapEmailErrAuth, humHystInt=humHystInt, trapTempError=trapTempError, serialNumber=serialNumber, compValAlarmInt=compValAlarmInt, compValLowInt=compValLowInt, trapHumHighAlarm=trapHumHighAlarm, trapCompValHighAlarm=trapCompValHighAlarm, historyEntry=historyEntry, humMax=humMax, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrFile=trapSOAPErrFile, trapTempLowAlarm=trapTempLowAlarm, pysmi_global=pysmi_global, trapTempHighAlarm=trapTempHighAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, trapEmailErrDNS=trapEmailErrDNS, valuesInt=valuesInt, compValAlarm=compValAlarm, humUnit=humUnit, tempHystInt=tempHystInt, compValUnit=compValUnit, values=values, settings=settings, hum=hum, historyTable=historyTable, humDelayInt=humDelayInt, trapSOAPErrDNS=trapSOAPErrDNS, trapSOAPErrSocket=trapSOAPErrSocket, trapHumLowAlarm=trapHumLowAlarm, trapCompValClrAlarm=trapCompValClrAlarm, trapHumClrAlarm=trapHumClrAlarm, compVal=compVal, trapHumError=trapHumError, tempAlarm=tempAlarm, humInt=humInt, tempLowInt=tempLowInt, traps=traps, tempMax=tempMax, trapTest=trapTest, compValMin=compValMin, compValMax=compValMax, compValInt=compValInt, products=products, trapTempClrAlarm=trapTempClrAlarm, tempInt=tempInt, compValHystInt=compValHystInt, tempDelayInt=tempDelayInt, trapEmailErrSome=trapEmailErrSome, DisplayString=DisplayString, deviceType=deviceType, histTemp=histTemp)
