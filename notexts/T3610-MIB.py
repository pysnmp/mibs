...
# Produced by pysmi-1.1.8 at Fri Jan 27 13:53:39 2023
...
TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ObjectIdentity, Bits, Counter32, IpAddress, ModuleIdentity, Counter64, Gauge32, Unsigned32, enterprises, iso, MibIdentifier, NotificationType, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ObjectIdentity", "Bits", "Counter32", "IpAddress", "ModuleIdentity", "Counter64", "Gauge32", "Unsigned32", "enterprises", "iso", "MibIdentifier", "NotificationType", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", humHystInt=humHystInt, deviceType=deviceType, traps=traps, humLowInt=humLowInt, humDelayInt=humDelayInt, trapEmailErrAuth=trapEmailErrAuth, trapCompValError=trapCompValError, sensorName=sensorName, pysmi_global=pysmi_global, humAlarm=humAlarm, trapEmailErrSocket=trapEmailErrSocket, tempAlarm=tempAlarm, hum=hum, compValMin=compValMin, trapHumHighAlarm=trapHumHighAlarm, trapHumClrAlarm=trapHumClrAlarm, comet=comet, products=products, humMax=humMax, trapHumError=trapHumError, compValMax=compValMax, trapEmailErrDNS=trapEmailErrDNS, compValInt=compValInt, trapEmailErrLogin=trapEmailErrLogin, trapSOAPErrFile=trapSOAPErrFile, humAlarmInt=humAlarmInt, humMin=humMin, trapCompValHighAlarm=trapCompValHighAlarm, DisplayString=DisplayString, tempMax=tempMax, historyTable=historyTable, historyEntry=historyEntry, compValDelayInt=compValDelayInt, trapTempLowAlarm=trapTempLowAlarm, values=values, compValAlarm=compValAlarm, trapSOAPErrDNS=trapSOAPErrDNS, humUnit=humUnit, compValLowInt=compValLowInt, trapTempHighAlarm=trapTempHighAlarm, trapHumLowAlarm=trapHumLowAlarm, settings=settings, humHighInt=humHighInt, trapCompValLowAlarm=trapCompValLowAlarm, histTemp=histTemp, serialNumber=serialNumber, tempInt=tempInt, tempUnit=tempUnit, trapTest=trapTest, tempMin=tempMin, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValClrAlarm=trapCompValClrAlarm, trapNTPError=trapNTPError, tempDelayInt=tempDelayInt, messageString=messageString, tempAlarmInt=tempAlarmInt, trapSOAPErrDelivery=trapSOAPErrDelivery, compVal=compVal, histHum=histHum, tables=tables, histCompVal=histCompVal, compValHystInt=compValHystInt, tempLowInt=tempLowInt, tempHighInt=tempHighInt, trapTempError=trapTempError, valuesInt=valuesInt, trapTempClrAlarm=trapTempClrAlarm, t3610=t3610, compValUnit=compValUnit, compValAlarmInt=compValAlarmInt, compValHighInt=compValHighInt, humInt=humInt, tempHystInt=tempHystInt, temp=temp, trapEmailErrSome=trapEmailErrSome)
