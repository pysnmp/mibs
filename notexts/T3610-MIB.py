...
# Produced by pysmi-1.1.8 at Thu Sep  7 11:38:37 2023
...
NotificationType, Integer32, NotificationType, Unsigned32, Gauge32, IpAddress, MibIdentifier, Bits, Counter32, ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, enterprises, Counter64, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "NotificationType", "Unsigned32", "Gauge32", "IpAddress", "MibIdentifier", "Bits", "Counter32", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "enterprises", "Counter64", "ObjectIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", trapTempClrAlarm=trapTempClrAlarm, trapEmailErrDNS=trapEmailErrDNS, trapHumClrAlarm=trapHumClrAlarm, products=products, compValUnit=compValUnit, trapTempLowAlarm=trapTempLowAlarm, compValMin=compValMin, trapTest=trapTest, tables=tables, serialNumber=serialNumber, trapHumHighAlarm=trapHumHighAlarm, comet=comet, settings=settings, humAlarm=humAlarm, sensorName=sensorName, histHum=histHum, histCompVal=histCompVal, humInt=humInt, compValDelayInt=compValDelayInt, trapEmailErrLogin=trapEmailErrLogin, trapCompValHighAlarm=trapCompValHighAlarm, compValInt=compValInt, trapNTPError=trapNTPError, trapTempHighAlarm=trapTempHighAlarm, trapSOAPErrSocket=trapSOAPErrSocket, compValAlarmInt=compValAlarmInt, humMin=humMin, valuesInt=valuesInt, temp=temp, humLowInt=humLowInt, tempDelayInt=tempDelayInt, tempHystInt=tempHystInt, humHystInt=humHystInt, values=values, compVal=compVal, trapCompValClrAlarm=trapCompValClrAlarm, compValAlarm=compValAlarm, tempMax=tempMax, trapHumError=trapHumError, trapHumLowAlarm=trapHumLowAlarm, tempMin=tempMin, tempUnit=tempUnit, DisplayString=DisplayString, tempLowInt=tempLowInt, trapSOAPErrFile=trapSOAPErrFile, trapSOAPErrDelivery=trapSOAPErrDelivery, hum=hum, t3610=t3610, tempAlarmInt=tempAlarmInt, humUnit=humUnit, traps=traps, tempInt=tempInt, compValLowInt=compValLowInt, messageString=messageString, historyEntry=historyEntry, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrDNS=trapSOAPErrDNS, historyTable=historyTable, humAlarmInt=humAlarmInt, trapEmailErrSocket=trapEmailErrSocket, trapCompValLowAlarm=trapCompValLowAlarm, trapTempError=trapTempError, tempAlarm=tempAlarm, trapEmailErrSome=trapEmailErrSome, pysmi_global=pysmi_global, trapCompValError=trapCompValError, tempHighInt=tempHighInt, compValMax=compValMax, humDelayInt=humDelayInt, histTemp=histTemp, deviceType=deviceType, humHighInt=humHighInt, compValHystInt=compValHystInt, compValHighInt=compValHighInt, humMax=humMax)
