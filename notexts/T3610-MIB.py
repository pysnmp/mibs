...
# Produced by pysmi-1.1.12 at Fri Nov 22 15:37:08 2024
...
Bits, NotificationType, NotificationType, enterprises, TimeTicks, Unsigned32, ModuleIdentity, ObjectIdentity, Counter64, IpAddress, Integer32, Counter32, MibIdentifier, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "NotificationType", "enterprises", "TimeTicks", "Unsigned32", "ModuleIdentity", "ObjectIdentity", "Counter64", "IpAddress", "Integer32", "Counter32", "MibIdentifier", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso")
...
mibBuilder.exportSymbols("T3610-MIB", humDelayInt=humDelayInt, values=values, historyTable=historyTable, tempDelayInt=tempDelayInt, tempAlarmInt=tempAlarmInt, histHum=histHum, humAlarm=humAlarm, tempUnit=tempUnit, compValInt=compValInt, humAlarmInt=humAlarmInt, trapHumHighAlarm=trapHumHighAlarm, trapHumClrAlarm=trapHumClrAlarm, pysmi_global=pysmi_global, tempMin=tempMin, trapEmailErrDNS=trapEmailErrDNS, hum=hum, trapCompValLowAlarm=trapCompValLowAlarm, trapTempError=trapTempError, trapCompValClrAlarm=trapCompValClrAlarm, messageString=messageString, histCompVal=histCompVal, trapSOAPErrFile=trapSOAPErrFile, trapTempClrAlarm=trapTempClrAlarm, comet=comet, humMax=humMax, deviceType=deviceType, humInt=humInt, tempLowInt=tempLowInt, compValHystInt=compValHystInt, traps=traps, trapSOAPErrDNS=trapSOAPErrDNS, tempHighInt=tempHighInt, temp=temp, t3610=t3610, compValHighInt=compValHighInt, compValMax=compValMax, compValAlarm=compValAlarm, products=products, settings=settings, sensorName=sensorName, humHystInt=humHystInt, trapTempLowAlarm=trapTempLowAlarm, trapHumLowAlarm=trapHumLowAlarm, trapHumError=trapHumError, historyEntry=historyEntry, trapEmailErrAuth=trapEmailErrAuth, compValMin=compValMin, trapEmailErrSocket=trapEmailErrSocket, tempAlarm=tempAlarm, trapTempHighAlarm=trapTempHighAlarm, trapEmailErrLogin=trapEmailErrLogin, trapCompValHighAlarm=trapCompValHighAlarm, tempInt=tempInt, serialNumber=serialNumber, trapSOAPErrSocket=trapSOAPErrSocket, DisplayString=DisplayString, compValUnit=compValUnit, tables=tables, trapNTPError=trapNTPError, trapTest=trapTest, trapEmailErrSome=trapEmailErrSome, compValLowInt=compValLowInt, histTemp=histTemp, valuesInt=valuesInt, humUnit=humUnit, tempMax=tempMax, humHighInt=humHighInt, humLowInt=humLowInt, compValDelayInt=compValDelayInt, trapSOAPErrDelivery=trapSOAPErrDelivery, compVal=compVal, trapCompValError=trapCompValError, humMin=humMin, tempHystInt=tempHystInt, compValAlarmInt=compValAlarmInt)
