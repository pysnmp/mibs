...
# Produced by pysmi-1.1.8 at Wed Sep 13 14:52:27 2023
...
Gauge32, Counter64, Bits, Unsigned32, enterprises, ModuleIdentity, MibIdentifier, ObjectIdentity, Integer32, TimeTicks, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, NotificationType, IpAddress, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter64", "Bits", "Unsigned32", "enterprises", "ModuleIdentity", "MibIdentifier", "ObjectIdentity", "Integer32", "TimeTicks", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "NotificationType", "IpAddress", "Counter32")
...
mibBuilder.exportSymbols("T3610-MIB", humInt=humInt, tempDelayInt=tempDelayInt, trapTempError=trapTempError, trapTest=trapTest, trapSOAPErrSocket=trapSOAPErrSocket, trapHumLowAlarm=trapHumLowAlarm, trapEmailErrAuth=trapEmailErrAuth, compValAlarm=compValAlarm, humMin=humMin, trapCompValClrAlarm=trapCompValClrAlarm, comet=comet, serialNumber=serialNumber, compValHighInt=compValHighInt, trapSOAPErrDNS=trapSOAPErrDNS, tables=tables, tempAlarm=tempAlarm, humAlarm=humAlarm, tempAlarmInt=tempAlarmInt, trapCompValHighAlarm=trapCompValHighAlarm, sensorName=sensorName, deviceType=deviceType, compVal=compVal, hum=hum, compValUnit=compValUnit, DisplayString=DisplayString, trapEmailErrSocket=trapEmailErrSocket, histCompVal=histCompVal, tempHighInt=tempHighInt, trapHumHighAlarm=trapHumHighAlarm, compValAlarmInt=compValAlarmInt, tempMin=tempMin, histTemp=histTemp, trapTempClrAlarm=trapTempClrAlarm, humAlarmInt=humAlarmInt, compValHystInt=compValHystInt, trapHumError=trapHumError, histHum=histHum, trapEmailErrLogin=trapEmailErrLogin, humLowInt=humLowInt, trapTempLowAlarm=trapTempLowAlarm, humUnit=humUnit, trapNTPError=trapNTPError, tempInt=tempInt, trapEmailErrDNS=trapEmailErrDNS, humHystInt=humHystInt, humDelayInt=humDelayInt, messageString=messageString, compValMin=compValMin, temp=temp, trapTempHighAlarm=trapTempHighAlarm, trapCompValLowAlarm=trapCompValLowAlarm, tempUnit=tempUnit, t3610=t3610, trapHumClrAlarm=trapHumClrAlarm, compValMax=compValMax, tempMax=tempMax, trapSOAPErrFile=trapSOAPErrFile, traps=traps, compValInt=compValInt, products=products, trapSOAPErrDelivery=trapSOAPErrDelivery, humMax=humMax, historyTable=historyTable, valuesInt=valuesInt, settings=settings, compValLowInt=compValLowInt, tempHystInt=tempHystInt, trapEmailErrSome=trapEmailErrSome, values=values, pysmi_global=pysmi_global, compValDelayInt=compValDelayInt, tempLowInt=tempLowInt, humHighInt=humHighInt, historyEntry=historyEntry, trapCompValError=trapCompValError)
