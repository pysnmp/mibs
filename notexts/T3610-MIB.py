...
# Produced by pysmi-1.1.12 at Fri Apr 12 00:25:44 2024
...
iso, enterprises, MibIdentifier, ModuleIdentity, Integer32, Bits, NotificationType, TimeTicks, Counter64, Unsigned32, ObjectIdentity, IpAddress, NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "enterprises", "MibIdentifier", "ModuleIdentity", "Integer32", "Bits", "NotificationType", "TimeTicks", "Counter64", "Unsigned32", "ObjectIdentity", "IpAddress", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32")
...
mibBuilder.exportSymbols("T3610-MIB", trapHumClrAlarm=trapHumClrAlarm, trapCompValLowAlarm=trapCompValLowAlarm, humAlarm=humAlarm, humHighInt=humHighInt, compValHighInt=compValHighInt, humHystInt=humHystInt, compValDelayInt=compValDelayInt, comet=comet, tempMin=tempMin, trapHumLowAlarm=trapHumLowAlarm, tables=tables, tempUnit=tempUnit, humMax=humMax, compValAlarm=compValAlarm, valuesInt=valuesInt, hum=hum, pysmi_global=pysmi_global, histHum=histHum, humInt=humInt, trapHumHighAlarm=trapHumHighAlarm, sensorName=sensorName, compValInt=compValInt, t3610=t3610, tempMax=tempMax, trapHumError=trapHumError, humLowInt=humLowInt, trapSOAPErrDNS=trapSOAPErrDNS, trapTempHighAlarm=trapTempHighAlarm, compValMin=compValMin, compValLowInt=compValLowInt, trapTempError=trapTempError, traps=traps, tempAlarmInt=tempAlarmInt, tempInt=tempInt, messageString=messageString, compValUnit=compValUnit, trapTempLowAlarm=trapTempLowAlarm, trapEmailErrLogin=trapEmailErrLogin, histTemp=histTemp, humMin=humMin, compValAlarmInt=compValAlarmInt, serialNumber=serialNumber, trapCompValError=trapCompValError, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValHighAlarm=trapCompValHighAlarm, compValHystInt=compValHystInt, historyEntry=historyEntry, trapTempClrAlarm=trapTempClrAlarm, trapEmailErrSome=trapEmailErrSome, trapSOAPErrFile=trapSOAPErrFile, tempLowInt=tempLowInt, settings=settings, deviceType=deviceType, historyTable=historyTable, humAlarmInt=humAlarmInt, trapTest=trapTest, DisplayString=DisplayString, values=values, trapEmailErrAuth=trapEmailErrAuth, tempAlarm=tempAlarm, trapEmailErrDNS=trapEmailErrDNS, trapSOAPErrDelivery=trapSOAPErrDelivery, humDelayInt=humDelayInt, tempDelayInt=tempDelayInt, compVal=compVal, trapNTPError=trapNTPError, temp=temp, tempHighInt=tempHighInt, tempHystInt=tempHystInt, trapCompValClrAlarm=trapCompValClrAlarm, compValMax=compValMax, products=products, trapEmailErrSocket=trapEmailErrSocket, histCompVal=histCompVal, humUnit=humUnit)
