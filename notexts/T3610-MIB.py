...
# Produced by pysmi-1.1.3 at Sun Nov 28 21:25:39 2021
...
Bits, IpAddress, Counter64, enterprises, ObjectIdentity, iso, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity, MibIdentifier, Integer32, NotificationType, NotificationType, Counter32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "Counter64", "enterprises", "ObjectIdentity", "iso", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity", "MibIdentifier", "Integer32", "NotificationType", "NotificationType", "Counter32", "TimeTicks")
...
mibBuilder.exportSymbols("T3610-MIB", humDelayInt=humDelayInt, compValAlarm=compValAlarm, compValAlarmInt=compValAlarmInt, trapTempClrAlarm=trapTempClrAlarm, t3610=t3610, compValInt=compValInt, comet=comet, trapEmailErrLogin=trapEmailErrLogin, trapHumLowAlarm=trapHumLowAlarm, tempUnit=tempUnit, values=values, products=products, historyTable=historyTable, trapCompValError=trapCompValError, trapSOAPErrDNS=trapSOAPErrDNS, valuesInt=valuesInt, settings=settings, trapNTPError=trapNTPError, trapCompValClrAlarm=trapCompValClrAlarm, trapTempLowAlarm=trapTempLowAlarm, histTemp=histTemp, trapSOAPErrFile=trapSOAPErrFile, deviceType=deviceType, humMin=humMin, humLowInt=humLowInt, tempInt=tempInt, trapCompValLowAlarm=trapCompValLowAlarm, hum=hum, compVal=compVal, tempAlarm=tempAlarm, tempMin=tempMin, DisplayString=DisplayString, humUnit=humUnit, messageString=messageString, humHighInt=humHighInt, trapTest=trapTest, tables=tables, histHum=histHum, compValDelayInt=compValDelayInt, trapEmailErrSome=trapEmailErrSome, trapHumHighAlarm=trapHumHighAlarm, traps=traps, humAlarmInt=humAlarmInt, humInt=humInt, sensorName=sensorName, compValLowInt=compValLowInt, compValHystInt=compValHystInt, serialNumber=serialNumber, compValMax=compValMax, histCompVal=histCompVal, tempLowInt=tempLowInt, trapHumClrAlarm=trapHumClrAlarm, humAlarm=humAlarm, trapHumError=trapHumError, humHystInt=humHystInt, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrSocket=trapSOAPErrSocket, humMax=humMax, tempHystInt=tempHystInt, trapEmailErrSocket=trapEmailErrSocket, tempMax=tempMax, compValHighInt=compValHighInt, trapEmailErrDNS=trapEmailErrDNS, compValUnit=compValUnit, tempHighInt=tempHighInt, compValMin=compValMin, trapTempHighAlarm=trapTempHighAlarm, pysmi_global=pysmi_global, trapCompValHighAlarm=trapCompValHighAlarm, tempAlarmInt=tempAlarmInt, tempDelayInt=tempDelayInt, temp=temp, historyEntry=historyEntry, trapTempError=trapTempError, trapSOAPErrDelivery=trapSOAPErrDelivery)
