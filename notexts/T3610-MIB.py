...
# Produced by pysmi-1.1.12 at Tue May 28 12:46:21 2024
...
ModuleIdentity, Counter64, Unsigned32, Gauge32, MibIdentifier, Bits, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, NotificationType, IpAddress, NotificationType, TimeTicks, Integer32, enterprises, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Unsigned32", "Gauge32", "MibIdentifier", "Bits", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "NotificationType", "IpAddress", "NotificationType", "TimeTicks", "Integer32", "enterprises", "iso")
...
mibBuilder.exportSymbols("T3610-MIB", tempAlarmInt=tempAlarmInt, values=values, sensorName=sensorName, tempHighInt=tempHighInt, deviceType=deviceType, tempDelayInt=tempDelayInt, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrDNS=trapSOAPErrDNS, trapSOAPErrDelivery=trapSOAPErrDelivery, trapCompValLowAlarm=trapCompValLowAlarm, trapTempError=trapTempError, DisplayString=DisplayString, humHighInt=humHighInt, humInt=humInt, compValDelayInt=compValDelayInt, tempHystInt=tempHystInt, compValAlarm=compValAlarm, t3610=t3610, tempAlarm=tempAlarm, humUnit=humUnit, tempMax=tempMax, compValInt=compValInt, histCompVal=histCompVal, trapSOAPErrFile=trapSOAPErrFile, humMax=humMax, trapTempClrAlarm=trapTempClrAlarm, trapHumError=trapHumError, compValUnit=compValUnit, compValHighInt=compValHighInt, tempInt=tempInt, compValMax=compValMax, trapTempHighAlarm=trapTempHighAlarm, trapHumClrAlarm=trapHumClrAlarm, compValAlarmInt=compValAlarmInt, trapHumHighAlarm=trapHumHighAlarm, tempUnit=tempUnit, compValMin=compValMin, trapCompValClrAlarm=trapCompValClrAlarm, settings=settings, products=products, historyTable=historyTable, tempLowInt=tempLowInt, trapEmailErrDNS=trapEmailErrDNS, trapSOAPErrSocket=trapSOAPErrSocket, humHystInt=humHystInt, trapNTPError=trapNTPError, traps=traps, compValLowInt=compValLowInt, trapEmailErrLogin=trapEmailErrLogin, trapHumLowAlarm=trapHumLowAlarm, trapEmailErrSome=trapEmailErrSome, trapTempLowAlarm=trapTempLowAlarm, humLowInt=humLowInt, compValHystInt=compValHystInt, trapCompValError=trapCompValError, valuesInt=valuesInt, histTemp=histTemp, trapTest=trapTest, compVal=compVal, trapEmailErrSocket=trapEmailErrSocket, messageString=messageString, pysmi_global=pysmi_global, comet=comet, tables=tables, temp=temp, hum=hum, trapCompValHighAlarm=trapCompValHighAlarm, humAlarmInt=humAlarmInt, humMin=humMin, humDelayInt=humDelayInt, histHum=histHum, tempMin=tempMin, humAlarm=humAlarm, historyEntry=historyEntry, serialNumber=serialNumber)
