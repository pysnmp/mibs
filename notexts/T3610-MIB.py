...
# Produced by pysmi-1.1.8 at Sat Jan 15 17:16:15 2022
...
Counter32, Integer32, IpAddress, Bits, MibIdentifier, Counter64, ModuleIdentity, Unsigned32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity, enterprises, NotificationType, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "IpAddress", "Bits", "MibIdentifier", "Counter64", "ModuleIdentity", "Unsigned32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity", "enterprises", "NotificationType", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", humHystInt=humHystInt, compValLowInt=compValLowInt, settings=settings, trapCompValClrAlarm=trapCompValClrAlarm, tempInt=tempInt, humMax=humMax, trapTempError=trapTempError, trapHumError=trapHumError, compValUnit=compValUnit, trapTempClrAlarm=trapTempClrAlarm, trapTempHighAlarm=trapTempHighAlarm, humAlarm=humAlarm, histTemp=histTemp, values=values, trapEmailErrAuth=trapEmailErrAuth, trapCompValHighAlarm=trapCompValHighAlarm, compVal=compVal, products=products, tempLowInt=tempLowInt, pysmi_global=pysmi_global, sensorName=sensorName, compValHighInt=compValHighInt, compValInt=compValInt, trapTempLowAlarm=trapTempLowAlarm, trapSOAPErrDNS=trapSOAPErrDNS, serialNumber=serialNumber, tempDelayInt=tempDelayInt, compValMax=compValMax, tempHighInt=tempHighInt, humLowInt=humLowInt, humUnit=humUnit, comet=comet, t3610=t3610, tempMin=tempMin, trapSOAPErrFile=trapSOAPErrFile, trapEmailErrLogin=trapEmailErrLogin, compValDelayInt=compValDelayInt, tables=tables, temp=temp, DisplayString=DisplayString, tempHystInt=tempHystInt, historyEntry=historyEntry, humHighInt=humHighInt, trapEmailErrDNS=trapEmailErrDNS, compValMin=compValMin, trapNTPError=trapNTPError, trapSOAPErrSocket=trapSOAPErrSocket, hum=hum, trapHumClrAlarm=trapHumClrAlarm, compValAlarmInt=compValAlarmInt, humMin=humMin, messageString=messageString, trapHumLowAlarm=trapHumLowAlarm, valuesInt=valuesInt, trapTest=trapTest, traps=traps, deviceType=deviceType, trapHumHighAlarm=trapHumHighAlarm, tempMax=tempMax, humInt=humInt, historyTable=historyTable, trapCompValLowAlarm=trapCompValLowAlarm, trapCompValError=trapCompValError, compValHystInt=compValHystInt, trapEmailErrSome=trapEmailErrSome, trapSOAPErrDelivery=trapSOAPErrDelivery, tempAlarmInt=tempAlarmInt, trapEmailErrSocket=trapEmailErrSocket, histHum=histHum, humAlarmInt=humAlarmInt, humDelayInt=humDelayInt, histCompVal=histCompVal, tempUnit=tempUnit, tempAlarm=tempAlarm, compValAlarm=compValAlarm)
