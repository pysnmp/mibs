...
# Produced by pysmi-1.1.8 at Thu Feb  9 13:54:33 2023
...
ObjectIdentity, enterprises, Counter32, TimeTicks, Unsigned32, ModuleIdentity, Integer32, MibIdentifier, NotificationType, Counter64, iso, Gauge32, Bits, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "enterprises", "Counter32", "TimeTicks", "Unsigned32", "ModuleIdentity", "Integer32", "MibIdentifier", "NotificationType", "Counter64", "iso", "Gauge32", "Bits", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("T3610-MIB", compVal=compVal, temp=temp, humMax=humMax, valuesInt=valuesInt, trapCompValClrAlarm=trapCompValClrAlarm, traps=traps, serialNumber=serialNumber, humHighInt=humHighInt, humInt=humInt, humHystInt=humHystInt, compValMax=compValMax, historyEntry=historyEntry, histTemp=histTemp, trapEmailErrSome=trapEmailErrSome, trapTempError=trapTempError, trapTempHighAlarm=trapTempHighAlarm, trapHumHighAlarm=trapHumHighAlarm, pysmi_global=pysmi_global, tempHystInt=tempHystInt, trapTempClrAlarm=trapTempClrAlarm, trapSOAPErrDNS=trapSOAPErrDNS, compValMin=compValMin, compValInt=compValInt, tempMin=tempMin, trapTest=trapTest, histCompVal=histCompVal, trapEmailErrDNS=trapEmailErrDNS, tables=tables, humAlarm=humAlarm, tempMax=tempMax, tempHighInt=tempHighInt, compValDelayInt=compValDelayInt, trapEmailErrSocket=trapEmailErrSocket, compValHighInt=compValHighInt, trapCompValLowAlarm=trapCompValLowAlarm, trapCompValError=trapCompValError, trapHumClrAlarm=trapHumClrAlarm, historyTable=historyTable, compValHystInt=compValHystInt, compValLowInt=compValLowInt, t3610=t3610, messageString=messageString, trapEmailErrAuth=trapEmailErrAuth, trapCompValHighAlarm=trapCompValHighAlarm, tempLowInt=tempLowInt, trapHumError=trapHumError, sensorName=sensorName, values=values, settings=settings, humUnit=humUnit, trapSOAPErrDelivery=trapSOAPErrDelivery, hum=hum, comet=comet, tempAlarm=tempAlarm, DisplayString=DisplayString, trapSOAPErrSocket=trapSOAPErrSocket, trapTempLowAlarm=trapTempLowAlarm, trapSOAPErrFile=trapSOAPErrFile, tempUnit=tempUnit, compValAlarm=compValAlarm, humAlarmInt=humAlarmInt, products=products, compValAlarmInt=compValAlarmInt, humLowInt=humLowInt, humDelayInt=humDelayInt, trapEmailErrLogin=trapEmailErrLogin, tempDelayInt=tempDelayInt, deviceType=deviceType, histHum=histHum, trapNTPError=trapNTPError, trapHumLowAlarm=trapHumLowAlarm, tempAlarmInt=tempAlarmInt, tempInt=tempInt, compValUnit=compValUnit, humMin=humMin)
