...
# Produced by pysmi-1.1.11 at Wed Apr  3 13:56:32 2024
...
IpAddress, enterprises, NotificationType, Gauge32, ObjectIdentity, NotificationType, ModuleIdentity, Unsigned32, Bits, Counter64, Counter32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, iso, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "enterprises", "NotificationType", "Gauge32", "ObjectIdentity", "NotificationType", "ModuleIdentity", "Unsigned32", "Bits", "Counter64", "Counter32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "iso", "MibIdentifier")
...
mibBuilder.exportSymbols("T3610-MIB", tempInt=tempInt, pysmi_global=pysmi_global, compValAlarm=compValAlarm, trapEmailErrDNS=trapEmailErrDNS, trapNTPError=trapNTPError, values=values, humDelayInt=humDelayInt, compVal=compVal, tempAlarm=tempAlarm, temp=temp, historyEntry=historyEntry, trapHumClrAlarm=trapHumClrAlarm, humAlarmInt=humAlarmInt, humLowInt=humLowInt, trapTempHighAlarm=trapTempHighAlarm, t3610=t3610, trapEmailErrAuth=trapEmailErrAuth, tempAlarmInt=tempAlarmInt, compValLowInt=compValLowInt, tempMax=tempMax, compValHystInt=compValHystInt, trapTest=trapTest, tables=tables, tempMin=tempMin, traps=traps, histCompVal=histCompVal, trapEmailErrSocket=trapEmailErrSocket, comet=comet, compValAlarmInt=compValAlarmInt, tempHighInt=tempHighInt, trapSOAPErrDelivery=trapSOAPErrDelivery, tempLowInt=tempLowInt, humHystInt=humHystInt, trapHumHighAlarm=trapHumHighAlarm, trapHumLowAlarm=trapHumLowAlarm, valuesInt=valuesInt, trapCompValLowAlarm=trapCompValLowAlarm, DisplayString=DisplayString, humMin=humMin, trapCompValClrAlarm=trapCompValClrAlarm, historyTable=historyTable, tempUnit=tempUnit, deviceType=deviceType, tempDelayInt=tempDelayInt, humUnit=humUnit, tempHystInt=tempHystInt, trapSOAPErrDNS=trapSOAPErrDNS, hum=hum, humAlarm=humAlarm, compValHighInt=compValHighInt, trapEmailErrSome=trapEmailErrSome, compValMin=compValMin, humInt=humInt, compValInt=compValInt, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValError=trapCompValError, trapCompValHighAlarm=trapCompValHighAlarm, compValDelayInt=compValDelayInt, histTemp=histTemp, trapTempClrAlarm=trapTempClrAlarm, products=products, trapSOAPErrFile=trapSOAPErrFile, histHum=histHum, humMax=humMax, messageString=messageString, compValUnit=compValUnit, humHighInt=humHighInt, settings=settings, trapTempError=trapTempError, serialNumber=serialNumber, trapTempLowAlarm=trapTempLowAlarm, compValMax=compValMax, trapHumError=trapHumError, trapEmailErrLogin=trapEmailErrLogin, sensorName=sensorName)
