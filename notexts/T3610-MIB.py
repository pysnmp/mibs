...
# Produced by pysmi-1.1.12 at Thu May 30 02:13:46 2024
...
iso, TimeTicks, NotificationType, ObjectIdentity, MibIdentifier, Counter32, Gauge32, enterprises, ModuleIdentity, IpAddress, Integer32, Unsigned32, Bits, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "NotificationType", "ObjectIdentity", "MibIdentifier", "Counter32", "Gauge32", "enterprises", "ModuleIdentity", "IpAddress", "Integer32", "Unsigned32", "Bits", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("T3610-MIB", serialNumber=serialNumber, values=values, compValAlarmInt=compValAlarmInt, compValMax=compValMax, histHum=histHum, trapCompValLowAlarm=trapCompValLowAlarm, sensorName=sensorName, tempHighInt=tempHighInt, trapNTPError=trapNTPError, trapEmailErrAuth=trapEmailErrAuth, DisplayString=DisplayString, tempAlarm=tempAlarm, humAlarmInt=humAlarmInt, compValHighInt=compValHighInt, trapHumLowAlarm=trapHumLowAlarm, trapTest=trapTest, historyTable=historyTable, trapTempLowAlarm=trapTempLowAlarm, humDelayInt=humDelayInt, trapEmailErrLogin=trapEmailErrLogin, valuesInt=valuesInt, hum=hum, trapTempError=trapTempError, trapCompValHighAlarm=trapCompValHighAlarm, histCompVal=histCompVal, tempDelayInt=tempDelayInt, histTemp=histTemp, tempMax=tempMax, tempMin=tempMin, humAlarm=humAlarm, trapSOAPErrSocket=trapSOAPErrSocket, deviceType=deviceType, trapCompValError=trapCompValError, trapTempClrAlarm=trapTempClrAlarm, traps=traps, humMin=humMin, trapSOAPErrDNS=trapSOAPErrDNS, tempLowInt=tempLowInt, temp=temp, humLowInt=humLowInt, pysmi_global=pysmi_global, tempHystInt=tempHystInt, trapEmailErrDNS=trapEmailErrDNS, tables=tables, tempAlarmInt=tempAlarmInt, humHystInt=humHystInt, compValMin=compValMin, trapHumHighAlarm=trapHumHighAlarm, compValAlarm=compValAlarm, tempUnit=tempUnit, compValDelayInt=compValDelayInt, trapTempHighAlarm=trapTempHighAlarm, messageString=messageString, trapHumError=trapHumError, compValUnit=compValUnit, comet=comet, compValHystInt=compValHystInt, settings=settings, historyEntry=historyEntry, trapHumClrAlarm=trapHumClrAlarm, trapCompValClrAlarm=trapCompValClrAlarm, trapSOAPErrFile=trapSOAPErrFile, trapEmailErrSome=trapEmailErrSome, trapSOAPErrDelivery=trapSOAPErrDelivery, compVal=compVal, humMax=humMax, trapEmailErrSocket=trapEmailErrSocket, humUnit=humUnit, compValInt=compValInt, t3610=t3610, tempInt=tempInt, humInt=humInt, humHighInt=humHighInt, compValLowInt=compValLowInt, products=products)
