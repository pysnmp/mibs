...
# Produced by pysmi-1.1.3 at Tue Dec  7 17:03:20 2021
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, TimeTicks, ModuleIdentity, NotificationType, Unsigned32, enterprises, IpAddress, Gauge32, Bits, ObjectIdentity, NotificationType, MibIdentifier, Counter64, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "TimeTicks", "ModuleIdentity", "NotificationType", "Unsigned32", "enterprises", "IpAddress", "Gauge32", "Bits", "ObjectIdentity", "NotificationType", "MibIdentifier", "Counter64", "iso")
...
mibBuilder.exportSymbols("T3610-MIB", humMax=humMax, messageString=messageString, histHum=histHum, trapTest=trapTest, trapHumClrAlarm=trapHumClrAlarm, trapCompValHighAlarm=trapCompValHighAlarm, humAlarm=humAlarm, trapTempLowAlarm=trapTempLowAlarm, traps=traps, trapTempError=trapTempError, trapHumError=trapHumError, tempMax=tempMax, serialNumber=serialNumber, trapTempHighAlarm=trapTempHighAlarm, products=products, humLowInt=humLowInt, compValHystInt=compValHystInt, compValMax=compValMax, trapSOAPErrSocket=trapSOAPErrSocket, compValMin=compValMin, compValUnit=compValUnit, compValLowInt=compValLowInt, trapEmailErrSocket=trapEmailErrSocket, pysmi_global=pysmi_global, sensorName=sensorName, tempUnit=tempUnit, humInt=humInt, trapHumHighAlarm=trapHumHighAlarm, histCompVal=histCompVal, humHystInt=humHystInt, trapCompValLowAlarm=trapCompValLowAlarm, historyTable=historyTable, trapEmailErrLogin=trapEmailErrLogin, tempLowInt=tempLowInt, DisplayString=DisplayString, humDelayInt=humDelayInt, valuesInt=valuesInt, trapEmailErrAuth=trapEmailErrAuth, comet=comet, trapEmailErrDNS=trapEmailErrDNS, trapSOAPErrFile=trapSOAPErrFile, trapTempClrAlarm=trapTempClrAlarm, t3610=t3610, trapCompValClrAlarm=trapCompValClrAlarm, tables=tables, tempAlarm=tempAlarm, tempHighInt=tempHighInt, tempHystInt=tempHystInt, hum=hum, settings=settings, humAlarmInt=humAlarmInt, deviceType=deviceType, humMin=humMin, compVal=compVal, tempInt=tempInt, compValDelayInt=compValDelayInt, trapEmailErrSome=trapEmailErrSome, historyEntry=historyEntry, tempDelayInt=tempDelayInt, humUnit=humUnit, values=values, compValInt=compValInt, histTemp=histTemp, trapCompValError=trapCompValError, trapHumLowAlarm=trapHumLowAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, tempMin=tempMin, trapNTPError=trapNTPError, compValAlarmInt=compValAlarmInt, humHighInt=humHighInt, compValAlarm=compValAlarm, compValHighInt=compValHighInt, trapSOAPErrDNS=trapSOAPErrDNS, tempAlarmInt=tempAlarmInt, temp=temp)
