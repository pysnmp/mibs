...
# Produced by pysmi-1.1.10 at Fri Oct 27 07:39:23 2023
...
Unsigned32, Bits, Counter64, ModuleIdentity, NotificationType, NotificationType, Gauge32, ObjectIdentity, enterprises, TimeTicks, Counter32, iso, IpAddress, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Bits", "Counter64", "ModuleIdentity", "NotificationType", "NotificationType", "Gauge32", "ObjectIdentity", "enterprises", "TimeTicks", "Counter32", "iso", "IpAddress", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("T3610-MIB", trapCompValError=trapCompValError, compValAlarm=compValAlarm, deviceType=deviceType, trapHumLowAlarm=trapHumLowAlarm, trapTest=trapTest, compValUnit=compValUnit, trapHumHighAlarm=trapHumHighAlarm, tables=tables, hum=hum, trapTempClrAlarm=trapTempClrAlarm, trapTempError=trapTempError, compValLowInt=compValLowInt, trapSOAPErrDNS=trapSOAPErrDNS, temp=temp, compValHystInt=compValHystInt, values=values, historyTable=historyTable, humMax=humMax, tempLowInt=tempLowInt, trapSOAPErrSocket=trapSOAPErrSocket, compValMin=compValMin, compValDelayInt=compValDelayInt, compValHighInt=compValHighInt, tempUnit=tempUnit, humInt=humInt, humHystInt=humHystInt, comet=comet, trapEmailErrAuth=trapEmailErrAuth, tempMin=tempMin, compValInt=compValInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTempLowAlarm=trapTempLowAlarm, valuesInt=valuesInt, humAlarmInt=humAlarmInt, trapHumError=trapHumError, trapSOAPErrFile=trapSOAPErrFile, trapCompValLowAlarm=trapCompValLowAlarm, humLowInt=humLowInt, tempHystInt=tempHystInt, trapEmailErrSome=trapEmailErrSome, pysmi_global=pysmi_global, compVal=compVal, tempAlarm=tempAlarm, histCompVal=histCompVal, compValAlarmInt=compValAlarmInt, tempMax=tempMax, tempAlarmInt=tempAlarmInt, tempDelayInt=tempDelayInt, histTemp=histTemp, trapNTPError=trapNTPError, historyEntry=historyEntry, humAlarm=humAlarm, messageString=messageString, trapEmailErrDNS=trapEmailErrDNS, trapCompValClrAlarm=trapCompValClrAlarm, sensorName=sensorName, tempHighInt=tempHighInt, trapCompValHighAlarm=trapCompValHighAlarm, humHighInt=humHighInt, trapHumClrAlarm=trapHumClrAlarm, serialNumber=serialNumber, humDelayInt=humDelayInt, humMin=humMin, compValMax=compValMax, histHum=histHum, DisplayString=DisplayString, trapEmailErrSocket=trapEmailErrSocket, trapEmailErrLogin=trapEmailErrLogin, trapTempHighAlarm=trapTempHighAlarm, t3610=t3610, humUnit=humUnit, tempInt=tempInt, traps=traps, products=products, settings=settings)
