...
# Produced by pysmi-1.1.12 at Tue Jun  4 14:09:35 2024
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, MibIdentifier, NotificationType, NotificationType, Gauge32, ObjectIdentity, ModuleIdentity, Integer32, Unsigned32, IpAddress, Counter32, enterprises, TimeTicks, Counter64, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "MibIdentifier", "NotificationType", "NotificationType", "Gauge32", "ObjectIdentity", "ModuleIdentity", "Integer32", "Unsigned32", "IpAddress", "Counter32", "enterprises", "TimeTicks", "Counter64", "iso")
...
mibBuilder.exportSymbols("T3610-MIB", sensorName=sensorName, hum=hum, deviceType=deviceType, trapHumHighAlarm=trapHumHighAlarm, tables=tables, compValAlarmInt=compValAlarmInt, products=products, tempAlarmInt=tempAlarmInt, trapSOAPErrDelivery=trapSOAPErrDelivery, humMin=humMin, comet=comet, trapSOAPErrSocket=trapSOAPErrSocket, trapTempLowAlarm=trapTempLowAlarm, tempInt=tempInt, trapEmailErrAuth=trapEmailErrAuth, compValLowInt=compValLowInt, t3610=t3610, humHystInt=humHystInt, trapTempError=trapTempError, compValHystInt=compValHystInt, trapCompValHighAlarm=trapCompValHighAlarm, humAlarmInt=humAlarmInt, humAlarm=humAlarm, trapEmailErrSocket=trapEmailErrSocket, compValMin=compValMin, humInt=humInt, trapEmailErrSome=trapEmailErrSome, histTemp=histTemp, humMax=humMax, compValMax=compValMax, trapCompValError=trapCompValError, tempDelayInt=tempDelayInt, tempAlarm=tempAlarm, trapTest=trapTest, messageString=messageString, trapSOAPErrDNS=trapSOAPErrDNS, tempHighInt=tempHighInt, trapCompValLowAlarm=trapCompValLowAlarm, humHighInt=humHighInt, compValUnit=compValUnit, tempHystInt=tempHystInt, trapCompValClrAlarm=trapCompValClrAlarm, settings=settings, compValAlarm=compValAlarm, tempMin=tempMin, histCompVal=histCompVal, trapEmailErrDNS=trapEmailErrDNS, compValInt=compValInt, compValDelayInt=compValDelayInt, trapSOAPErrFile=trapSOAPErrFile, tempMax=tempMax, serialNumber=serialNumber, tempUnit=tempUnit, compVal=compVal, trapEmailErrLogin=trapEmailErrLogin, trapHumLowAlarm=trapHumLowAlarm, DisplayString=DisplayString, trapTempClrAlarm=trapTempClrAlarm, temp=temp, trapNTPError=trapNTPError, trapHumClrAlarm=trapHumClrAlarm, valuesInt=valuesInt, values=values, humLowInt=humLowInt, historyEntry=historyEntry, histHum=histHum, pysmi_global=pysmi_global, tempLowInt=tempLowInt, trapTempHighAlarm=trapTempHighAlarm, humDelayInt=humDelayInt, trapHumError=trapHumError, compValHighInt=compValHighInt, humUnit=humUnit, traps=traps, historyTable=historyTable)
