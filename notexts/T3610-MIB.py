...
Integer32, iso, TimeTicks, ObjectIdentity, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, Counter32, IpAddress, Unsigned32, enterprises, ModuleIdentity, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "TimeTicks", "ObjectIdentity", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "Counter32", "IpAddress", "Unsigned32", "enterprises", "ModuleIdentity", "Counter64", "Gauge32")
...
mibBuilder.exportSymbols("T3610-MIB", trapTest=trapTest, compValAlarmInt=compValAlarmInt, comet=comet, humUnit=humUnit, tempLowInt=tempLowInt, compValDelayInt=compValDelayInt, compValHighInt=compValHighInt, settings=settings, traps=traps, compValHystInt=compValHystInt, trapCompValClrAlarm=trapCompValClrAlarm, tempDelayInt=tempDelayInt, humInt=humInt, humHystInt=humHystInt, trapSOAPErrDNS=trapSOAPErrDNS, humDelayInt=humDelayInt, trapCompValError=trapCompValError, valuesInt=valuesInt, tempMax=tempMax, histTemp=histTemp, histCompVal=histCompVal, trapCompValLowAlarm=trapCompValLowAlarm, values=values, histHum=histHum, humMin=humMin, trapHumHighAlarm=trapHumHighAlarm, tempMin=tempMin, trapTempHighAlarm=trapTempHighAlarm, humLowInt=humLowInt, compValMax=compValMax, trapCompValHighAlarm=trapCompValHighAlarm, tempHighInt=tempHighInt, trapSOAPErrFile=trapSOAPErrFile, t3610=t3610, trapEmailErrAuth=trapEmailErrAuth, compValMin=compValMin, temp=temp, compValLowInt=compValLowInt, tempHystInt=tempHystInt, DisplayString=DisplayString, trapEmailErrDNS=trapEmailErrDNS, hum=hum, humHighInt=humHighInt, historyEntry=historyEntry, humAlarmInt=humAlarmInt, humAlarm=humAlarm, trapTempLowAlarm=trapTempLowAlarm, trapHumLowAlarm=trapHumLowAlarm, tempInt=tempInt, trapHumClrAlarm=trapHumClrAlarm, messageString=messageString, trapSOAPErrDelivery=trapSOAPErrDelivery, trapNTPError=trapNTPError, trapHumError=trapHumError, compValAlarm=compValAlarm, products=products, historyTable=historyTable, trapEmailErrSocket=trapEmailErrSocket, trapTempError=trapTempError, serialNumber=serialNumber, trapTempClrAlarm=trapTempClrAlarm, tempAlarm=tempAlarm, tempAlarmInt=tempAlarmInt, deviceType=deviceType, sensorName=sensorName, compValUnit=compValUnit, compValInt=compValInt, trapEmailErrLogin=trapEmailErrLogin, trapEmailErrSome=trapEmailErrSome, pysmi_global=pysmi_global, tables=tables, tempUnit=tempUnit, trapSOAPErrSocket=trapSOAPErrSocket, compVal=compVal, humMax=humMax)
