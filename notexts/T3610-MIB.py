...
# Produced by pysmi-1.1.8 at Tue Sep 12 12:49:23 2023
...
ModuleIdentity, Unsigned32, iso, Counter64, TimeTicks, NotificationType, Counter32, NotificationType, Gauge32, enterprises, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ObjectIdentity, MibIdentifier, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "iso", "Counter64", "TimeTicks", "NotificationType", "Counter32", "NotificationType", "Gauge32", "enterprises", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ObjectIdentity", "MibIdentifier", "IpAddress")
...
mibBuilder.exportSymbols("T3610-MIB", humMax=humMax, humAlarmInt=humAlarmInt, humMin=humMin, humLowInt=humLowInt, compValUnit=compValUnit, trapTempClrAlarm=trapTempClrAlarm, trapCompValClrAlarm=trapCompValClrAlarm, historyEntry=historyEntry, valuesInt=valuesInt, humInt=humInt, sensorName=sensorName, trapCompValHighAlarm=trapCompValHighAlarm, t3610=t3610, compValAlarm=compValAlarm, DisplayString=DisplayString, temp=temp, tempMax=tempMax, compValMin=compValMin, compValLowInt=compValLowInt, tempDelayInt=tempDelayInt, messageString=messageString, trapEmailErrSocket=trapEmailErrSocket, trapEmailErrDNS=trapEmailErrDNS, trapSOAPErrFile=trapSOAPErrFile, tempLowInt=tempLowInt, tables=tables, tempMin=tempMin, deviceType=deviceType, trapTempError=trapTempError, trapEmailErrLogin=trapEmailErrLogin, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrSocket=trapSOAPErrSocket, trapTempHighAlarm=trapTempHighAlarm, hum=hum, compValAlarmInt=compValAlarmInt, tempHighInt=tempHighInt, tempUnit=tempUnit, trapSOAPErrDelivery=trapSOAPErrDelivery, compValDelayInt=compValDelayInt, compValHighInt=compValHighInt, tempAlarmInt=tempAlarmInt, trapSOAPErrDNS=trapSOAPErrDNS, settings=settings, compValInt=compValInt, products=products, compVal=compVal, humHighInt=humHighInt, trapCompValError=trapCompValError, serialNumber=serialNumber, compValHystInt=compValHystInt, pysmi_global=pysmi_global, trapHumLowAlarm=trapHumLowAlarm, comet=comet, humUnit=humUnit, histHum=histHum, histTemp=histTemp, historyTable=historyTable, trapHumHighAlarm=trapHumHighAlarm, humHystInt=humHystInt, histCompVal=histCompVal, trapTest=trapTest, values=values, traps=traps, trapCompValLowAlarm=trapCompValLowAlarm, trapHumClrAlarm=trapHumClrAlarm, compValMax=compValMax, trapHumError=trapHumError, humAlarm=humAlarm, trapTempLowAlarm=trapTempLowAlarm, tempAlarm=tempAlarm, trapNTPError=trapNTPError, humDelayInt=humDelayInt, tempHystInt=tempHystInt, tempInt=tempInt, trapEmailErrSome=trapEmailErrSome)
