...
# Produced by pysmi-1.1.8 at Tue Jan 11 21:16:21 2022
...
Bits, ObjectIdentity, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, IpAddress, MibIdentifier, Gauge32, ModuleIdentity, enterprises, Integer32, Counter64, NotificationType, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ObjectIdentity", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "IpAddress", "MibIdentifier", "Gauge32", "ModuleIdentity", "enterprises", "Integer32", "Counter64", "NotificationType", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("T3610-MIB", humHighInt=humHighInt, compValAlarmInt=compValAlarmInt, trapHumError=trapHumError, trapTest=trapTest, tempDelayInt=tempDelayInt, tables=tables, compVal=compVal, tempMax=tempMax, trapCompValLowAlarm=trapCompValLowAlarm, trapSOAPErrDNS=trapSOAPErrDNS, trapSOAPErrFile=trapSOAPErrFile, trapHumClrAlarm=trapHumClrAlarm, humUnit=humUnit, trapCompValClrAlarm=trapCompValClrAlarm, compValDelayInt=compValDelayInt, tempLowInt=tempLowInt, historyTable=historyTable, trapTempLowAlarm=trapTempLowAlarm, trapEmailErrSome=trapEmailErrSome, trapTempError=trapTempError, compValHighInt=compValHighInt, compValAlarm=compValAlarm, serialNumber=serialNumber, histCompVal=histCompVal, compValLowInt=compValLowInt, tempHystInt=tempHystInt, trapSOAPErrSocket=trapSOAPErrSocket, humMin=humMin, DisplayString=DisplayString, tempAlarmInt=tempAlarmInt, humDelayInt=humDelayInt, comet=comet, trapEmailErrAuth=trapEmailErrAuth, compValUnit=compValUnit, messageString=messageString, trapEmailErrDNS=trapEmailErrDNS, trapHumLowAlarm=trapHumLowAlarm, compValHystInt=compValHystInt, humLowInt=humLowInt, products=products, trapSOAPErrDelivery=trapSOAPErrDelivery, humAlarmInt=humAlarmInt, settings=settings, historyEntry=historyEntry, temp=temp, tempAlarm=tempAlarm, tempMin=tempMin, compValInt=compValInt, tempUnit=tempUnit, trapTempClrAlarm=trapTempClrAlarm, trapCompValError=trapCompValError, histTemp=histTemp, humHystInt=humHystInt, compValMin=compValMin, trapEmailErrLogin=trapEmailErrLogin, trapCompValHighAlarm=trapCompValHighAlarm, trapNTPError=trapNTPError, t3610=t3610, values=values, hum=hum, traps=traps, compValMax=compValMax, deviceType=deviceType, humInt=humInt, humMax=humMax, trapEmailErrSocket=trapEmailErrSocket, trapTempHighAlarm=trapTempHighAlarm, tempHighInt=tempHighInt, tempInt=tempInt, humAlarm=humAlarm, sensorName=sensorName, trapHumHighAlarm=trapHumHighAlarm, pysmi_global=pysmi_global, histHum=histHum, valuesInt=valuesInt)
