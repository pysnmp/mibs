...
# Produced by pysmi-1.1.8 at Thu Sep  7 12:00:04 2023
...
Bits, Counter64, Counter32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, IpAddress, TimeTicks, ModuleIdentity, iso, Unsigned32, MibIdentifier, enterprises, ObjectIdentity, NotificationType, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "Counter32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "IpAddress", "TimeTicks", "ModuleIdentity", "iso", "Unsigned32", "MibIdentifier", "enterprises", "ObjectIdentity", "NotificationType", "Integer32")
...
mibBuilder.exportSymbols("T3610-MIB", compValAlarmInt=compValAlarmInt, compValLowInt=compValLowInt, settings=settings, trapSOAPErrDNS=trapSOAPErrDNS, trapEmailErrAuth=trapEmailErrAuth, trapTempClrAlarm=trapTempClrAlarm, trapHumClrAlarm=trapHumClrAlarm, histCompVal=histCompVal, humLowInt=humLowInt, humDelayInt=humDelayInt, trapCompValClrAlarm=trapCompValClrAlarm, historyEntry=historyEntry, humHighInt=humHighInt, trapNTPError=trapNTPError, compValMin=compValMin, humUnit=humUnit, trapSOAPErrFile=trapSOAPErrFile, humInt=humInt, tempDelayInt=tempDelayInt, comet=comet, histHum=histHum, trapCompValLowAlarm=trapCompValLowAlarm, t3610=t3610, compValInt=compValInt, compValDelayInt=compValDelayInt, trapSOAPErrDelivery=trapSOAPErrDelivery, tables=tables, compValMax=compValMax, tempInt=tempInt, tempLowInt=tempLowInt, trapHumHighAlarm=trapHumHighAlarm, pysmi_global=pysmi_global, tempHighInt=tempHighInt, trapHumError=trapHumError, tempUnit=tempUnit, temp=temp, humMax=humMax, sensorName=sensorName, humAlarmInt=humAlarmInt, tempAlarmInt=tempAlarmInt, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrSocket=trapSOAPErrSocket, historyTable=historyTable, products=products, traps=traps, hum=hum, compValHighInt=compValHighInt, messageString=messageString, trapHumLowAlarm=trapHumLowAlarm, trapEmailErrDNS=trapEmailErrDNS, tempMax=tempMax, tempHystInt=tempHystInt, trapEmailErrSome=trapEmailErrSome, trapCompValHighAlarm=trapCompValHighAlarm, trapEmailErrLogin=trapEmailErrLogin, trapTest=trapTest, serialNumber=serialNumber, histTemp=histTemp, compValAlarm=compValAlarm, humAlarm=humAlarm, humMin=humMin, trapTempLowAlarm=trapTempLowAlarm, humHystInt=humHystInt, tempMin=tempMin, deviceType=deviceType, compValHystInt=compValHystInt, trapTempError=trapTempError, tempAlarm=tempAlarm, DisplayString=DisplayString, trapCompValError=trapCompValError, values=values, compVal=compVal, trapTempHighAlarm=trapTempHighAlarm, valuesInt=valuesInt, compValUnit=compValUnit)
