...
# Produced by pysmi-1.1.8 at Tue Sep 12 07:22:27 2023
...
Integer32, Bits, Unsigned32, iso, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, ObjectIdentity, Counter64, IpAddress, MibIdentifier, NotificationType, ModuleIdentity, Counter32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "Unsigned32", "iso", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "ObjectIdentity", "Counter64", "IpAddress", "MibIdentifier", "NotificationType", "ModuleIdentity", "Counter32", "TimeTicks")
...
mibBuilder.exportSymbols("T3610-MIB", trapEmailErrSocket=trapEmailErrSocket, humLowInt=humLowInt, humHighInt=humHighInt, compValDelayInt=compValDelayInt, DisplayString=DisplayString, trapTempHighAlarm=trapTempHighAlarm, trapCompValError=trapCompValError, compValHighInt=compValHighInt, tables=tables, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValClrAlarm=trapCompValClrAlarm, humAlarmInt=humAlarmInt, compValHystInt=compValHystInt, tempMin=tempMin, tempInt=tempInt, tempMax=tempMax, compVal=compVal, compValUnit=compValUnit, trapTempError=trapTempError, trapSOAPErrDNS=trapSOAPErrDNS, humAlarm=humAlarm, histCompVal=histCompVal, trapTest=trapTest, compValLowInt=compValLowInt, trapEmailErrDNS=trapEmailErrDNS, serialNumber=serialNumber, compValInt=compValInt, compValMin=compValMin, humMax=humMax, tempHystInt=tempHystInt, historyEntry=historyEntry, trapEmailErrAuth=trapEmailErrAuth, settings=settings, sensorName=sensorName, trapHumClrAlarm=trapHumClrAlarm, humMin=humMin, trapCompValLowAlarm=trapCompValLowAlarm, products=products, humHystInt=humHystInt, temp=temp, tempAlarm=tempAlarm, humUnit=humUnit, trapCompValHighAlarm=trapCompValHighAlarm, tempHighInt=tempHighInt, t3610=t3610, compValMax=compValMax, compValAlarm=compValAlarm, comet=comet, pysmi_global=pysmi_global, values=values, histHum=histHum, messageString=messageString, deviceType=deviceType, histTemp=histTemp, tempAlarmInt=tempAlarmInt, trapHumLowAlarm=trapHumLowAlarm, tempUnit=tempUnit, trapSOAPErrDelivery=trapSOAPErrDelivery, trapHumError=trapHumError, hum=hum, trapNTPError=trapNTPError, valuesInt=valuesInt, tempDelayInt=tempDelayInt, humInt=humInt, trapHumHighAlarm=trapHumHighAlarm, trapEmailErrLogin=trapEmailErrLogin, humDelayInt=humDelayInt, tempLowInt=tempLowInt, historyTable=historyTable, trapSOAPErrFile=trapSOAPErrFile, traps=traps, trapTempLowAlarm=trapTempLowAlarm, trapEmailErrSome=trapEmailErrSome, trapTempClrAlarm=trapTempClrAlarm, compValAlarmInt=compValAlarmInt)
