...
# Produced by pysmi-1.1.12 at Wed Dec  4 21:12:34 2024
...
Bits, Gauge32, TimeTicks, NotificationType, NotificationType, IpAddress, MibIdentifier, ModuleIdentity, Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Integer32, ObjectIdentity, enterprises, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Gauge32", "TimeTicks", "NotificationType", "NotificationType", "IpAddress", "MibIdentifier", "ModuleIdentity", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Integer32", "ObjectIdentity", "enterprises", "Counter64")
...
mibBuilder.exportSymbols("T3610-MIB", DisplayString=DisplayString, tables=tables, comet=comet, humUnit=humUnit, compValLowInt=compValLowInt, trapTest=trapTest, trapTempClrAlarm=trapTempClrAlarm, tempMin=tempMin, humAlarm=humAlarm, trapHumLowAlarm=trapHumLowAlarm, trapEmailErrSome=trapEmailErrSome, tempLowInt=tempLowInt, trapHumClrAlarm=trapHumClrAlarm, compValAlarm=compValAlarm, tempHystInt=tempHystInt, histCompVal=histCompVal, trapEmailErrDNS=trapEmailErrDNS, trapCompValError=trapCompValError, values=values, pysmi_global=pysmi_global, trapNTPError=trapNTPError, trapHumHighAlarm=trapHumHighAlarm, compValMin=compValMin, humHighInt=humHighInt, tempMax=tempMax, t3610=t3610, humAlarmInt=humAlarmInt, tempHighInt=tempHighInt, messageString=messageString, tempAlarm=tempAlarm, compValAlarmInt=compValAlarmInt, compValHystInt=compValHystInt, humMin=humMin, tempAlarmInt=tempAlarmInt, historyEntry=historyEntry, valuesInt=valuesInt, trapEmailErrAuth=trapEmailErrAuth, tempUnit=tempUnit, tempInt=tempInt, compVal=compVal, trapSOAPErrDNS=trapSOAPErrDNS, temp=temp, trapTempHighAlarm=trapTempHighAlarm, trapCompValLowAlarm=trapCompValLowAlarm, trapTempError=trapTempError, trapSOAPErrDelivery=trapSOAPErrDelivery, hum=hum, histTemp=histTemp, trapSOAPErrSocket=trapSOAPErrSocket, humMax=humMax, sensorName=sensorName, humInt=humInt, compValInt=compValInt, tempDelayInt=tempDelayInt, deviceType=deviceType, trapSOAPErrFile=trapSOAPErrFile, trapHumError=trapHumError, compValUnit=compValUnit, humDelayInt=humDelayInt, trapCompValHighAlarm=trapCompValHighAlarm, humLowInt=humLowInt, humHystInt=humHystInt, compValMax=compValMax, trapCompValClrAlarm=trapCompValClrAlarm, compValDelayInt=compValDelayInt, traps=traps, trapEmailErrLogin=trapEmailErrLogin, compValHighInt=compValHighInt, historyTable=historyTable, trapEmailErrSocket=trapEmailErrSocket, histHum=histHum, settings=settings, serialNumber=serialNumber, products=products, trapTempLowAlarm=trapTempLowAlarm)
