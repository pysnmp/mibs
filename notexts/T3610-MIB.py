...
# Produced by pysmi-1.1.12 at Tue Jun  4 09:28:02 2024
...
Counter32, ModuleIdentity, MibIdentifier, Integer32, Bits, enterprises, NotificationType, iso, Gauge32, NotificationType, TimeTicks, Counter64, IpAddress, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "MibIdentifier", "Integer32", "Bits", "enterprises", "NotificationType", "iso", "Gauge32", "NotificationType", "TimeTicks", "Counter64", "IpAddress", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("T3610-MIB", messageString=messageString, traps=traps, valuesInt=valuesInt, temp=temp, humAlarmInt=humAlarmInt, humHystInt=humHystInt, tempMax=tempMax, tempHighInt=tempHighInt, historyTable=historyTable, pysmi_global=pysmi_global, t3610=t3610, historyEntry=historyEntry, trapHumLowAlarm=trapHumLowAlarm, trapTempClrAlarm=trapTempClrAlarm, compValInt=compValInt, histCompVal=histCompVal, comet=comet, tempInt=tempInt, compValDelayInt=compValDelayInt, trapEmailErrAuth=trapEmailErrAuth, deviceType=deviceType, DisplayString=DisplayString, tempLowInt=tempLowInt, humDelayInt=humDelayInt, trapTempHighAlarm=trapTempHighAlarm, trapEmailErrLogin=trapEmailErrLogin, tempMin=tempMin, sensorName=sensorName, trapTempError=trapTempError, tempAlarmInt=tempAlarmInt, humUnit=humUnit, compValLowInt=compValLowInt, hum=hum, compValMin=compValMin, trapEmailErrDNS=trapEmailErrDNS, trapSOAPErrDNS=trapSOAPErrDNS, humMin=humMin, compValAlarm=compValAlarm, histTemp=histTemp, trapHumError=trapHumError, compVal=compVal, compValUnit=compValUnit, histHum=histHum, trapCompValClrAlarm=trapCompValClrAlarm, trapEmailErrSome=trapEmailErrSome, trapCompValLowAlarm=trapCompValLowAlarm, tables=tables, compValMax=compValMax, trapSOAPErrFile=trapSOAPErrFile, trapSOAPErrSocket=trapSOAPErrSocket, trapNTPError=trapNTPError, trapSOAPErrDelivery=trapSOAPErrDelivery, settings=settings, values=values, tempDelayInt=tempDelayInt, compValHystInt=compValHystInt, serialNumber=serialNumber, humMax=humMax, tempAlarm=tempAlarm, compValAlarmInt=compValAlarmInt, humLowInt=humLowInt, products=products, humAlarm=humAlarm, humHighInt=humHighInt, tempHystInt=tempHystInt, trapEmailErrSocket=trapEmailErrSocket, trapHumHighAlarm=trapHumHighAlarm, trapTest=trapTest, trapCompValHighAlarm=trapCompValHighAlarm, trapTempLowAlarm=trapTempLowAlarm, trapHumClrAlarm=trapHumClrAlarm, trapCompValError=trapCompValError, tempUnit=tempUnit, humInt=humInt, compValHighInt=compValHighInt)
