...
# Produced by pysmi-1.1.8 at Fri Jan 27 14:01:51 2023
...
enterprises, TimeTicks, iso, ModuleIdentity, Bits, NotificationType, IpAddress, ObjectIdentity, Counter32, Gauge32, Unsigned32, Integer32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "TimeTicks", "iso", "ModuleIdentity", "Bits", "NotificationType", "IpAddress", "ObjectIdentity", "Counter32", "Gauge32", "Unsigned32", "Integer32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", humMax=humMax, traps=traps, compVal=compVal, humLowInt=humLowInt, historyTable=historyTable, histHum=histHum, serialNumber=serialNumber, compValMax=compValMax, trapTest=trapTest, trapEmailErrDNS=trapEmailErrDNS, tempMax=tempMax, trapEmailErrSome=trapEmailErrSome, trapSOAPErrDNS=trapSOAPErrDNS, settings=settings, tempAlarm=tempAlarm, trapHumHighAlarm=trapHumHighAlarm, tempHighInt=tempHighInt, trapHumError=trapHumError, compValDelayInt=compValDelayInt, humUnit=humUnit, tables=tables, humMin=humMin, products=products, deviceType=deviceType, historyEntry=historyEntry, values=values, t3610=t3610, tempInt=tempInt, humAlarmInt=humAlarmInt, humHystInt=humHystInt, trapEmailErrSocket=trapEmailErrSocket, tempDelayInt=tempDelayInt, tempLowInt=tempLowInt, valuesInt=valuesInt, hum=hum, compValMin=compValMin, humDelayInt=humDelayInt, trapNTPError=trapNTPError, tempHystInt=tempHystInt, tempAlarmInt=tempAlarmInt, trapCompValLowAlarm=trapCompValLowAlarm, trapCompValClrAlarm=trapCompValClrAlarm, tempUnit=tempUnit, trapSOAPErrSocket=trapSOAPErrSocket, histTemp=histTemp, pysmi_global=pysmi_global, DisplayString=DisplayString, tempMin=tempMin, compValHighInt=compValHighInt, trapEmailErrAuth=trapEmailErrAuth, trapCompValHighAlarm=trapCompValHighAlarm, trapEmailErrLogin=trapEmailErrLogin, histCompVal=histCompVal, humAlarm=humAlarm, compValAlarm=compValAlarm, sensorName=sensorName, trapSOAPErrFile=trapSOAPErrFile, trapHumClrAlarm=trapHumClrAlarm, comet=comet, compValUnit=compValUnit, compValAlarmInt=compValAlarmInt, trapSOAPErrDelivery=trapSOAPErrDelivery, humHighInt=humHighInt, compValLowInt=compValLowInt, messageString=messageString, trapHumLowAlarm=trapHumLowAlarm, trapTempClrAlarm=trapTempClrAlarm, trapCompValError=trapCompValError, humInt=humInt, trapTempError=trapTempError, temp=temp, compValHystInt=compValHystInt, compValInt=compValInt, trapTempLowAlarm=trapTempLowAlarm, trapTempHighAlarm=trapTempHighAlarm)
