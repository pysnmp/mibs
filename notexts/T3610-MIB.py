...
iso, Counter32, NotificationType, TimeTicks, Unsigned32, Integer32, NotificationType, IpAddress, Bits, ModuleIdentity, MibIdentifier, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter64, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter32", "NotificationType", "TimeTicks", "Unsigned32", "Integer32", "NotificationType", "IpAddress", "Bits", "ModuleIdentity", "MibIdentifier", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter64", "enterprises")
...
mibBuilder.exportSymbols("T3610-MIB", tempMin=tempMin, tempHighInt=tempHighInt, hum=hum, historyEntry=historyEntry, humUnit=humUnit, trapTempHighAlarm=trapTempHighAlarm, trapTempError=trapTempError, tempMax=tempMax, tempHystInt=tempHystInt, trapTest=trapTest, humHighInt=humHighInt, humInt=humInt, trapSOAPErrDelivery=trapSOAPErrDelivery, tempInt=tempInt, trapEmailErrLogin=trapEmailErrLogin, trapHumError=trapHumError, humAlarm=humAlarm, temp=temp, histCompVal=histCompVal, tempAlarm=tempAlarm, compValAlarm=compValAlarm, trapEmailErrAuth=trapEmailErrAuth, humLowInt=humLowInt, histTemp=histTemp, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrSocket=trapSOAPErrSocket, comet=comet, products=products, humAlarmInt=humAlarmInt, humHystInt=humHystInt, tempLowInt=tempLowInt, compValAlarmInt=compValAlarmInt, trapEmailErrDNS=trapEmailErrDNS, compValDelayInt=compValDelayInt, DisplayString=DisplayString, trapEmailErrSome=trapEmailErrSome, trapCompValClrAlarm=trapCompValClrAlarm, compValHighInt=compValHighInt, pysmi_global=pysmi_global, traps=traps, compValMin=compValMin, compValInt=compValInt, tempAlarmInt=tempAlarmInt, tables=tables, tempDelayInt=tempDelayInt, trapSOAPErrFile=trapSOAPErrFile, humDelayInt=humDelayInt, trapTempClrAlarm=trapTempClrAlarm, trapCompValError=trapCompValError, compValMax=compValMax, t3610=t3610, serialNumber=serialNumber, trapNTPError=trapNTPError, deviceType=deviceType, compValHystInt=compValHystInt, trapSOAPErrDNS=trapSOAPErrDNS, trapHumLowAlarm=trapHumLowAlarm, trapHumClrAlarm=trapHumClrAlarm, sensorName=sensorName, compVal=compVal, values=values, compValLowInt=compValLowInt, messageString=messageString, valuesInt=valuesInt, trapTempLowAlarm=trapTempLowAlarm, compValUnit=compValUnit, historyTable=historyTable, humMax=humMax, trapCompValHighAlarm=trapCompValHighAlarm, trapHumHighAlarm=trapHumHighAlarm, humMin=humMin, tempUnit=tempUnit, trapCompValLowAlarm=trapCompValLowAlarm, histHum=histHum, settings=settings)
