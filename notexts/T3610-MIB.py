...
# Produced by pysmi-1.1.8 at Sat Jan 15 04:17:19 2022
...
NotificationType, TimeTicks, enterprises, Counter64, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, MibIdentifier, Gauge32, NotificationType, ModuleIdentity, iso, Unsigned32, ObjectIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "enterprises", "Counter64", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "MibIdentifier", "Gauge32", "NotificationType", "ModuleIdentity", "iso", "Unsigned32", "ObjectIdentity", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", compValInt=compValInt, humHighInt=humHighInt, trapHumError=trapHumError, hum=hum, tempMax=tempMax, compValMax=compValMax, trapEmailErrDNS=trapEmailErrDNS, deviceType=deviceType, trapTempLowAlarm=trapTempLowAlarm, humUnit=humUnit, trapCompValError=trapCompValError, compVal=compVal, compValHighInt=compValHighInt, settings=settings, trapTest=trapTest, comet=comet, trapNTPError=trapNTPError, trapEmailErrSome=trapEmailErrSome, trapSOAPErrFile=trapSOAPErrFile, compValUnit=compValUnit, compValAlarm=compValAlarm, humLowInt=humLowInt, pysmi_global=pysmi_global, compValLowInt=compValLowInt, tempInt=tempInt, trapTempClrAlarm=trapTempClrAlarm, trapCompValHighAlarm=trapCompValHighAlarm, compValDelayInt=compValDelayInt, trapTempError=trapTempError, tempAlarm=tempAlarm, products=products, humMax=humMax, trapSOAPErrDNS=trapSOAPErrDNS, trapCompValLowAlarm=trapCompValLowAlarm, histCompVal=histCompVal, values=values, t3610=t3610, traps=traps, humMin=humMin, tempAlarmInt=tempAlarmInt, trapTempHighAlarm=trapTempHighAlarm, tempDelayInt=tempDelayInt, historyTable=historyTable, tempHystInt=tempHystInt, tempUnit=tempUnit, compValAlarmInt=compValAlarmInt, trapEmailErrSocket=trapEmailErrSocket, compValHystInt=compValHystInt, humAlarmInt=humAlarmInt, historyEntry=historyEntry, trapHumLowAlarm=trapHumLowAlarm, trapHumClrAlarm=trapHumClrAlarm, DisplayString=DisplayString, trapEmailErrAuth=trapEmailErrAuth, messageString=messageString, histHum=histHum, temp=temp, humHystInt=humHystInt, histTemp=histTemp, trapEmailErrLogin=trapEmailErrLogin, sensorName=sensorName, trapCompValClrAlarm=trapCompValClrAlarm, serialNumber=serialNumber, humInt=humInt, humDelayInt=humDelayInt, tables=tables, tempLowInt=tempLowInt, trapSOAPErrDelivery=trapSOAPErrDelivery, valuesInt=valuesInt, tempHighInt=tempHighInt, trapHumHighAlarm=trapHumHighAlarm, tempMin=tempMin, humAlarm=humAlarm, compValMin=compValMin, trapSOAPErrSocket=trapSOAPErrSocket)
