...
# Produced by pysmi-1.1.3 at Wed Dec  8 20:58:18 2021
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, Gauge32, NotificationType, MibIdentifier, TimeTicks, ObjectIdentity, enterprises, IpAddress, Counter32, NotificationType, Bits, Counter64, iso, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "Gauge32", "NotificationType", "MibIdentifier", "TimeTicks", "ObjectIdentity", "enterprises", "IpAddress", "Counter32", "NotificationType", "Bits", "Counter64", "iso", "ModuleIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", trapSOAPErrDNS=trapSOAPErrDNS, trapSOAPErrDelivery=trapSOAPErrDelivery, compValHystInt=compValHystInt, trapCompValLowAlarm=trapCompValLowAlarm, DisplayString=DisplayString, compValDelayInt=compValDelayInt, histTemp=histTemp, trapSOAPErrSocket=trapSOAPErrSocket, t3610=t3610, traps=traps, trapCompValHighAlarm=trapCompValHighAlarm, tempMin=tempMin, humAlarmInt=humAlarmInt, trapEmailErrLogin=trapEmailErrLogin, pysmi_global=pysmi_global, trapHumError=trapHumError, trapTempLowAlarm=trapTempLowAlarm, tempUnit=tempUnit, tables=tables, trapSOAPErrFile=trapSOAPErrFile, compValMin=compValMin, values=values, tempMax=tempMax, comet=comet, compValMax=compValMax, compValHighInt=compValHighInt, historyEntry=historyEntry, histCompVal=histCompVal, trapTempError=trapTempError, humInt=humInt, trapEmailErrSome=trapEmailErrSome, trapCompValClrAlarm=trapCompValClrAlarm, humMax=humMax, trapHumLowAlarm=trapHumLowAlarm, products=products, trapHumClrAlarm=trapHumClrAlarm, tempAlarm=tempAlarm, trapTempClrAlarm=trapTempClrAlarm, valuesInt=valuesInt, trapEmailErrSocket=trapEmailErrSocket, trapNTPError=trapNTPError, tempDelayInt=tempDelayInt, tempHystInt=tempHystInt, settings=settings, compValAlarm=compValAlarm, compValInt=compValInt, humAlarm=humAlarm, tempAlarmInt=tempAlarmInt, trapTest=trapTest, temp=temp, historyTable=historyTable, tempLowInt=tempLowInt, compValUnit=compValUnit, hum=hum, tempHighInt=tempHighInt, trapEmailErrDNS=trapEmailErrDNS, trapCompValError=trapCompValError, histHum=histHum, compValAlarmInt=compValAlarmInt, sensorName=sensorName, serialNumber=serialNumber, humHighInt=humHighInt, trapTempHighAlarm=trapTempHighAlarm, trapHumHighAlarm=trapHumHighAlarm, humLowInt=humLowInt, deviceType=deviceType, compVal=compVal, humMin=humMin, trapEmailErrAuth=trapEmailErrAuth, humHystInt=humHystInt, humUnit=humUnit, tempInt=tempInt, compValLowInt=compValLowInt, messageString=messageString, humDelayInt=humDelayInt)
