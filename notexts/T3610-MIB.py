...
# Produced by pysmi-1.1.10 at Thu Nov  9 13:45:00 2023
...
IpAddress, enterprises, iso, ObjectIdentity, Unsigned32, Integer32, NotificationType, MibIdentifier, Gauge32, TimeTicks, ModuleIdentity, Counter64, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "enterprises", "iso", "ObjectIdentity", "Unsigned32", "Integer32", "NotificationType", "MibIdentifier", "Gauge32", "TimeTicks", "ModuleIdentity", "Counter64", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", values=values, deviceType=deviceType, trapCompValLowAlarm=trapCompValLowAlarm, humInt=humInt, tempAlarm=tempAlarm, trapCompValError=trapCompValError, trapTempLowAlarm=trapTempLowAlarm, histTemp=histTemp, DisplayString=DisplayString, compValAlarmInt=compValAlarmInt, trapTest=trapTest, trapCompValClrAlarm=trapCompValClrAlarm, tempAlarmInt=tempAlarmInt, tempDelayInt=tempDelayInt, compValHystInt=compValHystInt, messageString=messageString, trapEmailErrDNS=trapEmailErrDNS, humLowInt=humLowInt, tempUnit=tempUnit, humUnit=humUnit, trapCompValHighAlarm=trapCompValHighAlarm, histHum=histHum, trapSOAPErrDelivery=trapSOAPErrDelivery, hum=hum, compValLowInt=compValLowInt, humMax=humMax, products=products, trapEmailErrSome=trapEmailErrSome, trapHumLowAlarm=trapHumLowAlarm, trapEmailErrSocket=trapEmailErrSocket, humAlarmInt=humAlarmInt, valuesInt=valuesInt, trapEmailErrLogin=trapEmailErrLogin, trapHumError=trapHumError, historyTable=historyTable, trapSOAPErrDNS=trapSOAPErrDNS, compValMax=compValMax, compValDelayInt=compValDelayInt, humHystInt=humHystInt, serialNumber=serialNumber, tempLowInt=tempLowInt, humHighInt=humHighInt, humAlarm=humAlarm, tempHighInt=tempHighInt, compValHighInt=compValHighInt, histCompVal=histCompVal, tempHystInt=tempHystInt, trapTempError=trapTempError, sensorName=sensorName, trapEmailErrAuth=trapEmailErrAuth, tempInt=tempInt, trapTempHighAlarm=trapTempHighAlarm, comet=comet, historyEntry=historyEntry, compValUnit=compValUnit, temp=temp, humMin=humMin, traps=traps, tempMin=tempMin, trapNTPError=trapNTPError, tables=tables, pysmi_global=pysmi_global, settings=settings, compVal=compVal, trapHumClrAlarm=trapHumClrAlarm, tempMax=tempMax, humDelayInt=humDelayInt, t3610=t3610, compValMin=compValMin, trapSOAPErrSocket=trapSOAPErrSocket, compValAlarm=compValAlarm, trapTempClrAlarm=trapTempClrAlarm, trapSOAPErrFile=trapSOAPErrFile, compValInt=compValInt, trapHumHighAlarm=trapHumHighAlarm)
