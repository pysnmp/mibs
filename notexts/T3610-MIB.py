...
# Produced by pysmi-1.1.10 at Fri Oct 27 12:07:04 2023
...
Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, enterprises, Counter64, TimeTicks, IpAddress, NotificationType, Unsigned32, iso, NotificationType, ObjectIdentity, ModuleIdentity, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "enterprises", "Counter64", "TimeTicks", "IpAddress", "NotificationType", "Unsigned32", "iso", "NotificationType", "ObjectIdentity", "ModuleIdentity", "Integer32", "Counter32")
...
mibBuilder.exportSymbols("T3610-MIB", trapTempHighAlarm=trapTempHighAlarm, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrSocket=trapSOAPErrSocket, values=values, trapCompValHighAlarm=trapCompValHighAlarm, t3610=t3610, tempMax=tempMax, trapCompValLowAlarm=trapCompValLowAlarm, compValMax=compValMax, pysmi_global=pysmi_global, trapTempClrAlarm=trapTempClrAlarm, humMin=humMin, tempHighInt=tempHighInt, trapEmailErrDNS=trapEmailErrDNS, tempUnit=tempUnit, humHighInt=humHighInt, messageString=messageString, comet=comet, trapHumLowAlarm=trapHumLowAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, humMax=humMax, humInt=humInt, historyTable=historyTable, humUnit=humUnit, tempDelayInt=tempDelayInt, temp=temp, humHystInt=humHystInt, trapSOAPErrDNS=trapSOAPErrDNS, sensorName=sensorName, trapHumHighAlarm=trapHumHighAlarm, tables=tables, compValLowInt=compValLowInt, tempAlarm=tempAlarm, traps=traps, tempAlarmInt=tempAlarmInt, compValAlarmInt=compValAlarmInt, tempLowInt=tempLowInt, products=products, trapCompValError=trapCompValError, serialNumber=serialNumber, trapTest=trapTest, valuesInt=valuesInt, historyEntry=historyEntry, DisplayString=DisplayString, deviceType=deviceType, trapNTPError=trapNTPError, compValAlarm=compValAlarm, compValMin=compValMin, compVal=compVal, histHum=histHum, humLowInt=humLowInt, tempMin=tempMin, compValHystInt=compValHystInt, humDelayInt=humDelayInt, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrFile=trapSOAPErrFile, trapHumError=trapHumError, compValDelayInt=compValDelayInt, compValUnit=compValUnit, compValHighInt=compValHighInt, trapEmailErrSome=trapEmailErrSome, hum=hum, tempHystInt=tempHystInt, trapEmailErrLogin=trapEmailErrLogin, trapCompValClrAlarm=trapCompValClrAlarm, histCompVal=histCompVal, settings=settings, humAlarmInt=humAlarmInt, tempInt=tempInt, humAlarm=humAlarm, compValInt=compValInt, trapTempError=trapTempError, trapHumClrAlarm=trapHumClrAlarm, histTemp=histTemp, trapTempLowAlarm=trapTempLowAlarm)
