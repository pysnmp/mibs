...
# Produced by pysmi-1.1.3 at Thu Dec  9 15:06:39 2021
...
Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, IpAddress, Gauge32, NotificationType, enterprises, Bits, TimeTicks, ModuleIdentity, ObjectIdentity, MibIdentifier, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "IpAddress", "Gauge32", "NotificationType", "enterprises", "Bits", "TimeTicks", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "iso", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", trapEmailErrAuth=trapEmailErrAuth, trapEmailErrSome=trapEmailErrSome, humHighInt=humHighInt, tempMin=tempMin, tempDelayInt=tempDelayInt, compValDelayInt=compValDelayInt, comet=comet, temp=temp, trapHumError=trapHumError, tempInt=tempInt, compValUnit=compValUnit, tempUnit=tempUnit, trapEmailErrSocket=trapEmailErrSocket, historyTable=historyTable, trapSOAPErrDelivery=trapSOAPErrDelivery, trapCompValHighAlarm=trapCompValHighAlarm, hum=hum, serialNumber=serialNumber, trapEmailErrDNS=trapEmailErrDNS, trapTempClrAlarm=trapTempClrAlarm, compValAlarm=compValAlarm, trapHumLowAlarm=trapHumLowAlarm, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValLowAlarm=trapCompValLowAlarm, tempAlarm=tempAlarm, humAlarm=humAlarm, compValMin=compValMin, humMax=humMax, tables=tables, messageString=messageString, humHystInt=humHystInt, compValHystInt=compValHystInt, humInt=humInt, tempMax=tempMax, trapTest=trapTest, values=values, tempLowInt=tempLowInt, trapTempError=trapTempError, trapSOAPErrDNS=trapSOAPErrDNS, settings=settings, pysmi_global=pysmi_global, humMin=humMin, tempHystInt=tempHystInt, compValInt=compValInt, tempHighInt=tempHighInt, trapTempHighAlarm=trapTempHighAlarm, t3610=t3610, trapHumHighAlarm=trapHumHighAlarm, trapNTPError=trapNTPError, trapSOAPErrFile=trapSOAPErrFile, traps=traps, compValLowInt=compValLowInt, sensorName=sensorName, humLowInt=humLowInt, humDelayInt=humDelayInt, tempAlarmInt=tempAlarmInt, historyEntry=historyEntry, histTemp=histTemp, histHum=histHum, compValAlarmInt=compValAlarmInt, compVal=compVal, products=products, trapHumClrAlarm=trapHumClrAlarm, DisplayString=DisplayString, trapEmailErrLogin=trapEmailErrLogin, trapCompValError=trapCompValError, compValHighInt=compValHighInt, trapTempLowAlarm=trapTempLowAlarm, valuesInt=valuesInt, humUnit=humUnit, trapCompValClrAlarm=trapCompValClrAlarm, histCompVal=histCompVal, humAlarmInt=humAlarmInt, deviceType=deviceType, compValMax=compValMax)
