...
# Produced by pysmi-1.1.12 at Tue Jun  4 13:30:44 2024
...
NotificationType, iso, Unsigned32, Bits, Counter32, ObjectIdentity, Integer32, ModuleIdentity, Counter64, IpAddress, MibIdentifier, enterprises, Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "Unsigned32", "Bits", "Counter32", "ObjectIdentity", "Integer32", "ModuleIdentity", "Counter64", "IpAddress", "MibIdentifier", "enterprises", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
...
mibBuilder.exportSymbols("T3610-MIB", humInt=humInt, tempHystInt=tempHystInt, historyEntry=historyEntry, compValHighInt=compValHighInt, trapEmailErrDNS=trapEmailErrDNS, compValAlarm=compValAlarm, humAlarmInt=humAlarmInt, tempLowInt=tempLowInt, trapHumError=trapHumError, products=products, traps=traps, trapCompValHighAlarm=trapCompValHighAlarm, humLowInt=humLowInt, messageString=messageString, trapSOAPErrSocket=trapSOAPErrSocket, trapEmailErrAuth=trapEmailErrAuth, humMin=humMin, compValLowInt=compValLowInt, tempUnit=tempUnit, DisplayString=DisplayString, humMax=humMax, trapTest=trapTest, trapCompValError=trapCompValError, humUnit=humUnit, trapSOAPErrDNS=trapSOAPErrDNS, trapCompValClrAlarm=trapCompValClrAlarm, trapTempLowAlarm=trapTempLowAlarm, valuesInt=valuesInt, humHystInt=humHystInt, tempMax=tempMax, tempMin=tempMin, trapHumLowAlarm=trapHumLowAlarm, hum=hum, trapEmailErrLogin=trapEmailErrLogin, compValInt=compValInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTempHighAlarm=trapTempHighAlarm, temp=temp, compValAlarmInt=compValAlarmInt, tempAlarmInt=tempAlarmInt, comet=comet, trapEmailErrSocket=trapEmailErrSocket, compValMin=compValMin, trapCompValLowAlarm=trapCompValLowAlarm, t3610=t3610, tempAlarm=tempAlarm, sensorName=sensorName, trapEmailErrSome=trapEmailErrSome, histCompVal=histCompVal, trapTempClrAlarm=trapTempClrAlarm, histTemp=histTemp, compVal=compVal, historyTable=historyTable, compValUnit=compValUnit, deviceType=deviceType, humHighInt=humHighInt, trapNTPError=trapNTPError, serialNumber=serialNumber, trapHumHighAlarm=trapHumHighAlarm, humDelayInt=humDelayInt, tempHighInt=tempHighInt, humAlarm=humAlarm, tables=tables, compValMax=compValMax, compValHystInt=compValHystInt, trapSOAPErrFile=trapSOAPErrFile, trapTempError=trapTempError, values=values, settings=settings, tempInt=tempInt, pysmi_global=pysmi_global, histHum=histHum, trapHumClrAlarm=trapHumClrAlarm, tempDelayInt=tempDelayInt, compValDelayInt=compValDelayInt)
