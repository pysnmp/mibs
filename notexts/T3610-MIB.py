...
# Produced by pysmi-1.1.8 at Sat Jan 15 17:57:37 2022
...
Bits, NotificationType, Counter32, Counter64, TimeTicks, ObjectIdentity, NotificationType, IpAddress, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, enterprises, MibIdentifier, Unsigned32, iso, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "Counter32", "Counter64", "TimeTicks", "ObjectIdentity", "NotificationType", "IpAddress", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "enterprises", "MibIdentifier", "Unsigned32", "iso", "ModuleIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", compValAlarm=compValAlarm, compValMax=compValMax, temp=temp, tempUnit=tempUnit, compValLowInt=compValLowInt, humDelayInt=humDelayInt, serialNumber=serialNumber, trapTempLowAlarm=trapTempLowAlarm, humAlarm=humAlarm, compValAlarmInt=compValAlarmInt, trapTempClrAlarm=trapTempClrAlarm, compValMin=compValMin, trapCompValClrAlarm=trapCompValClrAlarm, trapHumHighAlarm=trapHumHighAlarm, DisplayString=DisplayString, trapHumError=trapHumError, trapNTPError=trapNTPError, trapSOAPErrDNS=trapSOAPErrDNS, humLowInt=humLowInt, trapEmailErrSocket=trapEmailErrSocket, trapCompValLowAlarm=trapCompValLowAlarm, comet=comet, trapHumLowAlarm=trapHumLowAlarm, humUnit=humUnit, trapHumClrAlarm=trapHumClrAlarm, histCompVal=histCompVal, trapSOAPErrFile=trapSOAPErrFile, trapSOAPErrDelivery=trapSOAPErrDelivery, traps=traps, pysmi_global=pysmi_global, valuesInt=valuesInt, compVal=compVal, trapEmailErrAuth=trapEmailErrAuth, histTemp=histTemp, humInt=humInt, tempAlarm=tempAlarm, trapEmailErrLogin=trapEmailErrLogin, humMin=humMin, compValInt=compValInt, trapTest=trapTest, messageString=messageString, trapCompValError=trapCompValError, tempLowInt=tempLowInt, compValHighInt=compValHighInt, humMax=humMax, tempMin=tempMin, histHum=histHum, hum=hum, humHighInt=humHighInt, tempHighInt=tempHighInt, historyEntry=historyEntry, trapCompValHighAlarm=trapCompValHighAlarm, tempDelayInt=tempDelayInt, trapSOAPErrSocket=trapSOAPErrSocket, deviceType=deviceType, humAlarmInt=humAlarmInt, trapEmailErrSome=trapEmailErrSome, compValDelayInt=compValDelayInt, tempAlarmInt=tempAlarmInt, compValUnit=compValUnit, tempMax=tempMax, tempHystInt=tempHystInt, humHystInt=humHystInt, products=products, t3610=t3610, historyTable=historyTable, trapEmailErrDNS=trapEmailErrDNS, trapTempHighAlarm=trapTempHighAlarm, sensorName=sensorName, compValHystInt=compValHystInt, trapTempError=trapTempError, tempInt=tempInt, tables=tables, values=values, settings=settings)
