...
# Produced by pysmi-1.1.8 at Thu Sep  8 09:13:18 2022
...
Integer32, ModuleIdentity, Unsigned32, NotificationType, ObjectIdentity, MibIdentifier, Counter64, TimeTicks, Counter32, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Gauge32, IpAddress, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "Unsigned32", "NotificationType", "ObjectIdentity", "MibIdentifier", "Counter64", "TimeTicks", "Counter32", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Gauge32", "IpAddress", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", trapTempLowAlarm=trapTempLowAlarm, trapHumLowAlarm=trapHumLowAlarm, valuesInt=valuesInt, tempHystInt=tempHystInt, messageString=messageString, humDelayInt=humDelayInt, tempMax=tempMax, values=values, trapTempClrAlarm=trapTempClrAlarm, compValMin=compValMin, tempAlarm=tempAlarm, humMin=humMin, tempDelayInt=tempDelayInt, humHystInt=humHystInt, compValHystInt=compValHystInt, histCompVal=histCompVal, trapSOAPErrDNS=trapSOAPErrDNS, trapSOAPErrFile=trapSOAPErrFile, trapTest=trapTest, trapCompValHighAlarm=trapCompValHighAlarm, humUnit=humUnit, tempUnit=tempUnit, deviceType=deviceType, humMax=humMax, trapCompValClrAlarm=trapCompValClrAlarm, trapCompValError=trapCompValError, comet=comet, tempLowInt=tempLowInt, compValLowInt=compValLowInt, t3610=t3610, sensorName=sensorName, trapNTPError=trapNTPError, products=products, trapEmailErrSocket=trapEmailErrSocket, trapTempError=trapTempError, temp=temp, pysmi_global=pysmi_global, tempInt=tempInt, compValAlarm=compValAlarm, tempAlarmInt=tempAlarmInt, humLowInt=humLowInt, compValHighInt=compValHighInt, histTemp=histTemp, trapEmailErrLogin=trapEmailErrLogin, settings=settings, DisplayString=DisplayString, trapSOAPErrSocket=trapSOAPErrSocket, trapSOAPErrDelivery=trapSOAPErrDelivery, trapHumHighAlarm=trapHumHighAlarm, trapCompValLowAlarm=trapCompValLowAlarm, tempHighInt=tempHighInt, trapHumClrAlarm=trapHumClrAlarm, trapEmailErrSome=trapEmailErrSome, tempMin=tempMin, tables=tables, trapEmailErrAuth=trapEmailErrAuth, compVal=compVal, humInt=humInt, humAlarmInt=humAlarmInt, compValDelayInt=compValDelayInt, trapEmailErrDNS=trapEmailErrDNS, historyTable=historyTable, compValUnit=compValUnit, compValInt=compValInt, serialNumber=serialNumber, traps=traps, historyEntry=historyEntry, histHum=histHum, compValAlarmInt=compValAlarmInt, humAlarm=humAlarm, compValMax=compValMax, trapHumError=trapHumError, trapTempHighAlarm=trapTempHighAlarm, hum=hum, humHighInt=humHighInt)
