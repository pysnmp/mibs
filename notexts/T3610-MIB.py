...
# Produced by pysmi-1.1.3 at Mon Nov 22 11:55:22 2021
...
Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, NotificationType, TimeTicks, Counter32, Counter64, Gauge32, ModuleIdentity, Bits, NotificationType, MibIdentifier, iso, Integer32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "NotificationType", "TimeTicks", "Counter32", "Counter64", "Gauge32", "ModuleIdentity", "Bits", "NotificationType", "MibIdentifier", "iso", "Integer32", "enterprises")
...
mibBuilder.exportSymbols("T3610-MIB", trapSOAPErrFile=trapSOAPErrFile, trapHumError=trapHumError, humDelayInt=humDelayInt, trapEmailErrSocket=trapEmailErrSocket, values=values, traps=traps, tempMin=tempMin, humMax=humMax, trapSOAPErrSocket=trapSOAPErrSocket, tempAlarm=tempAlarm, histTemp=histTemp, humHighInt=humHighInt, histHum=histHum, tables=tables, histCompVal=histCompVal, sensorName=sensorName, historyTable=historyTable, trapEmailErrLogin=trapEmailErrLogin, trapEmailErrDNS=trapEmailErrDNS, trapHumClrAlarm=trapHumClrAlarm, trapTest=trapTest, trapSOAPErrDelivery=trapSOAPErrDelivery, comet=comet, humMin=humMin, humAlarmInt=humAlarmInt, trapCompValClrAlarm=trapCompValClrAlarm, compValMax=compValMax, tempLowInt=tempLowInt, compValInt=compValInt, trapTempHighAlarm=trapTempHighAlarm, tempMax=tempMax, trapCompValHighAlarm=trapCompValHighAlarm, trapTempClrAlarm=trapTempClrAlarm, compValDelayInt=compValDelayInt, tempHighInt=tempHighInt, trapHumHighAlarm=trapHumHighAlarm, pysmi_global=pysmi_global, trapCompValLowAlarm=trapCompValLowAlarm, compValHighInt=compValHighInt, valuesInt=valuesInt, humUnit=humUnit, humLowInt=humLowInt, settings=settings, trapEmailErrSome=trapEmailErrSome, trapHumLowAlarm=trapHumLowAlarm, hum=hum, trapTempError=trapTempError, trapSOAPErrDNS=trapSOAPErrDNS, trapEmailErrAuth=trapEmailErrAuth, t3610=t3610, compValHystInt=compValHystInt, compValMin=compValMin, tempHystInt=tempHystInt, tempUnit=tempUnit, trapCompValError=trapCompValError, temp=temp, DisplayString=DisplayString, tempInt=tempInt, tempAlarmInt=tempAlarmInt, trapNTPError=trapNTPError, compValLowInt=compValLowInt, trapTempLowAlarm=trapTempLowAlarm, serialNumber=serialNumber, compVal=compVal, compValAlarmInt=compValAlarmInt, humHystInt=humHystInt, compValAlarm=compValAlarm, tempDelayInt=tempDelayInt, messageString=messageString, deviceType=deviceType, historyEntry=historyEntry, compValUnit=compValUnit, humInt=humInt, products=products, humAlarm=humAlarm)
