...
# Produced by pysmi-1.1.12 at Mon Jun  3 12:20:53 2024
...
Integer32, Bits, Counter64, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, MibIdentifier, Counter32, Unsigned32, iso, TimeTicks, NotificationType, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "Counter64", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "MibIdentifier", "Counter32", "Unsigned32", "iso", "TimeTicks", "NotificationType", "ObjectIdentity", "IpAddress")
...
mibBuilder.exportSymbols("T3610-MIB", tempMax=tempMax, deviceType=deviceType, tempInt=tempInt, trapEmailErrDNS=trapEmailErrDNS, trapSOAPErrFile=trapSOAPErrFile, trapTempHighAlarm=trapTempHighAlarm, trapEmailErrSocket=trapEmailErrSocket, tempUnit=tempUnit, tempHystInt=tempHystInt, trapCompValLowAlarm=trapCompValLowAlarm, tables=tables, hum=hum, tempAlarm=tempAlarm, humAlarm=humAlarm, humMin=humMin, compValAlarm=compValAlarm, humHystInt=humHystInt, trapTest=trapTest, trapCompValHighAlarm=trapCompValHighAlarm, trapHumLowAlarm=trapHumLowAlarm, sensorName=sensorName, comet=comet, compValLowInt=compValLowInt, trapTempError=trapTempError, valuesInt=valuesInt, t3610=t3610, pysmi_global=pysmi_global, trapNTPError=trapNTPError, compValMin=compValMin, compValAlarmInt=compValAlarmInt, tempHighInt=tempHighInt, trapSOAPErrDNS=trapSOAPErrDNS, compValDelayInt=compValDelayInt, compValMax=compValMax, humInt=humInt, values=values, trapCompValClrAlarm=trapCompValClrAlarm, temp=temp, humAlarmInt=humAlarmInt, trapHumHighAlarm=trapHumHighAlarm, trapTempClrAlarm=trapTempClrAlarm, DisplayString=DisplayString, tempAlarmInt=tempAlarmInt, compValInt=compValInt, historyEntry=historyEntry, messageString=messageString, humUnit=humUnit, histCompVal=histCompVal, humLowInt=humLowInt, tempLowInt=tempLowInt, humMax=humMax, histHum=histHum, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrSocket=trapSOAPErrSocket, trapSOAPErrDelivery=trapSOAPErrDelivery, trapCompValError=trapCompValError, tempDelayInt=tempDelayInt, traps=traps, trapHumClrAlarm=trapHumClrAlarm, trapHumError=trapHumError, compVal=compVal, tempMin=tempMin, trapEmailErrLogin=trapEmailErrLogin, compValUnit=compValUnit, serialNumber=serialNumber, compValHystInt=compValHystInt, histTemp=histTemp, trapTempLowAlarm=trapTempLowAlarm, trapEmailErrSome=trapEmailErrSome, products=products, humDelayInt=humDelayInt, settings=settings, historyTable=historyTable, compValHighInt=compValHighInt, humHighInt=humHighInt)
