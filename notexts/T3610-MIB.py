...
# Produced by pysmi-1.1.12 at Fri Jul 19 09:42:32 2024
...
TimeTicks, MibIdentifier, Gauge32, Integer32, NotificationType, IpAddress, NotificationType, Bits, Counter64, iso, ModuleIdentity, ObjectIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibIdentifier", "Gauge32", "Integer32", "NotificationType", "IpAddress", "NotificationType", "Bits", "Counter64", "iso", "ModuleIdentity", "ObjectIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "enterprises")
...
mibBuilder.exportSymbols("T3610-MIB", compValInt=compValInt, humInt=humInt, trapEmailErrLogin=trapEmailErrLogin, trapNTPError=trapNTPError, histTemp=histTemp, compValAlarmInt=compValAlarmInt, tempLowInt=tempLowInt, t3610=t3610, valuesInt=valuesInt, settings=settings, humLowInt=humLowInt, compValHighInt=compValHighInt, trapSOAPErrSocket=trapSOAPErrSocket, traps=traps, humAlarm=humAlarm, compVal=compVal, tempMin=tempMin, histHum=histHum, tempAlarm=tempAlarm, compValMax=compValMax, humMax=humMax, tempAlarmInt=tempAlarmInt, tempHighInt=tempHighInt, humUnit=humUnit, trapTest=trapTest, trapTempHighAlarm=trapTempHighAlarm, compValAlarm=compValAlarm, humMin=humMin, trapCompValClrAlarm=trapCompValClrAlarm, trapTempError=trapTempError, tempUnit=tempUnit, trapHumHighAlarm=trapHumHighAlarm, trapCompValError=trapCompValError, trapHumLowAlarm=trapHumLowAlarm, messageString=messageString, tempDelayInt=tempDelayInt, trapEmailErrSome=trapEmailErrSome, trapTempLowAlarm=trapTempLowAlarm, sensorName=sensorName, trapHumError=trapHumError, compValUnit=compValUnit, tempMax=tempMax, humHighInt=humHighInt, tempHystInt=tempHystInt, humAlarmInt=humAlarmInt, humDelayInt=humDelayInt, trapEmailErrSocket=trapEmailErrSocket, tables=tables, DisplayString=DisplayString, trapSOAPErrDNS=trapSOAPErrDNS, values=values, deviceType=deviceType, compValDelayInt=compValDelayInt, products=products, historyTable=historyTable, hum=hum, trapEmailErrDNS=trapEmailErrDNS, trapSOAPErrDelivery=trapSOAPErrDelivery, trapHumClrAlarm=trapHumClrAlarm, serialNumber=serialNumber, trapSOAPErrFile=trapSOAPErrFile, pysmi_global=pysmi_global, comet=comet, tempInt=tempInt, compValHystInt=compValHystInt, trapEmailErrAuth=trapEmailErrAuth, trapCompValHighAlarm=trapCompValHighAlarm, temp=temp, compValLowInt=compValLowInt, humHystInt=humHystInt, historyEntry=historyEntry, compValMin=compValMin, trapCompValLowAlarm=trapCompValLowAlarm, trapTempClrAlarm=trapTempClrAlarm, histCompVal=histCompVal)
