...
# Produced by pysmi-1.1.3 at Wed Dec  1 16:42:49 2021
...
NotificationType, ObjectIdentity, Bits, Gauge32, Counter32, iso, NotificationType, Integer32, Counter64, Unsigned32, IpAddress, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, TimeTicks, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "Bits", "Gauge32", "Counter32", "iso", "NotificationType", "Integer32", "Counter64", "Unsigned32", "IpAddress", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "TimeTicks", "MibIdentifier")
...
mibBuilder.exportSymbols("T3610-MIB", histTemp=histTemp, trapHumError=trapHumError, tempMin=tempMin, comet=comet, tempAlarmInt=tempAlarmInt, tempHighInt=tempHighInt, t3610=t3610, humHystInt=humHystInt, trapEmailErrSome=trapEmailErrSome, tempInt=tempInt, compValAlarmInt=compValAlarmInt, tempHystInt=tempHystInt, histCompVal=histCompVal, trapTempHighAlarm=trapTempHighAlarm, pysmi_global=pysmi_global, trapSOAPErrFile=trapSOAPErrFile, DisplayString=DisplayString, compVal=compVal, tempAlarm=tempAlarm, tempUnit=tempUnit, valuesInt=valuesInt, historyTable=historyTable, trapEmailErrDNS=trapEmailErrDNS, compValMax=compValMax, tempDelayInt=tempDelayInt, trapCompValHighAlarm=trapCompValHighAlarm, compValMin=compValMin, humHighInt=humHighInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTest=trapTest, trapEmailErrLogin=trapEmailErrLogin, trapTempError=trapTempError, compValUnit=compValUnit, tempMax=tempMax, trapHumHighAlarm=trapHumHighAlarm, values=values, trapTempClrAlarm=trapTempClrAlarm, humInt=humInt, compValDelayInt=compValDelayInt, trapHumLowAlarm=trapHumLowAlarm, trapCompValLowAlarm=trapCompValLowAlarm, humUnit=humUnit, serialNumber=serialNumber, humLowInt=humLowInt, trapHumClrAlarm=trapHumClrAlarm, humAlarmInt=humAlarmInt, sensorName=sensorName, humMax=humMax, hum=hum, deviceType=deviceType, compValHighInt=compValHighInt, trapNTPError=trapNTPError, historyEntry=historyEntry, histHum=histHum, products=products, settings=settings, compValLowInt=compValLowInt, compValHystInt=compValHystInt, trapEmailErrAuth=trapEmailErrAuth, temp=temp, compValInt=compValInt, trapEmailErrSocket=trapEmailErrSocket, compValAlarm=compValAlarm, trapSOAPErrDNS=trapSOAPErrDNS, tempLowInt=tempLowInt, traps=traps, trapSOAPErrSocket=trapSOAPErrSocket, messageString=messageString, humAlarm=humAlarm, humMin=humMin, trapCompValClrAlarm=trapCompValClrAlarm, trapCompValError=trapCompValError, humDelayInt=humDelayInt, tables=tables, trapTempLowAlarm=trapTempLowAlarm)
