...
# Produced by pysmi-1.1.10 at Fri Nov 10 09:16:36 2023
...
Counter32, ModuleIdentity, TimeTicks, Unsigned32, enterprises, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity, MibIdentifier, NotificationType, IpAddress, NotificationType, Counter64, Integer32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "TimeTicks", "Unsigned32", "enterprises", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity", "MibIdentifier", "NotificationType", "IpAddress", "NotificationType", "Counter64", "Integer32", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", trapEmailErrDNS=trapEmailErrDNS, compVal=compVal, DisplayString=DisplayString, compValMin=compValMin, compValMax=compValMax, tempLowInt=tempLowInt, products=products, tempHighInt=tempHighInt, trapCompValHighAlarm=trapCompValHighAlarm, t3610=t3610, histHum=histHum, humLowInt=humLowInt, trapNTPError=trapNTPError, tempMin=tempMin, historyEntry=historyEntry, values=values, humHystInt=humHystInt, trapTempHighAlarm=trapTempHighAlarm, tables=tables, trapHumError=trapHumError, tempAlarm=tempAlarm, trapEmailErrSocket=trapEmailErrSocket, tempMax=tempMax, humUnit=humUnit, compValDelayInt=compValDelayInt, trapSOAPErrDNS=trapSOAPErrDNS, compValHystInt=compValHystInt, humDelayInt=humDelayInt, historyTable=historyTable, trapTempError=trapTempError, pysmi_global=pysmi_global, serialNumber=serialNumber, tempInt=tempInt, traps=traps, histTemp=histTemp, valuesInt=valuesInt, trapEmailErrLogin=trapEmailErrLogin, humMin=humMin, trapCompValError=trapCompValError, settings=settings, compValUnit=compValUnit, tempAlarmInt=tempAlarmInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTempClrAlarm=trapTempClrAlarm, compValInt=compValInt, compValAlarm=compValAlarm, compValLowInt=compValLowInt, compValAlarmInt=compValAlarmInt, tempUnit=tempUnit, temp=temp, trapHumHighAlarm=trapHumHighAlarm, hum=hum, trapCompValClrAlarm=trapCompValClrAlarm, humAlarm=humAlarm, trapTempLowAlarm=trapTempLowAlarm, tempDelayInt=tempDelayInt, humAlarmInt=humAlarmInt, humInt=humInt, compValHighInt=compValHighInt, trapSOAPErrFile=trapSOAPErrFile, trapCompValLowAlarm=trapCompValLowAlarm, tempHystInt=tempHystInt, sensorName=sensorName, deviceType=deviceType, histCompVal=histCompVal, trapEmailErrAuth=trapEmailErrAuth, trapHumLowAlarm=trapHumLowAlarm, humHighInt=humHighInt, trapHumClrAlarm=trapHumClrAlarm, humMax=humMax, trapSOAPErrSocket=trapSOAPErrSocket, trapEmailErrSome=trapEmailErrSome, trapTest=trapTest, comet=comet, messageString=messageString)
