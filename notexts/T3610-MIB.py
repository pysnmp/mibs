...
# Produced by pysmi-1.1.12 at Tue Jun  4 10:06:39 2024
...
iso, MibIdentifier, Unsigned32, enterprises, ModuleIdentity, NotificationType, TimeTicks, Bits, Integer32, Counter64, NotificationType, Gauge32, ObjectIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "Unsigned32", "enterprises", "ModuleIdentity", "NotificationType", "TimeTicks", "Bits", "Integer32", "Counter64", "NotificationType", "Gauge32", "ObjectIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
...
mibBuilder.exportSymbols("T3610-MIB", trapHumClrAlarm=trapHumClrAlarm, tempMin=tempMin, deviceType=deviceType, historyEntry=historyEntry, compValAlarm=compValAlarm, sensorName=sensorName, trapSOAPErrSocket=trapSOAPErrSocket, trapEmailErrSocket=trapEmailErrSocket, compValMin=compValMin, traps=traps, humAlarmInt=humAlarmInt, hum=hum, trapHumError=trapHumError, messageString=messageString, tempHighInt=tempHighInt, trapEmailErrSome=trapEmailErrSome, histCompVal=histCompVal, products=products, tempMax=tempMax, humLowInt=humLowInt, compValMax=compValMax, valuesInt=valuesInt, humHighInt=humHighInt, trapCompValClrAlarm=trapCompValClrAlarm, t3610=t3610, trapTempError=trapTempError, humMax=humMax, tempHystInt=tempHystInt, trapCompValLowAlarm=trapCompValLowAlarm, trapTempClrAlarm=trapTempClrAlarm, humInt=humInt, settings=settings, histHum=histHum, tempAlarm=tempAlarm, trapTest=trapTest, trapCompValHighAlarm=trapCompValHighAlarm, trapHumLowAlarm=trapHumLowAlarm, trapTempLowAlarm=trapTempLowAlarm, compValLowInt=compValLowInt, trapEmailErrLogin=trapEmailErrLogin, historyTable=historyTable, compValHystInt=compValHystInt, tempLowInt=tempLowInt, humHystInt=humHystInt, trapSOAPErrDNS=trapSOAPErrDNS, humAlarm=humAlarm, histTemp=histTemp, pysmi_global=pysmi_global, DisplayString=DisplayString, compValDelayInt=compValDelayInt, humUnit=humUnit, humMin=humMin, compValAlarmInt=compValAlarmInt, compVal=compVal, trapEmailErrAuth=trapEmailErrAuth, compValHighInt=compValHighInt, trapSOAPErrFile=trapSOAPErrFile, temp=temp, compValUnit=compValUnit, compValInt=compValInt, comet=comet, trapTempHighAlarm=trapTempHighAlarm, tempInt=tempInt, trapNTPError=trapNTPError, trapCompValError=trapCompValError, tables=tables, tempDelayInt=tempDelayInt, tempUnit=tempUnit, humDelayInt=humDelayInt, serialNumber=serialNumber, trapEmailErrDNS=trapEmailErrDNS, trapHumHighAlarm=trapHumHighAlarm, values=values, tempAlarmInt=tempAlarmInt, trapSOAPErrDelivery=trapSOAPErrDelivery)
