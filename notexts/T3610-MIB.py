...
# Produced by pysmi-1.1.12 at Mon Jul  1 11:10:58 2024
...
Gauge32, Unsigned32, MibIdentifier, NotificationType, TimeTicks, ObjectIdentity, Counter64, enterprises, Integer32, Bits, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, IpAddress, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Unsigned32", "MibIdentifier", "NotificationType", "TimeTicks", "ObjectIdentity", "Counter64", "enterprises", "Integer32", "Bits", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "IpAddress", "NotificationType", "iso")
...
mibBuilder.exportSymbols("T3610-MIB", tables=tables, valuesInt=valuesInt, sensorName=sensorName, humMin=humMin, humMax=humMax, compValAlarmInt=compValAlarmInt, pysmi_global=pysmi_global, histHum=histHum, trapTest=trapTest, compValDelayInt=compValDelayInt, trapEmailErrSocket=trapEmailErrSocket, trapHumLowAlarm=trapHumLowAlarm, serialNumber=serialNumber, compValHystInt=compValHystInt, historyTable=historyTable, compValUnit=compValUnit, humDelayInt=humDelayInt, trapNTPError=trapNTPError, tempDelayInt=tempDelayInt, t3610=t3610, humUnit=humUnit, trapHumError=trapHumError, humHighInt=humHighInt, tempMax=tempMax, trapCompValLowAlarm=trapCompValLowAlarm, trapTempError=trapTempError, trapEmailErrSome=trapEmailErrSome, messageString=messageString, tempAlarm=tempAlarm, trapHumHighAlarm=trapHumHighAlarm, tempMin=tempMin, trapSOAPErrDelivery=trapSOAPErrDelivery, compValInt=compValInt, trapSOAPErrDNS=trapSOAPErrDNS, compValHighInt=compValHighInt, tempUnit=tempUnit, humLowInt=humLowInt, deviceType=deviceType, trapSOAPErrSocket=trapSOAPErrSocket, trapEmailErrLogin=trapEmailErrLogin, compValMin=compValMin, histCompVal=histCompVal, hum=hum, trapHumClrAlarm=trapHumClrAlarm, compValLowInt=compValLowInt, compVal=compVal, traps=traps, tempAlarmInt=tempAlarmInt, tempHighInt=tempHighInt, trapTempClrAlarm=trapTempClrAlarm, temp=temp, products=products, DisplayString=DisplayString, comet=comet, humHystInt=humHystInt, trapTempLowAlarm=trapTempLowAlarm, humAlarmInt=humAlarmInt, humAlarm=humAlarm, histTemp=histTemp, trapEmailErrAuth=trapEmailErrAuth, trapEmailErrDNS=trapEmailErrDNS, compValMax=compValMax, tempInt=tempInt, tempHystInt=tempHystInt, trapTempHighAlarm=trapTempHighAlarm, trapCompValError=trapCompValError, historyEntry=historyEntry, values=values, trapCompValClrAlarm=trapCompValClrAlarm, trapSOAPErrFile=trapSOAPErrFile, humInt=humInt, settings=settings, trapCompValHighAlarm=trapCompValHighAlarm, tempLowInt=tempLowInt, compValAlarm=compValAlarm)
