...
# Produced by pysmi-1.1.8 at Fri Jan  7 17:40:14 2022
...
NotificationType, Counter32, enterprises, Bits, TimeTicks, Integer32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, IpAddress, MibIdentifier, Counter64, Gauge32, iso, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "enterprises", "Bits", "TimeTicks", "Integer32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "IpAddress", "MibIdentifier", "Counter64", "Gauge32", "iso", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", trapTest=trapTest, DisplayString=DisplayString, humMin=humMin, humAlarmInt=humAlarmInt, trapSOAPErrDNS=trapSOAPErrDNS, trapHumClrAlarm=trapHumClrAlarm, tempMin=tempMin, deviceType=deviceType, humUnit=humUnit, tempHystInt=tempHystInt, historyTable=historyTable, tables=tables, humMax=humMax, traps=traps, historyEntry=historyEntry, trapNTPError=trapNTPError, trapSOAPErrFile=trapSOAPErrFile, trapHumHighAlarm=trapHumHighAlarm, histCompVal=histCompVal, trapEmailErrAuth=trapEmailErrAuth, valuesInt=valuesInt, pysmi_global=pysmi_global, compVal=compVal, tempHighInt=tempHighInt, values=values, humHystInt=humHystInt, trapSOAPErrSocket=trapSOAPErrSocket, trapTempError=trapTempError, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTempLowAlarm=trapTempLowAlarm, compValHystInt=compValHystInt, settings=settings, humHighInt=humHighInt, trapEmailErrSome=trapEmailErrSome, trapHumError=trapHumError, trapCompValHighAlarm=trapCompValHighAlarm, tempDelayInt=tempDelayInt, trapCompValLowAlarm=trapCompValLowAlarm, messageString=messageString, histHum=histHum, humDelayInt=humDelayInt, trapEmailErrSocket=trapEmailErrSocket, trapTempHighAlarm=trapTempHighAlarm, tempMax=tempMax, compValHighInt=compValHighInt, trapCompValClrAlarm=trapCompValClrAlarm, compValDelayInt=compValDelayInt, trapEmailErrDNS=trapEmailErrDNS, hum=hum, comet=comet, compValAlarm=compValAlarm, tempAlarm=tempAlarm, compValAlarmInt=compValAlarmInt, tempInt=tempInt, trapTempClrAlarm=trapTempClrAlarm, tempUnit=tempUnit, products=products, temp=temp, humAlarm=humAlarm, sensorName=sensorName, trapHumLowAlarm=trapHumLowAlarm, compValMin=compValMin, trapEmailErrLogin=trapEmailErrLogin, t3610=t3610, tempLowInt=tempLowInt, humLowInt=humLowInt, histTemp=histTemp, compValUnit=compValUnit, tempAlarmInt=tempAlarmInt, humInt=humInt, compValLowInt=compValLowInt, compValMax=compValMax, trapCompValError=trapCompValError, compValInt=compValInt, serialNumber=serialNumber)
