...
# Produced by pysmi-1.1.8 at Thu Sep  8 10:12:34 2022
...
TimeTicks, Unsigned32, IpAddress, NotificationType, ObjectIdentity, ModuleIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, Counter64, Integer32, iso, NotificationType, enterprises, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "IpAddress", "NotificationType", "ObjectIdentity", "ModuleIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "Counter64", "Integer32", "iso", "NotificationType", "enterprises", "MibIdentifier")
...
mibBuilder.exportSymbols("T3610-MIB", compValMin=compValMin, trapNTPError=trapNTPError, trapSOAPErrFile=trapSOAPErrFile, compValHighInt=compValHighInt, trapCompValLowAlarm=trapCompValLowAlarm, settings=settings, tempAlarm=tempAlarm, serialNumber=serialNumber, tempHighInt=tempHighInt, trapCompValHighAlarm=trapCompValHighAlarm, tempUnit=tempUnit, trapEmailErrSocket=trapEmailErrSocket, trapCompValClrAlarm=trapCompValClrAlarm, trapHumError=trapHumError, compValDelayInt=compValDelayInt, humMin=humMin, historyTable=historyTable, trapTempClrAlarm=trapTempClrAlarm, messageString=messageString, humHighInt=humHighInt, traps=traps, trapTest=trapTest, pysmi_global=pysmi_global, compValMax=compValMax, humLowInt=humLowInt, trapHumClrAlarm=trapHumClrAlarm, trapEmailErrLogin=trapEmailErrLogin, trapTempLowAlarm=trapTempLowAlarm, trapCompValError=trapCompValError, tempAlarmInt=tempAlarmInt, humUnit=humUnit, tempHystInt=tempHystInt, histTemp=histTemp, trapTempHighAlarm=trapTempHighAlarm, temp=temp, sensorName=sensorName, trapEmailErrAuth=trapEmailErrAuth, trapEmailErrDNS=trapEmailErrDNS, compValHystInt=compValHystInt, deviceType=deviceType, trapHumHighAlarm=trapHumHighAlarm, valuesInt=valuesInt, tempDelayInt=tempDelayInt, tempMin=tempMin, tempMax=tempMax, humMax=humMax, trapEmailErrSome=trapEmailErrSome, tempInt=tempInt, humHystInt=humHystInt, DisplayString=DisplayString, trapSOAPErrSocket=trapSOAPErrSocket, trapSOAPErrDelivery=trapSOAPErrDelivery, compValUnit=compValUnit, t3610=t3610, comet=comet, hum=hum, compValLowInt=compValLowInt, compValInt=compValInt, humAlarm=humAlarm, humDelayInt=humDelayInt, compValAlarmInt=compValAlarmInt, products=products, values=values, tables=tables, tempLowInt=tempLowInt, historyEntry=historyEntry, trapSOAPErrDNS=trapSOAPErrDNS, humAlarmInt=humAlarmInt, trapHumLowAlarm=trapHumLowAlarm, trapTempError=trapTempError, humInt=humInt, compVal=compVal, histHum=histHum, histCompVal=histCompVal, compValAlarm=compValAlarm)
