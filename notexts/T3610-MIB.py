...
# Produced by pysmi-1.1.12 at Wed Jul  3 13:03:40 2024
...
Unsigned32, iso, NotificationType, TimeTicks, ModuleIdentity, enterprises, NotificationType, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, IpAddress, Gauge32, Counter32, ObjectIdentity, Integer32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "iso", "NotificationType", "TimeTicks", "ModuleIdentity", "enterprises", "NotificationType", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "IpAddress", "Gauge32", "Counter32", "ObjectIdentity", "Integer32", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", tempHighInt=tempHighInt, serialNumber=serialNumber, trapEmailErrSome=trapEmailErrSome, trapTempHighAlarm=trapTempHighAlarm, products=products, compValLowInt=compValLowInt, trapCompValLowAlarm=trapCompValLowAlarm, trapEmailErrLogin=trapEmailErrLogin, humMax=humMax, comet=comet, humInt=humInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTempError=trapTempError, historyTable=historyTable, compVal=compVal, hum=hum, trapCompValError=trapCompValError, tempAlarmInt=tempAlarmInt, messageString=messageString, trapNTPError=trapNTPError, historyEntry=historyEntry, trapCompValHighAlarm=trapCompValHighAlarm, humAlarm=humAlarm, trapHumLowAlarm=trapHumLowAlarm, trapCompValClrAlarm=trapCompValClrAlarm, compValInt=compValInt, humDelayInt=humDelayInt, trapHumClrAlarm=trapHumClrAlarm, tempMin=tempMin, humMin=humMin, tempInt=tempInt, compValAlarmInt=compValAlarmInt, humLowInt=humLowInt, compValMax=compValMax, trapSOAPErrDNS=trapSOAPErrDNS, values=values, histTemp=histTemp, trapTempClrAlarm=trapTempClrAlarm, tempAlarm=tempAlarm, trapEmailErrSocket=trapEmailErrSocket, compValMin=compValMin, histCompVal=histCompVal, pysmi_global=pysmi_global, settings=settings, DisplayString=DisplayString, tempMax=tempMax, humAlarmInt=humAlarmInt, trapSOAPErrFile=trapSOAPErrFile, humHystInt=humHystInt, compValUnit=compValUnit, compValHystInt=compValHystInt, trapEmailErrDNS=trapEmailErrDNS, valuesInt=valuesInt, traps=traps, trapTest=trapTest, compValDelayInt=compValDelayInt, humHighInt=humHighInt, tempHystInt=tempHystInt, trapSOAPErrSocket=trapSOAPErrSocket, tempDelayInt=tempDelayInt, temp=temp, tempLowInt=tempLowInt, compValHighInt=compValHighInt, t3610=t3610, sensorName=sensorName, trapEmailErrAuth=trapEmailErrAuth, trapTempLowAlarm=trapTempLowAlarm, histHum=histHum, deviceType=deviceType, trapHumError=trapHumError, trapHumHighAlarm=trapHumHighAlarm, compValAlarm=compValAlarm, humUnit=humUnit, tempUnit=tempUnit, tables=tables)
