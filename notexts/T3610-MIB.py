...
# Produced by pysmi-1.1.12 at Thu Apr  4 10:09:21 2024
...
NotificationType, ObjectIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, Unsigned32, IpAddress, TimeTicks, Gauge32, Bits, MibIdentifier, enterprises, ModuleIdentity, iso, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "Unsigned32", "IpAddress", "TimeTicks", "Gauge32", "Bits", "MibIdentifier", "enterprises", "ModuleIdentity", "iso", "Counter32")
...
mibBuilder.exportSymbols("T3610-MIB", tempAlarmInt=tempAlarmInt, humInt=humInt, compValAlarm=compValAlarm, humMin=humMin, compValHystInt=compValHystInt, compValDelayInt=compValDelayInt, compValMin=compValMin, DisplayString=DisplayString, humMax=humMax, humAlarmInt=humAlarmInt, tempHystInt=tempHystInt, trapEmailErrDNS=trapEmailErrDNS, trapTempLowAlarm=trapTempLowAlarm, tempAlarm=tempAlarm, tables=tables, traps=traps, trapHumHighAlarm=trapHumHighAlarm, compValLowInt=compValLowInt, compVal=compVal, sensorName=sensorName, historyTable=historyTable, trapCompValLowAlarm=trapCompValLowAlarm, messageString=messageString, compValAlarmInt=compValAlarmInt, trapTempClrAlarm=trapTempClrAlarm, trapHumClrAlarm=trapHumClrAlarm, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValClrAlarm=trapCompValClrAlarm, trapTempError=trapTempError, trapEmailErrLogin=trapEmailErrLogin, trapSOAPErrFile=trapSOAPErrFile, tempHighInt=tempHighInt, tempDelayInt=tempDelayInt, histHum=histHum, trapCompValHighAlarm=trapCompValHighAlarm, tempMax=tempMax, serialNumber=serialNumber, histCompVal=histCompVal, trapHumLowAlarm=trapHumLowAlarm, trapNTPError=trapNTPError, temp=temp, humHystInt=humHystInt, trapCompValError=trapCompValError, humDelayInt=humDelayInt, tempLowInt=tempLowInt, compValMax=compValMax, compValUnit=compValUnit, historyEntry=historyEntry, trapEmailErrSocket=trapEmailErrSocket, trapTempHighAlarm=trapTempHighAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, compValHighInt=compValHighInt, hum=hum, trapTest=trapTest, trapHumError=trapHumError, compValInt=compValInt, deviceType=deviceType, trapEmailErrAuth=trapEmailErrAuth, tempUnit=tempUnit, humHighInt=humHighInt, humAlarm=humAlarm, histTemp=histTemp, trapSOAPErrDNS=trapSOAPErrDNS, values=values, pysmi_global=pysmi_global, humUnit=humUnit, tempMin=tempMin, settings=settings, humLowInt=humLowInt, tempInt=tempInt, comet=comet, valuesInt=valuesInt, trapEmailErrSome=trapEmailErrSome, products=products, t3610=t3610)
