...
# Produced by pysmi-1.1.8 at Sat Jan 15 23:44:18 2022
...
Counter64, MibIdentifier, enterprises, IpAddress, TimeTicks, Integer32, iso, Unsigned32, Bits, NotificationType, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, Counter32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibIdentifier", "enterprises", "IpAddress", "TimeTicks", "Integer32", "iso", "Unsigned32", "Bits", "NotificationType", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "Counter32", "ModuleIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", trapTempLowAlarm=trapTempLowAlarm, serialNumber=serialNumber, compValHystInt=compValHystInt, humHighInt=humHighInt, trapSOAPErrDNS=trapSOAPErrDNS, hum=hum, compValDelayInt=compValDelayInt, settings=settings, tempMax=tempMax, trapHumClrAlarm=trapHumClrAlarm, trapSOAPErrFile=trapSOAPErrFile, tempInt=tempInt, compValUnit=compValUnit, histTemp=histTemp, trapTest=trapTest, traps=traps, compValMin=compValMin, tempHighInt=tempHighInt, humDelayInt=humDelayInt, humMax=humMax, trapNTPError=trapNTPError, tempAlarmInt=tempAlarmInt, histHum=histHum, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrSocket=trapSOAPErrSocket, DisplayString=DisplayString, trapTempHighAlarm=trapTempHighAlarm, t3610=t3610, tempDelayInt=tempDelayInt, comet=comet, histCompVal=histCompVal, trapCompValLowAlarm=trapCompValLowAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, products=products, trapHumLowAlarm=trapHumLowAlarm, tempHystInt=tempHystInt, valuesInt=valuesInt, tempLowInt=tempLowInt, trapEmailErrLogin=trapEmailErrLogin, humMin=humMin, historyEntry=historyEntry, messageString=messageString, compValHighInt=compValHighInt, compValLowInt=compValLowInt, trapEmailErrSome=trapEmailErrSome, tempAlarm=tempAlarm, compValAlarmInt=compValAlarmInt, humLowInt=humLowInt, compValAlarm=compValAlarm, tables=tables, humHystInt=humHystInt, humInt=humInt, trapCompValError=trapCompValError, historyTable=historyTable, compVal=compVal, deviceType=deviceType, trapCompValHighAlarm=trapCompValHighAlarm, temp=temp, pysmi_global=pysmi_global, tempUnit=tempUnit, trapTempClrAlarm=trapTempClrAlarm, trapCompValClrAlarm=trapCompValClrAlarm, trapHumError=trapHumError, humAlarmInt=humAlarmInt, values=values, compValInt=compValInt, trapHumHighAlarm=trapHumHighAlarm, tempMin=tempMin, sensorName=sensorName, trapEmailErrSocket=trapEmailErrSocket, compValMax=compValMax, humUnit=humUnit, humAlarm=humAlarm, trapEmailErrDNS=trapEmailErrDNS, trapTempError=trapTempError)
