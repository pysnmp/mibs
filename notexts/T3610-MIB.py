...
# Produced by pysmi-1.1.8 at Tue Feb  8 23:12:40 2022
...
MibIdentifier, NotificationType, Counter32, Bits, TimeTicks, Counter64, enterprises, Gauge32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, ObjectIdentity, NotificationType, IpAddress, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "Counter32", "Bits", "TimeTicks", "Counter64", "enterprises", "Gauge32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "ObjectIdentity", "NotificationType", "IpAddress", "Integer32", "iso")
...
mibBuilder.exportSymbols("T3610-MIB", products=products, compValHighInt=compValHighInt, trapHumLowAlarm=trapHumLowAlarm, compValMin=compValMin, humMax=humMax, trapHumHighAlarm=trapHumHighAlarm, trapCompValHighAlarm=trapCompValHighAlarm, trapTest=trapTest, trapTempHighAlarm=trapTempHighAlarm, trapTempError=trapTempError, humHighInt=humHighInt, valuesInt=valuesInt, tables=tables, trapCompValError=trapCompValError, deviceType=deviceType, humMin=humMin, trapEmailErrSome=trapEmailErrSome, humDelayInt=humDelayInt, compValAlarm=compValAlarm, trapCompValLowAlarm=trapCompValLowAlarm, tempMin=tempMin, compValDelayInt=compValDelayInt, pysmi_global=pysmi_global, tempMax=tempMax, tempLowInt=tempLowInt, trapEmailErrLogin=trapEmailErrLogin, humLowInt=humLowInt, historyEntry=historyEntry, compVal=compVal, trapEmailErrSocket=trapEmailErrSocket, values=values, comet=comet, compValUnit=compValUnit, compValMax=compValMax, humAlarm=humAlarm, sensorName=sensorName, compValHystInt=compValHystInt, histCompVal=histCompVal, trapSOAPErrDNS=trapSOAPErrDNS, t3610=t3610, tempAlarm=tempAlarm, historyTable=historyTable, trapHumClrAlarm=trapHumClrAlarm, histHum=histHum, humAlarmInt=humAlarmInt, hum=hum, traps=traps, trapSOAPErrFile=trapSOAPErrFile, trapEmailErrAuth=trapEmailErrAuth, humUnit=humUnit, compValAlarmInt=compValAlarmInt, trapCompValClrAlarm=trapCompValClrAlarm, histTemp=histTemp, messageString=messageString, trapHumError=trapHumError, settings=settings, trapTempLowAlarm=trapTempLowAlarm, DisplayString=DisplayString, tempAlarmInt=tempAlarmInt, tempHystInt=tempHystInt, trapSOAPErrSocket=trapSOAPErrSocket, tempUnit=tempUnit, tempDelayInt=tempDelayInt, tempInt=tempInt, compValLowInt=compValLowInt, temp=temp, humInt=humInt, compValInt=compValInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTempClrAlarm=trapTempClrAlarm, humHystInt=humHystInt, tempHighInt=tempHighInt, serialNumber=serialNumber, trapNTPError=trapNTPError, trapEmailErrDNS=trapEmailErrDNS)
