...
# Produced by pysmi-1.1.12 at Tue Jun  4 08:16:13 2024
...
TimeTicks, ObjectIdentity, Unsigned32, enterprises, Bits, Gauge32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter64, ModuleIdentity, MibIdentifier, Integer32, NotificationType, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ObjectIdentity", "Unsigned32", "enterprises", "Bits", "Gauge32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter64", "ModuleIdentity", "MibIdentifier", "Integer32", "NotificationType", "Counter32", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", trapHumError=trapHumError, trapCompValClrAlarm=trapCompValClrAlarm, compValMax=compValMax, trapEmailErrSome=trapEmailErrSome, settings=settings, tempHighInt=tempHighInt, trapHumLowAlarm=trapHumLowAlarm, tempMax=tempMax, tempMin=tempMin, tempHystInt=tempHystInt, compValAlarmInt=compValAlarmInt, compValMin=compValMin, trapCompValHighAlarm=trapCompValHighAlarm, humMin=humMin, valuesInt=valuesInt, trapCompValError=trapCompValError, trapEmailErrDNS=trapEmailErrDNS, trapHumClrAlarm=trapHumClrAlarm, compValUnit=compValUnit, traps=traps, trapSOAPErrFile=trapSOAPErrFile, humHystInt=humHystInt, comet=comet, trapTempHighAlarm=trapTempHighAlarm, humMax=humMax, hum=hum, compValHystInt=compValHystInt, trapEmailErrSocket=trapEmailErrSocket, humLowInt=humLowInt, trapNTPError=trapNTPError, tempLowInt=tempLowInt, humInt=humInt, t3610=t3610, trapCompValLowAlarm=trapCompValLowAlarm, trapTempClrAlarm=trapTempClrAlarm, trapEmailErrAuth=trapEmailErrAuth, compValHighInt=compValHighInt, compValDelayInt=compValDelayInt, compValAlarm=compValAlarm, trapHumHighAlarm=trapHumHighAlarm, tempAlarm=tempAlarm, temp=temp, tempDelayInt=tempDelayInt, compValInt=compValInt, historyTable=historyTable, deviceType=deviceType, humHighInt=humHighInt, compVal=compVal, tempInt=tempInt, DisplayString=DisplayString, histCompVal=histCompVal, humUnit=humUnit, compValLowInt=compValLowInt, historyEntry=historyEntry, trapTempError=trapTempError, serialNumber=serialNumber, humAlarmInt=humAlarmInt, tempAlarmInt=tempAlarmInt, values=values, humAlarm=humAlarm, tables=tables, humDelayInt=humDelayInt, messageString=messageString, trapSOAPErrSocket=trapSOAPErrSocket, trapTempLowAlarm=trapTempLowAlarm, trapTest=trapTest, histTemp=histTemp, products=products, trapEmailErrLogin=trapEmailErrLogin, trapSOAPErrDNS=trapSOAPErrDNS, histHum=histHum, trapSOAPErrDelivery=trapSOAPErrDelivery, pysmi_global=pysmi_global, tempUnit=tempUnit, sensorName=sensorName)
