...
# Produced by pysmi-1.1.12 at Mon Jun  3 11:13:02 2024
...
Integer32, Counter32, Gauge32, Unsigned32, enterprises, NotificationType, Bits, NotificationType, MibIdentifier, Counter64, iso, IpAddress, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "Gauge32", "Unsigned32", "enterprises", "NotificationType", "Bits", "NotificationType", "MibIdentifier", "Counter64", "iso", "IpAddress", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", DisplayString=DisplayString, tables=tables, traps=traps, humHystInt=humHystInt, histTemp=histTemp, compValUnit=compValUnit, tempHighInt=tempHighInt, compValInt=compValInt, trapNTPError=trapNTPError, histCompVal=histCompVal, products=products, compValLowInt=compValLowInt, serialNumber=serialNumber, trapSOAPErrFile=trapSOAPErrFile, tempMin=tempMin, t3610=t3610, trapSOAPErrDNS=trapSOAPErrDNS, messageString=messageString, trapSOAPErrSocket=trapSOAPErrSocket, trapTempLowAlarm=trapTempLowAlarm, trapCompValHighAlarm=trapCompValHighAlarm, trapEmailErrDNS=trapEmailErrDNS, trapTempClrAlarm=trapTempClrAlarm, tempLowInt=tempLowInt, humMin=humMin, tempHystInt=tempHystInt, humUnit=humUnit, trapTempError=trapTempError, humMax=humMax, trapHumHighAlarm=trapHumHighAlarm, settings=settings, tempAlarmInt=tempAlarmInt, historyTable=historyTable, valuesInt=valuesInt, trapSOAPErrDelivery=trapSOAPErrDelivery, compValHystInt=compValHystInt, deviceType=deviceType, humAlarmInt=humAlarmInt, compValHighInt=compValHighInt, trapTest=trapTest, trapTempHighAlarm=trapTempHighAlarm, pysmi_global=pysmi_global, sensorName=sensorName, histHum=histHum, humDelayInt=humDelayInt, compValMin=compValMin, compVal=compVal, trapEmailErrSocket=trapEmailErrSocket, trapHumLowAlarm=trapHumLowAlarm, trapHumError=trapHumError, comet=comet, hum=hum, tempAlarm=tempAlarm, trapEmailErrSome=trapEmailErrSome, compValDelayInt=compValDelayInt, trapEmailErrLogin=trapEmailErrLogin, trapCompValClrAlarm=trapCompValClrAlarm, humHighInt=humHighInt, tempInt=tempInt, humLowInt=humLowInt, trapCompValError=trapCompValError, trapCompValLowAlarm=trapCompValLowAlarm, trapHumClrAlarm=trapHumClrAlarm, tempDelayInt=tempDelayInt, values=values, compValAlarmInt=compValAlarmInt, compValMax=compValMax, temp=temp, tempMax=tempMax, historyEntry=historyEntry, humInt=humInt, compValAlarm=compValAlarm, trapEmailErrAuth=trapEmailErrAuth, tempUnit=tempUnit, humAlarm=humAlarm)
