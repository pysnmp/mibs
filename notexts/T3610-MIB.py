...
# Produced by pysmi-1.1.10 at Mon Feb 12 02:20:14 2024
...
TimeTicks, enterprises, Counter64, ModuleIdentity, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType, Bits, IpAddress, Counter32, NotificationType, MibIdentifier, ObjectIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "enterprises", "Counter64", "ModuleIdentity", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType", "Bits", "IpAddress", "Counter32", "NotificationType", "MibIdentifier", "ObjectIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("T3610-MIB", trapTempLowAlarm=trapTempLowAlarm, tempAlarmInt=tempAlarmInt, humAlarm=humAlarm, trapCompValLowAlarm=trapCompValLowAlarm, pysmi_global=pysmi_global, valuesInt=valuesInt, sensorName=sensorName, trapTempClrAlarm=trapTempClrAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, trapHumError=trapHumError, compVal=compVal, compValDelayInt=compValDelayInt, trapTempError=trapTempError, hum=hum, compValMin=compValMin, humAlarmInt=humAlarmInt, tempHighInt=tempHighInt, compValInt=compValInt, trapSOAPErrFile=trapSOAPErrFile, traps=traps, compValUnit=compValUnit, deviceType=deviceType, tempDelayInt=tempDelayInt, t3610=t3610, messageString=messageString, tempInt=tempInt, trapCompValClrAlarm=trapCompValClrAlarm, trapSOAPErrSocket=trapSOAPErrSocket, trapHumLowAlarm=trapHumLowAlarm, humUnit=humUnit, DisplayString=DisplayString, historyEntry=historyEntry, humDelayInt=humDelayInt, trapEmailErrSome=trapEmailErrSome, humHystInt=humHystInt, trapCompValError=trapCompValError, humMax=humMax, compValAlarm=compValAlarm, trapCompValHighAlarm=trapCompValHighAlarm, trapEmailErrLogin=trapEmailErrLogin, settings=settings, comet=comet, trapTest=trapTest, tables=tables, compValAlarmInt=compValAlarmInt, histHum=histHum, trapEmailErrAuth=trapEmailErrAuth, tempLowInt=tempLowInt, histTemp=histTemp, humHighInt=humHighInt, trapNTPError=trapNTPError, humMin=humMin, trapHumHighAlarm=trapHumHighAlarm, tempHystInt=tempHystInt, trapHumClrAlarm=trapHumClrAlarm, trapSOAPErrDNS=trapSOAPErrDNS, historyTable=historyTable, trapTempHighAlarm=trapTempHighAlarm, tempUnit=tempUnit, products=products, compValMax=compValMax, trapEmailErrDNS=trapEmailErrDNS, compValHystInt=compValHystInt, serialNumber=serialNumber, trapEmailErrSocket=trapEmailErrSocket, tempMin=tempMin, humLowInt=humLowInt, values=values, tempAlarm=tempAlarm, histCompVal=histCompVal, temp=temp, compValLowInt=compValLowInt, tempMax=tempMax, compValHighInt=compValHighInt, humInt=humInt)
