...
# Produced by pysmi-1.1.12 at Tue Jun  4 02:37:55 2024
...
enterprises, Counter32, ModuleIdentity, NotificationType, ObjectIdentity, MibIdentifier, iso, Integer32, IpAddress, NotificationType, Unsigned32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter32", "ModuleIdentity", "NotificationType", "ObjectIdentity", "MibIdentifier", "iso", "Integer32", "IpAddress", "NotificationType", "Unsigned32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter64", "Gauge32")
...
mibBuilder.exportSymbols("T3610-MIB", compValAlarm=compValAlarm, tempAlarmInt=tempAlarmInt, compValInt=compValInt, values=values, trapSOAPErrDelivery=trapSOAPErrDelivery, hum=hum, histCompVal=histCompVal, humDelayInt=humDelayInt, humHighInt=humHighInt, humLowInt=humLowInt, humInt=humInt, temp=temp, trapNTPError=trapNTPError, trapTempHighAlarm=trapTempHighAlarm, humMax=humMax, sensorName=sensorName, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrFile=trapSOAPErrFile, compValMin=compValMin, trapCompValHighAlarm=trapCompValHighAlarm, trapHumError=trapHumError, trapTest=trapTest, trapHumHighAlarm=trapHumHighAlarm, valuesInt=valuesInt, tempMin=tempMin, histTemp=histTemp, compValLowInt=compValLowInt, historyTable=historyTable, trapSOAPErrDNS=trapSOAPErrDNS, compValAlarmInt=compValAlarmInt, historyEntry=historyEntry, trapHumLowAlarm=trapHumLowAlarm, trapHumClrAlarm=trapHumClrAlarm, humAlarm=humAlarm, messageString=messageString, trapTempError=trapTempError, trapEmailErrLogin=trapEmailErrLogin, tables=tables, humMin=humMin, serialNumber=serialNumber, trapSOAPErrSocket=trapSOAPErrSocket, settings=settings, pysmi_global=pysmi_global, tempInt=tempInt, trapEmailErrSome=trapEmailErrSome, tempMax=tempMax, tempHystInt=tempHystInt, tempDelayInt=tempDelayInt, trapTempClrAlarm=trapTempClrAlarm, compValDelayInt=compValDelayInt, tempUnit=tempUnit, humUnit=humUnit, compValMax=compValMax, trapCompValClrAlarm=trapCompValClrAlarm, trapEmailErrAuth=trapEmailErrAuth, trapTempLowAlarm=trapTempLowAlarm, compValHighInt=compValHighInt, trapCompValError=trapCompValError, tempHighInt=tempHighInt, DisplayString=DisplayString, t3610=t3610, products=products, traps=traps, comet=comet, deviceType=deviceType, histHum=histHum, trapCompValLowAlarm=trapCompValLowAlarm, compVal=compVal, humHystInt=humHystInt, humAlarmInt=humAlarmInt, tempLowInt=tempLowInt, trapEmailErrDNS=trapEmailErrDNS, tempAlarm=tempAlarm, compValUnit=compValUnit, compValHystInt=compValHystInt)
