...
# Produced by pysmi-1.1.8 at Fri Jan  7 00:14:35 2022
...
NotificationType, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, MibIdentifier, Counter32, Bits, ObjectIdentity, Counter64, NotificationType, iso, Unsigned32, Gauge32, TimeTicks, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "MibIdentifier", "Counter32", "Bits", "ObjectIdentity", "Counter64", "NotificationType", "iso", "Unsigned32", "Gauge32", "TimeTicks", "ModuleIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", tempAlarmInt=tempAlarmInt, pysmi_global=pysmi_global, tempHystInt=tempHystInt, trapNTPError=trapNTPError, trapHumLowAlarm=trapHumLowAlarm, trapSOAPErrSocket=trapSOAPErrSocket, trapHumError=trapHumError, histHum=histHum, compValLowInt=compValLowInt, comet=comet, trapSOAPErrDNS=trapSOAPErrDNS, trapCompValClrAlarm=trapCompValClrAlarm, compValDelayInt=compValDelayInt, humInt=humInt, compValAlarmInt=compValAlarmInt, products=products, histTemp=histTemp, trapHumHighAlarm=trapHumHighAlarm, humHystInt=humHystInt, compValHighInt=compValHighInt, humAlarm=humAlarm, humUnit=humUnit, compValMin=compValMin, humLowInt=humLowInt, trapSOAPErrFile=trapSOAPErrFile, historyEntry=historyEntry, values=values, humHighInt=humHighInt, tempInt=tempInt, trapCompValLowAlarm=trapCompValLowAlarm, tempLowInt=tempLowInt, serialNumber=serialNumber, trapTempHighAlarm=trapTempHighAlarm, tables=tables, deviceType=deviceType, valuesInt=valuesInt, traps=traps, trapCompValHighAlarm=trapCompValHighAlarm, sensorName=sensorName, compVal=compVal, messageString=messageString, trapCompValError=trapCompValError, tempAlarm=tempAlarm, trapEmailErrSocket=trapEmailErrSocket, tempMin=tempMin, historyTable=historyTable, trapTempClrAlarm=trapTempClrAlarm, trapTempError=trapTempError, trapSOAPErrDelivery=trapSOAPErrDelivery, compValUnit=compValUnit, compValAlarm=compValAlarm, trapEmailErrSome=trapEmailErrSome, trapTest=trapTest, compValHystInt=compValHystInt, trapTempLowAlarm=trapTempLowAlarm, hum=hum, compValMax=compValMax, compValInt=compValInt, tempMax=tempMax, settings=settings, trapEmailErrLogin=trapEmailErrLogin, humAlarmInt=humAlarmInt, humDelayInt=humDelayInt, humMin=humMin, tempUnit=tempUnit, tempHighInt=tempHighInt, humMax=humMax, trapEmailErrDNS=trapEmailErrDNS, trapEmailErrAuth=trapEmailErrAuth, t3610=t3610, trapHumClrAlarm=trapHumClrAlarm, DisplayString=DisplayString, temp=temp, tempDelayInt=tempDelayInt, histCompVal=histCompVal)
