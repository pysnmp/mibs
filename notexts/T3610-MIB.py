...
# Produced by pysmi-1.1.8 at Sun Jan 16 00:56:27 2022
...
iso, NotificationType, Gauge32, Bits, Counter32, ObjectIdentity, enterprises, TimeTicks, IpAddress, Counter64, MibIdentifier, ModuleIdentity, NotificationType, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "Gauge32", "Bits", "Counter32", "ObjectIdentity", "enterprises", "TimeTicks", "IpAddress", "Counter64", "MibIdentifier", "ModuleIdentity", "NotificationType", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
...
mibBuilder.exportSymbols("T3610-MIB", hum=hum, histTemp=histTemp, traps=traps, tempDelayInt=tempDelayInt, humLowInt=humLowInt, compValDelayInt=compValDelayInt, tempUnit=tempUnit, sensorName=sensorName, compValAlarm=compValAlarm, serialNumber=serialNumber, trapEmailErrSome=trapEmailErrSome, compValMax=compValMax, trapTempClrAlarm=trapTempClrAlarm, trapCompValClrAlarm=trapCompValClrAlarm, compValHystInt=compValHystInt, t3610=t3610, histCompVal=histCompVal, trapHumHighAlarm=trapHumHighAlarm, trapTempLowAlarm=trapTempLowAlarm, tempAlarmInt=tempAlarmInt, compValMin=compValMin, trapTempError=trapTempError, trapCompValLowAlarm=trapCompValLowAlarm, tempHystInt=tempHystInt, trapSOAPErrFile=trapSOAPErrFile, settings=settings, humDelayInt=humDelayInt, trapSOAPErrSocket=trapSOAPErrSocket, trapHumClrAlarm=trapHumClrAlarm, tempMin=tempMin, compValHighInt=compValHighInt, tempInt=tempInt, humHystInt=humHystInt, trapTempHighAlarm=trapTempHighAlarm, tempLowInt=tempLowInt, compValLowInt=compValLowInt, trapNTPError=trapNTPError, tempAlarm=tempAlarm, trapEmailErrLogin=trapEmailErrLogin, deviceType=deviceType, values=values, trapEmailErrAuth=trapEmailErrAuth, trapCompValError=trapCompValError, humHighInt=humHighInt, tables=tables, trapEmailErrDNS=trapEmailErrDNS, compValUnit=compValUnit, historyEntry=historyEntry, trapSOAPErrDNS=trapSOAPErrDNS, tempMax=tempMax, products=products, messageString=messageString, trapHumError=trapHumError, temp=temp, tempHighInt=tempHighInt, histHum=histHum, DisplayString=DisplayString, trapCompValHighAlarm=trapCompValHighAlarm, comet=comet, compVal=compVal, humUnit=humUnit, compValAlarmInt=compValAlarmInt, trapTest=trapTest, humMin=humMin, trapSOAPErrDelivery=trapSOAPErrDelivery, valuesInt=valuesInt, humMax=humMax, compValInt=compValInt, humAlarmInt=humAlarmInt, trapHumLowAlarm=trapHumLowAlarm, historyTable=historyTable, humAlarm=humAlarm, trapEmailErrSocket=trapEmailErrSocket, pysmi_global=pysmi_global, humInt=humInt)
