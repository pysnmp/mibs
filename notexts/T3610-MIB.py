...
# Produced by pysmi-1.1.10 at Mon Feb 19 02:54:51 2024
...
ObjectIdentity, enterprises, Gauge32, MibIdentifier, Counter32, IpAddress, Counter64, Bits, iso, TimeTicks, NotificationType, ModuleIdentity, Unsigned32, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "enterprises", "Gauge32", "MibIdentifier", "Counter32", "IpAddress", "Counter64", "Bits", "iso", "TimeTicks", "NotificationType", "ModuleIdentity", "Unsigned32", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("T3610-MIB", DisplayString=DisplayString, compValDelayInt=compValDelayInt, trapHumError=trapHumError, compValHighInt=compValHighInt, humAlarmInt=humAlarmInt, tempHystInt=tempHystInt, trapCompValLowAlarm=trapCompValLowAlarm, valuesInt=valuesInt, tempAlarmInt=tempAlarmInt, trapNTPError=trapNTPError, messageString=messageString, trapEmailErrSocket=trapEmailErrSocket, compValLowInt=compValLowInt, humHystInt=humHystInt, histHum=histHum, trapTempError=trapTempError, trapCompValHighAlarm=trapCompValHighAlarm, compValMax=compValMax, trapEmailErrLogin=trapEmailErrLogin, values=values, serialNumber=serialNumber, compValAlarmInt=compValAlarmInt, humHighInt=humHighInt, tempInt=tempInt, humUnit=humUnit, compValMin=compValMin, trapEmailErrAuth=trapEmailErrAuth, t3610=t3610, humMin=humMin, tables=tables, tempUnit=tempUnit, compValHystInt=compValHystInt, tempMin=tempMin, trapTempLowAlarm=trapTempLowAlarm, trapHumClrAlarm=trapHumClrAlarm, trapCompValError=trapCompValError, sensorName=sensorName, humInt=humInt, trapEmailErrDNS=trapEmailErrDNS, humDelayInt=humDelayInt, compValUnit=compValUnit, products=products, trapHumLowAlarm=trapHumLowAlarm, tempMax=tempMax, humLowInt=humLowInt, trapTempHighAlarm=trapTempHighAlarm, trapTest=trapTest, trapHumHighAlarm=trapHumHighAlarm, temp=temp, compValInt=compValInt, humMax=humMax, historyTable=historyTable, histCompVal=histCompVal, compVal=compVal, trapCompValClrAlarm=trapCompValClrAlarm, settings=settings, tempHighInt=tempHighInt, historyEntry=historyEntry, compValAlarm=compValAlarm, tempLowInt=tempLowInt, histTemp=histTemp, pysmi_global=pysmi_global, humAlarm=humAlarm, trapSOAPErrFile=trapSOAPErrFile, trapEmailErrSome=trapEmailErrSome, trapSOAPErrDNS=trapSOAPErrDNS, trapSOAPErrDelivery=trapSOAPErrDelivery, traps=traps, tempAlarm=tempAlarm, tempDelayInt=tempDelayInt, comet=comet, trapSOAPErrSocket=trapSOAPErrSocket, hum=hum, deviceType=deviceType, trapTempClrAlarm=trapTempClrAlarm)
