...
# Produced by pysmi-1.1.3 at Sat Nov 20 17:23:37 2021
...
NotificationType, NotificationType, IpAddress, Counter64, Gauge32, ModuleIdentity, iso, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, Bits, TimeTicks, Unsigned32, ObjectIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "NotificationType", "IpAddress", "Counter64", "Gauge32", "ModuleIdentity", "iso", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "Bits", "TimeTicks", "Unsigned32", "ObjectIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("T3610-MIB", trapSOAPErrSocket=trapSOAPErrSocket, trapHumLowAlarm=trapHumLowAlarm, compValMax=compValMax, humHystInt=humHystInt, compValDelayInt=compValDelayInt, tempMax=tempMax, historyTable=historyTable, trapCompValClrAlarm=trapCompValClrAlarm, trapHumClrAlarm=trapHumClrAlarm, comet=comet, compValHystInt=compValHystInt, histHum=histHum, valuesInt=valuesInt, tempLowInt=tempLowInt, compValMin=compValMin, humAlarmInt=humAlarmInt, compValLowInt=compValLowInt, messageString=messageString, histTemp=histTemp, t3610=t3610, humAlarm=humAlarm, trapEmailErrDNS=trapEmailErrDNS, DisplayString=DisplayString, tempDelayInt=tempDelayInt, trapEmailErrSome=trapEmailErrSome, trapSOAPErrDNS=trapSOAPErrDNS, humUnit=humUnit, deviceType=deviceType, serialNumber=serialNumber, trapTempError=trapTempError, trapHumError=trapHumError, trapCompValError=trapCompValError, tables=tables, tempHystInt=tempHystInt, historyEntry=historyEntry, trapEmailErrAuth=trapEmailErrAuth, trapTempHighAlarm=trapTempHighAlarm, trapCompValLowAlarm=trapCompValLowAlarm, trapTempClrAlarm=trapTempClrAlarm, compValAlarm=compValAlarm, tempHighInt=tempHighInt, traps=traps, tempUnit=tempUnit, humMax=humMax, trapTest=trapTest, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrFile=trapSOAPErrFile, humDelayInt=humDelayInt, tempMin=tempMin, trapHumHighAlarm=trapHumHighAlarm, products=products, pysmi_global=pysmi_global, compValInt=compValInt, compValHighInt=compValHighInt, tempAlarm=tempAlarm, temp=temp, trapEmailErrLogin=trapEmailErrLogin, tempAlarmInt=tempAlarmInt, settings=settings, histCompVal=histCompVal, trapNTPError=trapNTPError, compValAlarmInt=compValAlarmInt, sensorName=sensorName, compVal=compVal, compValUnit=compValUnit, tempInt=tempInt, humMin=humMin, trapTempLowAlarm=trapTempLowAlarm, humLowInt=humLowInt, hum=hum, values=values, trapCompValHighAlarm=trapCompValHighAlarm, humInt=humInt, trapSOAPErrDelivery=trapSOAPErrDelivery, humHighInt=humHighInt)
