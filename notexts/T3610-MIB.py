...
# Produced by pysmi-1.1.12 at Tue Sep 17 12:20:03 2024
...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, enterprises, Counter64, Gauge32, IpAddress, Unsigned32, NotificationType, MibIdentifier, iso, Counter32, Bits, ModuleIdentity, TimeTicks, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "enterprises", "Counter64", "Gauge32", "IpAddress", "Unsigned32", "NotificationType", "MibIdentifier", "iso", "Counter32", "Bits", "ModuleIdentity", "TimeTicks", "Integer32")
...
mibBuilder.exportSymbols("T3610-MIB", tempAlarm=tempAlarm, trapEmailErrSocket=trapEmailErrSocket, humLowInt=humLowInt, trapSOAPErrDNS=trapSOAPErrDNS, trapCompValClrAlarm=trapCompValClrAlarm, histTemp=histTemp, humAlarm=humAlarm, sensorName=sensorName, compValAlarm=compValAlarm, trapEmailErrLogin=trapEmailErrLogin, trapEmailErrSome=trapEmailErrSome, trapSOAPErrFile=trapSOAPErrFile, tempLowInt=tempLowInt, t3610=t3610, comet=comet, trapHumLowAlarm=trapHumLowAlarm, trapCompValLowAlarm=trapCompValLowAlarm, historyTable=historyTable, tempDelayInt=tempDelayInt, historyEntry=historyEntry, trapEmailErrAuth=trapEmailErrAuth, deviceType=deviceType, trapCompValError=trapCompValError, trapCompValHighAlarm=trapCompValHighAlarm, trapHumClrAlarm=trapHumClrAlarm, values=values, humInt=humInt, tempInt=tempInt, compValHystInt=compValHystInt, tables=tables, DisplayString=DisplayString, tempHystInt=tempHystInt, valuesInt=valuesInt, humHystInt=humHystInt, trapTempHighAlarm=trapTempHighAlarm, settings=settings, compVal=compVal, pysmi_global=pysmi_global, temp=temp, compValInt=compValInt, humHighInt=humHighInt, serialNumber=serialNumber, trapHumError=trapHumError, hum=hum, trapTempLowAlarm=trapTempLowAlarm, humMax=humMax, compValMax=compValMax, tempAlarmInt=tempAlarmInt, humAlarmInt=humAlarmInt, tempHighInt=tempHighInt, traps=traps, humDelayInt=humDelayInt, histHum=histHum, trapNTPError=trapNTPError, compValAlarmInt=compValAlarmInt, tempUnit=tempUnit, trapSOAPErrSocket=trapSOAPErrSocket, trapSOAPErrDelivery=trapSOAPErrDelivery, compValUnit=compValUnit, trapHumHighAlarm=trapHumHighAlarm, compValMin=compValMin, trapEmailErrDNS=trapEmailErrDNS, trapTempClrAlarm=trapTempClrAlarm, humUnit=humUnit, tempMin=tempMin, compValHighInt=compValHighInt, compValDelayInt=compValDelayInt, tempMax=tempMax, compValLowInt=compValLowInt, messageString=messageString, histCompVal=histCompVal, trapTest=trapTest, trapTempError=trapTempError, products=products, humMin=humMin)
