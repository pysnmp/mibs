...
# Produced by pysmi-1.1.8 at Thu Apr 27 11:26:02 2023
...
Integer32, NotificationType, Gauge32, TimeTicks, Counter64, ModuleIdentity, iso, MibIdentifier, ObjectIdentity, NotificationType, IpAddress, enterprises, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "Gauge32", "TimeTicks", "Counter64", "ModuleIdentity", "iso", "MibIdentifier", "ObjectIdentity", "NotificationType", "IpAddress", "enterprises", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", tempInt=tempInt, traps=traps, sensorName=sensorName, compValInt=compValInt, valuesInt=valuesInt, tables=tables, tempDelayInt=tempDelayInt, humAlarm=humAlarm, humHystInt=humHystInt, compValLowInt=compValLowInt, trapTempClrAlarm=trapTempClrAlarm, trapTempError=trapTempError, serialNumber=serialNumber, DisplayString=DisplayString, humUnit=humUnit, trapCompValLowAlarm=trapCompValLowAlarm, humAlarmInt=humAlarmInt, trapNTPError=trapNTPError, trapCompValHighAlarm=trapCompValHighAlarm, settings=settings, trapSOAPErrSocket=trapSOAPErrSocket, tempLowInt=tempLowInt, compValMax=compValMax, compVal=compVal, compValHighInt=compValHighInt, tempAlarmInt=tempAlarmInt, tempHighInt=tempHighInt, humDelayInt=humDelayInt, tempAlarm=tempAlarm, trapEmailErrLogin=trapEmailErrLogin, humHighInt=humHighInt, histCompVal=histCompVal, historyTable=historyTable, products=products, trapEmailErrSocket=trapEmailErrSocket, trapHumHighAlarm=trapHumHighAlarm, tempUnit=tempUnit, trapSOAPErrDelivery=trapSOAPErrDelivery, compValMin=compValMin, humLowInt=humLowInt, trapHumError=trapHumError, comet=comet, trapEmailErrSome=trapEmailErrSome, trapTempHighAlarm=trapTempHighAlarm, compValDelayInt=compValDelayInt, deviceType=deviceType, histTemp=histTemp, trapTempLowAlarm=trapTempLowAlarm, hum=hum, trapHumLowAlarm=trapHumLowAlarm, historyEntry=historyEntry, compValUnit=compValUnit, humMin=humMin, compValAlarm=compValAlarm, trapSOAPErrFile=trapSOAPErrFile, tempMin=tempMin, humInt=humInt, t3610=t3610, trapEmailErrAuth=trapEmailErrAuth, trapCompValError=trapCompValError, compValAlarmInt=compValAlarmInt, tempMax=tempMax, trapEmailErrDNS=trapEmailErrDNS, trapCompValClrAlarm=trapCompValClrAlarm, trapTest=trapTest, trapHumClrAlarm=trapHumClrAlarm, pysmi_global=pysmi_global, histHum=histHum, messageString=messageString, compValHystInt=compValHystInt, humMax=humMax, temp=temp, tempHystInt=tempHystInt, values=values, trapSOAPErrDNS=trapSOAPErrDNS)
