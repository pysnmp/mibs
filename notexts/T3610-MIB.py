...
# Produced by pysmi-1.1.8 at Fri Sep  8 07:57:50 2023
...
TimeTicks, Counter32, Unsigned32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ModuleIdentity, MibIdentifier, iso, Gauge32, IpAddress, NotificationType, Integer32, ObjectIdentity, Counter64, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "Unsigned32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ModuleIdentity", "MibIdentifier", "iso", "Gauge32", "IpAddress", "NotificationType", "Integer32", "ObjectIdentity", "Counter64", "enterprises")
...
mibBuilder.exportSymbols("T3610-MIB", humInt=humInt, humAlarmInt=humAlarmInt, trapSOAPErrDelivery=trapSOAPErrDelivery, messageString=messageString, trapSOAPErrSocket=trapSOAPErrSocket, tempInt=tempInt, compValHighInt=compValHighInt, humLowInt=humLowInt, trapHumClrAlarm=trapHumClrAlarm, trapCompValHighAlarm=trapCompValHighAlarm, valuesInt=valuesInt, compValDelayInt=compValDelayInt, compVal=compVal, tempMax=tempMax, humMax=humMax, temp=temp, humHystInt=humHystInt, histHum=histHum, pysmi_global=pysmi_global, humDelayInt=humDelayInt, trapTempLowAlarm=trapTempLowAlarm, trapHumHighAlarm=trapHumHighAlarm, histCompVal=histCompVal, historyEntry=historyEntry, trapEmailErrSocket=trapEmailErrSocket, t3610=t3610, trapSOAPErrFile=trapSOAPErrFile, trapSOAPErrDNS=trapSOAPErrDNS, trapTempHighAlarm=trapTempHighAlarm, tempMin=tempMin, DisplayString=DisplayString, compValAlarmInt=compValAlarmInt, compValMax=compValMax, compValLowInt=compValLowInt, trapEmailErrLogin=trapEmailErrLogin, humUnit=humUnit, serialNumber=serialNumber, hum=hum, humAlarm=humAlarm, trapTempError=trapTempError, compValInt=compValInt, tempAlarm=tempAlarm, tempLowInt=tempLowInt, traps=traps, trapCompValError=trapCompValError, humHighInt=humHighInt, trapNTPError=trapNTPError, compValAlarm=compValAlarm, tempAlarmInt=tempAlarmInt, tables=tables, comet=comet, compValUnit=compValUnit, tempHystInt=tempHystInt, trapEmailErrAuth=trapEmailErrAuth, trapHumLowAlarm=trapHumLowAlarm, tempDelayInt=tempDelayInt, trapCompValClrAlarm=trapCompValClrAlarm, values=values, deviceType=deviceType, humMin=humMin, products=products, tempHighInt=tempHighInt, compValHystInt=compValHystInt, historyTable=historyTable, trapEmailErrSome=trapEmailErrSome, histTemp=histTemp, trapCompValLowAlarm=trapCompValLowAlarm, trapTempClrAlarm=trapTempClrAlarm, trapHumError=trapHumError, compValMin=compValMin, trapEmailErrDNS=trapEmailErrDNS, tempUnit=tempUnit, trapTest=trapTest, settings=settings, sensorName=sensorName)
