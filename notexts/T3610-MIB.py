...
# Produced by pysmi-1.1.8 at Thu Feb  3 21:00:33 2022
...
iso, Counter32, ModuleIdentity, IpAddress, enterprises, ObjectIdentity, Counter64, TimeTicks, Unsigned32, Bits, Integer32, NotificationType, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter32", "ModuleIdentity", "IpAddress", "enterprises", "ObjectIdentity", "Counter64", "TimeTicks", "Unsigned32", "Bits", "Integer32", "NotificationType", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32")
...
mibBuilder.exportSymbols("T3610-MIB", compValUnit=compValUnit, compVal=compVal, trapSOAPErrDNS=trapSOAPErrDNS, trapSOAPErrSocket=trapSOAPErrSocket, compValInt=compValInt, tempHystInt=tempHystInt, compValHystInt=compValHystInt, pysmi_global=pysmi_global, tempAlarm=tempAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, settings=settings, trapEmailErrSocket=trapEmailErrSocket, humMin=humMin, valuesInt=valuesInt, serialNumber=serialNumber, trapNTPError=trapNTPError, humHystInt=humHystInt, DisplayString=DisplayString, trapHumHighAlarm=trapHumHighAlarm, deviceType=deviceType, trapTempHighAlarm=trapTempHighAlarm, trapCompValHighAlarm=trapCompValHighAlarm, histCompVal=histCompVal, values=values, humDelayInt=humDelayInt, comet=comet, humLowInt=humLowInt, histHum=histHum, trapTest=trapTest, humUnit=humUnit, trapTempLowAlarm=trapTempLowAlarm, historyTable=historyTable, tempDelayInt=tempDelayInt, trapTempError=trapTempError, compValMin=compValMin, tempMin=tempMin, sensorName=sensorName, messageString=messageString, temp=temp, humAlarm=humAlarm, humMax=humMax, products=products, tempUnit=tempUnit, trapHumLowAlarm=trapHumLowAlarm, trapEmailErrDNS=trapEmailErrDNS, t3610=t3610, humInt=humInt, tempLowInt=tempLowInt, trapCompValError=trapCompValError, compValMax=compValMax, tempInt=tempInt, humHighInt=humHighInt, trapSOAPErrFile=trapSOAPErrFile, hum=hum, tables=tables, compValAlarmInt=compValAlarmInt, traps=traps, compValLowInt=compValLowInt, humAlarmInt=humAlarmInt, historyEntry=historyEntry, histTemp=histTemp, trapEmailErrAuth=trapEmailErrAuth, trapTempClrAlarm=trapTempClrAlarm, compValDelayInt=compValDelayInt, trapEmailErrLogin=trapEmailErrLogin, trapCompValClrAlarm=trapCompValClrAlarm, trapHumError=trapHumError, compValHighInt=compValHighInt, trapHumClrAlarm=trapHumClrAlarm, trapCompValLowAlarm=trapCompValLowAlarm, compValAlarm=compValAlarm, tempMax=tempMax, tempAlarmInt=tempAlarmInt, tempHighInt=tempHighInt, trapEmailErrSome=trapEmailErrSome)
