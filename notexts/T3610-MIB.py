...
# Produced by pysmi-1.1.8 at Fri Sep  8 11:03:52 2023
...
Integer32, NotificationType, TimeTicks, ModuleIdentity, ObjectIdentity, Unsigned32, IpAddress, NotificationType, Counter64, Gauge32, Bits, MibIdentifier, enterprises, Counter32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "TimeTicks", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "IpAddress", "NotificationType", "Counter64", "Gauge32", "Bits", "MibIdentifier", "enterprises", "Counter32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("T3610-MIB", hum=hum, trapTempError=trapTempError, compValUnit=compValUnit, compValDelayInt=compValDelayInt, pysmi_global=pysmi_global, histTemp=histTemp, t3610=t3610, values=values, tables=tables, compValHighInt=compValHighInt, messageString=messageString, trapTest=trapTest, trapNTPError=trapNTPError, trapEmailErrLogin=trapEmailErrLogin, humHighInt=humHighInt, trapSOAPErrFile=trapSOAPErrFile, trapTempHighAlarm=trapTempHighAlarm, tempLowInt=tempLowInt, compValMin=compValMin, DisplayString=DisplayString, historyTable=historyTable, compValAlarm=compValAlarm, trapEmailErrSocket=trapEmailErrSocket, trapEmailErrSome=trapEmailErrSome, humDelayInt=humDelayInt, histCompVal=histCompVal, trapSOAPErrDNS=trapSOAPErrDNS, trapSOAPErrSocket=trapSOAPErrSocket, humAlarmInt=humAlarmInt, compValAlarmInt=compValAlarmInt, humLowInt=humLowInt, trapHumHighAlarm=trapHumHighAlarm, trapCompValClrAlarm=trapCompValClrAlarm, humInt=humInt, trapEmailErrDNS=trapEmailErrDNS, trapHumLowAlarm=trapHumLowAlarm, humMax=humMax, temp=temp, trapCompValLowAlarm=trapCompValLowAlarm, humUnit=humUnit, trapTempLowAlarm=trapTempLowAlarm, tempHighInt=tempHighInt, trapHumClrAlarm=trapHumClrAlarm, humHystInt=humHystInt, compValHystInt=compValHystInt, serialNumber=serialNumber, products=products, tempAlarmInt=tempAlarmInt, tempDelayInt=tempDelayInt, histHum=histHum, settings=settings, comet=comet, compValLowInt=compValLowInt, historyEntry=historyEntry, humAlarm=humAlarm, deviceType=deviceType, trapCompValHighAlarm=trapCompValHighAlarm, trapCompValError=trapCompValError, tempMax=tempMax, tempUnit=tempUnit, tempMin=tempMin, trapSOAPErrDelivery=trapSOAPErrDelivery, trapHumError=trapHumError, valuesInt=valuesInt, tempInt=tempInt, trapTempClrAlarm=trapTempClrAlarm, compValInt=compValInt, compValMax=compValMax, traps=traps, compVal=compVal, tempAlarm=tempAlarm, tempHystInt=tempHystInt, trapEmailErrAuth=trapEmailErrAuth, sensorName=sensorName, humMin=humMin)
