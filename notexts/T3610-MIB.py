...
# Produced by pysmi-1.1.12 at Mon May 13 02:36:07 2024
...
iso, Integer32, ObjectIdentity, Unsigned32, NotificationType, Counter32, ModuleIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, MibIdentifier, NotificationType, TimeTicks, IpAddress, enterprises, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "ObjectIdentity", "Unsigned32", "NotificationType", "Counter32", "ModuleIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "MibIdentifier", "NotificationType", "TimeTicks", "IpAddress", "enterprises", "Counter64")
...
mibBuilder.exportSymbols("T3610-MIB", deviceType=deviceType, compValAlarmInt=compValAlarmInt, trapNTPError=trapNTPError, compValHystInt=compValHystInt, messageString=messageString, trapEmailErrDNS=trapEmailErrDNS, tempDelayInt=tempDelayInt, compValHighInt=compValHighInt, temp=temp, trapCompValClrAlarm=trapCompValClrAlarm, histHum=histHum, tempHystInt=tempHystInt, trapTest=trapTest, trapSOAPErrDNS=trapSOAPErrDNS, trapHumError=trapHumError, valuesInt=valuesInt, serialNumber=serialNumber, tempHighInt=tempHighInt, trapEmailErrAuth=trapEmailErrAuth, values=values, tempMax=tempMax, compValAlarm=compValAlarm, tempAlarmInt=tempAlarmInt, trapSOAPErrFile=trapSOAPErrFile, humUnit=humUnit, tempInt=tempInt, humInt=humInt, compValInt=compValInt, historyEntry=historyEntry, comet=comet, trapSOAPErrDelivery=trapSOAPErrDelivery, compValUnit=compValUnit, trapTempClrAlarm=trapTempClrAlarm, trapCompValError=trapCompValError, histCompVal=histCompVal, humAlarmInt=humAlarmInt, compValLowInt=compValLowInt, trapSOAPErrSocket=trapSOAPErrSocket, tables=tables, trapEmailErrLogin=trapEmailErrLogin, trapTempError=trapTempError, tempMin=tempMin, trapHumClrAlarm=trapHumClrAlarm, humMax=humMax, humHighInt=humHighInt, historyTable=historyTable, tempUnit=tempUnit, compVal=compVal, humDelayInt=humDelayInt, compValDelayInt=compValDelayInt, trapCompValHighAlarm=trapCompValHighAlarm, trapHumLowAlarm=trapHumLowAlarm, DisplayString=DisplayString, products=products, pysmi_global=pysmi_global, humAlarm=humAlarm, humMin=humMin, tempLowInt=tempLowInt, trapEmailErrSome=trapEmailErrSome, trapEmailErrSocket=trapEmailErrSocket, compValMin=compValMin, trapTempHighAlarm=trapTempHighAlarm, trapHumHighAlarm=trapHumHighAlarm, sensorName=sensorName, humHystInt=humHystInt, t3610=t3610, compValMax=compValMax, humLowInt=humLowInt, trapCompValLowAlarm=trapCompValLowAlarm, settings=settings, histTemp=histTemp, trapTempLowAlarm=trapTempLowAlarm, hum=hum, tempAlarm=tempAlarm, traps=traps)
