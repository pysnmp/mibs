...
# Produced by pysmi-1.1.12 at Tue Jun  4 08:27:39 2024
...
Integer32, Counter32, NotificationType, MibIdentifier, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, IpAddress, TimeTicks, Bits, iso, Gauge32, Unsigned32, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "NotificationType", "MibIdentifier", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "IpAddress", "TimeTicks", "Bits", "iso", "Gauge32", "Unsigned32", "ObjectIdentity", "ModuleIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", histCompVal=histCompVal, compValMin=compValMin, values=values, historyEntry=historyEntry, trapTest=trapTest, trapEmailErrLogin=trapEmailErrLogin, trapNTPError=trapNTPError, humMax=humMax, tempDelayInt=tempDelayInt, tempInt=tempInt, compValUnit=compValUnit, compValHystInt=compValHystInt, humHighInt=humHighInt, compValDelayInt=compValDelayInt, serialNumber=serialNumber, humAlarmInt=humAlarmInt, settings=settings, tempHighInt=tempHighInt, trapEmailErrAuth=trapEmailErrAuth, histTemp=histTemp, humAlarm=humAlarm, trapEmailErrDNS=trapEmailErrDNS, trapTempClrAlarm=trapTempClrAlarm, tempMax=tempMax, humUnit=humUnit, tempAlarm=tempAlarm, histHum=histHum, trapHumHighAlarm=trapHumHighAlarm, compValLowInt=compValLowInt, deviceType=deviceType, trapCompValClrAlarm=trapCompValClrAlarm, temp=temp, humMin=humMin, compValInt=compValInt, compValHighInt=compValHighInt, trapTempHighAlarm=trapTempHighAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, trapCompValLowAlarm=trapCompValLowAlarm, trapEmailErrSome=trapEmailErrSome, sensorName=sensorName, humDelayInt=humDelayInt, DisplayString=DisplayString, humLowInt=humLowInt, tempLowInt=tempLowInt, humHystInt=humHystInt, trapCompValError=trapCompValError, tempUnit=tempUnit, compValAlarmInt=compValAlarmInt, compVal=compVal, trapSOAPErrFile=trapSOAPErrFile, hum=hum, tempMin=tempMin, humInt=humInt, trapTempLowAlarm=trapTempLowAlarm, trapHumClrAlarm=trapHumClrAlarm, compValAlarm=compValAlarm, trapHumError=trapHumError, compValMax=compValMax, t3610=t3610, pysmi_global=pysmi_global, traps=traps, historyTable=historyTable, valuesInt=valuesInt, tempHystInt=tempHystInt, trapSOAPErrDNS=trapSOAPErrDNS, messageString=messageString, tables=tables, trapSOAPErrSocket=trapSOAPErrSocket, trapTempError=trapTempError, trapEmailErrSocket=trapEmailErrSocket, tempAlarmInt=tempAlarmInt, comet=comet, trapCompValHighAlarm=trapCompValHighAlarm, products=products, trapHumLowAlarm=trapHumLowAlarm)
