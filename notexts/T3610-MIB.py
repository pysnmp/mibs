...
# Produced by pysmi-1.1.8 at Mon Jan  2 15:25:16 2023
...
TimeTicks, Unsigned32, IpAddress, NotificationType, Integer32, Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, iso, ModuleIdentity, Counter32, Counter64, enterprises, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "IpAddress", "NotificationType", "Integer32", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "iso", "ModuleIdentity", "Counter32", "Counter64", "enterprises", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", deviceType=deviceType, settings=settings, humUnit=humUnit, trapCompValClrAlarm=trapCompValClrAlarm, products=products, traps=traps, sensorName=sensorName, histCompVal=histCompVal, compValAlarmInt=compValAlarmInt, compValHighInt=compValHighInt, tables=tables, compValUnit=compValUnit, trapEmailErrDNS=trapEmailErrDNS, trapEmailErrAuth=trapEmailErrAuth, tempMin=tempMin, trapTempHighAlarm=trapTempHighAlarm, trapNTPError=trapNTPError, compValDelayInt=compValDelayInt, trapHumLowAlarm=trapHumLowAlarm, tempAlarm=tempAlarm, tempDelayInt=tempDelayInt, valuesInt=valuesInt, compValMin=compValMin, compValLowInt=compValLowInt, values=values, trapSOAPErrDelivery=trapSOAPErrDelivery, humHighInt=humHighInt, temp=temp, compValInt=compValInt, tempAlarmInt=tempAlarmInt, trapSOAPErrFile=trapSOAPErrFile, trapTest=trapTest, trapTempError=trapTempError, historyTable=historyTable, compVal=compVal, humLowInt=humLowInt, humMin=humMin, compValMax=compValMax, trapCompValLowAlarm=trapCompValLowAlarm, t3610=t3610, humInt=humInt, trapEmailErrLogin=trapEmailErrLogin, trapHumError=trapHumError, humDelayInt=humDelayInt, compValHystInt=compValHystInt, comet=comet, tempUnit=tempUnit, trapTempClrAlarm=trapTempClrAlarm, humHystInt=humHystInt, humMax=humMax, trapCompValError=trapCompValError, trapHumClrAlarm=trapHumClrAlarm, pysmi_global=pysmi_global, tempHystInt=tempHystInt, trapEmailErrSocket=trapEmailErrSocket, trapTempLowAlarm=trapTempLowAlarm, humAlarm=humAlarm, tempInt=tempInt, messageString=messageString, DisplayString=DisplayString, serialNumber=serialNumber, histHum=histHum, tempLowInt=tempLowInt, tempHighInt=tempHighInt, histTemp=histTemp, trapEmailErrSome=trapEmailErrSome, tempMax=tempMax, trapSOAPErrDNS=trapSOAPErrDNS, humAlarmInt=humAlarmInt, trapCompValHighAlarm=trapCompValHighAlarm, historyEntry=historyEntry, trapHumHighAlarm=trapHumHighAlarm, hum=hum, compValAlarm=compValAlarm, trapSOAPErrSocket=trapSOAPErrSocket)
