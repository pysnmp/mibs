...
# Produced by pysmi-1.1.3 at Sun Nov 21 13:33:09 2021
...
NotificationType, ModuleIdentity, enterprises, Counter32, Counter64, TimeTicks, Integer32, iso, Gauge32, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, IpAddress, Unsigned32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "enterprises", "Counter32", "Counter64", "TimeTicks", "Integer32", "iso", "Gauge32", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "IpAddress", "Unsigned32", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", tempAlarmInt=tempAlarmInt, valuesInt=valuesInt, compValMin=compValMin, compValMax=compValMax, compValInt=compValInt, trapEmailErrAuth=trapEmailErrAuth, humHystInt=humHystInt, compValLowInt=compValLowInt, humInt=humInt, humMin=humMin, historyEntry=historyEntry, humHighInt=humHighInt, messageString=messageString, trapSOAPErrFile=trapSOAPErrFile, trapHumClrAlarm=trapHumClrAlarm, serialNumber=serialNumber, trapTest=trapTest, trapCompValHighAlarm=trapCompValHighAlarm, historyTable=historyTable, trapEmailErrSocket=trapEmailErrSocket, pysmi_global=pysmi_global, compValHighInt=compValHighInt, comet=comet, tempDelayInt=tempDelayInt, trapCompValLowAlarm=trapCompValLowAlarm, tempUnit=tempUnit, trapHumHighAlarm=trapHumHighAlarm, compValUnit=compValUnit, trapTempError=trapTempError, t3610=t3610, humAlarmInt=humAlarmInt, trapTempClrAlarm=trapTempClrAlarm, trapHumError=trapHumError, tempMax=tempMax, trapTempHighAlarm=trapTempHighAlarm, products=products, compValHystInt=compValHystInt, tempLowInt=tempLowInt, hum=hum, histHum=histHum, temp=temp, deviceType=deviceType, compValAlarmInt=compValAlarmInt, trapEmailErrSome=trapEmailErrSome, trapHumLowAlarm=trapHumLowAlarm, values=values, compVal=compVal, tempAlarm=tempAlarm, traps=traps, humUnit=humUnit, trapCompValClrAlarm=trapCompValClrAlarm, trapSOAPErrDNS=trapSOAPErrDNS, tempInt=tempInt, trapSOAPErrSocket=trapSOAPErrSocket, trapTempLowAlarm=trapTempLowAlarm, trapCompValError=trapCompValError, humDelayInt=humDelayInt, tempHystInt=tempHystInt, histTemp=histTemp, compValDelayInt=compValDelayInt, humMax=humMax, sensorName=sensorName, trapEmailErrDNS=trapEmailErrDNS, trapNTPError=trapNTPError, tables=tables, compValAlarm=compValAlarm, settings=settings, histCompVal=histCompVal, humAlarm=humAlarm, humLowInt=humLowInt, tempMin=tempMin, trapEmailErrLogin=trapEmailErrLogin, trapSOAPErrDelivery=trapSOAPErrDelivery, tempHighInt=tempHighInt, DisplayString=DisplayString)
