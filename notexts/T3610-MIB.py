...
# Produced by pysmi-1.1.8 at Fri Jan 13 12:00:03 2023
...
TimeTicks, MibIdentifier, Gauge32, Bits, Unsigned32, NotificationType, IpAddress, ObjectIdentity, iso, ModuleIdentity, Counter64, NotificationType, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibIdentifier", "Gauge32", "Bits", "Unsigned32", "NotificationType", "IpAddress", "ObjectIdentity", "iso", "ModuleIdentity", "Counter64", "NotificationType", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32")
...
mibBuilder.exportSymbols("T3610-MIB", tables=tables, trapTest=trapTest, compValMin=compValMin, histCompVal=histCompVal, trapTempError=trapTempError, deviceType=deviceType, trapEmailErrSome=trapEmailErrSome, trapTempHighAlarm=trapTempHighAlarm, serialNumber=serialNumber, humAlarmInt=humAlarmInt, trapHumError=trapHumError, tempHystInt=tempHystInt, trapSOAPErrSocket=trapSOAPErrSocket, historyTable=historyTable, trapCompValHighAlarm=trapCompValHighAlarm, historyEntry=historyEntry, trapEmailErrLogin=trapEmailErrLogin, tempAlarm=tempAlarm, settings=settings, compValHystInt=compValHystInt, temp=temp, compValAlarm=compValAlarm, sensorName=sensorName, tempDelayInt=tempDelayInt, trapCompValClrAlarm=trapCompValClrAlarm, t3610=t3610, humUnit=humUnit, tempLowInt=tempLowInt, comet=comet, humDelayInt=humDelayInt, tempHighInt=tempHighInt, trapEmailErrDNS=trapEmailErrDNS, trapCompValLowAlarm=trapCompValLowAlarm, trapSOAPErrFile=trapSOAPErrFile, trapTempLowAlarm=trapTempLowAlarm, compValLowInt=compValLowInt, humMin=humMin, trapCompValError=trapCompValError, tempUnit=tempUnit, tempAlarmInt=tempAlarmInt, histTemp=histTemp, traps=traps, messageString=messageString, trapEmailErrSocket=trapEmailErrSocket, humAlarm=humAlarm, humInt=humInt, trapTempClrAlarm=trapTempClrAlarm, trapHumClrAlarm=trapHumClrAlarm, compValAlarmInt=compValAlarmInt, humHystInt=humHystInt, tempInt=tempInt, compValHighInt=compValHighInt, trapSOAPErrDNS=trapSOAPErrDNS, humHighInt=humHighInt, compValDelayInt=compValDelayInt, trapHumHighAlarm=trapHumHighAlarm, DisplayString=DisplayString, valuesInt=valuesInt, humMax=humMax, values=values, tempMin=tempMin, products=products, trapHumLowAlarm=trapHumLowAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, humLowInt=humLowInt, compValUnit=compValUnit, trapEmailErrAuth=trapEmailErrAuth, hum=hum, tempMax=tempMax, compValMax=compValMax, compVal=compVal, trapNTPError=trapNTPError, histHum=histHum, pysmi_global=pysmi_global, compValInt=compValInt)
