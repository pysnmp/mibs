...
# Produced by pysmi-1.1.8 at Sun Jan 16 15:48:42 2022
...
TimeTicks, enterprises, NotificationType, MibIdentifier, IpAddress, NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ModuleIdentity, Bits, Gauge32, ObjectIdentity, iso, Integer32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "enterprises", "NotificationType", "MibIdentifier", "IpAddress", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ModuleIdentity", "Bits", "Gauge32", "ObjectIdentity", "iso", "Integer32", "Unsigned32")
...
mibBuilder.exportSymbols("T3610-MIB", humUnit=humUnit, temp=temp, tempMax=tempMax, trapTempClrAlarm=trapTempClrAlarm, tempHystInt=tempHystInt, tempHighInt=tempHighInt, compValDelayInt=compValDelayInt, deviceType=deviceType, tempMin=tempMin, humDelayInt=humDelayInt, histHum=histHum, trapNTPError=trapNTPError, trapCompValHighAlarm=trapCompValHighAlarm, trapCompValError=trapCompValError, tables=tables, compValHystInt=compValHystInt, settings=settings, trapTempHighAlarm=trapTempHighAlarm, trapSOAPErrFile=trapSOAPErrFile, trapSOAPErrSocket=trapSOAPErrSocket, DisplayString=DisplayString, valuesInt=valuesInt, trapEmailErrSome=trapEmailErrSome, trapCompValClrAlarm=trapCompValClrAlarm, histCompVal=histCompVal, tempInt=tempInt, comet=comet, histTemp=histTemp, tempUnit=tempUnit, humMax=humMax, humHighInt=humHighInt, hum=hum, historyEntry=historyEntry, trapEmailErrLogin=trapEmailErrLogin, humLowInt=humLowInt, tempLowInt=tempLowInt, compValHighInt=compValHighInt, trapTempLowAlarm=trapTempLowAlarm, humHystInt=humHystInt, humAlarm=humAlarm, serialNumber=serialNumber, trapHumError=trapHumError, traps=traps, trapSOAPErrDNS=trapSOAPErrDNS, humAlarmInt=humAlarmInt, humInt=humInt, trapEmailErrAuth=trapEmailErrAuth, compValAlarm=compValAlarm, trapHumClrAlarm=trapHumClrAlarm, compValMin=compValMin, trapEmailErrDNS=trapEmailErrDNS, compVal=compVal, trapHumHighAlarm=trapHumHighAlarm, compValUnit=compValUnit, trapTempError=trapTempError, trapEmailErrSocket=trapEmailErrSocket, pysmi_global=pysmi_global, t3610=t3610, values=values, messageString=messageString, trapTest=trapTest, trapHumLowAlarm=trapHumLowAlarm, compValInt=compValInt, tempDelayInt=tempDelayInt, trapSOAPErrDelivery=trapSOAPErrDelivery, humMin=humMin, historyTable=historyTable, trapCompValLowAlarm=trapCompValLowAlarm, tempAlarm=tempAlarm, products=products, sensorName=sensorName, compValMax=compValMax, tempAlarmInt=tempAlarmInt, compValAlarmInt=compValAlarmInt, compValLowInt=compValLowInt)
