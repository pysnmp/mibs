...
# Produced by pysmi-1.1.3 at Sat Nov 20 21:33:50 2021
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, TimeTicks, MibIdentifier, ModuleIdentity, ObjectIdentity, Bits, NotificationType, iso, Integer32, Counter32, IpAddress, enterprises, Counter64, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "TimeTicks", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "Bits", "NotificationType", "iso", "Integer32", "Counter32", "IpAddress", "enterprises", "Counter64", "Unsigned32")
...
mibBuilder.exportSymbols("T3610-MIB", humMax=humMax, settings=settings, humInt=humInt, trapHumError=trapHumError, temp=temp, historyTable=historyTable, sensorName=sensorName, trapEmailErrDNS=trapEmailErrDNS, trapHumHighAlarm=trapHumHighAlarm, tempAlarm=tempAlarm, compValDelayInt=compValDelayInt, trapEmailErrSome=trapEmailErrSome, histHum=histHum, tables=tables, tempMax=tempMax, serialNumber=serialNumber, comet=comet, humAlarmInt=humAlarmInt, histTemp=histTemp, messageString=messageString, trapEmailErrLogin=trapEmailErrLogin, DisplayString=DisplayString, tempLowInt=tempLowInt, products=products, trapEmailErrAuth=trapEmailErrAuth, t3610=t3610, compVal=compVal, compValHystInt=compValHystInt, trapEmailErrSocket=trapEmailErrSocket, trapCompValHighAlarm=trapCompValHighAlarm, compValUnit=compValUnit, trapHumLowAlarm=trapHumLowAlarm, deviceType=deviceType, tempAlarmInt=tempAlarmInt, compValAlarm=compValAlarm, hum=hum, humMin=humMin, humLowInt=humLowInt, trapCompValError=trapCompValError, compValMax=compValMax, trapTest=trapTest, compValHighInt=compValHighInt, trapSOAPErrDNS=trapSOAPErrDNS, trapCompValClrAlarm=trapCompValClrAlarm, humUnit=humUnit, tempInt=tempInt, humAlarm=humAlarm, humHighInt=humHighInt, pysmi_global=pysmi_global, tempHystInt=tempHystInt, trapSOAPErrDelivery=trapSOAPErrDelivery, humHystInt=humHystInt, tempUnit=tempUnit, histCompVal=histCompVal, trapSOAPErrSocket=trapSOAPErrSocket, compValInt=compValInt, values=values, compValLowInt=compValLowInt, trapTempClrAlarm=trapTempClrAlarm, humDelayInt=humDelayInt, trapNTPError=trapNTPError, tempMin=tempMin, trapHumClrAlarm=trapHumClrAlarm, trapTempError=trapTempError, tempDelayInt=tempDelayInt, trapSOAPErrFile=trapSOAPErrFile, trapTempHighAlarm=trapTempHighAlarm, trapTempLowAlarm=trapTempLowAlarm, traps=traps, compValAlarmInt=compValAlarmInt, tempHighInt=tempHighInt, historyEntry=historyEntry, valuesInt=valuesInt, trapCompValLowAlarm=trapCompValLowAlarm, compValMin=compValMin)
