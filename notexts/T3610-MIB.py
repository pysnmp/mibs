...
# Produced by pysmi-1.1.12 at Tue Dec  3 10:53:44 2024
...
Integer32, Unsigned32, Counter32, ObjectIdentity, NotificationType, iso, IpAddress, MibIdentifier, TimeTicks, enterprises, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Bits, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "Counter32", "ObjectIdentity", "NotificationType", "iso", "IpAddress", "MibIdentifier", "TimeTicks", "enterprises", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Bits", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", humMin=humMin, trapSOAPErrDNS=trapSOAPErrDNS, trapCompValError=trapCompValError, compValAlarm=compValAlarm, pysmi_global=pysmi_global, humInt=humInt, trapEmailErrSome=trapEmailErrSome, trapTempClrAlarm=trapTempClrAlarm, humAlarmInt=humAlarmInt, trapEmailErrLogin=trapEmailErrLogin, trapTempHighAlarm=trapTempHighAlarm, values=values, trapSOAPErrSocket=trapSOAPErrSocket, trapHumClrAlarm=trapHumClrAlarm, trapTempLowAlarm=trapTempLowAlarm, trapTempError=trapTempError, compValInt=compValInt, histHum=histHum, compValUnit=compValUnit, compVal=compVal, humUnit=humUnit, products=products, tempMin=tempMin, tables=tables, DisplayString=DisplayString, compValAlarmInt=compValAlarmInt, sensorName=sensorName, serialNumber=serialNumber, compValHighInt=compValHighInt, humDelayInt=humDelayInt, deviceType=deviceType, tempInt=tempInt, histTemp=histTemp, trapHumHighAlarm=trapHumHighAlarm, trapCompValHighAlarm=trapCompValHighAlarm, compValMax=compValMax, comet=comet, compValDelayInt=compValDelayInt, humHighInt=humHighInt, tempAlarmInt=tempAlarmInt, traps=traps, historyEntry=historyEntry, historyTable=historyTable, compValHystInt=compValHystInt, trapEmailErrSocket=trapEmailErrSocket, compValMin=compValMin, compValLowInt=compValLowInt, trapCompValClrAlarm=trapCompValClrAlarm, valuesInt=valuesInt, tempMax=tempMax, trapEmailErrDNS=trapEmailErrDNS, hum=hum, trapSOAPErrDelivery=trapSOAPErrDelivery, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrFile=trapSOAPErrFile, humLowInt=humLowInt, trapTest=trapTest, tempLowInt=tempLowInt, t3610=t3610, histCompVal=histCompVal, tempHighInt=tempHighInt, trapHumLowAlarm=trapHumLowAlarm, trapCompValLowAlarm=trapCompValLowAlarm, tempDelayInt=tempDelayInt, tempAlarm=tempAlarm, tempHystInt=tempHystInt, humHystInt=humHystInt, messageString=messageString, trapNTPError=trapNTPError, settings=settings, humAlarm=humAlarm, tempUnit=tempUnit, humMax=humMax, temp=temp, trapHumError=trapHumError)
