...
# Produced by pysmi-1.1.3 at Wed Dec  1 17:11:52 2021
...
Counter32, ModuleIdentity, Bits, TimeTicks, Integer32, NotificationType, iso, ObjectIdentity, IpAddress, Counter64, Unsigned32, enterprises, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "Bits", "TimeTicks", "Integer32", "NotificationType", "iso", "ObjectIdentity", "IpAddress", "Counter64", "Unsigned32", "enterprises", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32")
...
mibBuilder.exportSymbols("T3610-MIB", trapEmailErrSocket=trapEmailErrSocket, settings=settings, humInt=humInt, humDelayInt=humDelayInt, compVal=compVal, compValUnit=compValUnit, tempInt=tempInt, tempAlarm=tempAlarm, DisplayString=DisplayString, trapTest=trapTest, tempHystInt=tempHystInt, compValHystInt=compValHystInt, trapSOAPErrSocket=trapSOAPErrSocket, humAlarm=humAlarm, tempHighInt=tempHighInt, historyEntry=historyEntry, histTemp=histTemp, products=products, deviceType=deviceType, trapSOAPErrFile=trapSOAPErrFile, tempUnit=tempUnit, trapEmailErrDNS=trapEmailErrDNS, compValInt=compValInt, trapTempError=trapTempError, trapCompValLowAlarm=trapCompValLowAlarm, trapCompValHighAlarm=trapCompValHighAlarm, humHystInt=humHystInt, messageString=messageString, values=values, tempLowInt=tempLowInt, trapHumHighAlarm=trapHumHighAlarm, humMax=humMax, tempAlarmInt=tempAlarmInt, trapNTPError=trapNTPError, humMin=humMin, trapCompValClrAlarm=trapCompValClrAlarm, traps=traps, hum=hum, sensorName=sensorName, trapHumError=trapHumError, trapTempLowAlarm=trapTempLowAlarm, compValDelayInt=compValDelayInt, humUnit=humUnit, histHum=histHum, historyTable=historyTable, trapEmailErrAuth=trapEmailErrAuth, trapTempHighAlarm=trapTempHighAlarm, trapEmailErrLogin=trapEmailErrLogin, trapCompValError=trapCompValError, compValAlarmInt=compValAlarmInt, trapHumLowAlarm=trapHumLowAlarm, trapTempClrAlarm=trapTempClrAlarm, trapEmailErrSome=trapEmailErrSome, compValHighInt=compValHighInt, trapSOAPErrDNS=trapSOAPErrDNS, trapSOAPErrDelivery=trapSOAPErrDelivery, tempMax=tempMax, humLowInt=humLowInt, compValAlarm=compValAlarm, serialNumber=serialNumber, valuesInt=valuesInt, histCompVal=histCompVal, trapHumClrAlarm=trapHumClrAlarm, humHighInt=humHighInt, tables=tables, compValMin=compValMin, t3610=t3610, comet=comet, temp=temp, compValMax=compValMax, tempMin=tempMin, compValLowInt=compValLowInt, pysmi_global=pysmi_global, tempDelayInt=tempDelayInt, humAlarmInt=humAlarmInt)
