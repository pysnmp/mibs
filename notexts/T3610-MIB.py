...
# Produced by pysmi-1.1.8 at Fri Jan  7 16:58:48 2022
...
Counter32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, MibIdentifier, TimeTicks, ObjectIdentity, Bits, NotificationType, ModuleIdentity, iso, Counter64, Gauge32, IpAddress, enterprises, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "MibIdentifier", "TimeTicks", "ObjectIdentity", "Bits", "NotificationType", "ModuleIdentity", "iso", "Counter64", "Gauge32", "IpAddress", "enterprises", "Integer32")
...
mibBuilder.exportSymbols("T3610-MIB", trapHumError=trapHumError, compValMin=compValMin, tempAlarmInt=tempAlarmInt, messageString=messageString, humInt=humInt, DisplayString=DisplayString, comet=comet, trapHumHighAlarm=trapHumHighAlarm, trapCompValHighAlarm=trapCompValHighAlarm, trapEmailErrLogin=trapEmailErrLogin, humMin=humMin, sensorName=sensorName, compValUnit=compValUnit, compValInt=compValInt, trapHumLowAlarm=trapHumLowAlarm, tempAlarm=tempAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTest=trapTest, humAlarm=humAlarm, tempDelayInt=tempDelayInt, humAlarmInt=humAlarmInt, humHystInt=humHystInt, trapSOAPErrFile=trapSOAPErrFile, compValLowInt=compValLowInt, compVal=compVal, traps=traps, hum=hum, tempMax=tempMax, deviceType=deviceType, compValAlarm=compValAlarm, humHighInt=humHighInt, settings=settings, compValHystInt=compValHystInt, trapEmailErrSome=trapEmailErrSome, tempUnit=tempUnit, trapSOAPErrDNS=trapSOAPErrDNS, trapTempError=trapTempError, histHum=histHum, trapHumClrAlarm=trapHumClrAlarm, pysmi_global=pysmi_global, trapNTPError=trapNTPError, trapSOAPErrSocket=trapSOAPErrSocket, trapTempClrAlarm=trapTempClrAlarm, tempMin=tempMin, histTemp=histTemp, tempHystInt=tempHystInt, humUnit=humUnit, humMax=humMax, tempInt=tempInt, tables=tables, compValAlarmInt=compValAlarmInt, historyTable=historyTable, trapTempHighAlarm=trapTempHighAlarm, trapCompValLowAlarm=trapCompValLowAlarm, values=values, histCompVal=histCompVal, humDelayInt=humDelayInt, temp=temp, t3610=t3610, compValMax=compValMax, humLowInt=humLowInt, trapEmailErrDNS=trapEmailErrDNS, trapCompValError=trapCompValError, serialNumber=serialNumber, trapEmailErrAuth=trapEmailErrAuth, trapTempLowAlarm=trapTempLowAlarm, tempHighInt=tempHighInt, compValHighInt=compValHighInt, trapCompValClrAlarm=trapCompValClrAlarm, historyEntry=historyEntry, products=products, compValDelayInt=compValDelayInt, trapEmailErrSocket=trapEmailErrSocket, tempLowInt=tempLowInt, valuesInt=valuesInt)
