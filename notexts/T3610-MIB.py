...
# Produced by pysmi-1.1.8 at Wed Jun 29 13:29:46 2022
...
enterprises, Counter32, Gauge32, iso, ModuleIdentity, Integer32, Bits, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, NotificationType, TimeTicks, MibIdentifier, IpAddress, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter32", "Gauge32", "iso", "ModuleIdentity", "Integer32", "Bits", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "NotificationType", "TimeTicks", "MibIdentifier", "IpAddress", "ObjectIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", trapNTPError=trapNTPError, humDelayInt=humDelayInt, tempHighInt=tempHighInt, comet=comet, humMax=humMax, historyTable=historyTable, traps=traps, tempDelayInt=tempDelayInt, temp=temp, trapHumHighAlarm=trapHumHighAlarm, tempAlarmInt=tempAlarmInt, trapTempLowAlarm=trapTempLowAlarm, trapTempHighAlarm=trapTempHighAlarm, compValAlarm=compValAlarm, serialNumber=serialNumber, trapHumLowAlarm=trapHumLowAlarm, humUnit=humUnit, trapEmailErrAuth=trapEmailErrAuth, trapEmailErrSocket=trapEmailErrSocket, trapTempError=trapTempError, compValHighInt=compValHighInt, trapTest=trapTest, tempMin=tempMin, deviceType=deviceType, trapTempClrAlarm=trapTempClrAlarm, trapHumClrAlarm=trapHumClrAlarm, tempAlarm=tempAlarm, trapCompValLowAlarm=trapCompValLowAlarm, compValMax=compValMax, compValLowInt=compValLowInt, trapEmailErrDNS=trapEmailErrDNS, tempHystInt=tempHystInt, trapSOAPErrFile=trapSOAPErrFile, sensorName=sensorName, tempMax=tempMax, valuesInt=valuesInt, t3610=t3610, messageString=messageString, humMin=humMin, tempLowInt=tempLowInt, trapCompValError=trapCompValError, trapCompValHighAlarm=trapCompValHighAlarm, compVal=compVal, histHum=histHum, trapSOAPErrDNS=trapSOAPErrDNS, trapHumError=trapHumError, tables=tables, compValUnit=compValUnit, trapSOAPErrSocket=trapSOAPErrSocket, humInt=humInt, trapCompValClrAlarm=trapCompValClrAlarm, humAlarmInt=humAlarmInt, products=products, trapSOAPErrDelivery=trapSOAPErrDelivery, histTemp=histTemp, tempUnit=tempUnit, values=values, compValHystInt=compValHystInt, compValAlarmInt=compValAlarmInt, settings=settings, humLowInt=humLowInt, DisplayString=DisplayString, pysmi_global=pysmi_global, humAlarm=humAlarm, humHystInt=humHystInt, trapEmailErrSome=trapEmailErrSome, compValMin=compValMin, humHighInt=humHighInt, historyEntry=historyEntry, hum=hum, tempInt=tempInt, trapEmailErrLogin=trapEmailErrLogin, histCompVal=histCompVal, compValDelayInt=compValDelayInt, compValInt=compValInt)
