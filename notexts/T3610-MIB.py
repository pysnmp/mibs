...
# Produced by pysmi-1.1.12 at Tue Jun  4 12:00:36 2024
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier, iso, enterprises, NotificationType, Unsigned32, TimeTicks, ModuleIdentity, Counter64, IpAddress, Bits, NotificationType, Gauge32, Counter32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier", "iso", "enterprises", "NotificationType", "Unsigned32", "TimeTicks", "ModuleIdentity", "Counter64", "IpAddress", "Bits", "NotificationType", "Gauge32", "Counter32", "ObjectIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", compValAlarmInt=compValAlarmInt, tempUnit=tempUnit, trapTempError=trapTempError, trapNTPError=trapNTPError, trapCompValHighAlarm=trapCompValHighAlarm, histHum=histHum, trapHumError=trapHumError, pysmi_global=pysmi_global, histCompVal=histCompVal, hum=hum, compValHighInt=compValHighInt, compValMax=compValMax, valuesInt=valuesInt, trapTempClrAlarm=trapTempClrAlarm, humInt=humInt, compValUnit=compValUnit, tempMax=tempMax, trapHumHighAlarm=trapHumHighAlarm, humUnit=humUnit, sensorName=sensorName, comet=comet, histTemp=histTemp, tempAlarmInt=tempAlarmInt, messageString=messageString, compValAlarm=compValAlarm, products=products, trapEmailErrLogin=trapEmailErrLogin, tempMin=tempMin, DisplayString=DisplayString, compValInt=compValInt, humAlarmInt=humAlarmInt, tables=tables, tempHighInt=tempHighInt, tempDelayInt=tempDelayInt, compValDelayInt=compValDelayInt, trapEmailErrSome=trapEmailErrSome, trapSOAPErrFile=trapSOAPErrFile, trapTempHighAlarm=trapTempHighAlarm, trapTempLowAlarm=trapTempLowAlarm, tempAlarm=tempAlarm, trapHumClrAlarm=trapHumClrAlarm, humDelayInt=humDelayInt, temp=temp, t3610=t3610, trapSOAPErrSocket=trapSOAPErrSocket, trapHumLowAlarm=trapHumLowAlarm, humHystInt=humHystInt, humLowInt=humLowInt, compVal=compVal, compValLowInt=compValLowInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapCompValLowAlarm=trapCompValLowAlarm, humHighInt=humHighInt, trapEmailErrAuth=trapEmailErrAuth, humMax=humMax, historyEntry=historyEntry, trapSOAPErrDNS=trapSOAPErrDNS, tempLowInt=tempLowInt, historyTable=historyTable, compValHystInt=compValHystInt, deviceType=deviceType, values=values, trapCompValError=trapCompValError, tempHystInt=tempHystInt, trapEmailErrSocket=trapEmailErrSocket, traps=traps, compValMin=compValMin, tempInt=tempInt, trapEmailErrDNS=trapEmailErrDNS, humAlarm=humAlarm, serialNumber=serialNumber, trapCompValClrAlarm=trapCompValClrAlarm, settings=settings, humMin=humMin, trapTest=trapTest)
