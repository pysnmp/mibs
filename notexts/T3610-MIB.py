...
# Produced by pysmi-1.1.8 at Mon Sep 19 08:26:11 2022
...
NotificationType, Counter64, ModuleIdentity, iso, Gauge32, Bits, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, Unsigned32, IpAddress, enterprises, MibIdentifier, ObjectIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "ModuleIdentity", "iso", "Gauge32", "Bits", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "Unsigned32", "IpAddress", "enterprises", "MibIdentifier", "ObjectIdentity", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", tempDelayInt=tempDelayInt, historyTable=historyTable, humAlarmInt=humAlarmInt, tables=tables, deviceType=deviceType, trapEmailErrSocket=trapEmailErrSocket, histHum=histHum, compValMax=compValMax, tempHystInt=tempHystInt, tempMin=tempMin, trapTempError=trapTempError, tempUnit=tempUnit, serialNumber=serialNumber, humLowInt=humLowInt, trapCompValHighAlarm=trapCompValHighAlarm, compValInt=compValInt, trapTempHighAlarm=trapTempHighAlarm, humUnit=humUnit, humHystInt=humHystInt, humInt=humInt, tempMax=tempMax, trapCompValError=trapCompValError, sensorName=sensorName, compValHystInt=compValHystInt, DisplayString=DisplayString, trapHumHighAlarm=trapHumHighAlarm, compValHighInt=compValHighInt, values=values, trapEmailErrLogin=trapEmailErrLogin, trapSOAPErrSocket=trapSOAPErrSocket, trapTest=trapTest, trapNTPError=trapNTPError, trapTempLowAlarm=trapTempLowAlarm, histTemp=histTemp, trapHumClrAlarm=trapHumClrAlarm, trapCompValClrAlarm=trapCompValClrAlarm, humMin=humMin, humDelayInt=humDelayInt, hum=hum, tempAlarm=tempAlarm, traps=traps, humMax=humMax, compVal=compVal, compValDelayInt=compValDelayInt, trapHumLowAlarm=trapHumLowAlarm, trapEmailErrSome=trapEmailErrSome, compValLowInt=compValLowInt, tempLowInt=tempLowInt, compValAlarmInt=compValAlarmInt, tempHighInt=tempHighInt, trapEmailErrAuth=trapEmailErrAuth, humHighInt=humHighInt, tempAlarmInt=tempAlarmInt, humAlarm=humAlarm, products=products, historyEntry=historyEntry, trapHumError=trapHumError, pysmi_global=pysmi_global, valuesInt=valuesInt, compValAlarm=compValAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTempClrAlarm=trapTempClrAlarm, messageString=messageString, trapEmailErrDNS=trapEmailErrDNS, tempInt=tempInt, t3610=t3610, settings=settings, temp=temp, trapSOAPErrFile=trapSOAPErrFile, trapCompValLowAlarm=trapCompValLowAlarm, trapSOAPErrDNS=trapSOAPErrDNS, histCompVal=histCompVal, comet=comet, compValMin=compValMin, compValUnit=compValUnit)
