...
# Produced by pysmi-1.1.8 at Tue Aug  9 15:38:34 2022
...
MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, MibIdentifier, ModuleIdentity, TimeTicks, IpAddress, NotificationType, ObjectIdentity, Gauge32, NotificationType, Counter64, Unsigned32, iso, Counter32, Integer32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "MibIdentifier", "ModuleIdentity", "TimeTicks", "IpAddress", "NotificationType", "ObjectIdentity", "Gauge32", "NotificationType", "Counter64", "Unsigned32", "iso", "Counter32", "Integer32", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", trapSOAPErrDNS=trapSOAPErrDNS, hum=hum, tempAlarmInt=tempAlarmInt, trapHumError=trapHumError, trapHumLowAlarm=trapHumLowAlarm, humUnit=humUnit, sensorName=sensorName, trapNTPError=trapNTPError, trapEmailErrDNS=trapEmailErrDNS, humHystInt=humHystInt, comet=comet, compValAlarmInt=compValAlarmInt, settings=settings, trapTempLowAlarm=trapTempLowAlarm, temp=temp, trapCompValLowAlarm=trapCompValLowAlarm, trapHumClrAlarm=trapHumClrAlarm, histTemp=histTemp, trapCompValClrAlarm=trapCompValClrAlarm, trapTempError=trapTempError, compVal=compVal, tables=tables, t3610=t3610, compValMin=compValMin, DisplayString=DisplayString, pysmi_global=pysmi_global, humLowInt=humLowInt, tempMin=tempMin, trapTempClrAlarm=trapTempClrAlarm, humAlarmInt=humAlarmInt, humMin=humMin, histHum=histHum, trapSOAPErrSocket=trapSOAPErrSocket, trapEmailErrSome=trapEmailErrSome, values=values, compValLowInt=compValLowInt, historyEntry=historyEntry, trapEmailErrSocket=trapEmailErrSocket, trapCompValHighAlarm=trapCompValHighAlarm, trapTest=trapTest, compValUnit=compValUnit, serialNumber=serialNumber, messageString=messageString, histCompVal=histCompVal, compValHighInt=compValHighInt, historyTable=historyTable, tempUnit=tempUnit, humMax=humMax, tempInt=tempInt, trapEmailErrAuth=trapEmailErrAuth, products=products, tempLowInt=tempLowInt, trapSOAPErrDelivery=trapSOAPErrDelivery, tempMax=tempMax, humDelayInt=humDelayInt, trapCompValError=trapCompValError, trapTempHighAlarm=trapTempHighAlarm, trapHumHighAlarm=trapHumHighAlarm, compValDelayInt=compValDelayInt, humAlarm=humAlarm, compValInt=compValInt, traps=traps, trapEmailErrLogin=trapEmailErrLogin, deviceType=deviceType, tempHighInt=tempHighInt, humHighInt=humHighInt, humInt=humInt, tempHystInt=tempHystInt, compValMax=compValMax, tempDelayInt=tempDelayInt, tempAlarm=tempAlarm, compValAlarm=compValAlarm, valuesInt=valuesInt, trapSOAPErrFile=trapSOAPErrFile, compValHystInt=compValHystInt)
