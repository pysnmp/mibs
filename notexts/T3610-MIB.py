...
# Produced by pysmi-1.1.8 at Fri Jan  7 16:16:19 2022
...
enterprises, IpAddress, Unsigned32, ModuleIdentity, MibIdentifier, iso, Bits, NotificationType, Gauge32, NotificationType, Integer32, ObjectIdentity, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "IpAddress", "Unsigned32", "ModuleIdentity", "MibIdentifier", "iso", "Bits", "NotificationType", "Gauge32", "NotificationType", "Integer32", "ObjectIdentity", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("T3610-MIB", tempAlarmInt=tempAlarmInt, compValAlarmInt=compValAlarmInt, trapSOAPErrSocket=trapSOAPErrSocket, t3610=t3610, comet=comet, compValHighInt=compValHighInt, compValMax=compValMax, humInt=humInt, humHighInt=humHighInt, compValDelayInt=compValDelayInt, trapNTPError=trapNTPError, trapEmailErrDNS=trapEmailErrDNS, trapSOAPErrDelivery=trapSOAPErrDelivery, tempDelayInt=tempDelayInt, trapEmailErrLogin=trapEmailErrLogin, trapTempError=trapTempError, valuesInt=valuesInt, serialNumber=serialNumber, tempHighInt=tempHighInt, trapCompValHighAlarm=trapCompValHighAlarm, trapCompValLowAlarm=trapCompValLowAlarm, tempAlarm=tempAlarm, humMin=humMin, humHystInt=humHystInt, trapTempLowAlarm=trapTempLowAlarm, trapEmailErrAuth=trapEmailErrAuth, trapTest=trapTest, tempInt=tempInt, humDelayInt=humDelayInt, trapCompValError=trapCompValError, compValMin=compValMin, tempMin=tempMin, deviceType=deviceType, trapEmailErrSocket=trapEmailErrSocket, trapTempHighAlarm=trapTempHighAlarm, trapHumLowAlarm=trapHumLowAlarm, trapHumClrAlarm=trapHumClrAlarm, trapSOAPErrDNS=trapSOAPErrDNS, tables=tables, temp=temp, traps=traps, tempLowInt=tempLowInt, tempUnit=tempUnit, compValUnit=compValUnit, compVal=compVal, trapTempClrAlarm=trapTempClrAlarm, trapSOAPErrFile=trapSOAPErrFile, trapCompValClrAlarm=trapCompValClrAlarm, hum=hum, humLowInt=humLowInt, compValInt=compValInt, humAlarmInt=humAlarmInt, values=values, humAlarm=humAlarm, tempMax=tempMax, trapHumError=trapHumError, settings=settings, humMax=humMax, histTemp=histTemp, tempHystInt=tempHystInt, compValLowInt=compValLowInt, compValHystInt=compValHystInt, DisplayString=DisplayString, compValAlarm=compValAlarm, historyEntry=historyEntry, histHum=histHum, trapEmailErrSome=trapEmailErrSome, messageString=messageString, pysmi_global=pysmi_global, products=products, histCompVal=histCompVal, sensorName=sensorName, trapHumHighAlarm=trapHumHighAlarm, historyTable=historyTable, humUnit=humUnit)
