...
# Produced by pysmi-1.1.3 at Wed Dec  8 20:20:54 2021
...
Gauge32, ModuleIdentity, TimeTicks, IpAddress, NotificationType, enterprises, NotificationType, Counter32, iso, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Integer32, MibIdentifier, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "TimeTicks", "IpAddress", "NotificationType", "enterprises", "NotificationType", "Counter32", "iso", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Integer32", "MibIdentifier", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", serialNumber=serialNumber, pysmi_global=pysmi_global, humAlarm=humAlarm, trapNTPError=trapNTPError, tempDelayInt=tempDelayInt, humLowInt=humLowInt, compValDelayInt=compValDelayInt, humDelayInt=humDelayInt, trapCompValClrAlarm=trapCompValClrAlarm, tempInt=tempInt, trapTempHighAlarm=trapTempHighAlarm, t3610=t3610, trapEmailErrSocket=trapEmailErrSocket, trapHumHighAlarm=trapHumHighAlarm, compValHystInt=compValHystInt, histTemp=histTemp, tempMax=tempMax, values=values, compValAlarmInt=compValAlarmInt, histCompVal=histCompVal, trapTempLowAlarm=trapTempLowAlarm, humMax=humMax, tempMin=tempMin, trapSOAPErrFile=trapSOAPErrFile, trapHumLowAlarm=trapHumLowAlarm, trapTempClrAlarm=trapTempClrAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValHighAlarm=trapCompValHighAlarm, tempUnit=tempUnit, trapEmailErrAuth=trapEmailErrAuth, compValAlarm=compValAlarm, humMin=humMin, sensorName=sensorName, comet=comet, DisplayString=DisplayString, tempHystInt=tempHystInt, humHystInt=humHystInt, trapHumClrAlarm=trapHumClrAlarm, trapTest=trapTest, tempLowInt=tempLowInt, trapTempError=trapTempError, messageString=messageString, tempAlarm=tempAlarm, tables=tables, valuesInt=valuesInt, compVal=compVal, compValMin=compValMin, compValHighInt=compValHighInt, humInt=humInt, trapHumError=trapHumError, compValUnit=compValUnit, historyEntry=historyEntry, humUnit=humUnit, trapEmailErrLogin=trapEmailErrLogin, trapEmailErrSome=trapEmailErrSome, compValLowInt=compValLowInt, compValMax=compValMax, humHighInt=humHighInt, tempAlarmInt=tempAlarmInt, compValInt=compValInt, traps=traps, trapCompValLowAlarm=trapCompValLowAlarm, hum=hum, tempHighInt=tempHighInt, trapSOAPErrDNS=trapSOAPErrDNS, historyTable=historyTable, temp=temp, settings=settings, humAlarmInt=humAlarmInt, trapEmailErrDNS=trapEmailErrDNS, trapCompValError=trapCompValError, deviceType=deviceType, histHum=histHum, products=products)
