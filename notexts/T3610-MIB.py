...
# Produced by pysmi-1.1.12 at Tue May 28 11:44:49 2024
...
NotificationType, MibIdentifier, Gauge32, NotificationType, enterprises, Bits, Integer32, Counter32, IpAddress, Counter64, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, iso, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "Gauge32", "NotificationType", "enterprises", "Bits", "Integer32", "Counter32", "IpAddress", "Counter64", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "iso", "ModuleIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", compValMin=compValMin, histHum=histHum, DisplayString=DisplayString, tempLowInt=tempLowInt, tempAlarmInt=tempAlarmInt, trapEmailErrLogin=trapEmailErrLogin, comet=comet, compValAlarmInt=compValAlarmInt, messageString=messageString, humLowInt=humLowInt, compValDelayInt=compValDelayInt, trapEmailErrAuth=trapEmailErrAuth, trapTempClrAlarm=trapTempClrAlarm, tables=tables, serialNumber=serialNumber, trapTempHighAlarm=trapTempHighAlarm, humHystInt=humHystInt, histCompVal=histCompVal, tempMin=tempMin, products=products, compValAlarm=compValAlarm, trapHumError=trapHumError, hum=hum, trapEmailErrDNS=trapEmailErrDNS, trapCompValLowAlarm=trapCompValLowAlarm, tempHighInt=tempHighInt, trapNTPError=trapNTPError, trapHumClrAlarm=trapHumClrAlarm, tempMax=tempMax, deviceType=deviceType, humInt=humInt, humAlarmInt=humAlarmInt, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValHighAlarm=trapCompValHighAlarm, compValInt=compValInt, trapTempLowAlarm=trapTempLowAlarm, compValHystInt=compValHystInt, t3610=t3610, trapCompValError=trapCompValError, historyEntry=historyEntry, trapSOAPErrFile=trapSOAPErrFile, trapTempError=trapTempError, compValUnit=compValUnit, compValMax=compValMax, histTemp=histTemp, tempHystInt=tempHystInt, compValLowInt=compValLowInt, trapEmailErrSome=trapEmailErrSome, settings=settings, trapEmailErrSocket=trapEmailErrSocket, trapHumHighAlarm=trapHumHighAlarm, historyTable=historyTable, traps=traps, humUnit=humUnit, tempAlarm=tempAlarm, tempDelayInt=tempDelayInt, trapHumLowAlarm=trapHumLowAlarm, trapCompValClrAlarm=trapCompValClrAlarm, compVal=compVal, pysmi_global=pysmi_global, tempUnit=tempUnit, valuesInt=valuesInt, compValHighInt=compValHighInt, trapTest=trapTest, temp=temp, humMin=humMin, trapSOAPErrDNS=trapSOAPErrDNS, trapSOAPErrDelivery=trapSOAPErrDelivery, humDelayInt=humDelayInt, tempInt=tempInt, sensorName=sensorName, values=values, humMax=humMax, humAlarm=humAlarm, humHighInt=humHighInt)
