...
# Produced by pysmi-1.1.8 at Thu Sep 29 13:03:55 2022
...
enterprises, ModuleIdentity, Counter32, Counter64, MibIdentifier, Integer32, Gauge32, IpAddress, NotificationType, NotificationType, TimeTicks, ObjectIdentity, Unsigned32, iso, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ModuleIdentity", "Counter32", "Counter64", "MibIdentifier", "Integer32", "Gauge32", "IpAddress", "NotificationType", "NotificationType", "TimeTicks", "ObjectIdentity", "Unsigned32", "iso", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("T3610-MIB", tables=tables, tempHighInt=tempHighInt, trapEmailErrSocket=trapEmailErrSocket, trapCompValClrAlarm=trapCompValClrAlarm, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValError=trapCompValError, trapTempError=trapTempError, trapNTPError=trapNTPError, humMax=humMax, serialNumber=serialNumber, trapCompValLowAlarm=trapCompValLowAlarm, products=products, trapHumClrAlarm=trapHumClrAlarm, tempMin=tempMin, trapTempLowAlarm=trapTempLowAlarm, compValLowInt=compValLowInt, values=values, sensorName=sensorName, compValUnit=compValUnit, tempInt=tempInt, trapSOAPErrFile=trapSOAPErrFile, trapHumError=trapHumError, humHighInt=humHighInt, tempMax=tempMax, messageString=messageString, hum=hum, trapTempClrAlarm=trapTempClrAlarm, compValMin=compValMin, trapTempHighAlarm=trapTempHighAlarm, humAlarm=humAlarm, trapEmailErrSome=trapEmailErrSome, settings=settings, compValInt=compValInt, tempAlarm=tempAlarm, humLowInt=humLowInt, traps=traps, tempHystInt=tempHystInt, humMin=humMin, trapEmailErrLogin=trapEmailErrLogin, tempDelayInt=tempDelayInt, compValHighInt=compValHighInt, trapHumLowAlarm=trapHumLowAlarm, temp=temp, trapEmailErrAuth=trapEmailErrAuth, compValHystInt=compValHystInt, trapSOAPErrDelivery=trapSOAPErrDelivery, DisplayString=DisplayString, tempUnit=tempUnit, t3610=t3610, tempAlarmInt=tempAlarmInt, humUnit=humUnit, compValDelayInt=compValDelayInt, humAlarmInt=humAlarmInt, valuesInt=valuesInt, comet=comet, histTemp=histTemp, deviceType=deviceType, humHystInt=humHystInt, histCompVal=histCompVal, humDelayInt=humDelayInt, compVal=compVal, compValMax=compValMax, historyEntry=historyEntry, histHum=histHum, trapHumHighAlarm=trapHumHighAlarm, trapCompValHighAlarm=trapCompValHighAlarm, pysmi_global=pysmi_global, humInt=humInt, historyTable=historyTable, trapEmailErrDNS=trapEmailErrDNS, compValAlarm=compValAlarm, trapSOAPErrDNS=trapSOAPErrDNS, compValAlarmInt=compValAlarmInt, tempLowInt=tempLowInt, trapTest=trapTest)
