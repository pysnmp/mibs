...
# Produced by pysmi-1.1.8 at Mon Jan  2 13:17:30 2023
...
Counter32, IpAddress, Counter64, enterprises, NotificationType, MibIdentifier, ObjectIdentity, NotificationType, iso, Gauge32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ModuleIdentity, TimeTicks, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "IpAddress", "Counter64", "enterprises", "NotificationType", "MibIdentifier", "ObjectIdentity", "NotificationType", "iso", "Gauge32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ModuleIdentity", "TimeTicks", "Unsigned32")
...
mibBuilder.exportSymbols("T3610-MIB", compValLowInt=compValLowInt, humInt=humInt, compValAlarm=compValAlarm, hum=hum, humHighInt=humHighInt, compValHighInt=compValHighInt, trapHumClrAlarm=trapHumClrAlarm, trapCompValClrAlarm=trapCompValClrAlarm, values=values, serialNumber=serialNumber, trapHumLowAlarm=trapHumLowAlarm, trapTempClrAlarm=trapTempClrAlarm, tempAlarm=tempAlarm, humMin=humMin, valuesInt=valuesInt, compValInt=compValInt, humLowInt=humLowInt, histCompVal=histCompVal, messageString=messageString, trapTest=trapTest, trapEmailErrLogin=trapEmailErrLogin, trapTempHighAlarm=trapTempHighAlarm, histHum=histHum, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrDNS=trapSOAPErrDNS, comet=comet, tempMin=tempMin, trapNTPError=trapNTPError, trapTempError=trapTempError, sensorName=sensorName, compValMin=compValMin, trapHumHighAlarm=trapHumHighAlarm, tempAlarmInt=tempAlarmInt, historyTable=historyTable, humUnit=humUnit, t3610=t3610, settings=settings, tempMax=tempMax, temp=temp, trapEmailErrSome=trapEmailErrSome, trapCompValLowAlarm=trapCompValLowAlarm, compValDelayInt=compValDelayInt, tempUnit=tempUnit, humAlarm=humAlarm, tempInt=tempInt, tempLowInt=tempLowInt, trapCompValHighAlarm=trapCompValHighAlarm, humMax=humMax, products=products, compValUnit=compValUnit, humDelayInt=humDelayInt, trapEmailErrAuth=trapEmailErrAuth, trapTempLowAlarm=trapTempLowAlarm, histTemp=histTemp, compValHystInt=compValHystInt, trapEmailErrDNS=trapEmailErrDNS, humHystInt=humHystInt, tables=tables, compValMax=compValMax, traps=traps, DisplayString=DisplayString, trapHumError=trapHumError, trapSOAPErrFile=trapSOAPErrFile, trapSOAPErrDelivery=trapSOAPErrDelivery, historyEntry=historyEntry, tempHighInt=tempHighInt, deviceType=deviceType, humAlarmInt=humAlarmInt, trapSOAPErrSocket=trapSOAPErrSocket, compValAlarmInt=compValAlarmInt, tempHystInt=tempHystInt, trapCompValError=trapCompValError, compVal=compVal, tempDelayInt=tempDelayInt, pysmi_global=pysmi_global)
