...
ObjectIdentity, iso, enterprises, Unsigned32, Bits, Counter32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, ModuleIdentity, IpAddress, NotificationType, MibIdentifier, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "iso", "enterprises", "Unsigned32", "Bits", "Counter32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "ModuleIdentity", "IpAddress", "NotificationType", "MibIdentifier", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("T3610-MIB", messageString=messageString, trapCompValHighAlarm=trapCompValHighAlarm, trapHumError=trapHumError, historyTable=historyTable, trapTempLowAlarm=trapTempLowAlarm, compValLowInt=compValLowInt, trapSOAPErrDNS=trapSOAPErrDNS, values=values, trapSOAPErrDelivery=trapSOAPErrDelivery, humAlarmInt=humAlarmInt, trapCompValLowAlarm=trapCompValLowAlarm, humInt=humInt, compValInt=compValInt, traps=traps, tempLowInt=tempLowInt, settings=settings, tempMax=tempMax, humHighInt=humHighInt, trapEmailErrLogin=trapEmailErrLogin, sensorName=sensorName, trapSOAPErrFile=trapSOAPErrFile, tempUnit=tempUnit, histCompVal=histCompVal, trapHumLowAlarm=trapHumLowAlarm, humMin=humMin, trapSOAPErrSocket=trapSOAPErrSocket, trapHumClrAlarm=trapHumClrAlarm, tempInt=tempInt, trapTempClrAlarm=trapTempClrAlarm, compVal=compVal, trapTempError=trapTempError, trapEmailErrSocket=trapEmailErrSocket, trapEmailErrAuth=trapEmailErrAuth, tempHystInt=tempHystInt, historyEntry=historyEntry, trapTempHighAlarm=trapTempHighAlarm, temp=temp, serialNumber=serialNumber, trapEmailErrDNS=trapEmailErrDNS, compValAlarm=compValAlarm, compValAlarmInt=compValAlarmInt, tempAlarmInt=tempAlarmInt, humAlarm=humAlarm, t3610=t3610, humUnit=humUnit, histTemp=histTemp, trapCompValError=trapCompValError, humMax=humMax, trapTest=trapTest, compValHystInt=compValHystInt, histHum=histHum, trapEmailErrSome=trapEmailErrSome, pysmi_global=pysmi_global, comet=comet, hum=hum, products=products, valuesInt=valuesInt, humLowInt=humLowInt, trapHumHighAlarm=trapHumHighAlarm, trapCompValClrAlarm=trapCompValClrAlarm, trapNTPError=trapNTPError, tables=tables, compValUnit=compValUnit, tempMin=tempMin, compValDelayInt=compValDelayInt, deviceType=deviceType, tempAlarm=tempAlarm, tempDelayInt=tempDelayInt, humDelayInt=humDelayInt, compValMax=compValMax, compValHighInt=compValHighInt, humHystInt=humHystInt, DisplayString=DisplayString, tempHighInt=tempHighInt, compValMin=compValMin)
