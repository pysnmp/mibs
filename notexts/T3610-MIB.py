...
# Produced by pysmi-1.1.3 at Thu Dec  9 15:06:04 2021
...
Gauge32, Counter32, TimeTicks, MibIdentifier, Unsigned32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, NotificationType, iso, ModuleIdentity, enterprises, IpAddress, ObjectIdentity, NotificationType, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "TimeTicks", "MibIdentifier", "Unsigned32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "NotificationType", "iso", "ModuleIdentity", "enterprises", "IpAddress", "ObjectIdentity", "NotificationType", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", tempHighInt=tempHighInt, tempAlarm=tempAlarm, humDelayInt=humDelayInt, tempAlarmInt=tempAlarmInt, messageString=messageString, trapEmailErrDNS=trapEmailErrDNS, historyTable=historyTable, sensorName=sensorName, trapTest=trapTest, trapSOAPErrSocket=trapSOAPErrSocket, hum=hum, traps=traps, tables=tables, compValLowInt=compValLowInt, histCompVal=histCompVal, trapSOAPErrDNS=trapSOAPErrDNS, humAlarmInt=humAlarmInt, pysmi_global=pysmi_global, settings=settings, trapHumLowAlarm=trapHumLowAlarm, serialNumber=serialNumber, tempLowInt=tempLowInt, tempMin=tempMin, temp=temp, compValHighInt=compValHighInt, humInt=humInt, tempHystInt=tempHystInt, trapCompValHighAlarm=trapCompValHighAlarm, trapEmailErrAuth=trapEmailErrAuth, trapTempError=trapTempError, histHum=histHum, comet=comet, tempMax=tempMax, compValMax=compValMax, trapCompValError=trapCompValError, trapHumClrAlarm=trapHumClrAlarm, compValMin=compValMin, products=products, trapCompValClrAlarm=trapCompValClrAlarm, trapEmailErrSome=trapEmailErrSome, humMax=humMax, tempDelayInt=tempDelayInt, trapNTPError=trapNTPError, deviceType=deviceType, DisplayString=DisplayString, trapSOAPErrFile=trapSOAPErrFile, humMin=humMin, humAlarm=humAlarm, compValUnit=compValUnit, compValHystInt=compValHystInt, trapTempHighAlarm=trapTempHighAlarm, histTemp=histTemp, trapTempLowAlarm=trapTempLowAlarm, compValAlarm=compValAlarm, humLowInt=humLowInt, trapEmailErrLogin=trapEmailErrLogin, trapSOAPErrDelivery=trapSOAPErrDelivery, trapCompValLowAlarm=trapCompValLowAlarm, trapTempClrAlarm=trapTempClrAlarm, compVal=compVal, humUnit=humUnit, tempUnit=tempUnit, humHystInt=humHystInt, trapEmailErrSocket=trapEmailErrSocket, compValDelayInt=compValDelayInt, values=values, historyEntry=historyEntry, humHighInt=humHighInt, valuesInt=valuesInt, tempInt=tempInt, compValInt=compValInt, trapHumError=trapHumError, trapHumHighAlarm=trapHumHighAlarm, compValAlarmInt=compValAlarmInt, t3610=t3610)
