...
# Produced by pysmi-1.1.10 at Thu Oct 26 13:02:05 2023
...
Integer32, NotificationType, Counter32, NotificationType, Counter64, IpAddress, iso, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, MibIdentifier, enterprises, ObjectIdentity, TimeTicks, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "Counter32", "NotificationType", "Counter64", "IpAddress", "iso", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "MibIdentifier", "enterprises", "ObjectIdentity", "TimeTicks", "Gauge32", "ModuleIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", humUnit=humUnit, values=values, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrDNS=trapSOAPErrDNS, tables=tables, compVal=compVal, trapTempError=trapTempError, historyEntry=historyEntry, comet=comet, trapTempLowAlarm=trapTempLowAlarm, tempUnit=tempUnit, compValAlarm=compValAlarm, hum=hum, trapTempHighAlarm=trapTempHighAlarm, histTemp=histTemp, humAlarm=humAlarm, tempAlarmInt=tempAlarmInt, trapHumLowAlarm=trapHumLowAlarm, trapCompValClrAlarm=trapCompValClrAlarm, tempMax=tempMax, messageString=messageString, trapSOAPErrSocket=trapSOAPErrSocket, tempLowInt=tempLowInt, tempHystInt=tempHystInt, serialNumber=serialNumber, trapCompValLowAlarm=trapCompValLowAlarm, trapCompValError=trapCompValError, humInt=humInt, valuesInt=valuesInt, tempAlarm=tempAlarm, traps=traps, humDelayInt=humDelayInt, pysmi_global=pysmi_global, humHighInt=humHighInt, historyTable=historyTable, compValMin=compValMin, trapSOAPErrDelivery=trapSOAPErrDelivery, humLowInt=humLowInt, tempDelayInt=tempDelayInt, tempInt=tempInt, compValUnit=compValUnit, trapTest=trapTest, trapEmailErrSome=trapEmailErrSome, histCompVal=histCompVal, trapHumHighAlarm=trapHumHighAlarm, trapSOAPErrFile=trapSOAPErrFile, trapHumClrAlarm=trapHumClrAlarm, trapEmailErrSocket=trapEmailErrSocket, products=products, humAlarmInt=humAlarmInt, trapNTPError=trapNTPError, compValDelayInt=compValDelayInt, compValMax=compValMax, t3610=t3610, tempMin=tempMin, compValAlarmInt=compValAlarmInt, trapEmailErrDNS=trapEmailErrDNS, settings=settings, DisplayString=DisplayString, humMin=humMin, compValHighInt=compValHighInt, compValHystInt=compValHystInt, trapHumError=trapHumError, tempHighInt=tempHighInt, deviceType=deviceType, humHystInt=humHystInt, trapEmailErrLogin=trapEmailErrLogin, trapCompValHighAlarm=trapCompValHighAlarm, humMax=humMax, histHum=histHum, compValLowInt=compValLowInt, trapTempClrAlarm=trapTempClrAlarm, sensorName=sensorName, temp=temp, compValInt=compValInt)
