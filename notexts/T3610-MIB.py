...
# Produced by pysmi-1.1.3 at Wed Dec  8 20:58:12 2021
...
enterprises, MibIdentifier, Counter32, NotificationType, TimeTicks, Counter64, Integer32, Unsigned32, IpAddress, ObjectIdentity, Bits, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibIdentifier", "Counter32", "NotificationType", "TimeTicks", "Counter64", "Integer32", "Unsigned32", "IpAddress", "ObjectIdentity", "Bits", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", comet=comet, compValDelayInt=compValDelayInt, trapNTPError=trapNTPError, compVal=compVal, trapCompValHighAlarm=trapCompValHighAlarm, deviceType=deviceType, historyEntry=historyEntry, trapTempClrAlarm=trapTempClrAlarm, histTemp=histTemp, trapCompValClrAlarm=trapCompValClrAlarm, humHighInt=humHighInt, values=values, tempAlarm=tempAlarm, tempMin=tempMin, temp=temp, valuesInt=valuesInt, compValMin=compValMin, trapCompValLowAlarm=trapCompValLowAlarm, compValMax=compValMax, tables=tables, compValHystInt=compValHystInt, humLowInt=humLowInt, humInt=humInt, messageString=messageString, trapEmailErrAuth=trapEmailErrAuth, tempHystInt=tempHystInt, trapEmailErrLogin=trapEmailErrLogin, settings=settings, traps=traps, trapHumHighAlarm=trapHumHighAlarm, tempHighInt=tempHighInt, historyTable=historyTable, trapEmailErrSome=trapEmailErrSome, hum=hum, serialNumber=serialNumber, tempAlarmInt=tempAlarmInt, histHum=histHum, humAlarmInt=humAlarmInt, t3610=t3610, trapSOAPErrDNS=trapSOAPErrDNS, trapHumLowAlarm=trapHumLowAlarm, trapEmailErrDNS=trapEmailErrDNS, humAlarm=humAlarm, tempUnit=tempUnit, compValUnit=compValUnit, humMax=humMax, trapTest=trapTest, trapEmailErrSocket=trapEmailErrSocket, compValInt=compValInt, compValLowInt=compValLowInt, pysmi_global=pysmi_global, products=products, trapSOAPErrSocket=trapSOAPErrSocket, trapTempLowAlarm=trapTempLowAlarm, DisplayString=DisplayString, humHystInt=humHystInt, trapTempHighAlarm=trapTempHighAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, sensorName=sensorName, compValHighInt=compValHighInt, compValAlarm=compValAlarm, trapSOAPErrFile=trapSOAPErrFile, tempLowInt=tempLowInt, humDelayInt=humDelayInt, trapHumError=trapHumError, trapHumClrAlarm=trapHumClrAlarm, trapTempError=trapTempError, compValAlarmInt=compValAlarmInt, histCompVal=histCompVal, tempMax=tempMax, humMin=humMin, humUnit=humUnit, tempInt=tempInt, trapCompValError=trapCompValError, tempDelayInt=tempDelayInt)
