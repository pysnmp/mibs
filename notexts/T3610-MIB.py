...
# Produced by pysmi-1.1.8 at Wed Sep 13 14:52:08 2023
...
Integer32, ModuleIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, TimeTicks, enterprises, iso, Counter32, NotificationType, IpAddress, NotificationType, Counter64, Bits, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "TimeTicks", "enterprises", "iso", "Counter32", "NotificationType", "IpAddress", "NotificationType", "Counter64", "Bits", "Gauge32")
...
mibBuilder.exportSymbols("T3610-MIB", trapCompValClrAlarm=trapCompValClrAlarm, tempInt=tempInt, hum=hum, tempLowInt=tempLowInt, DisplayString=DisplayString, temp=temp, values=values, humInt=humInt, humHystInt=humHystInt, humMax=humMax, trapEmailErrDNS=trapEmailErrDNS, messageString=messageString, trapSOAPErrDelivery=trapSOAPErrDelivery, trapCompValHighAlarm=trapCompValHighAlarm, settings=settings, trapHumLowAlarm=trapHumLowAlarm, trapHumClrAlarm=trapHumClrAlarm, trapEmailErrSome=trapEmailErrSome, trapSOAPErrFile=trapSOAPErrFile, tempMax=tempMax, traps=traps, compValAlarmInt=compValAlarmInt, trapHumError=trapHumError, serialNumber=serialNumber, humUnit=humUnit, sensorName=sensorName, compValUnit=compValUnit, trapNTPError=trapNTPError, historyEntry=historyEntry, humAlarm=humAlarm, tempUnit=tempUnit, compValAlarm=compValAlarm, compValHystInt=compValHystInt, compValDelayInt=compValDelayInt, trapTempLowAlarm=trapTempLowAlarm, trapCompValLowAlarm=trapCompValLowAlarm, compValHighInt=compValHighInt, trapEmailErrAuth=trapEmailErrAuth, humMin=humMin, valuesInt=valuesInt, humHighInt=humHighInt, trapTempError=trapTempError, tempAlarm=tempAlarm, trapHumHighAlarm=trapHumHighAlarm, compValInt=compValInt, t3610=t3610, tempMin=tempMin, historyTable=historyTable, trapSOAPErrDNS=trapSOAPErrDNS, compValLowInt=compValLowInt, humDelayInt=humDelayInt, tempHighInt=tempHighInt, humLowInt=humLowInt, comet=comet, trapEmailErrSocket=trapEmailErrSocket, products=products, pysmi_global=pysmi_global, histHum=histHum, tempDelayInt=tempDelayInt, trapSOAPErrSocket=trapSOAPErrSocket, trapTempClrAlarm=trapTempClrAlarm, trapCompValError=trapCompValError, tempAlarmInt=tempAlarmInt, compValMax=compValMax, trapEmailErrLogin=trapEmailErrLogin, compVal=compVal, tables=tables, compValMin=compValMin, histCompVal=histCompVal, trapTest=trapTest, humAlarmInt=humAlarmInt, deviceType=deviceType, histTemp=histTemp, tempHystInt=tempHystInt, trapTempHighAlarm=trapTempHighAlarm)
