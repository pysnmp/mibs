...
# Produced by pysmi-1.1.12 at Mon Jun  3 14:04:02 2024
...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Bits, Integer32, TimeTicks, iso, ModuleIdentity, enterprises, IpAddress, Counter64, MibIdentifier, Unsigned32, ObjectIdentity, NotificationType, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Bits", "Integer32", "TimeTicks", "iso", "ModuleIdentity", "enterprises", "IpAddress", "Counter64", "MibIdentifier", "Unsigned32", "ObjectIdentity", "NotificationType", "Gauge32")
...
mibBuilder.exportSymbols("T3610-MIB", compValDelayInt=compValDelayInt, t3610=t3610, tempAlarm=tempAlarm, pysmi_global=pysmi_global, tempUnit=tempUnit, compValHystInt=compValHystInt, trapTempLowAlarm=trapTempLowAlarm, messageString=messageString, histHum=histHum, trapSOAPErrFile=trapSOAPErrFile, tempLowInt=tempLowInt, humAlarmInt=humAlarmInt, DisplayString=DisplayString, tempAlarmInt=tempAlarmInt, humUnit=humUnit, tempMin=tempMin, trapCompValClrAlarm=trapCompValClrAlarm, compValAlarm=compValAlarm, temp=temp, trapCompValHighAlarm=trapCompValHighAlarm, compValUnit=compValUnit, histCompVal=histCompVal, trapTempHighAlarm=trapTempHighAlarm, settings=settings, trapEmailErrSocket=trapEmailErrSocket, deviceType=deviceType, compValInt=compValInt, trapSOAPErrSocket=trapSOAPErrSocket, humAlarm=humAlarm, trapEmailErrAuth=trapEmailErrAuth, hum=hum, compValMax=compValMax, compVal=compVal, trapCompValLowAlarm=trapCompValLowAlarm, trapNTPError=trapNTPError, traps=traps, compValMin=compValMin, trapHumError=trapHumError, compValAlarmInt=compValAlarmInt, histTemp=histTemp, trapCompValError=trapCompValError, humDelayInt=humDelayInt, tempHystInt=tempHystInt, humMax=humMax, trapSOAPErrDNS=trapSOAPErrDNS, trapHumHighAlarm=trapHumHighAlarm, trapTempError=trapTempError, values=values, humHighInt=humHighInt, humHystInt=humHystInt, trapSOAPErrDelivery=trapSOAPErrDelivery, historyTable=historyTable, trapTempClrAlarm=trapTempClrAlarm, sensorName=sensorName, tempMax=tempMax, trapTest=trapTest, tempHighInt=tempHighInt, humMin=humMin, historyEntry=historyEntry, trapEmailErrSome=trapEmailErrSome, products=products, tempInt=tempInt, trapHumLowAlarm=trapHumLowAlarm, trapHumClrAlarm=trapHumClrAlarm, tables=tables, trapEmailErrDNS=trapEmailErrDNS, trapEmailErrLogin=trapEmailErrLogin, serialNumber=serialNumber, humInt=humInt, tempDelayInt=tempDelayInt, compValLowInt=compValLowInt, humLowInt=humLowInt, valuesInt=valuesInt, compValHighInt=compValHighInt, comet=comet)
