...
# Produced by pysmi-1.1.3 at Wed Dec  1 17:45:34 2021
...
enterprises, TimeTicks, Counter32, MibIdentifier, Bits, NotificationType, iso, Counter64, ModuleIdentity, IpAddress, NotificationType, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ObjectIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "TimeTicks", "Counter32", "MibIdentifier", "Bits", "NotificationType", "iso", "Counter64", "ModuleIdentity", "IpAddress", "NotificationType", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ObjectIdentity", "Gauge32")
...
mibBuilder.exportSymbols("T3610-MIB", humAlarm=humAlarm, trapTempClrAlarm=trapTempClrAlarm, compValAlarmInt=compValAlarmInt, compValMax=compValMax, trapHumClrAlarm=trapHumClrAlarm, serialNumber=serialNumber, tempMax=tempMax, compValInt=compValInt, compValHystInt=compValHystInt, trapNTPError=trapNTPError, trapCompValHighAlarm=trapCompValHighAlarm, valuesInt=valuesInt, compValHighInt=compValHighInt, historyTable=historyTable, histHum=histHum, trapTempError=trapTempError, temp=temp, tempInt=tempInt, trapSOAPErrFile=trapSOAPErrFile, tables=tables, compValLowInt=compValLowInt, tempHystInt=tempHystInt, tempAlarm=tempAlarm, humMax=humMax, trapHumLowAlarm=trapHumLowAlarm, deviceType=deviceType, humInt=humInt, humUnit=humUnit, tempUnit=tempUnit, trapSOAPErrDelivery=trapSOAPErrDelivery, tempLowInt=tempLowInt, trapEmailErrLogin=trapEmailErrLogin, trapEmailErrAuth=trapEmailErrAuth, compValDelayInt=compValDelayInt, trapTempHighAlarm=trapTempHighAlarm, tempDelayInt=tempDelayInt, trapTempLowAlarm=trapTempLowAlarm, messageString=messageString, trapHumHighAlarm=trapHumHighAlarm, compValUnit=compValUnit, trapCompValError=trapCompValError, humDelayInt=humDelayInt, compValMin=compValMin, hum=hum, t3610=t3610, trapEmailErrSome=trapEmailErrSome, trapHumError=trapHumError, trapCompValLowAlarm=trapCompValLowAlarm, humMin=humMin, historyEntry=historyEntry, tempAlarmInt=tempAlarmInt, trapEmailErrDNS=trapEmailErrDNS, trapSOAPErrSocket=trapSOAPErrSocket, tempHighInt=tempHighInt, DisplayString=DisplayString, tempMin=tempMin, sensorName=sensorName, humAlarmInt=humAlarmInt, histCompVal=histCompVal, humLowInt=humLowInt, trapCompValClrAlarm=trapCompValClrAlarm, traps=traps, products=products, compValAlarm=compValAlarm, pysmi_global=pysmi_global, humHighInt=humHighInt, trapTest=trapTest, trapEmailErrSocket=trapEmailErrSocket, humHystInt=humHystInt, trapSOAPErrDNS=trapSOAPErrDNS, histTemp=histTemp, values=values, comet=comet, compVal=compVal, settings=settings)
