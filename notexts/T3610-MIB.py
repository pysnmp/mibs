...
Integer32, Unsigned32, NotificationType, NotificationType, Counter32, TimeTicks, IpAddress, ObjectIdentity, ModuleIdentity, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Gauge32, Counter64, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "NotificationType", "NotificationType", "Counter32", "TimeTicks", "IpAddress", "ObjectIdentity", "ModuleIdentity", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Gauge32", "Counter64", "iso")
...
mibBuilder.exportSymbols("T3610-MIB", humMax=humMax, compValAlarmInt=compValAlarmInt, t3610=t3610, tempHystInt=tempHystInt, trapEmailErrLogin=trapEmailErrLogin, trapEmailErrSocket=trapEmailErrSocket, trapTempHighAlarm=trapTempHighAlarm, trapTempLowAlarm=trapTempLowAlarm, tempLowInt=tempLowInt, DisplayString=DisplayString, hum=hum, compValDelayInt=compValDelayInt, trapSOAPErrDNS=trapSOAPErrDNS, pysmi_global=pysmi_global, traps=traps, tempUnit=tempUnit, compValUnit=compValUnit, tempDelayInt=tempDelayInt, trapTest=trapTest, serialNumber=serialNumber, trapSOAPErrSocket=trapSOAPErrSocket, compValInt=compValInt, trapSOAPErrFile=trapSOAPErrFile, humInt=humInt, trapHumError=trapHumError, humDelayInt=humDelayInt, histHum=histHum, humLowInt=humLowInt, settings=settings, tempAlarm=tempAlarm, valuesInt=valuesInt, tempInt=tempInt, trapTempError=trapTempError, trapSOAPErrDelivery=trapSOAPErrDelivery, values=values, humHystInt=humHystInt, humAlarmInt=humAlarmInt, humHighInt=humHighInt, messageString=messageString, historyEntry=historyEntry, trapCompValHighAlarm=trapCompValHighAlarm, trapCompValError=trapCompValError, tempAlarmInt=tempAlarmInt, trapEmailErrDNS=trapEmailErrDNS, products=products, humUnit=humUnit, trapCompValLowAlarm=trapCompValLowAlarm, tempMax=tempMax, tempMin=tempMin, histCompVal=histCompVal, trapEmailErrSome=trapEmailErrSome, histTemp=histTemp, compValMax=compValMax, comet=comet, trapHumClrAlarm=trapHumClrAlarm, humMin=humMin, compVal=compVal, trapNTPError=trapNTPError, tables=tables, trapHumLowAlarm=trapHumLowAlarm, tempHighInt=tempHighInt, sensorName=sensorName, trapEmailErrAuth=trapEmailErrAuth, compValHighInt=compValHighInt, historyTable=historyTable, trapTempClrAlarm=trapTempClrAlarm, compValHystInt=compValHystInt, compValMin=compValMin, humAlarm=humAlarm, compValLowInt=compValLowInt, trapCompValClrAlarm=trapCompValClrAlarm, compValAlarm=compValAlarm, trapHumHighAlarm=trapHumHighAlarm, temp=temp, deviceType=deviceType)
