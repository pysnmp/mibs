...
# Produced by pysmi-1.1.8 at Tue Jan 18 13:39:34 2022
...
Counter32, NotificationType, MibIdentifier, Integer32, ObjectIdentity, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter64, ModuleIdentity, Unsigned32, iso, IpAddress, TimeTicks, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "MibIdentifier", "Integer32", "ObjectIdentity", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter64", "ModuleIdentity", "Unsigned32", "iso", "IpAddress", "TimeTicks", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", trapTempLowAlarm=trapTempLowAlarm, products=products, trapHumHighAlarm=trapHumHighAlarm, humDelayInt=humDelayInt, trapTempHighAlarm=trapTempHighAlarm, histHum=histHum, values=values, trapSOAPErrSocket=trapSOAPErrSocket, serialNumber=serialNumber, tempAlarmInt=tempAlarmInt, trapTempClrAlarm=trapTempClrAlarm, trapCompValHighAlarm=trapCompValHighAlarm, DisplayString=DisplayString, tempMax=tempMax, tempLowInt=tempLowInt, tempMin=tempMin, compValHighInt=compValHighInt, historyTable=historyTable, humHighInt=humHighInt, tempHighInt=tempHighInt, histCompVal=histCompVal, trapEmailErrAuth=trapEmailErrAuth, trapCompValLowAlarm=trapCompValLowAlarm, messageString=messageString, compValMin=compValMin, humInt=humInt, tempDelayInt=tempDelayInt, settings=settings, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTempError=trapTempError, historyEntry=historyEntry, tables=tables, compValHystInt=compValHystInt, humHystInt=humHystInt, compValAlarmInt=compValAlarmInt, tempUnit=tempUnit, compValLowInt=compValLowInt, trapEmailErrSome=trapEmailErrSome, trapSOAPErrFile=trapSOAPErrFile, tempAlarm=tempAlarm, trapEmailErrLogin=trapEmailErrLogin, trapCompValClrAlarm=trapCompValClrAlarm, tempHystInt=tempHystInt, humAlarm=humAlarm, pysmi_global=pysmi_global, trapNTPError=trapNTPError, trapHumLowAlarm=trapHumLowAlarm, compValUnit=compValUnit, tempInt=tempInt, hum=hum, t3610=t3610, humAlarmInt=humAlarmInt, trapHumError=trapHumError, compVal=compVal, trapHumClrAlarm=trapHumClrAlarm, traps=traps, comet=comet, trapSOAPErrDNS=trapSOAPErrDNS, humUnit=humUnit, compValMax=compValMax, humMin=humMin, deviceType=deviceType, compValDelayInt=compValDelayInt, temp=temp, humLowInt=humLowInt, humMax=humMax, sensorName=sensorName, compValInt=compValInt, trapEmailErrDNS=trapEmailErrDNS, valuesInt=valuesInt, histTemp=histTemp, trapEmailErrSocket=trapEmailErrSocket, trapCompValError=trapCompValError, trapTest=trapTest, compValAlarm=compValAlarm)
