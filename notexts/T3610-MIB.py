...
# Produced by pysmi-1.1.12 at Mon Jul  1 10:52:10 2024
...
Unsigned32, Integer32, ModuleIdentity, MibIdentifier, NotificationType, Counter64, Gauge32, IpAddress, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, ObjectIdentity, NotificationType, TimeTicks, Counter32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Integer32", "ModuleIdentity", "MibIdentifier", "NotificationType", "Counter64", "Gauge32", "IpAddress", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "ObjectIdentity", "NotificationType", "TimeTicks", "Counter32", "iso")
...
mibBuilder.exportSymbols("T3610-MIB", tempMax=tempMax, compValInt=compValInt, trapTempLowAlarm=trapTempLowAlarm, trapNTPError=trapNTPError, trapCompValClrAlarm=trapCompValClrAlarm, sensorName=sensorName, trapTest=trapTest, trapEmailErrSocket=trapEmailErrSocket, trapTempError=trapTempError, humUnit=humUnit, trapHumError=trapHumError, humHighInt=humHighInt, tempAlarmInt=tempAlarmInt, tempUnit=tempUnit, tempMin=tempMin, deviceType=deviceType, humAlarmInt=humAlarmInt, trapEmailErrLogin=trapEmailErrLogin, trapEmailErrSome=trapEmailErrSome, trapCompValError=trapCompValError, serialNumber=serialNumber, compValHystInt=compValHystInt, tempInt=tempInt, trapTempClrAlarm=trapTempClrAlarm, tempHighInt=tempHighInt, products=products, pysmi_global=pysmi_global, trapEmailErrAuth=trapEmailErrAuth, humHystInt=humHystInt, compValMin=compValMin, compValAlarmInt=compValAlarmInt, trapSOAPErrDNS=trapSOAPErrDNS, compValUnit=compValUnit, trapCompValHighAlarm=trapCompValHighAlarm, tempAlarm=tempAlarm, values=values, t3610=t3610, compValMax=compValMax, compValHighInt=compValHighInt, compValLowInt=compValLowInt, humMax=humMax, tempLowInt=tempLowInt, comet=comet, tables=tables, compValDelayInt=compValDelayInt, histCompVal=histCompVal, trapSOAPErrFile=trapSOAPErrFile, trapCompValLowAlarm=trapCompValLowAlarm, temp=temp, tempDelayInt=tempDelayInt, compValAlarm=compValAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTempHighAlarm=trapTempHighAlarm, humLowInt=humLowInt, trapSOAPErrSocket=trapSOAPErrSocket, valuesInt=valuesInt, compVal=compVal, traps=traps, tempHystInt=tempHystInt, trapHumLowAlarm=trapHumLowAlarm, histTemp=histTemp, humMin=humMin, trapHumHighAlarm=trapHumHighAlarm, DisplayString=DisplayString, humAlarm=humAlarm, historyEntry=historyEntry, settings=settings, messageString=messageString, trapHumClrAlarm=trapHumClrAlarm, humDelayInt=humDelayInt, hum=hum, histHum=histHum, historyTable=historyTable, trapEmailErrDNS=trapEmailErrDNS, humInt=humInt)
