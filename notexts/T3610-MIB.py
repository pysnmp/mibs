...
# Produced by pysmi-1.1.8 at Thu Apr 27 10:31:41 2023
...
ObjectIdentity, Bits, TimeTicks, IpAddress, MibIdentifier, NotificationType, Counter64, Counter32, NotificationType, iso, enterprises, ModuleIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Bits", "TimeTicks", "IpAddress", "MibIdentifier", "NotificationType", "Counter64", "Counter32", "NotificationType", "iso", "enterprises", "ModuleIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32")
...
mibBuilder.exportSymbols("T3610-MIB", trapEmailErrLogin=trapEmailErrLogin, compValDelayInt=compValDelayInt, trapSOAPErrSocket=trapSOAPErrSocket, tempHighInt=tempHighInt, humMax=humMax, tempMin=tempMin, humInt=humInt, tables=tables, trapNTPError=trapNTPError, products=products, trapTempLowAlarm=trapTempLowAlarm, compVal=compVal, compValHighInt=compValHighInt, DisplayString=DisplayString, humHystInt=humHystInt, comet=comet, historyTable=historyTable, tempAlarm=tempAlarm, humHighInt=humHighInt, values=values, settings=settings, tempAlarmInt=tempAlarmInt, trapEmailErrDNS=trapEmailErrDNS, trapHumClrAlarm=trapHumClrAlarm, histCompVal=histCompVal, trapEmailErrAuth=trapEmailErrAuth, trapHumLowAlarm=trapHumLowAlarm, compValInt=compValInt, deviceType=deviceType, compValAlarmInt=compValAlarmInt, temp=temp, tempInt=tempInt, trapCompValHighAlarm=trapCompValHighAlarm, trapTempError=trapTempError, hum=hum, traps=traps, humMin=humMin, humAlarmInt=humAlarmInt, histHum=histHum, trapEmailErrSome=trapEmailErrSome, trapTempHighAlarm=trapTempHighAlarm, tempUnit=tempUnit, pysmi_global=pysmi_global, trapEmailErrSocket=trapEmailErrSocket, trapHumHighAlarm=trapHumHighAlarm, compValMin=compValMin, humLowInt=humLowInt, histTemp=histTemp, valuesInt=valuesInt, trapHumError=trapHumError, trapSOAPErrFile=trapSOAPErrFile, trapTest=trapTest, trapSOAPErrDNS=trapSOAPErrDNS, trapCompValError=trapCompValError, tempLowInt=tempLowInt, compValLowInt=compValLowInt, t3610=t3610, historyEntry=historyEntry, compValAlarm=compValAlarm, compValUnit=compValUnit, humDelayInt=humDelayInt, trapTempClrAlarm=trapTempClrAlarm, serialNumber=serialNumber, tempMax=tempMax, trapCompValClrAlarm=trapCompValClrAlarm, tempHystInt=tempHystInt, messageString=messageString, humUnit=humUnit, trapSOAPErrDelivery=trapSOAPErrDelivery, compValHystInt=compValHystInt, trapCompValLowAlarm=trapCompValLowAlarm, sensorName=sensorName, humAlarm=humAlarm, tempDelayInt=tempDelayInt, compValMax=compValMax)
