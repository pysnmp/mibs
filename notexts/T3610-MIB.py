...
# Produced by pysmi-1.1.8 at Thu Sep  7 09:12:43 2023
...
TimeTicks, ObjectIdentity, NotificationType, Bits, Integer32, enterprises, Counter32, iso, Unsigned32, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, ModuleIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ObjectIdentity", "NotificationType", "Bits", "Integer32", "enterprises", "Counter32", "iso", "Unsigned32", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "ModuleIdentity", "Gauge32")
...
mibBuilder.exportSymbols("T3610-MIB", compValLowInt=compValLowInt, trapCompValError=trapCompValError, trapSOAPErrSocket=trapSOAPErrSocket, tempAlarm=tempAlarm, trapEmailErrSome=trapEmailErrSome, humDelayInt=humDelayInt, comet=comet, compValUnit=compValUnit, trapSOAPErrFile=trapSOAPErrFile, trapHumHighAlarm=trapHumHighAlarm, trapCompValClrAlarm=trapCompValClrAlarm, trapHumError=trapHumError, trapTempClrAlarm=trapTempClrAlarm, trapSOAPErrDNS=trapSOAPErrDNS, tempMin=tempMin, humAlarmInt=humAlarmInt, tempHighInt=tempHighInt, compValMax=compValMax, compValHighInt=compValHighInt, humAlarm=humAlarm, historyEntry=historyEntry, trapEmailErrLogin=trapEmailErrLogin, deviceType=deviceType, compValDelayInt=compValDelayInt, trapTempError=trapTempError, tempMax=tempMax, trapEmailErrAuth=trapEmailErrAuth, humMin=humMin, settings=settings, messageString=messageString, humInt=humInt, trapNTPError=trapNTPError, t3610=t3610, compValMin=compValMin, humUnit=humUnit, compValHystInt=compValHystInt, humLowInt=humLowInt, historyTable=historyTable, trapSOAPErrDelivery=trapSOAPErrDelivery, DisplayString=DisplayString, compValAlarmInt=compValAlarmInt, tables=tables, pysmi_global=pysmi_global, hum=hum, serialNumber=serialNumber, tempInt=tempInt, tempHystInt=tempHystInt, trapTest=trapTest, tempUnit=tempUnit, tempAlarmInt=tempAlarmInt, trapEmailErrDNS=trapEmailErrDNS, trapCompValHighAlarm=trapCompValHighAlarm, trapTempLowAlarm=trapTempLowAlarm, compValAlarm=compValAlarm, values=values, humHystInt=humHystInt, tempDelayInt=tempDelayInt, compVal=compVal, trapEmailErrSocket=trapEmailErrSocket, tempLowInt=tempLowInt, histCompVal=histCompVal, trapTempHighAlarm=trapTempHighAlarm, traps=traps, humMax=humMax, sensorName=sensorName, compValInt=compValInt, temp=temp, humHighInt=humHighInt, trapCompValLowAlarm=trapCompValLowAlarm, products=products, valuesInt=valuesInt, histTemp=histTemp, trapHumClrAlarm=trapHumClrAlarm, histHum=histHum, trapHumLowAlarm=trapHumLowAlarm)
