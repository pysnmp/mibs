...
# Produced by pysmi-1.1.8 at Mon Jan  9 09:48:23 2023
...
Bits, NotificationType, ModuleIdentity, NotificationType, Counter32, Gauge32, enterprises, ObjectIdentity, Counter64, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, TimeTicks, iso, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "ModuleIdentity", "NotificationType", "Counter32", "Gauge32", "enterprises", "ObjectIdentity", "Counter64", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "TimeTicks", "iso", "MibIdentifier")
...
mibBuilder.exportSymbols("T3610-MIB", compValAlarmInt=compValAlarmInt, compVal=compVal, tempHystInt=tempHystInt, histCompVal=histCompVal, messageString=messageString, trapEmailErrLogin=trapEmailErrLogin, valuesInt=valuesInt, historyEntry=historyEntry, compValMin=compValMin, trapTest=trapTest, tempLowInt=tempLowInt, tempAlarmInt=tempAlarmInt, compValUnit=compValUnit, deviceType=deviceType, tempHighInt=tempHighInt, compValDelayInt=compValDelayInt, humLowInt=humLowInt, trapEmailErrSocket=trapEmailErrSocket, trapHumError=trapHumError, humUnit=humUnit, serialNumber=serialNumber, compValInt=compValInt, settings=settings, tempMax=tempMax, trapSOAPErrFile=trapSOAPErrFile, trapSOAPErrDNS=trapSOAPErrDNS, comet=comet, products=products, tempAlarm=tempAlarm, tempInt=tempInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTempHighAlarm=trapTempHighAlarm, trapTempClrAlarm=trapTempClrAlarm, pysmi_global=pysmi_global, tempUnit=tempUnit, humDelayInt=humDelayInt, trapSOAPErrSocket=trapSOAPErrSocket, trapHumHighAlarm=trapHumHighAlarm, trapHumLowAlarm=trapHumLowAlarm, humMin=humMin, trapEmailErrDNS=trapEmailErrDNS, trapCompValLowAlarm=trapCompValLowAlarm, trapEmailErrAuth=trapEmailErrAuth, trapEmailErrSome=trapEmailErrSome, compValAlarm=compValAlarm, trapCompValError=trapCompValError, hum=hum, compValHighInt=compValHighInt, humHighInt=humHighInt, compValHystInt=compValHystInt, values=values, humAlarm=humAlarm, histTemp=histTemp, trapNTPError=trapNTPError, sensorName=sensorName, trapCompValHighAlarm=trapCompValHighAlarm, compValMax=compValMax, humMax=humMax, trapHumClrAlarm=trapHumClrAlarm, histHum=histHum, tempMin=tempMin, humHystInt=humHystInt, historyTable=historyTable, humInt=humInt, humAlarmInt=humAlarmInt, tempDelayInt=tempDelayInt, temp=temp, t3610=t3610, DisplayString=DisplayString, traps=traps, trapCompValClrAlarm=trapCompValClrAlarm, trapTempError=trapTempError, compValLowInt=compValLowInt, tables=tables, trapTempLowAlarm=trapTempLowAlarm)
