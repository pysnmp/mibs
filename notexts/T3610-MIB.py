...
# Produced by pysmi-1.1.8 at Mon Feb  7 15:46:12 2022
...
Bits, TimeTicks, Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, ObjectIdentity, IpAddress, MibIdentifier, NotificationType, Counter32, Unsigned32, NotificationType, Counter64, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "TimeTicks", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "ObjectIdentity", "IpAddress", "MibIdentifier", "NotificationType", "Counter32", "Unsigned32", "NotificationType", "Counter64", "Gauge32", "iso")
...
mibBuilder.exportSymbols("T3610-MIB", compValUnit=compValUnit, humInt=humInt, trapCompValLowAlarm=trapCompValLowAlarm, compValDelayInt=compValDelayInt, tempDelayInt=tempDelayInt, compValAlarmInt=compValAlarmInt, compValAlarm=compValAlarm, histTemp=histTemp, trapEmailErrSocket=trapEmailErrSocket, humMin=humMin, trapCompValHighAlarm=trapCompValHighAlarm, humLowInt=humLowInt, trapHumLowAlarm=trapHumLowAlarm, DisplayString=DisplayString, pysmi_global=pysmi_global, values=values, compValMin=compValMin, trapTempClrAlarm=trapTempClrAlarm, compValHighInt=compValHighInt, compValInt=compValInt, trapTempLowAlarm=trapTempLowAlarm, tempUnit=tempUnit, compValHystInt=compValHystInt, t3610=t3610, trapCompValError=trapCompValError, serialNumber=serialNumber, trapSOAPErrFile=trapSOAPErrFile, compVal=compVal, humMax=humMax, trapTempHighAlarm=trapTempHighAlarm, histHum=histHum, tempAlarm=tempAlarm, humUnit=humUnit, historyEntry=historyEntry, trapEmailErrSome=trapEmailErrSome, settings=settings, humAlarm=humAlarm, sensorName=sensorName, tempLowInt=tempLowInt, trapHumClrAlarm=trapHumClrAlarm, trapCompValClrAlarm=trapCompValClrAlarm, temp=temp, valuesInt=valuesInt, trapEmailErrDNS=trapEmailErrDNS, tables=tables, trapNTPError=trapNTPError, tempAlarmInt=tempAlarmInt, trapSOAPErrDNS=trapSOAPErrDNS, trapTempError=trapTempError, deviceType=deviceType, historyTable=historyTable, messageString=messageString, humHystInt=humHystInt, products=products, hum=hum, compValLowInt=compValLowInt, humHighInt=humHighInt, humAlarmInt=humAlarmInt, traps=traps, trapEmailErrLogin=trapEmailErrLogin, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrDelivery=trapSOAPErrDelivery, trapHumHighAlarm=trapHumHighAlarm, trapHumError=trapHumError, compValMax=compValMax, comet=comet, trapTest=trapTest, histCompVal=histCompVal, tempMin=tempMin, tempInt=tempInt, tempHighInt=tempHighInt, tempHystInt=tempHystInt, trapSOAPErrSocket=trapSOAPErrSocket, humDelayInt=humDelayInt, tempMax=tempMax)
