...
# Produced by pysmi-1.1.3 at Wed Dec  8 17:25:16 2021
...
Integer32, enterprises, IpAddress, Counter32, Unsigned32, ObjectIdentity, Bits, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, Gauge32, NotificationType, TimeTicks, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "enterprises", "IpAddress", "Counter32", "Unsigned32", "ObjectIdentity", "Bits", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "Gauge32", "NotificationType", "TimeTicks", "MibIdentifier")
...
mibBuilder.exportSymbols("T3610-MIB", humUnit=humUnit, traps=traps, compValMin=compValMin, compValMax=compValMax, serialNumber=serialNumber, humInt=humInt, humHighInt=humHighInt, tempHystInt=tempHystInt, trapEmailErrSome=trapEmailErrSome, tempLowInt=tempLowInt, trapEmailErrDNS=trapEmailErrDNS, trapTempHighAlarm=trapTempHighAlarm, trapSOAPErrFile=trapSOAPErrFile, compValAlarmInt=compValAlarmInt, humDelayInt=humDelayInt, trapCompValLowAlarm=trapCompValLowAlarm, histCompVal=histCompVal, trapHumHighAlarm=trapHumHighAlarm, tempMax=tempMax, trapTempError=trapTempError, tempAlarm=tempAlarm, temp=temp, tempHighInt=tempHighInt, trapHumError=trapHumError, products=products, DisplayString=DisplayString, compVal=compVal, humAlarmInt=humAlarmInt, t3610=t3610, trapHumClrAlarm=trapHumClrAlarm, tempAlarmInt=tempAlarmInt, tempDelayInt=tempDelayInt, histHum=histHum, tempInt=tempInt, trapCompValHighAlarm=trapCompValHighAlarm, historyEntry=historyEntry, trapCompValClrAlarm=trapCompValClrAlarm, humLowInt=humLowInt, compValAlarm=compValAlarm, humMax=humMax, settings=settings, trapEmailErrSocket=trapEmailErrSocket, tempUnit=tempUnit, tables=tables, values=values, trapHumLowAlarm=trapHumLowAlarm, deviceType=deviceType, trapSOAPErrDelivery=trapSOAPErrDelivery, historyTable=historyTable, valuesInt=valuesInt, sensorName=sensorName, compValUnit=compValUnit, trapTest=trapTest, trapSOAPErrSocket=trapSOAPErrSocket, humMin=humMin, trapSOAPErrDNS=trapSOAPErrDNS, trapEmailErrAuth=trapEmailErrAuth, comet=comet, histTemp=histTemp, trapEmailErrLogin=trapEmailErrLogin, trapNTPError=trapNTPError, trapCompValError=trapCompValError, humAlarm=humAlarm, compValInt=compValInt, compValHighInt=compValHighInt, messageString=messageString, compValDelayInt=compValDelayInt, compValHystInt=compValHystInt, pysmi_global=pysmi_global, humHystInt=humHystInt, hum=hum, compValLowInt=compValLowInt, trapTempLowAlarm=trapTempLowAlarm, trapTempClrAlarm=trapTempClrAlarm, tempMin=tempMin)
