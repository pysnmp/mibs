...
# Produced by pysmi-1.1.3 at Sun Nov 28 19:33:38 2021
...
Integer32, Bits, iso, TimeTicks, ModuleIdentity, IpAddress, Counter64, NotificationType, ObjectIdentity, MibIdentifier, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, enterprises, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "iso", "TimeTicks", "ModuleIdentity", "IpAddress", "Counter64", "NotificationType", "ObjectIdentity", "MibIdentifier", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "enterprises", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", compValUnit=compValUnit, compValAlarm=compValAlarm, sensorName=sensorName, compVal=compVal, compValDelayInt=compValDelayInt, trapTempLowAlarm=trapTempLowAlarm, trapCompValClrAlarm=trapCompValClrAlarm, compValLowInt=compValLowInt, histTemp=histTemp, trapHumError=trapHumError, humHighInt=humHighInt, tempMax=tempMax, histHum=histHum, trapNTPError=trapNTPError, trapHumClrAlarm=trapHumClrAlarm, tempMin=tempMin, compValHystInt=compValHystInt, humUnit=humUnit, comet=comet, tempDelayInt=tempDelayInt, humAlarmInt=humAlarmInt, tempLowInt=tempLowInt, historyTable=historyTable, trapTempHighAlarm=trapTempHighAlarm, trapEmailErrLogin=trapEmailErrLogin, products=products, tables=tables, humInt=humInt, trapHumHighAlarm=trapHumHighAlarm, valuesInt=valuesInt, historyEntry=historyEntry, humMax=humMax, trapEmailErrDNS=trapEmailErrDNS, temp=temp, trapSOAPErrSocket=trapSOAPErrSocket, tempAlarm=tempAlarm, pysmi_global=pysmi_global, trapTempError=trapTempError, trapSOAPErrFile=trapSOAPErrFile, hum=hum, settings=settings, trapEmailErrSocket=trapEmailErrSocket, compValMin=compValMin, messageString=messageString, trapSOAPErrDelivery=trapSOAPErrDelivery, serialNumber=serialNumber, traps=traps, humLowInt=humLowInt, trapTempClrAlarm=trapTempClrAlarm, compValHighInt=compValHighInt, trapEmailErrAuth=trapEmailErrAuth, trapCompValLowAlarm=trapCompValLowAlarm, trapHumLowAlarm=trapHumLowAlarm, trapTest=trapTest, trapCompValError=trapCompValError, humMin=humMin, humHystInt=humHystInt, values=values, tempUnit=tempUnit, deviceType=deviceType, tempInt=tempInt, histCompVal=histCompVal, DisplayString=DisplayString, compValMax=compValMax, tempAlarmInt=tempAlarmInt, t3610=t3610, compValAlarmInt=compValAlarmInt, trapEmailErrSome=trapEmailErrSome, trapSOAPErrDNS=trapSOAPErrDNS, humDelayInt=humDelayInt, tempHighInt=tempHighInt, trapCompValHighAlarm=trapCompValHighAlarm, tempHystInt=tempHystInt, compValInt=compValInt, humAlarm=humAlarm)
