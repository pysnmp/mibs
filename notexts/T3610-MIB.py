...
# Produced by pysmi-1.1.8 at Tue Sep 12 12:06:18 2023
...
Integer32, Counter64, NotificationType, Gauge32, enterprises, ModuleIdentity, MibIdentifier, TimeTicks, Bits, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter32, ObjectIdentity, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter64", "NotificationType", "Gauge32", "enterprises", "ModuleIdentity", "MibIdentifier", "TimeTicks", "Bits", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter32", "ObjectIdentity", "IpAddress", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", trapHumClrAlarm=trapHumClrAlarm, humAlarm=humAlarm, humLowInt=humLowInt, trapEmailErrLogin=trapEmailErrLogin, compValAlarm=compValAlarm, trapTempError=trapTempError, comet=comet, pysmi_global=pysmi_global, sensorName=sensorName, historyTable=historyTable, hum=hum, trapEmailErrDNS=trapEmailErrDNS, trapCompValError=trapCompValError, humDelayInt=humDelayInt, trapCompValClrAlarm=trapCompValClrAlarm, compValDelayInt=compValDelayInt, historyEntry=historyEntry, compValUnit=compValUnit, histHum=histHum, trapTempHighAlarm=trapTempHighAlarm, serialNumber=serialNumber, deviceType=deviceType, tempInt=tempInt, DisplayString=DisplayString, tables=tables, humInt=humInt, tempMax=tempMax, trapTempLowAlarm=trapTempLowAlarm, humAlarmInt=humAlarmInt, trapHumLowAlarm=trapHumLowAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, humUnit=humUnit, compValMax=compValMax, tempMin=tempMin, tempDelayInt=tempDelayInt, histCompVal=histCompVal, trapEmailErrSocket=trapEmailErrSocket, humMax=humMax, humHystInt=humHystInt, trapSOAPErrDNS=trapSOAPErrDNS, trapCompValLowAlarm=trapCompValLowAlarm, humMin=humMin, tempHighInt=tempHighInt, traps=traps, valuesInt=valuesInt, t3610=t3610, tempHystInt=tempHystInt, trapTest=trapTest, temp=temp, compValMin=compValMin, compValLowInt=compValLowInt, products=products, trapCompValHighAlarm=trapCompValHighAlarm, trapTempClrAlarm=trapTempClrAlarm, settings=settings, trapNTPError=trapNTPError, compVal=compVal, compValHighInt=compValHighInt, compValInt=compValInt, tempUnit=tempUnit, compValHystInt=compValHystInt, histTemp=histTemp, trapHumHighAlarm=trapHumHighAlarm, compValAlarmInt=compValAlarmInt, trapHumError=trapHumError, trapEmailErrAuth=trapEmailErrAuth, messageString=messageString, humHighInt=humHighInt, trapEmailErrSome=trapEmailErrSome, tempAlarmInt=tempAlarmInt, trapSOAPErrSocket=trapSOAPErrSocket, tempLowInt=tempLowInt, tempAlarm=tempAlarm, trapSOAPErrFile=trapSOAPErrFile, values=values)
