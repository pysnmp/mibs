...
# Produced by pysmi-1.1.8 at Thu Sep 29 12:40:49 2022
...
Counter32, iso, Integer32, Counter64, ModuleIdentity, TimeTicks, IpAddress, MibIdentifier, NotificationType, Unsigned32, Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "iso", "Integer32", "Counter64", "ModuleIdentity", "TimeTicks", "IpAddress", "MibIdentifier", "NotificationType", "Unsigned32", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "enterprises")
...
mibBuilder.exportSymbols("T3610-MIB", hum=hum, tempUnit=tempUnit, humHystInt=humHystInt, sensorName=sensorName, histTemp=histTemp, trapEmailErrLogin=trapEmailErrLogin, historyTable=historyTable, trapCompValHighAlarm=trapCompValHighAlarm, products=products, tempAlarm=tempAlarm, compValHighInt=compValHighInt, histCompVal=histCompVal, trapTempError=trapTempError, historyEntry=historyEntry, trapSOAPErrDelivery=trapSOAPErrDelivery, humDelayInt=humDelayInt, humMax=humMax, humMin=humMin, compValAlarm=compValAlarm, trapEmailErrSome=trapEmailErrSome, trapSOAPErrDNS=trapSOAPErrDNS, tempInt=tempInt, humAlarmInt=humAlarmInt, humLowInt=humLowInt, tempLowInt=tempLowInt, trapCompValClrAlarm=trapCompValClrAlarm, trapEmailErrDNS=trapEmailErrDNS, compValHystInt=compValHystInt, compValUnit=compValUnit, humUnit=humUnit, trapHumClrAlarm=trapHumClrAlarm, settings=settings, trapSOAPErrFile=trapSOAPErrFile, trapTempClrAlarm=trapTempClrAlarm, tempMin=tempMin, temp=temp, tempDelayInt=tempDelayInt, humHighInt=humHighInt, DisplayString=DisplayString, trapHumError=trapHumError, tempMax=tempMax, compValLowInt=compValLowInt, trapEmailErrAuth=trapEmailErrAuth, trapHumLowAlarm=trapHumLowAlarm, trapTest=trapTest, compValMax=compValMax, tempAlarmInt=tempAlarmInt, serialNumber=serialNumber, trapCompValError=trapCompValError, compValAlarmInt=compValAlarmInt, compVal=compVal, tempHighInt=tempHighInt, valuesInt=valuesInt, trapNTPError=trapNTPError, comet=comet, pysmi_global=pysmi_global, compValDelayInt=compValDelayInt, deviceType=deviceType, histHum=histHum, trapEmailErrSocket=trapEmailErrSocket, trapCompValLowAlarm=trapCompValLowAlarm, t3610=t3610, tempHystInt=tempHystInt, compValMin=compValMin, humInt=humInt, values=values, compValInt=compValInt, trapTempHighAlarm=trapTempHighAlarm, trapTempLowAlarm=trapTempLowAlarm, humAlarm=humAlarm, trapHumHighAlarm=trapHumHighAlarm, traps=traps, tables=tables, trapSOAPErrSocket=trapSOAPErrSocket, messageString=messageString)
