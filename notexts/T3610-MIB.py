...
# Produced by pysmi-1.1.3 at Sun Nov 21 01:13:35 2021
...
ModuleIdentity, enterprises, Gauge32, Counter64, MibIdentifier, Counter32, TimeTicks, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Integer32, NotificationType, Bits, ObjectIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "enterprises", "Gauge32", "Counter64", "MibIdentifier", "Counter32", "TimeTicks", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Integer32", "NotificationType", "Bits", "ObjectIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("T3610-MIB", compValUnit=compValUnit, compValAlarmInt=compValAlarmInt, humDelayInt=humDelayInt, messageString=messageString, trapEmailErrDNS=trapEmailErrDNS, trapSOAPErrDelivery=trapSOAPErrDelivery, DisplayString=DisplayString, tempMin=tempMin, humAlarmInt=humAlarmInt, settings=settings, trapEmailErrAuth=trapEmailErrAuth, trapEmailErrSome=trapEmailErrSome, trapCompValError=trapCompValError, humMax=humMax, deviceType=deviceType, trapCompValLowAlarm=trapCompValLowAlarm, compValDelayInt=compValDelayInt, trapTempHighAlarm=trapTempHighAlarm, trapTempClrAlarm=trapTempClrAlarm, humUnit=humUnit, tempInt=tempInt, humHystInt=humHystInt, sensorName=sensorName, tempHystInt=tempHystInt, trapEmailErrLogin=trapEmailErrLogin, historyTable=historyTable, compVal=compVal, tempAlarm=tempAlarm, trapHumHighAlarm=trapHumHighAlarm, trapTempLowAlarm=trapTempLowAlarm, compValInt=compValInt, compValLowInt=compValLowInt, trapHumClrAlarm=trapHumClrAlarm, comet=comet, trapNTPError=trapNTPError, trapTempError=trapTempError, serialNumber=serialNumber, values=values, compValMax=compValMax, trapHumLowAlarm=trapHumLowAlarm, humHighInt=humHighInt, humAlarm=humAlarm, humLowInt=humLowInt, hum=hum, tempUnit=tempUnit, tempDelayInt=tempDelayInt, valuesInt=valuesInt, trapSOAPErrDNS=trapSOAPErrDNS, humMin=humMin, tempAlarmInt=tempAlarmInt, compValHystInt=compValHystInt, compValAlarm=compValAlarm, histCompVal=histCompVal, trapHumError=trapHumError, tempMax=tempMax, pysmi_global=pysmi_global, products=products, trapCompValClrAlarm=trapCompValClrAlarm, t3610=t3610, temp=temp, humInt=humInt, trapSOAPErrSocket=trapSOAPErrSocket, compValHighInt=compValHighInt, trapCompValHighAlarm=trapCompValHighAlarm, histTemp=histTemp, trapTest=trapTest, tempLowInt=tempLowInt, tempHighInt=tempHighInt, historyEntry=historyEntry, trapSOAPErrFile=trapSOAPErrFile, tables=tables, traps=traps, trapEmailErrSocket=trapEmailErrSocket, histHum=histHum, compValMin=compValMin)
