...
# Produced by pysmi-1.1.10 at Thu Oct 26 12:24:59 2023
...
IpAddress, TimeTicks, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, MibIdentifier, Integer32, iso, enterprises, Gauge32, Bits, ModuleIdentity, Counter32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "TimeTicks", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "MibIdentifier", "Integer32", "iso", "enterprises", "Gauge32", "Bits", "ModuleIdentity", "Counter32", "ObjectIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", tempLowInt=tempLowInt, trapSOAPErrSocket=trapSOAPErrSocket, tempMin=tempMin, compValUnit=compValUnit, compValLowInt=compValLowInt, tempAlarmInt=tempAlarmInt, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrDNS=trapSOAPErrDNS, compVal=compVal, tempAlarm=tempAlarm, humHighInt=humHighInt, trapEmailErrDNS=trapEmailErrDNS, trapHumClrAlarm=trapHumClrAlarm, trapNTPError=trapNTPError, trapTempError=trapTempError, trapSOAPErrFile=trapSOAPErrFile, historyTable=historyTable, trapSOAPErrDelivery=trapSOAPErrDelivery, deviceType=deviceType, trapEmailErrLogin=trapEmailErrLogin, hum=hum, compValInt=compValInt, trapTempClrAlarm=trapTempClrAlarm, trapTempHighAlarm=trapTempHighAlarm, t3610=t3610, tempDelayInt=tempDelayInt, trapHumHighAlarm=trapHumHighAlarm, sensorName=sensorName, compValHystInt=compValHystInt, humMax=humMax, humAlarm=humAlarm, humLowInt=humLowInt, compValDelayInt=compValDelayInt, pysmi_global=pysmi_global, valuesInt=valuesInt, compValMin=compValMin, tempUnit=tempUnit, trapEmailErrAuth=trapEmailErrAuth, histCompVal=histCompVal, tempMax=tempMax, trapCompValHighAlarm=trapCompValHighAlarm, tempInt=tempInt, DisplayString=DisplayString, humInt=humInt, humHystInt=humHystInt, trapCompValClrAlarm=trapCompValClrAlarm, trapEmailErrSome=trapEmailErrSome, values=values, comet=comet, tempHighInt=tempHighInt, humAlarmInt=humAlarmInt, tables=tables, traps=traps, humMin=humMin, settings=settings, humUnit=humUnit, trapTempLowAlarm=trapTempLowAlarm, products=products, compValHighInt=compValHighInt, trapHumLowAlarm=trapHumLowAlarm, historyEntry=historyEntry, trapCompValLowAlarm=trapCompValLowAlarm, trapTest=trapTest, histHum=histHum, trapCompValError=trapCompValError, compValMax=compValMax, serialNumber=serialNumber, humDelayInt=humDelayInt, compValAlarm=compValAlarm, temp=temp, messageString=messageString, histTemp=histTemp, trapHumError=trapHumError, compValAlarmInt=compValAlarmInt, tempHystInt=tempHystInt)
