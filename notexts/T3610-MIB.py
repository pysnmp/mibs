...
# Produced by pysmi-1.1.3 at Wed Dec  1 17:45:24 2021
...
ObjectIdentity, Counter64, ModuleIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, TimeTicks, Unsigned32, MibIdentifier, Gauge32, IpAddress, iso, Counter32, NotificationType, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter64", "ModuleIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "TimeTicks", "Unsigned32", "MibIdentifier", "Gauge32", "IpAddress", "iso", "Counter32", "NotificationType", "enterprises")
...
mibBuilder.exportSymbols("T3610-MIB", histCompVal=histCompVal, tempMax=tempMax, trapEmailErrSome=trapEmailErrSome, tempUnit=tempUnit, tempAlarmInt=tempAlarmInt, valuesInt=valuesInt, products=products, deviceType=deviceType, compValHystInt=compValHystInt, trapNTPError=trapNTPError, compValMin=compValMin, historyEntry=historyEntry, pysmi_global=pysmi_global, tempMin=tempMin, humMax=humMax, trapTest=trapTest, compValAlarm=compValAlarm, humAlarm=humAlarm, trapSOAPErrSocket=trapSOAPErrSocket, tempHighInt=tempHighInt, historyTable=historyTable, humUnit=humUnit, trapEmailErrSocket=trapEmailErrSocket, trapEmailErrAuth=trapEmailErrAuth, humInt=humInt, histHum=histHum, trapSOAPErrDelivery=trapSOAPErrDelivery, values=values, tempDelayInt=tempDelayInt, trapCompValError=trapCompValError, settings=settings, trapHumLowAlarm=trapHumLowAlarm, tempAlarm=tempAlarm, compValUnit=compValUnit, compValInt=compValInt, humHighInt=humHighInt, compValDelayInt=compValDelayInt, trapTempError=trapTempError, trapHumError=trapHumError, humLowInt=humLowInt, tempLowInt=tempLowInt, DisplayString=DisplayString, tables=tables, humMin=humMin, trapEmailErrLogin=trapEmailErrLogin, compValMax=compValMax, trapHumClrAlarm=trapHumClrAlarm, t3610=t3610, humHystInt=humHystInt, traps=traps, trapTempLowAlarm=trapTempLowAlarm, temp=temp, trapSOAPErrDNS=trapSOAPErrDNS, histTemp=histTemp, compVal=compVal, humAlarmInt=humAlarmInt, trapHumHighAlarm=trapHumHighAlarm, trapTempHighAlarm=trapTempHighAlarm, tempHystInt=tempHystInt, tempInt=tempInt, trapCompValClrAlarm=trapCompValClrAlarm, serialNumber=serialNumber, trapSOAPErrFile=trapSOAPErrFile, hum=hum, trapEmailErrDNS=trapEmailErrDNS, humDelayInt=humDelayInt, trapTempClrAlarm=trapTempClrAlarm, messageString=messageString, trapCompValHighAlarm=trapCompValHighAlarm, sensorName=sensorName, compValAlarmInt=compValAlarmInt, compValHighInt=compValHighInt, compValLowInt=compValLowInt, trapCompValLowAlarm=trapCompValLowAlarm, comet=comet)
