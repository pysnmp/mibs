...
# Produced by pysmi-1.1.10 at Fri Oct 27 07:49:22 2023
...
Counter64, Unsigned32, NotificationType, iso, TimeTicks, Integer32, ModuleIdentity, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Gauge32, NotificationType, ObjectIdentity, Counter32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Unsigned32", "NotificationType", "iso", "TimeTicks", "Integer32", "ModuleIdentity", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Gauge32", "NotificationType", "ObjectIdentity", "Counter32", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", traps=traps, humUnit=humUnit, historyEntry=historyEntry, serialNumber=serialNumber, trapCompValHighAlarm=trapCompValHighAlarm, compValAlarmInt=compValAlarmInt, tempLowInt=tempLowInt, tempHighInt=tempHighInt, trapHumClrAlarm=trapHumClrAlarm, trapHumError=trapHumError, pysmi_global=pysmi_global, sensorName=sensorName, settings=settings, humLowInt=humLowInt, compValHighInt=compValHighInt, compValUnit=compValUnit, trapCompValLowAlarm=trapCompValLowAlarm, trapTempClrAlarm=trapTempClrAlarm, trapCompValClrAlarm=trapCompValClrAlarm, histHum=histHum, humHystInt=humHystInt, trapTempHighAlarm=trapTempHighAlarm, trapEmailErrLogin=trapEmailErrLogin, humAlarm=humAlarm, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrSocket=trapSOAPErrSocket, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTempLowAlarm=trapTempLowAlarm, DisplayString=DisplayString, temp=temp, tempUnit=tempUnit, humMin=humMin, trapSOAPErrFile=trapSOAPErrFile, humHighInt=humHighInt, compValHystInt=compValHystInt, trapNTPError=trapNTPError, humInt=humInt, trapTempError=trapTempError, histCompVal=histCompVal, messageString=messageString, products=products, compValInt=compValInt, compValDelayInt=compValDelayInt, historyTable=historyTable, trapSOAPErrDNS=trapSOAPErrDNS, tables=tables, tempInt=tempInt, trapHumLowAlarm=trapHumLowAlarm, valuesInt=valuesInt, comet=comet, humMax=humMax, trapHumHighAlarm=trapHumHighAlarm, trapCompValError=trapCompValError, trapTest=trapTest, compValLowInt=compValLowInt, tempAlarm=tempAlarm, tempDelayInt=tempDelayInt, tempHystInt=tempHystInt, hum=hum, tempMin=tempMin, humAlarmInt=humAlarmInt, trapEmailErrDNS=trapEmailErrDNS, humDelayInt=humDelayInt, trapEmailErrAuth=trapEmailErrAuth, compValMin=compValMin, tempMax=tempMax, deviceType=deviceType, histTemp=histTemp, compValAlarm=compValAlarm, compValMax=compValMax, values=values, trapEmailErrSome=trapEmailErrSome, compVal=compVal, t3610=t3610, tempAlarmInt=tempAlarmInt)
