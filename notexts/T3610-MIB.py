...
# Produced by pysmi-1.1.8 at Wed Sep 13 02:43:57 2023
...
IpAddress, Counter32, Counter64, Gauge32, ObjectIdentity, Unsigned32, Bits, NotificationType, Integer32, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ModuleIdentity, enterprises, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter32", "Counter64", "Gauge32", "ObjectIdentity", "Unsigned32", "Bits", "NotificationType", "Integer32", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ModuleIdentity", "enterprises", "TimeTicks")
...
mibBuilder.exportSymbols("T3610-MIB", comet=comet, temp=temp, serialNumber=serialNumber, traps=traps, hum=hum, compValHystInt=compValHystInt, trapHumError=trapHumError, tempMin=tempMin, humMax=humMax, values=values, tempInt=tempInt, tempLowInt=tempLowInt, compValAlarm=compValAlarm, trapTempClrAlarm=trapTempClrAlarm, valuesInt=valuesInt, tempAlarmInt=tempAlarmInt, trapHumClrAlarm=trapHumClrAlarm, humInt=humInt, trapSOAPErrDNS=trapSOAPErrDNS, trapEmailErrAuth=trapEmailErrAuth, trapHumHighAlarm=trapHumHighAlarm, trapCompValError=trapCompValError, histCompVal=histCompVal, humMin=humMin, deviceType=deviceType, trapSOAPErrFile=trapSOAPErrFile, compValInt=compValInt, compValUnit=compValUnit, products=products, trapTempLowAlarm=trapTempLowAlarm, humAlarm=humAlarm, trapEmailErrSocket=trapEmailErrSocket, tempHighInt=tempHighInt, compValHighInt=compValHighInt, histHum=histHum, trapEmailErrLogin=trapEmailErrLogin, trapEmailErrSome=trapEmailErrSome, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValClrAlarm=trapCompValClrAlarm, settings=settings, compValMin=compValMin, compValDelayInt=compValDelayInt, DisplayString=DisplayString, sensorName=sensorName, humHystInt=humHystInt, trapNTPError=trapNTPError, compValAlarmInt=compValAlarmInt, trapTempHighAlarm=trapTempHighAlarm, tempMax=tempMax, humUnit=humUnit, humAlarmInt=humAlarmInt, humDelayInt=humDelayInt, tempAlarm=tempAlarm, tempUnit=tempUnit, humHighInt=humHighInt, trapHumLowAlarm=trapHumLowAlarm, historyEntry=historyEntry, trapTempError=trapTempError, compValLowInt=compValLowInt, trapSOAPErrDelivery=trapSOAPErrDelivery, humLowInt=humLowInt, t3610=t3610, tempHystInt=tempHystInt, compVal=compVal, tempDelayInt=tempDelayInt, trapTest=trapTest, trapCompValLowAlarm=trapCompValLowAlarm, trapEmailErrDNS=trapEmailErrDNS, historyTable=historyTable, trapCompValHighAlarm=trapCompValHighAlarm, compValMax=compValMax, histTemp=histTemp, messageString=messageString, tables=tables, pysmi_global=pysmi_global)
