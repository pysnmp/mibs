...
# Produced by pysmi-1.1.0 at Tue Nov 16 11:37:31 2021
...
Bits, ModuleIdentity, Gauge32, MibIdentifier, enterprises, Counter64, Unsigned32, iso, Counter32, ObjectIdentity, IpAddress, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "Gauge32", "MibIdentifier", "enterprises", "Counter64", "Unsigned32", "iso", "Counter32", "ObjectIdentity", "IpAddress", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", tempHystInt=tempHystInt, humHystInt=humHystInt, DisplayString=DisplayString, trapSOAPErrSocket=trapSOAPErrSocket, trapEmailErrLogin=trapEmailErrLogin, trapCompValClrAlarm=trapCompValClrAlarm, temp=temp, messageString=messageString, trapTest=trapTest, compValLowInt=compValLowInt, compValHighInt=compValHighInt, tempUnit=tempUnit, tempInt=tempInt, histTemp=histTemp, sensorName=sensorName, trapSOAPErrFile=trapSOAPErrFile, trapCompValError=trapCompValError, values=values, trapTempClrAlarm=trapTempClrAlarm, humDelayInt=humDelayInt, comet=comet, trapSOAPErrDNS=trapSOAPErrDNS, trapTempHighAlarm=trapTempHighAlarm, trapHumHighAlarm=trapHumHighAlarm, deviceType=deviceType, trapHumClrAlarm=trapHumClrAlarm, trapTempError=trapTempError, humMin=humMin, hum=hum, compValDelayInt=compValDelayInt, t3610=t3610, compVal=compVal, trapEmailErrAuth=trapEmailErrAuth, humHighInt=humHighInt, pysmi_global=pysmi_global, humInt=humInt, humAlarm=humAlarm, trapHumLowAlarm=trapHumLowAlarm, humLowInt=humLowInt, compValUnit=compValUnit, tempMax=tempMax, tempAlarm=tempAlarm, tempMin=tempMin, compValMin=compValMin, compValAlarmInt=compValAlarmInt, histCompVal=histCompVal, trapNTPError=trapNTPError, trapHumError=trapHumError, histHum=histHum, trapCompValHighAlarm=trapCompValHighAlarm, historyTable=historyTable, humAlarmInt=humAlarmInt, historyEntry=historyEntry, products=products, settings=settings, tempAlarmInt=tempAlarmInt, valuesInt=valuesInt, humUnit=humUnit, compValHystInt=compValHystInt, trapEmailErrDNS=trapEmailErrDNS, tempHighInt=tempHighInt, trapEmailErrSome=trapEmailErrSome, traps=traps, compValAlarm=compValAlarm, tempDelayInt=tempDelayInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTempLowAlarm=trapTempLowAlarm, trapCompValLowAlarm=trapCompValLowAlarm, serialNumber=serialNumber, compValInt=compValInt, tempLowInt=tempLowInt, trapEmailErrSocket=trapEmailErrSocket, humMax=humMax, tables=tables, compValMax=compValMax)
