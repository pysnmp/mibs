...
# Produced by pysmi-1.1.3 at Wed Dec  8 17:58:35 2021
...
TimeTicks, Unsigned32, ObjectIdentity, MibIdentifier, enterprises, Counter64, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, Gauge32, NotificationType, Counter32, IpAddress, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "ObjectIdentity", "MibIdentifier", "enterprises", "Counter64", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "Gauge32", "NotificationType", "Counter32", "IpAddress", "Integer32", "ModuleIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", compValHystInt=compValHystInt, trapTest=trapTest, serialNumber=serialNumber, tempAlarm=tempAlarm, tempAlarmInt=tempAlarmInt, compValLowInt=compValLowInt, humAlarm=humAlarm, histHum=histHum, trapCompValHighAlarm=trapCompValHighAlarm, trapTempLowAlarm=trapTempLowAlarm, trapHumLowAlarm=trapHumLowAlarm, tempMax=tempMax, trapSOAPErrDNS=trapSOAPErrDNS, trapNTPError=trapNTPError, tempDelayInt=tempDelayInt, historyTable=historyTable, trapCompValLowAlarm=trapCompValLowAlarm, trapCompValClrAlarm=trapCompValClrAlarm, sensorName=sensorName, trapHumClrAlarm=trapHumClrAlarm, humDelayInt=humDelayInt, trapEmailErrLogin=trapEmailErrLogin, historyEntry=historyEntry, histCompVal=histCompVal, tempLowInt=tempLowInt, pysmi_global=pysmi_global, DisplayString=DisplayString, traps=traps, t3610=t3610, compValAlarmInt=compValAlarmInt, tempHystInt=tempHystInt, humHystInt=humHystInt, trapSOAPErrDelivery=trapSOAPErrDelivery, tempHighInt=tempHighInt, histTemp=histTemp, valuesInt=valuesInt, messageString=messageString, compValHighInt=compValHighInt, trapEmailErrDNS=trapEmailErrDNS, tables=tables, compValInt=compValInt, compValMax=compValMax, trapTempHighAlarm=trapTempHighAlarm, tempMin=tempMin, tempUnit=tempUnit, trapEmailErrAuth=trapEmailErrAuth, humInt=humInt, compValDelayInt=compValDelayInt, trapSOAPErrFile=trapSOAPErrFile, trapHumHighAlarm=trapHumHighAlarm, trapTempClrAlarm=trapTempClrAlarm, values=values, compVal=compVal, humMax=humMax, deviceType=deviceType, trapSOAPErrSocket=trapSOAPErrSocket, trapHumError=trapHumError, trapEmailErrSome=trapEmailErrSome, humAlarmInt=humAlarmInt, trapCompValError=trapCompValError, humMin=humMin, tempInt=tempInt, comet=comet, products=products, humHighInt=humHighInt, compValAlarm=compValAlarm, settings=settings, temp=temp, hum=hum, compValUnit=compValUnit, humLowInt=humLowInt, trapEmailErrSocket=trapEmailErrSocket, trapTempError=trapTempError, compValMin=compValMin, humUnit=humUnit)
