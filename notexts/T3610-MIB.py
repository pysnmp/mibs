...
# Produced by pysmi-1.1.8 at Tue Jul 26 16:11:38 2022
...
ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter64, NotificationType, TimeTicks, ModuleIdentity, Unsigned32, IpAddress, MibIdentifier, NotificationType, Gauge32, Counter32, enterprises, Integer32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter64", "NotificationType", "TimeTicks", "ModuleIdentity", "Unsigned32", "IpAddress", "MibIdentifier", "NotificationType", "Gauge32", "Counter32", "enterprises", "Integer32", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", hum=hum, humMax=humMax, tempAlarm=tempAlarm, compValHystInt=compValHystInt, humHystInt=humHystInt, valuesInt=valuesInt, historyEntry=historyEntry, trapHumHighAlarm=trapHumHighAlarm, messageString=messageString, DisplayString=DisplayString, tempUnit=tempUnit, comet=comet, tempMin=tempMin, trapEmailErrAuth=trapEmailErrAuth, tempDelayInt=tempDelayInt, trapEmailErrDNS=trapEmailErrDNS, deviceType=deviceType, trapCompValClrAlarm=trapCompValClrAlarm, histHum=histHum, sensorName=sensorName, traps=traps, humMin=humMin, compValHighInt=compValHighInt, compValInt=compValInt, trapSOAPErrSocket=trapSOAPErrSocket, trapHumError=trapHumError, trapHumLowAlarm=trapHumLowAlarm, compValMin=compValMin, humLowInt=humLowInt, trapCompValHighAlarm=trapCompValHighAlarm, humAlarm=humAlarm, settings=settings, humInt=humInt, compValMax=compValMax, histTemp=histTemp, humDelayInt=humDelayInt, trapSOAPErrFile=trapSOAPErrFile, trapTempError=trapTempError, humUnit=humUnit, t3610=t3610, trapEmailErrSome=trapEmailErrSome, histCompVal=histCompVal, compValAlarm=compValAlarm, compValDelayInt=compValDelayInt, serialNumber=serialNumber, humHighInt=humHighInt, values=values, trapCompValError=trapCompValError, tempLowInt=tempLowInt, trapEmailErrLogin=trapEmailErrLogin, tempHystInt=tempHystInt, trapTempLowAlarm=trapTempLowAlarm, trapCompValLowAlarm=trapCompValLowAlarm, tempHighInt=tempHighInt, tempAlarmInt=tempAlarmInt, trapHumClrAlarm=trapHumClrAlarm, compValUnit=compValUnit, trapSOAPErrDNS=trapSOAPErrDNS, compVal=compVal, trapSOAPErrDelivery=trapSOAPErrDelivery, tempMax=tempMax, tempInt=tempInt, products=products, pysmi_global=pysmi_global, humAlarmInt=humAlarmInt, trapTest=trapTest, trapNTPError=trapNTPError, historyTable=historyTable, compValLowInt=compValLowInt, compValAlarmInt=compValAlarmInt, trapEmailErrSocket=trapEmailErrSocket, trapTempHighAlarm=trapTempHighAlarm, trapTempClrAlarm=trapTempClrAlarm, tables=tables, temp=temp)
