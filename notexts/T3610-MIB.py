...
# Produced by pysmi-1.1.8 at Sat Jan 15 15:06:42 2022
...
Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, TimeTicks, NotificationType, Counter32, Counter64, MibIdentifier, Gauge32, enterprises, NotificationType, Bits, ObjectIdentity, iso, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "TimeTicks", "NotificationType", "Counter32", "Counter64", "MibIdentifier", "Gauge32", "enterprises", "NotificationType", "Bits", "ObjectIdentity", "iso", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("T3610-MIB", compVal=compVal, compValHighInt=compValHighInt, DisplayString=DisplayString, trapEmailErrSocket=trapEmailErrSocket, trapTempLowAlarm=trapTempLowAlarm, compValUnit=compValUnit, t3610=t3610, compValLowInt=compValLowInt, trapSOAPErrSocket=trapSOAPErrSocket, compValAlarm=compValAlarm, compValInt=compValInt, tempMin=tempMin, tempDelayInt=tempDelayInt, tables=tables, messageString=messageString, histCompVal=histCompVal, tempAlarmInt=tempAlarmInt, tempHighInt=tempHighInt, trapSOAPErrDNS=trapSOAPErrDNS, tempLowInt=tempLowInt, trapCompValLowAlarm=trapCompValLowAlarm, serialNumber=serialNumber, tempUnit=tempUnit, histHum=histHum, trapNTPError=trapNTPError, trapEmailErrSome=trapEmailErrSome, trapEmailErrAuth=trapEmailErrAuth, comet=comet, humAlarmInt=humAlarmInt, compValMax=compValMax, valuesInt=valuesInt, sensorName=sensorName, trapTest=trapTest, tempHystInt=tempHystInt, trapTempHighAlarm=trapTempHighAlarm, trapEmailErrDNS=trapEmailErrDNS, trapHumLowAlarm=trapHumLowAlarm, pysmi_global=pysmi_global, hum=hum, tempInt=tempInt, trapTempClrAlarm=trapTempClrAlarm, humMax=humMax, humUnit=humUnit, humLowInt=humLowInt, trapEmailErrLogin=trapEmailErrLogin, tempAlarm=tempAlarm, humDelayInt=humDelayInt, trapSOAPErrFile=trapSOAPErrFile, trapHumHighAlarm=trapHumHighAlarm, trapTempError=trapTempError, humInt=humInt, humAlarm=humAlarm, compValHystInt=compValHystInt, histTemp=histTemp, trapCompValHighAlarm=trapCompValHighAlarm, compValMin=compValMin, settings=settings, values=values, trapSOAPErrDelivery=trapSOAPErrDelivery, humHystInt=humHystInt, trapHumError=trapHumError, deviceType=deviceType, trapCompValError=trapCompValError, historyTable=historyTable, humHighInt=humHighInt, trapHumClrAlarm=trapHumClrAlarm, compValDelayInt=compValDelayInt, tempMax=tempMax, humMin=humMin, compValAlarmInt=compValAlarmInt, products=products, trapCompValClrAlarm=trapCompValClrAlarm, historyEntry=historyEntry, temp=temp, traps=traps)
