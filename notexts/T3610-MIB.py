...
# Produced by pysmi-1.1.8 at Mon Jan 17 14:30:40 2022
...
ObjectIdentity, Unsigned32, NotificationType, ModuleIdentity, IpAddress, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, Bits, iso, TimeTicks, Counter32, enterprises, Integer32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "NotificationType", "ModuleIdentity", "IpAddress", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "Bits", "iso", "TimeTicks", "Counter32", "enterprises", "Integer32", "MibIdentifier")
...
mibBuilder.exportSymbols("T3610-MIB", trapHumLowAlarm=trapHumLowAlarm, historyTable=historyTable, trapCompValClrAlarm=trapCompValClrAlarm, tempMin=tempMin, humAlarmInt=humAlarmInt, tempHighInt=tempHighInt, tempDelayInt=tempDelayInt, valuesInt=valuesInt, compValLowInt=compValLowInt, trapTempClrAlarm=trapTempClrAlarm, tempAlarm=tempAlarm, trapSOAPErrFile=trapSOAPErrFile, compValAlarm=compValAlarm, pysmi_global=pysmi_global, products=products, humHystInt=humHystInt, tempMax=tempMax, humLowInt=humLowInt, trapEmailErrDNS=trapEmailErrDNS, trapCompValLowAlarm=trapCompValLowAlarm, temp=temp, compValUnit=compValUnit, humInt=humInt, compValHystInt=compValHystInt, traps=traps, compValDelayInt=compValDelayInt, messageString=messageString, humUnit=humUnit, historyEntry=historyEntry, sensorName=sensorName, t3610=t3610, tempAlarmInt=tempAlarmInt, histHum=histHum, compValMin=compValMin, trapEmailErrSome=trapEmailErrSome, values=values, hum=hum, trapNTPError=trapNTPError, trapHumClrAlarm=trapHumClrAlarm, trapTempError=trapTempError, tempInt=tempInt, trapEmailErrSocket=trapEmailErrSocket, tempUnit=tempUnit, trapCompValHighAlarm=trapCompValHighAlarm, humMax=humMax, histTemp=histTemp, trapTempLowAlarm=trapTempLowAlarm, trapEmailErrLogin=trapEmailErrLogin, trapSOAPErrDNS=trapSOAPErrDNS, compValHighInt=compValHighInt, settings=settings, comet=comet, deviceType=deviceType, humDelayInt=humDelayInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapHumHighAlarm=trapHumHighAlarm, humMin=humMin, DisplayString=DisplayString, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValError=trapCompValError, trapHumError=trapHumError, humHighInt=humHighInt, histCompVal=histCompVal, trapTest=trapTest, tables=tables, compValInt=compValInt, tempLowInt=tempLowInt, humAlarm=humAlarm, compValAlarmInt=compValAlarmInt, serialNumber=serialNumber, trapTempHighAlarm=trapTempHighAlarm, trapEmailErrAuth=trapEmailErrAuth, compVal=compVal, tempHystInt=tempHystInt, compValMax=compValMax)
