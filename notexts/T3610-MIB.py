...
# Produced by pysmi-1.1.12 at Fri Jul 19 10:02:41 2024
...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier, Gauge32, ObjectIdentity, NotificationType, Integer32, Unsigned32, enterprises, ModuleIdentity, Bits, iso, TimeTicks, Counter64, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier", "Gauge32", "ObjectIdentity", "NotificationType", "Integer32", "Unsigned32", "enterprises", "ModuleIdentity", "Bits", "iso", "TimeTicks", "Counter64", "IpAddress")
...
mibBuilder.exportSymbols("T3610-MIB", compValAlarmInt=compValAlarmInt, tempUnit=tempUnit, trapTempHighAlarm=trapTempHighAlarm, trapNTPError=trapNTPError, compValMax=compValMax, products=products, humLowInt=humLowInt, compValHystInt=compValHystInt, compValAlarm=compValAlarm, historyTable=historyTable, humUnit=humUnit, humDelayInt=humDelayInt, histHum=histHum, trapSOAPErrFile=trapSOAPErrFile, compValMin=compValMin, tables=tables, serialNumber=serialNumber, humAlarmInt=humAlarmInt, trapHumHighAlarm=trapHumHighAlarm, trapCompValLowAlarm=trapCompValLowAlarm, trapSOAPErrSocket=trapSOAPErrSocket, histTemp=histTemp, humHighInt=humHighInt, trapEmailErrAuth=trapEmailErrAuth, trapHumClrAlarm=trapHumClrAlarm, historyEntry=historyEntry, traps=traps, compValHighInt=compValHighInt, compValDelayInt=compValDelayInt, tempHystInt=tempHystInt, trapTempError=trapTempError, t3610=t3610, trapSOAPErrDNS=trapSOAPErrDNS, messageString=messageString, tempMax=tempMax, compVal=compVal, tempAlarmInt=tempAlarmInt, tempLowInt=tempLowInt, trapCompValError=trapCompValError, DisplayString=DisplayString, comet=comet, tempAlarm=tempAlarm, trapTempClrAlarm=trapTempClrAlarm, humMax=humMax, tempDelayInt=tempDelayInt, humHystInt=humHystInt, compValLowInt=compValLowInt, compValInt=compValInt, humAlarm=humAlarm, humInt=humInt, hum=hum, sensorName=sensorName, pysmi_global=pysmi_global, trapHumError=trapHumError, histCompVal=histCompVal, compValUnit=compValUnit, trapTest=trapTest, trapEmailErrSocket=trapEmailErrSocket, trapEmailErrDNS=trapEmailErrDNS, tempMin=tempMin, trapEmailErrSome=trapEmailErrSome, trapTempLowAlarm=trapTempLowAlarm, values=values, valuesInt=valuesInt, trapEmailErrLogin=trapEmailErrLogin, tempHighInt=tempHighInt, trapCompValHighAlarm=trapCompValHighAlarm, tempInt=tempInt, trapHumLowAlarm=trapHumLowAlarm, humMin=humMin, deviceType=deviceType, trapCompValClrAlarm=trapCompValClrAlarm, temp=temp, settings=settings, trapSOAPErrDelivery=trapSOAPErrDelivery)
