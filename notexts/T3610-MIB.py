...
# Produced by pysmi-1.1.3 at Sun Nov 28 17:17:04 2021
...
ModuleIdentity, Integer32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter64, TimeTicks, Gauge32, ObjectIdentity, IpAddress, enterprises, Counter32, MibIdentifier, NotificationType, iso, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter64", "TimeTicks", "Gauge32", "ObjectIdentity", "IpAddress", "enterprises", "Counter32", "MibIdentifier", "NotificationType", "iso", "Unsigned32")
...
mibBuilder.exportSymbols("T3610-MIB", compValUnit=compValUnit, histHum=histHum, trapSOAPErrDNS=trapSOAPErrDNS, tempUnit=tempUnit, tempMin=tempMin, trapTempError=trapTempError, compValMin=compValMin, compValHighInt=compValHighInt, tempHystInt=tempHystInt, products=products, trapEmailErrSome=trapEmailErrSome, trapTempLowAlarm=trapTempLowAlarm, humInt=humInt, trapCompValClrAlarm=trapCompValClrAlarm, tempDelayInt=tempDelayInt, histCompVal=histCompVal, trapHumClrAlarm=trapHumClrAlarm, values=values, serialNumber=serialNumber, deviceType=deviceType, DisplayString=DisplayString, tempInt=tempInt, humDelayInt=humDelayInt, traps=traps, trapTempClrAlarm=trapTempClrAlarm, tempAlarm=tempAlarm, tempAlarmInt=tempAlarmInt, compValDelayInt=compValDelayInt, humHystInt=humHystInt, settings=settings, tempMax=tempMax, trapEmailErrSocket=trapEmailErrSocket, trapEmailErrDNS=trapEmailErrDNS, compValInt=compValInt, comet=comet, trapTest=trapTest, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrFile=trapSOAPErrFile, trapCompValError=trapCompValError, trapNTPError=trapNTPError, temp=temp, trapHumHighAlarm=trapHumHighAlarm, tables=tables, humLowInt=humLowInt, valuesInt=valuesInt, humAlarmInt=humAlarmInt, tempLowInt=tempLowInt, historyEntry=historyEntry, trapSOAPErrDelivery=trapSOAPErrDelivery, tempHighInt=tempHighInt, trapHumLowAlarm=trapHumLowAlarm, trapHumError=trapHumError, t3610=t3610, trapSOAPErrSocket=trapSOAPErrSocket, compValHystInt=compValHystInt, pysmi_global=pysmi_global, humHighInt=humHighInt, humMin=humMin, histTemp=histTemp, trapTempHighAlarm=trapTempHighAlarm, compValLowInt=compValLowInt, sensorName=sensorName, trapEmailErrLogin=trapEmailErrLogin, hum=hum, trapCompValLowAlarm=trapCompValLowAlarm, humAlarm=humAlarm, compValAlarmInt=compValAlarmInt, messageString=messageString, trapCompValHighAlarm=trapCompValHighAlarm, compValAlarm=compValAlarm, compVal=compVal, humUnit=humUnit, historyTable=historyTable, compValMax=compValMax, humMax=humMax)
