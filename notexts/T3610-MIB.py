...
# Produced by pysmi-1.1.12 at Wed Jul  3 10:43:58 2024
...
iso, MibIdentifier, IpAddress, Unsigned32, Gauge32, NotificationType, Counter32, Counter64, ModuleIdentity, TimeTicks, ObjectIdentity, Integer32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "IpAddress", "Unsigned32", "Gauge32", "NotificationType", "Counter32", "Counter64", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "Integer32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", values=values, humLowInt=humLowInt, hum=hum, trapCompValClrAlarm=trapCompValClrAlarm, humInt=humInt, humMin=humMin, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrFile=trapSOAPErrFile, tempAlarm=tempAlarm, sensorName=sensorName, pysmi_global=pysmi_global, messageString=messageString, humMax=humMax, trapTempLowAlarm=trapTempLowAlarm, serialNumber=serialNumber, humHighInt=humHighInt, trapNTPError=trapNTPError, compValHighInt=compValHighInt, trapCompValError=trapCompValError, tempLowInt=tempLowInt, tempHighInt=tempHighInt, histTemp=histTemp, tempInt=tempInt, trapTempHighAlarm=trapTempHighAlarm, trapSOAPErrDNS=trapSOAPErrDNS, humAlarmInt=humAlarmInt, tempMax=tempMax, trapTest=trapTest, compValDelayInt=compValDelayInt, trapEmailErrLogin=trapEmailErrLogin, compValMax=compValMax, trapCompValHighAlarm=trapCompValHighAlarm, products=products, compValMin=compValMin, trapSOAPErrDelivery=trapSOAPErrDelivery, tables=tables, tempAlarmInt=tempAlarmInt, valuesInt=valuesInt, humAlarm=humAlarm, trapHumHighAlarm=trapHumHighAlarm, historyEntry=historyEntry, t3610=t3610, compVal=compVal, traps=traps, compValUnit=compValUnit, settings=settings, tempDelayInt=tempDelayInt, tempHystInt=tempHystInt, historyTable=historyTable, humUnit=humUnit, deviceType=deviceType, trapEmailErrSome=trapEmailErrSome, trapSOAPErrSocket=trapSOAPErrSocket, trapEmailErrAuth=trapEmailErrAuth, trapHumClrAlarm=trapHumClrAlarm, trapHumError=trapHumError, comet=comet, trapCompValLowAlarm=trapCompValLowAlarm, compValAlarm=compValAlarm, histHum=histHum, histCompVal=histCompVal, tempMin=tempMin, compValAlarmInt=compValAlarmInt, humDelayInt=humDelayInt, humHystInt=humHystInt, temp=temp, trapTempError=trapTempError, trapHumLowAlarm=trapHumLowAlarm, compValInt=compValInt, trapTempClrAlarm=trapTempClrAlarm, compValHystInt=compValHystInt, DisplayString=DisplayString, trapEmailErrDNS=trapEmailErrDNS, compValLowInt=compValLowInt, tempUnit=tempUnit)
