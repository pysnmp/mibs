...
# Produced by pysmi-1.1.12 at Tue Jun  4 12:19:01 2024
...
NotificationType, IpAddress, Counter32, enterprises, Unsigned32, ObjectIdentity, Bits, iso, NotificationType, ModuleIdentity, TimeTicks, Counter64, MibIdentifier, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "Counter32", "enterprises", "Unsigned32", "ObjectIdentity", "Bits", "iso", "NotificationType", "ModuleIdentity", "TimeTicks", "Counter64", "MibIdentifier", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("T3610-MIB", temp=temp, humHighInt=humHighInt, humHystInt=humHystInt, pysmi_global=pysmi_global, tables=tables, humInt=humInt, compValHystInt=compValHystInt, trapTempClrAlarm=trapTempClrAlarm, trapHumError=trapHumError, values=values, trapCompValError=trapCompValError, historyEntry=historyEntry, compValInt=compValInt, trapHumClrAlarm=trapHumClrAlarm, histCompVal=histCompVal, traps=traps, comet=comet, compValLowInt=compValLowInt, tempDelayInt=tempDelayInt, tempHystInt=tempHystInt, humMin=humMin, humMax=humMax, trapEmailErrSome=trapEmailErrSome, trapCompValHighAlarm=trapCompValHighAlarm, tempHighInt=tempHighInt, tempInt=tempInt, messageString=messageString, histHum=histHum, trapTest=trapTest, valuesInt=valuesInt, trapTempError=trapTempError, DisplayString=DisplayString, t3610=t3610, deviceType=deviceType, trapTempHighAlarm=trapTempHighAlarm, tempMax=tempMax, trapEmailErrSocket=trapEmailErrSocket, trapEmailErrDNS=trapEmailErrDNS, trapHumHighAlarm=trapHumHighAlarm, tempAlarmInt=tempAlarmInt, tempAlarm=tempAlarm, tempUnit=tempUnit, settings=settings, humAlarmInt=humAlarmInt, compValAlarm=compValAlarm, compValMin=compValMin, humUnit=humUnit, trapCompValClrAlarm=trapCompValClrAlarm, trapSOAPErrFile=trapSOAPErrFile, hum=hum, historyTable=historyTable, trapEmailErrLogin=trapEmailErrLogin, tempMin=tempMin, compValAlarmInt=compValAlarmInt, humAlarm=humAlarm, tempLowInt=tempLowInt, trapNTPError=trapNTPError, compValMax=compValMax, trapSOAPErrSocket=trapSOAPErrSocket, trapEmailErrAuth=trapEmailErrAuth, trapHumLowAlarm=trapHumLowAlarm, sensorName=sensorName, compValHighInt=compValHighInt, humLowInt=humLowInt, histTemp=histTemp, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTempLowAlarm=trapTempLowAlarm, compValUnit=compValUnit, humDelayInt=humDelayInt, trapCompValLowAlarm=trapCompValLowAlarm, compValDelayInt=compValDelayInt, compVal=compVal, trapSOAPErrDNS=trapSOAPErrDNS, products=products, serialNumber=serialNumber)
