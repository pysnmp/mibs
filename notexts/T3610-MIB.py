...
# Produced by pysmi-1.1.10 at Fri Nov 10 10:31:12 2023
...
NotificationType, enterprises, TimeTicks, Counter64, Unsigned32, ModuleIdentity, Counter32, Gauge32, IpAddress, NotificationType, Integer32, ObjectIdentity, iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "enterprises", "TimeTicks", "Counter64", "Unsigned32", "ModuleIdentity", "Counter32", "Gauge32", "IpAddress", "NotificationType", "Integer32", "ObjectIdentity", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", histCompVal=histCompVal, trapCompValError=trapCompValError, trapHumHighAlarm=trapHumHighAlarm, compValAlarmInt=compValAlarmInt, comet=comet, trapTempHighAlarm=trapTempHighAlarm, tempMin=tempMin, tables=tables, humLowInt=humLowInt, tempAlarmInt=tempAlarmInt, trapEmailErrAuth=trapEmailErrAuth, compValDelayInt=compValDelayInt, humMax=humMax, trapTempError=trapTempError, tempDelayInt=tempDelayInt, tempHystInt=tempHystInt, DisplayString=DisplayString, compVal=compVal, tempInt=tempInt, compValMax=compValMax, temp=temp, humAlarmInt=humAlarmInt, historyTable=historyTable, trapTempClrAlarm=trapTempClrAlarm, pysmi_global=pysmi_global, trapEmailErrSome=trapEmailErrSome, tempUnit=tempUnit, humDelayInt=humDelayInt, compValMin=compValMin, historyEntry=historyEntry, compValAlarm=compValAlarm, messageString=messageString, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrSocket=trapSOAPErrSocket, trapHumLowAlarm=trapHumLowAlarm, values=values, trapCompValLowAlarm=trapCompValLowAlarm, histHum=histHum, tempLowInt=tempLowInt, trapTest=trapTest, trapSOAPErrFile=trapSOAPErrFile, trapNTPError=trapNTPError, trapHumClrAlarm=trapHumClrAlarm, compValInt=compValInt, humInt=humInt, compValLowInt=compValLowInt, humAlarm=humAlarm, trapCompValHighAlarm=trapCompValHighAlarm, t3610=t3610, deviceType=deviceType, valuesInt=valuesInt, humHystInt=humHystInt, histTemp=histTemp, sensorName=sensorName, compValHystInt=compValHystInt, trapSOAPErrDelivery=trapSOAPErrDelivery, compValUnit=compValUnit, trapSOAPErrDNS=trapSOAPErrDNS, serialNumber=serialNumber, trapEmailErrLogin=trapEmailErrLogin, humUnit=humUnit, compValHighInt=compValHighInt, trapCompValClrAlarm=trapCompValClrAlarm, trapEmailErrDNS=trapEmailErrDNS, tempAlarm=tempAlarm, traps=traps, humMin=humMin, tempHighInt=tempHighInt, trapTempLowAlarm=trapTempLowAlarm, humHighInt=humHighInt, trapHumError=trapHumError, hum=hum, products=products, settings=settings, tempMax=tempMax)
