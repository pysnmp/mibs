...
# Produced by pysmi-1.1.8 at Thu Oct 26 09:56:46 2023
...
ObjectIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, MibIdentifier, NotificationType, IpAddress, TimeTicks, Gauge32, ModuleIdentity, Counter32, enterprises, Bits, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "MibIdentifier", "NotificationType", "IpAddress", "TimeTicks", "Gauge32", "ModuleIdentity", "Counter32", "enterprises", "Bits", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", tempLowInt=tempLowInt, values=values, trapSOAPErrDNS=trapSOAPErrDNS, compValDelayInt=compValDelayInt, temp=temp, tempAlarmInt=tempAlarmInt, compValHystInt=compValHystInt, compValUnit=compValUnit, trapHumHighAlarm=trapHumHighAlarm, humLowInt=humLowInt, trapTempClrAlarm=trapTempClrAlarm, compValAlarm=compValAlarm, trapTempError=trapTempError, compValAlarmInt=compValAlarmInt, trapCompValClrAlarm=trapCompValClrAlarm, t3610=t3610, compValInt=compValInt, trapHumError=trapHumError, humDelayInt=humDelayInt, histCompVal=histCompVal, trapSOAPErrSocket=trapSOAPErrSocket, humHighInt=humHighInt, humAlarmInt=humAlarmInt, trapTempHighAlarm=trapTempHighAlarm, valuesInt=valuesInt, trapCompValLowAlarm=trapCompValLowAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, trapCompValHighAlarm=trapCompValHighAlarm, hum=hum, humMin=humMin, compValMin=compValMin, histHum=histHum, sensorName=sensorName, trapEmailErrDNS=trapEmailErrDNS, messageString=messageString, trapEmailErrLogin=trapEmailErrLogin, trapEmailErrSome=trapEmailErrSome, tempDelayInt=tempDelayInt, histTemp=histTemp, trapCompValError=trapCompValError, pysmi_global=pysmi_global, trapHumLowAlarm=trapHumLowAlarm, DisplayString=DisplayString, comet=comet, serialNumber=serialNumber, humHystInt=humHystInt, trapNTPError=trapNTPError, compValMax=compValMax, trapEmailErrAuth=trapEmailErrAuth, trapEmailErrSocket=trapEmailErrSocket, compValLowInt=compValLowInt, compVal=compVal, humMax=humMax, humInt=humInt, historyEntry=historyEntry, trapTest=trapTest, tempAlarm=tempAlarm, settings=settings, trapSOAPErrFile=trapSOAPErrFile, tempUnit=tempUnit, tempHighInt=tempHighInt, tempInt=tempInt, compValHighInt=compValHighInt, tables=tables, trapHumClrAlarm=trapHumClrAlarm, deviceType=deviceType, historyTable=historyTable, products=products, traps=traps, tempMax=tempMax, tempMin=tempMin, tempHystInt=tempHystInt, humUnit=humUnit, humAlarm=humAlarm, trapTempLowAlarm=trapTempLowAlarm)
