...
# Produced by pysmi-1.1.3 at Wed Dec  8 19:48:40 2021
...
Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter64, iso, Integer32, NotificationType, MibIdentifier, Counter32, NotificationType, Unsigned32, IpAddress, enterprises, ModuleIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter64", "iso", "Integer32", "NotificationType", "MibIdentifier", "Counter32", "NotificationType", "Unsigned32", "IpAddress", "enterprises", "ModuleIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("T3610-MIB", trapEmailErrAuth=trapEmailErrAuth, tables=tables, compValMin=compValMin, t3610=t3610, trapSOAPErrSocket=trapSOAPErrSocket, trapTempHighAlarm=trapTempHighAlarm, trapHumHighAlarm=trapHumHighAlarm, trapCompValError=trapCompValError, humAlarm=humAlarm, trapEmailErrSome=trapEmailErrSome, trapEmailErrLogin=trapEmailErrLogin, histCompVal=histCompVal, hum=hum, trapCompValHighAlarm=trapCompValHighAlarm, trapTempClrAlarm=trapTempClrAlarm, tempDelayInt=tempDelayInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTest=trapTest, trapHumClrAlarm=trapHumClrAlarm, tempAlarm=tempAlarm, tempInt=tempInt, compValHighInt=compValHighInt, humMin=humMin, trapHumLowAlarm=trapHumLowAlarm, serialNumber=serialNumber, humMax=humMax, tempMax=tempMax, trapSOAPErrFile=trapSOAPErrFile, humDelayInt=humDelayInt, products=products, sensorName=sensorName, compValHystInt=compValHystInt, temp=temp, compValAlarmInt=compValAlarmInt, compValUnit=compValUnit, trapEmailErrSocket=trapEmailErrSocket, humInt=humInt, humUnit=humUnit, humAlarmInt=humAlarmInt, humHighInt=humHighInt, historyTable=historyTable, trapTempLowAlarm=trapTempLowAlarm, valuesInt=valuesInt, compValInt=compValInt, tempHystInt=tempHystInt, settings=settings, DisplayString=DisplayString, compValAlarm=compValAlarm, humHystInt=humHystInt, deviceType=deviceType, histHum=histHum, compValLowInt=compValLowInt, tempAlarmInt=tempAlarmInt, values=values, trapCompValClrAlarm=trapCompValClrAlarm, traps=traps, pysmi_global=pysmi_global, compValMax=compValMax, tempHighInt=tempHighInt, comet=comet, messageString=messageString, trapCompValLowAlarm=trapCompValLowAlarm, compValDelayInt=compValDelayInt, compVal=compVal, trapNTPError=trapNTPError, tempMin=tempMin, histTemp=histTemp, historyEntry=historyEntry, tempUnit=tempUnit, trapTempError=trapTempError, tempLowInt=tempLowInt, humLowInt=humLowInt, trapSOAPErrDNS=trapSOAPErrDNS, trapHumError=trapHumError, trapEmailErrDNS=trapEmailErrDNS)
