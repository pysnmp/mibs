...
# Produced by pysmi-1.1.8 at Mon Jan  2 13:47:17 2023
...
NotificationType, IpAddress, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Gauge32, Bits, ModuleIdentity, MibIdentifier, NotificationType, ObjectIdentity, Unsigned32, Counter32, TimeTicks, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Gauge32", "Bits", "ModuleIdentity", "MibIdentifier", "NotificationType", "ObjectIdentity", "Unsigned32", "Counter32", "TimeTicks", "Integer32", "iso")
...
mibBuilder.exportSymbols("T3610-MIB", values=values, humHighInt=humHighInt, humDelayInt=humDelayInt, histHum=histHum, humHystInt=humHystInt, trapCompValHighAlarm=trapCompValHighAlarm, compValMin=compValMin, DisplayString=DisplayString, humLowInt=humLowInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapHumLowAlarm=trapHumLowAlarm, historyEntry=historyEntry, trapCompValError=trapCompValError, trapTempClrAlarm=trapTempClrAlarm, trapSOAPErrFile=trapSOAPErrFile, compValLowInt=compValLowInt, sensorName=sensorName, tempInt=tempInt, trapEmailErrAuth=trapEmailErrAuth, trapCompValLowAlarm=trapCompValLowAlarm, trapTempError=trapTempError, trapTempLowAlarm=trapTempLowAlarm, settings=settings, tempMax=tempMax, products=products, humInt=humInt, humAlarm=humAlarm, trapEmailErrSocket=trapEmailErrSocket, compValAlarmInt=compValAlarmInt, trapSOAPErrSocket=trapSOAPErrSocket, compValHystInt=compValHystInt, histCompVal=histCompVal, trapTempHighAlarm=trapTempHighAlarm, compValHighInt=compValHighInt, trapTest=trapTest, traps=traps, tempAlarmInt=tempAlarmInt, historyTable=historyTable, humMin=humMin, trapNTPError=trapNTPError, comet=comet, compValUnit=compValUnit, trapEmailErrDNS=trapEmailErrDNS, tempDelayInt=tempDelayInt, trapHumError=trapHumError, humAlarmInt=humAlarmInt, tempAlarm=tempAlarm, tempUnit=tempUnit, compVal=compVal, tempHystInt=tempHystInt, compValDelayInt=compValDelayInt, trapHumClrAlarm=trapHumClrAlarm, compValMax=compValMax, trapEmailErrSome=trapEmailErrSome, t3610=t3610, compValAlarm=compValAlarm, deviceType=deviceType, tempHighInt=tempHighInt, trapSOAPErrDNS=trapSOAPErrDNS, temp=temp, humUnit=humUnit, tables=tables, pysmi_global=pysmi_global, humMax=humMax, histTemp=histTemp, tempMin=tempMin, compValInt=compValInt, trapCompValClrAlarm=trapCompValClrAlarm, trapHumHighAlarm=trapHumHighAlarm, hum=hum, messageString=messageString, valuesInt=valuesInt, serialNumber=serialNumber, trapEmailErrLogin=trapEmailErrLogin, tempLowInt=tempLowInt)
