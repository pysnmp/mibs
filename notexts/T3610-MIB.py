...
# Produced by pysmi-1.1.8 at Tue Aug  9 15:10:01 2022
...
Integer32, NotificationType, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, ObjectIdentity, Bits, Counter32, IpAddress, Counter64, ModuleIdentity, Unsigned32, TimeTicks, iso, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "ObjectIdentity", "Bits", "Counter32", "IpAddress", "Counter64", "ModuleIdentity", "Unsigned32", "TimeTicks", "iso", "MibIdentifier")
...
mibBuilder.exportSymbols("T3610-MIB", comet=comet, values=values, t3610=t3610, trapCompValHighAlarm=trapCompValHighAlarm, tempDelayInt=tempDelayInt, tempAlarmInt=tempAlarmInt, products=products, humHystInt=humHystInt, compVal=compVal, compValInt=compValInt, humInt=humInt, DisplayString=DisplayString, historyEntry=historyEntry, trapEmailErrSocket=trapEmailErrSocket, trapTempLowAlarm=trapTempLowAlarm, tempMin=tempMin, trapHumError=trapHumError, histCompVal=histCompVal, trapCompValLowAlarm=trapCompValLowAlarm, sensorName=sensorName, trapTest=trapTest, trapSOAPErrDNS=trapSOAPErrDNS, trapTempError=trapTempError, trapCompValError=trapCompValError, trapSOAPErrDelivery=trapSOAPErrDelivery, messageString=messageString, humMax=humMax, trapHumLowAlarm=trapHumLowAlarm, tables=tables, trapHumClrAlarm=trapHumClrAlarm, pysmi_global=pysmi_global, humLowInt=humLowInt, compValAlarm=compValAlarm, humDelayInt=humDelayInt, trapEmailErrLogin=trapEmailErrLogin, historyTable=historyTable, traps=traps, compValLowInt=compValLowInt, humHighInt=humHighInt, compValDelayInt=compValDelayInt, compValHystInt=compValHystInt, trapEmailErrSome=trapEmailErrSome, trapHumHighAlarm=trapHumHighAlarm, tempHystInt=tempHystInt, humUnit=humUnit, hum=hum, serialNumber=serialNumber, tempInt=tempInt, humAlarmInt=humAlarmInt, temp=temp, tempLowInt=tempLowInt, histHum=histHum, humAlarm=humAlarm, compValAlarmInt=compValAlarmInt, compValMin=compValMin, compValMax=compValMax, humMin=humMin, compValHighInt=compValHighInt, histTemp=histTemp, trapNTPError=trapNTPError, settings=settings, tempUnit=tempUnit, trapEmailErrAuth=trapEmailErrAuth, trapTempClrAlarm=trapTempClrAlarm, deviceType=deviceType, tempMax=tempMax, trapCompValClrAlarm=trapCompValClrAlarm, tempHighInt=tempHighInt, trapTempHighAlarm=trapTempHighAlarm, tempAlarm=tempAlarm, valuesInt=valuesInt, trapEmailErrDNS=trapEmailErrDNS, trapSOAPErrSocket=trapSOAPErrSocket, compValUnit=compValUnit, trapSOAPErrFile=trapSOAPErrFile)
