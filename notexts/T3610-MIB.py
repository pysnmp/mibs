...
# Produced by pysmi-1.1.12 at Wed May 29 02:41:15 2024
...
MibIdentifier, NotificationType, Counter32, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks, NotificationType, Integer32, enterprises, IpAddress, Counter64, Bits, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "Counter32", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks", "NotificationType", "Integer32", "enterprises", "IpAddress", "Counter64", "Bits", "Gauge32", "ModuleIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", trapCompValClrAlarm=trapCompValClrAlarm, trapTempClrAlarm=trapTempClrAlarm, compValUnit=compValUnit, compVal=compVal, trapSOAPErrDNS=trapSOAPErrDNS, histHum=histHum, tempHighInt=tempHighInt, tempMax=tempMax, sensorName=sensorName, trapSOAPErrDelivery=trapSOAPErrDelivery, humDelayInt=humDelayInt, valuesInt=valuesInt, compValMax=compValMax, DisplayString=DisplayString, messageString=messageString, trapTempHighAlarm=trapTempHighAlarm, traps=traps, humAlarm=humAlarm, tempAlarmInt=tempAlarmInt, trapCompValHighAlarm=trapCompValHighAlarm, deviceType=deviceType, compValLowInt=compValLowInt, trapCompValLowAlarm=trapCompValLowAlarm, trapHumError=trapHumError, tempMin=tempMin, settings=settings, humInt=humInt, temp=temp, tempAlarm=tempAlarm, comet=comet, compValInt=compValInt, tempLowInt=tempLowInt, trapTempError=trapTempError, historyTable=historyTable, trapSOAPErrSocket=trapSOAPErrSocket, compValAlarmInt=compValAlarmInt, trapEmailErrAuth=trapEmailErrAuth, trapNTPError=trapNTPError, trapSOAPErrFile=trapSOAPErrFile, products=products, compValAlarm=compValAlarm, compValDelayInt=compValDelayInt, historyEntry=historyEntry, trapTempLowAlarm=trapTempLowAlarm, tempHystInt=tempHystInt, compValHystInt=compValHystInt, histTemp=histTemp, trapEmailErrLogin=trapEmailErrLogin, trapEmailErrSome=trapEmailErrSome, humUnit=humUnit, trapEmailErrDNS=trapEmailErrDNS, humMax=humMax, tempUnit=tempUnit, humAlarmInt=humAlarmInt, trapHumHighAlarm=trapHumHighAlarm, trapHumLowAlarm=trapHumLowAlarm, values=values, t3610=t3610, hum=hum, humMin=humMin, trapHumClrAlarm=trapHumClrAlarm, tempInt=tempInt, trapTest=trapTest, humLowInt=humLowInt, trapEmailErrSocket=trapEmailErrSocket, trapCompValError=trapCompValError, serialNumber=serialNumber, compValHighInt=compValHighInt, humHystInt=humHystInt, compValMin=compValMin, tempDelayInt=tempDelayInt, tables=tables, pysmi_global=pysmi_global, histCompVal=histCompVal, humHighInt=humHighInt)
