...
# Produced by pysmi-1.1.12 at Thu Apr  4 13:47:42 2024
...
TimeTicks, enterprises, NotificationType, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier, ObjectIdentity, Gauge32, Bits, Counter32, ModuleIdentity, IpAddress, Unsigned32, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "enterprises", "NotificationType", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier", "ObjectIdentity", "Gauge32", "Bits", "Counter32", "ModuleIdentity", "IpAddress", "Unsigned32", "NotificationType", "iso")
...
mibBuilder.exportSymbols("T3610-MIB", historyEntry=historyEntry, trapSOAPErrDNS=trapSOAPErrDNS, compValUnit=compValUnit, trapCompValError=trapCompValError, humUnit=humUnit, compValInt=compValInt, sensorName=sensorName, traps=traps, hum=hum, compValHighInt=compValHighInt, tempAlarm=tempAlarm, tempInt=tempInt, trapNTPError=trapNTPError, compValLowInt=compValLowInt, tempDelayInt=tempDelayInt, trapEmailErrLogin=trapEmailErrLogin, trapCompValLowAlarm=trapCompValLowAlarm, trapEmailErrSome=trapEmailErrSome, values=values, tempAlarmInt=tempAlarmInt, compValHystInt=compValHystInt, humMin=humMin, trapSOAPErrFile=trapSOAPErrFile, compValAlarmInt=compValAlarmInt, compValMin=compValMin, tempUnit=tempUnit, histHum=histHum, trapHumHighAlarm=trapHumHighAlarm, trapTempLowAlarm=trapTempLowAlarm, humLowInt=humLowInt, t3610=t3610, products=products, trapTempHighAlarm=trapTempHighAlarm, comet=comet, trapSOAPErrDelivery=trapSOAPErrDelivery, deviceType=deviceType, compValAlarm=compValAlarm, humHystInt=humHystInt, histCompVal=histCompVal, compVal=compVal, valuesInt=valuesInt, settings=settings, tables=tables, messageString=messageString, trapSOAPErrSocket=trapSOAPErrSocket, humDelayInt=humDelayInt, trapHumError=trapHumError, humMax=humMax, trapHumClrAlarm=trapHumClrAlarm, trapCompValHighAlarm=trapCompValHighAlarm, trapTempError=trapTempError, DisplayString=DisplayString, trapTempClrAlarm=trapTempClrAlarm, histTemp=histTemp, tempLowInt=tempLowInt, trapEmailErrAuth=trapEmailErrAuth, tempHighInt=tempHighInt, humHighInt=humHighInt, temp=temp, humInt=humInt, trapCompValClrAlarm=trapCompValClrAlarm, tempMin=tempMin, trapTest=trapTest, humAlarmInt=humAlarmInt, trapEmailErrSocket=trapEmailErrSocket, compValMax=compValMax, trapEmailErrDNS=trapEmailErrDNS, humAlarm=humAlarm, tempHystInt=tempHystInt, pysmi_global=pysmi_global, compValDelayInt=compValDelayInt, tempMax=tempMax, historyTable=historyTable, serialNumber=serialNumber, trapHumLowAlarm=trapHumLowAlarm)
