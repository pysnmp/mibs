...
# Produced by pysmi-1.1.12 at Fri Jul 19 10:00:04 2024
...
Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ObjectIdentity, IpAddress, NotificationType, ModuleIdentity, enterprises, TimeTicks, Gauge32, NotificationType, MibIdentifier, iso, Bits, Unsigned32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ObjectIdentity", "IpAddress", "NotificationType", "ModuleIdentity", "enterprises", "TimeTicks", "Gauge32", "NotificationType", "MibIdentifier", "iso", "Bits", "Unsigned32", "Counter32")
...
mibBuilder.exportSymbols("T3610-MIB", trapHumClrAlarm=trapHumClrAlarm, tempLowInt=tempLowInt, histTemp=histTemp, trapEmailErrLogin=trapEmailErrLogin, tempAlarmInt=tempAlarmInt, tempHighInt=tempHighInt, humUnit=humUnit, pysmi_global=pysmi_global, temp=temp, compVal=compVal, humMin=humMin, compValHighInt=compValHighInt, valuesInt=valuesInt, trapHumLowAlarm=trapHumLowAlarm, values=values, trapEmailErrDNS=trapEmailErrDNS, trapSOAPErrDNS=trapSOAPErrDNS, trapSOAPErrDelivery=trapSOAPErrDelivery, tempMax=tempMax, trapTempHighAlarm=trapTempHighAlarm, trapCompValClrAlarm=trapCompValClrAlarm, humLowInt=humLowInt, compValAlarm=compValAlarm, compValHystInt=compValHystInt, compValLowInt=compValLowInt, compValMin=compValMin, compValMax=compValMax, products=products, histCompVal=histCompVal, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValError=trapCompValError, settings=settings, tempMin=tempMin, tempInt=tempInt, compValInt=compValInt, histHum=histHum, trapCompValHighAlarm=trapCompValHighAlarm, serialNumber=serialNumber, tempUnit=tempUnit, historyEntry=historyEntry, tempHystInt=tempHystInt, sensorName=sensorName, trapTempClrAlarm=trapTempClrAlarm, humAlarmInt=humAlarmInt, t3610=t3610, trapNTPError=trapNTPError, trapHumError=trapHumError, humHighInt=humHighInt, tables=tables, trapTempError=trapTempError, tempDelayInt=tempDelayInt, humHystInt=humHystInt, trapEmailErrSome=trapEmailErrSome, trapTempLowAlarm=trapTempLowAlarm, deviceType=deviceType, trapTest=trapTest, humDelayInt=humDelayInt, compValUnit=compValUnit, trapSOAPErrFile=trapSOAPErrFile, trapHumHighAlarm=trapHumHighAlarm, tempAlarm=tempAlarm, traps=traps, humInt=humInt, trapEmailErrSocket=trapEmailErrSocket, compValAlarmInt=compValAlarmInt, trapCompValLowAlarm=trapCompValLowAlarm, messageString=messageString, hum=hum, historyTable=historyTable, comet=comet, DisplayString=DisplayString, trapEmailErrAuth=trapEmailErrAuth, compValDelayInt=compValDelayInt, humMax=humMax, humAlarm=humAlarm)
