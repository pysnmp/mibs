...
# Produced by pysmi-1.1.8 at Mon Jan 17 19:20:21 2022
...
MibIdentifier, iso, IpAddress, Counter32, TimeTicks, Integer32, ModuleIdentity, Unsigned32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, ObjectIdentity, enterprises, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "iso", "IpAddress", "Counter32", "TimeTicks", "Integer32", "ModuleIdentity", "Unsigned32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "ObjectIdentity", "enterprises", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("T3610-MIB", humAlarmInt=humAlarmInt, humUnit=humUnit, trapHumHighAlarm=trapHumHighAlarm, pysmi_global=pysmi_global, humLowInt=humLowInt, histCompVal=histCompVal, trapEmailErrLogin=trapEmailErrLogin, trapCompValHighAlarm=trapCompValHighAlarm, trapHumClrAlarm=trapHumClrAlarm, tempInt=tempInt, humInt=humInt, traps=traps, trapHumLowAlarm=trapHumLowAlarm, temp=temp, tempMax=tempMax, sensorName=sensorName, tempHystInt=tempHystInt, trapTempLowAlarm=trapTempLowAlarm, trapEmailErrSocket=trapEmailErrSocket, serialNumber=serialNumber, compValInt=compValInt, compValHighInt=compValHighInt, DisplayString=DisplayString, humHystInt=humHystInt, valuesInt=valuesInt, compValLowInt=compValLowInt, t3610=t3610, trapSOAPErrFile=trapSOAPErrFile, compValUnit=compValUnit, products=products, trapCompValClrAlarm=trapCompValClrAlarm, tempMin=tempMin, tempDelayInt=tempDelayInt, compValDelayInt=compValDelayInt, trapTempClrAlarm=trapTempClrAlarm, values=values, tempHighInt=tempHighInt, deviceType=deviceType, trapSOAPErrDelivery=trapSOAPErrDelivery, compValAlarmInt=compValAlarmInt, compValMax=compValMax, humHighInt=humHighInt, humAlarm=humAlarm, tempLowInt=tempLowInt, settings=settings, humDelayInt=humDelayInt, trapNTPError=trapNTPError, compValHystInt=compValHystInt, histHum=histHum, tempAlarm=tempAlarm, trapEmailErrDNS=trapEmailErrDNS, trapTempHighAlarm=trapTempHighAlarm, trapCompValLowAlarm=trapCompValLowAlarm, historyTable=historyTable, compValMin=compValMin, trapTest=trapTest, trapSOAPErrSocket=trapSOAPErrSocket, historyEntry=historyEntry, tables=tables, histTemp=histTemp, trapEmailErrAuth=trapEmailErrAuth, trapHumError=trapHumError, messageString=messageString, tempUnit=tempUnit, trapEmailErrSome=trapEmailErrSome, comet=comet, hum=hum, trapTempError=trapTempError, trapSOAPErrDNS=trapSOAPErrDNS, humMax=humMax, humMin=humMin, trapCompValError=trapCompValError, compValAlarm=compValAlarm, tempAlarmInt=tempAlarmInt, compVal=compVal)
