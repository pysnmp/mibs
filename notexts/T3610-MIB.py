...
# Produced by pysmi-1.1.3 at Sun Nov 28 20:04:54 2021
...
MibIdentifier, Bits, NotificationType, TimeTicks, Unsigned32, IpAddress, Counter64, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Integer32, ModuleIdentity, iso, enterprises, NotificationType, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Bits", "NotificationType", "TimeTicks", "Unsigned32", "IpAddress", "Counter64", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Integer32", "ModuleIdentity", "iso", "enterprises", "NotificationType", "ObjectIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", compValUnit=compValUnit, trapSOAPErrSocket=trapSOAPErrSocket, traps=traps, tempAlarmInt=tempAlarmInt, tempAlarm=tempAlarm, tempMin=tempMin, compValInt=compValInt, compValLowInt=compValLowInt, settings=settings, pysmi_global=pysmi_global, tempLowInt=tempLowInt, humHystInt=humHystInt, humLowInt=humLowInt, compValDelayInt=compValDelayInt, humDelayInt=humDelayInt, tempDelayInt=tempDelayInt, trapCompValClrAlarm=trapCompValClrAlarm, histTemp=histTemp, trapTempHighAlarm=trapTempHighAlarm, trapEmailErrSocket=trapEmailErrSocket, trapHumLowAlarm=trapHumLowAlarm, comet=comet, humAlarmInt=humAlarmInt, trapSOAPErrFile=trapSOAPErrFile, trapCompValLowAlarm=trapCompValLowAlarm, humAlarm=humAlarm, serialNumber=serialNumber, humInt=humInt, DisplayString=DisplayString, humMax=humMax, trapTest=trapTest, historyTable=historyTable, t3610=t3610, hum=hum, trapEmailErrLogin=trapEmailErrLogin, trapEmailErrDNS=trapEmailErrDNS, sensorName=sensorName, deviceType=deviceType, tempHystInt=tempHystInt, values=values, tempHighInt=tempHighInt, trapTempError=trapTempError, trapTempLowAlarm=trapTempLowAlarm, tempMax=tempMax, humUnit=humUnit, trapSOAPErrDelivery=trapSOAPErrDelivery, trapCompValError=trapCompValError, histCompVal=histCompVal, compValAlarmInt=compValAlarmInt, trapNTPError=trapNTPError, products=products, tables=tables, compValHighInt=compValHighInt, temp=temp, trapCompValHighAlarm=trapCompValHighAlarm, valuesInt=valuesInt, trapTempClrAlarm=trapTempClrAlarm, compVal=compVal, historyEntry=historyEntry, trapEmailErrSome=trapEmailErrSome, trapHumHighAlarm=trapHumHighAlarm, humMin=humMin, compValHystInt=compValHystInt, trapHumClrAlarm=trapHumClrAlarm, trapHumError=trapHumError, compValAlarm=compValAlarm, tempUnit=tempUnit, compValMin=compValMin, trapEmailErrAuth=trapEmailErrAuth, tempInt=tempInt, histHum=histHum, messageString=messageString, compValMax=compValMax, humHighInt=humHighInt, trapSOAPErrDNS=trapSOAPErrDNS)
