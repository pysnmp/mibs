...
enterprises, ModuleIdentity, ObjectIdentity, MibIdentifier, iso, Counter32, NotificationType, Gauge32, Counter64, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32, Unsigned32, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "iso", "Counter32", "NotificationType", "Gauge32", "Counter64", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32", "Unsigned32", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", compValMax=compValMax, histHum=histHum, trapNTPError=trapNTPError, trapSOAPErrDNS=trapSOAPErrDNS, trapCompValLowAlarm=trapCompValLowAlarm, hum=hum, humMax=humMax, trapEmailErrSome=trapEmailErrSome, humAlarmInt=humAlarmInt, tables=tables, compValMin=compValMin, pysmi_global=pysmi_global, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTest=trapTest, tempLowInt=tempLowInt, historyTable=historyTable, humHystInt=humHystInt, trapTempLowAlarm=trapTempLowAlarm, tempHystInt=tempHystInt, comet=comet, tempInt=tempInt, trapHumLowAlarm=trapHumLowAlarm, trapCompValClrAlarm=trapCompValClrAlarm, settings=settings, valuesInt=valuesInt, products=products, compValHystInt=compValHystInt, tempMin=tempMin, compValUnit=compValUnit, humLowInt=humLowInt, messageString=messageString, trapHumClrAlarm=trapHumClrAlarm, humInt=humInt, compValInt=compValInt, histTemp=histTemp, trapTempError=trapTempError, tempDelayInt=tempDelayInt, humUnit=humUnit, compValHighInt=compValHighInt, humMin=humMin, histCompVal=histCompVal, trapTempHighAlarm=trapTempHighAlarm, traps=traps, compVal=compVal, humAlarm=humAlarm, serialNumber=serialNumber, trapEmailErrAuth=trapEmailErrAuth, trapEmailErrDNS=trapEmailErrDNS, tempHighInt=tempHighInt, trapCompValError=trapCompValError, trapEmailErrSocket=trapEmailErrSocket, compValAlarm=compValAlarm, tempMax=tempMax, trapCompValHighAlarm=trapCompValHighAlarm, values=values, trapSOAPErrSocket=trapSOAPErrSocket, compValLowInt=compValLowInt, trapSOAPErrFile=trapSOAPErrFile, tempAlarm=tempAlarm, t3610=t3610, temp=temp, trapEmailErrLogin=trapEmailErrLogin, trapTempClrAlarm=trapTempClrAlarm, humHighInt=humHighInt, historyEntry=historyEntry, compValAlarmInt=compValAlarmInt, deviceType=deviceType, trapHumHighAlarm=trapHumHighAlarm, DisplayString=DisplayString, compValDelayInt=compValDelayInt, sensorName=sensorName, humDelayInt=humDelayInt, tempAlarmInt=tempAlarmInt, tempUnit=tempUnit, trapHumError=trapHumError)
