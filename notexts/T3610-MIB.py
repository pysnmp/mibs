...
# Produced by pysmi-1.1.8 at Thu Sep  7 10:12:03 2023
...
TimeTicks, Counter64, iso, Integer32, Unsigned32, NotificationType, Bits, Counter32, enterprises, MibIdentifier, ModuleIdentity, ObjectIdentity, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter64", "iso", "Integer32", "Unsigned32", "NotificationType", "Bits", "Counter32", "enterprises", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32")
...
mibBuilder.exportSymbols("T3610-MIB", tempUnit=tempUnit, hum=hum, humUnit=humUnit, humMax=humMax, tempLowInt=tempLowInt, products=products, sensorName=sensorName, trapTest=trapTest, trapTempHighAlarm=trapTempHighAlarm, humMin=humMin, compValDelayInt=compValDelayInt, DisplayString=DisplayString, trapTempClrAlarm=trapTempClrAlarm, compValAlarmInt=compValAlarmInt, histHum=histHum, humInt=humInt, humAlarmInt=humAlarmInt, trapTempError=trapTempError, humDelayInt=humDelayInt, trapHumError=trapHumError, humHystInt=humHystInt, values=values, tables=tables, compValHighInt=compValHighInt, trapCompValLowAlarm=trapCompValLowAlarm, trapHumClrAlarm=trapHumClrAlarm, compValInt=compValInt, compValUnit=compValUnit, compValMin=compValMin, deviceType=deviceType, traps=traps, tempInt=tempInt, trapEmailErrSocket=trapEmailErrSocket, trapCompValClrAlarm=trapCompValClrAlarm, trapEmailErrSome=trapEmailErrSome, compValHystInt=compValHystInt, trapEmailErrAuth=trapEmailErrAuth, tempAlarmInt=tempAlarmInt, t3610=t3610, temp=temp, trapHumHighAlarm=trapHumHighAlarm, compValMax=compValMax, pysmi_global=pysmi_global, trapTempLowAlarm=trapTempLowAlarm, serialNumber=serialNumber, trapEmailErrLogin=trapEmailErrLogin, tempMax=tempMax, tempHystInt=tempHystInt, trapCompValHighAlarm=trapCompValHighAlarm, historyTable=historyTable, compVal=compVal, trapHumLowAlarm=trapHumLowAlarm, trapEmailErrDNS=trapEmailErrDNS, tempHighInt=tempHighInt, trapSOAPErrDelivery=trapSOAPErrDelivery, compValAlarm=compValAlarm, tempDelayInt=tempDelayInt, humHighInt=humHighInt, valuesInt=valuesInt, trapSOAPErrSocket=trapSOAPErrSocket, histTemp=histTemp, trapSOAPErrFile=trapSOAPErrFile, tempAlarm=tempAlarm, historyEntry=historyEntry, messageString=messageString, trapNTPError=trapNTPError, trapSOAPErrDNS=trapSOAPErrDNS, trapCompValError=trapCompValError, comet=comet, humAlarm=humAlarm, settings=settings, histCompVal=histCompVal, humLowInt=humLowInt, tempMin=tempMin, compValLowInt=compValLowInt)
