...
# Produced by pysmi-1.1.12 at Thu Nov 28 02:55:44 2024
...
NotificationType, TimeTicks, Gauge32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, enterprises, Counter32, IpAddress, MibIdentifier, ObjectIdentity, iso, NotificationType, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "Gauge32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "enterprises", "Counter32", "IpAddress", "MibIdentifier", "ObjectIdentity", "iso", "NotificationType", "ModuleIdentity", "Integer32")
...
mibBuilder.exportSymbols("T3610-MIB", tempHystInt=tempHystInt, trapTempHighAlarm=trapTempHighAlarm, tempLowInt=tempLowInt, compValAlarmInt=compValAlarmInt, values=values, humAlarmInt=humAlarmInt, trapHumHighAlarm=trapHumHighAlarm, tempAlarmInt=tempAlarmInt, deviceType=deviceType, compValLowInt=compValLowInt, traps=traps, compValUnit=compValUnit, compValMax=compValMax, tempDelayInt=tempDelayInt, trapTest=trapTest, trapEmailErrLogin=trapEmailErrLogin, tempHighInt=tempHighInt, compValHighInt=compValHighInt, serialNumber=serialNumber, compValInt=compValInt, historyTable=historyTable, trapEmailErrSocket=trapEmailErrSocket, temp=temp, trapEmailErrDNS=trapEmailErrDNS, trapSOAPErrSocket=trapSOAPErrSocket, humHystInt=humHystInt, historyEntry=historyEntry, tempMin=tempMin, trapNTPError=trapNTPError, hum=hum, trapHumLowAlarm=trapHumLowAlarm, products=products, trapCompValLowAlarm=trapCompValLowAlarm, trapHumClrAlarm=trapHumClrAlarm, trapHumError=trapHumError, compValMin=compValMin, tempUnit=tempUnit, t3610=t3610, humMin=humMin, tempAlarm=tempAlarm, trapTempLowAlarm=trapTempLowAlarm, compVal=compVal, humMax=humMax, humLowInt=humLowInt, settings=settings, histCompVal=histCompVal, comet=comet, compValAlarm=compValAlarm, tables=tables, histTemp=histTemp, compValHystInt=compValHystInt, humHighInt=humHighInt, tempMax=tempMax, compValDelayInt=compValDelayInt, histHum=histHum, humUnit=humUnit, DisplayString=DisplayString, valuesInt=valuesInt, messageString=messageString, trapCompValHighAlarm=trapCompValHighAlarm, trapTempClrAlarm=trapTempClrAlarm, trapSOAPErrDNS=trapSOAPErrDNS, sensorName=sensorName, trapEmailErrSome=trapEmailErrSome, tempInt=tempInt, trapCompValError=trapCompValError, trapTempError=trapTempError, humDelayInt=humDelayInt, humInt=humInt, trapSOAPErrFile=trapSOAPErrFile, trapSOAPErrDelivery=trapSOAPErrDelivery, pysmi_global=pysmi_global, trapCompValClrAlarm=trapCompValClrAlarm, trapEmailErrAuth=trapEmailErrAuth, humAlarm=humAlarm)
