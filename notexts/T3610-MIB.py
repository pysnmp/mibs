...
# Produced by pysmi-1.1.12 at Tue May 28 13:33:55 2024
...
ObjectIdentity, Bits, enterprises, IpAddress, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Gauge32, MibIdentifier, iso, TimeTicks, Unsigned32, NotificationType, Counter32, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Bits", "enterprises", "IpAddress", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Gauge32", "MibIdentifier", "iso", "TimeTicks", "Unsigned32", "NotificationType", "Counter32", "ModuleIdentity", "Counter64")
...
mibBuilder.exportSymbols("T3610-MIB", trapTempHighAlarm=trapTempHighAlarm, trapSOAPErrFile=trapSOAPErrFile, t3610=t3610, trapEmailErrLogin=trapEmailErrLogin, humDelayInt=humDelayInt, hum=hum, humInt=humInt, tempInt=tempInt, trapTest=trapTest, tempMax=tempMax, humUnit=humUnit, sensorName=sensorName, histCompVal=histCompVal, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrDNS=trapSOAPErrDNS, compValHystInt=compValHystInt, tempHystInt=tempHystInt, histTemp=histTemp, trapNTPError=trapNTPError, messageString=messageString, DisplayString=DisplayString, historyEntry=historyEntry, trapEmailErrSome=trapEmailErrSome, tempDelayInt=tempDelayInt, tempMin=tempMin, trapEmailErrDNS=trapEmailErrDNS, traps=traps, trapCompValLowAlarm=trapCompValLowAlarm, trapCompValHighAlarm=trapCompValHighAlarm, tempAlarmInt=tempAlarmInt, trapSOAPErrSocket=trapSOAPErrSocket, trapHumClrAlarm=trapHumClrAlarm, humMax=humMax, compValUnit=compValUnit, tempAlarm=tempAlarm, comet=comet, compValMax=compValMax, tempHighInt=tempHighInt, histHum=histHum, trapEmailErrAuth=trapEmailErrAuth, settings=settings, compValLowInt=compValLowInt, tables=tables, trapHumLowAlarm=trapHumLowAlarm, humLowInt=humLowInt, compValMin=compValMin, compVal=compVal, humMin=humMin, humAlarmInt=humAlarmInt, trapCompValClrAlarm=trapCompValClrAlarm, values=values, valuesInt=valuesInt, trapHumHighAlarm=trapHumHighAlarm, tempUnit=tempUnit, trapCompValError=trapCompValError, compValAlarm=compValAlarm, tempLowInt=tempLowInt, trapSOAPErrDelivery=trapSOAPErrDelivery, deviceType=deviceType, products=products, serialNumber=serialNumber, pysmi_global=pysmi_global, compValHighInt=compValHighInt, humHighInt=humHighInt, trapTempLowAlarm=trapTempLowAlarm, historyTable=historyTable, temp=temp, humAlarm=humAlarm, compValInt=compValInt, compValAlarmInt=compValAlarmInt, humHystInt=humHystInt, trapTempError=trapTempError, compValDelayInt=compValDelayInt, trapHumError=trapHumError, trapTempClrAlarm=trapTempClrAlarm)
