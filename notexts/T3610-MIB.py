...
# Produced by pysmi-1.1.8 at Thu Jan 27 21:32:40 2022
...
TimeTicks, Counter64, enterprises, ObjectIdentity, Unsigned32, NotificationType, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Bits, NotificationType, Gauge32, IpAddress, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter64", "enterprises", "ObjectIdentity", "Unsigned32", "NotificationType", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Bits", "NotificationType", "Gauge32", "IpAddress", "Integer32", "ModuleIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", tempMin=tempMin, sensorName=sensorName, histTemp=histTemp, humAlarm=humAlarm, histCompVal=histCompVal, tempMax=tempMax, compValHighInt=compValHighInt, tempInt=tempInt, trapTempLowAlarm=trapTempLowAlarm, tempLowInt=tempLowInt, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrFile=trapSOAPErrFile, historyEntry=historyEntry, compValMax=compValMax, trapCompValHighAlarm=trapCompValHighAlarm, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValClrAlarm=trapCompValClrAlarm, t3610=t3610, hum=hum, compValHystInt=compValHystInt, trapNTPError=trapNTPError, traps=traps, compValMin=compValMin, tempUnit=tempUnit, trapEmailErrSome=trapEmailErrSome, deviceType=deviceType, trapTest=trapTest, trapHumLowAlarm=trapHumLowAlarm, humHighInt=humHighInt, trapEmailErrDNS=trapEmailErrDNS, serialNumber=serialNumber, humMin=humMin, pysmi_global=pysmi_global, compValUnit=compValUnit, DisplayString=DisplayString, compValLowInt=compValLowInt, humDelayInt=humDelayInt, compValDelayInt=compValDelayInt, tempAlarm=tempAlarm, trapEmailErrLogin=trapEmailErrLogin, trapSOAPErrDNS=trapSOAPErrDNS, trapHumClrAlarm=trapHumClrAlarm, humMax=humMax, tables=tables, trapHumError=trapHumError, compValAlarm=compValAlarm, trapCompValLowAlarm=trapCompValLowAlarm, humHystInt=humHystInt, trapTempError=trapTempError, valuesInt=valuesInt, humUnit=humUnit, values=values, humInt=humInt, humLowInt=humLowInt, histHum=histHum, products=products, settings=settings, messageString=messageString, tempAlarmInt=tempAlarmInt, trapSOAPErrDelivery=trapSOAPErrDelivery, humAlarmInt=humAlarmInt, comet=comet, compVal=compVal, temp=temp, compValAlarmInt=compValAlarmInt, tempHystInt=tempHystInt, trapTempHighAlarm=trapTempHighAlarm, compValInt=compValInt, tempHighInt=tempHighInt, tempDelayInt=tempDelayInt, trapTempClrAlarm=trapTempClrAlarm, historyTable=historyTable, trapCompValError=trapCompValError, trapHumHighAlarm=trapHumHighAlarm)
