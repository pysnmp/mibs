...
# Produced by pysmi-1.1.3 at Sun Nov 28 21:31:16 2021
...
Integer32, ModuleIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, iso, TimeTicks, IpAddress, ObjectIdentity, Counter32, enterprises, Counter64, NotificationType, Gauge32, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "iso", "TimeTicks", "IpAddress", "ObjectIdentity", "Counter32", "enterprises", "Counter64", "NotificationType", "Gauge32", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", compValMin=compValMin, tables=tables, compValAlarmInt=compValAlarmInt, products=products, humMin=humMin, tempUnit=tempUnit, tempDelayInt=tempDelayInt, trapCompValClrAlarm=trapCompValClrAlarm, compValMax=compValMax, DisplayString=DisplayString, valuesInt=valuesInt, values=values, humUnit=humUnit, compValAlarm=compValAlarm, trapNTPError=trapNTPError, compValInt=compValInt, tempAlarm=tempAlarm, traps=traps, humLowInt=humLowInt, hum=hum, trapCompValHighAlarm=trapCompValHighAlarm, trapHumError=trapHumError, histTemp=histTemp, trapEmailErrSocket=trapEmailErrSocket, trapTempError=trapTempError, histCompVal=histCompVal, trapSOAPErrDelivery=trapSOAPErrDelivery, tempHighInt=tempHighInt, compVal=compVal, temp=temp, sensorName=sensorName, tempMin=tempMin, trapEmailErrSome=trapEmailErrSome, compValHighInt=compValHighInt, trapSOAPErrDNS=trapSOAPErrDNS, compValDelayInt=compValDelayInt, compValHystInt=compValHystInt, historyEntry=historyEntry, trapEmailErrDNS=trapEmailErrDNS, tempLowInt=tempLowInt, histHum=histHum, trapTempHighAlarm=trapTempHighAlarm, humMax=humMax, humAlarm=humAlarm, trapSOAPErrSocket=trapSOAPErrSocket, trapTempClrAlarm=trapTempClrAlarm, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrFile=trapSOAPErrFile, trapHumHighAlarm=trapHumHighAlarm, historyTable=historyTable, trapCompValLowAlarm=trapCompValLowAlarm, humDelayInt=humDelayInt, tempMax=tempMax, t3610=t3610, tempInt=tempInt, compValUnit=compValUnit, deviceType=deviceType, humInt=humInt, tempAlarmInt=tempAlarmInt, trapEmailErrLogin=trapEmailErrLogin, trapHumClrAlarm=trapHumClrAlarm, messageString=messageString, trapHumLowAlarm=trapHumLowAlarm, trapTempLowAlarm=trapTempLowAlarm, humHystInt=humHystInt, serialNumber=serialNumber, humHighInt=humHighInt, compValLowInt=compValLowInt, comet=comet, trapTest=trapTest, settings=settings, trapCompValError=trapCompValError, humAlarmInt=humAlarmInt, pysmi_global=pysmi_global, tempHystInt=tempHystInt)
