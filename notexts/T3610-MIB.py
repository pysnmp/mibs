...
# Produced by pysmi-1.1.12 at Tue Dec  3 12:32:50 2024
...
Counter32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, Gauge32, Counter64, Integer32, Unsigned32, ModuleIdentity, ObjectIdentity, MibIdentifier, iso, enterprises, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "Gauge32", "Counter64", "Integer32", "Unsigned32", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "iso", "enterprises", "Bits", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", humHighInt=humHighInt, histTemp=histTemp, tempLowInt=tempLowInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapHumError=trapHumError, trapNTPError=trapNTPError, trapCompValLowAlarm=trapCompValLowAlarm, trapCompValError=trapCompValError, comet=comet, humMax=humMax, compValDelayInt=compValDelayInt, messageString=messageString, histHum=histHum, tempHighInt=tempHighInt, trapTempHighAlarm=trapTempHighAlarm, compVal=compVal, serialNumber=serialNumber, humInt=humInt, historyEntry=historyEntry, values=values, histCompVal=histCompVal, valuesInt=valuesInt, hum=hum, tempMax=tempMax, trapTempError=trapTempError, trapEmailErrLogin=trapEmailErrLogin, DisplayString=DisplayString, tempAlarm=tempAlarm, t3610=t3610, temp=temp, compValMax=compValMax, historyTable=historyTable, tables=tables, settings=settings, tempUnit=tempUnit, compValUnit=compValUnit, humLowInt=humLowInt, humAlarm=humAlarm, compValInt=compValInt, compValHighInt=compValHighInt, humUnit=humUnit, tempHystInt=tempHystInt, tempDelayInt=tempDelayInt, tempInt=tempInt, trapEmailErrAuth=trapEmailErrAuth, trapHumHighAlarm=trapHumHighAlarm, trapSOAPErrDNS=trapSOAPErrDNS, pysmi_global=pysmi_global, sensorName=sensorName, compValLowInt=compValLowInt, deviceType=deviceType, trapSOAPErrFile=trapSOAPErrFile, trapTest=trapTest, trapTempClrAlarm=trapTempClrAlarm, tempMin=tempMin, trapTempLowAlarm=trapTempLowAlarm, compValMin=compValMin, compValAlarm=compValAlarm, tempAlarmInt=tempAlarmInt, humMin=humMin, trapEmailErrSome=trapEmailErrSome, humAlarmInt=humAlarmInt, trapCompValHighAlarm=trapCompValHighAlarm, trapHumClrAlarm=trapHumClrAlarm, trapEmailErrSocket=trapEmailErrSocket, trapCompValClrAlarm=trapCompValClrAlarm, humDelayInt=humDelayInt, compValAlarmInt=compValAlarmInt, trapSOAPErrSocket=trapSOAPErrSocket, products=products, trapEmailErrDNS=trapEmailErrDNS, compValHystInt=compValHystInt, humHystInt=humHystInt, trapHumLowAlarm=trapHumLowAlarm, traps=traps)
