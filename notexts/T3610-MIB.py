...
# Produced by pysmi-1.1.8 at Sun Jan 16 00:33:27 2022
...
NotificationType, Integer32, ObjectIdentity, Unsigned32, Bits, Counter32, iso, enterprises, NotificationType, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter64, Gauge32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "ObjectIdentity", "Unsigned32", "Bits", "Counter32", "iso", "enterprises", "NotificationType", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter64", "Gauge32", "TimeTicks")
...
mibBuilder.exportSymbols("T3610-MIB", humHighInt=humHighInt, trapHumHighAlarm=trapHumHighAlarm, products=products, humMin=humMin, pysmi_global=pysmi_global, compValInt=compValInt, comet=comet, trapEmailErrSome=trapEmailErrSome, trapTest=trapTest, temp=temp, humAlarmInt=humAlarmInt, humLowInt=humLowInt, valuesInt=valuesInt, deviceType=deviceType, trapCompValClrAlarm=trapCompValClrAlarm, compValDelayInt=compValDelayInt, trapCompValHighAlarm=trapCompValHighAlarm, trapHumError=trapHumError, tempHighInt=tempHighInt, compValMax=compValMax, tempAlarm=tempAlarm, humDelayInt=humDelayInt, trapCompValError=trapCompValError, histCompVal=histCompVal, t3610=t3610, tempInt=tempInt, tempLowInt=tempLowInt, trapHumLowAlarm=trapHumLowAlarm, compValMin=compValMin, trapCompValLowAlarm=trapCompValLowAlarm, humHystInt=humHystInt, settings=settings, trapSOAPErrSocket=trapSOAPErrSocket, trapSOAPErrFile=trapSOAPErrFile, tempUnit=tempUnit, humInt=humInt, hum=hum, trapNTPError=trapNTPError, trapEmailErrSocket=trapEmailErrSocket, traps=traps, trapSOAPErrDelivery=trapSOAPErrDelivery, humAlarm=humAlarm, compValUnit=compValUnit, serialNumber=serialNumber, messageString=messageString, historyTable=historyTable, trapTempLowAlarm=trapTempLowAlarm, trapTempClrAlarm=trapTempClrAlarm, histHum=histHum, trapHumClrAlarm=trapHumClrAlarm, trapEmailErrDNS=trapEmailErrDNS, tempMin=tempMin, humUnit=humUnit, compValLowInt=compValLowInt, compValAlarmInt=compValAlarmInt, tempHystInt=tempHystInt, compValHighInt=compValHighInt, compValAlarm=compValAlarm, tempMax=tempMax, DisplayString=DisplayString, tables=tables, values=values, humMax=humMax, sensorName=sensorName, tempAlarmInt=tempAlarmInt, tempDelayInt=tempDelayInt, compValHystInt=compValHystInt, trapEmailErrAuth=trapEmailErrAuth, trapEmailErrLogin=trapEmailErrLogin, trapSOAPErrDNS=trapSOAPErrDNS, histTemp=histTemp, trapTempHighAlarm=trapTempHighAlarm, trapTempError=trapTempError, compVal=compVal, historyEntry=historyEntry)
