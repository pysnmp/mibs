...
# Produced by pysmi-1.1.12 at Mon Jun  3 13:40:54 2024
...
MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity, Unsigned32, Gauge32, NotificationType, iso, Counter64, TimeTicks, ObjectIdentity, enterprises, Integer32, IpAddress, Counter32, NotificationType, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity", "Unsigned32", "Gauge32", "NotificationType", "iso", "Counter64", "TimeTicks", "ObjectIdentity", "enterprises", "Integer32", "IpAddress", "Counter32", "NotificationType", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", trapEmailErrSocket=trapEmailErrSocket, traps=traps, tables=tables, trapEmailErrSome=trapEmailErrSome, pysmi_global=pysmi_global, trapEmailErrDNS=trapEmailErrDNS, compValMax=compValMax, compValHighInt=compValHighInt, humInt=humInt, trapTempHighAlarm=trapTempHighAlarm, compValMin=compValMin, tempLowInt=tempLowInt, tempAlarm=tempAlarm, trapCompValLowAlarm=trapCompValLowAlarm, comet=comet, trapHumClrAlarm=trapHumClrAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, settings=settings, trapTempLowAlarm=trapTempLowAlarm, historyTable=historyTable, trapHumLowAlarm=trapHumLowAlarm, compValUnit=compValUnit, humLowInt=humLowInt, trapEmailErrLogin=trapEmailErrLogin, trapSOAPErrDNS=trapSOAPErrDNS, humMin=humMin, trapCompValClrAlarm=trapCompValClrAlarm, humUnit=humUnit, tempUnit=tempUnit, compVal=compVal, tempAlarmInt=tempAlarmInt, t3610=t3610, values=values, compValHystInt=compValHystInt, histCompVal=histCompVal, trapSOAPErrSocket=trapSOAPErrSocket, sensorName=sensorName, tempInt=tempInt, humHighInt=humHighInt, humMax=humMax, trapHumHighAlarm=trapHumHighAlarm, tempMin=tempMin, serialNumber=serialNumber, deviceType=deviceType, historyEntry=historyEntry, trapTempError=trapTempError, temp=temp, humAlarm=humAlarm, histTemp=histTemp, valuesInt=valuesInt, hum=hum, humAlarmInt=humAlarmInt, tempHighInt=tempHighInt, trapNTPError=trapNTPError, trapCompValHighAlarm=trapCompValHighAlarm, trapTempClrAlarm=trapTempClrAlarm, compValLowInt=compValLowInt, trapHumError=trapHumError, histHum=histHum, trapSOAPErrFile=trapSOAPErrFile, tempMax=tempMax, compValDelayInt=compValDelayInt, compValAlarmInt=compValAlarmInt, messageString=messageString, trapCompValError=trapCompValError, compValAlarm=compValAlarm, tempDelayInt=tempDelayInt, humHystInt=humHystInt, trapTest=trapTest, compValInt=compValInt, trapEmailErrAuth=trapEmailErrAuth, products=products, tempHystInt=tempHystInt, humDelayInt=humDelayInt, DisplayString=DisplayString)
