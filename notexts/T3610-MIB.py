...
# Produced by pysmi-1.1.12 at Thu Apr  4 13:11:49 2024
...
MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Gauge32, Counter64, ModuleIdentity, ObjectIdentity, enterprises, TimeTicks, Bits, Counter32, Unsigned32, NotificationType, Integer32, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Gauge32", "Counter64", "ModuleIdentity", "ObjectIdentity", "enterprises", "TimeTicks", "Bits", "Counter32", "Unsigned32", "NotificationType", "Integer32", "iso", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", trapCompValError=trapCompValError, trapSOAPErrFile=trapSOAPErrFile, trapSOAPErrDNS=trapSOAPErrDNS, hum=hum, humUnit=humUnit, trapCompValHighAlarm=trapCompValHighAlarm, traps=traps, trapEmailErrSome=trapEmailErrSome, trapHumHighAlarm=trapHumHighAlarm, trapHumLowAlarm=trapHumLowAlarm, trapTempClrAlarm=trapTempClrAlarm, trapTest=trapTest, trapHumClrAlarm=trapHumClrAlarm, compValHighInt=compValHighInt, tempAlarm=tempAlarm, histCompVal=histCompVal, trapTempHighAlarm=trapTempHighAlarm, histTemp=histTemp, temp=temp, trapCompValLowAlarm=trapCompValLowAlarm, compValUnit=compValUnit, tempMax=tempMax, trapEmailErrLogin=trapEmailErrLogin, t3610=t3610, histHum=histHum, trapHumError=trapHumError, compValDelayInt=compValDelayInt, comet=comet, serialNumber=serialNumber, tempAlarmInt=tempAlarmInt, humLowInt=humLowInt, compValInt=compValInt, valuesInt=valuesInt, tempLowInt=tempLowInt, humHighInt=humHighInt, tempDelayInt=tempDelayInt, tempUnit=tempUnit, historyEntry=historyEntry, trapSOAPErrSocket=trapSOAPErrSocket, compValMin=compValMin, trapTempError=trapTempError, trapSOAPErrDelivery=trapSOAPErrDelivery, humMin=humMin, trapCompValClrAlarm=trapCompValClrAlarm, compVal=compVal, tempInt=tempInt, humHystInt=humHystInt, messageString=messageString, settings=settings, humAlarmInt=humAlarmInt, values=values, compValAlarmInt=compValAlarmInt, tables=tables, trapTempLowAlarm=trapTempLowAlarm, compValMax=compValMax, humMax=humMax, compValLowInt=compValLowInt, historyTable=historyTable, sensorName=sensorName, DisplayString=DisplayString, compValAlarm=compValAlarm, deviceType=deviceType, humInt=humInt, trapEmailErrAuth=trapEmailErrAuth, trapNTPError=trapNTPError, trapEmailErrSocket=trapEmailErrSocket, trapEmailErrDNS=trapEmailErrDNS, products=products, pysmi_global=pysmi_global, humAlarm=humAlarm, tempHighInt=tempHighInt, humDelayInt=humDelayInt, tempHystInt=tempHystInt, compValHystInt=compValHystInt, tempMin=tempMin)
