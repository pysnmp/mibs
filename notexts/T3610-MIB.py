...
# Produced by pysmi-1.1.8 at Tue Jul 26 16:40:40 2022
...
Unsigned32, Counter64, Gauge32, Integer32, ObjectIdentity, IpAddress, NotificationType, TimeTicks, MibIdentifier, ModuleIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, iso, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter64", "Gauge32", "Integer32", "ObjectIdentity", "IpAddress", "NotificationType", "TimeTicks", "MibIdentifier", "ModuleIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "iso", "enterprises")
...
mibBuilder.exportSymbols("T3610-MIB", compValMax=compValMax, tempUnit=tempUnit, deviceType=deviceType, values=values, compValInt=compValInt, humDelayInt=humDelayInt, tempLowInt=tempLowInt, DisplayString=DisplayString, traps=traps, humInt=humInt, compValLowInt=compValLowInt, tempHystInt=tempHystInt, humMin=humMin, humMax=humMax, hum=hum, trapEmailErrSome=trapEmailErrSome, trapEmailErrLogin=trapEmailErrLogin, trapEmailErrSocket=trapEmailErrSocket, tables=tables, trapSOAPErrDelivery=trapSOAPErrDelivery, compValAlarmInt=compValAlarmInt, histTemp=histTemp, tempAlarm=tempAlarm, tempMax=tempMax, settings=settings, humAlarmInt=humAlarmInt, historyEntry=historyEntry, compValUnit=compValUnit, valuesInt=valuesInt, humAlarm=humAlarm, compValHystInt=compValHystInt, products=products, compValAlarm=compValAlarm, compVal=compVal, histHum=histHum, trapSOAPErrDNS=trapSOAPErrDNS, humUnit=humUnit, tempHighInt=tempHighInt, trapCompValHighAlarm=trapCompValHighAlarm, humHystInt=humHystInt, trapTempLowAlarm=trapTempLowAlarm, trapHumClrAlarm=trapHumClrAlarm, trapHumError=trapHumError, trapNTPError=trapNTPError, tempMin=tempMin, humLowInt=humLowInt, t3610=t3610, compValDelayInt=compValDelayInt, humHighInt=humHighInt, trapHumLowAlarm=trapHumLowAlarm, trapSOAPErrFile=trapSOAPErrFile, pysmi_global=pysmi_global, trapHumHighAlarm=trapHumHighAlarm, trapCompValLowAlarm=trapCompValLowAlarm, trapTempHighAlarm=trapTempHighAlarm, tempAlarmInt=tempAlarmInt, messageString=messageString, trapEmailErrDNS=trapEmailErrDNS, trapCompValError=trapCompValError, trapTest=trapTest, tempDelayInt=tempDelayInt, trapSOAPErrSocket=trapSOAPErrSocket, compValHighInt=compValHighInt, histCompVal=histCompVal, trapTempClrAlarm=trapTempClrAlarm, trapCompValClrAlarm=trapCompValClrAlarm, trapTempError=trapTempError, tempInt=tempInt, sensorName=sensorName, historyTable=historyTable, compValMin=compValMin, serialNumber=serialNumber, temp=temp, comet=comet, trapEmailErrAuth=trapEmailErrAuth)
