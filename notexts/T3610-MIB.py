...
# Produced by pysmi-1.1.8 at Thu Oct 12 08:50:51 2023
...
iso, MibIdentifier, Gauge32, NotificationType, Counter64, ObjectIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ModuleIdentity, Unsigned32, Integer32, NotificationType, Counter32, Bits, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "Gauge32", "NotificationType", "Counter64", "ObjectIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ModuleIdentity", "Unsigned32", "Integer32", "NotificationType", "Counter32", "Bits", "TimeTicks")
...
mibBuilder.exportSymbols("T3610-MIB", histTemp=histTemp, compVal=compVal, hum=hum, compValHighInt=compValHighInt, trapTest=trapTest, trapEmailErrDNS=trapEmailErrDNS, trapSOAPErrSocket=trapSOAPErrSocket, trapTempHighAlarm=trapTempHighAlarm, settings=settings, trapSOAPErrDelivery=trapSOAPErrDelivery, trapHumLowAlarm=trapHumLowAlarm, trapCompValLowAlarm=trapCompValLowAlarm, products=products, trapTempClrAlarm=trapTempClrAlarm, temp=temp, trapEmailErrLogin=trapEmailErrLogin, trapHumClrAlarm=trapHumClrAlarm, compValAlarm=compValAlarm, trapEmailErrSome=trapEmailErrSome, tempMax=tempMax, humAlarmInt=humAlarmInt, trapHumHighAlarm=trapHumHighAlarm, humLowInt=humLowInt, compValInt=compValInt, trapSOAPErrDNS=trapSOAPErrDNS, trapNTPError=trapNTPError, tempLowInt=tempLowInt, values=values, humHystInt=humHystInt, historyEntry=historyEntry, deviceType=deviceType, pysmi_global=pysmi_global, compValUnit=compValUnit, tempInt=tempInt, tables=tables, tempHystInt=tempHystInt, historyTable=historyTable, DisplayString=DisplayString, trapEmailErrSocket=trapEmailErrSocket, histHum=histHum, tempAlarm=tempAlarm, humDelayInt=humDelayInt, tempAlarmInt=tempAlarmInt, histCompVal=histCompVal, traps=traps, comet=comet, compValMax=compValMax, tempMin=tempMin, tempDelayInt=tempDelayInt, t3610=t3610, compValMin=compValMin, trapEmailErrAuth=trapEmailErrAuth, compValAlarmInt=compValAlarmInt, trapSOAPErrFile=trapSOAPErrFile, trapCompValHighAlarm=trapCompValHighAlarm, trapTempLowAlarm=trapTempLowAlarm, valuesInt=valuesInt, humAlarm=humAlarm, serialNumber=serialNumber, compValHystInt=compValHystInt, humHighInt=humHighInt, tempUnit=tempUnit, compValLowInt=compValLowInt, trapCompValClrAlarm=trapCompValClrAlarm, sensorName=sensorName, trapCompValError=trapCompValError, humMax=humMax, humInt=humInt, tempHighInt=tempHighInt, trapHumError=trapHumError, humMin=humMin, humUnit=humUnit, compValDelayInt=compValDelayInt, messageString=messageString, trapTempError=trapTempError)
