...
NotificationType, TimeTicks, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Gauge32, Unsigned32, ObjectIdentity, MibIdentifier, NotificationType, iso, Integer32, ModuleIdentity, Counter32, enterprises, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Gauge32", "Unsigned32", "ObjectIdentity", "MibIdentifier", "NotificationType", "iso", "Integer32", "ModuleIdentity", "Counter32", "enterprises", "IpAddress")
...
mibBuilder.exportSymbols("T3610-MIB", pysmi_global=pysmi_global, compValMin=compValMin, tempMax=tempMax, trapSOAPErrDNS=trapSOAPErrDNS, trapSOAPErrFile=trapSOAPErrFile, compValAlarm=compValAlarm, tables=tables, humMin=humMin, DisplayString=DisplayString, compValHystInt=compValHystInt, trapTest=trapTest, humLowInt=humLowInt, humHighInt=humHighInt, trapSOAPErrSocket=trapSOAPErrSocket, products=products, trapHumError=trapHumError, compValLowInt=compValLowInt, trapCompValHighAlarm=trapCompValHighAlarm, trapHumClrAlarm=trapHumClrAlarm, compValHighInt=compValHighInt, historyTable=historyTable, hum=hum, compValInt=compValInt, trapHumHighAlarm=trapHumHighAlarm, histCompVal=histCompVal, values=values, histTemp=histTemp, traps=traps, trapCompValClrAlarm=trapCompValClrAlarm, messageString=messageString, tempUnit=tempUnit, trapHumLowAlarm=trapHumLowAlarm, tempHystInt=tempHystInt, trapTempClrAlarm=trapTempClrAlarm, trapEmailErrLogin=trapEmailErrLogin, trapTempLowAlarm=trapTempLowAlarm, compValDelayInt=compValDelayInt, trapTempHighAlarm=trapTempHighAlarm, tempInt=tempInt, humHystInt=humHystInt, trapSOAPErrDelivery=trapSOAPErrDelivery, compValMax=compValMax, deviceType=deviceType, tempHighInt=tempHighInt, temp=temp, tempLowInt=tempLowInt, trapEmailErrAuth=trapEmailErrAuth, tempAlarmInt=tempAlarmInt, t3610=t3610, histHum=histHum, humUnit=humUnit, comet=comet, historyEntry=historyEntry, trapEmailErrSome=trapEmailErrSome, compValAlarmInt=compValAlarmInt, humInt=humInt, serialNumber=serialNumber, tempMin=tempMin, valuesInt=valuesInt, humMax=humMax, settings=settings, humDelayInt=humDelayInt, trapEmailErrDNS=trapEmailErrDNS, compVal=compVal, tempDelayInt=tempDelayInt, humAlarmInt=humAlarmInt, compValUnit=compValUnit, trapEmailErrSocket=trapEmailErrSocket, trapTempError=trapTempError, trapCompValError=trapCompValError, trapNTPError=trapNTPError, sensorName=sensorName, humAlarm=humAlarm, trapCompValLowAlarm=trapCompValLowAlarm, tempAlarm=tempAlarm)
