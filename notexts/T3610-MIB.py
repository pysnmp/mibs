...
Integer32, ObjectIdentity, enterprises, IpAddress, MibIdentifier, Counter64, iso, NotificationType, Counter32, ModuleIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "enterprises", "IpAddress", "MibIdentifier", "Counter64", "iso", "NotificationType", "Counter32", "ModuleIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", messageString=messageString, trapEmailErrLogin=trapEmailErrLogin, historyTable=historyTable, trapEmailErrSocket=trapEmailErrSocket, humMax=humMax, products=products, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValHighAlarm=trapCompValHighAlarm, trapCompValClrAlarm=trapCompValClrAlarm, trapCompValError=trapCompValError, trapSOAPErrDNS=trapSOAPErrDNS, trapSOAPErrDelivery=trapSOAPErrDelivery, humInt=humInt, humDelayInt=humDelayInt, trapNTPError=trapNTPError, trapHumHighAlarm=trapHumHighAlarm, histCompVal=histCompVal, settings=settings, hum=hum, compValLowInt=compValLowInt, trapTempLowAlarm=trapTempLowAlarm, trapTempHighAlarm=trapTempHighAlarm, humUnit=humUnit, trapHumLowAlarm=trapHumLowAlarm, trapTest=trapTest, humAlarmInt=humAlarmInt, tempAlarm=tempAlarm, tempLowInt=tempLowInt, trapEmailErrSome=trapEmailErrSome, historyEntry=historyEntry, trapTempClrAlarm=trapTempClrAlarm, compValUnit=compValUnit, pysmi_global=pysmi_global, humMin=humMin, serialNumber=serialNumber, compValHystInt=compValHystInt, compValAlarmInt=compValAlarmInt, trapSOAPErrFile=trapSOAPErrFile, histTemp=histTemp, tempAlarmInt=tempAlarmInt, compValDelayInt=compValDelayInt, tempHystInt=tempHystInt, tempUnit=tempUnit, trapHumClrAlarm=trapHumClrAlarm, trapCompValLowAlarm=trapCompValLowAlarm, trapEmailErrDNS=trapEmailErrDNS, values=values, tempMax=tempMax, tempMin=tempMin, tempDelayInt=tempDelayInt, deviceType=deviceType, comet=comet, traps=traps, tempHighInt=tempHighInt, trapHumError=trapHumError, DisplayString=DisplayString, compValAlarm=compValAlarm, t3610=t3610, temp=temp, humAlarm=humAlarm, valuesInt=valuesInt, trapEmailErrAuth=trapEmailErrAuth, sensorName=sensorName, humLowInt=humLowInt, compVal=compVal, tables=tables, compValMax=compValMax, humHystInt=humHystInt, histHum=histHum, compValMin=compValMin, compValHighInt=compValHighInt, humHighInt=humHighInt, trapTempError=trapTempError, tempInt=tempInt, compValInt=compValInt)
