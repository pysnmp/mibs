...
# Produced by pysmi-1.1.8 at Tue Feb  1 20:59:06 2022
...
Gauge32, TimeTicks, Integer32, NotificationType, ObjectIdentity, IpAddress, MibIdentifier, Unsigned32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Bits, Counter32, iso, enterprises, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "TimeTicks", "Integer32", "NotificationType", "ObjectIdentity", "IpAddress", "MibIdentifier", "Unsigned32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Bits", "Counter32", "iso", "enterprises", "Counter64")
...
mibBuilder.exportSymbols("T3610-MIB", sensorName=sensorName, tempHighInt=tempHighInt, humAlarm=humAlarm, trapSOAPErrFile=trapSOAPErrFile, humMin=humMin, compValUnit=compValUnit, tempInt=tempInt, tempUnit=tempUnit, humDelayInt=humDelayInt, tables=tables, compVal=compVal, trapHumHighAlarm=trapHumHighAlarm, trapCompValError=trapCompValError, hum=hum, humMax=humMax, deviceType=deviceType, compValMin=compValMin, comet=comet, humInt=humInt, DisplayString=DisplayString, humAlarmInt=humAlarmInt, tempHystInt=tempHystInt, compValHystInt=compValHystInt, trapSOAPErrSocket=trapSOAPErrSocket, trapHumLowAlarm=trapHumLowAlarm, trapCompValLowAlarm=trapCompValLowAlarm, tempDelayInt=tempDelayInt, histCompVal=histCompVal, trapCompValHighAlarm=trapCompValHighAlarm, trapNTPError=trapNTPError, humHighInt=humHighInt, trapEmailErrAuth=trapEmailErrAuth, histHum=histHum, values=values, compValAlarm=compValAlarm, compValHighInt=compValHighInt, humUnit=humUnit, tempMin=tempMin, pysmi_global=pysmi_global, humLowInt=humLowInt, trapTempHighAlarm=trapTempHighAlarm, trapHumClrAlarm=trapHumClrAlarm, temp=temp, compValInt=compValInt, trapEmailErrLogin=trapEmailErrLogin, trapTempClrAlarm=trapTempClrAlarm, valuesInt=valuesInt, traps=traps, compValLowInt=compValLowInt, trapEmailErrSocket=trapEmailErrSocket, t3610=t3610, historyEntry=historyEntry, compValMax=compValMax, messageString=messageString, serialNumber=serialNumber, trapHumError=trapHumError, humHystInt=humHystInt, settings=settings, products=products, historyTable=historyTable, trapEmailErrSome=trapEmailErrSome, tempAlarm=tempAlarm, tempLowInt=tempLowInt, compValDelayInt=compValDelayInt, trapEmailErrDNS=trapEmailErrDNS, trapSOAPErrDNS=trapSOAPErrDNS, trapTempLowAlarm=trapTempLowAlarm, tempMax=tempMax, trapTempError=trapTempError, histTemp=histTemp, compValAlarmInt=compValAlarmInt, tempAlarmInt=tempAlarmInt, trapTest=trapTest, trapSOAPErrDelivery=trapSOAPErrDelivery, trapCompValClrAlarm=trapCompValClrAlarm)
