...
# Produced by pysmi-1.1.12 at Tue May 28 13:56:16 2024
...
Counter32, Counter64, Unsigned32, MibIdentifier, iso, NotificationType, Bits, TimeTicks, Gauge32, ModuleIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ObjectIdentity, NotificationType, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "Unsigned32", "MibIdentifier", "iso", "NotificationType", "Bits", "TimeTicks", "Gauge32", "ModuleIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ObjectIdentity", "NotificationType", "enterprises")
...
mibBuilder.exportSymbols("T3610-MIB", compValHighInt=compValHighInt, tempDelayInt=tempDelayInt, trapEmailErrAuth=trapEmailErrAuth, compValUnit=compValUnit, tempInt=tempInt, trapSOAPErrDelivery=trapSOAPErrDelivery, tempHighInt=tempHighInt, tempHystInt=tempHystInt, historyEntry=historyEntry, trapHumLowAlarm=trapHumLowAlarm, trapTempError=trapTempError, sensorName=sensorName, compVal=compVal, pysmi_global=pysmi_global, trapEmailErrLogin=trapEmailErrLogin, historyTable=historyTable, serialNumber=serialNumber, t3610=t3610, compValDelayInt=compValDelayInt, humDelayInt=humDelayInt, trapTest=trapTest, trapCompValLowAlarm=trapCompValLowAlarm, trapCompValHighAlarm=trapCompValHighAlarm, compValMin=compValMin, tempAlarm=tempAlarm, traps=traps, settings=settings, DisplayString=DisplayString, hum=hum, humAlarm=humAlarm, tempLowInt=tempLowInt, values=values, trapHumError=trapHumError, tempUnit=tempUnit, deviceType=deviceType, compValAlarm=compValAlarm, trapSOAPErrFile=trapSOAPErrFile, trapNTPError=trapNTPError, tempAlarmInt=tempAlarmInt, compValLowInt=compValLowInt, products=products, valuesInt=valuesInt, humMax=humMax, compValMax=compValMax, compValAlarmInt=compValAlarmInt, humMin=humMin, humInt=humInt, histTemp=histTemp, humHighInt=humHighInt, tempMin=tempMin, humLowInt=humLowInt, temp=temp, compValHystInt=compValHystInt, trapEmailErrSocket=trapEmailErrSocket, humAlarmInt=humAlarmInt, trapCompValError=trapCompValError, comet=comet, messageString=messageString, compValInt=compValInt, histHum=histHum, trapEmailErrSome=trapEmailErrSome, trapSOAPErrSocket=trapSOAPErrSocket, trapHumHighAlarm=trapHumHighAlarm, trapTempLowAlarm=trapTempLowAlarm, trapTempClrAlarm=trapTempClrAlarm, trapCompValClrAlarm=trapCompValClrAlarm, trapHumClrAlarm=trapHumClrAlarm, humHystInt=humHystInt, tables=tables, humUnit=humUnit, trapSOAPErrDNS=trapSOAPErrDNS, trapTempHighAlarm=trapTempHighAlarm, trapEmailErrDNS=trapEmailErrDNS, tempMax=tempMax, histCompVal=histCompVal)
