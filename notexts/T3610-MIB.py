...
# Produced by pysmi-1.1.12 at Mon Jun  3 13:59:53 2024
...
enterprises, NotificationType, NotificationType, Counter32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32, ModuleIdentity, ObjectIdentity, iso, Unsigned32, TimeTicks, IpAddress, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "NotificationType", "NotificationType", "Counter32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32", "ModuleIdentity", "ObjectIdentity", "iso", "Unsigned32", "TimeTicks", "IpAddress", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("T3610-MIB", tempLowInt=tempLowInt, tempHystInt=tempHystInt, historyEntry=historyEntry, tempAlarmInt=tempAlarmInt, settings=settings, compValHighInt=compValHighInt, trapSOAPErrDNS=trapSOAPErrDNS, trapTempError=trapTempError, comet=comet, sensorName=sensorName, humHystInt=humHystInt, trapSOAPErrSocket=trapSOAPErrSocket, humMax=humMax, compValAlarmInt=compValAlarmInt, trapHumError=trapHumError, tempInt=tempInt, compValMin=compValMin, tempAlarm=tempAlarm, hum=hum, trapTempLowAlarm=trapTempLowAlarm, compValInt=compValInt, compValLowInt=compValLowInt, tempMax=tempMax, trapEmailErrLogin=trapEmailErrLogin, trapEmailErrAuth=trapEmailErrAuth, trapEmailErrSome=trapEmailErrSome, trapEmailErrSocket=trapEmailErrSocket, trapTempClrAlarm=trapTempClrAlarm, values=values, compValMax=compValMax, tempHighInt=tempHighInt, humUnit=humUnit, tempMin=tempMin, compValAlarm=compValAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, compValUnit=compValUnit, valuesInt=valuesInt, tempUnit=tempUnit, tables=tables, trapHumClrAlarm=trapHumClrAlarm, humLowInt=humLowInt, humDelayInt=humDelayInt, serialNumber=serialNumber, compValHystInt=compValHystInt, messageString=messageString, compVal=compVal, histTemp=histTemp, trapCompValError=trapCompValError, traps=traps, trapTest=trapTest, humHighInt=humHighInt, histHum=histHum, trapEmailErrDNS=trapEmailErrDNS, trapHumHighAlarm=trapHumHighAlarm, trapTempHighAlarm=trapTempHighAlarm, temp=temp, humMin=humMin, humAlarmInt=humAlarmInt, tempDelayInt=tempDelayInt, humInt=humInt, trapCompValHighAlarm=trapCompValHighAlarm, trapCompValClrAlarm=trapCompValClrAlarm, compValDelayInt=compValDelayInt, DisplayString=DisplayString, histCompVal=histCompVal, humAlarm=humAlarm, trapSOAPErrFile=trapSOAPErrFile, t3610=t3610, trapHumLowAlarm=trapHumLowAlarm, pysmi_global=pysmi_global, trapCompValLowAlarm=trapCompValLowAlarm, historyTable=historyTable, deviceType=deviceType, trapNTPError=trapNTPError, products=products)
