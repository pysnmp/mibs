...
# Produced by pysmi-1.1.3 at Sun Nov 28 16:44:59 2021
...
NotificationType, TimeTicks, ModuleIdentity, NotificationType, Integer32, Unsigned32, Counter32, Gauge32, iso, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, MibIdentifier, enterprises, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "ModuleIdentity", "NotificationType", "Integer32", "Unsigned32", "Counter32", "Gauge32", "iso", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "MibIdentifier", "enterprises", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", trapTempError=trapTempError, valuesInt=valuesInt, compValInt=compValInt, trapTest=trapTest, humLowInt=humLowInt, histHum=histHum, humInt=humInt, deviceType=deviceType, humHystInt=humHystInt, traps=traps, compValMin=compValMin, trapEmailErrAuth=trapEmailErrAuth, trapCompValClrAlarm=trapCompValClrAlarm, trapHumError=trapHumError, tempMin=tempMin, trapEmailErrSocket=trapEmailErrSocket, tempUnit=tempUnit, trapHumLowAlarm=trapHumLowAlarm, comet=comet, tempAlarmInt=tempAlarmInt, DisplayString=DisplayString, compValAlarm=compValAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, compValDelayInt=compValDelayInt, tempAlarm=tempAlarm, trapEmailErrDNS=trapEmailErrDNS, tempInt=tempInt, trapHumClrAlarm=trapHumClrAlarm, trapTempLowAlarm=trapTempLowAlarm, compVal=compVal, trapSOAPErrSocket=trapSOAPErrSocket, humMin=humMin, humAlarm=humAlarm, tempDelayInt=tempDelayInt, temp=temp, compValHystInt=compValHystInt, trapSOAPErrFile=trapSOAPErrFile, t3610=t3610, products=products, tempLowInt=tempLowInt, compValHighInt=compValHighInt, trapTempHighAlarm=trapTempHighAlarm, tempMax=tempMax, pysmi_global=pysmi_global, trapEmailErrLogin=trapEmailErrLogin, trapTempClrAlarm=trapTempClrAlarm, trapNTPError=trapNTPError, trapSOAPErrDNS=trapSOAPErrDNS, tables=tables, compValUnit=compValUnit, compValLowInt=compValLowInt, historyTable=historyTable, trapEmailErrSome=trapEmailErrSome, humMax=humMax, tempHystInt=tempHystInt, values=values, trapHumHighAlarm=trapHumHighAlarm, trapCompValError=trapCompValError, compValMax=compValMax, compValAlarmInt=compValAlarmInt, histTemp=histTemp, histCompVal=histCompVal, trapCompValHighAlarm=trapCompValHighAlarm, sensorName=sensorName, humAlarmInt=humAlarmInt, tempHighInt=tempHighInt, humUnit=humUnit, messageString=messageString, historyEntry=historyEntry, humDelayInt=humDelayInt, trapCompValLowAlarm=trapCompValLowAlarm, humHighInt=humHighInt, hum=hum, settings=settings, serialNumber=serialNumber)
