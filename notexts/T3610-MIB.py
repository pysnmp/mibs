...
# Produced by pysmi-1.1.8 at Mon Sep 19 08:00:49 2022
...
Counter32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Unsigned32, NotificationType, Bits, Integer32, TimeTicks, MibIdentifier, ModuleIdentity, iso, NotificationType, Counter64, enterprises, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Unsigned32", "NotificationType", "Bits", "Integer32", "TimeTicks", "MibIdentifier", "ModuleIdentity", "iso", "NotificationType", "Counter64", "enterprises", "IpAddress")
...
mibBuilder.exportSymbols("T3610-MIB", pysmi_global=pysmi_global, humMax=humMax, humInt=humInt, compValUnit=compValUnit, tempAlarmInt=tempAlarmInt, historyEntry=historyEntry, serialNumber=serialNumber, compValHighInt=compValHighInt, humLowInt=humLowInt, histTemp=histTemp, compValLowInt=compValLowInt, trapEmailErrAuth=trapEmailErrAuth, trapCompValHighAlarm=trapCompValHighAlarm, trapEmailErrDNS=trapEmailErrDNS, trapHumHighAlarm=trapHumHighAlarm, products=products, trapTempLowAlarm=trapTempLowAlarm, t3610=t3610, valuesInt=valuesInt, trapSOAPErrDelivery=trapSOAPErrDelivery, compValHystInt=compValHystInt, messageString=messageString, compValAlarm=compValAlarm, humDelayInt=humDelayInt, trapHumError=trapHumError, tempMin=tempMin, histCompVal=histCompVal, sensorName=sensorName, trapEmailErrLogin=trapEmailErrLogin, trapCompValClrAlarm=trapCompValClrAlarm, tempAlarm=tempAlarm, humAlarm=humAlarm, tempMax=tempMax, deviceType=deviceType, trapNTPError=trapNTPError, temp=temp, trapTempHighAlarm=trapTempHighAlarm, compValInt=compValInt, trapTempClrAlarm=trapTempClrAlarm, tempUnit=tempUnit, trapSOAPErrFile=trapSOAPErrFile, values=values, trapHumClrAlarm=trapHumClrAlarm, traps=traps, tempDelayInt=tempDelayInt, histHum=histHum, trapTest=trapTest, hum=hum, humMin=humMin, trapSOAPErrSocket=trapSOAPErrSocket, trapSOAPErrDNS=trapSOAPErrDNS, tables=tables, humAlarmInt=humAlarmInt, compValAlarmInt=compValAlarmInt, tempHystInt=tempHystInt, trapTempError=trapTempError, historyTable=historyTable, humUnit=humUnit, compValDelayInt=compValDelayInt, settings=settings, humHighInt=humHighInt, tempLowInt=tempLowInt, trapHumLowAlarm=trapHumLowAlarm, trapEmailErrSome=trapEmailErrSome, humHystInt=humHystInt, compVal=compVal, trapCompValLowAlarm=trapCompValLowAlarm, trapCompValError=trapCompValError, DisplayString=DisplayString, compValMax=compValMax, tempInt=tempInt, trapEmailErrSocket=trapEmailErrSocket, comet=comet, tempHighInt=tempHighInt, compValMin=compValMin)
