...
# Produced by pysmi-1.1.10 at Fri Nov 10 08:41:46 2023
...
Counter32, Bits, Integer32, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, TimeTicks, IpAddress, iso, NotificationType, enterprises, MibIdentifier, ObjectIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Bits", "Integer32", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "TimeTicks", "IpAddress", "iso", "NotificationType", "enterprises", "MibIdentifier", "ObjectIdentity", "Gauge32")
...
mibBuilder.exportSymbols("T3610-MIB", trapTest=trapTest, trapEmailErrDNS=trapEmailErrDNS, humUnit=humUnit, trapHumLowAlarm=trapHumLowAlarm, serialNumber=serialNumber, trapCompValHighAlarm=trapCompValHighAlarm, temp=temp, t3610=t3610, humMin=humMin, tempMax=tempMax, compValAlarmInt=compValAlarmInt, histCompVal=histCompVal, trapEmailErrLogin=trapEmailErrLogin, trapSOAPErrDelivery=trapSOAPErrDelivery, trapNTPError=trapNTPError, compValUnit=compValUnit, humHystInt=humHystInt, values=values, histTemp=histTemp, compValHystInt=compValHystInt, tempHystInt=tempHystInt, tables=tables, tempLowInt=tempLowInt, tempInt=tempInt, humLowInt=humLowInt, compValAlarm=compValAlarm, trapSOAPErrFile=trapSOAPErrFile, traps=traps, sensorName=sensorName, trapCompValError=trapCompValError, histHum=histHum, trapTempError=trapTempError, deviceType=deviceType, compValMin=compValMin, products=products, humInt=humInt, compValHighInt=compValHighInt, humDelayInt=humDelayInt, compValDelayInt=compValDelayInt, messageString=messageString, historyTable=historyTable, historyEntry=historyEntry, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrSocket=trapSOAPErrSocket, trapEmailErrSome=trapEmailErrSome, tempAlarmInt=tempAlarmInt, humHighInt=humHighInt, humMax=humMax, DisplayString=DisplayString, humAlarmInt=humAlarmInt, trapCompValClrAlarm=trapCompValClrAlarm, trapHumError=trapHumError, trapSOAPErrDNS=trapSOAPErrDNS, comet=comet, trapEmailErrAuth=trapEmailErrAuth, tempAlarm=tempAlarm, pysmi_global=pysmi_global, compVal=compVal, compValLowInt=compValLowInt, trapTempClrAlarm=trapTempClrAlarm, compValMax=compValMax, compValInt=compValInt, trapTempLowAlarm=trapTempLowAlarm, settings=settings, trapCompValLowAlarm=trapCompValLowAlarm, tempUnit=tempUnit, tempHighInt=tempHighInt, trapHumClrAlarm=trapHumClrAlarm, valuesInt=valuesInt, tempMin=tempMin, trapHumHighAlarm=trapHumHighAlarm, humAlarm=humAlarm, hum=hum, trapTempHighAlarm=trapTempHighAlarm, tempDelayInt=tempDelayInt)
