...
# Produced by pysmi-1.1.8 at Wed Sep 13 12:46:57 2023
...
Bits, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, NotificationType, Unsigned32, enterprises, MibIdentifier, ModuleIdentity, Counter64, IpAddress, TimeTicks, Integer32, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "NotificationType", "Unsigned32", "enterprises", "MibIdentifier", "ModuleIdentity", "Counter64", "IpAddress", "TimeTicks", "Integer32", "Counter32", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", trapEmailErrSome=trapEmailErrSome, trapEmailErrAuth=trapEmailErrAuth, trapTempError=trapTempError, comet=comet, compValMax=compValMax, compValAlarmInt=compValAlarmInt, compVal=compVal, humMax=humMax, compValDelayInt=compValDelayInt, trapHumClrAlarm=trapHumClrAlarm, serialNumber=serialNumber, trapNTPError=trapNTPError, tempUnit=tempUnit, compValInt=compValInt, trapTest=trapTest, trapSOAPErrFile=trapSOAPErrFile, tempHighInt=tempHighInt, compValHighInt=compValHighInt, histTemp=histTemp, settings=settings, messageString=messageString, compValUnit=compValUnit, humDelayInt=humDelayInt, tempHystInt=tempHystInt, trapHumHighAlarm=trapHumHighAlarm, tables=tables, trapTempClrAlarm=trapTempClrAlarm, hum=hum, compValMin=compValMin, historyTable=historyTable, t3610=t3610, trapSOAPErrDelivery=trapSOAPErrDelivery, historyEntry=historyEntry, tempLowInt=tempLowInt, tempMax=tempMax, histCompVal=histCompVal, tempDelayInt=tempDelayInt, trapHumError=trapHumError, products=products, temp=temp, tempAlarmInt=tempAlarmInt, trapEmailErrSocket=trapEmailErrSocket, trapCompValClrAlarm=trapCompValClrAlarm, humAlarm=humAlarm, tempMin=tempMin, sensorName=sensorName, DisplayString=DisplayString, valuesInt=valuesInt, values=values, tempAlarm=tempAlarm, humMin=humMin, deviceType=deviceType, tempInt=tempInt, humHystInt=humHystInt, trapTempLowAlarm=trapTempLowAlarm, trapHumLowAlarm=trapHumLowAlarm, trapCompValError=trapCompValError, humHighInt=humHighInt, humUnit=humUnit, compValLowInt=compValLowInt, trapTempHighAlarm=trapTempHighAlarm, trapCompValHighAlarm=trapCompValHighAlarm, trapSOAPErrSocket=trapSOAPErrSocket, trapEmailErrLogin=trapEmailErrLogin, trapEmailErrDNS=trapEmailErrDNS, compValHystInt=compValHystInt, trapSOAPErrDNS=trapSOAPErrDNS, humLowInt=humLowInt, trapCompValLowAlarm=trapCompValLowAlarm, compValAlarm=compValAlarm, traps=traps, humAlarmInt=humAlarmInt, pysmi_global=pysmi_global, humInt=humInt, histHum=histHum)
