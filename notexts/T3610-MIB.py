...
# Produced by pysmi-1.1.12 at Mon Jul  1 09:10:51 2024
...
MibIdentifier, NotificationType, NotificationType, iso, Integer32, Gauge32, TimeTicks, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, ObjectIdentity, Unsigned32, Counter64, IpAddress, Counter32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "NotificationType", "iso", "Integer32", "Gauge32", "TimeTicks", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "ObjectIdentity", "Unsigned32", "Counter64", "IpAddress", "Counter32", "ModuleIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", trapEmailErrSocket=trapEmailErrSocket, humHystInt=humHystInt, tempAlarm=tempAlarm, humAlarm=humAlarm, valuesInt=valuesInt, hum=hum, humHighInt=humHighInt, tables=tables, comet=comet, compValDelayInt=compValDelayInt, messageString=messageString, historyEntry=historyEntry, histCompVal=histCompVal, trapHumLowAlarm=trapHumLowAlarm, tempMin=tempMin, compValHystInt=compValHystInt, trapEmailErrSome=trapEmailErrSome, trapTempHighAlarm=trapTempHighAlarm, settings=settings, trapSOAPErrFile=trapSOAPErrFile, histHum=histHum, trapHumHighAlarm=trapHumHighAlarm, trapTest=trapTest, traps=traps, trapTempLowAlarm=trapTempLowAlarm, tempUnit=tempUnit, compValHighInt=compValHighInt, compValUnit=compValUnit, compValMax=compValMax, pysmi_global=pysmi_global, trapTempError=trapTempError, trapSOAPErrSocket=trapSOAPErrSocket, histTemp=histTemp, humUnit=humUnit, tempHystInt=tempHystInt, trapHumClrAlarm=trapHumClrAlarm, humInt=humInt, tempHighInt=tempHighInt, trapSOAPErrDNS=trapSOAPErrDNS, trapEmailErrAuth=trapEmailErrAuth, trapNTPError=trapNTPError, humMax=humMax, compValAlarmInt=compValAlarmInt, trapCompValHighAlarm=trapCompValHighAlarm, trapCompValClrAlarm=trapCompValClrAlarm, tempLowInt=tempLowInt, products=products, DisplayString=DisplayString, tempInt=tempInt, values=values, compValInt=compValInt, compValAlarm=compValAlarm, sensorName=sensorName, compValLowInt=compValLowInt, humDelayInt=humDelayInt, historyTable=historyTable, trapCompValLowAlarm=trapCompValLowAlarm, trapHumError=trapHumError, humMin=humMin, trapSOAPErrDelivery=trapSOAPErrDelivery, tempMax=tempMax, trapEmailErrDNS=trapEmailErrDNS, trapTempClrAlarm=trapTempClrAlarm, deviceType=deviceType, tempDelayInt=tempDelayInt, humAlarmInt=humAlarmInt, serialNumber=serialNumber, trapEmailErrLogin=trapEmailErrLogin, temp=temp, tempAlarmInt=tempAlarmInt, compValMin=compValMin, trapCompValError=trapCompValError, t3610=t3610, humLowInt=humLowInt, compVal=compVal)
