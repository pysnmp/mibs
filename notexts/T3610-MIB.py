...
# Produced by pysmi-1.1.8 at Mon Jan 17 18:43:59 2022
...
Bits, Unsigned32, NotificationType, NotificationType, Gauge32, IpAddress, Counter64, ModuleIdentity, MibIdentifier, TimeTicks, Integer32, iso, Counter32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Unsigned32", "NotificationType", "NotificationType", "Gauge32", "IpAddress", "Counter64", "ModuleIdentity", "MibIdentifier", "TimeTicks", "Integer32", "iso", "Counter32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", trapTest=trapTest, tempAlarm=tempAlarm, products=products, humInt=humInt, messageString=messageString, humHighInt=humHighInt, t3610=t3610, trapHumLowAlarm=trapHumLowAlarm, humUnit=humUnit, DisplayString=DisplayString, compValInt=compValInt, trapTempClrAlarm=trapTempClrAlarm, trapTempHighAlarm=trapTempHighAlarm, trapHumClrAlarm=trapHumClrAlarm, trapSOAPErrFile=trapSOAPErrFile, trapEmailErrSome=trapEmailErrSome, compValHystInt=compValHystInt, trapTempError=trapTempError, traps=traps, trapEmailErrSocket=trapEmailErrSocket, settings=settings, trapEmailErrAuth=trapEmailErrAuth, tempHystInt=tempHystInt, histHum=histHum, deviceType=deviceType, sensorName=sensorName, temp=temp, trapCompValClrAlarm=trapCompValClrAlarm, trapNTPError=trapNTPError, valuesInt=valuesInt, values=values, tempMax=tempMax, tempAlarmInt=tempAlarmInt, humAlarmInt=humAlarmInt, humLowInt=humLowInt, compValMin=compValMin, compValAlarmInt=compValAlarmInt, histTemp=histTemp, tempInt=tempInt, trapHumError=trapHumError, compValUnit=compValUnit, trapEmailErrLogin=trapEmailErrLogin, historyEntry=historyEntry, trapHumHighAlarm=trapHumHighAlarm, compValAlarm=compValAlarm, trapSOAPErrSocket=trapSOAPErrSocket, tempUnit=tempUnit, tempHighInt=tempHighInt, humAlarm=humAlarm, humDelayInt=humDelayInt, compVal=compVal, trapSOAPErrDelivery=trapSOAPErrDelivery, trapCompValHighAlarm=trapCompValHighAlarm, compValHighInt=compValHighInt, trapCompValError=trapCompValError, humMin=humMin, tempMin=tempMin, compValMax=compValMax, trapEmailErrDNS=trapEmailErrDNS, humMax=humMax, compValDelayInt=compValDelayInt, tempDelayInt=tempDelayInt, serialNumber=serialNumber, trapTempLowAlarm=trapTempLowAlarm, tables=tables, trapSOAPErrDNS=trapSOAPErrDNS, historyTable=historyTable, comet=comet, tempLowInt=tempLowInt, histCompVal=histCompVal, trapCompValLowAlarm=trapCompValLowAlarm, compValLowInt=compValLowInt, humHystInt=humHystInt, pysmi_global=pysmi_global, hum=hum)
