...
# Produced by pysmi-1.1.10 at Mon Dec 11 02:35:09 2023
...
Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, MibIdentifier, ModuleIdentity, enterprises, NotificationType, TimeTicks, ObjectIdentity, Unsigned32, NotificationType, Counter64, iso, Counter32, Integer32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "MibIdentifier", "ModuleIdentity", "enterprises", "NotificationType", "TimeTicks", "ObjectIdentity", "Unsigned32", "NotificationType", "Counter64", "iso", "Counter32", "Integer32", "IpAddress")
...
mibBuilder.exportSymbols("T3610-MIB", histTemp=histTemp, humLowInt=humLowInt, trapHumLowAlarm=trapHumLowAlarm, tables=tables, trapHumClrAlarm=trapHumClrAlarm, humInt=humInt, humUnit=humUnit, compValHystInt=compValHystInt, compValUnit=compValUnit, historyTable=historyTable, compValMin=compValMin, trapCompValError=trapCompValError, humMax=humMax, trapEmailErrSome=trapEmailErrSome, products=products, trapCompValLowAlarm=trapCompValLowAlarm, trapSOAPErrDNS=trapSOAPErrDNS, messageString=messageString, humDelayInt=humDelayInt, comet=comet, trapCompValClrAlarm=trapCompValClrAlarm, compValMax=compValMax, serialNumber=serialNumber, humHystInt=humHystInt, trapSOAPErrFile=trapSOAPErrFile, deviceType=deviceType, trapTest=trapTest, trapSOAPErrDelivery=trapSOAPErrDelivery, compValAlarmInt=compValAlarmInt, trapNTPError=trapNTPError, hum=hum, trapSOAPErrSocket=trapSOAPErrSocket, tempMax=tempMax, traps=traps, tempAlarmInt=tempAlarmInt, trapTempClrAlarm=trapTempClrAlarm, compValInt=compValInt, trapEmailErrDNS=trapEmailErrDNS, pysmi_global=pysmi_global, histHum=histHum, humHighInt=humHighInt, temp=temp, t3610=t3610, tempDelayInt=tempDelayInt, compValHighInt=compValHighInt, trapTempLowAlarm=trapTempLowAlarm, trapTempError=trapTempError, compValAlarm=compValAlarm, compValLowInt=compValLowInt, compVal=compVal, trapHumError=trapHumError, compValDelayInt=compValDelayInt, trapCompValHighAlarm=trapCompValHighAlarm, tempMin=tempMin, historyEntry=historyEntry, humAlarm=humAlarm, tempInt=tempInt, histCompVal=histCompVal, sensorName=sensorName, tempHighInt=tempHighInt, tempAlarm=tempAlarm, settings=settings, trapEmailErrSocket=trapEmailErrSocket, valuesInt=valuesInt, trapHumHighAlarm=trapHumHighAlarm, tempUnit=tempUnit, trapTempHighAlarm=trapTempHighAlarm, trapEmailErrAuth=trapEmailErrAuth, trapEmailErrLogin=trapEmailErrLogin, humAlarmInt=humAlarmInt, humMin=humMin, tempLowInt=tempLowInt, DisplayString=DisplayString, tempHystInt=tempHystInt, values=values)
