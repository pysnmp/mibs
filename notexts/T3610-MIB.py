...
# Produced by pysmi-1.1.3 at Wed Dec  8 18:39:06 2021
...
enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Integer32, Counter32, NotificationType, ModuleIdentity, ObjectIdentity, Bits, MibIdentifier, IpAddress, TimeTicks, Unsigned32, Gauge32, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Integer32", "Counter32", "NotificationType", "ModuleIdentity", "ObjectIdentity", "Bits", "MibIdentifier", "IpAddress", "TimeTicks", "Unsigned32", "Gauge32", "iso", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", trapTempHighAlarm=trapTempHighAlarm, tempHystInt=tempHystInt, tempHighInt=tempHighInt, histTemp=histTemp, messageString=messageString, historyEntry=historyEntry, trapTest=trapTest, humMax=humMax, humHighInt=humHighInt, tempMin=tempMin, humAlarmInt=humAlarmInt, trapCompValLowAlarm=trapCompValLowAlarm, humLowInt=humLowInt, trapTempError=trapTempError, hum=hum, trapSOAPErrDNS=trapSOAPErrDNS, compValUnit=compValUnit, sensorName=sensorName, compValAlarm=compValAlarm, trapEmailErrSocket=trapEmailErrSocket, compValMin=compValMin, tempInt=tempInt, trapSOAPErrSocket=trapSOAPErrSocket, humDelayInt=humDelayInt, trapEmailErrAuth=trapEmailErrAuth, t3610=t3610, trapSOAPErrDelivery=trapSOAPErrDelivery, temp=temp, trapEmailErrSome=trapEmailErrSome, trapCompValClrAlarm=trapCompValClrAlarm, humAlarm=humAlarm, trapEmailErrDNS=trapEmailErrDNS, deviceType=deviceType, settings=settings, tempAlarmInt=tempAlarmInt, compValAlarmInt=compValAlarmInt, tempAlarm=tempAlarm, compValHystInt=compValHystInt, humMin=humMin, products=products, tempLowInt=tempLowInt, values=values, trapSOAPErrFile=trapSOAPErrFile, humHystInt=humHystInt, DisplayString=DisplayString, histCompVal=histCompVal, compVal=compVal, traps=traps, histHum=histHum, humUnit=humUnit, compValMax=compValMax, tempUnit=tempUnit, trapTempClrAlarm=trapTempClrAlarm, trapHumClrAlarm=trapHumClrAlarm, tempMax=tempMax, trapHumError=trapHumError, compValHighInt=compValHighInt, tempDelayInt=tempDelayInt, pysmi_global=pysmi_global, trapCompValError=trapCompValError, comet=comet, serialNumber=serialNumber, humInt=humInt, compValDelayInt=compValDelayInt, trapHumHighAlarm=trapHumHighAlarm, tables=tables, trapEmailErrLogin=trapEmailErrLogin, trapTempLowAlarm=trapTempLowAlarm, trapNTPError=trapNTPError, compValLowInt=compValLowInt, trapHumLowAlarm=trapHumLowAlarm, trapCompValHighAlarm=trapCompValHighAlarm, valuesInt=valuesInt, historyTable=historyTable, compValInt=compValInt)
