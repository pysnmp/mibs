...
# Produced by pysmi-1.1.8 at Fri Dec  2 17:02:40 2022
...
iso, Bits, Counter32, enterprises, Integer32, Counter64, Unsigned32, ObjectIdentity, TimeTicks, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, ModuleIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "Counter32", "enterprises", "Integer32", "Counter64", "Unsigned32", "ObjectIdentity", "TimeTicks", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "ModuleIdentity", "Gauge32")
...
mibBuilder.exportSymbols("T3610-MIB", tempHystInt=tempHystInt, trapTempHighAlarm=trapTempHighAlarm, serialNumber=serialNumber, humMax=humMax, humLowInt=humLowInt, trapCompValHighAlarm=trapCompValHighAlarm, tempMax=tempMax, trapTest=trapTest, tempDelayInt=tempDelayInt, trapHumClrAlarm=trapHumClrAlarm, trapEmailErrAuth=trapEmailErrAuth, valuesInt=valuesInt, trapHumError=trapHumError, sensorName=sensorName, trapSOAPErrDelivery=trapSOAPErrDelivery, histCompVal=histCompVal, compValUnit=compValUnit, trapCompValError=trapCompValError, humInt=humInt, historyEntry=historyEntry, products=products, trapTempLowAlarm=trapTempLowAlarm, compValAlarmInt=compValAlarmInt, trapSOAPErrSocket=trapSOAPErrSocket, compValInt=compValInt, trapEmailErrSocket=trapEmailErrSocket, compVal=compVal, compValHystInt=compValHystInt, tempInt=tempInt, tempAlarmInt=tempAlarmInt, histTemp=histTemp, compValMax=compValMax, trapNTPError=trapNTPError, tempAlarm=tempAlarm, humMin=humMin, tables=tables, compValAlarm=compValAlarm, tempLowInt=tempLowInt, compValMin=compValMin, trapCompValClrAlarm=trapCompValClrAlarm, tempHighInt=tempHighInt, humHighInt=humHighInt, trapCompValLowAlarm=trapCompValLowAlarm, trapHumHighAlarm=trapHumHighAlarm, trapEmailErrLogin=trapEmailErrLogin, comet=comet, values=values, pysmi_global=pysmi_global, tempUnit=tempUnit, tempMin=tempMin, compValHighInt=compValHighInt, trapEmailErrDNS=trapEmailErrDNS, trapTempError=trapTempError, humAlarmInt=humAlarmInt, histHum=histHum, deviceType=deviceType, humUnit=humUnit, traps=traps, trapTempClrAlarm=trapTempClrAlarm, compValDelayInt=compValDelayInt, humHystInt=humHystInt, trapSOAPErrFile=trapSOAPErrFile, humAlarm=humAlarm, settings=settings, DisplayString=DisplayString, temp=temp, historyTable=historyTable, trapHumLowAlarm=trapHumLowAlarm, messageString=messageString, humDelayInt=humDelayInt, hum=hum, t3610=t3610, trapEmailErrSome=trapEmailErrSome, compValLowInt=compValLowInt, trapSOAPErrDNS=trapSOAPErrDNS)
