...
# Produced by pysmi-1.1.8 at Mon Jan 16 15:00:56 2023
...
TimeTicks, Counter32, enterprises, Gauge32, MibIdentifier, ModuleIdentity, NotificationType, ObjectIdentity, Integer32, Bits, iso, NotificationType, Counter64, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "enterprises", "Gauge32", "MibIdentifier", "ModuleIdentity", "NotificationType", "ObjectIdentity", "Integer32", "Bits", "iso", "NotificationType", "Counter64", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("T3610-MIB", trapHumClrAlarm=trapHumClrAlarm, comet=comet, humInt=humInt, humLowInt=humLowInt, trapCompValError=trapCompValError, tempAlarm=tempAlarm, compValDelayInt=compValDelayInt, compValHighInt=compValHighInt, compValAlarmInt=compValAlarmInt, compValInt=compValInt, tempMax=tempMax, tempLowInt=tempLowInt, temp=temp, tables=tables, trapTempLowAlarm=trapTempLowAlarm, hum=hum, humAlarm=humAlarm, histHum=histHum, trapCompValLowAlarm=trapCompValLowAlarm, trapEmailErrAuth=trapEmailErrAuth, humHighInt=humHighInt, sensorName=sensorName, trapEmailErrLogin=trapEmailErrLogin, settings=settings, products=products, compValUnit=compValUnit, trapCompValClrAlarm=trapCompValClrAlarm, tempUnit=tempUnit, humDelayInt=humDelayInt, messageString=messageString, humHystInt=humHystInt, compValAlarm=compValAlarm, tempMin=tempMin, values=values, deviceType=deviceType, trapEmailErrSocket=trapEmailErrSocket, compValLowInt=compValLowInt, trapHumLowAlarm=trapHumLowAlarm, tempInt=tempInt, trapTempHighAlarm=trapTempHighAlarm, t3610=t3610, traps=traps, humAlarmInt=humAlarmInt, trapSOAPErrFile=trapSOAPErrFile, humMin=humMin, valuesInt=valuesInt, compValMax=compValMax, trapHumHighAlarm=trapHumHighAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, DisplayString=DisplayString, historyTable=historyTable, histCompVal=histCompVal, compValMin=compValMin, trapNTPError=trapNTPError, serialNumber=serialNumber, trapTest=trapTest, pysmi_global=pysmi_global, trapEmailErrDNS=trapEmailErrDNS, humMax=humMax, trapSOAPErrDNS=trapSOAPErrDNS, trapSOAPErrSocket=trapSOAPErrSocket, trapTempClrAlarm=trapTempClrAlarm, compValHystInt=compValHystInt, tempAlarmInt=tempAlarmInt, tempHystInt=tempHystInt, compVal=compVal, tempDelayInt=tempDelayInt, trapEmailErrSome=trapEmailErrSome, tempHighInt=tempHighInt, trapCompValHighAlarm=trapCompValHighAlarm, trapTempError=trapTempError, historyEntry=historyEntry, humUnit=humUnit, trapHumError=trapHumError, histTemp=histTemp)
