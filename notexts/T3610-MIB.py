...
# Produced by pysmi-1.1.8 at Fri Jan  7 16:00:56 2022
...
iso, NotificationType, Unsigned32, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, enterprises, ObjectIdentity, Bits, Counter64, Gauge32, ModuleIdentity, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "Unsigned32", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "enterprises", "ObjectIdentity", "Bits", "Counter64", "Gauge32", "ModuleIdentity", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("T3610-MIB", trapSOAPErrDelivery=trapSOAPErrDelivery, historyEntry=historyEntry, humHighInt=humHighInt, trapTempHighAlarm=trapTempHighAlarm, trapNTPError=trapNTPError, hum=hum, compValMin=compValMin, compValDelayInt=compValDelayInt, trapCompValError=trapCompValError, humLowInt=humLowInt, tempLowInt=tempLowInt, compValAlarm=compValAlarm, humMin=humMin, tempMax=tempMax, tempHighInt=tempHighInt, trapCompValLowAlarm=trapCompValLowAlarm, sensorName=sensorName, compValUnit=compValUnit, trapEmailErrDNS=trapEmailErrDNS, deviceType=deviceType, trapSOAPErrDNS=trapSOAPErrDNS, temp=temp, trapEmailErrSocket=trapEmailErrSocket, historyTable=historyTable, histCompVal=histCompVal, tables=tables, humUnit=humUnit, trapEmailErrSome=trapEmailErrSome, valuesInt=valuesInt, trapHumError=trapHumError, histHum=histHum, trapSOAPErrFile=trapSOAPErrFile, humMax=humMax, humDelayInt=humDelayInt, settings=settings, compValHighInt=compValHighInt, compValHystInt=compValHystInt, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValHighAlarm=trapCompValHighAlarm, trapHumLowAlarm=trapHumLowAlarm, trapHumClrAlarm=trapHumClrAlarm, humAlarm=humAlarm, compVal=compVal, compValMax=compValMax, serialNumber=serialNumber, humInt=humInt, histTemp=histTemp, compValLowInt=compValLowInt, trapTest=trapTest, tempAlarm=tempAlarm, tempMin=tempMin, compValAlarmInt=compValAlarmInt, humHystInt=humHystInt, messageString=messageString, trapTempClrAlarm=trapTempClrAlarm, pysmi_global=pysmi_global, tempInt=tempInt, trapTempLowAlarm=trapTempLowAlarm, tempHystInt=tempHystInt, trapEmailErrLogin=trapEmailErrLogin, products=products, DisplayString=DisplayString, tempDelayInt=tempDelayInt, trapEmailErrAuth=trapEmailErrAuth, trapTempError=trapTempError, comet=comet, tempAlarmInt=tempAlarmInt, compValInt=compValInt, t3610=t3610, trapHumHighAlarm=trapHumHighAlarm, tempUnit=tempUnit, values=values, traps=traps, humAlarmInt=humAlarmInt, trapCompValClrAlarm=trapCompValClrAlarm)
