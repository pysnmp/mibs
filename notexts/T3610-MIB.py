...
# Produced by pysmi-1.1.12 at Mon Oct  7 02:51:02 2024
...
iso, NotificationType, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, ModuleIdentity, Counter32, Integer32, NotificationType, TimeTicks, IpAddress, Unsigned32, MibIdentifier, Gauge32, ObjectIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "ModuleIdentity", "Counter32", "Integer32", "NotificationType", "TimeTicks", "IpAddress", "Unsigned32", "MibIdentifier", "Gauge32", "ObjectIdentity", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", temp=temp, tables=tables, trapCompValHighAlarm=trapCompValHighAlarm, values=values, t3610=t3610, trapNTPError=trapNTPError, humAlarmInt=humAlarmInt, compValHighInt=compValHighInt, messageString=messageString, trapTest=trapTest, trapSOAPErrSocket=trapSOAPErrSocket, tempHighInt=tempHighInt, trapTempClrAlarm=trapTempClrAlarm, trapTempError=trapTempError, compValMin=compValMin, trapSOAPErrFile=trapSOAPErrFile, trapHumError=trapHumError, trapCompValError=trapCompValError, tempAlarm=tempAlarm, humAlarm=humAlarm, historyEntry=historyEntry, trapEmailErrSome=trapEmailErrSome, compValAlarmInt=compValAlarmInt, trapEmailErrSocket=trapEmailErrSocket, trapEmailErrAuth=trapEmailErrAuth, compVal=compVal, trapEmailErrDNS=trapEmailErrDNS, trapTempLowAlarm=trapTempLowAlarm, products=products, traps=traps, histCompVal=histCompVal, compValInt=compValInt, DisplayString=DisplayString, compValLowInt=compValLowInt, humMin=humMin, humDelayInt=humDelayInt, trapSOAPErrDelivery=trapSOAPErrDelivery, compValAlarm=compValAlarm, comet=comet, tempHystInt=tempHystInt, serialNumber=serialNumber, trapCompValLowAlarm=trapCompValLowAlarm, humHystInt=humHystInt, compValUnit=compValUnit, hum=hum, tempLowInt=tempLowInt, tempInt=tempInt, humMax=humMax, humHighInt=humHighInt, histTemp=histTemp, tempAlarmInt=tempAlarmInt, tempDelayInt=tempDelayInt, trapSOAPErrDNS=trapSOAPErrDNS, humInt=humInt, trapHumLowAlarm=trapHumLowAlarm, trapHumClrAlarm=trapHumClrAlarm, tempMax=tempMax, deviceType=deviceType, compValDelayInt=compValDelayInt, humUnit=humUnit, trapHumHighAlarm=trapHumHighAlarm, valuesInt=valuesInt, compValHystInt=compValHystInt, histHum=histHum, tempUnit=tempUnit, humLowInt=humLowInt, trapCompValClrAlarm=trapCompValClrAlarm, settings=settings, historyTable=historyTable, trapEmailErrLogin=trapEmailErrLogin, sensorName=sensorName, pysmi_global=pysmi_global, trapTempHighAlarm=trapTempHighAlarm, compValMax=compValMax, tempMin=tempMin)
