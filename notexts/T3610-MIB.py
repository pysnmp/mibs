...
# Produced by pysmi-1.1.10 at Fri Nov 10 13:20:48 2023
...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, enterprises, Integer32, Bits, MibIdentifier, ObjectIdentity, iso, Counter32, Unsigned32, NotificationType, IpAddress, ModuleIdentity, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "enterprises", "Integer32", "Bits", "MibIdentifier", "ObjectIdentity", "iso", "Counter32", "Unsigned32", "NotificationType", "IpAddress", "ModuleIdentity", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("T3610-MIB", humAlarm=humAlarm, messageString=messageString, humInt=humInt, historyTable=historyTable, comet=comet, tables=tables, deviceType=deviceType, humLowInt=humLowInt, trapTempError=trapTempError, sensorName=sensorName, traps=traps, tempMax=tempMax, compValMax=compValMax, humHighInt=humHighInt, tempAlarmInt=tempAlarmInt, tempMin=tempMin, tempLowInt=tempLowInt, trapEmailErrLogin=trapEmailErrLogin, trapEmailErrSocket=trapEmailErrSocket, trapTest=trapTest, trapSOAPErrFile=trapSOAPErrFile, trapCompValClrAlarm=trapCompValClrAlarm, trapCompValError=trapCompValError, histHum=histHum, trapTempLowAlarm=trapTempLowAlarm, trapEmailErrAuth=trapEmailErrAuth, tempAlarm=tempAlarm, compValDelayInt=compValDelayInt, trapNTPError=trapNTPError, DisplayString=DisplayString, tempHystInt=tempHystInt, hum=hum, humDelayInt=humDelayInt, products=products, trapEmailErrDNS=trapEmailErrDNS, trapHumClrAlarm=trapHumClrAlarm, trapHumError=trapHumError, compValAlarm=compValAlarm, trapEmailErrSome=trapEmailErrSome, trapCompValLowAlarm=trapCompValLowAlarm, historyEntry=historyEntry, compValLowInt=compValLowInt, tempHighInt=tempHighInt, trapSOAPErrDelivery=trapSOAPErrDelivery, compValHystInt=compValHystInt, trapSOAPErrSocket=trapSOAPErrSocket, trapTempHighAlarm=trapTempHighAlarm, trapHumLowAlarm=trapHumLowAlarm, tempUnit=tempUnit, temp=temp, t3610=t3610, compValMin=compValMin, tempInt=tempInt, trapSOAPErrDNS=trapSOAPErrDNS, trapCompValHighAlarm=trapCompValHighAlarm, humMax=humMax, values=values, humMin=humMin, compValHighInt=compValHighInt, humHystInt=humHystInt, trapHumHighAlarm=trapHumHighAlarm, humAlarmInt=humAlarmInt, tempDelayInt=tempDelayInt, histCompVal=histCompVal, serialNumber=serialNumber, compValInt=compValInt, compValUnit=compValUnit, histTemp=histTemp, compVal=compVal, compValAlarmInt=compValAlarmInt, pysmi_global=pysmi_global, valuesInt=valuesInt, trapTempClrAlarm=trapTempClrAlarm, settings=settings, humUnit=humUnit)
