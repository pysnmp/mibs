...
# Produced by pysmi-1.1.12 at Thu Apr  4 09:15:48 2024
...
Counter32, Gauge32, ObjectIdentity, NotificationType, ModuleIdentity, enterprises, TimeTicks, NotificationType, iso, IpAddress, Counter64, Unsigned32, Integer32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "ObjectIdentity", "NotificationType", "ModuleIdentity", "enterprises", "TimeTicks", "NotificationType", "iso", "IpAddress", "Counter64", "Unsigned32", "Integer32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", trapCompValClrAlarm=trapCompValClrAlarm, tempHystInt=tempHystInt, tempInt=tempInt, trapSOAPErrFile=trapSOAPErrFile, humHighInt=humHighInt, humHystInt=humHystInt, historyTable=historyTable, tempLowInt=tempLowInt, tempMax=tempMax, trapCompValError=trapCompValError, trapEmailErrAuth=trapEmailErrAuth, valuesInt=valuesInt, humDelayInt=humDelayInt, tables=tables, trapEmailErrLogin=trapEmailErrLogin, trapCompValLowAlarm=trapCompValLowAlarm, histCompVal=histCompVal, trapNTPError=trapNTPError, serialNumber=serialNumber, trapHumClrAlarm=trapHumClrAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, temp=temp, histTemp=histTemp, tempDelayInt=tempDelayInt, compValAlarm=compValAlarm, compValAlarmInt=compValAlarmInt, compValHighInt=compValHighInt, tempHighInt=tempHighInt, DisplayString=DisplayString, compValInt=compValInt, tempAlarmInt=tempAlarmInt, trapTempClrAlarm=trapTempClrAlarm, trapHumLowAlarm=trapHumLowAlarm, trapEmailErrDNS=trapEmailErrDNS, compValHystInt=compValHystInt, humLowInt=humLowInt, trapCompValHighAlarm=trapCompValHighAlarm, compValDelayInt=compValDelayInt, trapTempLowAlarm=trapTempLowAlarm, hum=hum, tempUnit=tempUnit, deviceType=deviceType, compValMax=compValMax, trapEmailErrSocket=trapEmailErrSocket, trapHumHighAlarm=trapHumHighAlarm, humAlarmInt=humAlarmInt, compVal=compVal, messageString=messageString, trapEmailErrSome=trapEmailErrSome, trapSOAPErrDNS=trapSOAPErrDNS, traps=traps, trapHumError=trapHumError, tempMin=tempMin, tempAlarm=tempAlarm, humMin=humMin, compValUnit=compValUnit, values=values, histHum=histHum, humMax=humMax, t3610=t3610, humInt=humInt, compValMin=compValMin, historyEntry=historyEntry, settings=settings, products=products, trapTest=trapTest, humAlarm=humAlarm, sensorName=sensorName, trapTempError=trapTempError, pysmi_global=pysmi_global, comet=comet, trapSOAPErrSocket=trapSOAPErrSocket, humUnit=humUnit, compValLowInt=compValLowInt, trapTempHighAlarm=trapTempHighAlarm)
