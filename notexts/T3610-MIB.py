...
# Produced by pysmi-1.1.12 at Tue Jun 25 14:09:38 2024
...
iso, Counter32, MibIdentifier, Integer32, IpAddress, enterprises, ObjectIdentity, ModuleIdentity, Bits, Counter64, NotificationType, NotificationType, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter32", "MibIdentifier", "Integer32", "IpAddress", "enterprises", "ObjectIdentity", "ModuleIdentity", "Bits", "Counter64", "NotificationType", "NotificationType", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks")
...
mibBuilder.exportSymbols("T3610-MIB", comet=comet, compValHighInt=compValHighInt, DisplayString=DisplayString, humMax=humMax, humAlarmInt=humAlarmInt, tempDelayInt=tempDelayInt, trapCompValError=trapCompValError, trapCompValClrAlarm=trapCompValClrAlarm, compValDelayInt=compValDelayInt, trapEmailErrSocket=trapEmailErrSocket, products=products, humInt=humInt, compValLowInt=compValLowInt, trapNTPError=trapNTPError, histTemp=histTemp, trapHumClrAlarm=trapHumClrAlarm, humAlarm=humAlarm, compValAlarm=compValAlarm, tempMin=tempMin, tempLowInt=tempLowInt, tables=tables, trapTempError=trapTempError, temp=temp, humHystInt=humHystInt, tempMax=tempMax, trapSOAPErrDelivery=trapSOAPErrDelivery, trapEmailErrSome=trapEmailErrSome, traps=traps, trapTempHighAlarm=trapTempHighAlarm, humUnit=humUnit, trapSOAPErrSocket=trapSOAPErrSocket, sensorName=sensorName, compValInt=compValInt, trapEmailErrLogin=trapEmailErrLogin, compValUnit=compValUnit, trapHumHighAlarm=trapHumHighAlarm, compValHystInt=compValHystInt, historyTable=historyTable, valuesInt=valuesInt, compValAlarmInt=compValAlarmInt, humMin=humMin, trapSOAPErrDNS=trapSOAPErrDNS, humDelayInt=humDelayInt, trapSOAPErrFile=trapSOAPErrFile, compVal=compVal, tempAlarm=tempAlarm, tempHighInt=tempHighInt, pysmi_global=pysmi_global, humLowInt=humLowInt, compValMin=compValMin, histHum=histHum, trapEmailErrAuth=trapEmailErrAuth, compValMax=compValMax, trapCompValHighAlarm=trapCompValHighAlarm, trapHumLowAlarm=trapHumLowAlarm, trapHumError=trapHumError, hum=hum, tempHystInt=tempHystInt, trapEmailErrDNS=trapEmailErrDNS, deviceType=deviceType, trapTest=trapTest, tempInt=tempInt, trapCompValLowAlarm=trapCompValLowAlarm, messageString=messageString, trapTempClrAlarm=trapTempClrAlarm, settings=settings, tempAlarmInt=tempAlarmInt, historyEntry=historyEntry, trapTempLowAlarm=trapTempLowAlarm, serialNumber=serialNumber, histCompVal=histCompVal, tempUnit=tempUnit, t3610=t3610, humHighInt=humHighInt, values=values)
