...
# Produced by pysmi-1.1.3 at Wed Dec  1 17:15:14 2021
...
Integer32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress, MibIdentifier, iso, Unsigned32, ObjectIdentity, Gauge32, NotificationType, Counter64, ModuleIdentity, Bits, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress", "MibIdentifier", "iso", "Unsigned32", "ObjectIdentity", "Gauge32", "NotificationType", "Counter64", "ModuleIdentity", "Bits", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("T3610-MIB", humUnit=humUnit, settings=settings, values=values, tempUnit=tempUnit, tempAlarm=tempAlarm, serialNumber=serialNumber, pysmi_global=pysmi_global, humAlarmInt=humAlarmInt, tempHighInt=tempHighInt, messageString=messageString, t3610=t3610, humAlarm=humAlarm, compValMax=compValMax, tempAlarmInt=tempAlarmInt, trapHumHighAlarm=trapHumHighAlarm, histTemp=histTemp, compValUnit=compValUnit, trapSOAPErrDelivery=trapSOAPErrDelivery, products=products, trapTest=trapTest, trapTempClrAlarm=trapTempClrAlarm, valuesInt=valuesInt, humMin=humMin, compValMin=compValMin, trapSOAPErrFile=trapSOAPErrFile, compValHystInt=compValHystInt, trapTempHighAlarm=trapTempHighAlarm, historyTable=historyTable, histHum=histHum, hum=hum, trapCompValHighAlarm=trapCompValHighAlarm, humHystInt=humHystInt, trapEmailErrAuth=trapEmailErrAuth, trapCompValLowAlarm=trapCompValLowAlarm, DisplayString=DisplayString, sensorName=sensorName, trapNTPError=trapNTPError, tables=tables, traps=traps, compVal=compVal, humLowInt=humLowInt, humMax=humMax, humHighInt=humHighInt, tempDelayInt=tempDelayInt, humDelayInt=humDelayInt, histCompVal=histCompVal, comet=comet, historyEntry=historyEntry, trapEmailErrDNS=trapEmailErrDNS, trapHumClrAlarm=trapHumClrAlarm, trapCompValError=trapCompValError, tempLowInt=tempLowInt, trapHumLowAlarm=trapHumLowAlarm, trapSOAPErrDNS=trapSOAPErrDNS, trapHumError=trapHumError, trapTempLowAlarm=trapTempLowAlarm, deviceType=deviceType, compValDelayInt=compValDelayInt, trapSOAPErrSocket=trapSOAPErrSocket, temp=temp, compValAlarmInt=compValAlarmInt, trapCompValClrAlarm=trapCompValClrAlarm, tempInt=tempInt, compValInt=compValInt, compValHighInt=compValHighInt, tempMax=tempMax, tempMin=tempMin, humInt=humInt, trapEmailErrSocket=trapEmailErrSocket, trapEmailErrLogin=trapEmailErrLogin, trapEmailErrSome=trapEmailErrSome, tempHystInt=tempHystInt, compValLowInt=compValLowInt, trapTempError=trapTempError, compValAlarm=compValAlarm)
