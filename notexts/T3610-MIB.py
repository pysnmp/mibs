...
# Produced by pysmi-1.1.12 at Wed Dec  4 17:52:17 2024
...
TimeTicks, ModuleIdentity, Bits, Integer32, ObjectIdentity, Counter64, iso, IpAddress, Gauge32, enterprises, NotificationType, MibIdentifier, Unsigned32, Counter32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "Bits", "Integer32", "ObjectIdentity", "Counter64", "iso", "IpAddress", "Gauge32", "enterprises", "NotificationType", "MibIdentifier", "Unsigned32", "Counter32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("T3610-MIB", compValUnit=compValUnit, compValMin=compValMin, trapSOAPErrDNS=trapSOAPErrDNS, humHighInt=humHighInt, tables=tables, trapSOAPErrDelivery=trapSOAPErrDelivery, trapNTPError=trapNTPError, trapCompValHighAlarm=trapCompValHighAlarm, trapTempClrAlarm=trapTempClrAlarm, histHum=histHum, compValAlarm=compValAlarm, trapEmailErrAuth=trapEmailErrAuth, compVal=compVal, historyEntry=historyEntry, tempLowInt=tempLowInt, trapHumClrAlarm=trapHumClrAlarm, trapTempLowAlarm=trapTempLowAlarm, trapCompValClrAlarm=trapCompValClrAlarm, temp=temp, traps=traps, tempAlarm=tempAlarm, trapCompValLowAlarm=trapCompValLowAlarm, sensorName=sensorName, humLowInt=humLowInt, messageString=messageString, tempAlarmInt=tempAlarmInt, trapSOAPErrFile=trapSOAPErrFile, hum=hum, humMin=humMin, deviceType=deviceType, compValAlarmInt=compValAlarmInt, humInt=humInt, humUnit=humUnit, t3610=t3610, humDelayInt=humDelayInt, compValDelayInt=compValDelayInt, compValHighInt=compValHighInt, humHystInt=humHystInt, historyTable=historyTable, humAlarm=humAlarm, histCompVal=histCompVal, tempMax=tempMax, tempUnit=tempUnit, comet=comet, tempDelayInt=tempDelayInt, serialNumber=serialNumber, valuesInt=valuesInt, compValInt=compValInt, compValLowInt=compValLowInt, trapTempHighAlarm=trapTempHighAlarm, compValMax=compValMax, tempHighInt=tempHighInt, trapHumHighAlarm=trapHumHighAlarm, humMax=humMax, tempInt=tempInt, compValHystInt=compValHystInt, histTemp=histTemp, pysmi_global=pysmi_global, trapTest=trapTest, products=products, settings=settings, humAlarmInt=humAlarmInt, trapHumLowAlarm=trapHumLowAlarm, trapTempError=trapTempError, trapHumError=trapHumError, values=values, trapEmailErrSocket=trapEmailErrSocket, trapEmailErrSome=trapEmailErrSome, trapCompValError=trapCompValError, tempHystInt=tempHystInt, trapEmailErrLogin=trapEmailErrLogin, trapSOAPErrSocket=trapSOAPErrSocket, DisplayString=DisplayString, tempMin=tempMin, trapEmailErrDNS=trapEmailErrDNS)
