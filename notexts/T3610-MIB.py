...
# Produced by pysmi-1.1.11 at Wed Apr  3 13:42:30 2024
...
Gauge32, ObjectIdentity, TimeTicks, Counter32, Counter64, Integer32, NotificationType, ModuleIdentity, Unsigned32, Bits, MibIdentifier, NotificationType, IpAddress, enterprises, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "TimeTicks", "Counter32", "Counter64", "Integer32", "NotificationType", "ModuleIdentity", "Unsigned32", "Bits", "MibIdentifier", "NotificationType", "IpAddress", "enterprises", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("T3610-MIB", compValAlarmInt=compValAlarmInt, trapNTPError=trapNTPError, trapTempClrAlarm=trapTempClrAlarm, settings=settings, compValAlarm=compValAlarm, humHighInt=humHighInt, pysmi_global=pysmi_global, tempUnit=tempUnit, tempAlarmInt=tempAlarmInt, compValDelayInt=compValDelayInt, tempLowInt=tempLowInt, tempHystInt=tempHystInt, trapEmailErrSome=trapEmailErrSome, trapSOAPErrDelivery=trapSOAPErrDelivery, humInt=humInt, humHystInt=humHystInt, historyEntry=historyEntry, compVal=compVal, compValHystInt=compValHystInt, t3610=t3610, humAlarmInt=humAlarmInt, traps=traps, trapCompValError=trapCompValError, humUnit=humUnit, messageString=messageString, tempHighInt=tempHighInt, humAlarm=humAlarm, DisplayString=DisplayString, trapEmailErrAuth=trapEmailErrAuth, tempDelayInt=tempDelayInt, trapSOAPErrFile=trapSOAPErrFile, trapTempHighAlarm=trapTempHighAlarm, trapHumHighAlarm=trapHumHighAlarm, humDelayInt=humDelayInt, tempMax=tempMax, deviceType=deviceType, histTemp=histTemp, trapEmailErrDNS=trapEmailErrDNS, compValUnit=compValUnit, compValInt=compValInt, compValMax=compValMax, serialNumber=serialNumber, humMax=humMax, trapEmailErrSocket=trapEmailErrSocket, compValMin=compValMin, trapCompValHighAlarm=trapCompValHighAlarm, trapHumClrAlarm=trapHumClrAlarm, trapCompValClrAlarm=trapCompValClrAlarm, tempMin=tempMin, tempAlarm=tempAlarm, compValLowInt=compValLowInt, trapTempError=trapTempError, trapCompValLowAlarm=trapCompValLowAlarm, trapHumError=trapHumError, histHum=histHum, values=values, tempInt=tempInt, trapSOAPErrDNS=trapSOAPErrDNS, valuesInt=valuesInt, compValHighInt=compValHighInt, tables=tables, trapTest=trapTest, trapHumLowAlarm=trapHumLowAlarm, humMin=humMin, comet=comet, humLowInt=humLowInt, trapEmailErrLogin=trapEmailErrLogin, temp=temp, trapSOAPErrSocket=trapSOAPErrSocket, products=products, sensorName=sensorName, trapTempLowAlarm=trapTempLowAlarm, histCompVal=histCompVal, historyTable=historyTable, hum=hum)
