...
# Produced by pysmi-1.1.8 at Wed Feb  2 18:20:04 2022
...
ObjectIdentity, NotificationType, Counter32, Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks, Unsigned32, MibIdentifier, Counter64, Integer32, ModuleIdentity, IpAddress, Bits, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "Counter32", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks", "Unsigned32", "MibIdentifier", "Counter64", "Integer32", "ModuleIdentity", "IpAddress", "Bits", "enterprises")
...
mibBuilder.exportSymbols("T3610-MIB", histTemp=histTemp, humDelayInt=humDelayInt, trapEmailErrLogin=trapEmailErrLogin, serialNumber=serialNumber, tempInt=tempInt, compValMax=compValMax, trapHumLowAlarm=trapHumLowAlarm, trapEmailErrSome=trapEmailErrSome, trapHumClrAlarm=trapHumClrAlarm, humHystInt=humHystInt, trapEmailErrDNS=trapEmailErrDNS, trapTempClrAlarm=trapTempClrAlarm, pysmi_global=pysmi_global, historyTable=historyTable, tempHystInt=tempHystInt, tables=tables, products=products, humMax=humMax, trapTest=trapTest, trapEmailErrAuth=trapEmailErrAuth, histHum=histHum, trapEmailErrSocket=trapEmailErrSocket, valuesInt=valuesInt, traps=traps, trapHumError=trapHumError, trapNTPError=trapNTPError, tempMax=tempMax, settings=settings, humHighInt=humHighInt, DisplayString=DisplayString, compVal=compVal, tempAlarm=tempAlarm, humMin=humMin, humAlarmInt=humAlarmInt, compValAlarmInt=compValAlarmInt, temp=temp, trapSOAPErrDNS=trapSOAPErrDNS, trapHumHighAlarm=trapHumHighAlarm, trapSOAPErrFile=trapSOAPErrFile, trapTempLowAlarm=trapTempLowAlarm, compValUnit=compValUnit, compValLowInt=compValLowInt, messageString=messageString, trapCompValError=trapCompValError, compValDelayInt=compValDelayInt, trapCompValLowAlarm=trapCompValLowAlarm, humLowInt=humLowInt, compValHighInt=compValHighInt, compValInt=compValInt, t3610=t3610, compValHystInt=compValHystInt, trapCompValHighAlarm=trapCompValHighAlarm, histCompVal=histCompVal, humAlarm=humAlarm, sensorName=sensorName, tempDelayInt=tempDelayInt, humInt=humInt, historyEntry=historyEntry, tempAlarmInt=tempAlarmInt, values=values, humUnit=humUnit, hum=hum, comet=comet, compValAlarm=compValAlarm, deviceType=deviceType, tempMin=tempMin, tempUnit=tempUnit, tempLowInt=tempLowInt, trapSOAPErrDelivery=trapSOAPErrDelivery, tempHighInt=tempHighInt, trapSOAPErrSocket=trapSOAPErrSocket, compValMin=compValMin, trapTempError=trapTempError, trapTempHighAlarm=trapTempHighAlarm, trapCompValClrAlarm=trapCompValClrAlarm)
