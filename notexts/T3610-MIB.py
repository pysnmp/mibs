...
TimeTicks, Gauge32, iso, ModuleIdentity, MibIdentifier, Bits, Counter32, ObjectIdentity, IpAddress, NotificationType, enterprises, NotificationType, Counter64, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Gauge32", "iso", "ModuleIdentity", "MibIdentifier", "Bits", "Counter32", "ObjectIdentity", "IpAddress", "NotificationType", "enterprises", "NotificationType", "Counter64", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
...
mibBuilder.exportSymbols("T3610-MIB", temp=temp, trapNTPError=trapNTPError, trapSOAPErrDelivery=trapSOAPErrDelivery, compValAlarmInt=compValAlarmInt, messageString=messageString, tempUnit=tempUnit, compValUnit=compValUnit, trapCompValHighAlarm=trapCompValHighAlarm, compValMax=compValMax, humLowInt=humLowInt, compValHighInt=compValHighInt, trapHumHighAlarm=trapHumHighAlarm, humHystInt=humHystInt, trapHumLowAlarm=trapHumLowAlarm, humHighInt=humHighInt, trapHumError=trapHumError, trapTempHighAlarm=trapTempHighAlarm, valuesInt=valuesInt, compValHystInt=compValHystInt, trapEmailErrDNS=trapEmailErrDNS, tempHystInt=tempHystInt, trapTempLowAlarm=trapTempLowAlarm, historyEntry=historyEntry, tempLowInt=tempLowInt, tempMin=tempMin, hum=hum, trapTempClrAlarm=trapTempClrAlarm, tables=tables, humAlarm=humAlarm, sensorName=sensorName, pysmi_global=pysmi_global, tempDelayInt=tempDelayInt, compValLowInt=compValLowInt, histHum=histHum, trapSOAPErrFile=trapSOAPErrFile, trapCompValError=trapCompValError, humMin=humMin, trapCompValClrAlarm=trapCompValClrAlarm, t3610=t3610, historyTable=historyTable, humAlarmInt=humAlarmInt, trapSOAPErrSocket=trapSOAPErrSocket, compValAlarm=compValAlarm, comet=comet, DisplayString=DisplayString, traps=traps, trapEmailErrAuth=trapEmailErrAuth, values=values, products=products, compValDelayInt=compValDelayInt, tempAlarmInt=tempAlarmInt, tempAlarm=tempAlarm, trapEmailErrLogin=trapEmailErrLogin, tempMax=tempMax, deviceType=deviceType, compValInt=compValInt, tempHighInt=tempHighInt, trapSOAPErrDNS=trapSOAPErrDNS, trapEmailErrSome=trapEmailErrSome, trapTest=trapTest, humUnit=humUnit, settings=settings, trapHumClrAlarm=trapHumClrAlarm, serialNumber=serialNumber, histTemp=histTemp, compValMin=compValMin, humMax=humMax, humInt=humInt, histCompVal=histCompVal, compVal=compVal, trapEmailErrSocket=trapEmailErrSocket, trapCompValLowAlarm=trapCompValLowAlarm, trapTempError=trapTempError, humDelayInt=humDelayInt, tempInt=tempInt)
