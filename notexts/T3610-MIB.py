...
# Produced by pysmi-1.1.3 at Sun Nov 28 20:30:27 2021
...
NotificationType, ModuleIdentity, MibIdentifier, ObjectIdentity, iso, Integer32, NotificationType, enterprises, TimeTicks, Bits, Counter64, Gauge32, IpAddress, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "MibIdentifier", "ObjectIdentity", "iso", "Integer32", "NotificationType", "enterprises", "TimeTicks", "Bits", "Counter64", "Gauge32", "IpAddress", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("T3610-MIB", compValUnit=compValUnit, histHum=histHum, temp=temp, trapCompValClrAlarm=trapCompValClrAlarm, compValAlarmInt=compValAlarmInt, compValLowInt=compValLowInt, trapTempHighAlarm=trapTempHighAlarm, compValMin=compValMin, humDelayInt=humDelayInt, humInt=humInt, historyEntry=historyEntry, tempUnit=tempUnit, tempMax=tempMax, humMax=humMax, compValDelayInt=compValDelayInt, trapEmailErrSome=trapEmailErrSome, trapHumLowAlarm=trapHumLowAlarm, trapSOAPErrFile=trapSOAPErrFile, serialNumber=serialNumber, tempHystInt=tempHystInt, histCompVal=histCompVal, trapSOAPErrSocket=trapSOAPErrSocket, trapTempClrAlarm=trapTempClrAlarm, messageString=messageString, trapCompValError=trapCompValError, compValMax=compValMax, trapEmailErrLogin=trapEmailErrLogin, compValHystInt=compValHystInt, compVal=compVal, histTemp=histTemp, tempLowInt=tempLowInt, humLowInt=humLowInt, historyTable=historyTable, trapNTPError=trapNTPError, trapTest=trapTest, tempMin=tempMin, traps=traps, products=products, tempDelayInt=tempDelayInt, values=values, tempHighInt=tempHighInt, trapHumError=trapHumError, compValAlarm=compValAlarm, compValInt=compValInt, trapEmailErrDNS=trapEmailErrDNS, trapTempError=trapTempError, DisplayString=DisplayString, humAlarm=humAlarm, tempInt=tempInt, settings=settings, humHighInt=humHighInt, humMin=humMin, humAlarmInt=humAlarmInt, compValHighInt=compValHighInt, hum=hum, trapSOAPErrDNS=trapSOAPErrDNS, deviceType=deviceType, tempAlarmInt=tempAlarmInt, pysmi_global=pysmi_global, trapSOAPErrDelivery=trapSOAPErrDelivery, tables=tables, trapEmailErrSocket=trapEmailErrSocket, trapHumClrAlarm=trapHumClrAlarm, comet=comet, trapCompValHighAlarm=trapCompValHighAlarm, trapTempLowAlarm=trapTempLowAlarm, tempAlarm=tempAlarm, trapCompValLowAlarm=trapCompValLowAlarm, humHystInt=humHystInt, trapEmailErrAuth=trapEmailErrAuth, trapHumHighAlarm=trapHumHighAlarm, sensorName=sensorName, valuesInt=valuesInt, humUnit=humUnit, t3610=t3610)
