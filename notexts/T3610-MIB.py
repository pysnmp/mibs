...
# Produced by pysmi-1.1.8 at Fri Jan  7 15:17:39 2022
...
ObjectIdentity, NotificationType, Unsigned32, IpAddress, enterprises, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ModuleIdentity, MibIdentifier, TimeTicks, Integer32, iso, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "Unsigned32", "IpAddress", "enterprises", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ModuleIdentity", "MibIdentifier", "TimeTicks", "Integer32", "iso", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("T3610-MIB", historyEntry=historyEntry, histTemp=histTemp, histCompVal=histCompVal, trapSOAPErrFile=trapSOAPErrFile, humAlarm=humAlarm, tempHystInt=tempHystInt, trapTempClrAlarm=trapTempClrAlarm, compValLowInt=compValLowInt, trapHumError=trapHumError, compValUnit=compValUnit, trapHumLowAlarm=trapHumLowAlarm, tempInt=tempInt, tempUnit=tempUnit, deviceType=deviceType, compValHystInt=compValHystInt, trapCompValClrAlarm=trapCompValClrAlarm, humUnit=humUnit, valuesInt=valuesInt, historyTable=historyTable, trapEmailErrSocket=trapEmailErrSocket, tables=tables, compValDelayInt=compValDelayInt, humDelayInt=humDelayInt, trapEmailErrSome=trapEmailErrSome, histHum=histHum, trapHumClrAlarm=trapHumClrAlarm, humAlarmInt=humAlarmInt, comet=comet, sensorName=sensorName, trapTempHighAlarm=trapTempHighAlarm, serialNumber=serialNumber, humHighInt=humHighInt, trapSOAPErrDNS=trapSOAPErrDNS, compVal=compVal, pysmi_global=pysmi_global, trapCompValHighAlarm=trapCompValHighAlarm, t3610=t3610, traps=traps, tempMax=tempMax, compValMax=compValMax, tempHighInt=tempHighInt, DisplayString=DisplayString, humHystInt=humHystInt, products=products, trapEmailErrLogin=trapEmailErrLogin, trapSOAPErrDelivery=trapSOAPErrDelivery, tempMin=tempMin, compValMin=compValMin, trapTempLowAlarm=trapTempLowAlarm, compValAlarmInt=compValAlarmInt, trapEmailErrDNS=trapEmailErrDNS, humLowInt=humLowInt, trapEmailErrAuth=trapEmailErrAuth, messageString=messageString, compValInt=compValInt, settings=settings, trapTempError=trapTempError, trapCompValLowAlarm=trapCompValLowAlarm, tempLowInt=tempLowInt, values=values, trapTest=trapTest, humMin=humMin, trapCompValError=trapCompValError, trapSOAPErrSocket=trapSOAPErrSocket, humInt=humInt, trapHumHighAlarm=trapHumHighAlarm, hum=hum, compValHighInt=compValHighInt, trapNTPError=trapNTPError, compValAlarm=compValAlarm, humMax=humMax, temp=temp, tempDelayInt=tempDelayInt, tempAlarm=tempAlarm, tempAlarmInt=tempAlarmInt)
