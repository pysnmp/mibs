...
# Produced by pysmi-1.1.3 at Wed Dec  1 15:03:02 2021
...
ObjectIdentity, Unsigned32, NotificationType, Bits, iso, Integer32, Counter64, ModuleIdentity, Counter32, enterprises, NotificationType, IpAddress, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "NotificationType", "Bits", "iso", "Integer32", "Counter64", "ModuleIdentity", "Counter32", "enterprises", "NotificationType", "IpAddress", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
...
mibBuilder.exportSymbols("T3610-MIB", humUnit=humUnit, trapHumError=trapHumError, tempHighInt=tempHighInt, trapSOAPErrDelivery=trapSOAPErrDelivery, compValHighInt=compValHighInt, histTemp=histTemp, tempAlarm=tempAlarm, tempLowInt=tempLowInt, trapCompValLowAlarm=trapCompValLowAlarm, historyTable=historyTable, trapTempHighAlarm=trapTempHighAlarm, trapTempError=trapTempError, tempUnit=tempUnit, histCompVal=histCompVal, trapNTPError=trapNTPError, hum=hum, settings=settings, values=values, tempAlarmInt=tempAlarmInt, histHum=histHum, sensorName=sensorName, trapCompValClrAlarm=trapCompValClrAlarm, humMin=humMin, humAlarmInt=humAlarmInt, humLowInt=humLowInt, trapSOAPErrFile=trapSOAPErrFile, comet=comet, valuesInt=valuesInt, trapHumLowAlarm=trapHumLowAlarm, humDelayInt=humDelayInt, compValAlarm=compValAlarm, deviceType=deviceType, traps=traps, trapEmailErrSocket=trapEmailErrSocket, trapCompValHighAlarm=trapCompValHighAlarm, trapTest=trapTest, products=products, trapEmailErrAuth=trapEmailErrAuth, compValUnit=compValUnit, temp=temp, tempMin=tempMin, humHighInt=humHighInt, humInt=humInt, trapTempClrAlarm=trapTempClrAlarm, compValDelayInt=compValDelayInt, trapEmailErrDNS=trapEmailErrDNS, compValHystInt=compValHystInt, trapCompValError=trapCompValError, compValLowInt=compValLowInt, tempInt=tempInt, serialNumber=serialNumber, messageString=messageString, humAlarm=humAlarm, compValMax=compValMax, t3610=t3610, historyEntry=historyEntry, pysmi_global=pysmi_global, trapEmailErrSome=trapEmailErrSome, trapEmailErrLogin=trapEmailErrLogin, trapSOAPErrDNS=trapSOAPErrDNS, DisplayString=DisplayString, compValAlarmInt=compValAlarmInt, trapHumHighAlarm=trapHumHighAlarm, compValMin=compValMin, compValInt=compValInt, trapHumClrAlarm=trapHumClrAlarm, humHystInt=humHystInt, humMax=humMax, tempDelayInt=tempDelayInt, tempMax=tempMax, trapTempLowAlarm=trapTempLowAlarm, trapSOAPErrSocket=trapSOAPErrSocket, tables=tables, tempHystInt=tempHystInt, compVal=compVal)
