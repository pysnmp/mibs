...
# Produced by pysmi-1.1.8 at Tue Feb  8 22:05:01 2022
...
iso, Counter32, IpAddress, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32, ObjectIdentity, enterprises, TimeTicks, NotificationType, MibIdentifier, Unsigned32, NotificationType, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter32", "IpAddress", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32", "ObjectIdentity", "enterprises", "TimeTicks", "NotificationType", "MibIdentifier", "Unsigned32", "NotificationType", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("T3610-MIB", trapSOAPErrDNS=trapSOAPErrDNS, compValMin=compValMin, trapEmailErrSocket=trapEmailErrSocket, humMax=humMax, tempDelayInt=tempDelayInt, deviceType=deviceType, trapCompValClrAlarm=trapCompValClrAlarm, compValInt=compValInt, tempAlarm=tempAlarm, humMin=humMin, histTemp=histTemp, trapCompValError=trapCompValError, pysmi_global=pysmi_global, compValMax=compValMax, compValHystInt=compValHystInt, trapEmailErrAuth=trapEmailErrAuth, products=products, trapEmailErrDNS=trapEmailErrDNS, historyTable=historyTable, humAlarm=humAlarm, trapEmailErrSome=trapEmailErrSome, tempMax=tempMax, humLowInt=humLowInt, trapSOAPErrFile=trapSOAPErrFile, trapSOAPErrSocket=trapSOAPErrSocket, comet=comet, compValAlarm=compValAlarm, compValUnit=compValUnit, tempAlarmInt=tempAlarmInt, trapTempClrAlarm=trapTempClrAlarm, humDelayInt=humDelayInt, compValAlarmInt=compValAlarmInt, trapHumHighAlarm=trapHumHighAlarm, hum=hum, humAlarmInt=humAlarmInt, trapNTPError=trapNTPError, trapHumLowAlarm=trapHumLowAlarm, trapCompValLowAlarm=trapCompValLowAlarm, tables=tables, t3610=t3610, trapHumClrAlarm=trapHumClrAlarm, tempUnit=tempUnit, humHighInt=humHighInt, trapHumError=trapHumError, humInt=humInt, DisplayString=DisplayString, temp=temp, historyEntry=historyEntry, trapSOAPErrDelivery=trapSOAPErrDelivery, serialNumber=serialNumber, compValLowInt=compValLowInt, traps=traps, compVal=compVal, valuesInt=valuesInt, sensorName=sensorName, tempInt=tempInt, compValHighInt=compValHighInt, trapCompValHighAlarm=trapCompValHighAlarm, trapTempError=trapTempError, histCompVal=histCompVal, tempLowInt=tempLowInt, tempMin=tempMin, values=values, messageString=messageString, trapEmailErrLogin=trapEmailErrLogin, humHystInt=humHystInt, trapTempLowAlarm=trapTempLowAlarm, humUnit=humUnit, trapTempHighAlarm=trapTempHighAlarm, compValDelayInt=compValDelayInt, settings=settings, tempHighInt=tempHighInt, tempHystInt=tempHystInt, trapTest=trapTest, histHum=histHum)
