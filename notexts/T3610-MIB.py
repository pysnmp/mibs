...
# Produced by pysmi-1.1.8 at Tue Jan 18 14:01:59 2022
...
TimeTicks, ObjectIdentity, Counter64, iso, NotificationType, enterprises, Counter32, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier, IpAddress, Bits, NotificationType, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ObjectIdentity", "Counter64", "iso", "NotificationType", "enterprises", "Counter32", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier", "IpAddress", "Bits", "NotificationType", "Unsigned32")
...
mibBuilder.exportSymbols("T3610-MIB", trapSOAPErrSocket=trapSOAPErrSocket, humHystInt=humHystInt, humMin=humMin, tempHystInt=tempHystInt, trapSOAPErrDNS=trapSOAPErrDNS, compValMin=compValMin, historyTable=historyTable, humInt=humInt, DisplayString=DisplayString, valuesInt=valuesInt, tables=tables, t3610=t3610, tempUnit=tempUnit, sensorName=sensorName, compValHighInt=compValHighInt, temp=temp, trapEmailErrSocket=trapEmailErrSocket, trapHumClrAlarm=trapHumClrAlarm, messageString=messageString, trapEmailErrAuth=trapEmailErrAuth, trapTempHighAlarm=trapTempHighAlarm, trapCompValError=trapCompValError, trapTempLowAlarm=trapTempLowAlarm, humMax=humMax, histCompVal=histCompVal, trapEmailErrLogin=trapEmailErrLogin, hum=hum, compValMax=compValMax, compValAlarmInt=compValAlarmInt, histTemp=histTemp, trapTempClrAlarm=trapTempClrAlarm, tempLowInt=tempLowInt, products=products, humUnit=humUnit, compValDelayInt=compValDelayInt, trapEmailErrSome=trapEmailErrSome, trapSOAPErrFile=trapSOAPErrFile, comet=comet, compVal=compVal, compValInt=compValInt, trapCompValHighAlarm=trapCompValHighAlarm, humLowInt=humLowInt, pysmi_global=pysmi_global, trapNTPError=trapNTPError, trapCompValClrAlarm=trapCompValClrAlarm, trapTempError=trapTempError, trapEmailErrDNS=trapEmailErrDNS, tempAlarmInt=tempAlarmInt, settings=settings, traps=traps, tempHighInt=tempHighInt, trapTest=trapTest, trapHumHighAlarm=trapHumHighAlarm, humAlarmInt=humAlarmInt, compValHystInt=compValHystInt, trapSOAPErrDelivery=trapSOAPErrDelivery, humDelayInt=humDelayInt, trapCompValLowAlarm=trapCompValLowAlarm, tempMin=tempMin, tempAlarm=tempAlarm, humHighInt=humHighInt, compValLowInt=compValLowInt, historyEntry=historyEntry, trapHumLowAlarm=trapHumLowAlarm, deviceType=deviceType, tempInt=tempInt, tempDelayInt=tempDelayInt, values=values, trapHumError=trapHumError, humAlarm=humAlarm, tempMax=tempMax, histHum=histHum, serialNumber=serialNumber, compValAlarm=compValAlarm, compValUnit=compValUnit)
