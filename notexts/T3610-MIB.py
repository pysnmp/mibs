...
# Produced by pysmi-1.1.8 at Sat Jan 15 17:56:57 2022
...
Bits, NotificationType, NotificationType, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, TimeTicks, enterprises, IpAddress, Counter32, iso, ModuleIdentity, Gauge32, ObjectIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "NotificationType", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "TimeTicks", "enterprises", "IpAddress", "Counter32", "iso", "ModuleIdentity", "Gauge32", "ObjectIdentity", "Counter64")
...
mibBuilder.exportSymbols("T3610-MIB", trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrSocket=trapSOAPErrSocket, tempHystInt=tempHystInt, humAlarmInt=humAlarmInt, historyEntry=historyEntry, compValMin=compValMin, compValHighInt=compValHighInt, DisplayString=DisplayString, trapEmailErrLogin=trapEmailErrLogin, settings=settings, trapHumLowAlarm=trapHumLowAlarm, trapCompValLowAlarm=trapCompValLowAlarm, t3610=t3610, temp=temp, compValMax=compValMax, compValHystInt=compValHystInt, humHystInt=humHystInt, trapTempHighAlarm=trapTempHighAlarm, tempAlarmInt=tempAlarmInt, compValUnit=compValUnit, historyTable=historyTable, trapHumHighAlarm=trapHumHighAlarm, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrFile=trapSOAPErrFile, trapCompValError=trapCompValError, humAlarm=humAlarm, tempInt=tempInt, humInt=humInt, trapTempClrAlarm=trapTempClrAlarm, tables=tables, traps=traps, tempDelayInt=tempDelayInt, tempAlarm=tempAlarm, trapNTPError=trapNTPError, trapEmailErrSome=trapEmailErrSome, trapTempLowAlarm=trapTempLowAlarm, tempMax=tempMax, compVal=compVal, trapTempError=trapTempError, products=products, hum=hum, humMax=humMax, messageString=messageString, compValInt=compValInt, trapTest=trapTest, comet=comet, trapSOAPErrDNS=trapSOAPErrDNS, compValAlarm=compValAlarm, humHighInt=humHighInt, tempLowInt=tempLowInt, serialNumber=serialNumber, humDelayInt=humDelayInt, tempMin=tempMin, histHum=histHum, tempUnit=tempUnit, compValDelayInt=compValDelayInt, pysmi_global=pysmi_global, tempHighInt=tempHighInt, humLowInt=humLowInt, humUnit=humUnit, histTemp=histTemp, histCompVal=histCompVal, trapHumClrAlarm=trapHumClrAlarm, trapEmailErrDNS=trapEmailErrDNS, trapCompValClrAlarm=trapCompValClrAlarm, compValLowInt=compValLowInt, values=values, trapSOAPErrDelivery=trapSOAPErrDelivery, compValAlarmInt=compValAlarmInt, humMin=humMin, sensorName=sensorName, trapCompValHighAlarm=trapCompValHighAlarm, deviceType=deviceType, trapHumError=trapHumError, valuesInt=valuesInt)
