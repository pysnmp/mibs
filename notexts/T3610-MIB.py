...
# Produced by pysmi-1.1.11 at Wed Apr  3 14:48:50 2024
...
ModuleIdentity, MibIdentifier, iso, IpAddress, Counter32, Counter64, Unsigned32, NotificationType, Gauge32, ObjectIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, enterprises, Integer32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibIdentifier", "iso", "IpAddress", "Counter32", "Counter64", "Unsigned32", "NotificationType", "Gauge32", "ObjectIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "enterprises", "Integer32", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", tempMin=tempMin, tempAlarm=tempAlarm, comet=comet, humAlarm=humAlarm, trapHumError=trapHumError, compValHighInt=compValHighInt, humUnit=humUnit, trapEmailErrSocket=trapEmailErrSocket, historyEntry=historyEntry, trapTempLowAlarm=trapTempLowAlarm, historyTable=historyTable, histCompVal=histCompVal, messageString=messageString, tempAlarmInt=tempAlarmInt, valuesInt=valuesInt, t3610=t3610, compValInt=compValInt, compValAlarmInt=compValAlarmInt, trapHumClrAlarm=trapHumClrAlarm, trapEmailErrSome=trapEmailErrSome, trapCompValClrAlarm=trapCompValClrAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, trapHumLowAlarm=trapHumLowAlarm, tempDelayInt=tempDelayInt, tables=tables, humHighInt=humHighInt, compValMin=compValMin, traps=traps, trapEmailErrAuth=trapEmailErrAuth, trapCompValLowAlarm=trapCompValLowAlarm, trapTempClrAlarm=trapTempClrAlarm, deviceType=deviceType, settings=settings, tempLowInt=tempLowInt, trapSOAPErrSocket=trapSOAPErrSocket, humDelayInt=humDelayInt, trapSOAPErrDNS=trapSOAPErrDNS, tempMax=tempMax, compValLowInt=compValLowInt, pysmi_global=pysmi_global, humAlarmInt=humAlarmInt, trapTest=trapTest, compValUnit=compValUnit, trapEmailErrDNS=trapEmailErrDNS, hum=hum, tempUnit=tempUnit, tempInt=tempInt, values=values, products=products, serialNumber=serialNumber, humInt=humInt, humLowInt=humLowInt, compValDelayInt=compValDelayInt, histHum=histHum, sensorName=sensorName, trapCompValHighAlarm=trapCompValHighAlarm, tempHystInt=tempHystInt, trapTempHighAlarm=trapTempHighAlarm, compValMax=compValMax, trapTempError=trapTempError, compVal=compVal, trapHumHighAlarm=trapHumHighAlarm, trapCompValError=trapCompValError, tempHighInt=tempHighInt, humHystInt=humHystInt, compValHystInt=compValHystInt, DisplayString=DisplayString, trapNTPError=trapNTPError, trapSOAPErrFile=trapSOAPErrFile, compValAlarm=compValAlarm, humMax=humMax, temp=temp, histTemp=histTemp, trapEmailErrLogin=trapEmailErrLogin, humMin=humMin)
