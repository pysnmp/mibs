...
# Produced by pysmi-1.1.12 at Wed Jul  3 12:20:39 2024
...
enterprises, NotificationType, NotificationType, IpAddress, Unsigned32, MibIdentifier, TimeTicks, Gauge32, Integer32, Counter64, iso, ObjectIdentity, Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "NotificationType", "NotificationType", "IpAddress", "Unsigned32", "MibIdentifier", "TimeTicks", "Gauge32", "Integer32", "Counter64", "iso", "ObjectIdentity", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", histHum=histHum, t3610=t3610, trapTempError=trapTempError, deviceType=deviceType, humDelayInt=humDelayInt, compValAlarm=compValAlarm, trapTempClrAlarm=trapTempClrAlarm, trapCompValClrAlarm=trapCompValClrAlarm, trapEmailErrSocket=trapEmailErrSocket, trapEmailErrLogin=trapEmailErrLogin, tables=tables, tempDelayInt=tempDelayInt, humHystInt=humHystInt, temp=temp, valuesInt=valuesInt, trapSOAPErrDNS=trapSOAPErrDNS, trapSOAPErrDelivery=trapSOAPErrDelivery, compValLowInt=compValLowInt, histTemp=histTemp, sensorName=sensorName, tempAlarmInt=tempAlarmInt, tempLowInt=tempLowInt, historyTable=historyTable, humUnit=humUnit, messageString=messageString, trapEmailErrAuth=trapEmailErrAuth, trapEmailErrDNS=trapEmailErrDNS, compVal=compVal, compValDelayInt=compValDelayInt, trapEmailErrSome=trapEmailErrSome, tempMin=tempMin, compValMin=compValMin, products=products, compValMax=compValMax, hum=hum, humAlarm=humAlarm, compValUnit=compValUnit, comet=comet, compValAlarmInt=compValAlarmInt, histCompVal=histCompVal, trapNTPError=trapNTPError, trapHumLowAlarm=trapHumLowAlarm, trapCompValError=trapCompValError, compValHystInt=compValHystInt, trapSOAPErrSocket=trapSOAPErrSocket, traps=traps, tempUnit=tempUnit, humLowInt=humLowInt, trapTest=trapTest, trapTempHighAlarm=trapTempHighAlarm, trapHumHighAlarm=trapHumHighAlarm, humMax=humMax, trapCompValHighAlarm=trapCompValHighAlarm, historyEntry=historyEntry, trapCompValLowAlarm=trapCompValLowAlarm, values=values, humAlarmInt=humAlarmInt, tempHighInt=tempHighInt, trapHumError=trapHumError, trapTempLowAlarm=trapTempLowAlarm, humHighInt=humHighInt, tempAlarm=tempAlarm, humMin=humMin, DisplayString=DisplayString, tempInt=tempInt, tempMax=tempMax, humInt=humInt, trapSOAPErrFile=trapSOAPErrFile, trapHumClrAlarm=trapHumClrAlarm, compValHighInt=compValHighInt, pysmi_global=pysmi_global, settings=settings, compValInt=compValInt, tempHystInt=tempHystInt, serialNumber=serialNumber)
