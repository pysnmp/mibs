...
# Produced by pysmi-1.1.3 at Mon Nov 22 12:21:39 2021
...
Counter32, Integer32, Unsigned32, Bits, enterprises, TimeTicks, Counter64, ModuleIdentity, NotificationType, iso, NotificationType, Gauge32, ObjectIdentity, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "Unsigned32", "Bits", "enterprises", "TimeTicks", "Counter64", "ModuleIdentity", "NotificationType", "iso", "NotificationType", "Gauge32", "ObjectIdentity", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("T3610-MIB", trapTempClrAlarm=trapTempClrAlarm, humDelayInt=humDelayInt, trapNTPError=trapNTPError, compValAlarmInt=compValAlarmInt, tempInt=tempInt, compValMax=compValMax, trapTempError=trapTempError, humUnit=humUnit, trapHumHighAlarm=trapHumHighAlarm, values=values, humHystInt=humHystInt, trapEmailErrSocket=trapEmailErrSocket, historyTable=historyTable, products=products, tempMin=tempMin, compVal=compVal, tempDelayInt=tempDelayInt, trapEmailErrDNS=trapEmailErrDNS, tempHystInt=tempHystInt, trapCompValHighAlarm=trapCompValHighAlarm, deviceType=deviceType, compValHystInt=compValHystInt, humInt=humInt, trapCompValLowAlarm=trapCompValLowAlarm, DisplayString=DisplayString, temp=temp, compValInt=compValInt, trapTest=trapTest, trapHumError=trapHumError, valuesInt=valuesInt, tempUnit=tempUnit, trapHumLowAlarm=trapHumLowAlarm, settings=settings, pysmi_global=pysmi_global, historyEntry=historyEntry, histTemp=histTemp, serialNumber=serialNumber, trapCompValError=trapCompValError, trapTempHighAlarm=trapTempHighAlarm, hum=hum, compValDelayInt=compValDelayInt, trapSOAPErrDNS=trapSOAPErrDNS, compValLowInt=compValLowInt, humLowInt=humLowInt, sensorName=sensorName, traps=traps, histCompVal=histCompVal, histHum=histHum, trapEmailErrAuth=trapEmailErrAuth, t3610=t3610, tempMax=tempMax, humAlarmInt=humAlarmInt, tables=tables, trapCompValClrAlarm=trapCompValClrAlarm, humAlarm=humAlarm, messageString=messageString, tempAlarm=tempAlarm, tempLowInt=tempLowInt, trapEmailErrLogin=trapEmailErrLogin, trapTempLowAlarm=trapTempLowAlarm, comet=comet, humMax=humMax, trapEmailErrSome=trapEmailErrSome, trapSOAPErrSocket=trapSOAPErrSocket, compValMin=compValMin, trapSOAPErrFile=trapSOAPErrFile, humHighInt=humHighInt, compValUnit=compValUnit, tempHighInt=tempHighInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapHumClrAlarm=trapHumClrAlarm, compValHighInt=compValHighInt, compValAlarm=compValAlarm, humMin=humMin, tempAlarmInt=tempAlarmInt)
