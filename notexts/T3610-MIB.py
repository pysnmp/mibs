...
# Produced by pysmi-1.1.12 at Mon Jun  3 13:37:04 2024
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, MibIdentifier, Integer32, Counter64, iso, Gauge32, ModuleIdentity, ObjectIdentity, enterprises, TimeTicks, IpAddress, Unsigned32, NotificationType, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "MibIdentifier", "Integer32", "Counter64", "iso", "Gauge32", "ModuleIdentity", "ObjectIdentity", "enterprises", "TimeTicks", "IpAddress", "Unsigned32", "NotificationType", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", compVal=compVal, trapTempLowAlarm=trapTempLowAlarm, tables=tables, tempInt=tempInt, messageString=messageString, humDelayInt=humDelayInt, compValHighInt=compValHighInt, histTemp=histTemp, temp=temp, pysmi_global=pysmi_global, humHighInt=humHighInt, settings=settings, compValUnit=compValUnit, tempAlarmInt=tempAlarmInt, humLowInt=humLowInt, compValLowInt=compValLowInt, traps=traps, products=products, tempHystInt=tempHystInt, trapTempHighAlarm=trapTempHighAlarm, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValLowAlarm=trapCompValLowAlarm, tempUnit=tempUnit, tempDelayInt=tempDelayInt, humHystInt=humHystInt, historyTable=historyTable, compValMin=compValMin, trapTest=trapTest, trapNTPError=trapNTPError, tempMin=tempMin, trapEmailErrSocket=trapEmailErrSocket, trapHumError=trapHumError, humAlarm=humAlarm, humInt=humInt, trapSOAPErrFile=trapSOAPErrFile, trapTempClrAlarm=trapTempClrAlarm, histCompVal=histCompVal, compValMax=compValMax, compValDelayInt=compValDelayInt, humMax=humMax, t3610=t3610, humAlarmInt=humAlarmInt, tempHighInt=tempHighInt, humMin=humMin, trapHumClrAlarm=trapHumClrAlarm, valuesInt=valuesInt, compValAlarmInt=compValAlarmInt, trapEmailErrSome=trapEmailErrSome, tempAlarm=tempAlarm, serialNumber=serialNumber, tempLowInt=tempLowInt, histHum=histHum, trapSOAPErrDelivery=trapSOAPErrDelivery, humUnit=humUnit, trapEmailErrLogin=trapEmailErrLogin, DisplayString=DisplayString, trapCompValClrAlarm=trapCompValClrAlarm, trapEmailErrDNS=trapEmailErrDNS, compValInt=compValInt, trapCompValError=trapCompValError, tempMax=tempMax, comet=comet, trapSOAPErrDNS=trapSOAPErrDNS, trapEmailErrAuth=trapEmailErrAuth, values=values, historyEntry=historyEntry, sensorName=sensorName, hum=hum, deviceType=deviceType, trapCompValHighAlarm=trapCompValHighAlarm, trapHumLowAlarm=trapHumLowAlarm, compValAlarm=compValAlarm, trapHumHighAlarm=trapHumHighAlarm, trapTempError=trapTempError, compValHystInt=compValHystInt)
