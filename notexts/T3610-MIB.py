...
# Produced by pysmi-1.1.8 at Thu Sep  8 09:48:49 2022
...
NotificationType, Gauge32, ModuleIdentity, Bits, Integer32, ObjectIdentity, Counter32, Unsigned32, NotificationType, Counter64, MibIdentifier, iso, IpAddress, enterprises, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "ModuleIdentity", "Bits", "Integer32", "ObjectIdentity", "Counter32", "Unsigned32", "NotificationType", "Counter64", "MibIdentifier", "iso", "IpAddress", "enterprises", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("T3610-MIB", compValHighInt=compValHighInt, compValDelayInt=compValDelayInt, tempLowInt=tempLowInt, traps=traps, trapTempError=trapTempError, trapSOAPErrFile=trapSOAPErrFile, historyEntry=historyEntry, tables=tables, trapSOAPErrDNS=trapSOAPErrDNS, humMax=humMax, compValAlarmInt=compValAlarmInt, pysmi_global=pysmi_global, compValMax=compValMax, humLowInt=humLowInt, trapSOAPErrSocket=trapSOAPErrSocket, tempAlarm=tempAlarm, tempAlarmInt=tempAlarmInt, historyTable=historyTable, trapEmailErrDNS=trapEmailErrDNS, trapCompValHighAlarm=trapCompValHighAlarm, trapTempLowAlarm=trapTempLowAlarm, trapHumLowAlarm=trapHumLowAlarm, settings=settings, tempHighInt=tempHighInt, histTemp=histTemp, histCompVal=histCompVal, humHystInt=humHystInt, humUnit=humUnit, t3610=t3610, messageString=messageString, trapEmailErrSocket=trapEmailErrSocket, compValHystInt=compValHystInt, valuesInt=valuesInt, humMin=humMin, humInt=humInt, trapEmailErrSome=trapEmailErrSome, trapHumClrAlarm=trapHumClrAlarm, deviceType=deviceType, trapHumError=trapHumError, tempDelayInt=tempDelayInt, comet=comet, humAlarm=humAlarm, tempHystInt=tempHystInt, sensorName=sensorName, trapCompValLowAlarm=trapCompValLowAlarm, compVal=compVal, values=values, trapCompValError=trapCompValError, tempMax=tempMax, products=products, humHighInt=humHighInt, tempInt=tempInt, trapEmailErrLogin=trapEmailErrLogin, compValAlarm=compValAlarm, tempUnit=tempUnit, compValUnit=compValUnit, compValInt=compValInt, humDelayInt=humDelayInt, trapHumHighAlarm=trapHumHighAlarm, trapTempClrAlarm=trapTempClrAlarm, tempMin=tempMin, trapCompValClrAlarm=trapCompValClrAlarm, compValMin=compValMin, compValLowInt=compValLowInt, trapTest=trapTest, serialNumber=serialNumber, trapSOAPErrDelivery=trapSOAPErrDelivery, trapNTPError=trapNTPError, humAlarmInt=humAlarmInt, trapTempHighAlarm=trapTempHighAlarm, trapEmailErrAuth=trapEmailErrAuth, histHum=histHum, hum=hum, DisplayString=DisplayString, temp=temp)
