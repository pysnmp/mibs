...
# Produced by pysmi-1.1.8 at Fri Sep  8 11:05:00 2023
...
Gauge32, Bits, ObjectIdentity, Unsigned32, enterprises, Counter64, NotificationType, IpAddress, Integer32, MibIdentifier, TimeTicks, NotificationType, Counter32, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Bits", "ObjectIdentity", "Unsigned32", "enterprises", "Counter64", "NotificationType", "IpAddress", "Integer32", "MibIdentifier", "TimeTicks", "NotificationType", "Counter32", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("T3610-MIB", values=values, tempUnit=tempUnit, temp=temp, trapCompValError=trapCompValError, trapEmailErrDNS=trapEmailErrDNS, histTemp=histTemp, compValAlarm=compValAlarm, tempInt=tempInt, trapEmailErrAuth=trapEmailErrAuth, trapTest=trapTest, trapSOAPErrDelivery=trapSOAPErrDelivery, tempHystInt=tempHystInt, compValDelayInt=compValDelayInt, messageString=messageString, compValInt=compValInt, humMin=humMin, valuesInt=valuesInt, DisplayString=DisplayString, compValHighInt=compValHighInt, tempDelayInt=tempDelayInt, trapSOAPErrSocket=trapSOAPErrSocket, compValUnit=compValUnit, pysmi_global=pysmi_global, t3610=t3610, historyTable=historyTable, trapHumLowAlarm=trapHumLowAlarm, trapEmailErrSocket=trapEmailErrSocket, deviceType=deviceType, humHighInt=humHighInt, sensorName=sensorName, trapTempError=trapTempError, trapTempHighAlarm=trapTempHighAlarm, humMax=humMax, humUnit=humUnit, trapHumClrAlarm=trapHumClrAlarm, humAlarmInt=humAlarmInt, historyEntry=historyEntry, tempAlarm=tempAlarm, humLowInt=humLowInt, tempAlarmInt=tempAlarmInt, trapEmailErrSome=trapEmailErrSome, settings=settings, humAlarm=humAlarm, compValAlarmInt=compValAlarmInt, trapCompValHighAlarm=trapCompValHighAlarm, compValLowInt=compValLowInt, histHum=histHum, tempMax=tempMax, humInt=humInt, serialNumber=serialNumber, humDelayInt=humDelayInt, compValMin=compValMin, compValMax=compValMax, trapHumHighAlarm=trapHumHighAlarm, tempMin=tempMin, comet=comet, compValHystInt=compValHystInt, humHystInt=humHystInt, trapSOAPErrFile=trapSOAPErrFile, trapCompValLowAlarm=trapCompValLowAlarm, trapCompValClrAlarm=trapCompValClrAlarm, tempHighInt=tempHighInt, trapSOAPErrDNS=trapSOAPErrDNS, products=products, traps=traps, trapTempLowAlarm=trapTempLowAlarm, trapEmailErrLogin=trapEmailErrLogin, tempLowInt=tempLowInt, histCompVal=histCompVal, trapNTPError=trapNTPError, hum=hum, compVal=compVal, trapTempClrAlarm=trapTempClrAlarm, tables=tables, trapHumError=trapHumError)
