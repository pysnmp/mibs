...
# Produced by pysmi-1.1.8 at Fri Jul  8 09:14:44 2022
...
NotificationType, Counter64, Unsigned32, Counter32, IpAddress, MibIdentifier, iso, Gauge32, Bits, ObjectIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, NotificationType, enterprises, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "Unsigned32", "Counter32", "IpAddress", "MibIdentifier", "iso", "Gauge32", "Bits", "ObjectIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "NotificationType", "enterprises", "Integer32")
...
mibBuilder.exportSymbols("T3610-MIB", humInt=humInt, humMax=humMax, trapSOAPErrSocket=trapSOAPErrSocket, histHum=histHum, tempMin=tempMin, compValAlarmInt=compValAlarmInt, compValDelayInt=compValDelayInt, compValMax=compValMax, trapNTPError=trapNTPError, trapCompValClrAlarm=trapCompValClrAlarm, trapEmailErrLogin=trapEmailErrLogin, histCompVal=histCompVal, trapHumLowAlarm=trapHumLowAlarm, pysmi_global=pysmi_global, tempMax=tempMax, deviceType=deviceType, trapEmailErrSocket=trapEmailErrSocket, histTemp=histTemp, humAlarmInt=humAlarmInt, trapTempClrAlarm=trapTempClrAlarm, tempHighInt=tempHighInt, trapTempHighAlarm=trapTempHighAlarm, compValInt=compValInt, trapHumClrAlarm=trapHumClrAlarm, trapSOAPErrDNS=trapSOAPErrDNS, compVal=compVal, trapCompValError=trapCompValError, values=values, DisplayString=DisplayString, compValMin=compValMin, serialNumber=serialNumber, humLowInt=humLowInt, humHighInt=humHighInt, tables=tables, compValLowInt=compValLowInt, trapSOAPErrDelivery=trapSOAPErrDelivery, products=products, tempHystInt=tempHystInt, trapCompValHighAlarm=trapCompValHighAlarm, tempAlarm=tempAlarm, traps=traps, tempDelayInt=tempDelayInt, tempInt=tempInt, humHystInt=humHystInt, trapHumError=trapHumError, hum=hum, t3610=t3610, compValHighInt=compValHighInt, compValHystInt=compValHystInt, tempLowInt=tempLowInt, historyEntry=historyEntry, valuesInt=valuesInt, humAlarm=humAlarm, humDelayInt=humDelayInt, historyTable=historyTable, trapTempLowAlarm=trapTempLowAlarm, trapEmailErrSome=trapEmailErrSome, humUnit=humUnit, trapTest=trapTest, tempUnit=tempUnit, sensorName=sensorName, trapTempError=trapTempError, trapEmailErrDNS=trapEmailErrDNS, settings=settings, tempAlarmInt=tempAlarmInt, comet=comet, temp=temp, compValAlarm=compValAlarm, compValUnit=compValUnit, humMin=humMin, trapEmailErrAuth=trapEmailErrAuth, trapHumHighAlarm=trapHumHighAlarm, trapCompValLowAlarm=trapCompValLowAlarm, messageString=messageString, trapSOAPErrFile=trapSOAPErrFile)
