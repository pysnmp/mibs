...
# Produced by pysmi-1.1.12 at Wed May 29 07:59:22 2024
...
TimeTicks, enterprises, ModuleIdentity, iso, Bits, Counter32, NotificationType, Gauge32, ObjectIdentity, Unsigned32, MibIdentifier, Counter64, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "enterprises", "ModuleIdentity", "iso", "Bits", "Counter32", "NotificationType", "Gauge32", "ObjectIdentity", "Unsigned32", "MibIdentifier", "Counter64", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
...
mibBuilder.exportSymbols("T3610-MIB", historyEntry=historyEntry, compVal=compVal, serialNumber=serialNumber, trapEmailErrSome=trapEmailErrSome, compValMin=compValMin, humAlarm=humAlarm, humMin=humMin, trapCompValLowAlarm=trapCompValLowAlarm, tempLowInt=tempLowInt, humDelayInt=humDelayInt, trapSOAPErrDelivery=trapSOAPErrDelivery, compValInt=compValInt, tempInt=tempInt, products=products, trapSOAPErrDNS=trapSOAPErrDNS, trapEmailErrDNS=trapEmailErrDNS, tempHighInt=tempHighInt, trapCompValHighAlarm=trapCompValHighAlarm, valuesInt=valuesInt, hum=hum, sensorName=sensorName, trapTempLowAlarm=trapTempLowAlarm, humUnit=humUnit, trapTempError=trapTempError, trapCompValError=trapCompValError, compValAlarm=compValAlarm, humAlarmInt=humAlarmInt, humHighInt=humHighInt, trapHumHighAlarm=trapHumHighAlarm, trapEmailErrSocket=trapEmailErrSocket, trapTempHighAlarm=trapTempHighAlarm, traps=traps, t3610=t3610, humHystInt=humHystInt, compValHystInt=compValHystInt, historyTable=historyTable, trapSOAPErrFile=trapSOAPErrFile, pysmi_global=pysmi_global, tables=tables, trapTest=trapTest, messageString=messageString, trapEmailErrAuth=trapEmailErrAuth, tempMin=tempMin, settings=settings, temp=temp, tempUnit=tempUnit, trapNTPError=trapNTPError, humMax=humMax, compValHighInt=compValHighInt, trapSOAPErrSocket=trapSOAPErrSocket, deviceType=deviceType, compValUnit=compValUnit, tempDelayInt=tempDelayInt, trapCompValClrAlarm=trapCompValClrAlarm, trapTempClrAlarm=trapTempClrAlarm, histCompVal=histCompVal, compValDelayInt=compValDelayInt, trapHumError=trapHumError, comet=comet, trapHumLowAlarm=trapHumLowAlarm, tempAlarmInt=tempAlarmInt, humInt=humInt, compValLowInt=compValLowInt, DisplayString=DisplayString, tempAlarm=tempAlarm, histTemp=histTemp, histHum=histHum, tempMax=tempMax, humLowInt=humLowInt, tempHystInt=tempHystInt, compValMax=compValMax, trapHumClrAlarm=trapHumClrAlarm, trapEmailErrLogin=trapEmailErrLogin, compValAlarmInt=compValAlarmInt, values=values)
