...
# Produced by pysmi-1.1.12 at Tue Dec  3 10:04:16 2024
...
MibIdentifier, Integer32, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, NotificationType, IpAddress, Gauge32, Unsigned32, ObjectIdentity, enterprises, Counter32, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Integer32", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "NotificationType", "IpAddress", "Gauge32", "Unsigned32", "ObjectIdentity", "enterprises", "Counter32", "ModuleIdentity", "Counter64")
...
mibBuilder.exportSymbols("T3610-MIB", valuesInt=valuesInt, serialNumber=serialNumber, tempAlarmInt=tempAlarmInt, comet=comet, values=values, compValHystInt=compValHystInt, compValDelayInt=compValDelayInt, histHum=histHum, trapCompValError=trapCompValError, compValUnit=compValUnit, trapHumLowAlarm=trapHumLowAlarm, histCompVal=histCompVal, humAlarmInt=humAlarmInt, trapSOAPErrDelivery=trapSOAPErrDelivery, humDelayInt=humDelayInt, trapEmailErrLogin=trapEmailErrLogin, tempLowInt=tempLowInt, trapHumClrAlarm=trapHumClrAlarm, trapCompValClrAlarm=trapCompValClrAlarm, tempMax=tempMax, t3610=t3610, humMax=humMax, deviceType=deviceType, compValAlarmInt=compValAlarmInt, compValHighInt=compValHighInt, humLowInt=humLowInt, histTemp=histTemp, compVal=compVal, humMin=humMin, trapSOAPErrFile=trapSOAPErrFile, humHystInt=humHystInt, trapEmailErrSocket=trapEmailErrSocket, trapHumHighAlarm=trapHumHighAlarm, pysmi_global=pysmi_global, compValAlarm=compValAlarm, tables=tables, sensorName=sensorName, tempInt=tempInt, historyEntry=historyEntry, trapTempClrAlarm=trapTempClrAlarm, historyTable=historyTable, tempDelayInt=tempDelayInt, humHighInt=humHighInt, settings=settings, trapCompValLowAlarm=trapCompValLowAlarm, compValMin=compValMin, trapTempError=trapTempError, tempAlarm=tempAlarm, temp=temp, tempUnit=tempUnit, products=products, tempHystInt=tempHystInt, trapEmailErrAuth=trapEmailErrAuth, trapTempLowAlarm=trapTempLowAlarm, tempMin=tempMin, compValMax=compValMax, compValInt=compValInt, compValLowInt=compValLowInt, trapTest=trapTest, trapTempHighAlarm=trapTempHighAlarm, tempHighInt=tempHighInt, trapNTPError=trapNTPError, trapHumError=trapHumError, humAlarm=humAlarm, messageString=messageString, traps=traps, trapEmailErrDNS=trapEmailErrDNS, trapCompValHighAlarm=trapCompValHighAlarm, humUnit=humUnit, DisplayString=DisplayString, trapSOAPErrDNS=trapSOAPErrDNS, humInt=humInt, trapEmailErrSome=trapEmailErrSome, hum=hum, trapSOAPErrSocket=trapSOAPErrSocket)
