...
# Produced by pysmi-1.1.3 at Mon Nov 22 19:36:26 2021
...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, ObjectIdentity, Bits, MibIdentifier, enterprises, Counter32, NotificationType, Counter64, Unsigned32, Gauge32, iso, TimeTicks, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "ObjectIdentity", "Bits", "MibIdentifier", "enterprises", "Counter32", "NotificationType", "Counter64", "Unsigned32", "Gauge32", "iso", "TimeTicks", "IpAddress", "Integer32")
...
mibBuilder.exportSymbols("T3610-MIB", trapEmailErrLogin=trapEmailErrLogin, products=products, histCompVal=histCompVal, sensorName=sensorName, tempAlarmInt=tempAlarmInt, histHum=histHum, values=values, compValAlarm=compValAlarm, tempInt=tempInt, hum=hum, compValAlarmInt=compValAlarmInt, compValHystInt=compValHystInt, trapSOAPErrDNS=trapSOAPErrDNS, tempHystInt=tempHystInt, trapTempLowAlarm=trapTempLowAlarm, trapCompValHighAlarm=trapCompValHighAlarm, trapCompValError=trapCompValError, tempDelayInt=tempDelayInt, trapSOAPErrSocket=trapSOAPErrSocket, trapTempClrAlarm=trapTempClrAlarm, tempMin=tempMin, comet=comet, compValInt=compValInt, t3610=t3610, tempLowInt=tempLowInt, humHighInt=humHighInt, humAlarm=humAlarm, DisplayString=DisplayString, historyTable=historyTable, trapSOAPErrFile=trapSOAPErrFile, trapHumHighAlarm=trapHumHighAlarm, trapHumClrAlarm=trapHumClrAlarm, humLowInt=humLowInt, compValDelayInt=compValDelayInt, histTemp=histTemp, trapEmailErrSocket=trapEmailErrSocket, messageString=messageString, humMin=humMin, compValMin=compValMin, trapEmailErrAuth=trapEmailErrAuth, trapEmailErrSome=trapEmailErrSome, compValLowInt=compValLowInt, trapHumError=trapHumError, settings=settings, tempUnit=tempUnit, compValUnit=compValUnit, tempMax=tempMax, compValHighInt=compValHighInt, temp=temp, humDelayInt=humDelayInt, humAlarmInt=humAlarmInt, trapTest=trapTest, trapHumLowAlarm=trapHumLowAlarm, humMax=humMax, tempHighInt=tempHighInt, humUnit=humUnit, trapCompValLowAlarm=trapCompValLowAlarm, tables=tables, historyEntry=historyEntry, humHystInt=humHystInt, trapNTPError=trapNTPError, tempAlarm=tempAlarm, trapEmailErrDNS=trapEmailErrDNS, trapTempHighAlarm=trapTempHighAlarm, pysmi_global=pysmi_global, compValMax=compValMax, deviceType=deviceType, humInt=humInt, valuesInt=valuesInt, trapCompValClrAlarm=trapCompValClrAlarm, trapTempError=trapTempError, serialNumber=serialNumber, traps=traps, compVal=compVal, trapSOAPErrDelivery=trapSOAPErrDelivery)
