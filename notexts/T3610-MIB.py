...
# Produced by pysmi-1.1.8 at Wed Jun 29 15:03:36 2022
...
enterprises, NotificationType, iso, MibIdentifier, Gauge32, IpAddress, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, Unsigned32, TimeTicks, NotificationType, ModuleIdentity, Counter64, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "NotificationType", "iso", "MibIdentifier", "Gauge32", "IpAddress", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "Unsigned32", "TimeTicks", "NotificationType", "ModuleIdentity", "Counter64", "ObjectIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", histTemp=histTemp, histHum=histHum, deviceType=deviceType, compValHighInt=compValHighInt, historyEntry=historyEntry, trapCompValError=trapCompValError, trapTempClrAlarm=trapTempClrAlarm, hum=hum, trapSOAPErrDelivery=trapSOAPErrDelivery, compValUnit=compValUnit, humDelayInt=humDelayInt, trapHumLowAlarm=trapHumLowAlarm, messageString=messageString, trapEmailErrSome=trapEmailErrSome, tempAlarm=tempAlarm, trapEmailErrSocket=trapEmailErrSocket, tempUnit=tempUnit, humAlarmInt=humAlarmInt, compValMax=compValMax, trapHumHighAlarm=trapHumHighAlarm, humAlarm=humAlarm, settings=settings, historyTable=historyTable, trapSOAPErrSocket=trapSOAPErrSocket, pysmi_global=pysmi_global, humHighInt=humHighInt, tempHystInt=tempHystInt, t3610=t3610, compValHystInt=compValHystInt, trapHumError=trapHumError, trapEmailErrLogin=trapEmailErrLogin, tempDelayInt=tempDelayInt, tables=tables, traps=traps, compVal=compVal, tempHighInt=tempHighInt, humHystInt=humHystInt, tempMin=tempMin, humUnit=humUnit, humMin=humMin, humInt=humInt, tempMax=tempMax, serialNumber=serialNumber, trapEmailErrDNS=trapEmailErrDNS, trapCompValHighAlarm=trapCompValHighAlarm, trapSOAPErrFile=trapSOAPErrFile, humMax=humMax, tempInt=tempInt, compValAlarm=compValAlarm, humLowInt=humLowInt, trapTempLowAlarm=trapTempLowAlarm, histCompVal=histCompVal, valuesInt=valuesInt, trapTempError=trapTempError, compValLowInt=compValLowInt, trapEmailErrAuth=trapEmailErrAuth, trapCompValClrAlarm=trapCompValClrAlarm, temp=temp, compValInt=compValInt, compValMin=compValMin, compValDelayInt=compValDelayInt, compValAlarmInt=compValAlarmInt, trapTest=trapTest, trapSOAPErrDNS=trapSOAPErrDNS, products=products, sensorName=sensorName, DisplayString=DisplayString, trapNTPError=trapNTPError, trapHumClrAlarm=trapHumClrAlarm, trapCompValLowAlarm=trapCompValLowAlarm, comet=comet, trapTempHighAlarm=trapTempHighAlarm, tempAlarmInt=tempAlarmInt, tempLowInt=tempLowInt, values=values)
