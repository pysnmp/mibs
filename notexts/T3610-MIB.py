...
# Produced by pysmi-1.1.8 at Fri Dec  2 16:41:29 2022
...
iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, enterprises, MibIdentifier, Unsigned32, Bits, Counter32, NotificationType, Gauge32, ModuleIdentity, ObjectIdentity, NotificationType, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "enterprises", "MibIdentifier", "Unsigned32", "Bits", "Counter32", "NotificationType", "Gauge32", "ModuleIdentity", "ObjectIdentity", "NotificationType", "Integer32")
...
mibBuilder.exportSymbols("T3610-MIB", deviceType=deviceType, trapTest=trapTest, tempDelayInt=tempDelayInt, trapTempError=trapTempError, compValInt=compValInt, traps=traps, tempAlarmInt=tempAlarmInt, trapEmailErrLogin=trapEmailErrLogin, trapEmailErrSome=trapEmailErrSome, trapEmailErrDNS=trapEmailErrDNS, trapTempClrAlarm=trapTempClrAlarm, valuesInt=valuesInt, trapHumClrAlarm=trapHumClrAlarm, tempInt=tempInt, compValAlarm=compValAlarm, compValHighInt=compValHighInt, DisplayString=DisplayString, compVal=compVal, tempMin=tempMin, historyEntry=historyEntry, tempAlarm=tempAlarm, historyTable=historyTable, settings=settings, humMin=humMin, trapEmailErrAuth=trapEmailErrAuth, products=products, humDelayInt=humDelayInt, humLowInt=humLowInt, trapCompValLowAlarm=trapCompValLowAlarm, humUnit=humUnit, trapCompValHighAlarm=trapCompValHighAlarm, trapSOAPErrFile=trapSOAPErrFile, compValUnit=compValUnit, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTempHighAlarm=trapTempHighAlarm, compValAlarmInt=compValAlarmInt, pysmi_global=pysmi_global, tempHystInt=tempHystInt, humHystInt=humHystInt, humInt=humInt, trapNTPError=trapNTPError, messageString=messageString, tempMax=tempMax, temp=temp, trapCompValClrAlarm=trapCompValClrAlarm, compValMax=compValMax, t3610=t3610, histTemp=histTemp, tempHighInt=tempHighInt, humAlarmInt=humAlarmInt, trapEmailErrSocket=trapEmailErrSocket, trapHumError=trapHumError, tables=tables, trapSOAPErrSocket=trapSOAPErrSocket, sensorName=sensorName, tempLowInt=tempLowInt, humAlarm=humAlarm, hum=hum, compValDelayInt=compValDelayInt, values=values, histHum=histHum, trapCompValError=trapCompValError, compValLowInt=compValLowInt, histCompVal=histCompVal, humHighInt=humHighInt, tempUnit=tempUnit, humMax=humMax, serialNumber=serialNumber, trapHumHighAlarm=trapHumHighAlarm, trapTempLowAlarm=trapTempLowAlarm, trapHumLowAlarm=trapHumLowAlarm, comet=comet, trapSOAPErrDNS=trapSOAPErrDNS, compValHystInt=compValHystInt, compValMin=compValMin)
