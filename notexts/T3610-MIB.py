...
# Produced by pysmi-1.1.8 at Tue Jan 11 20:31:59 2022
...
ModuleIdentity, Bits, IpAddress, Integer32, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, NotificationType, Unsigned32, Counter32, enterprises, TimeTicks, iso, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "IpAddress", "Integer32", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "NotificationType", "Unsigned32", "Counter32", "enterprises", "TimeTicks", "iso", "MibIdentifier")
...
mibBuilder.exportSymbols("T3610-MIB", tempAlarmInt=tempAlarmInt, trapTempLowAlarm=trapTempLowAlarm, trapTempError=trapTempError, tables=tables, tempHighInt=tempHighInt, DisplayString=DisplayString, tempInt=tempInt, trapHumLowAlarm=trapHumLowAlarm, tempUnit=tempUnit, compValUnit=compValUnit, values=values, compValMax=compValMax, serialNumber=serialNumber, trapTest=trapTest, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrFile=trapSOAPErrFile, trapCompValLowAlarm=trapCompValLowAlarm, compValMin=compValMin, humMin=humMin, tempHystInt=tempHystInt, historyEntry=historyEntry, trapCompValClrAlarm=trapCompValClrAlarm, compValHystInt=compValHystInt, humMax=humMax, humLowInt=humLowInt, compValAlarm=compValAlarm, tempDelayInt=tempDelayInt, valuesInt=valuesInt, temp=temp, sensorName=sensorName, compValLowInt=compValLowInt, histTemp=histTemp, trapHumClrAlarm=trapHumClrAlarm, pysmi_global=pysmi_global, traps=traps, humAlarm=humAlarm, trapTempHighAlarm=trapTempHighAlarm, trapHumError=trapHumError, tempLowInt=tempLowInt, humAlarmInt=humAlarmInt, compValAlarmInt=compValAlarmInt, humUnit=humUnit, messageString=messageString, historyTable=historyTable, trapNTPError=trapNTPError, humHystInt=humHystInt, trapEmailErrDNS=trapEmailErrDNS, trapTempClrAlarm=trapTempClrAlarm, hum=hum, compValDelayInt=compValDelayInt, tempAlarm=tempAlarm, histCompVal=histCompVal, compValHighInt=compValHighInt, trapSOAPErrSocket=trapSOAPErrSocket, histHum=histHum, trapEmailErrSocket=trapEmailErrSocket, trapCompValHighAlarm=trapCompValHighAlarm, compVal=compVal, compValInt=compValInt, products=products, trapCompValError=trapCompValError, settings=settings, tempMin=tempMin, trapSOAPErrDNS=trapSOAPErrDNS, humDelayInt=humDelayInt, trapSOAPErrDelivery=trapSOAPErrDelivery, humHighInt=humHighInt, tempMax=tempMax, trapEmailErrSome=trapEmailErrSome, humInt=humInt, deviceType=deviceType, t3610=t3610, trapHumHighAlarm=trapHumHighAlarm, comet=comet, trapEmailErrLogin=trapEmailErrLogin)
