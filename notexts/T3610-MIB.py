...
# Produced by pysmi-1.1.8 at Thu Jan 13 23:43:08 2022
...
TimeTicks, ModuleIdentity, Bits, enterprises, Counter32, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, MibIdentifier, Integer32, Counter64, Gauge32, NotificationType, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "Bits", "enterprises", "Counter32", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "MibIdentifier", "Integer32", "Counter64", "Gauge32", "NotificationType", "iso", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", histCompVal=histCompVal, compVal=compVal, compValHighInt=compValHighInt, compValMin=compValMin, trapCompValError=trapCompValError, trapCompValClrAlarm=trapCompValClrAlarm, humUnit=humUnit, trapSOAPErrDNS=trapSOAPErrDNS, trapCompValHighAlarm=trapCompValHighAlarm, comet=comet, trapSOAPErrFile=trapSOAPErrFile, compValInt=compValInt, tempMin=tempMin, trapNTPError=trapNTPError, tempMax=tempMax, tempUnit=tempUnit, trapTempLowAlarm=trapTempLowAlarm, trapTempError=trapTempError, settings=settings, humLowInt=humLowInt, tempHystInt=tempHystInt, tables=tables, humMin=humMin, trapCompValLowAlarm=trapCompValLowAlarm, histTemp=histTemp, compValAlarm=compValAlarm, trapHumHighAlarm=trapHumHighAlarm, compValDelayInt=compValDelayInt, messageString=messageString, humHighInt=humHighInt, t3610=t3610, humMax=humMax, trapEmailErrSome=trapEmailErrSome, DisplayString=DisplayString, trapEmailErrSocket=trapEmailErrSocket, trapEmailErrDNS=trapEmailErrDNS, trapTempClrAlarm=trapTempClrAlarm, compValLowInt=compValLowInt, trapSOAPErrSocket=trapSOAPErrSocket, humInt=humInt, trapHumClrAlarm=trapHumClrAlarm, temp=temp, compValAlarmInt=compValAlarmInt, serialNumber=serialNumber, tempLowInt=tempLowInt, histHum=histHum, hum=hum, compValUnit=compValUnit, tempDelayInt=tempDelayInt, historyEntry=historyEntry, trapTempHighAlarm=trapTempHighAlarm, valuesInt=valuesInt, trapTest=trapTest, humDelayInt=humDelayInt, compValHystInt=compValHystInt, sensorName=sensorName, compValMax=compValMax, trapHumError=trapHumError, traps=traps, tempAlarm=tempAlarm, tempAlarmInt=tempAlarmInt, historyTable=historyTable, trapSOAPErrDelivery=trapSOAPErrDelivery, values=values, deviceType=deviceType, humAlarm=humAlarm, tempInt=tempInt, humAlarmInt=humAlarmInt, products=products, humHystInt=humHystInt, tempHighInt=tempHighInt, trapEmailErrAuth=trapEmailErrAuth, trapHumLowAlarm=trapHumLowAlarm, trapEmailErrLogin=trapEmailErrLogin, pysmi_global=pysmi_global)
