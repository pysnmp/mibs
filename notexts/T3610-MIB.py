...
# Produced by pysmi-1.1.12 at Tue May 28 12:32:27 2024
...
ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter64, NotificationType, Integer32, Counter32, Gauge32, Unsigned32, iso, enterprises, ModuleIdentity, MibIdentifier, TimeTicks, Bits, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter64", "NotificationType", "Integer32", "Counter32", "Gauge32", "Unsigned32", "iso", "enterprises", "ModuleIdentity", "MibIdentifier", "TimeTicks", "Bits", "IpAddress")
...
mibBuilder.exportSymbols("T3610-MIB", tempAlarm=tempAlarm, humHighInt=humHighInt, compValLowInt=compValLowInt, humLowInt=humLowInt, humMin=humMin, trapTempHighAlarm=trapTempHighAlarm, historyEntry=historyEntry, deviceType=deviceType, sensorName=sensorName, tables=tables, trapSOAPErrSocket=trapSOAPErrSocket, products=products, valuesInt=valuesInt, traps=traps, trapNTPError=trapNTPError, trapTempLowAlarm=trapTempLowAlarm, trapCompValLowAlarm=trapCompValLowAlarm, trapEmailErrLogin=trapEmailErrLogin, tempUnit=tempUnit, compValUnit=compValUnit, humUnit=humUnit, compValAlarm=compValAlarm, tempHighInt=tempHighInt, compValDelayInt=compValDelayInt, tempHystInt=tempHystInt, histHum=histHum, trapEmailErrSome=trapEmailErrSome, serialNumber=serialNumber, trapHumHighAlarm=trapHumHighAlarm, temp=temp, compVal=compVal, humInt=humInt, compValHighInt=compValHighInt, histTemp=histTemp, values=values, compValInt=compValInt, histCompVal=histCompVal, comet=comet, trapHumClrAlarm=trapHumClrAlarm, compValAlarmInt=compValAlarmInt, trapCompValError=trapCompValError, trapSOAPErrFile=trapSOAPErrFile, tempLowInt=tempLowInt, trapEmailErrSocket=trapEmailErrSocket, trapTest=trapTest, trapTempError=trapTempError, trapEmailErrAuth=trapEmailErrAuth, trapHumError=trapHumError, pysmi_global=pysmi_global, t3610=t3610, trapCompValClrAlarm=trapCompValClrAlarm, tempMax=tempMax, compValMax=compValMax, trapHumLowAlarm=trapHumLowAlarm, messageString=messageString, humDelayInt=humDelayInt, tempInt=tempInt, humAlarm=humAlarm, humHystInt=humHystInt, trapCompValHighAlarm=trapCompValHighAlarm, trapEmailErrDNS=trapEmailErrDNS, tempMin=tempMin, humMax=humMax, trapSOAPErrDNS=trapSOAPErrDNS, hum=hum, compValMin=compValMin, tempDelayInt=tempDelayInt, trapSOAPErrDelivery=trapSOAPErrDelivery, settings=settings, tempAlarmInt=tempAlarmInt, compValHystInt=compValHystInt, trapTempClrAlarm=trapTempClrAlarm, historyTable=historyTable, DisplayString=DisplayString, humAlarmInt=humAlarmInt)
