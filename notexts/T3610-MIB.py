...
# Produced by pysmi-1.1.8 at Tue Feb  8 22:28:08 2022
...
Integer32, Bits, enterprises, Gauge32, iso, ModuleIdentity, ObjectIdentity, Counter64, IpAddress, NotificationType, MibIdentifier, Counter32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "enterprises", "Gauge32", "iso", "ModuleIdentity", "ObjectIdentity", "Counter64", "IpAddress", "NotificationType", "MibIdentifier", "Counter32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", trapSOAPErrFile=trapSOAPErrFile, trapTempLowAlarm=trapTempLowAlarm, trapTempError=trapTempError, compValMax=compValMax, serialNumber=serialNumber, values=values, t3610=t3610, humLowInt=humLowInt, compValLowInt=compValLowInt, tables=tables, humDelayInt=humDelayInt, trapSOAPErrSocket=trapSOAPErrSocket, trapSOAPErrDelivery=trapSOAPErrDelivery, histCompVal=histCompVal, temp=temp, trapEmailErrDNS=trapEmailErrDNS, trapSOAPErrDNS=trapSOAPErrDNS, humMin=humMin, tempHystInt=tempHystInt, trapHumLowAlarm=trapHumLowAlarm, humUnit=humUnit, tempLowInt=tempLowInt, trapCompValLowAlarm=trapCompValLowAlarm, humAlarm=humAlarm, trapCompValError=trapCompValError, compValHystInt=compValHystInt, tempAlarmInt=tempAlarmInt, messageString=messageString, trapCompValClrAlarm=trapCompValClrAlarm, valuesInt=valuesInt, compValUnit=compValUnit, compValInt=compValInt, trapEmailErrSocket=trapEmailErrSocket, humHystInt=humHystInt, compValAlarm=compValAlarm, historyTable=historyTable, comet=comet, compValAlarmInt=compValAlarmInt, histHum=histHum, trapTempHighAlarm=trapTempHighAlarm, trapTest=trapTest, trapHumHighAlarm=trapHumHighAlarm, compVal=compVal, trapEmailErrAuth=trapEmailErrAuth, tempInt=tempInt, trapEmailErrSome=trapEmailErrSome, humInt=humInt, trapNTPError=trapNTPError, trapEmailErrLogin=trapEmailErrLogin, historyEntry=historyEntry, DisplayString=DisplayString, hum=hum, compValMin=compValMin, trapHumError=trapHumError, tempDelayInt=tempDelayInt, traps=traps, histTemp=histTemp, humMax=humMax, tempHighInt=tempHighInt, tempMax=tempMax, compValHighInt=compValHighInt, compValDelayInt=compValDelayInt, settings=settings, products=products, tempAlarm=tempAlarm, tempUnit=tempUnit, sensorName=sensorName, deviceType=deviceType, pysmi_global=pysmi_global, humAlarmInt=humAlarmInt, humHighInt=humHighInt, trapCompValHighAlarm=trapCompValHighAlarm, trapTempClrAlarm=trapTempClrAlarm, trapHumClrAlarm=trapHumClrAlarm, tempMin=tempMin)
