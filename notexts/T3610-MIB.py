...
# Produced by pysmi-1.1.8 at Tue Jan 18 15:06:42 2022
...
Gauge32, enterprises, NotificationType, Integer32, Counter64, Unsigned32, Bits, MibIdentifier, iso, ModuleIdentity, IpAddress, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ObjectIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "enterprises", "NotificationType", "Integer32", "Counter64", "Unsigned32", "Bits", "MibIdentifier", "iso", "ModuleIdentity", "IpAddress", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ObjectIdentity", "Counter32")
...
mibBuilder.exportSymbols("T3610-MIB", compValMin=compValMin, trapTempLowAlarm=trapTempLowAlarm, valuesInt=valuesInt, humAlarm=humAlarm, compValDelayInt=compValDelayInt, compValHighInt=compValHighInt, trapSOAPErrFile=trapSOAPErrFile, trapEmailErrSome=trapEmailErrSome, deviceType=deviceType, compValAlarmInt=compValAlarmInt, trapSOAPErrDNS=trapSOAPErrDNS, historyEntry=historyEntry, settings=settings, humMin=humMin, trapEmailErrAuth=trapEmailErrAuth, tempUnit=tempUnit, traps=traps, trapEmailErrLogin=trapEmailErrLogin, trapEmailErrDNS=trapEmailErrDNS, trapCompValError=trapCompValError, tempDelayInt=tempDelayInt, trapEmailErrSocket=trapEmailErrSocket, compValMax=compValMax, compValUnit=compValUnit, tempAlarmInt=tempAlarmInt, tables=tables, products=products, trapTest=trapTest, trapCompValClrAlarm=trapCompValClrAlarm, comet=comet, tempMin=tempMin, temp=temp, humMax=humMax, serialNumber=serialNumber, tempInt=tempInt, tempHighInt=tempHighInt, messageString=messageString, trapNTPError=trapNTPError, humAlarmInt=humAlarmInt, t3610=t3610, trapSOAPErrDelivery=trapSOAPErrDelivery, trapHumHighAlarm=trapHumHighAlarm, trapCompValLowAlarm=trapCompValLowAlarm, trapTempClrAlarm=trapTempClrAlarm, trapHumError=trapHumError, humInt=humInt, histCompVal=histCompVal, historyTable=historyTable, sensorName=sensorName, humUnit=humUnit, trapTempHighAlarm=trapTempHighAlarm, humHighInt=humHighInt, compValInt=compValInt, humLowInt=humLowInt, compValHystInt=compValHystInt, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValHighAlarm=trapCompValHighAlarm, compValLowInt=compValLowInt, humDelayInt=humDelayInt, trapHumLowAlarm=trapHumLowAlarm, tempLowInt=tempLowInt, trapHumClrAlarm=trapHumClrAlarm, histHum=histHum, trapTempError=trapTempError, DisplayString=DisplayString, tempAlarm=tempAlarm, values=values, hum=hum, tempHystInt=tempHystInt, histTemp=histTemp, humHystInt=humHystInt, compValAlarm=compValAlarm, compVal=compVal, tempMax=tempMax, pysmi_global=pysmi_global)
