...
# Produced by pysmi-1.1.8 at Thu Sep 15 09:07:31 2022
...
iso, Gauge32, ObjectIdentity, Bits, IpAddress, Counter32, Counter64, ModuleIdentity, MibIdentifier, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Integer32, enterprises, NotificationType, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Gauge32", "ObjectIdentity", "Bits", "IpAddress", "Counter32", "Counter64", "ModuleIdentity", "MibIdentifier", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Integer32", "enterprises", "NotificationType", "Unsigned32")
...
mibBuilder.exportSymbols("T3610-MIB", humAlarmInt=humAlarmInt, tempDelayInt=tempDelayInt, valuesInt=valuesInt, tempAlarmInt=tempAlarmInt, humMin=humMin, sensorName=sensorName, trapSOAPErrSocket=trapSOAPErrSocket, trapHumHighAlarm=trapHumHighAlarm, trapCompValError=trapCompValError, trapEmailErrLogin=trapEmailErrLogin, values=values, compValInt=compValInt, trapCompValHighAlarm=trapCompValHighAlarm, humUnit=humUnit, serialNumber=serialNumber, humAlarm=humAlarm, tempAlarm=tempAlarm, compValMax=compValMax, trapHumClrAlarm=trapHumClrAlarm, compValAlarm=compValAlarm, trapTempError=trapTempError, trapHumError=trapHumError, comet=comet, hum=hum, humHighInt=humHighInt, trapHumLowAlarm=trapHumLowAlarm, trapSOAPErrFile=trapSOAPErrFile, histCompVal=histCompVal, settings=settings, temp=temp, compValHystInt=compValHystInt, histTemp=histTemp, tempInt=tempInt, compValHighInt=compValHighInt, histHum=histHum, deviceType=deviceType, trapEmailErrSocket=trapEmailErrSocket, compValDelayInt=compValDelayInt, trapSOAPErrDelivery=trapSOAPErrDelivery, DisplayString=DisplayString, tempHystInt=tempHystInt, tempLowInt=tempLowInt, trapTest=trapTest, tempHighInt=tempHighInt, humLowInt=humLowInt, trapEmailErrAuth=trapEmailErrAuth, trapEmailErrSome=trapEmailErrSome, trapSOAPErrDNS=trapSOAPErrDNS, humDelayInt=humDelayInt, products=products, messageString=messageString, trapTempHighAlarm=trapTempHighAlarm, humInt=humInt, compValLowInt=compValLowInt, compValMin=compValMin, compVal=compVal, compValAlarmInt=compValAlarmInt, trapCompValClrAlarm=trapCompValClrAlarm, trapCompValLowAlarm=trapCompValLowAlarm, trapTempClrAlarm=trapTempClrAlarm, trapTempLowAlarm=trapTempLowAlarm, t3610=t3610, compValUnit=compValUnit, humHystInt=humHystInt, tempUnit=tempUnit, tempMax=tempMax, pysmi_global=pysmi_global, traps=traps, historyTable=historyTable, trapNTPError=trapNTPError, historyEntry=historyEntry, humMax=humMax, trapEmailErrDNS=trapEmailErrDNS, tables=tables, tempMin=tempMin)
