...
# Produced by pysmi-1.1.8 at Sat Jan 15 17:10:50 2022
...
MibIdentifier, NotificationType, ModuleIdentity, ObjectIdentity, iso, Integer32, Gauge32, Unsigned32, Bits, IpAddress, Counter32, Counter64, NotificationType, enterprises, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "ModuleIdentity", "ObjectIdentity", "iso", "Integer32", "Gauge32", "Unsigned32", "Bits", "IpAddress", "Counter32", "Counter64", "NotificationType", "enterprises", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("T3610-MIB", trapNTPError=trapNTPError, histTemp=histTemp, tempMax=tempMax, trapEmailErrLogin=trapEmailErrLogin, historyEntry=historyEntry, trapTempClrAlarm=trapTempClrAlarm, histHum=histHum, compValMin=compValMin, tempUnit=tempUnit, trapHumClrAlarm=trapHumClrAlarm, compValHighInt=compValHighInt, compValDelayInt=compValDelayInt, messageString=messageString, histCompVal=histCompVal, humHighInt=humHighInt, humAlarmInt=humAlarmInt, trapSOAPErrFile=trapSOAPErrFile, trapSOAPErrDelivery=trapSOAPErrDelivery, trapHumHighAlarm=trapHumHighAlarm, tempAlarm=tempAlarm, tempMin=tempMin, trapEmailErrSome=trapEmailErrSome, deviceType=deviceType, trapCompValError=trapCompValError, compValLowInt=compValLowInt, compValAlarm=compValAlarm, tempLowInt=tempLowInt, trapTest=trapTest, trapSOAPErrDNS=trapSOAPErrDNS, values=values, humUnit=humUnit, trapTempLowAlarm=trapTempLowAlarm, trapEmailErrDNS=trapEmailErrDNS, humLowInt=humLowInt, valuesInt=valuesInt, tempHystInt=tempHystInt, compValInt=compValInt, temp=temp, comet=comet, trapTempHighAlarm=trapTempHighAlarm, trapCompValHighAlarm=trapCompValHighAlarm, trapCompValClrAlarm=trapCompValClrAlarm, compValHystInt=compValHystInt, humHystInt=humHystInt, humAlarm=humAlarm, compValAlarmInt=compValAlarmInt, compVal=compVal, humMax=humMax, t3610=t3610, trapCompValLowAlarm=trapCompValLowAlarm, sensorName=sensorName, tables=tables, pysmi_global=pysmi_global, humInt=humInt, compValMax=compValMax, settings=settings, products=products, historyTable=historyTable, hum=hum, traps=traps, tempHighInt=tempHighInt, tempInt=tempInt, humMin=humMin, trapHumLowAlarm=trapHumLowAlarm, tempAlarmInt=tempAlarmInt, trapEmailErrSocket=trapEmailErrSocket, humDelayInt=humDelayInt, trapEmailErrAuth=trapEmailErrAuth, serialNumber=serialNumber, tempDelayInt=tempDelayInt, trapSOAPErrSocket=trapSOAPErrSocket, compValUnit=compValUnit, trapTempError=trapTempError, trapHumError=trapHumError, DisplayString=DisplayString)
