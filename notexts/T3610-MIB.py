...
# Produced by pysmi-1.1.8 at Mon Jan 17 21:38:48 2022
...
MibIdentifier, ObjectIdentity, TimeTicks, NotificationType, NotificationType, enterprises, Counter32, Counter64, Unsigned32, Bits, Integer32, ModuleIdentity, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ObjectIdentity", "TimeTicks", "NotificationType", "NotificationType", "enterprises", "Counter32", "Counter64", "Unsigned32", "Bits", "Integer32", "ModuleIdentity", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32")
...
mibBuilder.exportSymbols("T3610-MIB", compValMin=compValMin, compValMax=compValMax, compValUnit=compValUnit, trapTempLowAlarm=trapTempLowAlarm, trapEmailErrLogin=trapEmailErrLogin, sensorName=sensorName, comet=comet, histHum=histHum, compValInt=compValInt, trapSOAPErrDNS=trapSOAPErrDNS, historyEntry=historyEntry, trapSOAPErrSocket=trapSOAPErrSocket, historyTable=historyTable, tempAlarm=tempAlarm, trapHumClrAlarm=trapHumClrAlarm, traps=traps, tempHystInt=tempHystInt, trapTempHighAlarm=trapTempHighAlarm, tempAlarmInt=tempAlarmInt, trapTest=trapTest, tempMin=tempMin, t3610=t3610, trapHumHighAlarm=trapHumHighAlarm, trapCompValLowAlarm=trapCompValLowAlarm, tempUnit=tempUnit, pysmi_global=pysmi_global, trapNTPError=trapNTPError, humUnit=humUnit, trapEmailErrSocket=trapEmailErrSocket, humMin=humMin, tempHighInt=tempHighInt, humDelayInt=humDelayInt, compValDelayInt=compValDelayInt, histCompVal=histCompVal, trapEmailErrDNS=trapEmailErrDNS, trapHumError=trapHumError, compValAlarmInt=compValAlarmInt, values=values, hum=hum, trapTempError=trapTempError, trapCompValHighAlarm=trapCompValHighAlarm, temp=temp, trapCompValError=trapCompValError, products=products, settings=settings, trapEmailErrSome=trapEmailErrSome, trapSOAPErrDelivery=trapSOAPErrDelivery, humMax=humMax, deviceType=deviceType, compValHighInt=compValHighInt, trapCompValClrAlarm=trapCompValClrAlarm, messageString=messageString, compValAlarm=compValAlarm, tempDelayInt=tempDelayInt, humInt=humInt, tempMax=tempMax, trapHumLowAlarm=trapHumLowAlarm, humHystInt=humHystInt, compVal=compVal, trapSOAPErrFile=trapSOAPErrFile, tempInt=tempInt, humAlarmInt=humAlarmInt, tempLowInt=tempLowInt, trapTempClrAlarm=trapTempClrAlarm, humLowInt=humLowInt, compValLowInt=compValLowInt, compValHystInt=compValHystInt, valuesInt=valuesInt, serialNumber=serialNumber, trapEmailErrAuth=trapEmailErrAuth, humHighInt=humHighInt, humAlarm=humAlarm, DisplayString=DisplayString, tables=tables, histTemp=histTemp)
