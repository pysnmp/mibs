...
IpAddress, enterprises, MibIdentifier, Integer32, NotificationType, Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits, Gauge32, NotificationType, iso, ObjectIdentity, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "enterprises", "MibIdentifier", "Integer32", "NotificationType", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits", "Gauge32", "NotificationType", "iso", "ObjectIdentity", "ModuleIdentity", "Counter64")
...
mibBuilder.exportSymbols("T3610-MIB", tables=tables, humLowInt=humLowInt, trapHumHighAlarm=trapHumHighAlarm, compValAlarm=compValAlarm, histCompVal=histCompVal, tempUnit=tempUnit, hum=hum, tempLowInt=tempLowInt, tempHighInt=tempHighInt, sensorName=sensorName, compValHystInt=compValHystInt, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrFile=trapSOAPErrFile, traps=traps, trapEmailErrDNS=trapEmailErrDNS, compVal=compVal, trapSOAPErrDelivery=trapSOAPErrDelivery, humMin=humMin, temp=temp, deviceType=deviceType, trapNTPError=trapNTPError, comet=comet, trapCompValClrAlarm=trapCompValClrAlarm, historyTable=historyTable, humUnit=humUnit, humInt=humInt, tempMin=tempMin, tempMax=tempMax, historyEntry=historyEntry, compValInt=compValInt, tempInt=tempInt, trapEmailErrAuth=trapEmailErrAuth, histHum=histHum, trapCompValHighAlarm=trapCompValHighAlarm, histTemp=histTemp, trapHumClrAlarm=trapHumClrAlarm, trapCompValError=trapCompValError, t3610=t3610, trapCompValLowAlarm=trapCompValLowAlarm, trapTempError=trapTempError, settings=settings, trapTest=trapTest, humAlarm=humAlarm, trapSOAPErrDNS=trapSOAPErrDNS, trapTempLowAlarm=trapTempLowAlarm, compValLowInt=compValLowInt, valuesInt=valuesInt, compValMax=compValMax, trapSOAPErrSocket=trapSOAPErrSocket, trapHumLowAlarm=trapHumLowAlarm, tempAlarm=tempAlarm, humHystInt=humHystInt, serialNumber=serialNumber, compValDelayInt=compValDelayInt, trapEmailErrLogin=trapEmailErrLogin, tempDelayInt=tempDelayInt, trapTempClrAlarm=trapTempClrAlarm, messageString=messageString, compValAlarmInt=compValAlarmInt, trapEmailErrSome=trapEmailErrSome, compValHighInt=compValHighInt, tempAlarmInt=tempAlarmInt, compValUnit=compValUnit, humAlarmInt=humAlarmInt, products=products, compValMin=compValMin, tempHystInt=tempHystInt, humHighInt=humHighInt, humMax=humMax, DisplayString=DisplayString, humDelayInt=humDelayInt, pysmi_global=pysmi_global, trapTempHighAlarm=trapTempHighAlarm, trapHumError=trapHumError, values=values)
