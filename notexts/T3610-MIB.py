...
# Produced by pysmi-1.1.8 at Thu Sep 15 10:01:40 2022
...
NotificationType, TimeTicks, Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, MibIdentifier, Bits, Counter64, Integer32, Counter32, IpAddress, Unsigned32, NotificationType, iso, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "MibIdentifier", "Bits", "Counter64", "Integer32", "Counter32", "IpAddress", "Unsigned32", "NotificationType", "iso", "ModuleIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", trapHumClrAlarm=trapHumClrAlarm, trapTest=trapTest, sensorName=sensorName, trapSOAPErrFile=trapSOAPErrFile, hum=hum, humHighInt=humHighInt, compValHystInt=compValHystInt, pysmi_global=pysmi_global, deviceType=deviceType, trapCompValHighAlarm=trapCompValHighAlarm, histHum=histHum, trapCompValError=trapCompValError, tempLowInt=tempLowInt, tempUnit=tempUnit, products=products, trapTempHighAlarm=trapTempHighAlarm, humAlarm=humAlarm, t3610=t3610, serialNumber=serialNumber, compValAlarmInt=compValAlarmInt, compValLowInt=compValLowInt, tempHystInt=tempHystInt, trapNTPError=trapNTPError, traps=traps, tempMax=tempMax, tempDelayInt=tempDelayInt, tempAlarm=tempAlarm, trapEmailErrSocket=trapEmailErrSocket, histCompVal=histCompVal, compValDelayInt=compValDelayInt, compValMin=compValMin, trapEmailErrAuth=trapEmailErrAuth, valuesInt=valuesInt, trapSOAPErrDNS=trapSOAPErrDNS, trapSOAPErrSocket=trapSOAPErrSocket, messageString=messageString, tables=tables, trapCompValClrAlarm=trapCompValClrAlarm, humLowInt=humLowInt, values=values, temp=temp, humMin=humMin, trapHumError=trapHumError, trapEmailErrDNS=trapEmailErrDNS, humDelayInt=humDelayInt, comet=comet, tempMin=tempMin, historyTable=historyTable, trapCompValLowAlarm=trapCompValLowAlarm, compVal=compVal, DisplayString=DisplayString, tempInt=tempInt, humInt=humInt, trapTempLowAlarm=trapTempLowAlarm, settings=settings, humAlarmInt=humAlarmInt, compValHighInt=compValHighInt, trapTempClrAlarm=trapTempClrAlarm, trapTempError=trapTempError, trapSOAPErrDelivery=trapSOAPErrDelivery, compValInt=compValInt, humMax=humMax, tempHighInt=tempHighInt, trapEmailErrLogin=trapEmailErrLogin, compValAlarm=compValAlarm, trapHumHighAlarm=trapHumHighAlarm, trapHumLowAlarm=trapHumLowAlarm, compValMax=compValMax, humUnit=humUnit, compValUnit=compValUnit, trapEmailErrSome=trapEmailErrSome, histTemp=histTemp, tempAlarmInt=tempAlarmInt, humHystInt=humHystInt, historyEntry=historyEntry)
