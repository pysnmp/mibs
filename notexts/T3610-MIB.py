...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity, Bits, Counter32, Counter64, Unsigned32, MibIdentifier, Integer32, NotificationType, IpAddress, ModuleIdentity, Gauge32, enterprises, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity", "Bits", "Counter32", "Counter64", "Unsigned32", "MibIdentifier", "Integer32", "NotificationType", "IpAddress", "ModuleIdentity", "Gauge32", "enterprises", "NotificationType", "iso")
...
mibBuilder.exportSymbols("T3610-MIB", products=products, trapTempLowAlarm=trapTempLowAlarm, trapNTPError=trapNTPError, messageString=messageString, humAlarm=humAlarm, compVal=compVal, tempLowInt=tempLowInt, serialNumber=serialNumber, tempHighInt=tempHighInt, trapEmailErrLogin=trapEmailErrLogin, humDelayInt=humDelayInt, trapEmailErrDNS=trapEmailErrDNS, compValUnit=compValUnit, compValAlarm=compValAlarm, trapHumLowAlarm=trapHumLowAlarm, hum=hum, DisplayString=DisplayString, trapCompValClrAlarm=trapCompValClrAlarm, humUnit=humUnit, comet=comet, t3610=t3610, tables=tables, trapHumClrAlarm=trapHumClrAlarm, deviceType=deviceType, trapHumHighAlarm=trapHumHighAlarm, trapTempClrAlarm=trapTempClrAlarm, tempAlarmInt=tempAlarmInt, trapTest=trapTest, humInt=humInt, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValError=trapCompValError, trapSOAPErrFile=trapSOAPErrFile, compValHighInt=compValHighInt, compValHystInt=compValHystInt, trapSOAPErrDNS=trapSOAPErrDNS, humLowInt=humLowInt, tempMin=tempMin, compValMax=compValMax, valuesInt=valuesInt, tempMax=tempMax, humHighInt=humHighInt, trapEmailErrSome=trapEmailErrSome, humHystInt=humHystInt, histHum=histHum, compValAlarmInt=compValAlarmInt, humMax=humMax, trapEmailErrSocket=trapEmailErrSocket, trapCompValLowAlarm=trapCompValLowAlarm, tempInt=tempInt, tempUnit=tempUnit, temp=temp, histTemp=histTemp, tempDelayInt=tempDelayInt, compValDelayInt=compValDelayInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapEmailErrAuth=trapEmailErrAuth, pysmi_global=pysmi_global, trapCompValHighAlarm=trapCompValHighAlarm, trapTempHighAlarm=trapTempHighAlarm, tempHystInt=tempHystInt, traps=traps, tempAlarm=tempAlarm, historyEntry=historyEntry, humAlarmInt=humAlarmInt, values=values, humMin=humMin, trapTempError=trapTempError, compValMin=compValMin, trapHumError=trapHumError, sensorName=sensorName, histCompVal=histCompVal, historyTable=historyTable, compValLowInt=compValLowInt, settings=settings, compValInt=compValInt)
