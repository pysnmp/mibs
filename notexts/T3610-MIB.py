...
# Produced by pysmi-1.1.10 at Wed Nov 15 02:35:16 2023
...
Counter32, NotificationType, TimeTicks, IpAddress, ObjectIdentity, NotificationType, Counter64, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, enterprises, MibIdentifier, iso, Gauge32, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "TimeTicks", "IpAddress", "ObjectIdentity", "NotificationType", "Counter64", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "enterprises", "MibIdentifier", "iso", "Gauge32", "ModuleIdentity", "Integer32")
...
mibBuilder.exportSymbols("T3610-MIB", compValInt=compValInt, tempInt=tempInt, trapSOAPErrSocket=trapSOAPErrSocket, compValLowInt=compValLowInt, trapCompValClrAlarm=trapCompValClrAlarm, sensorName=sensorName, valuesInt=valuesInt, traps=traps, trapSOAPErrDelivery=trapSOAPErrDelivery, humMax=humMax, compValMax=compValMax, trapEmailErrSome=trapEmailErrSome, humAlarmInt=humAlarmInt, humHighInt=humHighInt, temp=temp, compValDelayInt=compValDelayInt, tables=tables, historyEntry=historyEntry, compValAlarm=compValAlarm, trapHumError=trapHumError, trapEmailErrDNS=trapEmailErrDNS, humAlarm=humAlarm, tempLowInt=tempLowInt, compValUnit=compValUnit, trapCompValError=trapCompValError, t3610=t3610, tempHighInt=tempHighInt, humMin=humMin, pysmi_global=pysmi_global, trapEmailErrSocket=trapEmailErrSocket, humInt=humInt, trapNTPError=trapNTPError, humHystInt=humHystInt, trapEmailErrLogin=trapEmailErrLogin, hum=hum, values=values, compValAlarmInt=compValAlarmInt, compValHighInt=compValHighInt, settings=settings, humLowInt=humLowInt, trapTest=trapTest, compVal=compVal, trapSOAPErrDNS=trapSOAPErrDNS, trapTempLowAlarm=trapTempLowAlarm, trapCompValLowAlarm=trapCompValLowAlarm, serialNumber=serialNumber, compValMin=compValMin, trapTempError=trapTempError, messageString=messageString, trapHumClrAlarm=trapHumClrAlarm, histHum=histHum, compValHystInt=compValHystInt, tempHystInt=tempHystInt, histTemp=histTemp, trapTempClrAlarm=trapTempClrAlarm, trapCompValHighAlarm=trapCompValHighAlarm, tempDelayInt=tempDelayInt, humUnit=humUnit, histCompVal=histCompVal, deviceType=deviceType, humDelayInt=humDelayInt, trapSOAPErrFile=trapSOAPErrFile, comet=comet, trapEmailErrAuth=trapEmailErrAuth, products=products, trapTempHighAlarm=trapTempHighAlarm, tempMin=tempMin, tempAlarm=tempAlarm, tempAlarmInt=tempAlarmInt, trapHumHighAlarm=trapHumHighAlarm, DisplayString=DisplayString, trapHumLowAlarm=trapHumLowAlarm, tempMax=tempMax, tempUnit=tempUnit, historyTable=historyTable)
