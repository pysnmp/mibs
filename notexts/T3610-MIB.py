...
# Produced by pysmi-1.1.3 at Sun Nov 28 14:02:54 2021
...
enterprises, Integer32, ObjectIdentity, IpAddress, iso, Gauge32, NotificationType, Bits, ModuleIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, TimeTicks, Counter64, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Integer32", "ObjectIdentity", "IpAddress", "iso", "Gauge32", "NotificationType", "Bits", "ModuleIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "TimeTicks", "Counter64", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("T3610-MIB", tempUnit=tempUnit, historyEntry=historyEntry, trapNTPError=trapNTPError, humMax=humMax, trapTest=trapTest, trapTempLowAlarm=trapTempLowAlarm, DisplayString=DisplayString, humMin=humMin, comet=comet, trapEmailErrLogin=trapEmailErrLogin, humAlarmInt=humAlarmInt, compValHighInt=compValHighInt, compValLowInt=compValLowInt, trapCompValClrAlarm=trapCompValClrAlarm, deviceType=deviceType, tempInt=tempInt, sensorName=sensorName, tempDelayInt=tempDelayInt, tempMin=tempMin, trapCompValLowAlarm=trapCompValLowAlarm, products=products, tables=tables, tempAlarmInt=tempAlarmInt, histTemp=histTemp, pysmi_global=pysmi_global, humUnit=humUnit, humHystInt=humHystInt, trapSOAPErrSocket=trapSOAPErrSocket, trapSOAPErrDelivery=trapSOAPErrDelivery, tempAlarm=tempAlarm, messageString=messageString, trapTempHighAlarm=trapTempHighAlarm, tempHystInt=tempHystInt, trapHumError=trapHumError, compValInt=compValInt, humDelayInt=humDelayInt, trapCompValHighAlarm=trapCompValHighAlarm, trapCompValError=trapCompValError, trapSOAPErrFile=trapSOAPErrFile, valuesInt=valuesInt, compVal=compVal, humLowInt=humLowInt, serialNumber=serialNumber, historyTable=historyTable, hum=hum, trapEmailErrSome=trapEmailErrSome, tempMax=tempMax, humAlarm=humAlarm, tempHighInt=tempHighInt, histHum=histHum, trapTempClrAlarm=trapTempClrAlarm, trapEmailErrSocket=trapEmailErrSocket, histCompVal=histCompVal, compValAlarmInt=compValAlarmInt, compValUnit=compValUnit, tempLowInt=tempLowInt, settings=settings, traps=traps, compValMax=compValMax, compValAlarm=compValAlarm, temp=temp, values=values, humInt=humInt, trapEmailErrDNS=trapEmailErrDNS, trapSOAPErrDNS=trapSOAPErrDNS, trapHumHighAlarm=trapHumHighAlarm, compValDelayInt=compValDelayInt, trapEmailErrAuth=trapEmailErrAuth, compValHystInt=compValHystInt, t3610=t3610, compValMin=compValMin, humHighInt=humHighInt, trapTempError=trapTempError, trapHumClrAlarm=trapHumClrAlarm, trapHumLowAlarm=trapHumLowAlarm)
