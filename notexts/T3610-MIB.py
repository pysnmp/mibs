...
# Produced by pysmi-1.1.3 at Sat Nov 20 22:42:01 2021
...
Counter64, ModuleIdentity, enterprises, ObjectIdentity, NotificationType, NotificationType, Counter32, IpAddress, Bits, iso, Unsigned32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ModuleIdentity", "enterprises", "ObjectIdentity", "NotificationType", "NotificationType", "Counter32", "IpAddress", "Bits", "iso", "Unsigned32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Gauge32", "MibIdentifier")
...
mibBuilder.exportSymbols("T3610-MIB", compValHystInt=compValHystInt, messageString=messageString, tempInt=tempInt, compValInt=compValInt, tempAlarmInt=tempAlarmInt, trapTempLowAlarm=trapTempLowAlarm, settings=settings, DisplayString=DisplayString, values=values, traps=traps, hum=hum, histHum=histHum, humHighInt=humHighInt, trapEmailErrLogin=trapEmailErrLogin, trapSOAPErrSocket=trapSOAPErrSocket, humInt=humInt, t3610=t3610, trapEmailErrDNS=trapEmailErrDNS, trapCompValLowAlarm=trapCompValLowAlarm, comet=comet, tables=tables, compVal=compVal, humDelayInt=humDelayInt, trapSOAPErrDNS=trapSOAPErrDNS, deviceType=deviceType, compValAlarmInt=compValAlarmInt, compValUnit=compValUnit, tempMin=tempMin, humMin=humMin, pysmi_global=pysmi_global, trapCompValClrAlarm=trapCompValClrAlarm, trapHumHighAlarm=trapHumHighAlarm, temp=temp, compValMin=compValMin, historyTable=historyTable, humMax=humMax, sensorName=sensorName, compValHighInt=compValHighInt, tempMax=tempMax, tempAlarm=tempAlarm, trapTest=trapTest, trapSOAPErrDelivery=trapSOAPErrDelivery, humUnit=humUnit, tempDelayInt=tempDelayInt, trapEmailErrSome=trapEmailErrSome, trapTempHighAlarm=trapTempHighAlarm, compValAlarm=compValAlarm, tempUnit=tempUnit, humLowInt=humLowInt, compValMax=compValMax, compValDelayInt=compValDelayInt, humHystInt=humHystInt, products=products, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrFile=trapSOAPErrFile, trapHumLowAlarm=trapHumLowAlarm, trapHumClrAlarm=trapHumClrAlarm, tempHighInt=tempHighInt, trapHumError=trapHumError, humAlarmInt=humAlarmInt, trapTempClrAlarm=trapTempClrAlarm, trapTempError=trapTempError, tempHystInt=tempHystInt, trapNTPError=trapNTPError, trapCompValError=trapCompValError, histCompVal=histCompVal, humAlarm=humAlarm, historyEntry=historyEntry, trapEmailErrSocket=trapEmailErrSocket, tempLowInt=tempLowInt, valuesInt=valuesInt, histTemp=histTemp, trapCompValHighAlarm=trapCompValHighAlarm, serialNumber=serialNumber, compValLowInt=compValLowInt)
