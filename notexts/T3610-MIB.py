...
NotificationType, Integer32, NotificationType, Gauge32, Bits, iso, MibIdentifier, Counter64, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, TimeTicks, Unsigned32, IpAddress, enterprises, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "NotificationType", "Gauge32", "Bits", "iso", "MibIdentifier", "Counter64", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "TimeTicks", "Unsigned32", "IpAddress", "enterprises", "Counter32")
...
mibBuilder.exportSymbols("T3610-MIB", humHighInt=humHighInt, values=values, compVal=compVal, temp=temp, traps=traps, DisplayString=DisplayString, trapCompValClrAlarm=trapCompValClrAlarm, compValAlarm=compValAlarm, humAlarm=humAlarm, tempMin=tempMin, t3610=t3610, tempHystInt=tempHystInt, historyTable=historyTable, histTemp=histTemp, trapSOAPErrDNS=trapSOAPErrDNS, trapSOAPErrDelivery=trapSOAPErrDelivery, tempInt=tempInt, tempUnit=tempUnit, trapEmailErrSome=trapEmailErrSome, trapTempHighAlarm=trapTempHighAlarm, trapCompValLowAlarm=trapCompValLowAlarm, trapNTPError=trapNTPError, tempMax=tempMax, trapHumError=trapHumError, trapEmailErrDNS=trapEmailErrDNS, sensorName=sensorName, serialNumber=serialNumber, humDelayInt=humDelayInt, compValDelayInt=compValDelayInt, humHystInt=humHystInt, histCompVal=histCompVal, trapEmailErrSocket=trapEmailErrSocket, trapHumLowAlarm=trapHumLowAlarm, tempHighInt=tempHighInt, humMin=humMin, compValMax=compValMax, tempLowInt=tempLowInt, trapTest=trapTest, compValHystInt=compValHystInt, trapHumHighAlarm=trapHumHighAlarm, trapCompValHighAlarm=trapCompValHighAlarm, trapTempLowAlarm=trapTempLowAlarm, compValLowInt=compValLowInt, trapTempError=trapTempError, trapEmailErrAuth=trapEmailErrAuth, deviceType=deviceType, hum=hum, trapEmailErrLogin=trapEmailErrLogin, tables=tables, trapSOAPErrFile=trapSOAPErrFile, comet=comet, trapSOAPErrSocket=trapSOAPErrSocket, tempDelayInt=tempDelayInt, trapTempClrAlarm=trapTempClrAlarm, trapCompValError=trapCompValError, compValInt=compValInt, products=products, settings=settings, tempAlarmInt=tempAlarmInt, compValAlarmInt=compValAlarmInt, humLowInt=humLowInt, pysmi_global=pysmi_global, humInt=humInt, tempAlarm=tempAlarm, messageString=messageString, humUnit=humUnit, compValUnit=compValUnit, historyEntry=historyEntry, trapHumClrAlarm=trapHumClrAlarm, compValMin=compValMin, humAlarmInt=humAlarmInt, valuesInt=valuesInt, histHum=histHum, compValHighInt=compValHighInt, humMax=humMax)
