...
# Produced by pysmi-1.1.12 at Tue Jun  4 08:03:47 2024
...
iso, NotificationType, ObjectIdentity, ModuleIdentity, Counter32, NotificationType, Counter64, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Integer32, IpAddress, MibIdentifier, Gauge32, TimeTicks, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "ObjectIdentity", "ModuleIdentity", "Counter32", "NotificationType", "Counter64", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Integer32", "IpAddress", "MibIdentifier", "Gauge32", "TimeTicks", "enterprises")
...
mibBuilder.exportSymbols("T3610-MIB", humLowInt=humLowInt, compValHighInt=compValHighInt, humMin=humMin, tempHystInt=tempHystInt, humUnit=humUnit, products=products, historyEntry=historyEntry, values=values, trapEmailErrLogin=trapEmailErrLogin, compValAlarm=compValAlarm, trapSOAPErrFile=trapSOAPErrFile, messageString=messageString, humDelayInt=humDelayInt, trapTest=trapTest, tempMax=tempMax, sensorName=sensorName, settings=settings, tempInt=tempInt, tempAlarmInt=tempAlarmInt, tempDelayInt=tempDelayInt, compValDelayInt=compValDelayInt, humHystInt=humHystInt, hum=hum, traps=traps, histHum=histHum, histCompVal=histCompVal, trapEmailErrSocket=trapEmailErrSocket, humInt=humInt, humAlarmInt=humAlarmInt, trapCompValHighAlarm=trapCompValHighAlarm, historyTable=historyTable, trapSOAPErrSocket=trapSOAPErrSocket, tempMin=tempMin, compValAlarmInt=compValAlarmInt, compValMin=compValMin, tempHighInt=tempHighInt, compValHystInt=compValHystInt, trapHumClrAlarm=trapHumClrAlarm, tables=tables, trapCompValLowAlarm=trapCompValLowAlarm, trapTempError=trapTempError, compValMax=compValMax, tempLowInt=tempLowInt, tempUnit=tempUnit, compValUnit=compValUnit, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTempLowAlarm=trapTempLowAlarm, t3610=t3610, comet=comet, trapTempHighAlarm=trapTempHighAlarm, DisplayString=DisplayString, valuesInt=valuesInt, temp=temp, serialNumber=serialNumber, deviceType=deviceType, compValInt=compValInt, humHighInt=humHighInt, compValLowInt=compValLowInt, trapEmailErrSome=trapEmailErrSome, trapHumError=trapHumError, compVal=compVal, histTemp=histTemp, humAlarm=humAlarm, trapHumLowAlarm=trapHumLowAlarm, tempAlarm=tempAlarm, humMax=humMax, trapHumHighAlarm=trapHumHighAlarm, trapTempClrAlarm=trapTempClrAlarm, trapCompValClrAlarm=trapCompValClrAlarm, trapEmailErrAuth=trapEmailErrAuth, pysmi_global=pysmi_global, trapCompValError=trapCompValError, trapEmailErrDNS=trapEmailErrDNS, trapSOAPErrDNS=trapSOAPErrDNS, trapNTPError=trapNTPError)
