...
# Produced by pysmi-1.1.8 at Mon Feb  6 14:26:15 2023
...
ModuleIdentity, iso, Bits, Integer32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, NotificationType, enterprises, Gauge32, MibIdentifier, TimeTicks, IpAddress, Unsigned32, NotificationType, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "Bits", "Integer32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "NotificationType", "enterprises", "Gauge32", "MibIdentifier", "TimeTicks", "IpAddress", "Unsigned32", "NotificationType", "Counter64")
...
mibBuilder.exportSymbols("T3610-MIB", compVal=compVal, compValAlarm=compValAlarm, humUnit=humUnit, compValAlarmInt=compValAlarmInt, historyTable=historyTable, trapHumClrAlarm=trapHumClrAlarm, compValHystInt=compValHystInt, trapTest=trapTest, compValUnit=compValUnit, histTemp=histTemp, histCompVal=histCompVal, compValMax=compValMax, sensorName=sensorName, histHum=histHum, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrDelivery=trapSOAPErrDelivery, compValDelayInt=compValDelayInt, tempHighInt=tempHighInt, tempLowInt=tempLowInt, trapNTPError=trapNTPError, compValLowInt=compValLowInt, trapCompValLowAlarm=trapCompValLowAlarm, tempMin=tempMin, humHystInt=humHystInt, trapTempLowAlarm=trapTempLowAlarm, compValMin=compValMin, products=products, humMin=humMin, trapTempHighAlarm=trapTempHighAlarm, trapCompValClrAlarm=trapCompValClrAlarm, humDelayInt=humDelayInt, temp=temp, messageString=messageString, tempAlarm=tempAlarm, pysmi_global=pysmi_global, compValHighInt=compValHighInt, DisplayString=DisplayString, tempHystInt=tempHystInt, trapEmailErrLogin=trapEmailErrLogin, traps=traps, tempInt=tempInt, humAlarm=humAlarm, trapHumHighAlarm=trapHumHighAlarm, tempMax=tempMax, trapEmailErrSome=trapEmailErrSome, trapHumError=trapHumError, t3610=t3610, humHighInt=humHighInt, comet=comet, hum=hum, tempUnit=tempUnit, historyEntry=historyEntry, settings=settings, trapEmailErrDNS=trapEmailErrDNS, trapHumLowAlarm=trapHumLowAlarm, trapCompValError=trapCompValError, trapSOAPErrSocket=trapSOAPErrSocket, humInt=humInt, humAlarmInt=humAlarmInt, trapTempError=trapTempError, trapSOAPErrDNS=trapSOAPErrDNS, trapSOAPErrFile=trapSOAPErrFile, trapTempClrAlarm=trapTempClrAlarm, valuesInt=valuesInt, humMax=humMax, tempDelayInt=tempDelayInt, values=values, deviceType=deviceType, trapCompValHighAlarm=trapCompValHighAlarm, serialNumber=serialNumber, humLowInt=humLowInt, trapEmailErrSocket=trapEmailErrSocket, tempAlarmInt=tempAlarmInt, tables=tables, compValInt=compValInt)
