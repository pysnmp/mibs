...
# Produced by pysmi-1.1.8 at Fri Oct 13 13:58:17 2023
...
Gauge32, ObjectIdentity, Unsigned32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, MibIdentifier, Counter64, Counter32, Integer32, iso, TimeTicks, IpAddress, enterprises, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "MibIdentifier", "Counter64", "Counter32", "Integer32", "iso", "TimeTicks", "IpAddress", "enterprises", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", hum=hum, trapHumClrAlarm=trapHumClrAlarm, tempHystInt=tempHystInt, histCompVal=histCompVal, humInt=humInt, values=values, tempHighInt=tempHighInt, humHighInt=humHighInt, historyTable=historyTable, humDelayInt=humDelayInt, traps=traps, trapEmailErrSocket=trapEmailErrSocket, trapEmailErrLogin=trapEmailErrLogin, tempMax=tempMax, comet=comet, compValLowInt=compValLowInt, tables=tables, tempAlarmInt=tempAlarmInt, messageString=messageString, compValInt=compValInt, historyEntry=historyEntry, compValAlarmInt=compValAlarmInt, settings=settings, compValHystInt=compValHystInt, trapNTPError=trapNTPError, trapEmailErrDNS=trapEmailErrDNS, trapSOAPErrFile=trapSOAPErrFile, compValAlarm=compValAlarm, trapHumHighAlarm=trapHumHighAlarm, compValHighInt=compValHighInt, trapSOAPErrSocket=trapSOAPErrSocket, tempInt=tempInt, humUnit=humUnit, valuesInt=valuesInt, humAlarm=humAlarm, compVal=compVal, humHystInt=humHystInt, trapCompValHighAlarm=trapCompValHighAlarm, trapHumLowAlarm=trapHumLowAlarm, humMax=humMax, trapCompValLowAlarm=trapCompValLowAlarm, humLowInt=humLowInt, compValMin=compValMin, compValMax=compValMax, serialNumber=serialNumber, deviceType=deviceType, trapEmailErrSome=trapEmailErrSome, temp=temp, sensorName=sensorName, tempDelayInt=tempDelayInt, trapTempHighAlarm=trapTempHighAlarm, trapTest=trapTest, t3610=t3610, products=products, tempMin=tempMin, trapEmailErrAuth=trapEmailErrAuth, tempLowInt=tempLowInt, trapTempClrAlarm=trapTempClrAlarm, compValUnit=compValUnit, humMin=humMin, DisplayString=DisplayString, tempUnit=tempUnit, trapTempLowAlarm=trapTempLowAlarm, trapCompValError=trapCompValError, trapSOAPErrDelivery=trapSOAPErrDelivery, tempAlarm=tempAlarm, humAlarmInt=humAlarmInt, compValDelayInt=compValDelayInt, histTemp=histTemp, pysmi_global=pysmi_global, trapHumError=trapHumError, trapSOAPErrDNS=trapSOAPErrDNS, trapTempError=trapTempError, trapCompValClrAlarm=trapCompValClrAlarm, histHum=histHum)
