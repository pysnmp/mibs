...
# Produced by pysmi-1.1.12 at Wed May 29 10:52:32 2024
...
Integer32, Unsigned32, enterprises, ObjectIdentity, NotificationType, Counter32, iso, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, Bits, Gauge32, NotificationType, MibIdentifier, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "enterprises", "ObjectIdentity", "NotificationType", "Counter32", "iso", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "Bits", "Gauge32", "NotificationType", "MibIdentifier", "IpAddress")
...
mibBuilder.exportSymbols("T3610-MIB", humUnit=humUnit, compValUnit=compValUnit, trapHumClrAlarm=trapHumClrAlarm, trapCompValClrAlarm=trapCompValClrAlarm, trapTempHighAlarm=trapTempHighAlarm, serialNumber=serialNumber, messageString=messageString, trapEmailErrLogin=trapEmailErrLogin, tempHighInt=tempHighInt, trapEmailErrAuth=trapEmailErrAuth, humMax=humMax, trapSOAPErrSocket=trapSOAPErrSocket, trapTest=trapTest, trapEmailErrSome=trapEmailErrSome, DisplayString=DisplayString, tempInt=tempInt, humHystInt=humHystInt, historyTable=historyTable, histHum=histHum, trapTempLowAlarm=trapTempLowAlarm, compValHystInt=compValHystInt, pysmi_global=pysmi_global, trapTempError=trapTempError, trapCompValError=trapCompValError, t3610=t3610, tempAlarm=tempAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, comet=comet, humMin=humMin, humLowInt=humLowInt, tempDelayInt=tempDelayInt, tempUnit=tempUnit, trapHumLowAlarm=trapHumLowAlarm, trapHumHighAlarm=trapHumHighAlarm, compValDelayInt=compValDelayInt, tempAlarmInt=tempAlarmInt, trapEmailErrDNS=trapEmailErrDNS, trapSOAPErrFile=trapSOAPErrFile, hum=hum, tempHystInt=tempHystInt, humDelayInt=humDelayInt, compValHighInt=compValHighInt, historyEntry=historyEntry, settings=settings, tempMin=tempMin, compValMin=compValMin, temp=temp, sensorName=sensorName, compValInt=compValInt, tempLowInt=tempLowInt, humHighInt=humHighInt, trapCompValHighAlarm=trapCompValHighAlarm, trapCompValLowAlarm=trapCompValLowAlarm, traps=traps, humAlarm=humAlarm, histCompVal=histCompVal, trapSOAPErrDNS=trapSOAPErrDNS, humInt=humInt, compValAlarmInt=compValAlarmInt, tempMax=tempMax, compValMax=compValMax, tables=tables, deviceType=deviceType, trapEmailErrSocket=trapEmailErrSocket, values=values, valuesInt=valuesInt, trapNTPError=trapNTPError, humAlarmInt=humAlarmInt, trapTempClrAlarm=trapTempClrAlarm, trapHumError=trapHumError, compVal=compVal, products=products, compValLowInt=compValLowInt, histTemp=histTemp, compValAlarm=compValAlarm)
