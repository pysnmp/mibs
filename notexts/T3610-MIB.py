...
# Produced by pysmi-1.1.8 at Thu Jan  6 19:24:30 2022
...
MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter32, iso, Gauge32, Integer32, ObjectIdentity, ModuleIdentity, Bits, NotificationType, NotificationType, TimeTicks, enterprises, Unsigned32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter32", "iso", "Gauge32", "Integer32", "ObjectIdentity", "ModuleIdentity", "Bits", "NotificationType", "NotificationType", "TimeTicks", "enterprises", "Unsigned32", "Counter64")
...
mibBuilder.exportSymbols("T3610-MIB", settings=settings, valuesInt=valuesInt, trapNTPError=trapNTPError, compValLowInt=compValLowInt, trapTempHighAlarm=trapTempHighAlarm, histTemp=histTemp, compValDelayInt=compValDelayInt, deviceType=deviceType, trapEmailErrAuth=trapEmailErrAuth, tempHighInt=tempHighInt, compValHighInt=compValHighInt, trapHumHighAlarm=trapHumHighAlarm, trapHumClrAlarm=trapHumClrAlarm, products=products, trapEmailErrSocket=trapEmailErrSocket, tempAlarm=tempAlarm, compValAlarm=compValAlarm, comet=comet, trapSOAPErrDelivery=trapSOAPErrDelivery, trapCompValHighAlarm=trapCompValHighAlarm, compVal=compVal, histCompVal=histCompVal, tempMin=tempMin, messageString=messageString, trapTest=trapTest, humLowInt=humLowInt, t3610=t3610, values=values, trapTempClrAlarm=trapTempClrAlarm, humAlarm=humAlarm, humHighInt=humHighInt, tempInt=tempInt, trapEmailErrLogin=trapEmailErrLogin, temp=temp, sensorName=sensorName, humAlarmInt=humAlarmInt, trapEmailErrSome=trapEmailErrSome, tempHystInt=tempHystInt, compValHystInt=compValHystInt, tempMax=tempMax, humMax=humMax, compValInt=compValInt, historyTable=historyTable, trapTempError=trapTempError, tables=tables, traps=traps, trapCompValError=trapCompValError, compValMax=compValMax, trapEmailErrDNS=trapEmailErrDNS, trapCompValClrAlarm=trapCompValClrAlarm, tempLowInt=tempLowInt, historyEntry=historyEntry, trapSOAPErrDNS=trapSOAPErrDNS, humMin=humMin, trapSOAPErrSocket=trapSOAPErrSocket, humInt=humInt, compValUnit=compValUnit, tempDelayInt=tempDelayInt, hum=hum, serialNumber=serialNumber, trapSOAPErrFile=trapSOAPErrFile, compValMin=compValMin, humDelayInt=humDelayInt, tempAlarmInt=tempAlarmInt, DisplayString=DisplayString, trapTempLowAlarm=trapTempLowAlarm, compValAlarmInt=compValAlarmInt, histHum=histHum, pysmi_global=pysmi_global, humUnit=humUnit, humHystInt=humHystInt, trapCompValLowAlarm=trapCompValLowAlarm, tempUnit=tempUnit, trapHumError=trapHumError, trapHumLowAlarm=trapHumLowAlarm)
