...
# Produced by pysmi-1.1.12 at Wed Nov  6 08:28:19 2024
...
iso, Integer32, ObjectIdentity, MibIdentifier, ModuleIdentity, Counter64, Counter32, NotificationType, IpAddress, NotificationType, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Bits, Gauge32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "Counter64", "Counter32", "NotificationType", "IpAddress", "NotificationType", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Bits", "Gauge32", "TimeTicks")
...
mibBuilder.exportSymbols("T3610-MIB", humDelayInt=humDelayInt, trapSOAPErrFile=trapSOAPErrFile, tempLowInt=tempLowInt, humUnit=humUnit, histHum=histHum, trapEmailErrSome=trapEmailErrSome, trapNTPError=trapNTPError, humInt=humInt, trapHumError=trapHumError, humAlarmInt=humAlarmInt, temp=temp, tempDelayInt=tempDelayInt, trapCompValHighAlarm=trapCompValHighAlarm, trapTempLowAlarm=trapTempLowAlarm, historyEntry=historyEntry, products=products, serialNumber=serialNumber, traps=traps, tempAlarmInt=tempAlarmInt, trapHumHighAlarm=trapHumHighAlarm, compValHighInt=compValHighInt, histCompVal=histCompVal, trapHumClrAlarm=trapHumClrAlarm, compValUnit=compValUnit, trapEmailErrAuth=trapEmailErrAuth, hum=hum, comet=comet, humMax=humMax, humLowInt=humLowInt, trapSOAPErrDelivery=trapSOAPErrDelivery, DisplayString=DisplayString, compValMax=compValMax, sensorName=sensorName, compValLowInt=compValLowInt, valuesInt=valuesInt, tempMin=tempMin, tempAlarm=tempAlarm, compValAlarmInt=compValAlarmInt, trapCompValClrAlarm=trapCompValClrAlarm, tempUnit=tempUnit, humHighInt=humHighInt, histTemp=histTemp, compValInt=compValInt, trapSOAPErrDNS=trapSOAPErrDNS, trapSOAPErrSocket=trapSOAPErrSocket, compValAlarm=compValAlarm, compValMin=compValMin, humHystInt=humHystInt, trapTest=trapTest, pysmi_global=pysmi_global, compVal=compVal, humMin=humMin, trapCompValError=trapCompValError, humAlarm=humAlarm, deviceType=deviceType, values=values, tempMax=tempMax, trapEmailErrDNS=trapEmailErrDNS, trapHumLowAlarm=trapHumLowAlarm, trapEmailErrLogin=trapEmailErrLogin, trapTempClrAlarm=trapTempClrAlarm, trapEmailErrSocket=trapEmailErrSocket, trapTempHighAlarm=trapTempHighAlarm, tables=tables, historyTable=historyTable, tempHighInt=tempHighInt, trapCompValLowAlarm=trapCompValLowAlarm, compValHystInt=compValHystInt, trapTempError=trapTempError, messageString=messageString, settings=settings, compValDelayInt=compValDelayInt, tempInt=tempInt, t3610=t3610, tempHystInt=tempHystInt)
