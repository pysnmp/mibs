...
# Produced by pysmi-1.1.12 at Fri Jul 19 11:33:31 2024
...
MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, Counter32, NotificationType, Unsigned32, Bits, iso, ModuleIdentity, ObjectIdentity, IpAddress, Gauge32, TimeTicks, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "Counter32", "NotificationType", "Unsigned32", "Bits", "iso", "ModuleIdentity", "ObjectIdentity", "IpAddress", "Gauge32", "TimeTicks", "enterprises")
...
mibBuilder.exportSymbols("T3610-MIB", tempUnit=tempUnit, compValInt=compValInt, tempInt=tempInt, humHighInt=humHighInt, trapCompValClrAlarm=trapCompValClrAlarm, humAlarmInt=humAlarmInt, compValAlarmInt=compValAlarmInt, trapCompValError=trapCompValError, humDelayInt=humDelayInt, trapTempLowAlarm=trapTempLowAlarm, tempDelayInt=tempDelayInt, products=products, compVal=compVal, tables=tables, trapTempError=trapTempError, histTemp=histTemp, humInt=humInt, historyTable=historyTable, histHum=histHum, trapHumLowAlarm=trapHumLowAlarm, historyEntry=historyEntry, trapTest=trapTest, values=values, histCompVal=histCompVal, settings=settings, tempAlarm=tempAlarm, serialNumber=serialNumber, trapEmailErrDNS=trapEmailErrDNS, trapHumClrAlarm=trapHumClrAlarm, compValMin=compValMin, compValUnit=compValUnit, compValAlarm=compValAlarm, trapNTPError=trapNTPError, messageString=messageString, trapEmailErrAuth=trapEmailErrAuth, trapHumHighAlarm=trapHumHighAlarm, tempMax=tempMax, pysmi_global=pysmi_global, humMax=humMax, trapSOAPErrFile=trapSOAPErrFile, compValDelayInt=compValDelayInt, humUnit=humUnit, deviceType=deviceType, trapSOAPErrSocket=trapSOAPErrSocket, sensorName=sensorName, trapEmailErrLogin=trapEmailErrLogin, valuesInt=valuesInt, trapHumError=trapHumError, trapTempHighAlarm=trapTempHighAlarm, compValLowInt=compValLowInt, humAlarm=humAlarm, trapEmailErrSome=trapEmailErrSome, trapSOAPErrDNS=trapSOAPErrDNS, hum=hum, trapCompValLowAlarm=trapCompValLowAlarm, trapEmailErrSocket=trapEmailErrSocket, humLowInt=humLowInt, tempHystInt=tempHystInt, trapCompValHighAlarm=trapCompValHighAlarm, DisplayString=DisplayString, traps=traps, trapSOAPErrDelivery=trapSOAPErrDelivery, tempLowInt=tempLowInt, comet=comet, tempMin=tempMin, tempAlarmInt=tempAlarmInt, compValMax=compValMax, tempHighInt=tempHighInt, humMin=humMin, trapTempClrAlarm=trapTempClrAlarm, compValHystInt=compValHystInt, temp=temp, compValHighInt=compValHighInt, humHystInt=humHystInt, t3610=t3610)
