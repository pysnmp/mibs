...
# Produced by pysmi-1.1.8 at Mon Feb  6 14:22:02 2023
...
enterprises, Counter32, ModuleIdentity, Unsigned32, Gauge32, NotificationType, IpAddress, Bits, TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter64, Integer32, ObjectIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter32", "ModuleIdentity", "Unsigned32", "Gauge32", "NotificationType", "IpAddress", "Bits", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter64", "Integer32", "ObjectIdentity", "iso")
...
mibBuilder.exportSymbols("T3610-MIB", tempMax=tempMax, hum=hum, humHighInt=humHighInt, values=values, humAlarm=humAlarm, tempUnit=tempUnit, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrSocket=trapSOAPErrSocket, compValAlarm=compValAlarm, trapCompValHighAlarm=trapCompValHighAlarm, trapHumError=trapHumError, compValInt=compValInt, humHystInt=humHystInt, valuesInt=valuesInt, DisplayString=DisplayString, tempAlarm=tempAlarm, trapCompValLowAlarm=trapCompValLowAlarm, trapTest=trapTest, trapCompValClrAlarm=trapCompValClrAlarm, historyTable=historyTable, tempHighInt=tempHighInt, trapNTPError=trapNTPError, histTemp=histTemp, compValUnit=compValUnit, humDelayInt=humDelayInt, compValHighInt=compValHighInt, tempDelayInt=tempDelayInt, t3610=t3610, trapTempClrAlarm=trapTempClrAlarm, compValMin=compValMin, trapEmailErrLogin=trapEmailErrLogin, humMin=humMin, compVal=compVal, sensorName=sensorName, trapTempLowAlarm=trapTempLowAlarm, trapTempHighAlarm=trapTempHighAlarm, historyEntry=historyEntry, trapTempError=trapTempError, comet=comet, compValHystInt=compValHystInt, compValMax=compValMax, trapEmailErrDNS=trapEmailErrDNS, trapSOAPErrDNS=trapSOAPErrDNS, deviceType=deviceType, trapSOAPErrFile=trapSOAPErrFile, temp=temp, tempAlarmInt=tempAlarmInt, humMax=humMax, humLowInt=humLowInt, trapHumClrAlarm=trapHumClrAlarm, traps=traps, serialNumber=serialNumber, histHum=histHum, trapCompValError=trapCompValError, trapEmailErrSocket=trapEmailErrSocket, settings=settings, humInt=humInt, compValLowInt=compValLowInt, tempHystInt=tempHystInt, trapEmailErrSome=trapEmailErrSome, humAlarmInt=humAlarmInt, pysmi_global=pysmi_global, compValDelayInt=compValDelayInt, tempInt=tempInt, humUnit=humUnit, tables=tables, products=products, histCompVal=histCompVal, tempLowInt=tempLowInt, compValAlarmInt=compValAlarmInt, trapSOAPErrDelivery=trapSOAPErrDelivery, messageString=messageString, trapHumHighAlarm=trapHumHighAlarm, tempMin=tempMin, trapHumLowAlarm=trapHumLowAlarm)
