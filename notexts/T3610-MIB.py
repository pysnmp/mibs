...
# Produced by pysmi-1.1.12 at Wed May 29 10:03:21 2024
...
Integer32, iso, Counter64, ObjectIdentity, IpAddress, Bits, enterprises, ModuleIdentity, NotificationType, Unsigned32, Gauge32, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "Counter64", "ObjectIdentity", "IpAddress", "Bits", "enterprises", "ModuleIdentity", "NotificationType", "Unsigned32", "Gauge32", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "TimeTicks")
...
mibBuilder.exportSymbols("T3610-MIB", tempAlarmInt=tempAlarmInt, humMax=humMax, trapSOAPErrFile=trapSOAPErrFile, trapHumClrAlarm=trapHumClrAlarm, humHighInt=humHighInt, trapHumError=trapHumError, histTemp=histTemp, histCompVal=histCompVal, trapCompValHighAlarm=trapCompValHighAlarm, trapCompValError=trapCompValError, histHum=histHum, pysmi_global=pysmi_global, compValInt=compValInt, compValAlarmInt=compValAlarmInt, traps=traps, trapTempLowAlarm=trapTempLowAlarm, compValMin=compValMin, settings=settings, tempInt=tempInt, DisplayString=DisplayString, messageString=messageString, trapTempError=trapTempError, compValDelayInt=compValDelayInt, humInt=humInt, trapSOAPErrSocket=trapSOAPErrSocket, trapSOAPErrDelivery=trapSOAPErrDelivery, trapEmailErrSome=trapEmailErrSome, tempMax=tempMax, compValMax=compValMax, serialNumber=serialNumber, trapHumLowAlarm=trapHumLowAlarm, tempLowInt=tempLowInt, humAlarmInt=humAlarmInt, humLowInt=humLowInt, tempDelayInt=tempDelayInt, humHystInt=humHystInt, historyEntry=historyEntry, trapTempHighAlarm=trapTempHighAlarm, values=values, humAlarm=humAlarm, compVal=compVal, compValLowInt=compValLowInt, trapHumHighAlarm=trapHumHighAlarm, trapEmailErrAuth=trapEmailErrAuth, humMin=humMin, trapCompValLowAlarm=trapCompValLowAlarm, tempHystInt=tempHystInt, historyTable=historyTable, tempMin=tempMin, trapCompValClrAlarm=trapCompValClrAlarm, trapNTPError=trapNTPError, compValUnit=compValUnit, valuesInt=valuesInt, products=products, deviceType=deviceType, compValHighInt=compValHighInt, compValHystInt=compValHystInt, trapTest=trapTest, t3610=t3610, sensorName=sensorName, tempUnit=tempUnit, humDelayInt=humDelayInt, humUnit=humUnit, trapSOAPErrDNS=trapSOAPErrDNS, tempAlarm=tempAlarm, tempHighInt=tempHighInt, trapEmailErrLogin=trapEmailErrLogin, trapEmailErrSocket=trapEmailErrSocket, trapTempClrAlarm=trapTempClrAlarm, comet=comet, tables=tables, compValAlarm=compValAlarm, trapEmailErrDNS=trapEmailErrDNS, temp=temp, hum=hum)
