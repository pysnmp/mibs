...
# Produced by pysmi-1.1.8 at Mon Jan  2 13:07:31 2023
...
ModuleIdentity, ObjectIdentity, Unsigned32, Counter32, Bits, Gauge32, enterprises, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, iso, NotificationType, Counter64, TimeTicks, MibIdentifier, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "Counter32", "Bits", "Gauge32", "enterprises", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "iso", "NotificationType", "Counter64", "TimeTicks", "MibIdentifier", "IpAddress")
...
mibBuilder.exportSymbols("T3610-MIB", trapSOAPErrDelivery=trapSOAPErrDelivery, humUnit=humUnit, sensorName=sensorName, histTemp=histTemp, deviceType=deviceType, compValAlarmInt=compValAlarmInt, trapHumLowAlarm=trapHumLowAlarm, humInt=humInt, humHystInt=humHystInt, tempMin=tempMin, trapTempClrAlarm=trapTempClrAlarm, compValUnit=compValUnit, trapCompValHighAlarm=trapCompValHighAlarm, trapSOAPErrSocket=trapSOAPErrSocket, trapTempLowAlarm=trapTempLowAlarm, messageString=messageString, trapEmailErrAuth=trapEmailErrAuth, DisplayString=DisplayString, trapEmailErrDNS=trapEmailErrDNS, historyEntry=historyEntry, trapTest=trapTest, historyTable=historyTable, comet=comet, humHighInt=humHighInt, compValHystInt=compValHystInt, t3610=t3610, trapCompValError=trapCompValError, serialNumber=serialNumber, compValDelayInt=compValDelayInt, settings=settings, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrFile=trapSOAPErrFile, tempHystInt=tempHystInt, compValLowInt=compValLowInt, compValInt=compValInt, tempUnit=tempUnit, trapEmailErrLogin=trapEmailErrLogin, products=products, humMax=humMax, trapCompValClrAlarm=trapCompValClrAlarm, compVal=compVal, tempAlarm=tempAlarm, humAlarm=humAlarm, humMin=humMin, compValMax=compValMax, humAlarmInt=humAlarmInt, histHum=histHum, tempHighInt=tempHighInt, compValAlarm=compValAlarm, traps=traps, valuesInt=valuesInt, trapHumHighAlarm=trapHumHighAlarm, tempAlarmInt=tempAlarmInt, histCompVal=histCompVal, trapSOAPErrDNS=trapSOAPErrDNS, compValHighInt=compValHighInt, temp=temp, trapNTPError=trapNTPError, tables=tables, hum=hum, compValMin=compValMin, tempInt=tempInt, values=values, humLowInt=humLowInt, tempDelayInt=tempDelayInt, trapHumClrAlarm=trapHumClrAlarm, trapTempError=trapTempError, tempLowInt=tempLowInt, trapEmailErrSome=trapEmailErrSome, trapTempHighAlarm=trapTempHighAlarm, trapCompValLowAlarm=trapCompValLowAlarm, trapHumError=trapHumError, pysmi_global=pysmi_global, humDelayInt=humDelayInt, tempMax=tempMax)
