...
# Produced by pysmi-1.1.8 at Thu Jan  5 10:14:52 2023
...
ModuleIdentity, Counter32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, IpAddress, Counter64, Gauge32, enterprises, Bits, TimeTicks, Unsigned32, ObjectIdentity, iso, NotificationType, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "IpAddress", "Counter64", "Gauge32", "enterprises", "Bits", "TimeTicks", "Unsigned32", "ObjectIdentity", "iso", "NotificationType", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", t3610=t3610, trapTempClrAlarm=trapTempClrAlarm, trapSOAPErrSocket=trapSOAPErrSocket, tempAlarm=tempAlarm, deviceType=deviceType, tempLowInt=tempLowInt, trapTest=trapTest, trapSOAPErrDelivery=trapSOAPErrDelivery, historyEntry=historyEntry, trapEmailErrSocket=trapEmailErrSocket, trapCompValHighAlarm=trapCompValHighAlarm, serialNumber=serialNumber, trapTempLowAlarm=trapTempLowAlarm, tempMin=tempMin, valuesInt=valuesInt, compVal=compVal, trapTempHighAlarm=trapTempHighAlarm, trapCompValClrAlarm=trapCompValClrAlarm, humLowInt=humLowInt, humAlarm=humAlarm, pysmi_global=pysmi_global, tempMax=tempMax, temp=temp, trapSOAPErrFile=trapSOAPErrFile, trapSOAPErrDNS=trapSOAPErrDNS, compValUnit=compValUnit, compValMin=compValMin, tempAlarmInt=tempAlarmInt, compValLowInt=compValLowInt, trapEmailErrSome=trapEmailErrSome, tempUnit=tempUnit, compValAlarm=compValAlarm, trapEmailErrDNS=trapEmailErrDNS, humMin=humMin, humHighInt=humHighInt, compValInt=compValInt, traps=traps, trapCompValLowAlarm=trapCompValLowAlarm, trapCompValError=trapCompValError, trapEmailErrLogin=trapEmailErrLogin, humDelayInt=humDelayInt, settings=settings, histHum=histHum, tempInt=tempInt, trapEmailErrAuth=trapEmailErrAuth, compValAlarmInt=compValAlarmInt, trapTempError=trapTempError, compValHystInt=compValHystInt, comet=comet, trapHumLowAlarm=trapHumLowAlarm, trapNTPError=trapNTPError, trapHumClrAlarm=trapHumClrAlarm, trapHumError=trapHumError, humInt=humInt, histTemp=histTemp, values=values, compValHighInt=compValHighInt, tempHystInt=tempHystInt, historyTable=historyTable, hum=hum, humMax=humMax, compValDelayInt=compValDelayInt, compValMax=compValMax, tables=tables, tempHighInt=tempHighInt, humHystInt=humHystInt, messageString=messageString, humUnit=humUnit, sensorName=sensorName, trapHumHighAlarm=trapHumHighAlarm, humAlarmInt=humAlarmInt, products=products, histCompVal=histCompVal, tempDelayInt=tempDelayInt, DisplayString=DisplayString)
