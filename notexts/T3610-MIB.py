...
# Produced by pysmi-1.1.12 at Tue Dec  3 11:38:00 2024
...
iso, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, TimeTicks, MibIdentifier, NotificationType, Gauge32, enterprises, Counter64, ModuleIdentity, Counter32, ObjectIdentity, NotificationType, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "TimeTicks", "MibIdentifier", "NotificationType", "Gauge32", "enterprises", "Counter64", "ModuleIdentity", "Counter32", "ObjectIdentity", "NotificationType", "IpAddress", "Integer32")
...
mibBuilder.exportSymbols("T3610-MIB", sensorName=sensorName, histHum=histHum, trapSOAPErrSocket=trapSOAPErrSocket, tempLowInt=tempLowInt, serialNumber=serialNumber, tempInt=tempInt, trapEmailErrLogin=trapEmailErrLogin, humLowInt=humLowInt, humMin=humMin, humInt=humInt, values=values, trapTest=trapTest, tempHighInt=tempHighInt, trapSOAPErrDelivery=trapSOAPErrDelivery, tempHystInt=tempHystInt, compValMin=compValMin, trapNTPError=trapNTPError, trapHumError=trapHumError, historyTable=historyTable, products=products, settings=settings, histTemp=histTemp, trapCompValClrAlarm=trapCompValClrAlarm, trapCompValHighAlarm=trapCompValHighAlarm, humAlarmInt=humAlarmInt, compValInt=compValInt, trapEmailErrSocket=trapEmailErrSocket, tempDelayInt=tempDelayInt, historyEntry=historyEntry, trapTempLowAlarm=trapTempLowAlarm, trapCompValError=trapCompValError, humAlarm=humAlarm, tempMin=tempMin, trapHumHighAlarm=trapHumHighAlarm, DisplayString=DisplayString, messageString=messageString, humUnit=humUnit, valuesInt=valuesInt, deviceType=deviceType, trapSOAPErrFile=trapSOAPErrFile, trapHumLowAlarm=trapHumLowAlarm, trapTempHighAlarm=trapTempHighAlarm, compVal=compVal, trapTempClrAlarm=trapTempClrAlarm, traps=traps, trapSOAPErrDNS=trapSOAPErrDNS, trapEmailErrSome=trapEmailErrSome, tables=tables, trapHumClrAlarm=trapHumClrAlarm, compValDelayInt=compValDelayInt, compValHighInt=compValHighInt, tempAlarm=tempAlarm, hum=hum, humHystInt=humHystInt, compValAlarmInt=compValAlarmInt, tempUnit=tempUnit, tempAlarmInt=tempAlarmInt, compValAlarm=compValAlarm, compValLowInt=compValLowInt, trapEmailErrAuth=trapEmailErrAuth, trapEmailErrDNS=trapEmailErrDNS, trapTempError=trapTempError, pysmi_global=pysmi_global, humHighInt=humHighInt, humMax=humMax, histCompVal=histCompVal, humDelayInt=humDelayInt, temp=temp, comet=comet, trapCompValLowAlarm=trapCompValLowAlarm, compValMax=compValMax, t3610=t3610, tempMax=tempMax, compValHystInt=compValHystInt, compValUnit=compValUnit)
