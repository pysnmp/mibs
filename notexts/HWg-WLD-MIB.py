...
mibBuilder.exportSymbols("HWg-WLD-MIB", wldIndex=wldIndex, wldSN=wldSN, SensorSN=SensorSN, wldName=wldName, x390=x390, SensorState=SensorState, SensorID=SensorID, wldPeriodicAlarm=wldPeriodicAlarm, hwgwld=hwgwld, info=info, infoAddressMAC=infoAddressMAC, hwgroup=hwgroup, wldState=wldState, wldStateToAlarm=wldStateToAlarm, wldValue=wldValue, wldTable=wldTable, wldStateToNormal=wldStateToNormal, SensorValue=SensorValue, wldID=wldID, PositiveInteger=PositiveInteger, wldEntry=wldEntry, SensorName=SensorName)
