...
ShelfId, PortType, CardType, CardId, PortMode, DuplexStatus, FirmwareSource, PicType, CardSubType, DiskVolumeUsageLevel, EqActionType, PrimaryState, SecondaryState, FlowControlMode, PortDetectedMode, AdminState, PortId, UnknownState = mibBuilder.importSymbols("CADANT-TC", "ShelfId", "PortType", "CardType", "CardId", "PortMode", "DuplexStatus", "FirmwareSource", "PicType", "CardSubType", "DiskVolumeUsageLevel", "EqActionType", "PrimaryState", "SecondaryState", "FlowControlMode", "PortDetectedMode", "AdminState", "PortId", "UnknownState")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ObjectGroup, NotificationGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "NotificationGroup", "ModuleCompliance")
Counter64, iso, Counter32, NotificationType, IpAddress, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, TimeTicks, ObjectIdentity, MibIdentifier, Gauge32, Bits, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "iso", "Counter32", "NotificationType", "IpAddress", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "TimeTicks", "ObjectIdentity", "MibIdentifier", "Gauge32", "Bits", "ModuleIdentity")
TruthValue, TimeStamp, TextualConvention, DisplayString, RowStatus, MacAddress, DateAndTime = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TimeStamp", "TextualConvention", "DisplayString", "RowStatus", "MacAddress", "DateAndTime")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", cardTemperatureHighError=cardTemperatureHighError, diskDriveNumber=diskDriveNumber, cmVendor=cmVendor, auditName=auditName, cardSubType=cardSubType, portCardSubType=portCardSubType, cardDplxStatus=cardDplxStatus, cardTestId=cardTestId, diskVolumeNumber=diskVolumeNumber, cardCPLDVersion=cardCPLDVersion, portTrapInh=portTrapInh, cardTestTransId=cardTestTransId, TestTransactionId=TestTransactionId, portDescription=portDescription, cmResetInfo=cmResetInfo, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, portEntry=portEntry, cardTrapInh=cardTrapInh, cardLastBootSource=cardLastBootSource, portNumber=portNumber, cardCarrierHwVersion=cardCarrierHwVersion, errEvRecoveryEnabled=errEvRecoveryEnabled, cardPicDetected=cardPicDetected, cardTestEntry=cardTestEntry, equipmentPortGroup=equipmentPortGroup, equipmentDiagGroup=equipmentDiagGroup, cmResetUpTime=cmResetUpTime, equipmentCardTestGroup=equipmentCardTestGroup, cardCpuSpeed=cardCpuSpeed, auditCycleCount=auditCycleCount, cardPicHwVersion=cardPicHwVersion, cardCarrierSerialNum=cardCarrierSerialNum, cardFpgaSource=cardFpgaSource, cmResetClearNotification=cmResetClearNotification, cardTestResult=cardTestResult, auditCommand=auditCommand, errEvLoggingEnabled=errEvLoggingEnabled, portRxFlowControlDetected=portRxFlowControlDetected, fpgaErrorEventTable=fpgaErrorEventTable, cardTestResultNotification=cardTestResultNotification, portRxFlowControlMode=portRxFlowControlMode, remainInDiagMode=remainInDiagMode, errEvRowStatus=errEvRowStatus, cardAction=cardAction, cardTemperatureHighWarn=cardTemperatureHighWarn, cmResetNotification=cmResetNotification, cardShelfTestIndex=cardShelfTestIndex, cardShelfId=cardShelfId, cmIpAddress=cmIpAddress, diskVolumeDiskSize=diskVolumeDiskSize, cardFwUpdateStatus=cardFwUpdateStatus, portNumChans=portNumChans, portMaxDsPower=portMaxDsPower, equipmentTbl=equipmentTbl, portDetectedMode=portDetectedMode, diskVolumeUsageNotification=diskVolumeUsageNotification, cardTestSchedule=cardTestSchedule, cardSecStateChange=cardSecStateChange, equipmentState=equipmentState, portPrState=portPrState, diskVolumeDriveId=diskVolumeDriveId, auditTable=auditTable, TestType=TestType, cardPicSerialNum=cardPicSerialNum, cardTestIndex=cardTestIndex, shelfNumber=shelfNumber, portTable=portTable, portDplxStatusChange=portDplxStatusChange, cardDplxStatusChange=cardDplxStatusChange, auditCardId=auditCardId, cardCpuType=cardCpuType, auditEntry=auditEntry, cmResetStatus=cmResetStatus, portMacAddress=portMacAddress, cardLastResetReason=cardLastResetReason, cardSerialNum=cardSerialNum, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, portType=portType, auditTotalPassedCount=auditTotalPassedCount, cardTemperature=cardTemperature, systemGeneral=systemGeneral, PYSNMP_MODULE_ID=cadEquipmentMib, auditLogOutput=auditLogOutput, cardTestTime=cardTestTime, cardBootVersion=cardBootVersion, cardSpareGroupId=cardSpareGroupId, consoleOutput=consoleOutput, cardDetectedChange=cardDetectedChange, cardTestCommand=cardTestCommand, auditAutoScheduling=auditAutoScheduling, auditTime=auditTime, cardUpTime=cardUpTime, equipmentStateGroup=equipmentStateGroup, cardTestDescription=cardTestDescription, cardNumber=cardNumber, portAction=portAction, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, cadEquipmentMibConformance=cadEquipmentMibConformance, portDocsIfIndex=portDocsIfIndex, diskVolumeUsageLevel=diskVolumeUsageLevel, cardType=cardType, cardFwVersion=cardFwVersion, portCurrDsPower=portCurrDsPower, TestScheduleCommand=TestScheduleCommand, cardId=cardId, cardSwVersion=cardSwVersion, diskVolumeUsagePercentage=diskVolumeUsagePercentage, cardSpareGroupMode=cardSpareGroupMode, eqDiagConfig=eqDiagConfig, cardPrState=cardPrState, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, auditStatus=auditStatus, cmResetReason=cmResetReason, portTxFlowControlDetected=portTxFlowControlDetected, equipmentAudit=equipmentAudit, cardLastChangeTime=cardLastChangeTime, diskVolumeName=diskVolumeName, shelfSwVersion=shelfSwVersion, diskVolumeId=diskVolumeId, cadEquipmentMibGroup=cadEquipmentMibGroup, cmUChannelID=cmUChannelID, cardTempOverHeatNotification=cardTempOverHeatNotification, cardEntry=cardEntry, cardTestResultDesc=cardTestResultDesc, systemKey=systemKey, diskVolumeTrapInh=diskVolumeTrapInh, auditLogThrottle=auditLogThrottle, portShelfId=portShelfId, portId=portId, portSecStateChange=portSecStateChange, equipmentShelfGroup=equipmentShelfGroup, cardTable=cardTable, cardLastBootVersion=cardLastBootVersion, cmMacAddress=cmMacAddress, cardTestType=cardTestType, systemClock=systemClock, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, cardTestScheduleCommand=cardTestScheduleCommand, auditDescription=auditDescription, trapCounter=trapCounter, shelfObjects=shelfObjects, equipmentTraps=equipmentTraps, shelfName=shelfName, portTxFlowControlMode=portTxFlowControlMode, equipmentCardGroup=equipmentCardGroup, auditTotalFailedCount=auditTotalFailedCount, diagTestId=diagTestId, portMinDsPower=portMinDsPower, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, errEvLogLevel=errEvLogLevel, cardDetected=cardDetected, portLastChangeTime=portLastChangeTime, auditFailedCount=auditFailedCount, cardPrStateChange=cardPrStateChange, cadEquipmentMib=cadEquipmentMib, portConnectorId=portConnectorId, verboseLevel=verboseLevel, cardTestTable=cardTestTable, auditResult=auditResult, fpgaErrorEventEntry=fpgaErrorEventEntry, cardAdminState=cardAdminState, cardSubDetected=cardSubDetected, cardTestName=cardTestName, equipmentError=equipmentError, TestResult=TestResult, cmPrimarySID=cmPrimarySID, portDplxStatus=portDplxStatus, systemGeneralGroup=systemGeneralGroup, auditPassedCount=auditPassedCount, cardRamSize=cardRamSize, TestCommand=TestCommand, cardNumPorts=cardNumPorts, portSecState=portSecState, equipmentAuditGroup=equipmentAuditGroup, portAdminState=portAdminState, TestSchedule=TestSchedule, diskVolumeTable=diskVolumeTable, portMode=portMode, errEventId=errEventId, diskVolumeFileName=diskVolumeFileName, cardSecState=cardSecState, equipmentDiag=equipmentDiag, portPrStateChange=portPrStateChange, diskVolumeSize=diskVolumeSize, diskVolumeCardId=diskVolumeCardId, cardTempNoReportNotification=cardTempNoReportNotification, cmDevice=cmDevice, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cardName=cardName, cmRegistrationNotification=cmRegistrationNotification, diskVolumeShelfId=diskVolumeShelfId, auditShelfId=auditShelfId, downstreamPowerLoss=downstreamPowerLoss, diskVolumeGroup=diskVolumeGroup, cardHwVersion=cardHwVersion, portBgpId=portBgpId, portMacIfIndex=portMacIfIndex, fpgaErrorEventGroup=fpgaErrorEventGroup, trapSeverity=trapSeverity, auditId=auditId, diskVolumeEntry=diskVolumeEntry, cadEquipmentMibCompliance=cadEquipmentMibCompliance, cardBusSpeed=cardBusSpeed, cardFlashSize=cardFlashSize, TestId=TestId, cardCarrierFwVersion=cardCarrierFwVersion, portCardId=portCardId)
