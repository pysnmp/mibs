...
DuplexStatus, CardId, FirmwareSource, SecondaryState, PortType, CardSubType, AdminState, DiskVolumeUsageLevel, PortDetectedMode, FlowControlMode, EqActionType, ShelfId, UnknownState, CardType, PortMode, PicType, PortId, PrimaryState = mibBuilder.importSymbols("CADANT-TC", "DuplexStatus", "CardId", "FirmwareSource", "SecondaryState", "PortType", "CardSubType", "AdminState", "DiskVolumeUsageLevel", "PortDetectedMode", "FlowControlMode", "EqActionType", "ShelfId", "UnknownState", "CardType", "PortMode", "PicType", "PortId", "PrimaryState")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
NotificationGroup, ObjectGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ObjectGroup", "ModuleCompliance")
MibIdentifier, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, NotificationType, iso, Integer32, TimeTicks, IpAddress, Unsigned32, Gauge32, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "NotificationType", "iso", "Integer32", "TimeTicks", "IpAddress", "Unsigned32", "Gauge32", "ObjectIdentity", "ModuleIdentity")
DateAndTime, DisplayString, TruthValue, TimeStamp, MacAddress, RowStatus, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "DisplayString", "TruthValue", "TimeStamp", "MacAddress", "RowStatus", "TextualConvention")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", portNumChans=portNumChans, portEntry=portEntry, equipmentAuditGroup=equipmentAuditGroup, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, equipmentPortGroup=equipmentPortGroup, diskVolumeUsageLevel=diskVolumeUsageLevel, portTxFlowControlMode=portTxFlowControlMode, portRxFlowControlMode=portRxFlowControlMode, cardEntry=cardEntry, cardSwVersion=cardSwVersion, portTxFlowControlDetected=portTxFlowControlDetected, cardTestTime=cardTestTime, cardLastResetReason=cardLastResetReason, cardTestEntry=cardTestEntry, errEvLoggingEnabled=errEvLoggingEnabled, cardTempNoReportNotification=cardTempNoReportNotification, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, portMacIfIndex=portMacIfIndex, cardTestIndex=cardTestIndex, cardLastBootVersion=cardLastBootVersion, portDescription=portDescription, auditName=auditName, portDplxStatus=portDplxStatus, diskVolumeTrapInh=diskVolumeTrapInh, portTrapInh=portTrapInh, cardTestName=cardTestName, auditCycleCount=auditCycleCount, cardDetectedChange=cardDetectedChange, auditResult=auditResult, errEventId=errEventId, fpgaErrorEventTable=fpgaErrorEventTable, cardNumPorts=cardNumPorts, TestCommand=TestCommand, portNumber=portNumber, verboseLevel=verboseLevel, PYSNMP_MODULE_ID=cadEquipmentMib, portTable=portTable, equipmentDiagGroup=equipmentDiagGroup, cardTestTable=cardTestTable, trapCounter=trapCounter, cmIpAddress=cmIpAddress, cardPicDetected=cardPicDetected, portSecState=portSecState, cardTestResultDesc=cardTestResultDesc, cardSubType=cardSubType, cardTestId=cardTestId, equipmentStateGroup=equipmentStateGroup, errEvRowStatus=errEvRowStatus, cadEquipmentMib=cadEquipmentMib, equipmentState=equipmentState, eqDiagConfig=eqDiagConfig, cardTestCommand=cardTestCommand, cadEquipmentMibCompliances=cadEquipmentMibCompliances, portMinDsPower=portMinDsPower, cmResetReason=cmResetReason, portBgpId=portBgpId, diskVolumeEntry=diskVolumeEntry, shelfObjects=shelfObjects, cardTestTransId=cardTestTransId, cmResetStatus=cmResetStatus, cardNumber=cardNumber, downstreamPowerLoss=downstreamPowerLoss, equipmentDiag=equipmentDiag, auditFailedCount=auditFailedCount, cardLastChangeTime=cardLastChangeTime, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cardCpuType=cardCpuType, cardCarrierSerialNum=cardCarrierSerialNum, portMode=portMode, diskVolumeUsageNotification=diskVolumeUsageNotification, auditDescription=auditDescription, cmDevice=cmDevice, cmVendor=cmVendor, portSecStateChange=portSecStateChange, cardTestResult=cardTestResult, diskVolumeName=diskVolumeName, errEvLogLevel=errEvLogLevel, cardTable=cardTable, cmUChannelID=cmUChannelID, cardFlashSize=cardFlashSize, portDetectedMode=portDetectedMode, portCardSubType=portCardSubType, portAdminState=portAdminState, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, diagTestId=diagTestId, shelfName=shelfName, TestScheduleCommand=TestScheduleCommand, cardFwVersion=cardFwVersion, cardSecState=cardSecState, cardFwUpdateStatus=cardFwUpdateStatus, errEvRecoveryEnabled=errEvRecoveryEnabled, cardName=cardName, cardSerialNum=cardSerialNum, cardSecStateChange=cardSecStateChange, systemClock=systemClock, cardTestDescription=cardTestDescription, cardTempOverHeatNotification=cardTempOverHeatNotification, equipmentCardTestGroup=equipmentCardTestGroup, portId=portId, auditTime=auditTime, equipmentError=equipmentError, cardDetected=cardDetected, portPrStateChange=portPrStateChange, cardTrapInh=cardTrapInh, shelfNumber=shelfNumber, diskDriveNumber=diskDriveNumber, diskVolumeDiskSize=diskVolumeDiskSize, cardTemperatureHighError=cardTemperatureHighError, portRxFlowControlDetected=portRxFlowControlDetected, remainInDiagMode=remainInDiagMode, cmResetInfo=cmResetInfo, TestResult=TestResult, cardBootVersion=cardBootVersion, cardLastBootSource=cardLastBootSource, cmResetUpTime=cmResetUpTime, auditShelfId=auditShelfId, portDplxStatusChange=portDplxStatusChange, cadEquipmentMibCompliance=cadEquipmentMibCompliance, diskVolumeNumber=diskVolumeNumber, diskVolumeSize=diskVolumeSize, portType=portType, auditPassedCount=auditPassedCount, cardCPLDVersion=cardCPLDVersion, cardAction=cardAction, cardUpTime=cardUpTime, portCardId=portCardId, cardPicHwVersion=cardPicHwVersion, auditCommand=auditCommand, systemGeneralGroup=systemGeneralGroup, cardType=cardType, auditTable=auditTable, auditCardId=auditCardId, shelfSwVersion=shelfSwVersion, equipmentAudit=equipmentAudit, TestType=TestType, equipmentShelfGroup=equipmentShelfGroup, cardPrState=cardPrState, auditLogThrottle=auditLogThrottle, cardCpuSpeed=cardCpuSpeed, equipmentTraps=equipmentTraps, diskVolumeId=diskVolumeId, cardCarrierFwVersion=cardCarrierFwVersion, cmRegistrationNotification=cmRegistrationNotification, cardShelfTestIndex=cardShelfTestIndex, equipmentCardGroup=equipmentCardGroup, auditStatus=auditStatus, cardTestSchedule=cardTestSchedule, cardFpgaSource=cardFpgaSource, diskVolumeGroup=diskVolumeGroup, trapSeverity=trapSeverity, TestTransactionId=TestTransactionId, systemKey=systemKey, auditAutoScheduling=auditAutoScheduling, cardTemperatureHighWarn=cardTemperatureHighWarn, diskVolumeCardId=diskVolumeCardId, cardTestType=cardTestType, auditLogOutput=auditLogOutput, cardDplxStatus=cardDplxStatus, portConnectorId=portConnectorId, cardTestResultNotification=cardTestResultNotification, cardAdminState=cardAdminState, cardTestScheduleCommand=cardTestScheduleCommand, auditTotalPassedCount=auditTotalPassedCount, portShelfId=portShelfId, diskVolumeShelfId=diskVolumeShelfId, auditId=auditId, TestSchedule=TestSchedule, cardBusSpeed=cardBusSpeed, cardId=cardId, portLastChangeTime=portLastChangeTime, systemGeneral=systemGeneral, fpgaErrorEventGroup=fpgaErrorEventGroup, cmMacAddress=cmMacAddress, equipmentTbl=equipmentTbl, diskVolumeTable=diskVolumeTable, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, fpgaErrorEventEntry=fpgaErrorEventEntry, consoleOutput=consoleOutput, cardCarrierHwVersion=cardCarrierHwVersion, TestId=TestId, cardSpareGroupMode=cardSpareGroupMode, cmResetNotification=cmResetNotification, cmResetClearNotification=cmResetClearNotification, cardSpareGroupId=cardSpareGroupId, portCurrDsPower=portCurrDsPower, portMaxDsPower=portMaxDsPower, cardRamSize=cardRamSize, auditTotalFailedCount=auditTotalFailedCount, cardTemperature=cardTemperature, cardPicSerialNum=cardPicSerialNum, auditEntry=auditEntry, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, cardPrStateChange=cardPrStateChange, cardShelfId=cardShelfId, cardSubDetected=cardSubDetected, cadEquipmentMibConformance=cadEquipmentMibConformance, diskVolumeUsagePercentage=diskVolumeUsagePercentage, cardHwVersion=cardHwVersion, diskVolumeFileName=diskVolumeFileName, cardDplxStatusChange=cardDplxStatusChange, portDocsIfIndex=portDocsIfIndex, cmPrimarySID=cmPrimarySID, portPrState=portPrState, cadEquipmentMibGroup=cadEquipmentMibGroup, diskVolumeDriveId=diskVolumeDriveId, portMacAddress=portMacAddress, portAction=portAction)
