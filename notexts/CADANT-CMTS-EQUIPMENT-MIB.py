...
FlowControlMode, AdminState, PrimaryState, DiskVolumeUsageLevel, PortId, PortType, ShelfId, UnknownState, CardId, PicType, PortMode, SecondaryState, PortDetectedMode, CardType, EqActionType, DuplexStatus, CardSubType, FirmwareSource = mibBuilder.importSymbols("CADANT-TC", "FlowControlMode", "AdminState", "PrimaryState", "DiskVolumeUsageLevel", "PortId", "PortType", "ShelfId", "UnknownState", "CardId", "PicType", "PortMode", "SecondaryState", "PortDetectedMode", "CardType", "EqActionType", "DuplexStatus", "CardSubType", "FirmwareSource")
...
MacAddress, TextualConvention, RowStatus, DisplayString, TimeStamp, DateAndTime, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "MacAddress", "TextualConvention", "RowStatus", "DisplayString", "TimeStamp", "DateAndTime", "TruthValue")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", diskVolumeCardId=diskVolumeCardId, portRxFlowControlMode=portRxFlowControlMode, portSecState=portSecState, auditDescription=auditDescription, portTable=portTable, systemKey=systemKey, portNumber=portNumber, cardDplxStatus=cardDplxStatus, portBgpId=portBgpId, auditTotalFailedCount=auditTotalFailedCount, diskVolumeNumber=diskVolumeNumber, diskVolumeUsagePercentage=diskVolumeUsagePercentage, portConnectorId=portConnectorId, cardCPLDVersion=cardCPLDVersion, auditCommand=auditCommand, cardDetected=cardDetected, systemGeneralGroup=systemGeneralGroup, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cmDevice=cmDevice, cmResetClearNotification=cmResetClearNotification, cardSecStateChange=cardSecStateChange, portCardId=portCardId, auditFailedCount=auditFailedCount, auditCycleCount=auditCycleCount, cardLastBootSource=cardLastBootSource, cardUpTime=cardUpTime, portPrState=portPrState, equipmentAudit=equipmentAudit, cmRegistrationNotification=cmRegistrationNotification, equipmentTraps=equipmentTraps, cardTestTable=cardTestTable, cardTestCommand=cardTestCommand, cardCarrierFwVersion=cardCarrierFwVersion, equipmentDiagGroup=equipmentDiagGroup, cardFwVersion=cardFwVersion, cmResetNotification=cmResetNotification, cardPicSerialNum=cardPicSerialNum, fpgaErrorEventEntry=fpgaErrorEventEntry, cardSwVersion=cardSwVersion, equipmentPortGroup=equipmentPortGroup, diskVolumeName=diskVolumeName, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, cardTemperatureHighWarn=cardTemperatureHighWarn, diskVolumeTrapInh=diskVolumeTrapInh, portCurrDsPower=portCurrDsPower, cardPrStateChange=cardPrStateChange, portTrapInh=portTrapInh, cardCpuSpeed=cardCpuSpeed, auditPassedCount=auditPassedCount, equipmentCardTestGroup=equipmentCardTestGroup, cardTemperature=cardTemperature, portDescription=portDescription, cardCarrierSerialNum=cardCarrierSerialNum, cardBusSpeed=cardBusSpeed, errEventId=errEventId, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, equipmentState=equipmentState, cmIpAddress=cmIpAddress, verboseLevel=verboseLevel, cadEquipmentMibCompliance=cadEquipmentMibCompliance, auditShelfId=auditShelfId, cmResetUpTime=cmResetUpTime, cardLastBootVersion=cardLastBootVersion, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, cardPrState=cardPrState, cardTestTime=cardTestTime, cardTestEntry=cardTestEntry, cardShelfTestIndex=cardShelfTestIndex, cadEquipmentMib=cadEquipmentMib, systemClock=systemClock, cardSpareGroupId=cardSpareGroupId, cmVendor=cmVendor, portMinDsPower=portMinDsPower, diskVolumeId=diskVolumeId, cmUChannelID=cmUChannelID, diskVolumeSize=diskVolumeSize, cardShelfId=cardShelfId, cmPrimarySID=cmPrimarySID, cardBootVersion=cardBootVersion, cardCarrierHwVersion=cardCarrierHwVersion, errEvLogLevel=errEvLogLevel, cardDetectedChange=cardDetectedChange, cardTestResultNotification=cardTestResultNotification, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, fpgaErrorEventTable=fpgaErrorEventTable, TestScheduleCommand=TestScheduleCommand, diskVolumeUsageLevel=diskVolumeUsageLevel, auditLogOutput=auditLogOutput, shelfObjects=shelfObjects, cardHwVersion=cardHwVersion, auditEntry=auditEntry, systemGeneral=systemGeneral, cadEquipmentMibConformance=cadEquipmentMibConformance, portSecStateChange=portSecStateChange, PYSNMP_MODULE_ID=cadEquipmentMib, TestSchedule=TestSchedule, cardCpuType=cardCpuType, cardTemperatureHighError=cardTemperatureHighError, portDetectedMode=portDetectedMode, cardTestDescription=cardTestDescription, portRxFlowControlDetected=portRxFlowControlDetected, equipmentDiag=equipmentDiag, cardAction=cardAction, cardSerialNum=cardSerialNum, portNumChans=portNumChans, cadEquipmentMibGroup=cadEquipmentMibGroup, cmMacAddress=cmMacAddress, cardTable=cardTable, auditName=auditName, auditLogThrottle=auditLogThrottle, auditTime=auditTime, portMaxDsPower=portMaxDsPower, diskVolumeGroup=diskVolumeGroup, portTxFlowControlDetected=portTxFlowControlDetected, portCardSubType=portCardSubType, cardNumber=cardNumber, auditAutoScheduling=auditAutoScheduling, cardTestType=cardTestType, cardTestSchedule=cardTestSchedule, cardId=cardId, cardSubDetected=cardSubDetected, diskVolumeUsageNotification=diskVolumeUsageNotification, portAdminState=portAdminState, cardDplxStatusChange=cardDplxStatusChange, remainInDiagMode=remainInDiagMode, fpgaErrorEventGroup=fpgaErrorEventGroup, TestCommand=TestCommand, TestResult=TestResult, auditStatus=auditStatus, diskVolumeEntry=diskVolumeEntry, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, cardEntry=cardEntry, cardTestIndex=cardTestIndex, cardTestScheduleCommand=cardTestScheduleCommand, portEntry=portEntry, diskDriveNumber=diskDriveNumber, cardTestResult=cardTestResult, trapSeverity=trapSeverity, cardSpareGroupMode=cardSpareGroupMode, cardPicHwVersion=cardPicHwVersion, cardFwUpdateStatus=cardFwUpdateStatus, auditCardId=auditCardId, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, portDplxStatusChange=portDplxStatusChange, portMode=portMode, cardLastChangeTime=cardLastChangeTime, consoleOutput=consoleOutput, cardName=cardName, cardFlashSize=cardFlashSize, cardLastResetReason=cardLastResetReason, equipmentShelfGroup=equipmentShelfGroup, equipmentTbl=equipmentTbl, auditTable=auditTable, cardSubType=cardSubType, portMacAddress=portMacAddress, cardTrapInh=cardTrapInh, portMacIfIndex=portMacIfIndex, auditResult=auditResult, auditId=auditId, auditTotalPassedCount=auditTotalPassedCount, diskVolumeDiskSize=diskVolumeDiskSize, eqDiagConfig=eqDiagConfig, cardType=cardType, equipmentError=equipmentError, downstreamPowerLoss=downstreamPowerLoss, errEvLoggingEnabled=errEvLoggingEnabled, TestTransactionId=TestTransactionId, errEvRecoveryEnabled=errEvRecoveryEnabled, cmResetReason=cmResetReason, cardTempOverHeatNotification=cardTempOverHeatNotification, diskVolumeFileName=diskVolumeFileName, portShelfId=portShelfId, cardFpgaSource=cardFpgaSource, TestType=TestType, cardSecState=cardSecState, equipmentCardGroup=equipmentCardGroup, cardTempNoReportNotification=cardTempNoReportNotification, portId=portId, diagTestId=diagTestId, cardPicDetected=cardPicDetected, trapCounter=trapCounter, cardTestId=cardTestId, errEvRowStatus=errEvRowStatus, cardTestName=cardTestName, portDocsIfIndex=portDocsIfIndex, portAction=portAction, portTxFlowControlMode=portTxFlowControlMode, cardAdminState=cardAdminState, equipmentStateGroup=equipmentStateGroup, portDplxStatus=portDplxStatus, cardRamSize=cardRamSize, portPrStateChange=portPrStateChange, shelfNumber=shelfNumber, portLastChangeTime=portLastChangeTime, cardNumPorts=cardNumPorts, portType=portType, shelfSwVersion=shelfSwVersion, equipmentAuditGroup=equipmentAuditGroup, diskVolumeShelfId=diskVolumeShelfId, cmResetStatus=cmResetStatus, TestId=TestId, cmResetInfo=cmResetInfo, shelfName=shelfName, diskVolumeDriveId=diskVolumeDriveId, cardTestTransId=cardTestTransId, cardTestResultDesc=cardTestResultDesc, diskVolumeTable=diskVolumeTable)
