...
FlowControlMode, CardType, PicType, PortDetectedMode, UnknownState, CardSubType, FirmwareSource, DiskVolumeUsageLevel, DuplexStatus, CardId, PortId, PortMode, AdminState, PortType, SecondaryState, ShelfId, PrimaryState, EqActionType = mibBuilder.importSymbols("CADANT-TC", "FlowControlMode", "CardType", "PicType", "PortDetectedMode", "UnknownState", "CardSubType", "FirmwareSource", "DiskVolumeUsageLevel", "DuplexStatus", "CardId", "PortId", "PortMode", "AdminState", "PortType", "SecondaryState", "ShelfId", "PrimaryState", "EqActionType")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
NotificationGroup, ObjectGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ObjectGroup", "ModuleCompliance")
Gauge32, ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Bits, ObjectIdentity, iso, Unsigned32, Counter64, MibIdentifier, Counter32, NotificationType, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Bits", "ObjectIdentity", "iso", "Unsigned32", "Counter64", "MibIdentifier", "Counter32", "NotificationType", "Integer32")
DisplayString, TruthValue, TextualConvention, TimeStamp, MacAddress, DateAndTime, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TruthValue", "TextualConvention", "TimeStamp", "MacAddress", "DateAndTime", "RowStatus")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", shelfSwVersion=shelfSwVersion, auditId=auditId, portSecState=portSecState, cardTempOverHeatNotification=cardTempOverHeatNotification, cardType=cardType, diskVolumeDriveId=diskVolumeDriveId, PYSNMP_MODULE_ID=cadEquipmentMib, cardSwVersion=cardSwVersion, cmPrimarySID=cmPrimarySID, cardName=cardName, cardTemperature=cardTemperature, portBgpId=portBgpId, cardUpTime=cardUpTime, cardTestId=cardTestId, portNumber=portNumber, portId=portId, portNumChans=portNumChans, cardSecStateChange=cardSecStateChange, portShelfId=portShelfId, cardShelfTestIndex=cardShelfTestIndex, TestResult=TestResult, diagTestId=diagTestId, cardPicSerialNum=cardPicSerialNum, auditCardId=auditCardId, auditTotalPassedCount=auditTotalPassedCount, diskVolumeCardId=diskVolumeCardId, cardNumPorts=cardNumPorts, systemKey=systemKey, equipmentCardGroup=equipmentCardGroup, equipmentAuditGroup=equipmentAuditGroup, cardSpareGroupId=cardSpareGroupId, portTable=portTable, diskVolumeUsageNotification=diskVolumeUsageNotification, diskVolumeUsageLevel=diskVolumeUsageLevel, cmResetStatus=cmResetStatus, cmResetNotification=cmResetNotification, consoleOutput=consoleOutput, auditLogThrottle=auditLogThrottle, auditResult=auditResult, cardTestType=cardTestType, portMode=portMode, cardShelfId=cardShelfId, cardFwUpdateStatus=cardFwUpdateStatus, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cardSpareGroupMode=cardSpareGroupMode, portSecStateChange=portSecStateChange, equipmentState=equipmentState, errEventId=errEventId, cardTestTransId=cardTestTransId, diskVolumeName=diskVolumeName, shelfName=shelfName, cardCarrierSerialNum=cardCarrierSerialNum, verboseLevel=verboseLevel, portDplxStatus=portDplxStatus, portDplxStatusChange=portDplxStatusChange, equipmentDiag=equipmentDiag, cardDetected=cardDetected, cardFpgaSource=cardFpgaSource, cardTestCommand=cardTestCommand, equipmentPortGroup=equipmentPortGroup, cardNumber=cardNumber, auditDescription=auditDescription, trapCounter=trapCounter, cadEquipmentMibGroup=cadEquipmentMibGroup, portTrapInh=portTrapInh, cmResetClearNotification=cmResetClearNotification, trapSeverity=trapSeverity, TestId=TestId, portPrState=portPrState, cardTrapInh=cardTrapInh, portCurrDsPower=portCurrDsPower, cardTestEntry=cardTestEntry, portConnectorId=portConnectorId, portPrStateChange=portPrStateChange, portRxFlowControlDetected=portRxFlowControlDetected, portRxFlowControlMode=portRxFlowControlMode, auditName=auditName, auditStatus=auditStatus, systemGeneral=systemGeneral, cardTestResultNotification=cardTestResultNotification, cardLastResetReason=cardLastResetReason, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, cardTestDescription=cardTestDescription, fpgaErrorEventEntry=fpgaErrorEventEntry, cmUChannelID=cmUChannelID, cardHwVersion=cardHwVersion, auditTime=auditTime, equipmentDiagGroup=equipmentDiagGroup, portDetectedMode=portDetectedMode, cardTestIndex=cardTestIndex, systemClock=systemClock, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, portAdminState=portAdminState, portEntry=portEntry, fpgaErrorEventTable=fpgaErrorEventTable, cadEquipmentMib=cadEquipmentMib, shelfNumber=shelfNumber, auditAutoScheduling=auditAutoScheduling, cardCarrierHwVersion=cardCarrierHwVersion, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, diskVolumeFileName=diskVolumeFileName, auditTable=auditTable, diskVolumeGroup=diskVolumeGroup, equipmentShelfGroup=equipmentShelfGroup, fpgaErrorEventGroup=fpgaErrorEventGroup, errEvLoggingEnabled=errEvLoggingEnabled, TestCommand=TestCommand, cardTestTable=cardTestTable, diskVolumeSize=diskVolumeSize, auditLogOutput=auditLogOutput, cardPicHwVersion=cardPicHwVersion, cardDplxStatus=cardDplxStatus, TestType=TestType, downstreamPowerLoss=downstreamPowerLoss, cardSubType=cardSubType, TestScheduleCommand=TestScheduleCommand, portMacAddress=portMacAddress, equipmentAudit=equipmentAudit, cmResetReason=cmResetReason, cardCpuType=cardCpuType, cardCarrierFwVersion=cardCarrierFwVersion, cardTestScheduleCommand=cardTestScheduleCommand, portTxFlowControlMode=portTxFlowControlMode, cmDevice=cmDevice, cardEntry=cardEntry, cardCPLDVersion=cardCPLDVersion, cmIpAddress=cmIpAddress, portMinDsPower=portMinDsPower, cardLastChangeTime=cardLastChangeTime, auditEntry=auditEntry, cardDetectedChange=cardDetectedChange, portDocsIfIndex=portDocsIfIndex, diskVolumeEntry=diskVolumeEntry, portType=portType, diskVolumeShelfId=diskVolumeShelfId, errEvRecoveryEnabled=errEvRecoveryEnabled, errEvLogLevel=errEvLogLevel, TestTransactionId=TestTransactionId, diskVolumeTrapInh=diskVolumeTrapInh, auditFailedCount=auditFailedCount, cardId=cardId, portMaxDsPower=portMaxDsPower, portDescription=portDescription, cardAction=cardAction, cardFwVersion=cardFwVersion, cardBootVersion=cardBootVersion, cardTestSchedule=cardTestSchedule, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, cardRamSize=cardRamSize, cadEquipmentMibCompliance=cadEquipmentMibCompliance, cardTemperatureHighError=cardTemperatureHighError, cardSecState=cardSecState, remainInDiagMode=remainInDiagMode, cmResetInfo=cmResetInfo, cardDplxStatusChange=cardDplxStatusChange, auditCycleCount=auditCycleCount, portCardId=portCardId, diskVolumeUsagePercentage=diskVolumeUsagePercentage, cardTemperatureHighWarn=cardTemperatureHighWarn, cardTable=cardTable, cardTestTime=cardTestTime, shelfObjects=shelfObjects, cmRegistrationNotification=cmRegistrationNotification, cardTestName=cardTestName, equipmentCardTestGroup=equipmentCardTestGroup, portAction=portAction, auditCommand=auditCommand, equipmentTraps=equipmentTraps, cardTempNoReportNotification=cardTempNoReportNotification, diskDriveNumber=diskDriveNumber, cardAdminState=cardAdminState, errEvRowStatus=errEvRowStatus, diskVolumeTable=diskVolumeTable, diskVolumeId=diskVolumeId, cardCpuSpeed=cardCpuSpeed, equipmentTbl=equipmentTbl, cardTestResultDesc=cardTestResultDesc, TestSchedule=TestSchedule, cardFlashSize=cardFlashSize, portCardSubType=portCardSubType, cardPicDetected=cardPicDetected, portMacIfIndex=portMacIfIndex, cardLastBootVersion=cardLastBootVersion, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, cmMacAddress=cmMacAddress, diskVolumeDiskSize=diskVolumeDiskSize, cardTestResult=cardTestResult, portTxFlowControlDetected=portTxFlowControlDetected, cmVendor=cmVendor, cadEquipmentMibConformance=cadEquipmentMibConformance, cardSerialNum=cardSerialNum, cmResetUpTime=cmResetUpTime, equipmentError=equipmentError, cardLastBootSource=cardLastBootSource, systemGeneralGroup=systemGeneralGroup, equipmentStateGroup=equipmentStateGroup, diskVolumeNumber=diskVolumeNumber, auditTotalFailedCount=auditTotalFailedCount, cardPrStateChange=cardPrStateChange, portLastChangeTime=portLastChangeTime, cardBusSpeed=cardBusSpeed, cardSubDetected=cardSubDetected, cardPrState=cardPrState, auditPassedCount=auditPassedCount, auditShelfId=auditShelfId, eqDiagConfig=eqDiagConfig)
