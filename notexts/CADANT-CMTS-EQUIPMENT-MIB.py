...
ShelfId, FirmwareSource, AdminState, FlowControlMode, PortDetectedMode, CardId, CardSubType, CardType, UnknownState, PicType, PortType, DiskVolumeUsageLevel, EqActionType, DuplexStatus, PortId, PrimaryState, SecondaryState, PortMode = mibBuilder.importSymbols("CADANT-TC", "ShelfId", "FirmwareSource", "AdminState", "FlowControlMode", "PortDetectedMode", "CardId", "CardSubType", "CardType", "UnknownState", "PicType", "PortType", "DiskVolumeUsageLevel", "EqActionType", "DuplexStatus", "PortId", "PrimaryState", "SecondaryState", "PortMode")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ModuleCompliance, NotificationGroup, ObjectGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "NotificationGroup", "ObjectGroup")
Counter32, Counter64, Integer32, NotificationType, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Gauge32, Bits, ModuleIdentity, ObjectIdentity, Unsigned32, MibIdentifier, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "Integer32", "NotificationType", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Gauge32", "Bits", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "MibIdentifier", "IpAddress")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", diskVolumeUsageLevel=diskVolumeUsageLevel, cardCarrierHwVersion=cardCarrierHwVersion, cmMacAddress=cmMacAddress, fpgaErrorEventGroup=fpgaErrorEventGroup, shelfSwVersion=shelfSwVersion, cardPicSerialNum=cardPicSerialNum, cardFpgaSource=cardFpgaSource, cmIpAddress=cmIpAddress, cardTempOverHeatNotification=cardTempOverHeatNotification, cardTestScheduleCommand=cardTestScheduleCommand, equipmentAudit=equipmentAudit, auditLogOutput=auditLogOutput, auditResult=auditResult, cardTestCommand=cardTestCommand, cardCPLDVersion=cardCPLDVersion, equipmentTbl=equipmentTbl, cardTestIndex=cardTestIndex, cardDetectedChange=cardDetectedChange, cmDevice=cmDevice, cardSpareGroupMode=cardSpareGroupMode, auditDescription=auditDescription, cmResetUpTime=cmResetUpTime, auditAutoScheduling=auditAutoScheduling, auditName=auditName, cardLastChangeTime=cardLastChangeTime, cardFwVersion=cardFwVersion, cadEquipmentMibCompliances=cadEquipmentMibCompliances, portBgpId=portBgpId, errEventId=errEventId, portDocsIfIndex=portDocsIfIndex, cardCarrierFwVersion=cardCarrierFwVersion, errEvRecoveryEnabled=errEvRecoveryEnabled, portAdminState=portAdminState, cardSecState=cardSecState, auditTable=auditTable, diskVolumeId=diskVolumeId, auditPassedCount=auditPassedCount, portRxFlowControlMode=portRxFlowControlMode, systemKey=systemKey, cmRegistrationNotification=cmRegistrationNotification, TestCommand=TestCommand, portEntry=portEntry, auditTotalPassedCount=auditTotalPassedCount, trapCounter=trapCounter, shelfNumber=shelfNumber, cardTable=cardTable, cardTestTransId=cardTestTransId, errEvLoggingEnabled=errEvLoggingEnabled, cardId=cardId, cmResetStatus=cmResetStatus, auditCycleCount=auditCycleCount, cardSpareGroupId=cardSpareGroupId, cadEquipmentMibCompliance=cadEquipmentMibCompliance, auditCardId=auditCardId, errEvRowStatus=errEvRowStatus, cardTestSchedule=cardTestSchedule, cmPrimarySID=cmPrimarySID, diskVolumeCardId=diskVolumeCardId, cardTestEntry=cardTestEntry, portPrStateChange=portPrStateChange, equipmentPortGroup=equipmentPortGroup, portDetectedMode=portDetectedMode, cardName=cardName, cardLastResetReason=cardLastResetReason, auditShelfId=auditShelfId, systemClock=systemClock, cardTestTime=cardTestTime, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, portLastChangeTime=portLastChangeTime, portSecState=portSecState, portTxFlowControlMode=portTxFlowControlMode, diskVolumeDriveId=diskVolumeDriveId, portRxFlowControlDetected=portRxFlowControlDetected, diskVolumeNumber=diskVolumeNumber, auditStatus=auditStatus, cardTestResult=cardTestResult, cmUChannelID=cmUChannelID, TestResult=TestResult, consoleOutput=consoleOutput, cadEquipmentMibGroup=cadEquipmentMibGroup, equipmentDiag=equipmentDiag, portDplxStatusChange=portDplxStatusChange, auditTime=auditTime, cardBootVersion=cardBootVersion, portTrapInh=portTrapInh, cardCpuSpeed=cardCpuSpeed, cardDplxStatusChange=cardDplxStatusChange, remainInDiagMode=remainInDiagMode, TestId=TestId, TestType=TestType, verboseLevel=verboseLevel, cardSubType=cardSubType, portTable=portTable, portId=portId, diskDriveNumber=diskDriveNumber, shelfObjects=shelfObjects, cardAdminState=cardAdminState, cardEntry=cardEntry, cardTestResultDesc=cardTestResultDesc, auditLogThrottle=auditLogThrottle, auditId=auditId, cardCarrierSerialNum=cardCarrierSerialNum, TestTransactionId=TestTransactionId, cardSerialNum=cardSerialNum, equipmentCardGroup=equipmentCardGroup, cardNumPorts=cardNumPorts, cardTemperatureHighWarn=cardTemperatureHighWarn, auditCommand=auditCommand, cadEquipmentMib=cadEquipmentMib, equipmentStateGroup=equipmentStateGroup, cardSwVersion=cardSwVersion, cardNumber=cardNumber, diskVolumeDiskSize=diskVolumeDiskSize, cardTestType=cardTestType, portDescription=portDescription, systemGeneralGroup=systemGeneralGroup, equipmentDiagGroup=equipmentDiagGroup, diskVolumeGroup=diskVolumeGroup, diskVolumeName=diskVolumeName, diskVolumeFileName=diskVolumeFileName, cardRamSize=cardRamSize, cardDplxStatus=cardDplxStatus, cardLastBootSource=cardLastBootSource, diskVolumeShelfId=diskVolumeShelfId, cardTemperatureHighError=cardTemperatureHighError, cardTestDescription=cardTestDescription, auditEntry=auditEntry, cmResetNotification=cmResetNotification, cardType=cardType, equipmentCardTestGroup=equipmentCardTestGroup, portMinDsPower=portMinDsPower, diskVolumeTable=diskVolumeTable, cardAction=cardAction, cardTempNoReportNotification=cardTempNoReportNotification, shelfName=shelfName, errEvLogLevel=errEvLogLevel, auditTotalFailedCount=auditTotalFailedCount, portTxFlowControlDetected=portTxFlowControlDetected, trapSeverity=trapSeverity, diskVolumeEntry=diskVolumeEntry, portShelfId=portShelfId, fpgaErrorEventEntry=fpgaErrorEventEntry, portPrState=portPrState, fpgaErrorEventTable=fpgaErrorEventTable, PYSNMP_MODULE_ID=cadEquipmentMib, equipmentError=equipmentError, downstreamPowerLoss=downstreamPowerLoss, portMode=portMode, cardTestTable=cardTestTable, cmResetClearNotification=cmResetClearNotification, diskVolumeUsagePercentage=diskVolumeUsagePercentage, cardUpTime=cardUpTime, cardPicHwVersion=cardPicHwVersion, cardTestId=cardTestId, cardPicDetected=cardPicDetected, portCardId=portCardId, equipmentTraps=equipmentTraps, portNumber=portNumber, cmResetReason=cmResetReason, diskVolumeSize=diskVolumeSize, systemGeneral=systemGeneral, cardBusSpeed=cardBusSpeed, cadEquipmentMibConformance=cadEquipmentMibConformance, cardPrState=cardPrState, cardCpuType=cardCpuType, portMaxDsPower=portMaxDsPower, cardTrapInh=cardTrapInh, portAction=portAction, equipmentAuditGroup=equipmentAuditGroup, TestScheduleCommand=TestScheduleCommand, eqDiagConfig=eqDiagConfig, cardHwVersion=cardHwVersion, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, cardSubDetected=cardSubDetected, equipmentShelfGroup=equipmentShelfGroup, portCurrDsPower=portCurrDsPower, equipmentState=equipmentState, cardSecStateChange=cardSecStateChange, cmVendor=cmVendor, cardFlashSize=cardFlashSize, cardTemperature=cardTemperature, portConnectorId=portConnectorId, cardFwUpdateStatus=cardFwUpdateStatus, portMacIfIndex=portMacIfIndex, portMacAddress=portMacAddress, diskVolumeTrapInh=diskVolumeTrapInh, TestSchedule=TestSchedule, portNumChans=portNumChans, cardTestName=cardTestName, cardShelfId=cardShelfId, cardTestResultNotification=cardTestResultNotification, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, cardDetected=cardDetected, diagTestId=diagTestId, cmResetInfo=cmResetInfo, cardPrStateChange=cardPrStateChange, cardLastBootVersion=cardLastBootVersion, portSecStateChange=portSecStateChange, cardShelfTestIndex=cardShelfTestIndex, portCardSubType=portCardSubType, portDplxStatus=portDplxStatus, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, auditFailedCount=auditFailedCount, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, portType=portType, diskVolumeUsageNotification=diskVolumeUsageNotification)
