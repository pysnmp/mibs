...
UnknownState, FirmwareSource, PicType, EqActionType, PortType, PortDetectedMode, DiskVolumeUsageLevel, AdminState, CardId, FlowControlMode, PrimaryState, DuplexStatus, PortId, CardSubType, SecondaryState, PortMode, ShelfId, CardType = mibBuilder.importSymbols("CADANT-TC", "UnknownState", "FirmwareSource", "PicType", "EqActionType", "PortType", "PortDetectedMode", "DiskVolumeUsageLevel", "AdminState", "CardId", "FlowControlMode", "PrimaryState", "DuplexStatus", "PortId", "CardSubType", "SecondaryState", "PortMode", "ShelfId", "CardType")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ObjectGroup, ModuleCompliance, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "ModuleCompliance", "NotificationGroup")
iso, Counter64, Gauge32, Unsigned32, ModuleIdentity, IpAddress, ObjectIdentity, Integer32, Counter32, TimeTicks, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter64", "Gauge32", "Unsigned32", "ModuleIdentity", "IpAddress", "ObjectIdentity", "Integer32", "Counter32", "TimeTicks", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
DateAndTime, DisplayString, MacAddress, RowStatus, TruthValue, TextualConvention, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "DisplayString", "MacAddress", "RowStatus", "TruthValue", "TextualConvention", "TimeStamp")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", cardTestTable=cardTestTable, cardAdminState=cardAdminState, portId=portId, portConnectorId=portConnectorId, auditDescription=auditDescription, auditPassedCount=auditPassedCount, portRxFlowControlMode=portRxFlowControlMode, cadEquipmentMibCompliances=cadEquipmentMibCompliances, portShelfId=portShelfId, cadEquipmentMib=cadEquipmentMib, portDplxStatusChange=portDplxStatusChange, fpgaErrorEventGroup=fpgaErrorEventGroup, cardTempNoReportNotification=cardTempNoReportNotification, diagTestId=diagTestId, cardId=cardId, diskVolumeDiskSize=diskVolumeDiskSize, cardTestSchedule=cardTestSchedule, trapSeverity=trapSeverity, portTable=portTable, portEntry=portEntry, cardTable=cardTable, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, portMacIfIndex=portMacIfIndex, consoleOutput=consoleOutput, auditCommand=auditCommand, shelfSwVersion=shelfSwVersion, diskVolumeTable=diskVolumeTable, auditStatus=auditStatus, portLastChangeTime=portLastChangeTime, equipmentAuditGroup=equipmentAuditGroup, cardNumPorts=cardNumPorts, cardFwUpdateStatus=cardFwUpdateStatus, diskVolumeName=diskVolumeName, downstreamPowerLoss=downstreamPowerLoss, cardLastResetReason=cardLastResetReason, diskVolumeUsageLevel=diskVolumeUsageLevel, auditTotalPassedCount=auditTotalPassedCount, cardFpgaSource=cardFpgaSource, cardCpuSpeed=cardCpuSpeed, TestTransactionId=TestTransactionId, portNumber=portNumber, fpgaErrorEventTable=fpgaErrorEventTable, cardLastBootSource=cardLastBootSource, portSecState=portSecState, equipmentStateGroup=equipmentStateGroup, remainInDiagMode=remainInDiagMode, cardEntry=cardEntry, cardName=cardName, equipmentError=equipmentError, diskVolumeTrapInh=diskVolumeTrapInh, systemClock=systemClock, portTxFlowControlDetected=portTxFlowControlDetected, cardAction=cardAction, diskVolumeSize=diskVolumeSize, cardTestType=cardTestType, auditResult=auditResult, cardTestIndex=cardTestIndex, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cardShelfTestIndex=cardShelfTestIndex, cardFlashSize=cardFlashSize, cardShelfId=cardShelfId, cardTestScheduleCommand=cardTestScheduleCommand, diskVolumeShelfId=diskVolumeShelfId, diskDriveNumber=diskDriveNumber, cardSubDetected=cardSubDetected, cardTestTime=cardTestTime, TestType=TestType, cardTestDescription=cardTestDescription, equipmentTraps=equipmentTraps, cardTestTransId=cardTestTransId, equipmentDiag=equipmentDiag, cmVendor=cmVendor, equipmentCardTestGroup=equipmentCardTestGroup, cardTempOverHeatNotification=cardTempOverHeatNotification, diskVolumeCardId=diskVolumeCardId, portMinDsPower=portMinDsPower, portType=portType, diskVolumeNumber=diskVolumeNumber, cardTestEntry=cardTestEntry, portCurrDsPower=portCurrDsPower, cardTestCommand=cardTestCommand, auditTotalFailedCount=auditTotalFailedCount, portRxFlowControlDetected=portRxFlowControlDetected, portDetectedMode=portDetectedMode, auditShelfId=auditShelfId, cardCarrierFwVersion=cardCarrierFwVersion, cardHwVersion=cardHwVersion, TestResult=TestResult, auditId=auditId, cmMacAddress=cmMacAddress, cmUChannelID=cmUChannelID, diskVolumeUsagePercentage=diskVolumeUsagePercentage, cardLastChangeTime=cardLastChangeTime, cmResetClearNotification=cmResetClearNotification, cardType=cardType, cardDplxStatus=cardDplxStatus, cardLastBootVersion=cardLastBootVersion, portBgpId=portBgpId, cardFwVersion=cardFwVersion, portCardId=portCardId, cardTestResultDesc=cardTestResultDesc, systemGeneral=systemGeneral, portDplxStatus=portDplxStatus, auditName=auditName, portDescription=portDescription, cardTestId=cardTestId, auditEntry=auditEntry, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, equipmentDiagGroup=equipmentDiagGroup, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, cardTestResult=cardTestResult, auditTable=auditTable, cardTemperatureHighError=cardTemperatureHighError, errEventId=errEventId, errEvRowStatus=errEvRowStatus, portMaxDsPower=portMaxDsPower, cardTemperatureHighWarn=cardTemperatureHighWarn, auditTime=auditTime, cmResetReason=cmResetReason, fpgaErrorEventEntry=fpgaErrorEventEntry, cardBusSpeed=cardBusSpeed, cardSubType=cardSubType, equipmentCardGroup=equipmentCardGroup, portAdminState=portAdminState, equipmentTbl=equipmentTbl, verboseLevel=verboseLevel, TestId=TestId, cardRamSize=cardRamSize, cardSecStateChange=cardSecStateChange, errEvLoggingEnabled=errEvLoggingEnabled, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, cardSpareGroupId=cardSpareGroupId, cardCarrierSerialNum=cardCarrierSerialNum, portMacAddress=portMacAddress, TestCommand=TestCommand, systemGeneralGroup=systemGeneralGroup, cadEquipmentMibCompliance=cadEquipmentMibCompliance, auditCycleCount=auditCycleCount, portPrStateChange=portPrStateChange, portDocsIfIndex=portDocsIfIndex, errEvRecoveryEnabled=errEvRecoveryEnabled, TestSchedule=TestSchedule, equipmentPortGroup=equipmentPortGroup, cmDevice=cmDevice, PYSNMP_MODULE_ID=cadEquipmentMib, cadEquipmentMibConformance=cadEquipmentMibConformance, diskVolumeId=diskVolumeId, equipmentAudit=equipmentAudit, cardPrState=cardPrState, trapCounter=trapCounter, cardPicDetected=cardPicDetected, auditLogThrottle=auditLogThrottle, cmPrimarySID=cmPrimarySID, portSecStateChange=portSecStateChange, cardCPLDVersion=cardCPLDVersion, TestScheduleCommand=TestScheduleCommand, auditFailedCount=auditFailedCount, cmResetNotification=cmResetNotification, portTrapInh=portTrapInh, cardPicHwVersion=cardPicHwVersion, cardTrapInh=cardTrapInh, shelfObjects=shelfObjects, cardPrStateChange=cardPrStateChange, cardTestResultNotification=cardTestResultNotification, cardSerialNum=cardSerialNum, systemKey=systemKey, cardDetected=cardDetected, cardCarrierHwVersion=cardCarrierHwVersion, diskVolumeEntry=diskVolumeEntry, auditAutoScheduling=auditAutoScheduling, eqDiagConfig=eqDiagConfig, shelfNumber=shelfNumber, portAction=portAction, shelfName=shelfName, auditCardId=auditCardId, portNumChans=portNumChans, cmResetUpTime=cmResetUpTime, cardSecState=cardSecState, equipmentShelfGroup=equipmentShelfGroup, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, diskVolumeFileName=diskVolumeFileName, errEvLogLevel=errEvLogLevel, cardDplxStatusChange=cardDplxStatusChange, cardSpareGroupMode=cardSpareGroupMode, cardBootVersion=cardBootVersion, cardCpuType=cardCpuType, auditLogOutput=auditLogOutput, cardPicSerialNum=cardPicSerialNum, cardUpTime=cardUpTime, cardNumber=cardNumber, portPrState=portPrState, portMode=portMode, diskVolumeUsageNotification=diskVolumeUsageNotification, portCardSubType=portCardSubType, cmIpAddress=cmIpAddress, portTxFlowControlMode=portTxFlowControlMode, cardSwVersion=cardSwVersion, cmResetInfo=cmResetInfo, cardDetectedChange=cardDetectedChange, equipmentState=equipmentState, diskVolumeDriveId=diskVolumeDriveId, cmResetStatus=cmResetStatus, diskVolumeGroup=diskVolumeGroup, cadEquipmentMibGroup=cadEquipmentMibGroup, cardTestName=cardTestName, cmRegistrationNotification=cmRegistrationNotification, cardTemperature=cardTemperature)
