...
EqActionType, UnknownState, SecondaryState, CardType, PrimaryState, DuplexStatus, PortId, PortMode, ShelfId, AdminState, PortDetectedMode, CardSubType, DiskVolumeUsageLevel, FlowControlMode, PicType, CardId, PortType, FirmwareSource = mibBuilder.importSymbols("CADANT-TC", "EqActionType", "UnknownState", "SecondaryState", "CardType", "PrimaryState", "DuplexStatus", "PortId", "PortMode", "ShelfId", "AdminState", "PortDetectedMode", "CardSubType", "DiskVolumeUsageLevel", "FlowControlMode", "PicType", "CardId", "PortType", "FirmwareSource")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ModuleCompliance, NotificationGroup, ObjectGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "NotificationGroup", "ObjectGroup")
ModuleIdentity, Integer32, Unsigned32, TimeTicks, ObjectIdentity, IpAddress, Bits, Counter64, MibIdentifier, iso, Counter32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "Unsigned32", "TimeTicks", "ObjectIdentity", "IpAddress", "Bits", "Counter64", "MibIdentifier", "iso", "Counter32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32")
TimeStamp, TruthValue, DateAndTime, RowStatus, DisplayString, TextualConvention, MacAddress = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TruthValue", "DateAndTime", "RowStatus", "DisplayString", "TextualConvention", "MacAddress")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cardSecState=cardSecState, diskVolumeTrapInh=diskVolumeTrapInh, auditLogThrottle=auditLogThrottle, diskVolumeFileName=diskVolumeFileName, cadEquipmentMibCompliances=cadEquipmentMibCompliances, equipmentDiag=equipmentDiag, portNumChans=portNumChans, equipmentStateGroup=equipmentStateGroup, auditId=auditId, cardTable=cardTable, systemClock=systemClock, trapCounter=trapCounter, cmResetStatus=cmResetStatus, cardTestResult=cardTestResult, eqDiagConfig=eqDiagConfig, cardTemperature=cardTemperature, errEvRowStatus=errEvRowStatus, cardLastBootVersion=cardLastBootVersion, trapSeverity=trapSeverity, TestTransactionId=TestTransactionId, fpgaErrorEventEntry=fpgaErrorEventEntry, auditShelfId=auditShelfId, diskVolumeCardId=diskVolumeCardId, equipmentPortGroup=equipmentPortGroup, errEvLogLevel=errEvLogLevel, cmResetClearNotification=cmResetClearNotification, TestResult=TestResult, cardNumPorts=cardNumPorts, portMacIfIndex=portMacIfIndex, cardHwVersion=cardHwVersion, cardEntry=cardEntry, portTrapInh=portTrapInh, equipmentTbl=equipmentTbl, cardPrState=cardPrState, portPrState=portPrState, portMode=portMode, auditCardId=auditCardId, cadEquipmentMibCompliance=cadEquipmentMibCompliance, diskVolumeDiskSize=diskVolumeDiskSize, TestId=TestId, cardUpTime=cardUpTime, portDplxStatusChange=portDplxStatusChange, cardTempNoReportNotification=cardTempNoReportNotification, cardAdminState=cardAdminState, systemGeneral=systemGeneral, portCurrDsPower=portCurrDsPower, cardLastChangeTime=cardLastChangeTime, cardTestSchedule=cardTestSchedule, cardTestTime=cardTestTime, auditTotalFailedCount=auditTotalFailedCount, auditLogOutput=auditLogOutput, cardCpuSpeed=cardCpuSpeed, diskVolumeShelfId=diskVolumeShelfId, verboseLevel=verboseLevel, cardRamSize=cardRamSize, diskVolumeUsageNotification=diskVolumeUsageNotification, cardTestId=cardTestId, cmIpAddress=cmIpAddress, diskVolumeTable=diskVolumeTable, cardShelfId=cardShelfId, portRxFlowControlDetected=portRxFlowControlDetected, cmResetReason=cmResetReason, portDescription=portDescription, cardNumber=cardNumber, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, equipmentCardGroup=equipmentCardGroup, cardTestType=cardTestType, fpgaErrorEventGroup=fpgaErrorEventGroup, cardCPLDVersion=cardCPLDVersion, cardAction=cardAction, cardTestResultDesc=cardTestResultDesc, cardPicSerialNum=cardPicSerialNum, cadEquipmentMibGroup=cadEquipmentMibGroup, cardDplxStatusChange=cardDplxStatusChange, portDocsIfIndex=portDocsIfIndex, cardFwVersion=cardFwVersion, auditDescription=auditDescription, cardShelfTestIndex=cardShelfTestIndex, portNumber=portNumber, cmResetNotification=cmResetNotification, diskVolumeSize=diskVolumeSize, cardTestName=cardTestName, cardCarrierSerialNum=cardCarrierSerialNum, cmUChannelID=cmUChannelID, portBgpId=portBgpId, cmDevice=cmDevice, portShelfId=portShelfId, diskVolumeNumber=diskVolumeNumber, portEntry=portEntry, cardCarrierHwVersion=cardCarrierHwVersion, cardTestTransId=cardTestTransId, auditCycleCount=auditCycleCount, diskVolumeName=diskVolumeName, portMinDsPower=portMinDsPower, TestSchedule=TestSchedule, cardBusSpeed=cardBusSpeed, equipmentDiagGroup=equipmentDiagGroup, auditTime=auditTime, shelfName=shelfName, cardSpareGroupId=cardSpareGroupId, cardTemperatureHighError=cardTemperatureHighError, portId=portId, cardPrStateChange=cardPrStateChange, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, shelfSwVersion=shelfSwVersion, cardType=cardType, TestScheduleCommand=TestScheduleCommand, auditTable=auditTable, diskVolumeEntry=diskVolumeEntry, cardSubDetected=cardSubDetected, downstreamPowerLoss=downstreamPowerLoss, portRxFlowControlMode=portRxFlowControlMode, cardTestResultNotification=cardTestResultNotification, portAction=portAction, cardSecStateChange=cardSecStateChange, portSecState=portSecState, portDplxStatus=portDplxStatus, cardFwUpdateStatus=cardFwUpdateStatus, portCardId=portCardId, portSecStateChange=portSecStateChange, auditFailedCount=auditFailedCount, cardLastBootSource=cardLastBootSource, auditEntry=auditEntry, shelfObjects=shelfObjects, errEvLoggingEnabled=errEvLoggingEnabled, auditAutoScheduling=auditAutoScheduling, cadEquipmentMib=cadEquipmentMib, equipmentState=equipmentState, cardTempOverHeatNotification=cardTempOverHeatNotification, cardSpareGroupMode=cardSpareGroupMode, cardTestDescription=cardTestDescription, cmResetUpTime=cmResetUpTime, diskDriveNumber=diskDriveNumber, diskVolumeId=diskVolumeId, cardTestCommand=cardTestCommand, cardDetectedChange=cardDetectedChange, diagTestId=diagTestId, auditCommand=auditCommand, portTxFlowControlMode=portTxFlowControlMode, cmRegistrationNotification=cmRegistrationNotification, portConnectorId=portConnectorId, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, portMacAddress=portMacAddress, cardSwVersion=cardSwVersion, cardTestEntry=cardTestEntry, cardPicHwVersion=cardPicHwVersion, cardTestScheduleCommand=cardTestScheduleCommand, cardTestTable=cardTestTable, cardCarrierFwVersion=cardCarrierFwVersion, equipmentAudit=equipmentAudit, cmPrimarySID=cmPrimarySID, errEvRecoveryEnabled=errEvRecoveryEnabled, cardDetected=cardDetected, cmVendor=cmVendor, cardCpuType=cardCpuType, cardPicDetected=cardPicDetected, remainInDiagMode=remainInDiagMode, cadEquipmentMibConformance=cadEquipmentMibConformance, fpgaErrorEventTable=fpgaErrorEventTable, cardTemperatureHighWarn=cardTemperatureHighWarn, cardId=cardId, portMaxDsPower=portMaxDsPower, auditStatus=auditStatus, cardSerialNum=cardSerialNum, cardLastResetReason=cardLastResetReason, portCardSubType=portCardSubType, diskVolumeUsageLevel=diskVolumeUsageLevel, cmMacAddress=cmMacAddress, cmResetInfo=cmResetInfo, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, equipmentShelfGroup=equipmentShelfGroup, PYSNMP_MODULE_ID=cadEquipmentMib, equipmentTraps=equipmentTraps, cardDplxStatus=cardDplxStatus, portAdminState=portAdminState, cardFlashSize=cardFlashSize, auditName=auditName, consoleOutput=consoleOutput, equipmentError=equipmentError, cardFpgaSource=cardFpgaSource, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, portTxFlowControlDetected=portTxFlowControlDetected, auditResult=auditResult, auditPassedCount=auditPassedCount, portType=portType, cardBootVersion=cardBootVersion, equipmentCardTestGroup=equipmentCardTestGroup, cardName=cardName, TestType=TestType, portDetectedMode=portDetectedMode, systemGeneralGroup=systemGeneralGroup, diskVolumeGroup=diskVolumeGroup, equipmentAuditGroup=equipmentAuditGroup, portLastChangeTime=portLastChangeTime, cardSubType=cardSubType, shelfNumber=shelfNumber, cardTestIndex=cardTestIndex, cardTrapInh=cardTrapInh, auditTotalPassedCount=auditTotalPassedCount, diskVolumeDriveId=diskVolumeDriveId, errEventId=errEventId, TestCommand=TestCommand, diskVolumeUsagePercentage=diskVolumeUsagePercentage, portTable=portTable, systemKey=systemKey, portPrStateChange=portPrStateChange)
