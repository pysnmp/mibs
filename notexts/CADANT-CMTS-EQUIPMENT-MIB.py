...
CardType, AdminState, PicType, PortId, CardSubType, SecondaryState, DuplexStatus, PortMode, PrimaryState, CardId, EqActionType, PortType, UnknownState, FirmwareSource, ShelfId, PortDetectedMode, DiskVolumeUsageLevel, FlowControlMode = mibBuilder.importSymbols("CADANT-TC", "CardType", "AdminState", "PicType", "PortId", "CardSubType", "SecondaryState", "DuplexStatus", "PortMode", "PrimaryState", "CardId", "EqActionType", "PortType", "UnknownState", "FirmwareSource", "ShelfId", "PortDetectedMode", "DiskVolumeUsageLevel", "FlowControlMode")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", portMaxDsPower=portMaxDsPower, diagTestId=diagTestId, cardId=cardId, equipmentAuditGroup=equipmentAuditGroup, portPrStateChange=portPrStateChange, cardSubType=cardSubType, portCurrDsPower=portCurrDsPower, portTxFlowControlDetected=portTxFlowControlDetected, cardDetectedChange=cardDetectedChange, cardNumPorts=cardNumPorts, shelfName=shelfName, cardFpgaSource=cardFpgaSource, diskVolumeGroup=diskVolumeGroup, auditStatus=auditStatus, portNumber=portNumber, cardSpareGroupId=cardSpareGroupId, cardCarrierHwVersion=cardCarrierHwVersion, TestResult=TestResult, systemGeneral=systemGeneral, trapCounter=trapCounter, auditAutoScheduling=auditAutoScheduling, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cardTempNoReportNotification=cardTempNoReportNotification, equipmentCardTestGroup=equipmentCardTestGroup, cardTable=cardTable, portConnectorId=portConnectorId, portTable=portTable, errEvLogLevel=errEvLogLevel, cardTempOverHeatNotification=cardTempOverHeatNotification, cardAdminState=cardAdminState, cardShelfTestIndex=cardShelfTestIndex, cardSwVersion=cardSwVersion, verboseLevel=verboseLevel, cardDplxStatusChange=cardDplxStatusChange, portLastChangeTime=portLastChangeTime, portRxFlowControlMode=portRxFlowControlMode, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, equipmentTbl=equipmentTbl, eqDiagConfig=eqDiagConfig, cmResetStatus=cmResetStatus, downstreamPowerLoss=downstreamPowerLoss, diskVolumeDriveId=diskVolumeDriveId, equipmentDiag=equipmentDiag, cardPrStateChange=cardPrStateChange, auditTotalPassedCount=auditTotalPassedCount, cardSecState=cardSecState, portTrapInh=portTrapInh, portAdminState=portAdminState, portShelfId=portShelfId, equipmentError=equipmentError, cardCpuSpeed=cardCpuSpeed, diskVolumeSize=diskVolumeSize, diskVolumeNumber=diskVolumeNumber, cardUpTime=cardUpTime, systemClock=systemClock, systemKey=systemKey, cardTestType=cardTestType, cmResetReason=cmResetReason, auditFailedCount=auditFailedCount, TestId=TestId, cardFwVersion=cardFwVersion, auditName=auditName, cardPrState=cardPrState, portTxFlowControlMode=portTxFlowControlMode, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cmMacAddress=cmMacAddress, auditCommand=auditCommand, auditLogOutput=auditLogOutput, portBgpId=portBgpId, cardAction=cardAction, cardTestTable=cardTestTable, cardSubDetected=cardSubDetected, TestSchedule=TestSchedule, cardBusSpeed=cardBusSpeed, cmResetUpTime=cmResetUpTime, portEntry=portEntry, portPrState=portPrState, diskVolumeUsageLevel=diskVolumeUsageLevel, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, fpgaErrorEventGroup=fpgaErrorEventGroup, portDescription=portDescription, cardLastBootSource=cardLastBootSource, auditDescription=auditDescription, cardCpuType=cardCpuType, cmUChannelID=cmUChannelID, portSecState=portSecState, cardRamSize=cardRamSize, equipmentStateGroup=equipmentStateGroup, equipmentTraps=equipmentTraps, portDetectedMode=portDetectedMode, cardPicHwVersion=cardPicHwVersion, cardTestIndex=cardTestIndex, fpgaErrorEventTable=fpgaErrorEventTable, portDplxStatus=portDplxStatus, TestType=TestType, shelfSwVersion=shelfSwVersion, TestCommand=TestCommand, cardLastResetReason=cardLastResetReason, cardBootVersion=cardBootVersion, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cadEquipmentMibConformance=cadEquipmentMibConformance, equipmentShelfGroup=equipmentShelfGroup, shelfNumber=shelfNumber, cardTestResult=cardTestResult, auditCardId=auditCardId, cardSpareGroupMode=cardSpareGroupMode, remainInDiagMode=remainInDiagMode, portNumChans=portNumChans, cardTestCommand=cardTestCommand, consoleOutput=consoleOutput, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, cardFwUpdateStatus=cardFwUpdateStatus, TestTransactionId=TestTransactionId, cmIpAddress=cmIpAddress, systemGeneralGroup=systemGeneralGroup, cardTestDescription=cardTestDescription, diskVolumeTrapInh=diskVolumeTrapInh, trapSeverity=trapSeverity, cardTemperatureHighWarn=cardTemperatureHighWarn, diskVolumeName=diskVolumeName, portAction=portAction, auditPassedCount=auditPassedCount, auditResult=auditResult, diskVolumeEntry=diskVolumeEntry, cardSecStateChange=cardSecStateChange, diskVolumeFileName=diskVolumeFileName, cardTestTime=cardTestTime, cardCarrierFwVersion=cardCarrierFwVersion, equipmentState=equipmentState, diskVolumeCardId=diskVolumeCardId, portMacIfIndex=portMacIfIndex, cardTestEntry=cardTestEntry, cardPicDetected=cardPicDetected, cardEntry=cardEntry, diskVolumeId=diskVolumeId, cardTestTransId=cardTestTransId, errEvRecoveryEnabled=errEvRecoveryEnabled, cardName=cardName, cmVendor=cmVendor, cardType=cardType, cardTestScheduleCommand=cardTestScheduleCommand, diskVolumeUsagePercentage=diskVolumeUsagePercentage, cmResetInfo=cmResetInfo, errEventId=errEventId, auditTable=auditTable, portCardSubType=portCardSubType, cmResetClearNotification=cmResetClearNotification, cardHwVersion=cardHwVersion, cardDetected=cardDetected, cardCarrierSerialNum=cardCarrierSerialNum, portId=portId, shelfObjects=shelfObjects, equipmentAudit=equipmentAudit, portMode=portMode, fpgaErrorEventEntry=fpgaErrorEventEntry, cardDplxStatus=cardDplxStatus, cardSerialNum=cardSerialNum, equipmentCardGroup=equipmentCardGroup, portType=portType, equipmentDiagGroup=equipmentDiagGroup, portMacAddress=portMacAddress, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, auditId=auditId, TestScheduleCommand=TestScheduleCommand, portCardId=portCardId, cardPicSerialNum=cardPicSerialNum, cardShelfId=cardShelfId, portDocsIfIndex=portDocsIfIndex, errEvLoggingEnabled=errEvLoggingEnabled, equipmentPortGroup=equipmentPortGroup, cardTestSchedule=cardTestSchedule, cmRegistrationNotification=cmRegistrationNotification, cardFlashSize=cardFlashSize, diskVolumeShelfId=diskVolumeShelfId, auditTime=auditTime, cmResetNotification=cmResetNotification, auditLogThrottle=auditLogThrottle, diskDriveNumber=diskDriveNumber, cadEquipmentMibCompliance=cadEquipmentMibCompliance, cardLastBootVersion=cardLastBootVersion, cardTestName=cardTestName, cardTestResultNotification=cardTestResultNotification, auditShelfId=auditShelfId, auditTotalFailedCount=auditTotalFailedCount, cardTemperature=cardTemperature, cardTemperatureHighError=cardTemperatureHighError, diskVolumeTable=diskVolumeTable, portDplxStatusChange=portDplxStatusChange, cardTestId=cardTestId, diskVolumeUsageNotification=diskVolumeUsageNotification, cmDevice=cmDevice, cmPrimarySID=cmPrimarySID, cardCPLDVersion=cardCPLDVersion, PYSNMP_MODULE_ID=cadEquipmentMib, diskVolumeDiskSize=diskVolumeDiskSize, portMinDsPower=portMinDsPower, cadEquipmentMib=cadEquipmentMib, portSecStateChange=portSecStateChange, auditEntry=auditEntry, cardNumber=cardNumber, auditCycleCount=auditCycleCount, cardLastChangeTime=cardLastChangeTime, cardTrapInh=cardTrapInh, portRxFlowControlDetected=portRxFlowControlDetected, cardTestResultDesc=cardTestResultDesc, errEvRowStatus=errEvRowStatus, cadEquipmentMibGroup=cadEquipmentMibGroup)
