...
CardSubType, PortMode, DiskVolumeUsageLevel, FlowControlMode, DuplexStatus, PicType, PortType, AdminState, PrimaryState, SecondaryState, ShelfId, FirmwareSource, CardId, UnknownState, CardType, PortId, EqActionType, PortDetectedMode = mibBuilder.importSymbols("CADANT-TC", "CardSubType", "PortMode", "DiskVolumeUsageLevel", "FlowControlMode", "DuplexStatus", "PicType", "PortType", "AdminState", "PrimaryState", "SecondaryState", "ShelfId", "FirmwareSource", "CardId", "UnknownState", "CardType", "PortId", "EqActionType", "PortDetectedMode")
...
TruthValue, DateAndTime, RowStatus, DisplayString, TextualConvention, MacAddress, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "DateAndTime", "RowStatus", "DisplayString", "TextualConvention", "MacAddress", "TimeStamp")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", portConnectorId=portConnectorId, portSecState=portSecState, cardTestId=cardTestId, cardSecStateChange=cardSecStateChange, cardLastBootVersion=cardLastBootVersion, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, auditDescription=auditDescription, auditLogOutput=auditLogOutput, cardFlashSize=cardFlashSize, cardTable=cardTable, cardPicDetected=cardPicDetected, portSecStateChange=portSecStateChange, portNumChans=portNumChans, cardTestResult=cardTestResult, portDescription=portDescription, cadEquipmentMibConformance=cadEquipmentMibConformance, errEventId=errEventId, cardLastBootSource=cardLastBootSource, cadEquipmentMibCompliances=cadEquipmentMibCompliances, auditFailedCount=auditFailedCount, cardTempNoReportNotification=cardTempNoReportNotification, cardPicSerialNum=cardPicSerialNum, auditTime=auditTime, cardPrState=cardPrState, cadEquipmentMibCompliance=cadEquipmentMibCompliance, cardHwVersion=cardHwVersion, diskVolumeEntry=diskVolumeEntry, consoleOutput=consoleOutput, cardPicHwVersion=cardPicHwVersion, portPrStateChange=portPrStateChange, portId=portId, cardNumPorts=cardNumPorts, cmDevice=cmDevice, cardSubType=cardSubType, portMode=portMode, equipmentCardGroup=equipmentCardGroup, auditEntry=auditEntry, portTxFlowControlDetected=portTxFlowControlDetected, equipmentAudit=equipmentAudit, cardUpTime=cardUpTime, equipmentError=equipmentError, cardTestSchedule=cardTestSchedule, cardTestTable=cardTestTable, portDplxStatusChange=portDplxStatusChange, cardTestType=cardTestType, cardFwVersion=cardFwVersion, cmVendor=cmVendor, cmRegistrationNotification=cmRegistrationNotification, cardEntry=cardEntry, equipmentCardTestGroup=equipmentCardTestGroup, portDetectedMode=portDetectedMode, cardShelfTestIndex=cardShelfTestIndex, systemClock=systemClock, cardTemperatureHighWarn=cardTemperatureHighWarn, cardDplxStatus=cardDplxStatus, cardTestResultNotification=cardTestResultNotification, trapCounter=trapCounter, portDplxStatus=portDplxStatus, portPrState=portPrState, diskVolumeTrapInh=diskVolumeTrapInh, auditTotalPassedCount=auditTotalPassedCount, cardDplxStatusChange=cardDplxStatusChange, cardTemperature=cardTemperature, diagTestId=diagTestId, TestScheduleCommand=TestScheduleCommand, errEvRecoveryEnabled=errEvRecoveryEnabled, equipmentTraps=equipmentTraps, equipmentDiagGroup=equipmentDiagGroup, auditResult=auditResult, cardSubDetected=cardSubDetected, cardCPLDVersion=cardCPLDVersion, portShelfId=portShelfId, equipmentDiag=equipmentDiag, cardBusSpeed=cardBusSpeed, cardCarrierSerialNum=cardCarrierSerialNum, TestSchedule=TestSchedule, equipmentTbl=equipmentTbl, equipmentAuditGroup=equipmentAuditGroup, cardFwUpdateStatus=cardFwUpdateStatus, shelfNumber=shelfNumber, cardTestTime=cardTestTime, portTrapInh=portTrapInh, cardShelfId=cardShelfId, errEvLogLevel=errEvLogLevel, cardTempOverHeatNotification=cardTempOverHeatNotification, cardLastChangeTime=cardLastChangeTime, cardCpuType=cardCpuType, diskVolumeId=diskVolumeId, TestCommand=TestCommand, PYSNMP_MODULE_ID=cadEquipmentMib, trapSeverity=trapSeverity, cardTrapInh=cardTrapInh, TestType=TestType, cardSpareGroupId=cardSpareGroupId, portMacAddress=portMacAddress, auditName=auditName, portTxFlowControlMode=portTxFlowControlMode, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, portNumber=portNumber, cardTestEntry=cardTestEntry, systemGeneralGroup=systemGeneralGroup, cardDetectedChange=cardDetectedChange, cardSecState=cardSecState, portBgpId=portBgpId, auditTotalFailedCount=auditTotalFailedCount, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, equipmentStateGroup=equipmentStateGroup, TestId=TestId, auditLogThrottle=auditLogThrottle, cmResetClearNotification=cmResetClearNotification, portType=portType, diskVolumeName=diskVolumeName, auditCycleCount=auditCycleCount, diskVolumeDriveId=diskVolumeDriveId, diskDriveNumber=diskDriveNumber, cmResetNotification=cmResetNotification, diskVolumeGroup=diskVolumeGroup, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cardCarrierFwVersion=cardCarrierFwVersion, portRxFlowControlMode=portRxFlowControlMode, diskVolumeUsageNotification=diskVolumeUsageNotification, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, cadEquipmentMib=cadEquipmentMib, diskVolumeUsageLevel=diskVolumeUsageLevel, cmResetUpTime=cmResetUpTime, diskVolumeSize=diskVolumeSize, cardTestDescription=cardTestDescription, diskVolumeTable=diskVolumeTable, auditShelfId=auditShelfId, cardRamSize=cardRamSize, diskVolumeNumber=diskVolumeNumber, cardBootVersion=cardBootVersion, cardName=cardName, cardId=cardId, auditTable=auditTable, shelfSwVersion=shelfSwVersion, auditCardId=auditCardId, systemKey=systemKey, portDocsIfIndex=portDocsIfIndex, cmMacAddress=cmMacAddress, fpgaErrorEventTable=fpgaErrorEventTable, portEntry=portEntry, systemGeneral=systemGeneral, auditAutoScheduling=auditAutoScheduling, cmResetInfo=cmResetInfo, shelfObjects=shelfObjects, cmIpAddress=cmIpAddress, verboseLevel=verboseLevel, cmPrimarySID=cmPrimarySID, portAdminState=portAdminState, diskVolumeFileName=diskVolumeFileName, diskVolumeShelfId=diskVolumeShelfId, portCardSubType=portCardSubType, portCardId=portCardId, cardLastResetReason=cardLastResetReason, portRxFlowControlDetected=portRxFlowControlDetected, cardPrStateChange=cardPrStateChange, cardTestIndex=cardTestIndex, equipmentPortGroup=equipmentPortGroup, shelfName=shelfName, auditId=auditId, auditPassedCount=auditPassedCount, portLastChangeTime=portLastChangeTime, portTable=portTable, diskVolumeCardId=diskVolumeCardId, cardSwVersion=cardSwVersion, fpgaErrorEventGroup=fpgaErrorEventGroup, portCurrDsPower=portCurrDsPower, equipmentShelfGroup=equipmentShelfGroup, cardTestResultDesc=cardTestResultDesc, portAction=portAction, downstreamPowerLoss=downstreamPowerLoss, cmResetStatus=cmResetStatus, TestTransactionId=TestTransactionId, cardType=cardType, fpgaErrorEventEntry=fpgaErrorEventEntry, cmResetReason=cmResetReason, cardTestTransId=cardTestTransId, cadEquipmentMibGroup=cadEquipmentMibGroup, cardTemperatureHighError=cardTemperatureHighError, cardNumber=cardNumber, TestResult=TestResult, cardSpareGroupMode=cardSpareGroupMode, portMacIfIndex=portMacIfIndex, portMinDsPower=portMinDsPower, cardTestCommand=cardTestCommand, cardTestScheduleCommand=cardTestScheduleCommand, remainInDiagMode=remainInDiagMode, cardAdminState=cardAdminState, cardAction=cardAction, diskVolumeDiskSize=diskVolumeDiskSize, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, cardCarrierHwVersion=cardCarrierHwVersion, diskVolumeUsagePercentage=diskVolumeUsagePercentage, cardSerialNum=cardSerialNum, cardCpuSpeed=cardCpuSpeed, cardDetected=cardDetected, cardFpgaSource=cardFpgaSource, errEvRowStatus=errEvRowStatus, auditCommand=auditCommand, cmUChannelID=cmUChannelID, portMaxDsPower=portMaxDsPower, eqDiagConfig=eqDiagConfig, errEvLoggingEnabled=errEvLoggingEnabled, cardTestName=cardTestName, equipmentState=equipmentState, auditStatus=auditStatus)
