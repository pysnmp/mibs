...
CardType, UnknownState, PicType, PortId, SecondaryState, PortMode, FlowControlMode, PortDetectedMode, ShelfId, PrimaryState, CardSubType, FirmwareSource, EqActionType, PortType, AdminState, DuplexStatus, DiskVolumeUsageLevel, CardId = mibBuilder.importSymbols("CADANT-TC", "CardType", "UnknownState", "PicType", "PortId", "SecondaryState", "PortMode", "FlowControlMode", "PortDetectedMode", "ShelfId", "PrimaryState", "CardSubType", "FirmwareSource", "EqActionType", "PortType", "AdminState", "DuplexStatus", "DiskVolumeUsageLevel", "CardId")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ObjectGroup, NotificationGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "NotificationGroup", "ModuleCompliance")
MibIdentifier, TimeTicks, ObjectIdentity, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32, Counter32, Counter64, Integer32, ModuleIdentity, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "TimeTicks", "ObjectIdentity", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32", "Counter32", "Counter64", "Integer32", "ModuleIdentity", "iso", "NotificationType")
RowStatus, TextualConvention, DisplayString, DateAndTime, TruthValue, TimeStamp, MacAddress = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TextualConvention", "DisplayString", "DateAndTime", "TruthValue", "TimeStamp", "MacAddress")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", cmIpAddress=cmIpAddress, errEvRecoveryEnabled=errEvRecoveryEnabled, equipmentError=equipmentError, fpgaErrorEventGroup=fpgaErrorEventGroup, cadEquipmentMibCompliances=cadEquipmentMibCompliances, TestCommand=TestCommand, equipmentShelfGroup=equipmentShelfGroup, auditEntry=auditEntry, equipmentCardTestGroup=equipmentCardTestGroup, systemGeneral=systemGeneral, cardName=cardName, portBgpId=portBgpId, diskVolumeTable=diskVolumeTable, cardTestTransId=cardTestTransId, portSecState=portSecState, cardLastResetReason=cardLastResetReason, cardPicDetected=cardPicDetected, cardCarrierFwVersion=cardCarrierFwVersion, portCurrDsPower=portCurrDsPower, diskVolumeUsagePercentage=diskVolumeUsagePercentage, consoleOutput=consoleOutput, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, diskVolumeId=diskVolumeId, remainInDiagMode=remainInDiagMode, equipmentCardGroup=equipmentCardGroup, portMaxDsPower=portMaxDsPower, diskVolumeDriveId=diskVolumeDriveId, portShelfId=portShelfId, cardTestResult=cardTestResult, portLastChangeTime=portLastChangeTime, diskVolumeName=diskVolumeName, trapCounter=trapCounter, diskVolumeDiskSize=diskVolumeDiskSize, errEvLoggingEnabled=errEvLoggingEnabled, systemKey=systemKey, cardTemperature=cardTemperature, cadEquipmentMibGroup=cadEquipmentMibGroup, cardShelfTestIndex=cardShelfTestIndex, TestSchedule=TestSchedule, portMode=portMode, cardCpuType=cardCpuType, portConnectorId=portConnectorId, equipmentAudit=equipmentAudit, portDplxStatusChange=portDplxStatusChange, portType=portType, equipmentAuditGroup=equipmentAuditGroup, portEntry=portEntry, PYSNMP_MODULE_ID=cadEquipmentMib, cardPrState=cardPrState, cardBusSpeed=cardBusSpeed, portTxFlowControlMode=portTxFlowControlMode, cardTestEntry=cardTestEntry, TestType=TestType, verboseLevel=verboseLevel, eqDiagConfig=eqDiagConfig, cmDevice=cmDevice, cardSecState=cardSecState, portNumber=portNumber, errEvRowStatus=errEvRowStatus, portSecStateChange=portSecStateChange, diskVolumeFileName=diskVolumeFileName, cardLastBootSource=cardLastBootSource, cardTable=cardTable, portMacIfIndex=portMacIfIndex, cardSecStateChange=cardSecStateChange, portMinDsPower=portMinDsPower, portCardId=portCardId, auditTable=auditTable, diskVolumeGroup=diskVolumeGroup, portAdminState=portAdminState, auditLogThrottle=auditLogThrottle, systemClock=systemClock, diskVolumeTrapInh=diskVolumeTrapInh, auditAutoScheduling=auditAutoScheduling, auditStatus=auditStatus, cmVendor=cmVendor, portAction=portAction, auditCardId=auditCardId, shelfNumber=shelfNumber, equipmentTraps=equipmentTraps, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, downstreamPowerLoss=downstreamPowerLoss, cardTestCommand=cardTestCommand, cardSubDetected=cardSubDetected, cardCarrierHwVersion=cardCarrierHwVersion, cmMacAddress=cmMacAddress, cardRamSize=cardRamSize, cardSubType=cardSubType, shelfSwVersion=shelfSwVersion, cardTestTime=cardTestTime, TestScheduleCommand=TestScheduleCommand, equipmentPortGroup=equipmentPortGroup, cardTrapInh=cardTrapInh, cardNumber=cardNumber, cardCarrierSerialNum=cardCarrierSerialNum, cardPrStateChange=cardPrStateChange, shelfName=shelfName, cadEquipmentMibCompliance=cadEquipmentMibCompliance, auditTotalFailedCount=auditTotalFailedCount, cadEquipmentMib=cadEquipmentMib, cardTemperatureHighWarn=cardTemperatureHighWarn, TestTransactionId=TestTransactionId, trapSeverity=trapSeverity, equipmentDiag=equipmentDiag, diagTestId=diagTestId, auditResult=auditResult, cardAction=cardAction, diskVolumeNumber=diskVolumeNumber, cardFpgaSource=cardFpgaSource, cardPicSerialNum=cardPicSerialNum, cmUChannelID=cmUChannelID, portCardSubType=portCardSubType, auditName=auditName, cardEntry=cardEntry, cmResetReason=cmResetReason, cardCPLDVersion=cardCPLDVersion, cardPicHwVersion=cardPicHwVersion, auditLogOutput=auditLogOutput, diskVolumeUsageLevel=diskVolumeUsageLevel, cardTempOverHeatNotification=cardTempOverHeatNotification, portPrState=portPrState, portDplxStatus=portDplxStatus, cardNumPorts=cardNumPorts, portDescription=portDescription, diskDriveNumber=diskDriveNumber, equipmentTbl=equipmentTbl, systemGeneralGroup=systemGeneralGroup, portPrStateChange=portPrStateChange, cmResetNotification=cmResetNotification, cardSpareGroupId=cardSpareGroupId, cardFlashSize=cardFlashSize, cardLastBootVersion=cardLastBootVersion, cardTestName=cardTestName, cardShelfId=cardShelfId, cardDplxStatus=cardDplxStatus, cardTempNoReportNotification=cardTempNoReportNotification, cmResetUpTime=cmResetUpTime, cardTestResultNotification=cardTestResultNotification, cardHwVersion=cardHwVersion, portDocsIfIndex=portDocsIfIndex, cardDplxStatusChange=cardDplxStatusChange, cardTestId=cardTestId, cardId=cardId, cardFwVersion=cardFwVersion, cardUpTime=cardUpTime, cmResetInfo=cmResetInfo, auditCommand=auditCommand, auditCycleCount=auditCycleCount, equipmentState=equipmentState, cmResetStatus=cmResetStatus, cmRegistrationNotification=cmRegistrationNotification, fpgaErrorEventTable=fpgaErrorEventTable, equipmentStateGroup=equipmentStateGroup, cardDetectedChange=cardDetectedChange, cardDetected=cardDetected, cardLastChangeTime=cardLastChangeTime, auditTime=auditTime, cardSpareGroupMode=cardSpareGroupMode, auditId=auditId, TestResult=TestResult, cardTestIndex=cardTestIndex, portTable=portTable, fpgaErrorEventEntry=fpgaErrorEventEntry, diskVolumeCardId=diskVolumeCardId, cardTestScheduleCommand=cardTestScheduleCommand, cardTestDescription=cardTestDescription, diskVolumeShelfId=diskVolumeShelfId, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, auditShelfId=auditShelfId, shelfObjects=shelfObjects, errEvLogLevel=errEvLogLevel, portRxFlowControlMode=portRxFlowControlMode, portTrapInh=portTrapInh, cmResetClearNotification=cmResetClearNotification, cardType=cardType, portMacAddress=portMacAddress, cardTestSchedule=cardTestSchedule, cmPrimarySID=cmPrimarySID, cardTestTable=cardTestTable, auditTotalPassedCount=auditTotalPassedCount, cardTestResultDesc=cardTestResultDesc, cadEquipmentMibConformance=cadEquipmentMibConformance, diskVolumeUsageNotification=diskVolumeUsageNotification, diskVolumeEntry=diskVolumeEntry, cardTestType=cardTestType, auditFailedCount=auditFailedCount, TestId=TestId, cardSwVersion=cardSwVersion, cardBootVersion=cardBootVersion, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, cardCpuSpeed=cardCpuSpeed, diskVolumeSize=diskVolumeSize, cardSerialNum=cardSerialNum, portDetectedMode=portDetectedMode, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, auditPassedCount=auditPassedCount, cardAdminState=cardAdminState, errEventId=errEventId, portNumChans=portNumChans, portId=portId, auditDescription=auditDescription, equipmentDiagGroup=equipmentDiagGroup, cardTemperatureHighError=cardTemperatureHighError, cardFwUpdateStatus=cardFwUpdateStatus, portTxFlowControlDetected=portTxFlowControlDetected, portRxFlowControlDetected=portRxFlowControlDetected)
