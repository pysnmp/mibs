...
PortId, DiskVolumeUsageLevel, PortType, CardSubType, UnknownState, CardType, FlowControlMode, EqActionType, CardId, DuplexStatus, PrimaryState, SecondaryState, PortMode, FirmwareSource, PicType, PortDetectedMode, ShelfId, AdminState = mibBuilder.importSymbols("CADANT-TC", "PortId", "DiskVolumeUsageLevel", "PortType", "CardSubType", "UnknownState", "CardType", "FlowControlMode", "EqActionType", "CardId", "DuplexStatus", "PrimaryState", "SecondaryState", "PortMode", "FirmwareSource", "PicType", "PortDetectedMode", "ShelfId", "AdminState")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
NotificationGroup, ModuleCompliance, ObjectGroup = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ModuleCompliance", "ObjectGroup")
Gauge32, Counter32, ObjectIdentity, Integer32, Bits, ModuleIdentity, TimeTicks, IpAddress, Unsigned32, iso, NotificationType, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "ObjectIdentity", "Integer32", "Bits", "ModuleIdentity", "TimeTicks", "IpAddress", "Unsigned32", "iso", "NotificationType", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
RowStatus, MacAddress, TextualConvention, DisplayString, TruthValue, TimeStamp, DateAndTime = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "MacAddress", "TextualConvention", "DisplayString", "TruthValue", "TimeStamp", "DateAndTime")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", cardTestName=cardTestName, portCardSubType=portCardSubType, cmUChannelID=cmUChannelID, cardNumPorts=cardNumPorts, cardPrState=cardPrState, cardFpgaSource=cardFpgaSource, portAction=portAction, TestScheduleCommand=TestScheduleCommand, fpgaErrorEventEntry=fpgaErrorEventEntry, equipmentPortGroup=equipmentPortGroup, diskVolumeEntry=diskVolumeEntry, cardSecState=cardSecState, cmMacAddress=cmMacAddress, portSecStateChange=portSecStateChange, equipmentCardGroup=equipmentCardGroup, cardSerialNum=cardSerialNum, portEntry=portEntry, auditLogThrottle=auditLogThrottle, portId=portId, cardTestCommand=cardTestCommand, diskVolumeUsageLevel=diskVolumeUsageLevel, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, diskVolumeTrapInh=diskVolumeTrapInh, portDescription=portDescription, auditStatus=auditStatus, equipmentAudit=equipmentAudit, cardTestTable=cardTestTable, equipmentCardTestGroup=equipmentCardTestGroup, auditId=auditId, cardTestTransId=cardTestTransId, cardCarrierFwVersion=cardCarrierFwVersion, cardPicSerialNum=cardPicSerialNum, shelfObjects=shelfObjects, cardAction=cardAction, cardFwVersion=cardFwVersion, portDplxStatusChange=portDplxStatusChange, diskVolumeDiskSize=diskVolumeDiskSize, cardSecStateChange=cardSecStateChange, TestId=TestId, auditShelfId=auditShelfId, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, cardNumber=cardNumber, TestResult=TestResult, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, cardShelfId=cardShelfId, diskVolumeUsagePercentage=diskVolumeUsagePercentage, systemKey=systemKey, cardRamSize=cardRamSize, cardLastResetReason=cardLastResetReason, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, cardTestResultNotification=cardTestResultNotification, cardBusSpeed=cardBusSpeed, cadEquipmentMibConformance=cadEquipmentMibConformance, fpgaErrorEventTable=fpgaErrorEventTable, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cardSpareGroupId=cardSpareGroupId, TestSchedule=TestSchedule, cardCarrierSerialNum=cardCarrierSerialNum, portSecState=portSecState, portDetectedMode=portDetectedMode, cardSpareGroupMode=cardSpareGroupMode, portConnectorId=portConnectorId, fpgaErrorEventGroup=fpgaErrorEventGroup, systemGeneral=systemGeneral, cardCPLDVersion=cardCPLDVersion, portNumChans=portNumChans, equipmentError=equipmentError, portType=portType, portMode=portMode, cmResetNotification=cmResetNotification, cardLastBootVersion=cardLastBootVersion, auditTime=auditTime, cardSubType=cardSubType, errEventId=errEventId, cardHwVersion=cardHwVersion, eqDiagConfig=eqDiagConfig, cardTestScheduleCommand=cardTestScheduleCommand, cardTable=cardTable, auditTable=auditTable, portMacIfIndex=portMacIfIndex, cmResetReason=cmResetReason, cardTestTime=cardTestTime, cardCarrierHwVersion=cardCarrierHwVersion, cmDevice=cmDevice, cardUpTime=cardUpTime, portShelfId=portShelfId, equipmentTbl=equipmentTbl, trapCounter=trapCounter, diskVolumeId=diskVolumeId, cardTestType=cardTestType, cardTestEntry=cardTestEntry, cadEquipmentMibGroup=cadEquipmentMibGroup, auditName=auditName, cardTrapInh=cardTrapInh, diskDriveNumber=diskDriveNumber, TestCommand=TestCommand, auditFailedCount=auditFailedCount, cmResetInfo=cmResetInfo, diskVolumeName=diskVolumeName, remainInDiagMode=remainInDiagMode, cardPicDetected=cardPicDetected, cmIpAddress=cmIpAddress, cardTempOverHeatNotification=cardTempOverHeatNotification, portTxFlowControlDetected=portTxFlowControlDetected, cardName=cardName, auditTotalFailedCount=auditTotalFailedCount, diskVolumeTable=diskVolumeTable, portRxFlowControlMode=portRxFlowControlMode, cardType=cardType, cardAdminState=cardAdminState, cardDplxStatus=cardDplxStatus, portRxFlowControlDetected=portRxFlowControlDetected, portNumber=portNumber, portCurrDsPower=portCurrDsPower, TestTransactionId=TestTransactionId, portMinDsPower=portMinDsPower, cadEquipmentMib=cadEquipmentMib, portDplxStatus=portDplxStatus, cmRegistrationNotification=cmRegistrationNotification, equipmentState=equipmentState, cardTemperatureHighWarn=cardTemperatureHighWarn, portPrStateChange=portPrStateChange, diskVolumeDriveId=diskVolumeDriveId, systemGeneralGroup=systemGeneralGroup, equipmentTraps=equipmentTraps, equipmentShelfGroup=equipmentShelfGroup, diagTestId=diagTestId, shelfNumber=shelfNumber, cardId=cardId, cardTestResult=cardTestResult, cmVendor=cmVendor, cmPrimarySID=cmPrimarySID, cmResetClearNotification=cmResetClearNotification, portTrapInh=portTrapInh, cadEquipmentMibCompliances=cadEquipmentMibCompliances, errEvRecoveryEnabled=errEvRecoveryEnabled, cardFwUpdateStatus=cardFwUpdateStatus, shelfName=shelfName, cmResetUpTime=cmResetUpTime, diskVolumeFileName=diskVolumeFileName, cadEquipmentMibCompliance=cadEquipmentMibCompliance, consoleOutput=consoleOutput, portPrState=portPrState, cardLastChangeTime=cardLastChangeTime, cardTestDescription=cardTestDescription, auditCardId=auditCardId, auditEntry=auditEntry, diskVolumeGroup=diskVolumeGroup, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, portTable=portTable, equipmentDiag=equipmentDiag, portDocsIfIndex=portDocsIfIndex, portMacAddress=portMacAddress, auditDescription=auditDescription, cardSubDetected=cardSubDetected, cardDplxStatusChange=cardDplxStatusChange, equipmentStateGroup=equipmentStateGroup, cardTestIndex=cardTestIndex, cardTemperature=cardTemperature, cardPicHwVersion=cardPicHwVersion, auditAutoScheduling=auditAutoScheduling, auditLogOutput=auditLogOutput, cardDetectedChange=cardDetectedChange, trapSeverity=trapSeverity, portMaxDsPower=portMaxDsPower, errEvLogLevel=errEvLogLevel, verboseLevel=verboseLevel, cardTestId=cardTestId, portAdminState=portAdminState, cardTestResultDesc=cardTestResultDesc, cardCpuSpeed=cardCpuSpeed, cardFlashSize=cardFlashSize, cardLastBootSource=cardLastBootSource, cmResetStatus=cmResetStatus, portLastChangeTime=portLastChangeTime, cardPrStateChange=cardPrStateChange, auditCommand=auditCommand, auditCycleCount=auditCycleCount, portBgpId=portBgpId, auditResult=auditResult, portCardId=portCardId, systemClock=systemClock, cardBootVersion=cardBootVersion, diskVolumeCardId=diskVolumeCardId, equipmentAuditGroup=equipmentAuditGroup, auditTotalPassedCount=auditTotalPassedCount, cardDetected=cardDetected, cardCpuType=cardCpuType, equipmentDiagGroup=equipmentDiagGroup, cardEntry=cardEntry, cardTestSchedule=cardTestSchedule, diskVolumeNumber=diskVolumeNumber, portTxFlowControlMode=portTxFlowControlMode, cardTempNoReportNotification=cardTempNoReportNotification, TestType=TestType, shelfSwVersion=shelfSwVersion, PYSNMP_MODULE_ID=cadEquipmentMib, errEvRowStatus=errEvRowStatus, cardShelfTestIndex=cardShelfTestIndex, diskVolumeShelfId=diskVolumeShelfId, cardSwVersion=cardSwVersion, downstreamPowerLoss=downstreamPowerLoss, diskVolumeUsageNotification=diskVolumeUsageNotification, cardTemperatureHighError=cardTemperatureHighError, diskVolumeSize=diskVolumeSize, errEvLoggingEnabled=errEvLoggingEnabled, auditPassedCount=auditPassedCount)
