...
AdminState, PrimaryState, PicType, PortType, DiskVolumeUsageLevel, PortMode, CardId, FirmwareSource, FlowControlMode, DuplexStatus, EqActionType, ShelfId, UnknownState, PortDetectedMode, CardSubType, CardType, SecondaryState, PortId = mibBuilder.importSymbols("CADANT-TC", "AdminState", "PrimaryState", "PicType", "PortType", "DiskVolumeUsageLevel", "PortMode", "CardId", "FirmwareSource", "FlowControlMode", "DuplexStatus", "EqActionType", "ShelfId", "UnknownState", "PortDetectedMode", "CardSubType", "CardType", "SecondaryState", "PortId")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ModuleCompliance, ObjectGroup, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "ObjectGroup", "NotificationGroup")
Gauge32, ObjectIdentity, Bits, TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter32, Counter64, Integer32, iso, Unsigned32, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "Bits", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter32", "Counter64", "Integer32", "iso", "Unsigned32", "ModuleIdentity", "NotificationType")
MacAddress, TimeStamp, RowStatus, TextualConvention, DisplayString, TruthValue, DateAndTime = mibBuilder.importSymbols("SNMPv2-TC", "MacAddress", "TimeStamp", "RowStatus", "TextualConvention", "DisplayString", "TruthValue", "DateAndTime")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", cardTemperature=cardTemperature, TestResult=TestResult, cardSwVersion=cardSwVersion, cardTestCommand=cardTestCommand, cardBootVersion=cardBootVersion, cardDetectedChange=cardDetectedChange, cardAdminState=cardAdminState, cardSubType=cardSubType, cardTemperatureHighError=cardTemperatureHighError, portTrapInh=portTrapInh, equipmentDiagGroup=equipmentDiagGroup, portTxFlowControlMode=portTxFlowControlMode, errEvLogLevel=errEvLogLevel, diskVolumeDriveId=diskVolumeDriveId, cardTestResultNotification=cardTestResultNotification, cardPicHwVersion=cardPicHwVersion, diagTestId=diagTestId, equipmentAudit=equipmentAudit, auditEntry=auditEntry, cardTempOverHeatNotification=cardTempOverHeatNotification, portType=portType, auditLogOutput=auditLogOutput, shelfSwVersion=shelfSwVersion, cardSerialNum=cardSerialNum, cardDplxStatusChange=cardDplxStatusChange, portRxFlowControlMode=portRxFlowControlMode, portCardSubType=portCardSubType, diskVolumeFileName=diskVolumeFileName, cmMacAddress=cmMacAddress, equipmentError=equipmentError, TestScheduleCommand=TestScheduleCommand, portPrStateChange=portPrStateChange, cardTestId=cardTestId, cardNumPorts=cardNumPorts, portDetectedMode=portDetectedMode, cardTestTransId=cardTestTransId, portSecStateChange=portSecStateChange, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cardSecStateChange=cardSecStateChange, portAction=portAction, cardCpuSpeed=cardCpuSpeed, diskVolumeSize=diskVolumeSize, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, verboseLevel=verboseLevel, auditPassedCount=auditPassedCount, cardRamSize=cardRamSize, cmResetReason=cmResetReason, diskVolumeId=diskVolumeId, TestCommand=TestCommand, cardLastChangeTime=cardLastChangeTime, cardTestScheduleCommand=cardTestScheduleCommand, portConnectorId=portConnectorId, equipmentPortGroup=equipmentPortGroup, diskVolumeNumber=diskVolumeNumber, cardTestName=cardTestName, auditLogThrottle=auditLogThrottle, trapSeverity=trapSeverity, diskVolumeDiskSize=diskVolumeDiskSize, diskDriveNumber=diskDriveNumber, cardTestTable=cardTestTable, portBgpId=portBgpId, cardTestIndex=cardTestIndex, cardTable=cardTable, TestTransactionId=TestTransactionId, diskVolumeTable=diskVolumeTable, portId=portId, cardHwVersion=cardHwVersion, errEvRowStatus=errEvRowStatus, cardTrapInh=cardTrapInh, portDescription=portDescription, cmRegistrationNotification=cmRegistrationNotification, cmResetUpTime=cmResetUpTime, eqDiagConfig=eqDiagConfig, portShelfId=portShelfId, portPrState=portPrState, diskVolumeUsageNotification=diskVolumeUsageNotification, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, equipmentCardTestGroup=equipmentCardTestGroup, auditCycleCount=auditCycleCount, portDplxStatusChange=portDplxStatusChange, portDocsIfIndex=portDocsIfIndex, equipmentTraps=equipmentTraps, portLastChangeTime=portLastChangeTime, cardSubDetected=cardSubDetected, portMacIfIndex=portMacIfIndex, auditDescription=auditDescription, TestId=TestId, portNumber=portNumber, portDplxStatus=portDplxStatus, cardSpareGroupMode=cardSpareGroupMode, auditTotalFailedCount=auditTotalFailedCount, cardTestEntry=cardTestEntry, cardTemperatureHighWarn=cardTemperatureHighWarn, cardDetected=cardDetected, errEventId=errEventId, downstreamPowerLoss=downstreamPowerLoss, diskVolumeGroup=diskVolumeGroup, cardFwVersion=cardFwVersion, systemClock=systemClock, cadEquipmentMibCompliance=cadEquipmentMibCompliance, equipmentStateGroup=equipmentStateGroup, cardTestResult=cardTestResult, diskVolumeTrapInh=diskVolumeTrapInh, trapCounter=trapCounter, portAdminState=portAdminState, cmUChannelID=cmUChannelID, cardPrStateChange=cardPrStateChange, portCardId=portCardId, portMaxDsPower=portMaxDsPower, cardFlashSize=cardFlashSize, cardCPLDVersion=cardCPLDVersion, cardAction=cardAction, auditCommand=auditCommand, cardName=cardName, cardCarrierSerialNum=cardCarrierSerialNum, auditCardId=auditCardId, equipmentState=equipmentState, shelfNumber=shelfNumber, equipmentCardGroup=equipmentCardGroup, diskVolumeUsagePercentage=diskVolumeUsagePercentage, cardTestType=cardTestType, equipmentAuditGroup=equipmentAuditGroup, cadEquipmentMibConformance=cadEquipmentMibConformance, equipmentTbl=equipmentTbl, auditName=auditName, auditFailedCount=auditFailedCount, portCurrDsPower=portCurrDsPower, auditResult=auditResult, errEvRecoveryEnabled=errEvRecoveryEnabled, cardCpuType=cardCpuType, systemGeneral=systemGeneral, cardPicDetected=cardPicDetected, cmResetStatus=cmResetStatus, cardLastBootSource=cardLastBootSource, portTable=portTable, cmVendor=cmVendor, portNumChans=portNumChans, consoleOutput=consoleOutput, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, cardNumber=cardNumber, cardTempNoReportNotification=cardTempNoReportNotification, PYSNMP_MODULE_ID=cadEquipmentMib, cardCarrierFwVersion=cardCarrierFwVersion, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, shelfName=shelfName, cardUpTime=cardUpTime, fpgaErrorEventGroup=fpgaErrorEventGroup, cardTestTime=cardTestTime, diskVolumeUsageLevel=diskVolumeUsageLevel, portMode=portMode, cardPrState=cardPrState, portRxFlowControlDetected=portRxFlowControlDetected, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, equipmentShelfGroup=equipmentShelfGroup, fpgaErrorEventTable=fpgaErrorEventTable, diskVolumeName=diskVolumeName, auditStatus=auditStatus, auditTime=auditTime, cmResetClearNotification=cmResetClearNotification, cardBusSpeed=cardBusSpeed, TestSchedule=TestSchedule, auditTable=auditTable, errEvLoggingEnabled=errEvLoggingEnabled, cmResetNotification=cmResetNotification, auditShelfId=auditShelfId, equipmentDiag=equipmentDiag, cardTestResultDesc=cardTestResultDesc, remainInDiagMode=remainInDiagMode, systemGeneralGroup=systemGeneralGroup, cardShelfTestIndex=cardShelfTestIndex, fpgaErrorEventEntry=fpgaErrorEventEntry, systemKey=systemKey, cardShelfId=cardShelfId, cardSecState=cardSecState, cardLastBootVersion=cardLastBootVersion, diskVolumeCardId=diskVolumeCardId, cadEquipmentMibCompliances=cadEquipmentMibCompliances, portTxFlowControlDetected=portTxFlowControlDetected, cmPrimarySID=cmPrimarySID, diskVolumeEntry=diskVolumeEntry, cadEquipmentMibGroup=cadEquipmentMibGroup, shelfObjects=shelfObjects, cmResetInfo=cmResetInfo, cardDplxStatus=cardDplxStatus, portMinDsPower=portMinDsPower, cmDevice=cmDevice, cardId=cardId, cmIpAddress=cmIpAddress, cardEntry=cardEntry, cardFpgaSource=cardFpgaSource, cardPicSerialNum=cardPicSerialNum, cardTestSchedule=cardTestSchedule, cadEquipmentMib=cadEquipmentMib, cardLastResetReason=cardLastResetReason, cardCarrierHwVersion=cardCarrierHwVersion, portEntry=portEntry, TestType=TestType, auditAutoScheduling=auditAutoScheduling, cardSpareGroupId=cardSpareGroupId, cardFwUpdateStatus=cardFwUpdateStatus, auditId=auditId, portMacAddress=portMacAddress, cardTestDescription=cardTestDescription, auditTotalPassedCount=auditTotalPassedCount, portSecState=portSecState, cardType=cardType, diskVolumeShelfId=diskVolumeShelfId)
