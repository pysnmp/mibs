...
DuplexStatus, AdminState, CardType, PortId, CardId, ShelfId, DiskVolumeUsageLevel, EqActionType, PortMode, FlowControlMode, SecondaryState, PortDetectedMode, CardSubType, UnknownState, PicType, PortType, FirmwareSource, PrimaryState = mibBuilder.importSymbols("CADANT-TC", "DuplexStatus", "AdminState", "CardType", "PortId", "CardId", "ShelfId", "DiskVolumeUsageLevel", "EqActionType", "PortMode", "FlowControlMode", "SecondaryState", "PortDetectedMode", "CardSubType", "UnknownState", "PicType", "PortType", "FirmwareSource", "PrimaryState")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ObjectGroup, ModuleCompliance, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "ModuleCompliance", "NotificationGroup")
iso, Counter64, TimeTicks, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter32, Bits, ObjectIdentity, NotificationType, Integer32, IpAddress, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter64", "TimeTicks", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter32", "Bits", "ObjectIdentity", "NotificationType", "Integer32", "IpAddress", "Unsigned32")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", portType=portType, cardShelfTestIndex=cardShelfTestIndex, cardTestTransId=cardTestTransId, cardEntry=cardEntry, cardNumPorts=cardNumPorts, cardTestScheduleCommand=cardTestScheduleCommand, cardPrStateChange=cardPrStateChange, cardName=cardName, cardFpgaSource=cardFpgaSource, trapCounter=trapCounter, cmIpAddress=cmIpAddress, portCardId=portCardId, equipmentDiagGroup=equipmentDiagGroup, TestTransactionId=TestTransactionId, portNumber=portNumber, cmVendor=cmVendor, PYSNMP_MODULE_ID=cadEquipmentMib, cardCpuType=cardCpuType, equipmentPortGroup=equipmentPortGroup, portTxFlowControlMode=portTxFlowControlMode, cardTestResult=cardTestResult, shelfSwVersion=shelfSwVersion, auditResult=auditResult, portId=portId, portDocsIfIndex=portDocsIfIndex, cardId=cardId, portRxFlowControlDetected=portRxFlowControlDetected, consoleOutput=consoleOutput, portTrapInh=portTrapInh, portShelfId=portShelfId, auditAutoScheduling=auditAutoScheduling, errEventId=errEventId, remainInDiagMode=remainInDiagMode, errEvLogLevel=errEvLogLevel, cardTable=cardTable, cardSwVersion=cardSwVersion, portPrState=portPrState, cardTestId=cardTestId, diskVolumeCardId=diskVolumeCardId, diskVolumeUsageLevel=diskVolumeUsageLevel, cadEquipmentMibGroup=cadEquipmentMibGroup, portMinDsPower=portMinDsPower, cardLastResetReason=cardLastResetReason, diskVolumeGroup=diskVolumeGroup, portRxFlowControlMode=portRxFlowControlMode, equipmentCardGroup=equipmentCardGroup, portDplxStatusChange=portDplxStatusChange, TestId=TestId, auditPassedCount=auditPassedCount, diskVolumeFileName=diskVolumeFileName, cardDetectedChange=cardDetectedChange, verboseLevel=verboseLevel, cardHwVersion=cardHwVersion, portLastChangeTime=portLastChangeTime, cardLastBootSource=cardLastBootSource, diskVolumeDriveId=diskVolumeDriveId, auditLogThrottle=auditLogThrottle, cardTestDescription=cardTestDescription, cardPicDetected=cardPicDetected, cardCpuSpeed=cardCpuSpeed, auditEntry=auditEntry, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, cardTestName=cardTestName, cardTestEntry=cardTestEntry, fpgaErrorEventEntry=fpgaErrorEventEntry, cardSecState=cardSecState, equipmentCardTestGroup=equipmentCardTestGroup, portDetectedMode=portDetectedMode, cmUChannelID=cmUChannelID, TestResult=TestResult, portDplxStatus=portDplxStatus, equipmentAuditGroup=equipmentAuditGroup, cardFlashSize=cardFlashSize, cardAction=cardAction, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, auditDescription=auditDescription, diskVolumeSize=diskVolumeSize, cadEquipmentMibCompliance=cadEquipmentMibCompliance, cmResetStatus=cmResetStatus, portAction=portAction, cardBootVersion=cardBootVersion, cardFwUpdateStatus=cardFwUpdateStatus, systemKey=systemKey, cardUpTime=cardUpTime, portTxFlowControlDetected=portTxFlowControlDetected, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, cardPicHwVersion=cardPicHwVersion, portNumChans=portNumChans, auditId=auditId, cadEquipmentMibConformance=cadEquipmentMibConformance, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cardSpareGroupId=cardSpareGroupId, auditShelfId=auditShelfId, cmDevice=cmDevice, equipmentError=equipmentError, cmResetClearNotification=cmResetClearNotification, TestCommand=TestCommand, portAdminState=portAdminState, systemClock=systemClock, portCardSubType=portCardSubType, cardTestType=cardTestType, cardFwVersion=cardFwVersion, errEvLoggingEnabled=errEvLoggingEnabled, cardDplxStatus=cardDplxStatus, cardTemperatureHighWarn=cardTemperatureHighWarn, TestType=TestType, cardLastBootVersion=cardLastBootVersion, cardPrState=cardPrState, equipmentTraps=equipmentTraps, cardSpareGroupMode=cardSpareGroupMode, diskVolumeUsagePercentage=diskVolumeUsagePercentage, cardSecStateChange=cardSecStateChange, auditTotalFailedCount=auditTotalFailedCount, equipmentAudit=equipmentAudit, cardPicSerialNum=cardPicSerialNum, portMacAddress=portMacAddress, portSecState=portSecState, cardTestCommand=cardTestCommand, cardSubType=cardSubType, errEvRecoveryEnabled=errEvRecoveryEnabled, portConnectorId=portConnectorId, cardAdminState=cardAdminState, cardTestTime=cardTestTime, portPrStateChange=portPrStateChange, cardRamSize=cardRamSize, eqDiagConfig=eqDiagConfig, cardTestSchedule=cardTestSchedule, cmResetInfo=cmResetInfo, systemGeneralGroup=systemGeneralGroup, auditTable=auditTable, shelfObjects=shelfObjects, cmResetNotification=cmResetNotification, cadEquipmentMib=cadEquipmentMib, cmResetUpTime=cmResetUpTime, downstreamPowerLoss=downstreamPowerLoss, cardCPLDVersion=cardCPLDVersion, diskVolumeEntry=diskVolumeEntry, diskVolumeTrapInh=diskVolumeTrapInh, cardCarrierFwVersion=cardCarrierFwVersion, diskVolumeId=diskVolumeId, auditTotalPassedCount=auditTotalPassedCount, cardLastChangeTime=cardLastChangeTime, cardTemperature=cardTemperature, cardCarrierSerialNum=cardCarrierSerialNum, cardTempNoReportNotification=cardTempNoReportNotification, equipmentState=equipmentState, portEntry=portEntry, portMaxDsPower=portMaxDsPower, cmPrimarySID=cmPrimarySID, shelfNumber=shelfNumber, equipmentDiag=equipmentDiag, portDescription=portDescription, diskVolumeDiskSize=diskVolumeDiskSize, cardSubDetected=cardSubDetected, systemGeneral=systemGeneral, diskVolumeNumber=diskVolumeNumber, cardTempOverHeatNotification=cardTempOverHeatNotification, cardTrapInh=cardTrapInh, diskDriveNumber=diskDriveNumber, shelfName=shelfName, cardTemperatureHighError=cardTemperatureHighError, cardNumber=cardNumber, diskVolumeTable=diskVolumeTable, portTable=portTable, errEvRowStatus=errEvRowStatus, auditFailedCount=auditFailedCount, cmMacAddress=cmMacAddress, cardDetected=cardDetected, cardTestTable=cardTestTable, auditName=auditName, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cardTestIndex=cardTestIndex, equipmentTbl=equipmentTbl, auditStatus=auditStatus, TestScheduleCommand=TestScheduleCommand, auditTime=auditTime, cmResetReason=cmResetReason, auditCommand=auditCommand, diskVolumeName=diskVolumeName, auditCardId=auditCardId, portCurrDsPower=portCurrDsPower, auditCycleCount=auditCycleCount, diskVolumeUsageNotification=diskVolumeUsageNotification, portMode=portMode, cardSerialNum=cardSerialNum, cardType=cardType, fpgaErrorEventTable=fpgaErrorEventTable, portBgpId=portBgpId, portSecStateChange=portSecStateChange, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, cardBusSpeed=cardBusSpeed, portMacIfIndex=portMacIfIndex, auditLogOutput=auditLogOutput, cardTestResultDesc=cardTestResultDesc, diagTestId=diagTestId, equipmentShelfGroup=equipmentShelfGroup, diskVolumeShelfId=diskVolumeShelfId, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, equipmentStateGroup=equipmentStateGroup, cardCarrierHwVersion=cardCarrierHwVersion, fpgaErrorEventGroup=fpgaErrorEventGroup, TestSchedule=TestSchedule, trapSeverity=trapSeverity, cardTestResultNotification=cardTestResultNotification, cmRegistrationNotification=cmRegistrationNotification, cardDplxStatusChange=cardDplxStatusChange, cardShelfId=cardShelfId)
