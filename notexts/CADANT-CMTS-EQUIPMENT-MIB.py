...
PrimaryState, ShelfId, PortDetectedMode, DiskVolumeUsageLevel, EqActionType, CardId, CardType, DuplexStatus, PicType, PortMode, PortType, SecondaryState, CardSubType, AdminState, UnknownState, FirmwareSource, PortId, FlowControlMode = mibBuilder.importSymbols("CADANT-TC", "PrimaryState", "ShelfId", "PortDetectedMode", "DiskVolumeUsageLevel", "EqActionType", "CardId", "CardType", "DuplexStatus", "PicType", "PortMode", "PortType", "SecondaryState", "CardSubType", "AdminState", "UnknownState", "FirmwareSource", "PortId", "FlowControlMode")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ObjectGroup, NotificationGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "NotificationGroup", "ModuleCompliance")
IpAddress, ObjectIdentity, TimeTicks, ModuleIdentity, Unsigned32, Counter64, Gauge32, MibIdentifier, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Bits, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ObjectIdentity", "TimeTicks", "ModuleIdentity", "Unsigned32", "Counter64", "Gauge32", "MibIdentifier", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Bits", "Counter32")
TextualConvention, DisplayString, RowStatus, MacAddress, DateAndTime, TimeStamp, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DisplayString", "RowStatus", "MacAddress", "DateAndTime", "TimeStamp", "TruthValue")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", shelfObjects=shelfObjects, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, portRxFlowControlDetected=portRxFlowControlDetected, TestId=TestId, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, auditPassedCount=auditPassedCount, cardSubDetected=cardSubDetected, cmDevice=cmDevice, cardTempOverHeatNotification=cardTempOverHeatNotification, cardTable=cardTable, cardUpTime=cardUpTime, cardTestType=cardTestType, cardHwVersion=cardHwVersion, errEvRecoveryEnabled=errEvRecoveryEnabled, portMaxDsPower=portMaxDsPower, portMacIfIndex=portMacIfIndex, auditStatus=auditStatus, cardCarrierSerialNum=cardCarrierSerialNum, cardEntry=cardEntry, equipmentStateGroup=equipmentStateGroup, portTxFlowControlDetected=portTxFlowControlDetected, diskVolumeUsageLevel=diskVolumeUsageLevel, cadEquipmentMibGroup=cadEquipmentMibGroup, cardBusSpeed=cardBusSpeed, cardAdminState=cardAdminState, remainInDiagMode=remainInDiagMode, cardShelfId=cardShelfId, portCardId=portCardId, diskVolumeTrapInh=diskVolumeTrapInh, trapSeverity=trapSeverity, cardDetectedChange=cardDetectedChange, diskVolumeId=diskVolumeId, cardTestId=cardTestId, equipmentState=equipmentState, cardPicDetected=cardPicDetected, errEvLoggingEnabled=errEvLoggingEnabled, diskVolumeGroup=diskVolumeGroup, systemGeneral=systemGeneral, portNumber=portNumber, cardId=cardId, cardDetected=cardDetected, cardTestScheduleCommand=cardTestScheduleCommand, cardTestResultNotification=cardTestResultNotification, cardNumPorts=cardNumPorts, portMacAddress=portMacAddress, cardDplxStatusChange=cardDplxStatusChange, auditTotalFailedCount=auditTotalFailedCount, cmMacAddress=cmMacAddress, cardTestCommand=cardTestCommand, auditFailedCount=auditFailedCount, cardTestSchedule=cardTestSchedule, cardFwUpdateStatus=cardFwUpdateStatus, auditResult=auditResult, cardTempNoReportNotification=cardTempNoReportNotification, auditId=auditId, portTable=portTable, portId=portId, diskVolumeName=diskVolumeName, cadEquipmentMibCompliance=cadEquipmentMibCompliance, equipmentDiagGroup=equipmentDiagGroup, auditLogOutput=auditLogOutput, verboseLevel=verboseLevel, cardLastBootVersion=cardLastBootVersion, cardTemperatureHighError=cardTemperatureHighError, portTrapInh=portTrapInh, portRxFlowControlMode=portRxFlowControlMode, cmIpAddress=cmIpAddress, cardFpgaSource=cardFpgaSource, auditDescription=auditDescription, portLastChangeTime=portLastChangeTime, portMinDsPower=portMinDsPower, portDocsIfIndex=portDocsIfIndex, trapCounter=trapCounter, cardTemperature=cardTemperature, fpgaErrorEventTable=fpgaErrorEventTable, cardCarrierFwVersion=cardCarrierFwVersion, auditName=auditName, equipmentCardTestGroup=equipmentCardTestGroup, cardSpareGroupId=cardSpareGroupId, cmResetInfo=cmResetInfo, diskVolumeNumber=diskVolumeNumber, TestTransactionId=TestTransactionId, cardSerialNum=cardSerialNum, cardSpareGroupMode=cardSpareGroupMode, diskVolumeFileName=diskVolumeFileName, cmRegistrationNotification=cmRegistrationNotification, diagTestId=diagTestId, cardPicHwVersion=cardPicHwVersion, diskVolumeEntry=diskVolumeEntry, equipmentDiag=equipmentDiag, portEntry=portEntry, cardSecState=cardSecState, TestType=TestType, cardBootVersion=cardBootVersion, portSecStateChange=portSecStateChange, cardFlashSize=cardFlashSize, cardCarrierHwVersion=cardCarrierHwVersion, shelfName=shelfName, cardSwVersion=cardSwVersion, portDplxStatusChange=portDplxStatusChange, portNumChans=portNumChans, portConnectorId=portConnectorId, shelfNumber=shelfNumber, TestScheduleCommand=TestScheduleCommand, cardDplxStatus=cardDplxStatus, diskVolumeDiskSize=diskVolumeDiskSize, auditEntry=auditEntry, portTxFlowControlMode=portTxFlowControlMode, equipmentTbl=equipmentTbl, portType=portType, equipmentAudit=equipmentAudit, portPrState=portPrState, auditTime=auditTime, cardLastResetReason=cardLastResetReason, diskVolumeCardId=diskVolumeCardId, diskVolumeUsagePercentage=diskVolumeUsagePercentage, errEvRowStatus=errEvRowStatus, fpgaErrorEventEntry=fpgaErrorEventEntry, systemGeneralGroup=systemGeneralGroup, cardName=cardName, diskVolumeUsageNotification=diskVolumeUsageNotification, cardPicSerialNum=cardPicSerialNum, auditShelfId=auditShelfId, cardTestDescription=cardTestDescription, portPrStateChange=portPrStateChange, auditCycleCount=auditCycleCount, cmResetUpTime=cmResetUpTime, cadEquipmentMibConformance=cadEquipmentMibConformance, equipmentPortGroup=equipmentPortGroup, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, equipmentTraps=equipmentTraps, cardAction=cardAction, errEventId=errEventId, auditCommand=auditCommand, cardSecStateChange=cardSecStateChange, systemKey=systemKey, portAction=portAction, diskDriveNumber=diskDriveNumber, diskVolumeTable=diskVolumeTable, diskVolumeSize=diskVolumeSize, cardTestTime=cardTestTime, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, TestSchedule=TestSchedule, cardFwVersion=cardFwVersion, TestCommand=TestCommand, cardPrStateChange=cardPrStateChange, cardTrapInh=cardTrapInh, cmResetStatus=cmResetStatus, diskVolumeShelfId=diskVolumeShelfId, portCurrDsPower=portCurrDsPower, auditAutoScheduling=auditAutoScheduling, cmResetClearNotification=cmResetClearNotification, cardTestEntry=cardTestEntry, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, cardRamSize=cardRamSize, portAdminState=portAdminState, equipmentCardGroup=equipmentCardGroup, cardCpuSpeed=cardCpuSpeed, cardCPLDVersion=cardCPLDVersion, cmUChannelID=cmUChannelID, auditTable=auditTable, portCardSubType=portCardSubType, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cardTestName=cardTestName, cmPrimarySID=cmPrimarySID, equipmentShelfGroup=equipmentShelfGroup, cardTestTransId=cardTestTransId, auditCardId=auditCardId, cardPrState=cardPrState, diskVolumeDriveId=diskVolumeDriveId, equipmentAuditGroup=equipmentAuditGroup, cadEquipmentMib=cadEquipmentMib, cardCpuType=cardCpuType, eqDiagConfig=eqDiagConfig, shelfSwVersion=shelfSwVersion, portBgpId=portBgpId, auditTotalPassedCount=auditTotalPassedCount, downstreamPowerLoss=downstreamPowerLoss, cardSubType=cardSubType, systemClock=systemClock, cardType=cardType, cmResetNotification=cmResetNotification, portDetectedMode=portDetectedMode, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, consoleOutput=consoleOutput, cardTestResultDesc=cardTestResultDesc, auditLogThrottle=auditLogThrottle, cardNumber=cardNumber, PYSNMP_MODULE_ID=cadEquipmentMib, portDescription=portDescription, cardTestResult=cardTestResult, portSecState=portSecState, cmResetReason=cmResetReason, cmVendor=cmVendor, cardTestTable=cardTestTable, cardShelfTestIndex=cardShelfTestIndex, cardLastBootSource=cardLastBootSource, cardLastChangeTime=cardLastChangeTime, cardTemperatureHighWarn=cardTemperatureHighWarn, equipmentError=equipmentError, fpgaErrorEventGroup=fpgaErrorEventGroup, portShelfId=portShelfId, cardTestIndex=cardTestIndex, portDplxStatus=portDplxStatus, portMode=portMode, errEvLogLevel=errEvLogLevel, TestResult=TestResult)
