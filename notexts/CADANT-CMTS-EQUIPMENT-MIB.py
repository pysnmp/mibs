...
UnknownState, EqActionType, ShelfId, PortId, DuplexStatus, CardId, CardType, CardSubType, FirmwareSource, DiskVolumeUsageLevel, PicType, PortDetectedMode, SecondaryState, PortType, PrimaryState, AdminState, FlowControlMode, PortMode = mibBuilder.importSymbols("CADANT-TC", "UnknownState", "EqActionType", "ShelfId", "PortId", "DuplexStatus", "CardId", "CardType", "CardSubType", "FirmwareSource", "DiskVolumeUsageLevel", "PicType", "PortDetectedMode", "SecondaryState", "PortType", "PrimaryState", "AdminState", "FlowControlMode", "PortMode")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ModuleCompliance, ObjectGroup, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "ObjectGroup", "NotificationGroup")
iso, Counter64, IpAddress, Gauge32, TimeTicks, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier, Unsigned32, Bits, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter64", "IpAddress", "Gauge32", "TimeTicks", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier", "Unsigned32", "Bits", "NotificationType", "ModuleIdentity")
DateAndTime, MacAddress, TimeStamp, TruthValue, DisplayString, RowStatus, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "MacAddress", "TimeStamp", "TruthValue", "DisplayString", "RowStatus", "TextualConvention")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", errEvRecoveryEnabled=errEvRecoveryEnabled, cardNumber=cardNumber, auditLogOutput=auditLogOutput, cardName=cardName, cardSwVersion=cardSwVersion, auditStatus=auditStatus, cardDetected=cardDetected, cardTestTransId=cardTestTransId, cardFpgaSource=cardFpgaSource, portBgpId=portBgpId, cardAdminState=cardAdminState, auditCommand=auditCommand, diskVolumeNumber=diskVolumeNumber, auditTotalFailedCount=auditTotalFailedCount, auditTotalPassedCount=auditTotalPassedCount, cardTestId=cardTestId, cardCpuSpeed=cardCpuSpeed, cmResetClearNotification=cmResetClearNotification, downstreamPowerLoss=downstreamPowerLoss, portDocsIfIndex=portDocsIfIndex, TestId=TestId, cardTestScheduleCommand=cardTestScheduleCommand, cardTestResultDesc=cardTestResultDesc, equipmentPortGroup=equipmentPortGroup, diskVolumeCardId=diskVolumeCardId, cardCpuType=cardCpuType, portRxFlowControlMode=portRxFlowControlMode, cardPicHwVersion=cardPicHwVersion, cmMacAddress=cmMacAddress, cardShelfId=cardShelfId, cardTestTime=cardTestTime, cardTestIndex=cardTestIndex, portMinDsPower=portMinDsPower, portDplxStatusChange=portDplxStatusChange, portTxFlowControlMode=portTxFlowControlMode, verboseLevel=verboseLevel, cmRegistrationNotification=cmRegistrationNotification, cardBootVersion=cardBootVersion, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cardType=cardType, diskVolumeShelfId=diskVolumeShelfId, portCardSubType=portCardSubType, portEntry=portEntry, auditFailedCount=auditFailedCount, systemGeneralGroup=systemGeneralGroup, portConnectorId=portConnectorId, portMaxDsPower=portMaxDsPower, portLastChangeTime=portLastChangeTime, equipmentCardTestGroup=equipmentCardTestGroup, portSecStateChange=portSecStateChange, cardSerialNum=cardSerialNum, portType=portType, portCurrDsPower=portCurrDsPower, portTrapInh=portTrapInh, portPrStateChange=portPrStateChange, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, diskVolumeUsagePercentage=diskVolumeUsagePercentage, cardPicDetected=cardPicDetected, portTxFlowControlDetected=portTxFlowControlDetected, portDescription=portDescription, cardFlashSize=cardFlashSize, cmIpAddress=cmIpAddress, portMacIfIndex=portMacIfIndex, errEvLogLevel=errEvLogLevel, cadEquipmentMibGroup=cadEquipmentMibGroup, cardTable=cardTable, portAction=portAction, fpgaErrorEventEntry=fpgaErrorEventEntry, portId=portId, auditAutoScheduling=auditAutoScheduling, cardAction=cardAction, portMacAddress=portMacAddress, cardPrStateChange=cardPrStateChange, portShelfId=portShelfId, systemClock=systemClock, portDplxStatus=portDplxStatus, portTable=portTable, cardLastBootVersion=cardLastBootVersion, trapSeverity=trapSeverity, auditCycleCount=auditCycleCount, cardTrapInh=cardTrapInh, equipmentCardGroup=equipmentCardGroup, TestCommand=TestCommand, cardId=cardId, cardSecState=cardSecState, cardSpareGroupMode=cardSpareGroupMode, cardTestSchedule=cardTestSchedule, cardCPLDVersion=cardCPLDVersion, errEvRowStatus=errEvRowStatus, cmPrimarySID=cmPrimarySID, cardNumPorts=cardNumPorts, cardSubDetected=cardSubDetected, trapCounter=trapCounter, portPrState=portPrState, portNumChans=portNumChans, cardTestDescription=cardTestDescription, shelfNumber=shelfNumber, cardPicSerialNum=cardPicSerialNum, portMode=portMode, diskVolumeId=diskVolumeId, diagTestId=diagTestId, auditDescription=auditDescription, errEventId=errEventId, portNumber=portNumber, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, diskVolumeEntry=diskVolumeEntry, portAdminState=portAdminState, portRxFlowControlDetected=portRxFlowControlDetected, diskVolumeTable=diskVolumeTable, equipmentTbl=equipmentTbl, cardTempNoReportNotification=cardTempNoReportNotification, cardTestResultNotification=cardTestResultNotification, systemKey=systemKey, equipmentAuditGroup=equipmentAuditGroup, cmResetReason=cmResetReason, equipmentTraps=equipmentTraps, TestType=TestType, shelfObjects=shelfObjects, cardTestType=cardTestType, auditCardId=auditCardId, errEvLoggingEnabled=errEvLoggingEnabled, diskVolumeDriveId=diskVolumeDriveId, cardLastBootSource=cardLastBootSource, portSecState=portSecState, cardTestEntry=cardTestEntry, equipmentDiagGroup=equipmentDiagGroup, diskVolumeUsageLevel=diskVolumeUsageLevel, cardTestResult=cardTestResult, cardCarrierFwVersion=cardCarrierFwVersion, cardFwVersion=cardFwVersion, shelfSwVersion=shelfSwVersion, cardHwVersion=cardHwVersion, cardDetectedChange=cardDetectedChange, cardSecStateChange=cardSecStateChange, cardTemperature=cardTemperature, cmResetNotification=cmResetNotification, cardCarrierHwVersion=cardCarrierHwVersion, auditEntry=auditEntry, diskVolumeUsageNotification=diskVolumeUsageNotification, cardTestTable=cardTestTable, cadEquipmentMib=cadEquipmentMib, consoleOutput=consoleOutput, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, cardShelfTestIndex=cardShelfTestIndex, equipmentStateGroup=equipmentStateGroup, shelfName=shelfName, PYSNMP_MODULE_ID=cadEquipmentMib, cardBusSpeed=cardBusSpeed, auditShelfId=auditShelfId, cardDplxStatus=cardDplxStatus, diskVolumeTrapInh=diskVolumeTrapInh, cardTestName=cardTestName, cmResetUpTime=cmResetUpTime, portCardId=portCardId, equipmentError=equipmentError, systemGeneral=systemGeneral, fpgaErrorEventTable=fpgaErrorEventTable, equipmentAudit=equipmentAudit, diskVolumeFileName=diskVolumeFileName, TestResult=TestResult, auditId=auditId, diskVolumeSize=diskVolumeSize, cardPrState=cardPrState, cmVendor=cmVendor, cardUpTime=cardUpTime, auditTable=auditTable, auditLogThrottle=auditLogThrottle, cardEntry=cardEntry, cardLastChangeTime=cardLastChangeTime, equipmentDiag=equipmentDiag, diskVolumeName=diskVolumeName, cmUChannelID=cmUChannelID, diskDriveNumber=diskDriveNumber, cardLastResetReason=cardLastResetReason, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, auditTime=auditTime, eqDiagConfig=eqDiagConfig, cardTestCommand=cardTestCommand, cadEquipmentMibConformance=cadEquipmentMibConformance, fpgaErrorEventGroup=fpgaErrorEventGroup, cardDplxStatusChange=cardDplxStatusChange, auditName=auditName, cardTemperatureHighWarn=cardTemperatureHighWarn, equipmentState=equipmentState, cardTempOverHeatNotification=cardTempOverHeatNotification, cmResetInfo=cmResetInfo, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cardRamSize=cardRamSize, auditPassedCount=auditPassedCount, cmResetStatus=cmResetStatus, cmDevice=cmDevice, cardTemperatureHighError=cardTemperatureHighError, cardFwUpdateStatus=cardFwUpdateStatus, diskVolumeDiskSize=diskVolumeDiskSize, portDetectedMode=portDetectedMode, TestTransactionId=TestTransactionId, cardSubType=cardSubType, TestSchedule=TestSchedule, cardSpareGroupId=cardSpareGroupId, auditResult=auditResult, cardCarrierSerialNum=cardCarrierSerialNum, cadEquipmentMibCompliance=cadEquipmentMibCompliance, TestScheduleCommand=TestScheduleCommand, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, equipmentShelfGroup=equipmentShelfGroup, diskVolumeGroup=diskVolumeGroup, remainInDiagMode=remainInDiagMode)
