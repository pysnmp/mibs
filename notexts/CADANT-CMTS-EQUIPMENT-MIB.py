...
CardType, PortDetectedMode, ShelfId, SecondaryState, CardId, FirmwareSource, DuplexStatus, EqActionType, CardSubType, PicType, PortType, PortMode, UnknownState, AdminState, FlowControlMode, DiskVolumeUsageLevel, PrimaryState, PortId = mibBuilder.importSymbols("CADANT-TC", "CardType", "PortDetectedMode", "ShelfId", "SecondaryState", "CardId", "FirmwareSource", "DuplexStatus", "EqActionType", "CardSubType", "PicType", "PortType", "PortMode", "UnknownState", "AdminState", "FlowControlMode", "DiskVolumeUsageLevel", "PrimaryState", "PortId")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
NotificationGroup, ObjectGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ObjectGroup", "ModuleCompliance")
Gauge32, ObjectIdentity, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Bits, ModuleIdentity, TimeTicks, iso, Counter64, Counter32, Integer32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Bits", "ModuleIdentity", "TimeTicks", "iso", "Counter64", "Counter32", "Integer32", "IpAddress")
TimeStamp, RowStatus, DateAndTime, TruthValue, MacAddress, TextualConvention, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowStatus", "DateAndTime", "TruthValue", "MacAddress", "TextualConvention", "DisplayString")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", cardFpgaSource=cardFpgaSource, diskVolumeDiskSize=diskVolumeDiskSize, diskVolumeShelfId=diskVolumeShelfId, equipmentTraps=equipmentTraps, cardNumPorts=cardNumPorts, equipmentStateGroup=equipmentStateGroup, portBgpId=portBgpId, TestScheduleCommand=TestScheduleCommand, cardFlashSize=cardFlashSize, diskVolumeTable=diskVolumeTable, cardDetected=cardDetected, equipmentAuditGroup=equipmentAuditGroup, portId=portId, PYSNMP_MODULE_ID=cadEquipmentMib, shelfName=shelfName, cmDevice=cmDevice, cardFwVersion=cardFwVersion, portAdminState=portAdminState, TestType=TestType, portMinDsPower=portMinDsPower, cardRamSize=cardRamSize, cardType=cardType, TestCommand=TestCommand, auditTable=auditTable, portAction=portAction, portMacIfIndex=portMacIfIndex, diskDriveNumber=diskDriveNumber, cardTemperature=cardTemperature, cardTestTransId=cardTestTransId, auditTotalPassedCount=auditTotalPassedCount, cardPrState=cardPrState, cmRegistrationNotification=cmRegistrationNotification, cardSerialNum=cardSerialNum, systemGeneralGroup=systemGeneralGroup, cardTestResult=cardTestResult, cadEquipmentMib=cadEquipmentMib, cardCarrierSerialNum=cardCarrierSerialNum, equipmentCardTestGroup=equipmentCardTestGroup, cmResetInfo=cmResetInfo, cardDetectedChange=cardDetectedChange, cardName=cardName, cmUChannelID=cmUChannelID, cmResetClearNotification=cmResetClearNotification, cardTestScheduleCommand=cardTestScheduleCommand, cardNumber=cardNumber, cmIpAddress=cmIpAddress, portCardId=portCardId, equipmentPortGroup=equipmentPortGroup, equipmentAudit=equipmentAudit, diskVolumeUsageLevel=diskVolumeUsageLevel, auditShelfId=auditShelfId, cardHwVersion=cardHwVersion, cardTestDescription=cardTestDescription, auditPassedCount=auditPassedCount, portConnectorId=portConnectorId, verboseLevel=verboseLevel, diskVolumeTrapInh=diskVolumeTrapInh, equipmentError=equipmentError, cmPrimarySID=cmPrimarySID, cardTempOverHeatNotification=cardTempOverHeatNotification, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, systemKey=systemKey, cardTrapInh=cardTrapInh, portNumChans=portNumChans, cadEquipmentMibConformance=cadEquipmentMibConformance, portShelfId=portShelfId, equipmentDiag=equipmentDiag, cardTestResultNotification=cardTestResultNotification, portEntry=portEntry, cardTempNoReportNotification=cardTempNoReportNotification, equipmentState=equipmentState, diskVolumeDriveId=diskVolumeDriveId, portTrapInh=portTrapInh, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, portLastChangeTime=portLastChangeTime, errEvLogLevel=errEvLogLevel, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cardTestIndex=cardTestIndex, errEvRowStatus=errEvRowStatus, trapCounter=trapCounter, cardLastBootSource=cardLastBootSource, downstreamPowerLoss=downstreamPowerLoss, systemGeneral=systemGeneral, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, auditTotalFailedCount=auditTotalFailedCount, cardLastResetReason=cardLastResetReason, auditCommand=auditCommand, fpgaErrorEventGroup=fpgaErrorEventGroup, portTxFlowControlDetected=portTxFlowControlDetected, portDplxStatus=portDplxStatus, portNumber=portNumber, diskVolumeName=diskVolumeName, portDocsIfIndex=portDocsIfIndex, cardSecState=cardSecState, diskVolumeSize=diskVolumeSize, TestResult=TestResult, cadEquipmentMibCompliance=cadEquipmentMibCompliance, cmResetStatus=cmResetStatus, errEvLoggingEnabled=errEvLoggingEnabled, diskVolumeNumber=diskVolumeNumber, cardTestSchedule=cardTestSchedule, cardTestCommand=cardTestCommand, diskVolumeCardId=diskVolumeCardId, cardTestResultDesc=cardTestResultDesc, diskVolumeGroup=diskVolumeGroup, cardTestName=cardTestName, cardCpuSpeed=cardCpuSpeed, cardSecStateChange=cardSecStateChange, cardTestTable=cardTestTable, cardAction=cardAction, cardSpareGroupMode=cardSpareGroupMode, portRxFlowControlDetected=portRxFlowControlDetected, cardSpareGroupId=cardSpareGroupId, cardCarrierFwVersion=cardCarrierFwVersion, auditId=auditId, equipmentShelfGroup=equipmentShelfGroup, cardCpuType=cardCpuType, equipmentDiagGroup=equipmentDiagGroup, errEventId=errEventId, auditLogOutput=auditLogOutput, systemClock=systemClock, cardBusSpeed=cardBusSpeed, cmResetUpTime=cmResetUpTime, auditName=auditName, portPrStateChange=portPrStateChange, cardSubDetected=cardSubDetected, auditEntry=auditEntry, diskVolumeUsagePercentage=diskVolumeUsagePercentage, cardLastChangeTime=cardLastChangeTime, cardFwUpdateStatus=cardFwUpdateStatus, cardPicDetected=cardPicDetected, cardPrStateChange=cardPrStateChange, auditCycleCount=auditCycleCount, portTable=portTable, portMacAddress=portMacAddress, cardPicHwVersion=cardPicHwVersion, portDetectedMode=portDetectedMode, portTxFlowControlMode=portTxFlowControlMode, auditLogThrottle=auditLogThrottle, fpgaErrorEventEntry=fpgaErrorEventEntry, auditStatus=auditStatus, cmMacAddress=cmMacAddress, cardLastBootVersion=cardLastBootVersion, consoleOutput=consoleOutput, equipmentTbl=equipmentTbl, portMaxDsPower=portMaxDsPower, cardCPLDVersion=cardCPLDVersion, diagTestId=diagTestId, TestTransactionId=TestTransactionId, cardUpTime=cardUpTime, diskVolumeUsageNotification=diskVolumeUsageNotification, cmResetReason=cmResetReason, cardTestId=cardTestId, cmVendor=cmVendor, portSecStateChange=portSecStateChange, cardPicSerialNum=cardPicSerialNum, cardSubType=cardSubType, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, fpgaErrorEventTable=fpgaErrorEventTable, cardCarrierHwVersion=cardCarrierHwVersion, cardId=cardId, cardDplxStatusChange=cardDplxStatusChange, cardDplxStatus=cardDplxStatus, equipmentCardGroup=equipmentCardGroup, cardEntry=cardEntry, cardTemperatureHighError=cardTemperatureHighError, portType=portType, trapSeverity=trapSeverity, shelfObjects=shelfObjects, cardTable=cardTable, cardSwVersion=cardSwVersion, cardBootVersion=cardBootVersion, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, cardTestType=cardTestType, portRxFlowControlMode=portRxFlowControlMode, auditFailedCount=auditFailedCount, portMode=portMode, auditTime=auditTime, portCurrDsPower=portCurrDsPower, cadEquipmentMibGroup=cadEquipmentMibGroup, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, TestId=TestId, cardTemperatureHighWarn=cardTemperatureHighWarn, cardShelfId=cardShelfId, remainInDiagMode=remainInDiagMode, portDescription=portDescription, shelfSwVersion=shelfSwVersion, shelfNumber=shelfNumber, auditAutoScheduling=auditAutoScheduling, auditCardId=auditCardId, errEvRecoveryEnabled=errEvRecoveryEnabled, portDplxStatusChange=portDplxStatusChange, portSecState=portSecState, diskVolumeEntry=diskVolumeEntry, cardShelfTestIndex=cardShelfTestIndex, TestSchedule=TestSchedule, cardTestEntry=cardTestEntry, cmResetNotification=cmResetNotification, portPrState=portPrState, cardAdminState=cardAdminState, portCardSubType=portCardSubType, eqDiagConfig=eqDiagConfig, cardTestTime=cardTestTime, auditDescription=auditDescription, diskVolumeFileName=diskVolumeFileName, diskVolumeId=diskVolumeId, auditResult=auditResult)
