...
SecondaryState, DiskVolumeUsageLevel, UnknownState, FirmwareSource, CardSubType, FlowControlMode, PicType, PortId, PortMode, DuplexStatus, CardId, PortDetectedMode, PortType, EqActionType, PrimaryState, AdminState, CardType, ShelfId = mibBuilder.importSymbols("CADANT-TC", "SecondaryState", "DiskVolumeUsageLevel", "UnknownState", "FirmwareSource", "CardSubType", "FlowControlMode", "PicType", "PortId", "PortMode", "DuplexStatus", "CardId", "PortDetectedMode", "PortType", "EqActionType", "PrimaryState", "AdminState", "CardType", "ShelfId")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
NotificationGroup, ModuleCompliance, ObjectGroup = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ModuleCompliance", "ObjectGroup")
Integer32, ObjectIdentity, NotificationType, IpAddress, Counter64, Bits, TimeTicks, Counter32, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "NotificationType", "IpAddress", "Counter64", "Bits", "TimeTicks", "Counter32", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "ModuleIdentity")
TruthValue, TextualConvention, RowStatus, MacAddress, DateAndTime, TimeStamp, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TextualConvention", "RowStatus", "MacAddress", "DateAndTime", "TimeStamp", "DisplayString")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", shelfName=shelfName, cardFpgaSource=cardFpgaSource, diskVolumeNumber=diskVolumeNumber, cardPicSerialNum=cardPicSerialNum, cardCPLDVersion=cardCPLDVersion, cmResetStatus=cmResetStatus, cardNumber=cardNumber, errEvRowStatus=errEvRowStatus, systemGeneral=systemGeneral, downstreamPowerLoss=downstreamPowerLoss, portBgpId=portBgpId, systemKey=systemKey, portCurrDsPower=portCurrDsPower, portSecStateChange=portSecStateChange, cadEquipmentMibConformance=cadEquipmentMibConformance, cardSwVersion=cardSwVersion, cardTestResultNotification=cardTestResultNotification, portRxFlowControlDetected=portRxFlowControlDetected, cardHwVersion=cardHwVersion, equipmentDiag=equipmentDiag, TestResult=TestResult, auditStatus=auditStatus, auditLogOutput=auditLogOutput, cardCarrierSerialNum=cardCarrierSerialNum, cadEquipmentMib=cadEquipmentMib, cardTestId=cardTestId, auditName=auditName, cmUChannelID=cmUChannelID, cadEquipmentMibCompliance=cadEquipmentMibCompliance, auditTable=auditTable, portRxFlowControlMode=portRxFlowControlMode, TestScheduleCommand=TestScheduleCommand, portDescription=portDescription, cardSpareGroupMode=cardSpareGroupMode, cardLastResetReason=cardLastResetReason, cmPrimarySID=cmPrimarySID, portLastChangeTime=portLastChangeTime, cardTrapInh=cardTrapInh, cardTempNoReportNotification=cardTempNoReportNotification, errEventId=errEventId, equipmentTraps=equipmentTraps, verboseLevel=verboseLevel, cardDplxStatus=cardDplxStatus, auditShelfId=auditShelfId, cardNumPorts=cardNumPorts, auditAutoScheduling=auditAutoScheduling, TestId=TestId, cmDevice=cmDevice, cardTestIndex=cardTestIndex, cardCarrierFwVersion=cardCarrierFwVersion, cardShelfId=cardShelfId, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, equipmentDiagGroup=equipmentDiagGroup, equipmentAuditGroup=equipmentAuditGroup, diskVolumeShelfId=diskVolumeShelfId, cardSerialNum=cardSerialNum, cardTestTime=cardTestTime, cardLastChangeTime=cardLastChangeTime, equipmentStateGroup=equipmentStateGroup, auditCycleCount=auditCycleCount, errEvLogLevel=errEvLogLevel, auditCardId=auditCardId, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, portType=portType, cardDplxStatusChange=cardDplxStatusChange, shelfObjects=shelfObjects, cardAction=cardAction, TestSchedule=TestSchedule, portTable=portTable, auditEntry=auditEntry, TestCommand=TestCommand, cardTestCommand=cardTestCommand, trapSeverity=trapSeverity, fpgaErrorEventGroup=fpgaErrorEventGroup, cardSubType=cardSubType, cardUpTime=cardUpTime, cardPicDetected=cardPicDetected, portTxFlowControlMode=portTxFlowControlMode, cmVendor=cmVendor, trapCounter=trapCounter, shelfSwVersion=shelfSwVersion, cardRamSize=cardRamSize, portSecState=portSecState, diskVolumeEntry=diskVolumeEntry, portId=portId, cardTempOverHeatNotification=cardTempOverHeatNotification, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, portMode=portMode, cardTemperatureHighWarn=cardTemperatureHighWarn, cardTestScheduleCommand=cardTestScheduleCommand, PYSNMP_MODULE_ID=cadEquipmentMib, auditTotalPassedCount=auditTotalPassedCount, cmResetClearNotification=cmResetClearNotification, cmResetReason=cmResetReason, cardPrStateChange=cardPrStateChange, TestType=TestType, portMaxDsPower=portMaxDsPower, diskVolumeFileName=diskVolumeFileName, consoleOutput=consoleOutput, cardTestTable=cardTestTable, equipmentError=equipmentError, equipmentCardGroup=equipmentCardGroup, cardFwVersion=cardFwVersion, diskVolumeName=diskVolumeName, equipmentShelfGroup=equipmentShelfGroup, portPrState=portPrState, diskDriveNumber=diskDriveNumber, cardCpuSpeed=cardCpuSpeed, cmResetInfo=cmResetInfo, cardTestDescription=cardTestDescription, cardDetectedChange=cardDetectedChange, auditFailedCount=auditFailedCount, portPrStateChange=portPrStateChange, diskVolumeUsageLevel=diskVolumeUsageLevel, systemGeneralGroup=systemGeneralGroup, portTxFlowControlDetected=portTxFlowControlDetected, cardCpuType=cardCpuType, cardTestName=cardTestName, diskVolumeTable=diskVolumeTable, cardSecState=cardSecState, portShelfId=portShelfId, cardSecStateChange=cardSecStateChange, diskVolumeDiskSize=diskVolumeDiskSize, diskVolumeGroup=diskVolumeGroup, cardTemperatureHighError=cardTemperatureHighError, cardPicHwVersion=cardPicHwVersion, auditCommand=auditCommand, cardEntry=cardEntry, diagTestId=diagTestId, portDplxStatusChange=portDplxStatusChange, auditId=auditId, portCardSubType=portCardSubType, TestTransactionId=TestTransactionId, portCardId=portCardId, diskVolumeUsagePercentage=diskVolumeUsagePercentage, cmResetNotification=cmResetNotification, auditResult=auditResult, cardCarrierHwVersion=cardCarrierHwVersion, cardTable=cardTable, equipmentAudit=equipmentAudit, portEntry=portEntry, eqDiagConfig=eqDiagConfig, diskVolumeDriveId=diskVolumeDriveId, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, cmResetUpTime=cmResetUpTime, cardTestTransId=cardTestTransId, cardLastBootVersion=cardLastBootVersion, cardShelfTestIndex=cardShelfTestIndex, auditTotalFailedCount=auditTotalFailedCount, cardLastBootSource=cardLastBootSource, portMacAddress=portMacAddress, diskVolumeId=diskVolumeId, equipmentCardTestGroup=equipmentCardTestGroup, cardTestResult=cardTestResult, diskVolumeSize=diskVolumeSize, cmMacAddress=cmMacAddress, portMacIfIndex=portMacIfIndex, equipmentPortGroup=equipmentPortGroup, cardFwUpdateStatus=cardFwUpdateStatus, cmRegistrationNotification=cmRegistrationNotification, portMinDsPower=portMinDsPower, portDocsIfIndex=portDocsIfIndex, cmIpAddress=cmIpAddress, cardTemperature=cardTemperature, cardType=cardType, cardName=cardName, portConnectorId=portConnectorId, cadEquipmentMibGroup=cadEquipmentMibGroup, cardBusSpeed=cardBusSpeed, auditLogThrottle=auditLogThrottle, systemClock=systemClock, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cardSpareGroupId=cardSpareGroupId, errEvRecoveryEnabled=errEvRecoveryEnabled, cardAdminState=cardAdminState, cardFlashSize=cardFlashSize, equipmentState=equipmentState, cardSubDetected=cardSubDetected, cardTestResultDesc=cardTestResultDesc, portNumber=portNumber, portDetectedMode=portDetectedMode, diskVolumeTrapInh=diskVolumeTrapInh, cardPrState=cardPrState, remainInDiagMode=remainInDiagMode, portDplxStatus=portDplxStatus, cardTestEntry=cardTestEntry, auditTime=auditTime, portTrapInh=portTrapInh, portAction=portAction, equipmentTbl=equipmentTbl, portNumChans=portNumChans, cardTestType=cardTestType, auditPassedCount=auditPassedCount, cardDetected=cardDetected, portAdminState=portAdminState, cardTestSchedule=cardTestSchedule, diskVolumeCardId=diskVolumeCardId, shelfNumber=shelfNumber, diskVolumeUsageNotification=diskVolumeUsageNotification, auditDescription=auditDescription, cardId=cardId, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, cardBootVersion=cardBootVersion, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, fpgaErrorEventEntry=fpgaErrorEventEntry, errEvLoggingEnabled=errEvLoggingEnabled, fpgaErrorEventTable=fpgaErrorEventTable)
