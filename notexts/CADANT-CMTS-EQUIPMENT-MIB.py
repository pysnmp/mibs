...
AdminState, PortId, PortDetectedMode, PortType, ShelfId, UnknownState, DuplexStatus, CardSubType, FlowControlMode, PortMode, CardId, PrimaryState, EqActionType, PicType, DiskVolumeUsageLevel, FirmwareSource, SecondaryState, CardType = mibBuilder.importSymbols("CADANT-TC", "AdminState", "PortId", "PortDetectedMode", "PortType", "ShelfId", "UnknownState", "DuplexStatus", "CardSubType", "FlowControlMode", "PortMode", "CardId", "PrimaryState", "EqActionType", "PicType", "DiskVolumeUsageLevel", "FirmwareSource", "SecondaryState", "CardType")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ObjectGroup, ModuleCompliance, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "ModuleCompliance", "NotificationGroup")
TimeTicks, ModuleIdentity, iso, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, ObjectIdentity, NotificationType, Counter32, Integer32, Bits, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "iso", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "ObjectIdentity", "NotificationType", "Counter32", "Integer32", "Bits", "Gauge32")
DateAndTime, TextualConvention, MacAddress, TimeStamp, DisplayString, RowStatus, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "TextualConvention", "MacAddress", "TimeStamp", "DisplayString", "RowStatus", "TruthValue")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", TestId=TestId, diskVolumeDriveId=diskVolumeDriveId, diskVolumeId=diskVolumeId, auditPassedCount=auditPassedCount, errEvRecoveryEnabled=errEvRecoveryEnabled, cardName=cardName, portBgpId=portBgpId, cardSpareGroupId=cardSpareGroupId, portPrState=portPrState, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, diskVolumeCardId=diskVolumeCardId, equipmentShelfGroup=equipmentShelfGroup, portLastChangeTime=portLastChangeTime, cmResetUpTime=cmResetUpTime, cadEquipmentMib=cadEquipmentMib, portAdminState=portAdminState, equipmentError=equipmentError, errEvLogLevel=errEvLogLevel, equipmentState=equipmentState, portMinDsPower=portMinDsPower, cardEntry=cardEntry, diskVolumeEntry=diskVolumeEntry, cmResetReason=cmResetReason, cardTestIndex=cardTestIndex, portId=portId, cardTestType=cardTestType, cardCpuType=cardCpuType, portCurrDsPower=portCurrDsPower, systemGeneral=systemGeneral, cardSecStateChange=cardSecStateChange, cardDplxStatusChange=cardDplxStatusChange, cardTestScheduleCommand=cardTestScheduleCommand, auditStatus=auditStatus, cardLastBootSource=cardLastBootSource, diskVolumeNumber=diskVolumeNumber, cardSubDetected=cardSubDetected, equipmentTbl=equipmentTbl, equipmentDiag=equipmentDiag, cadEquipmentMibCompliances=cadEquipmentMibCompliances, TestSchedule=TestSchedule, cardId=cardId, auditTotalPassedCount=auditTotalPassedCount, portTxFlowControlDetected=portTxFlowControlDetected, eqDiagConfig=eqDiagConfig, auditAutoScheduling=auditAutoScheduling, portSecState=portSecState, cardTestResult=cardTestResult, portShelfId=portShelfId, diskVolumeGroup=diskVolumeGroup, diskDriveNumber=diskDriveNumber, errEvRowStatus=errEvRowStatus, cardTestTime=cardTestTime, cadEquipmentMibGroup=cadEquipmentMibGroup, cardDetectedChange=cardDetectedChange, portConnectorId=portConnectorId, cardPicDetected=cardPicDetected, TestCommand=TestCommand, auditCycleCount=auditCycleCount, diskVolumeName=diskVolumeName, consoleOutput=consoleOutput, portTable=portTable, cardTestTransId=cardTestTransId, diskVolumeDiskSize=diskVolumeDiskSize, cardPrStateChange=cardPrStateChange, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cardPicHwVersion=cardPicHwVersion, portAction=portAction, cardTestName=cardTestName, cardCpuSpeed=cardCpuSpeed, cardTemperatureHighWarn=cardTemperatureHighWarn, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, portNumber=portNumber, shelfNumber=shelfNumber, cardFwUpdateStatus=cardFwUpdateStatus, fpgaErrorEventTable=fpgaErrorEventTable, systemClock=systemClock, errEventId=errEventId, equipmentPortGroup=equipmentPortGroup, cmIpAddress=cmIpAddress, auditTime=auditTime, cardHwVersion=cardHwVersion, portDplxStatus=portDplxStatus, cardFlashSize=cardFlashSize, cardLastChangeTime=cardLastChangeTime, cardDetected=cardDetected, portNumChans=portNumChans, cardBootVersion=cardBootVersion, cmResetInfo=cmResetInfo, cmUChannelID=cmUChannelID, auditDescription=auditDescription, diagTestId=diagTestId, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, auditTotalFailedCount=auditTotalFailedCount, portRxFlowControlMode=portRxFlowControlMode, cardUpTime=cardUpTime, cardTestResultNotification=cardTestResultNotification, cardFwVersion=cardFwVersion, diskVolumeShelfId=diskVolumeShelfId, auditShelfId=auditShelfId, cmMacAddress=cmMacAddress, cardAdminState=cardAdminState, cardNumPorts=cardNumPorts, cardNumber=cardNumber, cardCarrierSerialNum=cardCarrierSerialNum, equipmentCardGroup=equipmentCardGroup, portMacAddress=portMacAddress, auditCommand=auditCommand, cardTrapInh=cardTrapInh, diskVolumeFileName=diskVolumeFileName, cardTestTable=cardTestTable, cardType=cardType, PYSNMP_MODULE_ID=cadEquipmentMib, portEntry=portEntry, auditEntry=auditEntry, portDplxStatusChange=portDplxStatusChange, diskVolumeTable=diskVolumeTable, cardRamSize=cardRamSize, cardAction=cardAction, fpgaErrorEventEntry=fpgaErrorEventEntry, portPrStateChange=portPrStateChange, cardLastBootVersion=cardLastBootVersion, diskVolumeTrapInh=diskVolumeTrapInh, cmVendor=cmVendor, cardTestSchedule=cardTestSchedule, cardSecState=cardSecState, shelfSwVersion=shelfSwVersion, TestType=TestType, portCardSubType=portCardSubType, cmDevice=cmDevice, equipmentStateGroup=equipmentStateGroup, cardTestResultDesc=cardTestResultDesc, cardFpgaSource=cardFpgaSource, downstreamPowerLoss=downstreamPowerLoss, portMaxDsPower=portMaxDsPower, TestScheduleCommand=TestScheduleCommand, cardPrState=cardPrState, diskVolumeUsageNotification=diskVolumeUsageNotification, cardCPLDVersion=cardCPLDVersion, diskVolumeSize=diskVolumeSize, cardTempOverHeatNotification=cardTempOverHeatNotification, cardCarrierFwVersion=cardCarrierFwVersion, auditFailedCount=auditFailedCount, cmResetClearNotification=cmResetClearNotification, auditId=auditId, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, remainInDiagMode=remainInDiagMode, TestTransactionId=TestTransactionId, cardDplxStatus=cardDplxStatus, cardTemperatureHighError=cardTemperatureHighError, shelfName=shelfName, verboseLevel=verboseLevel, cardTestEntry=cardTestEntry, auditName=auditName, auditLogThrottle=auditLogThrottle, cmPrimarySID=cmPrimarySID, cardTestCommand=cardTestCommand, portSecStateChange=portSecStateChange, portRxFlowControlDetected=portRxFlowControlDetected, cmResetNotification=cmResetNotification, cadEquipmentMibCompliance=cadEquipmentMibCompliance, cardTable=cardTable, cardCarrierHwVersion=cardCarrierHwVersion, portDescription=portDescription, equipmentTraps=equipmentTraps, equipmentCardTestGroup=equipmentCardTestGroup, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, trapSeverity=trapSeverity, portMode=portMode, cmRegistrationNotification=cmRegistrationNotification, cardTemperature=cardTemperature, auditLogOutput=auditLogOutput, trapCounter=trapCounter, portCardId=portCardId, portMacIfIndex=portMacIfIndex, portDetectedMode=portDetectedMode, cardSwVersion=cardSwVersion, auditCardId=auditCardId, cardShelfTestIndex=cardShelfTestIndex, fpgaErrorEventGroup=fpgaErrorEventGroup, cardShelfId=cardShelfId, cardTestId=cardTestId, diskVolumeUsageLevel=diskVolumeUsageLevel, cadEquipmentMibConformance=cadEquipmentMibConformance, portTrapInh=portTrapInh, TestResult=TestResult, errEvLoggingEnabled=errEvLoggingEnabled, cardBusSpeed=cardBusSpeed, auditTable=auditTable, diskVolumeUsagePercentage=diskVolumeUsagePercentage, equipmentAuditGroup=equipmentAuditGroup, portDocsIfIndex=portDocsIfIndex, portTxFlowControlMode=portTxFlowControlMode, cardSpareGroupMode=cardSpareGroupMode, auditResult=auditResult, equipmentDiagGroup=equipmentDiagGroup, portType=portType, cardTestDescription=cardTestDescription, shelfObjects=shelfObjects, equipmentAudit=equipmentAudit, systemGeneralGroup=systemGeneralGroup, cardSubType=cardSubType, cardPicSerialNum=cardPicSerialNum, cardTempNoReportNotification=cardTempNoReportNotification, systemKey=systemKey, cardLastResetReason=cardLastResetReason, cardSerialNum=cardSerialNum, cmResetStatus=cmResetStatus)
