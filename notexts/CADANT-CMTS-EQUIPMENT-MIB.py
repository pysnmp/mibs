...
ShelfId, PortDetectedMode, UnknownState, PrimaryState, DuplexStatus, AdminState, PortId, PortMode, CardSubType, SecondaryState, FlowControlMode, DiskVolumeUsageLevel, PicType, EqActionType, PortType, CardType, CardId, FirmwareSource = mibBuilder.importSymbols("CADANT-TC", "ShelfId", "PortDetectedMode", "UnknownState", "PrimaryState", "DuplexStatus", "AdminState", "PortId", "PortMode", "CardSubType", "SecondaryState", "FlowControlMode", "DiskVolumeUsageLevel", "PicType", "EqActionType", "PortType", "CardType", "CardId", "FirmwareSource")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ModuleCompliance, ObjectGroup, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "ObjectGroup", "NotificationGroup")
Integer32, Counter64, ModuleIdentity, Counter32, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, iso, Unsigned32, Bits, Gauge32, NotificationType, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter64", "ModuleIdentity", "Counter32", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "iso", "Unsigned32", "Bits", "Gauge32", "NotificationType", "ObjectIdentity")
TextualConvention, DateAndTime, TimeStamp, MacAddress, DisplayString, RowStatus, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DateAndTime", "TimeStamp", "MacAddress", "DisplayString", "RowStatus", "TruthValue")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", equipmentDiagGroup=equipmentDiagGroup, diskVolumeCardId=diskVolumeCardId, auditEntry=auditEntry, cardCPLDVersion=cardCPLDVersion, errEvLogLevel=errEvLogLevel, remainInDiagMode=remainInDiagMode, cmIpAddress=cmIpAddress, downstreamPowerLoss=downstreamPowerLoss, errEventId=errEventId, cmResetReason=cmResetReason, fpgaErrorEventEntry=fpgaErrorEventEntry, cardSecState=cardSecState, diskVolumeId=diskVolumeId, cardTestResultDesc=cardTestResultDesc, diskVolumeShelfId=diskVolumeShelfId, equipmentShelfGroup=equipmentShelfGroup, equipmentPortGroup=equipmentPortGroup, TestResult=TestResult, cardUpTime=cardUpTime, cardBootVersion=cardBootVersion, portType=portType, auditAutoScheduling=auditAutoScheduling, portTable=portTable, cardSubType=cardSubType, errEvRowStatus=errEvRowStatus, auditTotalFailedCount=auditTotalFailedCount, equipmentAuditGroup=equipmentAuditGroup, cardTestDescription=cardTestDescription, cardSpareGroupId=cardSpareGroupId, portEntry=portEntry, systemKey=systemKey, cmDevice=cmDevice, cardLastChangeTime=cardLastChangeTime, cardFlashSize=cardFlashSize, cardSubDetected=cardSubDetected, equipmentTraps=equipmentTraps, cardId=cardId, cardTestResult=cardTestResult, cardTestIndex=cardTestIndex, fpgaErrorEventGroup=fpgaErrorEventGroup, portShelfId=portShelfId, portMaxDsPower=portMaxDsPower, TestCommand=TestCommand, cardTestScheduleCommand=cardTestScheduleCommand, cadEquipmentMibCompliances=cadEquipmentMibCompliances, systemGeneral=systemGeneral, TestScheduleCommand=TestScheduleCommand, cardTestTable=cardTestTable, equipmentAudit=equipmentAudit, cardTestType=cardTestType, cardNumber=cardNumber, equipmentCardGroup=equipmentCardGroup, portLastChangeTime=portLastChangeTime, cardLastResetReason=cardLastResetReason, cmVendor=cmVendor, cmUChannelID=cmUChannelID, cardPicDetected=cardPicDetected, cardTestEntry=cardTestEntry, cardPicSerialNum=cardPicSerialNum, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, auditTable=auditTable, cardTemperatureHighError=cardTemperatureHighError, diskVolumeUsageLevel=diskVolumeUsageLevel, auditId=auditId, cardSpareGroupMode=cardSpareGroupMode, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, auditLogOutput=auditLogOutput, cardTestName=cardTestName, portDplxStatus=portDplxStatus, cardTestResultNotification=cardTestResultNotification, auditName=auditName, cardTrapInh=cardTrapInh, cardFwUpdateStatus=cardFwUpdateStatus, equipmentDiag=equipmentDiag, TestType=TestType, portAdminState=portAdminState, auditResult=auditResult, portDplxStatusChange=portDplxStatusChange, cmResetStatus=cmResetStatus, errEvRecoveryEnabled=errEvRecoveryEnabled, cardSwVersion=cardSwVersion, portNumChans=portNumChans, cardDplxStatusChange=cardDplxStatusChange, cardCpuType=cardCpuType, cardSecStateChange=cardSecStateChange, cardPicHwVersion=cardPicHwVersion, cardFwVersion=cardFwVersion, portRxFlowControlMode=portRxFlowControlMode, TestSchedule=TestSchedule, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, auditCardId=auditCardId, diskVolumeName=diskVolumeName, portTxFlowControlDetected=portTxFlowControlDetected, portMinDsPower=portMinDsPower, auditCommand=auditCommand, cadEquipmentMib=cadEquipmentMib, auditPassedCount=auditPassedCount, cadEquipmentMibCompliance=cadEquipmentMibCompliance, cadEquipmentMibConformance=cadEquipmentMibConformance, cardAction=cardAction, diskVolumeNumber=diskVolumeNumber, cardTemperatureHighWarn=cardTemperatureHighWarn, cardNumPorts=cardNumPorts, systemGeneralGroup=systemGeneralGroup, portMacAddress=portMacAddress, cardLastBootVersion=cardLastBootVersion, diskVolumeTrapInh=diskVolumeTrapInh, cardCpuSpeed=cardCpuSpeed, cardLastBootSource=cardLastBootSource, portCardSubType=portCardSubType, cardDetectedChange=cardDetectedChange, cardCarrierHwVersion=cardCarrierHwVersion, diskVolumeGroup=diskVolumeGroup, verboseLevel=verboseLevel, diskVolumeUsageNotification=diskVolumeUsageNotification, cmResetNotification=cmResetNotification, cardTemperature=cardTemperature, equipmentStateGroup=equipmentStateGroup, portAction=portAction, auditStatus=auditStatus, diskVolumeDriveId=diskVolumeDriveId, auditDescription=auditDescription, trapSeverity=trapSeverity, cardTempOverHeatNotification=cardTempOverHeatNotification, cmMacAddress=cmMacAddress, portPrStateChange=portPrStateChange, shelfName=shelfName, cardSerialNum=cardSerialNum, portDescription=portDescription, diagTestId=diagTestId, shelfSwVersion=shelfSwVersion, auditTotalPassedCount=auditTotalPassedCount, cmPrimarySID=cmPrimarySID, portSecStateChange=portSecStateChange, diskDriveNumber=diskDriveNumber, PYSNMP_MODULE_ID=cadEquipmentMib, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, cardCarrierSerialNum=cardCarrierSerialNum, portTrapInh=portTrapInh, fpgaErrorEventTable=fpgaErrorEventTable, systemClock=systemClock, cardBusSpeed=cardBusSpeed, cardShelfTestIndex=cardShelfTestIndex, portTxFlowControlMode=portTxFlowControlMode, consoleOutput=consoleOutput, cardPrStateChange=cardPrStateChange, diskVolumeFileName=diskVolumeFileName, portId=portId, diskVolumeEntry=diskVolumeEntry, cardTestTransId=cardTestTransId, cardShelfId=cardShelfId, TestId=TestId, cardType=cardType, equipmentTbl=equipmentTbl, auditLogThrottle=auditLogThrottle, shelfNumber=shelfNumber, TestTransactionId=TestTransactionId, cmRegistrationNotification=cmRegistrationNotification, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, auditShelfId=auditShelfId, portDocsIfIndex=portDocsIfIndex, auditTime=auditTime, cardFpgaSource=cardFpgaSource, auditFailedCount=auditFailedCount, cmResetInfo=cmResetInfo, cadEquipmentMibGroup=cadEquipmentMibGroup, diskVolumeUsagePercentage=diskVolumeUsagePercentage, portMode=portMode, cardAdminState=cardAdminState, portBgpId=portBgpId, auditCycleCount=auditCycleCount, cardPrState=cardPrState, cardHwVersion=cardHwVersion, cardRamSize=cardRamSize, cardTempNoReportNotification=cardTempNoReportNotification, cardDplxStatus=cardDplxStatus, cardTestId=cardTestId, cmResetClearNotification=cmResetClearNotification, cmResetUpTime=cmResetUpTime, cardCarrierFwVersion=cardCarrierFwVersion, equipmentState=equipmentState, diskVolumeDiskSize=diskVolumeDiskSize, cardTestSchedule=cardTestSchedule, eqDiagConfig=eqDiagConfig, shelfObjects=shelfObjects, cardTable=cardTable, portNumber=portNumber, cardName=cardName, cardDetected=cardDetected, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cardTestCommand=cardTestCommand, portCurrDsPower=portCurrDsPower, portConnectorId=portConnectorId, portMacIfIndex=portMacIfIndex, trapCounter=trapCounter, equipmentError=equipmentError, portRxFlowControlDetected=portRxFlowControlDetected, diskVolumeSize=diskVolumeSize, cardEntry=cardEntry, portPrState=portPrState, portDetectedMode=portDetectedMode, diskVolumeTable=diskVolumeTable, errEvLoggingEnabled=errEvLoggingEnabled, cardTestTime=cardTestTime, portCardId=portCardId, portSecState=portSecState, equipmentCardTestGroup=equipmentCardTestGroup)
