...
PicType, PortType, FlowControlMode, EqActionType, SecondaryState, PortDetectedMode, PrimaryState, UnknownState, CardSubType, DiskVolumeUsageLevel, PortId, ShelfId, CardId, AdminState, CardType, FirmwareSource, DuplexStatus, PortMode = mibBuilder.importSymbols("CADANT-TC", "PicType", "PortType", "FlowControlMode", "EqActionType", "SecondaryState", "PortDetectedMode", "PrimaryState", "UnknownState", "CardSubType", "DiskVolumeUsageLevel", "PortId", "ShelfId", "CardId", "AdminState", "CardType", "FirmwareSource", "DuplexStatus", "PortMode")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
NotificationGroup, ModuleCompliance, ObjectGroup = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ModuleCompliance", "ObjectGroup")
NotificationType, ModuleIdentity, Counter32, TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, MibIdentifier, iso, Integer32, Bits, Counter64, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "Counter32", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "MibIdentifier", "iso", "Integer32", "Bits", "Counter64", "Unsigned32")
DateAndTime, DisplayString, TruthValue, MacAddress, TimeStamp, TextualConvention, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "DisplayString", "TruthValue", "MacAddress", "TimeStamp", "TextualConvention", "RowStatus")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", portNumChans=portNumChans, TestResult=TestResult, cardLastBootSource=cardLastBootSource, portSecState=portSecState, cardBusSpeed=cardBusSpeed, fpgaErrorEventTable=fpgaErrorEventTable, trapCounter=trapCounter, cardTestDescription=cardTestDescription, cardFpgaSource=cardFpgaSource, portRxFlowControlDetected=portRxFlowControlDetected, auditName=auditName, cmResetNotification=cmResetNotification, equipmentCardTestGroup=equipmentCardTestGroup, cardLastResetReason=cardLastResetReason, TestTransactionId=TestTransactionId, auditFailedCount=auditFailedCount, cadEquipmentMibConformance=cadEquipmentMibConformance, equipmentTraps=equipmentTraps, trapSeverity=trapSeverity, portTrapInh=portTrapInh, cardTestEntry=cardTestEntry, portType=portType, auditLogThrottle=auditLogThrottle, cardHwVersion=cardHwVersion, auditShelfId=auditShelfId, cardTempOverHeatNotification=cardTempOverHeatNotification, equipmentDiagGroup=equipmentDiagGroup, cardName=cardName, cardSwVersion=cardSwVersion, portTable=portTable, diskVolumeName=diskVolumeName, cardTestCommand=cardTestCommand, cardType=cardType, auditStatus=auditStatus, cardFlashSize=cardFlashSize, cardTestTime=cardTestTime, systemGeneralGroup=systemGeneralGroup, auditCommand=auditCommand, shelfNumber=shelfNumber, equipmentStateGroup=equipmentStateGroup, portCardId=portCardId, portMacIfIndex=portMacIfIndex, cardCPLDVersion=cardCPLDVersion, cardTrapInh=cardTrapInh, cardUpTime=cardUpTime, cadEquipmentMib=cadEquipmentMib, cardCarrierHwVersion=cardCarrierHwVersion, cardTestScheduleCommand=cardTestScheduleCommand, cardSerialNum=cardSerialNum, cardDetectedChange=cardDetectedChange, portDplxStatusChange=portDplxStatusChange, portLastChangeTime=portLastChangeTime, cardDplxStatus=cardDplxStatus, equipmentDiag=equipmentDiag, cardPrStateChange=cardPrStateChange, diskVolumeDriveId=diskVolumeDriveId, systemGeneral=systemGeneral, cardPrState=cardPrState, portMacAddress=portMacAddress, portRxFlowControlMode=portRxFlowControlMode, fpgaErrorEventGroup=fpgaErrorEventGroup, cmResetReason=cmResetReason, portNumber=portNumber, diskVolumeUsageLevel=diskVolumeUsageLevel, cardSecStateChange=cardSecStateChange, equipmentState=equipmentState, shelfName=shelfName, equipmentCardGroup=equipmentCardGroup, fpgaErrorEventEntry=fpgaErrorEventEntry, shelfSwVersion=shelfSwVersion, cardLastBootVersion=cardLastBootVersion, TestId=TestId, auditCycleCount=auditCycleCount, portDplxStatus=portDplxStatus, errEvRowStatus=errEvRowStatus, cardSecState=cardSecState, portMode=portMode, cmPrimarySID=cmPrimarySID, diskVolumeEntry=diskVolumeEntry, auditTotalPassedCount=auditTotalPassedCount, cardRamSize=cardRamSize, systemClock=systemClock, cardTable=cardTable, equipmentAuditGroup=equipmentAuditGroup, cardAction=cardAction, cardPicHwVersion=cardPicHwVersion, cardTestTransId=cardTestTransId, diskVolumeTable=diskVolumeTable, auditResult=auditResult, cmMacAddress=cmMacAddress, shelfObjects=shelfObjects, auditCardId=auditCardId, diskVolumeSize=diskVolumeSize, errEventId=errEventId, cadEquipmentMibGroup=cadEquipmentMibGroup, portPrStateChange=portPrStateChange, TestCommand=TestCommand, eqDiagConfig=eqDiagConfig, portBgpId=portBgpId, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, cardPicSerialNum=cardPicSerialNum, TestSchedule=TestSchedule, cardLastChangeTime=cardLastChangeTime, cardTestTable=cardTestTable, portDocsIfIndex=portDocsIfIndex, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, equipmentAudit=equipmentAudit, cardTemperatureHighError=cardTemperatureHighError, portCardSubType=portCardSubType, portTxFlowControlMode=portTxFlowControlMode, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cardSpareGroupId=cardSpareGroupId, cardTemperatureHighWarn=cardTemperatureHighWarn, cardPicDetected=cardPicDetected, diskVolumeUsagePercentage=diskVolumeUsagePercentage, cardCpuSpeed=cardCpuSpeed, cardCarrierFwVersion=cardCarrierFwVersion, portAction=portAction, cardTempNoReportNotification=cardTempNoReportNotification, cardTemperature=cardTemperature, cardTestResultNotification=cardTestResultNotification, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, diskVolumeFileName=diskVolumeFileName, cardTestSchedule=cardTestSchedule, auditDescription=auditDescription, portMinDsPower=portMinDsPower, auditLogOutput=auditLogOutput, cardNumPorts=cardNumPorts, cardShelfTestIndex=cardShelfTestIndex, diskVolumeDiskSize=diskVolumeDiskSize, cardNumber=cardNumber, consoleOutput=consoleOutput, PYSNMP_MODULE_ID=cadEquipmentMib, cardDplxStatusChange=cardDplxStatusChange, cardAdminState=cardAdminState, cmIpAddress=cmIpAddress, portId=portId, portDescription=portDescription, portCurrDsPower=portCurrDsPower, cmDevice=cmDevice, cmVendor=cmVendor, cmUChannelID=cmUChannelID, auditPassedCount=auditPassedCount, cmResetStatus=cmResetStatus, equipmentError=equipmentError, diskVolumeGroup=diskVolumeGroup, cadEquipmentMibCompliance=cadEquipmentMibCompliance, cmRegistrationNotification=cmRegistrationNotification, portMaxDsPower=portMaxDsPower, cardTestResult=cardTestResult, portConnectorId=portConnectorId, cardTestType=cardTestType, cardBootVersion=cardBootVersion, portAdminState=portAdminState, cardId=cardId, cardShelfId=cardShelfId, cardCarrierSerialNum=cardCarrierSerialNum, auditTime=auditTime, cmResetInfo=cmResetInfo, cmResetUpTime=cmResetUpTime, errEvLogLevel=errEvLogLevel, diagTestId=diagTestId, downstreamPowerLoss=downstreamPowerLoss, portSecStateChange=portSecStateChange, cardFwUpdateStatus=cardFwUpdateStatus, portEntry=portEntry, diskVolumeUsageNotification=diskVolumeUsageNotification, cardTestResultDesc=cardTestResultDesc, diskVolumeNumber=diskVolumeNumber, equipmentPortGroup=equipmentPortGroup, equipmentShelfGroup=equipmentShelfGroup, auditAutoScheduling=auditAutoScheduling, diskVolumeShelfId=diskVolumeShelfId, auditEntry=auditEntry, portPrState=portPrState, portTxFlowControlDetected=portTxFlowControlDetected, cardTestName=cardTestName, diskVolumeId=diskVolumeId, TestType=TestType, diskVolumeCardId=diskVolumeCardId, cardSubDetected=cardSubDetected, verboseLevel=verboseLevel, auditTable=auditTable, cardDetected=cardDetected, cardEntry=cardEntry, diskDriveNumber=diskDriveNumber, cardTestId=cardTestId, cmResetClearNotification=cmResetClearNotification, equipmentTbl=equipmentTbl, errEvLoggingEnabled=errEvLoggingEnabled, systemKey=systemKey, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, portDetectedMode=portDetectedMode, remainInDiagMode=remainInDiagMode, cardFwVersion=cardFwVersion, portShelfId=portShelfId, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cardTestIndex=cardTestIndex, diskVolumeTrapInh=diskVolumeTrapInh, auditId=auditId, auditTotalFailedCount=auditTotalFailedCount, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, cardSpareGroupMode=cardSpareGroupMode, cardCpuType=cardCpuType, TestScheduleCommand=TestScheduleCommand, cardSubType=cardSubType, errEvRecoveryEnabled=errEvRecoveryEnabled)
