...
PortId, PrimaryState, AdminState, CardId, DiskVolumeUsageLevel, ShelfId, FlowControlMode, FirmwareSource, PortMode, CardSubType, CardType, DuplexStatus, PortType, SecondaryState, EqActionType, UnknownState, PicType, PortDetectedMode = mibBuilder.importSymbols("CADANT-TC", "PortId", "PrimaryState", "AdminState", "CardId", "DiskVolumeUsageLevel", "ShelfId", "FlowControlMode", "FirmwareSource", "PortMode", "CardSubType", "CardType", "DuplexStatus", "PortType", "SecondaryState", "EqActionType", "UnknownState", "PicType", "PortDetectedMode")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", cmMacAddress=cmMacAddress, cadEquipmentMibConformance=cadEquipmentMibConformance, cardId=cardId, auditResult=auditResult, TestCommand=TestCommand, eqDiagConfig=eqDiagConfig, cardNumPorts=cardNumPorts, auditLogThrottle=auditLogThrottle, auditDescription=auditDescription, cmIpAddress=cmIpAddress, equipmentCardTestGroup=equipmentCardTestGroup, cardBusSpeed=cardBusSpeed, diskVolumeCardId=diskVolumeCardId, cadEquipmentMib=cadEquipmentMib, systemClock=systemClock, diagTestId=diagTestId, cardFwUpdateStatus=cardFwUpdateStatus, equipmentCardGroup=equipmentCardGroup, portLastChangeTime=portLastChangeTime, cmResetStatus=cmResetStatus, cardEntry=cardEntry, diskVolumeSize=diskVolumeSize, systemGeneralGroup=systemGeneralGroup, remainInDiagMode=remainInDiagMode, cmResetNotification=cmResetNotification, diskVolumeUsageNotification=diskVolumeUsageNotification, fpgaErrorEventGroup=fpgaErrorEventGroup, cardAction=cardAction, cmResetUpTime=cmResetUpTime, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, cardDplxStatus=cardDplxStatus, equipmentAuditGroup=equipmentAuditGroup, diskVolumeUsagePercentage=diskVolumeUsagePercentage, cardShelfId=cardShelfId, cardSecState=cardSecState, portTrapInh=portTrapInh, errEvRecoveryEnabled=errEvRecoveryEnabled, errEvLoggingEnabled=errEvLoggingEnabled, portSecState=portSecState, cardCarrierHwVersion=cardCarrierHwVersion, TestSchedule=TestSchedule, cardCPLDVersion=cardCPLDVersion, diskVolumeFileName=diskVolumeFileName, auditTime=auditTime, cardNumber=cardNumber, cmResetReason=cmResetReason, fpgaErrorEventEntry=fpgaErrorEventEntry, systemKey=systemKey, TestTransactionId=TestTransactionId, cardDplxStatusChange=cardDplxStatusChange, portCardId=portCardId, equipmentShelfGroup=equipmentShelfGroup, portTable=portTable, cmRegistrationNotification=cmRegistrationNotification, cardTemperatureHighError=cardTemperatureHighError, diskVolumeDiskSize=diskVolumeDiskSize, cadEquipmentMibCompliance=cadEquipmentMibCompliance, auditEntry=auditEntry, cardTestType=cardTestType, cmPrimarySID=cmPrimarySID, cmResetInfo=cmResetInfo, cardTestResultDesc=cardTestResultDesc, fpgaErrorEventTable=fpgaErrorEventTable, auditCycleCount=auditCycleCount, auditFailedCount=auditFailedCount, portRxFlowControlDetected=portRxFlowControlDetected, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cardCpuType=cardCpuType, cardLastBootSource=cardLastBootSource, cardTrapInh=cardTrapInh, diskVolumeId=diskVolumeId, cadEquipmentMibGroup=cadEquipmentMibGroup, auditStatus=auditStatus, diskVolumeEntry=diskVolumeEntry, portDetectedMode=portDetectedMode, cmResetClearNotification=cmResetClearNotification, cardPrStateChange=cardPrStateChange, cardTempOverHeatNotification=cardTempOverHeatNotification, TestScheduleCommand=TestScheduleCommand, cardLastChangeTime=cardLastChangeTime, cardAdminState=cardAdminState, cardUpTime=cardUpTime, cardSwVersion=cardSwVersion, portShelfId=portShelfId, diskDriveNumber=diskDriveNumber, portNumChans=portNumChans, portRxFlowControlMode=portRxFlowControlMode, cardTestSchedule=cardTestSchedule, cardLastResetReason=cardLastResetReason, diskVolumeTable=diskVolumeTable, errEventId=errEventId, errEvRowStatus=errEvRowStatus, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, cardTestTime=cardTestTime, portId=portId, portEntry=portEntry, portCurrDsPower=portCurrDsPower, equipmentTbl=equipmentTbl, auditId=auditId, equipmentDiagGroup=equipmentDiagGroup, portPrStateChange=portPrStateChange, trapCounter=trapCounter, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, auditLogOutput=auditLogOutput, cardTemperature=cardTemperature, auditTotalFailedCount=auditTotalFailedCount, cmDevice=cmDevice, auditTable=auditTable, cardTestTransId=cardTestTransId, portDplxStatusChange=portDplxStatusChange, cardCarrierFwVersion=cardCarrierFwVersion, cardRamSize=cardRamSize, auditShelfId=auditShelfId, cardTempNoReportNotification=cardTempNoReportNotification, cardTestResultNotification=cardTestResultNotification, cardSerialNum=cardSerialNum, portTxFlowControlMode=portTxFlowControlMode, auditCommand=auditCommand, portPrState=portPrState, cardFlashSize=cardFlashSize, systemGeneral=systemGeneral, portAction=portAction, shelfSwVersion=shelfSwVersion, portMacAddress=portMacAddress, cadEquipmentMibCompliances=cadEquipmentMibCompliances, PYSNMP_MODULE_ID=cadEquipmentMib, portNumber=portNumber, equipmentDiag=equipmentDiag, cardFpgaSource=cardFpgaSource, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, shelfName=shelfName, cardTestName=cardTestName, portCardSubType=portCardSubType, TestType=TestType, cardPicHwVersion=cardPicHwVersion, equipmentPortGroup=equipmentPortGroup, cardTestTable=cardTestTable, errEvLogLevel=errEvLogLevel, portType=portType, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, portAdminState=portAdminState, diskVolumeGroup=diskVolumeGroup, cardTestResult=cardTestResult, cardShelfTestIndex=cardShelfTestIndex, equipmentError=equipmentError, portTxFlowControlDetected=portTxFlowControlDetected, cardPrState=cardPrState, auditCardId=auditCardId, cardSecStateChange=cardSecStateChange, cardSubDetected=cardSubDetected, equipmentState=equipmentState, cardTestScheduleCommand=cardTestScheduleCommand, diskVolumeNumber=diskVolumeNumber, cardName=cardName, shelfObjects=shelfObjects, cardDetectedChange=cardDetectedChange, trapSeverity=trapSeverity, cardPicSerialNum=cardPicSerialNum, portMode=portMode, diskVolumeDriveId=diskVolumeDriveId, cmVendor=cmVendor, cardSpareGroupId=cardSpareGroupId, equipmentStateGroup=equipmentStateGroup, TestResult=TestResult, portConnectorId=portConnectorId, cardCarrierSerialNum=cardCarrierSerialNum, cardFwVersion=cardFwVersion, equipmentTraps=equipmentTraps, portSecStateChange=portSecStateChange, portDescription=portDescription, cardTestDescription=cardTestDescription, equipmentAudit=equipmentAudit, consoleOutput=consoleOutput, diskVolumeUsageLevel=diskVolumeUsageLevel, cardTemperatureHighWarn=cardTemperatureHighWarn, cardTestId=cardTestId, cardTestIndex=cardTestIndex, cardDetected=cardDetected, cardSubType=cardSubType, portDplxStatus=portDplxStatus, portMinDsPower=portMinDsPower, diskVolumeName=diskVolumeName, portMacIfIndex=portMacIfIndex, cardTestCommand=cardTestCommand, cardPicDetected=cardPicDetected, portBgpId=portBgpId, portDocsIfIndex=portDocsIfIndex, cardTestEntry=cardTestEntry, TestId=TestId, auditAutoScheduling=auditAutoScheduling, verboseLevel=verboseLevel, diskVolumeTrapInh=diskVolumeTrapInh, cardCpuSpeed=cardCpuSpeed, auditPassedCount=auditPassedCount, portMaxDsPower=portMaxDsPower, auditName=auditName, auditTotalPassedCount=auditTotalPassedCount, cardType=cardType, cmUChannelID=cmUChannelID, cardHwVersion=cardHwVersion, cardLastBootVersion=cardLastBootVersion, cardSpareGroupMode=cardSpareGroupMode, cardBootVersion=cardBootVersion, downstreamPowerLoss=downstreamPowerLoss, shelfNumber=shelfNumber, diskVolumeShelfId=diskVolumeShelfId, cardTable=cardTable)
