...
mibBuilder.exportSymbols("SAF-IPRADIO", radioRxFrequency=radioRxFrequency, modemModulation=modemModulation, vlanNumber=vlanNumber, modemErroredSecondRatio=modemErroredSecondRatio, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXMulticasts=ethTXMulticasts, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemBandwith=modemBandwith, writeConfig=writeConfig, localIpMask=localIpMask, ipRadioStatEth=ipRadioStatEth, ethQOSRXQ2Frames=ethQOSRXQ2Frames, loopbacks=loopbacks, radioEntry=radioEntry, modemE1T1ChannelMask=modemE1T1ChannelMask, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemErroredBlock=modemErroredBlock, radioRxLevel=radioRxLevel, modemACMethernetCapacity=modemACMethernetCapacity, vlanEntry=vlanEntry, ethRXDvEvent=ethRXDvEvent, modemGeneralStatus=modemGeneralStatus, e1t1StatTable=e1t1StatTable, modemRadialMSE=modemRadialMSE, e1t1AIS=e1t1AIS, microwaveRadio=microwaveRadio, localIp=localIp, remoteIp=remoteIp, radioTxPower=radioTxPower, ethRXLongEvents=ethRXLongEvents, modemUnavailtime=modemUnavailtime, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXBackpresEvents=ethTXBackpresEvents, license=license, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioSide=radioSide, ethQOSTXFrames=ethQOSTXFrames, restartcpu=restartcpu, modemLastAcqError=modemLastAcqError, ethRXDones=ethRXDones, modemCountTime=modemCountTime, ethRXPauseFrames=ethRXPauseFrames, licenseMask=licenseMask, ethTXCollisions=ethTXCollisions, modemE1T1Channels=modemE1T1Channels, ethTXVlanTags=ethTXVlanTags, modemTotalCapacity=modemTotalCapacity, modemRowStatus=modemRowStatus, vlansEnabled=vlansEnabled, ethGFPDelineationErrors=ethGFPDelineationErrors, modemUptime=modemUptime, ethRXPrevPktDropped=ethRXPrevPktDropped, modemIndex=modemIndex, ethRXControlFrames=ethRXControlFrames, modemACMmodulationMin=modemACMmodulationMin, ethTXWireByteCounterLow=ethTXWireByteCounterLow, vlanPortmap=vlanPortmap, vlanRowStatus=vlanRowStatus, ethTXGiants=ethTXGiants, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXLateCollisions=ethTXLateCollisions, ethRXMulticasts=ethRXMulticasts, modemCarrierOffset=modemCarrierOffset, ethRXBroadcasts=ethRXBroadcasts, modemTable=modemTable, e1t1StatEntry=e1t1StatEntry, modemACMmodulationMax=modemACMmodulationMax, ipRadioCfgGeneral=ipRadioCfgGeneral, ethGFPDropedFrames=ethGFPDropedFrames, ethRXByteCounterLow=ethRXByteCounterLow, ethTXCRCErrors=ethTXCRCErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, ethGFPFCSErrors=ethGFPFCSErrors, modemSymbolRateTx=modemSymbolRateTx, modemStatistics=modemStatistics, modemLDPCdecoderStress=modemLDPCdecoderStress, modemSymbolRateRx=modemSymbolRateRx, ethGFPCHECErrors=ethGFPCHECErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, modemErroredSecond=modemErroredSecond, product=product, atpcEnabled=atpcEnabled, radioDuplexShift=radioDuplexShift, sysTemperature=sysTemperature, radioTxMute=radioTxMute, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlanPortType=vlanPortType, ethTXMaxCollisions=ethTXMaxCollisions, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXByteCounterHi=ethTXByteCounterHi, radioTable=radioTable, e1t1LOS=e1t1LOS, tehnika=tehnika, modemTotalBlockNumber=modemTotalBlockNumber, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemEntry=modemEntry, radioLoopback=radioLoopback, ethRXByteCounterHi=ethRXByteCounterHi, ethRXCRCErrors=ethRXCRCErrors, licenseUpdateStatus=licenseUpdateStatus, ethTXByteCounterLow=ethTXByteCounterLow, vlanCfgStat=vlanCfgStat, radioTxFrequency=radioTxFrequency, safip=safip, ethRXCodeErrors=ethRXCodeErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXWireByteCounterHi=ethTXWireByteCounterHi, vlanFid=vlanFid, e1t1ChannelNr=e1t1ChannelNr, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, vlanTable=vlanTable, modemACMtotalCapacity=modemACMtotalCapacity, modemStandard=modemStandard, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemEthernetCapacity=modemEthernetCapacity, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemInternalAGCgain=modemInternalAGCgain, pointToPoint=pointToPoint, ethTXControlFrames=ethTXControlFrames, modemACMengine=modemACMengine, ethTXDones=ethTXDones, saf=saf, modemAcqStatus=modemAcqStatus, loopback_tributary_mask=loopback_tributary_mask, ipRadioMgmt=ipRadioMgmt, ethTXUnderruns=ethTXUnderruns, ethTXBroadcasts=ethTXBroadcasts, atpcIndex=atpcIndex, radioIndex=radioIndex, ipRadio=ipRadio, atpcTxPowerCorrection=atpcTxPowerCorrection, aTPCEntry=aTPCEntry, ethRXDribleNibbles=ethRXDribleNibbles, radioGenStatus=radioGenStatus, hostname=hostname, ipRadioStat=ipRadioStat, ipRadioCfg=ipRadioCfg, sysDateAndTime=sysDateAndTime, ethQOSTXDropped=ethQOSTXDropped, aTPCTable=aTPCTable, ethTXPauseFrames=ethTXPauseFrames, description=description)
