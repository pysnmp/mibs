...
mibBuilder.exportSymbols("SAF-IPRADIO", modemIndex=modemIndex, ethTXDones=ethTXDones, radioGenStatus=radioGenStatus, pointToPoint=pointToPoint, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadioMgmt=ipRadioMgmt, radioEntry=radioEntry, ethGFPDropedFrames=ethGFPDropedFrames, modemEthernetCapacity=modemEthernetCapacity, modemACMmodulationMax=modemACMmodulationMax, modemE1T1ChannelMask=modemE1T1ChannelMask, ethGFPFCSErrors=ethGFPFCSErrors, radioTable=radioTable, saf=saf, vlanCfgStat=vlanCfgStat, modemTable=modemTable, modemCarrierOffset=modemCarrierOffset, modemACMengine=modemACMengine, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXCRCErrors=ethTXCRCErrors, radioTxPower=radioTxPower, modemE1T1Channels=modemE1T1Channels, modemTotalCapacity=modemTotalCapacity, modemACMethernetCapacity=modemACMethernetCapacity, vlanFid=vlanFid, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, description=description, modemErroredBlock=modemErroredBlock, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioSide=radioSide, ethRXLongEvents=ethRXLongEvents, ethTXGiants=ethTXGiants, license=license, modemACMtotalCapacity=modemACMtotalCapacity, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioIndex=radioIndex, radioTxMute=radioTxMute, ethTXByteCounterLow=ethTXByteCounterLow, radioRxLevel=radioRxLevel, product=product, radioLoopback=radioLoopback, ethTXVlanTags=ethTXVlanTags, modemGeneralStatus=modemGeneralStatus, ipRadioStat=ipRadioStat, ethTXMulticasts=ethTXMulticasts, ipRadio=ipRadio, ipRadioStatEth=ipRadioStatEth, radioRxFrequency=radioRxFrequency, modemACMmodulationMin=modemACMmodulationMin, localIp=localIp, ethGFPCHECErrors=ethGFPCHECErrors, radioDuplexShift=radioDuplexShift, localIpMask=localIpMask, modemErroredSecond=modemErroredSecond, ethTXByteCounterHi=ethTXByteCounterHi, hostname=hostname, modemBandwith=modemBandwith, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, atpcIndex=atpcIndex, modemSymbolRateRx=modemSymbolRateRx, licenseMask=licenseMask, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXExcessiveDefers=ethTXExcessiveDefers, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemUptime=modemUptime, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXByteCounterLow=ethRXByteCounterLow, modemRowStatus=modemRowStatus, ethQOSTXDropped=ethQOSTXDropped, atpcTxPowerCorrection=atpcTxPowerCorrection, modemTotalBlockNumber=modemTotalBlockNumber, ethQOSTXFrames=ethQOSTXFrames, e1t1AIS=e1t1AIS, aTPCEntry=aTPCEntry, vlanEntry=vlanEntry, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemLastAcqError=modemLastAcqError, ethTXUnderruns=ethTXUnderruns, vlanRowStatus=vlanRowStatus, modemModulation=modemModulation, ipRadioCfgNetwork=ipRadioCfgNetwork, loopback_tributary_mask=loopback_tributary_mask, ethRXBroadcasts=ethRXBroadcasts, e1t1LOS=e1t1LOS, ethRXDvEvent=ethRXDvEvent, modemUnavailtime=modemUnavailtime, restartcpu=restartcpu, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemStandard=modemStandard, aTPCTable=aTPCTable, modemLDPCdecoderStress=modemLDPCdecoderStress, tehnika=tehnika, loopbacks=loopbacks, modemStatistics=modemStatistics, safip=safip, ethRXControlFrames=ethRXControlFrames, modemSymbolRateTx=modemSymbolRateTx, licenseUpdateStatus=licenseUpdateStatus, modemEntry=modemEntry, microwaveRadio=microwaveRadio, modemCountTime=modemCountTime, e1t1StatTable=e1t1StatTable, remoteIp=remoteIp, vlanPortmap=vlanPortmap, ethTXBroadcasts=ethTXBroadcasts, sysTemperature=sysTemperature, ethRXDones=ethRXDones, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXCollisions=ethTXCollisions, modemErroredSecondRatio=modemErroredSecondRatio, ethTXWireByteCounterLow=ethTXWireByteCounterLow, atpcEnabled=atpcEnabled, modemRadialMSE=modemRadialMSE, ethTXMaxCollisions=ethTXMaxCollisions, e1t1ChannelNr=e1t1ChannelNr, ethRXMulticasts=ethRXMulticasts, ethRXByteCounterHi=ethRXByteCounterHi, vlanPortType=vlanPortType, ethTXBackpresEvents=ethTXBackpresEvents, ethTXPauseFrames=ethTXPauseFrames, ethTXControlFrames=ethTXControlFrames, vlanTable=vlanTable, ethRXDribleNibbles=ethRXDribleNibbles, ethRXCodeErrors=ethRXCodeErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXCRCErrors=ethRXCRCErrors, ethTXLateCollisions=ethTXLateCollisions, ipRadioCfg=ipRadioCfg, sysDateAndTime=sysDateAndTime, vlanNumber=vlanNumber, ipRadioCfgGeneral=ipRadioCfgGeneral, modemInternalAGCgain=modemInternalAGCgain, vlansEnabled=vlansEnabled, e1t1StatEntry=e1t1StatEntry, writeConfig=writeConfig, radioTxFrequency=radioTxFrequency, ethRXPauseFrames=ethRXPauseFrames, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXTruncatedFrames=ethRXTruncatedFrames, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemAcqStatus=modemAcqStatus)
