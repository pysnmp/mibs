...
mibBuilder.exportSymbols("SAF-IPRADIO", atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXPrevPktDropped=ethRXPrevPktDropped, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ipRadio=ipRadio, licenseUpdateStatus=licenseUpdateStatus, aTPCTable=aTPCTable, ethRXControlFrames=ethRXControlFrames, safip=safip, modemRowStatus=modemRowStatus, ethTXExcessiveDefers=ethTXExcessiveDefers, modemSymbolRateRx=modemSymbolRateRx, vlansEnabled=vlansEnabled, ethRXByteCounterLow=ethRXByteCounterLow, vlanFid=vlanFid, ethTXMulticasts=ethTXMulticasts, ethQOSRXQ2Frames=ethQOSRXQ2Frames, loopback_tributary_mask=loopback_tributary_mask, ethRXPauseFrames=ethRXPauseFrames, loopbacks=loopbacks, ethTXMaxCollisions=ethTXMaxCollisions, sysDateAndTime=sysDateAndTime, microwaveRadio=microwaveRadio, e1t1StatEntry=e1t1StatEntry, e1t1LOS=e1t1LOS, radioEntry=radioEntry, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXLengthCheckErrors=ethTXLengthCheckErrors, aTPCEntry=aTPCEntry, radioDuplexShift=radioDuplexShift, license=license, radioSide=radioSide, modemTable=modemTable, modemErroredSecond=modemErroredSecond, ethRXDones=ethRXDones, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ipRadioMgmt=ipRadioMgmt, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemBandwith=modemBandwith, vlanPortmap=vlanPortmap, modemUptime=modemUptime, vlanRowStatus=vlanRowStatus, ethRXCodeErrors=ethRXCodeErrors, ethTXBackpresEvents=ethTXBackpresEvents, ethGFPDropedFrames=ethGFPDropedFrames, vlanCfgStat=vlanCfgStat, ethRXByteCounterHi=ethRXByteCounterHi, atpcIndex=atpcIndex, e1t1ChannelNr=e1t1ChannelNr, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ipRadioCfg=ipRadioCfg, description=description, ethRXCRCErrors=ethRXCRCErrors, modemLDPCdecoderStress=modemLDPCdecoderStress, modemEntry=modemEntry, modemIndex=modemIndex, remoteIp=remoteIp, restartcpu=restartcpu, radioTxFrequency=radioTxFrequency, licenseMask=licenseMask, vlanNumber=vlanNumber, ipRadioStat=ipRadioStat, radioTxPower=radioTxPower, modemStandard=modemStandard, ethTXControlFrames=ethTXControlFrames, ethRXDvEvent=ethRXDvEvent, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXMulticasts=ethRXMulticasts, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, localIpMask=localIpMask, radioGenStatus=radioGenStatus, modemInternalAGCgain=modemInternalAGCgain, ethTXDones=ethTXDones, modemLastAcqError=modemLastAcqError, tehnika=tehnika, ethTXByteCounterHi=ethTXByteCounterHi, modemTotalBlockNumber=modemTotalBlockNumber, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXPauseFrames=ethTXPauseFrames, ethQOSTXDropped=ethQOSTXDropped, ethGFPFCSErrors=ethGFPFCSErrors, modemACMengine=modemACMengine, modemEthernetCapacity=modemEthernetCapacity, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemGeneralStatus=modemGeneralStatus, vlanPortType=vlanPortType, modemErroredSecondRatio=modemErroredSecondRatio, modemCountTime=modemCountTime, saf=saf, radioIndex=radioIndex, radioTable=radioTable, modemAcqStatus=modemAcqStatus, ethRXDribleNibbles=ethRXDribleNibbles, ethTXVlanTags=ethTXVlanTags, ethTXUnderruns=ethTXUnderruns, modemE1T1Channels=modemE1T1Channels, e1t1StatTable=e1t1StatTable, sysTemperature=sysTemperature, modemTotalCapacity=modemTotalCapacity, radioRxFrequency=radioRxFrequency, ethRXTruncatedFrames=ethRXTruncatedFrames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, vlanTable=vlanTable, ethTXLateCollisions=ethTXLateCollisions, pointToPoint=pointToPoint, e1t1AIS=e1t1AIS, atpcEnabled=atpcEnabled, modemErroredBlock=modemErroredBlock, modemSymbolRateTx=modemSymbolRateTx, hostname=hostname, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, writeConfig=writeConfig, ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlanEntry=vlanEntry, radioLoopback=radioLoopback, modemStatistics=modemStatistics, ethGFPCHECErrors=ethGFPCHECErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXLongEvents=ethRXLongEvents, radioTxMute=radioTxMute, ethTXByteCounterLow=ethTXByteCounterLow, ethQOSTXFrames=ethQOSTXFrames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, localIp=localIp, modemACMmodulationMax=modemACMmodulationMax, modemCarrierOffset=modemCarrierOffset, modemRadialMSE=modemRadialMSE, ethTXCRCErrors=ethTXCRCErrors, ethTXGiants=ethTXGiants, ipRadioStatEth=ipRadioStatEth, modemUnavailtime=modemUnavailtime, modemACMtotalCapacity=modemACMtotalCapacity, ipRadioCfgNetwork=ipRadioCfgNetwork, modemACMethernetCapacity=modemACMethernetCapacity, ethTXBroadcasts=ethTXBroadcasts, radioRxLevel=radioRxLevel, modemACMmodulationMin=modemACMmodulationMin, product=product, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXBroadcasts=ethRXBroadcasts, ethTXCollisions=ethTXCollisions, modemModulation=modemModulation)
