...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXPauseFrames=ethTXPauseFrames, e1t1AIS=e1t1AIS, ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadioCfgGeneral=ipRadioCfgGeneral, modemTable=modemTable, ethTXControlFrames=ethTXControlFrames, radioRxLevel=radioRxLevel, safip=safip, modemUptime=modemUptime, atpcEnabled=atpcEnabled, radioSide=radioSide, modemInternalAGCgain=modemInternalAGCgain, modemCarrierOffset=modemCarrierOffset, licenseUpdateStatus=licenseUpdateStatus, modemLastAcqError=modemLastAcqError, ipRadioCfg=ipRadioCfg, ethQOSTXFrames=ethQOSTXFrames, ethTXGiants=ethTXGiants, modemStatistics=modemStatistics, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXByteCounterLow=ethTXByteCounterLow, modemACMengine=modemACMengine, vlanCfgStat=vlanCfgStat, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemCountTime=modemCountTime, ethTXLengthCheckErrors=ethTXLengthCheckErrors, atpcTxPowerCorrection=atpcTxPowerCorrection, modemSymbolRateTx=modemSymbolRateTx, modemIndex=modemIndex, saf=saf, modemACMmodulationMax=modemACMmodulationMax, loopbacks=loopbacks, ethRXPauseFrames=ethRXPauseFrames, sysTemperature=sysTemperature, ethRXDribleNibbles=ethRXDribleNibbles, ethGFPDropedFrames=ethGFPDropedFrames, ethGFPCHECErrors=ethGFPCHECErrors, modemErroredSecondRatio=modemErroredSecondRatio, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXByteCounterHi=ethRXByteCounterHi, ethGFPFCSErrors=ethGFPFCSErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, e1t1ChannelNr=e1t1ChannelNr, ethTXWireByteCounterLow=ethTXWireByteCounterLow, pointToPoint=pointToPoint, atpcIndex=atpcIndex, ethTXCollisions=ethTXCollisions, vlanRowStatus=vlanRowStatus, ipRadioMgmt=ipRadioMgmt, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemE1T1Channels=modemE1T1Channels, radioTxMute=radioTxMute, ethRXBroadcasts=ethRXBroadcasts, vlanPortmap=vlanPortmap, localIpMask=localIpMask, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, product=product, e1t1LOS=e1t1LOS, localIp=localIp, ethTXVlanTags=ethTXVlanTags, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXCRCErrors=ethRXCRCErrors, license=license, vlansEnabled=vlansEnabled, ipRadioCfgNetwork=ipRadioCfgNetwork, vlanTable=vlanTable, ethRXMulticasts=ethRXMulticasts, ethRXDones=ethRXDones, modemE1T1ChannelMask=modemE1T1ChannelMask, modemRadialMSE=modemRadialMSE, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemACMethernetCapacity=modemACMethernetCapacity, radioTable=radioTable, modemBandwith=modemBandwith, modemErroredSecond=modemErroredSecond, licenseMask=licenseMask, ethRXControlFrames=ethRXControlFrames, radioDuplexShift=radioDuplexShift, modemAcqStatus=modemAcqStatus, ethTXMulticasts=ethTXMulticasts, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXByteCounterLow=ethRXByteCounterLow, radioGenStatus=radioGenStatus, aTPCEntry=aTPCEntry, ethTXCRCErrors=ethTXCRCErrors, ethTXUnderruns=ethTXUnderruns, radioEntry=radioEntry, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXDvEvent=ethRXDvEvent, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemEntry=modemEntry, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemTotalCapacity=modemTotalCapacity, modemTotalBlockNumber=modemTotalBlockNumber, modemStandard=modemStandard, e1t1StatTable=e1t1StatTable, vlanNumber=vlanNumber, ipRadioStatEth=ipRadioStatEth, modemEthernetCapacity=modemEthernetCapacity, ethRXLongEvents=ethRXLongEvents, ethTXByteCounterHi=ethTXByteCounterHi, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ipRadioStat=ipRadioStat, modemModulation=modemModulation, vlanFid=vlanFid, ethQOSTXDropped=ethQOSTXDropped, vlanPortType=vlanPortType, description=description, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXCodeErrors=ethRXCodeErrors, modemACMmodulationMin=modemACMmodulationMin, ethRXPrevPktDropped=ethRXPrevPktDropped, modemACMtotalCapacity=modemACMtotalCapacity, radioTxFrequency=radioTxFrequency, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioIndex=radioIndex, restartcpu=restartcpu, modemErroredBlock=modemErroredBlock, ethTXBackpresEvents=ethTXBackpresEvents, writeConfig=writeConfig, radioLoopback=radioLoopback, ethTXBroadcasts=ethTXBroadcasts, hostname=hostname, modemGeneralStatus=modemGeneralStatus, ethTXMaxCollisions=ethTXMaxCollisions, aTPCTable=aTPCTable, loopback_tributary_mask=loopback_tributary_mask, radioRxFrequency=radioRxFrequency, modemSymbolRateRx=modemSymbolRateRx, tehnika=tehnika, modemRowStatus=modemRowStatus, e1t1StatEntry=e1t1StatEntry, radioTxPower=radioTxPower, ipRadio=ipRadio, remoteIp=remoteIp, ethTXExcessiveDefers=ethTXExcessiveDefers, microwaveRadio=microwaveRadio, vlanEntry=vlanEntry, ethTXLateCollisions=ethTXLateCollisions, modemUnavailtime=modemUnavailtime, sysDateAndTime=sysDateAndTime, ethTXDones=ethTXDones, ethRXVlanTagsDetected=ethRXVlanTagsDetected)
