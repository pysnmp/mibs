...
mibBuilder.exportSymbols("SAF-IPRADIO", modemErroredBlock=modemErroredBlock, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemGeneralStatus=modemGeneralStatus, ethRXDribleNibbles=ethRXDribleNibbles, ethTXBroadcasts=ethTXBroadcasts, radioLoopback=radioLoopback, ethRXMulticasts=ethRXMulticasts, description=description, ethRXPrevPktDropped=ethRXPrevPktDropped, e1t1StatTable=e1t1StatTable, ethGFPDropedFrames=ethGFPDropedFrames, modemCountTime=modemCountTime, modemBandwith=modemBandwith, vlanRowStatus=vlanRowStatus, sysDateAndTime=sysDateAndTime, ethRXByteCounterLow=ethRXByteCounterLow, radioRxFrequency=radioRxFrequency, modemSymbolRateRx=modemSymbolRateRx, modemLastAcqError=modemLastAcqError, ipRadioCfgNetwork=ipRadioCfgNetwork, license=license, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXDones=ethRXDones, ethRXByteCounterHi=ethRXByteCounterHi, ipRadioCfg=ipRadioCfg, tehnika=tehnika, saf=saf, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemACMmodulationMin=modemACMmodulationMin, ethTXMaxCollisions=ethTXMaxCollisions, ethTXControlFrames=ethTXControlFrames, e1t1StatEntry=e1t1StatEntry, ethTXByteCounterLow=ethTXByteCounterLow, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, vlanFid=vlanFid, radioRxLevel=radioRxLevel, atpcIndex=atpcIndex, modemAcqStatus=modemAcqStatus, modemTable=modemTable, sysTemperature=sysTemperature, modemEthernetCapacity=modemEthernetCapacity, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlanCfgStat=vlanCfgStat, modemACMengine=modemACMengine, ethTXVlanTags=ethTXVlanTags, modemErroredSecond=modemErroredSecond, modemACMmodulationMax=modemACMmodulationMax, localIp=localIp, aTPCEntry=aTPCEntry, ethRXPauseFrames=ethRXPauseFrames, modemIndex=modemIndex, ethGFPDelineationErrors=ethGFPDelineationErrors, e1t1LOS=e1t1LOS, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, microwaveRadio=microwaveRadio, modemUptime=modemUptime, ethRXDvEvent=ethRXDvEvent, radioTxMute=radioTxMute, modemErroredSecondRatio=modemErroredSecondRatio, atpcTxPowerCorrection=atpcTxPowerCorrection, vlansEnabled=vlansEnabled, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethQOSTXDropped=ethQOSTXDropped, restartcpu=restartcpu, ethTXUnderruns=ethTXUnderruns, modemStandard=modemStandard, modemSymbolRateTx=modemSymbolRateTx, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemTotalCapacity=modemTotalCapacity, ethTXWireByteCounterLow=ethTXWireByteCounterLow, vlanEntry=vlanEntry, modemRowStatus=modemRowStatus, ethTXMulticasts=ethTXMulticasts, ethRXLongEvents=ethRXLongEvents, safip=safip, ethTXPauseFrames=ethTXPauseFrames, radioSide=radioSide, ethRXTruncatedFrames=ethRXTruncatedFrames, modemLDPCdecoderStress=modemLDPCdecoderStress, ethGFPCHECErrors=ethGFPCHECErrors, radioGenStatus=radioGenStatus, ethRXControlFrames=ethRXControlFrames, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethQOSRXQ1Frames=ethQOSRXQ1Frames, e1t1AIS=e1t1AIS, radioDuplexShift=radioDuplexShift, vlanTable=vlanTable, ethGFPFCSErrors=ethGFPFCSErrors, vlanPortmap=vlanPortmap, ethTXLateCollisions=ethTXLateCollisions, localIpMask=localIpMask, vlanNumber=vlanNumber, ethTXCollisions=ethTXCollisions, writeConfig=writeConfig, ipRadioStat=ipRadioStat, ipRadio=ipRadio, radioEntry=radioEntry, radioIndex=radioIndex, ethTXByteCounterHi=ethTXByteCounterHi, modemCarrierOffset=modemCarrierOffset, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemRadialMSE=modemRadialMSE, modemTotalBlockNumber=modemTotalBlockNumber, modemUnavailtime=modemUnavailtime, radioTxFrequency=radioTxFrequency, ipRadioStatEth=ipRadioStatEth, ethTXGiants=ethTXGiants, ipRadioCfgGeneral=ipRadioCfgGeneral, modemE1T1Channels=modemE1T1Channels, pointToPoint=pointToPoint, hostname=hostname, modemModulation=modemModulation, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, licenseUpdateStatus=licenseUpdateStatus, ethTXDones=ethTXDones, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemStatistics=modemStatistics, e1t1ChannelNr=e1t1ChannelNr, radioTable=radioTable, ethTXBackpresEvents=ethTXBackpresEvents, ethQOSTXFrames=ethQOSTXFrames, remoteIp=remoteIp, ipRadioMgmt=ipRadioMgmt, loopbacks=loopbacks, radioTxPower=radioTxPower, modemEntry=modemEntry, atpcEnabled=atpcEnabled, modemACMtotalCapacity=modemACMtotalCapacity, licenseMask=licenseMask, vlanPortType=vlanPortType, ethTXExcessiveDefers=ethTXExcessiveDefers, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXBroadcasts=ethRXBroadcasts, loopback_tributary_mask=loopback_tributary_mask, aTPCTable=aTPCTable, product=product, modemACMethernetCapacity=modemACMethernetCapacity, ethRXCRCErrors=ethRXCRCErrors, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemInternalAGCgain=modemInternalAGCgain, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXCRCErrors=ethTXCRCErrors, ethRXCodeErrors=ethRXCodeErrors)
