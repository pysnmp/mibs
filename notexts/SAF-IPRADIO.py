...
mibBuilder.exportSymbols("SAF-IPRADIO", atpcIndex=atpcIndex, loopback_tributary_mask=loopback_tributary_mask, ethRXCRCErrors=ethRXCRCErrors, radioTxMute=radioTxMute, radioTxFrequency=radioTxFrequency, aTPCEntry=aTPCEntry, e1t1LOS=e1t1LOS, ethQOSTXFrames=ethQOSTXFrames, ipRadioCfg=ipRadioCfg, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXTruncatedFrames=ethRXTruncatedFrames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethGFPDropedFrames=ethGFPDropedFrames, sysDateAndTime=sysDateAndTime, ethGFPDelineationErrors=ethGFPDelineationErrors, vlanNumber=vlanNumber, ethTXMulticasts=ethTXMulticasts, e1t1AIS=e1t1AIS, ipRadioCfgGeneral=ipRadioCfgGeneral, radioEntry=radioEntry, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, safip=safip, modemUnavailtime=modemUnavailtime, ethTXBackpresEvents=ethTXBackpresEvents, modemCountTime=modemCountTime, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, e1t1StatTable=e1t1StatTable, ethRXDvEvent=ethRXDvEvent, ethTXByteCounterHi=ethTXByteCounterHi, radioTable=radioTable, modemE1T1Channels=modemE1T1Channels, modemIndex=modemIndex, modemACMmodulationMin=modemACMmodulationMin, ethRXDribleNibbles=ethRXDribleNibbles, ethTXByteCounterLow=ethTXByteCounterLow, radioIndex=radioIndex, vlanFid=vlanFid, ethRXDones=ethRXDones, ethRXByteCounterHi=ethRXByteCounterHi, ipRadioStatEth=ipRadioStatEth, ethRXCodeErrors=ethRXCodeErrors, radioRxLevel=radioRxLevel, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemEthernetCapacity=modemEthernetCapacity, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemACMtotalCapacity=modemACMtotalCapacity, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemErroredSecond=modemErroredSecond, ethTXGiants=ethTXGiants, modemGeneralStatus=modemGeneralStatus, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXControlFrames=ethTXControlFrames, radioDuplexShift=radioDuplexShift, modemTable=modemTable, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXLateCollisions=ethTXLateCollisions, ethGFPCHECErrors=ethGFPCHECErrors, modemSymbolRateRx=modemSymbolRateRx, vlanEntry=vlanEntry, e1t1ChannelNr=e1t1ChannelNr, modemEntry=modemEntry, ipRadio=ipRadio, ethTXUnderruns=ethTXUnderruns, sysTemperature=sysTemperature, modemErroredBlock=modemErroredBlock, ethRXControlFrames=ethRXControlFrames, vlanPortType=vlanPortType, restartcpu=restartcpu, modemErroredSecondRatio=modemErroredSecondRatio, modemCarrierOffset=modemCarrierOffset, description=description, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXExcessiveDefers=ethTXExcessiveDefers, product=product, modemLastAcqError=modemLastAcqError, modemModulation=modemModulation, modemTotalCapacity=modemTotalCapacity, modemLDPCdecoderStress=modemLDPCdecoderStress, modemTotalBlockNumber=modemTotalBlockNumber, ethRXMulticasts=ethRXMulticasts, writeConfig=writeConfig, saf=saf, ethRXBroadcasts=ethRXBroadcasts, modemACMmodulationMax=modemACMmodulationMax, modemACMengine=modemACMengine, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethQOSTXDropped=ethQOSTXDropped, vlanPortmap=vlanPortmap, ethRXPauseFrames=ethRXPauseFrames, ethTXDones=ethTXDones, radioSide=radioSide, modemBandwith=modemBandwith, atpcEnabled=atpcEnabled, modemInternalAGCgain=modemInternalAGCgain, microwaveRadio=microwaveRadio, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethGFPFCSErrors=ethGFPFCSErrors, vlanCfgStat=vlanCfgStat, vlanRowStatus=vlanRowStatus, loopbacks=loopbacks, license=license, localIp=localIp, ethTXMaxCollisions=ethTXMaxCollisions, ethTXCollisions=ethTXCollisions, radioGenStatus=radioGenStatus, radioRxFrequency=radioRxFrequency, radioTxPower=radioTxPower, modemRadialMSE=modemRadialMSE, tehnika=tehnika, modemSymbolRateTx=modemSymbolRateTx, e1t1StatEntry=e1t1StatEntry, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXCRCErrors=ethTXCRCErrors, ethTXVlanTags=ethTXVlanTags, modemStandard=modemStandard, modemStatistics=modemStatistics, ipRadioStat=ipRadioStat, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemAcqStatus=modemAcqStatus, ethRXLongEvents=ethRXLongEvents, ipRadioMgmt=ipRadioMgmt, licenseMask=licenseMask, ethRXByteCounterLow=ethRXByteCounterLow, vlanTable=vlanTable, localIpMask=localIpMask, licenseUpdateStatus=licenseUpdateStatus, ethTXBroadcasts=ethTXBroadcasts, pointToPoint=pointToPoint, ethRXPrevPktDropped=ethRXPrevPktDropped, radioLoopback=radioLoopback, modemUptime=modemUptime, modemRowStatus=modemRowStatus, aTPCTable=aTPCTable, remoteIp=remoteIp, modemACMethernetCapacity=modemACMethernetCapacity, ethTXPauseFrames=ethTXPauseFrames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, vlansEnabled=vlansEnabled, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, hostname=hostname)
