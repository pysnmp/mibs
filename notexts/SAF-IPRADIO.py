...
mibBuilder.exportSymbols("SAF-IPRADIO", modemIndex=modemIndex, modemModulation=modemModulation, modemEthernetCapacity=modemEthernetCapacity, modemStatistics=modemStatistics, atpcTxPowerCorrection=atpcTxPowerCorrection, radioTable=radioTable, modemErroredSecondRatio=modemErroredSecondRatio, ethTXExcessiveDefers=ethTXExcessiveDefers, modemInternalAGCgain=modemInternalAGCgain, ethTXBroadcasts=ethTXBroadcasts, modemErroredSecond=modemErroredSecond, ethQOSTXFrames=ethQOSTXFrames, modemLastAcqError=modemLastAcqError, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, sysDateAndTime=sysDateAndTime, ethTXGiants=ethTXGiants, vlanEntry=vlanEntry, product=product, atpcIndex=atpcIndex, radioTxMute=radioTxMute, ethTXControlFrames=ethTXControlFrames, modemACMethernetCapacity=modemACMethernetCapacity, ethTXByteCounterLow=ethTXByteCounterLow, ethTXUnderruns=ethTXUnderruns, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXByteCounterHi=ethRXByteCounterHi, e1t1StatTable=e1t1StatTable, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioEntry=radioEntry, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXPauseFrames=ethTXPauseFrames, ethTXCRCErrors=ethTXCRCErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, ethGFPCHECErrors=ethGFPCHECErrors, aTPCEntry=aTPCEntry, ethTXBackpresEvents=ethTXBackpresEvents, saf=saf, ethRXControlFrames=ethRXControlFrames, modemUnavailtime=modemUnavailtime, vlanPortmap=vlanPortmap, vlanPortType=vlanPortType, ethGFPDelineationErrors=ethGFPDelineationErrors, licenseUpdateStatus=licenseUpdateStatus, modemBandwith=modemBandwith, modemErroredBlock=modemErroredBlock, localIpMask=localIpMask, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ipRadio=ipRadio, radioTxPower=radioTxPower, radioLoopback=radioLoopback, license=license, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXDribleNibbles=ethRXDribleNibbles, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemSymbolRateRx=modemSymbolRateRx, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlanTable=vlanTable, modemUptime=modemUptime, remoteIp=remoteIp, ipRadioMgmt=ipRadioMgmt, writeConfig=writeConfig, ethRXMulticasts=ethRXMulticasts, ethRXCodeErrors=ethRXCodeErrors, radioRxFrequency=radioRxFrequency, ethRXPauseFrames=ethRXPauseFrames, loopback_tributary_mask=loopback_tributary_mask, modemLDPCdecoderStress=modemLDPCdecoderStress, microwaveRadio=microwaveRadio, ethTXByteCounterHi=ethTXByteCounterHi, licenseMask=licenseMask, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemE1T1Channels=modemE1T1Channels, radioIndex=radioIndex, description=description, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, e1t1AIS=e1t1AIS, radioGenStatus=radioGenStatus, modemCarrierOffset=modemCarrierOffset, vlanRowStatus=vlanRowStatus, radioDuplexShift=radioDuplexShift, modemStandard=modemStandard, modemTotalCapacity=modemTotalCapacity, ipRadioStat=ipRadioStat, ethRXLongEvents=ethRXLongEvents, modemE1T1ChannelMask=modemE1T1ChannelMask, modemRowStatus=modemRowStatus, ethRXBroadcasts=ethRXBroadcasts, modemSymbolRateTx=modemSymbolRateTx, hostname=hostname, modemEntry=modemEntry, ethGFPDropedFrames=ethGFPDropedFrames, ethRXDvEvent=ethRXDvEvent, safip=safip, ipRadioStatEth=ipRadioStatEth, atpcEnabled=atpcEnabled, ethGFPFCSErrors=ethGFPFCSErrors, ethQOSTXDropped=ethQOSTXDropped, ethRXVlanTagsDetected=ethRXVlanTagsDetected, aTPCTable=aTPCTable, localIp=localIp, modemACMmodulationMin=modemACMmodulationMin, ipRadioCfg=ipRadioCfg, e1t1ChannelNr=e1t1ChannelNr, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemACMtotalCapacity=modemACMtotalCapacity, restartcpu=restartcpu, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioSide=radioSide, ethTXVlanTags=ethTXVlanTags, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, loopbacks=loopbacks, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXUnsupOpcodes=ethRXUnsupOpcodes, e1t1LOS=e1t1LOS, modemACMmodulationMax=modemACMmodulationMax, sysTemperature=sysTemperature, modemTable=modemTable, vlanFid=vlanFid, ethTXMulticasts=ethTXMulticasts, tehnika=tehnika, ethTXDones=ethTXDones, modemRadialMSE=modemRadialMSE, modemACMengine=modemACMengine, modemAcqStatus=modemAcqStatus, ethTXCollisions=ethTXCollisions, modemTotalBlockNumber=modemTotalBlockNumber, ethRXCRCErrors=ethRXCRCErrors, ethRXByteCounterLow=ethRXByteCounterLow, modemGeneralStatus=modemGeneralStatus, vlanNumber=vlanNumber, ethTXLateCollisions=ethTXLateCollisions, ethTXMaxCollisions=ethTXMaxCollisions, radioRxLevel=radioRxLevel, vlansEnabled=vlansEnabled, ethRXDones=ethRXDones, radioTxFrequency=radioTxFrequency, ethRXPrevPktDropped=ethRXPrevPktDropped, e1t1StatEntry=e1t1StatEntry, modemCountTime=modemCountTime, ipRadioCfgGeneral=ipRadioCfgGeneral, pointToPoint=pointToPoint, vlanCfgStat=vlanCfgStat)
