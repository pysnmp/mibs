...
mibBuilder.exportSymbols("SAF-IPRADIO", modemIndex=modemIndex, pointToPoint=pointToPoint, localIpMask=localIpMask, vlanCfgStat=vlanCfgStat, sysDateAndTime=sysDateAndTime, vlanTable=vlanTable, modemStandard=modemStandard, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ipRadioCfgGeneral=ipRadioCfgGeneral, restartcpu=restartcpu, ethTXLateCollisions=ethTXLateCollisions, e1t1LOS=e1t1LOS, ethGFPFCSErrors=ethGFPFCSErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlanNumber=vlanNumber, modemRowStatus=modemRowStatus, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, product=product, writeConfig=writeConfig, modemTotalCapacity=modemTotalCapacity, ethTXCRCErrors=ethTXCRCErrors, vlanPortType=vlanPortType, ethRXCodeErrors=ethRXCodeErrors, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, vlansEnabled=vlansEnabled, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemACMmodulationMin=modemACMmodulationMin, aTPCEntry=aTPCEntry, modemACMethernetCapacity=modemACMethernetCapacity, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemACMengine=modemACMengine, ethRXUnsupOpcodes=ethRXUnsupOpcodes, vlanPortmap=vlanPortmap, ipRadioMgmt=ipRadioMgmt, e1t1StatTable=e1t1StatTable, microwaveRadio=microwaveRadio, ethRXDvEvent=ethRXDvEvent, ethTXVlanTags=ethTXVlanTags, atpcIndex=atpcIndex, ethTXMulticasts=ethTXMulticasts, modemStatistics=modemStatistics, modemEntry=modemEntry, hostname=hostname, ethRXPrevPktDropped=ethRXPrevPktDropped, modemRadialMSE=modemRadialMSE, ethGFPDropedFrames=ethGFPDropedFrames, radioTxMute=radioTxMute, ethRXByteCounterLow=ethRXByteCounterLow, radioSide=radioSide, modemUnavailtime=modemUnavailtime, loopback_tributary_mask=loopback_tributary_mask, ethRXMulticasts=ethRXMulticasts, ethTXDones=ethTXDones, modemSymbolRateRx=modemSymbolRateRx, atpcTxPowerCorrection=atpcTxPowerCorrection, modemBandwith=modemBandwith, ethRXByteCounterHi=ethRXByteCounterHi, modemE1T1ChannelMask=modemE1T1ChannelMask, radioRxLevel=radioRxLevel, loopbacks=loopbacks, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXControlFrames=ethRXControlFrames, radioTxFrequency=radioTxFrequency, e1t1ChannelNr=e1t1ChannelNr, vlanRowStatus=vlanRowStatus, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemLastAcqError=modemLastAcqError, modemCountTime=modemCountTime, remoteIp=remoteIp, ipRadioStat=ipRadioStat, ethRXBroadcasts=ethRXBroadcasts, license=license, modemGeneralStatus=modemGeneralStatus, modemAcqStatus=modemAcqStatus, radioTable=radioTable, ethRXCRCErrors=ethRXCRCErrors, modemCarrierOffset=modemCarrierOffset, modemErroredSecondRatio=modemErroredSecondRatio, e1t1AIS=e1t1AIS, ethRXDones=ethRXDones, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXPauseFrames=ethRXPauseFrames, ethQOSTXFrames=ethQOSTXFrames, ethTXUnderruns=ethTXUnderruns, ipRadioCfgNetwork=ipRadioCfgNetwork, radioRxFrequency=radioRxFrequency, ethRXLongEvents=ethRXLongEvents, radioLoopback=radioLoopback, radioDuplexShift=radioDuplexShift, aTPCTable=aTPCTable, ethRXDribleNibbles=ethRXDribleNibbles, ethTXMaxCollisions=ethTXMaxCollisions, ethQOSTXDropped=ethQOSTXDropped, licenseUpdateStatus=licenseUpdateStatus, modemInternalAGCgain=modemInternalAGCgain, saf=saf, description=description, ipRadioCfg=ipRadioCfg, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemModulation=modemModulation, sysTemperature=sysTemperature, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioGenStatus=radioGenStatus, vlanEntry=vlanEntry, modemErroredBlock=modemErroredBlock, modemUptime=modemUptime, safip=safip, radioTxPower=radioTxPower, localIp=localIp, radioIndex=radioIndex, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadioStatEth=ipRadioStatEth, modemACMtotalCapacity=modemACMtotalCapacity, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXByteCounterHi=ethTXByteCounterHi, ethTXBroadcasts=ethTXBroadcasts, modemTotalBlockNumber=modemTotalBlockNumber, ethTXControlFrames=ethTXControlFrames, modemSymbolRateTx=modemSymbolRateTx, tehnika=tehnika, ethTXPauseFrames=ethTXPauseFrames, ethTXGiants=ethTXGiants, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXCollisions=ethTXCollisions, modemErroredSecond=modemErroredSecond, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioEntry=radioEntry, ipRadio=ipRadio, modemE1T1Channels=modemE1T1Channels, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemACMmodulationMax=modemACMmodulationMax, ethTXBackpresEvents=ethTXBackpresEvents, e1t1StatEntry=e1t1StatEntry, ethGFPCHECErrors=ethGFPCHECErrors, licenseMask=licenseMask, vlanFid=vlanFid, atpcEnabled=atpcEnabled, modemEthernetCapacity=modemEthernetCapacity, ethTXByteCounterLow=ethTXByteCounterLow, modemTable=modemTable)
