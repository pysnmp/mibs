...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXMaxCollisions=ethTXMaxCollisions, modemTotalCapacity=modemTotalCapacity, hostname=hostname, ipRadioCfg=ipRadioCfg, writeConfig=writeConfig, vlanPortType=vlanPortType, remoteIp=remoteIp, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemRowStatus=modemRowStatus, radioLoopback=radioLoopback, modemUnavailtime=modemUnavailtime, modemACMengine=modemACMengine, e1t1AIS=e1t1AIS, ethRXLongEvents=ethRXLongEvents, radioTxMute=radioTxMute, ethTXPauseFrames=ethTXPauseFrames, e1t1LOS=e1t1LOS, ipRadioStatEth=ipRadioStatEth, modemLastAcqError=modemLastAcqError, ethTXByteCounterLow=ethTXByteCounterLow, ethTXVlanTags=ethTXVlanTags, licenseMask=licenseMask, modemSeverelyErroredSecond=modemSeverelyErroredSecond, loopbacks=loopbacks, radioEntry=radioEntry, ethTXGiants=ethTXGiants, modemACMmodulationMin=modemACMmodulationMin, modemEthernetCapacity=modemEthernetCapacity, safip=safip, localIp=localIp, radioRxLevel=radioRxLevel, microwaveRadio=microwaveRadio, ethRXDones=ethRXDones, radioTable=radioTable, modemBandwith=modemBandwith, vlanEntry=vlanEntry, vlanFid=vlanFid, ethTXByteCounterHi=ethTXByteCounterHi, modemACMethernetCapacity=modemACMethernetCapacity, ipRadioCfgNetwork=ipRadioCfgNetwork, modemErroredSecondRatio=modemErroredSecondRatio, modemACMtotalCapacity=modemACMtotalCapacity, modemE1T1Channels=modemE1T1Channels, ethRXControlFrames=ethRXControlFrames, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethQOSTXDropped=ethQOSTXDropped, modemErroredSecond=modemErroredSecond, modemCarrierOffset=modemCarrierOffset, vlanPortmap=vlanPortmap, licenseUpdateStatus=licenseUpdateStatus, ethTXLengthCheckErrors=ethTXLengthCheckErrors, radioTxPower=radioTxPower, loopback_tributary_mask=loopback_tributary_mask, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXPauseFrames=ethRXPauseFrames, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ipRadioCfgGeneral=ipRadioCfgGeneral, ethGFPDropedFrames=ethGFPDropedFrames, radioIndex=radioIndex, e1t1StatEntry=e1t1StatEntry, ethRXPrevPktDropped=ethRXPrevPktDropped, modemCountTime=modemCountTime, vlansEnabled=vlansEnabled, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemErroredBlock=modemErroredBlock, ethRXTruncatedFrames=ethRXTruncatedFrames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXBroadcasts=ethRXBroadcasts, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioGenStatus=radioGenStatus, modemSymbolRateTx=modemSymbolRateTx, modemRadialMSE=modemRadialMSE, ethRXDvEvent=ethRXDvEvent, modemGeneralStatus=modemGeneralStatus, tehnika=tehnika, modemBackgroundBlockErrror=modemBackgroundBlockErrror, sysTemperature=sysTemperature, ethTXBackpresEvents=ethTXBackpresEvents, ethTXDones=ethTXDones, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemStandard=modemStandard, pointToPoint=pointToPoint, ethTXBroadcasts=ethTXBroadcasts, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethQOSTXFrames=ethQOSTXFrames, product=product, modemAcqStatus=modemAcqStatus, license=license, ethTXLateCollisions=ethTXLateCollisions, vlanTable=vlanTable, radioTxFrequency=radioTxFrequency, modemIndex=modemIndex, ethGFPDelineationErrors=ethGFPDelineationErrors, atpcIndex=atpcIndex, modemEntry=modemEntry, ethRXCodeErrors=ethRXCodeErrors, ethRXByteCounterHi=ethRXByteCounterHi, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXByteCounterLow=ethRXByteCounterLow, ethTXUnderruns=ethTXUnderruns, modemE1T1ChannelMask=modemE1T1ChannelMask, e1t1StatTable=e1t1StatTable, ethTXControlFrames=ethTXControlFrames, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioSide=radioSide, aTPCTable=aTPCTable, ethTXExcessiveDefers=ethTXExcessiveDefers, e1t1ChannelNr=e1t1ChannelNr, localIpMask=localIpMask, ethRXVlanTagsDetected=ethRXVlanTagsDetected, atpcEnabled=atpcEnabled, ethTXMulticasts=ethTXMulticasts, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemTotalBlockNumber=modemTotalBlockNumber, ethRXDribleNibbles=ethRXDribleNibbles, ethRXMulticasts=ethRXMulticasts, restartcpu=restartcpu, radioDuplexShift=radioDuplexShift, atpcTxPowerCorrection=atpcTxPowerCorrection, vlanNumber=vlanNumber, ethTXCRCErrors=ethTXCRCErrors, modemACMmodulationMax=modemACMmodulationMax, description=description, vlanCfgStat=vlanCfgStat, ethRXCRCErrors=ethRXCRCErrors, modemModulation=modemModulation, modemInternalAGCgain=modemInternalAGCgain, ethGFPFCSErrors=ethGFPFCSErrors, ipRadioStat=ipRadioStat, aTPCEntry=aTPCEntry, modemUptime=modemUptime, ipRadio=ipRadio, sysDateAndTime=sysDateAndTime, modemTable=modemTable, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ipRadioMgmt=ipRadioMgmt, vlanRowStatus=vlanRowStatus, modemSymbolRateRx=modemSymbolRateRx, ethTXCollisions=ethTXCollisions, ethGFPCHECErrors=ethGFPCHECErrors, modemStatistics=modemStatistics, ethQOSRXQ2Frames=ethQOSRXQ2Frames, saf=saf, radioRxFrequency=radioRxFrequency)
