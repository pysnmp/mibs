...
mibBuilder.exportSymbols("SAF-IPRADIO", license=license, atpcIndex=atpcIndex, saf=saf, ethGFPCHECErrors=ethGFPCHECErrors, ethQOSTXFrames=ethQOSTXFrames, vlanEntry=vlanEntry, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXControlFrames=ethTXControlFrames, ethTXLateCollisions=ethTXLateCollisions, ethTXVlanTags=ethTXVlanTags, vlanPortmap=vlanPortmap, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioTxFrequency=radioTxFrequency, aTPCTable=aTPCTable, modemErroredSecondRatio=modemErroredSecondRatio, modemUptime=modemUptime, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemBandwith=modemBandwith, ethTXCollisions=ethTXCollisions, modemTotalBlockNumber=modemTotalBlockNumber, ethRXBroadcasts=ethRXBroadcasts, modemModulation=modemModulation, ethTXPauseFrames=ethTXPauseFrames, tehnika=tehnika, modemTotalCapacity=modemTotalCapacity, modemRadialMSE=modemRadialMSE, vlanRowStatus=vlanRowStatus, ethTXByteCounterHi=ethTXByteCounterHi, loopbacks=loopbacks, ethRXCodeErrors=ethRXCodeErrors, modemStandard=modemStandard, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXCRCErrors=ethTXCRCErrors, ethRXByteCounterLow=ethRXByteCounterLow, ethTXGiants=ethTXGiants, radioRxFrequency=radioRxFrequency, aTPCEntry=aTPCEntry, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioLoopback=radioLoopback, ethTXBroadcasts=ethTXBroadcasts, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXLongEvents=ethRXLongEvents, ethTXBackpresEvents=ethTXBackpresEvents, modemEntry=modemEntry, atpcEnabled=atpcEnabled, modemLastAcqError=modemLastAcqError, modemACMmodulationMin=modemACMmodulationMin, modemRowStatus=modemRowStatus, safip=safip, ethRXDones=ethRXDones, vlanFid=vlanFid, ethTXMulticasts=ethTXMulticasts, pointToPoint=pointToPoint, modemEthernetCapacity=modemEthernetCapacity, modemACMethernetCapacity=modemACMethernetCapacity, ethGFPDropedFrames=ethGFPDropedFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadioCfg=ipRadioCfg, modemErroredSecond=modemErroredSecond, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, sysDateAndTime=sysDateAndTime, radioDuplexShift=radioDuplexShift, vlansEnabled=vlansEnabled, ethGFPFCSErrors=ethGFPFCSErrors, e1t1AIS=e1t1AIS, modemSymbolRateTx=modemSymbolRateTx, modemTable=modemTable, vlanTable=vlanTable, writeConfig=writeConfig, radioRxLevel=radioRxLevel, ipRadioCfgGeneral=ipRadioCfgGeneral, modemUnavailtime=modemUnavailtime, ethRXControlFrames=ethRXControlFrames, e1t1StatEntry=e1t1StatEntry, modemE1T1ChannelMask=modemE1T1ChannelMask, modemSymbolRateRx=modemSymbolRateRx, ipRadioStat=ipRadioStat, licenseMask=licenseMask, ethRXCRCErrors=ethRXCRCErrors, modemLDPCdecoderStress=modemLDPCdecoderStress, modemSeverelyErroredSecond=modemSeverelyErroredSecond, remoteIp=remoteIp, modemStatistics=modemStatistics, ipRadioCfgNetwork=ipRadioCfgNetwork, localIpMask=localIpMask, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemInternalAGCgain=modemInternalAGCgain, e1t1StatTable=e1t1StatTable, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, radioTxPower=radioTxPower, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXDvEvent=ethRXDvEvent, modemACMmodulationMax=modemACMmodulationMax, modemGeneralStatus=modemGeneralStatus, ethQOSTXDropped=ethQOSTXDropped, ethTXByteCounterLow=ethTXByteCounterLow, vlanNumber=vlanNumber, modemCountTime=modemCountTime, ipRadioStatEth=ipRadioStatEth, radioGenStatus=radioGenStatus, ethTXUnderruns=ethTXUnderruns, description=description, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioTxMute=radioTxMute, loopback_tributary_mask=loopback_tributary_mask, modemErroredBlock=modemErroredBlock, sysTemperature=sysTemperature, licenseUpdateStatus=licenseUpdateStatus, ethRXByteCounterHi=ethRXByteCounterHi, modemE1T1Channels=modemE1T1Channels, ethTXLengthCheckErrors=ethTXLengthCheckErrors, microwaveRadio=microwaveRadio, modemIndex=modemIndex, ethRXDribleNibbles=ethRXDribleNibbles, ethTXDones=ethTXDones, vlanCfgStat=vlanCfgStat, modemCarrierOffset=modemCarrierOffset, modemACMengine=modemACMengine, hostname=hostname, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemACMtotalCapacity=modemACMtotalCapacity, e1t1LOS=e1t1LOS, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ipRadioMgmt=ipRadioMgmt, e1t1ChannelNr=e1t1ChannelNr, radioTable=radioTable, radioEntry=radioEntry, ethRXPauseFrames=ethRXPauseFrames, radioIndex=radioIndex, product=product, ethRXMulticasts=ethRXMulticasts, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXExcessiveDefers=ethTXExcessiveDefers, radioSide=radioSide, localIp=localIp, ipRadio=ipRadio, restartcpu=restartcpu, ethTXMaxCollisions=ethTXMaxCollisions, vlanPortType=vlanPortType, modemAcqStatus=modemAcqStatus)
