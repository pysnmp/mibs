...
mibBuilder.exportSymbols("SAF-IPRADIO", vlanEntry=vlanEntry, modemErroredBlock=modemErroredBlock, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioRxLevel=radioRxLevel, modemTable=modemTable, modemBandwith=modemBandwith, modemCarrierOffset=modemCarrierOffset, vlanFid=vlanFid, radioTxPower=radioTxPower, radioIndex=radioIndex, radioTable=radioTable, modemRadialMSE=modemRadialMSE, vlanPortType=vlanPortType, modemGeneralStatus=modemGeneralStatus, ethTXExcessiveDefers=ethTXExcessiveDefers, vlanNumber=vlanNumber, modemTotalCapacity=modemTotalCapacity, ethTXDones=ethTXDones, modemLDPCdecoderStress=modemLDPCdecoderStress, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXBroadcasts=ethRXBroadcasts, remoteIp=remoteIp, modemStatistics=modemStatistics, ethRXCodeErrors=ethRXCodeErrors, vlansEnabled=vlansEnabled, pointToPoint=pointToPoint, modemACMengine=modemACMengine, localIp=localIp, modemStandard=modemStandard, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXDones=ethRXDones, modemUptime=modemUptime, ethTXByteCounterLow=ethTXByteCounterLow, ethTXBroadcasts=ethTXBroadcasts, ipRadio=ipRadio, ethTXGiants=ethTXGiants, ethTXUnderruns=ethTXUnderruns, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlanPortmap=vlanPortmap, ethRXMulticasts=ethRXMulticasts, e1t1StatEntry=e1t1StatEntry, ethTXCRCErrors=ethTXCRCErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, licenseUpdateStatus=licenseUpdateStatus, modemErroredSecond=modemErroredSecond, hostname=hostname, ethGFPCHECErrors=ethGFPCHECErrors, ethTXBackpresEvents=ethTXBackpresEvents, loopbacks=loopbacks, product=product, atpcIndex=atpcIndex, aTPCEntry=aTPCEntry, modemACMethernetCapacity=modemACMethernetCapacity, modemSymbolRateRx=modemSymbolRateRx, modemE1T1Channels=modemE1T1Channels, modemEthernetCapacity=modemEthernetCapacity, aTPCTable=aTPCTable, modemCountTime=modemCountTime, radioSide=radioSide, writeConfig=writeConfig, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXByteCounterHi=ethRXByteCounterHi, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemACMmodulationMin=modemACMmodulationMin, safip=safip, ipRadioMgmt=ipRadioMgmt, ethQOSTXDropped=ethQOSTXDropped, modemLastAcqError=modemLastAcqError, ipRadioCfgGeneral=ipRadioCfgGeneral, modemModulation=modemModulation, modemInternalAGCgain=modemInternalAGCgain, ethTXLateCollisions=ethTXLateCollisions, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadioCfg=ipRadioCfg, ethRXUnsupOpcodes=ethRXUnsupOpcodes, license=license, ethQOSRXQ1Frames=ethQOSRXQ1Frames, licenseMask=licenseMask, modemEntry=modemEntry, ethRXCRCErrors=ethRXCRCErrors, sysDateAndTime=sysDateAndTime, radioGenStatus=radioGenStatus, ethGFPDropedFrames=ethGFPDropedFrames, ethRXLongEvents=ethRXLongEvents, microwaveRadio=microwaveRadio, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXDribleNibbles=ethRXDribleNibbles, e1t1AIS=e1t1AIS, sysTemperature=sysTemperature, modemUnavailtime=modemUnavailtime, loopback_tributary_mask=loopback_tributary_mask, localIpMask=localIpMask, vlanTable=vlanTable, saf=saf, modemTotalBlockNumber=modemTotalBlockNumber, e1t1ChannelNr=e1t1ChannelNr, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXMaxCollisions=ethTXMaxCollisions, ethTXPauseFrames=ethTXPauseFrames, radioLoopback=radioLoopback, radioTxMute=radioTxMute, modemSymbolRateTx=modemSymbolRateTx, ipRadioStatEth=ipRadioStatEth, ethTXVlanTags=ethTXVlanTags, ethRXDvEvent=ethRXDvEvent, vlanRowStatus=vlanRowStatus, modemRowStatus=modemRowStatus, ethTXCollisions=ethTXCollisions, ethTXMulticasts=ethTXMulticasts, atpcEnabled=atpcEnabled, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioTxFrequency=radioTxFrequency, modemAcqStatus=modemAcqStatus, description=description, tehnika=tehnika, ethRXPrevPktDropped=ethRXPrevPktDropped, ethGFPFCSErrors=ethGFPFCSErrors, modemE1T1ChannelMask=modemE1T1ChannelMask, ethQOSTXFrames=ethQOSTXFrames, radioRxFrequency=radioRxFrequency, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXByteCounterLow=ethRXByteCounterLow, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXTruncatedFrames=ethRXTruncatedFrames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXControlFrames=ethTXControlFrames, modemACMmodulationMax=modemACMmodulationMax, ipRadioStat=ipRadioStat, radioDuplexShift=radioDuplexShift, modemErroredSecondRatio=modemErroredSecondRatio, ethTXWireByteCounterLow=ethTXWireByteCounterLow, restartcpu=restartcpu, e1t1StatTable=e1t1StatTable, ethRXPauseFrames=ethRXPauseFrames, radioEntry=radioEntry, ethRXControlFrames=ethRXControlFrames, e1t1LOS=e1t1LOS, modemIndex=modemIndex, ethTXByteCounterHi=ethTXByteCounterHi, vlanCfgStat=vlanCfgStat, modemACMtotalCapacity=modemACMtotalCapacity)
