...
mibBuilder.exportSymbols("SAF-IPRADIO", modemErroredBlock=modemErroredBlock, ethRXLongEvents=ethRXLongEvents, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, e1t1ChannelNr=e1t1ChannelNr, ethQOSTXDropped=ethQOSTXDropped, modemCarrierOffset=modemCarrierOffset, ethRXMulticasts=ethRXMulticasts, vlanTable=vlanTable, sysTemperature=sysTemperature, modemACMtotalCapacity=modemACMtotalCapacity, modemRowStatus=modemRowStatus, vlanNumber=vlanNumber, modemUnavailtime=modemUnavailtime, ethTXMulticasts=ethTXMulticasts, sysDateAndTime=sysDateAndTime, ethTXDones=ethTXDones, vlanPortmap=vlanPortmap, radioTxPower=radioTxPower, ipRadioStatEth=ipRadioStatEth, radioDuplexShift=radioDuplexShift, ethRXByteCounterLow=ethRXByteCounterLow, atpcIndex=atpcIndex, microwaveRadio=microwaveRadio, ethTXControlFrames=ethTXControlFrames, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemRadialMSE=modemRadialMSE, safip=safip, ethTXCRCErrors=ethTXCRCErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXTruncatedFrames=ethRXTruncatedFrames, ipRadioCfg=ipRadioCfg, licenseUpdateStatus=licenseUpdateStatus, aTPCTable=aTPCTable, ethRXDribleNibbles=ethRXDribleNibbles, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioIndex=radioIndex, modemUptime=modemUptime, ethRXDones=ethRXDones, modemTotalCapacity=modemTotalCapacity, modemEntry=modemEntry, atpcEnabled=atpcEnabled, ethTXBroadcasts=ethTXBroadcasts, radioTable=radioTable, ethGFPDropedFrames=ethGFPDropedFrames, ethTXUnderruns=ethTXUnderruns, ethRXByteCounterHi=ethRXByteCounterHi, ethRXVlanTagsDetected=ethRXVlanTagsDetected, localIpMask=localIpMask, ethRXDvEvent=ethRXDvEvent, ethTXWireByteCounterLow=ethTXWireByteCounterLow, loopback_tributary_mask=loopback_tributary_mask, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, license=license, modemTotalBlockNumber=modemTotalBlockNumber, ethTXPauseFrames=ethTXPauseFrames, atpcTxPowerCorrection=atpcTxPowerCorrection, vlanRowStatus=vlanRowStatus, ethRXPrevPktDropped=ethRXPrevPktDropped, localIp=localIp, ipRadioCfgGeneral=ipRadioCfgGeneral, vlansEnabled=vlansEnabled, product=product, modemLDPCdecoderStress=modemLDPCdecoderStress, modemLastAcqError=modemLastAcqError, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, e1t1StatEntry=e1t1StatEntry, ethGFPFCSErrors=ethGFPFCSErrors, modemIndex=modemIndex, loopbacks=loopbacks, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXBackpresEvents=ethTXBackpresEvents, vlanEntry=vlanEntry, ethQOSRXQ2Frames=ethQOSRXQ2Frames, saf=saf, licenseMask=licenseMask, modemCountTime=modemCountTime, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemStatistics=modemStatistics, ipRadio=ipRadio, ethTXExcessiveDefers=ethTXExcessiveDefers, modemEthernetCapacity=modemEthernetCapacity, radioRxLevel=radioRxLevel, e1t1LOS=e1t1LOS, e1t1AIS=e1t1AIS, modemGeneralStatus=modemGeneralStatus, writeConfig=writeConfig, ethTXMaxCollisions=ethTXMaxCollisions, modemACMengine=modemACMengine, ethRXCodeErrors=ethRXCodeErrors, ipRadioStat=ipRadioStat, ethRXControlFrames=ethRXControlFrames, modemSymbolRateRx=modemSymbolRateRx, modemModulation=modemModulation, modemACMmodulationMax=modemACMmodulationMax, modemE1T1ChannelMask=modemE1T1ChannelMask, vlanCfgStat=vlanCfgStat, pointToPoint=pointToPoint, radioEntry=radioEntry, modemE1T1Channels=modemE1T1Channels, modemACMmodulationMin=modemACMmodulationMin, radioLoopback=radioLoopback, modemTable=modemTable, tehnika=tehnika, radioRxFrequency=radioRxFrequency, modemBandwith=modemBandwith, ethRXCRCErrors=ethRXCRCErrors, radioSide=radioSide, ethGFPCHECErrors=ethGFPCHECErrors, aTPCEntry=aTPCEntry, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemACMethernetCapacity=modemACMethernetCapacity, modemErroredSecond=modemErroredSecond, ethRXBroadcasts=ethRXBroadcasts, modemInternalAGCgain=modemInternalAGCgain, ethQOSTXFrames=ethQOSTXFrames, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXByteCounterHi=ethTXByteCounterHi, ethGFPDelineationErrors=ethGFPDelineationErrors, hostname=hostname, ethRXPauseFrames=ethRXPauseFrames, vlanPortType=vlanPortType, e1t1StatTable=e1t1StatTable, remoteIp=remoteIp, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXGiants=ethTXGiants, modemSymbolRateTx=modemSymbolRateTx, description=description, modemErroredSecondRatio=modemErroredSecondRatio, radioTxMute=radioTxMute, vlanFid=vlanFid, modemStandard=modemStandard, modemAcqStatus=modemAcqStatus, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXByteCounterLow=ethTXByteCounterLow, restartcpu=restartcpu, ethTXLateCollisions=ethTXLateCollisions, radioTxFrequency=radioTxFrequency, radioGenStatus=radioGenStatus, ethTXVlanTags=ethTXVlanTags, ethTXCollisions=ethTXCollisions, ipRadioMgmt=ipRadioMgmt)
