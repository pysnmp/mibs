...
mibBuilder.exportSymbols("SAF-IPRADIO", ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemACMmodulationMin=modemACMmodulationMin, modemBandwith=modemBandwith, ethRXPauseFrames=ethRXPauseFrames, modemIndex=modemIndex, licenseUpdateStatus=licenseUpdateStatus, radioRxLevel=radioRxLevel, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXMulticasts=ethTXMulticasts, description=description, ethTXControlFrames=ethTXControlFrames, e1t1StatTable=e1t1StatTable, modemAcqStatus=modemAcqStatus, ethRXCodeErrors=ethRXCodeErrors, modemCountTime=modemCountTime, modemUptime=modemUptime, ethTXBackpresEvents=ethTXBackpresEvents, ethGFPDropedFrames=ethGFPDropedFrames, tehnika=tehnika, radioTxMute=radioTxMute, hostname=hostname, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemSymbolRateRx=modemSymbolRateRx, radioLoopback=radioLoopback, ethRXBroadcasts=ethRXBroadcasts, ethTXUnderruns=ethTXUnderruns, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethGFPCHECErrors=ethGFPCHECErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, vlanNumber=vlanNumber, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXPrevPktDropped=ethRXPrevPktDropped, radioTxFrequency=radioTxFrequency, ethTXDones=ethTXDones, modemACMmodulationMax=modemACMmodulationMax, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemStandard=modemStandard, radioTxPower=radioTxPower, ethRXDvEvent=ethRXDvEvent, sysDateAndTime=sysDateAndTime, modemCarrierOffset=modemCarrierOffset, ethQOSTXDropped=ethQOSTXDropped, ethQOSTXFrames=ethQOSTXFrames, sysTemperature=sysTemperature, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXCRCErrors=ethTXCRCErrors, ethRXDones=ethRXDones, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlanPortType=vlanPortType, radioGenStatus=radioGenStatus, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemInternalAGCgain=modemInternalAGCgain, modemLastAcqError=modemLastAcqError, ipRadioCfg=ipRadioCfg, modemSymbolRateTx=modemSymbolRateTx, localIpMask=localIpMask, modemGeneralStatus=modemGeneralStatus, modemStatistics=modemStatistics, ethTXVlanTags=ethTXVlanTags, modemErroredSecondRatio=modemErroredSecondRatio, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, atpcEnabled=atpcEnabled, ethTXPauseFrames=ethTXPauseFrames, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXMulticasts=ethRXMulticasts, modemErroredSecond=modemErroredSecond, ethGFPFCSErrors=ethGFPFCSErrors, ethRXByteCounterLow=ethRXByteCounterLow, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXLateCollisions=ethTXLateCollisions, localIp=localIp, modemACMengine=modemACMengine, ipRadioMgmt=ipRadioMgmt, radioRxFrequency=radioRxFrequency, atpcIndex=atpcIndex, ipRadioCfgGeneral=ipRadioCfgGeneral, e1t1LOS=e1t1LOS, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioEntry=radioEntry, modemModulation=modemModulation, vlanTable=vlanTable, product=product, saf=saf, microwaveRadio=microwaveRadio, ethTXCollisions=ethTXCollisions, radioIndex=radioIndex, radioTable=radioTable, ethRXLongEvents=ethRXLongEvents, ethRXUnsupOpcodes=ethRXUnsupOpcodes, e1t1ChannelNr=e1t1ChannelNr, restartcpu=restartcpu, modemUnavailtime=modemUnavailtime, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXCRCErrors=ethRXCRCErrors, modemRowStatus=modemRowStatus, vlansEnabled=vlansEnabled, ipRadioCfgNetwork=ipRadioCfgNetwork, modemErroredBlock=modemErroredBlock, writeConfig=writeConfig, vlanFid=vlanFid, safip=safip, ethTXByteCounterHi=ethTXByteCounterHi, ipRadio=ipRadio, ethRXDribleNibbles=ethRXDribleNibbles, ethRXControlFrames=ethRXControlFrames, loopback_tributary_mask=loopback_tributary_mask, ipRadioStat=ipRadioStat, vlanCfgStat=vlanCfgStat, vlanPortmap=vlanPortmap, ethGFPDelineationErrors=ethGFPDelineationErrors, e1t1StatEntry=e1t1StatEntry, remoteIp=remoteIp, ethTXByteCounterLow=ethTXByteCounterLow, modemACMethernetCapacity=modemACMethernetCapacity, aTPCEntry=aTPCEntry, ethTXExcessiveDefers=ethTXExcessiveDefers, modemEthernetCapacity=modemEthernetCapacity, ethTXBroadcasts=ethTXBroadcasts, aTPCTable=aTPCTable, modemEntry=modemEntry, vlanRowStatus=vlanRowStatus, e1t1AIS=e1t1AIS, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXGiants=ethTXGiants, modemE1T1Channels=modemE1T1Channels, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemLDPCdecoderStress=modemLDPCdecoderStress, pointToPoint=pointToPoint, modemRadialMSE=modemRadialMSE, licenseMask=licenseMask, modemACMtotalCapacity=modemACMtotalCapacity, ipRadioStatEth=ipRadioStatEth, radioDuplexShift=radioDuplexShift, vlanEntry=vlanEntry, radioSide=radioSide, ethRXVlanTagsDetected=ethRXVlanTagsDetected, license=license, modemTotalCapacity=modemTotalCapacity, modemTotalBlockNumber=modemTotalBlockNumber, ethTXMaxCollisions=ethTXMaxCollisions, loopbacks=loopbacks, ethRXByteCounterHi=ethRXByteCounterHi, modemTable=modemTable)
