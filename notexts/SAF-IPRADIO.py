...
mibBuilder.exportSymbols("SAF-IPRADIO", modemInternalAGCgain=modemInternalAGCgain, description=description, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemAcqStatus=modemAcqStatus, modemEntry=modemEntry, modemStandard=modemStandard, e1t1LOS=e1t1LOS, ethRXDones=ethRXDones, loopback_tributary_mask=loopback_tributary_mask, modemIndex=modemIndex, modemTotalCapacity=modemTotalCapacity, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXBroadcasts=ethTXBroadcasts, ethTXUnderruns=ethTXUnderruns, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, writeConfig=writeConfig, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXCRCErrors=ethRXCRCErrors, ethTXMulticasts=ethTXMulticasts, loopbacks=loopbacks, radioLoopback=radioLoopback, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethGFPCHECErrors=ethGFPCHECErrors, e1t1ChannelNr=e1t1ChannelNr, ipRadioCfg=ipRadioCfg, radioDuplexShift=radioDuplexShift, modemACMengine=modemACMengine, modemTable=modemTable, ethTXExcessiveDefers=ethTXExcessiveDefers, radioRxLevel=radioRxLevel, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ipRadioStat=ipRadioStat, modemUnavailtime=modemUnavailtime, pointToPoint=pointToPoint, e1t1AIS=e1t1AIS, modemTotalBlockNumber=modemTotalBlockNumber, modemGeneralStatus=modemGeneralStatus, radioTable=radioTable, radioTxPower=radioTxPower, vlanRowStatus=vlanRowStatus, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemBandwith=modemBandwith, licenseMask=licenseMask, ipRadioCfgGeneral=ipRadioCfgGeneral, e1t1StatTable=e1t1StatTable, remoteIp=remoteIp, ethGFPFCSErrors=ethGFPFCSErrors, vlanEntry=vlanEntry, localIp=localIp, ethQOSRXQ2Frames=ethQOSRXQ2Frames, microwaveRadio=microwaveRadio, modemErroredSecond=modemErroredSecond, ethRXDribleNibbles=ethRXDribleNibbles, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXPauseFrames=ethRXPauseFrames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioIndex=radioIndex, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemE1T1ChannelMask=modemE1T1ChannelMask, modemCarrierOffset=modemCarrierOffset, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXMaxCollisions=ethTXMaxCollisions, vlanTable=vlanTable, ethTXBackpresEvents=ethTXBackpresEvents, localIpMask=localIpMask, modemE1T1Channels=modemE1T1Channels, ethRXDvEvent=ethRXDvEvent, modemRadialMSE=modemRadialMSE, ethTXLengthCheckErrors=ethTXLengthCheckErrors, radioEntry=radioEntry, atpcEnabled=atpcEnabled, ethTXByteCounterLow=ethTXByteCounterLow, atpcIndex=atpcIndex, ethTXCollisions=ethTXCollisions, vlanPortmap=vlanPortmap, modemSymbolRateRx=modemSymbolRateRx, sysTemperature=sysTemperature, ethTXCRCErrors=ethTXCRCErrors, e1t1StatEntry=e1t1StatEntry, hostname=hostname, ethRXLongEvents=ethRXLongEvents, ipRadio=ipRadio, restartcpu=restartcpu, modemErroredBlock=modemErroredBlock, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, tehnika=tehnika, modemACMmodulationMin=modemACMmodulationMin, modemStatistics=modemStatistics, vlanPortType=vlanPortType, ethRXCodeErrors=ethRXCodeErrors, atpcTxPowerCorrection=atpcTxPowerCorrection, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemRowStatus=modemRowStatus, aTPCTable=aTPCTable, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXWireByteCounterHi=ethTXWireByteCounterHi, licenseUpdateStatus=licenseUpdateStatus, vlansEnabled=vlansEnabled, vlanFid=vlanFid, safip=safip, radioTxMute=radioTxMute, ethRXByteCounterLow=ethRXByteCounterLow, modemErroredSecondRatio=modemErroredSecondRatio, ethTXVlanTags=ethTXVlanTags, ethQOSTXFrames=ethQOSTXFrames, ethTXPauseFrames=ethTXPauseFrames, vlanNumber=vlanNumber, ethTXControlFrames=ethTXControlFrames, modemUptime=modemUptime, ethRXTruncatedFrames=ethRXTruncatedFrames, product=product, ethTXByteCounterHi=ethTXByteCounterHi, radioRxFrequency=radioRxFrequency, ethGFPDropedFrames=ethGFPDropedFrames, ethQOSTXDropped=ethQOSTXDropped, radioGenStatus=radioGenStatus, sysDateAndTime=sysDateAndTime, modemLDPCdecoderStress=modemLDPCdecoderStress, saf=saf, ethTXLateCollisions=ethTXLateCollisions, ipRadioStatEth=ipRadioStatEth, ethTXDones=ethTXDones, modemLastAcqError=modemLastAcqError, modemEthernetCapacity=modemEthernetCapacity, aTPCEntry=aTPCEntry, ethRXByteCounterHi=ethRXByteCounterHi, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXMulticasts=ethRXMulticasts, modemACMethernetCapacity=modemACMethernetCapacity, ethRXBroadcasts=ethRXBroadcasts, modemSymbolRateTx=modemSymbolRateTx, ipRadioMgmt=ipRadioMgmt, modemCountTime=modemCountTime, modemACMtotalCapacity=modemACMtotalCapacity, license=license, radioTxFrequency=radioTxFrequency, modemACMmodulationMax=modemACMmodulationMax, radioSide=radioSide, modemModulation=modemModulation, vlanCfgStat=vlanCfgStat, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXGiants=ethTXGiants, ethRXControlFrames=ethRXControlFrames)
