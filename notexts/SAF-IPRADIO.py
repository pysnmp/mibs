...
mibBuilder.exportSymbols("SAF-IPRADIO", modemACMtotalCapacity=modemACMtotalCapacity, vlanCfgStat=vlanCfgStat, vlanPortmap=vlanPortmap, ethRXPrevPktDropped=ethRXPrevPktDropped, modemUptime=modemUptime, ethRXDribleNibbles=ethRXDribleNibbles, ethRXDones=ethRXDones, saf=saf, ethTXControlFrames=ethTXControlFrames, e1t1StatEntry=e1t1StatEntry, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, licenseUpdateStatus=licenseUpdateStatus, ethTXMulticasts=ethTXMulticasts, modemBandwith=modemBandwith, modemRadialMSE=modemRadialMSE, ethTXPauseFrames=ethTXPauseFrames, ipRadioMgmt=ipRadioMgmt, radioIndex=radioIndex, radioDuplexShift=radioDuplexShift, radioGenStatus=radioGenStatus, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXByteCounterLow=ethTXByteCounterLow, radioTxMute=radioTxMute, modemModulation=modemModulation, ethGFPFCSErrors=ethGFPFCSErrors, radioRxLevel=radioRxLevel, ethRXPauseFrames=ethRXPauseFrames, localIp=localIp, modemSymbolRateRx=modemSymbolRateRx, ethTXMaxCollisions=ethTXMaxCollisions, ethGFPDelineationErrors=ethGFPDelineationErrors, modemTotalBlockNumber=modemTotalBlockNumber, modemBackgroundBlockErrror=modemBackgroundBlockErrror, localIpMask=localIpMask, modemErroredBlock=modemErroredBlock, remoteIp=remoteIp, modemLDPCdecoderStress=modemLDPCdecoderStress, aTPCEntry=aTPCEntry, aTPCTable=aTPCTable, ipRadioStatEth=ipRadioStatEth, license=license, modemIndex=modemIndex, ethTXBackpresEvents=ethTXBackpresEvents, ethTXDones=ethTXDones, pointToPoint=pointToPoint, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, writeConfig=writeConfig, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemACMethernetCapacity=modemACMethernetCapacity, ethGFPDropedFrames=ethGFPDropedFrames, modemAcqStatus=modemAcqStatus, ethRXMulticasts=ethRXMulticasts, modemErroredSecond=modemErroredSecond, description=description, modemSymbolRateTx=modemSymbolRateTx, vlanEntry=vlanEntry, ethRXCodeErrors=ethRXCodeErrors, modemRowStatus=modemRowStatus, modemCarrierOffset=modemCarrierOffset, modemACMengine=modemACMengine, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemE1T1Channels=modemE1T1Channels, ethQOSTXFrames=ethQOSTXFrames, e1t1StatTable=e1t1StatTable, modemUnavailtime=modemUnavailtime, atpcIndex=atpcIndex, radioRxFrequency=radioRxFrequency, restartcpu=restartcpu, e1t1ChannelNr=e1t1ChannelNr, atpcEnabled=atpcEnabled, ethRXLongEvents=ethRXLongEvents, ethTXCollisions=ethTXCollisions, ethRXDvEvent=ethRXDvEvent, e1t1LOS=e1t1LOS, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXCRCErrors=ethTXCRCErrors, vlanPortType=vlanPortType, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemStandard=modemStandard, licenseMask=licenseMask, modemACMmodulationMax=modemACMmodulationMax, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, tehnika=tehnika, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemGeneralStatus=modemGeneralStatus, ethRXBroadcasts=ethRXBroadcasts, ethTXByteCounterHi=ethTXByteCounterHi, sysTemperature=sysTemperature, modemTable=modemTable, ethTXGiants=ethTXGiants, vlanRowStatus=vlanRowStatus, radioSide=radioSide, ethTXUnderruns=ethTXUnderruns, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemE1T1ChannelMask=modemE1T1ChannelMask, safip=safip, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemInternalAGCgain=modemInternalAGCgain, radioEntry=radioEntry, ethTXExcessiveDefers=ethTXExcessiveDefers, vlanFid=vlanFid, ethTXWireByteCounterHi=ethTXWireByteCounterHi, microwaveRadio=microwaveRadio, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, loopbacks=loopbacks, modemTotalCapacity=modemTotalCapacity, ethTXBroadcasts=ethTXBroadcasts, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ipRadioCfgGeneral=ipRadioCfgGeneral, radioTxPower=radioTxPower, modemErroredSecondRatio=modemErroredSecondRatio, modemLastAcqError=modemLastAcqError, hostname=hostname, ipRadioStat=ipRadioStat, ethTXVlanTags=ethTXVlanTags, ethTXLateCollisions=ethTXLateCollisions, atpcTxPowerCorrection=atpcTxPowerCorrection, modemEthernetCapacity=modemEthernetCapacity, ipRadioCfg=ipRadioCfg, radioTxFrequency=radioTxFrequency, ethGFPCHECErrors=ethGFPCHECErrors, modemStatistics=modemStatistics, product=product, vlansEnabled=vlansEnabled, vlanTable=vlanTable, ethRXByteCounterHi=ethRXByteCounterHi, e1t1AIS=e1t1AIS, sysDateAndTime=sysDateAndTime, ipRadio=ipRadio, ethRXControlFrames=ethRXControlFrames, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioTable=radioTable, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXByteCounterLow=ethRXByteCounterLow, modemACMmodulationMin=modemACMmodulationMin, vlanNumber=vlanNumber, ethQOSTXDropped=ethQOSTXDropped, modemCountTime=modemCountTime, modemEntry=modemEntry, ethRXCRCErrors=ethRXCRCErrors, radioLoopback=radioLoopback, loopback_tributary_mask=loopback_tributary_mask)
