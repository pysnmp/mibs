...
mibBuilder.exportSymbols("SAF-IPRADIO", vlanCfgStat=vlanCfgStat, pointToPoint=pointToPoint, ethTXBackpresEvents=ethTXBackpresEvents, modemModulation=modemModulation, modemRowStatus=modemRowStatus, ethQOSTXDropped=ethQOSTXDropped, modemACMmodulationMin=modemACMmodulationMin, e1t1AIS=e1t1AIS, licenseUpdateStatus=licenseUpdateStatus, ipRadio=ipRadio, ethRXPauseFrames=ethRXPauseFrames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, remoteIp=remoteIp, ethRXBroadcasts=ethRXBroadcasts, modemEthernetCapacity=modemEthernetCapacity, ethTXWireByteCounterHi=ethTXWireByteCounterHi, e1t1StatEntry=e1t1StatEntry, ethTXControlFrames=ethTXControlFrames, modemCountTime=modemCountTime, radioGenStatus=radioGenStatus, radioSide=radioSide, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXDribleNibbles=ethRXDribleNibbles, atpcIndex=atpcIndex, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, safip=safip, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemUnavailtime=modemUnavailtime, modemACMethernetCapacity=modemACMethernetCapacity, vlanPortType=vlanPortType, radioRxFrequency=radioRxFrequency, modemAcqStatus=modemAcqStatus, ethTXVlanTags=ethTXVlanTags, atpcEnabled=atpcEnabled, ipRadioStatEth=ipRadioStatEth, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXLongEvents=ethRXLongEvents, modemErroredSecondRatio=modemErroredSecondRatio, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXByteCounterLow=ethTXByteCounterLow, ethRXCRCErrors=ethRXCRCErrors, radioRxLevel=radioRxLevel, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemTotalCapacity=modemTotalCapacity, ethTXUnderruns=ethTXUnderruns, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, tehnika=tehnika, aTPCTable=aTPCTable, modemTotalBlockNumber=modemTotalBlockNumber, modemSymbolRateRx=modemSymbolRateRx, modemEntry=modemEntry, vlanRowStatus=vlanRowStatus, ethQOSTXFrames=ethQOSTXFrames, modemACMmodulationMax=modemACMmodulationMax, localIpMask=localIpMask, loopbacks=loopbacks, ethRXMulticasts=ethRXMulticasts, ethGFPFCSErrors=ethGFPFCSErrors, vlanTable=vlanTable, radioDuplexShift=radioDuplexShift, ethGFPDelineationErrors=ethGFPDelineationErrors, saf=saf, ethRXControlFrames=ethRXControlFrames, ethTXLateCollisions=ethTXLateCollisions, radioTxMute=radioTxMute, loopback_tributary_mask=loopback_tributary_mask, writeConfig=writeConfig, ethRXByteCounterLow=ethRXByteCounterLow, restartcpu=restartcpu, radioLoopback=radioLoopback, ipRadioStat=ipRadioStat, vlansEnabled=vlansEnabled, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXDones=ethRXDones, ethRXCodeErrors=ethRXCodeErrors, microwaveRadio=microwaveRadio, modemUptime=modemUptime, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXDones=ethTXDones, sysDateAndTime=sysDateAndTime, license=license, vlanPortmap=vlanPortmap, modemTable=modemTable, ethTXGiants=ethTXGiants, ethTXMaxCollisions=ethTXMaxCollisions, aTPCEntry=aTPCEntry, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemCarrierOffset=modemCarrierOffset, ethRXByteCounterHi=ethRXByteCounterHi, radioIndex=radioIndex, licenseMask=licenseMask, modemGeneralStatus=modemGeneralStatus, hostname=hostname, localIp=localIp, ethRXUnsupOpcodes=ethRXUnsupOpcodes, e1t1LOS=e1t1LOS, sysTemperature=sysTemperature, radioEntry=radioEntry, vlanEntry=vlanEntry, modemStandard=modemStandard, vlanNumber=vlanNumber, modemErroredSecond=modemErroredSecond, ethTXByteCounterHi=ethTXByteCounterHi, modemStatistics=modemStatistics, e1t1ChannelNr=e1t1ChannelNr, modemACMtotalCapacity=modemACMtotalCapacity, ethRXDvEvent=ethRXDvEvent, product=product, modemLastAcqError=modemLastAcqError, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethGFPDropedFrames=ethGFPDropedFrames, ipRadioMgmt=ipRadioMgmt, modemACMengine=modemACMengine, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXTruncatedFrames=ethRXTruncatedFrames, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemErroredBlock=modemErroredBlock, description=description, modemE1T1Channels=modemE1T1Channels, modemRadialMSE=modemRadialMSE, modemBandwith=modemBandwith, modemIndex=modemIndex, radioTable=radioTable, vlanFid=vlanFid, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXCollisions=ethTXCollisions, ethTXPauseFrames=ethTXPauseFrames, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXCRCErrors=ethTXCRCErrors, modemInternalAGCgain=modemInternalAGCgain, modemSymbolRateTx=modemSymbolRateTx, ipRadioCfg=ipRadioCfg, ethTXBroadcasts=ethTXBroadcasts, ethGFPCHECErrors=ethGFPCHECErrors, radioTxFrequency=radioTxFrequency, ethTXMulticasts=ethTXMulticasts, modemE1T1ChannelMask=modemE1T1ChannelMask, radioTxPower=radioTxPower, ethQOSRXQ2Frames=ethQOSRXQ2Frames, e1t1StatTable=e1t1StatTable, modemSeverelyErroredSecond=modemSeverelyErroredSecond)
