...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXLongEvents=ethRXLongEvents, radioTable=radioTable, vlanEntry=vlanEntry, ethRXByteCounterLow=ethRXByteCounterLow, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemEntry=modemEntry, modemTotalBlockNumber=modemTotalBlockNumber, radioRxLevel=radioRxLevel, ipRadioMgmt=ipRadioMgmt, modemEthernetCapacity=modemEthernetCapacity, ipRadioStat=ipRadioStat, modemAcqStatus=modemAcqStatus, radioGenStatus=radioGenStatus, modemACMengine=modemACMengine, modemACMethernetCapacity=modemACMethernetCapacity, writeConfig=writeConfig, ethTXByteCounterHi=ethTXByteCounterHi, radioSide=radioSide, hostname=hostname, e1t1LOS=e1t1LOS, localIp=localIp, modemUptime=modemUptime, modemStatistics=modemStatistics, modemTotalCapacity=modemTotalCapacity, modemRowStatus=modemRowStatus, ethTXCollisions=ethTXCollisions, atpcEnabled=atpcEnabled, ipRadioStatEth=ipRadioStatEth, ipRadio=ipRadio, modemUnavailtime=modemUnavailtime, saf=saf, modemErroredBlock=modemErroredBlock, vlanPortmap=vlanPortmap, ethTXLateCollisions=ethTXLateCollisions, ethRXTruncatedFrames=ethRXTruncatedFrames, localIpMask=localIpMask, modemACMtotalCapacity=modemACMtotalCapacity, ethGFPFCSErrors=ethGFPFCSErrors, ethTXByteCounterLow=ethTXByteCounterLow, licenseUpdateStatus=licenseUpdateStatus, e1t1StatTable=e1t1StatTable, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXMaxCollisions=ethTXMaxCollisions, radioTxFrequency=radioTxFrequency, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, atpcIndex=atpcIndex, ethQOSTXFrames=ethQOSTXFrames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, description=description, ethTXUnderruns=ethTXUnderruns, ethRXDvEvent=ethRXDvEvent, vlansEnabled=vlansEnabled, licenseMask=licenseMask, aTPCEntry=aTPCEntry, e1t1StatEntry=e1t1StatEntry, modemSymbolRateRx=modemSymbolRateRx, radioRxFrequency=radioRxFrequency, modemACMmodulationMax=modemACMmodulationMax, radioDuplexShift=radioDuplexShift, modemInternalAGCgain=modemInternalAGCgain, aTPCTable=aTPCTable, vlanPortType=vlanPortType, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXMulticasts=ethTXMulticasts, radioTxMute=radioTxMute, radioTxPower=radioTxPower, ethRXDones=ethRXDones, modemE1T1Channels=modemE1T1Channels, sysTemperature=sysTemperature, modemLDPCdecoderStress=modemLDPCdecoderStress, tehnika=tehnika, ipRadioCfgNetwork=ipRadioCfgNetwork, sysDateAndTime=sysDateAndTime, ipRadioCfgGeneral=ipRadioCfgGeneral, modemErroredSecondRatio=modemErroredSecondRatio, modemCountTime=modemCountTime, vlanNumber=vlanNumber, loopback_tributary_mask=loopback_tributary_mask, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ipRadioCfg=ipRadioCfg, ethTXCRCErrors=ethTXCRCErrors, ethTXVlanTags=ethTXVlanTags, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, license=license, ethTXPauseFrames=ethTXPauseFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXPauseFrames=ethRXPauseFrames, modemStandard=modemStandard, modemBandwith=modemBandwith, ethTXGiants=ethTXGiants, ethTXBroadcasts=ethTXBroadcasts, pointToPoint=pointToPoint, modemSymbolRateTx=modemSymbolRateTx, vlanRowStatus=vlanRowStatus, safip=safip, ethTXBackpresEvents=ethTXBackpresEvents, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXPrevPktDropped=ethRXPrevPktDropped, ethGFPCHECErrors=ethGFPCHECErrors, ethRXCodeErrors=ethRXCodeErrors, radioIndex=radioIndex, e1t1AIS=e1t1AIS, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXExcessiveDefers=ethTXExcessiveDefers, modemACMmodulationMin=modemACMmodulationMin, modemIndex=modemIndex, ethGFPDropedFrames=ethGFPDropedFrames, modemModulation=modemModulation, ethTXDones=ethTXDones, modemErroredSecond=modemErroredSecond, modemLastAcqError=modemLastAcqError, ethQOSTXDropped=ethQOSTXDropped, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXControlFrames=ethRXControlFrames, remoteIp=remoteIp, radioLoopback=radioLoopback, e1t1ChannelNr=e1t1ChannelNr, ethRXByteCounterHi=ethRXByteCounterHi, ethRXMulticasts=ethRXMulticasts, modemCarrierOffset=modemCarrierOffset, vlanCfgStat=vlanCfgStat, product=product, modemTable=modemTable, modemE1T1ChannelMask=modemE1T1ChannelMask, modemGeneralStatus=modemGeneralStatus, ethRXCRCErrors=ethRXCRCErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, loopbacks=loopbacks, modemRadialMSE=modemRadialMSE, restartcpu=restartcpu, radioEntry=radioEntry, ethTXControlFrames=ethTXControlFrames, microwaveRadio=microwaveRadio, vlanTable=vlanTable, ethRXDribleNibbles=ethRXDribleNibbles, ethRXBroadcasts=ethRXBroadcasts, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXVlanTagsDetected=ethRXVlanTagsDetected, vlanFid=vlanFid)
