...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXUnderruns=ethTXUnderruns, radioLoopback=radioLoopback, e1t1LOS=e1t1LOS, modemSymbolRateTx=modemSymbolRateTx, ethRXMulticasts=ethRXMulticasts, modemAcqStatus=modemAcqStatus, ipRadioStatEth=ipRadioStatEth, modemErroredSecondRatio=modemErroredSecondRatio, vlanEntry=vlanEntry, ethRXBroadcasts=ethRXBroadcasts, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ipRadio=ipRadio, modemACMtotalCapacity=modemACMtotalCapacity, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethGFPDropedFrames=ethGFPDropedFrames, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXDones=ethTXDones, radioTxFrequency=radioTxFrequency, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemEthernetCapacity=modemEthernetCapacity, radioDuplexShift=radioDuplexShift, ethTXGiants=ethTXGiants, product=product, vlanPortmap=vlanPortmap, ethRXTruncatedFrames=ethRXTruncatedFrames, modemBandwith=modemBandwith, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadioCfg=ipRadioCfg, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemUnavailtime=modemUnavailtime, ethRXDones=ethRXDones, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXCRCErrors=ethRXCRCErrors, e1t1AIS=e1t1AIS, ethTXVlanTags=ethTXVlanTags, ethRXControlFrames=ethRXControlFrames, atpcIndex=atpcIndex, hostname=hostname, aTPCEntry=aTPCEntry, modemRadialMSE=modemRadialMSE, radioIndex=radioIndex, modemSymbolRateRx=modemSymbolRateRx, ethRXCodeErrors=ethRXCodeErrors, ethRXDvEvent=ethRXDvEvent, ethTXLengthCheckErrors=ethTXLengthCheckErrors, e1t1StatEntry=e1t1StatEntry, modemModulation=modemModulation, ethQOSRXQ1Frames=ethQOSRXQ1Frames, pointToPoint=pointToPoint, ipRadioMgmt=ipRadioMgmt, ethGFPCHECErrors=ethGFPCHECErrors, ethTXBackpresEvents=ethTXBackpresEvents, modemStatistics=modemStatistics, modemCountTime=modemCountTime, radioTxPower=radioTxPower, modemUptime=modemUptime, modemE1T1Channels=modemE1T1Channels, modemCarrierOffset=modemCarrierOffset, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, e1t1StatTable=e1t1StatTable, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ipRadioCfgGeneral=ipRadioCfgGeneral, modemACMethernetCapacity=modemACMethernetCapacity, modemErroredSecond=modemErroredSecond, ethTXExcessiveDefers=ethTXExcessiveDefers, modemStandard=modemStandard, loopbacks=loopbacks, ethQOSTXDropped=ethQOSTXDropped, ethTXCRCErrors=ethTXCRCErrors, atpcEnabled=atpcEnabled, modemRowStatus=modemRowStatus, ethRXByteCounterHi=ethRXByteCounterHi, ethTXLateCollisions=ethTXLateCollisions, modemACMmodulationMin=modemACMmodulationMin, vlanPortType=vlanPortType, saf=saf, radioSide=radioSide, sysDateAndTime=sysDateAndTime, modemTable=modemTable, microwaveRadio=microwaveRadio, radioEntry=radioEntry, ethTXMaxCollisions=ethTXMaxCollisions, vlanCfgStat=vlanCfgStat, radioRxLevel=radioRxLevel, localIp=localIp, vlanNumber=vlanNumber, ethRXByteCounterLow=ethRXByteCounterLow, remoteIp=remoteIp, licenseMask=licenseMask, ipRadioCfgNetwork=ipRadioCfgNetwork, modemACMmodulationMax=modemACMmodulationMax, modemIndex=modemIndex, ethTXByteCounterLow=ethTXByteCounterLow, vlansEnabled=vlansEnabled, writeConfig=writeConfig, radioTable=radioTable, ethTXBroadcasts=ethTXBroadcasts, radioTxMute=radioTxMute, description=description, ethTXPauseFrames=ethTXPauseFrames, aTPCTable=aTPCTable, ipRadioStat=ipRadioStat, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemGeneralStatus=modemGeneralStatus, ethTXMulticasts=ethTXMulticasts, modemLDPCdecoderStress=modemLDPCdecoderStress, ethQOSTXFrames=ethQOSTXFrames, e1t1ChannelNr=e1t1ChannelNr, modemInternalAGCgain=modemInternalAGCgain, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXControlFrames=ethTXControlFrames, license=license, licenseUpdateStatus=licenseUpdateStatus, ethRXPauseFrames=ethRXPauseFrames, vlanFid=vlanFid, atpcTxPowerCorrection=atpcTxPowerCorrection, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemEntry=modemEntry, modemTotalBlockNumber=modemTotalBlockNumber, vlanTable=vlanTable, loopback_tributary_mask=loopback_tributary_mask, ethRXDribleNibbles=ethRXDribleNibbles, ethGFPFCSErrors=ethGFPFCSErrors, modemTotalCapacity=modemTotalCapacity, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemACMengine=modemACMengine, ethTXCollisions=ethTXCollisions, localIpMask=localIpMask, modemErroredBlock=modemErroredBlock, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, sysTemperature=sysTemperature, ethRXUnsupOpcodes=ethRXUnsupOpcodes, restartcpu=restartcpu, radioGenStatus=radioGenStatus, radioRxFrequency=radioRxFrequency, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXPrevPktDropped=ethRXPrevPktDropped, modemLastAcqError=modemLastAcqError, vlanRowStatus=vlanRowStatus, safip=safip, tehnika=tehnika, ethTXByteCounterHi=ethTXByteCounterHi, ethRXLongEvents=ethRXLongEvents)
