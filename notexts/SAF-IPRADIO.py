...
mibBuilder.exportSymbols("SAF-IPRADIO", modemUnavailtime=modemUnavailtime, modemE1T1Channels=modemE1T1Channels, vlanNumber=vlanNumber, hostname=hostname, aTPCEntry=aTPCEntry, modemCarrierOffset=modemCarrierOffset, ethRXDribleNibbles=ethRXDribleNibbles, ethTXUnderruns=ethTXUnderruns, ethTXVlanTags=ethTXVlanTags, ethTXDones=ethTXDones, vlanTable=vlanTable, description=description, ethTXMulticasts=ethTXMulticasts, ipRadioCfgGeneral=ipRadioCfgGeneral, microwaveRadio=microwaveRadio, radioEntry=radioEntry, modemACMmodulationMax=modemACMmodulationMax, ethTXMaxCollisions=ethTXMaxCollisions, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, licenseUpdateStatus=licenseUpdateStatus, vlanPortmap=vlanPortmap, modemTotalCapacity=modemTotalCapacity, ethGFPDelineationErrors=ethGFPDelineationErrors, modemStandard=modemStandard, radioDuplexShift=radioDuplexShift, radioRxFrequency=radioRxFrequency, ethTXWireByteCounterHi=ethTXWireByteCounterHi, licenseMask=licenseMask, modemEthernetCapacity=modemEthernetCapacity, ethRXLongEvents=ethRXLongEvents, modemSymbolRateTx=modemSymbolRateTx, modemBandwith=modemBandwith, loopbacks=loopbacks, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, tehnika=tehnika, ethRXByteCounterLow=ethRXByteCounterLow, radioRxLevel=radioRxLevel, ethTXByteCounterHi=ethTXByteCounterHi, ethQOSTXFrames=ethQOSTXFrames, ipRadio=ipRadio, pointToPoint=pointToPoint, ethRXDones=ethRXDones, modemEntry=modemEntry, modemACMmodulationMin=modemACMmodulationMin, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlanEntry=vlanEntry, e1t1StatTable=e1t1StatTable, writeConfig=writeConfig, atpcEnabled=atpcEnabled, ethTXLateCollisions=ethTXLateCollisions, aTPCTable=aTPCTable, vlanPortType=vlanPortType, ethTXPauseFrames=ethTXPauseFrames, ethRXCRCErrors=ethRXCRCErrors, modemACMethernetCapacity=modemACMethernetCapacity, sysTemperature=sysTemperature, modemLDPCdecoderStress=modemLDPCdecoderStress, ipRadioCfg=ipRadioCfg, modemLastAcqError=modemLastAcqError, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXGiants=ethTXGiants, ethQOSRXQ2Frames=ethQOSRXQ2Frames, e1t1LOS=e1t1LOS, ethTXByteCounterLow=ethTXByteCounterLow, radioLoopback=radioLoopback, restartcpu=restartcpu, modemUptime=modemUptime, modemErroredSecond=modemErroredSecond, modemErroredSecondRatio=modemErroredSecondRatio, safip=safip, modemRowStatus=modemRowStatus, ethQOSTXDropped=ethQOSTXDropped, localIpMask=localIpMask, ethRXCodeErrors=ethRXCodeErrors, ethTXControlFrames=ethTXControlFrames, ethTXCRCErrors=ethTXCRCErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, vlanRowStatus=vlanRowStatus, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioIndex=radioIndex, modemACMengine=modemACMengine, ethGFPFCSErrors=ethGFPFCSErrors, loopback_tributary_mask=loopback_tributary_mask, atpcIndex=atpcIndex, vlanFid=vlanFid, modemInternalAGCgain=modemInternalAGCgain, sysDateAndTime=sysDateAndTime, radioTxFrequency=radioTxFrequency, e1t1ChannelNr=e1t1ChannelNr, localIp=localIp, ethGFPCHECErrors=ethGFPCHECErrors, modemModulation=modemModulation, product=product, ethTXCollisions=ethTXCollisions, modemStatistics=modemStatistics, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemRadialMSE=modemRadialMSE, ethGFPDropedFrames=ethGFPDropedFrames, license=license, vlanCfgStat=vlanCfgStat, remoteIp=remoteIp, ipRadioCfgNetwork=ipRadioCfgNetwork, ipRadioStatEth=ipRadioStatEth, vlansEnabled=vlansEnabled, ethTXBackpresEvents=ethTXBackpresEvents, ethTXBroadcasts=ethTXBroadcasts, radioGenStatus=radioGenStatus, radioTxMute=radioTxMute, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ipRadioMgmt=ipRadioMgmt, modemE1T1ChannelMask=modemE1T1ChannelMask, saf=saf, modemACMtotalCapacity=modemACMtotalCapacity, e1t1AIS=e1t1AIS, modemGeneralStatus=modemGeneralStatus, ethRXBroadcasts=ethRXBroadcasts, ipRadioStat=ipRadioStat, ethRXMulticasts=ethRXMulticasts, ethRXControlFrames=ethRXControlFrames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXByteCounterHi=ethRXByteCounterHi, modemTable=modemTable, ethRXDvEvent=ethRXDvEvent, modemErroredBlock=modemErroredBlock, ethRXUnsupOpcodes=ethRXUnsupOpcodes, atpcTxPowerCorrection=atpcTxPowerCorrection, modemSymbolRateRx=modemSymbolRateRx, modemTotalBlockNumber=modemTotalBlockNumber, ethRXTruncatedFrames=ethRXTruncatedFrames, modemCountTime=modemCountTime, modemIndex=modemIndex, ethTXExcessiveDefers=ethTXExcessiveDefers, radioSide=radioSide, e1t1StatEntry=e1t1StatEntry, radioTable=radioTable, radioTxPower=radioTxPower, ethRXPauseFrames=ethRXPauseFrames, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemAcqStatus=modemAcqStatus)
