...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, tehnika=tehnika, modemStatistics=modemStatistics, modemACMmodulationMin=modemACMmodulationMin, ipRadio=ipRadio, radioRxFrequency=radioRxFrequency, description=description, e1t1ChannelNr=e1t1ChannelNr, modemModulation=modemModulation, modemSymbolRateTx=modemSymbolRateTx, saf=saf, radioEntry=radioEntry, licenseMask=licenseMask, modemE1T1Channels=modemE1T1Channels, ethTXCRCErrors=ethTXCRCErrors, safip=safip, ethRXControlFrames=ethRXControlFrames, e1t1AIS=e1t1AIS, ipRadioMgmt=ipRadioMgmt, radioRxLevel=radioRxLevel, modemACMmodulationMax=modemACMmodulationMax, writeConfig=writeConfig, modemErroredSecondRatio=modemErroredSecondRatio, license=license, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXControlFrames=ethTXControlFrames, sysTemperature=sysTemperature, aTPCEntry=aTPCEntry, modemRadialMSE=modemRadialMSE, modemErroredSecond=modemErroredSecond, ethGFPCHECErrors=ethGFPCHECErrors, modemTable=modemTable, modemRowStatus=modemRowStatus, modemACMengine=modemACMengine, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemTotalCapacity=modemTotalCapacity, ethRXCRCErrors=ethRXCRCErrors, vlanEntry=vlanEntry, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXLengthCheckErrors=ethTXLengthCheckErrors, localIp=localIp, modemLDPCdecoderStress=modemLDPCdecoderStress, modemEntry=modemEntry, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethGFPFCSErrors=ethGFPFCSErrors, modemBandwith=modemBandwith, ethTXUnderruns=ethTXUnderruns, modemACMtotalCapacity=modemACMtotalCapacity, ethTXByteCounterHi=ethTXByteCounterHi, ethRXDvEvent=ethRXDvEvent, loopback_tributary_mask=loopback_tributary_mask, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXBackpresEvents=ethTXBackpresEvents, ethTXMulticasts=ethTXMulticasts, modemUptime=modemUptime, ethRXDones=ethRXDones, ethTXPauseFrames=ethTXPauseFrames, ethRXTruncatedFrames=ethRXTruncatedFrames, modemErroredBlock=modemErroredBlock, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXWireByteCounterLow=ethTXWireByteCounterLow, microwaveRadio=microwaveRadio, ipRadioStat=ipRadioStat, radioGenStatus=radioGenStatus, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethQOSRXQ1Frames=ethQOSRXQ1Frames, atpcTxPowerCorrection=atpcTxPowerCorrection, radioIndex=radioIndex, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXDribleNibbles=ethRXDribleNibbles, modemTotalBlockNumber=modemTotalBlockNumber, radioDuplexShift=radioDuplexShift, vlanCfgStat=vlanCfgStat, modemInternalAGCgain=modemInternalAGCgain, radioSide=radioSide, radioTxFrequency=radioTxFrequency, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioTxMute=radioTxMute, modemEthernetCapacity=modemEthernetCapacity, ipRadioStatEth=ipRadioStatEth, vlanRowStatus=vlanRowStatus, ethTXByteCounterLow=ethTXByteCounterLow, ethTXMaxCollisions=ethTXMaxCollisions, atpcEnabled=atpcEnabled, modemStandard=modemStandard, ethQOSRXQ2Frames=ethQOSRXQ2Frames, atpcIndex=atpcIndex, ethRXBroadcasts=ethRXBroadcasts, loopbacks=loopbacks, e1t1LOS=e1t1LOS, aTPCTable=aTPCTable, modemACMethernetCapacity=modemACMethernetCapacity, modemUnavailtime=modemUnavailtime, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXCodeErrors=ethRXCodeErrors, ethTXGiants=ethTXGiants, vlanPortType=vlanPortType, ethTXBroadcasts=ethTXBroadcasts, ethGFPDelineationErrors=ethGFPDelineationErrors, modemCountTime=modemCountTime, vlansEnabled=vlansEnabled, licenseUpdateStatus=licenseUpdateStatus, modemLastAcqError=modemLastAcqError, remoteIp=remoteIp, vlanTable=vlanTable, vlanFid=vlanFid, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXByteCounterHi=ethRXByteCounterHi, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemIndex=modemIndex, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXMulticasts=ethRXMulticasts, ethGFPDropedFrames=ethGFPDropedFrames, pointToPoint=pointToPoint, modemAcqStatus=modemAcqStatus, ethRXPrevPktDropped=ethRXPrevPktDropped, product=product, radioLoopback=radioLoopback, modemGeneralStatus=modemGeneralStatus, ethQOSTXDropped=ethQOSTXDropped, vlanNumber=vlanNumber, ethTXCollisions=ethTXCollisions, e1t1StatTable=e1t1StatTable, restartcpu=restartcpu, hostname=hostname, localIpMask=localIpMask, e1t1StatEntry=e1t1StatEntry, ethRXByteCounterLow=ethRXByteCounterLow, modemCarrierOffset=modemCarrierOffset, radioTxPower=radioTxPower, ethTXExcessiveDefers=ethTXExcessiveDefers, ethQOSTXFrames=ethQOSTXFrames, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXLongEvents=ethRXLongEvents, ethTXVlanTags=ethTXVlanTags, modemSymbolRateRx=modemSymbolRateRx, sysDateAndTime=sysDateAndTime, radioTable=radioTable, ipRadioCfg=ipRadioCfg, ethRXPauseFrames=ethRXPauseFrames, ethTXDones=ethTXDones, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXLateCollisions=ethTXLateCollisions, vlanPortmap=vlanPortmap)
