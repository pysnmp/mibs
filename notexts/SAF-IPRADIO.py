...
mibBuilder.exportSymbols("SAF-IPRADIO", modemE1T1ChannelMask=modemE1T1ChannelMask, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioGenStatus=radioGenStatus, radioTxFrequency=radioTxFrequency, vlanNumber=vlanNumber, pointToPoint=pointToPoint, ethRXPrevPktDropped=ethRXPrevPktDropped, localIp=localIp, e1t1StatEntry=e1t1StatEntry, e1t1AIS=e1t1AIS, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethQOSRXQ2Frames=ethQOSRXQ2Frames, localIpMask=localIpMask, modemBackgroundBlockErrror=modemBackgroundBlockErrror, product=product, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ipRadioCfg=ipRadioCfg, vlanPortType=vlanPortType, vlanCfgStat=vlanCfgStat, modemACMethernetCapacity=modemACMethernetCapacity, modemACMmodulationMax=modemACMmodulationMax, ethGFPFCSErrors=ethGFPFCSErrors, ethTXPauseFrames=ethTXPauseFrames, modemRadialMSE=modemRadialMSE, modemUnavailtime=modemUnavailtime, atpcTxPowerCorrection=atpcTxPowerCorrection, licenseUpdateStatus=licenseUpdateStatus, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemStatistics=modemStatistics, modemEthernetCapacity=modemEthernetCapacity, aTPCEntry=aTPCEntry, modemEntry=modemEntry, modemACMtotalCapacity=modemACMtotalCapacity, modemStandard=modemStandard, radioEntry=radioEntry, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethGFPCHECErrors=ethGFPCHECErrors, loopback_tributary_mask=loopback_tributary_mask, modemAcqStatus=modemAcqStatus, ethGFPDelineationErrors=ethGFPDelineationErrors, ethQOSTXDropped=ethQOSTXDropped, ipRadioMgmt=ipRadioMgmt, radioRxFrequency=radioRxFrequency, modemLastAcqError=modemLastAcqError, licenseMask=licenseMask, license=license, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, sysDateAndTime=sysDateAndTime, modemCountTime=modemCountTime, modemErroredSecondRatio=modemErroredSecondRatio, restartcpu=restartcpu, ethQOSTXFrames=ethQOSTXFrames, ethTXUnderruns=ethTXUnderruns, radioTxMute=radioTxMute, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemTotalBlockNumber=modemTotalBlockNumber, ethRXDvEvent=ethRXDvEvent, e1t1ChannelNr=e1t1ChannelNr, modemUptime=modemUptime, modemIndex=modemIndex, modemLDPCdecoderStress=modemLDPCdecoderStress, sysTemperature=sysTemperature, aTPCTable=aTPCTable, ethRXLongEvents=ethRXLongEvents, writeConfig=writeConfig, modemErroredBlock=modemErroredBlock, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemModulation=modemModulation, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXDribleNibbles=ethRXDribleNibbles, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemGeneralStatus=modemGeneralStatus, ethTXGiants=ethTXGiants, ethTXMaxCollisions=ethTXMaxCollisions, modemTable=modemTable, tehnika=tehnika, ipRadioStat=ipRadioStat, ethRXByteCounterLow=ethRXByteCounterLow, ethTXControlFrames=ethTXControlFrames, ethTXVlanTags=ethTXVlanTags, ethTXLengthCheckErrors=ethTXLengthCheckErrors, radioLoopback=radioLoopback, vlanTable=vlanTable, ethRXDones=ethRXDones, atpcIndex=atpcIndex, ethTXMulticasts=ethTXMulticasts, ethTXBroadcasts=ethTXBroadcasts, hostname=hostname, vlanFid=vlanFid, ethRXBroadcasts=ethRXBroadcasts, description=description, radioRxLevel=radioRxLevel, ethRXCRCErrors=ethRXCRCErrors, ethRXPauseFrames=ethRXPauseFrames, ethTXByteCounterHi=ethTXByteCounterHi, radioTable=radioTable, vlanPortmap=vlanPortmap, ethTXCRCErrors=ethTXCRCErrors, ethTXLateCollisions=ethTXLateCollisions, vlanRowStatus=vlanRowStatus, modemTotalCapacity=modemTotalCapacity, ethTXDones=ethTXDones, modemBandwith=modemBandwith, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemACMengine=modemACMengine, ethGFPDropedFrames=ethGFPDropedFrames, loopbacks=loopbacks, modemErroredSecond=modemErroredSecond, ethRXCodeErrors=ethRXCodeErrors, ethRXByteCounterHi=ethRXByteCounterHi, modemInternalAGCgain=modemInternalAGCgain, ethTXBackpresEvents=ethTXBackpresEvents, ipRadioCfgNetwork=ipRadioCfgNetwork, vlanEntry=vlanEntry, atpcEnabled=atpcEnabled, modemRowStatus=modemRowStatus, ethTXByteCounterLow=ethTXByteCounterLow, ipRadio=ipRadio, modemSymbolRateTx=modemSymbolRateTx, radioTxPower=radioTxPower, vlansEnabled=vlansEnabled, ethTXCollisions=ethTXCollisions, ethRXMulticasts=ethRXMulticasts, modemACMmodulationMin=modemACMmodulationMin, modemSymbolRateRx=modemSymbolRateRx, ethTXExcessiveDefers=ethTXExcessiveDefers, ipRadioStatEth=ipRadioStatEth, radioDuplexShift=radioDuplexShift, modemE1T1Channels=modemE1T1Channels, modemCarrierOffset=modemCarrierOffset, safip=safip, microwaveRadio=microwaveRadio, radioIndex=radioIndex, ethRXControlFrames=ethRXControlFrames, e1t1StatTable=e1t1StatTable, remoteIp=remoteIp, e1t1LOS=e1t1LOS, radioSide=radioSide, ethTXWireByteCounterHi=ethTXWireByteCounterHi, saf=saf)
