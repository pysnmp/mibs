...
mibBuilder.exportSymbols("SAF-IPRADIO", ethGFPCHECErrors=ethGFPCHECErrors, ethRXBroadcasts=ethRXBroadcasts, ethTXBackpresEvents=ethTXBackpresEvents, modemErroredSecond=modemErroredSecond, ethRXByteCounterHi=ethRXByteCounterHi, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, e1t1StatEntry=e1t1StatEntry, radioTxPower=radioTxPower, radioTxFrequency=radioTxFrequency, radioTable=radioTable, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioIndex=radioIndex, modemACMengine=modemACMengine, saf=saf, ethTXByteCounterLow=ethTXByteCounterLow, modemGeneralStatus=modemGeneralStatus, ipRadioStat=ipRadioStat, modemIndex=modemIndex, ethQOSTXFrames=ethQOSTXFrames, pointToPoint=pointToPoint, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemRadialMSE=modemRadialMSE, ethQOSTXDropped=ethQOSTXDropped, modemSymbolRateTx=modemSymbolRateTx, ipRadioMgmt=ipRadioMgmt, hostname=hostname, modemACMmodulationMax=modemACMmodulationMax, localIpMask=localIpMask, modemBandwith=modemBandwith, modemACMethernetCapacity=modemACMethernetCapacity, modemEntry=modemEntry, vlanPortType=vlanPortType, ethTXLengthCheckErrors=ethTXLengthCheckErrors, licenseUpdateStatus=licenseUpdateStatus, ethRXDribleNibbles=ethRXDribleNibbles, ethTXPauseFrames=ethTXPauseFrames, ipRadio=ipRadio, ethGFPDelineationErrors=ethGFPDelineationErrors, radioRxFrequency=radioRxFrequency, ethRXControlFrames=ethRXControlFrames, ethRXDones=ethRXDones, ethTXCollisions=ethTXCollisions, loopback_tributary_mask=loopback_tributary_mask, modemErroredSecondRatio=modemErroredSecondRatio, ethTXUnderruns=ethTXUnderruns, modemUnavailtime=modemUnavailtime, ethRXMulticasts=ethRXMulticasts, microwaveRadio=microwaveRadio, remoteIp=remoteIp, aTPCTable=aTPCTable, ethTXByteCounterHi=ethTXByteCounterHi, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXMaxCollisions=ethTXMaxCollisions, ethRXPauseFrames=ethRXPauseFrames, radioGenStatus=radioGenStatus, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXDones=ethTXDones, ethTXGiants=ethTXGiants, product=product, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, aTPCEntry=aTPCEntry, ethRXLongEvents=ethRXLongEvents, license=license, modemACMmodulationMin=modemACMmodulationMin, modemLastAcqError=modemLastAcqError, vlanPortmap=vlanPortmap, radioTxMute=radioTxMute, radioLoopback=radioLoopback, localIp=localIp, ethRXTruncatedFrames=ethRXTruncatedFrames, e1t1AIS=e1t1AIS, modemE1T1Channels=modemE1T1Channels, atpcEnabled=atpcEnabled, atpcTxPowerCorrection=atpcTxPowerCorrection, radioDuplexShift=radioDuplexShift, modemE1T1ChannelMask=modemE1T1ChannelMask, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlanTable=vlanTable, modemUptime=modemUptime, vlanEntry=vlanEntry, modemStatistics=modemStatistics, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXDvEvent=ethRXDvEvent, ethTXVlanTags=ethTXVlanTags, description=description, radioSide=radioSide, modemInternalAGCgain=modemInternalAGCgain, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, vlanNumber=vlanNumber, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemStandard=modemStandard, radioEntry=radioEntry, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ipRadioCfg=ipRadioCfg, ipRadioCfgGeneral=ipRadioCfgGeneral, modemErroredBlock=modemErroredBlock, ethRXPrevPktDropped=ethRXPrevPktDropped, modemTable=modemTable, modemCarrierOffset=modemCarrierOffset, vlanRowStatus=vlanRowStatus, modemRowStatus=modemRowStatus, writeConfig=writeConfig, modemTotalCapacity=modemTotalCapacity, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXLateCollisions=ethTXLateCollisions, modemEthernetCapacity=modemEthernetCapacity, ethRXCodeErrors=ethRXCodeErrors, modemAcqStatus=modemAcqStatus, safip=safip, modemSymbolRateRx=modemSymbolRateRx, ethTXMulticasts=ethTXMulticasts, ethTXControlFrames=ethTXControlFrames, ethGFPFCSErrors=ethGFPFCSErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXByteCounterLow=ethRXByteCounterLow, vlanCfgStat=vlanCfgStat, ipRadioStatEth=ipRadioStatEth, restartcpu=restartcpu, ethRXCRCErrors=ethRXCRCErrors, tehnika=tehnika, vlansEnabled=vlansEnabled, modemTotalBlockNumber=modemTotalBlockNumber, licenseMask=licenseMask, sysTemperature=sysTemperature, ethGFPDropedFrames=ethGFPDropedFrames, ethTXCRCErrors=ethTXCRCErrors, vlanFid=vlanFid, ethTXBroadcasts=ethTXBroadcasts, loopbacks=loopbacks, ethRXVlanTagsDetected=ethRXVlanTagsDetected, e1t1ChannelNr=e1t1ChannelNr, ethRXUnsupOpcodes=ethRXUnsupOpcodes, e1t1LOS=e1t1LOS, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ipRadioCfgNetwork=ipRadioCfgNetwork, modemModulation=modemModulation, modemCountTime=modemCountTime, ethTXExcessiveDefers=ethTXExcessiveDefers, radioRxLevel=radioRxLevel, atpcIndex=atpcIndex, modemACMtotalCapacity=modemACMtotalCapacity, sysDateAndTime=sysDateAndTime, e1t1StatTable=e1t1StatTable)
