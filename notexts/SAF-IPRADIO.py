...
mibBuilder.exportSymbols("SAF-IPRADIO", product=product, modemE1T1ChannelMask=modemE1T1ChannelMask, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXExcessiveDefers=ethTXExcessiveDefers, modemIndex=modemIndex, modemACMethernetCapacity=modemACMethernetCapacity, ethRXBroadcasts=ethRXBroadcasts, vlanPortType=vlanPortType, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXCodeErrors=ethRXCodeErrors, ipRadio=ipRadio, ethRXMulticasts=ethRXMulticasts, modemSeverelyErroredSecond=modemSeverelyErroredSecond, e1t1AIS=e1t1AIS, ethRXLongEvents=ethRXLongEvents, ethTXBroadcasts=ethTXBroadcasts, modemUptime=modemUptime, license=license, ethTXUnderruns=ethTXUnderruns, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioTxMute=radioTxMute, modemTotalBlockNumber=modemTotalBlockNumber, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXCollisions=ethTXCollisions, e1t1LOS=e1t1LOS, tehnika=tehnika, modemInternalAGCgain=modemInternalAGCgain, ethTXByteCounterLow=ethTXByteCounterLow, e1t1StatTable=e1t1StatTable, modemCountTime=modemCountTime, saf=saf, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ipRadioStatEth=ipRadioStatEth, loopbacks=loopbacks, licenseUpdateStatus=licenseUpdateStatus, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXWireByteCounterLow=ethTXWireByteCounterLow, vlansEnabled=vlansEnabled, modemLDPCdecoderStress=modemLDPCdecoderStress, modemEthernetCapacity=modemEthernetCapacity, ethRXByteCounterHi=ethRXByteCounterHi, modemTotalCapacity=modemTotalCapacity, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemModulation=modemModulation, radioEntry=radioEntry, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXDribleNibbles=ethRXDribleNibbles, licenseMask=licenseMask, modemLastAcqError=modemLastAcqError, aTPCEntry=aTPCEntry, ethRXDvEvent=ethRXDvEvent, ethGFPDropedFrames=ethGFPDropedFrames, modemStandard=modemStandard, modemErroredSecondRatio=modemErroredSecondRatio, radioDuplexShift=radioDuplexShift, radioTxFrequency=radioTxFrequency, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethQOSTXDropped=ethQOSTXDropped, e1t1StatEntry=e1t1StatEntry, ethRXCRCErrors=ethRXCRCErrors, radioLoopback=radioLoopback, ethRXPauseFrames=ethRXPauseFrames, pointToPoint=pointToPoint, restartcpu=restartcpu, ethGFPFCSErrors=ethGFPFCSErrors, modemUnavailtime=modemUnavailtime, vlanEntry=vlanEntry, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemEntry=modemEntry, ethRXControlFrames=ethRXControlFrames, radioRxFrequency=radioRxFrequency, modemGeneralStatus=modemGeneralStatus, modemCarrierOffset=modemCarrierOffset, radioTxPower=radioTxPower, ethTXDones=ethTXDones, atpcEnabled=atpcEnabled, ethRXByteCounterLow=ethRXByteCounterLow, radioGenStatus=radioGenStatus, description=description, ethRXUnsupOpcodes=ethRXUnsupOpcodes, hostname=hostname, ethTXByteCounterHi=ethTXByteCounterHi, ipRadioMgmt=ipRadioMgmt, modemACMengine=modemACMengine, microwaveRadio=microwaveRadio, localIp=localIp, safip=safip, vlanTable=vlanTable, ethRXDones=ethRXDones, modemRowStatus=modemRowStatus, modemTable=modemTable, aTPCTable=aTPCTable, vlanCfgStat=vlanCfgStat, modemAcqStatus=modemAcqStatus, modemStatistics=modemStatistics, ethTXBackpresEvents=ethTXBackpresEvents, modemErroredSecond=modemErroredSecond, ethTXLateCollisions=ethTXLateCollisions, vlanPortmap=vlanPortmap, loopback_tributary_mask=loopback_tributary_mask, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlanRowStatus=vlanRowStatus, radioIndex=radioIndex, modemBandwith=modemBandwith, modemACMtotalCapacity=modemACMtotalCapacity, ipRadioStat=ipRadioStat, ipRadioCfgNetwork=ipRadioCfgNetwork, sysDateAndTime=sysDateAndTime, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXVlanTags=ethTXVlanTags, ethGFPCHECErrors=ethGFPCHECErrors, modemRadialMSE=modemRadialMSE, radioSide=radioSide, localIpMask=localIpMask, ipRadioCfgGeneral=ipRadioCfgGeneral, atpcTxPowerCorrection=atpcTxPowerCorrection, radioTable=radioTable, vlanFid=vlanFid, e1t1ChannelNr=e1t1ChannelNr, vlanNumber=vlanNumber, ipRadioCfg=ipRadioCfg, modemSymbolRateTx=modemSymbolRateTx, modemE1T1Channels=modemE1T1Channels, ethTXCRCErrors=ethTXCRCErrors, modemACMmodulationMax=modemACMmodulationMax, writeConfig=writeConfig, ethQOSRXQ2Frames=ethQOSRXQ2Frames, remoteIp=remoteIp, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXPauseFrames=ethTXPauseFrames, ethTXMaxCollisions=ethTXMaxCollisions, modemErroredBlock=modemErroredBlock, ethQOSTXFrames=ethQOSTXFrames, ethTXControlFrames=ethTXControlFrames, ethTXMulticasts=ethTXMulticasts, ethTXGiants=ethTXGiants, sysTemperature=sysTemperature, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemACMmodulationMin=modemACMmodulationMin, modemSymbolRateRx=modemSymbolRateRx, radioRxLevel=radioRxLevel, atpcIndex=atpcIndex)
