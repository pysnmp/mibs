...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemStatistics=modemStatistics, vlansEnabled=vlansEnabled, ethTXDones=ethTXDones, vlanRowStatus=vlanRowStatus, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXControlFrames=ethTXControlFrames, radioGenStatus=radioGenStatus, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemInternalAGCgain=modemInternalAGCgain, modemTotalBlockNumber=modemTotalBlockNumber, radioSide=radioSide, vlanNumber=vlanNumber, vlanTable=vlanTable, product=product, e1t1StatEntry=e1t1StatEntry, ethRXByteCounterHi=ethRXByteCounterHi, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXUnderruns=ethTXUnderruns, modemE1T1Channels=modemE1T1Channels, ethGFPCHECErrors=ethGFPCHECErrors, ethTXVlanTags=ethTXVlanTags, ipRadioStat=ipRadioStat, ethTXLateCollisions=ethTXLateCollisions, radioTxFrequency=radioTxFrequency, radioRxFrequency=radioRxFrequency, radioLoopback=radioLoopback, modemACMmodulationMax=modemACMmodulationMax, modemTable=modemTable, modemE1T1ChannelMask=modemE1T1ChannelMask, modemGeneralStatus=modemGeneralStatus, ethTXBackpresEvents=ethTXBackpresEvents, modemBandwith=modemBandwith, ipRadioCfgNetwork=ipRadioCfgNetwork, modemIndex=modemIndex, modemStandard=modemStandard, radioTxMute=radioTxMute, radioIndex=radioIndex, ethGFPFCSErrors=ethGFPFCSErrors, ethRXUnsupOpcodes=ethRXUnsupOpcodes, vlanCfgStat=vlanCfgStat, modemACMengine=modemACMengine, ethRXBroadcasts=ethRXBroadcasts, pointToPoint=pointToPoint, ethRXControlFrames=ethRXControlFrames, modemErroredSecondRatio=modemErroredSecondRatio, ethTXExcessiveDefers=ethTXExcessiveDefers, ethGFPDelineationErrors=ethGFPDelineationErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemModulation=modemModulation, ethGFPDropedFrames=ethGFPDropedFrames, ipRadioStatEth=ipRadioStatEth, radioDuplexShift=radioDuplexShift, modemErroredSecond=modemErroredSecond, e1t1StatTable=e1t1StatTable, modemUnavailtime=modemUnavailtime, ipRadioMgmt=ipRadioMgmt, ipRadio=ipRadio, ethRXVlanTagsDetected=ethRXVlanTagsDetected, loopbacks=loopbacks, modemEthernetCapacity=modemEthernetCapacity, ethRXLongEvents=ethRXLongEvents, ethRXByteCounterLow=ethRXByteCounterLow, ethTXMaxCollisions=ethTXMaxCollisions, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemUptime=modemUptime, ethTXGiants=ethTXGiants, vlanPortmap=vlanPortmap, ethRXDones=ethRXDones, ethTXCRCErrors=ethTXCRCErrors, hostname=hostname, modemACMtotalCapacity=modemACMtotalCapacity, modemAcqStatus=modemAcqStatus, modemCarrierOffset=modemCarrierOffset, description=description, modemCountTime=modemCountTime, modemACMethernetCapacity=modemACMethernetCapacity, ethRXDribleNibbles=ethRXDribleNibbles, modemSymbolRateRx=modemSymbolRateRx, ethRXMulticasts=ethRXMulticasts, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, license=license, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXDvEvent=ethRXDvEvent, ethTXByteCounterHi=ethTXByteCounterHi, microwaveRadio=microwaveRadio, ethRXPrevPktDropped=ethRXPrevPktDropped, e1t1AIS=e1t1AIS, licenseUpdateStatus=licenseUpdateStatus, e1t1ChannelNr=e1t1ChannelNr, remoteIp=remoteIp, modemEntry=modemEntry, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXPauseFrames=ethTXPauseFrames, radioTable=radioTable, modemTotalCapacity=modemTotalCapacity, loopback_tributary_mask=loopback_tributary_mask, modemACMmodulationMin=modemACMmodulationMin, ethTXByteCounterLow=ethTXByteCounterLow, sysTemperature=sysTemperature, ethRXCRCErrors=ethRXCRCErrors, radioTxPower=radioTxPower, localIpMask=localIpMask, atpcTxPowerCorrection=atpcTxPowerCorrection, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemSymbolRateTx=modemSymbolRateTx, tehnika=tehnika, aTPCTable=aTPCTable, radioEntry=radioEntry, aTPCEntry=aTPCEntry, sysDateAndTime=sysDateAndTime, safip=safip, modemLastAcqError=modemLastAcqError, ipRadioCfgGeneral=ipRadioCfgGeneral, vlanFid=vlanFid, e1t1LOS=e1t1LOS, modemErroredBlock=modemErroredBlock, restartcpu=restartcpu, ethQOSTXFrames=ethQOSTXFrames, vlanPortType=vlanPortType, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethQOSTXDropped=ethQOSTXDropped, ethRXTruncatedFrames=ethRXTruncatedFrames, modemRowStatus=modemRowStatus, modemBackgroundBlockErrror=modemBackgroundBlockErrror, writeConfig=writeConfig, radioRxLevel=radioRxLevel, atpcIndex=atpcIndex, atpcEnabled=atpcEnabled, ethTXBroadcasts=ethTXBroadcasts, localIp=localIp, ethRXPauseFrames=ethRXPauseFrames, ethTXCollisions=ethTXCollisions, ipRadioCfg=ipRadioCfg, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXCodeErrors=ethRXCodeErrors, licenseMask=licenseMask, modemRadialMSE=modemRadialMSE, ethTXLengthCheckErrors=ethTXLengthCheckErrors, saf=saf, vlanEntry=vlanEntry, ethTXMulticasts=ethTXMulticasts)
