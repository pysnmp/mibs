...
mibBuilder.exportSymbols("SAF-IPRADIO", vlanNumber=vlanNumber, e1t1ChannelNr=e1t1ChannelNr, modemGeneralStatus=modemGeneralStatus, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethQOSTXDropped=ethQOSTXDropped, ipRadioCfg=ipRadioCfg, radioTable=radioTable, ethRXDribleNibbles=ethRXDribleNibbles, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXGiants=ethTXGiants, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemSymbolRateRx=modemSymbolRateRx, pointToPoint=pointToPoint, ethRXMulticasts=ethRXMulticasts, ethTXControlFrames=ethTXControlFrames, e1t1LOS=e1t1LOS, ethRXByteCounterLow=ethRXByteCounterLow, radioSide=radioSide, ethRXDvEvent=ethRXDvEvent, sysDateAndTime=sysDateAndTime, vlanPortType=vlanPortType, ethRXByteCounterHi=ethRXByteCounterHi, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemErroredSecond=modemErroredSecond, ethGFPDelineationErrors=ethGFPDelineationErrors, atpcEnabled=atpcEnabled, ethRXPauseFrames=ethRXPauseFrames, e1t1StatEntry=e1t1StatEntry, ethTXDones=ethTXDones, modemRowStatus=modemRowStatus, radioTxMute=radioTxMute, modemErroredBlock=modemErroredBlock, radioRxLevel=radioRxLevel, ethRXBroadcasts=ethRXBroadcasts, modemEthernetCapacity=modemEthernetCapacity, modemACMmodulationMax=modemACMmodulationMax, vlanEntry=vlanEntry, saf=saf, sysTemperature=sysTemperature, modemTotalBlockNumber=modemTotalBlockNumber, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemACMethernetCapacity=modemACMethernetCapacity, ethTXCollisions=ethTXCollisions, ethGFPFCSErrors=ethGFPFCSErrors, tehnika=tehnika, ethTXVlanTags=ethTXVlanTags, remoteIp=remoteIp, ethGFPDropedFrames=ethGFPDropedFrames, ethRXLongEvents=ethRXLongEvents, radioEntry=radioEntry, ethTXCRCErrors=ethTXCRCErrors, writeConfig=writeConfig, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXTruncatedFrames=ethRXTruncatedFrames, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXControlFrames=ethRXControlFrames, e1t1AIS=e1t1AIS, modemE1T1ChannelMask=modemE1T1ChannelMask, localIp=localIp, license=license, loopback_tributary_mask=loopback_tributary_mask, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, product=product, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, description=description, radioTxPower=radioTxPower, modemBandwith=modemBandwith, modemACMmodulationMin=modemACMmodulationMin, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemE1T1Channels=modemE1T1Channels, radioLoopback=radioLoopback, vlanTable=vlanTable, ipRadioMgmt=ipRadioMgmt, radioDuplexShift=radioDuplexShift, modemEntry=modemEntry, modemCarrierOffset=modemCarrierOffset, modemUnavailtime=modemUnavailtime, licenseMask=licenseMask, radioIndex=radioIndex, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlansEnabled=vlansEnabled, ethTXPauseFrames=ethTXPauseFrames, modemRadialMSE=modemRadialMSE, vlanPortmap=vlanPortmap, modemUptime=modemUptime, ethRXCRCErrors=ethRXCRCErrors, loopbacks=loopbacks, localIpMask=localIpMask, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXByteCounterHi=ethTXByteCounterHi, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXCodeErrors=ethRXCodeErrors, modemErroredSecondRatio=modemErroredSecondRatio, atpcIndex=atpcIndex, modemIndex=modemIndex, aTPCEntry=aTPCEntry, vlanRowStatus=vlanRowStatus, radioTxFrequency=radioTxFrequency, hostname=hostname, e1t1StatTable=e1t1StatTable, radioRxFrequency=radioRxFrequency, modemInternalAGCgain=modemInternalAGCgain, ethQOSTXFrames=ethQOSTXFrames, ethTXByteCounterLow=ethTXByteCounterLow, ethTXMulticasts=ethTXMulticasts, vlanCfgStat=vlanCfgStat, ipRadio=ipRadio, radioGenStatus=radioGenStatus, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemAcqStatus=modemAcqStatus, ethTXLateCollisions=ethTXLateCollisions, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXBackpresEvents=ethTXBackpresEvents, ethTXExcessiveDefers=ethTXExcessiveDefers, aTPCTable=aTPCTable, ethGFPCHECErrors=ethGFPCHECErrors, modemACMengine=modemACMengine, ethRXDones=ethRXDones, ethTXUnderruns=ethTXUnderruns, ethTXBroadcasts=ethTXBroadcasts, ipRadioCfgNetwork=ipRadioCfgNetwork, licenseUpdateStatus=licenseUpdateStatus, modemModulation=modemModulation, modemSymbolRateTx=modemSymbolRateTx, vlanFid=vlanFid, ipRadioCfgGeneral=ipRadioCfgGeneral, modemLastAcqError=modemLastAcqError, modemTotalCapacity=modemTotalCapacity, ethQOSRXQ2Frames=ethQOSRXQ2Frames, atpcTxPowerCorrection=atpcTxPowerCorrection, safip=safip, modemStatistics=modemStatistics, ipRadioStatEth=ipRadioStatEth, ipRadioStat=ipRadioStat, modemTable=modemTable, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, microwaveRadio=microwaveRadio, ethTXMaxCollisions=ethTXMaxCollisions, modemCountTime=modemCountTime, restartcpu=restartcpu, modemACMtotalCapacity=modemACMtotalCapacity, modemStandard=modemStandard)
