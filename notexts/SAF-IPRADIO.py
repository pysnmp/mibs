...
mibBuilder.exportSymbols("SAF-IPRADIO", modemRadialMSE=modemRadialMSE, remoteIp=remoteIp, radioLoopback=radioLoopback, atpcIndex=atpcIndex, modemIndex=modemIndex, vlanFid=vlanFid, modemErroredSecond=modemErroredSecond, ethRXPauseFrames=ethRXPauseFrames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXVlanTags=ethTXVlanTags, ethGFPDelineationErrors=ethGFPDelineationErrors, licenseMask=licenseMask, localIpMask=localIpMask, ethRXDones=ethRXDones, modemStandard=modemStandard, modemErroredSecondRatio=modemErroredSecondRatio, modemInternalAGCgain=modemInternalAGCgain, ethQOSTXDropped=ethQOSTXDropped, modemBandwith=modemBandwith, modemCountTime=modemCountTime, ethTXBroadcasts=ethTXBroadcasts, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXMulticasts=ethTXMulticasts, e1t1LOS=e1t1LOS, modemTable=modemTable, e1t1AIS=e1t1AIS, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXDones=ethTXDones, radioSide=radioSide, radioRxLevel=radioRxLevel, radioDuplexShift=radioDuplexShift, writeConfig=writeConfig, modemCarrierOffset=modemCarrierOffset, safip=safip, ethTXCRCErrors=ethTXCRCErrors, ethRXCodeErrors=ethRXCodeErrors, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXByteCounterHi=ethRXByteCounterHi, description=description, ethTXMaxCollisions=ethTXMaxCollisions, ipRadioCfgGeneral=ipRadioCfgGeneral, vlanCfgStat=vlanCfgStat, modemE1T1ChannelMask=modemE1T1ChannelMask, modemTotalCapacity=modemTotalCapacity, radioTable=radioTable, microwaveRadio=microwaveRadio, sysTemperature=sysTemperature, vlanRowStatus=vlanRowStatus, ethTXPauseFrames=ethTXPauseFrames, modemUnavailtime=modemUnavailtime, aTPCTable=aTPCTable, modemGeneralStatus=modemGeneralStatus, localIp=localIp, ethRXTruncatedFrames=ethRXTruncatedFrames, restartcpu=restartcpu, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemStatistics=modemStatistics, modemLDPCdecoderStress=modemLDPCdecoderStress, ethQOSTXFrames=ethQOSTXFrames, atpcTxPowerCorrection=atpcTxPowerCorrection, license=license, modemErroredBlock=modemErroredBlock, ipRadio=ipRadio, modemSymbolRateRx=modemSymbolRateRx, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXByteCounterLow=ethRXByteCounterLow, ethTXCollisions=ethTXCollisions, ethGFPFCSErrors=ethGFPFCSErrors, ethRXPrevPktDropped=ethRXPrevPktDropped, vlanPortmap=vlanPortmap, hostname=hostname, modemEntry=modemEntry, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemTotalBlockNumber=modemTotalBlockNumber, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioRxFrequency=radioRxFrequency, ethTXBackpresEvents=ethTXBackpresEvents, ethTXByteCounterHi=ethTXByteCounterHi, vlanEntry=vlanEntry, loopback_tributary_mask=loopback_tributary_mask, ethTXControlFrames=ethTXControlFrames, ethGFPDropedFrames=ethGFPDropedFrames, licenseUpdateStatus=licenseUpdateStatus, modemUptime=modemUptime, saf=saf, modemSymbolRateTx=modemSymbolRateTx, ethTXUnderruns=ethTXUnderruns, sysDateAndTime=sysDateAndTime, ethTXLateCollisions=ethTXLateCollisions, atpcEnabled=atpcEnabled, ethRXLongEvents=ethRXLongEvents, radioIndex=radioIndex, modemACMethernetCapacity=modemACMethernetCapacity, ethRXMulticasts=ethRXMulticasts, modemRowStatus=modemRowStatus, vlanPortType=vlanPortType, vlanTable=vlanTable, e1t1ChannelNr=e1t1ChannelNr, ipRadioCfg=ipRadioCfg, tehnika=tehnika, pointToPoint=pointToPoint, loopbacks=loopbacks, radioTxFrequency=radioTxFrequency, aTPCEntry=aTPCEntry, radioTxPower=radioTxPower, ethRXControlFrames=ethRXControlFrames, radioEntry=radioEntry, ethRXCRCErrors=ethRXCRCErrors, vlansEnabled=vlansEnabled, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXDribleNibbles=ethRXDribleNibbles, modemAcqStatus=modemAcqStatus, modemE1T1Channels=modemE1T1Channels, ipRadioMgmt=ipRadioMgmt, modemACMtotalCapacity=modemACMtotalCapacity, ethGFPCHECErrors=ethGFPCHECErrors, ethRXDvEvent=ethRXDvEvent, e1t1StatEntry=e1t1StatEntry, modemLastAcqError=modemLastAcqError, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ipRadioStatEth=ipRadioStatEth, vlanNumber=vlanNumber, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemEthernetCapacity=modemEthernetCapacity, radioGenStatus=radioGenStatus, product=product, radioTxMute=radioTxMute, modemModulation=modemModulation, e1t1StatTable=e1t1StatTable, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemACMmodulationMax=modemACMmodulationMax, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemACMengine=modemACMengine, ipRadioStat=ipRadioStat, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXByteCounterLow=ethTXByteCounterLow, ethRXBroadcasts=ethRXBroadcasts, ethTXGiants=ethTXGiants, modemACMmodulationMin=modemACMmodulationMin)
