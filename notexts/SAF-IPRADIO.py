...
mibBuilder.exportSymbols("SAF-IPRADIO", modemRowStatus=modemRowStatus, ipRadioCfgNetwork=ipRadioCfgNetwork, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, pointToPoint=pointToPoint, modemACMtotalCapacity=modemACMtotalCapacity, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXControlFrames=ethTXControlFrames, sysTemperature=sysTemperature, ethTXUnderruns=ethTXUnderruns, ethRXLongEvents=ethRXLongEvents, modemACMmodulationMin=modemACMmodulationMin, modemIndex=modemIndex, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, e1t1LOS=e1t1LOS, modemBackgroundBlockErrror=modemBackgroundBlockErrror, hostname=hostname, radioTxMute=radioTxMute, vlansEnabled=vlansEnabled, licenseUpdateStatus=licenseUpdateStatus, modemRadialMSE=modemRadialMSE, vlanFid=vlanFid, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXUnsupOpcodes=ethRXUnsupOpcodes, atpcEnabled=atpcEnabled, e1t1StatEntry=e1t1StatEntry, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemStandard=modemStandard, ethQOSTXFrames=ethQOSTXFrames, radioSide=radioSide, tehnika=tehnika, ethRXByteCounterHi=ethRXByteCounterHi, vlanTable=vlanTable, ethQOSTXDropped=ethQOSTXDropped, ethRXDribleNibbles=ethRXDribleNibbles, description=description, radioRxLevel=radioRxLevel, modemInternalAGCgain=modemInternalAGCgain, e1t1AIS=e1t1AIS, modemACMmodulationMax=modemACMmodulationMax, ethTXBackpresEvents=ethTXBackpresEvents, loopbacks=loopbacks, saf=saf, ethTXVlanTags=ethTXVlanTags, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlanPortType=vlanPortType, radioRxFrequency=radioRxFrequency, ethTXLateCollisions=ethTXLateCollisions, vlanCfgStat=vlanCfgStat, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemBandwith=modemBandwith, localIp=localIp, ethRXDvEvent=ethRXDvEvent, e1t1ChannelNr=e1t1ChannelNr, safip=safip, modemE1T1Channels=modemE1T1Channels, vlanRowStatus=vlanRowStatus, ethRXPauseFrames=ethRXPauseFrames, ethRXDones=ethRXDones, ipRadioCfg=ipRadioCfg, radioGenStatus=radioGenStatus, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXGiants=ethTXGiants, modemSymbolRateRx=modemSymbolRateRx, modemEntry=modemEntry, ethTXByteCounterHi=ethTXByteCounterHi, modemModulation=modemModulation, ethRXControlFrames=ethRXControlFrames, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioEntry=radioEntry, radioLoopback=radioLoopback, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioTxPower=radioTxPower, ethTXMaxCollisions=ethTXMaxCollisions, ethGFPDropedFrames=ethGFPDropedFrames, localIpMask=localIpMask, ipRadioMgmt=ipRadioMgmt, aTPCEntry=aTPCEntry, modemACMengine=modemACMengine, ethTXByteCounterLow=ethTXByteCounterLow, restartcpu=restartcpu, modemUptime=modemUptime, atpcIndex=atpcIndex, modemErroredBlock=modemErroredBlock, modemErroredSecondRatio=modemErroredSecondRatio, radioDuplexShift=radioDuplexShift, modemEthernetCapacity=modemEthernetCapacity, modemLastAcqError=modemLastAcqError, modemStatistics=modemStatistics, ethTXPauseFrames=ethTXPauseFrames, ipRadio=ipRadio, radioTable=radioTable, ethGFPFCSErrors=ethGFPFCSErrors, modemE1T1ChannelMask=modemE1T1ChannelMask, modemCountTime=modemCountTime, ethRXByteCounterLow=ethRXByteCounterLow, vlanPortmap=vlanPortmap, ethTXMulticasts=ethTXMulticasts, ethGFPCHECErrors=ethGFPCHECErrors, modemCarrierOffset=modemCarrierOffset, ethTXDones=ethTXDones, licenseMask=licenseMask, remoteIp=remoteIp, modemErroredSecond=modemErroredSecond, modemAcqStatus=modemAcqStatus, product=product, loopback_tributary_mask=loopback_tributary_mask, ethRXBroadcasts=ethRXBroadcasts, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemUnavailtime=modemUnavailtime, writeConfig=writeConfig, ethRXMulticasts=ethRXMulticasts, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemTotalBlockNumber=modemTotalBlockNumber, atpcTxPowerCorrection=atpcTxPowerCorrection, ipRadioStat=ipRadioStat, ethRXCodeErrors=ethRXCodeErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemSymbolRateTx=modemSymbolRateTx, radioIndex=radioIndex, vlanEntry=vlanEntry, ethTXCRCErrors=ethTXCRCErrors, ethRXPrevPktDropped=ethRXPrevPktDropped, ipRadioStatEth=ipRadioStatEth, license=license, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, microwaveRadio=microwaveRadio, ethRXCRCErrors=ethRXCRCErrors, sysDateAndTime=sysDateAndTime, modemTable=modemTable, modemGeneralStatus=modemGeneralStatus, vlanNumber=vlanNumber, ethTXBroadcasts=ethTXBroadcasts, modemACMethernetCapacity=modemACMethernetCapacity, aTPCTable=aTPCTable, e1t1StatTable=e1t1StatTable, modemTotalCapacity=modemTotalCapacity, radioTxFrequency=radioTxFrequency, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXCollisions=ethTXCollisions)
