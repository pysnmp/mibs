...
mibBuilder.exportSymbols("SAF-IPRADIO", ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXByteCounterLow=ethRXByteCounterLow, remoteIp=remoteIp, aTPCEntry=aTPCEntry, ethTXByteCounterHi=ethTXByteCounterHi, modemStandard=modemStandard, modemBandwith=modemBandwith, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXControlFrames=ethTXControlFrames, ethTXGiants=ethTXGiants, ethQOSTXFrames=ethQOSTXFrames, radioRxLevel=radioRxLevel, ethTXLateCollisions=ethTXLateCollisions, modemStatistics=modemStatistics, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXPauseFrames=ethTXPauseFrames, ethRXTruncatedFrames=ethRXTruncatedFrames, ethQOSTXDropped=ethQOSTXDropped, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXCollisions=ethTXCollisions, modemSymbolRateTx=modemSymbolRateTx, modemInternalAGCgain=modemInternalAGCgain, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemSymbolRateRx=modemSymbolRateRx, vlanRowStatus=vlanRowStatus, ipRadioStatEth=ipRadioStatEth, modemEntry=modemEntry, ipRadioStat=ipRadioStat, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethGFPDropedFrames=ethGFPDropedFrames, modemUnavailtime=modemUnavailtime, ethTXExcessiveDefers=ethTXExcessiveDefers, modemGeneralStatus=modemGeneralStatus, ethTXByteCounterLow=ethTXByteCounterLow, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ipRadioCfg=ipRadioCfg, vlansEnabled=vlansEnabled, modemTable=modemTable, modemLastAcqError=modemLastAcqError, modemACMtotalCapacity=modemACMtotalCapacity, atpcIndex=atpcIndex, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXPauseFrames=ethRXPauseFrames, radioEntry=radioEntry, modemE1T1Channels=modemE1T1Channels, vlanFid=vlanFid, ethRXMulticasts=ethRXMulticasts, loopback_tributary_mask=loopback_tributary_mask, e1t1ChannelNr=e1t1ChannelNr, vlanPortmap=vlanPortmap, modemBackgroundBlockErrror=modemBackgroundBlockErrror, sysDateAndTime=sysDateAndTime, microwaveRadio=microwaveRadio, localIpMask=localIpMask, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioGenStatus=radioGenStatus, radioSide=radioSide, ethTXUnderruns=ethTXUnderruns, ethRXByteCounterHi=ethRXByteCounterHi, hostname=hostname, modemACMmodulationMax=modemACMmodulationMax, vlanEntry=vlanEntry, e1t1AIS=e1t1AIS, modemAcqStatus=modemAcqStatus, modemErroredSecondRatio=modemErroredSecondRatio, atpcEnabled=atpcEnabled, license=license, ethTXMulticasts=ethTXMulticasts, modemTotalCapacity=modemTotalCapacity, ethTXDones=ethTXDones, sysTemperature=sysTemperature, modemTotalBlockNumber=modemTotalBlockNumber, ipRadioCfgNetwork=ipRadioCfgNetwork, safip=safip, ethTXVlanTags=ethTXVlanTags, modemCarrierOffset=modemCarrierOffset, radioRxFrequency=radioRxFrequency, ethRXCRCErrors=ethRXCRCErrors, ethRXDribleNibbles=ethRXDribleNibbles, ethRXBroadcasts=ethRXBroadcasts, ethTXBroadcasts=ethTXBroadcasts, ethRXPrevPktDropped=ethRXPrevPktDropped, e1t1LOS=e1t1LOS, radioTxMute=radioTxMute, product=product, e1t1StatEntry=e1t1StatEntry, ethRXControlFrames=ethRXControlFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, writeConfig=writeConfig, radioTxFrequency=radioTxFrequency, e1t1StatTable=e1t1StatTable, modemErroredSecond=modemErroredSecond, modemUptime=modemUptime, ethTXMaxCollisions=ethTXMaxCollisions, modemRowStatus=modemRowStatus, modemEthernetCapacity=modemEthernetCapacity, ethRXLongEvents=ethRXLongEvents, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, tehnika=tehnika, modemACMengine=modemACMengine, radioIndex=radioIndex, restartcpu=restartcpu, licenseUpdateStatus=licenseUpdateStatus, radioTxPower=radioTxPower, modemCountTime=modemCountTime, modemModulation=modemModulation, loopbacks=loopbacks, modemIndex=modemIndex, vlanTable=vlanTable, localIp=localIp, radioTable=radioTable, licenseMask=licenseMask, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ipRadio=ipRadio, modemErroredBlock=modemErroredBlock, saf=saf, ethRXDones=ethRXDones, ethTXCRCErrors=ethTXCRCErrors, modemRadialMSE=modemRadialMSE, vlanCfgStat=vlanCfgStat, ethTXWireByteCounterHi=ethTXWireByteCounterHi, vlanPortType=vlanPortType, ethGFPFCSErrors=ethGFPFCSErrors, ethGFPCHECErrors=ethGFPCHECErrors, ethRXDvEvent=ethRXDvEvent, modemACMethernetCapacity=modemACMethernetCapacity, pointToPoint=pointToPoint, ethRXCodeErrors=ethRXCodeErrors, radioLoopback=radioLoopback, aTPCTable=aTPCTable, modemACMmodulationMin=modemACMmodulationMin, modemLDPCdecoderStress=modemLDPCdecoderStress, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ipRadioMgmt=ipRadioMgmt, radioDuplexShift=radioDuplexShift, ethTXBackpresEvents=ethTXBackpresEvents, vlanNumber=vlanNumber, atpcTxPowerCorrection=atpcTxPowerCorrection, description=description, ethQOSRXQ1Frames=ethQOSRXQ1Frames)
