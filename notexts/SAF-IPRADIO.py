...
mibBuilder.exportSymbols("SAF-IPRADIO", vlansEnabled=vlansEnabled, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemInternalAGCgain=modemInternalAGCgain, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, microwaveRadio=microwaveRadio, ethTXVlanTags=ethTXVlanTags, radioLoopback=radioLoopback, ethTXLateCollisions=ethTXLateCollisions, modemTotalCapacity=modemTotalCapacity, modemBackgroundBlockErrror=modemBackgroundBlockErrror, atpcEnabled=atpcEnabled, ethRXDribleNibbles=ethRXDribleNibbles, license=license, e1t1LOS=e1t1LOS, ethTXBackpresEvents=ethTXBackpresEvents, ethRXPauseFrames=ethRXPauseFrames, e1t1ChannelNr=e1t1ChannelNr, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, loopbacks=loopbacks, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioTable=radioTable, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemUnavailtime=modemUnavailtime, ethTXCollisions=ethTXCollisions, vlanPortmap=vlanPortmap, localIp=localIp, ethTXCRCErrors=ethTXCRCErrors, remoteIp=remoteIp, localIpMask=localIpMask, ethRXMulticasts=ethRXMulticasts, ethTXUnderruns=ethTXUnderruns, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXByteCounterHi=ethTXByteCounterHi, modemE1T1Channels=modemE1T1Channels, licenseMask=licenseMask, ethTXDones=ethTXDones, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ipRadioMgmt=ipRadioMgmt, modemAcqStatus=modemAcqStatus, radioIndex=radioIndex, ethRXCodeErrors=ethRXCodeErrors, modemACMengine=modemACMengine, radioDuplexShift=radioDuplexShift, modemACMmodulationMin=modemACMmodulationMin, product=product, modemACMethernetCapacity=modemACMethernetCapacity, ipRadioCfgGeneral=ipRadioCfgGeneral, ethGFPCHECErrors=ethGFPCHECErrors, radioGenStatus=radioGenStatus, modemLDPCdecoderStress=modemLDPCdecoderStress, ipRadioStatEth=ipRadioStatEth, aTPCTable=aTPCTable, modemIndex=modemIndex, ethRXVlanTagsDetected=ethRXVlanTagsDetected, hostname=hostname, modemEthernetCapacity=modemEthernetCapacity, saf=saf, ethRXPrevPktDropped=ethRXPrevPktDropped, ipRadioCfgNetwork=ipRadioCfgNetwork, modemRadialMSE=modemRadialMSE, ethRXControlFrames=ethRXControlFrames, ethRXLongEvents=ethRXLongEvents, ethRXByteCounterLow=ethRXByteCounterLow, ethGFPDropedFrames=ethGFPDropedFrames, modemErroredBlock=modemErroredBlock, e1t1AIS=e1t1AIS, ethTXPauseFrames=ethTXPauseFrames, writeConfig=writeConfig, radioTxMute=radioTxMute, radioTxFrequency=radioTxFrequency, ethGFPDelineationErrors=ethGFPDelineationErrors, modemStandard=modemStandard, modemACMmodulationMax=modemACMmodulationMax, ethRXCRCErrors=ethRXCRCErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXByteCounterHi=ethRXByteCounterHi, loopback_tributary_mask=loopback_tributary_mask, vlanTable=vlanTable, atpcIndex=atpcIndex, vlanRowStatus=vlanRowStatus, modemEntry=modemEntry, modemBandwith=modemBandwith, ipRadio=ipRadio, modemGeneralStatus=modemGeneralStatus, ethGFPFCSErrors=ethGFPFCSErrors, ethQOSTXFrames=ethQOSTXFrames, ethTXBroadcasts=ethTXBroadcasts, modemCarrierOffset=modemCarrierOffset, pointToPoint=pointToPoint, ipRadioStat=ipRadioStat, modemErroredSecondRatio=modemErroredSecondRatio, ethTXMaxCollisions=ethTXMaxCollisions, modemErroredSecond=modemErroredSecond, modemE1T1ChannelMask=modemE1T1ChannelMask, modemUptime=modemUptime, ethTXExcessiveDefers=ethTXExcessiveDefers, modemACMtotalCapacity=modemACMtotalCapacity, modemCountTime=modemCountTime, atpcTxPowerCorrection=atpcTxPowerCorrection, radioRxLevel=radioRxLevel, radioSide=radioSide, ethRXBroadcasts=ethRXBroadcasts, ethTXByteCounterLow=ethTXByteCounterLow, ethQOSTXDropped=ethQOSTXDropped, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemLastAcqError=modemLastAcqError, e1t1StatTable=e1t1StatTable, description=description, radioTxPower=radioTxPower, ethTXWireByteCounterHi=ethTXWireByteCounterHi, vlanFid=vlanFid, radioRxFrequency=radioRxFrequency, vlanEntry=vlanEntry, sysTemperature=sysTemperature, ethRXDvEvent=ethRXDvEvent, ipRadioCfg=ipRadioCfg, licenseUpdateStatus=licenseUpdateStatus, ethRXDones=ethRXDones, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXGiants=ethTXGiants, vlanNumber=vlanNumber, tehnika=tehnika, radioEntry=radioEntry, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXControlFrames=ethTXControlFrames, vlanCfgStat=vlanCfgStat, modemSymbolRateRx=modemSymbolRateRx, safip=safip, aTPCEntry=aTPCEntry, modemModulation=modemModulation, e1t1StatEntry=e1t1StatEntry, modemSymbolRateTx=modemSymbolRateTx, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, sysDateAndTime=sysDateAndTime, modemStatistics=modemStatistics, vlanPortType=vlanPortType, restartcpu=restartcpu, modemRowStatus=modemRowStatus, modemTotalBlockNumber=modemTotalBlockNumber, ethTXMulticasts=ethTXMulticasts, modemTable=modemTable)
