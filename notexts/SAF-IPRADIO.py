...
mibBuilder.exportSymbols("SAF-IPRADIO", radioEntry=radioEntry, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, e1t1StatEntry=e1t1StatEntry, ethRXVlanTagsDetected=ethRXVlanTagsDetected, atpcEnabled=atpcEnabled, ethTXUnderruns=ethTXUnderruns, sysDateAndTime=sysDateAndTime, ethRXDribleNibbles=ethRXDribleNibbles, modemLastAcqError=modemLastAcqError, ethRXCodeErrors=ethRXCodeErrors, modemAcqStatus=modemAcqStatus, ipRadioStat=ipRadioStat, restartcpu=restartcpu, modemACMtotalCapacity=modemACMtotalCapacity, modemRadialMSE=modemRadialMSE, vlanFid=vlanFid, modemSymbolRateRx=modemSymbolRateRx, vlanTable=vlanTable, modemBandwith=modemBandwith, e1t1AIS=e1t1AIS, microwaveRadio=microwaveRadio, sysTemperature=sysTemperature, remoteIp=remoteIp, ethRXTruncatedFrames=ethRXTruncatedFrames, modemACMethernetCapacity=modemACMethernetCapacity, radioSide=radioSide, saf=saf, ethTXControlFrames=ethTXControlFrames, ipRadioMgmt=ipRadioMgmt, tehnika=tehnika, e1t1ChannelNr=e1t1ChannelNr, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXControlFrames=ethRXControlFrames, modemE1T1Channels=modemE1T1Channels, ethTXVlanTags=ethTXVlanTags, hostname=hostname, ethTXCRCErrors=ethTXCRCErrors, loopbacks=loopbacks, modemStandard=modemStandard, ethRXCRCErrors=ethRXCRCErrors, ethTXByteCounterLow=ethTXByteCounterLow, radioDuplexShift=radioDuplexShift, licenseUpdateStatus=licenseUpdateStatus, ethRXDones=ethRXDones, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, description=description, modemErroredSecond=modemErroredSecond, radioIndex=radioIndex, ethTXDones=ethTXDones, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemTable=modemTable, modemACMmodulationMin=modemACMmodulationMin, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemErroredBlock=modemErroredBlock, modemCarrierOffset=modemCarrierOffset, modemGeneralStatus=modemGeneralStatus, vlanEntry=vlanEntry, radioTxPower=radioTxPower, safip=safip, modemModulation=modemModulation, modemEntry=modemEntry, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemLDPCdecoderStress=modemLDPCdecoderStress, vlanPortmap=vlanPortmap, ethTXMaxCollisions=ethTXMaxCollisions, vlanCfgStat=vlanCfgStat, ipRadioStatEth=ipRadioStatEth, ethGFPCHECErrors=ethGFPCHECErrors, ethTXLateCollisions=ethTXLateCollisions, modemStatistics=modemStatistics, localIp=localIp, ethRXMulticasts=ethRXMulticasts, vlanRowStatus=vlanRowStatus, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXMulticasts=ethTXMulticasts, modemInternalAGCgain=modemInternalAGCgain, radioGenStatus=radioGenStatus, aTPCEntry=aTPCEntry, modemUptime=modemUptime, ethTXPauseFrames=ethTXPauseFrames, modemTotalCapacity=modemTotalCapacity, license=license, modemSymbolRateTx=modemSymbolRateTx, modemACMmodulationMax=modemACMmodulationMax, ethRXBroadcasts=ethRXBroadcasts, modemACMengine=modemACMengine, radioRxLevel=radioRxLevel, vlanPortType=vlanPortType, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethQOSTXFrames=ethQOSTXFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioRxFrequency=radioRxFrequency, ethGFPFCSErrors=ethGFPFCSErrors, vlanNumber=vlanNumber, pointToPoint=pointToPoint, product=product, modemErroredSecondRatio=modemErroredSecondRatio, ethQOSRXQ1Frames=ethQOSRXQ1Frames, aTPCTable=aTPCTable, ethRXPrevPktDropped=ethRXPrevPktDropped, ipRadioCfg=ipRadioCfg, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemIndex=modemIndex, radioTxFrequency=radioTxFrequency, radioTxMute=radioTxMute, atpcTxPowerCorrection=atpcTxPowerCorrection, e1t1StatTable=e1t1StatTable, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemTotalBlockNumber=modemTotalBlockNumber, modemUnavailtime=modemUnavailtime, radioLoopback=radioLoopback, radioTable=radioTable, ipRadio=ipRadio, ethTXBackpresEvents=ethTXBackpresEvents, e1t1LOS=e1t1LOS, ethRXByteCounterHi=ethRXByteCounterHi, modemCountTime=modemCountTime, atpcIndex=atpcIndex, modemEthernetCapacity=modemEthernetCapacity, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemRowStatus=modemRowStatus, licenseMask=licenseMask, ethQOSTXDropped=ethQOSTXDropped, writeConfig=writeConfig, ethTXByteCounterHi=ethTXByteCounterHi, ethRXDvEvent=ethRXDvEvent, ethRXByteCounterLow=ethRXByteCounterLow, ethGFPDropedFrames=ethGFPDropedFrames, ethTXCollisions=ethTXCollisions, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, loopback_tributary_mask=loopback_tributary_mask, localIpMask=localIpMask, ethTXGiants=ethTXGiants, ethTXBroadcasts=ethTXBroadcasts, ethTXExcessiveDefers=ethTXExcessiveDefers, modemE1T1ChannelMask=modemE1T1ChannelMask, vlansEnabled=vlansEnabled, ethRXPauseFrames=ethRXPauseFrames, ethRXLongEvents=ethRXLongEvents)
