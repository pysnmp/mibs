...
mibBuilder.exportSymbols("SAF-IPRADIO", safip=safip, licenseUpdateStatus=licenseUpdateStatus, e1t1ChannelNr=e1t1ChannelNr, ipRadioStatEth=ipRadioStatEth, modemEthernetCapacity=modemEthernetCapacity, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXPauseFrames=ethTXPauseFrames, aTPCTable=aTPCTable, modemStandard=modemStandard, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemSymbolRateTx=modemSymbolRateTx, ethRXMulticasts=ethRXMulticasts, radioRxLevel=radioRxLevel, vlanRowStatus=vlanRowStatus, modemBandwith=modemBandwith, pointToPoint=pointToPoint, radioDuplexShift=radioDuplexShift, localIpMask=localIpMask, modemIndex=modemIndex, ethTXBroadcasts=ethTXBroadcasts, modemTable=modemTable, modemTotalBlockNumber=modemTotalBlockNumber, ethRXByteCounterLow=ethRXByteCounterLow, modemSymbolRateRx=modemSymbolRateRx, aTPCEntry=aTPCEntry, radioRxFrequency=radioRxFrequency, ethGFPFCSErrors=ethGFPFCSErrors, vlanPortType=vlanPortType, ethTXMulticasts=ethTXMulticasts, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, product=product, modemLastAcqError=modemLastAcqError, radioLoopback=radioLoopback, sysDateAndTime=sysDateAndTime, remoteIp=remoteIp, ethRXPrevPktDropped=ethRXPrevPktDropped, ipRadioCfgNetwork=ipRadioCfgNetwork, hostname=hostname, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemTotalCapacity=modemTotalCapacity, vlanEntry=vlanEntry, e1t1AIS=e1t1AIS, writeConfig=writeConfig, atpcTxPowerCorrection=atpcTxPowerCorrection, loopbacks=loopbacks, ethRXBroadcasts=ethRXBroadcasts, ethTXCollisions=ethTXCollisions, ethGFPDropedFrames=ethGFPDropedFrames, vlanTable=vlanTable, modemE1T1Channels=modemE1T1Channels, e1t1StatTable=e1t1StatTable, modemUptime=modemUptime, e1t1StatEntry=e1t1StatEntry, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXDones=ethTXDones, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioIndex=radioIndex, atpcIndex=atpcIndex, modemUnavailtime=modemUnavailtime, sysTemperature=sysTemperature, ethRXPauseFrames=ethRXPauseFrames, ethTXLateCollisions=ethTXLateCollisions, microwaveRadio=microwaveRadio, e1t1LOS=e1t1LOS, vlanFid=vlanFid, ipRadioCfg=ipRadioCfg, license=license, ethTXVlanTags=ethTXVlanTags, licenseMask=licenseMask, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXByteCounterLow=ethTXByteCounterLow, modemRadialMSE=modemRadialMSE, modemCountTime=modemCountTime, ethTXControlFrames=ethTXControlFrames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadioMgmt=ipRadioMgmt, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXByteCounterHi=ethTXByteCounterHi, ethRXTruncatedFrames=ethRXTruncatedFrames, modemGeneralStatus=modemGeneralStatus, loopback_tributary_mask=loopback_tributary_mask, ethTXMaxCollisions=ethTXMaxCollisions, radioTxPower=radioTxPower, ethRXDvEvent=ethRXDvEvent, ethRXDones=ethRXDones, description=description, localIp=localIp, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXLongEvents=ethRXLongEvents, ethTXUnderruns=ethTXUnderruns, modemStatistics=modemStatistics, modemErroredSecond=modemErroredSecond, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemLDPCdecoderStress=modemLDPCdecoderStress, ethGFPCHECErrors=ethGFPCHECErrors, ethTXBackpresEvents=ethTXBackpresEvents, modemE1T1ChannelMask=modemE1T1ChannelMask, saf=saf, vlansEnabled=vlansEnabled, modemRowStatus=modemRowStatus, vlanCfgStat=vlanCfgStat, ethGFPDelineationErrors=ethGFPDelineationErrors, modemCarrierOffset=modemCarrierOffset, modemACMtotalCapacity=modemACMtotalCapacity, modemACMethernetCapacity=modemACMethernetCapacity, ethRXByteCounterHi=ethRXByteCounterHi, ethTXCRCErrors=ethTXCRCErrors, vlanNumber=vlanNumber, ethRXCodeErrors=ethRXCodeErrors, radioEntry=radioEntry, modemACMmodulationMax=modemACMmodulationMax, ethRXDribleNibbles=ethRXDribleNibbles, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXCRCErrors=ethRXCRCErrors, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemErroredBlock=modemErroredBlock, ipRadioStat=ipRadioStat, radioTxFrequency=radioTxFrequency, modemAcqStatus=modemAcqStatus, vlanPortmap=vlanPortmap, modemModulation=modemModulation, radioSide=radioSide, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioGenStatus=radioGenStatus, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, tehnika=tehnika, atpcEnabled=atpcEnabled, modemACMmodulationMin=modemACMmodulationMin, ethRXControlFrames=ethRXControlFrames, restartcpu=restartcpu, ethTXExcessiveDefers=ethTXExcessiveDefers, modemInternalAGCgain=modemInternalAGCgain, modemEntry=modemEntry, ethQOSTXDropped=ethQOSTXDropped, radioTable=radioTable, ethQOSTXFrames=ethQOSTXFrames, ipRadio=ipRadio, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemErroredSecondRatio=modemErroredSecondRatio, modemACMengine=modemACMengine, ethTXGiants=ethTXGiants, radioTxMute=radioTxMute)
