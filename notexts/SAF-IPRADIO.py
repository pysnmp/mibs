...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXDvEvent=ethRXDvEvent, modemUnavailtime=modemUnavailtime, ethRXLongEvents=ethRXLongEvents, modemErroredSecond=modemErroredSecond, modemBandwith=modemBandwith, radioTable=radioTable, restartcpu=restartcpu, writeConfig=writeConfig, vlanTable=vlanTable, radioLoopback=radioLoopback, vlanEntry=vlanEntry, ethRXDribleNibbles=ethRXDribleNibbles, ethRXMulticasts=ethRXMulticasts, ethTXMaxCollisions=ethTXMaxCollisions, ethTXLengthCheckErrors=ethTXLengthCheckErrors, safip=safip, e1t1AIS=e1t1AIS, modemModulation=modemModulation, ethRXDones=ethRXDones, ethRXCodeErrors=ethRXCodeErrors, ethTXVlanTags=ethTXVlanTags, ethTXByteCounterHi=ethTXByteCounterHi, pointToPoint=pointToPoint, modemACMmodulationMin=modemACMmodulationMin, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXControlFrames=ethRXControlFrames, ethTXCollisions=ethTXCollisions, ethRXPauseFrames=ethRXPauseFrames, vlanPortType=vlanPortType, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethQOSTXDropped=ethQOSTXDropped, atpcTxPowerCorrection=atpcTxPowerCorrection, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioTxFrequency=radioTxFrequency, microwaveRadio=microwaveRadio, ethTXByteCounterLow=ethTXByteCounterLow, modemCarrierOffset=modemCarrierOffset, modemErroredBlock=modemErroredBlock, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioRxLevel=radioRxLevel, ipRadioStat=ipRadioStat, aTPCEntry=aTPCEntry, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXCRCErrors=ethRXCRCErrors, modemEntry=modemEntry, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadioStatEth=ipRadioStatEth, modemStatistics=modemStatistics, ethRXVlanTagsDetected=ethRXVlanTagsDetected, aTPCTable=aTPCTable, radioTxPower=radioTxPower, ethTXBackpresEvents=ethTXBackpresEvents, ethTXDones=ethTXDones, modemTotalBlockNumber=modemTotalBlockNumber, modemACMethernetCapacity=modemACMethernetCapacity, license=license, modemTotalCapacity=modemTotalCapacity, ethRXByteCounterLow=ethRXByteCounterLow, ethTXGiants=ethTXGiants, modemGeneralStatus=modemGeneralStatus, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXLateCollisions=ethTXLateCollisions, ethRXTruncatedFrames=ethRXTruncatedFrames, sysDateAndTime=sysDateAndTime, ethTXExcessiveDefers=ethTXExcessiveDefers, e1t1StatTable=e1t1StatTable, product=product, vlanCfgStat=vlanCfgStat, ethGFPDropedFrames=ethGFPDropedFrames, modemE1T1ChannelMask=modemE1T1ChannelMask, ethQOSRXQ2Frames=ethQOSRXQ2Frames, description=description, ipRadioCfgNetwork=ipRadioCfgNetwork, modemCountTime=modemCountTime, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, hostname=hostname, modemErroredSecondRatio=modemErroredSecondRatio, licenseUpdateStatus=licenseUpdateStatus, radioGenStatus=radioGenStatus, ethTXBroadcasts=ethTXBroadcasts, radioDuplexShift=radioDuplexShift, radioSide=radioSide, localIpMask=localIpMask, atpcIndex=atpcIndex, ethTXControlFrames=ethTXControlFrames, radioEntry=radioEntry, ethRXByteCounterHi=ethRXByteCounterHi, ethTXPauseFrames=ethTXPauseFrames, modemStandard=modemStandard, modemRadialMSE=modemRadialMSE, e1t1LOS=e1t1LOS, vlanNumber=vlanNumber, ethGFPCHECErrors=ethGFPCHECErrors, ethQOSTXFrames=ethQOSTXFrames, modemACMengine=modemACMengine, modemIndex=modemIndex, tehnika=tehnika, ipRadioCfg=ipRadioCfg, modemSymbolRateRx=modemSymbolRateRx, modemLDPCdecoderStress=modemLDPCdecoderStress, e1t1StatEntry=e1t1StatEntry, ipRadio=ipRadio, modemACMmodulationMax=modemACMmodulationMax, ethTXMulticasts=ethTXMulticasts, licenseMask=licenseMask, ethGFPDelineationErrors=ethGFPDelineationErrors, localIp=localIp, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, loopback_tributary_mask=loopback_tributary_mask, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXBroadcasts=ethRXBroadcasts, radioIndex=radioIndex, radioRxFrequency=radioRxFrequency, ethGFPFCSErrors=ethGFPFCSErrors, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, vlanRowStatus=vlanRowStatus, vlanFid=vlanFid, modemRowStatus=modemRowStatus, modemLastAcqError=modemLastAcqError, radioTxMute=radioTxMute, ethTXUnderruns=ethTXUnderruns, remoteIp=remoteIp, atpcEnabled=atpcEnabled, modemE1T1Channels=modemE1T1Channels, vlanPortmap=vlanPortmap, ipRadioMgmt=ipRadioMgmt, modemEthernetCapacity=modemEthernetCapacity, saf=saf, modemACMtotalCapacity=modemACMtotalCapacity, ethRXPrevPktDropped=ethRXPrevPktDropped, modemBackgroundBlockErrror=modemBackgroundBlockErrror, sysTemperature=sysTemperature, modemInternalAGCgain=modemInternalAGCgain, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXCRCErrors=ethTXCRCErrors, modemUptime=modemUptime, loopbacks=loopbacks, modemSymbolRateTx=modemSymbolRateTx, modemAcqStatus=modemAcqStatus, e1t1ChannelNr=e1t1ChannelNr, modemTable=modemTable, vlansEnabled=vlansEnabled)
