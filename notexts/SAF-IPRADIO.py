...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXCollisions=ethTXCollisions, loopbacks=loopbacks, atpcTxPowerCorrection=atpcTxPowerCorrection, modemErroredSecond=modemErroredSecond, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXControlFrames=ethTXControlFrames, vlanNumber=vlanNumber, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemACMengine=modemACMengine, modemTotalBlockNumber=modemTotalBlockNumber, license=license, ethTXLateCollisions=ethTXLateCollisions, ethQOSRXQ1Frames=ethQOSRXQ1Frames, restartcpu=restartcpu, radioGenStatus=radioGenStatus, radioTxFrequency=radioTxFrequency, radioTable=radioTable, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, loopback_tributary_mask=loopback_tributary_mask, description=description, modemStandard=modemStandard, modemACMmodulationMin=modemACMmodulationMin, vlanCfgStat=vlanCfgStat, tehnika=tehnika, modemErroredSecondRatio=modemErroredSecondRatio, ipRadioStat=ipRadioStat, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXBackpresEvents=ethTXBackpresEvents, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXUnderruns=ethTXUnderruns, e1t1LOS=e1t1LOS, vlanEntry=vlanEntry, ethRXDribleNibbles=ethRXDribleNibbles, modemTotalCapacity=modemTotalCapacity, modemEthernetCapacity=modemEthernetCapacity, modemACMethernetCapacity=modemACMethernetCapacity, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethGFPDropedFrames=ethGFPDropedFrames, radioDuplexShift=radioDuplexShift, modemStatistics=modemStatistics, ethTXBroadcasts=ethTXBroadcasts, modemSymbolRateTx=modemSymbolRateTx, ethQOSTXFrames=ethQOSTXFrames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, remoteIp=remoteIp, hostname=hostname, modemAcqStatus=modemAcqStatus, ethTXMaxCollisions=ethTXMaxCollisions, ipRadioMgmt=ipRadioMgmt, e1t1ChannelNr=e1t1ChannelNr, radioIndex=radioIndex, modemIndex=modemIndex, vlansEnabled=vlansEnabled, modemUnavailtime=modemUnavailtime, ethRXMulticasts=ethRXMulticasts, radioTxPower=radioTxPower, ethTXCRCErrors=ethTXCRCErrors, modemE1T1ChannelMask=modemE1T1ChannelMask, modemACMmodulationMax=modemACMmodulationMax, ethRXCodeErrors=ethRXCodeErrors, radioLoopback=radioLoopback, ethRXControlFrames=ethRXControlFrames, aTPCTable=aTPCTable, ethTXMulticasts=ethTXMulticasts, localIpMask=localIpMask, modemRowStatus=modemRowStatus, vlanPortmap=vlanPortmap, ethGFPDelineationErrors=ethGFPDelineationErrors, licenseUpdateStatus=licenseUpdateStatus, ethRXPrevPktDropped=ethRXPrevPktDropped, sysTemperature=sysTemperature, ipRadioStatEth=ipRadioStatEth, radioRxLevel=radioRxLevel, vlanTable=vlanTable, modemInternalAGCgain=modemInternalAGCgain, pointToPoint=pointToPoint, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, vlanFid=vlanFid, saf=saf, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ipRadioCfg=ipRadioCfg, modemCarrierOffset=modemCarrierOffset, ethRXByteCounterHi=ethRXByteCounterHi, radioRxFrequency=radioRxFrequency, e1t1StatEntry=e1t1StatEntry, vlanRowStatus=vlanRowStatus, radioSide=radioSide, modemModulation=modemModulation, ipRadioCfgGeneral=ipRadioCfgGeneral, modemUptime=modemUptime, modemErroredBlock=modemErroredBlock, ethTXDones=ethTXDones, vlanPortType=vlanPortType, modemRadialMSE=modemRadialMSE, e1t1AIS=e1t1AIS, ethRXDvEvent=ethRXDvEvent, product=product, modemBandwith=modemBandwith, ipRadio=ipRadio, ethTXPauseFrames=ethTXPauseFrames, ethQOSTXDropped=ethQOSTXDropped, modemGeneralStatus=modemGeneralStatus, modemACMtotalCapacity=modemACMtotalCapacity, radioEntry=radioEntry, aTPCEntry=aTPCEntry, modemSymbolRateRx=modemSymbolRateRx, ethTXGiants=ethTXGiants, ethGFPCHECErrors=ethGFPCHECErrors, localIp=localIp, atpcIndex=atpcIndex, modemEntry=modemEntry, sysDateAndTime=sysDateAndTime, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXLongEvents=ethRXLongEvents, radioTxMute=radioTxMute, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXVlanTags=ethTXVlanTags, modemE1T1Channels=modemE1T1Channels, ethTXLengthCheckErrors=ethTXLengthCheckErrors, microwaveRadio=microwaveRadio, licenseMask=licenseMask, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXBroadcasts=ethRXBroadcasts, ethRXByteCounterLow=ethRXByteCounterLow, ethTXByteCounterLow=ethTXByteCounterLow, writeConfig=writeConfig, ethRXPauseFrames=ethRXPauseFrames, e1t1StatTable=e1t1StatTable, modemLastAcqError=modemLastAcqError, ipRadioCfgNetwork=ipRadioCfgNetwork, atpcEnabled=atpcEnabled, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemLDPCdecoderStress=modemLDPCdecoderStress, safip=safip, modemTable=modemTable, modemCountTime=modemCountTime, ethTXByteCounterHi=ethTXByteCounterHi, ethRXCRCErrors=ethRXCRCErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXDones=ethRXDones, ethGFPFCSErrors=ethGFPFCSErrors)
