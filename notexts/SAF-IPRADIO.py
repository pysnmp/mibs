...
mibBuilder.exportSymbols("SAF-IPRADIO", modemErroredBlock=modemErroredBlock, ethTXByteCounterHi=ethTXByteCounterHi, radioRxFrequency=radioRxFrequency, modemACMengine=modemACMengine, ethTXPauseFrames=ethTXPauseFrames, ethRXLongEvents=ethRXLongEvents, modemUptime=modemUptime, licenseUpdateStatus=licenseUpdateStatus, saf=saf, ethQOSTXDropped=ethQOSTXDropped, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXCodeErrors=ethRXCodeErrors, modemGeneralStatus=modemGeneralStatus, atpcTxPowerCorrection=atpcTxPowerCorrection, e1t1ChannelNr=e1t1ChannelNr, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, aTPCEntry=aTPCEntry, modemStandard=modemStandard, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemACMtotalCapacity=modemACMtotalCapacity, radioTable=radioTable, tehnika=tehnika, ipRadioMgmt=ipRadioMgmt, modemCountTime=modemCountTime, ethGFPCHECErrors=ethGFPCHECErrors, description=description, pointToPoint=pointToPoint, radioTxMute=radioTxMute, radioGenStatus=radioGenStatus, ethTXUnderruns=ethTXUnderruns, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXDribleNibbles=ethRXDribleNibbles, licenseMask=licenseMask, radioSide=radioSide, modemSymbolRateTx=modemSymbolRateTx, ethRXMulticasts=ethRXMulticasts, product=product, ethRXVlanTagsDetected=ethRXVlanTagsDetected, vlanCfgStat=vlanCfgStat, ethTXVlanTags=ethTXVlanTags, radioEntry=radioEntry, e1t1LOS=e1t1LOS, modemSymbolRateRx=modemSymbolRateRx, ethTXExcessiveDefers=ethTXExcessiveDefers, modemModulation=modemModulation, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXCRCErrors=ethTXCRCErrors, modemTotalCapacity=modemTotalCapacity, vlanTable=vlanTable, ethGFPDropedFrames=ethGFPDropedFrames, modemE1T1ChannelMask=modemE1T1ChannelMask, e1t1AIS=e1t1AIS, modemRowStatus=modemRowStatus, ethTXByteCounterLow=ethTXByteCounterLow, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ipRadioStat=ipRadioStat, ethRXTruncatedFrames=ethRXTruncatedFrames, modemIndex=modemIndex, radioIndex=radioIndex, modemEthernetCapacity=modemEthernetCapacity, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, license=license, e1t1StatTable=e1t1StatTable, modemAcqStatus=modemAcqStatus, modemLastAcqError=modemLastAcqError, ethRXPauseFrames=ethRXPauseFrames, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXGiants=ethTXGiants, restartcpu=restartcpu, loopback_tributary_mask=loopback_tributary_mask, modemTable=modemTable, localIpMask=localIpMask, ethRXCRCErrors=ethRXCRCErrors, localIp=localIp, modemACMethernetCapacity=modemACMethernetCapacity, ethRXPrevPktDropped=ethRXPrevPktDropped, remoteIp=remoteIp, ethTXLateCollisions=ethTXLateCollisions, microwaveRadio=microwaveRadio, ipRadio=ipRadio, radioRxLevel=radioRxLevel, modemEntry=modemEntry, vlanPortType=vlanPortType, ethTXMulticasts=ethTXMulticasts, ethQOSRXQ1Frames=ethQOSRXQ1Frames, aTPCTable=aTPCTable, vlanEntry=vlanEntry, ethRXByteCounterLow=ethRXByteCounterLow, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXDones=ethRXDones, ethTXDones=ethTXDones, ipRadioCfg=ipRadioCfg, hostname=hostname, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, vlanNumber=vlanNumber, modemACMmodulationMin=modemACMmodulationMin, ethTXBackpresEvents=ethTXBackpresEvents, ipRadioStatEth=ipRadioStatEth, ethRXBroadcasts=ethRXBroadcasts, e1t1StatEntry=e1t1StatEntry, modemBandwith=modemBandwith, ethRXControlFrames=ethRXControlFrames, modemErroredSecond=modemErroredSecond, safip=safip, ipRadioCfgNetwork=ipRadioCfgNetwork, modemRadialMSE=modemRadialMSE, ethTXMaxCollisions=ethTXMaxCollisions, ethQOSTXFrames=ethQOSTXFrames, ethRXDvEvent=ethRXDvEvent, vlanPortmap=vlanPortmap, vlansEnabled=vlansEnabled, vlanRowStatus=vlanRowStatus, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXByteCounterHi=ethRXByteCounterHi, atpcIndex=atpcIndex, sysDateAndTime=sysDateAndTime, modemUnavailtime=modemUnavailtime, ethTXControlFrames=ethTXControlFrames, modemE1T1Channels=modemE1T1Channels, vlanFid=vlanFid, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemErroredSecondRatio=modemErroredSecondRatio, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemInternalAGCgain=modemInternalAGCgain, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioLoopback=radioLoopback, modemTotalBlockNumber=modemTotalBlockNumber, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXBroadcasts=ethTXBroadcasts, modemACMmodulationMax=modemACMmodulationMax, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethGFPFCSErrors=ethGFPFCSErrors, modemStatistics=modemStatistics, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemCarrierOffset=modemCarrierOffset, ethTXCollisions=ethTXCollisions, loopbacks=loopbacks, writeConfig=writeConfig, atpcEnabled=atpcEnabled, radioTxPower=radioTxPower, radioTxFrequency=radioTxFrequency, radioDuplexShift=radioDuplexShift, ethGFPDelineationErrors=ethGFPDelineationErrors, sysTemperature=sysTemperature)
