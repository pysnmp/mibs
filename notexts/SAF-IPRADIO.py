...
mibBuilder.exportSymbols("SAF-IPRADIO", modemE1T1Channels=modemE1T1Channels, loopback_tributary_mask=loopback_tributary_mask, vlanFid=vlanFid, radioTable=radioTable, ethTXControlFrames=ethTXControlFrames, ethTXPauseFrames=ethTXPauseFrames, ethQOSRXQ1Frames=ethQOSRXQ1Frames, loopbacks=loopbacks, ethRXByteCounterLow=ethRXByteCounterLow, modemACMethernetCapacity=modemACMethernetCapacity, license=license, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXVlanTags=ethTXVlanTags, localIpMask=localIpMask, description=description, modemUptime=modemUptime, ethRXCRCErrors=ethRXCRCErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXVlanTagsDetected=ethRXVlanTagsDetected, vlanPortType=vlanPortType, product=product, ethRXPauseFrames=ethRXPauseFrames, modemCountTime=modemCountTime, modemAcqStatus=modemAcqStatus, modemTotalCapacity=modemTotalCapacity, ethRXCodeErrors=ethRXCodeErrors, ipRadioCfg=ipRadioCfg, aTPCEntry=aTPCEntry, ethRXMulticasts=ethRXMulticasts, modemIndex=modemIndex, ethTXByteCounterLow=ethTXByteCounterLow, modemEntry=modemEntry, tehnika=tehnika, aTPCTable=aTPCTable, radioEntry=radioEntry, ethRXDribleNibbles=ethRXDribleNibbles, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioTxPower=radioTxPower, atpcIndex=atpcIndex, ethTXCollisions=ethTXCollisions, vlanRowStatus=vlanRowStatus, radioTxFrequency=radioTxFrequency, restartcpu=restartcpu, ethRXPrevPktDropped=ethRXPrevPktDropped, ethGFPDropedFrames=ethGFPDropedFrames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethGFPDelineationErrors=ethGFPDelineationErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, licenseMask=licenseMask, modemACMmodulationMax=modemACMmodulationMax, ethRXDvEvent=ethRXDvEvent, ipRadioStatEth=ipRadioStatEth, sysTemperature=sysTemperature, modemModulation=modemModulation, pointToPoint=pointToPoint, saf=saf, radioRxLevel=radioRxLevel, ipRadio=ipRadio, radioLoopback=radioLoopback, radioDuplexShift=radioDuplexShift, vlanTable=vlanTable, ethRXControlFrames=ethRXControlFrames, radioGenStatus=radioGenStatus, vlanPortmap=vlanPortmap, ethGFPFCSErrors=ethGFPFCSErrors, modemBandwith=modemBandwith, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioRxFrequency=radioRxFrequency, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, licenseUpdateStatus=licenseUpdateStatus, ethTXLateCollisions=ethTXLateCollisions, ethTXDones=ethTXDones, vlanNumber=vlanNumber, ethRXLongEvents=ethRXLongEvents, radioTxMute=radioTxMute, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemErroredBlock=modemErroredBlock, remoteIp=remoteIp, modemCarrierOffset=modemCarrierOffset, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXMaxCollisions=ethTXMaxCollisions, modemErroredSecondRatio=modemErroredSecondRatio, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemACMengine=modemACMengine, ipRadioMgmt=ipRadioMgmt, vlanEntry=vlanEntry, ethRXTruncatedFrames=ethRXTruncatedFrames, hostname=hostname, sysDateAndTime=sysDateAndTime, atpcEnabled=atpcEnabled, atpcTxPowerCorrection=atpcTxPowerCorrection, e1t1StatEntry=e1t1StatEntry, modemSymbolRateTx=modemSymbolRateTx, modemTable=modemTable, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXDones=ethRXDones, ethTXBackpresEvents=ethTXBackpresEvents, modemLastAcqError=modemLastAcqError, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemRowStatus=modemRowStatus, vlansEnabled=vlansEnabled, ethRXByteCounterHi=ethRXByteCounterHi, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemEthernetCapacity=modemEthernetCapacity, e1t1StatTable=e1t1StatTable, ethTXUnderruns=ethTXUnderruns, ethRXBroadcasts=ethRXBroadcasts, radioSide=radioSide, ethTXGiants=ethTXGiants, ethQOSTXDropped=ethQOSTXDropped, microwaveRadio=microwaveRadio, modemTotalBlockNumber=modemTotalBlockNumber, ethTXCRCErrors=ethTXCRCErrors, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXExcessiveDefers=ethTXExcessiveDefers, modemACMmodulationMin=modemACMmodulationMin, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemStatistics=modemStatistics, modemLDPCdecoderStress=modemLDPCdecoderStress, radioIndex=radioIndex, ipRadioStat=ipRadioStat, safip=safip, modemStandard=modemStandard, modemRadialMSE=modemRadialMSE, e1t1LOS=e1t1LOS, modemACMtotalCapacity=modemACMtotalCapacity, modemInternalAGCgain=modemInternalAGCgain, e1t1AIS=e1t1AIS, modemGeneralStatus=modemGeneralStatus, localIp=localIp, e1t1ChannelNr=e1t1ChannelNr, writeConfig=writeConfig, ethTXByteCounterHi=ethTXByteCounterHi, modemUnavailtime=modemUnavailtime, ethTXMulticasts=ethTXMulticasts, ethGFPCHECErrors=ethGFPCHECErrors, ethQOSTXFrames=ethQOSTXFrames, modemErroredSecond=modemErroredSecond, vlanCfgStat=vlanCfgStat, modemSymbolRateRx=modemSymbolRateRx, ethTXBroadcasts=ethTXBroadcasts)
