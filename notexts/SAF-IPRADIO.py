...
mibBuilder.exportSymbols("SAF-IPRADIO", modemInternalAGCgain=modemInternalAGCgain, modemACMtotalCapacity=modemACMtotalCapacity, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemRowStatus=modemRowStatus, ethTXBroadcasts=ethTXBroadcasts, ethTXCRCErrors=ethTXCRCErrors, vlanFid=vlanFid, aTPCEntry=aTPCEntry, modemCountTime=modemCountTime, ipRadioCfg=ipRadioCfg, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethQOSTXDropped=ethQOSTXDropped, radioSide=radioSide, modemIndex=modemIndex, e1t1StatTable=e1t1StatTable, ethRXControlFrames=ethRXControlFrames, ethGFPFCSErrors=ethGFPFCSErrors, radioIndex=radioIndex, modemACMmodulationMax=modemACMmodulationMax, modemEthernetCapacity=modemEthernetCapacity, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, sysTemperature=sysTemperature, modemACMmodulationMin=modemACMmodulationMin, vlanEntry=vlanEntry, ethRXMulticasts=ethRXMulticasts, ethQOSTXFrames=ethQOSTXFrames, remoteIp=remoteIp, radioLoopback=radioLoopback, hostname=hostname, ipRadioStatEth=ipRadioStatEth, loopback_tributary_mask=loopback_tributary_mask, e1t1StatEntry=e1t1StatEntry, ethTXDones=ethTXDones, ethRXBroadcasts=ethRXBroadcasts, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioRxFrequency=radioRxFrequency, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXByteCounterLow=ethRXByteCounterLow, modemSymbolRateRx=modemSymbolRateRx, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioRxLevel=radioRxLevel, ethRXDribleNibbles=ethRXDribleNibbles, radioDuplexShift=radioDuplexShift, modemAcqStatus=modemAcqStatus, vlanNumber=vlanNumber, ipRadioCfgGeneral=ipRadioCfgGeneral, e1t1AIS=e1t1AIS, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXPauseFrames=ethRXPauseFrames, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXTruncatedFrames=ethRXTruncatedFrames, modemTable=modemTable, ethRXDones=ethRXDones, ethTXMaxCollisions=ethTXMaxCollisions, modemE1T1Channels=modemE1T1Channels, ethTXLateCollisions=ethTXLateCollisions, vlanPortType=vlanPortType, atpcIndex=atpcIndex, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXVlanTagsDetected=ethRXVlanTagsDetected, localIp=localIp, ethTXGiants=ethTXGiants, restartcpu=restartcpu, modemUnavailtime=modemUnavailtime, modemErroredBlock=modemErroredBlock, ethTXCollisions=ethTXCollisions, saf=saf, licenseUpdateStatus=licenseUpdateStatus, ethTXByteCounterHi=ethTXByteCounterHi, modemCarrierOffset=modemCarrierOffset, ethTXExcessiveDefers=ethTXExcessiveDefers, ipRadioCfgNetwork=ipRadioCfgNetwork, ipRadio=ipRadio, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemGeneralStatus=modemGeneralStatus, modemACMethernetCapacity=modemACMethernetCapacity, ethTXVlanTags=ethTXVlanTags, ipRadioStat=ipRadioStat, modemSymbolRateTx=modemSymbolRateTx, atpcEnabled=atpcEnabled, ethTXByteCounterLow=ethTXByteCounterLow, vlanTable=vlanTable, product=product, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, vlansEnabled=vlansEnabled, ethRXDvEvent=ethRXDvEvent, vlanRowStatus=vlanRowStatus, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemLDPCdecoderStress=modemLDPCdecoderStress, modemBandwith=modemBandwith, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXBackpresEvents=ethTXBackpresEvents, ethRXCRCErrors=ethRXCRCErrors, radioGenStatus=radioGenStatus, ethRXByteCounterHi=ethRXByteCounterHi, tehnika=tehnika, radioTable=radioTable, modemRadialMSE=modemRadialMSE, modemEntry=modemEntry, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXPauseFrames=ethTXPauseFrames, modemErroredSecond=modemErroredSecond, radioEntry=radioEntry, modemStandard=modemStandard, sysDateAndTime=sysDateAndTime, ethTXMulticasts=ethTXMulticasts, license=license, modemACMengine=modemACMengine, modemTotalBlockNumber=modemTotalBlockNumber, safip=safip, pointToPoint=pointToPoint, aTPCTable=aTPCTable, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemUptime=modemUptime, vlanPortmap=vlanPortmap, vlanCfgStat=vlanCfgStat, ethRXLongEvents=ethRXLongEvents, radioTxMute=radioTxMute, modemModulation=modemModulation, ethRXCodeErrors=ethRXCodeErrors, e1t1LOS=e1t1LOS, description=description, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemErroredSecondRatio=modemErroredSecondRatio, modemTotalCapacity=modemTotalCapacity, radioTxPower=radioTxPower, modemE1T1ChannelMask=modemE1T1ChannelMask, ipRadioMgmt=ipRadioMgmt, ethTXControlFrames=ethTXControlFrames, microwaveRadio=microwaveRadio, ethTXUnderruns=ethTXUnderruns, modemLastAcqError=modemLastAcqError, writeConfig=writeConfig, ethGFPCHECErrors=ethGFPCHECErrors, radioTxFrequency=radioTxFrequency, ethGFPDropedFrames=ethGFPDropedFrames, modemStatistics=modemStatistics, licenseMask=licenseMask, e1t1ChannelNr=e1t1ChannelNr, atpcTxPowerCorrection=atpcTxPowerCorrection, localIpMask=localIpMask, loopbacks=loopbacks)
