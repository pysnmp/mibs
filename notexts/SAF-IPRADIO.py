...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXLongEvents=ethRXLongEvents, ethTXCollisions=ethTXCollisions, modemEthernetCapacity=modemEthernetCapacity, ethTXMaxCollisions=ethTXMaxCollisions, ipRadioCfgGeneral=ipRadioCfgGeneral, radioTxMute=radioTxMute, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXDribleNibbles=ethRXDribleNibbles, radioRxLevel=radioRxLevel, product=product, ethTXCRCErrors=ethTXCRCErrors, microwaveRadio=microwaveRadio, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioLoopback=radioLoopback, vlanEntry=vlanEntry, ethTXDones=ethTXDones, saf=saf, ethTXPauseFrames=ethTXPauseFrames, modemIndex=modemIndex, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemACMmodulationMin=modemACMmodulationMin, ethGFPCHECErrors=ethGFPCHECErrors, localIpMask=localIpMask, ethTXByteCounterHi=ethTXByteCounterHi, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, vlanFid=vlanFid, ethGFPFCSErrors=ethGFPFCSErrors, modemAcqStatus=modemAcqStatus, e1t1StatTable=e1t1StatTable, aTPCEntry=aTPCEntry, modemCarrierOffset=modemCarrierOffset, modemUptime=modemUptime, ethTXVlanTags=ethTXVlanTags, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXByteCounterLow=ethTXByteCounterLow, aTPCTable=aTPCTable, ethRXControlFrames=ethRXControlFrames, license=license, modemACMethernetCapacity=modemACMethernetCapacity, radioGenStatus=radioGenStatus, atpcEnabled=atpcEnabled, modemCountTime=modemCountTime, modemACMmodulationMax=modemACMmodulationMax, ipRadioCfgNetwork=ipRadioCfgNetwork, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemErroredSecondRatio=modemErroredSecondRatio, localIp=localIp, modemRowStatus=modemRowStatus, ethTXUnderruns=ethTXUnderruns, ipRadioCfg=ipRadioCfg, ethQOSTXDropped=ethQOSTXDropped, ethRXBroadcasts=ethRXBroadcasts, ethTXMulticasts=ethTXMulticasts, sysDateAndTime=sysDateAndTime, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXDvEvent=ethRXDvEvent, radioTxFrequency=radioTxFrequency, radioTable=radioTable, safip=safip, vlansEnabled=vlansEnabled, sysTemperature=sysTemperature, modemBandwith=modemBandwith, ipRadioStat=ipRadioStat, ethTXLateCollisions=ethTXLateCollisions, modemErroredBlock=modemErroredBlock, modemTotalBlockNumber=modemTotalBlockNumber, ipRadioMgmt=ipRadioMgmt, ethGFPDelineationErrors=ethGFPDelineationErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXControlFrames=ethTXControlFrames, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, vlanCfgStat=vlanCfgStat, ethRXPauseFrames=ethRXPauseFrames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemErroredSecond=modemErroredSecond, description=description, e1t1StatEntry=e1t1StatEntry, modemModulation=modemModulation, radioEntry=radioEntry, modemACMtotalCapacity=modemACMtotalCapacity, pointToPoint=pointToPoint, licenseUpdateStatus=licenseUpdateStatus, loopbacks=loopbacks, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXBroadcasts=ethTXBroadcasts, ethRXCodeErrors=ethRXCodeErrors, ethRXMulticasts=ethRXMulticasts, ethRXByteCounterLow=ethRXByteCounterLow, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioTxPower=radioTxPower, ethRXByteCounterHi=ethRXByteCounterHi, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemRadialMSE=modemRadialMSE, writeConfig=writeConfig, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXDones=ethRXDones, hostname=hostname, vlanPortmap=vlanPortmap, licenseMask=licenseMask, ethRXTruncatedFrames=ethRXTruncatedFrames, modemACMengine=modemACMengine, vlanPortType=vlanPortType, vlanTable=vlanTable, e1t1AIS=e1t1AIS, tehnika=tehnika, modemUnavailtime=modemUnavailtime, modemSymbolRateRx=modemSymbolRateRx, modemTable=modemTable, ethTXGiants=ethTXGiants, modemEntry=modemEntry, modemStandard=modemStandard, atpcIndex=atpcIndex, ipRadioStatEth=ipRadioStatEth, e1t1ChannelNr=e1t1ChannelNr, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ipRadio=ipRadio, modemLastAcqError=modemLastAcqError, ethRXCRCErrors=ethRXCRCErrors, ethTXBackpresEvents=ethTXBackpresEvents, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlanRowStatus=vlanRowStatus, vlanNumber=vlanNumber, restartcpu=restartcpu, radioRxFrequency=radioRxFrequency, ethQOSTXFrames=ethQOSTXFrames, modemStatistics=modemStatistics, radioDuplexShift=radioDuplexShift, radioSide=radioSide, remoteIp=remoteIp, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemE1T1Channels=modemE1T1Channels, atpcTxPowerCorrection=atpcTxPowerCorrection, modemGeneralStatus=modemGeneralStatus, ethGFPDropedFrames=ethGFPDropedFrames, modemTotalCapacity=modemTotalCapacity, modemInternalAGCgain=modemInternalAGCgain, loopback_tributary_mask=loopback_tributary_mask, ethRXPrevPktDropped=ethRXPrevPktDropped, e1t1LOS=e1t1LOS, modemSymbolRateTx=modemSymbolRateTx, radioIndex=radioIndex)
