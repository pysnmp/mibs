...
mibBuilder.exportSymbols("SAF-IPRADIO", modemRowStatus=modemRowStatus, ethQOSRXQ2Frames=ethQOSRXQ2Frames, localIp=localIp, radioLoopback=radioLoopback, ethTXLateCollisions=ethTXLateCollisions, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXDribleNibbles=ethRXDribleNibbles, modemSymbolRateRx=modemSymbolRateRx, e1t1LOS=e1t1LOS, radioTable=radioTable, tehnika=tehnika, ipRadioCfgGeneral=ipRadioCfgGeneral, vlanEntry=vlanEntry, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemBandwith=modemBandwith, modemRadialMSE=modemRadialMSE, loopback_tributary_mask=loopback_tributary_mask, atpcIndex=atpcIndex, modemEntry=modemEntry, ethGFPCHECErrors=ethGFPCHECErrors, remoteIp=remoteIp, ethRXCRCErrors=ethRXCRCErrors, loopbacks=loopbacks, ipRadioStatEth=ipRadioStatEth, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemGeneralStatus=modemGeneralStatus, modemACMmodulationMax=modemACMmodulationMax, ethRXLongEvents=ethRXLongEvents, ethRXControlFrames=ethRXControlFrames, microwaveRadio=microwaveRadio, vlanFid=vlanFid, vlanNumber=vlanNumber, vlanTable=vlanTable, atpcEnabled=atpcEnabled, ethRXPauseFrames=ethRXPauseFrames, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioRxFrequency=radioRxFrequency, modemTable=modemTable, ethTXExcessiveDefers=ethTXExcessiveDefers, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXControlFrames=ethTXControlFrames, radioTxMute=radioTxMute, vlanRowStatus=vlanRowStatus, ethTXVlanTags=ethTXVlanTags, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ipRadioCfgNetwork=ipRadioCfgNetwork, radioSide=radioSide, ethTXCRCErrors=ethTXCRCErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemLastAcqError=modemLastAcqError, vlanPortmap=vlanPortmap, modemIndex=modemIndex, ethTXBroadcasts=ethTXBroadcasts, modemStandard=modemStandard, modemUnavailtime=modemUnavailtime, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethGFPDelineationErrors=ethGFPDelineationErrors, safip=safip, modemStatistics=modemStatistics, radioEntry=radioEntry, ethTXUnderruns=ethTXUnderruns, ethRXVlanTagsDetected=ethRXVlanTagsDetected, vlanCfgStat=vlanCfgStat, ethRXMulticasts=ethRXMulticasts, ipRadioMgmt=ipRadioMgmt, e1t1StatTable=e1t1StatTable, modemLDPCdecoderStress=modemLDPCdecoderStress, restartcpu=restartcpu, modemErroredSecond=modemErroredSecond, ethTXCollisions=ethTXCollisions, ethQOSTXFrames=ethQOSTXFrames, ethQOSTXDropped=ethQOSTXDropped, radioDuplexShift=radioDuplexShift, writeConfig=writeConfig, ethRXPrevPktDropped=ethRXPrevPktDropped, ethGFPFCSErrors=ethGFPFCSErrors, modemEthernetCapacity=modemEthernetCapacity, ipRadio=ipRadio, ethGFPDropedFrames=ethGFPDropedFrames, modemACMtotalCapacity=modemACMtotalCapacity, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ipRadioCfg=ipRadioCfg, ethRXUnsupOpcodes=ethRXUnsupOpcodes, licenseUpdateStatus=licenseUpdateStatus, modemE1T1ChannelMask=modemE1T1ChannelMask, aTPCTable=aTPCTable, e1t1AIS=e1t1AIS, modemTotalBlockNumber=modemTotalBlockNumber, ethTXPauseFrames=ethTXPauseFrames, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioGenStatus=radioGenStatus, modemACMmodulationMin=modemACMmodulationMin, ethTXByteCounterHi=ethTXByteCounterHi, modemCountTime=modemCountTime, modemErroredBlock=modemErroredBlock, modemUptime=modemUptime, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, sysTemperature=sysTemperature, pointToPoint=pointToPoint, radioIndex=radioIndex, vlansEnabled=vlansEnabled, modemSymbolRateTx=modemSymbolRateTx, ethTXMulticasts=ethTXMulticasts, ethTXByteCounterLow=ethTXByteCounterLow, ethTXBackpresEvents=ethTXBackpresEvents, ethRXCodeErrors=ethRXCodeErrors, description=description, e1t1StatEntry=e1t1StatEntry, ethRXDvEvent=ethRXDvEvent, saf=saf, atpcTxPowerCorrection=atpcTxPowerCorrection, modemErroredSecondRatio=modemErroredSecondRatio, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemModulation=modemModulation, modemAcqStatus=modemAcqStatus, modemE1T1Channels=modemE1T1Channels, license=license, sysDateAndTime=sysDateAndTime, modemInternalAGCgain=modemInternalAGCgain, modemCarrierOffset=modemCarrierOffset, radioTxFrequency=radioTxFrequency, ethRXDones=ethRXDones, vlanPortType=vlanPortType, aTPCEntry=aTPCEntry, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXDones=ethTXDones, modemTotalCapacity=modemTotalCapacity, ethRXByteCounterLow=ethRXByteCounterLow, modemACMethernetCapacity=modemACMethernetCapacity, product=product, radioTxPower=radioTxPower, radioRxLevel=radioRxLevel, hostname=hostname, ethTXGiants=ethTXGiants, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemACMengine=modemACMengine, ethTXMaxCollisions=ethTXMaxCollisions, localIpMask=localIpMask, e1t1ChannelNr=e1t1ChannelNr, ipRadioStat=ipRadioStat, licenseMask=licenseMask, ethRXByteCounterHi=ethRXByteCounterHi, ethRXBroadcasts=ethRXBroadcasts)
