...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXExcessiveDefers=ethTXExcessiveDefers, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXByteCounterHi=ethTXByteCounterHi, modemE1T1Channels=modemE1T1Channels, loopbacks=loopbacks, modemLastAcqError=modemLastAcqError, ethTXByteCounterLow=ethTXByteCounterLow, ethQOSRXQ2Frames=ethQOSRXQ2Frames, sysDateAndTime=sysDateAndTime, ethGFPCHECErrors=ethGFPCHECErrors, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXPauseFrames=ethRXPauseFrames, e1t1StatEntry=e1t1StatEntry, vlanPortmap=vlanPortmap, pointToPoint=pointToPoint, modemIndex=modemIndex, license=license, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethQOSTXDropped=ethQOSTXDropped, licenseMask=licenseMask, licenseUpdateStatus=licenseUpdateStatus, ipRadioCfgNetwork=ipRadioCfgNetwork, localIpMask=localIpMask, modemCountTime=modemCountTime, remoteIp=remoteIp, modemUnavailtime=modemUnavailtime, modemACMtotalCapacity=modemACMtotalCapacity, modemBackgroundBlockErrror=modemBackgroundBlockErrror, aTPCEntry=aTPCEntry, ipRadioCfg=ipRadioCfg, writeConfig=writeConfig, ethRXControlFrames=ethRXControlFrames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioTxMute=radioTxMute, vlanNumber=vlanNumber, ethRXDvEvent=ethRXDvEvent, hostname=hostname, ethTXCRCErrors=ethTXCRCErrors, e1t1LOS=e1t1LOS, modemTotalBlockNumber=modemTotalBlockNumber, modemCarrierOffset=modemCarrierOffset, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXControlFrames=ethTXControlFrames, description=description, radioIndex=radioIndex, ethRXDribleNibbles=ethRXDribleNibbles, ethRXMulticasts=ethRXMulticasts, product=product, vlanEntry=vlanEntry, modemAcqStatus=modemAcqStatus, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXWireByteCounterLow=ethTXWireByteCounterLow, restartcpu=restartcpu, ethGFPDropedFrames=ethGFPDropedFrames, aTPCTable=aTPCTable, ethRXBroadcasts=ethRXBroadcasts, ethTXGiants=ethTXGiants, ethTXUnderruns=ethTXUnderruns, radioTxFrequency=radioTxFrequency, e1t1ChannelNr=e1t1ChannelNr, ethTXVlanTags=ethTXVlanTags, radioDuplexShift=radioDuplexShift, modemErroredSecondRatio=modemErroredSecondRatio, ethQOSTXFrames=ethQOSTXFrames, safip=safip, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, vlanTable=vlanTable, ethTXMaxCollisions=ethTXMaxCollisions, modemTotalCapacity=modemTotalCapacity, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXCRCErrors=ethRXCRCErrors, modemModulation=modemModulation, modemRowStatus=modemRowStatus, modemStatistics=modemStatistics, ethTXMulticasts=ethTXMulticasts, modemRadialMSE=modemRadialMSE, atpcEnabled=atpcEnabled, vlanFid=vlanFid, radioRxFrequency=radioRxFrequency, modemErroredSecond=modemErroredSecond, ethRXDones=ethRXDones, modemEthernetCapacity=modemEthernetCapacity, modemACMmodulationMax=modemACMmodulationMax, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemGeneralStatus=modemGeneralStatus, modemSymbolRateTx=modemSymbolRateTx, modemSymbolRateRx=modemSymbolRateRx, radioTable=radioTable, ethTXPauseFrames=ethTXPauseFrames, vlanPortType=vlanPortType, ipRadioStat=ipRadioStat, radioLoopback=radioLoopback, ipRadio=ipRadio, ethTXBroadcasts=ethTXBroadcasts, radioEntry=radioEntry, ethTXLateCollisions=ethTXLateCollisions, modemEntry=modemEntry, ipRadioStatEth=ipRadioStatEth, ipRadioMgmt=ipRadioMgmt, ethRXTruncatedFrames=ethRXTruncatedFrames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlansEnabled=vlansEnabled, ethTXBackpresEvents=ethTXBackpresEvents, modemBandwith=modemBandwith, modemACMethernetCapacity=modemACMethernetCapacity, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXByteCounterHi=ethRXByteCounterHi, e1t1AIS=e1t1AIS, modemUptime=modemUptime, loopback_tributary_mask=loopback_tributary_mask, modemACMmodulationMin=modemACMmodulationMin, radioTxPower=radioTxPower, radioRxLevel=radioRxLevel, localIp=localIp, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXDones=ethTXDones, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemACMengine=modemACMengine, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethGFPFCSErrors=ethGFPFCSErrors, modemStandard=modemStandard, ethRXCodeErrors=ethRXCodeErrors, ethTXCollisions=ethTXCollisions, tehnika=tehnika, radioSide=radioSide, modemTable=modemTable, modemInternalAGCgain=modemInternalAGCgain, ethTXLengthCheckErrors=ethTXLengthCheckErrors, sysTemperature=sysTemperature, saf=saf, vlanCfgStat=vlanCfgStat, vlanRowStatus=vlanRowStatus, e1t1StatTable=e1t1StatTable, modemErroredBlock=modemErroredBlock, ethRXLongEvents=ethRXLongEvents, radioGenStatus=radioGenStatus, microwaveRadio=microwaveRadio, atpcIndex=atpcIndex, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXByteCounterLow=ethRXByteCounterLow)
