...
mibBuilder.exportSymbols("SAF-IPRADIO", modemRowStatus=modemRowStatus, modemGeneralStatus=modemGeneralStatus, radioTxPower=radioTxPower, ethTXCollisions=ethTXCollisions, radioDuplexShift=radioDuplexShift, modemIndex=modemIndex, ethTXCRCErrors=ethTXCRCErrors, ethQOSTXFrames=ethQOSTXFrames, ethGFPCHECErrors=ethGFPCHECErrors, modemSymbolRateTx=modemSymbolRateTx, licenseMask=licenseMask, radioTxFrequency=radioTxFrequency, modemLDPCdecoderStress=modemLDPCdecoderStress, modemE1T1Channels=modemE1T1Channels, vlanEntry=vlanEntry, ethRXPauseFrames=ethRXPauseFrames, e1t1StatEntry=e1t1StatEntry, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, pointToPoint=pointToPoint, ipRadioStat=ipRadioStat, modemACMmodulationMin=modemACMmodulationMin, loopbacks=loopbacks, ethTXExcessiveDefers=ethTXExcessiveDefers, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXWireByteCounterLow=ethTXWireByteCounterLow, vlanTable=vlanTable, ethRXLongEvents=ethRXLongEvents, localIp=localIp, ethRXBroadcasts=ethRXBroadcasts, modemCarrierOffset=modemCarrierOffset, tehnika=tehnika, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXDones=ethTXDones, loopback_tributary_mask=loopback_tributary_mask, atpcTxPowerCorrection=atpcTxPowerCorrection, aTPCEntry=aTPCEntry, ethRXPrevPktDropped=ethRXPrevPktDropped, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemACMtotalCapacity=modemACMtotalCapacity, vlanRowStatus=vlanRowStatus, modemTable=modemTable, ethGFPDropedFrames=ethGFPDropedFrames, modemStandard=modemStandard, ipRadioCfgGeneral=ipRadioCfgGeneral, radioRxFrequency=radioRxFrequency, ethTXByteCounterHi=ethTXByteCounterHi, remoteIp=remoteIp, modemLastAcqError=modemLastAcqError, ethTXBroadcasts=ethTXBroadcasts, modemACMmodulationMax=modemACMmodulationMax, e1t1StatTable=e1t1StatTable, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXMulticasts=ethTXMulticasts, sysDateAndTime=sysDateAndTime, aTPCTable=aTPCTable, modemRadialMSE=modemRadialMSE, modemTotalBlockNumber=modemTotalBlockNumber, ethTXUnderruns=ethTXUnderruns, ethRXVlanTagsDetected=ethRXVlanTagsDetected, safip=safip, vlanCfgStat=vlanCfgStat, ethRXMulticasts=ethRXMulticasts, ethRXByteCounterHi=ethRXByteCounterHi, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ipRadioMgmt=ipRadioMgmt, modemErroredBlock=modemErroredBlock, radioEntry=radioEntry, ethRXControlFrames=ethRXControlFrames, ethTXLateCollisions=ethTXLateCollisions, ethTXMaxCollisions=ethTXMaxCollisions, atpcEnabled=atpcEnabled, ethQOSTXDropped=ethQOSTXDropped, modemErroredSecondRatio=modemErroredSecondRatio, modemACMethernetCapacity=modemACMethernetCapacity, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXBackpresEvents=ethTXBackpresEvents, radioIndex=radioIndex, vlansEnabled=vlansEnabled, ethRXCodeErrors=ethRXCodeErrors, e1t1AIS=e1t1AIS, license=license, modemAcqStatus=modemAcqStatus, modemACMengine=modemACMengine, modemUnavailtime=modemUnavailtime, ethRXByteCounterLow=ethRXByteCounterLow, sysTemperature=sysTemperature, ethRXDvEvent=ethRXDvEvent, ethTXControlFrames=ethTXControlFrames, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemTotalCapacity=modemTotalCapacity, modemModulation=modemModulation, ethGFPFCSErrors=ethGFPFCSErrors, licenseUpdateStatus=licenseUpdateStatus, ethTXPauseFrames=ethTXPauseFrames, ethRXTruncatedFrames=ethRXTruncatedFrames, writeConfig=writeConfig, modemInternalAGCgain=modemInternalAGCgain, vlanPortmap=vlanPortmap, radioSide=radioSide, restartcpu=restartcpu, ethRXDones=ethRXDones, ipRadioCfg=ipRadioCfg, e1t1LOS=e1t1LOS, saf=saf, ethTXByteCounterLow=ethTXByteCounterLow, microwaveRadio=microwaveRadio, modemBandwith=modemBandwith, modemEthernetCapacity=modemEthernetCapacity, hostname=hostname, ethTXVlanTags=ethTXVlanTags, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemE1T1ChannelMask=modemE1T1ChannelMask, modemSymbolRateRx=modemSymbolRateRx, modemErroredSecond=modemErroredSecond, modemCountTime=modemCountTime, ipRadio=ipRadio, ethTXLengthCheckErrors=ethTXLengthCheckErrors, vlanNumber=vlanNumber, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioLoopback=radioLoopback, ethRXCRCErrors=ethRXCRCErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemStatistics=modemStatistics, description=description, atpcIndex=atpcIndex, radioGenStatus=radioGenStatus, localIpMask=localIpMask, modemEntry=modemEntry, vlanFid=vlanFid, product=product, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ipRadioStatEth=ipRadioStatEth, vlanPortType=vlanPortType, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXDribleNibbles=ethRXDribleNibbles, e1t1ChannelNr=e1t1ChannelNr, radioRxLevel=radioRxLevel, ipRadioCfgNetwork=ipRadioCfgNetwork, radioTxMute=radioTxMute, modemUptime=modemUptime, radioTable=radioTable, ethTXGiants=ethTXGiants, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers)
