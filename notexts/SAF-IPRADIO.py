...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXLongEvents=ethRXLongEvents, tehnika=tehnika, modemUnavailtime=modemUnavailtime, vlanPortType=vlanPortType, modemCountTime=modemCountTime, ipRadioCfgNetwork=ipRadioCfgNetwork, licenseMask=licenseMask, restartcpu=restartcpu, modemStatistics=modemStatistics, vlansEnabled=vlansEnabled, ethGFPDropedFrames=ethGFPDropedFrames, ethTXControlFrames=ethTXControlFrames, ethRXVlanTagsDetected=ethRXVlanTagsDetected, vlanEntry=vlanEntry, modemSymbolRateRx=modemSymbolRateRx, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemLastAcqError=modemLastAcqError, licenseUpdateStatus=licenseUpdateStatus, modemE1T1Channels=modemE1T1Channels, modemTotalCapacity=modemTotalCapacity, modemLDPCdecoderStress=modemLDPCdecoderStress, vlanPortmap=vlanPortmap, ethTXLateCollisions=ethTXLateCollisions, ethRXCodeErrors=ethRXCodeErrors, modemEthernetCapacity=modemEthernetCapacity, ethTXByteCounterLow=ethTXByteCounterLow, modemGeneralStatus=modemGeneralStatus, ipRadioStat=ipRadioStat, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioDuplexShift=radioDuplexShift, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXPauseFrames=ethTXPauseFrames, vlanTable=vlanTable, vlanCfgStat=vlanCfgStat, e1t1LOS=e1t1LOS, description=description, radioTxFrequency=radioTxFrequency, saf=saf, ethTXGiants=ethTXGiants, ethRXByteCounterHi=ethRXByteCounterHi, modemIndex=modemIndex, vlanRowStatus=vlanRowStatus, modemSymbolRateTx=modemSymbolRateTx, ethRXDones=ethRXDones, ethQOSTXFrames=ethQOSTXFrames, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, vlanFid=vlanFid, modemInternalAGCgain=modemInternalAGCgain, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXBroadcasts=ethTXBroadcasts, radioSide=radioSide, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethGFPCHECErrors=ethGFPCHECErrors, modemStandard=modemStandard, modemErroredBlock=modemErroredBlock, hostname=hostname, license=license, ethTXVlanTags=ethTXVlanTags, radioIndex=radioIndex, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXDribleNibbles=ethRXDribleNibbles, e1t1StatEntry=e1t1StatEntry, modemErroredSecond=modemErroredSecond, sysDateAndTime=sysDateAndTime, ethTXCollisions=ethTXCollisions, e1t1AIS=e1t1AIS, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXBroadcasts=ethRXBroadcasts, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioEntry=radioEntry, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXDones=ethTXDones, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemAcqStatus=modemAcqStatus, radioRxFrequency=radioRxFrequency, modemTable=modemTable, loopback_tributary_mask=loopback_tributary_mask, modemRadialMSE=modemRadialMSE, ipRadioMgmt=ipRadioMgmt, ethTXExcessiveDefers=ethTXExcessiveDefers, modemRowStatus=modemRowStatus, ipRadioCfgGeneral=ipRadioCfgGeneral, ethQOSTXDropped=ethQOSTXDropped, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemErroredSecondRatio=modemErroredSecondRatio, loopbacks=loopbacks, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemACMtotalCapacity=modemACMtotalCapacity, ethRXCRCErrors=ethRXCRCErrors, modemModulation=modemModulation, ethRXPauseFrames=ethRXPauseFrames, ethRXControlFrames=ethRXControlFrames, pointToPoint=pointToPoint, product=product, modemUptime=modemUptime, aTPCEntry=aTPCEntry, writeConfig=writeConfig, modemACMengine=modemACMengine, ethTXWireByteCounterHi=ethTXWireByteCounterHi, microwaveRadio=microwaveRadio, modemCarrierOffset=modemCarrierOffset, localIpMask=localIpMask, ethRXDvEvent=ethRXDvEvent, ethTXMaxCollisions=ethTXMaxCollisions, ethGFPFCSErrors=ethGFPFCSErrors, modemTotalBlockNumber=modemTotalBlockNumber, ethTXMulticasts=ethTXMulticasts, atpcTxPowerCorrection=atpcTxPowerCorrection, modemBandwith=modemBandwith, localIp=localIp, ethRXMulticasts=ethRXMulticasts, ipRadio=ipRadio, radioLoopback=radioLoopback, modemACMmodulationMax=modemACMmodulationMax, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, remoteIp=remoteIp, modemACMethernetCapacity=modemACMethernetCapacity, radioGenStatus=radioGenStatus, radioTxPower=radioTxPower, modemEntry=modemEntry, ipRadioCfg=ipRadioCfg, ethTXByteCounterHi=ethTXByteCounterHi, aTPCTable=aTPCTable, ipRadioStatEth=ipRadioStatEth, radioRxLevel=radioRxLevel, e1t1StatTable=e1t1StatTable, atpcEnabled=atpcEnabled, safip=safip, sysTemperature=sysTemperature, ethRXByteCounterLow=ethRXByteCounterLow, modemACMmodulationMin=modemACMmodulationMin, atpcIndex=atpcIndex, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXUnderruns=ethTXUnderruns, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXBackpresEvents=ethTXBackpresEvents, radioTable=radioTable, e1t1ChannelNr=e1t1ChannelNr, ethTXCRCErrors=ethTXCRCErrors, vlanNumber=vlanNumber, radioTxMute=radioTxMute)
