...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXPrevPktDropped=ethRXPrevPktDropped, modemEntry=modemEntry, modemRowStatus=modemRowStatus, ethRXDones=ethRXDones, modemEthernetCapacity=modemEthernetCapacity, vlanPortType=vlanPortType, ethRXMulticasts=ethRXMulticasts, modemACMmodulationMin=modemACMmodulationMin, ethRXCRCErrors=ethRXCRCErrors, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, microwaveRadio=microwaveRadio, vlansEnabled=vlansEnabled, modemACMtotalCapacity=modemACMtotalCapacity, vlanNumber=vlanNumber, ethRXDribleNibbles=ethRXDribleNibbles, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, product=product, radioTable=radioTable, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemLDPCdecoderStress=modemLDPCdecoderStress, modemUnavailtime=modemUnavailtime, ethGFPDropedFrames=ethGFPDropedFrames, ethRXPauseFrames=ethRXPauseFrames, ipRadioCfgNetwork=ipRadioCfgNetwork, modemCarrierOffset=modemCarrierOffset, vlanPortmap=vlanPortmap, licenseMask=licenseMask, ipRadioMgmt=ipRadioMgmt, ethRXDvEvent=ethRXDvEvent, remoteIp=remoteIp, modemSymbolRateTx=modemSymbolRateTx, modemAcqStatus=modemAcqStatus, ethTXMulticasts=ethTXMulticasts, modemACMengine=modemACMengine, e1t1LOS=e1t1LOS, ethRXControlFrames=ethRXControlFrames, ethTXCollisions=ethTXCollisions, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemBandwith=modemBandwith, ethTXWireByteCounterHi=ethTXWireByteCounterHi, license=license, pointToPoint=pointToPoint, ipRadioStatEth=ipRadioStatEth, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXControlFrames=ethTXControlFrames, writeConfig=writeConfig, radioRxLevel=radioRxLevel, atpcEnabled=atpcEnabled, modemACMethernetCapacity=modemACMethernetCapacity, vlanFid=vlanFid, ethRXByteCounterLow=ethRXByteCounterLow, modemStandard=modemStandard, aTPCEntry=aTPCEntry, e1t1StatTable=e1t1StatTable, vlanTable=vlanTable, localIp=localIp, ethTXCRCErrors=ethTXCRCErrors, safip=safip, ethTXMaxCollisions=ethTXMaxCollisions, radioGenStatus=radioGenStatus, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXCodeErrors=ethRXCodeErrors, ethGFPDelineationErrors=ethGFPDelineationErrors, modemErroredBlock=modemErroredBlock, ethGFPFCSErrors=ethGFPFCSErrors, atpcIndex=atpcIndex, e1t1ChannelNr=e1t1ChannelNr, radioIndex=radioIndex, vlanRowStatus=vlanRowStatus, ethGFPCHECErrors=ethGFPCHECErrors, radioTxFrequency=radioTxFrequency, ethTXUnderruns=ethTXUnderruns, ipRadioCfg=ipRadioCfg, ipRadio=ipRadio, loopback_tributary_mask=loopback_tributary_mask, ethTXByteCounterLow=ethTXByteCounterLow, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXBroadcasts=ethRXBroadcasts, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemErroredSecond=modemErroredSecond, modemGeneralStatus=modemGeneralStatus, ethQOSTXDropped=ethQOSTXDropped, e1t1AIS=e1t1AIS, modemStatistics=modemStatistics, modemLastAcqError=modemLastAcqError, modemSymbolRateRx=modemSymbolRateRx, ethTXExcessiveDefers=ethTXExcessiveDefers, modemE1T1ChannelMask=modemE1T1ChannelMask, modemModulation=modemModulation, radioSide=radioSide, radioRxFrequency=radioRxFrequency, radioEntry=radioEntry, ethTXBroadcasts=ethTXBroadcasts, localIpMask=localIpMask, ethTXDones=ethTXDones, modemErroredSecondRatio=modemErroredSecondRatio, ethTXGiants=ethTXGiants, ethTXByteCounterHi=ethTXByteCounterHi, modemACMmodulationMax=modemACMmodulationMax, modemTotalCapacity=modemTotalCapacity, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, description=description, modemUptime=modemUptime, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ipRadioStat=ipRadioStat, modemIndex=modemIndex, ethRXByteCounterHi=ethRXByteCounterHi, ethTXVlanTags=ethTXVlanTags, ethRXLongEvents=ethRXLongEvents, radioTxMute=radioTxMute, ethTXPauseFrames=ethTXPauseFrames, vlanEntry=vlanEntry, ethTXBackpresEvents=ethTXBackpresEvents, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemRadialMSE=modemRadialMSE, modemCountTime=modemCountTime, loopbacks=loopbacks, modemE1T1Channels=modemE1T1Channels, modemTable=modemTable, aTPCTable=aTPCTable, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethQOSTXFrames=ethQOSTXFrames, ethTXLateCollisions=ethTXLateCollisions, saf=saf, restartcpu=restartcpu, e1t1StatEntry=e1t1StatEntry, modemTotalBlockNumber=modemTotalBlockNumber, vlanCfgStat=vlanCfgStat, licenseUpdateStatus=licenseUpdateStatus, tehnika=tehnika, modemInternalAGCgain=modemInternalAGCgain, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioTxPower=radioTxPower, ethRXTruncatedFrames=ethRXTruncatedFrames, ethQOSRXQ2Frames=ethQOSRXQ2Frames, sysDateAndTime=sysDateAndTime, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioDuplexShift=radioDuplexShift, hostname=hostname, sysTemperature=sysTemperature, radioLoopback=radioLoopback, modemBackgroundBlockErrror=modemBackgroundBlockErrror)
