...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXLongEvents=ethRXLongEvents, ipRadio=ipRadio, radioDuplexShift=radioDuplexShift, modemACMmodulationMin=modemACMmodulationMin, atpcEnabled=atpcEnabled, modemInternalAGCgain=modemInternalAGCgain, ipRadioMgmt=ipRadioMgmt, modemAcqStatus=modemAcqStatus, atpcTxPowerCorrection=atpcTxPowerCorrection, modemIndex=modemIndex, sysDateAndTime=sysDateAndTime, ipRadioStatEth=ipRadioStatEth, ethTXDones=ethTXDones, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXMulticasts=ethTXMulticasts, ethTXByteCounterHi=ethTXByteCounterHi, modemModulation=modemModulation, localIp=localIp, modemStatistics=modemStatistics, ethTXGiants=ethTXGiants, ethRXControlFrames=ethRXControlFrames, ethTXBackpresEvents=ethTXBackpresEvents, ethRXByteCounterLow=ethRXByteCounterLow, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemACMtotalCapacity=modemACMtotalCapacity, product=product, vlansEnabled=vlansEnabled, ethTXCollisions=ethTXCollisions, radioTable=radioTable, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioLoopback=radioLoopback, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioIndex=radioIndex, modemTable=modemTable, ethRXByteCounterHi=ethRXByteCounterHi, ipRadioStat=ipRadioStat, vlanTable=vlanTable, vlanRowStatus=vlanRowStatus, e1t1LOS=e1t1LOS, ethRXDones=ethRXDones, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ipRadioCfg=ipRadioCfg, ethTXBroadcasts=ethTXBroadcasts, modemBandwith=modemBandwith, loopbacks=loopbacks, sysTemperature=sysTemperature, vlanNumber=vlanNumber, ethRXPrevPktDropped=ethRXPrevPktDropped, modemRowStatus=modemRowStatus, description=description, licenseUpdateStatus=licenseUpdateStatus, aTPCTable=aTPCTable, localIpMask=localIpMask, vlanPortType=vlanPortType, radioRxLevel=radioRxLevel, modemLDPCdecoderStress=modemLDPCdecoderStress, modemErroredBlock=modemErroredBlock, modemEthernetCapacity=modemEthernetCapacity, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethGFPFCSErrors=ethGFPFCSErrors, ethRXDvEvent=ethRXDvEvent, ethRXMulticasts=ethRXMulticasts, ethTXControlFrames=ethTXControlFrames, ethQOSTXDropped=ethQOSTXDropped, radioTxPower=radioTxPower, modemUnavailtime=modemUnavailtime, ethRXDribleNibbles=ethRXDribleNibbles, modemSymbolRateTx=modemSymbolRateTx, ethRXVlanTagsDetected=ethRXVlanTagsDetected, vlanEntry=vlanEntry, ethTXUnderruns=ethTXUnderruns, ethRXBroadcasts=ethRXBroadcasts, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, restartcpu=restartcpu, modemEntry=modemEntry, ethGFPCHECErrors=ethGFPCHECErrors, e1t1ChannelNr=e1t1ChannelNr, modemGeneralStatus=modemGeneralStatus, modemCarrierOffset=modemCarrierOffset, modemACMethernetCapacity=modemACMethernetCapacity, modemStandard=modemStandard, remoteIp=remoteIp, modemUptime=modemUptime, ethTXPauseFrames=ethTXPauseFrames, ethRXCodeErrors=ethRXCodeErrors, radioTxMute=radioTxMute, ethTXLengthCheckErrors=ethTXLengthCheckErrors, vlanFid=vlanFid, pointToPoint=pointToPoint, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemE1T1Channels=modemE1T1Channels, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, safip=safip, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXCRCErrors=ethTXCRCErrors, modemErroredSecond=modemErroredSecond, ethTXVlanTags=ethTXVlanTags, modemACMmodulationMax=modemACMmodulationMax, ipRadioCfgGeneral=ipRadioCfgGeneral, hostname=hostname, ethGFPDropedFrames=ethGFPDropedFrames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXByteCounterLow=ethTXByteCounterLow, atpcIndex=atpcIndex, radioGenStatus=radioGenStatus, ethTXLateCollisions=ethTXLateCollisions, ethRXTruncatedFrames=ethRXTruncatedFrames, writeConfig=writeConfig, vlanCfgStat=vlanCfgStat, e1t1StatTable=e1t1StatTable, microwaveRadio=microwaveRadio, ethQOSTXFrames=ethQOSTXFrames, modemSymbolRateRx=modemSymbolRateRx, radioRxFrequency=radioRxFrequency, radioTxFrequency=radioTxFrequency, modemRadialMSE=modemRadialMSE, radioSide=radioSide, modemLastAcqError=modemLastAcqError, license=license, ethRXCRCErrors=ethRXCRCErrors, e1t1AIS=e1t1AIS, ethGFPDelineationErrors=ethGFPDelineationErrors, modemTotalCapacity=modemTotalCapacity, tehnika=tehnika, ethRXPauseFrames=ethRXPauseFrames, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, saf=saf, modemErroredSecondRatio=modemErroredSecondRatio, ipRadioCfgNetwork=ipRadioCfgNetwork, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXMaxCollisions=ethTXMaxCollisions, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, e1t1StatEntry=e1t1StatEntry, vlanPortmap=vlanPortmap, modemCountTime=modemCountTime, radioEntry=radioEntry, licenseMask=licenseMask, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemTotalBlockNumber=modemTotalBlockNumber, modemACMengine=modemACMengine, loopback_tributary_mask=loopback_tributary_mask, aTPCEntry=aTPCEntry)
