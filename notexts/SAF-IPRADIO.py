...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXLongEvents=ethRXLongEvents, saf=saf, modemCarrierOffset=modemCarrierOffset, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXBackpresEvents=ethTXBackpresEvents, licenseMask=licenseMask, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXDones=ethRXDones, modemLastAcqError=modemLastAcqError, modemACMethernetCapacity=modemACMethernetCapacity, modemStandard=modemStandard, loopbacks=loopbacks, ethTXUnderruns=ethTXUnderruns, radioDuplexShift=radioDuplexShift, modemSymbolRateRx=modemSymbolRateRx, radioGenStatus=radioGenStatus, ethTXCollisions=ethTXCollisions, modemUptime=modemUptime, vlanNumber=vlanNumber, ipRadioMgmt=ipRadioMgmt, atpcIndex=atpcIndex, modemACMengine=modemACMengine, ethRXBroadcasts=ethRXBroadcasts, safip=safip, e1t1AIS=e1t1AIS, radioIndex=radioIndex, ethRXDribleNibbles=ethRXDribleNibbles, modemCountTime=modemCountTime, modemACMmodulationMax=modemACMmodulationMax, radioEntry=radioEntry, modemACMmodulationMin=modemACMmodulationMin, vlanFid=vlanFid, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlanCfgStat=vlanCfgStat, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioTxMute=radioTxMute, modemBandwith=modemBandwith, modemErroredBlock=modemErroredBlock, restartcpu=restartcpu, atpcEnabled=atpcEnabled, radioRxLevel=radioRxLevel, e1t1StatEntry=e1t1StatEntry, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXMulticasts=ethRXMulticasts, ethRXCodeErrors=ethRXCodeErrors, ethRXByteCounterLow=ethRXByteCounterLow, ethTXControlFrames=ethTXControlFrames, modemIndex=modemIndex, ethTXByteCounterHi=ethTXByteCounterHi, hostname=hostname, ethQOSTXDropped=ethQOSTXDropped, pointToPoint=pointToPoint, ethTXPauseFrames=ethTXPauseFrames, ethRXControlFrames=ethRXControlFrames, modemGeneralStatus=modemGeneralStatus, licenseUpdateStatus=licenseUpdateStatus, radioRxFrequency=radioRxFrequency, e1t1StatTable=e1t1StatTable, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemACMtotalCapacity=modemACMtotalCapacity, product=product, ethTXByteCounterLow=ethTXByteCounterLow, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXLateCollisions=ethTXLateCollisions, license=license, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemTotalCapacity=modemTotalCapacity, ethRXTruncatedFrames=ethRXTruncatedFrames, atpcTxPowerCorrection=atpcTxPowerCorrection, radioTable=radioTable, modemUnavailtime=modemUnavailtime, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioSide=radioSide, localIp=localIp, ethRXPauseFrames=ethRXPauseFrames, ethTXMaxCollisions=ethTXMaxCollisions, localIpMask=localIpMask, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXMulticasts=ethTXMulticasts, modemTotalBlockNumber=modemTotalBlockNumber, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemE1T1Channels=modemE1T1Channels, modemLDPCdecoderStress=modemLDPCdecoderStress, ethGFPCHECErrors=ethGFPCHECErrors, aTPCEntry=aTPCEntry, modemEntry=modemEntry, sysDateAndTime=sysDateAndTime, ethRXDvEvent=ethRXDvEvent, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXCRCErrors=ethRXCRCErrors, modemTable=modemTable, modemAcqStatus=modemAcqStatus, modemSymbolRateTx=modemSymbolRateTx, radioTxPower=radioTxPower, vlanPortmap=vlanPortmap, modemErroredSecond=modemErroredSecond, ethTXCRCErrors=ethTXCRCErrors, radioTxFrequency=radioTxFrequency, ethTXGiants=ethTXGiants, writeConfig=writeConfig, vlanPortType=vlanPortType, ipRadio=ipRadio, modemStatistics=modemStatistics, radioLoopback=radioLoopback, vlanTable=vlanTable, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, aTPCTable=aTPCTable, ethRXByteCounterHi=ethRXByteCounterHi, tehnika=tehnika, ipRadioStatEth=ipRadioStatEth, vlansEnabled=vlansEnabled, ethTXDones=ethTXDones, vlanRowStatus=vlanRowStatus, modemEthernetCapacity=modemEthernetCapacity, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethGFPFCSErrors=ethGFPFCSErrors, ipRadioStat=ipRadioStat, ethQOSTXFrames=ethQOSTXFrames, microwaveRadio=microwaveRadio, sysTemperature=sysTemperature, modemRadialMSE=modemRadialMSE, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXVlanTags=ethTXVlanTags, loopback_tributary_mask=loopback_tributary_mask, description=description, ethGFPDropedFrames=ethGFPDropedFrames, e1t1LOS=e1t1LOS, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemInternalAGCgain=modemInternalAGCgain, vlanEntry=vlanEntry, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemRowStatus=modemRowStatus, e1t1ChannelNr=e1t1ChannelNr, modemModulation=modemModulation, ethTXBroadcasts=ethTXBroadcasts, remoteIp=remoteIp, ipRadioCfg=ipRadioCfg, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemErroredSecondRatio=modemErroredSecondRatio)
