...
mibBuilder.exportSymbols("SAF-IPRADIO", modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXTruncatedFrames=ethRXTruncatedFrames, ethGFPCHECErrors=ethGFPCHECErrors, ethGFPFCSErrors=ethGFPFCSErrors, localIp=localIp, vlanNumber=vlanNumber, modemErroredSecond=modemErroredSecond, product=product, ethTXLateCollisions=ethTXLateCollisions, ethTXCRCErrors=ethTXCRCErrors, writeConfig=writeConfig, safip=safip, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemStatistics=modemStatistics, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ipRadioMgmt=ipRadioMgmt, atpcIndex=atpcIndex, ethRXDones=ethRXDones, modemACMethernetCapacity=modemACMethernetCapacity, ethRXDvEvent=ethRXDvEvent, ethTXCollisions=ethTXCollisions, ethTXMaxCollisions=ethTXMaxCollisions, aTPCEntry=aTPCEntry, e1t1AIS=e1t1AIS, localIpMask=localIpMask, ethTXBackpresEvents=ethTXBackpresEvents, modemACMmodulationMax=modemACMmodulationMax, modemTotalBlockNumber=modemTotalBlockNumber, vlanPortType=vlanPortType, atpcEnabled=atpcEnabled, modemTable=modemTable, vlanCfgStat=vlanCfgStat, loopback_tributary_mask=loopback_tributary_mask, ethRXControlFrames=ethRXControlFrames, ethRXCRCErrors=ethRXCRCErrors, ipRadioStat=ipRadioStat, saf=saf, radioEntry=radioEntry, modemErroredSecondRatio=modemErroredSecondRatio, restartcpu=restartcpu, hostname=hostname, ethTXByteCounterHi=ethTXByteCounterHi, modemE1T1Channels=modemE1T1Channels, e1t1StatEntry=e1t1StatEntry, modemUnavailtime=modemUnavailtime, modemBandwith=modemBandwith, radioGenStatus=radioGenStatus, modemSymbolRateTx=modemSymbolRateTx, ethRXByteCounterHi=ethRXByteCounterHi, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, vlanRowStatus=vlanRowStatus, ethQOSTXFrames=ethQOSTXFrames, modemGeneralStatus=modemGeneralStatus, modemACMengine=modemACMengine, modemErroredBlock=modemErroredBlock, radioLoopback=radioLoopback, ethTXBroadcasts=ethTXBroadcasts, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXMulticasts=ethRXMulticasts, vlanTable=vlanTable, modemModulation=modemModulation, aTPCTable=aTPCTable, radioRxLevel=radioRxLevel, vlanFid=vlanFid, modemUptime=modemUptime, modemEntry=modemEntry, e1t1LOS=e1t1LOS, ethGFPDropedFrames=ethGFPDropedFrames, modemRowStatus=modemRowStatus, licenseUpdateStatus=licenseUpdateStatus, ethRXBroadcasts=ethRXBroadcasts, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, loopbacks=loopbacks, modemIndex=modemIndex, ethRXByteCounterLow=ethRXByteCounterLow, ethTXControlFrames=ethTXControlFrames, ipRadioCfg=ipRadioCfg, radioTxFrequency=radioTxFrequency, license=license, sysTemperature=sysTemperature, ethTXMulticasts=ethTXMulticasts, radioDuplexShift=radioDuplexShift, ethTXDones=ethTXDones, ethTXByteCounterLow=ethTXByteCounterLow, pointToPoint=pointToPoint, modemEthernetCapacity=modemEthernetCapacity, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXUnderruns=ethTXUnderruns, e1t1ChannelNr=e1t1ChannelNr, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioTxPower=radioTxPower, radioIndex=radioIndex, ethQOSTXDropped=ethQOSTXDropped, modemStandard=modemStandard, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlanEntry=vlanEntry, ethGFPDelineationErrors=ethGFPDelineationErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioTxMute=radioTxMute, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXVlanTags=ethTXVlanTags, ethRXPrevPktDropped=ethRXPrevPktDropped, modemRadialMSE=modemRadialMSE, radioSide=radioSide, ethTXPauseFrames=ethTXPauseFrames, modemInternalAGCgain=modemInternalAGCgain, e1t1StatTable=e1t1StatTable, modemCountTime=modemCountTime, vlansEnabled=vlansEnabled, radioTable=radioTable, licenseMask=licenseMask, vlanPortmap=vlanPortmap, ipRadioStatEth=ipRadioStatEth, remoteIp=remoteIp, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXGiants=ethTXGiants, modemTotalCapacity=modemTotalCapacity, modemCarrierOffset=modemCarrierOffset, ipRadio=ipRadio, ethRXPauseFrames=ethRXPauseFrames, modemACMmodulationMin=modemACMmodulationMin, description=description, modemSymbolRateRx=modemSymbolRateRx, modemACMtotalCapacity=modemACMtotalCapacity, ethRXLongEvents=ethRXLongEvents, ipRadioCfgNetwork=ipRadioCfgNetwork, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemAcqStatus=modemAcqStatus, sysDateAndTime=sysDateAndTime, modemLastAcqError=modemLastAcqError, radioRxFrequency=radioRxFrequency, microwaveRadio=microwaveRadio, tehnika=tehnika, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXDribleNibbles=ethRXDribleNibbles, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXCodeErrors=ethRXCodeErrors, atpcTxPowerCorrection=atpcTxPowerCorrection)
