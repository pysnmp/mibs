...
mibBuilder.exportSymbols("SAF-IPRADIO", modemRadialMSE=modemRadialMSE, vlanPortmap=vlanPortmap, modemTotalCapacity=modemTotalCapacity, aTPCEntry=aTPCEntry, ipRadioCfgGeneral=ipRadioCfgGeneral, ipRadioMgmt=ipRadioMgmt, modemUptime=modemUptime, pointToPoint=pointToPoint, vlanEntry=vlanEntry, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXUnsupOpcodes=ethRXUnsupOpcodes, localIp=localIp, modemUnavailtime=modemUnavailtime, modemEntry=modemEntry, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethQOSTXFrames=ethQOSTXFrames, ethTXDones=ethTXDones, ethRXByteCounterLow=ethRXByteCounterLow, ethTXUnderruns=ethTXUnderruns, modemErroredSecondRatio=modemErroredSecondRatio, modemSymbolRateRx=modemSymbolRateRx, ethTXLateCollisions=ethTXLateCollisions, ethGFPCHECErrors=ethGFPCHECErrors, atpcIndex=atpcIndex, vlanFid=vlanFid, modemE1T1Channels=modemE1T1Channels, product=product, ethRXPauseFrames=ethRXPauseFrames, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXBroadcasts=ethRXBroadcasts, ethRXControlFrames=ethRXControlFrames, ethTXPauseFrames=ethTXPauseFrames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, vlanPortType=vlanPortType, modemIndex=modemIndex, modemEthernetCapacity=modemEthernetCapacity, e1t1StatTable=e1t1StatTable, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXByteCounterHi=ethRXByteCounterHi, modemACMengine=modemACMengine, licenseMask=licenseMask, ethRXCodeErrors=ethRXCodeErrors, ethRXPrevPktDropped=ethRXPrevPktDropped, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, remoteIp=remoteIp, ethTXByteCounterHi=ethTXByteCounterHi, licenseUpdateStatus=licenseUpdateStatus, ethRXDvEvent=ethRXDvEvent, modemTotalBlockNumber=modemTotalBlockNumber, modemACMethernetCapacity=modemACMethernetCapacity, modemCountTime=modemCountTime, e1t1LOS=e1t1LOS, modemStandard=modemStandard, modemTable=modemTable, radioIndex=radioIndex, ethRXDribleNibbles=ethRXDribleNibbles, ethTXMulticasts=ethTXMulticasts, ethGFPDropedFrames=ethGFPDropedFrames, modemErroredBlock=modemErroredBlock, ethRXCRCErrors=ethRXCRCErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXControlFrames=ethTXControlFrames, vlanCfgStat=vlanCfgStat, writeConfig=writeConfig, ipRadioCfg=ipRadioCfg, aTPCTable=aTPCTable, ethTXVlanTags=ethTXVlanTags, modemCarrierOffset=modemCarrierOffset, vlanNumber=vlanNumber, microwaveRadio=microwaveRadio, vlansEnabled=vlansEnabled, ipRadioCfgNetwork=ipRadioCfgNetwork, modemE1T1ChannelMask=modemE1T1ChannelMask, radioGenStatus=radioGenStatus, radioTxFrequency=radioTxFrequency, localIpMask=localIpMask, modemGeneralStatus=modemGeneralStatus, radioLoopback=radioLoopback, modemACMmodulationMax=modemACMmodulationMax, sysTemperature=sysTemperature, modemAcqStatus=modemAcqStatus, ethTXMaxCollisions=ethTXMaxCollisions, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, sysDateAndTime=sysDateAndTime, radioRxFrequency=radioRxFrequency, ethRXDones=ethRXDones, ethGFPDelineationErrors=ethGFPDelineationErrors, modemSymbolRateTx=modemSymbolRateTx, ethTXBroadcasts=ethTXBroadcasts, ipRadio=ipRadio, tehnika=tehnika, atpcEnabled=atpcEnabled, ipRadioStat=ipRadioStat, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemRowStatus=modemRowStatus, description=description, ethRXLongEvents=ethRXLongEvents, e1t1ChannelNr=e1t1ChannelNr, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioSide=radioSide, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemSeverelyErroredSecond=modemSeverelyErroredSecond, restartcpu=restartcpu, modemBandwith=modemBandwith, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethGFPFCSErrors=ethGFPFCSErrors, ethTXCRCErrors=ethTXCRCErrors, vlanRowStatus=vlanRowStatus, ethQOSRXQ2Frames=ethQOSRXQ2Frames, e1t1AIS=e1t1AIS, modemLastAcqError=modemLastAcqError, radioDuplexShift=radioDuplexShift, safip=safip, loopback_tributary_mask=loopback_tributary_mask, e1t1StatEntry=e1t1StatEntry, ethTXGiants=ethTXGiants, ethRXVlanTagsDetected=ethRXVlanTagsDetected, hostname=hostname, vlanTable=vlanTable, modemInternalAGCgain=modemInternalAGCgain, ipRadioStatEth=ipRadioStatEth, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXByteCounterLow=ethTXByteCounterLow, modemACMmodulationMin=modemACMmodulationMin, ethTXBackpresEvents=ethTXBackpresEvents, modemErroredSecond=modemErroredSecond, modemStatistics=modemStatistics, radioTable=radioTable, ethTXCollisions=ethTXCollisions, radioRxLevel=radioRxLevel, saf=saf, modemModulation=modemModulation, radioTxPower=radioTxPower, loopbacks=loopbacks, radioEntry=radioEntry, modemACMtotalCapacity=modemACMtotalCapacity, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, license=license, radioTxMute=radioTxMute, ethQOSTXDropped=ethQOSTXDropped, ethRXMulticasts=ethRXMulticasts, ethTXExcessiveDefers=ethTXExcessiveDefers)
