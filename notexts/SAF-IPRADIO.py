...
mibBuilder.exportSymbols("SAF-IPRADIO", e1t1StatTable=e1t1StatTable, ethGFPFCSErrors=ethGFPFCSErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioDuplexShift=radioDuplexShift, description=description, radioTxPower=radioTxPower, licenseMask=licenseMask, atpcEnabled=atpcEnabled, ethRXCodeErrors=ethRXCodeErrors, loopback_tributary_mask=loopback_tributary_mask, radioEntry=radioEntry, ethRXDvEvent=ethRXDvEvent, ethRXControlFrames=ethRXControlFrames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemRadialMSE=modemRadialMSE, radioRxFrequency=radioRxFrequency, ipRadioCfg=ipRadioCfg, modemErroredBlock=modemErroredBlock, modemTotalBlockNumber=modemTotalBlockNumber, modemE1T1ChannelMask=modemE1T1ChannelMask, modemCarrierOffset=modemCarrierOffset, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ipRadioCfgNetwork=ipRadioCfgNetwork, saf=saf, radioTxMute=radioTxMute, vlanPortType=vlanPortType, ethGFPCHECErrors=ethGFPCHECErrors, modemE1T1Channels=modemE1T1Channels, ethQOSTXDropped=ethQOSTXDropped, vlanRowStatus=vlanRowStatus, ipRadioStatEth=ipRadioStatEth, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXByteCounterHi=ethTXByteCounterHi, restartcpu=restartcpu, modemInternalAGCgain=modemInternalAGCgain, ethTXByteCounterLow=ethTXByteCounterLow, ethTXUnderruns=ethTXUnderruns, radioRxLevel=radioRxLevel, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, remoteIp=remoteIp, aTPCEntry=aTPCEntry, licenseUpdateStatus=licenseUpdateStatus, ethGFPDropedFrames=ethGFPDropedFrames, modemUnavailtime=modemUnavailtime, tehnika=tehnika, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemIndex=modemIndex, modemModulation=modemModulation, ethTXVlanTags=ethTXVlanTags, ethQOSRXQ1Frames=ethQOSRXQ1Frames, safip=safip, ethTXBackpresEvents=ethTXBackpresEvents, ethTXDones=ethTXDones, modemSymbolRateRx=modemSymbolRateRx, ethRXLongEvents=ethRXLongEvents, ethTXGiants=ethTXGiants, vlanFid=vlanFid, ethTXBroadcasts=ethTXBroadcasts, modemCountTime=modemCountTime, ipRadio=ipRadio, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, atpcIndex=atpcIndex, ethTXCRCErrors=ethTXCRCErrors, vlanEntry=vlanEntry, modemGeneralStatus=modemGeneralStatus, ethTXExcessiveDefers=ethTXExcessiveDefers, microwaveRadio=microwaveRadio, localIpMask=localIpMask, ipRadioStat=ipRadioStat, license=license, modemACMtotalCapacity=modemACMtotalCapacity, e1t1LOS=e1t1LOS, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXMulticasts=ethRXMulticasts, modemTable=modemTable, modemEntry=modemEntry, radioIndex=radioIndex, pointToPoint=pointToPoint, ethRXByteCounterHi=ethRXByteCounterHi, e1t1StatEntry=e1t1StatEntry, vlanNumber=vlanNumber, ethRXTruncatedFrames=ethRXTruncatedFrames, modemStatistics=modemStatistics, modemACMengine=modemACMengine, modemACMethernetCapacity=modemACMethernetCapacity, ethRXPrevPktDropped=ethRXPrevPktDropped, radioTxFrequency=radioTxFrequency, localIp=localIp, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemBandwith=modemBandwith, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXPauseFrames=ethTXPauseFrames, ethRXByteCounterLow=ethRXByteCounterLow, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioSide=radioSide, modemACMmodulationMin=modemACMmodulationMin, ethTXControlFrames=ethTXControlFrames, vlanTable=vlanTable, e1t1ChannelNr=e1t1ChannelNr, ethTXCollisions=ethTXCollisions, vlansEnabled=vlansEnabled, radioLoopback=radioLoopback, ethRXDribleNibbles=ethRXDribleNibbles, modemStandard=modemStandard, e1t1AIS=e1t1AIS, modemSymbolRateTx=modemSymbolRateTx, product=product, sysTemperature=sysTemperature, ethRXPauseFrames=ethRXPauseFrames, ethTXMulticasts=ethTXMulticasts, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemAcqStatus=modemAcqStatus, loopbacks=loopbacks, vlanPortmap=vlanPortmap, modemACMmodulationMax=modemACMmodulationMax, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXCRCErrors=ethRXCRCErrors, modemLastAcqError=modemLastAcqError, modemRowStatus=modemRowStatus, modemEthernetCapacity=modemEthernetCapacity, vlanCfgStat=vlanCfgStat, ethRXDones=ethRXDones, ethTXLateCollisions=ethTXLateCollisions, modemTotalCapacity=modemTotalCapacity, writeConfig=writeConfig, aTPCTable=aTPCTable, radioTable=radioTable, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXBroadcasts=ethRXBroadcasts, ipRadioMgmt=ipRadioMgmt, modemErroredSecond=modemErroredSecond, modemUptime=modemUptime, ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadioCfgGeneral=ipRadioCfgGeneral, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXMaxCollisions=ethTXMaxCollisions, ethQOSTXFrames=ethQOSTXFrames, modemErroredSecondRatio=modemErroredSecondRatio, hostname=hostname, radioGenStatus=radioGenStatus, sysDateAndTime=sysDateAndTime, modemBackgroundBlockErrror=modemBackgroundBlockErrror)
