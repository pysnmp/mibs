...
mibBuilder.exportSymbols("SAF-IPRADIO", sysDateAndTime=sysDateAndTime, ethTXDones=ethTXDones, ipRadioMgmt=ipRadioMgmt, modemUptime=modemUptime, radioLoopback=radioLoopback, modemCarrierOffset=modemCarrierOffset, ethRXVlanTagsDetected=ethRXVlanTagsDetected, vlanCfgStat=vlanCfgStat, aTPCEntry=aTPCEntry, modemTotalCapacity=modemTotalCapacity, pointToPoint=pointToPoint, loopbacks=loopbacks, loopback_tributary_mask=loopback_tributary_mask, modemSymbolRateTx=modemSymbolRateTx, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioSide=radioSide, description=description, modemACMethernetCapacity=modemACMethernetCapacity, vlanPortmap=vlanPortmap, ethQOSTXDropped=ethQOSTXDropped, modemRowStatus=modemRowStatus, ethTXWireByteCounterLow=ethTXWireByteCounterLow, hostname=hostname, ipRadioStat=ipRadioStat, licenseUpdateStatus=licenseUpdateStatus, e1t1StatTable=e1t1StatTable, vlanPortType=vlanPortType, ethRXMulticasts=ethRXMulticasts, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXByteCounterLow=ethRXByteCounterLow, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXUnderruns=ethTXUnderruns, modemEntry=modemEntry, modemGeneralStatus=modemGeneralStatus, modemRadialMSE=modemRadialMSE, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioEntry=radioEntry, modemBandwith=modemBandwith, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXLengthCheckErrors=ethTXLengthCheckErrors, licenseMask=licenseMask, modemLastAcqError=modemLastAcqError, modemErroredSecondRatio=modemErroredSecondRatio, ethRXCRCErrors=ethRXCRCErrors, ethRXByteCounterHi=ethRXByteCounterHi, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXPauseFrames=ethTXPauseFrames, radioTable=radioTable, radioGenStatus=radioGenStatus, ethTXBackpresEvents=ethTXBackpresEvents, ethGFPDropedFrames=ethGFPDropedFrames, ethRXBroadcasts=ethRXBroadcasts, localIpMask=localIpMask, ethTXMaxCollisions=ethTXMaxCollisions, ethRXCodeErrors=ethRXCodeErrors, ipRadioCfg=ipRadioCfg, modemACMengine=modemACMengine, ethTXVlanTags=ethTXVlanTags, radioRxFrequency=radioRxFrequency, radioTxMute=radioTxMute, ethRXPauseFrames=ethRXPauseFrames, ethQOSTXFrames=ethQOSTXFrames, ipRadio=ipRadio, modemErroredSecond=modemErroredSecond, radioTxPower=radioTxPower, license=license, vlanEntry=vlanEntry, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioTxFrequency=radioTxFrequency, vlanTable=vlanTable, radioDuplexShift=radioDuplexShift, modemModulation=modemModulation, localIp=localIp, ethTXByteCounterHi=ethTXByteCounterHi, microwaveRadio=microwaveRadio, safip=safip, modemSymbolRateRx=modemSymbolRateRx, vlanNumber=vlanNumber, e1t1LOS=e1t1LOS, sysTemperature=sysTemperature, modemTable=modemTable, ethGFPFCSErrors=ethGFPFCSErrors, atpcIndex=atpcIndex, vlanRowStatus=vlanRowStatus, ethRXDvEvent=ethRXDvEvent, e1t1ChannelNr=e1t1ChannelNr, ethTXLateCollisions=ethTXLateCollisions, modemLDPCdecoderStress=modemLDPCdecoderStress, modemE1T1Channels=modemE1T1Channels, ipRadioStatEth=ipRadioStatEth, ethRXTruncatedFrames=ethRXTruncatedFrames, restartcpu=restartcpu, ethTXCollisions=ethTXCollisions, modemAcqStatus=modemAcqStatus, ethRXLongEvents=ethRXLongEvents, modemBackgroundBlockErrror=modemBackgroundBlockErrror, atpcTxPowerCorrection=atpcTxPowerCorrection, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXGiants=ethTXGiants, ethRXControlFrames=ethRXControlFrames, ethTXBroadcasts=ethTXBroadcasts, radioIndex=radioIndex, ethRXDribleNibbles=ethRXDribleNibbles, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, writeConfig=writeConfig, modemCountTime=modemCountTime, remoteIp=remoteIp, modemACMmodulationMin=modemACMmodulationMin, ethTXByteCounterLow=ethTXByteCounterLow, ethTXControlFrames=ethTXControlFrames, modemStandard=modemStandard, ethTXMulticasts=ethTXMulticasts, modemIndex=modemIndex, modemACMmodulationMax=modemACMmodulationMax, atpcEnabled=atpcEnabled, radioRxLevel=radioRxLevel, e1t1AIS=e1t1AIS, modemTotalBlockNumber=modemTotalBlockNumber, saf=saf, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemUnavailtime=modemUnavailtime, vlansEnabled=vlansEnabled, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, product=product, modemInternalAGCgain=modemInternalAGCgain, ipRadioCfgGeneral=ipRadioCfgGeneral, modemEthernetCapacity=modemEthernetCapacity, ethGFPCHECErrors=ethGFPCHECErrors, ethRXDones=ethRXDones, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXCRCErrors=ethTXCRCErrors, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemErroredBlock=modemErroredBlock, modemStatistics=modemStatistics, modemACMtotalCapacity=modemACMtotalCapacity, modemSeverelyErroredSecond=modemSeverelyErroredSecond, e1t1StatEntry=e1t1StatEntry, vlanFid=vlanFid, aTPCTable=aTPCTable, tehnika=tehnika)
