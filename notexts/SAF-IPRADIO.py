...
mibBuilder.exportSymbols("SAF-IPRADIO", vlanTable=vlanTable, ethTXControlFrames=ethTXControlFrames, ethRXCRCErrors=ethRXCRCErrors, writeConfig=writeConfig, radioTxFrequency=radioTxFrequency, modemInternalAGCgain=modemInternalAGCgain, radioGenStatus=radioGenStatus, ethQOSTXDropped=ethQOSTXDropped, product=product, radioEntry=radioEntry, ipRadioStatEth=ipRadioStatEth, ethTXByteCounterLow=ethTXByteCounterLow, hostname=hostname, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, licenseUpdateStatus=licenseUpdateStatus, ethQOSRXQ2Frames=ethQOSRXQ2Frames, e1t1LOS=e1t1LOS, modemErroredBlock=modemErroredBlock, pointToPoint=pointToPoint, ethGFPCHECErrors=ethGFPCHECErrors, modemEthernetCapacity=modemEthernetCapacity, remoteIp=remoteIp, ethRXControlFrames=ethRXControlFrames, modemLDPCdecoderStress=modemLDPCdecoderStress, modemErroredSecond=modemErroredSecond, vlanCfgStat=vlanCfgStat, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXCodeErrors=ethRXCodeErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, saf=saf, localIp=localIp, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemStandard=modemStandard, radioTxPower=radioTxPower, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemRowStatus=modemRowStatus, ethRXLongEvents=ethRXLongEvents, vlanNumber=vlanNumber, ethTXGiants=ethTXGiants, e1t1StatTable=e1t1StatTable, ethRXDvEvent=ethRXDvEvent, ethRXByteCounterLow=ethRXByteCounterLow, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXDribleNibbles=ethRXDribleNibbles, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXUnderruns=ethTXUnderruns, ethTXLateCollisions=ethTXLateCollisions, ethRXBroadcasts=ethRXBroadcasts, radioIndex=radioIndex, ipRadioStat=ipRadioStat, modemStatistics=modemStatistics, radioTable=radioTable, aTPCEntry=aTPCEntry, modemCarrierOffset=modemCarrierOffset, ethTXMaxCollisions=ethTXMaxCollisions, vlanFid=vlanFid, ethGFPDelineationErrors=ethGFPDelineationErrors, e1t1ChannelNr=e1t1ChannelNr, localIpMask=localIpMask, modemACMengine=modemACMengine, modemSeverelyErroredSecond=modemSeverelyErroredSecond, e1t1StatEntry=e1t1StatEntry, safip=safip, ethTXCRCErrors=ethTXCRCErrors, modemE1T1Channels=modemE1T1Channels, ethTXDones=ethTXDones, ethTXPauseFrames=ethTXPauseFrames, ethTXMulticasts=ethTXMulticasts, modemSymbolRateRx=modemSymbolRateRx, ethRXByteCounterHi=ethRXByteCounterHi, ethTXWireByteCounterHi=ethTXWireByteCounterHi, sysTemperature=sysTemperature, ethRXPrevPktDropped=ethRXPrevPktDropped, modemGeneralStatus=modemGeneralStatus, modemEntry=modemEntry, ipRadioMgmt=ipRadioMgmt, ethTXBroadcasts=ethTXBroadcasts, modemTotalBlockNumber=modemTotalBlockNumber, modemLastAcqError=modemLastAcqError, ethRXDones=ethRXDones, radioDuplexShift=radioDuplexShift, vlansEnabled=vlansEnabled, ipRadioCfg=ipRadioCfg, ethGFPDropedFrames=ethGFPDropedFrames, ethQOSTXFrames=ethQOSTXFrames, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXByteCounterHi=ethTXByteCounterHi, loopbacks=loopbacks, ethRXTruncatedFrames=ethRXTruncatedFrames, modemModulation=modemModulation, vlanRowStatus=vlanRowStatus, microwaveRadio=microwaveRadio, ipRadioCfgNetwork=ipRadioCfgNetwork, modemRadialMSE=modemRadialMSE, modemBandwith=modemBandwith, license=license, restartcpu=restartcpu, modemErroredSecondRatio=modemErroredSecondRatio, ethRXPauseFrames=ethRXPauseFrames, vlanPortType=vlanPortType, loopback_tributary_mask=loopback_tributary_mask, radioRxLevel=radioRxLevel, atpcEnabled=atpcEnabled, modemACMtotalCapacity=modemACMtotalCapacity, modemTable=modemTable, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXMulticasts=ethRXMulticasts, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, e1t1AIS=e1t1AIS, modemIndex=modemIndex, ethTXExcessiveDefers=ethTXExcessiveDefers, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioRxFrequency=radioRxFrequency, radioSide=radioSide, modemE1T1ChannelMask=modemE1T1ChannelMask, ethGFPFCSErrors=ethGFPFCSErrors, sysDateAndTime=sysDateAndTime, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXBackpresEvents=ethTXBackpresEvents, modemACMmodulationMax=modemACMmodulationMax, modemAcqStatus=modemAcqStatus, modemUptime=modemUptime, atpcIndex=atpcIndex, modemACMethernetCapacity=modemACMethernetCapacity, aTPCTable=aTPCTable, modemUnavailtime=modemUnavailtime, description=description, tehnika=tehnika, licenseMask=licenseMask, radioLoopback=radioLoopback, modemCountTime=modemCountTime, modemSymbolRateTx=modemSymbolRateTx, modemACMmodulationMin=modemACMmodulationMin, vlanPortmap=vlanPortmap, ethTXVlanTags=ethTXVlanTags, ipRadio=ipRadio, radioTxMute=radioTxMute, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXCollisions=ethTXCollisions, vlanEntry=vlanEntry, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemTotalCapacity=modemTotalCapacity)
