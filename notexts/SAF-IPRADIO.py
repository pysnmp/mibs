...
mibBuilder.exportSymbols("SAF-IPRADIO", ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemUptime=modemUptime, radioRxFrequency=radioRxFrequency, loopbacks=loopbacks, ethTXMaxCollisions=ethTXMaxCollisions, e1t1LOS=e1t1LOS, modemCountTime=modemCountTime, modemErroredSecondRatio=modemErroredSecondRatio, modemGeneralStatus=modemGeneralStatus, modemBandwith=modemBandwith, modemAcqStatus=modemAcqStatus, modemLDPCdecoderStress=modemLDPCdecoderStress, modemACMmodulationMax=modemACMmodulationMax, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioTxFrequency=radioTxFrequency, ethRXByteCounterHi=ethRXByteCounterHi, remoteIp=remoteIp, modemIndex=modemIndex, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, loopback_tributary_mask=loopback_tributary_mask, ethRXByteCounterLow=ethRXByteCounterLow, modemACMethernetCapacity=modemACMethernetCapacity, ethRXTruncatedFrames=ethRXTruncatedFrames, modemACMtotalCapacity=modemACMtotalCapacity, ethTXCRCErrors=ethTXCRCErrors, ethRXPrevPktDropped=ethRXPrevPktDropped, modemTable=modemTable, ethTXBroadcasts=ethTXBroadcasts, ethTXLateCollisions=ethTXLateCollisions, ethGFPFCSErrors=ethGFPFCSErrors, vlanNumber=vlanNumber, ethRXMulticasts=ethRXMulticasts, atpcIndex=atpcIndex, ethQOSTXDropped=ethQOSTXDropped, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXCollisions=ethTXCollisions, saf=saf, product=product, ethRXControlFrames=ethRXControlFrames, modemACMmodulationMin=modemACMmodulationMin, modemRadialMSE=modemRadialMSE, ipRadioCfgGeneral=ipRadioCfgGeneral, vlanPortmap=vlanPortmap, modemRowStatus=modemRowStatus, modemErroredSecond=modemErroredSecond, ethGFPDropedFrames=ethGFPDropedFrames, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXCRCErrors=ethRXCRCErrors, hostname=hostname, ethTXWireByteCounterHi=ethTXWireByteCounterHi, restartcpu=restartcpu, aTPCTable=aTPCTable, modemE1T1ChannelMask=modemE1T1ChannelMask, vlanEntry=vlanEntry, ethTXDones=ethTXDones, e1t1StatTable=e1t1StatTable, radioEntry=radioEntry, radioIndex=radioIndex, radioGenStatus=radioGenStatus, modemACMengine=modemACMengine, modemLastAcqError=modemLastAcqError, ipRadioMgmt=ipRadioMgmt, modemE1T1Channels=modemE1T1Channels, ethRXUnsupOpcodes=ethRXUnsupOpcodes, e1t1StatEntry=e1t1StatEntry, ethTXByteCounterLow=ethTXByteCounterLow, modemCarrierOffset=modemCarrierOffset, sysTemperature=sysTemperature, localIpMask=localIpMask, ethTXBackpresEvents=ethTXBackpresEvents, microwaveRadio=microwaveRadio, modemStandard=modemStandard, ethGFPCHECErrors=ethGFPCHECErrors, modemEthernetCapacity=modemEthernetCapacity, ethRXDones=ethRXDones, e1t1AIS=e1t1AIS, ipRadio=ipRadio, radioRxLevel=radioRxLevel, localIp=localIp, ipRadioCfg=ipRadioCfg, ethQOSTXFrames=ethQOSTXFrames, modemInternalAGCgain=modemInternalAGCgain, ethRXDvEvent=ethRXDvEvent, licenseUpdateStatus=licenseUpdateStatus, modemSymbolRateRx=modemSymbolRateRx, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, pointToPoint=pointToPoint, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXCodeErrors=ethRXCodeErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXPauseFrames=ethRXPauseFrames, ipRadioCfgNetwork=ipRadioCfgNetwork, vlanFid=vlanFid, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXVlanTagsDetected=ethRXVlanTagsDetected, license=license, licenseMask=licenseMask, ethTXGiants=ethTXGiants, modemErroredBlock=modemErroredBlock, ethTXMulticasts=ethTXMulticasts, ethRXLongEvents=ethRXLongEvents, modemSeverelyErroredSecond=modemSeverelyErroredSecond, sysDateAndTime=sysDateAndTime, vlanTable=vlanTable, radioTable=radioTable, ethTXUnderruns=ethTXUnderruns, tehnika=tehnika, modemStatistics=modemStatistics, description=description, ethTXControlFrames=ethTXControlFrames, e1t1ChannelNr=e1t1ChannelNr, vlanPortType=vlanPortType, ethRXDribleNibbles=ethRXDribleNibbles, ethTXWireByteCounterLow=ethTXWireByteCounterLow, safip=safip, writeConfig=writeConfig, ethTXExcessiveDefers=ethTXExcessiveDefers, modemSymbolRateTx=modemSymbolRateTx, ethTXByteCounterHi=ethTXByteCounterHi, aTPCEntry=aTPCEntry, modemTotalCapacity=modemTotalCapacity, radioSide=radioSide, radioLoopback=radioLoopback, modemTotalBlockNumber=modemTotalBlockNumber, vlansEnabled=vlansEnabled, ipRadioStatEth=ipRadioStatEth, ipRadioStat=ipRadioStat, radioTxMute=radioTxMute, modemEntry=modemEntry, ethGFPDelineationErrors=ethGFPDelineationErrors, atpcEnabled=atpcEnabled, vlanCfgStat=vlanCfgStat, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXBroadcasts=ethRXBroadcasts, radioTxPower=radioTxPower, radioDuplexShift=radioDuplexShift, modemUnavailtime=modemUnavailtime, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXVlanTags=ethTXVlanTags, vlanRowStatus=vlanRowStatus, ethTXPauseFrames=ethTXPauseFrames, modemModulation=modemModulation)
