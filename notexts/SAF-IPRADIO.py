...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXControlFrames=ethTXControlFrames, aTPCTable=aTPCTable, modemACMethernetCapacity=modemACMethernetCapacity, radioTxMute=radioTxMute, ethRXDvEvent=ethRXDvEvent, modemErroredSecond=modemErroredSecond, ethTXCollisions=ethTXCollisions, ethGFPDelineationErrors=ethGFPDelineationErrors, vlanPortmap=vlanPortmap, radioTxPower=radioTxPower, ethTXBackpresEvents=ethTXBackpresEvents, ipRadio=ipRadio, ethRXDones=ethRXDones, ethRXMulticasts=ethRXMulticasts, modemGeneralStatus=modemGeneralStatus, modemCarrierOffset=modemCarrierOffset, modemSymbolRateTx=modemSymbolRateTx, remoteIp=remoteIp, ethQOSTXFrames=ethQOSTXFrames, ethRXByteCounterLow=ethRXByteCounterLow, ethTXCRCErrors=ethTXCRCErrors, product=product, licenseMask=licenseMask, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemStatistics=modemStatistics, ethTXMaxCollisions=ethTXMaxCollisions, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ipRadioCfgNetwork=ipRadioCfgNetwork, loopback_tributary_mask=loopback_tributary_mask, ethTXPauseFrames=ethTXPauseFrames, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ipRadioCfgGeneral=ipRadioCfgGeneral, description=description, modemEthernetCapacity=modemEthernetCapacity, radioRxLevel=radioRxLevel, hostname=hostname, radioSide=radioSide, restartcpu=restartcpu, radioTable=radioTable, modemCountTime=modemCountTime, ethGFPFCSErrors=ethGFPFCSErrors, ethRXLongEvents=ethRXLongEvents, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemAcqStatus=modemAcqStatus, modemBandwith=modemBandwith, vlanTable=vlanTable, e1t1StatTable=e1t1StatTable, ethRXCRCErrors=ethRXCRCErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioTxFrequency=radioTxFrequency, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, loopbacks=loopbacks, modemTotalCapacity=modemTotalCapacity, modemInternalAGCgain=modemInternalAGCgain, ethTXGiants=ethTXGiants, modemEntry=modemEntry, saf=saf, modemLDPCdecoderStress=modemLDPCdecoderStress, modemACMengine=modemACMengine, atpcIndex=atpcIndex, ethRXPauseFrames=ethRXPauseFrames, ethGFPDropedFrames=ethGFPDropedFrames, localIpMask=localIpMask, modemUnavailtime=modemUnavailtime, vlanPortType=vlanPortType, safip=safip, vlanCfgStat=vlanCfgStat, modemTable=modemTable, modemModulation=modemModulation, ethTXUnderruns=ethTXUnderruns, radioLoopback=radioLoopback, ethRXBroadcasts=ethRXBroadcasts, modemSymbolRateRx=modemSymbolRateRx, modemErroredSecondRatio=modemErroredSecondRatio, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXMulticasts=ethTXMulticasts, ethRXDribleNibbles=ethRXDribleNibbles, modemErroredBlock=modemErroredBlock, modemStandard=modemStandard, ethTXVlanTags=ethTXVlanTags, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXLateCollisions=ethTXLateCollisions, modemE1T1Channels=modemE1T1Channels, ipRadioCfg=ipRadioCfg, radioDuplexShift=radioDuplexShift, ethRXCodeErrors=ethRXCodeErrors, modemRadialMSE=modemRadialMSE, ipRadioMgmt=ipRadioMgmt, atpcTxPowerCorrection=atpcTxPowerCorrection, microwaveRadio=microwaveRadio, modemLastAcqError=modemLastAcqError, modemUptime=modemUptime, licenseUpdateStatus=licenseUpdateStatus, modemRowStatus=modemRowStatus, radioRxFrequency=radioRxFrequency, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXByteCounterHi=ethRXByteCounterHi, vlanNumber=vlanNumber, radioGenStatus=radioGenStatus, e1t1AIS=e1t1AIS, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, aTPCEntry=aTPCEntry, ethGFPCHECErrors=ethGFPCHECErrors, modemACMmodulationMin=modemACMmodulationMin, pointToPoint=pointToPoint, writeConfig=writeConfig, localIp=localIp, ethQOSTXDropped=ethQOSTXDropped, ipRadioStat=ipRadioStat, modemTotalBlockNumber=modemTotalBlockNumber, vlanFid=vlanFid, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemIndex=modemIndex, radioEntry=radioEntry, sysTemperature=sysTemperature, vlansEnabled=vlansEnabled, ethTXByteCounterHi=ethTXByteCounterHi, modemACMtotalCapacity=modemACMtotalCapacity, e1t1LOS=e1t1LOS, radioIndex=radioIndex, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXTruncatedFrames=ethRXTruncatedFrames, vlanEntry=vlanEntry, ethTXDones=ethTXDones, e1t1ChannelNr=e1t1ChannelNr, ethTXByteCounterLow=ethTXByteCounterLow, modemE1T1ChannelMask=modemE1T1ChannelMask, ipRadioStatEth=ipRadioStatEth, modemBackgroundBlockErrror=modemBackgroundBlockErrror, license=license, ethRXUnsupOpcodes=ethRXUnsupOpcodes, tehnika=tehnika, vlanRowStatus=vlanRowStatus, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, sysDateAndTime=sysDateAndTime, modemACMmodulationMax=modemACMmodulationMax, atpcEnabled=atpcEnabled, ethTXBroadcasts=ethTXBroadcasts, e1t1StatEntry=e1t1StatEntry, ethRXControlFrames=ethRXControlFrames, ethTXExcessiveDefers=ethTXExcessiveDefers)
