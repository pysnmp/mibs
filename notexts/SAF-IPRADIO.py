...
mibBuilder.exportSymbols("SAF-IPRADIO", modemEthernetCapacity=modemEthernetCapacity, modemUptime=modemUptime, radioDuplexShift=radioDuplexShift, modemACMmodulationMin=modemACMmodulationMin, modemGeneralStatus=modemGeneralStatus, modemACMmodulationMax=modemACMmodulationMax, modemRadialMSE=modemRadialMSE, radioSide=radioSide, ethGFPFCSErrors=ethGFPFCSErrors, radioRxFrequency=radioRxFrequency, ethTXUnderruns=ethTXUnderruns, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXVlanTags=ethTXVlanTags, e1t1StatTable=e1t1StatTable, modemACMtotalCapacity=modemACMtotalCapacity, tehnika=tehnika, atpcEnabled=atpcEnabled, aTPCEntry=aTPCEntry, atpcIndex=atpcIndex, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, licenseUpdateStatus=licenseUpdateStatus, ethRXBroadcasts=ethRXBroadcasts, modemACMethernetCapacity=modemACMethernetCapacity, modemTotalCapacity=modemTotalCapacity, radioTxMute=radioTxMute, e1t1LOS=e1t1LOS, modemBackgroundBlockErrror=modemBackgroundBlockErrror, hostname=hostname, ethRXControlFrames=ethRXControlFrames, atpcTxPowerCorrection=atpcTxPowerCorrection, ipRadioStat=ipRadioStat, modemUnavailtime=modemUnavailtime, modemStatistics=modemStatistics, e1t1StatEntry=e1t1StatEntry, license=license, modemAcqStatus=modemAcqStatus, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, sysTemperature=sysTemperature, ethTXControlFrames=ethTXControlFrames, sysDateAndTime=sysDateAndTime, ethTXMulticasts=ethTXMulticasts, ipRadioCfgGeneral=ipRadioCfgGeneral, ipRadio=ipRadio, ethGFPDropedFrames=ethGFPDropedFrames, vlanEntry=vlanEntry, product=product, vlanFid=vlanFid, remoteIp=remoteIp, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, e1t1ChannelNr=e1t1ChannelNr, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemSymbolRateRx=modemSymbolRateRx, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlanPortmap=vlanPortmap, ethRXPauseFrames=ethRXPauseFrames, ethRXCodeErrors=ethRXCodeErrors, radioLoopback=radioLoopback, ethRXDribleNibbles=ethRXDribleNibbles, aTPCTable=aTPCTable, licenseMask=licenseMask, modemRowStatus=modemRowStatus, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethGFPCHECErrors=ethGFPCHECErrors, localIp=localIp, modemLDPCdecoderStress=modemLDPCdecoderStress, modemErroredSecond=modemErroredSecond, vlanRowStatus=vlanRowStatus, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethGFPDelineationErrors=ethGFPDelineationErrors, modemModulation=modemModulation, ethTXCRCErrors=ethTXCRCErrors, modemCountTime=modemCountTime, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXWireByteCounterHi=ethTXWireByteCounterHi, vlanTable=vlanTable, description=description, pointToPoint=pointToPoint, radioRxLevel=radioRxLevel, radioGenStatus=radioGenStatus, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ipRadioCfg=ipRadioCfg, ipRadioMgmt=ipRadioMgmt, writeConfig=writeConfig, radioTable=radioTable, modemCarrierOffset=modemCarrierOffset, ethRXPrevPktDropped=ethRXPrevPktDropped, modemE1T1ChannelMask=modemE1T1ChannelMask, saf=saf, vlanNumber=vlanNumber, modemE1T1Channels=modemE1T1Channels, ethTXByteCounterLow=ethTXByteCounterLow, ethTXBroadcasts=ethTXBroadcasts, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXCRCErrors=ethRXCRCErrors, radioTxPower=radioTxPower, ethRXByteCounterLow=ethRXByteCounterLow, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemStandard=modemStandard, ethTXGiants=ethTXGiants, ethTXByteCounterHi=ethTXByteCounterHi, ethRXLongEvents=ethRXLongEvents, ethTXBackpresEvents=ethTXBackpresEvents, e1t1AIS=e1t1AIS, ethTXExcessiveDefers=ethTXExcessiveDefers, modemEntry=modemEntry, vlanPortType=vlanPortType, modemBandwith=modemBandwith, microwaveRadio=microwaveRadio, radioEntry=radioEntry, modemTable=modemTable, ethTXPauseFrames=ethTXPauseFrames, vlanCfgStat=vlanCfgStat, ethQOSTXDropped=ethQOSTXDropped, ethTXCollisions=ethTXCollisions, modemLastAcqError=modemLastAcqError, vlansEnabled=vlansEnabled, modemIndex=modemIndex, ethRXDvEvent=ethRXDvEvent, radioIndex=radioIndex, ipRadioStatEth=ipRadioStatEth, ethQOSTXFrames=ethQOSTXFrames, modemErroredBlock=modemErroredBlock, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioTxFrequency=radioTxFrequency, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemSymbolRateTx=modemSymbolRateTx, ethRXMulticasts=ethRXMulticasts, loopback_tributary_mask=loopback_tributary_mask, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemACMengine=modemACMengine, ethTXLateCollisions=ethTXLateCollisions, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXMaxCollisions=ethTXMaxCollisions, safip=safip, ethRXDones=ethRXDones, modemTotalBlockNumber=modemTotalBlockNumber, localIpMask=localIpMask, modemInternalAGCgain=modemInternalAGCgain, ethRXTruncatedFrames=ethRXTruncatedFrames, restartcpu=restartcpu, modemErroredSecondRatio=modemErroredSecondRatio, ethTXDones=ethTXDones, ethRXByteCounterHi=ethRXByteCounterHi, loopbacks=loopbacks)
