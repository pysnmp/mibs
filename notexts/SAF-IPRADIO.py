...
mibBuilder.exportSymbols("SAF-IPRADIO", licenseUpdateStatus=licenseUpdateStatus, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemAcqStatus=modemAcqStatus, ipRadioCfg=ipRadioCfg, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemRowStatus=modemRowStatus, radioTable=radioTable, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ipRadioStat=ipRadioStat, modemRadialMSE=modemRadialMSE, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, localIpMask=localIpMask, aTPCEntry=aTPCEntry, restartcpu=restartcpu, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXCRCErrors=ethRXCRCErrors, modemLastAcqError=modemLastAcqError, vlansEnabled=vlansEnabled, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXCRCErrors=ethTXCRCErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemSymbolRateTx=modemSymbolRateTx, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemUptime=modemUptime, ethRXDvEvent=ethRXDvEvent, ipRadioCfgGeneral=ipRadioCfgGeneral, radioGenStatus=radioGenStatus, ethRXPauseFrames=ethRXPauseFrames, sysTemperature=sysTemperature, ethGFPFCSErrors=ethGFPFCSErrors, modemCarrierOffset=modemCarrierOffset, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXUnderruns=ethTXUnderruns, modemTotalBlockNumber=modemTotalBlockNumber, radioTxPower=radioTxPower, aTPCTable=aTPCTable, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXBroadcasts=ethRXBroadcasts, radioSide=radioSide, modemTable=modemTable, modemEthernetCapacity=modemEthernetCapacity, ethQOSRXQ1Frames=ethQOSRXQ1Frames, localIp=localIp, e1t1AIS=e1t1AIS, ethTXPauseFrames=ethTXPauseFrames, modemTotalCapacity=modemTotalCapacity, modemACMmodulationMin=modemACMmodulationMin, safip=safip, ethTXGiants=ethTXGiants, ipRadio=ipRadio, atpcIndex=atpcIndex, modemE1T1Channels=modemE1T1Channels, modemACMtotalCapacity=modemACMtotalCapacity, modemStatistics=modemStatistics, vlanCfgStat=vlanCfgStat, ethRXByteCounterHi=ethRXByteCounterHi, ethRXByteCounterLow=ethRXByteCounterLow, modemEntry=modemEntry, modemBandwith=modemBandwith, modemUnavailtime=modemUnavailtime, modemE1T1ChannelMask=modemE1T1ChannelMask, writeConfig=writeConfig, modemACMethernetCapacity=modemACMethernetCapacity, modemErroredSecond=modemErroredSecond, ipRadioMgmt=ipRadioMgmt, modemGeneralStatus=modemGeneralStatus, ethRXMulticasts=ethRXMulticasts, modemSymbolRateRx=modemSymbolRateRx, hostname=hostname, ethRXPrevPktDropped=ethRXPrevPktDropped, modemACMmodulationMax=modemACMmodulationMax, ethTXByteCounterHi=ethTXByteCounterHi, ethRXLongEvents=ethRXLongEvents, ethRXCodeErrors=ethRXCodeErrors, loopbacks=loopbacks, tehnika=tehnika, radioTxFrequency=radioTxFrequency, license=license, ethQOSTXFrames=ethQOSTXFrames, vlanPortType=vlanPortType, ethTXVlanTags=ethTXVlanTags, ethTXControlFrames=ethTXControlFrames, modemBackgroundBlockErrror=modemBackgroundBlockErrror, e1t1StatTable=e1t1StatTable, vlanTable=vlanTable, radioIndex=radioIndex, e1t1ChannelNr=e1t1ChannelNr, ethGFPDropedFrames=ethGFPDropedFrames, vlanFid=vlanFid, ipRadioStatEth=ipRadioStatEth, modemIndex=modemIndex, modemModulation=modemModulation, remoteIp=remoteIp, modemACMengine=modemACMengine, modemCountTime=modemCountTime, radioTxMute=radioTxMute, radioLoopback=radioLoopback, vlanNumber=vlanNumber, e1t1LOS=e1t1LOS, ethQOSTXDropped=ethQOSTXDropped, ethTXExcessiveDefers=ethTXExcessiveDefers, vlanEntry=vlanEntry, modemInternalAGCgain=modemInternalAGCgain, ethTXBackpresEvents=ethTXBackpresEvents, radioRxFrequency=radioRxFrequency, ethTXLateCollisions=ethTXLateCollisions, radioDuplexShift=radioDuplexShift, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXByteCounterLow=ethTXByteCounterLow, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, pointToPoint=pointToPoint, vlanPortmap=vlanPortmap, ethGFPDelineationErrors=ethGFPDelineationErrors, modemErroredBlock=modemErroredBlock, product=product, modemStandard=modemStandard, loopback_tributary_mask=loopback_tributary_mask, description=description, saf=saf, ethGFPCHECErrors=ethGFPCHECErrors, ethRXDones=ethRXDones, radioRxLevel=radioRxLevel, ethTXBroadcasts=ethTXBroadcasts, ethTXCollisions=ethTXCollisions, radioEntry=radioEntry, ethRXDribleNibbles=ethRXDribleNibbles, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXControlFrames=ethRXControlFrames, microwaveRadio=microwaveRadio, vlanRowStatus=vlanRowStatus, modemErroredSecondRatio=modemErroredSecondRatio, atpcEnabled=atpcEnabled, ethTXMaxCollisions=ethTXMaxCollisions, sysDateAndTime=sysDateAndTime, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXDones=ethTXDones, ethTXMulticasts=ethTXMulticasts, licenseMask=licenseMask, e1t1StatEntry=e1t1StatEntry)
