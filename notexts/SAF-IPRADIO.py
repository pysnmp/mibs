...
mibBuilder.exportSymbols("SAF-IPRADIO", e1t1ChannelNr=e1t1ChannelNr, atpcIndex=atpcIndex, ethTXCollisions=ethTXCollisions, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXCodeErrors=ethRXCodeErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, license=license, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXPrevPktDropped=ethRXPrevPktDropped, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioRxLevel=radioRxLevel, ethRXByteCounterHi=ethRXByteCounterHi, radioLoopback=radioLoopback, vlanNumber=vlanNumber, modemLDPCdecoderStress=modemLDPCdecoderStress, modemTable=modemTable, modemErroredSecondRatio=modemErroredSecondRatio, safip=safip, ethGFPCHECErrors=ethGFPCHECErrors, ethTXMulticasts=ethTXMulticasts, ethTXLateCollisions=ethTXLateCollisions, loopback_tributary_mask=loopback_tributary_mask, modemCarrierOffset=modemCarrierOffset, modemBandwith=modemBandwith, ethRXDones=ethRXDones, sysDateAndTime=sysDateAndTime, modemEntry=modemEntry, remoteIp=remoteIp, radioGenStatus=radioGenStatus, modemACMmodulationMin=modemACMmodulationMin, ethRXControlFrames=ethRXControlFrames, ethRXBroadcasts=ethRXBroadcasts, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlanCfgStat=vlanCfgStat, radioEntry=radioEntry, ethGFPFCSErrors=ethGFPFCSErrors, modemRowStatus=modemRowStatus, modemSeverelyErroredSecond=modemSeverelyErroredSecond, saf=saf, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXCRCErrors=ethTXCRCErrors, loopbacks=loopbacks, ethTXMaxCollisions=ethTXMaxCollisions, ethTXGiants=ethTXGiants, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, e1t1AIS=e1t1AIS, modemStandard=modemStandard, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemRadialMSE=modemRadialMSE, modemLastAcqError=modemLastAcqError, vlansEnabled=vlansEnabled, e1t1LOS=e1t1LOS, modemErroredSecond=modemErroredSecond, modemGeneralStatus=modemGeneralStatus, ethQOSTXDropped=ethQOSTXDropped, ethTXPauseFrames=ethTXPauseFrames, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ipRadioStat=ipRadioStat, modemACMethernetCapacity=modemACMethernetCapacity, ipRadioCfgNetwork=ipRadioCfgNetwork, modemUptime=modemUptime, vlanRowStatus=vlanRowStatus, ethRXLongEvents=ethRXLongEvents, modemCountTime=modemCountTime, localIpMask=localIpMask, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemSymbolRateTx=modemSymbolRateTx, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXDribleNibbles=ethRXDribleNibbles, ethQOSTXFrames=ethQOSTXFrames, product=product, vlanPortType=vlanPortType, ethTXDones=ethTXDones, modemStatistics=modemStatistics, modemTotalBlockNumber=modemTotalBlockNumber, ethGFPDropedFrames=ethGFPDropedFrames, radioTxMute=radioTxMute, radioTxPower=radioTxPower, e1t1StatTable=e1t1StatTable, radioIndex=radioIndex, ethRXByteCounterLow=ethRXByteCounterLow, modemInternalAGCgain=modemInternalAGCgain, tehnika=tehnika, ethTXExcessiveDefers=ethTXExcessiveDefers, hostname=hostname, vlanEntry=vlanEntry, ethTXControlFrames=ethTXControlFrames, sysTemperature=sysTemperature, writeConfig=writeConfig, ethRXDvEvent=ethRXDvEvent, radioTable=radioTable, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioRxFrequency=radioRxFrequency, radioSide=radioSide, atpcEnabled=atpcEnabled, radioDuplexShift=radioDuplexShift, ethGFPDelineationErrors=ethGFPDelineationErrors, modemSymbolRateRx=modemSymbolRateRx, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemUnavailtime=modemUnavailtime, vlanFid=vlanFid, ethTXUnderruns=ethTXUnderruns, modemACMtotalCapacity=modemACMtotalCapacity, modemTotalCapacity=modemTotalCapacity, ethTXByteCounterLow=ethTXByteCounterLow, ipRadioMgmt=ipRadioMgmt, ethTXByteCounterHi=ethTXByteCounterHi, aTPCEntry=aTPCEntry, ethRXTruncatedFrames=ethRXTruncatedFrames, vlanPortmap=vlanPortmap, modemErroredBlock=modemErroredBlock, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXBroadcasts=ethTXBroadcasts, vlanTable=vlanTable, localIp=localIp, ethRXCRCErrors=ethRXCRCErrors, modemACMengine=modemACMengine, ipRadio=ipRadio, microwaveRadio=microwaveRadio, modemAcqStatus=modemAcqStatus, e1t1StatEntry=e1t1StatEntry, restartcpu=restartcpu, description=description, modemACMmodulationMax=modemACMmodulationMax, atpcTxPowerCorrection=atpcTxPowerCorrection, pointToPoint=pointToPoint, ethTXBackpresEvents=ethTXBackpresEvents, modemEthernetCapacity=modemEthernetCapacity, ethTXVlanTags=ethTXVlanTags, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemE1T1ChannelMask=modemE1T1ChannelMask, licenseUpdateStatus=licenseUpdateStatus, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, aTPCTable=aTPCTable, ipRadioCfg=ipRadioCfg, ipRadioStatEth=ipRadioStatEth, ethRXPauseFrames=ethRXPauseFrames, modemModulation=modemModulation, modemIndex=modemIndex, radioTxFrequency=radioTxFrequency, ethRXMulticasts=ethRXMulticasts, modemE1T1Channels=modemE1T1Channels, licenseMask=licenseMask)
