...
mibBuilder.exportSymbols("SAF-IPRADIO", vlanNumber=vlanNumber, vlanCfgStat=vlanCfgStat, modemAcqStatus=modemAcqStatus, radioRxFrequency=radioRxFrequency, modemACMethernetCapacity=modemACMethernetCapacity, ipRadioCfg=ipRadioCfg, modemACMengine=modemACMengine, vlanRowStatus=vlanRowStatus, radioRxLevel=radioRxLevel, ethRXByteCounterLow=ethRXByteCounterLow, aTPCEntry=aTPCEntry, description=description, vlanPortmap=vlanPortmap, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ipRadioStatEth=ipRadioStatEth, vlanPortType=vlanPortType, ethTXCRCErrors=ethTXCRCErrors, ethQOSTXFrames=ethQOSTXFrames, localIp=localIp, pointToPoint=pointToPoint, modemLastAcqError=modemLastAcqError, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemCountTime=modemCountTime, modemE1T1Channels=modemE1T1Channels, e1t1ChannelNr=e1t1ChannelNr, modemStandard=modemStandard, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemInternalAGCgain=modemInternalAGCgain, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethGFPFCSErrors=ethGFPFCSErrors, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioIndex=radioIndex, hostname=hostname, ethRXPauseFrames=ethRXPauseFrames, product=product, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXExcessiveDefers=ethTXExcessiveDefers, modemEthernetCapacity=modemEthernetCapacity, modemStatistics=modemStatistics, sysDateAndTime=sysDateAndTime, ethTXPauseFrames=ethTXPauseFrames, modemErroredSecondRatio=modemErroredSecondRatio, radioTxFrequency=radioTxFrequency, modemSymbolRateTx=modemSymbolRateTx, ethRXCodeErrors=ethRXCodeErrors, ethTXBroadcasts=ethTXBroadcasts, ipRadioStat=ipRadioStat, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemErroredSecond=modemErroredSecond, license=license, radioSide=radioSide, restartcpu=restartcpu, modemACMmodulationMin=modemACMmodulationMin, ethGFPCHECErrors=ethGFPCHECErrors, ethTXByteCounterLow=ethTXByteCounterLow, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXMulticasts=ethRXMulticasts, loopbacks=loopbacks, vlanTable=vlanTable, ethTXMaxCollisions=ethTXMaxCollisions, radioTxMute=radioTxMute, modemCarrierOffset=modemCarrierOffset, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioEntry=radioEntry, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXGiants=ethTXGiants, remoteIp=remoteIp, modemErroredBlock=modemErroredBlock, localIpMask=localIpMask, modemSymbolRateRx=modemSymbolRateRx, modemBandwith=modemBandwith, ethRXDvEvent=ethRXDvEvent, vlanEntry=vlanEntry, e1t1StatTable=e1t1StatTable, ethRXPrevPktDropped=ethRXPrevPktDropped, modemIndex=modemIndex, licenseUpdateStatus=licenseUpdateStatus, modemTotalCapacity=modemTotalCapacity, modemUnavailtime=modemUnavailtime, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, e1t1AIS=e1t1AIS, ethRXTruncatedFrames=ethRXTruncatedFrames, loopback_tributary_mask=loopback_tributary_mask, ethTXControlFrames=ethTXControlFrames, ethTXBackpresEvents=ethTXBackpresEvents, ethQOSTXDropped=ethQOSTXDropped, modemGeneralStatus=modemGeneralStatus, ethTXMulticasts=ethTXMulticasts, modemUptime=modemUptime, safip=safip, saf=saf, ethRXDones=ethRXDones, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXCRCErrors=ethRXCRCErrors, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXByteCounterHi=ethTXByteCounterHi, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXUnderruns=ethTXUnderruns, modemTotalBlockNumber=modemTotalBlockNumber, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXVlanTags=ethTXVlanTags, modemModulation=modemModulation, e1t1StatEntry=e1t1StatEntry, ethTXLateCollisions=ethTXLateCollisions, radioLoopback=radioLoopback, radioDuplexShift=radioDuplexShift, ethTXCollisions=ethTXCollisions, radioTable=radioTable, atpcIndex=atpcIndex, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXDribleNibbles=ethRXDribleNibbles, vlansEnabled=vlansEnabled, writeConfig=writeConfig, modemACMmodulationMax=modemACMmodulationMax, ethTXDones=ethTXDones, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXByteCounterHi=ethRXByteCounterHi, aTPCTable=aTPCTable, ethRXBroadcasts=ethRXBroadcasts, sysTemperature=sysTemperature, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemTable=modemTable, tehnika=tehnika, modemRadialMSE=modemRadialMSE, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemEntry=modemEntry, ipRadio=ipRadio, radioGenStatus=radioGenStatus, ethRXControlFrames=ethRXControlFrames, ethGFPDropedFrames=ethGFPDropedFrames, atpcEnabled=atpcEnabled, microwaveRadio=microwaveRadio, ipRadioMgmt=ipRadioMgmt, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemRowStatus=modemRowStatus, e1t1LOS=e1t1LOS, licenseMask=licenseMask, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemACMtotalCapacity=modemACMtotalCapacity, radioTxPower=radioTxPower, ethRXLongEvents=ethRXLongEvents, vlanFid=vlanFid)
