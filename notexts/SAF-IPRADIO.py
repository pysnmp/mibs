...
mibBuilder.exportSymbols("SAF-IPRADIO", modemUptime=modemUptime, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXVlanTags=ethTXVlanTags, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXPrevPktDropped=ethRXPrevPktDropped, ethQOSTXFrames=ethQOSTXFrames, ethRXLongEvents=ethRXLongEvents, modemRadialMSE=modemRadialMSE, radioLoopback=radioLoopback, modemStatistics=modemStatistics, modemE1T1ChannelMask=modemE1T1ChannelMask, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemCarrierOffset=modemCarrierOffset, modemTable=modemTable, modemGeneralStatus=modemGeneralStatus, atpcTxPowerCorrection=atpcTxPowerCorrection, restartcpu=restartcpu, ethRXDones=ethRXDones, vlanRowStatus=vlanRowStatus, ethTXGiants=ethTXGiants, modemACMtotalCapacity=modemACMtotalCapacity, localIp=localIp, atpcEnabled=atpcEnabled, ethTXPauseFrames=ethTXPauseFrames, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXDones=ethTXDones, vlanFid=vlanFid, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemErroredSecondRatio=modemErroredSecondRatio, safip=safip, vlanTable=vlanTable, radioTxPower=radioTxPower, ethRXPauseFrames=ethRXPauseFrames, modemEntry=modemEntry, modemCountTime=modemCountTime, modemTotalBlockNumber=modemTotalBlockNumber, modemUnavailtime=modemUnavailtime, modemLastAcqError=modemLastAcqError, ethRXDribleNibbles=ethRXDribleNibbles, ethTXByteCounterLow=ethTXByteCounterLow, licenseMask=licenseMask, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioGenStatus=radioGenStatus, modemErroredBlock=modemErroredBlock, modemACMmodulationMin=modemACMmodulationMin, aTPCTable=aTPCTable, modemLDPCdecoderStress=modemLDPCdecoderStress, radioRxFrequency=radioRxFrequency, modemStandard=modemStandard, ethTXControlFrames=ethTXControlFrames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, loopbacks=loopbacks, ethGFPCHECErrors=ethGFPCHECErrors, product=product, remoteIp=remoteIp, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXBackpresEvents=ethTXBackpresEvents, ethTXLateCollisions=ethTXLateCollisions, e1t1StatTable=e1t1StatTable, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXControlFrames=ethRXControlFrames, modemInternalAGCgain=modemInternalAGCgain, atpcIndex=atpcIndex, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, saf=saf, ethTXUnderruns=ethTXUnderruns, ipRadioMgmt=ipRadioMgmt, vlanPortType=vlanPortType, ipRadioStatEth=ipRadioStatEth, modemSymbolRateTx=modemSymbolRateTx, modemE1T1Channels=modemE1T1Channels, pointToPoint=pointToPoint, localIpMask=localIpMask, license=license, ethTXBroadcasts=ethTXBroadcasts, radioDuplexShift=radioDuplexShift, vlanNumber=vlanNumber, ipRadio=ipRadio, ethTXCRCErrors=ethTXCRCErrors, vlansEnabled=vlansEnabled, radioTxMute=radioTxMute, radioIndex=radioIndex, sysTemperature=sysTemperature, vlanEntry=vlanEntry, ipRadioCfgNetwork=ipRadioCfgNetwork, e1t1ChannelNr=e1t1ChannelNr, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemAcqStatus=modemAcqStatus, tehnika=tehnika, ethQOSTXDropped=ethQOSTXDropped, radioRxLevel=radioRxLevel, sysDateAndTime=sysDateAndTime, e1t1LOS=e1t1LOS, modemIndex=modemIndex, ethRXBroadcasts=ethRXBroadcasts, writeConfig=writeConfig, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemSymbolRateRx=modemSymbolRateRx, ethRXCodeErrors=ethRXCodeErrors, ethTXExcessiveDefers=ethTXExcessiveDefers, radioTable=radioTable, ethTXMaxCollisions=ethTXMaxCollisions, ethRXCRCErrors=ethRXCRCErrors, ethRXMulticasts=ethRXMulticasts, description=description, modemTotalCapacity=modemTotalCapacity, modemACMmodulationMax=modemACMmodulationMax, hostname=hostname, modemRowStatus=modemRowStatus, ethRXByteCounterHi=ethRXByteCounterHi, ethRXDvEvent=ethRXDvEvent, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemBandwith=modemBandwith, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXUnsupOpcodes=ethRXUnsupOpcodes, vlanPortmap=vlanPortmap, radioTxFrequency=radioTxFrequency, ipRadioCfg=ipRadioCfg, ethGFPFCSErrors=ethGFPFCSErrors, licenseUpdateStatus=licenseUpdateStatus, modemACMethernetCapacity=modemACMethernetCapacity, ethRXByteCounterLow=ethRXByteCounterLow, ethTXByteCounterHi=ethTXByteCounterHi, vlanCfgStat=vlanCfgStat, microwaveRadio=microwaveRadio, ipRadioStat=ipRadioStat, e1t1AIS=e1t1AIS, radioEntry=radioEntry, modemEthernetCapacity=modemEthernetCapacity, e1t1StatEntry=e1t1StatEntry, modemACMengine=modemACMengine, modemModulation=modemModulation, modemErroredSecond=modemErroredSecond, loopback_tributary_mask=loopback_tributary_mask, ethTXCollisions=ethTXCollisions, ethGFPDropedFrames=ethGFPDropedFrames, aTPCEntry=aTPCEntry, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXMulticasts=ethTXMulticasts, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioSide=radioSide)
