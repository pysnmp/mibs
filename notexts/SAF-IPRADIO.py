...
mibBuilder.exportSymbols("SAF-IPRADIO", modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXByteCounterHi=ethTXByteCounterHi, description=description, atpcIndex=atpcIndex, modemACMmodulationMin=modemACMmodulationMin, ethRXVlanTagsDetected=ethRXVlanTagsDetected, sysTemperature=sysTemperature, ethTXPauseFrames=ethTXPauseFrames, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXTruncatedFrames=ethRXTruncatedFrames, licenseUpdateStatus=licenseUpdateStatus, writeConfig=writeConfig, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioDuplexShift=radioDuplexShift, ethRXControlFrames=ethRXControlFrames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemStandard=modemStandard, hostname=hostname, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXUnderruns=ethTXUnderruns, ethGFPDelineationErrors=ethGFPDelineationErrors, e1t1AIS=e1t1AIS, modemACMtotalCapacity=modemACMtotalCapacity, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioEntry=radioEntry, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemTable=modemTable, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemErroredSecond=modemErroredSecond, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, safip=safip, vlanTable=vlanTable, ipRadioCfg=ipRadioCfg, modemGeneralStatus=modemGeneralStatus, e1t1ChannelNr=e1t1ChannelNr, modemInternalAGCgain=modemInternalAGCgain, modemCountTime=modemCountTime, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemUnavailtime=modemUnavailtime, ipRadioStat=ipRadioStat, ethRXByteCounterHi=ethRXByteCounterHi, ipRadioCfgNetwork=ipRadioCfgNetwork, modemEthernetCapacity=modemEthernetCapacity, ethRXDones=ethRXDones, license=license, restartcpu=restartcpu, ethTXCollisions=ethTXCollisions, product=product, modemTotalCapacity=modemTotalCapacity, ethTXMaxCollisions=ethTXMaxCollisions, modemSymbolRateRx=modemSymbolRateRx, vlanNumber=vlanNumber, vlanPortType=vlanPortType, radioRxLevel=radioRxLevel, ethQOSTXFrames=ethQOSTXFrames, remoteIp=remoteIp, modemSymbolRateTx=modemSymbolRateTx, modemModulation=modemModulation, modemIndex=modemIndex, ethTXControlFrames=ethTXControlFrames, modemE1T1Channels=modemE1T1Channels, vlanFid=vlanFid, microwaveRadio=microwaveRadio, e1t1StatTable=e1t1StatTable, ethRXCRCErrors=ethRXCRCErrors, modemCarrierOffset=modemCarrierOffset, ethTXBackpresEvents=ethTXBackpresEvents, aTPCTable=aTPCTable, ethTXMulticasts=ethTXMulticasts, ethRXMulticasts=ethRXMulticasts, modemACMmodulationMax=modemACMmodulationMax, ethRXCodeErrors=ethRXCodeErrors, ethGFPDropedFrames=ethGFPDropedFrames, ethTXBroadcasts=ethTXBroadcasts, localIpMask=localIpMask, atpcTxPowerCorrection=atpcTxPowerCorrection, vlanRowStatus=vlanRowStatus, modemStatistics=modemStatistics, ethTXLateCollisions=ethTXLateCollisions, e1t1LOS=e1t1LOS, modemACMengine=modemACMengine, aTPCEntry=aTPCEntry, ethTXCRCErrors=ethTXCRCErrors, loopbacks=loopbacks, modemACMethernetCapacity=modemACMethernetCapacity, modemErroredSecondRatio=modemErroredSecondRatio, atpcEnabled=atpcEnabled, ipRadioStatEth=ipRadioStatEth, ipRadioMgmt=ipRadioMgmt, vlanEntry=vlanEntry, vlanPortmap=vlanPortmap, modemUptime=modemUptime, ethRXBroadcasts=ethRXBroadcasts, saf=saf, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioSide=radioSide, modemAcqStatus=modemAcqStatus, vlansEnabled=vlansEnabled, radioTable=radioTable, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioIndex=radioIndex, modemEntry=modemEntry, modemBackgroundBlockErrror=modemBackgroundBlockErrror, e1t1StatEntry=e1t1StatEntry, ethTXByteCounterLow=ethTXByteCounterLow, ethRXLongEvents=ethRXLongEvents, ipRadio=ipRadio, tehnika=tehnika, modemBandwith=modemBandwith, ethRXDribleNibbles=ethRXDribleNibbles, localIp=localIp, modemRowStatus=modemRowStatus, ethGFPFCSErrors=ethGFPFCSErrors, ethGFPCHECErrors=ethGFPCHECErrors, ethQOSTXDropped=ethQOSTXDropped, modemLastAcqError=modemLastAcqError, modemE1T1ChannelMask=modemE1T1ChannelMask, vlanCfgStat=vlanCfgStat, ipRadioCfgGeneral=ipRadioCfgGeneral, radioGenStatus=radioGenStatus, loopback_tributary_mask=loopback_tributary_mask, radioLoopback=radioLoopback, radioTxFrequency=radioTxFrequency, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXDones=ethTXDones, modemTotalBlockNumber=modemTotalBlockNumber, pointToPoint=pointToPoint, licenseMask=licenseMask, radioTxPower=radioTxPower, sysDateAndTime=sysDateAndTime, ethTXGiants=ethTXGiants, modemRadialMSE=modemRadialMSE, modemErroredBlock=modemErroredBlock, radioTxMute=radioTxMute, ethTXVlanTags=ethTXVlanTags, ethRXDvEvent=ethRXDvEvent, ethRXByteCounterLow=ethRXByteCounterLow, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXPauseFrames=ethRXPauseFrames, radioRxFrequency=radioRxFrequency)
