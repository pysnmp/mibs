...
mibBuilder.exportSymbols("SAF-IPRADIO", pointToPoint=pointToPoint, modemACMmodulationMax=modemACMmodulationMax, ethTXLateCollisions=ethTXLateCollisions, vlanRowStatus=vlanRowStatus, radioTable=radioTable, licenseUpdateStatus=licenseUpdateStatus, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ipRadioMgmt=ipRadioMgmt, modemEntry=modemEntry, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioTxFrequency=radioTxFrequency, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlansEnabled=vlansEnabled, product=product, ipRadioCfg=ipRadioCfg, sysTemperature=sysTemperature, modemBackgroundBlockErrror=modemBackgroundBlockErrror, e1t1StatTable=e1t1StatTable, ethRXVlanTagsDetected=ethRXVlanTagsDetected, localIpMask=localIpMask, ethTXDones=ethTXDones, modemSymbolRateTx=modemSymbolRateTx, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXByteCounterLow=ethRXByteCounterLow, modemRadialMSE=modemRadialMSE, ethRXCodeErrors=ethRXCodeErrors, ethTXBroadcasts=ethTXBroadcasts, ethTXByteCounterHi=ethTXByteCounterHi, radioEntry=radioEntry, ethTXUnderruns=ethTXUnderruns, safip=safip, ethQOSTXDropped=ethQOSTXDropped, modemStandard=modemStandard, description=description, ethRXByteCounterHi=ethRXByteCounterHi, modemIndex=modemIndex, e1t1AIS=e1t1AIS, modemTotalBlockNumber=modemTotalBlockNumber, tehnika=tehnika, modemRowStatus=modemRowStatus, modemE1T1ChannelMask=modemE1T1ChannelMask, modemACMtotalCapacity=modemACMtotalCapacity, vlanEntry=vlanEntry, ethTXCollisions=ethTXCollisions, vlanPortmap=vlanPortmap, ethRXPauseFrames=ethRXPauseFrames, modemSymbolRateRx=modemSymbolRateRx, radioIndex=radioIndex, writeConfig=writeConfig, radioDuplexShift=radioDuplexShift, modemUptime=modemUptime, modemAcqStatus=modemAcqStatus, ethTXVlanTags=ethTXVlanTags, ipRadio=ipRadio, atpcEnabled=atpcEnabled, atpcTxPowerCorrection=atpcTxPowerCorrection, modemStatistics=modemStatistics, radioSide=radioSide, vlanNumber=vlanNumber, modemACMethernetCapacity=modemACMethernetCapacity, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXControlFrames=ethTXControlFrames, vlanPortType=vlanPortType, restartcpu=restartcpu, modemGeneralStatus=modemGeneralStatus, modemBandwith=modemBandwith, ethTXCRCErrors=ethTXCRCErrors, hostname=hostname, modemModulation=modemModulation, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, e1t1LOS=e1t1LOS, remoteIp=remoteIp, ethTXExcessiveDefers=ethTXExcessiveDefers, modemACMengine=modemACMengine, ethRXDribleNibbles=ethRXDribleNibbles, ethRXBroadcasts=ethRXBroadcasts, ipRadioStatEth=ipRadioStatEth, aTPCTable=aTPCTable, radioTxMute=radioTxMute, aTPCEntry=aTPCEntry, ipRadioCfgNetwork=ipRadioCfgNetwork, modemEthernetCapacity=modemEthernetCapacity, ethRXDones=ethRXDones, modemTable=modemTable, ethTXGiants=ethTXGiants, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethGFPFCSErrors=ethGFPFCSErrors, modemErroredSecond=modemErroredSecond, ethGFPDropedFrames=ethGFPDropedFrames, modemErroredSecondRatio=modemErroredSecondRatio, ethRXLongEvents=ethRXLongEvents, loopback_tributary_mask=loopback_tributary_mask, ethRXCRCErrors=ethRXCRCErrors, radioRxLevel=radioRxLevel, ethTXPauseFrames=ethTXPauseFrames, localIp=localIp, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXWireByteCounterHi=ethTXWireByteCounterHi, saf=saf, vlanTable=vlanTable, ethTXByteCounterLow=ethTXByteCounterLow, modemCountTime=modemCountTime, ipRadioStat=ipRadioStat, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, sysDateAndTime=sysDateAndTime, vlanFid=vlanFid, ethRXMulticasts=ethRXMulticasts, e1t1ChannelNr=e1t1ChannelNr, loopbacks=loopbacks, ethGFPCHECErrors=ethGFPCHECErrors, modemLDPCdecoderStress=modemLDPCdecoderStress, modemACMmodulationMin=modemACMmodulationMin, ethTXMaxCollisions=ethTXMaxCollisions, modemTotalCapacity=modemTotalCapacity, ethQOSTXFrames=ethQOSTXFrames, e1t1StatEntry=e1t1StatEntry, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXMulticasts=ethTXMulticasts, modemErroredBlock=modemErroredBlock, radioGenStatus=radioGenStatus, modemE1T1Channels=modemE1T1Channels, microwaveRadio=microwaveRadio, ethRXControlFrames=ethRXControlFrames, modemUnavailtime=modemUnavailtime, atpcIndex=atpcIndex, radioRxFrequency=radioRxFrequency, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXBackpresEvents=ethTXBackpresEvents, modemLastAcqError=modemLastAcqError, licenseMask=licenseMask, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemInternalAGCgain=modemInternalAGCgain, ethRXDvEvent=ethRXDvEvent, license=license, radioLoopback=radioLoopback, modemCarrierOffset=modemCarrierOffset, vlanCfgStat=vlanCfgStat, ethGFPDelineationErrors=ethGFPDelineationErrors, radioTxPower=radioTxPower, ipRadioCfgGeneral=ipRadioCfgGeneral)
