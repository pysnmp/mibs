...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXDones=ethRXDones, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioIndex=radioIndex, vlanEntry=vlanEntry, ethRXDribleNibbles=ethRXDribleNibbles, license=license, writeConfig=writeConfig, ethRXPrevPktDropped=ethRXPrevPktDropped, radioEntry=radioEntry, tehnika=tehnika, radioLoopback=radioLoopback, ethRXPauseFrames=ethRXPauseFrames, modemErroredSecondRatio=modemErroredSecondRatio, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXGiants=ethTXGiants, ethTXPauseFrames=ethTXPauseFrames, modemEthernetCapacity=modemEthernetCapacity, saf=saf, modemModulation=modemModulation, ethTXDones=ethTXDones, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, sysTemperature=sysTemperature, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXByteCounterLow=ethRXByteCounterLow, ethRXLongEvents=ethRXLongEvents, vlanTable=vlanTable, ethTXCRCErrors=ethTXCRCErrors, modemACMmodulationMin=modemACMmodulationMin, ethTXLengthCheckErrors=ethTXLengthCheckErrors, vlanRowStatus=vlanRowStatus, remoteIp=remoteIp, atpcIndex=atpcIndex, localIpMask=localIpMask, licenseUpdateStatus=licenseUpdateStatus, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemUptime=modemUptime, ethRXTruncatedFrames=ethRXTruncatedFrames, vlanFid=vlanFid, ethTXCollisions=ethTXCollisions, safip=safip, licenseMask=licenseMask, hostname=hostname, ethRXCodeErrors=ethRXCodeErrors, radioDuplexShift=radioDuplexShift, loopback_tributary_mask=loopback_tributary_mask, modemACMtotalCapacity=modemACMtotalCapacity, restartcpu=restartcpu, modemAcqStatus=modemAcqStatus, ethTXBroadcasts=ethTXBroadcasts, atpcEnabled=atpcEnabled, e1t1StatEntry=e1t1StatEntry, e1t1LOS=e1t1LOS, localIp=localIp, vlanPortmap=vlanPortmap, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlanNumber=vlanNumber, ethRXControlFrames=ethRXControlFrames, vlanPortType=vlanPortType, ethRXDvEvent=ethRXDvEvent, ipRadioMgmt=ipRadioMgmt, ethTXMulticasts=ethTXMulticasts, ethTXBackpresEvents=ethTXBackpresEvents, product=product, description=description, modemRowStatus=modemRowStatus, ipRadioStat=ipRadioStat, modemCarrierOffset=modemCarrierOffset, modemCountTime=modemCountTime, modemTable=modemTable, modemE1T1Channels=modemE1T1Channels, vlanCfgStat=vlanCfgStat, ethTXLateCollisions=ethTXLateCollisions, e1t1AIS=e1t1AIS, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, aTPCTable=aTPCTable, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXMulticasts=ethRXMulticasts, e1t1ChannelNr=e1t1ChannelNr, radioTxMute=radioTxMute, modemInternalAGCgain=modemInternalAGCgain, modemACMengine=modemACMengine, e1t1StatTable=e1t1StatTable, sysDateAndTime=sysDateAndTime, loopbacks=loopbacks, modemErroredSecond=modemErroredSecond, ethRXBroadcasts=ethRXBroadcasts, ethGFPDelineationErrors=ethGFPDelineationErrors, pointToPoint=pointToPoint, modemBandwith=modemBandwith, radioSide=radioSide, radioRxFrequency=radioRxFrequency, ethTXControlFrames=ethTXControlFrames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXVlanTags=ethTXVlanTags, ipRadioCfg=ipRadioCfg, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemLDPCdecoderStress=modemLDPCdecoderStress, modemLastAcqError=modemLastAcqError, ethTXByteCounterHi=ethTXByteCounterHi, ethTXUnderruns=ethTXUnderruns, modemGeneralStatus=modemGeneralStatus, modemTotalBlockNumber=modemTotalBlockNumber, radioTxPower=radioTxPower, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadio=ipRadio, ipRadioStatEth=ipRadioStatEth, modemEntry=modemEntry, modemRadialMSE=modemRadialMSE, modemTotalCapacity=modemTotalCapacity, ethRXUnsupOpcodes=ethRXUnsupOpcodes, aTPCEntry=aTPCEntry, ethTXMaxCollisions=ethTXMaxCollisions, modemACMmodulationMax=modemACMmodulationMax, modemStandard=modemStandard, ipRadioCfgNetwork=ipRadioCfgNetwork, radioTable=radioTable, ethQOSTXFrames=ethQOSTXFrames, ethQOSTXDropped=ethQOSTXDropped, radioTxFrequency=radioTxFrequency, modemIndex=modemIndex, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXByteCounterHi=ethRXByteCounterHi, ethGFPFCSErrors=ethGFPFCSErrors, modemUnavailtime=modemUnavailtime, modemSymbolRateTx=modemSymbolRateTx, ethGFPCHECErrors=ethGFPCHECErrors, modemStatistics=modemStatistics, modemE1T1ChannelMask=modemE1T1ChannelMask, ethGFPDropedFrames=ethGFPDropedFrames, microwaveRadio=microwaveRadio, modemACMethernetCapacity=modemACMethernetCapacity, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemErroredBlock=modemErroredBlock, ipRadioCfgGeneral=ipRadioCfgGeneral, vlansEnabled=vlansEnabled, ethRXCRCErrors=ethRXCRCErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioGenStatus=radioGenStatus, modemSymbolRateRx=modemSymbolRateRx, radioRxLevel=radioRxLevel, ethTXByteCounterLow=ethTXByteCounterLow)
