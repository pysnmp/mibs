...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXDvEvent=ethRXDvEvent, sysTemperature=sysTemperature, ipRadioCfgGeneral=ipRadioCfgGeneral, vlanTable=vlanTable, modemLastAcqError=modemLastAcqError, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemCarrierOffset=modemCarrierOffset, modemSymbolRateRx=modemSymbolRateRx, sysDateAndTime=sysDateAndTime, product=product, loopbacks=loopbacks, localIpMask=localIpMask, ethTXCRCErrors=ethTXCRCErrors, modemACMmodulationMin=modemACMmodulationMin, safip=safip, radioGenStatus=radioGenStatus, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemTotalBlockNumber=modemTotalBlockNumber, ethRXByteCounterLow=ethRXByteCounterLow, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ipRadioStat=ipRadioStat, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXByteCounterHi=ethRXByteCounterHi, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, license=license, modemEthernetCapacity=modemEthernetCapacity, modemACMtotalCapacity=modemACMtotalCapacity, ethTXDones=ethTXDones, radioRxLevel=radioRxLevel, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemE1T1ChannelMask=modemE1T1ChannelMask, modemErroredBlock=modemErroredBlock, ipRadioStatEth=ipRadioStatEth, vlanEntry=vlanEntry, ethTXBroadcasts=ethTXBroadcasts, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ipRadioCfg=ipRadioCfg, ethTXPauseFrames=ethTXPauseFrames, ethRXPauseFrames=ethRXPauseFrames, ethRXBroadcasts=ethRXBroadcasts, modemInternalAGCgain=modemInternalAGCgain, modemBackgroundBlockErrror=modemBackgroundBlockErrror, localIp=localIp, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemE1T1Channels=modemE1T1Channels, ethRXDribleNibbles=ethRXDribleNibbles, modemACMethernetCapacity=modemACMethernetCapacity, modemUptime=modemUptime, ethRXLongEvents=ethRXLongEvents, modemRowStatus=modemRowStatus, e1t1AIS=e1t1AIS, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXLateCollisions=ethTXLateCollisions, modemUnavailtime=modemUnavailtime, modemAcqStatus=modemAcqStatus, ethTXUnderruns=ethTXUnderruns, ethTXCollisions=ethTXCollisions, ipRadio=ipRadio, e1t1LOS=e1t1LOS, modemErroredSecondRatio=modemErroredSecondRatio, pointToPoint=pointToPoint, modemSymbolRateTx=modemSymbolRateTx, modemCountTime=modemCountTime, modemTotalCapacity=modemTotalCapacity, radioRxFrequency=radioRxFrequency, radioTxPower=radioTxPower, description=description, writeConfig=writeConfig, vlanCfgStat=vlanCfgStat, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXGiants=ethTXGiants, ethTXMulticasts=ethTXMulticasts, ethGFPDelineationErrors=ethGFPDelineationErrors, ethQOSTXDropped=ethQOSTXDropped, radioSide=radioSide, ethTXMaxCollisions=ethTXMaxCollisions, modemErroredSecond=modemErroredSecond, modemEntry=modemEntry, radioTable=radioTable, ethTXExcessiveDefers=ethTXExcessiveDefers, tehnika=tehnika, saf=saf, modemRadialMSE=modemRadialMSE, ethRXCodeErrors=ethRXCodeErrors, ethRXPrevPktDropped=ethRXPrevPktDropped, vlanPortmap=vlanPortmap, radioDuplexShift=radioDuplexShift, vlanRowStatus=vlanRowStatus, ethGFPFCSErrors=ethGFPFCSErrors, atpcEnabled=atpcEnabled, modemBandwith=modemBandwith, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemIndex=modemIndex, vlanPortType=vlanPortType, radioEntry=radioEntry, ethRXMulticasts=ethRXMulticasts, hostname=hostname, licenseUpdateStatus=licenseUpdateStatus, modemACMengine=modemACMengine, modemStatistics=modemStatistics, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, microwaveRadio=microwaveRadio, ethQOSTXFrames=ethQOSTXFrames, remoteIp=remoteIp, modemGeneralStatus=modemGeneralStatus, ethGFPDropedFrames=ethGFPDropedFrames, atpcIndex=atpcIndex, e1t1ChannelNr=e1t1ChannelNr, vlanNumber=vlanNumber, vlansEnabled=vlansEnabled, modemTable=modemTable, ethTXVlanTags=ethTXVlanTags, modemACMmodulationMax=modemACMmodulationMax, radioTxMute=radioTxMute, ethRXControlFrames=ethRXControlFrames, radioLoopback=radioLoopback, ethGFPCHECErrors=ethGFPCHECErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXDones=ethRXDones, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioTxFrequency=radioTxFrequency, loopback_tributary_mask=loopback_tributary_mask, aTPCTable=aTPCTable, modemModulation=modemModulation, ipRadioMgmt=ipRadioMgmt, ethTXBackpresEvents=ethTXBackpresEvents, ethTXByteCounterHi=ethTXByteCounterHi, radioIndex=radioIndex, e1t1StatTable=e1t1StatTable, vlanFid=vlanFid, ethTXByteCounterLow=ethTXByteCounterLow, aTPCEntry=aTPCEntry, ethTXControlFrames=ethTXControlFrames, ethRXCRCErrors=ethRXCRCErrors, restartcpu=restartcpu, e1t1StatEntry=e1t1StatEntry, ipRadioCfgNetwork=ipRadioCfgNetwork, modemLDPCdecoderStress=modemLDPCdecoderStress, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, licenseMask=licenseMask, modemStandard=modemStandard)
