...
mibBuilder.exportSymbols("SAF-IPRADIO", modemRowStatus=modemRowStatus, remoteIp=remoteIp, modemErroredSecondRatio=modemErroredSecondRatio, modemIndex=modemIndex, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethGFPDropedFrames=ethGFPDropedFrames, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemUptime=modemUptime, vlanPortmap=vlanPortmap, tehnika=tehnika, ethRXVlanTagsDetected=ethRXVlanTagsDetected, e1t1LOS=e1t1LOS, modemCountTime=modemCountTime, ethRXTruncatedFrames=ethRXTruncatedFrames, modemACMmodulationMax=modemACMmodulationMax, vlansEnabled=vlansEnabled, radioTxMute=radioTxMute, ipRadioStatEth=ipRadioStatEth, ethTXCRCErrors=ethTXCRCErrors, vlanCfgStat=vlanCfgStat, radioLoopback=radioLoopback, ethRXDvEvent=ethRXDvEvent, ethRXUnsupOpcodes=ethRXUnsupOpcodes, aTPCTable=aTPCTable, ethTXUnderruns=ethTXUnderruns, ethQOSTXFrames=ethQOSTXFrames, ipRadioStat=ipRadioStat, radioIndex=radioIndex, aTPCEntry=aTPCEntry, ethTXCollisions=ethTXCollisions, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, e1t1AIS=e1t1AIS, licenseMask=licenseMask, radioDuplexShift=radioDuplexShift, modemCarrierOffset=modemCarrierOffset, ethTXPauseFrames=ethTXPauseFrames, e1t1StatTable=e1t1StatTable, ethRXMulticasts=ethRXMulticasts, modemACMtotalCapacity=modemACMtotalCapacity, ethTXByteCounterHi=ethTXByteCounterHi, modemEntry=modemEntry, ethRXDones=ethRXDones, radioTable=radioTable, modemE1T1Channels=modemE1T1Channels, atpcTxPowerCorrection=atpcTxPowerCorrection, restartcpu=restartcpu, sysTemperature=sysTemperature, modemRadialMSE=modemRadialMSE, pointToPoint=pointToPoint, hostname=hostname, ipRadioCfgGeneral=ipRadioCfgGeneral, modemE1T1ChannelMask=modemE1T1ChannelMask, modemACMethernetCapacity=modemACMethernetCapacity, ethRXCodeErrors=ethRXCodeErrors, vlanTable=vlanTable, vlanEntry=vlanEntry, modemInternalAGCgain=modemInternalAGCgain, radioEntry=radioEntry, modemACMmodulationMin=modemACMmodulationMin, modemErroredBlock=modemErroredBlock, ethTXMulticasts=ethTXMulticasts, licenseUpdateStatus=licenseUpdateStatus, ethTXByteCounterLow=ethTXByteCounterLow, vlanNumber=vlanNumber, writeConfig=writeConfig, modemStandard=modemStandard, modemEthernetCapacity=modemEthernetCapacity, loopbacks=loopbacks, modemSymbolRateTx=modemSymbolRateTx, ethTXVlanTags=ethTXVlanTags, modemAcqStatus=modemAcqStatus, modemSymbolRateRx=modemSymbolRateRx, ethTXLateCollisions=ethTXLateCollisions, modemModulation=modemModulation, ethGFPFCSErrors=ethGFPFCSErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXDribleNibbles=ethRXDribleNibbles, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, e1t1StatEntry=e1t1StatEntry, radioTxFrequency=radioTxFrequency, ethRXPrevPktDropped=ethRXPrevPktDropped, e1t1ChannelNr=e1t1ChannelNr, radioSide=radioSide, modemLastAcqError=modemLastAcqError, ethGFPCHECErrors=ethGFPCHECErrors, radioGenStatus=radioGenStatus, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, microwaveRadio=microwaveRadio, ethRXPauseFrames=ethRXPauseFrames, radioRxFrequency=radioRxFrequency, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, atpcEnabled=atpcEnabled, localIp=localIp, modemGeneralStatus=modemGeneralStatus, radioTxPower=radioTxPower, ethRXByteCounterHi=ethRXByteCounterHi, ethRXBroadcasts=ethRXBroadcasts, ethTXControlFrames=ethTXControlFrames, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXWireByteCounterHi=ethTXWireByteCounterHi, vlanFid=vlanFid, modemACMengine=modemACMengine, ipRadioCfg=ipRadioCfg, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemUnavailtime=modemUnavailtime, ethRXControlFrames=ethRXControlFrames, modemErroredSecond=modemErroredSecond, modemTable=modemTable, saf=saf, ethTXMaxCollisions=ethTXMaxCollisions, product=product, ethRXLongEvents=ethRXLongEvents, modemTotalCapacity=modemTotalCapacity, description=description, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadio=ipRadio, ethTXGiants=ethTXGiants, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemTotalBlockNumber=modemTotalBlockNumber, ethTXBroadcasts=ethTXBroadcasts, license=license, ethTXBackpresEvents=ethTXBackpresEvents, vlanRowStatus=vlanRowStatus, ethRXCRCErrors=ethRXCRCErrors, vlanPortType=vlanPortType, ipRadioMgmt=ipRadioMgmt, modemBandwith=modemBandwith, safip=safip, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, localIpMask=localIpMask, loopback_tributary_mask=loopback_tributary_mask, atpcIndex=atpcIndex, sysDateAndTime=sysDateAndTime, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXByteCounterLow=ethRXByteCounterLow, ethTXDones=ethTXDones, ethQOSTXDropped=ethQOSTXDropped, radioRxLevel=radioRxLevel, modemStatistics=modemStatistics, ethTXLengthCheckErrors=ethTXLengthCheckErrors)
