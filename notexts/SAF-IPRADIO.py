...
mibBuilder.exportSymbols("SAF-IPRADIO", modemSymbolRateRx=modemSymbolRateRx, e1t1AIS=e1t1AIS, ethRXTruncatedFrames=ethRXTruncatedFrames, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXDones=ethRXDones, atpcTxPowerCorrection=atpcTxPowerCorrection, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemBandwith=modemBandwith, modemSeverelyErroredSecond=modemSeverelyErroredSecond, localIpMask=localIpMask, modemTotalCapacity=modemTotalCapacity, ethRXCodeErrors=ethRXCodeErrors, ethTXDones=ethTXDones, modemACMengine=modemACMengine, ipRadioStat=ipRadioStat, ethGFPDropedFrames=ethGFPDropedFrames, product=product, remoteIp=remoteIp, vlanTable=vlanTable, ethRXCRCErrors=ethRXCRCErrors, ethTXCollisions=ethTXCollisions, licenseUpdateStatus=licenseUpdateStatus, modemSymbolRateTx=modemSymbolRateTx, ethTXByteCounterLow=ethTXByteCounterLow, modemErroredBlock=modemErroredBlock, ethTXPauseFrames=ethTXPauseFrames, modemIndex=modemIndex, sysTemperature=sysTemperature, vlanNumber=vlanNumber, ethRXByteCounterLow=ethRXByteCounterLow, ethRXPrevPktDropped=ethRXPrevPktDropped, e1t1StatTable=e1t1StatTable, modemRowStatus=modemRowStatus, ethTXLateCollisions=ethTXLateCollisions, ethTXControlFrames=ethTXControlFrames, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemEthernetCapacity=modemEthernetCapacity, modemModulation=modemModulation, radioSide=radioSide, vlanPortType=vlanPortType, modemACMtotalCapacity=modemACMtotalCapacity, ethTXUnderruns=ethTXUnderruns, ethRXPauseFrames=ethRXPauseFrames, ethRXControlFrames=ethRXControlFrames, ethRXMulticasts=ethRXMulticasts, radioRxFrequency=radioRxFrequency, ethRXBroadcasts=ethRXBroadcasts, modemEntry=modemEntry, vlansEnabled=vlansEnabled, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXBackpresEvents=ethTXBackpresEvents, modemGeneralStatus=modemGeneralStatus, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioEntry=radioEntry, safip=safip, modemErroredSecond=modemErroredSecond, vlanFid=vlanFid, atpcIndex=atpcIndex, restartcpu=restartcpu, modemStandard=modemStandard, radioGenStatus=radioGenStatus, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemTotalBlockNumber=modemTotalBlockNumber, modemACMmodulationMax=modemACMmodulationMax, ethGFPFCSErrors=ethGFPFCSErrors, e1t1StatEntry=e1t1StatEntry, radioTable=radioTable, radioTxMute=radioTxMute, modemTable=modemTable, ethRXLongEvents=ethRXLongEvents, ethTXBroadcasts=ethTXBroadcasts, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioLoopback=radioLoopback, ethTXWireByteCounterHi=ethTXWireByteCounterHi, saf=saf, modemLastAcqError=modemLastAcqError, aTPCTable=aTPCTable, pointToPoint=pointToPoint, ipRadioCfgGeneral=ipRadioCfgGeneral, radioRxLevel=radioRxLevel, e1t1LOS=e1t1LOS, loopback_tributary_mask=loopback_tributary_mask, modemAcqStatus=modemAcqStatus, vlanPortmap=vlanPortmap, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXVlanTags=ethTXVlanTags, ethTXGiants=ethTXGiants, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioDuplexShift=radioDuplexShift, ipRadioStatEth=ipRadioStatEth, localIp=localIp, radioIndex=radioIndex, writeConfig=writeConfig, ethTXMulticasts=ethTXMulticasts, sysDateAndTime=sysDateAndTime, modemUnavailtime=modemUnavailtime, ipRadioMgmt=ipRadioMgmt, e1t1ChannelNr=e1t1ChannelNr, modemACMethernetCapacity=modemACMethernetCapacity, ethGFPDelineationErrors=ethGFPDelineationErrors, modemUptime=modemUptime, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemACMmodulationMin=modemACMmodulationMin, ethQOSTXDropped=ethQOSTXDropped, radioTxPower=radioTxPower, licenseMask=licenseMask, ethRXByteCounterHi=ethRXByteCounterHi, ethRXDvEvent=ethRXDvEvent, modemRadialMSE=modemRadialMSE, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, tehnika=tehnika, description=description, ethRXDribleNibbles=ethRXDribleNibbles, ethTXMaxCollisions=ethTXMaxCollisions, ethTXByteCounterHi=ethTXByteCounterHi, modemErroredSecondRatio=modemErroredSecondRatio, atpcEnabled=atpcEnabled, loopbacks=loopbacks, microwaveRadio=microwaveRadio, ethTXLengthCheckErrors=ethTXLengthCheckErrors, vlanCfgStat=vlanCfgStat, modemInternalAGCgain=modemInternalAGCgain, aTPCEntry=aTPCEntry, modemE1T1Channels=modemE1T1Channels, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethGFPCHECErrors=ethGFPCHECErrors, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXExcessiveDefers=ethTXExcessiveDefers, hostname=hostname, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethQOSTXFrames=ethQOSTXFrames, modemCarrierOffset=modemCarrierOffset, vlanRowStatus=vlanRowStatus, ethTXCRCErrors=ethTXCRCErrors, license=license, radioTxFrequency=radioTxFrequency, modemCountTime=modemCountTime, modemStatistics=modemStatistics, vlanEntry=vlanEntry, ipRadio=ipRadio, ipRadioCfg=ipRadioCfg)
