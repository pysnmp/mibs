...
mibBuilder.exportSymbols("SAF-IPRADIO", modemIndex=modemIndex, ethTXLateCollisions=ethTXLateCollisions, modemACMmodulationMax=modemACMmodulationMax, ipRadioStat=ipRadioStat, microwaveRadio=microwaveRadio, aTPCEntry=aTPCEntry, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXCRCErrors=ethRXCRCErrors, ethGFPDropedFrames=ethGFPDropedFrames, licenseMask=licenseMask, atpcIndex=atpcIndex, ethRXByteCounterLow=ethRXByteCounterLow, radioRxLevel=radioRxLevel, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethGFPDelineationErrors=ethGFPDelineationErrors, modemCarrierOffset=modemCarrierOffset, ipRadio=ipRadio, modemAcqStatus=modemAcqStatus, vlanTable=vlanTable, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemUptime=modemUptime, modemInternalAGCgain=modemInternalAGCgain, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXByteCounterHi=ethTXByteCounterHi, ethTXExcessiveDefers=ethTXExcessiveDefers, vlanPortType=vlanPortType, ethRXDvEvent=ethRXDvEvent, modemACMengine=modemACMengine, loopback_tributary_mask=loopback_tributary_mask, radioTxPower=radioTxPower, ethTXMulticasts=ethTXMulticasts, radioTxMute=radioTxMute, ethTXBroadcasts=ethTXBroadcasts, modemRadialMSE=modemRadialMSE, vlanNumber=vlanNumber, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ipRadioCfgGeneral=ipRadioCfgGeneral, ipRadioCfgNetwork=ipRadioCfgNetwork, ethGFPCHECErrors=ethGFPCHECErrors, modemTotalCapacity=modemTotalCapacity, ethRXDones=ethRXDones, aTPCTable=aTPCTable, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemTable=modemTable, sysDateAndTime=sysDateAndTime, loopbacks=loopbacks, modemLastAcqError=modemLastAcqError, ethRXMulticasts=ethRXMulticasts, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioTxFrequency=radioTxFrequency, modemACMethernetCapacity=modemACMethernetCapacity, modemE1T1ChannelMask=modemE1T1ChannelMask, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXDribleNibbles=ethRXDribleNibbles, pointToPoint=pointToPoint, radioSide=radioSide, description=description, modemUnavailtime=modemUnavailtime, ethTXGiants=ethTXGiants, ethRXTruncatedFrames=ethRXTruncatedFrames, vlanCfgStat=vlanCfgStat, ethTXWireByteCounterLow=ethTXWireByteCounterLow, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, e1t1AIS=e1t1AIS, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ipRadioStatEth=ipRadioStatEth, ethTXUnderruns=ethTXUnderruns, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, sysTemperature=sysTemperature, ethTXCollisions=ethTXCollisions, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemGeneralStatus=modemGeneralStatus, ethRXCodeErrors=ethRXCodeErrors, modemModulation=modemModulation, e1t1StatEntry=e1t1StatEntry, ethTXControlFrames=ethTXControlFrames, ethRXPauseFrames=ethRXPauseFrames, e1t1StatTable=e1t1StatTable, writeConfig=writeConfig, radioLoopback=radioLoopback, ethQOSTXFrames=ethQOSTXFrames, modemStatistics=modemStatistics, modemCountTime=modemCountTime, modemErroredSecondRatio=modemErroredSecondRatio, localIpMask=localIpMask, ethTXPauseFrames=ethTXPauseFrames, radioDuplexShift=radioDuplexShift, modemLDPCdecoderStress=modemLDPCdecoderStress, license=license, e1t1LOS=e1t1LOS, localIp=localIp, radioIndex=radioIndex, vlanFid=vlanFid, ethRXByteCounterHi=ethRXByteCounterHi, vlansEnabled=vlansEnabled, modemACMmodulationMin=modemACMmodulationMin, ethTXDones=ethTXDones, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemRowStatus=modemRowStatus, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemE1T1Channels=modemE1T1Channels, restartcpu=restartcpu, ethQOSTXDropped=ethQOSTXDropped, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemBandwith=modemBandwith, ethRXLongEvents=ethRXLongEvents, modemErroredBlock=modemErroredBlock, ethTXCRCErrors=ethTXCRCErrors, ipRadioMgmt=ipRadioMgmt, ipRadioCfg=ipRadioCfg, modemStandard=modemStandard, radioGenStatus=radioGenStatus, modemEntry=modemEntry, vlanEntry=vlanEntry, ethTXByteCounterLow=ethTXByteCounterLow, modemTotalBlockNumber=modemTotalBlockNumber, vlanPortmap=vlanPortmap, ethGFPFCSErrors=ethGFPFCSErrors, ethRXControlFrames=ethRXControlFrames, safip=safip, saf=saf, e1t1ChannelNr=e1t1ChannelNr, radioTable=radioTable, vlanRowStatus=vlanRowStatus, remoteIp=remoteIp, ethTXMaxCollisions=ethTXMaxCollisions, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, tehnika=tehnika, modemErroredSecond=modemErroredSecond, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, hostname=hostname, atpcEnabled=atpcEnabled, modemSymbolRateTx=modemSymbolRateTx, modemACMtotalCapacity=modemACMtotalCapacity, modemEthernetCapacity=modemEthernetCapacity, ethRXBroadcasts=ethRXBroadcasts, ethTXVlanTags=ethTXVlanTags, ethTXBackpresEvents=ethTXBackpresEvents, modemSymbolRateRx=modemSymbolRateRx, product=product, radioRxFrequency=radioRxFrequency, licenseUpdateStatus=licenseUpdateStatus, radioEntry=radioEntry)
