...
mibBuilder.exportSymbols("SAF-IPRADIO", tehnika=tehnika, ethQOSTXDropped=ethQOSTXDropped, modemACMengine=modemACMengine, vlansEnabled=vlansEnabled, loopback_tributary_mask=loopback_tributary_mask, radioIndex=radioIndex, modemIndex=modemIndex, ethRXByteCounterLow=ethRXByteCounterLow, ethRXControlFrames=ethRXControlFrames, ipRadio=ipRadio, ethTXBackpresEvents=ethTXBackpresEvents, loopbacks=loopbacks, modemStatistics=modemStatistics, sysDateAndTime=sysDateAndTime, modemEthernetCapacity=modemEthernetCapacity, e1t1LOS=e1t1LOS, radioTxPower=radioTxPower, modemTotalCapacity=modemTotalCapacity, vlanTable=vlanTable, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXDvEvent=ethRXDvEvent, aTPCEntry=aTPCEntry, modemACMethernetCapacity=modemACMethernetCapacity, ethTXMulticasts=ethTXMulticasts, modemRadialMSE=modemRadialMSE, ethRXCodeErrors=ethRXCodeErrors, ethTXByteCounterLow=ethTXByteCounterLow, description=description, ethTXBroadcasts=ethTXBroadcasts, ethTXByteCounterHi=ethTXByteCounterHi, ethGFPCHECErrors=ethGFPCHECErrors, ethRXBroadcasts=ethRXBroadcasts, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemModulation=modemModulation, product=product, remoteIp=remoteIp, ethGFPDelineationErrors=ethGFPDelineationErrors, modemACMmodulationMin=modemACMmodulationMin, ipRadioMgmt=ipRadioMgmt, radioEntry=radioEntry, modemEntry=modemEntry, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethQOSTXFrames=ethQOSTXFrames, ethTXCRCErrors=ethTXCRCErrors, radioSide=radioSide, modemLDPCdecoderStress=modemLDPCdecoderStress, modemInternalAGCgain=modemInternalAGCgain, modemUptime=modemUptime, hostname=hostname, ethGFPDropedFrames=ethGFPDropedFrames, modemE1T1Channels=modemE1T1Channels, vlanPortType=vlanPortType, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemStandard=modemStandard, ethRXMulticasts=ethRXMulticasts, modemSymbolRateTx=modemSymbolRateTx, ethRXPrevPktDropped=ethRXPrevPktDropped, atpcIndex=atpcIndex, modemGeneralStatus=modemGeneralStatus, ethRXLongEvents=ethRXLongEvents, vlanNumber=vlanNumber, e1t1StatEntry=e1t1StatEntry, restartcpu=restartcpu, ethRXDones=ethRXDones, saf=saf, aTPCTable=aTPCTable, vlanRowStatus=vlanRowStatus, ethRXCRCErrors=ethRXCRCErrors, licenseMask=licenseMask, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioTxMute=radioTxMute, ethTXMaxCollisions=ethTXMaxCollisions, modemCarrierOffset=modemCarrierOffset, pointToPoint=pointToPoint, radioRxLevel=radioRxLevel, vlanFid=vlanFid, licenseUpdateStatus=licenseUpdateStatus, modemAcqStatus=modemAcqStatus, ipRadioStatEth=ipRadioStatEth, ipRadioCfg=ipRadioCfg, ethTXControlFrames=ethTXControlFrames, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemErroredSecond=modemErroredSecond, license=license, localIpMask=localIpMask, modemLastAcqError=modemLastAcqError, ipRadioStat=ipRadioStat, ethRXDribleNibbles=ethRXDribleNibbles, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXLateCollisions=ethTXLateCollisions, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemTotalBlockNumber=modemTotalBlockNumber, atpcTxPowerCorrection=atpcTxPowerCorrection, modemACMtotalCapacity=modemACMtotalCapacity, vlanPortmap=vlanPortmap, vlanEntry=vlanEntry, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, writeConfig=writeConfig, radioRxFrequency=radioRxFrequency, modemACMmodulationMax=modemACMmodulationMax, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioTxFrequency=radioTxFrequency, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, e1t1ChannelNr=e1t1ChannelNr, modemE1T1ChannelMask=modemE1T1ChannelMask, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemErroredBlock=modemErroredBlock, sysTemperature=sysTemperature, microwaveRadio=microwaveRadio, radioTable=radioTable, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemTable=modemTable, atpcEnabled=atpcEnabled, modemSymbolRateRx=modemSymbolRateRx, modemErroredSecondRatio=modemErroredSecondRatio, ethTXCollisions=ethTXCollisions, vlanCfgStat=vlanCfgStat, ethTXDones=ethTXDones, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioGenStatus=radioGenStatus, radioDuplexShift=radioDuplexShift, modemRowStatus=modemRowStatus, ethTXUnderruns=ethTXUnderruns, ethTXLengthCheckErrors=ethTXLengthCheckErrors, e1t1AIS=e1t1AIS, ethGFPFCSErrors=ethGFPFCSErrors, e1t1StatTable=e1t1StatTable, ethTXPauseFrames=ethTXPauseFrames, modemCountTime=modemCountTime, ethRXPauseFrames=ethRXPauseFrames, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioLoopback=radioLoopback, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXByteCounterHi=ethRXByteCounterHi, modemBandwith=modemBandwith, ethTXVlanTags=ethTXVlanTags, ethTXWireByteCounterHi=ethTXWireByteCounterHi, safip=safip, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXGiants=ethTXGiants, localIp=localIp, ethRXTruncatedFrames=ethRXTruncatedFrames, modemUnavailtime=modemUnavailtime)
