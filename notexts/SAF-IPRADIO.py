...
mibBuilder.exportSymbols("SAF-IPRADIO", modemTotalBlockNumber=modemTotalBlockNumber, vlanRowStatus=vlanRowStatus, modemACMtotalCapacity=modemACMtotalCapacity, ipRadioStat=ipRadioStat, modemRowStatus=modemRowStatus, modemCountTime=modemCountTime, loopback_tributary_mask=loopback_tributary_mask, ethQOSRXQ2Frames=ethQOSRXQ2Frames, aTPCEntry=aTPCEntry, modemErroredBlock=modemErroredBlock, localIp=localIp, ethGFPDelineationErrors=ethGFPDelineationErrors, ethGFPFCSErrors=ethGFPFCSErrors, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, licenseMask=licenseMask, modemE1T1ChannelMask=modemE1T1ChannelMask, e1t1StatEntry=e1t1StatEntry, e1t1LOS=e1t1LOS, radioEntry=radioEntry, modemStatistics=modemStatistics, modemGeneralStatus=modemGeneralStatus, modemIndex=modemIndex, ethRXDribleNibbles=ethRXDribleNibbles, ethTXBackpresEvents=ethTXBackpresEvents, modemLDPCdecoderStress=modemLDPCdecoderStress, modemACMengine=modemACMengine, sysTemperature=sysTemperature, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlanPortmap=vlanPortmap, microwaveRadio=microwaveRadio, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemACMethernetCapacity=modemACMethernetCapacity, ethRXPauseFrames=ethRXPauseFrames, remoteIp=remoteIp, ethRXByteCounterHi=ethRXByteCounterHi, ethQOSTXDropped=ethQOSTXDropped, modemACMmodulationMin=modemACMmodulationMin, radioIndex=radioIndex, modemE1T1Channels=modemE1T1Channels, e1t1StatTable=e1t1StatTable, ipRadioCfg=ipRadioCfg, ethRXCodeErrors=ethRXCodeErrors, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, writeConfig=writeConfig, ethTXBroadcasts=ethTXBroadcasts, radioDuplexShift=radioDuplexShift, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXBroadcasts=ethRXBroadcasts, radioTxFrequency=radioTxFrequency, radioLoopback=radioLoopback, description=description, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemStandard=modemStandard, vlanEntry=vlanEntry, modemEthernetCapacity=modemEthernetCapacity, vlanNumber=vlanNumber, ethGFPCHECErrors=ethGFPCHECErrors, modemBandwith=modemBandwith, ethRXPrevPktDropped=ethRXPrevPktDropped, e1t1AIS=e1t1AIS, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, license=license, modemUptime=modemUptime, ethTXGiants=ethTXGiants, atpcEnabled=atpcEnabled, radioTable=radioTable, hostname=hostname, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXDones=ethRXDones, ethTXByteCounterLow=ethTXByteCounterLow, atpcTxPowerCorrection=atpcTxPowerCorrection, saf=saf, ipRadio=ipRadio, radioRxLevel=radioRxLevel, modemErroredSecondRatio=modemErroredSecondRatio, modemAcqStatus=modemAcqStatus, sysDateAndTime=sysDateAndTime, modemUnavailtime=modemUnavailtime, ethRXMulticasts=ethRXMulticasts, modemSymbolRateTx=modemSymbolRateTx, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, product=product, ethRXByteCounterLow=ethRXByteCounterLow, ethTXMulticasts=ethTXMulticasts, ethRXCRCErrors=ethRXCRCErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXLateCollisions=ethTXLateCollisions, ethTXMaxCollisions=ethTXMaxCollisions, modemInternalAGCgain=modemInternalAGCgain, modemSymbolRateRx=modemSymbolRateRx, ipRadioStatEth=ipRadioStatEth, ethRXControlFrames=ethRXControlFrames, radioRxFrequency=radioRxFrequency, modemTotalCapacity=modemTotalCapacity, ethTXExcessiveDefers=ethTXExcessiveDefers, localIpMask=localIpMask, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXControlFrames=ethTXControlFrames, modemACMmodulationMax=modemACMmodulationMax, modemBackgroundBlockErrror=modemBackgroundBlockErrror, tehnika=tehnika, radioSide=radioSide, modemCarrierOffset=modemCarrierOffset, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemLastAcqError=modemLastAcqError, radioTxPower=radioTxPower, ethTXCollisions=ethTXCollisions, modemRadialMSE=modemRadialMSE, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethQOSTXFrames=ethQOSTXFrames, modemModulation=modemModulation, vlanCfgStat=vlanCfgStat, modemTable=modemTable, ethTXLengthCheckErrors=ethTXLengthCheckErrors, safip=safip, vlansEnabled=vlansEnabled, vlanPortType=vlanPortType, ethTXByteCounterHi=ethTXByteCounterHi, atpcIndex=atpcIndex, restartcpu=restartcpu, ethRXLongEvents=ethRXLongEvents, modemErroredSecond=modemErroredSecond, e1t1ChannelNr=e1t1ChannelNr, radioGenStatus=radioGenStatus, ethRXDvEvent=ethRXDvEvent, vlanTable=vlanTable, aTPCTable=aTPCTable, ethTXDones=ethTXDones, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ipRadioMgmt=ipRadioMgmt, pointToPoint=pointToPoint, ethTXVlanTags=ethTXVlanTags, modemEntry=modemEntry, ethTXPauseFrames=ethTXPauseFrames, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXUnderruns=ethTXUnderruns, radioTxMute=radioTxMute, vlanFid=vlanFid, licenseUpdateStatus=licenseUpdateStatus, ethGFPDropedFrames=ethGFPDropedFrames, loopbacks=loopbacks, ethTXCRCErrors=ethTXCRCErrors)
