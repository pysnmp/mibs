...
mibBuilder.exportSymbols("SAF-IPRADIO", ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, loopback_tributary_mask=loopback_tributary_mask, ethTXControlFrames=ethTXControlFrames, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemACMtotalCapacity=modemACMtotalCapacity, ethTXPauseFrames=ethTXPauseFrames, modemErroredSecond=modemErroredSecond, ethRXByteCounterHi=ethRXByteCounterHi, ethGFPDropedFrames=ethGFPDropedFrames, radioLoopback=radioLoopback, radioTxFrequency=radioTxFrequency, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXByteCounterHi=ethTXByteCounterHi, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXByteCounterLow=ethTXByteCounterLow, modemAcqStatus=modemAcqStatus, vlanFid=vlanFid, modemEthernetCapacity=modemEthernetCapacity, vlanTable=vlanTable, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioTable=radioTable, modemSymbolRateTx=modemSymbolRateTx, ipRadio=ipRadio, restartcpu=restartcpu, ethTXMulticasts=ethTXMulticasts, atpcTxPowerCorrection=atpcTxPowerCorrection, modemStandard=modemStandard, modemTable=modemTable, radioEntry=radioEntry, description=description, modemE1T1Channels=modemE1T1Channels, hostname=hostname, modemRowStatus=modemRowStatus, modemStatistics=modemStatistics, radioGenStatus=radioGenStatus, ethTXLateCollisions=ethTXLateCollisions, ipRadioStat=ipRadioStat, ethRXMulticasts=ethRXMulticasts, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXExcessiveDefers=ethTXExcessiveDefers, localIpMask=localIpMask, ethTXBackpresEvents=ethTXBackpresEvents, modemInternalAGCgain=modemInternalAGCgain, modemE1T1ChannelMask=modemE1T1ChannelMask, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlanPortType=vlanPortType, localIp=localIp, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXBroadcasts=ethTXBroadcasts, modemACMengine=modemACMengine, safip=safip, saf=saf, modemGeneralStatus=modemGeneralStatus, ethTXLengthCheckErrors=ethTXLengthCheckErrors, license=license, vlanPortmap=vlanPortmap, ethRXCRCErrors=ethRXCRCErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemTotalBlockNumber=modemTotalBlockNumber, e1t1StatEntry=e1t1StatEntry, ipRadioCfgNetwork=ipRadioCfgNetwork, radioRxFrequency=radioRxFrequency, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemBandwith=modemBandwith, ethQOSTXDropped=ethQOSTXDropped, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXUnsupOpcodes=ethRXUnsupOpcodes, remoteIp=remoteIp, modemACMmodulationMax=modemACMmodulationMax, ethRXControlFrames=ethRXControlFrames, microwaveRadio=microwaveRadio, modemCarrierOffset=modemCarrierOffset, radioTxMute=radioTxMute, atpcEnabled=atpcEnabled, modemRadialMSE=modemRadialMSE, loopbacks=loopbacks, ethRXBroadcasts=ethRXBroadcasts, licenseMask=licenseMask, ethGFPCHECErrors=ethGFPCHECErrors, ipRadioCfgGeneral=ipRadioCfgGeneral, aTPCEntry=aTPCEntry, e1t1ChannelNr=e1t1ChannelNr, ethTXCRCErrors=ethTXCRCErrors, ethRXDones=ethRXDones, modemModulation=modemModulation, modemACMmodulationMin=modemACMmodulationMin, ethRXLongEvents=ethRXLongEvents, pointToPoint=pointToPoint, ipRadioMgmt=ipRadioMgmt, vlanEntry=vlanEntry, modemUptime=modemUptime, modemUnavailtime=modemUnavailtime, radioDuplexShift=radioDuplexShift, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXCodeErrors=ethRXCodeErrors, e1t1StatTable=e1t1StatTable, product=product, radioIndex=radioIndex, ethRXTruncatedFrames=ethRXTruncatedFrames, radioSide=radioSide, modemACMethernetCapacity=modemACMethernetCapacity, ethTXDones=ethTXDones, sysDateAndTime=sysDateAndTime, vlanCfgStat=vlanCfgStat, modemEntry=modemEntry, ethTXMaxCollisions=ethTXMaxCollisions, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXPauseFrames=ethRXPauseFrames, modemTotalCapacity=modemTotalCapacity, modemSymbolRateRx=modemSymbolRateRx, radioTxPower=radioTxPower, vlanNumber=vlanNumber, e1t1AIS=e1t1AIS, ethGFPFCSErrors=ethGFPFCSErrors, e1t1LOS=e1t1LOS, radioRxLevel=radioRxLevel, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXCollisions=ethTXCollisions, ethTXGiants=ethTXGiants, ethRXByteCounterLow=ethRXByteCounterLow, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, tehnika=tehnika, licenseUpdateStatus=licenseUpdateStatus, modemSeverelyErroredSecond=modemSeverelyErroredSecond, vlanRowStatus=vlanRowStatus, aTPCTable=aTPCTable, writeConfig=writeConfig, ipRadioCfg=ipRadioCfg, modemCountTime=modemCountTime, ipRadioStatEth=ipRadioStatEth, modemErroredSecondRatio=modemErroredSecondRatio, modemErroredBlock=modemErroredBlock, modemIndex=modemIndex, atpcIndex=atpcIndex, modemLastAcqError=modemLastAcqError, ethTXVlanTags=ethTXVlanTags, ethQOSTXFrames=ethQOSTXFrames, vlansEnabled=vlansEnabled, ethRXDvEvent=ethRXDvEvent, sysTemperature=sysTemperature, ethRXDribleNibbles=ethRXDribleNibbles, ethTXUnderruns=ethTXUnderruns)
