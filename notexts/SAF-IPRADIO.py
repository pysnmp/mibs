...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXMulticasts=ethTXMulticasts, ethRXTruncatedFrames=ethRXTruncatedFrames, modemEthernetCapacity=modemEthernetCapacity, ethTXCollisions=ethTXCollisions, vlanFid=vlanFid, ethGFPDropedFrames=ethGFPDropedFrames, description=description, licenseUpdateStatus=licenseUpdateStatus, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXBackpresEvents=ethTXBackpresEvents, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioRxLevel=radioRxLevel, ipRadioStat=ipRadioStat, sysDateAndTime=sysDateAndTime, modemSymbolRateTx=modemSymbolRateTx, modemACMethernetCapacity=modemACMethernetCapacity, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXDvEvent=ethRXDvEvent, pointToPoint=pointToPoint, ethRXLongEvents=ethRXLongEvents, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ipRadio=ipRadio, atpcIndex=atpcIndex, modemCarrierOffset=modemCarrierOffset, safip=safip, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXDones=ethTXDones, aTPCTable=aTPCTable, modemAcqStatus=modemAcqStatus, ethQOSTXDropped=ethQOSTXDropped, ethTXLateCollisions=ethTXLateCollisions, loopbacks=loopbacks, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, atpcEnabled=atpcEnabled, modemLDPCdecoderStress=modemLDPCdecoderStress, radioTxFrequency=radioTxFrequency, modemLastAcqError=modemLastAcqError, ethRXCRCErrors=ethRXCRCErrors, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemInternalAGCgain=modemInternalAGCgain, ethRXByteCounterLow=ethRXByteCounterLow, modemCountTime=modemCountTime, tehnika=tehnika, ethTXUnderruns=ethTXUnderruns, modemBandwith=modemBandwith, modemGeneralStatus=modemGeneralStatus, modemIndex=modemIndex, ethGFPDelineationErrors=ethGFPDelineationErrors, vlanNumber=vlanNumber, radioGenStatus=radioGenStatus, product=product, ethRXPauseFrames=ethRXPauseFrames, licenseMask=licenseMask, ipRadioStatEth=ipRadioStatEth, modemUptime=modemUptime, aTPCEntry=aTPCEntry, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, e1t1AIS=e1t1AIS, ipRadioCfg=ipRadioCfg, vlanPortmap=vlanPortmap, ethRXMulticasts=ethRXMulticasts, e1t1StatTable=e1t1StatTable, modemTable=modemTable, modemRowStatus=modemRowStatus, radioRxFrequency=radioRxFrequency, ethGFPFCSErrors=ethGFPFCSErrors, modemTotalCapacity=modemTotalCapacity, ethGFPCHECErrors=ethGFPCHECErrors, license=license, ipRadioMgmt=ipRadioMgmt, restartcpu=restartcpu, ethTXByteCounterHi=ethTXByteCounterHi, radioIndex=radioIndex, modemErroredBlock=modemErroredBlock, modemTotalBlockNumber=modemTotalBlockNumber, radioTable=radioTable, modemModulation=modemModulation, modemErroredSecond=modemErroredSecond, modemE1T1Channels=modemE1T1Channels, localIp=localIp, localIpMask=localIpMask, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemACMmodulationMax=modemACMmodulationMax, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXByteCounterHi=ethRXByteCounterHi, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXPauseFrames=ethTXPauseFrames, ethRXDribleNibbles=ethRXDribleNibbles, modemStatistics=modemStatistics, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXCRCErrors=ethTXCRCErrors, e1t1ChannelNr=e1t1ChannelNr, vlanEntry=vlanEntry, ethRXUnsupOpcodes=ethRXUnsupOpcodes, microwaveRadio=microwaveRadio, modemRadialMSE=modemRadialMSE, hostname=hostname, modemEntry=modemEntry, modemStandard=modemStandard, ethQOSTXFrames=ethQOSTXFrames, ethTXGiants=ethTXGiants, loopback_tributary_mask=loopback_tributary_mask, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemACMengine=modemACMengine, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXByteCounterLow=ethTXByteCounterLow, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXDones=ethRXDones, vlansEnabled=vlansEnabled, saf=saf, radioEntry=radioEntry, ipRadioCfgNetwork=ipRadioCfgNetwork, vlanRowStatus=vlanRowStatus, modemACMmodulationMin=modemACMmodulationMin, radioDuplexShift=radioDuplexShift, e1t1LOS=e1t1LOS, modemErroredSecondRatio=modemErroredSecondRatio, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXControlFrames=ethRXControlFrames, writeConfig=writeConfig, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, e1t1StatEntry=e1t1StatEntry, modemACMtotalCapacity=modemACMtotalCapacity, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXCodeErrors=ethRXCodeErrors, radioSide=radioSide, ethTXControlFrames=ethTXControlFrames, ethTXBroadcasts=ethTXBroadcasts, modemUnavailtime=modemUnavailtime, remoteIp=remoteIp, vlanPortType=vlanPortType, radioTxPower=radioTxPower, vlanTable=vlanTable, radioLoopback=radioLoopback, radioTxMute=radioTxMute, ethTXMaxCollisions=ethTXMaxCollisions, ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlanCfgStat=vlanCfgStat, sysTemperature=sysTemperature, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemSymbolRateRx=modemSymbolRateRx, ethTXVlanTags=ethTXVlanTags, ethRXBroadcasts=ethRXBroadcasts)
