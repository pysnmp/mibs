...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXMulticasts=ethRXMulticasts, modemLDPCdecoderStress=modemLDPCdecoderStress, aTPCTable=aTPCTable, modemACMethernetCapacity=modemACMethernetCapacity, sysTemperature=sysTemperature, modemEntry=modemEntry, modemStatistics=modemStatistics, radioRxFrequency=radioRxFrequency, restartcpu=restartcpu, ethTXBackpresEvents=ethTXBackpresEvents, e1t1ChannelNr=e1t1ChannelNr, modemCarrierOffset=modemCarrierOffset, ethGFPDropedFrames=ethGFPDropedFrames, ethTXExcessiveDefers=ethTXExcessiveDefers, vlanPortType=vlanPortType, vlanNumber=vlanNumber, saf=saf, ethTXLengthCheckErrors=ethTXLengthCheckErrors, description=description, sysDateAndTime=sysDateAndTime, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, localIp=localIp, e1t1StatTable=e1t1StatTable, vlanTable=vlanTable, atpcIndex=atpcIndex, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXByteCounterHi=ethRXByteCounterHi, modemLastAcqError=modemLastAcqError, ethTXDones=ethTXDones, e1t1AIS=e1t1AIS, modemUnavailtime=modemUnavailtime, ethQOSTXDropped=ethQOSTXDropped, ethQOSRXQ2Frames=ethQOSRXQ2Frames, product=product, modemErroredBlock=modemErroredBlock, ethRXLongEvents=ethRXLongEvents, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemEthernetCapacity=modemEthernetCapacity, licenseUpdateStatus=licenseUpdateStatus, vlanCfgStat=vlanCfgStat, vlanRowStatus=vlanRowStatus, ethRXControlFrames=ethRXControlFrames, modemUptime=modemUptime, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXLateCollisions=ethTXLateCollisions, modemTable=modemTable, ethTXCRCErrors=ethTXCRCErrors, ipRadio=ipRadio, radioRxLevel=radioRxLevel, radioEntry=radioEntry, ethTXMulticasts=ethTXMulticasts, modemIndex=modemIndex, ethTXControlFrames=ethTXControlFrames, ethRXDones=ethRXDones, modemSymbolRateTx=modemSymbolRateTx, radioTxFrequency=radioTxFrequency, modemACMengine=modemACMengine, vlanEntry=vlanEntry, ipRadioCfgNetwork=ipRadioCfgNetwork, modemGeneralStatus=modemGeneralStatus, ethRXCRCErrors=ethRXCRCErrors, e1t1LOS=e1t1LOS, writeConfig=writeConfig, modemRowStatus=modemRowStatus, ethRXTruncatedFrames=ethRXTruncatedFrames, loopbacks=loopbacks, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadioMgmt=ipRadioMgmt, localIpMask=localIpMask, remoteIp=remoteIp, ethRXPrevPktDropped=ethRXPrevPktDropped, vlansEnabled=vlansEnabled, vlanFid=vlanFid, safip=safip, licenseMask=licenseMask, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioSide=radioSide, radioTable=radioTable, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXBroadcasts=ethTXBroadcasts, ethQOSTXFrames=ethQOSTXFrames, modemACMmodulationMin=modemACMmodulationMin, tehnika=tehnika, ethRXDribleNibbles=ethRXDribleNibbles, radioTxMute=radioTxMute, modemACMmodulationMax=modemACMmodulationMax, modemInternalAGCgain=modemInternalAGCgain, radioDuplexShift=radioDuplexShift, modemE1T1Channels=modemE1T1Channels, modemStandard=modemStandard, ethRXByteCounterLow=ethRXByteCounterLow, ethGFPCHECErrors=ethGFPCHECErrors, ethTXGiants=ethTXGiants, loopback_tributary_mask=loopback_tributary_mask, modemAcqStatus=modemAcqStatus, vlanPortmap=vlanPortmap, modemErroredSecondRatio=modemErroredSecondRatio, ethTXMaxCollisions=ethTXMaxCollisions, ethTXByteCounterLow=ethTXByteCounterLow, ethRXBroadcasts=ethRXBroadcasts, modemModulation=modemModulation, e1t1StatEntry=e1t1StatEntry, atpcTxPowerCorrection=atpcTxPowerCorrection, modemACMtotalCapacity=modemACMtotalCapacity, radioGenStatus=radioGenStatus, ethRXCodeErrors=ethRXCodeErrors, ethTXUnderruns=ethTXUnderruns, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXCollisions=ethTXCollisions, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXUnsupOpcodes=ethRXUnsupOpcodes, microwaveRadio=microwaveRadio, ipRadioStatEth=ipRadioStatEth, radioLoopback=radioLoopback, ipRadioCfg=ipRadioCfg, radioTxPower=radioTxPower, radioIndex=radioIndex, modemE1T1ChannelMask=modemE1T1ChannelMask, pointToPoint=pointToPoint, modemBandwith=modemBandwith, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, hostname=hostname, ipRadioStat=ipRadioStat, modemCountTime=modemCountTime, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemTotalBlockNumber=modemTotalBlockNumber, aTPCEntry=aTPCEntry, ethGFPFCSErrors=ethGFPFCSErrors, ethTXByteCounterHi=ethTXByteCounterHi, atpcEnabled=atpcEnabled, ethTXVlanTags=ethTXVlanTags, modemSymbolRateRx=modemSymbolRateRx, license=license, modemErroredSecond=modemErroredSecond, modemTotalCapacity=modemTotalCapacity, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemRadialMSE=modemRadialMSE, ethRXDvEvent=ethRXDvEvent, ethTXPauseFrames=ethTXPauseFrames, ethRXPauseFrames=ethRXPauseFrames)
