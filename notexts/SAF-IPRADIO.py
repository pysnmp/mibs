...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXPauseFrames=ethRXPauseFrames, modemRowStatus=modemRowStatus, ethRXDones=ethRXDones, atpcEnabled=atpcEnabled, ethTXCRCErrors=ethTXCRCErrors, ethTXByteCounterLow=ethTXByteCounterLow, localIpMask=localIpMask, ethRXControlFrames=ethRXControlFrames, modemACMengine=modemACMengine, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioIndex=radioIndex, loopbacks=loopbacks, modemACMethernetCapacity=modemACMethernetCapacity, modemCountTime=modemCountTime, modemSeverelyErroredSecond=modemSeverelyErroredSecond, e1t1StatEntry=e1t1StatEntry, ethTXControlFrames=ethTXControlFrames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemUptime=modemUptime, loopback_tributary_mask=loopback_tributary_mask, modemACMmodulationMin=modemACMmodulationMin, modemStandard=modemStandard, vlanCfgStat=vlanCfgStat, saf=saf, description=description, tehnika=tehnika, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ipRadioCfg=ipRadioCfg, modemRadialMSE=modemRadialMSE, vlanNumber=vlanNumber, e1t1AIS=e1t1AIS, ethRXVlanTagsDetected=ethRXVlanTagsDetected, vlanEntry=vlanEntry, radioTxMute=radioTxMute, ethTXDones=ethTXDones, modemACMmodulationMax=modemACMmodulationMax, vlanTable=vlanTable, safip=safip, aTPCTable=aTPCTable, radioTable=radioTable, modemLastAcqError=modemLastAcqError, ethTXWireByteCounterHi=ethTXWireByteCounterHi, microwaveRadio=microwaveRadio, radioSide=radioSide, ethQOSTXFrames=ethQOSTXFrames, ipRadio=ipRadio, license=license, modemEntry=modemEntry, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, atpcTxPowerCorrection=atpcTxPowerCorrection, modemInternalAGCgain=modemInternalAGCgain, vlanRowStatus=vlanRowStatus, ethQOSRXQ1Frames=ethQOSRXQ1Frames, e1t1LOS=e1t1LOS, hostname=hostname, modemLDPCdecoderStress=modemLDPCdecoderStress, product=product, ethTXLateCollisions=ethTXLateCollisions, ethRXBroadcasts=ethRXBroadcasts, ethTXMulticasts=ethTXMulticasts, ethRXDvEvent=ethRXDvEvent, modemE1T1ChannelMask=modemE1T1ChannelMask, vlanFid=vlanFid, radioRxFrequency=radioRxFrequency, modemErroredBlock=modemErroredBlock, ipRadioMgmt=ipRadioMgmt, pointToPoint=pointToPoint, ethTXPauseFrames=ethTXPauseFrames, aTPCEntry=aTPCEntry, ethTXMaxCollisions=ethTXMaxCollisions, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemAcqStatus=modemAcqStatus, modemEthernetCapacity=modemEthernetCapacity, ethQOSTXDropped=ethQOSTXDropped, radioEntry=radioEntry, radioTxFrequency=radioTxFrequency, ethRXTruncatedFrames=ethRXTruncatedFrames, radioTxPower=radioTxPower, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethGFPFCSErrors=ethGFPFCSErrors, vlanPortmap=vlanPortmap, ipRadioCfgGeneral=ipRadioCfgGeneral, modemBandwith=modemBandwith, vlanPortType=vlanPortType, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXPrevPktDropped=ethRXPrevPktDropped, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXCRCErrors=ethRXCRCErrors, modemGeneralStatus=modemGeneralStatus, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ipRadioStatEth=ipRadioStatEth, radioLoopback=radioLoopback, licenseMask=licenseMask, modemCarrierOffset=modemCarrierOffset, modemStatistics=modemStatistics, e1t1ChannelNr=e1t1ChannelNr, ethRXCodeErrors=ethRXCodeErrors, modemTotalCapacity=modemTotalCapacity, sysTemperature=sysTemperature, ethRXMulticasts=ethRXMulticasts, ethTXUnderruns=ethTXUnderruns, ethRXDribleNibbles=ethRXDribleNibbles, licenseUpdateStatus=licenseUpdateStatus, radioRxLevel=radioRxLevel, sysDateAndTime=sysDateAndTime, ethGFPDropedFrames=ethGFPDropedFrames, modemE1T1Channels=modemE1T1Channels, ethTXBackpresEvents=ethTXBackpresEvents, modemACMtotalCapacity=modemACMtotalCapacity, modemSymbolRateRx=modemSymbolRateRx, modemIndex=modemIndex, ethTXByteCounterHi=ethTXByteCounterHi, ethRXByteCounterHi=ethRXByteCounterHi, ethGFPCHECErrors=ethGFPCHECErrors, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, restartcpu=restartcpu, remoteIp=remoteIp, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioDuplexShift=radioDuplexShift, localIp=localIp, modemModulation=modemModulation, ethTXVlanTags=ethTXVlanTags, modemSymbolRateTx=modemSymbolRateTx, radioGenStatus=radioGenStatus, vlansEnabled=vlansEnabled, ethTXGiants=ethTXGiants, atpcIndex=atpcIndex, ethTXBroadcasts=ethTXBroadcasts, ethRXLongEvents=ethRXLongEvents, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemTable=modemTable, ethTXExcessiveDefers=ethTXExcessiveDefers, modemErroredSecondRatio=modemErroredSecondRatio, ipRadioStat=ipRadioStat, modemErroredSecond=modemErroredSecond, ethRXByteCounterLow=ethRXByteCounterLow, modemTotalBlockNumber=modemTotalBlockNumber, ethTXCollisions=ethTXCollisions, e1t1StatTable=e1t1StatTable, modemUnavailtime=modemUnavailtime, writeConfig=writeConfig, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors)
