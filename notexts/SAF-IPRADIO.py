...
mibBuilder.exportSymbols("SAF-IPRADIO", saf=saf, radioRxLevel=radioRxLevel, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemACMmodulationMin=modemACMmodulationMin, localIpMask=localIpMask, ethTXUnderruns=ethTXUnderruns, ethRXPauseFrames=ethRXPauseFrames, e1t1AIS=e1t1AIS, ethTXBroadcasts=ethTXBroadcasts, localIp=localIp, e1t1LOS=e1t1LOS, description=description, ethRXControlFrames=ethRXControlFrames, radioSide=radioSide, ethRXByteCounterHi=ethRXByteCounterHi, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemErroredSecond=modemErroredSecond, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXMulticasts=ethTXMulticasts, radioTxMute=radioTxMute, tehnika=tehnika, vlanTable=vlanTable, modemGeneralStatus=modemGeneralStatus, ethGFPDropedFrames=ethGFPDropedFrames, pointToPoint=pointToPoint, loopbacks=loopbacks, ethRXCodeErrors=ethRXCodeErrors, vlanPortmap=vlanPortmap, modemLDPCdecoderStress=modemLDPCdecoderStress, ipRadioMgmt=ipRadioMgmt, vlanRowStatus=vlanRowStatus, ethQOSTXFrames=ethQOSTXFrames, ethTXPauseFrames=ethTXPauseFrames, ipRadio=ipRadio, modemACMengine=modemACMengine, vlanFid=vlanFid, ethGFPCHECErrors=ethGFPCHECErrors, modemRadialMSE=modemRadialMSE, product=product, radioRxFrequency=radioRxFrequency, microwaveRadio=microwaveRadio, e1t1StatTable=e1t1StatTable, vlanEntry=vlanEntry, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXCRCErrors=ethTXCRCErrors, ethRXPrevPktDropped=ethRXPrevPktDropped, modemRowStatus=modemRowStatus, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemLastAcqError=modemLastAcqError, modemACMethernetCapacity=modemACMethernetCapacity, radioLoopback=radioLoopback, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioIndex=radioIndex, modemModulation=modemModulation, ethQOSTXDropped=ethQOSTXDropped, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemCountTime=modemCountTime, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, atpcTxPowerCorrection=atpcTxPowerCorrection, writeConfig=writeConfig, ethTXCollisions=ethTXCollisions, modemTable=modemTable, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioTxPower=radioTxPower, ethTXByteCounterHi=ethTXByteCounterHi, ethTXByteCounterLow=ethTXByteCounterLow, ipRadioStat=ipRadioStat, radioDuplexShift=radioDuplexShift, aTPCTable=aTPCTable, radioGenStatus=radioGenStatus, aTPCEntry=aTPCEntry, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXLateCollisions=ethTXLateCollisions, modemTotalBlockNumber=modemTotalBlockNumber, vlanPortType=vlanPortType, modemSymbolRateTx=modemSymbolRateTx, ipRadioCfgGeneral=ipRadioCfgGeneral, atpcEnabled=atpcEnabled, modemSymbolRateRx=modemSymbolRateRx, loopback_tributary_mask=loopback_tributary_mask, modemUptime=modemUptime, modemStandard=modemStandard, safip=safip, modemTotalCapacity=modemTotalCapacity, licenseMask=licenseMask, ethTXExcessiveDefers=ethTXExcessiveDefers, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethGFPFCSErrors=ethGFPFCSErrors, vlanCfgStat=vlanCfgStat, modemErroredSecondRatio=modemErroredSecondRatio, restartcpu=restartcpu, ethRXDvEvent=ethRXDvEvent, radioEntry=radioEntry, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXBackpresEvents=ethTXBackpresEvents, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemAcqStatus=modemAcqStatus, atpcIndex=atpcIndex, ethRXMulticasts=ethRXMulticasts, ethTXWireByteCounterHi=ethTXWireByteCounterHi, hostname=hostname, license=license, e1t1StatEntry=e1t1StatEntry, vlansEnabled=vlansEnabled, ethRXLongEvents=ethRXLongEvents, ethRXByteCounterLow=ethRXByteCounterLow, ethRXCRCErrors=ethRXCRCErrors, ethRXDones=ethRXDones, e1t1ChannelNr=e1t1ChannelNr, licenseUpdateStatus=licenseUpdateStatus, modemE1T1Channels=modemE1T1Channels, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXBroadcasts=ethRXBroadcasts, modemBandwith=modemBandwith, ethTXGiants=ethTXGiants, ethTXVlanTags=ethTXVlanTags, modemACMtotalCapacity=modemACMtotalCapacity, ipRadioStatEth=ipRadioStatEth, ethTXDones=ethTXDones, ethTXControlFrames=ethTXControlFrames, modemUnavailtime=modemUnavailtime, radioTxFrequency=radioTxFrequency, ethTXMaxCollisions=ethTXMaxCollisions, modemACMmodulationMax=modemACMmodulationMax, modemErroredBlock=modemErroredBlock, sysTemperature=sysTemperature, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemStatistics=modemStatistics, vlanNumber=vlanNumber, modemIndex=modemIndex, modemEthernetCapacity=modemEthernetCapacity, modemInternalAGCgain=modemInternalAGCgain, modemEntry=modemEntry, ipRadioCfg=ipRadioCfg, radioTable=radioTable, ethGFPDelineationErrors=ethGFPDelineationErrors, remoteIp=remoteIp, ethRXDribleNibbles=ethRXDribleNibbles, sysDateAndTime=sysDateAndTime, modemCarrierOffset=modemCarrierOffset)
