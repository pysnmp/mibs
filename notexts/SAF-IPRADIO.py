...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXTruncatedFrames=ethRXTruncatedFrames, vlanNumber=vlanNumber, e1t1ChannelNr=e1t1ChannelNr, ethTXControlFrames=ethTXControlFrames, ethTXVlanTags=ethTXVlanTags, modemUnavailtime=modemUnavailtime, radioEntry=radioEntry, modemCarrierOffset=modemCarrierOffset, modemE1T1Channels=modemE1T1Channels, loopback_tributary_mask=loopback_tributary_mask, remoteIp=remoteIp, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXMulticasts=ethRXMulticasts, modemSeverelyErroredSecond=modemSeverelyErroredSecond, safip=safip, ethGFPCHECErrors=ethGFPCHECErrors, e1t1StatEntry=e1t1StatEntry, modemACMtotalCapacity=modemACMtotalCapacity, modemTotalCapacity=modemTotalCapacity, radioLoopback=radioLoopback, restartcpu=restartcpu, modemEthernetCapacity=modemEthernetCapacity, modemCountTime=modemCountTime, ethTXBroadcasts=ethTXBroadcasts, ipRadioCfgNetwork=ipRadioCfgNetwork, modemRowStatus=modemRowStatus, ethTXByteCounterHi=ethTXByteCounterHi, modemErroredBlock=modemErroredBlock, atpcTxPowerCorrection=atpcTxPowerCorrection, tehnika=tehnika, modemAcqStatus=modemAcqStatus, radioRxFrequency=radioRxFrequency, ethRXCodeErrors=ethRXCodeErrors, radioTable=radioTable, radioSide=radioSide, modemSymbolRateRx=modemSymbolRateRx, product=product, modemRadialMSE=modemRadialMSE, localIp=localIp, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ipRadioStatEth=ipRadioStatEth, ethTXCRCErrors=ethTXCRCErrors, ethRXBroadcasts=ethRXBroadcasts, ethTXDones=ethTXDones, radioTxPower=radioTxPower, e1t1AIS=e1t1AIS, modemInternalAGCgain=modemInternalAGCgain, modemStandard=modemStandard, ethTXPauseFrames=ethTXPauseFrames, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethQOSTXFrames=ethQOSTXFrames, vlanRowStatus=vlanRowStatus, sysDateAndTime=sysDateAndTime, modemStatistics=modemStatistics, modemEntry=modemEntry, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ipRadioCfgGeneral=ipRadioCfgGeneral, modemE1T1ChannelMask=modemE1T1ChannelMask, pointToPoint=pointToPoint, radioGenStatus=radioGenStatus, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemGeneralStatus=modemGeneralStatus, ethRXDvEvent=ethRXDvEvent, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, microwaveRadio=microwaveRadio, ethTXCollisions=ethTXCollisions, ethTXExcessiveDefers=ethTXExcessiveDefers, saf=saf, sysTemperature=sysTemperature, vlanPortmap=vlanPortmap, ipRadioStat=ipRadioStat, hostname=hostname, ipRadio=ipRadio, radioRxLevel=radioRxLevel, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXLateCollisions=ethTXLateCollisions, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXLongEvents=ethRXLongEvents, modemACMmodulationMin=modemACMmodulationMin, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXDribleNibbles=ethRXDribleNibbles, modemModulation=modemModulation, ethRXByteCounterLow=ethRXByteCounterLow, ethTXMulticasts=ethTXMulticasts, vlanEntry=vlanEntry, modemTotalBlockNumber=modemTotalBlockNumber, ethTXMaxCollisions=ethTXMaxCollisions, vlanFid=vlanFid, ethRXPauseFrames=ethRXPauseFrames, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXBackpresEvents=ethTXBackpresEvents, vlanCfgStat=vlanCfgStat, atpcEnabled=atpcEnabled, modemBandwith=modemBandwith, modemACMengine=modemACMengine, e1t1StatTable=e1t1StatTable, loopbacks=loopbacks, modemErroredSecond=modemErroredSecond, ethRXDones=ethRXDones, ethGFPFCSErrors=ethGFPFCSErrors, modemUptime=modemUptime, modemSymbolRateTx=modemSymbolRateTx, modemACMmodulationMax=modemACMmodulationMax, ethRXCRCErrors=ethRXCRCErrors, ethTXUnderruns=ethTXUnderruns, vlanPortType=vlanPortType, ethRXPrevPktDropped=ethRXPrevPktDropped, modemErroredSecondRatio=modemErroredSecondRatio, ethTXWireByteCounterLow=ethTXWireByteCounterLow, e1t1LOS=e1t1LOS, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioIndex=radioIndex, licenseUpdateStatus=licenseUpdateStatus, aTPCEntry=aTPCEntry, license=license, modemACMethernetCapacity=modemACMethernetCapacity, ethQOSTXDropped=ethQOSTXDropped, ipRadioCfg=ipRadioCfg, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, licenseMask=licenseMask, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXControlFrames=ethRXControlFrames, description=description, localIpMask=localIpMask, radioDuplexShift=radioDuplexShift, vlansEnabled=vlansEnabled, aTPCTable=aTPCTable, radioTxMute=radioTxMute, modemTable=modemTable, ethTXGiants=ethTXGiants, modemLastAcqError=modemLastAcqError, radioTxFrequency=radioTxFrequency, vlanTable=vlanTable, ethRXByteCounterHi=ethRXByteCounterHi, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethGFPDropedFrames=ethGFPDropedFrames, ipRadioMgmt=ipRadioMgmt, atpcIndex=atpcIndex, modemIndex=modemIndex, writeConfig=writeConfig, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXByteCounterLow=ethTXByteCounterLow)
