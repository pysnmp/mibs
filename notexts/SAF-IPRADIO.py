...
mibBuilder.exportSymbols("SAF-IPRADIO", radioTable=radioTable, modemACMethernetCapacity=modemACMethernetCapacity, ethTXMulticasts=ethTXMulticasts, hostname=hostname, radioGenStatus=radioGenStatus, vlanPortmap=vlanPortmap, modemACMmodulationMin=modemACMmodulationMin, vlanTable=vlanTable, radioTxMute=radioTxMute, modemErroredSecond=modemErroredSecond, e1t1StatTable=e1t1StatTable, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXCodeErrors=ethRXCodeErrors, ethTXByteCounterLow=ethTXByteCounterLow, saf=saf, radioIndex=radioIndex, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXWireByteCounterHi=ethTXWireByteCounterHi, e1t1LOS=e1t1LOS, modemRadialMSE=modemRadialMSE, modemErroredBlock=modemErroredBlock, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemBackgroundBlockErrror=modemBackgroundBlockErrror, e1t1StatEntry=e1t1StatEntry, modemIndex=modemIndex, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXByteCounterHi=ethTXByteCounterHi, e1t1AIS=e1t1AIS, license=license, modemACMtotalCapacity=modemACMtotalCapacity, ethTXVlanTags=ethTXVlanTags, ipRadioStat=ipRadioStat, localIpMask=localIpMask, radioRxLevel=radioRxLevel, vlanEntry=vlanEntry, ethRXDones=ethRXDones, loopbacks=loopbacks, modemEthernetCapacity=modemEthernetCapacity, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXControlFrames=ethTXControlFrames, ethTXGiants=ethTXGiants, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemUnavailtime=modemUnavailtime, radioTxPower=radioTxPower, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemCarrierOffset=modemCarrierOffset, ethQOSTXDropped=ethQOSTXDropped, licenseUpdateStatus=licenseUpdateStatus, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethGFPCHECErrors=ethGFPCHECErrors, radioDuplexShift=radioDuplexShift, ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, modemStatistics=modemStatistics, atpcIndex=atpcIndex, ipRadioMgmt=ipRadioMgmt, radioRxFrequency=radioRxFrequency, atpcEnabled=atpcEnabled, ethQOSTXFrames=ethQOSTXFrames, modemTotalBlockNumber=modemTotalBlockNumber, modemSymbolRateTx=modemSymbolRateTx, tehnika=tehnika, restartcpu=restartcpu, microwaveRadio=microwaveRadio, ethRXDvEvent=ethRXDvEvent, product=product, modemErroredSecondRatio=modemErroredSecondRatio, modemACMengine=modemACMengine, loopback_tributary_mask=loopback_tributary_mask, ethTXPauseFrames=ethTXPauseFrames, licenseMask=licenseMask, radioLoopback=radioLoopback, modemEntry=modemEntry, aTPCTable=aTPCTable, ethTXUnderruns=ethTXUnderruns, modemBandwith=modemBandwith, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXExcessiveDefers=ethTXExcessiveDefers, writeConfig=writeConfig, ipRadioCfg=ipRadioCfg, radioSide=radioSide, atpcTxPowerCorrection=atpcTxPowerCorrection, modemModulation=modemModulation, ethTXLateCollisions=ethTXLateCollisions, ethTXCRCErrors=ethTXCRCErrors, sysDateAndTime=sysDateAndTime, ethTXDones=ethTXDones, localIp=localIp, radioTxFrequency=radioTxFrequency, modemACMmodulationMax=modemACMmodulationMax, vlanRowStatus=vlanRowStatus, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, pointToPoint=pointToPoint, aTPCEntry=aTPCEntry, modemSymbolRateRx=modemSymbolRateRx, ethRXDribleNibbles=ethRXDribleNibbles, ethGFPFCSErrors=ethGFPFCSErrors, vlanCfgStat=vlanCfgStat, ethRXLongEvents=ethRXLongEvents, ethRXMulticasts=ethRXMulticasts, ipRadioStatEth=ipRadioStatEth, modemLastAcqError=modemLastAcqError, ethRXByteCounterHi=ethRXByteCounterHi, ethTXBroadcasts=ethTXBroadcasts, modemUptime=modemUptime, ethRXBroadcasts=ethRXBroadcasts, ethRXByteCounterLow=ethRXByteCounterLow, ethTXCollisions=ethTXCollisions, modemLDPCdecoderStress=modemLDPCdecoderStress, modemInternalAGCgain=modemInternalAGCgain, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ipRadio=ipRadio, ipRadioCfgGeneral=ipRadioCfgGeneral, modemGeneralStatus=modemGeneralStatus, vlanNumber=vlanNumber, modemAcqStatus=modemAcqStatus, e1t1ChannelNr=e1t1ChannelNr, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemStandard=modemStandard, vlanPortType=vlanPortType, description=description, safip=safip, remoteIp=remoteIp, modemTable=modemTable, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemE1T1Channels=modemE1T1Channels, radioEntry=radioEntry, sysTemperature=sysTemperature, ethRXCRCErrors=ethRXCRCErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXControlFrames=ethRXControlFrames, vlanFid=vlanFid, modemCountTime=modemCountTime, vlansEnabled=vlansEnabled, modemRowStatus=modemRowStatus, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemTotalCapacity=modemTotalCapacity, ethTXBackpresEvents=ethTXBackpresEvents, ethRXTruncatedFrames=ethRXTruncatedFrames, ethGFPDropedFrames=ethGFPDropedFrames, ethRXPauseFrames=ethRXPauseFrames, ethTXMaxCollisions=ethTXMaxCollisions)
