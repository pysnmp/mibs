...
mibBuilder.exportSymbols("SAF-IPRADIO", modemAcqStatus=modemAcqStatus, ethTXByteCounterHi=ethTXByteCounterHi, modemRowStatus=modemRowStatus, modemBandwith=modemBandwith, radioGenStatus=radioGenStatus, ethRXDribleNibbles=ethRXDribleNibbles, ethRXLongEvents=ethRXLongEvents, ethTXControlFrames=ethTXControlFrames, radioTxMute=radioTxMute, e1t1AIS=e1t1AIS, modemGeneralStatus=modemGeneralStatus, ethRXDvEvent=ethRXDvEvent, modemLastAcqError=modemLastAcqError, ethRXCRCErrors=ethRXCRCErrors, modemCarrierOffset=modemCarrierOffset, license=license, ipRadioCfg=ipRadioCfg, vlansEnabled=vlansEnabled, ethQOSTXDropped=ethQOSTXDropped, licenseMask=licenseMask, e1t1StatTable=e1t1StatTable, modemErroredBlock=modemErroredBlock, modemTable=modemTable, ipRadioStat=ipRadioStat, writeConfig=writeConfig, modemACMmodulationMax=modemACMmodulationMax, vlanFid=vlanFid, modemTotalCapacity=modemTotalCapacity, ethTXMaxCollisions=ethTXMaxCollisions, atpcEnabled=atpcEnabled, remoteIp=remoteIp, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemErroredSecond=modemErroredSecond, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlanEntry=vlanEntry, loopback_tributary_mask=loopback_tributary_mask, ethQOSTXFrames=ethQOSTXFrames, saf=saf, localIpMask=localIpMask, modemBackgroundBlockErrror=modemBackgroundBlockErrror, tehnika=tehnika, modemACMtotalCapacity=modemACMtotalCapacity, sysDateAndTime=sysDateAndTime, ipRadioCfgGeneral=ipRadioCfgGeneral, e1t1StatEntry=e1t1StatEntry, modemACMmodulationMin=modemACMmodulationMin, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXMulticasts=ethRXMulticasts, modemRadialMSE=modemRadialMSE, ethTXCollisions=ethTXCollisions, modemIndex=modemIndex, modemUptime=modemUptime, radioLoopback=radioLoopback, safip=safip, ipRadioStatEth=ipRadioStatEth, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioSide=radioSide, radioRxFrequency=radioRxFrequency, radioDuplexShift=radioDuplexShift, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemEthernetCapacity=modemEthernetCapacity, ethTXLateCollisions=ethTXLateCollisions, atpcIndex=atpcIndex, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXMulticasts=ethTXMulticasts, ipRadioMgmt=ipRadioMgmt, modemCountTime=modemCountTime, ipRadio=ipRadio, ethGFPDelineationErrors=ethGFPDelineationErrors, modemErroredSecondRatio=modemErroredSecondRatio, radioRxLevel=radioRxLevel, ethTXByteCounterLow=ethTXByteCounterLow, ethTXVlanTags=ethTXVlanTags, hostname=hostname, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioTxFrequency=radioTxFrequency, modemE1T1Channels=modemE1T1Channels, vlanRowStatus=vlanRowStatus, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXCodeErrors=ethRXCodeErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXUnderruns=ethTXUnderruns, ethTXBroadcasts=ethTXBroadcasts, ethRXByteCounterHi=ethRXByteCounterHi, vlanTable=vlanTable, ethTXGiants=ethTXGiants, ethRXBroadcasts=ethRXBroadcasts, ethTXBackpresEvents=ethTXBackpresEvents, ethGFPCHECErrors=ethGFPCHECErrors, modemACMengine=modemACMengine, modemTotalBlockNumber=modemTotalBlockNumber, e1t1LOS=e1t1LOS, ethRXControlFrames=ethRXControlFrames, ethGFPFCSErrors=ethGFPFCSErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemStatistics=modemStatistics, radioTxPower=radioTxPower, pointToPoint=pointToPoint, modemStandard=modemStandard, radioTable=radioTable, modemE1T1ChannelMask=modemE1T1ChannelMask, localIp=localIp, ethTXWireByteCounterHi=ethTXWireByteCounterHi, sysTemperature=sysTemperature, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXDones=ethRXDones, ethGFPDropedFrames=ethGFPDropedFrames, modemUnavailtime=modemUnavailtime, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXByteCounterLow=ethRXByteCounterLow, ethRXVlanTagsDetected=ethRXVlanTagsDetected, licenseUpdateStatus=licenseUpdateStatus, e1t1ChannelNr=e1t1ChannelNr, vlanNumber=vlanNumber, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemACMethernetCapacity=modemACMethernetCapacity, loopbacks=loopbacks, description=description, vlanCfgStat=vlanCfgStat, ethQOSRXQ1Frames=ethQOSRXQ1Frames, aTPCTable=aTPCTable, modemSymbolRateTx=modemSymbolRateTx, ethTXPauseFrames=ethTXPauseFrames, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXPrevPktDropped=ethRXPrevPktDropped, radioEntry=radioEntry, ethTXDones=ethTXDones, atpcTxPowerCorrection=atpcTxPowerCorrection, modemEntry=modemEntry, product=product, modemSymbolRateRx=modemSymbolRateRx, ethTXCRCErrors=ethTXCRCErrors, vlanPortType=vlanPortType, modemModulation=modemModulation, restartcpu=restartcpu, radioIndex=radioIndex, aTPCEntry=aTPCEntry, modemInternalAGCgain=modemInternalAGCgain, vlanPortmap=vlanPortmap, ipRadioCfgNetwork=ipRadioCfgNetwork, microwaveRadio=microwaveRadio, ethRXPauseFrames=ethRXPauseFrames)
