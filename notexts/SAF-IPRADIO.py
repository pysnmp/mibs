...
mibBuilder.exportSymbols("SAF-IPRADIO", atpcIndex=atpcIndex, radioEntry=radioEntry, ethTXCRCErrors=ethTXCRCErrors, loopback_tributary_mask=loopback_tributary_mask, modemEthernetCapacity=modemEthernetCapacity, radioLoopback=radioLoopback, ethTXLengthCheckErrors=ethTXLengthCheckErrors, e1t1StatTable=e1t1StatTable, sysDateAndTime=sysDateAndTime, modemEntry=modemEntry, vlanNumber=vlanNumber, e1t1ChannelNr=e1t1ChannelNr, vlanFid=vlanFid, ethRXDvEvent=ethRXDvEvent, radioGenStatus=radioGenStatus, product=product, modemACMengine=modemACMengine, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, saf=saf, modemSymbolRateTx=modemSymbolRateTx, vlanPortType=vlanPortType, license=license, ethRXPauseFrames=ethRXPauseFrames, ethRXByteCounterHi=ethRXByteCounterHi, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemErroredSecond=modemErroredSecond, ethTXByteCounterHi=ethTXByteCounterHi, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioSide=radioSide, modemRadialMSE=modemRadialMSE, ethTXGiants=ethTXGiants, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXByteCounterLow=ethRXByteCounterLow, ethRXDones=ethRXDones, ethTXDones=ethTXDones, ethTXBackpresEvents=ethTXBackpresEvents, writeConfig=writeConfig, e1t1AIS=e1t1AIS, ethRXPrevPktDropped=ethRXPrevPktDropped, localIp=localIp, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethGFPCHECErrors=ethGFPCHECErrors, modemLDPCdecoderStress=modemLDPCdecoderStress, description=description, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXMulticasts=ethRXMulticasts, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioTxFrequency=radioTxFrequency, modemCarrierOffset=modemCarrierOffset, ethRXCRCErrors=ethRXCRCErrors, ipRadio=ipRadio, ipRadioCfg=ipRadioCfg, modemSymbolRateRx=modemSymbolRateRx, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXCollisions=ethTXCollisions, modemErroredSecondRatio=modemErroredSecondRatio, atpcEnabled=atpcEnabled, ethGFPDelineationErrors=ethGFPDelineationErrors, modemACMmodulationMax=modemACMmodulationMax, vlanEntry=vlanEntry, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, safip=safip, modemAcqStatus=modemAcqStatus, ipRadioCfgGeneral=ipRadioCfgGeneral, vlansEnabled=vlansEnabled, modemStandard=modemStandard, sysTemperature=sysTemperature, ethQOSTXFrames=ethQOSTXFrames, modemModulation=modemModulation, loopbacks=loopbacks, radioRxLevel=radioRxLevel, ethRXVlanTagsDetected=ethRXVlanTagsDetected, licenseMask=licenseMask, modemIndex=modemIndex, ethRXDribleNibbles=ethRXDribleNibbles, radioIndex=radioIndex, vlanCfgStat=vlanCfgStat, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioTxMute=radioTxMute, modemCountTime=modemCountTime, ipRadioStat=ipRadioStat, microwaveRadio=microwaveRadio, modemTable=modemTable, modemUnavailtime=modemUnavailtime, radioTxPower=radioTxPower, ethRXBroadcasts=ethRXBroadcasts, pointToPoint=pointToPoint, aTPCTable=aTPCTable, localIpMask=localIpMask, ethGFPFCSErrors=ethGFPFCSErrors, ethRXControlFrames=ethRXControlFrames, ethGFPDropedFrames=ethGFPDropedFrames, ethTXPauseFrames=ethTXPauseFrames, ethRXLongEvents=ethRXLongEvents, modemACMethernetCapacity=modemACMethernetCapacity, vlanPortmap=vlanPortmap, modemTotalBlockNumber=modemTotalBlockNumber, licenseUpdateStatus=licenseUpdateStatus, radioTable=radioTable, ethTXMulticasts=ethTXMulticasts, e1t1StatEntry=e1t1StatEntry, ethTXExcessiveDefers=ethTXExcessiveDefers, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXTruncatedFrames=ethRXTruncatedFrames, ethQOSTXDropped=ethQOSTXDropped, modemRowStatus=modemRowStatus, modemE1T1ChannelMask=modemE1T1ChannelMask, modemGeneralStatus=modemGeneralStatus, modemBandwith=modemBandwith, modemLastAcqError=modemLastAcqError, hostname=hostname, modemACMmodulationMin=modemACMmodulationMin, restartcpu=restartcpu, modemUptime=modemUptime, ipRadioMgmt=ipRadioMgmt, modemErroredBlock=modemErroredBlock, vlanRowStatus=vlanRowStatus, ipRadioStatEth=ipRadioStatEth, modemTotalCapacity=modemTotalCapacity, ethTXByteCounterLow=ethTXByteCounterLow, ethTXLateCollisions=ethTXLateCollisions, e1t1LOS=e1t1LOS, ethTXUnderruns=ethTXUnderruns, atpcTxPowerCorrection=atpcTxPowerCorrection, vlanTable=vlanTable, tehnika=tehnika, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemACMtotalCapacity=modemACMtotalCapacity, radioRxFrequency=radioRxFrequency, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioDuplexShift=radioDuplexShift, ethTXVlanTags=ethTXVlanTags, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemInternalAGCgain=modemInternalAGCgain, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, aTPCEntry=aTPCEntry, ethRXCodeErrors=ethRXCodeErrors, ethTXMaxCollisions=ethTXMaxCollisions, ethTXControlFrames=ethTXControlFrames, modemStatistics=modemStatistics, modemE1T1Channels=modemE1T1Channels, remoteIp=remoteIp, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXBroadcasts=ethTXBroadcasts)
