...
mibBuilder.exportSymbols("SAF-IPRADIO", modemUptime=modemUptime, modemACMmodulationMax=modemACMmodulationMax, writeConfig=writeConfig, modemCarrierOffset=modemCarrierOffset, safip=safip, ethRXPauseFrames=ethRXPauseFrames, ethRXControlFrames=ethRXControlFrames, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ipRadio=ipRadio, ethRXByteCounterHi=ethRXByteCounterHi, ethTXBackpresEvents=ethTXBackpresEvents, modemACMengine=modemACMengine, modemStandard=modemStandard, radioLoopback=radioLoopback, e1t1StatTable=e1t1StatTable, modemACMethernetCapacity=modemACMethernetCapacity, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXCollisions=ethTXCollisions, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioTxFrequency=radioTxFrequency, modemACMtotalCapacity=modemACMtotalCapacity, radioTxPower=radioTxPower, description=description, modemStatistics=modemStatistics, vlanEntry=vlanEntry, e1t1AIS=e1t1AIS, e1t1ChannelNr=e1t1ChannelNr, modemCountTime=modemCountTime, microwaveRadio=microwaveRadio, modemGeneralStatus=modemGeneralStatus, sysTemperature=sysTemperature, ethTXLateCollisions=ethTXLateCollisions, ethTXGiants=ethTXGiants, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXCodeErrors=ethRXCodeErrors, sysDateAndTime=sysDateAndTime, ethQOSTXDropped=ethQOSTXDropped, modemE1T1Channels=modemE1T1Channels, ethTXByteCounterHi=ethTXByteCounterHi, radioDuplexShift=radioDuplexShift, ethRXDvEvent=ethRXDvEvent, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemUnavailtime=modemUnavailtime, ethGFPFCSErrors=ethGFPFCSErrors, modemErroredSecondRatio=modemErroredSecondRatio, loopback_tributary_mask=loopback_tributary_mask, vlanRowStatus=vlanRowStatus, vlanFid=vlanFid, ethRXMulticasts=ethRXMulticasts, ipRadioMgmt=ipRadioMgmt, radioIndex=radioIndex, modemLDPCdecoderStress=modemLDPCdecoderStress, modemTotalBlockNumber=modemTotalBlockNumber, ethTXControlFrames=ethTXControlFrames, radioSide=radioSide, loopbacks=loopbacks, aTPCEntry=aTPCEntry, modemModulation=modemModulation, ethGFPCHECErrors=ethGFPCHECErrors, ethTXUnderruns=ethTXUnderruns, atpcTxPowerCorrection=atpcTxPowerCorrection, modemTable=modemTable, modemE1T1ChannelMask=modemE1T1ChannelMask, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ipRadioCfgNetwork=ipRadioCfgNetwork, modemEthernetCapacity=modemEthernetCapacity, modemErroredBlock=modemErroredBlock, ethQOSTXFrames=ethQOSTXFrames, remoteIp=remoteIp, restartcpu=restartcpu, ethTXPauseFrames=ethTXPauseFrames, vlanNumber=vlanNumber, ethRXDones=ethRXDones, ethTXDones=ethTXDones, modemRowStatus=modemRowStatus, radioRxLevel=radioRxLevel, ethTXBroadcasts=ethTXBroadcasts, ethRXLongEvents=ethRXLongEvents, ethTXMulticasts=ethTXMulticasts, modemSymbolRateRx=modemSymbolRateRx, vlanTable=vlanTable, vlansEnabled=vlansEnabled, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemErroredSecond=modemErroredSecond, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, vlanPortmap=vlanPortmap, modemACMmodulationMin=modemACMmodulationMin, ethTXCRCErrors=ethTXCRCErrors, licenseMask=licenseMask, aTPCTable=aTPCTable, ethTXVlanTags=ethTXVlanTags, modemAcqStatus=modemAcqStatus, ethRXBroadcasts=ethRXBroadcasts, e1t1LOS=e1t1LOS, atpcIndex=atpcIndex, pointToPoint=pointToPoint, atpcEnabled=atpcEnabled, modemBandwith=modemBandwith, modemTotalCapacity=modemTotalCapacity, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioTxMute=radioTxMute, product=product, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, e1t1StatEntry=e1t1StatEntry, radioRxFrequency=radioRxFrequency, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemRadialMSE=modemRadialMSE, vlanPortType=vlanPortType, modemBackgroundBlockErrror=modemBackgroundBlockErrror, hostname=hostname, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, licenseUpdateStatus=licenseUpdateStatus, tehnika=tehnika, modemEntry=modemEntry, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ipRadioCfg=ipRadioCfg, modemLastAcqError=modemLastAcqError, ethTXExcessiveDefers=ethTXExcessiveDefers, modemIndex=modemIndex, radioTable=radioTable, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ipRadioStatEth=ipRadioStatEth, ethGFPDropedFrames=ethGFPDropedFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, modemInternalAGCgain=modemInternalAGCgain, ethTXLengthCheckErrors=ethTXLengthCheckErrors, radioGenStatus=radioGenStatus, vlanCfgStat=vlanCfgStat, localIp=localIp, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, saf=saf, localIpMask=localIpMask, ethRXDribleNibbles=ethRXDribleNibbles, license=license, ethRXByteCounterLow=ethRXByteCounterLow, ethTXMaxCollisions=ethTXMaxCollisions, ethTXByteCounterLow=ethTXByteCounterLow, ethRXCRCErrors=ethRXCRCErrors, modemSymbolRateTx=modemSymbolRateTx, radioEntry=radioEntry, ipRadioStat=ipRadioStat)
