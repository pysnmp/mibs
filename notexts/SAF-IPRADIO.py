...
mibBuilder.exportSymbols("SAF-IPRADIO", modemCountTime=modemCountTime, e1t1ChannelNr=e1t1ChannelNr, ethRXByteCounterHi=ethRXByteCounterHi, vlanEntry=vlanEntry, ethTXControlFrames=ethTXControlFrames, ipRadioMgmt=ipRadioMgmt, ethTXMulticasts=ethTXMulticasts, modemACMethernetCapacity=modemACMethernetCapacity, modemTotalBlockNumber=modemTotalBlockNumber, modemACMmodulationMin=modemACMmodulationMin, modemErroredSecond=modemErroredSecond, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXCodeErrors=ethRXCodeErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlanCfgStat=vlanCfgStat, modemTotalCapacity=modemTotalCapacity, vlanNumber=vlanNumber, license=license, ethRXDvEvent=ethRXDvEvent, radioTxMute=radioTxMute, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethGFPCHECErrors=ethGFPCHECErrors, licenseMask=licenseMask, loopbacks=loopbacks, restartcpu=restartcpu, radioIndex=radioIndex, ethQOSTXFrames=ethQOSTXFrames, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioTxFrequency=radioTxFrequency, modemErroredBlock=modemErroredBlock, ipRadioCfg=ipRadioCfg, modemInternalAGCgain=modemInternalAGCgain, radioRxFrequency=radioRxFrequency, sysTemperature=sysTemperature, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemIndex=modemIndex, ethTXGiants=ethTXGiants, product=product, radioRxLevel=radioRxLevel, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror, remoteIp=remoteIp, modemLastAcqError=modemLastAcqError, ethTXPauseFrames=ethTXPauseFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, aTPCTable=aTPCTable, modemErroredSecondRatio=modemErroredSecondRatio, radioLoopback=radioLoopback, radioEntry=radioEntry, modemEthernetCapacity=modemEthernetCapacity, ethQOSTXDropped=ethQOSTXDropped, ipRadioStatEth=ipRadioStatEth, modemRowStatus=modemRowStatus, writeConfig=writeConfig, modemEntry=modemEntry, modemACMmodulationMax=modemACMmodulationMax, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXVlanTags=ethTXVlanTags, ethRXByteCounterLow=ethRXByteCounterLow, ethRXDribleNibbles=ethRXDribleNibbles, modemSymbolRateRx=modemSymbolRateRx, e1t1StatTable=e1t1StatTable, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethGFPDropedFrames=ethGFPDropedFrames, ethTXCRCErrors=ethTXCRCErrors, ipRadioStat=ipRadioStat, radioDuplexShift=radioDuplexShift, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemTable=modemTable, ethRXControlFrames=ethRXControlFrames, e1t1LOS=e1t1LOS, ethGFPFCSErrors=ethGFPFCSErrors, modemGeneralStatus=modemGeneralStatus, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXBroadcasts=ethTXBroadcasts, vlanTable=vlanTable, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXLateCollisions=ethTXLateCollisions, radioTxPower=radioTxPower, sysDateAndTime=sysDateAndTime, radioSide=radioSide, localIpMask=localIpMask, ethRXBroadcasts=ethRXBroadcasts, modemStatistics=modemStatistics, saf=saf, licenseUpdateStatus=licenseUpdateStatus, ethTXByteCounterLow=ethTXByteCounterLow, vlanFid=vlanFid, description=description, modemCarrierOffset=modemCarrierOffset, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, e1t1AIS=e1t1AIS, ipRadioCfgNetwork=ipRadioCfgNetwork, microwaveRadio=microwaveRadio, ethRXPauseFrames=ethRXPauseFrames, ethRXMulticasts=ethRXMulticasts, tehnika=tehnika, vlanRowStatus=vlanRowStatus, modemBandwith=modemBandwith, modemAcqStatus=modemAcqStatus, vlansEnabled=vlansEnabled, modemStandard=modemStandard, ethTXCollisions=ethTXCollisions, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXByteCounterHi=ethTXByteCounterHi, modemLDPCdecoderStress=modemLDPCdecoderStress, vlanPortType=vlanPortType, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXDones=ethRXDones, radioGenStatus=radioGenStatus, pointToPoint=pointToPoint, ipRadioCfgGeneral=ipRadioCfgGeneral, modemModulation=modemModulation, modemRadialMSE=modemRadialMSE, safip=safip, vlanPortmap=vlanPortmap, modemACMengine=modemACMengine, radioTable=radioTable, hostname=hostname, ipRadio=ipRadio, atpcEnabled=atpcEnabled, ethTXMaxCollisions=ethTXMaxCollisions, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemUnavailtime=modemUnavailtime, ethTXUnderruns=ethTXUnderruns, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, loopback_tributary_mask=loopback_tributary_mask, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXBackpresEvents=ethTXBackpresEvents, modemACMtotalCapacity=modemACMtotalCapacity, atpcIndex=atpcIndex, modemUptime=modemUptime, ethRXLongEvents=ethRXLongEvents, ethRXPrevPktDropped=ethRXPrevPktDropped, aTPCEntry=aTPCEntry, e1t1StatEntry=e1t1StatEntry, modemE1T1Channels=modemE1T1Channels, localIp=localIp, modemSymbolRateTx=modemSymbolRateTx, ethRXCRCErrors=ethRXCRCErrors, ethTXDones=ethTXDones)
