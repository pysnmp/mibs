...
mibBuilder.exportSymbols("SAF-IPRADIO", hostname=hostname, radioRxLevel=radioRxLevel, vlanRowStatus=vlanRowStatus, product=product, ethRXPauseFrames=ethRXPauseFrames, radioDuplexShift=radioDuplexShift, e1t1ChannelNr=e1t1ChannelNr, ethGFPFCSErrors=ethGFPFCSErrors, atpcIndex=atpcIndex, radioTxFrequency=radioTxFrequency, ethGFPDelineationErrors=ethGFPDelineationErrors, e1t1LOS=e1t1LOS, aTPCTable=aTPCTable, ethTXBackpresEvents=ethTXBackpresEvents, modemStatistics=modemStatistics, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXByteCounterLow=ethRXByteCounterLow, modemRowStatus=modemRowStatus, ethTXUnderruns=ethTXUnderruns, ethTXMulticasts=ethTXMulticasts, ethTXCollisions=ethTXCollisions, ipRadioCfgNetwork=ipRadioCfgNetwork, modemUnavailtime=modemUnavailtime, modemE1T1ChannelMask=modemE1T1ChannelMask, ethGFPCHECErrors=ethGFPCHECErrors, vlansEnabled=vlansEnabled, ipRadioCfg=ipRadioCfg, vlanFid=vlanFid, ethTXByteCounterLow=ethTXByteCounterLow, modemStandard=modemStandard, ethQOSTXFrames=ethQOSTXFrames, ethTXMaxCollisions=ethTXMaxCollisions, modemBandwith=modemBandwith, radioTxMute=radioTxMute, ethTXWireByteCounterHi=ethTXWireByteCounterHi, loopbacks=loopbacks, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemCountTime=modemCountTime, atpcEnabled=atpcEnabled, radioSide=radioSide, vlanPortType=vlanPortType, ethGFPDropedFrames=ethGFPDropedFrames, modemACMethernetCapacity=modemACMethernetCapacity, modemEthernetCapacity=modemEthernetCapacity, ethTXPauseFrames=ethTXPauseFrames, localIp=localIp, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXBroadcasts=ethTXBroadcasts, modemInternalAGCgain=modemInternalAGCgain, modemIndex=modemIndex, modemLastAcqError=modemLastAcqError, radioTxPower=radioTxPower, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemErroredSecond=modemErroredSecond, ipRadioMgmt=ipRadioMgmt, ethQOSTXDropped=ethQOSTXDropped, modemAcqStatus=modemAcqStatus, modemTotalCapacity=modemTotalCapacity, ipRadio=ipRadio, ipRadioStat=ipRadioStat, vlanTable=vlanTable, ethRXCRCErrors=ethRXCRCErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXControlFrames=ethRXControlFrames, vlanEntry=vlanEntry, ethRXByteCounterHi=ethRXByteCounterHi, ethRXDvEvent=ethRXDvEvent, restartcpu=restartcpu, vlanPortmap=vlanPortmap, modemErroredBlock=modemErroredBlock, ethRXDones=ethRXDones, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXControlFrames=ethTXControlFrames, ethTXVlanTags=ethTXVlanTags, atpcTxPowerCorrection=atpcTxPowerCorrection, modemTotalBlockNumber=modemTotalBlockNumber, licenseMask=licenseMask, modemUptime=modemUptime, ethTXExcessiveDefers=ethTXExcessiveDefers, modemModulation=modemModulation, sysDateAndTime=sysDateAndTime, modemSymbolRateTx=modemSymbolRateTx, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXLengthCheckErrors=ethTXLengthCheckErrors, remoteIp=remoteIp, loopback_tributary_mask=loopback_tributary_mask, ethTXDones=ethTXDones, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, localIpMask=localIpMask, writeConfig=writeConfig, ethTXLateCollisions=ethTXLateCollisions, radioRxFrequency=radioRxFrequency, e1t1StatTable=e1t1StatTable, radioLoopback=radioLoopback, ethRXMulticasts=ethRXMulticasts, e1t1AIS=e1t1AIS, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXCodeErrors=ethRXCodeErrors, vlanCfgStat=vlanCfgStat, safip=safip, radioIndex=radioIndex, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioEntry=radioEntry, ethRXLongEvents=ethRXLongEvents, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemRadialMSE=modemRadialMSE, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, vlanNumber=vlanNumber, saf=saf, modemE1T1Channels=modemE1T1Channels, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemGeneralStatus=modemGeneralStatus, modemACMengine=modemACMengine, license=license, ethTXGiants=ethTXGiants, aTPCEntry=aTPCEntry, tehnika=tehnika, modemSymbolRateRx=modemSymbolRateRx, pointToPoint=pointToPoint, microwaveRadio=microwaveRadio, ethRXPrevPktDropped=ethRXPrevPktDropped, e1t1StatEntry=e1t1StatEntry, radioGenStatus=radioGenStatus, modemACMtotalCapacity=modemACMtotalCapacity, modemEntry=modemEntry, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemACMmodulationMax=modemACMmodulationMax, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemCarrierOffset=modemCarrierOffset, ethRXBroadcasts=ethRXBroadcasts, description=description, sysTemperature=sysTemperature, modemACMmodulationMin=modemACMmodulationMin, ethRXDribleNibbles=ethRXDribleNibbles, ethTXCRCErrors=ethTXCRCErrors, modemErroredSecondRatio=modemErroredSecondRatio, ipRadioStatEth=ipRadioStatEth, licenseUpdateStatus=licenseUpdateStatus, radioTable=radioTable, modemTable=modemTable, ethTXByteCounterHi=ethTXByteCounterHi)
