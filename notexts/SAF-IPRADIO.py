...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXMulticasts=ethTXMulticasts, hostname=hostname, modemCarrierOffset=modemCarrierOffset, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemBandwith=modemBandwith, ethTXVlanTags=ethTXVlanTags, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, aTPCTable=aTPCTable, modemAcqStatus=modemAcqStatus, ethQOSTXDropped=ethQOSTXDropped, modemModulation=modemModulation, ethRXByteCounterLow=ethRXByteCounterLow, radioDuplexShift=radioDuplexShift, ethTXCRCErrors=ethTXCRCErrors, e1t1StatTable=e1t1StatTable, ipRadioStatEth=ipRadioStatEth, pointToPoint=pointToPoint, radioRxFrequency=radioRxFrequency, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ipRadioCfg=ipRadioCfg, remoteIp=remoteIp, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemStatistics=modemStatistics, ethRXDones=ethRXDones, atpcTxPowerCorrection=atpcTxPowerCorrection, vlanPortType=vlanPortType, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, vlanCfgStat=vlanCfgStat, ethTXDones=ethTXDones, ethRXBroadcasts=ethRXBroadcasts, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXPauseFrames=ethRXPauseFrames, modemLastAcqError=modemLastAcqError, vlanPortmap=vlanPortmap, radioGenStatus=radioGenStatus, sysTemperature=sysTemperature, modemSymbolRateRx=modemSymbolRateRx, safip=safip, ethRXMulticasts=ethRXMulticasts, modemEntry=modemEntry, localIp=localIp, vlanRowStatus=vlanRowStatus, loopbacks=loopbacks, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ipRadioMgmt=ipRadioMgmt, vlansEnabled=vlansEnabled, ethRXDvEvent=ethRXDvEvent, vlanEntry=vlanEntry, ethTXCollisions=ethTXCollisions, ethTXBroadcasts=ethTXBroadcasts, radioSide=radioSide, modemInternalAGCgain=modemInternalAGCgain, licenseUpdateStatus=licenseUpdateStatus, ethTXByteCounterHi=ethTXByteCounterHi, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemErroredSecond=modemErroredSecond, ethTXBackpresEvents=ethTXBackpresEvents, ethGFPDelineationErrors=ethGFPDelineationErrors, modemIndex=modemIndex, ipRadio=ipRadio, modemRadialMSE=modemRadialMSE, modemTotalCapacity=modemTotalCapacity, ethRXControlFrames=ethRXControlFrames, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXWireByteCounterLow=ethTXWireByteCounterLow, atpcIndex=atpcIndex, ethQOSTXFrames=ethQOSTXFrames, e1t1ChannelNr=e1t1ChannelNr, vlanNumber=vlanNumber, modemE1T1ChannelMask=modemE1T1ChannelMask, license=license, saf=saf, radioLoopback=radioLoopback, ipRadioStat=ipRadioStat, radioTable=radioTable, ethTXPauseFrames=ethTXPauseFrames, modemTotalBlockNumber=modemTotalBlockNumber, loopback_tributary_mask=loopback_tributary_mask, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXControlFrames=ethTXControlFrames, aTPCEntry=aTPCEntry, ethRXByteCounterHi=ethRXByteCounterHi, modemE1T1Channels=modemE1T1Channels, modemACMtotalCapacity=modemACMtotalCapacity, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemEthernetCapacity=modemEthernetCapacity, licenseMask=licenseMask, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemTable=modemTable, restartcpu=restartcpu, ethGFPFCSErrors=ethGFPFCSErrors, radioEntry=radioEntry, modemUnavailtime=modemUnavailtime, radioTxFrequency=radioTxFrequency, localIpMask=localIpMask, modemACMengine=modemACMengine, vlanTable=vlanTable, e1t1AIS=e1t1AIS, e1t1StatEntry=e1t1StatEntry, radioIndex=radioIndex, modemErroredBlock=modemErroredBlock, ethTXLateCollisions=ethTXLateCollisions, modemRowStatus=modemRowStatus, description=description, product=product, ethGFPDropedFrames=ethGFPDropedFrames, modemSymbolRateTx=modemSymbolRateTx, modemLDPCdecoderStress=modemLDPCdecoderStress, modemStandard=modemStandard, modemACMmodulationMin=modemACMmodulationMin, ethRXDribleNibbles=ethRXDribleNibbles, vlanFid=vlanFid, modemErroredSecondRatio=modemErroredSecondRatio, radioTxPower=radioTxPower, modemGeneralStatus=modemGeneralStatus, writeConfig=writeConfig, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXCodeErrors=ethRXCodeErrors, ethTXUnderruns=ethTXUnderruns, modemACMmodulationMax=modemACMmodulationMax, ethGFPCHECErrors=ethGFPCHECErrors, ipRadioCfgGeneral=ipRadioCfgGeneral, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioTxMute=radioTxMute, ethTXByteCounterLow=ethTXByteCounterLow, e1t1LOS=e1t1LOS, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemACMethernetCapacity=modemACMethernetCapacity, sysDateAndTime=sysDateAndTime, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, tehnika=tehnika, atpcEnabled=atpcEnabled, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXMaxCollisions=ethTXMaxCollisions, radioRxLevel=radioRxLevel, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXGiants=ethTXGiants, ethRXCRCErrors=ethRXCRCErrors, ethRXLongEvents=ethRXLongEvents, microwaveRadio=microwaveRadio, modemCountTime=modemCountTime, modemUptime=modemUptime)
