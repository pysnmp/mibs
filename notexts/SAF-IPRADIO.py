...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXControlFrames=ethTXControlFrames, ethTXCollisions=ethTXCollisions, ethGFPFCSErrors=ethGFPFCSErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemTotalBlockNumber=modemTotalBlockNumber, description=description, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXByteCounterHi=ethTXByteCounterHi, licenseUpdateStatus=licenseUpdateStatus, ethTXPauseFrames=ethTXPauseFrames, ipRadioMgmt=ipRadioMgmt, ethRXPauseFrames=ethRXPauseFrames, modemCarrierOffset=modemCarrierOffset, saf=saf, sysTemperature=sysTemperature, ipRadioCfgGeneral=ipRadioCfgGeneral, ethGFPDropedFrames=ethGFPDropedFrames, radioGenStatus=radioGenStatus, radioRxFrequency=radioRxFrequency, radioDuplexShift=radioDuplexShift, ethRXDribleNibbles=ethRXDribleNibbles, modemErroredSecond=modemErroredSecond, modemCountTime=modemCountTime, loopbacks=loopbacks, vlanEntry=vlanEntry, modemE1T1ChannelMask=modemE1T1ChannelMask, hostname=hostname, radioIndex=radioIndex, radioSide=radioSide, vlanRowStatus=vlanRowStatus, pointToPoint=pointToPoint, modemGeneralStatus=modemGeneralStatus, ethRXPrevPktDropped=ethRXPrevPktDropped, modemSymbolRateRx=modemSymbolRateRx, radioTxMute=radioTxMute, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXLateCollisions=ethTXLateCollisions, vlanNumber=vlanNumber, modemACMengine=modemACMengine, modemE1T1Channels=modemE1T1Channels, ethTXMaxCollisions=ethTXMaxCollisions, modemTable=modemTable, modemIndex=modemIndex, radioRxLevel=radioRxLevel, product=product, ethRXBroadcasts=ethRXBroadcasts, ethTXGiants=ethTXGiants, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, aTPCEntry=aTPCEntry, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioTxPower=radioTxPower, modemRowStatus=modemRowStatus, ethTXExcessiveDefers=ethTXExcessiveDefers, atpcIndex=atpcIndex, ipRadioCfg=ipRadioCfg, licenseMask=licenseMask, modemEntry=modemEntry, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ipRadio=ipRadio, tehnika=tehnika, vlanFid=vlanFid, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXUnderruns=ethTXUnderruns, microwaveRadio=microwaveRadio, ethTXBroadcasts=ethTXBroadcasts, modemStatistics=modemStatistics, ethRXDvEvent=ethRXDvEvent, modemErroredSecondRatio=modemErroredSecondRatio, modemACMmodulationMax=modemACMmodulationMax, ethRXByteCounterHi=ethRXByteCounterHi, e1t1StatEntry=e1t1StatEntry, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXLongEvents=ethRXLongEvents, vlanPortType=vlanPortType, modemAcqStatus=modemAcqStatus, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlanCfgStat=vlanCfgStat, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ipRadioStatEth=ipRadioStatEth, ethRXCodeErrors=ethRXCodeErrors, radioTable=radioTable, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemStandard=modemStandard, modemACMethernetCapacity=modemACMethernetCapacity, ethTXBackpresEvents=ethTXBackpresEvents, modemACMmodulationMin=modemACMmodulationMin, safip=safip, ethQOSTXFrames=ethQOSTXFrames, radioLoopback=radioLoopback, modemInternalAGCgain=modemInternalAGCgain, loopback_tributary_mask=loopback_tributary_mask, atpcEnabled=atpcEnabled, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemEthernetCapacity=modemEthernetCapacity, license=license, modemErroredBlock=modemErroredBlock, ethTXByteCounterLow=ethTXByteCounterLow, remoteIp=remoteIp, vlansEnabled=vlansEnabled, ethTXCRCErrors=ethTXCRCErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethQOSTXDropped=ethQOSTXDropped, ethGFPCHECErrors=ethGFPCHECErrors, modemBandwith=modemBandwith, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXDones=ethTXDones, ethRXControlFrames=ethRXControlFrames, aTPCTable=aTPCTable, ipRadioCfgNetwork=ipRadioCfgNetwork, sysDateAndTime=sysDateAndTime, localIp=localIp, modemACMtotalCapacity=modemACMtotalCapacity, ethTXMulticasts=ethTXMulticasts, writeConfig=writeConfig, ethRXDones=ethRXDones, modemSymbolRateTx=modemSymbolRateTx, ethGFPDelineationErrors=ethGFPDelineationErrors, radioEntry=radioEntry, ethQOSRXQ2Frames=ethQOSRXQ2Frames, e1t1ChannelNr=e1t1ChannelNr, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXByteCounterLow=ethRXByteCounterLow, ethRXMulticasts=ethRXMulticasts, ethRXCRCErrors=ethRXCRCErrors, radioTxFrequency=radioTxFrequency, modemUptime=modemUptime, ipRadioStat=ipRadioStat, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemModulation=modemModulation, e1t1StatTable=e1t1StatTable, ethTXWireByteCounterLow=ethTXWireByteCounterLow, e1t1LOS=e1t1LOS, modemLastAcqError=modemLastAcqError, restartcpu=restartcpu, modemTotalCapacity=modemTotalCapacity, modemRadialMSE=modemRadialMSE, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXVlanTags=ethTXVlanTags, modemUnavailtime=modemUnavailtime, localIpMask=localIpMask, e1t1AIS=e1t1AIS, vlanPortmap=vlanPortmap, vlanTable=vlanTable)
