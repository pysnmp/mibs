...
mibBuilder.exportSymbols("SAF-IPRADIO", tehnika=tehnika, ethQOSTXDropped=ethQOSTXDropped, modemRadialMSE=modemRadialMSE, aTPCTable=aTPCTable, modemStandard=modemStandard, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemSymbolRateRx=modemSymbolRateRx, saf=saf, writeConfig=writeConfig, hostname=hostname, ethRXByteCounterHi=ethRXByteCounterHi, atpcEnabled=atpcEnabled, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXPauseFrames=ethTXPauseFrames, radioGenStatus=radioGenStatus, e1t1ChannelNr=e1t1ChannelNr, ethRXBroadcasts=ethRXBroadcasts, ethRXMulticasts=ethRXMulticasts, ethQOSRXQ2Frames=ethQOSRXQ2Frames, sysDateAndTime=sysDateAndTime, modemRowStatus=modemRowStatus, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXGiants=ethTXGiants, ethRXDones=ethRXDones, ethRXTruncatedFrames=ethRXTruncatedFrames, loopbacks=loopbacks, e1t1LOS=e1t1LOS, e1t1StatEntry=e1t1StatEntry, modemE1T1ChannelMask=modemE1T1ChannelMask, modemACMtotalCapacity=modemACMtotalCapacity, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlanPortmap=vlanPortmap, ethTXBroadcasts=ethTXBroadcasts, modemTotalCapacity=modemTotalCapacity, radioIndex=radioIndex, vlanRowStatus=vlanRowStatus, modemAcqStatus=modemAcqStatus, e1t1StatTable=e1t1StatTable, licenseMask=licenseMask, vlanCfgStat=vlanCfgStat, aTPCEntry=aTPCEntry, modemCountTime=modemCountTime, modemStatistics=modemStatistics, loopback_tributary_mask=loopback_tributary_mask, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ipRadioCfg=ipRadioCfg, ethRXDribleNibbles=ethRXDribleNibbles, modemSymbolRateTx=modemSymbolRateTx, ethTXByteCounterLow=ethTXByteCounterLow, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, licenseUpdateStatus=licenseUpdateStatus, modemACMmodulationMin=modemACMmodulationMin, ethRXPrevPktDropped=ethRXPrevPktDropped, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXExcessiveDefers=ethTXExcessiveDefers, localIp=localIp, modemBandwith=modemBandwith, modemErroredBlock=modemErroredBlock, pointToPoint=pointToPoint, modemEthernetCapacity=modemEthernetCapacity, modemErroredSecond=modemErroredSecond, product=product, radioRxLevel=radioRxLevel, ethRXDvEvent=ethRXDvEvent, ethTXLateCollisions=ethTXLateCollisions, ipRadioStat=ipRadioStat, vlanTable=vlanTable, radioTxPower=radioTxPower, ethGFPCHECErrors=ethGFPCHECErrors, ethGFPDropedFrames=ethGFPDropedFrames, ipRadioMgmt=ipRadioMgmt, ethRXPauseFrames=ethRXPauseFrames, modemE1T1Channels=modemE1T1Channels, e1t1AIS=e1t1AIS, restartcpu=restartcpu, modemTotalBlockNumber=modemTotalBlockNumber, radioTable=radioTable, atpcIndex=atpcIndex, ethTXMulticasts=ethTXMulticasts, modemACMethernetCapacity=modemACMethernetCapacity, ethRXCRCErrors=ethRXCRCErrors, ethTXBackpresEvents=ethTXBackpresEvents, microwaveRadio=microwaveRadio, ethGFPFCSErrors=ethGFPFCSErrors, radioTxMute=radioTxMute, ethTXCollisions=ethTXCollisions, modemIndex=modemIndex, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioRxFrequency=radioRxFrequency, radioEntry=radioEntry, modemACMmodulationMax=modemACMmodulationMax, modemUptime=modemUptime, modemLDPCdecoderStress=modemLDPCdecoderStress, modemModulation=modemModulation, vlanNumber=vlanNumber, description=description, modemCarrierOffset=modemCarrierOffset, ethTXUnderruns=ethTXUnderruns, modemTable=modemTable, modemACMengine=modemACMengine, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXCodeErrors=ethRXCodeErrors, ethTXMaxCollisions=ethTXMaxCollisions, vlanEntry=vlanEntry, ethTXControlFrames=ethTXControlFrames, modemLastAcqError=modemLastAcqError, vlanFid=vlanFid, ethTXDones=ethTXDones, modemErroredSecondRatio=modemErroredSecondRatio, modemUnavailtime=modemUnavailtime, ethRXByteCounterLow=ethRXByteCounterLow, ethTXByteCounterHi=ethTXByteCounterHi, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemInternalAGCgain=modemInternalAGCgain, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, localIpMask=localIpMask, ipRadioStatEth=ipRadioStatEth, radioLoopback=radioLoopback, ethTXCRCErrors=ethTXCRCErrors, ethTXVlanTags=ethTXVlanTags, modemGeneralStatus=modemGeneralStatus, modemEntry=modemEntry, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, vlansEnabled=vlansEnabled, radioDuplexShift=radioDuplexShift, remoteIp=remoteIp, radioSide=radioSide, ethQOSTXFrames=ethQOSTXFrames, ethRXControlFrames=ethRXControlFrames, radioTxFrequency=radioTxFrequency, ethRXLongEvents=ethRXLongEvents, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ipRadio=ipRadio, license=license, modemSeverelyErroredSecond=modemSeverelyErroredSecond, vlanPortType=vlanPortType, ethTXLengthCheckErrors=ethTXLengthCheckErrors, safip=safip, sysTemperature=sysTemperature)
