...
mibBuilder.exportSymbols("SAF-IPRADIO", modemUptime=modemUptime, ethTXBroadcasts=ethTXBroadcasts, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ipRadioCfg=ipRadioCfg, vlanCfgStat=vlanCfgStat, localIpMask=localIpMask, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemCountTime=modemCountTime, aTPCEntry=aTPCEntry, ethTXPauseFrames=ethTXPauseFrames, ipRadioCfgNetwork=ipRadioCfgNetwork, vlanNumber=vlanNumber, vlanEntry=vlanEntry, modemRadialMSE=modemRadialMSE, modemStandard=modemStandard, modemSymbolRateTx=modemSymbolRateTx, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXWireByteCounterHi=ethTXWireByteCounterHi, vlansEnabled=vlansEnabled, radioTxFrequency=radioTxFrequency, aTPCTable=aTPCTable, modemTotalCapacity=modemTotalCapacity, license=license, ethRXDones=ethRXDones, modemInternalAGCgain=modemInternalAGCgain, modemStatistics=modemStatistics, radioDuplexShift=radioDuplexShift, modemGeneralStatus=modemGeneralStatus, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemErroredBlock=modemErroredBlock, e1t1StatTable=e1t1StatTable, ethTXGiants=ethTXGiants, modemSeverelyErroredSecond=modemSeverelyErroredSecond, vlanFid=vlanFid, ethRXLongEvents=ethRXLongEvents, tehnika=tehnika, ethRXByteCounterHi=ethRXByteCounterHi, e1t1StatEntry=e1t1StatEntry, ethTXLateCollisions=ethTXLateCollisions, ethTXMulticasts=ethTXMulticasts, ipRadio=ipRadio, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, e1t1LOS=e1t1LOS, modemCarrierOffset=modemCarrierOffset, licenseUpdateStatus=licenseUpdateStatus, ethTXCRCErrors=ethTXCRCErrors, modemTotalBlockNumber=modemTotalBlockNumber, modemACMengine=modemACMengine, ethTXByteCounterHi=ethTXByteCounterHi, ipRadioMgmt=ipRadioMgmt, radioTable=radioTable, remoteIp=remoteIp, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXTruncatedFrames=ethRXTruncatedFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethGFPCHECErrors=ethGFPCHECErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethQOSTXDropped=ethQOSTXDropped, ethRXPrevPktDropped=ethRXPrevPktDropped, radioSide=radioSide, ethTXControlFrames=ethTXControlFrames, radioRxLevel=radioRxLevel, localIp=localIp, safip=safip, modemEntry=modemEntry, modemE1T1Channels=modemE1T1Channels, ethRXMulticasts=ethRXMulticasts, modemACMmodulationMin=modemACMmodulationMin, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXControlFrames=ethRXControlFrames, restartcpu=restartcpu, ethRXByteCounterLow=ethRXByteCounterLow, modemEthernetCapacity=modemEthernetCapacity, pointToPoint=pointToPoint, ethGFPFCSErrors=ethGFPFCSErrors, modemACMmodulationMax=modemACMmodulationMax, ethRXDvEvent=ethRXDvEvent, ipRadioCfgGeneral=ipRadioCfgGeneral, atpcIndex=atpcIndex, modemRowStatus=modemRowStatus, e1t1ChannelNr=e1t1ChannelNr, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXVlanTags=ethTXVlanTags, vlanPortType=vlanPortType, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXCodeErrors=ethRXCodeErrors, radioEntry=radioEntry, modemACMtotalCapacity=modemACMtotalCapacity, radioTxMute=radioTxMute, modemAcqStatus=modemAcqStatus, e1t1AIS=e1t1AIS, radioIndex=radioIndex, ipRadioStat=ipRadioStat, modemLDPCdecoderStress=modemLDPCdecoderStress, hostname=hostname, loopbacks=loopbacks, modemModulation=modemModulation, product=product, modemIndex=modemIndex, ethTXDones=ethTXDones, ethTXByteCounterLow=ethTXByteCounterLow, modemACMethernetCapacity=modemACMethernetCapacity, vlanPortmap=vlanPortmap, saf=saf, loopback_tributary_mask=loopback_tributary_mask, description=description, ethTXMaxCollisions=ethTXMaxCollisions, modemUnavailtime=modemUnavailtime, radioTxPower=radioTxPower, ethQOSTXFrames=ethQOSTXFrames, atpcEnabled=atpcEnabled, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemTable=modemTable, writeConfig=writeConfig, ethTXUnderruns=ethTXUnderruns, radioRxFrequency=radioRxFrequency, modemBandwith=modemBandwith, ethTXBackpresEvents=ethTXBackpresEvents, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXCollisions=ethTXCollisions, radioLoopback=radioLoopback, ethRXCRCErrors=ethRXCRCErrors, ethGFPDropedFrames=ethGFPDropedFrames, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ipRadioStatEth=ipRadioStatEth, microwaveRadio=microwaveRadio, ethQOSRXQ2Frames=ethQOSRXQ2Frames, sysTemperature=sysTemperature, modemLastAcqError=modemLastAcqError, ethRXBroadcasts=ethRXBroadcasts, licenseMask=licenseMask, modemErroredSecondRatio=modemErroredSecondRatio, vlanTable=vlanTable, modemSymbolRateRx=modemSymbolRateRx, ethTXWireByteCounterLow=ethTXWireByteCounterLow, vlanRowStatus=vlanRowStatus, ethRXDribleNibbles=ethRXDribleNibbles, sysDateAndTime=sysDateAndTime, radioGenStatus=radioGenStatus, modemErroredSecond=modemErroredSecond, ethRXPauseFrames=ethRXPauseFrames)
