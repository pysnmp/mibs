...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXCRCErrors=ethTXCRCErrors, atpcTxPowerCorrection=atpcTxPowerCorrection, ethQOSTXDropped=ethQOSTXDropped, modemEthernetCapacity=modemEthernetCapacity, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXMulticasts=ethTXMulticasts, modemACMmodulationMin=modemACMmodulationMin, vlanRowStatus=vlanRowStatus, atpcIndex=atpcIndex, radioSide=radioSide, description=description, ipRadioStat=ipRadioStat, ethGFPCHECErrors=ethGFPCHECErrors, radioDuplexShift=radioDuplexShift, radioRxFrequency=radioRxFrequency, vlanFid=vlanFid, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, product=product, vlanCfgStat=vlanCfgStat, ethRXLongEvents=ethRXLongEvents, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, localIpMask=localIpMask, ethRXByteCounterHi=ethRXByteCounterHi, radioIndex=radioIndex, loopback_tributary_mask=loopback_tributary_mask, radioTable=radioTable, localIp=localIp, modemRowStatus=modemRowStatus, ethTXLateCollisions=ethTXLateCollisions, modemCarrierOffset=modemCarrierOffset, radioEntry=radioEntry, modemStatistics=modemStatistics, ethTXBackpresEvents=ethTXBackpresEvents, modemSymbolRateTx=modemSymbolRateTx, modemE1T1Channels=modemE1T1Channels, ipRadioCfg=ipRadioCfg, ipRadioMgmt=ipRadioMgmt, ethQOSTXFrames=ethQOSTXFrames, ethTXLengthCheckErrors=ethTXLengthCheckErrors, sysDateAndTime=sysDateAndTime, ipRadio=ipRadio, modemSymbolRateRx=modemSymbolRateRx, modemBandwith=modemBandwith, ethGFPDelineationErrors=ethGFPDelineationErrors, modemStandard=modemStandard, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, microwaveRadio=microwaveRadio, ethRXControlFrames=ethRXControlFrames, modemEntry=modemEntry, ethTXDones=ethTXDones, vlanTable=vlanTable, ethGFPDropedFrames=ethGFPDropedFrames, modemACMmodulationMax=modemACMmodulationMax, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXMulticasts=ethRXMulticasts, modemTable=modemTable, modemACMengine=modemACMengine, radioTxMute=radioTxMute, vlanNumber=vlanNumber, ethRXDones=ethRXDones, radioGenStatus=radioGenStatus, e1t1LOS=e1t1LOS, modemErroredSecond=modemErroredSecond, ipRadioStatEth=ipRadioStatEth, licenseUpdateStatus=licenseUpdateStatus, radioRxLevel=radioRxLevel, radioLoopback=radioLoopback, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXUnderruns=ethTXUnderruns, remoteIp=remoteIp, atpcEnabled=atpcEnabled, tehnika=tehnika, ipRadioCfgNetwork=ipRadioCfgNetwork, ipRadioCfgGeneral=ipRadioCfgGeneral, modemErroredSecondRatio=modemErroredSecondRatio, hostname=hostname, restartcpu=restartcpu, radioTxFrequency=radioTxFrequency, ethTXBroadcasts=ethTXBroadcasts, safip=safip, ethTXControlFrames=ethTXControlFrames, vlanPortType=vlanPortType, ethTXVlanTags=ethTXVlanTags, ethTXByteCounterHi=ethTXByteCounterHi, ethTXMaxCollisions=ethTXMaxCollisions, modemE1T1ChannelMask=modemE1T1ChannelMask, modemGeneralStatus=modemGeneralStatus, modemAcqStatus=modemAcqStatus, ethRXBroadcasts=ethRXBroadcasts, ethTXWireByteCounterLow=ethTXWireByteCounterLow, e1t1StatEntry=e1t1StatEntry, modemLastAcqError=modemLastAcqError, ethTXByteCounterLow=ethTXByteCounterLow, ethTXExcessiveDefers=ethTXExcessiveDefers, modemLDPCdecoderStress=modemLDPCdecoderStress, modemBackgroundBlockErrror=modemBackgroundBlockErrror, aTPCEntry=aTPCEntry, modemIndex=modemIndex, modemModulation=modemModulation, ethTXPauseFrames=ethTXPauseFrames, e1t1ChannelNr=e1t1ChannelNr, ethRXByteCounterLow=ethRXByteCounterLow, radioTxPower=radioTxPower, ethTXWireByteCounterHi=ethTXWireByteCounterHi, e1t1AIS=e1t1AIS, ethRXDribleNibbles=ethRXDribleNibbles, modemErroredBlock=modemErroredBlock, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemACMtotalCapacity=modemACMtotalCapacity, ethRXCodeErrors=ethRXCodeErrors, modemCountTime=modemCountTime, ethRXDvEvent=ethRXDvEvent, ethTXGiants=ethTXGiants, saf=saf, modemTotalBlockNumber=modemTotalBlockNumber, sysTemperature=sysTemperature, modemInternalAGCgain=modemInternalAGCgain, modemUptime=modemUptime, modemUnavailtime=modemUnavailtime, vlanPortmap=vlanPortmap, ethRXPrevPktDropped=ethRXPrevPktDropped, license=license, ethRXCRCErrors=ethRXCRCErrors, writeConfig=writeConfig, ethTXCollisions=ethTXCollisions, modemTotalCapacity=modemTotalCapacity, pointToPoint=pointToPoint, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, loopbacks=loopbacks, e1t1StatTable=e1t1StatTable, aTPCTable=aTPCTable, vlansEnabled=vlansEnabled, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemACMethernetCapacity=modemACMethernetCapacity, modemRadialMSE=modemRadialMSE, licenseMask=licenseMask, ethGFPFCSErrors=ethGFPFCSErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXPauseFrames=ethRXPauseFrames, vlanEntry=vlanEntry)
