...
mibBuilder.exportSymbols("SAF-IPRADIO", modemSeverelyErroredSecond=modemSeverelyErroredSecond, vlanTable=vlanTable, modemACMethernetCapacity=modemACMethernetCapacity, ethTXCollisions=ethTXCollisions, modemErroredSecond=modemErroredSecond, aTPCEntry=aTPCEntry, modemE1T1ChannelMask=modemE1T1ChannelMask, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ipRadioCfgGeneral=ipRadioCfgGeneral, radioDuplexShift=radioDuplexShift, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXCRCErrors=ethTXCRCErrors, ethTXGiants=ethTXGiants, ethTXMulticasts=ethTXMulticasts, loopback_tributary_mask=loopback_tributary_mask, modemModulation=modemModulation, ethTXWireByteCounterHi=ethTXWireByteCounterHi, vlanPortmap=vlanPortmap, tehnika=tehnika, sysDateAndTime=sysDateAndTime, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, vlanNumber=vlanNumber, vlanEntry=vlanEntry, writeConfig=writeConfig, e1t1AIS=e1t1AIS, modemEntry=modemEntry, modemRadialMSE=modemRadialMSE, modemACMmodulationMax=modemACMmodulationMax, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXCRCErrors=ethRXCRCErrors, modemStatistics=modemStatistics, aTPCTable=aTPCTable, modemACMengine=modemACMengine, ethRXDvEvent=ethRXDvEvent, modemACMmodulationMin=modemACMmodulationMin, ethRXDones=ethRXDones, ethGFPFCSErrors=ethGFPFCSErrors, localIpMask=localIpMask, ethRXPauseFrames=ethRXPauseFrames, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ipRadioMgmt=ipRadioMgmt, modemAcqStatus=modemAcqStatus, ethTXByteCounterHi=ethTXByteCounterHi, radioTxFrequency=radioTxFrequency, ethRXMulticasts=ethRXMulticasts, modemGeneralStatus=modemGeneralStatus, modemBandwith=modemBandwith, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ipRadioStatEth=ipRadioStatEth, modemLastAcqError=modemLastAcqError, ethRXControlFrames=ethRXControlFrames, ethTXLateCollisions=ethTXLateCollisions, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethQOSTXFrames=ethQOSTXFrames, license=license, ethRXBroadcasts=ethRXBroadcasts, safip=safip, ethRXByteCounterHi=ethRXByteCounterHi, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemSymbolRateRx=modemSymbolRateRx, modemTable=modemTable, ethTXByteCounterLow=ethTXByteCounterLow, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemUptime=modemUptime, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemStandard=modemStandard, e1t1LOS=e1t1LOS, ethRXLongEvents=ethRXLongEvents, ethTXControlFrames=ethTXControlFrames, licenseUpdateStatus=licenseUpdateStatus, radioTxPower=radioTxPower, radioIndex=radioIndex, vlanCfgStat=vlanCfgStat, licenseMask=licenseMask, vlanRowStatus=vlanRowStatus, vlanPortType=vlanPortType, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXCodeErrors=ethRXCodeErrors, e1t1ChannelNr=e1t1ChannelNr, modemTotalBlockNumber=modemTotalBlockNumber, ipRadioCfg=ipRadioCfg, product=product, modemSymbolRateTx=modemSymbolRateTx, ethTXDones=ethTXDones, radioTable=radioTable, loopbacks=loopbacks, modemTotalCapacity=modemTotalCapacity, ethTXVlanTags=ethTXVlanTags, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXDribleNibbles=ethRXDribleNibbles, remoteIp=remoteIp, vlansEnabled=vlansEnabled, modemACMtotalCapacity=modemACMtotalCapacity, modemErroredBlock=modemErroredBlock, radioLoopback=radioLoopback, modemE1T1Channels=modemE1T1Channels, modemRowStatus=modemRowStatus, sysTemperature=sysTemperature, ethRXByteCounterLow=ethRXByteCounterLow, ethRXTruncatedFrames=ethRXTruncatedFrames, modemLDPCdecoderStress=modemLDPCdecoderStress, description=description, ethTXPauseFrames=ethTXPauseFrames, ethRXPrevPktDropped=ethRXPrevPktDropped, modemIndex=modemIndex, ethTXMaxCollisions=ethTXMaxCollisions, pointToPoint=pointToPoint, ipRadioCfgNetwork=ipRadioCfgNetwork, saf=saf, modemCarrierOffset=modemCarrierOffset, microwaveRadio=microwaveRadio, vlanFid=vlanFid, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethQOSTXDropped=ethQOSTXDropped, modemEthernetCapacity=modemEthernetCapacity, e1t1StatEntry=e1t1StatEntry, localIp=localIp, modemUnavailtime=modemUnavailtime, radioRxFrequency=radioRxFrequency, ethQOSRXQ1Frames=ethQOSRXQ1Frames, hostname=hostname, modemErroredSecondRatio=modemErroredSecondRatio, atpcIndex=atpcIndex, radioSide=radioSide, radioGenStatus=radioGenStatus, ethTXUnderruns=ethTXUnderruns, ethGFPCHECErrors=ethGFPCHECErrors, radioTxMute=radioTxMute, atpcEnabled=atpcEnabled, modemCountTime=modemCountTime, modemInternalAGCgain=modemInternalAGCgain, ethGFPDropedFrames=ethGFPDropedFrames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXBackpresEvents=ethTXBackpresEvents, ipRadioStat=ipRadioStat, ipRadio=ipRadio, radioEntry=radioEntry, radioRxLevel=radioRxLevel, ethTXBroadcasts=ethTXBroadcasts, restartcpu=restartcpu, e1t1StatTable=e1t1StatTable)
