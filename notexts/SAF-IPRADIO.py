...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXUnderruns=ethTXUnderruns, ethTXPauseFrames=ethTXPauseFrames, modemSymbolRateRx=modemSymbolRateRx, loopback_tributary_mask=loopback_tributary_mask, modemErroredBlock=modemErroredBlock, ethRXLongEvents=ethRXLongEvents, modemCarrierOffset=modemCarrierOffset, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXExcessiveDefers=ethTXExcessiveDefers, ethGFPDropedFrames=ethGFPDropedFrames, vlanPortmap=vlanPortmap, modemACMethernetCapacity=modemACMethernetCapacity, ethTXCRCErrors=ethTXCRCErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioLoopback=radioLoopback, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemErroredSecond=modemErroredSecond, e1t1StatEntry=e1t1StatEntry, microwaveRadio=microwaveRadio, ethRXMulticasts=ethRXMulticasts, pointToPoint=pointToPoint, modemE1T1ChannelMask=modemE1T1ChannelMask, writeConfig=writeConfig, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXDones=ethTXDones, modemACMengine=modemACMengine, aTPCTable=aTPCTable, licenseMask=licenseMask, ipRadio=ipRadio, ethGFPDelineationErrors=ethGFPDelineationErrors, e1t1LOS=e1t1LOS, ipRadioCfg=ipRadioCfg, radioRxFrequency=radioRxFrequency, modemTable=modemTable, ethRXDvEvent=ethRXDvEvent, modemErroredSecondRatio=modemErroredSecondRatio, ipRadioCfgGeneral=ipRadioCfgGeneral, product=product, ethRXPrevPktDropped=ethRXPrevPktDropped, modemTotalBlockNumber=modemTotalBlockNumber, radioGenStatus=radioGenStatus, ethRXCodeErrors=ethRXCodeErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXCollisions=ethTXCollisions, ethQOSTXFrames=ethQOSTXFrames, modemACMtotalCapacity=modemACMtotalCapacity, radioRxLevel=radioRxLevel, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemSymbolRateTx=modemSymbolRateTx, modemSeverelyErroredSecond=modemSeverelyErroredSecond, vlansEnabled=vlansEnabled, modemTotalCapacity=modemTotalCapacity, ipRadioStatEth=ipRadioStatEth, radioIndex=radioIndex, ethTXBackpresEvents=ethTXBackpresEvents, localIp=localIp, modemLastAcqError=modemLastAcqError, ethRXBroadcasts=ethRXBroadcasts, modemUptime=modemUptime, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemIndex=modemIndex, ethRXByteCounterLow=ethRXByteCounterLow, sysDateAndTime=sysDateAndTime, modemStatistics=modemStatistics, modemBandwith=modemBandwith, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, vlanTable=vlanTable, radioTxFrequency=radioTxFrequency, restartcpu=restartcpu, ethTXGiants=ethTXGiants, ethRXCRCErrors=ethRXCRCErrors, saf=saf, radioTxPower=radioTxPower, vlanEntry=vlanEntry, aTPCEntry=aTPCEntry, description=description, radioTable=radioTable, vlanCfgStat=vlanCfgStat, ipRadioCfgNetwork=ipRadioCfgNetwork, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, localIpMask=localIpMask, modemACMmodulationMin=modemACMmodulationMin, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXBroadcasts=ethTXBroadcasts, atpcIndex=atpcIndex, modemACMmodulationMax=modemACMmodulationMax, modemRadialMSE=modemRadialMSE, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioSide=radioSide, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemInternalAGCgain=modemInternalAGCgain, modemE1T1Channels=modemE1T1Channels, modemRowStatus=modemRowStatus, radioTxMute=radioTxMute, vlanFid=vlanFid, ethTXVlanTags=ethTXVlanTags, license=license, ethRXByteCounterHi=ethRXByteCounterHi, ipRadioStat=ipRadioStat, modemStandard=modemStandard, ethQOSTXDropped=ethQOSTXDropped, ethRXControlFrames=ethRXControlFrames, ethTXMulticasts=ethTXMulticasts, tehnika=tehnika, vlanRowStatus=vlanRowStatus, licenseUpdateStatus=licenseUpdateStatus, hostname=hostname, ethGFPCHECErrors=ethGFPCHECErrors, sysTemperature=sysTemperature, e1t1ChannelNr=e1t1ChannelNr, radioDuplexShift=radioDuplexShift, loopbacks=loopbacks, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXByteCounterHi=ethTXByteCounterHi, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXLateCollisions=ethTXLateCollisions, e1t1AIS=e1t1AIS, radioEntry=radioEntry, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXMaxCollisions=ethTXMaxCollisions, atpcEnabled=atpcEnabled, ethGFPFCSErrors=ethGFPFCSErrors, modemAcqStatus=modemAcqStatus, ethTXControlFrames=ethTXControlFrames, ipRadioMgmt=ipRadioMgmt, vlanNumber=vlanNumber, modemCountTime=modemCountTime, safip=safip, modemModulation=modemModulation, remoteIp=remoteIp, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXDones=ethRXDones, modemUnavailtime=modemUnavailtime, ethRXDribleNibbles=ethRXDribleNibbles, modemEntry=modemEntry, modemGeneralStatus=modemGeneralStatus, ethRXPauseFrames=ethRXPauseFrames, e1t1StatTable=e1t1StatTable, ethTXByteCounterLow=ethTXByteCounterLow, modemEthernetCapacity=modemEthernetCapacity, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlanPortType=vlanPortType, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors)
