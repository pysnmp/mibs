...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXWireByteCounterLow=ethTXWireByteCounterLow, vlanCfgStat=vlanCfgStat, modemRowStatus=modemRowStatus, atpcIndex=atpcIndex, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemErroredBlock=modemErroredBlock, sysDateAndTime=sysDateAndTime, ethTXLengthCheckErrors=ethTXLengthCheckErrors, safip=safip, modemACMmodulationMax=modemACMmodulationMax, radioRxLevel=radioRxLevel, ethTXPauseFrames=ethTXPauseFrames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemStandard=modemStandard, microwaveRadio=microwaveRadio, modemErroredSecondRatio=modemErroredSecondRatio, hostname=hostname, ethTXVlanTags=ethTXVlanTags, ethRXControlFrames=ethRXControlFrames, radioDuplexShift=radioDuplexShift, modemACMengine=modemACMengine, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXBroadcasts=ethRXBroadcasts, writeConfig=writeConfig, ethTXByteCounterHi=ethTXByteCounterHi, ethRXByteCounterLow=ethRXByteCounterLow, e1t1LOS=e1t1LOS, modemTotalCapacity=modemTotalCapacity, modemACMethernetCapacity=modemACMethernetCapacity, ipRadioCfgGeneral=ipRadioCfgGeneral, radioSide=radioSide, restartcpu=restartcpu, ethRXLongEvents=ethRXLongEvents, ethRXUnsupOpcodes=ethRXUnsupOpcodes, vlanFid=vlanFid, e1t1AIS=e1t1AIS, ethTXUnderruns=ethTXUnderruns, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXGiants=ethTXGiants, ethGFPFCSErrors=ethGFPFCSErrors, license=license, ethTXMaxCollisions=ethTXMaxCollisions, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXDones=ethRXDones, ethRXCRCErrors=ethRXCRCErrors, ethTXCollisions=ethTXCollisions, modemLDPCdecoderStress=modemLDPCdecoderStress, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXMulticasts=ethTXMulticasts, e1t1ChannelNr=e1t1ChannelNr, modemEthernetCapacity=modemEthernetCapacity, modemIndex=modemIndex, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemInternalAGCgain=modemInternalAGCgain, vlanTable=vlanTable, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, vlanPortmap=vlanPortmap, ethRXDvEvent=ethRXDvEvent, modemUnavailtime=modemUnavailtime, radioGenStatus=radioGenStatus, radioLoopback=radioLoopback, saf=saf, modemStatistics=modemStatistics, loopbacks=loopbacks, ethRXCodeErrors=ethRXCodeErrors, ethTXBackpresEvents=ethTXBackpresEvents, modemUptime=modemUptime, modemEntry=modemEntry, ipRadioCfg=ipRadioCfg, modemGeneralStatus=modemGeneralStatus, radioRxFrequency=radioRxFrequency, ethTXControlFrames=ethTXControlFrames, ethTXBroadcasts=ethTXBroadcasts, ipRadioStatEth=ipRadioStatEth, atpcTxPowerCorrection=atpcTxPowerCorrection, vlanPortType=vlanPortType, localIp=localIp, ethTXDones=ethTXDones, modemRadialMSE=modemRadialMSE, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXMulticasts=ethRXMulticasts, vlanEntry=vlanEntry, ipRadioMgmt=ipRadioMgmt, tehnika=tehnika, vlansEnabled=vlansEnabled, description=description, ethGFPCHECErrors=ethGFPCHECErrors, radioTable=radioTable, ethRXPauseFrames=ethRXPauseFrames, localIpMask=localIpMask, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemCarrierOffset=modemCarrierOffset, ethQOSTXDropped=ethQOSTXDropped, vlanNumber=vlanNumber, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemLastAcqError=modemLastAcqError, modemErroredSecond=modemErroredSecond, ipRadioCfgNetwork=ipRadioCfgNetwork, ipRadio=ipRadio, remoteIp=remoteIp, ipRadioStat=ipRadioStat, atpcEnabled=atpcEnabled, modemSymbolRateTx=modemSymbolRateTx, modemACMtotalCapacity=modemACMtotalCapacity, vlanRowStatus=vlanRowStatus, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXDribleNibbles=ethRXDribleNibbles, ethTXExcessiveDefers=ethTXExcessiveDefers, ethGFPDropedFrames=ethGFPDropedFrames, modemCountTime=modemCountTime, e1t1StatTable=e1t1StatTable, radioIndex=radioIndex, loopback_tributary_mask=loopback_tributary_mask, pointToPoint=pointToPoint, aTPCEntry=aTPCEntry, ethQOSTXFrames=ethQOSTXFrames, modemBandwith=modemBandwith, modemAcqStatus=modemAcqStatus, radioEntry=radioEntry, modemModulation=modemModulation, licenseUpdateStatus=licenseUpdateStatus, radioTxFrequency=radioTxFrequency, modemTotalBlockNumber=modemTotalBlockNumber, ethRXByteCounterHi=ethRXByteCounterHi, modemACMmodulationMin=modemACMmodulationMin, ethTXCRCErrors=ethTXCRCErrors, aTPCTable=aTPCTable, licenseMask=licenseMask, ethTXByteCounterLow=ethTXByteCounterLow, ethTXLateCollisions=ethTXLateCollisions, ethGFPDelineationErrors=ethGFPDelineationErrors, product=product, sysTemperature=sysTemperature, modemTable=modemTable, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemE1T1Channels=modemE1T1Channels, radioTxPower=radioTxPower, e1t1StatEntry=e1t1StatEntry, radioTxMute=radioTxMute, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemSymbolRateRx=modemSymbolRateRx)
