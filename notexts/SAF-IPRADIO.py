...
mibBuilder.exportSymbols("SAF-IPRADIO", modemRadialMSE=modemRadialMSE, ethRXByteCounterHi=ethRXByteCounterHi, ethTXGiants=ethTXGiants, ethRXMulticasts=ethRXMulticasts, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemTotalCapacity=modemTotalCapacity, ethTXByteCounterLow=ethTXByteCounterLow, modemErroredSecondRatio=modemErroredSecondRatio, ethGFPFCSErrors=ethGFPFCSErrors, loopbacks=loopbacks, hostname=hostname, vlanRowStatus=vlanRowStatus, vlansEnabled=vlansEnabled, radioTable=radioTable, modemSymbolRateTx=modemSymbolRateTx, ethTXMaxCollisions=ethTXMaxCollisions, modemErroredBlock=modemErroredBlock, ethTXMulticasts=ethTXMulticasts, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXControlFrames=ethTXControlFrames, vlanEntry=vlanEntry, modemEthernetCapacity=modemEthernetCapacity, ethTXLateCollisions=ethTXLateCollisions, modemACMethernetCapacity=modemACMethernetCapacity, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemTable=modemTable, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemE1T1Channels=modemE1T1Channels, modemCarrierOffset=modemCarrierOffset, atpcIndex=atpcIndex, modemACMengine=modemACMengine, radioRxLevel=radioRxLevel, ethQOSRXQ2Frames=ethQOSRXQ2Frames, atpcEnabled=atpcEnabled, modemACMmodulationMin=modemACMmodulationMin, modemGeneralStatus=modemGeneralStatus, safip=safip, ipRadioStat=ipRadioStat, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioTxFrequency=radioTxFrequency, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethGFPCHECErrors=ethGFPCHECErrors, aTPCTable=aTPCTable, ipRadioStatEth=ipRadioStatEth, modemStatistics=modemStatistics, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemStandard=modemStandard, description=description, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemIndex=modemIndex, vlanCfgStat=vlanCfgStat, ethTXUnderruns=ethTXUnderruns, e1t1LOS=e1t1LOS, ethGFPDropedFrames=ethGFPDropedFrames, modemACMtotalCapacity=modemACMtotalCapacity, ethGFPDelineationErrors=ethGFPDelineationErrors, restartcpu=restartcpu, modemUptime=modemUptime, writeConfig=writeConfig, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethQOSTXFrames=ethQOSTXFrames, radioRxFrequency=radioRxFrequency, ethRXCRCErrors=ethRXCRCErrors, e1t1StatEntry=e1t1StatEntry, radioDuplexShift=radioDuplexShift, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ipRadio=ipRadio, ethRXDones=ethRXDones, ethTXBackpresEvents=ethTXBackpresEvents, vlanPortType=vlanPortType, radioTxPower=radioTxPower, vlanFid=vlanFid, ethRXPauseFrames=ethRXPauseFrames, ipRadioCfgGeneral=ipRadioCfgGeneral, radioIndex=radioIndex, ethRXByteCounterLow=ethRXByteCounterLow, ethTXBroadcasts=ethTXBroadcasts, sysTemperature=sysTemperature, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXDribleNibbles=ethRXDribleNibbles, radioTxMute=radioTxMute, vlanPortmap=vlanPortmap, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXLongEvents=ethRXLongEvents, saf=saf, ipRadioMgmt=ipRadioMgmt, localIpMask=localIpMask, modemACMmodulationMax=modemACMmodulationMax, modemModulation=modemModulation, radioGenStatus=radioGenStatus, e1t1StatTable=e1t1StatTable, modemSymbolRateRx=modemSymbolRateRx, aTPCEntry=aTPCEntry, e1t1AIS=e1t1AIS, ethTXDones=ethTXDones, ethRXCodeErrors=ethRXCodeErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, ipRadioCfg=ipRadioCfg, sysDateAndTime=sysDateAndTime, vlanNumber=vlanNumber, radioSide=radioSide, modemTotalBlockNumber=modemTotalBlockNumber, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXCollisions=ethTXCollisions, modemErroredSecond=modemErroredSecond, modemE1T1ChannelMask=modemE1T1ChannelMask, product=product, modemCountTime=modemCountTime, licenseUpdateStatus=licenseUpdateStatus, licenseMask=licenseMask, radioEntry=radioEntry, modemAcqStatus=modemAcqStatus, ethRXPrevPktDropped=ethRXPrevPktDropped, modemEntry=modemEntry, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, vlanTable=vlanTable, ethRXControlFrames=ethRXControlFrames, ethRXDvEvent=ethRXDvEvent, tehnika=tehnika, ethQOSTXDropped=ethQOSTXDropped, ethTXByteCounterHi=ethTXByteCounterHi, atpcTxPowerCorrection=atpcTxPowerCorrection, e1t1ChannelNr=e1t1ChannelNr, modemLDPCdecoderStress=modemLDPCdecoderStress, license=license, ethTXCRCErrors=ethTXCRCErrors, loopback_tributary_mask=loopback_tributary_mask, microwaveRadio=microwaveRadio, radioLoopback=radioLoopback, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemInternalAGCgain=modemInternalAGCgain, modemBandwith=modemBandwith, ethTXVlanTags=ethTXVlanTags, ethTXPauseFrames=ethTXPauseFrames, localIp=localIp, ethRXBroadcasts=ethRXBroadcasts, modemRowStatus=modemRowStatus, modemUnavailtime=modemUnavailtime, pointToPoint=pointToPoint, remoteIp=remoteIp, modemLastAcqError=modemLastAcqError)
