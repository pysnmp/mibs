...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXDribleNibbles=ethRXDribleNibbles, atpcTxPowerCorrection=atpcTxPowerCorrection, modemEthernetCapacity=modemEthernetCapacity, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemUnavailtime=modemUnavailtime, radioRxFrequency=radioRxFrequency, radioLoopback=radioLoopback, ethTXCRCErrors=ethTXCRCErrors, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXPrevPktDropped=ethRXPrevPktDropped, modemAcqStatus=modemAcqStatus, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ipRadioCfg=ipRadioCfg, ethQOSTXFrames=ethQOSTXFrames, ipRadio=ipRadio, modemACMmodulationMin=modemACMmodulationMin, ethTXUnderruns=ethTXUnderruns, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlanTable=vlanTable, radioSide=radioSide, ethRXControlFrames=ethRXControlFrames, modemACMmodulationMax=modemACMmodulationMax, ethTXVlanTags=ethTXVlanTags, ipRadioCfgGeneral=ipRadioCfgGeneral, loopback_tributary_mask=loopback_tributary_mask, modemE1T1Channels=modemE1T1Channels, localIp=localIp, modemACMengine=modemACMengine, radioTxMute=radioTxMute, product=product, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXBackpresEvents=ethTXBackpresEvents, atpcIndex=atpcIndex, ethQOSTXDropped=ethQOSTXDropped, vlanPortType=vlanPortType, tehnika=tehnika, radioRxLevel=radioRxLevel, loopbacks=loopbacks, aTPCEntry=aTPCEntry, ethRXDones=ethRXDones, ethGFPDelineationErrors=ethGFPDelineationErrors, vlanCfgStat=vlanCfgStat, modemLastAcqError=modemLastAcqError, ethRXMulticasts=ethRXMulticasts, modemSeverelyErroredSecond=modemSeverelyErroredSecond, pointToPoint=pointToPoint, modemErroredSecondRatio=modemErroredSecondRatio, e1t1LOS=e1t1LOS, license=license, ethTXLateCollisions=ethTXLateCollisions, licenseMask=licenseMask, vlanEntry=vlanEntry, ethRXCRCErrors=ethRXCRCErrors, ethTXCollisions=ethTXCollisions, ethTXByteCounterHi=ethTXByteCounterHi, radioGenStatus=radioGenStatus, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXDones=ethTXDones, ethTXBroadcasts=ethTXBroadcasts, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXByteCounterLow=ethTXByteCounterLow, ethGFPDropedFrames=ethGFPDropedFrames, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, aTPCTable=aTPCTable, ethRXLongEvents=ethRXLongEvents, modemErroredSecond=modemErroredSecond, modemCarrierOffset=modemCarrierOffset, ethRXVlanTagsDetected=ethRXVlanTagsDetected, vlanRowStatus=vlanRowStatus, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXDvEvent=ethRXDvEvent, ethRXPauseFrames=ethRXPauseFrames, ethTXLengthCheckErrors=ethTXLengthCheckErrors, e1t1AIS=e1t1AIS, e1t1StatEntry=e1t1StatEntry, modemSymbolRateTx=modemSymbolRateTx, localIpMask=localIpMask, radioEntry=radioEntry, ethTXControlFrames=ethTXControlFrames, ethGFPFCSErrors=ethGFPFCSErrors, modemSymbolRateRx=modemSymbolRateRx, licenseUpdateStatus=licenseUpdateStatus, radioTable=radioTable, description=description, modemGeneralStatus=modemGeneralStatus, modemInternalAGCgain=modemInternalAGCgain, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemEntry=modemEntry, ethGFPCHECErrors=ethGFPCHECErrors, vlanFid=vlanFid, ipRadioMgmt=ipRadioMgmt, modemTable=modemTable, sysTemperature=sysTemperature, ethRXByteCounterLow=ethRXByteCounterLow, atpcEnabled=atpcEnabled, modemModulation=modemModulation, radioIndex=radioIndex, saf=saf, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemIndex=modemIndex, vlansEnabled=vlansEnabled, vlanPortmap=vlanPortmap, remoteIp=remoteIp, ethRXByteCounterHi=ethRXByteCounterHi, safip=safip, modemACMethernetCapacity=modemACMethernetCapacity, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXBroadcasts=ethRXBroadcasts, modemErroredBlock=modemErroredBlock, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemRadialMSE=modemRadialMSE, ethTXMaxCollisions=ethTXMaxCollisions, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, microwaveRadio=microwaveRadio, ethTXMulticasts=ethTXMulticasts, vlanNumber=vlanNumber, modemBandwith=modemBandwith, modemStatistics=modemStatistics, e1t1StatTable=e1t1StatTable, ethTXGiants=ethTXGiants, modemCountTime=modemCountTime, ipRadioStatEth=ipRadioStatEth, hostname=hostname, sysDateAndTime=sysDateAndTime, writeConfig=writeConfig, modemRowStatus=modemRowStatus, radioDuplexShift=radioDuplexShift, ethTXPauseFrames=ethTXPauseFrames, radioTxPower=radioTxPower, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXCodeErrors=ethRXCodeErrors, restartcpu=restartcpu, radioTxFrequency=radioTxFrequency, ipRadioStat=ipRadioStat, e1t1ChannelNr=e1t1ChannelNr, modemTotalBlockNumber=modemTotalBlockNumber, modemACMtotalCapacity=modemACMtotalCapacity, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemTotalCapacity=modemTotalCapacity, modemUptime=modemUptime, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemStandard=modemStandard)
