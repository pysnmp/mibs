...
mibBuilder.exportSymbols("SAF-IPRADIO", modemACMethernetCapacity=modemACMethernetCapacity, radioRxFrequency=radioRxFrequency, modemIndex=modemIndex, modemACMtotalCapacity=modemACMtotalCapacity, saf=saf, radioTable=radioTable, safip=safip, ipRadioStatEth=ipRadioStatEth, ethTXDones=ethTXDones, modemCountTime=modemCountTime, ethRXByteCounterHi=ethRXByteCounterHi, aTPCEntry=aTPCEntry, radioIndex=radioIndex, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ipRadioCfgGeneral=ipRadioCfgGeneral, modemCarrierOffset=modemCarrierOffset, modemBandwith=modemBandwith, ethTXPauseFrames=ethTXPauseFrames, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXTruncatedFrames=ethRXTruncatedFrames, sysTemperature=sysTemperature, modemE1T1Channels=modemE1T1Channels, loopback_tributary_mask=loopback_tributary_mask, ethTXByteCounterHi=ethTXByteCounterHi, restartcpu=restartcpu, vlanNumber=vlanNumber, modemErroredSecondRatio=modemErroredSecondRatio, ethRXDribleNibbles=ethRXDribleNibbles, atpcEnabled=atpcEnabled, ethRXLongEvents=ethRXLongEvents, ethGFPDropedFrames=ethGFPDropedFrames, vlanCfgStat=vlanCfgStat, modemEthernetCapacity=modemEthernetCapacity, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, e1t1LOS=e1t1LOS, modemACMmodulationMin=modemACMmodulationMin, vlanFid=vlanFid, e1t1StatTable=e1t1StatTable, sysDateAndTime=sysDateAndTime, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethQOSTXFrames=ethQOSTXFrames, radioRxLevel=radioRxLevel, modemUnavailtime=modemUnavailtime, ipRadioCfg=ipRadioCfg, tehnika=tehnika, modemRowStatus=modemRowStatus, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXCodeErrors=ethRXCodeErrors, writeConfig=writeConfig, e1t1ChannelNr=e1t1ChannelNr, modemGeneralStatus=modemGeneralStatus, ethRXMulticasts=ethRXMulticasts, modemACMengine=modemACMengine, ipRadioStat=ipRadioStat, radioTxPower=radioTxPower, ethRXCRCErrors=ethRXCRCErrors, hostname=hostname, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXVlanTags=ethTXVlanTags, license=license, modemModulation=modemModulation, ethRXControlFrames=ethRXControlFrames, modemTotalBlockNumber=modemTotalBlockNumber, localIp=localIp, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, product=product, microwaveRadio=microwaveRadio, ethTXBroadcasts=ethTXBroadcasts, vlanRowStatus=vlanRowStatus, modemACMmodulationMax=modemACMmodulationMax, radioTxMute=radioTxMute, ethRXDvEvent=ethRXDvEvent, modemStandard=modemStandard, ethGFPDelineationErrors=ethGFPDelineationErrors, vlanPortmap=vlanPortmap, vlansEnabled=vlansEnabled, ethRXDones=ethRXDones, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXPauseFrames=ethRXPauseFrames, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemSymbolRateRx=modemSymbolRateRx, modemE1T1ChannelMask=modemE1T1ChannelMask, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXGiants=ethTXGiants, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemEntry=modemEntry, modemTable=modemTable, pointToPoint=pointToPoint, ipRadioMgmt=ipRadioMgmt, vlanEntry=vlanEntry, description=description, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXPrevPktDropped=ethRXPrevPktDropped, radioGenStatus=radioGenStatus, ethRXByteCounterLow=ethRXByteCounterLow, ethTXMulticasts=ethTXMulticasts, licenseUpdateStatus=licenseUpdateStatus, ethGFPFCSErrors=ethGFPFCSErrors, aTPCTable=aTPCTable, e1t1AIS=e1t1AIS, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemLastAcqError=modemLastAcqError, modemInternalAGCgain=modemInternalAGCgain, ipRadio=ipRadio, vlanTable=vlanTable, ethGFPCHECErrors=ethGFPCHECErrors, ethTXControlFrames=ethTXControlFrames, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, licenseMask=licenseMask, modemSymbolRateTx=modemSymbolRateTx, radioEntry=radioEntry, ethQOSTXDropped=ethQOSTXDropped, ethTXUnderruns=ethTXUnderruns, modemAcqStatus=modemAcqStatus, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXMaxCollisions=ethTXMaxCollisions, atpcIndex=atpcIndex, ethTXExcessiveDefers=ethTXExcessiveDefers, modemErroredSecond=modemErroredSecond, e1t1StatEntry=e1t1StatEntry, localIpMask=localIpMask, ethRXBroadcasts=ethRXBroadcasts, modemErroredBlock=modemErroredBlock, remoteIp=remoteIp, loopbacks=loopbacks, ethTXCollisions=ethTXCollisions, ethTXByteCounterLow=ethTXByteCounterLow, ethTXLateCollisions=ethTXLateCollisions, vlanPortType=vlanPortType, ethTXCRCErrors=ethTXCRCErrors, modemUptime=modemUptime, modemRadialMSE=modemRadialMSE, modemStatistics=modemStatistics, modemTotalCapacity=modemTotalCapacity, radioDuplexShift=radioDuplexShift, radioLoopback=radioLoopback, atpcTxPowerCorrection=atpcTxPowerCorrection, radioSide=radioSide, ethTXBackpresEvents=ethTXBackpresEvents, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioTxFrequency=radioTxFrequency)
