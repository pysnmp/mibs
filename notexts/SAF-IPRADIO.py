...
mibBuilder.exportSymbols("SAF-IPRADIO", modemTotalCapacity=modemTotalCapacity, ethTXMulticasts=ethTXMulticasts, ethGFPCHECErrors=ethGFPCHECErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, hostname=hostname, e1t1StatTable=e1t1StatTable, modemACMmodulationMin=modemACMmodulationMin, modemTable=modemTable, ethQOSTXFrames=ethQOSTXFrames, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXLongEvents=ethRXLongEvents, e1t1StatEntry=e1t1StatEntry, radioGenStatus=radioGenStatus, ipRadioMgmt=ipRadioMgmt, modemE1T1Channels=modemE1T1Channels, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, writeConfig=writeConfig, ethTXWireByteCounterHi=ethTXWireByteCounterHi, aTPCEntry=aTPCEntry, vlanRowStatus=vlanRowStatus, licenseMask=licenseMask, modemACMmodulationMax=modemACMmodulationMax, modemUnavailtime=modemUnavailtime, ethRXMulticasts=ethRXMulticasts, modemACMengine=modemACMengine, modemStandard=modemStandard, ipRadioCfgNetwork=ipRadioCfgNetwork, radioIndex=radioIndex, ethTXWireByteCounterLow=ethTXWireByteCounterLow, localIpMask=localIpMask, modemStatistics=modemStatistics, e1t1LOS=e1t1LOS, modemCountTime=modemCountTime, modemEntry=modemEntry, ethRXDones=ethRXDones, vlanCfgStat=vlanCfgStat, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXControlFrames=ethTXControlFrames, vlanPortType=vlanPortType, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXCollisions=ethTXCollisions, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXByteCounterLow=ethRXByteCounterLow, modemAcqStatus=modemAcqStatus, modemErroredSecondRatio=modemErroredSecondRatio, ethRXByteCounterHi=ethRXByteCounterHi, ethGFPDropedFrames=ethGFPDropedFrames, ethTXLateCollisions=ethTXLateCollisions, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ipRadio=ipRadio, modemErroredBlock=modemErroredBlock, modemBandwith=modemBandwith, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXCRCErrors=ethTXCRCErrors, modemModulation=modemModulation, modemACMtotalCapacity=modemACMtotalCapacity, ethRXTruncatedFrames=ethRXTruncatedFrames, atpcTxPowerCorrection=atpcTxPowerCorrection, radioTxMute=radioTxMute, ethRXControlFrames=ethRXControlFrames, ethRXBroadcasts=ethRXBroadcasts, modemRadialMSE=modemRadialMSE, ethTXBackpresEvents=ethTXBackpresEvents, ethTXGiants=ethTXGiants, modemCarrierOffset=modemCarrierOffset, ipRadioStat=ipRadioStat, radioRxFrequency=radioRxFrequency, ethTXExcessiveDefers=ethTXExcessiveDefers, product=product, ethTXByteCounterLow=ethTXByteCounterLow, radioEntry=radioEntry, modemSymbolRateTx=modemSymbolRateTx, vlansEnabled=vlansEnabled, vlanNumber=vlanNumber, modemE1T1ChannelMask=modemE1T1ChannelMask, localIp=localIp, atpcEnabled=atpcEnabled, radioSide=radioSide, radioDuplexShift=radioDuplexShift, modemTotalBlockNumber=modemTotalBlockNumber, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlanPortmap=vlanPortmap, ethTXVlanTags=ethTXVlanTags, licenseUpdateStatus=licenseUpdateStatus, restartcpu=restartcpu, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemGeneralStatus=modemGeneralStatus, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemSymbolRateRx=modemSymbolRateRx, ethGFPFCSErrors=ethGFPFCSErrors, modemRowStatus=modemRowStatus, loopback_tributary_mask=loopback_tributary_mask, modemInternalAGCgain=modemInternalAGCgain, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemLDPCdecoderStress=modemLDPCdecoderStress, ethQOSTXDropped=ethQOSTXDropped, radioTxPower=radioTxPower, vlanEntry=vlanEntry, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXMaxCollisions=ethTXMaxCollisions, loopbacks=loopbacks, e1t1AIS=e1t1AIS, ethTXPauseFrames=ethTXPauseFrames, ethTXUnderruns=ethTXUnderruns, ethTXDones=ethTXDones, modemLastAcqError=modemLastAcqError, sysDateAndTime=sysDateAndTime, radioTxFrequency=radioTxFrequency, atpcIndex=atpcIndex, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXCodeErrors=ethRXCodeErrors, ipRadioStatEth=ipRadioStatEth, vlanFid=vlanFid, ethRXDvEvent=ethRXDvEvent, ipRadioCfg=ipRadioCfg, radioRxLevel=radioRxLevel, modemEthernetCapacity=modemEthernetCapacity, radioTable=radioTable, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, e1t1ChannelNr=e1t1ChannelNr, ethRXDribleNibbles=ethRXDribleNibbles, ethTXByteCounterHi=ethTXByteCounterHi, saf=saf, vlanTable=vlanTable, modemUptime=modemUptime, aTPCTable=aTPCTable, microwaveRadio=microwaveRadio, pointToPoint=pointToPoint, ethTXBroadcasts=ethTXBroadcasts, modemErroredSecond=modemErroredSecond, license=license, ethRXCRCErrors=ethRXCRCErrors, remoteIp=remoteIp, tehnika=tehnika, sysTemperature=sysTemperature, modemACMethernetCapacity=modemACMethernetCapacity, radioLoopback=radioLoopback, modemIndex=modemIndex, safip=safip, ethRXPauseFrames=ethRXPauseFrames, description=description)
