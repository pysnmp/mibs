...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemTotalBlockNumber=modemTotalBlockNumber, radioTable=radioTable, ethTXByteCounterLow=ethTXByteCounterLow, e1t1AIS=e1t1AIS, ethTXByteCounterHi=ethTXByteCounterHi, ethRXByteCounterLow=ethRXByteCounterLow, ethRXMulticasts=ethRXMulticasts, e1t1StatEntry=e1t1StatEntry, localIpMask=localIpMask, ethTXBackpresEvents=ethTXBackpresEvents, licenseUpdateStatus=licenseUpdateStatus, modemE1T1ChannelMask=modemE1T1ChannelMask, saf=saf, hostname=hostname, ipRadioStatEth=ipRadioStatEth, ethRXByteCounterHi=ethRXByteCounterHi, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXCollisions=ethTXCollisions, radioGenStatus=radioGenStatus, modemCarrierOffset=modemCarrierOffset, modemSymbolRateTx=modemSymbolRateTx, modemUptime=modemUptime, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, writeConfig=writeConfig, license=license, radioSide=radioSide, radioRxLevel=radioRxLevel, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXVlanTags=ethTXVlanTags, restartcpu=restartcpu, radioTxMute=radioTxMute, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXLongEvents=ethRXLongEvents, ethTXDones=ethTXDones, vlanPortType=vlanPortType, loopback_tributary_mask=loopback_tributary_mask, ipRadioStat=ipRadioStat, vlanEntry=vlanEntry, modemACMengine=modemACMengine, licenseMask=licenseMask, ethGFPCHECErrors=ethGFPCHECErrors, vlansEnabled=vlansEnabled, ethRXDones=ethRXDones, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXControlFrames=ethTXControlFrames, modemLDPCdecoderStress=modemLDPCdecoderStress, radioEntry=radioEntry, ipRadioMgmt=ipRadioMgmt, ethRXPauseFrames=ethRXPauseFrames, vlanPortmap=vlanPortmap, ethRXDribleNibbles=ethRXDribleNibbles, radioIndex=radioIndex, ipRadio=ipRadio, localIp=localIp, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, e1t1ChannelNr=e1t1ChannelNr, radioRxFrequency=radioRxFrequency, pointToPoint=pointToPoint, sysTemperature=sysTemperature, ethQOSRXQ1Frames=ethQOSRXQ1Frames, product=product, loopbacks=loopbacks, modemModulation=modemModulation, radioDuplexShift=radioDuplexShift, modemACMethernetCapacity=modemACMethernetCapacity, ethGFPDropedFrames=ethGFPDropedFrames, ipRadioCfgGeneral=ipRadioCfgGeneral, modemTotalCapacity=modemTotalCapacity, modemACMmodulationMax=modemACMmodulationMax, modemEntry=modemEntry, modemRowStatus=modemRowStatus, modemUnavailtime=modemUnavailtime, modemTable=modemTable, modemErroredSecond=modemErroredSecond, ethRXPrevPktDropped=ethRXPrevPktDropped, modemRadialMSE=modemRadialMSE, ipRadioCfg=ipRadioCfg, modemGeneralStatus=modemGeneralStatus, modemStandard=modemStandard, vlanCfgStat=vlanCfgStat, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXUnsupOpcodes=ethRXUnsupOpcodes, microwaveRadio=microwaveRadio, safip=safip, modemEthernetCapacity=modemEthernetCapacity, modemAcqStatus=modemAcqStatus, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXMulticasts=ethTXMulticasts, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioTxPower=radioTxPower, ethTXUnderruns=ethTXUnderruns, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXControlFrames=ethRXControlFrames, ethRXTruncatedFrames=ethRXTruncatedFrames, modemInternalAGCgain=modemInternalAGCgain, modemCountTime=modemCountTime, ethRXCodeErrors=ethRXCodeErrors, aTPCTable=aTPCTable, modemErroredSecondRatio=modemErroredSecondRatio, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXBroadcasts=ethRXBroadcasts, vlanNumber=vlanNumber, ipRadioCfgNetwork=ipRadioCfgNetwork, modemLastAcqError=modemLastAcqError, modemBandwith=modemBandwith, description=description, ethTXPauseFrames=ethTXPauseFrames, ethQOSTXFrames=ethQOSTXFrames, vlanFid=vlanFid, ethTXCRCErrors=ethTXCRCErrors, atpcEnabled=atpcEnabled, modemE1T1Channels=modemE1T1Channels, ethRXCRCErrors=ethRXCRCErrors, ethGFPFCSErrors=ethGFPFCSErrors, modemIndex=modemIndex, sysDateAndTime=sysDateAndTime, ethTXLateCollisions=ethTXLateCollisions, ethQOSTXDropped=ethQOSTXDropped, ethTXBroadcasts=ethTXBroadcasts, modemACMmodulationMin=modemACMmodulationMin, atpcIndex=atpcIndex, modemSymbolRateRx=modemSymbolRateRx, vlanRowStatus=vlanRowStatus, remoteIp=remoteIp, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethGFPDelineationErrors=ethGFPDelineationErrors, modemStatistics=modemStatistics, radioLoopback=radioLoopback, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXDvEvent=ethRXDvEvent, vlanTable=vlanTable, ethTXGiants=ethTXGiants, tehnika=tehnika, modemACMtotalCapacity=modemACMtotalCapacity, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXMaxCollisions=ethTXMaxCollisions, radioTxFrequency=radioTxFrequency, e1t1LOS=e1t1LOS, modemErroredBlock=modemErroredBlock, aTPCEntry=aTPCEntry, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, e1t1StatTable=e1t1StatTable)
