...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXByteCounterHi=ethTXByteCounterHi, ethTXMaxCollisions=ethTXMaxCollisions, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemGeneralStatus=modemGeneralStatus, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, atpcEnabled=atpcEnabled, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, localIpMask=localIpMask, ethTXCRCErrors=ethTXCRCErrors, ethGFPDelineationErrors=ethGFPDelineationErrors, radioTxFrequency=radioTxFrequency, vlanNumber=vlanNumber, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemE1T1Channels=modemE1T1Channels, modemUptime=modemUptime, vlanTable=vlanTable, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethGFPFCSErrors=ethGFPFCSErrors, localIp=localIp, ethTXLateCollisions=ethTXLateCollisions, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXPauseFrames=ethTXPauseFrames, ethQOSTXFrames=ethQOSTXFrames, radioEntry=radioEntry, radioLoopback=radioLoopback, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemStatistics=modemStatistics, modemTotalCapacity=modemTotalCapacity, ethTXBackpresEvents=ethTXBackpresEvents, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemTable=modemTable, writeConfig=writeConfig, modemLastAcqError=modemLastAcqError, ethTXDones=ethTXDones, ethRXByteCounterLow=ethRXByteCounterLow, modemUnavailtime=modemUnavailtime, sysTemperature=sysTemperature, ipRadioCfgNetwork=ipRadioCfgNetwork, loopback_tributary_mask=loopback_tributary_mask, ethRXDones=ethRXDones, microwaveRadio=microwaveRadio, ethTXGiants=ethTXGiants, ipRadio=ipRadio, modemSymbolRateTx=modemSymbolRateTx, modemSymbolRateRx=modemSymbolRateRx, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethQOSRXQ2Frames=ethQOSRXQ2Frames, pointToPoint=pointToPoint, e1t1AIS=e1t1AIS, ipRadioStat=ipRadioStat, radioGenStatus=radioGenStatus, radioTable=radioTable, vlanCfgStat=vlanCfgStat, ethTXBroadcasts=ethTXBroadcasts, modemACMtotalCapacity=modemACMtotalCapacity, e1t1ChannelNr=e1t1ChannelNr, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXPrevPktDropped=ethRXPrevPktDropped, modemBandwith=modemBandwith, licenseUpdateStatus=licenseUpdateStatus, modemRadialMSE=modemRadialMSE, description=description, modemACMethernetCapacity=modemACMethernetCapacity, modemIndex=modemIndex, modemCarrierOffset=modemCarrierOffset, vlanEntry=vlanEntry, licenseMask=licenseMask, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemACMmodulationMin=modemACMmodulationMin, modemACMengine=modemACMengine, atpcIndex=atpcIndex, vlanRowStatus=vlanRowStatus, ethRXBroadcasts=ethRXBroadcasts, radioDuplexShift=radioDuplexShift, vlansEnabled=vlansEnabled, ipRadioCfgGeneral=ipRadioCfgGeneral, radioTxPower=radioTxPower, e1t1StatEntry=e1t1StatEntry, product=product, ipRadioCfg=ipRadioCfg, ipRadioStatEth=ipRadioStatEth, ethRXControlFrames=ethRXControlFrames, e1t1StatTable=e1t1StatTable, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXControlFrames=ethTXControlFrames, modemEntry=modemEntry, vlanPortType=vlanPortType, modemACMmodulationMax=modemACMmodulationMax, aTPCEntry=aTPCEntry, ethRXCRCErrors=ethRXCRCErrors, radioTxMute=radioTxMute, vlanPortmap=vlanPortmap, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXLongEvents=ethRXLongEvents, radioRxFrequency=radioRxFrequency, aTPCTable=aTPCTable, modemAcqStatus=modemAcqStatus, ethRXDribleNibbles=ethRXDribleNibbles, hostname=hostname, ethTXByteCounterLow=ethTXByteCounterLow, ethRXByteCounterHi=ethRXByteCounterHi, ethRXPauseFrames=ethRXPauseFrames, modemErroredBlock=modemErroredBlock, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXMulticasts=ethRXMulticasts, ipRadioMgmt=ipRadioMgmt, ethTXCollisions=ethTXCollisions, ethTXUnderruns=ethTXUnderruns, modemE1T1ChannelMask=modemE1T1ChannelMask, ethGFPDropedFrames=ethGFPDropedFrames, e1t1LOS=e1t1LOS, radioIndex=radioIndex, ethRXTruncatedFrames=ethRXTruncatedFrames, safip=safip, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemCountTime=modemCountTime, modemTotalBlockNumber=modemTotalBlockNumber, ethTXExcessiveDefers=ethTXExcessiveDefers, modemRowStatus=modemRowStatus, ethRXCodeErrors=ethRXCodeErrors, tehnika=tehnika, vlanFid=vlanFid, license=license, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXDvEvent=ethRXDvEvent, remoteIp=remoteIp, radioSide=radioSide, saf=saf, ethGFPCHECErrors=ethGFPCHECErrors, modemErroredSecondRatio=modemErroredSecondRatio, modemErroredSecond=modemErroredSecond, ethTXMulticasts=ethTXMulticasts, sysDateAndTime=sysDateAndTime, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemModulation=modemModulation, modemStandard=modemStandard, loopbacks=loopbacks, ethQOSTXDropped=ethQOSTXDropped, restartcpu=restartcpu, radioRxLevel=radioRxLevel, modemInternalAGCgain=modemInternalAGCgain, ethTXVlanTags=ethTXVlanTags, modemEthernetCapacity=modemEthernetCapacity)
