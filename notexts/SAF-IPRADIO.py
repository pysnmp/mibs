...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXControlFrames=ethRXControlFrames, vlanCfgStat=vlanCfgStat, saf=saf, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, remoteIp=remoteIp, ethRXDones=ethRXDones, radioLoopback=radioLoopback, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioRxFrequency=radioRxFrequency, ethGFPFCSErrors=ethGFPFCSErrors, modemLastAcqError=modemLastAcqError, writeConfig=writeConfig, sysDateAndTime=sysDateAndTime, modemGeneralStatus=modemGeneralStatus, atpcEnabled=atpcEnabled, modemModulation=modemModulation, e1t1StatEntry=e1t1StatEntry, aTPCTable=aTPCTable, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXLongEvents=ethRXLongEvents, ethRXDribleNibbles=ethRXDribleNibbles, modemACMengine=modemACMengine, ethRXByteCounterLow=ethRXByteCounterLow, e1t1ChannelNr=e1t1ChannelNr, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethQOSTXFrames=ethQOSTXFrames, sysTemperature=sysTemperature, vlanEntry=vlanEntry, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXExcessiveDefers=ethTXExcessiveDefers, licenseMask=licenseMask, ethTXCRCErrors=ethTXCRCErrors, ethTXControlFrames=ethTXControlFrames, ipRadio=ipRadio, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXByteCounterHi=ethRXByteCounterHi, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethGFPDelineationErrors=ethGFPDelineationErrors, modemACMmodulationMin=modemACMmodulationMin, vlanPortmap=vlanPortmap, ethTXCollisions=ethTXCollisions, ipRadioCfgGeneral=ipRadioCfgGeneral, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXMulticasts=ethTXMulticasts, modemErroredSecondRatio=modemErroredSecondRatio, ethRXCRCErrors=ethRXCRCErrors, modemAcqStatus=modemAcqStatus, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioRxLevel=radioRxLevel, modemE1T1Channels=modemE1T1Channels, localIp=localIp, ethQOSTXDropped=ethQOSTXDropped, ethTXByteCounterHi=ethTXByteCounterHi, modemCountTime=modemCountTime, ethTXByteCounterLow=ethTXByteCounterLow, radioTable=radioTable, modemTable=modemTable, modemSymbolRateTx=modemSymbolRateTx, ethTXGiants=ethTXGiants, localIpMask=localIpMask, atpcTxPowerCorrection=atpcTxPowerCorrection, modemTotalCapacity=modemTotalCapacity, modemErroredBlock=modemErroredBlock, loopbacks=loopbacks, vlanPortType=vlanPortType, modemRadialMSE=modemRadialMSE, modemStatistics=modemStatistics, description=description, microwaveRadio=microwaveRadio, modemEntry=modemEntry, radioDuplexShift=radioDuplexShift, vlanRowStatus=vlanRowStatus, ethRXCodeErrors=ethRXCodeErrors, vlanNumber=vlanNumber, vlanFid=vlanFid, pointToPoint=pointToPoint, ipRadioStatEth=ipRadioStatEth, ethTXMaxCollisions=ethTXMaxCollisions, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemSymbolRateRx=modemSymbolRateRx, modemACMethernetCapacity=modemACMethernetCapacity, modemUnavailtime=modemUnavailtime, ipRadioMgmt=ipRadioMgmt, product=product, e1t1AIS=e1t1AIS, e1t1StatTable=e1t1StatTable, hostname=hostname, radioTxPower=radioTxPower, licenseUpdateStatus=licenseUpdateStatus, ipRadioStat=ipRadioStat, radioSide=radioSide, ethTXUnderruns=ethTXUnderruns, restartcpu=restartcpu, radioTxFrequency=radioTxFrequency, ethTXDones=ethTXDones, license=license, modemEthernetCapacity=modemEthernetCapacity, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioGenStatus=radioGenStatus, modemACMmodulationMax=modemACMmodulationMax, ethTXVlanTags=ethTXVlanTags, modemTotalBlockNumber=modemTotalBlockNumber, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXPauseFrames=ethRXPauseFrames, modemRowStatus=modemRowStatus, ethQOSRXQ1Frames=ethQOSRXQ1Frames, tehnika=tehnika, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXBackpresEvents=ethTXBackpresEvents, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlanTable=vlanTable, ethRXDvEvent=ethRXDvEvent, ethTXPauseFrames=ethTXPauseFrames, ethGFPCHECErrors=ethGFPCHECErrors, e1t1LOS=e1t1LOS, safip=safip, modemACMtotalCapacity=modemACMtotalCapacity, modemIndex=modemIndex, modemStandard=modemStandard, modemUptime=modemUptime, loopback_tributary_mask=loopback_tributary_mask, radioIndex=radioIndex, ethTXBroadcasts=ethTXBroadcasts, radioTxMute=radioTxMute, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioEntry=radioEntry, atpcIndex=atpcIndex, modemInternalAGCgain=modemInternalAGCgain, modemErroredSecond=modemErroredSecond, ethTXLateCollisions=ethTXLateCollisions, modemCarrierOffset=modemCarrierOffset, ipRadioCfgNetwork=ipRadioCfgNetwork, modemBandwith=modemBandwith, ethRXBroadcasts=ethRXBroadcasts, ethGFPDropedFrames=ethGFPDropedFrames, ethRXMulticasts=ethRXMulticasts, ipRadioCfg=ipRadioCfg, vlansEnabled=vlansEnabled, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, aTPCEntry=aTPCEntry)
