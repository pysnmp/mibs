...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXMaxCollisions=ethTXMaxCollisions, modemTotalCapacity=modemTotalCapacity, ethTXBackpresEvents=ethTXBackpresEvents, modemTable=modemTable, ethRXControlFrames=ethRXControlFrames, modemErroredSecondRatio=modemErroredSecondRatio, ethQOSTXDropped=ethQOSTXDropped, ethTXGiants=ethTXGiants, product=product, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXCRCErrors=ethTXCRCErrors, ipRadioCfgGeneral=ipRadioCfgGeneral, saf=saf, modemACMethernetCapacity=modemACMethernetCapacity, modemUnavailtime=modemUnavailtime, radioTxPower=radioTxPower, radioRxLevel=radioRxLevel, modemUptime=modemUptime, ethQOSTXFrames=ethQOSTXFrames, ipRadioCfgNetwork=ipRadioCfgNetwork, e1t1StatEntry=e1t1StatEntry, ethRXCodeErrors=ethRXCodeErrors, license=license, modemCarrierOffset=modemCarrierOffset, ethTXPauseFrames=ethTXPauseFrames, ethRXDvEvent=ethRXDvEvent, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, vlanRowStatus=vlanRowStatus, ethRXUnsupOpcodes=ethRXUnsupOpcodes, localIp=localIp, radioLoopback=radioLoopback, vlanTable=vlanTable, description=description, aTPCTable=aTPCTable, ethGFPDropedFrames=ethGFPDropedFrames, licenseUpdateStatus=licenseUpdateStatus, sysTemperature=sysTemperature, radioGenStatus=radioGenStatus, modemIndex=modemIndex, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemStatistics=modemStatistics, ethTXByteCounterHi=ethTXByteCounterHi, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXBroadcasts=ethRXBroadcasts, modemModulation=modemModulation, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemSymbolRateTx=modemSymbolRateTx, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlansEnabled=vlansEnabled, ethTXExcessiveDefers=ethTXExcessiveDefers, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioTxFrequency=radioTxFrequency, modemRadialMSE=modemRadialMSE, modemEntry=modemEntry, licenseMask=licenseMask, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXVlanTagsDetected=ethRXVlanTagsDetected, sysDateAndTime=sysDateAndTime, modemE1T1ChannelMask=modemE1T1ChannelMask, modemBandwith=modemBandwith, ethTXBroadcasts=ethTXBroadcasts, loopbacks=loopbacks, ethTXLateCollisions=ethTXLateCollisions, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemGeneralStatus=modemGeneralStatus, ethRXByteCounterHi=ethRXByteCounterHi, ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlanNumber=vlanNumber, loopback_tributary_mask=loopback_tributary_mask, ethTXByteCounterLow=ethTXByteCounterLow, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemInternalAGCgain=modemInternalAGCgain, atpcTxPowerCorrection=atpcTxPowerCorrection, microwaveRadio=microwaveRadio, modemACMmodulationMin=modemACMmodulationMin, remoteIp=remoteIp, radioSide=radioSide, e1t1AIS=e1t1AIS, modemACMengine=modemACMengine, e1t1StatTable=e1t1StatTable, e1t1ChannelNr=e1t1ChannelNr, ethRXByteCounterLow=ethRXByteCounterLow, ipRadioStat=ipRadioStat, modemSymbolRateRx=modemSymbolRateRx, localIpMask=localIpMask, radioTxMute=radioTxMute, ethRXDribleNibbles=ethRXDribleNibbles, ipRadioMgmt=ipRadioMgmt, safip=safip, atpcEnabled=atpcEnabled, ethRXCRCErrors=ethRXCRCErrors, ethTXCollisions=ethTXCollisions, radioTable=radioTable, radioIndex=radioIndex, modemACMtotalCapacity=modemACMtotalCapacity, hostname=hostname, ethGFPCHECErrors=ethGFPCHECErrors, pointToPoint=pointToPoint, ipRadio=ipRadio, radioEntry=radioEntry, modemRowStatus=modemRowStatus, vlanPortType=vlanPortType, vlanFid=vlanFid, modemE1T1Channels=modemE1T1Channels, ethGFPFCSErrors=ethGFPFCSErrors, tehnika=tehnika, modemErroredSecond=modemErroredSecond, vlanEntry=vlanEntry, ethTXVlanTags=ethTXVlanTags, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioRxFrequency=radioRxFrequency, ethRXPrevPktDropped=ethRXPrevPktDropped, modemErroredBlock=modemErroredBlock, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemAcqStatus=modemAcqStatus, modemLastAcqError=modemLastAcqError, ethTXMulticasts=ethTXMulticasts, vlanPortmap=vlanPortmap, ethRXPauseFrames=ethRXPauseFrames, ethRXLongEvents=ethRXLongEvents, modemLDPCdecoderStress=modemLDPCdecoderStress, modemEthernetCapacity=modemEthernetCapacity, ethTXUnderruns=ethTXUnderruns, writeConfig=writeConfig, ipRadioCfg=ipRadioCfg, modemTotalBlockNumber=modemTotalBlockNumber, ethTXLengthCheckErrors=ethTXLengthCheckErrors, e1t1LOS=e1t1LOS, ethRXDones=ethRXDones, ethRXMulticasts=ethRXMulticasts, radioDuplexShift=radioDuplexShift, aTPCEntry=aTPCEntry, modemCountTime=modemCountTime, atpcIndex=atpcIndex, ipRadioStatEth=ipRadioStatEth, restartcpu=restartcpu, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXDones=ethTXDones, modemACMmodulationMax=modemACMmodulationMax, ethTXControlFrames=ethTXControlFrames, modemStandard=modemStandard, vlanCfgStat=vlanCfgStat)
