...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXPrevPktDropped=ethRXPrevPktDropped, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXCodeErrors=ethRXCodeErrors, aTPCEntry=aTPCEntry, radioTxFrequency=radioTxFrequency, ipRadioStat=ipRadioStat, radioSide=radioSide, atpcIndex=atpcIndex, modemIndex=modemIndex, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemCarrierOffset=modemCarrierOffset, ethRXDones=ethRXDones, ethRXMulticasts=ethRXMulticasts, vlanEntry=vlanEntry, ethRXDribleNibbles=ethRXDribleNibbles, aTPCTable=aTPCTable, modemErroredBlock=modemErroredBlock, modemInternalAGCgain=modemInternalAGCgain, vlanNumber=vlanNumber, ethTXByteCounterHi=ethTXByteCounterHi, ethRXByteCounterLow=ethRXByteCounterLow, modemEthernetCapacity=modemEthernetCapacity, hostname=hostname, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXControlFrames=ethRXControlFrames, ethTXMaxCollisions=ethTXMaxCollisions, modemGeneralStatus=modemGeneralStatus, modemE1T1Channels=modemE1T1Channels, ipRadioStatEth=ipRadioStatEth, licenseMask=licenseMask, writeConfig=writeConfig, ethRXBroadcasts=ethRXBroadcasts, ethTXPauseFrames=ethTXPauseFrames, e1t1ChannelNr=e1t1ChannelNr, license=license, restartcpu=restartcpu, modemUnavailtime=modemUnavailtime, ethGFPFCSErrors=ethGFPFCSErrors, radioGenStatus=radioGenStatus, atpcEnabled=atpcEnabled, modemACMmodulationMax=modemACMmodulationMax, ethTXDones=ethTXDones, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioTxMute=radioTxMute, ethRXCRCErrors=ethRXCRCErrors, ethTXByteCounterLow=ethTXByteCounterLow, remoteIp=remoteIp, modemSymbolRateTx=modemSymbolRateTx, ethTXBroadcasts=ethTXBroadcasts, ipRadioMgmt=ipRadioMgmt, modemCountTime=modemCountTime, vlanPortmap=vlanPortmap, ethTXVlanTags=ethTXVlanTags, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioDuplexShift=radioDuplexShift, ethRXDvEvent=ethRXDvEvent, e1t1StatTable=e1t1StatTable, modemRowStatus=modemRowStatus, localIpMask=localIpMask, modemRadialMSE=modemRadialMSE, sysDateAndTime=sysDateAndTime, modemTotalBlockNumber=modemTotalBlockNumber, modemACMengine=modemACMengine, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXCRCErrors=ethTXCRCErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioLoopback=radioLoopback, safip=safip, modemEntry=modemEntry, modemE1T1ChannelMask=modemE1T1ChannelMask, modemACMmodulationMin=modemACMmodulationMin, vlanFid=vlanFid, modemTable=modemTable, ethTXControlFrames=ethTXControlFrames, vlanRowStatus=vlanRowStatus, ethRXPauseFrames=ethRXPauseFrames, vlanPortType=vlanPortType, modemLDPCdecoderStress=modemLDPCdecoderStress, ipRadio=ipRadio, ethGFPDropedFrames=ethGFPDropedFrames, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethGFPCHECErrors=ethGFPCHECErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXByteCounterHi=ethRXByteCounterHi, modemBandwith=modemBandwith, modemTotalCapacity=modemTotalCapacity, product=product, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, loopback_tributary_mask=loopback_tributary_mask, ethTXGiants=ethTXGiants, ethTXExcessiveDefers=ethTXExcessiveDefers, e1t1LOS=e1t1LOS, modemErroredSecondRatio=modemErroredSecondRatio, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemLastAcqError=modemLastAcqError, vlanTable=vlanTable, ethTXUnderruns=ethTXUnderruns, radioTxPower=radioTxPower, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXLongEvents=ethRXLongEvents, ethQOSTXDropped=ethQOSTXDropped, ipRadioCfg=ipRadioCfg, modemStatistics=modemStatistics, modemModulation=modemModulation, modemSymbolRateRx=modemSymbolRateRx, radioRxFrequency=radioRxFrequency, tehnika=tehnika, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemAcqStatus=modemAcqStatus, radioTable=radioTable, ethQOSTXFrames=ethQOSTXFrames, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXMulticasts=ethTXMulticasts, pointToPoint=pointToPoint, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, description=description, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemACMtotalCapacity=modemACMtotalCapacity, e1t1AIS=e1t1AIS, modemErroredSecond=modemErroredSecond, ethTXBackpresEvents=ethTXBackpresEvents, vlansEnabled=vlansEnabled, modemUptime=modemUptime, vlanCfgStat=vlanCfgStat, localIp=localIp, modemACMethernetCapacity=modemACMethernetCapacity, sysTemperature=sysTemperature, e1t1StatEntry=e1t1StatEntry, atpcTxPowerCorrection=atpcTxPowerCorrection, radioRxLevel=radioRxLevel, modemStandard=modemStandard, microwaveRadio=microwaveRadio, ethRXTruncatedFrames=ethRXTruncatedFrames, loopbacks=loopbacks, licenseUpdateStatus=licenseUpdateStatus, radioEntry=radioEntry, ethTXLateCollisions=ethTXLateCollisions, ethTXCollisions=ethTXCollisions, saf=saf, radioIndex=radioIndex, ipRadioCfgGeneral=ipRadioCfgGeneral)
