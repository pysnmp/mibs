...
mibBuilder.exportSymbols("SAF-IPRADIO", radioSide=radioSide, modemACMethernetCapacity=modemACMethernetCapacity, ethTXByteCounterHi=ethTXByteCounterHi, e1t1StatEntry=e1t1StatEntry, ipRadio=ipRadio, sysDateAndTime=sysDateAndTime, modemE1T1Channels=modemE1T1Channels, modemBackgroundBlockErrror=modemBackgroundBlockErrror, description=description, e1t1StatTable=e1t1StatTable, ethQOSTXDropped=ethQOSTXDropped, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXDones=ethTXDones, radioIndex=radioIndex, modemErroredSecond=modemErroredSecond, ethRXCodeErrors=ethRXCodeErrors, vlanFid=vlanFid, loopbacks=loopbacks, modemE1T1ChannelMask=modemE1T1ChannelMask, modemInternalAGCgain=modemInternalAGCgain, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, licenseMask=licenseMask, ethGFPDelineationErrors=ethGFPDelineationErrors, vlansEnabled=vlansEnabled, safip=safip, modemACMmodulationMax=modemACMmodulationMax, ethQOSRXQ1Frames=ethQOSRXQ1Frames, atpcTxPowerCorrection=atpcTxPowerCorrection, modemTable=modemTable, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemCarrierOffset=modemCarrierOffset, radioLoopback=radioLoopback, vlanPortType=vlanPortType, ethRXDones=ethRXDones, radioRxFrequency=radioRxFrequency, ethTXBackpresEvents=ethTXBackpresEvents, ethTXGiants=ethTXGiants, modemCountTime=modemCountTime, modemACMtotalCapacity=modemACMtotalCapacity, radioTxPower=radioTxPower, localIpMask=localIpMask, ethRXBroadcasts=ethRXBroadcasts, localIp=localIp, ethRXPauseFrames=ethRXPauseFrames, modemIndex=modemIndex, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ipRadioMgmt=ipRadioMgmt, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemUptime=modemUptime, vlanPortmap=vlanPortmap, pointToPoint=pointToPoint, modemSeverelyErroredSecond=modemSeverelyErroredSecond, atpcEnabled=atpcEnabled, ethGFPDropedFrames=ethGFPDropedFrames, vlanRowStatus=vlanRowStatus, restartcpu=restartcpu, radioTable=radioTable, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemModulation=modemModulation, ethTXMulticasts=ethTXMulticasts, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, aTPCEntry=aTPCEntry, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXExcessiveDefers=ethTXExcessiveDefers, modemRadialMSE=modemRadialMSE, license=license, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioDuplexShift=radioDuplexShift, ipRadioCfgNetwork=ipRadioCfgNetwork, modemErroredSecondRatio=modemErroredSecondRatio, ethQOSTXFrames=ethQOSTXFrames, vlanTable=vlanTable, ethRXByteCounterHi=ethRXByteCounterHi, ethRXDvEvent=ethRXDvEvent, remoteIp=remoteIp, ipRadioStatEth=ipRadioStatEth, ipRadioStat=ipRadioStat, ethTXMaxCollisions=ethTXMaxCollisions, writeConfig=writeConfig, radioGenStatus=radioGenStatus, modemUnavailtime=modemUnavailtime, licenseUpdateStatus=licenseUpdateStatus, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, aTPCTable=aTPCTable, modemLastAcqError=modemLastAcqError, ethTXByteCounterLow=ethTXByteCounterLow, modemTotalBlockNumber=modemTotalBlockNumber, ethTXWireByteCounterHi=ethTXWireByteCounterHi, e1t1ChannelNr=e1t1ChannelNr, atpcIndex=atpcIndex, modemSymbolRateRx=modemSymbolRateRx, vlanCfgStat=vlanCfgStat, ethRXLongEvents=ethRXLongEvents, vlanNumber=vlanNumber, ethTXCRCErrors=ethTXCRCErrors, ethTXLateCollisions=ethTXLateCollisions, modemAcqStatus=modemAcqStatus, modemStatistics=modemStatistics, ethTXControlFrames=ethTXControlFrames, e1t1LOS=e1t1LOS, modemErroredBlock=modemErroredBlock, microwaveRadio=microwaveRadio, modemACMmodulationMin=modemACMmodulationMin, ethRXControlFrames=ethRXControlFrames, modemBandwith=modemBandwith, ipRadioCfg=ipRadioCfg, modemEntry=modemEntry, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXVlanTags=ethTXVlanTags, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXUnderruns=ethTXUnderruns, modemRowStatus=modemRowStatus, e1t1AIS=e1t1AIS, ethRXCRCErrors=ethRXCRCErrors, ethTXBroadcasts=ethTXBroadcasts, product=product, ethRXByteCounterLow=ethRXByteCounterLow, ethTXPauseFrames=ethTXPauseFrames, ethRXDribleNibbles=ethRXDribleNibbles, loopback_tributary_mask=loopback_tributary_mask, modemSymbolRateTx=modemSymbolRateTx, ethGFPFCSErrors=ethGFPFCSErrors, ethTXCollisions=ethTXCollisions, radioRxLevel=radioRxLevel, ethGFPCHECErrors=ethGFPCHECErrors, modemGeneralStatus=modemGeneralStatus, radioTxFrequency=radioTxFrequency, modemTotalCapacity=modemTotalCapacity, hostname=hostname, tehnika=tehnika, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, saf=saf, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioTxMute=radioTxMute, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemACMengine=modemACMengine, vlanEntry=vlanEntry, ethRXMulticasts=ethRXMulticasts, ethRXPrevPktDropped=ethRXPrevPktDropped, modemEthernetCapacity=modemEthernetCapacity, radioEntry=radioEntry, modemStandard=modemStandard, sysTemperature=sysTemperature)
