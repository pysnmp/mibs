...
mibBuilder.exportSymbols("SAF-IPRADIO", loopback_tributary_mask=loopback_tributary_mask, localIp=localIp, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemBandwith=modemBandwith, e1t1AIS=e1t1AIS, remoteIp=remoteIp, ethTXBackpresEvents=ethTXBackpresEvents, ethQOSTXDropped=ethQOSTXDropped, modemTotalBlockNumber=modemTotalBlockNumber, ethRXControlFrames=ethRXControlFrames, radioGenStatus=radioGenStatus, modemRadialMSE=modemRadialMSE, modemErroredSecond=modemErroredSecond, aTPCTable=aTPCTable, vlansEnabled=vlansEnabled, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemInternalAGCgain=modemInternalAGCgain, modemE1T1Channels=modemE1T1Channels, radioIndex=radioIndex, ethTXMaxCollisions=ethTXMaxCollisions, e1t1StatTable=e1t1StatTable, ethGFPDelineationErrors=ethGFPDelineationErrors, modemGeneralStatus=modemGeneralStatus, ethRXDones=ethRXDones, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXPrevPktDropped=ethRXPrevPktDropped, vlanRowStatus=vlanRowStatus, license=license, radioDuplexShift=radioDuplexShift, vlanPortmap=vlanPortmap, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemCarrierOffset=modemCarrierOffset, modemLastAcqError=modemLastAcqError, aTPCEntry=aTPCEntry, radioSide=radioSide, radioTxPower=radioTxPower, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXMulticasts=ethRXMulticasts, modemStandard=modemStandard, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemACMmodulationMin=modemACMmodulationMin, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemStatistics=modemStatistics, ethTXControlFrames=ethTXControlFrames, licenseUpdateStatus=licenseUpdateStatus, ethRXByteCounterLow=ethRXByteCounterLow, radioLoopback=radioLoopback, e1t1ChannelNr=e1t1ChannelNr, saf=saf, ethRXBroadcasts=ethRXBroadcasts, ethRXLongEvents=ethRXLongEvents, atpcEnabled=atpcEnabled, ethTXUnderruns=ethTXUnderruns, modemUnavailtime=modemUnavailtime, radioTable=radioTable, modemErroredSecondRatio=modemErroredSecondRatio, ipRadioCfgNetwork=ipRadioCfgNetwork, modemACMethernetCapacity=modemACMethernetCapacity, modemACMtotalCapacity=modemACMtotalCapacity, modemSymbolRateRx=modemSymbolRateRx, modemErroredBlock=modemErroredBlock, modemUptime=modemUptime, ethTXBroadcasts=ethTXBroadcasts, ethTXGiants=ethTXGiants, modemAcqStatus=modemAcqStatus, ethTXCollisions=ethTXCollisions, ipRadioMgmt=ipRadioMgmt, atpcTxPowerCorrection=atpcTxPowerCorrection, ethGFPCHECErrors=ethGFPCHECErrors, modemIndex=modemIndex, sysTemperature=sysTemperature, ethTXCRCErrors=ethTXCRCErrors, tehnika=tehnika, ethRXCodeErrors=ethRXCodeErrors, ethRXByteCounterHi=ethRXByteCounterHi, vlanCfgStat=vlanCfgStat, radioTxFrequency=radioTxFrequency, writeConfig=writeConfig, ethRXDribleNibbles=ethRXDribleNibbles, product=product, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioEntry=radioEntry, ethTXLateCollisions=ethTXLateCollisions, safip=safip, modemE1T1ChannelMask=modemE1T1ChannelMask, vlanFid=vlanFid, modemTable=modemTable, ipRadioStat=ipRadioStat, modemEntry=modemEntry, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemTotalCapacity=modemTotalCapacity, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXDvEvent=ethRXDvEvent, radioTxMute=radioTxMute, e1t1LOS=e1t1LOS, loopbacks=loopbacks, ethQOSTXFrames=ethQOSTXFrames, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlanPortType=vlanPortType, ipRadioCfgGeneral=ipRadioCfgGeneral, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethGFPDropedFrames=ethGFPDropedFrames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioRxLevel=radioRxLevel, radioRxFrequency=radioRxFrequency, vlanTable=vlanTable, localIpMask=localIpMask, ethRXTruncatedFrames=ethRXTruncatedFrames, modemSymbolRateTx=modemSymbolRateTx, modemRowStatus=modemRowStatus, vlanEntry=vlanEntry, description=description, atpcIndex=atpcIndex, modemACMmodulationMax=modemACMmodulationMax, ethTXMulticasts=ethTXMulticasts, sysDateAndTime=sysDateAndTime, ipRadioCfg=ipRadioCfg, ethTXPauseFrames=ethTXPauseFrames, modemModulation=modemModulation, ethGFPFCSErrors=ethGFPFCSErrors, e1t1StatEntry=e1t1StatEntry, ethRXPauseFrames=ethRXPauseFrames, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXByteCounterLow=ethTXByteCounterLow, restartcpu=restartcpu, modemEthernetCapacity=modemEthernetCapacity, ethTXVlanTags=ethTXVlanTags, ipRadio=ipRadio, modemACMengine=modemACMengine, licenseMask=licenseMask, ethTXLengthCheckErrors=ethTXLengthCheckErrors, pointToPoint=pointToPoint, modemCountTime=modemCountTime, microwaveRadio=microwaveRadio, vlanNumber=vlanNumber, ethTXByteCounterHi=ethTXByteCounterHi, ethRXCRCErrors=ethRXCRCErrors, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ipRadioStatEth=ipRadioStatEth, ethTXDones=ethTXDones, hostname=hostname)
