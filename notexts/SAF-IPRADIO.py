...
mibBuilder.exportSymbols("SAF-IPRADIO", aTPCTable=aTPCTable, modemACMengine=modemACMengine, ethRXLongEvents=ethRXLongEvents, radioLoopback=radioLoopback, modemLDPCdecoderStress=modemLDPCdecoderStress, atpcTxPowerCorrection=atpcTxPowerCorrection, localIpMask=localIpMask, ethRXPauseFrames=ethRXPauseFrames, ethTXMulticasts=ethTXMulticasts, modemACMethernetCapacity=modemACMethernetCapacity, ethTXPauseFrames=ethTXPauseFrames, radioTxFrequency=radioTxFrequency, modemAcqStatus=modemAcqStatus, radioIndex=radioIndex, modemEthernetCapacity=modemEthernetCapacity, ethTXMaxCollisions=ethTXMaxCollisions, ethGFPDelineationErrors=ethGFPDelineationErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ipRadioStatEth=ipRadioStatEth, radioGenStatus=radioGenStatus, e1t1ChannelNr=e1t1ChannelNr, modemRowStatus=modemRowStatus, modemTotalBlockNumber=modemTotalBlockNumber, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemUnavailtime=modemUnavailtime, restartcpu=restartcpu, e1t1StatTable=e1t1StatTable, aTPCEntry=aTPCEntry, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ipRadioMgmt=ipRadioMgmt, ethTXGiants=ethTXGiants, modemInternalAGCgain=modemInternalAGCgain, ethRXBroadcasts=ethRXBroadcasts, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, loopback_tributary_mask=loopback_tributary_mask, modemTotalCapacity=modemTotalCapacity, radioRxFrequency=radioRxFrequency, ethTXUnderruns=ethTXUnderruns, sysTemperature=sysTemperature, modemErroredBlock=modemErroredBlock, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, writeConfig=writeConfig, ipRadioStat=ipRadioStat, vlanRowStatus=vlanRowStatus, modemTable=modemTable, ethRXByteCounterHi=ethRXByteCounterHi, vlanTable=vlanTable, ethRXMulticasts=ethRXMulticasts, ethTXBackpresEvents=ethTXBackpresEvents, safip=safip, ethTXBroadcasts=ethTXBroadcasts, modemACMmodulationMin=modemACMmodulationMin, vlanNumber=vlanNumber, remoteIp=remoteIp, ethTXDones=ethTXDones, vlanCfgStat=vlanCfgStat, description=description, e1t1AIS=e1t1AIS, ethRXDribleNibbles=ethRXDribleNibbles, modemLastAcqError=modemLastAcqError, modemUptime=modemUptime, radioRxLevel=radioRxLevel, modemCountTime=modemCountTime, ethGFPFCSErrors=ethGFPFCSErrors, hostname=hostname, loopbacks=loopbacks, atpcEnabled=atpcEnabled, modemRadialMSE=modemRadialMSE, saf=saf, ethTXCRCErrors=ethTXCRCErrors, radioTable=radioTable, modemBandwith=modemBandwith, product=product, license=license, radioSide=radioSide, ethRXDones=ethRXDones, ethTXLateCollisions=ethTXLateCollisions, ethRXCodeErrors=ethRXCodeErrors, modemEntry=modemEntry, pointToPoint=pointToPoint, localIp=localIp, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemSymbolRateRx=modemSymbolRateRx, ethRXCRCErrors=ethRXCRCErrors, ethTXVlanTags=ethTXVlanTags, e1t1StatEntry=e1t1StatEntry, ipRadio=ipRadio, ethQOSTXDropped=ethQOSTXDropped, ipRadioCfg=ipRadioCfg, e1t1LOS=e1t1LOS, ethQOSRXQ1Frames=ethQOSRXQ1Frames, sysDateAndTime=sysDateAndTime, microwaveRadio=microwaveRadio, ipRadioCfgNetwork=ipRadioCfgNetwork, modemGeneralStatus=modemGeneralStatus, modemE1T1Channels=modemE1T1Channels, modemACMtotalCapacity=modemACMtotalCapacity, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemE1T1ChannelMask=modemE1T1ChannelMask, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemACMmodulationMax=modemACMmodulationMax, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXByteCounterLow=ethTXByteCounterLow, ethGFPDropedFrames=ethGFPDropedFrames, modemErroredSecondRatio=modemErroredSecondRatio, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlanEntry=vlanEntry, atpcIndex=atpcIndex, radioDuplexShift=radioDuplexShift, ethRXByteCounterLow=ethRXByteCounterLow, ethQOSTXFrames=ethQOSTXFrames, radioEntry=radioEntry, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXDvEvent=ethRXDvEvent, modemStandard=modemStandard, ethRXPrevPktDropped=ethRXPrevPktDropped, modemModulation=modemModulation, ethTXWireByteCounterHi=ethTXWireByteCounterHi, licenseUpdateStatus=licenseUpdateStatus, modemCarrierOffset=modemCarrierOffset, ethTXCollisions=ethTXCollisions, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXByteCounterHi=ethTXByteCounterHi, modemIndex=modemIndex, vlansEnabled=vlansEnabled, vlanPortmap=vlanPortmap, ethGFPCHECErrors=ethGFPCHECErrors, modemSymbolRateTx=modemSymbolRateTx, ethRXVlanTagsDetected=ethRXVlanTagsDetected, licenseMask=licenseMask, ethTXControlFrames=ethTXControlFrames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXControlFrames=ethRXControlFrames, vlanFid=vlanFid, modemStatistics=modemStatistics, radioTxPower=radioTxPower, radioTxMute=radioTxMute, tehnika=tehnika, modemErroredSecond=modemErroredSecond, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, vlanPortType=vlanPortType, ethRXTruncatedFrames=ethRXTruncatedFrames)
