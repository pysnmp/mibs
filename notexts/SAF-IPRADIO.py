...
mibBuilder.exportSymbols("SAF-IPRADIO", restartcpu=restartcpu, atpcEnabled=atpcEnabled, modemBandwith=modemBandwith, ethTXBackpresEvents=ethTXBackpresEvents, modemACMmodulationMax=modemACMmodulationMax, vlanCfgStat=vlanCfgStat, ethGFPFCSErrors=ethGFPFCSErrors, radioTxFrequency=radioTxFrequency, e1t1LOS=e1t1LOS, ethTXVlanTags=ethTXVlanTags, saf=saf, modemACMtotalCapacity=modemACMtotalCapacity, hostname=hostname, localIp=localIp, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioTxMute=radioTxMute, modemAcqStatus=modemAcqStatus, ethTXDones=ethTXDones, vlanTable=vlanTable, vlanNumber=vlanNumber, modemErroredSecond=modemErroredSecond, modemSymbolRateTx=modemSymbolRateTx, ethTXMaxCollisions=ethTXMaxCollisions, ethRXLongEvents=ethRXLongEvents, aTPCEntry=aTPCEntry, ethTXCRCErrors=ethTXCRCErrors, ethTXByteCounterLow=ethTXByteCounterLow, loopback_tributary_mask=loopback_tributary_mask, ethTXByteCounterHi=ethTXByteCounterHi, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemInternalAGCgain=modemInternalAGCgain, modemErroredBlock=modemErroredBlock, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXBroadcasts=ethRXBroadcasts, ethTXUnderruns=ethTXUnderruns, vlanPortType=vlanPortType, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, vlanEntry=vlanEntry, ipRadio=ipRadio, radioSide=radioSide, ethTXPauseFrames=ethTXPauseFrames, licenseMask=licenseMask, ipRadioCfg=ipRadioCfg, ethRXCRCErrors=ethRXCRCErrors, sysDateAndTime=sysDateAndTime, radioDuplexShift=radioDuplexShift, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemEthernetCapacity=modemEthernetCapacity, vlansEnabled=vlansEnabled, ethTXLateCollisions=ethTXLateCollisions, ethRXByteCounterLow=ethRXByteCounterLow, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXCollisions=ethTXCollisions, e1t1StatTable=e1t1StatTable, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXGiants=ethTXGiants, pointToPoint=pointToPoint, license=license, ethRXDones=ethRXDones, modemStandard=modemStandard, modemTable=modemTable, remoteIp=remoteIp, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemRowStatus=modemRowStatus, sysTemperature=sysTemperature, modemACMmodulationMin=modemACMmodulationMin, safip=safip, radioRxFrequency=radioRxFrequency, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXDribleNibbles=ethRXDribleNibbles, ethRXDvEvent=ethRXDvEvent, ethGFPDelineationErrors=ethGFPDelineationErrors, tehnika=tehnika, loopbacks=loopbacks, ethRXMulticasts=ethRXMulticasts, modemSymbolRateRx=modemSymbolRateRx, radioTable=radioTable, radioEntry=radioEntry, modemGeneralStatus=modemGeneralStatus, vlanRowStatus=vlanRowStatus, ipRadioCfgNetwork=ipRadioCfgNetwork, modemACMengine=modemACMengine, modemUptime=modemUptime, ethGFPDropedFrames=ethGFPDropedFrames, aTPCTable=aTPCTable, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, vlanPortmap=vlanPortmap, ethRXControlFrames=ethRXControlFrames, writeConfig=writeConfig, vlanFid=vlanFid, licenseUpdateStatus=licenseUpdateStatus, modemRadialMSE=modemRadialMSE, modemE1T1Channels=modemE1T1Channels, ipRadioStat=ipRadioStat, radioRxLevel=radioRxLevel, modemLastAcqError=modemLastAcqError, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXPauseFrames=ethRXPauseFrames, modemTotalCapacity=modemTotalCapacity, ipRadioMgmt=ipRadioMgmt, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, e1t1ChannelNr=e1t1ChannelNr, ipRadioStatEth=ipRadioStatEth, radioLoopback=radioLoopback, radioTxPower=radioTxPower, e1t1AIS=e1t1AIS, product=product, ethRXByteCounterHi=ethRXByteCounterHi, e1t1StatEntry=e1t1StatEntry, description=description, modemACMethernetCapacity=modemACMethernetCapacity, ethTXMulticasts=ethTXMulticasts, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ipRadioCfgGeneral=ipRadioCfgGeneral, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXTruncatedFrames=ethRXTruncatedFrames, modemCountTime=modemCountTime, modemErroredSecondRatio=modemErroredSecondRatio, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemStatistics=modemStatistics, ethQOSTXDropped=ethQOSTXDropped, radioIndex=radioIndex, modemEntry=modemEntry, ethTXBroadcasts=ethTXBroadcasts, localIpMask=localIpMask, atpcIndex=atpcIndex, ethRXCodeErrors=ethRXCodeErrors, modemIndex=modemIndex, microwaveRadio=microwaveRadio, ethQOSTXFrames=ethQOSTXFrames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemUnavailtime=modemUnavailtime, modemCarrierOffset=modemCarrierOffset, ethTXControlFrames=ethTXControlFrames, modemTotalBlockNumber=modemTotalBlockNumber, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioGenStatus=radioGenStatus, ethTXExcessiveDefers=ethTXExcessiveDefers, ethGFPCHECErrors=ethGFPCHECErrors, modemModulation=modemModulation)
