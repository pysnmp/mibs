...
mibBuilder.exportSymbols("SAF-IPRADIO", radioSide=radioSide, loopback_tributary_mask=loopback_tributary_mask, ethRXPauseFrames=ethRXPauseFrames, modemE1T1Channels=modemE1T1Channels, modemE1T1ChannelMask=modemE1T1ChannelMask, modemACMengine=modemACMengine, radioLoopback=radioLoopback, radioRxLevel=radioRxLevel, vlanFid=vlanFid, ethRXMulticasts=ethRXMulticasts, radioTxFrequency=radioTxFrequency, vlanRowStatus=vlanRowStatus, loopbacks=loopbacks, aTPCTable=aTPCTable, ethRXVlanTagsDetected=ethRXVlanTagsDetected, saf=saf, radioIndex=radioIndex, aTPCEntry=aTPCEntry, modemBandwith=modemBandwith, radioEntry=radioEntry, ethGFPCHECErrors=ethGFPCHECErrors, vlanEntry=vlanEntry, ethRXBroadcasts=ethRXBroadcasts, e1t1LOS=e1t1LOS, ethTXCollisions=ethTXCollisions, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethGFPFCSErrors=ethGFPFCSErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXBackpresEvents=ethTXBackpresEvents, ipRadioStatEth=ipRadioStatEth, modemErroredSecondRatio=modemErroredSecondRatio, radioTxPower=radioTxPower, modemUptime=modemUptime, ipRadioStat=ipRadioStat, ethTXExcessiveDefers=ethTXExcessiveDefers, vlanPortType=vlanPortType, safip=safip, ethQOSTXFrames=ethQOSTXFrames, e1t1StatEntry=e1t1StatEntry, licenseUpdateStatus=licenseUpdateStatus, product=product, ethRXLongEvents=ethRXLongEvents, ethTXLateCollisions=ethTXLateCollisions, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, restartcpu=restartcpu, ethQOSTXDropped=ethQOSTXDropped, modemACMmodulationMin=modemACMmodulationMin, modemIndex=modemIndex, modemTotalBlockNumber=modemTotalBlockNumber, atpcEnabled=atpcEnabled, localIp=localIp, ethTXWireByteCounterLow=ethTXWireByteCounterLow, atpcTxPowerCorrection=atpcTxPowerCorrection, modemLastAcqError=modemLastAcqError, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioGenStatus=radioGenStatus, ethTXMaxCollisions=ethTXMaxCollisions, microwaveRadio=microwaveRadio, writeConfig=writeConfig, ipRadioMgmt=ipRadioMgmt, ethGFPDropedFrames=ethGFPDropedFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, modemTotalCapacity=modemTotalCapacity, hostname=hostname, modemACMethernetCapacity=modemACMethernetCapacity, ethTXMulticasts=ethTXMulticasts, modemModulation=modemModulation, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXPauseFrames=ethTXPauseFrames, modemErroredBlock=modemErroredBlock, licenseMask=licenseMask, ethRXByteCounterHi=ethRXByteCounterHi, ethTXBroadcasts=ethTXBroadcasts, ethTXByteCounterLow=ethTXByteCounterLow, modemRadialMSE=modemRadialMSE, vlanPortmap=vlanPortmap, localIpMask=localIpMask, ipRadioCfgGeneral=ipRadioCfgGeneral, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemInternalAGCgain=modemInternalAGCgain, modemSymbolRateRx=modemSymbolRateRx, description=description, e1t1StatTable=e1t1StatTable, ipRadio=ipRadio, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, pointToPoint=pointToPoint, modemErroredSecond=modemErroredSecond, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXByteCounterLow=ethRXByteCounterLow, modemCarrierOffset=modemCarrierOffset, modemUnavailtime=modemUnavailtime, ethRXDones=ethRXDones, ethRXControlFrames=ethRXControlFrames, tehnika=tehnika, modemSymbolRateTx=modemSymbolRateTx, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXCRCErrors=ethTXCRCErrors, modemGeneralStatus=modemGeneralStatus, ethTXByteCounterHi=ethTXByteCounterHi, ethRXDribleNibbles=ethRXDribleNibbles, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioDuplexShift=radioDuplexShift, e1t1AIS=e1t1AIS, ethRXPrevPktDropped=ethRXPrevPktDropped, vlansEnabled=vlansEnabled, vlanNumber=vlanNumber, modemACMtotalCapacity=modemACMtotalCapacity, sysTemperature=sysTemperature, modemTable=modemTable, license=license, radioTxMute=radioTxMute, modemEthernetCapacity=modemEthernetCapacity, ethRXCRCErrors=ethRXCRCErrors, e1t1ChannelNr=e1t1ChannelNr, ethTXVlanTags=ethTXVlanTags, modemRowStatus=modemRowStatus, ethRXDvEvent=ethRXDvEvent, vlanTable=vlanTable, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemAcqStatus=modemAcqStatus, atpcIndex=atpcIndex, ethRXTruncatedFrames=ethRXTruncatedFrames, remoteIp=remoteIp, ethTXControlFrames=ethTXControlFrames, vlanCfgStat=vlanCfgStat, modemEntry=modemEntry, sysDateAndTime=sysDateAndTime, modemACMmodulationMax=modemACMmodulationMax, modemStandard=modemStandard, modemCountTime=modemCountTime, ethTXGiants=ethTXGiants, radioRxFrequency=radioRxFrequency, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ipRadioCfg=ipRadioCfg, ipRadioCfgNetwork=ipRadioCfgNetwork, modemStatistics=modemStatistics, ethRXCodeErrors=ethRXCodeErrors, ethTXUnderruns=ethTXUnderruns, radioTable=radioTable, ethTXDones=ethTXDones)
