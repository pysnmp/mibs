...
mibBuilder.exportSymbols("SAF-IPRADIO", microwaveRadio=microwaveRadio, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ipRadioCfg=ipRadioCfg, e1t1LOS=e1t1LOS, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, pointToPoint=pointToPoint, vlanPortType=vlanPortType, ethTXMaxCollisions=ethTXMaxCollisions, licenseUpdateStatus=licenseUpdateStatus, aTPCTable=aTPCTable, vlansEnabled=vlansEnabled, ethRXDvEvent=ethRXDvEvent, ipRadioMgmt=ipRadioMgmt, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXByteCounterLow=ethTXByteCounterLow, ethGFPFCSErrors=ethGFPFCSErrors, vlanFid=vlanFid, ethTXVlanTags=ethTXVlanTags, radioTxMute=radioTxMute, ethTXBackpresEvents=ethTXBackpresEvents, ipRadioStat=ipRadioStat, modemACMmodulationMax=modemACMmodulationMax, ethRXByteCounterLow=ethRXByteCounterLow, ethRXControlFrames=ethRXControlFrames, radioTxFrequency=radioTxFrequency, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioIndex=radioIndex, ethRXDribleNibbles=ethRXDribleNibbles, ethGFPCHECErrors=ethGFPCHECErrors, tehnika=tehnika, modemErroredSecondRatio=modemErroredSecondRatio, atpcEnabled=atpcEnabled, modemEthernetCapacity=modemEthernetCapacity, modemLDPCdecoderStress=modemLDPCdecoderStress, modemRowStatus=modemRowStatus, ethQOSTXFrames=ethQOSTXFrames, modemInternalAGCgain=modemInternalAGCgain, ethRXPauseFrames=ethRXPauseFrames, modemIndex=modemIndex, sysTemperature=sysTemperature, modemBandwith=modemBandwith, ethRXByteCounterHi=ethRXByteCounterHi, sysDateAndTime=sysDateAndTime, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXBroadcasts=ethRXBroadcasts, modemSymbolRateTx=modemSymbolRateTx, radioTable=radioTable, vlanCfgStat=vlanCfgStat, localIpMask=localIpMask, modemStatistics=modemStatistics, e1t1ChannelNr=e1t1ChannelNr, licenseMask=licenseMask, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXUnderruns=ethTXUnderruns, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, loopbacks=loopbacks, ethRXVlanTagsDetected=ethRXVlanTagsDetected, loopback_tributary_mask=loopback_tributary_mask, ethGFPDropedFrames=ethGFPDropedFrames, modemUptime=modemUptime, modemSeverelyErroredSecond=modemSeverelyErroredSecond, safip=safip, ethRXDones=ethRXDones, modemLastAcqError=modemLastAcqError, ethGFPDelineationErrors=ethGFPDelineationErrors, radioLoopback=radioLoopback, localIp=localIp, ethTXControlFrames=ethTXControlFrames, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemE1T1ChannelMask=modemE1T1ChannelMask, modemStandard=modemStandard, modemSymbolRateRx=modemSymbolRateRx, modemAcqStatus=modemAcqStatus, modemACMmodulationMin=modemACMmodulationMin, e1t1StatEntry=e1t1StatEntry, restartcpu=restartcpu, radioDuplexShift=radioDuplexShift, ethRXCodeErrors=ethRXCodeErrors, modemACMengine=modemACMengine, modemTotalBlockNumber=modemTotalBlockNumber, ethRXCRCErrors=ethRXCRCErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXByteCounterHi=ethTXByteCounterHi, ethTXLengthCheckErrors=ethTXLengthCheckErrors, e1t1StatTable=e1t1StatTable, modemCountTime=modemCountTime, modemTotalCapacity=modemTotalCapacity, vlanTable=vlanTable, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioRxLevel=radioRxLevel, ipRadioCfgNetwork=ipRadioCfgNetwork, description=description, hostname=hostname, modemACMethernetCapacity=modemACMethernetCapacity, ipRadioCfgGeneral=ipRadioCfgGeneral, saf=saf, radioRxFrequency=radioRxFrequency, ethTXExcessiveDefers=ethTXExcessiveDefers, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXPauseFrames=ethTXPauseFrames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemErroredBlock=modemErroredBlock, ethTXGiants=ethTXGiants, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemUnavailtime=modemUnavailtime, ipRadioStatEth=ipRadioStatEth, radioEntry=radioEntry, remoteIp=remoteIp, modemErroredSecond=modemErroredSecond, radioSide=radioSide, e1t1AIS=e1t1AIS, modemModulation=modemModulation, vlanPortmap=vlanPortmap, modemE1T1Channels=modemE1T1Channels, vlanRowStatus=vlanRowStatus, modemEntry=modemEntry, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemTable=modemTable, ipRadio=ipRadio, ethTXLateCollisions=ethTXLateCollisions, ethTXCRCErrors=ethTXCRCErrors, atpcIndex=atpcIndex, ethQOSTXDropped=ethQOSTXDropped, modemRadialMSE=modemRadialMSE, ethTXCollisions=ethTXCollisions, vlanNumber=vlanNumber, ethRXLongEvents=ethRXLongEvents, radioGenStatus=radioGenStatus, modemCarrierOffset=modemCarrierOffset, product=product, license=license, ethTXDones=ethTXDones, modemGeneralStatus=modemGeneralStatus, radioTxPower=radioTxPower, ethTXBroadcasts=ethTXBroadcasts, aTPCEntry=aTPCEntry, writeConfig=writeConfig, modemACMtotalCapacity=modemACMtotalCapacity, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlanEntry=vlanEntry, ethTXMulticasts=ethTXMulticasts, ethRXMulticasts=ethRXMulticasts, ethRXTruncatedFrames=ethRXTruncatedFrames)
