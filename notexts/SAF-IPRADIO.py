...
mibBuilder.exportSymbols("SAF-IPRADIO", vlanCfgStat=vlanCfgStat, restartcpu=restartcpu, modemEntry=modemEntry, ethTXVlanTags=ethTXVlanTags, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemTotalBlockNumber=modemTotalBlockNumber, modemEthernetCapacity=modemEthernetCapacity, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethGFPFCSErrors=ethGFPFCSErrors, ethTXLateCollisions=ethTXLateCollisions, vlanFid=vlanFid, licenseUpdateStatus=licenseUpdateStatus, ethRXDvEvent=ethRXDvEvent, modemE1T1Channels=modemE1T1Channels, ethQOSTXFrames=ethQOSTXFrames, radioDuplexShift=radioDuplexShift, ethRXBroadcasts=ethRXBroadcasts, radioIndex=radioIndex, modemLastAcqError=modemLastAcqError, sysTemperature=sysTemperature, radioLoopback=radioLoopback, modemACMengine=modemACMengine, radioRxFrequency=radioRxFrequency, ethTXByteCounterLow=ethTXByteCounterLow, ethTXExcessiveDefers=ethTXExcessiveDefers, radioTable=radioTable, ethTXBackpresEvents=ethTXBackpresEvents, ethRXUnsupOpcodes=ethRXUnsupOpcodes, remoteIp=remoteIp, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemLDPCdecoderStress=modemLDPCdecoderStress, modemGeneralStatus=modemGeneralStatus, modemIndex=modemIndex, pointToPoint=pointToPoint, ipRadio=ipRadio, ethGFPDelineationErrors=ethGFPDelineationErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethGFPCHECErrors=ethGFPCHECErrors, modemTotalCapacity=modemTotalCapacity, ethRXLongEvents=ethRXLongEvents, modemACMmodulationMin=modemACMmodulationMin, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, vlansEnabled=vlansEnabled, license=license, modemACMtotalCapacity=modemACMtotalCapacity, ethTXByteCounterHi=ethTXByteCounterHi, ethRXVlanTagsDetected=ethRXVlanTagsDetected, atpcEnabled=atpcEnabled, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemErroredSecond=modemErroredSecond, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ipRadioCfg=ipRadioCfg, ethRXByteCounterLow=ethRXByteCounterLow, atpcIndex=atpcIndex, ethRXDones=ethRXDones, ethTXUnderruns=ethTXUnderruns, modemSymbolRateRx=modemSymbolRateRx, e1t1AIS=e1t1AIS, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemErroredSecondRatio=modemErroredSecondRatio, modemStandard=modemStandard, modemE1T1ChannelMask=modemE1T1ChannelMask, radioTxFrequency=radioTxFrequency, description=description, modemModulation=modemModulation, atpcTxPowerCorrection=atpcTxPowerCorrection, sysDateAndTime=sysDateAndTime, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemTable=modemTable, modemRadialMSE=modemRadialMSE, modemRowStatus=modemRowStatus, modemACMmodulationMax=modemACMmodulationMax, ethTXCRCErrors=ethTXCRCErrors, product=product, ethQOSTXDropped=ethQOSTXDropped, modemErroredBlock=modemErroredBlock, ipRadioStat=ipRadioStat, ethTXBroadcasts=ethTXBroadcasts, ipRadioCfgNetwork=ipRadioCfgNetwork, safip=safip, radioRxLevel=radioRxLevel, e1t1ChannelNr=e1t1ChannelNr, hostname=hostname, radioGenStatus=radioGenStatus, loopbacks=loopbacks, loopback_tributary_mask=loopback_tributary_mask, ethRXControlFrames=ethRXControlFrames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXMaxCollisions=ethTXMaxCollisions, modemSymbolRateTx=modemSymbolRateTx, radioTxMute=radioTxMute, vlanTable=vlanTable, modemAcqStatus=modemAcqStatus, modemStatistics=modemStatistics, writeConfig=writeConfig, microwaveRadio=microwaveRadio, vlanEntry=vlanEntry, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioTxPower=radioTxPower, ipRadioMgmt=ipRadioMgmt, localIpMask=localIpMask, modemUnavailtime=modemUnavailtime, ethRXByteCounterHi=ethRXByteCounterHi, vlanRowStatus=vlanRowStatus, ethRXCodeErrors=ethRXCodeErrors, ethRXMulticasts=ethRXMulticasts, ethTXGiants=ethTXGiants, modemCarrierOffset=modemCarrierOffset, ethTXControlFrames=ethTXControlFrames, vlanNumber=vlanNumber, ethGFPDropedFrames=ethGFPDropedFrames, modemInternalAGCgain=modemInternalAGCgain, e1t1StatEntry=e1t1StatEntry, saf=saf, ethRXDribleNibbles=ethRXDribleNibbles, vlanPortType=vlanPortType, radioSide=radioSide, ethTXMulticasts=ethTXMulticasts, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXPauseFrames=ethRXPauseFrames, ipRadioCfgGeneral=ipRadioCfgGeneral, e1t1LOS=e1t1LOS, vlanPortmap=vlanPortmap, ipRadioStatEth=ipRadioStatEth, localIp=localIp, aTPCEntry=aTPCEntry, modemBandwith=modemBandwith, modemCountTime=modemCountTime, ethRXCRCErrors=ethRXCRCErrors, licenseMask=licenseMask, ethTXDones=ethTXDones, modemUptime=modemUptime, ethTXWireByteCounterLow=ethTXWireByteCounterLow, tehnika=tehnika, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, aTPCTable=aTPCTable, e1t1StatTable=e1t1StatTable, ethTXCollisions=ethTXCollisions, ethTXPauseFrames=ethTXPauseFrames, modemACMethernetCapacity=modemACMethernetCapacity, radioEntry=radioEntry)
