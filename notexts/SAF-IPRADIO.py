...
mibBuilder.exportSymbols("SAF-IPRADIO", modemE1T1ChannelMask=modemE1T1ChannelMask, e1t1StatTable=e1t1StatTable, ethRXMulticasts=ethRXMulticasts, hostname=hostname, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, e1t1LOS=e1t1LOS, modemEthernetCapacity=modemEthernetCapacity, modemCarrierOffset=modemCarrierOffset, pointToPoint=pointToPoint, modemErroredSecondRatio=modemErroredSecondRatio, ethGFPCHECErrors=ethGFPCHECErrors, modemACMmodulationMax=modemACMmodulationMax, saf=saf, radioLoopback=radioLoopback, modemIndex=modemIndex, loopbacks=loopbacks, aTPCEntry=aTPCEntry, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemErroredBlock=modemErroredBlock, e1t1ChannelNr=e1t1ChannelNr, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioTxMute=radioTxMute, vlansEnabled=vlansEnabled, ethTXVlanTags=ethTXVlanTags, vlanCfgStat=vlanCfgStat, ethTXMaxCollisions=ethTXMaxCollisions, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXByteCounterLow=ethTXByteCounterLow, modemRadialMSE=modemRadialMSE, modemACMengine=modemACMengine, vlanNumber=vlanNumber, modemTotalCapacity=modemTotalCapacity, ethGFPDelineationErrors=ethGFPDelineationErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXControlFrames=ethTXControlFrames, safip=safip, e1t1StatEntry=e1t1StatEntry, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemTotalBlockNumber=modemTotalBlockNumber, radioDuplexShift=radioDuplexShift, sysTemperature=sysTemperature, ethRXBroadcasts=ethRXBroadcasts, ethTXUnderruns=ethTXUnderruns, ethRXCodeErrors=ethRXCodeErrors, modemUnavailtime=modemUnavailtime, modemACMmodulationMin=modemACMmodulationMin, licenseUpdateStatus=licenseUpdateStatus, modemACMtotalCapacity=modemACMtotalCapacity, ethTXByteCounterHi=ethTXByteCounterHi, radioEntry=radioEntry, modemBandwith=modemBandwith, modemErroredSecond=modemErroredSecond, modemE1T1Channels=modemE1T1Channels, licenseMask=licenseMask, ethTXMulticasts=ethTXMulticasts, radioSide=radioSide, ipRadioStatEth=ipRadioStatEth, vlanEntry=vlanEntry, radioRxLevel=radioRxLevel, ethGFPDropedFrames=ethGFPDropedFrames, remoteIp=remoteIp, ipRadioCfgNetwork=ipRadioCfgNetwork, loopback_tributary_mask=loopback_tributary_mask, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioTable=radioTable, ethTXBroadcasts=ethTXBroadcasts, vlanFid=vlanFid, modemStandard=modemStandard, atpcEnabled=atpcEnabled, ethQOSTXDropped=ethQOSTXDropped, modemLDPCdecoderStress=modemLDPCdecoderStress, radioRxFrequency=radioRxFrequency, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlanPortmap=vlanPortmap, vlanPortType=vlanPortType, description=description, modemInternalAGCgain=modemInternalAGCgain, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethQOSTXFrames=ethQOSTXFrames, radioTxPower=radioTxPower, atpcTxPowerCorrection=atpcTxPowerCorrection, modemSymbolRateTx=modemSymbolRateTx, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemStatistics=modemStatistics, modemRowStatus=modemRowStatus, radioGenStatus=radioGenStatus, modemTable=modemTable, radioIndex=radioIndex, modemSymbolRateRx=modemSymbolRateRx, ethTXBackpresEvents=ethTXBackpresEvents, ipRadioCfg=ipRadioCfg, localIpMask=localIpMask, ethTXLateCollisions=ethTXLateCollisions, modemACMethernetCapacity=modemACMethernetCapacity, writeConfig=writeConfig, ethTXDones=ethTXDones, ethTXGiants=ethTXGiants, localIp=localIp, atpcIndex=atpcIndex, ethRXDones=ethRXDones, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, tehnika=tehnika, vlanTable=vlanTable, ethRXCRCErrors=ethRXCRCErrors, ipRadioMgmt=ipRadioMgmt, ethRXControlFrames=ethRXControlFrames, ethTXWireByteCounterLow=ethTXWireByteCounterLow, restartcpu=restartcpu, ethTXCollisions=ethTXCollisions, modemEntry=modemEntry, modemUptime=modemUptime, sysDateAndTime=sysDateAndTime, modemModulation=modemModulation, ipRadioStat=ipRadioStat, ethRXByteCounterHi=ethRXByteCounterHi, ethRXTruncatedFrames=ethRXTruncatedFrames, modemCountTime=modemCountTime, modemLastAcqError=modemLastAcqError, ethTXPauseFrames=ethTXPauseFrames, e1t1AIS=e1t1AIS, ethGFPFCSErrors=ethGFPFCSErrors, modemGeneralStatus=modemGeneralStatus, ethTXCRCErrors=ethTXCRCErrors, product=product, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXDvEvent=ethRXDvEvent, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXByteCounterLow=ethRXByteCounterLow, aTPCTable=aTPCTable, ipRadio=ipRadio, ethRXPauseFrames=ethRXPauseFrames, ethRXDribleNibbles=ethRXDribleNibbles, microwaveRadio=microwaveRadio, radioTxFrequency=radioTxFrequency, modemAcqStatus=modemAcqStatus, vlanRowStatus=vlanRowStatus, ethRXLongEvents=ethRXLongEvents, ethRXUnsupOpcodes=ethRXUnsupOpcodes, license=license)
