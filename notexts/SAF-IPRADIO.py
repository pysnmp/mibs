...
mibBuilder.exportSymbols("SAF-IPRADIO", ipRadioStatEth=ipRadioStatEth, ethRXByteCounterLow=ethRXByteCounterLow, vlanCfgStat=vlanCfgStat, ipRadioCfgGeneral=ipRadioCfgGeneral, localIp=localIp, vlansEnabled=vlansEnabled, writeConfig=writeConfig, radioEntry=radioEntry, vlanPortmap=vlanPortmap, ethTXByteCounterLow=ethTXByteCounterLow, modemLastAcqError=modemLastAcqError, radioTxFrequency=radioTxFrequency, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXDvEvent=ethRXDvEvent, modemTotalBlockNumber=modemTotalBlockNumber, modemRowStatus=modemRowStatus, ethRXDribleNibbles=ethRXDribleNibbles, ethTXBroadcasts=ethTXBroadcasts, modemCountTime=modemCountTime, ethRXCRCErrors=ethRXCRCErrors, modemLDPCdecoderStress=modemLDPCdecoderStress, radioSide=radioSide, description=description, license=license, modemUnavailtime=modemUnavailtime, modemErroredSecond=modemErroredSecond, ethRXMulticasts=ethRXMulticasts, modemStatistics=modemStatistics, radioTable=radioTable, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXWireByteCounterLow=ethTXWireByteCounterLow, pointToPoint=pointToPoint, ethGFPFCSErrors=ethGFPFCSErrors, ethTXCRCErrors=ethTXCRCErrors, vlanPortType=vlanPortType, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXGiants=ethTXGiants, modemSymbolRateRx=modemSymbolRateRx, modemErroredSecondRatio=modemErroredSecondRatio, ethQOSTXFrames=ethQOSTXFrames, hostname=hostname, atpcIndex=atpcIndex, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ipRadioMgmt=ipRadioMgmt, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, licenseUpdateStatus=licenseUpdateStatus, remoteIp=remoteIp, ethGFPDropedFrames=ethGFPDropedFrames, modemInternalAGCgain=modemInternalAGCgain, ethTXMaxCollisions=ethTXMaxCollisions, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemEntry=modemEntry, ethTXByteCounterHi=ethTXByteCounterHi, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXUnderruns=ethTXUnderruns, modemGeneralStatus=modemGeneralStatus, ethTXCollisions=ethTXCollisions, modemACMengine=modemACMengine, radioRxFrequency=radioRxFrequency, radioTxMute=radioTxMute, aTPCTable=aTPCTable, sysDateAndTime=sysDateAndTime, vlanNumber=vlanNumber, ethTXExcessiveDefers=ethTXExcessiveDefers, ipRadio=ipRadio, e1t1AIS=e1t1AIS, e1t1StatTable=e1t1StatTable, ethQOSTXDropped=ethQOSTXDropped, ipRadioStat=ipRadioStat, licenseMask=licenseMask, ethTXControlFrames=ethTXControlFrames, aTPCEntry=aTPCEntry, radioIndex=radioIndex, ethRXPauseFrames=ethRXPauseFrames, vlanFid=vlanFid, radioDuplexShift=radioDuplexShift, atpcEnabled=atpcEnabled, radioLoopback=radioLoopback, radioTxPower=radioTxPower, modemBandwith=modemBandwith, modemStandard=modemStandard, saf=saf, modemACMmodulationMax=modemACMmodulationMax, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemE1T1Channels=modemE1T1Channels, safip=safip, modemErroredBlock=modemErroredBlock, microwaveRadio=microwaveRadio, product=product, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemEthernetCapacity=modemEthernetCapacity, radioRxLevel=radioRxLevel, modemCarrierOffset=modemCarrierOffset, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXBroadcasts=ethRXBroadcasts, sysTemperature=sysTemperature, ethTXLateCollisions=ethTXLateCollisions, modemModulation=modemModulation, e1t1ChannelNr=e1t1ChannelNr, vlanTable=vlanTable, vlanEntry=vlanEntry, ethRXLongEvents=ethRXLongEvents, ipRadioCfg=ipRadioCfg, vlanRowStatus=vlanRowStatus, localIpMask=localIpMask, modemSymbolRateTx=modemSymbolRateTx, ethRXDones=ethRXDones, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXDones=ethTXDones, modemRadialMSE=modemRadialMSE, loopback_tributary_mask=loopback_tributary_mask, modemTotalCapacity=modemTotalCapacity, modemACMmodulationMin=modemACMmodulationMin, ethTXVlanTags=ethTXVlanTags, ethTXMulticasts=ethTXMulticasts, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, tehnika=tehnika, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemACMtotalCapacity=modemACMtotalCapacity, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioGenStatus=radioGenStatus, modemE1T1ChannelMask=modemE1T1ChannelMask, modemUptime=modemUptime, ethTXBackpresEvents=ethTXBackpresEvents, modemTable=modemTable, ethRXCodeErrors=ethRXCodeErrors, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemACMethernetCapacity=modemACMethernetCapacity, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, restartcpu=restartcpu, e1t1LOS=e1t1LOS, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXControlFrames=ethRXControlFrames, ethRXByteCounterHi=ethRXByteCounterHi, ethGFPCHECErrors=ethGFPCHECErrors, e1t1StatEntry=e1t1StatEntry, loopbacks=loopbacks, ethTXPauseFrames=ethTXPauseFrames, modemAcqStatus=modemAcqStatus, modemIndex=modemIndex)
