...
mibBuilder.exportSymbols("SAF-IPRADIO", modemAcqStatus=modemAcqStatus, modemSymbolRateTx=modemSymbolRateTx, radioTxFrequency=radioTxFrequency, loopbacks=loopbacks, ethRXMulticasts=ethRXMulticasts, license=license, aTPCEntry=aTPCEntry, ipRadioStatEth=ipRadioStatEth, modemACMmodulationMax=modemACMmodulationMax, ethTXBackpresEvents=ethTXBackpresEvents, atpcIndex=atpcIndex, ethRXCodeErrors=ethRXCodeErrors, vlanTable=vlanTable, ipRadioCfgGeneral=ipRadioCfgGeneral, ethGFPFCSErrors=ethGFPFCSErrors, pointToPoint=pointToPoint, ethRXUnsupOpcodes=ethRXUnsupOpcodes, tehnika=tehnika, radioEntry=radioEntry, ethGFPCHECErrors=ethGFPCHECErrors, vlansEnabled=vlansEnabled, modemRadialMSE=modemRadialMSE, ipRadioMgmt=ipRadioMgmt, modemIndex=modemIndex, radioDuplexShift=radioDuplexShift, modemInternalAGCgain=modemInternalAGCgain, radioTxMute=radioTxMute, ethRXLongEvents=ethRXLongEvents, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioTable=radioTable, ethTXCRCErrors=ethTXCRCErrors, ethRXByteCounterHi=ethRXByteCounterHi, ethTXGiants=ethTXGiants, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemACMmodulationMin=modemACMmodulationMin, ethRXPauseFrames=ethRXPauseFrames, modemStatistics=modemStatistics, e1t1StatEntry=e1t1StatEntry, restartcpu=restartcpu, product=product, modemCarrierOffset=modemCarrierOffset, modemACMethernetCapacity=modemACMethernetCapacity, modemGeneralStatus=modemGeneralStatus, ipRadioCfg=ipRadioCfg, atpcEnabled=atpcEnabled, vlanEntry=vlanEntry, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXCRCErrors=ethRXCRCErrors, modemErroredSecond=modemErroredSecond, ethTXVlanTags=ethTXVlanTags, modemCountTime=modemCountTime, hostname=hostname, modemStandard=modemStandard, modemUptime=modemUptime, e1t1AIS=e1t1AIS, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXControlFrames=ethTXControlFrames, radioLoopback=radioLoopback, writeConfig=writeConfig, aTPCTable=aTPCTable, ethRXByteCounterLow=ethRXByteCounterLow, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXMaxCollisions=ethTXMaxCollisions, ipRadioStat=ipRadioStat, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, vlanFid=vlanFid, sysDateAndTime=sysDateAndTime, ethQOSTXFrames=ethQOSTXFrames, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXBroadcasts=ethTXBroadcasts, modemLastAcqError=modemLastAcqError, localIpMask=localIpMask, modemE1T1Channels=modemE1T1Channels, ethRXDones=ethRXDones, modemModulation=modemModulation, radioGenStatus=radioGenStatus, licenseMask=licenseMask, modemACMengine=modemACMengine, ethGFPDelineationErrors=ethGFPDelineationErrors, radioSide=radioSide, ethTXByteCounterHi=ethTXByteCounterHi, sysTemperature=sysTemperature, ipRadio=ipRadio, loopback_tributary_mask=loopback_tributary_mask, vlanPortmap=vlanPortmap, ethTXPauseFrames=ethTXPauseFrames, ethRXDvEvent=ethRXDvEvent, description=description, modemEthernetCapacity=modemEthernetCapacity, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethGFPDropedFrames=ethGFPDropedFrames, vlanRowStatus=vlanRowStatus, modemRowStatus=modemRowStatus, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXControlFrames=ethRXControlFrames, modemTotalCapacity=modemTotalCapacity, modemErroredBlock=modemErroredBlock, vlanNumber=vlanNumber, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXBroadcasts=ethRXBroadcasts, microwaveRadio=microwaveRadio, localIp=localIp, ethRXDribleNibbles=ethRXDribleNibbles, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioRxLevel=radioRxLevel, radioRxFrequency=radioRxFrequency, vlanPortType=vlanPortType, modemBandwith=modemBandwith, ethTXMulticasts=ethTXMulticasts, ethTXWireByteCounterLow=ethTXWireByteCounterLow, remoteIp=remoteIp, ethRXTruncatedFrames=ethRXTruncatedFrames, safip=safip, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethQOSTXDropped=ethQOSTXDropped, ethTXUnderruns=ethTXUnderruns, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemEntry=modemEntry, modemUnavailtime=modemUnavailtime, modemACMtotalCapacity=modemACMtotalCapacity, e1t1StatTable=e1t1StatTable, e1t1LOS=e1t1LOS, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioIndex=radioIndex, e1t1ChannelNr=e1t1ChannelNr, radioTxPower=radioTxPower, saf=saf, ethTXExcessiveDefers=ethTXExcessiveDefers, modemTable=modemTable, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemErroredSecondRatio=modemErroredSecondRatio, licenseUpdateStatus=licenseUpdateStatus, ethTXLateCollisions=ethTXLateCollisions, modemSymbolRateRx=modemSymbolRateRx, vlanCfgStat=vlanCfgStat, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXByteCounterLow=ethTXByteCounterLow, ethTXCollisions=ethTXCollisions, ethTXDones=ethTXDones, modemTotalBlockNumber=modemTotalBlockNumber, modemE1T1ChannelMask=modemE1T1ChannelMask)
