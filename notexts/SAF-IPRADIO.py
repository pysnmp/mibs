...
mibBuilder.exportSymbols("SAF-IPRADIO", modemEthernetCapacity=modemEthernetCapacity, e1t1LOS=e1t1LOS, modemTotalCapacity=modemTotalCapacity, loopback_tributary_mask=loopback_tributary_mask, ethRXDribleNibbles=ethRXDribleNibbles, modemUnavailtime=modemUnavailtime, modemE1T1ChannelMask=modemE1T1ChannelMask, vlanPortType=vlanPortType, ipRadioStat=ipRadioStat, radioEntry=radioEntry, remoteIp=remoteIp, modemErroredBlock=modemErroredBlock, modemAcqStatus=modemAcqStatus, ethTXGiants=ethTXGiants, modemACMmodulationMax=modemACMmodulationMax, ethQOSTXFrames=ethQOSTXFrames, modemBandwith=modemBandwith, ethGFPDropedFrames=ethGFPDropedFrames, modemIndex=modemIndex, atpcIndex=atpcIndex, ethTXByteCounterHi=ethTXByteCounterHi, ethRXCodeErrors=ethRXCodeErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXLongEvents=ethRXLongEvents, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXCRCErrors=ethRXCRCErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, saf=saf, ethTXBroadcasts=ethTXBroadcasts, modemLDPCdecoderStress=modemLDPCdecoderStress, sysTemperature=sysTemperature, modemLastAcqError=modemLastAcqError, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemCountTime=modemCountTime, vlanFid=vlanFid, ethTXVlanTags=ethTXVlanTags, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemErroredSecond=modemErroredSecond, modemACMmodulationMin=modemACMmodulationMin, modemCarrierOffset=modemCarrierOffset, vlanNumber=vlanNumber, ethTXWireByteCounterLow=ethTXWireByteCounterLow, vlansEnabled=vlansEnabled, modemSymbolRateRx=modemSymbolRateRx, vlanTable=vlanTable, loopbacks=loopbacks, ethTXCRCErrors=ethTXCRCErrors, modemStatistics=modemStatistics, hostname=hostname, radioRxLevel=radioRxLevel, ethRXByteCounterHi=ethRXByteCounterHi, radioLoopback=radioLoopback, radioDuplexShift=radioDuplexShift, e1t1StatEntry=e1t1StatEntry, ethTXByteCounterLow=ethTXByteCounterLow, radioIndex=radioIndex, ethGFPCHECErrors=ethGFPCHECErrors, radioGenStatus=radioGenStatus, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlanRowStatus=vlanRowStatus, modemTotalBlockNumber=modemTotalBlockNumber, modemE1T1Channels=modemE1T1Channels, modemRowStatus=modemRowStatus, restartcpu=restartcpu, ethRXUnsupOpcodes=ethRXUnsupOpcodes, e1t1ChannelNr=e1t1ChannelNr, ethRXTruncatedFrames=ethRXTruncatedFrames, modemGeneralStatus=modemGeneralStatus, radioTxPower=radioTxPower, description=description, ethTXPauseFrames=ethTXPauseFrames, aTPCEntry=aTPCEntry, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemStandard=modemStandard, writeConfig=writeConfig, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, tehnika=tehnika, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ipRadioStatEth=ipRadioStatEth, modemACMethernetCapacity=modemACMethernetCapacity, modemEntry=modemEntry, microwaveRadio=microwaveRadio, safip=safip, ethRXPauseFrames=ethRXPauseFrames, modemUptime=modemUptime, radioRxFrequency=radioRxFrequency, modemACMengine=modemACMengine, ethTXLateCollisions=ethTXLateCollisions, ipRadioMgmt=ipRadioMgmt, vlanCfgStat=vlanCfgStat, localIp=localIp, sysDateAndTime=sysDateAndTime, ethTXDones=ethTXDones, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXPrevPktDropped=ethRXPrevPktDropped, localIpMask=localIpMask, radioSide=radioSide, atpcEnabled=atpcEnabled, modemErroredSecondRatio=modemErroredSecondRatio, licenseMask=licenseMask, ethRXMulticasts=ethRXMulticasts, modemSymbolRateTx=modemSymbolRateTx, ethTXMaxCollisions=ethTXMaxCollisions, modemSeverelyErroredSecond=modemSeverelyErroredSecond, vlanEntry=vlanEntry, ipRadio=ipRadio, ethTXUnderruns=ethTXUnderruns, ethRXByteCounterLow=ethRXByteCounterLow, ipRadioCfgNetwork=ipRadioCfgNetwork, license=license, modemTable=modemTable, ethGFPDelineationErrors=ethGFPDelineationErrors, ethGFPFCSErrors=ethGFPFCSErrors, radioTable=radioTable, ethRXDones=ethRXDones, radioTxFrequency=radioTxFrequency, ethTXBackpresEvents=ethTXBackpresEvents, ethRXBroadcasts=ethRXBroadcasts, ethTXExcessiveDefers=ethTXExcessiveDefers, modemModulation=modemModulation, ipRadioCfg=ipRadioCfg, ethRXDvEvent=ethRXDvEvent, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, e1t1StatTable=e1t1StatTable, ethRXControlFrames=ethRXControlFrames, modemACMtotalCapacity=modemACMtotalCapacity, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethQOSTXDropped=ethQOSTXDropped, ipRadioCfgGeneral=ipRadioCfgGeneral, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, pointToPoint=pointToPoint, product=product, vlanPortmap=vlanPortmap, modemInternalAGCgain=modemInternalAGCgain, ethTXCollisions=ethTXCollisions, ethTXControlFrames=ethTXControlFrames, licenseUpdateStatus=licenseUpdateStatus, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioTxMute=radioTxMute, aTPCTable=aTPCTable, ethTXMulticasts=ethTXMulticasts, modemRadialMSE=modemRadialMSE, e1t1AIS=e1t1AIS)
