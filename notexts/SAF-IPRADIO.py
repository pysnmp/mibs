...
mibBuilder.exportSymbols("SAF-IPRADIO", modemACMtotalCapacity=modemACMtotalCapacity, remoteIp=remoteIp, ethTXByteCounterLow=ethTXByteCounterLow, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioDuplexShift=radioDuplexShift, ethRXControlFrames=ethRXControlFrames, modemAcqStatus=modemAcqStatus, pointToPoint=pointToPoint, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXMulticasts=ethRXMulticasts, radioTxFrequency=radioTxFrequency, modemE1T1ChannelMask=modemE1T1ChannelMask, modemACMethernetCapacity=modemACMethernetCapacity, e1t1StatEntry=e1t1StatEntry, e1t1AIS=e1t1AIS, saf=saf, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ipRadioCfg=ipRadioCfg, radioGenStatus=radioGenStatus, ethGFPDropedFrames=ethGFPDropedFrames, restartcpu=restartcpu, localIpMask=localIpMask, modemSymbolRateTx=modemSymbolRateTx, license=license, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXDribleNibbles=ethRXDribleNibbles, ipRadioMgmt=ipRadioMgmt, modemGeneralStatus=modemGeneralStatus, microwaveRadio=microwaveRadio, radioEntry=radioEntry, ethTXUnderruns=ethTXUnderruns, modemACMmodulationMin=modemACMmodulationMin, vlanCfgStat=vlanCfgStat, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemModulation=modemModulation, modemErroredBlock=modemErroredBlock, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioTable=radioTable, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXBroadcasts=ethTXBroadcasts, e1t1ChannelNr=e1t1ChannelNr, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ipRadioStat=ipRadioStat, atpcEnabled=atpcEnabled, modemACMengine=modemACMengine, vlanFid=vlanFid, ethTXGiants=ethTXGiants, ethTXWireByteCounterHi=ethTXWireByteCounterHi, licenseMask=licenseMask, radioIndex=radioIndex, modemBandwith=modemBandwith, ethTXCRCErrors=ethTXCRCErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlanEntry=vlanEntry, e1t1LOS=e1t1LOS, modemIndex=modemIndex, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXBroadcasts=ethRXBroadcasts, modemInternalAGCgain=modemInternalAGCgain, ethRXPauseFrames=ethRXPauseFrames, vlanTable=vlanTable, modemTotalCapacity=modemTotalCapacity, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemUptime=modemUptime, hostname=hostname, product=product, ethRXCodeErrors=ethRXCodeErrors, safip=safip, ethQOSTXFrames=ethQOSTXFrames, loopbacks=loopbacks, vlanNumber=vlanNumber, ethTXMulticasts=ethTXMulticasts, vlanPortType=vlanPortType, ethQOSTXDropped=ethQOSTXDropped, loopback_tributary_mask=loopback_tributary_mask, modemErroredSecondRatio=modemErroredSecondRatio, aTPCTable=aTPCTable, modemEthernetCapacity=modemEthernetCapacity, modemCarrierOffset=modemCarrierOffset, ethRXDvEvent=ethRXDvEvent, ethGFPCHECErrors=ethGFPCHECErrors, sysTemperature=sysTemperature, sysDateAndTime=sysDateAndTime, ethGFPDelineationErrors=ethGFPDelineationErrors, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXLongEvents=ethRXLongEvents, description=description, radioRxLevel=radioRxLevel, modemBackgroundBlockErrror=modemBackgroundBlockErrror, licenseUpdateStatus=licenseUpdateStatus, localIp=localIp, ethRXByteCounterHi=ethRXByteCounterHi, vlanPortmap=vlanPortmap, ethTXCollisions=ethTXCollisions, modemTotalBlockNumber=modemTotalBlockNumber, vlanRowStatus=vlanRowStatus, ipRadioStatEth=ipRadioStatEth, radioTxPower=radioTxPower, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemRowStatus=modemRowStatus, ipRadioCfgNetwork=ipRadioCfgNetwork, vlansEnabled=vlansEnabled, ethRXDones=ethRXDones, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemRadialMSE=modemRadialMSE, ethRXCRCErrors=ethRXCRCErrors, modemTable=modemTable, modemACMmodulationMax=modemACMmodulationMax, modemStandard=modemStandard, tehnika=tehnika, ethTXVlanTags=ethTXVlanTags, modemE1T1Channels=modemE1T1Channels, modemSymbolRateRx=modemSymbolRateRx, ethTXPauseFrames=ethTXPauseFrames, ipRadioCfgGeneral=ipRadioCfgGeneral, modemEntry=modemEntry, ethTXControlFrames=ethTXControlFrames, writeConfig=writeConfig, e1t1StatTable=e1t1StatTable, atpcIndex=atpcIndex, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemCountTime=modemCountTime, ethTXBackpresEvents=ethTXBackpresEvents, ethRXByteCounterLow=ethRXByteCounterLow, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioTxMute=radioTxMute, ipRadio=ipRadio, ethTXLateCollisions=ethTXLateCollisions, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemStatistics=modemStatistics, ethTXDones=ethTXDones, modemUnavailtime=modemUnavailtime, ethGFPFCSErrors=ethGFPFCSErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXMaxCollisions=ethTXMaxCollisions, radioSide=radioSide, radioLoopback=radioLoopback, aTPCEntry=aTPCEntry, ethTXByteCounterHi=ethTXByteCounterHi, modemErroredSecond=modemErroredSecond, modemLastAcqError=modemLastAcqError, radioRxFrequency=radioRxFrequency)
