...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXUnderruns=ethTXUnderruns, radioIndex=radioIndex, ethRXByteCounterHi=ethRXByteCounterHi, e1t1LOS=e1t1LOS, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethGFPFCSErrors=ethGFPFCSErrors, modemStatistics=modemStatistics, modemTotalBlockNumber=modemTotalBlockNumber, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemInternalAGCgain=modemInternalAGCgain, modemModulation=modemModulation, modemTotalCapacity=modemTotalCapacity, modemCarrierOffset=modemCarrierOffset, restartcpu=restartcpu, radioTxFrequency=radioTxFrequency, radioTable=radioTable, ethTXMaxCollisions=ethTXMaxCollisions, ethQOSTXFrames=ethQOSTXFrames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXMulticasts=ethTXMulticasts, modemACMengine=modemACMengine, ethRXLongEvents=ethRXLongEvents, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXDones=ethTXDones, ipRadioCfgNetwork=ipRadioCfgNetwork, description=description, ipRadio=ipRadio, modemEthernetCapacity=modemEthernetCapacity, ethTXByteCounterHi=ethTXByteCounterHi, ethRXControlFrames=ethRXControlFrames, radioEntry=radioEntry, ethRXPrevPktDropped=ethRXPrevPktDropped, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXLateCollisions=ethTXLateCollisions, radioRxLevel=radioRxLevel, microwaveRadio=microwaveRadio, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemIndex=modemIndex, radioLoopback=radioLoopback, modemACMtotalCapacity=modemACMtotalCapacity, vlanNumber=vlanNumber, modemErroredSecond=modemErroredSecond, ipRadioCfg=ipRadioCfg, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadioCfgGeneral=ipRadioCfgGeneral, modemSymbolRateRx=modemSymbolRateRx, product=product, tehnika=tehnika, localIp=localIp, e1t1ChannelNr=e1t1ChannelNr, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemSymbolRateTx=modemSymbolRateTx, aTPCTable=aTPCTable, atpcEnabled=atpcEnabled, modemErroredSecondRatio=modemErroredSecondRatio, radioTxPower=radioTxPower, modemACMmodulationMin=modemACMmodulationMin, modemBandwith=modemBandwith, modemEntry=modemEntry, modemUptime=modemUptime, radioSide=radioSide, modemLastAcqError=modemLastAcqError, vlanPortmap=vlanPortmap, licenseUpdateStatus=licenseUpdateStatus, sysTemperature=sysTemperature, ethRXVlanTagsDetected=ethRXVlanTagsDetected, pointToPoint=pointToPoint, e1t1AIS=e1t1AIS, atpcIndex=atpcIndex, ethTXGiants=ethTXGiants, hostname=hostname, ethTXControlFrames=ethTXControlFrames, modemGeneralStatus=modemGeneralStatus, vlanTable=vlanTable, vlanRowStatus=vlanRowStatus, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemRowStatus=modemRowStatus, modemACMmodulationMax=modemACMmodulationMax, modemCountTime=modemCountTime, modemUnavailtime=modemUnavailtime, saf=saf, e1t1StatEntry=e1t1StatEntry, modemRadialMSE=modemRadialMSE, license=license, modemStandard=modemStandard, ethQOSTXDropped=ethQOSTXDropped, radioRxFrequency=radioRxFrequency, modemE1T1Channels=modemE1T1Channels, ethTXPauseFrames=ethTXPauseFrames, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXCRCErrors=ethTXCRCErrors, radioGenStatus=radioGenStatus, safip=safip, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, sysDateAndTime=sysDateAndTime, ethRXPauseFrames=ethRXPauseFrames, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ipRadioMgmt=ipRadioMgmt, loopbacks=loopbacks, loopback_tributary_mask=loopback_tributary_mask, ethRXDvEvent=ethRXDvEvent, ethRXCodeErrors=ethRXCodeErrors, e1t1StatTable=e1t1StatTable, writeConfig=writeConfig, localIpMask=localIpMask, ethTXBroadcasts=ethTXBroadcasts, modemErroredBlock=modemErroredBlock, vlanPortType=vlanPortType, ethRXDribleNibbles=ethRXDribleNibbles, vlanEntry=vlanEntry, vlanCfgStat=vlanCfgStat, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ipRadioStatEth=ipRadioStatEth, ethRXMulticasts=ethRXMulticasts, ethRXDones=ethRXDones, vlanFid=vlanFid, modemACMethernetCapacity=modemACMethernetCapacity, ethRXByteCounterLow=ethRXByteCounterLow, ethTXCollisions=ethTXCollisions, ethGFPDropedFrames=ethGFPDropedFrames, ethGFPCHECErrors=ethGFPCHECErrors, ethTXBackpresEvents=ethTXBackpresEvents, ethRXBroadcasts=ethRXBroadcasts, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXCRCErrors=ethRXCRCErrors, aTPCEntry=aTPCEntry, licenseMask=licenseMask, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXExcessiveDefers=ethTXExcessiveDefers, atpcTxPowerCorrection=atpcTxPowerCorrection, vlansEnabled=vlansEnabled, radioDuplexShift=radioDuplexShift, radioTxMute=radioTxMute, modemAcqStatus=modemAcqStatus, ethTXVlanTags=ethTXVlanTags, modemTable=modemTable, remoteIp=remoteIp, ethTXByteCounterLow=ethTXByteCounterLow, ipRadioStat=ipRadioStat)
