...
mibBuilder.exportSymbols("SAF-IPRADIO", modemGeneralStatus=modemGeneralStatus, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemErroredSecondRatio=modemErroredSecondRatio, modemStandard=modemStandard, ethRXBroadcasts=ethRXBroadcasts, radioTxPower=radioTxPower, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, loopback_tributary_mask=loopback_tributary_mask, vlanNumber=vlanNumber, modemErroredBlock=modemErroredBlock, aTPCTable=aTPCTable, ethTXCollisions=ethTXCollisions, radioTxFrequency=radioTxFrequency, modemErroredSecond=modemErroredSecond, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXDones=ethTXDones, remoteIp=remoteIp, ethRXDvEvent=ethRXDvEvent, vlanTable=vlanTable, ethTXGiants=ethTXGiants, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, atpcTxPowerCorrection=atpcTxPowerCorrection, saf=saf, product=product, ipRadio=ipRadio, radioRxFrequency=radioRxFrequency, ipRadioStat=ipRadioStat, microwaveRadio=microwaveRadio, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXByteCounterLow=ethTXByteCounterLow, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemACMmodulationMax=modemACMmodulationMax, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXPauseFrames=ethTXPauseFrames, ethRXPrevPktDropped=ethRXPrevPktDropped, modemUnavailtime=modemUnavailtime, ethRXLongEvents=ethRXLongEvents, modemInternalAGCgain=modemInternalAGCgain, vlanCfgStat=vlanCfgStat, vlanRowStatus=vlanRowStatus, sysDateAndTime=sysDateAndTime, license=license, ipRadioCfgNetwork=ipRadioCfgNetwork, loopbacks=loopbacks, modemIndex=modemIndex, modemStatistics=modemStatistics, vlansEnabled=vlansEnabled, ethRXMulticasts=ethRXMulticasts, localIpMask=localIpMask, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemCountTime=modemCountTime, description=description, modemEntry=modemEntry, modemCarrierOffset=modemCarrierOffset, modemUptime=modemUptime, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXCRCErrors=ethRXCRCErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, restartcpu=restartcpu, radioRxLevel=radioRxLevel, ethTXCRCErrors=ethTXCRCErrors, ethGFPDelineationErrors=ethGFPDelineationErrors, localIp=localIp, ethRXCodeErrors=ethRXCodeErrors, radioTxMute=radioTxMute, modemEthernetCapacity=modemEthernetCapacity, ethTXMulticasts=ethTXMulticasts, modemSymbolRateTx=modemSymbolRateTx, radioGenStatus=radioGenStatus, modemACMengine=modemACMengine, tehnika=tehnika, radioEntry=radioEntry, ethTXControlFrames=ethTXControlFrames, ethRXDones=ethRXDones, ethTXBackpresEvents=ethTXBackpresEvents, modemACMmodulationMin=modemACMmodulationMin, modemTotalBlockNumber=modemTotalBlockNumber, e1t1StatTable=e1t1StatTable, radioLoopback=radioLoopback, ipRadioMgmt=ipRadioMgmt, ethGFPCHECErrors=ethGFPCHECErrors, radioDuplexShift=radioDuplexShift, hostname=hostname, modemAcqStatus=modemAcqStatus, ethQOSRXQ1Frames=ethQOSRXQ1Frames, e1t1StatEntry=e1t1StatEntry, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, sysTemperature=sysTemperature, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, e1t1AIS=e1t1AIS, licenseMask=licenseMask, atpcEnabled=atpcEnabled, ethRXDribleNibbles=ethRXDribleNibbles, ethTXBroadcasts=ethTXBroadcasts, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXControlFrames=ethRXControlFrames, modemRowStatus=modemRowStatus, atpcIndex=atpcIndex, ethTXVlanTags=ethTXVlanTags, radioTable=radioTable, modemModulation=modemModulation, ipRadioCfg=ipRadioCfg, vlanPortType=vlanPortType, ipRadioStatEth=ipRadioStatEth, modemBandwith=modemBandwith, modemTable=modemTable, ethGFPFCSErrors=ethGFPFCSErrors, modemACMtotalCapacity=modemACMtotalCapacity, modemBackgroundBlockErrror=modemBackgroundBlockErrror, pointToPoint=pointToPoint, safip=safip, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, e1t1ChannelNr=e1t1ChannelNr, modemRadialMSE=modemRadialMSE, modemLastAcqError=modemLastAcqError, e1t1LOS=e1t1LOS, ethGFPDropedFrames=ethGFPDropedFrames, ethTXMaxCollisions=ethTXMaxCollisions, radioSide=radioSide, modemSymbolRateRx=modemSymbolRateRx, ethTXUnderruns=ethTXUnderruns, ipRadioCfgGeneral=ipRadioCfgGeneral, writeConfig=writeConfig, radioIndex=radioIndex, modemTotalCapacity=modemTotalCapacity, aTPCEntry=aTPCEntry, modemE1T1Channels=modemE1T1Channels, ethRXByteCounterLow=ethRXByteCounterLow, ethTXByteCounterHi=ethTXByteCounterHi, ethRXPauseFrames=ethRXPauseFrames, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXByteCounterHi=ethRXByteCounterHi, vlanFid=vlanFid, licenseUpdateStatus=licenseUpdateStatus, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethQOSTXDropped=ethQOSTXDropped, vlanPortmap=vlanPortmap, modemACMethernetCapacity=modemACMethernetCapacity, ethTXLateCollisions=ethTXLateCollisions, vlanEntry=vlanEntry, ethQOSTXFrames=ethQOSTXFrames, ethTXWireByteCounterHi=ethTXWireByteCounterHi)
