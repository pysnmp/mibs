...
mibBuilder.exportSymbols("SAF-IPRADIO", modemTotalCapacity=modemTotalCapacity, modemCarrierOffset=modemCarrierOffset, vlanRowStatus=vlanRowStatus, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXVlanTags=ethTXVlanTags, modemTable=modemTable, vlanTable=vlanTable, ethRXByteCounterLow=ethRXByteCounterLow, ethRXMulticasts=ethRXMulticasts, modemE1T1Channels=modemE1T1Channels, radioRxFrequency=radioRxFrequency, modemACMmodulationMin=modemACMmodulationMin, ethTXCRCErrors=ethTXCRCErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemACMtotalCapacity=modemACMtotalCapacity, ipRadioStat=ipRadioStat, vlanFid=vlanFid, modemModulation=modemModulation, ipRadioStatEth=ipRadioStatEth, product=product, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioTxFrequency=radioTxFrequency, radioGenStatus=radioGenStatus, atpcTxPowerCorrection=atpcTxPowerCorrection, modemTotalBlockNumber=modemTotalBlockNumber, radioSide=radioSide, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXByteCounterLow=ethTXByteCounterLow, radioTxPower=radioTxPower, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemStandard=modemStandard, ethRXCodeErrors=ethRXCodeErrors, radioLoopback=radioLoopback, modemEntry=modemEntry, radioDuplexShift=radioDuplexShift, vlansEnabled=vlansEnabled, ethTXBackpresEvents=ethTXBackpresEvents, vlanPortType=vlanPortType, microwaveRadio=microwaveRadio, ethTXByteCounterHi=ethTXByteCounterHi, modemACMmodulationMax=modemACMmodulationMax, ipRadioCfg=ipRadioCfg, ipRadioCfgGeneral=ipRadioCfgGeneral, modemRowStatus=modemRowStatus, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXWireByteCounterLow=ethTXWireByteCounterLow, remoteIp=remoteIp, vlanNumber=vlanNumber, pointToPoint=pointToPoint, radioIndex=radioIndex, modemStatistics=modemStatistics, modemInternalAGCgain=modemInternalAGCgain, ethRXPrevPktDropped=ethRXPrevPktDropped, modemBackgroundBlockErrror=modemBackgroundBlockErrror, sysDateAndTime=sysDateAndTime, ethTXMulticasts=ethTXMulticasts, ethRXDvEvent=ethRXDvEvent, ethRXBroadcasts=ethRXBroadcasts, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXDones=ethTXDones, atpcEnabled=atpcEnabled, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemUptime=modemUptime, radioTxMute=radioTxMute, licenseMask=licenseMask, localIp=localIp, e1t1StatTable=e1t1StatTable, ethTXPauseFrames=ethTXPauseFrames, modemLastAcqError=modemLastAcqError, ethTXLateCollisions=ethTXLateCollisions, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemSymbolRateTx=modemSymbolRateTx, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemErroredBlock=modemErroredBlock, modemEthernetCapacity=modemEthernetCapacity, vlanCfgStat=vlanCfgStat, tehnika=tehnika, license=license, description=description, localIpMask=localIpMask, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemErroredSecond=modemErroredSecond, ethTXUnderruns=ethTXUnderruns, modemLDPCdecoderStress=modemLDPCdecoderStress, ipRadioMgmt=ipRadioMgmt, modemErroredSecondRatio=modemErroredSecondRatio, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, licenseUpdateStatus=licenseUpdateStatus, vlanEntry=vlanEntry, ipRadio=ipRadio, aTPCTable=aTPCTable, ethRXByteCounterHi=ethRXByteCounterHi, ethTXBroadcasts=ethTXBroadcasts, modemIndex=modemIndex, writeConfig=writeConfig, modemSymbolRateRx=modemSymbolRateRx, modemAcqStatus=modemAcqStatus, sysTemperature=sysTemperature, ethTXCollisions=ethTXCollisions, radioTable=radioTable, modemACMengine=modemACMengine, ethRXUnsupOpcodes=ethRXUnsupOpcodes, vlanPortmap=vlanPortmap, loopback_tributary_mask=loopback_tributary_mask, e1t1ChannelNr=e1t1ChannelNr, ethGFPFCSErrors=ethGFPFCSErrors, ethTXControlFrames=ethTXControlFrames, radioEntry=radioEntry, ethTXGiants=ethTXGiants, modemBandwith=modemBandwith, ethRXLongEvents=ethRXLongEvents, modemUnavailtime=modemUnavailtime, atpcIndex=atpcIndex, ethQOSTXFrames=ethQOSTXFrames, ethRXPauseFrames=ethRXPauseFrames, modemGeneralStatus=modemGeneralStatus, modemACMethernetCapacity=modemACMethernetCapacity, ethRXDones=ethRXDones, hostname=hostname, saf=saf, radioRxLevel=radioRxLevel, modemRadialMSE=modemRadialMSE, ethGFPDropedFrames=ethGFPDropedFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, loopbacks=loopbacks, aTPCEntry=aTPCEntry, ethQOSTXDropped=ethQOSTXDropped, ethRXDribleNibbles=ethRXDribleNibbles, modemCountTime=modemCountTime, ipRadioCfgNetwork=ipRadioCfgNetwork, safip=safip, ethTXMaxCollisions=ethTXMaxCollisions, ethQOSRXQ2Frames=ethQOSRXQ2Frames, e1t1StatEntry=e1t1StatEntry, ethRXControlFrames=ethRXControlFrames, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, e1t1AIS=e1t1AIS, ethGFPCHECErrors=ethGFPCHECErrors, ethRXCRCErrors=ethRXCRCErrors, e1t1LOS=e1t1LOS, modemE1T1ChannelMask=modemE1T1ChannelMask, restartcpu=restartcpu)
