...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXMulticasts=ethRXMulticasts, modemRowStatus=modemRowStatus, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXByteCounterHi=ethTXByteCounterHi, ethTXMulticasts=ethTXMulticasts, modemModulation=modemModulation, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXVlanTags=ethTXVlanTags, ipRadio=ipRadio, vlanCfgStat=vlanCfgStat, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemEntry=modemEntry, radioTable=radioTable, vlanTable=vlanTable, radioLoopback=radioLoopback, ethTXBroadcasts=ethTXBroadcasts, modemBackgroundBlockErrror=modemBackgroundBlockErrror, sysTemperature=sysTemperature, ethRXPrevPktDropped=ethRXPrevPktDropped, modemStandard=modemStandard, product=product, modemACMethernetCapacity=modemACMethernetCapacity, modemACMtotalCapacity=modemACMtotalCapacity, modemGeneralStatus=modemGeneralStatus, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemTable=modemTable, modemStatistics=modemStatistics, loopbacks=loopbacks, localIpMask=localIpMask, radioTxFrequency=radioTxFrequency, ethRXCRCErrors=ethRXCRCErrors, atpcEnabled=atpcEnabled, ethTXLateCollisions=ethTXLateCollisions, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, vlanPortType=vlanPortType, licenseMask=licenseMask, remoteIp=remoteIp, ethQOSTXDropped=ethQOSTXDropped, ethRXByteCounterLow=ethRXByteCounterLow, modemUnavailtime=modemUnavailtime, modemErroredSecond=modemErroredSecond, microwaveRadio=microwaveRadio, vlanPortmap=vlanPortmap, ethTXDones=ethTXDones, ethRXLongEvents=ethRXLongEvents, modemACMmodulationMax=modemACMmodulationMax, ethGFPDropedFrames=ethGFPDropedFrames, radioSide=radioSide, ethTXControlFrames=ethTXControlFrames, e1t1ChannelNr=e1t1ChannelNr, modemUptime=modemUptime, radioRxFrequency=radioRxFrequency, modemTotalBlockNumber=modemTotalBlockNumber, ethTXGiants=ethTXGiants, radioIndex=radioIndex, radioGenStatus=radioGenStatus, aTPCTable=aTPCTable, description=description, ipRadioCfgGeneral=ipRadioCfgGeneral, ethGFPDelineationErrors=ethGFPDelineationErrors, ethGFPCHECErrors=ethGFPCHECErrors, modemRadialMSE=modemRadialMSE, ethRXControlFrames=ethRXControlFrames, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemInternalAGCgain=modemInternalAGCgain, ipRadioCfg=ipRadioCfg, ethRXCodeErrors=ethRXCodeErrors, aTPCEntry=aTPCEntry, ethTXCollisions=ethTXCollisions, modemCarrierOffset=modemCarrierOffset, radioEntry=radioEntry, radioRxLevel=radioRxLevel, ethRXBroadcasts=ethRXBroadcasts, ethTXExcessiveDefers=ethTXExcessiveDefers, modemE1T1ChannelMask=modemE1T1ChannelMask, modemACMengine=modemACMengine, license=license, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioTxMute=radioTxMute, ethGFPFCSErrors=ethGFPFCSErrors, modemSymbolRateRx=modemSymbolRateRx, modemEthernetCapacity=modemEthernetCapacity, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXDones=ethRXDones, ipRadioCfgNetwork=ipRadioCfgNetwork, loopback_tributary_mask=loopback_tributary_mask, modemBandwith=modemBandwith, modemACMmodulationMin=modemACMmodulationMin, ethRXByteCounterHi=ethRXByteCounterHi, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemLastAcqError=modemLastAcqError, ethTXCRCErrors=ethTXCRCErrors, safip=safip, e1t1StatEntry=e1t1StatEntry, ethTXBackpresEvents=ethTXBackpresEvents, ethRXPauseFrames=ethRXPauseFrames, ethRXTruncatedFrames=ethRXTruncatedFrames, licenseUpdateStatus=licenseUpdateStatus, ethRXDribleNibbles=ethRXDribleNibbles, saf=saf, modemIndex=modemIndex, modemCountTime=modemCountTime, ipRadioStat=ipRadioStat, sysDateAndTime=sysDateAndTime, e1t1LOS=e1t1LOS, e1t1AIS=e1t1AIS, modemAcqStatus=modemAcqStatus, writeConfig=writeConfig, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethQOSTXFrames=ethQOSTXFrames, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemTotalCapacity=modemTotalCapacity, ethTXPauseFrames=ethTXPauseFrames, modemLDPCdecoderStress=modemLDPCdecoderStress, radioDuplexShift=radioDuplexShift, modemErroredSecondRatio=modemErroredSecondRatio, atpcIndex=atpcIndex, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlanEntry=vlanEntry, vlanNumber=vlanNumber, ipRadioMgmt=ipRadioMgmt, vlanFid=vlanFid, ethTXWireByteCounterLow=ethTXWireByteCounterLow, vlanRowStatus=vlanRowStatus, localIp=localIp, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlansEnabled=vlansEnabled, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemSymbolRateTx=modemSymbolRateTx, modemE1T1Channels=modemE1T1Channels, ethTXByteCounterLow=ethTXByteCounterLow, ethTXMaxCollisions=ethTXMaxCollisions, hostname=hostname, tehnika=tehnika, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemErroredBlock=modemErroredBlock, modemSeverelyErroredSecond=modemSeverelyErroredSecond, e1t1StatTable=e1t1StatTable, pointToPoint=pointToPoint, ipRadioStatEth=ipRadioStatEth, ethRXDvEvent=ethRXDvEvent, restartcpu=restartcpu, radioTxPower=radioTxPower, ethTXUnderruns=ethTXUnderruns)
