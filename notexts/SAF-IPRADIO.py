...
mibBuilder.exportSymbols("SAF-IPRADIO", radioTxPower=radioTxPower, e1t1AIS=e1t1AIS, radioIndex=radioIndex, aTPCEntry=aTPCEntry, ipRadioCfg=ipRadioCfg, license=license, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioRxLevel=radioRxLevel, vlanFid=vlanFid, modemUnavailtime=modemUnavailtime, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXVlanTags=ethTXVlanTags, ethTXBackpresEvents=ethTXBackpresEvents, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXLongEvents=ethRXLongEvents, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioTable=radioTable, ethRXControlFrames=ethRXControlFrames, ethRXMulticasts=ethRXMulticasts, safip=safip, modemSymbolRateRx=modemSymbolRateRx, licenseUpdateStatus=licenseUpdateStatus, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXControlFrames=ethTXControlFrames, radioGenStatus=radioGenStatus, ethTXMulticasts=ethTXMulticasts, modemCountTime=modemCountTime, modemErroredSecond=modemErroredSecond, modemTotalBlockNumber=modemTotalBlockNumber, modemSymbolRateTx=modemSymbolRateTx, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemACMethernetCapacity=modemACMethernetCapacity, radioTxFrequency=radioTxFrequency, modemAcqStatus=modemAcqStatus, e1t1StatEntry=e1t1StatEntry, e1t1LOS=e1t1LOS, vlanEntry=vlanEntry, ethRXByteCounterLow=ethRXByteCounterLow, ethTXMaxCollisions=ethTXMaxCollisions, modemTable=modemTable, vlanNumber=vlanNumber, ethQOSTXDropped=ethQOSTXDropped, radioLoopback=radioLoopback, modemACMmodulationMax=modemACMmodulationMax, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemTotalCapacity=modemTotalCapacity, ethTXPauseFrames=ethTXPauseFrames, loopback_tributary_mask=loopback_tributary_mask, modemUptime=modemUptime, modemLastAcqError=modemLastAcqError, ethRXByteCounterHi=ethRXByteCounterHi, radioDuplexShift=radioDuplexShift, modemErroredBlock=modemErroredBlock, vlanTable=vlanTable, microwaveRadio=microwaveRadio, ipRadio=ipRadio, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemGeneralStatus=modemGeneralStatus, description=description, ethTXBroadcasts=ethTXBroadcasts, modemLDPCdecoderStress=modemLDPCdecoderStress, sysDateAndTime=sysDateAndTime, modemBandwith=modemBandwith, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlanCfgStat=vlanCfgStat, modemCarrierOffset=modemCarrierOffset, localIpMask=localIpMask, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXPrevPktDropped=ethRXPrevPktDropped, saf=saf, ipRadioStatEth=ipRadioStatEth, modemRadialMSE=modemRadialMSE, ethTXCRCErrors=ethTXCRCErrors, tehnika=tehnika, modemIndex=modemIndex, modemErroredSecondRatio=modemErroredSecondRatio, ethRXCodeErrors=ethRXCodeErrors, modemE1T1Channels=modemE1T1Channels, ethQOSTXFrames=ethQOSTXFrames, ethTXGiants=ethTXGiants, loopbacks=loopbacks, radioEntry=radioEntry, hostname=hostname, ethGFPDropedFrames=ethGFPDropedFrames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, writeConfig=writeConfig, vlansEnabled=vlansEnabled, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXDribleNibbles=ethRXDribleNibbles, licenseMask=licenseMask, modemInternalAGCgain=modemInternalAGCgain, atpcEnabled=atpcEnabled, radioTxMute=radioTxMute, modemRowStatus=modemRowStatus, product=product, radioRxFrequency=radioRxFrequency, radioSide=radioSide, ethRXPauseFrames=ethRXPauseFrames, remoteIp=remoteIp, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXUnderruns=ethTXUnderruns, sysTemperature=sysTemperature, modemStandard=modemStandard, ethTXByteCounterLow=ethTXByteCounterLow, atpcTxPowerCorrection=atpcTxPowerCorrection, e1t1ChannelNr=e1t1ChannelNr, modemEthernetCapacity=modemEthernetCapacity, aTPCTable=aTPCTable, ipRadioMgmt=ipRadioMgmt, restartcpu=restartcpu, ethRXBroadcasts=ethRXBroadcasts, ethGFPFCSErrors=ethGFPFCSErrors, ethRXDvEvent=ethRXDvEvent, modemModulation=modemModulation, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXDones=ethTXDones, ethTXByteCounterHi=ethTXByteCounterHi, ethQOSRXQ2Frames=ethQOSRXQ2Frames, atpcIndex=atpcIndex, modemStatistics=modemStatistics, ethGFPCHECErrors=ethGFPCHECErrors, localIp=localIp, pointToPoint=pointToPoint, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, vlanRowStatus=vlanRowStatus, modemACMtotalCapacity=modemACMtotalCapacity, modemSeverelyErroredSecond=modemSeverelyErroredSecond, e1t1StatTable=e1t1StatTable, ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlanPortType=vlanPortType, ipRadioStat=ipRadioStat, vlanPortmap=vlanPortmap, modemACMengine=modemACMengine, modemACMmodulationMin=modemACMmodulationMin, ipRadioCfgNetwork=ipRadioCfgNetwork, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXDones=ethRXDones, ethRXCRCErrors=ethRXCRCErrors, ethTXCollisions=ethTXCollisions, modemEntry=modemEntry, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXLateCollisions=ethTXLateCollisions)
