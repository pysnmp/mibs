...
mibBuilder.exportSymbols("SAF-IPRADIO", localIpMask=localIpMask, modemUptime=modemUptime, aTPCEntry=aTPCEntry, ethTXCRCErrors=ethTXCRCErrors, ethTXControlFrames=ethTXControlFrames, modemLDPCdecoderStress=modemLDPCdecoderStress, radioTxMute=radioTxMute, ethRXUnsupOpcodes=ethRXUnsupOpcodes, loopback_tributary_mask=loopback_tributary_mask, vlanFid=vlanFid, modemRowStatus=modemRowStatus, modemErroredBlock=modemErroredBlock, radioTable=radioTable, ethRXTruncatedFrames=ethRXTruncatedFrames, product=product, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXMulticasts=ethRXMulticasts, modemCountTime=modemCountTime, ethTXExcessiveDefers=ethTXExcessiveDefers, e1t1AIS=e1t1AIS, modemErroredSecondRatio=modemErroredSecondRatio, modemACMethernetCapacity=modemACMethernetCapacity, modemBandwith=modemBandwith, ipRadioCfg=ipRadioCfg, ethTXWireByteCounterHi=ethTXWireByteCounterHi, loopbacks=loopbacks, e1t1StatTable=e1t1StatTable, radioLoopback=radioLoopback, modemEntry=modemEntry, e1t1StatEntry=e1t1StatEntry, ethRXDribleNibbles=ethRXDribleNibbles, ethRXCodeErrors=ethRXCodeErrors, vlansEnabled=vlansEnabled, sysTemperature=sysTemperature, saf=saf, ethRXControlFrames=ethRXControlFrames, vlanPortType=vlanPortType, atpcTxPowerCorrection=atpcTxPowerCorrection, ethQOSTXDropped=ethQOSTXDropped, ethRXLongEvents=ethRXLongEvents, radioTxFrequency=radioTxFrequency, licenseMask=licenseMask, modemModulation=modemModulation, radioDuplexShift=radioDuplexShift, atpcIndex=atpcIndex, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemStatistics=modemStatistics, modemACMmodulationMax=modemACMmodulationMax, safip=safip, vlanCfgStat=vlanCfgStat, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemIndex=modemIndex, ipRadioMgmt=ipRadioMgmt, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, aTPCTable=aTPCTable, ethTXBackpresEvents=ethTXBackpresEvents, ethRXBroadcasts=ethRXBroadcasts, ipRadioCfgGeneral=ipRadioCfgGeneral, modemACMtotalCapacity=modemACMtotalCapacity, modemLastAcqError=modemLastAcqError, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemE1T1Channels=modemE1T1Channels, modemCarrierOffset=modemCarrierOffset, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemGeneralStatus=modemGeneralStatus, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemSymbolRateTx=modemSymbolRateTx, radioSide=radioSide, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXLateCollisions=ethTXLateCollisions, ethTXGiants=ethTXGiants, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXDones=ethTXDones, modemErroredSecond=modemErroredSecond, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXDones=ethRXDones, license=license, microwaveRadio=microwaveRadio, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXMaxCollisions=ethTXMaxCollisions, ethGFPDropedFrames=ethGFPDropedFrames, tehnika=tehnika, ethTXByteCounterHi=ethTXByteCounterHi, restartcpu=restartcpu, modemInternalAGCgain=modemInternalAGCgain, e1t1ChannelNr=e1t1ChannelNr, atpcEnabled=atpcEnabled, ethRXPauseFrames=ethRXPauseFrames, radioRxLevel=radioRxLevel, radioTxPower=radioTxPower, pointToPoint=pointToPoint, ethTXCollisions=ethTXCollisions, modemAcqStatus=modemAcqStatus, vlanNumber=vlanNumber, ethRXByteCounterHi=ethRXByteCounterHi, ipRadioStat=ipRadioStat, radioRxFrequency=radioRxFrequency, hostname=hostname, vlanPortmap=vlanPortmap, modemACMmodulationMin=modemACMmodulationMin, ethRXByteCounterLow=ethRXByteCounterLow, ethTXByteCounterLow=ethTXByteCounterLow, modemStandard=modemStandard, ethTXVlanTags=ethTXVlanTags, modemUnavailtime=modemUnavailtime, radioEntry=radioEntry, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ipRadioStatEth=ipRadioStatEth, ethQOSTXFrames=ethQOSTXFrames, modemEthernetCapacity=modemEthernetCapacity, e1t1LOS=e1t1LOS, ipRadioCfgNetwork=ipRadioCfgNetwork, modemSymbolRateRx=modemSymbolRateRx, vlanRowStatus=vlanRowStatus, modemTotalCapacity=modemTotalCapacity, vlanTable=vlanTable, sysDateAndTime=sysDateAndTime, writeConfig=writeConfig, radioIndex=radioIndex, localIp=localIp, modemTable=modemTable, licenseUpdateStatus=licenseUpdateStatus, modemE1T1ChannelMask=modemE1T1ChannelMask, description=description, modemRadialMSE=modemRadialMSE, ethRXPrevPktDropped=ethRXPrevPktDropped, remoteIp=remoteIp, ethTXBroadcasts=ethTXBroadcasts, ethTXPauseFrames=ethTXPauseFrames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ipRadio=ipRadio, vlanEntry=vlanEntry, radioGenStatus=radioGenStatus, ethTXUnderruns=ethTXUnderruns, ethRXDvEvent=ethRXDvEvent, modemTotalBlockNumber=modemTotalBlockNumber, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemACMengine=modemACMengine, ethGFPCHECErrors=ethGFPCHECErrors, ethGFPFCSErrors=ethGFPFCSErrors, ethRXCRCErrors=ethRXCRCErrors, ethTXMulticasts=ethTXMulticasts)
