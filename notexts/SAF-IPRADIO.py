...
mibBuilder.exportSymbols("SAF-IPRADIO", modemStandard=modemStandard, modemTable=modemTable, ethTXLateCollisions=ethTXLateCollisions, microwaveRadio=microwaveRadio, radioRxFrequency=radioRxFrequency, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethQOSTXDropped=ethQOSTXDropped, radioSide=radioSide, modemRowStatus=modemRowStatus, modemLastAcqError=modemLastAcqError, modemStatistics=modemStatistics, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXByteCounterLow=ethTXByteCounterLow, e1t1ChannelNr=e1t1ChannelNr, radioDuplexShift=radioDuplexShift, modemBandwith=modemBandwith, vlansEnabled=vlansEnabled, modemTotalBlockNumber=modemTotalBlockNumber, product=product, ethRXMulticasts=ethRXMulticasts, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemACMmodulationMin=modemACMmodulationMin, ipRadioCfgNetwork=ipRadioCfgNetwork, radioTxMute=radioTxMute, modemCarrierOffset=modemCarrierOffset, modemSymbolRateRx=modemSymbolRateRx, ethGFPCHECErrors=ethGFPCHECErrors, radioTable=radioTable, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXDvEvent=ethRXDvEvent, ethTXWireByteCounterLow=ethTXWireByteCounterLow, vlanNumber=vlanNumber, ethGFPDelineationErrors=ethGFPDelineationErrors, modemRadialMSE=modemRadialMSE, ethRXByteCounterLow=ethRXByteCounterLow, modemUnavailtime=modemUnavailtime, radioLoopback=radioLoopback, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemE1T1Channels=modemE1T1Channels, modemIndex=modemIndex, ethQOSTXFrames=ethQOSTXFrames, sysDateAndTime=sysDateAndTime, hostname=hostname, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemEntry=modemEntry, vlanPortType=vlanPortType, ipRadioCfgGeneral=ipRadioCfgGeneral, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemAcqStatus=modemAcqStatus, ethRXCRCErrors=ethRXCRCErrors, ethRXControlFrames=ethRXControlFrames, e1t1StatTable=e1t1StatTable, ethGFPDropedFrames=ethGFPDropedFrames, ipRadioStatEth=ipRadioStatEth, modemACMengine=modemACMengine, ethTXByteCounterHi=ethTXByteCounterHi, ethTXUnderruns=ethTXUnderruns, modemACMmodulationMax=modemACMmodulationMax, modemGeneralStatus=modemGeneralStatus, description=description, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, e1t1LOS=e1t1LOS, modemUptime=modemUptime, ethGFPFCSErrors=ethGFPFCSErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, e1t1AIS=e1t1AIS, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXByteCounterHi=ethRXByteCounterHi, vlanPortmap=vlanPortmap, ethTXMaxCollisions=ethTXMaxCollisions, modemModulation=modemModulation, sysTemperature=sysTemperature, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemSymbolRateTx=modemSymbolRateTx, loopback_tributary_mask=loopback_tributary_mask, ethTXCollisions=ethTXCollisions, localIpMask=localIpMask, ethTXVlanTags=ethTXVlanTags, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXDones=ethRXDones, ethRXDribleNibbles=ethRXDribleNibbles, modemErroredBlock=modemErroredBlock, modemACMethernetCapacity=modemACMethernetCapacity, ethTXGiants=ethTXGiants, restartcpu=restartcpu, ethTXControlFrames=ethTXControlFrames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemInternalAGCgain=modemInternalAGCgain, radioGenStatus=radioGenStatus, atpcEnabled=atpcEnabled, writeConfig=writeConfig, ethTXMulticasts=ethTXMulticasts, licenseMask=licenseMask, ethTXExcessiveDefers=ethTXExcessiveDefers, pointToPoint=pointToPoint, vlanEntry=vlanEntry, e1t1StatEntry=e1t1StatEntry, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXPauseFrames=ethRXPauseFrames, loopbacks=loopbacks, vlanRowStatus=vlanRowStatus, radioTxPower=radioTxPower, ethRXBroadcasts=ethRXBroadcasts, atpcIndex=atpcIndex, modemErroredSecond=modemErroredSecond, ethRXTruncatedFrames=ethRXTruncatedFrames, saf=saf, safip=safip, modemEthernetCapacity=modemEthernetCapacity, modemCountTime=modemCountTime, ethTXBroadcasts=ethTXBroadcasts, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlanFid=vlanFid, ipRadioStat=ipRadioStat, aTPCEntry=aTPCEntry, licenseUpdateStatus=licenseUpdateStatus, ethRXCodeErrors=ethRXCodeErrors, aTPCTable=aTPCTable, modemErroredSecondRatio=modemErroredSecondRatio, ethTXPauseFrames=ethTXPauseFrames, ethRXLongEvents=ethRXLongEvents, radioIndex=radioIndex, radioTxFrequency=radioTxFrequency, radioRxLevel=radioRxLevel, modemTotalCapacity=modemTotalCapacity, ethTXDones=ethTXDones, vlanTable=vlanTable, tehnika=tehnika, ipRadioMgmt=ipRadioMgmt, modemACMtotalCapacity=modemACMtotalCapacity, radioEntry=radioEntry, vlanCfgStat=vlanCfgStat, license=license, localIp=localIp, ipRadioCfg=ipRadioCfg, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ipRadio=ipRadio, ethTXCRCErrors=ethTXCRCErrors, remoteIp=remoteIp, ethTXBackpresEvents=ethTXBackpresEvents)
