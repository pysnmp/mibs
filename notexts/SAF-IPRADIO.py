...
mibBuilder.exportSymbols("SAF-IPRADIO", modemSymbolRateRx=modemSymbolRateRx, vlanPortType=vlanPortType, modemAcqStatus=modemAcqStatus, vlanTable=vlanTable, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXLongEvents=ethRXLongEvents, ethTXCRCErrors=ethTXCRCErrors, ethGFPCHECErrors=ethGFPCHECErrors, tehnika=tehnika, sysDateAndTime=sysDateAndTime, modemIndex=modemIndex, ipRadioCfgNetwork=ipRadioCfgNetwork, modemGeneralStatus=modemGeneralStatus, ethTXMaxCollisions=ethTXMaxCollisions, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioTxFrequency=radioTxFrequency, pointToPoint=pointToPoint, vlanEntry=vlanEntry, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemInternalAGCgain=modemInternalAGCgain, sysTemperature=sysTemperature, ethRXDribleNibbles=ethRXDribleNibbles, modemTotalCapacity=modemTotalCapacity, ipRadioStatEth=ipRadioStatEth, localIpMask=localIpMask, ethQOSRXQ2Frames=ethQOSRXQ2Frames, safip=safip, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemTotalBlockNumber=modemTotalBlockNumber, ethQOSTXDropped=ethQOSTXDropped, modemBandwith=modemBandwith, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXBackpresEvents=ethTXBackpresEvents, modemBackgroundBlockErrror=modemBackgroundBlockErrror, loopbacks=loopbacks, modemEntry=modemEntry, vlanFid=vlanFid, ethTXUnderruns=ethTXUnderruns, aTPCEntry=aTPCEntry, radioLoopback=radioLoopback, ethTXExcessiveDefers=ethTXExcessiveDefers, radioIndex=radioIndex, modemCountTime=modemCountTime, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXControlFrames=ethTXControlFrames, ethTXBroadcasts=ethTXBroadcasts, ethRXPauseFrames=ethRXPauseFrames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemStatistics=modemStatistics, ipRadioStat=ipRadioStat, modemRadialMSE=modemRadialMSE, vlansEnabled=vlansEnabled, radioGenStatus=radioGenStatus, vlanCfgStat=vlanCfgStat, ethQOSTXFrames=ethQOSTXFrames, writeConfig=writeConfig, modemACMengine=modemACMengine, license=license, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, loopback_tributary_mask=loopback_tributary_mask, ethRXCodeErrors=ethRXCodeErrors, ethTXCollisions=ethTXCollisions, e1t1ChannelNr=e1t1ChannelNr, modemACMmodulationMin=modemACMmodulationMin, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXByteCounterHi=ethTXByteCounterHi, radioDuplexShift=radioDuplexShift, licenseUpdateStatus=licenseUpdateStatus, modemRowStatus=modemRowStatus, restartcpu=restartcpu, modemErroredSecond=modemErroredSecond, ipRadioMgmt=ipRadioMgmt, localIp=localIp, modemStandard=modemStandard, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXMulticasts=ethRXMulticasts, radioTxPower=radioTxPower, radioRxFrequency=radioRxFrequency, e1t1LOS=e1t1LOS, vlanRowStatus=vlanRowStatus, ethRXByteCounterHi=ethRXByteCounterHi, modemSeverelyErroredSecond=modemSeverelyErroredSecond, product=product, ethRXDvEvent=ethRXDvEvent, modemACMtotalCapacity=modemACMtotalCapacity, description=description, microwaveRadio=microwaveRadio, vlanNumber=vlanNumber, vlanPortmap=vlanPortmap, hostname=hostname, modemACMmodulationMax=modemACMmodulationMax, remoteIp=remoteIp, atpcEnabled=atpcEnabled, modemSymbolRateTx=modemSymbolRateTx, ethTXGiants=ethTXGiants, modemLDPCdecoderStress=modemLDPCdecoderStress, modemCarrierOffset=modemCarrierOffset, saf=saf, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXByteCounterLow=ethRXByteCounterLow, ethRXControlFrames=ethRXControlFrames, ipRadioCfg=ipRadioCfg, radioEntry=radioEntry, ethRXBroadcasts=ethRXBroadcasts, modemTable=modemTable, modemACMethernetCapacity=modemACMethernetCapacity, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemErroredBlock=modemErroredBlock, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethGFPDropedFrames=ethGFPDropedFrames, ethRXDones=ethRXDones, modemErroredSecondRatio=modemErroredSecondRatio, ethGFPFCSErrors=ethGFPFCSErrors, modemUnavailtime=modemUnavailtime, radioTable=radioTable, aTPCTable=aTPCTable, ethRXTruncatedFrames=ethRXTruncatedFrames, radioRxLevel=radioRxLevel, ethRXCRCErrors=ethRXCRCErrors, radioTxMute=radioTxMute, e1t1StatTable=e1t1StatTable, ethTXVlanTags=ethTXVlanTags, ethTXDones=ethTXDones, modemLastAcqError=modemLastAcqError, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, e1t1AIS=e1t1AIS, ethTXMulticasts=ethTXMulticasts, modemUptime=modemUptime, ethTXPauseFrames=ethTXPauseFrames, modemModulation=modemModulation, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethGFPDelineationErrors=ethGFPDelineationErrors, e1t1StatEntry=e1t1StatEntry, atpcIndex=atpcIndex, ipRadio=ipRadio, licenseMask=licenseMask, modemE1T1Channels=modemE1T1Channels, radioSide=radioSide, ethTXByteCounterLow=ethTXByteCounterLow, ethTXLateCollisions=ethTXLateCollisions, modemEthernetCapacity=modemEthernetCapacity)
