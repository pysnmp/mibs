...
mibBuilder.exportSymbols("SAF-IPRADIO", modemRadialMSE=modemRadialMSE, radioSide=radioSide, ipRadioCfg=ipRadioCfg, localIpMask=localIpMask, ethTXMaxCollisions=ethTXMaxCollisions, ethTXDones=ethTXDones, ethGFPDelineationErrors=ethGFPDelineationErrors, e1t1StatEntry=e1t1StatEntry, writeConfig=writeConfig, loopbacks=loopbacks, e1t1ChannelNr=e1t1ChannelNr, ipRadio=ipRadio, radioDuplexShift=radioDuplexShift, radioRxLevel=radioRxLevel, ethTXExcessiveDefers=ethTXExcessiveDefers, ipRadioStat=ipRadioStat, pointToPoint=pointToPoint, ethRXDones=ethRXDones, modemLastAcqError=modemLastAcqError, ethRXDvEvent=ethRXDvEvent, license=license, ethQOSTXDropped=ethQOSTXDropped, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ipRadioMgmt=ipRadioMgmt, ethRXTruncatedFrames=ethRXTruncatedFrames, vlanRowStatus=vlanRowStatus, ethTXByteCounterLow=ethTXByteCounterLow, sysDateAndTime=sysDateAndTime, ethRXCRCErrors=ethRXCRCErrors, ethRXByteCounterLow=ethRXByteCounterLow, radioLoopback=radioLoopback, remoteIp=remoteIp, vlanFid=vlanFid, modemSymbolRateRx=modemSymbolRateRx, ethRXMulticasts=ethRXMulticasts, radioTxMute=radioTxMute, ethTXLateCollisions=ethTXLateCollisions, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemACMethernetCapacity=modemACMethernetCapacity, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXByteCounterHi=ethTXByteCounterHi, vlanEntry=vlanEntry, ethGFPDropedFrames=ethGFPDropedFrames, ethTXCRCErrors=ethTXCRCErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioTxPower=radioTxPower, ethGFPCHECErrors=ethGFPCHECErrors, vlansEnabled=vlansEnabled, ethGFPFCSErrors=ethGFPFCSErrors, modemBandwith=modemBandwith, e1t1StatTable=e1t1StatTable, licenseMask=licenseMask, ethRXControlFrames=ethRXControlFrames, modemACMtotalCapacity=modemACMtotalCapacity, ethRXByteCounterHi=ethRXByteCounterHi, modemACMmodulationMin=modemACMmodulationMin, ethRXPauseFrames=ethRXPauseFrames, aTPCTable=aTPCTable, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemCountTime=modemCountTime, ethTXVlanTags=ethTXVlanTags, modemACMmodulationMax=modemACMmodulationMax, e1t1AIS=e1t1AIS, modemEntry=modemEntry, modemTotalBlockNumber=modemTotalBlockNumber, ethRXCodeErrors=ethRXCodeErrors, modemE1T1Channels=modemE1T1Channels, modemACMengine=modemACMengine, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlanPortType=vlanPortType, atpcIndex=atpcIndex, modemAcqStatus=modemAcqStatus, description=description, atpcEnabled=atpcEnabled, modemGeneralStatus=modemGeneralStatus, ethRXBroadcasts=ethRXBroadcasts, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXBroadcasts=ethTXBroadcasts, ethTXPauseFrames=ethTXPauseFrames, modemSymbolRateTx=modemSymbolRateTx, modemEthernetCapacity=modemEthernetCapacity, radioGenStatus=radioGenStatus, ethTXCollisions=ethTXCollisions, ethTXBackpresEvents=ethTXBackpresEvents, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemStatistics=modemStatistics, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, tehnika=tehnika, modemErroredBlock=modemErroredBlock, atpcTxPowerCorrection=atpcTxPowerCorrection, ipRadioStatEth=ipRadioStatEth, radioRxFrequency=radioRxFrequency, hostname=hostname, radioTxFrequency=radioTxFrequency, modemIndex=modemIndex, ethTXMulticasts=ethTXMulticasts, ethRXPrevPktDropped=ethRXPrevPktDropped, aTPCEntry=aTPCEntry, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXUnderruns=ethTXUnderruns, ethRXLongEvents=ethRXLongEvents, ethRXUnsupOpcodes=ethRXUnsupOpcodes, vlanPortmap=vlanPortmap, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemCarrierOffset=modemCarrierOffset, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemErroredSecondRatio=modemErroredSecondRatio, vlanCfgStat=vlanCfgStat, saf=saf, loopback_tributary_mask=loopback_tributary_mask, vlanNumber=vlanNumber, product=product, modemTotalCapacity=modemTotalCapacity, ethRXDribleNibbles=ethRXDribleNibbles, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioIndex=radioIndex, modemUptime=modemUptime, ethQOSTXFrames=ethQOSTXFrames, safip=safip, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXGiants=ethTXGiants, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, sysTemperature=sysTemperature, modemInternalAGCgain=modemInternalAGCgain, licenseUpdateStatus=licenseUpdateStatus, e1t1LOS=e1t1LOS, modemModulation=modemModulation, radioTable=radioTable, vlanTable=vlanTable, modemE1T1ChannelMask=modemE1T1ChannelMask, modemErroredSecond=modemErroredSecond, modemStandard=modemStandard, restartcpu=restartcpu, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXControlFrames=ethTXControlFrames, microwaveRadio=microwaveRadio, modemUnavailtime=modemUnavailtime, radioEntry=radioEntry, modemTable=modemTable, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, localIp=localIp, modemRowStatus=modemRowStatus)
