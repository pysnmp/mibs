...
mibBuilder.exportSymbols("SAF-IPRADIO", modemRadialMSE=modemRadialMSE, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXControlFrames=ethTXControlFrames, ethRXMulticasts=ethRXMulticasts, sysDateAndTime=sysDateAndTime, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXPauseFrames=ethTXPauseFrames, ethTXMulticasts=ethTXMulticasts, modemStatistics=modemStatistics, modemSymbolRateRx=modemSymbolRateRx, radioTxPower=radioTxPower, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemInternalAGCgain=modemInternalAGCgain, radioRxLevel=radioRxLevel, ethTXGiants=ethTXGiants, atpcIndex=atpcIndex, modemACMmodulationMin=modemACMmodulationMin, modemSymbolRateTx=modemSymbolRateTx, vlanFid=vlanFid, licenseMask=licenseMask, radioTable=radioTable, ethQOSTXDropped=ethQOSTXDropped, ipRadioCfg=ipRadioCfg, modemErroredSecondRatio=modemErroredSecondRatio, localIp=localIp, vlanPortType=vlanPortType, modemACMethernetCapacity=modemACMethernetCapacity, ethGFPCHECErrors=ethGFPCHECErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ipRadio=ipRadio, radioDuplexShift=radioDuplexShift, microwaveRadio=microwaveRadio, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemRowStatus=modemRowStatus, vlanPortmap=vlanPortmap, ethRXByteCounterLow=ethRXByteCounterLow, loopback_tributary_mask=loopback_tributary_mask, e1t1AIS=e1t1AIS, modemUptime=modemUptime, ethTXCollisions=ethTXCollisions, loopbacks=loopbacks, radioTxMute=radioTxMute, saf=saf, product=product, modemTotalBlockNumber=modemTotalBlockNumber, radioIndex=radioIndex, ethTXExcessiveDefers=ethTXExcessiveDefers, ipRadioCfgNetwork=ipRadioCfgNetwork, radioLoopback=radioLoopback, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXMaxCollisions=ethTXMaxCollisions, modemStandard=modemStandard, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethGFPDropedFrames=ethGFPDropedFrames, ethQOSTXFrames=ethQOSTXFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, writeConfig=writeConfig, ethRXControlFrames=ethRXControlFrames, sysTemperature=sysTemperature, modemE1T1ChannelMask=modemE1T1ChannelMask, modemGeneralStatus=modemGeneralStatus, atpcEnabled=atpcEnabled, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemACMtotalCapacity=modemACMtotalCapacity, radioGenStatus=radioGenStatus, ethTXBroadcasts=ethTXBroadcasts, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, licenseUpdateStatus=licenseUpdateStatus, ethTXDones=ethTXDones, pointToPoint=pointToPoint, modemBandwith=modemBandwith, modemSeverelyErroredSecond=modemSeverelyErroredSecond, tehnika=tehnika, modemE1T1Channels=modemE1T1Channels, vlanTable=vlanTable, modemTotalCapacity=modemTotalCapacity, ipRadioMgmt=ipRadioMgmt, aTPCTable=aTPCTable, restartcpu=restartcpu, modemCountTime=modemCountTime, description=description, ethTXByteCounterLow=ethTXByteCounterLow, vlanCfgStat=vlanCfgStat, ethRXCodeErrors=ethRXCodeErrors, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXDones=ethRXDones, ethQOSRXQ1Frames=ethQOSRXQ1Frames, e1t1StatEntry=e1t1StatEntry, e1t1ChannelNr=e1t1ChannelNr, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemACMengine=modemACMengine, safip=safip, ethTXUnderruns=ethTXUnderruns, vlanNumber=vlanNumber, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXLongEvents=ethRXLongEvents, vlanEntry=vlanEntry, modemErroredSecond=modemErroredSecond, hostname=hostname, ethTXLateCollisions=ethTXLateCollisions, modemEthernetCapacity=modemEthernetCapacity, ethRXDvEvent=ethRXDvEvent, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXCRCErrors=ethRXCRCErrors, ipRadioStat=ipRadioStat, radioEntry=radioEntry, ethTXVlanTags=ethTXVlanTags, radioRxFrequency=radioRxFrequency, ethRXPauseFrames=ethRXPauseFrames, localIpMask=localIpMask, modemTable=modemTable, e1t1StatTable=e1t1StatTable, modemLDPCdecoderStress=modemLDPCdecoderStress, modemCarrierOffset=modemCarrierOffset, vlansEnabled=vlansEnabled, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemErroredBlock=modemErroredBlock, radioTxFrequency=radioTxFrequency, remoteIp=remoteIp, ethGFPFCSErrors=ethGFPFCSErrors, aTPCEntry=aTPCEntry, radioSide=radioSide, vlanRowStatus=vlanRowStatus, ethRXBroadcasts=ethRXBroadcasts, ethRXTruncatedFrames=ethRXTruncatedFrames, modemAcqStatus=modemAcqStatus, ethRXByteCounterHi=ethRXByteCounterHi, ethTXCRCErrors=ethTXCRCErrors, modemACMmodulationMax=modemACMmodulationMax, ethTXBackpresEvents=ethTXBackpresEvents, ipRadioStatEth=ipRadioStatEth, modemEntry=modemEntry, ethRXDribleNibbles=ethRXDribleNibbles, ethRXPrevPktDropped=ethRXPrevPktDropped, license=license, modemModulation=modemModulation, ethTXByteCounterHi=ethTXByteCounterHi, e1t1LOS=e1t1LOS, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemUnavailtime=modemUnavailtime, modemIndex=modemIndex, modemLastAcqError=modemLastAcqError)
