...
mibBuilder.exportSymbols("SAF-IPRADIO", radioGenStatus=radioGenStatus, modemUptime=modemUptime, ethGFPCHECErrors=ethGFPCHECErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXMaxCollisions=ethTXMaxCollisions, pointToPoint=pointToPoint, licenseUpdateStatus=licenseUpdateStatus, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, writeConfig=writeConfig, ethTXCRCErrors=ethTXCRCErrors, vlanFid=vlanFid, modemRowStatus=modemRowStatus, ethRXCodeErrors=ethRXCodeErrors, ethGFPDropedFrames=ethGFPDropedFrames, saf=saf, hostname=hostname, microwaveRadio=microwaveRadio, description=description, ipRadioMgmt=ipRadioMgmt, modemIndex=modemIndex, vlanCfgStat=vlanCfgStat, modemACMtotalCapacity=modemACMtotalCapacity, modemE1T1Channels=modemE1T1Channels, modemStandard=modemStandard, vlanEntry=vlanEntry, ethTXBackpresEvents=ethTXBackpresEvents, radioIndex=radioIndex, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, sysDateAndTime=sysDateAndTime, ethTXByteCounterLow=ethTXByteCounterLow, ethQOSTXDropped=ethQOSTXDropped, modemTotalBlockNumber=modemTotalBlockNumber, ipRadioCfg=ipRadioCfg, e1t1AIS=e1t1AIS, modemErroredSecondRatio=modemErroredSecondRatio, atpcEnabled=atpcEnabled, radioDuplexShift=radioDuplexShift, modemCountTime=modemCountTime, modemACMengine=modemACMengine, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ipRadioStatEth=ipRadioStatEth, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemErroredBlock=modemErroredBlock, modemAcqStatus=modemAcqStatus, vlanNumber=vlanNumber, ethRXByteCounterHi=ethRXByteCounterHi, ipRadioCfgNetwork=ipRadioCfgNetwork, remoteIp=remoteIp, aTPCTable=aTPCTable, e1t1LOS=e1t1LOS, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXUnderruns=ethTXUnderruns, product=product, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemACMethernetCapacity=modemACMethernetCapacity, ipRadioStat=ipRadioStat, e1t1StatTable=e1t1StatTable, ethTXPauseFrames=ethTXPauseFrames, modemErroredSecond=modemErroredSecond, ethTXControlFrames=ethTXControlFrames, ethTXByteCounterHi=ethTXByteCounterHi, licenseMask=licenseMask, e1t1ChannelNr=e1t1ChannelNr, loopback_tributary_mask=loopback_tributary_mask, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXDones=ethTXDones, ethRXControlFrames=ethRXControlFrames, radioTxFrequency=radioTxFrequency, ethRXBroadcasts=ethRXBroadcasts, ethRXMulticasts=ethRXMulticasts, ethTXExcessiveDefers=ethTXExcessiveDefers, modemEntry=modemEntry, modemEthernetCapacity=modemEthernetCapacity, vlanPortmap=vlanPortmap, vlanRowStatus=vlanRowStatus, ethRXPauseFrames=ethRXPauseFrames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemLDPCdecoderStress=modemLDPCdecoderStress, radioSide=radioSide, ethRXByteCounterLow=ethRXByteCounterLow, atpcTxPowerCorrection=atpcTxPowerCorrection, modemACMmodulationMin=modemACMmodulationMin, sysTemperature=sysTemperature, modemSymbolRateTx=modemSymbolRateTx, ethTXBroadcasts=ethTXBroadcasts, modemRadialMSE=modemRadialMSE, modemTable=modemTable, ethRXTruncatedFrames=ethRXTruncatedFrames, modemACMmodulationMax=modemACMmodulationMax, safip=safip, vlansEnabled=vlansEnabled, ethTXLateCollisions=ethTXLateCollisions, ethRXDones=ethRXDones, radioTxMute=radioTxMute, aTPCEntry=aTPCEntry, modemLastAcqError=modemLastAcqError, ethRXDvEvent=ethRXDvEvent, localIpMask=localIpMask, ethTXGiants=ethTXGiants, modemSymbolRateRx=modemSymbolRateRx, localIp=localIp, ethQOSTXFrames=ethQOSTXFrames, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXVlanTags=ethTXVlanTags, modemUnavailtime=modemUnavailtime, ethGFPFCSErrors=ethGFPFCSErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioRxLevel=radioRxLevel, modemCarrierOffset=modemCarrierOffset, radioLoopback=radioLoopback, radioRxFrequency=radioRxFrequency, modemInternalAGCgain=modemInternalAGCgain, ethTXCollisions=ethTXCollisions, modemModulation=modemModulation, modemTotalCapacity=modemTotalCapacity, radioTable=radioTable, ipRadioCfgGeneral=ipRadioCfgGeneral, modemBandwith=modemBandwith, restartcpu=restartcpu, ethRXLongEvents=ethRXLongEvents, modemStatistics=modemStatistics, ethRXCRCErrors=ethRXCRCErrors, atpcIndex=atpcIndex, ethTXMulticasts=ethTXMulticasts, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, tehnika=tehnika, radioEntry=radioEntry, ipRadio=ipRadio, vlanTable=vlanTable, modemE1T1ChannelMask=modemE1T1ChannelMask, vlanPortType=vlanPortType, loopbacks=loopbacks, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioTxPower=radioTxPower, ethRXDribleNibbles=ethRXDribleNibbles, e1t1StatEntry=e1t1StatEntry, license=license, modemGeneralStatus=modemGeneralStatus, ethGFPDelineationErrors=ethGFPDelineationErrors)
