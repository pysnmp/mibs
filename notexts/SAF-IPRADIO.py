...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXBroadcasts=ethRXBroadcasts, ethTXLateCollisions=ethTXLateCollisions, ethGFPFCSErrors=ethGFPFCSErrors, vlanNumber=vlanNumber, atpcEnabled=atpcEnabled, ethRXCodeErrors=ethRXCodeErrors, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXVlanTags=ethTXVlanTags, ethRXControlFrames=ethRXControlFrames, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemIndex=modemIndex, ethTXBackpresEvents=ethTXBackpresEvents, modemErroredSecond=modemErroredSecond, ethRXPauseFrames=ethRXPauseFrames, ethRXByteCounterLow=ethRXByteCounterLow, aTPCTable=aTPCTable, modemCarrierOffset=modemCarrierOffset, atpcTxPowerCorrection=atpcTxPowerCorrection, modemTable=modemTable, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemUptime=modemUptime, hostname=hostname, radioSide=radioSide, modemACMethernetCapacity=modemACMethernetCapacity, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXLongEvents=ethRXLongEvents, ethRXDribleNibbles=ethRXDribleNibbles, modemSymbolRateRx=modemSymbolRateRx, ethRXMulticasts=ethRXMulticasts, ethTXByteCounterHi=ethTXByteCounterHi, modemTotalBlockNumber=modemTotalBlockNumber, radioRxLevel=radioRxLevel, license=license, modemSymbolRateTx=modemSymbolRateTx, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethQOSTXFrames=ethQOSTXFrames, radioLoopback=radioLoopback, ethTXMulticasts=ethTXMulticasts, e1t1ChannelNr=e1t1ChannelNr, modemACMmodulationMin=modemACMmodulationMin, ethTXDones=ethTXDones, radioGenStatus=radioGenStatus, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, e1t1AIS=e1t1AIS, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadioStat=ipRadioStat, e1t1StatEntry=e1t1StatEntry, modemUnavailtime=modemUnavailtime, ethGFPCHECErrors=ethGFPCHECErrors, ipRadio=ipRadio, ethTXPauseFrames=ethTXPauseFrames, ipRadioCfgNetwork=ipRadioCfgNetwork, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, sysDateAndTime=sysDateAndTime, vlanPortmap=vlanPortmap, vlanCfgStat=vlanCfgStat, product=product, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXCRCErrors=ethTXCRCErrors, localIpMask=localIpMask, ethTXByteCounterLow=ethTXByteCounterLow, ethTXUnderruns=ethTXUnderruns, modemGeneralStatus=modemGeneralStatus, ethGFPDelineationErrors=ethGFPDelineationErrors, modemModulation=modemModulation, pointToPoint=pointToPoint, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioRxFrequency=radioRxFrequency, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemEntry=modemEntry, radioTable=radioTable, vlanTable=vlanTable, ethRXDvEvent=ethRXDvEvent, radioTxMute=radioTxMute, restartcpu=restartcpu, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXControlFrames=ethTXControlFrames, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, vlanFid=vlanFid, ethRXByteCounterHi=ethRXByteCounterHi, modemE1T1ChannelMask=modemE1T1ChannelMask, modemACMtotalCapacity=modemACMtotalCapacity, sysTemperature=sysTemperature, modemErroredSecondRatio=modemErroredSecondRatio, radioTxPower=radioTxPower, ipRadioStatEth=ipRadioStatEth, safip=safip, atpcIndex=atpcIndex, modemBandwith=modemBandwith, saf=saf, modemStatistics=modemStatistics, remoteIp=remoteIp, modemTotalCapacity=modemTotalCapacity, loopback_tributary_mask=loopback_tributary_mask, modemAcqStatus=modemAcqStatus, loopbacks=loopbacks, localIp=localIp, ethRXCRCErrors=ethRXCRCErrors, licenseUpdateStatus=licenseUpdateStatus, tehnika=tehnika, ethRXDones=ethRXDones, ethTXMaxCollisions=ethTXMaxCollisions, vlanPortType=vlanPortType, modemACMmodulationMax=modemACMmodulationMax, ethRXTruncatedFrames=ethRXTruncatedFrames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, aTPCEntry=aTPCEntry, radioTxFrequency=radioTxFrequency, ethTXGiants=ethTXGiants, modemCountTime=modemCountTime, description=description, radioDuplexShift=radioDuplexShift, modemACMengine=modemACMengine, ethTXExcessiveDefers=ethTXExcessiveDefers, modemRowStatus=modemRowStatus, microwaveRadio=microwaveRadio, modemInternalAGCgain=modemInternalAGCgain, radioIndex=radioIndex, e1t1StatTable=e1t1StatTable, ipRadioMgmt=ipRadioMgmt, writeConfig=writeConfig, modemEthernetCapacity=modemEthernetCapacity, e1t1LOS=e1t1LOS, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlanEntry=vlanEntry, modemE1T1Channels=modemE1T1Channels, licenseMask=licenseMask, ethTXBroadcasts=ethTXBroadcasts, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethGFPDropedFrames=ethGFPDropedFrames, modemErroredBlock=modemErroredBlock, ethTXCollisions=ethTXCollisions, radioEntry=radioEntry, vlanRowStatus=vlanRowStatus, vlansEnabled=vlansEnabled, ethQOSTXDropped=ethQOSTXDropped, modemLastAcqError=modemLastAcqError, modemLDPCdecoderStress=modemLDPCdecoderStress, ipRadioCfg=ipRadioCfg, modemStandard=modemStandard, modemRadialMSE=modemRadialMSE)
