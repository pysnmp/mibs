...
mibBuilder.exportSymbols("SAF-IPRADIO", ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXUnderruns=ethTXUnderruns, ethTXByteCounterLow=ethTXByteCounterLow, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioLoopback=radioLoopback, vlanEntry=vlanEntry, ipRadioCfg=ipRadioCfg, ethRXByteCounterLow=ethRXByteCounterLow, modemACMtotalCapacity=modemACMtotalCapacity, restartcpu=restartcpu, radioTxMute=radioTxMute, atpcEnabled=atpcEnabled, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXDones=ethTXDones, modemACMethernetCapacity=modemACMethernetCapacity, modemSymbolRateTx=modemSymbolRateTx, radioRxFrequency=radioRxFrequency, vlanFid=vlanFid, e1t1StatTable=e1t1StatTable, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioTable=radioTable, aTPCEntry=aTPCEntry, modemStatistics=modemStatistics, remoteIp=remoteIp, ipRadioCfgGeneral=ipRadioCfgGeneral, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXMulticasts=ethRXMulticasts, sysTemperature=sysTemperature, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, hostname=hostname, modemInternalAGCgain=modemInternalAGCgain, ethRXDones=ethRXDones, modemErroredSecond=modemErroredSecond, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemTotalCapacity=modemTotalCapacity, modemUnavailtime=modemUnavailtime, ethQOSRXQ1Frames=ethQOSRXQ1Frames, saf=saf, radioSide=radioSide, vlanRowStatus=vlanRowStatus, ethRXPauseFrames=ethRXPauseFrames, localIpMask=localIpMask, radioRxLevel=radioRxLevel, modemE1T1ChannelMask=modemE1T1ChannelMask, ethQOSTXFrames=ethQOSTXFrames, localIp=localIp, ipRadioMgmt=ipRadioMgmt, ethRXControlFrames=ethRXControlFrames, ethRXCodeErrors=ethRXCodeErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemCarrierOffset=modemCarrierOffset, ipRadio=ipRadio, ipRadioCfgNetwork=ipRadioCfgNetwork, modemRadialMSE=modemRadialMSE, modemTable=modemTable, modemGeneralStatus=modemGeneralStatus, radioEntry=radioEntry, e1t1LOS=e1t1LOS, modemTotalBlockNumber=modemTotalBlockNumber, ethTXBroadcasts=ethTXBroadcasts, writeConfig=writeConfig, atpcIndex=atpcIndex, ethQOSTXDropped=ethQOSTXDropped, ethRXCRCErrors=ethRXCRCErrors, ethTXPauseFrames=ethTXPauseFrames, vlansEnabled=vlansEnabled, ethRXDvEvent=ethRXDvEvent, modemModulation=modemModulation, modemUptime=modemUptime, ethRXTruncatedFrames=ethRXTruncatedFrames, vlanTable=vlanTable, ethRXBroadcasts=ethRXBroadcasts, ethTXByteCounterHi=ethTXByteCounterHi, ethRXUnsupOpcodes=ethRXUnsupOpcodes, pointToPoint=pointToPoint, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemLastAcqError=modemLastAcqError, modemRowStatus=modemRowStatus, ipRadioStat=ipRadioStat, ethRXPrevPktDropped=ethRXPrevPktDropped, aTPCTable=aTPCTable, ipRadioStatEth=ipRadioStatEth, license=license, modemIndex=modemIndex, sysDateAndTime=sysDateAndTime, modemLDPCdecoderStress=modemLDPCdecoderStress, vlanPortmap=vlanPortmap, vlanCfgStat=vlanCfgStat, ethRXLongEvents=ethRXLongEvents, licenseMask=licenseMask, ethRXVlanTagsDetected=ethRXVlanTagsDetected, loopback_tributary_mask=loopback_tributary_mask, vlanPortType=vlanPortType, ethGFPDelineationErrors=ethGFPDelineationErrors, e1t1StatEntry=e1t1StatEntry, ethTXMaxCollisions=ethTXMaxCollisions, loopbacks=loopbacks, radioTxFrequency=radioTxFrequency, modemE1T1Channels=modemE1T1Channels, ethTXMulticasts=ethTXMulticasts, modemEthernetCapacity=modemEthernetCapacity, tehnika=tehnika, ethTXCRCErrors=ethTXCRCErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemACMmodulationMax=modemACMmodulationMax, modemBandwith=modemBandwith, modemErroredBlock=modemErroredBlock, ethTXCollisions=ethTXCollisions, licenseUpdateStatus=licenseUpdateStatus, ethTXBackpresEvents=ethTXBackpresEvents, modemAcqStatus=modemAcqStatus, ethTXExcessiveDefers=ethTXExcessiveDefers, ethGFPDropedFrames=ethGFPDropedFrames, atpcTxPowerCorrection=atpcTxPowerCorrection, modemACMmodulationMin=modemACMmodulationMin, ethTXControlFrames=ethTXControlFrames, ethGFPFCSErrors=ethGFPFCSErrors, e1t1AIS=e1t1AIS, ethTXGiants=ethTXGiants, product=product, radioTxPower=radioTxPower, modemACMengine=modemACMengine, modemSymbolRateRx=modemSymbolRateRx, safip=safip, modemStandard=modemStandard, modemEntry=modemEntry, ethTXLateCollisions=ethTXLateCollisions, radioIndex=radioIndex, ethRXDribleNibbles=ethRXDribleNibbles, radioGenStatus=radioGenStatus, microwaveRadio=microwaveRadio, ethRXByteCounterHi=ethRXByteCounterHi, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethGFPCHECErrors=ethGFPCHECErrors, e1t1ChannelNr=e1t1ChannelNr, vlanNumber=vlanNumber, modemCountTime=modemCountTime, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioDuplexShift=radioDuplexShift, ethTXVlanTags=ethTXVlanTags, description=description, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemErroredSecondRatio=modemErroredSecondRatio)
