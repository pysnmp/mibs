...
mibBuilder.exportSymbols("SAF-IPRADIO", radioTable=radioTable, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemCountTime=modemCountTime, ethRXCRCErrors=ethRXCRCErrors, vlanRowStatus=vlanRowStatus, modemErroredSecondRatio=modemErroredSecondRatio, ethQOSRXQ2Frames=ethQOSRXQ2Frames, e1t1AIS=e1t1AIS, e1t1StatEntry=e1t1StatEntry, vlanCfgStat=vlanCfgStat, ipRadioMgmt=ipRadioMgmt, modemSymbolRateTx=modemSymbolRateTx, ethRXDvEvent=ethRXDvEvent, ipRadio=ipRadio, ethTXBroadcasts=ethTXBroadcasts, modemLDPCdecoderStress=modemLDPCdecoderStress, modemLastAcqError=modemLastAcqError, modemTable=modemTable, ethRXDribleNibbles=ethRXDribleNibbles, ethTXGiants=ethTXGiants, ethTXCRCErrors=ethTXCRCErrors, modemTotalCapacity=modemTotalCapacity, modemGeneralStatus=modemGeneralStatus, modemUnavailtime=modemUnavailtime, localIp=localIp, ethRXPrevPktDropped=ethRXPrevPktDropped, vlanPortType=vlanPortType, modemStatistics=modemStatistics, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethGFPFCSErrors=ethGFPFCSErrors, radioEntry=radioEntry, modemE1T1Channels=modemE1T1Channels, ethRXMulticasts=ethRXMulticasts, e1t1LOS=e1t1LOS, modemModulation=modemModulation, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemStandard=modemStandard, ethGFPDropedFrames=ethGFPDropedFrames, loopback_tributary_mask=loopback_tributary_mask, modemACMethernetCapacity=modemACMethernetCapacity, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemTotalBlockNumber=modemTotalBlockNumber, ethTXMulticasts=ethTXMulticasts, ethQOSTXFrames=ethQOSTXFrames, modemInternalAGCgain=modemInternalAGCgain, modemErroredBlock=modemErroredBlock, modemAcqStatus=modemAcqStatus, ipRadioStat=ipRadioStat, radioLoopback=radioLoopback, saf=saf, ipRadioCfg=ipRadioCfg, hostname=hostname, sysDateAndTime=sysDateAndTime, modemACMmodulationMin=modemACMmodulationMin, radioSide=radioSide, aTPCTable=aTPCTable, ethTXByteCounterHi=ethTXByteCounterHi, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXDones=ethRXDones, ethTXDones=ethTXDones, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemErroredSecond=modemErroredSecond, sysTemperature=sysTemperature, radioIndex=radioIndex, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXLongEvents=ethRXLongEvents, microwaveRadio=microwaveRadio, ethTXPauseFrames=ethTXPauseFrames, ethRXCodeErrors=ethRXCodeErrors, safip=safip, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemACMengine=modemACMengine, description=description, ethRXByteCounterLow=ethRXByteCounterLow, vlanEntry=vlanEntry, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXBroadcasts=ethRXBroadcasts, ethTXUnderruns=ethTXUnderruns, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioTxPower=radioTxPower, radioGenStatus=radioGenStatus, licenseUpdateStatus=licenseUpdateStatus, modemIndex=modemIndex, modemCarrierOffset=modemCarrierOffset, product=product, ethTXCollisions=ethTXCollisions, modemEthernetCapacity=modemEthernetCapacity, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, atpcEnabled=atpcEnabled, vlansEnabled=vlansEnabled, vlanNumber=vlanNumber, vlanFid=vlanFid, modemE1T1ChannelMask=modemE1T1ChannelMask, modemUptime=modemUptime, ethRXByteCounterHi=ethRXByteCounterHi, atpcTxPowerCorrection=atpcTxPowerCorrection, atpcIndex=atpcIndex, radioRxLevel=radioRxLevel, modemACMmodulationMax=modemACMmodulationMax, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXControlFrames=ethTXControlFrames, modemRadialMSE=modemRadialMSE, tehnika=tehnika, localIpMask=localIpMask, ipRadioCfgGeneral=ipRadioCfgGeneral, aTPCEntry=aTPCEntry, radioTxMute=radioTxMute, license=license, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXMaxCollisions=ethTXMaxCollisions, modemEntry=modemEntry, modemBandwith=modemBandwith, radioTxFrequency=radioTxFrequency, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXVlanTags=ethTXVlanTags, ethGFPCHECErrors=ethGFPCHECErrors, licenseMask=licenseMask, remoteIp=remoteIp, e1t1ChannelNr=e1t1ChannelNr, ethQOSTXDropped=ethQOSTXDropped, modemRowStatus=modemRowStatus, modemSymbolRateRx=modemSymbolRateRx, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXLateCollisions=ethTXLateCollisions, writeConfig=writeConfig, restartcpu=restartcpu, vlanPortmap=vlanPortmap, pointToPoint=pointToPoint, ethRXPauseFrames=ethRXPauseFrames, ethRXControlFrames=ethRXControlFrames, loopbacks=loopbacks, ethTXByteCounterLow=ethTXByteCounterLow, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXUnsupOpcodes=ethRXUnsupOpcodes, vlanTable=vlanTable, modemACMtotalCapacity=modemACMtotalCapacity, ethTXBackpresEvents=ethTXBackpresEvents, ipRadioStatEth=ipRadioStatEth, radioDuplexShift=radioDuplexShift, e1t1StatTable=e1t1StatTable, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioRxFrequency=radioRxFrequency)
