...
mibBuilder.exportSymbols("SAF-IPRADIO", radioGenStatus=radioGenStatus, modemACMethernetCapacity=modemACMethernetCapacity, modemErroredSecondRatio=modemErroredSecondRatio, modemUptime=modemUptime, localIpMask=localIpMask, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, e1t1StatTable=e1t1StatTable, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXByteCounterHi=ethRXByteCounterHi, e1t1LOS=e1t1LOS, ipRadio=ipRadio, ipRadioMgmt=ipRadioMgmt, modemGeneralStatus=modemGeneralStatus, ethRXMulticasts=ethRXMulticasts, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemEthernetCapacity=modemEthernetCapacity, aTPCTable=aTPCTable, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXTruncatedFrames=ethRXTruncatedFrames, licenseMask=licenseMask, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioTable=radioTable, e1t1StatEntry=e1t1StatEntry, vlanPortmap=vlanPortmap, modemRowStatus=modemRowStatus, modemE1T1Channels=modemE1T1Channels, modemLastAcqError=modemLastAcqError, ethTXUnderruns=ethTXUnderruns, saf=saf, vlanEntry=vlanEntry, e1t1ChannelNr=e1t1ChannelNr, ethTXByteCounterHi=ethTXByteCounterHi, ethQOSTXDropped=ethQOSTXDropped, radioEntry=radioEntry, vlanPortType=vlanPortType, radioSide=radioSide, ethTXGiants=ethTXGiants, modemTotalCapacity=modemTotalCapacity, licenseUpdateStatus=licenseUpdateStatus, atpcTxPowerCorrection=atpcTxPowerCorrection, ipRadioCfgGeneral=ipRadioCfgGeneral, hostname=hostname, modemAcqStatus=modemAcqStatus, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioIndex=radioIndex, remoteIp=remoteIp, modemCountTime=modemCountTime, license=license, vlanTable=vlanTable, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemSymbolRateRx=modemSymbolRateRx, ethRXDones=ethRXDones, ethTXCollisions=ethTXCollisions, ethTXBroadcasts=ethTXBroadcasts, modemBandwith=modemBandwith, vlanFid=vlanFid, modemUnavailtime=modemUnavailtime, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXControlFrames=ethRXControlFrames, vlansEnabled=vlansEnabled, ethGFPCHECErrors=ethGFPCHECErrors, ethTXMaxCollisions=ethTXMaxCollisions, ethTXByteCounterLow=ethTXByteCounterLow, pointToPoint=pointToPoint, radioTxFrequency=radioTxFrequency, modemEntry=modemEntry, ethTXPauseFrames=ethTXPauseFrames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, description=description, ethQOSRXQ1Frames=ethQOSRXQ1Frames, localIp=localIp, modemRadialMSE=modemRadialMSE, ethTXVlanTags=ethTXVlanTags, product=product, ipRadioStat=ipRadioStat, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemErroredSecond=modemErroredSecond, ipRadioCfg=ipRadioCfg, ethRXPauseFrames=ethRXPauseFrames, ethRXCRCErrors=ethRXCRCErrors, vlanRowStatus=vlanRowStatus, radioRxLevel=radioRxLevel, tehnika=tehnika, aTPCEntry=aTPCEntry, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioDuplexShift=radioDuplexShift, modemLDPCdecoderStress=modemLDPCdecoderStress, vlanCfgStat=vlanCfgStat, ethTXDones=ethTXDones, ethGFPDropedFrames=ethGFPDropedFrames, ethRXBroadcasts=ethRXBroadcasts, ethGFPDelineationErrors=ethGFPDelineationErrors, modemACMmodulationMin=modemACMmodulationMin, microwaveRadio=microwaveRadio, modemInternalAGCgain=modemInternalAGCgain, ethGFPFCSErrors=ethGFPFCSErrors, modemErroredBlock=modemErroredBlock, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemACMengine=modemACMengine, ethTXMulticasts=ethTXMulticasts, ethTXBackpresEvents=ethTXBackpresEvents, ipRadioStatEth=ipRadioStatEth, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXLongEvents=ethRXLongEvents, vlanNumber=vlanNumber, ethTXControlFrames=ethTXControlFrames, modemStatistics=modemStatistics, safip=safip, ethQOSTXFrames=ethQOSTXFrames, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioTxMute=radioTxMute, radioLoopback=radioLoopback, ethRXDvEvent=ethRXDvEvent, ethTXCRCErrors=ethTXCRCErrors, ethRXCodeErrors=ethRXCodeErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, sysTemperature=sysTemperature, e1t1AIS=e1t1AIS, ipRadioCfgNetwork=ipRadioCfgNetwork, writeConfig=writeConfig, atpcEnabled=atpcEnabled, modemModulation=modemModulation, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemIndex=modemIndex, radioRxFrequency=radioRxFrequency, modemACMmodulationMax=modemACMmodulationMax, ethRXByteCounterLow=ethRXByteCounterLow, modemACMtotalCapacity=modemACMtotalCapacity, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, restartcpu=restartcpu, ethRXPrevPktDropped=ethRXPrevPktDropped, modemStandard=modemStandard, atpcIndex=atpcIndex, modemSymbolRateTx=modemSymbolRateTx, sysDateAndTime=sysDateAndTime, ethTXLateCollisions=ethTXLateCollisions, loopbacks=loopbacks, loopback_tributary_mask=loopback_tributary_mask, ethRXDribleNibbles=ethRXDribleNibbles, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemCarrierOffset=modemCarrierOffset, radioTxPower=radioTxPower, modemTotalBlockNumber=modemTotalBlockNumber, modemTable=modemTable)
