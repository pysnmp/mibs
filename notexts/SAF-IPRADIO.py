...
mibBuilder.exportSymbols("SAF-IPRADIO", aTPCTable=aTPCTable, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemAcqStatus=modemAcqStatus, vlansEnabled=vlansEnabled, radioTxFrequency=radioTxFrequency, modemEntry=modemEntry, safip=safip, atpcEnabled=atpcEnabled, vlanTable=vlanTable, ethGFPDelineationErrors=ethGFPDelineationErrors, modemErroredSecondRatio=modemErroredSecondRatio, ethQOSTXDropped=ethQOSTXDropped, modemIndex=modemIndex, modemSymbolRateRx=modemSymbolRateRx, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXCollisions=ethTXCollisions, modemUnavailtime=modemUnavailtime, modemACMmodulationMin=modemACMmodulationMin, ethTXUnderruns=ethTXUnderruns, ethRXDones=ethRXDones, ethRXCodeErrors=ethRXCodeErrors, ethTXMaxCollisions=ethTXMaxCollisions, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ipRadio=ipRadio, ethTXPauseFrames=ethTXPauseFrames, modemRadialMSE=modemRadialMSE, vlanEntry=vlanEntry, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemModulation=modemModulation, saf=saf, modemLDPCdecoderStress=modemLDPCdecoderStress, pointToPoint=pointToPoint, modemCountTime=modemCountTime, ethTXCRCErrors=ethTXCRCErrors, ethRXPrevPktDropped=ethRXPrevPktDropped, radioTable=radioTable, ethRXPauseFrames=ethRXPauseFrames, hostname=hostname, remoteIp=remoteIp, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXControlFrames=ethRXControlFrames, radioRxLevel=radioRxLevel, microwaveRadio=microwaveRadio, product=product, writeConfig=writeConfig, ethTXLengthCheckErrors=ethTXLengthCheckErrors, e1t1AIS=e1t1AIS, sysDateAndTime=sysDateAndTime, ethRXByteCounterHi=ethRXByteCounterHi, localIpMask=localIpMask, vlanRowStatus=vlanRowStatus, ethTXVlanTags=ethTXVlanTags, vlanPortType=vlanPortType, atpcTxPowerCorrection=atpcTxPowerCorrection, modemErroredBlock=modemErroredBlock, ethGFPDropedFrames=ethGFPDropedFrames, tehnika=tehnika, ethRXCRCErrors=ethRXCRCErrors, vlanPortmap=vlanPortmap, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXGiants=ethTXGiants, modemCarrierOffset=modemCarrierOffset, modemTotalBlockNumber=modemTotalBlockNumber, ethRXLongEvents=ethRXLongEvents, modemACMtotalCapacity=modemACMtotalCapacity, license=license, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ipRadioCfg=ipRadioCfg, radioLoopback=radioLoopback, vlanFid=vlanFid, loopbacks=loopbacks, ethTXExcessiveDefers=ethTXExcessiveDefers, radioSide=radioSide, e1t1ChannelNr=e1t1ChannelNr, modemSymbolRateTx=modemSymbolRateTx, ethRXMulticasts=ethRXMulticasts, modemTotalCapacity=modemTotalCapacity, atpcIndex=atpcIndex, ethTXLateCollisions=ethTXLateCollisions, ipRadioCfgGeneral=ipRadioCfgGeneral, modemLastAcqError=modemLastAcqError, radioDuplexShift=radioDuplexShift, ipRadioStat=ipRadioStat, ethTXByteCounterLow=ethTXByteCounterLow, ethQOSTXFrames=ethQOSTXFrames, description=description, modemRowStatus=modemRowStatus, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, vlanCfgStat=vlanCfgStat, e1t1LOS=e1t1LOS, licenseUpdateStatus=licenseUpdateStatus, radioTxPower=radioTxPower, modemACMethernetCapacity=modemACMethernetCapacity, ethGFPFCSErrors=ethGFPFCSErrors, licenseMask=licenseMask, modemACMmodulationMax=modemACMmodulationMax, modemUptime=modemUptime, radioGenStatus=radioGenStatus, ethTXDones=ethTXDones, ipRadioStatEth=ipRadioStatEth, ipRadioMgmt=ipRadioMgmt, modemBandwith=modemBandwith, radioIndex=radioIndex, modemEthernetCapacity=modemEthernetCapacity, modemACMengine=modemACMengine, modemStandard=modemStandard, ethRXTruncatedFrames=ethRXTruncatedFrames, modemErroredSecond=modemErroredSecond, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemStatistics=modemStatistics, modemInternalAGCgain=modemInternalAGCgain, ethTXBackpresEvents=ethTXBackpresEvents, modemTable=modemTable, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadioCfgNetwork=ipRadioCfgNetwork, radioTxMute=radioTxMute, ethRXDribleNibbles=ethRXDribleNibbles, vlanNumber=vlanNumber, loopback_tributary_mask=loopback_tributary_mask, ethTXControlFrames=ethTXControlFrames, localIp=localIp, ethQOSRXQ2Frames=ethQOSRXQ2Frames, e1t1StatEntry=e1t1StatEntry, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioEntry=radioEntry, modemGeneralStatus=modemGeneralStatus, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXDvEvent=ethRXDvEvent, e1t1StatTable=e1t1StatTable, ethTXBroadcasts=ethTXBroadcasts, restartcpu=restartcpu, ethTXByteCounterHi=ethTXByteCounterHi, radioRxFrequency=radioRxFrequency, ethGFPCHECErrors=ethGFPCHECErrors, sysTemperature=sysTemperature, ethRXByteCounterLow=ethRXByteCounterLow, ethRXBroadcasts=ethRXBroadcasts, ethTXMulticasts=ethTXMulticasts, modemE1T1Channels=modemE1T1Channels, aTPCEntry=aTPCEntry)
