...
mibBuilder.exportSymbols("SAF-IPRADIO", loopbacks=loopbacks, modemTotalCapacity=modemTotalCapacity, loopback_tributary_mask=loopback_tributary_mask, vlanPortmap=vlanPortmap, ethTXByteCounterHi=ethTXByteCounterHi, ethTXBackpresEvents=ethTXBackpresEvents, modemEthernetCapacity=modemEthernetCapacity, ethTXVlanTags=ethTXVlanTags, ethTXBroadcasts=ethTXBroadcasts, vlanRowStatus=vlanRowStatus, ethRXControlFrames=ethRXControlFrames, ethRXCRCErrors=ethRXCRCErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemACMtotalCapacity=modemACMtotalCapacity, microwaveRadio=microwaveRadio, ethTXDones=ethTXDones, product=product, modemUnavailtime=modemUnavailtime, vlansEnabled=vlansEnabled, vlanFid=vlanFid, vlanEntry=vlanEntry, localIpMask=localIpMask, modemErroredSecondRatio=modemErroredSecondRatio, aTPCEntry=aTPCEntry, ethRXCodeErrors=ethRXCodeErrors, radioDuplexShift=radioDuplexShift, radioTxPower=radioTxPower, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemTable=modemTable, writeConfig=writeConfig, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXDvEvent=ethRXDvEvent, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemCarrierOffset=modemCarrierOffset, modemInternalAGCgain=modemInternalAGCgain, ipRadioStatEth=ipRadioStatEth, ethGFPDelineationErrors=ethGFPDelineationErrors, vlanTable=vlanTable, tehnika=tehnika, modemACMmodulationMin=modemACMmodulationMin, vlanPortType=vlanPortType, ethRXByteCounterHi=ethRXByteCounterHi, ethGFPFCSErrors=ethGFPFCSErrors, aTPCTable=aTPCTable, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemModulation=modemModulation, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXPauseFrames=ethRXPauseFrames, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXLateCollisions=ethTXLateCollisions, atpcTxPowerCorrection=atpcTxPowerCorrection, modemRowStatus=modemRowStatus, modemStatistics=modemStatistics, licenseUpdateStatus=licenseUpdateStatus, ethTXByteCounterLow=ethTXByteCounterLow, e1t1StatTable=e1t1StatTable, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXLongEvents=ethRXLongEvents, ethQOSTXFrames=ethQOSTXFrames, modemErroredBlock=modemErroredBlock, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioTxMute=radioTxMute, license=license, radioTxFrequency=radioTxFrequency, ethGFPCHECErrors=ethGFPCHECErrors, modemSymbolRateTx=modemSymbolRateTx, hostname=hostname, ethRXByteCounterLow=ethRXByteCounterLow, modemE1T1Channels=modemE1T1Channels, ethTXControlFrames=ethTXControlFrames, ipRadioMgmt=ipRadioMgmt, modemUptime=modemUptime, modemIndex=modemIndex, ethGFPDropedFrames=ethGFPDropedFrames, sysTemperature=sysTemperature, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, atpcEnabled=atpcEnabled, vlanNumber=vlanNumber, safip=safip, modemAcqStatus=modemAcqStatus, ipRadioCfgNetwork=ipRadioCfgNetwork, modemACMethernetCapacity=modemACMethernetCapacity, licenseMask=licenseMask, ethRXDones=ethRXDones, radioLoopback=radioLoopback, vlanCfgStat=vlanCfgStat, sysDateAndTime=sysDateAndTime, modemE1T1ChannelMask=modemE1T1ChannelMask, e1t1ChannelNr=e1t1ChannelNr, description=description, e1t1AIS=e1t1AIS, ethTXCRCErrors=ethTXCRCErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXBroadcasts=ethRXBroadcasts, ipRadioCfg=ipRadioCfg, ipRadioStat=ipRadioStat, radioRxFrequency=radioRxFrequency, radioRxLevel=radioRxLevel, ethQOSTXDropped=ethQOSTXDropped, modemACMmodulationMax=modemACMmodulationMax, ipRadioCfgGeneral=ipRadioCfgGeneral, modemLastAcqError=modemLastAcqError, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXUnderruns=ethTXUnderruns, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXMulticasts=ethTXMulticasts, ethRXDribleNibbles=ethRXDribleNibbles, modemBackgroundBlockErrror=modemBackgroundBlockErrror, e1t1LOS=e1t1LOS, ethTXMaxCollisions=ethTXMaxCollisions, atpcIndex=atpcIndex, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXCollisions=ethTXCollisions, ipRadio=ipRadio, e1t1StatEntry=e1t1StatEntry, modemCountTime=modemCountTime, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, saf=saf, ethTXGiants=ethTXGiants, modemErroredSecond=modemErroredSecond, modemEntry=modemEntry, modemStandard=modemStandard, modemTotalBlockNumber=modemTotalBlockNumber, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXPauseFrames=ethTXPauseFrames, ethQOSRXQ2Frames=ethQOSRXQ2Frames, localIp=localIp, modemSymbolRateRx=modemSymbolRateRx, radioGenStatus=radioGenStatus, remoteIp=remoteIp, pointToPoint=pointToPoint, restartcpu=restartcpu, radioTable=radioTable, ethRXTruncatedFrames=ethRXTruncatedFrames, radioSide=radioSide, modemACMengine=modemACMengine, radioIndex=radioIndex, modemBandwith=modemBandwith, ethRXMulticasts=ethRXMulticasts, modemGeneralStatus=modemGeneralStatus, modemRadialMSE=modemRadialMSE, radioEntry=radioEntry)
