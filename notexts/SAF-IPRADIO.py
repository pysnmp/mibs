...
mibBuilder.exportSymbols("SAF-IPRADIO", writeConfig=writeConfig, ipRadioCfg=ipRadioCfg, ethRXControlFrames=ethRXControlFrames, ethGFPDropedFrames=ethGFPDropedFrames, modemE1T1Channels=modemE1T1Channels, hostname=hostname, ipRadioStat=ipRadioStat, vlanCfgStat=vlanCfgStat, modemErroredSecondRatio=modemErroredSecondRatio, localIp=localIp, radioIndex=radioIndex, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioSide=radioSide, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, description=description, loopbacks=loopbacks, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXBroadcasts=ethTXBroadcasts, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, atpcIndex=atpcIndex, radioRxLevel=radioRxLevel, modemEthernetCapacity=modemEthernetCapacity, saf=saf, e1t1AIS=e1t1AIS, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXCRCErrors=ethTXCRCErrors, remoteIp=remoteIp, modemCarrierOffset=modemCarrierOffset, ethRXDones=ethRXDones, ethRXPauseFrames=ethRXPauseFrames, e1t1StatEntry=e1t1StatEntry, modemAcqStatus=modemAcqStatus, ethGFPDelineationErrors=ethGFPDelineationErrors, product=product, modemSymbolRateTx=modemSymbolRateTx, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemUnavailtime=modemUnavailtime, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXByteCounterLow=ethRXByteCounterLow, radioRxFrequency=radioRxFrequency, ethTXByteCounterHi=ethTXByteCounterHi, ethTXGiants=ethTXGiants, ipRadioCfgGeneral=ipRadioCfgGeneral, sysDateAndTime=sysDateAndTime, e1t1ChannelNr=e1t1ChannelNr, vlansEnabled=vlansEnabled, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemInternalAGCgain=modemInternalAGCgain, modemACMtotalCapacity=modemACMtotalCapacity, ethTXUnderruns=ethTXUnderruns, modemErroredSecond=modemErroredSecond, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, sysTemperature=sysTemperature, ethGFPFCSErrors=ethGFPFCSErrors, modemTable=modemTable, e1t1StatTable=e1t1StatTable, modemSymbolRateRx=modemSymbolRateRx, ethRXDribleNibbles=ethRXDribleNibbles, aTPCEntry=aTPCEntry, ethTXMaxCollisions=ethTXMaxCollisions, ethQOSTXDropped=ethQOSTXDropped, ethRXMulticasts=ethRXMulticasts, radioDuplexShift=radioDuplexShift, ethTXControlFrames=ethTXControlFrames, ethTXMulticasts=ethTXMulticasts, radioLoopback=radioLoopback, vlanPortType=vlanPortType, ethTXPauseFrames=ethTXPauseFrames, ipRadioMgmt=ipRadioMgmt, modemStatistics=modemStatistics, modemSeverelyErroredSecond=modemSeverelyErroredSecond, pointToPoint=pointToPoint, licenseMask=licenseMask, atpcEnabled=atpcEnabled, radioEntry=radioEntry, vlanFid=vlanFid, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemCountTime=modemCountTime, microwaveRadio=microwaveRadio, safip=safip, modemErroredBlock=modemErroredBlock, restartcpu=restartcpu, modemTotalCapacity=modemTotalCapacity, ethRXDvEvent=ethRXDvEvent, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXDones=ethTXDones, vlanRowStatus=vlanRowStatus, vlanEntry=vlanEntry, ethRXBroadcasts=ethRXBroadcasts, ethGFPCHECErrors=ethGFPCHECErrors, ethRXPrevPktDropped=ethRXPrevPktDropped, radioTxPower=radioTxPower, ethTXLateCollisions=ethTXLateCollisions, ipRadio=ipRadio, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXBackpresEvents=ethTXBackpresEvents, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, tehnika=tehnika, modemGeneralStatus=modemGeneralStatus, radioGenStatus=radioGenStatus, modemIndex=modemIndex, radioTxFrequency=radioTxFrequency, ipRadioStatEth=ipRadioStatEth, radioTable=radioTable, licenseUpdateStatus=licenseUpdateStatus, modemModulation=modemModulation, ethRXCodeErrors=ethRXCodeErrors, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXByteCounterLow=ethTXByteCounterLow, modemACMengine=modemACMengine, ethTXVlanTags=ethTXVlanTags, aTPCTable=aTPCTable, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXCRCErrors=ethRXCRCErrors, modemBandwith=modemBandwith, localIpMask=localIpMask, vlanTable=vlanTable, modemTotalBlockNumber=modemTotalBlockNumber, ethQOSTXFrames=ethQOSTXFrames, modemRowStatus=modemRowStatus, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioTxMute=radioTxMute, ethRXLongEvents=ethRXLongEvents, ethTXLengthCheckErrors=ethTXLengthCheckErrors, loopback_tributary_mask=loopback_tributary_mask, vlanPortmap=vlanPortmap, modemACMethernetCapacity=modemACMethernetCapacity, ethTXCollisions=ethTXCollisions, modemRadialMSE=modemRadialMSE, modemBackgroundBlockErrror=modemBackgroundBlockErrror, e1t1LOS=e1t1LOS, ethRXByteCounterHi=ethRXByteCounterHi, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemLastAcqError=modemLastAcqError, modemEntry=modemEntry, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemE1T1ChannelMask=modemE1T1ChannelMask, vlanNumber=vlanNumber, license=license, modemACMmodulationMin=modemACMmodulationMin, modemStandard=modemStandard, modemACMmodulationMax=modemACMmodulationMax, modemUptime=modemUptime)
