...
mibBuilder.exportSymbols("SAF-IPRADIO", aTPCTable=aTPCTable, localIp=localIp, modemIndex=modemIndex, ethRXUnsupOpcodes=ethRXUnsupOpcodes, loopbacks=loopbacks, vlanPortmap=vlanPortmap, atpcTxPowerCorrection=atpcTxPowerCorrection, licenseMask=licenseMask, ethTXWireByteCounterHi=ethTXWireByteCounterHi, e1t1AIS=e1t1AIS, vlanFid=vlanFid, localIpMask=localIpMask, ethTXBroadcasts=ethTXBroadcasts, modemCountTime=modemCountTime, e1t1StatTable=e1t1StatTable, radioRxFrequency=radioRxFrequency, microwaveRadio=microwaveRadio, modemEntry=modemEntry, modemInternalAGCgain=modemInternalAGCgain, sysTemperature=sysTemperature, vlanRowStatus=vlanRowStatus, saf=saf, modemACMmodulationMin=modemACMmodulationMin, e1t1StatEntry=e1t1StatEntry, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXCodeErrors=ethRXCodeErrors, ethRXCRCErrors=ethRXCRCErrors, description=description, ethTXMaxCollisions=ethTXMaxCollisions, ethQOSTXFrames=ethQOSTXFrames, tehnika=tehnika, modemErroredSecond=modemErroredSecond, ethQOSTXDropped=ethQOSTXDropped, ethTXByteCounterLow=ethTXByteCounterLow, radioEntry=radioEntry, ethRXByteCounterLow=ethRXByteCounterLow, vlanTable=vlanTable, ethRXControlFrames=ethRXControlFrames, ethRXByteCounterHi=ethRXByteCounterHi, ethTXCRCErrors=ethTXCRCErrors, modemTotalBlockNumber=modemTotalBlockNumber, modemSymbolRateTx=modemSymbolRateTx, radioLoopback=radioLoopback, modemRadialMSE=modemRadialMSE, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXVlanTags=ethTXVlanTags, ethTXCollisions=ethTXCollisions, ethGFPDelineationErrors=ethGFPDelineationErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXBroadcasts=ethRXBroadcasts, radioTxFrequency=radioTxFrequency, ethRXDvEvent=ethRXDvEvent, radioTxPower=radioTxPower, modemBackgroundBlockErrror=modemBackgroundBlockErrror, e1t1ChannelNr=e1t1ChannelNr, modemEthernetCapacity=modemEthernetCapacity, ethGFPCHECErrors=ethGFPCHECErrors, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXGiants=ethTXGiants, ethGFPFCSErrors=ethGFPFCSErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, modemSymbolRateRx=modemSymbolRateRx, radioIndex=radioIndex, modemErroredBlock=modemErroredBlock, ethRXDones=ethRXDones, vlansEnabled=vlansEnabled, ipRadioStatEth=ipRadioStatEth, remoteIp=remoteIp, ethRXLongEvents=ethRXLongEvents, product=product, ethTXDones=ethTXDones, ethTXControlFrames=ethTXControlFrames, atpcEnabled=atpcEnabled, aTPCEntry=aTPCEntry, ethTXMulticasts=ethTXMulticasts, modemACMethernetCapacity=modemACMethernetCapacity, ethTXPauseFrames=ethTXPauseFrames, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemCarrierOffset=modemCarrierOffset, ipRadioMgmt=ipRadioMgmt, modemAcqStatus=modemAcqStatus, vlanCfgStat=vlanCfgStat, radioGenStatus=radioGenStatus, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, vlanNumber=vlanNumber, radioTable=radioTable, modemACMengine=modemACMengine, modemACMmodulationMax=modemACMmodulationMax, radioSide=radioSide, vlanPortType=vlanPortType, ethTXByteCounterHi=ethTXByteCounterHi, modemUnavailtime=modemUnavailtime, ethTXBackpresEvents=ethTXBackpresEvents, ethRXMulticasts=ethRXMulticasts, vlanEntry=vlanEntry, radioTxMute=radioTxMute, radioDuplexShift=radioDuplexShift, radioRxLevel=radioRxLevel, ethRXPauseFrames=ethRXPauseFrames, licenseUpdateStatus=licenseUpdateStatus, ethTXUnderruns=ethTXUnderruns, modemErroredSecondRatio=modemErroredSecondRatio, e1t1LOS=e1t1LOS, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXDribleNibbles=ethRXDribleNibbles, modemBandwith=modemBandwith, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemTotalCapacity=modemTotalCapacity, modemStatistics=modemStatistics, writeConfig=writeConfig, modemUptime=modemUptime, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemLastAcqError=modemLastAcqError, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemACMtotalCapacity=modemACMtotalCapacity, modemRowStatus=modemRowStatus, ethGFPDropedFrames=ethGFPDropedFrames, ethTXLateCollisions=ethTXLateCollisions, restartcpu=restartcpu, hostname=hostname, sysDateAndTime=sysDateAndTime, safip=safip, ipRadio=ipRadio, atpcIndex=atpcIndex, modemGeneralStatus=modemGeneralStatus, license=license, modemModulation=modemModulation, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemStandard=modemStandard, modemTable=modemTable, ipRadioStat=ipRadioStat, loopback_tributary_mask=loopback_tributary_mask, pointToPoint=pointToPoint, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ipRadioCfg=ipRadioCfg, modemLDPCdecoderStress=modemLDPCdecoderStress, ipRadioCfgGeneral=ipRadioCfgGeneral, modemE1T1Channels=modemE1T1Channels, ipRadioCfgNetwork=ipRadioCfgNetwork)
