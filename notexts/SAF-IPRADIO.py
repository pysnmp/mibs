...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXByteCounterHi=ethRXByteCounterHi, ipRadioCfgGeneral=ipRadioCfgGeneral, modemACMengine=modemACMengine, modemErroredBlock=modemErroredBlock, ethTXCRCErrors=ethTXCRCErrors, modemACMmodulationMax=modemACMmodulationMax, modemTotalBlockNumber=modemTotalBlockNumber, ethTXDones=ethTXDones, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioRxLevel=radioRxLevel, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXDones=ethRXDones, microwaveRadio=microwaveRadio, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXControlFrames=ethRXControlFrames, ipRadio=ipRadio, localIp=localIp, loopback_tributary_mask=loopback_tributary_mask, localIpMask=localIpMask, ethRXByteCounterLow=ethRXByteCounterLow, ethGFPFCSErrors=ethGFPFCSErrors, ipRadioStat=ipRadioStat, modemLastAcqError=modemLastAcqError, licenseMask=licenseMask, modemTable=modemTable, ethTXLateCollisions=ethTXLateCollisions, radioTxPower=radioTxPower, atpcIndex=atpcIndex, modemModulation=modemModulation, modemCountTime=modemCountTime, remoteIp=remoteIp, modemUptime=modemUptime, ethTXVlanTags=ethTXVlanTags, tehnika=tehnika, modemBackgroundBlockErrror=modemBackgroundBlockErrror, product=product, radioEntry=radioEntry, saf=saf, vlanTable=vlanTable, ethGFPCHECErrors=ethGFPCHECErrors, ethTXByteCounterLow=ethTXByteCounterLow, radioGenStatus=radioGenStatus, vlanPortType=vlanPortType, ethRXMulticasts=ethRXMulticasts, e1t1ChannelNr=e1t1ChannelNr, modemAcqStatus=modemAcqStatus, atpcTxPowerCorrection=atpcTxPowerCorrection, loopbacks=loopbacks, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXExcessiveDefers=ethTXExcessiveDefers, vlanEntry=vlanEntry, ethRXCodeErrors=ethRXCodeErrors, license=license, radioRxFrequency=radioRxFrequency, modemEthernetCapacity=modemEthernetCapacity, ethQOSTXFrames=ethQOSTXFrames, ethTXPauseFrames=ethTXPauseFrames, ethTXByteCounterHi=ethTXByteCounterHi, radioTxMute=radioTxMute, ethRXPrevPktDropped=ethRXPrevPktDropped, modemACMtotalCapacity=modemACMtotalCapacity, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXGiants=ethTXGiants, radioTxFrequency=radioTxFrequency, radioIndex=radioIndex, ethRXBroadcasts=ethRXBroadcasts, safip=safip, vlanRowStatus=vlanRowStatus, ethQOSTXDropped=ethQOSTXDropped, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXBroadcasts=ethTXBroadcasts, ethRXUnsupOpcodes=ethRXUnsupOpcodes, aTPCEntry=aTPCEntry, ethGFPDropedFrames=ethGFPDropedFrames, ipRadioCfg=ipRadioCfg, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemIndex=modemIndex, ethTXControlFrames=ethTXControlFrames, modemInternalAGCgain=modemInternalAGCgain, ethTXMaxCollisions=ethTXMaxCollisions, ethTXBackpresEvents=ethTXBackpresEvents, aTPCTable=aTPCTable, ethRXCRCErrors=ethRXCRCErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, modemE1T1ChannelMask=modemE1T1ChannelMask, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioTable=radioTable, ethRXLongEvents=ethRXLongEvents, modemSymbolRateRx=modemSymbolRateRx, radioLoopback=radioLoopback, modemStatistics=modemStatistics, ethRXPauseFrames=ethRXPauseFrames, modemGeneralStatus=modemGeneralStatus, modemLDPCdecoderStress=modemLDPCdecoderStress, modemBandwith=modemBandwith, vlanNumber=vlanNumber, ethTXMulticasts=ethTXMulticasts, pointToPoint=pointToPoint, modemACMethernetCapacity=modemACMethernetCapacity, e1t1StatTable=e1t1StatTable, modemUnavailtime=modemUnavailtime, vlanFid=vlanFid, atpcEnabled=atpcEnabled, modemErroredSecondRatio=modemErroredSecondRatio, modemStandard=modemStandard, ethTXUnderruns=ethTXUnderruns, e1t1AIS=e1t1AIS, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, description=description, radioSide=radioSide, sysDateAndTime=sysDateAndTime, hostname=hostname, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemSymbolRateTx=modemSymbolRateTx, vlanCfgStat=vlanCfgStat, modemTotalCapacity=modemTotalCapacity, licenseUpdateStatus=licenseUpdateStatus, vlanPortmap=vlanPortmap, modemACMmodulationMin=modemACMmodulationMin, modemCarrierOffset=modemCarrierOffset, ipRadioStatEth=ipRadioStatEth, vlansEnabled=vlansEnabled, modemErroredSecond=modemErroredSecond, ethRXDvEvent=ethRXDvEvent, ethRXDribleNibbles=ethRXDribleNibbles, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioDuplexShift=radioDuplexShift, e1t1LOS=e1t1LOS, writeConfig=writeConfig, modemRadialMSE=modemRadialMSE, sysTemperature=sysTemperature, ethTXCollisions=ethTXCollisions, ethRXTruncatedFrames=ethRXTruncatedFrames, ipRadioMgmt=ipRadioMgmt, restartcpu=restartcpu, modemEntry=modemEntry, e1t1StatEntry=e1t1StatEntry, modemE1T1Channels=modemE1T1Channels, modemRowStatus=modemRowStatus)
