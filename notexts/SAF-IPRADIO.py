...
mibBuilder.exportSymbols("SAF-IPRADIO", saf=saf, ethRXByteCounterLow=ethRXByteCounterLow, aTPCEntry=aTPCEntry, ipRadioCfgGeneral=ipRadioCfgGeneral, ipRadioMgmt=ipRadioMgmt, radioGenStatus=radioGenStatus, radioIndex=radioIndex, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, sysDateAndTime=sysDateAndTime, tehnika=tehnika, modemModulation=modemModulation, microwaveRadio=microwaveRadio, ethTXLateCollisions=ethTXLateCollisions, localIpMask=localIpMask, product=product, radioTxMute=radioTxMute, radioRxLevel=radioRxLevel, restartcpu=restartcpu, ethRXMulticasts=ethRXMulticasts, modemBandwith=modemBandwith, ethTXCollisions=ethTXCollisions, modemEthernetCapacity=modemEthernetCapacity, vlanEntry=vlanEntry, ethRXDvEvent=ethRXDvEvent, modemRadialMSE=modemRadialMSE, modemUptime=modemUptime, safip=safip, loopback_tributary_mask=loopback_tributary_mask, ethGFPDelineationErrors=ethGFPDelineationErrors, modemErroredBlock=modemErroredBlock, ethRXByteCounterHi=ethRXByteCounterHi, modemInternalAGCgain=modemInternalAGCgain, modemErroredSecond=modemErroredSecond, e1t1StatEntry=e1t1StatEntry, radioSide=radioSide, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemCountTime=modemCountTime, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ipRadioStatEth=ipRadioStatEth, ipRadioCfg=ipRadioCfg, modemAcqStatus=modemAcqStatus, modemRowStatus=modemRowStatus, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXUnderruns=ethTXUnderruns, ethTXBroadcasts=ethTXBroadcasts, radioLoopback=radioLoopback, localIp=localIp, aTPCTable=aTPCTable, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethQOSTXDropped=ethQOSTXDropped, ethTXPauseFrames=ethTXPauseFrames, licenseUpdateStatus=licenseUpdateStatus, modemACMmodulationMax=modemACMmodulationMax, radioRxFrequency=radioRxFrequency, modemACMmodulationMin=modemACMmodulationMin, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemTotalBlockNumber=modemTotalBlockNumber, vlanCfgStat=vlanCfgStat, ethRXLongEvents=ethRXLongEvents, modemErroredSecondRatio=modemErroredSecondRatio, ethRXBroadcasts=ethRXBroadcasts, modemUnavailtime=modemUnavailtime, atpcEnabled=atpcEnabled, ethRXDones=ethRXDones, modemACMtotalCapacity=modemACMtotalCapacity, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemIndex=modemIndex, remoteIp=remoteIp, vlanTable=vlanTable, ethRXCodeErrors=ethRXCodeErrors, e1t1ChannelNr=e1t1ChannelNr, ethTXByteCounterLow=ethTXByteCounterLow, vlansEnabled=vlansEnabled, radioDuplexShift=radioDuplexShift, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXMulticasts=ethTXMulticasts, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXControlFrames=ethRXControlFrames, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethQOSTXFrames=ethQOSTXFrames, modemSymbolRateTx=modemSymbolRateTx, modemACMengine=modemACMengine, modemCarrierOffset=modemCarrierOffset, ethTXByteCounterHi=ethTXByteCounterHi, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, hostname=hostname, atpcIndex=atpcIndex, radioTxPower=radioTxPower, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXCRCErrors=ethRXCRCErrors, vlanRowStatus=vlanRowStatus, ethRXDribleNibbles=ethRXDribleNibbles, ethRXPrevPktDropped=ethRXPrevPktDropped, e1t1StatTable=e1t1StatTable, vlanPortmap=vlanPortmap, license=license, modemEntry=modemEntry, ethGFPDropedFrames=ethGFPDropedFrames, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXControlFrames=ethTXControlFrames, modemTable=modemTable, sysTemperature=sysTemperature, modemStandard=modemStandard, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXDones=ethTXDones, radioEntry=radioEntry, atpcTxPowerCorrection=atpcTxPowerCorrection, e1t1AIS=e1t1AIS, modemLastAcqError=modemLastAcqError, ethTXCRCErrors=ethTXCRCErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ipRadio=ipRadio, modemGeneralStatus=modemGeneralStatus, ethGFPFCSErrors=ethGFPFCSErrors, writeConfig=writeConfig, modemACMethernetCapacity=modemACMethernetCapacity, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethGFPCHECErrors=ethGFPCHECErrors, e1t1LOS=e1t1LOS, modemStatistics=modemStatistics, vlanNumber=vlanNumber, description=description, ipRadioStat=ipRadioStat, ethTXGiants=ethTXGiants, licenseMask=licenseMask, ethTXVlanTags=ethTXVlanTags, ethTXMaxCollisions=ethTXMaxCollisions, vlanFid=vlanFid, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXBackpresEvents=ethTXBackpresEvents, radioTxFrequency=radioTxFrequency, modemE1T1Channels=modemE1T1Channels, vlanPortType=vlanPortType, ethTXExcessiveDefers=ethTXExcessiveDefers, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemSymbolRateRx=modemSymbolRateRx, loopbacks=loopbacks, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemTotalCapacity=modemTotalCapacity, radioTable=radioTable, pointToPoint=pointToPoint, ethRXPauseFrames=ethRXPauseFrames)
