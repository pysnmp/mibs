...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXPauseFrames=ethRXPauseFrames, ethRXMulticasts=ethRXMulticasts, modemErroredSecondRatio=modemErroredSecondRatio, ethGFPDropedFrames=ethGFPDropedFrames, ethTXExcessiveDefers=ethTXExcessiveDefers, modemErroredBlock=modemErroredBlock, ethRXByteCounterHi=ethRXByteCounterHi, radioTable=radioTable, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioEntry=radioEntry, remoteIp=remoteIp, ethTXPauseFrames=ethTXPauseFrames, writeConfig=writeConfig, modemTotalCapacity=modemTotalCapacity, license=license, ethRXCRCErrors=ethRXCRCErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemACMtotalCapacity=modemACMtotalCapacity, ethTXByteCounterHi=ethTXByteCounterHi, e1t1ChannelNr=e1t1ChannelNr, modemCountTime=modemCountTime, modemACMmodulationMin=modemACMmodulationMin, vlanTable=vlanTable, ethRXDribleNibbles=ethRXDribleNibbles, modemE1T1Channels=modemE1T1Channels, modemUptime=modemUptime, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, saf=saf, ethRXDones=ethRXDones, sysTemperature=sysTemperature, ipRadioCfgNetwork=ipRadioCfgNetwork, modemLastAcqError=modemLastAcqError, ethTXVlanTags=ethTXVlanTags, ethTXCollisions=ethTXCollisions, ethGFPFCSErrors=ethGFPFCSErrors, radioIndex=radioIndex, ipRadioMgmt=ipRadioMgmt, ethTXBackpresEvents=ethTXBackpresEvents, ethQOSTXFrames=ethQOSTXFrames, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, description=description, radioRxFrequency=radioRxFrequency, tehnika=tehnika, ethGFPDelineationErrors=ethGFPDelineationErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemACMengine=modemACMengine, ethTXLateCollisions=ethTXLateCollisions, localIpMask=localIpMask, modemModulation=modemModulation, ipRadioStat=ipRadioStat, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, vlanFid=vlanFid, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemGeneralStatus=modemGeneralStatus, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemE1T1ChannelMask=modemE1T1ChannelMask, modemSymbolRateTx=modemSymbolRateTx, restartcpu=restartcpu, modemRadialMSE=modemRadialMSE, vlanRowStatus=vlanRowStatus, safip=safip, ethRXDvEvent=ethRXDvEvent, modemTable=modemTable, loopback_tributary_mask=loopback_tributary_mask, radioTxFrequency=radioTxFrequency, vlansEnabled=vlansEnabled, ipRadioStatEth=ipRadioStatEth, radioDuplexShift=radioDuplexShift, ethTXMaxCollisions=ethTXMaxCollisions, modemIndex=modemIndex, modemAcqStatus=modemAcqStatus, modemStatistics=modemStatistics, pointToPoint=pointToPoint, licenseUpdateStatus=licenseUpdateStatus, ethRXBroadcasts=ethRXBroadcasts, atpcIndex=atpcIndex, modemUnavailtime=modemUnavailtime, modemInternalAGCgain=modemInternalAGCgain, modemLDPCdecoderStress=modemLDPCdecoderStress, vlanPortmap=vlanPortmap, modemSeverelyErroredSecond=modemSeverelyErroredSecond, microwaveRadio=microwaveRadio, modemCarrierOffset=modemCarrierOffset, ethTXGiants=ethTXGiants, product=product, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethQOSTXDropped=ethQOSTXDropped, modemSymbolRateRx=modemSymbolRateRx, modemErroredSecond=modemErroredSecond, radioSide=radioSide, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ipRadioCfg=ipRadioCfg, ipRadio=ipRadio, ethGFPCHECErrors=ethGFPCHECErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, e1t1AIS=e1t1AIS, modemTotalBlockNumber=modemTotalBlockNumber, radioLoopback=radioLoopback, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXWireByteCounterHi=ethTXWireByteCounterHi, vlanPortType=vlanPortType, vlanNumber=vlanNumber, radioRxLevel=radioRxLevel, ethRXByteCounterLow=ethRXByteCounterLow, vlanEntry=vlanEntry, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXControlFrames=ethTXControlFrames, modemACMethernetCapacity=modemACMethernetCapacity, ethQOSRXQ2Frames=ethQOSRXQ2Frames, licenseMask=licenseMask, modemEthernetCapacity=modemEthernetCapacity, ipRadioCfgGeneral=ipRadioCfgGeneral, modemRowStatus=modemRowStatus, aTPCEntry=aTPCEntry, modemACMmodulationMax=modemACMmodulationMax, ethTXUnderruns=ethTXUnderruns, atpcEnabled=atpcEnabled, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, e1t1StatEntry=e1t1StatEntry, ethTXMulticasts=ethTXMulticasts, radioTxMute=radioTxMute, ethTXByteCounterLow=ethTXByteCounterLow, ethRXCodeErrors=ethRXCodeErrors, modemBandwith=modemBandwith, loopbacks=loopbacks, aTPCTable=aTPCTable, ethTXDones=ethTXDones, ethTXBroadcasts=ethTXBroadcasts, ethRXLongEvents=ethRXLongEvents, hostname=hostname, sysDateAndTime=sysDateAndTime, radioTxPower=radioTxPower, vlanCfgStat=vlanCfgStat, modemEntry=modemEntry, e1t1StatTable=e1t1StatTable, ethTXCRCErrors=ethTXCRCErrors, radioGenStatus=radioGenStatus, localIp=localIp, e1t1LOS=e1t1LOS, modemStandard=modemStandard, ethRXControlFrames=ethRXControlFrames, ethRXTruncatedFrames=ethRXTruncatedFrames)
