...
mibBuilder.exportSymbols("SAF-IPRADIO", ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemInternalAGCgain=modemInternalAGCgain, vlansEnabled=vlansEnabled, modemTotalBlockNumber=modemTotalBlockNumber, ethTXLateCollisions=ethTXLateCollisions, modemRowStatus=modemRowStatus, ipRadioCfg=ipRadioCfg, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemACMethernetCapacity=modemACMethernetCapacity, modemSeverelyErroredSecond=modemSeverelyErroredSecond, writeConfig=writeConfig, microwaveRadio=microwaveRadio, e1t1ChannelNr=e1t1ChannelNr, ethRXPauseFrames=ethRXPauseFrames, modemLastAcqError=modemLastAcqError, vlanPortType=vlanPortType, modemStandard=modemStandard, radioDuplexShift=radioDuplexShift, ethQOSTXDropped=ethQOSTXDropped, ethRXBroadcasts=ethRXBroadcasts, licenseUpdateStatus=licenseUpdateStatus, ethTXExcessiveDefers=ethTXExcessiveDefers, modemUnavailtime=modemUnavailtime, vlanRowStatus=vlanRowStatus, vlanPortmap=vlanPortmap, modemUptime=modemUptime, vlanTable=vlanTable, hostname=hostname, remoteIp=remoteIp, modemErroredSecond=modemErroredSecond, ethTXUnderruns=ethTXUnderruns, ethRXCRCErrors=ethRXCRCErrors, e1t1StatTable=e1t1StatTable, ethTXMaxCollisions=ethTXMaxCollisions, ethGFPDropedFrames=ethGFPDropedFrames, tehnika=tehnika, modemStatistics=modemStatistics, modemEthernetCapacity=modemEthernetCapacity, radioTxPower=radioTxPower, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemE1T1Channels=modemE1T1Channels, e1t1StatEntry=e1t1StatEntry, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, atpcIndex=atpcIndex, radioTxMute=radioTxMute, vlanCfgStat=vlanCfgStat, ethTXPauseFrames=ethTXPauseFrames, radioSide=radioSide, e1t1AIS=e1t1AIS, radioIndex=radioIndex, modemAcqStatus=modemAcqStatus, ipRadioCfgNetwork=ipRadioCfgNetwork, localIp=localIp, ipRadioStatEth=ipRadioStatEth, ethRXTruncatedFrames=ethRXTruncatedFrames, modemErroredSecondRatio=modemErroredSecondRatio, ethTXCollisions=ethTXCollisions, ethTXVlanTags=ethTXVlanTags, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, pointToPoint=pointToPoint, ethTXBackpresEvents=ethTXBackpresEvents, atpcTxPowerCorrection=atpcTxPowerCorrection, modemTable=modemTable, loopbacks=loopbacks, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethGFPCHECErrors=ethGFPCHECErrors, sysTemperature=sysTemperature, modemSymbolRateTx=modemSymbolRateTx, ethRXDones=ethRXDones, modemRadialMSE=modemRadialMSE, ipRadioMgmt=ipRadioMgmt, ethRXDribleNibbles=ethRXDribleNibbles, ethRXByteCounterHi=ethRXByteCounterHi, sysDateAndTime=sysDateAndTime, modemEntry=modemEntry, modemIndex=modemIndex, radioTable=radioTable, ethTXByteCounterHi=ethTXByteCounterHi, modemBandwith=modemBandwith, atpcEnabled=atpcEnabled, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemSymbolRateRx=modemSymbolRateRx, aTPCTable=aTPCTable, ethTXCRCErrors=ethTXCRCErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXBroadcasts=ethTXBroadcasts, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ipRadioStat=ipRadioStat, modemGeneralStatus=modemGeneralStatus, licenseMask=licenseMask, license=license, vlanEntry=vlanEntry, vlanFid=vlanFid, ethTXDones=ethTXDones, radioTxFrequency=radioTxFrequency, safip=safip, product=product, modemModulation=modemModulation, ethGFPDelineationErrors=ethGFPDelineationErrors, radioEntry=radioEntry, ethRXControlFrames=ethRXControlFrames, modemACMengine=modemACMengine, modemTotalCapacity=modemTotalCapacity, loopback_tributary_mask=loopback_tributary_mask, modemE1T1ChannelMask=modemE1T1ChannelMask, ethGFPFCSErrors=ethGFPFCSErrors, modemLDPCdecoderStress=modemLDPCdecoderStress, modemACMtotalCapacity=modemACMtotalCapacity, ethTXLengthCheckErrors=ethTXLengthCheckErrors, e1t1LOS=e1t1LOS, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemErroredBlock=modemErroredBlock, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ipRadioCfgGeneral=ipRadioCfgGeneral, saf=saf, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioGenStatus=radioGenStatus, ethTXMulticasts=ethTXMulticasts, radioRxFrequency=radioRxFrequency, ethRXMulticasts=ethRXMulticasts, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, restartcpu=restartcpu, vlanNumber=vlanNumber, ethRXByteCounterLow=ethRXByteCounterLow, radioRxLevel=radioRxLevel, radioLoopback=radioLoopback, localIpMask=localIpMask, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemCarrierOffset=modemCarrierOffset, ethQOSTXFrames=ethQOSTXFrames, ethTXGiants=ethTXGiants, ethRXCodeErrors=ethRXCodeErrors, aTPCEntry=aTPCEntry, ethRXLongEvents=ethRXLongEvents, ipRadio=ipRadio, ethTXControlFrames=ethTXControlFrames, modemCountTime=modemCountTime, ethTXByteCounterLow=ethTXByteCounterLow, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXDvEvent=ethRXDvEvent, modemACMmodulationMax=modemACMmodulationMax, modemACMmodulationMin=modemACMmodulationMin, description=description)
