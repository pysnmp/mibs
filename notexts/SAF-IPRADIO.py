...
mibBuilder.exportSymbols("SAF-IPRADIO", modemIndex=modemIndex, ethTXCollisions=ethTXCollisions, ipRadio=ipRadio, modemTotalCapacity=modemTotalCapacity, vlanTable=vlanTable, ethTXUnderruns=ethTXUnderruns, description=description, atpcEnabled=atpcEnabled, e1t1AIS=e1t1AIS, pointToPoint=pointToPoint, radioSide=radioSide, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemEthernetCapacity=modemEthernetCapacity, ethTXDones=ethTXDones, loopback_tributary_mask=loopback_tributary_mask, microwaveRadio=microwaveRadio, vlanCfgStat=vlanCfgStat, ethRXControlFrames=ethRXControlFrames, ipRadioMgmt=ipRadioMgmt, aTPCTable=aTPCTable, vlanFid=vlanFid, modemACMmodulationMin=modemACMmodulationMin, ethRXPrevPktDropped=ethRXPrevPktDropped, sysDateAndTime=sysDateAndTime, license=license, modemAcqStatus=modemAcqStatus, safip=safip, radioEntry=radioEntry, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethGFPCHECErrors=ethGFPCHECErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXByteCounterLow=ethRXByteCounterLow, e1t1ChannelNr=e1t1ChannelNr, modemRowStatus=modemRowStatus, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethGFPFCSErrors=ethGFPFCSErrors, vlanPortType=vlanPortType, sysTemperature=sysTemperature, radioRxLevel=radioRxLevel, licenseUpdateStatus=licenseUpdateStatus, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemErroredSecondRatio=modemErroredSecondRatio, ethRXBroadcasts=ethRXBroadcasts, ipRadioStatEth=ipRadioStatEth, vlansEnabled=vlansEnabled, ethTXBroadcasts=ethTXBroadcasts, modemStatistics=modemStatistics, modemGeneralStatus=modemGeneralStatus, ethTXBackpresEvents=ethTXBackpresEvents, localIp=localIp, modemSymbolRateRx=modemSymbolRateRx, modemACMengine=modemACMengine, modemE1T1Channels=modemE1T1Channels, ethRXLongEvents=ethRXLongEvents, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXCRCErrors=ethTXCRCErrors, modemModulation=modemModulation, ethTXLengthCheckErrors=ethTXLengthCheckErrors, radioTable=radioTable, localIpMask=localIpMask, saf=saf, ethTXExcessiveDefers=ethTXExcessiveDefers, e1t1StatEntry=e1t1StatEntry, ethRXByteCounterHi=ethRXByteCounterHi, modemCountTime=modemCountTime, ipRadioStat=ipRadioStat, restartcpu=restartcpu, hostname=hostname, ethRXDones=ethRXDones, licenseMask=licenseMask, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemCarrierOffset=modemCarrierOffset, ethRXDvEvent=ethRXDvEvent, modemBandwith=modemBandwith, modemErroredSecond=modemErroredSecond, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, e1t1StatTable=e1t1StatTable, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXMaxCollisions=ethTXMaxCollisions, product=product, ethTXVlanTags=ethTXVlanTags, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethQOSTXFrames=ethQOSTXFrames, radioLoopback=radioLoopback, ethGFPDelineationErrors=ethGFPDelineationErrors, radioTxFrequency=radioTxFrequency, ethTXByteCounterLow=ethTXByteCounterLow, modemE1T1ChannelMask=modemE1T1ChannelMask, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXLateCollisions=ethTXLateCollisions, remoteIp=remoteIp, modemStandard=modemStandard, vlanRowStatus=vlanRowStatus, radioIndex=radioIndex, radioDuplexShift=radioDuplexShift, ethRXPauseFrames=ethRXPauseFrames, modemACMethernetCapacity=modemACMethernetCapacity, vlanPortmap=vlanPortmap, e1t1LOS=e1t1LOS, radioTxPower=radioTxPower, ethTXControlFrames=ethTXControlFrames, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXCRCErrors=ethRXCRCErrors, loopbacks=loopbacks, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemUptime=modemUptime, modemInternalAGCgain=modemInternalAGCgain, vlanEntry=vlanEntry, ethRXMulticasts=ethRXMulticasts, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, writeConfig=writeConfig, ipRadioCfgNetwork=ipRadioCfgNetwork, modemUnavailtime=modemUnavailtime, modemTable=modemTable, modemLastAcqError=modemLastAcqError, ipRadioCfg=ipRadioCfg, ethTXPauseFrames=ethTXPauseFrames, ethRXDribleNibbles=ethRXDribleNibbles, ethTXGiants=ethTXGiants, radioGenStatus=radioGenStatus, ethRXTruncatedFrames=ethRXTruncatedFrames, vlanNumber=vlanNumber, modemErroredBlock=modemErroredBlock, ethTXMulticasts=ethTXMulticasts, ethQOSTXDropped=ethQOSTXDropped, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemACMmodulationMax=modemACMmodulationMax, atpcIndex=atpcIndex, modemACMtotalCapacity=modemACMtotalCapacity, radioRxFrequency=radioRxFrequency, modemTotalBlockNumber=modemTotalBlockNumber, modemLDPCdecoderStress=modemLDPCdecoderStress, tehnika=tehnika, ethTXByteCounterHi=ethTXByteCounterHi, ethRXCodeErrors=ethRXCodeErrors, aTPCEntry=aTPCEntry, modemEntry=modemEntry, modemSymbolRateTx=modemSymbolRateTx, radioTxMute=radioTxMute, ethGFPDropedFrames=ethGFPDropedFrames, modemRadialMSE=modemRadialMSE)
