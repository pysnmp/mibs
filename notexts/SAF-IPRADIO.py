...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXDribleNibbles=ethRXDribleNibbles, radioIndex=radioIndex, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemSymbolRateRx=modemSymbolRateRx, ethTXPauseFrames=ethTXPauseFrames, tehnika=tehnika, modemUnavailtime=modemUnavailtime, ethTXBackpresEvents=ethTXBackpresEvents, modemACMmodulationMax=modemACMmodulationMax, localIp=localIp, ethRXCodeErrors=ethRXCodeErrors, e1t1ChannelNr=e1t1ChannelNr, ethTXCRCErrors=ethTXCRCErrors, vlanPortmap=vlanPortmap, product=product, vlanTable=vlanTable, ethRXTruncatedFrames=ethRXTruncatedFrames, atpcEnabled=atpcEnabled, modemACMtotalCapacity=modemACMtotalCapacity, ipRadioCfg=ipRadioCfg, modemInternalAGCgain=modemInternalAGCgain, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ipRadioMgmt=ipRadioMgmt, modemTotalCapacity=modemTotalCapacity, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemACMethernetCapacity=modemACMethernetCapacity, license=license, ethRXControlFrames=ethRXControlFrames, ethTXByteCounterLow=ethTXByteCounterLow, licenseMask=licenseMask, modemLDPCdecoderStress=modemLDPCdecoderStress, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlanFid=vlanFid, ipRadioStat=ipRadioStat, e1t1StatTable=e1t1StatTable, modemErroredBlock=modemErroredBlock, modemCarrierOffset=modemCarrierOffset, radioTable=radioTable, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXMulticasts=ethTXMulticasts, radioTxFrequency=radioTxFrequency, modemEntry=modemEntry, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXDvEvent=ethRXDvEvent, ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadio=ipRadio, modemTotalBlockNumber=modemTotalBlockNumber, modemLastAcqError=modemLastAcqError, ethRXPrevPktDropped=ethRXPrevPktDropped, modemACMmodulationMin=modemACMmodulationMin, ethTXBroadcasts=ethTXBroadcasts, modemAcqStatus=modemAcqStatus, ethRXCRCErrors=ethRXCRCErrors, ethRXMulticasts=ethRXMulticasts, radioLoopback=radioLoopback, radioRxFrequency=radioRxFrequency, modemACMengine=modemACMengine, ethQOSTXDropped=ethQOSTXDropped, ethRXPauseFrames=ethRXPauseFrames, radioSide=radioSide, ethRXDones=ethRXDones, modemE1T1Channels=modemE1T1Channels, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlanCfgStat=vlanCfgStat, loopback_tributary_mask=loopback_tributary_mask, modemStatistics=modemStatistics, ethTXDones=ethTXDones, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, pointToPoint=pointToPoint, hostname=hostname, e1t1StatEntry=e1t1StatEntry, modemCountTime=modemCountTime, radioRxLevel=radioRxLevel, ethTXExcessiveDefers=ethTXExcessiveDefers, modemUptime=modemUptime, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, safip=safip, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXUnderruns=ethTXUnderruns, remoteIp=remoteIp, modemGeneralStatus=modemGeneralStatus, ipRadioCfgNetwork=ipRadioCfgNetwork, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemModulation=modemModulation, modemBandwith=modemBandwith, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, sysDateAndTime=sysDateAndTime, ethRXByteCounterHi=ethRXByteCounterHi, ethTXControlFrames=ethTXControlFrames, radioEntry=radioEntry, vlanPortType=vlanPortType, ethQOSRXQ1Frames=ethQOSRXQ1Frames, restartcpu=restartcpu, ipRadioStatEth=ipRadioStatEth, radioDuplexShift=radioDuplexShift, vlanRowStatus=vlanRowStatus, modemRowStatus=modemRowStatus, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioTxMute=radioTxMute, ethTXVlanTags=ethTXVlanTags, modemErroredSecondRatio=modemErroredSecondRatio, saf=saf, modemEthernetCapacity=modemEthernetCapacity, ethTXLengthCheckErrors=ethTXLengthCheckErrors, writeConfig=writeConfig, ethTXWireByteCounterHi=ethTXWireByteCounterHi, localIpMask=localIpMask, modemRadialMSE=modemRadialMSE, ethQOSTXFrames=ethQOSTXFrames, ethRXByteCounterLow=ethRXByteCounterLow, radioTxPower=radioTxPower, ethTXCollisions=ethTXCollisions, loopbacks=loopbacks, atpcIndex=atpcIndex, modemStandard=modemStandard, vlanEntry=vlanEntry, ethRXBroadcasts=ethRXBroadcasts, aTPCTable=aTPCTable, ethGFPDropedFrames=ethGFPDropedFrames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXLongEvents=ethRXLongEvents, ethGFPFCSErrors=ethGFPFCSErrors, vlanNumber=vlanNumber, sysTemperature=sysTemperature, vlansEnabled=vlansEnabled, ethGFPCHECErrors=ethGFPCHECErrors, microwaveRadio=microwaveRadio, ethTXByteCounterHi=ethTXByteCounterHi, e1t1AIS=e1t1AIS, ethTXLateCollisions=ethTXLateCollisions, ethTXGiants=ethTXGiants, description=description, modemIndex=modemIndex, e1t1LOS=e1t1LOS, ethTXMaxCollisions=ethTXMaxCollisions, modemTable=modemTable, modemErroredSecond=modemErroredSecond, licenseUpdateStatus=licenseUpdateStatus, aTPCEntry=aTPCEntry, radioGenStatus=radioGenStatus, modemSymbolRateTx=modemSymbolRateTx)
