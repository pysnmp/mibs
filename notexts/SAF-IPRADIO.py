...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemAcqStatus=modemAcqStatus, ethTXGiants=ethTXGiants, radioGenStatus=radioGenStatus, ethTXBackpresEvents=ethTXBackpresEvents, safip=safip, radioLoopback=radioLoopback, radioEntry=radioEntry, hostname=hostname, modemGeneralStatus=modemGeneralStatus, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlanFid=vlanFid, ipRadio=ipRadio, license=license, restartcpu=restartcpu, modemEntry=modemEntry, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemTable=modemTable, ethGFPFCSErrors=ethGFPFCSErrors, modemTotalBlockNumber=modemTotalBlockNumber, aTPCEntry=aTPCEntry, ethRXDvEvent=ethRXDvEvent, radioTxFrequency=radioTxFrequency, ethTXDones=ethTXDones, sysDateAndTime=sysDateAndTime, ipRadioStat=ipRadioStat, modemE1T1ChannelMask=modemE1T1ChannelMask, radioDuplexShift=radioDuplexShift, ethGFPCHECErrors=ethGFPCHECErrors, modemCarrierOffset=modemCarrierOffset, ethQOSTXDropped=ethQOSTXDropped, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXPauseFrames=ethRXPauseFrames, product=product, modemBandwith=modemBandwith, modemCountTime=modemCountTime, ethTXByteCounterHi=ethTXByteCounterHi, radioTxMute=radioTxMute, ethRXBroadcasts=ethRXBroadcasts, writeConfig=writeConfig, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ipRadioCfgGeneral=ipRadioCfgGeneral, modemRadialMSE=modemRadialMSE, microwaveRadio=microwaveRadio, modemTotalCapacity=modemTotalCapacity, remoteIp=remoteIp, ethQOSRXQ1Frames=ethQOSRXQ1Frames, e1t1ChannelNr=e1t1ChannelNr, radioSide=radioSide, radioIndex=radioIndex, saf=saf, aTPCTable=aTPCTable, modemModulation=modemModulation, modemLastAcqError=modemLastAcqError, ethTXControlFrames=ethTXControlFrames, modemE1T1Channels=modemE1T1Channels, ethTXLateCollisions=ethTXLateCollisions, e1t1StatEntry=e1t1StatEntry, modemIndex=modemIndex, ethRXControlFrames=ethRXControlFrames, modemStandard=modemStandard, ethTXVlanTags=ethTXVlanTags, modemACMengine=modemACMengine, tehnika=tehnika, ethTXLengthCheckErrors=ethTXLengthCheckErrors, vlanTable=vlanTable, modemACMethernetCapacity=modemACMethernetCapacity, vlanPortmap=vlanPortmap, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, e1t1StatTable=e1t1StatTable, ipRadioStatEth=ipRadioStatEth, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemErroredBlock=modemErroredBlock, atpcIndex=atpcIndex, ipRadioCfgNetwork=ipRadioCfgNetwork, modemInternalAGCgain=modemInternalAGCgain, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXMulticasts=ethRXMulticasts, modemErroredSecondRatio=modemErroredSecondRatio, vlanCfgStat=vlanCfgStat, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXMulticasts=ethTXMulticasts, atpcTxPowerCorrection=atpcTxPowerCorrection, modemACMtotalCapacity=modemACMtotalCapacity, localIp=localIp, radioRxLevel=radioRxLevel, vlanEntry=vlanEntry, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXDribleNibbles=ethRXDribleNibbles, ethRXByteCounterLow=ethRXByteCounterLow, description=description, ethRXLongEvents=ethRXLongEvents, ethGFPDropedFrames=ethGFPDropedFrames, ethRXDones=ethRXDones, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioRxFrequency=radioRxFrequency, ethTXCollisions=ethTXCollisions, loopbacks=loopbacks, ipRadioMgmt=ipRadioMgmt, ethQOSTXFrames=ethQOSTXFrames, modemEthernetCapacity=modemEthernetCapacity, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXMaxCollisions=ethTXMaxCollisions, vlanRowStatus=vlanRowStatus, ethRXCodeErrors=ethRXCodeErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, pointToPoint=pointToPoint, vlanPortType=vlanPortType, modemLDPCdecoderStress=modemLDPCdecoderStress, ipRadioCfg=ipRadioCfg, modemACMmodulationMin=modemACMmodulationMin, ethTXExcessiveDefers=ethTXExcessiveDefers, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioTxPower=radioTxPower, ethRXByteCounterHi=ethRXByteCounterHi, modemSymbolRateTx=modemSymbolRateTx, vlanNumber=vlanNumber, ethRXCRCErrors=ethRXCRCErrors, localIpMask=localIpMask, radioTable=radioTable, ethTXBroadcasts=ethTXBroadcasts, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXCRCErrors=ethTXCRCErrors, sysTemperature=sysTemperature, ethTXUnderruns=ethTXUnderruns, e1t1AIS=e1t1AIS, vlansEnabled=vlansEnabled, licenseMask=licenseMask, modemRowStatus=modemRowStatus, modemStatistics=modemStatistics, atpcEnabled=atpcEnabled, modemUnavailtime=modemUnavailtime, modemUptime=modemUptime, e1t1LOS=e1t1LOS, ethTXPauseFrames=ethTXPauseFrames, licenseUpdateStatus=licenseUpdateStatus, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, loopback_tributary_mask=loopback_tributary_mask, modemErroredSecond=modemErroredSecond, modemSymbolRateRx=modemSymbolRateRx, ethTXByteCounterLow=ethTXByteCounterLow, modemACMmodulationMax=modemACMmodulationMax)
