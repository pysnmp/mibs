...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioRxFrequency=radioRxFrequency, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, hostname=hostname, product=product, vlanEntry=vlanEntry, ethRXDones=ethRXDones, modemErroredBlock=modemErroredBlock, modemStatistics=modemStatistics, ethTXUnderruns=ethTXUnderruns, radioDuplexShift=radioDuplexShift, vlanFid=vlanFid, ethRXBroadcasts=ethRXBroadcasts, modemBandwith=modemBandwith, e1t1AIS=e1t1AIS, ipRadioCfgNetwork=ipRadioCfgNetwork, modemLastAcqError=modemLastAcqError, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXWireByteCounterLow=ethTXWireByteCounterLow, e1t1LOS=e1t1LOS, saf=saf, sysDateAndTime=sysDateAndTime, loopbacks=loopbacks, ethGFPCHECErrors=ethGFPCHECErrors, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, loopback_tributary_mask=loopback_tributary_mask, ethTXCRCErrors=ethTXCRCErrors, ethTXGiants=ethTXGiants, ethRXCodeErrors=ethRXCodeErrors, aTPCEntry=aTPCEntry, ethTXMulticasts=ethTXMulticasts, e1t1StatEntry=e1t1StatEntry, ethTXPauseFrames=ethTXPauseFrames, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXPrevPktDropped=ethRXPrevPktDropped, ethQOSTXDropped=ethQOSTXDropped, modemEthernetCapacity=modemEthernetCapacity, sysTemperature=sysTemperature, ethTXCollisions=ethTXCollisions, vlanPortType=vlanPortType, ethTXByteCounterLow=ethTXByteCounterLow, ethRXPauseFrames=ethRXPauseFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, atpcEnabled=atpcEnabled, vlanTable=vlanTable, modemCarrierOffset=modemCarrierOffset, microwaveRadio=microwaveRadio, ethRXControlFrames=ethRXControlFrames, ethTXDones=ethTXDones, modemACMmodulationMin=modemACMmodulationMin, ethTXLateCollisions=ethTXLateCollisions, modemAcqStatus=modemAcqStatus, modemErroredSecond=modemErroredSecond, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemErroredSecondRatio=modemErroredSecondRatio, modemCountTime=modemCountTime, ethRXDribleNibbles=ethRXDribleNibbles, modemUnavailtime=modemUnavailtime, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ipRadioStatEth=ipRadioStatEth, radioTxPower=radioTxPower, modemE1T1Channels=modemE1T1Channels, modemTable=modemTable, license=license, ethTXMaxCollisions=ethTXMaxCollisions, modemTotalBlockNumber=modemTotalBlockNumber, localIp=localIp, modemTotalCapacity=modemTotalCapacity, modemSymbolRateTx=modemSymbolRateTx, radioTable=radioTable, ethGFPDropedFrames=ethGFPDropedFrames, ethRXLongEvents=ethRXLongEvents, modemModulation=modemModulation, e1t1StatTable=e1t1StatTable, radioEntry=radioEntry, modemSymbolRateRx=modemSymbolRateRx, ethRXDvEvent=ethRXDvEvent, radioTxMute=radioTxMute, modemGeneralStatus=modemGeneralStatus, modemRadialMSE=modemRadialMSE, ethTXBackpresEvents=ethTXBackpresEvents, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemEntry=modemEntry, radioTxFrequency=radioTxFrequency, ethQOSTXFrames=ethQOSTXFrames, modemRowStatus=modemRowStatus, radioGenStatus=radioGenStatus, ethTXVlanTags=ethTXVlanTags, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, writeConfig=writeConfig, description=description, vlanRowStatus=vlanRowStatus, modemE1T1ChannelMask=modemE1T1ChannelMask, ipRadioCfg=ipRadioCfg, ethGFPFCSErrors=ethGFPFCSErrors, ipRadio=ipRadio, pointToPoint=pointToPoint, vlansEnabled=vlansEnabled, modemInternalAGCgain=modemInternalAGCgain, radioRxLevel=radioRxLevel, modemStandard=modemStandard, vlanPortmap=vlanPortmap, ethRXTruncatedFrames=ethRXTruncatedFrames, modemACMethernetCapacity=modemACMethernetCapacity, aTPCTable=aTPCTable, ethRXByteCounterHi=ethRXByteCounterHi, safip=safip, ipRadioStat=ipRadioStat, restartcpu=restartcpu, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioIndex=radioIndex, e1t1ChannelNr=e1t1ChannelNr, vlanCfgStat=vlanCfgStat, modemACMengine=modemACMengine, ethRXMulticasts=ethRXMulticasts, ethRXCRCErrors=ethRXCRCErrors, ipRadioMgmt=ipRadioMgmt, radioLoopback=radioLoopback, ethRXByteCounterLow=ethRXByteCounterLow, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemACMtotalCapacity=modemACMtotalCapacity, localIpMask=localIpMask, modemIndex=modemIndex, modemUptime=modemUptime, vlanNumber=vlanNumber, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXBroadcasts=ethTXBroadcasts, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioSide=radioSide, licenseMask=licenseMask, tehnika=tehnika, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXByteCounterHi=ethTXByteCounterHi, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXControlFrames=ethTXControlFrames, modemACMmodulationMax=modemACMmodulationMax, remoteIp=remoteIp, licenseUpdateStatus=licenseUpdateStatus, atpcIndex=atpcIndex)
