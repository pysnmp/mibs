...
mibBuilder.exportSymbols("SAF-IPRADIO", vlanCfgStat=vlanCfgStat, ipRadio=ipRadio, ethTXCRCErrors=ethTXCRCErrors, modemTable=modemTable, modemStatistics=modemStatistics, sysTemperature=sysTemperature, modemBandwith=modemBandwith, ethGFPCHECErrors=ethGFPCHECErrors, modemEntry=modemEntry, product=product, ethQOSRXQ1Frames=ethQOSRXQ1Frames, description=description, ethTXMaxCollisions=ethTXMaxCollisions, modemACMengine=modemACMengine, radioSide=radioSide, ethRXControlFrames=ethRXControlFrames, modemSymbolRateRx=modemSymbolRateRx, ethTXVlanTags=ethTXVlanTags, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemTotalCapacity=modemTotalCapacity, modemACMethernetCapacity=modemACMethernetCapacity, modemInternalAGCgain=modemInternalAGCgain, ethTXWireByteCounterLow=ethTXWireByteCounterLow, vlanTable=vlanTable, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXLateCollisions=ethTXLateCollisions, modemStandard=modemStandard, restartcpu=restartcpu, pointToPoint=pointToPoint, ethRXPauseFrames=ethRXPauseFrames, ethQOSTXDropped=ethQOSTXDropped, radioEntry=radioEntry, vlansEnabled=vlansEnabled, writeConfig=writeConfig, radioTable=radioTable, modemIndex=modemIndex, modemAcqStatus=modemAcqStatus, vlanRowStatus=vlanRowStatus, ethGFPFCSErrors=ethGFPFCSErrors, modemGeneralStatus=modemGeneralStatus, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, sysDateAndTime=sysDateAndTime, ethRXBroadcasts=ethRXBroadcasts, ethQOSRXQ2Frames=ethQOSRXQ2Frames, e1t1AIS=e1t1AIS, radioTxFrequency=radioTxFrequency, vlanPortmap=vlanPortmap, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemEthernetCapacity=modemEthernetCapacity, ethRXCRCErrors=ethRXCRCErrors, radioRxLevel=radioRxLevel, atpcEnabled=atpcEnabled, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ipRadioStat=ipRadioStat, ethTXByteCounterHi=ethTXByteCounterHi, modemSeverelyErroredSecond=modemSeverelyErroredSecond, localIpMask=localIpMask, ipRadioCfg=ipRadioCfg, ethRXDvEvent=ethRXDvEvent, modemRadialMSE=modemRadialMSE, modemModulation=modemModulation, ethRXCodeErrors=ethRXCodeErrors, tehnika=tehnika, radioDuplexShift=radioDuplexShift, ethTXPauseFrames=ethTXPauseFrames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXByteCounterHi=ethRXByteCounterHi, aTPCEntry=aTPCEntry, ethTXControlFrames=ethTXControlFrames, ethQOSTXFrames=ethQOSTXFrames, modemUptime=modemUptime, ethRXPrevPktDropped=ethRXPrevPktDropped, modemTotalBlockNumber=modemTotalBlockNumber, modemErroredSecond=modemErroredSecond, ethTXDones=ethTXDones, e1t1StatTable=e1t1StatTable, radioTxMute=radioTxMute, ipRadioCfgGeneral=ipRadioCfgGeneral, localIp=localIp, modemLDPCdecoderStress=modemLDPCdecoderStress, modemCarrierOffset=modemCarrierOffset, ethRXTruncatedFrames=ethRXTruncatedFrames, radioIndex=radioIndex, ethRXDribleNibbles=ethRXDribleNibbles, ethRXLongEvents=ethRXLongEvents, modemLastAcqError=modemLastAcqError, licenseUpdateStatus=licenseUpdateStatus, safip=safip, saf=saf, license=license, ethTXMulticasts=ethTXMulticasts, ethTXByteCounterLow=ethTXByteCounterLow, e1t1LOS=e1t1LOS, ipRadioCfgNetwork=ipRadioCfgNetwork, ipRadioMgmt=ipRadioMgmt, radioLoopback=radioLoopback, modemE1T1Channels=modemE1T1Channels, ethTXExcessiveDefers=ethTXExcessiveDefers, modemACMtotalCapacity=modemACMtotalCapacity, aTPCTable=aTPCTable, vlanNumber=vlanNumber, radioTxPower=radioTxPower, modemACMmodulationMin=modemACMmodulationMin, radioRxFrequency=radioRxFrequency, ethGFPDropedFrames=ethGFPDropedFrames, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXUnderruns=ethTXUnderruns, radioGenStatus=radioGenStatus, modemRowStatus=modemRowStatus, ethRXByteCounterLow=ethRXByteCounterLow, atpcIndex=atpcIndex, ethRXUnsupOpcodes=ethRXUnsupOpcodes, loopbacks=loopbacks, ethTXBackpresEvents=ethTXBackpresEvents, ethRXMulticasts=ethRXMulticasts, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemUnavailtime=modemUnavailtime, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlanFid=vlanFid, modemE1T1ChannelMask=modemE1T1ChannelMask, modemCountTime=modemCountTime, ethTXBroadcasts=ethTXBroadcasts, e1t1ChannelNr=e1t1ChannelNr, ethTXGiants=ethTXGiants, modemSymbolRateTx=modemSymbolRateTx, microwaveRadio=microwaveRadio, licenseMask=licenseMask, e1t1StatEntry=e1t1StatEntry, loopback_tributary_mask=loopback_tributary_mask, modemACMmodulationMax=modemACMmodulationMax, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadioStatEth=ipRadioStatEth, modemErroredSecondRatio=modemErroredSecondRatio, modemErroredBlock=modemErroredBlock, vlanPortType=vlanPortType, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, hostname=hostname, ethTXCollisions=ethTXCollisions, ethRXDones=ethRXDones, vlanEntry=vlanEntry, remoteIp=remoteIp)
