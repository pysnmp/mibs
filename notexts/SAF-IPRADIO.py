...
mibBuilder.exportSymbols("SAF-IPRADIO", ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemACMtotalCapacity=modemACMtotalCapacity, localIp=localIp, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemCountTime=modemCountTime, modemCarrierOffset=modemCarrierOffset, vlanNumber=vlanNumber, ethTXWireByteCounterHi=ethTXWireByteCounterHi, writeConfig=writeConfig, ipRadio=ipRadio, aTPCEntry=aTPCEntry, licenseMask=licenseMask, localIpMask=localIpMask, ethRXDones=ethRXDones, ethRXCRCErrors=ethRXCRCErrors, ethTXDones=ethTXDones, e1t1StatTable=e1t1StatTable, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXMulticasts=ethTXMulticasts, ipRadioCfgGeneral=ipRadioCfgGeneral, restartcpu=restartcpu, modemGeneralStatus=modemGeneralStatus, loopback_tributary_mask=loopback_tributary_mask, modemUnavailtime=modemUnavailtime, ethRXCodeErrors=ethRXCodeErrors, vlanPortmap=vlanPortmap, vlanFid=vlanFid, modemIndex=modemIndex, ipRadioStatEth=ipRadioStatEth, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, aTPCTable=aTPCTable, modemACMengine=modemACMengine, modemLDPCdecoderStress=modemLDPCdecoderStress, sysTemperature=sysTemperature, modemRowStatus=modemRowStatus, ethQOSTXFrames=ethQOSTXFrames, ethRXPauseFrames=ethRXPauseFrames, modemAcqStatus=modemAcqStatus, modemTotalCapacity=modemTotalCapacity, ethTXControlFrames=ethTXControlFrames, ethGFPCHECErrors=ethGFPCHECErrors, ethGFPDropedFrames=ethGFPDropedFrames, ethQOSRXQ1Frames=ethQOSRXQ1Frames, atpcTxPowerCorrection=atpcTxPowerCorrection, licenseUpdateStatus=licenseUpdateStatus, ethGFPFCSErrors=ethGFPFCSErrors, loopbacks=loopbacks, radioLoopback=radioLoopback, ethTXLateCollisions=ethTXLateCollisions, ethRXTruncatedFrames=ethRXTruncatedFrames, radioRxLevel=radioRxLevel, pointToPoint=pointToPoint, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemUptime=modemUptime, modemEthernetCapacity=modemEthernetCapacity, ethRXDvEvent=ethRXDvEvent, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlanEntry=vlanEntry, modemStandard=modemStandard, ethGFPDelineationErrors=ethGFPDelineationErrors, vlanRowStatus=vlanRowStatus, tehnika=tehnika, radioIndex=radioIndex, ethTXWireByteCounterLow=ethTXWireByteCounterLow, e1t1LOS=e1t1LOS, ethTXMaxCollisions=ethTXMaxCollisions, modemModulation=modemModulation, ipRadioStat=ipRadioStat, ethTXBackpresEvents=ethTXBackpresEvents, modemErroredSecond=modemErroredSecond, safip=safip, microwaveRadio=microwaveRadio, description=description, modemACMethernetCapacity=modemACMethernetCapacity, vlanPortType=vlanPortType, remoteIp=remoteIp, ethTXByteCounterHi=ethTXByteCounterHi, ethTXLengthCheckErrors=ethTXLengthCheckErrors, radioRxFrequency=radioRxFrequency, saf=saf, vlansEnabled=vlansEnabled, radioTxPower=radioTxPower, modemTotalBlockNumber=modemTotalBlockNumber, radioGenStatus=radioGenStatus, modemE1T1ChannelMask=modemE1T1ChannelMask, atpcIndex=atpcIndex, ethRXByteCounterLow=ethRXByteCounterLow, ethTXVlanTags=ethTXVlanTags, radioEntry=radioEntry, e1t1StatEntry=e1t1StatEntry, modemSymbolRateTx=modemSymbolRateTx, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ipRadioCfg=ipRadioCfg, modemTable=modemTable, ethRXDribleNibbles=ethRXDribleNibbles, ethRXMulticasts=ethRXMulticasts, modemInternalAGCgain=modemInternalAGCgain, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemBandwith=modemBandwith, ethTXUnderruns=ethTXUnderruns, ethTXCollisions=ethTXCollisions, radioTxFrequency=radioTxFrequency, modemErroredSecondRatio=modemErroredSecondRatio, ethQOSTXDropped=ethQOSTXDropped, modemSymbolRateRx=modemSymbolRateRx, ethTXCRCErrors=ethTXCRCErrors, modemRadialMSE=modemRadialMSE, e1t1ChannelNr=e1t1ChannelNr, radioTable=radioTable, license=license, ethTXByteCounterLow=ethTXByteCounterLow, modemACMmodulationMax=modemACMmodulationMax, modemStatistics=modemStatistics, ipRadioMgmt=ipRadioMgmt, radioTxMute=radioTxMute, ethRXBroadcasts=ethRXBroadcasts, modemLastAcqError=modemLastAcqError, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXByteCounterHi=ethRXByteCounterHi, e1t1AIS=e1t1AIS, vlanTable=vlanTable, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXGiants=ethTXGiants, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXExcessiveDefers=ethTXExcessiveDefers, modemErroredBlock=modemErroredBlock, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXPauseFrames=ethTXPauseFrames, product=product, atpcEnabled=atpcEnabled, modemEntry=modemEntry, vlanCfgStat=vlanCfgStat, modemACMmodulationMin=modemACMmodulationMin, ethRXLongEvents=ethRXLongEvents, radioSide=radioSide, ethRXControlFrames=ethRXControlFrames, radioDuplexShift=radioDuplexShift, ethTXBroadcasts=ethTXBroadcasts, modemE1T1Channels=modemE1T1Channels, sysDateAndTime=sysDateAndTime, ethRXUnsupOpcodes=ethRXUnsupOpcodes, hostname=hostname)
