...
mibBuilder.exportSymbols("SAF-IPRADIO", modemACMmodulationMax=modemACMmodulationMax, modemErroredSecondRatio=modemErroredSecondRatio, modemSymbolRateRx=modemSymbolRateRx, aTPCTable=aTPCTable, modemTable=modemTable, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXByteCounterHi=ethRXByteCounterHi, modemStatistics=modemStatistics, vlanRowStatus=vlanRowStatus, ethRXVlanTagsDetected=ethRXVlanTagsDetected, tehnika=tehnika, e1t1StatEntry=e1t1StatEntry, ethRXControlFrames=ethRXControlFrames, radioSide=radioSide, modemGeneralStatus=modemGeneralStatus, ipRadio=ipRadio, ethTXGiants=ethTXGiants, radioDuplexShift=radioDuplexShift, vlanNumber=vlanNumber, ethRXBroadcasts=ethRXBroadcasts, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioTxFrequency=radioTxFrequency, e1t1AIS=e1t1AIS, localIpMask=localIpMask, sysTemperature=sysTemperature, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioRxLevel=radioRxLevel, modemEntry=modemEntry, ethTXByteCounterHi=ethTXByteCounterHi, ethTXControlFrames=ethTXControlFrames, ethRXLongEvents=ethRXLongEvents, ethRXDones=ethRXDones, ethTXCollisions=ethTXCollisions, modemInternalAGCgain=modemInternalAGCgain, vlanCfgStat=vlanCfgStat, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXDvEvent=ethRXDvEvent, modemEthernetCapacity=modemEthernetCapacity, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, sysDateAndTime=sysDateAndTime, pointToPoint=pointToPoint, radioEntry=radioEntry, ipRadioCfgNetwork=ipRadioCfgNetwork, license=license, ethRXCRCErrors=ethRXCRCErrors, modemUnavailtime=modemUnavailtime, ethTXMulticasts=ethTXMulticasts, modemACMethernetCapacity=modemACMethernetCapacity, modemTotalBlockNumber=modemTotalBlockNumber, radioTxMute=radioTxMute, modemLastAcqError=modemLastAcqError, product=product, vlanEntry=vlanEntry, modemACMengine=modemACMengine, modemCarrierOffset=modemCarrierOffset, ethRXByteCounterLow=ethRXByteCounterLow, ipRadioCfgGeneral=ipRadioCfgGeneral, safip=safip, remoteIp=remoteIp, description=description, ethTXMaxCollisions=ethTXMaxCollisions, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethQOSTXDropped=ethQOSTXDropped, radioGenStatus=radioGenStatus, modemTotalCapacity=modemTotalCapacity, ethRXTruncatedFrames=ethRXTruncatedFrames, vlanPortType=vlanPortType, ethRXDribleNibbles=ethRXDribleNibbles, licenseUpdateStatus=licenseUpdateStatus, restartcpu=restartcpu, loopbacks=loopbacks, modemE1T1ChannelMask=modemE1T1ChannelMask, radioLoopback=radioLoopback, ethQOSTXFrames=ethQOSTXFrames, ethRXPrevPktDropped=ethRXPrevPktDropped, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlanPortmap=vlanPortmap, aTPCEntry=aTPCEntry, modemACMtotalCapacity=modemACMtotalCapacity, ethTXBackpresEvents=ethTXBackpresEvents, ethTXPauseFrames=ethTXPauseFrames, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemBandwith=modemBandwith, ethRXCodeErrors=ethRXCodeErrors, modemLDPCdecoderStress=modemLDPCdecoderStress, ipRadioStat=ipRadioStat, modemModulation=modemModulation, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethGFPDelineationErrors=ethGFPDelineationErrors, e1t1StatTable=e1t1StatTable, radioTable=radioTable, writeConfig=writeConfig, ethTXCRCErrors=ethTXCRCErrors, vlanTable=vlanTable, ipRadioMgmt=ipRadioMgmt, ethTXDones=ethTXDones, ethTXBroadcasts=ethTXBroadcasts, e1t1LOS=e1t1LOS, vlanFid=vlanFid, radioRxFrequency=radioRxFrequency, ethGFPFCSErrors=ethGFPFCSErrors, ipRadioStatEth=ipRadioStatEth, ethRXPauseFrames=ethRXPauseFrames, modemE1T1Channels=modemE1T1Channels, ethTXByteCounterLow=ethTXByteCounterLow, ethGFPDropedFrames=ethGFPDropedFrames, ethGFPCHECErrors=ethGFPCHECErrors, modemSymbolRateTx=modemSymbolRateTx, microwaveRadio=microwaveRadio, modemErroredBlock=modemErroredBlock, radioTxPower=radioTxPower, saf=saf, vlansEnabled=vlansEnabled, ethQOSRXQ2Frames=ethQOSRXQ2Frames, localIp=localIp, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXMulticasts=ethRXMulticasts, ipRadioCfg=ipRadioCfg, radioIndex=radioIndex, atpcEnabled=atpcEnabled, modemRowStatus=modemRowStatus, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXLateCollisions=ethTXLateCollisions, loopback_tributary_mask=loopback_tributary_mask, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemACMmodulationMin=modemACMmodulationMin, atpcIndex=atpcIndex, licenseMask=licenseMask, atpcTxPowerCorrection=atpcTxPowerCorrection, modemCountTime=modemCountTime, modemIndex=modemIndex, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, e1t1ChannelNr=e1t1ChannelNr, ethTXUnderruns=ethTXUnderruns, modemStandard=modemStandard, hostname=hostname, modemUptime=modemUptime, modemAcqStatus=modemAcqStatus, modemErroredSecond=modemErroredSecond, modemRadialMSE=modemRadialMSE, ethTXVlanTags=ethTXVlanTags)
