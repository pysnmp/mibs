...
mibBuilder.exportSymbols("SAF-IPRADIO", radioTxPower=radioTxPower, ipRadio=ipRadio, licenseMask=licenseMask, ethTXVlanTags=ethTXVlanTags, ethGFPDropedFrames=ethGFPDropedFrames, atpcEnabled=atpcEnabled, vlanPortmap=vlanPortmap, description=description, atpcTxPowerCorrection=atpcTxPowerCorrection, modemModulation=modemModulation, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ipRadioMgmt=ipRadioMgmt, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, aTPCTable=aTPCTable, modemLastAcqError=modemLastAcqError, ethRXCRCErrors=ethRXCRCErrors, ethTXByteCounterLow=ethTXByteCounterLow, modemCountTime=modemCountTime, modemTotalCapacity=modemTotalCapacity, ipRadioStatEth=ipRadioStatEth, modemACMtotalCapacity=modemACMtotalCapacity, atpcIndex=atpcIndex, vlansEnabled=vlansEnabled, licenseUpdateStatus=licenseUpdateStatus, ethTXControlFrames=ethTXControlFrames, loopback_tributary_mask=loopback_tributary_mask, ethTXMaxCollisions=ethTXMaxCollisions, vlanFid=vlanFid, modemInternalAGCgain=modemInternalAGCgain, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemUptime=modemUptime, radioRxFrequency=radioRxFrequency, ethRXPrevPktDropped=ethRXPrevPktDropped, e1t1ChannelNr=e1t1ChannelNr, ipRadioCfgGeneral=ipRadioCfgGeneral, modemEntry=modemEntry, ethTXMulticasts=ethTXMulticasts, radioGenStatus=radioGenStatus, modemUnavailtime=modemUnavailtime, modemIndex=modemIndex, pointToPoint=pointToPoint, product=product, writeConfig=writeConfig, ipRadioCfg=ipRadioCfg, tehnika=tehnika, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemErroredSecondRatio=modemErroredSecondRatio, modemE1T1Channels=modemE1T1Channels, ethRXDones=ethRXDones, ethGFPDelineationErrors=ethGFPDelineationErrors, aTPCEntry=aTPCEntry, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXLateCollisions=ethTXLateCollisions, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioSide=radioSide, modemGeneralStatus=modemGeneralStatus, modemACMmodulationMin=modemACMmodulationMin, modemE1T1ChannelMask=modemE1T1ChannelMask, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, sysTemperature=sysTemperature, ethRXByteCounterHi=ethRXByteCounterHi, ethTXBroadcasts=ethTXBroadcasts, ethTXGiants=ethTXGiants, modemAcqStatus=modemAcqStatus, e1t1StatEntry=e1t1StatEntry, modemACMmodulationMax=modemACMmodulationMax, modemRowStatus=modemRowStatus, radioDuplexShift=radioDuplexShift, ethRXLongEvents=ethRXLongEvents, ethQOSTXFrames=ethQOSTXFrames, ipRadioStat=ipRadioStat, vlanCfgStat=vlanCfgStat, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXDribleNibbles=ethRXDribleNibbles, safip=safip, vlanRowStatus=vlanRowStatus, e1t1AIS=e1t1AIS, modemStandard=modemStandard, radioRxLevel=radioRxLevel, vlanPortType=vlanPortType, localIpMask=localIpMask, saf=saf, ethRXDvEvent=ethRXDvEvent, ethTXByteCounterHi=ethTXByteCounterHi, vlanEntry=vlanEntry, ethTXDones=ethTXDones, modemErroredBlock=modemErroredBlock, localIp=localIp, modemBandwith=modemBandwith, ethRXByteCounterLow=ethRXByteCounterLow, radioTxFrequency=radioTxFrequency, license=license, modemLDPCdecoderStress=modemLDPCdecoderStress, e1t1StatTable=e1t1StatTable, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemSymbolRateTx=modemSymbolRateTx, ethGFPFCSErrors=ethGFPFCSErrors, vlanTable=vlanTable, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXControlFrames=ethRXControlFrames, modemACMethernetCapacity=modemACMethernetCapacity, ethTXCollisions=ethTXCollisions, restartcpu=restartcpu, modemTotalBlockNumber=modemTotalBlockNumber, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemRadialMSE=modemRadialMSE, ethRXPauseFrames=ethRXPauseFrames, modemTable=modemTable, radioTxMute=radioTxMute, ethRXBroadcasts=ethRXBroadcasts, modemEthernetCapacity=modemEthernetCapacity, radioTable=radioTable, modemCarrierOffset=modemCarrierOffset, loopbacks=loopbacks, radioIndex=radioIndex, radioLoopback=radioLoopback, sysDateAndTime=sysDateAndTime, modemSeverelyErroredSecond=modemSeverelyErroredSecond, remoteIp=remoteIp, ethQOSTXDropped=ethQOSTXDropped, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXBackpresEvents=ethTXBackpresEvents, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemErroredSecond=modemErroredSecond, modemSymbolRateRx=modemSymbolRateRx, microwaveRadio=microwaveRadio, ethTXPauseFrames=ethTXPauseFrames, ethTXCRCErrors=ethTXCRCErrors, ethGFPCHECErrors=ethGFPCHECErrors, vlanNumber=vlanNumber, radioEntry=radioEntry, hostname=hostname, ethRXCodeErrors=ethRXCodeErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, e1t1LOS=e1t1LOS, ethTXUnderruns=ethTXUnderruns, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXMulticasts=ethRXMulticasts, ethTXExcessiveDefers=ethTXExcessiveDefers, modemACMengine=modemACMengine, modemStatistics=modemStatistics, modemBackgroundBlockErrror=modemBackgroundBlockErrror)
