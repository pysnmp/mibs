...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXDones=ethRXDones, license=license, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXBroadcasts=ethRXBroadcasts, modemErroredSecondRatio=modemErroredSecondRatio, modemSymbolRateRx=modemSymbolRateRx, vlanRowStatus=vlanRowStatus, modemErroredBlock=modemErroredBlock, modemACMengine=modemACMengine, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, restartcpu=restartcpu, writeConfig=writeConfig, modemLastAcqError=modemLastAcqError, loopback_tributary_mask=loopback_tributary_mask, ethTXControlFrames=ethTXControlFrames, radioRxFrequency=radioRxFrequency, ipRadioStat=ipRadioStat, modemACMtotalCapacity=modemACMtotalCapacity, modemAcqStatus=modemAcqStatus, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXLongEvents=ethRXLongEvents, ethTXExcessiveDefers=ethTXExcessiveDefers, radioDuplexShift=radioDuplexShift, modemTotalBlockNumber=modemTotalBlockNumber, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, licenseMask=licenseMask, modemRowStatus=modemRowStatus, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioTxFrequency=radioTxFrequency, modemBackgroundBlockErrror=modemBackgroundBlockErrror, atpcIndex=atpcIndex, radioGenStatus=radioGenStatus, vlanEntry=vlanEntry, vlanPortmap=vlanPortmap, aTPCEntry=aTPCEntry, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXCodeErrors=ethRXCodeErrors, ethGFPFCSErrors=ethGFPFCSErrors, sysTemperature=sysTemperature, modemUnavailtime=modemUnavailtime, ethRXControlFrames=ethRXControlFrames, vlanFid=vlanFid, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, atpcTxPowerCorrection=atpcTxPowerCorrection, modemCarrierOffset=modemCarrierOffset, vlansEnabled=vlansEnabled, radioSide=radioSide, modemUptime=modemUptime, ethTXCollisions=ethTXCollisions, vlanTable=vlanTable, pointToPoint=pointToPoint, ipRadioCfgNetwork=ipRadioCfgNetwork, ethGFPDelineationErrors=ethGFPDelineationErrors, safip=safip, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemSymbolRateTx=modemSymbolRateTx, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXMulticasts=ethRXMulticasts, ipRadioCfg=ipRadioCfg, radioIndex=radioIndex, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXBroadcasts=ethTXBroadcasts, ethRXDribleNibbles=ethRXDribleNibbles, ipRadio=ipRadio, modemEthernetCapacity=modemEthernetCapacity, ethTXCRCErrors=ethTXCRCErrors, modemCountTime=modemCountTime, modemBandwith=modemBandwith, ethTXLateCollisions=ethTXLateCollisions, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXBackpresEvents=ethTXBackpresEvents, microwaveRadio=microwaveRadio, sysDateAndTime=sysDateAndTime, ethTXGiants=ethTXGiants, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXDones=ethTXDones, ethQOSTXDropped=ethQOSTXDropped, radioTxMute=radioTxMute, tehnika=tehnika, ethGFPCHECErrors=ethGFPCHECErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, vlanCfgStat=vlanCfgStat, vlanNumber=vlanNumber, e1t1StatEntry=e1t1StatEntry, saf=saf, modemModulation=modemModulation, ethTXByteCounterHi=ethTXByteCounterHi, aTPCTable=aTPCTable, modemTable=modemTable, ethQOSTXFrames=ethQOSTXFrames, ethTXUnderruns=ethTXUnderruns, ipRadioCfgGeneral=ipRadioCfgGeneral, e1t1AIS=e1t1AIS, vlanPortType=vlanPortType, atpcEnabled=atpcEnabled, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXDvEvent=ethRXDvEvent, radioLoopback=radioLoopback, modemErroredSecond=modemErroredSecond, modemACMmodulationMax=modemACMmodulationMax, modemE1T1Channels=modemE1T1Channels, ethTXMaxCollisions=ethTXMaxCollisions, radioTxPower=radioTxPower, modemGeneralStatus=modemGeneralStatus, e1t1ChannelNr=e1t1ChannelNr, modemInternalAGCgain=modemInternalAGCgain, ethRXPrevPktDropped=ethRXPrevPktDropped, modemStatistics=modemStatistics, e1t1StatTable=e1t1StatTable, modemRadialMSE=modemRadialMSE, ethTXMulticasts=ethTXMulticasts, modemACMethernetCapacity=modemACMethernetCapacity, description=description, product=product, loopbacks=loopbacks, ethTXVlanTags=ethTXVlanTags, ethGFPDropedFrames=ethGFPDropedFrames, ethTXPauseFrames=ethTXPauseFrames, modemTotalCapacity=modemTotalCapacity, modemACMmodulationMin=modemACMmodulationMin, e1t1LOS=e1t1LOS, radioTable=radioTable, modemStandard=modemStandard, ethRXCRCErrors=ethRXCRCErrors, ethTXByteCounterLow=ethTXByteCounterLow, ipRadioStatEth=ipRadioStatEth, ethQOSRXQ2Frames=ethQOSRXQ2Frames, hostname=hostname, radioRxLevel=radioRxLevel, radioEntry=radioEntry, modemEntry=modemEntry, localIpMask=localIpMask, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemIndex=modemIndex, ethRXByteCounterHi=ethRXByteCounterHi, remoteIp=remoteIp, ipRadioMgmt=ipRadioMgmt, ethRXByteCounterLow=ethRXByteCounterLow, localIp=localIp, ethRXPauseFrames=ethRXPauseFrames, licenseUpdateStatus=licenseUpdateStatus)
