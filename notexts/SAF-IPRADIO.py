...
mibBuilder.exportSymbols("SAF-IPRADIO", modemTotalCapacity=modemTotalCapacity, atpcEnabled=atpcEnabled, vlanRowStatus=vlanRowStatus, ethTXBackpresEvents=ethTXBackpresEvents, modemStandard=modemStandard, saf=saf, radioTable=radioTable, modemACMethernetCapacity=modemACMethernetCapacity, ethRXByteCounterHi=ethRXByteCounterHi, radioRxFrequency=radioRxFrequency, modemRowStatus=modemRowStatus, atpcIndex=atpcIndex, loopback_tributary_mask=loopback_tributary_mask, ethRXDribleNibbles=ethRXDribleNibbles, ethGFPFCSErrors=ethGFPFCSErrors, modemModulation=modemModulation, ethTXBroadcasts=ethTXBroadcasts, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ipRadioCfg=ipRadioCfg, modemE1T1ChannelMask=modemE1T1ChannelMask, vlanTable=vlanTable, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXLateCollisions=ethTXLateCollisions, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethGFPCHECErrors=ethGFPCHECErrors, vlanNumber=vlanNumber, e1t1AIS=e1t1AIS, modemErroredSecond=modemErroredSecond, license=license, radioSide=radioSide, modemACMmodulationMax=modemACMmodulationMax, vlanEntry=vlanEntry, modemInternalAGCgain=modemInternalAGCgain, ipRadioMgmt=ipRadioMgmt, ethTXDones=ethTXDones, writeConfig=writeConfig, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, tehnika=tehnika, radioGenStatus=radioGenStatus, modemSymbolRateTx=modemSymbolRateTx, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemGeneralStatus=modemGeneralStatus, modemUnavailtime=modemUnavailtime, ipRadioCfgNetwork=ipRadioCfgNetwork, restartcpu=restartcpu, ipRadio=ipRadio, safip=safip, product=product, modemIndex=modemIndex, ipRadioStatEth=ipRadioStatEth, modemErroredSecondRatio=modemErroredSecondRatio, modemACMtotalCapacity=modemACMtotalCapacity, hostname=hostname, ethQOSTXDropped=ethQOSTXDropped, vlanFid=vlanFid, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethQOSTXFrames=ethQOSTXFrames, modemACMmodulationMin=modemACMmodulationMin, vlanCfgStat=vlanCfgStat, ethRXVlanTagsDetected=ethRXVlanTagsDetected, e1t1LOS=e1t1LOS, localIp=localIp, modemAcqStatus=modemAcqStatus, ethTXByteCounterLow=ethTXByteCounterLow, pointToPoint=pointToPoint, ethRXLongEvents=ethRXLongEvents, vlanPortType=vlanPortType, ethGFPDelineationErrors=ethGFPDelineationErrors, loopbacks=loopbacks, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, aTPCEntry=aTPCEntry, ethTXCollisions=ethTXCollisions, modemCountTime=modemCountTime, ethTXMaxCollisions=ethTXMaxCollisions, modemEntry=modemEntry, description=description, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemSymbolRateRx=modemSymbolRateRx, modemTable=modemTable, aTPCTable=aTPCTable, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, remoteIp=remoteIp, radioLoopback=radioLoopback, ethRXDones=ethRXDones, ethTXPauseFrames=ethTXPauseFrames, ipRadioCfgGeneral=ipRadioCfgGeneral, vlanPortmap=vlanPortmap, ethRXPauseFrames=ethRXPauseFrames, ethRXPrevPktDropped=ethRXPrevPktDropped, modemLastAcqError=modemLastAcqError, modemCarrierOffset=modemCarrierOffset, ipRadioStat=ipRadioStat, modemLDPCdecoderStress=modemLDPCdecoderStress, localIpMask=localIpMask, ethTXGiants=ethTXGiants, licenseMask=licenseMask, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemTotalBlockNumber=modemTotalBlockNumber, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioTxMute=radioTxMute, modemStatistics=modemStatistics, modemEthernetCapacity=modemEthernetCapacity, microwaveRadio=microwaveRadio, radioEntry=radioEntry, sysDateAndTime=sysDateAndTime, modemBandwith=modemBandwith, ethRXControlFrames=ethRXControlFrames, ethTXCRCErrors=ethTXCRCErrors, modemACMengine=modemACMengine, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXDvEvent=ethRXDvEvent, ethTXUnderruns=ethTXUnderruns, ethTXVlanTags=ethTXVlanTags, e1t1ChannelNr=e1t1ChannelNr, ethGFPDropedFrames=ethGFPDropedFrames, ethRXBroadcasts=ethRXBroadcasts, licenseUpdateStatus=licenseUpdateStatus, modemRadialMSE=modemRadialMSE, radioTxPower=radioTxPower, ethTXMulticasts=ethTXMulticasts, e1t1StatEntry=e1t1StatEntry, vlansEnabled=vlansEnabled, e1t1StatTable=e1t1StatTable, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioIndex=radioIndex, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXByteCounterHi=ethTXByteCounterHi, ethTXControlFrames=ethTXControlFrames, sysTemperature=sysTemperature, ethRXCRCErrors=ethRXCRCErrors, radioDuplexShift=radioDuplexShift, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXCodeErrors=ethRXCodeErrors, modemUptime=modemUptime, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXByteCounterLow=ethRXByteCounterLow, modemErroredBlock=modemErroredBlock, modemE1T1Channels=modemE1T1Channels, ethRXMulticasts=ethRXMulticasts, radioRxLevel=radioRxLevel, radioTxFrequency=radioTxFrequency)
