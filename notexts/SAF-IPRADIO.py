...
mibBuilder.exportSymbols("SAF-IPRADIO", e1t1AIS=e1t1AIS, aTPCTable=aTPCTable, ethTXMulticasts=ethTXMulticasts, modemLastAcqError=modemLastAcqError, aTPCEntry=aTPCEntry, modemTotalBlockNumber=modemTotalBlockNumber, modemModulation=modemModulation, ethTXLateCollisions=ethTXLateCollisions, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXBroadcasts=ethTXBroadcasts, modemRadialMSE=modemRadialMSE, ethQOSTXDropped=ethQOSTXDropped, ethTXControlFrames=ethTXControlFrames, modemCarrierOffset=modemCarrierOffset, ethRXMulticasts=ethRXMulticasts, e1t1LOS=e1t1LOS, localIpMask=localIpMask, modemSymbolRateRx=modemSymbolRateRx, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemACMengine=modemACMengine, saf=saf, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXVlanTags=ethTXVlanTags, modemStandard=modemStandard, modemErroredSecondRatio=modemErroredSecondRatio, radioGenStatus=radioGenStatus, ethRXDribleNibbles=ethRXDribleNibbles, ethGFPDropedFrames=ethGFPDropedFrames, radioEntry=radioEntry, vlanEntry=vlanEntry, ethRXPauseFrames=ethRXPauseFrames, modemAcqStatus=modemAcqStatus, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemErroredSecond=modemErroredSecond, radioTable=radioTable, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemLDPCdecoderStress=modemLDPCdecoderStress, pointToPoint=pointToPoint, ipRadioStat=ipRadioStat, vlanFid=vlanFid, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXMaxCollisions=ethTXMaxCollisions, ethRXDones=ethRXDones, vlanNumber=vlanNumber, modemEntry=modemEntry, ipRadio=ipRadio, ethTXCRCErrors=ethTXCRCErrors, ethTXDones=ethTXDones, safip=safip, ipRadioMgmt=ipRadioMgmt, ethGFPCHECErrors=ethGFPCHECErrors, modemIndex=modemIndex, vlanTable=vlanTable, radioDuplexShift=radioDuplexShift, e1t1StatTable=e1t1StatTable, modemCountTime=modemCountTime, loopback_tributary_mask=loopback_tributary_mask, sysTemperature=sysTemperature, modemBandwith=modemBandwith, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXPauseFrames=ethTXPauseFrames, modemE1T1ChannelMask=modemE1T1ChannelMask, writeConfig=writeConfig, modemACMmodulationMax=modemACMmodulationMax, sysDateAndTime=sysDateAndTime, hostname=hostname, modemACMtotalCapacity=modemACMtotalCapacity, modemTable=modemTable, modemUptime=modemUptime, ethRXControlFrames=ethRXControlFrames, vlanPortType=vlanPortType, restartcpu=restartcpu, ipRadioStatEth=ipRadioStatEth, description=description, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, e1t1ChannelNr=e1t1ChannelNr, localIp=localIp, radioTxPower=radioTxPower, ipRadioCfg=ipRadioCfg, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXCollisions=ethTXCollisions, ethRXByteCounterHi=ethRXByteCounterHi, ethTXByteCounterHi=ethTXByteCounterHi, license=license, radioRxLevel=radioRxLevel, radioRxFrequency=radioRxFrequency, modemInternalAGCgain=modemInternalAGCgain, vlanCfgStat=vlanCfgStat, modemGeneralStatus=modemGeneralStatus, modemErroredBlock=modemErroredBlock, microwaveRadio=microwaveRadio, ethQOSTXFrames=ethQOSTXFrames, atpcEnabled=atpcEnabled, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, atpcIndex=atpcIndex, modemE1T1Channels=modemE1T1Channels, modemTotalCapacity=modemTotalCapacity, modemStatistics=modemStatistics, vlansEnabled=vlansEnabled, ethRXDvEvent=ethRXDvEvent, modemRowStatus=modemRowStatus, ethTXGiants=ethTXGiants, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXCodeErrors=ethRXCodeErrors, remoteIp=remoteIp, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXByteCounterLow=ethTXByteCounterLow, modemACMethernetCapacity=modemACMethernetCapacity, ethTXLengthCheckErrors=ethTXLengthCheckErrors, vlanPortmap=vlanPortmap, ethRXBroadcasts=ethRXBroadcasts, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXLongEvents=ethRXLongEvents, ethRXUnsupOpcodes=ethRXUnsupOpcodes, tehnika=tehnika, licenseUpdateStatus=licenseUpdateStatus, radioIndex=radioIndex, radioSide=radioSide, ipRadioCfgNetwork=ipRadioCfgNetwork, radioTxMute=radioTxMute, modemACMmodulationMin=modemACMmodulationMin, ethRXByteCounterLow=ethRXByteCounterLow, vlanRowStatus=vlanRowStatus, product=product, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioTxFrequency=radioTxFrequency, ethRXCRCErrors=ethRXCRCErrors, ethTXUnderruns=ethTXUnderruns, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemEthernetCapacity=modemEthernetCapacity, radioLoopback=radioLoopback, e1t1StatEntry=e1t1StatEntry, modemSymbolRateTx=modemSymbolRateTx, modemUnavailtime=modemUnavailtime, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, loopbacks=loopbacks, ethTXBackpresEvents=ethTXBackpresEvents, ethTXExcessiveDefers=ethTXExcessiveDefers, licenseMask=licenseMask, ethGFPDelineationErrors=ethGFPDelineationErrors, ethGFPFCSErrors=ethGFPFCSErrors)
