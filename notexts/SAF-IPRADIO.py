...
mibBuilder.exportSymbols("SAF-IPRADIO", ethGFPFCSErrors=ethGFPFCSErrors, ethTXMulticasts=ethTXMulticasts, modemE1T1ChannelMask=modemE1T1ChannelMask, sysDateAndTime=sysDateAndTime, modemLastAcqError=modemLastAcqError, modemACMmodulationMax=modemACMmodulationMax, modemLDPCdecoderStress=modemLDPCdecoderStress, localIp=localIp, ethTXControlFrames=ethTXControlFrames, modemUptime=modemUptime, e1t1StatTable=e1t1StatTable, ethTXUnderruns=ethTXUnderruns, modemRadialMSE=modemRadialMSE, modemACMtotalCapacity=modemACMtotalCapacity, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXByteCounterHi=ethTXByteCounterHi, modemIndex=modemIndex, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, loopbacks=loopbacks, vlanTable=vlanTable, ethRXTruncatedFrames=ethRXTruncatedFrames, remoteIp=remoteIp, aTPCEntry=aTPCEntry, radioEntry=radioEntry, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethQOSTXFrames=ethQOSTXFrames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXBackpresEvents=ethTXBackpresEvents, ethTXExcessiveDefers=ethTXExcessiveDefers, vlanCfgStat=vlanCfgStat, radioIndex=radioIndex, e1t1StatEntry=e1t1StatEntry, modemStatistics=modemStatistics, modemInternalAGCgain=modemInternalAGCgain, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXDvEvent=ethRXDvEvent, ethRXByteCounterLow=ethRXByteCounterLow, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXPauseFrames=ethRXPauseFrames, modemBandwith=modemBandwith, modemTotalBlockNumber=modemTotalBlockNumber, atpcIndex=atpcIndex, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXBroadcasts=ethTXBroadcasts, radioGenStatus=radioGenStatus, sysTemperature=sysTemperature, license=license, description=description, ethRXCRCErrors=ethRXCRCErrors, saf=saf, ethGFPDelineationErrors=ethGFPDelineationErrors, radioTxFrequency=radioTxFrequency, radioTable=radioTable, modemACMethernetCapacity=modemACMethernetCapacity, ethTXMaxCollisions=ethTXMaxCollisions, modemTotalCapacity=modemTotalCapacity, ethRXMulticasts=ethRXMulticasts, ethTXVlanTags=ethTXVlanTags, modemGeneralStatus=modemGeneralStatus, tehnika=tehnika, ethTXWireByteCounterHi=ethTXWireByteCounterHi, hostname=hostname, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadioCfg=ipRadioCfg, ethQOSTXDropped=ethQOSTXDropped, e1t1LOS=e1t1LOS, product=product, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXBroadcasts=ethRXBroadcasts, vlanNumber=vlanNumber, ethTXDones=ethTXDones, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemTable=modemTable, ethTXLateCollisions=ethTXLateCollisions, modemEthernetCapacity=modemEthernetCapacity, ipRadioStat=ipRadioStat, safip=safip, modemEntry=modemEntry, ethGFPDropedFrames=ethGFPDropedFrames, modemACMengine=modemACMengine, radioRxFrequency=radioRxFrequency, ethRXDribleNibbles=ethRXDribleNibbles, atpcEnabled=atpcEnabled, radioTxPower=radioTxPower, modemSymbolRateRx=modemSymbolRateRx, writeConfig=writeConfig, ethTXCollisions=ethTXCollisions, atpcTxPowerCorrection=atpcTxPowerCorrection, modemAcqStatus=modemAcqStatus, ipRadioStatEth=ipRadioStatEth, restartcpu=restartcpu, pointToPoint=pointToPoint, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, loopback_tributary_mask=loopback_tributary_mask, radioRxLevel=radioRxLevel, e1t1AIS=e1t1AIS, vlanEntry=vlanEntry, radioLoopback=radioLoopback, modemUnavailtime=modemUnavailtime, ethRXDones=ethRXDones, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemSymbolRateTx=modemSymbolRateTx, licenseMask=licenseMask, radioTxMute=radioTxMute, modemErroredBlock=modemErroredBlock, vlanRowStatus=vlanRowStatus, modemACMmodulationMin=modemACMmodulationMin, vlanPortType=vlanPortType, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXByteCounterHi=ethRXByteCounterHi, modemCountTime=modemCountTime, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemRowStatus=modemRowStatus, radioSide=radioSide, microwaveRadio=microwaveRadio, localIpMask=localIpMask, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ipRadio=ipRadio, modemCarrierOffset=modemCarrierOffset, modemModulation=modemModulation, ethRXCodeErrors=ethRXCodeErrors, ethTXGiants=ethTXGiants, vlanPortmap=vlanPortmap, ethTXCRCErrors=ethTXCRCErrors, e1t1ChannelNr=e1t1ChannelNr, modemErroredSecond=modemErroredSecond, ethRXPrevPktDropped=ethRXPrevPktDropped, modemErroredSecondRatio=modemErroredSecondRatio, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXPauseFrames=ethTXPauseFrames, aTPCTable=aTPCTable, ethRXLongEvents=ethRXLongEvents, radioDuplexShift=radioDuplexShift, vlansEnabled=vlansEnabled, modemE1T1Channels=modemE1T1Channels, modemStandard=modemStandard, ethTXByteCounterLow=ethTXByteCounterLow, ipRadioMgmt=ipRadioMgmt, ethGFPCHECErrors=ethGFPCHECErrors, vlanFid=vlanFid, licenseUpdateStatus=licenseUpdateStatus, ethRXControlFrames=ethRXControlFrames)
