...
mibBuilder.exportSymbols("SAF-IPRADIO", modemStandard=modemStandard, radioGenStatus=radioGenStatus, radioRxFrequency=radioRxFrequency, ethRXVlanTagsDetected=ethRXVlanTagsDetected, localIp=localIp, ethRXCRCErrors=ethRXCRCErrors, localIpMask=localIpMask, ipRadioCfgGeneral=ipRadioCfgGeneral, modemErroredSecondRatio=modemErroredSecondRatio, ethRXLongEvents=ethRXLongEvents, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, vlanPortType=vlanPortType, ethTXMulticasts=ethTXMulticasts, ethQOSTXFrames=ethQOSTXFrames, e1t1StatTable=e1t1StatTable, restartcpu=restartcpu, radioLoopback=radioLoopback, vlanPortmap=vlanPortmap, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXVlanTags=ethTXVlanTags, ethGFPCHECErrors=ethGFPCHECErrors, ethRXByteCounterLow=ethRXByteCounterLow, microwaveRadio=microwaveRadio, ethRXPauseFrames=ethRXPauseFrames, modemLDPCdecoderStress=modemLDPCdecoderStress, vlansEnabled=vlansEnabled, radioEntry=radioEntry, ethTXLateCollisions=ethTXLateCollisions, modemRowStatus=modemRowStatus, safip=safip, writeConfig=writeConfig, vlanCfgStat=vlanCfgStat, radioTxMute=radioTxMute, ethTXPauseFrames=ethTXPauseFrames, sysDateAndTime=sysDateAndTime, modemSymbolRateRx=modemSymbolRateRx, modemStatistics=modemStatistics, ethTXCollisions=ethTXCollisions, modemCountTime=modemCountTime, modemInternalAGCgain=modemInternalAGCgain, modemTable=modemTable, ethTXUnderruns=ethTXUnderruns, ethQOSTXDropped=ethQOSTXDropped, modemACMethernetCapacity=modemACMethernetCapacity, modemSymbolRateTx=modemSymbolRateTx, ethRXByteCounterHi=ethRXByteCounterHi, modemErroredSecond=modemErroredSecond, vlanFid=vlanFid, vlanNumber=vlanNumber, loopback_tributary_mask=loopback_tributary_mask, hostname=hostname, modemACMtotalCapacity=modemACMtotalCapacity, e1t1LOS=e1t1LOS, ethQOSRXQ2Frames=ethQOSRXQ2Frames, licenseMask=licenseMask, e1t1ChannelNr=e1t1ChannelNr, ethRXPrevPktDropped=ethRXPrevPktDropped, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadioStatEth=ipRadioStatEth, radioTable=radioTable, atpcEnabled=atpcEnabled, atpcIndex=atpcIndex, modemCarrierOffset=modemCarrierOffset, modemACMmodulationMin=modemACMmodulationMin, modemLastAcqError=modemLastAcqError, atpcTxPowerCorrection=atpcTxPowerCorrection, e1t1AIS=e1t1AIS, radioDuplexShift=radioDuplexShift, ethGFPFCSErrors=ethGFPFCSErrors, pointToPoint=pointToPoint, modemEthernetCapacity=modemEthernetCapacity, product=product, loopbacks=loopbacks, modemE1T1ChannelMask=modemE1T1ChannelMask, radioIndex=radioIndex, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemTotalCapacity=modemTotalCapacity, modemRadialMSE=modemRadialMSE, ethTXDones=ethTXDones, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ipRadioCfg=ipRadioCfg, description=description, saf=saf, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioSide=radioSide, e1t1StatEntry=e1t1StatEntry, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemUnavailtime=modemUnavailtime, aTPCEntry=aTPCEntry, ethRXDribleNibbles=ethRXDribleNibbles, ipRadioStat=ipRadioStat, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemIndex=modemIndex, modemAcqStatus=modemAcqStatus, aTPCTable=aTPCTable, modemEntry=modemEntry, modemTotalBlockNumber=modemTotalBlockNumber, ethTXCRCErrors=ethTXCRCErrors, radioTxFrequency=radioTxFrequency, vlanEntry=vlanEntry, modemACMengine=modemACMengine, vlanTable=vlanTable, ethRXDvEvent=ethRXDvEvent, remoteIp=remoteIp, ethTXBackpresEvents=ethTXBackpresEvents, modemErroredBlock=modemErroredBlock, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXMulticasts=ethRXMulticasts, vlanRowStatus=vlanRowStatus, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, sysTemperature=sysTemperature, ethRXCodeErrors=ethRXCodeErrors, radioTxPower=radioTxPower, ethTXByteCounterLow=ethTXByteCounterLow, ethRXBroadcasts=ethRXBroadcasts, modemACMmodulationMax=modemACMmodulationMax, ethRXDones=ethRXDones, modemUptime=modemUptime, modemBandwith=modemBandwith, modemBackgroundBlockErrror=modemBackgroundBlockErrror, license=license, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXBroadcasts=ethTXBroadcasts, ethTXByteCounterHi=ethTXByteCounterHi, ethRXControlFrames=ethRXControlFrames, ethTXMaxCollisions=ethTXMaxCollisions, modemModulation=modemModulation, licenseUpdateStatus=licenseUpdateStatus, ipRadioCfgNetwork=ipRadioCfgNetwork, modemGeneralStatus=modemGeneralStatus, ipRadio=ipRadio, radioRxLevel=radioRxLevel, ethTXControlFrames=ethTXControlFrames, ipRadioMgmt=ipRadioMgmt, modemE1T1Channels=modemE1T1Channels, ethTXGiants=ethTXGiants, ethRXTruncatedFrames=ethRXTruncatedFrames, ethGFPDropedFrames=ethGFPDropedFrames, tehnika=tehnika)
