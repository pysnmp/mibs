...
mibBuilder.exportSymbols("SAF-IPRADIO", radioTxFrequency=radioTxFrequency, ethTXGiants=ethTXGiants, saf=saf, ethQOSTXFrames=ethQOSTXFrames, modemRadialMSE=modemRadialMSE, sysTemperature=sysTemperature, restartcpu=restartcpu, modemTotalCapacity=modemTotalCapacity, ethGFPCHECErrors=ethGFPCHECErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemSymbolRateRx=modemSymbolRateRx, ethRXCRCErrors=ethRXCRCErrors, microwaveRadio=microwaveRadio, loopback_tributary_mask=loopback_tributary_mask, radioSide=radioSide, ethTXBroadcasts=ethTXBroadcasts, vlanTable=vlanTable, ethTXControlFrames=ethTXControlFrames, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemUptime=modemUptime, modemModulation=modemModulation, e1t1StatTable=e1t1StatTable, modemCountTime=modemCountTime, ethTXCRCErrors=ethTXCRCErrors, ethGFPDropedFrames=ethGFPDropedFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, modemAcqStatus=modemAcqStatus, hostname=hostname, atpcTxPowerCorrection=atpcTxPowerCorrection, localIpMask=localIpMask, tehnika=tehnika, ethTXDones=ethTXDones, ipRadioMgmt=ipRadioMgmt, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioDuplexShift=radioDuplexShift, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ipRadioStat=ipRadioStat, modemErroredSecondRatio=modemErroredSecondRatio, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ipRadio=ipRadio, modemLastAcqError=modemLastAcqError, e1t1ChannelNr=e1t1ChannelNr, loopbacks=loopbacks, vlanRowStatus=vlanRowStatus, product=product, description=description, modemInternalAGCgain=modemInternalAGCgain, vlanEntry=vlanEntry, ipRadioCfgGeneral=ipRadioCfgGeneral, modemGeneralStatus=modemGeneralStatus, modemCarrierOffset=modemCarrierOffset, ethTXWireByteCounterLow=ethTXWireByteCounterLow, writeConfig=writeConfig, e1t1LOS=e1t1LOS, pointToPoint=pointToPoint, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemUnavailtime=modemUnavailtime, ethTXUnderruns=ethTXUnderruns, ethGFPFCSErrors=ethGFPFCSErrors, modemRowStatus=modemRowStatus, license=license, ethTXBackpresEvents=ethTXBackpresEvents, aTPCEntry=aTPCEntry, vlanPortType=vlanPortType, radioTxMute=radioTxMute, ethRXVlanTagsDetected=ethRXVlanTagsDetected, e1t1AIS=e1t1AIS, radioRxLevel=radioRxLevel, e1t1StatEntry=e1t1StatEntry, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXByteCounterLow=ethTXByteCounterLow, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXMulticasts=ethTXMulticasts, safip=safip, radioIndex=radioIndex, ethRXBroadcasts=ethRXBroadcasts, modemACMengine=modemACMengine, ethRXPrevPktDropped=ethRXPrevPktDropped, modemE1T1Channels=modemE1T1Channels, atpcEnabled=atpcEnabled, modemBandwith=modemBandwith, ethRXDribleNibbles=ethRXDribleNibbles, modemErroredSecond=modemErroredSecond, ethRXByteCounterHi=ethRXByteCounterHi, ethTXByteCounterHi=ethTXByteCounterHi, remoteIp=remoteIp, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXByteCounterLow=ethRXByteCounterLow, radioLoopback=radioLoopback, modemErroredBlock=modemErroredBlock, modemACMmodulationMax=modemACMmodulationMax, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXMulticasts=ethRXMulticasts, ethTXPauseFrames=ethTXPauseFrames, ethTXExcessiveDefers=ethTXExcessiveDefers, modemSeverelyErroredSecond=modemSeverelyErroredSecond, vlansEnabled=vlansEnabled, radioEntry=radioEntry, modemTable=modemTable, modemIndex=modemIndex, ethRXDones=ethRXDones, modemACMtotalCapacity=modemACMtotalCapacity, radioGenStatus=radioGenStatus, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXPauseFrames=ethRXPauseFrames, modemStatistics=modemStatistics, modemACMmodulationMin=modemACMmodulationMin, modemStandard=modemStandard, vlanFid=vlanFid, radioRxFrequency=radioRxFrequency, ipRadioStatEth=ipRadioStatEth, ethRXControlFrames=ethRXControlFrames, modemTotalBlockNumber=modemTotalBlockNumber, modemSymbolRateTx=modemSymbolRateTx, ipRadioCfg=ipRadioCfg, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXCodeErrors=ethRXCodeErrors, ethTXMaxCollisions=ethTXMaxCollisions, radioTxPower=radioTxPower, localIp=localIp, ethTXCollisions=ethTXCollisions, vlanNumber=vlanNumber, radioTable=radioTable, vlanPortmap=vlanPortmap, ethQOSTXDropped=ethQOSTXDropped, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, aTPCTable=aTPCTable, sysDateAndTime=sysDateAndTime, licenseUpdateStatus=licenseUpdateStatus, atpcIndex=atpcIndex, ethTXVlanTags=ethTXVlanTags, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXDvEvent=ethRXDvEvent, vlanCfgStat=vlanCfgStat, ethRXLongEvents=ethRXLongEvents, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemACMethernetCapacity=modemACMethernetCapacity, ethTXLateCollisions=ethTXLateCollisions, modemEntry=modemEntry, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemEthernetCapacity=modemEthernetCapacity, licenseMask=licenseMask)
