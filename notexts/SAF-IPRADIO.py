...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXControlFrames=ethTXControlFrames, ethTXCollisions=ethTXCollisions, e1t1LOS=e1t1LOS, ethTXDones=ethTXDones, e1t1AIS=e1t1AIS, modemBandwith=modemBandwith, license=license, e1t1ChannelNr=e1t1ChannelNr, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXByteCounterLow=ethTXByteCounterLow, ethRXControlFrames=ethRXControlFrames, vlanFid=vlanFid, radioTxFrequency=radioTxFrequency, modemUnavailtime=modemUnavailtime, vlanPortType=vlanPortType, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXVlanTags=ethTXVlanTags, writeConfig=writeConfig, vlanRowStatus=vlanRowStatus, atpcIndex=atpcIndex, microwaveRadio=microwaveRadio, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioEntry=radioEntry, restartcpu=restartcpu, radioRxFrequency=radioRxFrequency, modemTable=modemTable, modemSymbolRateTx=modemSymbolRateTx, modemACMethernetCapacity=modemACMethernetCapacity, saf=saf, modemErroredSecond=modemErroredSecond, aTPCEntry=aTPCEntry, ethRXCRCErrors=ethRXCRCErrors, ethTXLateCollisions=ethTXLateCollisions, modemACMmodulationMax=modemACMmodulationMax, modemLDPCdecoderStress=modemLDPCdecoderStress, modemSymbolRateRx=modemSymbolRateRx, ethQOSTXDropped=ethQOSTXDropped, modemEntry=modemEntry, radioDuplexShift=radioDuplexShift, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemGeneralStatus=modemGeneralStatus, aTPCTable=aTPCTable, ipRadioCfg=ipRadioCfg, radioLoopback=radioLoopback, product=product, hostname=hostname, localIpMask=localIpMask, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemIndex=modemIndex, modemEthernetCapacity=modemEthernetCapacity, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXExcessiveDefers=ethTXExcessiveDefers, modemErroredSecondRatio=modemErroredSecondRatio, modemStatistics=modemStatistics, ethRXDribleNibbles=ethRXDribleNibbles, remoteIp=remoteIp, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXPauseFrames=ethTXPauseFrames, ipRadio=ipRadio, ethTXBroadcasts=ethTXBroadcasts, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXByteCounterLow=ethRXByteCounterLow, modemE1T1Channels=modemE1T1Channels, radioTxMute=radioTxMute, ethTXBackpresEvents=ethTXBackpresEvents, modemStandard=modemStandard, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemCarrierOffset=modemCarrierOffset, ethRXDvEvent=ethRXDvEvent, ethRXMulticasts=ethRXMulticasts, modemInternalAGCgain=modemInternalAGCgain, modemACMtotalCapacity=modemACMtotalCapacity, ethQOSRXQ2Frames=ethQOSRXQ2Frames, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemTotalBlockNumber=modemTotalBlockNumber, atpcEnabled=atpcEnabled, radioTable=radioTable, ethRXByteCounterHi=ethRXByteCounterHi, modemACMengine=modemACMengine, modemUptime=modemUptime, ethTXMulticasts=ethTXMulticasts, modemLastAcqError=modemLastAcqError, ethTXLengthCheckErrors=ethTXLengthCheckErrors, localIp=localIp, ethRXCodeErrors=ethRXCodeErrors, ethTXUnderruns=ethTXUnderruns, vlanCfgStat=vlanCfgStat, pointToPoint=pointToPoint, modemModulation=modemModulation, loopbacks=loopbacks, licenseUpdateStatus=licenseUpdateStatus, e1t1StatTable=e1t1StatTable, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioTxPower=radioTxPower, ethRXDones=ethRXDones, ipRadioCfgGeneral=ipRadioCfgGeneral, modemAcqStatus=modemAcqStatus, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethGFPDropedFrames=ethGFPDropedFrames, radioGenStatus=radioGenStatus, vlanTable=vlanTable, ethRXBroadcasts=ethRXBroadcasts, modemTotalCapacity=modemTotalCapacity, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioIndex=radioIndex, description=description, ethGFPCHECErrors=ethGFPCHECErrors, licenseMask=licenseMask, ipRadioMgmt=ipRadioMgmt, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemCountTime=modemCountTime, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXGiants=ethTXGiants, sysTemperature=sysTemperature, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ipRadioStatEth=ipRadioStatEth, ethGFPFCSErrors=ethGFPFCSErrors, radioSide=radioSide, vlanPortmap=vlanPortmap, vlansEnabled=vlansEnabled, modemACMmodulationMin=modemACMmodulationMin, safip=safip, radioRxLevel=radioRxLevel, modemRadialMSE=modemRadialMSE, ethQOSTXFrames=ethQOSTXFrames, tehnika=tehnika, modemRowStatus=modemRowStatus, loopback_tributary_mask=loopback_tributary_mask, ethRXPauseFrames=ethRXPauseFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadioStat=ipRadioStat, ethTXMaxCollisions=ethTXMaxCollisions, ethTXCRCErrors=ethTXCRCErrors, ethTXByteCounterHi=ethTXByteCounterHi, ethQOSRXQ1Frames=ethQOSRXQ1Frames, sysDateAndTime=sysDateAndTime, vlanNumber=vlanNumber, modemErroredBlock=modemErroredBlock, e1t1StatEntry=e1t1StatEntry, vlanEntry=vlanEntry, ethRXLongEvents=ethRXLongEvents)
