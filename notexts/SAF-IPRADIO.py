...
mibBuilder.exportSymbols("SAF-IPRADIO", vlanEntry=vlanEntry, ethRXBroadcasts=ethRXBroadcasts, vlanPortType=vlanPortType, radioEntry=radioEntry, ethRXControlFrames=ethRXControlFrames, ethTXBackpresEvents=ethTXBackpresEvents, ethTXDones=ethTXDones, modemModulation=modemModulation, modemSymbolRateRx=modemSymbolRateRx, ethTXVlanTags=ethTXVlanTags, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioRxFrequency=radioRxFrequency, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ipRadioCfg=ipRadioCfg, vlanRowStatus=vlanRowStatus, radioDuplexShift=radioDuplexShift, aTPCTable=aTPCTable, modemUptime=modemUptime, radioSide=radioSide, vlanCfgStat=vlanCfgStat, modemTable=modemTable, sysTemperature=sysTemperature, product=product, remoteIp=remoteIp, restartcpu=restartcpu, hostname=hostname, modemStandard=modemStandard, ethTXByteCounterLow=ethTXByteCounterLow, e1t1ChannelNr=e1t1ChannelNr, safip=safip, ipRadioCfgGeneral=ipRadioCfgGeneral, modemGeneralStatus=modemGeneralStatus, ipRadioStatEth=ipRadioStatEth, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemUnavailtime=modemUnavailtime, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXCodeErrors=ethRXCodeErrors, ethTXCollisions=ethTXCollisions, ethQOSRXQ2Frames=ethQOSRXQ2Frames, e1t1AIS=e1t1AIS, modemTotalBlockNumber=modemTotalBlockNumber, modemACMmodulationMin=modemACMmodulationMin, ethRXPauseFrames=ethRXPauseFrames, ethRXVlanTagsDetected=ethRXVlanTagsDetected, vlanPortmap=vlanPortmap, modemACMtotalCapacity=modemACMtotalCapacity, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemBandwith=modemBandwith, modemLastAcqError=modemLastAcqError, vlanNumber=vlanNumber, ethRXDvEvent=ethRXDvEvent, vlanFid=vlanFid, ethQOSTXDropped=ethQOSTXDropped, modemInternalAGCgain=modemInternalAGCgain, ethTXLengthCheckErrors=ethTXLengthCheckErrors, aTPCEntry=aTPCEntry, vlanTable=vlanTable, modemACMmodulationMax=modemACMmodulationMax, ethGFPDelineationErrors=ethGFPDelineationErrors, ethGFPDropedFrames=ethGFPDropedFrames, atpcTxPowerCorrection=atpcTxPowerCorrection, ipRadioCfgNetwork=ipRadioCfgNetwork, writeConfig=writeConfig, modemRadialMSE=modemRadialMSE, modemE1T1Channels=modemE1T1Channels, radioTxMute=radioTxMute, radioLoopback=radioLoopback, e1t1LOS=e1t1LOS, ethTXPauseFrames=ethTXPauseFrames, e1t1StatEntry=e1t1StatEntry, ethRXCRCErrors=ethRXCRCErrors, modemACMengine=modemACMengine, modemCarrierOffset=modemCarrierOffset, modemErroredBlock=modemErroredBlock, loopback_tributary_mask=loopback_tributary_mask, ethTXGiants=ethTXGiants, ipRadio=ipRadio, radioTxPower=radioTxPower, ethTXUnderruns=ethTXUnderruns, modemErroredSecondRatio=modemErroredSecondRatio, ethGFPCHECErrors=ethGFPCHECErrors, modemEntry=modemEntry, ethRXMulticasts=ethRXMulticasts, ethRXByteCounterLow=ethRXByteCounterLow, ethTXExcessiveDefers=ethTXExcessiveDefers, ipRadioMgmt=ipRadioMgmt, radioTable=radioTable, modemCountTime=modemCountTime, sysDateAndTime=sysDateAndTime, modemRowStatus=modemRowStatus, pointToPoint=pointToPoint, ethRXLongEvents=ethRXLongEvents, localIpMask=localIpMask, tehnika=tehnika, modemTotalCapacity=modemTotalCapacity, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemE1T1ChannelMask=modemE1T1ChannelMask, license=license, modemACMethernetCapacity=modemACMethernetCapacity, ethTXBroadcasts=ethTXBroadcasts, licenseMask=licenseMask, radioGenStatus=radioGenStatus, ethRXDribleNibbles=ethRXDribleNibbles, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemIndex=modemIndex, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, atpcEnabled=atpcEnabled, ethRXDones=ethRXDones, radioRxLevel=radioRxLevel, ethTXMaxCollisions=ethTXMaxCollisions, localIp=localIp, licenseUpdateStatus=licenseUpdateStatus, ethRXPrevPktDropped=ethRXPrevPktDropped, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, saf=saf, radioIndex=radioIndex, ethRXUnsupOpcodes=ethRXUnsupOpcodes, description=description, modemEthernetCapacity=modemEthernetCapacity, ethTXByteCounterHi=ethTXByteCounterHi, ethTXLateCollisions=ethTXLateCollisions, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemAcqStatus=modemAcqStatus, ethQOSTXFrames=ethQOSTXFrames, ethTXWireByteCounterHi=ethTXWireByteCounterHi, loopbacks=loopbacks, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXByteCounterHi=ethRXByteCounterHi, microwaveRadio=microwaveRadio, modemErroredSecond=modemErroredSecond, ethTXMulticasts=ethTXMulticasts, radioTxFrequency=radioTxFrequency, ethTXCRCErrors=ethTXCRCErrors, ethTXControlFrames=ethTXControlFrames, ipRadioStat=ipRadioStat, modemStatistics=modemStatistics, ethTXWireByteCounterLow=ethTXWireByteCounterLow, e1t1StatTable=e1t1StatTable, ethGFPFCSErrors=ethGFPFCSErrors, atpcIndex=atpcIndex, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemLDPCdecoderStress=modemLDPCdecoderStress, modemSymbolRateTx=modemSymbolRateTx, vlansEnabled=vlansEnabled)
