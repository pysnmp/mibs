...
mibBuilder.exportSymbols("SAF-IPRADIO", radioTable=radioTable, radioRxLevel=radioRxLevel, e1t1AIS=e1t1AIS, radioEntry=radioEntry, radioTxPower=radioTxPower, modemUptime=modemUptime, modemGeneralStatus=modemGeneralStatus, modemStatistics=modemStatistics, modemTotalCapacity=modemTotalCapacity, radioDuplexShift=radioDuplexShift, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXBroadcasts=ethRXBroadcasts, remoteIp=remoteIp, ethRXCRCErrors=ethRXCRCErrors, ethTXExcessiveDefers=ethTXExcessiveDefers, vlanTable=vlanTable, ethRXCodeErrors=ethRXCodeErrors, modemSymbolRateRx=modemSymbolRateRx, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethGFPDropedFrames=ethGFPDropedFrames, modemRowStatus=modemRowStatus, ethTXByteCounterHi=ethTXByteCounterHi, vlanEntry=vlanEntry, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ipRadioStatEth=ipRadioStatEth, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXLongEvents=ethRXLongEvents, radioGenStatus=radioGenStatus, ethTXVlanTags=ethTXVlanTags, ethTXLateCollisions=ethTXLateCollisions, modemBandwith=modemBandwith, ethRXDvEvent=ethRXDvEvent, ethQOSTXFrames=ethQOSTXFrames, modemRadialMSE=modemRadialMSE, radioSide=radioSide, atpcTxPowerCorrection=atpcTxPowerCorrection, description=description, radioTxFrequency=radioTxFrequency, ethRXByteCounterHi=ethRXByteCounterHi, modemE1T1Channels=modemE1T1Channels, localIpMask=localIpMask, ethTXPauseFrames=ethTXPauseFrames, ethTXBroadcasts=ethTXBroadcasts, hostname=hostname, ethGFPDelineationErrors=ethGFPDelineationErrors, e1t1StatTable=e1t1StatTable, ethRXPauseFrames=ethRXPauseFrames, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXMulticasts=ethRXMulticasts, ethRXByteCounterLow=ethRXByteCounterLow, radioTxMute=radioTxMute, modemErroredBlock=modemErroredBlock, atpcEnabled=atpcEnabled, modemACMtotalCapacity=modemACMtotalCapacity, ethTXCollisions=ethTXCollisions, ipRadioMgmt=ipRadioMgmt, radioIndex=radioIndex, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, vlanPortmap=vlanPortmap, saf=saf, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, loopbacks=loopbacks, modemErroredSecond=modemErroredSecond, modemACMmodulationMax=modemACMmodulationMax, ethRXTruncatedFrames=ethRXTruncatedFrames, safip=safip, e1t1LOS=e1t1LOS, modemErroredSecondRatio=modemErroredSecondRatio, ethQOSTXDropped=ethQOSTXDropped, ethTXUnderruns=ethTXUnderruns, ethTXCRCErrors=ethTXCRCErrors, aTPCTable=aTPCTable, modemTotalBlockNumber=modemTotalBlockNumber, vlanPortType=vlanPortType, licenseUpdateStatus=licenseUpdateStatus, ipRadioCfgNetwork=ipRadioCfgNetwork, modemEntry=modemEntry, ipRadioStat=ipRadioStat, sysTemperature=sysTemperature, ethTXMulticasts=ethTXMulticasts, ethGFPCHECErrors=ethGFPCHECErrors, radioLoopback=radioLoopback, modemLDPCdecoderStress=modemLDPCdecoderStress, aTPCEntry=aTPCEntry, product=product, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemACMmodulationMin=modemACMmodulationMin, modemStandard=modemStandard, writeConfig=writeConfig, ethTXMaxCollisions=ethTXMaxCollisions, modemSymbolRateTx=modemSymbolRateTx, modemInternalAGCgain=modemInternalAGCgain, ethTXControlFrames=ethTXControlFrames, ethRXDones=ethRXDones, ipRadioCfg=ipRadioCfg, loopback_tributary_mask=loopback_tributary_mask, vlanFid=vlanFid, modemLastAcqError=modemLastAcqError, modemIndex=modemIndex, restartcpu=restartcpu, ethTXBackpresEvents=ethTXBackpresEvents, vlanRowStatus=vlanRowStatus, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemTable=modemTable, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemCarrierOffset=modemCarrierOffset, vlansEnabled=vlansEnabled, modemACMengine=modemACMengine, radioRxFrequency=radioRxFrequency, atpcIndex=atpcIndex, ethGFPFCSErrors=ethGFPFCSErrors, modemEthernetCapacity=modemEthernetCapacity, localIp=localIp, sysDateAndTime=sysDateAndTime, tehnika=tehnika, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlanCfgStat=vlanCfgStat, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXDribleNibbles=ethRXDribleNibbles, modemBackgroundBlockErrror=modemBackgroundBlockErrror, microwaveRadio=microwaveRadio, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, pointToPoint=pointToPoint, modemUnavailtime=modemUnavailtime, modemAcqStatus=modemAcqStatus, modemE1T1ChannelMask=modemE1T1ChannelMask, modemCountTime=modemCountTime, ipRadio=ipRadio, vlanNumber=vlanNumber, ethTXByteCounterLow=ethTXByteCounterLow, ethTXDones=ethTXDones, ethTXGiants=ethTXGiants, modemACMethernetCapacity=modemACMethernetCapacity, license=license, e1t1ChannelNr=e1t1ChannelNr, licenseMask=licenseMask, e1t1StatEntry=e1t1StatEntry, modemModulation=modemModulation, ethRXControlFrames=ethRXControlFrames, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers)
