...
mibBuilder.exportSymbols("SAF-IPRADIO", ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioTxPower=radioTxPower, modemLDPCdecoderStress=modemLDPCdecoderStress, ethGFPDelineationErrors=ethGFPDelineationErrors, vlanNumber=vlanNumber, ethRXBroadcasts=ethRXBroadcasts, modemCountTime=modemCountTime, description=description, ethTXMaxCollisions=ethTXMaxCollisions, ethTXUnderruns=ethTXUnderruns, ethTXLateCollisions=ethTXLateCollisions, radioSide=radioSide, modemBandwith=modemBandwith, radioTxFrequency=radioTxFrequency, aTPCTable=aTPCTable, aTPCEntry=aTPCEntry, ethTXMulticasts=ethTXMulticasts, hostname=hostname, ethTXCRCErrors=ethTXCRCErrors, ethTXControlFrames=ethTXControlFrames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, loopbacks=loopbacks, ethRXByteCounterLow=ethRXByteCounterLow, modemUptime=modemUptime, ethTXBackpresEvents=ethTXBackpresEvents, ethQOSTXFrames=ethQOSTXFrames, atpcTxPowerCorrection=atpcTxPowerCorrection, modemE1T1ChannelMask=modemE1T1ChannelMask, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXTruncatedFrames=ethRXTruncatedFrames, ethGFPFCSErrors=ethGFPFCSErrors, modemRowStatus=modemRowStatus, vlanPortmap=vlanPortmap, modemGeneralStatus=modemGeneralStatus, microwaveRadio=microwaveRadio, ipRadio=ipRadio, localIpMask=localIpMask, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioGenStatus=radioGenStatus, ethTXDones=ethTXDones, ipRadioCfgNetwork=ipRadioCfgNetwork, vlanEntry=vlanEntry, modemACMmodulationMax=modemACMmodulationMax, modemIndex=modemIndex, modemTotalBlockNumber=modemTotalBlockNumber, modemStatistics=modemStatistics, ipRadioStatEth=ipRadioStatEth, atpcIndex=atpcIndex, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemACMtotalCapacity=modemACMtotalCapacity, vlanTable=vlanTable, ethTXPauseFrames=ethTXPauseFrames, ethTXBroadcasts=ethTXBroadcasts, ethRXMulticasts=ethRXMulticasts, ethRXDones=ethRXDones, pointToPoint=pointToPoint, modemTable=modemTable, modemLastAcqError=modemLastAcqError, loopback_tributary_mask=loopback_tributary_mask, vlanRowStatus=vlanRowStatus, modemSymbolRateRx=modemSymbolRateRx, vlanCfgStat=vlanCfgStat, vlansEnabled=vlansEnabled, ethTXWireByteCounterLow=ethTXWireByteCounterLow, remoteIp=remoteIp, ethRXCRCErrors=ethRXCRCErrors, ethRXDribleNibbles=ethRXDribleNibbles, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, atpcEnabled=atpcEnabled, radioLoopback=radioLoopback, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXPauseFrames=ethRXPauseFrames, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXCollisions=ethTXCollisions, modemACMmodulationMin=modemACMmodulationMin, modemAcqStatus=modemAcqStatus, modemCarrierOffset=modemCarrierOffset, modemACMethernetCapacity=modemACMethernetCapacity, localIp=localIp, ethRXCodeErrors=ethRXCodeErrors, ethTXGiants=ethTXGiants, modemUnavailtime=modemUnavailtime, e1t1StatTable=e1t1StatTable, ipRadioCfg=ipRadioCfg, ethTXByteCounterLow=ethTXByteCounterLow, ipRadioStat=ipRadioStat, licenseUpdateStatus=licenseUpdateStatus, sysDateAndTime=sysDateAndTime, modemEntry=modemEntry, ethTXByteCounterHi=ethTXByteCounterHi, ethGFPCHECErrors=ethGFPCHECErrors, licenseMask=licenseMask, ethQOSRXQ2Frames=ethQOSRXQ2Frames, safip=safip, writeConfig=writeConfig, license=license, modemInternalAGCgain=modemInternalAGCgain, modemE1T1Channels=modemE1T1Channels, modemErroredBlock=modemErroredBlock, restartcpu=restartcpu, modemRadialMSE=modemRadialMSE, radioTable=radioTable, radioRxFrequency=radioRxFrequency, e1t1LOS=e1t1LOS, modemErroredSecondRatio=modemErroredSecondRatio, ethRXLongEvents=ethRXLongEvents, modemModulation=modemModulation, sysTemperature=sysTemperature, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethGFPDropedFrames=ethGFPDropedFrames, modemErroredSecond=modemErroredSecond, radioIndex=radioIndex, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXByteCounterHi=ethRXByteCounterHi, product=product, e1t1ChannelNr=e1t1ChannelNr, ipRadioCfgGeneral=ipRadioCfgGeneral, tehnika=tehnika, ethTXWireByteCounterHi=ethTXWireByteCounterHi, vlanFid=vlanFid, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXControlFrames=ethRXControlFrames, ethQOSTXDropped=ethQOSTXDropped, e1t1StatEntry=e1t1StatEntry, modemStandard=modemStandard, radioEntry=radioEntry, modemTotalCapacity=modemTotalCapacity, e1t1AIS=e1t1AIS, modemEthernetCapacity=modemEthernetCapacity, modemACMengine=modemACMengine, ethTXExcessiveDefers=ethTXExcessiveDefers, modemSeverelyErroredSecond=modemSeverelyErroredSecond, saf=saf, ethRXDvEvent=ethRXDvEvent, radioTxMute=radioTxMute, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ipRadioMgmt=ipRadioMgmt, radioRxLevel=radioRxLevel, vlanPortType=vlanPortType, modemSymbolRateTx=modemSymbolRateTx, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioDuplexShift=radioDuplexShift, ethTXVlanTags=ethTXVlanTags)
