...
mibBuilder.exportSymbols("SAF-IPRADIO", ipRadioCfg=ipRadioCfg, e1t1StatEntry=e1t1StatEntry, modemCarrierOffset=modemCarrierOffset, e1t1LOS=e1t1LOS, modemCountTime=modemCountTime, radioSide=radioSide, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXBroadcasts=ethTXBroadcasts, ethRXLongEvents=ethRXLongEvents, ethRXByteCounterHi=ethRXByteCounterHi, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXControlFrames=ethRXControlFrames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXLateCollisions=ethTXLateCollisions, licenseUpdateStatus=licenseUpdateStatus, product=product, ethTXCRCErrors=ethTXCRCErrors, vlanPortmap=vlanPortmap, e1t1AIS=e1t1AIS, modemRadialMSE=modemRadialMSE, vlansEnabled=vlansEnabled, vlanEntry=vlanEntry, modemErroredBlock=modemErroredBlock, ethRXPrevPktDropped=ethRXPrevPktDropped, radioRxFrequency=radioRxFrequency, aTPCTable=aTPCTable, ethTXUnderruns=ethTXUnderruns, ipRadioCfgGeneral=ipRadioCfgGeneral, modemStandard=modemStandard, ipRadioCfgNetwork=ipRadioCfgNetwork, e1t1StatTable=e1t1StatTable, modemSymbolRateRx=modemSymbolRateRx, e1t1ChannelNr=e1t1ChannelNr, loopback_tributary_mask=loopback_tributary_mask, modemEntry=modemEntry, ethQOSTXDropped=ethQOSTXDropped, atpcIndex=atpcIndex, ethTXBackpresEvents=ethTXBackpresEvents, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXGiants=ethTXGiants, radioLoopback=radioLoopback, localIpMask=localIpMask, ethRXPauseFrames=ethRXPauseFrames, modemUnavailtime=modemUnavailtime, writeConfig=writeConfig, radioTable=radioTable, modemAcqStatus=modemAcqStatus, modemErroredSecondRatio=modemErroredSecondRatio, vlanRowStatus=vlanRowStatus, ethRXDvEvent=ethRXDvEvent, vlanTable=vlanTable, ipRadioMgmt=ipRadioMgmt, ethGFPDropedFrames=ethGFPDropedFrames, modemTotalBlockNumber=modemTotalBlockNumber, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXLengthCheckErrors=ethTXLengthCheckErrors, sysTemperature=sysTemperature, remoteIp=remoteIp, ipRadioStatEth=ipRadioStatEth, ethRXMulticasts=ethRXMulticasts, ethTXMaxCollisions=ethTXMaxCollisions, modemRowStatus=modemRowStatus, tehnika=tehnika, loopbacks=loopbacks, modemTable=modemTable, radioRxLevel=radioRxLevel, radioTxFrequency=radioTxFrequency, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXByteCounterHi=ethTXByteCounterHi, ethRXDribleNibbles=ethRXDribleNibbles, hostname=hostname, vlanFid=vlanFid, modemACMethernetCapacity=modemACMethernetCapacity, ethRXCodeErrors=ethRXCodeErrors, modemACMtotalCapacity=modemACMtotalCapacity, vlanCfgStat=vlanCfgStat, modemACMmodulationMax=modemACMmodulationMax, atpcTxPowerCorrection=atpcTxPowerCorrection, license=license, atpcEnabled=atpcEnabled, modemSymbolRateTx=modemSymbolRateTx, saf=saf, ethTXCollisions=ethTXCollisions, radioTxMute=radioTxMute, radioIndex=radioIndex, radioEntry=radioEntry, pointToPoint=pointToPoint, aTPCEntry=aTPCEntry, modemModulation=modemModulation, ethTXVlanTags=ethTXVlanTags, ethRXCRCErrors=ethRXCRCErrors, modemStatistics=modemStatistics, radioGenStatus=radioGenStatus, modemErroredSecond=modemErroredSecond, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemBandwith=modemBandwith, description=description, ethRXTruncatedFrames=ethRXTruncatedFrames, modemIndex=modemIndex, ethGFPFCSErrors=ethGFPFCSErrors, radioTxPower=radioTxPower, ethQOSTXFrames=ethQOSTXFrames, modemE1T1ChannelMask=modemE1T1ChannelMask, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXControlFrames=ethTXControlFrames, radioDuplexShift=radioDuplexShift, ethTXWireByteCounterHi=ethTXWireByteCounterHi, vlanPortType=vlanPortType, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethGFPCHECErrors=ethGFPCHECErrors, modemEthernetCapacity=modemEthernetCapacity, ethTXDones=ethTXDones, modemLastAcqError=modemLastAcqError, modemUptime=modemUptime, localIp=localIp, vlanNumber=vlanNumber, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXMulticasts=ethTXMulticasts, ethRXByteCounterLow=ethRXByteCounterLow, ipRadio=ipRadio, modemE1T1Channels=modemE1T1Channels, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemInternalAGCgain=modemInternalAGCgain, sysDateAndTime=sysDateAndTime, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemACMmodulationMin=modemACMmodulationMin, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXByteCounterLow=ethTXByteCounterLow, licenseMask=licenseMask, modemTotalCapacity=modemTotalCapacity, modemACMengine=modemACMengine, microwaveRadio=microwaveRadio, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXPauseFrames=ethTXPauseFrames, safip=safip, ethRXDones=ethRXDones, ipRadioStat=ipRadioStat, modemGeneralStatus=modemGeneralStatus, restartcpu=restartcpu, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXBroadcasts=ethRXBroadcasts, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped)
