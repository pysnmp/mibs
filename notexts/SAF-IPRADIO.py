...
mibBuilder.exportSymbols("SAF-IPRADIO", radioRxFrequency=radioRxFrequency, writeConfig=writeConfig, radioTable=radioTable, ethTXMaxCollisions=ethTXMaxCollisions, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXMulticasts=ethRXMulticasts, modemTotalBlockNumber=modemTotalBlockNumber, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemRowStatus=modemRowStatus, modemErroredSecondRatio=modemErroredSecondRatio, vlanRowStatus=vlanRowStatus, modemAcqStatus=modemAcqStatus, ethRXDribleNibbles=ethRXDribleNibbles, ethRXLongEvents=ethRXLongEvents, localIp=localIp, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemEntry=modemEntry, radioIndex=radioIndex, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethGFPDropedFrames=ethGFPDropedFrames, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, sysTemperature=sysTemperature, ethRXCRCErrors=ethRXCRCErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemErroredBlock=modemErroredBlock, radioEntry=radioEntry, hostname=hostname, ipRadioCfg=ipRadioCfg, loopbacks=loopbacks, atpcIndex=atpcIndex, license=license, modemE1T1Channels=modemE1T1Channels, modemLastAcqError=modemLastAcqError, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXGiants=ethTXGiants, saf=saf, safip=safip, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ipRadioMgmt=ipRadioMgmt, e1t1StatEntry=e1t1StatEntry, sysDateAndTime=sysDateAndTime, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemUnavailtime=modemUnavailtime, ethRXControlFrames=ethRXControlFrames, ethTXByteCounterLow=ethTXByteCounterLow, modemStatistics=modemStatistics, modemTotalCapacity=modemTotalCapacity, vlanCfgStat=vlanCfgStat, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemACMethernetCapacity=modemACMethernetCapacity, ethTXMulticasts=ethTXMulticasts, ethTXBackpresEvents=ethTXBackpresEvents, ethTXControlFrames=ethTXControlFrames, ethRXVlanTagsDetected=ethRXVlanTagsDetected, description=description, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXLateCollisions=ethTXLateCollisions, vlanTable=vlanTable, ipRadio=ipRadio, modemLDPCdecoderStress=modemLDPCdecoderStress, modemTable=modemTable, ethRXPrevPktDropped=ethRXPrevPktDropped, tehnika=tehnika, ethRXByteCounterHi=ethRXByteCounterHi, modemIndex=modemIndex, ethGFPFCSErrors=ethGFPFCSErrors, ethTXCollisions=ethTXCollisions, e1t1StatTable=e1t1StatTable, radioTxMute=radioTxMute, licenseMask=licenseMask, modemGeneralStatus=modemGeneralStatus, aTPCEntry=aTPCEntry, vlanNumber=vlanNumber, modemModulation=modemModulation, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, atpcTxPowerCorrection=atpcTxPowerCorrection, modemSymbolRateRx=modemSymbolRateRx, modemCarrierOffset=modemCarrierOffset, ethRXPauseFrames=ethRXPauseFrames, ethQOSTXFrames=ethQOSTXFrames, modemRadialMSE=modemRadialMSE, pointToPoint=pointToPoint, vlansEnabled=vlansEnabled, ethRXBroadcasts=ethRXBroadcasts, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXCodeErrors=ethRXCodeErrors, ethGFPDelineationErrors=ethGFPDelineationErrors, vlanEntry=vlanEntry, loopback_tributary_mask=loopback_tributary_mask, localIpMask=localIpMask, vlanPortType=vlanPortType, ethTXUnderruns=ethTXUnderruns, radioGenStatus=radioGenStatus, modemUptime=modemUptime, licenseUpdateStatus=licenseUpdateStatus, ipRadioStatEth=ipRadioStatEth, ethTXPauseFrames=ethTXPauseFrames, e1t1AIS=e1t1AIS, product=product, ethRXTruncatedFrames=ethRXTruncatedFrames, microwaveRadio=microwaveRadio, vlanPortmap=vlanPortmap, radioLoopback=radioLoopback, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethGFPCHECErrors=ethGFPCHECErrors, radioSide=radioSide, modemACMmodulationMax=modemACMmodulationMax, modemE1T1ChannelMask=modemE1T1ChannelMask, radioTxPower=radioTxPower, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXCRCErrors=ethTXCRCErrors, aTPCTable=aTPCTable, modemACMengine=modemACMengine, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXDones=ethRXDones, modemSymbolRateTx=modemSymbolRateTx, e1t1ChannelNr=e1t1ChannelNr, e1t1LOS=e1t1LOS, ethTXDones=ethTXDones, vlanFid=vlanFid, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ipRadioCfgGeneral=ipRadioCfgGeneral, atpcEnabled=atpcEnabled, modemCountTime=modemCountTime, modemInternalAGCgain=modemInternalAGCgain, ethRXByteCounterLow=ethRXByteCounterLow, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXVlanTags=ethTXVlanTags, ipRadioStat=ipRadioStat, modemACMtotalCapacity=modemACMtotalCapacity, ethTXBroadcasts=ethTXBroadcasts, ethQOSTXDropped=ethQOSTXDropped, ethRXDvEvent=ethRXDvEvent, radioTxFrequency=radioTxFrequency, modemErroredSecond=modemErroredSecond, modemACMmodulationMin=modemACMmodulationMin, modemBandwith=modemBandwith, ethTXByteCounterHi=ethTXByteCounterHi, remoteIp=remoteIp, modemEthernetCapacity=modemEthernetCapacity, modemStandard=modemStandard, restartcpu=restartcpu, radioRxLevel=radioRxLevel, radioDuplexShift=radioDuplexShift)
