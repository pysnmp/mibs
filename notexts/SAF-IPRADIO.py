...
mibBuilder.exportSymbols("SAF-IPRADIO", modemInternalAGCgain=modemInternalAGCgain, radioTxFrequency=radioTxFrequency, ethRXDones=ethRXDones, ethTXMaxCollisions=ethTXMaxCollisions, modemEthernetCapacity=modemEthernetCapacity, atpcEnabled=atpcEnabled, modemLastAcqError=modemLastAcqError, modemSymbolRateTx=modemSymbolRateTx, ipRadioStatEth=ipRadioStatEth, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXLongEvents=ethRXLongEvents, ethTXWireByteCounterHi=ethTXWireByteCounterHi, writeConfig=writeConfig, product=product, ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadioCfgGeneral=ipRadioCfgGeneral, modemTotalCapacity=modemTotalCapacity, modemACMmodulationMin=modemACMmodulationMin, modemRadialMSE=modemRadialMSE, pointToPoint=pointToPoint, modemE1T1ChannelMask=modemE1T1ChannelMask, radioSide=radioSide, ethTXLateCollisions=ethTXLateCollisions, hostname=hostname, modemModulation=modemModulation, vlanFid=vlanFid, ethRXTruncatedFrames=ethRXTruncatedFrames, modemErroredSecond=modemErroredSecond, licenseMask=licenseMask, ipRadio=ipRadio, modemErroredSecondRatio=modemErroredSecondRatio, modemACMengine=modemACMengine, vlanPortType=vlanPortType, e1t1ChannelNr=e1t1ChannelNr, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethGFPFCSErrors=ethGFPFCSErrors, ethQOSTXFrames=ethQOSTXFrames, radioTable=radioTable, radioGenStatus=radioGenStatus, vlanCfgStat=vlanCfgStat, e1t1StatEntry=e1t1StatEntry, modemStandard=modemStandard, modemACMethernetCapacity=modemACMethernetCapacity, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXByteCounterLow=ethTXByteCounterLow, e1t1LOS=e1t1LOS, vlanEntry=vlanEntry, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXPauseFrames=ethTXPauseFrames, ipRadioMgmt=ipRadioMgmt, remoteIp=remoteIp, e1t1AIS=e1t1AIS, radioDuplexShift=radioDuplexShift, license=license, vlanRowStatus=vlanRowStatus, modemAcqStatus=modemAcqStatus, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXCollisions=ethTXCollisions, modemEntry=modemEntry, sysDateAndTime=sysDateAndTime, radioRxFrequency=radioRxFrequency, licenseUpdateStatus=licenseUpdateStatus, ethRXDvEvent=ethRXDvEvent, modemCountTime=modemCountTime, ethRXCRCErrors=ethRXCRCErrors, ethRXMulticasts=ethRXMulticasts, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXWireByteCounterLow=ethTXWireByteCounterLow, localIpMask=localIpMask, radioTxMute=radioTxMute, description=description, modemGeneralStatus=modemGeneralStatus, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXDones=ethTXDones, modemLDPCdecoderStress=modemLDPCdecoderStress, modemIndex=modemIndex, safip=safip, ethQOSRXQ1Frames=ethQOSRXQ1Frames, e1t1StatTable=e1t1StatTable, vlansEnabled=vlansEnabled, ethTXVlanTags=ethTXVlanTags, radioIndex=radioIndex, saf=saf, aTPCEntry=aTPCEntry, modemBandwith=modemBandwith, ethTXMulticasts=ethTXMulticasts, ipRadioStat=ipRadioStat, radioRxLevel=radioRxLevel, modemRowStatus=modemRowStatus, vlanTable=vlanTable, radioTxPower=radioTxPower, ethTXUnderruns=ethTXUnderruns, restartcpu=restartcpu, ethRXPauseFrames=ethRXPauseFrames, modemUptime=modemUptime, ethRXDribleNibbles=ethRXDribleNibbles, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXBroadcasts=ethRXBroadcasts, modemE1T1Channels=modemE1T1Channels, vlanPortmap=vlanPortmap, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethGFPDropedFrames=ethGFPDropedFrames, modemTable=modemTable, loopback_tributary_mask=loopback_tributary_mask, ethTXControlFrames=ethTXControlFrames, modemSymbolRateRx=modemSymbolRateRx, modemACMmodulationMax=modemACMmodulationMax, ethQOSTXDropped=ethQOSTXDropped, ethRXVlanTagsDetected=ethRXVlanTagsDetected, sysTemperature=sysTemperature, ethRXCodeErrors=ethRXCodeErrors, ethTXGiants=ethTXGiants, ethTXExcessiveDefers=ethTXExcessiveDefers, vlanNumber=vlanNumber, ethRXControlFrames=ethRXControlFrames, ethTXCRCErrors=ethTXCRCErrors, ipRadioCfg=ipRadioCfg, aTPCTable=aTPCTable, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXBroadcasts=ethTXBroadcasts, ethRXPrevPktDropped=ethRXPrevPktDropped, microwaveRadio=microwaveRadio, modemTotalBlockNumber=modemTotalBlockNumber, ethRXByteCounterLow=ethRXByteCounterLow, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemUnavailtime=modemUnavailtime, ethRXByteCounterHi=ethRXByteCounterHi, radioEntry=radioEntry, ethTXBackpresEvents=ethTXBackpresEvents, localIp=localIp, radioLoopback=radioLoopback, loopbacks=loopbacks, modemStatistics=modemStatistics, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, atpcIndex=atpcIndex, ethTXByteCounterHi=ethTXByteCounterHi, ethGFPCHECErrors=ethGFPCHECErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemACMtotalCapacity=modemACMtotalCapacity, modemCarrierOffset=modemCarrierOffset, modemErroredBlock=modemErroredBlock, tehnika=tehnika)
