...
mibBuilder.exportSymbols("SAF-IPRADIO", modemBackgroundBlockErrror=modemBackgroundBlockErrror, sysTemperature=sysTemperature, sysDateAndTime=sysDateAndTime, vlanPortmap=vlanPortmap, ethRXCRCErrors=ethRXCRCErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, e1t1AIS=e1t1AIS, localIp=localIp, modemBandwith=modemBandwith, saf=saf, modemUptime=modemUptime, ethTXVlanTags=ethTXVlanTags, ethRXCodeErrors=ethRXCodeErrors, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemStatistics=modemStatistics, e1t1LOS=e1t1LOS, modemErroredSecond=modemErroredSecond, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, microwaveRadio=microwaveRadio, modemSymbolRateTx=modemSymbolRateTx, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemStandard=modemStandard, localIpMask=localIpMask, modemEthernetCapacity=modemEthernetCapacity, ethTXByteCounterLow=ethTXByteCounterLow, modemCountTime=modemCountTime, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, atpcIndex=atpcIndex, product=product, modemUnavailtime=modemUnavailtime, radioDuplexShift=radioDuplexShift, license=license, modemACMengine=modemACMengine, ethTXPauseFrames=ethTXPauseFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, radioEntry=radioEntry, ethTXLateCollisions=ethTXLateCollisions, vlanEntry=vlanEntry, modemTotalBlockNumber=modemTotalBlockNumber, ethQOSTXFrames=ethQOSTXFrames, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXControlFrames=ethTXControlFrames, vlanNumber=vlanNumber, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, pointToPoint=pointToPoint, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemACMtotalCapacity=modemACMtotalCapacity, ipRadioStatEth=ipRadioStatEth, radioTxMute=radioTxMute, modemACMmodulationMin=modemACMmodulationMin, modemCarrierOffset=modemCarrierOffset, radioTxFrequency=radioTxFrequency, radioSide=radioSide, ipRadio=ipRadio, writeConfig=writeConfig, loopbacks=loopbacks, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemModulation=modemModulation, modemAcqStatus=modemAcqStatus, modemInternalAGCgain=modemInternalAGCgain, ethRXByteCounterHi=ethRXByteCounterHi, modemTotalCapacity=modemTotalCapacity, restartcpu=restartcpu, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXMaxCollisions=ethTXMaxCollisions, modemACMethernetCapacity=modemACMethernetCapacity, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemEntry=modemEntry, tehnika=tehnika, radioTxPower=radioTxPower, modemTable=modemTable, modemLDPCdecoderStress=modemLDPCdecoderStress, e1t1ChannelNr=e1t1ChannelNr, ethRXByteCounterLow=ethRXByteCounterLow, ethRXPauseFrames=ethRXPauseFrames, ethTXCRCErrors=ethTXCRCErrors, radioRxLevel=radioRxLevel, modemGeneralStatus=modemGeneralStatus, safip=safip, ethTXExcessiveDefers=ethTXExcessiveDefers, loopback_tributary_mask=loopback_tributary_mask, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ipRadioStat=ipRadioStat, radioRxFrequency=radioRxFrequency, modemLastAcqError=modemLastAcqError, vlanRowStatus=vlanRowStatus, radioTable=radioTable, modemRowStatus=modemRowStatus, ethTXDones=ethTXDones, ethQOSTXDropped=ethQOSTXDropped, vlanTable=vlanTable, modemErroredSecondRatio=modemErroredSecondRatio, ipRadioCfgGeneral=ipRadioCfgGeneral, modemSymbolRateRx=modemSymbolRateRx, ethTXMulticasts=ethTXMulticasts, radioIndex=radioIndex, ethTXGiants=ethTXGiants, aTPCTable=aTPCTable, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ipRadioCfg=ipRadioCfg, ethTXCollisions=ethTXCollisions, modemIndex=modemIndex, remoteIp=remoteIp, modemE1T1ChannelMask=modemE1T1ChannelMask, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, aTPCEntry=aTPCEntry, e1t1StatEntry=e1t1StatEntry, description=description, modemACMmodulationMax=modemACMmodulationMax, ethGFPFCSErrors=ethGFPFCSErrors, vlanFid=vlanFid, licenseUpdateStatus=licenseUpdateStatus, ethRXMulticasts=ethRXMulticasts, ethGFPCHECErrors=ethGFPCHECErrors, e1t1StatTable=e1t1StatTable, licenseMask=licenseMask, ethRXLongEvents=ethRXLongEvents, ethGFPDropedFrames=ethGFPDropedFrames, radioGenStatus=radioGenStatus, vlansEnabled=vlansEnabled, atpcEnabled=atpcEnabled, ethRXControlFrames=ethRXControlFrames, ethTXBackpresEvents=ethTXBackpresEvents, ethTXByteCounterHi=ethTXByteCounterHi, modemErroredBlock=modemErroredBlock, modemRadialMSE=modemRadialMSE, hostname=hostname, ethRXDones=ethRXDones, modemE1T1Channels=modemE1T1Channels, ethRXDvEvent=ethRXDvEvent, ethRXDribleNibbles=ethRXDribleNibbles, ipRadioMgmt=ipRadioMgmt, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXUnderruns=ethTXUnderruns, radioLoopback=radioLoopback, vlanCfgStat=vlanCfgStat, ethRXBroadcasts=ethRXBroadcasts, ethTXBroadcasts=ethTXBroadcasts, ethTXLengthCheckErrors=ethTXLengthCheckErrors, vlanPortType=vlanPortType)
