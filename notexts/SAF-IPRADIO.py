...
mibBuilder.exportSymbols("SAF-IPRADIO", modemAcqStatus=modemAcqStatus, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemACMmodulationMin=modemACMmodulationMin, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemTotalCapacity=modemTotalCapacity, modemSymbolRateRx=modemSymbolRateRx, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, licenseMask=licenseMask, ethRXDvEvent=ethRXDvEvent, modemTotalBlockNumber=modemTotalBlockNumber, ethGFPDropedFrames=ethGFPDropedFrames, ethRXDones=ethRXDones, radioSide=radioSide, modemUptime=modemUptime, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ipRadioStatEth=ipRadioStatEth, ethTXPauseFrames=ethTXPauseFrames, sysDateAndTime=sysDateAndTime, aTPCEntry=aTPCEntry, atpcEnabled=atpcEnabled, modemInternalAGCgain=modemInternalAGCgain, modemSymbolRateTx=modemSymbolRateTx, ethTXControlFrames=ethTXControlFrames, modemEntry=modemEntry, ethTXMulticasts=ethTXMulticasts, modemModulation=modemModulation, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemIndex=modemIndex, e1t1ChannelNr=e1t1ChannelNr, ethTXDones=ethTXDones, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ipRadio=ipRadio, e1t1StatTable=e1t1StatTable, loopback_tributary_mask=loopback_tributary_mask, e1t1LOS=e1t1LOS, ethRXBroadcasts=ethRXBroadcasts, modemCountTime=modemCountTime, radioGenStatus=radioGenStatus, description=description, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemACMmodulationMax=modemACMmodulationMax, ethGFPFCSErrors=ethGFPFCSErrors, aTPCTable=aTPCTable, vlanFid=vlanFid, ethTXLateCollisions=ethTXLateCollisions, ethGFPCHECErrors=ethGFPCHECErrors, license=license, localIpMask=localIpMask, ethTXExcessiveDefers=ethTXExcessiveDefers, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioTxMute=radioTxMute, radioDuplexShift=radioDuplexShift, modemStandard=modemStandard, ethTXWireByteCounterLow=ethTXWireByteCounterLow, microwaveRadio=microwaveRadio, modemACMtotalCapacity=modemACMtotalCapacity, radioRxLevel=radioRxLevel, radioTxPower=radioTxPower, hostname=hostname, radioIndex=radioIndex, modemStatistics=modemStatistics, modemEthernetCapacity=modemEthernetCapacity, radioTxFrequency=radioTxFrequency, radioEntry=radioEntry, ethQOSTXFrames=ethQOSTXFrames, ethRXByteCounterLow=ethRXByteCounterLow, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemErroredSecondRatio=modemErroredSecondRatio, pointToPoint=pointToPoint, ipRadioCfgGeneral=ipRadioCfgGeneral, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, vlansEnabled=vlansEnabled, ethQOSTXDropped=ethQOSTXDropped, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXMaxCollisions=ethTXMaxCollisions, ethTXCollisions=ethTXCollisions, modemE1T1ChannelMask=modemE1T1ChannelMask, localIp=localIp, ethTXByteCounterLow=ethTXByteCounterLow, modemGeneralStatus=modemGeneralStatus, ipRadioCfg=ipRadioCfg, modemRowStatus=modemRowStatus, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemCarrierOffset=modemCarrierOffset, vlanPortmap=vlanPortmap, vlanNumber=vlanNumber, ethRXLongEvents=ethRXLongEvents, modemE1T1Channels=modemE1T1Channels, modemACMengine=modemACMengine, vlanEntry=vlanEntry, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXPauseFrames=ethRXPauseFrames, vlanPortType=vlanPortType, ethRXControlFrames=ethRXControlFrames, modemLastAcqError=modemLastAcqError, ipRadioMgmt=ipRadioMgmt, vlanRowStatus=vlanRowStatus, modemErroredSecond=modemErroredSecond, ethTXUnderruns=ethTXUnderruns, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXGiants=ethTXGiants, modemACMethernetCapacity=modemACMethernetCapacity, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXMulticasts=ethRXMulticasts, writeConfig=writeConfig, ethRXCRCErrors=ethRXCRCErrors, product=product, ethRXCodeErrors=ethRXCodeErrors, restartcpu=restartcpu, ipRadioCfgNetwork=ipRadioCfgNetwork, atpcTxPowerCorrection=atpcTxPowerCorrection, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXBackpresEvents=ethTXBackpresEvents, ipRadioStat=ipRadioStat, modemUnavailtime=modemUnavailtime, ethTXCRCErrors=ethTXCRCErrors, saf=saf, modemBandwith=modemBandwith, ethTXByteCounterHi=ethTXByteCounterHi, ethRXByteCounterHi=ethRXByteCounterHi, atpcIndex=atpcIndex, remoteIp=remoteIp, ethTXBroadcasts=ethTXBroadcasts, e1t1StatEntry=e1t1StatEntry, radioLoopback=radioLoopback, modemTable=modemTable, ethRXDribleNibbles=ethRXDribleNibbles, modemRadialMSE=modemRadialMSE, vlanCfgStat=vlanCfgStat, tehnika=tehnika, radioTable=radioTable, modemErroredBlock=modemErroredBlock, e1t1AIS=e1t1AIS, loopbacks=loopbacks, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, licenseUpdateStatus=licenseUpdateStatus, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXVlanTags=ethTXVlanTags, radioRxFrequency=radioRxFrequency, vlanTable=vlanTable, safip=safip, sysTemperature=sysTemperature)
