...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXByteCounterLow=ethTXByteCounterLow, ethTXPauseFrames=ethTXPauseFrames, e1t1AIS=e1t1AIS, ipRadioStat=ipRadioStat, modemRowStatus=modemRowStatus, vlanFid=vlanFid, ethTXBackpresEvents=ethTXBackpresEvents, ethTXVlanTags=ethTXVlanTags, modemStandard=modemStandard, modemBandwith=modemBandwith, ethTXLateCollisions=ethTXLateCollisions, modemErroredSecond=modemErroredSecond, ethTXCollisions=ethTXCollisions, vlansEnabled=vlansEnabled, ethGFPCHECErrors=ethGFPCHECErrors, ethGFPDelineationErrors=ethGFPDelineationErrors, atpcIndex=atpcIndex, ethRXByteCounterHi=ethRXByteCounterHi, writeConfig=writeConfig, ethQOSTXDropped=ethQOSTXDropped, modemStatistics=modemStatistics, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXMaxCollisions=ethTXMaxCollisions, modemACMmodulationMin=modemACMmodulationMin, ethRXBroadcasts=ethRXBroadcasts, radioTxMute=radioTxMute, license=license, ethRXPrevPktDropped=ethRXPrevPktDropped, modemTotalBlockNumber=modemTotalBlockNumber, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemTable=modemTable, vlanTable=vlanTable, radioTable=radioTable, modemEthernetCapacity=modemEthernetCapacity, radioDuplexShift=radioDuplexShift, ipRadioMgmt=ipRadioMgmt, modemACMengine=modemACMengine, radioRxLevel=radioRxLevel, modemUnavailtime=modemUnavailtime, ethRXLongEvents=ethRXLongEvents, safip=safip, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemEntry=modemEntry, radioTxFrequency=radioTxFrequency, e1t1ChannelNr=e1t1ChannelNr, loopback_tributary_mask=loopback_tributary_mask, description=description, ethRXUnsupOpcodes=ethRXUnsupOpcodes, e1t1StatTable=e1t1StatTable, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemErroredBlock=modemErroredBlock, modemRadialMSE=modemRadialMSE, modemUptime=modemUptime, ipRadio=ipRadio, radioEntry=radioEntry, modemLastAcqError=modemLastAcqError, microwaveRadio=microwaveRadio, hostname=hostname, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXLengthCheckErrors=ethTXLengthCheckErrors, radioTxPower=radioTxPower, pointToPoint=pointToPoint, atpcEnabled=atpcEnabled, modemSeverelyErroredSecond=modemSeverelyErroredSecond, vlanPortType=vlanPortType, atpcTxPowerCorrection=atpcTxPowerCorrection, modemTotalCapacity=modemTotalCapacity, ethQOSRXQ2Frames=ethQOSRXQ2Frames, sysDateAndTime=sysDateAndTime, vlanEntry=vlanEntry, radioRxFrequency=radioRxFrequency, ethRXDones=ethRXDones, modemCarrierOffset=modemCarrierOffset, modemCountTime=modemCountTime, modemInternalAGCgain=modemInternalAGCgain, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXDvEvent=ethRXDvEvent, ethTXCRCErrors=ethTXCRCErrors, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXDones=ethTXDones, ethQOSTXFrames=ethQOSTXFrames, modemSymbolRateTx=modemSymbolRateTx, vlanNumber=vlanNumber, modemACMmodulationMax=modemACMmodulationMax, ethGFPDropedFrames=ethGFPDropedFrames, radioSide=radioSide, ethRXCRCErrors=ethRXCRCErrors, ethTXExcessiveDefers=ethTXExcessiveDefers, loopbacks=loopbacks, ethRXControlFrames=ethRXControlFrames, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, localIpMask=localIpMask, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXMulticasts=ethTXMulticasts, remoteIp=remoteIp, modemE1T1Channels=modemE1T1Channels, modemErroredSecondRatio=modemErroredSecondRatio, modemGeneralStatus=modemGeneralStatus, e1t1StatEntry=e1t1StatEntry, ethTXUnderruns=ethTXUnderruns, e1t1LOS=e1t1LOS, radioLoopback=radioLoopback, licenseMask=licenseMask, localIp=localIp, ipRadioCfgNetwork=ipRadioCfgNetwork, ipRadioCfg=ipRadioCfg, radioGenStatus=radioGenStatus, modemSymbolRateRx=modemSymbolRateRx, ethTXByteCounterHi=ethTXByteCounterHi, vlanPortmap=vlanPortmap, ethRXMulticasts=ethRXMulticasts, tehnika=tehnika, vlanCfgStat=vlanCfgStat, licenseUpdateStatus=licenseUpdateStatus, ethRXVlanTagsDetected=ethRXVlanTagsDetected, sysTemperature=sysTemperature, modemIndex=modemIndex, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXByteCounterLow=ethRXByteCounterLow, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, saf=saf, ethTXControlFrames=ethTXControlFrames, modemACMtotalCapacity=modemACMtotalCapacity, modemACMethernetCapacity=modemACMethernetCapacity, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXWireByteCounterLow=ethTXWireByteCounterLow, aTPCTable=aTPCTable, ethGFPFCSErrors=ethGFPFCSErrors, ethTXGiants=ethTXGiants, modemAcqStatus=modemAcqStatus, vlanRowStatus=vlanRowStatus, ethTXBroadcasts=ethTXBroadcasts, modemModulation=modemModulation, ipRadioStatEth=ipRadioStatEth, ethRXPauseFrames=ethRXPauseFrames, ethRXDribleNibbles=ethRXDribleNibbles, product=product, restartcpu=restartcpu, radioIndex=radioIndex, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXCodeErrors=ethRXCodeErrors, aTPCEntry=aTPCEntry)
