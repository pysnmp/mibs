...
mibBuilder.exportSymbols("SAF-IPRADIO", modemCountTime=modemCountTime, radioDuplexShift=radioDuplexShift, modemACMtotalCapacity=modemACMtotalCapacity, e1t1LOS=e1t1LOS, e1t1StatEntry=e1t1StatEntry, modemCarrierOffset=modemCarrierOffset, radioRxLevel=radioRxLevel, modemRadialMSE=modemRadialMSE, ethGFPFCSErrors=ethGFPFCSErrors, ethGFPCHECErrors=ethGFPCHECErrors, product=product, radioTxFrequency=radioTxFrequency, ethRXControlFrames=ethRXControlFrames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXDones=ethRXDones, ethRXByteCounterHi=ethRXByteCounterHi, loopback_tributary_mask=loopback_tributary_mask, ipRadio=ipRadio, modemE1T1Channels=modemE1T1Channels, vlanPortmap=vlanPortmap, ethRXPauseFrames=ethRXPauseFrames, license=license, modemAcqStatus=modemAcqStatus, radioSide=radioSide, modemErroredSecondRatio=modemErroredSecondRatio, radioIndex=radioIndex, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemBackgroundBlockErrror=modemBackgroundBlockErrror, e1t1ChannelNr=e1t1ChannelNr, ethTXMaxCollisions=ethTXMaxCollisions, ethTXControlFrames=ethTXControlFrames, modemBandwith=modemBandwith, ethRXBroadcasts=ethRXBroadcasts, ipRadioCfg=ipRadioCfg, ethTXDones=ethTXDones, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ipRadioStatEth=ipRadioStatEth, ethTXLateCollisions=ethTXLateCollisions, sysTemperature=sysTemperature, localIp=localIp, aTPCTable=aTPCTable, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemIndex=modemIndex, vlanCfgStat=vlanCfgStat, e1t1StatTable=e1t1StatTable, modemStatistics=modemStatistics, vlansEnabled=vlansEnabled, ethRXCodeErrors=ethRXCodeErrors, ethRXDribleNibbles=ethRXDribleNibbles, ethRXByteCounterLow=ethRXByteCounterLow, radioTxPower=radioTxPower, vlanNumber=vlanNumber, modemTable=modemTable, modemACMethernetCapacity=modemACMethernetCapacity, vlanEntry=vlanEntry, licenseMask=licenseMask, localIpMask=localIpMask, tehnika=tehnika, ethTXBroadcasts=ethTXBroadcasts, ethTXCRCErrors=ethTXCRCErrors, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXByteCounterHi=ethTXByteCounterHi, modemACMmodulationMin=modemACMmodulationMin, modemTotalBlockNumber=modemTotalBlockNumber, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemLastAcqError=modemLastAcqError, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXUnderruns=ethTXUnderruns, ethTXBackpresEvents=ethTXBackpresEvents, pointToPoint=pointToPoint, modemErroredSecond=modemErroredSecond, modemUnavailtime=modemUnavailtime, microwaveRadio=microwaveRadio, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemSymbolRateRx=modemSymbolRateRx, remoteIp=remoteIp, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXMulticasts=ethRXMulticasts, modemE1T1ChannelMask=modemE1T1ChannelMask, modemEthernetCapacity=modemEthernetCapacity, ethQOSTXFrames=ethQOSTXFrames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, vlanRowStatus=vlanRowStatus, modemACMengine=modemACMengine, safip=safip, ipRadioStat=ipRadioStat, radioTable=radioTable, vlanTable=vlanTable, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXLongEvents=ethRXLongEvents, ethTXPauseFrames=ethTXPauseFrames, ipRadioCfgNetwork=ipRadioCfgNetwork, radioTxMute=radioTxMute, atpcTxPowerCorrection=atpcTxPowerCorrection, modemGeneralStatus=modemGeneralStatus, vlanFid=vlanFid, ipRadioMgmt=ipRadioMgmt, description=description, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemStandard=modemStandard, radioGenStatus=radioGenStatus, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, e1t1AIS=e1t1AIS, modemTotalCapacity=modemTotalCapacity, modemInternalAGCgain=modemInternalAGCgain, sysDateAndTime=sysDateAndTime, ethGFPDropedFrames=ethGFPDropedFrames, modemACMmodulationMax=modemACMmodulationMax, ethGFPDelineationErrors=ethGFPDelineationErrors, atpcEnabled=atpcEnabled, ethQOSTXDropped=ethQOSTXDropped, atpcIndex=atpcIndex, licenseUpdateStatus=licenseUpdateStatus, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXWireByteCounterLow=ethTXWireByteCounterLow, restartcpu=restartcpu, aTPCEntry=aTPCEntry, loopbacks=loopbacks, saf=saf, ethTXExcessiveDefers=ethTXExcessiveDefers, ipRadioCfgGeneral=ipRadioCfgGeneral, vlanPortType=vlanPortType, radioEntry=radioEntry, ethTXByteCounterLow=ethTXByteCounterLow, ethTXVlanTags=ethTXVlanTags, ethTXGiants=ethTXGiants, ethRXDvEvent=ethRXDvEvent, writeConfig=writeConfig, modemErroredBlock=modemErroredBlock, modemUptime=modemUptime, ethRXCRCErrors=ethRXCRCErrors, modemRowStatus=modemRowStatus, ethTXCollisions=ethTXCollisions, hostname=hostname, modemSymbolRateTx=modemSymbolRateTx, modemModulation=modemModulation, ethTXMulticasts=ethTXMulticasts, radioLoopback=radioLoopback, radioRxFrequency=radioRxFrequency, modemEntry=modemEntry, ethTXWireByteCounterHi=ethTXWireByteCounterHi)
