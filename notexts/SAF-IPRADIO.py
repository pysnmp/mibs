...
mibBuilder.exportSymbols("SAF-IPRADIO", modemACMmodulationMax=modemACMmodulationMax, ethTXUnderruns=ethTXUnderruns, atpcEnabled=atpcEnabled, modemErroredBlock=modemErroredBlock, vlansEnabled=vlansEnabled, modemE1T1ChannelMask=modemE1T1ChannelMask, ipRadioMgmt=ipRadioMgmt, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioDuplexShift=radioDuplexShift, saf=saf, ethRXLongEvents=ethRXLongEvents, modemIndex=modemIndex, vlanFid=vlanFid, ethTXMulticasts=ethTXMulticasts, modemACMengine=modemACMengine, ethTXByteCounterHi=ethTXByteCounterHi, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioRxLevel=radioRxLevel, modemLastAcqError=modemLastAcqError, ethRXMulticasts=ethRXMulticasts, vlanTable=vlanTable, radioTable=radioTable, modemACMmodulationMin=modemACMmodulationMin, modemStatistics=modemStatistics, licenseMask=licenseMask, radioRxFrequency=radioRxFrequency, ethTXPauseFrames=ethTXPauseFrames, modemRowStatus=modemRowStatus, modemTotalCapacity=modemTotalCapacity, vlanPortmap=vlanPortmap, sysDateAndTime=sysDateAndTime, ipRadioStatEth=ipRadioStatEth, ethRXDribleNibbles=ethRXDribleNibbles, writeConfig=writeConfig, ethRXControlFrames=ethRXControlFrames, radioTxFrequency=radioTxFrequency, atpcIndex=atpcIndex, modemErroredSecondRatio=modemErroredSecondRatio, ethRXPrevPktDropped=ethRXPrevPktDropped, remoteIp=remoteIp, radioGenStatus=radioGenStatus, modemAcqStatus=modemAcqStatus, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXWireByteCounterLow=ethTXWireByteCounterLow, e1t1StatTable=e1t1StatTable, e1t1StatEntry=e1t1StatEntry, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, microwaveRadio=microwaveRadio, ethTXGiants=ethTXGiants, ethTXDones=ethTXDones, ipRadioStat=ipRadioStat, restartcpu=restartcpu, ethQOSTXFrames=ethQOSTXFrames, localIpMask=localIpMask, ipRadioCfgGeneral=ipRadioCfgGeneral, modemGeneralStatus=modemGeneralStatus, radioLoopback=radioLoopback, modemACMtotalCapacity=modemACMtotalCapacity, modemUnavailtime=modemUnavailtime, product=product, modemModulation=modemModulation, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXPauseFrames=ethRXPauseFrames, radioEntry=radioEntry, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioIndex=radioIndex, modemErroredSecond=modemErroredSecond, pointToPoint=pointToPoint, modemBandwith=modemBandwith, ethTXCollisions=ethTXCollisions, ethRXBroadcasts=ethRXBroadcasts, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, loopback_tributary_mask=loopback_tributary_mask, ethTXBackpresEvents=ethTXBackpresEvents, description=description, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, vlanPortType=vlanPortType, ethGFPDropedFrames=ethGFPDropedFrames, modemACMethernetCapacity=modemACMethernetCapacity, vlanCfgStat=vlanCfgStat, ethRXDones=ethRXDones, ethGFPCHECErrors=ethGFPCHECErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemCarrierOffset=modemCarrierOffset, radioSide=radioSide, tehnika=tehnika, modemEthernetCapacity=modemEthernetCapacity, licenseUpdateStatus=licenseUpdateStatus, modemInternalAGCgain=modemInternalAGCgain, modemTable=modemTable, vlanNumber=vlanNumber, modemE1T1Channels=modemE1T1Channels, ethRXCodeErrors=ethRXCodeErrors, ipRadioCfg=ipRadioCfg, sysTemperature=sysTemperature, ethTXControlFrames=ethTXControlFrames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioTxPower=radioTxPower, e1t1LOS=e1t1LOS, ethTXLateCollisions=ethTXLateCollisions, modemUptime=modemUptime, modemEntry=modemEntry, ethRXByteCounterHi=ethRXByteCounterHi, modemSymbolRateRx=modemSymbolRateRx, hostname=hostname, modemStandard=modemStandard, ethTXVlanTags=ethTXVlanTags, ipRadio=ipRadio, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXCRCErrors=ethTXCRCErrors, ethQOSTXDropped=ethQOSTXDropped, modemCountTime=modemCountTime, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, license=license, ethTXByteCounterLow=ethTXByteCounterLow, radioTxMute=radioTxMute, ethRXCRCErrors=ethRXCRCErrors, e1t1AIS=e1t1AIS, ipRadioCfgNetwork=ipRadioCfgNetwork, atpcTxPowerCorrection=atpcTxPowerCorrection, localIp=localIp, ethTXMaxCollisions=ethTXMaxCollisions, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXBroadcasts=ethTXBroadcasts, vlanEntry=vlanEntry, ethQOSRXQ1Frames=ethQOSRXQ1Frames, aTPCTable=aTPCTable, ethRXByteCounterLow=ethRXByteCounterLow, modemSymbolRateTx=modemSymbolRateTx, ethRXDvEvent=ethRXDvEvent, modemBackgroundBlockErrror=modemBackgroundBlockErrror, e1t1ChannelNr=e1t1ChannelNr, modemTotalBlockNumber=modemTotalBlockNumber, ethGFPFCSErrors=ethGFPFCSErrors, safip=safip, loopbacks=loopbacks, vlanRowStatus=vlanRowStatus, aTPCEntry=aTPCEntry, modemRadialMSE=modemRadialMSE)
