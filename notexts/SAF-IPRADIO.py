...
mibBuilder.exportSymbols("SAF-IPRADIO", ipRadioCfg=ipRadioCfg, ethRXBroadcasts=ethRXBroadcasts, radioRxLevel=radioRxLevel, vlanNumber=vlanNumber, ipRadio=ipRadio, ethTXCollisions=ethTXCollisions, radioTable=radioTable, radioRxFrequency=radioRxFrequency, ethTXExcessiveDefers=ethTXExcessiveDefers, ipRadioStat=ipRadioStat, modemGeneralStatus=modemGeneralStatus, modemTable=modemTable, saf=saf, ethTXUnderruns=ethTXUnderruns, sysTemperature=sysTemperature, remoteIp=remoteIp, vlanPortmap=vlanPortmap, ethTXMaxCollisions=ethTXMaxCollisions, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethQOSTXFrames=ethQOSTXFrames, ethGFPCHECErrors=ethGFPCHECErrors, safip=safip, modemE1T1Channels=modemE1T1Channels, vlansEnabled=vlansEnabled, vlanRowStatus=vlanRowStatus, ethTXWireByteCounterHi=ethTXWireByteCounterHi, aTPCTable=aTPCTable, modemErroredSecondRatio=modemErroredSecondRatio, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioTxPower=radioTxPower, loopback_tributary_mask=loopback_tributary_mask, modemErroredBlock=modemErroredBlock, loopbacks=loopbacks, ethGFPDropedFrames=ethGFPDropedFrames, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemAcqStatus=modemAcqStatus, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXPauseFrames=ethRXPauseFrames, licenseMask=licenseMask, ethTXByteCounterLow=ethTXByteCounterLow, ethTXByteCounterHi=ethTXByteCounterHi, ethTXDones=ethTXDones, modemTotalBlockNumber=modemTotalBlockNumber, ethRXByteCounterHi=ethRXByteCounterHi, ethTXGiants=ethTXGiants, modemE1T1ChannelMask=modemE1T1ChannelMask, modemInternalAGCgain=modemInternalAGCgain, e1t1LOS=e1t1LOS, modemUptime=modemUptime, ethRXDones=ethRXDones, localIpMask=localIpMask, modemTotalCapacity=modemTotalCapacity, modemCountTime=modemCountTime, aTPCEntry=aTPCEntry, modemEthernetCapacity=modemEthernetCapacity, e1t1StatTable=e1t1StatTable, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemErroredSecond=modemErroredSecond, modemIndex=modemIndex, radioIndex=radioIndex, ethQOSTXDropped=ethQOSTXDropped, modemRowStatus=modemRowStatus, sysDateAndTime=sysDateAndTime, modemACMengine=modemACMengine, ethTXCRCErrors=ethTXCRCErrors, vlanFid=vlanFid, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioSide=radioSide, atpcIndex=atpcIndex, hostname=hostname, tehnika=tehnika, ipRadioCfgGeneral=ipRadioCfgGeneral, vlanEntry=vlanEntry, ethTXPauseFrames=ethTXPauseFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, modemUnavailtime=modemUnavailtime, modemACMmodulationMin=modemACMmodulationMin, vlanPortType=vlanPortType, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioLoopback=radioLoopback, ethRXMulticasts=ethRXMulticasts, localIp=localIp, modemACMmodulationMax=modemACMmodulationMax, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, e1t1AIS=e1t1AIS, ethTXBackpresEvents=ethTXBackpresEvents, ethRXDvEvent=ethRXDvEvent, ethTXMulticasts=ethTXMulticasts, product=product, atpcEnabled=atpcEnabled, modemLastAcqError=modemLastAcqError, ethGFPFCSErrors=ethGFPFCSErrors, modemStandard=modemStandard, modemEntry=modemEntry, modemSymbolRateRx=modemSymbolRateRx, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemRadialMSE=modemRadialMSE, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemACMtotalCapacity=modemACMtotalCapacity, radioGenStatus=radioGenStatus, radioTxMute=radioTxMute, restartcpu=restartcpu, vlanTable=vlanTable, atpcTxPowerCorrection=atpcTxPowerCorrection, license=license, licenseUpdateStatus=licenseUpdateStatus, modemStatistics=modemStatistics, radioTxFrequency=radioTxFrequency, modemModulation=modemModulation, e1t1ChannelNr=e1t1ChannelNr, vlanCfgStat=vlanCfgStat, ethRXDribleNibbles=ethRXDribleNibbles, pointToPoint=pointToPoint, modemACMethernetCapacity=modemACMethernetCapacity, ethRXControlFrames=ethRXControlFrames, ethRXLongEvents=ethRXLongEvents, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemLDPCdecoderStress=modemLDPCdecoderStress, ipRadioCfgNetwork=ipRadioCfgNetwork, microwaveRadio=microwaveRadio, writeConfig=writeConfig, ethTXVlanTags=ethTXVlanTags, ipRadioMgmt=ipRadioMgmt, ethQOSRXQ2Frames=ethQOSRXQ2Frames, e1t1StatEntry=e1t1StatEntry, modemBandwith=modemBandwith, ethTXBroadcasts=ethTXBroadcasts, ethTXControlFrames=ethTXControlFrames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, description=description, ethRXByteCounterLow=ethRXByteCounterLow, ethRXPrevPktDropped=ethRXPrevPktDropped, modemSymbolRateTx=modemSymbolRateTx, modemCarrierOffset=modemCarrierOffset, radioEntry=radioEntry, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXCodeErrors=ethRXCodeErrors, ipRadioStatEth=ipRadioStatEth, ethRXCRCErrors=ethRXCRCErrors, ethTXLateCollisions=ethTXLateCollisions, ethRXTruncatedFrames=ethRXTruncatedFrames, radioDuplexShift=radioDuplexShift)
