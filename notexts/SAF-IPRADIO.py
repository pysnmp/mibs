...
mibBuilder.exportSymbols("SAF-IPRADIO", pointToPoint=pointToPoint, ethTXByteCounterHi=ethTXByteCounterHi, ipRadioCfgGeneral=ipRadioCfgGeneral, ipRadioCfgNetwork=ipRadioCfgNetwork, aTPCTable=aTPCTable, radioIndex=radioIndex, vlanRowStatus=vlanRowStatus, ethQOSTXFrames=ethQOSTXFrames, radioTable=radioTable, modemIndex=modemIndex, ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlanEntry=vlanEntry, product=product, ethRXPauseFrames=ethRXPauseFrames, ethRXDones=ethRXDones, modemUnavailtime=modemUnavailtime, licenseMask=licenseMask, radioRxLevel=radioRxLevel, modemStandard=modemStandard, aTPCEntry=aTPCEntry, ipRadio=ipRadio, modemErroredSecondRatio=modemErroredSecondRatio, modemTotalCapacity=modemTotalCapacity, modemRowStatus=modemRowStatus, ethTXControlFrames=ethTXControlFrames, ethRXCodeErrors=ethRXCodeErrors, ethTXMulticasts=ethTXMulticasts, modemErroredSecond=modemErroredSecond, ipRadioMgmt=ipRadioMgmt, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemErroredBlock=modemErroredBlock, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethGFPFCSErrors=ethGFPFCSErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXUnderruns=ethTXUnderruns, radioDuplexShift=radioDuplexShift, vlanCfgStat=vlanCfgStat, vlanNumber=vlanNumber, modemACMtotalCapacity=modemACMtotalCapacity, tehnika=tehnika, ethRXByteCounterLow=ethRXByteCounterLow, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemACMmodulationMax=modemACMmodulationMax, radioGenStatus=radioGenStatus, ethRXCRCErrors=ethRXCRCErrors, radioLoopback=radioLoopback, modemCarrierOffset=modemCarrierOffset, modemTable=modemTable, microwaveRadio=microwaveRadio, modemLastAcqError=modemLastAcqError, license=license, modemAcqStatus=modemAcqStatus, ipRadioStat=ipRadioStat, restartcpu=restartcpu, modemLDPCdecoderStress=modemLDPCdecoderStress, ethGFPDelineationErrors=ethGFPDelineationErrors, modemUptime=modemUptime, localIp=localIp, ethTXGiants=ethTXGiants, remoteIp=remoteIp, ethRXDribleNibbles=ethRXDribleNibbles, atpcIndex=atpcIndex, safip=safip, ethRXTruncatedFrames=ethRXTruncatedFrames, modemE1T1ChannelMask=modemE1T1ChannelMask, sysTemperature=sysTemperature, modemE1T1Channels=modemE1T1Channels, ethTXBackpresEvents=ethTXBackpresEvents, e1t1LOS=e1t1LOS, modemCountTime=modemCountTime, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXPrevPktDropped=ethRXPrevPktDropped, modemBandwith=modemBandwith, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlanTable=vlanTable, modemGeneralStatus=modemGeneralStatus, radioSide=radioSide, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, loopbacks=loopbacks, sysDateAndTime=sysDateAndTime, ethRXDvEvent=ethRXDvEvent, atpcEnabled=atpcEnabled, e1t1ChannelNr=e1t1ChannelNr, modemTotalBlockNumber=modemTotalBlockNumber, description=description, e1t1StatTable=e1t1StatTable, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioTxMute=radioTxMute, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXExcessiveDefers=ethTXExcessiveDefers, ipRadioCfg=ipRadioCfg, ipRadioStatEth=ipRadioStatEth, licenseUpdateStatus=licenseUpdateStatus, radioRxFrequency=radioRxFrequency, writeConfig=writeConfig, ethTXPauseFrames=ethTXPauseFrames, modemEthernetCapacity=modemEthernetCapacity, ethGFPCHECErrors=ethGFPCHECErrors, ethRXLongEvents=ethRXLongEvents, modemBackgroundBlockErrror=modemBackgroundBlockErrror, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXCollisions=ethTXCollisions, vlanPortmap=vlanPortmap, vlanPortType=vlanPortType, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemSymbolRateTx=modemSymbolRateTx, ethQOSTXDropped=ethQOSTXDropped, ethRXBroadcasts=ethRXBroadcasts, vlansEnabled=vlansEnabled, ethTXByteCounterLow=ethTXByteCounterLow, modemModulation=modemModulation, saf=saf, e1t1StatEntry=e1t1StatEntry, radioEntry=radioEntry, loopback_tributary_mask=loopback_tributary_mask, ethRXByteCounterHi=ethRXByteCounterHi, ethRXControlFrames=ethRXControlFrames, ethTXDones=ethTXDones, modemSymbolRateRx=modemSymbolRateRx, modemRadialMSE=modemRadialMSE, ethGFPDropedFrames=ethGFPDropedFrames, ethTXVlanTags=ethTXVlanTags, ethTXBroadcasts=ethTXBroadcasts, modemACMmodulationMin=modemACMmodulationMin, modemEntry=modemEntry, modemInternalAGCgain=modemInternalAGCgain, ethRXUnsupOpcodes=ethRXUnsupOpcodes, hostname=hostname, ethRXMulticasts=ethRXMulticasts, localIpMask=localIpMask, radioTxPower=radioTxPower, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXCRCErrors=ethTXCRCErrors, ethTXLateCollisions=ethTXLateCollisions, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioTxFrequency=radioTxFrequency, ethTXMaxCollisions=ethTXMaxCollisions, e1t1AIS=e1t1AIS, modemACMengine=modemACMengine, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemStatistics=modemStatistics, vlanFid=vlanFid, modemACMethernetCapacity=modemACMethernetCapacity)
