...
mibBuilder.exportSymbols("SAF-IPRADIO", vlanTable=vlanTable, ethGFPCHECErrors=ethGFPCHECErrors, ipRadioCfg=ipRadioCfg, ethTXControlFrames=ethTXControlFrames, radioTable=radioTable, ethTXUnderruns=ethTXUnderruns, ethGFPFCSErrors=ethGFPFCSErrors, e1t1AIS=e1t1AIS, modemAcqStatus=modemAcqStatus, ethTXVlanTags=ethTXVlanTags, modemErroredSecond=modemErroredSecond, ethRXDribleNibbles=ethRXDribleNibbles, ethTXLateCollisions=ethTXLateCollisions, ethTXByteCounterLow=ethTXByteCounterLow, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, writeConfig=writeConfig, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemACMmodulationMin=modemACMmodulationMin, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, sysTemperature=sysTemperature, vlanEntry=vlanEntry, e1t1StatTable=e1t1StatTable, radioDuplexShift=radioDuplexShift, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioIndex=radioIndex, ethRXControlFrames=ethRXControlFrames, ethRXCRCErrors=ethRXCRCErrors, modemEntry=modemEntry, ethRXLongEvents=ethRXLongEvents, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemBandwith=modemBandwith, radioSide=radioSide, modemACMmodulationMax=modemACMmodulationMax, modemTable=modemTable, modemInternalAGCgain=modemInternalAGCgain, modemIndex=modemIndex, radioLoopback=radioLoopback, ethTXDones=ethTXDones, ipRadio=ipRadio, pointToPoint=pointToPoint, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXBackpresEvents=ethTXBackpresEvents, ethRXDvEvent=ethRXDvEvent, ipRadioMgmt=ipRadioMgmt, modemACMtotalCapacity=modemACMtotalCapacity, ethRXByteCounterHi=ethRXByteCounterHi, ethQOSTXDropped=ethQOSTXDropped, radioRxFrequency=radioRxFrequency, ipRadioCfgGeneral=ipRadioCfgGeneral, loopback_tributary_mask=loopback_tributary_mask, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXMulticasts=ethRXMulticasts, modemGeneralStatus=modemGeneralStatus, localIpMask=localIpMask, licenseUpdateStatus=licenseUpdateStatus, ethTXGiants=ethTXGiants, modemSymbolRateRx=modemSymbolRateRx, modemRadialMSE=modemRadialMSE, modemLDPCdecoderStress=modemLDPCdecoderStress, modemCarrierOffset=modemCarrierOffset, ethTXExcessiveDefers=ethTXExcessiveDefers, radioTxPower=radioTxPower, modemE1T1ChannelMask=modemE1T1ChannelMask, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemE1T1Channels=modemE1T1Channels, localIp=localIp, ethRXCodeErrors=ethRXCodeErrors, vlanPortType=vlanPortType, ipRadioCfgNetwork=ipRadioCfgNetwork, e1t1LOS=e1t1LOS, modemACMethernetCapacity=modemACMethernetCapacity, license=license, modemUptime=modemUptime, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, saf=saf, e1t1ChannelNr=e1t1ChannelNr, remoteIp=remoteIp, modemUnavailtime=modemUnavailtime, sysDateAndTime=sysDateAndTime, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethGFPDelineationErrors=ethGFPDelineationErrors, e1t1StatEntry=e1t1StatEntry, modemCountTime=modemCountTime, vlanRowStatus=vlanRowStatus, modemSymbolRateTx=modemSymbolRateTx, safip=safip, radioRxLevel=radioRxLevel, description=description, radioTxFrequency=radioTxFrequency, hostname=hostname, tehnika=tehnika, ethTXBroadcasts=ethTXBroadcasts, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXCRCErrors=ethTXCRCErrors, modemEthernetCapacity=modemEthernetCapacity, atpcIndex=atpcIndex, modemErroredBlock=modemErroredBlock, licenseMask=licenseMask, vlanNumber=vlanNumber, restartcpu=restartcpu, modemACMengine=modemACMengine, modemTotalCapacity=modemTotalCapacity, ethQOSTXFrames=ethQOSTXFrames, radioTxMute=radioTxMute, vlansEnabled=vlansEnabled, product=product, modemTotalBlockNumber=modemTotalBlockNumber, ethRXDones=ethRXDones, ethTXMulticasts=ethTXMulticasts, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ipRadioStatEth=ipRadioStatEth, radioGenStatus=radioGenStatus, vlanCfgStat=vlanCfgStat, modemLastAcqError=modemLastAcqError, ethRXPauseFrames=ethRXPauseFrames, ethRXBroadcasts=ethRXBroadcasts, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethGFPDropedFrames=ethGFPDropedFrames, ipRadioStat=ipRadioStat, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXByteCounterLow=ethRXByteCounterLow, radioEntry=radioEntry, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemStandard=modemStandard, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXCollisions=ethTXCollisions, atpcEnabled=atpcEnabled, aTPCEntry=aTPCEntry, loopbacks=loopbacks, ethRXPrevPktDropped=ethRXPrevPktDropped, atpcTxPowerCorrection=atpcTxPowerCorrection, modemStatistics=modemStatistics, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemErroredSecondRatio=modemErroredSecondRatio, vlanPortmap=vlanPortmap, microwaveRadio=microwaveRadio, vlanFid=vlanFid, ethTXMaxCollisions=ethTXMaxCollisions, aTPCTable=aTPCTable, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemRowStatus=modemRowStatus, modemModulation=modemModulation, ethTXByteCounterHi=ethTXByteCounterHi, ethTXPauseFrames=ethTXPauseFrames)
