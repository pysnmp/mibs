...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXVlanTagsDetected=ethRXVlanTagsDetected, vlanRowStatus=vlanRowStatus, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemModulation=modemModulation, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemACMengine=modemACMengine, hostname=hostname, atpcTxPowerCorrection=atpcTxPowerCorrection, ethGFPDelineationErrors=ethGFPDelineationErrors, aTPCTable=aTPCTable, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemRadialMSE=modemRadialMSE, restartcpu=restartcpu, radioRxLevel=radioRxLevel, safip=safip, ethRXByteCounterHi=ethRXByteCounterHi, ethTXMulticasts=ethTXMulticasts, radioTxMute=radioTxMute, ipRadioCfgNetwork=ipRadioCfgNetwork, vlanEntry=vlanEntry, product=product, ethTXCRCErrors=ethTXCRCErrors, ethRXControlFrames=ethRXControlFrames, ethTXCollisions=ethTXCollisions, vlanTable=vlanTable, modemErroredBlock=modemErroredBlock, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, vlanFid=vlanFid, ethRXPauseFrames=ethRXPauseFrames, ethGFPFCSErrors=ethGFPFCSErrors, ipRadio=ipRadio, ipRadioMgmt=ipRadioMgmt, modemACMmodulationMax=modemACMmodulationMax, ipRadioStatEth=ipRadioStatEth, saf=saf, modemGeneralStatus=modemGeneralStatus, modemErroredSecondRatio=modemErroredSecondRatio, ethTXBackpresEvents=ethTXBackpresEvents, ethRXDones=ethRXDones, ethRXCodeErrors=ethRXCodeErrors, modemE1T1Channels=modemE1T1Channels, modemUptime=modemUptime, modemErroredSecond=modemErroredSecond, modemBandwith=modemBandwith, ethQOSTXFrames=ethQOSTXFrames, modemSymbolRateTx=modemSymbolRateTx, radioTxFrequency=radioTxFrequency, ethTXBroadcasts=ethTXBroadcasts, ethRXDribleNibbles=ethRXDribleNibbles, ethTXPauseFrames=ethTXPauseFrames, ethTXGiants=ethTXGiants, modemStandard=modemStandard, modemLDPCdecoderStress=modemLDPCdecoderStress, radioDuplexShift=radioDuplexShift, ipRadioCfgGeneral=ipRadioCfgGeneral, atpcIndex=atpcIndex, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXDones=ethTXDones, modemCarrierOffset=modemCarrierOffset, modemRowStatus=modemRowStatus, ethGFPCHECErrors=ethGFPCHECErrors, description=description, microwaveRadio=microwaveRadio, remoteIp=remoteIp, e1t1AIS=e1t1AIS, ethRXMulticasts=ethRXMulticasts, modemSymbolRateRx=modemSymbolRateRx, license=license, modemCountTime=modemCountTime, ethTXVlanTags=ethTXVlanTags, localIp=localIp, ipRadioCfg=ipRadioCfg, ethTXByteCounterLow=ethTXByteCounterLow, modemAcqStatus=modemAcqStatus, radioGenStatus=radioGenStatus, radioLoopback=radioLoopback, ethRXByteCounterLow=ethRXByteCounterLow, sysDateAndTime=sysDateAndTime, radioRxFrequency=radioRxFrequency, modemStatistics=modemStatistics, modemTotalBlockNumber=modemTotalBlockNumber, writeConfig=writeConfig, modemTable=modemTable, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXLateCollisions=ethTXLateCollisions, ethRXCRCErrors=ethRXCRCErrors, modemACMethernetCapacity=modemACMethernetCapacity, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethQOSRXQ2Frames=ethQOSRXQ2Frames, loopbacks=loopbacks, sysTemperature=sysTemperature, ethTXControlFrames=ethTXControlFrames, modemUnavailtime=modemUnavailtime, ethQOSRXQ1Frames=ethQOSRXQ1Frames, localIpMask=localIpMask, vlanCfgStat=vlanCfgStat, radioEntry=radioEntry, modemTotalCapacity=modemTotalCapacity, e1t1LOS=e1t1LOS, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioSide=radioSide, radioTxPower=radioTxPower, vlanPortmap=vlanPortmap, licenseUpdateStatus=licenseUpdateStatus, modemACMmodulationMin=modemACMmodulationMin, ethRXPrevPktDropped=ethRXPrevPktDropped, radioIndex=radioIndex, modemACMtotalCapacity=modemACMtotalCapacity, ethRXBroadcasts=ethRXBroadcasts, ethTXWireByteCounterHi=ethTXWireByteCounterHi, licenseMask=licenseMask, ethGFPDropedFrames=ethGFPDropedFrames, e1t1ChannelNr=e1t1ChannelNr, modemIndex=modemIndex, ethRXDvEvent=ethRXDvEvent, ethRXTruncatedFrames=ethRXTruncatedFrames, ipRadioStat=ipRadioStat, pointToPoint=pointToPoint, ethTXMaxCollisions=ethTXMaxCollisions, tehnika=tehnika, modemLastAcqError=modemLastAcqError, vlanPortType=vlanPortType, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXLongEvents=ethRXLongEvents, e1t1StatEntry=e1t1StatEntry, modemInternalAGCgain=modemInternalAGCgain, loopback_tributary_mask=loopback_tributary_mask, atpcEnabled=atpcEnabled, vlanNumber=vlanNumber, radioTable=radioTable, e1t1StatTable=e1t1StatTable, ethTXByteCounterHi=ethTXByteCounterHi, modemEntry=modemEntry, ethTXUnderruns=ethTXUnderruns, aTPCEntry=aTPCEntry, ethTXExcessiveDefers=ethTXExcessiveDefers, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemE1T1ChannelMask=modemE1T1ChannelMask, ethQOSTXDropped=ethQOSTXDropped, vlansEnabled=vlansEnabled, modemEthernetCapacity=modemEthernetCapacity, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped)
