...
mibBuilder.exportSymbols("SAF-IPRADIO", ipRadioMgmt=ipRadioMgmt, remoteIp=remoteIp, modemE1T1Channels=modemE1T1Channels, modemErroredSecondRatio=modemErroredSecondRatio, ethTXControlFrames=ethTXControlFrames, radioSide=radioSide, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ipRadioCfgGeneral=ipRadioCfgGeneral, modemUptime=modemUptime, ethRXTruncatedFrames=ethRXTruncatedFrames, vlanCfgStat=vlanCfgStat, ethRXBroadcasts=ethRXBroadcasts, ethRXPauseFrames=ethRXPauseFrames, atpcEnabled=atpcEnabled, modemACMtotalCapacity=modemACMtotalCapacity, ethRXPrevPktDropped=ethRXPrevPktDropped, licenseUpdateStatus=licenseUpdateStatus, vlanEntry=vlanEntry, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemTotalBlockNumber=modemTotalBlockNumber, modemTable=modemTable, vlanNumber=vlanNumber, ethGFPFCSErrors=ethGFPFCSErrors, ethTXVlanTags=ethTXVlanTags, e1t1StatEntry=e1t1StatEntry, restartcpu=restartcpu, modemE1T1ChannelMask=modemE1T1ChannelMask, modemRadialMSE=modemRadialMSE, localIp=localIp, ethTXBroadcasts=ethTXBroadcasts, ethGFPDelineationErrors=ethGFPDelineationErrors, radioRxLevel=radioRxLevel, modemEthernetCapacity=modemEthernetCapacity, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioTxFrequency=radioTxFrequency, ethGFPDropedFrames=ethGFPDropedFrames, modemIndex=modemIndex, modemAcqStatus=modemAcqStatus, ipRadioStatEth=ipRadioStatEth, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXCollisions=ethTXCollisions, aTPCTable=aTPCTable, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXDvEvent=ethRXDvEvent, ethTXMaxCollisions=ethTXMaxCollisions, modemBandwith=modemBandwith, radioLoopback=radioLoopback, description=description, ipRadio=ipRadio, ipRadioCfgNetwork=ipRadioCfgNetwork, localIpMask=localIpMask, microwaveRadio=microwaveRadio, modemStandard=modemStandard, modemACMmodulationMin=modemACMmodulationMin, ethTXByteCounterHi=ethTXByteCounterHi, e1t1ChannelNr=e1t1ChannelNr, tehnika=tehnika, e1t1LOS=e1t1LOS, ethRXByteCounterHi=ethRXByteCounterHi, modemLDPCdecoderStress=modemLDPCdecoderStress, pointToPoint=pointToPoint, vlanTable=vlanTable, ethRXMulticasts=ethRXMulticasts, modemCarrierOffset=modemCarrierOffset, modemEntry=modemEntry, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioTxMute=radioTxMute, radioTxPower=radioTxPower, modemACMethernetCapacity=modemACMethernetCapacity, radioDuplexShift=radioDuplexShift, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioRxFrequency=radioRxFrequency, ethTXCRCErrors=ethTXCRCErrors, saf=saf, sysDateAndTime=sysDateAndTime, e1t1StatTable=e1t1StatTable, vlanPortType=vlanPortType, safip=safip, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ipRadioCfg=ipRadioCfg, ethTXExcessiveDefers=ethTXExcessiveDefers, radioEntry=radioEntry, vlanFid=vlanFid, ethQOSTXDropped=ethQOSTXDropped, modemSymbolRateTx=modemSymbolRateTx, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioIndex=radioIndex, ipRadioStat=ipRadioStat, loopbacks=loopbacks, ethRXDones=ethRXDones, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXByteCounterLow=ethRXByteCounterLow, ethTXDones=ethTXDones, ethQOSTXFrames=ethQOSTXFrames, hostname=hostname, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemACMengine=modemACMengine, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXByteCounterLow=ethTXByteCounterLow, vlanPortmap=vlanPortmap, ethTXLateCollisions=ethTXLateCollisions, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemCountTime=modemCountTime, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXCodeErrors=ethRXCodeErrors, ethTXBackpresEvents=ethTXBackpresEvents, modemGeneralStatus=modemGeneralStatus, ethTXUnderruns=ethTXUnderruns, ethTXMulticasts=ethTXMulticasts, ethGFPCHECErrors=ethGFPCHECErrors, ethRXControlFrames=ethRXControlFrames, aTPCEntry=aTPCEntry, atpcIndex=atpcIndex, modemRowStatus=modemRowStatus, modemErroredBlock=modemErroredBlock, license=license, modemErroredSecond=modemErroredSecond, radioTable=radioTable, licenseMask=licenseMask, ethTXGiants=ethTXGiants, vlanRowStatus=vlanRowStatus, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemACMmodulationMax=modemACMmodulationMax, modemModulation=modemModulation, modemStatistics=modemStatistics, modemLastAcqError=modemLastAcqError, modemSymbolRateRx=modemSymbolRateRx, sysTemperature=sysTemperature, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemTotalCapacity=modemTotalCapacity, modemUnavailtime=modemUnavailtime, radioGenStatus=radioGenStatus, writeConfig=writeConfig, ethRXLongEvents=ethRXLongEvents, modemInternalAGCgain=modemInternalAGCgain, ethTXPauseFrames=ethTXPauseFrames, vlansEnabled=vlansEnabled, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, loopback_tributary_mask=loopback_tributary_mask, ethRXDribleNibbles=ethRXDribleNibbles, ethRXCRCErrors=ethRXCRCErrors, e1t1AIS=e1t1AIS, product=product)
