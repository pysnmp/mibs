...
mibBuilder.exportSymbols("SAF-IPRADIO", modemEntry=modemEntry, ethQOSTXDropped=ethQOSTXDropped, vlansEnabled=vlansEnabled, localIpMask=localIpMask, ethTXCollisions=ethTXCollisions, remoteIp=remoteIp, modemStandard=modemStandard, ethRXByteCounterHi=ethRXByteCounterHi, loopbacks=loopbacks, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethGFPCHECErrors=ethGFPCHECErrors, ethRXDribleNibbles=ethRXDribleNibbles, ipRadioCfg=ipRadioCfg, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemACMengine=modemACMengine, hostname=hostname, licenseMask=licenseMask, ipRadio=ipRadio, ethRXDones=ethRXDones, radioTxFrequency=radioTxFrequency, vlanEntry=vlanEntry, e1t1StatTable=e1t1StatTable, modemErroredSecond=modemErroredSecond, ethGFPFCSErrors=ethGFPFCSErrors, modemLDPCdecoderStress=modemLDPCdecoderStress, ipRadioCfgGeneral=ipRadioCfgGeneral, tehnika=tehnika, ipRadioCfgNetwork=ipRadioCfgNetwork, vlanTable=vlanTable, modemACMethernetCapacity=modemACMethernetCapacity, vlanNumber=vlanNumber, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXByteCounterLow=ethTXByteCounterLow, ethTXMaxCollisions=ethTXMaxCollisions, saf=saf, writeConfig=writeConfig, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemTotalBlockNumber=modemTotalBlockNumber, vlanFid=vlanFid, ethRXControlFrames=ethRXControlFrames, modemTotalCapacity=modemTotalCapacity, modemSymbolRateTx=modemSymbolRateTx, modemLastAcqError=modemLastAcqError, ethTXGiants=ethTXGiants, ethQOSTXFrames=ethQOSTXFrames, loopback_tributary_mask=loopback_tributary_mask, modemE1T1Channels=modemE1T1Channels, atpcIndex=atpcIndex, vlanPortmap=vlanPortmap, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXLateCollisions=ethTXLateCollisions, ethTXDones=ethTXDones, ethTXCRCErrors=ethTXCRCErrors, atpcTxPowerCorrection=atpcTxPowerCorrection, modemIndex=modemIndex, sysDateAndTime=sysDateAndTime, radioIndex=radioIndex, modemTable=modemTable, ethTXByteCounterHi=ethTXByteCounterHi, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, license=license, e1t1LOS=e1t1LOS, modemInternalAGCgain=modemInternalAGCgain, modemACMtotalCapacity=modemACMtotalCapacity, ethTXMulticasts=ethTXMulticasts, ethTXExcessiveDefers=ethTXExcessiveDefers, description=description, pointToPoint=pointToPoint, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemStatistics=modemStatistics, radioTxMute=radioTxMute, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemBackgroundBlockErrror=modemBackgroundBlockErrror, microwaveRadio=microwaveRadio, modemCarrierOffset=modemCarrierOffset, ethRXCodeErrors=ethRXCodeErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, radioLoopback=radioLoopback, modemRadialMSE=modemRadialMSE, ethRXLongEvents=ethRXLongEvents, ethRXByteCounterLow=ethRXByteCounterLow, sysTemperature=sysTemperature, ethGFPDropedFrames=ethGFPDropedFrames, localIp=localIp, radioTxPower=radioTxPower, aTPCTable=aTPCTable, product=product, radioRxLevel=radioRxLevel, modemSymbolRateRx=modemSymbolRateRx, ethRXCRCErrors=ethRXCRCErrors, modemUnavailtime=modemUnavailtime, radioGenStatus=radioGenStatus, ethRXDvEvent=ethRXDvEvent, radioEntry=radioEntry, modemACMmodulationMax=modemACMmodulationMax, aTPCEntry=aTPCEntry, vlanRowStatus=vlanRowStatus, ethTXBroadcasts=ethTXBroadcasts, radioTable=radioTable, vlanPortType=vlanPortType, modemErroredBlock=modemErroredBlock, ethTXControlFrames=ethTXControlFrames, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXBroadcasts=ethRXBroadcasts, licenseUpdateStatus=licenseUpdateStatus, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXPrevPktDropped=ethRXPrevPktDropped, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemRowStatus=modemRowStatus, ethTXUnderruns=ethTXUnderruns, e1t1StatEntry=e1t1StatEntry, ethTXBackpresEvents=ethTXBackpresEvents, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemErroredSecondRatio=modemErroredSecondRatio, modemGeneralStatus=modemGeneralStatus, ethTXPauseFrames=ethTXPauseFrames, e1t1ChannelNr=e1t1ChannelNr, vlanCfgStat=vlanCfgStat, modemAcqStatus=modemAcqStatus, radioSide=radioSide, atpcEnabled=atpcEnabled, modemBandwith=modemBandwith, modemEthernetCapacity=modemEthernetCapacity, ethRXMulticasts=ethRXMulticasts, ipRadioMgmt=ipRadioMgmt, ipRadioStatEth=ipRadioStatEth, ethRXPauseFrames=ethRXPauseFrames, safip=safip, modemCountTime=modemCountTime, ethTXVlanTags=ethTXVlanTags, radioDuplexShift=radioDuplexShift, restartcpu=restartcpu, e1t1AIS=e1t1AIS, modemACMmodulationMin=modemACMmodulationMin, radioRxFrequency=radioRxFrequency, modemModulation=modemModulation, modemE1T1ChannelMask=modemE1T1ChannelMask, modemUptime=modemUptime, ipRadioStat=ipRadioStat)
