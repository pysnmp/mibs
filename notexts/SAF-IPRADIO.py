...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXGiants=ethTXGiants, license=license, ethRXMulticasts=ethRXMulticasts, modemInternalAGCgain=modemInternalAGCgain, modemUnavailtime=modemUnavailtime, ethTXByteCounterLow=ethTXByteCounterLow, sysTemperature=sysTemperature, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemErroredBlock=modemErroredBlock, modemTotalCapacity=modemTotalCapacity, ethQOSTXFrames=ethQOSTXFrames, tehnika=tehnika, ethRXLongEvents=ethRXLongEvents, radioLoopback=radioLoopback, ethRXTruncatedFrames=ethRXTruncatedFrames, modemLastAcqError=modemLastAcqError, ethRXPrevPktDropped=ethRXPrevPktDropped, modemEntry=modemEntry, modemSymbolRateTx=modemSymbolRateTx, ethTXDones=ethTXDones, loopbacks=loopbacks, ethTXBackpresEvents=ethTXBackpresEvents, e1t1AIS=e1t1AIS, modemRowStatus=modemRowStatus, vlanFid=vlanFid, vlanPortmap=vlanPortmap, localIp=localIp, modemStandard=modemStandard, licenseMask=licenseMask, ethTXCollisions=ethTXCollisions, aTPCEntry=aTPCEntry, ipRadioCfgNetwork=ipRadioCfgNetwork, vlanEntry=vlanEntry, ethTXCRCErrors=ethTXCRCErrors, product=product, modemCarrierOffset=modemCarrierOffset, ethTXByteCounterHi=ethTXByteCounterHi, modemACMmodulationMin=modemACMmodulationMin, ipRadioStat=ipRadioStat, radioRxFrequency=radioRxFrequency, modemTotalBlockNumber=modemTotalBlockNumber, e1t1StatTable=e1t1StatTable, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, atpcIndex=atpcIndex, modemACMengine=modemACMengine, ethRXByteCounterLow=ethRXByteCounterLow, ethGFPFCSErrors=ethGFPFCSErrors, ethRXBroadcasts=ethRXBroadcasts, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioDuplexShift=radioDuplexShift, modemACMmodulationMax=modemACMmodulationMax, ethTXLengthCheckErrors=ethTXLengthCheckErrors, vlanPortType=vlanPortType, ethQOSTXDropped=ethQOSTXDropped, modemGeneralStatus=modemGeneralStatus, modemUptime=modemUptime, microwaveRadio=microwaveRadio, modemIndex=modemIndex, ethTXControlFrames=ethTXControlFrames, description=description, ethTXPauseFrames=ethTXPauseFrames, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioSide=radioSide, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXDones=ethRXDones, e1t1ChannelNr=e1t1ChannelNr, vlanCfgStat=vlanCfgStat, modemErroredSecondRatio=modemErroredSecondRatio, ethRXUnsupOpcodes=ethRXUnsupOpcodes, remoteIp=remoteIp, modemModulation=modemModulation, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemAcqStatus=modemAcqStatus, atpcTxPowerCorrection=atpcTxPowerCorrection, modemE1T1Channels=modemE1T1Channels, radioEntry=radioEntry, modemSymbolRateRx=modemSymbolRateRx, vlansEnabled=vlansEnabled, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, restartcpu=restartcpu, vlanTable=vlanTable, radioTxFrequency=radioTxFrequency, modemRadialMSE=modemRadialMSE, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXBroadcasts=ethTXBroadcasts, atpcEnabled=atpcEnabled, pointToPoint=pointToPoint, aTPCTable=aTPCTable, ethRXCodeErrors=ethRXCodeErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXUnderruns=ethTXUnderruns, ethRXDvEvent=ethRXDvEvent, hostname=hostname, radioTable=radioTable, radioTxMute=radioTxMute, radioRxLevel=radioRxLevel, modemEthernetCapacity=modemEthernetCapacity, safip=safip, ipRadioCfg=ipRadioCfg, ipRadioStatEth=ipRadioStatEth, ethRXControlFrames=ethRXControlFrames, localIpMask=localIpMask, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, e1t1StatEntry=e1t1StatEntry, ethRXDribleNibbles=ethRXDribleNibbles, ethRXCRCErrors=ethRXCRCErrors, vlanNumber=vlanNumber, ethTXVlanTags=ethTXVlanTags, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemErroredSecond=modemErroredSecond, radioGenStatus=radioGenStatus, ipRadioMgmt=ipRadioMgmt, e1t1LOS=e1t1LOS, saf=saf, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, sysDateAndTime=sysDateAndTime, licenseUpdateStatus=licenseUpdateStatus, modemE1T1ChannelMask=modemE1T1ChannelMask, radioIndex=radioIndex, ethGFPDropedFrames=ethGFPDropedFrames, loopback_tributary_mask=loopback_tributary_mask, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioTxPower=radioTxPower, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXByteCounterHi=ethRXByteCounterHi, ethRXPauseFrames=ethRXPauseFrames, modemACMtotalCapacity=modemACMtotalCapacity, ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadio=ipRadio, ethTXExcessiveDefers=ethTXExcessiveDefers, modemACMethernetCapacity=modemACMethernetCapacity, modemStatistics=modemStatistics, ethTXMulticasts=ethTXMulticasts, vlanRowStatus=vlanRowStatus, ethTXMaxCollisions=ethTXMaxCollisions, ethGFPCHECErrors=ethGFPCHECErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemTable=modemTable, modemBandwith=modemBandwith, ipRadioCfgGeneral=ipRadioCfgGeneral, modemCountTime=modemCountTime, ethTXLateCollisions=ethTXLateCollisions, writeConfig=writeConfig)
