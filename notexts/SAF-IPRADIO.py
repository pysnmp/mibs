...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXPrevPktDropped=ethRXPrevPktDropped, license=license, e1t1StatTable=e1t1StatTable, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXUnderruns=ethTXUnderruns, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXPauseFrames=ethTXPauseFrames, modemSymbolRateRx=modemSymbolRateRx, ethTXVlanTags=ethTXVlanTags, ethRXByteCounterHi=ethRXByteCounterHi, ethTXMulticasts=ethTXMulticasts, radioRxFrequency=radioRxFrequency, modemModulation=modemModulation, aTPCTable=aTPCTable, radioTxPower=radioTxPower, radioIndex=radioIndex, hostname=hostname, ipRadioStat=ipRadioStat, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemLastAcqError=modemLastAcqError, modemStatistics=modemStatistics, e1t1StatEntry=e1t1StatEntry, tehnika=tehnika, ethRXCodeErrors=ethRXCodeErrors, ethTXByteCounterLow=ethTXByteCounterLow, radioEntry=radioEntry, ethRXTruncatedFrames=ethRXTruncatedFrames, modemErroredSecondRatio=modemErroredSecondRatio, e1t1LOS=e1t1LOS, atpcEnabled=atpcEnabled, ethTXBackpresEvents=ethTXBackpresEvents, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXCRCErrors=ethRXCRCErrors, licenseUpdateStatus=licenseUpdateStatus, modemUptime=modemUptime, radioGenStatus=radioGenStatus, ethTXBroadcasts=ethTXBroadcasts, ethTXExcessiveDefers=ethTXExcessiveDefers, radioSide=radioSide, ethTXWireByteCounterHi=ethTXWireByteCounterHi, remoteIp=remoteIp, restartcpu=restartcpu, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemACMmodulationMax=modemACMmodulationMax, modemAcqStatus=modemAcqStatus, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethQOSTXDropped=ethQOSTXDropped, modemRadialMSE=modemRadialMSE, ipRadioCfg=ipRadioCfg, ethGFPCHECErrors=ethGFPCHECErrors, radioDuplexShift=radioDuplexShift, modemEthernetCapacity=modemEthernetCapacity, licenseMask=licenseMask, radioTxFrequency=radioTxFrequency, vlansEnabled=vlansEnabled, modemErroredBlock=modemErroredBlock, ethTXDones=ethTXDones, modemACMengine=modemACMengine, ethRXDribleNibbles=ethRXDribleNibbles, vlanRowStatus=vlanRowStatus, loopbacks=loopbacks, modemGeneralStatus=modemGeneralStatus, ipRadioMgmt=ipRadioMgmt, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemTotalBlockNumber=modemTotalBlockNumber, vlanTable=vlanTable, modemSeverelyErroredSecond=modemSeverelyErroredSecond, writeConfig=writeConfig, ethRXByteCounterLow=ethRXByteCounterLow, modemSymbolRateTx=modemSymbolRateTx, ethTXCRCErrors=ethTXCRCErrors, microwaveRadio=microwaveRadio, modemE1T1ChannelMask=modemE1T1ChannelMask, modemRowStatus=modemRowStatus, product=product, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, safip=safip, ethQOSTXFrames=ethQOSTXFrames, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXLongEvents=ethRXLongEvents, ethRXDvEvent=ethRXDvEvent, ipRadioStatEth=ipRadioStatEth, modemTotalCapacity=modemTotalCapacity, e1t1AIS=e1t1AIS, ethRXDones=ethRXDones, ethTXLateCollisions=ethTXLateCollisions, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioRxLevel=radioRxLevel, ethTXLengthCheckErrors=ethTXLengthCheckErrors, saf=saf, ethRXBroadcasts=ethRXBroadcasts, radioTable=radioTable, modemCountTime=modemCountTime, ethRXControlFrames=ethRXControlFrames, vlanPortType=vlanPortType, ethTXControlFrames=ethTXControlFrames, modemACMethernetCapacity=modemACMethernetCapacity, radioLoopback=radioLoopback, sysTemperature=sysTemperature, modemBandwith=modemBandwith, ipRadioCfgGeneral=ipRadioCfgGeneral, modemCarrierOffset=modemCarrierOffset, ipRadio=ipRadio, ethRXVlanTagsDetected=ethRXVlanTagsDetected, localIp=localIp, ethRXPauseFrames=ethRXPauseFrames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXCollisions=ethTXCollisions, loopback_tributary_mask=loopback_tributary_mask, ethGFPDelineationErrors=ethGFPDelineationErrors, ethGFPFCSErrors=ethGFPFCSErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXByteCounterHi=ethTXByteCounterHi, ethTXMaxCollisions=ethTXMaxCollisions, modemACMtotalCapacity=modemACMtotalCapacity, vlanPortmap=vlanPortmap, modemIndex=modemIndex, atpcIndex=atpcIndex, modemLDPCdecoderStress=modemLDPCdecoderStress, modemErroredSecond=modemErroredSecond, modemE1T1Channels=modemE1T1Channels, ethRXMulticasts=ethRXMulticasts, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemEntry=modemEntry, vlanFid=vlanFid, description=description, aTPCEntry=aTPCEntry, modemInternalAGCgain=modemInternalAGCgain, modemUnavailtime=modemUnavailtime, pointToPoint=pointToPoint, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlanEntry=vlanEntry, ethGFPDropedFrames=ethGFPDropedFrames, modemACMmodulationMin=modemACMmodulationMin, radioTxMute=radioTxMute, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXGiants=ethTXGiants, e1t1ChannelNr=e1t1ChannelNr, sysDateAndTime=sysDateAndTime, modemStandard=modemStandard, localIpMask=localIpMask, vlanCfgStat=vlanCfgStat, vlanNumber=vlanNumber, modemTable=modemTable)
