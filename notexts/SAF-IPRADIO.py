...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXTruncatedFrames=ethRXTruncatedFrames, description=description, localIp=localIp, ethTXExcessiveDefers=ethTXExcessiveDefers, ipRadioStat=ipRadioStat, ipRadioCfgGeneral=ipRadioCfgGeneral, radioLoopback=radioLoopback, ethTXWireByteCounterHi=ethTXWireByteCounterHi, e1t1LOS=e1t1LOS, ethTXMulticasts=ethTXMulticasts, licenseMask=licenseMask, modemTotalBlockNumber=modemTotalBlockNumber, license=license, ethRXPrevPktDropped=ethRXPrevPktDropped, modemStatistics=modemStatistics, ethGFPDropedFrames=ethGFPDropedFrames, aTPCEntry=aTPCEntry, aTPCTable=aTPCTable, microwaveRadio=microwaveRadio, modemACMengine=modemACMengine, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, loopbacks=loopbacks, ethTXCRCErrors=ethTXCRCErrors, atpcEnabled=atpcEnabled, vlanTable=vlanTable, writeConfig=writeConfig, vlanPortmap=vlanPortmap, modemEntry=modemEntry, ethTXPauseFrames=ethTXPauseFrames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ipRadioCfg=ipRadioCfg, pointToPoint=pointToPoint, radioRxLevel=radioRxLevel, modemCarrierOffset=modemCarrierOffset, product=product, vlanNumber=vlanNumber, e1t1ChannelNr=e1t1ChannelNr, modemUptime=modemUptime, ipRadio=ipRadio, ethTXControlFrames=ethTXControlFrames, modemStandard=modemStandard, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioTxMute=radioTxMute, ethQOSTXFrames=ethQOSTXFrames, modemACMmodulationMin=modemACMmodulationMin, modemUnavailtime=modemUnavailtime, ethTXLateCollisions=ethTXLateCollisions, modemRowStatus=modemRowStatus, ethRXPauseFrames=ethRXPauseFrames, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXMaxCollisions=ethTXMaxCollisions, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXByteCounterHi=ethRXByteCounterHi, atpcTxPowerCorrection=atpcTxPowerCorrection, localIpMask=localIpMask, ethQOSRXQ2Frames=ethQOSRXQ2Frames, loopback_tributary_mask=loopback_tributary_mask, modemLDPCdecoderStress=modemLDPCdecoderStress, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioTable=radioTable, vlansEnabled=vlansEnabled, ethTXCollisions=ethTXCollisions, sysTemperature=sysTemperature, e1t1StatTable=e1t1StatTable, remoteIp=remoteIp, radioSide=radioSide, atpcIndex=atpcIndex, modemBandwith=modemBandwith, vlanPortType=vlanPortType, ethRXDones=ethRXDones, ipRadioMgmt=ipRadioMgmt, saf=saf, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioGenStatus=radioGenStatus, modemSymbolRateTx=modemSymbolRateTx, vlanEntry=vlanEntry, ethRXByteCounterLow=ethRXByteCounterLow, modemLastAcqError=modemLastAcqError, vlanFid=vlanFid, ethRXVlanTagsDetected=ethRXVlanTagsDetected, restartcpu=restartcpu, modemRadialMSE=modemRadialMSE, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioTxFrequency=radioTxFrequency, ethTXBroadcasts=ethTXBroadcasts, ethGFPCHECErrors=ethGFPCHECErrors, modemTotalCapacity=modemTotalCapacity, tehnika=tehnika, radioIndex=radioIndex, ethTXDones=ethTXDones, radioTxPower=radioTxPower, ethRXUnsupOpcodes=ethRXUnsupOpcodes, vlanCfgStat=vlanCfgStat, modemACMmodulationMax=modemACMmodulationMax, modemACMtotalCapacity=modemACMtotalCapacity, ethRXLongEvents=ethRXLongEvents, ethTXUnderruns=ethTXUnderruns, modemACMethernetCapacity=modemACMethernetCapacity, modemErroredSecondRatio=modemErroredSecondRatio, radioDuplexShift=radioDuplexShift, radioEntry=radioEntry, vlanRowStatus=vlanRowStatus, modemE1T1Channels=modemE1T1Channels, licenseUpdateStatus=licenseUpdateStatus, modemGeneralStatus=modemGeneralStatus, ethQOSTXDropped=ethQOSTXDropped, modemInternalAGCgain=modemInternalAGCgain, modemErroredSecond=modemErroredSecond, ethTXByteCounterHi=ethTXByteCounterHi, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemE1T1ChannelMask=modemE1T1ChannelMask, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemIndex=modemIndex, safip=safip, modemErroredBlock=modemErroredBlock, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXBackpresEvents=ethTXBackpresEvents, e1t1StatEntry=e1t1StatEntry, ethGFPFCSErrors=ethGFPFCSErrors, modemModulation=modemModulation, ethRXCRCErrors=ethRXCRCErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXDribleNibbles=ethRXDribleNibbles, modemTable=modemTable, hostname=hostname, ethRXBroadcasts=ethRXBroadcasts, modemEthernetCapacity=modemEthernetCapacity, ethTXByteCounterLow=ethTXByteCounterLow, e1t1AIS=e1t1AIS, ethRXCodeErrors=ethRXCodeErrors, ethRXDvEvent=ethRXDvEvent, modemSymbolRateRx=modemSymbolRateRx, ethRXControlFrames=ethRXControlFrames, ethTXVlanTags=ethTXVlanTags, modemCountTime=modemCountTime, sysDateAndTime=sysDateAndTime, ethRXMulticasts=ethRXMulticasts, ipRadioStatEth=ipRadioStatEth, ethTXGiants=ethTXGiants, modemAcqStatus=modemAcqStatus, radioRxFrequency=radioRxFrequency)
