...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXMaxCollisions=ethTXMaxCollisions, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ipRadioStatEth=ipRadioStatEth, modemTable=modemTable, vlanRowStatus=vlanRowStatus, ethGFPFCSErrors=ethGFPFCSErrors, ethGFPDropedFrames=ethGFPDropedFrames, radioLoopback=radioLoopback, radioDuplexShift=radioDuplexShift, radioTxPower=radioTxPower, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, atpcTxPowerCorrection=atpcTxPowerCorrection, sysDateAndTime=sysDateAndTime, modemAcqStatus=modemAcqStatus, ethTXLateCollisions=ethTXLateCollisions, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemErroredSecondRatio=modemErroredSecondRatio, ipRadio=ipRadio, modemTotalCapacity=modemTotalCapacity, ethTXControlFrames=ethTXControlFrames, modemIndex=modemIndex, ethTXCRCErrors=ethTXCRCErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, product=product, vlanNumber=vlanNumber, radioIndex=radioIndex, ethRXBroadcasts=ethRXBroadcasts, atpcIndex=atpcIndex, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXByteCounterLow=ethTXByteCounterLow, modemModulation=modemModulation, saf=saf, vlanFid=vlanFid, ipRadioMgmt=ipRadioMgmt, safip=safip, radioTxFrequency=radioTxFrequency, ethRXLongEvents=ethRXLongEvents, radioRxLevel=radioRxLevel, ethTXByteCounterHi=ethTXByteCounterHi, radioEntry=radioEntry, modemACMethernetCapacity=modemACMethernetCapacity, modemErroredSecond=modemErroredSecond, modemTotalBlockNumber=modemTotalBlockNumber, vlanPortType=vlanPortType, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioRxFrequency=radioRxFrequency, tehnika=tehnika, e1t1StatEntry=e1t1StatEntry, licenseUpdateStatus=licenseUpdateStatus, ethTXExcessiveDefers=ethTXExcessiveDefers, modemSymbolRateTx=modemSymbolRateTx, ethRXDones=ethRXDones, ethRXPauseFrames=ethRXPauseFrames, e1t1LOS=e1t1LOS, radioTable=radioTable, restartcpu=restartcpu, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXTruncatedFrames=ethRXTruncatedFrames, atpcEnabled=atpcEnabled, ethTXVlanTags=ethTXVlanTags, modemInternalAGCgain=modemInternalAGCgain, ethRXVlanTagsDetected=ethRXVlanTagsDetected, vlanEntry=vlanEntry, hostname=hostname, ethTXBackpresEvents=ethTXBackpresEvents, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemACMmodulationMin=modemACMmodulationMin, vlanPortmap=vlanPortmap, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadioCfg=ipRadioCfg, ethTXBroadcasts=ethTXBroadcasts, ethTXCollisions=ethTXCollisions, modemACMengine=modemACMengine, ethTXDones=ethTXDones, ethRXDribleNibbles=ethRXDribleNibbles, modemGeneralStatus=modemGeneralStatus, modemRadialMSE=modemRadialMSE, vlanTable=vlanTable, aTPCTable=aTPCTable, ethTXPauseFrames=ethTXPauseFrames, remoteIp=remoteIp, modemCountTime=modemCountTime, radioGenStatus=radioGenStatus, modemSymbolRateRx=modemSymbolRateRx, modemACMtotalCapacity=modemACMtotalCapacity, vlansEnabled=vlansEnabled, ethRXCRCErrors=ethRXCRCErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, description=description, modemE1T1Channels=modemE1T1Channels, modemEthernetCapacity=modemEthernetCapacity, modemErroredBlock=modemErroredBlock, ethRXControlFrames=ethRXControlFrames, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, microwaveRadio=microwaveRadio, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXMulticasts=ethTXMulticasts, ethTXGiants=ethTXGiants, modemLastAcqError=modemLastAcqError, modemACMmodulationMax=modemACMmodulationMax, radioTxMute=radioTxMute, e1t1AIS=e1t1AIS, ethRXByteCounterLow=ethRXByteCounterLow, localIpMask=localIpMask, modemEntry=modemEntry, ethQOSTXFrames=ethQOSTXFrames, modemCarrierOffset=modemCarrierOffset, loopback_tributary_mask=loopback_tributary_mask, aTPCEntry=aTPCEntry, ethGFPCHECErrors=ethGFPCHECErrors, license=license, ethRXCodeErrors=ethRXCodeErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, sysTemperature=sysTemperature, ipRadioCfgNetwork=ipRadioCfgNetwork, pointToPoint=pointToPoint, ethTXUnderruns=ethTXUnderruns, modemLDPCdecoderStress=modemLDPCdecoderStress, e1t1ChannelNr=e1t1ChannelNr, modemStandard=modemStandard, modemUptime=modemUptime, ipRadioStat=ipRadioStat, modemBandwith=modemBandwith, vlanCfgStat=vlanCfgStat, modemRowStatus=modemRowStatus, loopbacks=loopbacks, radioSide=radioSide, modemUnavailtime=modemUnavailtime, ethQOSTXDropped=ethQOSTXDropped, ethRXDvEvent=ethRXDvEvent, e1t1StatTable=e1t1StatTable, writeConfig=writeConfig, licenseMask=licenseMask, ethRXByteCounterHi=ethRXByteCounterHi, ethRXMulticasts=ethRXMulticasts, modemStatistics=modemStatistics, localIp=localIp)
