...
mibBuilder.exportSymbols("SAF-IPRADIO", ipRadio=ipRadio, localIp=localIp, modemCarrierOffset=modemCarrierOffset, radioLoopback=radioLoopback, ethTXPauseFrames=ethTXPauseFrames, ethTXByteCounterLow=ethTXByteCounterLow, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemErroredSecondRatio=modemErroredSecondRatio, ethTXLateCollisions=ethTXLateCollisions, ethTXCollisions=ethTXCollisions, radioTxMute=radioTxMute, radioSide=radioSide, e1t1LOS=e1t1LOS, ethTXByteCounterHi=ethTXByteCounterHi, ethRXLongEvents=ethRXLongEvents, modemAcqStatus=modemAcqStatus, ethTXBackpresEvents=ethTXBackpresEvents, modemACMmodulationMax=modemACMmodulationMax, ethRXCodeErrors=ethRXCodeErrors, modemRadialMSE=modemRadialMSE, ethTXMulticasts=ethTXMulticasts, modemACMethernetCapacity=modemACMethernetCapacity, e1t1StatTable=e1t1StatTable, modemEntry=modemEntry, vlanTable=vlanTable, ethRXMulticasts=ethRXMulticasts, radioRxFrequency=radioRxFrequency, modemUptime=modemUptime, writeConfig=writeConfig, ipRadioMgmt=ipRadioMgmt, modemBandwith=modemBandwith, vlansEnabled=vlansEnabled, ethRXDribleNibbles=ethRXDribleNibbles, radioTable=radioTable, modemModulation=modemModulation, ipRadioStat=ipRadioStat, license=license, ipRadioStatEth=ipRadioStatEth, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXGiants=ethTXGiants, atpcTxPowerCorrection=atpcTxPowerCorrection, modemEthernetCapacity=modemEthernetCapacity, modemBackgroundBlockErrror=modemBackgroundBlockErrror, atpcIndex=atpcIndex, loopbacks=loopbacks, ipRadioCfgNetwork=ipRadioCfgNetwork, vlanEntry=vlanEntry, radioGenStatus=radioGenStatus, vlanPortmap=vlanPortmap, ethTXControlFrames=ethTXControlFrames, radioDuplexShift=radioDuplexShift, radioRxLevel=radioRxLevel, modemRowStatus=modemRowStatus, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, vlanNumber=vlanNumber, ethRXDvEvent=ethRXDvEvent, modemCountTime=modemCountTime, ethGFPFCSErrors=ethGFPFCSErrors, modemTotalCapacity=modemTotalCapacity, vlanRowStatus=vlanRowStatus, product=product, vlanPortType=vlanPortType, modemTotalBlockNumber=modemTotalBlockNumber, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ipRadioCfg=ipRadioCfg, modemStandard=modemStandard, ethRXByteCounterLow=ethRXByteCounterLow, ethTXDones=ethTXDones, ethQOSTXDropped=ethQOSTXDropped, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemErroredSecond=modemErroredSecond, ethRXBroadcasts=ethRXBroadcasts, modemE1T1Channels=modemE1T1Channels, pointToPoint=pointToPoint, modemLastAcqError=modemLastAcqError, sysDateAndTime=sysDateAndTime, modemGeneralStatus=modemGeneralStatus, safip=safip, ethRXPrevPktDropped=ethRXPrevPktDropped, localIpMask=localIpMask, modemLDPCdecoderStress=modemLDPCdecoderStress, loopback_tributary_mask=loopback_tributary_mask, remoteIp=remoteIp, modemIndex=modemIndex, licenseMask=licenseMask, modemTable=modemTable, ethTXBroadcasts=ethTXBroadcasts, aTPCEntry=aTPCEntry, radioTxPower=radioTxPower, vlanCfgStat=vlanCfgStat, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXPauseFrames=ethRXPauseFrames, modemACMtotalCapacity=modemACMtotalCapacity, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXUnderruns=ethTXUnderruns, ethRXUnsupOpcodes=ethRXUnsupOpcodes, atpcEnabled=atpcEnabled, ethRXDones=ethRXDones, modemUnavailtime=modemUnavailtime, restartcpu=restartcpu, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, sysTemperature=sysTemperature, ethTXVlanTags=ethTXVlanTags, modemInternalAGCgain=modemInternalAGCgain, modemStatistics=modemStatistics, ethQOSTXFrames=ethQOSTXFrames, modemSymbolRateTx=modemSymbolRateTx, modemSymbolRateRx=modemSymbolRateRx, radioIndex=radioIndex, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXCRCErrors=ethRXCRCErrors, modemACMmodulationMin=modemACMmodulationMin, ethRXTruncatedFrames=ethRXTruncatedFrames, description=description, ethGFPDropedFrames=ethGFPDropedFrames, modemE1T1ChannelMask=modemE1T1ChannelMask, e1t1AIS=e1t1AIS, radioTxFrequency=radioTxFrequency, ethTXMaxCollisions=ethTXMaxCollisions, ethGFPCHECErrors=ethGFPCHECErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, tehnika=tehnika, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXByteCounterHi=ethRXByteCounterHi, hostname=hostname, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemACMengine=modemACMengine, microwaveRadio=microwaveRadio, vlanFid=vlanFid, modemErroredBlock=modemErroredBlock, e1t1ChannelNr=e1t1ChannelNr, e1t1StatEntry=e1t1StatEntry, aTPCTable=aTPCTable, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioEntry=radioEntry, licenseUpdateStatus=licenseUpdateStatus, saf=saf, ethTXCRCErrors=ethTXCRCErrors, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXControlFrames=ethRXControlFrames, ethTXExcessiveDefers=ethTXExcessiveDefers)
