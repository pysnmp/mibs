...
mibBuilder.exportSymbols("SAF-IPRADIO", radioTxMute=radioTxMute, restartcpu=restartcpu, modemLastAcqError=modemLastAcqError, vlanRowStatus=vlanRowStatus, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, pointToPoint=pointToPoint, tehnika=tehnika, modemStatistics=modemStatistics, radioIndex=radioIndex, loopback_tributary_mask=loopback_tributary_mask, ethTXBackpresEvents=ethTXBackpresEvents, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemAcqStatus=modemAcqStatus, ethRXCodeErrors=ethRXCodeErrors, safip=safip, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioRxFrequency=radioRxFrequency, ethTXControlFrames=ethTXControlFrames, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemSymbolRateRx=modemSymbolRateRx, ethTXVlanTags=ethTXVlanTags, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemLDPCdecoderStress=modemLDPCdecoderStress, modemErroredSecond=modemErroredSecond, modemEthernetCapacity=modemEthernetCapacity, ethTXCollisions=ethTXCollisions, modemCarrierOffset=modemCarrierOffset, ethRXDones=ethRXDones, ethRXPrevPktDropped=ethRXPrevPktDropped, ethQOSTXDropped=ethQOSTXDropped, e1t1LOS=e1t1LOS, license=license, ethTXUnderruns=ethTXUnderruns, ethTXBroadcasts=ethTXBroadcasts, sysTemperature=sysTemperature, ethRXByteCounterHi=ethRXByteCounterHi, ethTXGiants=ethTXGiants, ethRXBroadcasts=ethRXBroadcasts, ethRXByteCounterLow=ethRXByteCounterLow, ethRXLongEvents=ethRXLongEvents, ipRadioStat=ipRadioStat, ipRadioCfgNetwork=ipRadioCfgNetwork, radioSide=radioSide, modemE1T1ChannelMask=modemE1T1ChannelMask, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlanFid=vlanFid, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemCountTime=modemCountTime, modemTable=modemTable, ipRadioCfg=ipRadioCfg, remoteIp=remoteIp, modemBandwith=modemBandwith, modemUptime=modemUptime, modemRowStatus=modemRowStatus, modemInternalAGCgain=modemInternalAGCgain, vlanNumber=vlanNumber, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXTruncatedFrames=ethRXTruncatedFrames, modemACMtotalCapacity=modemACMtotalCapacity, ethQOSTXFrames=ethQOSTXFrames, ethTXExcessiveDefers=ethTXExcessiveDefers, licenseMask=licenseMask, radioGenStatus=radioGenStatus, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXDones=ethTXDones, sysDateAndTime=sysDateAndTime, ethTXMulticasts=ethTXMulticasts, loopbacks=loopbacks, modemErroredBlock=modemErroredBlock, modemSymbolRateTx=modemSymbolRateTx, ethRXPauseFrames=ethRXPauseFrames, ethRXMulticasts=ethRXMulticasts, aTPCTable=aTPCTable, modemACMengine=modemACMengine, e1t1AIS=e1t1AIS, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, vlanTable=vlanTable, e1t1ChannelNr=e1t1ChannelNr, modemACMmodulationMax=modemACMmodulationMax, ethGFPFCSErrors=ethGFPFCSErrors, ethTXMaxCollisions=ethTXMaxCollisions, ethGFPDelineationErrors=ethGFPDelineationErrors, vlanEntry=vlanEntry, microwaveRadio=microwaveRadio, modemACMmodulationMin=modemACMmodulationMin, ipRadioMgmt=ipRadioMgmt, licenseUpdateStatus=licenseUpdateStatus, ethRXControlFrames=ethRXControlFrames, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethGFPCHECErrors=ethGFPCHECErrors, vlanPortmap=vlanPortmap, modemModulation=modemModulation, vlansEnabled=vlansEnabled, ethTXLateCollisions=ethTXLateCollisions, radioEntry=radioEntry, product=product, ipRadio=ipRadio, radioTxFrequency=radioTxFrequency, radioDuplexShift=radioDuplexShift, modemUnavailtime=modemUnavailtime, ethTXCRCErrors=ethTXCRCErrors, modemGeneralStatus=modemGeneralStatus, radioRxLevel=radioRxLevel, ipRadioCfgGeneral=ipRadioCfgGeneral, ethGFPDropedFrames=ethGFPDropedFrames, saf=saf, modemIndex=modemIndex, vlanPortType=vlanPortType, radioTxPower=radioTxPower, radioTable=radioTable, ethTXWireByteCounterHi=ethTXWireByteCounterHi, atpcEnabled=atpcEnabled, localIpMask=localIpMask, writeConfig=writeConfig, modemTotalCapacity=modemTotalCapacity, aTPCEntry=aTPCEntry, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, atpcIndex=atpcIndex, ethRXDvEvent=ethRXDvEvent, modemTotalBlockNumber=modemTotalBlockNumber, hostname=hostname, ethTXPauseFrames=ethTXPauseFrames, modemEntry=modemEntry, modemRadialMSE=modemRadialMSE, e1t1StatTable=e1t1StatTable, modemE1T1Channels=modemE1T1Channels, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, description=description, modemStandard=modemStandard, radioLoopback=radioLoopback, e1t1StatEntry=e1t1StatEntry, localIp=localIp, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXByteCounterLow=ethTXByteCounterLow, modemACMethernetCapacity=modemACMethernetCapacity, vlanCfgStat=vlanCfgStat, ethRXDribleNibbles=ethRXDribleNibbles, ethRXCRCErrors=ethRXCRCErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadioStatEth=ipRadioStatEth, modemErroredSecondRatio=modemErroredSecondRatio, ethTXByteCounterHi=ethTXByteCounterHi)
