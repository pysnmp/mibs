...
mibBuilder.exportSymbols("SAF-IPRADIO", modemE1T1ChannelMask=modemE1T1ChannelMask, vlanEntry=vlanEntry, license=license, ethQOSTXFrames=ethQOSTXFrames, ethRXPauseFrames=ethRXPauseFrames, radioRxFrequency=radioRxFrequency, radioTable=radioTable, licenseMask=licenseMask, modemTotalCapacity=modemTotalCapacity, ethRXControlFrames=ethRXControlFrames, ethTXGiants=ethTXGiants, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioTxFrequency=radioTxFrequency, saf=saf, ethTXVlanTags=ethTXVlanTags, e1t1StatEntry=e1t1StatEntry, restartcpu=restartcpu, modemSymbolRateRx=modemSymbolRateRx, sysTemperature=sysTemperature, vlanPortType=vlanPortType, modemModulation=modemModulation, localIpMask=localIpMask, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemGeneralStatus=modemGeneralStatus, ethTXCollisions=ethTXCollisions, modemCarrierOffset=modemCarrierOffset, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ipRadioStat=ipRadioStat, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXByteCounterHi=ethRXByteCounterHi, modemRowStatus=modemRowStatus, ipRadioCfgGeneral=ipRadioCfgGeneral, vlanCfgStat=vlanCfgStat, modemInternalAGCgain=modemInternalAGCgain, radioTxPower=radioTxPower, modemTable=modemTable, atpcEnabled=atpcEnabled, modemIndex=modemIndex, microwaveRadio=microwaveRadio, ethTXByteCounterLow=ethTXByteCounterLow, radioGenStatus=radioGenStatus, ethRXPrevPktDropped=ethRXPrevPktDropped, loopback_tributary_mask=loopback_tributary_mask, localIp=localIp, radioLoopback=radioLoopback, vlanTable=vlanTable, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXExcessiveDefers=ethTXExcessiveDefers, modemBandwith=modemBandwith, tehnika=tehnika, ipRadioStatEth=ipRadioStatEth, ethTXBackpresEvents=ethTXBackpresEvents, ipRadio=ipRadio, e1t1AIS=e1t1AIS, modemStandard=modemStandard, modemUptime=modemUptime, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXDribleNibbles=ethRXDribleNibbles, ethRXDones=ethRXDones, ethGFPDelineationErrors=ethGFPDelineationErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXByteCounterLow=ethRXByteCounterLow, ipRadioCfg=ipRadioCfg, modemACMmodulationMin=modemACMmodulationMin, sysDateAndTime=sysDateAndTime, remoteIp=remoteIp, aTPCEntry=aTPCEntry, e1t1LOS=e1t1LOS, vlanPortmap=vlanPortmap, ethRXMulticasts=ethRXMulticasts, ethGFPFCSErrors=ethGFPFCSErrors, modemCountTime=modemCountTime, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemACMengine=modemACMengine, ethTXPauseFrames=ethTXPauseFrames, loopbacks=loopbacks, vlanNumber=vlanNumber, ethTXByteCounterHi=ethTXByteCounterHi, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioIndex=radioIndex, product=product, description=description, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXDvEvent=ethRXDvEvent, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemAcqStatus=modemAcqStatus, vlansEnabled=vlansEnabled, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioRxLevel=radioRxLevel, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXLongEvents=ethRXLongEvents, modemErroredSecondRatio=modemErroredSecondRatio, safip=safip, radioTxMute=radioTxMute, modemTotalBlockNumber=modemTotalBlockNumber, modemEntry=modemEntry, modemStatistics=modemStatistics, ethTXLateCollisions=ethTXLateCollisions, ethRXCRCErrors=ethRXCRCErrors, ethTXMaxCollisions=ethTXMaxCollisions, ethQOSTXDropped=ethQOSTXDropped, atpcTxPowerCorrection=atpcTxPowerCorrection, modemACMmodulationMax=modemACMmodulationMax, licenseUpdateStatus=licenseUpdateStatus, hostname=hostname, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXUnderruns=ethTXUnderruns, ethGFPCHECErrors=ethGFPCHECErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemEthernetCapacity=modemEthernetCapacity, modemE1T1Channels=modemE1T1Channels, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlanFid=vlanFid, modemSymbolRateTx=modemSymbolRateTx, modemACMethernetCapacity=modemACMethernetCapacity, ipRadioMgmt=ipRadioMgmt, vlanRowStatus=vlanRowStatus, ethTXDones=ethTXDones, radioEntry=radioEntry, writeConfig=writeConfig, modemLastAcqError=modemLastAcqError, radioDuplexShift=radioDuplexShift, ethRXUnsupOpcodes=ethRXUnsupOpcodes, aTPCTable=aTPCTable, modemErroredBlock=modemErroredBlock, ethTXWireByteCounterLow=ethTXWireByteCounterLow, pointToPoint=pointToPoint, ethGFPDropedFrames=ethGFPDropedFrames, modemErroredSecond=modemErroredSecond, radioSide=radioSide, ethTXBroadcasts=ethTXBroadcasts, e1t1ChannelNr=e1t1ChannelNr, ethRXBroadcasts=ethRXBroadcasts, modemUnavailtime=modemUnavailtime, ethTXMulticasts=ethTXMulticasts, atpcIndex=atpcIndex, e1t1StatTable=e1t1StatTable, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXControlFrames=ethTXControlFrames, modemRadialMSE=modemRadialMSE, ethRXCodeErrors=ethRXCodeErrors, ethTXCRCErrors=ethTXCRCErrors, modemACMtotalCapacity=modemACMtotalCapacity, modemSeverelyErroredSecond=modemSeverelyErroredSecond)
