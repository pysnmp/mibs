...
mibBuilder.exportSymbols("SAF-IPRADIO", modemRadialMSE=modemRadialMSE, modemStandard=modemStandard, sysTemperature=sysTemperature, modemUnavailtime=modemUnavailtime, product=product, ethRXVlanTagsDetected=ethRXVlanTagsDetected, loopback_tributary_mask=loopback_tributary_mask, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXPauseFrames=ethRXPauseFrames, radioGenStatus=radioGenStatus, modemACMmodulationMin=modemACMmodulationMin, radioTable=radioTable, ethTXDones=ethTXDones, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXByteCounterHi=ethRXByteCounterHi, ethTXMaxCollisions=ethTXMaxCollisions, modemStatistics=modemStatistics, ethRXDribleNibbles=ethRXDribleNibbles, ethTXByteCounterLow=ethTXByteCounterLow, ethTXUnderruns=ethTXUnderruns, radioRxLevel=radioRxLevel, modemTotalBlockNumber=modemTotalBlockNumber, ethQOSTXFrames=ethQOSTXFrames, modemSymbolRateTx=modemSymbolRateTx, ethGFPDelineationErrors=ethGFPDelineationErrors, e1t1StatTable=e1t1StatTable, atpcEnabled=atpcEnabled, ethTXByteCounterHi=ethTXByteCounterHi, e1t1AIS=e1t1AIS, radioSide=radioSide, licenseUpdateStatus=licenseUpdateStatus, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethGFPCHECErrors=ethGFPCHECErrors, modemE1T1Channels=modemE1T1Channels, ethRXByteCounterLow=ethRXByteCounterLow, localIp=localIp, ethTXGiants=ethTXGiants, modemE1T1ChannelMask=modemE1T1ChannelMask, modemGeneralStatus=modemGeneralStatus, modemACMmodulationMax=modemACMmodulationMax, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemEntry=modemEntry, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXLongEvents=ethRXLongEvents, e1t1StatEntry=e1t1StatEntry, description=description, ipRadioCfg=ipRadioCfg, radioTxMute=radioTxMute, pointToPoint=pointToPoint, writeConfig=writeConfig, modemRowStatus=modemRowStatus, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemACMengine=modemACMengine, vlanTable=vlanTable, ethTXLengthCheckErrors=ethTXLengthCheckErrors, radioTxPower=radioTxPower, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXDvEvent=ethRXDvEvent, radioRxFrequency=radioRxFrequency, aTPCTable=aTPCTable, modemBandwith=modemBandwith, ethTXCollisions=ethTXCollisions, microwaveRadio=microwaveRadio, modemSymbolRateRx=modemSymbolRateRx, vlanPortType=vlanPortType, modemInternalAGCgain=modemInternalAGCgain, ethRXCRCErrors=ethRXCRCErrors, ethRXPrevPktDropped=ethRXPrevPktDropped, radioIndex=radioIndex, tehnika=tehnika, atpcIndex=atpcIndex, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXLateCollisions=ethTXLateCollisions, modemUptime=modemUptime, radioEntry=radioEntry, modemErroredSecondRatio=modemErroredSecondRatio, sysDateAndTime=sysDateAndTime, modemModulation=modemModulation, ethTXMulticasts=ethTXMulticasts, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXControlFrames=ethRXControlFrames, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, loopbacks=loopbacks, licenseMask=licenseMask, ethTXPauseFrames=ethTXPauseFrames, vlanPortmap=vlanPortmap, vlanFid=vlanFid, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXControlFrames=ethTXControlFrames, modemACMethernetCapacity=modemACMethernetCapacity, ethTXCRCErrors=ethTXCRCErrors, ethQOSTXDropped=ethQOSTXDropped, ethGFPDropedFrames=ethGFPDropedFrames, modemErroredBlock=modemErroredBlock, modemEthernetCapacity=modemEthernetCapacity, ethTXBroadcasts=ethTXBroadcasts, ethRXUnsupOpcodes=ethRXUnsupOpcodes, vlanCfgStat=vlanCfgStat, modemIndex=modemIndex, ethTXWireByteCounterHi=ethTXWireByteCounterHi, remoteIp=remoteIp, ethRXMulticasts=ethRXMulticasts, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemACMtotalCapacity=modemACMtotalCapacity, localIpMask=localIpMask, safip=safip, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXCodeErrors=ethRXCodeErrors, ipRadioCfgGeneral=ipRadioCfgGeneral, modemCountTime=modemCountTime, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXVlanTags=ethTXVlanTags, vlanEntry=vlanEntry, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ipRadio=ipRadio, restartcpu=restartcpu, modemCarrierOffset=modemCarrierOffset, modemTable=modemTable, hostname=hostname, saf=saf, radioTxFrequency=radioTxFrequency, ipRadioStatEth=ipRadioStatEth, e1t1LOS=e1t1LOS, ipRadioStat=ipRadioStat, vlansEnabled=vlansEnabled, ethGFPFCSErrors=ethGFPFCSErrors, ethRXDones=ethRXDones, ethRXBroadcasts=ethRXBroadcasts, vlanNumber=vlanNumber, ipRadioMgmt=ipRadioMgmt, modemTotalCapacity=modemTotalCapacity, modemLDPCdecoderStress=modemLDPCdecoderStress, radioLoopback=radioLoopback, modemLastAcqError=modemLastAcqError, radioDuplexShift=radioDuplexShift, ethTXBackpresEvents=ethTXBackpresEvents, ethQOSRXQ2Frames=ethQOSRXQ2Frames, e1t1ChannelNr=e1t1ChannelNr, aTPCEntry=aTPCEntry, vlanRowStatus=vlanRowStatus, license=license, modemAcqStatus=modemAcqStatus, modemErroredSecond=modemErroredSecond, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped)
