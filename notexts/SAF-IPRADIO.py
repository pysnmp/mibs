...
mibBuilder.exportSymbols("SAF-IPRADIO", ipRadio=ipRadio, sysTemperature=sysTemperature, ethTXBackpresEvents=ethTXBackpresEvents, modemRadialMSE=modemRadialMSE, ethTXWireByteCounterHi=ethTXWireByteCounterHi, safip=safip, writeConfig=writeConfig, radioRxFrequency=radioRxFrequency, e1t1AIS=e1t1AIS, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXMulticasts=ethRXMulticasts, aTPCEntry=aTPCEntry, ethRXByteCounterLow=ethRXByteCounterLow, ethTXVlanTags=ethTXVlanTags, modemIndex=modemIndex, ethTXByteCounterLow=ethTXByteCounterLow, ethGFPFCSErrors=ethGFPFCSErrors, licenseMask=licenseMask, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXCollisions=ethTXCollisions, ipRadioCfgNetwork=ipRadioCfgNetwork, vlanCfgStat=vlanCfgStat, ethTXBroadcasts=ethTXBroadcasts, vlanEntry=vlanEntry, restartcpu=restartcpu, modemErroredSecondRatio=modemErroredSecondRatio, atpcEnabled=atpcEnabled, modemStandard=modemStandard, ethTXWireByteCounterLow=ethTXWireByteCounterLow, vlanFid=vlanFid, modemGeneralStatus=modemGeneralStatus, radioTxMute=radioTxMute, ethRXPauseFrames=ethRXPauseFrames, modemSymbolRateRx=modemSymbolRateRx, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlanNumber=vlanNumber, modemEntry=modemEntry, modemE1T1Channels=modemE1T1Channels, vlanRowStatus=vlanRowStatus, radioTxFrequency=radioTxFrequency, modemRowStatus=modemRowStatus, ipRadioStatEth=ipRadioStatEth, ethTXByteCounterHi=ethTXByteCounterHi, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXCRCErrors=ethRXCRCErrors, modemUnavailtime=modemUnavailtime, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, atpcTxPowerCorrection=atpcTxPowerCorrection, description=description, vlanPortmap=vlanPortmap, ethTXMaxCollisions=ethTXMaxCollisions, modemE1T1ChannelMask=modemE1T1ChannelMask, e1t1ChannelNr=e1t1ChannelNr, modemACMmodulationMax=modemACMmodulationMax, modemSymbolRateTx=modemSymbolRateTx, loopbacks=loopbacks, pointToPoint=pointToPoint, ethRXPrevPktDropped=ethRXPrevPktDropped, modemCarrierOffset=modemCarrierOffset, radioEntry=radioEntry, aTPCTable=aTPCTable, saf=saf, modemAcqStatus=modemAcqStatus, ethGFPDropedFrames=ethGFPDropedFrames, modemErroredSecond=modemErroredSecond, ipRadioCfg=ipRadioCfg, modemBandwith=modemBandwith, modemTable=modemTable, ethGFPCHECErrors=ethGFPCHECErrors, modemErroredBlock=modemErroredBlock, modemStatistics=modemStatistics, e1t1LOS=e1t1LOS, modemModulation=modemModulation, modemACMethernetCapacity=modemACMethernetCapacity, loopback_tributary_mask=loopback_tributary_mask, modemACMmodulationMin=modemACMmodulationMin, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioDuplexShift=radioDuplexShift, remoteIp=remoteIp, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXPauseFrames=ethTXPauseFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, localIp=localIp, modemTotalCapacity=modemTotalCapacity, e1t1StatEntry=e1t1StatEntry, microwaveRadio=microwaveRadio, ethQOSTXDropped=ethQOSTXDropped, ethTXCRCErrors=ethTXCRCErrors, ethRXDones=ethRXDones, tehnika=tehnika, ethTXExcessiveDefers=ethTXExcessiveDefers, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethQOSTXFrames=ethQOSTXFrames, radioSide=radioSide, ipRadioCfgGeneral=ipRadioCfgGeneral, licenseUpdateStatus=licenseUpdateStatus, atpcIndex=atpcIndex, radioTxPower=radioTxPower, radioRxLevel=radioRxLevel, radioIndex=radioIndex, license=license, modemCountTime=modemCountTime, localIpMask=localIpMask, ethRXCodeErrors=ethRXCodeErrors, ethRXDribleNibbles=ethRXDribleNibbles, vlanPortType=vlanPortType, ethTXMulticasts=ethTXMulticasts, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ipRadioMgmt=ipRadioMgmt, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXControlFrames=ethRXControlFrames, hostname=hostname, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXControlFrames=ethTXControlFrames, modemTotalBlockNumber=modemTotalBlockNumber, vlansEnabled=vlansEnabled, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioTable=radioTable, e1t1StatTable=e1t1StatTable, radioGenStatus=radioGenStatus, ethRXBroadcasts=ethRXBroadcasts, ethRXLongEvents=ethRXLongEvents, ethTXLateCollisions=ethTXLateCollisions, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioLoopback=radioLoopback, modemInternalAGCgain=modemInternalAGCgain, ethRXDvEvent=ethRXDvEvent, modemACMengine=modemACMengine, modemACMtotalCapacity=modemACMtotalCapacity, ethTXGiants=ethTXGiants, ethTXDones=ethTXDones, modemUptime=modemUptime, sysDateAndTime=sysDateAndTime, ethRXTruncatedFrames=ethRXTruncatedFrames, ipRadioStat=ipRadioStat, ethTXUnderruns=ethTXUnderruns, product=product, vlanTable=vlanTable, ethRXByteCounterHi=ethRXByteCounterHi, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemLastAcqError=modemLastAcqError, modemEthernetCapacity=modemEthernetCapacity)
