...
mibBuilder.exportSymbols("SAF-IPRADIO", sysTemperature=sysTemperature, modemErroredSecondRatio=modemErroredSecondRatio, ethRXTruncatedFrames=ethRXTruncatedFrames, aTPCTable=aTPCTable, modemStatistics=modemStatistics, ethTXLateCollisions=ethTXLateCollisions, modemErroredBlock=modemErroredBlock, ethRXByteCounterLow=ethRXByteCounterLow, e1t1StatEntry=e1t1StatEntry, ethRXDvEvent=ethRXDvEvent, modemRowStatus=modemRowStatus, ethGFPDropedFrames=ethGFPDropedFrames, radioLoopback=radioLoopback, modemACMengine=modemACMengine, vlansEnabled=vlansEnabled, radioTxPower=radioTxPower, radioRxFrequency=radioRxFrequency, ethTXUnderruns=ethTXUnderruns, ipRadioCfgNetwork=ipRadioCfgNetwork, radioGenStatus=radioGenStatus, modemCountTime=modemCountTime, e1t1ChannelNr=e1t1ChannelNr, vlanTable=vlanTable, loopback_tributary_mask=loopback_tributary_mask, ipRadio=ipRadio, ethTXCollisions=ethTXCollisions, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemACMethernetCapacity=modemACMethernetCapacity, ethRXBroadcasts=ethRXBroadcasts, ethRXCRCErrors=ethRXCRCErrors, ipRadioStat=ipRadioStat, modemEntry=modemEntry, ipRadioCfg=ipRadioCfg, modemE1T1ChannelMask=modemE1T1ChannelMask, vlanEntry=vlanEntry, ethRXControlFrames=ethRXControlFrames, saf=saf, modemACMmodulationMin=modemACMmodulationMin, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioTxMute=radioTxMute, ipRadioMgmt=ipRadioMgmt, modemACMtotalCapacity=modemACMtotalCapacity, tehnika=tehnika, radioIndex=radioIndex, modemLDPCdecoderStress=modemLDPCdecoderStress, e1t1StatTable=e1t1StatTable, modemUptime=modemUptime, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXDones=ethTXDones, writeConfig=writeConfig, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, restartcpu=restartcpu, safip=safip, ethRXPauseFrames=ethRXPauseFrames, radioTable=radioTable, ethTXGiants=ethTXGiants, hostname=hostname, ethTXByteCounterLow=ethTXByteCounterLow, ethTXBroadcasts=ethTXBroadcasts, ethTXCRCErrors=ethTXCRCErrors, ethRXPrevPktDropped=ethRXPrevPktDropped, aTPCEntry=aTPCEntry, ethGFPFCSErrors=ethGFPFCSErrors, ethTXVlanTags=ethTXVlanTags, vlanRowStatus=vlanRowStatus, description=description, modemLastAcqError=modemLastAcqError, e1t1AIS=e1t1AIS, modemUnavailtime=modemUnavailtime, ethQOSTXFrames=ethQOSTXFrames, sysDateAndTime=sysDateAndTime, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, pointToPoint=pointToPoint, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioDuplexShift=radioDuplexShift, localIpMask=localIpMask, radioRxLevel=radioRxLevel, loopbacks=loopbacks, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXByteCounterHi=ethRXByteCounterHi, ethTXByteCounterHi=ethTXByteCounterHi, ethTXPauseFrames=ethTXPauseFrames, ethGFPCHECErrors=ethGFPCHECErrors, ethRXDones=ethRXDones, e1t1LOS=e1t1LOS, atpcIndex=atpcIndex, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemStandard=modemStandard, modemSymbolRateTx=modemSymbolRateTx, ethRXDribleNibbles=ethRXDribleNibbles, ethTXControlFrames=ethTXControlFrames, modemGeneralStatus=modemGeneralStatus, ethTXBackpresEvents=ethTXBackpresEvents, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, vlanPortType=vlanPortType, ethRXCodeErrors=ethRXCodeErrors, localIp=localIp, radioSide=radioSide, vlanNumber=vlanNumber, modemRadialMSE=modemRadialMSE, modemTotalCapacity=modemTotalCapacity, vlanFid=vlanFid, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemSymbolRateRx=modemSymbolRateRx, modemTotalBlockNumber=modemTotalBlockNumber, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, atpcEnabled=atpcEnabled, ethRXUnsupOpcodes=ethRXUnsupOpcodes, licenseUpdateStatus=licenseUpdateStatus, ethGFPDelineationErrors=ethGFPDelineationErrors, radioTxFrequency=radioTxFrequency, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXMaxCollisions=ethTXMaxCollisions, modemE1T1Channels=modemE1T1Channels, modemIndex=modemIndex, modemBandwith=modemBandwith, microwaveRadio=microwaveRadio, ethRXVlanTagsDetected=ethRXVlanTagsDetected, licenseMask=licenseMask, modemEthernetCapacity=modemEthernetCapacity, modemTable=modemTable, modemACMmodulationMax=modemACMmodulationMax, vlanPortmap=vlanPortmap, radioEntry=radioEntry, ipRadioStatEth=ipRadioStatEth, modemCarrierOffset=modemCarrierOffset, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXMulticasts=ethRXMulticasts, modemInternalAGCgain=modemInternalAGCgain, ethRXLongEvents=ethRXLongEvents, ethQOSTXDropped=ethQOSTXDropped, atpcTxPowerCorrection=atpcTxPowerCorrection, license=license, vlanCfgStat=vlanCfgStat, modemModulation=modemModulation, modemAcqStatus=modemAcqStatus, modemBackgroundBlockErrror=modemBackgroundBlockErrror, product=product, modemErroredSecond=modemErroredSecond, remoteIp=remoteIp, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXMulticasts=ethTXMulticasts)
