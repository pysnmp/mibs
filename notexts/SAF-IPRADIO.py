...
mibBuilder.exportSymbols("SAF-IPRADIO", modemIndex=modemIndex, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXMulticasts=ethRXMulticasts, ethTXMaxCollisions=ethTXMaxCollisions, ipRadioStat=ipRadioStat, sysTemperature=sysTemperature, licenseUpdateStatus=licenseUpdateStatus, ethRXUnsupOpcodes=ethRXUnsupOpcodes, sysDateAndTime=sysDateAndTime, e1t1ChannelNr=e1t1ChannelNr, localIpMask=localIpMask, ethTXUnderruns=ethTXUnderruns, e1t1AIS=e1t1AIS, ethGFPFCSErrors=ethGFPFCSErrors, modemEthernetCapacity=modemEthernetCapacity, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioTable=radioTable, modemACMmodulationMax=modemACMmodulationMax, modemAcqStatus=modemAcqStatus, vlansEnabled=vlansEnabled, tehnika=tehnika, ethRXPrevPktDropped=ethRXPrevPktDropped, radioSide=radioSide, modemRadialMSE=modemRadialMSE, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemGeneralStatus=modemGeneralStatus, vlanTable=vlanTable, ethTXLateCollisions=ethTXLateCollisions, modemE1T1Channels=modemE1T1Channels, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXCRCErrors=ethTXCRCErrors, modemLastAcqError=modemLastAcqError, pointToPoint=pointToPoint, ethTXBackpresEvents=ethTXBackpresEvents, modemE1T1ChannelMask=modemE1T1ChannelMask, modemStatistics=modemStatistics, modemSymbolRateTx=modemSymbolRateTx, modemInternalAGCgain=modemInternalAGCgain, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemTotalBlockNumber=modemTotalBlockNumber, modemCarrierOffset=modemCarrierOffset, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ipRadioStatEth=ipRadioStatEth, ethRXDones=ethRXDones, ethRXTruncatedFrames=ethRXTruncatedFrames, radioLoopback=radioLoopback, aTPCTable=aTPCTable, ethGFPDelineationErrors=ethGFPDelineationErrors, modemCountTime=modemCountTime, ethTXLengthCheckErrors=ethTXLengthCheckErrors, radioIndex=radioIndex, ethQOSTXDropped=ethQOSTXDropped, ethTXCollisions=ethTXCollisions, ethRXByteCounterLow=ethRXByteCounterLow, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXBroadcasts=ethRXBroadcasts, description=description, modemStandard=modemStandard, modemACMmodulationMin=modemACMmodulationMin, modemTable=modemTable, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethQOSTXFrames=ethQOSTXFrames, atpcIndex=atpcIndex, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, atpcTxPowerCorrection=atpcTxPowerCorrection, writeConfig=writeConfig, restartcpu=restartcpu, vlanRowStatus=vlanRowStatus, modemUptime=modemUptime, product=product, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXDribleNibbles=ethRXDribleNibbles, ethRXPauseFrames=ethRXPauseFrames, radioDuplexShift=radioDuplexShift, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ipRadioCfg=ipRadioCfg, ethGFPDropedFrames=ethGFPDropedFrames, ethTXVlanTags=ethTXVlanTags, vlanCfgStat=vlanCfgStat, ethRXCodeErrors=ethRXCodeErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXGiants=ethTXGiants, e1t1StatEntry=e1t1StatEntry, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethGFPCHECErrors=ethGFPCHECErrors, vlanPortmap=vlanPortmap, ethTXExcessiveDefers=ethTXExcessiveDefers, radioTxMute=radioTxMute, ethTXMulticasts=ethTXMulticasts, modemACMengine=modemACMengine, e1t1StatTable=e1t1StatTable, modemRowStatus=modemRowStatus, ethTXControlFrames=ethTXControlFrames, ethTXBroadcasts=ethTXBroadcasts, ethRXByteCounterHi=ethRXByteCounterHi, remoteIp=remoteIp, modemUnavailtime=modemUnavailtime, ethTXPauseFrames=ethTXPauseFrames, e1t1LOS=e1t1LOS, hostname=hostname, vlanPortType=vlanPortType, microwaveRadio=microwaveRadio, modemBandwith=modemBandwith, radioTxPower=radioTxPower, vlanFid=vlanFid, ethRXCRCErrors=ethRXCRCErrors, saf=saf, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXLongEvents=ethRXLongEvents, modemErroredBlock=modemErroredBlock, modemModulation=modemModulation, safip=safip, modemACMtotalCapacity=modemACMtotalCapacity, radioRxLevel=radioRxLevel, modemTotalCapacity=modemTotalCapacity, loopbacks=loopbacks, atpcEnabled=atpcEnabled, modemLDPCdecoderStress=modemLDPCdecoderStress, radioGenStatus=radioGenStatus, radioRxFrequency=radioRxFrequency, vlanNumber=vlanNumber, modemErroredSecond=modemErroredSecond, licenseMask=licenseMask, modemErroredSecondRatio=modemErroredSecondRatio, vlanEntry=vlanEntry, ethTXByteCounterLow=ethTXByteCounterLow, aTPCEntry=aTPCEntry, radioTxFrequency=radioTxFrequency, localIp=localIp, license=license, loopback_tributary_mask=loopback_tributary_mask, modemSymbolRateRx=modemSymbolRateRx, modemACMethernetCapacity=modemACMethernetCapacity, ipRadioMgmt=ipRadioMgmt, ethTXDones=ethTXDones, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ipRadio=ipRadio, ethTXByteCounterHi=ethTXByteCounterHi, modemEntry=modemEntry, ethRXDvEvent=ethRXDvEvent, ethRXControlFrames=ethRXControlFrames, ipRadioCfgGeneral=ipRadioCfgGeneral, radioEntry=radioEntry)
