...
mibBuilder.exportSymbols("SAF-IPRADIO", writeConfig=writeConfig, radioRxFrequency=radioRxFrequency, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, restartcpu=restartcpu, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemModulation=modemModulation, e1t1LOS=e1t1LOS, localIp=localIp, ethRXUnsupOpcodes=ethRXUnsupOpcodes, e1t1StatTable=e1t1StatTable, ethTXCollisions=ethTXCollisions, modemAcqStatus=modemAcqStatus, localIpMask=localIpMask, modemStatistics=modemStatistics, ethTXGiants=ethTXGiants, licenseMask=licenseMask, modemLastAcqError=modemLastAcqError, ethTXBackpresEvents=ethTXBackpresEvents, ipRadioCfgNetwork=ipRadioCfgNetwork, safip=safip, radioSide=radioSide, ethRXPrevPktDropped=ethRXPrevPktDropped, radioTable=radioTable, ethRXCodeErrors=ethRXCodeErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXVlanTags=ethTXVlanTags, ethTXUnderruns=ethTXUnderruns, vlanPortType=vlanPortType, ethTXPauseFrames=ethTXPauseFrames, remoteIp=remoteIp, ethRXMulticasts=ethRXMulticasts, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemTable=modemTable, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXCRCErrors=ethRXCRCErrors, vlanEntry=vlanEntry, e1t1StatEntry=e1t1StatEntry, modemEntry=modemEntry, modemIndex=modemIndex, vlanNumber=vlanNumber, radioGenStatus=radioGenStatus, ethTXMulticasts=ethTXMulticasts, radioTxPower=radioTxPower, ethRXDvEvent=ethRXDvEvent, ethRXTruncatedFrames=ethRXTruncatedFrames, radioDuplexShift=radioDuplexShift, ipRadioStatEth=ipRadioStatEth, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ipRadioCfg=ipRadioCfg, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemE1T1ChannelMask=modemE1T1ChannelMask, ethQOSTXDropped=ethQOSTXDropped, radioRxLevel=radioRxLevel, ethRXByteCounterLow=ethRXByteCounterLow, ipRadioCfgGeneral=ipRadioCfgGeneral, ethGFPCHECErrors=ethGFPCHECErrors, ethRXDones=ethRXDones, modemACMethernetCapacity=modemACMethernetCapacity, hostname=hostname, ethGFPFCSErrors=ethGFPFCSErrors, product=product, modemBandwith=modemBandwith, modemStandard=modemStandard, radioTxMute=radioTxMute, modemACMtotalCapacity=modemACMtotalCapacity, modemUnavailtime=modemUnavailtime, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemUptime=modemUptime, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethQOSTXFrames=ethQOSTXFrames, modemErroredSecondRatio=modemErroredSecondRatio, modemACMmodulationMin=modemACMmodulationMin, atpcTxPowerCorrection=atpcTxPowerCorrection, license=license, saf=saf, radioLoopback=radioLoopback, atpcIndex=atpcIndex, modemACMengine=modemACMengine, ethTXByteCounterHi=ethTXByteCounterHi, ethRXLongEvents=ethRXLongEvents, modemTotalBlockNumber=modemTotalBlockNumber, radioTxFrequency=radioTxFrequency, ethRXBroadcasts=ethRXBroadcasts, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, sysDateAndTime=sysDateAndTime, atpcEnabled=atpcEnabled, tehnika=tehnika, modemInternalAGCgain=modemInternalAGCgain, vlanRowStatus=vlanRowStatus, vlanCfgStat=vlanCfgStat, ethTXControlFrames=ethTXControlFrames, e1t1AIS=e1t1AIS, ethTXMaxCollisions=ethTXMaxCollisions, ethTXLateCollisions=ethTXLateCollisions, ethGFPDelineationErrors=ethGFPDelineationErrors, aTPCEntry=aTPCEntry, ethRXByteCounterHi=ethRXByteCounterHi, sysTemperature=sysTemperature, licenseUpdateStatus=licenseUpdateStatus, ethRXPauseFrames=ethRXPauseFrames, modemRadialMSE=modemRadialMSE, ipRadioStat=ipRadioStat, loopback_tributary_mask=loopback_tributary_mask, ethRXDribleNibbles=ethRXDribleNibbles, ethTXCRCErrors=ethTXCRCErrors, vlanPortmap=vlanPortmap, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemE1T1Channels=modemE1T1Channels, modemSymbolRateTx=modemSymbolRateTx, modemCarrierOffset=modemCarrierOffset, ipRadioMgmt=ipRadioMgmt, radioIndex=radioIndex, loopbacks=loopbacks, ethTXBroadcasts=ethTXBroadcasts, ipRadio=ipRadio, vlansEnabled=vlansEnabled, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXByteCounterLow=ethTXByteCounterLow, pointToPoint=pointToPoint, aTPCTable=aTPCTable, modemSymbolRateRx=modemSymbolRateRx, modemACMmodulationMax=modemACMmodulationMax, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXExcessiveDefers=ethTXExcessiveDefers, modemCountTime=modemCountTime, microwaveRadio=microwaveRadio, vlanFid=vlanFid, modemGeneralStatus=modemGeneralStatus, radioEntry=radioEntry, vlanTable=vlanTable, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, e1t1ChannelNr=e1t1ChannelNr, modemErroredSecond=modemErroredSecond, ethRXControlFrames=ethRXControlFrames, modemErroredBlock=modemErroredBlock, modemTotalCapacity=modemTotalCapacity, ethGFPDropedFrames=ethGFPDropedFrames, description=description, modemRowStatus=modemRowStatus, ethTXDones=ethTXDones, modemEthernetCapacity=modemEthernetCapacity)
