...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXCRCErrors=ethRXCRCErrors, modemLastAcqError=modemLastAcqError, ethTXVlanTags=ethTXVlanTags, modemEntry=modemEntry, modemStandard=modemStandard, radioRxFrequency=radioRxFrequency, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXDones=ethRXDones, ipRadioCfgGeneral=ipRadioCfgGeneral, modemTable=modemTable, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlansEnabled=vlansEnabled, modemSymbolRateTx=modemSymbolRateTx, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, atpcIndex=atpcIndex, ethRXDvEvent=ethRXDvEvent, ethRXPauseFrames=ethRXPauseFrames, modemACMtotalCapacity=modemACMtotalCapacity, ethRXDribleNibbles=ethRXDribleNibbles, e1t1AIS=e1t1AIS, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXUnderruns=ethTXUnderruns, tehnika=tehnika, ipRadioStat=ipRadioStat, remoteIp=remoteIp, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXByteCounterHi=ethTXByteCounterHi, e1t1StatEntry=e1t1StatEntry, license=license, radioLoopback=radioLoopback, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXCodeErrors=ethRXCodeErrors, writeConfig=writeConfig, modemGeneralStatus=modemGeneralStatus, vlanFid=vlanFid, ethTXMulticasts=ethTXMulticasts, ethRXBroadcasts=ethRXBroadcasts, ethGFPCHECErrors=ethGFPCHECErrors, pointToPoint=pointToPoint, ethTXControlFrames=ethTXControlFrames, modemRadialMSE=modemRadialMSE, modemACMethernetCapacity=modemACMethernetCapacity, ethTXCollisions=ethTXCollisions, modemTotalCapacity=modemTotalCapacity, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, restartcpu=restartcpu, vlanNumber=vlanNumber, radioEntry=radioEntry, aTPCTable=aTPCTable, modemErroredSecond=modemErroredSecond, ethGFPFCSErrors=ethGFPFCSErrors, radioTxPower=radioTxPower, ethQOSTXFrames=ethQOSTXFrames, ethRXPrevPktDropped=ethRXPrevPktDropped, ipRadio=ipRadio, ethTXLateCollisions=ethTXLateCollisions, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadioMgmt=ipRadioMgmt, ethTXBackpresEvents=ethTXBackpresEvents, radioSide=radioSide, description=description, modemEthernetCapacity=modemEthernetCapacity, localIp=localIp, ethRXControlFrames=ethRXControlFrames, modemACMmodulationMin=modemACMmodulationMin, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemErroredBlock=modemErroredBlock, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXByteCounterHi=ethRXByteCounterHi, ethTXByteCounterLow=ethTXByteCounterLow, modemTotalBlockNumber=modemTotalBlockNumber, modemACMmodulationMax=modemACMmodulationMax, radioDuplexShift=radioDuplexShift, loopbacks=loopbacks, vlanCfgStat=vlanCfgStat, ipRadioCfgNetwork=ipRadioCfgNetwork, modemE1T1Channels=modemE1T1Channels, licenseUpdateStatus=licenseUpdateStatus, modemStatistics=modemStatistics, e1t1StatTable=e1t1StatTable, ethRXByteCounterLow=ethRXByteCounterLow, safip=safip, localIpMask=localIpMask, ethGFPDropedFrames=ethGFPDropedFrames, radioIndex=radioIndex, modemCarrierOffset=modemCarrierOffset, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemE1T1ChannelMask=modemE1T1ChannelMask, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXBroadcasts=ethTXBroadcasts, licenseMask=licenseMask, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemBandwith=modemBandwith, modemAcqStatus=modemAcqStatus, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethGFPDelineationErrors=ethGFPDelineationErrors, modemACMengine=modemACMengine, loopback_tributary_mask=loopback_tributary_mask, modemIndex=modemIndex, radioTable=radioTable, modemModulation=modemModulation, hostname=hostname, radioRxLevel=radioRxLevel, modemLDPCdecoderStress=modemLDPCdecoderStress, vlanRowStatus=vlanRowStatus, ipRadioStatEth=ipRadioStatEth, modemRowStatus=modemRowStatus, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioGenStatus=radioGenStatus, modemUnavailtime=modemUnavailtime, sysTemperature=sysTemperature, ipRadioCfg=ipRadioCfg, ethTXWireByteCounterLow=ethTXWireByteCounterLow, microwaveRadio=microwaveRadio, modemCountTime=modemCountTime, aTPCEntry=aTPCEntry, ethRXMulticasts=ethRXMulticasts, ethQOSTXDropped=ethQOSTXDropped, vlanPortmap=vlanPortmap, sysDateAndTime=sysDateAndTime, radioTxMute=radioTxMute, vlanTable=vlanTable, ethTXCRCErrors=ethTXCRCErrors, atpcEnabled=atpcEnabled, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlanPortType=vlanPortType, e1t1LOS=e1t1LOS, vlanEntry=vlanEntry, modemUptime=modemUptime, radioTxFrequency=radioTxFrequency, product=product, modemInternalAGCgain=modemInternalAGCgain, e1t1ChannelNr=e1t1ChannelNr, modemErroredSecondRatio=modemErroredSecondRatio, ethTXMaxCollisions=ethTXMaxCollisions, ethTXGiants=ethTXGiants, ethTXPauseFrames=ethTXPauseFrames, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXLongEvents=ethRXLongEvents, modemSymbolRateRx=modemSymbolRateRx, ethTXDones=ethTXDones, saf=saf, atpcTxPowerCorrection=atpcTxPowerCorrection)
