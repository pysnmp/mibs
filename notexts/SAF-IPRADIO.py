...
mibBuilder.exportSymbols("SAF-IPRADIO", modemLastAcqError=modemLastAcqError, ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlanRowStatus=vlanRowStatus, modemSeverelyErroredSecond=modemSeverelyErroredSecond, vlanCfgStat=vlanCfgStat, ethTXBackpresEvents=ethTXBackpresEvents, modemStatistics=modemStatistics, ethTXCRCErrors=ethTXCRCErrors, loopbacks=loopbacks, ethRXControlFrames=ethRXControlFrames, safip=safip, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, e1t1StatTable=e1t1StatTable, ethQOSTXFrames=ethQOSTXFrames, ethGFPFCSErrors=ethGFPFCSErrors, sysDateAndTime=sysDateAndTime, ethRXDvEvent=ethRXDvEvent, ethTXUnderruns=ethTXUnderruns, e1t1StatEntry=e1t1StatEntry, aTPCEntry=aTPCEntry, modemEntry=modemEntry, modemBandwith=modemBandwith, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemRadialMSE=modemRadialMSE, modemACMethernetCapacity=modemACMethernetCapacity, ethTXByteCounterLow=ethTXByteCounterLow, ethTXControlFrames=ethTXControlFrames, ipRadioStat=ipRadioStat, restartcpu=restartcpu, modemE1T1Channels=modemE1T1Channels, vlanEntry=vlanEntry, writeConfig=writeConfig, ethTXLateCollisions=ethTXLateCollisions, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemErroredSecond=modemErroredSecond, ethRXMulticasts=ethRXMulticasts, vlanPortType=vlanPortType, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXVlanTags=ethTXVlanTags, vlanTable=vlanTable, modemStandard=modemStandard, ethRXCRCErrors=ethRXCRCErrors, modemIndex=modemIndex, pointToPoint=pointToPoint, ethRXByteCounterLow=ethRXByteCounterLow, radioTxFrequency=radioTxFrequency, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethGFPDropedFrames=ethGFPDropedFrames, licenseMask=licenseMask, ethRXDribleNibbles=ethRXDribleNibbles, modemAcqStatus=modemAcqStatus, modemCarrierOffset=modemCarrierOffset, vlanPortmap=vlanPortmap, ethTXPauseFrames=ethTXPauseFrames, e1t1ChannelNr=e1t1ChannelNr, ethTXCollisions=ethTXCollisions, ipRadio=ipRadio, modemE1T1ChannelMask=modemE1T1ChannelMask, modemACMengine=modemACMengine, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemSymbolRateTx=modemSymbolRateTx, remoteIp=remoteIp, description=description, ipRadioCfgGeneral=ipRadioCfgGeneral, vlanFid=vlanFid, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXBroadcasts=ethTXBroadcasts, ipRadioCfg=ipRadioCfg, ethRXCodeErrors=ethRXCodeErrors, radioDuplexShift=radioDuplexShift, radioEntry=radioEntry, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioTable=radioTable, ethTXByteCounterHi=ethTXByteCounterHi, radioIndex=radioIndex, modemErroredSecondRatio=modemErroredSecondRatio, localIp=localIp, modemTotalBlockNumber=modemTotalBlockNumber, ethRXPauseFrames=ethRXPauseFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXMaxCollisions=ethTXMaxCollisions, modemSymbolRateRx=modemSymbolRateRx, modemACMmodulationMax=modemACMmodulationMax, radioTxMute=radioTxMute, ethQOSTXDropped=ethQOSTXDropped, modemLDPCdecoderStress=modemLDPCdecoderStress, modemACMtotalCapacity=modemACMtotalCapacity, vlanNumber=vlanNumber, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, tehnika=tehnika, radioTxPower=radioTxPower, modemGeneralStatus=modemGeneralStatus, ethTXExcessiveDefers=ethTXExcessiveDefers, vlansEnabled=vlansEnabled, modemUnavailtime=modemUnavailtime, modemUptime=modemUptime, e1t1LOS=e1t1LOS, license=license, ipRadioMgmt=ipRadioMgmt, sysTemperature=sysTemperature, product=product, modemACMmodulationMin=modemACMmodulationMin, ethTXDones=ethTXDones, modemEthernetCapacity=modemEthernetCapacity, ethRXDones=ethRXDones, radioRxLevel=radioRxLevel, ethTXMulticasts=ethTXMulticasts, modemErroredBlock=modemErroredBlock, loopback_tributary_mask=loopback_tributary_mask, modemRowStatus=modemRowStatus, saf=saf, radioSide=radioSide, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, aTPCTable=aTPCTable, licenseUpdateStatus=licenseUpdateStatus, modemTotalCapacity=modemTotalCapacity, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemCountTime=modemCountTime, ethRXBroadcasts=ethRXBroadcasts, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, atpcEnabled=atpcEnabled, modemModulation=modemModulation, ethGFPCHECErrors=ethGFPCHECErrors, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioLoopback=radioLoopback, e1t1AIS=e1t1AIS, modemInternalAGCgain=modemInternalAGCgain, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXByteCounterHi=ethRXByteCounterHi, ipRadioStatEth=ipRadioStatEth, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXGiants=ethTXGiants, atpcTxPowerCorrection=atpcTxPowerCorrection, radioRxFrequency=radioRxFrequency, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemTable=modemTable, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXLongEvents=ethRXLongEvents, microwaveRadio=microwaveRadio, ethRXPrevPktDropped=ethRXPrevPktDropped, radioGenStatus=radioGenStatus, hostname=hostname, localIpMask=localIpMask, atpcIndex=atpcIndex)
