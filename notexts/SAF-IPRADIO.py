...
mibBuilder.exportSymbols("SAF-IPRADIO", sysTemperature=sysTemperature, modemRadialMSE=modemRadialMSE, ethTXUnderruns=ethTXUnderruns, ipRadioCfgNetwork=ipRadioCfgNetwork, e1t1LOS=e1t1LOS, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXPauseFrames=ethRXPauseFrames, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXDvEvent=ethRXDvEvent, vlanPortmap=vlanPortmap, atpcIndex=atpcIndex, aTPCTable=aTPCTable, radioGenStatus=radioGenStatus, ethRXCodeErrors=ethRXCodeErrors, ipRadio=ipRadio, ethRXMulticasts=ethRXMulticasts, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethGFPDropedFrames=ethGFPDropedFrames, modemACMtotalCapacity=modemACMtotalCapacity, modemACMengine=modemACMengine, ipRadioStatEth=ipRadioStatEth, modemErroredBlock=modemErroredBlock, ethRXByteCounterHi=ethRXByteCounterHi, ethGFPDelineationErrors=ethGFPDelineationErrors, writeConfig=writeConfig, modemSymbolRateRx=modemSymbolRateRx, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXByteCounterLow=ethTXByteCounterLow, localIp=localIp, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethGFPCHECErrors=ethGFPCHECErrors, ethTXMaxCollisions=ethTXMaxCollisions, ethTXCRCErrors=ethTXCRCErrors, remoteIp=remoteIp, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, localIpMask=localIpMask, modemE1T1ChannelMask=modemE1T1ChannelMask, radioRxLevel=radioRxLevel, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemStandard=modemStandard, radioSide=radioSide, radioRxFrequency=radioRxFrequency, ipRadioStat=ipRadioStat, ethTXCollisions=ethTXCollisions, ethRXBroadcasts=ethRXBroadcasts, modemAcqStatus=modemAcqStatus, modemIndex=modemIndex, ethQOSTXDropped=ethQOSTXDropped, modemBandwith=modemBandwith, modemACMethernetCapacity=modemACMethernetCapacity, pointToPoint=pointToPoint, modemTotalBlockNumber=modemTotalBlockNumber, modemUptime=modemUptime, atpcTxPowerCorrection=atpcTxPowerCorrection, modemUnavailtime=modemUnavailtime, modemErroredSecond=modemErroredSecond, sysDateAndTime=sysDateAndTime, modemSeverelyErroredSecond=modemSeverelyErroredSecond, vlanRowStatus=vlanRowStatus, ethRXLongEvents=ethRXLongEvents, modemInternalAGCgain=modemInternalAGCgain, ipRadioCfgGeneral=ipRadioCfgGeneral, hostname=hostname, modemTotalCapacity=modemTotalCapacity, vlansEnabled=vlansEnabled, product=product, radioIndex=radioIndex, microwaveRadio=microwaveRadio, e1t1StatEntry=e1t1StatEntry, modemGeneralStatus=modemGeneralStatus, vlanPortType=vlanPortType, restartcpu=restartcpu, safip=safip, modemErroredSecondRatio=modemErroredSecondRatio, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, aTPCEntry=aTPCEntry, modemCountTime=modemCountTime, ethTXBroadcasts=ethTXBroadcasts, modemRowStatus=modemRowStatus, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, e1t1ChannelNr=e1t1ChannelNr, ipRadioCfg=ipRadioCfg, licenseMask=licenseMask, modemTable=modemTable, ethTXVlanTags=ethTXVlanTags, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, license=license, loopback_tributary_mask=loopback_tributary_mask, ethTXByteCounterHi=ethTXByteCounterHi, atpcEnabled=atpcEnabled, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioTxFrequency=radioTxFrequency, modemEthernetCapacity=modemEthernetCapacity, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXByteCounterLow=ethRXByteCounterLow, modemCarrierOffset=modemCarrierOffset, ethTXGiants=ethTXGiants, e1t1AIS=e1t1AIS, ethTXPauseFrames=ethTXPauseFrames, e1t1StatTable=e1t1StatTable, ethRXDribleNibbles=ethRXDribleNibbles, vlanTable=vlanTable, ethQOSTXFrames=ethQOSTXFrames, vlanFid=vlanFid, ethRXDones=ethRXDones, description=description, modemACMmodulationMax=modemACMmodulationMax, ethTXDones=ethTXDones, radioLoopback=radioLoopback, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ipRadioMgmt=ipRadioMgmt, modemModulation=modemModulation, vlanEntry=vlanEntry, modemEntry=modemEntry, ethQOSRXQ2Frames=ethQOSRXQ2Frames, licenseUpdateStatus=licenseUpdateStatus, radioDuplexShift=radioDuplexShift, vlanNumber=vlanNumber, ethRXControlFrames=ethRXControlFrames, loopbacks=loopbacks, ethTXLateCollisions=ethTXLateCollisions, radioTxMute=radioTxMute, radioEntry=radioEntry, radioTable=radioTable, ethTXBackpresEvents=ethTXBackpresEvents, ethRXCRCErrors=ethRXCRCErrors, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXMulticasts=ethTXMulticasts, saf=saf, radioTxPower=radioTxPower, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemLastAcqError=modemLastAcqError, modemSymbolRateTx=modemSymbolRateTx, modemE1T1Channels=modemE1T1Channels, ethGFPFCSErrors=ethGFPFCSErrors, tehnika=tehnika, vlanCfgStat=vlanCfgStat, modemACMmodulationMin=modemACMmodulationMin, ethTXControlFrames=ethTXControlFrames, modemStatistics=modemStatistics)
