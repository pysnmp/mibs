...
mibBuilder.exportSymbols("SAF-IPRADIO", modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemTable=modemTable, ethTXDones=ethTXDones, radioEntry=radioEntry, ethRXControlFrames=ethRXControlFrames, vlanCfgStat=vlanCfgStat, modemStatistics=modemStatistics, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemLastAcqError=modemLastAcqError, pointToPoint=pointToPoint, radioTxFrequency=radioTxFrequency, ethRXDvEvent=ethRXDvEvent, ethRXCRCErrors=ethRXCRCErrors, aTPCEntry=aTPCEntry, loopbacks=loopbacks, restartcpu=restartcpu, description=description, e1t1StatTable=e1t1StatTable, aTPCTable=aTPCTable, modemEntry=modemEntry, radioIndex=radioIndex, ethTXGiants=ethTXGiants, e1t1ChannelNr=e1t1ChannelNr, modemModulation=modemModulation, radioTxMute=radioTxMute, radioRxFrequency=radioRxFrequency, saf=saf, e1t1LOS=e1t1LOS, modemEthernetCapacity=modemEthernetCapacity, modemACMengine=modemACMengine, ethRXDribleNibbles=ethRXDribleNibbles, vlanEntry=vlanEntry, ethRXByteCounterHi=ethRXByteCounterHi, modemTotalBlockNumber=modemTotalBlockNumber, ethTXCollisions=ethTXCollisions, localIp=localIp, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXMulticasts=ethTXMulticasts, radioTxPower=radioTxPower, atpcEnabled=atpcEnabled, loopback_tributary_mask=loopback_tributary_mask, ipRadioMgmt=ipRadioMgmt, vlanPortType=vlanPortType, safip=safip, modemSeverelyErroredSecond=modemSeverelyErroredSecond, product=product, modemSymbolRateTx=modemSymbolRateTx, ethRXByteCounterLow=ethRXByteCounterLow, ethTXMaxCollisions=ethTXMaxCollisions, modemTotalCapacity=modemTotalCapacity, tehnika=tehnika, ethTXByteCounterHi=ethTXByteCounterHi, ethTXUnderruns=ethTXUnderruns, writeConfig=writeConfig, modemACMethernetCapacity=modemACMethernetCapacity, modemErroredBlock=modemErroredBlock, ethTXVlanTags=ethTXVlanTags, ethRXVlanTagsDetected=ethRXVlanTagsDetected, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXControlFrames=ethTXControlFrames, ethRXPauseFrames=ethRXPauseFrames, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioLoopback=radioLoopback, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, e1t1AIS=e1t1AIS, sysDateAndTime=sysDateAndTime, modemE1T1Channels=modemE1T1Channels, ipRadioStatEth=ipRadioStatEth, ethQOSTXDropped=ethQOSTXDropped, licenseMask=licenseMask, remoteIp=remoteIp, modemACMmodulationMax=modemACMmodulationMax, localIpMask=localIpMask, vlansEnabled=vlansEnabled, vlanNumber=vlanNumber, ethGFPDropedFrames=ethGFPDropedFrames, ipRadioCfgGeneral=ipRadioCfgGeneral, radioDuplexShift=radioDuplexShift, modemBandwith=modemBandwith, ethRXCodeErrors=ethRXCodeErrors, sysTemperature=sysTemperature, ethRXBroadcasts=ethRXBroadcasts, modemInternalAGCgain=modemInternalAGCgain, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioSide=radioSide, ethRXMulticasts=ethRXMulticasts, ipRadioStat=ipRadioStat, licenseUpdateStatus=licenseUpdateStatus, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemErroredSecond=modemErroredSecond, vlanTable=vlanTable, license=license, radioTable=radioTable, ethTXByteCounterLow=ethTXByteCounterLow, vlanFid=vlanFid, ipRadio=ipRadio, hostname=hostname, modemUptime=modemUptime, ethTXCRCErrors=ethTXCRCErrors, atpcIndex=atpcIndex, ipRadioCfgNetwork=ipRadioCfgNetwork, vlanRowStatus=vlanRowStatus, ethTXBroadcasts=ethTXBroadcasts, modemSymbolRateRx=modemSymbolRateRx, e1t1StatEntry=e1t1StatEntry, ethRXTruncatedFrames=ethRXTruncatedFrames, vlanPortmap=vlanPortmap, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXLateCollisions=ethTXLateCollisions, modemE1T1ChannelMask=modemE1T1ChannelMask, ethGFPCHECErrors=ethGFPCHECErrors, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioGenStatus=radioGenStatus, modemCarrierOffset=modemCarrierOffset, modemLDPCdecoderStress=modemLDPCdecoderStress, ethGFPFCSErrors=ethGFPFCSErrors, modemACMmodulationMin=modemACMmodulationMin, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemUnavailtime=modemUnavailtime, modemIndex=modemIndex, ethQOSTXFrames=ethQOSTXFrames, radioRxLevel=radioRxLevel, modemRadialMSE=modemRadialMSE, ethRXDones=ethRXDones, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXLongEvents=ethRXLongEvents, modemACMtotalCapacity=modemACMtotalCapacity, modemGeneralStatus=modemGeneralStatus, microwaveRadio=microwaveRadio, modemStandard=modemStandard, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXPrevPktDropped=ethRXPrevPktDropped, modemAcqStatus=modemAcqStatus, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemRowStatus=modemRowStatus, ethTXBackpresEvents=ethTXBackpresEvents, modemErroredSecondRatio=modemErroredSecondRatio, modemCountTime=modemCountTime, ethTXPauseFrames=ethTXPauseFrames, ipRadioCfg=ipRadioCfg)
