...
mibBuilder.exportSymbols("SAF-IPRADIO", ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, vlanNumber=vlanNumber, vlansEnabled=vlansEnabled, description=description, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, e1t1ChannelNr=e1t1ChannelNr, modemBandwith=modemBandwith, aTPCTable=aTPCTable, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemGeneralStatus=modemGeneralStatus, vlanFid=vlanFid, ethTXVlanTags=ethTXVlanTags, radioIndex=radioIndex, radioTable=radioTable, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXByteCounterHi=ethTXByteCounterHi, loopback_tributary_mask=loopback_tributary_mask, ethQOSTXDropped=ethQOSTXDropped, microwaveRadio=microwaveRadio, safip=safip, product=product, vlanPortType=vlanPortType, vlanEntry=vlanEntry, modemIndex=modemIndex, vlanRowStatus=vlanRowStatus, ethTXGiants=ethTXGiants, ethGFPDropedFrames=ethGFPDropedFrames, atpcIndex=atpcIndex, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemModulation=modemModulation, ethRXTruncatedFrames=ethRXTruncatedFrames, licenseUpdateStatus=licenseUpdateStatus, licenseMask=licenseMask, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemE1T1Channels=modemE1T1Channels, ethTXByteCounterLow=ethTXByteCounterLow, ethTXBroadcasts=ethTXBroadcasts, e1t1AIS=e1t1AIS, modemErroredSecond=modemErroredSecond, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemLastAcqError=modemLastAcqError, radioEntry=radioEntry, radioRxFrequency=radioRxFrequency, radioGenStatus=radioGenStatus, vlanCfgStat=vlanCfgStat, ethRXBroadcasts=ethRXBroadcasts, ipRadioCfgNetwork=ipRadioCfgNetwork, radioDuplexShift=radioDuplexShift, radioTxFrequency=radioTxFrequency, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXCollisions=ethTXCollisions, ethRXCRCErrors=ethRXCRCErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror, remoteIp=remoteIp, modemACMengine=modemACMengine, ethRXDones=ethRXDones, modemACMtotalCapacity=modemACMtotalCapacity, radioLoopback=radioLoopback, ethRXDribleNibbles=ethRXDribleNibbles, modemStandard=modemStandard, ethTXControlFrames=ethTXControlFrames, modemStatistics=modemStatistics, aTPCEntry=aTPCEntry, modemACMmodulationMin=modemACMmodulationMin, saf=saf, ethQOSTXFrames=ethQOSTXFrames, restartcpu=restartcpu, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, vlanTable=vlanTable, ethTXMulticasts=ethTXMulticasts, modemTotalBlockNumber=modemTotalBlockNumber, ethGFPFCSErrors=ethGFPFCSErrors, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemACMmodulationMax=modemACMmodulationMax, ipRadioStatEth=ipRadioStatEth, modemEthernetCapacity=modemEthernetCapacity, ethRXDvEvent=ethRXDvEvent, ethRXByteCounterLow=ethRXByteCounterLow, ethTXPauseFrames=ethTXPauseFrames, ethTXDones=ethTXDones, modemRowStatus=modemRowStatus, license=license, modemTotalCapacity=modemTotalCapacity, radioSide=radioSide, modemCountTime=modemCountTime, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXPauseFrames=ethRXPauseFrames, modemErroredBlock=modemErroredBlock, ethTXExcessiveDefers=ethTXExcessiveDefers, modemTable=modemTable, vlanPortmap=vlanPortmap, localIpMask=localIpMask, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXMaxCollisions=ethTXMaxCollisions, ethRXCodeErrors=ethRXCodeErrors, ethGFPDelineationErrors=ethGFPDelineationErrors, sysDateAndTime=sysDateAndTime, ipRadioMgmt=ipRadioMgmt, ethGFPCHECErrors=ethGFPCHECErrors, radioTxPower=radioTxPower, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemACMethernetCapacity=modemACMethernetCapacity, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXBackpresEvents=ethTXBackpresEvents, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXUnderruns=ethTXUnderruns, ethTXLateCollisions=ethTXLateCollisions, localIp=localIp, modemCarrierOffset=modemCarrierOffset, radioTxMute=radioTxMute, ethRXPrevPktDropped=ethRXPrevPktDropped, e1t1StatEntry=e1t1StatEntry, ipRadioCfg=ipRadioCfg, ethRXControlFrames=ethRXControlFrames, modemInternalAGCgain=modemInternalAGCgain, modemRadialMSE=modemRadialMSE, ethRXMulticasts=ethRXMulticasts, ipRadioStat=ipRadioStat, radioRxLevel=radioRxLevel, e1t1StatTable=e1t1StatTable, sysTemperature=sysTemperature, ethRXLongEvents=ethRXLongEvents, ipRadio=ipRadio, modemUnavailtime=modemUnavailtime, pointToPoint=pointToPoint, modemSymbolRateTx=modemSymbolRateTx, ethTXWireByteCounterLow=ethTXWireByteCounterLow, atpcEnabled=atpcEnabled, tehnika=tehnika, hostname=hostname, modemAcqStatus=modemAcqStatus, modemUptime=modemUptime, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXByteCounterHi=ethRXByteCounterHi, modemSymbolRateRx=modemSymbolRateRx, modemErroredSecondRatio=modemErroredSecondRatio, modemEntry=modemEntry, writeConfig=writeConfig, loopbacks=loopbacks, e1t1LOS=e1t1LOS, ethTXCRCErrors=ethTXCRCErrors)
