...
mibBuilder.exportSymbols("SAF-IPRADIO", radioRxLevel=radioRxLevel, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXMaxCollisions=ethTXMaxCollisions, radioTxMute=radioTxMute, license=license, ethGFPCHECErrors=ethGFPCHECErrors, modemErroredBlock=modemErroredBlock, modemACMtotalCapacity=modemACMtotalCapacity, writeConfig=writeConfig, modemEthernetCapacity=modemEthernetCapacity, loopbacks=loopbacks, hostname=hostname, modemE1T1ChannelMask=modemE1T1ChannelMask, pointToPoint=pointToPoint, radioGenStatus=radioGenStatus, tehnika=tehnika, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, e1t1ChannelNr=e1t1ChannelNr, modemE1T1Channels=modemE1T1Channels, modemInternalAGCgain=modemInternalAGCgain, modemStandard=modemStandard, ethTXByteCounterHi=ethTXByteCounterHi, modemTotalBlockNumber=modemTotalBlockNumber, modemRowStatus=modemRowStatus, modemSymbolRateTx=modemSymbolRateTx, ethRXUnsupOpcodes=ethRXUnsupOpcodes, vlansEnabled=vlansEnabled, vlanCfgStat=vlanCfgStat, ethTXDones=ethTXDones, radioTxFrequency=radioTxFrequency, modemEntry=modemEntry, ethQOSTXDropped=ethQOSTXDropped, ethRXLongEvents=ethRXLongEvents, modemErroredSecond=modemErroredSecond, localIpMask=localIpMask, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioSide=radioSide, localIp=localIp, modemSymbolRateRx=modemSymbolRateRx, ethRXMulticasts=ethRXMulticasts, sysDateAndTime=sysDateAndTime, ethGFPFCSErrors=ethGFPFCSErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlanNumber=vlanNumber, modemTotalCapacity=modemTotalCapacity, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXCollisions=ethTXCollisions, e1t1StatEntry=e1t1StatEntry, ethTXByteCounterLow=ethTXByteCounterLow, ethTXCRCErrors=ethTXCRCErrors, atpcTxPowerCorrection=atpcTxPowerCorrection, modemModulation=modemModulation, ethTXGiants=ethTXGiants, ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlanTable=vlanTable, ethRXPauseFrames=ethRXPauseFrames, e1t1AIS=e1t1AIS, ipRadio=ipRadio, radioTxPower=radioTxPower, atpcEnabled=atpcEnabled, modemACMmodulationMin=modemACMmodulationMin, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, safip=safip, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemACMethernetCapacity=modemACMethernetCapacity, ethRXCRCErrors=ethRXCRCErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, product=product, radioLoopback=radioLoopback, ethTXVlanTags=ethTXVlanTags, ipRadioCfg=ipRadioCfg, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemAcqStatus=modemAcqStatus, ethQOSTXFrames=ethQOSTXFrames, ethTXControlFrames=ethTXControlFrames, modemTable=modemTable, modemBandwith=modemBandwith, ethRXDvEvent=ethRXDvEvent, modemCountTime=modemCountTime, modemGeneralStatus=modemGeneralStatus, modemIndex=modemIndex, ethTXBroadcasts=ethTXBroadcasts, e1t1LOS=e1t1LOS, radioIndex=radioIndex, ethRXDribleNibbles=ethRXDribleNibbles, ethRXCodeErrors=ethRXCodeErrors, vlanRowStatus=vlanRowStatus, modemErroredSecondRatio=modemErroredSecondRatio, vlanEntry=vlanEntry, modemACMmodulationMax=modemACMmodulationMax, ethTXBackpresEvents=ethTXBackpresEvents, modemRadialMSE=modemRadialMSE, radioEntry=radioEntry, radioRxFrequency=radioRxFrequency, ethRXBroadcasts=ethRXBroadcasts, ethRXPrevPktDropped=ethRXPrevPktDropped, atpcIndex=atpcIndex, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXUnderruns=ethTXUnderruns, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXByteCounterLow=ethRXByteCounterLow, vlanFid=vlanFid, microwaveRadio=microwaveRadio, licenseUpdateStatus=licenseUpdateStatus, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXLateCollisions=ethTXLateCollisions, ethQOSRXQ2Frames=ethQOSRXQ2Frames, description=description, vlanPortmap=vlanPortmap, radioTable=radioTable, remoteIp=remoteIp, ethRXByteCounterHi=ethRXByteCounterHi, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethGFPDropedFrames=ethGFPDropedFrames, modemStatistics=modemStatistics, aTPCTable=aTPCTable, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemCarrierOffset=modemCarrierOffset, ipRadioStatEth=ipRadioStatEth, modemLastAcqError=modemLastAcqError, restartcpu=restartcpu, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemUnavailtime=modemUnavailtime, ipRadioStat=ipRadioStat, ethTXPauseFrames=ethTXPauseFrames, saf=saf, ethTXMulticasts=ethTXMulticasts, ethTXExcessiveDefers=ethTXExcessiveDefers, ipRadioCfgGeneral=ipRadioCfgGeneral, radioDuplexShift=radioDuplexShift, loopback_tributary_mask=loopback_tributary_mask, ethRXDones=ethRXDones, ipRadioMgmt=ipRadioMgmt, aTPCEntry=aTPCEntry, ethRXControlFrames=ethRXControlFrames, modemUptime=modemUptime, e1t1StatTable=e1t1StatTable, licenseMask=licenseMask, modemACMengine=modemACMengine, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, vlanPortType=vlanPortType, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, sysTemperature=sysTemperature)
