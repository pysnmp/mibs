...
mibBuilder.exportSymbols("SAF-IPRADIO", modemModulation=modemModulation, ethRXControlFrames=ethRXControlFrames, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethQOSRXQ1Frames=ethQOSRXQ1Frames, e1t1LOS=e1t1LOS, modemTable=modemTable, licenseUpdateStatus=licenseUpdateStatus, ethGFPFCSErrors=ethGFPFCSErrors, modemACMmodulationMin=modemACMmodulationMin, ethTXWireByteCounterHi=ethTXWireByteCounterHi, microwaveRadio=microwaveRadio, ethRXByteCounterHi=ethRXByteCounterHi, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, hostname=hostname, ethQOSRXQ2Frames=ethQOSRXQ2Frames, sysTemperature=sysTemperature, vlanFid=vlanFid, modemAcqStatus=modemAcqStatus, modemUptime=modemUptime, ipRadio=ipRadio, modemACMmodulationMax=modemACMmodulationMax, ethRXCRCErrors=ethRXCRCErrors, ethTXBackpresEvents=ethTXBackpresEvents, radioTxMute=radioTxMute, modemTotalCapacity=modemTotalCapacity, ethRXBroadcasts=ethRXBroadcasts, e1t1ChannelNr=e1t1ChannelNr, modemErroredSecondRatio=modemErroredSecondRatio, vlanCfgStat=vlanCfgStat, modemE1T1ChannelMask=modemE1T1ChannelMask, aTPCTable=aTPCTable, modemStandard=modemStandard, modemACMtotalCapacity=modemACMtotalCapacity, ethTXLateCollisions=ethTXLateCollisions, e1t1StatEntry=e1t1StatEntry, modemBandwith=modemBandwith, ethRXVlanTagsDetected=ethRXVlanTagsDetected, restartcpu=restartcpu, modemACMethernetCapacity=modemACMethernetCapacity, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXByteCounterLow=ethRXByteCounterLow, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXLengthCheckErrors=ethTXLengthCheckErrors, vlanEntry=vlanEntry, radioSide=radioSide, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethQOSTXDropped=ethQOSTXDropped, ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, modemE1T1Channels=modemE1T1Channels, ethTXBroadcasts=ethTXBroadcasts, localIp=localIp, writeConfig=writeConfig, ethRXDribleNibbles=ethRXDribleNibbles, ipRadioCfgGeneral=ipRadioCfgGeneral, licenseMask=licenseMask, modemSymbolRateRx=modemSymbolRateRx, radioTxFrequency=radioTxFrequency, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXWireByteCounterLow=ethTXWireByteCounterLow, remoteIp=remoteIp, ipRadioStat=ipRadioStat, ethTXByteCounterLow=ethTXByteCounterLow, loopback_tributary_mask=loopback_tributary_mask, radioTable=radioTable, modemIndex=modemIndex, ethTXExcessiveDefers=ethTXExcessiveDefers, radioEntry=radioEntry, atpcIndex=atpcIndex, ethTXDones=ethTXDones, description=description, modemCountTime=modemCountTime, modemUnavailtime=modemUnavailtime, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, e1t1AIS=e1t1AIS, radioIndex=radioIndex, ipRadioCfg=ipRadioCfg, ethRXCodeErrors=ethRXCodeErrors, ethGFPCHECErrors=ethGFPCHECErrors, ethGFPDropedFrames=ethGFPDropedFrames, modemLDPCdecoderStress=modemLDPCdecoderStress, vlansEnabled=vlansEnabled, tehnika=tehnika, radioRxLevel=radioRxLevel, modemInternalAGCgain=modemInternalAGCgain, ethRXDones=ethRXDones, product=product, ethTXPauseFrames=ethTXPauseFrames, vlanNumber=vlanNumber, pointToPoint=pointToPoint, atpcTxPowerCorrection=atpcTxPowerCorrection, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ipRadioStatEth=ipRadioStatEth, modemErroredSecond=modemErroredSecond, radioLoopback=radioLoopback, ethTXControlFrames=ethTXControlFrames, radioTxPower=radioTxPower, ipRadioMgmt=ipRadioMgmt, modemEthernetCapacity=modemEthernetCapacity, modemTotalBlockNumber=modemTotalBlockNumber, ethQOSTXFrames=ethQOSTXFrames, sysDateAndTime=sysDateAndTime, aTPCEntry=aTPCEntry, ethTXCollisions=ethTXCollisions, ethRXMulticasts=ethRXMulticasts, ethTXUnderruns=ethTXUnderruns, ethTXGiants=ethTXGiants, loopbacks=loopbacks, radioRxFrequency=radioRxFrequency, modemRadialMSE=modemRadialMSE, modemStatistics=modemStatistics, modemErroredBlock=modemErroredBlock, safip=safip, license=license, vlanTable=vlanTable, modemEntry=modemEntry, ethRXLongEvents=ethRXLongEvents, modemACMengine=modemACMengine, atpcEnabled=atpcEnabled, modemSymbolRateTx=modemSymbolRateTx, ethTXCRCErrors=ethTXCRCErrors, modemRowStatus=modemRowStatus, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXVlanTags=ethTXVlanTags, modemCarrierOffset=modemCarrierOffset, ethRXPauseFrames=ethRXPauseFrames, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, vlanRowStatus=vlanRowStatus, ethRXPrevPktDropped=ethRXPrevPktDropped, saf=saf, modemGeneralStatus=modemGeneralStatus, radioDuplexShift=radioDuplexShift, ethRXDvEvent=ethRXDvEvent, radioGenStatus=radioGenStatus, localIpMask=localIpMask, ethTXByteCounterHi=ethTXByteCounterHi, e1t1StatTable=e1t1StatTable, ethTXMaxCollisions=ethTXMaxCollisions, vlanPortmap=vlanPortmap, ethTXMulticasts=ethTXMulticasts, vlanPortType=vlanPortType, modemLastAcqError=modemLastAcqError)
