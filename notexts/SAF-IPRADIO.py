...
mibBuilder.exportSymbols("SAF-IPRADIO", modemE1T1Channels=modemE1T1Channels, ipRadioCfg=ipRadioCfg, ipRadioCfgGeneral=ipRadioCfgGeneral, modemACMmodulationMin=modemACMmodulationMin, hostname=hostname, tehnika=tehnika, modemTotalBlockNumber=modemTotalBlockNumber, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXCodeErrors=ethRXCodeErrors, ethTXDones=ethTXDones, modemLastAcqError=modemLastAcqError, ethRXMulticasts=ethRXMulticasts, ethGFPCHECErrors=ethGFPCHECErrors, ethGFPFCSErrors=ethGFPFCSErrors, ethRXLongEvents=ethRXLongEvents, product=product, vlanNumber=vlanNumber, modemErroredBlock=modemErroredBlock, modemBandwith=modemBandwith, ethTXByteCounterLow=ethTXByteCounterLow, ipRadio=ipRadio, ipRadioCfgNetwork=ipRadioCfgNetwork, ipRadioStat=ipRadioStat, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, saf=saf, ethRXPrevPktDropped=ethRXPrevPktDropped, modemACMmodulationMax=modemACMmodulationMax, ethTXUnderruns=ethTXUnderruns, modemACMengine=modemACMengine, modemSymbolRateRx=modemSymbolRateRx, ethQOSRXQ1Frames=ethQOSRXQ1Frames, remoteIp=remoteIp, modemEthernetCapacity=modemEthernetCapacity, localIp=localIp, vlanPortType=vlanPortType, ethRXByteCounterHi=ethRXByteCounterHi, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemErroredSecond=modemErroredSecond, modemIndex=modemIndex, ethTXLengthCheckErrors=ethTXLengthCheckErrors, e1t1LOS=e1t1LOS, radioIndex=radioIndex, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, atpcTxPowerCorrection=atpcTxPowerCorrection, loopbacks=loopbacks, ipRadioStatEth=ipRadioStatEth, ethRXUnsupOpcodes=ethRXUnsupOpcodes, sysDateAndTime=sysDateAndTime, radioRxLevel=radioRxLevel, license=license, e1t1StatTable=e1t1StatTable, ethRXControlFrames=ethRXControlFrames, radioDuplexShift=radioDuplexShift, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXMulticasts=ethTXMulticasts, ipRadioMgmt=ipRadioMgmt, modemUptime=modemUptime, microwaveRadio=microwaveRadio, atpcEnabled=atpcEnabled, writeConfig=writeConfig, ethRXVlanTagsDetected=ethRXVlanTagsDetected, restartcpu=restartcpu, atpcIndex=atpcIndex, ethTXBackpresEvents=ethTXBackpresEvents, modemAcqStatus=modemAcqStatus, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioTxMute=radioTxMute, vlanCfgStat=vlanCfgStat, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXCRCErrors=ethTXCRCErrors, ethQOSTXDropped=ethQOSTXDropped, modemGeneralStatus=modemGeneralStatus, licenseUpdateStatus=licenseUpdateStatus, modemLDPCdecoderStress=modemLDPCdecoderStress, modemInternalAGCgain=modemInternalAGCgain, ethTXGiants=ethTXGiants, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemACMethernetCapacity=modemACMethernetCapacity, ethTXControlFrames=ethTXControlFrames, ethTXExcessiveDefers=ethTXExcessiveDefers, localIpMask=localIpMask, e1t1ChannelNr=e1t1ChannelNr, modemACMtotalCapacity=modemACMtotalCapacity, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemStandard=modemStandard, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXWireByteCounterHi=ethTXWireByteCounterHi, vlanPortmap=vlanPortmap, e1t1AIS=e1t1AIS, modemTable=modemTable, modemErroredSecondRatio=modemErroredSecondRatio, ethRXByteCounterLow=ethRXByteCounterLow, modemRowStatus=modemRowStatus, ethRXDvEvent=ethRXDvEvent, ethTXByteCounterHi=ethTXByteCounterHi, modemRadialMSE=modemRadialMSE, ethRXCRCErrors=ethRXCRCErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemCarrierOffset=modemCarrierOffset, ethGFPDelineationErrors=ethGFPDelineationErrors, e1t1StatEntry=e1t1StatEntry, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioLoopback=radioLoopback, vlansEnabled=vlansEnabled, modemModulation=modemModulation, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXVlanTags=ethTXVlanTags, ethTXLateCollisions=ethTXLateCollisions, radioSide=radioSide, radioTxPower=radioTxPower, modemUnavailtime=modemUnavailtime, modemCountTime=modemCountTime, safip=safip, modemTotalCapacity=modemTotalCapacity, pointToPoint=pointToPoint, vlanTable=vlanTable, radioGenStatus=radioGenStatus, radioRxFrequency=radioRxFrequency, ethTXMaxCollisions=ethTXMaxCollisions, vlanEntry=vlanEntry, radioTxFrequency=radioTxFrequency, ethRXDribleNibbles=ethRXDribleNibbles, radioTable=radioTable, aTPCEntry=aTPCEntry, vlanFid=vlanFid, description=description, ethTXPauseFrames=ethTXPauseFrames, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemEntry=modemEntry, radioEntry=radioEntry, ethTXCollisions=ethTXCollisions, vlanRowStatus=vlanRowStatus, ethTXBroadcasts=ethTXBroadcasts, sysTemperature=sysTemperature, ethRXDones=ethRXDones, ethGFPDropedFrames=ethGFPDropedFrames, loopback_tributary_mask=loopback_tributary_mask, ethQOSTXFrames=ethQOSTXFrames, modemStatistics=modemStatistics, aTPCTable=aTPCTable, licenseMask=licenseMask, ethRXBroadcasts=ethRXBroadcasts, ethRXPauseFrames=ethRXPauseFrames, modemSymbolRateTx=modemSymbolRateTx)
