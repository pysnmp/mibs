...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXCRCErrors=ethRXCRCErrors, ethRXCodeErrors=ethRXCodeErrors, modemLastAcqError=modemLastAcqError, modemErroredSecond=modemErroredSecond, radioIndex=radioIndex, modemInternalAGCgain=modemInternalAGCgain, localIp=localIp, modemSymbolRateTx=modemSymbolRateTx, sysDateAndTime=sysDateAndTime, ethRXByteCounterLow=ethRXByteCounterLow, modemTotalBlockNumber=modemTotalBlockNumber, radioTable=radioTable, vlansEnabled=vlansEnabled, ethRXBroadcasts=ethRXBroadcasts, modemACMethernetCapacity=modemACMethernetCapacity, ethTXVlanTags=ethTXVlanTags, radioSide=radioSide, product=product, microwaveRadio=microwaveRadio, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXUnderruns=ethTXUnderruns, ipRadioCfgGeneral=ipRadioCfgGeneral, modemTotalCapacity=modemTotalCapacity, ipRadioMgmt=ipRadioMgmt, ethTXLengthCheckErrors=ethTXLengthCheckErrors, radioTxMute=radioTxMute, license=license, ethRXDvEvent=ethRXDvEvent, vlanNumber=vlanNumber, modemModulation=modemModulation, licenseUpdateStatus=licenseUpdateStatus, ethRXMulticasts=ethRXMulticasts, radioDuplexShift=radioDuplexShift, modemGeneralStatus=modemGeneralStatus, licenseMask=licenseMask, ethGFPCHECErrors=ethGFPCHECErrors, modemE1T1ChannelMask=modemE1T1ChannelMask, modemSeverelyErroredSecond=modemSeverelyErroredSecond, restartcpu=restartcpu, ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlanPortmap=vlanPortmap, modemTable=modemTable, ipRadio=ipRadio, modemCountTime=modemCountTime, e1t1LOS=e1t1LOS, modemEntry=modemEntry, atpcTxPowerCorrection=atpcTxPowerCorrection, aTPCEntry=aTPCEntry, ethGFPDropedFrames=ethGFPDropedFrames, radioLoopback=radioLoopback, ethTXExcessiveDefers=ethTXExcessiveDefers, radioRxLevel=radioRxLevel, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemCarrierOffset=modemCarrierOffset, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXControlFrames=ethTXControlFrames, ethTXByteCounterLow=ethTXByteCounterLow, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXByteCounterHi=ethTXByteCounterHi, atpcIndex=atpcIndex, radioRxFrequency=radioRxFrequency, modemErroredBlock=modemErroredBlock, vlanEntry=vlanEntry, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethQOSTXDropped=ethQOSTXDropped, modemBandwith=modemBandwith, ethTXMaxCollisions=ethTXMaxCollisions, modemE1T1Channels=modemE1T1Channels, modemStandard=modemStandard, loopbacks=loopbacks, modemACMtotalCapacity=modemACMtotalCapacity, modemSymbolRateRx=modemSymbolRateRx, sysTemperature=sysTemperature, ethTXMulticasts=ethTXMulticasts, ethQOSTXFrames=ethQOSTXFrames, safip=safip, ethTXGiants=ethTXGiants, modemACMmodulationMax=modemACMmodulationMax, ethTXLateCollisions=ethTXLateCollisions, ethRXPauseFrames=ethRXPauseFrames, modemUnavailtime=modemUnavailtime, ethTXBroadcasts=ethTXBroadcasts, atpcEnabled=atpcEnabled, vlanFid=vlanFid, ipRadioStatEth=ipRadioStatEth, ethTXCollisions=ethTXCollisions, ethGFPDelineationErrors=ethGFPDelineationErrors, radioGenStatus=radioGenStatus, description=description, e1t1StatEntry=e1t1StatEntry, modemEthernetCapacity=modemEthernetCapacity, tehnika=tehnika, vlanCfgStat=vlanCfgStat, modemAcqStatus=modemAcqStatus, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemErroredSecondRatio=modemErroredSecondRatio, ethRXDribleNibbles=ethRXDribleNibbles, vlanTable=vlanTable, aTPCTable=aTPCTable, ipRadioStat=ipRadioStat, radioTxPower=radioTxPower, e1t1StatTable=e1t1StatTable, modemACMengine=modemACMengine, modemIndex=modemIndex, remoteIp=remoteIp, loopback_tributary_mask=loopback_tributary_mask, e1t1ChannelNr=e1t1ChannelNr, modemACMmodulationMin=modemACMmodulationMin, ethRXDones=ethRXDones, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, vlanRowStatus=vlanRowStatus, modemRadialMSE=modemRadialMSE, ethRXPrevPktDropped=ethRXPrevPktDropped, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ipRadioCfg=ipRadioCfg, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXControlFrames=ethRXControlFrames, ethTXDones=ethTXDones, ethRXByteCounterHi=ethRXByteCounterHi, localIpMask=localIpMask, writeConfig=writeConfig, ethTXCRCErrors=ethTXCRCErrors, modemStatistics=modemStatistics, modemUptime=modemUptime, ethTXBackpresEvents=ethTXBackpresEvents, vlanPortType=vlanPortType, radioEntry=radioEntry, pointToPoint=pointToPoint, hostname=hostname, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXPauseFrames=ethTXPauseFrames, modemRowStatus=modemRowStatus, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ipRadioCfgNetwork=ipRadioCfgNetwork, radioTxFrequency=radioTxFrequency, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, saf=saf, ethRXLongEvents=ethRXLongEvents, e1t1AIS=e1t1AIS, ethGFPFCSErrors=ethGFPFCSErrors)
