...
mibBuilder.exportSymbols("SAF-IPRADIO", pointToPoint=pointToPoint, radioTxPower=radioTxPower, sysDateAndTime=sysDateAndTime, ethTXUnderruns=ethTXUnderruns, license=license, e1t1ChannelNr=e1t1ChannelNr, localIpMask=localIpMask, radioGenStatus=radioGenStatus, ethRXLongEvents=ethRXLongEvents, ethTXWireByteCounterLow=ethTXWireByteCounterLow, loopbacks=loopbacks, ethTXMulticasts=ethTXMulticasts, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemSymbolRateRx=modemSymbolRateRx, ethTXVlanTags=ethTXVlanTags, ethRXByteCounterHi=ethRXByteCounterHi, radioRxLevel=radioRxLevel, ethQOSRXQ1Frames=ethQOSRXQ1Frames, atpcTxPowerCorrection=atpcTxPowerCorrection, atpcIndex=atpcIndex, ethTXLateCollisions=ethTXLateCollisions, modemE1T1Channels=modemE1T1Channels, ethGFPDelineationErrors=ethGFPDelineationErrors, ethGFPCHECErrors=ethGFPCHECErrors, modemBandwith=modemBandwith, modemTotalCapacity=modemTotalCapacity, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXDribleNibbles=ethRXDribleNibbles, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemStandard=modemStandard, saf=saf, ethRXVlanTagsDetected=ethRXVlanTagsDetected, writeConfig=writeConfig, ipRadio=ipRadio, modemCarrierOffset=modemCarrierOffset, modemUnavailtime=modemUnavailtime, ipRadioCfgGeneral=ipRadioCfgGeneral, modemStatistics=modemStatistics, modemGeneralStatus=modemGeneralStatus, ipRadioMgmt=ipRadioMgmt, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioTxMute=radioTxMute, ethTXByteCounterLow=ethTXByteCounterLow, ethGFPDropedFrames=ethGFPDropedFrames, localIp=localIp, modemCountTime=modemCountTime, modemRowStatus=modemRowStatus, modemLDPCdecoderStress=modemLDPCdecoderStress, modemErroredBlock=modemErroredBlock, ethTXCRCErrors=ethTXCRCErrors, radioLoopback=radioLoopback, ethTXByteCounterHi=ethTXByteCounterHi, radioTable=radioTable, radioTxFrequency=radioTxFrequency, modemAcqStatus=modemAcqStatus, modemUptime=modemUptime, vlanTable=vlanTable, modemModulation=modemModulation, remoteIp=remoteIp, safip=safip, ethTXPauseFrames=ethTXPauseFrames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXPauseFrames=ethRXPauseFrames, licenseMask=licenseMask, description=description, loopback_tributary_mask=loopback_tributary_mask, vlanPortType=vlanPortType, modemEthernetCapacity=modemEthernetCapacity, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXBackpresEvents=ethTXBackpresEvents, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, e1t1LOS=e1t1LOS, atpcEnabled=atpcEnabled, vlansEnabled=vlansEnabled, ethTXGiants=ethTXGiants, ethTXBroadcasts=ethTXBroadcasts, vlanCfgStat=vlanCfgStat, modemErroredSecond=modemErroredSecond, sysTemperature=sysTemperature, ethTXExcessiveDefers=ethTXExcessiveDefers, vlanFid=vlanFid, e1t1StatEntry=e1t1StatEntry, ipRadioStatEth=ipRadioStatEth, ethRXDvEvent=ethRXDvEvent, radioSide=radioSide, e1t1StatTable=e1t1StatTable, product=product, ipRadioStat=ipRadioStat, vlanRowStatus=vlanRowStatus, modemSymbolRateTx=modemSymbolRateTx, ethRXDones=ethRXDones, restartcpu=restartcpu, ethTXCollisions=ethTXCollisions, modemACMmodulationMax=modemACMmodulationMax, modemLastAcqError=modemLastAcqError, radioEntry=radioEntry, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, aTPCTable=aTPCTable, modemIndex=modemIndex, ethQOSTXFrames=ethQOSTXFrames, radioRxFrequency=radioRxFrequency, ipRadioCfg=ipRadioCfg, modemE1T1ChannelMask=modemE1T1ChannelMask, radioIndex=radioIndex, modemInternalAGCgain=modemInternalAGCgain, hostname=hostname, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXMulticasts=ethRXMulticasts, ethTXControlFrames=ethTXControlFrames, licenseUpdateStatus=licenseUpdateStatus, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXCodeErrors=ethRXCodeErrors, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemACMengine=modemACMengine, ethRXBroadcasts=ethRXBroadcasts, tehnika=tehnika, e1t1AIS=e1t1AIS, ethTXDones=ethTXDones, modemACMethernetCapacity=modemACMethernetCapacity, ethRXCRCErrors=ethRXCRCErrors, modemTable=modemTable, modemErroredSecondRatio=modemErroredSecondRatio, aTPCEntry=aTPCEntry, radioDuplexShift=radioDuplexShift, vlanEntry=vlanEntry, ethRXByteCounterLow=ethRXByteCounterLow, modemACMmodulationMin=modemACMmodulationMin, vlanNumber=vlanNumber, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethQOSTXDropped=ethQOSTXDropped, modemEntry=modemEntry, ethTXMaxCollisions=ethTXMaxCollisions, microwaveRadio=microwaveRadio, modemACMtotalCapacity=modemACMtotalCapacity, modemTotalBlockNumber=modemTotalBlockNumber, vlanPortmap=vlanPortmap, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXControlFrames=ethRXControlFrames, ethGFPFCSErrors=ethGFPFCSErrors, modemRadialMSE=modemRadialMSE, ethQOSRXQ2Frames=ethQOSRXQ2Frames)
