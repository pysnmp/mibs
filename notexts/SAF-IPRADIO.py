...
mibBuilder.exportSymbols("SAF-IPRADIO", radioTxPower=radioTxPower, ethRXBroadcasts=ethRXBroadcasts, modemTotalCapacity=modemTotalCapacity, ethRXUnsupOpcodes=ethRXUnsupOpcodes, e1t1ChannelNr=e1t1ChannelNr, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemModulation=modemModulation, product=product, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethGFPFCSErrors=ethGFPFCSErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXWireByteCounterHi=ethTXWireByteCounterHi, vlansEnabled=vlansEnabled, ipRadioMgmt=ipRadioMgmt, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, vlanPortmap=vlanPortmap, radioIndex=radioIndex, ethTXByteCounterLow=ethTXByteCounterLow, ethTXByteCounterHi=ethTXByteCounterHi, modemEntry=modemEntry, radioTxMute=radioTxMute, radioRxLevel=radioRxLevel, modemACMethernetCapacity=modemACMethernetCapacity, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ipRadioCfgNetwork=ipRadioCfgNetwork, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXControlFrames=ethTXControlFrames, radioLoopback=radioLoopback, ethQOSTXFrames=ethQOSTXFrames, description=description, modemEthernetCapacity=modemEthernetCapacity, sysDateAndTime=sysDateAndTime, loopbacks=loopbacks, atpcIndex=atpcIndex, safip=safip, ethRXPauseFrames=ethRXPauseFrames, modemAcqStatus=modemAcqStatus, ethTXVlanTags=ethTXVlanTags, modemUnavailtime=modemUnavailtime, sysTemperature=sysTemperature, modemErroredBlock=modemErroredBlock, licenseMask=licenseMask, radioTable=radioTable, license=license, localIp=localIp, ethRXControlFrames=ethRXControlFrames, tehnika=tehnika, ethTXUnderruns=ethTXUnderruns, modemRowStatus=modemRowStatus, modemTotalBlockNumber=modemTotalBlockNumber, modemStatistics=modemStatistics, ethTXLateCollisions=ethTXLateCollisions, modemStandard=modemStandard, ethTXExcessiveDefers=ethTXExcessiveDefers, localIpMask=localIpMask, ethTXDones=ethTXDones, modemLastAcqError=modemLastAcqError, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXDvEvent=ethRXDvEvent, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemACMengine=modemACMengine, ethTXBroadcasts=ethTXBroadcasts, ethTXLengthCheckErrors=ethTXLengthCheckErrors, saf=saf, modemBandwith=modemBandwith, ethRXByteCounterLow=ethRXByteCounterLow, ipRadio=ipRadio, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethGFPDelineationErrors=ethGFPDelineationErrors, e1t1LOS=e1t1LOS, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemACMtotalCapacity=modemACMtotalCapacity, ethRXLongEvents=ethRXLongEvents, e1t1AIS=e1t1AIS, radioDuplexShift=radioDuplexShift, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, e1t1StatTable=e1t1StatTable, modemTable=modemTable, vlanTable=vlanTable, writeConfig=writeConfig, ethRXPrevPktDropped=ethRXPrevPktDropped, ipRadioCfgGeneral=ipRadioCfgGeneral, modemGeneralStatus=modemGeneralStatus, ethTXPauseFrames=ethTXPauseFrames, modemSymbolRateRx=modemSymbolRateRx, ethRXDones=ethRXDones, ethTXBackpresEvents=ethTXBackpresEvents, vlanPortType=vlanPortType, loopback_tributary_mask=loopback_tributary_mask, ipRadioStat=ipRadioStat, modemSymbolRateTx=modemSymbolRateTx, radioSide=radioSide, modemErroredSecondRatio=modemErroredSecondRatio, modemUptime=modemUptime, radioTxFrequency=radioTxFrequency, modemLDPCdecoderStress=modemLDPCdecoderStress, vlanEntry=vlanEntry, restartcpu=restartcpu, modemACMmodulationMax=modemACMmodulationMax, vlanCfgStat=vlanCfgStat, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXCodeErrors=ethRXCodeErrors, aTPCTable=aTPCTable, ethQOSTXDropped=ethQOSTXDropped, modemCountTime=modemCountTime, atpcTxPowerCorrection=atpcTxPowerCorrection, modemE1T1Channels=modemE1T1Channels, ipRadioStatEth=ipRadioStatEth, ethGFPDropedFrames=ethGFPDropedFrames, ethGFPCHECErrors=ethGFPCHECErrors, ethTXMulticasts=ethTXMulticasts, ethRXCRCErrors=ethRXCRCErrors, modemIndex=modemIndex, modemErroredSecond=modemErroredSecond, atpcEnabled=atpcEnabled, radioGenStatus=radioGenStatus, aTPCEntry=aTPCEntry, ethRXTruncatedFrames=ethRXTruncatedFrames, modemACMmodulationMin=modemACMmodulationMin, hostname=hostname, radioEntry=radioEntry, ethRXByteCounterHi=ethRXByteCounterHi, ipRadioCfg=ipRadioCfg, licenseUpdateStatus=licenseUpdateStatus, ethRXMulticasts=ethRXMulticasts, ethRXDribleNibbles=ethRXDribleNibbles, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXMaxCollisions=ethTXMaxCollisions, modemCarrierOffset=modemCarrierOffset, ethTXCollisions=ethTXCollisions, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXCRCErrors=ethTXCRCErrors, modemInternalAGCgain=modemInternalAGCgain, vlanNumber=vlanNumber, vlanFid=vlanFid, microwaveRadio=microwaveRadio, modemRadialMSE=modemRadialMSE, radioRxFrequency=radioRxFrequency, ethTXGiants=ethTXGiants, vlanRowStatus=vlanRowStatus, e1t1StatEntry=e1t1StatEntry, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, pointToPoint=pointToPoint, remoteIp=remoteIp)
