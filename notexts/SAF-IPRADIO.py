...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemE1T1ChannelMask=modemE1T1ChannelMask, ethGFPCHECErrors=ethGFPCHECErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror, pointToPoint=pointToPoint, vlanPortmap=vlanPortmap, hostname=hostname, saf=saf, loopbacks=loopbacks, ethRXPrevPktDropped=ethRXPrevPktDropped, ethGFPFCSErrors=ethGFPFCSErrors, modemRowStatus=modemRowStatus, atpcEnabled=atpcEnabled, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemBandwith=modemBandwith, radioGenStatus=radioGenStatus, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemCountTime=modemCountTime, ethTXCollisions=ethTXCollisions, ethRXByteCounterLow=ethRXByteCounterLow, radioDuplexShift=radioDuplexShift, modemErroredSecond=modemErroredSecond, modemTotalCapacity=modemTotalCapacity, vlanCfgStat=vlanCfgStat, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlanNumber=vlanNumber, radioTable=radioTable, aTPCTable=aTPCTable, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemACMethernetCapacity=modemACMethernetCapacity, ethTXLateCollisions=ethTXLateCollisions, ipRadio=ipRadio, vlanRowStatus=vlanRowStatus, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlanFid=vlanFid, sysTemperature=sysTemperature, ethRXLongEvents=ethRXLongEvents, modemTotalBlockNumber=modemTotalBlockNumber, ethQOSTXDropped=ethQOSTXDropped, vlansEnabled=vlansEnabled, e1t1StatTable=e1t1StatTable, ethTXGiants=ethTXGiants, aTPCEntry=aTPCEntry, modemCarrierOffset=modemCarrierOffset, ethQOSTXFrames=ethQOSTXFrames, vlanPortType=vlanPortType, ethRXPauseFrames=ethRXPauseFrames, ipRadioCfgGeneral=ipRadioCfgGeneral, description=description, ethRXDribleNibbles=ethRXDribleNibbles, modemGeneralStatus=modemGeneralStatus, ethTXUnderruns=ethTXUnderruns, e1t1ChannelNr=e1t1ChannelNr, ethRXTruncatedFrames=ethRXTruncatedFrames, modemACMmodulationMax=modemACMmodulationMax, ethRXDones=ethRXDones, loopback_tributary_mask=loopback_tributary_mask, radioTxPower=radioTxPower, modemRadialMSE=modemRadialMSE, ethRXDvEvent=ethRXDvEvent, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioIndex=radioIndex, writeConfig=writeConfig, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXCRCErrors=ethTXCRCErrors, ethTXByteCounterLow=ethTXByteCounterLow, restartcpu=restartcpu, microwaveRadio=microwaveRadio, radioTxMute=radioTxMute, modemInternalAGCgain=modemInternalAGCgain, modemErroredSecondRatio=modemErroredSecondRatio, localIpMask=localIpMask, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXCodeErrors=ethRXCodeErrors, radioRxLevel=radioRxLevel, ipRadioCfg=ipRadioCfg, ethTXControlFrames=ethTXControlFrames, radioEntry=radioEntry, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethGFPDelineationErrors=ethGFPDelineationErrors, modemEthernetCapacity=modemEthernetCapacity, licenseMask=licenseMask, modemStandard=modemStandard, ethTXBackpresEvents=ethTXBackpresEvents, radioRxFrequency=radioRxFrequency, modemSymbolRateRx=modemSymbolRateRx, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemIndex=modemIndex, vlanTable=vlanTable, radioTxFrequency=radioTxFrequency, ethTXVlanTags=ethTXVlanTags, modemUnavailtime=modemUnavailtime, ethTXPauseFrames=ethTXPauseFrames, modemErroredBlock=modemErroredBlock, modemSymbolRateTx=modemSymbolRateTx, ethRXByteCounterHi=ethRXByteCounterHi, ethTXMulticasts=ethTXMulticasts, e1t1AIS=e1t1AIS, ethRXBroadcasts=ethRXBroadcasts, modemLDPCdecoderStress=modemLDPCdecoderStress, ipRadioMgmt=ipRadioMgmt, atpcTxPowerCorrection=atpcTxPowerCorrection, e1t1LOS=e1t1LOS, ethTXWireByteCounterHi=ethTXWireByteCounterHi, license=license, e1t1StatEntry=e1t1StatEntry, modemAcqStatus=modemAcqStatus, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemUptime=modemUptime, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemACMmodulationMin=modemACMmodulationMin, tehnika=tehnika, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXByteCounterHi=ethTXByteCounterHi, ipRadioStatEth=ipRadioStatEth, ipRadioStat=ipRadioStat, modemTable=modemTable, modemModulation=modemModulation, modemLastAcqError=modemLastAcqError, ethTXBroadcasts=ethTXBroadcasts, licenseUpdateStatus=licenseUpdateStatus, localIp=localIp, ipRadioCfgNetwork=ipRadioCfgNetwork, sysDateAndTime=sysDateAndTime, modemACMtotalCapacity=modemACMtotalCapacity, ethRXMulticasts=ethRXMulticasts, modemE1T1Channels=modemE1T1Channels, ethRXCRCErrors=ethRXCRCErrors, ethTXDones=ethTXDones, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioLoopback=radioLoopback, ethTXMaxCollisions=ethTXMaxCollisions, modemStatistics=modemStatistics, product=product, vlanEntry=vlanEntry, ethRXControlFrames=ethRXControlFrames, modemEntry=modemEntry, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemACMengine=modemACMengine, ethGFPDropedFrames=ethGFPDropedFrames, radioSide=radioSide, atpcIndex=atpcIndex, safip=safip, remoteIp=remoteIp)
