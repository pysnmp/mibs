...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXGiants=ethTXGiants, ethTXCollisions=ethTXCollisions, modemEntry=modemEntry, modemTotalCapacity=modemTotalCapacity, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, aTPCEntry=aTPCEntry, ethTXLateCollisions=ethTXLateCollisions, sysDateAndTime=sysDateAndTime, atpcIndex=atpcIndex, ethTXDones=ethTXDones, ethRXPauseFrames=ethRXPauseFrames, saf=saf, ethGFPFCSErrors=ethGFPFCSErrors, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioRxFrequency=radioRxFrequency, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXMaxCollisions=ethTXMaxCollisions, safip=safip, vlanCfgStat=vlanCfgStat, vlanFid=vlanFid, ethGFPDropedFrames=ethGFPDropedFrames, modemSymbolRateRx=modemSymbolRateRx, license=license, modemRowStatus=modemRowStatus, ethTXBroadcasts=ethTXBroadcasts, e1t1ChannelNr=e1t1ChannelNr, ethTXControlFrames=ethTXControlFrames, vlanTable=vlanTable, ethRXCodeErrors=ethRXCodeErrors, ethQOSTXDropped=ethQOSTXDropped, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemEthernetCapacity=modemEthernetCapacity, vlanEntry=vlanEntry, e1t1AIS=e1t1AIS, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, localIpMask=localIpMask, modemSeverelyErroredSecond=modemSeverelyErroredSecond, e1t1StatTable=e1t1StatTable, e1t1StatEntry=e1t1StatEntry, localIp=localIp, ethTXVlanTags=ethTXVlanTags, microwaveRadio=microwaveRadio, ethRXDones=ethRXDones, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ipRadio=ipRadio, remoteIp=remoteIp, ethTXBackpresEvents=ethTXBackpresEvents, ethTXPauseFrames=ethTXPauseFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, radioDuplexShift=radioDuplexShift, radioTable=radioTable, modemSymbolRateTx=modemSymbolRateTx, ethRXPrevPktDropped=ethRXPrevPktDropped, loopbacks=loopbacks, ipRadioStat=ipRadioStat, ethRXBroadcasts=ethRXBroadcasts, writeConfig=writeConfig, modemModulation=modemModulation, restartcpu=restartcpu, modemIndex=modemIndex, modemLastAcqError=modemLastAcqError, modemErroredSecondRatio=modemErroredSecondRatio, modemErroredSecond=modemErroredSecond, ethTXByteCounterLow=ethTXByteCounterLow, ethTXMulticasts=ethTXMulticasts, pointToPoint=pointToPoint, vlansEnabled=vlansEnabled, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemUnavailtime=modemUnavailtime, radioTxMute=radioTxMute, atpcEnabled=atpcEnabled, loopback_tributary_mask=loopback_tributary_mask, modemACMethernetCapacity=modemACMethernetCapacity, vlanNumber=vlanNumber, ethTXUnderruns=ethTXUnderruns, modemCountTime=modemCountTime, ipRadioCfg=ipRadioCfg, modemE1T1Channels=modemE1T1Channels, ethRXLongEvents=ethRXLongEvents, tehnika=tehnika, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioIndex=radioIndex, modemACMtotalCapacity=modemACMtotalCapacity, modemInternalAGCgain=modemInternalAGCgain, modemErroredBlock=modemErroredBlock, radioLoopback=radioLoopback, ipRadioStatEth=ipRadioStatEth, radioTxFrequency=radioTxFrequency, licenseMask=licenseMask, ethGFPCHECErrors=ethGFPCHECErrors, modemRadialMSE=modemRadialMSE, vlanRowStatus=vlanRowStatus, description=description, ethRXByteCounterHi=ethRXByteCounterHi, radioGenStatus=radioGenStatus, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemAcqStatus=modemAcqStatus, product=product, modemStandard=modemStandard, modemACMmodulationMin=modemACMmodulationMin, ethRXTruncatedFrames=ethRXTruncatedFrames, ethQOSRXQ2Frames=ethQOSRXQ2Frames, aTPCTable=aTPCTable, atpcTxPowerCorrection=atpcTxPowerCorrection, modemStatistics=modemStatistics, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemUptime=modemUptime, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemGeneralStatus=modemGeneralStatus, ethRXCRCErrors=ethRXCRCErrors, ethQOSTXFrames=ethQOSTXFrames, ethRXByteCounterLow=ethRXByteCounterLow, radioRxLevel=radioRxLevel, ethRXDribleNibbles=ethRXDribleNibbles, ipRadioCfgGeneral=ipRadioCfgGeneral, ipRadioCfgNetwork=ipRadioCfgNetwork, modemACMmodulationMax=modemACMmodulationMax, ethRXMulticasts=ethRXMulticasts, vlanPortmap=vlanPortmap, ethTXCRCErrors=ethTXCRCErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemACMengine=modemACMengine, radioTxPower=radioTxPower, ethRXDvEvent=ethRXDvEvent, modemE1T1ChannelMask=modemE1T1ChannelMask, hostname=hostname, radioSide=radioSide, e1t1LOS=e1t1LOS, ethRXControlFrames=ethRXControlFrames, modemBandwith=modemBandwith, modemTable=modemTable, vlanPortType=vlanPortType, modemLDPCdecoderStress=modemLDPCdecoderStress, modemCarrierOffset=modemCarrierOffset, licenseUpdateStatus=licenseUpdateStatus, modemTotalBlockNumber=modemTotalBlockNumber, sysTemperature=sysTemperature, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXByteCounterHi=ethTXByteCounterHi, radioEntry=radioEntry, ipRadioMgmt=ipRadioMgmt)
