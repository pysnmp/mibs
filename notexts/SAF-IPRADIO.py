...
mibBuilder.exportSymbols("SAF-IPRADIO", ethQOSTXDropped=ethQOSTXDropped, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXControlFrames=ethTXControlFrames, ethGFPDropedFrames=ethGFPDropedFrames, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXLateCollisions=ethTXLateCollisions, radioEntry=radioEntry, localIp=localIp, modemIndex=modemIndex, ethTXBackpresEvents=ethTXBackpresEvents, ethTXMulticasts=ethTXMulticasts, modemInternalAGCgain=modemInternalAGCgain, loopbacks=loopbacks, hostname=hostname, modemUptime=modemUptime, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, remoteIp=remoteIp, ethRXControlFrames=ethRXControlFrames, vlanPortmap=vlanPortmap, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemACMmodulationMax=modemACMmodulationMax, ethRXCRCErrors=ethRXCRCErrors, licenseMask=licenseMask, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemSymbolRateRx=modemSymbolRateRx, e1t1ChannelNr=e1t1ChannelNr, e1t1StatEntry=e1t1StatEntry, modemErroredSecondRatio=modemErroredSecondRatio, modemModulation=modemModulation, modemAcqStatus=modemAcqStatus, ethQOSTXFrames=ethQOSTXFrames, modemRadialMSE=modemRadialMSE, ethRXPauseFrames=ethRXPauseFrames, modemStandard=modemStandard, ipRadioCfgGeneral=ipRadioCfgGeneral, radioIndex=radioIndex, modemCountTime=modemCountTime, atpcIndex=atpcIndex, ipRadioStat=ipRadioStat, ipRadioMgmt=ipRadioMgmt, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXBroadcasts=ethRXBroadcasts, modemRowStatus=modemRowStatus, ipRadioStatEth=ipRadioStatEth, modemErroredBlock=modemErroredBlock, sysDateAndTime=sysDateAndTime, aTPCEntry=aTPCEntry, microwaveRadio=microwaveRadio, radioTxPower=radioTxPower, ethRXLongEvents=ethRXLongEvents, modemBandwith=modemBandwith, vlanEntry=vlanEntry, sysTemperature=sysTemperature, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXDvEvent=ethRXDvEvent, ethRXPrevPktDropped=ethRXPrevPktDropped, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethGFPFCSErrors=ethGFPFCSErrors, license=license, ethTXBroadcasts=ethTXBroadcasts, pointToPoint=pointToPoint, tehnika=tehnika, vlanFid=vlanFid, modemACMengine=modemACMengine, modemUnavailtime=modemUnavailtime, ethRXCodeErrors=ethRXCodeErrors, localIpMask=localIpMask, vlansEnabled=vlansEnabled, modemCarrierOffset=modemCarrierOffset, vlanCfgStat=vlanCfgStat, vlanRowStatus=vlanRowStatus, ethRXDones=ethRXDones, modemSymbolRateTx=modemSymbolRateTx, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioTable=radioTable, ethTXGiants=ethTXGiants, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, e1t1LOS=e1t1LOS, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemACMmodulationMin=modemACMmodulationMin, modemTable=modemTable, ethTXPauseFrames=ethTXPauseFrames, radioSide=radioSide, atpcEnabled=atpcEnabled, modemTotalCapacity=modemTotalCapacity, radioDuplexShift=radioDuplexShift, ethTXDones=ethTXDones, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, restartcpu=restartcpu, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemLastAcqError=modemLastAcqError, radioRxLevel=radioRxLevel, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXByteCounterLow=ethRXByteCounterLow, e1t1StatTable=e1t1StatTable, safip=safip, ethGFPDelineationErrors=ethGFPDelineationErrors, modemLDPCdecoderStress=modemLDPCdecoderStress, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXByteCounterLow=ethTXByteCounterLow, ethTXCRCErrors=ethTXCRCErrors, modemACMtotalCapacity=modemACMtotalCapacity, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXVlanTags=ethTXVlanTags, modemE1T1Channels=modemE1T1Channels, product=product, saf=saf, modemEntry=modemEntry, description=description, ethRXDribleNibbles=ethRXDribleNibbles, ethRXMulticasts=ethRXMulticasts, ethGFPCHECErrors=ethGFPCHECErrors, ethTXCollisions=ethTXCollisions, vlanPortType=vlanPortType, modemTotalBlockNumber=modemTotalBlockNumber, writeConfig=writeConfig, ethRXByteCounterHi=ethRXByteCounterHi, radioTxFrequency=radioTxFrequency, ethTXMaxCollisions=ethTXMaxCollisions, radioGenStatus=radioGenStatus, modemACMethernetCapacity=modemACMethernetCapacity, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXByteCounterHi=ethTXByteCounterHi, radioTxMute=radioTxMute, vlanTable=vlanTable, modemStatistics=modemStatistics, ipRadioCfg=ipRadioCfg, modemE1T1ChannelMask=modemE1T1ChannelMask, modemErroredSecond=modemErroredSecond, radioRxFrequency=radioRxFrequency, ethTXUnderruns=ethTXUnderruns, licenseUpdateStatus=licenseUpdateStatus, modemEthernetCapacity=modemEthernetCapacity, aTPCTable=aTPCTable, radioLoopback=radioLoopback, loopback_tributary_mask=loopback_tributary_mask, ipRadio=ipRadio, modemGeneralStatus=modemGeneralStatus, e1t1AIS=e1t1AIS, vlanNumber=vlanNumber, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors)
