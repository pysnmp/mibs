...
mibBuilder.exportSymbols("SAF-IPRADIO", modemGeneralStatus=modemGeneralStatus, product=product, modemTotalCapacity=modemTotalCapacity, ethTXGiants=ethTXGiants, radioRxLevel=radioRxLevel, ethTXCRCErrors=ethTXCRCErrors, ethGFPCHECErrors=ethGFPCHECErrors, radioTxPower=radioTxPower, licenseUpdateStatus=licenseUpdateStatus, ipRadioMgmt=ipRadioMgmt, modemACMethernetCapacity=modemACMethernetCapacity, vlanFid=vlanFid, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioSide=radioSide, modemRadialMSE=modemRadialMSE, radioTxFrequency=radioTxFrequency, restartcpu=restartcpu, modemUptime=modemUptime, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemAcqStatus=modemAcqStatus, ethGFPDropedFrames=ethGFPDropedFrames, radioRxFrequency=radioRxFrequency, modemErroredBlock=modemErroredBlock, ethTXByteCounterLow=ethTXByteCounterLow, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemLDPCdecoderStress=modemLDPCdecoderStress, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXMaxCollisions=ethTXMaxCollisions, ipRadioCfg=ipRadioCfg, modemRowStatus=modemRowStatus, sysTemperature=sysTemperature, ethTXByteCounterHi=ethTXByteCounterHi, vlanNumber=vlanNumber, ethRXByteCounterHi=ethRXByteCounterHi, modemBandwith=modemBandwith, localIp=localIp, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioEntry=radioEntry, ethTXUnderruns=ethTXUnderruns, licenseMask=licenseMask, ethRXCRCErrors=ethRXCRCErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, hostname=hostname, modemStatistics=modemStatistics, ethTXLateCollisions=ethTXLateCollisions, writeConfig=writeConfig, modemEthernetCapacity=modemEthernetCapacity, radioGenStatus=radioGenStatus, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, e1t1AIS=e1t1AIS, ethQOSTXFrames=ethQOSTXFrames, aTPCTable=aTPCTable, ethRXMulticasts=ethRXMulticasts, modemInternalAGCgain=modemInternalAGCgain, ethRXByteCounterLow=ethRXByteCounterLow, ethTXBroadcasts=ethTXBroadcasts, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ipRadioStatEth=ipRadioStatEth, modemE1T1ChannelMask=modemE1T1ChannelMask, vlanPortmap=vlanPortmap, modemTable=modemTable, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethGFPDelineationErrors=ethGFPDelineationErrors, ethQOSTXDropped=ethQOSTXDropped, ethRXBroadcasts=ethRXBroadcasts, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemTotalBlockNumber=modemTotalBlockNumber, modemACMmodulationMin=modemACMmodulationMin, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXMulticasts=ethTXMulticasts, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXBackpresEvents=ethTXBackpresEvents, ethTXCollisions=ethTXCollisions, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXCodeErrors=ethRXCodeErrors, modemEntry=modemEntry, modemACMengine=modemACMengine, radioIndex=radioIndex, radioLoopback=radioLoopback, modemCarrierOffset=modemCarrierOffset, atpcIndex=atpcIndex, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethGFPFCSErrors=ethGFPFCSErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, vlanTable=vlanTable, modemUnavailtime=modemUnavailtime, remoteIp=remoteIp, ethTXPauseFrames=ethTXPauseFrames, vlanCfgStat=vlanCfgStat, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXDones=ethRXDones, safip=safip, pointToPoint=pointToPoint, ethRXDribleNibbles=ethRXDribleNibbles, modemErroredSecond=modemErroredSecond, radioDuplexShift=radioDuplexShift, ethRXControlFrames=ethRXControlFrames, ethTXControlFrames=ethTXControlFrames, description=description, vlanRowStatus=vlanRowStatus, localIpMask=localIpMask, microwaveRadio=microwaveRadio, ipRadio=ipRadio, ipRadioStat=ipRadioStat, e1t1ChannelNr=e1t1ChannelNr, ethRXLongEvents=ethRXLongEvents, ethRXPrevPktDropped=ethRXPrevPktDropped, e1t1LOS=e1t1LOS, modemLastAcqError=modemLastAcqError, sysDateAndTime=sysDateAndTime, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemCountTime=modemCountTime, aTPCEntry=aTPCEntry, license=license, e1t1StatEntry=e1t1StatEntry, ethRXDvEvent=ethRXDvEvent, modemIndex=modemIndex, modemErroredSecondRatio=modemErroredSecondRatio, loopbacks=loopbacks, ethTXDones=ethTXDones, modemModulation=modemModulation, vlanEntry=vlanEntry, radioTxMute=radioTxMute, modemSymbolRateRx=modemSymbolRateRx, modemACMtotalCapacity=modemACMtotalCapacity, vlanPortType=vlanPortType, modemStandard=modemStandard, atpcEnabled=atpcEnabled, saf=saf, atpcTxPowerCorrection=atpcTxPowerCorrection, loopback_tributary_mask=loopback_tributary_mask, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, e1t1StatTable=e1t1StatTable, ethTXVlanTags=ethTXVlanTags, ipRadioCfgNetwork=ipRadioCfgNetwork, vlansEnabled=vlansEnabled, ethRXPauseFrames=ethRXPauseFrames, modemSymbolRateTx=modemSymbolRateTx, radioTable=radioTable, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemACMmodulationMax=modemACMmodulationMax, modemE1T1Channels=modemE1T1Channels, tehnika=tehnika)
