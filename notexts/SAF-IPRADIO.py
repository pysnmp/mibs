...
mibBuilder.exportSymbols("SAF-IPRADIO", modemACMethernetCapacity=modemACMethernetCapacity, ethRXByteCounterLow=ethRXByteCounterLow, modemErroredBlock=modemErroredBlock, e1t1StatEntry=e1t1StatEntry, restartcpu=restartcpu, modemE1T1Channels=modemE1T1Channels, ethTXLateCollisions=ethTXLateCollisions, vlanEntry=vlanEntry, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioTxFrequency=radioTxFrequency, ipRadioCfgNetwork=ipRadioCfgNetwork, aTPCTable=aTPCTable, modemACMengine=modemACMengine, localIpMask=localIpMask, sysTemperature=sysTemperature, vlanRowStatus=vlanRowStatus, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemCountTime=modemCountTime, modemACMtotalCapacity=modemACMtotalCapacity, ethTXVlanTags=ethTXVlanTags, ethTXDones=ethTXDones, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemAcqStatus=modemAcqStatus, modemIndex=modemIndex, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemStandard=modemStandard, ethTXControlFrames=ethTXControlFrames, radioIndex=radioIndex, modemSymbolRateRx=modemSymbolRateRx, ethTXGiants=ethTXGiants, modemTotalCapacity=modemTotalCapacity, modemE1T1ChannelMask=modemE1T1ChannelMask, vlansEnabled=vlansEnabled, ethRXDones=ethRXDones, tehnika=tehnika, e1t1StatTable=e1t1StatTable, ethTXPauseFrames=ethTXPauseFrames, modemModulation=modemModulation, modemErroredSecond=modemErroredSecond, e1t1ChannelNr=e1t1ChannelNr, modemUptime=modemUptime, licenseMask=licenseMask, vlanPortType=vlanPortType, modemEthernetCapacity=modemEthernetCapacity, ethTXByteCounterLow=ethTXByteCounterLow, saf=saf, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlanCfgStat=vlanCfgStat, modemTotalBlockNumber=modemTotalBlockNumber, ethRXBroadcasts=ethRXBroadcasts, ethRXCodeErrors=ethRXCodeErrors, localIp=localIp, ethTXUnderruns=ethTXUnderruns, ethTXBroadcasts=ethTXBroadcasts, radioRxFrequency=radioRxFrequency, modemEntry=modemEntry, modemCarrierOffset=modemCarrierOffset, sysDateAndTime=sysDateAndTime, loopback_tributary_mask=loopback_tributary_mask, loopbacks=loopbacks, ethRXControlFrames=ethRXControlFrames, vlanPortmap=vlanPortmap, ethRXPauseFrames=ethRXPauseFrames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ipRadioMgmt=ipRadioMgmt, ipRadioCfg=ipRadioCfg, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioRxLevel=radioRxLevel, modemRadialMSE=modemRadialMSE, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethGFPFCSErrors=ethGFPFCSErrors, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXLongEvents=ethRXLongEvents, radioTxPower=radioTxPower, modemGeneralStatus=modemGeneralStatus, modemUnavailtime=modemUnavailtime, ethRXByteCounterHi=ethRXByteCounterHi, radioEntry=radioEntry, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ipRadioStat=ipRadioStat, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, aTPCEntry=aTPCEntry, ethRXDribleNibbles=ethRXDribleNibbles, radioSide=radioSide, ethTXMaxCollisions=ethTXMaxCollisions, writeConfig=writeConfig, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioTable=radioTable, ethRXCRCErrors=ethRXCRCErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, ethGFPCHECErrors=ethGFPCHECErrors, ipRadio=ipRadio, ethRXDvEvent=ethRXDvEvent, ethTXExcessiveDefers=ethTXExcessiveDefers, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXMulticasts=ethTXMulticasts, atpcTxPowerCorrection=atpcTxPowerCorrection, radioDuplexShift=radioDuplexShift, ethGFPDropedFrames=ethGFPDropedFrames, e1t1LOS=e1t1LOS, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXCollisions=ethTXCollisions, hostname=hostname, description=description, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, atpcIndex=atpcIndex, pointToPoint=pointToPoint, remoteIp=remoteIp, license=license, modemACMmodulationMin=modemACMmodulationMin, microwaveRadio=microwaveRadio, licenseUpdateStatus=licenseUpdateStatus, product=product, ethQOSTXFrames=ethQOSTXFrames, radioGenStatus=radioGenStatus, atpcEnabled=atpcEnabled, ethQOSTXDropped=ethQOSTXDropped, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ipRadioStatEth=ipRadioStatEth, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXCRCErrors=ethTXCRCErrors, ethTXByteCounterHi=ethTXByteCounterHi, modemErroredSecondRatio=modemErroredSecondRatio, safip=safip, radioTxMute=radioTxMute, modemInternalAGCgain=modemInternalAGCgain, modemStatistics=modemStatistics, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemBandwith=modemBandwith, ethTXBackpresEvents=ethTXBackpresEvents, modemTable=modemTable, modemSymbolRateTx=modemSymbolRateTx, modemACMmodulationMax=modemACMmodulationMax, vlanNumber=vlanNumber, vlanFid=vlanFid, ethRXMulticasts=ethRXMulticasts, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemRowStatus=modemRowStatus, modemLastAcqError=modemLastAcqError, radioLoopback=radioLoopback, e1t1AIS=e1t1AIS, vlanTable=vlanTable)
