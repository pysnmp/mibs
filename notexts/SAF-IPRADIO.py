...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXCollisions=ethTXCollisions, ethTXControlFrames=ethTXControlFrames, e1t1StatEntry=e1t1StatEntry, safip=safip, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemAcqStatus=modemAcqStatus, modemIndex=modemIndex, modemACMmodulationMax=modemACMmodulationMax, e1t1StatTable=e1t1StatTable, e1t1LOS=e1t1LOS, aTPCTable=aTPCTable, ethRXTruncatedFrames=ethRXTruncatedFrames, vlanTable=vlanTable, ethRXPrevPktDropped=ethRXPrevPktDropped, modemACMethernetCapacity=modemACMethernetCapacity, ethRXCodeErrors=ethRXCodeErrors, ethRXPauseFrames=ethRXPauseFrames, ethRXLongEvents=ethRXLongEvents, modemUnavailtime=modemUnavailtime, ethRXByteCounterLow=ethRXByteCounterLow, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethGFPCHECErrors=ethGFPCHECErrors, ethTXVlanTags=ethTXVlanTags, ipRadioCfgGeneral=ipRadioCfgGeneral, loopback_tributary_mask=loopback_tributary_mask, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemTotalCapacity=modemTotalCapacity, modemEntry=modemEntry, vlanEntry=vlanEntry, restartcpu=restartcpu, ethTXExcessiveDefers=ethTXExcessiveDefers, modemEthernetCapacity=modemEthernetCapacity, modemLDPCdecoderStress=modemLDPCdecoderStress, hostname=hostname, ethTXPauseFrames=ethTXPauseFrames, ethGFPFCSErrors=ethGFPFCSErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemBandwith=modemBandwith, ethTXMulticasts=ethTXMulticasts, radioRxFrequency=radioRxFrequency, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXByteCounterHi=ethTXByteCounterHi, modemSymbolRateRx=modemSymbolRateRx, remoteIp=remoteIp, localIpMask=localIpMask, ipRadioStat=ipRadioStat, radioRxLevel=radioRxLevel, vlansEnabled=vlansEnabled, modemCarrierOffset=modemCarrierOffset, radioGenStatus=radioGenStatus, sysDateAndTime=sysDateAndTime, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, saf=saf, modemErroredBlock=modemErroredBlock, ethTXDones=ethTXDones, licenseMask=licenseMask, pointToPoint=pointToPoint, modemGeneralStatus=modemGeneralStatus, radioTxPower=radioTxPower, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemACMtotalCapacity=modemACMtotalCapacity, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemRadialMSE=modemRadialMSE, modemACMengine=modemACMengine, radioDuplexShift=radioDuplexShift, vlanPortType=vlanPortType, ethQOSTXDropped=ethQOSTXDropped, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemStandard=modemStandard, ethTXByteCounterLow=ethTXByteCounterLow, modemE1T1Channels=modemE1T1Channels, radioTable=radioTable, radioLoopback=radioLoopback, modemErroredSecondRatio=modemErroredSecondRatio, ethRXBroadcasts=ethRXBroadcasts, ipRadio=ipRadio, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ipRadioCfg=ipRadioCfg, vlanRowStatus=vlanRowStatus, radioIndex=radioIndex, modemUptime=modemUptime, modemTable=modemTable, modemInternalAGCgain=modemInternalAGCgain, microwaveRadio=microwaveRadio, writeConfig=writeConfig, product=product, loopbacks=loopbacks, ethQOSTXFrames=ethQOSTXFrames, modemACMmodulationMin=modemACMmodulationMin, modemTotalBlockNumber=modemTotalBlockNumber, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXMulticasts=ethRXMulticasts, modemSymbolRateTx=modemSymbolRateTx, ethRXDribleNibbles=ethRXDribleNibbles, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXDones=ethRXDones, ethTXCRCErrors=ethTXCRCErrors, vlanNumber=vlanNumber, modemModulation=modemModulation, ethTXLateCollisions=ethTXLateCollisions, ethGFPDelineationErrors=ethGFPDelineationErrors, atpcIndex=atpcIndex, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, tehnika=tehnika, ethRXControlFrames=ethRXControlFrames, localIp=localIp, sysTemperature=sysTemperature, modemBackgroundBlockErrror=modemBackgroundBlockErrror, licenseUpdateStatus=licenseUpdateStatus, aTPCEntry=aTPCEntry, vlanFid=vlanFid, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXVlanTagsDetected=ethRXVlanTagsDetected, vlanCfgStat=vlanCfgStat, ethTXBackpresEvents=ethTXBackpresEvents, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemCountTime=modemCountTime, radioSide=radioSide, modemStatistics=modemStatistics, ethTXGiants=ethTXGiants, ipRadioMgmt=ipRadioMgmt, modemErroredSecond=modemErroredSecond, ethGFPDropedFrames=ethGFPDropedFrames, modemLastAcqError=modemLastAcqError, e1t1AIS=e1t1AIS, ipRadioStatEth=ipRadioStatEth, radioTxFrequency=radioTxFrequency, atpcEnabled=atpcEnabled, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, license=license, modemRowStatus=modemRowStatus, ethTXUnderruns=ethTXUnderruns, radioEntry=radioEntry, ethRXDvEvent=ethRXDvEvent, radioTxMute=radioTxMute, ethRXCRCErrors=ethRXCRCErrors, description=description, ethTXMaxCollisions=ethTXMaxCollisions, e1t1ChannelNr=e1t1ChannelNr, vlanPortmap=vlanPortmap, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXByteCounterHi=ethRXByteCounterHi, ethTXBroadcasts=ethTXBroadcasts)
