...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, aTPCTable=aTPCTable, modemCountTime=modemCountTime, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemACMethernetCapacity=modemACMethernetCapacity, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXControlFrames=ethRXControlFrames, modemErroredBlock=modemErroredBlock, modemTotalCapacity=modemTotalCapacity, ethGFPCHECErrors=ethGFPCHECErrors, vlanFid=vlanFid, modemUptime=modemUptime, ethTXMulticasts=ethTXMulticasts, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXDribleNibbles=ethRXDribleNibbles, ethTXByteCounterHi=ethTXByteCounterHi, ethTXPauseFrames=ethTXPauseFrames, modemAcqStatus=modemAcqStatus, ethRXPrevPktDropped=ethRXPrevPktDropped, ipRadioCfgNetwork=ipRadioCfgNetwork, loopback_tributary_mask=loopback_tributary_mask, ipRadioMgmt=ipRadioMgmt, writeConfig=writeConfig, radioSide=radioSide, microwaveRadio=microwaveRadio, modemCarrierOffset=modemCarrierOffset, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, loopbacks=loopbacks, ethGFPDelineationErrors=ethGFPDelineationErrors, modemSymbolRateRx=modemSymbolRateRx, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemStatistics=modemStatistics, ethTXExcessiveDefers=ethTXExcessiveDefers, modemRadialMSE=modemRadialMSE, vlanNumber=vlanNumber, hostname=hostname, modemLastAcqError=modemLastAcqError, modemEntry=modemEntry, safip=safip, radioTxFrequency=radioTxFrequency, modemACMmodulationMax=modemACMmodulationMax, ethTXVlanTags=ethTXVlanTags, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXByteCounterHi=ethRXByteCounterHi, ethGFPDropedFrames=ethGFPDropedFrames, ethTXCRCErrors=ethTXCRCErrors, modemTotalBlockNumber=modemTotalBlockNumber, ipRadioStatEth=ipRadioStatEth, modemIndex=modemIndex, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXPauseFrames=ethRXPauseFrames, ethTXControlFrames=ethTXControlFrames, vlanRowStatus=vlanRowStatus, ipRadio=ipRadio, modemACMengine=modemACMengine, modemE1T1Channels=modemE1T1Channels, modemBandwith=modemBandwith, ethQOSTXDropped=ethQOSTXDropped, atpcEnabled=atpcEnabled, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXByteCounterLow=ethRXByteCounterLow, vlansEnabled=vlansEnabled, ethRXMulticasts=ethRXMulticasts, license=license, restartcpu=restartcpu, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlanPortmap=vlanPortmap, ethRXCodeErrors=ethRXCodeErrors, modemLDPCdecoderStress=modemLDPCdecoderStress, licenseUpdateStatus=licenseUpdateStatus, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemErroredSecond=modemErroredSecond, pointToPoint=pointToPoint, vlanEntry=vlanEntry, ethTXLateCollisions=ethTXLateCollisions, aTPCEntry=aTPCEntry, ethQOSTXFrames=ethQOSTXFrames, localIp=localIp, radioDuplexShift=radioDuplexShift, product=product, e1t1LOS=e1t1LOS, radioRxFrequency=radioRxFrequency, ethQOSRXQ1Frames=ethQOSRXQ1Frames, remoteIp=remoteIp, ethTXCollisions=ethTXCollisions, ethTXUnderruns=ethTXUnderruns, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, description=description, ethRXTruncatedFrames=ethRXTruncatedFrames, modemInternalAGCgain=modemInternalAGCgain, ethRXDvEvent=ethRXDvEvent, ethTXBackpresEvents=ethTXBackpresEvents, ipRadioStat=ipRadioStat, saf=saf, localIpMask=localIpMask, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioTxMute=radioTxMute, atpcIndex=atpcIndex, modemSymbolRateTx=modemSymbolRateTx, radioLoopback=radioLoopback, modemStandard=modemStandard, e1t1ChannelNr=e1t1ChannelNr, tehnika=tehnika, e1t1StatEntry=e1t1StatEntry, radioEntry=radioEntry, radioGenStatus=radioGenStatus, radioRxLevel=radioRxLevel, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioTxPower=radioTxPower, ethTXBroadcasts=ethTXBroadcasts, modemModulation=modemModulation, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemACMtotalCapacity=modemACMtotalCapacity, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXBroadcasts=ethRXBroadcasts, ethRXLongEvents=ethRXLongEvents, ethTXGiants=ethTXGiants, sysDateAndTime=sysDateAndTime, radioTable=radioTable, ethTXDones=ethTXDones, ethGFPFCSErrors=ethGFPFCSErrors, sysTemperature=sysTemperature, e1t1AIS=e1t1AIS, ethRXCRCErrors=ethRXCRCErrors, modemUnavailtime=modemUnavailtime, modemErroredSecondRatio=modemErroredSecondRatio, ipRadioCfg=ipRadioCfg, radioIndex=radioIndex, vlanPortType=vlanPortType, e1t1StatTable=e1t1StatTable, vlanTable=vlanTable, modemTable=modemTable, modemACMmodulationMin=modemACMmodulationMin, modemGeneralStatus=modemGeneralStatus, ethRXDones=ethRXDones, vlanCfgStat=vlanCfgStat, ethTXByteCounterLow=ethTXByteCounterLow, modemEthernetCapacity=modemEthernetCapacity, modemRowStatus=modemRowStatus, licenseMask=licenseMask, ethTXMaxCollisions=ethTXMaxCollisions, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXLengthCheckErrors=ethTXLengthCheckErrors)
