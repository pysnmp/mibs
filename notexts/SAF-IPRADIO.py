...
mibBuilder.exportSymbols("SAF-IPRADIO", modemInternalAGCgain=modemInternalAGCgain, ipRadioCfg=ipRadioCfg, modemACMtotalCapacity=modemACMtotalCapacity, modemACMmodulationMin=modemACMmodulationMin, radioSide=radioSide, radioRxLevel=radioRxLevel, modemUnavailtime=modemUnavailtime, vlansEnabled=vlansEnabled, ethTXMulticasts=ethTXMulticasts, radioDuplexShift=radioDuplexShift, vlanRowStatus=vlanRowStatus, vlanPortType=vlanPortType, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXByteCounterLow=ethRXByteCounterLow, atpcTxPowerCorrection=atpcTxPowerCorrection, modemCountTime=modemCountTime, modemGeneralStatus=modemGeneralStatus, ethTXBackpresEvents=ethTXBackpresEvents, product=product, ethGFPCHECErrors=ethGFPCHECErrors, ethTXDones=ethTXDones, ethTXVlanTags=ethTXVlanTags, ipRadioStatEth=ipRadioStatEth, radioLoopback=radioLoopback, modemACMengine=modemACMengine, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemTable=modemTable, aTPCEntry=aTPCEntry, aTPCTable=aTPCTable, modemModulation=modemModulation, ethRXPauseFrames=ethRXPauseFrames, radioRxFrequency=radioRxFrequency, modemErroredSecond=modemErroredSecond, modemUptime=modemUptime, licenseUpdateStatus=licenseUpdateStatus, modemStandard=modemStandard, ethRXDvEvent=ethRXDvEvent, ethQOSTXDropped=ethQOSTXDropped, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ipRadio=ipRadio, tehnika=tehnika, licenseMask=licenseMask, vlanCfgStat=vlanCfgStat, vlanPortmap=vlanPortmap, ethRXMulticasts=ethRXMulticasts, description=description, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXBroadcasts=ethTXBroadcasts, ethRXVlanTagsDetected=ethRXVlanTagsDetected, atpcIndex=atpcIndex, modemE1T1ChannelMask=modemE1T1ChannelMask, vlanTable=vlanTable, ethTXCollisions=ethTXCollisions, radioTxPower=radioTxPower, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemSymbolRateTx=modemSymbolRateTx, modemErroredBlock=modemErroredBlock, ethRXByteCounterHi=ethRXByteCounterHi, hostname=hostname, restartcpu=restartcpu, modemACMethernetCapacity=modemACMethernetCapacity, modemACMmodulationMax=modemACMmodulationMax, vlanEntry=vlanEntry, ethRXDones=ethRXDones, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemRowStatus=modemRowStatus, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioIndex=radioIndex, ethTXGiants=ethTXGiants, ethTXUnderruns=ethTXUnderruns, e1t1LOS=e1t1LOS, modemIndex=modemIndex, ethTXPauseFrames=ethTXPauseFrames, vlanNumber=vlanNumber, ethRXBroadcasts=ethRXBroadcasts, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXControlFrames=ethTXControlFrames, pointToPoint=pointToPoint, modemE1T1Channels=modemE1T1Channels, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, saf=saf, radioGenStatus=radioGenStatus, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemEntry=modemEntry, ethRXDribleNibbles=ethRXDribleNibbles, ethRXPrevPktDropped=ethRXPrevPktDropped, writeConfig=writeConfig, modemRadialMSE=modemRadialMSE, ipRadioCfgGeneral=ipRadioCfgGeneral, e1t1StatEntry=e1t1StatEntry, license=license, loopback_tributary_mask=loopback_tributary_mask, vlanFid=vlanFid, ethRXLongEvents=ethRXLongEvents, ethRXCodeErrors=ethRXCodeErrors, modemTotalBlockNumber=modemTotalBlockNumber, modemCarrierOffset=modemCarrierOffset, modemBandwith=modemBandwith, modemStatistics=modemStatistics, modemLDPCdecoderStress=modemLDPCdecoderStress, ethGFPFCSErrors=ethGFPFCSErrors, ethRXControlFrames=ethRXControlFrames, ethTXLateCollisions=ethTXLateCollisions, modemTotalCapacity=modemTotalCapacity, ethQOSTXFrames=ethQOSTXFrames, safip=safip, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXCRCErrors=ethRXCRCErrors, ipRadioMgmt=ipRadioMgmt, radioTxMute=radioTxMute, atpcEnabled=atpcEnabled, ethTXCRCErrors=ethTXCRCErrors, modemAcqStatus=modemAcqStatus, loopbacks=loopbacks, ethGFPDropedFrames=ethGFPDropedFrames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, remoteIp=remoteIp, sysDateAndTime=sysDateAndTime, modemSymbolRateRx=modemSymbolRateRx, localIp=localIp, microwaveRadio=microwaveRadio, modemErroredSecondRatio=modemErroredSecondRatio, ethTXMaxCollisions=ethTXMaxCollisions, ipRadioCfgNetwork=ipRadioCfgNetwork, e1t1ChannelNr=e1t1ChannelNr, radioTable=radioTable, e1t1StatTable=e1t1StatTable, e1t1AIS=e1t1AIS, sysTemperature=sysTemperature, ethTXByteCounterHi=ethTXByteCounterHi, radioTxFrequency=radioTxFrequency, ethRXTruncatedFrames=ethRXTruncatedFrames, radioEntry=radioEntry, ipRadioStat=ipRadioStat, modemLastAcqError=modemLastAcqError, ethTXByteCounterLow=ethTXByteCounterLow, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethGFPDelineationErrors=ethGFPDelineationErrors, modemEthernetCapacity=modemEthernetCapacity, localIpMask=localIpMask)
