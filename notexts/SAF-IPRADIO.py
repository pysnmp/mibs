...
mibBuilder.exportSymbols("SAF-IPRADIO", modemTotalCapacity=modemTotalCapacity, ethRXBroadcasts=ethRXBroadcasts, ipRadioMgmt=ipRadioMgmt, saf=saf, sysTemperature=sysTemperature, ipRadio=ipRadio, aTPCTable=aTPCTable, modemSymbolRateRx=modemSymbolRateRx, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXCRCErrors=ethTXCRCErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemErroredSecond=modemErroredSecond, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemUnavailtime=modemUnavailtime, modemInternalAGCgain=modemInternalAGCgain, ethTXExcessiveDefers=ethTXExcessiveDefers, e1t1StatEntry=e1t1StatEntry, modemModulation=modemModulation, vlanPortmap=vlanPortmap, ethRXTruncatedFrames=ethRXTruncatedFrames, writeConfig=writeConfig, ipRadioStat=ipRadioStat, modemTable=modemTable, vlanPortType=vlanPortType, ethGFPDropedFrames=ethGFPDropedFrames, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXBackpresEvents=ethTXBackpresEvents, radioTxMute=radioTxMute, ethTXControlFrames=ethTXControlFrames, restartcpu=restartcpu, ethGFPDelineationErrors=ethGFPDelineationErrors, modemE1T1Channels=modemE1T1Channels, localIp=localIp, safip=safip, ethRXCodeErrors=ethRXCodeErrors, radioIndex=radioIndex, radioGenStatus=radioGenStatus, hostname=hostname, modemIndex=modemIndex, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemACMtotalCapacity=modemACMtotalCapacity, vlanEntry=vlanEntry, licenseMask=licenseMask, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXMulticasts=ethRXMulticasts, radioLoopback=radioLoopback, product=product, remoteIp=remoteIp, e1t1StatTable=e1t1StatTable, modemSymbolRateTx=modemSymbolRateTx, modemEntry=modemEntry, sysDateAndTime=sysDateAndTime, ethQOSRXQ2Frames=ethQOSRXQ2Frames, loopbacks=loopbacks, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, vlanRowStatus=vlanRowStatus, modemStatistics=modemStatistics, atpcIndex=atpcIndex, localIpMask=localIpMask, ethRXDones=ethRXDones, modemACMethernetCapacity=modemACMethernetCapacity, tehnika=tehnika, radioDuplexShift=radioDuplexShift, ethTXVlanTags=ethTXVlanTags, ethGFPFCSErrors=ethGFPFCSErrors, radioEntry=radioEntry, ethRXByteCounterHi=ethRXByteCounterHi, e1t1AIS=e1t1AIS, ethQOSRXQ1Frames=ethQOSRXQ1Frames, microwaveRadio=microwaveRadio, modemEthernetCapacity=modemEthernetCapacity, modemErroredSecondRatio=modemErroredSecondRatio, ethTXWireByteCounterHi=ethTXWireByteCounterHi, atpcTxPowerCorrection=atpcTxPowerCorrection, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXCollisions=ethTXCollisions, ipRadioCfg=ipRadioCfg, atpcEnabled=atpcEnabled, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethGFPCHECErrors=ethGFPCHECErrors, vlansEnabled=vlansEnabled, ethRXLongEvents=ethRXLongEvents, ethQOSTXFrames=ethQOSTXFrames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, pointToPoint=pointToPoint, modemBandwith=modemBandwith, modemErroredBlock=modemErroredBlock, modemUptime=modemUptime, e1t1LOS=e1t1LOS, description=description, modemTotalBlockNumber=modemTotalBlockNumber, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemGeneralStatus=modemGeneralStatus, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemAcqStatus=modemAcqStatus, ethTXBroadcasts=ethTXBroadcasts, vlanTable=vlanTable, radioSide=radioSide, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXMulticasts=ethTXMulticasts, radioRxLevel=radioRxLevel, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioTxPower=radioTxPower, modemStandard=modemStandard, modemACMengine=modemACMengine, ethQOSTXDropped=ethQOSTXDropped, ethRXDribleNibbles=ethRXDribleNibbles, ethTXMaxCollisions=ethTXMaxCollisions, modemRadialMSE=modemRadialMSE, modemCarrierOffset=modemCarrierOffset, ethRXCRCErrors=ethRXCRCErrors, radioTxFrequency=radioTxFrequency, ethRXByteCounterLow=ethRXByteCounterLow, e1t1ChannelNr=e1t1ChannelNr, ethTXDones=ethTXDones, modemACMmodulationMax=modemACMmodulationMax, ethTXUnderruns=ethTXUnderruns, modemLastAcqError=modemLastAcqError, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXPauseFrames=ethRXPauseFrames, radioTable=radioTable, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXDvEvent=ethRXDvEvent, ethRXControlFrames=ethRXControlFrames, ethTXPauseFrames=ethTXPauseFrames, ethTXGiants=ethTXGiants, ethTXLateCollisions=ethTXLateCollisions, radioRxFrequency=radioRxFrequency, aTPCEntry=aTPCEntry, ipRadioCfgNetwork=ipRadioCfgNetwork, ipRadioStatEth=ipRadioStatEth, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXByteCounterHi=ethTXByteCounterHi, license=license, vlanFid=vlanFid, loopback_tributary_mask=loopback_tributary_mask, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemACMmodulationMin=modemACMmodulationMin, modemCountTime=modemCountTime, ethTXByteCounterLow=ethTXByteCounterLow, licenseUpdateStatus=licenseUpdateStatus, modemRowStatus=modemRowStatus, vlanNumber=vlanNumber, vlanCfgStat=vlanCfgStat)
