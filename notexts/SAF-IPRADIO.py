...
mibBuilder.exportSymbols("SAF-IPRADIO", ipRadioCfgGeneral=ipRadioCfgGeneral, modemACMtotalCapacity=modemACMtotalCapacity, modemE1T1Channels=modemE1T1Channels, modemSeverelyErroredSecond=modemSeverelyErroredSecond, license=license, modemSymbolRateRx=modemSymbolRateRx, licenseUpdateStatus=licenseUpdateStatus, localIp=localIp, ethTXLateCollisions=ethTXLateCollisions, ethRXControlFrames=ethRXControlFrames, radioIndex=radioIndex, ipRadioCfgNetwork=ipRadioCfgNetwork, radioLoopback=radioLoopback, radioTxPower=radioTxPower, e1t1StatEntry=e1t1StatEntry, modemACMmodulationMax=modemACMmodulationMax, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemStandard=modemStandard, radioSide=radioSide, modemGeneralStatus=modemGeneralStatus, modemStatistics=modemStatistics, radioTxMute=radioTxMute, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXDones=ethRXDones, ipRadioStat=ipRadioStat, vlanRowStatus=vlanRowStatus, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemSymbolRateTx=modemSymbolRateTx, modemACMengine=modemACMengine, remoteIp=remoteIp, vlanPortType=vlanPortType, modemACMethernetCapacity=modemACMethernetCapacity, ethRXBroadcasts=ethRXBroadcasts, modemAcqStatus=modemAcqStatus, ipRadioStatEth=ipRadioStatEth, ethRXCRCErrors=ethRXCRCErrors, product=product, ipRadioMgmt=ipRadioMgmt, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemRadialMSE=modemRadialMSE, modemCountTime=modemCountTime, localIpMask=localIpMask, ethTXExcessiveDefers=ethTXExcessiveDefers, ethQOSTXDropped=ethQOSTXDropped, ipRadio=ipRadio, vlansEnabled=vlansEnabled, vlanEntry=vlanEntry, modemLDPCdecoderStress=modemLDPCdecoderStress, modemEntry=modemEntry, ethTXLengthCheckErrors=ethTXLengthCheckErrors, e1t1ChannelNr=e1t1ChannelNr, ethRXDribleNibbles=ethRXDribleNibbles, vlanPortmap=vlanPortmap, radioRxLevel=radioRxLevel, ethRXCodeErrors=ethRXCodeErrors, atpcTxPowerCorrection=atpcTxPowerCorrection, modemTotalBlockNumber=modemTotalBlockNumber, ipRadioCfg=ipRadioCfg, modemIndex=modemIndex, modemInternalAGCgain=modemInternalAGCgain, ethTXBackpresEvents=ethTXBackpresEvents, ethRXPauseFrames=ethRXPauseFrames, ethGFPCHECErrors=ethGFPCHECErrors, e1t1AIS=e1t1AIS, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioDuplexShift=radioDuplexShift, licenseMask=licenseMask, sysDateAndTime=sysDateAndTime, ethTXMaxCollisions=ethTXMaxCollisions, vlanNumber=vlanNumber, description=description, modemCarrierOffset=modemCarrierOffset, modemErroredSecond=modemErroredSecond, ethTXUnderruns=ethTXUnderruns, modemModulation=modemModulation, ethTXCRCErrors=ethTXCRCErrors, ethTXWireByteCounterHi=ethTXWireByteCounterHi, atpcEnabled=atpcEnabled, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXMulticasts=ethRXMulticasts, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemTable=modemTable, radioRxFrequency=radioRxFrequency, radioTxFrequency=radioTxFrequency, modemACMmodulationMin=modemACMmodulationMin, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXControlFrames=ethTXControlFrames, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXPauseFrames=ethTXPauseFrames, modemTotalCapacity=modemTotalCapacity, aTPCEntry=aTPCEntry, aTPCTable=aTPCTable, ethRXByteCounterHi=ethRXByteCounterHi, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, e1t1LOS=e1t1LOS, modemErroredBlock=modemErroredBlock, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemUptime=modemUptime, modemUnavailtime=modemUnavailtime, tehnika=tehnika, modemBandwith=modemBandwith, ethTXByteCounterHi=ethTXByteCounterHi, safip=safip, modemEthernetCapacity=modemEthernetCapacity, saf=saf, ethTXBroadcasts=ethTXBroadcasts, loopback_tributary_mask=loopback_tributary_mask, modemE1T1ChannelMask=modemE1T1ChannelMask, sysTemperature=sysTemperature, modemLastAcqError=modemLastAcqError, restartcpu=restartcpu, ethQOSTXFrames=ethQOSTXFrames, ethRXLongEvents=ethRXLongEvents, ethRXByteCounterLow=ethRXByteCounterLow, ethRXDvEvent=ethRXDvEvent, vlanFid=vlanFid, ethTXCollisions=ethTXCollisions, atpcIndex=atpcIndex, radioTable=radioTable, ethRXPrevPktDropped=ethRXPrevPktDropped, ethGFPDropedFrames=ethGFPDropedFrames, microwaveRadio=microwaveRadio, radioGenStatus=radioGenStatus, ethTXDones=ethTXDones, ethGFPFCSErrors=ethGFPFCSErrors, pointToPoint=pointToPoint, radioEntry=radioEntry, ethTXGiants=ethTXGiants, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, writeConfig=writeConfig, ethTXVlanTags=ethTXVlanTags, ethTXMulticasts=ethTXMulticasts, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlanTable=vlanTable, modemRowStatus=modemRowStatus, modemErroredSecondRatio=modemErroredSecondRatio, hostname=hostname, e1t1StatTable=e1t1StatTable, ethTXByteCounterLow=ethTXByteCounterLow, vlanCfgStat=vlanCfgStat, loopbacks=loopbacks)
