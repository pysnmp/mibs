...
mibBuilder.exportSymbols("SAF-IPRADIO", ipRadioCfgNetwork=ipRadioCfgNetwork, modemE1T1Channels=modemE1T1Channels, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXDones=ethTXDones, modemErroredSecond=modemErroredSecond, ethRXCRCErrors=ethRXCRCErrors, modemACMengine=modemACMengine, loopbacks=loopbacks, remoteIp=remoteIp, radioDuplexShift=radioDuplexShift, ethRXDribleNibbles=ethRXDribleNibbles, ethTXControlFrames=ethTXControlFrames, ipRadio=ipRadio, license=license, ethRXControlFrames=ethRXControlFrames, modemCarrierOffset=modemCarrierOffset, ethTXCollisions=ethTXCollisions, modemLastAcqError=modemLastAcqError, restartcpu=restartcpu, modemACMtotalCapacity=modemACMtotalCapacity, ethRXBroadcasts=ethRXBroadcasts, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, atpcEnabled=atpcEnabled, modemTotalBlockNumber=modemTotalBlockNumber, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioTxPower=radioTxPower, ipRadioCfg=ipRadioCfg, ethTXVlanTags=ethTXVlanTags, ethTXExcessiveDefers=ethTXExcessiveDefers, aTPCTable=aTPCTable, ethQOSTXDropped=ethQOSTXDropped, radioIndex=radioIndex, ethGFPCHECErrors=ethGFPCHECErrors, tehnika=tehnika, ipRadioMgmt=ipRadioMgmt, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXTruncatedFrames=ethRXTruncatedFrames, licenseUpdateStatus=licenseUpdateStatus, ipRadioCfgGeneral=ipRadioCfgGeneral, e1t1ChannelNr=e1t1ChannelNr, modemSymbolRateTx=modemSymbolRateTx, vlanEntry=vlanEntry, modemStatistics=modemStatistics, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXLongEvents=ethRXLongEvents, sysDateAndTime=sysDateAndTime, radioTxMute=radioTxMute, modemAcqStatus=modemAcqStatus, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemErroredBlock=modemErroredBlock, e1t1StatEntry=e1t1StatEntry, radioLoopback=radioLoopback, radioEntry=radioEntry, e1t1AIS=e1t1AIS, microwaveRadio=microwaveRadio, ethGFPDelineationErrors=ethGFPDelineationErrors, vlanRowStatus=vlanRowStatus, licenseMask=licenseMask, ethTXBroadcasts=ethTXBroadcasts, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXByteCounterLow=ethTXByteCounterLow, vlanPortmap=vlanPortmap, hostname=hostname, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemE1T1ChannelMask=modemE1T1ChannelMask, modemBandwith=modemBandwith, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioTable=radioTable, modemACMmodulationMin=modemACMmodulationMin, modemEthernetCapacity=modemEthernetCapacity, aTPCEntry=aTPCEntry, ethTXPauseFrames=ethTXPauseFrames, radioRxFrequency=radioRxFrequency, modemIndex=modemIndex, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXCodeErrors=ethRXCodeErrors, vlanTable=vlanTable, sysTemperature=sysTemperature, vlansEnabled=vlansEnabled, modemLDPCdecoderStress=modemLDPCdecoderStress, modemTotalCapacity=modemTotalCapacity, ethTXMulticasts=ethTXMulticasts, radioSide=radioSide, atpcIndex=atpcIndex, ethRXByteCounterLow=ethRXByteCounterLow, ethQOSTXFrames=ethQOSTXFrames, modemStandard=modemStandard, ethTXBackpresEvents=ethTXBackpresEvents, modemEntry=modemEntry, ethTXCRCErrors=ethTXCRCErrors, modemErroredSecondRatio=modemErroredSecondRatio, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXByteCounterHi=ethRXByteCounterHi, saf=saf, writeConfig=writeConfig, modemSymbolRateRx=modemSymbolRateRx, modemUnavailtime=modemUnavailtime, radioGenStatus=radioGenStatus, ethGFPDropedFrames=ethGFPDropedFrames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, e1t1LOS=e1t1LOS, pointToPoint=pointToPoint, ethGFPFCSErrors=ethGFPFCSErrors, modemModulation=modemModulation, localIpMask=localIpMask, ethTXLateCollisions=ethTXLateCollisions, modemRowStatus=modemRowStatus, safip=safip, ethTXByteCounterHi=ethTXByteCounterHi, description=description, radioTxFrequency=radioTxFrequency, ethTXGiants=ethTXGiants, modemUptime=modemUptime, modemGeneralStatus=modemGeneralStatus, radioRxLevel=radioRxLevel, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, atpcTxPowerCorrection=atpcTxPowerCorrection, vlanPortType=vlanPortType, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXMaxCollisions=ethTXMaxCollisions, vlanNumber=vlanNumber, product=product, modemCountTime=modemCountTime, modemTable=modemTable, modemInternalAGCgain=modemInternalAGCgain, e1t1StatTable=e1t1StatTable, ethRXDones=ethRXDones, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, loopback_tributary_mask=loopback_tributary_mask, ethRXDvEvent=ethRXDvEvent, ipRadioStatEth=ipRadioStatEth, vlanFid=vlanFid, modemRadialMSE=modemRadialMSE, ethRXPauseFrames=ethRXPauseFrames, ipRadioStat=ipRadioStat, ethTXUnderruns=ethTXUnderruns, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemACMmodulationMax=modemACMmodulationMax, vlanCfgStat=vlanCfgStat, modemACMethernetCapacity=modemACMethernetCapacity, localIp=localIp, ethRXMulticasts=ethRXMulticasts)
