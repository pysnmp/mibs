...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXBroadcasts=ethTXBroadcasts, modemACMengine=modemACMengine, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ipRadioStatEth=ipRadioStatEth, radioEntry=radioEntry, ethRXLongEvents=ethRXLongEvents, sysTemperature=sysTemperature, vlanPortType=vlanPortType, e1t1AIS=e1t1AIS, localIpMask=localIpMask, modemUptime=modemUptime, radioSide=radioSide, radioRxLevel=radioRxLevel, radioTxMute=radioTxMute, ethQOSTXDropped=ethQOSTXDropped, saf=saf, modemStatistics=modemStatistics, modemInternalAGCgain=modemInternalAGCgain, vlanFid=vlanFid, ethTXByteCounterLow=ethTXByteCounterLow, aTPCTable=aTPCTable, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXVlanTags=ethTXVlanTags, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXDvEvent=ethRXDvEvent, modemTotalBlockNumber=modemTotalBlockNumber, tehnika=tehnika, vlanPortmap=vlanPortmap, hostname=hostname, loopbacks=loopbacks, modemACMmodulationMin=modemACMmodulationMin, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, vlansEnabled=vlansEnabled, ethGFPDropedFrames=ethGFPDropedFrames, ethTXBackpresEvents=ethTXBackpresEvents, ethRXMulticasts=ethRXMulticasts, modemSymbolRateTx=modemSymbolRateTx, localIp=localIp, product=product, modemErroredBlock=modemErroredBlock, ipRadio=ipRadio, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethQOSTXFrames=ethQOSTXFrames, ethTXUnderruns=ethTXUnderruns, writeConfig=writeConfig, microwaveRadio=microwaveRadio, remoteIp=remoteIp, vlanCfgStat=vlanCfgStat, radioIndex=radioIndex, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXControlFrames=ethTXControlFrames, radioDuplexShift=radioDuplexShift, ethTXMulticasts=ethTXMulticasts, modemErroredSecondRatio=modemErroredSecondRatio, ethRXPauseFrames=ethRXPauseFrames, modemE1T1ChannelMask=modemE1T1ChannelMask, atpcIndex=atpcIndex, ethRXBroadcasts=ethRXBroadcasts, ethTXPauseFrames=ethTXPauseFrames, modemIndex=modemIndex, modemEthernetCapacity=modemEthernetCapacity, ipRadioMgmt=ipRadioMgmt, ethRXDribleNibbles=ethRXDribleNibbles, modemErroredSecond=modemErroredSecond, e1t1StatTable=e1t1StatTable, modemCountTime=modemCountTime, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemRadialMSE=modemRadialMSE, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, e1t1ChannelNr=e1t1ChannelNr, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, atpcEnabled=atpcEnabled, ethQOSRXQ2Frames=ethQOSRXQ2Frames, aTPCEntry=aTPCEntry, modemUnavailtime=modemUnavailtime, modemModulation=modemModulation, radioGenStatus=radioGenStatus, pointToPoint=pointToPoint, modemCarrierOffset=modemCarrierOffset, modemGeneralStatus=modemGeneralStatus, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXGiants=ethTXGiants, modemE1T1Channels=modemE1T1Channels, modemACMethernetCapacity=modemACMethernetCapacity, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXDones=ethTXDones, radioRxFrequency=radioRxFrequency, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemStandard=modemStandard, e1t1StatEntry=e1t1StatEntry, modemACMtotalCapacity=modemACMtotalCapacity, radioTable=radioTable, modemEntry=modemEntry, ethTXLateCollisions=ethTXLateCollisions, ethGFPCHECErrors=ethGFPCHECErrors, ethRXControlFrames=ethRXControlFrames, ethGFPFCSErrors=ethGFPFCSErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXByteCounterHi=ethRXByteCounterHi, modemRowStatus=modemRowStatus, radioTxPower=radioTxPower, radioTxFrequency=radioTxFrequency, vlanRowStatus=vlanRowStatus, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXDones=ethRXDones, ipRadioCfg=ipRadioCfg, restartcpu=restartcpu, loopback_tributary_mask=loopback_tributary_mask, vlanTable=vlanTable, vlanNumber=vlanNumber, modemAcqStatus=modemAcqStatus, ethRXByteCounterLow=ethRXByteCounterLow, licenseUpdateStatus=licenseUpdateStatus, ethTXCRCErrors=ethTXCRCErrors, radioLoopback=radioLoopback, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXExcessiveDefers=ethTXExcessiveDefers, licenseMask=licenseMask, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXCodeErrors=ethRXCodeErrors, safip=safip, license=license, modemSymbolRateRx=modemSymbolRateRx, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemACMmodulationMax=modemACMmodulationMax, ethTXCollisions=ethTXCollisions, modemBandwith=modemBandwith, ethTXByteCounterHi=ethTXByteCounterHi, ethTXMaxCollisions=ethTXMaxCollisions, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemLastAcqError=modemLastAcqError, vlanEntry=vlanEntry, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXPrevPktDropped=ethRXPrevPktDropped, e1t1LOS=e1t1LOS, sysDateAndTime=sysDateAndTime, ethRXCRCErrors=ethRXCRCErrors, ipRadioStat=ipRadioStat, description=description, modemTotalCapacity=modemTotalCapacity, modemTable=modemTable)
