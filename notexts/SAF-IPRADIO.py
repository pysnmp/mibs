...
mibBuilder.exportSymbols("SAF-IPRADIO", ipRadioCfgNetwork=ipRadioCfgNetwork, modemErroredBlock=modemErroredBlock, radioSide=radioSide, modemACMengine=modemACMengine, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXLateCollisions=ethTXLateCollisions, ethTXControlFrames=ethTXControlFrames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethGFPDelineationErrors=ethGFPDelineationErrors, radioRxLevel=radioRxLevel, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXBackpresEvents=ethTXBackpresEvents, ethTXByteCounterLow=ethTXByteCounterLow, ipRadio=ipRadio, ethRXLongEvents=ethRXLongEvents, ethRXUnsupOpcodes=ethRXUnsupOpcodes, atpcIndex=atpcIndex, radioIndex=radioIndex, ethRXControlFrames=ethRXControlFrames, ethRXDones=ethRXDones, tehnika=tehnika, modemACMtotalCapacity=modemACMtotalCapacity, modemErroredSecondRatio=modemErroredSecondRatio, radioTxPower=radioTxPower, ethTXWireByteCounterLow=ethTXWireByteCounterLow, e1t1StatTable=e1t1StatTable, microwaveRadio=microwaveRadio, ethTXCollisions=ethTXCollisions, radioDuplexShift=radioDuplexShift, ethRXMulticasts=ethRXMulticasts, pointToPoint=pointToPoint, modemUnavailtime=modemUnavailtime, vlanFid=vlanFid, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemAcqStatus=modemAcqStatus, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemCountTime=modemCountTime, e1t1AIS=e1t1AIS, modemRadialMSE=modemRadialMSE, localIpMask=localIpMask, ethRXByteCounterHi=ethRXByteCounterHi, ethTXDones=ethTXDones, modemSymbolRateTx=modemSymbolRateTx, vlanPortType=vlanPortType, modemGeneralStatus=modemGeneralStatus, ipRadioStat=ipRadioStat, sysDateAndTime=sysDateAndTime, modemBandwith=modemBandwith, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemE1T1Channels=modemE1T1Channels, ipRadioMgmt=ipRadioMgmt, localIp=localIp, ethRXByteCounterLow=ethRXByteCounterLow, ipRadioStatEth=ipRadioStatEth, vlanCfgStat=vlanCfgStat, loopback_tributary_mask=loopback_tributary_mask, radioTxMute=radioTxMute, modemACMethernetCapacity=modemACMethernetCapacity, licenseUpdateStatus=licenseUpdateStatus, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXDvEvent=ethRXDvEvent, modemTable=modemTable, ethTXMulticasts=ethTXMulticasts, modemLastAcqError=modemLastAcqError, ethRXCodeErrors=ethRXCodeErrors, modemSymbolRateRx=modemSymbolRateRx, ethTXVlanTags=ethTXVlanTags, restartcpu=restartcpu, radioTable=radioTable, ethRXTruncatedFrames=ethRXTruncatedFrames, radioTxFrequency=radioTxFrequency, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, loopbacks=loopbacks, ethTXBroadcasts=ethTXBroadcasts, ethRXPrevPktDropped=ethRXPrevPktDropped, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXCRCErrors=ethTXCRCErrors, description=description, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioEntry=radioEntry, modemACMmodulationMax=modemACMmodulationMax, vlanNumber=vlanNumber, vlanPortmap=vlanPortmap, ethRXBroadcasts=ethRXBroadcasts, modemEthernetCapacity=modemEthernetCapacity, ethGFPCHECErrors=ethGFPCHECErrors, vlansEnabled=vlansEnabled, ipRadioCfg=ipRadioCfg, e1t1LOS=e1t1LOS, vlanRowStatus=vlanRowStatus, radioLoopback=radioLoopback, ethTXByteCounterHi=ethTXByteCounterHi, radioRxFrequency=radioRxFrequency, sysTemperature=sysTemperature, aTPCTable=aTPCTable, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, vlanEntry=vlanEntry, ethQOSTXFrames=ethQOSTXFrames, e1t1ChannelNr=e1t1ChannelNr, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXDribleNibbles=ethRXDribleNibbles, ethTXExcessiveDefers=ethTXExcessiveDefers, modemInternalAGCgain=modemInternalAGCgain, product=product, ethTXPauseFrames=ethTXPauseFrames, licenseMask=licenseMask, remoteIp=remoteIp, ethRXPauseFrames=ethRXPauseFrames, writeConfig=writeConfig, ethTXUnderruns=ethTXUnderruns, safip=safip, modemTotalBlockNumber=modemTotalBlockNumber, aTPCEntry=aTPCEntry, ethQOSTXDropped=ethQOSTXDropped, e1t1StatEntry=e1t1StatEntry, modemStandard=modemStandard, ethTXMaxCollisions=ethTXMaxCollisions, saf=saf, ethRXCRCErrors=ethRXCRCErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioGenStatus=radioGenStatus, modemACMmodulationMin=modemACMmodulationMin, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethGFPDropedFrames=ethGFPDropedFrames, modemCarrierOffset=modemCarrierOffset, modemStatistics=modemStatistics, hostname=hostname, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemErroredSecond=modemErroredSecond, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemLDPCdecoderStress=modemLDPCdecoderStress, modemUptime=modemUptime, ethTXGiants=ethTXGiants, modemIndex=modemIndex, vlanTable=vlanTable, modemEntry=modemEntry, license=license, modemTotalCapacity=modemTotalCapacity, modemModulation=modemModulation, ethGFPFCSErrors=ethGFPFCSErrors, modemRowStatus=modemRowStatus, atpcEnabled=atpcEnabled)
