...
mibBuilder.exportSymbols("SAF-IPRADIO", product=product, ethRXCodeErrors=ethRXCodeErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, aTPCTable=aTPCTable, modemBackgroundBlockErrror=modemBackgroundBlockErrror, atpcTxPowerCorrection=atpcTxPowerCorrection, modemCarrierOffset=modemCarrierOffset, ethTXUnderruns=ethTXUnderruns, ethRXPrevPktDropped=ethRXPrevPktDropped, ethGFPDropedFrames=ethGFPDropedFrames, ethRXMulticasts=ethRXMulticasts, ethRXUnsupOpcodes=ethRXUnsupOpcodes, localIp=localIp, localIpMask=localIpMask, safip=safip, modemRadialMSE=modemRadialMSE, modemE1T1Channels=modemE1T1Channels, ethTXCollisions=ethTXCollisions, modemACMmodulationMin=modemACMmodulationMin, ethRXCRCErrors=ethRXCRCErrors, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXVlanTags=ethTXVlanTags, description=description, vlanCfgStat=vlanCfgStat, modemModulation=modemModulation, license=license, modemStatistics=modemStatistics, modemErroredSecond=modemErroredSecond, licenseMask=licenseMask, hostname=hostname, vlanEntry=vlanEntry, modemAcqStatus=modemAcqStatus, ethGFPFCSErrors=ethGFPFCSErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemACMengine=modemACMengine, modemUptime=modemUptime, modemGeneralStatus=modemGeneralStatus, ipRadioMgmt=ipRadioMgmt, modemACMtotalCapacity=modemACMtotalCapacity, radioSide=radioSide, atpcIndex=atpcIndex, ipRadioStatEth=ipRadioStatEth, ethGFPCHECErrors=ethGFPCHECErrors, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ipRadioCfg=ipRadioCfg, ethRXBroadcasts=ethRXBroadcasts, sysTemperature=sysTemperature, modemUnavailtime=modemUnavailtime, loopback_tributary_mask=loopback_tributary_mask, modemTotalCapacity=modemTotalCapacity, saf=saf, radioIndex=radioIndex, e1t1LOS=e1t1LOS, modemACMmodulationMax=modemACMmodulationMax, ethRXControlFrames=ethRXControlFrames, ethTXBackpresEvents=ethTXBackpresEvents, ethTXDones=ethTXDones, loopbacks=loopbacks, vlanRowStatus=vlanRowStatus, ipRadioStat=ipRadioStat, radioLoopback=radioLoopback, modemSymbolRateTx=modemSymbolRateTx, radioEntry=radioEntry, radioRxLevel=radioRxLevel, vlanPortmap=vlanPortmap, e1t1AIS=e1t1AIS, ethQOSTXFrames=ethQOSTXFrames, radioDuplexShift=radioDuplexShift, aTPCEntry=aTPCEntry, modemCountTime=modemCountTime, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioGenStatus=radioGenStatus, e1t1ChannelNr=e1t1ChannelNr, vlanPortType=vlanPortType, ipRadio=ipRadio, modemBandwith=modemBandwith, modemStandard=modemStandard, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXByteCounterHi=ethRXByteCounterHi, ethTXGiants=ethTXGiants, licenseUpdateStatus=licenseUpdateStatus, radioTxFrequency=radioTxFrequency, e1t1StatTable=e1t1StatTable, ethTXByteCounterLow=ethTXByteCounterLow, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXDones=ethRXDones, ethTXBroadcasts=ethTXBroadcasts, atpcEnabled=atpcEnabled, modemErroredBlock=modemErroredBlock, modemRowStatus=modemRowStatus, ethTXExcessiveDefers=ethTXExcessiveDefers, writeConfig=writeConfig, ethRXByteCounterLow=ethRXByteCounterLow, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemACMethernetCapacity=modemACMethernetCapacity, modemInternalAGCgain=modemInternalAGCgain, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXDvEvent=ethRXDvEvent, modemSymbolRateRx=modemSymbolRateRx, radioTable=radioTable, modemTable=modemTable, modemIndex=modemIndex, ethRXLongEvents=ethRXLongEvents, pointToPoint=pointToPoint, modemErroredSecondRatio=modemErroredSecondRatio, modemEthernetCapacity=modemEthernetCapacity, radioTxPower=radioTxPower, ethQOSTXDropped=ethQOSTXDropped, remoteIp=remoteIp, ethTXLateCollisions=ethTXLateCollisions, restartcpu=restartcpu, microwaveRadio=microwaveRadio, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXDribleNibbles=ethRXDribleNibbles, ethTXControlFrames=ethTXControlFrames, ethTXByteCounterHi=ethTXByteCounterHi, radioRxFrequency=radioRxFrequency, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, e1t1StatEntry=e1t1StatEntry, ethTXCRCErrors=ethTXCRCErrors, radioTxMute=radioTxMute, ipRadioCfgNetwork=ipRadioCfgNetwork, tehnika=tehnika, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemLastAcqError=modemLastAcqError, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlansEnabled=vlansEnabled, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXPauseFrames=ethRXPauseFrames, ethRXVlanTagsDetected=ethRXVlanTagsDetected, sysDateAndTime=sysDateAndTime, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXMulticasts=ethTXMulticasts, modemTotalBlockNumber=modemTotalBlockNumber, ethRXTruncatedFrames=ethRXTruncatedFrames, vlanTable=vlanTable, vlanNumber=vlanNumber, ethTXMaxCollisions=ethTXMaxCollisions, ethTXPauseFrames=ethTXPauseFrames, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemEntry=modemEntry, vlanFid=vlanFid, ethGFPDelineationErrors=ethGFPDelineationErrors)
