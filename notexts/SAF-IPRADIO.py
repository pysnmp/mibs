...
mibBuilder.exportSymbols("SAF-IPRADIO", e1t1LOS=e1t1LOS, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemTable=modemTable, modemACMtotalCapacity=modemACMtotalCapacity, ethRXCodeErrors=ethRXCodeErrors, radioDuplexShift=radioDuplexShift, ethRXDvEvent=ethRXDvEvent, modemE1T1ChannelMask=modemE1T1ChannelMask, e1t1ChannelNr=e1t1ChannelNr, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, restartcpu=restartcpu, modemInternalAGCgain=modemInternalAGCgain, radioRxLevel=radioRxLevel, modemEthernetCapacity=modemEthernetCapacity, ethTXByteCounterHi=ethTXByteCounterHi, ethGFPDelineationErrors=ethGFPDelineationErrors, remoteIp=remoteIp, ipRadio=ipRadio, aTPCTable=aTPCTable, licenseUpdateStatus=licenseUpdateStatus, ethTXPauseFrames=ethTXPauseFrames, radioTxPower=radioTxPower, radioIndex=radioIndex, vlansEnabled=vlansEnabled, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethQOSTXFrames=ethQOSTXFrames, e1t1AIS=e1t1AIS, modemGeneralStatus=modemGeneralStatus, ethRXPauseFrames=ethRXPauseFrames, modemIndex=modemIndex, ethRXControlFrames=ethRXControlFrames, loopbacks=loopbacks, ethRXBroadcasts=ethRXBroadcasts, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXVlanTags=ethTXVlanTags, ethTXCRCErrors=ethTXCRCErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethQOSRXQ1Frames=ethQOSRXQ1Frames, safip=safip, radioTxFrequency=radioTxFrequency, modemLDPCdecoderStress=modemLDPCdecoderStress, vlanEntry=vlanEntry, radioSide=radioSide, modemSymbolRateRx=modemSymbolRateRx, ethRXDones=ethRXDones, writeConfig=writeConfig, modemSymbolRateTx=modemSymbolRateTx, vlanCfgStat=vlanCfgStat, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, sysDateAndTime=sysDateAndTime, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemRadialMSE=modemRadialMSE, ethQOSTXDropped=ethQOSTXDropped, vlanFid=vlanFid, modemTotalBlockNumber=modemTotalBlockNumber, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemStandard=modemStandard, modemErroredSecondRatio=modemErroredSecondRatio, ethRXMulticasts=ethRXMulticasts, modemErroredSecond=modemErroredSecond, radioRxFrequency=radioRxFrequency, modemEntry=modemEntry, ethTXExcessiveDefers=ethTXExcessiveDefers, ipRadioCfgGeneral=ipRadioCfgGeneral, modemLastAcqError=modemLastAcqError, modemBandwith=modemBandwith, saf=saf, description=description, modemRowStatus=modemRowStatus, modemUnavailtime=modemUnavailtime, radioTxMute=radioTxMute, e1t1StatEntry=e1t1StatEntry, e1t1StatTable=e1t1StatTable, modemACMmodulationMin=modemACMmodulationMin, modemUptime=modemUptime, ethRXByteCounterLow=ethRXByteCounterLow, ethTXBroadcasts=ethTXBroadcasts, license=license, radioLoopback=radioLoopback, modemModulation=modemModulation, ethTXCollisions=ethTXCollisions, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXByteCounterLow=ethTXByteCounterLow, atpcTxPowerCorrection=atpcTxPowerCorrection, modemStatistics=modemStatistics, ethRXLongEvents=ethRXLongEvents, ethRXPrevPktDropped=ethRXPrevPktDropped, licenseMask=licenseMask, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemErroredBlock=modemErroredBlock, ipRadioCfgNetwork=ipRadioCfgNetwork, modemCarrierOffset=modemCarrierOffset, ethTXGiants=ethTXGiants, modemACMengine=modemACMengine, vlanNumber=vlanNumber, ethTXMulticasts=ethTXMulticasts, ethRXTruncatedFrames=ethRXTruncatedFrames, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXBackpresEvents=ethTXBackpresEvents, modemTotalCapacity=modemTotalCapacity, ipRadioStatEth=ipRadioStatEth, modemE1T1Channels=modemE1T1Channels, ethTXDones=ethTXDones, radioGenStatus=radioGenStatus, vlanTable=vlanTable, vlanRowStatus=vlanRowStatus, ethRXByteCounterHi=ethRXByteCounterHi, microwaveRadio=microwaveRadio, ipRadioCfg=ipRadioCfg, ethTXLengthCheckErrors=ethTXLengthCheckErrors, localIpMask=localIpMask, ethTXUnderruns=ethTXUnderruns, ethGFPFCSErrors=ethGFPFCSErrors, pointToPoint=pointToPoint, ethTXMaxCollisions=ethTXMaxCollisions, ethTXControlFrames=ethTXControlFrames, radioEntry=radioEntry, ipRadioStat=ipRadioStat, ipRadioMgmt=ipRadioMgmt, sysTemperature=sysTemperature, modemBackgroundBlockErrror=modemBackgroundBlockErrror, tehnika=tehnika, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, localIp=localIp, ethRXCRCErrors=ethRXCRCErrors, modemCountTime=modemCountTime, modemACMmodulationMax=modemACMmodulationMax, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, hostname=hostname, modemACMethernetCapacity=modemACMethernetCapacity, loopback_tributary_mask=loopback_tributary_mask, aTPCEntry=aTPCEntry, atpcIndex=atpcIndex, vlanPortType=vlanPortType, vlanPortmap=vlanPortmap, ethTXLateCollisions=ethTXLateCollisions, modemAcqStatus=modemAcqStatus, atpcEnabled=atpcEnabled, ethRXDribleNibbles=ethRXDribleNibbles, radioTable=radioTable, ethGFPDropedFrames=ethGFPDropedFrames, product=product, ethGFPCHECErrors=ethGFPCHECErrors)
