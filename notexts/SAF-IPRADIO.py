...
mibBuilder.exportSymbols("SAF-IPRADIO", radioSide=radioSide, ethGFPDropedFrames=ethGFPDropedFrames, modemTotalBlockNumber=modemTotalBlockNumber, aTPCEntry=aTPCEntry, ethRXControlFrames=ethRXControlFrames, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXPauseFrames=ethRXPauseFrames, modemACMmodulationMax=modemACMmodulationMax, modemErroredSecond=modemErroredSecond, ethTXMulticasts=ethTXMulticasts, vlanPortType=vlanPortType, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlanPortmap=vlanPortmap, ethTXCollisions=ethTXCollisions, modemACMtotalCapacity=modemACMtotalCapacity, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethGFPFCSErrors=ethGFPFCSErrors, sysTemperature=sysTemperature, modemGeneralStatus=modemGeneralStatus, vlanRowStatus=vlanRowStatus, ethTXLateCollisions=ethTXLateCollisions, ethTXBroadcasts=ethTXBroadcasts, e1t1StatEntry=e1t1StatEntry, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, atpcTxPowerCorrection=atpcTxPowerCorrection, vlansEnabled=vlansEnabled, ethTXVlanTags=ethTXVlanTags, modemRowStatus=modemRowStatus, atpcIndex=atpcIndex, ethRXByteCounterHi=ethRXByteCounterHi, loopbacks=loopbacks, ipRadioStatEth=ipRadioStatEth, ethRXDvEvent=ethRXDvEvent, modemCountTime=modemCountTime, modemACMethernetCapacity=modemACMethernetCapacity, modemInternalAGCgain=modemInternalAGCgain, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethGFPCHECErrors=ethGFPCHECErrors, e1t1LOS=e1t1LOS, ethRXVlanTagsDetected=ethRXVlanTagsDetected, hostname=hostname, radioTxPower=radioTxPower, modemUnavailtime=modemUnavailtime, ipRadioStat=ipRadioStat, ethRXByteCounterLow=ethRXByteCounterLow, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemErroredBlock=modemErroredBlock, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXDribleNibbles=ethRXDribleNibbles, microwaveRadio=microwaveRadio, modemStandard=modemStandard, modemSymbolRateRx=modemSymbolRateRx, radioTxMute=radioTxMute, modemAcqStatus=modemAcqStatus, writeConfig=writeConfig, modemE1T1ChannelMask=modemE1T1ChannelMask, product=product, modemModulation=modemModulation, ethTXUnderruns=ethTXUnderruns, saf=saf, tehnika=tehnika, radioLoopback=radioLoopback, description=description, licenseUpdateStatus=licenseUpdateStatus, modemSymbolRateTx=modemSymbolRateTx, ethTXGiants=ethTXGiants, radioTable=radioTable, vlanFid=vlanFid, ethGFPDelineationErrors=ethGFPDelineationErrors, radioRxFrequency=radioRxFrequency, ethRXUnsupOpcodes=ethRXUnsupOpcodes, localIp=localIp, pointToPoint=pointToPoint, e1t1ChannelNr=e1t1ChannelNr, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, vlanTable=vlanTable, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXMulticasts=ethRXMulticasts, ethTXPauseFrames=ethTXPauseFrames, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioRxLevel=radioRxLevel, modemErroredSecondRatio=modemErroredSecondRatio, ethTXExcessiveDefers=ethTXExcessiveDefers, ethQOSTXFrames=ethQOSTXFrames, modemACMmodulationMin=modemACMmodulationMin, modemEntry=modemEntry, ethTXControlFrames=ethTXControlFrames, ethRXLongEvents=ethRXLongEvents, modemLastAcqError=modemLastAcqError, ethTXCRCErrors=ethTXCRCErrors, modemIndex=modemIndex, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, vlanNumber=vlanNumber, ipRadio=ipRadio, e1t1StatTable=e1t1StatTable, ethRXPrevPktDropped=ethRXPrevPktDropped, sysDateAndTime=sysDateAndTime, modemStatistics=modemStatistics, radioGenStatus=radioGenStatus, modemCarrierOffset=modemCarrierOffset, modemTable=modemTable, restartcpu=restartcpu, localIpMask=localIpMask, ethRXCodeErrors=ethRXCodeErrors, ethRXCRCErrors=ethRXCRCErrors, ethTXMaxCollisions=ethTXMaxCollisions, ethTXByteCounterHi=ethTXByteCounterHi, licenseMask=licenseMask, ethQOSTXDropped=ethQOSTXDropped, atpcEnabled=atpcEnabled, e1t1AIS=e1t1AIS, ipRadioMgmt=ipRadioMgmt, modemUptime=modemUptime, vlanCfgStat=vlanCfgStat, ethTXBackpresEvents=ethTXBackpresEvents, modemEthernetCapacity=modemEthernetCapacity, radioEntry=radioEntry, modemACMengine=modemACMengine, radioDuplexShift=radioDuplexShift, safip=safip, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXDones=ethRXDones, modemRadialMSE=modemRadialMSE, license=license, vlanEntry=vlanEntry, loopback_tributary_mask=loopback_tributary_mask, modemE1T1Channels=modemE1T1Channels, modemLDPCdecoderStress=modemLDPCdecoderStress, remoteIp=remoteIp, ethTXDones=ethTXDones, radioIndex=radioIndex, modemBandwith=modemBandwith, modemTotalCapacity=modemTotalCapacity, aTPCTable=aTPCTable, radioTxFrequency=radioTxFrequency, ipRadioCfg=ipRadioCfg, ethRXBroadcasts=ethRXBroadcasts, ethTXByteCounterLow=ethTXByteCounterLow, ethRXTruncatedFrames=ethRXTruncatedFrames)
