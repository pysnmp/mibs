...
mibBuilder.exportSymbols("SAF-IPRADIO", licenseMask=licenseMask, modemUptime=modemUptime, ethTXByteCounterHi=ethTXByteCounterHi, ethRXLongEvents=ethRXLongEvents, loopbacks=loopbacks, radioGenStatus=radioGenStatus, licenseUpdateStatus=licenseUpdateStatus, e1t1LOS=e1t1LOS, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, vlanNumber=vlanNumber, localIp=localIp, ethRXMulticasts=ethRXMulticasts, ipRadioStatEth=ipRadioStatEth, e1t1AIS=e1t1AIS, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemInternalAGCgain=modemInternalAGCgain, ethRXCRCErrors=ethRXCRCErrors, ipRadioCfg=ipRadioCfg, radioDuplexShift=radioDuplexShift, radioTxFrequency=radioTxFrequency, ethTXDones=ethTXDones, ipRadioCfgNetwork=ipRadioCfgNetwork, radioSide=radioSide, pointToPoint=pointToPoint, ethTXLengthCheckErrors=ethTXLengthCheckErrors, vlanEntry=vlanEntry, modemErroredBlock=modemErroredBlock, modemStatistics=modemStatistics, ethTXMaxCollisions=ethTXMaxCollisions, modemTotalCapacity=modemTotalCapacity, ipRadioMgmt=ipRadioMgmt, radioRxLevel=radioRxLevel, ethRXUnsupOpcodes=ethRXUnsupOpcodes, vlanCfgStat=vlanCfgStat, description=description, modemErroredSecond=modemErroredSecond, ethQOSTXDropped=ethQOSTXDropped, modemErroredSecondRatio=modemErroredSecondRatio, atpcTxPowerCorrection=atpcTxPowerCorrection, modemTable=modemTable, sysTemperature=sysTemperature, ethRXBroadcasts=ethRXBroadcasts, modemIndex=modemIndex, ethTXCollisions=ethTXCollisions, modemGeneralStatus=modemGeneralStatus, modemLastAcqError=modemLastAcqError, ethTXVlanTags=ethTXVlanTags, safip=safip, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, hostname=hostname, loopback_tributary_mask=loopback_tributary_mask, remoteIp=remoteIp, ethTXExcessiveDefers=ethTXExcessiveDefers, e1t1StatTable=e1t1StatTable, ethTXWireByteCounterLow=ethTXWireByteCounterLow, tehnika=tehnika, modemE1T1Channels=modemE1T1Channels, modemACMmodulationMin=modemACMmodulationMin, modemEntry=modemEntry, e1t1StatEntry=e1t1StatEntry, ethRXPrevPktDropped=ethRXPrevPktDropped, modemUnavailtime=modemUnavailtime, ethRXControlFrames=ethRXControlFrames, ethRXDribleNibbles=ethRXDribleNibbles, atpcEnabled=atpcEnabled, ethTXPauseFrames=ethTXPauseFrames, radioIndex=radioIndex, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXUnderruns=ethTXUnderruns, saf=saf, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, license=license, modemACMengine=modemACMengine, modemACMmodulationMax=modemACMmodulationMax, modemCarrierOffset=modemCarrierOffset, modemRowStatus=modemRowStatus, modemE1T1ChannelMask=modemE1T1ChannelMask, modemACMethernetCapacity=modemACMethernetCapacity, atpcIndex=atpcIndex, modemAcqStatus=modemAcqStatus, aTPCEntry=aTPCEntry, ethRXByteCounterHi=ethRXByteCounterHi, ethRXCodeErrors=ethRXCodeErrors, ethRXDvEvent=ethRXDvEvent, microwaveRadio=microwaveRadio, product=product, ipRadioCfgGeneral=ipRadioCfgGeneral, radioTxPower=radioTxPower, modemRadialMSE=modemRadialMSE, ethTXBackpresEvents=ethTXBackpresEvents, modemACMtotalCapacity=modemACMtotalCapacity, ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadio=ipRadio, ethTXControlFrames=ethTXControlFrames, radioEntry=radioEntry, ethTXCRCErrors=ethTXCRCErrors, ethGFPDropedFrames=ethGFPDropedFrames, ethGFPFCSErrors=ethGFPFCSErrors, vlanRowStatus=vlanRowStatus, ethTXBroadcasts=ethTXBroadcasts, e1t1ChannelNr=e1t1ChannelNr, ipRadioStat=ipRadioStat, vlanTable=vlanTable, vlansEnabled=vlansEnabled, modemStandard=modemStandard, modemSymbolRateRx=modemSymbolRateRx, writeConfig=writeConfig, vlanPortmap=vlanPortmap, modemLDPCdecoderStress=modemLDPCdecoderStress, radioTxMute=radioTxMute, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemEthernetCapacity=modemEthernetCapacity, aTPCTable=aTPCTable, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXMulticasts=ethTXMulticasts, ethQOSTXFrames=ethQOSTXFrames, ethRXDones=ethRXDones, vlanPortType=vlanPortType, vlanFid=vlanFid, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemSymbolRateTx=modemSymbolRateTx, radioTable=radioTable, ethTXByteCounterLow=ethTXByteCounterLow, ethRXByteCounterLow=ethRXByteCounterLow, ethTXGiants=ethTXGiants, sysDateAndTime=sysDateAndTime, radioRxFrequency=radioRxFrequency, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethGFPCHECErrors=ethGFPCHECErrors, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemModulation=modemModulation, localIpMask=localIpMask, modemTotalBlockNumber=modemTotalBlockNumber, ethRXPauseFrames=ethRXPauseFrames, modemCountTime=modemCountTime, ethTXLateCollisions=ethTXLateCollisions, radioLoopback=radioLoopback, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, restartcpu=restartcpu, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemBandwith=modemBandwith)
