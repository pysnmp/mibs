...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXExcessiveDefers=ethTXExcessiveDefers, vlanFid=vlanFid, radioIndex=radioIndex, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethGFPDropedFrames=ethGFPDropedFrames, ipRadioStat=ipRadioStat, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethQOSTXFrames=ethQOSTXFrames, license=license, modemUnavailtime=modemUnavailtime, radioGenStatus=radioGenStatus, ethRXDvEvent=ethRXDvEvent, licenseMask=licenseMask, radioEntry=radioEntry, ethGFPCHECErrors=ethGFPCHECErrors, sysTemperature=sysTemperature, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXByteCounterLow=ethTXByteCounterLow, radioTxPower=radioTxPower, radioRxFrequency=radioRxFrequency, ethRXByteCounterHi=ethRXByteCounterHi, modemEntry=modemEntry, licenseUpdateStatus=licenseUpdateStatus, modemTotalCapacity=modemTotalCapacity, modemBackgroundBlockErrror=modemBackgroundBlockErrror, e1t1StatEntry=e1t1StatEntry, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemRadialMSE=modemRadialMSE, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethGFPFCSErrors=ethGFPFCSErrors, remoteIp=remoteIp, modemTable=modemTable, modemSymbolRateTx=modemSymbolRateTx, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXMaxCollisions=ethTXMaxCollisions, ipRadioCfg=ipRadioCfg, vlansEnabled=vlansEnabled, ethRXCodeErrors=ethRXCodeErrors, modemRowStatus=modemRowStatus, modemCarrierOffset=modemCarrierOffset, ethQOSTXDropped=ethQOSTXDropped, e1t1AIS=e1t1AIS, atpcIndex=atpcIndex, radioTxMute=radioTxMute, restartcpu=restartcpu, ethRXControlFrames=ethRXControlFrames, sysDateAndTime=sysDateAndTime, tehnika=tehnika, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemGeneralStatus=modemGeneralStatus, ethRXTruncatedFrames=ethRXTruncatedFrames, e1t1ChannelNr=e1t1ChannelNr, ethTXCollisions=ethTXCollisions, ethRXByteCounterLow=ethRXByteCounterLow, e1t1LOS=e1t1LOS, modemEthernetCapacity=modemEthernetCapacity, radioLoopback=radioLoopback, ethTXVlanTags=ethTXVlanTags, localIpMask=localIpMask, modemACMmodulationMin=modemACMmodulationMin, modemACMethernetCapacity=modemACMethernetCapacity, ethTXUnderruns=ethTXUnderruns, writeConfig=writeConfig, modemStandard=modemStandard, radioDuplexShift=radioDuplexShift, aTPCTable=aTPCTable, modemACMengine=modemACMengine, modemErroredSecondRatio=modemErroredSecondRatio, modemSymbolRateRx=modemSymbolRateRx, modemErroredSecond=modemErroredSecond, ethGFPDelineationErrors=ethGFPDelineationErrors, microwaveRadio=microwaveRadio, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXLateCollisions=ethTXLateCollisions, localIp=localIp, safip=safip, ethTXDones=ethTXDones, modemModulation=modemModulation, loopbacks=loopbacks, aTPCEntry=aTPCEntry, hostname=hostname, modemACMmodulationMax=modemACMmodulationMax, vlanPortType=vlanPortType, ethRXCRCErrors=ethRXCRCErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemIndex=modemIndex, radioTable=radioTable, product=product, modemLDPCdecoderStress=modemLDPCdecoderStress, ipRadioStatEth=ipRadioStatEth, ethTXCRCErrors=ethTXCRCErrors, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXPrevPktDropped=ethRXPrevPktDropped, modemE1T1Channels=modemE1T1Channels, e1t1StatTable=e1t1StatTable, vlanRowStatus=vlanRowStatus, saf=saf, radioSide=radioSide, ipRadioCfgGeneral=ipRadioCfgGeneral, radioRxLevel=radioRxLevel, ethTXBroadcasts=ethTXBroadcasts, modemLastAcqError=modemLastAcqError, ipRadio=ipRadio, ethTXPauseFrames=ethTXPauseFrames, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXGiants=ethTXGiants, atpcEnabled=atpcEnabled, modemCountTime=modemCountTime, vlanEntry=vlanEntry, ethTXBackpresEvents=ethTXBackpresEvents, vlanCfgStat=vlanCfgStat, modemACMtotalCapacity=modemACMtotalCapacity, ethRXLongEvents=ethRXLongEvents, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemAcqStatus=modemAcqStatus, ethRXPauseFrames=ethRXPauseFrames, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, atpcTxPowerCorrection=atpcTxPowerCorrection, vlanTable=vlanTable, ethTXControlFrames=ethTXControlFrames, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioTxFrequency=radioTxFrequency, modemInternalAGCgain=modemInternalAGCgain, ethTXMulticasts=ethTXMulticasts, pointToPoint=pointToPoint, modemBandwith=modemBandwith, description=description, vlanPortmap=vlanPortmap, modemUptime=modemUptime, ethRXDones=ethRXDones, ethRXBroadcasts=ethRXBroadcasts, ethRXDribleNibbles=ethRXDribleNibbles, loopback_tributary_mask=loopback_tributary_mask, vlanNumber=vlanNumber, modemErroredBlock=modemErroredBlock, modemTotalBlockNumber=modemTotalBlockNumber, ethTXByteCounterHi=ethTXByteCounterHi, ethRXMulticasts=ethRXMulticasts, modemStatistics=modemStatistics, ipRadioMgmt=ipRadioMgmt)
