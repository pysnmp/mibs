...
mibBuilder.exportSymbols("SAF-IPRADIO", modemEntry=modemEntry, radioIndex=radioIndex, atpcIndex=atpcIndex, ethRXControlFrames=ethRXControlFrames, e1t1AIS=e1t1AIS, restartcpu=restartcpu, radioTxPower=radioTxPower, vlanPortmap=vlanPortmap, modemSymbolRateTx=modemSymbolRateTx, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXPauseFrames=ethTXPauseFrames, modemE1T1ChannelMask=modemE1T1ChannelMask, safip=safip, modemTotalCapacity=modemTotalCapacity, ipRadioStat=ipRadioStat, ethTXExcessiveDefers=ethTXExcessiveDefers, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, licenseMask=licenseMask, modemTotalBlockNumber=modemTotalBlockNumber, modemGeneralStatus=modemGeneralStatus, vlanCfgStat=vlanCfgStat, license=license, modemUptime=modemUptime, ethTXDones=ethTXDones, vlanNumber=vlanNumber, vlanTable=vlanTable, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioRxFrequency=radioRxFrequency, aTPCEntry=aTPCEntry, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, description=description, saf=saf, modemStatistics=modemStatistics, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemTable=modemTable, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemInternalAGCgain=modemInternalAGCgain, radioSide=radioSide, modemErroredSecondRatio=modemErroredSecondRatio, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXMulticasts=ethTXMulticasts, radioTxMute=radioTxMute, radioGenStatus=radioGenStatus, licenseUpdateStatus=licenseUpdateStatus, vlansEnabled=vlansEnabled, atpcEnabled=atpcEnabled, modemBandwith=modemBandwith, aTPCTable=aTPCTable, modemModulation=modemModulation, ethRXCRCErrors=ethRXCRCErrors, ethRXBroadcasts=ethRXBroadcasts, ethRXDvEvent=ethRXDvEvent, modemEthernetCapacity=modemEthernetCapacity, modemLDPCdecoderStress=modemLDPCdecoderStress, ipRadioCfgNetwork=ipRadioCfgNetwork, microwaveRadio=microwaveRadio, sysDateAndTime=sysDateAndTime, ipRadioMgmt=ipRadioMgmt, ethGFPDelineationErrors=ethGFPDelineationErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ipRadioCfgGeneral=ipRadioCfgGeneral, remoteIp=remoteIp, ethTXMaxCollisions=ethTXMaxCollisions, ethTXBroadcasts=ethTXBroadcasts, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethQOSRXQ1Frames=ethQOSRXQ1Frames, e1t1ChannelNr=e1t1ChannelNr, ipRadio=ipRadio, vlanFid=vlanFid, ethTXByteCounterLow=ethTXByteCounterLow, radioTable=radioTable, ethRXPrevPktDropped=ethRXPrevPktDropped, modemErroredSecond=modemErroredSecond, ethGFPCHECErrors=ethGFPCHECErrors, sysTemperature=sysTemperature, radioDuplexShift=radioDuplexShift, ethTXVlanTags=ethTXVlanTags, modemSymbolRateRx=modemSymbolRateRx, ethGFPFCSErrors=ethGFPFCSErrors, ethRXPauseFrames=ethRXPauseFrames, hostname=hostname, e1t1StatTable=e1t1StatTable, modemAcqStatus=modemAcqStatus, modemACMmodulationMin=modemACMmodulationMin, modemACMethernetCapacity=modemACMethernetCapacity, vlanRowStatus=vlanRowStatus, modemACMmodulationMax=modemACMmodulationMax, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXMulticasts=ethRXMulticasts, modemRowStatus=modemRowStatus, product=product, ethQOSTXFrames=ethQOSTXFrames, modemStandard=modemStandard, modemCountTime=modemCountTime, ethTXControlFrames=ethTXControlFrames, radioLoopback=radioLoopback, modemErroredBlock=modemErroredBlock, ethRXLongEvents=ethRXLongEvents, writeConfig=writeConfig, ethTXCollisions=ethTXCollisions, ethTXByteCounterHi=ethTXByteCounterHi, modemRadialMSE=modemRadialMSE, ethRXByteCounterLow=ethRXByteCounterLow, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, loopbacks=loopbacks, modemACMengine=modemACMengine, radioEntry=radioEntry, modemLastAcqError=modemLastAcqError, ethRXTruncatedFrames=ethRXTruncatedFrames, modemACMtotalCapacity=modemACMtotalCapacity, ethRXByteCounterHi=ethRXByteCounterHi, ethRXCodeErrors=ethRXCodeErrors, ipRadioCfg=ipRadioCfg, ethRXDribleNibbles=ethRXDribleNibbles, radioTxFrequency=radioTxFrequency, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemUnavailtime=modemUnavailtime, ethRXVlanTagsDetected=ethRXVlanTagsDetected, localIp=localIp, vlanPortType=vlanPortType, ethQOSTXDropped=ethQOSTXDropped, modemE1T1Channels=modemE1T1Channels, ethTXBackpresEvents=ethTXBackpresEvents, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, atpcTxPowerCorrection=atpcTxPowerCorrection, modemSeverelyErroredSecond=modemSeverelyErroredSecond, localIpMask=localIpMask, pointToPoint=pointToPoint, ethGFPDropedFrames=ethGFPDropedFrames, ethTXGiants=ethTXGiants, ipRadioStatEth=ipRadioStatEth, ethTXLateCollisions=ethTXLateCollisions, ethTXCRCErrors=ethTXCRCErrors, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioRxLevel=radioRxLevel, e1t1LOS=e1t1LOS, vlanEntry=vlanEntry, modemCarrierOffset=modemCarrierOffset, loopback_tributary_mask=loopback_tributary_mask, ethTXUnderruns=ethTXUnderruns, modemIndex=modemIndex, tehnika=tehnika, ethRXDones=ethRXDones, e1t1StatEntry=e1t1StatEntry)
