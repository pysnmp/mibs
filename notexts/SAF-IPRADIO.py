...
mibBuilder.exportSymbols("SAF-IPRADIO", atpcTxPowerCorrection=atpcTxPowerCorrection, modemEntry=modemEntry, radioLoopback=radioLoopback, radioSide=radioSide, ethTXGiants=ethTXGiants, restartcpu=restartcpu, loopback_tributary_mask=loopback_tributary_mask, ethTXMulticasts=ethTXMulticasts, modemUnavailtime=modemUnavailtime, tehnika=tehnika, ethTXCollisions=ethTXCollisions, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemStatistics=modemStatistics, ethRXPauseFrames=ethRXPauseFrames, modemBackgroundBlockErrror=modemBackgroundBlockErrror, licenseUpdateStatus=licenseUpdateStatus, modemCarrierOffset=modemCarrierOffset, ethTXLateCollisions=ethTXLateCollisions, modemACMmodulationMax=modemACMmodulationMax, ethTXCRCErrors=ethTXCRCErrors, aTPCEntry=aTPCEntry, ipRadio=ipRadio, ethTXUnderruns=ethTXUnderruns, remoteIp=remoteIp, modemBandwith=modemBandwith, licenseMask=licenseMask, localIpMask=localIpMask, license=license, ethRXLongEvents=ethRXLongEvents, ethTXByteCounterLow=ethTXByteCounterLow, ethRXVlanTagsDetected=ethRXVlanTagsDetected, e1t1ChannelNr=e1t1ChannelNr, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadioStat=ipRadioStat, modemStandard=modemStandard, modemUptime=modemUptime, radioTxPower=radioTxPower, modemCountTime=modemCountTime, ipRadioMgmt=ipRadioMgmt, ipRadioCfg=ipRadioCfg, vlanPortmap=vlanPortmap, ethQOSTXDropped=ethQOSTXDropped, ethGFPCHECErrors=ethGFPCHECErrors, vlanEntry=vlanEntry, modemACMethernetCapacity=modemACMethernetCapacity, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemEthernetCapacity=modemEthernetCapacity, modemInternalAGCgain=modemInternalAGCgain, e1t1AIS=e1t1AIS, radioGenStatus=radioGenStatus, modemErroredBlock=modemErroredBlock, atpcEnabled=atpcEnabled, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, sysTemperature=sysTemperature, ethQOSTXFrames=ethQOSTXFrames, modemAcqStatus=modemAcqStatus, ethTXByteCounterHi=ethTXByteCounterHi, ipRadioStatEth=ipRadioStatEth, modemE1T1Channels=modemE1T1Channels, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXByteCounterLow=ethRXByteCounterLow, e1t1LOS=e1t1LOS, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemTotalBlockNumber=modemTotalBlockNumber, modemACMtotalCapacity=modemACMtotalCapacity, ethTXBackpresEvents=ethTXBackpresEvents, modemErroredSecond=modemErroredSecond, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemACMengine=modemACMengine, ethTXMaxCollisions=ethTXMaxCollisions, modemSymbolRateTx=modemSymbolRateTx, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXPrevPktDropped=ethRXPrevPktDropped, radioDuplexShift=radioDuplexShift, modemRowStatus=modemRowStatus, ethRXControlFrames=ethRXControlFrames, radioTxMute=radioTxMute, ethRXCodeErrors=ethRXCodeErrors, e1t1StatEntry=e1t1StatEntry, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, e1t1StatTable=e1t1StatTable, sysDateAndTime=sysDateAndTime, safip=safip, vlanPortType=vlanPortType, modemRadialMSE=modemRadialMSE, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemIndex=modemIndex, ethRXByteCounterHi=ethRXByteCounterHi, pointToPoint=pointToPoint, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXDones=ethTXDones, description=description, vlanTable=vlanTable, ipRadioCfgGeneral=ipRadioCfgGeneral, ipRadioCfgNetwork=ipRadioCfgNetwork, ethGFPFCSErrors=ethGFPFCSErrors, radioEntry=radioEntry, ethRXCRCErrors=ethRXCRCErrors, modemSymbolRateRx=modemSymbolRateRx, ethGFPDropedFrames=ethGFPDropedFrames, ethTXBroadcasts=ethTXBroadcasts, vlanNumber=vlanNumber, atpcIndex=atpcIndex, ethRXDvEvent=ethRXDvEvent, microwaveRadio=microwaveRadio, saf=saf, modemTable=modemTable, ethRXDribleNibbles=ethRXDribleNibbles, ethTXPauseFrames=ethTXPauseFrames, radioTable=radioTable, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlanCfgStat=vlanCfgStat, ethRXMulticasts=ethRXMulticasts, modemE1T1ChannelMask=modemE1T1ChannelMask, vlanRowStatus=vlanRowStatus, radioTxFrequency=radioTxFrequency, ethRXDones=ethRXDones, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemErroredSecondRatio=modemErroredSecondRatio, radioRxLevel=radioRxLevel, vlanFid=vlanFid, hostname=hostname, localIp=localIp, vlansEnabled=vlansEnabled, writeConfig=writeConfig, radioIndex=radioIndex, aTPCTable=aTPCTable, radioRxFrequency=radioRxFrequency, modemModulation=modemModulation, ethTXVlanTags=ethTXVlanTags, ethRXBroadcasts=ethRXBroadcasts, modemTotalCapacity=modemTotalCapacity, product=product, loopbacks=loopbacks, modemLastAcqError=modemLastAcqError, modemACMmodulationMin=modemACMmodulationMin, modemGeneralStatus=modemGeneralStatus, ethTXControlFrames=ethTXControlFrames)
