...
mibBuilder.exportSymbols("SAF-IPRADIO", atpcEnabled=atpcEnabled, modemBackgroundBlockErrror=modemBackgroundBlockErrror, restartcpu=restartcpu, ethTXLengthCheckErrors=ethTXLengthCheckErrors, licenseUpdateStatus=licenseUpdateStatus, modemIndex=modemIndex, ethTXVlanTags=ethTXVlanTags, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXByteCounterLow=ethRXByteCounterLow, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXCollisions=ethTXCollisions, ethGFPFCSErrors=ethGFPFCSErrors, localIp=localIp, localIpMask=localIpMask, vlanPortmap=vlanPortmap, radioDuplexShift=radioDuplexShift, modemE1T1Channels=modemE1T1Channels, modemTable=modemTable, aTPCEntry=aTPCEntry, vlanFid=vlanFid, e1t1StatTable=e1t1StatTable, modemLDPCdecoderStress=modemLDPCdecoderStress, ipRadioCfgNetwork=ipRadioCfgNetwork, modemErroredSecondRatio=modemErroredSecondRatio, modemModulation=modemModulation, radioTable=radioTable, ethRXPrevPktDropped=ethRXPrevPktDropped, ipRadioCfg=ipRadioCfg, ethTXBackpresEvents=ethTXBackpresEvents, vlanPortType=vlanPortType, modemACMmodulationMin=modemACMmodulationMin, ethQOSTXDropped=ethQOSTXDropped, vlanNumber=vlanNumber, ipRadioCfgGeneral=ipRadioCfgGeneral, modemCarrierOffset=modemCarrierOffset, modemACMmodulationMax=modemACMmodulationMax, ethRXDribleNibbles=ethRXDribleNibbles, tehnika=tehnika, ipRadio=ipRadio, hostname=hostname, ethTXGiants=ethTXGiants, ethTXDones=ethTXDones, sysTemperature=sysTemperature, ethRXBroadcasts=ethRXBroadcasts, ethTXExcessiveDefers=ethTXExcessiveDefers, microwaveRadio=microwaveRadio, ethTXMaxCollisions=ethTXMaxCollisions, modemStatistics=modemStatistics, modemRadialMSE=modemRadialMSE, ethGFPCHECErrors=ethGFPCHECErrors, modemStandard=modemStandard, ethRXCodeErrors=ethRXCodeErrors, product=product, ethTXControlFrames=ethTXControlFrames, vlanEntry=vlanEntry, vlansEnabled=vlansEnabled, aTPCTable=aTPCTable, pointToPoint=pointToPoint, radioTxFrequency=radioTxFrequency, radioRxFrequency=radioRxFrequency, modemErroredBlock=modemErroredBlock, loopback_tributary_mask=loopback_tributary_mask, atpcTxPowerCorrection=atpcTxPowerCorrection, modemSymbolRateTx=modemSymbolRateTx, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemACMengine=modemACMengine, modemSeverelyErroredSecond=modemSeverelyErroredSecond, vlanTable=vlanTable, radioEntry=radioEntry, modemGeneralStatus=modemGeneralStatus, modemACMtotalCapacity=modemACMtotalCapacity, description=description, e1t1StatEntry=e1t1StatEntry, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXUnderruns=ethTXUnderruns, modemRowStatus=modemRowStatus, modemUptime=modemUptime, modemAcqStatus=modemAcqStatus, safip=safip, modemTotalCapacity=modemTotalCapacity, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioTxPower=radioTxPower, modemSymbolRateRx=modemSymbolRateRx, ethTXByteCounterLow=ethTXByteCounterLow, license=license, remoteIp=remoteIp, radioIndex=radioIndex, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXControlFrames=ethRXControlFrames, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXLateCollisions=ethTXLateCollisions, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXPauseFrames=ethTXPauseFrames, modemBandwith=modemBandwith, ethGFPDelineationErrors=ethGFPDelineationErrors, modemCountTime=modemCountTime, e1t1AIS=e1t1AIS, modemLastAcqError=modemLastAcqError, modemACMethernetCapacity=modemACMethernetCapacity, loopbacks=loopbacks, licenseMask=licenseMask, e1t1ChannelNr=e1t1ChannelNr, radioTxMute=radioTxMute, vlanRowStatus=vlanRowStatus, sysDateAndTime=sysDateAndTime, vlanCfgStat=vlanCfgStat, ethRXDones=ethRXDones, e1t1LOS=e1t1LOS, modemTotalBlockNumber=modemTotalBlockNumber, radioLoopback=radioLoopback, ethRXLongEvents=ethRXLongEvents, radioRxLevel=radioRxLevel, ethQOSTXFrames=ethQOSTXFrames, ethTXCRCErrors=ethTXCRCErrors, ipRadioStat=ipRadioStat, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethGFPDropedFrames=ethGFPDropedFrames, ethTXMulticasts=ethTXMulticasts, ethTXBroadcasts=ethTXBroadcasts, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, atpcIndex=atpcIndex, ethRXCRCErrors=ethRXCRCErrors, ethRXByteCounterHi=ethRXByteCounterHi, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemEntry=modemEntry, radioSide=radioSide, radioGenStatus=radioGenStatus, ethRXPauseFrames=ethRXPauseFrames, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXMulticasts=ethRXMulticasts, modemErroredSecond=modemErroredSecond, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemInternalAGCgain=modemInternalAGCgain, modemEthernetCapacity=modemEthernetCapacity, modemUnavailtime=modemUnavailtime, ipRadioMgmt=ipRadioMgmt, ipRadioStatEth=ipRadioStatEth, ethTXByteCounterHi=ethTXByteCounterHi, saf=saf, writeConfig=writeConfig, ethRXDvEvent=ethRXDvEvent)
