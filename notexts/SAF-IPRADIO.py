...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXCRCErrors=ethRXCRCErrors, radioDuplexShift=radioDuplexShift, radioEntry=radioEntry, ethRXDones=ethRXDones, ethTXControlFrames=ethTXControlFrames, ipRadioStat=ipRadioStat, licenseUpdateStatus=licenseUpdateStatus, ipRadio=ipRadio, license=license, modemACMtotalCapacity=modemACMtotalCapacity, radioSide=radioSide, radioLoopback=radioLoopback, e1t1StatEntry=e1t1StatEntry, ethRXCodeErrors=ethRXCodeErrors, ethTXBackpresEvents=ethTXBackpresEvents, ethTXMaxCollisions=ethTXMaxCollisions, e1t1AIS=e1t1AIS, restartcpu=restartcpu, radioTxFrequency=radioTxFrequency, aTPCEntry=aTPCEntry, aTPCTable=aTPCTable, description=description, modemBandwith=modemBandwith, modemStatistics=modemStatistics, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXPauseFrames=ethRXPauseFrames, ethTXMulticasts=ethTXMulticasts, ethTXDones=ethTXDones, ethRXByteCounterLow=ethRXByteCounterLow, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXVlanTagsDetected=ethRXVlanTagsDetected, e1t1StatTable=e1t1StatTable, radioRxLevel=radioRxLevel, e1t1LOS=e1t1LOS, radioTxMute=radioTxMute, vlanRowStatus=vlanRowStatus, atpcTxPowerCorrection=atpcTxPowerCorrection, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemCarrierOffset=modemCarrierOffset, vlanCfgStat=vlanCfgStat, modemErroredSecond=modemErroredSecond, vlanPortType=vlanPortType, remoteIp=remoteIp, modemTable=modemTable, localIpMask=localIpMask, modemIndex=modemIndex, ethTXUnderruns=ethTXUnderruns, modemErroredBlock=modemErroredBlock, modemTotalCapacity=modemTotalCapacity, modemACMethernetCapacity=modemACMethernetCapacity, modemStandard=modemStandard, ethTXWireByteCounterHi=ethTXWireByteCounterHi, vlanTable=vlanTable, modemRowStatus=modemRowStatus, ethTXCRCErrors=ethTXCRCErrors, atpcIndex=atpcIndex, atpcEnabled=atpcEnabled, modemLastAcqError=modemLastAcqError, modemRadialMSE=modemRadialMSE, modemACMmodulationMax=modemACMmodulationMax, modemE1T1ChannelMask=modemE1T1ChannelMask, radioGenStatus=radioGenStatus, modemTotalBlockNumber=modemTotalBlockNumber, radioTable=radioTable, sysTemperature=sysTemperature, licenseMask=licenseMask, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemModulation=modemModulation, modemUnavailtime=modemUnavailtime, modemACMmodulationMin=modemACMmodulationMin, modemGeneralStatus=modemGeneralStatus, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioRxFrequency=radioRxFrequency, localIp=localIp, ethRXDribleNibbles=ethRXDribleNibbles, modemCountTime=modemCountTime, ipRadioStatEth=ipRadioStatEth, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, sysDateAndTime=sysDateAndTime, pointToPoint=pointToPoint, ipRadioCfg=ipRadioCfg, modemInternalAGCgain=modemInternalAGCgain, tehnika=tehnika, ethRXControlFrames=ethRXControlFrames, ipRadioMgmt=ipRadioMgmt, ethGFPDropedFrames=ethGFPDropedFrames, radioTxPower=radioTxPower, ethGFPDelineationErrors=ethGFPDelineationErrors, ethQOSTXFrames=ethQOSTXFrames, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethGFPFCSErrors=ethGFPFCSErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlanNumber=vlanNumber, saf=saf, hostname=hostname, modemSymbolRateTx=modemSymbolRateTx, vlansEnabled=vlansEnabled, ethTXGiants=ethTXGiants, modemErroredSecondRatio=modemErroredSecondRatio, ethRXByteCounterHi=ethRXByteCounterHi, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXVlanTags=ethTXVlanTags, product=product, ethTXByteCounterLow=ethTXByteCounterLow, e1t1ChannelNr=e1t1ChannelNr, ethTXCollisions=ethTXCollisions, ethRXTruncatedFrames=ethRXTruncatedFrames, modemACMengine=modemACMengine, vlanPortmap=vlanPortmap, ethRXMulticasts=ethRXMulticasts, vlanFid=vlanFid, modemUptime=modemUptime, modemAcqStatus=modemAcqStatus, loopbacks=loopbacks, modemE1T1Channels=modemE1T1Channels, microwaveRadio=microwaveRadio, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, writeConfig=writeConfig, modemSymbolRateRx=modemSymbolRateRx, modemEthernetCapacity=modemEthernetCapacity, ethQOSTXDropped=ethQOSTXDropped, vlanEntry=vlanEntry, safip=safip, loopback_tributary_mask=loopback_tributary_mask, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethGFPCHECErrors=ethGFPCHECErrors, ethTXLateCollisions=ethTXLateCollisions, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXBroadcasts=ethTXBroadcasts, ethRXDvEvent=ethRXDvEvent, ethTXExcessiveDefers=ethTXExcessiveDefers, modemEntry=modemEntry, ethRXLongEvents=ethRXLongEvents, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXPauseFrames=ethTXPauseFrames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXByteCounterHi=ethTXByteCounterHi, radioIndex=radioIndex, ethRXBroadcasts=ethRXBroadcasts, modemLDPCdecoderStress=modemLDPCdecoderStress, modemSeverelyErroredSecond=modemSeverelyErroredSecond)
