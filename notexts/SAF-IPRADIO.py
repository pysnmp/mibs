...
mibBuilder.exportSymbols("SAF-IPRADIO", modemErroredSecond=modemErroredSecond, loopbacks=loopbacks, vlanCfgStat=vlanCfgStat, ethTXCollisions=ethTXCollisions, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemEntry=modemEntry, modemRowStatus=modemRowStatus, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, aTPCEntry=aTPCEntry, atpcTxPowerCorrection=atpcTxPowerCorrection, ethGFPFCSErrors=ethGFPFCSErrors, licenseUpdateStatus=licenseUpdateStatus, localIp=localIp, ethGFPDropedFrames=ethGFPDropedFrames, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXByteCounterHi=ethRXByteCounterHi, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXByteCounterLow=ethTXByteCounterLow, radioIndex=radioIndex, ethTXVlanTags=ethTXVlanTags, ethTXBackpresEvents=ethTXBackpresEvents, radioRxLevel=radioRxLevel, radioEntry=radioEntry, modemGeneralStatus=modemGeneralStatus, radioDuplexShift=radioDuplexShift, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, vlanPortmap=vlanPortmap, ethRXCRCErrors=ethRXCRCErrors, safip=safip, e1t1AIS=e1t1AIS, ethTXExcessiveDefers=ethTXExcessiveDefers, ipRadioStat=ipRadioStat, modemACMtotalCapacity=modemACMtotalCapacity, radioRxFrequency=radioRxFrequency, atpcIndex=atpcIndex, ipRadioStatEth=ipRadioStatEth, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, product=product, ethTXGiants=ethTXGiants, ethTXPauseFrames=ethTXPauseFrames, radioLoopback=radioLoopback, vlanEntry=vlanEntry, e1t1LOS=e1t1LOS, localIpMask=localIpMask, atpcEnabled=atpcEnabled, e1t1StatTable=e1t1StatTable, saf=saf, modemTotalBlockNumber=modemTotalBlockNumber, radioSide=radioSide, ethRXControlFrames=ethRXControlFrames, modemE1T1Channels=modemE1T1Channels, modemACMmodulationMax=modemACMmodulationMax, ethRXMulticasts=ethRXMulticasts, remoteIp=remoteIp, ethTXBroadcasts=ethTXBroadcasts, modemE1T1ChannelMask=modemE1T1ChannelMask, loopback_tributary_mask=loopback_tributary_mask, radioTxPower=radioTxPower, ethTXMaxCollisions=ethTXMaxCollisions, ethGFPCHECErrors=ethGFPCHECErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethQOSRXQ1Frames=ethQOSRXQ1Frames, microwaveRadio=microwaveRadio, ethRXDvEvent=ethRXDvEvent, writeConfig=writeConfig, sysTemperature=sysTemperature, ipRadioMgmt=ipRadioMgmt, radioTxFrequency=radioTxFrequency, ethQOSTXFrames=ethQOSTXFrames, hostname=hostname, ethTXWireByteCounterHi=ethTXWireByteCounterHi, vlanTable=vlanTable, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXUnderruns=ethTXUnderruns, ipRadioCfg=ipRadioCfg, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXLongEvents=ethRXLongEvents, ethTXMulticasts=ethTXMulticasts, vlanRowStatus=vlanRowStatus, e1t1ChannelNr=e1t1ChannelNr, ethRXDribleNibbles=ethRXDribleNibbles, modemTotalCapacity=modemTotalCapacity, modemUnavailtime=modemUnavailtime, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXByteCounterLow=ethRXByteCounterLow, modemCarrierOffset=modemCarrierOffset, modemErroredBlock=modemErroredBlock, radioTxMute=radioTxMute, modemAcqStatus=modemAcqStatus, modemTable=modemTable, modemInternalAGCgain=modemInternalAGCgain, ethRXDones=ethRXDones, modemLDPCdecoderStress=modemLDPCdecoderStress, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXControlFrames=ethTXControlFrames, ethRXPauseFrames=ethRXPauseFrames, licenseMask=licenseMask, restartcpu=restartcpu, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, vlanNumber=vlanNumber, ethRXCodeErrors=ethRXCodeErrors, e1t1StatEntry=e1t1StatEntry, modemModulation=modemModulation, modemEthernetCapacity=modemEthernetCapacity, modemACMethernetCapacity=modemACMethernetCapacity, pointToPoint=pointToPoint, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ipRadioCfgGeneral=ipRadioCfgGeneral, vlanFid=vlanFid, modemSymbolRateRx=modemSymbolRateRx, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioTable=radioTable, modemBandwith=modemBandwith, modemLastAcqError=modemLastAcqError, ethQOSTXDropped=ethQOSTXDropped, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlanPortType=vlanPortType, ethTXDones=ethTXDones, ethTXLateCollisions=ethTXLateCollisions, ethTXByteCounterHi=ethTXByteCounterHi, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemACMmodulationMin=modemACMmodulationMin, radioGenStatus=radioGenStatus, license=license, modemSymbolRateTx=modemSymbolRateTx, description=description, vlansEnabled=vlansEnabled, modemIndex=modemIndex, modemStatistics=modemStatistics, tehnika=tehnika, modemCountTime=modemCountTime, modemACMengine=modemACMengine, ethRXBroadcasts=ethRXBroadcasts, ethTXCRCErrors=ethTXCRCErrors, aTPCTable=aTPCTable, ipRadio=ipRadio, modemErroredSecondRatio=modemErroredSecondRatio, modemRadialMSE=modemRadialMSE, modemUptime=modemUptime, modemStandard=modemStandard, sysDateAndTime=sysDateAndTime)
