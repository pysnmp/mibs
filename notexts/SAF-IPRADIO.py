...
mibBuilder.exportSymbols("SAF-IPRADIO", e1t1ChannelNr=e1t1ChannelNr, radioTable=radioTable, radioDuplexShift=radioDuplexShift, modemSymbolRateRx=modemSymbolRateRx, modemModulation=modemModulation, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXDribleNibbles=ethRXDribleNibbles, modemACMethernetCapacity=modemACMethernetCapacity, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXBroadcasts=ethTXBroadcasts, ethRXByteCounterHi=ethRXByteCounterHi, ethGFPCHECErrors=ethGFPCHECErrors, ethRXCodeErrors=ethRXCodeErrors, ipRadioStatEth=ipRadioStatEth, ethTXByteCounterLow=ethTXByteCounterLow, modemErroredSecond=modemErroredSecond, ethTXCollisions=ethTXCollisions, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ipRadioCfg=ipRadioCfg, ethGFPDropedFrames=ethGFPDropedFrames, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXPauseFrames=ethRXPauseFrames, ethTXLateCollisions=ethTXLateCollisions, vlanPortType=vlanPortType, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXByteCounterLow=ethRXByteCounterLow, localIpMask=localIpMask, ethRXMulticasts=ethRXMulticasts, radioSide=radioSide, ethTXPauseFrames=ethTXPauseFrames, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, saf=saf, ethTXExcessiveDefers=ethTXExcessiveDefers, modemUptime=modemUptime, localIp=localIp, modemTable=modemTable, modemEthernetCapacity=modemEthernetCapacity, ethTXWireByteCounterHi=ethTXWireByteCounterHi, writeConfig=writeConfig, ethTXMaxCollisions=ethTXMaxCollisions, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemTotalCapacity=modemTotalCapacity, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXCRCErrors=ethTXCRCErrors, atpcEnabled=atpcEnabled, vlanCfgStat=vlanCfgStat, modemACMtotalCapacity=modemACMtotalCapacity, modemRadialMSE=modemRadialMSE, radioLoopback=radioLoopback, sysTemperature=sysTemperature, atpcIndex=atpcIndex, tehnika=tehnika, modemGeneralStatus=modemGeneralStatus, radioIndex=radioIndex, safip=safip, license=license, e1t1StatTable=e1t1StatTable, restartcpu=restartcpu, ethTXMulticasts=ethTXMulticasts, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXLongEvents=ethRXLongEvents, radioTxFrequency=radioTxFrequency, radioTxPower=radioTxPower, vlansEnabled=vlansEnabled, modemACMengine=modemACMengine, modemAcqStatus=modemAcqStatus, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXGiants=ethTXGiants, ethRXPrevPktDropped=ethRXPrevPktDropped, vlanNumber=vlanNumber, ipRadio=ipRadio, ethTXVlanTags=ethTXVlanTags, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXUnderruns=ethTXUnderruns, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethQOSTXFrames=ethQOSTXFrames, description=description, aTPCEntry=aTPCEntry, ethTXControlFrames=ethTXControlFrames, modemErroredBlock=modemErroredBlock, vlanTable=vlanTable, ethGFPFCSErrors=ethGFPFCSErrors, ethRXBroadcasts=ethRXBroadcasts, hostname=hostname, ethTXDones=ethTXDones, modemStandard=modemStandard, vlanFid=vlanFid, ethRXDones=ethRXDones, pointToPoint=pointToPoint, radioRxFrequency=radioRxFrequency, modemCountTime=modemCountTime, radioTxMute=radioTxMute, modemTotalBlockNumber=modemTotalBlockNumber, modemEntry=modemEntry, modemIndex=modemIndex, loopback_tributary_mask=loopback_tributary_mask, radioEntry=radioEntry, ipRadioMgmt=ipRadioMgmt, radioRxLevel=radioRxLevel, ethRXDvEvent=ethRXDvEvent, licenseMask=licenseMask, vlanRowStatus=vlanRowStatus, modemBandwith=modemBandwith, sysDateAndTime=sysDateAndTime, radioGenStatus=radioGenStatus, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXByteCounterHi=ethTXByteCounterHi, loopbacks=loopbacks, modemUnavailtime=modemUnavailtime, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, remoteIp=remoteIp, modemACMmodulationMin=modemACMmodulationMin, aTPCTable=aTPCTable, product=product, licenseUpdateStatus=licenseUpdateStatus, ethTXBackpresEvents=ethTXBackpresEvents, ethRXCRCErrors=ethRXCRCErrors, modemE1T1Channels=modemE1T1Channels, ipRadioCfgNetwork=ipRadioCfgNetwork, ethQOSTXDropped=ethQOSTXDropped, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemCarrierOffset=modemCarrierOffset, modemLDPCdecoderStress=modemLDPCdecoderStress, modemACMmodulationMax=modemACMmodulationMax, vlanPortmap=vlanPortmap, e1t1AIS=e1t1AIS, modemRowStatus=modemRowStatus, modemErroredSecondRatio=modemErroredSecondRatio, vlanEntry=vlanEntry, e1t1LOS=e1t1LOS, e1t1StatEntry=e1t1StatEntry, modemStatistics=modemStatistics, microwaveRadio=microwaveRadio, modemLastAcqError=modemLastAcqError, modemInternalAGCgain=modemInternalAGCgain, ipRadioStat=ipRadioStat, modemSymbolRateTx=modemSymbolRateTx, ethRXControlFrames=ethRXControlFrames)
