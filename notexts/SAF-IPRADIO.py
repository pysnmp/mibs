...
mibBuilder.exportSymbols("SAF-IPRADIO", loopbacks=loopbacks, modemStandard=modemStandard, radioTxPower=radioTxPower, localIpMask=localIpMask, radioGenStatus=radioGenStatus, radioRxLevel=radioRxLevel, ethRXDribleNibbles=ethRXDribleNibbles, modemACMmodulationMin=modemACMmodulationMin, ethRXPrevPktDropped=ethRXPrevPktDropped, licenseUpdateStatus=licenseUpdateStatus, ethGFPFCSErrors=ethGFPFCSErrors, ethTXPauseFrames=ethTXPauseFrames, vlanNumber=vlanNumber, modemStatistics=modemStatistics, licenseMask=licenseMask, modemAcqStatus=modemAcqStatus, modemACMengine=modemACMengine, radioTxFrequency=radioTxFrequency, ethRXLongEvents=ethRXLongEvents, ethGFPDropedFrames=ethGFPDropedFrames, license=license, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethQOSTXFrames=ethQOSTXFrames, modemErroredSecond=modemErroredSecond, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXCollisions=ethTXCollisions, radioRxFrequency=radioRxFrequency, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlanTable=vlanTable, pointToPoint=pointToPoint, modemTable=modemTable, tehnika=tehnika, radioSide=radioSide, ethRXCodeErrors=ethRXCodeErrors, ethTXCRCErrors=ethTXCRCErrors, sysTemperature=sysTemperature, ethTXMulticasts=ethTXMulticasts, vlansEnabled=vlansEnabled, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ipRadio=ipRadio, hostname=hostname, modemEntry=modemEntry, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, loopback_tributary_mask=loopback_tributary_mask, modemCarrierOffset=modemCarrierOffset, sysDateAndTime=sysDateAndTime, modemACMethernetCapacity=modemACMethernetCapacity, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXByteCounterLow=ethRXByteCounterLow, ipRadioCfgNetwork=ipRadioCfgNetwork, vlanCfgStat=vlanCfgStat, radioTxMute=radioTxMute, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXControlFrames=ethTXControlFrames, modemACMmodulationMax=modemACMmodulationMax, modemLDPCdecoderStress=modemLDPCdecoderStress, modemACMtotalCapacity=modemACMtotalCapacity, ethTXByteCounterHi=ethTXByteCounterHi, ipRadioCfg=ipRadioCfg, ethGFPCHECErrors=ethGFPCHECErrors, ipRadioStatEth=ipRadioStatEth, e1t1LOS=e1t1LOS, ethTXDones=ethTXDones, vlanPortmap=vlanPortmap, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, e1t1StatTable=e1t1StatTable, ethTXGiants=ethTXGiants, ethRXControlFrames=ethRXControlFrames, radioIndex=radioIndex, modemEthernetCapacity=modemEthernetCapacity, ipRadioStat=ipRadioStat, saf=saf, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXDones=ethRXDones, ethTXVlanTags=ethTXVlanTags, modemCountTime=modemCountTime, modemSymbolRateRx=modemSymbolRateRx, modemInternalAGCgain=modemInternalAGCgain, ethTXExcessiveDefers=ethTXExcessiveDefers, modemBandwith=modemBandwith, ethQOSTXDropped=ethQOSTXDropped, e1t1StatEntry=e1t1StatEntry, modemSymbolRateTx=modemSymbolRateTx, radioDuplexShift=radioDuplexShift, vlanRowStatus=vlanRowStatus, ethRXCRCErrors=ethRXCRCErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXDvEvent=ethRXDvEvent, ethRXPauseFrames=ethRXPauseFrames, modemErroredBlock=modemErroredBlock, modemTotalBlockNumber=modemTotalBlockNumber, modemUnavailtime=modemUnavailtime, modemGeneralStatus=modemGeneralStatus, product=product, modemErroredSecondRatio=modemErroredSecondRatio, description=description, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioLoopback=radioLoopback, atpcIndex=atpcIndex, aTPCEntry=aTPCEntry, safip=safip, modemE1T1ChannelMask=modemE1T1ChannelMask, radioTable=radioTable, modemRowStatus=modemRowStatus, writeConfig=writeConfig, modemLastAcqError=modemLastAcqError, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemTotalCapacity=modemTotalCapacity, ethTXBackpresEvents=ethTXBackpresEvents, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXBroadcasts=ethRXBroadcasts, modemUptime=modemUptime, vlanEntry=vlanEntry, ipRadioMgmt=ipRadioMgmt, localIp=localIp, radioEntry=radioEntry, modemModulation=modemModulation, microwaveRadio=microwaveRadio, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethGFPDelineationErrors=ethGFPDelineationErrors, modemIndex=modemIndex, ethTXLateCollisions=ethTXLateCollisions, ethTXMaxCollisions=ethTXMaxCollisions, e1t1ChannelNr=e1t1ChannelNr, aTPCTable=aTPCTable, modemRadialMSE=modemRadialMSE, modemE1T1Channels=modemE1T1Channels, remoteIp=remoteIp, ethRXByteCounterHi=ethRXByteCounterHi, ethTXBroadcasts=ethTXBroadcasts, vlanFid=vlanFid, ethTXByteCounterLow=ethTXByteCounterLow, ethTXUnderruns=ethTXUnderruns, ethRXVlanTagsDetected=ethRXVlanTagsDetected, vlanPortType=vlanPortType, atpcEnabled=atpcEnabled, restartcpu=restartcpu, ipRadioCfgGeneral=ipRadioCfgGeneral, e1t1AIS=e1t1AIS, ethRXMulticasts=ethRXMulticasts, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors)
