...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXBroadcasts=ethTXBroadcasts, product=product, localIpMask=localIpMask, modemGeneralStatus=modemGeneralStatus, ethTXWireByteCounterLow=ethTXWireByteCounterLow, loopback_tributary_mask=loopback_tributary_mask, modemLastAcqError=modemLastAcqError, radioRxLevel=radioRxLevel, ethRXByteCounterLow=ethRXByteCounterLow, ethTXMaxCollisions=ethTXMaxCollisions, localIp=localIp, ethTXDones=ethTXDones, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ipRadioCfgGeneral=ipRadioCfgGeneral, vlanEntry=vlanEntry, modemInternalAGCgain=modemInternalAGCgain, ipRadioStatEth=ipRadioStatEth, ethTXPauseFrames=ethTXPauseFrames, vlanPortmap=vlanPortmap, ethGFPDropedFrames=ethGFPDropedFrames, modemCarrierOffset=modemCarrierOffset, ethRXCodeErrors=ethRXCodeErrors, licenseUpdateStatus=licenseUpdateStatus, e1t1StatTable=e1t1StatTable, radioTxPower=radioTxPower, radioSide=radioSide, radioTxFrequency=radioTxFrequency, modemACMtotalCapacity=modemACMtotalCapacity, ethRXControlFrames=ethRXControlFrames, atpcIndex=atpcIndex, license=license, ethTXLateCollisions=ethTXLateCollisions, saf=saf, ethTXVlanTags=ethTXVlanTags, ethRXCRCErrors=ethRXCRCErrors, description=description, modemTotalBlockNumber=modemTotalBlockNumber, e1t1StatEntry=e1t1StatEntry, ethQOSTXFrames=ethQOSTXFrames, safip=safip, ethTXUnderruns=ethTXUnderruns, modemCountTime=modemCountTime, modemACMmodulationMin=modemACMmodulationMin, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemACMethernetCapacity=modemACMethernetCapacity, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXPrevPktDropped=ethRXPrevPktDropped, e1t1LOS=e1t1LOS, radioLoopback=radioLoopback, ethQOSTXDropped=ethQOSTXDropped, modemUptime=modemUptime, ipRadioCfg=ipRadioCfg, ethGFPFCSErrors=ethGFPFCSErrors, microwaveRadio=microwaveRadio, ipRadioStat=ipRadioStat, loopbacks=loopbacks, e1t1AIS=e1t1AIS, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXByteCounterLow=ethTXByteCounterLow, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemEthernetCapacity=modemEthernetCapacity, modemAcqStatus=modemAcqStatus, ethTXWireByteCounterHi=ethTXWireByteCounterHi, e1t1ChannelNr=e1t1ChannelNr, ethTXExcessiveDefers=ethTXExcessiveDefers, modemErroredSecondRatio=modemErroredSecondRatio, modemEntry=modemEntry, ethTXControlFrames=ethTXControlFrames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXGiants=ethTXGiants, ethRXLongEvents=ethRXLongEvents, modemModulation=modemModulation, ethRXByteCounterHi=ethRXByteCounterHi, modemE1T1ChannelMask=modemE1T1ChannelMask, modemTotalCapacity=modemTotalCapacity, modemErroredBlock=modemErroredBlock, modemLDPCdecoderStress=modemLDPCdecoderStress, vlanPortType=vlanPortType, ethRXDribleNibbles=ethRXDribleNibbles, vlanFid=vlanFid, vlanCfgStat=vlanCfgStat, radioTxMute=radioTxMute, licenseMask=licenseMask, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, aTPCTable=aTPCTable, modemSymbolRateRx=modemSymbolRateRx, ethRXDvEvent=ethRXDvEvent, restartcpu=restartcpu, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioEntry=radioEntry, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemStandard=modemStandard, ethTXBackpresEvents=ethTXBackpresEvents, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemE1T1Channels=modemE1T1Channels, tehnika=tehnika, ethTXMulticasts=ethTXMulticasts, modemIndex=modemIndex, modemBandwith=modemBandwith, ethTXByteCounterHi=ethTXByteCounterHi, ethRXBroadcasts=ethRXBroadcasts, vlansEnabled=vlansEnabled, ethRXPauseFrames=ethRXPauseFrames, ethRXTruncatedFrames=ethRXTruncatedFrames, radioRxFrequency=radioRxFrequency, modemTable=modemTable, vlanTable=vlanTable, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemACMengine=modemACMengine, radioIndex=radioIndex, ipRadioCfgNetwork=ipRadioCfgNetwork, sysDateAndTime=sysDateAndTime, ipRadioMgmt=ipRadioMgmt, atpcEnabled=atpcEnabled, remoteIp=remoteIp, ethRXVlanTagsDetected=ethRXVlanTagsDetected, aTPCEntry=aTPCEntry, radioDuplexShift=radioDuplexShift, modemErroredSecond=modemErroredSecond, vlanNumber=vlanNumber, ipRadio=ipRadio, modemSymbolRateTx=modemSymbolRateTx, vlanRowStatus=vlanRowStatus, sysTemperature=sysTemperature, ethTXCollisions=ethTXCollisions, radioTable=radioTable, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemRadialMSE=modemRadialMSE, ethGFPCHECErrors=ethGFPCHECErrors, modemACMmodulationMax=modemACMmodulationMax, modemUnavailtime=modemUnavailtime, modemRowStatus=modemRowStatus, radioGenStatus=radioGenStatus, hostname=hostname, modemStatistics=modemStatistics, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, writeConfig=writeConfig, pointToPoint=pointToPoint, ethRXMulticasts=ethRXMulticasts, ethRXDones=ethRXDones, ethTXCRCErrors=ethTXCRCErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror)
