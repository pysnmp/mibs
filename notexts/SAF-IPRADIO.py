...
mibBuilder.exportSymbols("SAF-IPRADIO", modemRowStatus=modemRowStatus, modemACMengine=modemACMengine, radioTxPower=radioTxPower, vlanFid=vlanFid, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemACMmodulationMin=modemACMmodulationMin, ethRXByteCounterHi=ethRXByteCounterHi, modemRadialMSE=modemRadialMSE, radioEntry=radioEntry, vlansEnabled=vlansEnabled, modemE1T1ChannelMask=modemE1T1ChannelMask, modemEntry=modemEntry, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioIndex=radioIndex, ethTXDones=ethTXDones, ethTXLateCollisions=ethTXLateCollisions, ethTXByteCounterHi=ethTXByteCounterHi, modemErroredBlock=modemErroredBlock, ethTXBackpresEvents=ethTXBackpresEvents, modemLastAcqError=modemLastAcqError, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemStandard=modemStandard, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethQOSRXQ2Frames=ethQOSRXQ2Frames, sysTemperature=sysTemperature, safip=safip, sysDateAndTime=sysDateAndTime, e1t1StatTable=e1t1StatTable, modemGeneralStatus=modemGeneralStatus, modemInternalAGCgain=modemInternalAGCgain, loopbacks=loopbacks, ipRadioStatEth=ipRadioStatEth, localIpMask=localIpMask, ethGFPDelineationErrors=ethGFPDelineationErrors, modemCountTime=modemCountTime, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXCRCErrors=ethTXCRCErrors, modemSymbolRateTx=modemSymbolRateTx, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ipRadio=ipRadio, ipRadioCfg=ipRadioCfg, modemStatistics=modemStatistics, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioRxLevel=radioRxLevel, restartcpu=restartcpu, saf=saf, ethTXGiants=ethTXGiants, ethTXControlFrames=ethTXControlFrames, radioRxFrequency=radioRxFrequency, radioTxMute=radioTxMute, microwaveRadio=microwaveRadio, e1t1LOS=e1t1LOS, radioTxFrequency=radioTxFrequency, vlanPortmap=vlanPortmap, localIp=localIp, modemTable=modemTable, e1t1StatEntry=e1t1StatEntry, e1t1ChannelNr=e1t1ChannelNr, modemLDPCdecoderStress=modemLDPCdecoderStress, ethGFPCHECErrors=ethGFPCHECErrors, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, pointToPoint=pointToPoint, ethGFPFCSErrors=ethGFPFCSErrors, modemACMtotalCapacity=modemACMtotalCapacity, ethRXMulticasts=ethRXMulticasts, ethTXByteCounterLow=ethTXByteCounterLow, ethQOSTXFrames=ethQOSTXFrames, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXLongEvents=ethRXLongEvents, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ipRadioMgmt=ipRadioMgmt, radioDuplexShift=radioDuplexShift, modemIndex=modemIndex, ethQOSTXDropped=ethQOSTXDropped, modemUptime=modemUptime, modemErroredSecond=modemErroredSecond, aTPCTable=aTPCTable, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXDones=ethRXDones, ethRXDribleNibbles=ethRXDribleNibbles, licenseMask=licenseMask, tehnika=tehnika, e1t1AIS=e1t1AIS, modemSymbolRateRx=modemSymbolRateRx, ethRXBroadcasts=ethRXBroadcasts, description=description, ipRadioCfgGeneral=ipRadioCfgGeneral, hostname=hostname, modemACMmodulationMax=modemACMmodulationMax, radioLoopback=radioLoopback, modemBandwith=modemBandwith, license=license, modemTotalCapacity=modemTotalCapacity, ethTXPauseFrames=ethTXPauseFrames, vlanPortType=vlanPortType, ethRXPauseFrames=ethRXPauseFrames, ethTXCollisions=ethTXCollisions, ethTXMulticasts=ethTXMulticasts, vlanCfgStat=vlanCfgStat, ethRXDvEvent=ethRXDvEvent, modemE1T1Channels=modemE1T1Channels, modemACMethernetCapacity=modemACMethernetCapacity, vlanEntry=vlanEntry, ethTXMaxCollisions=ethTXMaxCollisions, ethGFPDropedFrames=ethGFPDropedFrames, modemErroredSecondRatio=modemErroredSecondRatio, ipRadioCfgNetwork=ipRadioCfgNetwork, modemCarrierOffset=modemCarrierOffset, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXByteCounterLow=ethRXByteCounterLow, writeConfig=writeConfig, vlanTable=vlanTable, ethTXBroadcasts=ethTXBroadcasts, licenseUpdateStatus=licenseUpdateStatus, modemTotalBlockNumber=modemTotalBlockNumber, vlanNumber=vlanNumber, ethRXCRCErrors=ethRXCRCErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXVlanTags=ethTXVlanTags, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlanRowStatus=vlanRowStatus, atpcEnabled=atpcEnabled, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXCodeErrors=ethRXCodeErrors, ethTXUnderruns=ethTXUnderruns, ethRXControlFrames=ethRXControlFrames, ipRadioStat=ipRadioStat, radioTable=radioTable, product=product, radioGenStatus=radioGenStatus, modemAcqStatus=modemAcqStatus, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, atpcIndex=atpcIndex, modemModulation=modemModulation, radioSide=radioSide, modemEthernetCapacity=modemEthernetCapacity, ethRXUnsupOpcodes=ethRXUnsupOpcodes, aTPCEntry=aTPCEntry, modemUnavailtime=modemUnavailtime, loopback_tributary_mask=loopback_tributary_mask, remoteIp=remoteIp)
