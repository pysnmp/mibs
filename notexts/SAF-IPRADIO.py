...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXLateCollisions=ethTXLateCollisions, ipRadioMgmt=ipRadioMgmt, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXBroadcasts=ethTXBroadcasts, localIpMask=localIpMask, ethRXUnsupOpcodes=ethRXUnsupOpcodes, tehnika=tehnika, modemBandwith=modemBandwith, ethTXMaxCollisions=ethTXMaxCollisions, sysDateAndTime=sysDateAndTime, ethTXCRCErrors=ethTXCRCErrors, vlansEnabled=vlansEnabled, e1t1StatTable=e1t1StatTable, radioRxLevel=radioRxLevel, localIp=localIp, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethGFPCHECErrors=ethGFPCHECErrors, modemGeneralStatus=modemGeneralStatus, ethTXControlFrames=ethTXControlFrames, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioSide=radioSide, vlanRowStatus=vlanRowStatus, description=description, licenseUpdateStatus=licenseUpdateStatus, safip=safip, vlanTable=vlanTable, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXPrevPktDropped=ethRXPrevPktDropped, radioTable=radioTable, hostname=hostname, ethRXTruncatedFrames=ethRXTruncatedFrames, loopbacks=loopbacks, ethTXUnderruns=ethTXUnderruns, modemRowStatus=modemRowStatus, ipRadio=ipRadio, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemStandard=modemStandard, modemCarrierOffset=modemCarrierOffset, atpcTxPowerCorrection=atpcTxPowerCorrection, modemTotalBlockNumber=modemTotalBlockNumber, modemSymbolRateRx=modemSymbolRateRx, modemErroredSecondRatio=modemErroredSecondRatio, modemACMengine=modemACMengine, ethTXGiants=ethTXGiants, vlanNumber=vlanNumber, license=license, ethQOSTXFrames=ethQOSTXFrames, loopback_tributary_mask=loopback_tributary_mask, modemACMethernetCapacity=modemACMethernetCapacity, radioRxFrequency=radioRxFrequency, modemInternalAGCgain=modemInternalAGCgain, restartcpu=restartcpu, radioTxFrequency=radioTxFrequency, e1t1ChannelNr=e1t1ChannelNr, ethRXByteCounterLow=ethRXByteCounterLow, ethRXMulticasts=ethRXMulticasts, modemModulation=modemModulation, modemACMtotalCapacity=modemACMtotalCapacity, ethRXDones=ethRXDones, modemRadialMSE=modemRadialMSE, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemUptime=modemUptime, ethTXVlanTags=ethTXVlanTags, modemUnavailtime=modemUnavailtime, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemAcqStatus=modemAcqStatus, ethGFPFCSErrors=ethGFPFCSErrors, sysTemperature=sysTemperature, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXDribleNibbles=ethRXDribleNibbles, radioLoopback=radioLoopback, aTPCEntry=aTPCEntry, e1t1LOS=e1t1LOS, ethTXPauseFrames=ethTXPauseFrames, modemACMmodulationMax=modemACMmodulationMax, vlanPortType=vlanPortType, saf=saf, modemACMmodulationMin=modemACMmodulationMin, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, product=product, ethTXMulticasts=ethTXMulticasts, ethRXBroadcasts=ethRXBroadcasts, modemEthernetCapacity=modemEthernetCapacity, ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlanFid=vlanFid, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemCountTime=modemCountTime, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ipRadioStatEth=ipRadioStatEth, atpcEnabled=atpcEnabled, modemErroredSecond=modemErroredSecond, modemTable=modemTable, ipRadioCfgGeneral=ipRadioCfgGeneral, radioTxPower=radioTxPower, e1t1AIS=e1t1AIS, vlanCfgStat=vlanCfgStat, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioGenStatus=radioGenStatus, ethGFPDropedFrames=ethGFPDropedFrames, pointToPoint=pointToPoint, modemLastAcqError=modemLastAcqError, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemE1T1Channels=modemE1T1Channels, ethRXControlFrames=ethRXControlFrames, ipRadioCfgNetwork=ipRadioCfgNetwork, modemEntry=modemEntry, modemStatistics=modemStatistics, ethTXBackpresEvents=ethTXBackpresEvents, modemLDPCdecoderStress=modemLDPCdecoderStress, vlanPortmap=vlanPortmap, ethTXCollisions=ethTXCollisions, ethTXByteCounterLow=ethTXByteCounterLow, modemTotalCapacity=modemTotalCapacity, licenseMask=licenseMask, ethRXCodeErrors=ethRXCodeErrors, radioTxMute=radioTxMute, atpcIndex=atpcIndex, ethTXByteCounterHi=ethTXByteCounterHi, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXCRCErrors=ethRXCRCErrors, writeConfig=writeConfig, ipRadioStat=ipRadioStat, e1t1StatEntry=e1t1StatEntry, ethTXDones=ethTXDones, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, remoteIp=remoteIp, radioEntry=radioEntry, ethRXLongEvents=ethRXLongEvents, ipRadioCfg=ipRadioCfg, ethRXByteCounterHi=ethRXByteCounterHi, radioIndex=radioIndex, aTPCTable=aTPCTable, ethRXDvEvent=ethRXDvEvent, ethTXExcessiveDefers=ethTXExcessiveDefers, modemIndex=modemIndex, ethQOSTXDropped=ethQOSTXDropped, vlanEntry=vlanEntry, radioDuplexShift=radioDuplexShift, modemErroredBlock=modemErroredBlock, modemSymbolRateTx=modemSymbolRateTx, ethRXPauseFrames=ethRXPauseFrames, microwaveRadio=microwaveRadio)
