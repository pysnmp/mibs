...
mibBuilder.exportSymbols("SAF-IPRADIO", ipRadio=ipRadio, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXLongEvents=ethRXLongEvents, modemCountTime=modemCountTime, e1t1StatTable=e1t1StatTable, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlanPortType=vlanPortType, vlanFid=vlanFid, modemACMmodulationMax=modemACMmodulationMax, ethTXDones=ethTXDones, loopbacks=loopbacks, ethRXByteCounterHi=ethRXByteCounterHi, vlanPortmap=vlanPortmap, ethTXMaxCollisions=ethTXMaxCollisions, modemInternalAGCgain=modemInternalAGCgain, ethTXByteCounterLow=ethTXByteCounterLow, radioTxFrequency=radioTxFrequency, license=license, ethGFPCHECErrors=ethGFPCHECErrors, radioIndex=radioIndex, ethTXPauseFrames=ethTXPauseFrames, restartcpu=restartcpu, sysTemperature=sysTemperature, radioLoopback=radioLoopback, vlanTable=vlanTable, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemGeneralStatus=modemGeneralStatus, modemTable=modemTable, e1t1ChannelNr=e1t1ChannelNr, atpcIndex=atpcIndex, modemACMengine=modemACMengine, safip=safip, modemEthernetCapacity=modemEthernetCapacity, modemErroredBlock=modemErroredBlock, ethTXUnderruns=ethTXUnderruns, modemRadialMSE=modemRadialMSE, description=description, writeConfig=writeConfig, ethRXTruncatedFrames=ethRXTruncatedFrames, product=product, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, saf=saf, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemE1T1ChannelMask=modemE1T1ChannelMask, ipRadioStat=ipRadioStat, radioTxPower=radioTxPower, ethGFPFCSErrors=ethGFPFCSErrors, ethRXMulticasts=ethRXMulticasts, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemIndex=modemIndex, radioTable=radioTable, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXMulticasts=ethTXMulticasts, modemUptime=modemUptime, e1t1LOS=e1t1LOS, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, localIpMask=localIpMask, ethRXCodeErrors=ethRXCodeErrors, modemTotalCapacity=modemTotalCapacity, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethGFPDelineationErrors=ethGFPDelineationErrors, modemCarrierOffset=modemCarrierOffset, ethTXControlFrames=ethTXControlFrames, ethTXBackpresEvents=ethTXBackpresEvents, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioDuplexShift=radioDuplexShift, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioRxLevel=radioRxLevel, loopback_tributary_mask=loopback_tributary_mask, ethTXLateCollisions=ethTXLateCollisions, atpcEnabled=atpcEnabled, radioSide=radioSide, vlanNumber=vlanNumber, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, licenseUpdateStatus=licenseUpdateStatus, ethTXByteCounterHi=ethTXByteCounterHi, ethTXExcessiveDefers=ethTXExcessiveDefers, localIp=localIp, ethTXCollisions=ethTXCollisions, ethGFPDropedFrames=ethGFPDropedFrames, modemLastAcqError=modemLastAcqError, modemStatistics=modemStatistics, ethRXVlanTagsDetected=ethRXVlanTagsDetected, e1t1StatEntry=e1t1StatEntry, modemEntry=modemEntry, ethTXVlanTags=ethTXVlanTags, modemSymbolRateRx=modemSymbolRateRx, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXControlFrames=ethRXControlFrames, radioEntry=radioEntry, licenseMask=licenseMask, modemAcqStatus=modemAcqStatus, modemTotalBlockNumber=modemTotalBlockNumber, ethTXGiants=ethTXGiants, ethTXCRCErrors=ethTXCRCErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, sysDateAndTime=sysDateAndTime, modemACMtotalCapacity=modemACMtotalCapacity, radioRxFrequency=radioRxFrequency, modemBandwith=modemBandwith, ethRXPrevPktDropped=ethRXPrevPktDropped, tehnika=tehnika, modemE1T1Channels=modemE1T1Channels, modemErroredSecondRatio=modemErroredSecondRatio, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXBroadcasts=ethRXBroadcasts, modemACMmodulationMin=modemACMmodulationMin, hostname=hostname, ethQOSTXDropped=ethQOSTXDropped, vlanCfgStat=vlanCfgStat, ethRXByteCounterLow=ethRXByteCounterLow, radioGenStatus=radioGenStatus, modemSymbolRateTx=modemSymbolRateTx, remoteIp=remoteIp, modemStandard=modemStandard, ethRXCRCErrors=ethRXCRCErrors, pointToPoint=pointToPoint, modemUnavailtime=modemUnavailtime, ethTXBroadcasts=ethTXBroadcasts, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXPauseFrames=ethRXPauseFrames, ethQOSTXFrames=ethQOSTXFrames, aTPCTable=aTPCTable, vlanRowStatus=vlanRowStatus, ethRXDvEvent=ethRXDvEvent, vlansEnabled=vlansEnabled, vlanEntry=vlanEntry, ethRXDones=ethRXDones, ipRadioMgmt=ipRadioMgmt, modemModulation=modemModulation, ipRadioStatEth=ipRadioStatEth, modemACMethernetCapacity=modemACMethernetCapacity, ethRXDribleNibbles=ethRXDribleNibbles, aTPCEntry=aTPCEntry, microwaveRadio=microwaveRadio, radioTxMute=radioTxMute, ipRadioCfgNetwork=ipRadioCfgNetwork, ipRadioCfg=ipRadioCfg, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemRowStatus=modemRowStatus, modemSeverelyErroredSecond=modemSeverelyErroredSecond, e1t1AIS=e1t1AIS, modemErroredSecond=modemErroredSecond)
