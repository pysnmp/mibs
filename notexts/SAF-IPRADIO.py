...
mibBuilder.exportSymbols("SAF-IPRADIO", ethQOSRXQ2Frames=ethQOSRXQ2Frames, sysDateAndTime=sysDateAndTime, modemTotalCapacity=modemTotalCapacity, ethTXLateCollisions=ethTXLateCollisions, ethGFPDropedFrames=ethGFPDropedFrames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXByteCounterLow=ethTXByteCounterLow, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXCollisions=ethTXCollisions, modemAcqStatus=modemAcqStatus, modemCarrierOffset=modemCarrierOffset, ethRXVlanTagsDetected=ethRXVlanTagsDetected, aTPCTable=aTPCTable, modemSymbolRateTx=modemSymbolRateTx, ipRadioMgmt=ipRadioMgmt, modemACMethernetCapacity=modemACMethernetCapacity, e1t1StatEntry=e1t1StatEntry, vlanCfgStat=vlanCfgStat, atpcEnabled=atpcEnabled, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXMulticasts=ethTXMulticasts, licenseUpdateStatus=licenseUpdateStatus, atpcTxPowerCorrection=atpcTxPowerCorrection, radioDuplexShift=radioDuplexShift, description=description, writeConfig=writeConfig, ethTXPauseFrames=ethTXPauseFrames, ipRadioStat=ipRadioStat, modemACMengine=modemACMengine, tehnika=tehnika, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethQOSTXDropped=ethQOSTXDropped, ethRXControlFrames=ethRXControlFrames, modemEntry=modemEntry, product=product, ethTXControlFrames=ethTXControlFrames, vlanRowStatus=vlanRowStatus, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlanNumber=vlanNumber, ethTXExcessiveDefers=ethTXExcessiveDefers, modemACMmodulationMax=modemACMmodulationMax, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXPauseFrames=ethRXPauseFrames, modemUptime=modemUptime, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, vlanTable=vlanTable, ethRXTruncatedFrames=ethRXTruncatedFrames, ethGFPFCSErrors=ethGFPFCSErrors, radioTxPower=radioTxPower, radioEntry=radioEntry, license=license, radioTable=radioTable, e1t1LOS=e1t1LOS, e1t1AIS=e1t1AIS, safip=safip, hostname=hostname, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXGiants=ethTXGiants, ethRXByteCounterLow=ethRXByteCounterLow, pointToPoint=pointToPoint, modemUnavailtime=modemUnavailtime, modemLDPCdecoderStress=modemLDPCdecoderStress, modemErroredBlock=modemErroredBlock, remoteIp=remoteIp, modemEthernetCapacity=modemEthernetCapacity, ethTXCRCErrors=ethTXCRCErrors, restartcpu=restartcpu, modemTotalBlockNumber=modemTotalBlockNumber, modemSymbolRateRx=modemSymbolRateRx, loopback_tributary_mask=loopback_tributary_mask, ethRXPrevPktDropped=ethRXPrevPktDropped, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemCountTime=modemCountTime, localIp=localIp, modemModulation=modemModulation, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ipRadioCfgGeneral=ipRadioCfgGeneral, vlanPortType=vlanPortType, modemErroredSecondRatio=modemErroredSecondRatio, modemACMmodulationMin=modemACMmodulationMin, radioRxLevel=radioRxLevel, ethRXDribleNibbles=ethRXDribleNibbles, ethTXVlanTags=ethTXVlanTags, ipRadioCfg=ipRadioCfg, modemRowStatus=modemRowStatus, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXBroadcasts=ethRXBroadcasts, ethTXBackpresEvents=ethTXBackpresEvents, ethTXBroadcasts=ethTXBroadcasts, radioLoopback=radioLoopback, modemStandard=modemStandard, ethRXDvEvent=ethRXDvEvent, sysTemperature=sysTemperature, ethRXLongEvents=ethRXLongEvents, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioIndex=radioIndex, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemErroredSecond=modemErroredSecond, radioGenStatus=radioGenStatus, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ipRadioStatEth=ipRadioStatEth, radioTxMute=radioTxMute, microwaveRadio=microwaveRadio, ethRXCRCErrors=ethRXCRCErrors, modemE1T1Channels=modemE1T1Channels, modemACMtotalCapacity=modemACMtotalCapacity, modemTable=modemTable, saf=saf, radioRxFrequency=radioRxFrequency, ethRXCodeErrors=ethRXCodeErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, loopbacks=loopbacks, ethTXUnderruns=ethTXUnderruns, ethTXByteCounterHi=ethTXByteCounterHi, e1t1ChannelNr=e1t1ChannelNr, vlanFid=vlanFid, radioTxFrequency=radioTxFrequency, e1t1StatTable=e1t1StatTable, ipRadio=ipRadio, vlanEntry=vlanEntry, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, aTPCEntry=aTPCEntry, ethRXMulticasts=ethRXMulticasts, ethGFPCHECErrors=ethGFPCHECErrors, modemStatistics=modemStatistics, licenseMask=licenseMask, modemBandwith=modemBandwith, atpcIndex=atpcIndex, modemGeneralStatus=modemGeneralStatus, modemIndex=modemIndex, modemInternalAGCgain=modemInternalAGCgain, ethTXMaxCollisions=ethTXMaxCollisions, localIpMask=localIpMask, radioSide=radioSide, ethRXByteCounterHi=ethRXByteCounterHi, ethQOSTXFrames=ethQOSTXFrames, vlansEnabled=vlansEnabled, vlanPortmap=vlanPortmap, modemLastAcqError=modemLastAcqError, modemRadialMSE=modemRadialMSE, ethRXDones=ethRXDones, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXDones=ethTXDones)
