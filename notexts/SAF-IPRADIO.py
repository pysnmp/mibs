...
mibBuilder.exportSymbols("SAF-IPRADIO", modemLastAcqError=modemLastAcqError, radioTable=radioTable, vlanEntry=vlanEntry, ipRadioStatEth=ipRadioStatEth, ipRadioCfgNetwork=ipRadioCfgNetwork, e1t1ChannelNr=e1t1ChannelNr, modemACMmodulationMin=modemACMmodulationMin, ethTXByteCounterLow=ethTXByteCounterLow, modemErroredSecond=modemErroredSecond, atpcEnabled=atpcEnabled, radioIndex=radioIndex, radioLoopback=radioLoopback, ethQOSRXQ1Frames=ethQOSRXQ1Frames, aTPCEntry=aTPCEntry, modemACMtotalCapacity=modemACMtotalCapacity, modemTable=modemTable, atpcIndex=atpcIndex, loopbacks=loopbacks, radioRxFrequency=radioRxFrequency, modemE1T1ChannelMask=modemE1T1ChannelMask, ethGFPDelineationErrors=ethGFPDelineationErrors, modemAcqStatus=modemAcqStatus, ethTXBackpresEvents=ethTXBackpresEvents, modemStatistics=modemStatistics, description=description, ethTXLateCollisions=ethTXLateCollisions, microwaveRadio=microwaveRadio, vlanPortmap=vlanPortmap, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXBroadcasts=ethRXBroadcasts, radioTxPower=radioTxPower, vlanCfgStat=vlanCfgStat, ethTXGiants=ethTXGiants, modemUnavailtime=modemUnavailtime, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXPauseFrames=ethRXPauseFrames, modemACMethernetCapacity=modemACMethernetCapacity, modemCountTime=modemCountTime, ethTXMaxCollisions=ethTXMaxCollisions, modemCarrierOffset=modemCarrierOffset, licenseMask=licenseMask, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioTxFrequency=radioTxFrequency, ethTXControlFrames=ethTXControlFrames, localIpMask=localIpMask, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioEntry=radioEntry, vlanNumber=vlanNumber, ethQOSTXDropped=ethQOSTXDropped, aTPCTable=aTPCTable, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXLongEvents=ethRXLongEvents, ethRXTruncatedFrames=ethRXTruncatedFrames, e1t1LOS=e1t1LOS, ethQOSTXFrames=ethQOSTXFrames, ethRXDvEvent=ethRXDvEvent, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemModulation=modemModulation, ethRXByteCounterLow=ethRXByteCounterLow, ethRXCRCErrors=ethRXCRCErrors, ethTXCollisions=ethTXCollisions, ipRadioCfg=ipRadioCfg, ethRXDribleNibbles=ethRXDribleNibbles, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemRowStatus=modemRowStatus, vlanTable=vlanTable, sysDateAndTime=sysDateAndTime, modemACMmodulationMax=modemACMmodulationMax, radioRxLevel=radioRxLevel, vlanFid=vlanFid, radioDuplexShift=radioDuplexShift, ethTXPauseFrames=ethTXPauseFrames, hostname=hostname, modemInternalAGCgain=modemInternalAGCgain, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, saf=saf, modemUptime=modemUptime, ethRXCodeErrors=ethRXCodeErrors, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXExcessiveDefers=ethTXExcessiveDefers, e1t1AIS=e1t1AIS, ethTXDones=ethTXDones, ipRadio=ipRadio, modemSymbolRateTx=modemSymbolRateTx, ethGFPCHECErrors=ethGFPCHECErrors, license=license, atpcTxPowerCorrection=atpcTxPowerCorrection, vlanRowStatus=vlanRowStatus, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemEntry=modemEntry, modemBandwith=modemBandwith, ipRadioCfgGeneral=ipRadioCfgGeneral, vlanPortType=vlanPortType, radioTxMute=radioTxMute, ethGFPFCSErrors=ethGFPFCSErrors, radioSide=radioSide, modemErroredBlock=modemErroredBlock, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemSymbolRateRx=modemSymbolRateRx, modemTotalCapacity=modemTotalCapacity, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, tehnika=tehnika, modemE1T1Channels=modemE1T1Channels, ethRXControlFrames=ethRXControlFrames, modemEthernetCapacity=modemEthernetCapacity, modemErroredSecondRatio=modemErroredSecondRatio, remoteIp=remoteIp, licenseUpdateStatus=licenseUpdateStatus, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXCRCErrors=ethTXCRCErrors, localIp=localIp, restartcpu=restartcpu, ipRadioStat=ipRadioStat, pointToPoint=pointToPoint, modemIndex=modemIndex, modemBackgroundBlockErrror=modemBackgroundBlockErrror, loopback_tributary_mask=loopback_tributary_mask, ethTXBroadcasts=ethTXBroadcasts, ethRXDones=ethRXDones, product=product, modemACMengine=modemACMengine, vlansEnabled=vlansEnabled, modemRadialMSE=modemRadialMSE, modemTotalBlockNumber=modemTotalBlockNumber, modemLDPCdecoderStress=modemLDPCdecoderStress, ipRadioMgmt=ipRadioMgmt, modemStandard=modemStandard, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXByteCounterHi=ethRXByteCounterHi, safip=safip, ethTXVlanTags=ethTXVlanTags, ethGFPDropedFrames=ethGFPDropedFrames, modemGeneralStatus=modemGeneralStatus, ethTXByteCounterHi=ethTXByteCounterHi, writeConfig=writeConfig, radioGenStatus=radioGenStatus, e1t1StatTable=e1t1StatTable, ethTXUnderruns=ethTXUnderruns, ethTXMulticasts=ethTXMulticasts, sysTemperature=sysTemperature, e1t1StatEntry=e1t1StatEntry, ethRXMulticasts=ethRXMulticasts)
