...
mibBuilder.exportSymbols("SAF-IPRADIO", license=license, modemUnavailtime=modemUnavailtime, modemACMethernetCapacity=modemACMethernetCapacity, licenseUpdateStatus=licenseUpdateStatus, modemE1T1Channels=modemE1T1Channels, pointToPoint=pointToPoint, modemEntry=modemEntry, ethRXBroadcasts=ethRXBroadcasts, modemTotalBlockNumber=modemTotalBlockNumber, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, vlanPortmap=vlanPortmap, safip=safip, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemAcqStatus=modemAcqStatus, licenseMask=licenseMask, description=description, ethTXVlanTags=ethTXVlanTags, aTPCEntry=aTPCEntry, microwaveRadio=microwaveRadio, radioGenStatus=radioGenStatus, ethRXDribleNibbles=ethRXDribleNibbles, ethRXMulticasts=ethRXMulticasts, ethRXControlFrames=ethRXControlFrames, modemRowStatus=modemRowStatus, ethTXMulticasts=ethTXMulticasts, e1t1ChannelNr=e1t1ChannelNr, radioRxLevel=radioRxLevel, modemACMmodulationMin=modemACMmodulationMin, aTPCTable=aTPCTable, modemACMengine=modemACMengine, ethTXLateCollisions=ethTXLateCollisions, atpcEnabled=atpcEnabled, modemCountTime=modemCountTime, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXCRCErrors=ethRXCRCErrors, radioIndex=radioIndex, ethQOSTXDropped=ethQOSTXDropped, ipRadioCfgNetwork=ipRadioCfgNetwork, writeConfig=writeConfig, modemRadialMSE=modemRadialMSE, vlanPortType=vlanPortType, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, restartcpu=restartcpu, modemStatistics=modemStatistics, radioEntry=radioEntry, ipRadio=ipRadio, vlanTable=vlanTable, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXPrevPktDropped=ethRXPrevPktDropped, radioTxFrequency=radioTxFrequency, tehnika=tehnika, modemUptime=modemUptime, ethRXDvEvent=ethRXDvEvent, modemIndex=modemIndex, ethTXByteCounterHi=ethTXByteCounterHi, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXBackpresEvents=ethTXBackpresEvents, modemTable=modemTable, ethGFPDropedFrames=ethGFPDropedFrames, modemACMmodulationMax=modemACMmodulationMax, modemEthernetCapacity=modemEthernetCapacity, radioDuplexShift=radioDuplexShift, modemModulation=modemModulation, ethTXWireByteCounterLow=ethTXWireByteCounterLow, hostname=hostname, ethTXCollisions=ethTXCollisions, ethTXCRCErrors=ethTXCRCErrors, e1t1StatTable=e1t1StatTable, modemE1T1ChannelMask=modemE1T1ChannelMask, ipRadioStat=ipRadioStat, vlanRowStatus=vlanRowStatus, radioTable=radioTable, modemTotalCapacity=modemTotalCapacity, ethRXTruncatedFrames=ethRXTruncatedFrames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXByteCounterHi=ethRXByteCounterHi, vlansEnabled=vlansEnabled, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemBandwith=modemBandwith, modemErroredSecond=modemErroredSecond, ethTXUnderruns=ethTXUnderruns, ethTXExcessiveDefers=ethTXExcessiveDefers, product=product, vlanCfgStat=vlanCfgStat, modemSymbolRateTx=modemSymbolRateTx, radioRxFrequency=radioRxFrequency, modemErroredSecondRatio=modemErroredSecondRatio, modemLDPCdecoderStress=modemLDPCdecoderStress, modemStandard=modemStandard, saf=saf, modemGeneralStatus=modemGeneralStatus, modemLastAcqError=modemLastAcqError, modemCarrierOffset=modemCarrierOffset, loopback_tributary_mask=loopback_tributary_mask, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ipRadioStatEth=ipRadioStatEth, ethTXDones=ethTXDones, sysTemperature=sysTemperature, localIp=localIp, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXDones=ethRXDones, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemACMtotalCapacity=modemACMtotalCapacity, ethQOSTXFrames=ethQOSTXFrames, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, e1t1AIS=e1t1AIS, ethTXByteCounterLow=ethTXByteCounterLow, ethGFPFCSErrors=ethGFPFCSErrors, radioSide=radioSide, modemSymbolRateRx=modemSymbolRateRx, ethGFPCHECErrors=ethGFPCHECErrors, e1t1StatEntry=e1t1StatEntry, ethRXLongEvents=ethRXLongEvents, ipRadioCfgGeneral=ipRadioCfgGeneral, remoteIp=remoteIp, ethQOSRXQ1Frames=ethQOSRXQ1Frames, localIpMask=localIpMask, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemErroredBlock=modemErroredBlock, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlanEntry=vlanEntry, ethTXMaxCollisions=ethTXMaxCollisions, ethRXPauseFrames=ethRXPauseFrames, radioTxPower=radioTxPower, ipRadioMgmt=ipRadioMgmt, modemInternalAGCgain=modemInternalAGCgain, ethTXBroadcasts=ethTXBroadcasts, ethRXCodeErrors=ethRXCodeErrors, radioTxMute=radioTxMute, loopbacks=loopbacks, ethTXPauseFrames=ethTXPauseFrames, ethTXGiants=ethTXGiants, ethRXByteCounterLow=ethRXByteCounterLow, sysDateAndTime=sysDateAndTime, e1t1LOS=e1t1LOS, ipRadioCfg=ipRadioCfg, radioLoopback=radioLoopback, atpcIndex=atpcIndex, vlanNumber=vlanNumber, ethTXControlFrames=ethTXControlFrames, vlanFid=vlanFid)
