...
mibBuilder.exportSymbols("SAF-IPRADIO", modemCarrierOffset=modemCarrierOffset, modemIndex=modemIndex, ethGFPFCSErrors=ethGFPFCSErrors, localIpMask=localIpMask, vlanEntry=vlanEntry, radioTxFrequency=radioTxFrequency, modemACMengine=modemACMengine, e1t1LOS=e1t1LOS, radioSide=radioSide, ethRXUnsupOpcodes=ethRXUnsupOpcodes, aTPCEntry=aTPCEntry, ethTXVlanTags=ethTXVlanTags, radioEntry=radioEntry, product=product, modemLDPCdecoderStress=modemLDPCdecoderStress, localIp=localIp, vlanFid=vlanFid, modemACMmodulationMin=modemACMmodulationMin, radioRxFrequency=radioRxFrequency, modemEntry=modemEntry, radioDuplexShift=radioDuplexShift, ethTXBroadcasts=ethTXBroadcasts, modemAcqStatus=modemAcqStatus, modemErroredBlock=modemErroredBlock, modemE1T1Channels=modemE1T1Channels, ethQOSRXQ2Frames=ethQOSRXQ2Frames, license=license, ipRadioCfgGeneral=ipRadioCfgGeneral, modemTable=modemTable, aTPCTable=aTPCTable, ipRadioStatEth=ipRadioStatEth, ipRadio=ipRadio, ipRadioStat=ipRadioStat, ethGFPDropedFrames=ethGFPDropedFrames, modemModulation=modemModulation, radioGenStatus=radioGenStatus, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXGiants=ethTXGiants, ethTXByteCounterLow=ethTXByteCounterLow, ethTXControlFrames=ethTXControlFrames, writeConfig=writeConfig, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXByteCounterHi=ethTXByteCounterHi, ethRXDones=ethRXDones, vlanPortmap=vlanPortmap, ipRadioMgmt=ipRadioMgmt, ethTXCollisions=ethTXCollisions, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemStandard=modemStandard, e1t1StatEntry=e1t1StatEntry, radioTxMute=radioTxMute, ethRXMulticasts=ethRXMulticasts, ethRXTruncatedFrames=ethRXTruncatedFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, safip=safip, ethQOSTXFrames=ethQOSTXFrames, e1t1StatTable=e1t1StatTable, modemUnavailtime=modemUnavailtime, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethQOSTXDropped=ethQOSTXDropped, sysTemperature=sysTemperature, modemInternalAGCgain=modemInternalAGCgain, vlanCfgStat=vlanCfgStat, ethRXCRCErrors=ethRXCRCErrors, modemACMtotalCapacity=modemACMtotalCapacity, vlanNumber=vlanNumber, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemEthernetCapacity=modemEthernetCapacity, ethRXPrevPktDropped=ethRXPrevPktDropped, ethQOSRXQ1Frames=ethQOSRXQ1Frames, restartcpu=restartcpu, atpcIndex=atpcIndex, modemBandwith=modemBandwith, modemTotalCapacity=modemTotalCapacity, ethRXVlanTagsDetected=ethRXVlanTagsDetected, hostname=hostname, ethTXMaxCollisions=ethTXMaxCollisions, ethTXLengthCheckErrors=ethTXLengthCheckErrors, vlanTable=vlanTable, ethTXDones=ethTXDones, radioLoopback=radioLoopback, modemTotalBlockNumber=modemTotalBlockNumber, modemLastAcqError=modemLastAcqError, vlansEnabled=vlansEnabled, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, atpcTxPowerCorrection=atpcTxPowerCorrection, modemErroredSecond=modemErroredSecond, ethRXCodeErrors=ethRXCodeErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXDribleNibbles=ethRXDribleNibbles, ethTXBackpresEvents=ethTXBackpresEvents, ethRXControlFrames=ethRXControlFrames, modemErroredSecondRatio=modemErroredSecondRatio, radioTxPower=radioTxPower, ethRXByteCounterHi=ethRXByteCounterHi, sysDateAndTime=sysDateAndTime, tehnika=tehnika, description=description, radioTable=radioTable, radioIndex=radioIndex, ethRXBroadcasts=ethRXBroadcasts, ethRXDvEvent=ethRXDvEvent, modemGeneralStatus=modemGeneralStatus, microwaveRadio=microwaveRadio, modemSymbolRateRx=modemSymbolRateRx, ethGFPCHECErrors=ethGFPCHECErrors, modemRadialMSE=modemRadialMSE, remoteIp=remoteIp, radioRxLevel=radioRxLevel, loopbacks=loopbacks, e1t1AIS=e1t1AIS, ethTXUnderruns=ethTXUnderruns, vlanPortType=vlanPortType, ethRXPauseFrames=ethRXPauseFrames, ethTXExcessiveDefers=ethTXExcessiveDefers, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemSymbolRateTx=modemSymbolRateTx, ethTXCRCErrors=ethTXCRCErrors, modemStatistics=modemStatistics, e1t1ChannelNr=e1t1ChannelNr, ipRadioCfg=ipRadioCfg, modemACMethernetCapacity=modemACMethernetCapacity, modemCountTime=modemCountTime, modemACMmodulationMax=modemACMmodulationMax, pointToPoint=pointToPoint, vlanRowStatus=vlanRowStatus, ethRXByteCounterLow=ethRXByteCounterLow, ipRadioCfgNetwork=ipRadioCfgNetwork, licenseMask=licenseMask, loopback_tributary_mask=loopback_tributary_mask, atpcEnabled=atpcEnabled, ethRXLongEvents=ethRXLongEvents, modemUptime=modemUptime, ethTXLateCollisions=ethTXLateCollisions, ethTXMulticasts=ethTXMulticasts, modemRowStatus=modemRowStatus, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXPauseFrames=ethTXPauseFrames, saf=saf, licenseUpdateStatus=licenseUpdateStatus)
