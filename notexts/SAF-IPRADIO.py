...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXControlFrames=ethTXControlFrames, radioLoopback=radioLoopback, loopback_tributary_mask=loopback_tributary_mask, modemErroredSecond=modemErroredSecond, ethGFPDropedFrames=ethGFPDropedFrames, tehnika=tehnika, vlanPortType=vlanPortType, ethRXCodeErrors=ethRXCodeErrors, modemACMmodulationMin=modemACMmodulationMin, radioTxMute=radioTxMute, ethTXByteCounterLow=ethTXByteCounterLow, modemLastAcqError=modemLastAcqError, ethTXExcessiveDefers=ethTXExcessiveDefers, radioEntry=radioEntry, radioIndex=radioIndex, radioRxLevel=radioRxLevel, ethTXLateCollisions=ethTXLateCollisions, ethTXPauseFrames=ethTXPauseFrames, modemTable=modemTable, ethTXCollisions=ethTXCollisions, modemUptime=modemUptime, modemRowStatus=modemRowStatus, product=product, ethRXLongEvents=ethRXLongEvents, ethRXControlFrames=ethRXControlFrames, ethGFPCHECErrors=ethGFPCHECErrors, modemGeneralStatus=modemGeneralStatus, radioTxPower=radioTxPower, pointToPoint=pointToPoint, ethRXMulticasts=ethRXMulticasts, ethRXPrevPktDropped=ethRXPrevPktDropped, radioTxFrequency=radioTxFrequency, ethRXBroadcasts=ethRXBroadcasts, modemEthernetCapacity=modemEthernetCapacity, e1t1ChannelNr=e1t1ChannelNr, sysTemperature=sysTemperature, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemIndex=modemIndex, radioTable=radioTable, modemACMmodulationMax=modemACMmodulationMax, modemTotalBlockNumber=modemTotalBlockNumber, ethTXMulticasts=ethTXMulticasts, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemRadialMSE=modemRadialMSE, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemTotalCapacity=modemTotalCapacity, aTPCTable=aTPCTable, modemSymbolRateRx=modemSymbolRateRx, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXVlanTags=ethTXVlanTags, microwaveRadio=microwaveRadio, sysDateAndTime=sysDateAndTime, modemErroredBlock=modemErroredBlock, restartcpu=restartcpu, ipRadioStatEth=ipRadioStatEth, ipRadioCfg=ipRadioCfg, ethRXPauseFrames=ethRXPauseFrames, hostname=hostname, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXVlanTagsDetected=ethRXVlanTagsDetected, vlanPortmap=vlanPortmap, radioRxFrequency=radioRxFrequency, atpcTxPowerCorrection=atpcTxPowerCorrection, modemSymbolRateTx=modemSymbolRateTx, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXDvEvent=ethRXDvEvent, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXBroadcasts=ethTXBroadcasts, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXMaxCollisions=ethTXMaxCollisions, modemBandwith=modemBandwith, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlanTable=vlanTable, modemAcqStatus=modemAcqStatus, ipRadioMgmt=ipRadioMgmt, e1t1StatTable=e1t1StatTable, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlanEntry=vlanEntry, ethRXDribleNibbles=ethRXDribleNibbles, vlansEnabled=vlansEnabled, loopbacks=loopbacks, modemACMethernetCapacity=modemACMethernetCapacity, modemErroredSecondRatio=modemErroredSecondRatio, ethRXByteCounterHi=ethRXByteCounterHi, modemACMtotalCapacity=modemACMtotalCapacity, ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, modemE1T1Channels=modemE1T1Channels, safip=safip, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemStandard=modemStandard, license=license, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXBackpresEvents=ethTXBackpresEvents, modemCarrierOffset=modemCarrierOffset, modemACMengine=modemACMengine, ethRXDones=ethRXDones, e1t1AIS=e1t1AIS, radioGenStatus=radioGenStatus, vlanCfgStat=vlanCfgStat, localIp=localIp, ethTXByteCounterHi=ethTXByteCounterHi, vlanFid=vlanFid, ethQOSTXDropped=ethQOSTXDropped, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemStatistics=modemStatistics, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemUnavailtime=modemUnavailtime, ethRXByteCounterLow=ethRXByteCounterLow, modemEntry=modemEntry, modemE1T1ChannelMask=modemE1T1ChannelMask, ethQOSTXFrames=ethQOSTXFrames, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXUnderruns=ethTXUnderruns, modemCountTime=modemCountTime, vlanNumber=vlanNumber, modemInternalAGCgain=modemInternalAGCgain, aTPCEntry=aTPCEntry, licenseUpdateStatus=licenseUpdateStatus, ethRXCRCErrors=ethRXCRCErrors, ipRadioStat=ipRadioStat, ipRadio=ipRadio, atpcEnabled=atpcEnabled, e1t1StatEntry=e1t1StatEntry, writeConfig=writeConfig, atpcIndex=atpcIndex, ethGFPFCSErrors=ethGFPFCSErrors, remoteIp=remoteIp, radioDuplexShift=radioDuplexShift, ethTXGiants=ethTXGiants, ethTXDones=ethTXDones, saf=saf, e1t1LOS=e1t1LOS, licenseMask=licenseMask, ethRXTruncatedFrames=ethRXTruncatedFrames, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXCRCErrors=ethTXCRCErrors, radioSide=radioSide, vlanRowStatus=vlanRowStatus, description=description, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemModulation=modemModulation, localIpMask=localIpMask)
