...
mibBuilder.exportSymbols("SAF-IPRADIO", ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, vlanNumber=vlanNumber, modemACMengine=modemACMengine, ethTXWireByteCounterLow=ethTXWireByteCounterLow, sysDateAndTime=sysDateAndTime, hostname=hostname, ethTXMaxCollisions=ethTXMaxCollisions, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioDuplexShift=radioDuplexShift, radioEntry=radioEntry, localIpMask=localIpMask, ethRXPauseFrames=ethRXPauseFrames, modemTotalBlockNumber=modemTotalBlockNumber, ethRXDvEvent=ethRXDvEvent, safip=safip, vlansEnabled=vlansEnabled, ethTXCollisions=ethTXCollisions, ethTXByteCounterLow=ethTXByteCounterLow, ipRadioMgmt=ipRadioMgmt, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXByteCounterLow=ethRXByteCounterLow, sysTemperature=sysTemperature, modemIndex=modemIndex, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlanPortmap=vlanPortmap, modemUptime=modemUptime, writeConfig=writeConfig, modemEthernetCapacity=modemEthernetCapacity, modemLastAcqError=modemLastAcqError, ethTXControlFrames=ethTXControlFrames, ethTXByteCounterHi=ethTXByteCounterHi, e1t1StatEntry=e1t1StatEntry, ethGFPCHECErrors=ethGFPCHECErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemACMmodulationMax=modemACMmodulationMax, modemACMtotalCapacity=modemACMtotalCapacity, ethTXPauseFrames=ethTXPauseFrames, localIp=localIp, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXBackpresEvents=ethTXBackpresEvents, modemCountTime=modemCountTime, radioTxMute=radioTxMute, ethRXBroadcasts=ethRXBroadcasts, radioGenStatus=radioGenStatus, microwaveRadio=microwaveRadio, aTPCTable=aTPCTable, modemE1T1Channels=modemE1T1Channels, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXMulticasts=ethTXMulticasts, modemStandard=modemStandard, ipRadioCfg=ipRadioCfg, modemGeneralStatus=modemGeneralStatus, ethGFPFCSErrors=ethGFPFCSErrors, ipRadio=ipRadio, restartcpu=restartcpu, ethRXDones=ethRXDones, license=license, ipRadioStat=ipRadioStat, radioTxFrequency=radioTxFrequency, modemE1T1ChannelMask=modemE1T1ChannelMask, loopback_tributary_mask=loopback_tributary_mask, vlanTable=vlanTable, ethQOSTXDropped=ethQOSTXDropped, e1t1AIS=e1t1AIS, radioLoopback=radioLoopback, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioIndex=radioIndex, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioRxFrequency=radioRxFrequency, modemTotalCapacity=modemTotalCapacity, modemACMethernetCapacity=modemACMethernetCapacity, modemInternalAGCgain=modemInternalAGCgain, vlanPortType=vlanPortType, ethTXGiants=ethTXGiants, modemModulation=modemModulation, description=description, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, atpcIndex=atpcIndex, ethTXCRCErrors=ethTXCRCErrors, remoteIp=remoteIp, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioTable=radioTable, atpcEnabled=atpcEnabled, atpcTxPowerCorrection=atpcTxPowerCorrection, ipRadioStatEth=ipRadioStatEth, ethTXLateCollisions=ethTXLateCollisions, ethTXVlanTags=ethTXVlanTags, radioRxLevel=radioRxLevel, e1t1ChannelNr=e1t1ChannelNr, ethRXPrevPktDropped=ethRXPrevPktDropped, modemErroredSecond=modemErroredSecond, modemBandwith=modemBandwith, tehnika=tehnika, vlanEntry=vlanEntry, ethRXControlFrames=ethRXControlFrames, modemLDPCdecoderStress=modemLDPCdecoderStress, ethQOSTXFrames=ethQOSTXFrames, modemACMmodulationMin=modemACMmodulationMin, modemRowStatus=modemRowStatus, modemAcqStatus=modemAcqStatus, licenseMask=licenseMask, vlanRowStatus=vlanRowStatus, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, licenseUpdateStatus=licenseUpdateStatus, modemRadialMSE=modemRadialMSE, ethRXLongEvents=ethRXLongEvents, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXCodeErrors=ethRXCodeErrors, modemErroredSecondRatio=modemErroredSecondRatio, modemSymbolRateRx=modemSymbolRateRx, ethTXUnderruns=ethTXUnderruns, product=product, ethTXExcessiveDefers=ethTXExcessiveDefers, modemCarrierOffset=modemCarrierOffset, modemEntry=modemEntry, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXByteCounterHi=ethRXByteCounterHi, saf=saf, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXDones=ethTXDones, loopbacks=loopbacks, ethRXCRCErrors=ethRXCRCErrors, modemSymbolRateTx=modemSymbolRateTx, e1t1LOS=e1t1LOS, ethRXDribleNibbles=ethRXDribleNibbles, ethRXMulticasts=ethRXMulticasts, pointToPoint=pointToPoint, radioTxPower=radioTxPower, e1t1StatTable=e1t1StatTable, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioSide=radioSide, aTPCEntry=aTPCEntry, vlanFid=vlanFid, modemTable=modemTable, vlanCfgStat=vlanCfgStat, ethTXBroadcasts=ethTXBroadcasts, modemStatistics=modemStatistics, modemUnavailtime=modemUnavailtime, ethGFPDropedFrames=ethGFPDropedFrames, modemErroredBlock=modemErroredBlock)
