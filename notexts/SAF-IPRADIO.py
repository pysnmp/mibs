...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXDvEvent=ethRXDvEvent, ethGFPCHECErrors=ethGFPCHECErrors, modemErroredSecondRatio=modemErroredSecondRatio, radioLoopback=radioLoopback, ethTXMaxCollisions=ethTXMaxCollisions, license=license, radioGenStatus=radioGenStatus, ipRadioCfgGeneral=ipRadioCfgGeneral, ipRadio=ipRadio, sysDateAndTime=sysDateAndTime, atpcEnabled=atpcEnabled, hostname=hostname, ethRXCodeErrors=ethRXCodeErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, localIp=localIp, modemBandwith=modemBandwith, ethRXByteCounterLow=ethRXByteCounterLow, radioSide=radioSide, modemLDPCdecoderStress=modemLDPCdecoderStress, modemStandard=modemStandard, ethTXLateCollisions=ethTXLateCollisions, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXCRCErrors=ethTXCRCErrors, modemCountTime=modemCountTime, ipRadioCfg=ipRadioCfg, modemRadialMSE=modemRadialMSE, modemE1T1Channels=modemE1T1Channels, modemStatistics=modemStatistics, radioDuplexShift=radioDuplexShift, modemEthernetCapacity=modemEthernetCapacity, ethTXUnderruns=ethTXUnderruns, ethRXMulticasts=ethRXMulticasts, ethRXTruncatedFrames=ethRXTruncatedFrames, modemEntry=modemEntry, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ipRadioStat=ipRadioStat, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXByteCounterHi=ethTXByteCounterHi, modemACMtotalCapacity=modemACMtotalCapacity, saf=saf, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlanRowStatus=vlanRowStatus, modemIndex=modemIndex, modemRowStatus=modemRowStatus, modemTotalBlockNumber=modemTotalBlockNumber, vlanPortType=vlanPortType, modemAcqStatus=modemAcqStatus, vlanNumber=vlanNumber, modemGeneralStatus=modemGeneralStatus, modemACMethernetCapacity=modemACMethernetCapacity, loopbacks=loopbacks, ethTXControlFrames=ethTXControlFrames, description=description, radioTxMute=radioTxMute, modemLastAcqError=modemLastAcqError, radioIndex=radioIndex, vlanEntry=vlanEntry, ethGFPFCSErrors=ethGFPFCSErrors, writeConfig=writeConfig, atpcIndex=atpcIndex, ipRadioStatEth=ipRadioStatEth, radioRxLevel=radioRxLevel, ipRadioMgmt=ipRadioMgmt, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXVlanTags=ethTXVlanTags, loopback_tributary_mask=loopback_tributary_mask, remoteIp=remoteIp, modemSymbolRateRx=modemSymbolRateRx, ethGFPDropedFrames=ethGFPDropedFrames, ethTXGiants=ethTXGiants, licenseUpdateStatus=licenseUpdateStatus, ethRXPrevPktDropped=ethRXPrevPktDropped, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemErroredSecond=modemErroredSecond, radioRxFrequency=radioRxFrequency, vlansEnabled=vlansEnabled, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethQOSTXDropped=ethQOSTXDropped, product=product, e1t1ChannelNr=e1t1ChannelNr, ethRXDribleNibbles=ethRXDribleNibbles, ethRXByteCounterHi=ethRXByteCounterHi, modemTable=modemTable, ethTXBroadcasts=ethTXBroadcasts, radioTable=radioTable, ethTXBackpresEvents=ethTXBackpresEvents, sysTemperature=sysTemperature, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXCollisions=ethTXCollisions, atpcTxPowerCorrection=atpcTxPowerCorrection, vlanCfgStat=vlanCfgStat, ethTXExcessiveDefers=ethTXExcessiveDefers, modemUptime=modemUptime, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemE1T1ChannelMask=modemE1T1ChannelMask, licenseMask=licenseMask, tehnika=tehnika, modemInternalAGCgain=modemInternalAGCgain, vlanTable=vlanTable, safip=safip, pointToPoint=pointToPoint, modemSymbolRateTx=modemSymbolRateTx, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, e1t1StatEntry=e1t1StatEntry, aTPCTable=aTPCTable, ethRXBroadcasts=ethRXBroadcasts, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemModulation=modemModulation, radioTxPower=radioTxPower, ethTXPauseFrames=ethTXPauseFrames, ethRXPauseFrames=ethRXPauseFrames, localIpMask=localIpMask, modemACMengine=modemACMengine, modemACMmodulationMin=modemACMmodulationMin, vlanPortmap=vlanPortmap, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlanFid=vlanFid, ethRXLongEvents=ethRXLongEvents, ethTXMulticasts=ethTXMulticasts, ethQOSTXFrames=ethQOSTXFrames, modemCarrierOffset=modemCarrierOffset, modemUnavailtime=modemUnavailtime, modemTotalCapacity=modemTotalCapacity, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXByteCounterLow=ethTXByteCounterLow, radioEntry=radioEntry, radioTxFrequency=radioTxFrequency, e1t1LOS=e1t1LOS, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXControlFrames=ethRXControlFrames, modemACMmodulationMax=modemACMmodulationMax, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, e1t1StatTable=e1t1StatTable, ethTXDones=ethTXDones, e1t1AIS=e1t1AIS, ethRXCRCErrors=ethRXCRCErrors, aTPCEntry=aTPCEntry, modemSeverelyErroredSecond=modemSeverelyErroredSecond, microwaveRadio=microwaveRadio, restartcpu=restartcpu, modemErroredBlock=modemErroredBlock, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXDones=ethRXDones)
