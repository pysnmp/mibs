...
mibBuilder.exportSymbols("SAF-IPRADIO", ipRadioMgmt=ipRadioMgmt, saf=saf, modemStatistics=modemStatistics, modemTotalCapacity=modemTotalCapacity, modemTotalBlockNumber=modemTotalBlockNumber, product=product, vlanPortType=vlanPortType, loopbacks=loopbacks, ipRadioStat=ipRadioStat, modemCarrierOffset=modemCarrierOffset, ethTXVlanTags=ethTXVlanTags, e1t1AIS=e1t1AIS, modemBandwith=modemBandwith, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXExcessiveDefers=ethTXExcessiveDefers, restartcpu=restartcpu, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemEntry=modemEntry, modemRowStatus=modemRowStatus, modemUnavailtime=modemUnavailtime, modemUptime=modemUptime, ethTXBackpresEvents=ethTXBackpresEvents, loopback_tributary_mask=loopback_tributary_mask, modemErroredSecond=modemErroredSecond, modemSymbolRateRx=modemSymbolRateRx, ethRXTruncatedFrames=ethRXTruncatedFrames, ethGFPFCSErrors=ethGFPFCSErrors, radioRxLevel=radioRxLevel, modemGeneralStatus=modemGeneralStatus, sysTemperature=sysTemperature, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXCollisions=ethTXCollisions, remoteIp=remoteIp, ethTXDones=ethTXDones, aTPCTable=aTPCTable, ethTXCRCErrors=ethTXCRCErrors, ethTXByteCounterLow=ethTXByteCounterLow, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXByteCounterLow=ethRXByteCounterLow, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXDribleNibbles=ethRXDribleNibbles, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemACMtotalCapacity=modemACMtotalCapacity, ethGFPCHECErrors=ethGFPCHECErrors, vlanPortmap=vlanPortmap, ethRXByteCounterHi=ethRXByteCounterHi, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXDvEvent=ethRXDvEvent, description=description, ethTXMulticasts=ethTXMulticasts, writeConfig=writeConfig, ethRXControlFrames=ethRXControlFrames, radioSide=radioSide, ethRXLongEvents=ethRXLongEvents, radioIndex=radioIndex, ethRXCodeErrors=ethRXCodeErrors, ipRadioStatEth=ipRadioStatEth, vlanEntry=vlanEntry, ethTXUnderruns=ethTXUnderruns, ethRXPauseFrames=ethRXPauseFrames, radioTxMute=radioTxMute, localIp=localIp, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlanCfgStat=vlanCfgStat, ethTXGiants=ethTXGiants, ethRXBroadcasts=ethRXBroadcasts, e1t1StatEntry=e1t1StatEntry, modemLastAcqError=modemLastAcqError, modemErroredSecondRatio=modemErroredSecondRatio, e1t1ChannelNr=e1t1ChannelNr, ipRadioCfgNetwork=ipRadioCfgNetwork, ethQOSTXDropped=ethQOSTXDropped, ethTXByteCounterHi=ethTXByteCounterHi, safip=safip, atpcEnabled=atpcEnabled, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXPauseFrames=ethTXPauseFrames, licenseUpdateStatus=licenseUpdateStatus, modemStandard=modemStandard, modemModulation=modemModulation, ethRXMulticasts=ethRXMulticasts, ethQOSTXFrames=ethQOSTXFrames, ipRadioCfgGeneral=ipRadioCfgGeneral, vlanFid=vlanFid, vlanNumber=vlanNumber, modemACMmodulationMax=modemACMmodulationMax, radioEntry=radioEntry, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemIndex=modemIndex, modemCountTime=modemCountTime, microwaveRadio=microwaveRadio, hostname=hostname, radioTxPower=radioTxPower, vlanTable=vlanTable, modemTable=modemTable, modemSymbolRateTx=modemSymbolRateTx, modemEthernetCapacity=modemEthernetCapacity, modemInternalAGCgain=modemInternalAGCgain, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, pointToPoint=pointToPoint, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXLengthCheckErrors=ethTXLengthCheckErrors, radioDuplexShift=radioDuplexShift, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXLateCollisions=ethTXLateCollisions, ethTXBroadcasts=ethTXBroadcasts, vlanRowStatus=vlanRowStatus, e1t1StatTable=e1t1StatTable, localIpMask=localIpMask, aTPCEntry=aTPCEntry, ethGFPDropedFrames=ethGFPDropedFrames, modemACMengine=modemACMengine, e1t1LOS=e1t1LOS, modemAcqStatus=modemAcqStatus, modemACMmodulationMin=modemACMmodulationMin, atpcIndex=atpcIndex, ethTXMaxCollisions=ethTXMaxCollisions, ethRXCRCErrors=ethRXCRCErrors, modemRadialMSE=modemRadialMSE, radioRxFrequency=radioRxFrequency, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXControlFrames=ethTXControlFrames, ipRadioCfg=ipRadioCfg, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioTable=radioTable, modemErroredBlock=modemErroredBlock, tehnika=tehnika, licenseMask=licenseMask, modemE1T1Channels=modemE1T1Channels, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioGenStatus=radioGenStatus, radioLoopback=radioLoopback, modemE1T1ChannelMask=modemE1T1ChannelMask, sysDateAndTime=sysDateAndTime, ipRadio=ipRadio, vlansEnabled=vlansEnabled, radioTxFrequency=radioTxFrequency, modemACMethernetCapacity=modemACMethernetCapacity, ethRXDones=ethRXDones, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, license=license)
