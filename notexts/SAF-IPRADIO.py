...
mibBuilder.exportSymbols("SAF-IPRADIO", modemRadialMSE=modemRadialMSE, vlanCfgStat=vlanCfgStat, ipRadioStatEth=ipRadioStatEth, vlanTable=vlanTable, ethGFPFCSErrors=ethGFPFCSErrors, vlansEnabled=vlansEnabled, radioRxFrequency=radioRxFrequency, vlanNumber=vlanNumber, atpcTxPowerCorrection=atpcTxPowerCorrection, modemAcqStatus=modemAcqStatus, localIpMask=localIpMask, modemStandard=modemStandard, e1t1LOS=e1t1LOS, restartcpu=restartcpu, ethRXDvEvent=ethRXDvEvent, ipRadioMgmt=ipRadioMgmt, hostname=hostname, ethQOSTXDropped=ethQOSTXDropped, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemE1T1Channels=modemE1T1Channels, radioGenStatus=radioGenStatus, radioSide=radioSide, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemACMmodulationMin=modemACMmodulationMin, e1t1StatTable=e1t1StatTable, e1t1ChannelNr=e1t1ChannelNr, licenseMask=licenseMask, vlanRowStatus=vlanRowStatus, sysTemperature=sysTemperature, radioTxMute=radioTxMute, ethTXBackpresEvents=ethTXBackpresEvents, ethTXBroadcasts=ethTXBroadcasts, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, vlanPortmap=vlanPortmap, safip=safip, description=description, modemCarrierOffset=modemCarrierOffset, ipRadioStat=ipRadioStat, modemInternalAGCgain=modemInternalAGCgain, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, sysDateAndTime=sysDateAndTime, pointToPoint=pointToPoint, ethRXMulticasts=ethRXMulticasts, ethTXDones=ethTXDones, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXUnderruns=ethTXUnderruns, ethTXControlFrames=ethTXControlFrames, modemBandwith=modemBandwith, ethTXPauseFrames=ethTXPauseFrames, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemACMmodulationMax=modemACMmodulationMax, localIp=localIp, ethRXBroadcasts=ethRXBroadcasts, ipRadioCfgNetwork=ipRadioCfgNetwork, modemLDPCdecoderStress=modemLDPCdecoderStress, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXByteCounterHi=ethRXByteCounterHi, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXControlFrames=ethRXControlFrames, ethRXDones=ethRXDones, ipRadioCfgGeneral=ipRadioCfgGeneral, modemRowStatus=modemRowStatus, ethTXByteCounterLow=ethTXByteCounterLow, modemTable=modemTable, vlanFid=vlanFid, radioTxPower=radioTxPower, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemErroredSecondRatio=modemErroredSecondRatio, license=license, atpcIndex=atpcIndex, ethRXCRCErrors=ethRXCRCErrors, ethTXCRCErrors=ethTXCRCErrors, ethRXDribleNibbles=ethRXDribleNibbles, ethRXLongEvents=ethRXLongEvents, microwaveRadio=microwaveRadio, aTPCEntry=aTPCEntry, radioTable=radioTable, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ipRadio=ipRadio, ethTXCollisions=ethTXCollisions, atpcEnabled=atpcEnabled, ipRadioCfg=ipRadioCfg, radioDuplexShift=radioDuplexShift, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXPauseFrames=ethRXPauseFrames, radioTxFrequency=radioTxFrequency, ethQOSTXFrames=ethQOSTXFrames, modemSymbolRateRx=modemSymbolRateRx, vlanPortType=vlanPortType, e1t1AIS=e1t1AIS, modemEthernetCapacity=modemEthernetCapacity, ethRXByteCounterLow=ethRXByteCounterLow, loopback_tributary_mask=loopback_tributary_mask, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethGFPDropedFrames=ethGFPDropedFrames, remoteIp=remoteIp, modemErroredSecond=modemErroredSecond, modemLastAcqError=modemLastAcqError, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, aTPCTable=aTPCTable, ethTXVlanTags=ethTXVlanTags, modemErroredBlock=modemErroredBlock, ethRXCodeErrors=ethRXCodeErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioLoopback=radioLoopback, modemTotalBlockNumber=modemTotalBlockNumber, tehnika=tehnika, saf=saf, radioEntry=radioEntry, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemACMengine=modemACMengine, ethTXMulticasts=ethTXMulticasts, ethTXByteCounterHi=ethTXByteCounterHi, ethRXUnsupOpcodes=ethRXUnsupOpcodes, product=product, writeConfig=writeConfig, ethTXMaxCollisions=ethTXMaxCollisions, modemGeneralStatus=modemGeneralStatus, e1t1StatEntry=e1t1StatEntry, modemTotalCapacity=modemTotalCapacity, modemACMethernetCapacity=modemACMethernetCapacity, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemModulation=modemModulation, modemSymbolRateTx=modemSymbolRateTx, ethGFPCHECErrors=ethGFPCHECErrors, radioRxLevel=radioRxLevel, modemACMtotalCapacity=modemACMtotalCapacity, modemEntry=modemEntry, licenseUpdateStatus=licenseUpdateStatus, modemUptime=modemUptime, modemStatistics=modemStatistics, modemCountTime=modemCountTime, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemUnavailtime=modemUnavailtime, ethTXGiants=ethTXGiants, loopbacks=loopbacks, modemIndex=modemIndex, modemE1T1ChannelMask=modemE1T1ChannelMask, vlanEntry=vlanEntry, ethTXLateCollisions=ethTXLateCollisions, radioIndex=radioIndex)
