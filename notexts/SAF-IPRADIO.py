...
mibBuilder.exportSymbols("SAF-IPRADIO", modemRowStatus=modemRowStatus, vlansEnabled=vlansEnabled, vlanTable=vlanTable, radioEntry=radioEntry, loopback_tributary_mask=loopback_tributary_mask, ethGFPFCSErrors=ethGFPFCSErrors, radioTxMute=radioTxMute, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioSide=radioSide, modemACMengine=modemACMengine, ethRXByteCounterHi=ethRXByteCounterHi, ethRXControlFrames=ethRXControlFrames, ethRXByteCounterLow=ethRXByteCounterLow, ethGFPDropedFrames=ethGFPDropedFrames, modemLastAcqError=modemLastAcqError, modemCountTime=modemCountTime, ethGFPDelineationErrors=ethGFPDelineationErrors, modemUnavailtime=modemUnavailtime, ipRadioMgmt=ipRadioMgmt, ethRXCRCErrors=ethRXCRCErrors, modemIndex=modemIndex, atpcIndex=atpcIndex, modemTotalCapacity=modemTotalCapacity, vlanCfgStat=vlanCfgStat, ethRXPauseFrames=ethRXPauseFrames, modemErroredBlock=modemErroredBlock, vlanRowStatus=vlanRowStatus, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXGiants=ethTXGiants, description=description, radioTable=radioTable, vlanEntry=vlanEntry, modemErroredSecond=modemErroredSecond, modemUptime=modemUptime, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemACMmodulationMax=modemACMmodulationMax, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXLengthCheckErrors=ethTXLengthCheckErrors, pointToPoint=pointToPoint, ethTXBroadcasts=ethTXBroadcasts, restartcpu=restartcpu, radioRxFrequency=radioRxFrequency, ethTXCollisions=ethTXCollisions, modemE1T1ChannelMask=modemE1T1ChannelMask, modemACMmodulationMin=modemACMmodulationMin, ethRXTruncatedFrames=ethRXTruncatedFrames, ethGFPCHECErrors=ethGFPCHECErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, license=license, modemErroredSecondRatio=modemErroredSecondRatio, ethTXLateCollisions=ethTXLateCollisions, modemACMtotalCapacity=modemACMtotalCapacity, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemTotalBlockNumber=modemTotalBlockNumber, ethTXByteCounterLow=ethTXByteCounterLow, radioIndex=radioIndex, modemModulation=modemModulation, saf=saf, modemTable=modemTable, vlanFid=vlanFid, tehnika=tehnika, radioLoopback=radioLoopback, ethRXDones=ethRXDones, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, e1t1LOS=e1t1LOS, vlanPortmap=vlanPortmap, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ipRadio=ipRadio, ethRXMulticasts=ethRXMulticasts, ipRadioStatEth=ipRadioStatEth, modemStandard=modemStandard, modemEntry=modemEntry, atpcTxPowerCorrection=atpcTxPowerCorrection, licenseMask=licenseMask, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXBackpresEvents=ethTXBackpresEvents, ethRXBroadcasts=ethRXBroadcasts, ethTXVlanTags=ethTXVlanTags, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, localIpMask=localIpMask, ethRXDribleNibbles=ethRXDribleNibbles, ethRXCodeErrors=ethRXCodeErrors, ethRXVlanTagsDetected=ethRXVlanTagsDetected, safip=safip, remoteIp=remoteIp, loopbacks=loopbacks, ethTXControlFrames=ethTXControlFrames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemStatistics=modemStatistics, modemBandwith=modemBandwith, modemSymbolRateTx=modemSymbolRateTx, modemE1T1Channels=modemE1T1Channels, sysDateAndTime=sysDateAndTime, modemEthernetCapacity=modemEthernetCapacity, atpcEnabled=atpcEnabled, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, e1t1AIS=e1t1AIS, microwaveRadio=microwaveRadio, radioDuplexShift=radioDuplexShift, licenseUpdateStatus=licenseUpdateStatus, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXLongEvents=ethRXLongEvents, ethQOSTXDropped=ethQOSTXDropped, hostname=hostname, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlanPortType=vlanPortType, localIp=localIp, ethTXUnderruns=ethTXUnderruns, ethQOSTXFrames=ethQOSTXFrames, product=product, e1t1StatEntry=e1t1StatEntry, modemACMethernetCapacity=modemACMethernetCapacity, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXDones=ethTXDones, sysTemperature=sysTemperature, modemGeneralStatus=modemGeneralStatus, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ipRadioStat=ipRadioStat, modemCarrierOffset=modemCarrierOffset, vlanNumber=vlanNumber, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemInternalAGCgain=modemInternalAGCgain, modemRadialMSE=modemRadialMSE, ethQOSRXQ2Frames=ethQOSRXQ2Frames, e1t1StatTable=e1t1StatTable, ethTXMaxCollisions=ethTXMaxCollisions, ethRXDvEvent=ethRXDvEvent, modemAcqStatus=modemAcqStatus, ethTXCRCErrors=ethTXCRCErrors, writeConfig=writeConfig, radioTxPower=radioTxPower, modemSymbolRateRx=modemSymbolRateRx, aTPCTable=aTPCTable, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioGenStatus=radioGenStatus, radioTxFrequency=radioTxFrequency, radioRxLevel=radioRxLevel, ethTXPauseFrames=ethTXPauseFrames, e1t1ChannelNr=e1t1ChannelNr, ethTXByteCounterHi=ethTXByteCounterHi, aTPCEntry=aTPCEntry, ethTXMulticasts=ethTXMulticasts, ipRadioCfg=ipRadioCfg)
