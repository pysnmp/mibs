...
mibBuilder.exportSymbols("SAF-IPRADIO", modemModulation=modemModulation, ipRadioCfg=ipRadioCfg, modemTotalBlockNumber=modemTotalBlockNumber, modemACMmodulationMin=modemACMmodulationMin, ethRXDones=ethRXDones, ethGFPDropedFrames=ethGFPDropedFrames, remoteIp=remoteIp, atpcIndex=atpcIndex, ethGFPDelineationErrors=ethGFPDelineationErrors, e1t1LOS=e1t1LOS, localIpMask=localIpMask, ethTXByteCounterHi=ethTXByteCounterHi, modemACMethernetCapacity=modemACMethernetCapacity, ethRXCRCErrors=ethRXCRCErrors, ethQOSTXDropped=ethQOSTXDropped, radioTxMute=radioTxMute, vlanRowStatus=vlanRowStatus, radioEntry=radioEntry, description=description, loopbacks=loopbacks, loopback_tributary_mask=loopback_tributary_mask, modemRowStatus=modemRowStatus, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXMulticasts=ethRXMulticasts, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlanEntry=vlanEntry, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioTxFrequency=radioTxFrequency, ethTXCollisions=ethTXCollisions, modemE1T1Channels=modemE1T1Channels, ethGFPFCSErrors=ethGFPFCSErrors, pointToPoint=pointToPoint, ethRXBroadcasts=ethRXBroadcasts, radioIndex=radioIndex, licenseUpdateStatus=licenseUpdateStatus, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXCodeErrors=ethRXCodeErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ipRadioStat=ipRadioStat, aTPCEntry=aTPCEntry, ethRXControlFrames=ethRXControlFrames, vlanFid=vlanFid, licenseMask=licenseMask, modemLDPCdecoderStress=modemLDPCdecoderStress, product=product, ethTXLateCollisions=ethTXLateCollisions, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ipRadioStatEth=ipRadioStatEth, safip=safip, ethTXUnderruns=ethTXUnderruns, ethQOSTXFrames=ethQOSTXFrames, modemSymbolRateRx=modemSymbolRateRx, modemBandwith=modemBandwith, modemIndex=modemIndex, vlanPortType=vlanPortType, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXDribleNibbles=ethRXDribleNibbles, modemInternalAGCgain=modemInternalAGCgain, vlanPortmap=vlanPortmap, radioRxLevel=radioRxLevel, ethRXByteCounterHi=ethRXByteCounterHi, ethTXBroadcasts=ethTXBroadcasts, radioDuplexShift=radioDuplexShift, e1t1StatTable=e1t1StatTable, e1t1ChannelNr=e1t1ChannelNr, modemTable=modemTable, ipRadioMgmt=ipRadioMgmt, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXDvEvent=ethRXDvEvent, ethTXBackpresEvents=ethTXBackpresEvents, ethTXByteCounterLow=ethTXByteCounterLow, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemErroredSecondRatio=modemErroredSecondRatio, ethRXPrevPktDropped=ethRXPrevPktDropped, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXGiants=ethTXGiants, modemAcqStatus=modemAcqStatus, modemTotalCapacity=modemTotalCapacity, radioGenStatus=radioGenStatus, radioRxFrequency=radioRxFrequency, modemGeneralStatus=modemGeneralStatus, e1t1StatEntry=e1t1StatEntry, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemUptime=modemUptime, vlanTable=vlanTable, ethTXDones=ethTXDones, ethTXCRCErrors=ethTXCRCErrors, saf=saf, ethTXMaxCollisions=ethTXMaxCollisions, modemStatistics=modemStatistics, ethTXPauseFrames=ethTXPauseFrames, radioLoopback=radioLoopback, ethRXPauseFrames=ethRXPauseFrames, ethTXVlanTags=ethTXVlanTags, modemStandard=modemStandard, modemErroredSecond=modemErroredSecond, modemErroredBlock=modemErroredBlock, modemE1T1ChannelMask=modemE1T1ChannelMask, ethGFPCHECErrors=ethGFPCHECErrors, writeConfig=writeConfig, tehnika=tehnika, sysTemperature=sysTemperature, license=license, ethTXLengthCheckErrors=ethTXLengthCheckErrors, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXMulticasts=ethTXMulticasts, e1t1AIS=e1t1AIS, radioTxPower=radioTxPower, ethRXByteCounterLow=ethRXByteCounterLow, modemRadialMSE=modemRadialMSE, modemEthernetCapacity=modemEthernetCapacity, modemSymbolRateTx=modemSymbolRateTx, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ipRadio=ipRadio, atpcEnabled=atpcEnabled, modemLastAcqError=modemLastAcqError, ethRXTruncatedFrames=ethRXTruncatedFrames, modemEntry=modemEntry, vlanNumber=vlanNumber, microwaveRadio=microwaveRadio, radioSide=radioSide, ethTXControlFrames=ethTXControlFrames, ethTXExcessiveDefers=ethTXExcessiveDefers, modemACMmodulationMax=modemACMmodulationMax, ethTXWireByteCounterHi=ethTXWireByteCounterHi, vlansEnabled=vlansEnabled, ethRXLongEvents=ethRXLongEvents, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemUnavailtime=modemUnavailtime, aTPCTable=aTPCTable, vlanCfgStat=vlanCfgStat, modemCarrierOffset=modemCarrierOffset, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioTable=radioTable, modemACMengine=modemACMengine, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemCountTime=modemCountTime, localIp=localIp, ethRXVlanTagsDetected=ethRXVlanTagsDetected, hostname=hostname, restartcpu=restartcpu, modemACMtotalCapacity=modemACMtotalCapacity, sysDateAndTime=sysDateAndTime)
