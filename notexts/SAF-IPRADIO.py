...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXCRCErrors=ethTXCRCErrors, ethRXControlFrames=ethRXControlFrames, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemTotalCapacity=modemTotalCapacity, ethTXPauseFrames=ethTXPauseFrames, vlanTable=vlanTable, ethTXLateCollisions=ethTXLateCollisions, ethGFPDelineationErrors=ethGFPDelineationErrors, e1t1ChannelNr=e1t1ChannelNr, pointToPoint=pointToPoint, radioTxMute=radioTxMute, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethGFPCHECErrors=ethGFPCHECErrors, modemEntry=modemEntry, e1t1AIS=e1t1AIS, ipRadioStat=ipRadioStat, aTPCTable=aTPCTable, atpcTxPowerCorrection=atpcTxPowerCorrection, modemUnavailtime=modemUnavailtime, safip=safip, ipRadioStatEth=ipRadioStatEth, modemStandard=modemStandard, ethRXMulticasts=ethRXMulticasts, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemSymbolRateTx=modemSymbolRateTx, license=license, radioIndex=radioIndex, modemTotalBlockNumber=modemTotalBlockNumber, tehnika=tehnika, modemACMtotalCapacity=modemACMtotalCapacity, modemIndex=modemIndex, microwaveRadio=microwaveRadio, ethTXByteCounterLow=ethTXByteCounterLow, ethRXPrevPktDropped=ethRXPrevPktDropped, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXCRCErrors=ethRXCRCErrors, e1t1StatEntry=e1t1StatEntry, ethTXMaxCollisions=ethTXMaxCollisions, ethRXDones=ethRXDones, ethRXDvEvent=ethRXDvEvent, radioSide=radioSide, licenseUpdateStatus=licenseUpdateStatus, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, licenseMask=licenseMask, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXCollisions=ethTXCollisions, radioGenStatus=radioGenStatus, ethTXByteCounterHi=ethTXByteCounterHi, modemRadialMSE=modemRadialMSE, ethQOSTXFrames=ethQOSTXFrames, radioTable=radioTable, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioTxFrequency=radioTxFrequency, product=product, modemAcqStatus=modemAcqStatus, ethRXTruncatedFrames=ethRXTruncatedFrames, loopback_tributary_mask=loopback_tributary_mask, modemUptime=modemUptime, modemBandwith=modemBandwith, ethTXDones=ethTXDones, vlanPortType=vlanPortType, ipRadioMgmt=ipRadioMgmt, ethTXBroadcasts=ethTXBroadcasts, modemErroredSecondRatio=modemErroredSecondRatio, localIpMask=localIpMask, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemErroredSecond=modemErroredSecond, vlanPortmap=vlanPortmap, ethRXByteCounterHi=ethRXByteCounterHi, modemErroredBlock=modemErroredBlock, description=description, ethRXBroadcasts=ethRXBroadcasts, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXLongEvents=ethRXLongEvents, modemACMethernetCapacity=modemACMethernetCapacity, modemStatistics=modemStatistics, writeConfig=writeConfig, radioDuplexShift=radioDuplexShift, radioEntry=radioEntry, modemLastAcqError=modemLastAcqError, loopbacks=loopbacks, ethTXBackpresEvents=ethTXBackpresEvents, ethRXByteCounterLow=ethRXByteCounterLow, ethGFPFCSErrors=ethGFPFCSErrors, radioTxPower=radioTxPower, modemACMmodulationMax=modemACMmodulationMax, radioRxLevel=radioRxLevel, atpcIndex=atpcIndex, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemModulation=modemModulation, ethTXGiants=ethTXGiants, modemACMmodulationMin=modemACMmodulationMin, modemE1T1ChannelMask=modemE1T1ChannelMask, modemEthernetCapacity=modemEthernetCapacity, sysTemperature=sysTemperature, ethTXMulticasts=ethTXMulticasts, ethTXExcessiveDefers=ethTXExcessiveDefers, ipRadioCfg=ipRadioCfg, vlanRowStatus=vlanRowStatus, vlanNumber=vlanNumber, modemCountTime=modemCountTime, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXPauseFrames=ethRXPauseFrames, ethTXUnderruns=ethTXUnderruns, remoteIp=remoteIp, modemACMengine=modemACMengine, modemTable=modemTable, radioRxFrequency=radioRxFrequency, atpcEnabled=atpcEnabled, hostname=hostname, ethRXCodeErrors=ethRXCodeErrors, e1t1LOS=e1t1LOS, vlanCfgStat=vlanCfgStat, modemGeneralStatus=modemGeneralStatus, sysDateAndTime=sysDateAndTime, radioLoopback=radioLoopback, vlansEnabled=vlansEnabled, ethRXDribleNibbles=ethRXDribleNibbles, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemSymbolRateRx=modemSymbolRateRx, modemCarrierOffset=modemCarrierOffset, vlanEntry=vlanEntry, vlanFid=vlanFid, ethTXControlFrames=ethTXControlFrames, ethGFPDropedFrames=ethGFPDropedFrames, ethTXVlanTags=ethTXVlanTags, saf=saf, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemLDPCdecoderStress=modemLDPCdecoderStress, ethQOSTXDropped=ethQOSTXDropped, ipRadio=ipRadio, modemRowStatus=modemRowStatus, ethTXWireByteCounterLow=ethTXWireByteCounterLow, e1t1StatTable=e1t1StatTable, modemE1T1Channels=modemE1T1Channels, localIp=localIp, modemInternalAGCgain=modemInternalAGCgain, aTPCEntry=aTPCEntry, restartcpu=restartcpu)
