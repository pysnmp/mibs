...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXLongEvents=ethRXLongEvents, modemEntry=modemEntry, ipRadioCfgGeneral=ipRadioCfgGeneral, atpcEnabled=atpcEnabled, vlanNumber=vlanNumber, e1t1ChannelNr=e1t1ChannelNr, modemE1T1Channels=modemE1T1Channels, ethTXBackpresEvents=ethTXBackpresEvents, modemACMmodulationMin=modemACMmodulationMin, writeConfig=writeConfig, ethTXDones=ethTXDones, ethTXVlanTags=ethTXVlanTags, ethTXCRCErrors=ethTXCRCErrors, vlanEntry=vlanEntry, ethTXMulticasts=ethTXMulticasts, tehnika=tehnika, ethGFPFCSErrors=ethGFPFCSErrors, license=license, modemTable=modemTable, modemTotalCapacity=modemTotalCapacity, modemErroredSecondRatio=modemErroredSecondRatio, ipRadioCfgNetwork=ipRadioCfgNetwork, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ipRadioCfg=ipRadioCfg, ethTXLateCollisions=ethTXLateCollisions, licenseUpdateStatus=licenseUpdateStatus, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemRadialMSE=modemRadialMSE, localIp=localIp, vlanPortmap=vlanPortmap, licenseMask=licenseMask, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioTxFrequency=radioTxFrequency, radioSide=radioSide, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXGiants=ethTXGiants, modemSymbolRateRx=modemSymbolRateRx, ethTXLengthCheckErrors=ethTXLengthCheckErrors, radioRxLevel=radioRxLevel, ethTXExcessiveDefers=ethTXExcessiveDefers, ethQOSTXDropped=ethQOSTXDropped, localIpMask=localIpMask, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemLastAcqError=modemLastAcqError, modemLDPCdecoderStress=modemLDPCdecoderStress, modemStatistics=modemStatistics, radioIndex=radioIndex, ethRXControlFrames=ethRXControlFrames, ethRXMulticasts=ethRXMulticasts, loopback_tributary_mask=loopback_tributary_mask, product=product, modemCountTime=modemCountTime, atpcTxPowerCorrection=atpcTxPowerCorrection, modemRowStatus=modemRowStatus, e1t1LOS=e1t1LOS, ethRXDvEvent=ethRXDvEvent, modemIndex=modemIndex, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, loopbacks=loopbacks, e1t1AIS=e1t1AIS, modemGeneralStatus=modemGeneralStatus, ethQOSTXFrames=ethQOSTXFrames, modemACMtotalCapacity=modemACMtotalCapacity, modemUptime=modemUptime, modemACMmodulationMax=modemACMmodulationMax, ethTXByteCounterHi=ethTXByteCounterHi, ethGFPDropedFrames=ethGFPDropedFrames, ethRXBroadcasts=ethRXBroadcasts, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ipRadio=ipRadio, ethRXPauseFrames=ethRXPauseFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadioStatEth=ipRadioStatEth, vlanPortType=vlanPortType, ethTXCollisions=ethTXCollisions, modemEthernetCapacity=modemEthernetCapacity, atpcIndex=atpcIndex, ethGFPCHECErrors=ethGFPCHECErrors, sysTemperature=sysTemperature, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemUnavailtime=modemUnavailtime, ethTXControlFrames=ethTXControlFrames, radioDuplexShift=radioDuplexShift, ethTXUnderruns=ethTXUnderruns, modemBandwith=modemBandwith, sysDateAndTime=sysDateAndTime, ipRadioStat=ipRadioStat, modemInternalAGCgain=modemInternalAGCgain, ethRXVlanTagsDetected=ethRXVlanTagsDetected, e1t1StatEntry=e1t1StatEntry, vlanTable=vlanTable, ethRXByteCounterLow=ethRXByteCounterLow, modemACMengine=modemACMengine, ethRXDones=ethRXDones, e1t1StatTable=e1t1StatTable, vlanCfgStat=vlanCfgStat, vlansEnabled=vlansEnabled, restartcpu=restartcpu, ethRXDribleNibbles=ethRXDribleNibbles, ethRXCodeErrors=ethRXCodeErrors, ethTXBroadcasts=ethTXBroadcasts, ethTXMaxCollisions=ethTXMaxCollisions, remoteIp=remoteIp, radioTxMute=radioTxMute, modemErroredBlock=modemErroredBlock, vlanFid=vlanFid, modemSymbolRateTx=modemSymbolRateTx, radioLoopback=radioLoopback, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXCRCErrors=ethRXCRCErrors, radioTxPower=radioTxPower, description=description, ethQOSRXQ1Frames=ethQOSRXQ1Frames, saf=saf, ethTXWireByteCounterLow=ethTXWireByteCounterLow, hostname=hostname, ethRXTruncatedFrames=ethRXTruncatedFrames, pointToPoint=pointToPoint, aTPCEntry=aTPCEntry, ethRXByteCounterHi=ethRXByteCounterHi, radioRxFrequency=radioRxFrequency, modemACMethernetCapacity=modemACMethernetCapacity, modemAcqStatus=modemAcqStatus, ethTXByteCounterLow=ethTXByteCounterLow, safip=safip, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemErroredSecond=modemErroredSecond, modemModulation=modemModulation, radioTable=radioTable, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioEntry=radioEntry, ethTXWireByteCounterHi=ethTXWireByteCounterHi, microwaveRadio=microwaveRadio, radioGenStatus=radioGenStatus, modemStandard=modemStandard, vlanRowStatus=vlanRowStatus, ethTXPauseFrames=ethTXPauseFrames, ipRadioMgmt=ipRadioMgmt, modemCarrierOffset=modemCarrierOffset, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemTotalBlockNumber=modemTotalBlockNumber, aTPCTable=aTPCTable)
