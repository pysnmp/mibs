...
mibBuilder.exportSymbols("SAF-IPRADIO", ethGFPCHECErrors=ethGFPCHECErrors, ethRXPauseFrames=ethRXPauseFrames, ethRXMulticasts=ethRXMulticasts, vlansEnabled=vlansEnabled, tehnika=tehnika, modemE1T1Channels=modemE1T1Channels, modemBandwith=modemBandwith, ethTXUnderruns=ethTXUnderruns, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXCodeErrors=ethRXCodeErrors, ethTXBackpresEvents=ethTXBackpresEvents, product=product, modemStatistics=modemStatistics, ethTXCollisions=ethTXCollisions, radioGenStatus=radioGenStatus, vlanRowStatus=vlanRowStatus, ethRXControlFrames=ethRXControlFrames, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXLongEvents=ethRXLongEvents, ethGFPDropedFrames=ethGFPDropedFrames, microwaveRadio=microwaveRadio, e1t1LOS=e1t1LOS, modemACMmodulationMax=modemACMmodulationMax, radioEntry=radioEntry, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXPauseFrames=ethTXPauseFrames, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioTxMute=radioTxMute, vlanFid=vlanFid, writeConfig=writeConfig, radioSide=radioSide, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ipRadioMgmt=ipRadioMgmt, loopback_tributary_mask=loopback_tributary_mask, atpcEnabled=atpcEnabled, ethTXMulticasts=ethTXMulticasts, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXVlanTagsDetected=ethRXVlanTagsDetected, licenseMask=licenseMask, license=license, ethRXDribleNibbles=ethRXDribleNibbles, modemCarrierOffset=modemCarrierOffset, vlanCfgStat=vlanCfgStat, ethRXPrevPktDropped=ethRXPrevPktDropped, localIp=localIp, ethRXByteCounterLow=ethRXByteCounterLow, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, restartcpu=restartcpu, modemACMtotalCapacity=modemACMtotalCapacity, vlanNumber=vlanNumber, modemACMmodulationMin=modemACMmodulationMin, atpcTxPowerCorrection=atpcTxPowerCorrection, modemInternalAGCgain=modemInternalAGCgain, modemACMethernetCapacity=modemACMethernetCapacity, e1t1ChannelNr=e1t1ChannelNr, modemErroredBlock=modemErroredBlock, modemTotalBlockNumber=modemTotalBlockNumber, vlanPortmap=vlanPortmap, radioTxPower=radioTxPower, ethRXBroadcasts=ethRXBroadcasts, aTPCEntry=aTPCEntry, modemSymbolRateRx=modemSymbolRateRx, radioRxFrequency=radioRxFrequency, modemLastAcqError=modemLastAcqError, ethTXLengthCheckErrors=ethTXLengthCheckErrors, description=description, modemACMengine=modemACMengine, ethGFPDelineationErrors=ethGFPDelineationErrors, modemTable=modemTable, modemErroredSecondRatio=modemErroredSecondRatio, modemRadialMSE=modemRadialMSE, radioIndex=radioIndex, ethTXCRCErrors=ethTXCRCErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioDuplexShift=radioDuplexShift, ethTXControlFrames=ethTXControlFrames, ethQOSTXDropped=ethQOSTXDropped, ipRadioStatEth=ipRadioStatEth, loopbacks=loopbacks, ethRXByteCounterHi=ethRXByteCounterHi, sysTemperature=sysTemperature, ethTXBroadcasts=ethTXBroadcasts, modemRowStatus=modemRowStatus, ethRXCRCErrors=ethRXCRCErrors, ipRadioCfg=ipRadioCfg, ethTXByteCounterLow=ethTXByteCounterLow, modemTotalCapacity=modemTotalCapacity, e1t1StatTable=e1t1StatTable, modemUnavailtime=modemUnavailtime, saf=saf, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXGiants=ethTXGiants, ipRadioStat=ipRadioStat, modemEntry=modemEntry, vlanPortType=vlanPortType, sysDateAndTime=sysDateAndTime, radioLoopback=radioLoopback, ethTXByteCounterHi=ethTXByteCounterHi, modemAcqStatus=modemAcqStatus, modemUptime=modemUptime, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, atpcIndex=atpcIndex, ethTXLateCollisions=ethTXLateCollisions, modemIndex=modemIndex, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, e1t1AIS=e1t1AIS, ethRXDvEvent=ethRXDvEvent, pointToPoint=pointToPoint, modemGeneralStatus=modemGeneralStatus, safip=safip, ipRadioCfgGeneral=ipRadioCfgGeneral, vlanEntry=vlanEntry, modemModulation=modemModulation, modemCountTime=modemCountTime, ipRadio=ipRadio, radioTable=radioTable, modemErroredSecond=modemErroredSecond, ipRadioCfgNetwork=ipRadioCfgNetwork, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioTxFrequency=radioTxFrequency, remoteIp=remoteIp, ethRXUnsupOpcodes=ethRXUnsupOpcodes, e1t1StatEntry=e1t1StatEntry, licenseUpdateStatus=licenseUpdateStatus, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXDones=ethTXDones, vlanTable=vlanTable, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemEthernetCapacity=modemEthernetCapacity, ethRXDones=ethRXDones, hostname=hostname, ethTXMaxCollisions=ethTXMaxCollisions, ethQOSTXFrames=ethQOSTXFrames, radioRxLevel=radioRxLevel, modemSymbolRateTx=modemSymbolRateTx, modemStandard=modemStandard, aTPCTable=aTPCTable, ethTXVlanTags=ethTXVlanTags, ethGFPFCSErrors=ethGFPFCSErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror, localIpMask=localIpMask, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers)
