...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXWireByteCounterHi=ethTXWireByteCounterHi, e1t1LOS=e1t1LOS, e1t1ChannelNr=e1t1ChannelNr, ipRadioMgmt=ipRadioMgmt, ethTXDones=ethTXDones, modemStandard=modemStandard, modemE1T1ChannelMask=modemE1T1ChannelMask, loopback_tributary_mask=loopback_tributary_mask, modemACMmodulationMax=modemACMmodulationMax, modemTotalCapacity=modemTotalCapacity, modemIndex=modemIndex, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXControlFrames=ethRXControlFrames, localIpMask=localIpMask, ethTXUnderruns=ethTXUnderruns, licenseMask=licenseMask, radioRxLevel=radioRxLevel, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXByteCounterLow=ethRXByteCounterLow, ethRXPrevPktDropped=ethRXPrevPktDropped, modemErroredBlock=modemErroredBlock, radioRxFrequency=radioRxFrequency, ethTXBackpresEvents=ethTXBackpresEvents, ethGFPDropedFrames=ethGFPDropedFrames, modemACMengine=modemACMengine, ethRXBroadcasts=ethRXBroadcasts, modemErroredSecondRatio=modemErroredSecondRatio, sysDateAndTime=sysDateAndTime, ethQOSTXFrames=ethQOSTXFrames, ethTXGiants=ethTXGiants, loopbacks=loopbacks, radioTxPower=radioTxPower, ethTXByteCounterLow=ethTXByteCounterLow, atpcIndex=atpcIndex, ethRXTruncatedFrames=ethRXTruncatedFrames, license=license, ethTXControlFrames=ethTXControlFrames, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemACMethernetCapacity=modemACMethernetCapacity, ethTXByteCounterHi=ethTXByteCounterHi, radioTxMute=radioTxMute, modemEntry=modemEntry, radioIndex=radioIndex, modemInternalAGCgain=modemInternalAGCgain, ethQOSTXDropped=ethQOSTXDropped, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, e1t1AIS=e1t1AIS, modemAcqStatus=modemAcqStatus, modemACMmodulationMin=modemACMmodulationMin, aTPCEntry=aTPCEntry, vlanPortmap=vlanPortmap, ethRXDribleNibbles=ethRXDribleNibbles, ethGFPFCSErrors=ethGFPFCSErrors, ethGFPDelineationErrors=ethGFPDelineationErrors, restartcpu=restartcpu, modemSymbolRateTx=modemSymbolRateTx, hostname=hostname, ethTXMulticasts=ethTXMulticasts, modemGeneralStatus=modemGeneralStatus, modemEthernetCapacity=modemEthernetCapacity, vlanFid=vlanFid, ethTXCRCErrors=ethTXCRCErrors, vlansEnabled=vlansEnabled, modemCarrierOffset=modemCarrierOffset, aTPCTable=aTPCTable, ethTXPauseFrames=ethTXPauseFrames, modemErroredSecond=modemErroredSecond, ethRXMulticasts=ethRXMulticasts, vlanTable=vlanTable, saf=saf, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXByteCounterHi=ethRXByteCounterHi, ipRadioCfg=ipRadioCfg, ethTXLateCollisions=ethTXLateCollisions, microwaveRadio=microwaveRadio, pointToPoint=pointToPoint, licenseUpdateStatus=licenseUpdateStatus, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, tehnika=tehnika, radioDuplexShift=radioDuplexShift, vlanPortType=vlanPortType, ipRadio=ipRadio, vlanEntry=vlanEntry, modemUnavailtime=modemUnavailtime, modemSymbolRateRx=modemSymbolRateRx, modemACMtotalCapacity=modemACMtotalCapacity, modemSeverelyErroredSecond=modemSeverelyErroredSecond, e1t1StatTable=e1t1StatTable, vlanNumber=vlanNumber, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioTable=radioTable, radioSide=radioSide, modemStatistics=modemStatistics, ethRXCodeErrors=ethRXCodeErrors, radioLoopback=radioLoopback, ethTXVlanTags=ethTXVlanTags, radioGenStatus=radioGenStatus, modemRadialMSE=modemRadialMSE, modemTotalBlockNumber=modemTotalBlockNumber, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemE1T1Channels=modemE1T1Channels, remoteIp=remoteIp, writeConfig=writeConfig, modemLastAcqError=modemLastAcqError, ipRadioStatEth=ipRadioStatEth, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXPauseFrames=ethRXPauseFrames, product=product, modemRowStatus=modemRowStatus, ethTXBroadcasts=ethTXBroadcasts, vlanRowStatus=vlanRowStatus, ipRadioStat=ipRadioStat, atpcEnabled=atpcEnabled, localIp=localIp, ethRXDones=ethRXDones, radioEntry=radioEntry, ethTXCollisions=ethTXCollisions, radioTxFrequency=radioTxFrequency, modemBackgroundBlockErrror=modemBackgroundBlockErrror, sysTemperature=sysTemperature, ethRXCRCErrors=ethRXCRCErrors, ethRXLongEvents=ethRXLongEvents, safip=safip, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, e1t1StatEntry=e1t1StatEntry, ethRXDvEvent=ethRXDvEvent, vlanCfgStat=vlanCfgStat, modemUptime=modemUptime, ipRadioCfgGeneral=ipRadioCfgGeneral, modemBandwith=modemBandwith, modemModulation=modemModulation, ethTXMaxCollisions=ethTXMaxCollisions, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXExcessiveDefers=ethTXExcessiveDefers, modemTable=modemTable, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethGFPCHECErrors=ethGFPCHECErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, description=description, modemCountTime=modemCountTime)
