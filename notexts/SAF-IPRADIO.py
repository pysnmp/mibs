...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXControlFrames=ethRXControlFrames, ethGFPDropedFrames=ethGFPDropedFrames, ipRadio=ipRadio, ethRXCodeErrors=ethRXCodeErrors, ethTXCRCErrors=ethTXCRCErrors, modemTotalBlockNumber=modemTotalBlockNumber, ethTXCollisions=ethTXCollisions, modemErroredBlock=modemErroredBlock, ipRadioStat=ipRadioStat, sysDateAndTime=sysDateAndTime, ethTXBroadcasts=ethTXBroadcasts, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioTxMute=radioTxMute, modemEntry=modemEntry, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemLastAcqError=modemLastAcqError, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioTable=radioTable, ethRXVlanTagsDetected=ethRXVlanTagsDetected, localIp=localIp, remoteIp=remoteIp, vlanFid=vlanFid, vlanCfgStat=vlanCfgStat, modemStandard=modemStandard, radioRxLevel=radioRxLevel, radioEntry=radioEntry, modemACMmodulationMin=modemACMmodulationMin, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemUnavailtime=modemUnavailtime, atpcTxPowerCorrection=atpcTxPowerCorrection, vlanPortType=vlanPortType, modemStatistics=modemStatistics, vlanEntry=vlanEntry, pointToPoint=pointToPoint, radioRxFrequency=radioRxFrequency, sysTemperature=sysTemperature, license=license, modemACMmodulationMax=modemACMmodulationMax, modemSymbolRateTx=modemSymbolRateTx, ethTXVlanTags=ethTXVlanTags, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, e1t1StatEntry=e1t1StatEntry, modemACMtotalCapacity=modemACMtotalCapacity, licenseUpdateStatus=licenseUpdateStatus, modemErroredSecondRatio=modemErroredSecondRatio, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXByteCounterHi=ethTXByteCounterHi, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethQOSTXFrames=ethQOSTXFrames, ipRadioMgmt=ipRadioMgmt, ethRXDribleNibbles=ethRXDribleNibbles, writeConfig=writeConfig, ethTXLateCollisions=ethTXLateCollisions, ethTXBackpresEvents=ethTXBackpresEvents, radioIndex=radioIndex, saf=saf, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemBandwith=modemBandwith, radioTxFrequency=radioTxFrequency, vlansEnabled=vlansEnabled, modemAcqStatus=modemAcqStatus, vlanNumber=vlanNumber, modemTotalCapacity=modemTotalCapacity, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemIndex=modemIndex, vlanRowStatus=vlanRowStatus, ethTXPauseFrames=ethTXPauseFrames, ethRXByteCounterLow=ethRXByteCounterLow, modemInternalAGCgain=modemInternalAGCgain, ipRadioCfg=ipRadioCfg, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioGenStatus=radioGenStatus, ipRadioStatEth=ipRadioStatEth, ethRXDones=ethRXDones, hostname=hostname, vlanPortmap=vlanPortmap, modemUptime=modemUptime, ipRadioCfgNetwork=ipRadioCfgNetwork, atpcEnabled=atpcEnabled, e1t1StatTable=e1t1StatTable, restartcpu=restartcpu, radioDuplexShift=radioDuplexShift, radioSide=radioSide, ethTXExcessiveDefers=ethTXExcessiveDefers, loopbacks=loopbacks, modemEthernetCapacity=modemEthernetCapacity, e1t1AIS=e1t1AIS, ethRXByteCounterHi=ethRXByteCounterHi, vlanTable=vlanTable, radioLoopback=radioLoopback, modemCountTime=modemCountTime, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXByteCounterLow=ethTXByteCounterLow, modemSymbolRateRx=modemSymbolRateRx, modemE1T1Channels=modemE1T1Channels, description=description, ethRXBroadcasts=ethRXBroadcasts, modemSeverelyErroredSecond=modemSeverelyErroredSecond, licenseMask=licenseMask, ethTXMaxCollisions=ethTXMaxCollisions, ethRXMulticasts=ethRXMulticasts, ethTXGiants=ethTXGiants, ethTXMulticasts=ethTXMulticasts, modemModulation=modemModulation, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemErroredSecond=modemErroredSecond, ethRXLongEvents=ethRXLongEvents, safip=safip, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemGeneralStatus=modemGeneralStatus, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXControlFrames=ethTXControlFrames, ethTXWireByteCounterHi=ethTXWireByteCounterHi, aTPCTable=aTPCTable, e1t1LOS=e1t1LOS, ethRXDvEvent=ethRXDvEvent, ethQOSTXDropped=ethQOSTXDropped, ethTXDones=ethTXDones, tehnika=tehnika, atpcIndex=atpcIndex, ethTXUnderruns=ethTXUnderruns, e1t1ChannelNr=e1t1ChannelNr, modemRowStatus=modemRowStatus, aTPCEntry=aTPCEntry, ethRXPauseFrames=ethRXPauseFrames, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ipRadioCfgGeneral=ipRadioCfgGeneral, modemRadialMSE=modemRadialMSE, localIpMask=localIpMask, microwaveRadio=microwaveRadio, modemACMethernetCapacity=modemACMethernetCapacity, ethRXTruncatedFrames=ethRXTruncatedFrames, modemLDPCdecoderStress=modemLDPCdecoderStress, product=product, modemACMengine=modemACMengine, loopback_tributary_mask=loopback_tributary_mask, modemTable=modemTable, ethGFPCHECErrors=ethGFPCHECErrors, modemCarrierOffset=modemCarrierOffset, ethGFPFCSErrors=ethGFPFCSErrors, ethRXCRCErrors=ethRXCRCErrors, radioTxPower=radioTxPower)
