...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXByteCounterHi=ethRXByteCounterHi, ethTXLateCollisions=ethTXLateCollisions, ethRXPauseFrames=ethRXPauseFrames, radioGenStatus=radioGenStatus, e1t1AIS=e1t1AIS, description=description, ethTXCRCErrors=ethTXCRCErrors, modemLastAcqError=modemLastAcqError, remoteIp=remoteIp, safip=safip, ethRXTruncatedFrames=ethRXTruncatedFrames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, e1t1StatTable=e1t1StatTable, modemSymbolRateRx=modemSymbolRateRx, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioTxPower=radioTxPower, ethGFPDelineationErrors=ethGFPDelineationErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXByteCounterHi=ethTXByteCounterHi, ethQOSTXFrames=ethQOSTXFrames, modemErroredSecondRatio=modemErroredSecondRatio, modemRadialMSE=modemRadialMSE, ethRXCRCErrors=ethRXCRCErrors, ethTXExcessiveDefers=ethTXExcessiveDefers, modemE1T1ChannelMask=modemE1T1ChannelMask, vlanFid=vlanFid, ethRXDones=ethRXDones, ethRXCodeErrors=ethRXCodeErrors, vlanTable=vlanTable, modemInternalAGCgain=modemInternalAGCgain, modemLDPCdecoderStress=modemLDPCdecoderStress, atpcTxPowerCorrection=atpcTxPowerCorrection, licenseUpdateStatus=licenseUpdateStatus, aTPCTable=aTPCTable, modemACMmodulationMax=modemACMmodulationMax, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethGFPCHECErrors=ethGFPCHECErrors, atpcEnabled=atpcEnabled, ipRadioMgmt=ipRadioMgmt, ethGFPDropedFrames=ethGFPDropedFrames, atpcIndex=atpcIndex, ipRadioCfgNetwork=ipRadioCfgNetwork, radioDuplexShift=radioDuplexShift, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXLongEvents=ethRXLongEvents, localIp=localIp, vlanCfgStat=vlanCfgStat, e1t1ChannelNr=e1t1ChannelNr, radioRxFrequency=radioRxFrequency, modemStatistics=modemStatistics, ethRXMulticasts=ethRXMulticasts, modemCarrierOffset=modemCarrierOffset, ipRadio=ipRadio, modemACMmodulationMin=modemACMmodulationMin, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, vlanNumber=vlanNumber, modemAcqStatus=modemAcqStatus, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, restartcpu=restartcpu, ethRXBroadcasts=ethRXBroadcasts, modemEthernetCapacity=modemEthernetCapacity, modemRowStatus=modemRowStatus, modemTable=modemTable, radioTxFrequency=radioTxFrequency, radioIndex=radioIndex, ipRadioStatEth=ipRadioStatEth, modemE1T1Channels=modemE1T1Channels, modemErroredBlock=modemErroredBlock, radioTxMute=radioTxMute, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXDones=ethTXDones, e1t1StatEntry=e1t1StatEntry, modemGeneralStatus=modemGeneralStatus, aTPCEntry=aTPCEntry, ipRadioCfg=ipRadioCfg, ethTXUnderruns=ethTXUnderruns, sysDateAndTime=sysDateAndTime, vlanRowStatus=vlanRowStatus, saf=saf, ethTXMaxCollisions=ethTXMaxCollisions, tehnika=tehnika, ethTXGiants=ethTXGiants, loopbacks=loopbacks, modemIndex=modemIndex, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioSide=radioSide, ethRXDvEvent=ethRXDvEvent, modemACMethernetCapacity=modemACMethernetCapacity, radioTable=radioTable, modemTotalCapacity=modemTotalCapacity, ethTXByteCounterLow=ethTXByteCounterLow, hostname=hostname, microwaveRadio=microwaveRadio, vlanPortType=vlanPortType, ipRadioStat=ipRadioStat, modemACMtotalCapacity=modemACMtotalCapacity, radioEntry=radioEntry, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, localIpMask=localIpMask, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, sysTemperature=sysTemperature, ethTXBackpresEvents=ethTXBackpresEvents, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXPauseFrames=ethTXPauseFrames, vlanPortmap=vlanPortmap, product=product, modemEntry=modemEntry, ethRXControlFrames=ethRXControlFrames, ethTXMulticasts=ethTXMulticasts, vlanEntry=vlanEntry, modemSymbolRateTx=modemSymbolRateTx, modemUnavailtime=modemUnavailtime, modemACMengine=modemACMengine, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemUptime=modemUptime, loopback_tributary_mask=loopback_tributary_mask, ethRXDribleNibbles=ethRXDribleNibbles, radioRxLevel=radioRxLevel, modemErroredSecond=modemErroredSecond, licenseMask=licenseMask, radioLoopback=radioLoopback, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXVlanTags=ethTXVlanTags, e1t1LOS=e1t1LOS, ethQOSTXDropped=ethQOSTXDropped, modemModulation=modemModulation, vlansEnabled=vlansEnabled, ethRXByteCounterLow=ethRXByteCounterLow, ethGFPFCSErrors=ethGFPFCSErrors, pointToPoint=pointToPoint, modemBandwith=modemBandwith, modemTotalBlockNumber=modemTotalBlockNumber, license=license, modemStandard=modemStandard, ethTXControlFrames=ethTXControlFrames, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemCountTime=modemCountTime, writeConfig=writeConfig, ethTXBroadcasts=ethTXBroadcasts, ethTXCollisions=ethTXCollisions)
