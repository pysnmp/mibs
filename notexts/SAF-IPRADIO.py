...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXByteCounterHi=ethTXByteCounterHi, loopbacks=loopbacks, ethRXByteCounterLow=ethRXByteCounterLow, ethQOSTXFrames=ethQOSTXFrames, ethQOSTXDropped=ethQOSTXDropped, ethRXDones=ethRXDones, microwaveRadio=microwaveRadio, radioDuplexShift=radioDuplexShift, modemE1T1Channels=modemE1T1Channels, ethGFPCHECErrors=ethGFPCHECErrors, ipRadioStatEth=ipRadioStatEth, ethTXExcessiveDefers=ethTXExcessiveDefers, ipRadioCfgNetwork=ipRadioCfgNetwork, e1t1StatEntry=e1t1StatEntry, atpcIndex=atpcIndex, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioIndex=radioIndex, ethGFPDelineationErrors=ethGFPDelineationErrors, modemACMethernetCapacity=modemACMethernetCapacity, ethTXLengthCheckErrors=ethTXLengthCheckErrors, loopback_tributary_mask=loopback_tributary_mask, licenseMask=licenseMask, atpcTxPowerCorrection=atpcTxPowerCorrection, modemACMmodulationMax=modemACMmodulationMax, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, vlanPortType=vlanPortType, modemErroredBlock=modemErroredBlock, writeConfig=writeConfig, aTPCTable=aTPCTable, ethGFPFCSErrors=ethGFPFCSErrors, modemStatistics=modemStatistics, modemCountTime=modemCountTime, vlanRowStatus=vlanRowStatus, radioTxMute=radioTxMute, modemACMmodulationMin=modemACMmodulationMin, localIp=localIp, ethRXByteCounterHi=ethRXByteCounterHi, license=license, modemErroredSecond=modemErroredSecond, remoteIp=remoteIp, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemACMtotalCapacity=modemACMtotalCapacity, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ipRadioCfg=ipRadioCfg, sysDateAndTime=sysDateAndTime, modemTable=modemTable, licenseUpdateStatus=licenseUpdateStatus, modemSymbolRateTx=modemSymbolRateTx, radioLoopback=radioLoopback, ethTXCRCErrors=ethTXCRCErrors, radioRxLevel=radioRxLevel, e1t1AIS=e1t1AIS, modemIndex=modemIndex, ethRXCodeErrors=ethRXCodeErrors, modemRowStatus=modemRowStatus, restartcpu=restartcpu, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemACMengine=modemACMengine, modemTotalBlockNumber=modemTotalBlockNumber, modemSymbolRateRx=modemSymbolRateRx, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXDones=ethTXDones, radioGenStatus=radioGenStatus, ethTXWireByteCounterLow=ethTXWireByteCounterLow, e1t1StatTable=e1t1StatTable, localIpMask=localIpMask, ethRXMulticasts=ethRXMulticasts, vlanFid=vlanFid, modemModulation=modemModulation, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, e1t1ChannelNr=e1t1ChannelNr, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXControlFrames=ethTXControlFrames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemCarrierOffset=modemCarrierOffset, ethTXBackpresEvents=ethTXBackpresEvents, vlansEnabled=vlansEnabled, ethTXUnderruns=ethTXUnderruns, modemUptime=modemUptime, hostname=hostname, modemErroredSecondRatio=modemErroredSecondRatio, ipRadioStat=ipRadioStat, radioTable=radioTable, modemTotalCapacity=modemTotalCapacity, ethTXLateCollisions=ethTXLateCollisions, ethRXPauseFrames=ethRXPauseFrames, modemAcqStatus=modemAcqStatus, ethTXByteCounterLow=ethTXByteCounterLow, modemLastAcqError=modemLastAcqError, pointToPoint=pointToPoint, ipRadioMgmt=ipRadioMgmt, ethRXDvEvent=ethRXDvEvent, radioRxFrequency=radioRxFrequency, product=product, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXMaxCollisions=ethTXMaxCollisions, ethRXCRCErrors=ethRXCRCErrors, ethTXBroadcasts=ethTXBroadcasts, tehnika=tehnika, ethRXControlFrames=ethRXControlFrames, vlanEntry=vlanEntry, ipRadio=ipRadio, vlanCfgStat=vlanCfgStat, modemEthernetCapacity=modemEthernetCapacity, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemEntry=modemEntry, modemGeneralStatus=modemGeneralStatus, ethTXMulticasts=ethTXMulticasts, ethTXCollisions=ethTXCollisions, ethTXVlanTags=ethTXVlanTags, modemInternalAGCgain=modemInternalAGCgain, radioTxPower=radioTxPower, ethRXTruncatedFrames=ethRXTruncatedFrames, modemLDPCdecoderStress=modemLDPCdecoderStress, modemStandard=modemStandard, e1t1LOS=e1t1LOS, sysTemperature=sysTemperature, vlanNumber=vlanNumber, ethTXGiants=ethTXGiants, safip=safip, description=description, ethRXBroadcasts=ethRXBroadcasts, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, atpcEnabled=atpcEnabled, ethRXLongEvents=ethRXLongEvents, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, vlanTable=vlanTable, radioEntry=radioEntry, modemBandwith=modemBandwith, modemUnavailtime=modemUnavailtime, saf=saf, radioTxFrequency=radioTxFrequency, modemRadialMSE=modemRadialMSE, aTPCEntry=aTPCEntry, ethGFPDropedFrames=ethGFPDropedFrames, radioSide=radioSide, vlanPortmap=vlanPortmap, ethRXDribleNibbles=ethRXDribleNibbles, ethTXPauseFrames=ethTXPauseFrames, ethRXPrevPktDropped=ethRXPrevPktDropped)
