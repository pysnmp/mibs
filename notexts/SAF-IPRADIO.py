...
mibBuilder.exportSymbols("SAF-IPRADIO", ipRadioStat=ipRadioStat, radioTxFrequency=radioTxFrequency, ethTXCRCErrors=ethTXCRCErrors, e1t1AIS=e1t1AIS, ethRXCRCErrors=ethRXCRCErrors, saf=saf, ethQOSTXDropped=ethQOSTXDropped, vlanPortType=vlanPortType, ethTXBackpresEvents=ethTXBackpresEvents, loopbacks=loopbacks, modemUnavailtime=modemUnavailtime, radioRxLevel=radioRxLevel, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, e1t1StatEntry=e1t1StatEntry, vlanTable=vlanTable, ethTXDones=ethTXDones, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlanEntry=vlanEntry, modemInternalAGCgain=modemInternalAGCgain, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXUnderruns=ethTXUnderruns, sysDateAndTime=sysDateAndTime, ethRXByteCounterLow=ethRXByteCounterLow, ipRadioStatEth=ipRadioStatEth, ethTXLateCollisions=ethTXLateCollisions, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXPrevPktDropped=ethRXPrevPktDropped, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXLongEvents=ethRXLongEvents, vlanNumber=vlanNumber, ethTXPauseFrames=ethTXPauseFrames, radioTable=radioTable, ethRXDribleNibbles=ethRXDribleNibbles, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemACMethernetCapacity=modemACMethernetCapacity, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioEntry=radioEntry, vlanFid=vlanFid, localIp=localIp, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemACMmodulationMax=modemACMmodulationMax, ethGFPCHECErrors=ethGFPCHECErrors, ipRadioCfg=ipRadioCfg, modemEntry=modemEntry, writeConfig=writeConfig, aTPCEntry=aTPCEntry, modemACMengine=modemACMengine, restartcpu=restartcpu, ethTXBroadcasts=ethTXBroadcasts, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXCodeErrors=ethRXCodeErrors, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXDvEvent=ethRXDvEvent, ipRadioMgmt=ipRadioMgmt, ethGFPDropedFrames=ethGFPDropedFrames, radioRxFrequency=radioRxFrequency, radioGenStatus=radioGenStatus, ethTXMulticasts=ethTXMulticasts, modemLDPCdecoderStress=modemLDPCdecoderStress, ipRadio=ipRadio, modemSymbolRateRx=modemSymbolRateRx, modemModulation=modemModulation, modemSymbolRateTx=modemSymbolRateTx, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemEthernetCapacity=modemEthernetCapacity, ipRadioCfgGeneral=ipRadioCfgGeneral, hostname=hostname, localIpMask=localIpMask, ethRXDones=ethRXDones, modemStatistics=modemStatistics, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXVlanTags=ethTXVlanTags, ethRXControlFrames=ethRXControlFrames, ethTXByteCounterHi=ethTXByteCounterHi, aTPCTable=aTPCTable, ethTXCollisions=ethTXCollisions, sysTemperature=sysTemperature, modemStandard=modemStandard, ethTXByteCounterLow=ethTXByteCounterLow, ethQOSTXFrames=ethQOSTXFrames, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, product=product, radioSide=radioSide, e1t1LOS=e1t1LOS, ethTXGiants=ethTXGiants, modemLastAcqError=modemLastAcqError, vlanCfgStat=vlanCfgStat, modemErroredSecondRatio=modemErroredSecondRatio, pointToPoint=pointToPoint, atpcEnabled=atpcEnabled, e1t1ChannelNr=e1t1ChannelNr, modemBandwith=modemBandwith, description=description, atpcIndex=atpcIndex, licenseMask=licenseMask, modemACMtotalCapacity=modemACMtotalCapacity, ethTXExcessiveDefers=ethTXExcessiveDefers, ethQOSRXQ1Frames=ethQOSRXQ1Frames, tehnika=tehnika, modemErroredBlock=modemErroredBlock, modemRowStatus=modemRowStatus, ethTXControlFrames=ethTXControlFrames, ethRXBroadcasts=ethRXBroadcasts, modemAcqStatus=modemAcqStatus, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemACMmodulationMin=modemACMmodulationMin, ethTXMaxCollisions=ethTXMaxCollisions, loopback_tributary_mask=loopback_tributary_mask, modemUptime=modemUptime, vlansEnabled=vlansEnabled, modemRadialMSE=modemRadialMSE, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXByteCounterHi=ethRXByteCounterHi, modemCountTime=modemCountTime, ethRXPauseFrames=ethRXPauseFrames, remoteIp=remoteIp, modemErroredSecond=modemErroredSecond, modemIndex=modemIndex, vlanRowStatus=vlanRowStatus, modemGeneralStatus=modemGeneralStatus, microwaveRadio=microwaveRadio, safip=safip, radioTxMute=radioTxMute, modemTable=modemTable, e1t1StatTable=e1t1StatTable, vlanPortmap=vlanPortmap, ethRXMulticasts=ethRXMulticasts, radioLoopback=radioLoopback, license=license, radioIndex=radioIndex, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemCarrierOffset=modemCarrierOffset, ethRXTruncatedFrames=ethRXTruncatedFrames, radioTxPower=radioTxPower, modemE1T1Channels=modemE1T1Channels, modemTotalCapacity=modemTotalCapacity, licenseUpdateStatus=licenseUpdateStatus, ethGFPFCSErrors=ethGFPFCSErrors, radioDuplexShift=radioDuplexShift, modemTotalBlockNumber=modemTotalBlockNumber)
