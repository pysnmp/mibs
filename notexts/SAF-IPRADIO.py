...
mibBuilder.exportSymbols("SAF-IPRADIO", e1t1StatTable=e1t1StatTable, modemE1T1Channels=modemE1T1Channels, ethTXExcessiveDefers=ethTXExcessiveDefers, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXUnsupOpcodes=ethRXUnsupOpcodes, atpcEnabled=atpcEnabled, ethTXControlFrames=ethTXControlFrames, ethTXLengthCheckErrors=ethTXLengthCheckErrors, remoteIp=remoteIp, ethRXTruncatedFrames=ethRXTruncatedFrames, license=license, saf=saf, ethTXDones=ethTXDones, ipRadio=ipRadio, ethRXDones=ethRXDones, ethRXCRCErrors=ethRXCRCErrors, ethTXCRCErrors=ethTXCRCErrors, ethRXPauseFrames=ethRXPauseFrames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemRadialMSE=modemRadialMSE, ipRadioMgmt=ipRadioMgmt, ethTXMaxCollisions=ethTXMaxCollisions, ipRadioCfgGeneral=ipRadioCfgGeneral, vlanCfgStat=vlanCfgStat, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemTable=modemTable, hostname=hostname, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlanRowStatus=vlanRowStatus, radioDuplexShift=radioDuplexShift, ethTXMulticasts=ethTXMulticasts, ethRXLongEvents=ethRXLongEvents, ethQOSTXFrames=ethQOSTXFrames, ethTXBackpresEvents=ethTXBackpresEvents, ethRXDvEvent=ethRXDvEvent, ethTXWireByteCounterHi=ethTXWireByteCounterHi, safip=safip, modemACMtotalCapacity=modemACMtotalCapacity, tehnika=tehnika, modemStatistics=modemStatistics, localIp=localIp, ethTXCollisions=ethTXCollisions, ethGFPCHECErrors=ethGFPCHECErrors, vlanNumber=vlanNumber, aTPCTable=aTPCTable, vlanPortmap=vlanPortmap, ethGFPFCSErrors=ethGFPFCSErrors, modemRowStatus=modemRowStatus, modemACMmodulationMax=modemACMmodulationMax, radioTxPower=radioTxPower, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioSide=radioSide, vlanPortType=vlanPortType, ethRXCodeErrors=ethRXCodeErrors, modemModulation=modemModulation, sysTemperature=sysTemperature, radioTxFrequency=radioTxFrequency, ethQOSTXDropped=ethQOSTXDropped, vlanFid=vlanFid, modemE1T1ChannelMask=modemE1T1ChannelMask, modemUptime=modemUptime, atpcIndex=atpcIndex, ethRXMulticasts=ethRXMulticasts, ethTXLateCollisions=ethTXLateCollisions, modemACMengine=modemACMengine, modemStandard=modemStandard, modemInternalAGCgain=modemInternalAGCgain, ethTXUnderruns=ethTXUnderruns, ethTXByteCounterHi=ethTXByteCounterHi, radioGenStatus=radioGenStatus, e1t1LOS=e1t1LOS, modemUnavailtime=modemUnavailtime, description=description, ethTXGiants=ethTXGiants, ethRXByteCounterHi=ethRXByteCounterHi, modemACMmodulationMin=modemACMmodulationMin, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXByteCounterLow=ethTXByteCounterLow, radioTable=radioTable, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethGFPDropedFrames=ethGFPDropedFrames, licenseUpdateStatus=licenseUpdateStatus, ethTXBroadcasts=ethTXBroadcasts, aTPCEntry=aTPCEntry, modemLastAcqError=modemLastAcqError, radioEntry=radioEntry, radioRxLevel=radioRxLevel, modemCountTime=modemCountTime, modemSymbolRateRx=modemSymbolRateRx, sysDateAndTime=sysDateAndTime, writeConfig=writeConfig, product=product, modemBackgroundBlockErrror=modemBackgroundBlockErrror, restartcpu=restartcpu, modemCarrierOffset=modemCarrierOffset, ethRXDribleNibbles=ethRXDribleNibbles, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemLDPCdecoderStress=modemLDPCdecoderStress, localIpMask=localIpMask, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXBroadcasts=ethRXBroadcasts, ethGFPDelineationErrors=ethGFPDelineationErrors, licenseMask=licenseMask, radioLoopback=radioLoopback, ethRXVlanTagsDetected=ethRXVlanTagsDetected, e1t1StatEntry=e1t1StatEntry, e1t1AIS=e1t1AIS, ethTXPauseFrames=ethTXPauseFrames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemGeneralStatus=modemGeneralStatus, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ipRadioStatEth=ipRadioStatEth, modemErroredSecond=modemErroredSecond, vlansEnabled=vlansEnabled, e1t1ChannelNr=e1t1ChannelNr, loopback_tributary_mask=loopback_tributary_mask, pointToPoint=pointToPoint, modemBandwith=modemBandwith, modemAcqStatus=modemAcqStatus, loopbacks=loopbacks, modemIndex=modemIndex, vlanEntry=vlanEntry, modemSymbolRateTx=modemSymbolRateTx, ethTXVlanTags=ethTXVlanTags, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemTotalCapacity=modemTotalCapacity, modemTotalBlockNumber=modemTotalBlockNumber, radioRxFrequency=radioRxFrequency, ethRXControlFrames=ethRXControlFrames, modemErroredBlock=modemErroredBlock, ipRadioStat=ipRadioStat, radioTxMute=radioTxMute, microwaveRadio=microwaveRadio, vlanTable=vlanTable, modemACMethernetCapacity=modemACMethernetCapacity, radioIndex=radioIndex, modemEthernetCapacity=modemEthernetCapacity, ipRadioCfgNetwork=ipRadioCfgNetwork, ipRadioCfg=ipRadioCfg, ethRXPrevPktDropped=ethRXPrevPktDropped, modemErroredSecondRatio=modemErroredSecondRatio, modemEntry=modemEntry, ethRXByteCounterLow=ethRXByteCounterLow)
