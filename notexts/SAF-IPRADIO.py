...
mibBuilder.exportSymbols("SAF-IPRADIO", modemACMtotalCapacity=modemACMtotalCapacity, modemStatistics=modemStatistics, modemUptime=modemUptime, e1t1StatTable=e1t1StatTable, atpcEnabled=atpcEnabled, vlanRowStatus=vlanRowStatus, microwaveRadio=microwaveRadio, ethRXLongEvents=ethRXLongEvents, e1t1ChannelNr=e1t1ChannelNr, ipRadioCfgGeneral=ipRadioCfgGeneral, modemACMmodulationMax=modemACMmodulationMax, ethQOSTXFrames=ethQOSTXFrames, radioTxPower=radioTxPower, modemGeneralStatus=modemGeneralStatus, ethTXLateCollisions=ethTXLateCollisions, ethRXPauseFrames=ethRXPauseFrames, ipRadioStatEth=ipRadioStatEth, modemEthernetCapacity=modemEthernetCapacity, modemTotalBlockNumber=modemTotalBlockNumber, ethGFPDropedFrames=ethGFPDropedFrames, description=description, writeConfig=writeConfig, ethRXPrevPktDropped=ethRXPrevPktDropped, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemSymbolRateTx=modemSymbolRateTx, modemE1T1Channels=modemE1T1Channels, modemTotalCapacity=modemTotalCapacity, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemTable=modemTable, modemAcqStatus=modemAcqStatus, modemBackgroundBlockErrror=modemBackgroundBlockErrror, license=license, aTPCTable=aTPCTable, ethTXCollisions=ethTXCollisions, ethQOSTXDropped=ethQOSTXDropped, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXLengthCheckErrors=ethTXLengthCheckErrors, localIpMask=localIpMask, vlanFid=vlanFid, ipRadioCfgNetwork=ipRadioCfgNetwork, vlanCfgStat=vlanCfgStat, ethRXControlFrames=ethRXControlFrames, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXDvEvent=ethRXDvEvent, licenseUpdateStatus=licenseUpdateStatus, modemE1T1ChannelMask=modemE1T1ChannelMask, sysDateAndTime=sysDateAndTime, ethRXCodeErrors=ethRXCodeErrors, radioGenStatus=radioGenStatus, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXByteCounterHi=ethTXByteCounterHi, pointToPoint=pointToPoint, modemUnavailtime=modemUnavailtime, ethRXCRCErrors=ethRXCRCErrors, ethTXMaxCollisions=ethTXMaxCollisions, vlanNumber=vlanNumber, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethGFPFCSErrors=ethGFPFCSErrors, modemSymbolRateRx=modemSymbolRateRx, ethTXUnderruns=ethTXUnderruns, ethRXMulticasts=ethRXMulticasts, ethRXTruncatedFrames=ethRXTruncatedFrames, vlanTable=vlanTable, modemACMengine=modemACMengine, ethRXByteCounterHi=ethRXByteCounterHi, safip=safip, loopback_tributary_mask=loopback_tributary_mask, ethRXDribleNibbles=ethRXDribleNibbles, modemACMmodulationMin=modemACMmodulationMin, modemEntry=modemEntry, modemBandwith=modemBandwith, modemErroredBlock=modemErroredBlock, radioLoopback=radioLoopback, product=product, modemCountTime=modemCountTime, e1t1LOS=e1t1LOS, modemRowStatus=modemRowStatus, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ipRadioMgmt=ipRadioMgmt, modemInternalAGCgain=modemInternalAGCgain, ethTXBackpresEvents=ethTXBackpresEvents, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXDones=ethRXDones, ethTXBroadcasts=ethTXBroadcasts, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXCRCErrors=ethTXCRCErrors, modemIndex=modemIndex, radioTxFrequency=radioTxFrequency, ethTXGiants=ethTXGiants, radioIndex=radioIndex, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXBroadcasts=ethRXBroadcasts, ethTXWireByteCounterLow=ethTXWireByteCounterLow, e1t1AIS=e1t1AIS, radioRxLevel=radioRxLevel, radioDuplexShift=radioDuplexShift, ipRadioStat=ipRadioStat, hostname=hostname, modemErroredSecondRatio=modemErroredSecondRatio, ethTXControlFrames=ethTXControlFrames, vlanPortmap=vlanPortmap, modemErroredSecond=modemErroredSecond, vlanPortType=vlanPortType, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXMulticasts=ethTXMulticasts, radioRxFrequency=radioRxFrequency, ethTXByteCounterLow=ethTXByteCounterLow, ethTXPauseFrames=ethTXPauseFrames, atpcIndex=atpcIndex, modemRadialMSE=modemRadialMSE, ethRXByteCounterLow=ethRXByteCounterLow, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXDones=ethTXDones, e1t1StatEntry=e1t1StatEntry, modemACMethernetCapacity=modemACMethernetCapacity, sysTemperature=sysTemperature, aTPCEntry=aTPCEntry, loopbacks=loopbacks, ipRadioCfg=ipRadioCfg, radioTxMute=radioTxMute, vlansEnabled=vlansEnabled, vlanEntry=vlanEntry, radioSide=radioSide, ipRadio=ipRadio, modemModulation=modemModulation, radioTable=radioTable, ethGFPCHECErrors=ethGFPCHECErrors, ethTXVlanTags=ethTXVlanTags, modemStandard=modemStandard, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, tehnika=tehnika, radioEntry=radioEntry, modemLastAcqError=modemLastAcqError, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, licenseMask=licenseMask, remoteIp=remoteIp, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemCarrierOffset=modemCarrierOffset, restartcpu=restartcpu, saf=saf, localIp=localIp)
