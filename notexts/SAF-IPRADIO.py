...
mibBuilder.exportSymbols("SAF-IPRADIO", modemStandard=modemStandard, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ipRadio=ipRadio, modemUnavailtime=modemUnavailtime, aTPCTable=aTPCTable, radioTable=radioTable, restartcpu=restartcpu, vlanNumber=vlanNumber, modemE1T1ChannelMask=modemE1T1ChannelMask, sysTemperature=sysTemperature, vlansEnabled=vlansEnabled, modemSymbolRateTx=modemSymbolRateTx, ethTXCollisions=ethTXCollisions, modemACMmodulationMax=modemACMmodulationMax, modemRadialMSE=modemRadialMSE, atpcTxPowerCorrection=atpcTxPowerCorrection, modemIndex=modemIndex, hostname=hostname, vlanPortmap=vlanPortmap, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, vlanRowStatus=vlanRowStatus, ethRXTruncatedFrames=ethRXTruncatedFrames, product=product, tehnika=tehnika, radioIndex=radioIndex, radioGenStatus=radioGenStatus, modemErroredSecondRatio=modemErroredSecondRatio, ethTXVlanTags=ethTXVlanTags, ipRadioCfg=ipRadioCfg, ethRXPrevPktDropped=ethRXPrevPktDropped, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXLongEvents=ethRXLongEvents, radioTxMute=radioTxMute, ethRXMulticasts=ethRXMulticasts, ethTXDones=ethTXDones, remoteIp=remoteIp, localIpMask=localIpMask, license=license, modemTable=modemTable, writeConfig=writeConfig, e1t1StatEntry=e1t1StatEntry, ethGFPDelineationErrors=ethGFPDelineationErrors, modemAcqStatus=modemAcqStatus, vlanEntry=vlanEntry, ethTXBackpresEvents=ethTXBackpresEvents, ethTXExcessiveDefers=ethTXExcessiveDefers, ipRadioMgmt=ipRadioMgmt, modemGeneralStatus=modemGeneralStatus, modemStatistics=modemStatistics, radioRxLevel=radioRxLevel, vlanPortType=vlanPortType, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, e1t1StatTable=e1t1StatTable, modemE1T1Channels=modemE1T1Channels, radioEntry=radioEntry, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemSymbolRateRx=modemSymbolRateRx, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXDvEvent=ethRXDvEvent, licenseUpdateStatus=licenseUpdateStatus, modemInternalAGCgain=modemInternalAGCgain, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioLoopback=radioLoopback, atpcIndex=atpcIndex, modemTotalCapacity=modemTotalCapacity, ethRXCodeErrors=ethRXCodeErrors, radioRxFrequency=radioRxFrequency, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemACMengine=modemACMengine, vlanCfgStat=vlanCfgStat, modemACMethernetCapacity=modemACMethernetCapacity, ipRadioCfgNetwork=ipRadioCfgNetwork, modemCountTime=modemCountTime, radioTxPower=radioTxPower, ethRXDribleNibbles=ethRXDribleNibbles, modemRowStatus=modemRowStatus, saf=saf, ethTXControlFrames=ethTXControlFrames, licenseMask=licenseMask, radioDuplexShift=radioDuplexShift, ethRXDones=ethRXDones, microwaveRadio=microwaveRadio, ethTXMaxCollisions=ethTXMaxCollisions, ethTXByteCounterLow=ethTXByteCounterLow, vlanTable=vlanTable, ethTXLateCollisions=ethTXLateCollisions, ethRXPauseFrames=ethRXPauseFrames, ethTXPauseFrames=ethTXPauseFrames, modemLastAcqError=modemLastAcqError, ipRadioStat=ipRadioStat, ethTXUnderruns=ethTXUnderruns, modemBandwith=modemBandwith, ethRXByteCounterLow=ethRXByteCounterLow, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, e1t1ChannelNr=e1t1ChannelNr, vlanFid=vlanFid, ethTXWireByteCounterHi=ethTXWireByteCounterHi, atpcEnabled=atpcEnabled, ethQOSTXFrames=ethQOSTXFrames, ethGFPDropedFrames=ethGFPDropedFrames, ethRXBroadcasts=ethRXBroadcasts, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXByteCounterHi=ethTXByteCounterHi, pointToPoint=pointToPoint, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXCRCErrors=ethRXCRCErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemEthernetCapacity=modemEthernetCapacity, safip=safip, ipRadioStatEth=ipRadioStatEth, loopbacks=loopbacks, modemTotalBlockNumber=modemTotalBlockNumber, modemModulation=modemModulation, e1t1AIS=e1t1AIS, ethTXMulticasts=ethTXMulticasts, modemCarrierOffset=modemCarrierOffset, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioSide=radioSide, radioTxFrequency=radioTxFrequency, modemErroredSecond=modemErroredSecond, modemUptime=modemUptime, ethGFPCHECErrors=ethGFPCHECErrors, modemErroredBlock=modemErroredBlock, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXBroadcasts=ethTXBroadcasts, ethRXControlFrames=ethRXControlFrames, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemACMmodulationMin=modemACMmodulationMin, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXCRCErrors=ethTXCRCErrors, modemACMtotalCapacity=modemACMtotalCapacity, modemEntry=modemEntry, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXByteCounterHi=ethRXByteCounterHi, ethTXGiants=ethTXGiants, aTPCEntry=aTPCEntry, localIp=localIp, description=description, ethQOSTXDropped=ethQOSTXDropped, loopback_tributary_mask=loopback_tributary_mask, ipRadioCfgGeneral=ipRadioCfgGeneral, sysDateAndTime=sysDateAndTime, e1t1LOS=e1t1LOS, ethGFPFCSErrors=ethGFPFCSErrors)
