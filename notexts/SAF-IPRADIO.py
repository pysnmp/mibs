...
mibBuilder.exportSymbols("SAF-IPRADIO", localIpMask=localIpMask, ethGFPDelineationErrors=ethGFPDelineationErrors, radioIndex=radioIndex, tehnika=tehnika, radioTxPower=radioTxPower, saf=saf, aTPCEntry=aTPCEntry, modemBandwith=modemBandwith, ethRXCRCErrors=ethRXCRCErrors, ethRXPauseFrames=ethRXPauseFrames, radioTxFrequency=radioTxFrequency, ethRXControlFrames=ethRXControlFrames, ethTXBroadcasts=ethTXBroadcasts, vlanPortmap=vlanPortmap, license=license, ethTXWireByteCounterLow=ethTXWireByteCounterLow, microwaveRadio=microwaveRadio, description=description, ethTXMulticasts=ethTXMulticasts, localIp=localIp, ethTXVlanTags=ethTXVlanTags, remoteIp=remoteIp, modemStandard=modemStandard, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemErroredBlock=modemErroredBlock, e1t1ChannelNr=e1t1ChannelNr, modemACMethernetCapacity=modemACMethernetCapacity, modemCarrierOffset=modemCarrierOffset, loopback_tributary_mask=loopback_tributary_mask, safip=safip, ipRadioStatEth=ipRadioStatEth, e1t1AIS=e1t1AIS, modemEntry=modemEntry, writeConfig=writeConfig, ethQOSRXQ1Frames=ethQOSRXQ1Frames, e1t1StatEntry=e1t1StatEntry, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, vlanTable=vlanTable, atpcEnabled=atpcEnabled, ipRadioCfg=ipRadioCfg, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemE1T1ChannelMask=modemE1T1ChannelMask, vlanRowStatus=vlanRowStatus, ethTXControlFrames=ethTXControlFrames, modemErroredSecond=modemErroredSecond, modemTotalBlockNumber=modemTotalBlockNumber, ethTXGiants=ethTXGiants, ethRXDribleNibbles=ethRXDribleNibbles, product=product, ethGFPCHECErrors=ethGFPCHECErrors, modemSymbolRateRx=modemSymbolRateRx, modemStatistics=modemStatistics, ethRXDones=ethRXDones, ethQOSTXFrames=ethQOSTXFrames, modemUnavailtime=modemUnavailtime, restartcpu=restartcpu, licenseMask=licenseMask, vlanNumber=vlanNumber, loopbacks=loopbacks, modemLastAcqError=modemLastAcqError, ethRXByteCounterLow=ethRXByteCounterLow, modemTable=modemTable, ethRXLongEvents=ethRXLongEvents, ethTXBackpresEvents=ethTXBackpresEvents, hostname=hostname, ethTXPauseFrames=ethTXPauseFrames, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXCodeErrors=ethRXCodeErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXLateCollisions=ethTXLateCollisions, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXByteCounterHi=ethTXByteCounterHi, modemInternalAGCgain=modemInternalAGCgain, modemModulation=modemModulation, ethRXUnsupOpcodes=ethRXUnsupOpcodes, vlanFid=vlanFid, modemACMmodulationMin=modemACMmodulationMin, ethTXCollisions=ethTXCollisions, ethRXPrevPktDropped=ethRXPrevPktDropped, ethGFPFCSErrors=ethGFPFCSErrors, radioGenStatus=radioGenStatus, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioSide=radioSide, modemACMmodulationMax=modemACMmodulationMax, vlanPortType=vlanPortType, radioTxMute=radioTxMute, modemACMtotalCapacity=modemACMtotalCapacity, ipRadioCfgNetwork=ipRadioCfgNetwork, radioEntry=radioEntry, modemTotalCapacity=modemTotalCapacity, ethRXVlanTagsDetected=ethRXVlanTagsDetected, e1t1StatTable=e1t1StatTable, e1t1LOS=e1t1LOS, modemACMengine=modemACMengine, ethRXTruncatedFrames=ethRXTruncatedFrames, ipRadio=ipRadio, ethTXDones=ethTXDones, modemErroredSecondRatio=modemErroredSecondRatio, sysDateAndTime=sysDateAndTime, modemE1T1Channels=modemE1T1Channels, sysTemperature=sysTemperature, modemRadialMSE=modemRadialMSE, vlansEnabled=vlansEnabled, radioRxLevel=radioRxLevel, modemIndex=modemIndex, modemGeneralStatus=modemGeneralStatus, modemRowStatus=modemRowStatus, ipRadioStat=ipRadioStat, ethTXCRCErrors=ethTXCRCErrors, ethRXDvEvent=ethRXDvEvent, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, aTPCTable=aTPCTable, modemUptime=modemUptime, ethRXByteCounterHi=ethRXByteCounterHi, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioDuplexShift=radioDuplexShift, ethRXBroadcasts=ethRXBroadcasts, atpcIndex=atpcIndex, pointToPoint=pointToPoint, radioTable=radioTable, ethRXMulticasts=ethRXMulticasts, ethQOSTXDropped=ethQOSTXDropped, vlanCfgStat=vlanCfgStat, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethGFPDropedFrames=ethGFPDropedFrames, ipRadioMgmt=ipRadioMgmt, ethQOSRXQ2Frames=ethQOSRXQ2Frames, licenseUpdateStatus=licenseUpdateStatus, radioLoopback=radioLoopback, vlanEntry=vlanEntry, ethTXUnderruns=ethTXUnderruns, modemSymbolRateTx=modemSymbolRateTx, modemLDPCdecoderStress=modemLDPCdecoderStress, radioRxFrequency=radioRxFrequency, ethTXByteCounterLow=ethTXByteCounterLow, modemAcqStatus=modemAcqStatus, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXMaxCollisions=ethTXMaxCollisions, modemCountTime=modemCountTime, modemEthernetCapacity=modemEthernetCapacity)
