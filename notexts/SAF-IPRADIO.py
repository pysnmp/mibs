...
mibBuilder.exportSymbols("SAF-IPRADIO", modemStandard=modemStandard, modemCarrierOffset=modemCarrierOffset, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXGiants=ethTXGiants, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXControlFrames=ethTXControlFrames, ipRadioStatEth=ipRadioStatEth, radioRxFrequency=radioRxFrequency, vlanTable=vlanTable, radioTxMute=radioTxMute, radioSide=radioSide, vlanFid=vlanFid, saf=saf, modemModulation=modemModulation, ipRadio=ipRadio, radioRxLevel=radioRxLevel, tehnika=tehnika, microwaveRadio=microwaveRadio, modemE1T1Channels=modemE1T1Channels, vlanEntry=vlanEntry, vlanPortType=vlanPortType, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, restartcpu=restartcpu, modemSymbolRateTx=modemSymbolRateTx, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlanNumber=vlanNumber, aTPCTable=aTPCTable, modemLastAcqError=modemLastAcqError, modemUnavailtime=modemUnavailtime, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemErroredSecond=modemErroredSecond, modemBandwith=modemBandwith, modemErroredBlock=modemErroredBlock, ethRXMulticasts=ethRXMulticasts, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ipRadioStat=ipRadioStat, ethTXVlanTags=ethTXVlanTags, ethTXLateCollisions=ethTXLateCollisions, ethTXCRCErrors=ethTXCRCErrors, loopbacks=loopbacks, modemIndex=modemIndex, e1t1LOS=e1t1LOS, vlanRowStatus=vlanRowStatus, ethRXCRCErrors=ethRXCRCErrors, modemCountTime=modemCountTime, sysTemperature=sysTemperature, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXDones=ethRXDones, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, atpcIndex=atpcIndex, ethRXByteCounterLow=ethRXByteCounterLow, radioDuplexShift=radioDuplexShift, modemGeneralStatus=modemGeneralStatus, ethRXByteCounterHi=ethRXByteCounterHi, hostname=hostname, ethTXByteCounterLow=ethTXByteCounterLow, radioTxPower=radioTxPower, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXPauseFrames=ethRXPauseFrames, ethTXPauseFrames=ethTXPauseFrames, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, pointToPoint=pointToPoint, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethQOSTXFrames=ethQOSTXFrames, modemErroredSecondRatio=modemErroredSecondRatio, ethTXDones=ethTXDones, modemUptime=modemUptime, modemInternalAGCgain=modemInternalAGCgain, sysDateAndTime=sysDateAndTime, atpcEnabled=atpcEnabled, modemStatistics=modemStatistics, modemE1T1ChannelMask=modemE1T1ChannelMask, radioGenStatus=radioGenStatus, e1t1StatTable=e1t1StatTable, ethRXDvEvent=ethRXDvEvent, modemAcqStatus=modemAcqStatus, product=product, ethGFPCHECErrors=ethGFPCHECErrors, ipRadioCfg=ipRadioCfg, localIp=localIp, e1t1AIS=e1t1AIS, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ipRadioCfgGeneral=ipRadioCfgGeneral, remoteIp=remoteIp, modemRowStatus=modemRowStatus, localIpMask=localIpMask, ethRXBroadcasts=ethRXBroadcasts, ethTXMulticasts=ethTXMulticasts, ethQOSTXDropped=ethQOSTXDropped, ethRXLongEvents=ethRXLongEvents, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXCodeErrors=ethRXCodeErrors, radioLoopback=radioLoopback, ethRXVlanTagsDetected=ethRXVlanTagsDetected, description=description, ethGFPDelineationErrors=ethGFPDelineationErrors, modemTotalCapacity=modemTotalCapacity, vlansEnabled=vlansEnabled, ethTXCollisions=ethTXCollisions, modemEntry=modemEntry, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemACMmodulationMax=modemACMmodulationMax, modemACMethernetCapacity=modemACMethernetCapacity, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadioMgmt=ipRadioMgmt, radioTable=radioTable, e1t1StatEntry=e1t1StatEntry, loopback_tributary_mask=loopback_tributary_mask, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethGFPFCSErrors=ethGFPFCSErrors, modemRadialMSE=modemRadialMSE, modemTotalBlockNumber=modemTotalBlockNumber, safip=safip, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemACMtotalCapacity=modemACMtotalCapacity, ethTXBroadcasts=ethTXBroadcasts, modemTable=modemTable, e1t1ChannelNr=e1t1ChannelNr, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXMaxCollisions=ethTXMaxCollisions, vlanPortmap=vlanPortmap, ethGFPDropedFrames=ethGFPDropedFrames, ethRXDribleNibbles=ethRXDribleNibbles, ethRXPrevPktDropped=ethRXPrevPktDropped, modemACMmodulationMin=modemACMmodulationMin, modemACMengine=modemACMengine, license=license, ethTXBackpresEvents=ethTXBackpresEvents, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXUnderruns=ethTXUnderruns, licenseMask=licenseMask, aTPCEntry=aTPCEntry, modemEthernetCapacity=modemEthernetCapacity, vlanCfgStat=vlanCfgStat, radioTxFrequency=radioTxFrequency, licenseUpdateStatus=licenseUpdateStatus, writeConfig=writeConfig, radioEntry=radioEntry, modemSymbolRateRx=modemSymbolRateRx, ethTXByteCounterHi=ethTXByteCounterHi, radioIndex=radioIndex, ethRXControlFrames=ethRXControlFrames)
