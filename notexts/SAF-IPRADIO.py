...
mibBuilder.exportSymbols("SAF-IPRADIO", vlanNumber=vlanNumber, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXByteCounterHi=ethTXByteCounterHi, aTPCTable=aTPCTable, modemACMtotalCapacity=modemACMtotalCapacity, ethRXMulticasts=ethRXMulticasts, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ipRadioStatEth=ipRadioStatEth, atpcEnabled=atpcEnabled, modemSymbolRateRx=modemSymbolRateRx, modemCountTime=modemCountTime, localIpMask=localIpMask, radioTxFrequency=radioTxFrequency, modemTotalCapacity=modemTotalCapacity, radioEntry=radioEntry, ethTXCRCErrors=ethTXCRCErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXMulticasts=ethTXMulticasts, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXBroadcasts=ethTXBroadcasts, ethRXCodeErrors=ethRXCodeErrors, ethQOSTXFrames=ethQOSTXFrames, ipRadioCfg=ipRadioCfg, ethRXByteCounterHi=ethRXByteCounterHi, e1t1StatTable=e1t1StatTable, ethTXBackpresEvents=ethTXBackpresEvents, restartcpu=restartcpu, modemUnavailtime=modemUnavailtime, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, e1t1AIS=e1t1AIS, radioTable=radioTable, loopback_tributary_mask=loopback_tributary_mask, product=product, modemInternalAGCgain=modemInternalAGCgain, modemLDPCdecoderStress=modemLDPCdecoderStress, modemErroredBlock=modemErroredBlock, modemEntry=modemEntry, radioRxLevel=radioRxLevel, ethTXUnderruns=ethTXUnderruns, ethTXControlFrames=ethTXControlFrames, modemStandard=modemStandard, sysDateAndTime=sysDateAndTime, aTPCEntry=aTPCEntry, modemIndex=modemIndex, modemTotalBlockNumber=modemTotalBlockNumber, loopbacks=loopbacks, ethTXPauseFrames=ethTXPauseFrames, radioLoopback=radioLoopback, vlansEnabled=vlansEnabled, modemModulation=modemModulation, localIp=localIp, description=description, vlanEntry=vlanEntry, pointToPoint=pointToPoint, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemACMethernetCapacity=modemACMethernetCapacity, safip=safip, radioDuplexShift=radioDuplexShift, atpcTxPowerCorrection=atpcTxPowerCorrection, modemACMengine=modemACMengine, ethTXExcessiveDefers=ethTXExcessiveDefers, modemACMmodulationMax=modemACMmodulationMax, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXGiants=ethTXGiants, modemUptime=modemUptime, modemRadialMSE=modemRadialMSE, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXUnsupOpcodes=ethRXUnsupOpcodes, e1t1LOS=e1t1LOS, radioGenStatus=radioGenStatus, radioTxMute=radioTxMute, ethTXDones=ethTXDones, modemStatistics=modemStatistics, ethRXTruncatedFrames=ethRXTruncatedFrames, modemTable=modemTable, e1t1ChannelNr=e1t1ChannelNr, vlanPortType=vlanPortType, ethTXByteCounterLow=ethTXByteCounterLow, licenseMask=licenseMask, hostname=hostname, radioIndex=radioIndex, modemLastAcqError=modemLastAcqError, ethRXPauseFrames=ethRXPauseFrames, ethGFPCHECErrors=ethGFPCHECErrors, ethRXDvEvent=ethRXDvEvent, vlanTable=vlanTable, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXLongEvents=ethRXLongEvents, modemACMmodulationMin=modemACMmodulationMin, ethTXVlanTags=ethTXVlanTags, modemAcqStatus=modemAcqStatus, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ipRadio=ipRadio, modemErroredSecond=modemErroredSecond, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, license=license, ethTXMaxCollisions=ethTXMaxCollisions, radioTxPower=radioTxPower, ethGFPDropedFrames=ethGFPDropedFrames, saf=saf, remoteIp=remoteIp, writeConfig=writeConfig, ethRXPrevPktDropped=ethRXPrevPktDropped, ipRadioCfgNetwork=ipRadioCfgNetwork, modemSymbolRateTx=modemSymbolRateTx, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioRxFrequency=radioRxFrequency, modemE1T1Channels=modemE1T1Channels, ethGFPDelineationErrors=ethGFPDelineationErrors, modemEthernetCapacity=modemEthernetCapacity, ethTXCollisions=ethTXCollisions, vlanPortmap=vlanPortmap, microwaveRadio=microwaveRadio, vlanCfgStat=vlanCfgStat, ethRXByteCounterLow=ethRXByteCounterLow, ipRadioMgmt=ipRadioMgmt, ethGFPFCSErrors=ethGFPFCSErrors, licenseUpdateStatus=licenseUpdateStatus, ethQOSTXDropped=ethQOSTXDropped, tehnika=tehnika, radioSide=radioSide, modemGeneralStatus=modemGeneralStatus, modemCarrierOffset=modemCarrierOffset, ethRXControlFrames=ethRXControlFrames, ethRXDones=ethRXDones, modemErroredSecondRatio=modemErroredSecondRatio, ethRXDribleNibbles=ethRXDribleNibbles, modemRowStatus=modemRowStatus, ethRXCRCErrors=ethRXCRCErrors, modemE1T1ChannelMask=modemE1T1ChannelMask, e1t1StatEntry=e1t1StatEntry, ethRXBroadcasts=ethRXBroadcasts, sysTemperature=sysTemperature, ethTXLateCollisions=ethTXLateCollisions, vlanRowStatus=vlanRowStatus, atpcIndex=atpcIndex, vlanFid=vlanFid, ipRadioStat=ipRadioStat, modemBandwith=modemBandwith)
