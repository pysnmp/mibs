...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXUnsupOpcodes=ethRXUnsupOpcodes, loopback_tributary_mask=loopback_tributary_mask, ethRXTruncatedFrames=ethRXTruncatedFrames, radioTxPower=radioTxPower, ethRXCRCErrors=ethRXCRCErrors, ethRXByteCounterHi=ethRXByteCounterHi, remoteIp=remoteIp, sysDateAndTime=sysDateAndTime, ethRXDones=ethRXDones, modemBandwith=modemBandwith, restartcpu=restartcpu, ethRXMulticasts=ethRXMulticasts, ethTXLateCollisions=ethTXLateCollisions, radioEntry=radioEntry, ethTXUnderruns=ethTXUnderruns, loopbacks=loopbacks, sysTemperature=sysTemperature, ethTXByteCounterLow=ethTXByteCounterLow, modemGeneralStatus=modemGeneralStatus, ethTXMulticasts=ethTXMulticasts, radioIndex=radioIndex, ethTXCRCErrors=ethTXCRCErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemLastAcqError=modemLastAcqError, microwaveRadio=microwaveRadio, modemTotalCapacity=modemTotalCapacity, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXMaxCollisions=ethTXMaxCollisions, aTPCEntry=aTPCEntry, hostname=hostname, vlanTable=vlanTable, ethTXDones=ethTXDones, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioRxLevel=radioRxLevel, ipRadioCfg=ipRadioCfg, ethRXControlFrames=ethRXControlFrames, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemCarrierOffset=modemCarrierOffset, ethQOSTXDropped=ethQOSTXDropped, modemSymbolRateRx=modemSymbolRateRx, radioDuplexShift=radioDuplexShift, licenseMask=licenseMask, modemEntry=modemEntry, localIpMask=localIpMask, ethRXBroadcasts=ethRXBroadcasts, e1t1AIS=e1t1AIS, modemStandard=modemStandard, radioLoopback=radioLoopback, ethRXByteCounterLow=ethRXByteCounterLow, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ipRadioCfgGeneral=ipRadioCfgGeneral, atpcTxPowerCorrection=atpcTxPowerCorrection, radioTxFrequency=radioTxFrequency, modemTotalBlockNumber=modemTotalBlockNumber, ethRXDribleNibbles=ethRXDribleNibbles, ethTXBackpresEvents=ethTXBackpresEvents, ethRXCodeErrors=ethRXCodeErrors, aTPCTable=aTPCTable, vlanPortmap=vlanPortmap, atpcEnabled=atpcEnabled, ethTXExcessiveDefers=ethTXExcessiveDefers, vlanNumber=vlanNumber, vlanRowStatus=vlanRowStatus, modemEthernetCapacity=modemEthernetCapacity, licenseUpdateStatus=licenseUpdateStatus, product=product, ethRXPauseFrames=ethRXPauseFrames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemUnavailtime=modemUnavailtime, modemE1T1ChannelMask=modemE1T1ChannelMask, modemACMmodulationMin=modemACMmodulationMin, modemRadialMSE=modemRadialMSE, ethTXCollisions=ethTXCollisions, ethGFPDropedFrames=ethGFPDropedFrames, modemSymbolRateTx=modemSymbolRateTx, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXLongEvents=ethRXLongEvents, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemTable=modemTable, radioTable=radioTable, ethGFPCHECErrors=ethGFPCHECErrors, ethTXGiants=ethTXGiants, localIp=localIp, ethTXControlFrames=ethTXControlFrames, vlanPortType=vlanPortType, license=license, ipRadio=ipRadio, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, vlanFid=vlanFid, writeConfig=writeConfig, tehnika=tehnika, modemE1T1Channels=modemE1T1Channels, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemErroredBlock=modemErroredBlock, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioRxFrequency=radioRxFrequency, modemACMengine=modemACMengine, modemErroredSecondRatio=modemErroredSecondRatio, saf=saf, ipRadioStat=ipRadioStat, modemErroredSecond=modemErroredSecond, vlanCfgStat=vlanCfgStat, ethTXBroadcasts=ethTXBroadcasts, ethGFPFCSErrors=ethGFPFCSErrors, e1t1LOS=e1t1LOS, ipRadioMgmt=ipRadioMgmt, vlanEntry=vlanEntry, ethRXDvEvent=ethRXDvEvent, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, e1t1ChannelNr=e1t1ChannelNr, modemModulation=modemModulation, modemRowStatus=modemRowStatus, radioTxMute=radioTxMute, ethTXByteCounterHi=ethTXByteCounterHi, description=description, ipRadioStatEth=ipRadioStatEth, pointToPoint=pointToPoint, modemAcqStatus=modemAcqStatus, ethQOSTXFrames=ethQOSTXFrames, modemBackgroundBlockErrror=modemBackgroundBlockErrror, safip=safip, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemACMethernetCapacity=modemACMethernetCapacity, modemIndex=modemIndex, modemCountTime=modemCountTime, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioGenStatus=radioGenStatus, modemStatistics=modemStatistics, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXPauseFrames=ethTXPauseFrames, radioSide=radioSide, modemACMtotalCapacity=modemACMtotalCapacity, e1t1StatEntry=e1t1StatEntry, modemInternalAGCgain=modemInternalAGCgain, modemACMmodulationMax=modemACMmodulationMax, atpcIndex=atpcIndex, modemUptime=modemUptime, ipRadioCfgNetwork=ipRadioCfgNetwork, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, e1t1StatTable=e1t1StatTable, vlansEnabled=vlansEnabled, ethTXVlanTags=ethTXVlanTags)
