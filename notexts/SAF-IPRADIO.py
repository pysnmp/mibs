...
mibBuilder.exportSymbols("SAF-IPRADIO", hostname=hostname, modemGeneralStatus=modemGeneralStatus, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethQOSTXFrames=ethQOSTXFrames, licenseUpdateStatus=licenseUpdateStatus, radioIndex=radioIndex, ethRXByteCounterHi=ethRXByteCounterHi, ethTXCollisions=ethTXCollisions, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXLongEvents=ethRXLongEvents, ipRadioCfg=ipRadioCfg, modemTable=modemTable, ethTXMulticasts=ethTXMulticasts, modemCarrierOffset=modemCarrierOffset, modemTotalBlockNumber=modemTotalBlockNumber, modemACMtotalCapacity=modemACMtotalCapacity, remoteIp=remoteIp, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadio=ipRadio, ipRadioMgmt=ipRadioMgmt, radioRxFrequency=radioRxFrequency, modemRadialMSE=modemRadialMSE, ethRXDvEvent=ethRXDvEvent, product=product, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXCRCErrors=ethTXCRCErrors, vlanEntry=vlanEntry, ethTXGiants=ethTXGiants, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXDribleNibbles=ethRXDribleNibbles, modemBackgroundBlockErrror=modemBackgroundBlockErrror, e1t1StatTable=e1t1StatTable, safip=safip, radioDuplexShift=radioDuplexShift, e1t1StatEntry=e1t1StatEntry, radioGenStatus=radioGenStatus, ethTXControlFrames=ethTXControlFrames, vlanFid=vlanFid, modemEthernetCapacity=modemEthernetCapacity, radioTxFrequency=radioTxFrequency, modemStandard=modemStandard, pointToPoint=pointToPoint, modemBandwith=modemBandwith, microwaveRadio=microwaveRadio, modemACMethernetCapacity=modemACMethernetCapacity, license=license, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXBroadcasts=ethTXBroadcasts, modemACMmodulationMax=modemACMmodulationMax, ethGFPCHECErrors=ethGFPCHECErrors, vlanPortType=vlanPortType, e1t1AIS=e1t1AIS, modemInternalAGCgain=modemInternalAGCgain, localIpMask=localIpMask, ethQOSRXQ1Frames=ethQOSRXQ1Frames, atpcIndex=atpcIndex, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemACMmodulationMin=modemACMmodulationMin, ethRXMulticasts=ethRXMulticasts, ethRXCodeErrors=ethRXCodeErrors, aTPCEntry=aTPCEntry, ethGFPFCSErrors=ethGFPFCSErrors, modemCountTime=modemCountTime, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioTable=radioTable, radioTxMute=radioTxMute, atpcTxPowerCorrection=atpcTxPowerCorrection, modemUptime=modemUptime, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXBackpresEvents=ethTXBackpresEvents, vlansEnabled=vlansEnabled, ethTXExcessiveDefers=ethTXExcessiveDefers, saf=saf, modemModulation=modemModulation, vlanRowStatus=vlanRowStatus, loopback_tributary_mask=loopback_tributary_mask, ethGFPDropedFrames=ethGFPDropedFrames, tehnika=tehnika, ethRXByteCounterLow=ethRXByteCounterLow, licenseMask=licenseMask, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, vlanNumber=vlanNumber, ipRadioCfgNetwork=ipRadioCfgNetwork, radioLoopback=radioLoopback, ethRXTruncatedFrames=ethRXTruncatedFrames, modemACMengine=modemACMengine, vlanCfgStat=vlanCfgStat, e1t1ChannelNr=e1t1ChannelNr, ethRXDones=ethRXDones, ethRXCRCErrors=ethRXCRCErrors, modemLastAcqError=modemLastAcqError, modemErroredSecondRatio=modemErroredSecondRatio, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXMaxCollisions=ethTXMaxCollisions, modemE1T1ChannelMask=modemE1T1ChannelMask, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, localIp=localIp, modemUnavailtime=modemUnavailtime, modemErroredBlock=modemErroredBlock, modemSymbolRateTx=modemSymbolRateTx, ethTXByteCounterHi=ethTXByteCounterHi, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXPrevPktDropped=ethRXPrevPktDropped, modemStatistics=modemStatistics, ipRadioStatEth=ipRadioStatEth, ethTXDones=ethTXDones, restartcpu=restartcpu, sysDateAndTime=sysDateAndTime, ethTXPauseFrames=ethTXPauseFrames, ethTXUnderruns=ethTXUnderruns, radioSide=radioSide, modemE1T1Channels=modemE1T1Channels, ethRXControlFrames=ethRXControlFrames, ethTXByteCounterLow=ethTXByteCounterLow, vlanPortmap=vlanPortmap, ethTXLateCollisions=ethTXLateCollisions, ethRXPauseFrames=ethRXPauseFrames, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXBroadcasts=ethRXBroadcasts, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXVlanTags=ethTXVlanTags, radioTxPower=radioTxPower, modemErroredSecond=modemErroredSecond, radioRxLevel=radioRxLevel, description=description, ethQOSTXDropped=ethQOSTXDropped, atpcEnabled=atpcEnabled, ipRadioStat=ipRadioStat, modemAcqStatus=modemAcqStatus, aTPCTable=aTPCTable, sysTemperature=sysTemperature, modemEntry=modemEntry, writeConfig=writeConfig, radioEntry=radioEntry, loopbacks=loopbacks, vlanTable=vlanTable, modemSymbolRateRx=modemSymbolRateRx, modemTotalCapacity=modemTotalCapacity, modemIndex=modemIndex, modemRowStatus=modemRowStatus, e1t1LOS=e1t1LOS, ethRXUnsupOpcodes=ethRXUnsupOpcodes)
