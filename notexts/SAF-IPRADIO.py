...
mibBuilder.exportSymbols("SAF-IPRADIO", ipRadioStat=ipRadioStat, description=description, remoteIp=remoteIp, ethGFPDropedFrames=ethGFPDropedFrames, ethRXBroadcasts=ethRXBroadcasts, vlanEntry=vlanEntry, ethRXByteCounterHi=ethRXByteCounterHi, e1t1StatEntry=e1t1StatEntry, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, e1t1StatTable=e1t1StatTable, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXPrevPktDropped=ethRXPrevPktDropped, licenseUpdateStatus=licenseUpdateStatus, modemUptime=modemUptime, modemBandwith=modemBandwith, saf=saf, modemErroredSecondRatio=modemErroredSecondRatio, radioIndex=radioIndex, aTPCTable=aTPCTable, modemErroredSecond=modemErroredSecond, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, licenseMask=licenseMask, restartcpu=restartcpu, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXByteCounterLow=ethTXByteCounterLow, modemTotalCapacity=modemTotalCapacity, atpcIndex=atpcIndex, modemModulation=modemModulation, microwaveRadio=microwaveRadio, vlanRowStatus=vlanRowStatus, modemGeneralStatus=modemGeneralStatus, ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlansEnabled=vlansEnabled, modemACMmodulationMin=modemACMmodulationMin, ipRadioCfg=ipRadioCfg, product=product, ethRXTruncatedFrames=ethRXTruncatedFrames, pointToPoint=pointToPoint, radioTable=radioTable, ethRXDvEvent=ethRXDvEvent, sysDateAndTime=sysDateAndTime, ethGFPFCSErrors=ethGFPFCSErrors, ethTXGiants=ethTXGiants, ipRadioCfgGeneral=ipRadioCfgGeneral, vlanPortType=vlanPortType, modemTable=modemTable, ethTXBackpresEvents=ethTXBackpresEvents, modemSymbolRateTx=modemSymbolRateTx, modemLDPCdecoderStress=modemLDPCdecoderStress, ethGFPDelineationErrors=ethGFPDelineationErrors, safip=safip, hostname=hostname, loopback_tributary_mask=loopback_tributary_mask, ethRXDones=ethRXDones, ethGFPCHECErrors=ethGFPCHECErrors, ethRXMulticasts=ethRXMulticasts, ethTXByteCounterHi=ethTXByteCounterHi, ethTXCRCErrors=ethTXCRCErrors, modemACMethernetCapacity=modemACMethernetCapacity, ethTXPauseFrames=ethTXPauseFrames, radioGenStatus=radioGenStatus, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioRxFrequency=radioRxFrequency, aTPCEntry=aTPCEntry, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemStatistics=modemStatistics, ethRXByteCounterLow=ethRXByteCounterLow, radioTxMute=radioTxMute, radioTxPower=radioTxPower, modemCarrierOffset=modemCarrierOffset, ethRXLongEvents=ethRXLongEvents, ethTXLengthCheckErrors=ethTXLengthCheckErrors, e1t1AIS=e1t1AIS, e1t1ChannelNr=e1t1ChannelNr, modemUnavailtime=modemUnavailtime, radioRxLevel=radioRxLevel, ethTXBroadcasts=ethTXBroadcasts, atpcEnabled=atpcEnabled, vlanCfgStat=vlanCfgStat, e1t1LOS=e1t1LOS, modemErroredBlock=modemErroredBlock, vlanTable=vlanTable, vlanFid=vlanFid, ethRXCRCErrors=ethRXCRCErrors, ipRadioMgmt=ipRadioMgmt, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXMaxCollisions=ethTXMaxCollisions, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemCountTime=modemCountTime, modemTotalBlockNumber=modemTotalBlockNumber, ethRXPauseFrames=ethRXPauseFrames, writeConfig=writeConfig, ethTXMulticasts=ethTXMulticasts, vlanNumber=vlanNumber, modemE1T1Channels=modemE1T1Channels, ethRXCodeErrors=ethRXCodeErrors, modemStandard=modemStandard, ethTXControlFrames=ethTXControlFrames, radioEntry=radioEntry, ethRXControlFrames=ethRXControlFrames, license=license, modemE1T1ChannelMask=modemE1T1ChannelMask, ipRadioCfgNetwork=ipRadioCfgNetwork, modemInternalAGCgain=modemInternalAGCgain, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemACMengine=modemACMengine, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ipRadio=ipRadio, ethQOSTXDropped=ethQOSTXDropped, ethRXDribleNibbles=ethRXDribleNibbles, modemLastAcqError=modemLastAcqError, modemACMtotalCapacity=modemACMtotalCapacity, radioDuplexShift=radioDuplexShift, modemEthernetCapacity=modemEthernetCapacity, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemSymbolRateRx=modemSymbolRateRx, loopbacks=loopbacks, radioLoopback=radioLoopback, ethTXVlanTags=ethTXVlanTags, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemAcqStatus=modemAcqStatus, localIpMask=localIpMask, radioTxFrequency=radioTxFrequency, ethTXDones=ethTXDones, ethTXWireByteCounterHi=ethTXWireByteCounterHi, vlanPortmap=vlanPortmap, modemRadialMSE=modemRadialMSE, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, sysTemperature=sysTemperature, modemEntry=modemEntry, modemACMmodulationMax=modemACMmodulationMax, modemIndex=modemIndex, ethQOSTXFrames=ethQOSTXFrames, localIp=localIp, modemRowStatus=modemRowStatus, ethTXLateCollisions=ethTXLateCollisions, tehnika=tehnika, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXCollisions=ethTXCollisions, radioSide=radioSide, ipRadioStatEth=ipRadioStatEth, ethTXUnderruns=ethTXUnderruns)
