...
mibBuilder.exportSymbols("SAF-IPRADIO", modemModulation=modemModulation, ethRXMulticasts=ethRXMulticasts, ethTXLateCollisions=ethTXLateCollisions, vlanFid=vlanFid, ethRXByteCounterLow=ethRXByteCounterLow, modemTotalCapacity=modemTotalCapacity, ethGFPFCSErrors=ethGFPFCSErrors, ethRXControlFrames=ethRXControlFrames, ethTXPauseFrames=ethTXPauseFrames, ethTXUnderruns=ethTXUnderruns, ipRadio=ipRadio, modemSymbolRateRx=modemSymbolRateRx, e1t1ChannelNr=e1t1ChannelNr, tehnika=tehnika, modemE1T1ChannelMask=modemE1T1ChannelMask, modemEntry=modemEntry, ethTXCRCErrors=ethTXCRCErrors, restartcpu=restartcpu, modemGeneralStatus=modemGeneralStatus, loopbacks=loopbacks, radioDuplexShift=radioDuplexShift, ipRadioCfgGeneral=ipRadioCfgGeneral, modemRowStatus=modemRowStatus, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXMaxCollisions=ethTXMaxCollisions, atpcTxPowerCorrection=atpcTxPowerCorrection, localIp=localIp, ipRadioStatEth=ipRadioStatEth, radioEntry=radioEntry, ethGFPDropedFrames=ethGFPDropedFrames, modemErroredBlock=modemErroredBlock, ipRadioCfgNetwork=ipRadioCfgNetwork, saf=saf, modemUnavailtime=modemUnavailtime, vlanTable=vlanTable, modemACMmodulationMin=modemACMmodulationMin, modemACMmodulationMax=modemACMmodulationMax, modemACMtotalCapacity=modemACMtotalCapacity, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXBackpresEvents=ethTXBackpresEvents, modemErroredSecondRatio=modemErroredSecondRatio, modemTable=modemTable, ethRXDones=ethRXDones, ethQOSTXFrames=ethQOSTXFrames, sysDateAndTime=sysDateAndTime, modemUptime=modemUptime, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemSymbolRateTx=modemSymbolRateTx, radioGenStatus=radioGenStatus, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioRxFrequency=radioRxFrequency, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXDribleNibbles=ethRXDribleNibbles, radioIndex=radioIndex, ethRXDvEvent=ethRXDvEvent, modemE1T1Channels=modemE1T1Channels, e1t1LOS=e1t1LOS, ethRXPauseFrames=ethRXPauseFrames, writeConfig=writeConfig, description=description, ethRXBroadcasts=ethRXBroadcasts, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXLongEvents=ethRXLongEvents, ethTXCollisions=ethTXCollisions, atpcIndex=atpcIndex, ethTXBroadcasts=ethTXBroadcasts, modemACMengine=modemACMengine, remoteIp=remoteIp, modemLDPCdecoderStress=modemLDPCdecoderStress, modemEthernetCapacity=modemEthernetCapacity, modemRadialMSE=modemRadialMSE, vlanPortType=vlanPortType, ethRXTruncatedFrames=ethRXTruncatedFrames, hostname=hostname, ethTXMulticasts=ethTXMulticasts, atpcEnabled=atpcEnabled, modemBandwith=modemBandwith, vlanEntry=vlanEntry, loopback_tributary_mask=loopback_tributary_mask, ethGFPCHECErrors=ethGFPCHECErrors, modemCarrierOffset=modemCarrierOffset, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXControlFrames=ethTXControlFrames, sysTemperature=sysTemperature, radioLoopback=radioLoopback, radioTxFrequency=radioTxFrequency, product=product, ethRXCodeErrors=ethRXCodeErrors, safip=safip, e1t1StatTable=e1t1StatTable, modemIndex=modemIndex, modemStandard=modemStandard, modemBackgroundBlockErrror=modemBackgroundBlockErrror, licenseMask=licenseMask, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, vlanRowStatus=vlanRowStatus, ethTXByteCounterHi=ethTXByteCounterHi, radioTxPower=radioTxPower, vlanPortmap=vlanPortmap, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXDones=ethTXDones, ipRadioCfg=ipRadioCfg, licenseUpdateStatus=licenseUpdateStatus, ethRXCRCErrors=ethRXCRCErrors, ethTXVlanTags=ethTXVlanTags, modemCountTime=modemCountTime, vlanCfgStat=vlanCfgStat, ipRadioMgmt=ipRadioMgmt, vlanNumber=vlanNumber, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioTable=radioTable, ethTXGiants=ethTXGiants, ethTXLengthCheckErrors=ethTXLengthCheckErrors, microwaveRadio=microwaveRadio, aTPCTable=aTPCTable, modemACMethernetCapacity=modemACMethernetCapacity, ethGFPDelineationErrors=ethGFPDelineationErrors, modemTotalBlockNumber=modemTotalBlockNumber, pointToPoint=pointToPoint, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXByteCounterLow=ethTXByteCounterLow, modemStatistics=modemStatistics, radioTxMute=radioTxMute, localIpMask=localIpMask, ethRXByteCounterHi=ethRXByteCounterHi, modemInternalAGCgain=modemInternalAGCgain, ethTXWireByteCounterLow=ethTXWireByteCounterLow, e1t1StatEntry=e1t1StatEntry, e1t1AIS=e1t1AIS, radioSide=radioSide, vlansEnabled=vlansEnabled, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioRxLevel=radioRxLevel, ethQOSTXDropped=ethQOSTXDropped, ipRadioStat=ipRadioStat, aTPCEntry=aTPCEntry, modemErroredSecond=modemErroredSecond, modemAcqStatus=modemAcqStatus, modemLastAcqError=modemLastAcqError, license=license)
