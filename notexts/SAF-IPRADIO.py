...
mibBuilder.exportSymbols("SAF-IPRADIO", ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemUptime=modemUptime, writeConfig=writeConfig, radioLoopback=radioLoopback, modemTable=modemTable, ethRXByteCounterHi=ethRXByteCounterHi, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXWireByteCounterLow=ethTXWireByteCounterLow, vlanNumber=vlanNumber, ethTXMulticasts=ethTXMulticasts, pointToPoint=pointToPoint, ethRXMulticasts=ethRXMulticasts, e1t1StatEntry=e1t1StatEntry, radioTxMute=radioTxMute, atpcEnabled=atpcEnabled, remoteIp=remoteIp, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ipRadioCfgGeneral=ipRadioCfgGeneral, loopbacks=loopbacks, microwaveRadio=microwaveRadio, ethRXDvEvent=ethRXDvEvent, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ipRadioStat=ipRadioStat, ethQOSTXDropped=ethQOSTXDropped, modemCarrierOffset=modemCarrierOffset, saf=saf, radioSide=radioSide, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemRadialMSE=modemRadialMSE, vlanPortmap=vlanPortmap, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethQOSTXFrames=ethQOSTXFrames, radioGenStatus=radioGenStatus, ethTXByteCounterHi=ethTXByteCounterHi, ipRadioMgmt=ipRadioMgmt, sysTemperature=sysTemperature, aTPCTable=aTPCTable, ipRadioStatEth=ipRadioStatEth, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXPauseFrames=ethTXPauseFrames, ethRXDones=ethRXDones, ethTXGiants=ethTXGiants, ethGFPDropedFrames=ethGFPDropedFrames, tehnika=tehnika, modemIndex=modemIndex, modemEntry=modemEntry, ethQOSRXQ2Frames=ethQOSRXQ2Frames, license=license, modemE1T1Channels=modemE1T1Channels, product=product, vlanPortType=vlanPortType, ethTXExcessiveDefers=ethTXExcessiveDefers, ipRadio=ipRadio, e1t1LOS=e1t1LOS, e1t1AIS=e1t1AIS, modemInternalAGCgain=modemInternalAGCgain, localIpMask=localIpMask, radioIndex=radioIndex, ethRXCRCErrors=ethRXCRCErrors, ethTXBackpresEvents=ethTXBackpresEvents, ethGFPFCSErrors=ethGFPFCSErrors, ethGFPCHECErrors=ethGFPCHECErrors, licenseUpdateStatus=licenseUpdateStatus, modemACMmodulationMax=modemACMmodulationMax, vlanCfgStat=vlanCfgStat, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXCodeErrors=ethRXCodeErrors, restartcpu=restartcpu, modemEthernetCapacity=modemEthernetCapacity, modemSymbolRateRx=modemSymbolRateRx, ethRXBroadcasts=ethRXBroadcasts, sysDateAndTime=sysDateAndTime, radioTable=radioTable, vlanEntry=vlanEntry, ethRXLongEvents=ethRXLongEvents, aTPCEntry=aTPCEntry, ethRXByteCounterLow=ethRXByteCounterLow, vlanRowStatus=vlanRowStatus, ethRXPauseFrames=ethRXPauseFrames, radioRxFrequency=radioRxFrequency, modemTotalBlockNumber=modemTotalBlockNumber, e1t1ChannelNr=e1t1ChannelNr, vlanFid=vlanFid, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXMaxCollisions=ethTXMaxCollisions, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ipRadioCfg=ipRadioCfg, modemACMtotalCapacity=modemACMtotalCapacity, ethTXDones=ethTXDones, modemLDPCdecoderStress=modemLDPCdecoderStress, modemModulation=modemModulation, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, description=description, vlanTable=vlanTable, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXByteCounterLow=ethTXByteCounterLow, ethRXControlFrames=ethRXControlFrames, atpcIndex=atpcIndex, modemTotalCapacity=modemTotalCapacity, ethRXTruncatedFrames=ethRXTruncatedFrames, modemRowStatus=modemRowStatus, ethTXVlanTags=ethTXVlanTags, modemBandwith=modemBandwith, modemSymbolRateTx=modemSymbolRateTx, ethTXUnderruns=ethTXUnderruns, modemCountTime=modemCountTime, modemStatistics=modemStatistics, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXControlFrames=ethTXControlFrames, modemErroredSecondRatio=modemErroredSecondRatio, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemGeneralStatus=modemGeneralStatus, vlansEnabled=vlansEnabled, safip=safip, ethGFPDelineationErrors=ethGFPDelineationErrors, modemErroredBlock=modemErroredBlock, ethTXCollisions=ethTXCollisions, loopback_tributary_mask=loopback_tributary_mask, modemUnavailtime=modemUnavailtime, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, hostname=hostname, modemStandard=modemStandard, radioTxPower=radioTxPower, ethRXDribleNibbles=ethRXDribleNibbles, e1t1StatTable=e1t1StatTable, modemACMengine=modemACMengine, radioTxFrequency=radioTxFrequency, radioRxLevel=radioRxLevel, licenseMask=licenseMask, ethTXLateCollisions=ethTXLateCollisions, modemACMethernetCapacity=modemACMethernetCapacity, modemAcqStatus=modemAcqStatus, ethTXCRCErrors=ethTXCRCErrors, radioEntry=radioEntry, modemACMmodulationMin=modemACMmodulationMin, ethTXBroadcasts=ethTXBroadcasts, radioDuplexShift=radioDuplexShift, localIp=localIp, modemErroredSecond=modemErroredSecond, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemLastAcqError=modemLastAcqError)
