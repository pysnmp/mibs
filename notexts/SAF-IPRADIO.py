...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXMulticasts=ethTXMulticasts, ethRXDones=ethRXDones, ethTXUnderruns=ethTXUnderruns, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXCodeErrors=ethRXCodeErrors, description=description, radioRxFrequency=radioRxFrequency, ethGFPDropedFrames=ethGFPDropedFrames, ethRXByteCounterHi=ethRXByteCounterHi, modemInternalAGCgain=modemInternalAGCgain, e1t1StatTable=e1t1StatTable, safip=safip, e1t1AIS=e1t1AIS, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethQOSTXFrames=ethQOSTXFrames, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXDones=ethTXDones, ipRadio=ipRadio, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXCRCErrors=ethTXCRCErrors, loopback_tributary_mask=loopback_tributary_mask, e1t1ChannelNr=e1t1ChannelNr, modemBandwith=modemBandwith, radioRxLevel=radioRxLevel, radioTxFrequency=radioTxFrequency, ethRXDvEvent=ethRXDvEvent, ethTXVlanTags=ethTXVlanTags, radioIndex=radioIndex, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemLDPCdecoderStress=modemLDPCdecoderStress, localIpMask=localIpMask, vlanNumber=vlanNumber, vlanFid=vlanFid, e1t1StatEntry=e1t1StatEntry, ipRadioCfgGeneral=ipRadioCfgGeneral, sysTemperature=sysTemperature, radioTxPower=radioTxPower, ipRadioStatEth=ipRadioStatEth, modemACMmodulationMax=modemACMmodulationMax, ethRXMulticasts=ethRXMulticasts, saf=saf, ethRXByteCounterLow=ethRXByteCounterLow, modemErroredSecond=modemErroredSecond, tehnika=tehnika, modemTable=modemTable, ethQOSTXDropped=ethQOSTXDropped, ethTXControlFrames=ethTXControlFrames, radioEntry=radioEntry, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXByteCounterLow=ethTXByteCounterLow, ipRadioStat=ipRadioStat, modemStatistics=modemStatistics, modemLastAcqError=modemLastAcqError, ethRXLongEvents=ethRXLongEvents, modemTotalCapacity=modemTotalCapacity, vlanRowStatus=vlanRowStatus, vlanCfgStat=vlanCfgStat, ethTXByteCounterHi=ethTXByteCounterHi, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemEntry=modemEntry, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXPauseFrames=ethRXPauseFrames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemEthernetCapacity=modemEthernetCapacity, modemCountTime=modemCountTime, ethGFPCHECErrors=ethGFPCHECErrors, ethRXCRCErrors=ethRXCRCErrors, modemGeneralStatus=modemGeneralStatus, license=license, localIp=localIp, ethRXTruncatedFrames=ethRXTruncatedFrames, ethGFPFCSErrors=ethGFPFCSErrors, modemTotalBlockNumber=modemTotalBlockNumber, microwaveRadio=microwaveRadio, loopbacks=loopbacks, radioLoopback=radioLoopback, modemRadialMSE=modemRadialMSE, modemAcqStatus=modemAcqStatus, hostname=hostname, modemRowStatus=modemRowStatus, modemErroredBlock=modemErroredBlock, modemACMengine=modemACMengine, radioSide=radioSide, ipRadioMgmt=ipRadioMgmt, ethTXMaxCollisions=ethTXMaxCollisions, ethTXGiants=ethTXGiants, ethGFPDelineationErrors=ethGFPDelineationErrors, radioGenStatus=radioGenStatus, radioTxMute=radioTxMute, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, writeConfig=writeConfig, modemACMethernetCapacity=modemACMethernetCapacity, ethRXControlFrames=ethRXControlFrames, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, vlanTable=vlanTable, aTPCEntry=aTPCEntry, remoteIp=remoteIp, modemErroredSecondRatio=modemErroredSecondRatio, modemModulation=modemModulation, licenseUpdateStatus=licenseUpdateStatus, ipRadioCfg=ipRadioCfg, modemStandard=modemStandard, vlanEntry=vlanEntry, ethRXDribleNibbles=ethRXDribleNibbles, modemSymbolRateTx=modemSymbolRateTx, modemSymbolRateRx=modemSymbolRateRx, sysDateAndTime=sysDateAndTime, radioTable=radioTable, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemE1T1Channels=modemE1T1Channels, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, e1t1LOS=e1t1LOS, vlanPortType=vlanPortType, modemUnavailtime=modemUnavailtime, pointToPoint=pointToPoint, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemACMmodulationMin=modemACMmodulationMin, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, restartcpu=restartcpu, atpcIndex=atpcIndex, ethRXBroadcasts=ethRXBroadcasts, modemCarrierOffset=modemCarrierOffset, ethTXLengthCheckErrors=ethTXLengthCheckErrors, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXBackpresEvents=ethTXBackpresEvents, ethTXPauseFrames=ethTXPauseFrames, ethTXCollisions=ethTXCollisions, radioDuplexShift=radioDuplexShift, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemUptime=modemUptime, ipRadioCfgNetwork=ipRadioCfgNetwork, product=product, ethTXLateCollisions=ethTXLateCollisions, ethTXWireByteCounterLow=ethTXWireByteCounterLow, aTPCTable=aTPCTable, ethTXBroadcasts=ethTXBroadcasts, modemACMtotalCapacity=modemACMtotalCapacity, atpcEnabled=atpcEnabled, licenseMask=licenseMask, vlanPortmap=vlanPortmap, ethRXPrevPktDropped=ethRXPrevPktDropped, vlansEnabled=vlansEnabled, modemIndex=modemIndex)
