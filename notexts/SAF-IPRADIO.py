...
mibBuilder.exportSymbols("SAF-IPRADIO", pointToPoint=pointToPoint, modemStatistics=modemStatistics, vlanPortType=vlanPortType, ethTXBroadcasts=ethTXBroadcasts, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemModulation=modemModulation, e1t1LOS=e1t1LOS, modemLastAcqError=modemLastAcqError, sysDateAndTime=sysDateAndTime, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXControlFrames=ethRXControlFrames, tehnika=tehnika, ipRadioStat=ipRadioStat, modemGeneralStatus=modemGeneralStatus, ethQOSTXDropped=ethQOSTXDropped, modemCountTime=modemCountTime, radioDuplexShift=radioDuplexShift, modemE1T1Channels=modemE1T1Channels, modemACMmodulationMin=modemACMmodulationMin, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXPrevPktDropped=ethRXPrevPktDropped, ethGFPCHECErrors=ethGFPCHECErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXLateCollisions=ethTXLateCollisions, e1t1ChannelNr=e1t1ChannelNr, modemSymbolRateTx=modemSymbolRateTx, radioSide=radioSide, localIp=localIp, ethTXMaxCollisions=ethTXMaxCollisions, e1t1StatTable=e1t1StatTable, aTPCEntry=aTPCEntry, modemRowStatus=modemRowStatus, ipRadio=ipRadio, ethTXCollisions=ethTXCollisions, ethQOSRXQ2Frames=ethQOSRXQ2Frames, atpcIndex=atpcIndex, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioTxMute=radioTxMute, vlanTable=vlanTable, ethRXPauseFrames=ethRXPauseFrames, ethTXDones=ethTXDones, ethTXCRCErrors=ethTXCRCErrors, loopbacks=loopbacks, modemCarrierOffset=modemCarrierOffset, ethTXPauseFrames=ethTXPauseFrames, ethTXControlFrames=ethTXControlFrames, remoteIp=remoteIp, modemTotalCapacity=modemTotalCapacity, e1t1StatEntry=e1t1StatEntry, ethRXLongEvents=ethRXLongEvents, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXTruncatedFrames=ethRXTruncatedFrames, modemEthernetCapacity=modemEthernetCapacity, radioTxFrequency=radioTxFrequency, ethTXUnderruns=ethTXUnderruns, ethRXByteCounterHi=ethRXByteCounterHi, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXBroadcasts=ethRXBroadcasts, ethRXDvEvent=ethRXDvEvent, modemTotalBlockNumber=modemTotalBlockNumber, ethTXBackpresEvents=ethTXBackpresEvents, ethRXCRCErrors=ethRXCRCErrors, modemTable=modemTable, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXByteCounterLow=ethTXByteCounterLow, radioRxLevel=radioRxLevel, ethTXGiants=ethTXGiants, loopback_tributary_mask=loopback_tributary_mask, licenseUpdateStatus=licenseUpdateStatus, ethTXVlanTags=ethTXVlanTags, vlanCfgStat=vlanCfgStat, modemACMethernetCapacity=modemACMethernetCapacity, radioEntry=radioEntry, modemErroredBlock=modemErroredBlock, ipRadioCfg=ipRadioCfg, modemErroredSecond=modemErroredSecond, ethRXDribleNibbles=ethRXDribleNibbles, radioLoopback=radioLoopback, modemBandwith=modemBandwith, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXDones=ethRXDones, ethRXVlanTagsDetected=ethRXVlanTagsDetected, e1t1AIS=e1t1AIS, hostname=hostname, ethRXUnsupOpcodes=ethRXUnsupOpcodes, product=product, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, atpcEnabled=atpcEnabled, vlanPortmap=vlanPortmap, radioTable=radioTable, modemInternalAGCgain=modemInternalAGCgain, license=license, radioTxPower=radioTxPower, modemACMtotalCapacity=modemACMtotalCapacity, modemUptime=modemUptime, ipRadioCfgNetwork=ipRadioCfgNetwork, ipRadioStatEth=ipRadioStatEth, ethTXByteCounterHi=ethTXByteCounterHi, modemStandard=modemStandard, ipRadioMgmt=ipRadioMgmt, modemErroredSecondRatio=modemErroredSecondRatio, safip=safip, localIpMask=localIpMask, licenseMask=licenseMask, ethGFPDropedFrames=ethGFPDropedFrames, writeConfig=writeConfig, vlansEnabled=vlansEnabled, ethTXMulticasts=ethTXMulticasts, vlanNumber=vlanNumber, vlanEntry=vlanEntry, modemSymbolRateRx=modemSymbolRateRx, microwaveRadio=microwaveRadio, modemACMmodulationMax=modemACMmodulationMax, ethRXCodeErrors=ethRXCodeErrors, ethGFPFCSErrors=ethGFPFCSErrors, ethRXMulticasts=ethRXMulticasts, modemLDPCdecoderStress=modemLDPCdecoderStress, modemRadialMSE=modemRadialMSE, restartcpu=restartcpu, modemUnavailtime=modemUnavailtime, saf=saf, radioRxFrequency=radioRxFrequency, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, sysTemperature=sysTemperature, modemAcqStatus=modemAcqStatus, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemACMengine=modemACMengine, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethQOSTXFrames=ethQOSTXFrames, atpcTxPowerCorrection=atpcTxPowerCorrection, radioIndex=radioIndex, modemIndex=modemIndex, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXByteCounterLow=ethRXByteCounterLow, modemE1T1ChannelMask=modemE1T1ChannelMask, modemEntry=modemEntry, aTPCTable=aTPCTable, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, description=description, vlanFid=vlanFid, radioGenStatus=radioGenStatus, vlanRowStatus=vlanRowStatus)
