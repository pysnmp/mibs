...
mibBuilder.exportSymbols("SAF-IPRADIO", ethGFPFCSErrors=ethGFPFCSErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXExcessiveDefers=ethTXExcessiveDefers, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, license=license, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethGFPDropedFrames=ethGFPDropedFrames, ipRadioMgmt=ipRadioMgmt, ethTXMaxCollisions=ethTXMaxCollisions, modemSymbolRateTx=modemSymbolRateTx, restartcpu=restartcpu, radioTxFrequency=radioTxFrequency, vlanRowStatus=vlanRowStatus, ethRXVlanTagsDetected=ethRXVlanTagsDetected, aTPCEntry=aTPCEntry, radioGenStatus=radioGenStatus, modemUptime=modemUptime, radioTable=radioTable, e1t1ChannelNr=e1t1ChannelNr, ipRadio=ipRadio, ethRXDvEvent=ethRXDvEvent, ipRadioCfgNetwork=ipRadioCfgNetwork, modemEntry=modemEntry, ethGFPCHECErrors=ethGFPCHECErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioTxMute=radioTxMute, ethTXLateCollisions=ethTXLateCollisions, radioIndex=radioIndex, modemTotalBlockNumber=modemTotalBlockNumber, vlanPortType=vlanPortType, modemRadialMSE=modemRadialMSE, ethRXControlFrames=ethRXControlFrames, modemCountTime=modemCountTime, modemACMmodulationMax=modemACMmodulationMax, ethQOSTXDropped=ethQOSTXDropped, remoteIp=remoteIp, modemCarrierOffset=modemCarrierOffset, modemACMethernetCapacity=modemACMethernetCapacity, modemSeverelyErroredSecond=modemSeverelyErroredSecond, vlansEnabled=vlansEnabled, ethTXPauseFrames=ethTXPauseFrames, modemAcqStatus=modemAcqStatus, e1t1LOS=e1t1LOS, atpcTxPowerCorrection=atpcTxPowerCorrection, modemTotalCapacity=modemTotalCapacity, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemStandard=modemStandard, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXDones=ethRXDones, ethTXCollisions=ethTXCollisions, vlanFid=vlanFid, saf=saf, ipRadioStat=ipRadioStat, radioLoopback=radioLoopback, radioEntry=radioEntry, modemACMtotalCapacity=modemACMtotalCapacity, ethTXCRCErrors=ethTXCRCErrors, modemUnavailtime=modemUnavailtime, tehnika=tehnika, modemSymbolRateRx=modemSymbolRateRx, ipRadioCfg=ipRadioCfg, licenseMask=licenseMask, vlanTable=vlanTable, modemIndex=modemIndex, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemStatistics=modemStatistics, modemErroredSecondRatio=modemErroredSecondRatio, vlanEntry=vlanEntry, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXLongEvents=ethRXLongEvents, ethGFPDelineationErrors=ethGFPDelineationErrors, product=product, modemErroredSecond=modemErroredSecond, modemErroredBlock=modemErroredBlock, ipRadioStatEth=ipRadioStatEth, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXBackpresEvents=ethTXBackpresEvents, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioSide=radioSide, ethTXByteCounterHi=ethTXByteCounterHi, localIp=localIp, description=description, hostname=hostname, ethRXByteCounterLow=ethRXByteCounterLow, ethRXByteCounterHi=ethRXByteCounterHi, ethRXCRCErrors=ethRXCRCErrors, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, vlanCfgStat=vlanCfgStat, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXVlanTags=ethTXVlanTags, radioRxFrequency=radioRxFrequency, modemACMmodulationMin=modemACMmodulationMin, ethTXBroadcasts=ethTXBroadcasts, modemInternalAGCgain=modemInternalAGCgain, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioRxLevel=radioRxLevel, modemE1T1Channels=modemE1T1Channels, modemModulation=modemModulation, aTPCTable=aTPCTable, safip=safip, ethRXCodeErrors=ethRXCodeErrors, ethTXDones=ethTXDones, atpcIndex=atpcIndex, loopback_tributary_mask=loopback_tributary_mask, modemBandwith=modemBandwith, microwaveRadio=microwaveRadio, ethTXUnderruns=ethTXUnderruns, modemTable=modemTable, modemLDPCdecoderStress=modemLDPCdecoderStress, loopbacks=loopbacks, ethTXControlFrames=ethTXControlFrames, ethTXByteCounterLow=ethTXByteCounterLow, pointToPoint=pointToPoint, atpcEnabled=atpcEnabled, ethQOSTXFrames=ethQOSTXFrames, vlanPortmap=vlanPortmap, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, sysDateAndTime=sysDateAndTime, radioDuplexShift=radioDuplexShift, e1t1StatTable=e1t1StatTable, e1t1AIS=e1t1AIS, modemGeneralStatus=modemGeneralStatus, modemEthernetCapacity=modemEthernetCapacity, ethTXGiants=ethTXGiants, localIpMask=localIpMask, writeConfig=writeConfig, ethRXBroadcasts=ethRXBroadcasts, ethRXPauseFrames=ethRXPauseFrames, modemACMengine=modemACMengine, ethRXMulticasts=ethRXMulticasts, modemLastAcqError=modemLastAcqError, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioTxPower=radioTxPower, e1t1StatEntry=e1t1StatEntry, sysTemperature=sysTemperature, licenseUpdateStatus=licenseUpdateStatus, ethTXMulticasts=ethTXMulticasts, ethRXDribleNibbles=ethRXDribleNibbles, modemRowStatus=modemRowStatus, vlanNumber=vlanNumber, ethRXUnsupOpcodes=ethRXUnsupOpcodes)
