...
mibBuilder.exportSymbols("SAF-IPRADIO", radioEntry=radioEntry, ethTXCRCErrors=ethTXCRCErrors, ethTXMulticasts=ethTXMulticasts, radioLoopback=radioLoopback, modemCountTime=modemCountTime, modemACMmodulationMax=modemACMmodulationMax, modemInternalAGCgain=modemInternalAGCgain, ethGFPDelineationErrors=ethGFPDelineationErrors, restartcpu=restartcpu, microwaveRadio=microwaveRadio, ethRXLongEvents=ethRXLongEvents, ethTXMaxCollisions=ethTXMaxCollisions, ethGFPDropedFrames=ethGFPDropedFrames, modemBandwith=modemBandwith, ethTXBackpresEvents=ethTXBackpresEvents, modemACMmodulationMin=modemACMmodulationMin, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethQOSTXDropped=ethQOSTXDropped, aTPCEntry=aTPCEntry, localIpMask=localIpMask, ipRadioStatEth=ipRadioStatEth, vlanTable=vlanTable, modemModulation=modemModulation, ethTXWireByteCounterLow=ethTXWireByteCounterLow, vlanPortType=vlanPortType, modemLastAcqError=modemLastAcqError, radioRxLevel=radioRxLevel, vlansEnabled=vlansEnabled, ethTXCollisions=ethTXCollisions, ethRXByteCounterLow=ethRXByteCounterLow, ethRXBroadcasts=ethRXBroadcasts, ethRXByteCounterHi=ethRXByteCounterHi, ethQOSTXFrames=ethQOSTXFrames, ipRadioCfg=ipRadioCfg, localIp=localIp, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioRxFrequency=radioRxFrequency, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, e1t1StatTable=e1t1StatTable, atpcEnabled=atpcEnabled, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXUnderruns=ethTXUnderruns, ethTXExcessiveDefers=ethTXExcessiveDefers, e1t1AIS=e1t1AIS, licenseUpdateStatus=licenseUpdateStatus, aTPCTable=aTPCTable, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXControlFrames=ethTXControlFrames, modemErroredSecond=modemErroredSecond, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, pointToPoint=pointToPoint, ethRXDones=ethRXDones, ethTXGiants=ethTXGiants, modemErroredBlock=modemErroredBlock, radioTxPower=radioTxPower, ethTXByteCounterHi=ethTXByteCounterHi, ipRadioMgmt=ipRadioMgmt, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, license=license, radioSide=radioSide, modemSymbolRateTx=modemSymbolRateTx, sysTemperature=sysTemperature, ethTXBroadcasts=ethTXBroadcasts, loopbacks=loopbacks, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXVlanTags=ethTXVlanTags, ethGFPCHECErrors=ethGFPCHECErrors, modemUptime=modemUptime, modemIndex=modemIndex, modemSymbolRateRx=modemSymbolRateRx, modemACMtotalCapacity=modemACMtotalCapacity, ethRXDvEvent=ethRXDvEvent, modemTotalCapacity=modemTotalCapacity, loopback_tributary_mask=loopback_tributary_mask, vlanRowStatus=vlanRowStatus, vlanFid=vlanFid, ethRXCRCErrors=ethRXCRCErrors, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXLengthCheckErrors=ethTXLengthCheckErrors, description=description, modemACMengine=modemACMengine, modemLDPCdecoderStress=modemLDPCdecoderStress, modemTotalBlockNumber=modemTotalBlockNumber, modemErroredSecondRatio=modemErroredSecondRatio, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXCodeErrors=ethRXCodeErrors, modemStandard=modemStandard, ethTXByteCounterLow=ethTXByteCounterLow, radioTxMute=radioTxMute, modemCarrierOffset=modemCarrierOffset, ethRXControlFrames=ethRXControlFrames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioIndex=radioIndex, sysDateAndTime=sysDateAndTime, modemGeneralStatus=modemGeneralStatus, ethRXPauseFrames=ethRXPauseFrames, hostname=hostname, modemRadialMSE=modemRadialMSE, radioGenStatus=radioGenStatus, safip=safip, vlanPortmap=vlanPortmap, writeConfig=writeConfig, ethRXDribleNibbles=ethRXDribleNibbles, ethTXDones=ethTXDones, e1t1StatEntry=e1t1StatEntry, modemACMethernetCapacity=modemACMethernetCapacity, product=product, atpcIndex=atpcIndex, remoteIp=remoteIp, modemEntry=modemEntry, modemRowStatus=modemRowStatus, radioTable=radioTable, modemUnavailtime=modemUnavailtime, modemEthernetCapacity=modemEthernetCapacity, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlanCfgStat=vlanCfgStat, ethGFPFCSErrors=ethGFPFCSErrors, saf=saf, ipRadio=ipRadio, modemTable=modemTable, tehnika=tehnika, ethRXMulticasts=ethRXMulticasts, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, e1t1LOS=e1t1LOS, licenseMask=licenseMask, ipRadioStat=ipRadioStat, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXPauseFrames=ethTXPauseFrames, vlanEntry=vlanEntry, ethTXLateCollisions=ethTXLateCollisions, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemAcqStatus=modemAcqStatus, ipRadioCfgNetwork=ipRadioCfgNetwork, modemE1T1Channels=modemE1T1Channels, radioDuplexShift=radioDuplexShift, modemStatistics=modemStatistics, vlanNumber=vlanNumber, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioTxFrequency=radioTxFrequency, e1t1ChannelNr=e1t1ChannelNr)
