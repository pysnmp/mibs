...
mibBuilder.exportSymbols("SAF-IPRADIO", radioRxFrequency=radioRxFrequency, ethRXLongEvents=ethRXLongEvents, ethQOSTXFrames=ethQOSTXFrames, writeConfig=writeConfig, modemACMmodulationMin=modemACMmodulationMin, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemACMtotalCapacity=modemACMtotalCapacity, radioTxPower=radioTxPower, ethTXDones=ethTXDones, ethGFPFCSErrors=ethGFPFCSErrors, ipRadioCfg=ipRadioCfg, ipRadioMgmt=ipRadioMgmt, ethRXTruncatedFrames=ethRXTruncatedFrames, modemEntry=modemEntry, vlanPortType=vlanPortType, ethTXBackpresEvents=ethTXBackpresEvents, e1t1StatEntry=e1t1StatEntry, ethTXByteCounterHi=ethTXByteCounterHi, radioGenStatus=radioGenStatus, ethTXMaxCollisions=ethTXMaxCollisions, ethGFPCHECErrors=ethGFPCHECErrors, modemACMethernetCapacity=modemACMethernetCapacity, sysDateAndTime=sysDateAndTime, ethTXGiants=ethTXGiants, radioRxLevel=radioRxLevel, ethRXBroadcasts=ethRXBroadcasts, hostname=hostname, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlanCfgStat=vlanCfgStat, sysTemperature=sysTemperature, product=product, modemGeneralStatus=modemGeneralStatus, vlanRowStatus=vlanRowStatus, modemErroredBlock=modemErroredBlock, modemErroredSecondRatio=modemErroredSecondRatio, modemLastAcqError=modemLastAcqError, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, license=license, ethQOSTXDropped=ethQOSTXDropped, ethRXControlFrames=ethRXControlFrames, loopbacks=loopbacks, modemTotalCapacity=modemTotalCapacity, ethTXCRCErrors=ethTXCRCErrors, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXDribleNibbles=ethRXDribleNibbles, modemTable=modemTable, ipRadioStat=ipRadioStat, ethTXMulticasts=ethTXMulticasts, modemACMengine=modemACMengine, radioSide=radioSide, microwaveRadio=microwaveRadio, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXPauseFrames=ethRXPauseFrames, ipRadioCfgGeneral=ipRadioCfgGeneral, modemACMmodulationMax=modemACMmodulationMax, ethRXMulticasts=ethRXMulticasts, safip=safip, ethTXByteCounterLow=ethTXByteCounterLow, ipRadio=ipRadio, modemBandwith=modemBandwith, modemE1T1Channels=modemE1T1Channels, pointToPoint=pointToPoint, aTPCTable=aTPCTable, vlanEntry=vlanEntry, ethTXLateCollisions=ethTXLateCollisions, ethTXExcessiveDefers=ethTXExcessiveDefers, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXPauseFrames=ethTXPauseFrames, modemUnavailtime=modemUnavailtime, modemInternalAGCgain=modemInternalAGCgain, modemBackgroundBlockErrror=modemBackgroundBlockErrror, atpcIndex=atpcIndex, modemEthernetCapacity=modemEthernetCapacity, atpcEnabled=atpcEnabled, description=description, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemCountTime=modemCountTime, modemRadialMSE=modemRadialMSE, vlanTable=vlanTable, vlanFid=vlanFid, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemSymbolRateTx=modemSymbolRateTx, modemUptime=modemUptime, modemStandard=modemStandard, licenseMask=licenseMask, localIpMask=localIpMask, radioTable=radioTable, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, vlanPortmap=vlanPortmap, radioIndex=radioIndex, ethRXByteCounterHi=ethRXByteCounterHi, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, aTPCEntry=aTPCEntry, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethGFPDropedFrames=ethGFPDropedFrames, modemAcqStatus=modemAcqStatus, radioTxMute=radioTxMute, ipRadioCfgNetwork=ipRadioCfgNetwork, modemErroredSecond=modemErroredSecond, modemSymbolRateRx=modemSymbolRateRx, e1t1StatTable=e1t1StatTable, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ipRadioStatEth=ipRadioStatEth, ethRXDvEvent=ethRXDvEvent, ethTXCollisions=ethTXCollisions, modemE1T1ChannelMask=modemE1T1ChannelMask, saf=saf, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXBroadcasts=ethTXBroadcasts, licenseUpdateStatus=licenseUpdateStatus, radioTxFrequency=radioTxFrequency, radioEntry=radioEntry, modemModulation=modemModulation, e1t1LOS=e1t1LOS, vlansEnabled=vlansEnabled, radioDuplexShift=radioDuplexShift, ethRXCRCErrors=ethRXCRCErrors, ethTXControlFrames=ethTXControlFrames, ethRXCodeErrors=ethRXCodeErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, localIp=localIp, ethRXByteCounterLow=ethRXByteCounterLow, restartcpu=restartcpu, radioLoopback=radioLoopback, vlanNumber=vlanNumber, ethRXDones=ethRXDones, ethTXVlanTags=ethTXVlanTags, ethTXUnderruns=ethTXUnderruns, modemStatistics=modemStatistics, e1t1AIS=e1t1AIS, loopback_tributary_mask=loopback_tributary_mask, modemLDPCdecoderStress=modemLDPCdecoderStress, remoteIp=remoteIp, ethQOSRXQ1Frames=ethQOSRXQ1Frames, e1t1ChannelNr=e1t1ChannelNr, ethRXPrevPktDropped=ethRXPrevPktDropped, modemTotalBlockNumber=modemTotalBlockNumber, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemRowStatus=modemRowStatus, modemIndex=modemIndex, tehnika=tehnika, modemCarrierOffset=modemCarrierOffset)
