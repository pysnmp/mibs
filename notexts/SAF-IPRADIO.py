...
mibBuilder.exportSymbols("SAF-IPRADIO", microwaveRadio=microwaveRadio, ethRXBroadcasts=ethRXBroadcasts, ethRXCodeErrors=ethRXCodeErrors, ethTXByteCounterHi=ethTXByteCounterHi, product=product, ipRadioCfgNetwork=ipRadioCfgNetwork, tehnika=tehnika, radioTxFrequency=radioTxFrequency, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXMulticasts=ethTXMulticasts, ethRXTruncatedFrames=ethRXTruncatedFrames, e1t1StatTable=e1t1StatTable, radioLoopback=radioLoopback, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemTable=modemTable, modemCarrierOffset=modemCarrierOffset, ethTXLateCollisions=ethTXLateCollisions, modemStandard=modemStandard, ethTXVlanTags=ethTXVlanTags, ethQOSTXDropped=ethQOSTXDropped, radioRxLevel=radioRxLevel, ethTXCollisions=ethTXCollisions, ethGFPDropedFrames=ethGFPDropedFrames, modemE1T1Channels=modemE1T1Channels, modemLastAcqError=modemLastAcqError, ethTXPauseFrames=ethTXPauseFrames, vlanTable=vlanTable, ethTXControlFrames=ethTXControlFrames, ethTXExcessiveDefers=ethTXExcessiveDefers, radioRxFrequency=radioRxFrequency, ipRadioCfg=ipRadioCfg, vlanFid=vlanFid, modemErroredSecondRatio=modemErroredSecondRatio, radioTxMute=radioTxMute, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemEthernetCapacity=modemEthernetCapacity, radioIndex=radioIndex, modemLDPCdecoderStress=modemLDPCdecoderStress, e1t1StatEntry=e1t1StatEntry, localIp=localIp, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXDvEvent=ethRXDvEvent, loopback_tributary_mask=loopback_tributary_mask, ethTXBackpresEvents=ethTXBackpresEvents, ethTXWireByteCounterHi=ethTXWireByteCounterHi, safip=safip, modemACMtotalCapacity=modemACMtotalCapacity, ethRXCRCErrors=ethRXCRCErrors, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXPrevPktDropped=ethRXPrevPktDropped, modemBandwith=modemBandwith, vlanNumber=vlanNumber, radioEntry=radioEntry, ethTXDones=ethTXDones, vlanRowStatus=vlanRowStatus, ipRadioMgmt=ipRadioMgmt, radioTable=radioTable, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXUnderruns=ethTXUnderruns, ethRXMulticasts=ethRXMulticasts, pointToPoint=pointToPoint, remoteIp=remoteIp, modemAcqStatus=modemAcqStatus, ethTXCRCErrors=ethTXCRCErrors, atpcEnabled=atpcEnabled, localIpMask=localIpMask, ethRXControlFrames=ethRXControlFrames, modemInternalAGCgain=modemInternalAGCgain, modemModulation=modemModulation, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXDribleNibbles=ethRXDribleNibbles, aTPCTable=aTPCTable, ethRXDones=ethRXDones, vlansEnabled=vlansEnabled, radioDuplexShift=radioDuplexShift, sysTemperature=sysTemperature, radioSide=radioSide, ethGFPCHECErrors=ethGFPCHECErrors, vlanEntry=vlanEntry, ethGFPFCSErrors=ethGFPFCSErrors, modemCountTime=modemCountTime, license=license, ethRXByteCounterLow=ethRXByteCounterLow, modemErroredSecond=modemErroredSecond, vlanCfgStat=vlanCfgStat, modemErroredBlock=modemErroredBlock, modemTotalCapacity=modemTotalCapacity, modemACMmodulationMax=modemACMmodulationMax, atpcIndex=atpcIndex, radioTxPower=radioTxPower, ipRadio=ipRadio, ethTXGiants=ethTXGiants, aTPCEntry=aTPCEntry, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemEntry=modemEntry, loopbacks=loopbacks, modemIndex=modemIndex, hostname=hostname, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXBroadcasts=ethTXBroadcasts, modemSymbolRateRx=modemSymbolRateRx, atpcTxPowerCorrection=atpcTxPowerCorrection, writeConfig=writeConfig, ipRadioStat=ipRadioStat, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemRadialMSE=modemRadialMSE, restartcpu=restartcpu, ethRXByteCounterHi=ethRXByteCounterHi, ethQOSTXFrames=ethQOSTXFrames, ethRXPauseFrames=ethRXPauseFrames, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemGeneralStatus=modemGeneralStatus, modemTotalBlockNumber=modemTotalBlockNumber, modemACMmodulationMin=modemACMmodulationMin, licenseUpdateStatus=licenseUpdateStatus, e1t1AIS=e1t1AIS, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioGenStatus=radioGenStatus, description=description, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemSymbolRateTx=modemSymbolRateTx, modemACMethernetCapacity=modemACMethernetCapacity, vlanPortmap=vlanPortmap, ipRadioStatEth=ipRadioStatEth, modemRowStatus=modemRowStatus, e1t1ChannelNr=e1t1ChannelNr, sysDateAndTime=sysDateAndTime, e1t1LOS=e1t1LOS, ethRXLongEvents=ethRXLongEvents, modemUnavailtime=modemUnavailtime, ethTXMaxCollisions=ethTXMaxCollisions, vlanPortType=vlanPortType, modemACMengine=modemACMengine, saf=saf, licenseMask=licenseMask, ethTXByteCounterLow=ethTXByteCounterLow, modemUptime=modemUptime, modemStatistics=modemStatistics, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio)
