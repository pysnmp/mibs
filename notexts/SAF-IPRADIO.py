...
mibBuilder.exportSymbols("SAF-IPRADIO", ipRadioCfgNetwork=ipRadioCfgNetwork, atpcEnabled=atpcEnabled, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemGeneralStatus=modemGeneralStatus, ethTXByteCounterLow=ethTXByteCounterLow, localIpMask=localIpMask, ethRXDvEvent=ethRXDvEvent, modemIndex=modemIndex, modemACMmodulationMin=modemACMmodulationMin, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ipRadioMgmt=ipRadioMgmt, aTPCTable=aTPCTable, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemStandard=modemStandard, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemRadialMSE=modemRadialMSE, aTPCEntry=aTPCEntry, ethRXMulticasts=ethRXMulticasts, modemUnavailtime=modemUnavailtime, ethRXVlanTagsDetected=ethRXVlanTagsDetected, saf=saf, atpcIndex=atpcIndex, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, sysTemperature=sysTemperature, modemStatistics=modemStatistics, radioIndex=radioIndex, modemErroredSecondRatio=modemErroredSecondRatio, vlanPortType=vlanPortType, ethRXLongEvents=ethRXLongEvents, licenseUpdateStatus=licenseUpdateStatus, ethTXCollisions=ethTXCollisions, e1t1ChannelNr=e1t1ChannelNr, modemACMmodulationMax=modemACMmodulationMax, ethTXWireByteCounterHi=ethTXWireByteCounterHi, loopback_tributary_mask=loopback_tributary_mask, modemACMtotalCapacity=modemACMtotalCapacity, sysDateAndTime=sysDateAndTime, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXControlFrames=ethRXControlFrames, ethTXLateCollisions=ethTXLateCollisions, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemAcqStatus=modemAcqStatus, modemSymbolRateTx=modemSymbolRateTx, ethRXByteCounterLow=ethRXByteCounterLow, ethGFPCHECErrors=ethGFPCHECErrors, radioEntry=radioEntry, ipRadioStat=ipRadioStat, vlanEntry=vlanEntry, safip=safip, ipRadioCfgGeneral=ipRadioCfgGeneral, vlanCfgStat=vlanCfgStat, ethRXByteCounterHi=ethRXByteCounterHi, ethRXTruncatedFrames=ethRXTruncatedFrames, ipRadio=ipRadio, modemTotalBlockNumber=modemTotalBlockNumber, radioTxMute=radioTxMute, pointToPoint=pointToPoint, modemModulation=modemModulation, ethTXPauseFrames=ethTXPauseFrames, ethTXVlanTags=ethTXVlanTags, tehnika=tehnika, ipRadioCfg=ipRadioCfg, loopbacks=loopbacks, modemErroredSecond=modemErroredSecond, radioLoopback=radioLoopback, ethGFPDropedFrames=ethGFPDropedFrames, license=license, radioTxPower=radioTxPower, modemACMethernetCapacity=modemACMethernetCapacity, vlanFid=vlanFid, modemCountTime=modemCountTime, ethRXBroadcasts=ethRXBroadcasts, modemSymbolRateRx=modemSymbolRateRx, vlanPortmap=vlanPortmap, vlanTable=vlanTable, vlanRowStatus=vlanRowStatus, e1t1StatTable=e1t1StatTable, modemE1T1Channels=modemE1T1Channels, ethRXPauseFrames=ethRXPauseFrames, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXMaxCollisions=ethTXMaxCollisions, writeConfig=writeConfig, e1t1AIS=e1t1AIS, modemUptime=modemUptime, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethGFPFCSErrors=ethGFPFCSErrors, atpcTxPowerCorrection=atpcTxPowerCorrection, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemBandwith=modemBandwith, radioDuplexShift=radioDuplexShift, modemEthernetCapacity=modemEthernetCapacity, vlansEnabled=vlansEnabled, ethGFPDelineationErrors=ethGFPDelineationErrors, localIp=localIp, modemTable=modemTable, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXCRCErrors=ethTXCRCErrors, vlanNumber=vlanNumber, e1t1StatEntry=e1t1StatEntry, ethTXMulticasts=ethTXMulticasts, modemBackgroundBlockErrror=modemBackgroundBlockErrror, restartcpu=restartcpu, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXExcessiveDefers=ethTXExcessiveDefers, ipRadioStatEth=ipRadioStatEth, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXCRCErrors=ethRXCRCErrors, radioGenStatus=radioGenStatus, radioTable=radioTable, modemLDPCdecoderStress=modemLDPCdecoderStress, radioSide=radioSide, modemErroredBlock=modemErroredBlock, modemRowStatus=modemRowStatus, modemInternalAGCgain=modemInternalAGCgain, ethRXCodeErrors=ethRXCodeErrors, radioRxFrequency=radioRxFrequency, modemEntry=modemEntry, ethRXDones=ethRXDones, microwaveRadio=microwaveRadio, modemLastAcqError=modemLastAcqError, ethRXDribleNibbles=ethRXDribleNibbles, licenseMask=licenseMask, e1t1LOS=e1t1LOS, radioRxLevel=radioRxLevel, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXBackpresEvents=ethTXBackpresEvents, hostname=hostname, product=product, modemACMengine=modemACMengine, ethTXUnderruns=ethTXUnderruns, ethTXControlFrames=ethTXControlFrames, ethTXBroadcasts=ethTXBroadcasts, description=description, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, remoteIp=remoteIp, ethTXGiants=ethTXGiants, modemCarrierOffset=modemCarrierOffset, ethRXPrevPktDropped=ethRXPrevPktDropped, ethQOSTXDropped=ethQOSTXDropped, radioTxFrequency=radioTxFrequency, ethTXByteCounterHi=ethTXByteCounterHi, ethQOSTXFrames=ethQOSTXFrames, ethTXDones=ethTXDones, modemTotalCapacity=modemTotalCapacity)
