...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXExcessiveDefers=ethTXExcessiveDefers, modemACMengine=modemACMengine, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXControlFrames=ethRXControlFrames, sysTemperature=sysTemperature, ethTXGiants=ethTXGiants, vlanPortmap=vlanPortmap, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, loopback_tributary_mask=loopback_tributary_mask, radioTable=radioTable, ethTXCRCErrors=ethTXCRCErrors, vlanFid=vlanFid, ethRXDones=ethRXDones, pointToPoint=pointToPoint, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioEntry=radioEntry, ethRXDvEvent=ethRXDvEvent, ethTXBackpresEvents=ethTXBackpresEvents, ethTXLateCollisions=ethTXLateCollisions, modemE1T1ChannelMask=modemE1T1ChannelMask, ipRadioStat=ipRadioStat, ethQOSTXFrames=ethQOSTXFrames, vlanPortType=vlanPortType, loopbacks=loopbacks, modemStatistics=modemStatistics, radioSide=radioSide, product=product, vlansEnabled=vlansEnabled, ethGFPDelineationErrors=ethGFPDelineationErrors, atpcTxPowerCorrection=atpcTxPowerCorrection, modemEntry=modemEntry, modemErroredBlock=modemErroredBlock, ipRadioCfg=ipRadioCfg, radioIndex=radioIndex, ethRXTruncatedFrames=ethRXTruncatedFrames, modemModulation=modemModulation, radioGenStatus=radioGenStatus, ethRXPrevPktDropped=ethRXPrevPktDropped, e1t1AIS=e1t1AIS, ethRXVlanTagsDetected=ethRXVlanTagsDetected, localIpMask=localIpMask, ethGFPCHECErrors=ethGFPCHECErrors, ethRXCRCErrors=ethRXCRCErrors, modemEthernetCapacity=modemEthernetCapacity, e1t1ChannelNr=e1t1ChannelNr, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXBroadcasts=ethTXBroadcasts, atpcEnabled=atpcEnabled, ethTXByteCounterLow=ethTXByteCounterLow, modemErroredSecondRatio=modemErroredSecondRatio, ethTXUnderruns=ethTXUnderruns, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemTable=modemTable, licenseMask=licenseMask, modemCarrierOffset=modemCarrierOffset, ethTXWireByteCounterLow=ethTXWireByteCounterLow, license=license, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemTotalCapacity=modemTotalCapacity, ethTXVlanTags=ethTXVlanTags, ipRadioCfgGeneral=ipRadioCfgGeneral, ipRadioCfgNetwork=ipRadioCfgNetwork, modemRowStatus=modemRowStatus, e1t1LOS=e1t1LOS, saf=saf, radioTxMute=radioTxMute, radioTxFrequency=radioTxFrequency, ethRXBroadcasts=ethRXBroadcasts, modemSymbolRateTx=modemSymbolRateTx, localIp=localIp, vlanCfgStat=vlanCfgStat, e1t1StatEntry=e1t1StatEntry, radioDuplexShift=radioDuplexShift, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ipRadio=ipRadio, remoteIp=remoteIp, tehnika=tehnika, ethTXByteCounterHi=ethTXByteCounterHi, vlanEntry=vlanEntry, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXDones=ethTXDones, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXControlFrames=ethTXControlFrames, modemAcqStatus=modemAcqStatus, modemSymbolRateRx=modemSymbolRateRx, licenseUpdateStatus=licenseUpdateStatus, ethQOSTXDropped=ethQOSTXDropped, microwaveRadio=microwaveRadio, radioLoopback=radioLoopback, e1t1StatTable=e1t1StatTable, modemIndex=modemIndex, ethTXMulticasts=ethTXMulticasts, modemTotalBlockNumber=modemTotalBlockNumber, ethRXPauseFrames=ethRXPauseFrames, restartcpu=restartcpu, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemUnavailtime=modemUnavailtime, modemUptime=modemUptime, modemACMtotalCapacity=modemACMtotalCapacity, modemLDPCdecoderStress=modemLDPCdecoderStress, vlanRowStatus=vlanRowStatus, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemGeneralStatus=modemGeneralStatus, modemACMethernetCapacity=modemACMethernetCapacity, vlanTable=vlanTable, modemE1T1Channels=modemE1T1Channels, ethRXLongEvents=ethRXLongEvents, modemStandard=modemStandard, modemErroredSecond=modemErroredSecond, modemRadialMSE=modemRadialMSE, aTPCTable=aTPCTable, safip=safip, description=description, ethRXMulticasts=ethRXMulticasts, modemLastAcqError=modemLastAcqError, radioRxLevel=radioRxLevel, sysDateAndTime=sysDateAndTime, radioTxPower=radioTxPower, ethRXByteCounterHi=ethRXByteCounterHi, ethTXMaxCollisions=ethTXMaxCollisions, ethGFPFCSErrors=ethGFPFCSErrors, ethRXByteCounterLow=ethRXByteCounterLow, hostname=hostname, modemInternalAGCgain=modemInternalAGCgain, modemBandwith=modemBandwith, ipRadioStatEth=ipRadioStatEth, radioRxFrequency=radioRxFrequency, modemACMmodulationMin=modemACMmodulationMin, modemACMmodulationMax=modemACMmodulationMax, ethRXCodeErrors=ethRXCodeErrors, ethTXCollisions=ethTXCollisions, vlanNumber=vlanNumber, ipRadioMgmt=ipRadioMgmt, atpcIndex=atpcIndex, aTPCEntry=aTPCEntry, ethRXDribleNibbles=ethRXDribleNibbles, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethGFPDropedFrames=ethGFPDropedFrames, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemCountTime=modemCountTime, ethTXPauseFrames=ethTXPauseFrames, writeConfig=writeConfig)
