...
mibBuilder.exportSymbols("SAF-IPRADIO", modemEntry=modemEntry, modemModulation=modemModulation, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, aTPCTable=aTPCTable, sysDateAndTime=sysDateAndTime, modemUnavailtime=modemUnavailtime, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXWireByteCounterHi=ethTXWireByteCounterHi, description=description, radioTxMute=radioTxMute, ethRXDvEvent=ethRXDvEvent, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXLongEvents=ethRXLongEvents, ethRXCRCErrors=ethRXCRCErrors, ethRXDribleNibbles=ethRXDribleNibbles, modemSymbolRateTx=modemSymbolRateTx, tehnika=tehnika, ethRXByteCounterHi=ethRXByteCounterHi, modemE1T1Channels=modemE1T1Channels, radioIndex=radioIndex, radioEntry=radioEntry, licenseUpdateStatus=licenseUpdateStatus, atpcTxPowerCorrection=atpcTxPowerCorrection, localIpMask=localIpMask, ethRXMulticasts=ethRXMulticasts, ipRadioCfgNetwork=ipRadioCfgNetwork, radioSide=radioSide, ethRXDones=ethRXDones, ethTXBackpresEvents=ethTXBackpresEvents, radioTable=radioTable, ethTXByteCounterHi=ethTXByteCounterHi, modemIndex=modemIndex, ethGFPFCSErrors=ethGFPFCSErrors, radioRxLevel=radioRxLevel, saf=saf, modemACMmodulationMin=modemACMmodulationMin, ethTXLengthCheckErrors=ethTXLengthCheckErrors, radioRxFrequency=radioRxFrequency, ethGFPCHECErrors=ethGFPCHECErrors, ipRadioCfgGeneral=ipRadioCfgGeneral, vlanPortmap=vlanPortmap, ethTXGiants=ethTXGiants, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemStatistics=modemStatistics, ethQOSTXFrames=ethQOSTXFrames, ethTXLateCollisions=ethTXLateCollisions, modemACMtotalCapacity=modemACMtotalCapacity, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, aTPCEntry=aTPCEntry, ethTXVlanTags=ethTXVlanTags, ethTXUnderruns=ethTXUnderruns, ipRadioStat=ipRadioStat, modemErroredBlock=modemErroredBlock, vlanEntry=vlanEntry, ethTXByteCounterLow=ethTXByteCounterLow, e1t1StatTable=e1t1StatTable, modemErroredSecondRatio=modemErroredSecondRatio, modemInternalAGCgain=modemInternalAGCgain, radioTxPower=radioTxPower, radioTxFrequency=radioTxFrequency, loopbacks=loopbacks, modemGeneralStatus=modemGeneralStatus, vlanRowStatus=vlanRowStatus, vlanNumber=vlanNumber, modemUptime=modemUptime, ethRXUnsupOpcodes=ethRXUnsupOpcodes, e1t1ChannelNr=e1t1ChannelNr, ethRXPrevPktDropped=ethRXPrevPktDropped, safip=safip, modemBandwith=modemBandwith, ethGFPDropedFrames=ethGFPDropedFrames, modemE1T1ChannelMask=modemE1T1ChannelMask, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemACMethernetCapacity=modemACMethernetCapacity, licenseMask=licenseMask, ethQOSTXDropped=ethQOSTXDropped, ipRadioMgmt=ipRadioMgmt, license=license, writeConfig=writeConfig, vlansEnabled=vlansEnabled, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXControlFrames=ethRXControlFrames, ethTXControlFrames=ethTXControlFrames, modemACMmodulationMax=modemACMmodulationMax, vlanCfgStat=vlanCfgStat, loopback_tributary_mask=loopback_tributary_mask, ethTXBroadcasts=ethTXBroadcasts, localIp=localIp, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemCarrierOffset=modemCarrierOffset, remoteIp=remoteIp, modemSymbolRateRx=modemSymbolRateRx, modemTotalBlockNumber=modemTotalBlockNumber, vlanFid=vlanFid, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemRadialMSE=modemRadialMSE, modemStandard=modemStandard, modemCountTime=modemCountTime, vlanTable=vlanTable, ethRXPauseFrames=ethRXPauseFrames, modemTotalCapacity=modemTotalCapacity, ipRadioCfg=ipRadioCfg, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, e1t1AIS=e1t1AIS, ethRXByteCounterLow=ethRXByteCounterLow, ethTXDones=ethTXDones, modemAcqStatus=modemAcqStatus, ethTXMaxCollisions=ethTXMaxCollisions, ipRadio=ipRadio, e1t1StatEntry=e1t1StatEntry, ethTXCRCErrors=ethTXCRCErrors, modemTable=modemTable, pointToPoint=pointToPoint, modemRowStatus=modemRowStatus, restartcpu=restartcpu, modemErroredSecond=modemErroredSecond, ethRXCodeErrors=ethRXCodeErrors, atpcEnabled=atpcEnabled, radioDuplexShift=radioDuplexShift, product=product, ethTXPauseFrames=ethTXPauseFrames, modemACMengine=modemACMengine, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXCollisions=ethTXCollisions, sysTemperature=sysTemperature, modemLastAcqError=modemLastAcqError, ipRadioStatEth=ipRadioStatEth, radioLoopback=radioLoopback, e1t1LOS=e1t1LOS, hostname=hostname, microwaveRadio=microwaveRadio, vlanPortType=vlanPortType, ethTXMulticasts=ethTXMulticasts, ethQOSRXQ1Frames=ethQOSRXQ1Frames, atpcIndex=atpcIndex, modemEthernetCapacity=modemEthernetCapacity, ethRXBroadcasts=ethRXBroadcasts, radioGenStatus=radioGenStatus)
