...
mibBuilder.exportSymbols("SAF-IPRADIO", modemModulation=modemModulation, ethRXPrevPktDropped=ethRXPrevPktDropped, ethGFPDropedFrames=ethGFPDropedFrames, atpcIndex=atpcIndex, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioTxFrequency=radioTxFrequency, modemAcqStatus=modemAcqStatus, ethTXVlanTags=ethTXVlanTags, ethGFPFCSErrors=ethGFPFCSErrors, e1t1StatEntry=e1t1StatEntry, ethRXBroadcasts=ethRXBroadcasts, ethTXPauseFrames=ethTXPauseFrames, vlanFid=vlanFid, saf=saf, modemBandwith=modemBandwith, product=product, vlanTable=vlanTable, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXControlFrames=ethRXControlFrames, modemACMmodulationMin=modemACMmodulationMin, ethTXBroadcasts=ethTXBroadcasts, radioLoopback=radioLoopback, sysTemperature=sysTemperature, modemACMethernetCapacity=modemACMethernetCapacity, vlanCfgStat=vlanCfgStat, ipRadioCfgGeneral=ipRadioCfgGeneral, ipRadioCfg=ipRadioCfg, modemE1T1Channels=modemE1T1Channels, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXDones=ethRXDones, modemErroredSecond=modemErroredSecond, ethTXExcessiveDefers=ethTXExcessiveDefers, radioTxPower=radioTxPower, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemStandard=modemStandard, modemTotalBlockNumber=modemTotalBlockNumber, ethTXCollisions=ethTXCollisions, radioRxLevel=radioRxLevel, radioTxMute=radioTxMute, loopbacks=loopbacks, aTPCTable=aTPCTable, radioIndex=radioIndex, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemInternalAGCgain=modemInternalAGCgain, ethTXMulticasts=ethTXMulticasts, radioSide=radioSide, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, aTPCEntry=aTPCEntry, vlanEntry=vlanEntry, ethTXControlFrames=ethTXControlFrames, modemLDPCdecoderStress=modemLDPCdecoderStress, modemTable=modemTable, modemErroredSecondRatio=modemErroredSecondRatio, modemTotalCapacity=modemTotalCapacity, modemRowStatus=modemRowStatus, modemEntry=modemEntry, modemCountTime=modemCountTime, ipRadio=ipRadio, radioGenStatus=radioGenStatus, modemLastAcqError=modemLastAcqError, ethTXByteCounterHi=ethTXByteCounterHi, ipRadioStat=ipRadioStat, radioEntry=radioEntry, atpcEnabled=atpcEnabled, modemUptime=modemUptime, ethQOSRXQ1Frames=ethQOSRXQ1Frames, e1t1ChannelNr=e1t1ChannelNr, ethRXMulticasts=ethRXMulticasts, ethRXPauseFrames=ethRXPauseFrames, ethRXByteCounterLow=ethRXByteCounterLow, modemE1T1ChannelMask=modemE1T1ChannelMask, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlanPortType=vlanPortType, ethGFPDelineationErrors=ethGFPDelineationErrors, loopback_tributary_mask=loopback_tributary_mask, modemIndex=modemIndex, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioDuplexShift=radioDuplexShift, modemACMengine=modemACMengine, atpcTxPowerCorrection=atpcTxPowerCorrection, localIpMask=localIpMask, e1t1AIS=e1t1AIS, vlanNumber=vlanNumber, hostname=hostname, pointToPoint=pointToPoint, restartcpu=restartcpu, remoteIp=remoteIp, ethRXDvEvent=ethRXDvEvent, ethRXDribleNibbles=ethRXDribleNibbles, microwaveRadio=microwaveRadio, modemSymbolRateTx=modemSymbolRateTx, modemACMmodulationMax=modemACMmodulationMax, modemEthernetCapacity=modemEthernetCapacity, sysDateAndTime=sysDateAndTime, ethRXLongEvents=ethRXLongEvents, ethTXLateCollisions=ethTXLateCollisions, ethTXBackpresEvents=ethTXBackpresEvents, modemUnavailtime=modemUnavailtime, vlanRowStatus=vlanRowStatus, modemStatistics=modemStatistics, description=description, ethTXDones=ethTXDones, ethQOSTXFrames=ethQOSTXFrames, ethRXByteCounterHi=ethRXByteCounterHi, e1t1StatTable=e1t1StatTable, radioRxFrequency=radioRxFrequency, ethTXMaxCollisions=ethTXMaxCollisions, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXTruncatedFrames=ethRXTruncatedFrames, vlanPortmap=vlanPortmap, ethRXCRCErrors=ethRXCRCErrors, modemRadialMSE=modemRadialMSE, ethQOSTXDropped=ethQOSTXDropped, safip=safip, ipRadioMgmt=ipRadioMgmt, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXUnderruns=ethTXUnderruns, writeConfig=writeConfig, ethTXCRCErrors=ethTXCRCErrors, modemACMtotalCapacity=modemACMtotalCapacity, tehnika=tehnika, licenseMask=licenseMask, localIp=localIp, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemErroredBlock=modemErroredBlock, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethGFPCHECErrors=ethGFPCHECErrors, ethRXCodeErrors=ethRXCodeErrors, vlansEnabled=vlansEnabled, licenseUpdateStatus=licenseUpdateStatus, modemGeneralStatus=modemGeneralStatus, ipRadioStatEth=ipRadioStatEth, radioTable=radioTable, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXByteCounterLow=ethTXByteCounterLow, license=license, modemSymbolRateRx=modemSymbolRateRx, modemBackgroundBlockErrror=modemBackgroundBlockErrror, e1t1LOS=e1t1LOS, ethTXGiants=ethTXGiants, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemCarrierOffset=modemCarrierOffset)
