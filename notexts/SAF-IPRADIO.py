...
mibBuilder.exportSymbols("SAF-IPRADIO", modemTable=modemTable, vlanRowStatus=vlanRowStatus, modemStatistics=modemStatistics, modemTotalBlockNumber=modemTotalBlockNumber, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemCountTime=modemCountTime, ethGFPFCSErrors=ethGFPFCSErrors, e1t1AIS=e1t1AIS, loopbacks=loopbacks, atpcIndex=atpcIndex, e1t1StatEntry=e1t1StatEntry, modemErroredSecond=modemErroredSecond, microwaveRadio=microwaveRadio, vlanNumber=vlanNumber, ethGFPCHECErrors=ethGFPCHECErrors, ethTXCRCErrors=ethTXCRCErrors, modemEntry=modemEntry, ethTXDones=ethTXDones, ethTXPauseFrames=ethTXPauseFrames, loopback_tributary_mask=loopback_tributary_mask, vlanTable=vlanTable, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethQOSTXFrames=ethQOSTXFrames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemErroredBlock=modemErroredBlock, modemACMmodulationMax=modemACMmodulationMax, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXByteCounterHi=ethRXByteCounterHi, ethRXByteCounterLow=ethRXByteCounterLow, ethTXMaxCollisions=ethTXMaxCollisions, modemInternalAGCgain=modemInternalAGCgain, tehnika=tehnika, vlanCfgStat=vlanCfgStat, ethRXMulticasts=ethRXMulticasts, radioGenStatus=radioGenStatus, radioTxMute=radioTxMute, vlansEnabled=vlansEnabled, modemBandwith=modemBandwith, ethRXControlFrames=ethRXControlFrames, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemIndex=modemIndex, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXCRCErrors=ethRXCRCErrors, vlanFid=vlanFid, atpcTxPowerCorrection=atpcTxPowerCorrection, e1t1StatTable=e1t1StatTable, radioTable=radioTable, modemAcqStatus=modemAcqStatus, localIp=localIp, ethRXDones=ethRXDones, radioTxFrequency=radioTxFrequency, description=description, modemACMethernetCapacity=modemACMethernetCapacity, ethRXBroadcasts=ethRXBroadcasts, modemACMtotalCapacity=modemACMtotalCapacity, vlanPortType=vlanPortType, e1t1LOS=e1t1LOS, e1t1ChannelNr=e1t1ChannelNr, ipRadio=ipRadio, pointToPoint=pointToPoint, licenseMask=licenseMask, modemErroredSecondRatio=modemErroredSecondRatio, aTPCTable=aTPCTable, ethRXLongEvents=ethRXLongEvents, modemGeneralStatus=modemGeneralStatus, restartcpu=restartcpu, safip=safip, radioRxLevel=radioRxLevel, radioEntry=radioEntry, product=product, modemEthernetCapacity=modemEthernetCapacity, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemE1T1Channels=modemE1T1Channels, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemStandard=modemStandard, writeConfig=writeConfig, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXLateCollisions=ethTXLateCollisions, ethGFPDelineationErrors=ethGFPDelineationErrors, modemACMmodulationMin=modemACMmodulationMin, ethRXDvEvent=ethRXDvEvent, ethTXUnderruns=ethTXUnderruns, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemLastAcqError=modemLastAcqError, radioRxFrequency=radioRxFrequency, radioDuplexShift=radioDuplexShift, ethRXCodeErrors=ethRXCodeErrors, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXVlanTags=ethTXVlanTags, modemUnavailtime=modemUnavailtime, ipRadioStat=ipRadioStat, ipRadioStatEth=ipRadioStatEth, ethTXBackpresEvents=ethTXBackpresEvents, radioIndex=radioIndex, ethRXPauseFrames=ethRXPauseFrames, saf=saf, modemSymbolRateTx=modemSymbolRateTx, ethTXBroadcasts=ethTXBroadcasts, aTPCEntry=aTPCEntry, ethTXByteCounterLow=ethTXByteCounterLow, ethTXByteCounterHi=ethTXByteCounterHi, ethRXTruncatedFrames=ethRXTruncatedFrames, modemModulation=modemModulation, ipRadioMgmt=ipRadioMgmt, radioTxPower=radioTxPower, radioSide=radioSide, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, licenseUpdateStatus=licenseUpdateStatus, modemCarrierOffset=modemCarrierOffset, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioLoopback=radioLoopback, vlanEntry=vlanEntry, ethGFPDropedFrames=ethGFPDropedFrames, sysTemperature=sysTemperature, ethTXMulticasts=ethTXMulticasts, sysDateAndTime=sysDateAndTime, license=license, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemACMengine=modemACMengine, ethRXVlanTagsDetected=ethRXVlanTagsDetected, hostname=hostname, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemRadialMSE=modemRadialMSE, modemTotalCapacity=modemTotalCapacity, localIpMask=localIpMask, ipRadioCfg=ipRadioCfg, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXGiants=ethTXGiants, modemUptime=modemUptime, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethQOSTXDropped=ethQOSTXDropped, remoteIp=remoteIp, modemRowStatus=modemRowStatus, vlanPortmap=vlanPortmap, atpcEnabled=atpcEnabled, modemSymbolRateRx=modemSymbolRateRx, ethTXControlFrames=ethTXControlFrames, ethTXCollisions=ethTXCollisions, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXDribleNibbles=ethRXDribleNibbles)
