...
mibBuilder.exportSymbols("SAF-IPRADIO", radioTable=radioTable, licenseMask=licenseMask, radioGenStatus=radioGenStatus, modemTable=modemTable, radioIndex=radioIndex, loopback_tributary_mask=loopback_tributary_mask, modemBandwith=modemBandwith, vlanNumber=vlanNumber, vlanTable=vlanTable, sysDateAndTime=sysDateAndTime, saf=saf, ethTXLateCollisions=ethTXLateCollisions, ethGFPFCSErrors=ethGFPFCSErrors, ipRadioStat=ipRadioStat, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXCRCErrors=ethRXCRCErrors, safip=safip, aTPCEntry=aTPCEntry, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, tehnika=tehnika, ethTXWireByteCounterHi=ethTXWireByteCounterHi, vlanFid=vlanFid, pointToPoint=pointToPoint, localIp=localIp, modemCarrierOffset=modemCarrierOffset, ethTXPauseFrames=ethTXPauseFrames, radioTxPower=radioTxPower, ethTXVlanTags=ethTXVlanTags, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemACMethernetCapacity=modemACMethernetCapacity, ethTXControlFrames=ethTXControlFrames, ethRXByteCounterHi=ethRXByteCounterHi, ethTXDones=ethTXDones, loopbacks=loopbacks, ethRXBroadcasts=ethRXBroadcasts, ipRadioMgmt=ipRadioMgmt, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXByteCounterLow=ethTXByteCounterLow, vlansEnabled=vlansEnabled, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemE1T1Channels=modemE1T1Channels, modemIndex=modemIndex, ipRadioCfgGeneral=ipRadioCfgGeneral, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXControlFrames=ethRXControlFrames, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, localIpMask=localIpMask, modemModulation=modemModulation, modemCountTime=modemCountTime, modemACMmodulationMin=modemACMmodulationMin, radioEntry=radioEntry, modemTotalBlockNumber=modemTotalBlockNumber, writeConfig=writeConfig, e1t1ChannelNr=e1t1ChannelNr, ethTXByteCounterHi=ethTXByteCounterHi, ethGFPDropedFrames=ethGFPDropedFrames, ethRXDones=ethRXDones, e1t1AIS=e1t1AIS, vlanPortType=vlanPortType, ethRXTruncatedFrames=ethRXTruncatedFrames, e1t1StatEntry=e1t1StatEntry, ethQOSTXFrames=ethQOSTXFrames, vlanPortmap=vlanPortmap, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemE1T1ChannelMask=modemE1T1ChannelMask, microwaveRadio=microwaveRadio, ethTXMulticasts=ethTXMulticasts, radioRxFrequency=radioRxFrequency, ethRXPauseFrames=ethRXPauseFrames, ethTXGiants=ethTXGiants, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemUnavailtime=modemUnavailtime, atpcEnabled=atpcEnabled, sysTemperature=sysTemperature, ethTXBackpresEvents=ethTXBackpresEvents, ethRXCodeErrors=ethRXCodeErrors, restartcpu=restartcpu, ethTXCollisions=ethTXCollisions, modemUptime=modemUptime, atpcIndex=atpcIndex, modemStatistics=modemStatistics, ethRXByteCounterLow=ethRXByteCounterLow, modemAcqStatus=modemAcqStatus, description=description, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemSymbolRateRx=modemSymbolRateRx, modemACMmodulationMax=modemACMmodulationMax, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ipRadioStatEth=ipRadioStatEth, modemGeneralStatus=modemGeneralStatus, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXExcessiveDefers=ethTXExcessiveDefers, remoteIp=remoteIp, radioSide=radioSide, modemTotalCapacity=modemTotalCapacity, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemEntry=modemEntry, ethTXBroadcasts=ethTXBroadcasts, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemACMengine=modemACMengine, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXCRCErrors=ethTXCRCErrors, modemInternalAGCgain=modemInternalAGCgain, ethRXPrevPktDropped=ethRXPrevPktDropped, modemLastAcqError=modemLastAcqError, modemRadialMSE=modemRadialMSE, modemACMtotalCapacity=modemACMtotalCapacity, ethTXUnderruns=ethTXUnderruns, modemErroredBlock=modemErroredBlock, modemEthernetCapacity=modemEthernetCapacity, modemErroredSecond=modemErroredSecond, ipRadioCfg=ipRadioCfg, license=license, ethRXDribleNibbles=ethRXDribleNibbles, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioTxMute=radioTxMute, e1t1LOS=e1t1LOS, vlanEntry=vlanEntry, vlanCfgStat=vlanCfgStat, ethGFPCHECErrors=ethGFPCHECErrors, radioDuplexShift=radioDuplexShift, product=product, licenseUpdateStatus=licenseUpdateStatus, ethRXDvEvent=ethRXDvEvent, e1t1StatTable=e1t1StatTable, ethRXLongEvents=ethRXLongEvents, radioLoopback=radioLoopback, radioTxFrequency=radioTxFrequency, modemErroredSecondRatio=modemErroredSecondRatio, aTPCTable=aTPCTable, modemStandard=modemStandard, ethQOSTXDropped=ethQOSTXDropped, vlanRowStatus=vlanRowStatus, hostname=hostname, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXMulticasts=ethRXMulticasts, radioRxLevel=radioRxLevel, ipRadio=ipRadio, modemRowStatus=modemRowStatus, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXMaxCollisions=ethTXMaxCollisions, modemSymbolRateTx=modemSymbolRateTx)
