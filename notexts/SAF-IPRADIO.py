...
mibBuilder.exportSymbols("SAF-IPRADIO", vlanCfgStat=vlanCfgStat, radioDuplexShift=radioDuplexShift, modemCountTime=modemCountTime, modemEntry=modemEntry, tehnika=tehnika, saf=saf, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethQOSTXFrames=ethQOSTXFrames, licenseMask=licenseMask, localIp=localIp, ethTXBackpresEvents=ethTXBackpresEvents, atpcIndex=atpcIndex, ethRXBroadcasts=ethRXBroadcasts, sysDateAndTime=sysDateAndTime, atpcTxPowerCorrection=atpcTxPowerCorrection, modemBandwith=modemBandwith, ipRadioStat=ipRadioStat, vlanPortType=vlanPortType, vlanNumber=vlanNumber, ethTXMaxCollisions=ethTXMaxCollisions, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXByteCounterHi=ethTXByteCounterHi, modemTable=modemTable, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXByteCounterLow=ethTXByteCounterLow, ipRadioCfgGeneral=ipRadioCfgGeneral, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethQOSTXDropped=ethQOSTXDropped, modemE1T1ChannelMask=modemE1T1ChannelMask, modemAcqStatus=modemAcqStatus, ethTXGiants=ethTXGiants, ipRadioStatEth=ipRadioStatEth, modemStandard=modemStandard, ethRXDones=ethRXDones, modemUnavailtime=modemUnavailtime, e1t1AIS=e1t1AIS, modemUptime=modemUptime, aTPCEntry=aTPCEntry, ethRXDvEvent=ethRXDvEvent, microwaveRadio=microwaveRadio, ipRadioMgmt=ipRadioMgmt, ethTXUnderruns=ethTXUnderruns, radioIndex=radioIndex, modemACMengine=modemACMengine, safip=safip, e1t1StatEntry=e1t1StatEntry, ethRXCRCErrors=ethRXCRCErrors, vlansEnabled=vlansEnabled, ethRXLongEvents=ethRXLongEvents, modemACMmodulationMax=modemACMmodulationMax, radioTable=radioTable, ethTXPauseFrames=ethTXPauseFrames, restartcpu=restartcpu, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, localIpMask=localIpMask, modemRowStatus=modemRowStatus, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemE1T1Channels=modemE1T1Channels, ethTXVlanTags=ethTXVlanTags, modemIndex=modemIndex, description=description, radioSide=radioSide, modemErroredBlock=modemErroredBlock, ethTXCRCErrors=ethTXCRCErrors, modemModulation=modemModulation, remoteIp=remoteIp, ethQOSRXQ2Frames=ethQOSRXQ2Frames, loopback_tributary_mask=loopback_tributary_mask, ethGFPDropedFrames=ethGFPDropedFrames, sysTemperature=sysTemperature, product=product, ethTXCollisions=ethTXCollisions, modemLDPCdecoderStress=modemLDPCdecoderStress, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioLoopback=radioLoopback, license=license, modemInternalAGCgain=modemInternalAGCgain, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXMulticasts=ethTXMulticasts, e1t1ChannelNr=e1t1ChannelNr, e1t1LOS=e1t1LOS, ethGFPFCSErrors=ethGFPFCSErrors, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXPauseFrames=ethRXPauseFrames, vlanEntry=vlanEntry, ethTXDones=ethTXDones, modemTotalBlockNumber=modemTotalBlockNumber, modemStatistics=modemStatistics, modemEthernetCapacity=modemEthernetCapacity, ethGFPDelineationErrors=ethGFPDelineationErrors, modemErroredSecond=modemErroredSecond, modemSymbolRateTx=modemSymbolRateTx, ethRXDribleNibbles=ethRXDribleNibbles, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXByteCounterLow=ethRXByteCounterLow, radioTxFrequency=radioTxFrequency, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemACMethernetCapacity=modemACMethernetCapacity, loopbacks=loopbacks, atpcEnabled=atpcEnabled, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, e1t1StatTable=e1t1StatTable, radioGenStatus=radioGenStatus, vlanRowStatus=vlanRowStatus, aTPCTable=aTPCTable, ipRadio=ipRadio, radioTxMute=radioTxMute, ethGFPCHECErrors=ethGFPCHECErrors, modemRadialMSE=modemRadialMSE, hostname=hostname, modemSymbolRateRx=modemSymbolRateRx, radioEntry=radioEntry, vlanTable=vlanTable, licenseUpdateStatus=licenseUpdateStatus, ethRXTruncatedFrames=ethRXTruncatedFrames, modemLastAcqError=modemLastAcqError, radioTxPower=radioTxPower, modemTotalCapacity=modemTotalCapacity, vlanPortmap=vlanPortmap, ethTXExcessiveDefers=ethTXExcessiveDefers, modemCarrierOffset=modemCarrierOffset, radioRxLevel=radioRxLevel, ipRadioCfg=ipRadioCfg, vlanFid=vlanFid, modemACMtotalCapacity=modemACMtotalCapacity, modemErroredSecondRatio=modemErroredSecondRatio, pointToPoint=pointToPoint, ethTXLateCollisions=ethTXLateCollisions, ethRXControlFrames=ethRXControlFrames, ipRadioCfgNetwork=ipRadioCfgNetwork, writeConfig=writeConfig, ethRXMulticasts=ethRXMulticasts, ethTXControlFrames=ethTXControlFrames, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXCodeErrors=ethRXCodeErrors, ethRXByteCounterHi=ethRXByteCounterHi, ethTXBroadcasts=ethTXBroadcasts, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemACMmodulationMin=modemACMmodulationMin, modemGeneralStatus=modemGeneralStatus, radioRxFrequency=radioRxFrequency)
