...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXCodeErrors=ethRXCodeErrors, pointToPoint=pointToPoint, e1t1ChannelNr=e1t1ChannelNr, e1t1AIS=e1t1AIS, ipRadioCfgGeneral=ipRadioCfgGeneral, modemACMmodulationMin=modemACMmodulationMin, ipRadioCfg=ipRadioCfg, e1t1StatEntry=e1t1StatEntry, modemStatistics=modemStatistics, ethGFPDropedFrames=ethGFPDropedFrames, modemACMtotalCapacity=modemACMtotalCapacity, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, atpcEnabled=atpcEnabled, writeConfig=writeConfig, ethRXByteCounterLow=ethRXByteCounterLow, ethRXControlFrames=ethRXControlFrames, localIpMask=localIpMask, loopbacks=loopbacks, licenseUpdateStatus=licenseUpdateStatus, ethTXCollisions=ethTXCollisions, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemACMengine=modemACMengine, ethRXLongEvents=ethRXLongEvents, vlanTable=vlanTable, modemUnavailtime=modemUnavailtime, modemCarrierOffset=modemCarrierOffset, remoteIp=remoteIp, radioSide=radioSide, ethTXByteCounterLow=ethTXByteCounterLow, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, loopback_tributary_mask=loopback_tributary_mask, ethTXMaxCollisions=ethTXMaxCollisions, ethRXDvEvent=ethRXDvEvent, vlanPortmap=vlanPortmap, ethGFPCHECErrors=ethGFPCHECErrors, modemE1T1ChannelMask=modemE1T1ChannelMask, ethGFPFCSErrors=ethGFPFCSErrors, ethRXDones=ethRXDones, microwaveRadio=microwaveRadio, modemEthernetCapacity=modemEthernetCapacity, ethRXCRCErrors=ethRXCRCErrors, modemErroredSecond=modemErroredSecond, modemE1T1Channels=modemE1T1Channels, radioRxLevel=radioRxLevel, modemTotalCapacity=modemTotalCapacity, vlansEnabled=vlansEnabled, ethQOSTXFrames=ethQOSTXFrames, ethRXPauseFrames=ethRXPauseFrames, ipRadio=ipRadio, ethGFPDelineationErrors=ethGFPDelineationErrors, modemTotalBlockNumber=modemTotalBlockNumber, hostname=hostname, modemIndex=modemIndex, ethTXGiants=ethTXGiants, ethTXBroadcasts=ethTXBroadcasts, safip=safip, ethTXDones=ethTXDones, localIp=localIp, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXWireByteCounterHi=ethTXWireByteCounterHi, vlanPortType=vlanPortType, modemACMmodulationMax=modemACMmodulationMax, ethTXBackpresEvents=ethTXBackpresEvents, aTPCTable=aTPCTable, vlanCfgStat=vlanCfgStat, modemErroredBlock=modemErroredBlock, saf=saf, radioDuplexShift=radioDuplexShift, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXPrevPktDropped=ethRXPrevPktDropped, e1t1StatTable=e1t1StatTable, radioTxMute=radioTxMute, modemRowStatus=modemRowStatus, modemGeneralStatus=modemGeneralStatus, ipRadioMgmt=ipRadioMgmt, radioTable=radioTable, radioTxPower=radioTxPower, vlanRowStatus=vlanRowStatus, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioEntry=radioEntry, ethTXVlanTags=ethTXVlanTags, tehnika=tehnika, license=license, modemTable=modemTable, modemModulation=modemModulation, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioGenStatus=radioGenStatus, radioIndex=radioIndex, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXByteCounterHi=ethRXByteCounterHi, restartcpu=restartcpu, ethTXByteCounterHi=ethTXByteCounterHi, description=description, modemLDPCdecoderStress=modemLDPCdecoderStress, modemLastAcqError=modemLastAcqError, licenseMask=licenseMask, modemUptime=modemUptime, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXDribleNibbles=ethRXDribleNibbles, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioRxFrequency=radioRxFrequency, modemSymbolRateRx=modemSymbolRateRx, vlanEntry=vlanEntry, aTPCEntry=aTPCEntry, ipRadioCfgNetwork=ipRadioCfgNetwork, vlanNumber=vlanNumber, sysTemperature=sysTemperature, ethTXCRCErrors=ethTXCRCErrors, modemStandard=modemStandard, ethTXPauseFrames=ethTXPauseFrames, ethTXExcessiveDefers=ethTXExcessiveDefers, modemRadialMSE=modemRadialMSE, sysDateAndTime=sysDateAndTime, modemAcqStatus=modemAcqStatus, atpcTxPowerCorrection=atpcTxPowerCorrection, modemErroredSecondRatio=modemErroredSecondRatio, vlanFid=vlanFid, atpcIndex=atpcIndex, modemEntry=modemEntry, ipRadioStat=ipRadioStat, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXLateCollisions=ethTXLateCollisions, e1t1LOS=e1t1LOS, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ipRadioStatEth=ipRadioStatEth, ethRXMulticasts=ethRXMulticasts, modemInternalAGCgain=modemInternalAGCgain, ethTXControlFrames=ethTXControlFrames, modemBandwith=modemBandwith, modemCountTime=modemCountTime, ethTXMulticasts=ethTXMulticasts, product=product, ethTXUnderruns=ethTXUnderruns, modemACMethernetCapacity=modemACMethernetCapacity, modemSymbolRateTx=modemSymbolRateTx, ethRXBroadcasts=ethRXBroadcasts, radioLoopback=radioLoopback, ethQOSTXDropped=ethQOSTXDropped, radioTxFrequency=radioTxFrequency)
