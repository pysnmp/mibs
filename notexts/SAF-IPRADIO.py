...
mibBuilder.exportSymbols("SAF-IPRADIO", vlanPortType=vlanPortType, modemBandwith=modemBandwith, license=license, vlanFid=vlanFid, modemUnavailtime=modemUnavailtime, ethTXControlFrames=ethTXControlFrames, restartcpu=restartcpu, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethQOSTXDropped=ethQOSTXDropped, microwaveRadio=microwaveRadio, modemACMengine=modemACMengine, ethRXPrevPktDropped=ethRXPrevPktDropped, ipRadioMgmt=ipRadioMgmt, radioEntry=radioEntry, localIpMask=localIpMask, e1t1AIS=e1t1AIS, radioDuplexShift=radioDuplexShift, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXMulticasts=ethTXMulticasts, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, e1t1StatEntry=e1t1StatEntry, ethTXMaxCollisions=ethTXMaxCollisions, modemACMmodulationMax=modemACMmodulationMax, safip=safip, modemErroredSecondRatio=modemErroredSecondRatio, modemTotalCapacity=modemTotalCapacity, radioTxFrequency=radioTxFrequency, modemE1T1Channels=modemE1T1Channels, ethRXLongEvents=ethRXLongEvents, ipRadioStatEth=ipRadioStatEth, ethTXVlanTags=ethTXVlanTags, vlanPortmap=vlanPortmap, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXMulticasts=ethRXMulticasts, ipRadioStat=ipRadioStat, ethTXCRCErrors=ethTXCRCErrors, radioGenStatus=radioGenStatus, ethRXCodeErrors=ethRXCodeErrors, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemACMtotalCapacity=modemACMtotalCapacity, radioTxMute=radioTxMute, ethGFPDropedFrames=ethGFPDropedFrames, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemEntry=modemEntry, pointToPoint=pointToPoint, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemRadialMSE=modemRadialMSE, hostname=hostname, ethRXByteCounterHi=ethRXByteCounterHi, ethRXBroadcasts=ethRXBroadcasts, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemUptime=modemUptime, ethRXDones=ethRXDones, ethTXBackpresEvents=ethTXBackpresEvents, e1t1LOS=e1t1LOS, modemCarrierOffset=modemCarrierOffset, ethRXDribleNibbles=ethRXDribleNibbles, tehnika=tehnika, atpcEnabled=atpcEnabled, ethTXByteCounterHi=ethTXByteCounterHi, ipRadio=ipRadio, modemLastAcqError=modemLastAcqError, ethTXPauseFrames=ethTXPauseFrames, ethGFPFCSErrors=ethGFPFCSErrors, modemErroredSecond=modemErroredSecond, radioSide=radioSide, radioIndex=radioIndex, modemIndex=modemIndex, modemEthernetCapacity=modemEthernetCapacity, ethRXByteCounterLow=ethRXByteCounterLow, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXDvEvent=ethRXDvEvent, radioTable=radioTable, modemAcqStatus=modemAcqStatus, modemInternalAGCgain=modemInternalAGCgain, radioTxPower=radioTxPower, remoteIp=remoteIp, e1t1StatTable=e1t1StatTable, modemACMethernetCapacity=modemACMethernetCapacity, vlansEnabled=vlansEnabled, ethRXControlFrames=ethRXControlFrames, ethTXGiants=ethTXGiants, loopbacks=loopbacks, modemRowStatus=modemRowStatus, saf=saf, ipRadioCfg=ipRadioCfg, modemStatistics=modemStatistics, ipRadioCfgGeneral=ipRadioCfgGeneral, radioLoopback=radioLoopback, radioRxFrequency=radioRxFrequency, ethTXDones=ethTXDones, modemStandard=modemStandard, ethGFPCHECErrors=ethGFPCHECErrors, modemSymbolRateRx=modemSymbolRateRx, modemCountTime=modemCountTime, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ipRadioCfgNetwork=ipRadioCfgNetwork, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXBroadcasts=ethTXBroadcasts, modemModulation=modemModulation, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXCRCErrors=ethRXCRCErrors, vlanTable=vlanTable, modemSymbolRateTx=modemSymbolRateTx, modemGeneralStatus=modemGeneralStatus, vlanRowStatus=vlanRowStatus, sysDateAndTime=sysDateAndTime, product=product, ethTXExcessiveDefers=ethTXExcessiveDefers, licenseUpdateStatus=licenseUpdateStatus, radioRxLevel=radioRxLevel, writeConfig=writeConfig, localIp=localIp, modemErroredBlock=modemErroredBlock, ethRXPauseFrames=ethRXPauseFrames, sysTemperature=sysTemperature, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethQOSTXFrames=ethQOSTXFrames, licenseMask=licenseMask, aTPCEntry=aTPCEntry, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXCollisions=ethTXCollisions, e1t1ChannelNr=e1t1ChannelNr, ethRXTruncatedFrames=ethRXTruncatedFrames, atpcIndex=atpcIndex, ethGFPDelineationErrors=ethGFPDelineationErrors, modemTotalBlockNumber=modemTotalBlockNumber, ethRXVlanTagsDetected=ethRXVlanTagsDetected, vlanNumber=vlanNumber, description=description, modemACMmodulationMin=modemACMmodulationMin, vlanCfgStat=vlanCfgStat, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXLateCollisions=ethTXLateCollisions, ethTXUnderruns=ethTXUnderruns, loopback_tributary_mask=loopback_tributary_mask, ethTXByteCounterLow=ethTXByteCounterLow, modemTable=modemTable, aTPCTable=aTPCTable, vlanEntry=vlanEntry, ethTXWireByteCounterLow=ethTXWireByteCounterLow)
