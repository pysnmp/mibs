...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXByteCounterLow=ethRXByteCounterLow, licenseMask=licenseMask, ethTXCollisions=ethTXCollisions, vlansEnabled=vlansEnabled, ethGFPCHECErrors=ethGFPCHECErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemE1T1ChannelMask=modemE1T1ChannelMask, modemCarrierOffset=modemCarrierOffset, ethTXMaxCollisions=ethTXMaxCollisions, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemEntry=modemEntry, ethRXCodeErrors=ethRXCodeErrors, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemACMtotalCapacity=modemACMtotalCapacity, radioTable=radioTable, radioTxPower=radioTxPower, vlanPortType=vlanPortType, radioRxFrequency=radioRxFrequency, ethQOSRXQ1Frames=ethQOSRXQ1Frames, writeConfig=writeConfig, radioSide=radioSide, modemRowStatus=modemRowStatus, ethRXDvEvent=ethRXDvEvent, ethTXCRCErrors=ethTXCRCErrors, safip=safip, remoteIp=remoteIp, modemTable=modemTable, modemTotalCapacity=modemTotalCapacity, modemStandard=modemStandard, ethQOSTXDropped=ethQOSTXDropped, description=description, e1t1StatEntry=e1t1StatEntry, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemRadialMSE=modemRadialMSE, ethRXBroadcasts=ethRXBroadcasts, vlanFid=vlanFid, modemGeneralStatus=modemGeneralStatus, ethRXDones=ethRXDones, ipRadio=ipRadio, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXControlFrames=ethRXControlFrames, modemSymbolRateTx=modemSymbolRateTx, modemInternalAGCgain=modemInternalAGCgain, ethRXDribleNibbles=ethRXDribleNibbles, radioEntry=radioEntry, modemCountTime=modemCountTime, tehnika=tehnika, vlanCfgStat=vlanCfgStat, ethQOSTXFrames=ethQOSTXFrames, ipRadioMgmt=ipRadioMgmt, ethTXByteCounterHi=ethTXByteCounterHi, modemACMethernetCapacity=modemACMethernetCapacity, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemSeverelyErroredSecond=modemSeverelyErroredSecond, loopbacks=loopbacks, localIp=localIp, modemIndex=modemIndex, modemEthernetCapacity=modemEthernetCapacity, radioGenStatus=radioGenStatus, ethTXControlFrames=ethTXControlFrames, modemTotalBlockNumber=modemTotalBlockNumber, ethTXLateCollisions=ethTXLateCollisions, ethTXPauseFrames=ethTXPauseFrames, radioDuplexShift=radioDuplexShift, modemLastAcqError=modemLastAcqError, radioRxLevel=radioRxLevel, modemACMengine=modemACMengine, modemStatistics=modemStatistics, e1t1StatTable=e1t1StatTable, saf=saf, ethRXTruncatedFrames=ethRXTruncatedFrames, aTPCTable=aTPCTable, ethRXCRCErrors=ethRXCRCErrors, radioTxMute=radioTxMute, ipRadioStatEth=ipRadioStatEth, vlanTable=vlanTable, ethRXMulticasts=ethRXMulticasts, ethRXVlanTagsDetected=ethRXVlanTagsDetected, e1t1ChannelNr=e1t1ChannelNr, vlanRowStatus=vlanRowStatus, atpcEnabled=atpcEnabled, modemModulation=modemModulation, modemACMmodulationMin=modemACMmodulationMin, ethTXWireByteCounterLow=ethTXWireByteCounterLow, loopback_tributary_mask=loopback_tributary_mask, sysTemperature=sysTemperature, atpcIndex=atpcIndex, modemBandwith=modemBandwith, ethRXLongEvents=ethRXLongEvents, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethGFPDropedFrames=ethGFPDropedFrames, modemErroredSecond=modemErroredSecond, localIpMask=localIpMask, modemAcqStatus=modemAcqStatus, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, licenseUpdateStatus=licenseUpdateStatus, ethTXBackpresEvents=ethTXBackpresEvents, vlanPortmap=vlanPortmap, microwaveRadio=microwaveRadio, restartcpu=restartcpu, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXVlanTags=ethTXVlanTags, ipRadioStat=ipRadioStat, ethTXGiants=ethTXGiants, modemLDPCdecoderStress=modemLDPCdecoderStress, modemACMmodulationMax=modemACMmodulationMax, ethTXBroadcasts=ethTXBroadcasts, hostname=hostname, modemErroredSecondRatio=modemErroredSecondRatio, ethRXPauseFrames=ethRXPauseFrames, modemUnavailtime=modemUnavailtime, radioIndex=radioIndex, ethRXByteCounterHi=ethRXByteCounterHi, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioLoopback=radioLoopback, ethTXUnderruns=ethTXUnderruns, ipRadioCfgNetwork=ipRadioCfgNetwork, atpcTxPowerCorrection=atpcTxPowerCorrection, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, pointToPoint=pointToPoint, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemErroredBlock=modemErroredBlock, ethTXDones=ethTXDones, ethTXByteCounterLow=ethTXByteCounterLow, modemUptime=modemUptime, sysDateAndTime=sysDateAndTime, radioTxFrequency=radioTxFrequency, e1t1AIS=e1t1AIS, e1t1LOS=e1t1LOS, aTPCEntry=aTPCEntry, modemSymbolRateRx=modemSymbolRateRx, ethTXMulticasts=ethTXMulticasts, vlanNumber=vlanNumber, ethGFPFCSErrors=ethGFPFCSErrors, modemE1T1Channels=modemE1T1Channels, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, vlanEntry=vlanEntry, product=product, ethGFPDelineationErrors=ethGFPDelineationErrors, license=license, ipRadioCfg=ipRadioCfg)
