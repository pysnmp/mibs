...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXByteCounterLow=ethRXByteCounterLow, modemTotalBlockNumber=modemTotalBlockNumber, ethQOSTXFrames=ethQOSTXFrames, modemE1T1Channels=modemE1T1Channels, vlanNumber=vlanNumber, ethRXCRCErrors=ethRXCRCErrors, modemSymbolRateRx=modemSymbolRateRx, radioEntry=radioEntry, radioTxMute=radioTxMute, vlanCfgStat=vlanCfgStat, ethTXWireByteCounterLow=ethTXWireByteCounterLow, aTPCEntry=aTPCEntry, ethRXMulticasts=ethRXMulticasts, ethQOSTXDropped=ethQOSTXDropped, licenseMask=licenseMask, ethTXMulticasts=ethTXMulticasts, modemStandard=modemStandard, microwaveRadio=microwaveRadio, radioRxFrequency=radioRxFrequency, ipRadioCfg=ipRadioCfg, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemACMmodulationMax=modemACMmodulationMax, ethTXUnderruns=ethTXUnderruns, pointToPoint=pointToPoint, vlanPortType=vlanPortType, modemAcqStatus=modemAcqStatus, modemBandwith=modemBandwith, loopback_tributary_mask=loopback_tributary_mask, radioTable=radioTable, ethRXPrevPktDropped=ethRXPrevPktDropped, hostname=hostname, ethTXCRCErrors=ethTXCRCErrors, ethRXLongEvents=ethRXLongEvents, ethQOSRXQ1Frames=ethQOSRXQ1Frames, sysDateAndTime=sysDateAndTime, modemUnavailtime=modemUnavailtime, modemACMethernetCapacity=modemACMethernetCapacity, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXCodeErrors=ethRXCodeErrors, modemGeneralStatus=modemGeneralStatus, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethGFPDropedFrames=ethGFPDropedFrames, modemACMengine=modemACMengine, modemRowStatus=modemRowStatus, ethGFPFCSErrors=ethGFPFCSErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioTxFrequency=radioTxFrequency, ipRadioStatEth=ipRadioStatEth, safip=safip, ipRadioMgmt=ipRadioMgmt, atpcEnabled=atpcEnabled, modemACMmodulationMin=modemACMmodulationMin, ethTXControlFrames=ethTXControlFrames, ethTXMaxCollisions=ethTXMaxCollisions, vlanTable=vlanTable, remoteIp=remoteIp, ethTXByteCounterLow=ethTXByteCounterLow, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, writeConfig=writeConfig, modemLDPCdecoderStress=modemLDPCdecoderStress, tehnika=tehnika, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXCollisions=ethTXCollisions, e1t1LOS=e1t1LOS, ethTXBroadcasts=ethTXBroadcasts, ethTXDones=ethTXDones, radioIndex=radioIndex, ethTXLengthCheckErrors=ethTXLengthCheckErrors, e1t1StatEntry=e1t1StatEntry, ethRXDribleNibbles=ethRXDribleNibbles, e1t1AIS=e1t1AIS, description=description, e1t1ChannelNr=e1t1ChannelNr, product=product, modemEntry=modemEntry, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioDuplexShift=radioDuplexShift, e1t1StatTable=e1t1StatTable, vlansEnabled=vlansEnabled, localIpMask=localIpMask, modemTable=modemTable, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXPauseFrames=ethTXPauseFrames, ethTXExcessiveDefers=ethTXExcessiveDefers, saf=saf, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemIndex=modemIndex, modemCarrierOffset=modemCarrierOffset, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXDvEvent=ethRXDvEvent, modemInternalAGCgain=modemInternalAGCgain, ethTXByteCounterHi=ethTXByteCounterHi, ethRXByteCounterHi=ethRXByteCounterHi, atpcIndex=atpcIndex, modemModulation=modemModulation, vlanRowStatus=vlanRowStatus, ethGFPCHECErrors=ethGFPCHECErrors, radioRxLevel=radioRxLevel, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXGiants=ethTXGiants, license=license, ethRXBroadcasts=ethRXBroadcasts, localIp=localIp, licenseUpdateStatus=licenseUpdateStatus, modemUptime=modemUptime, modemEthernetCapacity=modemEthernetCapacity, modemACMtotalCapacity=modemACMtotalCapacity, vlanFid=vlanFid, modemSymbolRateTx=modemSymbolRateTx, modemCountTime=modemCountTime, sysTemperature=sysTemperature, modemErroredBlock=modemErroredBlock, ipRadio=ipRadio, ethTXBackpresEvents=ethTXBackpresEvents, ethRXControlFrames=ethRXControlFrames, ethRXDones=ethRXDones, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, vlanEntry=vlanEntry, radioTxPower=radioTxPower, ipRadioStat=ipRadioStat, modemTotalCapacity=modemTotalCapacity, ethRXPauseFrames=ethRXPauseFrames, radioGenStatus=radioGenStatus, ethTXLateCollisions=ethTXLateCollisions, ethGFPDelineationErrors=ethGFPDelineationErrors, radioSide=radioSide, modemErroredSecond=modemErroredSecond, aTPCTable=aTPCTable, modemLastAcqError=modemLastAcqError, modemRadialMSE=modemRadialMSE, modemStatistics=modemStatistics, loopbacks=loopbacks, restartcpu=restartcpu, radioLoopback=radioLoopback, vlanPortmap=vlanPortmap, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ipRadioCfgGeneral=ipRadioCfgGeneral, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXVlanTags=ethTXVlanTags, modemErroredSecondRatio=modemErroredSecondRatio, ethRXUnsupOpcodes=ethRXUnsupOpcodes)
