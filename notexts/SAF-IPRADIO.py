...
mibBuilder.exportSymbols("SAF-IPRADIO", radioTxPower=radioTxPower, ethRXMulticasts=ethRXMulticasts, modemStatistics=modemStatistics, saf=saf, modemEntry=modemEntry, vlanNumber=vlanNumber, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemAcqStatus=modemAcqStatus, ethRXPauseFrames=ethRXPauseFrames, ipRadioStatEth=ipRadioStatEth, radioTxFrequency=radioTxFrequency, e1t1StatEntry=e1t1StatEntry, radioRxFrequency=radioRxFrequency, ethRXCRCErrors=ethRXCRCErrors, modemBandwith=modemBandwith, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioTable=radioTable, e1t1LOS=e1t1LOS, pointToPoint=pointToPoint, remoteIp=remoteIp, modemRowStatus=modemRowStatus, e1t1AIS=e1t1AIS, modemInternalAGCgain=modemInternalAGCgain, ipRadioStat=ipRadioStat, ethRXControlFrames=ethRXControlFrames, aTPCTable=aTPCTable, vlanTable=vlanTable, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXUnsupOpcodes=ethRXUnsupOpcodes, loopback_tributary_mask=loopback_tributary_mask, ethTXCRCErrors=ethTXCRCErrors, modemACMtotalCapacity=modemACMtotalCapacity, radioTxMute=radioTxMute, aTPCEntry=aTPCEntry, ethRXLongEvents=ethRXLongEvents, radioDuplexShift=radioDuplexShift, ethRXByteCounterHi=ethRXByteCounterHi, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXVlanTags=ethTXVlanTags, atpcEnabled=atpcEnabled, ethRXDones=ethRXDones, ipRadioCfgGeneral=ipRadioCfgGeneral, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioLoopback=radioLoopback, ethTXGiants=ethTXGiants, modemIndex=modemIndex, modemACMmodulationMax=modemACMmodulationMax, sysTemperature=sysTemperature, modemRadialMSE=modemRadialMSE, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXDones=ethTXDones, ethRXBroadcasts=ethRXBroadcasts, ethTXCollisions=ethTXCollisions, ethQOSTXDropped=ethQOSTXDropped, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemLastAcqError=modemLastAcqError, modemCountTime=modemCountTime, ethRXDribleNibbles=ethRXDribleNibbles, ipRadio=ipRadio, ethGFPCHECErrors=ethGFPCHECErrors, modemEthernetCapacity=modemEthernetCapacity, ethTXMaxCollisions=ethTXMaxCollisions, ethRXCodeErrors=ethRXCodeErrors, ethTXPauseFrames=ethTXPauseFrames, writeConfig=writeConfig, vlansEnabled=vlansEnabled, ethTXLengthCheckErrors=ethTXLengthCheckErrors, radioIndex=radioIndex, ethQOSTXFrames=ethQOSTXFrames, ethTXBroadcasts=ethTXBroadcasts, atpcIndex=atpcIndex, licenseUpdateStatus=licenseUpdateStatus, ethTXMulticasts=ethTXMulticasts, license=license, modemUnavailtime=modemUnavailtime, product=product, microwaveRadio=microwaveRadio, restartcpu=restartcpu, radioGenStatus=radioGenStatus, modemStandard=modemStandard, ethGFPFCSErrors=ethGFPFCSErrors, modemModulation=modemModulation, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXWireByteCounterLow=ethTXWireByteCounterLow, vlanPortType=vlanPortType, modemTotalBlockNumber=modemTotalBlockNumber, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXDvEvent=ethRXDvEvent, ipRadioCfgNetwork=ipRadioCfgNetwork, safip=safip, ethGFPDropedFrames=ethGFPDropedFrames, localIp=localIp, ethTXLateCollisions=ethTXLateCollisions, hostname=hostname, modemGeneralStatus=modemGeneralStatus, vlanPortmap=vlanPortmap, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemE1T1Channels=modemE1T1Channels, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemACMmodulationMin=modemACMmodulationMin, radioRxLevel=radioRxLevel, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethQOSRXQ2Frames=ethQOSRXQ2Frames, atpcTxPowerCorrection=atpcTxPowerCorrection, modemACMethernetCapacity=modemACMethernetCapacity, ethTXUnderruns=ethTXUnderruns, radioEntry=radioEntry, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, vlanRowStatus=vlanRowStatus, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXBackpresEvents=ethTXBackpresEvents, modemSymbolRateRx=modemSymbolRateRx, sysDateAndTime=sysDateAndTime, modemTotalCapacity=modemTotalCapacity, modemE1T1ChannelMask=modemE1T1ChannelMask, ipRadioCfg=ipRadioCfg, ethTXControlFrames=ethTXControlFrames, localIpMask=localIpMask, loopbacks=loopbacks, radioSide=radioSide, ethTXByteCounterLow=ethTXByteCounterLow, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXExcessiveDefers=ethTXExcessiveDefers, vlanCfgStat=vlanCfgStat, modemTable=modemTable, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlanEntry=vlanEntry, vlanFid=vlanFid, modemErroredSecond=modemErroredSecond, ipRadioMgmt=ipRadioMgmt, modemSymbolRateTx=modemSymbolRateTx, modemUptime=modemUptime, modemErroredBlock=modemErroredBlock, ethRXByteCounterLow=ethRXByteCounterLow, e1t1ChannelNr=e1t1ChannelNr, modemACMengine=modemACMengine, ethTXByteCounterHi=ethTXByteCounterHi, e1t1StatTable=e1t1StatTable, description=description, modemCarrierOffset=modemCarrierOffset, tehnika=tehnika, licenseMask=licenseMask, modemErroredSecondRatio=modemErroredSecondRatio)
