...
mibBuilder.exportSymbols("SAF-IPRADIO", modemUnavailtime=modemUnavailtime, remoteIp=remoteIp, ethGFPDelineationErrors=ethGFPDelineationErrors, modemE1T1ChannelMask=modemE1T1ChannelMask, radioRxFrequency=radioRxFrequency, atpcTxPowerCorrection=atpcTxPowerCorrection, modemACMmodulationMax=modemACMmodulationMax, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXBroadcasts=ethTXBroadcasts, e1t1StatEntry=e1t1StatEntry, modemSymbolRateTx=modemSymbolRateTx, modemStatistics=modemStatistics, radioIndex=radioIndex, ethRXDribleNibbles=ethRXDribleNibbles, ethTXCRCErrors=ethTXCRCErrors, ethTXMaxCollisions=ethTXMaxCollisions, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXByteCounterLow=ethTXByteCounterLow, licenseMask=licenseMask, radioTxPower=radioTxPower, modemLastAcqError=modemLastAcqError, sysDateAndTime=sysDateAndTime, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, e1t1LOS=e1t1LOS, localIpMask=localIpMask, ethTXGiants=ethTXGiants, ethGFPCHECErrors=ethGFPCHECErrors, modemCountTime=modemCountTime, ethRXPrevPktDropped=ethRXPrevPktDropped, modemEntry=modemEntry, product=product, modemACMengine=modemACMengine, loopbacks=loopbacks, aTPCTable=aTPCTable, modemBackgroundBlockErrror=modemBackgroundBlockErrror, saf=saf, atpcEnabled=atpcEnabled, vlanPortmap=vlanPortmap, ethTXLateCollisions=ethTXLateCollisions, ethTXControlFrames=ethTXControlFrames, ethRXMulticasts=ethRXMulticasts, modemErroredSecondRatio=modemErroredSecondRatio, modemACMethernetCapacity=modemACMethernetCapacity, e1t1AIS=e1t1AIS, restartcpu=restartcpu, radioEntry=radioEntry, atpcIndex=atpcIndex, ethRXLongEvents=ethRXLongEvents, ethRXByteCounterLow=ethRXByteCounterLow, ipRadioCfgNetwork=ipRadioCfgNetwork, modemTotalBlockNumber=modemTotalBlockNumber, modemTotalCapacity=modemTotalCapacity, ethTXExcessiveDefers=ethTXExcessiveDefers, ethQOSTXDropped=ethQOSTXDropped, modemInternalAGCgain=modemInternalAGCgain, ethTXLengthCheckErrors=ethTXLengthCheckErrors, loopback_tributary_mask=loopback_tributary_mask, vlanCfgStat=vlanCfgStat, radioTxFrequency=radioTxFrequency, modemACMtotalCapacity=modemACMtotalCapacity, ethTXDones=ethTXDones, radioSide=radioSide, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXDvEvent=ethRXDvEvent, ethTXPauseFrames=ethTXPauseFrames, modemRadialMSE=modemRadialMSE, ethTXByteCounterHi=ethTXByteCounterHi, modemBandwith=modemBandwith, modemSymbolRateRx=modemSymbolRateRx, ethQOSTXFrames=ethQOSTXFrames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, localIp=localIp, radioTable=radioTable, ethRXCodeErrors=ethRXCodeErrors, vlanPortType=vlanPortType, modemACMmodulationMin=modemACMmodulationMin, modemTable=modemTable, ethGFPFCSErrors=ethGFPFCSErrors, radioTxMute=radioTxMute, license=license, modemCarrierOffset=modemCarrierOffset, ipRadioStat=ipRadioStat, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, description=description, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, vlanFid=vlanFid, ipRadio=ipRadio, e1t1ChannelNr=e1t1ChannelNr, modemAcqStatus=modemAcqStatus, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXUnderruns=ethTXUnderruns, ethRXControlFrames=ethRXControlFrames, e1t1StatTable=e1t1StatTable, ethRXByteCounterHi=ethRXByteCounterHi, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioDuplexShift=radioDuplexShift, vlansEnabled=vlansEnabled, vlanEntry=vlanEntry, pointToPoint=pointToPoint, modemUptime=modemUptime, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemIndex=modemIndex, safip=safip, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ipRadioStatEth=ipRadioStatEth, modemE1T1Channels=modemE1T1Channels, vlanTable=vlanTable, modemErroredBlock=modemErroredBlock, modemEthernetCapacity=modemEthernetCapacity, microwaveRadio=microwaveRadio, modemStandard=modemStandard, ipRadioMgmt=ipRadioMgmt, ipRadioCfgGeneral=ipRadioCfgGeneral, hostname=hostname, modemErroredSecond=modemErroredSecond, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioRxLevel=radioRxLevel, ethTXCollisions=ethTXCollisions, ethGFPDropedFrames=ethGFPDropedFrames, sysTemperature=sysTemperature, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXBackpresEvents=ethTXBackpresEvents, ipRadioCfg=ipRadioCfg, ethTXVlanTags=ethTXVlanTags, radioLoopback=radioLoopback, ethRXBroadcasts=ethRXBroadcasts, ethRXVlanTagsDetected=ethRXVlanTagsDetected, vlanRowStatus=vlanRowStatus, writeConfig=writeConfig, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlanNumber=vlanNumber, modemRowStatus=modemRowStatus, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, aTPCEntry=aTPCEntry, licenseUpdateStatus=licenseUpdateStatus, ethRXDones=ethRXDones, modemGeneralStatus=modemGeneralStatus, tehnika=tehnika, modemModulation=modemModulation, ethTXMulticasts=ethTXMulticasts, ethRXCRCErrors=ethRXCRCErrors, ethRXPauseFrames=ethRXPauseFrames, radioGenStatus=radioGenStatus)
