...
mibBuilder.exportSymbols("SAF-IPRADIO", ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXGiants=ethTXGiants, modemACMtotalCapacity=modemACMtotalCapacity, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemEntry=modemEntry, modemTotalBlockNumber=modemTotalBlockNumber, e1t1StatEntry=e1t1StatEntry, ethRXCRCErrors=ethRXCRCErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXControlFrames=ethTXControlFrames, ipRadioMgmt=ipRadioMgmt, modemACMmodulationMin=modemACMmodulationMin, e1t1AIS=e1t1AIS, vlanPortType=vlanPortType, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXDones=ethTXDones, ethRXLongEvents=ethRXLongEvents, modemTable=modemTable, radioEntry=radioEntry, ethTXByteCounterLow=ethTXByteCounterLow, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, modemACMethernetCapacity=modemACMethernetCapacity, ethGFPFCSErrors=ethGFPFCSErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioTxPower=radioTxPower, restartcpu=restartcpu, description=description, modemSymbolRateRx=modemSymbolRateRx, ipRadioStat=ipRadioStat, loopbacks=loopbacks, ethRXPauseFrames=ethRXPauseFrames, aTPCEntry=aTPCEntry, ethTXExcessiveDefers=ethTXExcessiveDefers, ethGFPDropedFrames=ethGFPDropedFrames, modemRowStatus=modemRowStatus, e1t1StatTable=e1t1StatTable, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemErroredSecondRatio=modemErroredSecondRatio, modemSymbolRateTx=modemSymbolRateTx, ethRXDones=ethRXDones, writeConfig=writeConfig, ethRXCodeErrors=ethRXCodeErrors, vlansEnabled=vlansEnabled, ethTXLateCollisions=ethTXLateCollisions, safip=safip, ethTXByteCounterHi=ethTXByteCounterHi, atpcIndex=atpcIndex, ethGFPDelineationErrors=ethGFPDelineationErrors, radioRxFrequency=radioRxFrequency, ethTXCRCErrors=ethTXCRCErrors, vlanTable=vlanTable, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, tehnika=tehnika, e1t1LOS=e1t1LOS, radioGenStatus=radioGenStatus, license=license, radioIndex=radioIndex, modemGeneralStatus=modemGeneralStatus, modemLastAcqError=modemLastAcqError, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemStatistics=modemStatistics, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXDribleNibbles=ethRXDribleNibbles, ethRXDvEvent=ethRXDvEvent, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemIndex=modemIndex, modemInternalAGCgain=modemInternalAGCgain, modemUptime=modemUptime, modemBandwith=modemBandwith, pointToPoint=pointToPoint, ethTXMulticasts=ethTXMulticasts, vlanRowStatus=vlanRowStatus, radioTable=radioTable, sysDateAndTime=sysDateAndTime, radioLoopback=radioLoopback, modemCarrierOffset=modemCarrierOffset, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXMaxCollisions=ethTXMaxCollisions, modemRadialMSE=modemRadialMSE, vlanCfgStat=vlanCfgStat, loopback_tributary_mask=loopback_tributary_mask, modemStandard=modemStandard, e1t1ChannelNr=e1t1ChannelNr, modemSeverelyErroredSecond=modemSeverelyErroredSecond, saf=saf, ipRadio=ipRadio, localIpMask=localIpMask, ethTXUnderruns=ethTXUnderruns, ethRXByteCounterHi=ethRXByteCounterHi, microwaveRadio=microwaveRadio, sysTemperature=sysTemperature, aTPCTable=aTPCTable, ethGFPCHECErrors=ethGFPCHECErrors, ethTXBroadcasts=ethTXBroadcasts, modemEthernetCapacity=modemEthernetCapacity, modemUnavailtime=modemUnavailtime, ethRXBroadcasts=ethRXBroadcasts, radioTxFrequency=radioTxFrequency, radioTxMute=radioTxMute, radioSide=radioSide, vlanPortmap=vlanPortmap, ethTXCollisions=ethTXCollisions, licenseMask=licenseMask, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ipRadioCfg=ipRadioCfg, localIp=localIp, modemACMengine=modemACMengine, ethRXControlFrames=ethRXControlFrames, vlanFid=vlanFid, radioRxLevel=radioRxLevel, modemModulation=modemModulation, ethRXByteCounterLow=ethRXByteCounterLow, modemTotalCapacity=modemTotalCapacity, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemACMmodulationMax=modemACMmodulationMax, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemErroredSecond=modemErroredSecond, radioDuplexShift=radioDuplexShift, atpcEnabled=atpcEnabled, ethTXVlanTags=ethTXVlanTags, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethQOSTXDropped=ethQOSTXDropped, modemE1T1ChannelMask=modemE1T1ChannelMask, modemErroredBlock=modemErroredBlock, ethQOSTXFrames=ethQOSTXFrames, ipRadioStatEth=ipRadioStatEth, remoteIp=remoteIp, modemCountTime=modemCountTime, modemAcqStatus=modemAcqStatus, vlanEntry=vlanEntry, ethRXMulticasts=ethRXMulticasts, hostname=hostname, vlanNumber=vlanNumber, product=product, modemE1T1Channels=modemE1T1Channels, ethTXPauseFrames=ethTXPauseFrames, licenseUpdateStatus=licenseUpdateStatus, ethTXBackpresEvents=ethTXBackpresEvents, atpcTxPowerCorrection=atpcTxPowerCorrection)
