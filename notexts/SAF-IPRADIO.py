...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXPrevPktDropped=ethRXPrevPktDropped, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemTable=modemTable, sysTemperature=sysTemperature, modemCarrierOffset=modemCarrierOffset, pointToPoint=pointToPoint, radioDuplexShift=radioDuplexShift, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemACMethernetCapacity=modemACMethernetCapacity, radioRxLevel=radioRxLevel, ethTXBackpresEvents=ethTXBackpresEvents, ethTXVlanTags=ethTXVlanTags, radioTxPower=radioTxPower, modemErroredBlock=modemErroredBlock, license=license, ethTXLateCollisions=ethTXLateCollisions, modemTotalCapacity=modemTotalCapacity, microwaveRadio=microwaveRadio, modemModulation=modemModulation, modemBandwith=modemBandwith, ethTXUnderruns=ethTXUnderruns, modemACMengine=modemACMengine, radioGenStatus=radioGenStatus, ethGFPDropedFrames=ethGFPDropedFrames, ethRXDvEvent=ethRXDvEvent, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, vlanPortmap=vlanPortmap, modemTotalBlockNumber=modemTotalBlockNumber, modemRadialMSE=modemRadialMSE, sysDateAndTime=sysDateAndTime, modemEntry=modemEntry, radioTable=radioTable, vlanEntry=vlanEntry, ethRXLongEvents=ethRXLongEvents, ethTXCollisions=ethTXCollisions, ethTXDones=ethTXDones, ethTXControlFrames=ethTXControlFrames, ethRXDones=ethRXDones, ethGFPCHECErrors=ethGFPCHECErrors, modemErroredSecond=modemErroredSecond, ethRXDribleNibbles=ethRXDribleNibbles, e1t1StatEntry=e1t1StatEntry, description=description, ipRadioStatEth=ipRadioStatEth, e1t1LOS=e1t1LOS, vlanRowStatus=vlanRowStatus, aTPCEntry=aTPCEntry, vlansEnabled=vlansEnabled, ipRadio=ipRadio, ethTXPauseFrames=ethTXPauseFrames, modemRowStatus=modemRowStatus, modemEthernetCapacity=modemEthernetCapacity, modemUptime=modemUptime, saf=saf, localIp=localIp, atpcTxPowerCorrection=atpcTxPowerCorrection, modemLastAcqError=modemLastAcqError, ipRadioCfgNetwork=ipRadioCfgNetwork, modemUnavailtime=modemUnavailtime, ethRXControlFrames=ethRXControlFrames, e1t1StatTable=e1t1StatTable, ethTXWireByteCounterLow=ethTXWireByteCounterLow, tehnika=tehnika, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioTxFrequency=radioTxFrequency, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXCRCErrors=ethRXCRCErrors, ethTXMulticasts=ethTXMulticasts, ipRadioStat=ipRadioStat, vlanCfgStat=vlanCfgStat, modemSymbolRateTx=modemSymbolRateTx, ipRadioCfg=ipRadioCfg, product=product, modemCountTime=modemCountTime, writeConfig=writeConfig, vlanNumber=vlanNumber, ethRXMulticasts=ethRXMulticasts, modemACMmodulationMin=modemACMmodulationMin, ethGFPDelineationErrors=ethGFPDelineationErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemErroredSecondRatio=modemErroredSecondRatio, safip=safip, ethTXMaxCollisions=ethTXMaxCollisions, modemE1T1Channels=modemE1T1Channels, radioLoopback=radioLoopback, e1t1ChannelNr=e1t1ChannelNr, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemStandard=modemStandard, modemInternalAGCgain=modemInternalAGCgain, loopbacks=loopbacks, e1t1AIS=e1t1AIS, ethRXByteCounterHi=ethRXByteCounterHi, remoteIp=remoteIp, modemAcqStatus=modemAcqStatus, ethTXExcessiveDefers=ethTXExcessiveDefers, ethGFPFCSErrors=ethGFPFCSErrors, modemACMmodulationMax=modemACMmodulationMax, modemIndex=modemIndex, radioIndex=radioIndex, aTPCTable=aTPCTable, vlanTable=vlanTable, localIpMask=localIpMask, ethTXByteCounterLow=ethTXByteCounterLow, ethQOSTXDropped=ethQOSTXDropped, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXBroadcasts=ethTXBroadcasts, ethRXBroadcasts=ethRXBroadcasts, licenseUpdateStatus=licenseUpdateStatus, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXPauseFrames=ethRXPauseFrames, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXLengthCheckErrors=ethTXLengthCheckErrors, loopback_tributary_mask=loopback_tributary_mask, ipRadioMgmt=ipRadioMgmt, atpcEnabled=atpcEnabled, restartcpu=restartcpu, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemSymbolRateRx=modemSymbolRateRx, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXCodeErrors=ethRXCodeErrors, licenseMask=licenseMask, hostname=hostname, vlanFid=vlanFid, ethRXByteCounterLow=ethRXByteCounterLow, ethTXGiants=ethTXGiants, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemE1T1ChannelMask=modemE1T1ChannelMask, modemLDPCdecoderStress=modemLDPCdecoderStress, radioEntry=radioEntry, modemACMtotalCapacity=modemACMtotalCapacity, ethTXByteCounterHi=ethTXByteCounterHi, modemGeneralStatus=modemGeneralStatus, vlanPortType=vlanPortType, radioRxFrequency=radioRxFrequency, modemStatistics=modemStatistics, radioSide=radioSide, ethTXCRCErrors=ethTXCRCErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, atpcIndex=atpcIndex, radioTxMute=radioTxMute, ethQOSTXFrames=ethQOSTXFrames)
