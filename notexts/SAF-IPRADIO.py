...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXMulticasts=ethTXMulticasts, ethRXCodeErrors=ethRXCodeErrors, ethRXPauseFrames=ethRXPauseFrames, ethTXDones=ethTXDones, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemErroredSecondRatio=modemErroredSecondRatio, atpcIndex=atpcIndex, pointToPoint=pointToPoint, modemEthernetCapacity=modemEthernetCapacity, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXLateCollisions=ethTXLateCollisions, ethRXTruncatedFrames=ethRXTruncatedFrames, saf=saf, product=product, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXCollisions=ethTXCollisions, ethQOSTXFrames=ethQOSTXFrames, modemRadialMSE=modemRadialMSE, licenseUpdateStatus=licenseUpdateStatus, modemUptime=modemUptime, modemE1T1ChannelMask=modemE1T1ChannelMask, modemModulation=modemModulation, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXControlFrames=ethTXControlFrames, ethRXLongEvents=ethRXLongEvents, ethGFPDropedFrames=ethGFPDropedFrames, e1t1StatTable=e1t1StatTable, ethTXByteCounterLow=ethTXByteCounterLow, remoteIp=remoteIp, hostname=hostname, radioTxFrequency=radioTxFrequency, safip=safip, loopbacks=loopbacks, ethTXCRCErrors=ethTXCRCErrors, loopback_tributary_mask=loopback_tributary_mask, ethTXByteCounterHi=ethTXByteCounterHi, radioIndex=radioIndex, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXControlFrames=ethRXControlFrames, modemUnavailtime=modemUnavailtime, vlansEnabled=vlansEnabled, tehnika=tehnika, modemSymbolRateRx=modemSymbolRateRx, ethTXUnderruns=ethTXUnderruns, licenseMask=licenseMask, modemTable=modemTable, e1t1AIS=e1t1AIS, e1t1ChannelNr=e1t1ChannelNr, ethTXGiants=ethTXGiants, radioLoopback=radioLoopback, modemStatistics=modemStatistics, radioEntry=radioEntry, e1t1StatEntry=e1t1StatEntry, modemACMengine=modemACMengine, vlanPortType=vlanPortType, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, vlanRowStatus=vlanRowStatus, ethTXMaxCollisions=ethTXMaxCollisions, license=license, ethRXByteCounterLow=ethRXByteCounterLow, ethQOSRXQ1Frames=ethQOSRXQ1Frames, aTPCTable=aTPCTable, atpcTxPowerCorrection=atpcTxPowerCorrection, modemCountTime=modemCountTime, vlanFid=vlanFid, ethTXVlanTags=ethTXVlanTags, modemSymbolRateTx=modemSymbolRateTx, vlanEntry=vlanEntry, ethRXMulticasts=ethRXMulticasts, ipRadioStatEth=ipRadioStatEth, vlanCfgStat=vlanCfgStat, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemInternalAGCgain=modemInternalAGCgain, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXBroadcasts=ethRXBroadcasts, radioDuplexShift=radioDuplexShift, ethRXCRCErrors=ethRXCRCErrors, ethRXDribleNibbles=ethRXDribleNibbles, modemStandard=modemStandard, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXPauseFrames=ethTXPauseFrames, radioRxLevel=radioRxLevel, ethGFPCHECErrors=ethGFPCHECErrors, modemAcqStatus=modemAcqStatus, modemACMmodulationMax=modemACMmodulationMax, ethRXDones=ethRXDones, e1t1LOS=e1t1LOS, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioTxPower=radioTxPower, modemTotalBlockNumber=modemTotalBlockNumber, ethTXWireByteCounterLow=ethTXWireByteCounterLow, sysTemperature=sysTemperature, modemErroredSecond=modemErroredSecond, modemCarrierOffset=modemCarrierOffset, ethRXPrevPktDropped=ethRXPrevPktDropped, atpcEnabled=atpcEnabled, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXDvEvent=ethRXDvEvent, ethTXBroadcasts=ethTXBroadcasts, modemIndex=modemIndex, aTPCEntry=aTPCEntry, modemLDPCdecoderStress=modemLDPCdecoderStress, localIp=localIp, modemACMethernetCapacity=modemACMethernetCapacity, sysDateAndTime=sysDateAndTime, description=description, ipRadioCfgGeneral=ipRadioCfgGeneral, radioRxFrequency=radioRxFrequency, microwaveRadio=microwaveRadio, writeConfig=writeConfig, ipRadioStat=ipRadioStat, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethGFPFCSErrors=ethGFPFCSErrors, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemACMtotalCapacity=modemACMtotalCapacity, radioGenStatus=radioGenStatus, ipRadioCfg=ipRadioCfg, modemLastAcqError=modemLastAcqError, modemEntry=modemEntry, ipRadioMgmt=ipRadioMgmt, ethRXByteCounterHi=ethRXByteCounterHi, modemTotalCapacity=modemTotalCapacity, ipRadio=ipRadio, vlanTable=vlanTable, restartcpu=restartcpu, modemE1T1Channels=modemE1T1Channels, modemACMmodulationMin=modemACMmodulationMin, radioTable=radioTable, radioTxMute=radioTxMute, modemGeneralStatus=modemGeneralStatus, radioSide=radioSide, modemBandwith=modemBandwith, ethTXBackpresEvents=ethTXBackpresEvents, ethQOSTXDropped=ethQOSTXDropped, ethTXLengthCheckErrors=ethTXLengthCheckErrors, localIpMask=localIpMask, modemRowStatus=modemRowStatus, vlanPortmap=vlanPortmap, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemErroredBlock=modemErroredBlock, ipRadioCfgNetwork=ipRadioCfgNetwork, vlanNumber=vlanNumber)
