...
mibBuilder.exportSymbols("SAF-IPRADIO", pointToPoint=pointToPoint, sysTemperature=sysTemperature, ethRXTruncatedFrames=ethRXTruncatedFrames, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXControlFrames=ethTXControlFrames, remoteIp=remoteIp, ethTXBroadcasts=ethTXBroadcasts, radioIndex=radioIndex, ethTXGiants=ethTXGiants, ethQOSTXDropped=ethQOSTXDropped, modemTotalBlockNumber=modemTotalBlockNumber, e1t1AIS=e1t1AIS, modemStatistics=modemStatistics, restartcpu=restartcpu, vlanPortType=vlanPortType, modemLastAcqError=modemLastAcqError, radioTable=radioTable, modemSymbolRateTx=modemSymbolRateTx, ethRXLongEvents=ethRXLongEvents, ethRXDvEvent=ethRXDvEvent, ethRXByteCounterLow=ethRXByteCounterLow, ethTXUnderruns=ethTXUnderruns, radioTxPower=radioTxPower, radioGenStatus=radioGenStatus, vlanEntry=vlanEntry, localIp=localIp, radioTxFrequency=radioTxFrequency, vlanCfgStat=vlanCfgStat, modemACMethernetCapacity=modemACMethernetCapacity, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemErroredSecond=modemErroredSecond, modemTotalCapacity=modemTotalCapacity, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXCollisions=ethTXCollisions, radioSide=radioSide, modemBandwith=modemBandwith, modemIndex=modemIndex, aTPCEntry=aTPCEntry, modemErroredSecondRatio=modemErroredSecondRatio, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXVlanTags=ethTXVlanTags, vlanTable=vlanTable, modemCountTime=modemCountTime, description=description, modemRowStatus=modemRowStatus, ethTXLateCollisions=ethTXLateCollisions, ethTXPauseFrames=ethTXPauseFrames, ipRadioCfg=ipRadioCfg, ethGFPCHECErrors=ethGFPCHECErrors, modemUnavailtime=modemUnavailtime, ethRXByteCounterHi=ethRXByteCounterHi, modemRadialMSE=modemRadialMSE, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXCRCErrors=ethTXCRCErrors, ethRXMulticasts=ethRXMulticasts, e1t1StatEntry=e1t1StatEntry, loopbacks=loopbacks, ethRXControlFrames=ethRXControlFrames, ethTXBackpresEvents=ethTXBackpresEvents, radioRxLevel=radioRxLevel, modemStandard=modemStandard, ethRXDones=ethRXDones, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXPauseFrames=ethRXPauseFrames, ethGFPDropedFrames=ethGFPDropedFrames, radioDuplexShift=radioDuplexShift, ethRXBroadcasts=ethRXBroadcasts, ethTXByteCounterLow=ethTXByteCounterLow, license=license, modemEthernetCapacity=modemEthernetCapacity, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethQOSTXFrames=ethQOSTXFrames, microwaveRadio=microwaveRadio, modemLDPCdecoderStress=modemLDPCdecoderStress, licenseMask=licenseMask, ethTXByteCounterHi=ethTXByteCounterHi, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemInternalAGCgain=modemInternalAGCgain, product=product, licenseUpdateStatus=licenseUpdateStatus, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemGeneralStatus=modemGeneralStatus, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlanRowStatus=vlanRowStatus, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXCRCErrors=ethRXCRCErrors, atpcEnabled=atpcEnabled, vlanPortmap=vlanPortmap, modemACMtotalCapacity=modemACMtotalCapacity, ipRadio=ipRadio, ethRXCodeErrors=ethRXCodeErrors, ethRXPrevPktDropped=ethRXPrevPktDropped, atpcIndex=atpcIndex, modemUptime=modemUptime, hostname=hostname, radioEntry=radioEntry, sysDateAndTime=sysDateAndTime, ipRadioMgmt=ipRadioMgmt, ethRXDribleNibbles=ethRXDribleNibbles, loopback_tributary_mask=loopback_tributary_mask, modemACMmodulationMax=modemACMmodulationMax, localIpMask=localIpMask, atpcTxPowerCorrection=atpcTxPowerCorrection, ipRadioCfgGeneral=ipRadioCfgGeneral, radioLoopback=radioLoopback, e1t1ChannelNr=e1t1ChannelNr, modemACMmodulationMin=modemACMmodulationMin, ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlanFid=vlanFid, saf=saf, ethTXMaxCollisions=ethTXMaxCollisions, ethTXDones=ethTXDones, modemEntry=modemEntry, ethGFPDelineationErrors=ethGFPDelineationErrors, aTPCTable=aTPCTable, ethGFPFCSErrors=ethGFPFCSErrors, radioTxMute=radioTxMute, modemCarrierOffset=modemCarrierOffset, modemAcqStatus=modemAcqStatus, ethTXMulticasts=ethTXMulticasts, writeConfig=writeConfig, radioRxFrequency=radioRxFrequency, e1t1StatTable=e1t1StatTable, ipRadioStatEth=ipRadioStatEth, modemE1T1Channels=modemE1T1Channels, modemErroredBlock=modemErroredBlock, modemTable=modemTable, vlansEnabled=vlansEnabled, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemModulation=modemModulation, ipRadioStat=ipRadioStat, modemACMengine=modemACMengine, safip=safip, e1t1LOS=e1t1LOS, tehnika=tehnika, ipRadioCfgNetwork=ipRadioCfgNetwork, modemSymbolRateRx=modemSymbolRateRx, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, vlanNumber=vlanNumber)
