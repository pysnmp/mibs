...
mibBuilder.exportSymbols("SAF-IPRADIO", saf=saf, ethTXMulticasts=ethTXMulticasts, modemACMethernetCapacity=modemACMethernetCapacity, safip=safip, radioTable=radioTable, ethTXWireByteCounterHi=ethTXWireByteCounterHi, vlanPortType=vlanPortType, modemSymbolRateTx=modemSymbolRateTx, modemTotalCapacity=modemTotalCapacity, microwaveRadio=microwaveRadio, radioEntry=radioEntry, atpcTxPowerCorrection=atpcTxPowerCorrection, modemLastAcqError=modemLastAcqError, radioTxMute=radioTxMute, licenseMask=licenseMask, modemIndex=modemIndex, ethTXMaxCollisions=ethTXMaxCollisions, modemBandwith=modemBandwith, ethRXTruncatedFrames=ethRXTruncatedFrames, modemCountTime=modemCountTime, vlanTable=vlanTable, e1t1StatEntry=e1t1StatEntry, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXBackpresEvents=ethTXBackpresEvents, atpcEnabled=atpcEnabled, ethTXLengthCheckErrors=ethTXLengthCheckErrors, restartcpu=restartcpu, modemGeneralStatus=modemGeneralStatus, radioIndex=radioIndex, ethGFPFCSErrors=ethGFPFCSErrors, radioRxFrequency=radioRxFrequency, vlansEnabled=vlansEnabled, ethTXDones=ethTXDones, ethTXCollisions=ethTXCollisions, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemCarrierOffset=modemCarrierOffset, ipRadioCfgGeneral=ipRadioCfgGeneral, localIpMask=localIpMask, modemACMengine=modemACMengine, modemInternalAGCgain=modemInternalAGCgain, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethGFPCHECErrors=ethGFPCHECErrors, ethTXByteCounterHi=ethTXByteCounterHi, radioLoopback=radioLoopback, ethRXLongEvents=ethRXLongEvents, ethTXUnderruns=ethTXUnderruns, modemModulation=modemModulation, pointToPoint=pointToPoint, description=description, modemRadialMSE=modemRadialMSE, modemErroredSecondRatio=modemErroredSecondRatio, license=license, modemACMmodulationMin=modemACMmodulationMin, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, sysTemperature=sysTemperature, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemSymbolRateRx=modemSymbolRateRx, ethTXCRCErrors=ethTXCRCErrors, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioRxLevel=radioRxLevel, modemAcqStatus=modemAcqStatus, ethRXDones=ethRXDones, modemACMtotalCapacity=modemACMtotalCapacity, ipRadioMgmt=ipRadioMgmt, ethRXControlFrames=ethRXControlFrames, ethTXControlFrames=ethTXControlFrames, ethRXPrevPktDropped=ethRXPrevPktDropped, e1t1StatTable=e1t1StatTable, vlanNumber=vlanNumber, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemUptime=modemUptime, ethRXByteCounterLow=ethRXByteCounterLow, ethGFPDropedFrames=ethGFPDropedFrames, modemACMmodulationMax=modemACMmodulationMax, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemLDPCdecoderStress=modemLDPCdecoderStress, radioDuplexShift=radioDuplexShift, modemE1T1ChannelMask=modemE1T1ChannelMask, modemTotalBlockNumber=modemTotalBlockNumber, writeConfig=writeConfig, ethTXBroadcasts=ethTXBroadcasts, loopback_tributary_mask=loopback_tributary_mask, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXByteCounterLow=ethTXByteCounterLow, radioSide=radioSide, ethRXCRCErrors=ethRXCRCErrors, ethTXLateCollisions=ethTXLateCollisions, modemErroredBlock=modemErroredBlock, ethGFPDelineationErrors=ethGFPDelineationErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, sysDateAndTime=sysDateAndTime, modemUnavailtime=modemUnavailtime, localIp=localIp, modemStandard=modemStandard, hostname=hostname, ethTXVlanTags=ethTXVlanTags, ethTXExcessiveDefers=ethTXExcessiveDefers, product=product, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioTxFrequency=radioTxFrequency, modemRowStatus=modemRowStatus, ethRXCodeErrors=ethRXCodeErrors, ethQOSTXDropped=ethQOSTXDropped, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ipRadioCfgNetwork=ipRadioCfgNetwork, vlanEntry=vlanEntry, vlanFid=vlanFid, modemStatistics=modemStatistics, ipRadio=ipRadio, modemTable=modemTable, remoteIp=remoteIp, ethTXGiants=ethTXGiants, modemEntry=modemEntry, ethRXMulticasts=ethRXMulticasts, modemEthernetCapacity=modemEthernetCapacity, e1t1AIS=e1t1AIS, atpcIndex=atpcIndex, ipRadioCfg=ipRadioCfg, modemE1T1Channels=modemE1T1Channels, e1t1LOS=e1t1LOS, ethQOSTXFrames=ethQOSTXFrames, radioTxPower=radioTxPower, vlanRowStatus=vlanRowStatus, ipRadioStat=ipRadioStat, ethRXDvEvent=ethRXDvEvent, licenseUpdateStatus=licenseUpdateStatus, vlanCfgStat=vlanCfgStat, ethRXDribleNibbles=ethRXDribleNibbles, ethRXPauseFrames=ethRXPauseFrames, loopbacks=loopbacks, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, e1t1ChannelNr=e1t1ChannelNr, tehnika=tehnika, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioGenStatus=radioGenStatus, ethTXPauseFrames=ethTXPauseFrames, aTPCTable=aTPCTable, modemErroredSecond=modemErroredSecond, ipRadioStatEth=ipRadioStatEth, vlanPortmap=vlanPortmap, ethRXByteCounterHi=ethRXByteCounterHi, ethRXBroadcasts=ethRXBroadcasts, aTPCEntry=aTPCEntry)
