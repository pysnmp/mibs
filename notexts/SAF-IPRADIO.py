...
mibBuilder.exportSymbols("SAF-IPRADIO", ipRadio=ipRadio, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXCRCErrors=ethRXCRCErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemTotalCapacity=modemTotalCapacity, radioLoopback=radioLoopback, modemInternalAGCgain=modemInternalAGCgain, ethTXLateCollisions=ethTXLateCollisions, e1t1AIS=e1t1AIS, modemE1T1Channels=modemE1T1Channels, aTPCEntry=aTPCEntry, vlanCfgStat=vlanCfgStat, modemRadialMSE=modemRadialMSE, modemIndex=modemIndex, modemTotalBlockNumber=modemTotalBlockNumber, modemSymbolRateRx=modemSymbolRateRx, modemRowStatus=modemRowStatus, modemEntry=modemEntry, radioIndex=radioIndex, pointToPoint=pointToPoint, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXPauseFrames=ethTXPauseFrames, modemModulation=modemModulation, modemACMengine=modemACMengine, description=description, modemGeneralStatus=modemGeneralStatus, ethRXBroadcasts=ethRXBroadcasts, modemStatistics=modemStatistics, modemACMethernetCapacity=modemACMethernetCapacity, vlansEnabled=vlansEnabled, atpcIndex=atpcIndex, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, atpcEnabled=atpcEnabled, vlanFid=vlanFid, radioDuplexShift=radioDuplexShift, radioTxMute=radioTxMute, modemTable=modemTable, modemLastAcqError=modemLastAcqError, ethRXDvEvent=ethRXDvEvent, modemAcqStatus=modemAcqStatus, ethTXGiants=ethTXGiants, radioGenStatus=radioGenStatus, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ipRadioMgmt=ipRadioMgmt, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXMaxCollisions=ethTXMaxCollisions, e1t1StatTable=e1t1StatTable, ethQOSTXDropped=ethQOSTXDropped, vlanTable=vlanTable, ethTXByteCounterHi=ethTXByteCounterHi, tehnika=tehnika, product=product, ethGFPDelineationErrors=ethGFPDelineationErrors, vlanNumber=vlanNumber, licenseUpdateStatus=licenseUpdateStatus, ethTXCRCErrors=ethTXCRCErrors, ipRadioCfg=ipRadioCfg, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXControlFrames=ethRXControlFrames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemErroredSecond=modemErroredSecond, ethRXCodeErrors=ethRXCodeErrors, modemCountTime=modemCountTime, modemLDPCdecoderStress=modemLDPCdecoderStress, modemEthernetCapacity=modemEthernetCapacity, radioTable=radioTable, ethTXCollisions=ethTXCollisions, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXMulticasts=ethRXMulticasts, loopback_tributary_mask=loopback_tributary_mask, ethRXLongEvents=ethRXLongEvents, ethTXDones=ethTXDones, modemACMmodulationMax=modemACMmodulationMax, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioTxPower=radioTxPower, localIpMask=localIpMask, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXPauseFrames=ethRXPauseFrames, ethTXVlanTags=ethTXVlanTags, modemUptime=modemUptime, ethRXDones=ethRXDones, licenseMask=licenseMask, ethRXByteCounterLow=ethRXByteCounterLow, e1t1StatEntry=e1t1StatEntry, loopbacks=loopbacks, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXExcessiveDefers=ethTXExcessiveDefers, vlanEntry=vlanEntry, ethTXMulticasts=ethTXMulticasts, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethQOSTXFrames=ethQOSTXFrames, modemStandard=modemStandard, ethGFPFCSErrors=ethGFPFCSErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemErroredBlock=modemErroredBlock, ipRadioCfgGeneral=ipRadioCfgGeneral, modemSymbolRateTx=modemSymbolRateTx, ethRXPrevPktDropped=ethRXPrevPktDropped, modemErroredSecondRatio=modemErroredSecondRatio, radioRxLevel=radioRxLevel, modemUnavailtime=modemUnavailtime, atpcTxPowerCorrection=atpcTxPowerCorrection, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXBackpresEvents=ethTXBackpresEvents, modemACMtotalCapacity=modemACMtotalCapacity, ipRadioStat=ipRadioStat, e1t1LOS=e1t1LOS, ethRXByteCounterHi=ethRXByteCounterHi, ipRadioStatEth=ipRadioStatEth, sysTemperature=sysTemperature, saf=saf, aTPCTable=aTPCTable, modemCarrierOffset=modemCarrierOffset, restartcpu=restartcpu, ethGFPDropedFrames=ethGFPDropedFrames, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioSide=radioSide, license=license, vlanRowStatus=vlanRowStatus, ethTXControlFrames=ethTXControlFrames, writeConfig=writeConfig, ethTXByteCounterLow=ethTXByteCounterLow, e1t1ChannelNr=e1t1ChannelNr, microwaveRadio=microwaveRadio, ethTXBroadcasts=ethTXBroadcasts, radioEntry=radioEntry, ethTXUnderruns=ethTXUnderruns, radioTxFrequency=radioTxFrequency, localIp=localIp, vlanPortmap=vlanPortmap, radioRxFrequency=radioRxFrequency, ethRXDribleNibbles=ethRXDribleNibbles, vlanPortType=vlanPortType, modemACMmodulationMin=modemACMmodulationMin, hostname=hostname, sysDateAndTime=sysDateAndTime, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemBandwith=modemBandwith, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethGFPCHECErrors=ethGFPCHECErrors, ethRXVlanTagsDetected=ethRXVlanTagsDetected, remoteIp=remoteIp, safip=safip)
