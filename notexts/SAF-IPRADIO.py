...
mibBuilder.exportSymbols("SAF-IPRADIO", modemCarrierOffset=modemCarrierOffset, modemACMethernetCapacity=modemACMethernetCapacity, radioEntry=radioEntry, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemAcqStatus=modemAcqStatus, ipRadioCfg=ipRadioCfg, vlanEntry=vlanEntry, ethRXCRCErrors=ethRXCRCErrors, modemStandard=modemStandard, ethTXBroadcasts=ethTXBroadcasts, ethGFPFCSErrors=ethGFPFCSErrors, vlanRowStatus=vlanRowStatus, ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlanPortType=vlanPortType, licenseMask=licenseMask, ethRXMulticasts=ethRXMulticasts, aTPCEntry=aTPCEntry, modemStatistics=modemStatistics, sysDateAndTime=sysDateAndTime, e1t1StatEntry=e1t1StatEntry, ethRXControlFrames=ethRXControlFrames, ethQOSTXFrames=ethQOSTXFrames, tehnika=tehnika, sysTemperature=sysTemperature, ethTXMaxCollisions=ethTXMaxCollisions, microwaveRadio=microwaveRadio, modemGeneralStatus=modemGeneralStatus, radioLoopback=radioLoopback, ethRXPrevPktDropped=ethRXPrevPktDropped, modemACMmodulationMin=modemACMmodulationMin, modemEntry=modemEntry, ethTXControlFrames=ethTXControlFrames, modemErroredSecond=modemErroredSecond, vlanFid=vlanFid, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemE1T1Channels=modemE1T1Channels, restartcpu=restartcpu, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXVlanTags=ethTXVlanTags, modemUptime=modemUptime, ethTXBackpresEvents=ethTXBackpresEvents, ethQOSTXDropped=ethQOSTXDropped, radioSide=radioSide, ethRXByteCounterHi=ethRXByteCounterHi, pointToPoint=pointToPoint, ethQOSRXQ2Frames=ethQOSRXQ2Frames, e1t1AIS=e1t1AIS, safip=safip, description=description, ipRadioStatEth=ipRadioStatEth, modemLastAcqError=modemLastAcqError, ethRXLongEvents=ethRXLongEvents, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemACMengine=modemACMengine, radioTxMute=radioTxMute, ipRadioMgmt=ipRadioMgmt, ethRXDvEvent=ethRXDvEvent, loopbacks=loopbacks, radioTxPower=radioTxPower, localIpMask=localIpMask, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXByteCounterLow=ethTXByteCounterLow, vlansEnabled=vlansEnabled, vlanTable=vlanTable, ethTXGiants=ethTXGiants, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, localIp=localIp, ethRXTruncatedFrames=ethRXTruncatedFrames, remoteIp=remoteIp, ethRXByteCounterLow=ethRXByteCounterLow, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXLateCollisions=ethTXLateCollisions, modemTotalCapacity=modemTotalCapacity, product=product, ethTXByteCounterHi=ethTXByteCounterHi, ipRadioCfgNetwork=ipRadioCfgNetwork, e1t1ChannelNr=e1t1ChannelNr, radioGenStatus=radioGenStatus, ipRadio=ipRadio, ethRXBroadcasts=ethRXBroadcasts, atpcIndex=atpcIndex, modemACMmodulationMax=modemACMmodulationMax, ipRadioCfgGeneral=ipRadioCfgGeneral, modemE1T1ChannelMask=modemE1T1ChannelMask, modemTable=modemTable, modemErroredBlock=modemErroredBlock, ethGFPCHECErrors=ethGFPCHECErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemBandwith=modemBandwith, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, licenseUpdateStatus=licenseUpdateStatus, atpcTxPowerCorrection=atpcTxPowerCorrection, vlanCfgStat=vlanCfgStat, hostname=hostname, radioTable=radioTable, modemSymbolRateRx=modemSymbolRateRx, ethTXCollisions=ethTXCollisions, modemModulation=modemModulation, modemLDPCdecoderStress=modemLDPCdecoderStress, vlanNumber=vlanNumber, ethRXDones=ethRXDones, modemErroredSecondRatio=modemErroredSecondRatio, saf=saf, ethRXCodeErrors=ethRXCodeErrors, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioIndex=radioIndex, ethTXMulticasts=ethTXMulticasts, vlanPortmap=vlanPortmap, atpcEnabled=atpcEnabled, ethTXPauseFrames=ethTXPauseFrames, ethTXUnderruns=ethTXUnderruns, ethRXPauseFrames=ethRXPauseFrames, ethTXWireByteCounterLow=ethTXWireByteCounterLow, loopback_tributary_mask=loopback_tributary_mask, modemSymbolRateTx=modemSymbolRateTx, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemUnavailtime=modemUnavailtime, modemEthernetCapacity=modemEthernetCapacity, ethGFPDelineationErrors=ethGFPDelineationErrors, modemInternalAGCgain=modemInternalAGCgain, radioTxFrequency=radioTxFrequency, aTPCTable=aTPCTable, writeConfig=writeConfig, modemRowStatus=modemRowStatus, ipRadioStat=ipRadioStat, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXDones=ethTXDones, modemCountTime=modemCountTime, radioRxLevel=radioRxLevel, ethRXDribleNibbles=ethRXDribleNibbles, ethTXCRCErrors=ethTXCRCErrors, e1t1LOS=e1t1LOS, modemTotalBlockNumber=modemTotalBlockNumber, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioRxFrequency=radioRxFrequency, ethGFPDropedFrames=ethGFPDropedFrames, e1t1StatTable=e1t1StatTable, modemACMtotalCapacity=modemACMtotalCapacity, modemIndex=modemIndex, license=license, modemRadialMSE=modemRadialMSE, radioDuplexShift=radioDuplexShift)
