...
mibBuilder.exportSymbols("SAF-IPRADIO", modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXControlFrames=ethTXControlFrames, writeConfig=writeConfig, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXDones=ethRXDones, ethTXBackpresEvents=ethTXBackpresEvents, modemIndex=modemIndex, modemUnavailtime=modemUnavailtime, atpcEnabled=atpcEnabled, ethRXDribleNibbles=ethRXDribleNibbles, radioGenStatus=radioGenStatus, modemBandwith=modemBandwith, modemStandard=modemStandard, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemACMethernetCapacity=modemACMethernetCapacity, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXByteCounterLow=ethTXByteCounterLow, tehnika=tehnika, radioLoopback=radioLoopback, ethGFPCHECErrors=ethGFPCHECErrors, e1t1AIS=e1t1AIS, modemEthernetCapacity=modemEthernetCapacity, radioIndex=radioIndex, vlanRowStatus=vlanRowStatus, ethRXCRCErrors=ethRXCRCErrors, ethTXBroadcasts=ethTXBroadcasts, ethTXLengthCheckErrors=ethTXLengthCheckErrors, radioEntry=radioEntry, safip=safip, vlanEntry=vlanEntry, remoteIp=remoteIp, modemEntry=modemEntry, ethQOSRXQ2Frames=ethQOSRXQ2Frames, loopback_tributary_mask=loopback_tributary_mask, radioTxPower=radioTxPower, ipRadioCfgGeneral=ipRadioCfgGeneral, vlansEnabled=vlansEnabled, vlanTable=vlanTable, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemErroredSecond=modemErroredSecond, modemCarrierOffset=modemCarrierOffset, microwaveRadio=microwaveRadio, ethRXDvEvent=ethRXDvEvent, radioTxMute=radioTxMute, modemTable=modemTable, modemErroredSecondRatio=modemErroredSecondRatio, ethRXByteCounterLow=ethRXByteCounterLow, saf=saf, modemStatistics=modemStatistics, ethTXCRCErrors=ethTXCRCErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, vlanPortmap=vlanPortmap, ethRXBroadcasts=ethRXBroadcasts, sysDateAndTime=sysDateAndTime, vlanCfgStat=vlanCfgStat, modemAcqStatus=modemAcqStatus, ethTXPauseFrames=ethTXPauseFrames, radioRxFrequency=radioRxFrequency, modemE1T1Channels=modemE1T1Channels, ethRXByteCounterHi=ethRXByteCounterHi, radioSide=radioSide, aTPCTable=aTPCTable, modemLastAcqError=modemLastAcqError, license=license, ethTXVlanTags=ethTXVlanTags, ethQOSTXDropped=ethQOSTXDropped, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethGFPFCSErrors=ethGFPFCSErrors, localIpMask=localIpMask, ethRXLongEvents=ethRXLongEvents, ethTXUnderruns=ethTXUnderruns, ethTXLateCollisions=ethTXLateCollisions, radioDuplexShift=radioDuplexShift, aTPCEntry=aTPCEntry, modemRadialMSE=modemRadialMSE, ipRadio=ipRadio, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXExcessiveDefers=ethTXExcessiveDefers, modemSymbolRateTx=modemSymbolRateTx, ethRXMulticasts=ethRXMulticasts, ethRXCodeErrors=ethRXCodeErrors, ethGFPDropedFrames=ethGFPDropedFrames, e1t1ChannelNr=e1t1ChannelNr, modemUptime=modemUptime, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXCollisions=ethTXCollisions, ipRadioMgmt=ipRadioMgmt, ethTXWireByteCounterHi=ethTXWireByteCounterHi, localIp=localIp, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXDones=ethTXDones, radioRxLevel=radioRxLevel, e1t1StatTable=e1t1StatTable, modemE1T1ChannelMask=modemE1T1ChannelMask, loopbacks=loopbacks, ethTXMaxCollisions=ethTXMaxCollisions, sysTemperature=sysTemperature, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemCountTime=modemCountTime, pointToPoint=pointToPoint, modemErroredBlock=modemErroredBlock, modemTotalBlockNumber=modemTotalBlockNumber, ethRXVlanTagsDetected=ethRXVlanTagsDetected, vlanNumber=vlanNumber, modemACMmodulationMax=modemACMmodulationMax, modemInternalAGCgain=modemInternalAGCgain, atpcIndex=atpcIndex, vlanPortType=vlanPortType, modemSymbolRateRx=modemSymbolRateRx, ipRadioCfg=ipRadioCfg, product=product, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXByteCounterHi=ethTXByteCounterHi, licenseMask=licenseMask, modemTotalCapacity=modemTotalCapacity, e1t1StatEntry=e1t1StatEntry, ethRXControlFrames=ethRXControlFrames, radioTable=radioTable, modemModulation=modemModulation, ipRadioStat=ipRadioStat, modemACMtotalCapacity=modemACMtotalCapacity, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, description=description, modemGeneralStatus=modemGeneralStatus, modemRowStatus=modemRowStatus, hostname=hostname, ipRadioStatEth=ipRadioStatEth, modemACMmodulationMin=modemACMmodulationMin, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, e1t1LOS=e1t1LOS, ethTXGiants=ethTXGiants, vlanFid=vlanFid, modemACMengine=modemACMengine, ethQOSTXFrames=ethQOSTXFrames, licenseUpdateStatus=licenseUpdateStatus, ethRXPauseFrames=ethRXPauseFrames, ethTXMulticasts=ethTXMulticasts, restartcpu=restartcpu, radioTxFrequency=radioTxFrequency)
