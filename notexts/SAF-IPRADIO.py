...
mibBuilder.exportSymbols("SAF-IPRADIO", ipRadioStat=ipRadioStat, licenseMask=licenseMask, ethGFPFCSErrors=ethGFPFCSErrors, e1t1ChannelNr=e1t1ChannelNr, license=license, modemEthernetCapacity=modemEthernetCapacity, ethRXCodeErrors=ethRXCodeErrors, radioDuplexShift=radioDuplexShift, radioTxMute=radioTxMute, product=product, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadioCfgNetwork=ipRadioCfgNetwork, vlanTable=vlanTable, ethTXControlFrames=ethTXControlFrames, ethQOSTXFrames=ethQOSTXFrames, ethTXMulticasts=ethTXMulticasts, radioRxLevel=radioRxLevel, hostname=hostname, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXCRCErrors=ethTXCRCErrors, modemSymbolRateTx=modemSymbolRateTx, ethTXBackpresEvents=ethTXBackpresEvents, radioTable=radioTable, modemErroredBlock=modemErroredBlock, e1t1StatTable=e1t1StatTable, modemLastAcqError=modemLastAcqError, tehnika=tehnika, vlanPortType=vlanPortType, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXDones=ethRXDones, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXCollisions=ethTXCollisions, modemACMethernetCapacity=modemACMethernetCapacity, ethRXDribleNibbles=ethRXDribleNibbles, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXByteCounterHi=ethRXByteCounterHi, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, atpcTxPowerCorrection=atpcTxPowerCorrection, modemIndex=modemIndex, modemTotalCapacity=modemTotalCapacity, ethRXBroadcasts=ethRXBroadcasts, ethGFPCHECErrors=ethGFPCHECErrors, microwaveRadio=microwaveRadio, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemTotalBlockNumber=modemTotalBlockNumber, saf=saf, modemRadialMSE=modemRadialMSE, modemStatistics=modemStatistics, ethRXPrevPktDropped=ethRXPrevPktDropped, ethQOSRXQ1Frames=ethQOSRXQ1Frames, restartcpu=restartcpu, modemACMengine=modemACMengine, vlansEnabled=vlansEnabled, vlanCfgStat=vlanCfgStat, ethTXDones=ethTXDones, modemTable=modemTable, modemStandard=modemStandard, ethRXLongEvents=ethRXLongEvents, modemE1T1Channels=modemE1T1Channels, vlanNumber=vlanNumber, ethRXDvEvent=ethRXDvEvent, sysDateAndTime=sysDateAndTime, ipRadio=ipRadio, radioLoopback=radioLoopback, modemModulation=modemModulation, modemLDPCdecoderStress=modemLDPCdecoderStress, ipRadioMgmt=ipRadioMgmt, ethGFPDropedFrames=ethGFPDropedFrames, ethTXLateCollisions=ethTXLateCollisions, ethTXPauseFrames=ethTXPauseFrames, ethTXVlanTags=ethTXVlanTags, modemUptime=modemUptime, description=description, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemACMmodulationMin=modemACMmodulationMin, ipRadioCfg=ipRadioCfg, localIpMask=localIpMask, ethRXControlFrames=ethRXControlFrames, ethTXByteCounterHi=ethTXByteCounterHi, ethRXCRCErrors=ethRXCRCErrors, vlanPortmap=vlanPortmap, vlanEntry=vlanEntry, ethRXByteCounterLow=ethRXByteCounterLow, modemGeneralStatus=modemGeneralStatus, ethQOSTXDropped=ethQOSTXDropped, modemErroredSecondRatio=modemErroredSecondRatio, ethRXTruncatedFrames=ethRXTruncatedFrames, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXExcessiveDefers=ethTXExcessiveDefers, remoteIp=remoteIp, modemAcqStatus=modemAcqStatus, radioGenStatus=radioGenStatus, licenseUpdateStatus=licenseUpdateStatus, radioTxPower=radioTxPower, e1t1LOS=e1t1LOS, sysTemperature=sysTemperature, radioTxFrequency=radioTxFrequency, modemSymbolRateRx=modemSymbolRateRx, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemACMmodulationMax=modemACMmodulationMax, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, aTPCEntry=aTPCEntry, pointToPoint=pointToPoint, radioSide=radioSide, e1t1StatEntry=e1t1StatEntry, writeConfig=writeConfig, ethTXGiants=ethTXGiants, modemCarrierOffset=modemCarrierOffset, ethTXBroadcasts=ethTXBroadcasts, loopback_tributary_mask=loopback_tributary_mask, loopbacks=loopbacks, ethTXByteCounterLow=ethTXByteCounterLow, modemBandwith=modemBandwith, modemCountTime=modemCountTime, vlanRowStatus=vlanRowStatus, atpcIndex=atpcIndex, modemACMtotalCapacity=modemACMtotalCapacity, aTPCTable=aTPCTable, ethTXUnderruns=ethTXUnderruns, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, e1t1AIS=e1t1AIS, vlanFid=vlanFid, ipRadioStatEth=ipRadioStatEth, modemE1T1ChannelMask=modemE1T1ChannelMask, modemEntry=modemEntry, atpcEnabled=atpcEnabled, radioEntry=radioEntry, localIp=localIp, ethRXMulticasts=ethRXMulticasts, modemUnavailtime=modemUnavailtime, modemRowStatus=modemRowStatus, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, safip=safip, modemErroredSecond=modemErroredSecond, ethRXPauseFrames=ethRXPauseFrames, ethTXMaxCollisions=ethTXMaxCollisions, radioIndex=radioIndex, radioRxFrequency=radioRxFrequency, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemInternalAGCgain=modemInternalAGCgain)
