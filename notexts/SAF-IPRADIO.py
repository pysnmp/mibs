...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXPauseFrames=ethTXPauseFrames, safip=safip, microwaveRadio=microwaveRadio, modemEthernetCapacity=modemEthernetCapacity, modemACMmodulationMin=modemACMmodulationMin, modemErroredSecondRatio=modemErroredSecondRatio, ethRXCodeErrors=ethRXCodeErrors, modemUnavailtime=modemUnavailtime, modemACMtotalCapacity=modemACMtotalCapacity, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ipRadioStat=ipRadioStat, modemACMengine=modemACMengine, sysDateAndTime=sysDateAndTime, saf=saf, ethQOSRXQ1Frames=ethQOSRXQ1Frames, e1t1StatTable=e1t1StatTable, modemErroredBlock=modemErroredBlock, ethRXDvEvent=ethRXDvEvent, ethRXByteCounterHi=ethRXByteCounterHi, atpcEnabled=atpcEnabled, e1t1LOS=e1t1LOS, ethGFPCHECErrors=ethGFPCHECErrors, radioTxMute=radioTxMute, vlanFid=vlanFid, ethTXExcessiveDefers=ethTXExcessiveDefers, loopbacks=loopbacks, modemCountTime=modemCountTime, ethTXMulticasts=ethTXMulticasts, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ipRadio=ipRadio, ethTXGiants=ethTXGiants, e1t1ChannelNr=e1t1ChannelNr, modemTotalCapacity=modemTotalCapacity, ethRXPauseFrames=ethRXPauseFrames, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ipRadioCfgGeneral=ipRadioCfgGeneral, vlanNumber=vlanNumber, writeConfig=writeConfig, atpcIndex=atpcIndex, ethRXDones=ethRXDones, restartcpu=restartcpu, ethQOSTXFrames=ethQOSTXFrames, e1t1StatEntry=e1t1StatEntry, licenseMask=licenseMask, modemACMmodulationMax=modemACMmodulationMax, modemStatistics=modemStatistics, vlanTable=vlanTable, modemLDPCdecoderStress=modemLDPCdecoderStress, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemTable=modemTable, modemACMethernetCapacity=modemACMethernetCapacity, radioEntry=radioEntry, tehnika=tehnika, ethQOSTXDropped=ethQOSTXDropped, ethTXByteCounterLow=ethTXByteCounterLow, modemSymbolRateTx=modemSymbolRateTx, radioGenStatus=radioGenStatus, modemInternalAGCgain=modemInternalAGCgain, vlansEnabled=vlansEnabled, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXTruncatedFrames=ethRXTruncatedFrames, vlanPortType=vlanPortType, vlanCfgStat=vlanCfgStat, license=license, ethTXCRCErrors=ethTXCRCErrors, radioRxLevel=radioRxLevel, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioTxFrequency=radioTxFrequency, ethTXUnderruns=ethTXUnderruns, ethRXPrevPktDropped=ethRXPrevPktDropped, modemStandard=modemStandard, ethGFPDelineationErrors=ethGFPDelineationErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXVlanTags=ethTXVlanTags, licenseUpdateStatus=licenseUpdateStatus, radioDuplexShift=radioDuplexShift, radioIndex=radioIndex, modemGeneralStatus=modemGeneralStatus, radioTxPower=radioTxPower, radioSide=radioSide, modemAcqStatus=modemAcqStatus, ipRadioMgmt=ipRadioMgmt, ipRadioCfg=ipRadioCfg, modemEntry=modemEntry, modemIndex=modemIndex, vlanRowStatus=vlanRowStatus, product=product, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXLongEvents=ethRXLongEvents, ethRXMulticasts=ethRXMulticasts, vlanEntry=vlanEntry, description=description, aTPCEntry=aTPCEntry, modemCarrierOffset=modemCarrierOffset, ethTXControlFrames=ethTXControlFrames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, aTPCTable=aTPCTable, ethGFPFCSErrors=ethGFPFCSErrors, modemModulation=modemModulation, modemBandwith=modemBandwith, ethRXByteCounterLow=ethRXByteCounterLow, ethTXWireByteCounterHi=ethTXWireByteCounterHi, remoteIp=remoteIp, ethTXByteCounterHi=ethTXByteCounterHi, radioTable=radioTable, sysTemperature=sysTemperature, ethTXBroadcasts=ethTXBroadcasts, vlanPortmap=vlanPortmap, modemRowStatus=modemRowStatus, ethTXBackpresEvents=ethTXBackpresEvents, ethTXDones=ethTXDones, ipRadioCfgNetwork=ipRadioCfgNetwork, modemSymbolRateRx=modemSymbolRateRx, ethTXCollisions=ethTXCollisions, ethTXMaxCollisions=ethTXMaxCollisions, ipRadioStatEth=ipRadioStatEth, atpcTxPowerCorrection=atpcTxPowerCorrection, e1t1AIS=e1t1AIS, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethGFPDropedFrames=ethGFPDropedFrames, modemUptime=modemUptime, modemE1T1Channels=modemE1T1Channels, ethRXControlFrames=ethRXControlFrames, localIp=localIp, loopback_tributary_mask=loopback_tributary_mask, ethRXCRCErrors=ethRXCRCErrors, ethTXLateCollisions=ethTXLateCollisions, modemTotalBlockNumber=modemTotalBlockNumber, radioRxFrequency=radioRxFrequency, modemRadialMSE=modemRadialMSE, modemLastAcqError=modemLastAcqError, ethTXWireByteCounterLow=ethTXWireByteCounterLow, hostname=hostname, localIpMask=localIpMask, radioLoopback=radioLoopback, ethRXBroadcasts=ethRXBroadcasts, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, pointToPoint=pointToPoint, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXDribleNibbles=ethRXDribleNibbles, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemErroredSecond=modemErroredSecond)
