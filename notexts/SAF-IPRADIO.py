...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXLateCollisions=ethTXLateCollisions, modemE1T1ChannelMask=modemE1T1ChannelMask, ipRadioCfg=ipRadioCfg, license=license, modemRowStatus=modemRowStatus, modemRadialMSE=modemRadialMSE, e1t1LOS=e1t1LOS, modemTotalCapacity=modemTotalCapacity, sysTemperature=sysTemperature, ethRXLongEvents=ethRXLongEvents, ethRXMulticasts=ethRXMulticasts, vlansEnabled=vlansEnabled, modemEntry=modemEntry, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXDones=ethTXDones, modemUnavailtime=modemUnavailtime, ethRXBroadcasts=ethRXBroadcasts, modemCountTime=modemCountTime, ethRXByteCounterLow=ethRXByteCounterLow, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemErroredSecondRatio=modemErroredSecondRatio, ethTXCRCErrors=ethTXCRCErrors, atpcIndex=atpcIndex, radioGenStatus=radioGenStatus, radioSide=radioSide, description=description, modemGeneralStatus=modemGeneralStatus, modemCarrierOffset=modemCarrierOffset, e1t1StatTable=e1t1StatTable, microwaveRadio=microwaveRadio, modemIndex=modemIndex, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlanEntry=vlanEntry, ipRadioMgmt=ipRadioMgmt, modemE1T1Channels=modemE1T1Channels, pointToPoint=pointToPoint, ethRXDvEvent=ethRXDvEvent, ethGFPDelineationErrors=ethGFPDelineationErrors, product=product, licenseMask=licenseMask, modemSymbolRateTx=modemSymbolRateTx, writeConfig=writeConfig, modemACMmodulationMax=modemACMmodulationMax, ethTXGiants=ethTXGiants, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemModulation=modemModulation, modemACMmodulationMin=modemACMmodulationMin, ethTXMulticasts=ethTXMulticasts, loopbacks=loopbacks, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, atpcTxPowerCorrection=atpcTxPowerCorrection, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXTruncatedFrames=ethRXTruncatedFrames, vlanNumber=vlanNumber, modemACMtotalCapacity=modemACMtotalCapacity, radioTable=radioTable, vlanPortType=vlanPortType, sysDateAndTime=sysDateAndTime, ethTXExcessiveDefers=ethTXExcessiveDefers, ethGFPFCSErrors=ethGFPFCSErrors, ethRXDribleNibbles=ethRXDribleNibbles, radioTxPower=radioTxPower, ipRadioCfgNetwork=ipRadioCfgNetwork, ethGFPCHECErrors=ethGFPCHECErrors, vlanPortmap=vlanPortmap, modemErroredBlock=modemErroredBlock, modemACMethernetCapacity=modemACMethernetCapacity, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethGFPDropedFrames=ethGFPDropedFrames, ipRadioStatEth=ipRadioStatEth, vlanCfgStat=vlanCfgStat, tehnika=tehnika, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemLastAcqError=modemLastAcqError, ethRXControlFrames=ethRXControlFrames, aTPCEntry=aTPCEntry, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXUnderruns=ethTXUnderruns, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioLoopback=radioLoopback, ethRXPauseFrames=ethRXPauseFrames, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, e1t1ChannelNr=e1t1ChannelNr, restartcpu=restartcpu, modemInternalAGCgain=modemInternalAGCgain, radioRxLevel=radioRxLevel, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, vlanRowStatus=vlanRowStatus, safip=safip, e1t1StatEntry=e1t1StatEntry, saf=saf, ipRadioStat=ipRadioStat, modemSymbolRateRx=modemSymbolRateRx, localIpMask=localIpMask, radioDuplexShift=radioDuplexShift, modemStandard=modemStandard, ethRXByteCounterHi=ethRXByteCounterHi, licenseUpdateStatus=licenseUpdateStatus, ethTXWireByteCounterLow=ethTXWireByteCounterLow, localIp=localIp, ethTXByteCounterHi=ethTXByteCounterHi, modemACMengine=modemACMengine, radioIndex=radioIndex, ethTXLengthCheckErrors=ethTXLengthCheckErrors, radioTxMute=radioTxMute, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, aTPCTable=aTPCTable, ethQOSTXFrames=ethQOSTXFrames, remoteIp=remoteIp, loopback_tributary_mask=loopback_tributary_mask, ethRXDones=ethRXDones, ethTXBackpresEvents=ethTXBackpresEvents, modemEthernetCapacity=modemEthernetCapacity, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXCodeErrors=ethRXCodeErrors, modemStatistics=modemStatistics, ethTXMaxCollisions=ethTXMaxCollisions, vlanFid=vlanFid, ethTXControlFrames=ethTXControlFrames, modemErroredSecond=modemErroredSecond, radioTxFrequency=radioTxFrequency, modemTotalBlockNumber=modemTotalBlockNumber, ethTXCollisions=ethTXCollisions, ethRXCRCErrors=ethRXCRCErrors, radioRxFrequency=radioRxFrequency, modemTable=modemTable, ethTXPauseFrames=ethTXPauseFrames, ethQOSTXDropped=ethQOSTXDropped, ethTXVlanTags=ethTXVlanTags, e1t1AIS=e1t1AIS, modemUptime=modemUptime, hostname=hostname, radioEntry=radioEntry, ipRadio=ipRadio, ethTXByteCounterLow=ethTXByteCounterLow, atpcEnabled=atpcEnabled, vlanTable=vlanTable, ethTXBroadcasts=ethTXBroadcasts, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemAcqStatus=modemAcqStatus, modemBandwith=modemBandwith)
