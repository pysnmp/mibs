...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXByteCounterHi=ethTXByteCounterHi, modemStandard=modemStandard, radioIndex=radioIndex, modemLastAcqError=modemLastAcqError, ipRadioStatEth=ipRadioStatEth, modemInternalAGCgain=modemInternalAGCgain, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethGFPDropedFrames=ethGFPDropedFrames, ethTXByteCounterLow=ethTXByteCounterLow, ipRadioStat=ipRadioStat, modemTotalBlockNumber=modemTotalBlockNumber, ethRXCRCErrors=ethRXCRCErrors, modemErroredSecond=modemErroredSecond, radioTxMute=radioTxMute, ethTXPauseFrames=ethTXPauseFrames, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXBackpresEvents=ethTXBackpresEvents, ethRXPrevPktDropped=ethRXPrevPktDropped, atpcIndex=atpcIndex, ethRXMulticasts=ethRXMulticasts, ethGFPCHECErrors=ethGFPCHECErrors, ethTXDones=ethTXDones, modemE1T1ChannelMask=modemE1T1ChannelMask, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, description=description, e1t1StatEntry=e1t1StatEntry, ipRadioCfgGeneral=ipRadioCfgGeneral, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemErroredBlock=modemErroredBlock, radioRxFrequency=radioRxFrequency, ethQOSTXDropped=ethQOSTXDropped, localIpMask=localIpMask, ethTXCRCErrors=ethTXCRCErrors, ethRXPauseFrames=ethRXPauseFrames, ethRXDribleNibbles=ethRXDribleNibbles, ethGFPFCSErrors=ethGFPFCSErrors, ethRXByteCounterLow=ethRXByteCounterLow, modemEthernetCapacity=modemEthernetCapacity, radioEntry=radioEntry, modemGeneralStatus=modemGeneralStatus, ethTXGiants=ethTXGiants, ethTXMaxCollisions=ethTXMaxCollisions, modemCountTime=modemCountTime, ethTXWireByteCounterHi=ethTXWireByteCounterHi, sysDateAndTime=sysDateAndTime, ethTXExcessiveDefers=ethTXExcessiveDefers, vlanEntry=vlanEntry, safip=safip, modemTable=modemTable, tehnika=tehnika, localIp=localIp, ethTXLateCollisions=ethTXLateCollisions, ethTXMulticasts=ethTXMulticasts, ethRXBroadcasts=ethRXBroadcasts, radioRxLevel=radioRxLevel, modemBandwith=modemBandwith, atpcEnabled=atpcEnabled, licenseMask=licenseMask, ipRadioCfgNetwork=ipRadioCfgNetwork, vlanFid=vlanFid, pointToPoint=pointToPoint, modemACMethernetCapacity=modemACMethernetCapacity, remoteIp=remoteIp, radioGenStatus=radioGenStatus, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemACMtotalCapacity=modemACMtotalCapacity, ethTXBroadcasts=ethTXBroadcasts, ethRXVlanTagsDetected=ethRXVlanTagsDetected, vlanRowStatus=vlanRowStatus, radioTxFrequency=radioTxFrequency, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlanTable=vlanTable, vlanNumber=vlanNumber, ethTXVlanTags=ethTXVlanTags, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXCodeErrors=ethRXCodeErrors, modemErroredSecondRatio=modemErroredSecondRatio, modemTotalCapacity=modemTotalCapacity, ethQOSTXFrames=ethQOSTXFrames, vlanCfgStat=vlanCfgStat, radioSide=radioSide, modemEntry=modemEntry, aTPCEntry=aTPCEntry, modemAcqStatus=modemAcqStatus, e1t1StatTable=e1t1StatTable, microwaveRadio=microwaveRadio, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioTable=radioTable, ethRXLongEvents=ethRXLongEvents, sysTemperature=sysTemperature, license=license, modemIndex=modemIndex, ethRXDones=ethRXDones, vlanPortmap=vlanPortmap, ethTXUnderruns=ethTXUnderruns, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, product=product, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemACMmodulationMin=modemACMmodulationMin, modemRadialMSE=modemRadialMSE, ethGFPDelineationErrors=ethGFPDelineationErrors, hostname=hostname, modemSymbolRateTx=modemSymbolRateTx, atpcTxPowerCorrection=atpcTxPowerCorrection, loopbacks=loopbacks, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemUnavailtime=modemUnavailtime, writeConfig=writeConfig, radioTxPower=radioTxPower, loopback_tributary_mask=loopback_tributary_mask, licenseUpdateStatus=licenseUpdateStatus, modemE1T1Channels=modemE1T1Channels, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemACMengine=modemACMengine, ipRadio=ipRadio, modemSymbolRateRx=modemSymbolRateRx, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXControlFrames=ethRXControlFrames, modemACMmodulationMax=modemACMmodulationMax, modemStatistics=modemStatistics, modemModulation=modemModulation, modemUptime=modemUptime, ethRXDvEvent=ethRXDvEvent, ipRadioCfg=ipRadioCfg, ethRXByteCounterHi=ethRXByteCounterHi, modemCarrierOffset=modemCarrierOffset, ethTXControlFrames=ethTXControlFrames, ipRadioMgmt=ipRadioMgmt, saf=saf, vlanPortType=vlanPortType, aTPCTable=aTPCTable, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXCollisions=ethTXCollisions, radioDuplexShift=radioDuplexShift, radioLoopback=radioLoopback, e1t1LOS=e1t1LOS, restartcpu=restartcpu, e1t1AIS=e1t1AIS, e1t1ChannelNr=e1t1ChannelNr, modemRowStatus=modemRowStatus, ethTXWireByteCounterLow=ethTXWireByteCounterLow, vlansEnabled=vlansEnabled)
