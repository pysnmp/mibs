...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXCodeErrors=ethRXCodeErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethGFPDelineationErrors=ethGFPDelineationErrors, modemCarrierOffset=modemCarrierOffset, modemRowStatus=modemRowStatus, sysTemperature=sysTemperature, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemRadialMSE=modemRadialMSE, radioTxPower=radioTxPower, modemSymbolRateRx=modemSymbolRateRx, pointToPoint=pointToPoint, radioDuplexShift=radioDuplexShift, atpcTxPowerCorrection=atpcTxPowerCorrection, modemLastAcqError=modemLastAcqError, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXGiants=ethTXGiants, radioIndex=radioIndex, modemE1T1Channels=modemE1T1Channels, ethTXControlFrames=ethTXControlFrames, writeConfig=writeConfig, radioGenStatus=radioGenStatus, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemInternalAGCgain=modemInternalAGCgain, ipRadioCfgNetwork=ipRadioCfgNetwork, modemUptime=modemUptime, modemACMethernetCapacity=modemACMethernetCapacity, modemEthernetCapacity=modemEthernetCapacity, modemErroredSecondRatio=modemErroredSecondRatio, ethTXVlanTags=ethTXVlanTags, ethTXByteCounterLow=ethTXByteCounterLow, localIpMask=localIpMask, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXBroadcasts=ethRXBroadcasts, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioLoopback=radioLoopback, ethTXCRCErrors=ethTXCRCErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, vlanRowStatus=vlanRowStatus, atpcEnabled=atpcEnabled, tehnika=tehnika, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXByteCounterHi=ethTXByteCounterHi, ethRXDribleNibbles=ethRXDribleNibbles, ipRadioStatEth=ipRadioStatEth, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXPauseFrames=ethRXPauseFrames, ethTXCollisions=ethTXCollisions, modemTotalBlockNumber=modemTotalBlockNumber, modemACMtotalCapacity=modemACMtotalCapacity, ethRXCRCErrors=ethRXCRCErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXDones=ethRXDones, radioTxFrequency=radioTxFrequency, ethTXMaxCollisions=ethTXMaxCollisions, remoteIp=remoteIp, atpcIndex=atpcIndex, restartcpu=restartcpu, modemModulation=modemModulation, modemGeneralStatus=modemGeneralStatus, e1t1StatTable=e1t1StatTable, ethRXMulticasts=ethRXMulticasts, modemTable=modemTable, ethTXMulticasts=ethTXMulticasts, modemACMmodulationMax=modemACMmodulationMax, modemE1T1ChannelMask=modemE1T1ChannelMask, sysDateAndTime=sysDateAndTime, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemUnavailtime=modemUnavailtime, radioRxLevel=radioRxLevel, ethGFPFCSErrors=ethGFPFCSErrors, license=license, radioTable=radioTable, vlanEntry=vlanEntry, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXPrevPktDropped=ethRXPrevPktDropped, safip=safip, e1t1StatEntry=e1t1StatEntry, ethQOSTXDropped=ethQOSTXDropped, radioTxMute=radioTxMute, vlanPortType=vlanPortType, ethRXVlanTagsDetected=ethRXVlanTagsDetected, vlanPortmap=vlanPortmap, aTPCTable=aTPCTable, ethTXPauseFrames=ethTXPauseFrames, radioSide=radioSide, modemCountTime=modemCountTime, ethQOSRXQ1Frames=ethQOSRXQ1Frames, licenseUpdateStatus=licenseUpdateStatus, loopbacks=loopbacks, ethRXLongEvents=ethRXLongEvents, modemBandwith=modemBandwith, microwaveRadio=microwaveRadio, ethTXUnderruns=ethTXUnderruns, radioEntry=radioEntry, ethRXByteCounterHi=ethRXByteCounterHi, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethGFPDropedFrames=ethGFPDropedFrames, modemACMengine=modemACMengine, modemIndex=modemIndex, licenseMask=licenseMask, e1t1AIS=e1t1AIS, modemErroredBlock=modemErroredBlock, ethTXBackpresEvents=ethTXBackpresEvents, modemACMmodulationMin=modemACMmodulationMin, hostname=hostname, modemEntry=modemEntry, ipRadioCfg=ipRadioCfg, modemSymbolRateTx=modemSymbolRateTx, vlansEnabled=vlansEnabled, ipRadioStat=ipRadioStat, description=description, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXDvEvent=ethRXDvEvent, modemTotalCapacity=modemTotalCapacity, localIp=localIp, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, e1t1LOS=e1t1LOS, ethTXLateCollisions=ethTXLateCollisions, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethQOSTXFrames=ethQOSTXFrames, aTPCEntry=aTPCEntry, ethRXUnsupOpcodes=ethRXUnsupOpcodes, saf=saf, ethGFPCHECErrors=ethGFPCHECErrors, vlanTable=vlanTable, modemStatistics=modemStatistics, modemStandard=modemStandard, loopback_tributary_mask=loopback_tributary_mask, ethTXDones=ethTXDones, ethRXControlFrames=ethRXControlFrames, ethTXBroadcasts=ethTXBroadcasts, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemAcqStatus=modemAcqStatus, modemErroredSecond=modemErroredSecond, vlanFid=vlanFid, radioRxFrequency=radioRxFrequency, e1t1ChannelNr=e1t1ChannelNr, ethRXByteCounterLow=ethRXByteCounterLow, ipRadioMgmt=ipRadioMgmt, vlanCfgStat=vlanCfgStat, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ipRadio=ipRadio, vlanNumber=vlanNumber, product=product)
