...
mibBuilder.exportSymbols("SAF-IPRADIO", vlanEntry=vlanEntry, ethRXByteCounterHi=ethRXByteCounterHi, e1t1StatTable=e1t1StatTable, radioIndex=radioIndex, radioEntry=radioEntry, tehnika=tehnika, modemBandwith=modemBandwith, ethRXCRCErrors=ethRXCRCErrors, ethGFPDelineationErrors=ethGFPDelineationErrors, remoteIp=remoteIp, saf=saf, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXPauseFrames=ethRXPauseFrames, ipRadioCfgGeneral=ipRadioCfgGeneral, atpcTxPowerCorrection=atpcTxPowerCorrection, ipRadioStatEth=ipRadioStatEth, vlanRowStatus=vlanRowStatus, modemE1T1ChannelMask=modemE1T1ChannelMask, ethGFPFCSErrors=ethGFPFCSErrors, modemErroredSecondRatio=modemErroredSecondRatio, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemRowStatus=modemRowStatus, ethTXPauseFrames=ethTXPauseFrames, ethRXDvEvent=ethRXDvEvent, vlanNumber=vlanNumber, radioDuplexShift=radioDuplexShift, license=license, ethRXTruncatedFrames=ethRXTruncatedFrames, modemCountTime=modemCountTime, loopbacks=loopbacks, vlanPortType=vlanPortType, modemUptime=modemUptime, radioTxPower=radioTxPower, ethTXBroadcasts=ethTXBroadcasts, aTPCEntry=aTPCEntry, ethTXUnderruns=ethTXUnderruns, ipRadioCfgNetwork=ipRadioCfgNetwork, radioRxFrequency=radioRxFrequency, e1t1StatEntry=e1t1StatEntry, ethTXDones=ethTXDones, ipRadio=ipRadio, modemSymbolRateTx=modemSymbolRateTx, modemUnavailtime=modemUnavailtime, ethQOSTXDropped=ethQOSTXDropped, modemACMmodulationMax=modemACMmodulationMax, modemErroredBlock=modemErroredBlock, ipRadioMgmt=ipRadioMgmt, radioTable=radioTable, modemStandard=modemStandard, modemIndex=modemIndex, atpcEnabled=atpcEnabled, modemACMtotalCapacity=modemACMtotalCapacity, ethTXCollisions=ethTXCollisions, ethTXMulticasts=ethTXMulticasts, ethTXBackpresEvents=ethTXBackpresEvents, modemTotalBlockNumber=modemTotalBlockNumber, radioRxLevel=radioRxLevel, e1t1LOS=e1t1LOS, ethTXControlFrames=ethTXControlFrames, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXDribleNibbles=ethRXDribleNibbles, modemSymbolRateRx=modemSymbolRateRx, vlanCfgStat=vlanCfgStat, microwaveRadio=microwaveRadio, product=product, ethRXLongEvents=ethRXLongEvents, modemGeneralStatus=modemGeneralStatus, localIp=localIp, modemACMmodulationMin=modemACMmodulationMin, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemAcqStatus=modemAcqStatus, ethRXBroadcasts=ethRXBroadcasts, sysDateAndTime=sysDateAndTime, atpcIndex=atpcIndex, ethTXWireByteCounterLow=ethTXWireByteCounterLow, licenseUpdateStatus=licenseUpdateStatus, sysTemperature=sysTemperature, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, vlanFid=vlanFid, modemInternalAGCgain=modemInternalAGCgain, modemACMengine=modemACMengine, ethRXMulticasts=ethRXMulticasts, modemSeverelyErroredSecond=modemSeverelyErroredSecond, writeConfig=writeConfig, vlanPortmap=vlanPortmap, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXExcessiveDefers=ethTXExcessiveDefers, modemStatistics=modemStatistics, modemTable=modemTable, modemEthernetCapacity=modemEthernetCapacity, ipRadioCfg=ipRadioCfg, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXByteCounterLow=ethTXByteCounterLow, ethTXVlanTags=ethTXVlanTags, modemACMethernetCapacity=modemACMethernetCapacity, ethTXMaxCollisions=ethTXMaxCollisions, modemErroredSecond=modemErroredSecond, ethRXDones=ethRXDones, ethRXControlFrames=ethRXControlFrames, ethGFPCHECErrors=ethGFPCHECErrors, modemLastAcqError=modemLastAcqError, radioSide=radioSide, localIpMask=localIpMask, ethTXGiants=ethTXGiants, loopback_tributary_mask=loopback_tributary_mask, ethQOSTXFrames=ethQOSTXFrames, licenseMask=licenseMask, modemTotalCapacity=modemTotalCapacity, ethRXByteCounterLow=ethRXByteCounterLow, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemEntry=modemEntry, ethTXWireByteCounterHi=ethTXWireByteCounterHi, hostname=hostname, modemModulation=modemModulation, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemRadialMSE=modemRadialMSE, radioGenStatus=radioGenStatus, ethGFPDropedFrames=ethGFPDropedFrames, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ipRadioStat=ipRadioStat, radioTxMute=radioTxMute, modemCarrierOffset=modemCarrierOffset, ethTXLateCollisions=ethTXLateCollisions, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, aTPCTable=aTPCTable, radioLoopback=radioLoopback, safip=safip, ethRXCodeErrors=ethRXCodeErrors, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXCRCErrors=ethTXCRCErrors, radioTxFrequency=radioTxFrequency, ethTXLengthCheckErrors=ethTXLengthCheckErrors, description=description, ethTXByteCounterHi=ethTXByteCounterHi, e1t1AIS=e1t1AIS, modemE1T1Channels=modemE1T1Channels, modemBackgroundBlockErrror=modemBackgroundBlockErrror, e1t1ChannelNr=e1t1ChannelNr, vlansEnabled=vlansEnabled, pointToPoint=pointToPoint, restartcpu=restartcpu, vlanTable=vlanTable)
