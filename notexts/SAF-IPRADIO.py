...
mibBuilder.exportSymbols("SAF-IPRADIO", radioLoopback=radioLoopback, e1t1LOS=e1t1LOS, ethRXUnsupOpcodes=ethRXUnsupOpcodes, atpcIndex=atpcIndex, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioSide=radioSide, ethRXPrevPktDropped=ethRXPrevPktDropped, modemSymbolRateRx=modemSymbolRateRx, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemLDPCdecoderStress=modemLDPCdecoderStress, radioGenStatus=radioGenStatus, atpcTxPowerCorrection=atpcTxPowerCorrection, licenseMask=licenseMask, ethTXControlFrames=ethTXControlFrames, ethGFPFCSErrors=ethGFPFCSErrors, ipRadioStat=ipRadioStat, ethTXPauseFrames=ethTXPauseFrames, pointToPoint=pointToPoint, ipRadioCfgNetwork=ipRadioCfgNetwork, modemTotalCapacity=modemTotalCapacity, modemCountTime=modemCountTime, radioEntry=radioEntry, license=license, ethTXCRCErrors=ethTXCRCErrors, ethTXLateCollisions=ethTXLateCollisions, ethRXByteCounterHi=ethRXByteCounterHi, hostname=hostname, ipRadioStatEth=ipRadioStatEth, restartcpu=restartcpu, modemE1T1ChannelMask=modemE1T1ChannelMask, e1t1ChannelNr=e1t1ChannelNr, ethRXBroadcasts=ethRXBroadcasts, ipRadioCfgGeneral=ipRadioCfgGeneral, loopbacks=loopbacks, radioTable=radioTable, ethTXDones=ethTXDones, aTPCTable=aTPCTable, ethTXMaxCollisions=ethTXMaxCollisions, ethRXByteCounterLow=ethRXByteCounterLow, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, description=description, vlanPortmap=vlanPortmap, vlanRowStatus=vlanRowStatus, ethTXGiants=ethTXGiants, modemStatistics=modemStatistics, loopback_tributary_mask=loopback_tributary_mask, modemTable=modemTable, ethRXControlFrames=ethRXControlFrames, modemCarrierOffset=modemCarrierOffset, licenseUpdateStatus=licenseUpdateStatus, e1t1StatTable=e1t1StatTable, vlanFid=vlanFid, modemGeneralStatus=modemGeneralStatus, modemACMmodulationMax=modemACMmodulationMax, ethRXCodeErrors=ethRXCodeErrors, ethRXCRCErrors=ethRXCRCErrors, safip=safip, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethQOSTXDropped=ethQOSTXDropped, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXMulticasts=ethTXMulticasts, modemAcqStatus=modemAcqStatus, ethTXCollisions=ethTXCollisions, modemInternalAGCgain=modemInternalAGCgain, vlanTable=vlanTable, modemE1T1Channels=modemE1T1Channels, modemACMtotalCapacity=modemACMtotalCapacity, ipRadioMgmt=ipRadioMgmt, radioRxLevel=radioRxLevel, radioTxFrequency=radioTxFrequency, modemErroredBlock=modemErroredBlock, ethRXDones=ethRXDones, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXBroadcasts=ethTXBroadcasts, ethTXByteCounterHi=ethTXByteCounterHi, ethTXByteCounterLow=ethTXByteCounterLow, ethRXLongEvents=ethRXLongEvents, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemStandard=modemStandard, sysDateAndTime=sysDateAndTime, modemRowStatus=modemRowStatus, ethRXDvEvent=ethRXDvEvent, atpcEnabled=atpcEnabled, modemBackgroundBlockErrror=modemBackgroundBlockErrror, e1t1AIS=e1t1AIS, ethGFPCHECErrors=ethGFPCHECErrors, tehnika=tehnika, ethTXBackpresEvents=ethTXBackpresEvents, ethGFPDelineationErrors=ethGFPDelineationErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethGFPDropedFrames=ethGFPDropedFrames, modemUnavailtime=modemUnavailtime, modemModulation=modemModulation, ipRadioCfg=ipRadioCfg, product=product, radioRxFrequency=radioRxFrequency, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioIndex=radioIndex, localIp=localIp, modemSymbolRateTx=modemSymbolRateTx, aTPCEntry=aTPCEntry, radioTxMute=radioTxMute, microwaveRadio=microwaveRadio, modemRadialMSE=modemRadialMSE, modemACMmodulationMin=modemACMmodulationMin, modemACMengine=modemACMengine, localIpMask=localIpMask, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemSeverelyErroredSecond=modemSeverelyErroredSecond, saf=saf, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemErroredSecondRatio=modemErroredSecondRatio, ethRXDribleNibbles=ethRXDribleNibbles, modemIndex=modemIndex, modemEthernetCapacity=modemEthernetCapacity, modemLastAcqError=modemLastAcqError, modemACMethernetCapacity=modemACMethernetCapacity, modemBandwith=modemBandwith, modemEntry=modemEntry, ethTXUnderruns=ethTXUnderruns, ethQOSTXFrames=ethQOSTXFrames, radioTxPower=radioTxPower, vlanEntry=vlanEntry, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, vlanCfgStat=vlanCfgStat, sysTemperature=sysTemperature, ipRadio=ipRadio, ethTXVlanTags=ethTXVlanTags, modemErroredSecond=modemErroredSecond, modemTotalBlockNumber=modemTotalBlockNumber, ethTXLengthCheckErrors=ethTXLengthCheckErrors, e1t1StatEntry=e1t1StatEntry, remoteIp=remoteIp, writeConfig=writeConfig, radioDuplexShift=radioDuplexShift, modemUptime=modemUptime, vlanPortType=vlanPortType, vlanNumber=vlanNumber, ethRXMulticasts=ethRXMulticasts, vlansEnabled=vlansEnabled, ethRXPauseFrames=ethRXPauseFrames)
