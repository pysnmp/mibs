...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXBackpresEvents=ethTXBackpresEvents, radioGenStatus=radioGenStatus, ethRXDones=ethRXDones, loopback_tributary_mask=loopback_tributary_mask, ethTXVlanTags=ethTXVlanTags, radioIndex=radioIndex, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioLoopback=radioLoopback, modemUnavailtime=modemUnavailtime, ethRXByteCounterLow=ethRXByteCounterLow, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemGeneralStatus=modemGeneralStatus, ipRadioCfgNetwork=ipRadioCfgNetwork, modemErroredSecond=modemErroredSecond, license=license, vlanPortType=vlanPortType, e1t1StatTable=e1t1StatTable, modemAcqStatus=modemAcqStatus, atpcIndex=atpcIndex, modemE1T1ChannelMask=modemE1T1ChannelMask, licenseMask=licenseMask, modemEntry=modemEntry, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemRowStatus=modemRowStatus, modemSymbolRateRx=modemSymbolRateRx, hostname=hostname, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioTxMute=radioTxMute, modemACMethernetCapacity=modemACMethernetCapacity, ethTXWireByteCounterHi=ethTXWireByteCounterHi, restartcpu=restartcpu, ethRXCRCErrors=ethRXCRCErrors, radioTable=radioTable, vlanEntry=vlanEntry, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlanFid=vlanFid, microwaveRadio=microwaveRadio, modemSymbolRateTx=modemSymbolRateTx, ethRXLongEvents=ethRXLongEvents, modemInternalAGCgain=modemInternalAGCgain, ethTXExcessiveDefers=ethTXExcessiveDefers, ipRadio=ipRadio, radioTxPower=radioTxPower, sysTemperature=sysTemperature, loopbacks=loopbacks, radioEntry=radioEntry, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioRxFrequency=radioRxFrequency, modemACMmodulationMax=modemACMmodulationMax, licenseUpdateStatus=licenseUpdateStatus, ethRXBroadcasts=ethRXBroadcasts, ethGFPDelineationErrors=ethGFPDelineationErrors, modemCarrierOffset=modemCarrierOffset, ipRadioCfgGeneral=ipRadioCfgGeneral, remoteIp=remoteIp, modemRadialMSE=modemRadialMSE, modemStandard=modemStandard, modemErroredSecondRatio=modemErroredSecondRatio, vlanPortmap=vlanPortmap, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioRxLevel=radioRxLevel, modemACMengine=modemACMengine, aTPCEntry=aTPCEntry, radioTxFrequency=radioTxFrequency, product=product, ethRXPauseFrames=ethRXPauseFrames, ethRXByteCounterHi=ethRXByteCounterHi, radioDuplexShift=radioDuplexShift, vlanRowStatus=vlanRowStatus, vlanCfgStat=vlanCfgStat, ethTXByteCounterLow=ethTXByteCounterLow, ethTXDones=ethTXDones, writeConfig=writeConfig, modemSeverelyErroredSecond=modemSeverelyErroredSecond, aTPCTable=aTPCTable, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXCollisions=ethTXCollisions, modemUptime=modemUptime, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXBroadcasts=ethTXBroadcasts, ethRXDvEvent=ethRXDvEvent, vlanTable=vlanTable, ipRadioMgmt=ipRadioMgmt, description=description, safip=safip, e1t1LOS=e1t1LOS, e1t1StatEntry=e1t1StatEntry, modemErroredBlock=modemErroredBlock, modemE1T1Channels=modemE1T1Channels, modemTable=modemTable, ipRadioStat=ipRadioStat, ethRXCodeErrors=ethRXCodeErrors, ethTXLateCollisions=ethTXLateCollisions, modemACMmodulationMin=modemACMmodulationMin, modemIndex=modemIndex, ipRadioCfg=ipRadioCfg, modemEthernetCapacity=modemEthernetCapacity, modemLDPCdecoderStress=modemLDPCdecoderStress, localIpMask=localIpMask, ethRXDribleNibbles=ethRXDribleNibbles, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXControlFrames=ethTXControlFrames, ipRadioStatEth=ipRadioStatEth, ethRXTruncatedFrames=ethRXTruncatedFrames, ethGFPDropedFrames=ethGFPDropedFrames, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, e1t1ChannelNr=e1t1ChannelNr, ethGFPFCSErrors=ethGFPFCSErrors, tehnika=tehnika, modemModulation=modemModulation, ethTXCRCErrors=ethTXCRCErrors, ethTXMaxCollisions=ethTXMaxCollisions, modemLastAcqError=modemLastAcqError, ethRXMulticasts=ethRXMulticasts, ethTXGiants=ethTXGiants, ethQOSTXFrames=ethQOSTXFrames, modemStatistics=modemStatistics, ethTXUnderruns=ethTXUnderruns, atpcEnabled=atpcEnabled, modemTotalCapacity=modemTotalCapacity, ethGFPCHECErrors=ethGFPCHECErrors, atpcTxPowerCorrection=atpcTxPowerCorrection, vlanNumber=vlanNumber, ethTXByteCounterHi=ethTXByteCounterHi, ethQOSTXDropped=ethQOSTXDropped, e1t1AIS=e1t1AIS, ethTXMulticasts=ethTXMulticasts, ethTXLengthCheckErrors=ethTXLengthCheckErrors, radioSide=radioSide, ethTXPauseFrames=ethTXPauseFrames, modemACMtotalCapacity=modemACMtotalCapacity, modemTotalBlockNumber=modemTotalBlockNumber, saf=saf, pointToPoint=pointToPoint, modemBandwith=modemBandwith, ethTXWireByteCounterLow=ethTXWireByteCounterLow, vlansEnabled=vlansEnabled, ethRXControlFrames=ethRXControlFrames, localIp=localIp, modemCountTime=modemCountTime, sysDateAndTime=sysDateAndTime)
