...
mibBuilder.exportSymbols("SAF-IPRADIO", modemTable=modemTable, ipRadioCfg=ipRadioCfg, ethRXLongEvents=ethRXLongEvents, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXVlanTags=ethTXVlanTags, ethQOSTXDropped=ethQOSTXDropped, vlanPortmap=vlanPortmap, e1t1ChannelNr=e1t1ChannelNr, vlanEntry=vlanEntry, modemGeneralStatus=modemGeneralStatus, modemACMethernetCapacity=modemACMethernetCapacity, vlanCfgStat=vlanCfgStat, loopbacks=loopbacks, modemLastAcqError=modemLastAcqError, vlanPortType=vlanPortType, ethGFPFCSErrors=ethGFPFCSErrors, hostname=hostname, modemSymbolRateTx=modemSymbolRateTx, modemInternalAGCgain=modemInternalAGCgain, modemRowStatus=modemRowStatus, radioTxMute=radioTxMute, ethRXBroadcasts=ethRXBroadcasts, remoteIp=remoteIp, e1t1StatEntry=e1t1StatEntry, ethTXBroadcasts=ethTXBroadcasts, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, loopback_tributary_mask=loopback_tributary_mask, ipRadioMgmt=ipRadioMgmt, modemStandard=modemStandard, atpcIndex=atpcIndex, ethRXCRCErrors=ethRXCRCErrors, modemCarrierOffset=modemCarrierOffset, aTPCTable=aTPCTable, sysTemperature=sysTemperature, modemACMmodulationMax=modemACMmodulationMax, ethTXLateCollisions=ethTXLateCollisions, ethRXMulticasts=ethRXMulticasts, radioIndex=radioIndex, ethRXCodeErrors=ethRXCodeErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioSide=radioSide, ethRXPauseFrames=ethRXPauseFrames, vlanNumber=vlanNumber, localIp=localIp, ipRadioStatEth=ipRadioStatEth, ethRXPrevPktDropped=ethRXPrevPktDropped, radioRxLevel=radioRxLevel, modemErroredSecondRatio=modemErroredSecondRatio, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemLDPCdecoderStress=modemLDPCdecoderStress, ipRadio=ipRadio, modemSymbolRateRx=modemSymbolRateRx, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXExcessiveDefers=ethTXExcessiveDefers, radioGenStatus=radioGenStatus, ethRXControlFrames=ethRXControlFrames, modemStatistics=modemStatistics, vlanRowStatus=vlanRowStatus, aTPCEntry=aTPCEntry, ethTXWireByteCounterHi=ethTXWireByteCounterHi, e1t1LOS=e1t1LOS, ethGFPCHECErrors=ethGFPCHECErrors, description=description, ethQOSTXFrames=ethQOSTXFrames, saf=saf, ethRXByteCounterLow=ethRXByteCounterLow, tehnika=tehnika, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXDones=ethTXDones, modemBackgroundBlockErrror=modemBackgroundBlockErrror, sysDateAndTime=sysDateAndTime, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemAcqStatus=modemAcqStatus, modemE1T1Channels=modemE1T1Channels, modemUptime=modemUptime, pointToPoint=pointToPoint, licenseMask=licenseMask, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethGFPDelineationErrors=ethGFPDelineationErrors, e1t1StatTable=e1t1StatTable, radioTxPower=radioTxPower, ethTXCollisions=ethTXCollisions, ethTXCRCErrors=ethTXCRCErrors, vlansEnabled=vlansEnabled, radioDuplexShift=radioDuplexShift, ethTXControlFrames=ethTXControlFrames, modemIndex=modemIndex, restartcpu=restartcpu, modemACMtotalCapacity=modemACMtotalCapacity, writeConfig=writeConfig, ethTXBackpresEvents=ethTXBackpresEvents, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemTotalBlockNumber=modemTotalBlockNumber, ethTXPauseFrames=ethTXPauseFrames, modemEntry=modemEntry, modemTotalCapacity=modemTotalCapacity, ethTXUnderruns=ethTXUnderruns, radioLoopback=radioLoopback, ethTXByteCounterHi=ethTXByteCounterHi, ipRadioCfgNetwork=ipRadioCfgNetwork, modemCountTime=modemCountTime, ipRadioStat=ipRadioStat, modemACMmodulationMin=modemACMmodulationMin, vlanTable=vlanTable, microwaveRadio=microwaveRadio, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioEntry=radioEntry, modemModulation=modemModulation, atpcEnabled=atpcEnabled, ethRXByteCounterHi=ethRXByteCounterHi, ethGFPDropedFrames=ethGFPDropedFrames, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXDones=ethRXDones, modemErroredSecond=modemErroredSecond, ethTXMulticasts=ethTXMulticasts, vlanFid=vlanFid, ethRXDribleNibbles=ethRXDribleNibbles, modemACMengine=modemACMengine, modemBandwith=modemBandwith, modemEthernetCapacity=modemEthernetCapacity, ethTXGiants=ethTXGiants, product=product, ethTXMaxCollisions=ethTXMaxCollisions, localIpMask=localIpMask, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioTxFrequency=radioTxFrequency, radioRxFrequency=radioRxFrequency, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, licenseUpdateStatus=licenseUpdateStatus, ethTXByteCounterLow=ethTXByteCounterLow, e1t1AIS=e1t1AIS, radioTable=radioTable, modemUnavailtime=modemUnavailtime, modemRadialMSE=modemRadialMSE, safip=safip, license=license, modemErroredBlock=modemErroredBlock, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXDvEvent=ethRXDvEvent)
