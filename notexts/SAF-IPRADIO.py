...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemRowStatus=modemRowStatus, ethRXDones=ethRXDones, ethTXByteCounterLow=ethTXByteCounterLow, vlansEnabled=vlansEnabled, ethTXGiants=ethTXGiants, ethRXDribleNibbles=ethRXDribleNibbles, vlanTable=vlanTable, ethRXPrevPktDropped=ethRXPrevPktDropped, modemLastAcqError=modemLastAcqError, modemSymbolRateTx=modemSymbolRateTx, description=description, ethGFPCHECErrors=ethGFPCHECErrors, modemUptime=modemUptime, ethGFPDropedFrames=ethGFPDropedFrames, e1t1StatTable=e1t1StatTable, tehnika=tehnika, radioTxPower=radioTxPower, ethRXCodeErrors=ethRXCodeErrors, ethTXByteCounterHi=ethTXByteCounterHi, atpcEnabled=atpcEnabled, vlanRowStatus=vlanRowStatus, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioEntry=radioEntry, radioSide=radioSide, ethRXBroadcasts=ethRXBroadcasts, ipRadioStat=ipRadioStat, radioTable=radioTable, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ipRadioMgmt=ipRadioMgmt, modemCountTime=modemCountTime, vlanFid=vlanFid, ethTXLateCollisions=ethTXLateCollisions, modemEntry=modemEntry, vlanNumber=vlanNumber, ethQOSTXDropped=ethQOSTXDropped, modemUnavailtime=modemUnavailtime, ipRadioCfgGeneral=ipRadioCfgGeneral, modemStatistics=modemStatistics, loopbacks=loopbacks, modemACMmodulationMin=modemACMmodulationMin, microwaveRadio=microwaveRadio, e1t1ChannelNr=e1t1ChannelNr, modemErroredBlock=modemErroredBlock, vlanPortType=vlanPortType, ethRXCRCErrors=ethRXCRCErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ipRadio=ipRadio, loopback_tributary_mask=loopback_tributary_mask, safip=safip, modemRadialMSE=modemRadialMSE, restartcpu=restartcpu, e1t1StatEntry=e1t1StatEntry, localIp=localIp, radioTxMute=radioTxMute, e1t1LOS=e1t1LOS, writeConfig=writeConfig, ethRXTruncatedFrames=ethRXTruncatedFrames, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioLoopback=radioLoopback, modemAcqStatus=modemAcqStatus, ethTXVlanTags=ethTXVlanTags, ethTXPauseFrames=ethTXPauseFrames, remoteIp=remoteIp, ethRXPauseFrames=ethRXPauseFrames, modemACMmodulationMax=modemACMmodulationMax, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXLongEvents=ethRXLongEvents, e1t1AIS=e1t1AIS, licenseUpdateStatus=licenseUpdateStatus, modemStandard=modemStandard, ethTXMulticasts=ethTXMulticasts, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemIndex=modemIndex, modemE1T1ChannelMask=modemE1T1ChannelMask, modemInternalAGCgain=modemInternalAGCgain, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXBroadcasts=ethTXBroadcasts, modemGeneralStatus=modemGeneralStatus, atpcIndex=atpcIndex, ethTXExcessiveDefers=ethTXExcessiveDefers, modemTable=modemTable, modemSeverelyErroredSecond=modemSeverelyErroredSecond, vlanEntry=vlanEntry, sysDateAndTime=sysDateAndTime, modemBandwith=modemBandwith, ethGFPDelineationErrors=ethGFPDelineationErrors, radioRxLevel=radioRxLevel, saf=saf, product=product, ethRXByteCounterLow=ethRXByteCounterLow, modemErroredSecondRatio=modemErroredSecondRatio, modemTotalCapacity=modemTotalCapacity, atpcTxPowerCorrection=atpcTxPowerCorrection, modemACMengine=modemACMengine, hostname=hostname, ethTXUnderruns=ethTXUnderruns, modemSymbolRateRx=modemSymbolRateRx, radioTxFrequency=radioTxFrequency, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemTotalBlockNumber=modemTotalBlockNumber, license=license, ethRXControlFrames=ethRXControlFrames, ethGFPFCSErrors=ethGFPFCSErrors, modemACMtotalCapacity=modemACMtotalCapacity, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethQOSTXFrames=ethQOSTXFrames, modemLDPCdecoderStress=modemLDPCdecoderStress, modemEthernetCapacity=modemEthernetCapacity, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, aTPCEntry=aTPCEntry, ipRadioCfg=ipRadioCfg, ipRadioStatEth=ipRadioStatEth, modemCarrierOffset=modemCarrierOffset, radioRxFrequency=radioRxFrequency, pointToPoint=pointToPoint, vlanPortmap=vlanPortmap, ethTXBackpresEvents=ethTXBackpresEvents, ethTXDones=ethTXDones, ethRXByteCounterHi=ethRXByteCounterHi, modemModulation=modemModulation, ipRadioCfgNetwork=ipRadioCfgNetwork, aTPCTable=aTPCTable, ethRXMulticasts=ethRXMulticasts, ethTXMaxCollisions=ethTXMaxCollisions, radioDuplexShift=radioDuplexShift, ethRXDvEvent=ethRXDvEvent, ethTXControlFrames=ethTXControlFrames, radioIndex=radioIndex, ethTXCRCErrors=ethTXCRCErrors, sysTemperature=sysTemperature, radioGenStatus=radioGenStatus, ethTXCollisions=ethTXCollisions, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, licenseMask=licenseMask, modemACMethernetCapacity=modemACMethernetCapacity, vlanCfgStat=vlanCfgStat, localIpMask=localIpMask, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemE1T1Channels=modemE1T1Channels, modemErroredSecond=modemErroredSecond, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors)
