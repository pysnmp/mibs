...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXCodeErrors=ethRXCodeErrors, modemGeneralStatus=modemGeneralStatus, ethRXDribleNibbles=ethRXDribleNibbles, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethGFPDropedFrames=ethGFPDropedFrames, modemErroredSecondRatio=modemErroredSecondRatio, modemSymbolRateTx=modemSymbolRateTx, tehnika=tehnika, radioRxFrequency=radioRxFrequency, vlanPortmap=vlanPortmap, ethTXMaxCollisions=ethTXMaxCollisions, ethTXDones=ethTXDones, modemACMethernetCapacity=modemACMethernetCapacity, ethRXCRCErrors=ethRXCRCErrors, ethTXControlFrames=ethTXControlFrames, atpcEnabled=atpcEnabled, radioDuplexShift=radioDuplexShift, loopbacks=loopbacks, sysTemperature=sysTemperature, ethGFPFCSErrors=ethGFPFCSErrors, e1t1StatEntry=e1t1StatEntry, ethRXTruncatedFrames=ethRXTruncatedFrames, vlanTable=vlanTable, writeConfig=writeConfig, modemIndex=modemIndex, ethRXDvEvent=ethRXDvEvent, vlanEntry=vlanEntry, product=product, ipRadioMgmt=ipRadioMgmt, aTPCTable=aTPCTable, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioTxPower=radioTxPower, microwaveRadio=microwaveRadio, licenseUpdateStatus=licenseUpdateStatus, radioEntry=radioEntry, modemTotalBlockNumber=modemTotalBlockNumber, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlanCfgStat=vlanCfgStat, ethRXPauseFrames=ethRXPauseFrames, sysDateAndTime=sysDateAndTime, modemSymbolRateRx=modemSymbolRateRx, vlanRowStatus=vlanRowStatus, modemEntry=modemEntry, ethRXByteCounterLow=ethRXByteCounterLow, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXCollisions=ethTXCollisions, e1t1AIS=e1t1AIS, modemACMtotalCapacity=modemACMtotalCapacity, radioSide=radioSide, ethTXGiants=ethTXGiants, radioTxFrequency=radioTxFrequency, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXLongEvents=ethRXLongEvents, ethRXControlFrames=ethRXControlFrames, saf=saf, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethQOSTXDropped=ethQOSTXDropped, ethRXMulticasts=ethRXMulticasts, modemInternalAGCgain=modemInternalAGCgain, modemErroredBlock=modemErroredBlock, radioTable=radioTable, modemACMmodulationMin=modemACMmodulationMin, safip=safip, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, pointToPoint=pointToPoint, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemE1T1ChannelMask=modemE1T1ChannelMask, vlanFid=vlanFid, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXPauseFrames=ethTXPauseFrames, modemUptime=modemUptime, ethRXBroadcasts=ethRXBroadcasts, radioGenStatus=radioGenStatus, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ipRadio=ipRadio, ethTXBroadcasts=ethTXBroadcasts, restartcpu=restartcpu, remoteIp=remoteIp, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXByteCounterHi=ethRXByteCounterHi, ethTXCRCErrors=ethTXCRCErrors, modemStandard=modemStandard, localIp=localIp, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXWireByteCounterLow=ethTXWireByteCounterLow, licenseMask=licenseMask, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXVlanTags=ethTXVlanTags, ethTXByteCounterLow=ethTXByteCounterLow, vlanNumber=vlanNumber, vlansEnabled=vlansEnabled, e1t1ChannelNr=e1t1ChannelNr, ipRadioStat=ipRadioStat, ipRadioStatEth=ipRadioStatEth, localIpMask=localIpMask, e1t1LOS=e1t1LOS, ipRadioCfgGeneral=ipRadioCfgGeneral, radioLoopback=radioLoopback, ethTXBackpresEvents=ethTXBackpresEvents, license=license, ethTXUnderruns=ethTXUnderruns, ethTXExcessiveDefers=ethTXExcessiveDefers, ethGFPCHECErrors=ethGFPCHECErrors, modemBandwith=modemBandwith, modemACMmodulationMax=modemACMmodulationMax, modemACMengine=modemACMengine, e1t1StatTable=e1t1StatTable, loopback_tributary_mask=loopback_tributary_mask, radioIndex=radioIndex, modemRowStatus=modemRowStatus, ethTXLateCollisions=ethTXLateCollisions, ethTXByteCounterHi=ethTXByteCounterHi, radioRxLevel=radioRxLevel, modemRadialMSE=modemRadialMSE, modemCarrierOffset=modemCarrierOffset, atpcIndex=atpcIndex, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethQOSTXFrames=ethQOSTXFrames, modemAcqStatus=modemAcqStatus, radioTxMute=radioTxMute, aTPCEntry=aTPCEntry, modemTable=modemTable, modemUnavailtime=modemUnavailtime, modemE1T1Channels=modemE1T1Channels, ethTXMulticasts=ethTXMulticasts, modemLastAcqError=modemLastAcqError, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, description=description, modemEthernetCapacity=modemEthernetCapacity, ethRXPrevPktDropped=ethRXPrevPktDropped, ipRadioCfg=ipRadioCfg, hostname=hostname, modemModulation=modemModulation, ethRXDones=ethRXDones, modemCountTime=modemCountTime, modemTotalCapacity=modemTotalCapacity, vlanPortType=vlanPortType, ipRadioCfgNetwork=ipRadioCfgNetwork, modemStatistics=modemStatistics, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemErroredSecond=modemErroredSecond)
