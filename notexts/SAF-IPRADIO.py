...
mibBuilder.exportSymbols("SAF-IPRADIO", modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXVlanTags=ethTXVlanTags, modemCountTime=modemCountTime, modemACMtotalCapacity=modemACMtotalCapacity, license=license, ethRXTruncatedFrames=ethRXTruncatedFrames, restartcpu=restartcpu, remoteIp=remoteIp, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXDones=ethTXDones, modemModulation=modemModulation, licenseMask=licenseMask, description=description, atpcEnabled=atpcEnabled, hostname=hostname, modemSymbolRateRx=modemSymbolRateRx, ethTXByteCounterLow=ethTXByteCounterLow, modemLDPCdecoderStress=modemLDPCdecoderStress, radioRxLevel=radioRxLevel, modemBandwith=modemBandwith, e1t1ChannelNr=e1t1ChannelNr, ethGFPFCSErrors=ethGFPFCSErrors, ethRXPrevPktDropped=ethRXPrevPktDropped, modemACMmodulationMax=modemACMmodulationMax, radioTable=radioTable, vlanPortType=vlanPortType, ethRXMulticasts=ethRXMulticasts, modemIndex=modemIndex, ipRadioCfgGeneral=ipRadioCfgGeneral, pointToPoint=pointToPoint, modemTable=modemTable, radioTxFrequency=radioTxFrequency, ipRadioCfgNetwork=ipRadioCfgNetwork, ethGFPCHECErrors=ethGFPCHECErrors, ethTXLateCollisions=ethTXLateCollisions, vlanCfgStat=vlanCfgStat, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemInternalAGCgain=modemInternalAGCgain, modemUptime=modemUptime, ethQOSRXQ1Frames=ethQOSRXQ1Frames, product=product, ethRXPauseFrames=ethRXPauseFrames, modemTotalBlockNumber=modemTotalBlockNumber, ethTXUnderruns=ethTXUnderruns, ipRadioCfg=ipRadioCfg, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlansEnabled=vlansEnabled, ethRXControlFrames=ethRXControlFrames, modemACMethernetCapacity=modemACMethernetCapacity, radioIndex=radioIndex, modemSymbolRateTx=modemSymbolRateTx, tehnika=tehnika, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, e1t1LOS=e1t1LOS, ethTXMulticasts=ethTXMulticasts, modemLastAcqError=modemLastAcqError, modemRowStatus=modemRowStatus, ethTXBackpresEvents=ethTXBackpresEvents, ipRadioStat=ipRadioStat, radioGenStatus=radioGenStatus, modemErroredBlock=modemErroredBlock, modemUnavailtime=modemUnavailtime, writeConfig=writeConfig, modemStandard=modemStandard, ethRXDribleNibbles=ethRXDribleNibbles, sysDateAndTime=sysDateAndTime, loopbacks=loopbacks, microwaveRadio=microwaveRadio, radioTxMute=radioTxMute, licenseUpdateStatus=licenseUpdateStatus, ethRXCRCErrors=ethRXCRCErrors, modemACMmodulationMin=modemACMmodulationMin, modemCarrierOffset=modemCarrierOffset, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXCodeErrors=ethRXCodeErrors, ethRXBroadcasts=ethRXBroadcasts, localIp=localIp, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXGiants=ethTXGiants, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemEntry=modemEntry, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioDuplexShift=radioDuplexShift, ethTXBroadcasts=ethTXBroadcasts, aTPCTable=aTPCTable, sysTemperature=sysTemperature, ethRXLongEvents=ethRXLongEvents, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemACMengine=modemACMengine, e1t1AIS=e1t1AIS, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXControlFrames=ethTXControlFrames, radioSide=radioSide, modemGeneralStatus=modemGeneralStatus, modemE1T1Channels=modemE1T1Channels, modemStatistics=modemStatistics, vlanTable=vlanTable, radioRxFrequency=radioRxFrequency, modemErroredSecond=modemErroredSecond, ethRXDvEvent=ethRXDvEvent, e1t1StatEntry=e1t1StatEntry, ethRXByteCounterHi=ethRXByteCounterHi, saf=saf, modemErroredSecondRatio=modemErroredSecondRatio, ethTXWireByteCounterHi=ethTXWireByteCounterHi, loopback_tributary_mask=loopback_tributary_mask, ethRXDones=ethRXDones, ipRadioStatEth=ipRadioStatEth, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ipRadioMgmt=ipRadioMgmt, vlanFid=vlanFid, radioEntry=radioEntry, ethGFPDelineationErrors=ethGFPDelineationErrors, vlanRowStatus=vlanRowStatus, localIpMask=localIpMask, ethRXByteCounterLow=ethRXByteCounterLow, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethQOSTXFrames=ethQOSTXFrames, ipRadio=ipRadio, modemTotalCapacity=modemTotalCapacity, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemEthernetCapacity=modemEthernetCapacity, vlanPortmap=vlanPortmap, safip=safip, vlanNumber=vlanNumber, radioTxPower=radioTxPower, ethGFPDropedFrames=ethGFPDropedFrames, ethTXMaxCollisions=ethTXMaxCollisions, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXPauseFrames=ethTXPauseFrames, vlanEntry=vlanEntry, radioLoopback=radioLoopback, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemAcqStatus=modemAcqStatus, ethTXCRCErrors=ethTXCRCErrors, modemRadialMSE=modemRadialMSE, e1t1StatTable=e1t1StatTable, ethTXCollisions=ethTXCollisions, ethTXByteCounterHi=ethTXByteCounterHi, ethQOSTXDropped=ethQOSTXDropped, aTPCEntry=aTPCEntry, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, atpcIndex=atpcIndex)
