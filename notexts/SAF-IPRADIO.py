...
mibBuilder.exportSymbols("SAF-IPRADIO", radioTxFrequency=radioTxFrequency, ethTXLengthCheckErrors=ethTXLengthCheckErrors, vlansEnabled=vlansEnabled, ethRXMulticasts=ethRXMulticasts, ethQOSTXDropped=ethQOSTXDropped, loopback_tributary_mask=loopback_tributary_mask, modemInternalAGCgain=modemInternalAGCgain, license=license, modemAcqStatus=modemAcqStatus, radioGenStatus=radioGenStatus, ethTXCollisions=ethTXCollisions, ipRadioStat=ipRadioStat, e1t1ChannelNr=e1t1ChannelNr, microwaveRadio=microwaveRadio, licenseUpdateStatus=licenseUpdateStatus, modemBandwith=modemBandwith, ethTXDones=ethTXDones, vlanEntry=vlanEntry, modemEntry=modemEntry, aTPCEntry=aTPCEntry, ethQOSRXQ2Frames=ethQOSRXQ2Frames, remoteIp=remoteIp, ethGFPDropedFrames=ethGFPDropedFrames, ethRXTruncatedFrames=ethRXTruncatedFrames, radioIndex=radioIndex, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlanCfgStat=vlanCfgStat, modemACMtotalCapacity=modemACMtotalCapacity, modemCountTime=modemCountTime, modemTable=modemTable, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXVlanTags=ethTXVlanTags, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXGiants=ethTXGiants, e1t1LOS=e1t1LOS, aTPCTable=aTPCTable, ethRXLongEvents=ethRXLongEvents, modemRowStatus=modemRowStatus, modemLastAcqError=modemLastAcqError, ethGFPDelineationErrors=ethGFPDelineationErrors, radioRxFrequency=radioRxFrequency, modemEthernetCapacity=modemEthernetCapacity, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemACMethernetCapacity=modemACMethernetCapacity, vlanFid=vlanFid, ethTXPauseFrames=ethTXPauseFrames, ipRadioCfg=ipRadioCfg, radioRxLevel=radioRxLevel, modemACMmodulationMin=modemACMmodulationMin, description=description, modemTotalCapacity=modemTotalCapacity, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ipRadio=ipRadio, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXByteCounterLow=ethRXByteCounterLow, atpcEnabled=atpcEnabled, modemErroredSecondRatio=modemErroredSecondRatio, ipRadioCfgGeneral=ipRadioCfgGeneral, radioEntry=radioEntry, sysTemperature=sysTemperature, modemStandard=modemStandard, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXCRCErrors=ethTXCRCErrors, vlanPortType=vlanPortType, vlanTable=vlanTable, modemIndex=modemIndex, ethRXCRCErrors=ethRXCRCErrors, ipRadioStatEth=ipRadioStatEth, modemUptime=modemUptime, modemGeneralStatus=modemGeneralStatus, modemCarrierOffset=modemCarrierOffset, e1t1StatEntry=e1t1StatEntry, modemLDPCdecoderStress=modemLDPCdecoderStress, restartcpu=restartcpu, modemE1T1Channels=modemE1T1Channels, localIp=localIp, e1t1AIS=e1t1AIS, ethTXExcessiveDefers=ethTXExcessiveDefers, loopbacks=loopbacks, ethRXByteCounterHi=ethRXByteCounterHi, ethRXPrevPktDropped=ethRXPrevPktDropped, ethGFPCHECErrors=ethGFPCHECErrors, ethRXControlFrames=ethRXControlFrames, ethRXDones=ethRXDones, vlanRowStatus=vlanRowStatus, modemE1T1ChannelMask=modemE1T1ChannelMask, modemTotalBlockNumber=modemTotalBlockNumber, radioTxMute=radioTxMute, ethTXUnderruns=ethTXUnderruns, sysDateAndTime=sysDateAndTime, atpcIndex=atpcIndex, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXMaxCollisions=ethTXMaxCollisions, modemSymbolRateTx=modemSymbolRateTx, ethTXBackpresEvents=ethTXBackpresEvents, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioSide=radioSide, ethTXBroadcasts=ethTXBroadcasts, saf=saf, modemACMengine=modemACMengine, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXByteCounterLow=ethTXByteCounterLow, ethTXLateCollisions=ethTXLateCollisions, ethTXControlFrames=ethTXControlFrames, modemErroredSecond=modemErroredSecond, writeConfig=writeConfig, modemUnavailtime=modemUnavailtime, ethRXUnsupOpcodes=ethRXUnsupOpcodes, tehnika=tehnika, localIpMask=localIpMask, licenseMask=licenseMask, pointToPoint=pointToPoint, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioDuplexShift=radioDuplexShift, ethRXCodeErrors=ethRXCodeErrors, ethRXPauseFrames=ethRXPauseFrames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, vlanNumber=vlanNumber, ethRXDribleNibbles=ethRXDribleNibbles, safip=safip, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXBroadcasts=ethRXBroadcasts, ethQOSTXFrames=ethQOSTXFrames, e1t1StatTable=e1t1StatTable, modemErroredBlock=modemErroredBlock, modemStatistics=modemStatistics, radioLoopback=radioLoopback, modemSymbolRateRx=modemSymbolRateRx, modemRadialMSE=modemRadialMSE, ipRadioCfgNetwork=ipRadioCfgNetwork, radioTable=radioTable, modemModulation=modemModulation, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemACMmodulationMax=modemACMmodulationMax, ethTXMulticasts=ethTXMulticasts, vlanPortmap=vlanPortmap, ethRXDvEvent=ethRXDvEvent, ethTXByteCounterHi=ethTXByteCounterHi, radioTxPower=radioTxPower, product=product, ethGFPFCSErrors=ethGFPFCSErrors, hostname=hostname, ipRadioMgmt=ipRadioMgmt)
