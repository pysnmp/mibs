...
mibBuilder.exportSymbols("SAF-IPRADIO", ethQOSTXFrames=ethQOSTXFrames, ethRXControlFrames=ethRXControlFrames, saf=saf, atpcIndex=atpcIndex, ethTXGiants=ethTXGiants, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, vlanNumber=vlanNumber, radioDuplexShift=radioDuplexShift, ethRXBroadcasts=ethRXBroadcasts, modemStandard=modemStandard, ethTXLateCollisions=ethTXLateCollisions, localIpMask=localIpMask, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemRadialMSE=modemRadialMSE, radioGenStatus=radioGenStatus, modemErroredSecondRatio=modemErroredSecondRatio, safip=safip, modemTotalCapacity=modemTotalCapacity, modemACMethernetCapacity=modemACMethernetCapacity, ethGFPDropedFrames=ethGFPDropedFrames, ethTXMulticasts=ethTXMulticasts, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, sysTemperature=sysTemperature, ethTXWireByteCounterLow=ethTXWireByteCounterLow, e1t1ChannelNr=e1t1ChannelNr, vlanPortType=vlanPortType, atpcTxPowerCorrection=atpcTxPowerCorrection, modemGeneralStatus=modemGeneralStatus, modemUnavailtime=modemUnavailtime, ethRXCRCErrors=ethRXCRCErrors, vlanTable=vlanTable, e1t1LOS=e1t1LOS, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioSide=radioSide, modemTotalBlockNumber=modemTotalBlockNumber, ethRXDribleNibbles=ethRXDribleNibbles, ethTXByteCounterHi=ethTXByteCounterHi, ethTXByteCounterLow=ethTXByteCounterLow, modemBandwith=modemBandwith, radioRxLevel=radioRxLevel, modemStatistics=modemStatistics, product=product, ethRXCodeErrors=ethRXCodeErrors, e1t1StatEntry=e1t1StatEntry, ethTXUnderruns=ethTXUnderruns, writeConfig=writeConfig, modemTable=modemTable, ethQOSTXDropped=ethQOSTXDropped, loopback_tributary_mask=loopback_tributary_mask, ethRXDvEvent=ethRXDvEvent, ethRXByteCounterHi=ethRXByteCounterHi, modemEthernetCapacity=modemEthernetCapacity, modemIndex=modemIndex, modemE1T1Channels=modemE1T1Channels, modemRowStatus=modemRowStatus, loopbacks=loopbacks, ipRadioStat=ipRadioStat, ethRXTruncatedFrames=ethRXTruncatedFrames, ipRadioStatEth=ipRadioStatEth, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemEntry=modemEntry, radioLoopback=radioLoopback, ethRXDones=ethRXDones, aTPCEntry=aTPCEntry, vlanEntry=vlanEntry, modemErroredSecond=modemErroredSecond, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemSymbolRateTx=modemSymbolRateTx, modemCountTime=modemCountTime, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ipRadioCfg=ipRadioCfg, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ipRadioMgmt=ipRadioMgmt, ethRXPauseFrames=ethRXPauseFrames, description=description, licenseUpdateStatus=licenseUpdateStatus, ethRXPrevPktDropped=ethRXPrevPktDropped, radioEntry=radioEntry, modemInternalAGCgain=modemInternalAGCgain, pointToPoint=pointToPoint, atpcEnabled=atpcEnabled, modemLastAcqError=modemLastAcqError, ethTXControlFrames=ethTXControlFrames, ethTXVlanTags=ethTXVlanTags, ethGFPCHECErrors=ethGFPCHECErrors, radioTxPower=radioTxPower, radioTxFrequency=radioTxFrequency, modemAcqStatus=modemAcqStatus, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, localIp=localIp, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemACMtotalCapacity=modemACMtotalCapacity, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, vlanPortmap=vlanPortmap, aTPCTable=aTPCTable, modemErroredBlock=modemErroredBlock, radioTable=radioTable, ethGFPDelineationErrors=ethGFPDelineationErrors, tehnika=tehnika, vlanCfgStat=vlanCfgStat, license=license, modemACMmodulationMax=modemACMmodulationMax, ipRadioCfgGeneral=ipRadioCfgGeneral, ipRadioCfgNetwork=ipRadioCfgNetwork, sysDateAndTime=sysDateAndTime, licenseMask=licenseMask, restartcpu=restartcpu, modemSymbolRateRx=modemSymbolRateRx, vlansEnabled=vlansEnabled, ethTXMaxCollisions=ethTXMaxCollisions, ethTXPauseFrames=ethTXPauseFrames, ethTXCRCErrors=ethTXCRCErrors, microwaveRadio=microwaveRadio, radioIndex=radioIndex, ethTXDones=ethTXDones, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemCarrierOffset=modemCarrierOffset, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, vlanFid=vlanFid, hostname=hostname, ethRXByteCounterLow=ethRXByteCounterLow, ethGFPFCSErrors=ethGFPFCSErrors, ethTXCollisions=ethTXCollisions, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemACMmodulationMin=modemACMmodulationMin, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXMulticasts=ethRXMulticasts, modemModulation=modemModulation, vlanRowStatus=vlanRowStatus, radioTxMute=radioTxMute, e1t1StatTable=e1t1StatTable, radioRxFrequency=radioRxFrequency, ipRadio=ipRadio, remoteIp=remoteIp, ethRXLongEvents=ethRXLongEvents, ethTXExcessiveDefers=ethTXExcessiveDefers, modemUptime=modemUptime, e1t1AIS=e1t1AIS, ethTXBroadcasts=ethTXBroadcasts, ethTXBackpresEvents=ethTXBackpresEvents, modemACMengine=modemACMengine)
