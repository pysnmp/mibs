...
mibBuilder.exportSymbols("SAF-IPRADIO", modemErroredSecond=modemErroredSecond, aTPCTable=aTPCTable, modemErroredSecondRatio=modemErroredSecondRatio, modemCarrierOffset=modemCarrierOffset, ethTXMulticasts=ethTXMulticasts, e1t1StatTable=e1t1StatTable, ipRadioStat=ipRadioStat, radioTxFrequency=radioTxFrequency, radioSide=radioSide, radioLoopback=radioLoopback, atpcEnabled=atpcEnabled, modemUptime=modemUptime, modemStatistics=modemStatistics, ethRXBroadcasts=ethRXBroadcasts, ipRadioCfg=ipRadioCfg, vlanFid=vlanFid, tehnika=tehnika, ethRXMulticasts=ethRXMulticasts, radioGenStatus=radioGenStatus, vlanPortmap=vlanPortmap, ethRXCRCErrors=ethRXCRCErrors, radioIndex=radioIndex, modemTable=modemTable, ipRadioCfgGeneral=ipRadioCfgGeneral, modemACMmodulationMin=modemACMmodulationMin, modemCountTime=modemCountTime, remoteIp=remoteIp, ethRXLongEvents=ethRXLongEvents, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXDvEvent=ethRXDvEvent, ethRXControlFrames=ethRXControlFrames, product=product, hostname=hostname, ethTXBroadcasts=ethTXBroadcasts, ethTXMaxCollisions=ethTXMaxCollisions, ethGFPCHECErrors=ethGFPCHECErrors, vlanTable=vlanTable, microwaveRadio=microwaveRadio, loopbacks=loopbacks, modemInternalAGCgain=modemInternalAGCgain, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethGFPFCSErrors=ethGFPFCSErrors, pointToPoint=pointToPoint, vlanCfgStat=vlanCfgStat, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioRxFrequency=radioRxFrequency, ethTXCRCErrors=ethTXCRCErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, licenseMask=licenseMask, ipRadioCfgNetwork=ipRadioCfgNetwork, modemACMtotalCapacity=modemACMtotalCapacity, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, atpcIndex=atpcIndex, sysDateAndTime=sysDateAndTime, ethRXPrevPktDropped=ethRXPrevPktDropped, description=description, ethRXVlanTagsDetected=ethRXVlanTagsDetected, restartcpu=restartcpu, modemBandwith=modemBandwith, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioRxLevel=radioRxLevel, radioTxMute=radioTxMute, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, aTPCEntry=aTPCEntry, saf=saf, vlanRowStatus=vlanRowStatus, ethRXByteCounterHi=ethRXByteCounterHi, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemIndex=modemIndex, ethQOSTXFrames=ethQOSTXFrames, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, vlanEntry=vlanEntry, radioTxPower=radioTxPower, atpcTxPowerCorrection=atpcTxPowerCorrection, modemTotalBlockNumber=modemTotalBlockNumber, ethRXPauseFrames=ethRXPauseFrames, licenseUpdateStatus=licenseUpdateStatus, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXControlFrames=ethTXControlFrames, loopback_tributary_mask=loopback_tributary_mask, modemRowStatus=modemRowStatus, ethTXGiants=ethTXGiants, radioDuplexShift=radioDuplexShift, modemSymbolRateRx=modemSymbolRateRx, ethGFPDropedFrames=ethGFPDropedFrames, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXByteCounterHi=ethTXByteCounterHi, ethTXBackpresEvents=ethTXBackpresEvents, ethRXDribleNibbles=ethRXDribleNibbles, vlanNumber=vlanNumber, modemACMethernetCapacity=modemACMethernetCapacity, sysTemperature=sysTemperature, ethRXCodeErrors=ethRXCodeErrors, ethTXVlanTags=ethTXVlanTags, vlanPortType=vlanPortType, license=license, modemAcqStatus=modemAcqStatus, modemEthernetCapacity=modemEthernetCapacity, modemGeneralStatus=modemGeneralStatus, modemACMengine=modemACMengine, ethTXUnderruns=ethTXUnderruns, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemEntry=modemEntry, modemErroredBlock=modemErroredBlock, writeConfig=writeConfig, safip=safip, modemSymbolRateTx=modemSymbolRateTx, localIpMask=localIpMask, modemUnavailtime=modemUnavailtime, ethTXDones=ethTXDones, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXPauseFrames=ethTXPauseFrames, radioEntry=radioEntry, ethTXExcessiveDefers=ethTXExcessiveDefers, modemE1T1ChannelMask=modemE1T1ChannelMask, radioTable=radioTable, modemTotalCapacity=modemTotalCapacity, e1t1LOS=e1t1LOS, modemACMmodulationMax=modemACMmodulationMax, ethRXDones=ethRXDones, ethQOSTXDropped=ethQOSTXDropped, modemLastAcqError=modemLastAcqError, modemRadialMSE=modemRadialMSE, ipRadioStatEth=ipRadioStatEth, modemE1T1Channels=modemE1T1Channels, ipRadio=ipRadio, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXLateCollisions=ethTXLateCollisions, ethTXByteCounterLow=ethTXByteCounterLow, localIp=localIp, modemStandard=modemStandard, ethTXCollisions=ethTXCollisions, e1t1StatEntry=e1t1StatEntry, e1t1ChannelNr=e1t1ChannelNr, e1t1AIS=e1t1AIS, modemModulation=modemModulation, modemLDPCdecoderStress=modemLDPCdecoderStress, vlansEnabled=vlansEnabled, ethRXByteCounterLow=ethRXByteCounterLow, ipRadioMgmt=ipRadioMgmt)
