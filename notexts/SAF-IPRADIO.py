...
mibBuilder.exportSymbols("SAF-IPRADIO", modemInternalAGCgain=modemInternalAGCgain, ethTXDones=ethTXDones, ethRXDones=ethRXDones, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlanEntry=vlanEntry, modemSymbolRateRx=modemSymbolRateRx, e1t1AIS=e1t1AIS, modemStatistics=modemStatistics, modemUnavailtime=modemUnavailtime, vlanFid=vlanFid, ethTXPauseFrames=ethTXPauseFrames, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, vlanRowStatus=vlanRowStatus, loopback_tributary_mask=loopback_tributary_mask, description=description, aTPCEntry=aTPCEntry, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemACMmodulationMax=modemACMmodulationMax, vlanCfgStat=vlanCfgStat, ethTXExcessiveDefers=ethTXExcessiveDefers, modemSymbolRateTx=modemSymbolRateTx, ipRadioCfgGeneral=ipRadioCfgGeneral, modemEthernetCapacity=modemEthernetCapacity, aTPCTable=aTPCTable, ipRadioStat=ipRadioStat, ethTXByteCounterHi=ethTXByteCounterHi, ethRXLongEvents=ethRXLongEvents, ipRadioMgmt=ipRadioMgmt, ethRXControlFrames=ethRXControlFrames, modemUptime=modemUptime, localIpMask=localIpMask, ethRXDvEvent=ethRXDvEvent, e1t1StatTable=e1t1StatTable, writeConfig=writeConfig, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioIndex=radioIndex, ethTXVlanTags=ethTXVlanTags, ipRadioStatEth=ipRadioStatEth, hostname=hostname, radioTable=radioTable, ethTXBackpresEvents=ethTXBackpresEvents, radioRxLevel=radioRxLevel, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, license=license, modemACMtotalCapacity=modemACMtotalCapacity, modemLDPCdecoderStress=modemLDPCdecoderStress, modemACMmodulationMin=modemACMmodulationMin, ethRXTruncatedFrames=ethRXTruncatedFrames, localIp=localIp, ethTXUnderruns=ethTXUnderruns, ethTXCollisions=ethTXCollisions, atpcTxPowerCorrection=atpcTxPowerCorrection, vlanPortmap=vlanPortmap, modemBandwith=modemBandwith, atpcIndex=atpcIndex, radioDuplexShift=radioDuplexShift, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ipRadio=ipRadio, modemIndex=modemIndex, ethTXByteCounterLow=ethTXByteCounterLow, modemTotalCapacity=modemTotalCapacity, ethTXGiants=ethTXGiants, radioLoopback=radioLoopback, ethTXBroadcasts=ethTXBroadcasts, ethRXCRCErrors=ethRXCRCErrors, radioTxPower=radioTxPower, modemE1T1Channels=modemE1T1Channels, sysDateAndTime=sysDateAndTime, modemStandard=modemStandard, ethRXPauseFrames=ethRXPauseFrames, modemACMethernetCapacity=modemACMethernetCapacity, ethRXByteCounterHi=ethRXByteCounterHi, ethGFPDelineationErrors=ethGFPDelineationErrors, modemTotalBlockNumber=modemTotalBlockNumber, ethTXWireByteCounterLow=ethTXWireByteCounterLow, vlanTable=vlanTable, licenseMask=licenseMask, ethTXMulticasts=ethTXMulticasts, saf=saf, modemAcqStatus=modemAcqStatus, radioRxFrequency=radioRxFrequency, ethRXVlanTagsDetected=ethRXVlanTagsDetected, tehnika=tehnika, ethQOSRXQ1Frames=ethQOSRXQ1Frames, remoteIp=remoteIp, ethQOSTXFrames=ethQOSTXFrames, modemGeneralStatus=modemGeneralStatus, radioGenStatus=radioGenStatus, modemRowStatus=modemRowStatus, modemACMengine=modemACMengine, vlanNumber=vlanNumber, modemCountTime=modemCountTime, sysTemperature=sysTemperature, ethTXLateCollisions=ethTXLateCollisions, vlansEnabled=vlansEnabled, ethRXByteCounterLow=ethRXByteCounterLow, loopbacks=loopbacks, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemE1T1ChannelMask=modemE1T1ChannelMask, modemCarrierOffset=modemCarrierOffset, ethRXCodeErrors=ethRXCodeErrors, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, e1t1LOS=e1t1LOS, ethRXPrevPktDropped=ethRXPrevPktDropped, modemLastAcqError=modemLastAcqError, radioTxMute=radioTxMute, radioTxFrequency=radioTxFrequency, e1t1ChannelNr=e1t1ChannelNr, radioEntry=radioEntry, e1t1StatEntry=e1t1StatEntry, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemTable=modemTable, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethGFPDropedFrames=ethGFPDropedFrames, ethGFPFCSErrors=ethGFPFCSErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, modemRadialMSE=modemRadialMSE, atpcEnabled=atpcEnabled, pointToPoint=pointToPoint, ethRXMulticasts=ethRXMulticasts, modemErroredSecondRatio=modemErroredSecondRatio, product=product, ethQOSTXDropped=ethQOSTXDropped, modemEntry=modemEntry, ethTXMaxCollisions=ethTXMaxCollisions, restartcpu=restartcpu, modemErroredBlock=modemErroredBlock, vlanPortType=vlanPortType, radioSide=radioSide, microwaveRadio=microwaveRadio, ipRadioCfg=ipRadioCfg, modemModulation=modemModulation, ethRXBroadcasts=ethRXBroadcasts, ethTXCRCErrors=ethTXCRCErrors, modemErroredSecond=modemErroredSecond, ethTXControlFrames=ethTXControlFrames, ethRXDribleNibbles=ethRXDribleNibbles, licenseUpdateStatus=licenseUpdateStatus, ethRXUnsupOpcodes=ethRXUnsupOpcodes, safip=safip, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethGFPCHECErrors=ethGFPCHECErrors)
