...
mibBuilder.exportSymbols("SAF-IPRADIO", modemACMmodulationMin=modemACMmodulationMin, radioTxMute=radioTxMute, ethTXDones=ethTXDones, modemTable=modemTable, modemErroredBlock=modemErroredBlock, modemErroredSecond=modemErroredSecond, atpcIndex=atpcIndex, tehnika=tehnika, safip=safip, modemEntry=modemEntry, modemACMethernetCapacity=modemACMethernetCapacity, ethTXCRCErrors=ethTXCRCErrors, ethRXByteCounterHi=ethRXByteCounterHi, remoteIp=remoteIp, aTPCEntry=aTPCEntry, modemRowStatus=modemRowStatus, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, saf=saf, loopback_tributary_mask=loopback_tributary_mask, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioTable=radioTable, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, pointToPoint=pointToPoint, modemBandwith=modemBandwith, modemRadialMSE=modemRadialMSE, ethTXCollisions=ethTXCollisions, modemTotalBlockNumber=modemTotalBlockNumber, modemInternalAGCgain=modemInternalAGCgain, modemACMengine=modemACMengine, vlanPortmap=vlanPortmap, writeConfig=writeConfig, modemStatistics=modemStatistics, radioEntry=radioEntry, modemACMmodulationMax=modemACMmodulationMax, ethRXPauseFrames=ethRXPauseFrames, ethGFPFCSErrors=ethGFPFCSErrors, ethTXWireByteCounterHi=ethTXWireByteCounterHi, vlanFid=vlanFid, ipRadioCfgNetwork=ipRadioCfgNetwork, license=license, ethTXByteCounterLow=ethTXByteCounterLow, ethQOSTXDropped=ethQOSTXDropped, sysTemperature=sysTemperature, radioDuplexShift=radioDuplexShift, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXMulticasts=ethTXMulticasts, modemE1T1ChannelMask=modemE1T1ChannelMask, radioTxPower=radioTxPower, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXDribleNibbles=ethRXDribleNibbles, radioSide=radioSide, atpcTxPowerCorrection=atpcTxPowerCorrection, vlansEnabled=vlansEnabled, ethRXControlFrames=ethRXControlFrames, ipRadioCfg=ipRadioCfg, modemUptime=modemUptime, ipRadioStatEth=ipRadioStatEth, ethRXCodeErrors=ethRXCodeErrors, restartcpu=restartcpu, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethQOSTXFrames=ethQOSTXFrames, loopbacks=loopbacks, localIp=localIp, modemErroredSecondRatio=modemErroredSecondRatio, aTPCTable=aTPCTable, radioRxLevel=radioRxLevel, modemCarrierOffset=modemCarrierOffset, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethGFPDelineationErrors=ethGFPDelineationErrors, atpcEnabled=atpcEnabled, modemGeneralStatus=modemGeneralStatus, localIpMask=localIpMask, ethTXGiants=ethTXGiants, e1t1StatEntry=e1t1StatEntry, ethRXDvEvent=ethRXDvEvent, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXMaxCollisions=ethTXMaxCollisions, ethRXLongEvents=ethRXLongEvents, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemAcqStatus=modemAcqStatus, modemLastAcqError=modemLastAcqError, ethRXDones=ethRXDones, ethRXPrevPktDropped=ethRXPrevPktDropped, ethGFPCHECErrors=ethGFPCHECErrors, ethTXLateCollisions=ethTXLateCollisions, modemACMtotalCapacity=modemACMtotalCapacity, ethTXUnderruns=ethTXUnderruns, hostname=hostname, ethTXExcessiveDefers=ethTXExcessiveDefers, modemEthernetCapacity=modemEthernetCapacity, ethGFPDropedFrames=ethGFPDropedFrames, ethTXVlanTags=ethTXVlanTags, vlanTable=vlanTable, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ipRadio=ipRadio, licenseUpdateStatus=licenseUpdateStatus, radioLoopback=radioLoopback, modemLDPCdecoderStress=modemLDPCdecoderStress, vlanNumber=vlanNumber, ipRadioStat=ipRadioStat, vlanCfgStat=vlanCfgStat, ethTXBackpresEvents=ethTXBackpresEvents, ethTXBroadcasts=ethTXBroadcasts, sysDateAndTime=sysDateAndTime, ipRadioCfgGeneral=ipRadioCfgGeneral, radioIndex=radioIndex, radioTxFrequency=radioTxFrequency, e1t1StatTable=e1t1StatTable, modemStandard=modemStandard, vlanEntry=vlanEntry, modemIndex=modemIndex, ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlanRowStatus=vlanRowStatus, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioRxFrequency=radioRxFrequency, ethTXControlFrames=ethTXControlFrames, e1t1AIS=e1t1AIS, modemTotalCapacity=modemTotalCapacity, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXBroadcasts=ethRXBroadcasts, ethRXCRCErrors=ethRXCRCErrors, licenseMask=licenseMask, ethRXByteCounterLow=ethRXByteCounterLow, modemCountTime=modemCountTime, ethRXMulticasts=ethRXMulticasts, e1t1LOS=e1t1LOS, ethTXByteCounterHi=ethTXByteCounterHi, e1t1ChannelNr=e1t1ChannelNr, modemModulation=modemModulation, modemSymbolRateRx=modemSymbolRateRx, description=description, vlanPortType=vlanPortType, ethTXPauseFrames=ethTXPauseFrames, modemE1T1Channels=modemE1T1Channels, ethTXLengthCheckErrors=ethTXLengthCheckErrors, product=product, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemSymbolRateTx=modemSymbolRateTx, microwaveRadio=microwaveRadio, modemUnavailtime=modemUnavailtime, radioGenStatus=radioGenStatus, ipRadioMgmt=ipRadioMgmt)
