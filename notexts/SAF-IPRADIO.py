...
mibBuilder.exportSymbols("SAF-IPRADIO", hostname=hostname, radioDuplexShift=radioDuplexShift, ethQOSTXDropped=ethQOSTXDropped, ethTXCollisions=ethTXCollisions, vlansEnabled=vlansEnabled, ethGFPFCSErrors=ethGFPFCSErrors, e1t1LOS=e1t1LOS, ethTXPauseFrames=ethTXPauseFrames, ethTXMulticasts=ethTXMulticasts, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXByteCounterHi=ethRXByteCounterHi, aTPCTable=aTPCTable, vlanPortType=vlanPortType, e1t1StatTable=e1t1StatTable, vlanRowStatus=vlanRowStatus, saf=saf, writeConfig=writeConfig, sysTemperature=sysTemperature, aTPCEntry=aTPCEntry, modemACMmodulationMin=modemACMmodulationMin, licenseMask=licenseMask, modemErroredSecond=modemErroredSecond, ethQOSRXQ1Frames=ethQOSRXQ1Frames, licenseUpdateStatus=licenseUpdateStatus, ethTXLateCollisions=ethTXLateCollisions, modemCountTime=modemCountTime, modemTable=modemTable, tehnika=tehnika, modemSeverelyErroredSecond=modemSeverelyErroredSecond, sysDateAndTime=sysDateAndTime, modemEthernetCapacity=modemEthernetCapacity, modemE1T1Channels=modemE1T1Channels, modemE1T1ChannelMask=modemE1T1ChannelMask, modemUnavailtime=modemUnavailtime, vlanCfgStat=vlanCfgStat, radioTxPower=radioTxPower, ethTXVlanTags=ethTXVlanTags, radioTable=radioTable, modemACMengine=modemACMengine, modemRowStatus=modemRowStatus, ethTXWireByteCounterLow=ethTXWireByteCounterLow, restartcpu=restartcpu, ethRXCRCErrors=ethRXCRCErrors, ipRadioStat=ipRadioStat, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethQOSTXFrames=ethQOSTXFrames, modemACMethernetCapacity=modemACMethernetCapacity, license=license, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioRxLevel=radioRxLevel, radioIndex=radioIndex, modemLastAcqError=modemLastAcqError, modemRadialMSE=modemRadialMSE, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ipRadioStatEth=ipRadioStatEth, ethTXByteCounterHi=ethTXByteCounterHi, ethTXUnderruns=ethTXUnderruns, radioSide=radioSide, vlanFid=vlanFid, localIp=localIp, ethTXBackpresEvents=ethTXBackpresEvents, ethTXGiants=ethTXGiants, ethRXMulticasts=ethRXMulticasts, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXTruncatedFrames=ethRXTruncatedFrames, modemACMtotalCapacity=modemACMtotalCapacity, vlanTable=vlanTable, modemErroredSecondRatio=modemErroredSecondRatio, ethGFPCHECErrors=ethGFPCHECErrors, modemCarrierOffset=modemCarrierOffset, radioTxFrequency=radioTxFrequency, e1t1ChannelNr=e1t1ChannelNr, pointToPoint=pointToPoint, vlanNumber=vlanNumber, ethRXBroadcasts=ethRXBroadcasts, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, remoteIp=remoteIp, ethTXDones=ethTXDones, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXPrevPktDropped=ethRXPrevPktDropped, loopback_tributary_mask=loopback_tributary_mask, description=description, radioEntry=radioEntry, safip=safip, localIpMask=localIpMask, ethTXControlFrames=ethTXControlFrames, ethRXDones=ethRXDones, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemGeneralStatus=modemGeneralStatus, ethRXDribleNibbles=ethRXDribleNibbles, vlanEntry=vlanEntry, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXByteCounterLow=ethTXByteCounterLow, modemIndex=modemIndex, loopbacks=loopbacks, ethTXMaxCollisions=ethTXMaxCollisions, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemEntry=modemEntry, modemTotalCapacity=modemTotalCapacity, microwaveRadio=microwaveRadio, ethTXExcessiveDefers=ethTXExcessiveDefers, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXControlFrames=ethRXControlFrames, ethRXCodeErrors=ethRXCodeErrors, ethRXLongEvents=ethRXLongEvents, modemLDPCdecoderStress=modemLDPCdecoderStress, atpcEnabled=atpcEnabled, modemUptime=modemUptime, vlanPortmap=vlanPortmap, e1t1StatEntry=e1t1StatEntry, ethGFPDelineationErrors=ethGFPDelineationErrors, modemModulation=modemModulation, ipRadioCfgNetwork=ipRadioCfgNetwork, product=product, radioGenStatus=radioGenStatus, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, e1t1AIS=e1t1AIS, radioTxMute=radioTxMute, radioRxFrequency=radioRxFrequency, ipRadioMgmt=ipRadioMgmt, modemStatistics=modemStatistics, modemSymbolRateTx=modemSymbolRateTx, ethGFPDropedFrames=ethGFPDropedFrames, ethTXBroadcasts=ethTXBroadcasts, modemErroredBlock=modemErroredBlock, modemAcqStatus=modemAcqStatus, modemBandwith=modemBandwith, ethRXByteCounterLow=ethRXByteCounterLow, ethRXPauseFrames=ethRXPauseFrames, ethRXDvEvent=ethRXDvEvent, ipRadio=ipRadio, modemACMmodulationMax=modemACMmodulationMax, ethTXCRCErrors=ethTXCRCErrors, modemStandard=modemStandard, ipRadioCfg=ipRadioCfg, modemTotalBlockNumber=modemTotalBlockNumber, atpcIndex=atpcIndex, radioLoopback=radioLoopback, modemInternalAGCgain=modemInternalAGCgain, modemSymbolRateRx=modemSymbolRateRx)
