...
mibBuilder.exportSymbols("SAF-IPRADIO", modemGeneralStatus=modemGeneralStatus, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioSide=radioSide, radioDuplexShift=radioDuplexShift, ipRadioCfgGeneral=ipRadioCfgGeneral, radioRxLevel=radioRxLevel, ethTXUnderruns=ethTXUnderruns, modemACMtotalCapacity=modemACMtotalCapacity, localIp=localIp, modemTable=modemTable, modemLastAcqError=modemLastAcqError, ethTXGiants=ethTXGiants, ethRXControlFrames=ethRXControlFrames, sysDateAndTime=sysDateAndTime, modemEthernetCapacity=modemEthernetCapacity, ethRXPauseFrames=ethRXPauseFrames, ethQOSTXFrames=ethQOSTXFrames, ethRXMulticasts=ethRXMulticasts, ethTXCollisions=ethTXCollisions, ethGFPDropedFrames=ethGFPDropedFrames, radioTxFrequency=radioTxFrequency, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXByteCounterHi=ethTXByteCounterHi, modemSymbolRateRx=modemSymbolRateRx, license=license, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemRowStatus=modemRowStatus, modemCountTime=modemCountTime, modemTotalCapacity=modemTotalCapacity, vlanTable=vlanTable, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, restartcpu=restartcpu, modemUnavailtime=modemUnavailtime, modemACMengine=modemACMengine, tehnika=tehnika, pointToPoint=pointToPoint, ethRXPrevPktDropped=ethRXPrevPktDropped, modemEntry=modemEntry, localIpMask=localIpMask, ethGFPFCSErrors=ethGFPFCSErrors, modemE1T1ChannelMask=modemE1T1ChannelMask, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXCRCErrors=ethTXCRCErrors, modemRadialMSE=modemRadialMSE, licenseUpdateStatus=licenseUpdateStatus, ethTXControlFrames=ethTXControlFrames, ethTXMulticasts=ethTXMulticasts, loopbacks=loopbacks, vlanPortmap=vlanPortmap, product=product, radioEntry=radioEntry, modemIndex=modemIndex, vlanNumber=vlanNumber, ethRXByteCounterLow=ethRXByteCounterLow, description=description, modemStandard=modemStandard, modemCarrierOffset=modemCarrierOffset, e1t1StatEntry=e1t1StatEntry, saf=saf, e1t1LOS=e1t1LOS, modemE1T1Channels=modemE1T1Channels, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemACMmodulationMax=modemACMmodulationMax, e1t1ChannelNr=e1t1ChannelNr, ethRXDones=ethRXDones, ethTXPauseFrames=ethTXPauseFrames, modemModulation=modemModulation, ethRXLongEvents=ethRXLongEvents, ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXCRCErrors=ethRXCRCErrors, e1t1StatTable=e1t1StatTable, hostname=hostname, radioIndex=radioIndex, radioLoopback=radioLoopback, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlanFid=vlanFid, radioTxPower=radioTxPower, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXDones=ethTXDones, remoteIp=remoteIp, writeConfig=writeConfig, ethQOSTXDropped=ethQOSTXDropped, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXDribleNibbles=ethRXDribleNibbles, e1t1AIS=e1t1AIS, licenseMask=licenseMask, loopback_tributary_mask=loopback_tributary_mask, ethTXExcessiveDefers=ethTXExcessiveDefers, safip=safip, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXByteCounterLow=ethTXByteCounterLow, ethRXDvEvent=ethRXDvEvent, ipRadioMgmt=ipRadioMgmt, ethTXLateCollisions=ethTXLateCollisions, sysTemperature=sysTemperature, ethRXBroadcasts=ethRXBroadcasts, modemLDPCdecoderStress=modemLDPCdecoderStress, vlanRowStatus=vlanRowStatus, modemUptime=modemUptime, ethTXLengthCheckErrors=ethTXLengthCheckErrors, atpcIndex=atpcIndex, modemErroredSecondRatio=modemErroredSecondRatio, ipRadioStatEth=ipRadioStatEth, radioRxFrequency=radioRxFrequency, radioTxMute=radioTxMute, modemErroredBlock=modemErroredBlock, vlanCfgStat=vlanCfgStat, modemACMmodulationMin=modemACMmodulationMin, ethTXMaxCollisions=ethTXMaxCollisions, ethTXVlanTags=ethTXVlanTags, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ipRadioStat=ipRadioStat, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, microwaveRadio=microwaveRadio, ethTXBroadcasts=ethTXBroadcasts, modemSymbolRateTx=modemSymbolRateTx, ethRXCodeErrors=ethRXCodeErrors, radioGenStatus=radioGenStatus, vlanPortType=vlanPortType, ethTXBackpresEvents=ethTXBackpresEvents, atpcEnabled=atpcEnabled, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ipRadioCfg=ipRadioCfg, modemStatistics=modemStatistics, vlansEnabled=vlansEnabled, modemTotalBlockNumber=modemTotalBlockNumber, ethRXByteCounterHi=ethRXByteCounterHi, modemAcqStatus=modemAcqStatus, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlanEntry=vlanEntry, modemErroredSecond=modemErroredSecond, ethGFPCHECErrors=ethGFPCHECErrors, modemInternalAGCgain=modemInternalAGCgain, modemACMethernetCapacity=modemACMethernetCapacity, ethRXTruncatedFrames=ethRXTruncatedFrames, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ipRadio=ipRadio, modemBandwith=modemBandwith, aTPCTable=aTPCTable, aTPCEntry=aTPCEntry, radioTable=radioTable)
