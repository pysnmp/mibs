...
mibBuilder.exportSymbols("SAF-IPRADIO", modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ipRadioCfg=ipRadioCfg, radioRxLevel=radioRxLevel, writeConfig=writeConfig, vlanTable=vlanTable, modemIndex=modemIndex, ethRXDribleNibbles=ethRXDribleNibbles, ethTXUnderruns=ethTXUnderruns, product=product, vlansEnabled=vlansEnabled, modemRowStatus=modemRowStatus, licenseMask=licenseMask, radioRxFrequency=radioRxFrequency, atpcTxPowerCorrection=atpcTxPowerCorrection, modemSymbolRateRx=modemSymbolRateRx, sysTemperature=sysTemperature, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemEthernetCapacity=modemEthernetCapacity, modemUptime=modemUptime, description=description, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemCountTime=modemCountTime, aTPCTable=aTPCTable, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXLongEvents=ethRXLongEvents, ethTXGiants=ethTXGiants, ethTXPauseFrames=ethTXPauseFrames, radioTxMute=radioTxMute, localIp=localIp, vlanNumber=vlanNumber, ethTXBroadcasts=ethTXBroadcasts, ipRadioCfgNetwork=ipRadioCfgNetwork, vlanRowStatus=vlanRowStatus, modemAcqStatus=modemAcqStatus, modemTotalCapacity=modemTotalCapacity, ethGFPDropedFrames=ethGFPDropedFrames, licenseUpdateStatus=licenseUpdateStatus, modemModulation=modemModulation, ethRXByteCounterLow=ethRXByteCounterLow, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethQOSTXDropped=ethQOSTXDropped, radioGenStatus=radioGenStatus, modemTable=modemTable, sysDateAndTime=sysDateAndTime, ipRadioStatEth=ipRadioStatEth, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, vlanCfgStat=vlanCfgStat, loopbacks=loopbacks, radioIndex=radioIndex, modemUnavailtime=modemUnavailtime, modemEntry=modemEntry, ethQOSRXQ1Frames=ethQOSRXQ1Frames, loopback_tributary_mask=loopback_tributary_mask, atpcIndex=atpcIndex, modemSymbolRateTx=modemSymbolRateTx, vlanPortType=vlanPortType, ethRXCRCErrors=ethRXCRCErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, localIpMask=localIpMask, modemInternalAGCgain=modemInternalAGCgain, ethRXMulticasts=ethRXMulticasts, ethTXWireByteCounterHi=ethTXWireByteCounterHi, hostname=hostname, saf=saf, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, e1t1AIS=e1t1AIS, ethRXPrevPktDropped=ethRXPrevPktDropped, modemTotalBlockNumber=modemTotalBlockNumber, modemErroredBlock=modemErroredBlock, ethGFPDelineationErrors=ethGFPDelineationErrors, radioEntry=radioEntry, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemGeneralStatus=modemGeneralStatus, e1t1LOS=e1t1LOS, modemLastAcqError=modemLastAcqError, modemACMethernetCapacity=modemACMethernetCapacity, ethRXDones=ethRXDones, ipRadioMgmt=ipRadioMgmt, ethTXCRCErrors=ethTXCRCErrors, ethGFPFCSErrors=ethGFPFCSErrors, pointToPoint=pointToPoint, ethRXPauseFrames=ethRXPauseFrames, remoteIp=remoteIp, modemACMmodulationMax=modemACMmodulationMax, license=license, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, e1t1StatEntry=e1t1StatEntry, ethRXCodeErrors=ethRXCodeErrors, safip=safip, modemACMmodulationMin=modemACMmodulationMin, restartcpu=restartcpu, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemCarrierOffset=modemCarrierOffset, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXLateCollisions=ethTXLateCollisions, modemStandard=modemStandard, microwaveRadio=microwaveRadio, e1t1ChannelNr=e1t1ChannelNr, ipRadio=ipRadio, ethTXControlFrames=ethTXControlFrames, radioTxPower=radioTxPower, radioDuplexShift=radioDuplexShift, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXMulticasts=ethTXMulticasts, ethRXControlFrames=ethRXControlFrames, ethQOSTXFrames=ethQOSTXFrames, radioTable=radioTable, modemErroredSecondRatio=modemErroredSecondRatio, tehnika=tehnika, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioTxFrequency=radioTxFrequency, ethRXTruncatedFrames=ethRXTruncatedFrames, modemACMtotalCapacity=modemACMtotalCapacity, ethRXByteCounterHi=ethRXByteCounterHi, radioLoopback=radioLoopback, modemRadialMSE=modemRadialMSE, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXMaxCollisions=ethTXMaxCollisions, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemStatistics=modemStatistics, e1t1StatTable=e1t1StatTable, ethTXCollisions=ethTXCollisions, ethRXBroadcasts=ethRXBroadcasts, ethGFPCHECErrors=ethGFPCHECErrors, vlanFid=vlanFid, modemBandwith=modemBandwith, ethTXByteCounterLow=ethTXByteCounterLow, ethRXDvEvent=ethRXDvEvent, ethTXDones=ethTXDones, modemE1T1ChannelMask=modemE1T1ChannelMask, modemErroredSecond=modemErroredSecond, ipRadioStat=ipRadioStat, modemE1T1Channels=modemE1T1Channels, vlanEntry=vlanEntry, vlanPortmap=vlanPortmap, ethTXVlanTags=ethTXVlanTags, modemACMengine=modemACMengine, ethTXBackpresEvents=ethTXBackpresEvents, atpcEnabled=atpcEnabled, aTPCEntry=aTPCEntry, radioSide=radioSide, ethTXByteCounterHi=ethTXByteCounterHi, ethRXUnsupOpcodes=ethRXUnsupOpcodes)
