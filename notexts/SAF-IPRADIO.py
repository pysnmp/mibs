...
mibBuilder.exportSymbols("SAF-IPRADIO", modemACMethernetCapacity=modemACMethernetCapacity, ethQOSTXDropped=ethQOSTXDropped, atpcEnabled=atpcEnabled, modemInternalAGCgain=modemInternalAGCgain, ipRadioStat=ipRadioStat, modemAcqStatus=modemAcqStatus, licenseMask=licenseMask, ipRadioMgmt=ipRadioMgmt, ethTXByteCounterHi=ethTXByteCounterHi, ethTXCollisions=ethTXCollisions, ethGFPDropedFrames=ethGFPDropedFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, modemStatistics=modemStatistics, restartcpu=restartcpu, localIpMask=localIpMask, ethTXByteCounterLow=ethTXByteCounterLow, radioGenStatus=radioGenStatus, vlanRowStatus=vlanRowStatus, modemSymbolRateTx=modemSymbolRateTx, radioTxMute=radioTxMute, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXMulticasts=ethTXMulticasts, ipRadioStatEth=ipRadioStatEth, loopback_tributary_mask=loopback_tributary_mask, radioRxLevel=radioRxLevel, vlansEnabled=vlansEnabled, licenseUpdateStatus=licenseUpdateStatus, radioTxFrequency=radioTxFrequency, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXCRCErrors=ethTXCRCErrors, ethGFPCHECErrors=ethGFPCHECErrors, modemLastAcqError=modemLastAcqError, e1t1AIS=e1t1AIS, ethRXDvEvent=ethRXDvEvent, ethTXWireByteCounterHi=ethTXWireByteCounterHi, microwaveRadio=microwaveRadio, ethRXControlFrames=ethRXControlFrames, modemErroredSecondRatio=modemErroredSecondRatio, ethRXByteCounterHi=ethRXByteCounterHi, modemACMmodulationMax=modemACMmodulationMax, ethTXControlFrames=ethTXControlFrames, product=product, remoteIp=remoteIp, atpcTxPowerCorrection=atpcTxPowerCorrection, vlanFid=vlanFid, ethTXBroadcasts=ethTXBroadcasts, e1t1ChannelNr=e1t1ChannelNr, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXPauseFrames=ethTXPauseFrames, saf=saf, ipRadioCfgGeneral=ipRadioCfgGeneral, ethQOSRXQ2Frames=ethQOSRXQ2Frames, e1t1LOS=e1t1LOS, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemE1T1Channels=modemE1T1Channels, e1t1StatEntry=e1t1StatEntry, vlanPortType=vlanPortType, ethTXMaxCollisions=ethTXMaxCollisions, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, description=description, ethRXPauseFrames=ethRXPauseFrames, modemBandwith=modemBandwith, sysDateAndTime=sysDateAndTime, modemCarrierOffset=modemCarrierOffset, vlanTable=vlanTable, aTPCTable=aTPCTable, modemCountTime=modemCountTime, modemSymbolRateRx=modemSymbolRateRx, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXDones=ethRXDones, modemErroredBlock=modemErroredBlock, ethTXDones=ethTXDones, ethRXByteCounterLow=ethRXByteCounterLow, ethRXCodeErrors=ethRXCodeErrors, modemModulation=modemModulation, radioIndex=radioIndex, modemACMmodulationMin=modemACMmodulationMin, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, vlanNumber=vlanNumber, writeConfig=writeConfig, modemStandard=modemStandard, vlanEntry=vlanEntry, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXExcessiveDefers=ethTXExcessiveDefers, modemGeneralStatus=modemGeneralStatus, radioSide=radioSide, loopbacks=loopbacks, modemErroredSecond=modemErroredSecond, modemRadialMSE=modemRadialMSE, modemUnavailtime=modemUnavailtime, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXGiants=ethTXGiants, modemTable=modemTable, modemIndex=modemIndex, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemACMtotalCapacity=modemACMtotalCapacity, ethRXMulticasts=ethRXMulticasts, ethTXUnderruns=ethTXUnderruns, ethRXDribleNibbles=ethRXDribleNibbles, license=license, ethQOSTXFrames=ethQOSTXFrames, modemRowStatus=modemRowStatus, ethTXLateCollisions=ethTXLateCollisions, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlanPortmap=vlanPortmap, modemEthernetCapacity=modemEthernetCapacity, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXTruncatedFrames=ethRXTruncatedFrames, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXBackpresEvents=ethTXBackpresEvents, radioDuplexShift=radioDuplexShift, hostname=hostname, pointToPoint=pointToPoint, ipRadioCfgNetwork=ipRadioCfgNetwork, modemTotalCapacity=modemTotalCapacity, ethGFPFCSErrors=ethGFPFCSErrors, modemACMengine=modemACMengine, ethTXVlanTags=ethTXVlanTags, ethRXLongEvents=ethRXLongEvents, ipRadioCfg=ipRadioCfg, ipRadio=ipRadio, ethTXLengthCheckErrors=ethTXLengthCheckErrors, sysTemperature=sysTemperature, ethTXWireByteCounterLow=ethTXWireByteCounterLow, tehnika=tehnika, ethRXBroadcasts=ethRXBroadcasts, radioRxFrequency=radioRxFrequency, radioTxPower=radioTxPower, modemUptime=modemUptime, radioLoopback=radioLoopback, modemEntry=modemEntry, radioEntry=radioEntry, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, safip=safip, ethRXCRCErrors=ethRXCRCErrors, modemTotalBlockNumber=modemTotalBlockNumber, atpcIndex=atpcIndex, vlanCfgStat=vlanCfgStat, radioTable=radioTable, aTPCEntry=aTPCEntry, e1t1StatTable=e1t1StatTable, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, localIp=localIp, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio)
