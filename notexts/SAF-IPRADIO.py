...
mibBuilder.exportSymbols("SAF-IPRADIO", modemModulation=modemModulation, modemEntry=modemEntry, pointToPoint=pointToPoint, modemSeverelyErroredSecond=modemSeverelyErroredSecond, license=license, loopback_tributary_mask=loopback_tributary_mask, ethTXLateCollisions=ethTXLateCollisions, vlanRowStatus=vlanRowStatus, ethRXByteCounterLow=ethRXByteCounterLow, licenseUpdateStatus=licenseUpdateStatus, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemErroredBlock=modemErroredBlock, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, vlanPortmap=vlanPortmap, ethTXCollisions=ethTXCollisions, modemBackgroundBlockErrror=modemBackgroundBlockErrror, e1t1StatEntry=e1t1StatEntry, ethGFPDropedFrames=ethGFPDropedFrames, e1t1ChannelNr=e1t1ChannelNr, modemErroredSecond=modemErroredSecond, vlanTable=vlanTable, ethRXTruncatedFrames=ethRXTruncatedFrames, modemBandwith=modemBandwith, modemStatistics=modemStatistics, modemACMmodulationMin=modemACMmodulationMin, modemAcqStatus=modemAcqStatus, ethGFPFCSErrors=ethGFPFCSErrors, modemGeneralStatus=modemGeneralStatus, atpcTxPowerCorrection=atpcTxPowerCorrection, radioTable=radioTable, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemUnavailtime=modemUnavailtime, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethGFPCHECErrors=ethGFPCHECErrors, ethQOSTXDropped=ethQOSTXDropped, modemACMtotalCapacity=modemACMtotalCapacity, modemLDPCdecoderStress=modemLDPCdecoderStress, atpcIndex=atpcIndex, radioIndex=radioIndex, ethQOSTXFrames=ethQOSTXFrames, atpcEnabled=atpcEnabled, product=product, loopbacks=loopbacks, localIp=localIp, localIpMask=localIpMask, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXControlFrames=ethRXControlFrames, modemStandard=modemStandard, ethRXDribleNibbles=ethRXDribleNibbles, ethTXGiants=ethTXGiants, modemInternalAGCgain=modemInternalAGCgain, modemIndex=modemIndex, writeConfig=writeConfig, modemEthernetCapacity=modemEthernetCapacity, ethTXMaxCollisions=ethTXMaxCollisions, description=description, ethTXByteCounterHi=ethTXByteCounterHi, radioDuplexShift=radioDuplexShift, ethTXByteCounterLow=ethTXByteCounterLow, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXCRCErrors=ethRXCRCErrors, ethTXBackpresEvents=ethTXBackpresEvents, ethTXMulticasts=ethTXMulticasts, ipRadioCfg=ipRadioCfg, modemRowStatus=modemRowStatus, ethTXControlFrames=ethTXControlFrames, modemTable=modemTable, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemErroredSecondRatio=modemErroredSecondRatio, aTPCTable=aTPCTable, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXVlanTags=ethTXVlanTags, vlansEnabled=vlansEnabled, ipRadio=ipRadio, e1t1LOS=e1t1LOS, e1t1StatTable=e1t1StatTable, ethTXBroadcasts=ethTXBroadcasts, ipRadioStatEth=ipRadioStatEth, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemSymbolRateRx=modemSymbolRateRx, modemUptime=modemUptime, ethRXLongEvents=ethRXLongEvents, radioSide=radioSide, vlanCfgStat=vlanCfgStat, ethTXDones=ethTXDones, remoteIp=remoteIp, sysDateAndTime=sysDateAndTime, microwaveRadio=microwaveRadio, ethTXPauseFrames=ethTXPauseFrames, modemRadialMSE=modemRadialMSE, ethTXCRCErrors=ethTXCRCErrors, modemACMmodulationMax=modemACMmodulationMax, ethTXExcessiveDefers=ethTXExcessiveDefers, radioRxLevel=radioRxLevel, radioTxPower=radioTxPower, ethRXDvEvent=ethRXDvEvent, ethRXPauseFrames=ethRXPauseFrames, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ipRadioStat=ipRadioStat, vlanNumber=vlanNumber, modemTotalBlockNumber=modemTotalBlockNumber, modemSymbolRateTx=modemSymbolRateTx, modemCarrierOffset=modemCarrierOffset, vlanPortType=vlanPortType, restartcpu=restartcpu, modemCountTime=modemCountTime, radioRxFrequency=radioRxFrequency, ethTXUnderruns=ethTXUnderruns, ethRXCodeErrors=ethRXCodeErrors, licenseMask=licenseMask, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXDones=ethRXDones, radioLoopback=radioLoopback, saf=saf, sysTemperature=sysTemperature, radioGenStatus=radioGenStatus, tehnika=tehnika, e1t1AIS=e1t1AIS, vlanFid=vlanFid, aTPCEntry=aTPCEntry, modemE1T1Channels=modemE1T1Channels, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemLastAcqError=modemLastAcqError, modemACMethernetCapacity=modemACMethernetCapacity, radioTxMute=radioTxMute, modemTotalCapacity=modemTotalCapacity, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXUnsupOpcodes=ethRXUnsupOpcodes, safip=safip, modemACMengine=modemACMengine, hostname=hostname, radioTxFrequency=radioTxFrequency, vlanEntry=vlanEntry, radioEntry=radioEntry, ethRXBroadcasts=ethRXBroadcasts, ipRadioMgmt=ipRadioMgmt, ethRXByteCounterHi=ethRXByteCounterHi, ethRXMulticasts=ethRXMulticasts, ethRXPrevPktDropped=ethRXPrevPktDropped)
