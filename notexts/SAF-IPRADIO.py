...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXDvEvent=ethRXDvEvent, modemRowStatus=modemRowStatus, ipRadioCfgGeneral=ipRadioCfgGeneral, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXVlanTags=ethTXVlanTags, tehnika=tehnika, radioLoopback=radioLoopback, pointToPoint=pointToPoint, ethGFPCHECErrors=ethGFPCHECErrors, aTPCTable=aTPCTable, description=description, modemGeneralStatus=modemGeneralStatus, radioTxMute=radioTxMute, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemE1T1ChannelMask=modemE1T1ChannelMask, remoteIp=remoteIp, license=license, ethRXControlFrames=ethRXControlFrames, ethQOSTXFrames=ethQOSTXFrames, modemStatistics=modemStatistics, radioTxFrequency=radioTxFrequency, modemTotalBlockNumber=modemTotalBlockNumber, localIpMask=localIpMask, safip=safip, ethRXCodeErrors=ethRXCodeErrors, ipRadioMgmt=ipRadioMgmt, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemACMmodulationMax=modemACMmodulationMax, radioEntry=radioEntry, e1t1StatEntry=e1t1StatEntry, ethTXByteCounterLow=ethTXByteCounterLow, modemACMethernetCapacity=modemACMethernetCapacity, ethRXPrevPktDropped=ethRXPrevPktDropped, modemSymbolRateRx=modemSymbolRateRx, ethTXExcessiveDefers=ethTXExcessiveDefers, e1t1StatTable=e1t1StatTable, ethTXLateCollisions=ethTXLateCollisions, modemAcqStatus=modemAcqStatus, ethTXControlFrames=ethTXControlFrames, sysDateAndTime=sysDateAndTime, radioSide=radioSide, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethGFPDropedFrames=ethGFPDropedFrames, radioIndex=radioIndex, modemErroredBlock=modemErroredBlock, modemEthernetCapacity=modemEthernetCapacity, microwaveRadio=microwaveRadio, modemEntry=modemEntry, ethTXCRCErrors=ethTXCRCErrors, radioTxPower=radioTxPower, ethRXUnsupOpcodes=ethRXUnsupOpcodes, atpcIndex=atpcIndex, modemErroredSecondRatio=modemErroredSecondRatio, modemUptime=modemUptime, vlanPortType=vlanPortType, ethTXBackpresEvents=ethTXBackpresEvents, loopback_tributary_mask=loopback_tributary_mask, vlanTable=vlanTable, writeConfig=writeConfig, ethTXUnderruns=ethTXUnderruns, modemBandwith=modemBandwith, e1t1LOS=e1t1LOS, ipRadioStatEth=ipRadioStatEth, modemTable=modemTable, ethTXCollisions=ethTXCollisions, radioRxFrequency=radioRxFrequency, ethTXWireByteCounterHi=ethTXWireByteCounterHi, loopbacks=loopbacks, modemACMmodulationMin=modemACMmodulationMin, vlanPortmap=vlanPortmap, radioDuplexShift=radioDuplexShift, ethTXMaxCollisions=ethTXMaxCollisions, ethTXDones=ethTXDones, ethRXMulticasts=ethRXMulticasts, modemSymbolRateTx=modemSymbolRateTx, modemStandard=modemStandard, modemE1T1Channels=modemE1T1Channels, ethTXPauseFrames=ethTXPauseFrames, vlanEntry=vlanEntry, ethTXBroadcasts=ethTXBroadcasts, modemErroredSecond=modemErroredSecond, modemInternalAGCgain=modemInternalAGCgain, ipRadio=ipRadio, ethRXTruncatedFrames=ethRXTruncatedFrames, ipRadioStat=ipRadioStat, ethGFPFCSErrors=ethGFPFCSErrors, licenseMask=licenseMask, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemCarrierOffset=modemCarrierOffset, vlanRowStatus=vlanRowStatus, ethRXBroadcasts=ethRXBroadcasts, e1t1ChannelNr=e1t1ChannelNr, modemUnavailtime=modemUnavailtime, aTPCEntry=aTPCEntry, licenseUpdateStatus=licenseUpdateStatus, vlanNumber=vlanNumber, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemACMtotalCapacity=modemACMtotalCapacity, saf=saf, hostname=hostname, ethRXByteCounterHi=ethRXByteCounterHi, ethTXGiants=ethTXGiants, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXMulticasts=ethTXMulticasts, modemRadialMSE=modemRadialMSE, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioTable=radioTable, vlansEnabled=vlansEnabled, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXByteCounterHi=ethTXByteCounterHi, ethRXCRCErrors=ethRXCRCErrors, vlanFid=vlanFid, localIp=localIp, radioGenStatus=radioGenStatus, ipRadioCfgNetwork=ipRadioCfgNetwork, atpcEnabled=atpcEnabled, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXDones=ethRXDones, restartcpu=restartcpu, sysTemperature=sysTemperature, ethRXPauseFrames=ethRXPauseFrames, modemModulation=modemModulation, ethRXByteCounterLow=ethRXByteCounterLow, modemLastAcqError=modemLastAcqError, modemLDPCdecoderStress=modemLDPCdecoderStress, product=product, ethQOSTXDropped=ethQOSTXDropped, modemTotalCapacity=modemTotalCapacity, ethRXLongEvents=ethRXLongEvents, modemBackgroundBlockErrror=modemBackgroundBlockErrror, e1t1AIS=e1t1AIS, ethGFPDelineationErrors=ethGFPDelineationErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioRxLevel=radioRxLevel, modemACMengine=modemACMengine, modemIndex=modemIndex, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXDribleNibbles=ethRXDribleNibbles, ipRadioCfg=ipRadioCfg, vlanCfgStat=vlanCfgStat, modemCountTime=modemCountTime)
