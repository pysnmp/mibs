...
mibBuilder.exportSymbols("SAF-IPRADIO", vlanPortmap=vlanPortmap, ethRXDones=ethRXDones, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ipRadioCfg=ipRadioCfg, ethTXCRCErrors=ethTXCRCErrors, hostname=hostname, writeConfig=writeConfig, restartcpu=restartcpu, modemE1T1Channels=modemE1T1Channels, modemLastAcqError=modemLastAcqError, modemErroredSecondRatio=modemErroredSecondRatio, ethTXPauseFrames=ethTXPauseFrames, ethRXLongEvents=ethRXLongEvents, ethTXBroadcasts=ethTXBroadcasts, ethRXMulticasts=ethRXMulticasts, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXControlFrames=ethTXControlFrames, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ipRadio=ipRadio, modemEntry=modemEntry, vlanNumber=vlanNumber, vlanPortType=vlanPortType, radioTxMute=radioTxMute, ethRXDvEvent=ethRXDvEvent, radioTxPower=radioTxPower, safip=safip, ethQOSTXDropped=ethQOSTXDropped, ethRXBroadcasts=ethRXBroadcasts, modemACMtotalCapacity=modemACMtotalCapacity, e1t1AIS=e1t1AIS, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemGeneralStatus=modemGeneralStatus, saf=saf, atpcEnabled=atpcEnabled, license=license, atpcTxPowerCorrection=atpcTxPowerCorrection, ipRadioCfgGeneral=ipRadioCfgGeneral, atpcIndex=atpcIndex, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXVlanTags=ethTXVlanTags, modemErroredBlock=modemErroredBlock, ipRadioStatEth=ipRadioStatEth, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, description=description, ethGFPCHECErrors=ethGFPCHECErrors, modemTotalCapacity=modemTotalCapacity, e1t1StatEntry=e1t1StatEntry, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, aTPCTable=aTPCTable, loopback_tributary_mask=loopback_tributary_mask, ethQOSTXFrames=ethQOSTXFrames, vlanTable=vlanTable, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXLateCollisions=ethTXLateCollisions, modemTable=modemTable, modemInternalAGCgain=modemInternalAGCgain, radioTxFrequency=radioTxFrequency, e1t1ChannelNr=e1t1ChannelNr, modemStandard=modemStandard, ethRXCodeErrors=ethRXCodeErrors, modemACMengine=modemACMengine, e1t1StatTable=e1t1StatTable, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemCountTime=modemCountTime, microwaveRadio=microwaveRadio, ethQOSRXQ2Frames=ethQOSRXQ2Frames, tehnika=tehnika, e1t1LOS=e1t1LOS, modemE1T1ChannelMask=modemE1T1ChannelMask, radioEntry=radioEntry, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemACMethernetCapacity=modemACMethernetCapacity, ethRXDribleNibbles=ethRXDribleNibbles, radioTable=radioTable, product=product, pointToPoint=pointToPoint, ethRXControlFrames=ethRXControlFrames, radioRxLevel=radioRxLevel, aTPCEntry=aTPCEntry, localIp=localIp, ethGFPFCSErrors=ethGFPFCSErrors, ethRXPauseFrames=ethRXPauseFrames, modemUptime=modemUptime, localIpMask=localIpMask, ethTXDones=ethTXDones, ethGFPDropedFrames=ethGFPDropedFrames, modemUnavailtime=modemUnavailtime, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXBackpresEvents=ethTXBackpresEvents, modemACMmodulationMax=modemACMmodulationMax, vlanRowStatus=vlanRowStatus, ethRXUnsupOpcodes=ethRXUnsupOpcodes, vlansEnabled=vlansEnabled, ethTXMaxCollisions=ethTXMaxCollisions, vlanEntry=vlanEntry, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXUnderruns=ethTXUnderruns, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, licenseMask=licenseMask, sysTemperature=sysTemperature, modemIndex=modemIndex, modemStatistics=modemStatistics, modemEthernetCapacity=modemEthernetCapacity, radioSide=radioSide, modemCarrierOffset=modemCarrierOffset, modemSymbolRateRx=modemSymbolRateRx, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXCollisions=ethTXCollisions, sysDateAndTime=sysDateAndTime, modemSymbolRateTx=modemSymbolRateTx, ethTXByteCounterHi=ethTXByteCounterHi, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemTotalBlockNumber=modemTotalBlockNumber, remoteIp=remoteIp, modemLDPCdecoderStress=modemLDPCdecoderStress, modemBandwith=modemBandwith, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemRowStatus=modemRowStatus, licenseUpdateStatus=licenseUpdateStatus, radioLoopback=radioLoopback, radioDuplexShift=radioDuplexShift, modemModulation=modemModulation, modemErroredSecond=modemErroredSecond, ethRXByteCounterLow=ethRXByteCounterLow, radioGenStatus=radioGenStatus, modemAcqStatus=modemAcqStatus, ethRXCRCErrors=ethRXCRCErrors, ethTXByteCounterLow=ethTXByteCounterLow, modemACMmodulationMin=modemACMmodulationMin, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXByteCounterHi=ethRXByteCounterHi, vlanCfgStat=vlanCfgStat, radioRxFrequency=radioRxFrequency, ethTXMulticasts=ethTXMulticasts, ipRadioMgmt=ipRadioMgmt, ipRadioStat=ipRadioStat, loopbacks=loopbacks, modemRadialMSE=modemRadialMSE, ethTXGiants=ethTXGiants, radioIndex=radioIndex, vlanFid=vlanFid, ethRXPrevPktDropped=ethRXPrevPktDropped)
