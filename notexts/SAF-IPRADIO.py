...
mibBuilder.exportSymbols("SAF-IPRADIO", vlanPortType=vlanPortType, radioRxLevel=radioRxLevel, ethGFPCHECErrors=ethGFPCHECErrors, vlanNumber=vlanNumber, radioRxFrequency=radioRxFrequency, aTPCTable=aTPCTable, ethRXPrevPktDropped=ethRXPrevPktDropped, vlanCfgStat=vlanCfgStat, aTPCEntry=aTPCEntry, vlansEnabled=vlansEnabled, modemErroredBlock=modemErroredBlock, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXMulticasts=ethRXMulticasts, modemACMmodulationMax=modemACMmodulationMax, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethGFPFCSErrors=ethGFPFCSErrors, modemUnavailtime=modemUnavailtime, modemACMmodulationMin=modemACMmodulationMin, modemLDPCdecoderStress=modemLDPCdecoderStress, remoteIp=remoteIp, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXByteCounterLow=ethRXByteCounterLow, ethTXPauseFrames=ethTXPauseFrames, ipRadioCfg=ipRadioCfg, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXGiants=ethTXGiants, vlanEntry=vlanEntry, licenseUpdateStatus=licenseUpdateStatus, safip=safip, e1t1AIS=e1t1AIS, licenseMask=licenseMask, e1t1ChannelNr=e1t1ChannelNr, modemTotalBlockNumber=modemTotalBlockNumber, ethTXByteCounterHi=ethTXByteCounterHi, ethTXExcessiveDefers=ethTXExcessiveDefers, ethQOSTXFrames=ethQOSTXFrames, atpcEnabled=atpcEnabled, radioSide=radioSide, ethTXLateCollisions=ethTXLateCollisions, localIp=localIp, modemUptime=modemUptime, modemRadialMSE=modemRadialMSE, ethTXCollisions=ethTXCollisions, writeConfig=writeConfig, vlanRowStatus=vlanRowStatus, modemAcqStatus=modemAcqStatus, modemTable=modemTable, modemACMengine=modemACMengine, vlanTable=vlanTable, ethRXDvEvent=ethRXDvEvent, ethTXMaxCollisions=ethTXMaxCollisions, modemBandwith=modemBandwith, modemSymbolRateTx=modemSymbolRateTx, ethQOSTXDropped=ethQOSTXDropped, radioTxFrequency=radioTxFrequency, ethRXPauseFrames=ethRXPauseFrames, modemErroredSecondRatio=modemErroredSecondRatio, modemCarrierOffset=modemCarrierOffset, ethTXControlFrames=ethTXControlFrames, radioEntry=radioEntry, microwaveRadio=microwaveRadio, atpcTxPowerCorrection=atpcTxPowerCorrection, ethGFPDropedFrames=ethGFPDropedFrames, ethTXBroadcasts=ethTXBroadcasts, modemACMethernetCapacity=modemACMethernetCapacity, ethRXLongEvents=ethRXLongEvents, ethTXByteCounterLow=ethTXByteCounterLow, tehnika=tehnika, hostname=hostname, ethRXDribleNibbles=ethRXDribleNibbles, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemRowStatus=modemRowStatus, ipRadioMgmt=ipRadioMgmt, ethRXCodeErrors=ethRXCodeErrors, ethRXDones=ethRXDones, atpcIndex=atpcIndex, modemTotalCapacity=modemTotalCapacity, modemE1T1Channels=modemE1T1Channels, modemStandard=modemStandard, modemGeneralStatus=modemGeneralStatus, restartcpu=restartcpu, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemEthernetCapacity=modemEthernetCapacity, sysDateAndTime=sysDateAndTime, ethTXVlanTags=ethTXVlanTags, e1t1StatTable=e1t1StatTable, ethRXCRCErrors=ethRXCRCErrors, ethTXDones=ethTXDones, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemLastAcqError=modemLastAcqError, modemInternalAGCgain=modemInternalAGCgain, ethQOSRXQ1Frames=ethQOSRXQ1Frames, sysTemperature=sysTemperature, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioTxMute=radioTxMute, modemErroredSecond=modemErroredSecond, vlanPortmap=vlanPortmap, ethTXMulticasts=ethTXMulticasts, modemModulation=modemModulation, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXBackpresEvents=ethTXBackpresEvents, radioTable=radioTable, product=product, description=description, ipRadioStat=ipRadioStat, radioIndex=radioIndex, loopbacks=loopbacks, e1t1LOS=e1t1LOS, modemE1T1ChannelMask=modemE1T1ChannelMask, modemACMtotalCapacity=modemACMtotalCapacity, radioGenStatus=radioGenStatus, ethRXControlFrames=ethRXControlFrames, ethTXCRCErrors=ethTXCRCErrors, e1t1StatEntry=e1t1StatEntry, ethGFPDelineationErrors=ethGFPDelineationErrors, modemCountTime=modemCountTime, ethRXBroadcasts=ethRXBroadcasts, modemEntry=modemEntry, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXWireByteCounterLow=ethTXWireByteCounterLow, pointToPoint=pointToPoint, modemStatistics=modemStatistics, ethRXVlanTagsDetected=ethRXVlanTagsDetected, loopback_tributary_mask=loopback_tributary_mask, radioLoopback=radioLoopback, ipRadio=ipRadio, modemSymbolRateRx=modemSymbolRateRx, ethRXByteCounterHi=ethRXByteCounterHi, ethTXLengthCheckErrors=ethTXLengthCheckErrors, localIpMask=localIpMask, ipRadioCfgNetwork=ipRadioCfgNetwork, vlanFid=vlanFid, license=license, radioTxPower=radioTxPower, saf=saf, radioDuplexShift=radioDuplexShift, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemIndex=modemIndex, ipRadioStatEth=ipRadioStatEth, ethTXUnderruns=ethTXUnderruns, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio)
