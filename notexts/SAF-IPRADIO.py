...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, vlanNumber=vlanNumber, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ipRadioMgmt=ipRadioMgmt, ethRXPauseFrames=ethRXPauseFrames, radioSide=radioSide, vlanRowStatus=vlanRowStatus, aTPCTable=aTPCTable, description=description, restartcpu=restartcpu, modemIndex=modemIndex, sysDateAndTime=sysDateAndTime, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemErroredSecond=modemErroredSecond, vlansEnabled=vlansEnabled, modemSeverelyErroredSecond=modemSeverelyErroredSecond, loopback_tributary_mask=loopback_tributary_mask, modemLastAcqError=modemLastAcqError, modemRadialMSE=modemRadialMSE, ethRXDones=ethRXDones, ethQOSTXFrames=ethQOSTXFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, e1t1ChannelNr=e1t1ChannelNr, writeConfig=writeConfig, modemTable=modemTable, licenseMask=licenseMask, ethRXLongEvents=ethRXLongEvents, radioTxFrequency=radioTxFrequency, ethTXVlanTags=ethTXVlanTags, radioRxFrequency=radioRxFrequency, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXCollisions=ethTXCollisions, e1t1StatTable=e1t1StatTable, saf=saf, ethRXControlFrames=ethRXControlFrames, vlanTable=vlanTable, radioIndex=radioIndex, ethTXPauseFrames=ethTXPauseFrames, radioGenStatus=radioGenStatus, ipRadioStat=ipRadioStat, radioTxPower=radioTxPower, modemUptime=modemUptime, modemBackgroundBlockErrror=modemBackgroundBlockErrror, atpcIndex=atpcIndex, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ipRadioStatEth=ipRadioStatEth, ethRXDvEvent=ethRXDvEvent, modemModulation=modemModulation, modemEthernetCapacity=modemEthernetCapacity, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXMaxCollisions=ethTXMaxCollisions, ethGFPFCSErrors=ethGFPFCSErrors, modemE1T1Channels=modemE1T1Channels, vlanPortmap=vlanPortmap, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioEntry=radioEntry, ethTXByteCounterHi=ethTXByteCounterHi, modemGeneralStatus=modemGeneralStatus, ethRXByteCounterLow=ethRXByteCounterLow, licenseUpdateStatus=licenseUpdateStatus, tehnika=tehnika, pointToPoint=pointToPoint, aTPCEntry=aTPCEntry, modemEntry=modemEntry, ethTXLateCollisions=ethTXLateCollisions, modemTotalBlockNumber=modemTotalBlockNumber, ethTXControlFrames=ethTXControlFrames, localIp=localIp, modemErroredBlock=modemErroredBlock, modemBandwith=modemBandwith, modemACMengine=modemACMengine, vlanPortType=vlanPortType, ethGFPCHECErrors=ethGFPCHECErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXBroadcasts=ethRXBroadcasts, modemStatistics=modemStatistics, sysTemperature=sysTemperature, modemRowStatus=modemRowStatus, ethRXMulticasts=ethRXMulticasts, product=product, modemCountTime=modemCountTime, radioTable=radioTable, localIpMask=localIpMask, atpcEnabled=atpcEnabled, remoteIp=remoteIp, ipRadio=ipRadio, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, e1t1LOS=e1t1LOS, modemACMmodulationMax=modemACMmodulationMax, radioTxMute=radioTxMute, modemTotalCapacity=modemTotalCapacity, ethTXBackpresEvents=ethTXBackpresEvents, modemACMethernetCapacity=modemACMethernetCapacity, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXByteCounterLow=ethTXByteCounterLow, modemAcqStatus=modemAcqStatus, ethRXTruncatedFrames=ethRXTruncatedFrames, microwaveRadio=microwaveRadio, modemACMmodulationMin=modemACMmodulationMin, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ipRadioCfgNetwork=ipRadioCfgNetwork, radioRxLevel=radioRxLevel, modemStandard=modemStandard, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemUnavailtime=modemUnavailtime, ethTXCRCErrors=ethTXCRCErrors, modemACMtotalCapacity=modemACMtotalCapacity, ipRadioCfg=ipRadioCfg, modemInternalAGCgain=modemInternalAGCgain, e1t1StatEntry=e1t1StatEntry, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXDribleNibbles=ethRXDribleNibbles, ethTXMulticasts=ethTXMulticasts, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemErroredSecondRatio=modemErroredSecondRatio, vlanEntry=vlanEntry, vlanCfgStat=vlanCfgStat, hostname=hostname, radioLoopback=radioLoopback, vlanFid=vlanFid, atpcTxPowerCorrection=atpcTxPowerCorrection, license=license, ethTXGiants=ethTXGiants, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemSymbolRateRx=modemSymbolRateRx, modemCarrierOffset=modemCarrierOffset, ethQOSTXDropped=ethQOSTXDropped, ethTXBroadcasts=ethTXBroadcasts, ethRXCodeErrors=ethRXCodeErrors, modemSymbolRateTx=modemSymbolRateTx, radioDuplexShift=radioDuplexShift, ethRXCRCErrors=ethRXCRCErrors, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXByteCounterHi=ethRXByteCounterHi, safip=safip, ethTXDones=ethTXDones, ethTXUnderruns=ethTXUnderruns, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXWireByteCounterHi=ethTXWireByteCounterHi, e1t1AIS=e1t1AIS, ethGFPDropedFrames=ethGFPDropedFrames, loopbacks=loopbacks)
