...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXMulticasts=ethTXMulticasts, ethRXDvEvent=ethRXDvEvent, pointToPoint=pointToPoint, product=product, modemGeneralStatus=modemGeneralStatus, vlanPortType=vlanPortType, ethTXGiants=ethTXGiants, modemLastAcqError=modemLastAcqError, modemInternalAGCgain=modemInternalAGCgain, ethRXCRCErrors=ethRXCRCErrors, e1t1ChannelNr=e1t1ChannelNr, ethRXByteCounterHi=ethRXByteCounterHi, ethTXBackpresEvents=ethTXBackpresEvents, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXTruncatedFrames=ethRXTruncatedFrames, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, vlanRowStatus=vlanRowStatus, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethGFPDelineationErrors=ethGFPDelineationErrors, modemErroredSecondRatio=modemErroredSecondRatio, modemACMmodulationMin=modemACMmodulationMin, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioTxPower=radioTxPower, radioDuplexShift=radioDuplexShift, ethRXCodeErrors=ethRXCodeErrors, ethRXUnsupOpcodes=ethRXUnsupOpcodes, licenseUpdateStatus=licenseUpdateStatus, ethTXPauseFrames=ethTXPauseFrames, ethRXBroadcasts=ethRXBroadcasts, modemTotalBlockNumber=modemTotalBlockNumber, description=description, vlanEntry=vlanEntry, licenseMask=licenseMask, radioTxMute=radioTxMute, radioTable=radioTable, modemStatistics=modemStatistics, modemBandwith=modemBandwith, ethTXDones=ethTXDones, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemE1T1Channels=modemE1T1Channels, ipRadio=ipRadio, atpcEnabled=atpcEnabled, ethRXControlFrames=ethRXControlFrames, remoteIp=remoteIp, ethTXCRCErrors=ethTXCRCErrors, modemCarrierOffset=modemCarrierOffset, ethTXLateCollisions=ethTXLateCollisions, aTPCEntry=aTPCEntry, localIp=localIp, modemIndex=modemIndex, e1t1StatEntry=e1t1StatEntry, modemErroredBlock=modemErroredBlock, modemAcqStatus=modemAcqStatus, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethQOSTXFrames=ethQOSTXFrames, ethRXLongEvents=ethRXLongEvents, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioEntry=radioEntry, ethTXUnderruns=ethTXUnderruns, localIpMask=localIpMask, ethTXBroadcasts=ethTXBroadcasts, modemCountTime=modemCountTime, writeConfig=writeConfig, radioTxFrequency=radioTxFrequency, vlanTable=vlanTable, modemE1T1ChannelMask=modemE1T1ChannelMask, aTPCTable=aTPCTable, loopback_tributary_mask=loopback_tributary_mask, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlanNumber=vlanNumber, vlanPortmap=vlanPortmap, modemUnavailtime=modemUnavailtime, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXVlanTags=ethTXVlanTags, radioLoopback=radioLoopback, radioRxFrequency=radioRxFrequency, ethTXByteCounterHi=ethTXByteCounterHi, ethQOSTXDropped=ethQOSTXDropped, modemTotalCapacity=modemTotalCapacity, ethRXPrevPktDropped=ethRXPrevPktDropped, restartcpu=restartcpu, modemSymbolRateTx=modemSymbolRateTx, ipRadioStatEth=ipRadioStatEth, e1t1StatTable=e1t1StatTable, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemErroredSecond=modemErroredSecond, e1t1AIS=e1t1AIS, modemACMmodulationMax=modemACMmodulationMax, modemLDPCdecoderStress=modemLDPCdecoderStress, ethGFPFCSErrors=ethGFPFCSErrors, modemTable=modemTable, ipRadioStat=ipRadioStat, ethTXCollisions=ethTXCollisions, ipRadioCfg=ipRadioCfg, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXDribleNibbles=ethRXDribleNibbles, safip=safip, modemModulation=modemModulation, ethRXPauseFrames=ethRXPauseFrames, saf=saf, modemRowStatus=modemRowStatus, modemStandard=modemStandard, ethRXMulticasts=ethRXMulticasts, loopbacks=loopbacks, microwaveRadio=microwaveRadio, radioIndex=radioIndex, modemACMethernetCapacity=modemACMethernetCapacity, atpcIndex=atpcIndex, ethTXMaxCollisions=ethTXMaxCollisions, ethTXByteCounterLow=ethTXByteCounterLow, ethRXVlanTagsDetected=ethRXVlanTagsDetected, e1t1LOS=e1t1LOS, sysTemperature=sysTemperature, modemEthernetCapacity=modemEthernetCapacity, ethGFPCHECErrors=ethGFPCHECErrors, sysDateAndTime=sysDateAndTime, modemACMengine=modemACMengine, vlansEnabled=vlansEnabled, modemRadialMSE=modemRadialMSE, tehnika=tehnika, ethGFPDropedFrames=ethGFPDropedFrames, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioGenStatus=radioGenStatus, vlanCfgStat=vlanCfgStat, atpcTxPowerCorrection=atpcTxPowerCorrection, modemUptime=modemUptime, ipRadioMgmt=ipRadioMgmt, ethTXExcessiveDefers=ethTXExcessiveDefers, hostname=hostname, radioRxLevel=radioRxLevel, ethRXByteCounterLow=ethRXByteCounterLow, license=license, vlanFid=vlanFid, ethRXDones=ethRXDones, ethTXControlFrames=ethTXControlFrames, modemACMtotalCapacity=modemACMtotalCapacity, modemSymbolRateRx=modemSymbolRateRx, radioSide=radioSide, modemEntry=modemEntry)
