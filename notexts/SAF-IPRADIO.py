...
mibBuilder.exportSymbols("SAF-IPRADIO", hostname=hostname, ethTXGiants=ethTXGiants, radioTxFrequency=radioTxFrequency, saf=saf, ethRXBroadcasts=ethRXBroadcasts, radioSide=radioSide, modemACMethernetCapacity=modemACMethernetCapacity, modemErroredSecondRatio=modemErroredSecondRatio, ethTXExcessiveDefers=ethTXExcessiveDefers, ipRadioCfgNetwork=ipRadioCfgNetwork, modemACMengine=modemACMengine, ethTXByteCounterLow=ethTXByteCounterLow, aTPCEntry=aTPCEntry, ethTXDones=ethTXDones, atpcIndex=atpcIndex, radioTable=radioTable, modemErroredBlock=modemErroredBlock, pointToPoint=pointToPoint, vlanPortmap=vlanPortmap, ethTXCollisions=ethTXCollisions, licenseUpdateStatus=licenseUpdateStatus, modemE1T1Channels=modemE1T1Channels, e1t1ChannelNr=e1t1ChannelNr, description=description, writeConfig=writeConfig, modemRowStatus=modemRowStatus, modemLDPCdecoderStress=modemLDPCdecoderStress, localIp=localIp, safip=safip, radioDuplexShift=radioDuplexShift, ipRadioMgmt=ipRadioMgmt, atpcTxPowerCorrection=atpcTxPowerCorrection, modemACMmodulationMax=modemACMmodulationMax, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemErroredSecond=modemErroredSecond, e1t1AIS=e1t1AIS, modemIndex=modemIndex, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXControlFrames=ethRXControlFrames, sysDateAndTime=sysDateAndTime, ipRadioStatEth=ipRadioStatEth, ethTXByteCounterHi=ethTXByteCounterHi, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXControlFrames=ethTXControlFrames, vlanTable=vlanTable, ethRXPrevPktDropped=ethRXPrevPktDropped, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemCountTime=modemCountTime, tehnika=tehnika, modemModulation=modemModulation, ethRXPauseFrames=ethRXPauseFrames, ethTXLateCollisions=ethTXLateCollisions, modemEthernetCapacity=modemEthernetCapacity, modemStandard=modemStandard, licenseMask=licenseMask, product=product, radioIndex=radioIndex, modemEntry=modemEntry, loopbacks=loopbacks, vlanNumber=vlanNumber, microwaveRadio=microwaveRadio, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXCRCErrors=ethRXCRCErrors, vlanFid=vlanFid, ethRXByteCounterHi=ethRXByteCounterHi, vlanPortType=vlanPortType, ethRXByteCounterLow=ethRXByteCounterLow, modemLastAcqError=modemLastAcqError, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemTotalBlockNumber=modemTotalBlockNumber, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXDribleNibbles=ethRXDribleNibbles, modemInternalAGCgain=modemInternalAGCgain, ethRXTruncatedFrames=ethRXTruncatedFrames, sysTemperature=sysTemperature, ipRadio=ipRadio, vlanEntry=vlanEntry, modemRadialMSE=modemRadialMSE, restartcpu=restartcpu, modemE1T1ChannelMask=modemE1T1ChannelMask, ipRadioCfg=ipRadioCfg, modemAcqStatus=modemAcqStatus, modemACMmodulationMin=modemACMmodulationMin, ethGFPDropedFrames=ethGFPDropedFrames, ethTXMaxCollisions=ethTXMaxCollisions, ethGFPCHECErrors=ethGFPCHECErrors, localIpMask=localIpMask, modemSymbolRateRx=modemSymbolRateRx, aTPCTable=aTPCTable, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethGFPFCSErrors=ethGFPFCSErrors, modemACMtotalCapacity=modemACMtotalCapacity, ethTXVlanTags=ethTXVlanTags, ethRXLongEvents=ethRXLongEvents, loopback_tributary_mask=loopback_tributary_mask, radioEntry=radioEntry, radioGenStatus=radioGenStatus, radioTxMute=radioTxMute, ethTXBackpresEvents=ethTXBackpresEvents, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethQOSTXDropped=ethQOSTXDropped, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioTxPower=radioTxPower, ethTXMulticasts=ethTXMulticasts, modemTotalCapacity=modemTotalCapacity, modemUptime=modemUptime, ethTXWireByteCounterHi=ethTXWireByteCounterHi, e1t1StatEntry=e1t1StatEntry, modemBandwith=modemBandwith, ethRXDvEvent=ethRXDvEvent, modemCarrierOffset=modemCarrierOffset, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemSymbolRateTx=modemSymbolRateTx, e1t1LOS=e1t1LOS, ethRXMulticasts=ethRXMulticasts, ethRXDones=ethRXDones, modemTable=modemTable, ethTXCRCErrors=ethTXCRCErrors, e1t1StatTable=e1t1StatTable, atpcEnabled=atpcEnabled, ethTXBroadcasts=ethTXBroadcasts, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXUnderruns=ethTXUnderruns, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, vlansEnabled=vlansEnabled, remoteIp=remoteIp, ethQOSTXFrames=ethQOSTXFrames, ethTXPauseFrames=ethTXPauseFrames, ethRXCodeErrors=ethRXCodeErrors, modemStatistics=modemStatistics, modemSeverelyErroredSecond=modemSeverelyErroredSecond, vlanRowStatus=vlanRowStatus, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethGFPDelineationErrors=ethGFPDelineationErrors, modemUnavailtime=modemUnavailtime, ipRadioStat=ipRadioStat, radioRxLevel=radioRxLevel, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemGeneralStatus=modemGeneralStatus, vlanCfgStat=vlanCfgStat, license=license, radioRxFrequency=radioRxFrequency, radioLoopback=radioLoopback)
