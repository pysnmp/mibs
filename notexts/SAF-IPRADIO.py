...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemUptime=modemUptime, modemTotalCapacity=modemTotalCapacity, writeConfig=writeConfig, product=product, ethTXCRCErrors=ethTXCRCErrors, modemLastAcqError=modemLastAcqError, ethTXDones=ethTXDones, modemGeneralStatus=modemGeneralStatus, ethTXControlFrames=ethTXControlFrames, modemInternalAGCgain=modemInternalAGCgain, radioTable=radioTable, modemRowStatus=modemRowStatus, modemACMtotalCapacity=modemACMtotalCapacity, modemTable=modemTable, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, sysTemperature=sysTemperature, ethTXGiants=ethTXGiants, vlanFid=vlanFid, vlanRowStatus=vlanRowStatus, ethTXBackpresEvents=ethTXBackpresEvents, sysDateAndTime=sysDateAndTime, e1t1ChannelNr=e1t1ChannelNr, modemTotalBlockNumber=modemTotalBlockNumber, hostname=hostname, vlansEnabled=vlansEnabled, ethTXLengthCheckErrors=ethTXLengthCheckErrors, pointToPoint=pointToPoint, radioEntry=radioEntry, modemSymbolRateRx=modemSymbolRateRx, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethGFPCHECErrors=ethGFPCHECErrors, e1t1StatTable=e1t1StatTable, safip=safip, modemLDPCdecoderStress=modemLDPCdecoderStress, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXBroadcasts=ethRXBroadcasts, ethTXByteCounterLow=ethTXByteCounterLow, microwaveRadio=microwaveRadio, ethTXPauseFrames=ethTXPauseFrames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, loopback_tributary_mask=loopback_tributary_mask, ethRXCodeErrors=ethRXCodeErrors, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXCRCErrors=ethRXCRCErrors, modemCountTime=modemCountTime, localIpMask=localIpMask, ethTXBroadcasts=ethTXBroadcasts, radioGenStatus=radioGenStatus, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioRxFrequency=radioRxFrequency, modemBackgroundBlockErrror=modemBackgroundBlockErrror, licenseUpdateStatus=licenseUpdateStatus, ethQOSTXFrames=ethQOSTXFrames, modemE1T1ChannelMask=modemE1T1ChannelMask, vlanTable=vlanTable, ethTXUnderruns=ethTXUnderruns, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, vlanPortmap=vlanPortmap, ethTXCollisions=ethTXCollisions, modemE1T1Channels=modemE1T1Channels, atpcIndex=atpcIndex, modemIndex=modemIndex, atpcEnabled=atpcEnabled, ethRXLongEvents=ethRXLongEvents, ethRXControlFrames=ethRXControlFrames, aTPCEntry=aTPCEntry, ethRXByteCounterLow=ethRXByteCounterLow, ethRXDribleNibbles=ethRXDribleNibbles, ethTXExcessiveDefers=ethTXExcessiveDefers, tehnika=tehnika, aTPCTable=aTPCTable, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ipRadioCfg=ipRadioCfg, e1t1AIS=e1t1AIS, e1t1StatEntry=e1t1StatEntry, ipRadioStatEth=ipRadioStatEth, modemErroredBlock=modemErroredBlock, e1t1LOS=e1t1LOS, ethRXTruncatedFrames=ethRXTruncatedFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, vlanCfgStat=vlanCfgStat, remoteIp=remoteIp, ethTXMaxCollisions=ethTXMaxCollisions, ethGFPDropedFrames=ethGFPDropedFrames, modemCarrierOffset=modemCarrierOffset, ethGFPFCSErrors=ethGFPFCSErrors, vlanEntry=vlanEntry, modemACMmodulationMax=modemACMmodulationMax, ethRXDvEvent=ethRXDvEvent, modemModulation=modemModulation, radioRxLevel=radioRxLevel, modemStatistics=modemStatistics, loopbacks=loopbacks, ipRadio=ipRadio, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioSide=radioSide, modemAcqStatus=modemAcqStatus, vlanNumber=vlanNumber, modemBandwith=modemBandwith, ethRXByteCounterHi=ethRXByteCounterHi, licenseMask=licenseMask, ethTXVlanTags=ethTXVlanTags, ethTXByteCounterHi=ethTXByteCounterHi, modemACMmodulationMin=modemACMmodulationMin, modemEntry=modemEntry, ethTXLateCollisions=ethTXLateCollisions, ipRadioStat=ipRadioStat, radioTxMute=radioTxMute, saf=saf, modemRadialMSE=modemRadialMSE, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioTxPower=radioTxPower, ipRadioCfgNetwork=ipRadioCfgNetwork, license=license, ethQOSTXDropped=ethQOSTXDropped, radioIndex=radioIndex, modemACMengine=modemACMengine, modemErroredSecondRatio=modemErroredSecondRatio, ethRXUnsupOpcodes=ethRXUnsupOpcodes, description=description, modemACMethernetCapacity=modemACMethernetCapacity, modemUnavailtime=modemUnavailtime, modemSeverelyErroredSecond=modemSeverelyErroredSecond, localIp=localIp, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXMulticasts=ethRXMulticasts, modemErroredSecond=modemErroredSecond, ethTXMulticasts=ethTXMulticasts, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioTxFrequency=radioTxFrequency, radioLoopback=radioLoopback, vlanPortType=vlanPortType, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemSymbolRateTx=modemSymbolRateTx, ethRXDones=ethRXDones, ipRadioMgmt=ipRadioMgmt, ipRadioCfgGeneral=ipRadioCfgGeneral, modemEthernetCapacity=modemEthernetCapacity, ethRXPauseFrames=ethRXPauseFrames, radioDuplexShift=radioDuplexShift, modemStandard=modemStandard, restartcpu=restartcpu)
