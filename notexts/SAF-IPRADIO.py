...
mibBuilder.exportSymbols("SAF-IPRADIO", sysTemperature=sysTemperature, vlanPortmap=vlanPortmap, ethTXGiants=ethTXGiants, ethTXUnderruns=ethTXUnderruns, radioEntry=radioEntry, e1t1StatEntry=e1t1StatEntry, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, vlanRowStatus=vlanRowStatus, modemRadialMSE=modemRadialMSE, vlanEntry=vlanEntry, modemErroredBlock=modemErroredBlock, description=description, e1t1AIS=e1t1AIS, ethTXWireByteCounterLow=ethTXWireByteCounterLow, atpcTxPowerCorrection=atpcTxPowerCorrection, modemEntry=modemEntry, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemErroredSecondRatio=modemErroredSecondRatio, ipRadioStatEth=ipRadioStatEth, modemLastAcqError=modemLastAcqError, ethTXBroadcasts=ethTXBroadcasts, modemInternalAGCgain=modemInternalAGCgain, ethRXVlanTagsDetected=ethRXVlanTagsDetected, sysDateAndTime=sysDateAndTime, ethRXPauseFrames=ethRXPauseFrames, modemACMtotalCapacity=modemACMtotalCapacity, ethTXPauseFrames=ethTXPauseFrames, aTPCEntry=aTPCEntry, ethTXByteCounterHi=ethTXByteCounterHi, modemStatistics=modemStatistics, ethGFPDelineationErrors=ethGFPDelineationErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, microwaveRadio=microwaveRadio, ethTXLateCollisions=ethTXLateCollisions, radioTxPower=radioTxPower, ethTXControlFrames=ethTXControlFrames, radioDuplexShift=radioDuplexShift, modemSymbolRateTx=modemSymbolRateTx, ethTXDones=ethTXDones, vlanFid=vlanFid, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXByteCounterLow=ethRXByteCounterLow, ethTXMaxCollisions=ethTXMaxCollisions, modemUnavailtime=modemUnavailtime, ethQOSRXQ1Frames=ethQOSRXQ1Frames, license=license, vlanPortType=vlanPortType, ipRadioCfgGeneral=ipRadioCfgGeneral, ethGFPFCSErrors=ethGFPFCSErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemIndex=modemIndex, hostname=hostname, modemSymbolRateRx=modemSymbolRateRx, modemStandard=modemStandard, ethTXMulticasts=ethTXMulticasts, remoteIp=remoteIp, modemUptime=modemUptime, vlansEnabled=vlansEnabled, ethRXPrevPktDropped=ethRXPrevPktDropped, e1t1ChannelNr=e1t1ChannelNr, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXCollisions=ethTXCollisions, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemTotalBlockNumber=modemTotalBlockNumber, modemACMethernetCapacity=modemACMethernetCapacity, ipRadioCfg=ipRadioCfg, modemTotalCapacity=modemTotalCapacity, ethQOSTXDropped=ethQOSTXDropped, modemRowStatus=modemRowStatus, ethTXVlanTags=ethTXVlanTags, licenseMask=licenseMask, modemTable=modemTable, ethRXDribleNibbles=ethRXDribleNibbles, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, vlanTable=vlanTable, radioRxFrequency=radioRxFrequency, atpcEnabled=atpcEnabled, ethTXByteCounterLow=ethTXByteCounterLow, ethRXByteCounterHi=ethRXByteCounterHi, ethTXLengthCheckErrors=ethTXLengthCheckErrors, licenseUpdateStatus=licenseUpdateStatus, safip=safip, vlanCfgStat=vlanCfgStat, radioTxFrequency=radioTxFrequency, modemBandwith=modemBandwith, modemAcqStatus=modemAcqStatus, product=product, ethRXDones=ethRXDones, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXLongEvents=ethRXLongEvents, e1t1StatTable=e1t1StatTable, modemErroredSecond=modemErroredSecond, modemCarrierOffset=modemCarrierOffset, ipRadioCfgNetwork=ipRadioCfgNetwork, localIp=localIp, modemEthernetCapacity=modemEthernetCapacity, radioLoopback=radioLoopback, modemModulation=modemModulation, modemE1T1Channels=modemE1T1Channels, restartcpu=restartcpu, loopback_tributary_mask=loopback_tributary_mask, e1t1LOS=e1t1LOS, ethRXCRCErrors=ethRXCRCErrors, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXExcessiveDefers=ethTXExcessiveDefers, modemCountTime=modemCountTime, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemGeneralStatus=modemGeneralStatus, pointToPoint=pointToPoint, writeConfig=writeConfig, ethRXControlFrames=ethRXControlFrames, modemE1T1ChannelMask=modemE1T1ChannelMask, radioRxLevel=radioRxLevel, vlanNumber=vlanNumber, ethTXCRCErrors=ethTXCRCErrors, loopbacks=loopbacks, aTPCTable=aTPCTable, ethQOSTXFrames=ethQOSTXFrames, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioIndex=radioIndex, ipRadioStat=ipRadioStat, radioTable=radioTable, ipRadioMgmt=ipRadioMgmt, ethRXMulticasts=ethRXMulticasts, ethTXBackpresEvents=ethTXBackpresEvents, modemACMmodulationMax=modemACMmodulationMax, ethRXDvEvent=ethRXDvEvent, localIpMask=localIpMask, ethGFPCHECErrors=ethGFPCHECErrors, radioSide=radioSide, ethRXCodeErrors=ethRXCodeErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethGFPDropedFrames=ethGFPDropedFrames, radioTxMute=radioTxMute, tehnika=tehnika, modemACMmodulationMin=modemACMmodulationMin, radioGenStatus=radioGenStatus, atpcIndex=atpcIndex, ipRadio=ipRadio, modemACMengine=modemACMengine, saf=saf, ethRXBroadcasts=ethRXBroadcasts)
