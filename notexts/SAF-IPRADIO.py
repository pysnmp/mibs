...
mibBuilder.exportSymbols("SAF-IPRADIO", vlanTable=vlanTable, pointToPoint=pointToPoint, radioIndex=radioIndex, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemACMethernetCapacity=modemACMethernetCapacity, modemLastAcqError=modemLastAcqError, ethTXByteCounterLow=ethTXByteCounterLow, ipRadio=ipRadio, radioDuplexShift=radioDuplexShift, sysDateAndTime=sysDateAndTime, modemTable=modemTable, ethRXDribleNibbles=ethRXDribleNibbles, ethTXUnderruns=ethTXUnderruns, loopback_tributary_mask=loopback_tributary_mask, ethQOSTXFrames=ethQOSTXFrames, ethTXDones=ethTXDones, safip=safip, atpcIndex=atpcIndex, ethTXControlFrames=ethTXControlFrames, remoteIp=remoteIp, e1t1StatTable=e1t1StatTable, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioTxPower=radioTxPower, restartcpu=restartcpu, aTPCTable=aTPCTable, description=description, ethGFPFCSErrors=ethGFPFCSErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemUptime=modemUptime, tehnika=tehnika, vlanFid=vlanFid, radioLoopback=radioLoopback, e1t1AIS=e1t1AIS, ethRXTruncatedFrames=ethRXTruncatedFrames, modemE1T1Channels=modemE1T1Channels, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXPauseFrames=ethRXPauseFrames, license=license, localIpMask=localIpMask, ethGFPDropedFrames=ethGFPDropedFrames, licenseMask=licenseMask, ipRadioCfgNetwork=ipRadioCfgNetwork, atpcEnabled=atpcEnabled, microwaveRadio=microwaveRadio, ethQOSTXDropped=ethQOSTXDropped, ethTXVlanTags=ethTXVlanTags, hostname=hostname, modemGeneralStatus=modemGeneralStatus, modemACMengine=modemACMengine, ethRXCRCErrors=ethRXCRCErrors, modemCountTime=modemCountTime, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemBandwith=modemBandwith, ipRadioStatEth=ipRadioStatEth, ethRXLongEvents=ethRXLongEvents, modemEntry=modemEntry, ethRXControlFrames=ethRXControlFrames, ethRXDones=ethRXDones, ethGFPCHECErrors=ethGFPCHECErrors, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemTotalCapacity=modemTotalCapacity, modemEthernetCapacity=modemEthernetCapacity, ethTXMulticasts=ethTXMulticasts, modemACMtotalCapacity=modemACMtotalCapacity, modemSymbolRateRx=modemSymbolRateRx, ethTXBackpresEvents=ethTXBackpresEvents, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemIndex=modemIndex, ethRXPrevPktDropped=ethRXPrevPktDropped, modemRowStatus=modemRowStatus, modemErroredBlock=modemErroredBlock, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, sysTemperature=sysTemperature, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemStandard=modemStandard, radioSide=radioSide, modemSymbolRateTx=modemSymbolRateTx, vlansEnabled=vlansEnabled, vlanEntry=vlanEntry, radioRxLevel=radioRxLevel, modemCarrierOffset=modemCarrierOffset, ipRadioMgmt=ipRadioMgmt, ethRXCodeErrors=ethRXCodeErrors, e1t1LOS=e1t1LOS, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemUnavailtime=modemUnavailtime, writeConfig=writeConfig, ethTXMaxCollisions=ethTXMaxCollisions, ethGFPDelineationErrors=ethGFPDelineationErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, localIp=localIp, ethRXVlanTagsDetected=ethRXVlanTagsDetected, saf=saf, radioTable=radioTable, ipRadioCfgGeneral=ipRadioCfgGeneral, e1t1StatEntry=e1t1StatEntry, modemRadialMSE=modemRadialMSE, ethRXBroadcasts=ethRXBroadcasts, ethTXLateCollisions=ethTXLateCollisions, modemLDPCdecoderStress=modemLDPCdecoderStress, licenseUpdateStatus=licenseUpdateStatus, modemModulation=modemModulation, ethTXCollisions=ethTXCollisions, modemTotalBlockNumber=modemTotalBlockNumber, ethTXBroadcasts=ethTXBroadcasts, ethRXMulticasts=ethRXMulticasts, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXDvEvent=ethRXDvEvent, radioRxFrequency=radioRxFrequency, ethTXPauseFrames=ethTXPauseFrames, ethTXLengthCheckErrors=ethTXLengthCheckErrors, vlanPortmap=vlanPortmap, radioTxFrequency=radioTxFrequency, ethTXByteCounterHi=ethTXByteCounterHi, loopbacks=loopbacks, ethTXGiants=ethTXGiants, modemACMmodulationMax=modemACMmodulationMax, product=product, ipRadioCfg=ipRadioCfg, modemStatistics=modemStatistics, modemACMmodulationMin=modemACMmodulationMin, e1t1ChannelNr=e1t1ChannelNr, vlanCfgStat=vlanCfgStat, radioGenStatus=radioGenStatus, ethTXCRCErrors=ethTXCRCErrors, radioTxMute=radioTxMute, vlanNumber=vlanNumber, ethTXExcessiveDefers=ethTXExcessiveDefers, modemErroredSecondRatio=modemErroredSecondRatio, vlanRowStatus=vlanRowStatus, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXByteCounterHi=ethRXByteCounterHi, ipRadioStat=ipRadioStat, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemErroredSecond=modemErroredSecond, modemAcqStatus=modemAcqStatus, radioEntry=radioEntry, aTPCEntry=aTPCEntry, vlanPortType=vlanPortType, modemInternalAGCgain=modemInternalAGCgain, ethRXByteCounterLow=ethRXByteCounterLow, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors)
