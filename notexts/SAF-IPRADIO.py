...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXCodeErrors=ethRXCodeErrors, ethTXByteCounterHi=ethTXByteCounterHi, ethTXGiants=ethTXGiants, ethRXCRCErrors=ethRXCRCErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, restartcpu=restartcpu, modemStandard=modemStandard, radioDuplexShift=radioDuplexShift, modemErroredSecond=modemErroredSecond, ethTXLateCollisions=ethTXLateCollisions, modemErroredSecondRatio=modemErroredSecondRatio, modemBandwith=modemBandwith, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, licenseUpdateStatus=licenseUpdateStatus, modemModulation=modemModulation, tehnika=tehnika, licenseMask=licenseMask, modemSymbolRateTx=modemSymbolRateTx, ethQOSTXDropped=ethQOSTXDropped, ethRXDones=ethRXDones, modemCountTime=modemCountTime, writeConfig=writeConfig, modemIndex=modemIndex, ethTXDones=ethTXDones, atpcEnabled=atpcEnabled, vlanRowStatus=vlanRowStatus, ethTXLengthCheckErrors=ethTXLengthCheckErrors, radioEntry=radioEntry, radioTable=radioTable, modemACMtotalCapacity=modemACMtotalCapacity, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ipRadio=ipRadio, radioTxPower=radioTxPower, radioTxFrequency=radioTxFrequency, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXUnsupOpcodes=ethRXUnsupOpcodes, vlanNumber=vlanNumber, microwaveRadio=microwaveRadio, e1t1StatEntry=e1t1StatEntry, localIp=localIp, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXByteCounterLow=ethRXByteCounterLow, pointToPoint=pointToPoint, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXControlFrames=ethRXControlFrames, ethGFPCHECErrors=ethGFPCHECErrors, e1t1ChannelNr=e1t1ChannelNr, sysDateAndTime=sysDateAndTime, e1t1AIS=e1t1AIS, saf=saf, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ipRadioCfg=ipRadioCfg, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioGenStatus=radioGenStatus, modemStatistics=modemStatistics, modemEthernetCapacity=modemEthernetCapacity, modemRowStatus=modemRowStatus, ethTXVlanTags=ethTXVlanTags, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXMulticasts=ethTXMulticasts, loopback_tributary_mask=loopback_tributary_mask, ethRXMulticasts=ethRXMulticasts, radioLoopback=radioLoopback, modemGeneralStatus=modemGeneralStatus, radioIndex=radioIndex, safip=safip, loopbacks=loopbacks, radioRxLevel=radioRxLevel, license=license, vlanTable=vlanTable, ethTXBackpresEvents=ethTXBackpresEvents, ethRXLongEvents=ethRXLongEvents, ethTXMaxCollisions=ethTXMaxCollisions, vlanEntry=vlanEntry, ethRXPauseFrames=ethRXPauseFrames, modemRadialMSE=modemRadialMSE, modemACMengine=modemACMengine, ethTXCRCErrors=ethTXCRCErrors, modemTotalBlockNumber=modemTotalBlockNumber, modemTotalCapacity=modemTotalCapacity, vlansEnabled=vlansEnabled, ethRXDribleNibbles=ethRXDribleNibbles, ethGFPDelineationErrors=ethGFPDelineationErrors, vlanPortType=vlanPortType, modemUnavailtime=modemUnavailtime, sysTemperature=sysTemperature, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXUnderruns=ethTXUnderruns, e1t1LOS=e1t1LOS, ipRadioStatEth=ipRadioStatEth, modemUptime=modemUptime, ethQOSTXFrames=ethQOSTXFrames, modemEntry=modemEntry, modemSymbolRateRx=modemSymbolRateRx, modemACMethernetCapacity=modemACMethernetCapacity, ethTXCollisions=ethTXCollisions, modemCarrierOffset=modemCarrierOffset, ipRadioMgmt=ipRadioMgmt, modemACMmodulationMin=modemACMmodulationMin, modemACMmodulationMax=modemACMmodulationMax, vlanCfgStat=vlanCfgStat, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioTxMute=radioTxMute, atpcIndex=atpcIndex, modemE1T1Channels=modemE1T1Channels, radioRxFrequency=radioRxFrequency, aTPCTable=aTPCTable, ethGFPFCSErrors=ethGFPFCSErrors, ethTXControlFrames=ethTXControlFrames, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXBroadcasts=ethTXBroadcasts, hostname=hostname, ethTXByteCounterLow=ethTXByteCounterLow, vlanFid=vlanFid, ethRXDvEvent=ethRXDvEvent, modemLDPCdecoderStress=modemLDPCdecoderStress, remoteIp=remoteIp, modemTable=modemTable, e1t1StatTable=e1t1StatTable, ethRXByteCounterHi=ethRXByteCounterHi, modemAcqStatus=modemAcqStatus, modemLastAcqError=modemLastAcqError, product=product, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, aTPCEntry=aTPCEntry, vlanPortmap=vlanPortmap, ipRadioCfgGeneral=ipRadioCfgGeneral, ethGFPDropedFrames=ethGFPDropedFrames, atpcTxPowerCorrection=atpcTxPowerCorrection, ipRadioStat=ipRadioStat, ethRXBroadcasts=ethRXBroadcasts, localIpMask=localIpMask, radioSide=radioSide, modemErroredBlock=modemErroredBlock, ethTXPauseFrames=ethTXPauseFrames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemBackgroundBlockErrror=modemBackgroundBlockErrror, description=description, modemInternalAGCgain=modemInternalAGCgain)
