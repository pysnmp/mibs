...
mibBuilder.exportSymbols("SAF-IPRADIO", modemErroredSecond=modemErroredSecond, modemAcqStatus=modemAcqStatus, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, localIp=localIp, ipRadioMgmt=ipRadioMgmt, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXByteCounterLow=ethTXByteCounterLow, ethQOSTXDropped=ethQOSTXDropped, modemBandwith=modemBandwith, modemTable=modemTable, ethRXCodeErrors=ethRXCodeErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, modemUptime=modemUptime, modemStandard=modemStandard, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXDribleNibbles=ethRXDribleNibbles, ethTXByteCounterHi=ethTXByteCounterHi, ethRXControlFrames=ethRXControlFrames, ethTXPauseFrames=ethTXPauseFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemEthernetCapacity=modemEthernetCapacity, safip=safip, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemEntry=modemEntry, modemSymbolRateTx=modemSymbolRateTx, radioSide=radioSide, radioRxFrequency=radioRxFrequency, modemRowStatus=modemRowStatus, ethQOSRXQ1Frames=ethQOSRXQ1Frames, localIpMask=localIpMask, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXByteCounterHi=ethRXByteCounterHi, modemACMethernetCapacity=modemACMethernetCapacity, modemACMtotalCapacity=modemACMtotalCapacity, pointToPoint=pointToPoint, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, e1t1StatEntry=e1t1StatEntry, ethRXCRCErrors=ethRXCRCErrors, modemE1T1ChannelMask=modemE1T1ChannelMask, sysTemperature=sysTemperature, ipRadioStatEth=ipRadioStatEth, ethTXMulticasts=ethTXMulticasts, ethTXLateCollisions=ethTXLateCollisions, aTPCEntry=aTPCEntry, modemACMmodulationMin=modemACMmodulationMin, modemErroredBlock=modemErroredBlock, radioTxMute=radioTxMute, ethRXMulticasts=ethRXMulticasts, description=description, modemGeneralStatus=modemGeneralStatus, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemIndex=modemIndex, vlanTable=vlanTable, vlanEntry=vlanEntry, vlanRowStatus=vlanRowStatus, ethRXLongEvents=ethRXLongEvents, ethRXByteCounterLow=ethRXByteCounterLow, ethGFPFCSErrors=ethGFPFCSErrors, ethTXMaxCollisions=ethTXMaxCollisions, radioRxLevel=radioRxLevel, modemTotalCapacity=modemTotalCapacity, modemACMengine=modemACMengine, modemLastAcqError=modemLastAcqError, aTPCTable=aTPCTable, atpcEnabled=atpcEnabled, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXControlFrames=ethTXControlFrames, e1t1LOS=e1t1LOS, ethTXUnderruns=ethTXUnderruns, tehnika=tehnika, modemRadialMSE=modemRadialMSE, modemInternalAGCgain=modemInternalAGCgain, e1t1StatTable=e1t1StatTable, vlanPortType=vlanPortType, ethGFPDropedFrames=ethGFPDropedFrames, product=product, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemStatistics=modemStatistics, ethRXDones=ethRXDones, ipRadioStat=ipRadioStat, hostname=hostname, modemCarrierOffset=modemCarrierOffset, ethTXExcessiveDefers=ethTXExcessiveDefers, ipRadioCfgGeneral=ipRadioCfgGeneral, e1t1AIS=e1t1AIS, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, restartcpu=restartcpu, modemErroredSecondRatio=modemErroredSecondRatio, vlanPortmap=vlanPortmap, vlanFid=vlanFid, vlansEnabled=vlansEnabled, vlanNumber=vlanNumber, licenseMask=licenseMask, loopbacks=loopbacks, writeConfig=writeConfig, radioTable=radioTable, ethRXBroadcasts=ethRXBroadcasts, e1t1ChannelNr=e1t1ChannelNr, vlanCfgStat=vlanCfgStat, radioLoopback=radioLoopback, sysDateAndTime=sysDateAndTime, license=license, saf=saf, ethGFPCHECErrors=ethGFPCHECErrors, ethTXVlanTags=ethTXVlanTags, radioGenStatus=radioGenStatus, modemUnavailtime=modemUnavailtime, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXBackpresEvents=ethTXBackpresEvents, radioDuplexShift=radioDuplexShift, modemE1T1Channels=modemE1T1Channels, ethTXCollisions=ethTXCollisions, loopback_tributary_mask=loopback_tributary_mask, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemSymbolRateRx=modemSymbolRateRx, modemModulation=modemModulation, ethRXPauseFrames=ethRXPauseFrames, radioIndex=radioIndex, radioEntry=radioEntry, modemLDPCdecoderStress=modemLDPCdecoderStress, ipRadio=ipRadio, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXVlanTagsDetected=ethRXVlanTagsDetected, atpcIndex=atpcIndex, licenseUpdateStatus=licenseUpdateStatus, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXGiants=ethTXGiants, ethRXDvEvent=ethRXDvEvent, radioTxFrequency=radioTxFrequency, microwaveRadio=microwaveRadio, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemCountTime=modemCountTime, modemTotalBlockNumber=modemTotalBlockNumber, modemACMmodulationMax=modemACMmodulationMax, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXDones=ethTXDones, remoteIp=remoteIp, radioTxPower=radioTxPower, ethTXCRCErrors=ethTXCRCErrors, ipRadioCfg=ipRadioCfg, ethQOSTXFrames=ethQOSTXFrames, ethTXBroadcasts=ethTXBroadcasts)
