...
mibBuilder.exportSymbols("SAF-IPRADIO", hostname=hostname, e1t1ChannelNr=e1t1ChannelNr, ethRXPrevPktDropped=ethRXPrevPktDropped, aTPCEntry=aTPCEntry, ethTXPauseFrames=ethTXPauseFrames, aTPCTable=aTPCTable, modemCarrierOffset=modemCarrierOffset, modemRowStatus=modemRowStatus, ethRXByteCounterHi=ethRXByteCounterHi, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemErroredSecondRatio=modemErroredSecondRatio, ipRadio=ipRadio, modemACMmodulationMin=modemACMmodulationMin, restartcpu=restartcpu, modemIndex=modemIndex, modemUnavailtime=modemUnavailtime, license=license, radioTable=radioTable, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemCountTime=modemCountTime, ethRXPauseFrames=ethRXPauseFrames, ethGFPFCSErrors=ethGFPFCSErrors, ethRXCodeErrors=ethRXCodeErrors, modemModulation=modemModulation, modemSymbolRateRx=modemSymbolRateRx, vlansEnabled=vlansEnabled, sysDateAndTime=sysDateAndTime, e1t1StatTable=e1t1StatTable, ethRXMulticasts=ethRXMulticasts, ethRXByteCounterLow=ethRXByteCounterLow, modemStatistics=modemStatistics, e1t1AIS=e1t1AIS, ethRXDribleNibbles=ethRXDribleNibbles, ethRXDvEvent=ethRXDvEvent, ethGFPDropedFrames=ethGFPDropedFrames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, vlanRowStatus=vlanRowStatus, ethTXLateCollisions=ethTXLateCollisions, ethRXDones=ethRXDones, microwaveRadio=microwaveRadio, modemTotalCapacity=modemTotalCapacity, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXBroadcasts=ethRXBroadcasts, ethRXControlFrames=ethRXControlFrames, description=description, ipRadioStat=ipRadioStat, safip=safip, radioRxLevel=radioRxLevel, ethGFPCHECErrors=ethGFPCHECErrors, radioIndex=radioIndex, ipRadioCfg=ipRadioCfg, ethTXWireByteCounterLow=ethTXWireByteCounterLow, remoteIp=remoteIp, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioGenStatus=radioGenStatus, modemAcqStatus=modemAcqStatus, ethRXTruncatedFrames=ethRXTruncatedFrames, modemTable=modemTable, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXVlanTags=ethTXVlanTags, atpcEnabled=atpcEnabled, e1t1LOS=e1t1LOS, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioLoopback=radioLoopback, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXMaxCollisions=ethTXMaxCollisions, ethTXMulticasts=ethTXMulticasts, modemErroredSecond=modemErroredSecond, licenseMask=licenseMask, ethTXExcessiveDefers=ethTXExcessiveDefers, loopbacks=loopbacks, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ipRadioCfgNetwork=ipRadioCfgNetwork, modemACMengine=modemACMengine, modemE1T1Channels=modemE1T1Channels, modemACMethernetCapacity=modemACMethernetCapacity, modemLDPCdecoderStress=modemLDPCdecoderStress, licenseUpdateStatus=licenseUpdateStatus, radioDuplexShift=radioDuplexShift, ethRXCRCErrors=ethRXCRCErrors, tehnika=tehnika, modemACMtotalCapacity=modemACMtotalCapacity, radioTxFrequency=radioTxFrequency, ethTXBroadcasts=ethTXBroadcasts, modemLastAcqError=modemLastAcqError, vlanNumber=vlanNumber, modemErroredBlock=modemErroredBlock, modemBandwith=modemBandwith, localIp=localIp, modemEthernetCapacity=modemEthernetCapacity, ethTXLengthCheckErrors=ethTXLengthCheckErrors, writeConfig=writeConfig, ethTXCRCErrors=ethTXCRCErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror, loopback_tributary_mask=loopback_tributary_mask, ethRXLongEvents=ethRXLongEvents, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ipRadioStatEth=ipRadioStatEth, ethQOSTXFrames=ethQOSTXFrames, sysTemperature=sysTemperature, radioEntry=radioEntry, radioTxMute=radioTxMute, ethGFPDelineationErrors=ethGFPDelineationErrors, radioRxFrequency=radioRxFrequency, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXControlFrames=ethTXControlFrames, modemStandard=modemStandard, vlanFid=vlanFid, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioTxPower=radioTxPower, ipRadioMgmt=ipRadioMgmt, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXByteCounterHi=ethTXByteCounterHi, modemACMmodulationMax=modemACMmodulationMax, vlanCfgStat=vlanCfgStat, modemEntry=modemEntry, product=product, atpcIndex=atpcIndex, ethTXUnderruns=ethTXUnderruns, radioSide=radioSide, modemTotalBlockNumber=modemTotalBlockNumber, ethTXGiants=ethTXGiants, modemSymbolRateTx=modemSymbolRateTx, vlanPortmap=vlanPortmap, ethTXDones=ethTXDones, pointToPoint=pointToPoint, modemRadialMSE=modemRadialMSE, ethQOSTXDropped=ethQOSTXDropped, vlanEntry=vlanEntry, atpcTxPowerCorrection=atpcTxPowerCorrection, modemUptime=modemUptime, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXBackpresEvents=ethTXBackpresEvents, modemGeneralStatus=modemGeneralStatus, ethTXCollisions=ethTXCollisions, e1t1StatEntry=e1t1StatEntry, localIpMask=localIpMask, modemInternalAGCgain=modemInternalAGCgain, saf=saf, ethTXByteCounterLow=ethTXByteCounterLow, vlanPortType=vlanPortType, vlanTable=vlanTable, modemE1T1ChannelMask=modemE1T1ChannelMask)
