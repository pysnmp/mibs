...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXMulticasts=ethTXMulticasts, ethRXDvEvent=ethRXDvEvent, ethTXCRCErrors=ethTXCRCErrors, radioTxPower=radioTxPower, modemE1T1Channels=modemE1T1Channels, safip=safip, modemSymbolRateRx=modemSymbolRateRx, ipRadioCfgNetwork=ipRadioCfgNetwork, modemBandwith=modemBandwith, vlanEntry=vlanEntry, ethRXByteCounterHi=ethRXByteCounterHi, loopback_tributary_mask=loopback_tributary_mask, pointToPoint=pointToPoint, ethRXLongEvents=ethRXLongEvents, ethRXControlFrames=ethRXControlFrames, e1t1StatTable=e1t1StatTable, ethGFPCHECErrors=ethGFPCHECErrors, modemStandard=modemStandard, vlanPortmap=vlanPortmap, ethTXUnderruns=ethTXUnderruns, ethTXCollisions=ethTXCollisions, modemModulation=modemModulation, radioTable=radioTable, modemEthernetCapacity=modemEthernetCapacity, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, loopbacks=loopbacks, modemTotalCapacity=modemTotalCapacity, ethGFPDropedFrames=ethGFPDropedFrames, ethTXBroadcasts=ethTXBroadcasts, vlanTable=vlanTable, ethRXPrevPktDropped=ethRXPrevPktDropped, modemErroredSecondRatio=modemErroredSecondRatio, license=license, vlanFid=vlanFid, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXUnsupOpcodes=ethRXUnsupOpcodes, restartcpu=restartcpu, modemErroredSecond=modemErroredSecond, ethTXVlanTags=ethTXVlanTags, ipRadioStat=ipRadioStat, modemACMmodulationMax=modemACMmodulationMax, vlanPortType=vlanPortType, ipRadioStatEth=ipRadioStatEth, localIpMask=localIpMask, ethTXPauseFrames=ethTXPauseFrames, radioIndex=radioIndex, modemE1T1ChannelMask=modemE1T1ChannelMask, modemGeneralStatus=modemGeneralStatus, modemACMtotalCapacity=modemACMtotalCapacity, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, e1t1ChannelNr=e1t1ChannelNr, modemTable=modemTable, modemLastAcqError=modemLastAcqError, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXByteCounterHi=ethTXByteCounterHi, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemInternalAGCgain=modemInternalAGCgain, ipRadio=ipRadio, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXByteCounterLow=ethRXByteCounterLow, modemStatistics=modemStatistics, modemACMethernetCapacity=modemACMethernetCapacity, ethTXBackpresEvents=ethTXBackpresEvents, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemRowStatus=modemRowStatus, radioRxFrequency=radioRxFrequency, e1t1LOS=e1t1LOS, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlanCfgStat=vlanCfgStat, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, licenseUpdateStatus=licenseUpdateStatus, modemIndex=modemIndex, modemACMengine=modemACMengine, modemRadialMSE=modemRadialMSE, ethTXByteCounterLow=ethTXByteCounterLow, ethGFPDelineationErrors=ethGFPDelineationErrors, sysTemperature=sysTemperature, e1t1StatEntry=e1t1StatEntry, modemAcqStatus=modemAcqStatus, atpcEnabled=atpcEnabled, ethQOSTXDropped=ethQOSTXDropped, modemUptime=modemUptime, remoteIp=remoteIp, atpcTxPowerCorrection=atpcTxPowerCorrection, modemEntry=modemEntry, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXDribleNibbles=ethRXDribleNibbles, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXDones=ethRXDones, product=product, radioEntry=radioEntry, modemCountTime=modemCountTime, modemTotalBlockNumber=modemTotalBlockNumber, licenseMask=licenseMask, ethTXGiants=ethTXGiants, radioLoopback=radioLoopback, ipRadioCfg=ipRadioCfg, microwaveRadio=microwaveRadio, writeConfig=writeConfig, modemLDPCdecoderStress=modemLDPCdecoderStress, saf=saf, radioDuplexShift=radioDuplexShift, ethRXBroadcasts=ethRXBroadcasts, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXMulticasts=ethRXMulticasts, ipRadioCfgGeneral=ipRadioCfgGeneral, e1t1AIS=e1t1AIS, ethRXPauseFrames=ethRXPauseFrames, ethRXCodeErrors=ethRXCodeErrors, ethQOSTXFrames=ethQOSTXFrames, hostname=hostname, radioGenStatus=radioGenStatus, radioRxLevel=radioRxLevel, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXControlFrames=ethTXControlFrames, description=description, modemSymbolRateTx=modemSymbolRateTx, vlansEnabled=vlansEnabled, radioTxMute=radioTxMute, modemUnavailtime=modemUnavailtime, atpcIndex=atpcIndex, vlanNumber=vlanNumber, ipRadioMgmt=ipRadioMgmt, aTPCEntry=aTPCEntry, radioTxFrequency=radioTxFrequency, modemErroredBlock=modemErroredBlock, ethTXLengthCheckErrors=ethTXLengthCheckErrors, sysDateAndTime=sysDateAndTime, ethTXLateCollisions=ethTXLateCollisions, localIp=localIp, ethTXDones=ethTXDones, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXCRCErrors=ethRXCRCErrors, modemACMmodulationMin=modemACMmodulationMin, tehnika=tehnika, vlanRowStatus=vlanRowStatus, radioSide=radioSide, aTPCTable=aTPCTable, ethTXMaxCollisions=ethTXMaxCollisions, ethGFPFCSErrors=ethGFPFCSErrors, modemCarrierOffset=modemCarrierOffset)
