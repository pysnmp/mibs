...
mibBuilder.exportSymbols("SAF-IPRADIO", ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethGFPCHECErrors=ethGFPCHECErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioTxMute=radioTxMute, vlanRowStatus=vlanRowStatus, modemModulation=modemModulation, radioTxFrequency=radioTxFrequency, ethQOSTXDropped=ethQOSTXDropped, modemErroredSecond=modemErroredSecond, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, e1t1StatEntry=e1t1StatEntry, radioTable=radioTable, licenseMask=licenseMask, modemACMmodulationMax=modemACMmodulationMax, vlansEnabled=vlansEnabled, hostname=hostname, modemStandard=modemStandard, ethTXBroadcasts=ethTXBroadcasts, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXByteCounterHi=ethRXByteCounterHi, vlanFid=vlanFid, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemE1T1Channels=modemE1T1Channels, ethTXLateCollisions=ethTXLateCollisions, ethGFPDropedFrames=ethGFPDropedFrames, ipRadio=ipRadio, modemRowStatus=modemRowStatus, vlanPortType=vlanPortType, modemACMengine=modemACMengine, modemTotalCapacity=modemTotalCapacity, description=description, modemErroredBlock=modemErroredBlock, ethTXControlFrames=ethTXControlFrames, modemSymbolRateTx=modemSymbolRateTx, ipRadioStat=ipRadioStat, license=license, modemLDPCdecoderStress=modemLDPCdecoderStress, ipRadioCfgGeneral=ipRadioCfgGeneral, licenseUpdateStatus=licenseUpdateStatus, ethTXExcessiveDefers=ethTXExcessiveDefers, sysDateAndTime=sysDateAndTime, aTPCTable=aTPCTable, radioDuplexShift=radioDuplexShift, sysTemperature=sysTemperature, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXBroadcasts=ethRXBroadcasts, modemCountTime=modemCountTime, loopback_tributary_mask=loopback_tributary_mask, ethRXLongEvents=ethRXLongEvents, ethRXDvEvent=ethRXDvEvent, modemEthernetCapacity=modemEthernetCapacity, ethRXByteCounterLow=ethRXByteCounterLow, modemUnavailtime=modemUnavailtime, saf=saf, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemRadialMSE=modemRadialMSE, safip=safip, modemIndex=modemIndex, remoteIp=remoteIp, modemInternalAGCgain=modemInternalAGCgain, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXByteCounterHi=ethTXByteCounterHi, modemGeneralStatus=modemGeneralStatus, radioIndex=radioIndex, modemSymbolRateRx=modemSymbolRateRx, modemLastAcqError=modemLastAcqError, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemAcqStatus=modemAcqStatus, radioEntry=radioEntry, modemACMethernetCapacity=modemACMethernetCapacity, ethRXMulticasts=ethRXMulticasts, ethGFPFCSErrors=ethGFPFCSErrors, radioLoopback=radioLoopback, modemE1T1ChannelMask=modemE1T1ChannelMask, tehnika=tehnika, vlanEntry=vlanEntry, ethRXDribleNibbles=ethRXDribleNibbles, ipRadioCfg=ipRadioCfg, modemTotalBlockNumber=modemTotalBlockNumber, modemTable=modemTable, modemBandwith=modemBandwith, localIpMask=localIpMask, radioRxFrequency=radioRxFrequency, ethRXCodeErrors=ethRXCodeErrors, ipRadioMgmt=ipRadioMgmt, e1t1StatTable=e1t1StatTable, ethTXByteCounterLow=ethTXByteCounterLow, vlanNumber=vlanNumber, ethRXUnsupOpcodes=ethRXUnsupOpcodes, microwaveRadio=microwaveRadio, product=product, ethTXMulticasts=ethTXMulticasts, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXCollisions=ethTXCollisions, modemACMmodulationMin=modemACMmodulationMin, ethRXControlFrames=ethRXControlFrames, ethRXPrevPktDropped=ethRXPrevPktDropped, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioSide=radioSide, vlanTable=vlanTable, restartcpu=restartcpu, ethRXCRCErrors=ethRXCRCErrors, ethQOSTXFrames=ethQOSTXFrames, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXVlanTags=ethTXVlanTags, ethRXPauseFrames=ethRXPauseFrames, loopbacks=loopbacks, aTPCEntry=aTPCEntry, radioRxLevel=radioRxLevel, pointToPoint=pointToPoint, modemErroredSecondRatio=modemErroredSecondRatio, vlanPortmap=vlanPortmap, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXDones=ethRXDones, ethTXBackpresEvents=ethTXBackpresEvents, e1t1AIS=e1t1AIS, ethTXUnderruns=ethTXUnderruns, radioGenStatus=radioGenStatus, ethTXPauseFrames=ethTXPauseFrames, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXDones=ethTXDones, modemStatistics=modemStatistics, ipRadioStatEth=ipRadioStatEth, ethTXCRCErrors=ethTXCRCErrors, ethTXGiants=ethTXGiants, radioTxPower=radioTxPower, ethTXMaxCollisions=ethTXMaxCollisions, e1t1ChannelNr=e1t1ChannelNr, modemEntry=modemEntry, e1t1LOS=e1t1LOS, atpcEnabled=atpcEnabled, localIp=localIp, modemACMtotalCapacity=modemACMtotalCapacity, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemCarrierOffset=modemCarrierOffset, modemUptime=modemUptime, writeConfig=writeConfig, vlanCfgStat=vlanCfgStat, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethGFPDelineationErrors=ethGFPDelineationErrors, atpcIndex=atpcIndex)
