...
mibBuilder.exportSymbols("SAF-IPRADIO", modemSymbolRateRx=modemSymbolRateRx, ipRadioStat=ipRadioStat, modemIndex=modemIndex, modemStatistics=modemStatistics, ethRXCodeErrors=ethRXCodeErrors, modemACMmodulationMin=modemACMmodulationMin, ethRXControlFrames=ethRXControlFrames, vlansEnabled=vlansEnabled, ipRadio=ipRadio, modemUptime=modemUptime, modemBandwith=modemBandwith, ethTXMaxCollisions=ethTXMaxCollisions, modemTotalBlockNumber=modemTotalBlockNumber, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, vlanRowStatus=vlanRowStatus, ethRXDribleNibbles=ethRXDribleNibbles, modemErroredSecondRatio=modemErroredSecondRatio, radioTxFrequency=radioTxFrequency, ethRXDvEvent=ethRXDvEvent, e1t1StatTable=e1t1StatTable, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioIndex=radioIndex, vlanPortType=vlanPortType, modemErroredSecond=modemErroredSecond, radioSide=radioSide, modemErroredBlock=modemErroredBlock, radioRxLevel=radioRxLevel, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXPauseFrames=ethRXPauseFrames, microwaveRadio=microwaveRadio, restartcpu=restartcpu, modemRowStatus=modemRowStatus, ethTXExcessiveDefers=ethTXExcessiveDefers, ethQOSTXFrames=ethQOSTXFrames, saf=saf, modemACMethernetCapacity=modemACMethernetCapacity, sysTemperature=sysTemperature, radioRxFrequency=radioRxFrequency, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXUnderruns=ethTXUnderruns, vlanNumber=vlanNumber, vlanTable=vlanTable, ethRXUnsupOpcodes=ethRXUnsupOpcodes, vlanPortmap=vlanPortmap, ethTXGiants=ethTXGiants, ipRadioCfg=ipRadioCfg, ethTXPauseFrames=ethTXPauseFrames, ethTXByteCounterLow=ethTXByteCounterLow, radioTxPower=radioTxPower, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXBroadcasts=ethTXBroadcasts, ethRXMulticasts=ethRXMulticasts, modemSymbolRateTx=modemSymbolRateTx, ethQOSTXDropped=ethQOSTXDropped, ethTXBackpresEvents=ethTXBackpresEvents, ethGFPDelineationErrors=ethGFPDelineationErrors, modemLastAcqError=modemLastAcqError, safip=safip, ipRadioMgmt=ipRadioMgmt, ethGFPFCSErrors=ethGFPFCSErrors, ethGFPCHECErrors=ethGFPCHECErrors, modemEntry=modemEntry, e1t1ChannelNr=e1t1ChannelNr, modemInternalAGCgain=modemInternalAGCgain, modemRadialMSE=modemRadialMSE, ethTXCollisions=ethTXCollisions, remoteIp=remoteIp, ethTXDones=ethTXDones, ethGFPDropedFrames=ethGFPDropedFrames, ethTXCRCErrors=ethTXCRCErrors, ethTXVlanTags=ethTXVlanTags, radioGenStatus=radioGenStatus, radioEntry=radioEntry, modemStandard=modemStandard, licenseUpdateStatus=licenseUpdateStatus, modemCarrierOffset=modemCarrierOffset, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioLoopback=radioLoopback, modemGeneralStatus=modemGeneralStatus, writeConfig=writeConfig, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXBroadcasts=ethRXBroadcasts, ethRXLongEvents=ethRXLongEvents, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemAcqStatus=modemAcqStatus, ethRXDones=ethRXDones, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemUnavailtime=modemUnavailtime, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, licenseMask=licenseMask, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, product=product, modemACMengine=modemACMengine, radioTxMute=radioTxMute, e1t1AIS=e1t1AIS, pointToPoint=pointToPoint, ethTXByteCounterHi=ethTXByteCounterHi, ethTXWireByteCounterHi=ethTXWireByteCounterHi, sysDateAndTime=sysDateAndTime, modemEthernetCapacity=modemEthernetCapacity, hostname=hostname, ethTXLengthCheckErrors=ethTXLengthCheckErrors, e1t1StatEntry=e1t1StatEntry, ipRadioStatEth=ipRadioStatEth, ethQOSRXQ1Frames=ethQOSRXQ1Frames, e1t1LOS=e1t1LOS, modemModulation=modemModulation, ethTXControlFrames=ethTXControlFrames, modemCountTime=modemCountTime, ipRadioCfgNetwork=ipRadioCfgNetwork, aTPCEntry=aTPCEntry, modemTable=modemTable, vlanFid=vlanFid, license=license, aTPCTable=aTPCTable, vlanCfgStat=vlanCfgStat, loopbacks=loopbacks, ethTXLateCollisions=ethTXLateCollisions, modemE1T1Channels=modemE1T1Channels, loopback_tributary_mask=loopback_tributary_mask, radioTable=radioTable, ethRXCRCErrors=ethRXCRCErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXByteCounterHi=ethRXByteCounterHi, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioDuplexShift=radioDuplexShift, modemACMmodulationMax=modemACMmodulationMax, ethTXMulticasts=ethTXMulticasts, ethRXByteCounterLow=ethRXByteCounterLow, modemACMtotalCapacity=modemACMtotalCapacity, ethTXWireByteCounterLow=ethTXWireByteCounterLow, description=description, localIpMask=localIpMask, ipRadioCfgGeneral=ipRadioCfgGeneral, modemTotalCapacity=modemTotalCapacity, atpcEnabled=atpcEnabled, tehnika=tehnika, vlanEntry=vlanEntry, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, localIp=localIp, atpcIndex=atpcIndex)
