...
mibBuilder.exportSymbols("SAF-IPRADIO", vlanRowStatus=vlanRowStatus, ethRXBroadcasts=ethRXBroadcasts, radioRxFrequency=radioRxFrequency, vlanFid=vlanFid, ethRXLongEvents=ethRXLongEvents, ethRXPrevPktDropped=ethRXPrevPktDropped, e1t1ChannelNr=e1t1ChannelNr, microwaveRadio=microwaveRadio, aTPCEntry=aTPCEntry, modemStatistics=modemStatistics, aTPCTable=aTPCTable, modemBandwith=modemBandwith, product=product, radioGenStatus=radioGenStatus, ethTXBackpresEvents=ethTXBackpresEvents, vlanNumber=vlanNumber, ethTXControlFrames=ethTXControlFrames, radioSide=radioSide, modemGeneralStatus=modemGeneralStatus, modemInternalAGCgain=modemInternalAGCgain, ethRXMulticasts=ethRXMulticasts, licenseUpdateStatus=licenseUpdateStatus, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXByteCounterLow=ethRXByteCounterLow, modemACMtotalCapacity=modemACMtotalCapacity, modemSeverelyErroredSecond=modemSeverelyErroredSecond, e1t1AIS=e1t1AIS, ethQOSTXDropped=ethQOSTXDropped, sysDateAndTime=sysDateAndTime, ethTXMaxCollisions=ethTXMaxCollisions, radioTable=radioTable, vlanPortType=vlanPortType, ethGFPDropedFrames=ethGFPDropedFrames, modemE1T1ChannelMask=modemE1T1ChannelMask, ipRadioStatEth=ipRadioStatEth, modemEthernetCapacity=modemEthernetCapacity, ethRXByteCounterHi=ethRXByteCounterHi, localIp=localIp, ipRadioStat=ipRadioStat, modemACMethernetCapacity=modemACMethernetCapacity, safip=safip, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemACMengine=modemACMengine, ethTXExcessiveDefers=ethTXExcessiveDefers, modemSymbolRateRx=modemSymbolRateRx, radioTxMute=radioTxMute, ethTXLateCollisions=ethTXLateCollisions, description=description, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemSymbolRateTx=modemSymbolRateTx, ipRadioCfgGeneral=ipRadioCfgGeneral, atpcEnabled=atpcEnabled, vlanPortmap=vlanPortmap, modemLDPCdecoderStress=modemLDPCdecoderStress, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, sysTemperature=sysTemperature, ipRadioCfg=ipRadioCfg, radioRxLevel=radioRxLevel, modemTotalCapacity=modemTotalCapacity, ethTXByteCounterLow=ethTXByteCounterLow, ethRXCodeErrors=ethRXCodeErrors, ethTXGiants=ethTXGiants, ethRXUnsupOpcodes=ethRXUnsupOpcodes, license=license, ipRadioMgmt=ipRadioMgmt, writeConfig=writeConfig, ipRadioCfgNetwork=ipRadioCfgNetwork, modemRowStatus=modemRowStatus, ethTXUnderruns=ethTXUnderruns, ipRadio=ipRadio, radioIndex=radioIndex, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXTruncatedFrames=ethRXTruncatedFrames, localIpMask=localIpMask, ethRXDvEvent=ethRXDvEvent, modemAcqStatus=modemAcqStatus, ethRXPauseFrames=ethRXPauseFrames, ethRXControlFrames=ethRXControlFrames, modemUnavailtime=modemUnavailtime, modemErroredSecond=modemErroredSecond, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethGFPCHECErrors=ethGFPCHECErrors, modemUptime=modemUptime, modemTotalBlockNumber=modemTotalBlockNumber, ethTXCRCErrors=ethTXCRCErrors, vlanTable=vlanTable, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethQOSRXQ1Frames=ethQOSRXQ1Frames, atpcIndex=atpcIndex, remoteIp=remoteIp, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemIndex=modemIndex, vlanCfgStat=vlanCfgStat, ethTXPauseFrames=ethTXPauseFrames, ethRXDones=ethRXDones, ethTXBroadcasts=ethTXBroadcasts, radioEntry=radioEntry, hostname=hostname, ethTXVlanTags=ethTXVlanTags, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXCollisions=ethTXCollisions, modemACMmodulationMin=modemACMmodulationMin, loopbacks=loopbacks, licenseMask=licenseMask, modemCarrierOffset=modemCarrierOffset, vlansEnabled=vlansEnabled, radioTxFrequency=radioTxFrequency, radioLoopback=radioLoopback, modemStandard=modemStandard, tehnika=tehnika, pointToPoint=pointToPoint, e1t1StatTable=e1t1StatTable, modemEntry=modemEntry, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, e1t1LOS=e1t1LOS, ethTXMulticasts=ethTXMulticasts, ethRXCRCErrors=ethRXCRCErrors, radioDuplexShift=radioDuplexShift, modemTable=modemTable, saf=saf, modemModulation=modemModulation, radioTxPower=radioTxPower, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXDones=ethTXDones, restartcpu=restartcpu, modemCountTime=modemCountTime, ethGFPFCSErrors=ethGFPFCSErrors, modemRadialMSE=modemRadialMSE, atpcTxPowerCorrection=atpcTxPowerCorrection, ethGFPDelineationErrors=ethGFPDelineationErrors, loopback_tributary_mask=loopback_tributary_mask, modemLastAcqError=modemLastAcqError, modemE1T1Channels=modemE1T1Channels, vlanEntry=vlanEntry, modemErroredBlock=modemErroredBlock, ethRXDribleNibbles=ethRXDribleNibbles, ethTXByteCounterHi=ethTXByteCounterHi, e1t1StatEntry=e1t1StatEntry, ethQOSTXFrames=ethQOSTXFrames, modemErroredSecondRatio=modemErroredSecondRatio, modemACMmodulationMax=modemACMmodulationMax, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors)
