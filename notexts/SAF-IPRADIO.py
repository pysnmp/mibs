...
mibBuilder.exportSymbols("SAF-IPRADIO", atpcTxPowerCorrection=atpcTxPowerCorrection, vlanCfgStat=vlanCfgStat, modemStatistics=modemStatistics, modemModulation=modemModulation, ethRXLongEvents=ethRXLongEvents, ethTXCRCErrors=ethTXCRCErrors, ethTXByteCounterHi=ethTXByteCounterHi, ipRadioStatEth=ipRadioStatEth, safip=safip, radioGenStatus=radioGenStatus, modemSymbolRateTx=modemSymbolRateTx, radioLoopback=radioLoopback, ethGFPCHECErrors=ethGFPCHECErrors, e1t1ChannelNr=e1t1ChannelNr, modemEthernetCapacity=modemEthernetCapacity, ethTXLengthCheckErrors=ethTXLengthCheckErrors, vlanNumber=vlanNumber, modemE1T1ChannelMask=modemE1T1ChannelMask, e1t1AIS=e1t1AIS, modemLDPCdecoderStress=modemLDPCdecoderStress, modemBandwith=modemBandwith, ethRXBroadcasts=ethRXBroadcasts, e1t1StatTable=e1t1StatTable, radioSide=radioSide, ethQOSRXQ2Frames=ethQOSRXQ2Frames, e1t1StatEntry=e1t1StatEntry, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemRadialMSE=modemRadialMSE, vlanPortmap=vlanPortmap, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioTxFrequency=radioTxFrequency, vlansEnabled=vlansEnabled, vlanRowStatus=vlanRowStatus, tehnika=tehnika, ipRadioCfgGeneral=ipRadioCfgGeneral, ipRadioCfg=ipRadioCfg, vlanPortType=vlanPortType, pointToPoint=pointToPoint, loopback_tributary_mask=loopback_tributary_mask, modemCarrierOffset=modemCarrierOffset, modemTotalBlockNumber=modemTotalBlockNumber, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, sysTemperature=sysTemperature, ipRadioStat=ipRadioStat, restartcpu=restartcpu, description=description, ethRXDribleNibbles=ethRXDribleNibbles, loopbacks=loopbacks, modemTable=modemTable, modemACMengine=modemACMengine, ethTXMulticasts=ethTXMulticasts, modemIndex=modemIndex, ethRXPauseFrames=ethRXPauseFrames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXDones=ethRXDones, modemCountTime=modemCountTime, licenseMask=licenseMask, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemErroredBlock=modemErroredBlock, radioRxLevel=radioRxLevel, ethTXPauseFrames=ethTXPauseFrames, ethTXDones=ethTXDones, modemErroredSecondRatio=modemErroredSecondRatio, radioTxPower=radioTxPower, ethRXByteCounterLow=ethRXByteCounterLow, ipRadioMgmt=ipRadioMgmt, modemACMtotalCapacity=modemACMtotalCapacity, ethRXCodeErrors=ethRXCodeErrors, ethTXGiants=ethTXGiants, ethTXLateCollisions=ethTXLateCollisions, localIpMask=localIpMask, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXCRCErrors=ethRXCRCErrors, modemEntry=modemEntry, saf=saf, ethTXMaxCollisions=ethTXMaxCollisions, aTPCEntry=aTPCEntry, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemAcqStatus=modemAcqStatus, radioTxMute=radioTxMute, ethRXControlFrames=ethRXControlFrames, ethTXBroadcasts=ethTXBroadcasts, radioRxFrequency=radioRxFrequency, radioDuplexShift=radioDuplexShift, ethTXByteCounterLow=ethTXByteCounterLow, ethQOSTXDropped=ethQOSTXDropped, ethGFPDropedFrames=ethGFPDropedFrames, ipRadio=ipRadio, localIp=localIp, modemGeneralStatus=modemGeneralStatus, ethTXExcessiveDefers=ethTXExcessiveDefers, radioTable=radioTable, ethRXDvEvent=ethRXDvEvent, sysDateAndTime=sysDateAndTime, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemSymbolRateRx=modemSymbolRateRx, ethTXBackpresEvents=ethTXBackpresEvents, ethGFPDelineationErrors=ethGFPDelineationErrors, vlanTable=vlanTable, ethQOSTXFrames=ethQOSTXFrames, license=license, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemUptime=modemUptime, ethTXUnderruns=ethTXUnderruns, modemRowStatus=modemRowStatus, ethTXCollisions=ethTXCollisions, vlanFid=vlanFid, ethGFPFCSErrors=ethGFPFCSErrors, vlanEntry=vlanEntry, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemTotalCapacity=modemTotalCapacity, aTPCTable=aTPCTable, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemACMethernetCapacity=modemACMethernetCapacity, modemE1T1Channels=modemE1T1Channels, hostname=hostname, ipRadioCfgNetwork=ipRadioCfgNetwork, e1t1LOS=e1t1LOS, modemInternalAGCgain=modemInternalAGCgain, ethRXTruncatedFrames=ethRXTruncatedFrames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemACMmodulationMin=modemACMmodulationMin, ethRXByteCounterHi=ethRXByteCounterHi, ethRXPrevPktDropped=ethRXPrevPktDropped, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemLastAcqError=modemLastAcqError, radioIndex=radioIndex, modemUnavailtime=modemUnavailtime, modemStandard=modemStandard, modemACMmodulationMax=modemACMmodulationMax, atpcIndex=atpcIndex, writeConfig=writeConfig, radioEntry=radioEntry, microwaveRadio=microwaveRadio, atpcEnabled=atpcEnabled, ethTXControlFrames=ethTXControlFrames, ethRXMulticasts=ethRXMulticasts, ethTXVlanTags=ethTXVlanTags, licenseUpdateStatus=licenseUpdateStatus, modemErroredSecond=modemErroredSecond, remoteIp=remoteIp, product=product, ethRXUnsupOpcodes=ethRXUnsupOpcodes)
