...
mibBuilder.exportSymbols("SAF-IPRADIO", radioEntry=radioEntry, modemE1T1ChannelMask=modemE1T1ChannelMask, modemE1T1Channels=modemE1T1Channels, writeConfig=writeConfig, ipRadio=ipRadio, modemACMengine=modemACMengine, ethTXWireByteCounterHi=ethTXWireByteCounterHi, sysDateAndTime=sysDateAndTime, loopback_tributary_mask=loopback_tributary_mask, ethRXControlFrames=ethRXControlFrames, atpcEnabled=atpcEnabled, hostname=hostname, ethTXDones=ethTXDones, radioDuplexShift=radioDuplexShift, ethRXByteCounterLow=ethRXByteCounterLow, e1t1AIS=e1t1AIS, ethTXGiants=ethTXGiants, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioIndex=radioIndex, ethTXCollisions=ethTXCollisions, ethTXBackpresEvents=ethTXBackpresEvents, modemErroredBlock=modemErroredBlock, radioTxMute=radioTxMute, radioLoopback=radioLoopback, modemACMtotalCapacity=modemACMtotalCapacity, modemUptime=modemUptime, ethRXDones=ethRXDones, modemErroredSecond=modemErroredSecond, e1t1StatEntry=e1t1StatEntry, ethRXDribleNibbles=ethRXDribleNibbles, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXBroadcasts=ethRXBroadcasts, modemEntry=modemEntry, ipRadioCfgNetwork=ipRadioCfgNetwork, modemSeverelyErroredSecond=modemSeverelyErroredSecond, licenseMask=licenseMask, ethTXPauseFrames=ethTXPauseFrames, localIp=localIp, ethGFPDelineationErrors=ethGFPDelineationErrors, modemBandwith=modemBandwith, modemSymbolRateTx=modemSymbolRateTx, aTPCEntry=aTPCEntry, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioGenStatus=radioGenStatus, ethRXCRCErrors=ethRXCRCErrors, ethTXExcessiveDefers=ethTXExcessiveDefers, radioTable=radioTable, remoteIp=remoteIp, e1t1LOS=e1t1LOS, ipRadioMgmt=ipRadioMgmt, ethRXPrevPktDropped=ethRXPrevPktDropped, description=description, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemLDPCdecoderStress=modemLDPCdecoderStress, ethQOSTXFrames=ethQOSTXFrames, vlansEnabled=vlansEnabled, modemRadialMSE=modemRadialMSE, ethGFPCHECErrors=ethGFPCHECErrors, modemTotalCapacity=modemTotalCapacity, loopbacks=loopbacks, modemACMmodulationMin=modemACMmodulationMin, ethQOSTXDropped=ethQOSTXDropped, modemErroredSecondRatio=modemErroredSecondRatio, vlanCfgStat=vlanCfgStat, atpcIndex=atpcIndex, ethGFPDropedFrames=ethGFPDropedFrames, ethTXMaxCollisions=ethTXMaxCollisions, vlanTable=vlanTable, atpcTxPowerCorrection=atpcTxPowerCorrection, safip=safip, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemSymbolRateRx=modemSymbolRateRx, modemGeneralStatus=modemGeneralStatus, ipRadioCfgGeneral=ipRadioCfgGeneral, e1t1StatTable=e1t1StatTable, modemIndex=modemIndex, radioTxFrequency=radioTxFrequency, ethRXDvEvent=ethRXDvEvent, ipRadioStat=ipRadioStat, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXMulticasts=ethTXMulticasts, license=license, ethRXPauseFrames=ethRXPauseFrames, modemUnavailtime=modemUnavailtime, ethTXByteCounterLow=ethTXByteCounterLow, restartcpu=restartcpu, sysTemperature=sysTemperature, localIpMask=localIpMask, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioTxPower=radioTxPower, ethRXMulticasts=ethRXMulticasts, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemRowStatus=modemRowStatus, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXByteCounterHi=ethRXByteCounterHi, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemAcqStatus=modemAcqStatus, ethTXBroadcasts=ethTXBroadcasts, modemModulation=modemModulation, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, saf=saf, ethGFPFCSErrors=ethGFPFCSErrors, ethTXLateCollisions=ethTXLateCollisions, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXCodeErrors=ethRXCodeErrors, modemEthernetCapacity=modemEthernetCapacity, ipRadioCfg=ipRadioCfg, ethTXVlanTags=ethTXVlanTags, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemInternalAGCgain=modemInternalAGCgain, modemStatistics=modemStatistics, licenseUpdateStatus=licenseUpdateStatus, ipRadioStatEth=ipRadioStatEth, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, tehnika=tehnika, modemStandard=modemStandard, modemACMethernetCapacity=modemACMethernetCapacity, vlanPortType=vlanPortType, microwaveRadio=microwaveRadio, pointToPoint=pointToPoint, modemTotalBlockNumber=modemTotalBlockNumber, ethTXControlFrames=ethTXControlFrames, ethTXByteCounterHi=ethTXByteCounterHi, vlanEntry=vlanEntry, vlanFid=vlanFid, ethRXLongEvents=ethRXLongEvents, vlanRowStatus=vlanRowStatus, vlanPortmap=vlanPortmap, radioSide=radioSide, modemCountTime=modemCountTime, ethTXCRCErrors=ethTXCRCErrors, product=product, e1t1ChannelNr=e1t1ChannelNr, radioRxLevel=radioRxLevel, modemCarrierOffset=modemCarrierOffset, modemACMmodulationMax=modemACMmodulationMax, ethTXUnderruns=ethTXUnderruns, modemTable=modemTable, vlanNumber=vlanNumber, modemLastAcqError=modemLastAcqError, radioRxFrequency=radioRxFrequency, aTPCTable=aTPCTable)
