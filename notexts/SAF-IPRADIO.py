...
mibBuilder.exportSymbols("SAF-IPRADIO", remoteIp=remoteIp, ethGFPDropedFrames=ethGFPDropedFrames, ethRXByteCounterHi=ethRXByteCounterHi, modemRowStatus=modemRowStatus, modemTable=modemTable, licenseUpdateStatus=licenseUpdateStatus, ethRXCodeErrors=ethRXCodeErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ipRadio=ipRadio, ethRXDones=ethRXDones, e1t1StatEntry=e1t1StatEntry, radioLoopback=radioLoopback, ethTXMulticasts=ethTXMulticasts, ethGFPFCSErrors=ethGFPFCSErrors, ethTXLateCollisions=ethTXLateCollisions, microwaveRadio=microwaveRadio, licenseMask=licenseMask, ethRXCRCErrors=ethRXCRCErrors, modemEntry=modemEntry, ethTXVlanTags=ethTXVlanTags, atpcIndex=atpcIndex, ethTXDones=ethTXDones, modemACMtotalCapacity=modemACMtotalCapacity, ethRXLongEvents=ethRXLongEvents, ethTXPauseFrames=ethTXPauseFrames, vlanTable=vlanTable, vlanNumber=vlanNumber, vlanCfgStat=vlanCfgStat, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemStatistics=modemStatistics, modemSymbolRateTx=modemSymbolRateTx, radioSide=radioSide, ethRXPauseFrames=ethRXPauseFrames, ethTXBackpresEvents=ethTXBackpresEvents, modemUptime=modemUptime, e1t1AIS=e1t1AIS, atpcTxPowerCorrection=atpcTxPowerCorrection, ipRadioCfg=ipRadioCfg, modemInternalAGCgain=modemInternalAGCgain, modemACMengine=modemACMengine, ethRXPrevPktDropped=ethRXPrevPktDropped, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlanEntry=vlanEntry, radioEntry=radioEntry, modemRadialMSE=modemRadialMSE, ethTXByteCounterLow=ethTXByteCounterLow, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioGenStatus=radioGenStatus, modemCountTime=modemCountTime, description=description, modemAcqStatus=modemAcqStatus, loopbacks=loopbacks, ethQOSTXFrames=ethQOSTXFrames, ethTXGiants=ethTXGiants, e1t1StatTable=e1t1StatTable, ethTXControlFrames=ethTXControlFrames, saf=saf, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemSymbolRateRx=modemSymbolRateRx, modemE1T1Channels=modemE1T1Channels, ipRadioStat=ipRadioStat, radioTable=radioTable, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, vlanFid=vlanFid, radioRxFrequency=radioRxFrequency, modemStandard=modemStandard, ethTXBroadcasts=ethTXBroadcasts, modemUnavailtime=modemUnavailtime, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioTxPower=radioTxPower, e1t1LOS=e1t1LOS, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXUnsupOpcodes=ethRXUnsupOpcodes, pointToPoint=pointToPoint, localIpMask=localIpMask, ethGFPDelineationErrors=ethGFPDelineationErrors, modemACMethernetCapacity=modemACMethernetCapacity, ethTXUnderruns=ethTXUnderruns, ethGFPCHECErrors=ethGFPCHECErrors, vlanRowStatus=vlanRowStatus, modemErroredSecond=modemErroredSecond, ethRXControlFrames=ethRXControlFrames, radioTxMute=radioTxMute, modemACMmodulationMax=modemACMmodulationMax, ipRadioStatEth=ipRadioStatEth, loopback_tributary_mask=loopback_tributary_mask, ethTXCollisions=ethTXCollisions, e1t1ChannelNr=e1t1ChannelNr, modemE1T1ChannelMask=modemE1T1ChannelMask, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, hostname=hostname, radioIndex=radioIndex, restartcpu=restartcpu, ethRXByteCounterLow=ethRXByteCounterLow, modemCarrierOffset=modemCarrierOffset, vlanPortmap=vlanPortmap, license=license, modemModulation=modemModulation, modemTotalCapacity=modemTotalCapacity, product=product, ethRXDribleNibbles=ethRXDribleNibbles, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemTotalBlockNumber=modemTotalBlockNumber, ipRadioMgmt=ipRadioMgmt, atpcEnabled=atpcEnabled, vlansEnabled=vlansEnabled, ethTXByteCounterHi=ethTXByteCounterHi, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXBroadcasts=ethRXBroadcasts, ipRadioCfgGeneral=ipRadioCfgGeneral, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioRxLevel=radioRxLevel, ethTXCRCErrors=ethTXCRCErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXDvEvent=ethRXDvEvent, sysTemperature=sysTemperature, modemGeneralStatus=modemGeneralStatus, modemLDPCdecoderStress=modemLDPCdecoderStress, modemEthernetCapacity=modemEthernetCapacity, ethRXTruncatedFrames=ethRXTruncatedFrames, modemLastAcqError=modemLastAcqError, radioTxFrequency=radioTxFrequency, safip=safip, sysDateAndTime=sysDateAndTime, radioDuplexShift=radioDuplexShift, ethRXMulticasts=ethRXMulticasts, modemErroredBlock=modemErroredBlock, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemBandwith=modemBandwith, writeConfig=writeConfig, tehnika=tehnika, modemErroredSecondRatio=modemErroredSecondRatio, localIp=localIp, vlanPortType=vlanPortType, ethQOSTXDropped=ethQOSTXDropped, modemACMmodulationMin=modemACMmodulationMin, ipRadioCfgNetwork=ipRadioCfgNetwork, aTPCTable=aTPCTable, ethTXMaxCollisions=ethTXMaxCollisions, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemIndex=modemIndex, aTPCEntry=aTPCEntry)
