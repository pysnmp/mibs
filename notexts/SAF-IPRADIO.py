...
mibBuilder.exportSymbols("SAF-IPRADIO", radioGenStatus=radioGenStatus, modemStatistics=modemStatistics, atpcTxPowerCorrection=atpcTxPowerCorrection, radioIndex=radioIndex, modemAcqStatus=modemAcqStatus, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioTxFrequency=radioTxFrequency, loopback_tributary_mask=loopback_tributary_mask, aTPCEntry=aTPCEntry, license=license, radioTxPower=radioTxPower, modemBandwith=modemBandwith, writeConfig=writeConfig, vlansEnabled=vlansEnabled, ethQOSRXQ1Frames=ethQOSRXQ1Frames, e1t1StatEntry=e1t1StatEntry, modemACMtotalCapacity=modemACMtotalCapacity, vlanTable=vlanTable, ethQOSTXDropped=ethQOSTXDropped, radioSide=radioSide, ethTXPauseFrames=ethTXPauseFrames, localIpMask=localIpMask, modemACMmodulationMin=modemACMmodulationMin, modemSymbolRateRx=modemSymbolRateRx, licenseMask=licenseMask, ethTXBackpresEvents=ethTXBackpresEvents, ethGFPDropedFrames=ethGFPDropedFrames, saf=saf, modemTotalCapacity=modemTotalCapacity, modemStandard=modemStandard, vlanPortType=vlanPortType, modemInternalAGCgain=modemInternalAGCgain, modemACMengine=modemACMengine, ethRXCodeErrors=ethRXCodeErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, atpcEnabled=atpcEnabled, ethRXUnsupOpcodes=ethRXUnsupOpcodes, loopbacks=loopbacks, localIp=localIp, ethRXDones=ethRXDones, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXGiants=ethTXGiants, sysTemperature=sysTemperature, ethTXByteCounterLow=ethTXByteCounterLow, e1t1LOS=e1t1LOS, modemErroredSecondRatio=modemErroredSecondRatio, e1t1AIS=e1t1AIS, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXCollisions=ethTXCollisions, modemRowStatus=modemRowStatus, modemEntry=modemEntry, sysDateAndTime=sysDateAndTime, radioRxFrequency=radioRxFrequency, aTPCTable=aTPCTable, product=product, ethGFPCHECErrors=ethGFPCHECErrors, ethGFPDelineationErrors=ethGFPDelineationErrors, modemEthernetCapacity=modemEthernetCapacity, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXControlFrames=ethRXControlFrames, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXUnderruns=ethTXUnderruns, ethRXByteCounterHi=ethRXByteCounterHi, ipRadioCfg=ipRadioCfg, licenseUpdateStatus=licenseUpdateStatus, modemIndex=modemIndex, ethQOSTXFrames=ethQOSTXFrames, modemCarrierOffset=modemCarrierOffset, vlanPortmap=vlanPortmap, remoteIp=remoteIp, modemGeneralStatus=modemGeneralStatus, ipRadioMgmt=ipRadioMgmt, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemTotalBlockNumber=modemTotalBlockNumber, radioTable=radioTable, safip=safip, radioEntry=radioEntry, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXExcessiveDefers=ethTXExcessiveDefers, ipRadio=ipRadio, microwaveRadio=microwaveRadio, ethTXBroadcasts=ethTXBroadcasts, ethTXDones=ethTXDones, ethGFPFCSErrors=ethGFPFCSErrors, ipRadioStatEth=ipRadioStatEth, atpcIndex=atpcIndex, ethTXCRCErrors=ethTXCRCErrors, tehnika=tehnika, ipRadioStat=ipRadioStat, vlanCfgStat=vlanCfgStat, ethRXLongEvents=ethRXLongEvents, hostname=hostname, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXDvEvent=ethRXDvEvent, ipRadioCfgNetwork=ipRadioCfgNetwork, modemRadialMSE=modemRadialMSE, radioDuplexShift=radioDuplexShift, modemUnavailtime=modemUnavailtime, modemCountTime=modemCountTime, e1t1StatTable=e1t1StatTable, ethTXLengthCheckErrors=ethTXLengthCheckErrors, pointToPoint=pointToPoint, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, vlanRowStatus=vlanRowStatus, ethRXCRCErrors=ethRXCRCErrors, modemTable=modemTable, ethRXDribleNibbles=ethRXDribleNibbles, modemUptime=modemUptime, ethRXByteCounterLow=ethRXByteCounterLow, modemACMethernetCapacity=modemACMethernetCapacity, description=description, ethTXByteCounterHi=ethTXByteCounterHi, ethRXMulticasts=ethRXMulticasts, ethTXControlFrames=ethTXControlFrames, ethTXLateCollisions=ethTXLateCollisions, radioTxMute=radioTxMute, radioRxLevel=radioRxLevel, vlanFid=vlanFid, vlanNumber=vlanNumber, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemModulation=modemModulation, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemE1T1Channels=modemE1T1Channels, modemSymbolRateTx=modemSymbolRateTx, ethTXVlanTags=ethTXVlanTags, restartcpu=restartcpu, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXPauseFrames=ethRXPauseFrames, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXMaxCollisions=ethTXMaxCollisions, vlanEntry=vlanEntry, radioLoopback=radioLoopback, ethTXMulticasts=ethTXMulticasts, modemLastAcqError=modemLastAcqError, modemErroredSecond=modemErroredSecond, e1t1ChannelNr=e1t1ChannelNr, ethRXBroadcasts=ethRXBroadcasts, modemErroredBlock=modemErroredBlock, modemACMmodulationMax=modemACMmodulationMax)
