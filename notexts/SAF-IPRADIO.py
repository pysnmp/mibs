...
mibBuilder.exportSymbols("SAF-IPRADIO", modemRowStatus=modemRowStatus, microwaveRadio=microwaveRadio, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemModulation=modemModulation, vlanPortType=vlanPortType, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXMulticasts=ethTXMulticasts, e1t1StatEntry=e1t1StatEntry, ethQOSTXDropped=ethQOSTXDropped, ethTXCRCErrors=ethTXCRCErrors, aTPCTable=aTPCTable, ethRXByteCounterHi=ethRXByteCounterHi, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemACMtotalCapacity=modemACMtotalCapacity, e1t1StatTable=e1t1StatTable, radioLoopback=radioLoopback, ethTXDones=ethTXDones, ethTXExcessiveDefers=ethTXExcessiveDefers, modemSymbolRateRx=modemSymbolRateRx, ethRXDvEvent=ethRXDvEvent, loopbacks=loopbacks, ethTXUnderruns=ethTXUnderruns, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXByteCounterLow=ethTXByteCounterLow, vlanCfgStat=vlanCfgStat, modemStatistics=modemStatistics, product=product, vlanFid=vlanFid, ethRXTruncatedFrames=ethRXTruncatedFrames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXBroadcasts=ethTXBroadcasts, safip=safip, ethTXGiants=ethTXGiants, remoteIp=remoteIp, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemCountTime=modemCountTime, writeConfig=writeConfig, localIpMask=localIpMask, modemACMmodulationMax=modemACMmodulationMax, ethRXMulticasts=ethRXMulticasts, modemEntry=modemEntry, radioTxFrequency=radioTxFrequency, modemUptime=modemUptime, e1t1AIS=e1t1AIS, ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadioMgmt=ipRadioMgmt, ipRadioCfg=ipRadioCfg, modemSymbolRateTx=modemSymbolRateTx, licenseMask=licenseMask, vlansEnabled=vlansEnabled, modemErroredSecond=modemErroredSecond, radioSide=radioSide, radioDuplexShift=radioDuplexShift, modemACMmodulationMin=modemACMmodulationMin, modemAcqStatus=modemAcqStatus, modemRadialMSE=modemRadialMSE, ethGFPCHECErrors=ethGFPCHECErrors, ipRadio=ipRadio, vlanPortmap=vlanPortmap, modemEthernetCapacity=modemEthernetCapacity, ethTXByteCounterHi=ethTXByteCounterHi, radioGenStatus=radioGenStatus, pointToPoint=pointToPoint, modemStandard=modemStandard, licenseUpdateStatus=licenseUpdateStatus, modemTotalBlockNumber=modemTotalBlockNumber, atpcIndex=atpcIndex, ethRXDribleNibbles=ethRXDribleNibbles, vlanNumber=vlanNumber, sysDateAndTime=sysDateAndTime, radioIndex=radioIndex, ethRXCodeErrors=ethRXCodeErrors, ethTXPauseFrames=ethTXPauseFrames, modemGeneralStatus=modemGeneralStatus, e1t1ChannelNr=e1t1ChannelNr, vlanTable=vlanTable, aTPCEntry=aTPCEntry, ethRXByteCounterLow=ethRXByteCounterLow, ethTXCollisions=ethTXCollisions, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXControlFrames=ethTXControlFrames, ethRXBroadcasts=ethRXBroadcasts, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ipRadioCfgGeneral=ipRadioCfgGeneral, radioRxFrequency=radioRxFrequency, ethRXControlFrames=ethRXControlFrames, license=license, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemBandwith=modemBandwith, loopback_tributary_mask=loopback_tributary_mask, atpcTxPowerCorrection=atpcTxPowerCorrection, modemE1T1ChannelMask=modemE1T1ChannelMask, description=description, radioTable=radioTable, e1t1LOS=e1t1LOS, saf=saf, ipRadioStatEth=ipRadioStatEth, radioEntry=radioEntry, modemErroredBlock=modemErroredBlock, vlanRowStatus=vlanRowStatus, modemSeverelyErroredSecond=modemSeverelyErroredSecond, vlanEntry=vlanEntry, ethRXLongEvents=ethRXLongEvents, modemACMengine=modemACMengine, ethTXVlanTags=ethTXVlanTags, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemInternalAGCgain=modemInternalAGCgain, ethRXDones=ethRXDones, hostname=hostname, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, tehnika=tehnika, ethRXCRCErrors=ethRXCRCErrors, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemErroredSecondRatio=modemErroredSecondRatio, modemCarrierOffset=modemCarrierOffset, modemACMethernetCapacity=modemACMethernetCapacity, radioTxMute=radioTxMute, ethRXPrevPktDropped=ethRXPrevPktDropped, modemIndex=modemIndex, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ipRadioStat=ipRadioStat, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXMaxCollisions=ethTXMaxCollisions, ethGFPFCSErrors=ethGFPFCSErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemTable=modemTable, ethRXPauseFrames=ethRXPauseFrames, radioTxPower=radioTxPower, localIp=localIp, modemLastAcqError=modemLastAcqError, modemTotalCapacity=modemTotalCapacity, modemUnavailtime=modemUnavailtime, restartcpu=restartcpu, ethTXBackpresEvents=ethTXBackpresEvents, sysTemperature=sysTemperature, radioRxLevel=radioRxLevel, modemE1T1Channels=modemE1T1Channels, ethGFPDropedFrames=ethGFPDropedFrames, ethTXLateCollisions=ethTXLateCollisions, atpcEnabled=atpcEnabled, ethQOSTXFrames=ethQOSTXFrames)
