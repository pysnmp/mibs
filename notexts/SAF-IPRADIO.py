...
mibBuilder.exportSymbols("SAF-IPRADIO", aTPCTable=aTPCTable, ethRXByteCounterHi=ethRXByteCounterHi, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemInternalAGCgain=modemInternalAGCgain, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, sysTemperature=sysTemperature, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ipRadioCfgNetwork=ipRadioCfgNetwork, modemACMengine=modemACMengine, radioIndex=radioIndex, modemIndex=modemIndex, radioTxFrequency=radioTxFrequency, vlanPortmap=vlanPortmap, loopback_tributary_mask=loopback_tributary_mask, modemRadialMSE=modemRadialMSE, ethGFPDropedFrames=ethGFPDropedFrames, ethGFPFCSErrors=ethGFPFCSErrors, ethTXVlanTags=ethTXVlanTags, licenseMask=licenseMask, tehnika=tehnika, modemEthernetCapacity=modemEthernetCapacity, vlanEntry=vlanEntry, ethTXUnderruns=ethTXUnderruns, modemSymbolRateRx=modemSymbolRateRx, modemACMmodulationMax=modemACMmodulationMax, ethQOSTXDropped=ethQOSTXDropped, radioRxLevel=radioRxLevel, ethRXLongEvents=ethRXLongEvents, license=license, modemTotalBlockNumber=modemTotalBlockNumber, vlansEnabled=vlansEnabled, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXBroadcasts=ethRXBroadcasts, ipRadioCfg=ipRadioCfg, vlanCfgStat=vlanCfgStat, modemUnavailtime=modemUnavailtime, e1t1AIS=e1t1AIS, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXBackpresEvents=ethTXBackpresEvents, modemStandard=modemStandard, ethRXDribleNibbles=ethRXDribleNibbles, ethRXMulticasts=ethRXMulticasts, modemACMethernetCapacity=modemACMethernetCapacity, vlanNumber=vlanNumber, ethTXMulticasts=ethTXMulticasts, ethTXGiants=ethTXGiants, modemCountTime=modemCountTime, ethTXLateCollisions=ethTXLateCollisions, ethTXDones=ethTXDones, ethTXCRCErrors=ethTXCRCErrors, ipRadioStatEth=ipRadioStatEth, ethTXByteCounterLow=ethTXByteCounterLow, ethQOSTXFrames=ethQOSTXFrames, ethRXVlanTagsDetected=ethRXVlanTagsDetected, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXBroadcasts=ethTXBroadcasts, e1t1ChannelNr=e1t1ChannelNr, saf=saf, description=description, microwaveRadio=microwaveRadio, modemErroredSecondRatio=modemErroredSecondRatio, ethGFPDelineationErrors=ethGFPDelineationErrors, writeConfig=writeConfig, vlanTable=vlanTable, aTPCEntry=aTPCEntry, ethRXPrevPktDropped=ethRXPrevPktDropped, modemGeneralStatus=modemGeneralStatus, vlanRowStatus=vlanRowStatus, ethRXTruncatedFrames=ethRXTruncatedFrames, vlanPortType=vlanPortType, ethRXDvEvent=ethRXDvEvent, ethRXDones=ethRXDones, restartcpu=restartcpu, modemErroredSecond=modemErroredSecond, modemRowStatus=modemRowStatus, ethQOSRXQ1Frames=ethQOSRXQ1Frames, loopbacks=loopbacks, ethGFPCHECErrors=ethGFPCHECErrors, modemAcqStatus=modemAcqStatus, radioEntry=radioEntry, ethRXUnsupOpcodes=ethRXUnsupOpcodes, safip=safip, product=product, modemModulation=modemModulation, modemE1T1Channels=modemE1T1Channels, ethRXControlFrames=ethRXControlFrames, radioTable=radioTable, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXControlFrames=ethTXControlFrames, ipRadioCfgGeneral=ipRadioCfgGeneral, licenseUpdateStatus=licenseUpdateStatus, modemLastAcqError=modemLastAcqError, ethRXCRCErrors=ethRXCRCErrors, ethRXCodeErrors=ethRXCodeErrors, modemTotalCapacity=modemTotalCapacity, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemTable=modemTable, sysDateAndTime=sysDateAndTime, hostname=hostname, ethTXWireByteCounterLow=ethTXWireByteCounterLow, atpcIndex=atpcIndex, radioSide=radioSide, radioLoopback=radioLoopback, atpcEnabled=atpcEnabled, modemCarrierOffset=modemCarrierOffset, ethTXPauseFrames=ethTXPauseFrames, ethTXMaxCollisions=ethTXMaxCollisions, radioRxFrequency=radioRxFrequency, modemBandwith=modemBandwith, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ipRadioStat=ipRadioStat, modemSymbolRateTx=modemSymbolRateTx, radioDuplexShift=radioDuplexShift, vlanFid=vlanFid, ethRXPauseFrames=ethRXPauseFrames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ipRadio=ipRadio, localIpMask=localIpMask, modemACMmodulationMin=modemACMmodulationMin, e1t1StatTable=e1t1StatTable, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioTxMute=radioTxMute, radioGenStatus=radioGenStatus, modemEntry=modemEntry, modemLDPCdecoderStress=modemLDPCdecoderStress, modemACMtotalCapacity=modemACMtotalCapacity, ethTXCollisions=ethTXCollisions, modemErroredBlock=modemErroredBlock, localIp=localIp, ethTXByteCounterHi=ethTXByteCounterHi, modemStatistics=modemStatistics, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemUptime=modemUptime, pointToPoint=pointToPoint, remoteIp=remoteIp, e1t1LOS=e1t1LOS, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXByteCounterLow=ethRXByteCounterLow, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioTxPower=radioTxPower, ipRadioMgmt=ipRadioMgmt, e1t1StatEntry=e1t1StatEntry)
