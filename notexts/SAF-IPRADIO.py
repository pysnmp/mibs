...
mibBuilder.exportSymbols("SAF-IPRADIO", hostname=hostname, ipRadioCfg=ipRadioCfg, radioDuplexShift=radioDuplexShift, modemLDPCdecoderStress=modemLDPCdecoderStress, modemIndex=modemIndex, ethRXCRCErrors=ethRXCRCErrors, modemCountTime=modemCountTime, remoteIp=remoteIp, modemStatistics=modemStatistics, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, e1t1StatEntry=e1t1StatEntry, ethGFPDropedFrames=ethGFPDropedFrames, aTPCTable=aTPCTable, vlanTable=vlanTable, ethRXByteCounterLow=ethRXByteCounterLow, ethTXBackpresEvents=ethTXBackpresEvents, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXControlFrames=ethTXControlFrames, ethTXMaxCollisions=ethTXMaxCollisions, ethRXTruncatedFrames=ethRXTruncatedFrames, modemE1T1ChannelMask=modemE1T1ChannelMask, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemGeneralStatus=modemGeneralStatus, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemEthernetCapacity=modemEthernetCapacity, ipRadioMgmt=ipRadioMgmt, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXPauseFrames=ethRXPauseFrames, saf=saf, restartcpu=restartcpu, description=description, ethRXMulticasts=ethRXMulticasts, modemCarrierOffset=modemCarrierOffset, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXGiants=ethTXGiants, ethRXCodeErrors=ethRXCodeErrors, ethTXDones=ethTXDones, ethQOSTXDropped=ethQOSTXDropped, radioSide=radioSide, loopback_tributary_mask=loopback_tributary_mask, ipRadioStat=ipRadioStat, e1t1AIS=e1t1AIS, ipRadioCfgNetwork=ipRadioCfgNetwork, radioTxPower=radioTxPower, vlansEnabled=vlansEnabled, ethTXPauseFrames=ethTXPauseFrames, ethQOSRXQ2Frames=ethQOSRXQ2Frames, localIpMask=localIpMask, modemACMmodulationMin=modemACMmodulationMin, ethTXBroadcasts=ethTXBroadcasts, radioRxFrequency=radioRxFrequency, safip=safip, e1t1StatTable=e1t1StatTable, ethTXLateCollisions=ethTXLateCollisions, ethRXDvEvent=ethRXDvEvent, modemAcqStatus=modemAcqStatus, modemRowStatus=modemRowStatus, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioTable=radioTable, vlanPortmap=vlanPortmap, ethTXCollisions=ethTXCollisions, ethRXDribleNibbles=ethRXDribleNibbles, modemTotalCapacity=modemTotalCapacity, vlanRowStatus=vlanRowStatus, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemACMmodulationMax=modemACMmodulationMax, sysDateAndTime=sysDateAndTime, vlanPortType=vlanPortType, ipRadioStatEth=ipRadioStatEth, modemEntry=modemEntry, atpcIndex=atpcIndex, modemRadialMSE=modemRadialMSE, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioGenStatus=radioGenStatus, licenseUpdateStatus=licenseUpdateStatus, modemErroredSecondRatio=modemErroredSecondRatio, modemBandwith=modemBandwith, modemACMengine=modemACMengine, e1t1LOS=e1t1LOS, microwaveRadio=microwaveRadio, modemSymbolRateTx=modemSymbolRateTx, vlanEntry=vlanEntry, ethTXVlanTags=ethTXVlanTags, modemUptime=modemUptime, modemE1T1Channels=modemE1T1Channels, modemStandard=modemStandard, modemTotalBlockNumber=modemTotalBlockNumber, ethTXByteCounterHi=ethTXByteCounterHi, ethRXControlFrames=ethRXControlFrames, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemLastAcqError=modemLastAcqError, loopbacks=loopbacks, localIp=localIp, tehnika=tehnika, vlanNumber=vlanNumber, ethTXUnderruns=ethTXUnderruns, ethTXByteCounterLow=ethTXByteCounterLow, licenseMask=licenseMask, aTPCEntry=aTPCEntry, modemModulation=modemModulation, product=product, ethGFPFCSErrors=ethGFPFCSErrors, ethTXCRCErrors=ethTXCRCErrors, radioLoopback=radioLoopback, modemInternalAGCgain=modemInternalAGCgain, modemErroredSecond=modemErroredSecond, radioRxLevel=radioRxLevel, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethQOSTXFrames=ethQOSTXFrames, sysTemperature=sysTemperature, modemUnavailtime=modemUnavailtime, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXMulticasts=ethTXMulticasts, ipRadio=ipRadio, ethRXDones=ethRXDones, modemSeverelyErroredSecond=modemSeverelyErroredSecond, e1t1ChannelNr=e1t1ChannelNr, radioIndex=radioIndex, ethRXBroadcasts=ethRXBroadcasts, radioTxFrequency=radioTxFrequency, atpcEnabled=atpcEnabled, license=license, radioEntry=radioEntry, vlanFid=vlanFid, radioTxMute=radioTxMute, modemErroredBlock=modemErroredBlock, ethRXByteCounterHi=ethRXByteCounterHi, vlanCfgStat=vlanCfgStat, writeConfig=writeConfig, modemSymbolRateRx=modemSymbolRateRx, modemACMethernetCapacity=modemACMethernetCapacity, ethGFPCHECErrors=ethGFPCHECErrors, ethRXLongEvents=ethRXLongEvents, modemTable=modemTable, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemACMtotalCapacity=modemACMtotalCapacity, pointToPoint=pointToPoint)
