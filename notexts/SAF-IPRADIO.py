...
mibBuilder.exportSymbols("SAF-IPRADIO", modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, vlanCfgStat=vlanCfgStat, e1t1StatEntry=e1t1StatEntry, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioEntry=radioEntry, ethRXDones=ethRXDones, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, sysTemperature=sysTemperature, radioRxLevel=radioRxLevel, radioRxFrequency=radioRxFrequency, modemStandard=modemStandard, modemACMmodulationMin=modemACMmodulationMin, ethRXDribleNibbles=ethRXDribleNibbles, pointToPoint=pointToPoint, modemRadialMSE=modemRadialMSE, tehnika=tehnika, ethQOSTXDropped=ethQOSTXDropped, licenseUpdateStatus=licenseUpdateStatus, licenseMask=licenseMask, ethRXBroadcasts=ethRXBroadcasts, atpcIndex=atpcIndex, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemIndex=modemIndex, ipRadioCfg=ipRadioCfg, localIp=localIp, ethTXBackpresEvents=ethTXBackpresEvents, modemErroredSecond=modemErroredSecond, radioLoopback=radioLoopback, modemModulation=modemModulation, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXControlFrames=ethRXControlFrames, loopbacks=loopbacks, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXCodeErrors=ethRXCodeErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemInternalAGCgain=modemInternalAGCgain, radioSide=radioSide, vlanTable=vlanTable, ipRadioCfgNetwork=ipRadioCfgNetwork, modemStatistics=modemStatistics, ipRadioStatEth=ipRadioStatEth, modemEntry=modemEntry, modemLastAcqError=modemLastAcqError, restartcpu=restartcpu, radioDuplexShift=radioDuplexShift, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXUnderruns=ethTXUnderruns, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlanEntry=vlanEntry, ethRXDvEvent=ethRXDvEvent, vlanRowStatus=vlanRowStatus, aTPCEntry=aTPCEntry, e1t1StatTable=e1t1StatTable, modemUnavailtime=modemUnavailtime, description=description, aTPCTable=aTPCTable, atpcEnabled=atpcEnabled, ethGFPDropedFrames=ethGFPDropedFrames, ipRadioCfgGeneral=ipRadioCfgGeneral, hostname=hostname, ethTXLateCollisions=ethTXLateCollisions, ethTXGiants=ethTXGiants, writeConfig=writeConfig, ethRXLongEvents=ethRXLongEvents, product=product, ethQOSTXFrames=ethQOSTXFrames, modemE1T1Channels=modemE1T1Channels, ethRXUnsupOpcodes=ethRXUnsupOpcodes, atpcTxPowerCorrection=atpcTxPowerCorrection, modemErroredBlock=modemErroredBlock, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, vlanPortmap=vlanPortmap, ethTXByteCounterHi=ethTXByteCounterHi, modemErroredSecondRatio=modemErroredSecondRatio, vlanNumber=vlanNumber, radioGenStatus=radioGenStatus, e1t1LOS=e1t1LOS, ipRadio=ipRadio, ipRadioStat=ipRadioStat, saf=saf, ethRXPauseFrames=ethRXPauseFrames, modemTotalBlockNumber=modemTotalBlockNumber, modemLDPCdecoderStress=modemLDPCdecoderStress, modemTable=modemTable, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethGFPCHECErrors=ethGFPCHECErrors, e1t1AIS=e1t1AIS, ethRXPrevPktDropped=ethRXPrevPktDropped, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXCRCErrors=ethRXCRCErrors, remoteIp=remoteIp, modemACMmodulationMax=modemACMmodulationMax, ethTXMulticasts=ethTXMulticasts, radioTxPower=radioTxPower, ethRXMulticasts=ethRXMulticasts, ethTXCRCErrors=ethTXCRCErrors, ethTXWireByteCounterHi=ethTXWireByteCounterHi, microwaveRadio=microwaveRadio, radioTxFrequency=radioTxFrequency, modemCountTime=modemCountTime, sysDateAndTime=sysDateAndTime, ethTXPauseFrames=ethTXPauseFrames, ethTXDones=ethTXDones, radioIndex=radioIndex, ipRadioMgmt=ipRadioMgmt, ethTXByteCounterLow=ethTXByteCounterLow, modemCarrierOffset=modemCarrierOffset, ethQOSRXQ2Frames=ethQOSRXQ2Frames, safip=safip, modemGeneralStatus=modemGeneralStatus, license=license, modemTotalCapacity=modemTotalCapacity, ethTXControlFrames=ethTXControlFrames, modemEthernetCapacity=modemEthernetCapacity, modemAcqStatus=modemAcqStatus, ethRXByteCounterLow=ethRXByteCounterLow, modemRowStatus=modemRowStatus, modemACMtotalCapacity=modemACMtotalCapacity, ethTXMaxCollisions=ethTXMaxCollisions, vlanPortType=vlanPortType, modemSymbolRateTx=modemSymbolRateTx, modemSymbolRateRx=modemSymbolRateRx, radioTxMute=radioTxMute, ethGFPFCSErrors=ethGFPFCSErrors, vlansEnabled=vlansEnabled, modemUptime=modemUptime, ethTXBroadcasts=ethTXBroadcasts, ethTXCollisions=ethTXCollisions, modemACMengine=modemACMengine, localIpMask=localIpMask, ethRXTruncatedFrames=ethRXTruncatedFrames, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXByteCounterHi=ethRXByteCounterHi, vlanFid=vlanFid, modemBandwith=modemBandwith, loopback_tributary_mask=loopback_tributary_mask, radioTable=radioTable, ethTXVlanTags=ethTXVlanTags, e1t1ChannelNr=e1t1ChannelNr, modemACMethernetCapacity=modemACMethernetCapacity)
