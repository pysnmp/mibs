...
mibBuilder.exportSymbols("SAF-IPRADIO", modemStandard=modemStandard, modemCarrierOffset=modemCarrierOffset, vlanEntry=vlanEntry, safip=safip, aTPCEntry=aTPCEntry, modemModulation=modemModulation, ethRXUnsupOpcodes=ethRXUnsupOpcodes, vlanPortmap=vlanPortmap, radioRxLevel=radioRxLevel, loopback_tributary_mask=loopback_tributary_mask, modemE1T1ChannelMask=modemE1T1ChannelMask, modemErroredSecond=modemErroredSecond, ethTXByteCounterHi=ethTXByteCounterHi, radioSide=radioSide, modemGeneralStatus=modemGeneralStatus, modemE1T1Channels=modemE1T1Channels, vlanPortType=vlanPortType, modemIndex=modemIndex, modemTotalCapacity=modemTotalCapacity, e1t1LOS=e1t1LOS, radioTxFrequency=radioTxFrequency, e1t1StatEntry=e1t1StatEntry, ethTXLateCollisions=ethTXLateCollisions, ipRadioCfgNetwork=ipRadioCfgNetwork, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemAcqStatus=modemAcqStatus, ethRXBroadcasts=ethRXBroadcasts, vlanRowStatus=vlanRowStatus, ethRXControlFrames=ethRXControlFrames, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, saf=saf, vlanTable=vlanTable, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemInternalAGCgain=modemInternalAGCgain, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXDribleNibbles=ethRXDribleNibbles, e1t1AIS=e1t1AIS, ethTXUnderruns=ethTXUnderruns, ethTXPauseFrames=ethTXPauseFrames, radioRxFrequency=radioRxFrequency, license=license, radioGenStatus=radioGenStatus, atpcEnabled=atpcEnabled, description=description, ethTXMaxCollisions=ethTXMaxCollisions, ethTXCRCErrors=ethTXCRCErrors, ethTXDones=ethTXDones, modemLastAcqError=modemLastAcqError, modemRadialMSE=modemRadialMSE, ipRadioStatEth=ipRadioStatEth, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXVlanTags=ethTXVlanTags, modemCountTime=modemCountTime, ethGFPDelineationErrors=ethGFPDelineationErrors, modemErroredBlock=modemErroredBlock, ethTXBackpresEvents=ethTXBackpresEvents, ethTXControlFrames=ethTXControlFrames, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXByteCounterLow=ethTXByteCounterLow, pointToPoint=pointToPoint, ethTXLengthCheckErrors=ethTXLengthCheckErrors, microwaveRadio=microwaveRadio, ethRXLongEvents=ethRXLongEvents, modemEntry=modemEntry, sysTemperature=sysTemperature, modemUnavailtime=modemUnavailtime, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXDones=ethRXDones, ipRadioCfg=ipRadioCfg, ethRXPrevPktDropped=ethRXPrevPktDropped, aTPCTable=aTPCTable, modemACMmodulationMax=modemACMmodulationMax, ethRXTruncatedFrames=ethRXTruncatedFrames, ethGFPFCSErrors=ethGFPFCSErrors, radioTxPower=radioTxPower, licenseMask=licenseMask, remoteIp=remoteIp, modemACMethernetCapacity=modemACMethernetCapacity, ethGFPDropedFrames=ethGFPDropedFrames, modemRowStatus=modemRowStatus, ethTXExcessiveDefers=ethTXExcessiveDefers, localIpMask=localIpMask, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXBroadcasts=ethTXBroadcasts, ethRXCRCErrors=ethRXCRCErrors, radioLoopback=radioLoopback, modemBandwith=modemBandwith, licenseUpdateStatus=licenseUpdateStatus, radioIndex=radioIndex, modemACMmodulationMin=modemACMmodulationMin, e1t1StatTable=e1t1StatTable, hostname=hostname, radioDuplexShift=radioDuplexShift, modemErroredSecondRatio=modemErroredSecondRatio, restartcpu=restartcpu, vlansEnabled=vlansEnabled, vlanCfgStat=vlanCfgStat, modemACMtotalCapacity=modemACMtotalCapacity, modemACMengine=modemACMengine, ipRadioMgmt=ipRadioMgmt, ethRXByteCounterHi=ethRXByteCounterHi, ethGFPCHECErrors=ethGFPCHECErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioTxMute=radioTxMute, writeConfig=writeConfig, ethQOSTXFrames=ethQOSTXFrames, ipRadio=ipRadio, ethRXPauseFrames=ethRXPauseFrames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXCollisions=ethTXCollisions, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXMulticasts=ethTXMulticasts, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXMulticasts=ethRXMulticasts, modemUptime=modemUptime, e1t1ChannelNr=e1t1ChannelNr, vlanFid=vlanFid, atpcTxPowerCorrection=atpcTxPowerCorrection, product=product, modemSymbolRateTx=modemSymbolRateTx, vlanNumber=vlanNumber, ethRXCodeErrors=ethRXCodeErrors, localIp=localIp, ethTXGiants=ethTXGiants, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemTable=modemTable, sysDateAndTime=sysDateAndTime, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemEthernetCapacity=modemEthernetCapacity, modemStatistics=modemStatistics, radioEntry=radioEntry, radioTable=radioTable, loopbacks=loopbacks, atpcIndex=atpcIndex, modemSymbolRateRx=modemSymbolRateRx, modemLDPCdecoderStress=modemLDPCdecoderStress, ipRadioStat=ipRadioStat, ethRXDvEvent=ethRXDvEvent, ethTXWireByteCounterHi=ethTXWireByteCounterHi, tehnika=tehnika, modemTotalBlockNumber=modemTotalBlockNumber, ethRXByteCounterLow=ethRXByteCounterLow, ethQOSTXDropped=ethQOSTXDropped)
