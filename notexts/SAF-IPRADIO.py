...
mibBuilder.exportSymbols("SAF-IPRADIO", modemIndex=modemIndex, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemE1T1ChannelMask=modemE1T1ChannelMask, sysTemperature=sysTemperature, ethTXUnderruns=ethTXUnderruns, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXCRCErrors=ethTXCRCErrors, ethTXByteCounterHi=ethTXByteCounterHi, ipRadioCfgGeneral=ipRadioCfgGeneral, modemErroredSecondRatio=modemErroredSecondRatio, ipRadio=ipRadio, radioTable=radioTable, saf=saf, ethTXPauseFrames=ethTXPauseFrames, ethRXMulticasts=ethRXMulticasts, remoteIp=remoteIp, modemTotalCapacity=modemTotalCapacity, e1t1StatEntry=e1t1StatEntry, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioGenStatus=radioGenStatus, radioRxLevel=radioRxLevel, ethRXByteCounterLow=ethRXByteCounterLow, modemLDPCdecoderStress=modemLDPCdecoderStress, restartcpu=restartcpu, ethQOSTXFrames=ethQOSTXFrames, loopbacks=loopbacks, atpcIndex=atpcIndex, ethTXWireByteCounterLow=ethTXWireByteCounterLow, localIpMask=localIpMask, vlansEnabled=vlansEnabled, safip=safip, modemEntry=modemEntry, ipRadioCfg=ipRadioCfg, sysDateAndTime=sysDateAndTime, product=product, ethTXVlanTags=ethTXVlanTags, modemLastAcqError=modemLastAcqError, radioDuplexShift=radioDuplexShift, radioSide=radioSide, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemRadialMSE=modemRadialMSE, radioEntry=radioEntry, modemStandard=modemStandard, e1t1LOS=e1t1LOS, aTPCTable=aTPCTable, vlanPortType=vlanPortType, modemUptime=modemUptime, modemBandwith=modemBandwith, e1t1AIS=e1t1AIS, vlanRowStatus=vlanRowStatus, modemAcqStatus=modemAcqStatus, ethGFPDropedFrames=ethGFPDropedFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXDones=ethRXDones, ethTXBackpresEvents=ethTXBackpresEvents, atpcTxPowerCorrection=atpcTxPowerCorrection, radioTxFrequency=radioTxFrequency, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, vlanCfgStat=vlanCfgStat, modemGeneralStatus=modemGeneralStatus, description=description, ethTXCollisions=ethTXCollisions, ethTXLateCollisions=ethTXLateCollisions, ethGFPFCSErrors=ethGFPFCSErrors, licenseMask=licenseMask, modemStatistics=modemStatistics, pointToPoint=pointToPoint, ethRXPauseFrames=ethRXPauseFrames, ethRXPrevPktDropped=ethRXPrevPktDropped, modemRowStatus=modemRowStatus, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, tehnika=tehnika, modemCountTime=modemCountTime, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ipRadioStat=ipRadioStat, modemACMengine=modemACMengine, e1t1ChannelNr=e1t1ChannelNr, modemTotalBlockNumber=modemTotalBlockNumber, ethQOSRXQ2Frames=ethQOSRXQ2Frames, atpcEnabled=atpcEnabled, ethRXControlFrames=ethRXControlFrames, ethRXCRCErrors=ethRXCRCErrors, modemSymbolRateTx=modemSymbolRateTx, ethTXGiants=ethTXGiants, ethQOSTXDropped=ethQOSTXDropped, ipRadioStatEth=ipRadioStatEth, ethRXBroadcasts=ethRXBroadcasts, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXDribleNibbles=ethRXDribleNibbles, vlanPortmap=vlanPortmap, modemTable=modemTable, ethRXDvEvent=ethRXDvEvent, ethTXBroadcasts=ethTXBroadcasts, vlanTable=vlanTable, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlanEntry=vlanEntry, modemACMtotalCapacity=modemACMtotalCapacity, modemModulation=modemModulation, ethRXByteCounterHi=ethRXByteCounterHi, ipRadioCfgNetwork=ipRadioCfgNetwork, modemEthernetCapacity=modemEthernetCapacity, modemInternalAGCgain=modemInternalAGCgain, aTPCEntry=aTPCEntry, ethTXLengthCheckErrors=ethTXLengthCheckErrors, radioRxFrequency=radioRxFrequency, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXMulticasts=ethTXMulticasts, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, loopback_tributary_mask=loopback_tributary_mask, radioLoopback=radioLoopback, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, localIp=localIp, modemE1T1Channels=modemE1T1Channels, radioTxMute=radioTxMute, vlanFid=vlanFid, modemErroredSecond=modemErroredSecond, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXDones=ethTXDones, modemErroredBlock=modemErroredBlock, e1t1StatTable=e1t1StatTable, microwaveRadio=microwaveRadio, ethRXCodeErrors=ethRXCodeErrors, ethTXMaxCollisions=ethTXMaxCollisions, radioIndex=radioIndex, license=license, writeConfig=writeConfig, ethGFPCHECErrors=ethGFPCHECErrors, modemACMethernetCapacity=modemACMethernetCapacity, licenseUpdateStatus=licenseUpdateStatus, modemACMmodulationMax=modemACMmodulationMax, ethTXControlFrames=ethTXControlFrames, hostname=hostname, modemCarrierOffset=modemCarrierOffset, ipRadioMgmt=ipRadioMgmt, modemSymbolRateRx=modemSymbolRateRx, modemACMmodulationMin=modemACMmodulationMin, ethTXByteCounterLow=ethTXByteCounterLow, modemUnavailtime=modemUnavailtime, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXLongEvents=ethRXLongEvents, ethRXUnsupOpcodes=ethRXUnsupOpcodes, vlanNumber=vlanNumber, radioTxPower=radioTxPower)
