...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXGiants=ethTXGiants, ethQOSTXFrames=ethQOSTXFrames, ipRadio=ipRadio, modemRowStatus=modemRowStatus, license=license, restartcpu=restartcpu, ethGFPCHECErrors=ethGFPCHECErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXBroadcasts=ethTXBroadcasts, modemSymbolRateTx=modemSymbolRateTx, remoteIp=remoteIp, vlanCfgStat=vlanCfgStat, modemLDPCdecoderStress=modemLDPCdecoderStress, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXExcessiveDefers=ethTXExcessiveDefers, ethGFPFCSErrors=ethGFPFCSErrors, radioTxPower=radioTxPower, ethGFPDropedFrames=ethGFPDropedFrames, loopbacks=loopbacks, modemLastAcqError=modemLastAcqError, vlanNumber=vlanNumber, modemStatistics=modemStatistics, modemModulation=modemModulation, ipRadioStatEth=ipRadioStatEth, modemIndex=modemIndex, ethRXByteCounterLow=ethRXByteCounterLow, ethTXCollisions=ethTXCollisions, e1t1StatTable=e1t1StatTable, modemErroredSecondRatio=modemErroredSecondRatio, hostname=hostname, modemACMmodulationMin=modemACMmodulationMin, ethTXLateCollisions=ethTXLateCollisions, modemEntry=modemEntry, modemTable=modemTable, microwaveRadio=microwaveRadio, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXByteCounterHi=ethRXByteCounterHi, ethQOSRXQ1Frames=ethQOSRXQ1Frames, aTPCEntry=aTPCEntry, modemUptime=modemUptime, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXByteCounterLow=ethTXByteCounterLow, pointToPoint=pointToPoint, ethRXPauseFrames=ethRXPauseFrames, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXDones=ethTXDones, modemCarrierOffset=modemCarrierOffset, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, localIpMask=localIpMask, modemACMethernetCapacity=modemACMethernetCapacity, ethQOSTXDropped=ethQOSTXDropped, vlanFid=vlanFid, modemInternalAGCgain=modemInternalAGCgain, modemACMengine=modemACMengine, ethTXControlFrames=ethTXControlFrames, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemErroredSecond=modemErroredSecond, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXPauseFrames=ethTXPauseFrames, e1t1StatEntry=e1t1StatEntry, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemUnavailtime=modemUnavailtime, modemCountTime=modemCountTime, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemGeneralStatus=modemGeneralStatus, ipRadioStat=ipRadioStat, licenseUpdateStatus=licenseUpdateStatus, radioLoopback=radioLoopback, modemBandwith=modemBandwith, ethRXDones=ethRXDones, ethRXDribleNibbles=ethRXDribleNibbles, radioEntry=radioEntry, ethTXMaxCollisions=ethTXMaxCollisions, ethRXDvEvent=ethRXDvEvent, ethRXTruncatedFrames=ethRXTruncatedFrames, ipRadioCfgGeneral=ipRadioCfgGeneral, modemACMtotalCapacity=modemACMtotalCapacity, modemErroredBlock=modemErroredBlock, radioTxFrequency=radioTxFrequency, modemAcqStatus=modemAcqStatus, radioIndex=radioIndex, ethRXCRCErrors=ethRXCRCErrors, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, product=product, radioSide=radioSide, vlanPortmap=vlanPortmap, ethTXVlanTags=ethTXVlanTags, radioDuplexShift=radioDuplexShift, ethTXMulticasts=ethTXMulticasts, vlanTable=vlanTable, atpcTxPowerCorrection=atpcTxPowerCorrection, vlanEntry=vlanEntry, ipRadioCfg=ipRadioCfg, modemEthernetCapacity=modemEthernetCapacity, modemRadialMSE=modemRadialMSE, sysTemperature=sysTemperature, ethRXMulticasts=ethRXMulticasts, ethRXCodeErrors=ethRXCodeErrors, e1t1AIS=e1t1AIS, modemE1T1ChannelMask=modemE1T1ChannelMask, radioTxMute=radioTxMute, ethTXCRCErrors=ethTXCRCErrors, writeConfig=writeConfig, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioRxFrequency=radioRxFrequency, ethTXUnderruns=ethTXUnderruns, ipRadioCfgNetwork=ipRadioCfgNetwork, modemSymbolRateRx=modemSymbolRateRx, sysDateAndTime=sysDateAndTime, modemACMmodulationMax=modemACMmodulationMax, aTPCTable=aTPCTable, modemStandard=modemStandard, ipRadioMgmt=ipRadioMgmt, modemE1T1Channels=modemE1T1Channels, vlanPortType=vlanPortType, ethRXControlFrames=ethRXControlFrames, ethRXBroadcasts=ethRXBroadcasts, ethTXBackpresEvents=ethTXBackpresEvents, ethTXByteCounterHi=ethTXByteCounterHi, modemTotalBlockNumber=modemTotalBlockNumber, localIp=localIp, vlansEnabled=vlansEnabled, radioGenStatus=radioGenStatus, radioTable=radioTable, e1t1ChannelNr=e1t1ChannelNr, ethRXLongEvents=ethRXLongEvents, licenseMask=licenseMask, description=description, vlanRowStatus=vlanRowStatus, ethTXWireByteCounterLow=ethTXWireByteCounterLow, loopback_tributary_mask=loopback_tributary_mask, e1t1LOS=e1t1LOS, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, saf=saf, safip=safip, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXLengthCheckErrors=ethTXLengthCheckErrors, radioRxLevel=radioRxLevel, atpcIndex=atpcIndex, atpcEnabled=atpcEnabled, tehnika=tehnika, modemTotalCapacity=modemTotalCapacity)
