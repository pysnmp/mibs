...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXBroadcasts=ethRXBroadcasts, e1t1StatTable=e1t1StatTable, ethRXCodeErrors=ethRXCodeErrors, ethTXUnderruns=ethTXUnderruns, ethGFPCHECErrors=ethGFPCHECErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioDuplexShift=radioDuplexShift, hostname=hostname, modemACMmodulationMin=modemACMmodulationMin, modemTable=modemTable, e1t1AIS=e1t1AIS, radioSide=radioSide, ethTXLateCollisions=ethTXLateCollisions, ipRadioCfg=ipRadioCfg, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXPrevPktDropped=ethRXPrevPktDropped, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, vlanNumber=vlanNumber, radioTxMute=radioTxMute, vlanFid=vlanFid, ethRXTruncatedFrames=ethRXTruncatedFrames, aTPCTable=aTPCTable, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemStandard=modemStandard, sysDateAndTime=sysDateAndTime, ethRXByteCounterHi=ethRXByteCounterHi, modemACMmodulationMax=modemACMmodulationMax, vlanEntry=vlanEntry, ethRXByteCounterLow=ethRXByteCounterLow, modemErroredSecondRatio=modemErroredSecondRatio, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioGenStatus=radioGenStatus, modemBandwith=modemBandwith, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemACMethernetCapacity=modemACMethernetCapacity, modemInternalAGCgain=modemInternalAGCgain, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXBroadcasts=ethTXBroadcasts, remoteIp=remoteIp, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXControlFrames=ethTXControlFrames, ethRXDribleNibbles=ethRXDribleNibbles, vlanRowStatus=vlanRowStatus, ipRadioStatEth=ipRadioStatEth, description=description, writeConfig=writeConfig, license=license, ethRXDones=ethRXDones, e1t1LOS=e1t1LOS, ethRXControlFrames=ethRXControlFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, radioTable=radioTable, safip=safip, modemTotalCapacity=modemTotalCapacity, modemEthernetCapacity=modemEthernetCapacity, ethGFPDropedFrames=ethGFPDropedFrames, modemGeneralStatus=modemGeneralStatus, ethTXVlanTags=ethTXVlanTags, vlansEnabled=vlansEnabled, ethGFPFCSErrors=ethGFPFCSErrors, atpcIndex=atpcIndex, ethRXPauseFrames=ethRXPauseFrames, ipRadioMgmt=ipRadioMgmt, modemErroredSecond=modemErroredSecond, ethTXBackpresEvents=ethTXBackpresEvents, ethRXCRCErrors=ethRXCRCErrors, modemRowStatus=modemRowStatus, loopbacks=loopbacks, ethTXCollisions=ethTXCollisions, aTPCEntry=aTPCEntry, loopback_tributary_mask=loopback_tributary_mask, modemCountTime=modemCountTime, modemStatistics=modemStatistics, atpcEnabled=atpcEnabled, ethTXMulticasts=ethTXMulticasts, modemModulation=modemModulation, ipRadio=ipRadio, radioTxFrequency=radioTxFrequency, ethQOSTXFrames=ethQOSTXFrames, ipRadioCfgNetwork=ipRadioCfgNetwork, microwaveRadio=microwaveRadio, sysTemperature=sysTemperature, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemCarrierOffset=modemCarrierOffset, tehnika=tehnika, radioIndex=radioIndex, ipRadioStat=ipRadioStat, vlanPortType=vlanPortType, ethTXPauseFrames=ethTXPauseFrames, modemLDPCdecoderStress=modemLDPCdecoderStress, licenseMask=licenseMask, restartcpu=restartcpu, pointToPoint=pointToPoint, modemUptime=modemUptime, ethRXLongEvents=ethRXLongEvents, modemE1T1Channels=modemE1T1Channels, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemEntry=modemEntry, ethRXDvEvent=ethRXDvEvent, saf=saf, vlanCfgStat=vlanCfgStat, modemRadialMSE=modemRadialMSE, ethTXMaxCollisions=ethTXMaxCollisions, ethTXByteCounterLow=ethTXByteCounterLow, e1t1ChannelNr=e1t1ChannelNr, ethRXMulticasts=ethRXMulticasts, modemLastAcqError=modemLastAcqError, modemTotalBlockNumber=modemTotalBlockNumber, modemACMtotalCapacity=modemACMtotalCapacity, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXGiants=ethTXGiants, modemACMengine=modemACMengine, ethTXByteCounterHi=ethTXByteCounterHi, vlanPortmap=vlanPortmap, atpcTxPowerCorrection=atpcTxPowerCorrection, radioEntry=radioEntry, localIp=localIp, modemIndex=modemIndex, modemErroredBlock=modemErroredBlock, ethTXCRCErrors=ethTXCRCErrors, product=product, modemSymbolRateTx=modemSymbolRateTx, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlanTable=vlanTable, ethTXLengthCheckErrors=ethTXLengthCheckErrors, radioTxPower=radioTxPower, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioRxFrequency=radioRxFrequency, radioLoopback=radioLoopback, modemSymbolRateRx=modemSymbolRateRx, ethQOSTXDropped=ethQOSTXDropped, modemAcqStatus=modemAcqStatus, localIpMask=localIpMask, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemUnavailtime=modemUnavailtime, licenseUpdateStatus=licenseUpdateStatus, ethTXDones=ethTXDones, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioRxLevel=radioRxLevel, e1t1StatEntry=e1t1StatEntry, ethTXExcessiveDefers=ethTXExcessiveDefers)
