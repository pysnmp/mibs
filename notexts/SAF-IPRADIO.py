...
mibBuilder.exportSymbols("SAF-IPRADIO", description=description, radioTxPower=radioTxPower, ethRXCodeErrors=ethRXCodeErrors, ethTXControlFrames=ethTXControlFrames, e1t1LOS=e1t1LOS, modemErroredSecondRatio=modemErroredSecondRatio, remoteIp=remoteIp, aTPCEntry=aTPCEntry, ipRadio=ipRadio, ethTXBroadcasts=ethTXBroadcasts, modemModulation=modemModulation, ethTXDones=ethTXDones, radioDuplexShift=radioDuplexShift, modemCarrierOffset=modemCarrierOffset, sysDateAndTime=sysDateAndTime, ethGFPFCSErrors=ethGFPFCSErrors, modemACMtotalCapacity=modemACMtotalCapacity, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXBroadcasts=ethRXBroadcasts, ethQOSTXFrames=ethQOSTXFrames, modemAcqStatus=modemAcqStatus, loopback_tributary_mask=loopback_tributary_mask, modemErroredBlock=modemErroredBlock, modemACMmodulationMax=modemACMmodulationMax, ethTXExcessiveDefers=ethTXExcessiveDefers, restartcpu=restartcpu, ethTXBackpresEvents=ethTXBackpresEvents, atpcTxPowerCorrection=atpcTxPowerCorrection, modemEntry=modemEntry, ethTXCRCErrors=ethTXCRCErrors, ipRadioStatEth=ipRadioStatEth, vlanEntry=vlanEntry, licenseUpdateStatus=licenseUpdateStatus, ethRXLongEvents=ethRXLongEvents, safip=safip, writeConfig=writeConfig, modemEthernetCapacity=modemEthernetCapacity, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethGFPDropedFrames=ethGFPDropedFrames, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ipRadioCfg=ipRadioCfg, modemBandwith=modemBandwith, ethTXByteCounterLow=ethTXByteCounterLow, ethTXGiants=ethTXGiants, localIp=localIp, ethRXUnsupOpcodes=ethRXUnsupOpcodes, vlanCfgStat=vlanCfgStat, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, e1t1StatEntry=e1t1StatEntry, ipRadioStat=ipRadioStat, atpcEnabled=atpcEnabled, modemTable=modemTable, ethRXDones=ethRXDones, ethRXByteCounterHi=ethRXByteCounterHi, ethTXCollisions=ethTXCollisions, ethRXMulticasts=ethRXMulticasts, ethTXMaxCollisions=ethTXMaxCollisions, modemErroredSecond=modemErroredSecond, product=product, radioRxFrequency=radioRxFrequency, ethTXPauseFrames=ethTXPauseFrames, ethRXTruncatedFrames=ethRXTruncatedFrames, modemSymbolRateTx=modemSymbolRateTx, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioTxFrequency=radioTxFrequency, tehnika=tehnika, ethTXLateCollisions=ethTXLateCollisions, ipRadioMgmt=ipRadioMgmt, modemUnavailtime=modemUnavailtime, e1t1ChannelNr=e1t1ChannelNr, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlanNumber=vlanNumber, licenseMask=licenseMask, atpcIndex=atpcIndex, modemUptime=modemUptime, saf=saf, ethTXByteCounterHi=ethTXByteCounterHi, ethRXPrevPktDropped=ethRXPrevPktDropped, hostname=hostname, ethRXCRCErrors=ethRXCRCErrors, vlanFid=vlanFid, localIpMask=localIpMask, modemE1T1Channels=modemE1T1Channels, radioSide=radioSide, modemGeneralStatus=modemGeneralStatus, ethTXMulticasts=ethTXMulticasts, ethTXVlanTags=ethTXVlanTags, radioGenStatus=radioGenStatus, ethRXDvEvent=ethRXDvEvent, aTPCTable=aTPCTable, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemACMethernetCapacity=modemACMethernetCapacity, sysTemperature=sysTemperature, ethGFPCHECErrors=ethGFPCHECErrors, e1t1StatTable=e1t1StatTable, e1t1AIS=e1t1AIS, ethQOSTXDropped=ethQOSTXDropped, modemRowStatus=modemRowStatus, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemTotalCapacity=modemTotalCapacity, modemStatistics=modemStatistics, ethGFPDelineationErrors=ethGFPDelineationErrors, license=license, microwaveRadio=microwaveRadio, ethRXControlFrames=ethRXControlFrames, pointToPoint=pointToPoint, radioEntry=radioEntry, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXDribleNibbles=ethRXDribleNibbles, modemE1T1ChannelMask=modemE1T1ChannelMask, modemACMengine=modemACMengine, ethRXByteCounterLow=ethRXByteCounterLow, radioTable=radioTable, ethTXUnderruns=ethTXUnderruns, modemSymbolRateRx=modemSymbolRateRx, modemCountTime=modemCountTime, modemIndex=modemIndex, modemStandard=modemStandard, ipRadioCfgNetwork=ipRadioCfgNetwork, modemACMmodulationMin=modemACMmodulationMin, vlanTable=vlanTable, vlansEnabled=vlansEnabled, modemInternalAGCgain=modemInternalAGCgain, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, vlanPortType=vlanPortType, modemLastAcqError=modemLastAcqError, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXPauseFrames=ethRXPauseFrames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioRxLevel=radioRxLevel, vlanRowStatus=vlanRowStatus, modemRadialMSE=modemRadialMSE, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlanPortmap=vlanPortmap, modemTotalBlockNumber=modemTotalBlockNumber, radioTxMute=radioTxMute, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioLoopback=radioLoopback, radioIndex=radioIndex, loopbacks=loopbacks, modemBackgroundBlockErrror=modemBackgroundBlockErrror)
