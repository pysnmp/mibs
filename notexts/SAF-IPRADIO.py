...
mibBuilder.exportSymbols("SAF-IPRADIO", restartcpu=restartcpu, radioSide=radioSide, modemErroredSecondRatio=modemErroredSecondRatio, modemLastAcqError=modemLastAcqError, vlanRowStatus=vlanRowStatus, safip=safip, aTPCEntry=aTPCEntry, vlansEnabled=vlansEnabled, localIpMask=localIpMask, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemRadialMSE=modemRadialMSE, modemUnavailtime=modemUnavailtime, ethTXByteCounterHi=ethTXByteCounterHi, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemModulation=modemModulation, saf=saf, e1t1AIS=e1t1AIS, modemRowStatus=modemRowStatus, ethGFPCHECErrors=ethGFPCHECErrors, ethTXWireByteCounterHi=ethTXWireByteCounterHi, license=license, ethTXMulticasts=ethTXMulticasts, ethRXPauseFrames=ethRXPauseFrames, modemErroredBlock=modemErroredBlock, radioDuplexShift=radioDuplexShift, e1t1ChannelNr=e1t1ChannelNr, ethTXBackpresEvents=ethTXBackpresEvents, ipRadioCfg=ipRadioCfg, vlanFid=vlanFid, ethTXLateCollisions=ethTXLateCollisions, radioGenStatus=radioGenStatus, sysTemperature=sysTemperature, ethRXBroadcasts=ethRXBroadcasts, modemIndex=modemIndex, modemACMmodulationMax=modemACMmodulationMax, localIp=localIp, ethTXControlFrames=ethTXControlFrames, vlanPortmap=vlanPortmap, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethGFPDelineationErrors=ethGFPDelineationErrors, sysDateAndTime=sysDateAndTime, loopback_tributary_mask=loopback_tributary_mask, radioRxFrequency=radioRxFrequency, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXDones=ethRXDones, ipRadioCfgGeneral=ipRadioCfgGeneral, modemACMengine=modemACMengine, atpcTxPowerCorrection=atpcTxPowerCorrection, modemSymbolRateTx=modemSymbolRateTx, modemSymbolRateRx=modemSymbolRateRx, ethQOSRXQ2Frames=ethQOSRXQ2Frames, e1t1StatEntry=e1t1StatEntry, modemEntry=modemEntry, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ipRadioStat=ipRadioStat, modemInternalAGCgain=modemInternalAGCgain, modemCountTime=modemCountTime, ethTXByteCounterLow=ethTXByteCounterLow, radioEntry=radioEntry, ethTXVlanTags=ethTXVlanTags, radioTable=radioTable, ethRXByteCounterHi=ethRXByteCounterHi, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethGFPDropedFrames=ethGFPDropedFrames, description=description, ethRXCRCErrors=ethRXCRCErrors, writeConfig=writeConfig, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlanTable=vlanTable, radioTxPower=radioTxPower, atpcIndex=atpcIndex, modemAcqStatus=modemAcqStatus, modemStatistics=modemStatistics, vlanNumber=vlanNumber, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXCodeErrors=ethRXCodeErrors, radioLoopback=radioLoopback, modemTotalBlockNumber=modemTotalBlockNumber, ethTXGiants=ethTXGiants, modemE1T1ChannelMask=modemE1T1ChannelMask, ethQOSTXFrames=ethQOSTXFrames, ethQOSRXQ1Frames=ethQOSRXQ1Frames, loopbacks=loopbacks, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemTable=modemTable, microwaveRadio=microwaveRadio, modemTotalCapacity=modemTotalCapacity, radioTxFrequency=radioTxFrequency, product=product, hostname=hostname, ethRXDribleNibbles=ethRXDribleNibbles, modemStandard=modemStandard, ethTXDones=ethTXDones, remoteIp=remoteIp, radioRxLevel=radioRxLevel, modemBandwith=modemBandwith, modemGeneralStatus=modemGeneralStatus, modemLDPCdecoderStress=modemLDPCdecoderStress, licenseUpdateStatus=licenseUpdateStatus, ipRadioMgmt=ipRadioMgmt, ethTXMaxCollisions=ethTXMaxCollisions, ethTXPauseFrames=ethTXPauseFrames, ethRXMulticasts=ethRXMulticasts, radioIndex=radioIndex, modemEthernetCapacity=modemEthernetCapacity, aTPCTable=aTPCTable, ethRXLongEvents=ethRXLongEvents, ethTXBroadcasts=ethTXBroadcasts, atpcEnabled=atpcEnabled, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXCRCErrors=ethTXCRCErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemACMethernetCapacity=modemACMethernetCapacity, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemErroredSecond=modemErroredSecond, vlanPortType=vlanPortType, e1t1LOS=e1t1LOS, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXDvEvent=ethRXDvEvent, ethTXLengthCheckErrors=ethTXLengthCheckErrors, vlanEntry=vlanEntry, ipRadio=ipRadio, modemUptime=modemUptime, licenseMask=licenseMask, tehnika=tehnika, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXCollisions=ethTXCollisions, e1t1StatTable=e1t1StatTable, modemE1T1Channels=modemE1T1Channels, pointToPoint=pointToPoint, radioTxMute=radioTxMute, ethTXUnderruns=ethTXUnderruns, modemACMmodulationMin=modemACMmodulationMin, modemACMtotalCapacity=modemACMtotalCapacity, ethQOSTXDropped=ethQOSTXDropped, modemCarrierOffset=modemCarrierOffset, ethRXByteCounterLow=ethRXByteCounterLow, ethRXTruncatedFrames=ethRXTruncatedFrames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ipRadioStatEth=ipRadioStatEth, ethGFPFCSErrors=ethGFPFCSErrors, vlanCfgStat=vlanCfgStat, ethRXControlFrames=ethRXControlFrames)
