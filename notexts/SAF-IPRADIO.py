...
mibBuilder.exportSymbols("SAF-IPRADIO", radioIndex=radioIndex, modemSymbolRateRx=modemSymbolRateRx, modemInternalAGCgain=modemInternalAGCgain, description=description, modemStandard=modemStandard, vlansEnabled=vlansEnabled, modemRadialMSE=modemRadialMSE, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXCRCErrors=ethRXCRCErrors, modemLastAcqError=modemLastAcqError, aTPCTable=aTPCTable, ethTXCRCErrors=ethTXCRCErrors, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, e1t1StatTable=e1t1StatTable, e1t1LOS=e1t1LOS, radioEntry=radioEntry, ethRXCodeErrors=ethRXCodeErrors, restartcpu=restartcpu, radioTxMute=radioTxMute, ethRXDones=ethRXDones, radioTable=radioTable, modemE1T1Channels=modemE1T1Channels, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXDones=ethTXDones, ipRadioCfgNetwork=ipRadioCfgNetwork, modemModulation=modemModulation, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXLateCollisions=ethTXLateCollisions, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, sysTemperature=sysTemperature, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioSide=radioSide, modemCarrierOffset=modemCarrierOffset, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethQOSRXQ2Frames=ethQOSRXQ2Frames, e1t1StatEntry=e1t1StatEntry, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, sysDateAndTime=sysDateAndTime, ethRXTruncatedFrames=ethRXTruncatedFrames, modemBandwith=modemBandwith, ethTXBackpresEvents=ethTXBackpresEvents, loopback_tributary_mask=loopback_tributary_mask, e1t1AIS=e1t1AIS, modemStatistics=modemStatistics, ethTXPauseFrames=ethTXPauseFrames, modemE1T1ChannelMask=modemE1T1ChannelMask, licenseMask=licenseMask, ethTXByteCounterHi=ethTXByteCounterHi, ethRXBroadcasts=ethRXBroadcasts, ethQOSTXFrames=ethQOSTXFrames, e1t1ChannelNr=e1t1ChannelNr, radioTxFrequency=radioTxFrequency, vlanRowStatus=vlanRowStatus, modemEthernetCapacity=modemEthernetCapacity, ethTXVlanTags=ethTXVlanTags, modemTotalCapacity=modemTotalCapacity, vlanCfgStat=vlanCfgStat, radioRxLevel=radioRxLevel, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemEntry=modemEntry, modemACMtotalCapacity=modemACMtotalCapacity, modemGeneralStatus=modemGeneralStatus, tehnika=tehnika, safip=safip, modemSymbolRateTx=modemSymbolRateTx, modemLDPCdecoderStress=modemLDPCdecoderStress, modemACMethernetCapacity=modemACMethernetCapacity, modemRowStatus=modemRowStatus, modemErroredSecondRatio=modemErroredSecondRatio, vlanPortmap=vlanPortmap, vlanNumber=vlanNumber, ipRadioCfgGeneral=ipRadioCfgGeneral, license=license, ethGFPDropedFrames=ethGFPDropedFrames, ethRXByteCounterHi=ethRXByteCounterHi, ethTXMaxCollisions=ethTXMaxCollisions, saf=saf, modemErroredSecond=modemErroredSecond, ethTXCollisions=ethTXCollisions, ethQOSTXDropped=ethQOSTXDropped, ipRadioMgmt=ipRadioMgmt, radioLoopback=radioLoopback, writeConfig=writeConfig, ethRXControlFrames=ethRXControlFrames, ethRXDvEvent=ethRXDvEvent, modemACMengine=modemACMengine, modemTotalBlockNumber=modemTotalBlockNumber, ethGFPFCSErrors=ethGFPFCSErrors, ethRXPauseFrames=ethRXPauseFrames, ipRadioStatEth=ipRadioStatEth, hostname=hostname, localIp=localIp, ipRadioCfg=ipRadioCfg, radioRxFrequency=radioRxFrequency, microwaveRadio=microwaveRadio, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemACMmodulationMin=modemACMmodulationMin, ethTXMulticasts=ethTXMulticasts, ethTXControlFrames=ethTXControlFrames, ethTXExcessiveDefers=ethTXExcessiveDefers, atpcEnabled=atpcEnabled, modemIndex=modemIndex, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXByteCounterLow=ethRXByteCounterLow, ethRXDribleNibbles=ethRXDribleNibbles, localIpMask=localIpMask, modemErroredBlock=modemErroredBlock, aTPCEntry=aTPCEntry, modemUnavailtime=modemUnavailtime, ethRXVlanTagsDetected=ethRXVlanTagsDetected, product=product, ethTXUnderruns=ethTXUnderruns, radioTxPower=radioTxPower, modemAcqStatus=modemAcqStatus, modemUptime=modemUptime, modemACMmodulationMax=modemACMmodulationMax, vlanTable=vlanTable, radioGenStatus=radioGenStatus, modemCountTime=modemCountTime, pointToPoint=pointToPoint, vlanEntry=vlanEntry, radioDuplexShift=radioDuplexShift, remoteIp=remoteIp, atpcIndex=atpcIndex, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXLongEvents=ethRXLongEvents, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXGiants=ethTXGiants, ipRadio=ipRadio, ipRadioStat=ipRadioStat, vlanFid=vlanFid, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXMulticasts=ethRXMulticasts, ethTXByteCounterLow=ethTXByteCounterLow, modemTable=modemTable, ethTXBroadcasts=ethTXBroadcasts, ethGFPCHECErrors=ethGFPCHECErrors, vlanPortType=vlanPortType, ethTXWireByteCounterLow=ethTXWireByteCounterLow, licenseUpdateStatus=licenseUpdateStatus, ethGFPDelineationErrors=ethGFPDelineationErrors, loopbacks=loopbacks)
