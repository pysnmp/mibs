...
mibBuilder.exportSymbols("SAF-IPRADIO", modemLDPCdecoderStress=modemLDPCdecoderStress, ipRadioMgmt=ipRadioMgmt, ethQOSRXQ1Frames=ethQOSRXQ1Frames, e1t1ChannelNr=e1t1ChannelNr, ethTXLengthCheckErrors=ethTXLengthCheckErrors, radioRxFrequency=radioRxFrequency, sysTemperature=sysTemperature, ethTXVlanTags=ethTXVlanTags, modemACMengine=modemACMengine, modemCarrierOffset=modemCarrierOffset, modemSeverelyErroredSecond=modemSeverelyErroredSecond, localIpMask=localIpMask, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXCRCErrors=ethRXCRCErrors, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioDuplexShift=radioDuplexShift, ethTXCRCErrors=ethTXCRCErrors, modemStandard=modemStandard, modemACMethernetCapacity=modemACMethernetCapacity, modemE1T1Channels=modemE1T1Channels, modemModulation=modemModulation, ethGFPFCSErrors=ethGFPFCSErrors, ethRXByteCounterLow=ethRXByteCounterLow, modemSymbolRateRx=modemSymbolRateRx, aTPCEntry=aTPCEntry, ipRadioCfgGeneral=ipRadioCfgGeneral, description=description, modemACMmodulationMax=modemACMmodulationMax, localIp=localIp, radioEntry=radioEntry, ethRXByteCounterHi=ethRXByteCounterHi, e1t1AIS=e1t1AIS, tehnika=tehnika, ethRXDvEvent=ethRXDvEvent, modemUnavailtime=modemUnavailtime, modemTotalCapacity=modemTotalCapacity, modemSymbolRateTx=modemSymbolRateTx, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXByteCounterLow=ethTXByteCounterLow, vlanTable=vlanTable, modemInternalAGCgain=modemInternalAGCgain, modemTotalBlockNumber=modemTotalBlockNumber, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioTxFrequency=radioTxFrequency, writeConfig=writeConfig, ethRXPauseFrames=ethRXPauseFrames, ethTXBroadcasts=ethTXBroadcasts, ethRXDribleNibbles=ethRXDribleNibbles, vlanEntry=vlanEntry, hostname=hostname, modemBandwith=modemBandwith, ethTXByteCounterHi=ethTXByteCounterHi, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemRadialMSE=modemRadialMSE, radioSide=radioSide, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioGenStatus=radioGenStatus, ethTXGiants=ethTXGiants, aTPCTable=aTPCTable, modemAcqStatus=modemAcqStatus, radioRxLevel=radioRxLevel, modemE1T1ChannelMask=modemE1T1ChannelMask, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, atpcTxPowerCorrection=atpcTxPowerCorrection, ethQOSTXDropped=ethQOSTXDropped, modemErroredSecondRatio=modemErroredSecondRatio, ethTXUnderruns=ethTXUnderruns, microwaveRadio=microwaveRadio, sysDateAndTime=sysDateAndTime, ethTXDones=ethTXDones, modemErroredSecond=modemErroredSecond, ethTXMaxCollisions=ethTXMaxCollisions, radioLoopback=radioLoopback, atpcEnabled=atpcEnabled, modemGeneralStatus=modemGeneralStatus, vlansEnabled=vlansEnabled, ipRadioCfg=ipRadioCfg, ethRXBroadcasts=ethRXBroadcasts, ipRadio=ipRadio, ethTXCollisions=ethTXCollisions, pointToPoint=pointToPoint, ethRXVlanTagsDetected=ethRXVlanTagsDetected, licenseMask=licenseMask, vlanFid=vlanFid, vlanCfgStat=vlanCfgStat, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXDones=ethRXDones, radioIndex=radioIndex, restartcpu=restartcpu, modemTable=modemTable, ethTXBackpresEvents=ethTXBackpresEvents, ethRXLongEvents=ethRXLongEvents, modemStatistics=modemStatistics, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, remoteIp=remoteIp, atpcIndex=atpcIndex, ethTXMulticasts=ethTXMulticasts, ethTXExcessiveDefers=ethTXExcessiveDefers, modemEntry=modemEntry, e1t1StatEntry=e1t1StatEntry, e1t1StatTable=e1t1StatTable, ethTXLateCollisions=ethTXLateCollisions, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemRowStatus=modemRowStatus, loopback_tributary_mask=loopback_tributary_mask, modemACMtotalCapacity=modemACMtotalCapacity, modemACMmodulationMin=modemACMmodulationMin, radioTxMute=radioTxMute, ethQOSTXFrames=ethQOSTXFrames, modemIndex=modemIndex, modemLastAcqError=modemLastAcqError, ipRadioStatEth=ipRadioStatEth, vlanPortType=vlanPortType, loopbacks=loopbacks, ethGFPDropedFrames=ethGFPDropedFrames, ethGFPCHECErrors=ethGFPCHECErrors, license=license, modemErroredBlock=modemErroredBlock, ipRadioStat=ipRadioStat, ethRXMulticasts=ethRXMulticasts, safip=safip, vlanPortmap=vlanPortmap, licenseUpdateStatus=licenseUpdateStatus, modemCountTime=modemCountTime, product=product, modemUptime=modemUptime, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioTxPower=radioTxPower, radioTable=radioTable, ethRXTruncatedFrames=ethRXTruncatedFrames, e1t1LOS=e1t1LOS, saf=saf, vlanNumber=vlanNumber, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXPauseFrames=ethTXPauseFrames, vlanRowStatus=vlanRowStatus, ethRXControlFrames=ethRXControlFrames, ethTXControlFrames=ethTXControlFrames, ethRXCodeErrors=ethRXCodeErrors, modemEthernetCapacity=modemEthernetCapacity, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors)
