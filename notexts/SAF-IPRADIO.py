...
mibBuilder.exportSymbols("SAF-IPRADIO", e1t1AIS=e1t1AIS, modemCountTime=modemCountTime, ethRXControlFrames=ethRXControlFrames, ethGFPDropedFrames=ethGFPDropedFrames, ethRXCodeErrors=ethRXCodeErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemStatistics=modemStatistics, modemErroredSecondRatio=modemErroredSecondRatio, modemACMmodulationMin=modemACMmodulationMin, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXDribleNibbles=ethRXDribleNibbles, ethGFPFCSErrors=ethGFPFCSErrors, sysDateAndTime=sysDateAndTime, ethTXBackpresEvents=ethTXBackpresEvents, ethQOSTXDropped=ethQOSTXDropped, ethRXUnsupOpcodes=ethRXUnsupOpcodes, restartcpu=restartcpu, modemLastAcqError=modemLastAcqError, vlanPortmap=vlanPortmap, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioTxMute=radioTxMute, vlanRowStatus=vlanRowStatus, modemACMtotalCapacity=modemACMtotalCapacity, modemACMengine=modemACMengine, localIp=localIp, ethRXPrevPktDropped=ethRXPrevPktDropped, pointToPoint=pointToPoint, ethTXMaxCollisions=ethTXMaxCollisions, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemModulation=modemModulation, modemErroredBlock=modemErroredBlock, vlanEntry=vlanEntry, vlanCfgStat=vlanCfgStat, ethTXCRCErrors=ethTXCRCErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ipRadioCfgGeneral=ipRadioCfgGeneral, ethGFPDelineationErrors=ethGFPDelineationErrors, radioRxLevel=radioRxLevel, modemLDPCdecoderStress=modemLDPCdecoderStress, modemErroredSecond=modemErroredSecond, ipRadioCfg=ipRadioCfg, ethTXByteCounterHi=ethTXByteCounterHi, modemRadialMSE=modemRadialMSE, modemUptime=modemUptime, licenseUpdateStatus=licenseUpdateStatus, modemIndex=modemIndex, ethTXMulticasts=ethTXMulticasts, ethRXDvEvent=ethRXDvEvent, ethRXByteCounterLow=ethRXByteCounterLow, ethRXBroadcasts=ethRXBroadcasts, modemEthernetCapacity=modemEthernetCapacity, microwaveRadio=microwaveRadio, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXUnderruns=ethTXUnderruns, license=license, radioDuplexShift=radioDuplexShift, radioTxFrequency=radioTxFrequency, vlanTable=vlanTable, description=description, ipRadioStat=ipRadioStat, ethRXByteCounterHi=ethRXByteCounterHi, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXByteCounterLow=ethTXByteCounterLow, atpcTxPowerCorrection=atpcTxPowerCorrection, loopbacks=loopbacks, modemStandard=modemStandard, modemE1T1Channels=modemE1T1Channels, radioTable=radioTable, ethRXCRCErrors=ethRXCRCErrors, modemInternalAGCgain=modemInternalAGCgain, product=product, loopback_tributary_mask=loopback_tributary_mask, licenseMask=licenseMask, modemGeneralStatus=modemGeneralStatus, ethQOSTXFrames=ethQOSTXFrames, aTPCTable=aTPCTable, modemAcqStatus=modemAcqStatus, writeConfig=writeConfig, radioEntry=radioEntry, e1t1StatEntry=e1t1StatEntry, modemSymbolRateRx=modemSymbolRateRx, ethTXControlFrames=ethTXControlFrames, radioGenStatus=radioGenStatus, ethRXMulticasts=ethRXMulticasts, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXBroadcasts=ethTXBroadcasts, safip=safip, radioIndex=radioIndex, modemCarrierOffset=modemCarrierOffset, vlanFid=vlanFid, radioSide=radioSide, vlansEnabled=vlansEnabled, modemACMethernetCapacity=modemACMethernetCapacity, ethTXDones=ethTXDones, sysTemperature=sysTemperature, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioTxPower=radioTxPower, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXLateCollisions=ethTXLateCollisions, atpcEnabled=atpcEnabled, ipRadioMgmt=ipRadioMgmt, ethTXWireByteCounterLow=ethTXWireByteCounterLow, vlanNumber=vlanNumber, modemTable=modemTable, tehnika=tehnika, ethTXVlanTags=ethTXVlanTags, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemRowStatus=modemRowStatus, radioLoopback=radioLoopback, ethTXCollisions=ethTXCollisions, e1t1StatTable=e1t1StatTable, modemACMmodulationMax=modemACMmodulationMax, ethRXLongEvents=ethRXLongEvents, ethTXLengthCheckErrors=ethTXLengthCheckErrors, e1t1LOS=e1t1LOS, hostname=hostname, ethRXPauseFrames=ethRXPauseFrames, modemSymbolRateTx=modemSymbolRateTx, vlanPortType=vlanPortType, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemE1T1ChannelMask=modemE1T1ChannelMask, radioRxFrequency=radioRxFrequency, ethTXGiants=ethTXGiants, modemEntry=modemEntry, remoteIp=remoteIp, e1t1ChannelNr=e1t1ChannelNr, ethRXTruncatedFrames=ethRXTruncatedFrames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadio=ipRadio, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemTotalBlockNumber=modemTotalBlockNumber, ethTXPauseFrames=ethTXPauseFrames, modemUnavailtime=modemUnavailtime, saf=saf, ipRadioStatEth=ipRadioStatEth, modemTotalCapacity=modemTotalCapacity, localIpMask=localIpMask, aTPCEntry=aTPCEntry, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethGFPCHECErrors=ethGFPCHECErrors, atpcIndex=atpcIndex, modemBandwith=modemBandwith, ethRXDones=ethRXDones)
