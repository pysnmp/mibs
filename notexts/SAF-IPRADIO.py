...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXCollisions=ethTXCollisions, modemIndex=modemIndex, ethRXBroadcasts=ethRXBroadcasts, ethTXMaxCollisions=ethTXMaxCollisions, atpcTxPowerCorrection=atpcTxPowerCorrection, vlansEnabled=vlansEnabled, ethGFPDropedFrames=ethGFPDropedFrames, ethTXControlFrames=ethTXControlFrames, ipRadioStatEth=ipRadioStatEth, ethQOSTXDropped=ethQOSTXDropped, ethTXByteCounterLow=ethTXByteCounterLow, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXLengthCheckErrors=ethTXLengthCheckErrors, pointToPoint=pointToPoint, ethTXGiants=ethTXGiants, e1t1LOS=e1t1LOS, remoteIp=remoteIp, aTPCEntry=aTPCEntry, radioRxFrequency=radioRxFrequency, modemACMtotalCapacity=modemACMtotalCapacity, modemLDPCdecoderStress=modemLDPCdecoderStress, modemE1T1Channels=modemE1T1Channels, ethRXControlFrames=ethRXControlFrames, writeConfig=writeConfig, modemModulation=modemModulation, hostname=hostname, ethTXWireByteCounterHi=ethTXWireByteCounterHi, vlanTable=vlanTable, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, license=license, ipRadio=ipRadio, modemSymbolRateTx=modemSymbolRateTx, ethTXVlanTags=ethTXVlanTags, ethRXMulticasts=ethRXMulticasts, vlanFid=vlanFid, ethTXUnderruns=ethTXUnderruns, modemStandard=modemStandard, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXCRCErrors=ethTXCRCErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemTotalBlockNumber=modemTotalBlockNumber, radioSide=radioSide, licenseUpdateStatus=licenseUpdateStatus, e1t1StatEntry=e1t1StatEntry, modemInternalAGCgain=modemInternalAGCgain, radioDuplexShift=radioDuplexShift, modemACMmodulationMax=modemACMmodulationMax, description=description, ethQOSRXQ2Frames=ethQOSRXQ2Frames, safip=safip, modemRowStatus=modemRowStatus, modemE1T1ChannelMask=modemE1T1ChannelMask, modemStatistics=modemStatistics, product=product, ethRXPrevPktDropped=ethRXPrevPktDropped, tehnika=tehnika, modemACMmodulationMin=modemACMmodulationMin, vlanPortType=vlanPortType, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, aTPCTable=aTPCTable, ipRadioCfg=ipRadioCfg, ethGFPFCSErrors=ethGFPFCSErrors, e1t1ChannelNr=e1t1ChannelNr, atpcEnabled=atpcEnabled, localIpMask=localIpMask, ethRXDvEvent=ethRXDvEvent, microwaveRadio=microwaveRadio, ethRXCRCErrors=ethRXCRCErrors, ethRXByteCounterHi=ethRXByteCounterHi, vlanCfgStat=vlanCfgStat, modemTable=modemTable, ethQOSTXFrames=ethQOSTXFrames, ethTXBroadcasts=ethTXBroadcasts, modemGeneralStatus=modemGeneralStatus, radioEntry=radioEntry, ethGFPCHECErrors=ethGFPCHECErrors, radioTxPower=radioTxPower, modemErroredSecond=modemErroredSecond, modemACMengine=modemACMengine, licenseMask=licenseMask, restartcpu=restartcpu, ethTXBackpresEvents=ethTXBackpresEvents, modemErroredBlock=modemErroredBlock, e1t1AIS=e1t1AIS, ethRXPauseFrames=ethRXPauseFrames, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemSymbolRateRx=modemSymbolRateRx, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXLateCollisions=ethTXLateCollisions, vlanEntry=vlanEntry, ethTXDones=ethTXDones, ethGFPDelineationErrors=ethGFPDelineationErrors, radioGenStatus=radioGenStatus, atpcIndex=atpcIndex, modemTotalCapacity=modemTotalCapacity, modemEthernetCapacity=modemEthernetCapacity, radioTxMute=radioTxMute, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ipRadioStat=ipRadioStat, modemCarrierOffset=modemCarrierOffset, ethRXDones=ethRXDones, modemErroredSecondRatio=modemErroredSecondRatio, radioIndex=radioIndex, ipRadioMgmt=ipRadioMgmt, modemRadialMSE=modemRadialMSE, ethTXExcessiveDefers=ethTXExcessiveDefers, modemLastAcqError=modemLastAcqError, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXPauseFrames=ethTXPauseFrames, sysTemperature=sysTemperature, vlanRowStatus=vlanRowStatus, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemAcqStatus=modemAcqStatus, ethTXByteCounterHi=ethTXByteCounterHi, ethTXMulticasts=ethTXMulticasts, vlanNumber=vlanNumber, modemUnavailtime=modemUnavailtime, ethRXByteCounterLow=ethRXByteCounterLow, loopback_tributary_mask=loopback_tributary_mask, loopbacks=loopbacks, modemEntry=modemEntry, localIp=localIp, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, saf=saf, modemCountTime=modemCountTime, radioTable=radioTable, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ipRadioCfgNetwork=ipRadioCfgNetwork, radioRxLevel=radioRxLevel, ethRXCodeErrors=ethRXCodeErrors, radioTxFrequency=radioTxFrequency, ethRXDribleNibbles=ethRXDribleNibbles, vlanPortmap=vlanPortmap, radioLoopback=radioLoopback, e1t1StatTable=e1t1StatTable, ethRXLongEvents=ethRXLongEvents, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemBandwith=modemBandwith, modemACMethernetCapacity=modemACMethernetCapacity, sysDateAndTime=sysDateAndTime, modemUptime=modemUptime)
