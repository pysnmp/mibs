...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXBroadcasts=ethRXBroadcasts, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, e1t1ChannelNr=e1t1ChannelNr, ethTXDones=ethTXDones, ethRXDones=ethRXDones, modemLDPCdecoderStress=modemLDPCdecoderStress, safip=safip, saf=saf, ethRXControlFrames=ethRXControlFrames, ethTXExcessiveDefers=ethTXExcessiveDefers, localIp=localIp, modemACMmodulationMin=modemACMmodulationMin, atpcIndex=atpcIndex, ipRadioStat=ipRadioStat, ethGFPFCSErrors=ethGFPFCSErrors, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, modemLastAcqError=modemLastAcqError, hostname=hostname, e1t1LOS=e1t1LOS, e1t1AIS=e1t1AIS, modemACMtotalCapacity=modemACMtotalCapacity, ipRadioCfgGeneral=ipRadioCfgGeneral, pointToPoint=pointToPoint, modemErroredSecond=modemErroredSecond, radioSide=radioSide, ethTXCollisions=ethTXCollisions, ethTXCRCErrors=ethTXCRCErrors, modemACMethernetCapacity=modemACMethernetCapacity, modemIndex=modemIndex, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXDvEvent=ethRXDvEvent, ethTXBroadcasts=ethTXBroadcasts, ethGFPDropedFrames=ethGFPDropedFrames, modemAcqStatus=modemAcqStatus, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXGiants=ethTXGiants, licenseMask=licenseMask, atpcTxPowerCorrection=atpcTxPowerCorrection, vlanEntry=vlanEntry, radioGenStatus=radioGenStatus, vlanFid=vlanFid, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioRxFrequency=radioRxFrequency, modemModulation=modemModulation, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioLoopback=radioLoopback, modemTable=modemTable, ethRXByteCounterHi=ethRXByteCounterHi, ethGFPCHECErrors=ethGFPCHECErrors, modemUnavailtime=modemUnavailtime, ethTXByteCounterHi=ethTXByteCounterHi, vlanPortmap=vlanPortmap, modemRowStatus=modemRowStatus, vlanTable=vlanTable, product=product, restartcpu=restartcpu, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioEntry=radioEntry, aTPCTable=aTPCTable, ethRXMulticasts=ethRXMulticasts, licenseUpdateStatus=licenseUpdateStatus, modemErroredBlock=modemErroredBlock, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXCodeErrors=ethRXCodeErrors, ipRadioCfg=ipRadioCfg, e1t1StatEntry=e1t1StatEntry, modemGeneralStatus=modemGeneralStatus, modemTotalBlockNumber=modemTotalBlockNumber, microwaveRadio=microwaveRadio, ethTXMaxCollisions=ethTXMaxCollisions, modemEthernetCapacity=modemEthernetCapacity, ethTXPauseFrames=ethTXPauseFrames, loopback_tributary_mask=loopback_tributary_mask, ipRadio=ipRadio, radioTxFrequency=radioTxFrequency, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemTotalCapacity=modemTotalCapacity, e1t1StatTable=e1t1StatTable, modemSymbolRateTx=modemSymbolRateTx, modemStandard=modemStandard, modemUptime=modemUptime, modemCarrierOffset=modemCarrierOffset, ethTXVlanTags=ethTXVlanTags, ethTXMulticasts=ethTXMulticasts, ipRadioMgmt=ipRadioMgmt, atpcEnabled=atpcEnabled, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioTxPower=radioTxPower, radioTxMute=radioTxMute, sysDateAndTime=sysDateAndTime, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlansEnabled=vlansEnabled, modemInternalAGCgain=modemInternalAGCgain, modemACMengine=modemACMengine, ethRXLongEvents=ethRXLongEvents, localIpMask=localIpMask, description=description, ipRadioCfgNetwork=ipRadioCfgNetwork, radioRxLevel=radioRxLevel, ethRXDribleNibbles=ethRXDribleNibbles, modemACMmodulationMax=modemACMmodulationMax, ethTXWireByteCounterLow=ethTXWireByteCounterLow, loopbacks=loopbacks, remoteIp=remoteIp, ethRXPauseFrames=ethRXPauseFrames, modemE1T1Channels=modemE1T1Channels, aTPCEntry=aTPCEntry, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioTable=radioTable, modemRadialMSE=modemRadialMSE, ethRXByteCounterLow=ethRXByteCounterLow, modemBandwith=modemBandwith, vlanRowStatus=vlanRowStatus, writeConfig=writeConfig, ethTXLateCollisions=ethTXLateCollisions, ethQOSTXFrames=ethQOSTXFrames, radioIndex=radioIndex, radioDuplexShift=radioDuplexShift, ethTXUnderruns=ethTXUnderruns, ethTXByteCounterLow=ethTXByteCounterLow, ethRXCRCErrors=ethRXCRCErrors, vlanNumber=vlanNumber, license=license, ethTXBackpresEvents=ethTXBackpresEvents, modemErroredSecondRatio=modemErroredSecondRatio, vlanCfgStat=vlanCfgStat, vlanPortType=vlanPortType, tehnika=tehnika, modemCountTime=modemCountTime, modemStatistics=modemStatistics, ethQOSTXDropped=ethQOSTXDropped, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemSymbolRateRx=modemSymbolRateRx, ethGFPDelineationErrors=ethGFPDelineationErrors, modemEntry=modemEntry, sysTemperature=sysTemperature, ipRadioStatEth=ipRadioStatEth, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXControlFrames=ethTXControlFrames)
