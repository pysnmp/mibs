...
mibBuilder.exportSymbols("SAF-IPRADIO", licenseUpdateStatus=licenseUpdateStatus, ethTXLateCollisions=ethTXLateCollisions, e1t1StatTable=e1t1StatTable, ethRXBroadcasts=ethRXBroadcasts, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemE1T1Channels=modemE1T1Channels, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXMulticasts=ethRXMulticasts, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, atpcEnabled=atpcEnabled, vlanRowStatus=vlanRowStatus, modemRadialMSE=modemRadialMSE, restartcpu=restartcpu, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemSymbolRateRx=modemSymbolRateRx, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, writeConfig=writeConfig, modemACMmodulationMin=modemACMmodulationMin, ipRadio=ipRadio, radioIndex=radioIndex, modemACMmodulationMax=modemACMmodulationMax, radioSide=radioSide, hostname=hostname, microwaveRadio=microwaveRadio, e1t1AIS=e1t1AIS, ethTXMulticasts=ethTXMulticasts, ethQOSTXFrames=ethQOSTXFrames, radioLoopback=radioLoopback, localIp=localIp, radioRxFrequency=radioRxFrequency, modemIndex=modemIndex, ethTXControlFrames=ethTXControlFrames, radioTxMute=radioTxMute, ethTXMaxCollisions=ethTXMaxCollisions, ethGFPFCSErrors=ethGFPFCSErrors, e1t1ChannelNr=e1t1ChannelNr, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemCarrierOffset=modemCarrierOffset, vlanCfgStat=vlanCfgStat, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadioStatEth=ipRadioStatEth, modemErroredBlock=modemErroredBlock, ethRXTruncatedFrames=ethRXTruncatedFrames, radioTxFrequency=radioTxFrequency, modemUnavailtime=modemUnavailtime, ethRXUnsupOpcodes=ethRXUnsupOpcodes, sysTemperature=sysTemperature, radioEntry=radioEntry, ipRadioCfgNetwork=ipRadioCfgNetwork, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXBroadcasts=ethTXBroadcasts, safip=safip, ethTXBackpresEvents=ethTXBackpresEvents, modemLastAcqError=modemLastAcqError, ethQOSTXDropped=ethQOSTXDropped, vlanPortType=vlanPortType, ethRXControlFrames=ethRXControlFrames, modemErroredSecond=modemErroredSecond, modemSymbolRateTx=modemSymbolRateTx, ethRXDribleNibbles=ethRXDribleNibbles, saf=saf, modemInternalAGCgain=modemInternalAGCgain, localIpMask=localIpMask, modemStatistics=modemStatistics, ethRXByteCounterHi=ethRXByteCounterHi, e1t1LOS=e1t1LOS, ipRadioCfg=ipRadioCfg, modemCountTime=modemCountTime, loopback_tributary_mask=loopback_tributary_mask, ethRXDones=ethRXDones, pointToPoint=pointToPoint, aTPCTable=aTPCTable, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, sysDateAndTime=sysDateAndTime, modemACMethernetCapacity=modemACMethernetCapacity, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioGenStatus=radioGenStatus, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXDvEvent=ethRXDvEvent, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXByteCounterHi=ethTXByteCounterHi, modemTotalCapacity=modemTotalCapacity, ethRXLongEvents=ethRXLongEvents, ethTXUnderruns=ethTXUnderruns, ethRXCRCErrors=ethRXCRCErrors, modemEthernetCapacity=modemEthernetCapacity, ethTXVlanTags=ethTXVlanTags, modemACMengine=modemACMengine, ethRXCodeErrors=ethRXCodeErrors, modemBandwith=modemBandwith, ethTXCollisions=ethTXCollisions, modemEntry=modemEntry, modemTable=modemTable, aTPCEntry=aTPCEntry, ethRXPauseFrames=ethRXPauseFrames, ethQOSRXQ2Frames=ethQOSRXQ2Frames, product=product, ethTXPauseFrames=ethTXPauseFrames, vlanTable=vlanTable, modemTotalBlockNumber=modemTotalBlockNumber, modemAcqStatus=modemAcqStatus, modemACMtotalCapacity=modemACMtotalCapacity, ethTXCRCErrors=ethTXCRCErrors, description=description, remoteIp=remoteIp, modemRowStatus=modemRowStatus, ethRXByteCounterLow=ethRXByteCounterLow, e1t1StatEntry=e1t1StatEntry, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXByteCounterLow=ethTXByteCounterLow, ethTXExcessiveDefers=ethTXExcessiveDefers, ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlansEnabled=vlansEnabled, atpcIndex=atpcIndex, loopbacks=loopbacks, modemModulation=modemModulation, vlanFid=vlanFid, ethTXGiants=ethTXGiants, ipRadioMgmt=ipRadioMgmt, tehnika=tehnika, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemUptime=modemUptime, ethGFPCHECErrors=ethGFPCHECErrors, vlanPortmap=vlanPortmap, license=license, ethTXDones=ethTXDones, radioTxPower=radioTxPower, ipRadioCfgGeneral=ipRadioCfgGeneral, modemLDPCdecoderStress=modemLDPCdecoderStress, radioDuplexShift=radioDuplexShift, radioRxLevel=radioRxLevel, ethGFPDropedFrames=ethGFPDropedFrames, licenseMask=licenseMask, radioTable=radioTable, ipRadioStat=ipRadioStat, vlanEntry=vlanEntry, ethTXWireByteCounterLow=ethTXWireByteCounterLow, vlanNumber=vlanNumber, modemGeneralStatus=modemGeneralStatus, modemStandard=modemStandard, modemErroredSecondRatio=modemErroredSecondRatio, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors)
