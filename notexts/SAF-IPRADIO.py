...
mibBuilder.exportSymbols("SAF-IPRADIO", loopback_tributary_mask=loopback_tributary_mask, modemACMengine=modemACMengine, ethRXBroadcasts=ethRXBroadcasts, atpcIndex=atpcIndex, modemCountTime=modemCountTime, vlanEntry=vlanEntry, radioDuplexShift=radioDuplexShift, modemIndex=modemIndex, modemInternalAGCgain=modemInternalAGCgain, radioEntry=radioEntry, radioGenStatus=radioGenStatus, localIp=localIp, ethRXLongEvents=ethRXLongEvents, modemUptime=modemUptime, vlanNumber=vlanNumber, ethTXDones=ethTXDones, vlanTable=vlanTable, modemTable=modemTable, ethTXMaxCollisions=ethTXMaxCollisions, saf=saf, ethRXByteCounterLow=ethRXByteCounterLow, ethTXLengthCheckErrors=ethTXLengthCheckErrors, vlanFid=vlanFid, ipRadioStat=ipRadioStat, license=license, ethRXDones=ethRXDones, radioSide=radioSide, e1t1AIS=e1t1AIS, ethTXLateCollisions=ethTXLateCollisions, sysDateAndTime=sysDateAndTime, safip=safip, ethTXByteCounterHi=ethTXByteCounterHi, modemGeneralStatus=modemGeneralStatus, radioRxFrequency=radioRxFrequency, ethTXCollisions=ethTXCollisions, vlanRowStatus=vlanRowStatus, modemLastAcqError=modemLastAcqError, e1t1StatEntry=e1t1StatEntry, ethRXControlFrames=ethRXControlFrames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemLDPCdecoderStress=modemLDPCdecoderStress, modemRowStatus=modemRowStatus, radioTxMute=radioTxMute, radioIndex=radioIndex, ipRadio=ipRadio, pointToPoint=pointToPoint, licenseMask=licenseMask, vlanCfgStat=vlanCfgStat, ethRXDribleNibbles=ethRXDribleNibbles, ethTXVlanTags=ethTXVlanTags, modemStatistics=modemStatistics, ipRadioStatEth=ipRadioStatEth, ethQOSTXFrames=ethQOSTXFrames, radioLoopback=radioLoopback, aTPCEntry=aTPCEntry, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXPauseFrames=ethTXPauseFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXBroadcasts=ethTXBroadcasts, ethTXControlFrames=ethTXControlFrames, modemACMethernetCapacity=modemACMethernetCapacity, modemE1T1Channels=modemE1T1Channels, sysTemperature=sysTemperature, ethTXWireByteCounterHi=ethTXWireByteCounterHi, remoteIp=remoteIp, e1t1ChannelNr=e1t1ChannelNr, ethRXDvEvent=ethRXDvEvent, modemModulation=modemModulation, ethTXCRCErrors=ethTXCRCErrors, ethGFPDropedFrames=ethGFPDropedFrames, ethRXCRCErrors=ethRXCRCErrors, modemTotalCapacity=modemTotalCapacity, radioTxPower=radioTxPower, ethRXPauseFrames=ethRXPauseFrames, modemEthernetCapacity=modemEthernetCapacity, product=product, ethGFPFCSErrors=ethGFPFCSErrors, loopbacks=loopbacks, modemRadialMSE=modemRadialMSE, modemE1T1ChannelMask=modemE1T1ChannelMask, modemEntry=modemEntry, modemTotalBlockNumber=modemTotalBlockNumber, radioTxFrequency=radioTxFrequency, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXMulticasts=ethRXMulticasts, writeConfig=writeConfig, ethTXGiants=ethTXGiants, vlanPortmap=vlanPortmap, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemACMtotalCapacity=modemACMtotalCapacity, e1t1LOS=e1t1LOS, ethRXByteCounterHi=ethRXByteCounterHi, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemBandwith=modemBandwith, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, vlanPortType=vlanPortType, ethGFPCHECErrors=ethGFPCHECErrors, hostname=hostname, restartcpu=restartcpu, modemACMmodulationMax=modemACMmodulationMax, modemErroredSecondRatio=modemErroredSecondRatio, ipRadioMgmt=ipRadioMgmt, modemAcqStatus=modemAcqStatus, localIpMask=localIpMask, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemACMmodulationMin=modemACMmodulationMin, ethRXPrevPktDropped=ethRXPrevPktDropped, ipRadioCfgNetwork=ipRadioCfgNetwork, description=description, ethTXMulticasts=ethTXMulticasts, modemCarrierOffset=modemCarrierOffset, radioTable=radioTable, microwaveRadio=microwaveRadio, ethTXByteCounterLow=ethTXByteCounterLow, atpcTxPowerCorrection=atpcTxPowerCorrection, ipRadioCfg=ipRadioCfg, ethTXUnderruns=ethTXUnderruns, ethTXBackpresEvents=ethTXBackpresEvents, ethQOSTXDropped=ethQOSTXDropped, atpcEnabled=atpcEnabled, aTPCTable=aTPCTable, licenseUpdateStatus=licenseUpdateStatus, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXExcessiveDefers=ethTXExcessiveDefers, vlansEnabled=vlansEnabled, modemUnavailtime=modemUnavailtime, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, e1t1StatTable=e1t1StatTable, tehnika=tehnika, ipRadioCfgGeneral=ipRadioCfgGeneral, radioRxLevel=radioRxLevel, modemSymbolRateRx=modemSymbolRateRx, modemStandard=modemStandard, modemErroredSecond=modemErroredSecond, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemErroredBlock=modemErroredBlock, modemSymbolRateTx=modemSymbolRateTx, ethRXCodeErrors=ethRXCodeErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond)
