...
mibBuilder.exportSymbols("SAF-IPRADIO", license=license, ethRXTruncatedFrames=ethRXTruncatedFrames, ethQOSRXQ1Frames=ethQOSRXQ1Frames, sysTemperature=sysTemperature, ethTXByteCounterLow=ethTXByteCounterLow, ethTXDones=ethTXDones, modemTable=modemTable, ethTXWireByteCounterHi=ethTXWireByteCounterHi, writeConfig=writeConfig, tehnika=tehnika, ethTXExcessiveDefers=ethTXExcessiveDefers, safip=safip, restartcpu=restartcpu, modemSymbolRateTx=modemSymbolRateTx, vlanCfgStat=vlanCfgStat, radioRxLevel=radioRxLevel, vlanFid=vlanFid, ipRadioCfgGeneral=ipRadioCfgGeneral, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXControlFrames=ethRXControlFrames, ethRXCRCErrors=ethRXCRCErrors, radioSide=radioSide, modemRadialMSE=modemRadialMSE, ethTXCRCErrors=ethTXCRCErrors, modemErroredSecond=modemErroredSecond, ethRXDvEvent=ethRXDvEvent, ethRXPrevPktDropped=ethRXPrevPktDropped, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXLengthCheckErrors=ethTXLengthCheckErrors, sysDateAndTime=sysDateAndTime, ipRadioStat=ipRadioStat, loopbacks=loopbacks, licenseUpdateStatus=licenseUpdateStatus, localIpMask=localIpMask, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemEthernetCapacity=modemEthernetCapacity, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethQOSTXFrames=ethQOSTXFrames, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioGenStatus=radioGenStatus, vlanRowStatus=vlanRowStatus, modemIndex=modemIndex, modemModulation=modemModulation, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemAcqStatus=modemAcqStatus, e1t1StatEntry=e1t1StatEntry, e1t1StatTable=e1t1StatTable, ethTXCollisions=ethTXCollisions, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethGFPCHECErrors=ethGFPCHECErrors, modemCarrierOffset=modemCarrierOffset, aTPCTable=aTPCTable, vlanNumber=vlanNumber, ethTXGiants=ethTXGiants, ethTXLateCollisions=ethTXLateCollisions, modemBandwith=modemBandwith, ethRXDones=ethRXDones, ethRXBroadcasts=ethRXBroadcasts, atpcEnabled=atpcEnabled, localIp=localIp, modemEntry=modemEntry, modemACMtotalCapacity=modemACMtotalCapacity, radioLoopback=radioLoopback, ipRadio=ipRadio, vlanTable=vlanTable, radioIndex=radioIndex, modemACMengine=modemACMengine, hostname=hostname, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemACMethernetCapacity=modemACMethernetCapacity, ethRXLongEvents=ethRXLongEvents, radioRxFrequency=radioRxFrequency, modemLastAcqError=modemLastAcqError, e1t1LOS=e1t1LOS, ipRadioCfg=ipRadioCfg, e1t1ChannelNr=e1t1ChannelNr, modemE1T1Channels=modemE1T1Channels, vlanPortmap=vlanPortmap, radioTxMute=radioTxMute, modemTotalCapacity=modemTotalCapacity, radioTxPower=radioTxPower, modemRowStatus=modemRowStatus, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioTable=radioTable, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXMulticasts=ethRXMulticasts, ethRXCodeErrors=ethRXCodeErrors, remoteIp=remoteIp, ethRXByteCounterHi=ethRXByteCounterHi, modemACMmodulationMin=modemACMmodulationMin, ethTXVlanTags=ethTXVlanTags, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, e1t1AIS=e1t1AIS, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemStandard=modemStandard, microwaveRadio=microwaveRadio, modemInternalAGCgain=modemInternalAGCgain, ethTXControlFrames=ethTXControlFrames, ethGFPDropedFrames=ethGFPDropedFrames, ethTXMaxCollisions=ethTXMaxCollisions, radioTxFrequency=radioTxFrequency, modemSymbolRateRx=modemSymbolRateRx, modemUptime=modemUptime, modemGeneralStatus=modemGeneralStatus, licenseMask=licenseMask, ethQOSTXDropped=ethQOSTXDropped, ethTXBackpresEvents=ethTXBackpresEvents, vlanPortType=vlanPortType, ethRXDribleNibbles=ethRXDribleNibbles, loopback_tributary_mask=loopback_tributary_mask, description=description, ethTXUnderruns=ethTXUnderruns, radioEntry=radioEntry, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXMulticasts=ethTXMulticasts, ethTXByteCounterHi=ethTXByteCounterHi, modemCountTime=modemCountTime, modemTotalBlockNumber=modemTotalBlockNumber, vlanEntry=vlanEntry, ipRadioCfgNetwork=ipRadioCfgNetwork, modemStatistics=modemStatistics, radioDuplexShift=radioDuplexShift, modemErroredSecondRatio=modemErroredSecondRatio, ethGFPFCSErrors=ethGFPFCSErrors, ethTXBroadcasts=ethTXBroadcasts, ethRXPauseFrames=ethRXPauseFrames, ethRXByteCounterLow=ethRXByteCounterLow, pointToPoint=pointToPoint, ethTXPauseFrames=ethTXPauseFrames, ipRadioStatEth=ipRadioStatEth, aTPCEntry=aTPCEntry, atpcIndex=atpcIndex, vlansEnabled=vlansEnabled, modemLDPCdecoderStress=modemLDPCdecoderStress, product=product, modemACMmodulationMax=modemACMmodulationMax, ipRadioMgmt=ipRadioMgmt, modemErroredBlock=modemErroredBlock, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, saf=saf, modemUnavailtime=modemUnavailtime)
