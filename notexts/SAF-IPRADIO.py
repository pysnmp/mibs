...
mibBuilder.exportSymbols("SAF-IPRADIO", sysDateAndTime=sysDateAndTime, modemUnavailtime=modemUnavailtime, ethTXCRCErrors=ethTXCRCErrors, modemTable=modemTable, modemStandard=modemStandard, hostname=hostname, ethQOSTXFrames=ethQOSTXFrames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlanCfgStat=vlanCfgStat, ethRXByteCounterHi=ethRXByteCounterHi, vlanPortmap=vlanPortmap, modemTotalCapacity=modemTotalCapacity, ethRXCRCErrors=ethRXCRCErrors, e1t1LOS=e1t1LOS, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioTxPower=radioTxPower, restartcpu=restartcpu, modemAcqStatus=modemAcqStatus, safip=safip, radioIndex=radioIndex, radioTxFrequency=radioTxFrequency, modemCountTime=modemCountTime, ethRXByteCounterLow=ethRXByteCounterLow, radioGenStatus=radioGenStatus, modemModulation=modemModulation, ethTXMaxCollisions=ethTXMaxCollisions, ethTXLateCollisions=ethTXLateCollisions, ipRadio=ipRadio, ipRadioCfgNetwork=ipRadioCfgNetwork, modemStatistics=modemStatistics, tehnika=tehnika, ipRadioStatEth=ipRadioStatEth, modemCarrierOffset=modemCarrierOffset, radioLoopback=radioLoopback, modemEntry=modemEntry, aTPCEntry=aTPCEntry, writeConfig=writeConfig, modemErroredSecond=modemErroredSecond, ethRXBroadcasts=ethRXBroadcasts, licenseUpdateStatus=licenseUpdateStatus, ethGFPDropedFrames=ethGFPDropedFrames, vlanNumber=vlanNumber, modemInternalAGCgain=modemInternalAGCgain, radioRxLevel=radioRxLevel, modemACMengine=modemACMengine, e1t1AIS=e1t1AIS, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXPauseFrames=ethTXPauseFrames, ethTXBroadcasts=ethTXBroadcasts, sysTemperature=sysTemperature, ethTXUnderruns=ethTXUnderruns, e1t1ChannelNr=e1t1ChannelNr, modemLastAcqError=modemLastAcqError, modemE1T1ChannelMask=modemE1T1ChannelMask, atpcEnabled=atpcEnabled, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXDvEvent=ethRXDvEvent, microwaveRadio=microwaveRadio, radioRxFrequency=radioRxFrequency, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXByteCounterHi=ethTXByteCounterHi, ethTXByteCounterLow=ethTXByteCounterLow, localIpMask=localIpMask, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXControlFrames=ethRXControlFrames, ethGFPCHECErrors=ethGFPCHECErrors, ethTXVlanTags=ethTXVlanTags, aTPCTable=aTPCTable, localIp=localIp, e1t1StatTable=e1t1StatTable, ethRXVlanTagsDetected=ethRXVlanTagsDetected, product=product, radioTable=radioTable, e1t1StatEntry=e1t1StatEntry, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadioMgmt=ipRadioMgmt, ethGFPDelineationErrors=ethGFPDelineationErrors, vlanTable=vlanTable, modemGeneralStatus=modemGeneralStatus, radioSide=radioSide, modemEthernetCapacity=modemEthernetCapacity, vlanRowStatus=vlanRowStatus, ethTXBackpresEvents=ethTXBackpresEvents, ethQOSRXQ2Frames=ethQOSRXQ2Frames, licenseMask=licenseMask, vlanEntry=vlanEntry, ethRXDribleNibbles=ethRXDribleNibbles, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXCodeErrors=ethRXCodeErrors, modemACMmodulationMin=modemACMmodulationMin, ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlansEnabled=vlansEnabled, radioTxMute=radioTxMute, ethTXGiants=ethTXGiants, ethTXCollisions=ethTXCollisions, ethRXPrevPktDropped=ethRXPrevPktDropped, modemACMtotalCapacity=modemACMtotalCapacity, ethGFPFCSErrors=ethGFPFCSErrors, radioEntry=radioEntry, ethRXPauseFrames=ethRXPauseFrames, modemRowStatus=modemRowStatus, ipRadioStat=ipRadioStat, ethTXControlFrames=ethTXControlFrames, atpcIndex=atpcIndex, remoteIp=remoteIp, ethRXLongEvents=ethRXLongEvents, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemErroredSecondRatio=modemErroredSecondRatio, modemSymbolRateRx=modemSymbolRateRx, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, loopback_tributary_mask=loopback_tributary_mask, saf=saf, atpcTxPowerCorrection=atpcTxPowerCorrection, modemSymbolRateTx=modemSymbolRateTx, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXTruncatedFrames=ethRXTruncatedFrames, ethQOSTXDropped=ethQOSTXDropped, ipRadioCfg=ipRadioCfg, modemTotalBlockNumber=modemTotalBlockNumber, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemE1T1Channels=modemE1T1Channels, vlanPortType=vlanPortType, modemRadialMSE=modemRadialMSE, ethRXUnsupOpcodes=ethRXUnsupOpcodes, license=license, modemIndex=modemIndex, loopbacks=loopbacks, ethTXMulticasts=ethTXMulticasts, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXDones=ethTXDones, vlanFid=vlanFid, modemUptime=modemUptime, description=description, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemACMmodulationMax=modemACMmodulationMax, ethRXMulticasts=ethRXMulticasts, ethRXDones=ethRXDones, radioDuplexShift=radioDuplexShift, modemErroredBlock=modemErroredBlock, modemACMethernetCapacity=modemACMethernetCapacity, modemBandwith=modemBandwith, pointToPoint=pointToPoint)
