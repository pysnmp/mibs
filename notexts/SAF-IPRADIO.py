...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXByteCounterHi=ethTXByteCounterHi, ethRXBroadcasts=ethRXBroadcasts, ethTXLateCollisions=ethTXLateCollisions, ethRXPrevPktDropped=ethRXPrevPktDropped, licenseMask=licenseMask, modemAcqStatus=modemAcqStatus, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemStatistics=modemStatistics, modemEthernetCapacity=modemEthernetCapacity, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethGFPFCSErrors=ethGFPFCSErrors, product=product, vlanTable=vlanTable, vlanRowStatus=vlanRowStatus, saf=saf, modemGeneralStatus=modemGeneralStatus, atpcTxPowerCorrection=atpcTxPowerCorrection, vlanPortmap=vlanPortmap, loopbacks=loopbacks, modemTotalCapacity=modemTotalCapacity, modemACMmodulationMax=modemACMmodulationMax, atpcEnabled=atpcEnabled, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioTxMute=radioTxMute, modemBandwith=modemBandwith, remoteIp=remoteIp, ethRXDvEvent=ethRXDvEvent, radioTable=radioTable, ethGFPDelineationErrors=ethGFPDelineationErrors, licenseUpdateStatus=licenseUpdateStatus, tehnika=tehnika, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ipRadioCfg=ipRadioCfg, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, aTPCEntry=aTPCEntry, ethRXCRCErrors=ethRXCRCErrors, modemErroredSecond=modemErroredSecond, ipRadioStat=ipRadioStat, ethRXPauseFrames=ethRXPauseFrames, modemIndex=modemIndex, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, e1t1AIS=e1t1AIS, ethRXDones=ethRXDones, modemSymbolRateRx=modemSymbolRateRx, ethTXDones=ethTXDones, modemLDPCdecoderStress=modemLDPCdecoderStress, modemSeverelyErroredSecond=modemSeverelyErroredSecond, description=description, vlanEntry=vlanEntry, loopback_tributary_mask=loopback_tributary_mask, ethRXByteCounterLow=ethRXByteCounterLow, ethRXCodeErrors=ethRXCodeErrors, radioGenStatus=radioGenStatus, modemSymbolRateTx=modemSymbolRateTx, restartcpu=restartcpu, vlanCfgStat=vlanCfgStat, ethTXPauseFrames=ethTXPauseFrames, radioLoopback=radioLoopback, ipRadioStatEth=ipRadioStatEth, radioTxPower=radioTxPower, radioRxFrequency=radioRxFrequency, vlanFid=vlanFid, hostname=hostname, ethTXMaxCollisions=ethTXMaxCollisions, modemCarrierOffset=modemCarrierOffset, ethRXMulticasts=ethRXMulticasts, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXMulticasts=ethTXMulticasts, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXCollisions=ethTXCollisions, ethGFPCHECErrors=ethGFPCHECErrors, radioIndex=radioIndex, ethRXDribleNibbles=ethRXDribleNibbles, modemUptime=modemUptime, ethTXControlFrames=ethTXControlFrames, modemTotalBlockNumber=modemTotalBlockNumber, modemE1T1Channels=modemE1T1Channels, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXControlFrames=ethRXControlFrames, writeConfig=writeConfig, sysTemperature=sysTemperature, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, e1t1StatTable=e1t1StatTable, modemStandard=modemStandard, ethGFPDropedFrames=ethGFPDropedFrames, ethTXBroadcasts=ethTXBroadcasts, modemCountTime=modemCountTime, localIp=localIp, ethTXVlanTags=ethTXVlanTags, e1t1ChannelNr=e1t1ChannelNr, aTPCTable=aTPCTable, modemACMtotalCapacity=modemACMtotalCapacity, e1t1LOS=e1t1LOS, ethRXByteCounterHi=ethRXByteCounterHi, radioSide=radioSide, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemE1T1ChannelMask=modemE1T1ChannelMask, atpcIndex=atpcIndex, microwaveRadio=microwaveRadio, ethTXCRCErrors=ethTXCRCErrors, modemErroredBlock=modemErroredBlock, modemTable=modemTable, modemRadialMSE=modemRadialMSE, vlansEnabled=vlansEnabled, modemModulation=modemModulation, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemUnavailtime=modemUnavailtime, modemRowStatus=modemRowStatus, license=license, ethTXUnderruns=ethTXUnderruns, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, pointToPoint=pointToPoint, modemACMmodulationMin=modemACMmodulationMin, modemEntry=modemEntry, ethTXGiants=ethTXGiants, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemLastAcqError=modemLastAcqError, ethQOSTXFrames=ethQOSTXFrames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ipRadio=ipRadio, modemInternalAGCgain=modemInternalAGCgain, ethQOSTXDropped=ethQOSTXDropped, vlanPortType=vlanPortType, vlanNumber=vlanNumber, modemACMengine=modemACMengine, radioDuplexShift=radioDuplexShift, ethRXTruncatedFrames=ethRXTruncatedFrames, ipRadioMgmt=ipRadioMgmt, radioEntry=radioEntry, ethTXLengthCheckErrors=ethTXLengthCheckErrors, safip=safip, ethRXLongEvents=ethRXLongEvents, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemACMethernetCapacity=modemACMethernetCapacity, localIpMask=localIpMask, ethTXBackpresEvents=ethTXBackpresEvents, ethTXByteCounterLow=ethTXByteCounterLow, radioRxLevel=radioRxLevel, modemErroredSecondRatio=modemErroredSecondRatio, e1t1StatEntry=e1t1StatEntry, radioTxFrequency=radioTxFrequency, sysDateAndTime=sysDateAndTime)
