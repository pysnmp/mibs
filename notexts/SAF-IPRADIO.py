...
mibBuilder.exportSymbols("SAF-IPRADIO", modemRadialMSE=modemRadialMSE, radioEntry=radioEntry, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemRowStatus=modemRowStatus, radioIndex=radioIndex, radioTxFrequency=radioTxFrequency, restartcpu=restartcpu, modemErroredSecond=modemErroredSecond, license=license, tehnika=tehnika, aTPCTable=aTPCTable, licenseUpdateStatus=licenseUpdateStatus, modemACMethernetCapacity=modemACMethernetCapacity, localIpMask=localIpMask, ethTXLateCollisions=ethTXLateCollisions, ipRadioCfgGeneral=ipRadioCfgGeneral, writeConfig=writeConfig, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethQOSTXDropped=ethQOSTXDropped, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemErroredBlock=modemErroredBlock, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXControlFrames=ethTXControlFrames, ethRXCodeErrors=ethRXCodeErrors, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemACMtotalCapacity=modemACMtotalCapacity, ethTXMaxCollisions=ethTXMaxCollisions, vlanTable=vlanTable, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXByteCounterLow=ethRXByteCounterLow, ipRadioCfg=ipRadioCfg, modemCarrierOffset=modemCarrierOffset, modemAcqStatus=modemAcqStatus, licenseMask=licenseMask, ethTXMulticasts=ethTXMulticasts, hostname=hostname, modemTotalBlockNumber=modemTotalBlockNumber, modemStandard=modemStandard, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, atpcIndex=atpcIndex, radioGenStatus=radioGenStatus, radioRxFrequency=radioRxFrequency, modemSymbolRateTx=modemSymbolRateTx, ethTXByteCounterLow=ethTXByteCounterLow, aTPCEntry=aTPCEntry, ethQOSRXQ2Frames=ethQOSRXQ2Frames, saf=saf, modemACMmodulationMin=modemACMmodulationMin, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXPrevPktDropped=ethRXPrevPktDropped, e1t1LOS=e1t1LOS, e1t1StatEntry=e1t1StatEntry, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioRxLevel=radioRxLevel, modemSymbolRateRx=modemSymbolRateRx, product=product, vlanRowStatus=vlanRowStatus, modemStatistics=modemStatistics, modemBandwith=modemBandwith, ipRadioCfgNetwork=ipRadioCfgNetwork, ipRadioStatEth=ipRadioStatEth, modemEntry=modemEntry, safip=safip, ethTXBroadcasts=ethTXBroadcasts, modemLastAcqError=modemLastAcqError, ethTXBackpresEvents=ethTXBackpresEvents, ethQOSTXFrames=ethQOSTXFrames, radioLoopback=radioLoopback, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, vlanCfgStat=vlanCfgStat, ethRXDvEvent=ethRXDvEvent, modemACMmodulationMax=modemACMmodulationMax, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXUnderruns=ethTXUnderruns, modemTotalCapacity=modemTotalCapacity, modemE1T1ChannelMask=modemE1T1ChannelMask, modemInternalAGCgain=modemInternalAGCgain, radioTxMute=radioTxMute, ethRXByteCounterHi=ethRXByteCounterHi, localIp=localIp, ipRadio=ipRadio, modemE1T1Channels=modemE1T1Channels, modemErroredSecondRatio=modemErroredSecondRatio, vlanFid=vlanFid, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ipRadioMgmt=ipRadioMgmt, modemTable=modemTable, ethRXLongEvents=ethRXLongEvents, ethTXCollisions=ethTXCollisions, loopback_tributary_mask=loopback_tributary_mask, sysDateAndTime=sysDateAndTime, modemUnavailtime=modemUnavailtime, ethTXGiants=ethTXGiants, ethRXBroadcasts=ethRXBroadcasts, ethRXDones=ethRXDones, ethTXPauseFrames=ethTXPauseFrames, ethRXUnsupOpcodes=ethRXUnsupOpcodes, loopbacks=loopbacks, microwaveRadio=microwaveRadio, ethRXTruncatedFrames=ethRXTruncatedFrames, atpcEnabled=atpcEnabled, ethGFPDropedFrames=ethGFPDropedFrames, modemCountTime=modemCountTime, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, vlanNumber=vlanNumber, ethTXByteCounterHi=ethTXByteCounterHi, ethRXDribleNibbles=ethRXDribleNibbles, e1t1AIS=e1t1AIS, ethTXCRCErrors=ethTXCRCErrors, ipRadioStat=ipRadioStat, ethRXPauseFrames=ethRXPauseFrames, remoteIp=remoteIp, ethRXControlFrames=ethRXControlFrames, modemLDPCdecoderStress=modemLDPCdecoderStress, radioTable=radioTable, vlanEntry=vlanEntry, vlansEnabled=vlansEnabled, modemGeneralStatus=modemGeneralStatus, vlanPortmap=vlanPortmap, modemIndex=modemIndex, radioDuplexShift=radioDuplexShift, ethRXCRCErrors=ethRXCRCErrors, description=description, modemModulation=modemModulation, ethTXDones=ethTXDones, ethGFPCHECErrors=ethGFPCHECErrors, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXVlanTags=ethTXVlanTags, modemUptime=modemUptime, e1t1StatTable=e1t1StatTable, e1t1ChannelNr=e1t1ChannelNr, sysTemperature=sysTemperature, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, pointToPoint=pointToPoint, vlanPortType=vlanPortType, ethGFPFCSErrors=ethGFPFCSErrors, modemEthernetCapacity=modemEthernetCapacity, radioTxPower=radioTxPower, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemACMengine=modemACMengine, radioSide=radioSide, ethRXMulticasts=ethRXMulticasts)
