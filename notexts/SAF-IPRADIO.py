...
mibBuilder.exportSymbols("SAF-IPRADIO", licenseMask=licenseMask, restartcpu=restartcpu, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXCodeErrors=ethRXCodeErrors, modemLastAcqError=modemLastAcqError, vlanTable=vlanTable, e1t1LOS=e1t1LOS, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXDvEvent=ethRXDvEvent, aTPCEntry=aTPCEntry, ethTXVlanTags=ethTXVlanTags, modemStandard=modemStandard, ipRadioCfgNetwork=ipRadioCfgNetwork, radioEntry=radioEntry, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXDones=ethTXDones, modemE1T1Channels=modemE1T1Channels, radioLoopback=radioLoopback, ethTXByteCounterLow=ethTXByteCounterLow, ethTXWireByteCounterHi=ethTXWireByteCounterHi, localIp=localIp, ipRadioStatEth=ipRadioStatEth, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXByteCounterLow=ethRXByteCounterLow, hostname=hostname, remoteIp=remoteIp, modemTotalCapacity=modemTotalCapacity, ethTXPauseFrames=ethTXPauseFrames, ethTXCRCErrors=ethTXCRCErrors, modemGeneralStatus=modemGeneralStatus, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemRadialMSE=modemRadialMSE, writeConfig=writeConfig, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, license=license, modemUptime=modemUptime, atpcTxPowerCorrection=atpcTxPowerCorrection, modemUnavailtime=modemUnavailtime, modemACMengine=modemACMengine, vlansEnabled=vlansEnabled, atpcEnabled=atpcEnabled, modemErroredBlock=modemErroredBlock, ethTXGiants=ethTXGiants, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXCollisions=ethTXCollisions, modemErroredSecond=modemErroredSecond, modemACMtotalCapacity=modemACMtotalCapacity, ethTXLateCollisions=ethTXLateCollisions, modemBandwith=modemBandwith, ethRXByteCounterHi=ethRXByteCounterHi, aTPCTable=aTPCTable, saf=saf, modemACMethernetCapacity=modemACMethernetCapacity, ethTXBackpresEvents=ethTXBackpresEvents, modemSymbolRateRx=modemSymbolRateRx, ethRXControlFrames=ethRXControlFrames, ethGFPFCSErrors=ethGFPFCSErrors, vlanEntry=vlanEntry, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemE1T1ChannelMask=modemE1T1ChannelMask, radioTable=radioTable, modemErroredSecondRatio=modemErroredSecondRatio, radioTxFrequency=radioTxFrequency, modemACMmodulationMin=modemACMmodulationMin, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXPauseFrames=ethRXPauseFrames, licenseUpdateStatus=licenseUpdateStatus, radioSide=radioSide, ethTXByteCounterHi=ethTXByteCounterHi, radioTxPower=radioTxPower, modemAcqStatus=modemAcqStatus, description=description, modemTotalBlockNumber=modemTotalBlockNumber, vlanFid=vlanFid, modemModulation=modemModulation, ethTXControlFrames=ethTXControlFrames, modemIndex=modemIndex, radioRxFrequency=radioRxFrequency, vlanCfgStat=vlanCfgStat, modemEthernetCapacity=modemEthernetCapacity, modemRowStatus=modemRowStatus, ethQOSTXDropped=ethQOSTXDropped, ethGFPDropedFrames=ethGFPDropedFrames, radioGenStatus=radioGenStatus, e1t1StatEntry=e1t1StatEntry, modemInternalAGCgain=modemInternalAGCgain, e1t1StatTable=e1t1StatTable, ipRadio=ipRadio, modemTable=modemTable, atpcIndex=atpcIndex, ethGFPDelineationErrors=ethGFPDelineationErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioDuplexShift=radioDuplexShift, vlanRowStatus=vlanRowStatus, radioIndex=radioIndex, modemACMmodulationMax=modemACMmodulationMax, ethQOSTXFrames=ethQOSTXFrames, ethRXCRCErrors=ethRXCRCErrors, product=product, ethRXMulticasts=ethRXMulticasts, ethRXDones=ethRXDones, pointToPoint=pointToPoint, loopbacks=loopbacks, modemStatistics=modemStatistics, localIpMask=localIpMask, modemCarrierOffset=modemCarrierOffset, modemEntry=modemEntry, modemLDPCdecoderStress=modemLDPCdecoderStress, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ipRadioMgmt=ipRadioMgmt, modemCountTime=modemCountTime, ipRadioStat=ipRadioStat, ethTXWireByteCounterLow=ethTXWireByteCounterLow, safip=safip, ethTXExcessiveDefers=ethTXExcessiveDefers, modemSymbolRateTx=modemSymbolRateTx, sysTemperature=sysTemperature, ipRadioCfg=ipRadioCfg, radioTxMute=radioTxMute, ethRXDribleNibbles=ethRXDribleNibbles, ethTXBroadcasts=ethTXBroadcasts, ethGFPCHECErrors=ethGFPCHECErrors, e1t1ChannelNr=e1t1ChannelNr, vlanNumber=vlanNumber, microwaveRadio=microwaveRadio, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioRxLevel=radioRxLevel, tehnika=tehnika, loopback_tributary_mask=loopback_tributary_mask, ethTXUnderruns=ethTXUnderruns, ethTXMaxCollisions=ethTXMaxCollisions, vlanPortType=vlanPortType, vlanPortmap=vlanPortmap, ethRXBroadcasts=ethRXBroadcasts, sysDateAndTime=sysDateAndTime, ethRXLongEvents=ethRXLongEvents, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXMulticasts=ethTXMulticasts, ethTXLengthCheckErrors=ethTXLengthCheckErrors, e1t1AIS=e1t1AIS)
