...
mibBuilder.exportSymbols("SAF-IPRADIO", modemSymbolRateRx=modemSymbolRateRx, remoteIp=remoteIp, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXCodeErrors=ethRXCodeErrors, ethTXGiants=ethTXGiants, atpcTxPowerCorrection=atpcTxPowerCorrection, modemTotalCapacity=modemTotalCapacity, radioTable=radioTable, modemACMethernetCapacity=modemACMethernetCapacity, hostname=hostname, localIp=localIp, modemErroredSecond=modemErroredSecond, ipRadio=ipRadio, radioLoopback=radioLoopback, ethTXControlFrames=ethTXControlFrames, ethTXMulticasts=ethTXMulticasts, ethTXCRCErrors=ethTXCRCErrors, ipRadioStatEth=ipRadioStatEth, modemEthernetCapacity=modemEthernetCapacity, modemRowStatus=modemRowStatus, licenseMask=licenseMask, modemTable=modemTable, modemModulation=modemModulation, ethTXUnderruns=ethTXUnderruns, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, safip=safip, radioEntry=radioEntry, modemACMtotalCapacity=modemACMtotalCapacity, ethRXByteCounterHi=ethRXByteCounterHi, ethRXDvEvent=ethRXDvEvent, radioRxFrequency=radioRxFrequency, modemTotalBlockNumber=modemTotalBlockNumber, ethRXCRCErrors=ethRXCRCErrors, modemAcqStatus=modemAcqStatus, modemLDPCdecoderStress=modemLDPCdecoderStress, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethQOSTXDropped=ethQOSTXDropped, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXControlFrames=ethRXControlFrames, radioGenStatus=radioGenStatus, vlanEntry=vlanEntry, radioIndex=radioIndex, modemACMmodulationMax=modemACMmodulationMax, sysTemperature=sysTemperature, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemSymbolRateTx=modemSymbolRateTx, ethTXPauseFrames=ethTXPauseFrames, modemGeneralStatus=modemGeneralStatus, e1t1StatEntry=e1t1StatEntry, writeConfig=writeConfig, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, restartcpu=restartcpu, vlanTable=vlanTable, aTPCTable=aTPCTable, ethGFPDelineationErrors=ethGFPDelineationErrors, modemE1T1ChannelMask=modemE1T1ChannelMask, radioDuplexShift=radioDuplexShift, ethTXByteCounterLow=ethTXByteCounterLow, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioRxLevel=radioRxLevel, modemInternalAGCgain=modemInternalAGCgain, description=description, radioTxMute=radioTxMute, ethTXLateCollisions=ethTXLateCollisions, product=product, ethTXByteCounterHi=ethTXByteCounterHi, modemErroredBlock=modemErroredBlock, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, atpcIndex=atpcIndex, tehnika=tehnika, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemCarrierOffset=modemCarrierOffset, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadioCfg=ipRadioCfg, aTPCEntry=aTPCEntry, vlanFid=vlanFid, vlanNumber=vlanNumber, ethGFPDropedFrames=ethGFPDropedFrames, e1t1StatTable=e1t1StatTable, radioTxFrequency=radioTxFrequency, modemErroredSecondRatio=modemErroredSecondRatio, ethQOSTXFrames=ethQOSTXFrames, modemUnavailtime=modemUnavailtime, e1t1ChannelNr=e1t1ChannelNr, e1t1AIS=e1t1AIS, modemUptime=modemUptime, ethRXPrevPktDropped=ethRXPrevPktDropped, ethGFPFCSErrors=ethGFPFCSErrors, license=license, ethRXDones=ethRXDones, ethTXBroadcasts=ethTXBroadcasts, modemStatistics=modemStatistics, ethRXDribleNibbles=ethRXDribleNibbles, licenseUpdateStatus=licenseUpdateStatus, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXPauseFrames=ethRXPauseFrames, vlanCfgStat=vlanCfgStat, ethTXVlanTags=ethTXVlanTags, ethTXBackpresEvents=ethTXBackpresEvents, modemIndex=modemIndex, modemE1T1Channels=modemE1T1Channels, modemACMengine=modemACMengine, modemEntry=modemEntry, loopbacks=loopbacks, ipRadioStat=ipRadioStat, radioTxPower=radioTxPower, sysDateAndTime=sysDateAndTime, e1t1LOS=e1t1LOS, pointToPoint=pointToPoint, modemACMmodulationMin=modemACMmodulationMin, ethTXLengthCheckErrors=ethTXLengthCheckErrors, microwaveRadio=microwaveRadio, ethRXMulticasts=ethRXMulticasts, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemRadialMSE=modemRadialMSE, modemBandwith=modemBandwith, ethGFPCHECErrors=ethGFPCHECErrors, ethRXByteCounterLow=ethRXByteCounterLow, ethTXCollisions=ethTXCollisions, vlanPortType=vlanPortType, ethRXBroadcasts=ethRXBroadcasts, modemCountTime=modemCountTime, vlanPortmap=vlanPortmap, ipRadioMgmt=ipRadioMgmt, atpcEnabled=atpcEnabled, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXMaxCollisions=ethTXMaxCollisions, ethTXExcessiveDefers=ethTXExcessiveDefers, ipRadioCfgNetwork=ipRadioCfgNetwork, vlanRowStatus=vlanRowStatus, loopback_tributary_mask=loopback_tributary_mask, vlansEnabled=vlansEnabled, ethTXDones=ethTXDones, modemLastAcqError=modemLastAcqError, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemStandard=modemStandard, saf=saf, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioSide=radioSide, localIpMask=localIpMask, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXLongEvents=ethRXLongEvents)
