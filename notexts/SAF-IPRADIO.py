...
mibBuilder.exportSymbols("SAF-IPRADIO", radioRxFrequency=radioRxFrequency, restartcpu=restartcpu, licenseUpdateStatus=licenseUpdateStatus, atpcTxPowerCorrection=atpcTxPowerCorrection, e1t1LOS=e1t1LOS, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, e1t1StatEntry=e1t1StatEntry, modemRadialMSE=modemRadialMSE, vlansEnabled=vlansEnabled, modemE1T1ChannelMask=modemE1T1ChannelMask, ethQOSTXFrames=ethQOSTXFrames, vlanNumber=vlanNumber, saf=saf, ethRXPauseFrames=ethRXPauseFrames, ethRXCRCErrors=ethRXCRCErrors, product=product, vlanCfgStat=vlanCfgStat, ipRadioStatEth=ipRadioStatEth, ethTXUnderruns=ethTXUnderruns, description=description, modemTotalCapacity=modemTotalCapacity, writeConfig=writeConfig, ipRadioCfgGeneral=ipRadioCfgGeneral, radioLoopback=radioLoopback, modemACMengine=modemACMengine, hostname=hostname, ethGFPCHECErrors=ethGFPCHECErrors, vlanRowStatus=vlanRowStatus, radioTxMute=radioTxMute, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, loopback_tributary_mask=loopback_tributary_mask, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXLongEvents=ethRXLongEvents, ethTXLateCollisions=ethTXLateCollisions, modemStandard=modemStandard, modemBandwith=modemBandwith, aTPCEntry=aTPCEntry, ipRadioCfg=ipRadioCfg, ethRXMulticasts=ethRXMulticasts, ethTXExcessiveDefers=ethTXExcessiveDefers, modemSymbolRateTx=modemSymbolRateTx, license=license, e1t1StatTable=e1t1StatTable, radioGenStatus=radioGenStatus, ethTXCollisions=ethTXCollisions, modemEthernetCapacity=modemEthernetCapacity, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXByteCounterHi=ethRXByteCounterHi, ethRXByteCounterLow=ethRXByteCounterLow, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXControlFrames=ethTXControlFrames, vlanPortType=vlanPortType, ethTXMaxCollisions=ethTXMaxCollisions, sysDateAndTime=sysDateAndTime, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemGeneralStatus=modemGeneralStatus, modemModulation=modemModulation, modemInternalAGCgain=modemInternalAGCgain, modemTotalBlockNumber=modemTotalBlockNumber, ipRadioMgmt=ipRadioMgmt, ethTXPauseFrames=ethTXPauseFrames, radioDuplexShift=radioDuplexShift, sysTemperature=sysTemperature, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethGFPDropedFrames=ethGFPDropedFrames, ethQOSTXDropped=ethQOSTXDropped, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXByteCounterLow=ethTXByteCounterLow, pointToPoint=pointToPoint, safip=safip, modemRowStatus=modemRowStatus, modemErroredSecondRatio=modemErroredSecondRatio, radioSide=radioSide, modemAcqStatus=modemAcqStatus, modemACMtotalCapacity=modemACMtotalCapacity, vlanFid=vlanFid, modemACMmodulationMin=modemACMmodulationMin, vlanEntry=vlanEntry, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, aTPCTable=aTPCTable, licenseMask=licenseMask, atpcEnabled=atpcEnabled, modemE1T1Channels=modemE1T1Channels, localIpMask=localIpMask, modemUnavailtime=modemUnavailtime, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXGiants=ethTXGiants, radioTable=radioTable, modemStatistics=modemStatistics, ethGFPFCSErrors=ethGFPFCSErrors, localIp=localIp, ipRadioStat=ipRadioStat, ipRadio=ipRadio, modemTable=modemTable, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXVlanTags=ethTXVlanTags, ethRXCodeErrors=ethRXCodeErrors, modemLastAcqError=modemLastAcqError, modemErroredSecond=modemErroredSecond, modemErroredBlock=modemErroredBlock, modemCountTime=modemCountTime, ethTXCRCErrors=ethTXCRCErrors, ethRXBroadcasts=ethRXBroadcasts, vlanTable=vlanTable, e1t1AIS=e1t1AIS, radioIndex=radioIndex, ethRXDvEvent=ethRXDvEvent, modemACMmodulationMax=modemACMmodulationMax, ethGFPDelineationErrors=ethGFPDelineationErrors, loopbacks=loopbacks, modemACMethernetCapacity=modemACMethernetCapacity, ethTXMulticasts=ethTXMulticasts, modemCarrierOffset=modemCarrierOffset, modemBackgroundBlockErrror=modemBackgroundBlockErrror, atpcIndex=atpcIndex, tehnika=tehnika, ethTXBroadcasts=ethTXBroadcasts, ethRXDribleNibbles=ethRXDribleNibbles, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXControlFrames=ethRXControlFrames, modemIndex=modemIndex, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXVlanTagsDetected=ethRXVlanTagsDetected, vlanPortmap=vlanPortmap, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXByteCounterHi=ethTXByteCounterHi, modemEntry=modemEntry, modemSymbolRateRx=modemSymbolRateRx, ethTXDones=ethTXDones, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, modemUptime=modemUptime, microwaveRadio=microwaveRadio, remoteIp=remoteIp, radioRxLevel=radioRxLevel, radioTxPower=radioTxPower, radioTxFrequency=radioTxFrequency, e1t1ChannelNr=e1t1ChannelNr, radioEntry=radioEntry, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXDones=ethRXDones, ethTXBackpresEvents=ethTXBackpresEvents)
