...
mibBuilder.exportSymbols("SAF-IPRADIO", modemModulation=modemModulation, ipRadioStat=ipRadioStat, modemErroredSecond=modemErroredSecond, vlansEnabled=vlansEnabled, pointToPoint=pointToPoint, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemIndex=modemIndex, vlanEntry=vlanEntry, radioIndex=radioIndex, ipRadioMgmt=ipRadioMgmt, ipRadio=ipRadio, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, licenseMask=licenseMask, modemTotalBlockNumber=modemTotalBlockNumber, ethRXBroadcasts=ethRXBroadcasts, hostname=hostname, vlanPortmap=vlanPortmap, ethRXDones=ethRXDones, ethTXMulticasts=ethTXMulticasts, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXCodeErrors=ethRXCodeErrors, modemUnavailtime=modemUnavailtime, ethTXCollisions=ethTXCollisions, licenseUpdateStatus=licenseUpdateStatus, tehnika=tehnika, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXMulticasts=ethRXMulticasts, radioTxFrequency=radioTxFrequency, ethTXLateCollisions=ethTXLateCollisions, loopbacks=loopbacks, aTPCTable=aTPCTable, modemUptime=modemUptime, radioRxFrequency=radioRxFrequency, safip=safip, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemErroredSecondRatio=modemErroredSecondRatio, ethTXPauseFrames=ethTXPauseFrames, vlanNumber=vlanNumber, modemErroredBlock=modemErroredBlock, ethTXByteCounterHi=ethTXByteCounterHi, localIp=localIp, radioTxPower=radioTxPower, aTPCEntry=aTPCEntry, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, microwaveRadio=microwaveRadio, ethTXBackpresEvents=ethTXBackpresEvents, radioTxMute=radioTxMute, atpcIndex=atpcIndex, remoteIp=remoteIp, e1t1ChannelNr=e1t1ChannelNr, e1t1AIS=e1t1AIS, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXBroadcasts=ethTXBroadcasts, radioEntry=radioEntry, e1t1StatTable=e1t1StatTable, modemACMtotalCapacity=modemACMtotalCapacity, ethQOSTXDropped=ethQOSTXDropped, ethTXUnderruns=ethTXUnderruns, vlanPortType=vlanPortType, vlanTable=vlanTable, ipRadioCfgGeneral=ipRadioCfgGeneral, modemInternalAGCgain=modemInternalAGCgain, description=description, modemRowStatus=modemRowStatus, ethTXCRCErrors=ethTXCRCErrors, radioLoopback=radioLoopback, ethGFPCHECErrors=ethGFPCHECErrors, vlanFid=vlanFid, vlanCfgStat=vlanCfgStat, modemCountTime=modemCountTime, modemACMmodulationMin=modemACMmodulationMin, modemTotalCapacity=modemTotalCapacity, modemSymbolRateTx=modemSymbolRateTx, modemEntry=modemEntry, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXControlFrames=ethRXControlFrames, saf=saf, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXMaxCollisions=ethTXMaxCollisions, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXVlanTags=ethTXVlanTags, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, sysDateAndTime=sysDateAndTime, writeConfig=writeConfig, ethRXByteCounterLow=ethRXByteCounterLow, modemGeneralStatus=modemGeneralStatus, modemTable=modemTable, ethRXCRCErrors=ethRXCRCErrors, modemAcqStatus=modemAcqStatus, modemACMmodulationMax=modemACMmodulationMax, modemCarrierOffset=modemCarrierOffset, radioGenStatus=radioGenStatus, modemE1T1Channels=modemE1T1Channels, e1t1LOS=e1t1LOS, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXControlFrames=ethTXControlFrames, ethRXDvEvent=ethRXDvEvent, restartcpu=restartcpu, loopback_tributary_mask=loopback_tributary_mask, ethQOSTXFrames=ethQOSTXFrames, modemStandard=modemStandard, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXByteCounterHi=ethRXByteCounterHi, ethTXGiants=ethTXGiants, ethRXLongEvents=ethRXLongEvents, ethRXDribleNibbles=ethRXDribleNibbles, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, atpcEnabled=atpcEnabled, product=product, ethTXByteCounterLow=ethTXByteCounterLow, modemLastAcqError=modemLastAcqError, ethTXDones=ethTXDones, radioDuplexShift=radioDuplexShift, localIpMask=localIpMask, modemSymbolRateRx=modemSymbolRateRx, ipRadioCfg=ipRadioCfg, sysTemperature=sysTemperature, modemBandwith=modemBandwith, modemEthernetCapacity=modemEthernetCapacity, ipRadioStatEth=ipRadioStatEth, vlanRowStatus=vlanRowStatus, ethRXTruncatedFrames=ethRXTruncatedFrames, modemRadialMSE=modemRadialMSE, radioSide=radioSide, radioTable=radioTable, license=license, ethGFPFCSErrors=ethGFPFCSErrors, modemACMengine=modemACMengine, modemE1T1ChannelMask=modemE1T1ChannelMask, modemStatistics=modemStatistics, radioRxLevel=radioRxLevel, ethGFPDropedFrames=ethGFPDropedFrames, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemACMethernetCapacity=modemACMethernetCapacity, ethTXWireByteCounterLow=ethTXWireByteCounterLow, e1t1StatEntry=e1t1StatEntry, ethRXPauseFrames=ethRXPauseFrames, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped)
