...
mibBuilder.exportSymbols("SAF-IPRADIO", modemInternalAGCgain=modemInternalAGCgain, modemRowStatus=modemRowStatus, radioDuplexShift=radioDuplexShift, ethGFPFCSErrors=ethGFPFCSErrors, vlanPortmap=vlanPortmap, hostname=hostname, ipRadioStat=ipRadioStat, modemTotalBlockNumber=modemTotalBlockNumber, vlanPortType=vlanPortType, ethTXUnderruns=ethTXUnderruns, radioTxMute=radioTxMute, modemCarrierOffset=modemCarrierOffset, product=product, ethTXDones=ethTXDones, modemEntry=modemEntry, pointToPoint=pointToPoint, ethTXByteCounterLow=ethTXByteCounterLow, radioSide=radioSide, tehnika=tehnika, e1t1ChannelNr=e1t1ChannelNr, ethRXControlFrames=ethRXControlFrames, radioTable=radioTable, radioEntry=radioEntry, ethTXGiants=ethTXGiants, ipRadioMgmt=ipRadioMgmt, ethTXBackpresEvents=ethTXBackpresEvents, aTPCEntry=aTPCEntry, ethTXCollisions=ethTXCollisions, aTPCTable=aTPCTable, radioIndex=radioIndex, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, e1t1AIS=e1t1AIS, ethRXTruncatedFrames=ethRXTruncatedFrames, modemBandwith=modemBandwith, ethTXControlFrames=ethTXControlFrames, ipRadioCfgNetwork=ipRadioCfgNetwork, modemE1T1Channels=modemE1T1Channels, modemLastAcqError=modemLastAcqError, localIpMask=localIpMask, ethRXCRCErrors=ethRXCRCErrors, modemSymbolRateRx=modemSymbolRateRx, vlansEnabled=vlansEnabled, e1t1StatEntry=e1t1StatEntry, modemTable=modemTable, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXLongEvents=ethRXLongEvents, description=description, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioGenStatus=radioGenStatus, modemErroredSecondRatio=modemErroredSecondRatio, vlanNumber=vlanNumber, e1t1LOS=e1t1LOS, ethGFPDropedFrames=ethGFPDropedFrames, ethTXLengthCheckErrors=ethTXLengthCheckErrors, localIp=localIp, ethTXExcessiveDefers=ethTXExcessiveDefers, atpcEnabled=atpcEnabled, modemAcqStatus=modemAcqStatus, ethRXDribleNibbles=ethRXDribleNibbles, saf=saf, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemIndex=modemIndex, modemErroredSecond=modemErroredSecond, ethGFPCHECErrors=ethGFPCHECErrors, ethRXPauseFrames=ethRXPauseFrames, modemACMmodulationMin=modemACMmodulationMin, ethQOSTXDropped=ethQOSTXDropped, ethRXDones=ethRXDones, ipRadioStatEth=ipRadioStatEth, vlanTable=vlanTable, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXByteCounterHi=ethRXByteCounterHi, modemGeneralStatus=modemGeneralStatus, vlanRowStatus=vlanRowStatus, modemACMmodulationMax=modemACMmodulationMax, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXBroadcasts=ethRXBroadcasts, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemLDPCdecoderStress=modemLDPCdecoderStress, ipRadioCfg=ipRadioCfg, modemUnavailtime=modemUnavailtime, license=license, ethRXByteCounterLow=ethRXByteCounterLow, ethTXByteCounterHi=ethTXByteCounterHi, ethTXMaxCollisions=ethTXMaxCollisions, radioRxLevel=radioRxLevel, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXMulticasts=ethRXMulticasts, ethQOSTXFrames=ethQOSTXFrames, ethTXWireByteCounterHi=ethTXWireByteCounterHi, loopbacks=loopbacks, microwaveRadio=microwaveRadio, radioTxPower=radioTxPower, ethQOSRXQ2Frames=ethQOSRXQ2Frames, remoteIp=remoteIp, modemACMengine=modemACMengine, radioLoopback=radioLoopback, e1t1StatTable=e1t1StatTable, sysTemperature=sysTemperature, ethTXCRCErrors=ethTXCRCErrors, modemUptime=modemUptime, ethTXPauseFrames=ethTXPauseFrames, modemErroredBlock=modemErroredBlock, sysDateAndTime=sysDateAndTime, radioRxFrequency=radioRxFrequency, modemSymbolRateTx=modemSymbolRateTx, modemCountTime=modemCountTime, ethRXCodeErrors=ethRXCodeErrors, modemACMtotalCapacity=modemACMtotalCapacity, licenseUpdateStatus=licenseUpdateStatus, ethTXWireByteCounterLow=ethTXWireByteCounterLow, writeConfig=writeConfig, ethTXLateCollisions=ethTXLateCollisions, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, atpcIndex=atpcIndex, ethRXUnsupOpcodes=ethRXUnsupOpcodes, restartcpu=restartcpu, atpcTxPowerCorrection=atpcTxPowerCorrection, vlanCfgStat=vlanCfgStat, modemEthernetCapacity=modemEthernetCapacity, ethTXVlanTags=ethTXVlanTags, licenseMask=licenseMask, modemRadialMSE=modemRadialMSE, ipRadioCfgGeneral=ipRadioCfgGeneral, modemTotalCapacity=modemTotalCapacity, modemACMethernetCapacity=modemACMethernetCapacity, ethRXDvEvent=ethRXDvEvent, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXPrevPktDropped=ethRXPrevPktDropped, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXMulticasts=ethTXMulticasts, radioTxFrequency=radioTxFrequency, modemStatistics=modemStatistics, ethTXBroadcasts=ethTXBroadcasts, safip=safip, ipRadio=ipRadio, loopback_tributary_mask=loopback_tributary_mask, vlanFid=vlanFid, modemStandard=modemStandard, ethGFPDelineationErrors=ethGFPDelineationErrors, vlanEntry=vlanEntry, modemModulation=modemModulation)
