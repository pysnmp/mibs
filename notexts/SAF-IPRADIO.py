...
mibBuilder.exportSymbols("SAF-IPRADIO", ethGFPDropedFrames=ethGFPDropedFrames, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemTotalBlockNumber=modemTotalBlockNumber, ethRXLongEvents=ethRXLongEvents, ethTXMulticasts=ethTXMulticasts, localIpMask=localIpMask, vlansEnabled=vlansEnabled, ethTXByteCounterLow=ethTXByteCounterLow, modemACMmodulationMax=modemACMmodulationMax, radioTxMute=radioTxMute, ethGFPFCSErrors=ethGFPFCSErrors, modemAcqStatus=modemAcqStatus, ethTXLateCollisions=ethTXLateCollisions, ethGFPCHECErrors=ethGFPCHECErrors, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, remoteIp=remoteIp, modemCarrierOffset=modemCarrierOffset, ethRXDones=ethRXDones, modemACMtotalCapacity=modemACMtotalCapacity, modemRowStatus=modemRowStatus, modemLastAcqError=modemLastAcqError, ipRadioCfgNetwork=ipRadioCfgNetwork, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXPauseFrames=ethTXPauseFrames, ethRXBroadcasts=ethRXBroadcasts, sysTemperature=sysTemperature, ethQOSTXDropped=ethQOSTXDropped, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, sysDateAndTime=sysDateAndTime, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemSymbolRateTx=modemSymbolRateTx, ethTXControlFrames=ethTXControlFrames, modemTable=modemTable, ethRXDribleNibbles=ethRXDribleNibbles, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXCollisions=ethTXCollisions, vlanPortType=vlanPortType, ethRXVlanTagsDetected=ethRXVlanTagsDetected, microwaveRadio=microwaveRadio, aTPCEntry=aTPCEntry, radioEntry=radioEntry, modemSymbolRateRx=modemSymbolRateRx, ipRadioStatEth=ipRadioStatEth, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemRadialMSE=modemRadialMSE, modemE1T1ChannelMask=modemE1T1ChannelMask, restartcpu=restartcpu, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemEthernetCapacity=modemEthernetCapacity, ipRadioMgmt=ipRadioMgmt, ethTXVlanTags=ethTXVlanTags, ethTXGiants=ethTXGiants, modemACMethernetCapacity=modemACMethernetCapacity, ethTXLengthCheckErrors=ethTXLengthCheckErrors, radioLoopback=radioLoopback, licenseUpdateStatus=licenseUpdateStatus, ipRadioCfg=ipRadioCfg, radioGenStatus=radioGenStatus, modemInternalAGCgain=modemInternalAGCgain, vlanCfgStat=vlanCfgStat, modemUptime=modemUptime, e1t1ChannelNr=e1t1ChannelNr, e1t1AIS=e1t1AIS, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemE1T1Channels=modemE1T1Channels, ethRXByteCounterLow=ethRXByteCounterLow, ethRXDvEvent=ethRXDvEvent, modemBandwith=modemBandwith, modemErroredBlock=modemErroredBlock, ethRXByteCounterHi=ethRXByteCounterHi, atpcIndex=atpcIndex, writeConfig=writeConfig, modemACMmodulationMin=modemACMmodulationMin, ethQOSTXFrames=ethQOSTXFrames, product=product, ethRXPauseFrames=ethRXPauseFrames, radioDuplexShift=radioDuplexShift, vlanPortmap=vlanPortmap, aTPCTable=aTPCTable, ethGFPDelineationErrors=ethGFPDelineationErrors, e1t1StatTable=e1t1StatTable, modemEntry=modemEntry, ethRXCodeErrors=ethRXCodeErrors, radioRxLevel=radioRxLevel, loopback_tributary_mask=loopback_tributary_mask, ethTXMaxCollisions=ethTXMaxCollisions, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXDones=ethTXDones, atpcEnabled=atpcEnabled, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXCRCErrors=ethTXCRCErrors, modemACMengine=modemACMengine, modemStandard=modemStandard, ethRXPrevPktDropped=ethRXPrevPktDropped, modemErroredSecond=modemErroredSecond, radioRxFrequency=radioRxFrequency, tehnika=tehnika, ethTXExcessiveDefers=ethTXExcessiveDefers, radioTxFrequency=radioTxFrequency, vlanFid=vlanFid, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, localIp=localIp, ipRadioCfgGeneral=ipRadioCfgGeneral, ipRadioStat=ipRadioStat, ethTXBroadcasts=ethTXBroadcasts, modemStatistics=modemStatistics, modemModulation=modemModulation, radioIndex=radioIndex, loopbacks=loopbacks, vlanEntry=vlanEntry, modemUnavailtime=modemUnavailtime, hostname=hostname, licenseMask=licenseMask, modemIndex=modemIndex, modemGeneralStatus=modemGeneralStatus, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, vlanNumber=vlanNumber, modemCountTime=modemCountTime, description=description, safip=safip, radioTable=radioTable, modemTotalCapacity=modemTotalCapacity, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXCRCErrors=ethRXCRCErrors, saf=saf, ethRXTruncatedFrames=ethRXTruncatedFrames, radioTxPower=radioTxPower, modemErroredSecondRatio=modemErroredSecondRatio, pointToPoint=pointToPoint, ipRadio=ipRadio, ethTXUnderruns=ethTXUnderruns, radioSide=radioSide, ethTXByteCounterHi=ethTXByteCounterHi, vlanRowStatus=vlanRowStatus, vlanTable=vlanTable, e1t1LOS=e1t1LOS, ethRXControlFrames=ethRXControlFrames, ethTXBackpresEvents=ethTXBackpresEvents, license=license, ethRXMulticasts=ethRXMulticasts, e1t1StatEntry=e1t1StatEntry, atpcTxPowerCorrection=atpcTxPowerCorrection)
