...
mibBuilder.exportSymbols("SAF-IPRADIO", aTPCEntry=aTPCEntry, vlanPortType=vlanPortType, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemRadialMSE=modemRadialMSE, microwaveRadio=microwaveRadio, pointToPoint=pointToPoint, modemAcqStatus=modemAcqStatus, modemGeneralStatus=modemGeneralStatus, ethTXUnderruns=ethTXUnderruns, ethTXByteCounterLow=ethTXByteCounterLow, modemUptime=modemUptime, modemUnavailtime=modemUnavailtime, ethTXGiants=ethTXGiants, modemModulation=modemModulation, ethTXDones=ethTXDones, modemStandard=modemStandard, writeConfig=writeConfig, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXCodeErrors=ethRXCodeErrors, modemACMengine=modemACMengine, modemCarrierOffset=modemCarrierOffset, modemE1T1Channels=modemE1T1Channels, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemSymbolRateTx=modemSymbolRateTx, ipRadioCfgGeneral=ipRadioCfgGeneral, modemIndex=modemIndex, modemRowStatus=modemRowStatus, ethTXLateCollisions=ethTXLateCollisions, modemBandwith=modemBandwith, ethRXDvEvent=ethRXDvEvent, ethTXCRCErrors=ethTXCRCErrors, radioIndex=radioIndex, ethGFPFCSErrors=ethGFPFCSErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, modemErroredSecondRatio=modemErroredSecondRatio, ethTXCollisions=ethTXCollisions, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemE1T1ChannelMask=modemE1T1ChannelMask, saf=saf, vlanFid=vlanFid, aTPCTable=aTPCTable, radioTable=radioTable, vlanNumber=vlanNumber, modemStatistics=modemStatistics, description=description, modemACMethernetCapacity=modemACMethernetCapacity, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXControlFrames=ethRXControlFrames, tehnika=tehnika, modemCountTime=modemCountTime, ipRadioStatEth=ipRadioStatEth, ethRXLongEvents=ethRXLongEvents, radioEntry=radioEntry, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, e1t1ChannelNr=e1t1ChannelNr, radioDuplexShift=radioDuplexShift, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXPauseFrames=ethTXPauseFrames, modemEntry=modemEntry, ethGFPDelineationErrors=ethGFPDelineationErrors, product=product, ethQOSTXFrames=ethQOSTXFrames, radioSide=radioSide, localIp=localIp, modemErroredBlock=modemErroredBlock, vlanEntry=vlanEntry, hostname=hostname, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadio=ipRadio, e1t1LOS=e1t1LOS, license=license, licenseMask=licenseMask, modemLDPCdecoderStress=modemLDPCdecoderStress, modemACMtotalCapacity=modemACMtotalCapacity, vlanRowStatus=vlanRowStatus, sysTemperature=sysTemperature, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethQOSTXDropped=ethQOSTXDropped, loopback_tributary_mask=loopback_tributary_mask, ethRXPrevPktDropped=ethRXPrevPktDropped, radioLoopback=radioLoopback, modemACMmodulationMin=modemACMmodulationMin, radioTxFrequency=radioTxFrequency, ethRXBroadcasts=ethRXBroadcasts, radioRxFrequency=radioRxFrequency, licenseUpdateStatus=licenseUpdateStatus, modemTotalCapacity=modemTotalCapacity, radioTxMute=radioTxMute, vlanCfgStat=vlanCfgStat, remoteIp=remoteIp, modemLastAcqError=modemLastAcqError, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXDones=ethRXDones, vlanPortmap=vlanPortmap, modemACMmodulationMax=modemACMmodulationMax, ethTXMaxCollisions=ethTXMaxCollisions, ipRadioCfg=ipRadioCfg, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXVlanTags=ethTXVlanTags, ipRadioStat=ipRadioStat, modemEthernetCapacity=modemEthernetCapacity, ethGFPDropedFrames=ethGFPDropedFrames, modemErroredSecond=modemErroredSecond, ethTXBackpresEvents=ethTXBackpresEvents, safip=safip, modemTotalBlockNumber=modemTotalBlockNumber, ipRadioMgmt=ipRadioMgmt, ethGFPCHECErrors=ethGFPCHECErrors, radioTxPower=radioTxPower, modemSymbolRateRx=modemSymbolRateRx, ethTXExcessiveDefers=ethTXExcessiveDefers, e1t1AIS=e1t1AIS, radioRxLevel=radioRxLevel, vlansEnabled=vlansEnabled, radioGenStatus=radioGenStatus, modemTable=modemTable, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXControlFrames=ethTXControlFrames, ethRXByteCounterHi=ethRXByteCounterHi, atpcIndex=atpcIndex, sysDateAndTime=sysDateAndTime, ethRXDribleNibbles=ethRXDribleNibbles, modemInternalAGCgain=modemInternalAGCgain, loopbacks=loopbacks, e1t1StatTable=e1t1StatTable, ethRXPauseFrames=ethRXPauseFrames, vlanTable=vlanTable, ethRXByteCounterLow=ethRXByteCounterLow, ethRXCRCErrors=ethRXCRCErrors, ethRXMulticasts=ethRXMulticasts, restartcpu=restartcpu, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, atpcEnabled=atpcEnabled, ethQOSRXQ2Frames=ethQOSRXQ2Frames, e1t1StatEntry=e1t1StatEntry, ethTXMulticasts=ethTXMulticasts, ethTXBroadcasts=ethTXBroadcasts, ethTXByteCounterHi=ethTXByteCounterHi, ethRXVlanTagsDetected=ethRXVlanTagsDetected, localIpMask=localIpMask)
