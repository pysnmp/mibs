...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXDvEvent=ethRXDvEvent, ethRXDribleNibbles=ethRXDribleNibbles, ethTXLengthCheckErrors=ethTXLengthCheckErrors, sysDateAndTime=sysDateAndTime, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemIndex=modemIndex, ethRXCRCErrors=ethRXCRCErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, product=product, modemStandard=modemStandard, ethGFPDropedFrames=ethGFPDropedFrames, e1t1LOS=e1t1LOS, ipRadioMgmt=ipRadioMgmt, modemGeneralStatus=modemGeneralStatus, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXUnderruns=ethTXUnderruns, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXVlanTags=ethTXVlanTags, remoteIp=remoteIp, ipRadioCfg=ipRadioCfg, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXPauseFrames=ethTXPauseFrames, licenseUpdateStatus=licenseUpdateStatus, modemEthernetCapacity=modemEthernetCapacity, vlanRowStatus=vlanRowStatus, saf=saf, radioIndex=radioIndex, modemStatistics=modemStatistics, ethTXMulticasts=ethTXMulticasts, ipRadioCfgGeneral=ipRadioCfgGeneral, vlanPortType=vlanPortType, modemBandwith=modemBandwith, modemLastAcqError=modemLastAcqError, modemACMtotalCapacity=modemACMtotalCapacity, radioLoopback=radioLoopback, vlanPortmap=vlanPortmap, ethTXControlFrames=ethTXControlFrames, radioSide=radioSide, radioDuplexShift=radioDuplexShift, ethTXExcessiveDefers=ethTXExcessiveDefers, e1t1StatEntry=e1t1StatEntry, ethRXDones=ethRXDones, e1t1AIS=e1t1AIS, description=description, restartcpu=restartcpu, ethTXGiants=ethTXGiants, tehnika=tehnika, vlanTable=vlanTable, loopbacks=loopbacks, modemTotalCapacity=modemTotalCapacity, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemModulation=modemModulation, license=license, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlansEnabled=vlansEnabled, modemUptime=modemUptime, modemErroredSecond=modemErroredSecond, modemCountTime=modemCountTime, modemSymbolRateTx=modemSymbolRateTx, ethQOSTXFrames=ethQOSTXFrames, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, aTPCEntry=aTPCEntry, radioRxFrequency=radioRxFrequency, ethTXCRCErrors=ethTXCRCErrors, pointToPoint=pointToPoint, ethRXByteCounterHi=ethRXByteCounterHi, modemSeverelyErroredSecond=modemSeverelyErroredSecond, sysTemperature=sysTemperature, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, safip=safip, ethTXByteCounterHi=ethTXByteCounterHi, e1t1StatTable=e1t1StatTable, modemRadialMSE=modemRadialMSE, modemUnavailtime=modemUnavailtime, vlanCfgStat=vlanCfgStat, modemACMengine=modemACMengine, modemACMethernetCapacity=modemACMethernetCapacity, ethTXLateCollisions=ethTXLateCollisions, ethTXByteCounterLow=ethTXByteCounterLow, vlanFid=vlanFid, loopback_tributary_mask=loopback_tributary_mask, atpcTxPowerCorrection=atpcTxPowerCorrection, ethQOSTXDropped=ethQOSTXDropped, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemACMmodulationMin=modemACMmodulationMin, ethRXMulticasts=ethRXMulticasts, modemErroredBlock=modemErroredBlock, localIpMask=localIpMask, radioGenStatus=radioGenStatus, licenseMask=licenseMask, ethRXPauseFrames=ethRXPauseFrames, vlanNumber=vlanNumber, modemInternalAGCgain=modemInternalAGCgain, modemTable=modemTable, atpcIndex=atpcIndex, modemE1T1Channels=modemE1T1Channels, radioRxLevel=radioRxLevel, ethRXControlFrames=ethRXControlFrames, radioEntry=radioEntry, ethTXBroadcasts=ethTXBroadcasts, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXPrevPktDropped=ethRXPrevPktDropped, ipRadioStatEth=ipRadioStatEth, radioTable=radioTable, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemAcqStatus=modemAcqStatus, radioTxFrequency=radioTxFrequency, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethGFPDelineationErrors=ethGFPDelineationErrors, vlanEntry=vlanEntry, modemErroredSecondRatio=modemErroredSecondRatio, modemCarrierOffset=modemCarrierOffset, modemSymbolRateRx=modemSymbolRateRx, radioTxMute=radioTxMute, ipRadioCfgNetwork=ipRadioCfgNetwork, writeConfig=writeConfig, ethTXMaxCollisions=ethTXMaxCollisions, ethRXBroadcasts=ethRXBroadcasts, radioTxPower=radioTxPower, localIp=localIp, ethGFPCHECErrors=ethGFPCHECErrors, modemEntry=modemEntry, modemTotalBlockNumber=modemTotalBlockNumber, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXCollisions=ethTXCollisions, atpcEnabled=atpcEnabled, modemACMmodulationMax=modemACMmodulationMax, ethTXDones=ethTXDones, aTPCTable=aTPCTable, ethRXUnsupOpcodes=ethRXUnsupOpcodes, hostname=hostname, ethTXBackpresEvents=ethTXBackpresEvents, ipRadio=ipRadio, ethRXLongEvents=ethRXLongEvents, microwaveRadio=microwaveRadio, ethRXByteCounterLow=ethRXByteCounterLow, ethRXCodeErrors=ethRXCodeErrors, ethGFPFCSErrors=ethGFPFCSErrors, modemRowStatus=modemRowStatus, ipRadioStat=ipRadioStat, e1t1ChannelNr=e1t1ChannelNr)
