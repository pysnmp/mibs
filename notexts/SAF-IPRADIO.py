...
mibBuilder.exportSymbols("SAF-IPRADIO", radioTxPower=radioTxPower, ethRXBroadcasts=ethRXBroadcasts, product=product, ipRadioCfg=ipRadioCfg, licenseUpdateStatus=licenseUpdateStatus, modemTable=modemTable, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioRxLevel=radioRxLevel, ethTXMaxCollisions=ethTXMaxCollisions, modemTotalBlockNumber=modemTotalBlockNumber, modemErroredSecondRatio=modemErroredSecondRatio, ethRXByteCounterLow=ethRXByteCounterLow, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXPrevPktDropped=ethRXPrevPktDropped, e1t1ChannelNr=e1t1ChannelNr, radioTxMute=radioTxMute, vlanFid=vlanFid, modemE1T1ChannelMask=modemE1T1ChannelMask, loopbacks=loopbacks, modemEthernetCapacity=modemEthernetCapacity, ethRXDribleNibbles=ethRXDribleNibbles, ethRXCRCErrors=ethRXCRCErrors, radioGenStatus=radioGenStatus, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXBroadcasts=ethTXBroadcasts, ethRXByteCounterHi=ethRXByteCounterHi, modemSymbolRateRx=modemSymbolRateRx, modemACMmodulationMin=modemACMmodulationMin, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXLateCollisions=ethTXLateCollisions, ipRadioStat=ipRadioStat, ethTXVlanTags=ethTXVlanTags, aTPCEntry=aTPCEntry, vlanPortmap=vlanPortmap, atpcTxPowerCorrection=atpcTxPowerCorrection, radioDuplexShift=radioDuplexShift, saf=saf, modemEntry=modemEntry, radioTable=radioTable, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, e1t1AIS=e1t1AIS, ethTXGiants=ethTXGiants, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, localIpMask=localIpMask, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioTxFrequency=radioTxFrequency, radioEntry=radioEntry, radioIndex=radioIndex, aTPCTable=aTPCTable, ipRadio=ipRadio, ethRXDones=ethRXDones, ethRXDvEvent=ethRXDvEvent, ethGFPFCSErrors=ethGFPFCSErrors, licenseMask=licenseMask, modemACMtotalCapacity=modemACMtotalCapacity, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethQOSRXQ1Frames=ethQOSRXQ1Frames, restartcpu=restartcpu, microwaveRadio=microwaveRadio, ethGFPDelineationErrors=ethGFPDelineationErrors, vlanCfgStat=vlanCfgStat, vlanNumber=vlanNumber, ipRadioMgmt=ipRadioMgmt, modemACMengine=modemACMengine, sysTemperature=sysTemperature, modemInternalAGCgain=modemInternalAGCgain, modemE1T1Channels=modemE1T1Channels, writeConfig=writeConfig, e1t1LOS=e1t1LOS, ethRXControlFrames=ethRXControlFrames, ethTXBackpresEvents=ethTXBackpresEvents, safip=safip, modemRadialMSE=modemRadialMSE, vlanTable=vlanTable, vlanRowStatus=vlanRowStatus, ethTXPauseFrames=ethTXPauseFrames, modemRowStatus=modemRowStatus, ethRXMulticasts=ethRXMulticasts, ethQOSTXDropped=ethQOSTXDropped, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemCarrierOffset=modemCarrierOffset, ethGFPDropedFrames=ethGFPDropedFrames, modemErroredSecond=modemErroredSecond, modemTotalCapacity=modemTotalCapacity, radioRxFrequency=radioRxFrequency, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXUnderruns=ethTXUnderruns, ethTXCRCErrors=ethTXCRCErrors, description=description, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXMulticasts=ethTXMulticasts, ethRXCodeErrors=ethRXCodeErrors, ethRXPauseFrames=ethRXPauseFrames, modemACMmodulationMax=modemACMmodulationMax, ethTXWireByteCounterLow=ethTXWireByteCounterLow, localIp=localIp, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, atpcIndex=atpcIndex, ethGFPCHECErrors=ethGFPCHECErrors, ethRXLongEvents=ethRXLongEvents, modemLastAcqError=modemLastAcqError, sysDateAndTime=sysDateAndTime, modemIndex=modemIndex, e1t1StatTable=e1t1StatTable, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemModulation=modemModulation, vlanEntry=vlanEntry, modemStatistics=modemStatistics, radioSide=radioSide, ethTXCollisions=ethTXCollisions, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXByteCounterLow=ethTXByteCounterLow, e1t1StatEntry=e1t1StatEntry, tehnika=tehnika, ethTXByteCounterHi=ethTXByteCounterHi, ethTXLengthCheckErrors=ethTXLengthCheckErrors, hostname=hostname, modemStandard=modemStandard, modemUptime=modemUptime, vlansEnabled=vlansEnabled, ipRadioStatEth=ipRadioStatEth, modemErroredBlock=modemErroredBlock, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioLoopback=radioLoopback, modemUnavailtime=modemUnavailtime, modemGeneralStatus=modemGeneralStatus, ethTXDones=ethTXDones, vlanPortType=vlanPortType, remoteIp=remoteIp, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXControlFrames=ethTXControlFrames, license=license, pointToPoint=pointToPoint, modemAcqStatus=modemAcqStatus, loopback_tributary_mask=loopback_tributary_mask, modemBandwith=modemBandwith, modemACMethernetCapacity=modemACMethernetCapacity, atpcEnabled=atpcEnabled, modemCountTime=modemCountTime, modemSymbolRateTx=modemSymbolRateTx, ethQOSTXFrames=ethQOSTXFrames)
