...
mibBuilder.exportSymbols("SAF-IPRADIO", ethGFPFCSErrors=ethGFPFCSErrors, modemTotalBlockNumber=modemTotalBlockNumber, sysDateAndTime=sysDateAndTime, vlanPortmap=vlanPortmap, modemACMengine=modemACMengine, vlanPortType=vlanPortType, modemE1T1ChannelMask=modemE1T1ChannelMask, radioLoopback=radioLoopback, atpcIndex=atpcIndex, ethRXByteCounterHi=ethRXByteCounterHi, loopback_tributary_mask=loopback_tributary_mask, vlanNumber=vlanNumber, ipRadioCfgNetwork=ipRadioCfgNetwork, localIpMask=localIpMask, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioTxPower=radioTxPower, tehnika=tehnika, modemErroredSecondRatio=modemErroredSecondRatio, ethTXWireByteCounterLow=ethTXWireByteCounterLow, license=license, hostname=hostname, modemSymbolRateTx=modemSymbolRateTx, ethRXPauseFrames=ethRXPauseFrames, sysTemperature=sysTemperature, ethRXDones=ethRXDones, radioEntry=radioEntry, vlanCfgStat=vlanCfgStat, safip=safip, pointToPoint=pointToPoint, description=description, modemACMmodulationMax=modemACMmodulationMax, modemUnavailtime=modemUnavailtime, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadio=ipRadio, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXDvEvent=ethRXDvEvent, ethQOSTXFrames=ethQOSTXFrames, ethRXByteCounterLow=ethRXByteCounterLow, modemACMmodulationMin=modemACMmodulationMin, ethRXMulticasts=ethRXMulticasts, ethGFPDropedFrames=ethGFPDropedFrames, vlansEnabled=vlansEnabled, ethTXCollisions=ethTXCollisions, e1t1AIS=e1t1AIS, modemErroredBlock=modemErroredBlock, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXBackpresEvents=ethTXBackpresEvents, remoteIp=remoteIp, modemStatistics=modemStatistics, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXPrevPktDropped=ethRXPrevPktDropped, licenseUpdateStatus=licenseUpdateStatus, modemSymbolRateRx=modemSymbolRateRx, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXVlanTags=ethTXVlanTags, ethTXBroadcasts=ethTXBroadcasts, e1t1StatTable=e1t1StatTable, loopbacks=loopbacks, modemEthernetCapacity=modemEthernetCapacity, ethTXCRCErrors=ethTXCRCErrors, localIp=localIp, radioGenStatus=radioGenStatus, radioRxFrequency=radioRxFrequency, ethTXUnderruns=ethTXUnderruns, ethQOSTXDropped=ethQOSTXDropped, modemAcqStatus=modemAcqStatus, modemTable=modemTable, modemUptime=modemUptime, ethTXMaxCollisions=ethTXMaxCollisions, modemTotalCapacity=modemTotalCapacity, saf=saf, ipRadioMgmt=ipRadioMgmt, atpcTxPowerCorrection=atpcTxPowerCorrection, modemGeneralStatus=modemGeneralStatus, ethRXDribleNibbles=ethRXDribleNibbles, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ipRadioCfgGeneral=ipRadioCfgGeneral, modemIndex=modemIndex, ipRadioStat=ipRadioStat, ethTXControlFrames=ethTXControlFrames, radioTable=radioTable, modemCarrierOffset=modemCarrierOffset, modemACMtotalCapacity=modemACMtotalCapacity, ethTXByteCounterLow=ethTXByteCounterLow, modemRowStatus=modemRowStatus, radioTxFrequency=radioTxFrequency, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXDones=ethTXDones, modemEntry=modemEntry, modemModulation=modemModulation, modemLastAcqError=modemLastAcqError, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, vlanFid=vlanFid, writeConfig=writeConfig, ethTXMulticasts=ethTXMulticasts, ethTXGiants=ethTXGiants, ethRXLongEvents=ethRXLongEvents, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, e1t1LOS=e1t1LOS, ethRXCRCErrors=ethRXCRCErrors, vlanEntry=vlanEntry, restartcpu=restartcpu, ethRXControlFrames=ethRXControlFrames, modemStandard=modemStandard, modemLDPCdecoderStress=modemLDPCdecoderStress, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioRxLevel=radioRxLevel, radioTxMute=radioTxMute, modemErroredSecond=modemErroredSecond, vlanTable=vlanTable, ethTXPauseFrames=ethTXPauseFrames, radioDuplexShift=radioDuplexShift, modemACMethernetCapacity=modemACMethernetCapacity, ethGFPCHECErrors=ethGFPCHECErrors, modemRadialMSE=modemRadialMSE, microwaveRadio=microwaveRadio, modemCountTime=modemCountTime, ipRadioCfg=ipRadioCfg, aTPCEntry=aTPCEntry, modemE1T1Channels=modemE1T1Channels, product=product, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioIndex=radioIndex, modemBandwith=modemBandwith, e1t1StatEntry=e1t1StatEntry, atpcEnabled=atpcEnabled, licenseMask=licenseMask, ethRXCodeErrors=ethRXCodeErrors, ethTXLateCollisions=ethTXLateCollisions, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemInternalAGCgain=modemInternalAGCgain, ethTXByteCounterHi=ethTXByteCounterHi, e1t1ChannelNr=e1t1ChannelNr, radioSide=radioSide, ipRadioStatEth=ipRadioStatEth, aTPCTable=aTPCTable, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlanRowStatus=vlanRowStatus, ethRXBroadcasts=ethRXBroadcasts, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped)
