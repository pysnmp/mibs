...
mibBuilder.exportSymbols("SAF-IPRADIO", modemSymbolRateRx=modemSymbolRateRx, ethTXMaxCollisions=ethTXMaxCollisions, ipRadioStat=ipRadioStat, description=description, sysDateAndTime=sysDateAndTime, ipRadio=ipRadio, ethTXLateCollisions=ethTXLateCollisions, modemACMmodulationMax=modemACMmodulationMax, ethTXMulticasts=ethTXMulticasts, modemStandard=modemStandard, ethTXUnderruns=ethTXUnderruns, ethTXGiants=ethTXGiants, ethTXCollisions=ethTXCollisions, modemErroredBlock=modemErroredBlock, ethRXControlFrames=ethRXControlFrames, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlansEnabled=vlansEnabled, ethTXDones=ethTXDones, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemRadialMSE=modemRadialMSE, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXDvEvent=ethRXDvEvent, ethRXPrevPktDropped=ethRXPrevPktDropped, ipRadioStatEth=ipRadioStatEth, ethRXDones=ethRXDones, vlanRowStatus=vlanRowStatus, vlanNumber=vlanNumber, modemACMengine=modemACMengine, remoteIp=remoteIp, radioEntry=radioEntry, ipRadioCfg=ipRadioCfg, writeConfig=writeConfig, modemEntry=modemEntry, ethRXBroadcasts=ethRXBroadcasts, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioLoopback=radioLoopback, modemLDPCdecoderStress=modemLDPCdecoderStress, radioRxLevel=radioRxLevel, modemACMtotalCapacity=modemACMtotalCapacity, vlanEntry=vlanEntry, ethTXCRCErrors=ethTXCRCErrors, modemUptime=modemUptime, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, localIp=localIp, ethTXExcessiveDefers=ethTXExcessiveDefers, license=license, modemCarrierOffset=modemCarrierOffset, product=product, modemErroredSecondRatio=modemErroredSecondRatio, vlanPortmap=vlanPortmap, restartcpu=restartcpu, modemUnavailtime=modemUnavailtime, modemACMethernetCapacity=modemACMethernetCapacity, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemEthernetCapacity=modemEthernetCapacity, ethQOSTXDropped=ethQOSTXDropped, ethRXMulticasts=ethRXMulticasts, modemLastAcqError=modemLastAcqError, ethTXPauseFrames=ethTXPauseFrames, vlanFid=vlanFid, radioDuplexShift=radioDuplexShift, modemE1T1ChannelMask=modemE1T1ChannelMask, modemRowStatus=modemRowStatus, radioSide=radioSide, ipRadioCfgNetwork=ipRadioCfgNetwork, modemBandwith=modemBandwith, ethRXTruncatedFrames=ethRXTruncatedFrames, modemGeneralStatus=modemGeneralStatus, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXVlanTags=ethTXVlanTags, licenseMask=licenseMask, modemAcqStatus=modemAcqStatus, ethTXBroadcasts=ethTXBroadcasts, e1t1LOS=e1t1LOS, ethQOSTXFrames=ethQOSTXFrames, radioRxFrequency=radioRxFrequency, radioGenStatus=radioGenStatus, radioTxMute=radioTxMute, modemModulation=modemModulation, modemInternalAGCgain=modemInternalAGCgain, modemErroredSecond=modemErroredSecond, vlanCfgStat=vlanCfgStat, safip=safip, modemTable=modemTable, ethRXDribleNibbles=ethRXDribleNibbles, ethRXByteCounterLow=ethRXByteCounterLow, aTPCTable=aTPCTable, ethRXCodeErrors=ethRXCodeErrors, modemTotalCapacity=modemTotalCapacity, ethRXCRCErrors=ethRXCRCErrors, modemIndex=modemIndex, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, aTPCEntry=aTPCEntry, modemE1T1Channels=modemE1T1Channels, hostname=hostname, ethRXUnsupOpcodes=ethRXUnsupOpcodes, e1t1StatEntry=e1t1StatEntry, licenseUpdateStatus=licenseUpdateStatus, radioTable=radioTable, atpcEnabled=atpcEnabled, ethRXByteCounterHi=ethRXByteCounterHi, ethTXBackpresEvents=ethTXBackpresEvents, ethTXControlFrames=ethTXControlFrames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ipRadioMgmt=ipRadioMgmt, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethGFPCHECErrors=ethGFPCHECErrors, ethGFPDropedFrames=ethGFPDropedFrames, radioTxFrequency=radioTxFrequency, e1t1ChannelNr=e1t1ChannelNr, modemTotalBlockNumber=modemTotalBlockNumber, radioIndex=radioIndex, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ipRadioCfgGeneral=ipRadioCfgGeneral, modemACMmodulationMin=modemACMmodulationMin, modemCountTime=modemCountTime, ethTXByteCounterLow=ethTXByteCounterLow, localIpMask=localIpMask, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethGFPFCSErrors=ethGFPFCSErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXByteCounterHi=ethTXByteCounterHi, e1t1StatTable=e1t1StatTable, modemStatistics=modemStatistics, radioTxPower=radioTxPower, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, e1t1AIS=e1t1AIS, loopbacks=loopbacks, vlanTable=vlanTable, microwaveRadio=microwaveRadio, modemSymbolRateTx=modemSymbolRateTx, ethRXPauseFrames=ethRXPauseFrames, saf=saf, tehnika=tehnika, atpcIndex=atpcIndex, loopback_tributary_mask=loopback_tributary_mask, ethQOSRXQ2Frames=ethQOSRXQ2Frames, pointToPoint=pointToPoint, vlanPortType=vlanPortType, atpcTxPowerCorrection=atpcTxPowerCorrection, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXLongEvents=ethRXLongEvents, sysTemperature=sysTemperature)
