...
mibBuilder.exportSymbols("SAF-IPRADIO", radioTxPower=radioTxPower, ethTXLateCollisions=ethTXLateCollisions, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXVlanTagsDetected=ethRXVlanTagsDetected, safip=safip, saf=saf, atpcTxPowerCorrection=atpcTxPowerCorrection, vlanFid=vlanFid, remoteIp=remoteIp, ethTXMaxCollisions=ethTXMaxCollisions, modemACMmodulationMax=modemACMmodulationMax, localIp=localIp, modemSymbolRateRx=modemSymbolRateRx, ethRXMulticasts=ethRXMulticasts, modemACMengine=modemACMengine, modemErroredSecondRatio=modemErroredSecondRatio, modemACMethernetCapacity=modemACMethernetCapacity, vlanRowStatus=vlanRowStatus, vlanNumber=vlanNumber, ipRadio=ipRadio, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemErroredBlock=modemErroredBlock, microwaveRadio=microwaveRadio, ethGFPDropedFrames=ethGFPDropedFrames, radioRxFrequency=radioRxFrequency, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemLDPCdecoderStress=modemLDPCdecoderStress, loopback_tributary_mask=loopback_tributary_mask, ethTXBroadcasts=ethTXBroadcasts, radioEntry=radioEntry, description=description, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioDuplexShift=radioDuplexShift, licenseMask=licenseMask, modemBandwith=modemBandwith, e1t1ChannelNr=e1t1ChannelNr, ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlanPortType=vlanPortType, modemErroredSecond=modemErroredSecond, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, aTPCEntry=aTPCEntry, modemStatistics=modemStatistics, modemLastAcqError=modemLastAcqError, modemACMtotalCapacity=modemACMtotalCapacity, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, atpcIndex=atpcIndex, ipRadioMgmt=ipRadioMgmt, e1t1StatEntry=e1t1StatEntry, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemAcqStatus=modemAcqStatus, modemUptime=modemUptime, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXDones=ethRXDones, ipRadioStatEth=ipRadioStatEth, modemSymbolRateTx=modemSymbolRateTx, ethRXLongEvents=ethRXLongEvents, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemEntry=modemEntry, vlanEntry=vlanEntry, ethTXGiants=ethTXGiants, e1t1StatTable=e1t1StatTable, modemEthernetCapacity=modemEthernetCapacity, tehnika=tehnika, radioTxFrequency=radioTxFrequency, e1t1AIS=e1t1AIS, ethTXPauseFrames=ethTXPauseFrames, ethTXCRCErrors=ethTXCRCErrors, sysTemperature=sysTemperature, ethTXExcessiveDefers=ethTXExcessiveDefers, ethGFPFCSErrors=ethGFPFCSErrors, restartcpu=restartcpu, radioTable=radioTable, aTPCTable=aTPCTable, ethRXDvEvent=ethRXDvEvent, modemGeneralStatus=modemGeneralStatus, ethGFPCHECErrors=ethGFPCHECErrors, ethQOSTXDropped=ethQOSTXDropped, ethTXVlanTags=ethTXVlanTags, e1t1LOS=e1t1LOS, modemIndex=modemIndex, localIpMask=localIpMask, ipRadioStat=ipRadioStat, radioLoopback=radioLoopback, ethTXControlFrames=ethTXControlFrames, pointToPoint=pointToPoint, ethRXCRCErrors=ethRXCRCErrors, licenseUpdateStatus=licenseUpdateStatus, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemInternalAGCgain=modemInternalAGCgain, ethRXControlFrames=ethRXControlFrames, modemUnavailtime=modemUnavailtime, modemRadialMSE=modemRadialMSE, sysDateAndTime=sysDateAndTime, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioRxLevel=radioRxLevel, ethRXDribleNibbles=ethRXDribleNibbles, loopbacks=loopbacks, ethRXBroadcasts=ethRXBroadcasts, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemTotalCapacity=modemTotalCapacity, modemRowStatus=modemRowStatus, modemACMmodulationMin=modemACMmodulationMin, radioIndex=radioIndex, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlanCfgStat=vlanCfgStat, vlansEnabled=vlansEnabled, ethTXCollisions=ethTXCollisions, vlanPortmap=vlanPortmap, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXMulticasts=ethTXMulticasts, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXBackpresEvents=ethTXBackpresEvents, ethRXPauseFrames=ethRXPauseFrames, modemCountTime=modemCountTime, ethGFPDelineationErrors=ethGFPDelineationErrors, modemTable=modemTable, modemStandard=modemStandard, radioTxMute=radioTxMute, ethRXTruncatedFrames=ethRXTruncatedFrames, ipRadioCfg=ipRadioCfg, license=license, writeConfig=writeConfig, ethQOSTXFrames=ethQOSTXFrames, modemModulation=modemModulation, atpcEnabled=atpcEnabled, ethTXByteCounterLow=ethTXByteCounterLow, ethTXDones=ethTXDones, ethRXCodeErrors=ethRXCodeErrors, vlanTable=vlanTable, modemE1T1Channels=modemE1T1Channels, ethRXByteCounterHi=ethRXByteCounterHi, radioGenStatus=radioGenStatus, product=product, modemCarrierOffset=modemCarrierOffset, modemTotalBlockNumber=modemTotalBlockNumber, hostname=hostname, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXUnderruns=ethTXUnderruns, ethRXByteCounterLow=ethRXByteCounterLow, radioSide=radioSide, ethTXByteCounterHi=ethTXByteCounterHi)
