...
mibBuilder.exportSymbols("SAF-IPRADIO", e1t1StatEntry=e1t1StatEntry, modemACMethernetCapacity=modemACMethernetCapacity, modemLastAcqError=modemLastAcqError, ethTXGiants=ethTXGiants, ethGFPFCSErrors=ethGFPFCSErrors, atpcTxPowerCorrection=atpcTxPowerCorrection, description=description, vlanPortmap=vlanPortmap, hostname=hostname, aTPCEntry=aTPCEntry, sysDateAndTime=sysDateAndTime, modemE1T1Channels=modemE1T1Channels, modemEthernetCapacity=modemEthernetCapacity, pointToPoint=pointToPoint, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXByteCounterLow=ethTXByteCounterLow, modemGeneralStatus=modemGeneralStatus, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, vlanRowStatus=vlanRowStatus, radioLoopback=radioLoopback, loopback_tributary_mask=loopback_tributary_mask, modemSeverelyErroredSecond=modemSeverelyErroredSecond, licenseMask=licenseMask, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ipRadioCfg=ipRadioCfg, ipRadioStat=ipRadioStat, ethTXVlanTags=ethTXVlanTags, aTPCTable=aTPCTable, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioRxFrequency=radioRxFrequency, ethRXDribleNibbles=ethRXDribleNibbles, ethTXLateCollisions=ethTXLateCollisions, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXUnderruns=ethTXUnderruns, ethRXUnsupOpcodes=ethRXUnsupOpcodes, e1t1ChannelNr=e1t1ChannelNr, modemIndex=modemIndex, ethRXDvEvent=ethRXDvEvent, modemStatistics=modemStatistics, modemTotalCapacity=modemTotalCapacity, modemStandard=modemStandard, ethRXControlFrames=ethRXControlFrames, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioTable=radioTable, ethRXByteCounterLow=ethRXByteCounterLow, modemTotalBlockNumber=modemTotalBlockNumber, modemBandwith=modemBandwith, ethRXCRCErrors=ethRXCRCErrors, modemEntry=modemEntry, radioTxPower=radioTxPower, vlanFid=vlanFid, ethQOSTXFrames=ethQOSTXFrames, saf=saf, ipRadioCfgGeneral=ipRadioCfgGeneral, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXByteCounterHi=ethTXByteCounterHi, atpcEnabled=atpcEnabled, ethRXPauseFrames=ethRXPauseFrames, ethGFPDropedFrames=ethGFPDropedFrames, ethGFPCHECErrors=ethGFPCHECErrors, modemCountTime=modemCountTime, safip=safip, ethRXVlanTagsDetected=ethRXVlanTagsDetected, restartcpu=restartcpu, localIpMask=localIpMask, atpcIndex=atpcIndex, e1t1StatTable=e1t1StatTable, ethRXMulticasts=ethRXMulticasts, licenseUpdateStatus=licenseUpdateStatus, ethTXExcessiveDefers=ethTXExcessiveDefers, radioTxMute=radioTxMute, vlanNumber=vlanNumber, ethTXBroadcasts=ethTXBroadcasts, ethRXCodeErrors=ethRXCodeErrors, e1t1LOS=e1t1LOS, ethRXByteCounterHi=ethRXByteCounterHi, ipRadioStatEth=ipRadioStatEth, ethTXCollisions=ethTXCollisions, microwaveRadio=microwaveRadio, sysTemperature=sysTemperature, ipRadioCfgNetwork=ipRadioCfgNetwork, modemACMengine=modemACMengine, ethRXLongEvents=ethRXLongEvents, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemErroredSecond=modemErroredSecond, modemRadialMSE=modemRadialMSE, radioRxLevel=radioRxLevel, localIp=localIp, radioDuplexShift=radioDuplexShift, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemE1T1ChannelMask=modemE1T1ChannelMask, modemLDPCdecoderStress=modemLDPCdecoderStress, vlanEntry=vlanEntry, modemACMtotalCapacity=modemACMtotalCapacity, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemModulation=modemModulation, ethTXMaxCollisions=ethTXMaxCollisions, modemACMmodulationMin=modemACMmodulationMin, ethTXCRCErrors=ethTXCRCErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemSymbolRateTx=modemSymbolRateTx, ethTXMulticasts=ethTXMulticasts, license=license, modemErroredBlock=modemErroredBlock, modemInternalAGCgain=modemInternalAGCgain, tehnika=tehnika, modemRowStatus=modemRowStatus, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXBackpresEvents=ethTXBackpresEvents, product=product, radioIndex=radioIndex, vlansEnabled=vlansEnabled, modemUptime=modemUptime, ethTXDones=ethTXDones, writeConfig=writeConfig, radioGenStatus=radioGenStatus, e1t1AIS=e1t1AIS, modemACMmodulationMax=modemACMmodulationMax, ethRXDones=ethRXDones, vlanCfgStat=vlanCfgStat, vlanTable=vlanTable, ethTXPauseFrames=ethTXPauseFrames, remoteIp=remoteIp, ethRXBroadcasts=ethRXBroadcasts, ethTXControlFrames=ethTXControlFrames, ipRadioMgmt=ipRadioMgmt, radioSide=radioSide, modemTable=modemTable, modemAcqStatus=modemAcqStatus, vlanPortType=vlanPortType, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXPrevPktDropped=ethRXPrevPktDropped, ethGFPDelineationErrors=ethGFPDelineationErrors, modemUnavailtime=modemUnavailtime, modemCarrierOffset=modemCarrierOffset, ipRadio=ipRadio, modemSymbolRateRx=modemSymbolRateRx, modemErroredSecondRatio=modemErroredSecondRatio, ethQOSTXDropped=ethQOSTXDropped, radioEntry=radioEntry, loopbacks=loopbacks, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioTxFrequency=radioTxFrequency)
