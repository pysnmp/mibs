...
mibBuilder.exportSymbols("SAF-IPRADIO", vlanPortType=vlanPortType, modemTotalBlockNumber=modemTotalBlockNumber, atpcEnabled=atpcEnabled, vlanCfgStat=vlanCfgStat, modemStandard=modemStandard, ethTXExcessiveDefers=ethTXExcessiveDefers, vlanRowStatus=vlanRowStatus, ethQOSRXQ2Frames=ethQOSRXQ2Frames, e1t1ChannelNr=e1t1ChannelNr, ethRXMulticasts=ethRXMulticasts, radioEntry=radioEntry, licenseMask=licenseMask, modemBandwith=modemBandwith, e1t1StatEntry=e1t1StatEntry, description=description, modemCountTime=modemCountTime, aTPCTable=aTPCTable, modemLastAcqError=modemLastAcqError, ethTXByteCounterLow=ethTXByteCounterLow, loopbacks=loopbacks, sysDateAndTime=sysDateAndTime, saf=saf, ethTXCollisions=ethTXCollisions, modemTotalCapacity=modemTotalCapacity, modemE1T1Channels=modemE1T1Channels, modemAcqStatus=modemAcqStatus, vlansEnabled=vlansEnabled, ethTXControlFrames=ethTXControlFrames, vlanTable=vlanTable, radioTable=radioTable, aTPCEntry=aTPCEntry, ethRXControlFrames=ethRXControlFrames, localIp=localIp, ethQOSTXDropped=ethQOSTXDropped, ethTXMaxCollisions=ethTXMaxCollisions, license=license, e1t1LOS=e1t1LOS, modemEthernetCapacity=modemEthernetCapacity, ipRadioCfgGeneral=ipRadioCfgGeneral, modemACMmodulationMin=modemACMmodulationMin, ethRXBroadcasts=ethRXBroadcasts, vlanEntry=vlanEntry, ethTXBackpresEvents=ethTXBackpresEvents, modemACMtotalCapacity=modemACMtotalCapacity, pointToPoint=pointToPoint, modemACMethernetCapacity=modemACMethernetCapacity, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ipRadioCfg=ipRadioCfg, radioDuplexShift=radioDuplexShift, ipRadioCfgNetwork=ipRadioCfgNetwork, modemSymbolRateTx=modemSymbolRateTx, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXLongEvents=ethRXLongEvents, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemEntry=modemEntry, radioRxFrequency=radioRxFrequency, ethTXLengthCheckErrors=ethTXLengthCheckErrors, safip=safip, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemStatistics=modemStatistics, ethTXCRCErrors=ethTXCRCErrors, ipRadioStat=ipRadioStat, modemErroredSecond=modemErroredSecond, loopback_tributary_mask=loopback_tributary_mask, tehnika=tehnika, modemCarrierOffset=modemCarrierOffset, vlanFid=vlanFid, modemUnavailtime=modemUnavailtime, hostname=hostname, modemGeneralStatus=modemGeneralStatus, ethRXByteCounterHi=ethRXByteCounterHi, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, restartcpu=restartcpu, ethQOSTXFrames=ethQOSTXFrames, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXDvEvent=ethRXDvEvent, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethGFPCHECErrors=ethGFPCHECErrors, vlanNumber=vlanNumber, radioTxMute=radioTxMute, ethTXVlanTags=ethTXVlanTags, ethTXMulticasts=ethTXMulticasts, ipRadio=ipRadio, ethTXUnderruns=ethTXUnderruns, modemRowStatus=modemRowStatus, ethRXByteCounterLow=ethRXByteCounterLow, ethTXDones=ethTXDones, ethRXPauseFrames=ethRXPauseFrames, modemInternalAGCgain=modemInternalAGCgain, modemModulation=modemModulation, modemErroredBlock=modemErroredBlock, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, remoteIp=remoteIp, radioLoopback=radioLoopback, atpcIndex=atpcIndex, modemACMmodulationMax=modemACMmodulationMax, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioIndex=radioIndex, vlanPortmap=vlanPortmap, e1t1AIS=e1t1AIS, ethTXBroadcasts=ethTXBroadcasts, radioTxFrequency=radioTxFrequency, modemRadialMSE=modemRadialMSE, ethTXByteCounterHi=ethTXByteCounterHi, ethRXDribleNibbles=ethRXDribleNibbles, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, licenseUpdateStatus=licenseUpdateStatus, modemErroredSecondRatio=modemErroredSecondRatio, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXDones=ethRXDones, localIpMask=localIpMask, radioRxLevel=radioRxLevel, ethGFPDropedFrames=ethGFPDropedFrames, ethRXCRCErrors=ethRXCRCErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, sysTemperature=sysTemperature, atpcTxPowerCorrection=atpcTxPowerCorrection, modemUptime=modemUptime, ipRadioMgmt=ipRadioMgmt, modemACMengine=modemACMengine, modemLDPCdecoderStress=modemLDPCdecoderStress, radioGenStatus=radioGenStatus, modemIndex=modemIndex, radioSide=radioSide, ethTXPauseFrames=ethTXPauseFrames, microwaveRadio=microwaveRadio, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemTable=modemTable, modemSymbolRateRx=modemSymbolRateRx, ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadioStatEth=ipRadioStatEth, ethGFPFCSErrors=ethGFPFCSErrors, ethTXLateCollisions=ethTXLateCollisions, product=product, writeConfig=writeConfig, ethRXPrevPktDropped=ethRXPrevPktDropped, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXGiants=ethTXGiants, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXVlanTagsDetected=ethRXVlanTagsDetected, e1t1StatTable=e1t1StatTable, ethRXCodeErrors=ethRXCodeErrors, radioTxPower=radioTxPower)
