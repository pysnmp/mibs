...
mibBuilder.exportSymbols("SAF-IPRADIO", ipRadioStatEth=ipRadioStatEth, ethTXBroadcasts=ethTXBroadcasts, ethRXCRCErrors=ethRXCRCErrors, ethRXCodeErrors=ethRXCodeErrors, ethTXVlanTags=ethTXVlanTags, e1t1LOS=e1t1LOS, remoteIp=remoteIp, modemTotalCapacity=modemTotalCapacity, modemBandwith=modemBandwith, radioTxFrequency=radioTxFrequency, ethTXDones=ethTXDones, modemErroredBlock=modemErroredBlock, e1t1ChannelNr=e1t1ChannelNr, loopback_tributary_mask=loopback_tributary_mask, ethTXControlFrames=ethTXControlFrames, vlanPortmap=vlanPortmap, atpcIndex=atpcIndex, vlanPortType=vlanPortType, ethRXTruncatedFrames=ethRXTruncatedFrames, e1t1StatEntry=e1t1StatEntry, modemACMethernetCapacity=modemACMethernetCapacity, modemTable=modemTable, modemInternalAGCgain=modemInternalAGCgain, ethRXBroadcasts=ethRXBroadcasts, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, loopbacks=loopbacks, ethTXGiants=ethTXGiants, localIp=localIp, modemCountTime=modemCountTime, licenseUpdateStatus=licenseUpdateStatus, ethRXDones=ethRXDones, ethGFPFCSErrors=ethGFPFCSErrors, pointToPoint=pointToPoint, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioEntry=radioEntry, ethRXDvEvent=ethRXDvEvent, modemGeneralStatus=modemGeneralStatus, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, atpcEnabled=atpcEnabled, modemACMengine=modemACMengine, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioGenStatus=radioGenStatus, vlanFid=vlanFid, modemIndex=modemIndex, ipRadioCfgNetwork=ipRadioCfgNetwork, vlanRowStatus=vlanRowStatus, radioRxFrequency=radioRxFrequency, modemEthernetCapacity=modemEthernetCapacity, modemSymbolRateRx=modemSymbolRateRx, ipRadioCfg=ipRadioCfg, ethTXMaxCollisions=ethTXMaxCollisions, vlanTable=vlanTable, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemUptime=modemUptime, modemCarrierOffset=modemCarrierOffset, modemErroredSecond=modemErroredSecond, safip=safip, modemE1T1Channels=modemE1T1Channels, modemSymbolRateTx=modemSymbolRateTx, ethGFPDelineationErrors=ethGFPDelineationErrors, radioTxMute=radioTxMute, ethRXPrevPktDropped=ethRXPrevPktDropped, e1t1StatTable=e1t1StatTable, ipRadioCfgGeneral=ipRadioCfgGeneral, restartcpu=restartcpu, tehnika=tehnika, sysTemperature=sysTemperature, radioTxPower=radioTxPower, microwaveRadio=microwaveRadio, ethTXCollisions=ethTXCollisions, vlanNumber=vlanNumber, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemTotalBlockNumber=modemTotalBlockNumber, saf=saf, ethRXDribleNibbles=ethRXDribleNibbles, ethRXLongEvents=ethRXLongEvents, vlanEntry=vlanEntry, ethGFPCHECErrors=ethGFPCHECErrors, ipRadioMgmt=ipRadioMgmt, ethTXMulticasts=ethTXMulticasts, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXExcessiveDefers=ethTXExcessiveDefers, modemModulation=modemModulation, localIpMask=localIpMask, ethQOSTXDropped=ethQOSTXDropped, ethRXControlFrames=ethRXControlFrames, radioSide=radioSide, radioIndex=radioIndex, ethTXPauseFrames=ethTXPauseFrames, e1t1AIS=e1t1AIS, ethTXLateCollisions=ethTXLateCollisions, ethRXPauseFrames=ethRXPauseFrames, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemAcqStatus=modemAcqStatus, modemLDPCdecoderStress=modemLDPCdecoderStress, ethQOSTXFrames=ethQOSTXFrames, ethRXByteCounterHi=ethRXByteCounterHi, modemUnavailtime=modemUnavailtime, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlansEnabled=vlansEnabled, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemACMmodulationMin=modemACMmodulationMin, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXUnderruns=ethTXUnderruns, ipRadio=ipRadio, ethRXMulticasts=ethRXMulticasts, ethGFPDropedFrames=ethGFPDropedFrames, modemRadialMSE=modemRadialMSE, radioLoopback=radioLoopback, modemLastAcqError=modemLastAcqError, ethTXByteCounterLow=ethTXByteCounterLow, modemEntry=modemEntry, hostname=hostname, modemACMmodulationMax=modemACMmodulationMax, ipRadioStat=ipRadioStat, modemRowStatus=modemRowStatus, vlanCfgStat=vlanCfgStat, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXBackpresEvents=ethTXBackpresEvents, license=license, writeConfig=writeConfig, ethTXByteCounterHi=ethTXByteCounterHi, ethTXCRCErrors=ethTXCRCErrors, ethRXByteCounterLow=ethRXByteCounterLow, ethQOSRXQ1Frames=ethQOSRXQ1Frames, licenseMask=licenseMask, modemStandard=modemStandard, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, product=product, radioRxLevel=radioRxLevel, description=description, modemStatistics=modemStatistics, ethTXWireByteCounterLow=ethTXWireByteCounterLow, aTPCTable=aTPCTable, radioDuplexShift=radioDuplexShift, radioTable=radioTable, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemACMtotalCapacity=modemACMtotalCapacity, sysDateAndTime=sysDateAndTime, modemErroredSecondRatio=modemErroredSecondRatio, aTPCEntry=aTPCEntry)
