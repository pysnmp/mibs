...
mibBuilder.exportSymbols("SAF-IPRADIO", microwaveRadio=microwaveRadio, e1t1ChannelNr=e1t1ChannelNr, modemRadialMSE=modemRadialMSE, writeConfig=writeConfig, modemUnavailtime=modemUnavailtime, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXByteCounterHi=ethTXByteCounterHi, safip=safip, ipRadioStatEth=ipRadioStatEth, atpcEnabled=atpcEnabled, ethTXControlFrames=ethTXControlFrames, radioRxLevel=radioRxLevel, localIpMask=localIpMask, sysDateAndTime=sysDateAndTime, ethGFPDelineationErrors=ethGFPDelineationErrors, modemACMmodulationMax=modemACMmodulationMax, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioTable=radioTable, modemTotalBlockNumber=modemTotalBlockNumber, radioLoopback=radioLoopback, modemSymbolRateRx=modemSymbolRateRx, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ipRadio=ipRadio, ethRXBroadcasts=ethRXBroadcasts, vlanPortType=vlanPortType, license=license, modemModulation=modemModulation, ethTXExcessiveDefers=ethTXExcessiveDefers, radioRxFrequency=radioRxFrequency, radioSide=radioSide, ethQOSTXDropped=ethQOSTXDropped, radioTxFrequency=radioTxFrequency, loopbacks=loopbacks, radioIndex=radioIndex, ethRXPauseFrames=ethRXPauseFrames, ethTXCRCErrors=ethTXCRCErrors, modemEntry=modemEntry, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, licenseUpdateStatus=licenseUpdateStatus, saf=saf, radioTxPower=radioTxPower, ipRadioMgmt=ipRadioMgmt, radioGenStatus=radioGenStatus, e1t1StatTable=e1t1StatTable, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, product=product, remoteIp=remoteIp, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemErroredSecondRatio=modemErroredSecondRatio, atpcIndex=atpcIndex, ethRXCodeErrors=ethRXCodeErrors, vlanFid=vlanFid, ethTXLateCollisions=ethTXLateCollisions, ethTXBroadcasts=ethTXBroadcasts, ethTXPauseFrames=ethTXPauseFrames, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, loopback_tributary_mask=loopback_tributary_mask, pointToPoint=pointToPoint, modemBandwith=modemBandwith, radioDuplexShift=radioDuplexShift, atpcTxPowerCorrection=atpcTxPowerCorrection, e1t1LOS=e1t1LOS, modemRowStatus=modemRowStatus, ethTXVlanTags=ethTXVlanTags, ethRXDones=ethRXDones, ethRXUnsupOpcodes=ethRXUnsupOpcodes, localIp=localIp, modemCarrierOffset=modemCarrierOffset, modemErroredSecond=modemErroredSecond, vlanNumber=vlanNumber, vlanRowStatus=vlanRowStatus, ethTXCollisions=ethTXCollisions, ethTXDones=ethTXDones, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, tehnika=tehnika, ipRadioCfg=ipRadioCfg, ethTXLengthCheckErrors=ethTXLengthCheckErrors, vlansEnabled=vlansEnabled, ethRXTruncatedFrames=ethRXTruncatedFrames, ipRadioCfgNetwork=ipRadioCfgNetwork, modemE1T1ChannelMask=modemE1T1ChannelMask, modemIndex=modemIndex, ipRadioCfgGeneral=ipRadioCfgGeneral, modemErroredBlock=modemErroredBlock, modemTable=modemTable, vlanPortmap=vlanPortmap, aTPCEntry=aTPCEntry, restartcpu=restartcpu, ethTXUnderruns=ethTXUnderruns, modemAcqStatus=modemAcqStatus, modemEthernetCapacity=modemEthernetCapacity, modemACMengine=modemACMengine, ethTXMaxCollisions=ethTXMaxCollisions, licenseMask=licenseMask, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXByteCounterLow=ethTXByteCounterLow, modemStandard=modemStandard, modemLastAcqError=modemLastAcqError, e1t1StatEntry=e1t1StatEntry, ethGFPCHECErrors=ethGFPCHECErrors, ethRXDvEvent=ethRXDvEvent, modemACMethernetCapacity=modemACMethernetCapacity, modemGeneralStatus=modemGeneralStatus, radioEntry=radioEntry, modemLDPCdecoderStress=modemLDPCdecoderStress, modemCountTime=modemCountTime, description=description, modemACMmodulationMin=modemACMmodulationMin, modemInternalAGCgain=modemInternalAGCgain, ipRadioStat=ipRadioStat, ethRXCRCErrors=ethRXCRCErrors, ethQOSTXFrames=ethQOSTXFrames, ethTXMulticasts=ethTXMulticasts, vlanTable=vlanTable, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXBackpresEvents=ethTXBackpresEvents, modemUptime=modemUptime, ethRXLongEvents=ethRXLongEvents, modemStatistics=modemStatistics, ethTXGiants=ethTXGiants, ethRXDribleNibbles=ethRXDribleNibbles, ethGFPDropedFrames=ethGFPDropedFrames, modemACMtotalCapacity=modemACMtotalCapacity, ethGFPFCSErrors=ethGFPFCSErrors, hostname=hostname, ethRXVlanTagsDetected=ethRXVlanTagsDetected, sysTemperature=sysTemperature, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXMulticasts=ethRXMulticasts, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXPrevPktDropped=ethRXPrevPktDropped, modemE1T1Channels=modemE1T1Channels, ethRXByteCounterHi=ethRXByteCounterHi, e1t1AIS=e1t1AIS, vlanEntry=vlanEntry, radioTxMute=radioTxMute, aTPCTable=aTPCTable, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlanCfgStat=vlanCfgStat, ethRXByteCounterLow=ethRXByteCounterLow, modemSymbolRateTx=modemSymbolRateTx, modemTotalCapacity=modemTotalCapacity, ethRXControlFrames=ethRXControlFrames)
