...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemUnavailtime=modemUnavailtime, loopbacks=loopbacks, ipRadio=ipRadio, radioRxLevel=radioRxLevel, modemACMengine=modemACMengine, ethTXBroadcasts=ethTXBroadcasts, radioGenStatus=radioGenStatus, vlanCfgStat=vlanCfgStat, loopback_tributary_mask=loopback_tributary_mask, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ipRadioCfg=ipRadioCfg, licenseUpdateStatus=licenseUpdateStatus, pointToPoint=pointToPoint, vlanPortmap=vlanPortmap, radioIndex=radioIndex, ethGFPFCSErrors=ethGFPFCSErrors, modemModulation=modemModulation, ethGFPDropedFrames=ethGFPDropedFrames, ethRXPauseFrames=ethRXPauseFrames, ethTXUnderruns=ethTXUnderruns, modemUptime=modemUptime, modemACMmodulationMax=modemACMmodulationMax, modemErroredSecondRatio=modemErroredSecondRatio, modemACMethernetCapacity=modemACMethernetCapacity, radioSide=radioSide, modemGeneralStatus=modemGeneralStatus, vlansEnabled=vlansEnabled, modemACMmodulationMin=modemACMmodulationMin, ethTXLateCollisions=ethTXLateCollisions, aTPCEntry=aTPCEntry, modemStatistics=modemStatistics, atpcTxPowerCorrection=atpcTxPowerCorrection, modemAcqStatus=modemAcqStatus, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, remoteIp=remoteIp, vlanPortType=vlanPortType, description=description, modemLDPCdecoderStress=modemLDPCdecoderStress, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXPrevPktDropped=ethRXPrevPktDropped, vlanEntry=vlanEntry, localIp=localIp, ethTXControlFrames=ethTXControlFrames, modemLastAcqError=modemLastAcqError, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXCRCErrors=ethRXCRCErrors, licenseMask=licenseMask, ethTXGiants=ethTXGiants, vlanRowStatus=vlanRowStatus, modemTable=modemTable, ethRXByteCounterLow=ethRXByteCounterLow, modemSymbolRateRx=modemSymbolRateRx, radioTxMute=radioTxMute, ipRadioStat=ipRadioStat, ethRXDones=ethRXDones, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemTotalBlockNumber=modemTotalBlockNumber, modemSymbolRateTx=modemSymbolRateTx, modemStandard=modemStandard, radioTable=radioTable, modemRadialMSE=modemRadialMSE, vlanNumber=vlanNumber, ethTXWireByteCounterHi=ethTXWireByteCounterHi, product=product, ethTXPauseFrames=ethTXPauseFrames, microwaveRadio=microwaveRadio, modemSeverelyErroredSecond=modemSeverelyErroredSecond, e1t1StatTable=e1t1StatTable, ethTXByteCounterHi=ethTXByteCounterHi, e1t1ChannelNr=e1t1ChannelNr, tehnika=tehnika, e1t1LOS=e1t1LOS, atpcEnabled=atpcEnabled, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemErroredSecond=modemErroredSecond, vlanFid=vlanFid, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXExcessiveDefers=ethTXExcessiveDefers, ipRadioCfgGeneral=ipRadioCfgGeneral, modemCarrierOffset=modemCarrierOffset, ethRXMulticasts=ethRXMulticasts, ethQOSTXFrames=ethQOSTXFrames, ethRXByteCounterHi=ethRXByteCounterHi, modemACMtotalCapacity=modemACMtotalCapacity, modemEntry=modemEntry, modemErroredBlock=modemErroredBlock, ethTXBackpresEvents=ethTXBackpresEvents, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioDuplexShift=radioDuplexShift, radioRxFrequency=radioRxFrequency, e1t1StatEntry=e1t1StatEntry, ethRXDvEvent=ethRXDvEvent, safip=safip, ethTXMaxCollisions=ethTXMaxCollisions, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, license=license, modemRowStatus=modemRowStatus, ipRadioMgmt=ipRadioMgmt, ipRadioStatEth=ipRadioStatEth, ethRXBroadcasts=ethRXBroadcasts, modemInternalAGCgain=modemInternalAGCgain, radioEntry=radioEntry, ethTXByteCounterLow=ethTXByteCounterLow, ethRXDribleNibbles=ethRXDribleNibbles, vlanTable=vlanTable, modemCountTime=modemCountTime, modemBandwith=modemBandwith, modemTotalCapacity=modemTotalCapacity, radioTxPower=radioTxPower, ethTXMulticasts=ethTXMulticasts, radioLoopback=radioLoopback, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXCRCErrors=ethTXCRCErrors, ethTXCollisions=ethTXCollisions, sysTemperature=sysTemperature, restartcpu=restartcpu, ethQOSTXDropped=ethQOSTXDropped, saf=saf, ethRXTruncatedFrames=ethRXTruncatedFrames, hostname=hostname, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXLongEvents=ethRXLongEvents, sysDateAndTime=sysDateAndTime, localIpMask=localIpMask, ethTXVlanTags=ethTXVlanTags, writeConfig=writeConfig, ethTXDones=ethTXDones, atpcIndex=atpcIndex, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXCodeErrors=ethRXCodeErrors, ethRXControlFrames=ethRXControlFrames, modemIndex=modemIndex, modemEthernetCapacity=modemEthernetCapacity, e1t1AIS=e1t1AIS, ethGFPCHECErrors=ethGFPCHECErrors, aTPCTable=aTPCTable, ipRadioCfgNetwork=ipRadioCfgNetwork, radioTxFrequency=radioTxFrequency, modemE1T1Channels=modemE1T1Channels)
