...
mibBuilder.exportSymbols("SAF-IPRADIO", pointToPoint=pointToPoint, modemErroredSecond=modemErroredSecond, radioTxPower=radioTxPower, ethRXPrevPktDropped=ethRXPrevPktDropped, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemE1T1Channels=modemE1T1Channels, hostname=hostname, modemErroredSecondRatio=modemErroredSecondRatio, ethQOSTXFrames=ethQOSTXFrames, radioIndex=radioIndex, ethTXBackpresEvents=ethTXBackpresEvents, ipRadioMgmt=ipRadioMgmt, restartcpu=restartcpu, vlanTable=vlanTable, modemEntry=modemEntry, vlanNumber=vlanNumber, description=description, ethTXExcessiveDefers=ethTXExcessiveDefers, e1t1ChannelNr=e1t1ChannelNr, modemAcqStatus=modemAcqStatus, writeConfig=writeConfig, aTPCEntry=aTPCEntry, ethRXByteCounterHi=ethRXByteCounterHi, aTPCTable=aTPCTable, ethTXPauseFrames=ethTXPauseFrames, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemUnavailtime=modemUnavailtime, modemCountTime=modemCountTime, radioEntry=radioEntry, ethTXVlanTags=ethTXVlanTags, modemStandard=modemStandard, radioTable=radioTable, vlanFid=vlanFid, saf=saf, modemACMtotalCapacity=modemACMtotalCapacity, modemACMmodulationMax=modemACMmodulationMax, modemBackgroundBlockErrror=modemBackgroundBlockErrror, e1t1StatEntry=e1t1StatEntry, e1t1StatTable=e1t1StatTable, modemInternalAGCgain=modemInternalAGCgain, safip=safip, remoteIp=remoteIp, ipRadioStatEth=ipRadioStatEth, ethRXPauseFrames=ethRXPauseFrames, ethTXBroadcasts=ethTXBroadcasts, radioLoopback=radioLoopback, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioDuplexShift=radioDuplexShift, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXBroadcasts=ethRXBroadcasts, loopback_tributary_mask=loopback_tributary_mask, localIpMask=localIpMask, radioTxFrequency=radioTxFrequency, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemRadialMSE=modemRadialMSE, modemTotalCapacity=modemTotalCapacity, ethRXCRCErrors=ethRXCRCErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, vlanCfgStat=vlanCfgStat, e1t1AIS=e1t1AIS, modemUptime=modemUptime, ipRadioCfg=ipRadioCfg, vlanPortType=vlanPortType, modemACMengine=modemACMengine, atpcEnabled=atpcEnabled, modemBandwith=modemBandwith, modemCarrierOffset=modemCarrierOffset, ethRXDones=ethRXDones, ethGFPFCSErrors=ethGFPFCSErrors, ethTXCRCErrors=ethTXCRCErrors, modemSymbolRateRx=modemSymbolRateRx, vlansEnabled=vlansEnabled, ethGFPDropedFrames=ethGFPDropedFrames, radioTxMute=radioTxMute, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemModulation=modemModulation, ethRXLongEvents=ethRXLongEvents, ipRadioCfgGeneral=ipRadioCfgGeneral, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemACMethernetCapacity=modemACMethernetCapacity, ethRXDribleNibbles=ethRXDribleNibbles, tehnika=tehnika, microwaveRadio=microwaveRadio, ethTXByteCounterHi=ethTXByteCounterHi, e1t1LOS=e1t1LOS, atpcTxPowerCorrection=atpcTxPowerCorrection, modemSymbolRateTx=modemSymbolRateTx, ethTXDones=ethTXDones, ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadio=ipRadio, product=product, radioSide=radioSide, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXUnderruns=ethTXUnderruns, modemIndex=modemIndex, modemLastAcqError=modemLastAcqError, radioRxFrequency=radioRxFrequency, ethRXByteCounterLow=ethRXByteCounterLow, ethTXCollisions=ethTXCollisions, ethRXCodeErrors=ethRXCodeErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, sysTemperature=sysTemperature, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXGiants=ethTXGiants, sysDateAndTime=sysDateAndTime, ethTXMulticasts=ethTXMulticasts, modemGeneralStatus=modemGeneralStatus, license=license, modemLDPCdecoderStress=modemLDPCdecoderStress, radioGenStatus=radioGenStatus, ipRadioStat=ipRadioStat, ethRXVlanTagsDetected=ethRXVlanTagsDetected, localIp=localIp, modemTable=modemTable, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethGFPCHECErrors=ethGFPCHECErrors, vlanRowStatus=vlanRowStatus, modemEthernetCapacity=modemEthernetCapacity, ethTXLateCollisions=ethTXLateCollisions, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, licenseUpdateStatus=licenseUpdateStatus, ethRXControlFrames=ethRXControlFrames, loopbacks=loopbacks, vlanPortmap=vlanPortmap, vlanEntry=vlanEntry, ethTXByteCounterLow=ethTXByteCounterLow, modemACMmodulationMin=modemACMmodulationMin, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXControlFrames=ethTXControlFrames, ethRXMulticasts=ethRXMulticasts, ethQOSTXDropped=ethQOSTXDropped, modemTotalBlockNumber=modemTotalBlockNumber, ethRXDvEvent=ethRXDvEvent, licenseMask=licenseMask, modemStatistics=modemStatistics, ethTXMaxCollisions=ethTXMaxCollisions, modemErroredBlock=modemErroredBlock, modemE1T1ChannelMask=modemE1T1ChannelMask, modemRowStatus=modemRowStatus, radioRxLevel=radioRxLevel, atpcIndex=atpcIndex)
