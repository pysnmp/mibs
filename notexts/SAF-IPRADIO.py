...
mibBuilder.exportSymbols("SAF-IPRADIO", microwaveRadio=microwaveRadio, product=product, modemRowStatus=modemRowStatus, modemACMengine=modemACMengine, safip=safip, sysDateAndTime=sysDateAndTime, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, vlanEntry=vlanEntry, ethRXMulticasts=ethRXMulticasts, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemUnavailtime=modemUnavailtime, aTPCTable=aTPCTable, vlanTable=vlanTable, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemErroredBlock=modemErroredBlock, licenseUpdateStatus=licenseUpdateStatus, ethTXMaxCollisions=ethTXMaxCollisions, tehnika=tehnika, ethQOSTXDropped=ethQOSTXDropped, modemErroredSecond=modemErroredSecond, atpcEnabled=atpcEnabled, modemStatistics=modemStatistics, modemTable=modemTable, ipRadioMgmt=ipRadioMgmt, ethTXCRCErrors=ethTXCRCErrors, modemE1T1Channels=modemE1T1Channels, modemInternalAGCgain=modemInternalAGCgain, ethTXControlFrames=ethTXControlFrames, description=description, aTPCEntry=aTPCEntry, ethGFPDropedFrames=ethGFPDropedFrames, modemAcqStatus=modemAcqStatus, licenseMask=licenseMask, ethTXByteCounterLow=ethTXByteCounterLow, radioGenStatus=radioGenStatus, modemErroredSecondRatio=modemErroredSecondRatio, ethRXLongEvents=ethRXLongEvents, ipRadioStat=ipRadioStat, radioTxPower=radioTxPower, ipRadioCfg=ipRadioCfg, loopback_tributary_mask=loopback_tributary_mask, modemRadialMSE=modemRadialMSE, e1t1StatEntry=e1t1StatEntry, atpcTxPowerCorrection=atpcTxPowerCorrection, radioTxMute=radioTxMute, modemSymbolRateTx=modemSymbolRateTx, modemCountTime=modemCountTime, remoteIp=remoteIp, radioRxLevel=radioRxLevel, modemModulation=modemModulation, sysTemperature=sysTemperature, ethTXBroadcasts=ethTXBroadcasts, modemIndex=modemIndex, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemLastAcqError=modemLastAcqError, modemSymbolRateRx=modemSymbolRateRx, modemACMtotalCapacity=modemACMtotalCapacity, ethTXWireByteCounterHi=ethTXWireByteCounterHi, e1t1LOS=e1t1LOS, radioIndex=radioIndex, radioEntry=radioEntry, saf=saf, modemACMmodulationMax=modemACMmodulationMax, vlansEnabled=vlansEnabled, restartcpu=restartcpu, vlanPortType=vlanPortType, ethRXBroadcasts=ethRXBroadcasts, ethTXLateCollisions=ethTXLateCollisions, modemUptime=modemUptime, ethRXByteCounterHi=ethRXByteCounterHi, ethTXDones=ethTXDones, ethRXCodeErrors=ethRXCodeErrors, ethGFPFCSErrors=ethGFPFCSErrors, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioSide=radioSide, modemStandard=modemStandard, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemACMmodulationMin=modemACMmodulationMin, ethRXPrevPktDropped=ethRXPrevPktDropped, radioRxFrequency=radioRxFrequency, modemEntry=modemEntry, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXDones=ethRXDones, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXWireByteCounterLow=ethTXWireByteCounterLow, writeConfig=writeConfig, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ipRadio=ipRadio, vlanRowStatus=vlanRowStatus, radioLoopback=radioLoopback, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXPauseFrames=ethRXPauseFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXVlanTags=ethTXVlanTags, modemTotalBlockNumber=modemTotalBlockNumber, modemBandwith=modemBandwith, modemEthernetCapacity=modemEthernetCapacity, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, loopbacks=loopbacks, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemTotalCapacity=modemTotalCapacity, license=license, pointToPoint=pointToPoint, ethTXMulticasts=ethTXMulticasts, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemCarrierOffset=modemCarrierOffset, e1t1ChannelNr=e1t1ChannelNr, modemBackgroundBlockErrror=modemBackgroundBlockErrror, atpcIndex=atpcIndex, ethRXByteCounterLow=ethRXByteCounterLow, ipRadioStatEth=ipRadioStatEth, localIpMask=localIpMask, e1t1StatTable=e1t1StatTable, ethTXByteCounterHi=ethTXByteCounterHi, ethTXGiants=ethTXGiants, modemGeneralStatus=modemGeneralStatus, ethRXDribleNibbles=ethRXDribleNibbles, ethTXBackpresEvents=ethTXBackpresEvents, vlanPortmap=vlanPortmap, vlanCfgStat=vlanCfgStat, ethRXCRCErrors=ethRXCRCErrors, ethTXCollisions=ethTXCollisions, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXControlFrames=ethRXControlFrames, e1t1AIS=e1t1AIS, radioTxFrequency=radioTxFrequency, vlanFid=vlanFid, ethTXPauseFrames=ethTXPauseFrames, radioTable=radioTable, modemLDPCdecoderStress=modemLDPCdecoderStress, vlanNumber=vlanNumber, radioDuplexShift=radioDuplexShift, localIp=localIp, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXUnderruns=ethTXUnderruns, ethGFPCHECErrors=ethGFPCHECErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXDvEvent=ethRXDvEvent, hostname=hostname, modemACMethernetCapacity=modemACMethernetCapacity, ethQOSTXFrames=ethQOSTXFrames, ethTXExcessiveDefers=ethTXExcessiveDefers)
