...
mibBuilder.exportSymbols("SAF-IPRADIO", licenseMask=licenseMask, radioTxMute=radioTxMute, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioIndex=radioIndex, sysTemperature=sysTemperature, vlanNumber=vlanNumber, modemStandard=modemStandard, hostname=hostname, modemEthernetCapacity=modemEthernetCapacity, modemErroredSecondRatio=modemErroredSecondRatio, remoteIp=remoteIp, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXPauseFrames=ethRXPauseFrames, vlanRowStatus=vlanRowStatus, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXBroadcasts=ethTXBroadcasts, modemUptime=modemUptime, ethTXCRCErrors=ethTXCRCErrors, aTPCEntry=aTPCEntry, vlansEnabled=vlansEnabled, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXUnderruns=ethTXUnderruns, ethGFPDelineationErrors=ethGFPDelineationErrors, safip=safip, ipRadioCfgNetwork=ipRadioCfgNetwork, localIpMask=localIpMask, radioTxPower=radioTxPower, radioRxFrequency=radioRxFrequency, ethRXDribleNibbles=ethRXDribleNibbles, e1t1StatTable=e1t1StatTable, radioGenStatus=radioGenStatus, atpcEnabled=atpcEnabled, modemACMmodulationMax=modemACMmodulationMax, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXMaxCollisions=ethTXMaxCollisions, e1t1LOS=e1t1LOS, loopbacks=loopbacks, ipRadioCfg=ipRadioCfg, radioSide=radioSide, loopback_tributary_mask=loopback_tributary_mask, modemACMtotalCapacity=modemACMtotalCapacity, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemErroredBlock=modemErroredBlock, restartcpu=restartcpu, modemEntry=modemEntry, modemTotalCapacity=modemTotalCapacity, ethQOSTXFrames=ethQOSTXFrames, ethTXPauseFrames=ethTXPauseFrames, ipRadio=ipRadio, tehnika=tehnika, ipRadioStat=ipRadioStat, modemACMengine=modemACMengine, modemStatistics=modemStatistics, modemRadialMSE=modemRadialMSE, vlanFid=vlanFid, ethQOSRXQ1Frames=ethQOSRXQ1Frames, license=license, ethRXBroadcasts=ethRXBroadcasts, description=description, vlanEntry=vlanEntry, ethTXCollisions=ethTXCollisions, ethTXByteCounterLow=ethTXByteCounterLow, ethTXControlFrames=ethTXControlFrames, ethQOSTXDropped=ethQOSTXDropped, vlanTable=vlanTable, modemTable=modemTable, modemE1T1Channels=modemE1T1Channels, ipRadioCfgGeneral=ipRadioCfgGeneral, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXControlFrames=ethRXControlFrames, e1t1AIS=e1t1AIS, modemLDPCdecoderStress=modemLDPCdecoderStress, modemACMmodulationMin=modemACMmodulationMin, ethTXWireByteCounterLow=ethTXWireByteCounterLow, aTPCTable=aTPCTable, sysDateAndTime=sysDateAndTime, atpcTxPowerCorrection=atpcTxPowerCorrection, modemBandwith=modemBandwith, ethRXLongEvents=ethRXLongEvents, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioDuplexShift=radioDuplexShift, vlanCfgStat=vlanCfgStat, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, writeConfig=writeConfig, ethTXBackpresEvents=ethTXBackpresEvents, localIp=localIp, ethRXPrevPktDropped=ethRXPrevPktDropped, modemAcqStatus=modemAcqStatus, ethGFPDropedFrames=ethGFPDropedFrames, modemRowStatus=modemRowStatus, modemTotalBlockNumber=modemTotalBlockNumber, microwaveRadio=microwaveRadio, ethRXCRCErrors=ethRXCRCErrors, modemSymbolRateTx=modemSymbolRateTx, modemSymbolRateRx=modemSymbolRateRx, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXDones=ethRXDones, radioTxFrequency=radioTxFrequency, ethTXGiants=ethTXGiants, product=product, e1t1StatEntry=e1t1StatEntry, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemCountTime=modemCountTime, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXDvEvent=ethRXDvEvent, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemACMethernetCapacity=modemACMethernetCapacity, modemInternalAGCgain=modemInternalAGCgain, ethTXMulticasts=ethTXMulticasts, atpcIndex=atpcIndex, vlanPortType=vlanPortType, saf=saf, ipRadioMgmt=ipRadioMgmt, ethRXCodeErrors=ethRXCodeErrors, radioRxLevel=radioRxLevel, licenseUpdateStatus=licenseUpdateStatus, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXByteCounterHi=ethRXByteCounterHi, modemLastAcqError=modemLastAcqError, ethTXVlanTags=ethTXVlanTags, ethGFPCHECErrors=ethGFPCHECErrors, radioTable=radioTable, modemIndex=modemIndex, modemGeneralStatus=modemGeneralStatus, ethRXMulticasts=ethRXMulticasts, modemE1T1ChannelMask=modemE1T1ChannelMask, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemModulation=modemModulation, radioLoopback=radioLoopback, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXDones=ethTXDones, ethTXByteCounterHi=ethTXByteCounterHi, modemErroredSecond=modemErroredSecond, modemUnavailtime=modemUnavailtime, ethRXByteCounterLow=ethRXByteCounterLow, ipRadioStatEth=ipRadioStatEth, radioEntry=radioEntry, e1t1ChannelNr=e1t1ChannelNr, pointToPoint=pointToPoint, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXLateCollisions=ethTXLateCollisions, ethGFPFCSErrors=ethGFPFCSErrors, modemCarrierOffset=modemCarrierOffset, vlanPortmap=vlanPortmap)
