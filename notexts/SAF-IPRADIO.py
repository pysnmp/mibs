...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemInternalAGCgain=modemInternalAGCgain, radioRxFrequency=radioRxFrequency, radioTxPower=radioTxPower, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXDones=ethTXDones, aTPCEntry=aTPCEntry, ethRXByteCounterHi=ethRXByteCounterHi, sysDateAndTime=sysDateAndTime, vlansEnabled=vlansEnabled, modemUnavailtime=modemUnavailtime, e1t1AIS=e1t1AIS, microwaveRadio=microwaveRadio, ethTXCollisions=ethTXCollisions, ethTXLateCollisions=ethTXLateCollisions, modemBackgroundBlockErrror=modemBackgroundBlockErrror, atpcTxPowerCorrection=atpcTxPowerCorrection, ipRadioMgmt=ipRadioMgmt, ethRXUnsupOpcodes=ethRXUnsupOpcodes, vlanPortmap=vlanPortmap, e1t1StatTable=e1t1StatTable, ipRadioCfgGeneral=ipRadioCfgGeneral, loopbacks=loopbacks, radioTxMute=radioTxMute, ethRXDribleNibbles=ethRXDribleNibbles, vlanTable=vlanTable, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioDuplexShift=radioDuplexShift, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXExcessiveDefers=ethTXExcessiveDefers, vlanNumber=vlanNumber, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXMulticasts=ethTXMulticasts, modemEntry=modemEntry, modemErroredSecond=modemErroredSecond, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXPauseFrames=ethRXPauseFrames, modemTotalBlockNumber=modemTotalBlockNumber, ipRadioStatEth=ipRadioStatEth, writeConfig=writeConfig, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, licenseUpdateStatus=licenseUpdateStatus, licenseMask=licenseMask, modemACMengine=modemACMengine, modemE1T1Channels=modemE1T1Channels, vlanCfgStat=vlanCfgStat, radioTable=radioTable, modemACMmodulationMin=modemACMmodulationMin, radioIndex=radioIndex, ethTXBackpresEvents=ethTXBackpresEvents, modemIndex=modemIndex, modemE1T1ChannelMask=modemE1T1ChannelMask, modemACMmodulationMax=modemACMmodulationMax, modemErroredBlock=modemErroredBlock, atpcEnabled=atpcEnabled, modemACMtotalCapacity=modemACMtotalCapacity, ethRXCodeErrors=ethRXCodeErrors, modemGeneralStatus=modemGeneralStatus, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, vlanRowStatus=vlanRowStatus, ethTXGiants=ethTXGiants, ethTXCRCErrors=ethTXCRCErrors, ethRXLongEvents=ethRXLongEvents, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, loopback_tributary_mask=loopback_tributary_mask, atpcIndex=atpcIndex, license=license, modemRowStatus=modemRowStatus, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXBroadcasts=ethTXBroadcasts, sysTemperature=sysTemperature, modemLastAcqError=modemLastAcqError, ethTXControlFrames=ethTXControlFrames, ethGFPCHECErrors=ethGFPCHECErrors, ipRadio=ipRadio, e1t1ChannelNr=e1t1ChannelNr, modemSymbolRateTx=modemSymbolRateTx, hostname=hostname, vlanEntry=vlanEntry, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemUptime=modemUptime, ethRXControlFrames=ethRXControlFrames, safip=safip, ipRadioStat=ipRadioStat, radioRxLevel=radioRxLevel, modemAcqStatus=modemAcqStatus, ethGFPDropedFrames=ethGFPDropedFrames, modemEthernetCapacity=modemEthernetCapacity, description=description, saf=saf, ethQOSTXDropped=ethQOSTXDropped, modemRadialMSE=modemRadialMSE, modemSymbolRateRx=modemSymbolRateRx, radioLoopback=radioLoopback, pointToPoint=pointToPoint, radioTxFrequency=radioTxFrequency, ethTXByteCounterLow=ethTXByteCounterLow, ethTXMaxCollisions=ethTXMaxCollisions, ethGFPDelineationErrors=ethGFPDelineationErrors, vlanPortType=vlanPortType, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXBroadcasts=ethRXBroadcasts, ethQOSTXFrames=ethQOSTXFrames, modemACMethernetCapacity=modemACMethernetCapacity, vlanFid=vlanFid, tehnika=tehnika, e1t1StatEntry=e1t1StatEntry, modemStandard=modemStandard, remoteIp=remoteIp, ethRXPrevPktDropped=ethRXPrevPktDropped, localIpMask=localIpMask, modemCarrierOffset=modemCarrierOffset, ethGFPFCSErrors=ethGFPFCSErrors, modemTable=modemTable, ethRXDones=ethRXDones, modemBandwith=modemBandwith, product=product, localIp=localIp, modemModulation=modemModulation, e1t1LOS=e1t1LOS, ethTXByteCounterHi=ethTXByteCounterHi, radioSide=radioSide, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXUnderruns=ethTXUnderruns, radioGenStatus=radioGenStatus, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXMulticasts=ethRXMulticasts, modemCountTime=modemCountTime, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXDvEvent=ethRXDvEvent, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemStatistics=modemStatistics, ethTXPauseFrames=ethTXPauseFrames, modemTotalCapacity=modemTotalCapacity, ipRadioCfg=ipRadioCfg, ethRXByteCounterLow=ethRXByteCounterLow, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXVlanTags=ethTXVlanTags, aTPCTable=aTPCTable, modemErroredSecondRatio=modemErroredSecondRatio, radioEntry=radioEntry, ethRXCRCErrors=ethRXCRCErrors, restartcpu=restartcpu)
