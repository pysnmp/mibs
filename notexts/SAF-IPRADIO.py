...
mibBuilder.exportSymbols("SAF-IPRADIO", modemE1T1Channels=modemE1T1Channels, ethGFPDropedFrames=ethGFPDropedFrames, licenseUpdateStatus=licenseUpdateStatus, radioTxPower=radioTxPower, atpcEnabled=atpcEnabled, modemEntry=modemEntry, licenseMask=licenseMask, loopback_tributary_mask=loopback_tributary_mask, radioRxFrequency=radioRxFrequency, modemLDPCdecoderStress=modemLDPCdecoderStress, aTPCTable=aTPCTable, modemTable=modemTable, modemRowStatus=modemRowStatus, ipRadioCfgNetwork=ipRadioCfgNetwork, vlanPortType=vlanPortType, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXLongEvents=ethRXLongEvents, ethTXCollisions=ethTXCollisions, modemCountTime=modemCountTime, loopbacks=loopbacks, modemModulation=modemModulation, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, e1t1StatEntry=e1t1StatEntry, ethRXCodeErrors=ethRXCodeErrors, ethTXBroadcasts=ethTXBroadcasts, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXCRCErrors=ethTXCRCErrors, e1t1AIS=e1t1AIS, restartcpu=restartcpu, vlanEntry=vlanEntry, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXBackpresEvents=ethTXBackpresEvents, radioTxFrequency=radioTxFrequency, ipRadioStatEth=ipRadioStatEth, ethRXByteCounterHi=ethRXByteCounterHi, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXMulticasts=ethRXMulticasts, ethQOSRXQ2Frames=ethQOSRXQ2Frames, e1t1StatTable=e1t1StatTable, vlanNumber=vlanNumber, modemErroredBlock=modemErroredBlock, ipRadioCfgGeneral=ipRadioCfgGeneral, radioDuplexShift=radioDuplexShift, microwaveRadio=microwaveRadio, modemACMtotalCapacity=modemACMtotalCapacity, ethRXCRCErrors=ethRXCRCErrors, vlanFid=vlanFid, aTPCEntry=aTPCEntry, modemSymbolRateTx=modemSymbolRateTx, description=description, ethRXControlFrames=ethRXControlFrames, e1t1LOS=e1t1LOS, ethGFPCHECErrors=ethGFPCHECErrors, modemE1T1ChannelMask=modemE1T1ChannelMask, radioTable=radioTable, tehnika=tehnika, modemInternalAGCgain=modemInternalAGCgain, ethTXVlanTags=ethTXVlanTags, radioSide=radioSide, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemSymbolRateRx=modemSymbolRateRx, modemACMethernetCapacity=modemACMethernetCapacity, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ipRadioMgmt=ipRadioMgmt, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXWireByteCounterHi=ethTXWireByteCounterHi, localIp=localIp, atpcIndex=atpcIndex, ipRadioStat=ipRadioStat, localIpMask=localIpMask, ethGFPFCSErrors=ethGFPFCSErrors, modemTotalBlockNumber=modemTotalBlockNumber, radioEntry=radioEntry, ethTXUnderruns=ethTXUnderruns, modemAcqStatus=modemAcqStatus, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, remoteIp=remoteIp, radioGenStatus=radioGenStatus, ethRXTruncatedFrames=ethRXTruncatedFrames, modemRadialMSE=modemRadialMSE, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioRxLevel=radioRxLevel, ethQOSTXDropped=ethQOSTXDropped, license=license, vlanCfgStat=vlanCfgStat, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemUptime=modemUptime, radioTxMute=radioTxMute, modemBandwith=modemBandwith, ethTXByteCounterHi=ethTXByteCounterHi, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXDones=ethRXDones, sysDateAndTime=sysDateAndTime, modemACMmodulationMax=modemACMmodulationMax, modemErroredSecond=modemErroredSecond, ethTXControlFrames=ethTXControlFrames, saf=saf, ipRadio=ipRadio, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemStatistics=modemStatistics, ethRXDribleNibbles=ethRXDribleNibbles, modemErroredSecondRatio=modemErroredSecondRatio, ipRadioCfg=ipRadioCfg, modemACMengine=modemACMengine, ethTXExcessiveDefers=ethTXExcessiveDefers, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXGiants=ethTXGiants, modemStandard=modemStandard, ethTXPauseFrames=ethTXPauseFrames, ethRXByteCounterLow=ethRXByteCounterLow, e1t1ChannelNr=e1t1ChannelNr, safip=safip, writeConfig=writeConfig, vlansEnabled=vlansEnabled, modemGeneralStatus=modemGeneralStatus, vlanTable=vlanTable, modemSeverelyErroredSecond=modemSeverelyErroredSecond, vlanRowStatus=vlanRowStatus, modemUnavailtime=modemUnavailtime, ethTXDones=ethTXDones, ethRXBroadcasts=ethRXBroadcasts, ethQOSTXFrames=ethQOSTXFrames, ethRXDvEvent=ethRXDvEvent, radioIndex=radioIndex, radioLoopback=radioLoopback, ethRXPauseFrames=ethRXPauseFrames, ethTXMulticasts=ethTXMulticasts, modemIndex=modemIndex, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXLateCollisions=ethTXLateCollisions, ethTXMaxCollisions=ethTXMaxCollisions, product=product, hostname=hostname, modemTotalCapacity=modemTotalCapacity, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemCarrierOffset=modemCarrierOffset, pointToPoint=pointToPoint, ethTXByteCounterLow=ethTXByteCounterLow, modemLastAcqError=modemLastAcqError, modemACMmodulationMin=modemACMmodulationMin, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemEthernetCapacity=modemEthernetCapacity, vlanPortmap=vlanPortmap, sysTemperature=sysTemperature)
