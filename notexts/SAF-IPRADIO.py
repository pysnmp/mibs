...
mibBuilder.exportSymbols("SAF-IPRADIO", ethQOSTXDropped=ethQOSTXDropped, ethGFPDelineationErrors=ethGFPDelineationErrors, licenseUpdateStatus=licenseUpdateStatus, vlanTable=vlanTable, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioLoopback=radioLoopback, e1t1StatTable=e1t1StatTable, modemEntry=modemEntry, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemACMengine=modemACMengine, ethTXBackpresEvents=ethTXBackpresEvents, aTPCTable=aTPCTable, modemGeneralStatus=modemGeneralStatus, vlanEntry=vlanEntry, modemUnavailtime=modemUnavailtime, ethQOSTXFrames=ethQOSTXFrames, radioRxLevel=radioRxLevel, modemCarrierOffset=modemCarrierOffset, modemAcqStatus=modemAcqStatus, modemTotalCapacity=modemTotalCapacity, license=license, ethTXPauseFrames=ethTXPauseFrames, modemCountTime=modemCountTime, ethTXByteCounterHi=ethTXByteCounterHi, product=product, modemEthernetCapacity=modemEthernetCapacity, microwaveRadio=microwaveRadio, radioTxMute=radioTxMute, restartcpu=restartcpu, saf=saf, tehnika=tehnika, radioGenStatus=radioGenStatus, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXLongEvents=ethRXLongEvents, modemSymbolRateTx=modemSymbolRateTx, vlanPortmap=vlanPortmap, ethRXPrevPktDropped=ethRXPrevPktDropped, ipRadioCfg=ipRadioCfg, modemIndex=modemIndex, ipRadioCfgNetwork=ipRadioCfgNetwork, remoteIp=remoteIp, description=description, modemStandard=modemStandard, aTPCEntry=aTPCEntry, ethTXUnderruns=ethTXUnderruns, vlansEnabled=vlansEnabled, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXDribleNibbles=ethRXDribleNibbles, vlanRowStatus=vlanRowStatus, radioTable=radioTable, modemBandwith=modemBandwith, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemE1T1Channels=modemE1T1Channels, e1t1StatEntry=e1t1StatEntry, e1t1LOS=e1t1LOS, ethTXBroadcasts=ethTXBroadcasts, ethRXControlFrames=ethRXControlFrames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemErroredSecond=modemErroredSecond, localIpMask=localIpMask, modemTable=modemTable, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethGFPFCSErrors=ethGFPFCSErrors, vlanFid=vlanFid, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXBroadcasts=ethRXBroadcasts, ethTXGiants=ethTXGiants, radioTxFrequency=radioTxFrequency, ethRXPauseFrames=ethRXPauseFrames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ipRadioCfgGeneral=ipRadioCfgGeneral, modemRowStatus=modemRowStatus, ethRXDones=ethRXDones, sysTemperature=sysTemperature, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemACMmodulationMax=modemACMmodulationMax, ethTXMaxCollisions=ethTXMaxCollisions, ipRadioMgmt=ipRadioMgmt, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXByteCounterHi=ethRXByteCounterHi, atpcEnabled=atpcEnabled, ethTXControlFrames=ethTXControlFrames, ethTXCRCErrors=ethTXCRCErrors, radioEntry=radioEntry, ethGFPDropedFrames=ethGFPDropedFrames, ethTXLateCollisions=ethTXLateCollisions, ethRXCodeErrors=ethRXCodeErrors, modemUptime=modemUptime, modemInternalAGCgain=modemInternalAGCgain, radioIndex=radioIndex, ethRXCRCErrors=ethRXCRCErrors, ethTXDones=ethTXDones, radioRxFrequency=radioRxFrequency, ethTXWireByteCounterLow=ethTXWireByteCounterLow, vlanPortType=vlanPortType, ethRXByteCounterLow=ethRXByteCounterLow, radioDuplexShift=radioDuplexShift, modemStatistics=modemStatistics, writeConfig=writeConfig, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXMulticasts=ethTXMulticasts, ethTXExcessiveDefers=ethTXExcessiveDefers, hostname=hostname, ethTXByteCounterLow=ethTXByteCounterLow, ethTXCollisions=ethTXCollisions, licenseMask=licenseMask, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemRadialMSE=modemRadialMSE, localIp=localIp, ethGFPCHECErrors=ethGFPCHECErrors, pointToPoint=pointToPoint, ethRXDvEvent=ethRXDvEvent, safip=safip, modemACMtotalCapacity=modemACMtotalCapacity, modemLDPCdecoderStress=modemLDPCdecoderStress, modemE1T1ChannelMask=modemE1T1ChannelMask, modemErroredBlock=modemErroredBlock, ethRXUnsupOpcodes=ethRXUnsupOpcodes, loopback_tributary_mask=loopback_tributary_mask, vlanCfgStat=vlanCfgStat, e1t1ChannelNr=e1t1ChannelNr, modemSymbolRateRx=modemSymbolRateRx, radioSide=radioSide, modemACMethernetCapacity=modemACMethernetCapacity, atpcIndex=atpcIndex, e1t1AIS=e1t1AIS, sysDateAndTime=sysDateAndTime, vlanNumber=vlanNumber, ipRadioStat=ipRadioStat, ipRadio=ipRadio, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemModulation=modemModulation, loopbacks=loopbacks, ipRadioStatEth=ipRadioStatEth, ethTXVlanTags=ethTXVlanTags, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemLastAcqError=modemLastAcqError, modemErroredSecondRatio=modemErroredSecondRatio, radioTxPower=radioTxPower, ethRXMulticasts=ethRXMulticasts, modemACMmodulationMin=modemACMmodulationMin, modemTotalBlockNumber=modemTotalBlockNumber, ethRXTruncatedFrames=ethRXTruncatedFrames)
