...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXDribleNibbles=ethRXDribleNibbles, ethGFPFCSErrors=ethGFPFCSErrors, vlanPortType=vlanPortType, license=license, vlanRowStatus=vlanRowStatus, aTPCEntry=aTPCEntry, modemACMmodulationMax=modemACMmodulationMax, ipRadioCfg=ipRadioCfg, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXCollisions=ethTXCollisions, modemRowStatus=modemRowStatus, ethRXControlFrames=ethRXControlFrames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, microwaveRadio=microwaveRadio, restartcpu=restartcpu, vlanTable=vlanTable, ethQOSTXFrames=ethQOSTXFrames, modemLDPCdecoderStress=modemLDPCdecoderStress, hostname=hostname, modemEthernetCapacity=modemEthernetCapacity, modemE1T1Channels=modemE1T1Channels, pointToPoint=pointToPoint, modemErroredBlock=modemErroredBlock, radioGenStatus=radioGenStatus, atpcEnabled=atpcEnabled, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemCarrierOffset=modemCarrierOffset, saf=saf, ipRadio=ipRadio, localIp=localIp, ethRXByteCounterHi=ethRXByteCounterHi, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemLastAcqError=modemLastAcqError, modemModulation=modemModulation, ethTXDones=ethTXDones, ipRadioStat=ipRadioStat, radioDuplexShift=radioDuplexShift, radioSide=radioSide, ethRXTruncatedFrames=ethRXTruncatedFrames, radioRxFrequency=radioRxFrequency, ethRXBroadcasts=ethRXBroadcasts, modemACMengine=modemACMengine, modemStandard=modemStandard, ethTXBroadcasts=ethTXBroadcasts, loopback_tributary_mask=loopback_tributary_mask, sysDateAndTime=sysDateAndTime, radioTable=radioTable, modemEntry=modemEntry, modemSymbolRateTx=modemSymbolRateTx, ethRXCodeErrors=ethRXCodeErrors, ethRXCRCErrors=ethRXCRCErrors, radioIndex=radioIndex, modemInternalAGCgain=modemInternalAGCgain, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, tehnika=tehnika, sysTemperature=sysTemperature, e1t1StatTable=e1t1StatTable, radioTxPower=radioTxPower, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXCRCErrors=ethTXCRCErrors, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioTxFrequency=radioTxFrequency, ipRadioMgmt=ipRadioMgmt, modemACMtotalCapacity=modemACMtotalCapacity, ethGFPCHECErrors=ethGFPCHECErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemBandwith=modemBandwith, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXBackpresEvents=ethTXBackpresEvents, ipRadioCfgNetwork=ipRadioCfgNetwork, description=description, ethTXByteCounterLow=ethTXByteCounterLow, modemErroredSecond=modemErroredSecond, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, localIpMask=localIpMask, radioRxLevel=radioRxLevel, ethRXDones=ethRXDones, radioLoopback=radioLoopback, licenseMask=licenseMask, ethRXByteCounterLow=ethRXByteCounterLow, ethRXMulticasts=ethRXMulticasts, ethTXByteCounterHi=ethTXByteCounterHi, modemSymbolRateRx=modemSymbolRateRx, modemIndex=modemIndex, vlanFid=vlanFid, ethGFPDelineationErrors=ethGFPDelineationErrors, ethQOSTXDropped=ethQOSTXDropped, modemUptime=modemUptime, e1t1AIS=e1t1AIS, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXVlanTags=ethTXVlanTags, vlansEnabled=vlansEnabled, remoteIp=remoteIp, modemTotalCapacity=modemTotalCapacity, ethTXControlFrames=ethTXControlFrames, ethTXMulticasts=ethTXMulticasts, aTPCTable=aTPCTable, vlanEntry=vlanEntry, ethTXGiants=ethTXGiants, vlanCfgStat=vlanCfgStat, ethRXLongEvents=ethRXLongEvents, e1t1LOS=e1t1LOS, radioTxMute=radioTxMute, ethTXLateCollisions=ethTXLateCollisions, modemTotalBlockNumber=modemTotalBlockNumber, ethTXPauseFrames=ethTXPauseFrames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, e1t1ChannelNr=e1t1ChannelNr, product=product, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemAcqStatus=modemAcqStatus, e1t1StatEntry=e1t1StatEntry, modemGeneralStatus=modemGeneralStatus, ethTXWireByteCounterHi=ethTXWireByteCounterHi, safip=safip, modemACMmodulationMin=modemACMmodulationMin, ethTXUnderruns=ethTXUnderruns, modemCountTime=modemCountTime, licenseUpdateStatus=licenseUpdateStatus, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ipRadioStatEth=ipRadioStatEth, modemE1T1ChannelMask=modemE1T1ChannelMask, modemUnavailtime=modemUnavailtime, modemStatistics=modemStatistics, atpcIndex=atpcIndex, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemErroredSecondRatio=modemErroredSecondRatio, radioEntry=radioEntry, modemACMethernetCapacity=modemACMethernetCapacity, loopbacks=loopbacks, ethRXPauseFrames=ethRXPauseFrames, writeConfig=writeConfig, ethGFPDropedFrames=ethGFPDropedFrames, modemRadialMSE=modemRadialMSE, modemTable=modemTable, ethRXDvEvent=ethRXDvEvent, vlanPortmap=vlanPortmap, vlanNumber=vlanNumber, ethTXMaxCollisions=ethTXMaxCollisions)
