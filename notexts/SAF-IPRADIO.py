...
mibBuilder.exportSymbols("SAF-IPRADIO", license=license, modemCarrierOffset=modemCarrierOffset, description=description, modemACMethernetCapacity=modemACMethernetCapacity, ethTXCollisions=ethTXCollisions, modemE1T1Channels=modemE1T1Channels, ethRXByteCounterHi=ethRXByteCounterHi, ethTXByteCounterLow=ethTXByteCounterLow, ethRXUnsupOpcodes=ethRXUnsupOpcodes, hostname=hostname, ethRXDribleNibbles=ethRXDribleNibbles, microwaveRadio=microwaveRadio, ethRXDones=ethRXDones, vlanTable=vlanTable, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemUnavailtime=modemUnavailtime, modemACMtotalCapacity=modemACMtotalCapacity, ethRXDvEvent=ethRXDvEvent, radioTxMute=radioTxMute, ethGFPDelineationErrors=ethGFPDelineationErrors, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXLateCollisions=ethTXLateCollisions, modemModulation=modemModulation, radioTable=radioTable, ethRXPrevPktDropped=ethRXPrevPktDropped, localIpMask=localIpMask, vlanCfgStat=vlanCfgStat, ethTXMaxCollisions=ethTXMaxCollisions, modemACMmodulationMax=modemACMmodulationMax, ethRXBroadcasts=ethRXBroadcasts, licenseUpdateStatus=licenseUpdateStatus, ipRadio=ipRadio, ethGFPDropedFrames=ethGFPDropedFrames, loopbacks=loopbacks, ipRadioCfg=ipRadioCfg, radioLoopback=radioLoopback, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioIndex=radioIndex, ethTXCRCErrors=ethTXCRCErrors, ethGFPCHECErrors=ethGFPCHECErrors, safip=safip, remoteIp=remoteIp, modemUptime=modemUptime, saf=saf, ethRXLongEvents=ethRXLongEvents, ethGFPFCSErrors=ethGFPFCSErrors, aTPCTable=aTPCTable, modemACMmodulationMin=modemACMmodulationMin, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemIndex=modemIndex, ethTXUnderruns=ethTXUnderruns, e1t1ChannelNr=e1t1ChannelNr, radioGenStatus=radioGenStatus, modemInternalAGCgain=modemInternalAGCgain, vlansEnabled=vlansEnabled, e1t1StatEntry=e1t1StatEntry, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXCRCErrors=ethRXCRCErrors, modemErroredSecond=modemErroredSecond, pointToPoint=pointToPoint, modemGeneralStatus=modemGeneralStatus, modemEthernetCapacity=modemEthernetCapacity, radioRxLevel=radioRxLevel, ethTXPauseFrames=ethTXPauseFrames, modemSymbolRateRx=modemSymbolRateRx, ipRadioCfgGeneral=ipRadioCfgGeneral, modemLastAcqError=modemLastAcqError, radioEntry=radioEntry, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioRxFrequency=radioRxFrequency, atpcEnabled=atpcEnabled, modemTable=modemTable, ethRXCodeErrors=ethRXCodeErrors, modemBandwith=modemBandwith, product=product, vlanNumber=vlanNumber, localIp=localIp, vlanRowStatus=vlanRowStatus, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXVlanTags=ethTXVlanTags, modemACMengine=modemACMengine, modemErroredSecondRatio=modemErroredSecondRatio, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemEntry=modemEntry, aTPCEntry=aTPCEntry, ethRXPauseFrames=ethRXPauseFrames, ethRXControlFrames=ethRXControlFrames, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemRadialMSE=modemRadialMSE, ipRadioStat=ipRadioStat, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemSymbolRateTx=modemSymbolRateTx, ethTXExcessiveDefers=ethTXExcessiveDefers, atpcTxPowerCorrection=atpcTxPowerCorrection, e1t1LOS=e1t1LOS, loopback_tributary_mask=loopback_tributary_mask, vlanPortType=vlanPortType, ethTXBackpresEvents=ethTXBackpresEvents, ipRadioMgmt=ipRadioMgmt, radioSide=radioSide, ethTXGiants=ethTXGiants, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemTotalBlockNumber=modemTotalBlockNumber, restartcpu=restartcpu, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemErroredBlock=modemErroredBlock, ethTXLengthCheckErrors=ethTXLengthCheckErrors, atpcIndex=atpcIndex, vlanFid=vlanFid, modemCountTime=modemCountTime, ethTXMulticasts=ethTXMulticasts, modemStatistics=modemStatistics, ethQOSTXFrames=ethQOSTXFrames, radioTxPower=radioTxPower, ethQOSRXQ1Frames=ethQOSRXQ1Frames, sysDateAndTime=sysDateAndTime, tehnika=tehnika, ethRXMulticasts=ethRXMulticasts, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, writeConfig=writeConfig, licenseMask=licenseMask, sysTemperature=sysTemperature, ipRadioStatEth=ipRadioStatEth, modemTotalCapacity=modemTotalCapacity, modemAcqStatus=modemAcqStatus, ethTXDones=ethTXDones, radioDuplexShift=radioDuplexShift, ethRXByteCounterLow=ethRXByteCounterLow, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, vlanEntry=vlanEntry, ethQOSTXDropped=ethQOSTXDropped, modemRowStatus=modemRowStatus, ethTXControlFrames=ethTXControlFrames, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXBroadcasts=ethTXBroadcasts, vlanPortmap=vlanPortmap, e1t1StatTable=e1t1StatTable, e1t1AIS=e1t1AIS, radioTxFrequency=radioTxFrequency, modemStandard=modemStandard, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXByteCounterHi=ethTXByteCounterHi)
