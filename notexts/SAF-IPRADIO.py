...
mibBuilder.exportSymbols("SAF-IPRADIO", licenseUpdateStatus=licenseUpdateStatus, radioLoopback=radioLoopback, loopbacks=loopbacks, modemLDPCdecoderStress=modemLDPCdecoderStress, radioDuplexShift=radioDuplexShift, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, atpcEnabled=atpcEnabled, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemACMmodulationMin=modemACMmodulationMin, ethTXByteCounterLow=ethTXByteCounterLow, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, vlanPortmap=vlanPortmap, vlanFid=vlanFid, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXPauseFrames=ethRXPauseFrames, ethGFPCHECErrors=ethGFPCHECErrors, ethTXPauseFrames=ethTXPauseFrames, ethGFPDropedFrames=ethGFPDropedFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXDones=ethTXDones, ethTXControlFrames=ethTXControlFrames, radioTxPower=radioTxPower, e1t1ChannelNr=e1t1ChannelNr, modemInternalAGCgain=modemInternalAGCgain, ethTXCRCErrors=ethTXCRCErrors, modemStandard=modemStandard, restartcpu=restartcpu, ethRXCRCErrors=ethRXCRCErrors, saf=saf, modemCarrierOffset=modemCarrierOffset, ethTXMaxCollisions=ethTXMaxCollisions, vlanTable=vlanTable, radioIndex=radioIndex, e1t1StatEntry=e1t1StatEntry, modemErroredBlock=modemErroredBlock, writeConfig=writeConfig, ethRXDvEvent=ethRXDvEvent, ethTXBroadcasts=ethTXBroadcasts, modemLastAcqError=modemLastAcqError, ethTXVlanTags=ethTXVlanTags, radioTxMute=radioTxMute, localIpMask=localIpMask, localIp=localIp, modemGeneralStatus=modemGeneralStatus, ethRXLongEvents=ethRXLongEvents, ethRXMulticasts=ethRXMulticasts, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXExcessiveDefers=ethTXExcessiveDefers, ipRadioCfgGeneral=ipRadioCfgGeneral, ethQOSTXFrames=ethQOSTXFrames, remoteIp=remoteIp, safip=safip, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethQOSTXDropped=ethQOSTXDropped, microwaveRadio=microwaveRadio, modemUnavailtime=modemUnavailtime, ethRXByteCounterHi=ethRXByteCounterHi, e1t1LOS=e1t1LOS, modemIndex=modemIndex, description=description, vlanRowStatus=vlanRowStatus, atpcIndex=atpcIndex, atpcTxPowerCorrection=atpcTxPowerCorrection, ipRadioStat=ipRadioStat, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemTotalBlockNumber=modemTotalBlockNumber, ipRadioCfg=ipRadioCfg, ipRadio=ipRadio, vlansEnabled=vlansEnabled, vlanPortType=vlanPortType, license=license, modemTotalCapacity=modemTotalCapacity, modemBackgroundBlockErrror=modemBackgroundBlockErrror, product=product, ethRXByteCounterLow=ethRXByteCounterLow, ethTXWireByteCounterLow=ethTXWireByteCounterLow, e1t1StatTable=e1t1StatTable, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXDribleNibbles=ethRXDribleNibbles, ethRXVlanTagsDetected=ethRXVlanTagsDetected, vlanCfgStat=vlanCfgStat, ethTXGiants=ethTXGiants, modemE1T1Channels=modemE1T1Channels, radioRxFrequency=radioRxFrequency, modemBandwith=modemBandwith, licenseMask=licenseMask, ethGFPFCSErrors=ethGFPFCSErrors, radioEntry=radioEntry, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemStatistics=modemStatistics, aTPCTable=aTPCTable, modemACMethernetCapacity=modemACMethernetCapacity, modemSymbolRateTx=modemSymbolRateTx, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ipRadioStatEth=ipRadioStatEth, aTPCEntry=aTPCEntry, ethTXBackpresEvents=ethTXBackpresEvents, ethRXDones=ethRXDones, radioTable=radioTable, modemACMengine=modemACMengine, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXUnderruns=ethTXUnderruns, radioTxFrequency=radioTxFrequency, sysDateAndTime=sysDateAndTime, radioRxLevel=radioRxLevel, ethTXCollisions=ethTXCollisions, ipRadioCfgNetwork=ipRadioCfgNetwork, modemEntry=modemEntry, ethTXByteCounterHi=ethTXByteCounterHi, modemACMmodulationMax=modemACMmodulationMax, vlanNumber=vlanNumber, modemModulation=modemModulation, ipRadioMgmt=ipRadioMgmt, tehnika=tehnika, ethTXMulticasts=ethTXMulticasts, e1t1AIS=e1t1AIS, radioGenStatus=radioGenStatus, sysTemperature=sysTemperature, modemCountTime=modemCountTime, ethRXCodeErrors=ethRXCodeErrors, pointToPoint=pointToPoint, modemUptime=modemUptime, modemRadialMSE=modemRadialMSE, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXPrevPktDropped=ethRXPrevPktDropped, modemACMtotalCapacity=modemACMtotalCapacity, modemRowStatus=modemRowStatus, modemEthernetCapacity=modemEthernetCapacity, loopback_tributary_mask=loopback_tributary_mask, modemAcqStatus=modemAcqStatus, ethTXLateCollisions=ethTXLateCollisions, vlanEntry=vlanEntry, ethRXControlFrames=ethRXControlFrames, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioSide=radioSide, modemSymbolRateRx=modemSymbolRateRx, ethRXTruncatedFrames=ethRXTruncatedFrames, modemTable=modemTable, modemErroredSecondRatio=modemErroredSecondRatio, modemErroredSecond=modemErroredSecond, ethRXBroadcasts=ethRXBroadcasts, hostname=hostname)
