...
mibBuilder.exportSymbols("SAF-IPRADIO", modemCountTime=modemCountTime, vlanFid=vlanFid, modemInternalAGCgain=modemInternalAGCgain, ethTXByteCounterLow=ethTXByteCounterLow, ethQOSTXDropped=ethQOSTXDropped, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXDribleNibbles=ethRXDribleNibbles, microwaveRadio=microwaveRadio, modemStandard=modemStandard, ethRXCRCErrors=ethRXCRCErrors, modemACMethernetCapacity=modemACMethernetCapacity, tehnika=tehnika, ethRXDones=ethRXDones, modemE1T1Channels=modemE1T1Channels, localIp=localIp, ethTXUnderruns=ethTXUnderruns, radioRxLevel=radioRxLevel, ethGFPCHECErrors=ethGFPCHECErrors, modemCarrierOffset=modemCarrierOffset, ethRXLongEvents=ethRXLongEvents, modemSymbolRateTx=modemSymbolRateTx, e1t1StatTable=e1t1StatTable, radioRxFrequency=radioRxFrequency, modemACMengine=modemACMengine, vlanPortType=vlanPortType, modemRowStatus=modemRowStatus, hostname=hostname, safip=safip, radioTxPower=radioTxPower, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethGFPFCSErrors=ethGFPFCSErrors, ethRXByteCounterHi=ethRXByteCounterHi, radioIndex=radioIndex, aTPCTable=aTPCTable, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXLateCollisions=ethTXLateCollisions, radioLoopback=radioLoopback, ethGFPDropedFrames=ethGFPDropedFrames, ipRadioStat=ipRadioStat, modemErroredBlock=modemErroredBlock, aTPCEntry=aTPCEntry, vlanRowStatus=vlanRowStatus, ethRXPauseFrames=ethRXPauseFrames, radioSide=radioSide, loopbacks=loopbacks, modemSeverelyErroredSecond=modemSeverelyErroredSecond, licenseMask=licenseMask, e1t1AIS=e1t1AIS, writeConfig=writeConfig, modemErroredSecondRatio=modemErroredSecondRatio, vlanCfgStat=vlanCfgStat, radioEntry=radioEntry, modemLDPCdecoderStress=modemLDPCdecoderStress, remoteIp=remoteIp, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemTable=modemTable, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXControlFrames=ethRXControlFrames, ipRadioCfg=ipRadioCfg, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXPauseFrames=ethTXPauseFrames, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemUnavailtime=modemUnavailtime, modemTotalCapacity=modemTotalCapacity, ethRXByteCounterLow=ethRXByteCounterLow, product=product, modemIndex=modemIndex, modemLastAcqError=modemLastAcqError, ethTXMaxCollisions=ethTXMaxCollisions, radioTxFrequency=radioTxFrequency, ethTXGiants=ethTXGiants, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemSymbolRateRx=modemSymbolRateRx, ethRXCodeErrors=ethRXCodeErrors, pointToPoint=pointToPoint, ethTXBackpresEvents=ethTXBackpresEvents, radioDuplexShift=radioDuplexShift, modemRadialMSE=modemRadialMSE, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ipRadioMgmt=ipRadioMgmt, license=license, vlanEntry=vlanEntry, ethRXMulticasts=ethRXMulticasts, vlanTable=vlanTable, e1t1ChannelNr=e1t1ChannelNr, modemAcqStatus=modemAcqStatus, description=description, radioTable=radioTable, modemStatistics=modemStatistics, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXExcessiveDefers=ethTXExcessiveDefers, modemACMtotalCapacity=modemACMtotalCapacity, modemGeneralStatus=modemGeneralStatus, loopback_tributary_mask=loopback_tributary_mask, vlanPortmap=vlanPortmap, ethTXMulticasts=ethTXMulticasts, ethTXDones=ethTXDones, e1t1LOS=e1t1LOS, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethGFPDelineationErrors=ethGFPDelineationErrors, modemACMmodulationMin=modemACMmodulationMin, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXControlFrames=ethTXControlFrames, ethTXCRCErrors=ethTXCRCErrors, modemTotalBlockNumber=modemTotalBlockNumber, ethRXDvEvent=ethRXDvEvent, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXByteCounterHi=ethTXByteCounterHi, ethTXVlanTags=ethTXVlanTags, sysTemperature=sysTemperature, ethRXBroadcasts=ethRXBroadcasts, atpcIndex=atpcIndex, restartcpu=restartcpu, sysDateAndTime=sysDateAndTime, modemModulation=modemModulation, ipRadioStatEth=ipRadioStatEth, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, radioTxMute=radioTxMute, licenseUpdateStatus=licenseUpdateStatus, e1t1StatEntry=e1t1StatEntry, modemACMmodulationMax=modemACMmodulationMax, saf=saf, atpcEnabled=atpcEnabled, ipRadio=ipRadio, modemEthernetCapacity=modemEthernetCapacity, modemUptime=modemUptime, modemErroredSecond=modemErroredSecond, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXBroadcasts=ethTXBroadcasts, modemBandwith=modemBandwith, modemEntry=modemEntry, vlanNumber=vlanNumber, ethTXCollisions=ethTXCollisions, vlansEnabled=vlansEnabled, ethRXVlanTagsDetected=ethRXVlanTagsDetected, localIpMask=localIpMask, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemE1T1ChannelMask=modemE1T1ChannelMask, ethQOSTXFrames=ethQOSTXFrames, radioGenStatus=radioGenStatus)
