...
mibBuilder.exportSymbols("SAF-IPRADIO", modemGeneralStatus=modemGeneralStatus, ethQOSTXFrames=ethQOSTXFrames, e1t1StatTable=e1t1StatTable, modemLastAcqError=modemLastAcqError, ipRadio=ipRadio, licenseMask=licenseMask, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, e1t1LOS=e1t1LOS, pointToPoint=pointToPoint, modemEntry=modemEntry, vlanPortmap=vlanPortmap, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXByteCounterLow=ethRXByteCounterLow, ethRXCodeErrors=ethRXCodeErrors, ethTXByteCounterLow=ethTXByteCounterLow, radioSide=radioSide, modemRadialMSE=modemRadialMSE, ethTXByteCounterHi=ethTXByteCounterHi, tehnika=tehnika, ethRXDribleNibbles=ethRXDribleNibbles, ipRadioMgmt=ipRadioMgmt, e1t1AIS=e1t1AIS, ethRXPrevPktDropped=ethRXPrevPktDropped, vlansEnabled=vlansEnabled, ethTXBroadcasts=ethTXBroadcasts, restartcpu=restartcpu, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemE1T1Channels=modemE1T1Channels, radioIndex=radioIndex, modemErroredSecondRatio=modemErroredSecondRatio, aTPCEntry=aTPCEntry, ipRadioStatEth=ipRadioStatEth, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemCarrierOffset=modemCarrierOffset, modemE1T1ChannelMask=modemE1T1ChannelMask, radioLoopback=radioLoopback, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioTxFrequency=radioTxFrequency, modemBandwith=modemBandwith, modemCountTime=modemCountTime, modemErroredSecond=modemErroredSecond, radioTxPower=radioTxPower, modemEthernetCapacity=modemEthernetCapacity, modemStatistics=modemStatistics, localIpMask=localIpMask, atpcEnabled=atpcEnabled, e1t1StatEntry=e1t1StatEntry, ethQOSRXQ1Frames=ethQOSRXQ1Frames, atpcIndex=atpcIndex, saf=saf, microwaveRadio=microwaveRadio, vlanNumber=vlanNumber, vlanEntry=vlanEntry, modemModulation=modemModulation, ethTXCollisions=ethTXCollisions, localIp=localIp, ethGFPDelineationErrors=ethGFPDelineationErrors, writeConfig=writeConfig, modemACMmodulationMax=modemACMmodulationMax, product=product, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, hostname=hostname, loopback_tributary_mask=loopback_tributary_mask, ethRXByteCounterHi=ethRXByteCounterHi, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ipRadioStat=ipRadioStat, ethRXCRCErrors=ethRXCRCErrors, radioGenStatus=radioGenStatus, loopbacks=loopbacks, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXDones=ethRXDones, modemTotalBlockNumber=modemTotalBlockNumber, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemSymbolRateTx=modemSymbolRateTx, ethTXUnderruns=ethTXUnderruns, vlanTable=vlanTable, vlanFid=vlanFid, ethRXControlFrames=ethRXControlFrames, radioDuplexShift=radioDuplexShift, modemTable=modemTable, modemTotalCapacity=modemTotalCapacity, radioRxFrequency=radioRxFrequency, license=license, radioRxLevel=radioRxLevel, modemLDPCdecoderStress=modemLDPCdecoderStress, modemIndex=modemIndex, ethQOSRXQ2Frames=ethQOSRXQ2Frames, licenseUpdateStatus=licenseUpdateStatus, sysDateAndTime=sysDateAndTime, ethRXPauseFrames=ethRXPauseFrames, ethRXDvEvent=ethRXDvEvent, ethTXDones=ethTXDones, modemUnavailtime=modemUnavailtime, radioTxMute=radioTxMute, modemErroredBlock=modemErroredBlock, modemRowStatus=modemRowStatus, ethGFPCHECErrors=ethGFPCHECErrors, e1t1ChannelNr=e1t1ChannelNr, description=description, modemACMethernetCapacity=modemACMethernetCapacity, sysTemperature=sysTemperature, ethTXControlFrames=ethTXControlFrames, modemACMengine=modemACMengine, ethRXBroadcasts=ethRXBroadcasts, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXBackpresEvents=ethTXBackpresEvents, ethRXLongEvents=ethRXLongEvents, vlanRowStatus=vlanRowStatus, modemAcqStatus=modemAcqStatus, modemUptime=modemUptime, ethGFPDropedFrames=ethGFPDropedFrames, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ipRadioCfg=ipRadioCfg, ethTXGiants=ethTXGiants, ethTXMaxCollisions=ethTXMaxCollisions, modemInternalAGCgain=modemInternalAGCgain, aTPCTable=aTPCTable, modemACMtotalCapacity=modemACMtotalCapacity, remoteIp=remoteIp, ethTXPauseFrames=ethTXPauseFrames, modemSymbolRateRx=modemSymbolRateRx, ethGFPFCSErrors=ethGFPFCSErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, modemACMmodulationMin=modemACMmodulationMin, ipRadioCfgNetwork=ipRadioCfgNetwork, vlanCfgStat=vlanCfgStat, ethTXLateCollisions=ethTXLateCollisions, ethTXVlanTags=ethTXVlanTags, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXCRCErrors=ethTXCRCErrors, radioEntry=radioEntry, safip=safip, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioTable=radioTable, ethTXMulticasts=ethTXMulticasts, ethQOSTXDropped=ethQOSTXDropped, atpcTxPowerCorrection=atpcTxPowerCorrection, modemStandard=modemStandard, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXMulticasts=ethRXMulticasts, vlanPortType=vlanPortType, ethTXExcessiveDefers=ethTXExcessiveDefers)
