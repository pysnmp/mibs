...
mibBuilder.exportSymbols("SAF-IPRADIO", radioLoopback=radioLoopback, ethRXLongEvents=ethRXLongEvents, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemEntry=modemEntry, modemACMmodulationMax=modemACMmodulationMax, ethGFPCHECErrors=ethGFPCHECErrors, ethTXMulticasts=ethTXMulticasts, ethRXDribleNibbles=ethRXDribleNibbles, saf=saf, modemLDPCdecoderStress=modemLDPCdecoderStress, ethGFPFCSErrors=ethGFPFCSErrors, sysTemperature=sysTemperature, modemModulation=modemModulation, licenseUpdateStatus=licenseUpdateStatus, ethRXByteCounterHi=ethRXByteCounterHi, modemGeneralStatus=modemGeneralStatus, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXLateCollisions=ethTXLateCollisions, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ipRadioCfgGeneral=ipRadioCfgGeneral, vlanTable=vlanTable, ethRXBroadcasts=ethRXBroadcasts, ethRXPauseFrames=ethRXPauseFrames, modemTable=modemTable, modemEthernetCapacity=modemEthernetCapacity, ipRadioMgmt=ipRadioMgmt, modemLastAcqError=modemLastAcqError, vlanCfgStat=vlanCfgStat, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioDuplexShift=radioDuplexShift, ethRXMulticasts=ethRXMulticasts, vlanPortmap=vlanPortmap, ipRadio=ipRadio, ipRadioStatEth=ipRadioStatEth, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXVlanTagsDetected=ethRXVlanTagsDetected, atpcEnabled=atpcEnabled, radioTxFrequency=radioTxFrequency, loopbacks=loopbacks, modemACMmodulationMin=modemACMmodulationMin, ethTXByteCounterHi=ethTXByteCounterHi, ethRXTruncatedFrames=ethRXTruncatedFrames, localIpMask=localIpMask, tehnika=tehnika, ethGFPDelineationErrors=ethGFPDelineationErrors, aTPCTable=aTPCTable, modemBandwith=modemBandwith, atpcTxPowerCorrection=atpcTxPowerCorrection, vlanPortType=vlanPortType, ethTXBackpresEvents=ethTXBackpresEvents, licenseMask=licenseMask, modemE1T1Channels=modemE1T1Channels, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemTotalCapacity=modemTotalCapacity, loopback_tributary_mask=loopback_tributary_mask, ethQOSTXFrames=ethQOSTXFrames, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, vlanFid=vlanFid, vlanNumber=vlanNumber, ipRadioCfg=ipRadioCfg, ethQOSTXDropped=ethQOSTXDropped, radioRxLevel=radioRxLevel, microwaveRadio=microwaveRadio, ethTXUnderruns=ethTXUnderruns, modemACMengine=modemACMengine, ethTXControlFrames=ethTXControlFrames, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, pointToPoint=pointToPoint, ethTXDones=ethTXDones, radioTable=radioTable, modemCarrierOffset=modemCarrierOffset, modemACMtotalCapacity=modemACMtotalCapacity, product=product, ethTXWireByteCounterHi=ethTXWireByteCounterHi, remoteIp=remoteIp, ethRXCRCErrors=ethRXCRCErrors, ethTXCRCErrors=ethTXCRCErrors, modemUnavailtime=modemUnavailtime, modemTotalBlockNumber=modemTotalBlockNumber, ethRXControlFrames=ethRXControlFrames, atpcIndex=atpcIndex, modemStatistics=modemStatistics, sysDateAndTime=sysDateAndTime, ipRadioStat=ipRadioStat, ethRXPrevPktDropped=ethRXPrevPktDropped, e1t1AIS=e1t1AIS, ethRXUnsupOpcodes=ethRXUnsupOpcodes, e1t1LOS=e1t1LOS, license=license, ethTXMaxCollisions=ethTXMaxCollisions, safip=safip, vlanRowStatus=vlanRowStatus, modemIndex=modemIndex, modemInternalAGCgain=modemInternalAGCgain, writeConfig=writeConfig, e1t1StatEntry=e1t1StatEntry, e1t1ChannelNr=e1t1ChannelNr, description=description, modemRadialMSE=modemRadialMSE, radioRxFrequency=radioRxFrequency, hostname=hostname, ethTXPauseFrames=ethTXPauseFrames, ethRXCodeErrors=ethRXCodeErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemAcqStatus=modemAcqStatus, e1t1StatTable=e1t1StatTable, ethTXBroadcasts=ethTXBroadcasts, modemErroredSecondRatio=modemErroredSecondRatio, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemRowStatus=modemRowStatus, modemCountTime=modemCountTime, ipRadioCfgNetwork=ipRadioCfgNetwork, modemSymbolRateTx=modemSymbolRateTx, ethGFPDropedFrames=ethGFPDropedFrames, modemSymbolRateRx=modemSymbolRateRx, radioTxMute=radioTxMute, ethTXVlanTags=ethTXVlanTags, restartcpu=restartcpu, modemACMethernetCapacity=modemACMethernetCapacity, ethTXWireByteCounterLow=ethTXWireByteCounterLow, aTPCEntry=aTPCEntry, ethTXByteCounterLow=ethTXByteCounterLow, radioGenStatus=radioGenStatus, radioTxPower=radioTxPower, vlanEntry=vlanEntry, localIp=localIp, modemErroredSecond=modemErroredSecond, ethRXDones=ethRXDones, radioIndex=radioIndex, modemUptime=modemUptime, ethTXExcessiveDefers=ethTXExcessiveDefers, radioSide=radioSide, vlansEnabled=vlansEnabled, ethTXCollisions=ethTXCollisions, ethTXGiants=ethTXGiants, modemStandard=modemStandard, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXByteCounterLow=ethRXByteCounterLow, radioEntry=radioEntry, modemErroredBlock=modemErroredBlock, ethRXDvEvent=ethRXDvEvent)
