...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXCRCErrors=ethRXCRCErrors, ethTXVlanTags=ethTXVlanTags, modemEntry=modemEntry, modemACMengine=modemACMengine, vlanNumber=vlanNumber, modemInternalAGCgain=modemInternalAGCgain, radioEntry=radioEntry, ethGFPDropedFrames=ethGFPDropedFrames, modemRowStatus=modemRowStatus, radioTxFrequency=radioTxFrequency, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXUnderruns=ethTXUnderruns, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, description=description, ethRXControlFrames=ethRXControlFrames, ethGFPCHECErrors=ethGFPCHECErrors, modemAcqStatus=modemAcqStatus, radioRxLevel=radioRxLevel, ethGFPDelineationErrors=ethGFPDelineationErrors, aTPCEntry=aTPCEntry, modemSymbolRateTx=modemSymbolRateTx, ethGFPFCSErrors=ethGFPFCSErrors, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioSide=radioSide, modemACMtotalCapacity=modemACMtotalCapacity, ethRXDvEvent=ethRXDvEvent, modemCarrierOffset=modemCarrierOffset, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXPauseFrames=ethTXPauseFrames, ipRadioStat=ipRadioStat, writeConfig=writeConfig, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXLongEvents=ethRXLongEvents, ipRadioCfgGeneral=ipRadioCfgGeneral, e1t1LOS=e1t1LOS, ethTXControlFrames=ethTXControlFrames, ethTXByteCounterHi=ethTXByteCounterHi, microwaveRadio=microwaveRadio, modemACMmodulationMax=modemACMmodulationMax, modemACMmodulationMin=modemACMmodulationMin, remoteIp=remoteIp, vlanEntry=vlanEntry, localIpMask=localIpMask, restartcpu=restartcpu, loopbacks=loopbacks, ethRXMulticasts=ethRXMulticasts, ipRadioStatEth=ipRadioStatEth, modemACMethernetCapacity=modemACMethernetCapacity, e1t1ChannelNr=e1t1ChannelNr, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethQOSRXQ2Frames=ethQOSRXQ2Frames, product=product, modemErroredSecond=modemErroredSecond, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXByteCounterLow=ethRXByteCounterLow, ipRadio=ipRadio, radioIndex=radioIndex, radioLoopback=radioLoopback, vlanFid=vlanFid, ethTXMaxCollisions=ethTXMaxCollisions, radioTxMute=radioTxMute, ipRadioMgmt=ipRadioMgmt, licenseUpdateStatus=licenseUpdateStatus, modemTotalBlockNumber=modemTotalBlockNumber, tehnika=tehnika, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXCRCErrors=ethTXCRCErrors, ethRXDones=ethRXDones, ethRXByteCounterHi=ethRXByteCounterHi, safip=safip, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioTxPower=radioTxPower, modemStandard=modemStandard, sysDateAndTime=sysDateAndTime, ethQOSTXFrames=ethQOSTXFrames, aTPCTable=aTPCTable, ethTXLateCollisions=ethTXLateCollisions, ethQOSTXDropped=ethQOSTXDropped, radioTable=radioTable, ethTXGiants=ethTXGiants, modemEthernetCapacity=modemEthernetCapacity, vlansEnabled=vlansEnabled, vlanTable=vlanTable, radioDuplexShift=radioDuplexShift, radioRxFrequency=radioRxFrequency, modemE1T1Channels=modemE1T1Channels, pointToPoint=pointToPoint, hostname=hostname, modemLastAcqError=modemLastAcqError, ethRXPauseFrames=ethRXPauseFrames, vlanPortType=vlanPortType, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXCodeErrors=ethRXCodeErrors, vlanRowStatus=vlanRowStatus, ethTXLengthCheckErrors=ethTXLengthCheckErrors, atpcEnabled=atpcEnabled, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioGenStatus=radioGenStatus, modemCountTime=modemCountTime, sysTemperature=sysTemperature, vlanPortmap=vlanPortmap, e1t1AIS=e1t1AIS, ethTXByteCounterLow=ethTXByteCounterLow, modemModulation=modemModulation, modemUnavailtime=modemUnavailtime, atpcIndex=atpcIndex, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemErroredSecondRatio=modemErroredSecondRatio, modemRadialMSE=modemRadialMSE, modemSymbolRateRx=modemSymbolRateRx, vlanCfgStat=vlanCfgStat, ethTXDones=ethTXDones, ethRXBroadcasts=ethRXBroadcasts, e1t1StatTable=e1t1StatTable, ethTXMulticasts=ethTXMulticasts, ethRXDribleNibbles=ethRXDribleNibbles, license=license, localIp=localIp, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXCollisions=ethTXCollisions, ethRXTruncatedFrames=ethRXTruncatedFrames, modemStatistics=modemStatistics, ethRXVlanTagsDetected=ethRXVlanTagsDetected, e1t1StatEntry=e1t1StatEntry, modemTable=modemTable, modemIndex=modemIndex, ethTXBackpresEvents=ethTXBackpresEvents, modemErroredBlock=modemErroredBlock, saf=saf, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ipRadioCfg=ipRadioCfg, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXBroadcasts=ethTXBroadcasts, modemGeneralStatus=modemGeneralStatus, ipRadioCfgNetwork=ipRadioCfgNetwork, modemLDPCdecoderStress=modemLDPCdecoderStress, loopback_tributary_mask=loopback_tributary_mask, licenseMask=licenseMask, modemTotalCapacity=modemTotalCapacity, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXPrevPktDropped=ethRXPrevPktDropped, modemBandwith=modemBandwith, modemUptime=modemUptime)
