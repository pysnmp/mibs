...
mibBuilder.exportSymbols("SAF-IPRADIO", e1t1StatEntry=e1t1StatEntry, atpcIndex=atpcIndex, ethTXMaxCollisions=ethTXMaxCollisions, modemEntry=modemEntry, modemCountTime=modemCountTime, modemACMmodulationMin=modemACMmodulationMin, ethTXByteCounterLow=ethTXByteCounterLow, licenseMask=licenseMask, ethRXByteCounterLow=ethRXByteCounterLow, aTPCEntry=aTPCEntry, loopbacks=loopbacks, modemBandwith=modemBandwith, sysTemperature=sysTemperature, license=license, ethTXGiants=ethTXGiants, ethTXCollisions=ethTXCollisions, vlanRowStatus=vlanRowStatus, modemUnavailtime=modemUnavailtime, localIp=localIp, vlanCfgStat=vlanCfgStat, radioLoopback=radioLoopback, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemACMtotalCapacity=modemACMtotalCapacity, e1t1AIS=e1t1AIS, ethRXDvEvent=ethRXDvEvent, ethTXCRCErrors=ethTXCRCErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, licenseUpdateStatus=licenseUpdateStatus, radioGenStatus=radioGenStatus, ethTXUnderruns=ethTXUnderruns, modemRadialMSE=modemRadialMSE, modemTotalCapacity=modemTotalCapacity, pointToPoint=pointToPoint, ethGFPDelineationErrors=ethGFPDelineationErrors, radioEntry=radioEntry, radioTxFrequency=radioTxFrequency, ipRadioStat=ipRadioStat, modemRowStatus=modemRowStatus, modemE1T1ChannelMask=modemE1T1ChannelMask, radioIndex=radioIndex, radioRxLevel=radioRxLevel, ethRXMulticasts=ethRXMulticasts, modemStatistics=modemStatistics, modemAcqStatus=modemAcqStatus, ethTXBackpresEvents=ethTXBackpresEvents, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXControlFrames=ethTXControlFrames, loopback_tributary_mask=loopback_tributary_mask, modemIndex=modemIndex, vlanEntry=vlanEntry, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemCarrierOffset=modemCarrierOffset, radioTxMute=radioTxMute, modemErroredSecond=modemErroredSecond, modemErroredBlock=modemErroredBlock, modemLastAcqError=modemLastAcqError, ethTXDones=ethTXDones, ethRXLongEvents=ethRXLongEvents, ethRXCodeErrors=ethRXCodeErrors, modemACMethernetCapacity=modemACMethernetCapacity, ethTXWireByteCounterHi=ethTXWireByteCounterHi, e1t1StatTable=e1t1StatTable, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXByteCounterHi=ethTXByteCounterHi, ipRadioMgmt=ipRadioMgmt, modemTable=modemTable, ethTXMulticasts=ethTXMulticasts, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, localIpMask=localIpMask, modemTotalBlockNumber=modemTotalBlockNumber, ethTXPauseFrames=ethTXPauseFrames, modemModulation=modemModulation, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXBroadcasts=ethRXBroadcasts, ipRadioStatEth=ipRadioStatEth, e1t1ChannelNr=e1t1ChannelNr, ethGFPDropedFrames=ethGFPDropedFrames, safip=safip, radioTxPower=radioTxPower, ethRXDribleNibbles=ethRXDribleNibbles, vlansEnabled=vlansEnabled, ipRadioCfgGeneral=ipRadioCfgGeneral, modemE1T1Channels=modemE1T1Channels, modemInternalAGCgain=modemInternalAGCgain, ethRXByteCounterHi=ethRXByteCounterHi, product=product, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemGeneralStatus=modemGeneralStatus, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadio=ipRadio, microwaveRadio=microwaveRadio, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXPauseFrames=ethRXPauseFrames, ethGFPCHECErrors=ethGFPCHECErrors, vlanPortmap=vlanPortmap, ethGFPFCSErrors=ethGFPFCSErrors, atpcTxPowerCorrection=atpcTxPowerCorrection, radioSide=radioSide, sysDateAndTime=sysDateAndTime, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemLDPCdecoderStress=modemLDPCdecoderStress, ethQOSTXDropped=ethQOSTXDropped, tehnika=tehnika, writeConfig=writeConfig, ipRadioCfg=ipRadioCfg, saf=saf, aTPCTable=aTPCTable, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemEthernetCapacity=modemEthernetCapacity, ethTXVlanTags=ethTXVlanTags, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemSymbolRateTx=modemSymbolRateTx, ethRXDones=ethRXDones, ethQOSTXFrames=ethQOSTXFrames, atpcEnabled=atpcEnabled, description=description, modemStandard=modemStandard, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXTruncatedFrames=ethRXTruncatedFrames, hostname=hostname, vlanTable=vlanTable, ethTXBroadcasts=ethTXBroadcasts, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, remoteIp=remoteIp, radioDuplexShift=radioDuplexShift, modemErroredSecondRatio=modemErroredSecondRatio, modemSymbolRateRx=modemSymbolRateRx, radioRxFrequency=radioRxFrequency, modemACMengine=modemACMengine, vlanPortType=vlanPortType, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXControlFrames=ethRXControlFrames, modemUptime=modemUptime, ethTXLateCollisions=ethTXLateCollisions, modemACMmodulationMax=modemACMmodulationMax, restartcpu=restartcpu, e1t1LOS=e1t1LOS, vlanNumber=vlanNumber, ethRXCRCErrors=ethRXCRCErrors, vlanFid=vlanFid, radioTable=radioTable)
