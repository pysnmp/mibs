...
mibBuilder.exportSymbols("SAF-IPRADIO", modemIndex=modemIndex, radioEntry=radioEntry, vlanEntry=vlanEntry, ethTXByteCounterHi=ethTXByteCounterHi, ethGFPCHECErrors=ethGFPCHECErrors, vlanPortType=vlanPortType, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, pointToPoint=pointToPoint, product=product, modemACMengine=modemACMengine, ipRadioCfgNetwork=ipRadioCfgNetwork, modemEthernetCapacity=modemEthernetCapacity, atpcEnabled=atpcEnabled, modemRowStatus=modemRowStatus, modemErroredSecond=modemErroredSecond, modemACMtotalCapacity=modemACMtotalCapacity, atpcTxPowerCorrection=atpcTxPowerCorrection, sysDateAndTime=sysDateAndTime, ethGFPFCSErrors=ethGFPFCSErrors, modemErroredBlock=modemErroredBlock, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemCountTime=modemCountTime, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ipRadioCfg=ipRadioCfg, ethRXDribleNibbles=ethRXDribleNibbles, ethTXExcessiveDefers=ethTXExcessiveDefers, radioRxFrequency=radioRxFrequency, localIpMask=localIpMask, ethRXPauseFrames=ethRXPauseFrames, ethRXControlFrames=ethRXControlFrames, modemUnavailtime=modemUnavailtime, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, vlanTable=vlanTable, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXGiants=ethTXGiants, ethTXDones=ethTXDones, modemTable=modemTable, modemEntry=modemEntry, modemSymbolRateRx=modemSymbolRateRx, radioTxFrequency=radioTxFrequency, ethRXBroadcasts=ethRXBroadcasts, modemLDPCdecoderStress=modemLDPCdecoderStress, e1t1StatTable=e1t1StatTable, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemInternalAGCgain=modemInternalAGCgain, tehnika=tehnika, ethRXPrevPktDropped=ethRXPrevPktDropped, vlanNumber=vlanNumber, modemACMmodulationMax=modemACMmodulationMax, ethTXUnderruns=ethTXUnderruns, modemCarrierOffset=modemCarrierOffset, modemE1T1Channels=modemE1T1Channels, radioGenStatus=radioGenStatus, radioRxLevel=radioRxLevel, ethQOSTXFrames=ethQOSTXFrames, ethTXCRCErrors=ethTXCRCErrors, saf=saf, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioIndex=radioIndex, ipRadioMgmt=ipRadioMgmt, modemACMethernetCapacity=modemACMethernetCapacity, e1t1ChannelNr=e1t1ChannelNr, modemModulation=modemModulation, radioDuplexShift=radioDuplexShift, modemErroredSecondRatio=modemErroredSecondRatio, atpcIndex=atpcIndex, license=license, aTPCEntry=aTPCEntry, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, e1t1StatEntry=e1t1StatEntry, modemSymbolRateTx=modemSymbolRateTx, modemTotalBlockNumber=modemTotalBlockNumber, ethTXMaxCollisions=ethTXMaxCollisions, ipRadioStatEth=ipRadioStatEth, hostname=hostname, restartcpu=restartcpu, ethRXCRCErrors=ethRXCRCErrors, ethTXControlFrames=ethTXControlFrames, licenseMask=licenseMask, ethRXByteCounterLow=ethRXByteCounterLow, modemUptime=modemUptime, loopbacks=loopbacks, licenseUpdateStatus=licenseUpdateStatus, radioTxMute=radioTxMute, modemTotalCapacity=modemTotalCapacity, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemGeneralStatus=modemGeneralStatus, ethTXLengthCheckErrors=ethTXLengthCheckErrors, localIp=localIp, ethRXMulticasts=ethRXMulticasts, ipRadio=ipRadio, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioTable=radioTable, modemE1T1ChannelMask=modemE1T1ChannelMask, ethQOSTXDropped=ethQOSTXDropped, e1t1AIS=e1t1AIS, vlansEnabled=vlansEnabled, modemAcqStatus=modemAcqStatus, ipRadioStat=ipRadioStat, ethTXPauseFrames=ethTXPauseFrames, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXLateCollisions=ethTXLateCollisions, ethTXMulticasts=ethTXMulticasts, ethGFPDropedFrames=ethGFPDropedFrames, ethRXDvEvent=ethRXDvEvent, ethRXLongEvents=ethRXLongEvents, modemBandwith=modemBandwith, safip=safip, ethRXCodeErrors=ethRXCodeErrors, vlanPortmap=vlanPortmap, ethTXCollisions=ethTXCollisions, ethRXByteCounterHi=ethRXByteCounterHi, ipRadioCfgGeneral=ipRadioCfgGeneral, radioLoopback=radioLoopback, writeConfig=writeConfig, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemACMmodulationMin=modemACMmodulationMin, ethTXBroadcasts=ethTXBroadcasts, e1t1LOS=e1t1LOS, ethTXVlanTags=ethTXVlanTags, ethRXTruncatedFrames=ethRXTruncatedFrames, modemRadialMSE=modemRadialMSE, vlanRowStatus=vlanRowStatus, vlanCfgStat=vlanCfgStat, radioTxPower=radioTxPower, modemStatistics=modemStatistics, vlanFid=vlanFid, ethTXByteCounterLow=ethTXByteCounterLow, loopback_tributary_mask=loopback_tributary_mask, sysTemperature=sysTemperature, microwaveRadio=microwaveRadio, radioSide=radioSide, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXUnsupOpcodes=ethRXUnsupOpcodes, aTPCTable=aTPCTable, modemLastAcqError=modemLastAcqError, remoteIp=remoteIp, ethRXDones=ethRXDones, description=description, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXBackpresEvents=ethTXBackpresEvents, modemStandard=modemStandard, ethGFPDelineationErrors=ethGFPDelineationErrors)
