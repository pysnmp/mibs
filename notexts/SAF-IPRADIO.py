...
mibBuilder.exportSymbols("SAF-IPRADIO", modemTotalCapacity=modemTotalCapacity, modemGeneralStatus=modemGeneralStatus, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioSide=radioSide, modemACMmodulationMin=modemACMmodulationMin, modemSymbolRateRx=modemSymbolRateRx, modemE1T1Channels=modemE1T1Channels, ipRadioCfg=ipRadioCfg, ethTXControlFrames=ethTXControlFrames, hostname=hostname, ethTXBroadcasts=ethTXBroadcasts, radioLoopback=radioLoopback, ethTXByteCounterLow=ethTXByteCounterLow, ethRXPauseFrames=ethRXPauseFrames, atpcIndex=atpcIndex, safip=safip, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemACMtotalCapacity=modemACMtotalCapacity, licenseMask=licenseMask, radioTxPower=radioTxPower, sysDateAndTime=sysDateAndTime, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ipRadioMgmt=ipRadioMgmt, modemInternalAGCgain=modemInternalAGCgain, licenseUpdateStatus=licenseUpdateStatus, writeConfig=writeConfig, e1t1ChannelNr=e1t1ChannelNr, ipRadioCfgGeneral=ipRadioCfgGeneral, modemSymbolRateTx=modemSymbolRateTx, modemACMethernetCapacity=modemACMethernetCapacity, modemUptime=modemUptime, modemTotalBlockNumber=modemTotalBlockNumber, microwaveRadio=microwaveRadio, radioTxMute=radioTxMute, vlanPortType=vlanPortType, ethTXWireByteCounterHi=ethTXWireByteCounterHi, tehnika=tehnika, ethRXByteCounterLow=ethRXByteCounterLow, ethTXVlanTags=ethTXVlanTags, loopbacks=loopbacks, ethTXDones=ethTXDones, ethRXPrevPktDropped=ethRXPrevPktDropped, modemRadialMSE=modemRadialMSE, ethRXDvEvent=ethRXDvEvent, vlanPortmap=vlanPortmap, ethRXMulticasts=ethRXMulticasts, ethTXBackpresEvents=ethTXBackpresEvents, atpcEnabled=atpcEnabled, ipRadio=ipRadio, ethRXCRCErrors=ethRXCRCErrors, modemEntry=modemEntry, ethGFPFCSErrors=ethGFPFCSErrors, ethTXUnderruns=ethTXUnderruns, modemStatistics=modemStatistics, atpcTxPowerCorrection=atpcTxPowerCorrection, vlanEntry=vlanEntry, modemCarrierOffset=modemCarrierOffset, radioIndex=radioIndex, ethRXDones=ethRXDones, ethRXDribleNibbles=ethRXDribleNibbles, aTPCTable=aTPCTable, ethQOSTXDropped=ethQOSTXDropped, e1t1StatEntry=e1t1StatEntry, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioEntry=radioEntry, radioRxLevel=radioRxLevel, ethGFPDropedFrames=ethGFPDropedFrames, saf=saf, modemACMmodulationMax=modemACMmodulationMax, radioDuplexShift=radioDuplexShift, modemStandard=modemStandard, e1t1AIS=e1t1AIS, ethTXGiants=ethTXGiants, product=product, ethRXControlFrames=ethRXControlFrames, modemTable=modemTable, ethTXLateCollisions=ethTXLateCollisions, modemIndex=modemIndex, vlansEnabled=vlansEnabled, sysTemperature=sysTemperature, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXMulticasts=ethTXMulticasts, modemLDPCdecoderStress=modemLDPCdecoderStress, radioTable=radioTable, ethTXExcessiveDefers=ethTXExcessiveDefers, modemBandwith=modemBandwith, modemModulation=modemModulation, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, vlanNumber=vlanNumber, loopback_tributary_mask=loopback_tributary_mask, modemAcqStatus=modemAcqStatus, ipRadioStatEth=ipRadioStatEth, modemErroredSecond=modemErroredSecond, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemEthernetCapacity=modemEthernetCapacity, ethQOSTXFrames=ethQOSTXFrames, modemACMengine=modemACMengine, ethGFPCHECErrors=ethGFPCHECErrors, vlanRowStatus=vlanRowStatus, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXByteCounterHi=ethRXByteCounterHi, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, aTPCEntry=aTPCEntry, modemLastAcqError=modemLastAcqError, ethRXLongEvents=ethRXLongEvents, ethRXCodeErrors=ethRXCodeErrors, e1t1LOS=e1t1LOS, vlanFid=vlanFid, license=license, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXPauseFrames=ethTXPauseFrames, modemErroredSecondRatio=modemErroredSecondRatio, description=description, radioGenStatus=radioGenStatus, ethRXBroadcasts=ethRXBroadcasts, ethTXCRCErrors=ethTXCRCErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, restartcpu=restartcpu, ethTXMaxCollisions=ethTXMaxCollisions, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemUnavailtime=modemUnavailtime, modemRowStatus=modemRowStatus, ethGFPDelineationErrors=ethGFPDelineationErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemErroredBlock=modemErroredBlock, radioRxFrequency=radioRxFrequency, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, localIp=localIp, modemE1T1ChannelMask=modemE1T1ChannelMask, modemCountTime=modemCountTime, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioTxFrequency=radioTxFrequency, localIpMask=localIpMask, ipRadioCfgNetwork=ipRadioCfgNetwork, pointToPoint=pointToPoint, ipRadioStat=ipRadioStat, remoteIp=remoteIp, vlanCfgStat=vlanCfgStat, e1t1StatTable=e1t1StatTable, vlanTable=vlanTable, ethTXCollisions=ethTXCollisions, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXByteCounterHi=ethTXByteCounterHi)
