...
mibBuilder.exportSymbols("SAF-IPRADIO", localIp=localIp, ipRadioCfg=ipRadioCfg, ethTXDones=ethTXDones, ethTXCRCErrors=ethTXCRCErrors, modemSymbolRateTx=modemSymbolRateTx, description=description, ethTXControlFrames=ethTXControlFrames, modemACMmodulationMax=modemACMmodulationMax, radioTable=radioTable, ipRadio=ipRadio, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethGFPCHECErrors=ethGFPCHECErrors, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXCodeErrors=ethRXCodeErrors, atpcTxPowerCorrection=atpcTxPowerCorrection, modemCountTime=modemCountTime, modemSymbolRateRx=modemSymbolRateRx, ethRXMulticasts=ethRXMulticasts, modemACMmodulationMin=modemACMmodulationMin, radioGenStatus=radioGenStatus, ethTXUnderruns=ethTXUnderruns, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemIndex=modemIndex, localIpMask=localIpMask, vlansEnabled=vlansEnabled, modemRowStatus=modemRowStatus, tehnika=tehnika, modemAcqStatus=modemAcqStatus, vlanEntry=vlanEntry, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ipRadioCfgGeneral=ipRadioCfgGeneral, ipRadioMgmt=ipRadioMgmt, radioIndex=radioIndex, ethTXBroadcasts=ethTXBroadcasts, radioRxFrequency=radioRxFrequency, vlanFid=vlanFid, ethRXDones=ethRXDones, modemErroredBlock=modemErroredBlock, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethGFPDropedFrames=ethGFPDropedFrames, sysTemperature=sysTemperature, ethRXCRCErrors=ethRXCRCErrors, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemTotalBlockNumber=modemTotalBlockNumber, ethRXControlFrames=ethRXControlFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemRadialMSE=modemRadialMSE, ethTXVlanTags=ethTXVlanTags, licenseMask=licenseMask, modemUptime=modemUptime, ethRXBroadcasts=ethRXBroadcasts, ethRXByteCounterLow=ethRXByteCounterLow, ethTXMulticasts=ethTXMulticasts, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, license=license, product=product, microwaveRadio=microwaveRadio, remoteIp=remoteIp, ethRXTruncatedFrames=ethRXTruncatedFrames, vlanPortType=vlanPortType, ethRXPrevPktDropped=ethRXPrevPktDropped, modemBandwith=modemBandwith, ethRXByteCounterHi=ethRXByteCounterHi, ethTXCollisions=ethTXCollisions, modemCarrierOffset=modemCarrierOffset, ethRXDribleNibbles=ethRXDribleNibbles, restartcpu=restartcpu, modemACMethernetCapacity=modemACMethernetCapacity, ethRXDvEvent=ethRXDvEvent, modemACMengine=modemACMengine, modemUnavailtime=modemUnavailtime, atpcIndex=atpcIndex, ethRXLongEvents=ethRXLongEvents, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemEntry=modemEntry, ipRadioCfgNetwork=ipRadioCfgNetwork, modemEthernetCapacity=modemEthernetCapacity, modemInternalAGCgain=modemInternalAGCgain, pointToPoint=pointToPoint, vlanRowStatus=vlanRowStatus, ethGFPFCSErrors=ethGFPFCSErrors, safip=safip, loopback_tributary_mask=loopback_tributary_mask, ethTXLateCollisions=ethTXLateCollisions, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethQOSTXDropped=ethQOSTXDropped, e1t1StatTable=e1t1StatTable, modemErroredSecond=modemErroredSecond, e1t1StatEntry=e1t1StatEntry, ethTXPauseFrames=ethTXPauseFrames, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXExcessiveDefers=ethTXExcessiveDefers, vlanCfgStat=vlanCfgStat, saf=saf, modemGeneralStatus=modemGeneralStatus, modemStandard=modemStandard, hostname=hostname, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioTxFrequency=radioTxFrequency, licenseUpdateStatus=licenseUpdateStatus, modemLastAcqError=modemLastAcqError, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXByteCounterHi=ethTXByteCounterHi, e1t1ChannelNr=e1t1ChannelNr, radioDuplexShift=radioDuplexShift, vlanTable=vlanTable, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXBackpresEvents=ethTXBackpresEvents, vlanNumber=vlanNumber, modemE1T1Channels=modemE1T1Channels, ethTXMaxCollisions=ethTXMaxCollisions, modemE1T1ChannelMask=modemE1T1ChannelMask, radioRxLevel=radioRxLevel, radioSide=radioSide, aTPCEntry=aTPCEntry, radioLoopback=radioLoopback, modemTable=modemTable, modemModulation=modemModulation, modemTotalCapacity=modemTotalCapacity, aTPCTable=aTPCTable, modemACMtotalCapacity=modemACMtotalCapacity, ethTXByteCounterLow=ethTXByteCounterLow, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXGiants=ethTXGiants, ethRXPauseFrames=ethRXPauseFrames, ipRadioStatEth=ipRadioStatEth, modemStatistics=modemStatistics, ipRadioStat=ipRadioStat, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, e1t1AIS=e1t1AIS, sysDateAndTime=sysDateAndTime, vlanPortmap=vlanPortmap, e1t1LOS=e1t1LOS, atpcEnabled=atpcEnabled, ethQOSTXFrames=ethQOSTXFrames, writeConfig=writeConfig, loopbacks=loopbacks, radioTxMute=radioTxMute, radioEntry=radioEntry, modemErroredSecondRatio=modemErroredSecondRatio, radioTxPower=radioTxPower)
