...
mibBuilder.exportSymbols("SAF-IPRADIO", vlanRowStatus=vlanRowStatus, modemBandwith=modemBandwith, radioGenStatus=radioGenStatus, modemACMmodulationMin=modemACMmodulationMin, ethGFPFCSErrors=ethGFPFCSErrors, modemErroredBlock=modemErroredBlock, modemLastAcqError=modemLastAcqError, ethRXControlFrames=ethRXControlFrames, sysDateAndTime=sysDateAndTime, writeConfig=writeConfig, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemACMmodulationMax=modemACMmodulationMax, radioRxFrequency=radioRxFrequency, ethRXByteCounterLow=ethRXByteCounterLow, radioTxPower=radioTxPower, radioSide=radioSide, loopback_tributary_mask=loopback_tributary_mask, microwaveRadio=microwaveRadio, tehnika=tehnika, modemE1T1Channels=modemE1T1Channels, ethRXLongEvents=ethRXLongEvents, ethTXPauseFrames=ethTXPauseFrames, modemTotalCapacity=modemTotalCapacity, vlanPortType=vlanPortType, atpcEnabled=atpcEnabled, ethRXDvEvent=ethRXDvEvent, vlansEnabled=vlansEnabled, modemSymbolRateTx=modemSymbolRateTx, vlanTable=vlanTable, ethRXByteCounterHi=ethRXByteCounterHi, ethTXByteCounterLow=ethTXByteCounterLow, ethTXUnderruns=ethTXUnderruns, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ipRadioStat=ipRadioStat, ethTXBackpresEvents=ethTXBackpresEvents, ethRXMulticasts=ethRXMulticasts, modemLDPCdecoderStress=modemLDPCdecoderStress, vlanNumber=vlanNumber, modemTotalBlockNumber=modemTotalBlockNumber, modemInternalAGCgain=modemInternalAGCgain, vlanCfgStat=vlanCfgStat, modemSymbolRateRx=modemSymbolRateRx, sysTemperature=sysTemperature, license=license, safip=safip, modemStatistics=modemStatistics, modemRadialMSE=modemRadialMSE, ethTXWireByteCounterLow=ethTXWireByteCounterLow, licenseUpdateStatus=licenseUpdateStatus, radioTable=radioTable, ethTXCollisions=ethTXCollisions, aTPCTable=aTPCTable, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXDones=ethRXDones, ethTXByteCounterHi=ethTXByteCounterHi, modemTable=modemTable, e1t1StatTable=e1t1StatTable, localIpMask=localIpMask, modemIndex=modemIndex, ipRadioStatEth=ipRadioStatEth, aTPCEntry=aTPCEntry, ethRXDribleNibbles=ethRXDribleNibbles, ipRadioMgmt=ipRadioMgmt, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemUptime=modemUptime, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXGiants=ethTXGiants, modemGeneralStatus=modemGeneralStatus, ethRXPauseFrames=ethRXPauseFrames, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, restartcpu=restartcpu, ethTXVlanTags=ethTXVlanTags, ethTXExcessiveDefers=ethTXExcessiveDefers, modemSeverelyErroredSecond=modemSeverelyErroredSecond, hostname=hostname, radioRxLevel=radioRxLevel, ethRXBroadcasts=ethRXBroadcasts, radioTxFrequency=radioTxFrequency, radioIndex=radioIndex, ethTXMaxCollisions=ethTXMaxCollisions, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemErroredSecondRatio=modemErroredSecondRatio, pointToPoint=pointToPoint, ipRadio=ipRadio, vlanFid=vlanFid, ethTXMulticasts=ethTXMulticasts, localIp=localIp, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemRowStatus=modemRowStatus, ethQOSTXDropped=ethQOSTXDropped, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemErroredSecond=modemErroredSecond, ethTXLateCollisions=ethTXLateCollisions, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemCarrierOffset=modemCarrierOffset, ethTXDones=ethTXDones, ipRadioCfg=ipRadioCfg, ethRXCRCErrors=ethRXCRCErrors, loopbacks=loopbacks, modemACMengine=modemACMengine, atpcIndex=atpcIndex, modemACMtotalCapacity=modemACMtotalCapacity, radioDuplexShift=radioDuplexShift, e1t1AIS=e1t1AIS, licenseMask=licenseMask, radioEntry=radioEntry, ethTXBroadcasts=ethTXBroadcasts, modemACMethernetCapacity=modemACMethernetCapacity, ethGFPCHECErrors=ethGFPCHECErrors, ethRXCodeErrors=ethRXCodeErrors, e1t1LOS=e1t1LOS, ethTXWireByteCounterHi=ethTXWireByteCounterHi, atpcTxPowerCorrection=atpcTxPowerCorrection, e1t1ChannelNr=e1t1ChannelNr, modemModulation=modemModulation, modemUnavailtime=modemUnavailtime, ipRadioCfgGeneral=ipRadioCfgGeneral, vlanPortmap=vlanPortmap, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXCRCErrors=ethTXCRCErrors, product=product, vlanEntry=vlanEntry, ethQOSTXFrames=ethQOSTXFrames, modemEthernetCapacity=modemEthernetCapacity, radioLoopback=radioLoopback, ipRadioCfgNetwork=ipRadioCfgNetwork, modemStandard=modemStandard, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethGFPDropedFrames=ethGFPDropedFrames, ethTXControlFrames=ethTXControlFrames, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, remoteIp=remoteIp, radioTxMute=radioTxMute, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemAcqStatus=modemAcqStatus, e1t1StatEntry=e1t1StatEntry, modemEntry=modemEntry, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemCountTime=modemCountTime, description=description, saf=saf)
