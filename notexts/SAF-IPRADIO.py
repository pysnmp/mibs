...
mibBuilder.exportSymbols("SAF-IPRADIO", modemUptime=modemUptime, modemUnavailtime=modemUnavailtime, modemACMethernetCapacity=modemACMethernetCapacity, ethTXBackpresEvents=ethTXBackpresEvents, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioTxMute=radioTxMute, licenseMask=licenseMask, ethTXLateCollisions=ethTXLateCollisions, modemLDPCdecoderStress=modemLDPCdecoderStress, ipRadioCfg=ipRadioCfg, radioGenStatus=radioGenStatus, licenseUpdateStatus=licenseUpdateStatus, vlanEntry=vlanEntry, ethRXVlanTagsDetected=ethRXVlanTagsDetected, description=description, modemIndex=modemIndex, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioRxLevel=radioRxLevel, aTPCEntry=aTPCEntry, ethQOSTXFrames=ethQOSTXFrames, modemTotalBlockNumber=modemTotalBlockNumber, modemRowStatus=modemRowStatus, modemCountTime=modemCountTime, ethRXCRCErrors=ethRXCRCErrors, modemRadialMSE=modemRadialMSE, vlanRowStatus=vlanRowStatus, modemGeneralStatus=modemGeneralStatus, ethQOSTXDropped=ethQOSTXDropped, modemStatistics=modemStatistics, atpcIndex=atpcIndex, ethRXLongEvents=ethRXLongEvents, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, remoteIp=remoteIp, ethTXByteCounterLow=ethTXByteCounterLow, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemSymbolRateTx=modemSymbolRateTx, aTPCTable=aTPCTable, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethGFPCHECErrors=ethGFPCHECErrors, loopbacks=loopbacks, ethRXBroadcasts=ethRXBroadcasts, vlanCfgStat=vlanCfgStat, radioRxFrequency=radioRxFrequency, license=license, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXMulticasts=ethTXMulticasts, modemEthernetCapacity=modemEthernetCapacity, radioSide=radioSide, modemBandwith=modemBandwith, modemACMtotalCapacity=modemACMtotalCapacity, e1t1AIS=e1t1AIS, modemBackgroundBlockErrror=modemBackgroundBlockErrror, restartcpu=restartcpu, e1t1LOS=e1t1LOS, vlansEnabled=vlansEnabled, modemInternalAGCgain=modemInternalAGCgain, ethRXByteCounterLow=ethRXByteCounterLow, ethTXCRCErrors=ethTXCRCErrors, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXPauseFrames=ethRXPauseFrames, ethRXDvEvent=ethRXDvEvent, ethTXByteCounterHi=ethTXByteCounterHi, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXControlFrames=ethRXControlFrames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemAcqStatus=modemAcqStatus, ethTXCollisions=ethTXCollisions, ethTXControlFrames=ethTXControlFrames, e1t1StatTable=e1t1StatTable, sysTemperature=sysTemperature, localIp=localIp, sysDateAndTime=sysDateAndTime, modemEntry=modemEntry, modemACMengine=modemACMengine, loopback_tributary_mask=loopback_tributary_mask, modemErroredSecondRatio=modemErroredSecondRatio, modemErroredSecond=modemErroredSecond, vlanPortmap=vlanPortmap, modemACMmodulationMax=modemACMmodulationMax, writeConfig=writeConfig, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXUnderruns=ethTXUnderruns, ethTXExcessiveDefers=ethTXExcessiveDefers, microwaveRadio=microwaveRadio, ethTXBroadcasts=ethTXBroadcasts, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, saf=saf, radioTxFrequency=radioTxFrequency, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, e1t1ChannelNr=e1t1ChannelNr, safip=safip, modemACMmodulationMin=modemACMmodulationMin, ethTXVlanTags=ethTXVlanTags, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXDones=ethRXDones, vlanPortType=vlanPortType, modemStandard=modemStandard, pointToPoint=pointToPoint, radioTable=radioTable, vlanNumber=vlanNumber, tehnika=tehnika, ethRXCodeErrors=ethRXCodeErrors, ipRadioMgmt=ipRadioMgmt, ipRadio=ipRadio, radioEntry=radioEntry, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXGiants=ethTXGiants, ethTXMaxCollisions=ethTXMaxCollisions, modemE1T1Channels=modemE1T1Channels, modemTotalCapacity=modemTotalCapacity, ethGFPDropedFrames=ethGFPDropedFrames, radioLoopback=radioLoopback, ethRXMulticasts=ethRXMulticasts, vlanTable=vlanTable, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, hostname=hostname, ipRadioStatEth=ipRadioStatEth, modemCarrierOffset=modemCarrierOffset, vlanFid=vlanFid, atpcTxPowerCorrection=atpcTxPowerCorrection, atpcEnabled=atpcEnabled, ethGFPFCSErrors=ethGFPFCSErrors, localIpMask=localIpMask, radioTxPower=radioTxPower, ethTXDones=ethTXDones, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethGFPDelineationErrors=ethGFPDelineationErrors, radioIndex=radioIndex, modemErroredBlock=modemErroredBlock, modemLastAcqError=modemLastAcqError, ipRadioStat=ipRadioStat, product=product, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXDribleNibbles=ethRXDribleNibbles, modemModulation=modemModulation, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioDuplexShift=radioDuplexShift, modemTable=modemTable, e1t1StatEntry=e1t1StatEntry, ethRXByteCounterHi=ethRXByteCounterHi, ethTXPauseFrames=ethTXPauseFrames, modemSymbolRateRx=modemSymbolRateRx)
