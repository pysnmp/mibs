...
mibBuilder.exportSymbols("SAF-IPRADIO", ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXExcessiveDefers=ethTXExcessiveDefers, vlanPortType=vlanPortType, ethRXLongEvents=ethRXLongEvents, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemCountTime=modemCountTime, modemRadialMSE=modemRadialMSE, radioTable=radioTable, ethTXMulticasts=ethTXMulticasts, ipRadioCfg=ipRadioCfg, ethRXByteCounterHi=ethRXByteCounterHi, ethTXUnderruns=ethTXUnderruns, e1t1StatEntry=e1t1StatEntry, ipRadioMgmt=ipRadioMgmt, ethTXDones=ethTXDones, ethTXControlFrames=ethTXControlFrames, ethRXDribleNibbles=ethRXDribleNibbles, modemInternalAGCgain=modemInternalAGCgain, safip=safip, radioDuplexShift=radioDuplexShift, modemStandard=modemStandard, vlanRowStatus=vlanRowStatus, ethTXBroadcasts=ethTXBroadcasts, radioGenStatus=radioGenStatus, tehnika=tehnika, e1t1AIS=e1t1AIS, ethRXCRCErrors=ethRXCRCErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, vlanFid=vlanFid, e1t1LOS=e1t1LOS, hostname=hostname, radioRxFrequency=radioRxFrequency, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlansEnabled=vlansEnabled, aTPCEntry=aTPCEntry, modemUptime=modemUptime, atpcEnabled=atpcEnabled, modemModulation=modemModulation, radioTxFrequency=radioTxFrequency, modemEthernetCapacity=modemEthernetCapacity, radioTxPower=radioTxPower, ethTXCollisions=ethTXCollisions, ethGFPFCSErrors=ethGFPFCSErrors, saf=saf, modemSymbolRateTx=modemSymbolRateTx, vlanTable=vlanTable, modemE1T1ChannelMask=modemE1T1ChannelMask, modemACMtotalCapacity=modemACMtotalCapacity, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioRxLevel=radioRxLevel, localIp=localIp, vlanNumber=vlanNumber, modemErroredSecondRatio=modemErroredSecondRatio, ethRXVlanTagsDetected=ethRXVlanTagsDetected, remoteIp=remoteIp, vlanCfgStat=vlanCfgStat, description=description, ethQOSTXFrames=ethQOSTXFrames, pointToPoint=pointToPoint, radioLoopback=radioLoopback, sysTemperature=sysTemperature, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXDvEvent=ethRXDvEvent, restartcpu=restartcpu, ethRXPrevPktDropped=ethRXPrevPktDropped, modemCarrierOffset=modemCarrierOffset, modemTotalBlockNumber=modemTotalBlockNumber, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXByteCounterLow=ethTXByteCounterLow, modemACMengine=modemACMengine, vlanPortmap=vlanPortmap, modemIndex=modemIndex, modemRowStatus=modemRowStatus, modemErroredSecond=modemErroredSecond, ethTXGiants=ethTXGiants, vlanEntry=vlanEntry, ethRXControlFrames=ethRXControlFrames, ethQOSRXQ1Frames=ethQOSRXQ1Frames, aTPCTable=aTPCTable, localIpMask=localIpMask, modemSeverelyErroredSecond=modemSeverelyErroredSecond, sysDateAndTime=sysDateAndTime, product=product, radioIndex=radioIndex, ethGFPCHECErrors=ethGFPCHECErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXPauseFrames=ethRXPauseFrames, modemE1T1Channels=modemE1T1Channels, loopback_tributary_mask=loopback_tributary_mask, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXByteCounterLow=ethRXByteCounterLow, microwaveRadio=microwaveRadio, modemACMethernetCapacity=modemACMethernetCapacity, license=license, atpcIndex=atpcIndex, ipRadio=ipRadio, modemACMmodulationMin=modemACMmodulationMin, e1t1StatTable=e1t1StatTable, modemUnavailtime=modemUnavailtime, licenseMask=licenseMask, modemBandwith=modemBandwith, modemSymbolRateRx=modemSymbolRateRx, e1t1ChannelNr=e1t1ChannelNr, ethRXMulticasts=ethRXMulticasts, modemLastAcqError=modemLastAcqError, ethTXVlanTags=ethTXVlanTags, radioSide=radioSide, radioTxMute=radioTxMute, loopbacks=loopbacks, modemTable=modemTable, modemACMmodulationMax=modemACMmodulationMax, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemEntry=modemEntry, ethRXDones=ethRXDones, atpcTxPowerCorrection=atpcTxPowerCorrection, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXCodeErrors=ethRXCodeErrors, ethRXBroadcasts=ethRXBroadcasts, ethQOSTXDropped=ethQOSTXDropped, ethTXPauseFrames=ethTXPauseFrames, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ipRadioStat=ipRadioStat, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXLateCollisions=ethTXLateCollisions, licenseUpdateStatus=licenseUpdateStatus, modemAcqStatus=modemAcqStatus, modemStatistics=modemStatistics, radioEntry=radioEntry, ipRadioStatEth=ipRadioStatEth, ethTXBackpresEvents=ethTXBackpresEvents, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethGFPDropedFrames=ethGFPDropedFrames, ethTXByteCounterHi=ethTXByteCounterHi, ethTXMaxCollisions=ethTXMaxCollisions, modemTotalCapacity=modemTotalCapacity, modemGeneralStatus=modemGeneralStatus, modemLDPCdecoderStress=modemLDPCdecoderStress, writeConfig=writeConfig, modemErroredBlock=modemErroredBlock, ethTXCRCErrors=ethTXCRCErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio)
