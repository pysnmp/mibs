...
mibBuilder.exportSymbols("SAF-IPRADIO", product=product, modemIndex=modemIndex, ethRXDones=ethRXDones, modemTable=modemTable, modemACMengine=modemACMengine, ethTXByteCounterLow=ethTXByteCounterLow, vlanRowStatus=vlanRowStatus, e1t1LOS=e1t1LOS, ethGFPDropedFrames=ethGFPDropedFrames, atpcIndex=atpcIndex, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXByteCounterLow=ethRXByteCounterLow, ethTXBroadcasts=ethTXBroadcasts, vlansEnabled=vlansEnabled, ethTXGiants=ethTXGiants, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, e1t1StatTable=e1t1StatTable, modemGeneralStatus=modemGeneralStatus, license=license, ethQOSRXQ1Frames=ethQOSRXQ1Frames, restartcpu=restartcpu, ethTXDones=ethTXDones, vlanPortType=vlanPortType, localIp=localIp, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemTotalBlockNumber=modemTotalBlockNumber, ethRXLongEvents=ethRXLongEvents, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, vlanEntry=vlanEntry, modemRadialMSE=modemRadialMSE, saf=saf, writeConfig=writeConfig, radioTxMute=radioTxMute, modemEthernetCapacity=modemEthernetCapacity, e1t1ChannelNr=e1t1ChannelNr, modemErroredSecond=modemErroredSecond, ethRXDvEvent=ethRXDvEvent, aTPCEntry=aTPCEntry, vlanFid=vlanFid, modemE1T1ChannelMask=modemE1T1ChannelMask, vlanTable=vlanTable, vlanPortmap=vlanPortmap, modemLastAcqError=modemLastAcqError, ethRXTruncatedFrames=ethRXTruncatedFrames, ethQOSTXFrames=ethQOSTXFrames, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ipRadioStatEth=ipRadioStatEth, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXExcessiveDefers=ethTXExcessiveDefers, pointToPoint=pointToPoint, atpcEnabled=atpcEnabled, ethRXDribleNibbles=ethRXDribleNibbles, vlanCfgStat=vlanCfgStat, tehnika=tehnika, modemACMtotalCapacity=modemACMtotalCapacity, ethGFPFCSErrors=ethGFPFCSErrors, ethTXControlFrames=ethTXControlFrames, modemUnavailtime=modemUnavailtime, aTPCTable=aTPCTable, radioIndex=radioIndex, ethTXCRCErrors=ethTXCRCErrors, ethRXCRCErrors=ethRXCRCErrors, radioTable=radioTable, modemUptime=modemUptime, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioTxFrequency=radioTxFrequency, e1t1StatEntry=e1t1StatEntry, ethGFPCHECErrors=ethGFPCHECErrors, loopbacks=loopbacks, ethGFPDelineationErrors=ethGFPDelineationErrors, licenseUpdateStatus=licenseUpdateStatus, ethQOSTXDropped=ethQOSTXDropped, atpcTxPowerCorrection=atpcTxPowerCorrection, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXMulticasts=ethTXMulticasts, modemCarrierOffset=modemCarrierOffset, modemACMmodulationMin=modemACMmodulationMin, ethTXPauseFrames=ethTXPauseFrames, modemLDPCdecoderStress=modemLDPCdecoderStress, modemSymbolRateRx=modemSymbolRateRx, ethRXControlFrames=ethRXControlFrames, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXCollisions=ethTXCollisions, radioRxFrequency=radioRxFrequency, ethTXWireByteCounterHi=ethTXWireByteCounterHi, hostname=hostname, modemACMethernetCapacity=modemACMethernetCapacity, vlanNumber=vlanNumber, modemErroredSecondRatio=modemErroredSecondRatio, modemACMmodulationMax=modemACMmodulationMax, e1t1AIS=e1t1AIS, sysDateAndTime=sysDateAndTime, radioSide=radioSide, ethTXLateCollisions=ethTXLateCollisions, ethRXMulticasts=ethRXMulticasts, localIpMask=localIpMask, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemSymbolRateTx=modemSymbolRateTx, modemStatistics=modemStatistics, ethTXBackpresEvents=ethTXBackpresEvents, modemAcqStatus=modemAcqStatus, remoteIp=remoteIp, ethTXMaxCollisions=ethTXMaxCollisions, ethTXUnderruns=ethTXUnderruns, ipRadioMgmt=ipRadioMgmt, description=description, ethRXPauseFrames=ethRXPauseFrames, ethRXCodeErrors=ethRXCodeErrors, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemCountTime=modemCountTime, radioTxPower=radioTxPower, modemEntry=modemEntry, modemModulation=modemModulation, modemErroredBlock=modemErroredBlock, ethRXBroadcasts=ethRXBroadcasts, ethTXByteCounterHi=ethTXByteCounterHi, ipRadioCfg=ipRadioCfg, radioRxLevel=radioRxLevel, radioDuplexShift=radioDuplexShift, modemRowStatus=modemRowStatus, sysTemperature=sysTemperature, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemStandard=modemStandard, licenseMask=licenseMask, modemE1T1Channels=modemE1T1Channels, modemInternalAGCgain=modemInternalAGCgain, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ipRadio=ipRadio, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXPrevPktDropped=ethRXPrevPktDropped, modemTotalCapacity=modemTotalCapacity, ethTXVlanTags=ethTXVlanTags, microwaveRadio=microwaveRadio, radioLoopback=radioLoopback, radioGenStatus=radioGenStatus, ethRXByteCounterHi=ethRXByteCounterHi, ipRadioStat=ipRadioStat, loopback_tributary_mask=loopback_tributary_mask, safip=safip, modemBandwith=modemBandwith, radioEntry=radioEntry, ipRadioCfgGeneral=ipRadioCfgGeneral)
