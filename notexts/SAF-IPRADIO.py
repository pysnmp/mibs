...
mibBuilder.exportSymbols("SAF-IPRADIO", ipRadioCfgGeneral=ipRadioCfgGeneral, pointToPoint=pointToPoint, vlanFid=vlanFid, modemEntry=modemEntry, sysDateAndTime=sysDateAndTime, saf=saf, radioIndex=radioIndex, ethQOSTXFrames=ethQOSTXFrames, modemSymbolRateRx=modemSymbolRateRx, ethRXControlFrames=ethRXControlFrames, sysTemperature=sysTemperature, ethRXCRCErrors=ethRXCRCErrors, ethTXLateCollisions=ethTXLateCollisions, radioDuplexShift=radioDuplexShift, product=product, modemLDPCdecoderStress=modemLDPCdecoderStress, ethGFPDelineationErrors=ethGFPDelineationErrors, hostname=hostname, ethTXVlanTags=ethTXVlanTags, atpcTxPowerCorrection=atpcTxPowerCorrection, vlanNumber=vlanNumber, radioSide=radioSide, modemEthernetCapacity=modemEthernetCapacity, ethRXLongEvents=ethRXLongEvents, radioTxFrequency=radioTxFrequency, ethTXControlFrames=ethTXControlFrames, vlanPortmap=vlanPortmap, modemTotalBlockNumber=modemTotalBlockNumber, modemACMengine=modemACMengine, e1t1AIS=e1t1AIS, vlanTable=vlanTable, modemInternalAGCgain=modemInternalAGCgain, ethTXBroadcasts=ethTXBroadcasts, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethQOSTXDropped=ethQOSTXDropped, ethRXDones=ethRXDones, radioEntry=radioEntry, modemUptime=modemUptime, ethRXDribleNibbles=ethRXDribleNibbles, radioRxLevel=radioRxLevel, aTPCTable=aTPCTable, loopback_tributary_mask=loopback_tributary_mask, modemACMmodulationMax=modemACMmodulationMax, ethTXByteCounterHi=ethTXByteCounterHi, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemCarrierOffset=modemCarrierOffset, atpcEnabled=atpcEnabled, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemBandwith=modemBandwith, license=license, modemSymbolRateTx=modemSymbolRateTx, microwaveRadio=microwaveRadio, aTPCEntry=aTPCEntry, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethGFPDropedFrames=ethGFPDropedFrames, ipRadioMgmt=ipRadioMgmt, radioGenStatus=radioGenStatus, ipRadio=ipRadio, modemStatistics=modemStatistics, modemRowStatus=modemRowStatus, ethRXMulticasts=ethRXMulticasts, modemSeverelyErroredSecond=modemSeverelyErroredSecond, writeConfig=writeConfig, vlanRowStatus=vlanRowStatus, modemTable=modemTable, localIp=localIp, ethTXLengthCheckErrors=ethTXLengthCheckErrors, vlanCfgStat=vlanCfgStat, radioRxFrequency=radioRxFrequency, modemCountTime=modemCountTime, description=description, radioTxMute=radioTxMute, radioTable=radioTable, e1t1LOS=e1t1LOS, ipRadioCfg=ipRadioCfg, ethRXBroadcasts=ethRXBroadcasts, ipRadioStat=ipRadioStat, modemAcqStatus=modemAcqStatus, modemErroredSecond=modemErroredSecond, ethTXExcessiveDefers=ethTXExcessiveDefers, vlansEnabled=vlansEnabled, tehnika=tehnika, ipRadioCfgNetwork=ipRadioCfgNetwork, localIpMask=localIpMask, ethGFPCHECErrors=ethGFPCHECErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethGFPFCSErrors=ethGFPFCSErrors, remoteIp=remoteIp, radioLoopback=radioLoopback, safip=safip, ethRXByteCounterLow=ethRXByteCounterLow, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXTruncatedFrames=ethRXTruncatedFrames, radioTxPower=radioTxPower, ethTXPauseFrames=ethTXPauseFrames, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, e1t1ChannelNr=e1t1ChannelNr, e1t1StatTable=e1t1StatTable, modemErroredBlock=modemErroredBlock, e1t1StatEntry=e1t1StatEntry, loopbacks=loopbacks, modemStandard=modemStandard, atpcIndex=atpcIndex, ethTXCollisions=ethTXCollisions, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXGiants=ethTXGiants, modemUnavailtime=modemUnavailtime, ipRadioStatEth=ipRadioStatEth, ethTXUnderruns=ethTXUnderruns, licenseUpdateStatus=licenseUpdateStatus, ethTXByteCounterLow=ethTXByteCounterLow, vlanPortType=vlanPortType, modemLastAcqError=modemLastAcqError, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXByteCounterHi=ethRXByteCounterHi, ethTXDones=ethTXDones, modemIndex=modemIndex, modemModulation=modemModulation, modemACMtotalCapacity=modemACMtotalCapacity, ethRXDvEvent=ethRXDvEvent, ethTXWireByteCounterLow=ethTXWireByteCounterLow, licenseMask=licenseMask, modemACMethernetCapacity=modemACMethernetCapacity, modemGeneralStatus=modemGeneralStatus, modemErroredSecondRatio=modemErroredSecondRatio, modemE1T1Channels=modemE1T1Channels, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXBackpresEvents=ethTXBackpresEvents, ethRXPrevPktDropped=ethRXPrevPktDropped, restartcpu=restartcpu, modemRadialMSE=modemRadialMSE, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, vlanEntry=vlanEntry, ethTXMulticasts=ethTXMulticasts, modemACMmodulationMin=modemACMmodulationMin, ethRXCodeErrors=ethRXCodeErrors, ethRXPauseFrames=ethRXPauseFrames, ethTXCRCErrors=ethTXCRCErrors, modemTotalCapacity=modemTotalCapacity, ethTXMaxCollisions=ethTXMaxCollisions, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped)
