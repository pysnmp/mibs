...
mibBuilder.exportSymbols("SAF-IPRADIO", modemGeneralStatus=modemGeneralStatus, e1t1LOS=e1t1LOS, radioRxFrequency=radioRxFrequency, e1t1AIS=e1t1AIS, modemAcqStatus=modemAcqStatus, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXCodeErrors=ethRXCodeErrors, ethTXVlanTags=ethTXVlanTags, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXPauseFrames=ethTXPauseFrames, ethGFPFCSErrors=ethGFPFCSErrors, ethTXByteCounterHi=ethTXByteCounterHi, licenseMask=licenseMask, ethRXByteCounterLow=ethRXByteCounterLow, ethTXWireByteCounterLow=ethTXWireByteCounterLow, atpcIndex=atpcIndex, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, localIp=localIp, modemUptime=modemUptime, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemACMtotalCapacity=modemACMtotalCapacity, modemSymbolRateRx=modemSymbolRateRx, vlanTable=vlanTable, modemSymbolRateTx=modemSymbolRateTx, ipRadioCfgNetwork=ipRadioCfgNetwork, modemACMmodulationMin=modemACMmodulationMin, ethRXPauseFrames=ethRXPauseFrames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemE1T1Channels=modemE1T1Channels, description=description, vlanFid=vlanFid, modemCountTime=modemCountTime, ethRXBroadcasts=ethRXBroadcasts, ethTXMulticasts=ethTXMulticasts, saf=saf, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioIndex=radioIndex, microwaveRadio=microwaveRadio, modemIndex=modemIndex, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemInternalAGCgain=modemInternalAGCgain, radioTable=radioTable, modemStandard=modemStandard, vlansEnabled=vlansEnabled, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioLoopback=radioLoopback, radioTxPower=radioTxPower, ethRXByteCounterHi=ethRXByteCounterHi, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemLDPCdecoderStress=modemLDPCdecoderStress, ipRadio=ipRadio, ethQOSTXFrames=ethQOSTXFrames, aTPCEntry=aTPCEntry, licenseUpdateStatus=licenseUpdateStatus, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXGiants=ethTXGiants, modemErroredSecondRatio=modemErroredSecondRatio, ethRXMulticasts=ethRXMulticasts, modemEthernetCapacity=modemEthernetCapacity, ethTXCollisions=ethTXCollisions, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ipRadioStat=ipRadioStat, ethRXCRCErrors=ethRXCRCErrors, writeConfig=writeConfig, loopbacks=loopbacks, modemACMengine=modemACMengine, ethRXLongEvents=ethRXLongEvents, ethTXCRCErrors=ethTXCRCErrors, ethRXDribleNibbles=ethRXDribleNibbles, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXDones=ethRXDones, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethQOSTXDropped=ethQOSTXDropped, modemTable=modemTable, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, atpcEnabled=atpcEnabled, pointToPoint=pointToPoint, ethRXControlFrames=ethRXControlFrames, ethRXDvEvent=ethRXDvEvent, modemUnavailtime=modemUnavailtime, modemEntry=modemEntry, radioGenStatus=radioGenStatus, e1t1ChannelNr=e1t1ChannelNr, ethTXBroadcasts=ethTXBroadcasts, modemRadialMSE=modemRadialMSE, ethRXTruncatedFrames=ethRXTruncatedFrames, radioRxLevel=radioRxLevel, radioTxMute=radioTxMute, vlanCfgStat=vlanCfgStat, modemTotalBlockNumber=modemTotalBlockNumber, radioDuplexShift=radioDuplexShift, radioSide=radioSide, ethTXBackpresEvents=ethTXBackpresEvents, tehnika=tehnika, ethTXLateCollisions=ethTXLateCollisions, ipRadioMgmt=ipRadioMgmt, ethGFPCHECErrors=ethGFPCHECErrors, ipRadioCfg=ipRadioCfg, e1t1StatEntry=e1t1StatEntry, ipRadioStatEth=ipRadioStatEth, sysTemperature=sysTemperature, vlanPortmap=vlanPortmap, radioEntry=radioEntry, e1t1StatTable=e1t1StatTable, aTPCTable=aTPCTable, modemACMethernetCapacity=modemACMethernetCapacity, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioTxFrequency=radioTxFrequency, ethTXDones=ethTXDones, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemRowStatus=modemRowStatus, hostname=hostname, modemBandwith=modemBandwith, loopback_tributary_mask=loopback_tributary_mask, ethTXMaxCollisions=ethTXMaxCollisions, product=product, vlanRowStatus=vlanRowStatus, remoteIp=remoteIp, ethTXExcessiveDefers=ethTXExcessiveDefers, modemTotalCapacity=modemTotalCapacity, restartcpu=restartcpu, modemACMmodulationMax=modemACMmodulationMax, ethGFPDelineationErrors=ethGFPDelineationErrors, localIpMask=localIpMask, modemCarrierOffset=modemCarrierOffset, vlanNumber=vlanNumber, vlanPortType=vlanPortType, modemStatistics=modemStatistics, modemModulation=modemModulation, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXByteCounterLow=ethTXByteCounterLow, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, sysDateAndTime=sysDateAndTime, vlanEntry=vlanEntry, safip=safip, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemErroredBlock=modemErroredBlock, modemErroredSecond=modemErroredSecond, license=license, ethTXUnderruns=ethTXUnderruns, ethGFPDropedFrames=ethGFPDropedFrames, modemLastAcqError=modemLastAcqError, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXControlFrames=ethTXControlFrames)
