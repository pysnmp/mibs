...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXBroadcasts=ethRXBroadcasts, description=description, loopbacks=loopbacks, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXVlanTags=ethTXVlanTags, localIp=localIp, ethTXLengthCheckErrors=ethTXLengthCheckErrors, vlanPortmap=vlanPortmap, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemErroredSecondRatio=modemErroredSecondRatio, modemEthernetCapacity=modemEthernetCapacity, modemRadialMSE=modemRadialMSE, radioTxMute=radioTxMute, radioGenStatus=radioGenStatus, vlanNumber=vlanNumber, radioIndex=radioIndex, ipRadioCfgGeneral=ipRadioCfgGeneral, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlanFid=vlanFid, vlanCfgStat=vlanCfgStat, ethTXUnderruns=ethTXUnderruns, modemTotalCapacity=modemTotalCapacity, ethTXControlFrames=ethTXControlFrames, ethRXPrevPktDropped=ethRXPrevPktDropped, modemErroredSecond=modemErroredSecond, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemStandard=modemStandard, license=license, atpcEnabled=atpcEnabled, ethRXCodeErrors=ethRXCodeErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemGeneralStatus=modemGeneralStatus, vlanTable=vlanTable, ethRXLongEvents=ethRXLongEvents, ethTXCRCErrors=ethTXCRCErrors, ethRXByteCounterLow=ethRXByteCounterLow, vlanRowStatus=vlanRowStatus, hostname=hostname, sysDateAndTime=sysDateAndTime, radioRxFrequency=radioRxFrequency, modemErroredBlock=modemErroredBlock, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemTotalBlockNumber=modemTotalBlockNumber, licenseUpdateStatus=licenseUpdateStatus, ethRXMulticasts=ethRXMulticasts, radioTxFrequency=radioTxFrequency, licenseMask=licenseMask, writeConfig=writeConfig, modemIndex=modemIndex, modemACMmodulationMax=modemACMmodulationMax, radioRxLevel=radioRxLevel, ethRXDones=ethRXDones, ethTXLateCollisions=ethTXLateCollisions, e1t1StatEntry=e1t1StatEntry, radioEntry=radioEntry, modemSymbolRateRx=modemSymbolRateRx, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioTable=radioTable, modemEntry=modemEntry, sysTemperature=sysTemperature, ethRXCRCErrors=ethRXCRCErrors, modemBandwith=modemBandwith, modemSymbolRateTx=modemSymbolRateTx, ipRadioStatEth=ipRadioStatEth, ethTXDones=ethTXDones, ethRXDvEvent=ethRXDvEvent, modemACMmodulationMin=modemACMmodulationMin, ethRXPauseFrames=ethRXPauseFrames, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemRowStatus=modemRowStatus, atpcIndex=atpcIndex, ethTXByteCounterHi=ethTXByteCounterHi, ipRadioCfg=ipRadioCfg, aTPCTable=aTPCTable, ethQOSRXQ1Frames=ethQOSRXQ1Frames, pointToPoint=pointToPoint, modemSeverelyErroredSecond=modemSeverelyErroredSecond, product=product, ethRXByteCounterHi=ethRXByteCounterHi, ethTXBroadcasts=ethTXBroadcasts, radioSide=radioSide, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXMaxCollisions=ethTXMaxCollisions, modemCountTime=modemCountTime, modemE1T1Channels=modemE1T1Channels, modemAcqStatus=modemAcqStatus, e1t1LOS=e1t1LOS, e1t1AIS=e1t1AIS, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXBackpresEvents=ethTXBackpresEvents, loopback_tributary_mask=loopback_tributary_mask, localIpMask=localIpMask, ethGFPCHECErrors=ethGFPCHECErrors, aTPCEntry=aTPCEntry, ethTXGiants=ethTXGiants, ipRadio=ipRadio, modemUnavailtime=modemUnavailtime, ethGFPDropedFrames=ethGFPDropedFrames, ethQOSTXDropped=ethQOSTXDropped, modemUptime=modemUptime, modemModulation=modemModulation, ethTXMulticasts=ethTXMulticasts, tehnika=tehnika, e1t1ChannelNr=e1t1ChannelNr, radioDuplexShift=radioDuplexShift, ethQOSTXFrames=ethQOSTXFrames, modemACMengine=modemACMengine, microwaveRadio=microwaveRadio, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXExcessiveDefers=ethTXExcessiveDefers, modemCarrierOffset=modemCarrierOffset, radioLoopback=radioLoopback, ethTXCollisions=ethTXCollisions, restartcpu=restartcpu, ethGFPFCSErrors=ethGFPFCSErrors, modemACMtotalCapacity=modemACMtotalCapacity, modemInternalAGCgain=modemInternalAGCgain, ethRXControlFrames=ethRXControlFrames, modemLDPCdecoderStress=modemLDPCdecoderStress, vlanEntry=vlanEntry, ethRXDribleNibbles=ethRXDribleNibbles, vlansEnabled=vlansEnabled, modemStatistics=modemStatistics, radioTxPower=radioTxPower, ipRadioMgmt=ipRadioMgmt, ipRadioStat=ipRadioStat, modemTable=modemTable, saf=saf, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, vlanPortType=vlanPortType, safip=safip, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemLastAcqError=modemLastAcqError, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXPauseFrames=ethTXPauseFrames, e1t1StatTable=e1t1StatTable, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, remoteIp=remoteIp, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXByteCounterLow=ethTXByteCounterLow, modemACMethernetCapacity=modemACMethernetCapacity)
