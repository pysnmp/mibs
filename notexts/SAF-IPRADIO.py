...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXUnderruns=ethTXUnderruns, e1t1StatEntry=e1t1StatEntry, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXBroadcasts=ethRXBroadcasts, ipRadioCfg=ipRadioCfg, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ipRadioMgmt=ipRadioMgmt, ipRadioStat=ipRadioStat, loopbacks=loopbacks, modemACMmodulationMin=modemACMmodulationMin, ethRXByteCounterLow=ethRXByteCounterLow, ethTXCollisions=ethTXCollisions, ethRXCodeErrors=ethRXCodeErrors, vlanNumber=vlanNumber, vlanPortType=vlanPortType, modemACMengine=modemACMengine, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemRadialMSE=modemRadialMSE, modemErroredSecondRatio=modemErroredSecondRatio, atpcEnabled=atpcEnabled, radioTxPower=radioTxPower, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioEntry=radioEntry, radioTxMute=radioTxMute, pointToPoint=pointToPoint, modemTable=modemTable, radioTxFrequency=radioTxFrequency, licenseUpdateStatus=licenseUpdateStatus, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXLengthCheckErrors=ethTXLengthCheckErrors, remoteIp=remoteIp, ethRXTruncatedFrames=ethRXTruncatedFrames, e1t1AIS=e1t1AIS, ethTXWireByteCounterLow=ethTXWireByteCounterLow, writeConfig=writeConfig, modemRowStatus=modemRowStatus, ethRXMulticasts=ethRXMulticasts, ethTXLateCollisions=ethTXLateCollisions, ethRXCRCErrors=ethRXCRCErrors, description=description, loopback_tributary_mask=loopback_tributary_mask, ethGFPCHECErrors=ethGFPCHECErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, modemACMtotalCapacity=modemACMtotalCapacity, ethRXLongEvents=ethRXLongEvents, ipRadio=ipRadio, restartcpu=restartcpu, radioDuplexShift=radioDuplexShift, ethTXControlFrames=ethTXControlFrames, modemIndex=modemIndex, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, license=license, modemEthernetCapacity=modemEthernetCapacity, modemBandwith=modemBandwith, ethGFPDropedFrames=ethGFPDropedFrames, ethRXControlFrames=ethRXControlFrames, modemUnavailtime=modemUnavailtime, radioRxFrequency=radioRxFrequency, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXMaxCollisions=ethTXMaxCollisions, modemStandard=modemStandard, vlansEnabled=vlansEnabled, microwaveRadio=microwaveRadio, e1t1LOS=e1t1LOS, ethQOSTXDropped=ethQOSTXDropped, modemCarrierOffset=modemCarrierOffset, ethTXByteCounterLow=ethTXByteCounterLow, modemStatistics=modemStatistics, saf=saf, modemModulation=modemModulation, e1t1StatTable=e1t1StatTable, ipRadioStatEth=ipRadioStatEth, ethTXDones=ethTXDones, hostname=hostname, ethRXByteCounterHi=ethRXByteCounterHi, safip=safip, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXPauseFrames=ethRXPauseFrames, ethQOSTXFrames=ethQOSTXFrames, sysDateAndTime=sysDateAndTime, modemInternalAGCgain=modemInternalAGCgain, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXDvEvent=ethRXDvEvent, modemGeneralStatus=modemGeneralStatus, ethTXBroadcasts=ethTXBroadcasts, ethGFPDelineationErrors=ethGFPDelineationErrors, localIpMask=localIpMask, vlanRowStatus=vlanRowStatus, ethTXExcessiveDefers=ethTXExcessiveDefers, radioIndex=radioIndex, ethTXCRCErrors=ethTXCRCErrors, radioSide=radioSide, tehnika=tehnika, vlanFid=vlanFid, ethTXGiants=ethTXGiants, radioRxLevel=radioRxLevel, vlanCfgStat=vlanCfgStat, modemSeverelyErroredSecond=modemSeverelyErroredSecond, aTPCTable=aTPCTable, modemErroredBlock=modemErroredBlock, ethTXWireByteCounterHi=ethTXWireByteCounterHi, vlanEntry=vlanEntry, modemE1T1Channels=modemE1T1Channels, ethRXDones=ethRXDones, modemAcqStatus=modemAcqStatus, modemSymbolRateRx=modemSymbolRateRx, product=product, radioTable=radioTable, modemEntry=modemEntry, modemSymbolRateTx=modemSymbolRateTx, modemACMethernetCapacity=modemACMethernetCapacity, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXDribleNibbles=ethRXDribleNibbles, ethTXVlanTags=ethTXVlanTags, radioLoopback=radioLoopback, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethGFPFCSErrors=ethGFPFCSErrors, modemLastAcqError=modemLastAcqError, modemUptime=modemUptime, ethTXMulticasts=ethTXMulticasts, radioGenStatus=radioGenStatus, vlanTable=vlanTable, modemTotalBlockNumber=modemTotalBlockNumber, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXByteCounterHi=ethTXByteCounterHi, localIp=localIp, atpcIndex=atpcIndex, atpcTxPowerCorrection=atpcTxPowerCorrection, vlanPortmap=vlanPortmap, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, e1t1ChannelNr=e1t1ChannelNr, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXBackpresEvents=ethTXBackpresEvents, ethTXPauseFrames=ethTXPauseFrames, modemTotalCapacity=modemTotalCapacity, licenseMask=licenseMask, modemACMmodulationMax=modemACMmodulationMax, modemErroredSecond=modemErroredSecond, sysTemperature=sysTemperature, aTPCEntry=aTPCEntry, modemCountTime=modemCountTime)
