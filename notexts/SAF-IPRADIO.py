...
mibBuilder.exportSymbols("SAF-IPRADIO", radioSide=radioSide, licenseMask=licenseMask, ipRadioStatEth=ipRadioStatEth, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemErroredSecondRatio=modemErroredSecondRatio, ethRXMulticasts=ethRXMulticasts, ethTXByteCounterHi=ethTXByteCounterHi, ethRXCRCErrors=ethRXCRCErrors, vlanNumber=vlanNumber, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXByteCounterLow=ethTXByteCounterLow, ethRXVlanTagsDetected=ethRXVlanTagsDetected, saf=saf, ethRXByteCounterLow=ethRXByteCounterLow, modemAcqStatus=modemAcqStatus, e1t1StatEntry=e1t1StatEntry, license=license, ethRXTruncatedFrames=ethRXTruncatedFrames, radioRxLevel=radioRxLevel, writeConfig=writeConfig, radioTable=radioTable, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXBroadcasts=ethTXBroadcasts, product=product, modemRadialMSE=modemRadialMSE, modemInternalAGCgain=modemInternalAGCgain, radioTxMute=radioTxMute, aTPCTable=aTPCTable, vlanCfgStat=vlanCfgStat, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXBroadcasts=ethRXBroadcasts, vlanTable=vlanTable, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemE1T1Channels=modemE1T1Channels, sysDateAndTime=sysDateAndTime, vlanPortType=vlanPortType, sysTemperature=sysTemperature, ethRXControlFrames=ethRXControlFrames, aTPCEntry=aTPCEntry, ethTXUnderruns=ethTXUnderruns, description=description, ethTXControlFrames=ethTXControlFrames, radioDuplexShift=radioDuplexShift, vlanPortmap=vlanPortmap, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXPauseFrames=ethTXPauseFrames, ethTXDones=ethTXDones, modemEntry=modemEntry, modemGeneralStatus=modemGeneralStatus, ethQOSTXDropped=ethQOSTXDropped, modemTotalCapacity=modemTotalCapacity, radioRxFrequency=radioRxFrequency, ipRadioCfgGeneral=ipRadioCfgGeneral, tehnika=tehnika, microwaveRadio=microwaveRadio, ethTXVlanTags=ethTXVlanTags, ethRXLongEvents=ethRXLongEvents, ethRXPauseFrames=ethRXPauseFrames, ethTXLateCollisions=ethTXLateCollisions, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlanEntry=vlanEntry, atpcTxPowerCorrection=atpcTxPowerCorrection, ipRadioMgmt=ipRadioMgmt, e1t1StatTable=e1t1StatTable, ipRadioStat=ipRadioStat, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemACMmodulationMax=modemACMmodulationMax, ethTXGiants=ethTXGiants, localIpMask=localIpMask, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemTotalBlockNumber=modemTotalBlockNumber, ipRadioCfgNetwork=ipRadioCfgNetwork, remoteIp=remoteIp, modemRowStatus=modemRowStatus, modemUnavailtime=modemUnavailtime, modemACMmodulationMin=modemACMmodulationMin, modemIndex=modemIndex, radioLoopback=radioLoopback, modemStandard=modemStandard, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemErroredSecond=modemErroredSecond, vlansEnabled=vlansEnabled, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXDvEvent=ethRXDvEvent, licenseUpdateStatus=licenseUpdateStatus, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioIndex=radioIndex, modemErroredBlock=modemErroredBlock, modemLastAcqError=modemLastAcqError, localIp=localIp, atpcEnabled=atpcEnabled, ipRadioCfg=ipRadioCfg, ethTXMaxCollisions=ethTXMaxCollisions, restartcpu=restartcpu, modemE1T1ChannelMask=modemE1T1ChannelMask, ethGFPFCSErrors=ethGFPFCSErrors, modemACMethernetCapacity=modemACMethernetCapacity, radioGenStatus=radioGenStatus, atpcIndex=atpcIndex, ethRXDones=ethRXDones, modemACMtotalCapacity=modemACMtotalCapacity, ethRXDribleNibbles=ethRXDribleNibbles, ethRXCodeErrors=ethRXCodeErrors, ethTXMulticasts=ethTXMulticasts, ethGFPCHECErrors=ethGFPCHECErrors, e1t1ChannelNr=e1t1ChannelNr, modemEthernetCapacity=modemEthernetCapacity, modemModulation=modemModulation, ethGFPDelineationErrors=ethGFPDelineationErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioTxFrequency=radioTxFrequency, modemSymbolRateTx=modemSymbolRateTx, modemACMengine=modemACMengine, vlanRowStatus=vlanRowStatus, ethRXByteCounterHi=ethRXByteCounterHi, ipRadio=ipRadio, ethGFPDropedFrames=ethGFPDropedFrames, modemStatistics=modemStatistics, ethTXBackpresEvents=ethTXBackpresEvents, hostname=hostname, vlanFid=vlanFid, loopbacks=loopbacks, ethTXCRCErrors=ethTXCRCErrors, radioEntry=radioEntry, radioTxPower=radioTxPower, modemCountTime=modemCountTime, modemTable=modemTable, e1t1LOS=e1t1LOS, modemSymbolRateRx=modemSymbolRateRx, loopback_tributary_mask=loopback_tributary_mask, modemBandwith=modemBandwith, pointToPoint=pointToPoint, modemCarrierOffset=modemCarrierOffset, ethTXCollisions=ethTXCollisions, safip=safip, e1t1AIS=e1t1AIS, ethQOSTXFrames=ethQOSTXFrames, modemUptime=modemUptime, ethTXLengthCheckErrors=ethTXLengthCheckErrors)
