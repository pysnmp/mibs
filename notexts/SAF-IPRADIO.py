...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXLengthCheckErrors=ethTXLengthCheckErrors, licenseMask=licenseMask, aTPCEntry=aTPCEntry, ethRXDones=ethRXDones, safip=safip, modemSymbolRateRx=modemSymbolRateRx, ethTXExcessiveDefers=ethTXExcessiveDefers, ethGFPDropedFrames=ethGFPDropedFrames, modemAcqStatus=modemAcqStatus, modemTotalBlockNumber=modemTotalBlockNumber, modemUnavailtime=modemUnavailtime, modemLDPCdecoderStress=modemLDPCdecoderStress, modemACMtotalCapacity=modemACMtotalCapacity, license=license, ethRXBroadcasts=ethRXBroadcasts, sysDateAndTime=sysDateAndTime, ethRXControlFrames=ethRXControlFrames, e1t1AIS=e1t1AIS, ethGFPCHECErrors=ethGFPCHECErrors, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, loopback_tributary_mask=loopback_tributary_mask, modemErroredBlock=modemErroredBlock, ethRXLongEvents=ethRXLongEvents, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, product=product, microwaveRadio=microwaveRadio, vlanCfgStat=vlanCfgStat, ethTXUnderruns=ethTXUnderruns, modemInternalAGCgain=modemInternalAGCgain, aTPCTable=aTPCTable, ethTXByteCounterHi=ethTXByteCounterHi, ethRXByteCounterHi=ethRXByteCounterHi, radioEntry=radioEntry, sysTemperature=sysTemperature, radioRxLevel=radioRxLevel, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemLastAcqError=modemLastAcqError, modemBandwith=modemBandwith, ethRXPauseFrames=ethRXPauseFrames, modemACMmodulationMax=modemACMmodulationMax, vlanPortmap=vlanPortmap, ethTXBackpresEvents=ethTXBackpresEvents, hostname=hostname, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioTxPower=radioTxPower, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXLateCollisions=ethTXLateCollisions, vlanPortType=vlanPortType, ethRXCRCErrors=ethRXCRCErrors, vlanNumber=vlanNumber, ethTXCollisions=ethTXCollisions, ethGFPFCSErrors=ethGFPFCSErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXUnsupOpcodes=ethRXUnsupOpcodes, description=description, radioGenStatus=radioGenStatus, ethRXDribleNibbles=ethRXDribleNibbles, modemRowStatus=modemRowStatus, radioSide=radioSide, licenseUpdateStatus=licenseUpdateStatus, ethTXBroadcasts=ethTXBroadcasts, pointToPoint=pointToPoint, ipRadioCfg=ipRadioCfg, ethTXPauseFrames=ethTXPauseFrames, modemEthernetCapacity=modemEthernetCapacity, ipRadioCfgNetwork=ipRadioCfgNetwork, vlanFid=vlanFid, ethRXDvEvent=ethRXDvEvent, atpcEnabled=atpcEnabled, modemErroredSecond=modemErroredSecond, radioTxFrequency=radioTxFrequency, ethRXByteCounterLow=ethRXByteCounterLow, modemRadialMSE=modemRadialMSE, writeConfig=writeConfig, ethQOSTXFrames=ethQOSTXFrames, modemE1T1ChannelMask=modemE1T1ChannelMask, modemACMethernetCapacity=modemACMethernetCapacity, e1t1StatTable=e1t1StatTable, ethTXVlanTags=ethTXVlanTags, radioIndex=radioIndex, modemE1T1Channels=modemE1T1Channels, modemEntry=modemEntry, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemErroredSecondRatio=modemErroredSecondRatio, modemGeneralStatus=modemGeneralStatus, saf=saf, vlanTable=vlanTable, ethTXByteCounterLow=ethTXByteCounterLow, radioLoopback=radioLoopback, radioRxFrequency=radioRxFrequency, modemSymbolRateTx=modemSymbolRateTx, ethTXGiants=ethTXGiants, modemModulation=modemModulation, ethTXMulticasts=ethTXMulticasts, ethTXWireByteCounterLow=ethTXWireByteCounterLow, e1t1ChannelNr=e1t1ChannelNr, ipRadioStatEth=ipRadioStatEth, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemTable=modemTable, ethTXDones=ethTXDones, localIpMask=localIpMask, vlansEnabled=vlansEnabled, e1t1StatEntry=e1t1StatEntry, modemStatistics=modemStatistics, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethGFPDelineationErrors=ethGFPDelineationErrors, ethQOSTXDropped=ethQOSTXDropped, ethRXCodeErrors=ethRXCodeErrors, modemIndex=modemIndex, loopbacks=loopbacks, modemUptime=modemUptime, ethTXCRCErrors=ethTXCRCErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioTxMute=radioTxMute, ethRXMulticasts=ethRXMulticasts, modemCountTime=modemCountTime, ipRadio=ipRadio, tehnika=tehnika, ethTXWireByteCounterHi=ethTXWireByteCounterHi, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXPrevPktDropped=ethRXPrevPktDropped, modemACMmodulationMin=modemACMmodulationMin, remoteIp=remoteIp, radioDuplexShift=radioDuplexShift, modemStandard=modemStandard, modemCarrierOffset=modemCarrierOffset, ipRadioCfgGeneral=ipRadioCfgGeneral, restartcpu=restartcpu, modemTotalCapacity=modemTotalCapacity, vlanEntry=vlanEntry, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXMaxCollisions=ethTXMaxCollisions, ipRadioMgmt=ipRadioMgmt, localIp=localIp, e1t1LOS=e1t1LOS, vlanRowStatus=vlanRowStatus, radioTable=radioTable, ipRadioStat=ipRadioStat, modemACMengine=modemACMengine, ethTXControlFrames=ethTXControlFrames, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, atpcIndex=atpcIndex)
