...
mibBuilder.exportSymbols("SAF-IPRADIO", modemCountTime=modemCountTime, modemTable=modemTable, vlanPortType=vlanPortType, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, localIp=localIp, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXLongEvents=ethRXLongEvents, ipRadioCfg=ipRadioCfg, ethQOSTXDropped=ethQOSTXDropped, modemLDPCdecoderStress=modemLDPCdecoderStress, radioEntry=radioEntry, aTPCTable=aTPCTable, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXVlanTags=ethTXVlanTags, ethTXByteCounterHi=ethTXByteCounterHi, remoteIp=remoteIp, e1t1LOS=e1t1LOS, ethTXLateCollisions=ethTXLateCollisions, radioTable=radioTable, modemSeverelyErroredSecond=modemSeverelyErroredSecond, e1t1ChannelNr=e1t1ChannelNr, aTPCEntry=aTPCEntry, ethGFPDelineationErrors=ethGFPDelineationErrors, radioTxMute=radioTxMute, modemSymbolRateRx=modemSymbolRateRx, radioDuplexShift=radioDuplexShift, ethTXBackpresEvents=ethTXBackpresEvents, modemBandwith=modemBandwith, ethRXMulticasts=ethRXMulticasts, ethQOSTXFrames=ethQOSTXFrames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXPauseFrames=ethRXPauseFrames, writeConfig=writeConfig, ipRadioStat=ipRadioStat, safip=safip, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemErroredSecondRatio=modemErroredSecondRatio, vlansEnabled=vlansEnabled, ethTXMulticasts=ethTXMulticasts, modemACMethernetCapacity=modemACMethernetCapacity, modemTotalCapacity=modemTotalCapacity, e1t1StatTable=e1t1StatTable, modemTotalBlockNumber=modemTotalBlockNumber, tehnika=tehnika, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioGenStatus=radioGenStatus, vlanPortmap=vlanPortmap, modemErroredBlock=modemErroredBlock, product=product, modemAcqStatus=modemAcqStatus, radioRxLevel=radioRxLevel, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, localIpMask=localIpMask, ethRXTruncatedFrames=ethRXTruncatedFrames, modemStandard=modemStandard, ethRXByteCounterLow=ethRXByteCounterLow, licenseUpdateStatus=licenseUpdateStatus, modemACMmodulationMin=modemACMmodulationMin, ethTXPauseFrames=ethTXPauseFrames, ethTXBroadcasts=ethTXBroadcasts, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemRadialMSE=modemRadialMSE, modemEntry=modemEntry, loopback_tributary_mask=loopback_tributary_mask, ethTXControlFrames=ethTXControlFrames, ethTXUnderruns=ethTXUnderruns, ethRXBroadcasts=ethRXBroadcasts, ethRXCodeErrors=ethRXCodeErrors, ipRadioMgmt=ipRadioMgmt, licenseMask=licenseMask, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemErroredSecond=modemErroredSecond, hostname=hostname, ethGFPDropedFrames=ethGFPDropedFrames, ethTXCRCErrors=ethTXCRCErrors, ethGFPFCSErrors=ethGFPFCSErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, restartcpu=restartcpu, modemUptime=modemUptime, loopbacks=loopbacks, microwaveRadio=microwaveRadio, sysDateAndTime=sysDateAndTime, radioTxFrequency=radioTxFrequency, modemACMmodulationMax=modemACMmodulationMax, ipRadioStatEth=ipRadioStatEth, vlanFid=vlanFid, e1t1AIS=e1t1AIS, ethRXDvEvent=ethRXDvEvent, ethTXMaxCollisions=ethTXMaxCollisions, ethGFPCHECErrors=ethGFPCHECErrors, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXByteCounterLow=ethTXByteCounterLow, modemLastAcqError=modemLastAcqError, modemACMengine=modemACMengine, modemRowStatus=modemRowStatus, radioSide=radioSide, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ipRadioCfgNetwork=ipRadioCfgNetwork, modemEthernetCapacity=modemEthernetCapacity, vlanRowStatus=vlanRowStatus, ethRXControlFrames=ethRXControlFrames, vlanEntry=vlanEntry, modemInternalAGCgain=modemInternalAGCgain, saf=saf, sysTemperature=sysTemperature, modemE1T1ChannelMask=modemE1T1ChannelMask, atpcTxPowerCorrection=atpcTxPowerCorrection, modemE1T1Channels=modemE1T1Channels, ethRXCRCErrors=ethRXCRCErrors, modemACMtotalCapacity=modemACMtotalCapacity, description=description, ethRXDones=ethRXDones, modemIndex=modemIndex, ethRXPrevPktDropped=ethRXPrevPktDropped, modemGeneralStatus=modemGeneralStatus, ethRXDribleNibbles=ethRXDribleNibbles, modemModulation=modemModulation, ethTXGiants=ethTXGiants, modemUnavailtime=modemUnavailtime, radioRxFrequency=radioRxFrequency, pointToPoint=pointToPoint, atpcIndex=atpcIndex, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ipRadio=ipRadio, vlanNumber=vlanNumber, vlanTable=vlanTable, radioTxPower=radioTxPower, modemCarrierOffset=modemCarrierOffset, license=license, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXDones=ethTXDones, modemStatistics=modemStatistics, radioLoopback=radioLoopback, e1t1StatEntry=e1t1StatEntry, ethRXByteCounterHi=ethRXByteCounterHi, vlanCfgStat=vlanCfgStat, atpcEnabled=atpcEnabled, radioIndex=radioIndex, ethTXCollisions=ethTXCollisions, modemSymbolRateTx=modemSymbolRateTx)
