...
mibBuilder.exportSymbols("SAF-IPRADIO", ethQOSTXFrames=ethQOSTXFrames, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, vlanRowStatus=vlanRowStatus, ethRXByteCounterHi=ethRXByteCounterHi, writeConfig=writeConfig, modemACMethernetCapacity=modemACMethernetCapacity, ipRadioMgmt=ipRadioMgmt, modemStandard=modemStandard, vlanEntry=vlanEntry, modemInternalAGCgain=modemInternalAGCgain, ethTXExcessiveDefers=ethTXExcessiveDefers, ethGFPDropedFrames=ethGFPDropedFrames, ethTXVlanTags=ethTXVlanTags, ethRXByteCounterLow=ethRXByteCounterLow, aTPCEntry=aTPCEntry, modemAcqStatus=modemAcqStatus, vlanCfgStat=vlanCfgStat, ethTXCollisions=ethTXCollisions, ipRadioCfgNetwork=ipRadioCfgNetwork, modemCarrierOffset=modemCarrierOffset, ethRXMulticasts=ethRXMulticasts, modemACMengine=modemACMengine, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, sysDateAndTime=sysDateAndTime, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXDones=ethTXDones, ipRadio=ipRadio, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXMaxCollisions=ethTXMaxCollisions, vlanTable=vlanTable, modemModulation=modemModulation, ipRadioCfg=ipRadioCfg, modemACMmodulationMax=modemACMmodulationMax, ethRXPrevPktDropped=ethRXPrevPktDropped, modemRowStatus=modemRowStatus, radioIndex=radioIndex, loopback_tributary_mask=loopback_tributary_mask, modemErroredBlock=modemErroredBlock, ipRadioStatEth=ipRadioStatEth, pointToPoint=pointToPoint, description=description, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemSymbolRateTx=modemSymbolRateTx, radioLoopback=radioLoopback, modemLastAcqError=modemLastAcqError, loopbacks=loopbacks, ethRXBroadcasts=ethRXBroadcasts, e1t1AIS=e1t1AIS, ethTXByteCounterHi=ethTXByteCounterHi, product=product, modemACMmodulationMin=modemACMmodulationMin, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioTxPower=radioTxPower, restartcpu=restartcpu, modemIndex=modemIndex, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXUnderruns=ethTXUnderruns, tehnika=tehnika, e1t1StatTable=e1t1StatTable, ethRXUnsupOpcodes=ethRXUnsupOpcodes, atpcTxPowerCorrection=atpcTxPowerCorrection, radioSide=radioSide, modemSeverelyErroredSecond=modemSeverelyErroredSecond, vlanFid=vlanFid, e1t1StatEntry=e1t1StatEntry, ethRXLongEvents=ethRXLongEvents, ethGFPFCSErrors=ethGFPFCSErrors, ethRXDribleNibbles=ethRXDribleNibbles, modemGeneralStatus=modemGeneralStatus, modemUnavailtime=modemUnavailtime, ethTXCRCErrors=ethTXCRCErrors, localIpMask=localIpMask, ethTXPauseFrames=ethTXPauseFrames, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioTxMute=radioTxMute, radioTable=radioTable, licenseMask=licenseMask, radioDuplexShift=radioDuplexShift, ipRadioStat=ipRadioStat, radioGenStatus=radioGenStatus, radioRxLevel=radioRxLevel, ethTXByteCounterLow=ethTXByteCounterLow, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXCRCErrors=ethRXCRCErrors, ethTXGiants=ethTXGiants, modemRadialMSE=modemRadialMSE, e1t1LOS=e1t1LOS, ethRXDones=ethRXDones, modemUptime=modemUptime, radioEntry=radioEntry, ethTXBroadcasts=ethTXBroadcasts, vlanNumber=vlanNumber, ethTXMulticasts=ethTXMulticasts, atpcIndex=atpcIndex, remoteIp=remoteIp, vlansEnabled=vlansEnabled, modemStatistics=modemStatistics, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethQOSTXDropped=ethQOSTXDropped, safip=safip, sysTemperature=sysTemperature, modemErroredSecond=modemErroredSecond, modemErroredSecondRatio=modemErroredSecondRatio, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, license=license, localIp=localIp, ethGFPCHECErrors=ethGFPCHECErrors, microwaveRadio=microwaveRadio, vlanPortmap=vlanPortmap, ethRXControlFrames=ethRXControlFrames, ethTXLateCollisions=ethTXLateCollisions, hostname=hostname, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemE1T1Channels=modemE1T1Channels, modemSymbolRateRx=modemSymbolRateRx, vlanPortType=vlanPortType, ethTXControlFrames=ethTXControlFrames, licenseUpdateStatus=licenseUpdateStatus, modemLDPCdecoderStress=modemLDPCdecoderStress, modemTotalBlockNumber=modemTotalBlockNumber, radioTxFrequency=radioTxFrequency, e1t1ChannelNr=e1t1ChannelNr, modemEthernetCapacity=modemEthernetCapacity, modemTable=modemTable, aTPCTable=aTPCTable, ethTXBackpresEvents=ethTXBackpresEvents, saf=saf, radioRxFrequency=radioRxFrequency, ethQOSRXQ1Frames=ethQOSRXQ1Frames, atpcEnabled=atpcEnabled, ethRXPauseFrames=ethRXPauseFrames, ethRXTruncatedFrames=ethRXTruncatedFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, modemTotalCapacity=modemTotalCapacity, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemBandwith=modemBandwith, ethRXDvEvent=ethRXDvEvent, modemCountTime=modemCountTime, modemEntry=modemEntry, ethRXCodeErrors=ethRXCodeErrors, modemACMtotalCapacity=modemACMtotalCapacity)
