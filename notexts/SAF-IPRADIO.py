...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXPauseFrames=ethTXPauseFrames, modemSymbolRateRx=modemSymbolRateRx, modemACMmodulationMax=modemACMmodulationMax, product=product, modemEntry=modemEntry, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXByteCounterLow=ethTXByteCounterLow, radioIndex=radioIndex, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ipRadio=ipRadio, modemCountTime=modemCountTime, modemUptime=modemUptime, radioEntry=radioEntry, modemTotalCapacity=modemTotalCapacity, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXExcessiveDefers=ethTXExcessiveDefers, ethQOSRXQ2Frames=ethQOSRXQ2Frames, saf=saf, ethTXBackpresEvents=ethTXBackpresEvents, ethRXControlFrames=ethRXControlFrames, ethRXDvEvent=ethRXDvEvent, ethRXLongEvents=ethRXLongEvents, vlanFid=vlanFid, loopback_tributary_mask=loopback_tributary_mask, modemInternalAGCgain=modemInternalAGCgain, vlanRowStatus=vlanRowStatus, vlanEntry=vlanEntry, radioLoopback=radioLoopback, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXMaxCollisions=ethTXMaxCollisions, pointToPoint=pointToPoint, ethTXMulticasts=ethTXMulticasts, e1t1AIS=e1t1AIS, modemErroredBlock=modemErroredBlock, atpcTxPowerCorrection=atpcTxPowerCorrection, modemRowStatus=modemRowStatus, atpcEnabled=atpcEnabled, ethTXUnderruns=ethTXUnderruns, loopbacks=loopbacks, ethRXPrevPktDropped=ethRXPrevPktDropped, licenseMask=licenseMask, localIp=localIp, modemSeverelyErroredSecond=modemSeverelyErroredSecond, aTPCTable=aTPCTable, modemStatistics=modemStatistics, license=license, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemE1T1ChannelMask=modemE1T1ChannelMask, radioGenStatus=radioGenStatus, ethRXByteCounterHi=ethRXByteCounterHi, ipRadioStat=ipRadioStat, modemIndex=modemIndex, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXMulticasts=ethRXMulticasts, ethRXCRCErrors=ethRXCRCErrors, modemE1T1Channels=modemE1T1Channels, vlanCfgStat=vlanCfgStat, ethTXDones=ethTXDones, vlanPortType=vlanPortType, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXVlanTags=ethTXVlanTags, ethRXDribleNibbles=ethRXDribleNibbles, localIpMask=localIpMask, ethRXPauseFrames=ethRXPauseFrames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioRxFrequency=radioRxFrequency, ethRXBroadcasts=ethRXBroadcasts, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXByteCounterLow=ethRXByteCounterLow, modemLastAcqError=modemLastAcqError, vlanNumber=vlanNumber, radioTable=radioTable, aTPCEntry=aTPCEntry, radioTxFrequency=radioTxFrequency, sysDateAndTime=sysDateAndTime, modemEthernetCapacity=modemEthernetCapacity, ethGFPCHECErrors=ethGFPCHECErrors, e1t1StatTable=e1t1StatTable, licenseUpdateStatus=licenseUpdateStatus, ethRXDones=ethRXDones, modemStandard=modemStandard, description=description, ipRadioStatEth=ipRadioStatEth, ethRXCodeErrors=ethRXCodeErrors, modemRadialMSE=modemRadialMSE, vlanPortmap=vlanPortmap, ethTXByteCounterHi=ethTXByteCounterHi, modemAcqStatus=modemAcqStatus, ethTXCRCErrors=ethTXCRCErrors, ethGFPDelineationErrors=ethGFPDelineationErrors, radioTxPower=radioTxPower, modemErroredSecond=modemErroredSecond, radioDuplexShift=radioDuplexShift, modemErroredSecondRatio=modemErroredSecondRatio, modemBandwith=modemBandwith, ipRadioCfgGeneral=ipRadioCfgGeneral, atpcIndex=atpcIndex, writeConfig=writeConfig, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ipRadioCfg=ipRadioCfg, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror, safip=safip, ipRadioMgmt=ipRadioMgmt, modemACMethernetCapacity=modemACMethernetCapacity, ethTXGiants=ethTXGiants, modemTotalBlockNumber=modemTotalBlockNumber, modemTable=modemTable, sysTemperature=sysTemperature, ethRXTruncatedFrames=ethRXTruncatedFrames, vlansEnabled=vlansEnabled, ethQOSTXDropped=ethQOSTXDropped, modemSymbolRateTx=modemSymbolRateTx, modemModulation=modemModulation, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXLateCollisions=ethTXLateCollisions, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioSide=radioSide, ethTXControlFrames=ethTXControlFrames, hostname=hostname, ethGFPDropedFrames=ethGFPDropedFrames, ethQOSTXFrames=ethQOSTXFrames, e1t1LOS=e1t1LOS, modemACMengine=modemACMengine, ethGFPFCSErrors=ethGFPFCSErrors, restartcpu=restartcpu, modemACMtotalCapacity=modemACMtotalCapacity, modemUnavailtime=modemUnavailtime, remoteIp=remoteIp, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, e1t1ChannelNr=e1t1ChannelNr, e1t1StatEntry=e1t1StatEntry, ethTXCollisions=ethTXCollisions, modemGeneralStatus=modemGeneralStatus, modemACMmodulationMin=modemACMmodulationMin, radioTxMute=radioTxMute, microwaveRadio=microwaveRadio, tehnika=tehnika, vlanTable=vlanTable, ethTXBroadcasts=ethTXBroadcasts, radioRxLevel=radioRxLevel, modemCarrierOffset=modemCarrierOffset)
