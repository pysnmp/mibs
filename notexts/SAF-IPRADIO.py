...
mibBuilder.exportSymbols("SAF-IPRADIO", hostname=hostname, ethTXBroadcasts=ethTXBroadcasts, e1t1LOS=e1t1LOS, radioTxFrequency=radioTxFrequency, radioTxMute=radioTxMute, licenseMask=licenseMask, ipRadioCfg=ipRadioCfg, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioRxLevel=radioRxLevel, ethRXCodeErrors=ethRXCodeErrors, modemRadialMSE=modemRadialMSE, ethRXByteCounterLow=ethRXByteCounterLow, microwaveRadio=microwaveRadio, ipRadioStatEth=ipRadioStatEth, e1t1StatTable=e1t1StatTable, localIp=localIp, modemIndex=modemIndex, ethTXExcessiveDefers=ethTXExcessiveDefers, modemGeneralStatus=modemGeneralStatus, ethTXByteCounterLow=ethTXByteCounterLow, aTPCTable=aTPCTable, ethTXBackpresEvents=ethTXBackpresEvents, ipRadioCfgNetwork=ipRadioCfgNetwork, tehnika=tehnika, ethRXByteCounterHi=ethRXByteCounterHi, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, vlanEntry=vlanEntry, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemBandwith=modemBandwith, vlanCfgStat=vlanCfgStat, modemCountTime=modemCountTime, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemTotalBlockNumber=modemTotalBlockNumber, modemUptime=modemUptime, modemEthernetCapacity=modemEthernetCapacity, radioDuplexShift=radioDuplexShift, modemE1T1Channels=modemE1T1Channels, ethTXPauseFrames=ethTXPauseFrames, ethTXUnderruns=ethTXUnderruns, ethRXCRCErrors=ethRXCRCErrors, modemErroredSecondRatio=modemErroredSecondRatio, writeConfig=writeConfig, sysTemperature=sysTemperature, ethTXWireByteCounterLow=ethTXWireByteCounterLow, licenseUpdateStatus=licenseUpdateStatus, modemSymbolRateRx=modemSymbolRateRx, ethTXCRCErrors=ethTXCRCErrors, modemAcqStatus=modemAcqStatus, radioEntry=radioEntry, loopback_tributary_mask=loopback_tributary_mask, radioGenStatus=radioGenStatus, modemACMmodulationMax=modemACMmodulationMax, modemACMethernetCapacity=modemACMethernetCapacity, ethTXGiants=ethTXGiants, modemACMmodulationMin=modemACMmodulationMin, ethQOSTXFrames=ethQOSTXFrames, description=description, modemTable=modemTable, ethTXLateCollisions=ethTXLateCollisions, ipRadio=ipRadio, vlanTable=vlanTable, vlansEnabled=vlansEnabled, ethTXByteCounterHi=ethTXByteCounterHi, aTPCEntry=aTPCEntry, atpcTxPowerCorrection=atpcTxPowerCorrection, modemStatistics=modemStatistics, modemLDPCdecoderStress=modemLDPCdecoderStress, modemInternalAGCgain=modemInternalAGCgain, ethRXPauseFrames=ethRXPauseFrames, e1t1ChannelNr=e1t1ChannelNr, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXDones=ethTXDones, saf=saf, ethTXControlFrames=ethTXControlFrames, atpcEnabled=atpcEnabled, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemSymbolRateTx=modemSymbolRateTx, ethQOSTXDropped=ethQOSTXDropped, restartcpu=restartcpu, ethRXTruncatedFrames=ethRXTruncatedFrames, sysDateAndTime=sysDateAndTime, ethGFPDropedFrames=ethGFPDropedFrames, ethRXDones=ethRXDones, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, e1t1StatEntry=e1t1StatEntry, modemUnavailtime=modemUnavailtime, ethRXDribleNibbles=ethRXDribleNibbles, radioTable=radioTable, modemErroredBlock=modemErroredBlock, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, pointToPoint=pointToPoint, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemACMtotalCapacity=modemACMtotalCapacity, ethRXDvEvent=ethRXDvEvent, ipRadioStat=ipRadioStat, radioLoopback=radioLoopback, ethRXLongEvents=ethRXLongEvents, radioTxPower=radioTxPower, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXBroadcasts=ethRXBroadcasts, loopbacks=loopbacks, ethTXCollisions=ethTXCollisions, e1t1AIS=e1t1AIS, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXControlFrames=ethRXControlFrames, vlanPortmap=vlanPortmap, atpcIndex=atpcIndex, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemTotalCapacity=modemTotalCapacity, remoteIp=remoteIp, ethGFPCHECErrors=ethGFPCHECErrors, modemModulation=modemModulation, ethRXMulticasts=ethRXMulticasts, vlanFid=vlanFid, modemCarrierOffset=modemCarrierOffset, vlanNumber=vlanNumber, product=product, safip=safip, ethTXMaxCollisions=ethTXMaxCollisions, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXMulticasts=ethTXMulticasts, ethTXVlanTags=ethTXVlanTags, modemEntry=modemEntry, modemErroredSecond=modemErroredSecond, localIpMask=localIpMask, modemACMengine=modemACMengine, vlanPortType=vlanPortType, ethRXPrevPktDropped=ethRXPrevPktDropped, radioSide=radioSide, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioIndex=radioIndex, ipRadioCfgGeneral=ipRadioCfgGeneral, ethGFPFCSErrors=ethGFPFCSErrors, radioRxFrequency=radioRxFrequency, modemLastAcqError=modemLastAcqError, modemRowStatus=modemRowStatus, vlanRowStatus=vlanRowStatus, ipRadioMgmt=ipRadioMgmt, license=license, modemStandard=modemStandard, ethGFPDelineationErrors=ethGFPDelineationErrors)
