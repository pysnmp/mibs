...
mibBuilder.exportSymbols("SAF-IPRADIO", modemInternalAGCgain=modemInternalAGCgain, ethGFPDropedFrames=ethGFPDropedFrames, modemErroredSecondRatio=modemErroredSecondRatio, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, tehnika=tehnika, modemSeverelyErroredSecond=modemSeverelyErroredSecond, vlanPortType=vlanPortType, ethRXLongEvents=ethRXLongEvents, atpcTxPowerCorrection=atpcTxPowerCorrection, aTPCEntry=aTPCEntry, localIp=localIp, radioTable=radioTable, modemUptime=modemUptime, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXBroadcasts=ethTXBroadcasts, ipRadio=ipRadio, modemEthernetCapacity=modemEthernetCapacity, modemSymbolRateTx=modemSymbolRateTx, ipRadioCfgGeneral=ipRadioCfgGeneral, license=license, vlanNumber=vlanNumber, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXMaxCollisions=ethTXMaxCollisions, ethTXByteCounterHi=ethTXByteCounterHi, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, licenseMask=licenseMask, modemACMmodulationMax=modemACMmodulationMax, modemGeneralStatus=modemGeneralStatus, modemBandwith=modemBandwith, sysDateAndTime=sysDateAndTime, ethTXUnderruns=ethTXUnderruns, vlanTable=vlanTable, ethTXLengthCheckErrors=ethTXLengthCheckErrors, vlanPortmap=vlanPortmap, ethTXLateCollisions=ethTXLateCollisions, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, saf=saf, modemErroredSecond=modemErroredSecond, radioTxPower=radioTxPower, microwaveRadio=microwaveRadio, localIpMask=localIpMask, vlanEntry=vlanEntry, e1t1StatTable=e1t1StatTable, modemBackgroundBlockErrror=modemBackgroundBlockErrror, e1t1AIS=e1t1AIS, radioIndex=radioIndex, ethGFPCHECErrors=ethGFPCHECErrors, modemAcqStatus=modemAcqStatus, remoteIp=remoteIp, licenseUpdateStatus=licenseUpdateStatus, radioEntry=radioEntry, aTPCTable=aTPCTable, modemModulation=modemModulation, modemCarrierOffset=modemCarrierOffset, ethRXCRCErrors=ethRXCRCErrors, modemLastAcqError=modemLastAcqError, ethRXByteCounterHi=ethRXByteCounterHi, modemCountTime=modemCountTime, ethTXWireByteCounterHi=ethTXWireByteCounterHi, product=product, writeConfig=writeConfig, ethRXCodeErrors=ethRXCodeErrors, ethRXDribleNibbles=ethRXDribleNibbles, ipRadioMgmt=ipRadioMgmt, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXControlFrames=ethTXControlFrames, ethQOSTXFrames=ethQOSTXFrames, radioRxLevel=radioRxLevel, modemSymbolRateRx=modemSymbolRateRx, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, e1t1LOS=e1t1LOS, atpcEnabled=atpcEnabled, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethQOSTXDropped=ethQOSTXDropped, modemACMmodulationMin=modemACMmodulationMin, description=description, radioTxFrequency=radioTxFrequency, ethRXPauseFrames=ethRXPauseFrames, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemUnavailtime=modemUnavailtime, radioLoopback=radioLoopback, vlanRowStatus=vlanRowStatus, ipRadioStatEth=ipRadioStatEth, modemStatistics=modemStatistics, ethTXGiants=ethTXGiants, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioSide=radioSide, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ipRadioStat=ipRadioStat, restartcpu=restartcpu, modemTotalCapacity=modemTotalCapacity, radioDuplexShift=radioDuplexShift, ethTXCRCErrors=ethTXCRCErrors, safip=safip, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXBackpresEvents=ethTXBackpresEvents, modemIndex=modemIndex, loopbacks=loopbacks, ethRXByteCounterLow=ethRXByteCounterLow, modemTotalBlockNumber=modemTotalBlockNumber, modemEntry=modemEntry, radioGenStatus=radioGenStatus, ipRadioCfg=ipRadioCfg, e1t1ChannelNr=e1t1ChannelNr, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXExcessiveDefers=ethTXExcessiveDefers, modemE1T1ChannelMask=modemE1T1ChannelMask, ethGFPFCSErrors=ethGFPFCSErrors, modemACMtotalCapacity=modemACMtotalCapacity, vlanCfgStat=vlanCfgStat, hostname=hostname, ethRXBroadcasts=ethRXBroadcasts, ethRXMulticasts=ethRXMulticasts, modemE1T1Channels=modemE1T1Channels, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXPauseFrames=ethTXPauseFrames, pointToPoint=pointToPoint, ethTXMulticasts=ethTXMulticasts, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemRadialMSE=modemRadialMSE, modemLDPCdecoderStress=modemLDPCdecoderStress, modemTable=modemTable, ethRXControlFrames=ethRXControlFrames, ethTXDones=ethTXDones, sysTemperature=sysTemperature, vlansEnabled=vlansEnabled, ethTXVlanTags=ethTXVlanTags, radioRxFrequency=radioRxFrequency, modemACMengine=modemACMengine, atpcIndex=atpcIndex, ethTXCollisions=ethTXCollisions, modemErroredBlock=modemErroredBlock, radioTxMute=radioTxMute, modemACMethernetCapacity=modemACMethernetCapacity, modemStandard=modemStandard, modemRowStatus=modemRowStatus, ethRXDones=ethRXDones, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXDvEvent=ethRXDvEvent, vlanFid=vlanFid, e1t1StatEntry=e1t1StatEntry, ethTXByteCounterLow=ethTXByteCounterLow, loopback_tributary_mask=loopback_tributary_mask)
