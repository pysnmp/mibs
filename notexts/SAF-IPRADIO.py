...
mibBuilder.exportSymbols("SAF-IPRADIO", modemInternalAGCgain=modemInternalAGCgain, ethTXUnderruns=ethTXUnderruns, ethTXLateCollisions=ethTXLateCollisions, modemEthernetCapacity=modemEthernetCapacity, ethGFPFCSErrors=ethGFPFCSErrors, aTPCEntry=aTPCEntry, licenseUpdateStatus=licenseUpdateStatus, ipRadio=ipRadio, modemACMmodulationMax=modemACMmodulationMax, product=product, aTPCTable=aTPCTable, modemCarrierOffset=modemCarrierOffset, modemACMmodulationMin=modemACMmodulationMin, radioIndex=radioIndex, restartcpu=restartcpu, modemStatistics=modemStatistics, ipRadioCfgGeneral=ipRadioCfgGeneral, radioGenStatus=radioGenStatus, microwaveRadio=microwaveRadio, modemUptime=modemUptime, ethRXDvEvent=ethRXDvEvent, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemErroredSecondRatio=modemErroredSecondRatio, vlanNumber=vlanNumber, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethGFPCHECErrors=ethGFPCHECErrors, ethTXGiants=ethTXGiants, modemTotalBlockNumber=modemTotalBlockNumber, modemRowStatus=modemRowStatus, ethTXMulticasts=ethTXMulticasts, ethRXByteCounterHi=ethRXByteCounterHi, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXMulticasts=ethRXMulticasts, ethTXVlanTags=ethTXVlanTags, vlanFid=vlanFid, modemACMtotalCapacity=modemACMtotalCapacity, modemUnavailtime=modemUnavailtime, modemSymbolRateRx=modemSymbolRateRx, ethTXBroadcasts=ethTXBroadcasts, e1t1StatEntry=e1t1StatEntry, e1t1ChannelNr=e1t1ChannelNr, atpcTxPowerCorrection=atpcTxPowerCorrection, loopback_tributary_mask=loopback_tributary_mask, pointToPoint=pointToPoint, ethTXBackpresEvents=ethTXBackpresEvents, ethTXPauseFrames=ethTXPauseFrames, e1t1LOS=e1t1LOS, safip=safip, sysTemperature=sysTemperature, remoteIp=remoteIp, vlanTable=vlanTable, ethTXExcessiveDefers=ethTXExcessiveDefers, ethGFPDelineationErrors=ethGFPDelineationErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemStandard=modemStandard, vlanCfgStat=vlanCfgStat, ethTXCollisions=ethTXCollisions, modemLastAcqError=modemLastAcqError, modemE1T1Channels=modemE1T1Channels, ethRXTruncatedFrames=ethRXTruncatedFrames, localIpMask=localIpMask, ethRXDribleNibbles=ethRXDribleNibbles, vlanEntry=vlanEntry, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXControlFrames=ethTXControlFrames, ethRXCodeErrors=ethRXCodeErrors, modemLDPCdecoderStress=modemLDPCdecoderStress, ethQOSRXQ2Frames=ethQOSRXQ2Frames, atpcIndex=atpcIndex, ethTXCRCErrors=ethTXCRCErrors, radioEntry=radioEntry, radioDuplexShift=radioDuplexShift, modemIndex=modemIndex, ethRXPrevPktDropped=ethRXPrevPktDropped, writeConfig=writeConfig, modemSymbolRateTx=modemSymbolRateTx, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ipRadioCfg=ipRadioCfg, ethGFPDropedFrames=ethGFPDropedFrames, modemErroredSecond=modemErroredSecond, saf=saf, ethTXDones=ethTXDones, ethRXBroadcasts=ethRXBroadcasts, radioTxFrequency=radioTxFrequency, ipRadioStat=ipRadioStat, sysDateAndTime=sysDateAndTime, localIp=localIp, radioLoopback=radioLoopback, modemRadialMSE=modemRadialMSE, modemEntry=modemEntry, vlansEnabled=vlansEnabled, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, atpcEnabled=atpcEnabled, modemGeneralStatus=modemGeneralStatus, ethTXByteCounterHi=ethTXByteCounterHi, modemACMengine=modemACMengine, ethRXUnsupOpcodes=ethRXUnsupOpcodes, vlanPortmap=vlanPortmap, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, modemCountTime=modemCountTime, ethTXMaxCollisions=ethTXMaxCollisions, licenseMask=licenseMask, license=license, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemTotalCapacity=modemTotalCapacity, e1t1StatTable=e1t1StatTable, vlanPortType=vlanPortType, modemBandwith=modemBandwith, radioTxMute=radioTxMute, radioSide=radioSide, radioTable=radioTable, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXByteCounterLow=ethRXByteCounterLow, ethRXControlFrames=ethRXControlFrames, ethTXByteCounterLow=ethTXByteCounterLow, ethQOSTXDropped=ethQOSTXDropped, vlanRowStatus=vlanRowStatus, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ipRadioMgmt=ipRadioMgmt, modemSeverelyErroredSecond=modemSeverelyErroredSecond, radioTxPower=radioTxPower, radioRxFrequency=radioRxFrequency, modemACMethernetCapacity=modemACMethernetCapacity, ethRXDones=ethRXDones, e1t1AIS=e1t1AIS, radioRxLevel=radioRxLevel, tehnika=tehnika, ethRXPauseFrames=ethRXPauseFrames, loopbacks=loopbacks, modemTable=modemTable, description=description, modemModulation=modemModulation, ipRadioStatEth=ipRadioStatEth, ethRXLongEvents=ethRXLongEvents, modemE1T1ChannelMask=modemE1T1ChannelMask, ethQOSTXFrames=ethQOSTXFrames, modemErroredBlock=modemErroredBlock, modemAcqStatus=modemAcqStatus, ethRXCRCErrors=ethRXCRCErrors, hostname=hostname, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio)
