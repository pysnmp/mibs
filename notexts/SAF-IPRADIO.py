...
mibBuilder.exportSymbols("SAF-IPRADIO", safip=safip, modemIndex=modemIndex, modemRowStatus=modemRowStatus, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXByteCounterHi=ethTXByteCounterHi, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXLongEvents=ethRXLongEvents, vlanTable=vlanTable, modemEthernetCapacity=modemEthernetCapacity, ethTXGiants=ethTXGiants, vlanRowStatus=vlanRowStatus, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXBroadcasts=ethTXBroadcasts, vlanFid=vlanFid, description=description, ethTXLateCollisions=ethTXLateCollisions, vlanNumber=vlanNumber, radioDuplexShift=radioDuplexShift, ethTXControlFrames=ethTXControlFrames, tehnika=tehnika, ipRadioStat=ipRadioStat, radioGenStatus=radioGenStatus, modemCountTime=modemCountTime, ethRXCRCErrors=ethRXCRCErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, writeConfig=writeConfig, modemSymbolRateRx=modemSymbolRateRx, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemLDPCdecoderStress=modemLDPCdecoderStress, loopback_tributary_mask=loopback_tributary_mask, modemErroredSecond=modemErroredSecond, ethGFPFCSErrors=ethGFPFCSErrors, e1t1LOS=e1t1LOS, radioIndex=radioIndex, aTPCTable=aTPCTable, vlanCfgStat=vlanCfgStat, ipRadioCfgGeneral=ipRadioCfgGeneral, sysTemperature=sysTemperature, radioRxLevel=radioRxLevel, ethTXCRCErrors=ethTXCRCErrors, ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlanPortType=vlanPortType, restartcpu=restartcpu, e1t1AIS=e1t1AIS, ethRXMulticasts=ethRXMulticasts, e1t1StatEntry=e1t1StatEntry, atpcIndex=atpcIndex, radioLoopback=radioLoopback, atpcTxPowerCorrection=atpcTxPowerCorrection, ipRadioStatEth=ipRadioStatEth, ethTXBackpresEvents=ethTXBackpresEvents, modemErroredSecondRatio=modemErroredSecondRatio, localIpMask=localIpMask, loopbacks=loopbacks, modemTotalCapacity=modemTotalCapacity, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemEntry=modemEntry, modemE1T1Channels=modemE1T1Channels, ethQOSTXFrames=ethQOSTXFrames, modemACMengine=modemACMengine, ethRXCodeErrors=ethRXCodeErrors, e1t1ChannelNr=e1t1ChannelNr, modemUnavailtime=modemUnavailtime, ipRadioMgmt=ipRadioMgmt, ethRXDvEvent=ethRXDvEvent, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemTotalBlockNumber=modemTotalBlockNumber, ethTXPauseFrames=ethTXPauseFrames, ethTXUnderruns=ethTXUnderruns, ethTXMaxCollisions=ethTXMaxCollisions, remoteIp=remoteIp, microwaveRadio=microwaveRadio, ethTXByteCounterLow=ethTXByteCounterLow, ethGFPCHECErrors=ethGFPCHECErrors, modemACMtotalCapacity=modemACMtotalCapacity, modemSeverelyErroredSecond=modemSeverelyErroredSecond, e1t1StatTable=e1t1StatTable, atpcEnabled=atpcEnabled, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemModulation=modemModulation, radioRxFrequency=radioRxFrequency, licenseMask=licenseMask, aTPCEntry=aTPCEntry, ethRXPauseFrames=ethRXPauseFrames, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXControlFrames=ethRXControlFrames, radioEntry=radioEntry, modemSymbolRateTx=modemSymbolRateTx, ethTXCollisions=ethTXCollisions, modemACMmodulationMax=modemACMmodulationMax, ethTXMulticasts=ethTXMulticasts, modemACMmodulationMin=modemACMmodulationMin, ethRXBroadcasts=ethRXBroadcasts, modemUptime=modemUptime, ethRXTruncatedFrames=ethRXTruncatedFrames, vlansEnabled=vlansEnabled, ethRXUnsupOpcodes=ethRXUnsupOpcodes, saf=saf, licenseUpdateStatus=licenseUpdateStatus, modemTable=modemTable, modemInternalAGCgain=modemInternalAGCgain, ethRXByteCounterHi=ethRXByteCounterHi, ethQOSTXDropped=ethQOSTXDropped, modemStandard=modemStandard, license=license, ipRadioCfg=ipRadioCfg, ethGFPDropedFrames=ethGFPDropedFrames, localIp=localIp, radioTable=radioTable, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ipRadioCfgNetwork=ipRadioCfgNetwork, modemRadialMSE=modemRadialMSE, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemCarrierOffset=modemCarrierOffset, radioSide=radioSide, vlanPortmap=vlanPortmap, vlanEntry=vlanEntry, ethRXDribleNibbles=ethRXDribleNibbles, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemStatistics=modemStatistics, product=product, ethRXDones=ethRXDones, hostname=hostname, modemLastAcqError=modemLastAcqError, modemGeneralStatus=modemGeneralStatus, ipRadio=ipRadio, sysDateAndTime=sysDateAndTime, modemACMethernetCapacity=modemACMethernetCapacity, ethTXVlanTags=ethTXVlanTags, modemAcqStatus=modemAcqStatus, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXDones=ethTXDones, modemErroredBlock=modemErroredBlock, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemBackgroundBlockErrror=modemBackgroundBlockErrror, pointToPoint=pointToPoint, radioTxMute=radioTxMute, radioTxPower=radioTxPower, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXByteCounterLow=ethRXByteCounterLow, radioTxFrequency=radioTxFrequency, modemBandwith=modemBandwith)
