...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXVlanTags=ethTXVlanTags, ethRXMulticasts=ethRXMulticasts, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemEthernetCapacity=modemEthernetCapacity, restartcpu=restartcpu, modemRowStatus=modemRowStatus, vlanCfgStat=vlanCfgStat, modemE1T1ChannelMask=modemE1T1ChannelMask, modemACMtotalCapacity=modemACMtotalCapacity, vlanPortType=vlanPortType, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXDribleNibbles=ethRXDribleNibbles, ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlanRowStatus=vlanRowStatus, modemACMmodulationMin=modemACMmodulationMin, ethRXByteCounterHi=ethRXByteCounterHi, ethQOSTXFrames=ethQOSTXFrames, ethTXByteCounterLow=ethTXByteCounterLow, ethQOSTXDropped=ethQOSTXDropped, e1t1LOS=e1t1LOS, licenseUpdateStatus=licenseUpdateStatus, modemIndex=modemIndex, ipRadioMgmt=ipRadioMgmt, ethRXCRCErrors=ethRXCRCErrors, modemBandwith=modemBandwith, ethTXUnderruns=ethTXUnderruns, ethRXPauseFrames=ethRXPauseFrames, modemTotalBlockNumber=modemTotalBlockNumber, modemErroredBlock=modemErroredBlock, e1t1StatEntry=e1t1StatEntry, e1t1ChannelNr=e1t1ChannelNr, ethTXPauseFrames=ethTXPauseFrames, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioTable=radioTable, ethGFPFCSErrors=ethGFPFCSErrors, ethGFPCHECErrors=ethGFPCHECErrors, ethRXByteCounterLow=ethRXByteCounterLow, ipRadioStat=ipRadioStat, ethRXDones=ethRXDones, ethTXExcessiveDefers=ethTXExcessiveDefers, atpcIndex=atpcIndex, atpcTxPowerCorrection=atpcTxPowerCorrection, saf=saf, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioEntry=radioEntry, vlanTable=vlanTable, ethTXCRCErrors=ethTXCRCErrors, vlanPortmap=vlanPortmap, pointToPoint=pointToPoint, radioTxMute=radioTxMute, vlanFid=vlanFid, licenseMask=licenseMask, modemACMmodulationMax=modemACMmodulationMax, vlanEntry=vlanEntry, atpcEnabled=atpcEnabled, radioDuplexShift=radioDuplexShift, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ipRadioCfgNetwork=ipRadioCfgNetwork, loopbacks=loopbacks, radioTxFrequency=radioTxFrequency, radioIndex=radioIndex, modemSymbolRateTx=modemSymbolRateTx, modemStatistics=modemStatistics, ethGFPDelineationErrors=ethGFPDelineationErrors, modemAcqStatus=modemAcqStatus, ethTXBroadcasts=ethTXBroadcasts, tehnika=tehnika, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXByteCounterHi=ethTXByteCounterHi, modemErroredSecondRatio=modemErroredSecondRatio, ipRadioCfgGeneral=ipRadioCfgGeneral, writeConfig=writeConfig, modemSymbolRateRx=modemSymbolRateRx, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXMulticasts=ethTXMulticasts, radioTxPower=radioTxPower, ipRadioStatEth=ipRadioStatEth, radioSide=radioSide, ethRXCodeErrors=ethRXCodeErrors, radioRxLevel=radioRxLevel, modemTable=modemTable, remoteIp=remoteIp, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemUptime=modemUptime, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXLateCollisions=ethTXLateCollisions, microwaveRadio=microwaveRadio, radioLoopback=radioLoopback, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemEntry=modemEntry, modemE1T1Channels=modemE1T1Channels, radioGenStatus=radioGenStatus, modemStandard=modemStandard, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, aTPCTable=aTPCTable, aTPCEntry=aTPCEntry, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemErroredSecond=modemErroredSecond, e1t1AIS=e1t1AIS, vlanNumber=vlanNumber, modemTotalCapacity=modemTotalCapacity, sysDateAndTime=sysDateAndTime, vlansEnabled=vlansEnabled, modemInternalAGCgain=modemInternalAGCgain, product=product, description=description, sysTemperature=sysTemperature, localIpMask=localIpMask, modemModulation=modemModulation, ethTXControlFrames=ethTXControlFrames, ipRadio=ipRadio, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ipRadioCfg=ipRadioCfg, ethTXGiants=ethTXGiants, modemACMengine=modemACMengine, modemCarrierOffset=modemCarrierOffset, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXCollisions=ethTXCollisions, license=license, modemGeneralStatus=modemGeneralStatus, ethRXLongEvents=ethRXLongEvents, ethTXBackpresEvents=ethTXBackpresEvents, safip=safip, ethTXWireByteCounterLow=ethTXWireByteCounterLow, loopback_tributary_mask=loopback_tributary_mask, modemRadialMSE=modemRadialMSE, e1t1StatTable=e1t1StatTable, radioRxFrequency=radioRxFrequency, localIp=localIp, ethRXDvEvent=ethRXDvEvent, ethGFPDropedFrames=ethGFPDropedFrames, ethTXMaxCollisions=ethTXMaxCollisions, modemUnavailtime=modemUnavailtime, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemLastAcqError=modemLastAcqError, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXControlFrames=ethRXControlFrames, hostname=hostname, modemCountTime=modemCountTime, ethRXBroadcasts=ethRXBroadcasts, ethTXDones=ethTXDones, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemACMethernetCapacity=modemACMethernetCapacity)
