...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXVlanTagsDetected=ethRXVlanTagsDetected, vlanNumber=vlanNumber, ethTXCRCErrors=ethTXCRCErrors, ethGFPDropedFrames=ethGFPDropedFrames, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXDones=ethRXDones, ethTXUnderruns=ethTXUnderruns, modemErroredSecond=modemErroredSecond, ethTXMaxCollisions=ethTXMaxCollisions, modemLDPCdecoderStress=modemLDPCdecoderStress, sysDateAndTime=sysDateAndTime, vlanEntry=vlanEntry, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, e1t1AIS=e1t1AIS, ethGFPFCSErrors=ethGFPFCSErrors, loopback_tributary_mask=loopback_tributary_mask, ethGFPDelineationErrors=ethGFPDelineationErrors, modemE1T1ChannelMask=modemE1T1ChannelMask, pointToPoint=pointToPoint, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ipRadioCfg=ipRadioCfg, licenseUpdateStatus=licenseUpdateStatus, ethTXByteCounterHi=ethTXByteCounterHi, ethRXTruncatedFrames=ethRXTruncatedFrames, radioGenStatus=radioGenStatus, ipRadioMgmt=ipRadioMgmt, ipRadioStat=ipRadioStat, localIpMask=localIpMask, modemAcqStatus=modemAcqStatus, modemRowStatus=modemRowStatus, safip=safip, modemStatistics=modemStatistics, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemGeneralStatus=modemGeneralStatus, e1t1StatEntry=e1t1StatEntry, modemTotalCapacity=modemTotalCapacity, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXExcessiveDefers=ethTXExcessiveDefers, atpcEnabled=atpcEnabled, remoteIp=remoteIp, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXByteCounterHi=ethRXByteCounterHi, ethGFPCHECErrors=ethGFPCHECErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, e1t1StatTable=e1t1StatTable, saf=saf, aTPCTable=aTPCTable, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethQOSTXFrames=ethQOSTXFrames, license=license, modemLastAcqError=modemLastAcqError, modemUptime=modemUptime, modemUnavailtime=modemUnavailtime, description=description, writeConfig=writeConfig, vlanFid=vlanFid, product=product, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXControlFrames=ethTXControlFrames, localIp=localIp, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXDvEvent=ethRXDvEvent, ethTXVlanTags=ethTXVlanTags, e1t1ChannelNr=e1t1ChannelNr, modemInternalAGCgain=modemInternalAGCgain, ipRadioStatEth=ipRadioStatEth, modemACMtotalCapacity=modemACMtotalCapacity, modemACMethernetCapacity=modemACMethernetCapacity, ethTXDones=ethTXDones, ethRXCRCErrors=ethRXCRCErrors, licenseMask=licenseMask, vlansEnabled=vlansEnabled, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemACMmodulationMin=modemACMmodulationMin, sysTemperature=sysTemperature, loopbacks=loopbacks, radioLoopback=radioLoopback, modemTotalBlockNumber=modemTotalBlockNumber, ipRadio=ipRadio, modemSymbolRateRx=modemSymbolRateRx, modemRadialMSE=modemRadialMSE, e1t1LOS=e1t1LOS, modemEntry=modemEntry, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXBroadcasts=ethTXBroadcasts, ethQOSTXDropped=ethQOSTXDropped, modemSymbolRateTx=modemSymbolRateTx, tehnika=tehnika, radioTxPower=radioTxPower, ethTXGiants=ethTXGiants, modemErroredSecondRatio=modemErroredSecondRatio, vlanPortType=vlanPortType, radioRxFrequency=radioRxFrequency, ethRXLongEvents=ethRXLongEvents, modemACMmodulationMax=modemACMmodulationMax, ethTXByteCounterLow=ethTXByteCounterLow, vlanPortmap=vlanPortmap, ethRXDribleNibbles=ethRXDribleNibbles, aTPCEntry=aTPCEntry, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXPauseFrames=ethTXPauseFrames, modemTable=modemTable, vlanTable=vlanTable, modemStandard=modemStandard, radioDuplexShift=radioDuplexShift, modemE1T1Channels=modemE1T1Channels, ethRXByteCounterLow=ethRXByteCounterLow, ethRXControlFrames=ethRXControlFrames, modemBandwith=modemBandwith, radioSide=radioSide, modemSeverelyErroredSecond=modemSeverelyErroredSecond, vlanRowStatus=vlanRowStatus, modemACMengine=modemACMengine, radioIndex=radioIndex, ethRXMulticasts=ethRXMulticasts, modemErroredBlock=modemErroredBlock, modemIndex=modemIndex, ethTXLateCollisions=ethTXLateCollisions, ipRadioCfgNetwork=ipRadioCfgNetwork, restartcpu=restartcpu, hostname=hostname, ethQOSRXQ1Frames=ethQOSRXQ1Frames, vlanCfgStat=vlanCfgStat, radioTxFrequency=radioTxFrequency, radioEntry=radioEntry, ethRXCodeErrors=ethRXCodeErrors, ethTXBackpresEvents=ethTXBackpresEvents, ipRadioCfgGeneral=ipRadioCfgGeneral, atpcIndex=atpcIndex, radioTxMute=radioTxMute, radioRxLevel=radioRxLevel, modemModulation=modemModulation, modemEthernetCapacity=modemEthernetCapacity, microwaveRadio=microwaveRadio, ethRXBroadcasts=ethRXBroadcasts, radioTable=radioTable, ethTXCollisions=ethTXCollisions, modemCountTime=modemCountTime, modemCarrierOffset=modemCarrierOffset, ethRXPauseFrames=ethRXPauseFrames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXMulticasts=ethTXMulticasts)
