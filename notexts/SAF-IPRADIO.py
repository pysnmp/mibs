...
mibBuilder.exportSymbols("SAF-IPRADIO", description=description, radioEntry=radioEntry, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, writeConfig=writeConfig, ethRXLongEvents=ethRXLongEvents, radioRxFrequency=radioRxFrequency, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXBroadcasts=ethRXBroadcasts, ethTXGiants=ethTXGiants, ethQOSTXDropped=ethQOSTXDropped, radioSide=radioSide, e1t1StatTable=e1t1StatTable, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, safip=safip, ethRXDones=ethRXDones, ethRXDribleNibbles=ethRXDribleNibbles, ethRXPauseFrames=ethRXPauseFrames, vlanFid=vlanFid, modemIndex=modemIndex, aTPCEntry=aTPCEntry, vlanEntry=vlanEntry, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemACMethernetCapacity=modemACMethernetCapacity, modemRowStatus=modemRowStatus, ipRadioStat=ipRadioStat, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, sysDateAndTime=sysDateAndTime, modemSymbolRateTx=modemSymbolRateTx, ethRXByteCounterHi=ethRXByteCounterHi, ethTXExcessiveDefers=ethTXExcessiveDefers, modemTable=modemTable, modemGeneralStatus=modemGeneralStatus, radioLoopback=radioLoopback, ethTXWireByteCounterLow=ethTXWireByteCounterLow, e1t1StatEntry=e1t1StatEntry, sysTemperature=sysTemperature, ipRadioMgmt=ipRadioMgmt, ethTXMulticasts=ethTXMulticasts, ethGFPDelineationErrors=ethGFPDelineationErrors, modemUnavailtime=modemUnavailtime, e1t1AIS=e1t1AIS, modemRadialMSE=modemRadialMSE, ipRadioCfgGeneral=ipRadioCfgGeneral, modemUptime=modemUptime, vlansEnabled=vlansEnabled, radioTxMute=radioTxMute, modemCarrierOffset=modemCarrierOffset, ethGFPDropedFrames=ethGFPDropedFrames, modemE1T1Channels=modemE1T1Channels, localIpMask=localIpMask, modemCountTime=modemCountTime, ethQOSTXFrames=ethQOSTXFrames, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, localIp=localIp, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemACMtotalCapacity=modemACMtotalCapacity, license=license, modemACMmodulationMax=modemACMmodulationMax, radioTxPower=radioTxPower, radioGenStatus=radioGenStatus, vlanPortmap=vlanPortmap, vlanNumber=vlanNumber, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ipRadio=ipRadio, ethGFPFCSErrors=ethGFPFCSErrors, modemEthernetCapacity=modemEthernetCapacity, atpcIndex=atpcIndex, ethRXCRCErrors=ethRXCRCErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXUnderruns=ethTXUnderruns, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXControlFrames=ethTXControlFrames, ipRadioStatEth=ipRadioStatEth, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXBroadcasts=ethTXBroadcasts, aTPCTable=aTPCTable, modemModulation=modemModulation, atpcEnabled=atpcEnabled, ipRadioCfgNetwork=ipRadioCfgNetwork, licenseMask=licenseMask, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXDones=ethTXDones, ethTXBackpresEvents=ethTXBackpresEvents, ethGFPCHECErrors=ethGFPCHECErrors, modemStandard=modemStandard, tehnika=tehnika, ethTXPauseFrames=ethTXPauseFrames, vlanRowStatus=vlanRowStatus, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, hostname=hostname, modemEntry=modemEntry, modemTotalBlockNumber=modemTotalBlockNumber, modemErroredSecond=modemErroredSecond, ipRadioCfg=ipRadioCfg, vlanTable=vlanTable, pointToPoint=pointToPoint, radioIndex=radioIndex, radioRxLevel=radioRxLevel, ethTXByteCounterLow=ethTXByteCounterLow, ethTXLateCollisions=ethTXLateCollisions, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXCRCErrors=ethTXCRCErrors, ethRXByteCounterLow=ethRXByteCounterLow, modemErroredSecondRatio=modemErroredSecondRatio, modemTotalCapacity=modemTotalCapacity, ethRXDvEvent=ethRXDvEvent, loopback_tributary_mask=loopback_tributary_mask, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemInternalAGCgain=modemInternalAGCgain, saf=saf, radioTable=radioTable, modemLastAcqError=modemLastAcqError, radioTxFrequency=radioTxFrequency, ethTXVlanTags=ethTXVlanTags, modemAcqStatus=modemAcqStatus, vlanCfgStat=vlanCfgStat, e1t1LOS=e1t1LOS, licenseUpdateStatus=licenseUpdateStatus, product=product, ethTXMaxCollisions=ethTXMaxCollisions, e1t1ChannelNr=e1t1ChannelNr, ethTXByteCounterHi=ethTXByteCounterHi, modemACMmodulationMin=modemACMmodulationMin, loopbacks=loopbacks, modemErroredBlock=modemErroredBlock, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemBandwith=modemBandwith, ethTXCollisions=ethTXCollisions, ethRXVlanTagsDetected=ethRXVlanTagsDetected, vlanPortType=vlanPortType, modemSymbolRateRx=modemSymbolRateRx, ethRXCodeErrors=ethRXCodeErrors, modemACMengine=modemACMengine, microwaveRadio=microwaveRadio, ethRXMulticasts=ethRXMulticasts, radioDuplexShift=radioDuplexShift, modemSeverelyErroredSecond=modemSeverelyErroredSecond, remoteIp=remoteIp, ethRXControlFrames=ethRXControlFrames, modemStatistics=modemStatistics, restartcpu=restartcpu)
