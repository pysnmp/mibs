...
mibBuilder.exportSymbols("SAF-IPRADIO", tehnika=tehnika, e1t1StatEntry=e1t1StatEntry, modemACMengine=modemACMengine, ethTXPauseFrames=ethTXPauseFrames, modemSymbolRateTx=modemSymbolRateTx, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioTxFrequency=radioTxFrequency, ethTXMaxCollisions=ethTXMaxCollisions, radioTxMute=radioTxMute, ethRXCodeErrors=ethRXCodeErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemACMtotalCapacity=modemACMtotalCapacity, modemE1T1ChannelMask=modemE1T1ChannelMask, license=license, modemLDPCdecoderStress=modemLDPCdecoderStress, ethQOSTXDropped=ethQOSTXDropped, ipRadioStat=ipRadioStat, modemInternalAGCgain=modemInternalAGCgain, ethTXByteCounterHi=ethTXByteCounterHi, radioRxLevel=radioRxLevel, modemCarrierOffset=modemCarrierOffset, ethTXControlFrames=ethTXControlFrames, ipRadioMgmt=ipRadioMgmt, modemBandwith=modemBandwith, ethQOSTXFrames=ethQOSTXFrames, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemRadialMSE=modemRadialMSE, ethRXControlFrames=ethRXControlFrames, radioDuplexShift=radioDuplexShift, ethTXVlanTags=ethTXVlanTags, modemACMethernetCapacity=modemACMethernetCapacity, sysTemperature=sysTemperature, ethTXLateCollisions=ethTXLateCollisions, modemSymbolRateRx=modemSymbolRateRx, writeConfig=writeConfig, ethRXBroadcasts=ethRXBroadcasts, ipRadioStatEth=ipRadioStatEth, ethRXDribleNibbles=ethRXDribleNibbles, sysDateAndTime=sysDateAndTime, modemErroredSecond=modemErroredSecond, vlanFid=vlanFid, modemE1T1Channels=modemE1T1Channels, ethRXByteCounterHi=ethRXByteCounterHi, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemCountTime=modemCountTime, vlanPortmap=vlanPortmap, product=product, radioTable=radioTable, e1t1StatTable=e1t1StatTable, ethTXBroadcasts=ethTXBroadcasts, ipRadio=ipRadio, modemTotalBlockNumber=modemTotalBlockNumber, vlanNumber=vlanNumber, safip=safip, radioSide=radioSide, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXByteCounterLow=ethTXByteCounterLow, aTPCTable=aTPCTable, vlanEntry=vlanEntry, ethRXPrevPktDropped=ethRXPrevPktDropped, modemTotalCapacity=modemTotalCapacity, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, vlanCfgStat=vlanCfgStat, modemACMmodulationMax=modemACMmodulationMax, localIp=localIp, ipRadioCfgNetwork=ipRadioCfgNetwork, aTPCEntry=aTPCEntry, radioRxFrequency=radioRxFrequency, modemStandard=modemStandard, vlanPortType=vlanPortType, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXMulticasts=ethRXMulticasts, pointToPoint=pointToPoint, hostname=hostname, modemACMmodulationMin=modemACMmodulationMin, radioEntry=radioEntry, ethGFPDelineationErrors=ethGFPDelineationErrors, modemEntry=modemEntry, modemErroredBlock=modemErroredBlock, modemEthernetCapacity=modemEthernetCapacity, ethRXVlanTagsDetected=ethRXVlanTagsDetected, atpcIndex=atpcIndex, modemGeneralStatus=modemGeneralStatus, vlansEnabled=vlansEnabled, radioLoopback=radioLoopback, ethTXBackpresEvents=ethTXBackpresEvents, ethRXByteCounterLow=ethRXByteCounterLow, modemUptime=modemUptime, localIpMask=localIpMask, ethRXPauseFrames=ethRXPauseFrames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, e1t1AIS=e1t1AIS, e1t1ChannelNr=e1t1ChannelNr, ethTXCRCErrors=ethTXCRCErrors, modemLastAcqError=modemLastAcqError, ethTXDones=ethTXDones, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, saf=saf, modemErroredSecondRatio=modemErroredSecondRatio, loopbacks=loopbacks, ethGFPDropedFrames=ethGFPDropedFrames, modemAcqStatus=modemAcqStatus, modemUnavailtime=modemUnavailtime, vlanRowStatus=vlanRowStatus, ethGFPFCSErrors=ethGFPFCSErrors, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioGenStatus=radioGenStatus, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemModulation=modemModulation, ethRXLongEvents=ethRXLongEvents, modemIndex=modemIndex, ethTXUnderruns=ethTXUnderruns, vlanTable=vlanTable, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, description=description, modemRowStatus=modemRowStatus, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, loopback_tributary_mask=loopback_tributary_mask, atpcEnabled=atpcEnabled, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ipRadioCfgGeneral=ipRadioCfgGeneral, e1t1LOS=e1t1LOS, ethTXGiants=ethTXGiants, ethRXTruncatedFrames=ethRXTruncatedFrames, atpcTxPowerCorrection=atpcTxPowerCorrection, modemBackgroundBlockErrror=modemBackgroundBlockErrror, restartcpu=restartcpu, ethTXLengthCheckErrors=ethTXLengthCheckErrors, licenseMask=licenseMask, ethRXDones=ethRXDones, ethGFPCHECErrors=ethGFPCHECErrors, ethRXDvEvent=ethRXDvEvent, ethTXMulticasts=ethTXMulticasts, radioIndex=radioIndex, modemStatistics=modemStatistics, ipRadioCfg=ipRadioCfg, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXCollisions=ethTXCollisions, licenseUpdateStatus=licenseUpdateStatus, modemTable=modemTable, microwaveRadio=microwaveRadio, radioTxPower=radioTxPower, ethRXCRCErrors=ethRXCRCErrors, remoteIp=remoteIp)
