...
mibBuilder.exportSymbols("SAF-IPRADIO", description=description, localIpMask=localIpMask, writeConfig=writeConfig, modemCountTime=modemCountTime, ethRXControlFrames=ethRXControlFrames, modemE1T1ChannelMask=modemE1T1ChannelMask, microwaveRadio=microwaveRadio, e1t1StatEntry=e1t1StatEntry, vlansEnabled=vlansEnabled, modemBandwith=modemBandwith, ethGFPDropedFrames=ethGFPDropedFrames, restartcpu=restartcpu, radioDuplexShift=radioDuplexShift, vlanNumber=vlanNumber, ethQOSTXFrames=ethQOSTXFrames, modemSymbolRateRx=modemSymbolRateRx, ipRadioMgmt=ipRadioMgmt, vlanPortType=vlanPortType, radioTxMute=radioTxMute, e1t1AIS=e1t1AIS, radioTable=radioTable, ethTXByteCounterHi=ethTXByteCounterHi, licenseMask=licenseMask, vlanPortmap=vlanPortmap, vlanTable=vlanTable, vlanFid=vlanFid, modemTotalCapacity=modemTotalCapacity, ethRXPauseFrames=ethRXPauseFrames, aTPCTable=aTPCTable, ethTXBackpresEvents=ethTXBackpresEvents, ethRXLongEvents=ethRXLongEvents, ethGFPDelineationErrors=ethGFPDelineationErrors, pointToPoint=pointToPoint, hostname=hostname, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXMaxCollisions=ethTXMaxCollisions, licenseUpdateStatus=licenseUpdateStatus, ethTXVlanTags=ethTXVlanTags, atpcTxPowerCorrection=atpcTxPowerCorrection, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXCodeErrors=ethRXCodeErrors, product=product, remoteIp=remoteIp, loopbacks=loopbacks, modemRowStatus=modemRowStatus, modemTable=modemTable, ethRXByteCounterHi=ethRXByteCounterHi, modemACMengine=modemACMengine, modemEntry=modemEntry, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXVlanTagsDetected=ethRXVlanTagsDetected, sysTemperature=sysTemperature, ethTXLateCollisions=ethTXLateCollisions, modemUnavailtime=modemUnavailtime, modemLDPCdecoderStress=modemLDPCdecoderStress, modemModulation=modemModulation, modemLastAcqError=modemLastAcqError, modemGeneralStatus=modemGeneralStatus, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemACMmodulationMax=modemACMmodulationMax, ethRXByteCounterLow=ethRXByteCounterLow, modemErroredSecondRatio=modemErroredSecondRatio, radioLoopback=radioLoopback, ethTXCollisions=ethTXCollisions, ethQOSTXDropped=ethQOSTXDropped, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemStatistics=modemStatistics, ethTXByteCounterLow=ethTXByteCounterLow, ipRadioCfgNetwork=ipRadioCfgNetwork, radioRxFrequency=radioRxFrequency, modemSymbolRateTx=modemSymbolRateTx, ethGFPCHECErrors=ethGFPCHECErrors, modemACMmodulationMin=modemACMmodulationMin, ethRXDribleNibbles=ethRXDribleNibbles, ethTXUnderruns=ethTXUnderruns, modemErroredSecond=modemErroredSecond, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, e1t1LOS=e1t1LOS, ipRadioStat=ipRadioStat, ethTXPauseFrames=ethTXPauseFrames, e1t1ChannelNr=e1t1ChannelNr, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXTruncatedFrames=ethRXTruncatedFrames, aTPCEntry=aTPCEntry, e1t1StatTable=e1t1StatTable, ethTXDones=ethTXDones, radioTxPower=radioTxPower, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioTxFrequency=radioTxFrequency, ethTXControlFrames=ethTXControlFrames, ethTXMulticasts=ethTXMulticasts, modemACMtotalCapacity=modemACMtotalCapacity, atpcEnabled=atpcEnabled, radioGenStatus=radioGenStatus, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXDones=ethRXDones, saf=saf, ethTXGiants=ethTXGiants, radioRxLevel=radioRxLevel, tehnika=tehnika, ethQOSRXQ2Frames=ethQOSRXQ2Frames, license=license, modemInternalAGCgain=modemInternalAGCgain, modemUptime=modemUptime, ethTXBroadcasts=ethTXBroadcasts, ipRadio=ipRadio, vlanCfgStat=vlanCfgStat, loopback_tributary_mask=loopback_tributary_mask, radioSide=radioSide, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethGFPFCSErrors=ethGFPFCSErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXCRCErrors=ethRXCRCErrors, radioEntry=radioEntry, modemAcqStatus=modemAcqStatus, vlanRowStatus=vlanRowStatus, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemE1T1Channels=modemE1T1Channels, sysDateAndTime=sysDateAndTime, atpcIndex=atpcIndex, vlanEntry=vlanEntry, modemRadialMSE=modemRadialMSE, ipRadioCfg=ipRadioCfg, radioIndex=radioIndex, ethRXBroadcasts=ethRXBroadcasts, safip=safip, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemErroredBlock=modemErroredBlock, ethTXCRCErrors=ethTXCRCErrors, modemCarrierOffset=modemCarrierOffset, modemACMethernetCapacity=modemACMethernetCapacity, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXDvEvent=ethRXDvEvent, localIp=localIp, modemTotalBlockNumber=modemTotalBlockNumber, ethRXMulticasts=ethRXMulticasts, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemEthernetCapacity=modemEthernetCapacity, modemStandard=modemStandard, ipRadioStatEth=ipRadioStatEth, modemIndex=modemIndex, ethRXUnsupOpcodes=ethRXUnsupOpcodes)
