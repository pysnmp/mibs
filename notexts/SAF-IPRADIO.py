...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXExcessiveDefers=ethTXExcessiveDefers, modemACMethernetCapacity=modemACMethernetCapacity, ethRXCRCErrors=ethRXCRCErrors, e1t1LOS=e1t1LOS, localIpMask=localIpMask, modemSymbolRateRx=modemSymbolRateRx, modemErroredBlock=modemErroredBlock, modemTotalCapacity=modemTotalCapacity, ethTXMaxCollisions=ethTXMaxCollisions, ethQOSRXQ2Frames=ethQOSRXQ2Frames, licenseMask=licenseMask, modemACMengine=modemACMengine, ethRXDvEvent=ethRXDvEvent, ethRXDones=ethRXDones, remoteIp=remoteIp, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemErroredSecondRatio=modemErroredSecondRatio, atpcEnabled=atpcEnabled, vlanRowStatus=vlanRowStatus, ipRadio=ipRadio, ethRXMulticasts=ethRXMulticasts, ethTXBackpresEvents=ethTXBackpresEvents, modemErroredSecond=modemErroredSecond, tehnika=tehnika, modemACMtotalCapacity=modemACMtotalCapacity, modemInternalAGCgain=modemInternalAGCgain, sysTemperature=sysTemperature, ethRXCodeErrors=ethRXCodeErrors, radioRxFrequency=radioRxFrequency, ethQOSTXDropped=ethQOSTXDropped, ethTXControlFrames=ethTXControlFrames, ethTXGiants=ethTXGiants, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemCountTime=modemCountTime, licenseUpdateStatus=licenseUpdateStatus, ethGFPCHECErrors=ethGFPCHECErrors, product=product, modemSymbolRateTx=modemSymbolRateTx, vlanPortType=vlanPortType, vlanNumber=vlanNumber, ethRXLongEvents=ethRXLongEvents, radioTxMute=radioTxMute, modemRowStatus=modemRowStatus, ethTXByteCounterLow=ethTXByteCounterLow, ethGFPDelineationErrors=ethGFPDelineationErrors, modemRadialMSE=modemRadialMSE, radioTable=radioTable, modemE1T1ChannelMask=modemE1T1ChannelMask, vlanCfgStat=vlanCfgStat, loopback_tributary_mask=loopback_tributary_mask, ethTXCollisions=ethTXCollisions, ethRXByteCounterHi=ethRXByteCounterHi, restartcpu=restartcpu, modemUnavailtime=modemUnavailtime, modemStatistics=modemStatistics, ethRXControlFrames=ethRXControlFrames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXDones=ethTXDones, ethRXBroadcasts=ethRXBroadcasts, sysDateAndTime=sysDateAndTime, atpcIndex=atpcIndex, ethTXBroadcasts=ethTXBroadcasts, radioGenStatus=radioGenStatus, pointToPoint=pointToPoint, localIp=localIp, modemGeneralStatus=modemGeneralStatus, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemLastAcqError=modemLastAcqError, radioTxFrequency=radioTxFrequency, vlanFid=vlanFid, modemEthernetCapacity=modemEthernetCapacity, aTPCTable=aTPCTable, radioRxLevel=radioRxLevel, modemAcqStatus=modemAcqStatus, ethQOSTXFrames=ethQOSTXFrames, license=license, ethTXMulticasts=ethTXMulticasts, hostname=hostname, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXUnsupOpcodes=ethRXUnsupOpcodes, e1t1StatTable=e1t1StatTable, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXUnderruns=ethTXUnderruns, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXVlanTags=ethTXVlanTags, modemBandwith=modemBandwith, modemModulation=modemModulation, vlanEntry=vlanEntry, radioLoopback=radioLoopback, vlanTable=vlanTable, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXByteCounterHi=ethTXByteCounterHi, ethRXDribleNibbles=ethRXDribleNibbles, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ipRadioStat=ipRadioStat, writeConfig=writeConfig, modemCarrierOffset=modemCarrierOffset, ethTXPauseFrames=ethTXPauseFrames, ethRXByteCounterLow=ethRXByteCounterLow, modemIndex=modemIndex, ipRadioCfg=ipRadioCfg, ethGFPFCSErrors=ethGFPFCSErrors, description=description, modemStandard=modemStandard, atpcTxPowerCorrection=atpcTxPowerCorrection, ipRadioStatEth=ipRadioStatEth, saf=saf, modemACMmodulationMax=modemACMmodulationMax, vlansEnabled=vlansEnabled, modemACMmodulationMin=modemACMmodulationMin, e1t1ChannelNr=e1t1ChannelNr, modemTable=modemTable, ethRXPauseFrames=ethRXPauseFrames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemTotalBlockNumber=modemTotalBlockNumber, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemE1T1Channels=modemE1T1Channels, ethGFPDropedFrames=ethGFPDropedFrames, loopbacks=loopbacks, safip=safip, aTPCEntry=aTPCEntry, ethTXLengthCheckErrors=ethTXLengthCheckErrors, radioIndex=radioIndex, ethTXCRCErrors=ethTXCRCErrors, microwaveRadio=microwaveRadio, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ipRadioCfgNetwork=ipRadioCfgNetwork, modemUptime=modemUptime, ipRadioMgmt=ipRadioMgmt, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, e1t1AIS=e1t1AIS, vlanPortmap=vlanPortmap, ethQOSRXQ1Frames=ethQOSRXQ1Frames, e1t1StatEntry=e1t1StatEntry, ethTXLateCollisions=ethTXLateCollisions, radioEntry=radioEntry, radioDuplexShift=radioDuplexShift, ethRXTruncatedFrames=ethRXTruncatedFrames, radioTxPower=radioTxPower, radioSide=radioSide, modemLDPCdecoderStress=modemLDPCdecoderStress, modemEntry=modemEntry, ipRadioCfgGeneral=ipRadioCfgGeneral)
