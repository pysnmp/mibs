...
mibBuilder.exportSymbols("SAF-IPRADIO", ipRadioCfgGeneral=ipRadioCfgGeneral, atpcTxPowerCorrection=atpcTxPowerCorrection, vlanTable=vlanTable, ethRXDvEvent=ethRXDvEvent, e1t1ChannelNr=e1t1ChannelNr, ethTXByteCounterLow=ethTXByteCounterLow, ethTXVlanTags=ethTXVlanTags, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXControlFrames=ethRXControlFrames, modemUnavailtime=modemUnavailtime, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXPrevPktDropped=ethRXPrevPktDropped, radioEntry=radioEntry, modemTotalCapacity=modemTotalCapacity, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemEntry=modemEntry, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, e1t1LOS=e1t1LOS, ethQOSTXDropped=ethQOSTXDropped, description=description, atpcEnabled=atpcEnabled, ethTXMaxCollisions=ethTXMaxCollisions, modemACMmodulationMin=modemACMmodulationMin, ethGFPFCSErrors=ethGFPFCSErrors, modemStandard=modemStandard, modemErroredSecond=modemErroredSecond, radioLoopback=radioLoopback, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethGFPCHECErrors=ethGFPCHECErrors, ethTXMulticasts=ethTXMulticasts, ethRXByteCounterHi=ethRXByteCounterHi, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXPauseFrames=ethRXPauseFrames, loopback_tributary_mask=loopback_tributary_mask, ipRadioMgmt=ipRadioMgmt, modemErroredBlock=modemErroredBlock, radioDuplexShift=radioDuplexShift, modemEthernetCapacity=modemEthernetCapacity, vlanEntry=vlanEntry, modemACMengine=modemACMengine, modemACMtotalCapacity=modemACMtotalCapacity, radioTxFrequency=radioTxFrequency, modemSymbolRateTx=modemSymbolRateTx, ethGFPDropedFrames=ethGFPDropedFrames, vlanPortmap=vlanPortmap, pointToPoint=pointToPoint, vlansEnabled=vlansEnabled, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXBackpresEvents=ethTXBackpresEvents, radioTxMute=radioTxMute, modemRadialMSE=modemRadialMSE, license=license, licenseMask=licenseMask, ipRadioCfg=ipRadioCfg, product=product, modemCarrierOffset=modemCarrierOffset, modemRowStatus=modemRowStatus, ethQOSRXQ1Frames=ethQOSRXQ1Frames, remoteIp=remoteIp, sysTemperature=sysTemperature, radioRxFrequency=radioRxFrequency, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXCollisions=ethTXCollisions, loopbacks=loopbacks, modemIndex=modemIndex, ipRadio=ipRadio, radioTable=radioTable, ethRXBroadcasts=ethRXBroadcasts, vlanCfgStat=vlanCfgStat, ethTXLateCollisions=ethTXLateCollisions, ethTXBroadcasts=ethTXBroadcasts, modemE1T1ChannelMask=modemE1T1ChannelMask, modemUptime=modemUptime, radioRxLevel=radioRxLevel, ethTXExcessiveDefers=ethTXExcessiveDefers, microwaveRadio=microwaveRadio, ethQOSTXFrames=ethQOSTXFrames, atpcIndex=atpcIndex, modemLastAcqError=modemLastAcqError, ethTXGiants=ethTXGiants, radioGenStatus=radioGenStatus, radioSide=radioSide, licenseUpdateStatus=licenseUpdateStatus, ethRXDribleNibbles=ethRXDribleNibbles, modemACMethernetCapacity=modemACMethernetCapacity, radioTxPower=radioTxPower, hostname=hostname, writeConfig=writeConfig, localIpMask=localIpMask, ethRXDones=ethRXDones, saf=saf, modemACMmodulationMax=modemACMmodulationMax, aTPCEntry=aTPCEntry, ethRXLongEvents=ethRXLongEvents, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXByteCounterHi=ethTXByteCounterHi, ethRXMulticasts=ethRXMulticasts, ethTXUnderruns=ethTXUnderruns, tehnika=tehnika, radioIndex=radioIndex, aTPCTable=aTPCTable, ethTXDones=ethTXDones, vlanRowStatus=vlanRowStatus, modemStatistics=modemStatistics, ipRadioStat=ipRadioStat, modemTable=modemTable, sysDateAndTime=sysDateAndTime, modemModulation=modemModulation, localIp=localIp, ipRadioCfgNetwork=ipRadioCfgNetwork, modemSymbolRateRx=modemSymbolRateRx, vlanPortType=vlanPortType, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemBandwith=modemBandwith, ethRXCRCErrors=ethRXCRCErrors, ethRXByteCounterLow=ethRXByteCounterLow, modemTotalBlockNumber=modemTotalBlockNumber, ethRXCodeErrors=ethRXCodeErrors, modemLDPCdecoderStress=modemLDPCdecoderStress, modemAcqStatus=modemAcqStatus, ethTXPauseFrames=ethTXPauseFrames, modemCountTime=modemCountTime, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemErroredSecondRatio=modemErroredSecondRatio, ipRadioStatEth=ipRadioStatEth, modemE1T1Channels=modemE1T1Channels, e1t1StatTable=e1t1StatTable, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, e1t1StatEntry=e1t1StatEntry, ethGFPDelineationErrors=ethGFPDelineationErrors, modemInternalAGCgain=modemInternalAGCgain, vlanNumber=vlanNumber, vlanFid=vlanFid, e1t1AIS=e1t1AIS, ethTXControlFrames=ethTXControlFrames, ethTXCRCErrors=ethTXCRCErrors, safip=safip, restartcpu=restartcpu, modemGeneralStatus=modemGeneralStatus, ethTXWireByteCounterLow=ethTXWireByteCounterLow)
