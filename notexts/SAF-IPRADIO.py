...
mibBuilder.exportSymbols("SAF-IPRADIO", writeConfig=writeConfig, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXExcessiveDefers=ethTXExcessiveDefers, hostname=hostname, vlansEnabled=vlansEnabled, ipRadio=ipRadio, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemErroredSecond=modemErroredSecond, modemEthernetCapacity=modemEthernetCapacity, modemGeneralStatus=modemGeneralStatus, modemErroredBlock=modemErroredBlock, ethGFPCHECErrors=ethGFPCHECErrors, modemIndex=modemIndex, ethTXByteCounterHi=ethTXByteCounterHi, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemModulation=modemModulation, ethRXDones=ethRXDones, licenseUpdateStatus=licenseUpdateStatus, ethRXLongEvents=ethRXLongEvents, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemAcqStatus=modemAcqStatus, ethTXCollisions=ethTXCollisions, ethRXDvEvent=ethRXDvEvent, radioRxLevel=radioRxLevel, vlanPortType=vlanPortType, product=product, pointToPoint=pointToPoint, loopback_tributary_mask=loopback_tributary_mask, modemSymbolRateTx=modemSymbolRateTx, e1t1AIS=e1t1AIS, modemE1T1ChannelMask=modemE1T1ChannelMask, ipRadioStat=ipRadioStat, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXCRCErrors=ethRXCRCErrors, ethTXDones=ethTXDones, ethRXByteCounterLow=ethRXByteCounterLow, modemRadialMSE=modemRadialMSE, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, loopbacks=loopbacks, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemUnavailtime=modemUnavailtime, sysTemperature=sysTemperature, remoteIp=remoteIp, modemACMmodulationMin=modemACMmodulationMin, modemBandwith=modemBandwith, radioTable=radioTable, ethTXControlFrames=ethTXControlFrames, e1t1ChannelNr=e1t1ChannelNr, vlanTable=vlanTable, modemCarrierOffset=modemCarrierOffset, ethTXLengthCheckErrors=ethTXLengthCheckErrors, e1t1StatEntry=e1t1StatEntry, ethRXPauseFrames=ethRXPauseFrames, ethQOSTXDropped=ethQOSTXDropped, ethRXControlFrames=ethRXControlFrames, localIp=localIp, radioIndex=radioIndex, ethTXBackpresEvents=ethTXBackpresEvents, modemRowStatus=modemRowStatus, radioTxMute=radioTxMute, modemLastAcqError=modemLastAcqError, modemTable=modemTable, ethRXPrevPktDropped=ethRXPrevPktDropped, localIpMask=localIpMask, modemCountTime=modemCountTime, modemE1T1Channels=modemE1T1Channels, radioTxPower=radioTxPower, saf=saf, modemTotalCapacity=modemTotalCapacity, vlanCfgStat=vlanCfgStat, modemACMmodulationMax=modemACMmodulationMax, ethGFPDelineationErrors=ethGFPDelineationErrors, vlanEntry=vlanEntry, ethTXVlanTags=ethTXVlanTags, ethQOSTXFrames=ethQOSTXFrames, safip=safip, vlanFid=vlanFid, modemErroredSecondRatio=modemErroredSecondRatio, ipRadioStatEth=ipRadioStatEth, atpcEnabled=atpcEnabled, radioGenStatus=radioGenStatus, ipRadioCfgGeneral=ipRadioCfgGeneral, aTPCTable=aTPCTable, ethTXCRCErrors=ethTXCRCErrors, radioRxFrequency=radioRxFrequency, modemEntry=modemEntry, microwaveRadio=microwaveRadio, ipRadioCfgNetwork=ipRadioCfgNetwork, modemInternalAGCgain=modemInternalAGCgain, licenseMask=licenseMask, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ipRadioMgmt=ipRadioMgmt, modemStandard=modemStandard, radioDuplexShift=radioDuplexShift, vlanRowStatus=vlanRowStatus, modemACMtotalCapacity=modemACMtotalCapacity, ethTXMulticasts=ethTXMulticasts, description=description, modemTotalBlockNumber=modemTotalBlockNumber, radioTxFrequency=radioTxFrequency, e1t1LOS=e1t1LOS, ipRadioCfg=ipRadioCfg, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXByteCounterLow=ethTXByteCounterLow, ethRXVlanTagsDetected=ethRXVlanTagsDetected, atpcIndex=atpcIndex, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXPauseFrames=ethTXPauseFrames, radioSide=radioSide, vlanNumber=vlanNumber, modemSymbolRateRx=modemSymbolRateRx, ethRXMulticasts=ethRXMulticasts, ethQOSRXQ1Frames=ethQOSRXQ1Frames, sysDateAndTime=sysDateAndTime, atpcTxPowerCorrection=atpcTxPowerCorrection, modemACMengine=modemACMengine, ethTXGiants=ethTXGiants, aTPCEntry=aTPCEntry, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, tehnika=tehnika, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXDribleNibbles=ethRXDribleNibbles, ethRXTruncatedFrames=ethRXTruncatedFrames, radioEntry=radioEntry, ethRXBroadcasts=ethRXBroadcasts, e1t1StatTable=e1t1StatTable, ethTXUnderruns=ethTXUnderruns, radioLoopback=radioLoopback, ethRXCodeErrors=ethRXCodeErrors, ethTXBroadcasts=ethTXBroadcasts, modemUptime=modemUptime, modemStatistics=modemStatistics, restartcpu=restartcpu, ethTXMaxCollisions=ethTXMaxCollisions, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXLateCollisions=ethTXLateCollisions, ethGFPFCSErrors=ethGFPFCSErrors, license=license, ethGFPDropedFrames=ethGFPDropedFrames, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemACMethernetCapacity=modemACMethernetCapacity, vlanPortmap=vlanPortmap, ethRXByteCounterHi=ethRXByteCounterHi)
