...
mibBuilder.exportSymbols("SAF-IPRADIO", licenseUpdateStatus=licenseUpdateStatus, ipRadioStatEth=ipRadioStatEth, modemErroredSecondRatio=modemErroredSecondRatio, microwaveRadio=microwaveRadio, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXUnderruns=ethTXUnderruns, modemRadialMSE=modemRadialMSE, modemErroredBlock=modemErroredBlock, ethTXVlanTags=ethTXVlanTags, vlansEnabled=vlansEnabled, radioLoopback=radioLoopback, atpcIndex=atpcIndex, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethGFPDelineationErrors=ethGFPDelineationErrors, modemUptime=modemUptime, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlanEntry=vlanEntry, modemGeneralStatus=modemGeneralStatus, ethTXBackpresEvents=ethTXBackpresEvents, ipRadioCfgNetwork=ipRadioCfgNetwork, licenseMask=licenseMask, radioTxMute=radioTxMute, radioTxFrequency=radioTxFrequency, ethQOSRXQ1Frames=ethQOSRXQ1Frames, saf=saf, atpcTxPowerCorrection=atpcTxPowerCorrection, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, tehnika=tehnika, ipRadioCfg=ipRadioCfg, modemACMmodulationMax=modemACMmodulationMax, modemEntry=modemEntry, modemSymbolRateRx=modemSymbolRateRx, modemIndex=modemIndex, loopbacks=loopbacks, vlanCfgStat=vlanCfgStat, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXPauseFrames=ethRXPauseFrames, modemAcqStatus=modemAcqStatus, ethRXDones=ethRXDones, ethTXByteCounterHi=ethTXByteCounterHi, modemTotalBlockNumber=modemTotalBlockNumber, radioRxLevel=radioRxLevel, localIp=localIp, modemCarrierOffset=modemCarrierOffset, ipRadioMgmt=ipRadioMgmt, ethGFPDropedFrames=ethGFPDropedFrames, restartcpu=restartcpu, e1t1AIS=e1t1AIS, radioGenStatus=radioGenStatus, modemE1T1Channels=modemE1T1Channels, modemLastAcqError=modemLastAcqError, e1t1ChannelNr=e1t1ChannelNr, modemStatistics=modemStatistics, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemErroredSecond=modemErroredSecond, ethTXWireByteCounterHi=ethTXWireByteCounterHi, remoteIp=remoteIp, ethTXCollisions=ethTXCollisions, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioDuplexShift=radioDuplexShift, vlanPortType=vlanPortType, modemBandwith=modemBandwith, writeConfig=writeConfig, vlanPortmap=vlanPortmap, aTPCTable=aTPCTable, radioTxPower=radioTxPower, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethQOSTXDropped=ethQOSTXDropped, ethRXControlFrames=ethRXControlFrames, pointToPoint=pointToPoint, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, radioTable=radioTable, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXBroadcasts=ethRXBroadcasts, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemACMengine=modemACMengine, ethTXGiants=ethTXGiants, ethTXLateCollisions=ethTXLateCollisions, ethTXDones=ethTXDones, e1t1StatTable=e1t1StatTable, modemACMmodulationMin=modemACMmodulationMin, sysDateAndTime=sysDateAndTime, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXByteCounterHi=ethRXByteCounterHi, ethRXDvEvent=ethRXDvEvent, modemInternalAGCgain=modemInternalAGCgain, e1t1StatEntry=e1t1StatEntry, modemTable=modemTable, loopback_tributary_mask=loopback_tributary_mask, radioIndex=radioIndex, radioEntry=radioEntry, ethTXCRCErrors=ethTXCRCErrors, localIpMask=localIpMask, ethRXCRCErrors=ethRXCRCErrors, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethGFPCHECErrors=ethGFPCHECErrors, ipRadioStat=ipRadioStat, product=product, modemModulation=modemModulation, atpcEnabled=atpcEnabled, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXLongEvents=ethRXLongEvents, radioSide=radioSide, ipRadio=ipRadio, ethRXByteCounterLow=ethRXByteCounterLow, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXMulticasts=ethTXMulticasts, ethQOSTXFrames=ethQOSTXFrames, ethRXPrevPktDropped=ethRXPrevPktDropped, modemEthernetCapacity=modemEthernetCapacity, vlanFid=vlanFid, modemE1T1ChannelMask=modemE1T1ChannelMask, modemSymbolRateTx=modemSymbolRateTx, radioRxFrequency=radioRxFrequency, sysTemperature=sysTemperature, ethGFPFCSErrors=ethGFPFCSErrors, modemStandard=modemStandard, modemACMethernetCapacity=modemACMethernetCapacity, ethRXDribleNibbles=ethRXDribleNibbles, ethTXPauseFrames=ethTXPauseFrames, modemUnavailtime=modemUnavailtime, vlanNumber=vlanNumber, ethRXUnsupOpcodes=ethRXUnsupOpcodes, aTPCEntry=aTPCEntry, ethRXMulticasts=ethRXMulticasts, modemRowStatus=modemRowStatus, ethTXBroadcasts=ethTXBroadcasts, ethTXByteCounterLow=ethTXByteCounterLow, ethTXMaxCollisions=ethTXMaxCollisions, license=license, ethRXCodeErrors=ethRXCodeErrors, vlanTable=vlanTable, ethTXControlFrames=ethTXControlFrames, modemCountTime=modemCountTime, e1t1LOS=e1t1LOS, modemTotalCapacity=modemTotalCapacity, modemACMtotalCapacity=modemACMtotalCapacity, description=description, safip=safip, vlanRowStatus=vlanRowStatus, hostname=hostname, ethTXExcessiveDefers=ethTXExcessiveDefers)
