...
mibBuilder.exportSymbols("SAF-IPRADIO", product=product, ethRXLongEvents=ethRXLongEvents, ethRXDribleNibbles=ethRXDribleNibbles, ethTXExcessiveDefers=ethTXExcessiveDefers, modemUnavailtime=modemUnavailtime, pointToPoint=pointToPoint, description=description, localIp=localIp, modemErroredBlock=modemErroredBlock, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemSymbolRateRx=modemSymbolRateRx, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioRxLevel=radioRxLevel, modemCarrierOffset=modemCarrierOffset, vlansEnabled=vlansEnabled, localIpMask=localIpMask, ethRXDones=ethRXDones, modemInternalAGCgain=modemInternalAGCgain, ethRXMulticasts=ethRXMulticasts, vlanPortType=vlanPortType, radioTable=radioTable, modemEthernetCapacity=modemEthernetCapacity, ethRXByteCounterLow=ethRXByteCounterLow, e1t1StatEntry=e1t1StatEntry, modemEntry=modemEntry, ethTXBackpresEvents=ethTXBackpresEvents, ethGFPFCSErrors=ethGFPFCSErrors, radioDuplexShift=radioDuplexShift, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ipRadioCfg=ipRadioCfg, vlanCfgStat=vlanCfgStat, radioTxPower=radioTxPower, atpcEnabled=atpcEnabled, hostname=hostname, licenseUpdateStatus=licenseUpdateStatus, ethTXUnderruns=ethTXUnderruns, radioGenStatus=radioGenStatus, modemRowStatus=modemRowStatus, ethQOSTXDropped=ethQOSTXDropped, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethGFPCHECErrors=ethGFPCHECErrors, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXControlFrames=ethRXControlFrames, loopbacks=loopbacks, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlanTable=vlanTable, radioSide=radioSide, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ipRadioMgmt=ipRadioMgmt, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethQOSTXFrames=ethQOSTXFrames, modemACMmodulationMax=modemACMmodulationMax, modemSeverelyErroredSecond=modemSeverelyErroredSecond, writeConfig=writeConfig, ethTXLateCollisions=ethTXLateCollisions, sysDateAndTime=sysDateAndTime, modemModulation=modemModulation, modemAcqStatus=modemAcqStatus, ethTXGiants=ethTXGiants, vlanFid=vlanFid, e1t1LOS=e1t1LOS, modemIndex=modemIndex, ethTXCRCErrors=ethTXCRCErrors, ethTXVlanTags=ethTXVlanTags, atpcIndex=atpcIndex, remoteIp=remoteIp, license=license, e1t1ChannelNr=e1t1ChannelNr, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemGeneralStatus=modemGeneralStatus, ethRXCRCErrors=ethRXCRCErrors, safip=safip, ethTXControlFrames=ethTXControlFrames, microwaveRadio=microwaveRadio, modemTotalCapacity=modemTotalCapacity, ethTXMaxCollisions=ethTXMaxCollisions, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemACMengine=modemACMengine, ethRXTruncatedFrames=ethRXTruncatedFrames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemErroredSecond=modemErroredSecond, ethRXPrevPktDropped=ethRXPrevPktDropped, saf=saf, ethRXDvEvent=ethRXDvEvent, modemErroredSecondRatio=modemErroredSecondRatio, tehnika=tehnika, radioTxFrequency=radioTxFrequency, ethTXByteCounterLow=ethTXByteCounterLow, ethRXBroadcasts=ethRXBroadcasts, modemACMethernetCapacity=modemACMethernetCapacity, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemCountTime=modemCountTime, modemUptime=modemUptime, restartcpu=restartcpu, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ipRadioCfgGeneral=ipRadioCfgGeneral, radioIndex=radioIndex, modemACMtotalCapacity=modemACMtotalCapacity, ipRadioStat=ipRadioStat, modemStandard=modemStandard, vlanNumber=vlanNumber, ethRXByteCounterHi=ethRXByteCounterHi, e1t1AIS=e1t1AIS, ethTXMulticasts=ethTXMulticasts, modemSymbolRateTx=modemSymbolRateTx, modemLastAcqError=modemLastAcqError, radioTxMute=radioTxMute, sysTemperature=sysTemperature, modemE1T1ChannelMask=modemE1T1ChannelMask, ipRadio=ipRadio, ethRXPauseFrames=ethRXPauseFrames, modemTotalBlockNumber=modemTotalBlockNumber, vlanEntry=vlanEntry, aTPCTable=aTPCTable, ethRXCodeErrors=ethRXCodeErrors, licenseMask=licenseMask, radioRxFrequency=radioRxFrequency, loopback_tributary_mask=loopback_tributary_mask, aTPCEntry=aTPCEntry, modemE1T1Channels=modemE1T1Channels, ethGFPDropedFrames=ethGFPDropedFrames, ipRadioStatEth=ipRadioStatEth, ethTXDones=ethTXDones, ethTXByteCounterHi=ethTXByteCounterHi, ethTXBroadcasts=ethTXBroadcasts, modemTable=modemTable, vlanPortmap=vlanPortmap, ethTXWireByteCounterHi=ethTXWireByteCounterHi, e1t1StatTable=e1t1StatTable, ethTXCollisions=ethTXCollisions, radioEntry=radioEntry, ethTXPauseFrames=ethTXPauseFrames, radioLoopback=radioLoopback, vlanRowStatus=vlanRowStatus, modemStatistics=modemStatistics, modemRadialMSE=modemRadialMSE, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemACMmodulationMin=modemACMmodulationMin, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemBandwith=modemBandwith, ethGFPDelineationErrors=ethGFPDelineationErrors)
