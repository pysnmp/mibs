...
mibBuilder.exportSymbols("SAF-IPRADIO", license=license, vlanNumber=vlanNumber, ethTXByteCounterLow=ethTXByteCounterLow, modemTotalCapacity=modemTotalCapacity, atpcEnabled=atpcEnabled, ethTXWireByteCounterHi=ethTXWireByteCounterHi, localIp=localIp, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXBroadcasts=ethRXBroadcasts, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXCollisions=ethTXCollisions, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXVlanTags=ethTXVlanTags, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioRxLevel=radioRxLevel, ethRXMulticasts=ethRXMulticasts, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioLoopback=radioLoopback, pointToPoint=pointToPoint, modemCarrierOffset=modemCarrierOffset, radioTable=radioTable, vlanPortmap=vlanPortmap, modemACMengine=modemACMengine, ethTXMulticasts=ethTXMulticasts, modemTotalBlockNumber=modemTotalBlockNumber, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXUnderruns=ethTXUnderruns, licenseUpdateStatus=licenseUpdateStatus, ipRadioMgmt=ipRadioMgmt, ethGFPCHECErrors=ethGFPCHECErrors, microwaveRadio=microwaveRadio, modemACMmodulationMax=modemACMmodulationMax, ethTXCRCErrors=ethTXCRCErrors, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXTruncatedFrames=ethRXTruncatedFrames, vlansEnabled=vlansEnabled, ethRXCodeErrors=ethRXCodeErrors, modemCountTime=modemCountTime, e1t1ChannelNr=e1t1ChannelNr, radioEntry=radioEntry, ethTXLengthCheckErrors=ethTXLengthCheckErrors, saf=saf, ethRXByteCounterLow=ethRXByteCounterLow, ethTXWireByteCounterLow=ethTXWireByteCounterLow, vlanCfgStat=vlanCfgStat, vlanEntry=vlanEntry, e1t1LOS=e1t1LOS, modemUnavailtime=modemUnavailtime, ipRadioCfg=ipRadioCfg, vlanPortType=vlanPortType, restartcpu=restartcpu, modemStatistics=modemStatistics, radioDuplexShift=radioDuplexShift, ethTXBackpresEvents=ethTXBackpresEvents, modemErroredSecond=modemErroredSecond, vlanTable=vlanTable, radioGenStatus=radioGenStatus, radioTxFrequency=radioTxFrequency, modemRadialMSE=modemRadialMSE, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXBroadcasts=ethTXBroadcasts, ipRadioStatEth=ipRadioStatEth, description=description, e1t1StatTable=e1t1StatTable, vlanFid=vlanFid, atpcIndex=atpcIndex, modemBandwith=modemBandwith, modemTable=modemTable, radioSide=radioSide, ethRXPauseFrames=ethRXPauseFrames, localIpMask=localIpMask, ethTXControlFrames=ethTXControlFrames, loopbacks=loopbacks, ethTXPauseFrames=ethTXPauseFrames, hostname=hostname, modemSymbolRateRx=modemSymbolRateRx, ethTXGiants=ethTXGiants, ethRXDribleNibbles=ethRXDribleNibbles, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemAcqStatus=modemAcqStatus, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethGFPFCSErrors=ethGFPFCSErrors, modemACMmodulationMin=modemACMmodulationMin, ethRXLongEvents=ethRXLongEvents, modemErroredBlock=modemErroredBlock, ipRadioStat=ipRadioStat, ethRXDvEvent=ethRXDvEvent, ethTXLateCollisions=ethTXLateCollisions, e1t1AIS=e1t1AIS, modemACMtotalCapacity=modemACMtotalCapacity, modemEthernetCapacity=modemEthernetCapacity, sysDateAndTime=sysDateAndTime, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXExcessiveDefers=ethTXExcessiveDefers, radioIndex=radioIndex, ipRadioCfgGeneral=ipRadioCfgGeneral, safip=safip, ethRXControlFrames=ethRXControlFrames, radioTxPower=radioTxPower, ethRXCRCErrors=ethRXCRCErrors, ethQOSTXFrames=ethQOSTXFrames, sysTemperature=sysTemperature, ethRXDones=ethRXDones, modemRowStatus=modemRowStatus, modemInternalAGCgain=modemInternalAGCgain, ethQOSTXDropped=ethQOSTXDropped, atpcTxPowerCorrection=atpcTxPowerCorrection, ipRadioCfgNetwork=ipRadioCfgNetwork, aTPCTable=aTPCTable, modemACMethernetCapacity=modemACMethernetCapacity, radioTxMute=radioTxMute, ethTXMaxCollisions=ethTXMaxCollisions, remoteIp=remoteIp, modemStandard=modemStandard, loopback_tributary_mask=loopback_tributary_mask, modemIndex=modemIndex, modemE1T1Channels=modemE1T1Channels, ethQOSRXQ2Frames=ethQOSRXQ2Frames, writeConfig=writeConfig, radioRxFrequency=radioRxFrequency, licenseMask=licenseMask, ethRXByteCounterHi=ethRXByteCounterHi, ethGFPDropedFrames=ethGFPDropedFrames, e1t1StatEntry=e1t1StatEntry, ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadio=ipRadio, modemModulation=modemModulation, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemLastAcqError=modemLastAcqError, tehnika=tehnika, aTPCEntry=aTPCEntry, ethTXDones=ethTXDones, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemErroredSecondRatio=modemErroredSecondRatio, modemGeneralStatus=modemGeneralStatus, modemEntry=modemEntry, ethTXByteCounterHi=ethTXByteCounterHi, modemUptime=modemUptime, vlanRowStatus=vlanRowStatus, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemSymbolRateTx=modemSymbolRateTx, product=product)
