...
mibBuilder.exportSymbols("SAF-IPRADIO", ethGFPDropedFrames=ethGFPDropedFrames, ethRXByteCounterHi=ethRXByteCounterHi, modemUptime=modemUptime, modemRowStatus=modemRowStatus, e1t1LOS=e1t1LOS, modemErroredSecondRatio=modemErroredSecondRatio, modemEthernetCapacity=modemEthernetCapacity, ethTXGiants=ethTXGiants, description=description, localIp=localIp, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXByteCounterLow=ethTXByteCounterLow, saf=saf, modemLDPCdecoderStress=modemLDPCdecoderStress, modemACMengine=modemACMengine, aTPCTable=aTPCTable, ethTXMaxCollisions=ethTXMaxCollisions, e1t1StatEntry=e1t1StatEntry, ethGFPFCSErrors=ethGFPFCSErrors, license=license, radioTxPower=radioTxPower, ethRXDvEvent=ethRXDvEvent, radioIndex=radioIndex, loopback_tributary_mask=loopback_tributary_mask, modemStatistics=modemStatistics, e1t1ChannelNr=e1t1ChannelNr, modemTotalBlockNumber=modemTotalBlockNumber, radioRxLevel=radioRxLevel, modemSymbolRateTx=modemSymbolRateTx, modemAcqStatus=modemAcqStatus, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXControlFrames=ethTXControlFrames, writeConfig=writeConfig, modemLastAcqError=modemLastAcqError, modemSymbolRateRx=modemSymbolRateRx, ethRXTruncatedFrames=ethRXTruncatedFrames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemBandwith=modemBandwith, sysTemperature=sysTemperature, radioDuplexShift=radioDuplexShift, licenseMask=licenseMask, modemGeneralStatus=modemGeneralStatus, radioTable=radioTable, ipRadioStatEth=ipRadioStatEth, microwaveRadio=microwaveRadio, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemACMmodulationMax=modemACMmodulationMax, radioSide=radioSide, loopbacks=loopbacks, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXLateCollisions=ethTXLateCollisions, remoteIp=remoteIp, licenseUpdateStatus=licenseUpdateStatus, ethTXPauseFrames=ethTXPauseFrames, modemTotalCapacity=modemTotalCapacity, radioTxFrequency=radioTxFrequency, modemACMethernetCapacity=modemACMethernetCapacity, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, e1t1AIS=e1t1AIS, atpcIndex=atpcIndex, vlanNumber=vlanNumber, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioRxFrequency=radioRxFrequency, ethRXDribleNibbles=ethRXDribleNibbles, vlanPortType=vlanPortType, ethRXControlFrames=ethRXControlFrames, modemE1T1Channels=modemE1T1Channels, radioEntry=radioEntry, tehnika=tehnika, hostname=hostname, ethTXCollisions=ethTXCollisions, ipRadioMgmt=ipRadioMgmt, modemStandard=modemStandard, modemRadialMSE=modemRadialMSE, ethRXBroadcasts=ethRXBroadcasts, pointToPoint=pointToPoint, ethRXCRCErrors=ethRXCRCErrors, vlansEnabled=vlansEnabled, ethTXBroadcasts=ethTXBroadcasts, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemErroredSecond=modemErroredSecond, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemUnavailtime=modemUnavailtime, ethTXByteCounterHi=ethTXByteCounterHi, atpcEnabled=atpcEnabled, ethQOSTXDropped=ethQOSTXDropped, modemErroredBlock=modemErroredBlock, radioGenStatus=radioGenStatus, vlanFid=vlanFid, modemModulation=modemModulation, modemIndex=modemIndex, ethTXBackpresEvents=ethTXBackpresEvents, sysDateAndTime=sysDateAndTime, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXMulticasts=ethTXMulticasts, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethGFPCHECErrors=ethGFPCHECErrors, ipRadioStat=ipRadioStat, vlanCfgStat=vlanCfgStat, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ipRadioCfg=ipRadioCfg, ipRadio=ipRadio, modemCarrierOffset=modemCarrierOffset, vlanTable=vlanTable, ethRXDones=ethRXDones, modemTable=modemTable, ethTXExcessiveDefers=ethTXExcessiveDefers, vlanPortmap=vlanPortmap, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXVlanTags=ethTXVlanTags, ethTXUnderruns=ethTXUnderruns, restartcpu=restartcpu, aTPCEntry=aTPCEntry, modemEntry=modemEntry, modemInternalAGCgain=modemInternalAGCgain, ethQOSTXFrames=ethQOSTXFrames, localIpMask=localIpMask, vlanRowStatus=vlanRowStatus, modemCountTime=modemCountTime, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, safip=safip, ethTXCRCErrors=ethTXCRCErrors, product=product, ethRXByteCounterLow=ethRXByteCounterLow, vlanEntry=vlanEntry, atpcTxPowerCorrection=atpcTxPowerCorrection, radioTxMute=radioTxMute, ethRXCodeErrors=ethRXCodeErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXPauseFrames=ethRXPauseFrames, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemACMmodulationMin=modemACMmodulationMin, ethRXMulticasts=ethRXMulticasts, modemACMtotalCapacity=modemACMtotalCapacity, ethRXLongEvents=ethRXLongEvents, e1t1StatTable=e1t1StatTable, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXDones=ethTXDones, radioLoopback=radioLoopback)
