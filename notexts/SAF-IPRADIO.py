...
mibBuilder.exportSymbols("SAF-IPRADIO", modemGeneralStatus=modemGeneralStatus, ethGFPDelineationErrors=ethGFPDelineationErrors, radioTxPower=radioTxPower, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ipRadioStatEth=ipRadioStatEth, modemErroredBlock=modemErroredBlock, modemACMmodulationMax=modemACMmodulationMax, ipRadioCfgNetwork=ipRadioCfgNetwork, vlanFid=vlanFid, atpcIndex=atpcIndex, vlanPortmap=vlanPortmap, vlansEnabled=vlansEnabled, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXPauseFrames=ethRXPauseFrames, vlanCfgStat=vlanCfgStat, modemUptime=modemUptime, hostname=hostname, ipRadioStat=ipRadioStat, modemIndex=modemIndex, tehnika=tehnika, modemLDPCdecoderStress=modemLDPCdecoderStress, localIpMask=localIpMask, radioEntry=radioEntry, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemStandard=modemStandard, vlanRowStatus=vlanRowStatus, ethTXBackpresEvents=ethTXBackpresEvents, ethTXLateCollisions=ethTXLateCollisions, ipRadioCfgGeneral=ipRadioCfgGeneral, radioIndex=radioIndex, license=license, vlanPortType=vlanPortType, vlanEntry=vlanEntry, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemErroredSecond=modemErroredSecond, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemEntry=modemEntry, ethTXByteCounterLow=ethTXByteCounterLow, vlanNumber=vlanNumber, loopback_tributary_mask=loopback_tributary_mask, saf=saf, sysDateAndTime=sysDateAndTime, ethRXControlFrames=ethRXControlFrames, ethQOSTXFrames=ethQOSTXFrames, modemTotalCapacity=modemTotalCapacity, radioRxFrequency=radioRxFrequency, ethRXDones=ethRXDones, modemUnavailtime=modemUnavailtime, aTPCTable=aTPCTable, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemRadialMSE=modemRadialMSE, microwaveRadio=microwaveRadio, radioTxMute=radioTxMute, loopbacks=loopbacks, description=description, modemRowStatus=modemRowStatus, ethTXPauseFrames=ethTXPauseFrames, radioSide=radioSide, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemACMmodulationMin=modemACMmodulationMin, ethRXCRCErrors=ethRXCRCErrors, ethRXMulticasts=ethRXMulticasts, modemStatistics=modemStatistics, ethTXUnderruns=ethTXUnderruns, restartcpu=restartcpu, e1t1ChannelNr=e1t1ChannelNr, ethTXExcessiveDefers=ethTXExcessiveDefers, aTPCEntry=aTPCEntry, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXGiants=ethTXGiants, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXControlFrames=ethTXControlFrames, ethRXByteCounterHi=ethRXByteCounterHi, writeConfig=writeConfig, ipRadioCfg=ipRadioCfg, modemACMengine=modemACMengine, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemErroredSecondRatio=modemErroredSecondRatio, product=product, modemSymbolRateRx=modemSymbolRateRx, e1t1AIS=e1t1AIS, modemCarrierOffset=modemCarrierOffset, modemBandwith=modemBandwith, ethTXMaxCollisions=ethTXMaxCollisions, atpcEnabled=atpcEnabled, modemCountTime=modemCountTime, radioTxFrequency=radioTxFrequency, ethGFPDropedFrames=ethGFPDropedFrames, ethRXBroadcasts=ethRXBroadcasts, ipRadio=ipRadio, ethRXCodeErrors=ethRXCodeErrors, ethGFPFCSErrors=ethGFPFCSErrors, modemModulation=modemModulation, radioDuplexShift=radioDuplexShift, ethTXVlanTags=ethTXVlanTags, safip=safip, modemTable=modemTable, remoteIp=remoteIp, e1t1StatTable=e1t1StatTable, ethTXCRCErrors=ethTXCRCErrors, vlanTable=vlanTable, radioGenStatus=radioGenStatus, atpcTxPowerCorrection=atpcTxPowerCorrection, radioTable=radioTable, e1t1LOS=e1t1LOS, ethRXDvEvent=ethRXDvEvent, ethRXByteCounterLow=ethRXByteCounterLow, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethGFPCHECErrors=ethGFPCHECErrors, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ipRadioMgmt=ipRadioMgmt, e1t1StatEntry=e1t1StatEntry, ethRXDribleNibbles=ethRXDribleNibbles, modemSymbolRateTx=modemSymbolRateTx, ethTXByteCounterHi=ethTXByteCounterHi, modemTotalBlockNumber=modemTotalBlockNumber, localIp=localIp, ethTXCollisions=ethTXCollisions, modemACMethernetCapacity=modemACMethernetCapacity, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, pointToPoint=pointToPoint, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemLastAcqError=modemLastAcqError, modemEthernetCapacity=modemEthernetCapacity, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXPrevPktDropped=ethRXPrevPktDropped, modemAcqStatus=modemAcqStatus, ethTXDones=ethTXDones, sysTemperature=sysTemperature, ethRXLongEvents=ethRXLongEvents, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemInternalAGCgain=modemInternalAGCgain, licenseUpdateStatus=licenseUpdateStatus, radioRxLevel=radioRxLevel, modemE1T1Channels=modemE1T1Channels, licenseMask=licenseMask, ethTXMulticasts=ethTXMulticasts, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethQOSTXDropped=ethQOSTXDropped, radioLoopback=radioLoopback, ethTXBroadcasts=ethTXBroadcasts, modemACMtotalCapacity=modemACMtotalCapacity)
