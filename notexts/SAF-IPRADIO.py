...
mibBuilder.exportSymbols("SAF-IPRADIO", modemTotalCapacity=modemTotalCapacity, ethRXCRCErrors=ethRXCRCErrors, ipRadioMgmt=ipRadioMgmt, radioRxFrequency=radioRxFrequency, radioEntry=radioEntry, sysDateAndTime=sysDateAndTime, license=license, ipRadioCfg=ipRadioCfg, ethTXPauseFrames=ethTXPauseFrames, ethTXVlanTags=ethTXVlanTags, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, vlanRowStatus=vlanRowStatus, loopback_tributary_mask=loopback_tributary_mask, e1t1StatEntry=e1t1StatEntry, localIpMask=localIpMask, vlanFid=vlanFid, ethTXDones=ethTXDones, modemErroredBlock=modemErroredBlock, ethTXByteCounterLow=ethTXByteCounterLow, ethTXMaxCollisions=ethTXMaxCollisions, vlanEntry=vlanEntry, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemTotalBlockNumber=modemTotalBlockNumber, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXDvEvent=ethRXDvEvent, modemSymbolRateTx=modemSymbolRateTx, ethRXPauseFrames=ethRXPauseFrames, remoteIp=remoteIp, modemE1T1Channels=modemE1T1Channels, ethQOSTXDropped=ethQOSTXDropped, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, hostname=hostname, radioSide=radioSide, tehnika=tehnika, ethRXPrevPktDropped=ethRXPrevPktDropped, modemIndex=modemIndex, ethRXLongEvents=ethRXLongEvents, ethTXCollisions=ethTXCollisions, e1t1AIS=e1t1AIS, ethRXDones=ethRXDones, ethRXDribleNibbles=ethRXDribleNibbles, ethRXByteCounterHi=ethRXByteCounterHi, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioTxFrequency=radioTxFrequency, modemErroredSecond=modemErroredSecond, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioTable=radioTable, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXControlFrames=ethTXControlFrames, vlanNumber=vlanNumber, ethGFPDelineationErrors=ethGFPDelineationErrors, atpcIndex=atpcIndex, atpcEnabled=atpcEnabled, ethGFPCHECErrors=ethGFPCHECErrors, ethRXBroadcasts=ethRXBroadcasts, ethRXControlFrames=ethRXControlFrames, microwaveRadio=microwaveRadio, product=product, ethTXMulticasts=ethTXMulticasts, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXExcessiveDefers=ethTXExcessiveDefers, licenseMask=licenseMask, ipRadio=ipRadio, ethRXByteCounterLow=ethRXByteCounterLow, modemErroredSecondRatio=modemErroredSecondRatio, modemACMmodulationMin=modemACMmodulationMin, radioGenStatus=radioGenStatus, pointToPoint=pointToPoint, radioDuplexShift=radioDuplexShift, modemSymbolRateRx=modemSymbolRateRx, e1t1LOS=e1t1LOS, modemLDPCdecoderStress=modemLDPCdecoderStress, modemBandwith=modemBandwith, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemModulation=modemModulation, ipRadioStat=ipRadioStat, ethGFPFCSErrors=ethGFPFCSErrors, ipRadioStatEth=ipRadioStatEth, modemTable=modemTable, modemEntry=modemEntry, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXGiants=ethTXGiants, ethTXUnderruns=ethTXUnderruns, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemACMtotalCapacity=modemACMtotalCapacity, licenseUpdateStatus=licenseUpdateStatus, vlanTable=vlanTable, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethQOSTXFrames=ethQOSTXFrames, ipRadioCfgNetwork=ipRadioCfgNetwork, safip=safip, e1t1ChannelNr=e1t1ChannelNr, vlanPortmap=vlanPortmap, writeConfig=writeConfig, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXCodeErrors=ethRXCodeErrors, ethTXBackpresEvents=ethTXBackpresEvents, aTPCTable=aTPCTable, modemEthernetCapacity=modemEthernetCapacity, modemGeneralStatus=modemGeneralStatus, vlanCfgStat=vlanCfgStat, restartcpu=restartcpu, modemACMengine=modemACMengine, vlanPortType=vlanPortType, modemRowStatus=modemRowStatus, modemCarrierOffset=modemCarrierOffset, modemCountTime=modemCountTime, modemStatistics=modemStatistics, modemACMmodulationMax=modemACMmodulationMax, ethTXCRCErrors=ethTXCRCErrors, modemAcqStatus=modemAcqStatus, modemInternalAGCgain=modemInternalAGCgain, ethTXBroadcasts=ethTXBroadcasts, e1t1StatTable=e1t1StatTable, modemUnavailtime=modemUnavailtime, sysTemperature=sysTemperature, modemRadialMSE=modemRadialMSE, aTPCEntry=aTPCEntry, radioLoopback=radioLoopback, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXByteCounterHi=ethTXByteCounterHi, modemACMethernetCapacity=modemACMethernetCapacity, ethTXLateCollisions=ethTXLateCollisions, description=description, loopbacks=loopbacks, radioTxMute=radioTxMute, vlansEnabled=vlansEnabled, ethRXMulticasts=ethRXMulticasts, radioIndex=radioIndex, modemStandard=modemStandard, ethGFPDropedFrames=ethGFPDropedFrames, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemUptime=modemUptime, radioRxLevel=radioRxLevel, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemLastAcqError=modemLastAcqError, radioTxPower=radioTxPower, ethTXWireByteCounterLow=ethTXWireByteCounterLow, localIp=localIp, saf=saf, ethRXTruncatedFrames=ethRXTruncatedFrames)
