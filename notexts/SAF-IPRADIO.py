...
mibBuilder.exportSymbols("SAF-IPRADIO", atpcTxPowerCorrection=atpcTxPowerCorrection, modemACMmodulationMin=modemACMmodulationMin, modemTotalCapacity=modemTotalCapacity, vlanFid=vlanFid, ethTXGiants=ethTXGiants, license=license, vlanTable=vlanTable, modemUnavailtime=modemUnavailtime, ethRXControlFrames=ethRXControlFrames, modemUptime=modemUptime, ethTXByteCounterHi=ethTXByteCounterHi, ipRadioCfgGeneral=ipRadioCfgGeneral, remoteIp=remoteIp, radioTxFrequency=radioTxFrequency, modemLastAcqError=modemLastAcqError, radioRxLevel=radioRxLevel, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXByteCounterLow=ethTXByteCounterLow, ethTXMaxCollisions=ethTXMaxCollisions, ethTXBroadcasts=ethTXBroadcasts, radioRxFrequency=radioRxFrequency, modemLDPCdecoderStress=modemLDPCdecoderStress, modemACMengine=modemACMengine, e1t1LOS=e1t1LOS, ethTXMulticasts=ethTXMulticasts, modemGeneralStatus=modemGeneralStatus, ethTXPauseFrames=ethTXPauseFrames, hostname=hostname, ethGFPCHECErrors=ethGFPCHECErrors, ipRadioMgmt=ipRadioMgmt, pointToPoint=pointToPoint, vlanPortmap=vlanPortmap, sysTemperature=sysTemperature, modemCountTime=modemCountTime, ipRadioCfg=ipRadioCfg, licenseMask=licenseMask, modemACMtotalCapacity=modemACMtotalCapacity, e1t1AIS=e1t1AIS, modemRowStatus=modemRowStatus, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXCRCErrors=ethTXCRCErrors, localIpMask=localIpMask, radioDuplexShift=radioDuplexShift, ethTXVlanTags=ethTXVlanTags, ethTXLateCollisions=ethTXLateCollisions, ethTXCollisions=ethTXCollisions, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXUnderruns=ethTXUnderruns, localIp=localIp, loopback_tributary_mask=loopback_tributary_mask, ethRXLongEvents=ethRXLongEvents, loopbacks=loopbacks, atpcEnabled=atpcEnabled, ethRXDvEvent=ethRXDvEvent, e1t1StatEntry=e1t1StatEntry, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemCarrierOffset=modemCarrierOffset, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemBandwith=modemBandwith, atpcIndex=atpcIndex, modemModulation=modemModulation, modemE1T1Channels=modemE1T1Channels, ethRXDones=ethRXDones, modemSymbolRateTx=modemSymbolRateTx, aTPCTable=aTPCTable, ipRadioStat=ipRadioStat, ethRXPauseFrames=ethRXPauseFrames, e1t1ChannelNr=e1t1ChannelNr, ethRXByteCounterHi=ethRXByteCounterHi, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXControlFrames=ethTXControlFrames, writeConfig=writeConfig, modemTotalBlockNumber=modemTotalBlockNumber, ethRXMulticasts=ethRXMulticasts, vlanPortType=vlanPortType, modemErroredBlock=modemErroredBlock, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethQOSTXFrames=ethQOSTXFrames, microwaveRadio=microwaveRadio, ethTXDones=ethTXDones, vlansEnabled=vlansEnabled, ethRXBroadcasts=ethRXBroadcasts, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioEntry=radioEntry, description=description, modemErroredSecondRatio=modemErroredSecondRatio, ethTXExcessiveDefers=ethTXExcessiveDefers, ipRadioStatEth=ipRadioStatEth, radioIndex=radioIndex, ethGFPDropedFrames=ethGFPDropedFrames, safip=safip, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethQOSTXDropped=ethQOSTXDropped, vlanNumber=vlanNumber, vlanRowStatus=vlanRowStatus, modemSymbolRateRx=modemSymbolRateRx, radioTable=radioTable, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioSide=radioSide, modemIndex=modemIndex, modemInternalAGCgain=modemInternalAGCgain, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioTxPower=radioTxPower, ethRXCodeErrors=ethRXCodeErrors, ethRXCRCErrors=ethRXCRCErrors, vlanEntry=vlanEntry, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemEntry=modemEntry, ethRXPrevPktDropped=ethRXPrevPktDropped, modemStatistics=modemStatistics, ethGFPFCSErrors=ethGFPFCSErrors, e1t1StatTable=e1t1StatTable, ethTXLengthCheckErrors=ethTXLengthCheckErrors, product=product, ethTXBackpresEvents=ethTXBackpresEvents, modemRadialMSE=modemRadialMSE, radioTxMute=radioTxMute, modemErroredSecond=modemErroredSecond, modemTable=modemTable, modemStandard=modemStandard, modemAcqStatus=modemAcqStatus, radioLoopback=radioLoopback, modemACMmodulationMax=modemACMmodulationMax, ethRXByteCounterLow=ethRXByteCounterLow, licenseUpdateStatus=licenseUpdateStatus, modemE1T1ChannelMask=modemE1T1ChannelMask, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, tehnika=tehnika, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemACMethernetCapacity=modemACMethernetCapacity, sysDateAndTime=sysDateAndTime, aTPCEntry=aTPCEntry, ipRadio=ipRadio, restartcpu=restartcpu, ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, modemEthernetCapacity=modemEthernetCapacity, ethRXTruncatedFrames=ethRXTruncatedFrames, radioGenStatus=radioGenStatus, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlanCfgStat=vlanCfgStat, ethRXDribleNibbles=ethRXDribleNibbles, saf=saf)
