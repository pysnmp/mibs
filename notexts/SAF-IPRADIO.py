...
mibBuilder.exportSymbols("SAF-IPRADIO", vlanCfgStat=vlanCfgStat, modemRowStatus=modemRowStatus, ipRadioCfgGeneral=ipRadioCfgGeneral, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemInternalAGCgain=modemInternalAGCgain, modemUptime=modemUptime, ipRadioMgmt=ipRadioMgmt, vlanEntry=vlanEntry, modemBandwith=modemBandwith, radioTxPower=radioTxPower, description=description, ipRadioStatEth=ipRadioStatEth, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXMaxCollisions=ethTXMaxCollisions, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXGiants=ethTXGiants, ethTXPauseFrames=ethTXPauseFrames, ethRXPauseFrames=ethRXPauseFrames, product=product, modemSymbolRateRx=modemSymbolRateRx, modemLDPCdecoderStress=modemLDPCdecoderStress, localIp=localIp, ethTXByteCounterHi=ethTXByteCounterHi, vlanPortType=vlanPortType, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXCRCErrors=ethTXCRCErrors, modemRadialMSE=modemRadialMSE, modemUnavailtime=modemUnavailtime, sysDateAndTime=sysDateAndTime, modemLastAcqError=modemLastAcqError, ethRXDones=ethRXDones, atpcEnabled=atpcEnabled, atpcIndex=atpcIndex, loopback_tributary_mask=loopback_tributary_mask, ethTXCollisions=ethTXCollisions, vlansEnabled=vlansEnabled, ethQOSTXDropped=ethQOSTXDropped, ethRXPrevPktDropped=ethRXPrevPktDropped, modemACMtotalCapacity=modemACMtotalCapacity, radioTxMute=radioTxMute, ethTXControlFrames=ethTXControlFrames, e1t1StatEntry=e1t1StatEntry, radioIndex=radioIndex, ipRadioStat=ipRadioStat, aTPCTable=aTPCTable, e1t1AIS=e1t1AIS, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethGFPDelineationErrors=ethGFPDelineationErrors, modemCarrierOffset=modemCarrierOffset, ethGFPFCSErrors=ethGFPFCSErrors, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXBackpresEvents=ethTXBackpresEvents, ethTXByteCounterLow=ethTXByteCounterLow, modemACMmodulationMin=modemACMmodulationMin, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemAcqStatus=modemAcqStatus, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXLongEvents=ethRXLongEvents, modemACMmodulationMax=modemACMmodulationMax, sysTemperature=sysTemperature, radioGenStatus=radioGenStatus, ethTXExcessiveDefers=ethTXExcessiveDefers, radioRxFrequency=radioRxFrequency, modemIndex=modemIndex, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemStatistics=modemStatistics, e1t1LOS=e1t1LOS, aTPCEntry=aTPCEntry, ethRXByteCounterHi=ethRXByteCounterHi, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXUnderruns=ethTXUnderruns, ethRXBroadcasts=ethRXBroadcasts, writeConfig=writeConfig, restartcpu=restartcpu, modemStandard=modemStandard, radioDuplexShift=radioDuplexShift, vlanTable=vlanTable, vlanNumber=vlanNumber, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXCodeErrors=ethRXCodeErrors, vlanRowStatus=vlanRowStatus, ethQOSTXFrames=ethQOSTXFrames, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, localIpMask=localIpMask, modemACMethernetCapacity=modemACMethernetCapacity, vlanPortmap=vlanPortmap, licenseUpdateStatus=licenseUpdateStatus, saf=saf, modemTotalBlockNumber=modemTotalBlockNumber, modemSymbolRateTx=modemSymbolRateTx, modemACMengine=modemACMengine, remoteIp=remoteIp, ethRXMulticasts=ethRXMulticasts, licenseMask=licenseMask, ethRXDribleNibbles=ethRXDribleNibbles, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioSide=radioSide, radioTxFrequency=radioTxFrequency, license=license, radioEntry=radioEntry, vlanFid=vlanFid, ethRXUnsupOpcodes=ethRXUnsupOpcodes, loopbacks=loopbacks, ipRadio=ipRadio, hostname=hostname, modemTable=modemTable, modemTotalCapacity=modemTotalCapacity, ethTXBroadcasts=ethTXBroadcasts, modemEthernetCapacity=modemEthernetCapacity, e1t1StatTable=e1t1StatTable, tehnika=tehnika, modemE1T1Channels=modemE1T1Channels, radioLoopback=radioLoopback, modemModulation=modemModulation, ipRadioCfg=ipRadioCfg, radioTable=radioTable, ethRXControlFrames=ethRXControlFrames, ethTXLateCollisions=ethTXLateCollisions, modemErroredBlock=modemErroredBlock, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethGFPDropedFrames=ethGFPDropedFrames, modemEntry=modemEntry, radioRxLevel=radioRxLevel, ethGFPCHECErrors=ethGFPCHECErrors, ethTXMulticasts=ethTXMulticasts, ethRXByteCounterLow=ethRXByteCounterLow, ethRXCRCErrors=ethRXCRCErrors, pointToPoint=pointToPoint, ethTXDones=ethTXDones, ethTXLengthCheckErrors=ethTXLengthCheckErrors, e1t1ChannelNr=e1t1ChannelNr, modemCountTime=modemCountTime, microwaveRadio=microwaveRadio, safip=safip, modemGeneralStatus=modemGeneralStatus, modemErroredSecond=modemErroredSecond, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXDvEvent=ethRXDvEvent, ethTXVlanTags=ethTXVlanTags, modemErroredSecondRatio=modemErroredSecondRatio)
