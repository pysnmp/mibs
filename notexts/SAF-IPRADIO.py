...
mibBuilder.exportSymbols("SAF-IPRADIO", e1t1StatTable=e1t1StatTable, modemTable=modemTable, ethGFPDelineationErrors=ethGFPDelineationErrors, modemStatistics=modemStatistics, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXLengthCheckErrors=ethTXLengthCheckErrors, e1t1AIS=e1t1AIS, modemErroredSecond=modemErroredSecond, radioEntry=radioEntry, vlanTable=vlanTable, ethRXByteCounterLow=ethRXByteCounterLow, safip=safip, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioSide=radioSide, radioGenStatus=radioGenStatus, modemACMethernetCapacity=modemACMethernetCapacity, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioTxMute=radioTxMute, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, vlanPortType=vlanPortType, ipRadioCfg=ipRadioCfg, aTPCTable=aTPCTable, modemBandwith=modemBandwith, modemCarrierOffset=modemCarrierOffset, hostname=hostname, localIpMask=localIpMask, modemRowStatus=modemRowStatus, ipRadioMgmt=ipRadioMgmt, ethTXGiants=ethTXGiants, ethGFPDropedFrames=ethGFPDropedFrames, modemRadialMSE=modemRadialMSE, ethTXPauseFrames=ethTXPauseFrames, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, e1t1ChannelNr=e1t1ChannelNr, modemErroredSecondRatio=modemErroredSecondRatio, aTPCEntry=aTPCEntry, modemModulation=modemModulation, sysTemperature=sysTemperature, license=license, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ipRadioStat=ipRadioStat, ethTXDones=ethTXDones, ethTXMaxCollisions=ethTXMaxCollisions, ethRXPauseFrames=ethRXPauseFrames, ethTXByteCounterHi=ethTXByteCounterHi, modemACMmodulationMax=modemACMmodulationMax, modemSymbolRateTx=modemSymbolRateTx, modemUptime=modemUptime, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXDvEvent=ethRXDvEvent, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXByteCounterLow=ethTXByteCounterLow, pointToPoint=pointToPoint, licenseMask=licenseMask, ethRXDribleNibbles=ethRXDribleNibbles, radioRxFrequency=radioRxFrequency, saf=saf, ethRXDones=ethRXDones, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemEthernetCapacity=modemEthernetCapacity, radioDuplexShift=radioDuplexShift, ethRXMulticasts=ethRXMulticasts, ipRadio=ipRadio, ethRXByteCounterHi=ethRXByteCounterHi, e1t1LOS=e1t1LOS, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXMulticasts=ethTXMulticasts, radioTxPower=radioTxPower, ethTXControlFrames=ethTXControlFrames, modemACMtotalCapacity=modemACMtotalCapacity, ethRXLongEvents=ethRXLongEvents, vlanEntry=vlanEntry, vlanRowStatus=vlanRowStatus, ethGFPCHECErrors=ethGFPCHECErrors, modemIndex=modemIndex, ethTXBackpresEvents=ethTXBackpresEvents, ipRadioCfgGeneral=ipRadioCfgGeneral, product=product, licenseUpdateStatus=licenseUpdateStatus, modemLDPCdecoderStress=modemLDPCdecoderStress, modemUnavailtime=modemUnavailtime, vlanCfgStat=vlanCfgStat, modemInternalAGCgain=modemInternalAGCgain, vlanNumber=vlanNumber, atpcEnabled=atpcEnabled, loopbacks=loopbacks, modemEntry=modemEntry, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethGFPFCSErrors=ethGFPFCSErrors, radioIndex=radioIndex, modemACMengine=modemACMengine, ethTXBroadcasts=ethTXBroadcasts, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXUnderruns=ethTXUnderruns, modemErroredBlock=modemErroredBlock, modemACMmodulationMin=modemACMmodulationMin, restartcpu=restartcpu, sysDateAndTime=sysDateAndTime, modemTotalCapacity=modemTotalCapacity, vlanPortmap=vlanPortmap, ethTXWireByteCounterHi=ethTXWireByteCounterHi, atpcIndex=atpcIndex, modemCountTime=modemCountTime, vlansEnabled=vlansEnabled, modemE1T1Channels=modemE1T1Channels, remoteIp=remoteIp, ethRXBroadcasts=ethRXBroadcasts, ethRXControlFrames=ethRXControlFrames, ethRXCodeErrors=ethRXCodeErrors, ethTXLateCollisions=ethTXLateCollisions, radioLoopback=radioLoopback, modemGeneralStatus=modemGeneralStatus, radioTxFrequency=radioTxFrequency, loopback_tributary_mask=loopback_tributary_mask, modemAcqStatus=modemAcqStatus, vlanFid=vlanFid, atpcTxPowerCorrection=atpcTxPowerCorrection, description=description, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXPrevPktDropped=ethRXPrevPktDropped, modemStandard=modemStandard, ethRXCRCErrors=ethRXCRCErrors, modemLastAcqError=modemLastAcqError, radioTable=radioTable, writeConfig=writeConfig, modemTotalBlockNumber=modemTotalBlockNumber, localIp=localIp, modemSymbolRateRx=modemSymbolRateRx, e1t1StatEntry=e1t1StatEntry, microwaveRadio=microwaveRadio, ethTXVlanTags=ethTXVlanTags, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ipRadioStatEth=ipRadioStatEth, ethQOSTXFrames=ethQOSTXFrames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, tehnika=tehnika, radioRxLevel=radioRxLevel, ethTXCRCErrors=ethTXCRCErrors, ethTXCollisions=ethTXCollisions, ethQOSTXDropped=ethQOSTXDropped)
