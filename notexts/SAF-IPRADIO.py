...
mibBuilder.exportSymbols("SAF-IPRADIO", modemUnavailtime=modemUnavailtime, microwaveRadio=microwaveRadio, ethRXCRCErrors=ethRXCRCErrors, modemLDPCdecoderStress=modemLDPCdecoderStress, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemStandard=modemStandard, ethRXByteCounterHi=ethRXByteCounterHi, sysTemperature=sysTemperature, ipRadioCfgGeneral=ipRadioCfgGeneral, vlanCfgStat=vlanCfgStat, modemACMmodulationMax=modemACMmodulationMax, saf=saf, radioDuplexShift=radioDuplexShift, e1t1ChannelNr=e1t1ChannelNr, modemCarrierOffset=modemCarrierOffset, radioEntry=radioEntry, ethRXBroadcasts=ethRXBroadcasts, ethTXWireByteCounterHi=ethTXWireByteCounterHi, e1t1LOS=e1t1LOS, remoteIp=remoteIp, atpcIndex=atpcIndex, vlanPortType=vlanPortType, ethTXMulticasts=ethTXMulticasts, modemTotalBlockNumber=modemTotalBlockNumber, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemRowStatus=modemRowStatus, modemErroredSecond=modemErroredSecond, ipRadioCfg=ipRadioCfg, e1t1StatTable=e1t1StatTable, ethTXExcessiveDefers=ethTXExcessiveDefers, modemSymbolRateTx=modemSymbolRateTx, radioLoopback=radioLoopback, modemGeneralStatus=modemGeneralStatus, ethRXPauseFrames=ethRXPauseFrames, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, safip=safip, ethTXDones=ethTXDones, modemRadialMSE=modemRadialMSE, writeConfig=writeConfig, atpcEnabled=atpcEnabled, hostname=hostname, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXControlFrames=ethRXControlFrames, ethTXCRCErrors=ethTXCRCErrors, modemInternalAGCgain=modemInternalAGCgain, ethGFPDropedFrames=ethGFPDropedFrames, modemEthernetCapacity=modemEthernetCapacity, vlanNumber=vlanNumber, ethRXDones=ethRXDones, aTPCTable=aTPCTable, tehnika=tehnika, ethTXByteCounterLow=ethTXByteCounterLow, ethTXLateCollisions=ethTXLateCollisions, vlanTable=vlanTable, loopbacks=loopbacks, vlansEnabled=vlansEnabled, ipRadioMgmt=ipRadioMgmt, modemACMtotalCapacity=modemACMtotalCapacity, ethQOSTXFrames=ethQOSTXFrames, ethGFPFCSErrors=ethGFPFCSErrors, ethTXCollisions=ethTXCollisions, modemErroredSecondRatio=modemErroredSecondRatio, licenseUpdateStatus=licenseUpdateStatus, radioTxFrequency=radioTxFrequency, modemTotalCapacity=modemTotalCapacity, modemLastAcqError=modemLastAcqError, license=license, ethRXByteCounterLow=ethRXByteCounterLow, pointToPoint=pointToPoint, vlanRowStatus=vlanRowStatus, modemIndex=modemIndex, modemE1T1ChannelMask=modemE1T1ChannelMask, e1t1AIS=e1t1AIS, radioRxLevel=radioRxLevel, ethGFPDelineationErrors=ethGFPDelineationErrors, e1t1StatEntry=e1t1StatEntry, description=description, radioTable=radioTable, ethQOSTXDropped=ethQOSTXDropped, ethTXBroadcasts=ethTXBroadcasts, ethRXMulticasts=ethRXMulticasts, ethRXPrevPktDropped=ethRXPrevPktDropped, ipRadioCfgNetwork=ipRadioCfgNetwork, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioRxFrequency=radioRxFrequency, modemModulation=modemModulation, ethRXDvEvent=ethRXDvEvent, modemErroredBlock=modemErroredBlock, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, licenseMask=licenseMask, modemSymbolRateRx=modemSymbolRateRx, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemTable=modemTable, vlanFid=vlanFid, ethTXGiants=ethTXGiants, localIpMask=localIpMask, restartcpu=restartcpu, modemACMmodulationMin=modemACMmodulationMin, ethTXMaxCollisions=ethTXMaxCollisions, modemCountTime=modemCountTime, radioIndex=radioIndex, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemEntry=modemEntry, ethTXUnderruns=ethTXUnderruns, sysDateAndTime=sysDateAndTime, radioTxPower=radioTxPower, ethTXLengthCheckErrors=ethTXLengthCheckErrors, radioTxMute=radioTxMute, ethRXVlanTagsDetected=ethRXVlanTagsDetected, localIp=localIp, modemE1T1Channels=modemE1T1Channels, ipRadioStatEth=ipRadioStatEth, vlanEntry=vlanEntry, ethTXControlFrames=ethTXControlFrames, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemUptime=modemUptime, ipRadio=ipRadio, loopback_tributary_mask=loopback_tributary_mask, ethRXCodeErrors=ethRXCodeErrors, atpcTxPowerCorrection=atpcTxPowerCorrection, modemBandwith=modemBandwith, ethGFPCHECErrors=ethGFPCHECErrors, product=product, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXLongEvents=ethRXLongEvents, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXDribleNibbles=ethRXDribleNibbles, ethTXVlanTags=ethTXVlanTags, modemAcqStatus=modemAcqStatus, modemACMethernetCapacity=modemACMethernetCapacity, modemACMengine=modemACMengine, modemStatistics=modemStatistics, radioSide=radioSide, vlanPortmap=vlanPortmap, radioGenStatus=radioGenStatus, aTPCEntry=aTPCEntry, ethTXPauseFrames=ethTXPauseFrames, ethTXByteCounterHi=ethTXByteCounterHi, ethTXBackpresEvents=ethTXBackpresEvents, ipRadioStat=ipRadioStat)
