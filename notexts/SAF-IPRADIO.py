...
mibBuilder.exportSymbols("SAF-IPRADIO", aTPCEntry=aTPCEntry, modemEntry=modemEntry, modemBandwith=modemBandwith, pointToPoint=pointToPoint, modemTable=modemTable, loopbacks=loopbacks, vlanEntry=vlanEntry, e1t1AIS=e1t1AIS, microwaveRadio=microwaveRadio, licenseMask=licenseMask, ethTXCollisions=ethTXCollisions, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXLongEvents=ethRXLongEvents, modemIndex=modemIndex, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, tehnika=tehnika, ipRadioCfgGeneral=ipRadioCfgGeneral, loopback_tributary_mask=loopback_tributary_mask, ipRadioMgmt=ipRadioMgmt, ethRXControlFrames=ethRXControlFrames, sysDateAndTime=sysDateAndTime, atpcIndex=atpcIndex, modemACMmodulationMin=modemACMmodulationMin, safip=safip, modemACMtotalCapacity=modemACMtotalCapacity, license=license, radioTxPower=radioTxPower, description=description, modemStandard=modemStandard, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXDones=ethRXDones, ethRXDribleNibbles=ethRXDribleNibbles, ethGFPCHECErrors=ethGFPCHECErrors, modemErroredBlock=modemErroredBlock, modemCarrierOffset=modemCarrierOffset, localIp=localIp, ethRXCodeErrors=ethRXCodeErrors, modemInternalAGCgain=modemInternalAGCgain, ethTXBackpresEvents=ethTXBackpresEvents, ethTXDones=ethTXDones, radioTxFrequency=radioTxFrequency, hostname=hostname, sysTemperature=sysTemperature, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemTotalCapacity=modemTotalCapacity, modemModulation=modemModulation, modemSymbolRateTx=modemSymbolRateTx, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemRowStatus=modemRowStatus, restartcpu=restartcpu, licenseUpdateStatus=licenseUpdateStatus, vlanTable=vlanTable, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXUnderruns=ethTXUnderruns, ethRXTruncatedFrames=ethRXTruncatedFrames, ipRadioCfg=ipRadioCfg, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, localIpMask=localIpMask, ethTXMaxCollisions=ethTXMaxCollisions, ipRadio=ipRadio, ethRXPrevPktDropped=ethRXPrevPktDropped, ethQOSTXFrames=ethQOSTXFrames, modemACMengine=modemACMengine, modemRadialMSE=modemRadialMSE, vlanCfgStat=vlanCfgStat, ethGFPDropedFrames=ethGFPDropedFrames, ethTXMulticasts=ethTXMulticasts, modemUptime=modemUptime, ipRadioStat=ipRadioStat, product=product, aTPCTable=aTPCTable, modemLastAcqError=modemLastAcqError, modemSymbolRateRx=modemSymbolRateRx, radioEntry=radioEntry, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioRxLevel=radioRxLevel, ethTXCRCErrors=ethTXCRCErrors, modemEthernetCapacity=modemEthernetCapacity, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXBroadcasts=ethTXBroadcasts, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXBroadcasts=ethRXBroadcasts, modemGeneralStatus=modemGeneralStatus, vlanPortmap=vlanPortmap, e1t1ChannelNr=e1t1ChannelNr, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, writeConfig=writeConfig, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemE1T1Channels=modemE1T1Channels, ethTXPauseFrames=ethTXPauseFrames, modemErroredSecondRatio=modemErroredSecondRatio, vlansEnabled=vlansEnabled, saf=saf, e1t1StatEntry=e1t1StatEntry, modemCountTime=modemCountTime, ethRXCRCErrors=ethRXCRCErrors, e1t1StatTable=e1t1StatTable, vlanPortType=vlanPortType, modemErroredSecond=modemErroredSecond, modemStatistics=modemStatistics, modemE1T1ChannelMask=modemE1T1ChannelMask, radioGenStatus=radioGenStatus, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXMulticasts=ethRXMulticasts, ethTXVlanTags=ethTXVlanTags, ipRadioStatEth=ipRadioStatEth, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioRxFrequency=radioRxFrequency, radioDuplexShift=radioDuplexShift, modemUnavailtime=modemUnavailtime, radioTable=radioTable, ethTXLateCollisions=ethTXLateCollisions, e1t1LOS=e1t1LOS, modemLDPCdecoderStress=modemLDPCdecoderStress, ethGFPFCSErrors=ethGFPFCSErrors, radioIndex=radioIndex, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemAcqStatus=modemAcqStatus, radioTxMute=radioTxMute, ethRXByteCounterHi=ethRXByteCounterHi, ethTXByteCounterHi=ethTXByteCounterHi, ethRXDvEvent=ethRXDvEvent, ethQOSTXDropped=ethQOSTXDropped, ethRXByteCounterLow=ethRXByteCounterLow, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlanFid=vlanFid, ipRadioCfgNetwork=ipRadioCfgNetwork, modemACMethernetCapacity=modemACMethernetCapacity, ethTXWireByteCounterLow=ethTXWireByteCounterLow, radioLoopback=radioLoopback, vlanRowStatus=vlanRowStatus, ethTXGiants=ethTXGiants, ethTXByteCounterLow=ethTXByteCounterLow, atpcEnabled=atpcEnabled, ethRXPauseFrames=ethRXPauseFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXControlFrames=ethTXControlFrames, modemTotalBlockNumber=modemTotalBlockNumber, radioSide=radioSide, remoteIp=remoteIp, modemACMmodulationMax=modemACMmodulationMax, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXVlanTagsDetected=ethRXVlanTagsDetected, vlanNumber=vlanNumber)
