...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXByteCounterLow=ethRXByteCounterLow, atpcTxPowerCorrection=atpcTxPowerCorrection, modemErroredSecond=modemErroredSecond, saf=saf, vlansEnabled=vlansEnabled, e1t1StatTable=e1t1StatTable, atpcIndex=atpcIndex, ethQOSTXDropped=ethQOSTXDropped, restartcpu=restartcpu, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXExcessiveDefers=ethTXExcessiveDefers, radioRxFrequency=radioRxFrequency, modemEntry=modemEntry, ipRadioStat=ipRadioStat, ethGFPDropedFrames=ethGFPDropedFrames, modemUnavailtime=modemUnavailtime, description=description, hostname=hostname, modemSymbolRateTx=modemSymbolRateTx, modemACMmodulationMin=modemACMmodulationMin, product=product, ethRXDvEvent=ethRXDvEvent, modemStandard=modemStandard, ipRadioCfg=ipRadioCfg, modemLDPCdecoderStress=modemLDPCdecoderStress, vlanEntry=vlanEntry, modemUptime=modemUptime, ipRadioCfgNetwork=ipRadioCfgNetwork, localIp=localIp, ethQOSTXFrames=ethQOSTXFrames, licenseMask=licenseMask, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, microwaveRadio=microwaveRadio, remoteIp=remoteIp, modemAcqStatus=modemAcqStatus, modemRadialMSE=modemRadialMSE, ethRXMulticasts=ethRXMulticasts, ethRXCodeErrors=ethRXCodeErrors, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXDones=ethTXDones, modemErroredSecondRatio=modemErroredSecondRatio, ethTXPauseFrames=ethTXPauseFrames, ethRXTruncatedFrames=ethRXTruncatedFrames, licenseUpdateStatus=licenseUpdateStatus, radioRxLevel=radioRxLevel, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemLastAcqError=modemLastAcqError, modemACMtotalCapacity=modemACMtotalCapacity, ethTXControlFrames=ethTXControlFrames, vlanPortmap=vlanPortmap, writeConfig=writeConfig, radioLoopback=radioLoopback, ipRadioCfgGeneral=ipRadioCfgGeneral, e1t1LOS=e1t1LOS, e1t1StatEntry=e1t1StatEntry, ipRadio=ipRadio, ethTXBackpresEvents=ethTXBackpresEvents, ethTXVlanTags=ethTXVlanTags, modemCountTime=modemCountTime, modemStatistics=modemStatistics, loopbacks=loopbacks, ethRXBroadcasts=ethRXBroadcasts, radioTxPower=radioTxPower, e1t1ChannelNr=e1t1ChannelNr, ethRXControlFrames=ethRXControlFrames, ethTXUnderruns=ethTXUnderruns, e1t1AIS=e1t1AIS, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemTotalBlockNumber=modemTotalBlockNumber, modemACMethernetCapacity=modemACMethernetCapacity, radioDuplexShift=radioDuplexShift, modemACMmodulationMax=modemACMmodulationMax, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, loopback_tributary_mask=loopback_tributary_mask, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemBandwith=modemBandwith, aTPCEntry=aTPCEntry, modemSeverelyErroredSecond=modemSeverelyErroredSecond, sysDateAndTime=sysDateAndTime, modemIndex=modemIndex, ethRXPauseFrames=ethRXPauseFrames, aTPCTable=aTPCTable, vlanRowStatus=vlanRowStatus, pointToPoint=pointToPoint, radioTxMute=radioTxMute, modemE1T1ChannelMask=modemE1T1ChannelMask, modemModulation=modemModulation, ethGFPFCSErrors=ethGFPFCSErrors, atpcEnabled=atpcEnabled, ethTXWireByteCounterLow=ethTXWireByteCounterLow, vlanTable=vlanTable, vlanCfgStat=vlanCfgStat, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlanPortType=vlanPortType, ethTXByteCounterLow=ethTXByteCounterLow, ethRXDribleNibbles=ethRXDribleNibbles, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethRXCRCErrors=ethRXCRCErrors, modemGeneralStatus=modemGeneralStatus, radioSide=radioSide, ethTXGiants=ethTXGiants, ethTXByteCounterHi=ethTXByteCounterHi, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXCRCErrors=ethTXCRCErrors, modemInternalAGCgain=modemInternalAGCgain, sysTemperature=sysTemperature, modemSymbolRateRx=modemSymbolRateRx, ipRadioStatEth=ipRadioStatEth, ipRadioMgmt=ipRadioMgmt, radioEntry=radioEntry, safip=safip, modemACMengine=modemACMengine, ethRXDones=ethRXDones, ethGFPDelineationErrors=ethGFPDelineationErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemTotalCapacity=modemTotalCapacity, localIpMask=localIpMask, radioGenStatus=radioGenStatus, ethTXMulticasts=ethTXMulticasts, modemEthernetCapacity=modemEthernetCapacity, vlanNumber=vlanNumber, modemE1T1Channels=modemE1T1Channels, ethTXMaxCollisions=ethTXMaxCollisions, radioIndex=radioIndex, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioTable=radioTable, modemCarrierOffset=modemCarrierOffset, modemRowStatus=modemRowStatus, tehnika=tehnika, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXCollisions=ethTXCollisions, vlanFid=vlanFid, ethRXLongEvents=ethRXLongEvents, modemTable=modemTable, ethRXByteCounterHi=ethRXByteCounterHi, ethTXBroadcasts=ethTXBroadcasts, ethTXLateCollisions=ethTXLateCollisions, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethGFPCHECErrors=ethGFPCHECErrors, license=license, radioTxFrequency=radioTxFrequency, ethRXPrevPktDropped=ethRXPrevPktDropped, modemErroredBlock=modemErroredBlock)
