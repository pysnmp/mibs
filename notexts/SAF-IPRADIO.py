...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXByteCounterLow=ethRXByteCounterLow, radioTxMute=radioTxMute, modemTotalBlockNumber=modemTotalBlockNumber, vlanRowStatus=vlanRowStatus, ethRXDones=ethRXDones, ethTXBroadcasts=ethTXBroadcasts, vlanCfgStat=vlanCfgStat, license=license, ethTXCRCErrors=ethTXCRCErrors, modemTable=modemTable, modemModulation=modemModulation, description=description, ethGFPFCSErrors=ethGFPFCSErrors, radioSide=radioSide, modemSymbolRateTx=modemSymbolRateTx, radioEntry=radioEntry, modemRadialMSE=modemRadialMSE, e1t1StatTable=e1t1StatTable, ethTXVlanTags=ethTXVlanTags, atpcIndex=atpcIndex, licenseUpdateStatus=licenseUpdateStatus, modemErroredBlock=modemErroredBlock, modemACMmodulationMin=modemACMmodulationMin, modemInternalAGCgain=modemInternalAGCgain, modemLastAcqError=modemLastAcqError, modemEntry=modemEntry, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ipRadioStat=ipRadioStat, ethRXCRCErrors=ethRXCRCErrors, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ipRadioCfg=ipRadioCfg, ethRXControlFrames=ethRXControlFrames, sysTemperature=sysTemperature, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemACMengine=modemACMengine, ipRadioCfgNetwork=ipRadioCfgNetwork, modemGeneralStatus=modemGeneralStatus, radioTxPower=radioTxPower, modemCarrierOffset=modemCarrierOffset, vlanNumber=vlanNumber, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXMulticasts=ethTXMulticasts, ethTXByteCounterLow=ethTXByteCounterLow, ethRXMulticasts=ethRXMulticasts, modemStatistics=modemStatistics, modemTotalCapacity=modemTotalCapacity, ethTXGiants=ethTXGiants, modemCountTime=modemCountTime, ipRadio=ipRadio, ethTXBackpresEvents=ethTXBackpresEvents, ethTXControlFrames=ethTXControlFrames, ethTXDones=ethTXDones, radioGenStatus=radioGenStatus, saf=saf, ethRXLongEvents=ethRXLongEvents, ipRadioStatEth=ipRadioStatEth, modemE1T1Channels=modemE1T1Channels, vlanEntry=vlanEntry, modemUptime=modemUptime, ethRXPauseFrames=ethRXPauseFrames, ethTXPauseFrames=ethTXPauseFrames, loopbacks=loopbacks, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethRXBroadcasts=ethRXBroadcasts, e1t1StatEntry=e1t1StatEntry, modemUnavailtime=modemUnavailtime, vlanFid=vlanFid, modemACMmodulationMax=modemACMmodulationMax, safip=safip, radioRxFrequency=radioRxFrequency, ethQOSTXFrames=ethQOSTXFrames, modemSymbolRateRx=modemSymbolRateRx, vlanPortType=vlanPortType, product=product, ethTXUnderruns=ethTXUnderruns, radioRxLevel=radioRxLevel, ipRadioCfgGeneral=ipRadioCfgGeneral, tehnika=tehnika, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXTruncatedFrames=ethRXTruncatedFrames, modemEthernetCapacity=modemEthernetCapacity, modemAcqStatus=modemAcqStatus, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXLateCollisions=ethTXLateCollisions, ethTXMaxCollisions=ethTXMaxCollisions, microwaveRadio=microwaveRadio, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethGFPCHECErrors=ethGFPCHECErrors, restartcpu=restartcpu, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXByteCounterHi=ethRXByteCounterHi, hostname=hostname, vlanTable=vlanTable, ethQOSRXQ2Frames=ethQOSRXQ2Frames, pointToPoint=pointToPoint, modemErroredSecond=modemErroredSecond, ipRadioMgmt=ipRadioMgmt, atpcTxPowerCorrection=atpcTxPowerCorrection, radioDuplexShift=radioDuplexShift, radioTable=radioTable, atpcEnabled=atpcEnabled, localIpMask=localIpMask, loopback_tributary_mask=loopback_tributary_mask, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemStandard=modemStandard, ethGFPDropedFrames=ethGFPDropedFrames, remoteIp=remoteIp, sysDateAndTime=sysDateAndTime, e1t1ChannelNr=e1t1ChannelNr, writeConfig=writeConfig, licenseMask=licenseMask, ethRXUnsupOpcodes=ethRXUnsupOpcodes, e1t1AIS=e1t1AIS, radioIndex=radioIndex, aTPCEntry=aTPCEntry, ethQOSTXDropped=ethQOSTXDropped, radioLoopback=radioLoopback, vlanPortmap=vlanPortmap, vlansEnabled=vlansEnabled, ethGFPDelineationErrors=ethGFPDelineationErrors, localIp=localIp, ethTXCollisions=ethTXCollisions, ethTXExcessiveDefers=ethTXExcessiveDefers, modemACMtotalCapacity=modemACMtotalCapacity, aTPCTable=aTPCTable, radioTxFrequency=radioTxFrequency, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXPrevPktDropped=ethRXPrevPktDropped, modemBandwith=modemBandwith, modemACMethernetCapacity=modemACMethernetCapacity, modemErroredSecondRatio=modemErroredSecondRatio, ethRXCodeErrors=ethRXCodeErrors, modemIndex=modemIndex, modemRowStatus=modemRowStatus, ethRXDribleNibbles=ethRXDribleNibbles, ethRXDvEvent=ethRXDvEvent, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXByteCounterHi=ethTXByteCounterHi, e1t1LOS=e1t1LOS)
