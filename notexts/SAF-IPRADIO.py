...
mibBuilder.exportSymbols("SAF-IPRADIO", localIp=localIp, radioEntry=radioEntry, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXByteCounterHi=ethTXByteCounterHi, modemRowStatus=modemRowStatus, modemEntry=modemEntry, writeConfig=writeConfig, radioTxMute=radioTxMute, radioTable=radioTable, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ipRadioMgmt=ipRadioMgmt, e1t1StatEntry=e1t1StatEntry, ethTXCollisions=ethTXCollisions, modemTotalCapacity=modemTotalCapacity, modemCountTime=modemCountTime, aTPCTable=aTPCTable, e1t1LOS=e1t1LOS, ethTXPauseFrames=ethTXPauseFrames, radioLoopback=radioLoopback, loopbacks=loopbacks, modemUnavailtime=modemUnavailtime, safip=safip, radioRxFrequency=radioRxFrequency, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, loopback_tributary_mask=loopback_tributary_mask, modemErroredBlock=modemErroredBlock, ethGFPFCSErrors=ethGFPFCSErrors, ethTXBackpresEvents=ethTXBackpresEvents, radioIndex=radioIndex, licenseUpdateStatus=licenseUpdateStatus, e1t1AIS=e1t1AIS, pointToPoint=pointToPoint, ipRadioStat=ipRadioStat, ethGFPDelineationErrors=ethGFPDelineationErrors, ipRadioCfgGeneral=ipRadioCfgGeneral, hostname=hostname, ethRXDribleNibbles=ethRXDribleNibbles, modemACMengine=modemACMengine, modemStandard=modemStandard, vlanPortType=vlanPortType, vlanPortmap=vlanPortmap, radioGenStatus=radioGenStatus, ethGFPDropedFrames=ethGFPDropedFrames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemSymbolRateTx=modemSymbolRateTx, description=description, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemACMethernetCapacity=modemACMethernetCapacity, modemLDPCdecoderStress=modemLDPCdecoderStress, ethRXMulticasts=ethRXMulticasts, saf=saf, modemInternalAGCgain=modemInternalAGCgain, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXTruncatedFrames=ethRXTruncatedFrames, modemErroredSecondRatio=modemErroredSecondRatio, modemTotalBlockNumber=modemTotalBlockNumber, modemSymbolRateRx=modemSymbolRateRx, ethTXVlanTags=ethTXVlanTags, ethRXPauseFrames=ethRXPauseFrames, atpcIndex=atpcIndex, remoteIp=remoteIp, ethRXBroadcasts=ethRXBroadcasts, vlanEntry=vlanEntry, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXByteCounterHi=ethRXByteCounterHi, ethTXDones=ethTXDones, ethTXLateCollisions=ethTXLateCollisions, ethTXLengthCheckErrors=ethTXLengthCheckErrors, radioRxLevel=radioRxLevel, ethRXCRCErrors=ethRXCRCErrors, ethTXExcessiveDefers=ethTXExcessiveDefers, license=license, e1t1StatTable=e1t1StatTable, modemModulation=modemModulation, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXLongEvents=ethRXLongEvents, radioSide=radioSide, atpcTxPowerCorrection=atpcTxPowerCorrection, vlanCfgStat=vlanCfgStat, modemACMmodulationMin=modemACMmodulationMin, ethTXMulticasts=ethTXMulticasts, ipRadioStatEth=ipRadioStatEth, ethRXDones=ethRXDones, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemBandwith=modemBandwith, microwaveRadio=microwaveRadio, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioTxPower=radioTxPower, modemLastAcqError=modemLastAcqError, ethGFPCHECErrors=ethGFPCHECErrors, ethTXMaxCollisions=ethTXMaxCollisions, aTPCEntry=aTPCEntry, ethRXByteCounterLow=ethRXByteCounterLow, vlanFid=vlanFid, modemTable=modemTable, modemSeverelyErroredSecond=modemSeverelyErroredSecond, vlanNumber=vlanNumber, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioTxFrequency=radioTxFrequency, modemACMmodulationMax=modemACMmodulationMax, ethTXControlFrames=ethTXControlFrames, modemUptime=modemUptime, sysDateAndTime=sysDateAndTime, radioDuplexShift=radioDuplexShift, ethTXByteCounterLow=ethTXByteCounterLow, modemE1T1Channels=modemE1T1Channels, ethQOSTXDropped=ethQOSTXDropped, modemIndex=modemIndex, restartcpu=restartcpu, modemACMtotalCapacity=modemACMtotalCapacity, ethRXCodeErrors=ethRXCodeErrors, ethRXControlFrames=ethRXControlFrames, atpcEnabled=atpcEnabled, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemCarrierOffset=modemCarrierOffset, ipRadio=ipRadio, ethTXBroadcasts=ethTXBroadcasts, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemRadialMSE=modemRadialMSE, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ipRadioCfgNetwork=ipRadioCfgNetwork, modemAcqStatus=modemAcqStatus, ethTXUnderruns=ethTXUnderruns, ethTXGiants=ethTXGiants, localIpMask=localIpMask, vlanTable=vlanTable, e1t1ChannelNr=e1t1ChannelNr, ethTXCRCErrors=ethTXCRCErrors, vlanRowStatus=vlanRowStatus, ethQOSTXFrames=ethQOSTXFrames, modemErroredSecond=modemErroredSecond, modemStatistics=modemStatistics, licenseMask=licenseMask, vlansEnabled=vlansEnabled, modemEthernetCapacity=modemEthernetCapacity, tehnika=tehnika, modemGeneralStatus=modemGeneralStatus, product=product, sysTemperature=sysTemperature, modemE1T1ChannelMask=modemE1T1ChannelMask, ipRadioCfg=ipRadioCfg, ethRXDvEvent=ethRXDvEvent)
