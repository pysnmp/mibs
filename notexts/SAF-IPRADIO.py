...
mibBuilder.exportSymbols("SAF-IPRADIO", sysTemperature=sysTemperature, e1t1ChannelNr=e1t1ChannelNr, modemTotalBlockNumber=modemTotalBlockNumber, radioIndex=radioIndex, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXDones=ethTXDones, vlanEntry=vlanEntry, modemACMtotalCapacity=modemACMtotalCapacity, vlanCfgStat=vlanCfgStat, modemBackgroundBlockErrror=modemBackgroundBlockErrror, safip=safip, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemRowStatus=modemRowStatus, radioSide=radioSide, aTPCEntry=aTPCEntry, ethRXByteCounterLow=ethRXByteCounterLow, modemRadialMSE=modemRadialMSE, ethGFPDropedFrames=ethGFPDropedFrames, licenseMask=licenseMask, modemStandard=modemStandard, ethRXDvEvent=ethRXDvEvent, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXCollisions=ethTXCollisions, modemEthernetCapacity=modemEthernetCapacity, ethRXBroadcasts=ethRXBroadcasts, loopback_tributary_mask=loopback_tributary_mask, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXBroadcasts=ethTXBroadcasts, ethTXByteCounterLow=ethTXByteCounterLow, modemIndex=modemIndex, writeConfig=writeConfig, ethRXControlFrames=ethRXControlFrames, radioDuplexShift=radioDuplexShift, atpcIndex=atpcIndex, modemInternalAGCgain=modemInternalAGCgain, microwaveRadio=microwaveRadio, sysDateAndTime=sysDateAndTime, ethRXCRCErrors=ethRXCRCErrors, vlanTable=vlanTable, ethTXByteCounterHi=ethTXByteCounterHi, hostname=hostname, ipRadioCfgGeneral=ipRadioCfgGeneral, product=product, ethTXMaxCollisions=ethTXMaxCollisions, modemTotalCapacity=modemTotalCapacity, vlansEnabled=vlansEnabled, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemCountTime=modemCountTime, ipRadioMgmt=ipRadioMgmt, modemUptime=modemUptime, modemSymbolRateTx=modemSymbolRateTx, modemErroredSecondRatio=modemErroredSecondRatio, description=description, tehnika=tehnika, ethTXUnderruns=ethTXUnderruns, ipRadioCfgNetwork=ipRadioCfgNetwork, e1t1StatEntry=e1t1StatEntry, radioGenStatus=radioGenStatus, radioTxPower=radioTxPower, loopbacks=loopbacks, modemErroredBlock=modemErroredBlock, ethRXDribleNibbles=ethRXDribleNibbles, saf=saf, remoteIp=remoteIp, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXPauseFrames=ethTXPauseFrames, ethGFPFCSErrors=ethGFPFCSErrors, modemACMmodulationMax=modemACMmodulationMax, license=license, aTPCTable=aTPCTable, radioRxLevel=radioRxLevel, modemBandwith=modemBandwith, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, localIpMask=localIpMask, modemLDPCdecoderStress=modemLDPCdecoderStress, modemAcqStatus=modemAcqStatus, radioTable=radioTable, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXByteCounterHi=ethRXByteCounterHi, radioEntry=radioEntry, radioTxMute=radioTxMute, localIp=localIp, radioRxFrequency=radioRxFrequency, ethQOSTXDropped=ethQOSTXDropped, modemLastAcqError=modemLastAcqError, ethRXLongEvents=ethRXLongEvents, vlanFid=vlanFid, ethRXDones=ethRXDones, ethTXGiants=ethTXGiants, modemACMengine=modemACMengine, ethTXControlFrames=ethTXControlFrames, modemModulation=modemModulation, vlanPortmap=vlanPortmap, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXPauseFrames=ethRXPauseFrames, modemUnavailtime=modemUnavailtime, modemCarrierOffset=modemCarrierOffset, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ipRadioCfg=ipRadioCfg, licenseUpdateStatus=licenseUpdateStatus, modemE1T1Channels=modemE1T1Channels, ethRXCodeErrors=ethRXCodeErrors, modemTable=modemTable, vlanPortType=vlanPortType, modemStatistics=modemStatistics, ethQOSTXFrames=ethQOSTXFrames, e1t1AIS=e1t1AIS, e1t1StatTable=e1t1StatTable, vlanRowStatus=vlanRowStatus, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, pointToPoint=pointToPoint, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ipRadioStatEth=ipRadioStatEth, ethTXBackpresEvents=ethTXBackpresEvents, modemEntry=modemEntry, ethRXMulticasts=ethRXMulticasts, ethGFPCHECErrors=ethGFPCHECErrors, radioTxFrequency=radioTxFrequency, ethQOSRXQ2Frames=ethQOSRXQ2Frames, vlanNumber=vlanNumber, modemGeneralStatus=modemGeneralStatus, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemErroredSecond=modemErroredSecond, e1t1LOS=e1t1LOS, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXCRCErrors=ethTXCRCErrors, ipRadioStat=ipRadioStat, ethTXVlanTags=ethTXVlanTags, ethTXMulticasts=ethTXMulticasts, modemSymbolRateRx=modemSymbolRateRx, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioLoopback=radioLoopback, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXLateCollisions=ethTXLateCollisions, atpcEnabled=atpcEnabled, ipRadio=ipRadio, modemACMmodulationMin=modemACMmodulationMin, modemACMethernetCapacity=modemACMethernetCapacity, restartcpu=restartcpu)
