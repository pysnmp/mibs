...
mibBuilder.exportSymbols("SAF-IPRADIO", ethGFPFCSErrors=ethGFPFCSErrors, modemStatistics=modemStatistics, ethRXMulticasts=ethRXMulticasts, modemTotalCapacity=modemTotalCapacity, safip=safip, sysTemperature=sysTemperature, ethTXMulticasts=ethTXMulticasts, writeConfig=writeConfig, ethTXExcessiveDefers=ethTXExcessiveDefers, modemRowStatus=modemRowStatus, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXLongEvents=ethRXLongEvents, remoteIp=remoteIp, radioSide=radioSide, radioTxMute=radioTxMute, pointToPoint=pointToPoint, modemRadialMSE=modemRadialMSE, vlanRowStatus=vlanRowStatus, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXControlFrames=ethTXControlFrames, ethRXPauseFrames=ethRXPauseFrames, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, vlanCfgStat=vlanCfgStat, modemEthernetCapacity=modemEthernetCapacity, microwaveRadio=microwaveRadio, ethTXMaxCollisions=ethTXMaxCollisions, ipRadioStatEth=ipRadioStatEth, aTPCEntry=aTPCEntry, e1t1AIS=e1t1AIS, loopback_tributary_mask=loopback_tributary_mask, tehnika=tehnika, vlanFid=vlanFid, modemInternalAGCgain=modemInternalAGCgain, ethRXByteCounterLow=ethRXByteCounterLow, ethRXByteCounterHi=ethRXByteCounterHi, ipRadioCfg=ipRadioCfg, modemErroredBlock=modemErroredBlock, radioIndex=radioIndex, restartcpu=restartcpu, radioDuplexShift=radioDuplexShift, product=product, ethTXBroadcasts=ethTXBroadcasts, e1t1LOS=e1t1LOS, radioRxLevel=radioRxLevel, ethRXCRCErrors=ethRXCRCErrors, modemUptime=modemUptime, localIp=localIp, ethTXCollisions=ethTXCollisions, ethQOSTXFrames=ethQOSTXFrames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, radioTxFrequency=radioTxFrequency, e1t1ChannelNr=e1t1ChannelNr, ethTXGiants=ethTXGiants, ethRXCodeErrors=ethRXCodeErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, e1t1StatTable=e1t1StatTable, ipRadioMgmt=ipRadioMgmt, atpcEnabled=atpcEnabled, hostname=hostname, ipRadioStat=ipRadioStat, ethQOSTXDropped=ethQOSTXDropped, ethRXControlFrames=ethRXControlFrames, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemCountTime=modemCountTime, aTPCTable=aTPCTable, description=description, modemIndex=modemIndex, radioEntry=radioEntry, saf=saf, sysDateAndTime=sysDateAndTime, ethRXPrevPktDropped=ethRXPrevPktDropped, loopbacks=loopbacks, modemTable=modemTable, modemAcqStatus=modemAcqStatus, radioTxPower=radioTxPower, vlanEntry=vlanEntry, ethTXCRCErrors=ethTXCRCErrors, ethTXBackpresEvents=ethTXBackpresEvents, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemE1T1ChannelMask=modemE1T1ChannelMask, ipRadioCfgGeneral=ipRadioCfgGeneral, modemLDPCdecoderStress=modemLDPCdecoderStress, vlanNumber=vlanNumber, modemErroredSecond=modemErroredSecond, ethTXVlanTags=ethTXVlanTags, modemBandwith=modemBandwith, modemModulation=modemModulation, radioLoopback=radioLoopback, vlanTable=vlanTable, modemUnavailtime=modemUnavailtime, ethRXDones=ethRXDones, localIpMask=localIpMask, modemSymbolRateRx=modemSymbolRateRx, ethTXLateCollisions=ethTXLateCollisions, modemCarrierOffset=modemCarrierOffset, modemACMengine=modemACMengine, ethRXDvEvent=ethRXDvEvent, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemLastAcqError=modemLastAcqError, modemGeneralStatus=modemGeneralStatus, modemSymbolRateTx=modemSymbolRateTx, ethGFPCHECErrors=ethGFPCHECErrors, atpcTxPowerCorrection=atpcTxPowerCorrection, modemACMmodulationMax=modemACMmodulationMax, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXPauseFrames=ethTXPauseFrames, licenseUpdateStatus=licenseUpdateStatus, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXTruncatedFrames=ethRXTruncatedFrames, vlanPortmap=vlanPortmap, modemEntry=modemEntry, modemStandard=modemStandard, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, licenseMask=licenseMask, ethRXBroadcasts=ethRXBroadcasts, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ipRadio=ipRadio, radioGenStatus=radioGenStatus, modemACMtotalCapacity=modemACMtotalCapacity, ethTXDones=ethTXDones, modemACMethernetCapacity=modemACMethernetCapacity, modemE1T1Channels=modemE1T1Channels, e1t1StatEntry=e1t1StatEntry, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethGFPDropedFrames=ethGFPDropedFrames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, atpcIndex=atpcIndex, ethTXByteCounterLow=ethTXByteCounterLow, license=license, vlansEnabled=vlansEnabled, modemErroredSecondRatio=modemErroredSecondRatio, ethTXByteCounterHi=ethTXByteCounterHi, ethRXDribleNibbles=ethRXDribleNibbles, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlanPortType=vlanPortType, ethTXUnderruns=ethTXUnderruns, modemACMmodulationMin=modemACMmodulationMin, modemTotalBlockNumber=modemTotalBlockNumber, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, radioRxFrequency=radioRxFrequency, radioTable=radioTable, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped)
