...
# ASN.1 source BTI8xx-SYSTEM-MIB
# Source digest sha256:f51c0be89f2afea1faf6a1206f31724f0b611160f3696297b27ee0565527f66f
...
if mibBuilder.loadTexts: systemConfig.setLastUpdated('2015-11-30 12:00')
...
imageInfoTable = MibTable((1, 3, 6, 1, 4, 1, 30005, 1, 7, 100, 1, 2, 1, 1, 2, 3, 10), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: imageInfoTable.setStatus('current')
imageInfoEntry = MibTableRow((1, 3, 6, 1, 4, 1, 30005, 1, 7, 100, 1, 2, 1, 1, 2, 3, 10, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "BTI8xx-SYSTEM-MIB", "imageInfoIndex"))
...
mibBuilder.exportSymbols("BTI8xx-SYSTEM-MIB", PYSNMP_MODULE_ID=systemConfig, accessInfo=accessInfo, autoLogoutTime=autoLogoutTime, cfgFileControl=cfgFileControl, cfgFileName=cfgFileName, cfgFileStatus=cfgFileStatus, configAndImageMgmt=configAndImageMgmt, configMgmt=configMgmt, consoleBaudRate=consoleBaudRate, consoleCharSize=consoleCharSize, consoleFlowControl=consoleFlowControl, consoleInformation=consoleInformation, consoleParityBits=consoleParityBits, consoleStopBits=consoleStopBits, fanCtrlStartTemp=fanCtrlStartTemp, fanCtrlStopTemp=fanCtrlStopTemp, fanHighTolerance=fanHighTolerance, fanHighToleranceValue=fanHighToleranceValue, fanLowTolerance=fanLowTolerance, fanLowToleranceValue=fanLowToleranceValue, fanRpmConfig=fanRpmConfig, ftpUserName=ftpUserName, ftpUserPasswd=ftpUserPasswd, imageInfoCreated=imageInfoCreated, imageInfoCurrent=imageInfoCurrent, imageInfoEntry=imageInfoEntry, imageInfoIndex=imageInfoIndex, imageInfoSize=imageInfoSize, imageInfoTable=imageInfoTable, imageInfoVersion=imageInfoVersion, imageMgmt=imageMgmt, lastCommand=lastCommand, lastSaveTime=lastSaveTime, mgmtInnerVlan=mgmtInnerVlan, mgmtInnerVlanPriority=mgmtInnerVlanPriority, mgmtOuterVlan=mgmtOuterVlan, mgmtOuterVlanPriority=mgmtOuterVlanPriority, mgmtVlanConfig=mgmtVlanConfig, miscellaneous=miscellaneous, pDefaultGateway=pDefaultGateway, pInbandIPAddress=pInbandIPAddress, pInbandMACAddress=pInbandMACAddress, pInbandNetMask=pInbandNetMask, pInbandNetworkAddress=pInbandNetworkAddress, pOOBIPAddress=pOOBIPAddress, pOOBMACAddress=pOOBMACAddress, pOOBNetMask=pOOBNetMask, pOOBNetworkAddress=pOOBNetworkAddress, reboot=reboot, save=save, serverConfig=serverConfig, serverInterfaceType=serverInterfaceType, serverIpAddr=serverIpAddr, systemConfig=systemConfig, systemHWVersion=systemHWVersion, systemInfo=systemInfo, systemManagement=systemManagement, systemName=systemName, systemProductName=systemProductName, systemSWDateAndTime=systemSWDateAndTime, systemSWVersion=systemSWVersion, systemTemperature=systemTemperature, systemTime=systemTime, systemUpTime=systemUpTime, tempHighThreshold=tempHighThreshold, tempLowThreshold=tempLowThreshold, timezone=timezone, upgradeImageSW=upgradeImageSW, upgradeImageSWDateAndTime=upgradeImageSWDateAndTime, upgradeImageSWFileName=upgradeImageSWFileName, upgradeImageSWStatus=upgradeImageSWStatus)
