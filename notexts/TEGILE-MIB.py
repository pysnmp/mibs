...
# Produced by pysmi-1.1.8 at Fri Jan 14 00:01:51 2022
...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ModuleIdentity, TimeTicks, Counter64, Counter32, NotificationType, MibIdentifier, Integer32, Unsigned32, Gauge32, IpAddress, ObjectIdentity, enterprises, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ModuleIdentity", "TimeTicks", "Counter64", "Counter32", "NotificationType", "MibIdentifier", "Integer32", "Unsigned32", "Gauge32", "IpAddress", "ObjectIdentity", "enterprises", "Bits")
...
mibBuilder.exportSymbols("TEGILE-MIB", poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, iscsiTargetsTable=iscsiTargetsTable, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, poolProjects=poolProjects, fcInitiatorCreateFailed=fcInitiatorCreateFailed, projectTable=projectTable, nicReceiveMbps=nicReceiveMbps, projectShares=projectShares, shareReservedSizeLow=shareReservedSizeLow, ipmiCriticalInterrupt=ipmiCriticalInterrupt, diskAvgWriteLatency=diskAvgWriteLatency, shareNFSReadMbps=shareNFSReadMbps, fcTargetIndex=fcTargetIndex, shareDeleted=shareDeleted, upgradeDownloadFailed=upgradeDownloadFailed, iscsiTargetError=iscsiTargetError, projectFreeSizeLow=projectFreeSizeLow, tegileCompliances=tegileCompliances, lunSnapshotSizeHigh=lunSnapshotSizeHigh, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, poolUsedSizeLow=poolUsedSizeLow, poolReadCacheReadIops=poolReadCacheReadIops, smbSocketFailure=smbSocketFailure, cacheTotalWriteIops=cacheTotalWriteIops, iscsiTargetReadMbps=iscsiTargetReadMbps, poolMetaWriteMbps=poolMetaWriteMbps, ipmiFan=ipmiFan, cpuSystemCalls=cpuSystemCalls, diskTotalWriteIops=diskTotalWriteIops, lunInitiatorGroup=lunInitiatorGroup, poolHealth=poolHealth, shareCreatedSuccessfully=shareCreatedSuccessfully, cacheTotalWriteMbps=cacheTotalWriteMbps, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, diskTable=diskTable, ipmiThreshold=ipmiThreshold, poolTable=poolTable, shareCIFSReadMbps=shareCIFSReadMbps, haControllerA_Name=haControllerA_Name, shareSnapshotSizeHigh=shareSnapshotSizeHigh, nicMTU=nicMTU, shareDataSizeHigh=shareDataSizeHigh, iscsiInitiatorChapUser=iscsiInitiatorChapUser, projectTotalSaving=projectTotalSaving, poolReadCacheReadMbps=poolReadCacheReadMbps, lunReadMbps=lunReadMbps, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, shareCompressionEnabled=shareCompressionEnabled, nicGroup=nicGroup, unknownSensorEvent=unknownSensorEvent, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, lunSizeHigh=lunSizeHigh, replicationAborted=replicationAborted, poolDegraded=poolDegraded, netbiosSocketFailure=netbiosSocketFailure, haResources=haResources, snapshotCreationFailed=snapshotCreationFailed, globalStatistics=globalStatistics, tegileArray_notifications=tegileArray_notifications, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, volumeQuotaFinished=volumeQuotaFinished, lunProtocol=lunProtocol, shareProjectName=shareProjectName, shareDedupEnabled=shareDedupEnabled, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, iscsiTargetAuth=iscsiTargetAuth, projectName=projectName, poolTotalReadMbps=poolTotalReadMbps, lunCompressionEnabled=lunCompressionEnabled, fcTargetsTable=fcTargetsTable, projectSnapshotSizeLow=projectSnapshotSizeLow, poolOwnerController=poolOwnerController, iscsiInitiatorsTable=iscsiInitiatorsTable, shareSnapshotSizeLow=shareSnapshotSizeLow, fcTargetReadMbps=fcTargetReadMbps, aclMigrationCompleted=aclMigrationCompleted, poolReadCacheWriteLatency=poolReadCacheWriteLatency, maintenanceModeEnabled=maintenanceModeEnabled, targetGroupDeleteCompleted=targetGroupDeleteCompleted, lunDedupEnabled=lunDedupEnabled, projectModified=projectModified, poolQuotaFinished=poolQuotaFinished, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, notificationReadingTriggerValue=notificationReadingTriggerValue, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, fcTargetWriteMbps=fcTargetWriteMbps, notificationObjects=notificationObjects, targetGroupMemberRemoved=targetGroupMemberRemoved, fcPortOnline=fcPortOnline, iscsiTargetReadIops=iscsiTargetReadIops, snapshotDeleteFailed=snapshotDeleteFailed, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, projectQuotaSizeLow=projectQuotaSizeLow, projectLunCount=projectLunCount, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, poolDataSizeHigh=poolDataSizeHigh, snmpServiceStarted=snmpServiceStarted, upgradeTimeout=upgradeTimeout, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, iscsiTotalWriteMbps=iscsiTotalWriteMbps, diskState=diskState, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, diskType=diskType, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, upgradeFailed=upgradeFailed, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, iscsiAvgReadLatency=iscsiAvgReadLatency, haResourcesTable=haResourcesTable, fcInitiatorsTable=fcInitiatorsTable, poolExported=poolExported, controllerUp=controllerUp, shareName=shareName, fcInitiatorEntry=fcInitiatorEntry, nfsAvgReadLatency=nfsAvgReadLatency, lunSizeLow=lunSizeLow, iscsiWriteIops=iscsiWriteIops, lunDataSizeLow=lunDataSizeLow, iscsiTargetName=iscsiTargetName, notificationThresholdTriggerValue=notificationThresholdTriggerValue, nicName=nicName, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, iscsiInitiatorIndex=iscsiInitiatorIndex, poolWriteCacheWriteIops=poolWriteCacheWriteIops, controllerDown=controllerDown, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, networkIpmpGroupUp=networkIpmpGroupUp, haResourceEntry=haResourceEntry, iscsiTargetWriteLatency=iscsiTargetWriteLatency, poolAvgReadLatency=poolAvgReadLatency, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, projectFreeSizeHigh=projectFreeSizeHigh, lunFreeSizeHigh=lunFreeSizeHigh, cifsTotalWriteIops=cifsTotalWriteIops, lunGUID=lunGUID, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, volumeModifyCompleted=volumeModifyCompleted, diskDataReadMbps=diskDataReadMbps, poolImported=poolImported, haControllerA_IPAddr=haControllerA_IPAddr, poolName=poolName, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, notificationComponentName=notificationComponentName, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, fcInitiatorGroup=fcInitiatorGroup, projectShareCount=projectShareCount, notificationSensorSuspect=notificationSensorSuspect, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, webdocsUpgradeFailed=webdocsUpgradeFailed, replicationTargetDeleted=replicationTargetDeleted, networkInterfaceDown=networkInterfaceDown, diskGoneOffline=diskGoneOffline, replicationResumed=replicationResumed, lunEntry=lunEntry, iscsiInitiatorGroup=iscsiInitiatorGroup, nvdimmFailInitializationError=nvdimmFailInitializationError, diskPoolName=diskPoolName, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, lunSnapshotSizeLow=lunSnapshotSizeLow, snapshotCloningFailed=snapshotCloningFailed, iscsiProperties=iscsiProperties, poolUpgraded=poolUpgraded, notificationSensorNumber=notificationSensorNumber, diskAlias=diskAlias, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, upgradeDownloadStarted=upgradeDownloadStarted, shareNFSWriteMbps=shareNFSWriteMbps, controllerTimeDrift=controllerTimeDrift, haResourceActiveNode=haResourceActiveNode, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, ipmiOther=ipmiOther, diskSizeHigh=diskSizeHigh, fcPortOffline=fcPortOffline, nfsTotalWriteIops=nfsTotalWriteIops, targetGroupMemberAdded=targetGroupMemberAdded, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, poolReadCacheWriteIops=poolReadCacheWriteIops, lunReservedSizeHigh=lunReservedSizeHigh, shareReservedSizeHigh=shareReservedSizeHigh, lunReadIops=lunReadIops, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, haControllerB_Uptime=haControllerB_Uptime, lunName=lunName, userLoginFailed=userLoginFailed, diskRandomIOCount=diskRandomIOCount, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, maintenanceModeDisabled=maintenanceModeDisabled, diskTotalReadIops=diskTotalReadIops, iscsiTargetIndex=iscsiTargetIndex, nicIndex=nicIndex, smisServiceStopFailed=smisServiceStopFailed, poolCreated=poolCreated, diskTotalWriteMbps=diskTotalWriteMbps, shareCIFSWriteIops=shareCIFSWriteIops, nfsTotalWriteMbps=nfsTotalWriteMbps, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, poolDataWriteIops=poolDataWriteIops, diskEntry=diskEntry, shareNFSReadLatency=shareNFSReadLatency, notificationSeverity=notificationSeverity, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, tdpsUpgradeFailed=tdpsUpgradeFailed, haResourceGroup=haResourceGroup, shareCIFSWriteMbps=shareCIFSWriteMbps, poolMetaReadIops=poolMetaReadIops, fcTotalWriteMbps=fcTotalWriteMbps, poolMetaWriteLatency=poolMetaWriteLatency, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, lunWriteMbps=lunWriteMbps, lunPoolName=lunPoolName, poolMetaWriteIops=poolMetaWriteIops, diskIsOnline=diskIsOnline, poolFreeSizeHigh=poolFreeSizeHigh, shareCompressedRatio=shareCompressedRatio, iscsiTargetGroupError=iscsiTargetGroupError, diagnosticDataUploaded=diagnosticDataUploaded, iscsiInitiatorEntry=iscsiInitiatorEntry, fcTotalReadMbps=fcTotalReadMbps, poolTotalWriteIops=poolTotalWriteIops, ipmiMemory=ipmiMemory, haResourceName=haResourceName, lunTable=lunTable, replicationStarted=replicationStarted, diskIOCount=diskIOCount, shareDataSizeLow=shareDataSizeLow, diskDataReadIops=diskDataReadIops, sensorFailureEvent=sensorFailureEvent, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, smisServiceStarted=smisServiceStarted, nfsAvgWriteLatency=nfsAvgWriteLatency, diskSizeLow=diskSizeLow, ipmiVoltage=ipmiVoltage, lunTargetGroup=lunTargetGroup, diskDataWriteMbps=diskDataWriteMbps, iscsiTargetGroup=iscsiTargetGroup, cacheRAMReads=cacheRAMReads, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, adServerTimeDrift=adServerTimeDrift, haResourceDescription=haResourceDescription, shareDeletionFailed=shareDeletionFailed, nicTable=nicTable, diskIndex=diskIndex, shareQuotaFinished=shareQuotaFinished, tegileConformance=tegileConformance, haControllerB_Name=haControllerB_Name, diskDataWriteIops=diskDataWriteIops)
mibBuilder.exportSymbols("TEGILE-MIB", smisServiceStopped=smisServiceStopped, disks=disks, projectDedupEnabled=projectDedupEnabled, snmpServiceStartFailed=snmpServiceStartFailed, poolTotalReadIops=poolTotalReadIops, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, testNotification=testNotification, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, cacheTotalReadMbps=cacheTotalReadMbps, cacheTotalReadIops=cacheTotalReadIops, nfsTotalReadMbps=nfsTotalReadMbps, iscsiTargetWriteIops=iscsiTargetWriteIops, currentNotificationGroup=currentNotificationGroup, shareQuotaHigh=shareQuotaHigh, shareNFSWriteLatency=shareNFSWriteLatency, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, networkInterfaceUp=networkInterfaceUp, fcTargetModifyCompleted=fcTargetModifyCompleted, fcTargetStatus=fcTargetStatus, projectLUNs=projectLUNs, intelliFlashSoftwareUp=intelliFlashSoftwareUp, shareEntry=shareEntry, poolExpanded=poolExpanded, projectSnapshotSizeHigh=projectSnapshotSizeHigh, iscsiTargets=iscsiTargets, fcProperties=fcProperties, haControllerA_Uptime=haControllerA_Uptime, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, poolProjectCount=poolProjectCount, fcInitiatorName=fcInitiatorName, network=network, alertsCleanupCompleted=alertsCleanupCompleted, notificationReadingUnit=notificationReadingUnit, fcTargetReadIops=fcTargetReadIops, projectThresholdExceedWarning=projectThresholdExceedWarning, haResourceIndex=haResourceIndex, projectIndex=projectIndex, poolAvgWriteLatency=poolAvgWriteLatency, lunWriteIops=lunWriteIops, upgradeStarted=upgradeStarted, currentObjectGroup=currentObjectGroup, controllerHardwareModel=controllerHardwareModel, fcTotalReadIops=fcTotalReadIops, replicationAbandoned=replicationAbandoned, spareDiskReplaced=spareDiskReplaced, diskTotalReadMbps=diskTotalReadMbps, fcTotalWriteIops=fcTotalWriteIops, poolDataReadMbps=poolDataReadMbps, iscsiImproperTargetGroup=iscsiImproperTargetGroup, volumeDeleteFailed=volumeDeleteFailed, nvdimmFailSoftError=nvdimmFailSoftError, shareIndex=shareIndex, poolMetaReadLatency=poolMetaReadLatency, properties=properties, poolUsedSizeHigh=poolUsedSizeHigh, shareExceedThresholdWarning=shareExceedThresholdWarning, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, cpuInterrupts=cpuInterrupts, lunFreeSizeLow=lunFreeSizeLow, haResourceStatus=haResourceStatus, smisServiceStartFailed=smisServiceStartFailed, shareCIFSReadIops=shareCIFSReadIops, iscsiInitiatorName=iscsiInitiatorName, nfsTotalReadIops=nfsTotalReadIops, upgradeCompleted=upgradeCompleted, shareMountPoint=shareMountPoint, nicEntry=nicEntry, fcAvgReadLatency=fcAvgReadLatency, cacheSSDReads=cacheSSDReads, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, projectEntry=projectEntry, fcTargetWriteLatency=fcTargetWriteLatency, snapshotRollbackFailed=snapshotRollbackFailed, poolTotalWriteMbps=poolTotalWriteMbps, sanProperties=sanProperties, iscsiTargetReadLatency=iscsiTargetReadLatency, poolDeleted=poolDeleted, replicationSourceRegistered=replicationSourceRegistered, webdocsUpgradeCompleted=webdocsUpgradeCompleted, networkIpmpGroupDown=networkIpmpGroupDown, poolSizeHigh=poolSizeHigh, initiatorGroupMemberAdded=initiatorGroupMemberAdded, cifsAvgReadLatency=cifsAvgReadLatency, haControllerB_IPAddr=haControllerB_IPAddr, iscsiInitiators=iscsiInitiators, cifsTotalReadMbps=cifsTotalReadMbps, networkTotalReceiveMbps=networkTotalReceiveMbps, nvdimmFailDeviceError=nvdimmFailDeviceError, poolState=poolState, tegileArray=tegileArray, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, shareNFSReadIops=shareNFSReadIops, intelliFlashSoftwareDown=intelliFlashSoftwareDown, cpuTotalUsage=cpuTotalUsage, diskError=diskError, upgradeDownloadCompleted=upgradeDownloadCompleted, snmpServiceStopFailed=snmpServiceStopFailed, snmpAgentVersion=snmpAgentVersion, notificationProps=notificationProps, cifsTotalWriteMbps=cifsTotalWriteMbps, ipmiPowerSupply=ipmiPowerSupply, lunBlockSize=lunBlockSize, tdpsUpgradeTimeout=tdpsUpgradeTimeout, poolSizeLow=poolSizeLow, memoryFailure=memoryFailure, shareCIFSReadLatency=shareCIFSReadLatency, poolReadCacheWriteMbps=poolReadCacheWriteMbps, shareQuotaLow=shareQuotaLow, fcTargetReadLatency=fcTargetReadLatency, poolReadCacheReadLatency=poolReadCacheReadLatency, volumeDeleteCompleted=volumeDeleteCompleted, projectCreatedSuccessfully=projectCreatedSuccessfully, deleteFolderFailed=deleteFolderFailed, pools=pools, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, nvdimmFailUnknownError=nvdimmFailUnknownError, lunReadLatency=lunReadLatency, volumeCreatedSuccessfully=volumeCreatedSuccessfully, poolDataSizeLow=poolDataSizeLow, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, nicState=nicState, basicCompliance=basicCompliance, poolFreeSizeLow=poolFreeSizeLow, poolDataReadLatency=poolDataReadLatency, projectDataSizeHigh=projectDataSizeHigh, projectPoolName=projectPoolName, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, ntpServerTimeDrift=ntpServerTimeDrift, ipmiTemperature=ipmiTemperature, targetGroupCreateCompleted=targetGroupCreateCompleted, projectDataSizeLow=projectDataSizeLow, aclMigrationStarted=aclMigrationStarted, poolDataWriteMbps=poolDataWriteMbps, iscsiTotalReadIops=iscsiTotalReadIops, poolCount=poolCount, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, poolDataWriteLatency=poolDataWriteLatency, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, deleteFolderCompleted=deleteFolderCompleted, nicTransmitMbps=nicTransmitMbps, snmpServiceStopped=snmpServiceStopped, snapshotRollbackCompleted=snapshotRollbackCompleted, shareNFSEnabled=shareNFSEnabled, projectDeletionFailed=projectDeletionFailed, iscsiTotalReadMbps=iscsiTotalReadMbps, poolIndex=poolIndex, vmwareNFSDatastores=vmwareNFSDatastores, sharePoolName=sharePoolName, poolDeletionFailed=poolDeletionFailed, lunCompressedRatio=lunCompressedRatio, projectQuotaFinished=projectQuotaFinished, shareNFSWriteIops=shareNFSWriteIops, replicationFailed=replicationFailed, networkTotalTransmitMbps=networkTotalTransmitMbps, poolDataReadIops=poolDataReadIops, notifications=notifications, notificationTargetEntityName=notificationTargetEntityName, diskSlowIo=diskSlowIo, lunWriteLatency=lunWriteLatency, fcInitiators=fcInitiators, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, lunDataSizeHigh=lunDataSizeHigh, diskSequentialIOCount=diskSequentialIOCount, fcTargetName=fcTargetName, notificationSensorAction=notificationSensorAction, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, fcAvgWriteLatency=fcAvgWriteLatency, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, poolTotalSaving=poolTotalSaving, projectCompressionEnabled=projectCompressionEnabled, tegileGroups=tegileGroups, lunIndex=lunIndex, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, notificationEventCode=notificationEventCode, projectDeleted=projectDeleted, tdpsUpgradeCompleted=tdpsUpgradeCompleted, tegile=tegile, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, cifsTotalReadIops=cifsTotalReadIops, fcInitiatorIndex=fcInitiatorIndex, snapshotCloneCompleted=snapshotCloneCompleted, replicationComplete=replicationComplete, fcTargetEntry=fcTargetEntry, fcTargets=fcTargets, fcTargetGroup=fcTargetGroup, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, poolMetaReadMbps=poolMetaReadMbps, fcTargetWriteIops=fcTargetWriteIops, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, diskAvgReadLatency=diskAvgReadLatency, iscsiTargetAlias=iscsiTargetAlias, iscsiTargetWriteMbps=iscsiTargetWriteMbps, shareCIFSEnabled=shareCIFSEnabled, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, poolEntry=poolEntry, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, lunProjectName=lunProjectName, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, shareTable=shareTable, replicationPaused=replicationPaused, PYSNMP_MODULE_ID=tegile, iscsiTargetEntry=iscsiTargetEntry, diskChassisIdx=diskChassisIdx, notificationDescription=notificationDescription, notificationTime=notificationTime, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, ipmiCurrent=ipmiCurrent, cifsAvgWriteLatency=cifsAvgWriteLatency, iscsiAvgWriteLatency=iscsiAvgWriteLatency, shareCIFSWriteLatency=shareCIFSWriteLatency, lunReservedSizeLow=lunReservedSizeLow, diskCount=diskCount, projectQuotaSizeHigh=projectQuotaSizeHigh)
