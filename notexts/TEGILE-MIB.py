...
# Produced by pysmi-1.1.8 at Thu Apr 27 10:44:32 2023
...
ModuleIdentity, iso, Counter32, TimeTicks, ObjectIdentity, NotificationType, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, Counter64, Gauge32, MibIdentifier, IpAddress, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "Counter32", "TimeTicks", "ObjectIdentity", "NotificationType", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "Counter64", "Gauge32", "MibIdentifier", "IpAddress", "enterprises")
...
mibBuilder.exportSymbols("TEGILE-MIB", fcTargetWriteMbps=fcTargetWriteMbps, vmwareNFSDatastores=vmwareNFSDatastores, shareSnapshotSizeLow=shareSnapshotSizeLow, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, snmpServiceStarted=snmpServiceStarted, ipmiOther=ipmiOther, projectLunCount=projectLunCount, poolTotalWriteIops=poolTotalWriteIops, iscsiTargetReadIops=iscsiTargetReadIops, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, tegileArray=tegileArray, projectIndex=projectIndex, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, snmpServiceStartFailed=snmpServiceStartFailed, poolTotalReadMbps=poolTotalReadMbps, lunFreeSizeLow=lunFreeSizeLow, shareReservedSizeLow=shareReservedSizeLow, fcPortOffline=fcPortOffline, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, lunWriteMbps=lunWriteMbps, shareReservedSizeHigh=shareReservedSizeHigh, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, notificationSensorNumber=notificationSensorNumber, poolState=poolState, nfsTotalReadMbps=nfsTotalReadMbps, fcTargetWriteLatency=fcTargetWriteLatency, fcTargetEntry=fcTargetEntry, iscsiTargetEntry=iscsiTargetEntry, fcTargetIndex=fcTargetIndex, poolAvgWriteLatency=poolAvgWriteLatency, nfsTotalWriteIops=nfsTotalWriteIops, nicMTU=nicMTU, poolCreated=poolCreated, nicState=nicState, replicationStarted=replicationStarted, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, haControllerA_IPAddr=haControllerA_IPAddr, poolTable=poolTable, diskRandomIOCount=diskRandomIOCount, poolDeletionFailed=poolDeletionFailed, shareQuotaFinished=shareQuotaFinished, haResources=haResources, haControllerA_Name=haControllerA_Name, shareQuotaLow=shareQuotaLow, lunFreeSizeHigh=lunFreeSizeHigh, sharePoolName=sharePoolName, snmpServiceStopped=snmpServiceStopped, notificationSensorAction=notificationSensorAction, shareExceedThresholdWarning=shareExceedThresholdWarning, lunPoolName=lunPoolName, smisServiceStarted=smisServiceStarted, poolMetaReadMbps=poolMetaReadMbps, fcAvgReadLatency=fcAvgReadLatency, lunReadLatency=lunReadLatency, diskAvgWriteLatency=diskAvgWriteLatency, ipmiFan=ipmiFan, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, fcTargetReadIops=fcTargetReadIops, cacheTotalReadIops=cacheTotalReadIops, fcTargetStatus=fcTargetStatus, haResourceStatus=haResourceStatus, haResourceName=haResourceName, notificationThresholdTriggerValue=notificationThresholdTriggerValue, iscsiTargetReadLatency=iscsiTargetReadLatency, notificationDescription=notificationDescription, lunCompressionEnabled=lunCompressionEnabled, sensorFailureEvent=sensorFailureEvent, tegileCompliances=tegileCompliances, notificationComponentName=notificationComponentName, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, projectPoolName=projectPoolName, lunProjectName=lunProjectName, shareNFSWriteLatency=shareNFSWriteLatency, shareNFSReadLatency=shareNFSReadLatency, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, cifsTotalReadIops=cifsTotalReadIops, maintenanceModeDisabled=maintenanceModeDisabled, lunSnapshotSizeHigh=lunSnapshotSizeHigh, diskSlowIo=diskSlowIo, poolFreeSizeLow=poolFreeSizeLow, iscsiImproperTargetGroup=iscsiImproperTargetGroup, lunInitiatorGroup=lunInitiatorGroup, initiatorGroupMemberAdded=initiatorGroupMemberAdded, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, iscsiTargetGroupError=iscsiTargetGroupError, iscsiTargetReadMbps=iscsiTargetReadMbps, networkTotalReceiveMbps=networkTotalReceiveMbps, iscsiTotalWriteMbps=iscsiTotalWriteMbps, haControllerB_Uptime=haControllerB_Uptime, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, cifsTotalReadMbps=cifsTotalReadMbps, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, snapshotRollbackFailed=snapshotRollbackFailed, alertsCleanupCompleted=alertsCleanupCompleted, diskSizeLow=diskSizeLow, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, nicIndex=nicIndex, shareTable=shareTable, cacheTotalReadMbps=cacheTotalReadMbps, shareCIFSWriteMbps=shareCIFSWriteMbps, fcTotalReadIops=fcTotalReadIops, projectShares=projectShares, diskTotalWriteIops=diskTotalWriteIops, currentNotificationGroup=currentNotificationGroup, poolSizeHigh=poolSizeHigh, shareNFSEnabled=shareNFSEnabled, poolDataWriteIops=poolDataWriteIops, spareDiskReplaced=spareDiskReplaced, poolQuotaFinished=poolQuotaFinished, nicGroup=nicGroup, notificationEventCode=notificationEventCode, sanProperties=sanProperties, iscsiInitiatorChapUser=iscsiInitiatorChapUser, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, diskPoolName=diskPoolName, poolTotalReadIops=poolTotalReadIops, unknownSensorEvent=unknownSensorEvent, currentObjectGroup=currentObjectGroup, controllerHardwareModel=controllerHardwareModel, smisServiceStopFailed=smisServiceStopFailed, diskEntry=diskEntry, lunSizeLow=lunSizeLow, poolSizeLow=poolSizeLow, poolDegraded=poolDegraded, nvdimmFailSoftError=nvdimmFailSoftError, haControllerB_IPAddr=haControllerB_IPAddr, shareCIFSReadLatency=shareCIFSReadLatency, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, diskDataReadIops=diskDataReadIops, lunDataSizeLow=lunDataSizeLow, diskGoneOffline=diskGoneOffline, iscsiTargetName=iscsiTargetName, projectDeletionFailed=projectDeletionFailed, disks=disks, diskTotalReadIops=diskTotalReadIops, projectDeleted=projectDeleted, cacheRAMReads=cacheRAMReads, nicReceiveMbps=nicReceiveMbps, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, diskChassisIdx=diskChassisIdx, smbSocketFailure=smbSocketFailure, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, shareCompressedRatio=shareCompressedRatio, projectThresholdExceedWarning=projectThresholdExceedWarning, iscsiInitiatorGroup=iscsiInitiatorGroup, iscsiTargetAuth=iscsiTargetAuth, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, fcTargetReadMbps=fcTargetReadMbps, notificationTargetEntityName=notificationTargetEntityName, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, shareNFSWriteMbps=shareNFSWriteMbps, poolDeleted=poolDeleted, iscsiTotalReadMbps=iscsiTotalReadMbps, cifsTotalWriteIops=cifsTotalWriteIops, projectDedupEnabled=projectDedupEnabled, fcInitiatorIndex=fcInitiatorIndex, lunGUID=lunGUID, maintenanceModeEnabled=maintenanceModeEnabled, projectFreeSizeHigh=projectFreeSizeHigh, cifsAvgReadLatency=cifsAvgReadLatency, volumeDeleteFailed=volumeDeleteFailed, projectSnapshotSizeLow=projectSnapshotSizeLow, snapshotDeleteFailed=snapshotDeleteFailed, nvdimmFailInitializationError=nvdimmFailInitializationError, diskIsOnline=diskIsOnline, networkTotalTransmitMbps=networkTotalTransmitMbps, lunCompressedRatio=lunCompressedRatio, fcInitiatorGroup=fcInitiatorGroup, poolProjectCount=poolProjectCount, fcTotalReadMbps=fcTotalReadMbps, poolReadCacheWriteLatency=poolReadCacheWriteLatency, projectQuotaFinished=projectQuotaFinished, diskSizeHigh=diskSizeHigh, iscsiInitiatorName=iscsiInitiatorName, aclMigrationStarted=aclMigrationStarted, poolOwnerController=poolOwnerController, iscsiTargets=iscsiTargets, lunSizeHigh=lunSizeHigh, poolMetaReadIops=poolMetaReadIops, ipmiTemperature=ipmiTemperature, shareDedupEnabled=shareDedupEnabled, shareProjectName=shareProjectName, nfsTotalReadIops=nfsTotalReadIops, poolUsedSizeLow=poolUsedSizeLow, fcProperties=fcProperties, lunTargetGroup=lunTargetGroup, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, cacheTotalWriteIops=cacheTotalWriteIops, projectShareCount=projectShareCount, haResourceActiveNode=haResourceActiveNode, lunName=lunName, diskDataWriteMbps=diskDataWriteMbps, nfsAvgReadLatency=nfsAvgReadLatency, shareQuotaHigh=shareQuotaHigh, projectDataSizeHigh=projectDataSizeHigh, iscsiTargetError=iscsiTargetError, poolDataSizeHigh=poolDataSizeHigh, notificationObjects=notificationObjects, iscsiProperties=iscsiProperties, projectTotalSaving=projectTotalSaving, iscsiTargetWriteMbps=iscsiTargetWriteMbps, haResourceEntry=haResourceEntry, poolUpgraded=poolUpgraded, iscsiAvgWriteLatency=iscsiAvgWriteLatency, poolDataReadMbps=poolDataReadMbps, projectCreatedSuccessfully=projectCreatedSuccessfully, notificationReadingTriggerValue=notificationReadingTriggerValue, smisServiceStartFailed=smisServiceStartFailed, lunEntry=lunEntry, lunReadIops=lunReadIops, projectEntry=projectEntry, tdpsUpgradeTimeout=tdpsUpgradeTimeout, fcPortOnline=fcPortOnline, deleteFolderCompleted=deleteFolderCompleted, nfsAvgWriteLatency=nfsAvgWriteLatency, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, testNotification=testNotification, projectName=projectName, basicCompliance=basicCompliance, replicationSourceRegistered=replicationSourceRegistered, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, shareEntry=shareEntry, memoryFailure=memoryFailure, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, snapshotCloningFailed=snapshotCloningFailed, projectSnapshotSizeHigh=projectSnapshotSizeHigh, nfsTotalWriteMbps=nfsTotalWriteMbps, fcInitiatorName=fcInitiatorName, poolIndex=poolIndex, fcTargetsTable=fcTargetsTable, poolImported=poolImported, poolTotalWriteMbps=poolTotalWriteMbps, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, iscsiTotalReadIops=iscsiTotalReadIops, diskCount=diskCount, networkIpmpGroupUp=networkIpmpGroupUp, shareNFSReadMbps=shareNFSReadMbps, diskDataWriteIops=diskDataWriteIops, diskTotalWriteMbps=diskTotalWriteMbps, shareCIFSEnabled=shareCIFSEnabled, fcInitiatorEntry=fcInitiatorEntry, snapshotRollbackCompleted=snapshotRollbackCompleted, ipmiVoltage=ipmiVoltage, ipmiCriticalInterrupt=ipmiCriticalInterrupt, ntpServerTimeDrift=ntpServerTimeDrift, lunIndex=lunIndex, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, network=network)
mibBuilder.exportSymbols("TEGILE-MIB", poolDataReadIops=poolDataReadIops, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, smisServiceStopped=smisServiceStopped, snmpServiceStopFailed=snmpServiceStopFailed, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, deleteFolderFailed=deleteFolderFailed, cifsTotalWriteMbps=cifsTotalWriteMbps, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, upgradeTimeout=upgradeTimeout, upgradeDownloadFailed=upgradeDownloadFailed, poolMetaWriteIops=poolMetaWriteIops, poolReadCacheReadMbps=poolReadCacheReadMbps, nicEntry=nicEntry, ipmiPowerSupply=ipmiPowerSupply, notifications=notifications, iscsiTargetGroup=iscsiTargetGroup, fcTargetModifyCompleted=fcTargetModifyCompleted, ipmiMemory=ipmiMemory, controllerUp=controllerUp, properties=properties, adServerTimeDrift=adServerTimeDrift, shareDeleted=shareDeleted, lunTable=lunTable, snapshotCreationFailed=snapshotCreationFailed, tegileConformance=tegileConformance, fcTargetName=fcTargetName, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, iscsiInitiatorEntry=iscsiInitiatorEntry, lunSnapshotSizeLow=lunSnapshotSizeLow, poolTotalSaving=poolTotalSaving, shareDataSizeLow=shareDataSizeLow, cpuSystemCalls=cpuSystemCalls, haControllerB_Name=haControllerB_Name, haResourceIndex=haResourceIndex, targetGroupDeleteCompleted=targetGroupDeleteCompleted, webdocsUpgradeFailed=webdocsUpgradeFailed, volumeDeleteCompleted=volumeDeleteCompleted, aclMigrationCompleted=aclMigrationCompleted, iscsiTargetAlias=iscsiTargetAlias, shareCreatedSuccessfully=shareCreatedSuccessfully, cacheSSDReads=cacheSSDReads, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, snmpAgentVersion=snmpAgentVersion, iscsiTargetWriteIops=iscsiTargetWriteIops, tegileGroups=tegileGroups, poolReadCacheReadLatency=poolReadCacheReadLatency, projectTable=projectTable, shareName=shareName, diskState=diskState, targetGroupMemberAdded=targetGroupMemberAdded, cpuInterrupts=cpuInterrupts, upgradeDownloadStarted=upgradeDownloadStarted, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, notificationReadingUnit=notificationReadingUnit, volumeModifyCompleted=volumeModifyCompleted, diskTable=diskTable, shareSnapshotSizeHigh=shareSnapshotSizeHigh, replicationResumed=replicationResumed, poolReadCacheWriteIops=poolReadCacheWriteIops, poolName=poolName, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, fcTotalWriteIops=fcTotalWriteIops, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, projectQuotaSizeLow=projectQuotaSizeLow, lunReadMbps=lunReadMbps, controllerTimeDrift=controllerTimeDrift, tdpsUpgradeCompleted=tdpsUpgradeCompleted, notificationSeverity=notificationSeverity, poolMetaWriteMbps=poolMetaWriteMbps, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, userLoginFailed=userLoginFailed, fcInitiatorsTable=fcInitiatorsTable, lunProtocol=lunProtocol, poolMetaReadLatency=poolMetaReadLatency, fcTotalWriteMbps=fcTotalWriteMbps, snapshotCloneCompleted=snapshotCloneCompleted, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, intelliFlashSoftwareDown=intelliFlashSoftwareDown, ipmiThreshold=ipmiThreshold, replicationTargetDeleted=replicationTargetDeleted, cifsAvgWriteLatency=cifsAvgWriteLatency, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, projectLUNs=projectLUNs, poolEntry=poolEntry, shareIndex=shareIndex, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, fcTargets=fcTargets, pools=pools, projectModified=projectModified, diskError=diskError, diskIndex=diskIndex, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, nvdimmFailUnknownError=nvdimmFailUnknownError, poolWriteCacheWriteIops=poolWriteCacheWriteIops, poolExported=poolExported, tdpsUpgradeFailed=tdpsUpgradeFailed, nvdimmFailDeviceError=nvdimmFailDeviceError, lunDedupEnabled=lunDedupEnabled, iscsiAvgReadLatency=iscsiAvgReadLatency, lunReservedSizeHigh=lunReservedSizeHigh, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, diskType=diskType, haResourcesTable=haResourcesTable, notificationProps=notificationProps, webdocsUpgradeCompleted=webdocsUpgradeCompleted, replicationFailed=replicationFailed, nicTable=nicTable, networkIpmpGroupDown=networkIpmpGroupDown, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, diskSequentialIOCount=diskSequentialIOCount, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, iscsiTargetIndex=iscsiTargetIndex, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, haControllerA_Uptime=haControllerA_Uptime, poolHealth=poolHealth, poolProjects=poolProjects, iscsiWriteIops=iscsiWriteIops, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, poolCount=poolCount, diskTotalReadMbps=diskTotalReadMbps, cpuTotalUsage=cpuTotalUsage, upgradeStarted=upgradeStarted, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, shareCompressionEnabled=shareCompressionEnabled, lunBlockSize=lunBlockSize, poolDataWriteMbps=poolDataWriteMbps, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, volumeQuotaFinished=volumeQuotaFinished, iscsiTargetWriteLatency=iscsiTargetWriteLatency, poolReadCacheReadIops=poolReadCacheReadIops, nicTransmitMbps=nicTransmitMbps, replicationAborted=replicationAborted, diskDataReadMbps=diskDataReadMbps, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, poolFreeSizeHigh=poolFreeSizeHigh, notificationTime=notificationTime, fcTargetGroup=fcTargetGroup, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, lunWriteIops=lunWriteIops, targetGroupMemberRemoved=targetGroupMemberRemoved, lunReservedSizeLow=lunReservedSizeLow, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, controllerDown=controllerDown, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, lunWriteLatency=lunWriteLatency, upgradeCompleted=upgradeCompleted, iscsiInitiatorsTable=iscsiInitiatorsTable, shareCIFSReadIops=shareCIFSReadIops, poolExpanded=poolExpanded, notificationSensorSuspect=notificationSensorSuspect, shareDataSizeHigh=shareDataSizeHigh, shareMountPoint=shareMountPoint, netbiosSocketFailure=netbiosSocketFailure, shareCIFSWriteIops=shareCIFSWriteIops, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, replicationComplete=replicationComplete, projectFreeSizeLow=projectFreeSizeLow, shareDeletionFailed=shareDeletionFailed, ipmiCurrent=ipmiCurrent, fcTargetReadLatency=fcTargetReadLatency, networkInterfaceUp=networkInterfaceUp, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, shareCIFSReadMbps=shareCIFSReadMbps, PYSNMP_MODULE_ID=tegile, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, poolDataWriteLatency=poolDataWriteLatency, globalStatistics=globalStatistics, projectQuotaSizeHigh=projectQuotaSizeHigh, iscsiInitiatorIndex=iscsiInitiatorIndex, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, poolReadCacheWriteMbps=poolReadCacheWriteMbps, projectCompressionEnabled=projectCompressionEnabled, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, poolDataSizeLow=poolDataSizeLow, shareCIFSWriteLatency=shareCIFSWriteLatency, poolDataReadLatency=poolDataReadLatency, fcInitiatorCreateFailed=fcInitiatorCreateFailed, replicationPaused=replicationPaused, tegile=tegile, poolUsedSizeHigh=poolUsedSizeHigh, fcAvgWriteLatency=fcAvgWriteLatency, fcTargetWriteIops=fcTargetWriteIops, projectDataSizeLow=projectDataSizeLow, upgradeDownloadCompleted=upgradeDownloadCompleted, iscsiTargetsTable=iscsiTargetsTable, nicName=nicName, replicationAbandoned=replicationAbandoned, volumeCreatedSuccessfully=volumeCreatedSuccessfully, diagnosticDataUploaded=diagnosticDataUploaded, fcInitiators=fcInitiators, shareNFSReadIops=shareNFSReadIops, haResourceDescription=haResourceDescription, intelliFlashSoftwareUp=intelliFlashSoftwareUp, tegileArray_notifications=tegileArray_notifications, haResourceGroup=haResourceGroup, poolAvgReadLatency=poolAvgReadLatency, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, diskIOCount=diskIOCount, shareNFSWriteIops=shareNFSWriteIops, lunDataSizeHigh=lunDataSizeHigh, networkInterfaceDown=networkInterfaceDown, cacheTotalWriteMbps=cacheTotalWriteMbps, poolMetaWriteLatency=poolMetaWriteLatency, targetGroupCreateCompleted=targetGroupCreateCompleted, iscsiInitiators=iscsiInitiators, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, upgradeFailed=upgradeFailed, diskAvgReadLatency=diskAvgReadLatency, diskAlias=diskAlias)
