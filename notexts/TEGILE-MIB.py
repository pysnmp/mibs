...
Integer32, enterprises, Counter32, IpAddress, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, TimeTicks, iso, NotificationType, MibIdentifier, Bits, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "enterprises", "Counter32", "IpAddress", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "TimeTicks", "iso", "NotificationType", "MibIdentifier", "Bits", "Counter64")
...
mibBuilder.exportSymbols("TEGILE-MIB", ipmiOther=ipmiOther, netbiosSocketFailure=netbiosSocketFailure, fcInitiatorsTable=fcInitiatorsTable, lunFreeSizeLow=lunFreeSizeLow, notificationSeverity=notificationSeverity, PYSNMP_MODULE_ID=tegile, haResources=haResources, lunReservedSizeHigh=lunReservedSizeHigh, haResourceActiveNode=haResourceActiveNode, notificationComponentName=notificationComponentName, controllerTimeDrift=controllerTimeDrift, maintenanceModeDisabled=maintenanceModeDisabled, ipmiFan=ipmiFan, shareCIFSReadIops=shareCIFSReadIops, poolFreeSizeHigh=poolFreeSizeHigh, projectFreeSizeHigh=projectFreeSizeHigh, notifications=notifications, upgradeCompleted=upgradeCompleted, snapshotDeleteFailed=snapshotDeleteFailed, iscsiInitiatorName=iscsiInitiatorName, projectPoolName=projectPoolName, cacheTotalWriteMbps=cacheTotalWriteMbps, nfsTotalReadIops=nfsTotalReadIops, networkIpmpGroupUp=networkIpmpGroupUp, iscsiTargetsTable=iscsiTargetsTable, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, snapshotCloningFailed=snapshotCloningFailed, projectDedupEnabled=projectDedupEnabled, shareNFSWriteIops=shareNFSWriteIops, iscsiTargetGroupError=iscsiTargetGroupError, userLoginFailed=userLoginFailed, lunProtocol=lunProtocol, fcTargetWriteLatency=fcTargetWriteLatency, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, ipmiThreshold=ipmiThreshold, projectDataSizeHigh=projectDataSizeHigh, cifsTotalWriteIops=cifsTotalWriteIops, shareQuotaLow=shareQuotaLow, snmpServiceStartFailed=snmpServiceStartFailed, diskChassisIdx=diskChassisIdx, lunSnapshotSizeLow=lunSnapshotSizeLow, nfsAvgReadLatency=nfsAvgReadLatency, networkIpmpGroupDown=networkIpmpGroupDown, iscsiTargets=iscsiTargets, diskIndex=diskIndex, intelliFlashSoftwareDown=intelliFlashSoftwareDown, replicationSourceRegistered=replicationSourceRegistered, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, diskTotalWriteMbps=diskTotalWriteMbps, haControllerB_Uptime=haControllerB_Uptime, snmpServiceStopFailed=snmpServiceStopFailed, poolMetaReadLatency=poolMetaReadLatency, volumeModifyCompleted=volumeModifyCompleted, diskSlowIo=diskSlowIo, notificationSensorAction=notificationSensorAction, currentObjectGroup=currentObjectGroup, poolUpgraded=poolUpgraded, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, projectDeleted=projectDeleted, poolIndex=poolIndex, diskTotalReadMbps=diskTotalReadMbps, fcTotalWriteMbps=fcTotalWriteMbps, controllerDown=controllerDown, poolSizeHigh=poolSizeHigh, poolCount=poolCount, iscsiTargetName=iscsiTargetName, ipmiCurrent=ipmiCurrent, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, shareQuotaFinished=shareQuotaFinished, diskCount=diskCount, diskSizeLow=diskSizeLow, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, notificationSensorSuspect=notificationSensorSuspect, networkTotalTransmitMbps=networkTotalTransmitMbps, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, fcTotalReadIops=fcTotalReadIops, poolDataReadMbps=poolDataReadMbps, shareSnapshotSizeHigh=shareSnapshotSizeHigh, ipmiVoltage=ipmiVoltage, controllerHardwareModel=controllerHardwareModel, networkInterfaceUp=networkInterfaceUp, diskDataWriteMbps=diskDataWriteMbps, shareNFSReadMbps=shareNFSReadMbps, poolHealth=poolHealth, haControllerB_Name=haControllerB_Name, lunPoolName=lunPoolName, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, nicReceiveMbps=nicReceiveMbps, haResourceIndex=haResourceIndex, sanProperties=sanProperties, poolReadCacheReadIops=poolReadCacheReadIops, notificationTime=notificationTime, cacheTotalReadIops=cacheTotalReadIops, fcTargetEntry=fcTargetEntry, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, iscsiAvgReadLatency=iscsiAvgReadLatency, poolAvgReadLatency=poolAvgReadLatency, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, ntpServerTimeDrift=ntpServerTimeDrift, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, iscsiTargetAuth=iscsiTargetAuth, haResourceGroup=haResourceGroup, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, projectDeletionFailed=projectDeletionFailed, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, poolSizeLow=poolSizeLow, fcTargetReadLatency=fcTargetReadLatency, poolImported=poolImported, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, haControllerB_IPAddr=haControllerB_IPAddr, lunTargetGroup=lunTargetGroup, snmpServiceStarted=snmpServiceStarted, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, ipmiTemperature=ipmiTemperature, haResourceStatus=haResourceStatus, volumeDeleteCompleted=volumeDeleteCompleted, maintenanceModeEnabled=maintenanceModeEnabled, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, lunTable=lunTable, notificationReadingTriggerValue=notificationReadingTriggerValue, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, shareCIFSWriteLatency=shareCIFSWriteLatency, memoryFailure=memoryFailure, projectTotalSaving=projectTotalSaving, poolReadCacheReadMbps=poolReadCacheReadMbps, fcTotalWriteIops=fcTotalWriteIops, poolCreated=poolCreated, tegile=tegile, iscsiTargetReadMbps=iscsiTargetReadMbps, notificationEventCode=notificationEventCode, haControllerA_Name=haControllerA_Name, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, haResourcesTable=haResourcesTable, snapshotRollbackFailed=snapshotRollbackFailed, iscsiInitiatorEntry=iscsiInitiatorEntry, projectQuotaSizeLow=projectQuotaSizeLow, projectSnapshotSizeHigh=projectSnapshotSizeHigh, aclMigrationCompleted=aclMigrationCompleted, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, haControllerA_IPAddr=haControllerA_IPAddr, upgradeTimeout=upgradeTimeout, cacheTotalReadMbps=cacheTotalReadMbps, spareDiskReplaced=spareDiskReplaced, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, lunDataSizeHigh=lunDataSizeHigh, poolAvgWriteLatency=poolAvgWriteLatency, projectShareCount=projectShareCount, poolMetaWriteLatency=poolMetaWriteLatency, lunSnapshotSizeHigh=lunSnapshotSizeHigh, fcAvgWriteLatency=fcAvgWriteLatency, notificationObjects=notificationObjects, iscsiTargetAlias=iscsiTargetAlias, poolMetaWriteMbps=poolMetaWriteMbps, poolTotalWriteIops=poolTotalWriteIops, poolProjectCount=poolProjectCount, lunCompressedRatio=lunCompressedRatio, poolReadCacheWriteMbps=poolReadCacheWriteMbps, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, diskDataReadMbps=diskDataReadMbps, notificationReadingUnit=notificationReadingUnit, diskAvgReadLatency=diskAvgReadLatency, iscsiInitiatorIndex=iscsiInitiatorIndex, fcTargetWriteMbps=fcTargetWriteMbps, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, poolMetaWriteIops=poolMetaWriteIops, tegileCompliances=tegileCompliances, nfsAvgWriteLatency=nfsAvgWriteLatency, lunGUID=lunGUID, poolDataSizeHigh=poolDataSizeHigh, shareCIFSWriteIops=shareCIFSWriteIops, shareTable=shareTable, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, poolMetaReadMbps=poolMetaReadMbps, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, controllerUp=controllerUp, poolFreeSizeLow=poolFreeSizeLow, diskDataWriteIops=diskDataWriteIops, targetGroupDeleteCompleted=targetGroupDeleteCompleted, nicTable=nicTable, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, cpuTotalUsage=cpuTotalUsage, lunEntry=lunEntry, projectCreatedSuccessfully=projectCreatedSuccessfully, iscsiTotalReadMbps=iscsiTotalReadMbps, poolOwnerController=poolOwnerController, fcInitiatorName=fcInitiatorName, smisServiceStopFailed=smisServiceStopFailed, tegileArray_notifications=tegileArray_notifications, diskAlias=diskAlias, nicTransmitMbps=nicTransmitMbps, fcTargetGroup=fcTargetGroup, replicationPaused=replicationPaused, projectIndex=projectIndex, networkTotalReceiveMbps=networkTotalReceiveMbps, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, iscsiAvgWriteLatency=iscsiAvgWriteLatency, lunWriteLatency=lunWriteLatency, nfsTotalReadMbps=nfsTotalReadMbps, targetGroupMemberRemoved=targetGroupMemberRemoved, volumeDeleteFailed=volumeDeleteFailed, cacheRAMReads=cacheRAMReads, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, lunFreeSizeHigh=lunFreeSizeHigh, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, poolQuotaFinished=poolQuotaFinished, poolUsedSizeLow=poolUsedSizeLow, initiatorGroupMemberAdded=initiatorGroupMemberAdded, tdpsUpgradeTimeout=tdpsUpgradeTimeout, shareCompressionEnabled=shareCompressionEnabled, iscsiInitiators=iscsiInitiators, nvdimmFailDeviceError=nvdimmFailDeviceError, lunSizeLow=lunSizeLow, fcPortOnline=fcPortOnline, deleteFolderCompleted=deleteFolderCompleted, projectSnapshotSizeLow=projectSnapshotSizeLow, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, snapshotCloneCompleted=snapshotCloneCompleted, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, replicationStarted=replicationStarted, snmpServiceStopped=snmpServiceStopped, ipmiMemory=ipmiMemory, shareNFSWriteLatency=shareNFSWriteLatency, projectLunCount=projectLunCount, replicationComplete=replicationComplete, shareCIFSReadMbps=shareCIFSReadMbps, replicationAborted=replicationAborted, diskPoolName=diskPoolName, ipmiCriticalInterrupt=ipmiCriticalInterrupt, poolName=poolName, nvdimmFailSoftError=nvdimmFailSoftError, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, lunIndex=lunIndex, iscsiTargetWriteMbps=iscsiTargetWriteMbps, shareIndex=shareIndex, shareSnapshotSizeLow=shareSnapshotSizeLow, shareCIFSEnabled=shareCIFSEnabled, snmpAgentVersion=snmpAgentVersion, shareNFSReadIops=shareNFSReadIops, shareDedupEnabled=shareDedupEnabled, iscsiProperties=iscsiProperties, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, poolWriteCacheWriteIops=poolWriteCacheWriteIops, shareCIFSReadLatency=shareCIFSReadLatency, iscsiTargetReadLatency=iscsiTargetReadLatency, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, poolDataReadLatency=poolDataReadLatency, testNotification=testNotification)
mibBuilder.exportSymbols("TEGILE-MIB", notificationTargetEntityName=notificationTargetEntityName, projectShares=projectShares, lunInitiatorGroup=lunInitiatorGroup, nicName=nicName, aclMigrationStarted=aclMigrationStarted, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, fcInitiatorGroup=fcInitiatorGroup, replicationTargetDeleted=replicationTargetDeleted, shareNFSReadLatency=shareNFSReadLatency, fcInitiatorEntry=fcInitiatorEntry, upgradeDownloadStarted=upgradeDownloadStarted, unknownSensorEvent=unknownSensorEvent, fcTargetName=fcTargetName, ipmiPowerSupply=ipmiPowerSupply, targetGroupCreateCompleted=targetGroupCreateCompleted, alertsCleanupCompleted=alertsCleanupCompleted, projectLUNs=projectLUNs, shareDeletionFailed=shareDeletionFailed, iscsiTotalReadIops=iscsiTotalReadIops, diskError=diskError, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, sensorFailureEvent=sensorFailureEvent, vmwareNFSDatastores=vmwareNFSDatastores, iscsiTargetWriteLatency=iscsiTargetWriteLatency, projectQuotaSizeHigh=projectQuotaSizeHigh, smisServiceStarted=smisServiceStarted, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, projectModified=projectModified, haResourceDescription=haResourceDescription, cifsTotalReadIops=cifsTotalReadIops, networkInterfaceDown=networkInterfaceDown, snapshotCreationFailed=snapshotCreationFailed, shareEntry=shareEntry, fcTotalReadMbps=fcTotalReadMbps, poolReadCacheReadLatency=poolReadCacheReadLatency, poolDataWriteIops=poolDataWriteIops, haResourceEntry=haResourceEntry, poolReadCacheWriteIops=poolReadCacheWriteIops, projectEntry=projectEntry, fcTargetStatus=fcTargetStatus, fcPortOffline=fcPortOffline, replicationResumed=replicationResumed, cifsAvgWriteLatency=cifsAvgWriteLatency, projectName=projectName, shareReservedSizeLow=shareReservedSizeLow, diskTable=diskTable, tegileArray=tegileArray, poolDeletionFailed=poolDeletionFailed, poolTotalReadMbps=poolTotalReadMbps, lunProjectName=lunProjectName, fcAvgReadLatency=fcAvgReadLatency, replicationAbandoned=replicationAbandoned, shareCIFSWriteMbps=shareCIFSWriteMbps, smisServiceStartFailed=smisServiceStartFailed, fcTargetWriteIops=fcTargetWriteIops, iscsiInitiatorsTable=iscsiInitiatorsTable, webdocsUpgradeCompleted=webdocsUpgradeCompleted, smbSocketFailure=smbSocketFailure, poolTable=poolTable, deleteFolderFailed=deleteFolderFailed, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, notificationDescription=notificationDescription, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, poolDeleted=poolDeleted, lunSizeHigh=lunSizeHigh, fcTargetModifyCompleted=fcTargetModifyCompleted, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, fcInitiatorCreateFailed=fcInitiatorCreateFailed, lunReservedSizeLow=lunReservedSizeLow, nicMTU=nicMTU, shareDataSizeHigh=shareDataSizeHigh, poolExported=poolExported, fcTargetReadIops=fcTargetReadIops, shareNFSWriteMbps=shareNFSWriteMbps, volumeQuotaFinished=volumeQuotaFinished, poolProjects=poolProjects, shareCreatedSuccessfully=shareCreatedSuccessfully, currentNotificationGroup=currentNotificationGroup, diskAvgWriteLatency=diskAvgWriteLatency, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, notificationProps=notificationProps, replicationFailed=replicationFailed, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, projectTable=projectTable, poolDegraded=poolDegraded, webdocsUpgradeFailed=webdocsUpgradeFailed, poolUsedSizeHigh=poolUsedSizeHigh, poolEntry=poolEntry, iscsiTargetIndex=iscsiTargetIndex, fcInitiators=fcInitiators, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, lunWriteMbps=lunWriteMbps, shareQuotaHigh=shareQuotaHigh, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, upgradeDownloadFailed=upgradeDownloadFailed, shareProjectName=shareProjectName, poolExpanded=poolExpanded, shareName=shareName, tegileGroups=tegileGroups, nicState=nicState, nicGroup=nicGroup, basicCompliance=basicCompliance, shareExceedThresholdWarning=shareExceedThresholdWarning, diskTotalWriteIops=diskTotalWriteIops, lunWriteIops=lunWriteIops, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, lunDedupEnabled=lunDedupEnabled, poolDataSizeLow=poolDataSizeLow, nicIndex=nicIndex, lunReadMbps=lunReadMbps, diskTotalReadIops=diskTotalReadIops, network=network, projectQuotaFinished=projectQuotaFinished, lunName=lunName, fcTargetIndex=fcTargetIndex, upgradeDownloadCompleted=upgradeDownloadCompleted, diskIOCount=diskIOCount, projectDataSizeLow=projectDataSizeLow, intelliFlashSoftwareUp=intelliFlashSoftwareUp, shareDeleted=shareDeleted, iscsiImproperTargetGroup=iscsiImproperTargetGroup, poolTotalSaving=poolTotalSaving, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, nfsTotalWriteMbps=nfsTotalWriteMbps, lunReadLatency=lunReadLatency, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, targetGroupMemberAdded=targetGroupMemberAdded, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, upgradeFailed=upgradeFailed, haResourceName=haResourceName, poolDataReadIops=poolDataReadIops, diskSequentialIOCount=diskSequentialIOCount, lunCompressionEnabled=lunCompressionEnabled, lunReadIops=lunReadIops, iscsiTargetGroup=iscsiTargetGroup, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, nvdimmFailInitializationError=nvdimmFailInitializationError, nvdimmFailUnknownError=nvdimmFailUnknownError, iscsiTargetWriteIops=iscsiTargetWriteIops, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, sharePoolName=sharePoolName, snapshotRollbackCompleted=snapshotRollbackCompleted, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, tdpsUpgradeFailed=tdpsUpgradeFailed, diskEntry=diskEntry, diskState=diskState, projectThresholdExceedWarning=projectThresholdExceedWarning, diskRandomIOCount=diskRandomIOCount, nfsTotalWriteIops=nfsTotalWriteIops, smisServiceStopped=smisServiceStopped, cifsTotalReadMbps=cifsTotalReadMbps, notificationThresholdTriggerValue=notificationThresholdTriggerValue, nicEntry=nicEntry, notificationSensorNumber=notificationSensorNumber, fcInitiatorIndex=fcInitiatorIndex, lunBlockSize=lunBlockSize, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, diskSizeHigh=diskSizeHigh, cifsAvgReadLatency=cifsAvgReadLatency, upgradeStarted=upgradeStarted, shareDataSizeLow=shareDataSizeLow, iscsiInitiatorGroup=iscsiInitiatorGroup, volumeCreatedSuccessfully=volumeCreatedSuccessfully, poolDataWriteLatency=poolDataWriteLatency, shareReservedSizeHigh=shareReservedSizeHigh, poolState=poolState, poolMetaReadIops=poolMetaReadIops, iscsiTargetEntry=iscsiTargetEntry, projectFreeSizeLow=projectFreeSizeLow, cpuInterrupts=cpuInterrupts, shareNFSEnabled=shareNFSEnabled, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, adServerTimeDrift=adServerTimeDrift, diskType=diskType, cpuSystemCalls=cpuSystemCalls, globalStatistics=globalStatistics, shareMountPoint=shareMountPoint, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, tegileConformance=tegileConformance, poolTotalReadIops=poolTotalReadIops, poolReadCacheWriteLatency=poolReadCacheWriteLatency, disks=disks, iscsiTargetError=iscsiTargetError, pools=pools, haControllerA_Uptime=haControllerA_Uptime, fcTargetsTable=fcTargetsTable, properties=properties, shareCompressedRatio=shareCompressedRatio, poolDataWriteMbps=poolDataWriteMbps, diskGoneOffline=diskGoneOffline, cacheTotalWriteIops=cacheTotalWriteIops, diagnosticDataUploaded=diagnosticDataUploaded, poolTotalWriteMbps=poolTotalWriteMbps, fcTargets=fcTargets, iscsiWriteIops=iscsiWriteIops, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, diskIsOnline=diskIsOnline, cifsTotalWriteMbps=cifsTotalWriteMbps, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, lunDataSizeLow=lunDataSizeLow, fcProperties=fcProperties, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, iscsiInitiatorChapUser=iscsiInitiatorChapUser, tdpsUpgradeCompleted=tdpsUpgradeCompleted, diskDataReadIops=diskDataReadIops, cacheSSDReads=cacheSSDReads, iscsiTargetReadIops=iscsiTargetReadIops, fcTargetReadMbps=fcTargetReadMbps, iscsiTotalWriteMbps=iscsiTotalWriteMbps, projectCompressionEnabled=projectCompressionEnabled)
