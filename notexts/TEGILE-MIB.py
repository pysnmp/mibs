...
# Produced by pysmi-1.1.3 at Wed Dec  8 17:59:45 2021
...
enterprises, IpAddress, Counter64, Gauge32, ModuleIdentity, Counter32, TimeTicks, NotificationType, Bits, ObjectIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "IpAddress", "Counter64", "Gauge32", "ModuleIdentity", "Counter32", "TimeTicks", "NotificationType", "Bits", "ObjectIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier", "Unsigned32")
...
mibBuilder.exportSymbols("TEGILE-MIB", diskDataReadMbps=diskDataReadMbps, tegileConformance=tegileConformance, poolDataReadMbps=poolDataReadMbps, shareTable=shareTable, smisServiceStarted=smisServiceStarted, fcProperties=fcProperties, adServerTimeDrift=adServerTimeDrift, shareQuotaHigh=shareQuotaHigh, fcInitiatorCreateFailed=fcInitiatorCreateFailed, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, notificationSensorSuspect=notificationSensorSuspect, shareCIFSEnabled=shareCIFSEnabled, fcTargetReadLatency=fcTargetReadLatency, haResourceDescription=haResourceDescription, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, globalStatistics=globalStatistics, lunProjectName=lunProjectName, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, lunTargetGroup=lunTargetGroup, snapshotDeleteFailed=snapshotDeleteFailed, ipmiCriticalInterrupt=ipmiCriticalInterrupt, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, shareProjectName=shareProjectName, diskGoneOffline=diskGoneOffline, projectDeleted=projectDeleted, iscsiTargetEntry=iscsiTargetEntry, lunBlockSize=lunBlockSize, projectTotalSaving=projectTotalSaving, upgradeTimeout=upgradeTimeout, shareNFSReadIops=shareNFSReadIops, nfsAvgWriteLatency=nfsAvgWriteLatency, iscsiTargetsTable=iscsiTargetsTable, projectQuotaSizeLow=projectQuotaSizeLow, ipmiCurrent=ipmiCurrent, targetGroupCreateCompleted=targetGroupCreateCompleted, shareNFSWriteMbps=shareNFSWriteMbps, iscsiImproperTargetGroup=iscsiImproperTargetGroup, lunSizeHigh=lunSizeHigh, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, diskDataReadIops=diskDataReadIops, nicIndex=nicIndex, shareNFSWriteLatency=shareNFSWriteLatency, nfsTotalWriteIops=nfsTotalWriteIops, poolTotalReadMbps=poolTotalReadMbps, fcInitiatorEntry=fcInitiatorEntry, cacheTotalWriteIops=cacheTotalWriteIops, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, diskError=diskError, initiatorGroupMemberAdded=initiatorGroupMemberAdded, lunInitiatorGroup=lunInitiatorGroup, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, lunWriteMbps=lunWriteMbps, shareIndex=shareIndex, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, deleteFolderCompleted=deleteFolderCompleted, shareCompressedRatio=shareCompressedRatio, intelliFlashSoftwareUp=intelliFlashSoftwareUp, controllerDown=controllerDown, projectShareCount=projectShareCount, iscsiTargetReadLatency=iscsiTargetReadLatency, iscsiTargetName=iscsiTargetName, replicationFailed=replicationFailed, poolDataWriteIops=poolDataWriteIops, fcInitiatorGroup=fcInitiatorGroup, fcInitiatorIndex=fcInitiatorIndex, shareQuotaFinished=shareQuotaFinished, notificationEventCode=notificationEventCode, diskDataWriteIops=diskDataWriteIops, shareCIFSWriteMbps=shareCIFSWriteMbps, tegileArray=tegileArray, nicTable=nicTable, networkTotalTransmitMbps=networkTotalTransmitMbps, projectFreeSizeLow=projectFreeSizeLow, testNotification=testNotification, snmpServiceStartFailed=snmpServiceStartFailed, haControllerA_IPAddr=haControllerA_IPAddr, poolDataReadLatency=poolDataReadLatency, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, poolEntry=poolEntry, poolDataSizeLow=poolDataSizeLow, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, shareCIFSReadLatency=shareCIFSReadLatency, diskTotalReadIops=diskTotalReadIops, nfsTotalReadMbps=nfsTotalReadMbps, poolExported=poolExported, nvdimmFailUnknownError=nvdimmFailUnknownError, iscsiTargetReadMbps=iscsiTargetReadMbps, snmpServiceStopped=snmpServiceStopped, poolSizeLow=poolSizeLow, lunWriteLatency=lunWriteLatency, cpuSystemCalls=cpuSystemCalls, poolMetaReadIops=poolMetaReadIops, shareDedupEnabled=shareDedupEnabled, projectEntry=projectEntry, shareExceedThresholdWarning=shareExceedThresholdWarning, lunFreeSizeHigh=lunFreeSizeHigh, notificationProps=notificationProps, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, cacheTotalWriteMbps=cacheTotalWriteMbps, poolUpgraded=poolUpgraded, poolDataWriteMbps=poolDataWriteMbps, iscsiTotalWriteMbps=iscsiTotalWriteMbps, shareCreatedSuccessfully=shareCreatedSuccessfully, smisServiceStartFailed=smisServiceStartFailed, nvdimmFailSoftError=nvdimmFailSoftError, shareReservedSizeLow=shareReservedSizeLow, shareDataSizeHigh=shareDataSizeHigh, lunReservedSizeHigh=lunReservedSizeHigh, tdpsUpgradeCompleted=tdpsUpgradeCompleted, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, currentNotificationGroup=currentNotificationGroup, iscsiInitiatorName=iscsiInitiatorName, lunSnapshotSizeLow=lunSnapshotSizeLow, iscsiTotalReadIops=iscsiTotalReadIops, fcTargetWriteMbps=fcTargetWriteMbps, iscsiProperties=iscsiProperties, fcTotalWriteMbps=fcTotalWriteMbps, shareMountPoint=shareMountPoint, cpuInterrupts=cpuInterrupts, projectDedupEnabled=projectDedupEnabled, poolState=poolState, tegile=tegile, spareDiskReplaced=spareDiskReplaced, shareNFSEnabled=shareNFSEnabled, cifsAvgReadLatency=cifsAvgReadLatency, nfsAvgReadLatency=nfsAvgReadLatency, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, iscsiAvgReadLatency=iscsiAvgReadLatency, replicationPaused=replicationPaused, networkTotalReceiveMbps=networkTotalReceiveMbps, iscsiInitiatorsTable=iscsiInitiatorsTable, controllerHardwareModel=controllerHardwareModel, projectName=projectName, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, lunDataSizeHigh=lunDataSizeHigh, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, deleteFolderFailed=deleteFolderFailed, networkIpmpGroupDown=networkIpmpGroupDown, lunEntry=lunEntry, shareDataSizeLow=shareDataSizeLow, diskTotalWriteIops=diskTotalWriteIops, iscsiInitiatorChapUser=iscsiInitiatorChapUser, volumeDeleteCompleted=volumeDeleteCompleted, webdocsUpgradeCompleted=webdocsUpgradeCompleted, cacheRAMReads=cacheRAMReads, cacheTotalReadMbps=cacheTotalReadMbps, replicationResumed=replicationResumed, lunName=lunName, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, fcTotalWriteIops=fcTotalWriteIops, poolCount=poolCount, iscsiTargetWriteLatency=iscsiTargetWriteLatency, fcTargetGroup=fcTargetGroup, cifsTotalWriteMbps=cifsTotalWriteMbps, ipmiPowerSupply=ipmiPowerSupply, diskAvgReadLatency=diskAvgReadLatency, poolDataReadIops=poolDataReadIops, poolProjects=poolProjects, poolReadCacheWriteMbps=poolReadCacheWriteMbps, controllerTimeDrift=controllerTimeDrift, cacheTotalReadIops=cacheTotalReadIops, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, lunIndex=lunIndex, projectThresholdExceedWarning=projectThresholdExceedWarning, ipmiFan=ipmiFan, poolIndex=poolIndex, projectModified=projectModified, iscsiTargetWriteIops=iscsiTargetWriteIops, snapshotRollbackFailed=snapshotRollbackFailed, intelliFlashSoftwareDown=intelliFlashSoftwareDown, ipmiMemory=ipmiMemory, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, poolReadCacheReadIops=poolReadCacheReadIops, haControllerB_IPAddr=haControllerB_IPAddr, haResourceEntry=haResourceEntry, volumeDeleteFailed=volumeDeleteFailed, diskIndex=diskIndex, poolDataWriteLatency=poolDataWriteLatency, lunWriteIops=lunWriteIops, unknownSensorEvent=unknownSensorEvent, smisServiceStopped=smisServiceStopped, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, poolQuotaFinished=poolQuotaFinished, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, projectIndex=projectIndex, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, iscsiInitiatorIndex=iscsiInitiatorIndex, shareNFSWriteIops=shareNFSWriteIops, lunReadMbps=lunReadMbps, ipmiOther=ipmiOther, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, cacheSSDReads=cacheSSDReads, snmpAgentVersion=snmpAgentVersion, nicGroup=nicGroup, shareDeleted=shareDeleted, notifications=notifications, projectFreeSizeHigh=projectFreeSizeHigh, iscsiInitiatorEntry=iscsiInitiatorEntry, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, PYSNMP_MODULE_ID=tegile, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, nicState=nicState, userLoginFailed=userLoginFailed, notificationTime=notificationTime, notificationComponentName=notificationComponentName, notificationObjects=notificationObjects, fcTargetStatus=fcTargetStatus, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, fcTargetsTable=fcTargetsTable, poolMetaWriteIops=poolMetaWriteIops, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, nicTransmitMbps=nicTransmitMbps, haControllerB_Name=haControllerB_Name, diskTable=diskTable, poolName=poolName, fcTargetReadIops=fcTargetReadIops, ipmiTemperature=ipmiTemperature, tdpsUpgradeFailed=tdpsUpgradeFailed, fcTargetEntry=fcTargetEntry, projectQuotaFinished=projectQuotaFinished, nicEntry=nicEntry, poolTable=poolTable, diskDataWriteMbps=diskDataWriteMbps, lunReadIops=lunReadIops, upgradeCompleted=upgradeCompleted, netbiosSocketFailure=netbiosSocketFailure, poolUsedSizeLow=poolUsedSizeLow, lunSizeLow=lunSizeLow, diskSizeHigh=diskSizeHigh, notificationReadingTriggerValue=notificationReadingTriggerValue, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, snmpServiceStopFailed=snmpServiceStopFailed, maintenanceModeDisabled=maintenanceModeDisabled, diskRandomIOCount=diskRandomIOCount, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, haResourceName=haResourceName, replicationAbandoned=replicationAbandoned, shareDeletionFailed=shareDeletionFailed, iscsiTargetAuth=iscsiTargetAuth, controllerUp=controllerUp, fcTargetWriteIops=fcTargetWriteIops, nicReceiveMbps=nicReceiveMbps, iscsiAvgWriteLatency=iscsiAvgWriteLatency, poolDataSizeHigh=poolDataSizeHigh)
mibBuilder.exportSymbols("TEGILE-MIB", diskIsOnline=diskIsOnline, diskAlias=diskAlias, replicationSourceRegistered=replicationSourceRegistered, smisServiceStopFailed=smisServiceStopFailed, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, poolTotalWriteIops=poolTotalWriteIops, diskEntry=diskEntry, cpuTotalUsage=cpuTotalUsage, poolCreated=poolCreated, shareNFSReadMbps=shareNFSReadMbps, projectSnapshotSizeLow=projectSnapshotSizeLow, lunDataSizeLow=lunDataSizeLow, fcInitiatorsTable=fcInitiatorsTable, sanProperties=sanProperties, haControllerA_Uptime=haControllerA_Uptime, currentObjectGroup=currentObjectGroup, upgradeDownloadCompleted=upgradeDownloadCompleted, poolMetaWriteMbps=poolMetaWriteMbps, nvdimmFailInitializationError=nvdimmFailInitializationError, haControllerA_Name=haControllerA_Name, cifsTotalReadIops=cifsTotalReadIops, volumeCreatedSuccessfully=volumeCreatedSuccessfully, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, fcTargetName=fcTargetName, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, smbSocketFailure=smbSocketFailure, notificationDescription=notificationDescription, tegileGroups=tegileGroups, tdpsUpgradeTimeout=tdpsUpgradeTimeout, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, projectSnapshotSizeHigh=projectSnapshotSizeHigh, sensorFailureEvent=sensorFailureEvent, poolDeletionFailed=poolDeletionFailed, notificationSeverity=notificationSeverity, cifsAvgWriteLatency=cifsAvgWriteLatency, haResourcesTable=haResourcesTable, projectQuotaSizeHigh=projectQuotaSizeHigh, poolFreeSizeHigh=poolFreeSizeHigh, nvdimmFailDeviceError=nvdimmFailDeviceError, fcTotalReadMbps=fcTotalReadMbps, nicName=nicName, poolMetaReadLatency=poolMetaReadLatency, lunSnapshotSizeHigh=lunSnapshotSizeHigh, fcPortOnline=fcPortOnline, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, lunDedupEnabled=lunDedupEnabled, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, fcTargetModifyCompleted=fcTargetModifyCompleted, iscsiTargetGroupError=iscsiTargetGroupError, shareSnapshotSizeLow=shareSnapshotSizeLow, projectLUNs=projectLUNs, snapshotCreationFailed=snapshotCreationFailed, upgradeDownloadFailed=upgradeDownloadFailed, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, networkIpmpGroupUp=networkIpmpGroupUp, diskIOCount=diskIOCount, iscsiTargetError=iscsiTargetError, upgradeDownloadStarted=upgradeDownloadStarted, properties=properties, poolReadCacheWriteIops=poolReadCacheWriteIops, fcTotalReadIops=fcTotalReadIops, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, lunPoolName=lunPoolName, iscsiInitiatorGroup=iscsiInitiatorGroup, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, poolWriteCacheWriteIops=poolWriteCacheWriteIops, fcInitiatorName=fcInitiatorName, diskState=diskState, projectPoolName=projectPoolName, haResources=haResources, targetGroupMemberAdded=targetGroupMemberAdded, iscsiTargetWriteMbps=iscsiTargetWriteMbps, targetGroupDeleteCompleted=targetGroupDeleteCompleted, webdocsUpgradeFailed=webdocsUpgradeFailed, iscsiWriteIops=iscsiWriteIops, diskSizeLow=diskSizeLow, network=network, fcAvgReadLatency=fcAvgReadLatency, lunTable=lunTable, nicMTU=nicMTU, replicationTargetDeleted=replicationTargetDeleted, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, nfsTotalReadIops=nfsTotalReadIops, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, snmpServiceStarted=snmpServiceStarted, lunCompressedRatio=lunCompressedRatio, replicationAborted=replicationAborted, snapshotCloneCompleted=snapshotCloneCompleted, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, fcPortOffline=fcPortOffline, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, aclMigrationCompleted=aclMigrationCompleted, diskTotalWriteMbps=diskTotalWriteMbps, projectShares=projectShares, poolTotalSaving=poolTotalSaving, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, lunFreeSizeLow=lunFreeSizeLow, poolMetaWriteLatency=poolMetaWriteLatency, lunCompressionEnabled=lunCompressionEnabled, iscsiTargetGroup=iscsiTargetGroup, lunProtocol=lunProtocol, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, targetGroupMemberRemoved=targetGroupMemberRemoved, shareCIFSWriteIops=shareCIFSWriteIops, shareReservedSizeHigh=shareReservedSizeHigh, shareEntry=shareEntry, ipmiVoltage=ipmiVoltage, iscsiTargetAlias=iscsiTargetAlias, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, diskCount=diskCount, maintenanceModeEnabled=maintenanceModeEnabled, poolReadCacheReadMbps=poolReadCacheReadMbps, diagnosticDataUploaded=diagnosticDataUploaded, projectDataSizeHigh=projectDataSizeHigh, projectLunCount=projectLunCount, volumeQuotaFinished=volumeQuotaFinished, poolProjectCount=poolProjectCount, fcTargetReadMbps=fcTargetReadMbps, poolAvgWriteLatency=poolAvgWriteLatency, lunReadLatency=lunReadLatency, diskSequentialIOCount=diskSequentialIOCount, haResourceStatus=haResourceStatus, ipmiThreshold=ipmiThreshold, poolTotalReadIops=poolTotalReadIops, shareCIFSReadMbps=shareCIFSReadMbps, poolDegraded=poolDegraded, nfsTotalWriteMbps=nfsTotalWriteMbps, poolMetaReadMbps=poolMetaReadMbps, fcTargetWriteLatency=fcTargetWriteLatency, poolReadCacheWriteLatency=poolReadCacheWriteLatency, shareCIFSReadIops=shareCIFSReadIops, ntpServerTimeDrift=ntpServerTimeDrift, vmwareNFSDatastores=vmwareNFSDatastores, sharePoolName=sharePoolName, notificationSensorAction=notificationSensorAction, networkInterfaceDown=networkInterfaceDown, poolAvgReadLatency=poolAvgReadLatency, projectDeletionFailed=projectDeletionFailed, diskType=diskType, notificationReadingUnit=notificationReadingUnit, poolImported=poolImported, haResourceIndex=haResourceIndex, snapshotRollbackCompleted=snapshotRollbackCompleted, alertsCleanupCompleted=alertsCleanupCompleted, iscsiTargetReadIops=iscsiTargetReadIops, diskAvgWriteLatency=diskAvgWriteLatency, cifsTotalReadMbps=cifsTotalReadMbps, upgradeFailed=upgradeFailed, aclMigrationStarted=aclMigrationStarted, notificationSensorNumber=notificationSensorNumber, poolExpanded=poolExpanded, haResourceActiveNode=haResourceActiveNode, notificationTargetEntityName=notificationTargetEntityName, diskChassisIdx=diskChassisIdx, haControllerB_Uptime=haControllerB_Uptime, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, diskPoolName=diskPoolName, poolTotalWriteMbps=poolTotalWriteMbps, iscsiTotalReadMbps=iscsiTotalReadMbps, diskTotalReadMbps=diskTotalReadMbps, snapshotCloningFailed=snapshotCloningFailed, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, projectTable=projectTable, shareQuotaLow=shareQuotaLow, fcInitiators=fcInitiators, upgradeStarted=upgradeStarted, replicationComplete=replicationComplete, poolFreeSizeLow=poolFreeSizeLow, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, projectDataSizeLow=projectDataSizeLow, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, cifsTotalWriteIops=cifsTotalWriteIops, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, memoryFailure=memoryFailure, fcAvgWriteLatency=fcAvgWriteLatency, volumeModifyCompleted=volumeModifyCompleted, pools=pools, lunReservedSizeLow=lunReservedSizeLow, fcTargets=fcTargets, haResourceGroup=haResourceGroup, poolUsedSizeHigh=poolUsedSizeHigh, diskSlowIo=diskSlowIo, shareCompressionEnabled=shareCompressionEnabled, fcTargetIndex=fcTargetIndex, poolOwnerController=poolOwnerController, tegileCompliances=tegileCompliances, poolSizeHigh=poolSizeHigh, poolReadCacheReadLatency=poolReadCacheReadLatency, networkInterfaceUp=networkInterfaceUp, disks=disks, iscsiInitiators=iscsiInitiators, iscsiTargets=iscsiTargets, basicCompliance=basicCompliance, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, poolHealth=poolHealth, lunGUID=lunGUID, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, shareCIFSWriteLatency=shareCIFSWriteLatency, projectCompressionEnabled=projectCompressionEnabled, tegileArray_notifications=tegileArray_notifications, shareName=shareName, poolDeleted=poolDeleted, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, notificationThresholdTriggerValue=notificationThresholdTriggerValue, projectCreatedSuccessfully=projectCreatedSuccessfully, shareSnapshotSizeHigh=shareSnapshotSizeHigh, iscsiTargetIndex=iscsiTargetIndex, replicationStarted=replicationStarted, shareNFSReadLatency=shareNFSReadLatency)
