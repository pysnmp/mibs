...
ModuleIdentity, Integer32, enterprises, iso, Bits, TimeTicks, ObjectIdentity, MibIdentifier, IpAddress, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "enterprises", "iso", "Bits", "TimeTicks", "ObjectIdentity", "MibIdentifier", "IpAddress", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("TEGILE-MIB", diskTotalReadIops=diskTotalReadIops, fcInitiatorIndex=fcInitiatorIndex, unknownSensorEvent=unknownSensorEvent, poolMetaWriteLatency=poolMetaWriteLatency, diskChassisIdx=diskChassisIdx, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, projectCreatedSuccessfully=projectCreatedSuccessfully, poolTotalWriteIops=poolTotalWriteIops, lunTargetGroup=lunTargetGroup, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, lunReservedSizeLow=lunReservedSizeLow, lunDataSizeHigh=lunDataSizeHigh, cacheTotalReadMbps=cacheTotalReadMbps, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, lunGUID=lunGUID, projectCompressionEnabled=projectCompressionEnabled, smisServiceStartFailed=smisServiceStartFailed, tdpsUpgradeTimeout=tdpsUpgradeTimeout, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, fcTargetName=fcTargetName, fcPortOffline=fcPortOffline, lunName=lunName, poolDataWriteMbps=poolDataWriteMbps, shareNFSWriteIops=shareNFSWriteIops, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, lunSnapshotSizeLow=lunSnapshotSizeLow, lunIndex=lunIndex, tegileGroups=tegileGroups, shareNFSWriteLatency=shareNFSWriteLatency, lunFreeSizeLow=lunFreeSizeLow, shareNFSReadLatency=shareNFSReadLatency, replicationFailed=replicationFailed, intelliFlashSoftwareUp=intelliFlashSoftwareUp, iscsiTargetAlias=iscsiTargetAlias, poolReadCacheWriteIops=poolReadCacheWriteIops, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, diskAvgWriteLatency=diskAvgWriteLatency, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, diskAlias=diskAlias, poolTotalSaving=poolTotalSaving, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, shareCreatedSuccessfully=shareCreatedSuccessfully, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, shareReservedSizeHigh=shareReservedSizeHigh, iscsiTargetReadLatency=iscsiTargetReadLatency, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, fcTargetWriteIops=fcTargetWriteIops, fcTargetWriteLatency=fcTargetWriteLatency, poolUpgraded=poolUpgraded, diskPoolName=diskPoolName, nfsTotalReadIops=nfsTotalReadIops, poolUsedSizeLow=poolUsedSizeLow, fcInitiatorName=fcInitiatorName, nicGroup=nicGroup, netbiosSocketFailure=netbiosSocketFailure, projectModified=projectModified, maintenanceModeDisabled=maintenanceModeDisabled, ipmiThreshold=ipmiThreshold, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, diskSizeHigh=diskSizeHigh, poolFreeSizeLow=poolFreeSizeLow, projectEntry=projectEntry, projectPoolName=projectPoolName, shareReservedSizeLow=shareReservedSizeLow, poolCreated=poolCreated, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, nvdimmFailUnknownError=nvdimmFailUnknownError, controllerTimeDrift=controllerTimeDrift, upgradeDownloadFailed=upgradeDownloadFailed, fcTargetReadLatency=fcTargetReadLatency, cpuTotalUsage=cpuTotalUsage, shareCIFSReadIops=shareCIFSReadIops, nvdimmFailInitializationError=nvdimmFailInitializationError, webdocsUpgradeFailed=webdocsUpgradeFailed, smisServiceStopped=smisServiceStopped, diskRandomIOCount=diskRandomIOCount, lunReadMbps=lunReadMbps, shareSnapshotSizeHigh=shareSnapshotSizeHigh, shareCIFSWriteLatency=shareCIFSWriteLatency, poolWriteCacheWriteIops=poolWriteCacheWriteIops, poolQuotaFinished=poolQuotaFinished, tegile=tegile, diskError=diskError, shareCompressedRatio=shareCompressedRatio, nicTable=nicTable, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, cifsTotalWriteIops=cifsTotalWriteIops, sharePoolName=sharePoolName, poolExported=poolExported, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, cifsAvgReadLatency=cifsAvgReadLatency, fcProperties=fcProperties, smbSocketFailure=smbSocketFailure, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, diskDataReadIops=diskDataReadIops, iscsiAvgWriteLatency=iscsiAvgWriteLatency, fcAvgReadLatency=fcAvgReadLatency, poolOwnerController=poolOwnerController, poolDeletionFailed=poolDeletionFailed, haResourceActiveNode=haResourceActiveNode, upgradeDownloadStarted=upgradeDownloadStarted, replicationAborted=replicationAborted, tegileArray=tegileArray, replicationPaused=replicationPaused, fcTargetGroup=fcTargetGroup, cpuInterrupts=cpuInterrupts, volumeQuotaFinished=volumeQuotaFinished, poolMetaReadIops=poolMetaReadIops, iscsiTargetsTable=iscsiTargetsTable, poolExpanded=poolExpanded, lunSizeHigh=lunSizeHigh, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, controllerDown=controllerDown, poolState=poolState, networkIpmpGroupDown=networkIpmpGroupDown, poolDegraded=poolDegraded, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, iscsiTargetName=iscsiTargetName, poolSizeHigh=poolSizeHigh, ipmiOther=ipmiOther, snmpServiceStarted=snmpServiceStarted, fcInitiators=fcInitiators, nfsTotalReadMbps=nfsTotalReadMbps, lunPoolName=lunPoolName, snapshotRollbackCompleted=snapshotRollbackCompleted, notificationSensorSuspect=notificationSensorSuspect, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, shareQuotaFinished=shareQuotaFinished, nfsTotalWriteIops=nfsTotalWriteIops, poolSizeLow=poolSizeLow, ipmiPowerSupply=ipmiPowerSupply, diskDataWriteMbps=diskDataWriteMbps, webdocsUpgradeCompleted=webdocsUpgradeCompleted, upgradeTimeout=upgradeTimeout, currentObjectGroup=currentObjectGroup, snapshotCloneCompleted=snapshotCloneCompleted, globalStatistics=globalStatistics, projectTotalSaving=projectTotalSaving, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, diskIndex=diskIndex, projectDedupEnabled=projectDedupEnabled, notificationObjects=notificationObjects, notificationTime=notificationTime, fcTotalReadIops=fcTotalReadIops, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, poolTable=poolTable, volumeModifyCompleted=volumeModifyCompleted, poolDataWriteLatency=poolDataWriteLatency, iscsiTargetWriteIops=iscsiTargetWriteIops, projectDeleted=projectDeleted, iscsiTargets=iscsiTargets, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, poolDataSizeHigh=poolDataSizeHigh, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, iscsiTargetReadIops=iscsiTargetReadIops, lunDedupEnabled=lunDedupEnabled, shareQuotaLow=shareQuotaLow, upgradeDownloadCompleted=upgradeDownloadCompleted, notificationComponentName=notificationComponentName, lunInitiatorGroup=lunInitiatorGroup, snmpServiceStopFailed=snmpServiceStopFailed, cifsTotalReadMbps=cifsTotalReadMbps, poolProjectCount=poolProjectCount, projectLunCount=projectLunCount, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, controllerUp=controllerUp, deleteFolderFailed=deleteFolderFailed, shareDataSizeHigh=shareDataSizeHigh, projectSnapshotSizeHigh=projectSnapshotSizeHigh, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, poolMetaReadLatency=poolMetaReadLatency, projectShares=projectShares, tegileConformance=tegileConformance, projectDataSizeLow=projectDataSizeLow, iscsiInitiatorChapUser=iscsiInitiatorChapUser, poolImported=poolImported, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, replicationSourceRegistered=replicationSourceRegistered, shareSnapshotSizeLow=shareSnapshotSizeLow, poolReadCacheWriteLatency=poolReadCacheWriteLatency, ipmiFan=ipmiFan, fcTargetStatus=fcTargetStatus, PYSNMP_MODULE_ID=tegile, diskSlowIo=diskSlowIo, projectQuotaSizeLow=projectQuotaSizeLow, poolDataSizeLow=poolDataSizeLow, iscsiTotalReadIops=iscsiTotalReadIops, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, notificationEventCode=notificationEventCode, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, iscsiInitiatorGroup=iscsiInitiatorGroup, shareDeletionFailed=shareDeletionFailed, iscsiTargetError=iscsiTargetError, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, cifsTotalReadIops=cifsTotalReadIops, targetGroupDeleteCompleted=targetGroupDeleteCompleted, diskIsOnline=diskIsOnline, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, userLoginFailed=userLoginFailed, iscsiTotalWriteMbps=iscsiTotalWriteMbps, haResourceName=haResourceName, targetGroupMemberRemoved=targetGroupMemberRemoved, iscsiProperties=iscsiProperties, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, tegileCompliances=tegileCompliances, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, disks=disks, notificationSensorAction=notificationSensorAction, projectThresholdExceedWarning=projectThresholdExceedWarning, smisServiceStarted=smisServiceStarted, diskTotalWriteMbps=diskTotalWriteMbps, iscsiInitiatorIndex=iscsiInitiatorIndex, iscsiAvgReadLatency=iscsiAvgReadLatency, shareNFSWriteMbps=shareNFSWriteMbps, fcTargetWriteMbps=fcTargetWriteMbps, poolCount=poolCount, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, lunTable=lunTable, properties=properties, iscsiTargetGroup=iscsiTargetGroup, shareDataSizeLow=shareDataSizeLow, spareDiskReplaced=spareDiskReplaced, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, notificationSensorNumber=notificationSensorNumber, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, cifsTotalWriteMbps=cifsTotalWriteMbps, fcInitiatorEntry=fcInitiatorEntry, cacheTotalWriteMbps=cacheTotalWriteMbps, diagnosticDataUploaded=diagnosticDataUploaded, diskAvgReadLatency=diskAvgReadLatency, cifsAvgWriteLatency=cifsAvgWriteLatency, haResourceGroup=haResourceGroup, upgradeStarted=upgradeStarted, shareNFSReadMbps=shareNFSReadMbps, projectShareCount=projectShareCount, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, diskTotalReadMbps=diskTotalReadMbps, haResourceStatus=haResourceStatus, replicationResumed=replicationResumed, poolAvgWriteLatency=poolAvgWriteLatency, projectQuotaSizeHigh=projectQuotaSizeHigh, diskCount=diskCount, snmpServiceStopped=snmpServiceStopped, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, nicMTU=nicMTU, lunBlockSize=lunBlockSize, lunSnapshotSizeHigh=lunSnapshotSizeHigh)
mibBuilder.exportSymbols("TEGILE-MIB", fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, notificationSeverity=notificationSeverity, adServerTimeDrift=adServerTimeDrift, haResourcesTable=haResourcesTable, snmpServiceStartFailed=snmpServiceStartFailed, poolReadCacheReadMbps=poolReadCacheReadMbps, shareCIFSWriteIops=shareCIFSWriteIops, haControllerB_Uptime=haControllerB_Uptime, diskSequentialIOCount=diskSequentialIOCount, snmpAgentVersion=snmpAgentVersion, poolIndex=poolIndex, iscsiTargetGroupError=iscsiTargetGroupError, ipmiMemory=ipmiMemory, notificationTargetEntityName=notificationTargetEntityName, lunDataSizeLow=lunDataSizeLow, nfsTotalWriteMbps=nfsTotalWriteMbps, poolProjects=poolProjects, nvdimmFailSoftError=nvdimmFailSoftError, haResourceIndex=haResourceIndex, haResourceDescription=haResourceDescription, snapshotDeleteFailed=snapshotDeleteFailed, diskGoneOffline=diskGoneOffline, initiatorGroupMemberAdded=initiatorGroupMemberAdded, poolDataReadIops=poolDataReadIops, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, iscsiTargetAuth=iscsiTargetAuth, fcTargets=fcTargets, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, maintenanceModeEnabled=maintenanceModeEnabled, poolHealth=poolHealth, lunReservedSizeHigh=lunReservedSizeHigh, smisServiceStopFailed=smisServiceStopFailed, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, projectIndex=projectIndex, shareMountPoint=shareMountPoint, projectLUNs=projectLUNs, lunProjectName=lunProjectName, controllerHardwareModel=controllerHardwareModel, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, projectQuotaFinished=projectQuotaFinished, projectFreeSizeLow=projectFreeSizeLow, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, shareQuotaHigh=shareQuotaHigh, fcTargetIndex=fcTargetIndex, basicCompliance=basicCompliance, testNotification=testNotification, snapshotCloningFailed=snapshotCloningFailed, fcTotalReadMbps=fcTotalReadMbps, diskDataReadMbps=diskDataReadMbps, shareCIFSWriteMbps=shareCIFSWriteMbps, lunProtocol=lunProtocol, projectDeletionFailed=projectDeletionFailed, haControllerA_Name=haControllerA_Name, replicationComplete=replicationComplete, projectDataSizeHigh=projectDataSizeHigh, shareNFSReadIops=shareNFSReadIops, notificationReadingTriggerValue=notificationReadingTriggerValue, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, diskTotalWriteIops=diskTotalWriteIops, iscsiTargetWriteMbps=iscsiTargetWriteMbps, fcTargetReadIops=fcTargetReadIops, nicReceiveMbps=nicReceiveMbps, poolTotalWriteMbps=poolTotalWriteMbps, upgradeFailed=upgradeFailed, ipmiCriticalInterrupt=ipmiCriticalInterrupt, deleteFolderCompleted=deleteFolderCompleted, snapshotRollbackFailed=snapshotRollbackFailed, fcInitiatorCreateFailed=fcInitiatorCreateFailed, iscsiInitiatorsTable=iscsiInitiatorsTable, shareDedupEnabled=shareDedupEnabled, diskState=diskState, diskIOCount=diskIOCount, networkTotalReceiveMbps=networkTotalReceiveMbps, shareCIFSReadMbps=shareCIFSReadMbps, aclMigrationStarted=aclMigrationStarted, iscsiTargetEntry=iscsiTargetEntry, haControllerB_IPAddr=haControllerB_IPAddr, lunFreeSizeHigh=lunFreeSizeHigh, vmwareNFSDatastores=vmwareNFSDatastores, networkInterfaceUp=networkInterfaceUp, sanProperties=sanProperties, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, shareNFSEnabled=shareNFSEnabled, shareProjectName=shareProjectName, volumeCreatedSuccessfully=volumeCreatedSuccessfully, networkInterfaceDown=networkInterfaceDown, poolMetaReadMbps=poolMetaReadMbps, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, nicState=nicState, cacheTotalReadIops=cacheTotalReadIops, diskTable=diskTable, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, lunCompressionEnabled=lunCompressionEnabled, memoryFailure=memoryFailure, intelliFlashSoftwareDown=intelliFlashSoftwareDown, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, iscsiImproperTargetGroup=iscsiImproperTargetGroup, iscsiInitiators=iscsiInitiators, lunWriteIops=lunWriteIops, nvdimmFailDeviceError=nvdimmFailDeviceError, cpuSystemCalls=cpuSystemCalls, notifications=notifications, notificationReadingUnit=notificationReadingUnit, projectSnapshotSizeLow=projectSnapshotSizeLow, poolDataReadMbps=poolDataReadMbps, shareEntry=shareEntry, poolReadCacheWriteMbps=poolReadCacheWriteMbps, tdpsUpgradeCompleted=tdpsUpgradeCompleted, shareDeleted=shareDeleted, shareIndex=shareIndex, ipmiTemperature=ipmiTemperature, haResources=haResources, tegileArray_notifications=tegileArray_notifications, haControllerA_Uptime=haControllerA_Uptime, shareCompressionEnabled=shareCompressionEnabled, haControllerB_Name=haControllerB_Name, poolDataReadLatency=poolDataReadLatency, volumeDeleteFailed=volumeDeleteFailed, targetGroupMemberAdded=targetGroupMemberAdded, lunWriteMbps=lunWriteMbps, shareName=shareName, shareTable=shareTable, iscsiInitiatorName=iscsiInitiatorName, nfsAvgWriteLatency=nfsAvgWriteLatency, shareCIFSEnabled=shareCIFSEnabled, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, replicationStarted=replicationStarted, currentNotificationGroup=currentNotificationGroup, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, cacheRAMReads=cacheRAMReads, poolFreeSizeHigh=poolFreeSizeHigh, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, notificationProps=notificationProps, fcTotalWriteIops=fcTotalWriteIops, poolTotalReadIops=poolTotalReadIops, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, aclMigrationCompleted=aclMigrationCompleted, diskSizeLow=diskSizeLow, fcTargetEntry=fcTargetEntry, shareExceedThresholdWarning=shareExceedThresholdWarning, poolMetaWriteIops=poolMetaWriteIops, poolReadCacheReadIops=poolReadCacheReadIops, ntpServerTimeDrift=ntpServerTimeDrift, notificationThresholdTriggerValue=notificationThresholdTriggerValue, fcTargetsTable=fcTargetsTable, fcTargetModifyCompleted=fcTargetModifyCompleted, diskDataWriteIops=diskDataWriteIops, alertsCleanupCompleted=alertsCleanupCompleted, cacheTotalWriteIops=cacheTotalWriteIops, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, targetGroupCreateCompleted=targetGroupCreateCompleted, shareCIFSReadLatency=shareCIFSReadLatency, replicationTargetDeleted=replicationTargetDeleted, iscsiTargetReadMbps=iscsiTargetReadMbps, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, networkTotalTransmitMbps=networkTotalTransmitMbps, poolName=poolName, lunSizeLow=lunSizeLow, projectTable=projectTable, projectFreeSizeHigh=projectFreeSizeHigh, poolAvgReadLatency=poolAvgReadLatency, volumeDeleteCompleted=volumeDeleteCompleted, fcTotalWriteMbps=fcTotalWriteMbps, lunCompressedRatio=lunCompressedRatio, nicName=nicName, diskType=diskType, lunWriteLatency=lunWriteLatency, poolDeleted=poolDeleted, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, haControllerA_IPAddr=haControllerA_IPAddr, fcInitiatorsTable=fcInitiatorsTable, projectName=projectName, pools=pools, iscsiTotalReadMbps=iscsiTotalReadMbps, iscsiWriteIops=iscsiWriteIops, notificationDescription=notificationDescription, tdpsUpgradeFailed=tdpsUpgradeFailed, network=network, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, iscsiTargetWriteLatency=iscsiTargetWriteLatency, fcTargetReadMbps=fcTargetReadMbps, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, poolDataWriteIops=poolDataWriteIops, lunReadLatency=lunReadLatency, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, nicIndex=nicIndex, snapshotCreationFailed=snapshotCreationFailed, fcPortOnline=fcPortOnline, lunReadIops=lunReadIops, nicEntry=nicEntry, lunEntry=lunEntry, poolReadCacheReadLatency=poolReadCacheReadLatency, poolEntry=poolEntry, poolUsedSizeHigh=poolUsedSizeHigh, diskEntry=diskEntry, poolMetaWriteMbps=poolMetaWriteMbps, fcAvgWriteLatency=fcAvgWriteLatency, iscsiTargetIndex=iscsiTargetIndex, nfsAvgReadLatency=nfsAvgReadLatency, ipmiVoltage=ipmiVoltage, sensorFailureEvent=sensorFailureEvent, ipmiCurrent=ipmiCurrent, upgradeCompleted=upgradeCompleted, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, replicationAbandoned=replicationAbandoned, nicTransmitMbps=nicTransmitMbps, haResourceEntry=haResourceEntry, poolTotalReadMbps=poolTotalReadMbps, cacheSSDReads=cacheSSDReads, networkIpmpGroupUp=networkIpmpGroupUp, fcInitiatorGroup=fcInitiatorGroup, iscsiInitiatorEntry=iscsiInitiatorEntry)
