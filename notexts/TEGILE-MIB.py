...
NotificationType, MibIdentifier, ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Bits, Counter32, Integer32, iso, Unsigned32, Counter64, IpAddress, enterprises, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Bits", "Counter32", "Integer32", "iso", "Unsigned32", "Counter64", "IpAddress", "enterprises", "Gauge32")
...
mibBuilder.exportSymbols("TEGILE-MIB", webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, shareNFSReadIops=shareNFSReadIops, poolUsedSizeLow=poolUsedSizeLow, notificationTime=notificationTime, networkTotalTransmitMbps=networkTotalTransmitMbps, iscsiTargetAuth=iscsiTargetAuth, lunDataSizeHigh=lunDataSizeHigh, lunReadLatency=lunReadLatency, poolReadCacheReadLatency=poolReadCacheReadLatency, poolReadCacheWriteLatency=poolReadCacheWriteLatency, snapshotCloneCompleted=snapshotCloneCompleted, upgradeCompleted=upgradeCompleted, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, fcPortOnline=fcPortOnline, replicationAbandoned=replicationAbandoned, diskAlias=diskAlias, replicationComplete=replicationComplete, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, nicTable=nicTable, tegileConformance=tegileConformance, upgradeTimeout=upgradeTimeout, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, poolCreated=poolCreated, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, networkInterfaceUp=networkInterfaceUp, fcInitiatorGroup=fcInitiatorGroup, shareSnapshotSizeHigh=shareSnapshotSizeHigh, haControllerA_Uptime=haControllerA_Uptime, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, smisServiceStopFailed=smisServiceStopFailed, tegile=tegile, projectDeleted=projectDeleted, poolTotalReadMbps=poolTotalReadMbps, upgradeDownloadCompleted=upgradeDownloadCompleted, poolReadCacheReadMbps=poolReadCacheReadMbps, poolWriteCacheWriteIops=poolWriteCacheWriteIops, fcTargetWriteMbps=fcTargetWriteMbps, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, nfsTotalWriteIops=nfsTotalWriteIops, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, poolTable=poolTable, nicName=nicName, lunGUID=lunGUID, shareQuotaLow=shareQuotaLow, spareDiskReplaced=spareDiskReplaced, iscsiTargetReadMbps=iscsiTargetReadMbps, projectDeletionFailed=projectDeletionFailed, smisServiceStarted=smisServiceStarted, diskTotalWriteMbps=diskTotalWriteMbps, shareDeleted=shareDeleted, cpuTotalUsage=cpuTotalUsage, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, notifications=notifications, nicTransmitMbps=nicTransmitMbps, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, projectTable=projectTable, haResourceIndex=haResourceIndex, fcInitiatorName=fcInitiatorName, shareDeletionFailed=shareDeletionFailed, shareMountPoint=shareMountPoint, fcTargetStatus=fcTargetStatus, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, poolTotalReadIops=poolTotalReadIops, poolReadCacheReadIops=poolReadCacheReadIops, poolExported=poolExported, projectName=projectName, projectSnapshotSizeHigh=projectSnapshotSizeHigh, targetGroupMemberRemoved=targetGroupMemberRemoved, shareQuotaHigh=shareQuotaHigh, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, poolDataReadLatency=poolDataReadLatency, lunSnapshotSizeHigh=lunSnapshotSizeHigh, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, diskCount=diskCount, targetGroupCreateCompleted=targetGroupCreateCompleted, nvdimmFailInitializationError=nvdimmFailInitializationError, diskError=diskError, nicState=nicState, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, poolMetaReadMbps=poolMetaReadMbps, poolDataWriteIops=poolDataWriteIops, vmwareNFSDatastores=vmwareNFSDatastores, lunSizeLow=lunSizeLow, iscsiTargetEntry=iscsiTargetEntry, webdocsUpgradeFailed=webdocsUpgradeFailed, diskSequentialIOCount=diskSequentialIOCount, projectFreeSizeLow=projectFreeSizeLow, diskAvgWriteLatency=diskAvgWriteLatency, fcTotalWriteIops=fcTotalWriteIops, shareNFSWriteIops=shareNFSWriteIops, controllerHardwareModel=controllerHardwareModel, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, haControllerB_Uptime=haControllerB_Uptime, nfsTotalReadIops=nfsTotalReadIops, nicEntry=nicEntry, diskSlowIo=diskSlowIo, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, poolMetaWriteIops=poolMetaWriteIops, iscsiTargets=iscsiTargets, ipmiVoltage=ipmiVoltage, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, iscsiTargetGroup=iscsiTargetGroup, fcAvgReadLatency=fcAvgReadLatency, fcTargetModifyCompleted=fcTargetModifyCompleted, poolUsedSizeHigh=poolUsedSizeHigh, diskPoolName=diskPoolName, snmpServiceStartFailed=snmpServiceStartFailed, lunProjectName=lunProjectName, fcInitiatorsTable=fcInitiatorsTable, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, pools=pools, disks=disks, diskDataWriteIops=diskDataWriteIops, snmpServiceStopFailed=snmpServiceStopFailed, aclMigrationCompleted=aclMigrationCompleted, snapshotCloningFailed=snapshotCloningFailed, snapshotDeleteFailed=snapshotDeleteFailed, nicIndex=nicIndex, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, haResourceActiveNode=haResourceActiveNode, lunCompressedRatio=lunCompressedRatio, cpuSystemCalls=cpuSystemCalls, smisServiceStartFailed=smisServiceStartFailed, fcInitiatorIndex=fcInitiatorIndex, poolDataSizeHigh=poolDataSizeHigh, cifsTotalWriteMbps=cifsTotalWriteMbps, shareNFSReadMbps=shareNFSReadMbps, fcTargetWriteLatency=fcTargetWriteLatency, shareExceedThresholdWarning=shareExceedThresholdWarning, lunInitiatorGroup=lunInitiatorGroup, iscsiTotalReadMbps=iscsiTotalReadMbps, projectQuotaSizeHigh=projectQuotaSizeHigh, poolReadCacheWriteMbps=poolReadCacheWriteMbps, notificationSeverity=notificationSeverity, fcTargetIndex=fcTargetIndex, shareCIFSReadIops=shareCIFSReadIops, projectDataSizeLow=projectDataSizeLow, poolMetaWriteMbps=poolMetaWriteMbps, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, haResourceGroup=haResourceGroup, ipmiFan=ipmiFan, networkIpmpGroupUp=networkIpmpGroupUp, poolUpgraded=poolUpgraded, snapshotCreationFailed=snapshotCreationFailed, ipmiOther=ipmiOther, nvdimmFailSoftError=nvdimmFailSoftError, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, nfsAvgWriteLatency=nfsAvgWriteLatency, notificationSensorAction=notificationSensorAction, fcTargetEntry=fcTargetEntry, shareNFSReadLatency=shareNFSReadLatency, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, diskState=diskState, shareNFSEnabled=shareNFSEnabled, tegileGroups=tegileGroups, sanProperties=sanProperties, lunFreeSizeHigh=lunFreeSizeHigh, poolProjects=poolProjects, notificationEventCode=notificationEventCode, nicMTU=nicMTU, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, nvdimmFailUnknownError=nvdimmFailUnknownError, iscsiTargetWriteMbps=iscsiTargetWriteMbps, cacheTotalWriteIops=cacheTotalWriteIops, poolDataReadMbps=poolDataReadMbps, iscsiInitiatorIndex=iscsiInitiatorIndex, nfsAvgReadLatency=nfsAvgReadLatency, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, poolEntry=poolEntry, lunSnapshotSizeLow=lunSnapshotSizeLow, iscsiTargetWriteIops=iscsiTargetWriteIops, fcTargetReadIops=fcTargetReadIops, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, diskEntry=diskEntry, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, replicationSourceRegistered=replicationSourceRegistered, notificationSensorNumber=notificationSensorNumber, cifsTotalReadMbps=cifsTotalReadMbps, projectCompressionEnabled=projectCompressionEnabled, iscsiTargetName=iscsiTargetName, fcTargetGroup=fcTargetGroup, currentNotificationGroup=currentNotificationGroup, snmpServiceStopped=snmpServiceStopped, fcTargetWriteIops=fcTargetWriteIops, iscsiTargetReadIops=iscsiTargetReadIops, poolSizeHigh=poolSizeHigh, adServerTimeDrift=adServerTimeDrift, iscsiTargetIndex=iscsiTargetIndex, aclMigrationStarted=aclMigrationStarted, iscsiTotalReadIops=iscsiTotalReadIops, poolReadCacheWriteIops=poolReadCacheWriteIops, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, initiatorGroupMemberAdded=initiatorGroupMemberAdded, notificationThresholdTriggerValue=notificationThresholdTriggerValue, ntpServerTimeDrift=ntpServerTimeDrift, fcProperties=fcProperties, fcTargetsTable=fcTargetsTable, poolDeleted=poolDeleted, iscsiTargetError=iscsiTargetError, notificationComponentName=notificationComponentName, projectPoolName=projectPoolName, iscsiWriteIops=iscsiWriteIops, poolImported=poolImported, iscsiInitiatorGroup=iscsiInitiatorGroup, volumeModifyCompleted=volumeModifyCompleted, iscsiTargetReadLatency=iscsiTargetReadLatency, fcInitiators=fcInitiators, cpuInterrupts=cpuInterrupts, tdpsUpgradeTimeout=tdpsUpgradeTimeout, notificationReadingUnit=notificationReadingUnit, shareProjectName=shareProjectName, shareReservedSizeLow=shareReservedSizeLow, basicCompliance=basicCompliance, nicGroup=nicGroup, poolProjectCount=poolProjectCount, iscsiTargetWriteLatency=iscsiTargetWriteLatency, diskTotalReadMbps=diskTotalReadMbps, poolExpanded=poolExpanded, poolMetaWriteLatency=poolMetaWriteLatency, fcTargetReadMbps=fcTargetReadMbps, cifsAvgWriteLatency=cifsAvgWriteLatency, cacheTotalReadMbps=cacheTotalReadMbps, projectDedupEnabled=projectDedupEnabled, notificationTargetEntityName=notificationTargetEntityName, diskTable=diskTable, volumeCreatedSuccessfully=volumeCreatedSuccessfully, userLoginFailed=userLoginFailed, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, network=network, lunFreeSizeLow=lunFreeSizeLow, replicationResumed=replicationResumed, poolMetaReadLatency=poolMetaReadLatency, poolHealth=poolHealth, notificationProps=notificationProps, shareIndex=shareIndex, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, cifsAvgReadLatency=cifsAvgReadLatency, diskChassisIdx=diskChassisIdx, smbSocketFailure=smbSocketFailure, PYSNMP_MODULE_ID=tegile, lunIndex=lunIndex, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, projectCreatedSuccessfully=projectCreatedSuccessfully, diskIOCount=diskIOCount, diskDataReadMbps=diskDataReadMbps, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, iscsiTargetGroupError=iscsiTargetGroupError, properties=properties, shareNFSWriteLatency=shareNFSWriteLatency, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, maintenanceModeEnabled=maintenanceModeEnabled, haResourceStatus=haResourceStatus)
mibBuilder.exportSymbols("TEGILE-MIB", poolAvgReadLatency=poolAvgReadLatency, replicationAborted=replicationAborted, shareCompressionEnabled=shareCompressionEnabled, alertsCleanupCompleted=alertsCleanupCompleted, haControllerA_IPAddr=haControllerA_IPAddr, diskGoneOffline=diskGoneOffline, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, fcTotalWriteMbps=fcTotalWriteMbps, nvdimmFailDeviceError=nvdimmFailDeviceError, projectThresholdExceedWarning=projectThresholdExceedWarning, volumeDeleteCompleted=volumeDeleteCompleted, tegileArray_notifications=tegileArray_notifications, controllerDown=controllerDown, projectLunCount=projectLunCount, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, fcInitiatorEntry=fcInitiatorEntry, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, replicationStarted=replicationStarted, lunProtocol=lunProtocol, shareCIFSWriteIops=shareCIFSWriteIops, fcInitiatorCreateFailed=fcInitiatorCreateFailed, ipmiCurrent=ipmiCurrent, haControllerB_IPAddr=haControllerB_IPAddr, intelliFlashSoftwareUp=intelliFlashSoftwareUp, poolDegraded=poolDegraded, diskAvgReadLatency=diskAvgReadLatency, diskIsOnline=diskIsOnline, sharePoolName=sharePoolName, nfsTotalReadMbps=nfsTotalReadMbps, fcTotalReadIops=fcTotalReadIops, snapshotRollbackFailed=snapshotRollbackFailed, poolTotalWriteMbps=poolTotalWriteMbps, shareCIFSWriteLatency=shareCIFSWriteLatency, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, haResources=haResources, testNotification=testNotification, webdocsUpgradeCompleted=webdocsUpgradeCompleted, nicReceiveMbps=nicReceiveMbps, shareCIFSReadLatency=shareCIFSReadLatency, maintenanceModeDisabled=maintenanceModeDisabled, fcAvgWriteLatency=fcAvgWriteLatency, lunReservedSizeHigh=lunReservedSizeHigh, controllerTimeDrift=controllerTimeDrift, iscsiInitiators=iscsiInitiators, ipmiThreshold=ipmiThreshold, haResourceName=haResourceName, projectEntry=projectEntry, notificationReadingTriggerValue=notificationReadingTriggerValue, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, upgradeDownloadFailed=upgradeDownloadFailed, projectLUNs=projectLUNs, cacheSSDReads=cacheSSDReads, iscsiTargetAlias=iscsiTargetAlias, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, poolDataWriteLatency=poolDataWriteLatency, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, upgradeDownloadStarted=upgradeDownloadStarted, haResourcesTable=haResourcesTable, tdpsUpgradeCompleted=tdpsUpgradeCompleted, snmpAgentVersion=snmpAgentVersion, cacheTotalReadIops=cacheTotalReadIops, deleteFolderCompleted=deleteFolderCompleted, notificationObjects=notificationObjects, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, replicationFailed=replicationFailed, shareDedupEnabled=shareDedupEnabled, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, volumeDeleteFailed=volumeDeleteFailed, diskSizeLow=diskSizeLow, sensorFailureEvent=sensorFailureEvent, tegileCompliances=tegileCompliances, poolMetaReadIops=poolMetaReadIops, replicationPaused=replicationPaused, poolTotalSaving=poolTotalSaving, lunTable=lunTable, poolCount=poolCount, currentObjectGroup=currentObjectGroup, iscsiTargetsTable=iscsiTargetsTable, replicationTargetDeleted=replicationTargetDeleted, diskRandomIOCount=diskRandomIOCount, poolIndex=poolIndex, globalStatistics=globalStatistics, lunEntry=lunEntry, poolDataReadIops=poolDataReadIops, diskType=diskType, lunReadMbps=lunReadMbps, shareCreatedSuccessfully=shareCreatedSuccessfully, poolFreeSizeLow=poolFreeSizeLow, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, networkIpmpGroupDown=networkIpmpGroupDown, projectShares=projectShares, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, cacheRAMReads=cacheRAMReads, intelliFlashSoftwareDown=intelliFlashSoftwareDown, networkInterfaceDown=networkInterfaceDown, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, nfsTotalWriteMbps=nfsTotalWriteMbps, ipmiPowerSupply=ipmiPowerSupply, projectModified=projectModified, projectShareCount=projectShareCount, notificationDescription=notificationDescription, upgradeFailed=upgradeFailed, shareEntry=shareEntry, projectIndex=projectIndex, targetGroupDeleteCompleted=targetGroupDeleteCompleted, lunTargetGroup=lunTargetGroup, shareDataSizeHigh=shareDataSizeHigh, shareCompressedRatio=shareCompressedRatio, lunDataSizeLow=lunDataSizeLow, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, shareReservedSizeHigh=shareReservedSizeHigh, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, unknownSensorEvent=unknownSensorEvent, networkTotalReceiveMbps=networkTotalReceiveMbps, lunSizeHigh=lunSizeHigh, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, snmpServiceStarted=snmpServiceStarted, shareNFSWriteMbps=shareNFSWriteMbps, lunWriteLatency=lunWriteLatency, lunWriteMbps=lunWriteMbps, shareCIFSEnabled=shareCIFSEnabled, shareQuotaFinished=shareQuotaFinished, lunBlockSize=lunBlockSize, ipmiTemperature=ipmiTemperature, iscsiInitiatorsTable=iscsiInitiatorsTable, deleteFolderFailed=deleteFolderFailed, diskIndex=diskIndex, fcTotalReadMbps=fcTotalReadMbps, projectDataSizeHigh=projectDataSizeHigh, poolDeletionFailed=poolDeletionFailed, memoryFailure=memoryFailure, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, iscsiInitiatorChapUser=iscsiInitiatorChapUser, projectQuotaFinished=projectQuotaFinished, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, haResourceEntry=haResourceEntry, notificationSensorSuspect=notificationSensorSuspect, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, netbiosSocketFailure=netbiosSocketFailure, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, fcTargets=fcTargets, lunReservedSizeLow=lunReservedSizeLow, poolDataSizeLow=poolDataSizeLow, diskTotalWriteIops=diskTotalWriteIops, poolDataWriteMbps=poolDataWriteMbps, diagnosticDataUploaded=diagnosticDataUploaded, iscsiInitiatorName=iscsiInitiatorName, iscsiProperties=iscsiProperties, projectSnapshotSizeLow=projectSnapshotSizeLow, volumeQuotaFinished=volumeQuotaFinished, iscsiImproperTargetGroup=iscsiImproperTargetGroup, lunName=lunName, iscsiAvgReadLatency=iscsiAvgReadLatency, smisServiceStopped=smisServiceStopped, controllerUp=controllerUp, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, targetGroupMemberAdded=targetGroupMemberAdded, fcPortOffline=fcPortOffline, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, poolState=poolState, haResourceDescription=haResourceDescription, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, poolFreeSizeHigh=poolFreeSizeHigh, tdpsUpgradeFailed=tdpsUpgradeFailed, diskTotalReadIops=diskTotalReadIops, shareName=shareName, lunDedupEnabled=lunDedupEnabled, poolQuotaFinished=poolQuotaFinished, lunCompressionEnabled=lunCompressionEnabled, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, iscsiTotalWriteMbps=iscsiTotalWriteMbps, shareCIFSReadMbps=shareCIFSReadMbps, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, diskDataReadIops=diskDataReadIops, shareDataSizeLow=shareDataSizeLow, poolName=poolName, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, ipmiCriticalInterrupt=ipmiCriticalInterrupt, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, iscsiAvgWriteLatency=iscsiAvgWriteLatency, ipmiMemory=ipmiMemory, shareTable=shareTable, lunWriteIops=lunWriteIops, poolAvgWriteLatency=poolAvgWriteLatency, poolOwnerController=poolOwnerController, upgradeStarted=upgradeStarted, projectQuotaSizeLow=projectQuotaSizeLow, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, projectTotalSaving=projectTotalSaving, diskSizeHigh=diskSizeHigh, shareCIFSWriteMbps=shareCIFSWriteMbps, haControllerB_Name=haControllerB_Name, poolSizeLow=poolSizeLow, lunPoolName=lunPoolName, fcTargetName=fcTargetName, tegileArray=tegileArray, poolTotalWriteIops=poolTotalWriteIops, cifsTotalWriteIops=cifsTotalWriteIops, lunReadIops=lunReadIops, haControllerA_Name=haControllerA_Name, iscsiInitiatorEntry=iscsiInitiatorEntry, snapshotRollbackCompleted=snapshotRollbackCompleted, shareSnapshotSizeLow=shareSnapshotSizeLow, cifsTotalReadIops=cifsTotalReadIops, diskDataWriteMbps=diskDataWriteMbps, cacheTotalWriteMbps=cacheTotalWriteMbps, fcTargetReadLatency=fcTargetReadLatency, projectFreeSizeHigh=projectFreeSizeHigh)
