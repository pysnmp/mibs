...
Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, enterprises, Counter64, Gauge32, MibIdentifier, IpAddress, iso, Bits, ModuleIdentity, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "enterprises", "Counter64", "Gauge32", "MibIdentifier", "IpAddress", "iso", "Bits", "ModuleIdentity", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("TEGILE-MIB", poolDataSizeLow=poolDataSizeLow, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, lunTargetGroup=lunTargetGroup, aclMigrationCompleted=aclMigrationCompleted, iscsiInitiatorsTable=iscsiInitiatorsTable, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, basicCompliance=basicCompliance, aclMigrationStarted=aclMigrationStarted, iscsiTotalReadIops=iscsiTotalReadIops, diskIndex=diskIndex, nfsTotalReadIops=nfsTotalReadIops, properties=properties, diskChassisIdx=diskChassisIdx, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, controllerUp=controllerUp, upgradeDownloadCompleted=upgradeDownloadCompleted, shareNFSWriteIops=shareNFSWriteIops, tdpsUpgradeTimeout=tdpsUpgradeTimeout, lunBlockSize=lunBlockSize, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, nicMTU=nicMTU, snapshotCloneCompleted=snapshotCloneCompleted, diskEntry=diskEntry, fcInitiatorGroup=fcInitiatorGroup, poolTotalWriteIops=poolTotalWriteIops, projectShareCount=projectShareCount, notificationTime=notificationTime, ntpServerTimeDrift=ntpServerTimeDrift, projectQuotaSizeLow=projectQuotaSizeLow, networkInterfaceUp=networkInterfaceUp, iscsiImproperTargetGroup=iscsiImproperTargetGroup, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, poolTotalReadIops=poolTotalReadIops, poolCount=poolCount, nfsAvgReadLatency=nfsAvgReadLatency, projectQuotaFinished=projectQuotaFinished, volumeDeleteCompleted=volumeDeleteCompleted, nicTable=nicTable, lunWriteLatency=lunWriteLatency, shareMountPoint=shareMountPoint, currentObjectGroup=currentObjectGroup, fcTargetReadLatency=fcTargetReadLatency, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, PYSNMP_MODULE_ID=tegile, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, tegileGroups=tegileGroups, diskDataWriteIops=diskDataWriteIops, poolReadCacheWriteLatency=poolReadCacheWriteLatency, iscsiTargets=iscsiTargets, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, lunWriteMbps=lunWriteMbps, deleteFolderCompleted=deleteFolderCompleted, notificationSensorAction=notificationSensorAction, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, notificationThresholdTriggerValue=notificationThresholdTriggerValue, poolEntry=poolEntry, haControllerB_IPAddr=haControllerB_IPAddr, projectDataSizeLow=projectDataSizeLow, fcAvgReadLatency=fcAvgReadLatency, fcTargets=fcTargets, upgradeDownloadFailed=upgradeDownloadFailed, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, fcTargetEntry=fcTargetEntry, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, projectPoolName=projectPoolName, webdocsUpgradeFailed=webdocsUpgradeFailed, replicationPaused=replicationPaused, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, fcTargetGroup=fcTargetGroup, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, snmpAgentVersion=snmpAgentVersion, poolUsedSizeLow=poolUsedSizeLow, haControllerA_Uptime=haControllerA_Uptime, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, poolExpanded=poolExpanded, diskAlias=diskAlias, shareSnapshotSizeLow=shareSnapshotSizeLow, tdpsUpgradeCompleted=tdpsUpgradeCompleted, poolMetaWriteMbps=poolMetaWriteMbps, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, projectQuotaSizeHigh=projectQuotaSizeHigh, lunPoolName=lunPoolName, cifsAvgReadLatency=cifsAvgReadLatency, fcTargetStatus=fcTargetStatus, replicationComplete=replicationComplete, networkIpmpGroupUp=networkIpmpGroupUp, shareExceedThresholdWarning=shareExceedThresholdWarning, snmpServiceStarted=snmpServiceStarted, iscsiInitiatorGroup=iscsiInitiatorGroup, maintenanceModeEnabled=maintenanceModeEnabled, iscsiAvgReadLatency=iscsiAvgReadLatency, lunTable=lunTable, replicationFailed=replicationFailed, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, fcTotalReadIops=fcTotalReadIops, poolDataWriteIops=poolDataWriteIops, poolDataReadIops=poolDataReadIops, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, shareCIFSEnabled=shareCIFSEnabled, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, poolMetaWriteLatency=poolMetaWriteLatency, shareCIFSReadIops=shareCIFSReadIops, fcTargetsTable=fcTargetsTable, notificationDescription=notificationDescription, iscsiTargetError=iscsiTargetError, iscsiTargetReadLatency=iscsiTargetReadLatency, upgradeStarted=upgradeStarted, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, lunDedupEnabled=lunDedupEnabled, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, projectDedupEnabled=projectDedupEnabled, shareCIFSReadLatency=shareCIFSReadLatency, haResourceActiveNode=haResourceActiveNode, sanProperties=sanProperties, haResourceIndex=haResourceIndex, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, diskError=diskError, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, snapshotCloningFailed=snapshotCloningFailed, projectIndex=projectIndex, shareNFSWriteLatency=shareNFSWriteLatency, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, diskIsOnline=diskIsOnline, lunProjectName=lunProjectName, fcPortOffline=fcPortOffline, fcInitiators=fcInitiators, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, lunReservedSizeLow=lunReservedSizeLow, iscsiTargetIndex=iscsiTargetIndex, lunSizeHigh=lunSizeHigh, networkIpmpGroupDown=networkIpmpGroupDown, targetGroupMemberAdded=targetGroupMemberAdded, haResourceStatus=haResourceStatus, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, iscsiWriteIops=iscsiWriteIops, fcInitiatorName=fcInitiatorName, fcTargetName=fcTargetName, poolMetaReadLatency=poolMetaReadLatency, shareName=shareName, cifsTotalReadMbps=cifsTotalReadMbps, poolDataReadLatency=poolDataReadLatency, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, diskGoneOffline=diskGoneOffline, poolReadCacheWriteIops=poolReadCacheWriteIops, controllerHardwareModel=controllerHardwareModel, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, shareDeletionFailed=shareDeletionFailed, adServerTimeDrift=adServerTimeDrift, shareEntry=shareEntry, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, ipmiOther=ipmiOther, nfsTotalWriteMbps=nfsTotalWriteMbps, ipmiPowerSupply=ipmiPowerSupply, notificationTargetEntityName=notificationTargetEntityName, snapshotCreationFailed=snapshotCreationFailed, lunDataSizeHigh=lunDataSizeHigh, nvdimmFailSoftError=nvdimmFailSoftError, poolReadCacheReadLatency=poolReadCacheReadLatency, replicationResumed=replicationResumed, tegileCompliances=tegileCompliances, lunProtocol=lunProtocol, poolProjectCount=poolProjectCount, nvdimmFailInitializationError=nvdimmFailInitializationError, shareCreatedSuccessfully=shareCreatedSuccessfully, volumeModifyCompleted=volumeModifyCompleted, poolIndex=poolIndex, diskTable=diskTable, poolExported=poolExported, notifications=notifications, notificationProps=notificationProps, poolDataSizeHigh=poolDataSizeHigh, diskAvgReadLatency=diskAvgReadLatency, poolUsedSizeHigh=poolUsedSizeHigh, projectFreeSizeLow=projectFreeSizeLow, upgradeFailed=upgradeFailed, iscsiTotalWriteMbps=iscsiTotalWriteMbps, shareDataSizeHigh=shareDataSizeHigh, unknownSensorEvent=unknownSensorEvent, tegileConformance=tegileConformance, diskCount=diskCount, poolQuotaFinished=poolQuotaFinished, projectSnapshotSizeLow=projectSnapshotSizeLow, replicationAborted=replicationAborted, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, cpuSystemCalls=cpuSystemCalls, sharePoolName=sharePoolName, ipmiFan=ipmiFan, cifsTotalWriteIops=cifsTotalWriteIops, intelliFlashSoftwareUp=intelliFlashSoftwareUp, poolDataWriteLatency=poolDataWriteLatency, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, upgradeDownloadStarted=upgradeDownloadStarted, iscsiTargetWriteIops=iscsiTargetWriteIops, smisServiceStopped=smisServiceStopped, poolUpgraded=poolUpgraded, notificationReadingTriggerValue=notificationReadingTriggerValue, poolSizeHigh=poolSizeHigh, fcTargetIndex=fcTargetIndex, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, poolReadCacheReadIops=poolReadCacheReadIops, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, smisServiceStartFailed=smisServiceStartFailed, shareCIFSWriteMbps=shareCIFSWriteMbps, lunSizeLow=lunSizeLow, projectThresholdExceedWarning=projectThresholdExceedWarning, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, notificationSensorNumber=notificationSensorNumber, haResourcesTable=haResourcesTable, lunName=lunName, shareNFSReadIops=shareNFSReadIops, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, poolDataReadMbps=poolDataReadMbps, shareCIFSReadMbps=shareCIFSReadMbps, shareCompressedRatio=shareCompressedRatio, iscsiTargetAlias=iscsiTargetAlias, ipmiCurrent=ipmiCurrent, cacheTotalWriteMbps=cacheTotalWriteMbps, targetGroupMemberRemoved=targetGroupMemberRemoved, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, poolSizeLow=poolSizeLow, ipmiVoltage=ipmiVoltage, poolTotalWriteMbps=poolTotalWriteMbps, iscsiTotalReadMbps=iscsiTotalReadMbps, diskTotalWriteIops=diskTotalWriteIops, nicTransmitMbps=nicTransmitMbps, webdocsUpgradeCompleted=webdocsUpgradeCompleted, maintenanceModeDisabled=maintenanceModeDisabled, poolAvgReadLatency=poolAvgReadLatency, projectLunCount=projectLunCount, notificationObjects=notificationObjects, cifsTotalReadIops=cifsTotalReadIops, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, projectName=projectName, projectCreatedSuccessfully=projectCreatedSuccessfully, projectModified=projectModified, controllerTimeDrift=controllerTimeDrift, haControllerA_IPAddr=haControllerA_IPAddr, tegileArray=tegileArray, projectTable=projectTable, projectDataSizeHigh=projectDataSizeHigh, poolWriteCacheWriteIops=poolWriteCacheWriteIops, shareSnapshotSizeHigh=shareSnapshotSizeHigh, projectLUNs=projectLUNs, shareReservedSizeHigh=shareReservedSizeHigh, cacheTotalWriteIops=cacheTotalWriteIops)
mibBuilder.exportSymbols("TEGILE-MIB", projectDeleted=projectDeleted, nvdimmFailUnknownError=nvdimmFailUnknownError, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, snmpServiceStopped=snmpServiceStopped, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, fcInitiatorCreateFailed=fcInitiatorCreateFailed, iscsiInitiators=iscsiInitiators, haResourceGroup=haResourceGroup, currentNotificationGroup=currentNotificationGroup, snapshotRollbackFailed=snapshotRollbackFailed, replicationStarted=replicationStarted, notificationEventCode=notificationEventCode, projectCompressionEnabled=projectCompressionEnabled, lunCompressionEnabled=lunCompressionEnabled, cpuTotalUsage=cpuTotalUsage, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, testNotification=testNotification, targetGroupDeleteCompleted=targetGroupDeleteCompleted, smisServiceStopFailed=smisServiceStopFailed, shareNFSReadMbps=shareNFSReadMbps, poolHealth=poolHealth, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, networkInterfaceDown=networkInterfaceDown, fcInitiatorEntry=fcInitiatorEntry, cpuInterrupts=cpuInterrupts, fcAvgWriteLatency=fcAvgWriteLatency, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, diskSizeLow=diskSizeLow, volumeCreatedSuccessfully=volumeCreatedSuccessfully, lunFreeSizeLow=lunFreeSizeLow, volumeDeleteFailed=volumeDeleteFailed, iscsiAvgWriteLatency=iscsiAvgWriteLatency, iscsiInitiatorEntry=iscsiInitiatorEntry, tegileArray_notifications=tegileArray_notifications, disks=disks, poolCreated=poolCreated, alertsCleanupCompleted=alertsCleanupCompleted, diskDataReadMbps=diskDataReadMbps, networkTotalTransmitMbps=networkTotalTransmitMbps, snmpServiceStartFailed=snmpServiceStartFailed, fcInitiatorIndex=fcInitiatorIndex, cacheTotalReadMbps=cacheTotalReadMbps, diskType=diskType, diskSequentialIOCount=diskSequentialIOCount, lunWriteIops=lunWriteIops, poolTotalReadMbps=poolTotalReadMbps, lunReadMbps=lunReadMbps, iscsiProperties=iscsiProperties, nvdimmFailDeviceError=nvdimmFailDeviceError, poolDeletionFailed=poolDeletionFailed, lunReservedSizeHigh=lunReservedSizeHigh, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, nicName=nicName, diskState=diskState, haControllerA_Name=haControllerA_Name, poolDegraded=poolDegraded, iscsiTargetEntry=iscsiTargetEntry, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, diskDataWriteMbps=diskDataWriteMbps, shareIndex=shareIndex, vmwareNFSDatastores=vmwareNFSDatastores, fcTotalWriteMbps=fcTotalWriteMbps, lunGUID=lunGUID, poolReadCacheReadMbps=poolReadCacheReadMbps, cacheTotalReadIops=cacheTotalReadIops, notificationReadingUnit=notificationReadingUnit, replicationSourceRegistered=replicationSourceRegistered, iscsiTargetAuth=iscsiTargetAuth, iscsiTargetReadIops=iscsiTargetReadIops, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, snmpServiceStopFailed=snmpServiceStopFailed, haControllerB_Uptime=haControllerB_Uptime, targetGroupCreateCompleted=targetGroupCreateCompleted, cifsAvgWriteLatency=cifsAvgWriteLatency, lunEntry=lunEntry, upgradeCompleted=upgradeCompleted, ipmiThreshold=ipmiThreshold, notificationSeverity=notificationSeverity, iscsiTargetName=iscsiTargetName, diskSizeHigh=diskSizeHigh, iscsiTargetReadMbps=iscsiTargetReadMbps, lunCompressedRatio=lunCompressedRatio, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, diskIOCount=diskIOCount, intelliFlashSoftwareDown=intelliFlashSoftwareDown, shareDedupEnabled=shareDedupEnabled, iscsiTargetWriteLatency=iscsiTargetWriteLatency, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, diskRandomIOCount=diskRandomIOCount, smisServiceStarted=smisServiceStarted, poolOwnerController=poolOwnerController, nfsAvgWriteLatency=nfsAvgWriteLatency, replicationAbandoned=replicationAbandoned, notificationSensorSuspect=notificationSensorSuspect, projectDeletionFailed=projectDeletionFailed, pools=pools, spareDiskReplaced=spareDiskReplaced, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, shareDeleted=shareDeleted, diskDataReadIops=diskDataReadIops, diskPoolName=diskPoolName, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, projectEntry=projectEntry, iscsiTargetWriteMbps=iscsiTargetWriteMbps, iscsiTargetGroupError=iscsiTargetGroupError, poolMetaReadIops=poolMetaReadIops, poolMetaWriteIops=poolMetaWriteIops, notificationComponentName=notificationComponentName, shareCIFSWriteIops=shareCIFSWriteIops, fcTargetReadIops=fcTargetReadIops, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, shareReservedSizeLow=shareReservedSizeLow, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, poolMetaReadMbps=poolMetaReadMbps, shareQuotaHigh=shareQuotaHigh, controllerDown=controllerDown, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, projectFreeSizeHigh=projectFreeSizeHigh, lunSnapshotSizeLow=lunSnapshotSizeLow, projectTotalSaving=projectTotalSaving, shareQuotaFinished=shareQuotaFinished, poolAvgWriteLatency=poolAvgWriteLatency, fcProperties=fcProperties, nicState=nicState, networkTotalReceiveMbps=networkTotalReceiveMbps, nicIndex=nicIndex, cacheSSDReads=cacheSSDReads, projectShares=projectShares, projectSnapshotSizeHigh=projectSnapshotSizeHigh, shareTable=shareTable, lunIndex=lunIndex, initiatorGroupMemberAdded=initiatorGroupMemberAdded, haResourceEntry=haResourceEntry, haResourceName=haResourceName, poolDataWriteMbps=poolDataWriteMbps, iscsiInitiatorName=iscsiInitiatorName, shareDataSizeLow=shareDataSizeLow, iscsiInitiatorChapUser=iscsiInitiatorChapUser, diagnosticDataUploaded=diagnosticDataUploaded, userLoginFailed=userLoginFailed, diskTotalReadIops=diskTotalReadIops, lunReadLatency=lunReadLatency, ipmiCriticalInterrupt=ipmiCriticalInterrupt, diskSlowIo=diskSlowIo, shareQuotaLow=shareQuotaLow, poolProjects=poolProjects, fcTargetWriteLatency=fcTargetWriteLatency, fcTotalWriteIops=fcTotalWriteIops, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, deleteFolderFailed=deleteFolderFailed, snapshotRollbackCompleted=snapshotRollbackCompleted, iscsiTargetGroup=iscsiTargetGroup, fcTargetReadMbps=fcTargetReadMbps, lunInitiatorGroup=lunInitiatorGroup, lunFreeSizeHigh=lunFreeSizeHigh, smbSocketFailure=smbSocketFailure, nfsTotalWriteIops=nfsTotalWriteIops, network=network, netbiosSocketFailure=netbiosSocketFailure, fcInitiatorsTable=fcInitiatorsTable, lunReadIops=lunReadIops, shareCIFSWriteLatency=shareCIFSWriteLatency, nicEntry=nicEntry, upgradeTimeout=upgradeTimeout, shareProjectName=shareProjectName, diskAvgWriteLatency=diskAvgWriteLatency, memoryFailure=memoryFailure, replicationTargetDeleted=replicationTargetDeleted, haResources=haResources, fcPortOnline=fcPortOnline, ipmiTemperature=ipmiTemperature, fcTargetModifyCompleted=fcTargetModifyCompleted, volumeQuotaFinished=volumeQuotaFinished, fcTargetWriteMbps=fcTargetWriteMbps, shareNFSEnabled=shareNFSEnabled, cifsTotalWriteMbps=cifsTotalWriteMbps, cacheRAMReads=cacheRAMReads, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, poolFreeSizeLow=poolFreeSizeLow, snapshotDeleteFailed=snapshotDeleteFailed, poolTotalSaving=poolTotalSaving, poolImported=poolImported, shareNFSReadLatency=shareNFSReadLatency, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, nicGroup=nicGroup, sensorFailureEvent=sensorFailureEvent, poolTable=poolTable, shareCompressionEnabled=shareCompressionEnabled, poolReadCacheWriteMbps=poolReadCacheWriteMbps, diskTotalWriteMbps=diskTotalWriteMbps, nicReceiveMbps=nicReceiveMbps, lunDataSizeLow=lunDataSizeLow, fcTargetWriteIops=fcTargetWriteIops, poolFreeSizeHigh=poolFreeSizeHigh, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, iscsiInitiatorIndex=iscsiInitiatorIndex, haResourceDescription=haResourceDescription, poolDeleted=poolDeleted, nfsTotalReadMbps=nfsTotalReadMbps, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, diskTotalReadMbps=diskTotalReadMbps, shareNFSWriteMbps=shareNFSWriteMbps, globalStatistics=globalStatistics, fcTotalReadMbps=fcTotalReadMbps, tdpsUpgradeFailed=tdpsUpgradeFailed, lunSnapshotSizeHigh=lunSnapshotSizeHigh, iscsiTargetsTable=iscsiTargetsTable, poolState=poolState, ipmiMemory=ipmiMemory, haControllerB_Name=haControllerB_Name, poolName=poolName, tegile=tegile)
