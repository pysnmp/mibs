...
# Produced by pysmi-1.1.10 at Fri Nov 10 08:56:33 2023
...
Counter32, iso, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, MibIdentifier, Integer32, Unsigned32, Gauge32, ObjectIdentity, enterprises, Bits, NotificationType, Counter64, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "iso", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "MibIdentifier", "Integer32", "Unsigned32", "Gauge32", "ObjectIdentity", "enterprises", "Bits", "NotificationType", "Counter64", "IpAddress")
...
mibBuilder.exportSymbols("TEGILE-MIB", lunEntry=lunEntry, projectFreeSizeHigh=projectFreeSizeHigh, poolWriteCacheWriteIops=poolWriteCacheWriteIops, cifsTotalWriteMbps=cifsTotalWriteMbps, shareDeleted=shareDeleted, replicationStarted=replicationStarted, shareCompressedRatio=shareCompressedRatio, userLoginFailed=userLoginFailed, iscsiTargetReadMbps=iscsiTargetReadMbps, poolTotalReadIops=poolTotalReadIops, lunSizeLow=lunSizeLow, tdpsUpgradeFailed=tdpsUpgradeFailed, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, fcTargetStatus=fcTargetStatus, upgradeTimeout=upgradeTimeout, cacheRAMReads=cacheRAMReads, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, lunWriteMbps=lunWriteMbps, poolMetaWriteIops=poolMetaWriteIops, snmpServiceStopFailed=snmpServiceStopFailed, lunPoolName=lunPoolName, shareNFSWriteMbps=shareNFSWriteMbps, ipmiVoltage=ipmiVoltage, ipmiCurrent=ipmiCurrent, currentObjectGroup=currentObjectGroup, notificationTime=notificationTime, projectIndex=projectIndex, controllerDown=controllerDown, lunInitiatorGroup=lunInitiatorGroup, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, fcTargetsTable=fcTargetsTable, shareQuotaLow=shareQuotaLow, snmpServiceStartFailed=snmpServiceStartFailed, volumeDeleteFailed=volumeDeleteFailed, nvdimmFailUnknownError=nvdimmFailUnknownError, adServerTimeDrift=adServerTimeDrift, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, fcAvgWriteLatency=fcAvgWriteLatency, projectEntry=projectEntry, upgradeDownloadFailed=upgradeDownloadFailed, fcTotalWriteMbps=fcTotalWriteMbps, nicGroup=nicGroup, iscsiInitiatorName=iscsiInitiatorName, tegileArray=tegileArray, shareCIFSReadLatency=shareCIFSReadLatency, testNotification=testNotification, fcTargetIndex=fcTargetIndex, shareCreatedSuccessfully=shareCreatedSuccessfully, ipmiCriticalInterrupt=ipmiCriticalInterrupt, projectQuotaSizeHigh=projectQuotaSizeHigh, projectDeletionFailed=projectDeletionFailed, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, currentNotificationGroup=currentNotificationGroup, vmwareNFSDatastores=vmwareNFSDatastores, fcInitiatorIndex=fcInitiatorIndex, ipmiThreshold=ipmiThreshold, nicTable=nicTable, upgradeStarted=upgradeStarted, fcTotalReadIops=fcTotalReadIops, poolDeleted=poolDeleted, diskDataReadIops=diskDataReadIops, nicEntry=nicEntry, poolHealth=poolHealth, diskSlowIo=diskSlowIo, nfsTotalReadMbps=nfsTotalReadMbps, haControllerB_Name=haControllerB_Name, fcProperties=fcProperties, notificationReadingTriggerValue=notificationReadingTriggerValue, fcTargets=fcTargets, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, diskAlias=diskAlias, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, poolReadCacheReadLatency=poolReadCacheReadLatency, notificationObjects=notificationObjects, iscsiTargetAuth=iscsiTargetAuth, replicationAborted=replicationAborted, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, cacheTotalReadIops=cacheTotalReadIops, haControllerA_Name=haControllerA_Name, haControllerA_Uptime=haControllerA_Uptime, networkTotalReceiveMbps=networkTotalReceiveMbps, fcInitiatorName=fcInitiatorName, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, projectDeleted=projectDeleted, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, lunFreeSizeLow=lunFreeSizeLow, PYSNMP_MODULE_ID=tegile, diskDataWriteIops=diskDataWriteIops, fcInitiators=fcInitiators, snapshotCreationFailed=snapshotCreationFailed, smisServiceStartFailed=smisServiceStartFailed, poolState=poolState, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, projectShares=projectShares, poolDataWriteMbps=poolDataWriteMbps, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, iscsiTargetAlias=iscsiTargetAlias, diagnosticDataUploaded=diagnosticDataUploaded, notificationProps=notificationProps, projectLUNs=projectLUNs, aclMigrationCompleted=aclMigrationCompleted, iscsiTargetGroupError=iscsiTargetGroupError, replicationComplete=replicationComplete, shareReservedSizeLow=shareReservedSizeLow, cacheTotalWriteIops=cacheTotalWriteIops, shareCIFSWriteIops=shareCIFSWriteIops, nfsTotalReadIops=nfsTotalReadIops, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, shareQuotaHigh=shareQuotaHigh, shareExceedThresholdWarning=shareExceedThresholdWarning, haResourceEntry=haResourceEntry, iscsiTargetsTable=iscsiTargetsTable, projectFreeSizeLow=projectFreeSizeLow, spareDiskReplaced=spareDiskReplaced, fcTargetWriteIops=fcTargetWriteIops, projectQuotaSizeLow=projectQuotaSizeLow, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, lunDataSizeHigh=lunDataSizeHigh, poolOwnerController=poolOwnerController, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, tdpsUpgradeCompleted=tdpsUpgradeCompleted, fcPortOffline=fcPortOffline, haResourceGroup=haResourceGroup, fcInitiatorCreateFailed=fcInitiatorCreateFailed, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, lunReadLatency=lunReadLatency, shareName=shareName, iscsiInitiatorIndex=iscsiInitiatorIndex, lunDataSizeLow=lunDataSizeLow, iscsiTargetWriteLatency=iscsiTargetWriteLatency, projectThresholdExceedWarning=projectThresholdExceedWarning, shareIndex=shareIndex, unknownSensorEvent=unknownSensorEvent, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, shareDataSizeLow=shareDataSizeLow, haResourceDescription=haResourceDescription, diskType=diskType, diskSequentialIOCount=diskSequentialIOCount, targetGroupCreateCompleted=targetGroupCreateCompleted, poolEntry=poolEntry, diskTotalWriteMbps=diskTotalWriteMbps, poolDataReadMbps=poolDataReadMbps, cifsAvgWriteLatency=cifsAvgWriteLatency, fcInitiatorGroup=fcInitiatorGroup, poolUsedSizeLow=poolUsedSizeLow, fcTargetModifyCompleted=fcTargetModifyCompleted, haControllerB_IPAddr=haControllerB_IPAddr, shareSnapshotSizeHigh=shareSnapshotSizeHigh, shareDataSizeHigh=shareDataSizeHigh, projectPoolName=projectPoolName, ipmiFan=ipmiFan, haResourceActiveNode=haResourceActiveNode, cifsTotalWriteIops=cifsTotalWriteIops, networkInterfaceUp=networkInterfaceUp, poolTotalWriteIops=poolTotalWriteIops, targetGroupDeleteCompleted=targetGroupDeleteCompleted, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, fcAvgReadLatency=fcAvgReadLatency, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, shareDedupEnabled=shareDedupEnabled, poolProjectCount=poolProjectCount, controllerTimeDrift=controllerTimeDrift, diskTotalReadIops=diskTotalReadIops, smisServiceStopFailed=smisServiceStopFailed, poolFreeSizeHigh=poolFreeSizeHigh, poolMetaReadIops=poolMetaReadIops, cifsAvgReadLatency=cifsAvgReadLatency, nfsTotalWriteMbps=nfsTotalWriteMbps, diskAvgWriteLatency=diskAvgWriteLatency, targetGroupMemberAdded=targetGroupMemberAdded, diskTotalWriteIops=diskTotalWriteIops, poolDataWriteLatency=poolDataWriteLatency, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, upgradeFailed=upgradeFailed, cifsTotalReadMbps=cifsTotalReadMbps, lunReservedSizeLow=lunReservedSizeLow, poolReadCacheWriteMbps=poolReadCacheWriteMbps, lunSizeHigh=lunSizeHigh, fcTargetWriteLatency=fcTargetWriteLatency, projectDedupEnabled=projectDedupEnabled, initiatorGroupMemberAdded=initiatorGroupMemberAdded, volumeModifyCompleted=volumeModifyCompleted, iscsiProperties=iscsiProperties, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, lunSnapshotSizeHigh=lunSnapshotSizeHigh, nicState=nicState, intelliFlashSoftwareUp=intelliFlashSoftwareUp, snapshotRollbackFailed=snapshotRollbackFailed, poolUsedSizeHigh=poolUsedSizeHigh, shareReservedSizeHigh=shareReservedSizeHigh, shareNFSReadMbps=shareNFSReadMbps, networkTotalTransmitMbps=networkTotalTransmitMbps, deleteFolderFailed=deleteFolderFailed, fcInitiatorsTable=fcInitiatorsTable, shareCIFSWriteMbps=shareCIFSWriteMbps, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, lunTable=lunTable, haResources=haResources, nicMTU=nicMTU, diskTotalReadMbps=diskTotalReadMbps, haResourcesTable=haResourcesTable, fcTargetWriteMbps=fcTargetWriteMbps, projectTotalSaving=projectTotalSaving, projectDataSizeHigh=projectDataSizeHigh, lunTargetGroup=lunTargetGroup, shareNFSEnabled=shareNFSEnabled, iscsiTotalReadIops=iscsiTotalReadIops, controllerHardwareModel=controllerHardwareModel, webdocsUpgradeCompleted=webdocsUpgradeCompleted, poolDeletionFailed=poolDeletionFailed, shareCIFSWriteLatency=shareCIFSWriteLatency, nicName=nicName, poolReadCacheReadMbps=poolReadCacheReadMbps, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, replicationSourceRegistered=replicationSourceRegistered, poolIndex=poolIndex, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, cpuInterrupts=cpuInterrupts, iscsiTargetName=iscsiTargetName, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, lunIndex=lunIndex, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, cacheSSDReads=cacheSSDReads, pools=pools, poolMetaWriteLatency=poolMetaWriteLatency, iscsiTargetEntry=iscsiTargetEntry, snmpServiceStarted=snmpServiceStarted, diskRandomIOCount=diskRandomIOCount, notificationTargetEntityName=notificationTargetEntityName, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, poolMetaReadLatency=poolMetaReadLatency, upgradeDownloadStarted=upgradeDownloadStarted, notificationSensorAction=notificationSensorAction, iscsiInitiators=iscsiInitiators, haControllerA_IPAddr=haControllerA_IPAddr, lunGUID=lunGUID, projectSnapshotSizeHigh=projectSnapshotSizeHigh, iscsiAvgReadLatency=iscsiAvgReadLatency, poolSizeLow=poolSizeLow, deleteFolderCompleted=deleteFolderCompleted, cacheTotalWriteMbps=cacheTotalWriteMbps, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, diskGoneOffline=diskGoneOffline, haResourceName=haResourceName, iscsiImproperTargetGroup=iscsiImproperTargetGroup, tegileCompliances=tegileCompliances, projectQuotaFinished=projectQuotaFinished, lunReservedSizeHigh=lunReservedSizeHigh, lunName=lunName, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, lunCompressionEnabled=lunCompressionEnabled, poolDataSizeLow=poolDataSizeLow)
mibBuilder.exportSymbols("TEGILE-MIB", diskCount=diskCount, projectName=projectName, iscsiAvgWriteLatency=iscsiAvgWriteLatency, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, poolQuotaFinished=poolQuotaFinished, nfsAvgWriteLatency=nfsAvgWriteLatency, diskAvgReadLatency=diskAvgReadLatency, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, poolName=poolName, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, smbSocketFailure=smbSocketFailure, shareMountPoint=shareMountPoint, network=network, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, basicCompliance=basicCompliance, nvdimmFailInitializationError=nvdimmFailInitializationError, diskEntry=diskEntry, tdpsUpgradeTimeout=tdpsUpgradeTimeout, iscsiInitiatorEntry=iscsiInitiatorEntry, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, poolDataReadLatency=poolDataReadLatency, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, lunCompressedRatio=lunCompressedRatio, sharePoolName=sharePoolName, replicationTargetDeleted=replicationTargetDeleted, notificationComponentName=notificationComponentName, poolAvgWriteLatency=poolAvgWriteLatency, poolTable=poolTable, nfsAvgReadLatency=nfsAvgReadLatency, volumeCreatedSuccessfully=volumeCreatedSuccessfully, tegileArray_notifications=tegileArray_notifications, targetGroupMemberRemoved=targetGroupMemberRemoved, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, iscsiInitiatorGroup=iscsiInitiatorGroup, notificationThresholdTriggerValue=notificationThresholdTriggerValue, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, fcTargetGroup=fcTargetGroup, shareDeletionFailed=shareDeletionFailed, haControllerB_Uptime=haControllerB_Uptime, diskPoolName=diskPoolName, poolTotalReadMbps=poolTotalReadMbps, lunDedupEnabled=lunDedupEnabled, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, ipmiTemperature=ipmiTemperature, nicTransmitMbps=nicTransmitMbps, iscsiTargetGroup=iscsiTargetGroup, notificationSensorNumber=notificationSensorNumber, nicReceiveMbps=nicReceiveMbps, nvdimmFailSoftError=nvdimmFailSoftError, iscsiTargetReadLatency=iscsiTargetReadLatency, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, snapshotDeleteFailed=snapshotDeleteFailed, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, poolUpgraded=poolUpgraded, lunProjectName=lunProjectName, cpuTotalUsage=cpuTotalUsage, smisServiceStarted=smisServiceStarted, lunProtocol=lunProtocol, poolReadCacheWriteLatency=poolReadCacheWriteLatency, shareNFSReadLatency=shareNFSReadLatency, iscsiTargetIndex=iscsiTargetIndex, diskIsOnline=diskIsOnline, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, shareSnapshotSizeLow=shareSnapshotSizeLow, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, ntpServerTimeDrift=ntpServerTimeDrift, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, poolExpanded=poolExpanded, poolDataWriteIops=poolDataWriteIops, shareTable=shareTable, upgradeDownloadCompleted=upgradeDownloadCompleted, shareCIFSReadMbps=shareCIFSReadMbps, iscsiTargetWriteMbps=iscsiTargetWriteMbps, poolDegraded=poolDegraded, fcTargetReadIops=fcTargetReadIops, iscsiInitiatorsTable=iscsiInitiatorsTable, alertsCleanupCompleted=alertsCleanupCompleted, networkIpmpGroupDown=networkIpmpGroupDown, poolImported=poolImported, iscsiTargetWriteIops=iscsiTargetWriteIops, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, lunReadMbps=lunReadMbps, poolDataSizeHigh=poolDataSizeHigh, iscsiInitiatorChapUser=iscsiInitiatorChapUser, lunWriteIops=lunWriteIops, diskDataWriteMbps=diskDataWriteMbps, notifications=notifications, projectCreatedSuccessfully=projectCreatedSuccessfully, snapshotCloningFailed=snapshotCloningFailed, shareNFSReadIops=shareNFSReadIops, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, poolCount=poolCount, shareCompressionEnabled=shareCompressionEnabled, poolSizeHigh=poolSizeHigh, shareQuotaFinished=shareQuotaFinished, fcTotalReadMbps=fcTotalReadMbps, lunWriteLatency=lunWriteLatency, tegileConformance=tegileConformance, diskDataReadMbps=diskDataReadMbps, fcTargetReadMbps=fcTargetReadMbps, poolMetaReadMbps=poolMetaReadMbps, volumeDeleteCompleted=volumeDeleteCompleted, iscsiTotalWriteMbps=iscsiTotalWriteMbps, lunSnapshotSizeLow=lunSnapshotSizeLow, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, fcPortOnline=fcPortOnline, diskTable=diskTable, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, poolExported=poolExported, diskSizeHigh=diskSizeHigh, poolDataReadIops=poolDataReadIops, poolCreated=poolCreated, replicationPaused=replicationPaused, networkInterfaceDown=networkInterfaceDown, diskState=diskState, poolFreeSizeLow=poolFreeSizeLow, shareNFSWriteIops=shareNFSWriteIops, fcInitiatorEntry=fcInitiatorEntry, ipmiPowerSupply=ipmiPowerSupply, iscsiTotalReadMbps=iscsiTotalReadMbps, nfsTotalWriteIops=nfsTotalWriteIops, networkIpmpGroupUp=networkIpmpGroupUp, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, projectCompressionEnabled=projectCompressionEnabled, poolTotalSaving=poolTotalSaving, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, projectModified=projectModified, notificationSeverity=notificationSeverity, projectDataSizeLow=projectDataSizeLow, poolReadCacheReadIops=poolReadCacheReadIops, fcTotalWriteIops=fcTotalWriteIops, notificationSensorSuspect=notificationSensorSuspect, aclMigrationStarted=aclMigrationStarted, cacheTotalReadMbps=cacheTotalReadMbps, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, shareCIFSEnabled=shareCIFSEnabled, cifsTotalReadIops=cifsTotalReadIops, poolMetaWriteMbps=poolMetaWriteMbps, projectTable=projectTable, shareCIFSReadIops=shareCIFSReadIops, smisServiceStopped=smisServiceStopped, poolProjects=poolProjects, volumeQuotaFinished=volumeQuotaFinished, controllerUp=controllerUp, globalStatistics=globalStatistics, diskChassisIdx=diskChassisIdx, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, sanProperties=sanProperties, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, memoryFailure=memoryFailure, notificationReadingUnit=notificationReadingUnit, replicationFailed=replicationFailed, diskIOCount=diskIOCount, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, ipmiMemory=ipmiMemory, projectLunCount=projectLunCount, projectSnapshotSizeLow=projectSnapshotSizeLow, tegileGroups=tegileGroups, properties=properties, maintenanceModeEnabled=maintenanceModeEnabled, sensorFailureEvent=sensorFailureEvent, lunBlockSize=lunBlockSize, disks=disks, tegile=tegile, fcTargetReadLatency=fcTargetReadLatency, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, nvdimmFailDeviceError=nvdimmFailDeviceError, netbiosSocketFailure=netbiosSocketFailure, iscsiTargetError=iscsiTargetError, ipmiOther=ipmiOther, notificationDescription=notificationDescription, poolTotalWriteMbps=poolTotalWriteMbps, diskSizeLow=diskSizeLow, snapshotCloneCompleted=snapshotCloneCompleted, upgradeCompleted=upgradeCompleted, iscsiTargets=iscsiTargets, poolAvgReadLatency=poolAvgReadLatency, diskIndex=diskIndex, shareEntry=shareEntry, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, maintenanceModeDisabled=maintenanceModeDisabled, lunReadIops=lunReadIops, webdocsUpgradeFailed=webdocsUpgradeFailed, shareNFSWriteLatency=shareNFSWriteLatency, notificationEventCode=notificationEventCode, diskError=diskError, projectShareCount=projectShareCount, iscsiTargetReadIops=iscsiTargetReadIops, fcTargetName=fcTargetName, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, snmpServiceStopped=snmpServiceStopped, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, lunFreeSizeHigh=lunFreeSizeHigh, nicIndex=nicIndex, cpuSystemCalls=cpuSystemCalls, replicationResumed=replicationResumed, snapshotRollbackCompleted=snapshotRollbackCompleted, haResourceIndex=haResourceIndex, iscsiWriteIops=iscsiWriteIops, poolReadCacheWriteIops=poolReadCacheWriteIops, replicationAbandoned=replicationAbandoned, shareProjectName=shareProjectName, intelliFlashSoftwareDown=intelliFlashSoftwareDown, haResourceStatus=haResourceStatus, fcTargetEntry=fcTargetEntry, snmpAgentVersion=snmpAgentVersion)
