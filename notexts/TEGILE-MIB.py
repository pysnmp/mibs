...
Counter32, ObjectIdentity, IpAddress, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Gauge32, Counter64, Bits, ModuleIdentity, NotificationType, MibIdentifier, TimeTicks, iso, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ObjectIdentity", "IpAddress", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Gauge32", "Counter64", "Bits", "ModuleIdentity", "NotificationType", "MibIdentifier", "TimeTicks", "iso", "enterprises")
...
mibBuilder.exportSymbols("TEGILE-MIB", poolSizeHigh=poolSizeHigh, notificationReadingUnit=notificationReadingUnit, poolReadCacheWriteIops=poolReadCacheWriteIops, basicCompliance=basicCompliance, tegile=tegile, replicationAbandoned=replicationAbandoned, shareSnapshotSizeLow=shareSnapshotSizeLow, poolAvgWriteLatency=poolAvgWriteLatency, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, poolCreated=poolCreated, diskSequentialIOCount=diskSequentialIOCount, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, diskRandomIOCount=diskRandomIOCount, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, intelliFlashSoftwareUp=intelliFlashSoftwareUp, shareEntry=shareEntry, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, projectDeletionFailed=projectDeletionFailed, projectModified=projectModified, iscsiInitiatorsTable=iscsiInitiatorsTable, upgradeFailed=upgradeFailed, diskDataWriteIops=diskDataWriteIops, diskAlias=diskAlias, haControllerB_IPAddr=haControllerB_IPAddr, ntpServerTimeDrift=ntpServerTimeDrift, targetGroupDeleteCompleted=targetGroupDeleteCompleted, lunInitiatorGroup=lunInitiatorGroup, fcTargetReadIops=fcTargetReadIops, iscsiTargetAlias=iscsiTargetAlias, haControllerB_Uptime=haControllerB_Uptime, lunIndex=lunIndex, projectSnapshotSizeLow=projectSnapshotSizeLow, projectFreeSizeLow=projectFreeSizeLow, poolQuotaFinished=poolQuotaFinished, cifsAvgWriteLatency=cifsAvgWriteLatency, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, shareNFSWriteMbps=shareNFSWriteMbps, poolDataSizeHigh=poolDataSizeHigh, lunTargetGroup=lunTargetGroup, ipmiMemory=ipmiMemory, targetGroupMemberAdded=targetGroupMemberAdded, nicMTU=nicMTU, deleteFolderCompleted=deleteFolderCompleted, lunProjectName=lunProjectName, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, poolName=poolName, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, fcTargetReadMbps=fcTargetReadMbps, poolExported=poolExported, smisServiceStopFailed=smisServiceStopFailed, adServerTimeDrift=adServerTimeDrift, haControllerA_Name=haControllerA_Name, cpuInterrupts=cpuInterrupts, fcTargets=fcTargets, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, ipmiVoltage=ipmiVoltage, diskSlowIo=diskSlowIo, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, projectThresholdExceedWarning=projectThresholdExceedWarning, poolDataWriteIops=poolDataWriteIops, lunFreeSizeLow=lunFreeSizeLow, projectCompressionEnabled=projectCompressionEnabled, poolCount=poolCount, initiatorGroupMemberAdded=initiatorGroupMemberAdded, poolFreeSizeLow=poolFreeSizeLow, replicationComplete=replicationComplete, ipmiOther=ipmiOther, poolUsedSizeLow=poolUsedSizeLow, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, tegileArray=tegileArray, nicState=nicState, iscsiInitiatorGroup=iscsiInitiatorGroup, smisServiceStopped=smisServiceStopped, snapshotDeleteFailed=snapshotDeleteFailed, nfsTotalReadMbps=nfsTotalReadMbps, shareCIFSReadMbps=shareCIFSReadMbps, diskAvgReadLatency=diskAvgReadLatency, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, cifsTotalWriteIops=cifsTotalWriteIops, cacheTotalReadMbps=cacheTotalReadMbps, shareNFSWriteLatency=shareNFSWriteLatency, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, iscsiTargetName=iscsiTargetName, haResources=haResources, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, haResourceDescription=haResourceDescription, fcAvgReadLatency=fcAvgReadLatency, projectTotalSaving=projectTotalSaving, fcTargetName=fcTargetName, diskEntry=diskEntry, iscsiTargetIndex=iscsiTargetIndex, diskAvgWriteLatency=diskAvgWriteLatency, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, webdocsUpgradeCompleted=webdocsUpgradeCompleted, notificationObjects=notificationObjects, diskTotalReadMbps=diskTotalReadMbps, lunReadIops=lunReadIops, nicIndex=nicIndex, diagnosticDataUploaded=diagnosticDataUploaded, poolMetaReadLatency=poolMetaReadLatency, iscsiWriteIops=iscsiWriteIops, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, shareCIFSWriteIops=shareCIFSWriteIops, upgradeDownloadCompleted=upgradeDownloadCompleted, poolUpgraded=poolUpgraded, fcInitiatorIndex=fcInitiatorIndex, poolReadCacheReadIops=poolReadCacheReadIops, upgradeCompleted=upgradeCompleted, fcTargetReadLatency=fcTargetReadLatency, ipmiFan=ipmiFan, fcTargetWriteIops=fcTargetWriteIops, iscsiTargetWriteMbps=iscsiTargetWriteMbps, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, poolProjectCount=poolProjectCount, shareMountPoint=shareMountPoint, replicationSourceRegistered=replicationSourceRegistered, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, sharePoolName=sharePoolName, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, volumeCreatedSuccessfully=volumeCreatedSuccessfully, volumeModifyCompleted=volumeModifyCompleted, shareDedupEnabled=shareDedupEnabled, shareNFSReadLatency=shareNFSReadLatency, nfsTotalWriteMbps=nfsTotalWriteMbps, fcInitiatorCreateFailed=fcInitiatorCreateFailed, shareCIFSEnabled=shareCIFSEnabled, vmwareNFSDatastores=vmwareNFSDatastores, smbSocketFailure=smbSocketFailure, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, lunSnapshotSizeLow=lunSnapshotSizeLow, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, fcTotalReadMbps=fcTotalReadMbps, lunReadMbps=lunReadMbps, diskError=diskError, snapshotRollbackCompleted=snapshotRollbackCompleted, targetGroupCreateCompleted=targetGroupCreateCompleted, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, shareDeletionFailed=shareDeletionFailed, nfsAvgReadLatency=nfsAvgReadLatency, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, haControllerA_Uptime=haControllerA_Uptime, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, disks=disks, poolDeletionFailed=poolDeletionFailed, haResourceName=haResourceName, shareCIFSWriteLatency=shareCIFSWriteLatency, nvdimmFailDeviceError=nvdimmFailDeviceError, tegileGroups=tegileGroups, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, cacheSSDReads=cacheSSDReads, poolProjects=poolProjects, lunBlockSize=lunBlockSize, iscsiInitiatorChapUser=iscsiInitiatorChapUser, fcInitiatorEntry=fcInitiatorEntry, aclMigrationCompleted=aclMigrationCompleted, poolFreeSizeHigh=poolFreeSizeHigh, projectQuotaSizeLow=projectQuotaSizeLow, tegileConformance=tegileConformance, shareIndex=shareIndex, testNotification=testNotification, haResourcesTable=haResourcesTable, notificationEventCode=notificationEventCode, upgradeStarted=upgradeStarted, netbiosSocketFailure=netbiosSocketFailure, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, projectCreatedSuccessfully=projectCreatedSuccessfully, iscsiAvgWriteLatency=iscsiAvgWriteLatency, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, haResourceStatus=haResourceStatus, tdpsUpgradeFailed=tdpsUpgradeFailed, lunFreeSizeHigh=lunFreeSizeHigh, nicEntry=nicEntry, poolDataReadIops=poolDataReadIops, cifsTotalReadMbps=cifsTotalReadMbps, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, diskPoolName=diskPoolName, poolTotalReadIops=poolTotalReadIops, poolReadCacheReadMbps=poolReadCacheReadMbps, poolTotalSaving=poolTotalSaving, ipmiTemperature=ipmiTemperature, fcTotalReadIops=fcTotalReadIops, poolWriteCacheWriteIops=poolWriteCacheWriteIops, lunTable=lunTable, fcAvgWriteLatency=fcAvgWriteLatency, lunEntry=lunEntry, iscsiInitiatorEntry=iscsiInitiatorEntry, iscsiAvgReadLatency=iscsiAvgReadLatency, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, iscsiTargets=iscsiTargets, fcTargetWriteLatency=fcTargetWriteLatency, lunSizeLow=lunSizeLow, lunWriteMbps=lunWriteMbps, smisServiceStarted=smisServiceStarted, notificationTime=notificationTime, shareNFSWriteIops=shareNFSWriteIops, ipmiCriticalInterrupt=ipmiCriticalInterrupt, poolTotalWriteMbps=poolTotalWriteMbps, diskState=diskState, shareCompressionEnabled=shareCompressionEnabled, networkTotalReceiveMbps=networkTotalReceiveMbps, snapshotCloningFailed=snapshotCloningFailed, notificationProps=notificationProps, snmpServiceStartFailed=snmpServiceStartFailed, poolAvgReadLatency=poolAvgReadLatency, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, diskDataReadIops=diskDataReadIops, cacheTotalWriteIops=cacheTotalWriteIops, fcTargetIndex=fcTargetIndex, projectName=projectName, haResourceGroup=haResourceGroup, poolDataWriteMbps=poolDataWriteMbps, snmpServiceStarted=snmpServiceStarted, poolUsedSizeHigh=poolUsedSizeHigh, lunDedupEnabled=lunDedupEnabled, nicTable=nicTable, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, shareNFSReadMbps=shareNFSReadMbps, iscsiInitiators=iscsiInitiators, diskIndex=diskIndex, haResourceEntry=haResourceEntry, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, iscsiTotalWriteMbps=iscsiTotalWriteMbps, tegileCompliances=tegileCompliances, volumeQuotaFinished=volumeQuotaFinished, upgradeTimeout=upgradeTimeout, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, haControllerA_IPAddr=haControllerA_IPAddr, volumeDeleteFailed=volumeDeleteFailed, diskIsOnline=diskIsOnline, networkInterfaceDown=networkInterfaceDown, tdpsUpgradeTimeout=tdpsUpgradeTimeout, properties=properties, sanProperties=sanProperties, ipmiPowerSupply=ipmiPowerSupply, projectIndex=projectIndex, snapshotCreationFailed=snapshotCreationFailed, nvdimmFailInitializationError=nvdimmFailInitializationError, lunSnapshotSizeHigh=lunSnapshotSizeHigh, poolExpanded=poolExpanded, iscsiInitiatorIndex=iscsiInitiatorIndex, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, aclMigrationStarted=aclMigrationStarted, poolState=poolState, webdocsUpgradeFailed=webdocsUpgradeFailed, shareTable=shareTable, iscsiTargetReadLatency=iscsiTargetReadLatency, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, diskType=diskType, notificationSensorNumber=notificationSensorNumber, iscsiTargetWriteIops=iscsiTargetWriteIops, notifications=notifications)
mibBuilder.exportSymbols("TEGILE-MIB", ipmiThreshold=ipmiThreshold, iscsiTargetsTable=iscsiTargetsTable, fcTargetStatus=fcTargetStatus, fcTotalWriteIops=fcTotalWriteIops, shareCreatedSuccessfully=shareCreatedSuccessfully, shareReservedSizeLow=shareReservedSizeLow, shareQuotaHigh=shareQuotaHigh, shareQuotaFinished=shareQuotaFinished, projectDedupEnabled=projectDedupEnabled, smisServiceStartFailed=smisServiceStartFailed, controllerHardwareModel=controllerHardwareModel, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, alertsCleanupCompleted=alertsCleanupCompleted, replicationAborted=replicationAborted, fcInitiatorGroup=fcInitiatorGroup, currentNotificationGroup=currentNotificationGroup, spareDiskReplaced=spareDiskReplaced, lunReadLatency=lunReadLatency, poolDataWriteLatency=poolDataWriteLatency, notificationSensorAction=notificationSensorAction, projectSnapshotSizeHigh=projectSnapshotSizeHigh, snapshotCloneCompleted=snapshotCloneCompleted, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, replicationFailed=replicationFailed, upgradeDownloadStarted=upgradeDownloadStarted, iscsiTargetReadIops=iscsiTargetReadIops, lunGUID=lunGUID, haResourceActiveNode=haResourceActiveNode, poolMetaReadIops=poolMetaReadIops, deleteFolderFailed=deleteFolderFailed, controllerDown=controllerDown, nicTransmitMbps=nicTransmitMbps, networkIpmpGroupDown=networkIpmpGroupDown, shareSnapshotSizeHigh=shareSnapshotSizeHigh, shareDataSizeHigh=shareDataSizeHigh, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, fcTargetModifyCompleted=fcTargetModifyCompleted, nvdimmFailUnknownError=nvdimmFailUnknownError, iscsiImproperTargetGroup=iscsiImproperTargetGroup, notificationSensorSuspect=notificationSensorSuspect, poolMetaWriteIops=poolMetaWriteIops, lunReservedSizeLow=lunReservedSizeLow, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, cacheTotalWriteMbps=cacheTotalWriteMbps, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, projectDeleted=projectDeleted, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, lunCompressedRatio=lunCompressedRatio, shareCIFSReadLatency=shareCIFSReadLatency, poolImported=poolImported, pools=pools, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, projectFreeSizeHigh=projectFreeSizeHigh, unknownSensorEvent=unknownSensorEvent, networkInterfaceUp=networkInterfaceUp, controllerUp=controllerUp, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, shareCIFSWriteMbps=shareCIFSWriteMbps, notificationTargetEntityName=notificationTargetEntityName, shareReservedSizeHigh=shareReservedSizeHigh, cpuSystemCalls=cpuSystemCalls, notificationSeverity=notificationSeverity, targetGroupMemberRemoved=targetGroupMemberRemoved, replicationPaused=replicationPaused, PYSNMP_MODULE_ID=tegile, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, replicationTargetDeleted=replicationTargetDeleted, fcInitiatorsTable=fcInitiatorsTable, cifsAvgReadLatency=cifsAvgReadLatency, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, poolReadCacheReadLatency=poolReadCacheReadLatency, iscsiTotalReadIops=iscsiTotalReadIops, lunProtocol=lunProtocol, upgradeDownloadFailed=upgradeDownloadFailed, projectLunCount=projectLunCount, iscsiTargetWriteLatency=iscsiTargetWriteLatency, nfsTotalReadIops=nfsTotalReadIops, shareNFSReadIops=shareNFSReadIops, cpuTotalUsage=cpuTotalUsage, projectShares=projectShares, diskSizeHigh=diskSizeHigh, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, poolDataSizeLow=poolDataSizeLow, ipmiCurrent=ipmiCurrent, poolSizeLow=poolSizeLow, fcTargetsTable=fcTargetsTable, nfsAvgWriteLatency=nfsAvgWriteLatency, shareNFSEnabled=shareNFSEnabled, poolOwnerController=poolOwnerController, poolIndex=poolIndex, memoryFailure=memoryFailure, fcTargetGroup=fcTargetGroup, network=network, poolTable=poolTable, fcInitiators=fcInitiators, iscsiTargetGroupError=iscsiTargetGroupError, nicGroup=nicGroup, snmpServiceStopped=snmpServiceStopped, poolEntry=poolEntry, projectQuotaFinished=projectQuotaFinished, notificationDescription=notificationDescription, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, iscsiInitiatorName=iscsiInitiatorName, diskGoneOffline=diskGoneOffline, sensorFailureEvent=sensorFailureEvent, poolTotalWriteIops=poolTotalWriteIops, poolReadCacheWriteMbps=poolReadCacheWriteMbps, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, projectPoolName=projectPoolName, iscsiTargetError=iscsiTargetError, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, lunName=lunName, iscsiTargetEntry=iscsiTargetEntry, shareQuotaLow=shareQuotaLow, nfsTotalWriteIops=nfsTotalWriteIops, networkTotalTransmitMbps=networkTotalTransmitMbps, replicationStarted=replicationStarted, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, projectDataSizeHigh=projectDataSizeHigh, tegileArray_notifications=tegileArray_notifications, fcProperties=fcProperties, lunCompressionEnabled=lunCompressionEnabled, cacheTotalReadIops=cacheTotalReadIops, poolMetaWriteLatency=poolMetaWriteLatency, shareName=shareName, snapshotRollbackFailed=snapshotRollbackFailed, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, diskTotalWriteIops=diskTotalWriteIops, shareCompressedRatio=shareCompressedRatio, poolDeleted=poolDeleted, projectQuotaSizeHigh=projectQuotaSizeHigh, iscsiProperties=iscsiProperties, diskTable=diskTable, diskDataReadMbps=diskDataReadMbps, projectTable=projectTable, replicationResumed=replicationResumed, snmpServiceStopFailed=snmpServiceStopFailed, lunWriteIops=lunWriteIops, poolMetaWriteMbps=poolMetaWriteMbps, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, projectShareCount=projectShareCount, haResourceIndex=haResourceIndex, nicName=nicName, notificationComponentName=notificationComponentName, iscsiTotalReadMbps=iscsiTotalReadMbps, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, diskDataWriteMbps=diskDataWriteMbps, poolTotalReadMbps=poolTotalReadMbps, projectLUNs=projectLUNs, lunReservedSizeHigh=lunReservedSizeHigh, poolMetaReadMbps=poolMetaReadMbps, shareDataSizeLow=shareDataSizeLow, iscsiTargetAuth=iscsiTargetAuth, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, notificationReadingTriggerValue=notificationReadingTriggerValue, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, tdpsUpgradeCompleted=tdpsUpgradeCompleted, poolDataReadMbps=poolDataReadMbps, userLoginFailed=userLoginFailed, snmpAgentVersion=snmpAgentVersion, globalStatistics=globalStatistics, intelliFlashSoftwareDown=intelliFlashSoftwareDown, cacheRAMReads=cacheRAMReads, lunDataSizeLow=lunDataSizeLow, diskTotalWriteMbps=diskTotalWriteMbps, shareExceedThresholdWarning=shareExceedThresholdWarning, nvdimmFailSoftError=nvdimmFailSoftError, shareProjectName=shareProjectName, fcPortOnline=fcPortOnline, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, maintenanceModeDisabled=maintenanceModeDisabled, haControllerB_Name=haControllerB_Name, diskSizeLow=diskSizeLow, shareDeleted=shareDeleted, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, lunPoolName=lunPoolName, poolReadCacheWriteLatency=poolReadCacheWriteLatency, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, fcInitiatorName=fcInitiatorName, cifsTotalReadIops=cifsTotalReadIops, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, shareCIFSReadIops=shareCIFSReadIops, poolDataReadLatency=poolDataReadLatency, networkIpmpGroupUp=networkIpmpGroupUp, volumeDeleteCompleted=volumeDeleteCompleted, diskTotalReadIops=diskTotalReadIops, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, projectEntry=projectEntry, maintenanceModeEnabled=maintenanceModeEnabled, fcPortOffline=fcPortOffline, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, nicReceiveMbps=nicReceiveMbps, controllerTimeDrift=controllerTimeDrift, diskIOCount=diskIOCount, lunWriteLatency=lunWriteLatency, poolDegraded=poolDegraded, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, currentObjectGroup=currentObjectGroup, notificationThresholdTriggerValue=notificationThresholdTriggerValue, iscsiTargetReadMbps=iscsiTargetReadMbps, fcTotalWriteMbps=fcTotalWriteMbps, fcTargetWriteMbps=fcTargetWriteMbps, lunDataSizeHigh=lunDataSizeHigh, fcTargetEntry=fcTargetEntry, cifsTotalWriteMbps=cifsTotalWriteMbps, diskCount=diskCount, projectDataSizeLow=projectDataSizeLow, diskChassisIdx=diskChassisIdx, iscsiTargetGroup=iscsiTargetGroup, lunSizeHigh=lunSizeHigh, poolHealth=poolHealth)
