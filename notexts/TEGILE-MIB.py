...
Bits, Unsigned32, ModuleIdentity, TimeTicks, Counter64, Integer32, Gauge32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, iso, ObjectIdentity, Counter32, enterprises, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Unsigned32", "ModuleIdentity", "TimeTicks", "Counter64", "Integer32", "Gauge32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "iso", "ObjectIdentity", "Counter32", "enterprises", "NotificationType")
...
mibBuilder.exportSymbols("TEGILE-MIB", deleteFolderCompleted=deleteFolderCompleted, poolDataReadLatency=poolDataReadLatency, fcTargetIndex=fcTargetIndex, haControllerA_Name=haControllerA_Name, iscsiInitiatorChapUser=iscsiInitiatorChapUser, projectSnapshotSizeLow=projectSnapshotSizeLow, lunPoolName=lunPoolName, diskState=diskState, poolMetaReadMbps=poolMetaReadMbps, deleteFolderFailed=deleteFolderFailed, networkIpmpGroupDown=networkIpmpGroupDown, nicTable=nicTable, fcTargetGroup=fcTargetGroup, projectName=projectName, ipmiCurrent=ipmiCurrent, fcInitiatorsTable=fcInitiatorsTable, haResourceDescription=haResourceDescription, poolTotalWriteIops=poolTotalWriteIops, maintenanceModeEnabled=maintenanceModeEnabled, notificationEventCode=notificationEventCode, notificationTargetEntityName=notificationTargetEntityName, smisServiceStopped=smisServiceStopped, shareExceedThresholdWarning=shareExceedThresholdWarning, iscsiImproperTargetGroup=iscsiImproperTargetGroup, poolImported=poolImported, notificationReadingUnit=notificationReadingUnit, nicIndex=nicIndex, poolDataWriteIops=poolDataWriteIops, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, fcTargets=fcTargets, poolMetaWriteIops=poolMetaWriteIops, lunInitiatorGroup=lunInitiatorGroup, upgradeFailed=upgradeFailed, projectEntry=projectEntry, cifsAvgReadLatency=cifsAvgReadLatency, diskSizeHigh=diskSizeHigh, shareEntry=shareEntry, poolCreated=poolCreated, notificationReadingTriggerValue=notificationReadingTriggerValue, shareReservedSizeHigh=shareReservedSizeHigh, diskChassisIdx=diskChassisIdx, alertsCleanupCompleted=alertsCleanupCompleted, lunReservedSizeHigh=lunReservedSizeHigh, upgradeDownloadFailed=upgradeDownloadFailed, poolMetaReadLatency=poolMetaReadLatency, haResourceName=haResourceName, nfsTotalWriteIops=nfsTotalWriteIops, diskDataReadMbps=diskDataReadMbps, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, iscsiInitiatorEntry=iscsiInitiatorEntry, nvdimmFailDeviceError=nvdimmFailDeviceError, controllerDown=controllerDown, replicationAbandoned=replicationAbandoned, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, nicGroup=nicGroup, diskRandomIOCount=diskRandomIOCount, poolTable=poolTable, networkTotalTransmitMbps=networkTotalTransmitMbps, notificationDescription=notificationDescription, cacheSSDReads=cacheSSDReads, nicName=nicName, intelliFlashSoftwareUp=intelliFlashSoftwareUp, fcInitiators=fcInitiators, lunWriteMbps=lunWriteMbps, iscsiInitiatorGroup=iscsiInitiatorGroup, shareCIFSWriteLatency=shareCIFSWriteLatency, poolIndex=poolIndex, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, poolDataWriteLatency=poolDataWriteLatency, lunIndex=lunIndex, shareSnapshotSizeLow=shareSnapshotSizeLow, ipmiFan=ipmiFan, lunReadLatency=lunReadLatency, nfsAvgWriteLatency=nfsAvgWriteLatency, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, fcInitiatorName=fcInitiatorName, PYSNMP_MODULE_ID=tegile, fcInitiatorIndex=fcInitiatorIndex, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, notificationTime=notificationTime, haControllerA_IPAddr=haControllerA_IPAddr, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, lunDataSizeHigh=lunDataSizeHigh, diskDataWriteMbps=diskDataWriteMbps, poolDataReadMbps=poolDataReadMbps, cacheRAMReads=cacheRAMReads, lunDedupEnabled=lunDedupEnabled, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, networkIpmpGroupUp=networkIpmpGroupUp, ipmiVoltage=ipmiVoltage, smbSocketFailure=smbSocketFailure, fcTargetEntry=fcTargetEntry, projectModified=projectModified, fcTotalReadMbps=fcTotalReadMbps, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, projectDeletionFailed=projectDeletionFailed, poolDegraded=poolDegraded, targetGroupCreateCompleted=targetGroupCreateCompleted, shareNFSReadLatency=shareNFSReadLatency, sharePoolName=sharePoolName, diskAvgReadLatency=diskAvgReadLatency, poolDataReadIops=poolDataReadIops, webdocsUpgradeFailed=webdocsUpgradeFailed, snapshotCloningFailed=snapshotCloningFailed, snmpServiceStartFailed=snmpServiceStartFailed, properties=properties, fcPortOffline=fcPortOffline, fcTotalWriteMbps=fcTotalWriteMbps, poolReadCacheReadLatency=poolReadCacheReadLatency, cifsAvgWriteLatency=cifsAvgWriteLatency, shareCIFSReadLatency=shareCIFSReadLatency, projectFreeSizeLow=projectFreeSizeLow, shareNFSWriteIops=shareNFSWriteIops, diskCount=diskCount, diskSizeLow=diskSizeLow, iscsiAvgReadLatency=iscsiAvgReadLatency, replicationComplete=replicationComplete, shareCIFSEnabled=shareCIFSEnabled, poolAvgWriteLatency=poolAvgWriteLatency, snmpServiceStopped=snmpServiceStopped, lunProtocol=lunProtocol, diskIsOnline=diskIsOnline, poolDataSizeHigh=poolDataSizeHigh, fcProperties=fcProperties, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, controllerHardwareModel=controllerHardwareModel, haControllerB_Uptime=haControllerB_Uptime, projectCreatedSuccessfully=projectCreatedSuccessfully, cacheTotalWriteMbps=cacheTotalWriteMbps, lunWriteLatency=lunWriteLatency, targetGroupMemberRemoved=targetGroupMemberRemoved, poolFreeSizeLow=poolFreeSizeLow, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, tegileCompliances=tegileCompliances, shareNFSReadMbps=shareNFSReadMbps, shareNFSEnabled=shareNFSEnabled, iscsiWriteIops=iscsiWriteIops, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, iscsiTargetEntry=iscsiTargetEntry, fcTotalReadIops=fcTotalReadIops, iscsiTargetAlias=iscsiTargetAlias, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, poolEntry=poolEntry, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, cacheTotalReadMbps=cacheTotalReadMbps, diskError=diskError, iscsiTargets=iscsiTargets, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, iscsiTotalReadMbps=iscsiTotalReadMbps, upgradeStarted=upgradeStarted, fcInitiatorGroup=fcInitiatorGroup, fcTargetWriteLatency=fcTargetWriteLatency, fcTargetName=fcTargetName, upgradeDownloadCompleted=upgradeDownloadCompleted, projectDeleted=projectDeleted, notificationThresholdTriggerValue=notificationThresholdTriggerValue, shareProjectName=shareProjectName, projectFreeSizeHigh=projectFreeSizeHigh, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, nfsAvgReadLatency=nfsAvgReadLatency, haResourceIndex=haResourceIndex, iscsiInitiatorsTable=iscsiInitiatorsTable, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, targetGroupDeleteCompleted=targetGroupDeleteCompleted, netbiosSocketFailure=netbiosSocketFailure, tdpsUpgradeTimeout=tdpsUpgradeTimeout, iscsiProperties=iscsiProperties, shareCreatedSuccessfully=shareCreatedSuccessfully, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, iscsiTargetAuth=iscsiTargetAuth, cifsTotalReadIops=cifsTotalReadIops, projectDedupEnabled=projectDedupEnabled, poolTotalReadMbps=poolTotalReadMbps, haResourceEntry=haResourceEntry, haResourceStatus=haResourceStatus, notificationComponentName=notificationComponentName, nvdimmFailSoftError=nvdimmFailSoftError, projectSnapshotSizeHigh=projectSnapshotSizeHigh, poolName=poolName, ntpServerTimeDrift=ntpServerTimeDrift, networkInterfaceDown=networkInterfaceDown, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, lunSnapshotSizeLow=lunSnapshotSizeLow, notifications=notifications, fcTargetModifyCompleted=fcTargetModifyCompleted, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, upgradeCompleted=upgradeCompleted, snapshotDeleteFailed=snapshotDeleteFailed, nvdimmFailUnknownError=nvdimmFailUnknownError, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, notificationSensorSuspect=notificationSensorSuspect, poolSizeHigh=poolSizeHigh, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, fcAvgWriteLatency=fcAvgWriteLatency, poolTotalReadIops=poolTotalReadIops, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, diskEntry=diskEntry, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, nicMTU=nicMTU, poolUsedSizeLow=poolUsedSizeLow, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, snapshotCloneCompleted=snapshotCloneCompleted, poolOwnerController=poolOwnerController, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, lunTargetGroup=lunTargetGroup, volumeDeleteCompleted=volumeDeleteCompleted, poolReadCacheWriteMbps=poolReadCacheWriteMbps, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, iscsiTargetGroup=iscsiTargetGroup, tegileArray_notifications=tegileArray_notifications, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, projectLunCount=projectLunCount, poolDataWriteMbps=poolDataWriteMbps, projectQuotaFinished=projectQuotaFinished, cpuInterrupts=cpuInterrupts, haControllerB_IPAddr=haControllerB_IPAddr, globalStatistics=globalStatistics, poolUpgraded=poolUpgraded, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, lunCompressionEnabled=lunCompressionEnabled, volumeQuotaFinished=volumeQuotaFinished, iscsiTargetsTable=iscsiTargetsTable, replicationTargetDeleted=replicationTargetDeleted, ipmiThreshold=ipmiThreshold, diskIOCount=diskIOCount, projectShares=projectShares, diskSlowIo=diskSlowIo, volumeDeleteFailed=volumeDeleteFailed, poolReadCacheWriteLatency=poolReadCacheWriteLatency, iscsiTargetReadLatency=iscsiTargetReadLatency, pools=pools, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, fcTargetReadIops=fcTargetReadIops, poolProjects=poolProjects, diskTotalWriteMbps=diskTotalWriteMbps, replicationStarted=replicationStarted, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, cifsTotalWriteIops=cifsTotalWriteIops, shareIndex=shareIndex, diagnosticDataUploaded=diagnosticDataUploaded, tdpsUpgradeCompleted=tdpsUpgradeCompleted, nvdimmFailInitializationError=nvdimmFailInitializationError, lunSizeLow=lunSizeLow, iscsiTargetWriteMbps=iscsiTargetWriteMbps, cifsTotalReadMbps=cifsTotalReadMbps, ipmiTemperature=ipmiTemperature, iscsiTotalReadIops=iscsiTotalReadIops)
mibBuilder.exportSymbols("TEGILE-MIB", projectCompressionEnabled=projectCompressionEnabled, shareCIFSReadMbps=shareCIFSReadMbps, haResourcesTable=haResourcesTable, poolProjectCount=poolProjectCount, poolWriteCacheWriteIops=poolWriteCacheWriteIops, volumeCreatedSuccessfully=volumeCreatedSuccessfully, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, iscsiTargetReadMbps=iscsiTargetReadMbps, snapshotRollbackCompleted=snapshotRollbackCompleted, cpuTotalUsage=cpuTotalUsage, poolMetaReadIops=poolMetaReadIops, fcTargetReadMbps=fcTargetReadMbps, haResources=haResources, replicationResumed=replicationResumed, nicEntry=nicEntry, poolHealth=poolHealth, snmpServiceStarted=snmpServiceStarted, diskGoneOffline=diskGoneOffline, lunBlockSize=lunBlockSize, projectQuotaSizeHigh=projectQuotaSizeHigh, tegile=tegile, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, adServerTimeDrift=adServerTimeDrift, diskTable=diskTable, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, spareDiskReplaced=spareDiskReplaced, diskTotalReadIops=diskTotalReadIops, iscsiInitiators=iscsiInitiators, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, cifsTotalWriteMbps=cifsTotalWriteMbps, snmpServiceStopFailed=snmpServiceStopFailed, snmpAgentVersion=snmpAgentVersion, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, lunCompressedRatio=lunCompressedRatio, poolMetaWriteMbps=poolMetaWriteMbps, lunEntry=lunEntry, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, diskIndex=diskIndex, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, notificationSeverity=notificationSeverity, haControllerB_Name=haControllerB_Name, smisServiceStopFailed=smisServiceStopFailed, iscsiTotalWriteMbps=iscsiTotalWriteMbps, poolTotalSaving=poolTotalSaving, controllerTimeDrift=controllerTimeDrift, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, diskDataReadIops=diskDataReadIops, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, maintenanceModeDisabled=maintenanceModeDisabled, lunName=lunName, lunSnapshotSizeHigh=lunSnapshotSizeHigh, notificationObjects=notificationObjects, fcInitiatorCreateFailed=fcInitiatorCreateFailed, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, initiatorGroupMemberAdded=initiatorGroupMemberAdded, replicationAborted=replicationAborted, aclMigrationCompleted=aclMigrationCompleted, ipmiPowerSupply=ipmiPowerSupply, diskPoolName=diskPoolName, shareDeletionFailed=shareDeletionFailed, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, iscsiTargetWriteLatency=iscsiTargetWriteLatency, smisServiceStarted=smisServiceStarted, diskType=diskType, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, iscsiTargetWriteIops=iscsiTargetWriteIops, nicState=nicState, ipmiCriticalInterrupt=ipmiCriticalInterrupt, shareDedupEnabled=shareDedupEnabled, upgradeTimeout=upgradeTimeout, nicReceiveMbps=nicReceiveMbps, currentNotificationGroup=currentNotificationGroup, poolReadCacheWriteIops=poolReadCacheWriteIops, projectDataSizeLow=projectDataSizeLow, projectQuotaSizeLow=projectQuotaSizeLow, iscsiAvgWriteLatency=iscsiAvgWriteLatency, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, currentObjectGroup=currentObjectGroup, poolDeletionFailed=poolDeletionFailed, lunReadMbps=lunReadMbps, network=network, shareReservedSizeLow=shareReservedSizeLow, lunDataSizeLow=lunDataSizeLow, lunGUID=lunGUID, diskTotalReadMbps=diskTotalReadMbps, projectPoolName=projectPoolName, targetGroupMemberAdded=targetGroupMemberAdded, projectIndex=projectIndex, sanProperties=sanProperties, nfsTotalWriteMbps=nfsTotalWriteMbps, shareDataSizeHigh=shareDataSizeHigh, shareName=shareName, shareTable=shareTable, notificationProps=notificationProps, poolTotalWriteMbps=poolTotalWriteMbps, ipmiMemory=ipmiMemory, fcInitiatorEntry=fcInitiatorEntry, snapshotRollbackFailed=snapshotRollbackFailed, poolState=poolState, poolUsedSizeHigh=poolUsedSizeHigh, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, shareQuotaHigh=shareQuotaHigh, notificationSensorAction=notificationSensorAction, webdocsUpgradeCompleted=webdocsUpgradeCompleted, fcTargetWriteMbps=fcTargetWriteMbps, iscsiInitiatorName=iscsiInitiatorName, nicTransmitMbps=nicTransmitMbps, fcTargetsTable=fcTargetsTable, poolReadCacheReadIops=poolReadCacheReadIops, poolCount=poolCount, shareNFSWriteMbps=shareNFSWriteMbps, fcTargetWriteIops=fcTargetWriteIops, iscsiTargetReadIops=iscsiTargetReadIops, haControllerA_Uptime=haControllerA_Uptime, networkTotalReceiveMbps=networkTotalReceiveMbps, shareSnapshotSizeHigh=shareSnapshotSizeHigh, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, unknownSensorEvent=unknownSensorEvent, poolSizeLow=poolSizeLow, projectThresholdExceedWarning=projectThresholdExceedWarning, shareCIFSReadIops=shareCIFSReadIops, iscsiTargetName=iscsiTargetName, replicationSourceRegistered=replicationSourceRegistered, lunFreeSizeHigh=lunFreeSizeHigh, diskAvgWriteLatency=diskAvgWriteLatency, projectTotalSaving=projectTotalSaving, volumeModifyCompleted=volumeModifyCompleted, userLoginFailed=userLoginFailed, controllerUp=controllerUp, cacheTotalWriteIops=cacheTotalWriteIops, cacheTotalReadIops=cacheTotalReadIops, tegileConformance=tegileConformance, poolExpanded=poolExpanded, shareCIFSWriteIops=shareCIFSWriteIops, lunSizeHigh=lunSizeHigh, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, poolAvgReadLatency=poolAvgReadLatency, nfsTotalReadMbps=nfsTotalReadMbps, shareDataSizeLow=shareDataSizeLow, poolExported=poolExported, shareCIFSWriteMbps=shareCIFSWriteMbps, ipmiOther=ipmiOther, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, shareCompressionEnabled=shareCompressionEnabled, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, lunReadIops=lunReadIops, vmwareNFSDatastores=vmwareNFSDatastores, smisServiceStartFailed=smisServiceStartFailed, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, lunTable=lunTable, poolDataSizeLow=poolDataSizeLow, fcPortOnline=fcPortOnline, networkInterfaceUp=networkInterfaceUp, diskSequentialIOCount=diskSequentialIOCount, intelliFlashSoftwareDown=intelliFlashSoftwareDown, diskTotalWriteIops=diskTotalWriteIops, haResourceGroup=haResourceGroup, poolMetaWriteLatency=poolMetaWriteLatency, nfsTotalReadIops=nfsTotalReadIops, projectDataSizeHigh=projectDataSizeHigh, replicationPaused=replicationPaused, projectLUNs=projectLUNs, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, shareCompressedRatio=shareCompressedRatio, fcTargetStatus=fcTargetStatus, shareMountPoint=shareMountPoint, testNotification=testNotification, lunProjectName=lunProjectName, poolReadCacheReadMbps=poolReadCacheReadMbps, notificationSensorNumber=notificationSensorNumber, disks=disks, tegileArray=tegileArray, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, diskDataWriteIops=diskDataWriteIops, shareQuotaFinished=shareQuotaFinished, basicCompliance=basicCompliance, tegileGroups=tegileGroups, fcTotalWriteIops=fcTotalWriteIops, aclMigrationStarted=aclMigrationStarted, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, projectShareCount=projectShareCount, poolQuotaFinished=poolQuotaFinished, poolDeleted=poolDeleted, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, lunFreeSizeLow=lunFreeSizeLow, memoryFailure=memoryFailure, tdpsUpgradeFailed=tdpsUpgradeFailed, projectTable=projectTable, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, haResourceActiveNode=haResourceActiveNode, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, lunWriteIops=lunWriteIops, iscsiTargetError=iscsiTargetError, sensorFailureEvent=sensorFailureEvent, fcAvgReadLatency=fcAvgReadLatency, poolFreeSizeHigh=poolFreeSizeHigh, fcTargetReadLatency=fcTargetReadLatency, shareQuotaLow=shareQuotaLow, cpuSystemCalls=cpuSystemCalls, iscsiTargetGroupError=iscsiTargetGroupError, upgradeDownloadStarted=upgradeDownloadStarted, iscsiTargetIndex=iscsiTargetIndex, snapshotCreationFailed=snapshotCreationFailed, replicationFailed=replicationFailed, shareDeleted=shareDeleted, iscsiInitiatorIndex=iscsiInitiatorIndex, shareNFSReadIops=shareNFSReadIops, lunReservedSizeLow=lunReservedSizeLow, diskAlias=diskAlias, shareNFSWriteLatency=shareNFSWriteLatency)
