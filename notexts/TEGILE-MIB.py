...
iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Gauge32, MibIdentifier, Counter64, IpAddress, ObjectIdentity, enterprises, Bits, TimeTicks, NotificationType, Counter32, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Gauge32", "MibIdentifier", "Counter64", "IpAddress", "ObjectIdentity", "enterprises", "Bits", "TimeTicks", "NotificationType", "Counter32", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("TEGILE-MIB", controllerDown=controllerDown, pools=pools, nicTransmitMbps=nicTransmitMbps, poolReadCacheReadIops=poolReadCacheReadIops, fcInitiators=fcInitiators, iscsiTargetWriteMbps=iscsiTargetWriteMbps, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, projectQuotaSizeLow=projectQuotaSizeLow, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, controllerTimeDrift=controllerTimeDrift, diskDataReadIops=diskDataReadIops, nicEntry=nicEntry, shareTable=shareTable, poolOwnerController=poolOwnerController, iscsiInitiatorIndex=iscsiInitiatorIndex, nicReceiveMbps=nicReceiveMbps, iscsiTargetIndex=iscsiTargetIndex, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, tegileCompliances=tegileCompliances, fcTargetWriteMbps=fcTargetWriteMbps, shareCIFSReadMbps=shareCIFSReadMbps, cacheTotalReadMbps=cacheTotalReadMbps, poolDataSizeLow=poolDataSizeLow, poolMetaWriteIops=poolMetaWriteIops, projectThresholdExceedWarning=projectThresholdExceedWarning, diskSequentialIOCount=diskSequentialIOCount, shareCIFSWriteLatency=shareCIFSWriteLatency, poolCreated=poolCreated, poolCount=poolCount, shareCreatedSuccessfully=shareCreatedSuccessfully, diskIOCount=diskIOCount, iscsiTargetsTable=iscsiTargetsTable, fcInitiatorCreateFailed=fcInitiatorCreateFailed, lunProtocol=lunProtocol, poolHealth=poolHealth, iscsiInitiatorName=iscsiInitiatorName, iscsiTargetReadLatency=iscsiTargetReadLatency, notificationSensorNumber=notificationSensorNumber, maintenanceModeDisabled=maintenanceModeDisabled, nvdimmFailInitializationError=nvdimmFailInitializationError, iscsiWriteIops=iscsiWriteIops, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, snmpServiceStopped=snmpServiceStopped, iscsiInitiatorEntry=iscsiInitiatorEntry, ipmiFan=ipmiFan, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, fcAvgWriteLatency=fcAvgWriteLatency, lunCompressionEnabled=lunCompressionEnabled, vmwareNFSDatastores=vmwareNFSDatastores, poolDataWriteLatency=poolDataWriteLatency, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, projectSnapshotSizeLow=projectSnapshotSizeLow, networkTotalReceiveMbps=networkTotalReceiveMbps, targetGroupCreateCompleted=targetGroupCreateCompleted, poolProjectCount=poolProjectCount, tegile=tegile, diskAlias=diskAlias, poolFreeSizeLow=poolFreeSizeLow, upgradeFailed=upgradeFailed, lunPoolName=lunPoolName, lunDataSizeHigh=lunDataSizeHigh, poolDataSizeHigh=poolDataSizeHigh, testNotification=testNotification, volumeDeleteFailed=volumeDeleteFailed, cpuInterrupts=cpuInterrupts, tdpsUpgradeFailed=tdpsUpgradeFailed, projectDedupEnabled=projectDedupEnabled, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, shareDeletionFailed=shareDeletionFailed, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, notificationTargetEntityName=notificationTargetEntityName, cpuSystemCalls=cpuSystemCalls, poolUpgraded=poolUpgraded, replicationResumed=replicationResumed, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, lunReservedSizeLow=lunReservedSizeLow, lunSizeHigh=lunSizeHigh, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, fcInitiatorIndex=fcInitiatorIndex, fcTargetReadIops=fcTargetReadIops, iscsiTotalReadMbps=iscsiTotalReadMbps, iscsiAvgWriteLatency=iscsiAvgWriteLatency, notificationDescription=notificationDescription, poolDataReadIops=poolDataReadIops, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, haResourceStatus=haResourceStatus, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, projectFreeSizeLow=projectFreeSizeLow, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, shareCIFSWriteMbps=shareCIFSWriteMbps, notifications=notifications, initiatorGroupMemberAdded=initiatorGroupMemberAdded, iscsiInitiators=iscsiInitiators, poolReadCacheReadLatency=poolReadCacheReadLatency, nfsTotalReadMbps=nfsTotalReadMbps, cifsTotalReadMbps=cifsTotalReadMbps, lunSizeLow=lunSizeLow, userLoginFailed=userLoginFailed, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, fcTotalWriteMbps=fcTotalWriteMbps, ipmiCriticalInterrupt=ipmiCriticalInterrupt, nvdimmFailSoftError=nvdimmFailSoftError, shareDataSizeHigh=shareDataSizeHigh, fcPortOffline=fcPortOffline, poolReadCacheWriteIops=poolReadCacheWriteIops, iscsiInitiatorChapUser=iscsiInitiatorChapUser, shareReservedSizeLow=shareReservedSizeLow, projectQuotaSizeHigh=projectQuotaSizeHigh, poolSizeLow=poolSizeLow, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, lunSnapshotSizeHigh=lunSnapshotSizeHigh, lunBlockSize=lunBlockSize, cifsTotalWriteMbps=cifsTotalWriteMbps, upgradeTimeout=upgradeTimeout, replicationSourceRegistered=replicationSourceRegistered, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, iscsiTotalReadIops=iscsiTotalReadIops, volumeModifyCompleted=volumeModifyCompleted, fcTargetModifyCompleted=fcTargetModifyCompleted, shareNFSReadIops=shareNFSReadIops, lunSnapshotSizeLow=lunSnapshotSizeLow, poolWriteCacheWriteIops=poolWriteCacheWriteIops, shareSnapshotSizeLow=shareSnapshotSizeLow, shareMountPoint=shareMountPoint, diskGoneOffline=diskGoneOffline, fcTargets=fcTargets, controllerHardwareModel=controllerHardwareModel, shareCompressionEnabled=shareCompressionEnabled, nicGroup=nicGroup, snmpServiceStartFailed=snmpServiceStartFailed, haControllerA_IPAddr=haControllerA_IPAddr, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, diskTotalReadMbps=diskTotalReadMbps, nfsTotalReadIops=nfsTotalReadIops, haResourcesTable=haResourcesTable, lunWriteMbps=lunWriteMbps, replicationComplete=replicationComplete, shareQuotaFinished=shareQuotaFinished, fcTotalReadMbps=fcTotalReadMbps, nicTable=nicTable, diskType=diskType, diskTotalWriteIops=diskTotalWriteIops, lunGUID=lunGUID, diskTotalReadIops=diskTotalReadIops, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, disks=disks, maintenanceModeEnabled=maintenanceModeEnabled, haResources=haResources, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, fcTotalReadIops=fcTotalReadIops, poolDataReadLatency=poolDataReadLatency, projectIndex=projectIndex, aclMigrationStarted=aclMigrationStarted, shareCIFSWriteIops=shareCIFSWriteIops, smisServiceStopped=smisServiceStopped, iscsiTotalWriteMbps=iscsiTotalWriteMbps, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, poolState=poolState, poolReadCacheReadMbps=poolReadCacheReadMbps, targetGroupMemberRemoved=targetGroupMemberRemoved, tegileArray_notifications=tegileArray_notifications, networkInterfaceDown=networkInterfaceDown, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, iscsiAvgReadLatency=iscsiAvgReadLatency, projectDataSizeLow=projectDataSizeLow, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, snapshotDeleteFailed=snapshotDeleteFailed, shareNFSWriteIops=shareNFSWriteIops, shareDataSizeLow=shareDataSizeLow, nvdimmFailUnknownError=nvdimmFailUnknownError, nicIndex=nicIndex, shareQuotaLow=shareQuotaLow, lunReservedSizeHigh=lunReservedSizeHigh, replicationStarted=replicationStarted, snapshotRollbackCompleted=snapshotRollbackCompleted, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, memoryFailure=memoryFailure, fcInitiatorEntry=fcInitiatorEntry, cacheSSDReads=cacheSSDReads, poolExpanded=poolExpanded, haControllerB_Uptime=haControllerB_Uptime, iscsiTargetAuth=iscsiTargetAuth, sensorFailureEvent=sensorFailureEvent, projectPoolName=projectPoolName, iscsiTargetWriteLatency=iscsiTargetWriteLatency, tdpsUpgradeCompleted=tdpsUpgradeCompleted, fcTargetWriteIops=fcTargetWriteIops, volumeCreatedSuccessfully=volumeCreatedSuccessfully, shareCompressedRatio=shareCompressedRatio, networkIpmpGroupUp=networkIpmpGroupUp, projectCompressionEnabled=projectCompressionEnabled, lunProjectName=lunProjectName, poolUsedSizeHigh=poolUsedSizeHigh, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, poolTotalWriteIops=poolTotalWriteIops, projectTotalSaving=projectTotalSaving, lunIndex=lunIndex, nfsAvgReadLatency=nfsAvgReadLatency, notificationTime=notificationTime, haResourceGroup=haResourceGroup, shareDedupEnabled=shareDedupEnabled, diskEntry=diskEntry, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, currentObjectGroup=currentObjectGroup, notificationSensorSuspect=notificationSensorSuspect, tegileGroups=tegileGroups, haResourceDescription=haResourceDescription, lunReadLatency=lunReadLatency, shareReservedSizeHigh=shareReservedSizeHigh, lunCompressedRatio=lunCompressedRatio, haResourceEntry=haResourceEntry, poolDegraded=poolDegraded, netbiosSocketFailure=netbiosSocketFailure, poolImported=poolImported, smbSocketFailure=smbSocketFailure, upgradeDownloadCompleted=upgradeDownloadCompleted, nvdimmFailDeviceError=nvdimmFailDeviceError, lunDataSizeLow=lunDataSizeLow, poolMetaReadMbps=poolMetaReadMbps, replicationPaused=replicationPaused, ipmiMemory=ipmiMemory, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, alertsCleanupCompleted=alertsCleanupCompleted, fcTargetWriteLatency=fcTargetWriteLatency, iscsiTargets=iscsiTargets, ntpServerTimeDrift=ntpServerTimeDrift, projectName=projectName, lunReadIops=lunReadIops, diskTotalWriteMbps=diskTotalWriteMbps, diskTable=diskTable, snmpServiceStarted=snmpServiceStarted, cacheTotalWriteIops=cacheTotalWriteIops, fcTargetIndex=fcTargetIndex, notificationComponentName=notificationComponentName, diskIsOnline=diskIsOnline, iscsiTargetName=iscsiTargetName, snapshotCloningFailed=snapshotCloningFailed, poolSizeHigh=poolSizeHigh, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, diskState=diskState, replicationAbandoned=replicationAbandoned, lunDedupEnabled=lunDedupEnabled, poolAvgReadLatency=poolAvgReadLatency, poolFreeSizeHigh=poolFreeSizeHigh, notificationProps=notificationProps, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, nicMTU=nicMTU)
mibBuilder.exportSymbols("TEGILE-MIB", snapshotRollbackFailed=snapshotRollbackFailed, haControllerA_Name=haControllerA_Name, diskAvgWriteLatency=diskAvgWriteLatency, poolDeletionFailed=poolDeletionFailed, shareIndex=shareIndex, lunTable=lunTable, cifsAvgWriteLatency=cifsAvgWriteLatency, iscsiImproperTargetGroup=iscsiImproperTargetGroup, diskDataReadMbps=diskDataReadMbps, notificationThresholdTriggerValue=notificationThresholdTriggerValue, projectLUNs=projectLUNs, haControllerB_Name=haControllerB_Name, haControllerA_Uptime=haControllerA_Uptime, lunEntry=lunEntry, fcTargetReadLatency=fcTargetReadLatency, diskPoolName=diskPoolName, webdocsUpgradeFailed=webdocsUpgradeFailed, fcTargetReadMbps=fcTargetReadMbps, targetGroupDeleteCompleted=targetGroupDeleteCompleted, networkInterfaceUp=networkInterfaceUp, fcTargetStatus=fcTargetStatus, diskIndex=diskIndex, tegileConformance=tegileConformance, diskCount=diskCount, diskDataWriteMbps=diskDataWriteMbps, projectDeletionFailed=projectDeletionFailed, cacheRAMReads=cacheRAMReads, lunFreeSizeLow=lunFreeSizeLow, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, controllerUp=controllerUp, poolDeleted=poolDeleted, diskRandomIOCount=diskRandomIOCount, shareCIFSReadIops=shareCIFSReadIops, intelliFlashSoftwareDown=intelliFlashSoftwareDown, fcPortOnline=fcPortOnline, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, properties=properties, iscsiTargetAlias=iscsiTargetAlias, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, snapshotCreationFailed=snapshotCreationFailed, cacheTotalReadIops=cacheTotalReadIops, poolMetaReadIops=poolMetaReadIops, poolReadCacheWriteLatency=poolReadCacheWriteLatency, shareCIFSEnabled=shareCIFSEnabled, tdpsUpgradeTimeout=tdpsUpgradeTimeout, projectEntry=projectEntry, snmpServiceStopFailed=snmpServiceStopFailed, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, notificationEventCode=notificationEventCode, lunWriteLatency=lunWriteLatency, diskError=diskError, intelliFlashSoftwareUp=intelliFlashSoftwareUp, poolTotalReadMbps=poolTotalReadMbps, fcInitiatorGroup=fcInitiatorGroup, upgradeDownloadFailed=upgradeDownloadFailed, tegileArray=tegileArray, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, shareNFSWriteMbps=shareNFSWriteMbps, nicState=nicState, projectQuotaFinished=projectQuotaFinished, networkTotalTransmitMbps=networkTotalTransmitMbps, projectLunCount=projectLunCount, projectModified=projectModified, fcAvgReadLatency=fcAvgReadLatency, lunInitiatorGroup=lunInitiatorGroup, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, network=network, diskSlowIo=diskSlowIo, smisServiceStarted=smisServiceStarted, poolExported=poolExported, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, notificationSensorAction=notificationSensorAction, projectShares=projectShares, poolMetaWriteMbps=poolMetaWriteMbps, volumeDeleteCompleted=volumeDeleteCompleted, poolReadCacheWriteMbps=poolReadCacheWriteMbps, notificationObjects=notificationObjects, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, targetGroupMemberAdded=targetGroupMemberAdded, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, ipmiOther=ipmiOther, shareEntry=shareEntry, poolEntry=poolEntry, projectShareCount=projectShareCount, fcTargetsTable=fcTargetsTable, nfsTotalWriteMbps=nfsTotalWriteMbps, nfsTotalWriteIops=nfsTotalWriteIops, ipmiTemperature=ipmiTemperature, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, diskSizeLow=diskSizeLow, globalStatistics=globalStatistics, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, unknownSensorEvent=unknownSensorEvent, nfsAvgWriteLatency=nfsAvgWriteLatency, spareDiskReplaced=spareDiskReplaced, shareExceedThresholdWarning=shareExceedThresholdWarning, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, projectDataSizeHigh=projectDataSizeHigh, fcInitiatorName=fcInitiatorName, cifsTotalWriteIops=cifsTotalWriteIops, poolDataReadMbps=poolDataReadMbps, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, shareQuotaHigh=shareQuotaHigh, diskDataWriteIops=diskDataWriteIops, poolMetaWriteLatency=poolMetaWriteLatency, fcTargetName=fcTargetName, poolTotalWriteMbps=poolTotalWriteMbps, poolDataWriteMbps=poolDataWriteMbps, adServerTimeDrift=adServerTimeDrift, replicationTargetDeleted=replicationTargetDeleted, fcProperties=fcProperties, projectDeleted=projectDeleted, sharePoolName=sharePoolName, diskAvgReadLatency=diskAvgReadLatency, haControllerB_IPAddr=haControllerB_IPAddr, poolDataWriteIops=poolDataWriteIops, poolTable=poolTable, poolTotalSaving=poolTotalSaving, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, ipmiCurrent=ipmiCurrent, fcTargetGroup=fcTargetGroup, upgradeCompleted=upgradeCompleted, notificationSeverity=notificationSeverity, iscsiTargetWriteIops=iscsiTargetWriteIops, shareNFSReadLatency=shareNFSReadLatency, notificationReadingTriggerValue=notificationReadingTriggerValue, ipmiVoltage=ipmiVoltage, upgradeStarted=upgradeStarted, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, fcTotalWriteIops=fcTotalWriteIops, deleteFolderFailed=deleteFolderFailed, lunTargetGroup=lunTargetGroup, lunName=lunName, cifsAvgReadLatency=cifsAvgReadLatency, shareSnapshotSizeHigh=shareSnapshotSizeHigh, nicName=nicName, smisServiceStartFailed=smisServiceStartFailed, volumeQuotaFinished=volumeQuotaFinished, iscsiTargetReadIops=iscsiTargetReadIops, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, projectFreeSizeHigh=projectFreeSizeHigh, PYSNMP_MODULE_ID=tegile, haResourceName=haResourceName, webdocsUpgradeCompleted=webdocsUpgradeCompleted, haResourceIndex=haResourceIndex, shareName=shareName, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, upgradeDownloadStarted=upgradeDownloadStarted, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, currentNotificationGroup=currentNotificationGroup, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, networkIpmpGroupDown=networkIpmpGroupDown, sanProperties=sanProperties, basicCompliance=basicCompliance, poolQuotaFinished=poolQuotaFinished, iscsiProperties=iscsiProperties, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, lunReadMbps=lunReadMbps, diagnosticDataUploaded=diagnosticDataUploaded, deleteFolderCompleted=deleteFolderCompleted, poolProjects=poolProjects, poolMetaReadLatency=poolMetaReadLatency, iscsiTargetEntry=iscsiTargetEntry, shareNFSReadMbps=shareNFSReadMbps, smisServiceStopFailed=smisServiceStopFailed, replicationFailed=replicationFailed, cacheTotalWriteMbps=cacheTotalWriteMbps, cpuTotalUsage=cpuTotalUsage, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, iscsiInitiatorsTable=iscsiInitiatorsTable, fcInitiatorsTable=fcInitiatorsTable, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, shareDeleted=shareDeleted, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, iscsiTargetGroup=iscsiTargetGroup, projectCreatedSuccessfully=projectCreatedSuccessfully, snmpAgentVersion=snmpAgentVersion, shareNFSWriteLatency=shareNFSWriteLatency, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, cifsTotalReadIops=cifsTotalReadIops, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, lunFreeSizeHigh=lunFreeSizeHigh, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, iscsiTargetReadMbps=iscsiTargetReadMbps, aclMigrationCompleted=aclMigrationCompleted, poolAvgWriteLatency=poolAvgWriteLatency, snapshotCloneCompleted=snapshotCloneCompleted, ipmiThreshold=ipmiThreshold, shareProjectName=shareProjectName, fcTargetEntry=fcTargetEntry, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, poolName=poolName, shareCIFSReadLatency=shareCIFSReadLatency, lunWriteIops=lunWriteIops, projectSnapshotSizeHigh=projectSnapshotSizeHigh, haResourceActiveNode=haResourceActiveNode, iscsiTargetGroupError=iscsiTargetGroupError, iscsiInitiatorGroup=iscsiInitiatorGroup, poolUsedSizeLow=poolUsedSizeLow, replicationAborted=replicationAborted, projectTable=projectTable, notificationReadingUnit=notificationReadingUnit, poolTotalReadIops=poolTotalReadIops, iscsiTargetError=iscsiTargetError, diskSizeHigh=diskSizeHigh, diskChassisIdx=diskChassisIdx, poolIndex=poolIndex, ipmiPowerSupply=ipmiPowerSupply, shareNFSEnabled=shareNFSEnabled)
