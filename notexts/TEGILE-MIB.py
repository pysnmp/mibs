...
ObjectIdentity, iso, Integer32, Bits, enterprises, ModuleIdentity, IpAddress, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, Gauge32, Unsigned32, Counter64, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "iso", "Integer32", "Bits", "enterprises", "ModuleIdentity", "IpAddress", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "Gauge32", "Unsigned32", "Counter64", "MibIdentifier")
...
mibBuilder.exportSymbols("TEGILE-MIB", poolMetaReadMbps=poolMetaReadMbps, projectSnapshotSizeLow=projectSnapshotSizeLow, lunDataSizeHigh=lunDataSizeHigh, haControllerA_Uptime=haControllerA_Uptime, shareQuotaLow=shareQuotaLow, poolImported=poolImported, nicGroup=nicGroup, lunDedupEnabled=lunDedupEnabled, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, ipmiCurrent=ipmiCurrent, shareDataSizeLow=shareDataSizeLow, poolDataReadMbps=poolDataReadMbps, notificationSensorNumber=notificationSensorNumber, iscsiTargetReadIops=iscsiTargetReadIops, iscsiTargetReadLatency=iscsiTargetReadLatency, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, shareNFSWriteLatency=shareNFSWriteLatency, smisServiceStopFailed=smisServiceStopFailed, haResourceName=haResourceName, adServerTimeDrift=adServerTimeDrift, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, poolTotalReadMbps=poolTotalReadMbps, poolUpgraded=poolUpgraded, upgradeTimeout=upgradeTimeout, diskState=diskState, notifications=notifications, lunIndex=lunIndex, fcInitiatorIndex=fcInitiatorIndex, poolDataWriteIops=poolDataWriteIops, iscsiTotalReadIops=iscsiTotalReadIops, diskDataWriteMbps=diskDataWriteMbps, notificationSensorSuspect=notificationSensorSuspect, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, lunReadMbps=lunReadMbps, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, iscsiInitiatorName=iscsiInitiatorName, volumeModifyCompleted=volumeModifyCompleted, shareCIFSWriteLatency=shareCIFSWriteLatency, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, tegileConformance=tegileConformance, tdpsUpgradeFailed=tdpsUpgradeFailed, poolName=poolName, poolExpanded=poolExpanded, notificationEventCode=notificationEventCode, unknownSensorEvent=unknownSensorEvent, cifsTotalWriteMbps=cifsTotalWriteMbps, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, shareQuotaHigh=shareQuotaHigh, cifsTotalReadIops=cifsTotalReadIops, controllerDown=controllerDown, properties=properties, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, shareCIFSReadIops=shareCIFSReadIops, projectShareCount=projectShareCount, poolHealth=poolHealth, targetGroupMemberAdded=targetGroupMemberAdded, intelliFlashSoftwareUp=intelliFlashSoftwareUp, projectEntry=projectEntry, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, cifsTotalWriteIops=cifsTotalWriteIops, poolReadCacheWriteIops=poolReadCacheWriteIops, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, upgradeCompleted=upgradeCompleted, ipmiTemperature=ipmiTemperature, ntpServerTimeDrift=ntpServerTimeDrift, volumeCreatedSuccessfully=volumeCreatedSuccessfully, replicationAborted=replicationAborted, fcInitiators=fcInitiators, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, nfsAvgWriteLatency=nfsAvgWriteLatency, smisServiceStopped=smisServiceStopped, shareQuotaFinished=shareQuotaFinished, projectLUNs=projectLUNs, lunEntry=lunEntry, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, notificationThresholdTriggerValue=notificationThresholdTriggerValue, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, lunFreeSizeHigh=lunFreeSizeHigh, poolDeletionFailed=poolDeletionFailed, projectCompressionEnabled=projectCompressionEnabled, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, shareCreatedSuccessfully=shareCreatedSuccessfully, controllerTimeDrift=controllerTimeDrift, shareNFSEnabled=shareNFSEnabled, projectCreatedSuccessfully=projectCreatedSuccessfully, targetGroupDeleteCompleted=targetGroupDeleteCompleted, lunSnapshotSizeHigh=lunSnapshotSizeHigh, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, fcTargets=fcTargets, shareCIFSReadLatency=shareCIFSReadLatency, diskChassisIdx=diskChassisIdx, haControllerA_Name=haControllerA_Name, notificationSensorAction=notificationSensorAction, cpuInterrupts=cpuInterrupts, shareName=shareName, poolQuotaFinished=poolQuotaFinished, tegileCompliances=tegileCompliances, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, nicReceiveMbps=nicReceiveMbps, shareDataSizeHigh=shareDataSizeHigh, replicationTargetDeleted=replicationTargetDeleted, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, iscsiTotalReadMbps=iscsiTotalReadMbps, shareCIFSEnabled=shareCIFSEnabled, upgradeFailed=upgradeFailed, fcTotalWriteIops=fcTotalWriteIops, shareTable=shareTable, upgradeStarted=upgradeStarted, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, iscsiProperties=iscsiProperties, haResourcesTable=haResourcesTable, poolProjectCount=poolProjectCount, snmpServiceStopped=snmpServiceStopped, poolDataSizeLow=poolDataSizeLow, fcTargetReadMbps=fcTargetReadMbps, testNotification=testNotification, upgradeDownloadFailed=upgradeDownloadFailed, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, netbiosSocketFailure=netbiosSocketFailure, replicationComplete=replicationComplete, diskIndex=diskIndex, fcPortOnline=fcPortOnline, snapshotRollbackCompleted=snapshotRollbackCompleted, deleteFolderFailed=deleteFolderFailed, userLoginFailed=userLoginFailed, webdocsUpgradeFailed=webdocsUpgradeFailed, tegileArray=tegileArray, cifsTotalReadMbps=cifsTotalReadMbps, poolDataWriteMbps=poolDataWriteMbps, tdpsUpgradeCompleted=tdpsUpgradeCompleted, iscsiInitiatorIndex=iscsiInitiatorIndex, diskError=diskError, poolProjects=poolProjects, nfsAvgReadLatency=nfsAvgReadLatency, diskSizeLow=diskSizeLow, notificationTime=notificationTime, diskIsOnline=diskIsOnline, maintenanceModeDisabled=maintenanceModeDisabled, diskAvgWriteLatency=diskAvgWriteLatency, tdpsUpgradeTimeout=tdpsUpgradeTimeout, fcTotalReadIops=fcTotalReadIops, fcProperties=fcProperties, poolCreated=poolCreated, fcTargetWriteIops=fcTargetWriteIops, nvdimmFailSoftError=nvdimmFailSoftError, snmpServiceStopFailed=snmpServiceStopFailed, ipmiCriticalInterrupt=ipmiCriticalInterrupt, currentNotificationGroup=currentNotificationGroup, snmpServiceStarted=snmpServiceStarted, diskSequentialIOCount=diskSequentialIOCount, poolAvgWriteLatency=poolAvgWriteLatency, diskAlias=diskAlias, ipmiThreshold=ipmiThreshold, poolReadCacheReadMbps=poolReadCacheReadMbps, aclMigrationStarted=aclMigrationStarted, tegileArray_notifications=tegileArray_notifications, pools=pools, lunDataSizeLow=lunDataSizeLow, diskDataReadIops=diskDataReadIops, shareNFSReadMbps=shareNFSReadMbps, shareDeletionFailed=shareDeletionFailed, diskPoolName=diskPoolName, lunName=lunName, fcTargetWriteLatency=fcTargetWriteLatency, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, deleteFolderCompleted=deleteFolderCompleted, targetGroupMemberRemoved=targetGroupMemberRemoved, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, shareSnapshotSizeHigh=shareSnapshotSizeHigh, poolMetaWriteIops=poolMetaWriteIops, maintenanceModeEnabled=maintenanceModeEnabled, notificationComponentName=notificationComponentName, poolDataReadIops=poolDataReadIops, poolState=poolState, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, cacheTotalWriteIops=cacheTotalWriteIops, diskDataReadMbps=diskDataReadMbps, replicationSourceRegistered=replicationSourceRegistered, diskAvgReadLatency=diskAvgReadLatency, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, poolEntry=poolEntry, poolReadCacheWriteLatency=poolReadCacheWriteLatency, projectFreeSizeLow=projectFreeSizeLow, iscsiTargetIndex=iscsiTargetIndex, shareExceedThresholdWarning=shareExceedThresholdWarning, tegileGroups=tegileGroups, nicTransmitMbps=nicTransmitMbps, shareCompressedRatio=shareCompressedRatio, diskIOCount=diskIOCount, notificationDescription=notificationDescription, iscsiTargetWriteLatency=iscsiTargetWriteLatency, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, cacheTotalReadMbps=cacheTotalReadMbps, notificationObjects=notificationObjects, nfsTotalReadMbps=nfsTotalReadMbps, projectShares=projectShares, lunReadIops=lunReadIops, iscsiInitiatorGroup=iscsiInitiatorGroup, aclMigrationCompleted=aclMigrationCompleted, projectQuotaSizeHigh=projectQuotaSizeHigh, disks=disks, replicationPaused=replicationPaused, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, smbSocketFailure=smbSocketFailure, poolCount=poolCount, projectIndex=projectIndex, upgradeDownloadCompleted=upgradeDownloadCompleted, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, nvdimmFailUnknownError=nvdimmFailUnknownError, lunReservedSizeHigh=lunReservedSizeHigh, diskGoneOffline=diskGoneOffline, cifsAvgWriteLatency=cifsAvgWriteLatency, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, projectDataSizeLow=projectDataSizeLow, shareNFSReadIops=shareNFSReadIops, snapshotDeleteFailed=snapshotDeleteFailed, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, iscsiTargetWriteIops=iscsiTargetWriteIops, vmwareNFSDatastores=vmwareNFSDatastores, haControllerA_IPAddr=haControllerA_IPAddr, ipmiMemory=ipmiMemory, lunWriteMbps=lunWriteMbps, iscsiTargetError=iscsiTargetError, notificationProps=notificationProps, controllerUp=controllerUp, nicMTU=nicMTU, spareDiskReplaced=spareDiskReplaced, fcInitiatorCreateFailed=fcInitiatorCreateFailed, fcTargetReadLatency=fcTargetReadLatency, projectModified=projectModified, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, poolFreeSizeHigh=poolFreeSizeHigh, shareSnapshotSizeLow=shareSnapshotSizeLow, cpuTotalUsage=cpuTotalUsage, iscsiWriteIops=iscsiWriteIops, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, fcInitiatorEntry=fcInitiatorEntry, shareNFSReadLatency=shareNFSReadLatency, lunPoolName=lunPoolName, replicationStarted=replicationStarted, iscsiInitiatorEntry=iscsiInitiatorEntry, nicName=nicName, fcInitiatorName=fcInitiatorName, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, diskTotalReadIops=diskTotalReadIops, iscsiTargetEntry=iscsiTargetEntry, sensorFailureEvent=sensorFailureEvent, diagnosticDataUploaded=diagnosticDataUploaded)
mibBuilder.exportSymbols("TEGILE-MIB", snapshotCloneCompleted=snapshotCloneCompleted, poolUsedSizeLow=poolUsedSizeLow, poolReadCacheReadIops=poolReadCacheReadIops, poolAvgReadLatency=poolAvgReadLatency, haResourceStatus=haResourceStatus, haResourceEntry=haResourceEntry, replicationAbandoned=replicationAbandoned, projectLunCount=projectLunCount, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, notificationSeverity=notificationSeverity, lunBlockSize=lunBlockSize, iscsiTotalWriteMbps=iscsiTotalWriteMbps, diskRandomIOCount=diskRandomIOCount, basicCompliance=basicCompliance, notificationReadingUnit=notificationReadingUnit, iscsiTargets=iscsiTargets, nfsTotalWriteIops=nfsTotalWriteIops, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, lunTable=lunTable, lunTargetGroup=lunTargetGroup, cacheTotalWriteMbps=cacheTotalWriteMbps, lunCompressionEnabled=lunCompressionEnabled, projectThresholdExceedWarning=projectThresholdExceedWarning, snapshotRollbackFailed=snapshotRollbackFailed, shareCIFSWriteIops=shareCIFSWriteIops, iscsiInitiators=iscsiInitiators, controllerHardwareModel=controllerHardwareModel, poolOwnerController=poolOwnerController, diskEntry=diskEntry, poolTotalReadIops=poolTotalReadIops, snmpAgentVersion=snmpAgentVersion, lunCompressedRatio=lunCompressedRatio, lunSizeLow=lunSizeLow, haControllerB_Uptime=haControllerB_Uptime, smisServiceStartFailed=smisServiceStartFailed, ipmiVoltage=ipmiVoltage, networkIpmpGroupDown=networkIpmpGroupDown, iscsiInitiatorChapUser=iscsiInitiatorChapUser, fcTargetGroup=fcTargetGroup, ipmiPowerSupply=ipmiPowerSupply, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, networkTotalTransmitMbps=networkTotalTransmitMbps, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, webdocsUpgradeCompleted=webdocsUpgradeCompleted, ipmiOther=ipmiOther, nfsTotalWriteMbps=nfsTotalWriteMbps, projectQuotaSizeLow=projectQuotaSizeLow, iscsiInitiatorsTable=iscsiInitiatorsTable, diskSizeHigh=diskSizeHigh, lunProtocol=lunProtocol, haControllerB_IPAddr=haControllerB_IPAddr, lunFreeSizeLow=lunFreeSizeLow, diskTotalWriteIops=diskTotalWriteIops, diskSlowIo=diskSlowIo, projectFreeSizeHigh=projectFreeSizeHigh, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, snapshotCreationFailed=snapshotCreationFailed, shareMountPoint=shareMountPoint, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, globalStatistics=globalStatistics, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, iscsiTargetAlias=iscsiTargetAlias, shareDeleted=shareDeleted, fcTargetEntry=fcTargetEntry, diskDataWriteIops=diskDataWriteIops, fcInitiatorGroup=fcInitiatorGroup, volumeDeleteFailed=volumeDeleteFailed, poolMetaWriteLatency=poolMetaWriteLatency, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, poolTotalWriteIops=poolTotalWriteIops, fcAvgReadLatency=fcAvgReadLatency, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, fcTargetReadIops=fcTargetReadIops, iscsiTargetGroup=iscsiTargetGroup, haResourceIndex=haResourceIndex, fcAvgWriteLatency=fcAvgWriteLatency, nvdimmFailInitializationError=nvdimmFailInitializationError, haControllerB_Name=haControllerB_Name, nicState=nicState, poolDegraded=poolDegraded, shareEntry=shareEntry, upgradeDownloadStarted=upgradeDownloadStarted, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, poolDataReadLatency=poolDataReadLatency, projectDataSizeHigh=projectDataSizeHigh, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, nicTable=nicTable, volumeQuotaFinished=volumeQuotaFinished, iscsiTargetsTable=iscsiTargetsTable, projectDedupEnabled=projectDedupEnabled, poolTable=poolTable, shareReservedSizeLow=shareReservedSizeLow, networkTotalReceiveMbps=networkTotalReceiveMbps, poolReadCacheWriteMbps=poolReadCacheWriteMbps, poolIndex=poolIndex, lunGUID=lunGUID, shareCIFSReadMbps=shareCIFSReadMbps, poolExported=poolExported, sanProperties=sanProperties, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, diskCount=diskCount, snmpServiceStartFailed=snmpServiceStartFailed, networkInterfaceDown=networkInterfaceDown, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, projectTotalSaving=projectTotalSaving, smisServiceStarted=smisServiceStarted, cpuSystemCalls=cpuSystemCalls, nicEntry=nicEntry, poolMetaWriteMbps=poolMetaWriteMbps, cacheRAMReads=cacheRAMReads, initiatorGroupMemberAdded=initiatorGroupMemberAdded, fcPortOffline=fcPortOffline, projectTable=projectTable, shareCompressionEnabled=shareCompressionEnabled, notificationReadingTriggerValue=notificationReadingTriggerValue, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, networkInterfaceUp=networkInterfaceUp, notificationTargetEntityName=notificationTargetEntityName, nvdimmFailDeviceError=nvdimmFailDeviceError, haResourceDescription=haResourceDescription, diskType=diskType, poolReadCacheReadLatency=poolReadCacheReadLatency, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, targetGroupCreateCompleted=targetGroupCreateCompleted, ipmiFan=ipmiFan, iscsiTargetAuth=iscsiTargetAuth, network=network, replicationResumed=replicationResumed, lunSizeHigh=lunSizeHigh, lunReservedSizeLow=lunReservedSizeLow, memoryFailure=memoryFailure, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, projectName=projectName, shareReservedSizeHigh=shareReservedSizeHigh, poolTotalSaving=poolTotalSaving, fcTotalReadMbps=fcTotalReadMbps, shareDedupEnabled=shareDedupEnabled, intelliFlashSoftwareDown=intelliFlashSoftwareDown, fcTargetStatus=fcTargetStatus, fcTargetIndex=fcTargetIndex, lunSnapshotSizeLow=lunSnapshotSizeLow, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, sharePoolName=sharePoolName, shareProjectName=shareProjectName, projectSnapshotSizeHigh=projectSnapshotSizeHigh, lunReadLatency=lunReadLatency, poolFreeSizeLow=poolFreeSizeLow, shareCIFSWriteMbps=shareCIFSWriteMbps, iscsiAvgReadLatency=iscsiAvgReadLatency, lunInitiatorGroup=lunInitiatorGroup, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, iscsiTargetGroupError=iscsiTargetGroupError, poolSizeHigh=poolSizeHigh, fcTargetWriteMbps=fcTargetWriteMbps, projectPoolName=projectPoolName, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, poolDataWriteLatency=poolDataWriteLatency, lunWriteLatency=lunWriteLatency, fcTargetsTable=fcTargetsTable, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, haResourceActiveNode=haResourceActiveNode, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, projectDeleted=projectDeleted, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, iscsiTargetReadMbps=iscsiTargetReadMbps, projectQuotaFinished=projectQuotaFinished, diskTable=diskTable, poolMetaReadIops=poolMetaReadIops, shareNFSWriteMbps=shareNFSWriteMbps, networkIpmpGroupUp=networkIpmpGroupUp, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, lunWriteIops=lunWriteIops, poolSizeLow=poolSizeLow, poolDeleted=poolDeleted, fcInitiatorsTable=fcInitiatorsTable, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, currentObjectGroup=currentObjectGroup, PYSNMP_MODULE_ID=tegile, snapshotCloningFailed=snapshotCloningFailed, diskTotalReadMbps=diskTotalReadMbps, shareNFSWriteIops=shareNFSWriteIops, alertsCleanupCompleted=alertsCleanupCompleted, poolUsedSizeHigh=poolUsedSizeHigh, fcTargetName=fcTargetName, fcTargetModifyCompleted=fcTargetModifyCompleted, poolTotalWriteMbps=poolTotalWriteMbps, poolMetaReadLatency=poolMetaReadLatency, iscsiTargetWriteMbps=iscsiTargetWriteMbps, iscsiAvgWriteLatency=iscsiAvgWriteLatency, replicationFailed=replicationFailed, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, fcTotalWriteMbps=fcTotalWriteMbps, poolDataSizeHigh=poolDataSizeHigh, tegile=tegile, poolWriteCacheWriteIops=poolWriteCacheWriteIops, shareIndex=shareIndex, diskTotalWriteMbps=diskTotalWriteMbps, projectDeletionFailed=projectDeletionFailed, cifsAvgReadLatency=cifsAvgReadLatency, volumeDeleteCompleted=volumeDeleteCompleted, cacheSSDReads=cacheSSDReads, lunProjectName=lunProjectName, cacheTotalReadIops=cacheTotalReadIops, haResources=haResources, iscsiTargetName=iscsiTargetName, nfsTotalReadIops=nfsTotalReadIops, iscsiImproperTargetGroup=iscsiImproperTargetGroup, haResourceGroup=haResourceGroup, nicIndex=nicIndex)
