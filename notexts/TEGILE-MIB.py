...
# Produced by pysmi-1.1.8 at Tue Sep 12 07:06:27 2023
...
Unsigned32, IpAddress, ModuleIdentity, Gauge32, MibIdentifier, TimeTicks, Counter64, Counter32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, iso, Integer32, ObjectIdentity, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "ModuleIdentity", "Gauge32", "MibIdentifier", "TimeTicks", "Counter64", "Counter32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "iso", "Integer32", "ObjectIdentity", "enterprises")
...
mibBuilder.exportSymbols("TEGILE-MIB", lunReadIops=lunReadIops, shareCompressedRatio=shareCompressedRatio, networkTotalTransmitMbps=networkTotalTransmitMbps, shareNFSReadMbps=shareNFSReadMbps, diskSequentialIOCount=diskSequentialIOCount, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, iscsiTargetError=iscsiTargetError, shareSnapshotSizeHigh=shareSnapshotSizeHigh, nfsTotalReadMbps=nfsTotalReadMbps, nfsAvgWriteLatency=nfsAvgWriteLatency, fcTargetGroup=fcTargetGroup, shareReservedSizeHigh=shareReservedSizeHigh, poolDataSizeLow=poolDataSizeLow, nvdimmFailDeviceError=nvdimmFailDeviceError, projectPoolName=projectPoolName, diskGoneOffline=diskGoneOffline, volumeModifyCompleted=volumeModifyCompleted, haResourcesTable=haResourcesTable, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, diskAvgReadLatency=diskAvgReadLatency, poolReadCacheReadMbps=poolReadCacheReadMbps, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, maintenanceModeDisabled=maintenanceModeDisabled, projectThresholdExceedWarning=projectThresholdExceedWarning, poolExported=poolExported, lunTargetGroup=lunTargetGroup, projectDeleted=projectDeleted, fcInitiators=fcInitiators, projectDataSizeHigh=projectDataSizeHigh, iscsiTargetReadLatency=iscsiTargetReadLatency, lunCompressedRatio=lunCompressedRatio, adServerTimeDrift=adServerTimeDrift, ipmiVoltage=ipmiVoltage, currentNotificationGroup=currentNotificationGroup, poolTotalReadMbps=poolTotalReadMbps, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, fcTotalReadMbps=fcTotalReadMbps, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, snmpServiceStarted=snmpServiceStarted, cacheTotalWriteMbps=cacheTotalWriteMbps, shareProjectName=shareProjectName, notificationReadingTriggerValue=notificationReadingTriggerValue, diskError=diskError, iscsiInitiatorIndex=iscsiInitiatorIndex, targetGroupCreateCompleted=targetGroupCreateCompleted, fcProperties=fcProperties, replicationAborted=replicationAborted, lunWriteLatency=lunWriteLatency, nicName=nicName, shareCIFSReadIops=shareCIFSReadIops, lunSizeLow=lunSizeLow, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, sensorFailureEvent=sensorFailureEvent, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, fcInitiatorCreateFailed=fcInitiatorCreateFailed, networkIpmpGroupDown=networkIpmpGroupDown, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, poolEntry=poolEntry, diskAlias=diskAlias, poolUsedSizeLow=poolUsedSizeLow, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, poolDegraded=poolDegraded, network=network, iscsiInitiators=iscsiInitiators, lunDataSizeHigh=lunDataSizeHigh, tegile=tegile, fcAvgReadLatency=fcAvgReadLatency, shareCIFSWriteMbps=shareCIFSWriteMbps, upgradeDownloadFailed=upgradeDownloadFailed, upgradeFailed=upgradeFailed, replicationPaused=replicationPaused, replicationComplete=replicationComplete, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, iscsiInitiatorEntry=iscsiInitiatorEntry, smisServiceStopped=smisServiceStopped, poolDataReadMbps=poolDataReadMbps, iscsiTargetAuth=iscsiTargetAuth, alertsCleanupCompleted=alertsCleanupCompleted, shareQuotaFinished=shareQuotaFinished, projectShareCount=projectShareCount, volumeQuotaFinished=volumeQuotaFinished, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, targetGroupMemberRemoved=targetGroupMemberRemoved, cacheTotalReadMbps=cacheTotalReadMbps, poolReadCacheReadIops=poolReadCacheReadIops, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, projectQuotaFinished=projectQuotaFinished, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, shareQuotaHigh=shareQuotaHigh, poolSizeHigh=poolSizeHigh, cifsAvgWriteLatency=cifsAvgWriteLatency, iscsiAvgWriteLatency=iscsiAvgWriteLatency, shareDeleted=shareDeleted, projectIndex=projectIndex, targetGroupMemberAdded=targetGroupMemberAdded, cpuInterrupts=cpuInterrupts, poolHealth=poolHealth, fcTargetReadLatency=fcTargetReadLatency, notificationReadingUnit=notificationReadingUnit, cpuTotalUsage=cpuTotalUsage, notificationEventCode=notificationEventCode, snapshotRollbackFailed=snapshotRollbackFailed, projectDataSizeLow=projectDataSizeLow, shareCIFSReadLatency=shareCIFSReadLatency, lunFreeSizeHigh=lunFreeSizeHigh, shareNFSWriteLatency=shareNFSWriteLatency, nicTable=nicTable, diskDataWriteIops=diskDataWriteIops, fcTotalReadIops=fcTotalReadIops, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, shareDeletionFailed=shareDeletionFailed, shareNFSWriteMbps=shareNFSWriteMbps, poolReadCacheWriteMbps=poolReadCacheWriteMbps, volumeCreatedSuccessfully=volumeCreatedSuccessfully, PYSNMP_MODULE_ID=tegile, fcTargetReadMbps=fcTargetReadMbps, poolName=poolName, haControllerA_IPAddr=haControllerA_IPAddr, diskType=diskType, lunProtocol=lunProtocol, nvdimmFailInitializationError=nvdimmFailInitializationError, shareReservedSizeLow=shareReservedSizeLow, projectCreatedSuccessfully=projectCreatedSuccessfully, notificationComponentName=notificationComponentName, lunTable=lunTable, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, cacheTotalWriteIops=cacheTotalWriteIops, iscsiTargetsTable=iscsiTargetsTable, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, diskTotalReadIops=diskTotalReadIops, cacheTotalReadIops=cacheTotalReadIops, poolMetaWriteMbps=poolMetaWriteMbps, diskTotalReadMbps=diskTotalReadMbps, notificationThresholdTriggerValue=notificationThresholdTriggerValue, notificationTargetEntityName=notificationTargetEntityName, replicationAbandoned=replicationAbandoned, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, diskSizeLow=diskSizeLow, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, iscsiTotalWriteMbps=iscsiTotalWriteMbps, diskSizeHigh=diskSizeHigh, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, ipmiTemperature=ipmiTemperature, lunIndex=lunIndex, nicGroup=nicGroup, lunSnapshotSizeLow=lunSnapshotSizeLow, notificationProps=notificationProps, replicationTargetDeleted=replicationTargetDeleted, lunEntry=lunEntry, ipmiCriticalInterrupt=ipmiCriticalInterrupt, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, diskIsOnline=diskIsOnline, poolCount=poolCount, poolDataWriteMbps=poolDataWriteMbps, volumeDeleteFailed=volumeDeleteFailed, iscsiTargets=iscsiTargets, poolUpgraded=poolUpgraded, snmpServiceStopped=snmpServiceStopped, projectQuotaSizeLow=projectQuotaSizeLow, shareDedupEnabled=shareDedupEnabled, shareEntry=shareEntry, cacheSSDReads=cacheSSDReads, iscsiTargetWriteLatency=iscsiTargetWriteLatency, cifsTotalReadMbps=cifsTotalReadMbps, fcInitiatorEntry=fcInitiatorEntry, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, projectDedupEnabled=projectDedupEnabled, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, networkTotalReceiveMbps=networkTotalReceiveMbps, iscsiWriteIops=iscsiWriteIops, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, smbSocketFailure=smbSocketFailure, controllerHardwareModel=controllerHardwareModel, notificationSensorSuspect=notificationSensorSuspect, notificationSensorAction=notificationSensorAction, cpuSystemCalls=cpuSystemCalls, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, poolMetaReadLatency=poolMetaReadLatency, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, currentObjectGroup=currentObjectGroup, lunFreeSizeLow=lunFreeSizeLow, upgradeTimeout=upgradeTimeout, poolTable=poolTable, pools=pools, shareNFSWriteIops=shareNFSWriteIops, snmpServiceStartFailed=snmpServiceStartFailed, userLoginFailed=userLoginFailed, fcTargetModifyCompleted=fcTargetModifyCompleted, nvdimmFailSoftError=nvdimmFailSoftError, deleteFolderCompleted=deleteFolderCompleted, cacheRAMReads=cacheRAMReads, diskEntry=diskEntry, nfsTotalReadIops=nfsTotalReadIops, networkInterfaceDown=networkInterfaceDown, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, diskChassisIdx=diskChassisIdx, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, fcTargetWriteLatency=fcTargetWriteLatency, iscsiTotalReadMbps=iscsiTotalReadMbps, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, shareMountPoint=shareMountPoint, ipmiFan=ipmiFan, fcPortOffline=fcPortOffline, iscsiInitiatorsTable=iscsiInitiatorsTable, lunProjectName=lunProjectName, fcTargetWriteIops=fcTargetWriteIops, lunGUID=lunGUID, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, poolDataReadLatency=poolDataReadLatency, diskAvgWriteLatency=diskAvgWriteLatency, diskSlowIo=diskSlowIo, tegileConformance=tegileConformance, iscsiInitiatorName=iscsiInitiatorName, snapshotCloningFailed=snapshotCloningFailed, replicationSourceRegistered=replicationSourceRegistered, iscsiTargetGroupError=iscsiTargetGroupError, diskIOCount=diskIOCount, notificationTime=notificationTime, haResources=haResources, projectSnapshotSizeHigh=projectSnapshotSizeHigh, snmpAgentVersion=snmpAgentVersion, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, shareCreatedSuccessfully=shareCreatedSuccessfully, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, nicIndex=nicIndex, diskDataReadMbps=diskDataReadMbps, lunName=lunName, diskTotalWriteMbps=diskTotalWriteMbps, lunDedupEnabled=lunDedupEnabled, volumeDeleteCompleted=volumeDeleteCompleted, iscsiTargetWriteIops=iscsiTargetWriteIops, tdpsUpgradeCompleted=tdpsUpgradeCompleted, diskRandomIOCount=diskRandomIOCount, intelliFlashSoftwareUp=intelliFlashSoftwareUp, lunBlockSize=lunBlockSize, tegileArray=tegileArray, shareDataSizeLow=shareDataSizeLow, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, nvdimmFailUnknownError=nvdimmFailUnknownError, fcTargetIndex=fcTargetIndex, lunInitiatorGroup=lunInitiatorGroup, snapshotCloneCompleted=snapshotCloneCompleted, poolTotalWriteIops=poolTotalWriteIops, poolTotalSaving=poolTotalSaving, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, haControllerA_Name=haControllerA_Name, shareNFSReadLatency=shareNFSReadLatency)
mibBuilder.exportSymbols("TEGILE-MIB", fcInitiatorGroup=fcInitiatorGroup, poolMetaReadMbps=poolMetaReadMbps, cifsAvgReadLatency=cifsAvgReadLatency, memoryFailure=memoryFailure, haControllerA_Uptime=haControllerA_Uptime, nicMTU=nicMTU, iscsiAvgReadLatency=iscsiAvgReadLatency, poolAvgWriteLatency=poolAvgWriteLatency, notifications=notifications, initiatorGroupMemberAdded=initiatorGroupMemberAdded, tdpsUpgradeFailed=tdpsUpgradeFailed, poolReadCacheWriteIops=poolReadCacheWriteIops, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, poolMetaReadIops=poolMetaReadIops, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, projectName=projectName, shareTable=shareTable, ipmiPowerSupply=ipmiPowerSupply, snapshotCreationFailed=snapshotCreationFailed, poolMetaWriteIops=poolMetaWriteIops, lunWriteIops=lunWriteIops, deleteFolderFailed=deleteFolderFailed, poolAvgReadLatency=poolAvgReadLatency, tdpsUpgradeTimeout=tdpsUpgradeTimeout, nfsAvgReadLatency=nfsAvgReadLatency, snapshotRollbackCompleted=snapshotRollbackCompleted, diskPoolName=diskPoolName, fcInitiatorName=fcInitiatorName, basicCompliance=basicCompliance, poolTotalWriteMbps=poolTotalWriteMbps, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, smisServiceStopFailed=smisServiceStopFailed, iscsiTargetName=iscsiTargetName, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, poolState=poolState, smisServiceStarted=smisServiceStarted, iscsiTargetEntry=iscsiTargetEntry, fcTotalWriteMbps=fcTotalWriteMbps, cifsTotalReadIops=cifsTotalReadIops, fcAvgWriteLatency=fcAvgWriteLatency, ipmiOther=ipmiOther, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, shareNFSReadIops=shareNFSReadIops, diskCount=diskCount, lunCompressionEnabled=lunCompressionEnabled, haResourceDescription=haResourceDescription, sanProperties=sanProperties, shareCIFSReadMbps=shareCIFSReadMbps, projectSnapshotSizeLow=projectSnapshotSizeLow, poolIndex=poolIndex, iscsiTargetReadMbps=iscsiTargetReadMbps, poolFreeSizeHigh=poolFreeSizeHigh, lunWriteMbps=lunWriteMbps, upgradeDownloadCompleted=upgradeDownloadCompleted, projectLUNs=projectLUNs, iscsiTargetAlias=iscsiTargetAlias, poolWriteCacheWriteIops=poolWriteCacheWriteIops, shareIndex=shareIndex, fcPortOnline=fcPortOnline, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, fcTargets=fcTargets, tegileArray_notifications=tegileArray_notifications, haControllerB_Uptime=haControllerB_Uptime, poolDataWriteLatency=poolDataWriteLatency, projectLunCount=projectLunCount, unknownSensorEvent=unknownSensorEvent, diagnosticDataUploaded=diagnosticDataUploaded, shareCIFSEnabled=shareCIFSEnabled, poolQuotaFinished=poolQuotaFinished, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, iscsiImproperTargetGroup=iscsiImproperTargetGroup, lunSnapshotSizeHigh=lunSnapshotSizeHigh, lunReservedSizeHigh=lunReservedSizeHigh, poolSizeLow=poolSizeLow, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, poolTotalReadIops=poolTotalReadIops, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, targetGroupDeleteCompleted=targetGroupDeleteCompleted, poolOwnerController=poolOwnerController, nicEntry=nicEntry, poolDataReadIops=poolDataReadIops, poolProjects=poolProjects, fcTargetEntry=fcTargetEntry, poolUsedSizeHigh=poolUsedSizeHigh, ntpServerTimeDrift=ntpServerTimeDrift, poolDeleted=poolDeleted, haResourceGroup=haResourceGroup, projectFreeSizeHigh=projectFreeSizeHigh, poolExpanded=poolExpanded, intelliFlashSoftwareDown=intelliFlashSoftwareDown, iscsiTargetIndex=iscsiTargetIndex, testNotification=testNotification, poolProjectCount=poolProjectCount, diskTable=diskTable, ipmiMemory=ipmiMemory, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, lunReadLatency=lunReadLatency, poolReadCacheReadLatency=poolReadCacheReadLatency, shareCompressionEnabled=shareCompressionEnabled, ipmiCurrent=ipmiCurrent, projectFreeSizeLow=projectFreeSizeLow, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, properties=properties, poolCreated=poolCreated, shareCIFSWriteIops=shareCIFSWriteIops, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, maintenanceModeEnabled=maintenanceModeEnabled, poolImported=poolImported, lunSizeHigh=lunSizeHigh, haResourceStatus=haResourceStatus, projectTable=projectTable, replicationResumed=replicationResumed, notificationSensorNumber=notificationSensorNumber, projectTotalSaving=projectTotalSaving, haResourceIndex=haResourceIndex, notificationObjects=notificationObjects, fcTargetWriteMbps=fcTargetWriteMbps, haControllerB_Name=haControllerB_Name, upgradeStarted=upgradeStarted, poolFreeSizeLow=poolFreeSizeLow, ipmiThreshold=ipmiThreshold, nicTransmitMbps=nicTransmitMbps, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, projectCompressionEnabled=projectCompressionEnabled, disks=disks, netbiosSocketFailure=netbiosSocketFailure, spareDiskReplaced=spareDiskReplaced, shareQuotaLow=shareQuotaLow, fcTargetStatus=fcTargetStatus, shareDataSizeHigh=shareDataSizeHigh, iscsiTargetGroup=iscsiTargetGroup, haResourceEntry=haResourceEntry, cifsTotalWriteIops=cifsTotalWriteIops, aclMigrationCompleted=aclMigrationCompleted, poolDeletionFailed=poolDeletionFailed, fcTargetReadIops=fcTargetReadIops, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, poolDataSizeHigh=poolDataSizeHigh, projectEntry=projectEntry, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, controllerUp=controllerUp, nfsTotalWriteMbps=nfsTotalWriteMbps, diskDataWriteMbps=diskDataWriteMbps, nicState=nicState, diskTotalWriteIops=diskTotalWriteIops, snapshotDeleteFailed=snapshotDeleteFailed, lunDataSizeLow=lunDataSizeLow, tegileCompliances=tegileCompliances, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, snmpServiceStopFailed=snmpServiceStopFailed, projectShares=projectShares, cifsTotalWriteMbps=cifsTotalWriteMbps, aclMigrationStarted=aclMigrationStarted, fcTargetName=fcTargetName, poolReadCacheWriteLatency=poolReadCacheWriteLatency, poolMetaWriteLatency=poolMetaWriteLatency, shareCIFSWriteLatency=shareCIFSWriteLatency, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, fcInitiatorsTable=fcInitiatorsTable, diskState=diskState, networkIpmpGroupUp=networkIpmpGroupUp, diskIndex=diskIndex, projectDeletionFailed=projectDeletionFailed, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, diskDataReadIops=diskDataReadIops, lunReadMbps=lunReadMbps, notificationDescription=notificationDescription, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, networkInterfaceUp=networkInterfaceUp, iscsiInitiatorGroup=iscsiInitiatorGroup, iscsiInitiatorChapUser=iscsiInitiatorChapUser, controllerDown=controllerDown, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, tegileGroups=tegileGroups, nicReceiveMbps=nicReceiveMbps, iscsiTotalReadIops=iscsiTotalReadIops, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, haResourceName=haResourceName, notificationSeverity=notificationSeverity, projectModified=projectModified, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, fcTargetsTable=fcTargetsTable, iscsiTargetWriteMbps=iscsiTargetWriteMbps, poolDataWriteIops=poolDataWriteIops, controllerTimeDrift=controllerTimeDrift, projectQuotaSizeHigh=projectQuotaSizeHigh, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, haResourceActiveNode=haResourceActiveNode, lunReservedSizeLow=lunReservedSizeLow, haControllerB_IPAddr=haControllerB_IPAddr, iscsiProperties=iscsiProperties, shareNFSEnabled=shareNFSEnabled, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, vmwareNFSDatastores=vmwareNFSDatastores, smisServiceStartFailed=smisServiceStartFailed, lunPoolName=lunPoolName, replicationFailed=replicationFailed, upgradeCompleted=upgradeCompleted, replicationStarted=replicationStarted, upgradeDownloadStarted=upgradeDownloadStarted, nfsTotalWriteIops=nfsTotalWriteIops, globalStatistics=globalStatistics, shareName=shareName, webdocsUpgradeFailed=webdocsUpgradeFailed, sharePoolName=sharePoolName, fcTotalWriteIops=fcTotalWriteIops, shareSnapshotSizeLow=shareSnapshotSizeLow, webdocsUpgradeCompleted=webdocsUpgradeCompleted, shareExceedThresholdWarning=shareExceedThresholdWarning, fcInitiatorIndex=fcInitiatorIndex, iscsiTargetReadIops=iscsiTargetReadIops)
