...
Integer32, TimeTicks, Gauge32, Bits, enterprises, iso, Counter64, ObjectIdentity, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "TimeTicks", "Gauge32", "Bits", "enterprises", "iso", "Counter64", "ObjectIdentity", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity", "Counter32", "NotificationType")
...
mibBuilder.exportSymbols("TEGILE-MIB", projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, cifsTotalReadMbps=cifsTotalReadMbps, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, nicName=nicName, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, poolReadCacheReadMbps=poolReadCacheReadMbps, cacheTotalWriteMbps=cacheTotalWriteMbps, iscsiTargetWriteMbps=iscsiTargetWriteMbps, controllerTimeDrift=controllerTimeDrift, haControllerB_IPAddr=haControllerB_IPAddr, poolTotalSaving=poolTotalSaving, shareCIFSReadMbps=shareCIFSReadMbps, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, controllerDown=controllerDown, shareNFSWriteLatency=shareNFSWriteLatency, notificationSensorNumber=notificationSensorNumber, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, shareDeleted=shareDeleted, diskTotalWriteMbps=diskTotalWriteMbps, poolDataReadIops=poolDataReadIops, poolOwnerController=poolOwnerController, lunReadLatency=lunReadLatency, webdocsUpgradeFailed=webdocsUpgradeFailed, diskRandomIOCount=diskRandomIOCount, ipmiOther=ipmiOther, poolReadCacheWriteIops=poolReadCacheWriteIops, iscsiTargetError=iscsiTargetError, haResourceName=haResourceName, networkInterfaceDown=networkInterfaceDown, fcPortOffline=fcPortOffline, shareNFSEnabled=shareNFSEnabled, shareName=shareName, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, poolDeleted=poolDeleted, diskSizeLow=diskSizeLow, testNotification=testNotification, replicationComplete=replicationComplete, notificationSensorSuspect=notificationSensorSuspect, properties=properties, poolTotalReadIops=poolTotalReadIops, lunProjectName=lunProjectName, replicationAborted=replicationAborted, networkTotalReceiveMbps=networkTotalReceiveMbps, poolMetaWriteIops=poolMetaWriteIops, shareSnapshotSizeHigh=shareSnapshotSizeHigh, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, ipmiFan=ipmiFan, nvdimmFailUnknownError=nvdimmFailUnknownError, currentObjectGroup=currentObjectGroup, shareCIFSReadIops=shareCIFSReadIops, shareQuotaHigh=shareQuotaHigh, poolEntry=poolEntry, fcTargetEntry=fcTargetEntry, nvdimmFailSoftError=nvdimmFailSoftError, fcTargetWriteMbps=fcTargetWriteMbps, lunName=lunName, upgradeCompleted=upgradeCompleted, fcTargetWriteLatency=fcTargetWriteLatency, aclMigrationStarted=aclMigrationStarted, snapshotRollbackCompleted=snapshotRollbackCompleted, lunEntry=lunEntry, diskAlias=diskAlias, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, smisServiceStartFailed=smisServiceStartFailed, fcTargetsTable=fcTargetsTable, iscsiTargetsTable=iscsiTargetsTable, iscsiProperties=iscsiProperties, nicTransmitMbps=nicTransmitMbps, cacheTotalReadIops=cacheTotalReadIops, poolDeletionFailed=poolDeletionFailed, intelliFlashSoftwareUp=intelliFlashSoftwareUp, projectModified=projectModified, controllerUp=controllerUp, fcInitiatorEntry=fcInitiatorEntry, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, cacheTotalWriteIops=cacheTotalWriteIops, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, poolReadCacheReadLatency=poolReadCacheReadLatency, iscsiWriteIops=iscsiWriteIops, poolTotalWriteIops=poolTotalWriteIops, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, diskTable=diskTable, iscsiInitiatorName=iscsiInitiatorName, projectTable=projectTable, iscsiInitiatorEntry=iscsiInitiatorEntry, disks=disks, poolUpgraded=poolUpgraded, replicationFailed=replicationFailed, poolCount=poolCount, poolHealth=poolHealth, cifsTotalWriteIops=cifsTotalWriteIops, lunInitiatorGroup=lunInitiatorGroup, deleteFolderFailed=deleteFolderFailed, projectSnapshotSizeHigh=projectSnapshotSizeHigh, fcPortOnline=fcPortOnline, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, aclMigrationCompleted=aclMigrationCompleted, fcAvgWriteLatency=fcAvgWriteLatency, snapshotDeleteFailed=snapshotDeleteFailed, ipmiMemory=ipmiMemory, notificationEventCode=notificationEventCode, notificationThresholdTriggerValue=notificationThresholdTriggerValue, networkInterfaceUp=networkInterfaceUp, diskIOCount=diskIOCount, iscsiTotalReadMbps=iscsiTotalReadMbps, shareTable=shareTable, smisServiceStarted=smisServiceStarted, lunWriteIops=lunWriteIops, ipmiVoltage=ipmiVoltage, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, replicationStarted=replicationStarted, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, shareDeletionFailed=shareDeletionFailed, fcTargetName=fcTargetName, shareDataSizeLow=shareDataSizeLow, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, lunFreeSizeLow=lunFreeSizeLow, projectFreeSizeLow=projectFreeSizeLow, poolWriteCacheWriteIops=poolWriteCacheWriteIops, lunDataSizeLow=lunDataSizeLow, shareNFSReadIops=shareNFSReadIops, haResourcesTable=haResourcesTable, lunProtocol=lunProtocol, tegileArray=tegileArray, poolTotalWriteMbps=poolTotalWriteMbps, controllerHardwareModel=controllerHardwareModel, poolQuotaFinished=poolQuotaFinished, lunWriteMbps=lunWriteMbps, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, shareMountPoint=shareMountPoint, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, iscsiTargetGroupError=iscsiTargetGroupError, projectShareCount=projectShareCount, smbSocketFailure=smbSocketFailure, notificationTime=notificationTime, nicMTU=nicMTU, iscsiTotalReadIops=iscsiTotalReadIops, projectQuotaFinished=projectQuotaFinished, projectDedupEnabled=projectDedupEnabled, spareDiskReplaced=spareDiskReplaced, fcTargetWriteIops=fcTargetWriteIops, cacheRAMReads=cacheRAMReads, network=network, poolState=poolState, projectName=projectName, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, nfsTotalWriteIops=nfsTotalWriteIops, diskSequentialIOCount=diskSequentialIOCount, fcTotalWriteMbps=fcTotalWriteMbps, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, projectCompressionEnabled=projectCompressionEnabled, shareCIFSWriteMbps=shareCIFSWriteMbps, volumeCreatedSuccessfully=volumeCreatedSuccessfully, poolDataWriteLatency=poolDataWriteLatency, nicTable=nicTable, tegileArray_notifications=tegileArray_notifications, poolExpanded=poolExpanded, replicationTargetDeleted=replicationTargetDeleted, snmpServiceStopped=snmpServiceStopped, maintenanceModeEnabled=maintenanceModeEnabled, haControllerA_Uptime=haControllerA_Uptime, lunCompressedRatio=lunCompressedRatio, poolImported=poolImported, lunSizeHigh=lunSizeHigh, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, iscsiAvgReadLatency=iscsiAvgReadLatency, haResourceStatus=haResourceStatus, iscsiInitiatorGroup=iscsiInitiatorGroup, shareEntry=shareEntry, vmwareNFSDatastores=vmwareNFSDatastores, cpuSystemCalls=cpuSystemCalls, targetGroupCreateCompleted=targetGroupCreateCompleted, diskSizeHigh=diskSizeHigh, projectSnapshotSizeLow=projectSnapshotSizeLow, nicReceiveMbps=nicReceiveMbps, iscsiTargetWriteLatency=iscsiTargetWriteLatency, tdpsUpgradeCompleted=tdpsUpgradeCompleted, diskDataReadMbps=diskDataReadMbps, volumeDeleteFailed=volumeDeleteFailed, poolName=poolName, shareCIFSReadLatency=shareCIFSReadLatency, projectLUNs=projectLUNs, shareDedupEnabled=shareDedupEnabled, nfsTotalWriteMbps=nfsTotalWriteMbps, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, poolReadCacheWriteMbps=poolReadCacheWriteMbps, basicCompliance=basicCompliance, nvdimmFailDeviceError=nvdimmFailDeviceError, fcTotalWriteIops=fcTotalWriteIops, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, cpuInterrupts=cpuInterrupts, diskTotalReadIops=diskTotalReadIops, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, poolProjectCount=poolProjectCount, diskTotalWriteIops=diskTotalWriteIops, ipmiPowerSupply=ipmiPowerSupply, haControllerB_Name=haControllerB_Name, snmpServiceStarted=snmpServiceStarted, deleteFolderCompleted=deleteFolderCompleted, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, snapshotCloningFailed=snapshotCloningFailed, diskCount=diskCount, shareQuotaFinished=shareQuotaFinished, targetGroupMemberRemoved=targetGroupMemberRemoved, shareSnapshotSizeLow=shareSnapshotSizeLow, haResources=haResources, nicEntry=nicEntry, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, poolMetaWriteMbps=poolMetaWriteMbps, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, ipmiCriticalInterrupt=ipmiCriticalInterrupt, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, nfsTotalReadMbps=nfsTotalReadMbps, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, cifsAvgReadLatency=cifsAvgReadLatency, poolDataSizeHigh=poolDataSizeHigh, iscsiInitiatorsTable=iscsiInitiatorsTable, fcInitiators=fcInitiators, notificationSensorAction=notificationSensorAction, lunGUID=lunGUID, cifsTotalWriteMbps=cifsTotalWriteMbps, intelliFlashSoftwareDown=intelliFlashSoftwareDown, poolAvgWriteLatency=poolAvgWriteLatency, fcTargetReadMbps=fcTargetReadMbps, iscsiTargetGroup=iscsiTargetGroup, netbiosSocketFailure=netbiosSocketFailure, snapshotCreationFailed=snapshotCreationFailed, poolDataWriteIops=poolDataWriteIops, tdpsUpgradeFailed=tdpsUpgradeFailed, initiatorGroupMemberAdded=initiatorGroupMemberAdded, targetGroupDeleteCompleted=targetGroupDeleteCompleted, shareNFSWriteIops=shareNFSWriteIops, haControllerB_Uptime=haControllerB_Uptime, diskType=diskType, lunReadIops=lunReadIops, lunReadMbps=lunReadMbps, cacheTotalReadMbps=cacheTotalReadMbps, shareIndex=shareIndex, networkIpmpGroupUp=networkIpmpGroupUp, upgradeDownloadCompleted=upgradeDownloadCompleted, projectDataSizeLow=projectDataSizeLow, projectQuotaSizeHigh=projectQuotaSizeHigh, notificationReadingUnit=notificationReadingUnit, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, lunReservedSizeLow=lunReservedSizeLow, diskDataReadIops=diskDataReadIops, projectEntry=projectEntry, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, poolDataWriteMbps=poolDataWriteMbps, poolReadCacheReadIops=poolReadCacheReadIops, iscsiInitiatorIndex=iscsiInitiatorIndex, fcInitiatorCreateFailed=fcInitiatorCreateFailed)
mibBuilder.exportSymbols("TEGILE-MIB", nicIndex=nicIndex, poolTable=poolTable, diskError=diskError, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, tegileGroups=tegileGroups, projectQuotaSizeLow=projectQuotaSizeLow, projectDeleted=projectDeleted, iscsiTargetReadMbps=iscsiTargetReadMbps, iscsiImproperTargetGroup=iscsiImproperTargetGroup, fcAvgReadLatency=fcAvgReadLatency, projectPoolName=projectPoolName, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, snmpServiceStartFailed=snmpServiceStartFailed, projectIndex=projectIndex, haControllerA_IPAddr=haControllerA_IPAddr, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, lunDedupEnabled=lunDedupEnabled, poolFreeSizeHigh=poolFreeSizeHigh, notificationDescription=notificationDescription, networkTotalTransmitMbps=networkTotalTransmitMbps, globalStatistics=globalStatistics, diskDataWriteIops=diskDataWriteIops, poolTotalReadMbps=poolTotalReadMbps, lunIndex=lunIndex, PYSNMP_MODULE_ID=tegile, poolCreated=poolCreated, poolDegraded=poolDegraded, upgradeTimeout=upgradeTimeout, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, fcProperties=fcProperties, diskAvgWriteLatency=diskAvgWriteLatency, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, replicationSourceRegistered=replicationSourceRegistered, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, notificationTargetEntityName=notificationTargetEntityName, projectDataSizeHigh=projectDataSizeHigh, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, lunTable=lunTable, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, diskTotalReadMbps=diskTotalReadMbps, poolDataSizeLow=poolDataSizeLow, poolDataReadMbps=poolDataReadMbps, projectCreatedSuccessfully=projectCreatedSuccessfully, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, fcInitiatorIndex=fcInitiatorIndex, replicationAbandoned=replicationAbandoned, diskAvgReadLatency=diskAvgReadLatency, notificationReadingTriggerValue=notificationReadingTriggerValue, poolSizeLow=poolSizeLow, shareCIFSEnabled=shareCIFSEnabled, iscsiTargetAuth=iscsiTargetAuth, lunWriteLatency=lunWriteLatency, iscsiInitiators=iscsiInitiators, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, fcTargetIndex=fcTargetIndex, poolDataReadLatency=poolDataReadLatency, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, ntpServerTimeDrift=ntpServerTimeDrift, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, lunSizeLow=lunSizeLow, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, diskDataWriteMbps=diskDataWriteMbps, poolAvgReadLatency=poolAvgReadLatency, volumeDeleteCompleted=volumeDeleteCompleted, poolMetaReadLatency=poolMetaReadLatency, fcTargetGroup=fcTargetGroup, shareCreatedSuccessfully=shareCreatedSuccessfully, projectThresholdExceedWarning=projectThresholdExceedWarning, fcTargetReadLatency=fcTargetReadLatency, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, fcInitiatorName=fcInitiatorName, upgradeFailed=upgradeFailed, adServerTimeDrift=adServerTimeDrift, sensorFailureEvent=sensorFailureEvent, shareCIFSWriteIops=shareCIFSWriteIops, targetGroupMemberAdded=targetGroupMemberAdded, smisServiceStopFailed=smisServiceStopFailed, iscsiTargetWriteIops=iscsiTargetWriteIops, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, lunSnapshotSizeLow=lunSnapshotSizeLow, iscsiInitiatorChapUser=iscsiInitiatorChapUser, lunSnapshotSizeHigh=lunSnapshotSizeHigh, shareExceedThresholdWarning=shareExceedThresholdWarning, projectFreeSizeHigh=projectFreeSizeHigh, snapshotRollbackFailed=snapshotRollbackFailed, cacheSSDReads=cacheSSDReads, nfsAvgReadLatency=nfsAvgReadLatency, shareNFSReadMbps=shareNFSReadMbps, fcTargetModifyCompleted=fcTargetModifyCompleted, diskIsOnline=diskIsOnline, shareCompressedRatio=shareCompressedRatio, sanProperties=sanProperties, sharePoolName=sharePoolName, lunCompressionEnabled=lunCompressionEnabled, lunBlockSize=lunBlockSize, haResourceGroup=haResourceGroup, haControllerA_Name=haControllerA_Name, iscsiTargetReadIops=iscsiTargetReadIops, poolSizeHigh=poolSizeHigh, ipmiThreshold=ipmiThreshold, iscsiTargetName=iscsiTargetName, notificationComponentName=notificationComponentName, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, iscsiTargetReadLatency=iscsiTargetReadLatency, currentNotificationGroup=currentNotificationGroup, webdocsUpgradeCompleted=webdocsUpgradeCompleted, shareQuotaLow=shareQuotaLow, projectLunCount=projectLunCount, lunReservedSizeHigh=lunReservedSizeHigh, tegileConformance=tegileConformance, tdpsUpgradeTimeout=tdpsUpgradeTimeout, shareCIFSWriteLatency=shareCIFSWriteLatency, fcTotalReadIops=fcTotalReadIops, diskChassisIdx=diskChassisIdx, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, volumeModifyCompleted=volumeModifyCompleted, pools=pools, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, memoryFailure=memoryFailure, nfsTotalReadIops=nfsTotalReadIops, poolProjects=poolProjects, networkIpmpGroupDown=networkIpmpGroupDown, projectDeletionFailed=projectDeletionFailed, haResourceActiveNode=haResourceActiveNode, nfsAvgWriteLatency=nfsAvgWriteLatency, shareCompressionEnabled=shareCompressionEnabled, shareProjectName=shareProjectName, projectShares=projectShares, diskState=diskState, diskEntry=diskEntry, ipmiCurrent=ipmiCurrent, iscsiAvgWriteLatency=iscsiAvgWriteLatency, diskGoneOffline=diskGoneOffline, upgradeDownloadStarted=upgradeDownloadStarted, fcInitiatorsTable=fcInitiatorsTable, unknownSensorEvent=unknownSensorEvent, alertsCleanupCompleted=alertsCleanupCompleted, nvdimmFailInitializationError=nvdimmFailInitializationError, poolReadCacheWriteLatency=poolReadCacheWriteLatency, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, ipmiTemperature=ipmiTemperature, poolMetaReadMbps=poolMetaReadMbps, diskIndex=diskIndex, lunPoolName=lunPoolName, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, diagnosticDataUploaded=diagnosticDataUploaded, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, smisServiceStopped=smisServiceStopped, poolUsedSizeHigh=poolUsedSizeHigh, poolMetaReadIops=poolMetaReadIops, snapshotCloneCompleted=snapshotCloneCompleted, maintenanceModeDisabled=maintenanceModeDisabled, haResourceEntry=haResourceEntry, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, fcTargets=fcTargets, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, tegile=tegile, poolIndex=poolIndex, haResourceDescription=haResourceDescription, lunFreeSizeHigh=lunFreeSizeHigh, shareNFSWriteMbps=shareNFSWriteMbps, lunTargetGroup=lunTargetGroup, shareDataSizeHigh=shareDataSizeHigh, cifsTotalReadIops=cifsTotalReadIops, notificationProps=notificationProps, shareNFSReadLatency=shareNFSReadLatency, iscsiTargetIndex=iscsiTargetIndex, iscsiTotalWriteMbps=iscsiTotalWriteMbps, fcTargetStatus=fcTargetStatus, poolExported=poolExported, userLoginFailed=userLoginFailed, nicGroup=nicGroup, snmpServiceStopFailed=snmpServiceStopFailed, poolMetaWriteLatency=poolMetaWriteLatency, diskSlowIo=diskSlowIo, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, iscsiTargets=iscsiTargets, iscsiTargetEntry=iscsiTargetEntry, notificationSeverity=notificationSeverity, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, shareReservedSizeHigh=shareReservedSizeHigh, diskPoolName=diskPoolName, cifsAvgWriteLatency=cifsAvgWriteLatency, fcInitiatorGroup=fcInitiatorGroup, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, tegileCompliances=tegileCompliances, shareReservedSizeLow=shareReservedSizeLow, poolFreeSizeLow=poolFreeSizeLow, notificationObjects=notificationObjects, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, nicState=nicState, poolUsedSizeLow=poolUsedSizeLow, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, fcTotalReadMbps=fcTotalReadMbps, haResourceIndex=haResourceIndex, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, volumeQuotaFinished=volumeQuotaFinished, snmpAgentVersion=snmpAgentVersion, replicationResumed=replicationResumed, cpuTotalUsage=cpuTotalUsage, replicationPaused=replicationPaused, upgradeDownloadFailed=upgradeDownloadFailed, projectTotalSaving=projectTotalSaving, fcTargetReadIops=fcTargetReadIops, lunDataSizeHigh=lunDataSizeHigh, upgradeStarted=upgradeStarted, iscsiTargetAlias=iscsiTargetAlias, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, notifications=notifications)
