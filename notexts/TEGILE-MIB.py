...
# Produced by pysmi-1.1.8 at Wed Sep 13 15:03:22 2023
...
Integer32, Unsigned32, iso, ModuleIdentity, Counter32, enterprises, MibIdentifier, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, IpAddress, Counter64, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "iso", "ModuleIdentity", "Counter32", "enterprises", "MibIdentifier", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "IpAddress", "Counter64", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("TEGILE-MIB", poolState=poolState, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, iscsiProperties=iscsiProperties, haResourceName=haResourceName, volumeDeleteFailed=volumeDeleteFailed, fcAvgReadLatency=fcAvgReadLatency, fcTargetGroup=fcTargetGroup, ipmiTemperature=ipmiTemperature, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, upgradeDownloadCompleted=upgradeDownloadCompleted, sanProperties=sanProperties, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, shareName=shareName, snmpAgentVersion=snmpAgentVersion, poolTotalWriteMbps=poolTotalWriteMbps, lunCompressionEnabled=lunCompressionEnabled, projectEntry=projectEntry, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, projectQuotaFinished=projectQuotaFinished, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, tegileCompliances=tegileCompliances, ipmiVoltage=ipmiVoltage, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, cpuSystemCalls=cpuSystemCalls, diskTotalReadMbps=diskTotalReadMbps, lunGUID=lunGUID, poolDataSizeLow=poolDataSizeLow, diskSequentialIOCount=diskSequentialIOCount, projectLUNs=projectLUNs, vmwareNFSDatastores=vmwareNFSDatastores, network=network, nvdimmFailInitializationError=nvdimmFailInitializationError, lunSnapshotSizeHigh=lunSnapshotSizeHigh, snapshotCreationFailed=snapshotCreationFailed, properties=properties, shareCIFSWriteLatency=shareCIFSWriteLatency, lunSizeLow=lunSizeLow, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, poolTotalWriteIops=poolTotalWriteIops, projectDeleted=projectDeleted, tegileConformance=tegileConformance, fcTargetName=fcTargetName, projectFreeSizeHigh=projectFreeSizeHigh, shareMountPoint=shareMountPoint, poolCreated=poolCreated, poolTotalSaving=poolTotalSaving, poolUsedSizeHigh=poolUsedSizeHigh, projectPoolName=projectPoolName, nfsTotalReadMbps=nfsTotalReadMbps, shareReservedSizeLow=shareReservedSizeLow, cacheTotalWriteIops=cacheTotalWriteIops, shareCompressionEnabled=shareCompressionEnabled, poolUsedSizeLow=poolUsedSizeLow, fcTargetEntry=fcTargetEntry, notificationDescription=notificationDescription, notificationTargetEntityName=notificationTargetEntityName, diskError=diskError, shareEntry=shareEntry, lunEntry=lunEntry, lunReadIops=lunReadIops, notificationSeverity=notificationSeverity, diskGoneOffline=diskGoneOffline, cifsTotalWriteMbps=cifsTotalWriteMbps, shareExceedThresholdWarning=shareExceedThresholdWarning, fcTargetReadMbps=fcTargetReadMbps, notificationObjects=notificationObjects, nvdimmFailSoftError=nvdimmFailSoftError, deleteFolderFailed=deleteFolderFailed, nicTable=nicTable, fcTargetWriteIops=fcTargetWriteIops, poolCount=poolCount, shareDeletionFailed=shareDeletionFailed, currentNotificationGroup=currentNotificationGroup, shareIndex=shareIndex, haResources=haResources, nicTransmitMbps=nicTransmitMbps, notificationSensorNumber=notificationSensorNumber, poolFreeSizeHigh=poolFreeSizeHigh, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, nicMTU=nicMTU, cifsAvgWriteLatency=cifsAvgWriteLatency, projectTable=projectTable, ipmiFan=ipmiFan, replicationStarted=replicationStarted, poolReadCacheWriteMbps=poolReadCacheWriteMbps, poolMetaReadMbps=poolMetaReadMbps, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, fcTargetWriteLatency=fcTargetWriteLatency, poolMetaWriteIops=poolMetaWriteIops, iscsiInitiatorName=iscsiInitiatorName, deleteFolderCompleted=deleteFolderCompleted, fcTargetReadIops=fcTargetReadIops, iscsiImproperTargetGroup=iscsiImproperTargetGroup, nfsTotalWriteMbps=nfsTotalWriteMbps, networkIpmpGroupUp=networkIpmpGroupUp, diskType=diskType, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, poolDataReadIops=poolDataReadIops, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, diskAvgWriteLatency=diskAvgWriteLatency, fcTargetWriteMbps=fcTargetWriteMbps, shareCIFSEnabled=shareCIFSEnabled, shareSnapshotSizeHigh=shareSnapshotSizeHigh, controllerHardwareModel=controllerHardwareModel, poolOwnerController=poolOwnerController, ipmiPowerSupply=ipmiPowerSupply, projectTotalSaving=projectTotalSaving, upgradeStarted=upgradeStarted, tdpsUpgradeFailed=tdpsUpgradeFailed, lunName=lunName, smisServiceStopped=smisServiceStopped, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, poolName=poolName, snapshotDeleteFailed=snapshotDeleteFailed, diskSizeHigh=diskSizeHigh, lunDedupEnabled=lunDedupEnabled, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, upgradeFailed=upgradeFailed, upgradeDownloadStarted=upgradeDownloadStarted, replicationTargetDeleted=replicationTargetDeleted, fcTotalWriteMbps=fcTotalWriteMbps, iscsiTargetAlias=iscsiTargetAlias, iscsiTargetReadMbps=iscsiTargetReadMbps, projectCreatedSuccessfully=projectCreatedSuccessfully, lunTargetGroup=lunTargetGroup, iscsiTargets=iscsiTargets, poolImported=poolImported, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, upgradeTimeout=upgradeTimeout, nicName=nicName, diskTotalReadIops=diskTotalReadIops, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, iscsiTargetAuth=iscsiTargetAuth, projectDeletionFailed=projectDeletionFailed, shareQuotaFinished=shareQuotaFinished, basicCompliance=basicCompliance, diskCount=diskCount, nicGroup=nicGroup, volumeCreatedSuccessfully=volumeCreatedSuccessfully, sharePoolName=sharePoolName, spareDiskReplaced=spareDiskReplaced, tdpsUpgradeCompleted=tdpsUpgradeCompleted, lunFreeSizeLow=lunFreeSizeLow, iscsiInitiatorGroup=iscsiInitiatorGroup, fcTargetReadLatency=fcTargetReadLatency, fcInitiatorCreateFailed=fcInitiatorCreateFailed, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, controllerUp=controllerUp, cifsTotalReadMbps=cifsTotalReadMbps, nfsTotalReadIops=nfsTotalReadIops, nicReceiveMbps=nicReceiveMbps, diskChassisIdx=diskChassisIdx, iscsiTargetReadLatency=iscsiTargetReadLatency, poolDataWriteMbps=poolDataWriteMbps, networkInterfaceDown=networkInterfaceDown, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, iscsiTargetsTable=iscsiTargetsTable, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, tegile=tegile, disks=disks, cacheTotalWriteMbps=cacheTotalWriteMbps, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, cacheTotalReadMbps=cacheTotalReadMbps, controllerTimeDrift=controllerTimeDrift, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, projectQuotaSizeLow=projectQuotaSizeLow, iscsiTargetWriteIops=iscsiTargetWriteIops, targetGroupMemberAdded=targetGroupMemberAdded, shareQuotaLow=shareQuotaLow, projectThresholdExceedWarning=projectThresholdExceedWarning, lunCompressedRatio=lunCompressedRatio, lunDataSizeHigh=lunDataSizeHigh, haResourceDescription=haResourceDescription, fcPortOffline=fcPortOffline, projectShareCount=projectShareCount, notificationEventCode=notificationEventCode, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, userLoginFailed=userLoginFailed, maintenanceModeEnabled=maintenanceModeEnabled, poolDeletionFailed=poolDeletionFailed, haControllerB_Uptime=haControllerB_Uptime, projectIndex=projectIndex, shareDataSizeHigh=shareDataSizeHigh, volumeQuotaFinished=volumeQuotaFinished, replicationPaused=replicationPaused, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, fcPortOnline=fcPortOnline, notificationComponentName=notificationComponentName, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, diskSlowIo=diskSlowIo, poolMetaWriteLatency=poolMetaWriteLatency, poolExpanded=poolExpanded, shareDeleted=shareDeleted, snmpServiceStartFailed=snmpServiceStartFailed, replicationSourceRegistered=replicationSourceRegistered, fcTargets=fcTargets, poolDegraded=poolDegraded, poolReadCacheReadLatency=poolReadCacheReadLatency, shareNFSWriteLatency=shareNFSWriteLatency, nvdimmFailDeviceError=nvdimmFailDeviceError, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, haResourcesTable=haResourcesTable, tegileArray_notifications=tegileArray_notifications, haResourceEntry=haResourceEntry, lunPoolName=lunPoolName, poolHealth=poolHealth, poolMetaReadIops=poolMetaReadIops, shareCIFSReadMbps=shareCIFSReadMbps, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, poolMetaWriteMbps=poolMetaWriteMbps, lunFreeSizeHigh=lunFreeSizeHigh, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, snapshotRollbackFailed=snapshotRollbackFailed, cpuInterrupts=cpuInterrupts, haControllerA_IPAddr=haControllerA_IPAddr, aclMigrationStarted=aclMigrationStarted, shareNFSReadIops=shareNFSReadIops, pools=pools, unknownSensorEvent=unknownSensorEvent, iscsiTargetReadIops=iscsiTargetReadIops, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, smbSocketFailure=smbSocketFailure, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, networkTotalReceiveMbps=networkTotalReceiveMbps, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, fcTotalReadIops=fcTotalReadIops, cpuTotalUsage=cpuTotalUsage, memoryFailure=memoryFailure, snapshotCloningFailed=snapshotCloningFailed, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, nicIndex=nicIndex, fcTargetsTable=fcTargetsTable, notificationThresholdTriggerValue=notificationThresholdTriggerValue, fcInitiatorName=fcInitiatorName, fcInitiatorIndex=fcInitiatorIndex, currentObjectGroup=currentObjectGroup, testNotification=testNotification, haResourceStatus=haResourceStatus, adServerTimeDrift=adServerTimeDrift, poolMetaReadLatency=poolMetaReadLatency, controllerDown=controllerDown, poolProjectCount=poolProjectCount, tegileGroups=tegileGroups, poolDataWriteLatency=poolDataWriteLatency, shareNFSEnabled=shareNFSEnabled, lunReadLatency=lunReadLatency, haResourceGroup=haResourceGroup, iscsiTotalReadIops=iscsiTotalReadIops, iscsiTargetIndex=iscsiTargetIndex, diskAlias=diskAlias)
mibBuilder.exportSymbols("TEGILE-MIB", diagnosticDataUploaded=diagnosticDataUploaded, lunIndex=lunIndex, iscsiTargetGroupError=iscsiTargetGroupError, cifsTotalWriteIops=cifsTotalWriteIops, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, lunWriteIops=lunWriteIops, replicationAbandoned=replicationAbandoned, cifsTotalReadIops=cifsTotalReadIops, poolIndex=poolIndex, volumeDeleteCompleted=volumeDeleteCompleted, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, fcTargetIndex=fcTargetIndex, replicationResumed=replicationResumed, poolReadCacheWriteIops=poolReadCacheWriteIops, nvdimmFailUnknownError=nvdimmFailUnknownError, diskDataReadIops=diskDataReadIops, targetGroupMemberRemoved=targetGroupMemberRemoved, fcAvgWriteLatency=fcAvgWriteLatency, cifsAvgReadLatency=cifsAvgReadLatency, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, diskRandomIOCount=diskRandomIOCount, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, diskEntry=diskEntry, networkInterfaceUp=networkInterfaceUp, shareSnapshotSizeLow=shareSnapshotSizeLow, smisServiceStartFailed=smisServiceStartFailed, nfsTotalWriteIops=nfsTotalWriteIops, intelliFlashSoftwareDown=intelliFlashSoftwareDown, fcTargetModifyCompleted=fcTargetModifyCompleted, tegileArray=tegileArray, notificationSensorSuspect=notificationSensorSuspect, projectSnapshotSizeHigh=projectSnapshotSizeHigh, projectShares=projectShares, alertsCleanupCompleted=alertsCleanupCompleted, poolExported=poolExported, poolDataReadMbps=poolDataReadMbps, volumeModifyCompleted=volumeModifyCompleted, cacheTotalReadIops=cacheTotalReadIops, snmpServiceStopFailed=snmpServiceStopFailed, poolReadCacheWriteLatency=poolReadCacheWriteLatency, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, notifications=notifications, diskState=diskState, iscsiAvgReadLatency=iscsiAvgReadLatency, smisServiceStarted=smisServiceStarted, iscsiTotalWriteMbps=iscsiTotalWriteMbps, lunDataSizeLow=lunDataSizeLow, targetGroupCreateCompleted=targetGroupCreateCompleted, fcInitiatorGroup=fcInitiatorGroup, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, fcTotalWriteIops=fcTotalWriteIops, ipmiThreshold=ipmiThreshold, iscsiWriteIops=iscsiWriteIops, projectLunCount=projectLunCount, projectFreeSizeLow=projectFreeSizeLow, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, maintenanceModeDisabled=maintenanceModeDisabled, iscsiAvgWriteLatency=iscsiAvgWriteLatency, globalStatistics=globalStatistics, snmpServiceStarted=snmpServiceStarted, webdocsUpgradeFailed=webdocsUpgradeFailed, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, diskSizeLow=diskSizeLow, notificationReadingTriggerValue=notificationReadingTriggerValue, iscsiTotalReadMbps=iscsiTotalReadMbps, projectDedupEnabled=projectDedupEnabled, upgradeCompleted=upgradeCompleted, iscsiTargetWriteLatency=iscsiTargetWriteLatency, initiatorGroupMemberAdded=initiatorGroupMemberAdded, notificationSensorAction=notificationSensorAction, haControllerB_Name=haControllerB_Name, lunSizeHigh=lunSizeHigh, diskPoolName=diskPoolName, poolSizeHigh=poolSizeHigh, shareCIFSReadIops=shareCIFSReadIops, notificationTime=notificationTime, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, shareCompressedRatio=shareCompressedRatio, shareCIFSReadLatency=shareCIFSReadLatency, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, diskTable=diskTable, netbiosSocketFailure=netbiosSocketFailure, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, iscsiTargetWriteMbps=iscsiTargetWriteMbps, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, smisServiceStopFailed=smisServiceStopFailed, poolReadCacheReadIops=poolReadCacheReadIops, webdocsUpgradeCompleted=webdocsUpgradeCompleted, shareProjectName=shareProjectName, poolQuotaFinished=poolQuotaFinished, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, replicationFailed=replicationFailed, ipmiMemory=ipmiMemory, sensorFailureEvent=sensorFailureEvent, fcTotalReadMbps=fcTotalReadMbps, poolTable=poolTable, snmpServiceStopped=snmpServiceStopped, fcInitiatorsTable=fcInitiatorsTable, poolWriteCacheWriteIops=poolWriteCacheWriteIops, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, haControllerA_Uptime=haControllerA_Uptime, notificationReadingUnit=notificationReadingUnit, haResourceIndex=haResourceIndex, tdpsUpgradeTimeout=tdpsUpgradeTimeout, cacheRAMReads=cacheRAMReads, diskDataWriteIops=diskDataWriteIops, fcTargetStatus=fcTargetStatus, shareNFSReadMbps=shareNFSReadMbps, iscsiTargetEntry=iscsiTargetEntry, poolUpgraded=poolUpgraded, iscsiInitiatorIndex=iscsiInitiatorIndex, ipmiCurrent=ipmiCurrent, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, shareCIFSWriteMbps=shareCIFSWriteMbps, lunWriteLatency=lunWriteLatency, fcProperties=fcProperties, projectCompressionEnabled=projectCompressionEnabled, lunInitiatorGroup=lunInitiatorGroup, replicationAborted=replicationAborted, lunSnapshotSizeLow=lunSnapshotSizeLow, poolEntry=poolEntry, ipmiOther=ipmiOther, lunTable=lunTable, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, haResourceActiveNode=haResourceActiveNode, shareNFSWriteIops=shareNFSWriteIops, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, shareQuotaHigh=shareQuotaHigh, networkIpmpGroupDown=networkIpmpGroupDown, lunReadMbps=lunReadMbps, poolDataSizeHigh=poolDataSizeHigh, lunWriteMbps=lunWriteMbps, diskIndex=diskIndex, diskIOCount=diskIOCount, ntpServerTimeDrift=ntpServerTimeDrift, notificationProps=notificationProps, nicEntry=nicEntry, lunProjectName=lunProjectName, shareTable=shareTable, diskTotalWriteIops=diskTotalWriteIops, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, poolTotalReadIops=poolTotalReadIops, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, diskIsOnline=diskIsOnline, projectDataSizeHigh=projectDataSizeHigh, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, shareNFSReadLatency=shareNFSReadLatency, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, projectDataSizeLow=projectDataSizeLow, iscsiInitiatorEntry=iscsiInitiatorEntry, iscsiTargetError=iscsiTargetError, ipmiCriticalInterrupt=ipmiCriticalInterrupt, PYSNMP_MODULE_ID=tegile, haControllerB_IPAddr=haControllerB_IPAddr, replicationComplete=replicationComplete, poolDeleted=poolDeleted, poolSizeLow=poolSizeLow, nfsAvgReadLatency=nfsAvgReadLatency, poolProjects=poolProjects, shareCIFSWriteIops=shareCIFSWriteIops, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, snapshotCloneCompleted=snapshotCloneCompleted, diskAvgReadLatency=diskAvgReadLatency, lunBlockSize=lunBlockSize, intelliFlashSoftwareUp=intelliFlashSoftwareUp, lunReservedSizeHigh=lunReservedSizeHigh, shareCreatedSuccessfully=shareCreatedSuccessfully, targetGroupDeleteCompleted=targetGroupDeleteCompleted, lunProtocol=lunProtocol, shareDedupEnabled=shareDedupEnabled, shareReservedSizeHigh=shareReservedSizeHigh, projectModified=projectModified, shareDataSizeLow=shareDataSizeLow, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, poolDataWriteIops=poolDataWriteIops, iscsiInitiatorsTable=iscsiInitiatorsTable, fcInitiators=fcInitiators, fcInitiatorEntry=fcInitiatorEntry, poolTotalReadMbps=poolTotalReadMbps, poolAvgReadLatency=poolAvgReadLatency, aclMigrationCompleted=aclMigrationCompleted, diskDataReadMbps=diskDataReadMbps, shareNFSWriteMbps=shareNFSWriteMbps, poolReadCacheReadMbps=poolReadCacheReadMbps, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, cacheSSDReads=cacheSSDReads, nfsAvgWriteLatency=nfsAvgWriteLatency, snapshotRollbackCompleted=snapshotRollbackCompleted, poolFreeSizeLow=poolFreeSizeLow, iscsiInitiatorChapUser=iscsiInitiatorChapUser, projectQuotaSizeHigh=projectQuotaSizeHigh, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, poolAvgWriteLatency=poolAvgWriteLatency, poolDataReadLatency=poolDataReadLatency, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, lunReservedSizeLow=lunReservedSizeLow, projectSnapshotSizeLow=projectSnapshotSizeLow, nicState=nicState, upgradeDownloadFailed=upgradeDownloadFailed, haControllerA_Name=haControllerA_Name, diskDataWriteMbps=diskDataWriteMbps, diskTotalWriteMbps=diskTotalWriteMbps, networkTotalTransmitMbps=networkTotalTransmitMbps, projectName=projectName, iscsiTargetName=iscsiTargetName, iscsiTargetGroup=iscsiTargetGroup, iscsiInitiators=iscsiInitiators)
