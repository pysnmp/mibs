...
# Produced by pysmi-1.1.8 at Thu Oct 26 11:31:54 2023
...
Counter64, ModuleIdentity, Unsigned32, Bits, IpAddress, ObjectIdentity, MibIdentifier, TimeTicks, Integer32, iso, Counter32, enterprises, Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ModuleIdentity", "Unsigned32", "Bits", "IpAddress", "ObjectIdentity", "MibIdentifier", "TimeTicks", "Integer32", "iso", "Counter32", "enterprises", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("TEGILE-MIB", poolReadCacheReadMbps=poolReadCacheReadMbps, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, poolDataReadLatency=poolDataReadLatency, poolState=poolState, diskAvgReadLatency=diskAvgReadLatency, poolName=poolName, projectThresholdExceedWarning=projectThresholdExceedWarning, poolSizeLow=poolSizeLow, snapshotCloneCompleted=snapshotCloneCompleted, haResourceActiveNode=haResourceActiveNode, cpuSystemCalls=cpuSystemCalls, projectShares=projectShares, nfsTotalWriteMbps=nfsTotalWriteMbps, shareNFSEnabled=shareNFSEnabled, projectFreeSizeHigh=projectFreeSizeHigh, poolAvgReadLatency=poolAvgReadLatency, poolHealth=poolHealth, notificationThresholdTriggerValue=notificationThresholdTriggerValue, haControllerB_Uptime=haControllerB_Uptime, fcTargetReadIops=fcTargetReadIops, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, diskSizeLow=diskSizeLow, poolReadCacheReadIops=poolReadCacheReadIops, iscsiWriteIops=iscsiWriteIops, shareTable=shareTable, snapshotCreationFailed=snapshotCreationFailed, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, shareEntry=shareEntry, lunProtocol=lunProtocol, diskTotalReadIops=diskTotalReadIops, shareCIFSWriteLatency=shareCIFSWriteLatency, fcTargetReadLatency=fcTargetReadLatency, cacheTotalReadMbps=cacheTotalReadMbps, iscsiTargetGroup=iscsiTargetGroup, fcInitiatorName=fcInitiatorName, poolDataWriteMbps=poolDataWriteMbps, iscsiInitiatorsTable=iscsiInitiatorsTable, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, tdpsUpgradeCompleted=tdpsUpgradeCompleted, fcTargetWriteMbps=fcTargetWriteMbps, diagnosticDataUploaded=diagnosticDataUploaded, diskCount=diskCount, fcAvgWriteLatency=fcAvgWriteLatency, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, aclMigrationStarted=aclMigrationStarted, nicEntry=nicEntry, poolMetaReadIops=poolMetaReadIops, ipmiTemperature=ipmiTemperature, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, projectEntry=projectEntry, projectTotalSaving=projectTotalSaving, poolSizeHigh=poolSizeHigh, shareProjectName=shareProjectName, tegileGroups=tegileGroups, iscsiTargetReadLatency=iscsiTargetReadLatency, poolExported=poolExported, upgradeDownloadCompleted=upgradeDownloadCompleted, replicationTargetDeleted=replicationTargetDeleted, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, fcTargetModifyCompleted=fcTargetModifyCompleted, diskIndex=diskIndex, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, poolDataSizeLow=poolDataSizeLow, shareQuotaLow=shareQuotaLow, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, initiatorGroupMemberAdded=initiatorGroupMemberAdded, poolReadCacheWriteLatency=poolReadCacheWriteLatency, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, tegileArray=tegileArray, lunInitiatorGroup=lunInitiatorGroup, upgradeDownloadStarted=upgradeDownloadStarted, shareNFSReadLatency=shareNFSReadLatency, fcTargets=fcTargets, ipmiOther=ipmiOther, poolIndex=poolIndex, nicTable=nicTable, fcTotalWriteIops=fcTotalWriteIops, adServerTimeDrift=adServerTimeDrift, iscsiAvgReadLatency=iscsiAvgReadLatency, haControllerA_Name=haControllerA_Name, projectDataSizeHigh=projectDataSizeHigh, network=network, poolEntry=poolEntry, lunGUID=lunGUID, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, ipmiVoltage=ipmiVoltage, properties=properties, projectDataSizeLow=projectDataSizeLow, poolTotalWriteMbps=poolTotalWriteMbps, notificationObjects=notificationObjects, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, poolFreeSizeLow=poolFreeSizeLow, haControllerB_IPAddr=haControllerB_IPAddr, ipmiCriticalInterrupt=ipmiCriticalInterrupt, shareCIFSWriteIops=shareCIFSWriteIops, iscsiInitiatorName=iscsiInitiatorName, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, tegileArray_notifications=tegileArray_notifications, iscsiTotalReadMbps=iscsiTotalReadMbps, projectDeletionFailed=projectDeletionFailed, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, poolDegraded=poolDegraded, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, nfsAvgReadLatency=nfsAvgReadLatency, fcInitiators=fcInitiators, fcTargetReadMbps=fcTargetReadMbps, poolTotalWriteIops=poolTotalWriteIops, shareDataSizeLow=shareDataSizeLow, shareCIFSEnabled=shareCIFSEnabled, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, shareQuotaHigh=shareQuotaHigh, iscsiTargetWriteLatency=iscsiTargetWriteLatency, shareDataSizeHigh=shareDataSizeHigh, lunReservedSizeLow=lunReservedSizeLow, diskDataReadIops=diskDataReadIops, notificationReadingTriggerValue=notificationReadingTriggerValue, fcInitiatorGroup=fcInitiatorGroup, projectLunCount=projectLunCount, sensorFailureEvent=sensorFailureEvent, iscsiInitiatorGroup=iscsiInitiatorGroup, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, iscsiTargetWriteIops=iscsiTargetWriteIops, diskType=diskType, shareReservedSizeHigh=shareReservedSizeHigh, lunDataSizeHigh=lunDataSizeHigh, projectModified=projectModified, targetGroupDeleteCompleted=targetGroupDeleteCompleted, shareExceedThresholdWarning=shareExceedThresholdWarning, smbSocketFailure=smbSocketFailure, upgradeDownloadFailed=upgradeDownloadFailed, iscsiInitiatorChapUser=iscsiInitiatorChapUser, lunReadMbps=lunReadMbps, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, notificationSeverity=notificationSeverity, cifsTotalReadIops=cifsTotalReadIops, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, shareCompressionEnabled=shareCompressionEnabled, snapshotRollbackCompleted=snapshotRollbackCompleted, lunName=lunName, notificationDescription=notificationDescription, shareCIFSReadIops=shareCIFSReadIops, poolDataReadIops=poolDataReadIops, projectSnapshotSizeLow=projectSnapshotSizeLow, shareMountPoint=shareMountPoint, shareNFSReadMbps=shareNFSReadMbps, projectShareCount=projectShareCount, poolExpanded=poolExpanded, iscsiTargetError=iscsiTargetError, iscsiInitiatorIndex=iscsiInitiatorIndex, projectTable=projectTable, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, cifsTotalReadMbps=cifsTotalReadMbps, snmpServiceStarted=snmpServiceStarted, fcInitiatorCreateFailed=fcInitiatorCreateFailed, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, notificationEventCode=notificationEventCode, memoryFailure=memoryFailure, nicTransmitMbps=nicTransmitMbps, poolMetaWriteLatency=poolMetaWriteLatency, intelliFlashSoftwareDown=intelliFlashSoftwareDown, replicationAborted=replicationAborted, currentObjectGroup=currentObjectGroup, lunReservedSizeHigh=lunReservedSizeHigh, poolMetaReadMbps=poolMetaReadMbps, fcInitiatorEntry=fcInitiatorEntry, ipmiPowerSupply=ipmiPowerSupply, volumeDeleteFailed=volumeDeleteFailed, diskTotalWriteIops=diskTotalWriteIops, tegileCompliances=tegileCompliances, iscsiTargets=iscsiTargets, replicationFailed=replicationFailed, poolUsedSizeHigh=poolUsedSizeHigh, lunFreeSizeLow=lunFreeSizeLow, pools=pools, upgradeStarted=upgradeStarted, fcTotalReadIops=fcTotalReadIops, haResourceDescription=haResourceDescription, controllerTimeDrift=controllerTimeDrift, notificationSensorSuspect=notificationSensorSuspect, poolAvgWriteLatency=poolAvgWriteLatency, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, controllerHardwareModel=controllerHardwareModel, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, poolDataWriteLatency=poolDataWriteLatency, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, diskState=diskState, lunCompressedRatio=lunCompressedRatio, diskTotalReadMbps=diskTotalReadMbps, iscsiTargetWriteMbps=iscsiTargetWriteMbps, projectName=projectName, poolReadCacheWriteIops=poolReadCacheWriteIops, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, cacheRAMReads=cacheRAMReads, fcTargetsTable=fcTargetsTable, iscsiTargetEntry=iscsiTargetEntry, iscsiTargetAlias=iscsiTargetAlias, projectQuotaFinished=projectQuotaFinished, ntpServerTimeDrift=ntpServerTimeDrift, targetGroupMemberAdded=targetGroupMemberAdded, nicIndex=nicIndex, webdocsUpgradeFailed=webdocsUpgradeFailed, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, sharePoolName=sharePoolName, controllerDown=controllerDown, cacheTotalWriteIops=cacheTotalWriteIops, poolMetaWriteMbps=poolMetaWriteMbps, lunReadIops=lunReadIops, diskError=diskError, iscsiImproperTargetGroup=iscsiImproperTargetGroup, snapshotCloningFailed=snapshotCloningFailed, netbiosSocketFailure=netbiosSocketFailure, lunBlockSize=lunBlockSize, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, poolProjectCount=poolProjectCount, poolDataReadMbps=poolDataReadMbps, nfsTotalReadIops=nfsTotalReadIops, lunCompressionEnabled=lunCompressionEnabled, haResourceEntry=haResourceEntry, poolReadCacheWriteMbps=poolReadCacheWriteMbps, iscsiTotalReadIops=iscsiTotalReadIops, smisServiceStopFailed=smisServiceStopFailed, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, nfsTotalReadMbps=nfsTotalReadMbps, lunWriteIops=lunWriteIops, haResourcesTable=haResourcesTable, fcTargetName=fcTargetName, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, projectCreatedSuccessfully=projectCreatedSuccessfully, upgradeTimeout=upgradeTimeout, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, diskSlowIo=diskSlowIo, poolWriteCacheWriteIops=poolWriteCacheWriteIops, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, shareCIFSReadLatency=shareCIFSReadLatency, cacheTotalReadIops=cacheTotalReadIops, replicationAbandoned=replicationAbandoned, projectLUNs=projectLUNs, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, shareCIFSWriteMbps=shareCIFSWriteMbps, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, upgradeFailed=upgradeFailed, poolDeleted=poolDeleted, volumeDeleteCompleted=volumeDeleteCompleted, haResourceIndex=haResourceIndex, diskSizeHigh=diskSizeHigh, shareDeletionFailed=shareDeletionFailed, lunSnapshotSizeHigh=lunSnapshotSizeHigh, networkIpmpGroupUp=networkIpmpGroupUp, fcTotalReadMbps=fcTotalReadMbps, snapshotDeleteFailed=snapshotDeleteFailed)
mibBuilder.exportSymbols("TEGILE-MIB", diskTotalWriteMbps=diskTotalWriteMbps, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, cacheTotalWriteMbps=cacheTotalWriteMbps, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, poolTotalReadIops=poolTotalReadIops, globalStatistics=globalStatistics, diskIOCount=diskIOCount, lunFreeSizeHigh=lunFreeSizeHigh, iscsiProperties=iscsiProperties, poolUsedSizeLow=poolUsedSizeLow, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, replicationComplete=replicationComplete, iscsiAvgWriteLatency=iscsiAvgWriteLatency, cifsAvgWriteLatency=cifsAvgWriteLatency, nicGroup=nicGroup, fcTargetEntry=fcTargetEntry, vmwareNFSDatastores=vmwareNFSDatastores, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, lunWriteLatency=lunWriteLatency, cpuTotalUsage=cpuTotalUsage, iscsiTargetAuth=iscsiTargetAuth, ipmiMemory=ipmiMemory, tegileConformance=tegileConformance, diskRandomIOCount=diskRandomIOCount, diskDataWriteMbps=diskDataWriteMbps, cifsTotalWriteMbps=cifsTotalWriteMbps, nvdimmFailSoftError=nvdimmFailSoftError, shareDedupEnabled=shareDedupEnabled, shareName=shareName, fcTargetStatus=fcTargetStatus, replicationPaused=replicationPaused, targetGroupMemberRemoved=targetGroupMemberRemoved, deleteFolderFailed=deleteFolderFailed, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, snapshotRollbackFailed=snapshotRollbackFailed, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, projectQuotaSizeLow=projectQuotaSizeLow, shareQuotaFinished=shareQuotaFinished, diskAlias=diskAlias, poolCreated=poolCreated, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, fcTargetWriteLatency=fcTargetWriteLatency, poolTotalReadMbps=poolTotalReadMbps, basicCompliance=basicCompliance, poolMetaWriteIops=poolMetaWriteIops, notificationTargetEntityName=notificationTargetEntityName, shareDeleted=shareDeleted, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, spareDiskReplaced=spareDiskReplaced, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, notificationTime=notificationTime, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, haControllerB_Name=haControllerB_Name, lunTable=lunTable, iscsiTargetReadIops=iscsiTargetReadIops, projectCompressionEnabled=projectCompressionEnabled, shareIndex=shareIndex, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, shareCreatedSuccessfully=shareCreatedSuccessfully, lunReadLatency=lunReadLatency, diskAvgWriteLatency=diskAvgWriteLatency, snmpServiceStopFailed=snmpServiceStopFailed, iscsiInitiatorEntry=iscsiInitiatorEntry, fcPortOffline=fcPortOffline, networkIpmpGroupDown=networkIpmpGroupDown, smisServiceStopped=smisServiceStopped, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, disks=disks, poolImported=poolImported, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, fcProperties=fcProperties, lunSizeLow=lunSizeLow, maintenanceModeEnabled=maintenanceModeEnabled, shareReservedSizeLow=shareReservedSizeLow, fcTargetWriteIops=fcTargetWriteIops, haControllerA_IPAddr=haControllerA_IPAddr, lunWriteMbps=lunWriteMbps, poolDeletionFailed=poolDeletionFailed, lunSnapshotSizeLow=lunSnapshotSizeLow, poolFreeSizeHigh=poolFreeSizeHigh, iscsiTargetGroupError=iscsiTargetGroupError, diskPoolName=diskPoolName, unknownSensorEvent=unknownSensorEvent, replicationSourceRegistered=replicationSourceRegistered, nvdimmFailDeviceError=nvdimmFailDeviceError, lunProjectName=lunProjectName, iscsiInitiators=iscsiInitiators, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, smisServiceStartFailed=smisServiceStartFailed, tdpsUpgradeTimeout=tdpsUpgradeTimeout, poolReadCacheReadLatency=poolReadCacheReadLatency, nfsAvgWriteLatency=nfsAvgWriteLatency, fcTargetIndex=fcTargetIndex, lunIndex=lunIndex, shareCompressedRatio=shareCompressedRatio, currentNotificationGroup=currentNotificationGroup, projectFreeSizeLow=projectFreeSizeLow, fcTotalWriteMbps=fcTotalWriteMbps, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, nvdimmFailUnknownError=nvdimmFailUnknownError, lunTargetGroup=lunTargetGroup, haControllerA_Uptime=haControllerA_Uptime, snmpAgentVersion=snmpAgentVersion, shareCIFSReadMbps=shareCIFSReadMbps, nicState=nicState, userLoginFailed=userLoginFailed, diskGoneOffline=diskGoneOffline, poolProjects=poolProjects, diskDataReadMbps=diskDataReadMbps, projectIndex=projectIndex, poolTotalSaving=poolTotalSaving, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, notificationComponentName=notificationComponentName, cifsTotalWriteIops=cifsTotalWriteIops, fcInitiatorsTable=fcInitiatorsTable, nicMTU=nicMTU, poolTable=poolTable, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, iscsiTargetReadMbps=iscsiTargetReadMbps, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, shareNFSWriteMbps=shareNFSWriteMbps, controllerUp=controllerUp, haResourceStatus=haResourceStatus, fcPortOnline=fcPortOnline, cifsAvgReadLatency=cifsAvgReadLatency, iscsiTargetName=iscsiTargetName, nicReceiveMbps=nicReceiveMbps, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, projectDedupEnabled=projectDedupEnabled, diskSequentialIOCount=diskSequentialIOCount, deleteFolderCompleted=deleteFolderCompleted, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, lunPoolName=lunPoolName, ipmiThreshold=ipmiThreshold, fcAvgReadLatency=fcAvgReadLatency, lunSizeHigh=lunSizeHigh, PYSNMP_MODULE_ID=tegile, notificationProps=notificationProps, projectSnapshotSizeHigh=projectSnapshotSizeHigh, haResourceName=haResourceName, nicName=nicName, networkInterfaceDown=networkInterfaceDown, diskTable=diskTable, notificationSensorAction=notificationSensorAction, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, networkInterfaceUp=networkInterfaceUp, shareNFSReadIops=shareNFSReadIops, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, haResourceGroup=haResourceGroup, poolDataWriteIops=poolDataWriteIops, projectPoolName=projectPoolName, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, upgradeCompleted=upgradeCompleted, snmpServiceStopped=snmpServiceStopped, tdpsUpgradeFailed=tdpsUpgradeFailed, poolMetaReadLatency=poolMetaReadLatency, shareSnapshotSizeLow=shareSnapshotSizeLow, ipmiCurrent=ipmiCurrent, iscsiTargetsTable=iscsiTargetsTable, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, networkTotalReceiveMbps=networkTotalReceiveMbps, poolCount=poolCount, volumeCreatedSuccessfully=volumeCreatedSuccessfully, sanProperties=sanProperties, volumeQuotaFinished=volumeQuotaFinished, ipmiFan=ipmiFan, maintenanceModeDisabled=maintenanceModeDisabled, snmpServiceStartFailed=snmpServiceStartFailed, projectDeleted=projectDeleted, lunDataSizeLow=lunDataSizeLow, shareSnapshotSizeHigh=shareSnapshotSizeHigh, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, nvdimmFailInitializationError=nvdimmFailInitializationError, notificationSensorNumber=notificationSensorNumber, poolDataSizeHigh=poolDataSizeHigh, diskChassisIdx=diskChassisIdx, testNotification=testNotification, shareNFSWriteLatency=shareNFSWriteLatency, volumeModifyCompleted=volumeModifyCompleted, projectQuotaSizeHigh=projectQuotaSizeHigh, cacheSSDReads=cacheSSDReads, shareNFSWriteIops=shareNFSWriteIops, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, cpuInterrupts=cpuInterrupts, smisServiceStarted=smisServiceStarted, alertsCleanupCompleted=alertsCleanupCompleted, fcTargetGroup=fcTargetGroup, aclMigrationCompleted=aclMigrationCompleted, nfsTotalWriteIops=nfsTotalWriteIops, replicationResumed=replicationResumed, lunEntry=lunEntry, poolQuotaFinished=poolQuotaFinished, diskIsOnline=diskIsOnline, webdocsUpgradeCompleted=webdocsUpgradeCompleted, notificationReadingUnit=notificationReadingUnit, diskDataWriteIops=diskDataWriteIops, iscsiTargetIndex=iscsiTargetIndex, lunDedupEnabled=lunDedupEnabled, fcInitiatorIndex=fcInitiatorIndex, poolUpgraded=poolUpgraded, tegile=tegile, intelliFlashSoftwareUp=intelliFlashSoftwareUp, diskEntry=diskEntry, notifications=notifications, networkTotalTransmitMbps=networkTotalTransmitMbps, replicationStarted=replicationStarted, iscsiTotalWriteMbps=iscsiTotalWriteMbps, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, haResources=haResources, poolOwnerController=poolOwnerController, targetGroupCreateCompleted=targetGroupCreateCompleted)
