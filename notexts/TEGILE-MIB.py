...
# Produced by pysmi-1.1.8 at Sat Jan 15 04:58:19 2022
...
Counter32, Integer32, MibIdentifier, iso, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits, Gauge32, ObjectIdentity, NotificationType, ModuleIdentity, IpAddress, Unsigned32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "MibIdentifier", "iso", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits", "Gauge32", "ObjectIdentity", "NotificationType", "ModuleIdentity", "IpAddress", "Unsigned32", "Counter64")
...
mibBuilder.exportSymbols("TEGILE-MIB", shareExceedThresholdWarning=shareExceedThresholdWarning, projectCreatedSuccessfully=projectCreatedSuccessfully, controllerUp=controllerUp, haResourceIndex=haResourceIndex, poolExpanded=poolExpanded, iscsiTargetWriteIops=iscsiTargetWriteIops, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, iscsiTargetIndex=iscsiTargetIndex, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, projectQuotaFinished=projectQuotaFinished, smisServiceStarted=smisServiceStarted, projectIndex=projectIndex, lunFreeSizeHigh=lunFreeSizeHigh, smisServiceStopped=smisServiceStopped, poolWriteCacheWriteIops=poolWriteCacheWriteIops, deleteFolderCompleted=deleteFolderCompleted, shareNFSReadIops=shareNFSReadIops, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, tegileArray_notifications=tegileArray_notifications, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, fcTargetEntry=fcTargetEntry, replicationTargetDeleted=replicationTargetDeleted, network=network, projectLunCount=projectLunCount, diskSlowIo=diskSlowIo, snapshotCreationFailed=snapshotCreationFailed, snapshotDeleteFailed=snapshotDeleteFailed, nicName=nicName, diskIOCount=diskIOCount, diskEntry=diskEntry, haResourceEntry=haResourceEntry, haControllerA_Name=haControllerA_Name, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, sanProperties=sanProperties, lunSizeLow=lunSizeLow, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, notifications=notifications, projectDeletionFailed=projectDeletionFailed, snmpServiceStopFailed=snmpServiceStopFailed, projectDataSizeHigh=projectDataSizeHigh, iscsiTotalWriteMbps=iscsiTotalWriteMbps, iscsiAvgWriteLatency=iscsiAvgWriteLatency, shareCompressedRatio=shareCompressedRatio, poolMetaReadLatency=poolMetaReadLatency, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, tegile=tegile, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, fcPortOffline=fcPortOffline, poolQuotaFinished=poolQuotaFinished, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, fcInitiators=fcInitiators, fcTargetWriteMbps=fcTargetWriteMbps, fcPortOnline=fcPortOnline, alertsCleanupCompleted=alertsCleanupCompleted, diskAvgWriteLatency=diskAvgWriteLatency, projectDedupEnabled=projectDedupEnabled, fcTotalWriteMbps=fcTotalWriteMbps, shareCIFSReadMbps=shareCIFSReadMbps, poolDataSizeHigh=poolDataSizeHigh, haResources=haResources, snmpServiceStarted=snmpServiceStarted, fcTotalWriteIops=fcTotalWriteIops, notificationDescription=notificationDescription, lunEntry=lunEntry, nvdimmFailSoftError=nvdimmFailSoftError, projectSnapshotSizeHigh=projectSnapshotSizeHigh, maintenanceModeDisabled=maintenanceModeDisabled, shareIndex=shareIndex, diskRandomIOCount=diskRandomIOCount, nvdimmFailUnknownError=nvdimmFailUnknownError, fcInitiatorName=fcInitiatorName, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, poolReadCacheReadMbps=poolReadCacheReadMbps, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, shareName=shareName, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, cifsTotalWriteIops=cifsTotalWriteIops, targetGroupMemberAdded=targetGroupMemberAdded, webdocsUpgradeCompleted=webdocsUpgradeCompleted, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, poolDegraded=poolDegraded, poolName=poolName, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, cacheTotalReadIops=cacheTotalReadIops, fcTargetReadMbps=fcTargetReadMbps, poolSizeLow=poolSizeLow, projectShares=projectShares, iscsiProperties=iscsiProperties, disks=disks, diskType=diskType, shareCIFSWriteMbps=shareCIFSWriteMbps, poolIndex=poolIndex, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, fcInitiatorCreateFailed=fcInitiatorCreateFailed, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, replicationPaused=replicationPaused, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, projectQuotaSizeLow=projectQuotaSizeLow, volumeModifyCompleted=volumeModifyCompleted, diskDataReadIops=diskDataReadIops, diskIndex=diskIndex, basicCompliance=basicCompliance, haControllerA_IPAddr=haControllerA_IPAddr, intelliFlashSoftwareDown=intelliFlashSoftwareDown, currentNotificationGroup=currentNotificationGroup, projectFreeSizeHigh=projectFreeSizeHigh, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, lunWriteIops=lunWriteIops, shareNFSWriteLatency=shareNFSWriteLatency, snapshotCloneCompleted=snapshotCloneCompleted, nicReceiveMbps=nicReceiveMbps, lunDataSizeHigh=lunDataSizeHigh, shareReservedSizeLow=shareReservedSizeLow, notificationProps=notificationProps, diskState=diskState, networkInterfaceUp=networkInterfaceUp, iscsiTargetGroup=iscsiTargetGroup, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, fcProperties=fcProperties, notificationSensorSuspect=notificationSensorSuspect, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, lunFreeSizeLow=lunFreeSizeLow, initiatorGroupMemberAdded=initiatorGroupMemberAdded, projectFreeSizeLow=projectFreeSizeLow, nicIndex=nicIndex, shareQuotaLow=shareQuotaLow, cifsTotalWriteMbps=cifsTotalWriteMbps, volumeDeleteFailed=volumeDeleteFailed, poolReadCacheReadLatency=poolReadCacheReadLatency, upgradeTimeout=upgradeTimeout, projectShareCount=projectShareCount, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, shareNFSReadLatency=shareNFSReadLatency, nicGroup=nicGroup, diskPoolName=diskPoolName, poolDataSizeLow=poolDataSizeLow, userLoginFailed=userLoginFailed, haControllerB_Uptime=haControllerB_Uptime, fcTargetIndex=fcTargetIndex, nfsTotalWriteMbps=nfsTotalWriteMbps, diskSizeLow=diskSizeLow, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, shareEntry=shareEntry, iscsiTotalReadIops=iscsiTotalReadIops, shareCIFSEnabled=shareCIFSEnabled, diskError=diskError, shareNFSWriteMbps=shareNFSWriteMbps, currentObjectGroup=currentObjectGroup, fcTargetReadIops=fcTargetReadIops, poolDeletionFailed=poolDeletionFailed, projectCompressionEnabled=projectCompressionEnabled, lunSizeHigh=lunSizeHigh, diskAvgReadLatency=diskAvgReadLatency, cpuInterrupts=cpuInterrupts, poolSizeHigh=poolSizeHigh, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, shareCreatedSuccessfully=shareCreatedSuccessfully, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, projectDeleted=projectDeleted, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, targetGroupMemberRemoved=targetGroupMemberRemoved, projectQuotaSizeHigh=projectQuotaSizeHigh, diskAlias=diskAlias, lunGUID=lunGUID, shareCIFSWriteIops=shareCIFSWriteIops, nicEntry=nicEntry, notificationEventCode=notificationEventCode, adServerTimeDrift=adServerTimeDrift, shareQuotaFinished=shareQuotaFinished, haResourceStatus=haResourceStatus, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, shareNFSReadMbps=shareNFSReadMbps, ipmiCurrent=ipmiCurrent, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, tdpsUpgradeCompleted=tdpsUpgradeCompleted, haResourceDescription=haResourceDescription, smbSocketFailure=smbSocketFailure, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, fcTargetName=fcTargetName, nicMTU=nicMTU, tegileGroups=tegileGroups, controllerDown=controllerDown, replicationFailed=replicationFailed, poolReadCacheReadIops=poolReadCacheReadIops, projectLUNs=projectLUNs, shareCIFSWriteLatency=shareCIFSWriteLatency, targetGroupCreateCompleted=targetGroupCreateCompleted, iscsiTargets=iscsiTargets, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, fcTotalReadMbps=fcTotalReadMbps, replicationComplete=replicationComplete, haControllerB_IPAddr=haControllerB_IPAddr, ipmiThreshold=ipmiThreshold, poolTotalWriteIops=poolTotalWriteIops, fcInitiatorGroup=fcInitiatorGroup, poolDeleted=poolDeleted, controllerHardwareModel=controllerHardwareModel, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, shareReservedSizeHigh=shareReservedSizeHigh, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, notificationThresholdTriggerValue=notificationThresholdTriggerValue, shareDataSizeLow=shareDataSizeLow, iscsiTargetAlias=iscsiTargetAlias, volumeQuotaFinished=volumeQuotaFinished, iscsiTargetWriteLatency=iscsiTargetWriteLatency, fcTotalReadIops=fcTotalReadIops, iscsiInitiatorEntry=iscsiInitiatorEntry, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, shareDeletionFailed=shareDeletionFailed, shareSnapshotSizeHigh=shareSnapshotSizeHigh, poolExported=poolExported, lunReservedSizeHigh=lunReservedSizeHigh, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, aclMigrationStarted=aclMigrationStarted, lunReadMbps=lunReadMbps, poolTotalWriteMbps=poolTotalWriteMbps, controllerTimeDrift=controllerTimeDrift, targetGroupDeleteCompleted=targetGroupDeleteCompleted, iscsiTargetReadLatency=iscsiTargetReadLatency, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, nvdimmFailInitializationError=nvdimmFailInitializationError, cifsAvgReadLatency=cifsAvgReadLatency, poolCreated=poolCreated, fcTargets=fcTargets, iscsiTargetEntry=iscsiTargetEntry, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, networkIpmpGroupDown=networkIpmpGroupDown, upgradeStarted=upgradeStarted, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, poolImported=poolImported, fcAvgReadLatency=fcAvgReadLatency, diskCount=diskCount, poolMetaReadIops=poolMetaReadIops, testNotification=testNotification, projectPoolName=projectPoolName, lunDedupEnabled=lunDedupEnabled, lunSnapshotSizeHigh=lunSnapshotSizeHigh, shareNFSWriteIops=shareNFSWriteIops, spareDiskReplaced=spareDiskReplaced, diskDataReadMbps=diskDataReadMbps, projectEntry=projectEntry, projectSnapshotSizeLow=projectSnapshotSizeLow, projectTotalSaving=projectTotalSaving, lunProjectName=lunProjectName, iscsiInitiatorGroup=iscsiInitiatorGroup, diskTotalWriteMbps=diskTotalWriteMbps, PYSNMP_MODULE_ID=tegile, diagnosticDataUploaded=diagnosticDataUploaded)
mibBuilder.exportSymbols("TEGILE-MIB", iscsiWriteIops=iscsiWriteIops, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, volumeCreatedSuccessfully=volumeCreatedSuccessfully, notificationTime=notificationTime, diskTotalReadIops=diskTotalReadIops, iscsiAvgReadLatency=iscsiAvgReadLatency, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, notificationSensorAction=notificationSensorAction, netbiosSocketFailure=netbiosSocketFailure, shareSnapshotSizeLow=shareSnapshotSizeLow, poolDataWriteIops=poolDataWriteIops, ipmiMemory=ipmiMemory, shareDeleted=shareDeleted, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, notificationTargetEntityName=notificationTargetEntityName, lunDataSizeLow=lunDataSizeLow, haControllerA_Uptime=haControllerA_Uptime, sharePoolName=sharePoolName, snapshotCloningFailed=snapshotCloningFailed, properties=properties, smisServiceStopFailed=smisServiceStopFailed, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, ipmiOther=ipmiOther, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, poolReadCacheWriteLatency=poolReadCacheWriteLatency, poolOwnerController=poolOwnerController, poolDataReadLatency=poolDataReadLatency, diskDataWriteMbps=diskDataWriteMbps, poolEntry=poolEntry, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, poolMetaWriteMbps=poolMetaWriteMbps, diskSizeHigh=diskSizeHigh, iscsiTargetReadIops=iscsiTargetReadIops, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, poolDataReadMbps=poolDataReadMbps, lunCompressionEnabled=lunCompressionEnabled, fcTargetsTable=fcTargetsTable, fcInitiatorIndex=fcInitiatorIndex, iscsiTargetAuth=iscsiTargetAuth, lunBlockSize=lunBlockSize, snapshotRollbackCompleted=snapshotRollbackCompleted, shareNFSEnabled=shareNFSEnabled, fcInitiatorEntry=fcInitiatorEntry, haControllerB_Name=haControllerB_Name, diskIsOnline=diskIsOnline, projectDataSizeLow=projectDataSizeLow, shareQuotaHigh=shareQuotaHigh, lunInitiatorGroup=lunInitiatorGroup, replicationSourceRegistered=replicationSourceRegistered, fcTargetModifyCompleted=fcTargetModifyCompleted, tegileCompliances=tegileCompliances, iscsiImproperTargetGroup=iscsiImproperTargetGroup, memoryFailure=memoryFailure, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, ntpServerTimeDrift=ntpServerTimeDrift, tegileConformance=tegileConformance, cacheTotalReadMbps=cacheTotalReadMbps, maintenanceModeEnabled=maintenanceModeEnabled, nfsAvgWriteLatency=nfsAvgWriteLatency, poolTotalSaving=poolTotalSaving, deleteFolderFailed=deleteFolderFailed, networkTotalReceiveMbps=networkTotalReceiveMbps, poolTable=poolTable, nfsAvgReadLatency=nfsAvgReadLatency, lunWriteLatency=lunWriteLatency, smisServiceStartFailed=smisServiceStartFailed, lunTable=lunTable, lunIndex=lunIndex, iscsiInitiators=iscsiInitiators, iscsiInitiatorName=iscsiInitiatorName, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, cpuSystemCalls=cpuSystemCalls, iscsiInitiatorIndex=iscsiInitiatorIndex, notificationReadingTriggerValue=notificationReadingTriggerValue, poolDataWriteMbps=poolDataWriteMbps, ipmiPowerSupply=ipmiPowerSupply, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, snmpServiceStartFailed=snmpServiceStartFailed, poolReadCacheWriteMbps=poolReadCacheWriteMbps, nicTransmitMbps=nicTransmitMbps, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, upgradeDownloadFailed=upgradeDownloadFailed, lunReservedSizeLow=lunReservedSizeLow, aclMigrationCompleted=aclMigrationCompleted, haResourceActiveNode=haResourceActiveNode, globalStatistics=globalStatistics, haResourceName=haResourceName, shareProjectName=shareProjectName, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, shareCompressionEnabled=shareCompressionEnabled, poolReadCacheWriteIops=poolReadCacheWriteIops, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, poolFreeSizeLow=poolFreeSizeLow, shareMountPoint=shareMountPoint, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, pools=pools, fcInitiatorsTable=fcInitiatorsTable, fcTargetGroup=fcTargetGroup, diskGoneOffline=diskGoneOffline, poolDataReadIops=poolDataReadIops, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, tegileArray=tegileArray, sensorFailureEvent=sensorFailureEvent, iscsiTargetWriteMbps=iscsiTargetWriteMbps, poolUsedSizeLow=poolUsedSizeLow, lunName=lunName, replicationAbandoned=replicationAbandoned, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, networkTotalTransmitMbps=networkTotalTransmitMbps, tdpsUpgradeTimeout=tdpsUpgradeTimeout, iscsiTargetReadMbps=iscsiTargetReadMbps, diskTotalWriteIops=diskTotalWriteIops, projectName=projectName, cifsAvgWriteLatency=cifsAvgWriteLatency, projectTable=projectTable, poolUpgraded=poolUpgraded, networkIpmpGroupUp=networkIpmpGroupUp, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, replicationStarted=replicationStarted, nicTable=nicTable, lunReadLatency=lunReadLatency, notificationComponentName=notificationComponentName, volumeDeleteCompleted=volumeDeleteCompleted, intelliFlashSoftwareUp=intelliFlashSoftwareUp, notificationSeverity=notificationSeverity, iscsiTotalReadMbps=iscsiTotalReadMbps, notificationSensorNumber=notificationSensorNumber, poolAvgReadLatency=poolAvgReadLatency, diskSequentialIOCount=diskSequentialIOCount, upgradeFailed=upgradeFailed, lunWriteMbps=lunWriteMbps, lunCompressedRatio=lunCompressedRatio, iscsiTargetName=iscsiTargetName, shareCIFSReadIops=shareCIFSReadIops, iscsiTargetGroupError=iscsiTargetGroupError, poolHealth=poolHealth, shareTable=shareTable, upgradeCompleted=upgradeCompleted, poolProjectCount=poolProjectCount, poolProjects=poolProjects, iscsiTargetError=iscsiTargetError, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, shareDedupEnabled=shareDedupEnabled, iscsiTargetsTable=iscsiTargetsTable, snmpServiceStopped=snmpServiceStopped, ipmiTemperature=ipmiTemperature, cifsTotalReadIops=cifsTotalReadIops, cacheTotalWriteIops=cacheTotalWriteIops, poolTotalReadIops=poolTotalReadIops, vmwareNFSDatastores=vmwareNFSDatastores, poolMetaWriteIops=poolMetaWriteIops, fcTargetReadLatency=fcTargetReadLatency, replicationResumed=replicationResumed, fcTargetWriteLatency=fcTargetWriteLatency, poolMetaReadMbps=poolMetaReadMbps, iscsiInitiatorsTable=iscsiInitiatorsTable, notificationObjects=notificationObjects, upgradeDownloadStarted=upgradeDownloadStarted, nvdimmFailDeviceError=nvdimmFailDeviceError, cacheSSDReads=cacheSSDReads, shareCIFSReadLatency=shareCIFSReadLatency, nicState=nicState, poolFreeSizeHigh=poolFreeSizeHigh, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, lunPoolName=lunPoolName, upgradeDownloadCompleted=upgradeDownloadCompleted, ipmiCriticalInterrupt=ipmiCriticalInterrupt, cacheRAMReads=cacheRAMReads, diskDataWriteIops=diskDataWriteIops, tdpsUpgradeFailed=tdpsUpgradeFailed, fcTargetStatus=fcTargetStatus, ipmiFan=ipmiFan, diskTable=diskTable, replicationAborted=replicationAborted, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, nfsTotalReadIops=nfsTotalReadIops, lunProtocol=lunProtocol, poolDataWriteLatency=poolDataWriteLatency, ipmiVoltage=ipmiVoltage, lunReadIops=lunReadIops, projectThresholdExceedWarning=projectThresholdExceedWarning, networkInterfaceDown=networkInterfaceDown, cifsTotalReadMbps=cifsTotalReadMbps, poolTotalReadMbps=poolTotalReadMbps, iscsiInitiatorChapUser=iscsiInitiatorChapUser, snmpAgentVersion=snmpAgentVersion, projectModified=projectModified, haResourceGroup=haResourceGroup, cacheTotalWriteMbps=cacheTotalWriteMbps, diskTotalReadMbps=diskTotalReadMbps, lunTargetGroup=lunTargetGroup, haResourcesTable=haResourcesTable, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, notificationReadingUnit=notificationReadingUnit, nfsTotalReadMbps=nfsTotalReadMbps, diskChassisIdx=diskChassisIdx, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, cpuTotalUsage=cpuTotalUsage, poolState=poolState, fcTargetWriteIops=fcTargetWriteIops, nfsTotalWriteIops=nfsTotalWriteIops, poolCount=poolCount, webdocsUpgradeFailed=webdocsUpgradeFailed, lunSnapshotSizeLow=lunSnapshotSizeLow, unknownSensorEvent=unknownSensorEvent, poolUsedSizeHigh=poolUsedSizeHigh, poolAvgWriteLatency=poolAvgWriteLatency, fcAvgWriteLatency=fcAvgWriteLatency, poolMetaWriteLatency=poolMetaWriteLatency, snapshotRollbackFailed=snapshotRollbackFailed, shareDataSizeHigh=shareDataSizeHigh)
